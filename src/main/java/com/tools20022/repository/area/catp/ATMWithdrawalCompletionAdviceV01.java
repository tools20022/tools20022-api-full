...
public class ATMWithdrawalCompletionAdviceV01 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Header21> mmHeader = new MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Header21>() {
		{
			xmlTag = "Hdr";
		...
		@Override
		public Header21 getValue(ATMWithdrawalCompletionAdviceV01 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(ATMWithdrawalCompletionAdviceV01 obj, Header21 value) {
			obj.setHeader(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ContentInformationType10>> mmProtectedATMWithdrawalCompletionAdvice = new MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ContentInformationType10>>() {
		{
		...
		@Override
		public Optional<ContentInformationType10> getValue(ATMWithdrawalCompletionAdviceV01 obj) {
			return obj.getProtectedATMWithdrawalCompletionAdvice();
		}

		@Override
		public void setValue(ATMWithdrawalCompletionAdviceV01 obj, Optional<ContentInformationType10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ATMWithdrawalCompletionAdvice1>> mmATMWithdrawalCompletionAdvice = new MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ATMWithdrawalCompletionAdvice1>>() {
		{
		...
		@Override
		public Optional<ATMWithdrawalCompletionAdvice1> getValue(ATMWithdrawalCompletionAdviceV01 obj) {
			return obj.getATMWithdrawalCompletionAdvice();
		}

		@Override
		public void setValue(ATMWithdrawalCompletionAdviceV01 obj, Optional<ATMWithdrawalCompletionAdvice1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ContentInformationType15>> mmSecurityTrailer = new MMMessageBuildingBlock<ATMWithdrawalCompletionAdviceV01, Optional<ContentInformationType15>>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<ContentInformationType15> getValue(ATMWithdrawalCompletionAdviceV01 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(ATMWithdrawalCompletionAdviceV01 obj, Optional<ContentInformationType15> value) {
