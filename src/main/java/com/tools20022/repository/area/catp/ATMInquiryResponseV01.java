		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ATMInquiryResponseV01.mmHeader, ATMInquiryResponseV01.mmProtectedATMInquiryResponse, ATMInquiryResponseV01.mmATMInquiryResponse, ATMInquiryResponseV01.mmSecurityTrailer);
