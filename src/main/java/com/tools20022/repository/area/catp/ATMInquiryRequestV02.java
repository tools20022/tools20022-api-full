		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ATMInquiryRequestV02.mmHeader, ATMInquiryRequestV02.mmProtectedATMInquiryRequest, ATMInquiryRequestV02.mmATMInquiryRequest, ATMInquiryRequestV02.mmSecurityTrailer);
