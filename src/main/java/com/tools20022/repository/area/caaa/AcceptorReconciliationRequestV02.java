 ...
 * messageDefinitionIdentifier} = {@code caaa.009.001.02}</li>
...
@XmlType(name = "AcceptorReconciliationRequestV02", propOrder = {"header", "reconciliationRequest", "securityTrailer"})
public class AcceptorReconciliationRequestV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV02, Header1> mmHeader = new MMMessageBuildingBlock<AcceptorReconciliationRequestV02, Header1>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Reconciliation request message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV03.mmHeader);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header1 getValue(AcceptorReconciliationRequestV02 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV02 obj, Header1 value) {
			obj.setHeader(value);
		}
	};
	@XmlElement(name = "RcncltnReq", required = true)
	protected AcceptorReconciliationRequest2 reconciliationRequest;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV02, AcceptorReconciliationRequest2> mmReconciliationRequest = new MMMessageBuildingBlock<AcceptorReconciliationRequestV02, AcceptorReconciliationRequest2>() {
		{
			xmlTag = "RcncltnReq";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReconciliationRequest";
			definition = "Information related to the reconcilliation request.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV03.mmReconciliationRequest);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorReconciliationRequest2 getValue(AcceptorReconciliationRequestV02 obj) {
			return obj.getReconciliationRequest();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV02 obj, AcceptorReconciliationRequest2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV02, ContentInformationType6> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorReconciliationRequestV02, ContentInformationType6>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV03.mmSecurityTrailer);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ContentInformationType6 getValue(AcceptorReconciliationRequestV02 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV02 obj, ContentInformationType6 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorReconciliationRequestV02.mmHeader, com.tools20022.repository.area.caaa.AcceptorReconciliationRequestV02.mmReconciliationRequest,
						com.tools20022.repository.area.caaa.AcceptorReconciliationRequestV02.mmSecurityTrailer);
			...
			public Class<?> getInstanceClass() {
				return AcceptorReconciliationRequestV02.class;
			}
		});
	...
	public AcceptorReconciliationRequestV02 setHeader(Header1 header) {
	...
	public AcceptorReconciliationRequestV02 setReconciliationRequest(AcceptorReconciliationRequest2 reconciliationRequest) {
	...
	public AcceptorReconciliationRequestV02 setSecurityTrailer(ContentInformationType6 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorReconciliationRequestV02 messageBody;
	}
}