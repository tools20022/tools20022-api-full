		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV03.mmHeader, AcceptorCancellationAdviceV03.mmCancellationAdvice, AcceptorCancellationAdviceV03.mmSecurityTrailer);
