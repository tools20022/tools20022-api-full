		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorDiagnosticRequestV04.mmHeader, AcceptorDiagnosticRequestV04.mmDiagnosticRequest, AcceptorDiagnosticRequestV04.mmSecurityTrailer);
