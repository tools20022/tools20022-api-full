		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV06.mmHeader, AcceptorCancellationAdviceV06.mmCancellationAdvice, AcceptorCancellationAdviceV06.mmSecurityTrailer);
