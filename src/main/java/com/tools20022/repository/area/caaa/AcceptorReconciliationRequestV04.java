...
public class AcceptorReconciliationRequestV04 {
	...
	public AcceptorReconciliationRequestV04 setHeader(Header10 header) {
	...
	public AcceptorReconciliationRequestV04 setReconciliationRequest(AcceptorReconciliationRequest4 reconciliationRequest) {
	...
	public AcceptorReconciliationRequestV04 setSecurityTrailer(ContentInformationType11 securityTrailer) {
