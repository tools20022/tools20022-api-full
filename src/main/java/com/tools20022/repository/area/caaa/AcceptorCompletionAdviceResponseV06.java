 ...
 * {@linkplain com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV06#identifier
 * AcceptorCompletionAdviceResponseV06.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Header = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV05.Header;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CompletionAdviceResponse = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV05.CompletionAdviceResponse;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV05.SecurityTrailer;
			minOccurs = 0;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV06.Header,
						com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV06.CompletionAdviceResponse, com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV06.SecurityTrailer);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceResponseV06.identifier;
			}
		});
