 ...
 * {@linkplain com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV02#identifier
 * AcceptorAuthorisationRequestV02.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Header = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV03.Header);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AuthorisationRequest = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV03.AuthorisationRequest);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV03.SecurityTrailer);
			minOccurs = 1;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV02.Header, com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV02.AuthorisationRequest,
						com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV02.SecurityTrailer);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.caaa.AcceptorAuthorisationRequestV02.identifier;
			}
		});
