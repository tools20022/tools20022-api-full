		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorBatchTransferV06.mmHeader, AcceptorBatchTransferV06.mmBatchTransfer, AcceptorBatchTransferV06.mmSecurityTrailer);
