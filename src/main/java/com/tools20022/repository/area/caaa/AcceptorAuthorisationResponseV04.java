 ...
 * messageDefinitionIdentifier} = {@code caaa.002.001.04}</li>
...
@XmlType(name = "AcceptorAuthorisationResponseV04", propOrder = {"header", "authorisationResponse", "securityTrailer"})
public class AcceptorAuthorisationResponseV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, Header10> mmHeader = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, Header10>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Authorisation response message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV05.mmHeader);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV03.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header10 getValue(AcceptorAuthorisationResponseV04 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV04 obj, Header10 value) {
			obj.setHeader(value);
		}
	};
	@XmlElement(name = "AuthstnRspn", required = true)
	protected AcceptorAuthorisationResponse4 authorisationResponse;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, AcceptorAuthorisationResponse4> mmAuthorisationResponse = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, AcceptorAuthorisationResponse4>() {
		{
			xmlTag = "AuthstnRspn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AuthorisationResponse";
			definition = "Information related to the response of the authorisation.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV05.mmAuthorisationResponse);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV03.mmAuthorisationResponse;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorAuthorisationResponse4 getValue(AcceptorAuthorisationResponseV04 obj) {
			return obj.getAuthorisationResponse();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV04 obj, AcceptorAuthorisationResponse4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, ContentInformationType11> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV04, ContentInformationType11>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV05.mmSecurityTrailer);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV03.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ContentInformationType11 getValue(AcceptorAuthorisationResponseV04 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV04 obj, ContentInformationType11 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV04.mmHeader, com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV04.mmAuthorisationResponse,
						com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV04.mmSecurityTrailer);
			...
			public Class<?> getInstanceClass() {
				return AcceptorAuthorisationResponseV04.class;
			}
		});
	...
	public AcceptorAuthorisationResponseV04 setHeader(Header10 header) {
	...
	public AcceptorAuthorisationResponseV04 setAuthorisationResponse(AcceptorAuthorisationResponse4 authorisationResponse) {
	...
	public AcceptorAuthorisationResponseV04 setSecurityTrailer(ContentInformationType11 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorAuthorisationResponseV04 messageBody;
	}
}