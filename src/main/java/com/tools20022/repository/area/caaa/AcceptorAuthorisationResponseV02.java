		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV02.mmHeader, AcceptorAuthorisationResponseV02.mmAuthorisationResponse, AcceptorAuthorisationResponseV02.mmSecurityTrailer);
