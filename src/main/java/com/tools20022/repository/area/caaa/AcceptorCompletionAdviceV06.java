	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV05.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCompletionAdvice = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV05.mmCompletionAdvice;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCompletionAdviceV05.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 0;
