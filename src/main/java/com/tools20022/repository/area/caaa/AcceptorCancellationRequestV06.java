		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationRequestV06.mmHeader, AcceptorCancellationRequestV06.mmCancellationRequest, AcceptorCancellationRequestV06.mmSecurityTrailer);
