...
@XmlType(name = "AcceptorDiagnosticRequestV03", propOrder = {"header", "diagnosticRequest", "securityTrailer"})
public class AcceptorDiagnosticRequestV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, Header7> mmHeader = new MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, Header7>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Diagnostic request message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticRequestV04.mmHeader);
			previousVersion_lazy = () -> AcceptorDiagnosticRequestV02.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header7 getValue(AcceptorDiagnosticRequestV03 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorDiagnosticRequestV03 obj, Header7 value) {
			obj.setHeader(value);
		}
	};
	@XmlElement(name = "DgnstcReq", required = true)
	protected AcceptorDiagnosticRequest3 diagnosticRequest;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, AcceptorDiagnosticRequest3> mmDiagnosticRequest = new MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, AcceptorDiagnosticRequest3>() {
		{
			xmlTag = "DgnstcReq";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DiagnosticRequest";
			definition = "Information related to the diagnostic request.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticRequestV04.mmDiagnosticRequest);
			previousVersion_lazy = () -> AcceptorDiagnosticRequestV02.mmDiagnosticRequest;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorDiagnosticRequest3 getValue(AcceptorDiagnosticRequestV03 obj) {
			return obj.getDiagnosticRequest();
		}

		@Override
		public void setValue(AcceptorDiagnosticRequestV03 obj, AcceptorDiagnosticRequest3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, ContentInformationType8> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorDiagnosticRequestV03, ContentInformationType8>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticRequestV04.mmSecurityTrailer);
			previousVersion_lazy = () -> AcceptorDiagnosticRequestV02.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ContentInformationType8 getValue(AcceptorDiagnosticRequestV03 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorDiagnosticRequestV03 obj, ContentInformationType8 value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return AcceptorDiagnosticRequestV03.class;
			}
		});
	...
	public AcceptorDiagnosticRequestV03 setHeader(Header7 header) {
	...
	public AcceptorDiagnosticRequestV03 setDiagnosticRequest(AcceptorDiagnosticRequest3 diagnosticRequest) {
	...
	public AcceptorDiagnosticRequestV03 setSecurityTrailer(ContentInformationType8 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorDiagnosticRequestV03 messageBody;
	}
}