		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponseV06.mmHeader, AcceptorCancellationAdviceResponseV06.mmCancellationAdviceResponse, AcceptorCancellationAdviceResponseV06.mmSecurityTrailer);
