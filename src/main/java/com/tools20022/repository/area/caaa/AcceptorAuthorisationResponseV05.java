...
@XmlType(name = "AcceptorAuthorisationResponseV05", propOrder = {"header", "authorisationResponse", "securityTrailer"})
public class AcceptorAuthorisationResponseV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, Header30> mmHeader = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, Header30>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Authorisation response message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV06.mmHeader);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV04.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header30 getValue(AcceptorAuthorisationResponseV05 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV05 obj, Header30 value) {
			obj.setHeader(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, AcceptorAuthorisationResponse5> mmAuthorisationResponse = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, AcceptorAuthorisationResponse5>() {
		{
			xmlTag = "AuthstnRspn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AuthorisationResponse";
			definition = "Information related to the response of the authorisation.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV06.mmAuthorisationResponse);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV04.mmAuthorisationResponse;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorAuthorisationResponse5 getValue(AcceptorAuthorisationResponseV05 obj) {
			return obj.getAuthorisationResponse();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV05 obj, AcceptorAuthorisationResponse5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, Optional<ContentInformationType15>> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorAuthorisationResponseV05, Optional<ContentInformationType15>>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV06.mmSecurityTrailer);
			previousVersion_lazy = () -> AcceptorAuthorisationResponseV04.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ContentInformationType15> getValue(AcceptorAuthorisationResponseV05 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorAuthorisationResponseV05 obj, Optional<ContentInformationType15> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return AcceptorAuthorisationResponseV05.class;
			}
		});
	...
	public AcceptorAuthorisationResponseV05 setHeader(Header30 header) {
	...
	public AcceptorAuthorisationResponseV05 setAuthorisationResponse(AcceptorAuthorisationResponse5 authorisationResponse) {
	...
	public AcceptorAuthorisationResponseV05 setSecurityTrailer(ContentInformationType15 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorAuthorisationResponseV05 messageBody;
	}
}