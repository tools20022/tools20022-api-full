...
@XmlType(name = "AcceptorReconciliationRequestV05", propOrder = {"header", "reconciliationRequest", "securityTrailer"})
public class AcceptorReconciliationRequestV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV05, Header30> mmHeader = new MMMessageBuildingBlock<AcceptorReconciliationRequestV05, Header30>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Reconciliation request message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV06.mmHeader);
			previousVersion_lazy = () -> AcceptorReconciliationRequestV04.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header30 getValue(AcceptorReconciliationRequestV05 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV05 obj, Header30 value) {
			obj.setHeader(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV05, AcceptorReconciliationRequest5> mmReconciliationRequest = new MMMessageBuildingBlock<AcceptorReconciliationRequestV05, AcceptorReconciliationRequest5>() {
		{
			xmlTag = "RcncltnReq";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReconciliationRequest";
			definition = "Information related to the reconciliation request.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV06.mmReconciliationRequest);
			previousVersion_lazy = () -> AcceptorReconciliationRequestV04.mmReconciliationRequest;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorReconciliationRequest5 getValue(AcceptorReconciliationRequestV05 obj) {
			return obj.getReconciliationRequest();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV05 obj, AcceptorReconciliationRequest5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorReconciliationRequestV05, Optional<ContentInformationType15>> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorReconciliationRequestV05, Optional<ContentInformationType15>>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV06.mmSecurityTrailer);
			previousVersion_lazy = () -> AcceptorReconciliationRequestV04.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ContentInformationType15> getValue(AcceptorReconciliationRequestV05 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorReconciliationRequestV05 obj, Optional<ContentInformationType15> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return AcceptorReconciliationRequestV05.class;
			}
		});
	...
	public AcceptorReconciliationRequestV05 setHeader(Header30 header) {
	...
	public AcceptorReconciliationRequestV05 setReconciliationRequest(AcceptorReconciliationRequest5 reconciliationRequest) {
	...
	public AcceptorReconciliationRequestV05 setSecurityTrailer(ContentInformationType15 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorReconciliationRequestV05 messageBody;
	}
}