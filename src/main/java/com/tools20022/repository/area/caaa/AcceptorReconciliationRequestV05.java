		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorReconciliationRequestV05.mmHeader, AcceptorReconciliationRequestV05.mmReconciliationRequest, AcceptorReconciliationRequestV05.mmSecurityTrailer);
