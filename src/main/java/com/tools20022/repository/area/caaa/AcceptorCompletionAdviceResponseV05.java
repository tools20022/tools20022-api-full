...
public class AcceptorCompletionAdviceResponseV05 {
	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return AcceptorCompletionAdviceResponseV05.class.getMethod("getHeader", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmCompletionAdviceResponse = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return AcceptorCompletionAdviceResponseV05.class.getMethod("getCompletionAdviceResponse", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return AcceptorCompletionAdviceResponseV05.class.getMethod("getSecurityTrailer", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public void setCompletionAdviceResponse(AcceptorCompletionAdviceResponse5 completionAdviceResponse) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:caaa.004.05.05")
