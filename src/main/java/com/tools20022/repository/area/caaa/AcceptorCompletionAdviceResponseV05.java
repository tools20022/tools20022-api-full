		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCompletionAdviceResponseV05.mmHeader, AcceptorCompletionAdviceResponseV05.mmCompletionAdviceResponse, AcceptorCompletionAdviceResponseV05.mmSecurityTrailer);
