		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCompletionAdviceV04.mmHeader, AcceptorCompletionAdviceV04.mmCompletionAdvice, AcceptorCompletionAdviceV04.mmSecurityTrailer);
