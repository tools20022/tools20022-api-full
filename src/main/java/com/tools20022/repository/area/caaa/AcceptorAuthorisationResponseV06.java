		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorAuthorisationResponseV06.mmHeader, AcceptorAuthorisationResponseV06.mmAuthorisationResponse, AcceptorAuthorisationResponseV06.mmSecurityTrailer);
