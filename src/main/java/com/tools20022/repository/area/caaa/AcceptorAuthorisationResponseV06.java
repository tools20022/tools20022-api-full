 ...
 * {@linkplain com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV06#identifier
 * AcceptorAuthorisationResponseV06.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Header = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV05.Header;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AuthorisationResponse = new MMMessageBuildingBlock() {
		{
			...
			definition = "Information related to the response of the authorisation.";
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV05.AuthorisationResponse;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV05.SecurityTrailer;
			minOccurs = 0;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV06.Header, com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV06.AuthorisationResponse,
						com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV06.SecurityTrailer);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.caaa.AcceptorAuthorisationResponseV06.identifier;
			}
		});
