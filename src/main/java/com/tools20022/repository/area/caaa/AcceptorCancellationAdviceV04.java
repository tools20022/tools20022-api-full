...
@XmlType(name = "AcceptorCancellationAdviceV04", propOrder = {"header", "cancellationAdvice", "securityTrailer"})
public class AcceptorCancellationAdviceV04 {
	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV05.mmHeader);
			previousVersion_lazy = () -> AcceptorCancellationAdviceV03.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCancellationAdvice = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV05.mmCancellationAdvice);
			previousVersion_lazy = () -> AcceptorCancellationAdviceV03.mmCancellationAdvice;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV05.mmSecurityTrailer);
			previousVersion_lazy = () -> AcceptorCancellationAdviceV03.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return AcceptorCancellationAdviceV04.class;
			}
		});
	...
	public AcceptorCancellationAdviceV04 setHeader(Header11 header) {
	...
	public AcceptorCancellationAdviceV04 setCancellationAdvice(AcceptorCancellationAdvice4 cancellationAdvice) {
	...
	public AcceptorCancellationAdviceV04 setSecurityTrailer(ContentInformationType11 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorCancellationAdviceV04 messageBody;
	}
}