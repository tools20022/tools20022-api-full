...
public class AcceptorCancellationAdviceResponseV05 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponseV05.mmHeader, AcceptorCancellationAdviceResponseV05.mmCancellationAdviceResponse, AcceptorCancellationAdviceResponseV05.mmSecurityTrailer);
	...
	public void setCancellationAdviceResponse(AcceptorCancellationAdviceResponse5 cancellationAdviceResponse) {
