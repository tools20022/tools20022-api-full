...
import com.tools20022.repository.msg.AcceptorDiagnosticResponse2;
...
@XmlType(name = "AcceptorDiagnosticResponseV02", propOrder = {"header", "diagnosticResponse", "securityTrailer"})
public class AcceptorDiagnosticResponseV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, Header1> mmHeader = new MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, Header1>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Diagnostic response message management information.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticResponseV03.mmHeader);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header1 getValue(AcceptorDiagnosticResponseV02 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponseV02 obj, Header1 value) {
			obj.setHeader(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, AcceptorDiagnosticResponse2> mmDiagnosticResponse = new MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, AcceptorDiagnosticResponse2>() {
		{
			xmlTag = "DgnstcRspn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DiagnosticResponse";
			definition = "Information related to the diagnostic response.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticResponseV03.mmDiagnosticResponse);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AcceptorDiagnosticResponse2 getValue(AcceptorDiagnosticResponseV02 obj) {
			return obj.getDiagnosticResponse();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponseV02 obj, AcceptorDiagnosticResponse2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, ContentInformationType6> mmSecurityTrailer = new MMMessageBuildingBlock<AcceptorDiagnosticResponseV02, ContentInformationType6>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorDiagnosticResponseV03.mmSecurityTrailer);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ContentInformationType6 getValue(AcceptorDiagnosticResponseV02 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponseV02 obj, ContentInformationType6 value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return AcceptorDiagnosticResponseV02.class;
			}
		});
	...
	public AcceptorDiagnosticResponseV02 setHeader(Header1 header) {
	...
	public AcceptorDiagnosticResponseV02 setDiagnosticResponse(AcceptorDiagnosticResponse2 diagnosticResponse) {
	...
	public AcceptorDiagnosticResponseV02 setSecurityTrailer(ContentInformationType6 securityTrailer) {
	...
	static public class Document {
		...
		public AcceptorDiagnosticResponseV02 messageBody;
	}
}