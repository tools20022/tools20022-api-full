		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceV05.mmHeader, AcceptorCancellationAdviceV05.mmCancellationAdvice, AcceptorCancellationAdviceV05.mmSecurityTrailer);
