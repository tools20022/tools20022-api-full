		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorAuthorisationRequestV03.mmHeader, AcceptorAuthorisationRequestV03.mmAuthorisationRequest, AcceptorAuthorisationRequestV03.mmSecurityTrailer);
