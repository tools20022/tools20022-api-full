		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorAuthorisationRequestV06.mmHeader, AcceptorAuthorisationRequestV06.mmAuthorisationRequest, AcceptorAuthorisationRequestV06.mmSecurityTrailer);
