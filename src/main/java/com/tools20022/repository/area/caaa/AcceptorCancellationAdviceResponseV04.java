...
public class AcceptorCancellationAdviceResponseV04 {
	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV05.mmHeader);
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV03.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCancellationAdviceResponse = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV05.mmCancellationAdviceResponse);
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV03.mmCancellationAdviceResponse;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV05.mmSecurityTrailer);
			previousVersion_lazy = () -> com.tools20022.repository.area.caaa.AcceptorCancellationAdviceResponseV03.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCancellationAdviceResponse(AcceptorCancellationAdviceResponse4 cancellationAdviceResponse) {
