		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestV05.mmAccountOwnerTransactionIdentification, SecuritiesTransactionCancellationRequestV05.mmAccountServicerTransactionIdentification,
						SecuritiesTransactionCancellationRequestV05.mmMarketInfrastructureTransactionIdentification, SecuritiesTransactionCancellationRequestV05.mmProcessorTransactionIdentification,
						SecuritiesTransactionCancellationRequestV05.mmAccountOwner, SecuritiesTransactionCancellationRequestV05.mmSafekeepingAccount, SecuritiesTransactionCancellationRequestV05.mmTransactionDetails,
						SecuritiesTransactionCancellationRequestV05.mmCancellationReason, SecuritiesTransactionCancellationRequestV05.mmFXCancellation, SecuritiesTransactionCancellationRequestV05.mmSupplementaryData);
