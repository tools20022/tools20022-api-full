		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV03.mmRequestReference, SecuritiesSettlementConditionModificationStatusAdviceV03.mmAccountOwner,
						SecuritiesSettlementConditionModificationStatusAdviceV03.mmSafekeepingAccount, SecuritiesSettlementConditionModificationStatusAdviceV03.mmRequestDetails,
						SecuritiesSettlementConditionModificationStatusAdviceV03.mmProcessingStatus, SecuritiesSettlementConditionModificationStatusAdviceV03.mmSupplementaryData);
