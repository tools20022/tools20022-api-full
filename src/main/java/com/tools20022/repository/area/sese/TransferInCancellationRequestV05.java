		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInCancellationRequestV05.mmMessageIdentification, TransferInCancellationRequestV05.mmReferences, TransferInCancellationRequestV05.mmCancellation,
						TransferInCancellationRequestV05.mmMarketPracticeVersion, TransferInCancellationRequestV05.mmCopyDetails);
