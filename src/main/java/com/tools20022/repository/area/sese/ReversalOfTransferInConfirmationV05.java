...
import com.tools20022.repository.choice.Reversal4Choice;
 ...
 * messageDefinitionIdentifier} = {@code sese.008.001.05}</li>
 * <li>
...
@XmlType(name = "ReversalOfTransferInConfirmationV05", propOrder = {"messageIdentification", "references", "reversal", "marketPracticeVersion", "copyDetails"})
public class ReversalOfTransferInConfirmationV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
		...
		@Override
		public MessageIdentification1 getValue(ReversalOfTransferInConfirmationV05 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(ReversalOfTransferInConfirmationV05 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, List<References15>> mmReferences = new MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, List<References15>>() {
		{
			xmlTag = "Refs";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "References";
			...
			nextVersions_lazy = () -> Arrays.asList(ReversalOfTransferInConfirmationV06.mmReferences);
			previousVersion_lazy = () -> ReversalOfTransferInConfirmationV04.mmReferences;
			minOccurs = 0;
			complexType_lazy = () -> References15.mmObject();
		}

		@Override
		public List<References15> getValue(ReversalOfTransferInConfirmationV05 obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(ReversalOfTransferInConfirmationV05 obj, List<References15> value) {
			obj.setReferences(value);
		}
	};
	@XmlElement(name = "Rvsl", required = true)
	protected Reversal4Choice reversal;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Reversal4Choice> mmReversal = new MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Reversal4Choice>() {
		{
			xmlTag = "Rvsl";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Reversal";
			definition = "Choice between reversal by reference or by reversal details.";
			nextVersions_lazy = () -> Arrays.asList(ReversalOfTransferInConfirmationV06.mmReversal);
			previousVersion_lazy = () -> ReversalOfTransferInConfirmationV04.mmReversal;
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> Reversal4Choice.mmObject();
		}

		@Override
		public Reversal4Choice getValue(ReversalOfTransferInConfirmationV05 obj) {
			return obj.getReversal();
		}

		@Override
		public void setValue(ReversalOfTransferInConfirmationV05 obj, Reversal4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Optional<MarketPracticeVersion1>> mmMarketPracticeVersion = new MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Optional<MarketPracticeVersion1>>() {
		{
			xmlTag = "MktPrctcVrsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MarketPracticeVersion";
			definition = "Identifies the market practice to which the message conforms.";
			nextVersions_lazy = () -> Arrays.asList(ReversalOfTransferInConfirmationV06.mmMarketPracticeVersion);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<MarketPracticeVersion1> getValue(ReversalOfTransferInConfirmationV05 obj) {
			return obj.getMarketPracticeVersion();
		}

		@Override
		public void setValue(ReversalOfTransferInConfirmationV05 obj, Optional<MarketPracticeVersion1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Optional<CopyInformation2>> mmCopyDetails = new MMMessageBuildingBlock<ReversalOfTransferInConfirmationV05, Optional<CopyInformation2>>() {
		{
			xmlTag = "CpyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CopyDetails";
			definition = "Information provided when the message is a copy of a previous message.";
			nextVersions_lazy = () -> Arrays.asList(ReversalOfTransferInConfirmationV06.mmCopyDetails);
			previousVersion_lazy = () -> ReversalOfTransferInConfirmationV04.mmCopyDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyInformation2> getValue(ReversalOfTransferInConfirmationV05 obj) {
			return obj.getCopyDetails();
		}

		@Override
		public void setValue(ReversalOfTransferInConfirmationV05 obj, Optional<CopyInformation2> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				name = "ReversalOfTransferInConfirmationV05";
				definition = "Scope\r\nAn executing party, for example, a transfer agent, sends the ReversalOfTransferInConfirmation message to the instructing party, for example, an investment manager or its authorised representative, to cancel a previously sent TransferInConfirmation message.\r\nUsage\r\nThe ReversalOfTransferInConfirmation message is used to reverse a previously sent TransferInConfirmation.\r\nThere are two ways to specify the reversal of the transfer in confirmation. Either:\r\n- the business references, for example, TransferReference, TransferConfirmationIdentification, of the transfer confirmation are quoted, or,\r\n- all the details of the transfer confirmation (this includes TransferReference and TransferConfirmationIdentification) are quoted but this is not recommended.\r\nThe message identification of the TransferInConfirmation message in which the transfer confirmation was conveyed may also be quoted in PreviousReference.\r\nThe message reference (MessageIdentification) of the TransferInInstruction message in which the transfer instruction was conveyed may also be quoted in RelatedReference.\r\n";
				nextVersions_lazy = () -> Arrays.asList(ReversalOfTransferInConfirmationV06.mmObject());
				previousVersion_lazy = () -> ReversalOfTransferInConfirmationV04.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "RvslOfTrfInConf";
				businessArea_lazy = () -> SecuritiesSettlementArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV05.mmMessageIdentification,
						com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV05.mmReferences, com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV05.mmReversal,
						com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV05.mmMarketPracticeVersion, com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV05.mmCopyDetails);
			...
			public Class<?> getInstanceClass() {
				return ReversalOfTransferInConfirmationV05.class;
			}
		});
	...
	public ReversalOfTransferInConfirmationV05 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public ReversalOfTransferInConfirmationV05 setReferences(List<References15> references) {
		this.references = Objects.requireNonNull(references);
		return this;
	}

	public Reversal4Choice getReversal() {
		return reversal;
	}

	public ReversalOfTransferInConfirmationV05 setReversal(Reversal4Choice reversal) {
	...
	public ReversalOfTransferInConfirmationV05 setMarketPracticeVersion(MarketPracticeVersion1 marketPracticeVersion) {
	...
	public ReversalOfTransferInConfirmationV05 setCopyDetails(CopyInformation2 copyDetails) {
		this.copyDetails = copyDetails;
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.008.001.05")
	static public class Document {
		@XmlElement(name = "RvslOfTrfInConf", required = true)
		public ReversalOfTransferInConfirmationV05 messageBody;
	}
}