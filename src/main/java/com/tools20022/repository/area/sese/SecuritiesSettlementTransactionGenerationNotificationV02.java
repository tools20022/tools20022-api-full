...
public class SecuritiesSettlementTransactionGenerationNotificationV02 {
	...
	public void setTransactionIdentificationDetails(SettlementTypeAndIdentification10 transactionIdentificationDetails) {
	...
	public void setLinkages(List<Linkages7> linkages) {
	...
	public void setFinancialInstrumentAttributes(FinancialInstrumentAttributes20 financialInstrumentAttributes) {
	...
	public void setQuantityAndAccountDetails(List<QuantityAndAccount17> quantityAndAccountDetails) {
	...
	public OtherAmounts12 getOtherAmounts() {
		return otherAmounts;
	}

	public void setOtherAmounts(OtherAmounts12 otherAmounts) {
		this.otherAmounts = otherAmounts;
	}

	@XmlElement(name = "OthrBizPties")
	public OtherParties8 getOtherBusinessParties() {
		return otherBusinessParties;
	}

	public void setOtherBusinessParties(OtherParties8 otherBusinessParties) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:sese.032.02.02")
