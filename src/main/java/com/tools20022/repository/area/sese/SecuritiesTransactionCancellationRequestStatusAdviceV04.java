 ...
 * messageDefinitionIdentifier} = {@code sese.027.001.04}</li>
 ...
 * SecuritiesTransactionCancellationRequestStatusAdviceV04.mmSupplementaryData}</li>
 * </ul>
 * </li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#for_sese_SecuritiesTransactionCancellationRequestStatusAdviceV04
...
@XmlType(name = "SecuritiesTransactionCancellationRequestStatusAdviceV04", propOrder = {"cancellationRequestReference", "transactionIdentification", "processingStatus", "transactionDetails", "supplementaryData"})
public class SecuritiesTransactionCancellationRequestStatusAdviceV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Identification1> mmCancellationRequestReference = new MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Identification1>() {
		{
			xmlTag = "CxlReqRef";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV05.mmCancellationRequestReference);
			previousVersion_lazy = () -> SecuritiesTransactionCancellationRequestStatusAdviceV03.mmCancellationRequestReference;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Identification1 getValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj) {
			return obj.getCancellationRequestReference();
		}

		@Override
		public void setValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj, Identification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Optional<TransactionIdentifications17>> mmTransactionIdentification = new MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Optional<TransactionIdentifications17>>() {
		{
			xmlTag = "TxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account servicer.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV05.mmTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTransactionCancellationRequestStatusAdviceV03.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionIdentifications17> getValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj, Optional<TransactionIdentifications17> value) {
			obj.setTransactionIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "PrcgSts", required = true)
	protected ProcessingStatus45Choice processingStatus;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, ProcessingStatus45Choice> mmProcessingStatus = new MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, ProcessingStatus45Choice>() {
		{
			xmlTag = "PrcgSts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ProcessingStatus";
			definition = "Provides details on the processing status of the request.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV05.mmProcessingStatus);
			previousVersion_lazy = () -> SecuritiesTransactionCancellationRequestStatusAdviceV03.mmProcessingStatus;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ProcessingStatus45Choice getValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj) {
			return obj.getProcessingStatus();
		}

		@Override
		public void setValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj, ProcessingStatus45Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Optional<TransactionDetails30>> mmTransactionDetails = new MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, Optional<TransactionDetails30>>() {
		{
			xmlTag = "TxDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionDetails";
			definition = "Identifies the details of the transaction.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV05.mmTransactionDetails);
			previousVersion_lazy = () -> SecuritiesTransactionCancellationRequestStatusAdviceV03.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionDetails30> getValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj, Optional<TransactionDetails30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<SecuritiesTransactionCancellationRequestStatusAdviceV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV05.mmSupplementaryData);
			previousVersion_lazy = () -> SecuritiesTransactionCancellationRequestStatusAdviceV03.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(SecuritiesTransactionCancellationRequestStatusAdviceV04 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetXRule.for_sese_SecuritiesTransactionCancellationRequestStatusAdviceV04,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.for_sese_SecuritiesTransactionCancellationRequestStatusAdviceV04,
						com.tools20022.repository.constraints.ConstraintSecuritiesMarketPracticeGroupGuideline.for_sese_SecuritiesTransactionCancellationRequestStatusAdviceV04);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV04.mmCancellationRequestReference,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV04.mmTransactionIdentification,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV04.mmProcessingStatus,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV04.mmTransactionDetails,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV04.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return SecuritiesTransactionCancellationRequestStatusAdviceV04.class;
			}
		});
	...
	public SecuritiesTransactionCancellationRequestStatusAdviceV04 setCancellationRequestReference(Identification1 cancellationRequestReference) {
	...
	public SecuritiesTransactionCancellationRequestStatusAdviceV04 setTransactionIdentification(TransactionIdentifications17 transactionIdentification) {
	...
	public SecuritiesTransactionCancellationRequestStatusAdviceV04 setProcessingStatus(ProcessingStatus45Choice processingStatus) {
	...
	public SecuritiesTransactionCancellationRequestStatusAdviceV04 setTransactionDetails(TransactionDetails30 transactionDetails) {
	...
	public SecuritiesTransactionCancellationRequestStatusAdviceV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public SecuritiesTransactionCancellationRequestStatusAdviceV04 messageBody;
	}
}