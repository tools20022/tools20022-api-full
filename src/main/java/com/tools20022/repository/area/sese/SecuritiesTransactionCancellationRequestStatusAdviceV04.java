		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionCancellationRequestStatusAdviceV04.mmCancellationRequestReference, SecuritiesTransactionCancellationRequestStatusAdviceV04.mmTransactionIdentification,
						SecuritiesTransactionCancellationRequestStatusAdviceV04.mmProcessingStatus, SecuritiesTransactionCancellationRequestStatusAdviceV04.mmTransactionDetails,
						SecuritiesTransactionCancellationRequestStatusAdviceV04.mmSupplementaryData);
