		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV02.mmAccountOwner, SecuritiesSettlementConditionsModificationRequestV02.mmSafekeepingAccount,
						SecuritiesSettlementConditionsModificationRequestV02.mmRequestDetails, SecuritiesSettlementConditionsModificationRequestV02.mmAdditionalInformation,
						SecuritiesSettlementConditionsModificationRequestV02.mmSupplementaryData);
