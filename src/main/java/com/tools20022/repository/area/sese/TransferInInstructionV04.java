...
@XmlType(name = "TransferInInstructionV04", propOrder = {"messageIdentification", "poolReference", "previousReference", "relatedReference", "masterReference", "transferDetails", "accountDetails", "settlementDetails", "copyDetails",
		"extension"})
public class TransferInInstructionV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<TransferInInstructionV04, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageIdentification";
			definition = "Reference that uniquely identifies a message from a business application standpoint.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(TransferInInstructionV04 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>> mmPoolReference = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
			definition = "Collective reference identifying a set of messages.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmPoolReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference2> getValue(TransferInInstructionV04 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, Optional<AdditionalReference2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>> mmPreviousReference = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousReference";
			definition = "Reference of the linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmPreviousReference);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>> mmRelatedReference = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<AdditionalReference2>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RelatedReference";
			definition = "Reference to a linked message that was previously received.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmRelatedReference);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<Max35Text>> mmMasterReference = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<Max35Text>>() {
		{
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual transfers as assigned by the instructing party. This identifier links the individual transfers together.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(TransferInInstructionV04 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, List<Transfer21>> mmTransferDetails = new MMMessageBuildingBlock<TransferInInstructionV04, List<Transfer21>>() {
		{
			xmlTag = "TrfDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransferDetails";
			definition = "General information related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmTransferDetails);
			minOccurs = 1;
			complexType_lazy = () -> Transfer21.mmObject();
		}

		@Override
		public List<Transfer21> getValue(TransferInInstructionV04 obj) {
			return obj.getTransferDetails();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, List<Transfer21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, InvestmentAccount22> mmAccountDetails = new MMMessageBuildingBlock<TransferInInstructionV04, InvestmentAccount22>() {
		{
			xmlTag = "AcctDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountDetails";
			definition = "Information related to the account into which the financial instrument is to be received.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmAccountDetails);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InvestmentAccount22 getValue(TransferInInstructionV04 obj) {
			return obj.getAccountDetails();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, InvestmentAccount22 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<DeliverInformation9>> mmSettlementDetails = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<DeliverInformation9>>() {
		{
			xmlTag = "SttlmDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementDetails";
			definition = "Information related to the delivering side of the transfer.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmSettlementDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DeliverInformation9> getValue(TransferInInstructionV04 obj) {
			return obj.getSettlementDetails();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, Optional<DeliverInformation9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, Optional<CopyInformation2>> mmCopyDetails = new MMMessageBuildingBlock<TransferInInstructionV04, Optional<CopyInformation2>>() {
		{
			xmlTag = "CpyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CopyDetails";
			definition = "Information provided when the message is a copy of a previous message.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmCopyDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyInformation2> getValue(TransferInInstructionV04 obj) {
			return obj.getCopyDetails();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, Optional<CopyInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferInInstructionV04, List<Extension1>> mmExtension = new MMMessageBuildingBlock<TransferInInstructionV04, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(TransferInInstructionV05.mmExtension);
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(TransferInInstructionV04 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(TransferInInstructionV04 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return TransferInInstructionV04.class;
			}
		});
	...
	public TransferInInstructionV04 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public TransferInInstructionV04 setPoolReference(AdditionalReference2 poolReference) {
	...
	public TransferInInstructionV04 setPreviousReference(AdditionalReference2 previousReference) {
	...
	public TransferInInstructionV04 setRelatedReference(AdditionalReference2 relatedReference) {
	...
	public TransferInInstructionV04 setMasterReference(Max35Text masterReference) {
	...
	public TransferInInstructionV04 setTransferDetails(List<Transfer21> transferDetails) {
	...
	public TransferInInstructionV04 setAccountDetails(InvestmentAccount22 accountDetails) {
	...
	public TransferInInstructionV04 setSettlementDetails(DeliverInformation9 settlementDetails) {
	...
	public TransferInInstructionV04 setCopyDetails(CopyInformation2 copyDetails) {
	...
	public TransferInInstructionV04 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.005.001.04")
	static public class Document {
		@XmlElement(name = "TrfInInstr", required = true)
		public TransferInInstructionV04 messageBody;
	}
}