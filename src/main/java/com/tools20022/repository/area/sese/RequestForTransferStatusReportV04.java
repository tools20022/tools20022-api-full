 ...
 * {@linkplain com.tools20022.repository.area.sese.RequestForTransferStatusReportV04#identifier
 * RequestForTransferStatusReportV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.MessageIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV05.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock RequestDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.RequestDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV05.RequestDetails);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV05.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.Extension;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV05.Extension);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV04.MessageIdentification,
						com.tools20022.repository.area.sese.RequestForTransferStatusReportV04.RequestDetails, com.tools20022.repository.area.sese.RequestForTransferStatusReportV04.MarketPracticeVersion,
						com.tools20022.repository.area.sese.RequestForTransferStatusReportV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.sese.RequestForTransferStatusReportV04.identifier;
			}
		});
