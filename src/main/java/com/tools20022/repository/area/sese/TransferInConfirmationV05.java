 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV05#MasterReference
 * TransferInConfirmationV05.MasterReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV05#TransferDetails
 * TransferInConfirmationV05.TransferDetails}</li>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV05#AccountDetails
 * TransferInConfirmationV05.AccountDetails}</li>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV05#SettlementDetails
 * TransferInConfirmationV05.SettlementDetails}</li>
 * <li>
 ...
 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV05#identifier
 * TransferInConfirmationV05.identifier}</li>
 * <li>
...
public class TransferInConfirmationV05 {
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.MessageIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.PoolReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.PoolReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			definition = "Reference of the linked message that was previously sent.";
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.PreviousReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.PreviousReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	...
	public static final MMMessageBuildingBlock RelatedReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.RelatedReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.RelatedReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV04#MasterReference
	 * TransferInConfirmationV04.MasterReference}</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock MasterReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.MasterReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.MasterReference);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV04#TransferDetails
	 * TransferInConfirmationV04.TransferDetails}</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock TransferDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.TransferDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.TransferDetails);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.AccountDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.AccountDetails);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.area.sese.TransferInConfirmationV04#SettlementDetails
	 * TransferInConfirmationV04.SettlementDetails}</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock SettlementDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.SettlementDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.SettlementDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.CopyDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.CopyDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV04.Extension;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.Extension);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV05.MessageIdentification, com.tools20022.repository.area.sese.TransferInConfirmationV05.PoolReference,
						...
						com.tools20022.repository.area.sese.TransferInConfirmationV05.MasterReference, com.tools20022.repository.area.sese.TransferInConfirmationV05.TransferDetails,
						com.tools20022.repository.area.sese.TransferInConfirmationV05.AccountDetails, com.tools20022.repository.area.sese.TransferInConfirmationV05.SettlementDetails,
						com.tools20022.repository.area.sese.TransferInConfirmationV05.MarketPracticeVersion, com.tools20022.repository.area.sese.TransferInConfirmationV05.CopyDetails,
						com.tools20022.repository.area.sese.TransferInConfirmationV05.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.sese.TransferInConfirmationV05.identifier;
			}
		});
