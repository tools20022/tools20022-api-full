...
public class SecuritiesSettlementTransactionModificationRequestV06 {
	...
	public static final MMMessageBuildingBlock mmModifiedTransactionDetails = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesSettlementTransactionModificationRequestV06.class.getMethod("getModifiedTransactionDetails", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmUpdateType = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesSettlementTransactionModificationRequestV06.class.getMethod("getUpdateType", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalInstructionDetailsUsageRule.forSecuritiesSettlementTransactionModificationRequestV06,
						com.tools20022.repository.constraints.ConstraintSecuritiesFinancingSettlementUsageRule.forSecuritiesSettlementTransactionModificationRequestV06,
						com.tools20022.repository.constraints.ConstraintLinkagesUsageRule.forSecuritiesSettlementTransactionModificationRequestV06);
