...
import com.tools20022.repository.msg.SecuritiesTradeDetails24;
...
@XmlType(name = "PortfolioTransferNotificationV03", propOrder = {"pagination", "statementGeneralDetails", "accountOwner", "safekeepingAccount", "transferNotificationDetails"})
public class PortfolioTransferNotificationV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferNotificationV03, Pagination> mmPagination = new MMMessageBuildingBlock<PortfolioTransferNotificationV03, Pagination>() {
		{
			xmlTag = "Pgntn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Pagination";
			definition = "Page number of the message (within a statement) and continuation indicator to indicate that the statement is to continue or that the message is the last page of the statement.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferNotificationV04.mmPagination);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Pagination getValue(PortfolioTransferNotificationV03 obj) {
			return obj.getPagination();
		}

		@Override
		public void setValue(PortfolioTransferNotificationV03 obj, Pagination value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferNotificationV03, Statement19> mmStatementGeneralDetails = new MMMessageBuildingBlock<PortfolioTransferNotificationV03, Statement19>() {
		{
			xmlTag = "StmtGnlDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Statement19 getValue(PortfolioTransferNotificationV03 obj) {
			return obj.getStatementGeneralDetails();
		}

		@Override
		public void setValue(PortfolioTransferNotificationV03 obj, Statement19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferNotificationV03, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageBuildingBlock<PortfolioTransferNotificationV03, Optional<PartyIdentification36Choice>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that legally owns the account.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferNotificationV04.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(PortfolioTransferNotificationV03 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(PortfolioTransferNotificationV03 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferNotificationV03, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageBuildingBlock<PortfolioTransferNotificationV03, SecuritiesAccount13>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SafekeepingAccount";
			definition = "Account to or from which a securities entry is made.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferNotificationV04.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesAccount13 getValue(PortfolioTransferNotificationV03 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(PortfolioTransferNotificationV03 obj, SecuritiesAccount13 value) {
			obj.setSafekeepingAccount(value);
		}
	};
	@XmlElement(name = "TrfNtfctnDtls")
	protected List<SecuritiesTradeDetails24> transferNotificationDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferNotificationV03, List<SecuritiesTradeDetails24>> mmTransferNotificationDetails = new MMMessageBuildingBlock<PortfolioTransferNotificationV03, List<SecuritiesTradeDetails24>>() {
		{
			xmlTag = "TrfNtfctnDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransferNotificationDetails";
			definition = "Details of transfer.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferNotificationV04.mmTransferNotificationDetails);
			minOccurs = 0;
			complexType_lazy = () -> SecuritiesTradeDetails24.mmObject();
		}

		@Override
		public List<SecuritiesTradeDetails24> getValue(PortfolioTransferNotificationV03 obj) {
			return obj.getTransferNotificationDetails();
		}

		@Override
		public void setValue(PortfolioTransferNotificationV03 obj, List<SecuritiesTradeDetails24> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return PortfolioTransferNotificationV03.class;
			}
		});
	...
	public PortfolioTransferNotificationV03 setPagination(Pagination pagination) {
	...
	public PortfolioTransferNotificationV03 setStatementGeneralDetails(Statement19 statementGeneralDetails) {
	...
	public PortfolioTransferNotificationV03 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public PortfolioTransferNotificationV03 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
		this.safekeepingAccount = Objects.requireNonNull(safekeepingAccount);
		return this;
	}

	public List<SecuritiesTradeDetails24> getTransferNotificationDetails() {
		return transferNotificationDetails == null ? transferNotificationDetails = new ArrayList<>() : transferNotificationDetails;
	}

	public PortfolioTransferNotificationV03 setTransferNotificationDetails(List<SecuritiesTradeDetails24> transferNotificationDetails) {
	...
	static public class Document {
		...
		public PortfolioTransferNotificationV03 messageBody;
	}
}