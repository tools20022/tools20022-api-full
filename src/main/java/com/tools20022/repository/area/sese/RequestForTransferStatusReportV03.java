 ...
 * messageDefinitionIdentifier} = {@code sese.009.001.03}</li>
 * <li>
...
@XmlType(name = "RequestForTransferStatusReportV03", propOrder = {"messageIdentification", "requestDetails", "extension"})
public class RequestForTransferStatusReportV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestForTransferStatusReportV03, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<RequestForTransferStatusReportV03, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
		...
		@Override
		public MessageIdentification1 getValue(RequestForTransferStatusReportV03 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(RequestForTransferStatusReportV03 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestForTransferStatusReportV03, List<MessageAndBusinessReference6>> mmRequestDetails = new MMMessageBuildingBlock<RequestForTransferStatusReportV03, List<MessageAndBusinessReference6>>() {
		{
			xmlTag = "ReqDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RequestDetails";
		...
		@Override
		public List<MessageAndBusinessReference6> getValue(RequestForTransferStatusReportV03 obj) {
			return obj.getRequestDetails();
		}

		@Override
		public void setValue(RequestForTransferStatusReportV03 obj, List<MessageAndBusinessReference6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestForTransferStatusReportV03, List<Extension1>> mmExtension = new MMMessageBuildingBlock<RequestForTransferStatusReportV03, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(RequestForTransferStatusReportV04.mmExtension);
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(RequestForTransferStatusReportV03 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(RequestForTransferStatusReportV03 obj, List<Extension1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				definition = "Scope\r\nAn instructing party, for example, an investment manager or its authorised representative, sends the RequestForTransferStatusReport to the executing party, for example, a transfer agent to request the status of a previously instructed transfer.\r\nUsage\r\nThe RequestForTransferStatusReport is used to request either:\r\n- the status of one or several transfer instructions or,\r\n- the status of one or several transfer cancellation instructions.";
				nextVersions_lazy = () -> Arrays.asList(RequestForTransferStatusReportV04.mmObject());
				previousVersion_lazy = () -> RequestForTransferStatusReportV02.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "ReqForTrfStsRpt";
				businessArea_lazy = () -> SecuritiesSettlementArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.mmMessageIdentification,
						com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.mmRequestDetails, com.tools20022.repository.area.sese.RequestForTransferStatusReportV03.mmExtension);
			...
			public Class<?> getInstanceClass() {
				return RequestForTransferStatusReportV03.class;
			}
		});
	...
	public RequestForTransferStatusReportV03 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public RequestForTransferStatusReportV03 setRequestDetails(List<MessageAndBusinessReference6> requestDetails) {
	...
	public RequestForTransferStatusReportV03 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.009.001.03")
	static public class Document {
		@XmlElement(name = "ReqForTrfStsRpt", required = true)
		public RequestForTransferStatusReportV03 messageBody;
	}
}