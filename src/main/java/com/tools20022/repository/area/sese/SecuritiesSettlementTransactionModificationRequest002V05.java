...
public class SecuritiesSettlementTransactionModificationRequest002V05 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionModificationRequest002V05.mmModifiedTransactionDetails, SecuritiesSettlementTransactionModificationRequest002V05.mmUpdateType);
	...
	public void setModifiedTransactionDetails(TransactionDetails101 modifiedTransactionDetails) {
