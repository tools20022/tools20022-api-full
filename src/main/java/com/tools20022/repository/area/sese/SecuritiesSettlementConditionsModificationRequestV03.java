...
public class SecuritiesSettlementConditionsModificationRequestV03 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV03.mmAccountOwner, SecuritiesSettlementConditionsModificationRequestV03.mmSafekeepingAccount,
						SecuritiesSettlementConditionsModificationRequestV03.mmRequestDetails, SecuritiesSettlementConditionsModificationRequestV03.mmAdditionalInformation,
						SecuritiesSettlementConditionsModificationRequestV03.mmSupplementaryData);
	...
	public void setRequestDetails(List<RequestDetails8> requestDetails) {
