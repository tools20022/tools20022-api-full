...
public class SecuritiesSettlementTransactionModificationRequestV04 {
	...
	public static final MMMessageBuildingBlock mmModifiedTransactionDetails = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesSettlementTransactionModificationRequestV04.class.getMethod("getModifiedTransactionDetails", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmUpdateType = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesSettlementTransactionModificationRequestV04.class.getMethod("getUpdateType", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalInstructionDetailsUsageRule.forSecuritiesSettlementTransactionModificationRequestV04,
						com.tools20022.repository.constraints.ConstraintSecuritiesFinancingSettlementUsageRule.forSecuritiesSettlementTransactionModificationRequestV04,
						com.tools20022.repository.constraints.ConstraintLinkagesUsageRule.forSecuritiesSettlementTransactionModificationRequestV04);
