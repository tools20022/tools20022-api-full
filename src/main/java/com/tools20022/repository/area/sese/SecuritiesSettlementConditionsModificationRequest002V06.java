		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequest002V06.mmAccountOwner, SecuritiesSettlementConditionsModificationRequest002V06.mmSafekeepingAccount,
						SecuritiesSettlementConditionsModificationRequest002V06.mmRequestDetails, SecuritiesSettlementConditionsModificationRequest002V06.mmAdditionalInformation,
						SecuritiesSettlementConditionsModificationRequest002V06.mmSupplementaryData);
