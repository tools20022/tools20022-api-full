 ...
 * messageDefinitionIdentifier} = {@code sese.012.001.04}</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getConstraint
 * constraint} =
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNomineeAccountServicerRule#for_sese_PortfolioTransferInstructionV04
 * ConstraintNomineeAccountServicerRule.for_sese_PortfolioTransferInstructionV04
 * }</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintInvestorRule#for_sese_PortfolioTransferInstructionV04
 * ConstraintInvestorRule.for_sese_PortfolioTransferInstructionV04}</li>
 * <li>
...
@XmlType(name = "PortfolioTransferInstructionV04", propOrder = {"messageReference", "poolReference", "previousReference", "relatedReference", "primaryIndividualInvestor", "secondaryIndividualInvestor", "otherIndividualInvestor",
...
public class PortfolioTransferInstructionV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, MessageIdentification1> mmMessageReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, MessageIdentification1>() {
		{
			xmlTag = "MsgRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageReference";
			definition = "Identifies the message.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmMessageReference);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getMessageReference();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
			definition = "Collective reference identifying a set of messages.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmPoolReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference3> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>> mmPreviousReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousReference";
			definition = "Reference to a linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmPreviousReference);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>> mmRelatedReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<AdditionalReference3>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RelatedReference";
			definition = "Reference to a linked message that was previously received.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmRelatedReference);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<IndividualPerson8>> mmPrimaryIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<IndividualPerson8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmPrimaryIndividualInvestor);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<IndividualPerson8> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getPrimaryIndividualInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Optional<IndividualPerson8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<IndividualPerson8>> mmSecondaryIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<IndividualPerson8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmSecondaryIndividualInvestor);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> IndividualPerson8.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<IndividualPerson8>> mmOtherIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<IndividualPerson8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmOtherIndividualInvestor);
			minOccurs = 0;
			complexType_lazy = () -> IndividualPerson8.mmObject();
		}

		@Override
		public List<IndividualPerson8> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getOtherIndividualInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, List<IndividualPerson8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Organisation4>> mmPrimaryCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Organisation4>>() {
		{
			xmlTag = "PmryCorpInvstr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PrimaryCorporateInvestor";
			definition = "Information identifying the primary corporate investor, eg, name and address.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmPrimaryCorporateInvestor);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Organisation4> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getPrimaryCorporateInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Optional<Organisation4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Organisation4>> mmSecondaryCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Organisation4>>() {
		{
			xmlTag = "ScndryCorpInvstr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecondaryCorporateInvestor";
			definition = "Information identifying the secondary corporate investor, eg, name and address.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmSecondaryCorporateInvestor);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> Organisation4.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<Organisation4>> mmOtherCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<Organisation4>>() {
		{
			xmlTag = "OthrCorpInvstr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OtherCorporateInvestor";
			definition = "Information identifying the other corporate investors, eg, name and address.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmOtherCorporateInvestor);
			minOccurs = 0;
			complexType_lazy = () -> Organisation4.mmObject();
		}

		@Override
		public List<Organisation4> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getOtherCorporateInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, List<Organisation4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Account5> mmTransferorAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Account5>() {
		{
			xmlTag = "TrfrAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransferorAccount";
			definition = "Identification of an account owned by the investor at the old plan manager (account servicer).";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmTransferorAccount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Account5 getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getTransferorAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Account5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Account6>> mmNomineeAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<Account6>>() {
		{
			xmlTag = "NmneeAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NomineeAccount";
			definition = "Account held in the name of a party that is not the name of the beneficial owner of the shares.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmNomineeAccount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Account6> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getNomineeAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Optional<Account6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, PartyIdentification2Choice> mmTransferee = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, PartyIdentification2Choice>() {
		{
			xmlTag = "Trfee";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Transferee";
			definition = "Information related to the institution to which the financial instrument is to be transferred.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmTransferee);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PartyIdentification2Choice getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getTransferee();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, PartyIdentification2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<CashAccount11>> mmCashAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, Optional<CashAccount11>>() {
		{
			xmlTag = "CshAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CashAccount";
			...
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmCashAccount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CashAccount11> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, Optional<CashAccount11> value) {
			obj.setCashAccount(value.orElse(null));
		}
	};
	@XmlElement(name = "PdctTrf", required = true)
	protected List<ISATransfer7> productTransfer;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageBuildingBlock#getComplexType
	 * complexType} = {@linkplain com.tools20022.repository.msg.ISATransfer7
	 * ISATransfer7}</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageConstruct#getXmlTag
	 * xmlTag} = "PdctTrf"</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<ISATransfer7>> mmProductTransfer = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<ISATransfer7>>() {
		{
			xmlTag = "PdctTrf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ProductTransfer";
			definition = "Provides information related to the asset(s) transferred.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmProductTransfer);
			minOccurs = 1;
			complexType_lazy = () -> ISATransfer7.mmObject();
		}

		@Override
		public List<ISATransfer7> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getProductTransfer();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, List<ISATransfer7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<Extension1>> mmExtension = new MMMessageBuildingBlock<PortfolioTransferInstructionV04, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmExtension);
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(PortfolioTransferInstructionV04 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV04 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNomineeAccountServicerRule.for_sese_PortfolioTransferInstructionV04,
						com.tools20022.repository.constraints.ConstraintPorfolioRule.for_sese_PortfolioTransferInstructionV04, com.tools20022.repository.constraints.ConstraintInvestorRule.for_sese_PortfolioTransferInstructionV04,
						com.tools20022.repository.constraints.ConstraintCorporateRule.for_sese_PortfolioTransferInstructionV04);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PortfolioTransferInstructionV04";
				definition = "Scope\r\nAn instructing party, for example, a (new) plan manager (Transferee), sends the PortfolioTransferInstruction message to the executing party, for example, a (old) plan manager (Transferor), on behalf of the initiating party, for example, an investor (client), to instruct the transfer of financial instruments from the clients account at the old plan manager (Transferor) to the clients account at the new plan manager (Transferee) through a nominee account.\r\nUsage\r\nThe PortfolioTransferInstruction message is used to instruct the withdrawal of one or more ISA or portfolio products from one account and deliver them to another account.\r\nThe PortfolioTransferInstruction message is used to instruct one or more transfers for one client. Each transfer is for delivery to the same account. The account may be owned by one or more individual investors or one or more corporate investors. Each transfer is identified in TransferIdentification.\r\nIf the instructing party does not have enough information to instruct the transfer, then it must first send a AccountHoldingInformationRequest message to the executing party in order to receive a AccountHoldingInformation message.";
				nextVersions_lazy = () -> Arrays.asList(PortfolioTransferInstructionV05.mmObject());
				previousVersion_lazy = () -> PortfolioTransferInstructionV03.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "PrtflTrfInstr";
				businessArea_lazy = () -> SecuritiesSettlementArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmMessageReference, com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmPoolReference,
						...
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmOtherIndividualInvestor, com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmPrimaryCorporateInvestor,
						...
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmTransferorAccount, com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmNomineeAccount,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmTransferee, com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmCashAccount,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmProductTransfer, com.tools20022.repository.area.sese.PortfolioTransferInstructionV04.mmExtension);
			...
			public Class<?> getInstanceClass() {
				return PortfolioTransferInstructionV04.class;
			}
		});
	...
	public PortfolioTransferInstructionV04 setMessageReference(MessageIdentification1 messageReference) {
	...
	public PortfolioTransferInstructionV04 setPoolReference(AdditionalReference3 poolReference) {
	...
	public PortfolioTransferInstructionV04 setPreviousReference(AdditionalReference3 previousReference) {
	...
	public PortfolioTransferInstructionV04 setRelatedReference(AdditionalReference3 relatedReference) {
	...
	public PortfolioTransferInstructionV04 setPrimaryIndividualInvestor(IndividualPerson8 primaryIndividualInvestor) {
	...
	public PortfolioTransferInstructionV04 setSecondaryIndividualInvestor(IndividualPerson8 secondaryIndividualInvestor) {
	...
	public PortfolioTransferInstructionV04 setOtherIndividualInvestor(List<IndividualPerson8> otherIndividualInvestor) {
	...
	public PortfolioTransferInstructionV04 setPrimaryCorporateInvestor(Organisation4 primaryCorporateInvestor) {
	...
	public PortfolioTransferInstructionV04 setSecondaryCorporateInvestor(Organisation4 secondaryCorporateInvestor) {
	...
	public PortfolioTransferInstructionV04 setOtherCorporateInvestor(List<Organisation4> otherCorporateInvestor) {
	...
	public PortfolioTransferInstructionV04 setTransferorAccount(Account5 transferorAccount) {
	...
	public PortfolioTransferInstructionV04 setNomineeAccount(Account6 nomineeAccount) {
	...
	public PortfolioTransferInstructionV04 setTransferee(PartyIdentification2Choice transferee) {
	...
	public PortfolioTransferInstructionV04 setCashAccount(CashAccount11 cashAccount) {
		this.cashAccount = cashAccount;
		return this;
	}

	public List<ISATransfer7> getProductTransfer() {
		return productTransfer == null ? productTransfer = new ArrayList<>() : productTransfer;
	}

	public PortfolioTransferInstructionV04 setProductTransfer(List<ISATransfer7> productTransfer) {
	...
	public PortfolioTransferInstructionV04 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.012.001.04")
	static public class Document {
		@XmlElement(name = "PrtflTrfInstr", required = true)
		public PortfolioTransferInstructionV04 messageBody;
	}
}