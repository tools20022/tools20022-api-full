		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmModificationRequestReference,
						SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmAccountOwner, SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmSafekeepingAccount,
						SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmTransactionIdentification, SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmModificationProcessingStatus,
						SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmTransactionDetails, SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmSupplementaryData);
