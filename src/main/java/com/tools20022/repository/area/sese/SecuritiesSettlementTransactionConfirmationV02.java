...
public class SecuritiesSettlementTransactionConfirmationV02 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmationV02.mmTransactionIdentificationDetails, SecuritiesSettlementTransactionConfirmationV02.mmAdditionalParameters,
						SecuritiesSettlementTransactionConfirmationV02.mmTradeDetails, SecuritiesSettlementTransactionConfirmationV02.mmFinancialInstrumentIdentification,
						SecuritiesSettlementTransactionConfirmationV02.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionConfirmationV02.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionConfirmationV02.mmSettlementParameters, SecuritiesSettlementTransactionConfirmationV02.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionConfirmationV02.mmDeliveringSettlementParties, SecuritiesSettlementTransactionConfirmationV02.mmReceivingSettlementParties,
						SecuritiesSettlementTransactionConfirmationV02.mmCashParties, SecuritiesSettlementTransactionConfirmationV02.mmSettledAmount, SecuritiesSettlementTransactionConfirmationV02.mmOtherAmounts,
						SecuritiesSettlementTransactionConfirmationV02.mmOtherBusinessParties, SecuritiesSettlementTransactionConfirmationV02.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionConfirmationV02.mmSupplementaryData);
	...
	public void setTransactionIdentificationDetails(SettlementTypeAndIdentification9 transactionIdentificationDetails) {
	...
	public void setQuantityAndAccountDetails(QuantityAndAccount15 quantityAndAccountDetails) {
	...
	public OtherAmounts9 getOtherAmounts() {
		return otherAmounts;
	}

	public void setOtherAmounts(OtherAmounts9 otherAmounts) {
