		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionInstructionV06.mmTransactionIdentification, SecuritiesSettlementTransactionInstructionV06.mmSettlementTypeAndAdditionalParameters,
						SecuritiesSettlementTransactionInstructionV06.mmNumberCounts, SecuritiesSettlementTransactionInstructionV06.mmLinkages, SecuritiesSettlementTransactionInstructionV06.mmTradeDetails,
						SecuritiesSettlementTransactionInstructionV06.mmFinancialInstrumentIdentification, SecuritiesSettlementTransactionInstructionV06.mmFinancialInstrumentAttributes,
						SecuritiesSettlementTransactionInstructionV06.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionInstructionV06.mmSettlementParameters,
						SecuritiesSettlementTransactionInstructionV06.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionInstructionV06.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionInstructionV06.mmReceivingSettlementParties, SecuritiesSettlementTransactionInstructionV06.mmCashParties, SecuritiesSettlementTransactionInstructionV06.mmSettlementAmount,
						SecuritiesSettlementTransactionInstructionV06.mmOtherAmounts, SecuritiesSettlementTransactionInstructionV06.mmOtherBusinessParties,
						SecuritiesSettlementTransactionInstructionV06.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionInstructionV06.mmSupplementaryData);
