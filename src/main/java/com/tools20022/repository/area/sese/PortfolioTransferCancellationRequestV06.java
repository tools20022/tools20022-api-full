 ...
 * {@linkplain com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06#identifier
 * PortfolioTransferCancellationRequestV06.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.MessageReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.MessageReference);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.PoolReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.PoolReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.PreviousReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.PreviousReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	...
	public static final MMMessageBuildingBlock RelatedReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.RelatedReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.RelatedReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	...
	public static final MMMessageBuildingBlock Cancellation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.Cancellation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.Cancellation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV05.MarketPracticeVersion;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV07.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.MessageReference,
						...
						com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.RelatedReference, com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.Cancellation,
						com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.MarketPracticeVersion);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.identifier;
			}
		});
