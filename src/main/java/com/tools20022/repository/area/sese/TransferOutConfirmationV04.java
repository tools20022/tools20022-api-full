 ...
 * {@linkplain com.tools20022.repository.area.sese.TransferOutConfirmationV04#identifier
 * TransferOutConfirmationV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.PoolReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			definition = "Reference of the linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.PreviousReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	...
	public static final MMMessageBuildingBlock RelatedReference = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.RelatedReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference2.mmObject();
		}
	...
	public static final MMMessageBuildingBlock MasterReference = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.MasterReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock TransferDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.TransferDetails);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.AccountDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SettlementDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.SettlementDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.CopyDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV05.Extension);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV04.MessageIdentification, com.tools20022.repository.area.sese.TransferOutConfirmationV04.PoolReference,
						...
						com.tools20022.repository.area.sese.TransferOutConfirmationV04.MasterReference, com.tools20022.repository.area.sese.TransferOutConfirmationV04.TransferDetails,
						com.tools20022.repository.area.sese.TransferOutConfirmationV04.AccountDetails, com.tools20022.repository.area.sese.TransferOutConfirmationV04.SettlementDetails,
						com.tools20022.repository.area.sese.TransferOutConfirmationV04.CopyDetails, com.tools20022.repository.area.sese.TransferOutConfirmationV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.sese.TransferOutConfirmationV04.identifier;
			}
		});
