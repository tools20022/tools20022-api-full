 ...
 * {@linkplain com.tools20022.repository.area.sese.TransferOutCancellationRequestV05#identifier
 * TransferOutCancellationRequestV05.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferOutCancellationRequestV04.MessageIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV06.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock References = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferOutCancellationRequestV04.References;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV06.References);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock Cancellation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferOutCancellationRequestV04.Cancellation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV06.Cancellation);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV06.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.sese.TransferOutCancellationRequestV04.CopyDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV06.CopyDetails);
			minOccurs = 0;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.MessageIdentification, com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.References,
						com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.Cancellation, com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.MarketPracticeVersion,
						com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.CopyDetails);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.identifier;
			}
		});
