		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmAccountOwner, SecuritiesSettlementConditionsModificationRequestV07.mmSafekeepingAccount,
						SecuritiesSettlementConditionsModificationRequestV07.mmRequestDetails, SecuritiesSettlementConditionsModificationRequestV07.mmAdditionalInformation,
