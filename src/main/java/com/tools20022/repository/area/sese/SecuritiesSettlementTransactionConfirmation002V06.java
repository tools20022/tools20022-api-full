...
public class SecuritiesSettlementTransactionConfirmation002V06 {
	...
	public AdditionalParameters27 getAdditionalParameters() {
		return additionalParameters;
	}

	public void setAdditionalParameters(AdditionalParameters27 additionalParameters) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:sese.025.06.06")
