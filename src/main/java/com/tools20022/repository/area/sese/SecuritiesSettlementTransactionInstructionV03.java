		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionInstructionV03.mmTransactionIdentification, SecuritiesSettlementTransactionInstructionV03.mmSettlementTypeAndAdditionalParameters,
						SecuritiesSettlementTransactionInstructionV03.mmNumberCounts, SecuritiesSettlementTransactionInstructionV03.mmLinkages, SecuritiesSettlementTransactionInstructionV03.mmTradeDetails,
						SecuritiesSettlementTransactionInstructionV03.mmFinancialInstrumentIdentification, SecuritiesSettlementTransactionInstructionV03.mmFinancialInstrumentAttributes,
						SecuritiesSettlementTransactionInstructionV03.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionInstructionV03.mmSettlementParameters,
						SecuritiesSettlementTransactionInstructionV03.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionInstructionV03.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionInstructionV03.mmReceivingSettlementParties, SecuritiesSettlementTransactionInstructionV03.mmCashParties, SecuritiesSettlementTransactionInstructionV03.mmSettlementAmount,
						SecuritiesSettlementTransactionInstructionV03.mmOtherAmounts, SecuritiesSettlementTransactionInstructionV03.mmOtherBusinessParties,
						SecuritiesSettlementTransactionInstructionV03.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionInstructionV03.mmSupplementaryData);
