...
public class SecuritiesSettlementConditionsModificationRequestV06 {
	...
	public void setAdditionalInformation(List<AdditionalInformation11> additionalInformation) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:sese.030.06.06")
