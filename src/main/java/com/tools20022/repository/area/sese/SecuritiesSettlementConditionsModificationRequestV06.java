 ...
 * SecuritiesSettlementConditionsModificationRequestV06.mmSafekeepingAccount}</li>
 * <li>
 ...
 * SecuritiesSettlementConditionsModificationRequestV06.mmAdditionalInformation}
 * </li>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06#mmSupplementaryData
 * SecuritiesSettlementConditionsModificationRequestV06.mmSupplementaryData}</li>
 * </ul>
 * </li>
 ...
 * messageDefinitionIdentifier} = {@code sese.030.001.06}</li>
...
@XmlType(name = "SecuritiesSettlementConditionsModificationRequestV06", propOrder = {"accountOwner", "safekeepingAccount", "requestDetails", "additionalInformation", "supplementaryData"})
public class SecuritiesSettlementConditionsModificationRequestV06 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, Optional<PartyIdentification98>> mmAccountOwner = new MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, Optional<PartyIdentification98>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that legally owns the account.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmAccountOwner);
			previousVersion_lazy = () -> SecuritiesSettlementConditionsModificationRequestV05.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyIdentification98> getValue(SecuritiesSettlementConditionsModificationRequestV06 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(SecuritiesSettlementConditionsModificationRequestV06 obj, Optional<PartyIdentification98> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, SecuritiesAccount19> mmSafekeepingAccount = new MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, SecuritiesAccount19>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SafekeepingAccount";
			definition = "Account to or from which a securities entry is made.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmSafekeepingAccount);
			previousVersion_lazy = () -> SecuritiesSettlementConditionsModificationRequestV05.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesAccount19 getValue(SecuritiesSettlementConditionsModificationRequestV06 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(SecuritiesSettlementConditionsModificationRequestV06 obj, SecuritiesAccount19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<RequestDetails15>> mmRequestDetails = new MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<RequestDetails15>>() {
		{
			xmlTag = "ReqDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RequestDetails";
			definition = "Details of the request.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmRequestDetails);
			previousVersion_lazy = () -> SecuritiesSettlementConditionsModificationRequestV05.mmRequestDetails;
			minOccurs = 1;
			complexType_lazy = () -> RequestDetails15.mmObject();
		}

		@Override
		public List<RequestDetails15> getValue(SecuritiesSettlementConditionsModificationRequestV06 obj) {
			return obj.getRequestDetails();
		}

		@Override
		public void setValue(SecuritiesSettlementConditionsModificationRequestV06 obj, List<RequestDetails15> value) {
			obj.setRequestDetails(value);
		}
	};
	@XmlElement(name = "AddtlInf")
	protected List<AdditionalInformation11> additionalInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<AdditionalInformation11>> mmAdditionalInformation = new MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<AdditionalInformation11>>() {
		{
			xmlTag = "AddtlInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AdditionalInformation";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmAdditionalInformation);
			previousVersion_lazy = () -> SecuritiesSettlementConditionsModificationRequestV05.mmAdditionalInformation;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalInformation11.mmObject();
		}

		@Override
		public List<AdditionalInformation11> getValue(SecuritiesSettlementConditionsModificationRequestV06 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(SecuritiesSettlementConditionsModificationRequestV06 obj, List<AdditionalInformation11> value) {
	 ...
	 * SecuritiesSettlementConditionsModificationRequestV07.mmSupplementaryData}
	 * </li>
	 * </ul>
	 * </li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<SecuritiesSettlementConditionsModificationRequestV06, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionsModificationRequestV07.mmSupplementaryData);
			previousVersion_lazy = () -> SecuritiesSettlementConditionsModificationRequestV05.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(SecuritiesSettlementConditionsModificationRequestV06 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(SecuritiesSettlementConditionsModificationRequestV06 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSecuritiesMarketPracticeGroupGuideline.for_sese_SecuritiesSettlementConditionsModificationRequestV06);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06.mmAccountOwner,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06.mmSafekeepingAccount,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06.mmRequestDetails,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06.mmAdditionalInformation,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionsModificationRequestV06.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return SecuritiesSettlementConditionsModificationRequestV06.class;
			}
		});
	...
	public SecuritiesSettlementConditionsModificationRequestV06 setAccountOwner(PartyIdentification98 accountOwner) {
	...
	public SecuritiesSettlementConditionsModificationRequestV06 setSafekeepingAccount(SecuritiesAccount19 safekeepingAccount) {
	...
	public SecuritiesSettlementConditionsModificationRequestV06 setRequestDetails(List<RequestDetails15> requestDetails) {
		this.requestDetails = Objects.requireNonNull(requestDetails);
		return this;
	}

	public List<AdditionalInformation11> getAdditionalInformation() {
		return additionalInformation == null ? additionalInformation = new ArrayList<>() : additionalInformation;
	}

	public SecuritiesSettlementConditionsModificationRequestV06 setAdditionalInformation(List<AdditionalInformation11> additionalInformation) {
	...
	public SecuritiesSettlementConditionsModificationRequestV06 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public SecuritiesSettlementConditionsModificationRequestV06 messageBody;
	}
}