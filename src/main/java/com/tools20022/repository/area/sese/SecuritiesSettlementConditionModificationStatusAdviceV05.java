		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV05.mmRequestReference, SecuritiesSettlementConditionModificationStatusAdviceV05.mmAccountOwner,
						SecuritiesSettlementConditionModificationStatusAdviceV05.mmSafekeepingAccount, SecuritiesSettlementConditionModificationStatusAdviceV05.mmRequestDetails,
						SecuritiesSettlementConditionModificationStatusAdviceV05.mmProcessingStatus, SecuritiesSettlementConditionModificationStatusAdviceV05.mmSupplementaryData);
