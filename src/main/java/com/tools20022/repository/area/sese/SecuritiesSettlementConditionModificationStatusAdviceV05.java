 ...
 * SecuritiesSettlementConditionModificationStatusAdviceV05.mmSupplementaryData}
 * </li>
 * </ul>
 * </li>
 ...
 * messageDefinitionIdentifier} = {@code sese.031.001.05}</li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#for_sese_SecuritiesSettlementConditionModificationStatusAdviceV05
...
@XmlType(name = "SecuritiesSettlementConditionModificationStatusAdviceV05", propOrder = {"requestReference", "accountOwner", "safekeepingAccount", "requestDetails", "processingStatus", "supplementaryData"})
public class SecuritiesSettlementConditionModificationStatusAdviceV05 {
	 ...
	 * SecuritiesSettlementConditionModificationStatusAdviceV04.
	 * mmRequestReference}</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Identification1> mmRequestReference = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Identification1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmRequestReference);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmRequestReference;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmAccountOwner);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<SecuritiesAccount13>> mmSafekeepingAccount = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<SecuritiesAccount13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmSafekeepingAccount);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * SecuritiesSettlementConditionModificationStatusAdviceV04.mmRequestDetails
	 * }</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<RequestDetails13>> mmRequestDetails = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, Optional<RequestDetails13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmRequestDetails);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmRequestDetails;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, ProcessingStatus18Choice> mmProcessingStatus = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, ProcessingStatus18Choice>() {
		{
			...
			definition = "Provides details on the processing status of the request.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmProcessingStatus);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmProcessingStatus;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<SecuritiesSettlementConditionModificationStatusAdviceV05, List<SupplementaryData1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmSupplementaryData);
			previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmSupplementaryData;
			minOccurs = 0;
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetXRule.for_sese_SecuritiesSettlementConditionModificationStatusAdviceV05,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.for_sese_SecuritiesSettlementConditionModificationStatusAdviceV05);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesSettlementConditionModificationStatusAdviceV05";
				definition = "Scope\nAn account servicer sends a SecuritiesSettlementConditionsModificationStatusAdvice to an account owner to advise the status of a modification request previously instructed by the account owner.\nThe account servicer/owner relationship may be:\n- a central securities depository or another settlement market infrastructure acting on behalf of their participants\n- an agent (sub-custodian) acting on behalf of their global custodian customer, or\n- a custodian acting on behalf of an investment management institution or a broker/dealer.\n\nUsage\nA SecuritiesSettlementConditionsModificationRequest may contain requests on multiple transactions. However, one SecuritiesSettlementConditionsModificationStatusAdvice must be sent per transaction modified unless the SecuritiesSettlementConditionsModificationRequest is rejected as a whole.\nThe message may also be used to:\n- re-send a message previously sent,\n- provide a third party with a copy of a message for information,\n- re-send to a third party a copy of a message for information\nusing the relevant elements in the Business Application Header.\n\nISO 15022 - 20022 Coexistence\nThis ISO 20022 message is reversed engineered from ISO 15022. Both standards will coexist for a certain number of years. Until this coexistence period ends, the usage of certain data types is restricted to ensure interoperability between ISO 15022 and 20022 users. Compliance to these rules is mandatory in a coexistence environment. The coexistence restrictions are described in a Textual Rule linked to the Message Items they concern. These coexistence textual rules are clearly identified as follows: “CoexistenceXxxxRule”.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesSettlementConditionModificationStatusAdviceV06.mmObject());
				previousVersion_lazy = () -> SecuritiesSettlementConditionModificationStatusAdviceV04.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "SctiesSttlmCondModStsAdvc";
				businessArea_lazy = () -> SecuritiesSettlementArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmRequestReference,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmAccountOwner,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmSafekeepingAccount,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmRequestDetails,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmProcessingStatus,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return SecuritiesSettlementConditionModificationStatusAdviceV05.class;
			}
		});
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setRequestReference(Identification1 requestReference) {
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setRequestDetails(RequestDetails13 requestDetails) {
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setProcessingStatus(ProcessingStatus18Choice processingStatus) {
	...
	public SecuritiesSettlementConditionModificationStatusAdviceV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public SecuritiesSettlementConditionModificationStatusAdviceV05 messageBody;
	}
}