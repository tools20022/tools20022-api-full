 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalInstructionDetailsUsageRule#for_sese_SecuritiesSettlementTransactionModificationRequest002V04
 * ConstraintPhysicalInstructionDetailsUsageRule.
 * for_sese_SecuritiesSettlementTransactionModificationRequest002V04}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSecuritiesFinancingSettlementUsageRule#for_sese_SecuritiesSettlementTransactionModificationRequest002V04
 * ConstraintSecuritiesFinancingSettlementUsageRule.
 * for_sese_SecuritiesSettlementTransactionModificationRequest002V04}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintLinkagesUsageRule#for_sese_SecuritiesSettlementTransactionModificationRequest002V04
...
public class SecuritiesSettlementTransactionModificationRequest002V04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementTransactionModificationRequest002V04, TransactionDetails85> mmModifiedTransactionDetails = new MMMessageBuildingBlock<SecuritiesSettlementTransactionModificationRequest002V04, TransactionDetails85>() {
		{
			xmlTag = "ModfdTxDtls";
		...
		@Override
		public TransactionDetails85 getValue(SecuritiesSettlementTransactionModificationRequest002V04 obj) {
			return obj.getModifiedTransactionDetails();
		}

		@Override
		public void setValue(SecuritiesSettlementTransactionModificationRequest002V04 obj, TransactionDetails85 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesSettlementTransactionModificationRequest002V04, List<UpdateType22Choice>> mmUpdateType = new MMMessageBuildingBlock<SecuritiesSettlementTransactionModificationRequest002V04, List<UpdateType22Choice>>() {
		{
			xmlTag = "UpdTp";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "UpdateType";
		...
		@Override
		public List<UpdateType22Choice> getValue(SecuritiesSettlementTransactionModificationRequest002V04 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(SecuritiesSettlementTransactionModificationRequest002V04 obj, List<UpdateType22Choice> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalInstructionDetailsUsageRule.for_sese_SecuritiesSettlementTransactionModificationRequest002V04,
						com.tools20022.repository.constraints.ConstraintSecuritiesFinancingSettlementUsageRule.for_sese_SecuritiesSettlementTransactionModificationRequest002V04,
						com.tools20022.repository.constraints.ConstraintLinkagesUsageRule.for_sese_SecuritiesSettlementTransactionModificationRequest002V04);
