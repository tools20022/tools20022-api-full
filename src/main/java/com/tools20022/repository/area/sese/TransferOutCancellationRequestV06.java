...
@XmlType(name = "TransferOutCancellationRequestV06", propOrder = {"messageIdentification", "references", "cancellation", "marketPracticeVersion", "copyDetails"})
public class TransferOutCancellationRequestV06 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferOutCancellationRequestV06, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<TransferOutCancellationRequestV06, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageIdentification";
			definition = "Reference that uniquely identifies a message from a business application standpoint.";
			nextVersions_lazy = () -> Arrays.asList(TransferOutCancellationRequestV07.mmMessageIdentification);
			previousVersion_lazy = () -> TransferOutCancellationRequestV05.mmMessageIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(TransferOutCancellationRequestV06 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(TransferOutCancellationRequestV06 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferOutCancellationRequestV06, List<References15>> mmReferences = new MMMessageBuildingBlock<TransferOutCancellationRequestV06, List<References15>>() {
		{
			xmlTag = "Refs";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "References";
			...
			nextVersions_lazy = () -> Arrays.asList(TransferOutCancellationRequestV07.mmReferences);
			previousVersion_lazy = () -> TransferOutCancellationRequestV05.mmReferences;
			minOccurs = 0;
			complexType_lazy = () -> References15.mmObject();
		}

		@Override
		public List<References15> getValue(TransferOutCancellationRequestV06 obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(TransferOutCancellationRequestV06 obj, List<References15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferOutCancellationRequestV06, List<Cancellation8Choice>> mmCancellation = new MMMessageBuildingBlock<TransferOutCancellationRequestV06, List<Cancellation8Choice>>() {
		{
			xmlTag = "Cxl";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Cancellation";
			definition = "Choice between cancellation by reference or by transfer details.";
			nextVersions_lazy = () -> Arrays.asList(TransferOutCancellationRequestV07.mmCancellation);
			previousVersion_lazy = () -> TransferOutCancellationRequestV05.mmCancellation;
			minOccurs = 1;
			complexType_lazy = () -> Cancellation8Choice.mmObject();
		}

		@Override
		public List<Cancellation8Choice> getValue(TransferOutCancellationRequestV06 obj) {
			return obj.getCancellation();
		}

		@Override
		public void setValue(TransferOutCancellationRequestV06 obj, List<Cancellation8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferOutCancellationRequestV06, Optional<MarketPracticeVersion1>> mmMarketPracticeVersion = new MMMessageBuildingBlock<TransferOutCancellationRequestV06, Optional<MarketPracticeVersion1>>() {
		{
			xmlTag = "MktPrctcVrsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MarketPracticeVersion";
			definition = "Identifies the market practice to which the message conforms.";
			nextVersions_lazy = () -> Arrays.asList(TransferOutCancellationRequestV07.mmMarketPracticeVersion);
			previousVersion_lazy = () -> TransferOutCancellationRequestV05.mmMarketPracticeVersion;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<MarketPracticeVersion1> getValue(TransferOutCancellationRequestV06 obj) {
			return obj.getMarketPracticeVersion();
		}

		@Override
		public void setValue(TransferOutCancellationRequestV06 obj, Optional<MarketPracticeVersion1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<TransferOutCancellationRequestV06, Optional<CopyInformation2>> mmCopyDetails = new MMMessageBuildingBlock<TransferOutCancellationRequestV06, Optional<CopyInformation2>>() {
		{
			xmlTag = "CpyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CopyDetails";
			definition = "Information provided when the message is a copy of a previous message.";
			nextVersions_lazy = () -> Arrays.asList(TransferOutCancellationRequestV07.mmCopyDetails);
			previousVersion_lazy = () -> TransferOutCancellationRequestV05.mmCopyDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyInformation2> getValue(TransferOutCancellationRequestV06 obj) {
			return obj.getCopyDetails();
		}

		@Override
		public void setValue(TransferOutCancellationRequestV06 obj, Optional<CopyInformation2> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return TransferOutCancellationRequestV06.class;
			}
		});
	...
	public TransferOutCancellationRequestV06 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public TransferOutCancellationRequestV06 setReferences(List<References15> references) {
	...
	public TransferOutCancellationRequestV06 setCancellation(List<Cancellation8Choice> cancellation) {
	...
	public TransferOutCancellationRequestV06 setMarketPracticeVersion(MarketPracticeVersion1 marketPracticeVersion) {
	...
	public TransferOutCancellationRequestV06 setCopyDetails(CopyInformation2 copyDetails) {
		this.copyDetails = copyDetails;
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:sese.002.001.06")
	static public class Document {
		@XmlElement(name = "TrfOutCxlReq", required = true)
		public TransferOutCancellationRequestV06 messageBody;
	}
}