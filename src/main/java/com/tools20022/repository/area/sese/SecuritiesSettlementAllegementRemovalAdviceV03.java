		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementAllegementRemovalAdviceV03.mmAccountServicerTransactionIdentification,
						SecuritiesSettlementAllegementRemovalAdviceV03.mmMarketInfrastructureTransactionIdentification, SecuritiesSettlementAllegementRemovalAdviceV03.mmAccountOwner,
						SecuritiesSettlementAllegementRemovalAdviceV03.mmSafekeepingAccount, SecuritiesSettlementAllegementRemovalAdviceV03.mmTransactionDetails, SecuritiesSettlementAllegementRemovalAdviceV03.mmSupplementaryData);
