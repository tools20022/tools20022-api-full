 ...
 * messageDefinitionIdentifier} = {@code sese.021.002.04}</li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.SecuritiesTransactionStatusQuery002V04#mmSupplementaryData
 * SecuritiesTransactionStatusQuery002V04.mmSupplementaryData}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SecuritiesTransactionStatusQuery002V04", propOrder = {"statusAdviceRequested", "accountOwner", "safekeepingAccount", "supplementaryData"})
public class SecuritiesTransactionStatusQuery002V04 {

	final static private AtomicReference<MMMessageDefinition> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "StsAdvcReqd", required = true)
	protected DocumentNumber15 statusAdviceRequested;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, DocumentNumber15> mmStatusAdviceRequested = new MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, DocumentNumber15>() {
		{
			xmlTag = "StsAdvcReqd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> DocumentNumber15.mmObject();
		}

		@Override
		public DocumentNumber15 getValue(SecuritiesTransactionStatusQuery002V04 obj) {
			return obj.getStatusAdviceRequested();
		}

		@Override
		public void setValue(SecuritiesTransactionStatusQuery002V04 obj, DocumentNumber15 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, Optional<PartyIdentification109>> mmAccountOwner = new MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, Optional<PartyIdentification109>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
		...
		@Override
		public Optional<PartyIdentification109> getValue(SecuritiesTransactionStatusQuery002V04 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(SecuritiesTransactionStatusQuery002V04 obj, Optional<PartyIdentification109> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, SecuritiesAccount27> mmSafekeepingAccount = new MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, SecuritiesAccount27>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SecuritiesAccount27 getValue(SecuritiesTransactionStatusQuery002V04 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(SecuritiesTransactionStatusQuery002V04 obj, SecuritiesAccount27 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<SecuritiesTransactionStatusQuery002V04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(SecuritiesTransactionStatusQuery002V04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(SecuritiesTransactionStatusQuery002V04 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				name = "SecuritiesTransactionStatusQuery002V04";
				definition = "Scope\r\nAn account owner sends a SecuritiesTransactionStatusQuery to an account servicer to request a status on a securities transaction.\r\nThe account owner/servicer relationship may be:\r\n- a global custodian which has an account with a local custodian, or\r\n- an investment management institution which manage a fund account opened at a custodian, or\r\n- a broker which has an account with a custodian, or\r\n- a central securities depository participant which has an account with a central securities depository, or\r\n- a central securities depository which has an account with a custodian, another central securities depository or another settlement market infrastructure, or\r\n- a central counterparty or a stock exchange or a trade matching utility which need to instruct to a central securities depository or another settlement market infrastructure.\r\n\r\nUsage\r\nThe message may also be used to:\r\n- re-send a message previously sent,\r\n- provide a third party with a copy of a message for information,\r\n- re-send to a third party a copy of a message for information\r\nusing the relevant elements in the Business Application Header.\r\n";
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionStatusQuery002V04.mmStatusAdviceRequested,
						com.tools20022.repository.area.sese.SecuritiesTransactionStatusQuery002V04.mmAccountOwner, com.tools20022.repository.area.sese.SecuritiesTransactionStatusQuery002V04.mmSafekeepingAccount,
						com.tools20022.repository.area.sese.SecuritiesTransactionStatusQuery002V04.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return SecuritiesTransactionStatusQuery002V04.class;
			}
		});
	...
	public SecuritiesTransactionStatusQuery002V04 setStatusAdviceRequested(DocumentNumber15 statusAdviceRequested) {
	...
	public SecuritiesTransactionStatusQuery002V04 setAccountOwner(PartyIdentification109 accountOwner) {
	...
	public SecuritiesTransactionStatusQuery002V04 setSafekeepingAccount(SecuritiesAccount27 safekeepingAccount) {
	...
	public SecuritiesTransactionStatusQuery002V04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public SecuritiesTransactionStatusQuery002V04 messageBody;
	}
}