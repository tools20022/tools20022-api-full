		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesMessageCancellationAdviceV01.mmIdentification, SecuritiesMessageCancellationAdviceV01.mmDetails, SecuritiesMessageCancellationAdviceV01.mmMessageOriginator,
						SecuritiesMessageCancellationAdviceV01.mmMessageRecipient, SecuritiesMessageCancellationAdviceV01.mmExtension);
