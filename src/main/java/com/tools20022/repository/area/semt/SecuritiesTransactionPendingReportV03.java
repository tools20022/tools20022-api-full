		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV03.mmPagination, SecuritiesTransactionPendingReportV03.mmStatementGeneralDetails, SecuritiesTransactionPendingReportV03.mmAccountOwner,
						SecuritiesTransactionPendingReportV03.mmSafekeepingAccount, SecuritiesTransactionPendingReportV03.mmStatus, SecuritiesTransactionPendingReportV03.mmTransactions);
