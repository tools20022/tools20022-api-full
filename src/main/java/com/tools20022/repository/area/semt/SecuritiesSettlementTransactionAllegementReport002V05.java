...
public class SecuritiesSettlementTransactionAllegementReport002V05 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAllegementReport002V05.mmPagination, SecuritiesSettlementTransactionAllegementReport002V05.mmStatementGeneralDetails,
						SecuritiesSettlementTransactionAllegementReport002V05.mmAccountOwner, SecuritiesSettlementTransactionAllegementReport002V05.mmSafekeepingAccount,
						SecuritiesSettlementTransactionAllegementReport002V05.mmAllegementDetails);
	...
	public void setAllegementDetails(List<SecuritiesTradeDetails61> allegementDetails) {
