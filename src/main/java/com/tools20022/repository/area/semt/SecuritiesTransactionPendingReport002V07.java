		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReport002V07.mmPagination, SecuritiesTransactionPendingReport002V07.mmStatementGeneralDetails,
						SecuritiesTransactionPendingReport002V07.mmAccountOwner, SecuritiesTransactionPendingReport002V07.mmSafekeepingAccount, SecuritiesTransactionPendingReport002V07.mmStatus,
						SecuritiesTransactionPendingReport002V07.mmTransactions);
