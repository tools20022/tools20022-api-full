	...
	public static final MMMessageBuildingBlock mmPagination = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmPagination);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmPagination;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmStatementGeneralDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmStatementGeneralDetails);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmStatementGeneralDetails;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmAccountOwner = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmAccountOwner);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmSafekeepingAccount = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmSafekeepingAccount);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmStatus = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmStatus);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmStatus;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmTransactions = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV07.mmTransactions);
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPendingReportV05.mmTransactions;
			minOccurs = 0;
