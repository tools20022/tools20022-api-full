		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesBalanceAccountingReportV04.mmPagination, SecuritiesBalanceAccountingReportV04.mmStatementGeneralDetails, SecuritiesBalanceAccountingReportV04.mmAccountOwner,
						SecuritiesBalanceAccountingReportV04.mmAccountServicer, SecuritiesBalanceAccountingReportV04.mmSafekeepingAccount, SecuritiesBalanceAccountingReportV04.mmIntermediaryInformation,
						SecuritiesBalanceAccountingReportV04.mmBalanceForAccount, SecuritiesBalanceAccountingReportV04.mmSubAccountDetails, SecuritiesBalanceAccountingReportV04.mmAccountBaseCurrencyTotalAmounts,
						SecuritiesBalanceAccountingReportV04.mmAlternateReportingCurrencyTotalAmounts);
