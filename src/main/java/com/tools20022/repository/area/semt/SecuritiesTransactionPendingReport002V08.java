 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSecuritiesMarketPracticeGroupGuideline#forSecuritiesTransactionPendingReport002V08
 * ConstraintSecuritiesMarketPracticeGroupGuideline.
 * forSecuritiesTransactionPendingReport002V08}</li>
 * </ul>
 * </li>
 * <li>
...
public class SecuritiesTransactionPendingReport002V08 {
	...
	public static final MMMessageBuildingBlock mmPagination = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getPagination", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmStatementGeneralDetails = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getStatementGeneralDetails", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmAccountOwner = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getAccountOwner", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmSafekeepingAccount = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getSafekeepingAccount", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmStatus = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getStatus", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmTransactions = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return SecuritiesTransactionPendingReport002V08.class.getMethod("getTransactions", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSecuritiesMarketPracticeGroupGuideline.forSecuritiesTransactionPendingReport002V08);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmPagination,
						com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmStatementGeneralDetails, com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmAccountOwner,
						com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmSafekeepingAccount, com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmStatus,
						com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.mmTransactions);
