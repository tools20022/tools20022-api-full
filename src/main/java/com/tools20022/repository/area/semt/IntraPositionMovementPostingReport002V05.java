...
public class IntraPositionMovementPostingReport002V05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Pagination> mmPagination = new MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Pagination>() {
		{
			xmlTag = "Pgntn";
		...
		@Override
		public Pagination getValue(IntraPositionMovementPostingReport002V05 obj) {
			return obj.getPagination();
		}

		@Override
		public void setValue(IntraPositionMovementPostingReport002V05 obj, Pagination value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Statement49> mmStatementGeneralDetails = new MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Statement49>() {
		{
			xmlTag = "StmtGnlDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Statement49 getValue(IntraPositionMovementPostingReport002V05 obj) {
			return obj.getStatementGeneralDetails();
		}

		@Override
		public void setValue(IntraPositionMovementPostingReport002V05 obj, Statement49 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Optional<PartyIdentification103Choice>> mmAccountOwner = new MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, Optional<PartyIdentification103Choice>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
		...
		@Override
		public Optional<PartyIdentification103Choice> getValue(IntraPositionMovementPostingReport002V05 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(IntraPositionMovementPostingReport002V05 obj, Optional<PartyIdentification103Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, SecuritiesAccount27> mmSafekeepingAccount = new MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, SecuritiesAccount27>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SecuritiesAccount27 getValue(IntraPositionMovementPostingReport002V05 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(IntraPositionMovementPostingReport002V05 obj, SecuritiesAccount27 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, List<FinancialInstrumentDetails22>> mmFinancialInstrument = new MMMessageBuildingBlock<IntraPositionMovementPostingReport002V05, List<FinancialInstrumentDetails22>>() {
		{
			xmlTag = "FinInstrm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<FinancialInstrumentDetails22> getValue(IntraPositionMovementPostingReport002V05 obj) {
			return obj.getFinancialInstrument();
		}

		@Override
		public void setValue(IntraPositionMovementPostingReport002V05 obj, List<FinancialInstrumentDetails22> value) {
