...
@XmlType(name = "IntraPositionMovementStatusAdvice002V05", propOrder = {"transactionIdentification", "processingStatus", "settlementStatus", "transactionDetails", "supplementaryData"})
public class IntraPositionMovementStatusAdvice002V05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, TransactionIdentifications34> mmTransactionIdentification = new MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, TransactionIdentifications34>() {
		{
			xmlTag = "TxId";
		...
		@Override
		public TransactionIdentifications34 getValue(IntraPositionMovementStatusAdvice002V05 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(IntraPositionMovementStatusAdvice002V05 obj, TransactionIdentifications34 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<IntraPositionProcessingStatus6Choice>> mmProcessingStatus = new MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<IntraPositionProcessingStatus6Choice>>() {
		{
			xmlTag = "PrcgSts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<IntraPositionProcessingStatus6Choice> getValue(IntraPositionMovementStatusAdvice002V05 obj) {
			return obj.getProcessingStatus();
		}

		@Override
		public void setValue(IntraPositionMovementStatusAdvice002V05 obj, Optional<IntraPositionProcessingStatus6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<SettlementStatus20Choice>> mmSettlementStatus = new MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<SettlementStatus20Choice>>() {
		{
			xmlTag = "SttlmSts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<SettlementStatus20Choice> getValue(IntraPositionMovementStatusAdvice002V05 obj) {
			return obj.getSettlementStatus();
		}

		@Override
		public void setValue(IntraPositionMovementStatusAdvice002V05 obj, Optional<SettlementStatus20Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<IntraPositionDetails42>> mmTransactionDetails = new MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, Optional<IntraPositionDetails42>>() {
		{
			xmlTag = "TxDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<IntraPositionDetails42> getValue(IntraPositionMovementStatusAdvice002V05 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(IntraPositionMovementStatusAdvice002V05 obj, Optional<IntraPositionDetails42> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<IntraPositionMovementStatusAdvice002V05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(IntraPositionMovementStatusAdvice002V05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(IntraPositionMovementStatusAdvice002V05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return IntraPositionMovementStatusAdvice002V05.class;
			}
		});
	...
	public IntraPositionMovementStatusAdvice002V05 setTransactionIdentification(TransactionIdentifications34 transactionIdentification) {
	...
	public IntraPositionMovementStatusAdvice002V05 setProcessingStatus(IntraPositionProcessingStatus6Choice processingStatus) {
	...
	public IntraPositionMovementStatusAdvice002V05 setSettlementStatus(SettlementStatus20Choice settlementStatus) {
	...
	public IntraPositionMovementStatusAdvice002V05 setTransactionDetails(IntraPositionDetails42 transactionDetails) {
	...
	public IntraPositionMovementStatusAdvice002V05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public IntraPositionMovementStatusAdvice002V05 messageBody;
	}
}