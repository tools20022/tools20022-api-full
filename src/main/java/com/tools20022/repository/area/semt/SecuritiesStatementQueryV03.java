		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesStatementQueryV03.mmStatementRequested, SecuritiesStatementQueryV03.mmStatementGeneralDetails, SecuritiesStatementQueryV03.mmAccountOwner,
						SecuritiesStatementQueryV03.mmSafekeepingAccount, SecuritiesStatementQueryV03.mmAdditionalQueryParameters, SecuritiesStatementQueryV03.mmSupplementaryData);
