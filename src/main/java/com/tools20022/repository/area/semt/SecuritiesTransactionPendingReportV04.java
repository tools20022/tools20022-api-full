		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV04.mmPagination, SecuritiesTransactionPendingReportV04.mmStatementGeneralDetails, SecuritiesTransactionPendingReportV04.mmAccountOwner,
						SecuritiesTransactionPendingReportV04.mmSafekeepingAccount, SecuritiesTransactionPendingReportV04.mmStatus, SecuritiesTransactionPendingReportV04.mmTransactions);
