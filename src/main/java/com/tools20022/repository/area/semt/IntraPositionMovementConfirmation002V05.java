		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementConfirmation002V05.mmAdditionalParameters, IntraPositionMovementConfirmation002V05.mmAccountOwner,
						IntraPositionMovementConfirmation002V05.mmSafekeepingAccount, IntraPositionMovementConfirmation002V05.mmSafekeepingPlace, IntraPositionMovementConfirmation002V05.mmFinancialInstrumentIdentification,
						IntraPositionMovementConfirmation002V05.mmFinancialInstrumentAttributes, IntraPositionMovementConfirmation002V05.mmIntraPositionDetails, IntraPositionMovementConfirmation002V05.mmSupplementaryData);
