...
import com.tools20022.repository.msg.SubAccountIdentification34;
 ...
 * {@linkplain com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05#identifier
 * SecuritiesTransactionPostingReportV05.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Pagination = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.Pagination;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.Pagination);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock StatementGeneralDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.StatementGeneralDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.StatementGeneralDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountOwner = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.AccountOwner;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.AccountOwner);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SafekeepingAccount = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.SafekeepingAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.SafekeepingAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock FinancialInstrumentDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.FinancialInstrumentDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.FinancialInstrumentDetails);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock SubAccountDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.SubAccountDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV06.SubAccountDetails);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.Pagination,
						com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.StatementGeneralDetails, com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.AccountOwner,
						com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.SafekeepingAccount, com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.FinancialInstrumentDetails,
						com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.SubAccountDetails);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.identifier;
			}
		});
