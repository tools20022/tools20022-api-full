 ...
 * ConstraintCoexistenceCharacterSetXRule.for_semt_SecuritiesStatementQueryV04}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#for_semt_SecuritiesStatementQueryV04
 * ConstraintCoexistenceIdentificationRule.for_semt_SecuritiesStatementQueryV04}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SecuritiesStatementQueryV04", propOrder = {"statementRequested", "statementGeneralDetails", "accountOwner", "safekeepingAccount", "additionalQueryParameters", "supplementaryData"})
public class SecuritiesStatementQueryV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, DocumentNumber1> mmStatementRequested = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, DocumentNumber1>() {
		{
			xmlTag = "StmtReqd";
		...
		@Override
		public DocumentNumber1 getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getStatementRequested();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, DocumentNumber1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, Optional<Statement16>> mmStatementGeneralDetails = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, Optional<Statement16>>() {
		{
			xmlTag = "StmtGnlDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<Statement16> getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getStatementGeneralDetails();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, Optional<Statement16> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, Optional<PartyIdentification36Choice>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, SecuritiesAccount13>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SecuritiesAccount13 getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, SecuritiesAccount13 value) {
			obj.setSafekeepingAccount(value);
		}
	};
	@XmlElement(name = "AddtlQryParams")
	protected List<AdditionalQueryParameters7> additionalQueryParameters;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, List<AdditionalQueryParameters7>> mmAdditionalQueryParameters = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, List<AdditionalQueryParameters7>>() {
		{
		...
		@Override
		public List<AdditionalQueryParameters7> getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getAdditionalQueryParameters();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, List<AdditionalQueryParameters7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SecuritiesStatementQueryV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<SecuritiesStatementQueryV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(SecuritiesStatementQueryV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(SecuritiesStatementQueryV04 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetXRule.for_semt_SecuritiesStatementQueryV04,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.for_semt_SecuritiesStatementQueryV04);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesStatementQueryV04";
				definition = "Scope\nAn account owner sends a SecuritiesStatementQuery to an account servicer to request any existing securities statement.\nThe account owner/servicer relationship may be:\n- a global custodian which has an account with a local custodian, or\n- an investment management institution which manage a fund account opened at a custodian, or\n- a broker which has an account with a custodian, or\n- a central securities depository participant which has an account with a central securities depository, or\n- a central securities depository which has an account with a custodian, another central securities depository or another settlement market infrastructure, or\n- a central counterparty or a stock exchange or a trade matching utility which need to instruct to a central securities depository or another settlement market infrastructure.\n\nUsage\nThe message may also be used to:\n- re-send a message previously sent,\n- provide a third party with a copy of a message for information,\n- re-send to a third party a copy of a message for information\nusing the relevant elements in the Business Application Header.\n\nISO 15022 - 20022 Coexistence\nThis ISO 20022 message is reversed engineered from ISO 15022. Both standards will coexist for a certain number of years. Until this coexistence period ends, the usage of certain data types is restricted to ensure interoperability between ISO 15022 and 20022 users. Compliance to these rules is mandatory in a coexistence environment. The coexistence restrictions are described in a Textual Rule linked to the Message Items they concern. These coexistence textual rules are clearly identified as follows: “CoexistenceXxxxRule”.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesStatementQueryV05.mmObject());
				previousVersion_lazy = () -> SecuritiesStatementQueryV03.mmObject();
			...
			public Class<?> getInstanceClass() {
				return SecuritiesStatementQueryV04.class;
			}
		});
	...
	public SecuritiesStatementQueryV04 setStatementRequested(DocumentNumber1 statementRequested) {
	...
	public SecuritiesStatementQueryV04 setStatementGeneralDetails(Statement16 statementGeneralDetails) {
	...
	public SecuritiesStatementQueryV04 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public SecuritiesStatementQueryV04 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
		this.safekeepingAccount = Objects.requireNonNull(safekeepingAccount);
		return this;
	}

	public List<AdditionalQueryParameters7> getAdditionalQueryParameters() {
		return additionalQueryParameters == null ? additionalQueryParameters = new ArrayList<>() : additionalQueryParameters;
	}

	public SecuritiesStatementQueryV04 setAdditionalQueryParameters(List<AdditionalQueryParameters7> additionalQueryParameters) {
	...
	public SecuritiesStatementQueryV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public SecuritiesStatementQueryV04 messageBody;
	}
}