		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesBalanceAccountingReportV08.mmPagination, SecuritiesBalanceAccountingReportV08.mmStatementGeneralDetails, SecuritiesBalanceAccountingReportV08.mmAccountOwner,
						SecuritiesBalanceAccountingReportV08.mmAccountServicer, SecuritiesBalanceAccountingReportV08.mmSafekeepingAccount, SecuritiesBalanceAccountingReportV08.mmIntermediaryInformation,
						SecuritiesBalanceAccountingReportV08.mmBalanceForAccount, SecuritiesBalanceAccountingReportV08.mmSubAccountDetails, SecuritiesBalanceAccountingReportV08.mmAccountBaseCurrencyTotalAmounts,
						SecuritiesBalanceAccountingReportV08.mmAlternateReportingCurrencyTotalAmounts);
