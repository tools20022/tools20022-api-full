 ...
 * to send additional information.<br>
 * <b>Usage</b><br>
...
public class AccountExcludedMandateMaintenanceAmendmentRequestV01 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, References4> mmReferences = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, References4>() {
		{
			xmlTag = "Refs";
		...
		@Override
		public References4 getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, References4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, Optional<AccountContract2>> mmContractDates = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, Optional<AccountContract2>>() {
		{
			xmlTag = "CtrctDts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ContractDates";
		...
		@Override
		public Optional<AccountContract2> getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getContractDates();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, Optional<AccountContract2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, Optional<ContractDocument1>> mmUnderlyingMasterAgreement = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, Optional<ContractDocument1>>() {
		{
		...
		@Override
		public Optional<ContractDocument1> getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getUnderlyingMasterAgreement();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, Optional<ContractDocument1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, CustomerAccount1> mmAccount = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, CustomerAccount1>() {
		{
			xmlTag = "Acct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Account";
		...
		@Override
		public CustomerAccount1 getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, CustomerAccount1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, BranchAndFinancialInstitutionIdentification4> mmAccountServicerIdentification = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, BranchAndFinancialInstitutionIdentification4>() {
		{
			xmlTag = "AcctSvcrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification4 getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getAccountServicerIdentification();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, BranchAndFinancialInstitutionIdentification4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, List<Organisation6>> mmOrganisation = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, List<Organisation6>>() {
		{
			xmlTag = "Org";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Organisation";
		...
		@Override
		public List<Organisation6> getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getOrganisation();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, List<Organisation6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, List<PartyAndSignature1>> mmDigitalSignature = new MMMessageBuildingBlock<AccountExcludedMandateMaintenanceAmendmentRequestV01, List<PartyAndSignature1>>() {
		{
			xmlTag = "DgtlSgntr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PartyAndSignature1> getValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj) {
			return obj.getDigitalSignature();
		}

		@Override
		public void setValue(AccountExcludedMandateMaintenanceAmendmentRequestV01 obj, List<PartyAndSignature1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				name = "AccountExcludedMandateMaintenanceAmendmentRequestV01";
				definition = "Scope\r\nThe AccountExcludedMandateMaintenanceAmendmentRequest message is sent from an organisation to a financial institution as part of the account maintenance process. It is sent in response to a request from the financial institution to send additional information.\r\nUsage\r\nThis update is about account details excluding any mandate information. The organisation will specify under the Account and Organisation tags the complete information as it should be in the financial institutions records after processing the update request.";
				nextVersions_lazy = () -> Arrays.asList(AccountExcludedMandateMaintenanceAmendmentRequestV02.mmObject());
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setReferences(References4 references) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setContractDates(AccountContract2 contractDates) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setUnderlyingMasterAgreement(ContractDocument1 underlyingMasterAgreement) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setAccount(CustomerAccount1 account) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setAccountServicerIdentification(BranchAndFinancialInstitutionIdentification4 accountServicerIdentification) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setOrganisation(List<Organisation6> organisation) {
	...
	public AccountExcludedMandateMaintenanceAmendmentRequestV01 setDigitalSignature(List<PartyAndSignature1> digitalSignature) {
