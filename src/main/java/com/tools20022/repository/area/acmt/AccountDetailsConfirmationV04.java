 ...
 * {@linkplain com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04#identifier
 * AccountDetailsConfirmationV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.MessageIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OrderReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.OrderReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.OrderReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock RelatedReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.RelatedReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.RelatedReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock ConfirmationDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.ConfirmationDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.ConfirmationDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock InvestmentAccount = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.InvestmentAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.InvestmentAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountParties = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.AccountParties;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.AccountParties);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Intermediaries = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.Intermediaries;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.Intermediaries);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageBuildingBlock Placement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.Placement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.Placement);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock NewIssueAllocation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.NewIssueAllocation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.NewIssueAllocation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SavingsInvestmentPlan = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.SavingsInvestmentPlan;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.SavingsInvestmentPlan);
			minOccurs = 0;
			maxOccurs = 50;
	...
	public static final MMMessageBuildingBlock WithdrawalInvestmentPlan = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.WithdrawalInvestmentPlan;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.WithdrawalInvestmentPlan);
			minOccurs = 0;
			maxOccurs = 10;
			complexType_lazy = () -> InvestmentPlan9.mmObject();
		}
	...
	public static final MMMessageBuildingBlock CashSettlement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.CashSettlement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.CashSettlement);
			minOccurs = 0;
			maxOccurs = 8;
	...
	public static final MMMessageBuildingBlock ServiceLevelAgreement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.ServiceLevelAgreement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.ServiceLevelAgreement);
			minOccurs = 0;
			maxOccurs = 30;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV03.Extension;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.Extension);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.MessageIdentification, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.OrderReference,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.RelatedReference, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.ConfirmationDetails,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.InvestmentAccount, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.AccountParties,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.Intermediaries, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.Placement,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.NewIssueAllocation, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.SavingsInvestmentPlan,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.WithdrawalInvestmentPlan, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.CashSettlement,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.ServiceLevelAgreement, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.MarketPracticeVersion,
						com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.acmt.AccountDetailsConfirmationV04.identifier;
			}
		});
