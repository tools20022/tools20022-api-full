		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				previousVersion_lazy = () -> AccountRequestAcknowledgementV01.mmObject();
				messageSet_lazy = () -> Arrays.asList(BankAccountManagementISOLatestversion.mmObject());
				rootElement = "Document";
				xmlTag = "AcctReqAck";
				businessArea_lazy = () -> AccountManagementLatestVersion.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountRequestAcknowledgementV02.mmReferences, AccountRequestAcknowledgementV02.mmFrom, AccountRequestAcknowledgementV02.mmAccountIdentification,
						AccountRequestAcknowledgementV02.mmOrganisationIdentification, AccountRequestAcknowledgementV02.mmAccountServicerIdentification, AccountRequestAcknowledgementV02.mmDigitalSignature,
