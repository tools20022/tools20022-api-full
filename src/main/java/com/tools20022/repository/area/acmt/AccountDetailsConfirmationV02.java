 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintInvestmentAccountRule#for_acmt_AccountDetailsConfirmationV02
 * ConstraintInvestmentAccountRule.for_acmt_AccountDetailsConfirmationV02}</li>
 * </ul>
 * </li>
 * <li>
...
public class AccountDetailsConfirmationV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
		...
		@Override
		public MessageIdentification1 getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentFundOrder4>> mmOrderReference = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentFundOrder4>>() {
		{
			xmlTag = "OrdrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OrderReference";
		...
		@Override
		public Optional<InvestmentFundOrder4> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getOrderReference();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<InvestmentFundOrder4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<AdditionalReference3>> mmRelatedReference = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<AdditionalReference3> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getRelatedReference();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, AccountManagementConfirmation1> mmConfirmationDetails = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, AccountManagementConfirmation1>() {
		{
			xmlTag = "ConfDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public AccountManagementConfirmation1 getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getConfirmationDetails();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, AccountManagementConfirmation1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentAccount27>> mmInvestmentAccount = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentAccount27>>() {
		{
			xmlTag = "InvstmtAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<InvestmentAccount27> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getInvestmentAccount();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<InvestmentAccount27> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<AccountParties5>> mmAccountParties = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<AccountParties5>>() {
		{
			xmlTag = "AcctPties";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountParties";
		...
		@Override
		public Optional<AccountParties5> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getAccountParties();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<AccountParties5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<Intermediary12>> mmIntermediaries = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<Intermediary12>>() {
		{
			xmlTag = "Intrmies";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Intermediaries";
		...
		@Override
		public List<Intermediary12> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getIntermediaries();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, List<Intermediary12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<ReferredAgent1>> mmPlacement = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<ReferredAgent1>>() {
		{
			xmlTag = "Plcmnt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Placement";
		...
		@Override
		public Optional<ReferredAgent1> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getPlacement();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<ReferredAgent1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<NewIssueAllocation1>> mmNewIssueAllocation = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<NewIssueAllocation1>>() {
		{
			xmlTag = "NewIsseAllcn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<NewIssueAllocation1> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getNewIssueAllocation();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<NewIssueAllocation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<InvestmentPlan4>> mmSavingsInvestmentPlan = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<InvestmentPlan4>>() {
		{
		...
		@Override
		public List<InvestmentPlan4> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getSavingsInvestmentPlan();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, List<InvestmentPlan4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<InvestmentPlan4>> mmWithdrawalInvestmentPlan = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<InvestmentPlan4>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentFundCashSettlementInformation3>> mmCashSettlement = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, Optional<InvestmentFundCashSettlementInformation3>>() {
		{
			xmlTag = "CshSttlm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CashSettlement";
		...
		@Override
		public Optional<InvestmentFundCashSettlementInformation3> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getCashSettlement();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, Optional<InvestmentFundCashSettlementInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<DocumentToSend1>> mmServiceLevelAgreement = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<DocumentToSend1>>() {
		{
			xmlTag = "SvcLvlAgrmt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<DocumentToSend1> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getServiceLevelAgreement();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, List<DocumentToSend1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<Extension1>> mmExtension = new MMMessageBuildingBlock<AccountDetailsConfirmationV02, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
		...
		@Override
		public List<Extension1> getValue(AccountDetailsConfirmationV02 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(AccountDetailsConfirmationV02 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestmentAccountRule.for_acmt_AccountDetailsConfirmationV02);
