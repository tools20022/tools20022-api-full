 ...
 * {@linkplain com.tools20022.repository.area.acmt.AccountOpeningInstructionV04#identifier
 * AccountOpeningInstructionV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.MessageIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OrderReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.OrderReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.OrderReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.PreviousReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.PreviousReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock InstructionDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.InstructionDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.InstructionDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock InvestmentAccount = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.InvestmentAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.InvestmentAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountParties = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.AccountParties;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.AccountParties);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Intermediaries = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.Intermediaries;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.Intermediaries);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageBuildingBlock Placement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.Placement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.Placement);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock NewIssueAllocation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.NewIssueAllocation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.NewIssueAllocation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SavingsInvestmentPlan = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.SavingsInvestmentPlan;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.SavingsInvestmentPlan);
			minOccurs = 0;
			maxOccurs = 50;
	...
	public static final MMMessageBuildingBlock WithdrawalInvestmentPlan = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.WithdrawalInvestmentPlan;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.WithdrawalInvestmentPlan);
			minOccurs = 0;
			maxOccurs = 10;
			complexType_lazy = () -> InvestmentPlan9.mmObject();
		}
	...
	public static final MMMessageBuildingBlock CashSettlement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.CashSettlement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.CashSettlement);
			minOccurs = 0;
			maxOccurs = 8;
	...
	public static final MMMessageBuildingBlock ServiceLevelAgreement = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.ServiceLevelAgreement;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.ServiceLevelAgreement);
			minOccurs = 0;
			maxOccurs = 30;
	...
	public static final MMMessageBuildingBlock MarketPracticeVersion = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.MarketPracticeVersion);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV03.Extension;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.Extension);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.MessageIdentification, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.OrderReference,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.PreviousReference, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.InstructionDetails,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.InvestmentAccount, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.AccountParties,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.Intermediaries, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.Placement,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.NewIssueAllocation, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.SavingsInvestmentPlan,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.WithdrawalInvestmentPlan, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.CashSettlement,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.ServiceLevelAgreement, com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.MarketPracticeVersion,
						com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.acmt.AccountOpeningInstructionV04.identifier;
			}
		});
