...
@XmlType(name = "AccountManagementStatusReportV02", propOrder = {"messageIdentification", "relatedReference", "statusReport"})
public class AccountManagementStatusReportV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountManagementStatusReportV02, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<AccountManagementStatusReportV02, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
		...
		@Override
		public MessageIdentification1 getValue(AccountManagementStatusReportV02 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(AccountManagementStatusReportV02 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountManagementStatusReportV02, List<AdditionalReference3>> mmRelatedReference = new MMMessageBuildingBlock<AccountManagementStatusReportV02, List<AdditionalReference3>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<AdditionalReference3> getValue(AccountManagementStatusReportV02 obj) {
			return obj.getRelatedReference();
		}

		@Override
		public void setValue(AccountManagementStatusReportV02 obj, List<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountManagementStatusReportV02, AccountManagementStatusAndReason1> mmStatusReport = new MMMessageBuildingBlock<AccountManagementStatusReportV02, AccountManagementStatusAndReason1>() {
		{
			xmlTag = "StsRpt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "StatusReport";
		...
		@Override
		public AccountManagementStatusAndReason1 getValue(AccountManagementStatusReportV02 obj) {
			return obj.getStatusReport();
		}

		@Override
		public void setValue(AccountManagementStatusReportV02 obj, AccountManagementStatusAndReason1 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountManagementStatusReportV02.mmMessageIdentification,
						com.tools20022.repository.area.acmt.AccountManagementStatusReportV02.mmRelatedReference, com.tools20022.repository.area.acmt.AccountManagementStatusReportV02.mmStatusReport);
			...
			public Class<?> getInstanceClass() {
				return AccountManagementStatusReportV02.class;
			}
		});
	...
	public AccountManagementStatusReportV02 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public AccountManagementStatusReportV02 setRelatedReference(List<AdditionalReference3> relatedReference) {
	...
	public AccountManagementStatusReportV02 setStatusReport(AccountManagementStatusAndReason1 statusReport) {
		this.statusReport = Objects.requireNonNull(statusReport);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:acmt.006.001.02")
	static public class Document {
		@XmlElement(name = "AcctMgmtStsRptV02", required = true)
		public AccountManagementStatusReportV02 messageBody;
	}
}