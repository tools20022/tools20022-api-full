 ...
 * messageDefinitionIdentifier} = {@code acmt.003.001.04}</li>
 ...
 * ConstraintDividendPercentage1Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
 ...
 * ConstraintDividendPercentage2Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
 ...
 * ConstraintDividendPercentage3Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDividendPercentage4Rule#for_acmt_AccountModificationInstructionV04
 * ConstraintDividendPercentage4Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDividendPercentage5Rule#for_acmt_AccountModificationInstructionV04
 * ConstraintDividendPercentage5Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
 ...
 * ConstraintDividendPercentage6Rule.for_acmt_AccountModificationInstructionV04}
 * </li>
 * <li>
...
@XmlType(name = "AccountModificationInstructionV04", propOrder = {"messageIdentification", "previousReference", "instructionDetails", "investmentAccountSelection", "modifiedInvestmentAccount", "modifiedAccountParties",
...
public class AccountModificationInstructionV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<AccountModificationInstructionV04, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageIdentification";
			definition = "Identifies the message.";
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmMessageIdentification);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmMessageIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(AccountModificationInstructionV04 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<AdditionalReference3>> mmPreviousReference = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousReference";
			definition = "Reference to a linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmPreviousReference);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmPreviousReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference3> getValue(AccountModificationInstructionV04 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<InvestmentAccountModificationDetails>> mmInstructionDetails = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<InvestmentAccountModificationDetails>>() {
		{
			xmlTag = "InstrDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<InvestmentAccountModificationDetails> getValue(AccountModificationInstructionV04 obj) {
			return obj.getInstructionDetails();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<InvestmentAccountModificationDetails> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, InvestmentAccountSelection2> mmInvestmentAccountSelection = new MMMessageBuildingBlock<AccountModificationInstructionV04, InvestmentAccountSelection2>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmInvestmentAccountSelection);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmInvestmentAccountSelection;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InvestmentAccountSelection2 getValue(AccountModificationInstructionV04 obj) {
			return obj.getInvestmentAccountSelection();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, InvestmentAccountSelection2 value) {
			obj.setInvestmentAccountSelection(value);
		}
	};
	@XmlElement(name = "ModfdInvstmtAcct")
	protected InvestmentAccount39 modifiedInvestmentAccount;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<InvestmentAccount39>> mmModifiedInvestmentAccount = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<InvestmentAccount39>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedInvestmentAccount);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedInvestmentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> InvestmentAccount39.mmObject();
		}

		@Override
		public Optional<InvestmentAccount39> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedInvestmentAccount();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<InvestmentAccount39> value) {
			obj.setModifiedInvestmentAccount(value.orElse(null));
		}
	};
	@XmlElement(name = "ModfdAcctPties")
	protected List<AccountParties8> modifiedAccountParties;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageBuildingBlock#getComplexType
	 * complexType} = {@linkplain com.tools20022.repository.msg.AccountParties8
	 * AccountParties8}</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageConstruct#getXmlTag
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<AccountParties8>> mmModifiedAccountParties = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<AccountParties8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedAccountParties);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedAccountParties;
			maxOccurs = 10;
			minOccurs = 0;
			complexType_lazy = () -> AccountParties8.mmObject();
		}

		@Override
		public List<AccountParties8> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedAccountParties();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<AccountParties8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope20>> mmModifiedIntermediaries = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedIntermediaries);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedIntermediaries;
			maxOccurs = 10;
			minOccurs = 0;
		...
		@Override
		public List<ModificationScope20> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedIntermediaries();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<ModificationScope20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<ReferredAgent1>> mmModifiedPlacement = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<ReferredAgent1>>() {
		{
			xmlTag = "ModfdPlcmnt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedPlacement);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedPlacement;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ReferredAgent1> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedPlacement();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<ReferredAgent1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<ModificationScope9>> mmModifiedIssueAllocation = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<ModificationScope9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedIssueAllocation);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedIssueAllocation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ModificationScope9> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedIssueAllocation();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<ModificationScope9> value) {
			obj.setModifiedIssueAllocation(value.orElse(null));
		}
	};
	@XmlElement(name = "ModfdSvgsInvstmtPlan")
	protected List<ModificationScope18> modifiedSavingsInvestmentPlan;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope18>> mmModifiedSavingsInvestmentPlan = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope18>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedSavingsInvestmentPlan);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedSavingsInvestmentPlan;
			maxOccurs = 50;
			minOccurs = 0;
			complexType_lazy = () -> ModificationScope18.mmObject();
		}

		@Override
		public List<ModificationScope18> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedSavingsInvestmentPlan();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<ModificationScope18> value) {
			obj.setModifiedSavingsInvestmentPlan(value);
		}
	};
	@XmlElement(name = "ModfdWdrwlInvstmtPlan")
	protected List<ModificationScope18> modifiedWithdrawalInvestmentPlan;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope18>> mmModifiedWithdrawalInvestmentPlan = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope18>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedWithdrawalInvestmentPlan);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedWithdrawalInvestmentPlan;
			maxOccurs = 10;
			minOccurs = 0;
			complexType_lazy = () -> ModificationScope18.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<InvestmentFundCashSettlementInformation8>> mmModifiedCashSettlement = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<InvestmentFundCashSettlementInformation8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedCashSettlement);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmModifiedCashSettlement;
			maxOccurs = 8;
			minOccurs = 0;
		...
		@Override
		public List<InvestmentFundCashSettlementInformation8> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedCashSettlement();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<InvestmentFundCashSettlementInformation8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope10>> mmModifiedServiceLevelAgreement = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<ModificationScope10>>() {
		{
		...
		@Override
		public List<ModificationScope10> getValue(AccountModificationInstructionV04 obj) {
			return obj.getModifiedServiceLevelAgreement();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<ModificationScope10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<MarketPracticeVersion1>> mmMarketPracticeVersion = new MMMessageBuildingBlock<AccountModificationInstructionV04, Optional<MarketPracticeVersion1>>() {
		{
			xmlTag = "MktPrctcVrsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MarketPracticeVersion";
			definition = "Identifies the market practice to which the message conforms.";
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmMarketPracticeVersion);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<MarketPracticeVersion1> getValue(AccountModificationInstructionV04 obj) {
			return obj.getMarketPracticeVersion();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, Optional<MarketPracticeVersion1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountModificationInstructionV04, List<Extension1>> mmExtension = new MMMessageBuildingBlock<AccountModificationInstructionV04, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmExtension);
			previousVersion_lazy = () -> AccountModificationInstructionV03.mmExtension;
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(AccountModificationInstructionV04 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(AccountModificationInstructionV04 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage1Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintDividendPercentage2Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintDividendPercentage3Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintDividendPercentage4Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintDividendPercentage5Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintDividendPercentage6Rule.for_acmt_AccountModificationInstructionV04,
						com.tools20022.repository.constraints.ConstraintUnit1Rule.for_acmt_AccountModificationInstructionV04);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountModificationInstructionV04";
				definition = "Scope\r\nAn account owner, for example, an investor or its designated agent, sends the AccountModificationInstruction message to the account servicer, for example, a registrar, transfer agent or custodian bank to modify, that is, create, update or delete specific details of an existing investment fund account.\r\nUsage\r\nThe AccountModificationInstruction message is used to modify the details of an existing account.\r\nThe AccountModificationInstruction message has three specific uses:\r\n- to maintain/update any of the existing account details, for example, to update the address of the beneficiary or modify the preference to income from distribution to capitalisation, or,\r\n- to add/create specific details to the existing account when these details were not yet recorded at the time of account creation, for example, to add a second address or to establish new cash settlement standing instructions, or,\r\n- to delete specific account details, for example, delete cash standing instructions.\r\nThis message cannot be used to delete an entire account, as institution specific and regulatory rules pertaining to account deletion are diverse.\r\nThe usage of this message may be subject to service level agreement (SLA) between the counterparties.\r\nExecution of the AccountModificationInstruction is confirmed via an AccountDetailsConfirmation message.";
				nextVersions_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmObject());
				previousVersion_lazy = () -> AccountModificationInstructionV03.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "AcctModInstr";
				businessArea_lazy = () -> AccountManagementArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmMessageIdentification,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmPreviousReference, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmInstructionDetails,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmInvestmentAccountSelection, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedInvestmentAccount,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedAccountParties, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedIntermediaries,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedPlacement, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedIssueAllocation,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedSavingsInvestmentPlan, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedWithdrawalInvestmentPlan,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedCashSettlement, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmModifiedServiceLevelAgreement,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmMarketPracticeVersion, com.tools20022.repository.area.acmt.AccountModificationInstructionV04.mmExtension);
			...
			public Class<?> getInstanceClass() {
				return AccountModificationInstructionV04.class;
			}
		});
	...
	public AccountModificationInstructionV04 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public AccountModificationInstructionV04 setPreviousReference(AdditionalReference3 previousReference) {
	...
	public AccountModificationInstructionV04 setInstructionDetails(InvestmentAccountModificationDetails instructionDetails) {
	...
	public AccountModificationInstructionV04 setInvestmentAccountSelection(InvestmentAccountSelection2 investmentAccountSelection) {
	...
	public AccountModificationInstructionV04 setModifiedInvestmentAccount(InvestmentAccount39 modifiedInvestmentAccount) {
	...
	public AccountModificationInstructionV04 setModifiedAccountParties(List<AccountParties8> modifiedAccountParties) {
	...
	public AccountModificationInstructionV04 setModifiedIntermediaries(List<ModificationScope20> modifiedIntermediaries) {
	...
	public AccountModificationInstructionV04 setModifiedPlacement(ReferredAgent1 modifiedPlacement) {
	...
	public AccountModificationInstructionV04 setModifiedIssueAllocation(ModificationScope9 modifiedIssueAllocation) {
	...
	public AccountModificationInstructionV04 setModifiedSavingsInvestmentPlan(List<ModificationScope18> modifiedSavingsInvestmentPlan) {
	...
	public AccountModificationInstructionV04 setModifiedWithdrawalInvestmentPlan(List<ModificationScope18> modifiedWithdrawalInvestmentPlan) {
	...
	public AccountModificationInstructionV04 setModifiedCashSettlement(List<InvestmentFundCashSettlementInformation8> modifiedCashSettlement) {
	...
	public AccountModificationInstructionV04 setModifiedServiceLevelAgreement(List<ModificationScope10> modifiedServiceLevelAgreement) {
	...
	public AccountModificationInstructionV04 setMarketPracticeVersion(MarketPracticeVersion1 marketPracticeVersion) {
	...
	public AccountModificationInstructionV04 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:acmt.003.001.04")
	static public class Document {
		@XmlElement(name = "AcctModInstr", required = true)
		public AccountModificationInstructionV04 messageBody;
	}
}