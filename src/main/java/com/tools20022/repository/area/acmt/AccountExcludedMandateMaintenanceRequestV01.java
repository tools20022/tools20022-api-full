		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountExcludedMandateMaintenanceRequestV01.mmReferences, AccountExcludedMandateMaintenanceRequestV01.mmContractDates,
						AccountExcludedMandateMaintenanceRequestV01.mmUnderlyingMasterAgreement, AccountExcludedMandateMaintenanceRequestV01.mmAccount, AccountExcludedMandateMaintenanceRequestV01.mmAccountServicerIdentification,
						AccountExcludedMandateMaintenanceRequestV01.mmOrganisation, AccountExcludedMandateMaintenanceRequestV01.mmAdditionalMessageInformation, AccountExcludedMandateMaintenanceRequestV01.mmDigitalSignature);
