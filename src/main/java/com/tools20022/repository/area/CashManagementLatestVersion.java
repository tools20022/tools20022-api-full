		...
		mmObject_lazy.compareAndSet(null, new MMBusinessArea() {
			{
				...
				messageDefinition_lazy = () -> Arrays.asList(PayInCallV02.mmObject(), PayInEventAcknowledgementV02.mmObject(), PayInScheduleV03.mmObject(), AccountReportingRequestV03.mmObject(), NotificationOfCaseAssignmentV04.mmObject(),
						RejectInvestigationV04.mmObject(), CancelCaseAssignmentV03.mmObject(), RequestForDuplicateV04.mmObject(), DuplicateV04.mmObject(), ProprietaryFormatInvestigationV03.mmObject(),
						DebitAuthorisationResponseV03.mmObject(), CaseStatusReportRequestV03.mmObject(), CaseStatusReportV04.mmObject(), FundDetailedEstimatedCashForecastReportV04.mmObject(), FundConfirmedCashForecastReportV04.mmObject(),
						...
						FundDetailedConfirmedCashForecastReportV04.mmObject(), BankToCustomerAccountReportV06.mmObject(), BankServicesBillingStatementV02.mmObject(), NotificationToReceiveStatusReportV05.mmObject(),
						NotificationToReceiveCancellationAdviceV05.mmObject(), BankToCustomerStatementV06.mmObject(), BankToCustomerDebitCreditNotificationV06.mmObject(), NotificationToReceiveV05.mmObject(), NetReportV01.mmObject(),
						UnableToApplyV05.mmObject(), CustomerPaymentCancellationRequestV06.mmObject(), AdditionalPaymentInformationV07.mmObject(), ResolutionOfInvestigationV07.mmObject(), FIToFIPaymentCancellationRequestV06.mmObject(),
