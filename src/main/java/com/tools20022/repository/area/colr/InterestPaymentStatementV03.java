...
/**
 * <b>Scope</b><br>
 * This message is sent by either the collateral giver or its collateral manager
 * to the collateral taker or its collateral manager. It is used to report the
 * interest amounts calculated based on the effective posted collateral amount,
 * over a specific period of time agreed by both parties.<br>
 * <br>
...
public class InterestPaymentStatementV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, Max35Text> mmTransactionIdentification = new MMMessageBuildingBlock<InterestPaymentStatementV03, Max35Text>() {
		{
			xmlTag = "TxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionIdentification";
			definition = "Unambiguous identification of the transaction as know by the instructing party.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(InterestPaymentStatementV03 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, Optional<Agreement2>> mmAgreement = new MMMessageBuildingBlock<InterestPaymentStatementV03, Optional<Agreement2>>() {
		{
			xmlTag = "Agrmt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Agreement";
			definition = "Agreement details for the over the counter market.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmAgreement);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Agreement2> getValue(InterestPaymentStatementV03 obj) {
			return obj.getAgreement();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, Optional<Agreement2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, Obligation3> mmObligation = new MMMessageBuildingBlock<InterestPaymentStatementV03, Obligation3>() {
		{
			xmlTag = "Oblgtn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Obligation";
			definition = "Provides information like the identification of the party or parties associated with the collateral agreement, the exposure type and the valuation date.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmObligation);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Obligation3 getValue(InterestPaymentStatementV03 obj) {
			return obj.getObligation();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, Obligation3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, Statement32> mmStatementParameters = new MMMessageBuildingBlock<InterestPaymentStatementV03, Statement32>() {
		{
			xmlTag = "StmtParams";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "StatementParameters";
			definition = "Provides general information on the report such as the statement identification.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmStatementParameters);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Statement32 getValue(InterestPaymentStatementV03 obj) {
			return obj.getStatementParameters();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, Statement32 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, Optional<Pagination>> mmPagination = new MMMessageBuildingBlock<InterestPaymentStatementV03, Optional<Pagination>>() {
		{
			xmlTag = "Pgntn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Pagination";
			definition = "Page number of the message (within a statement) and continuation indicator to indicate that the statement is to continue or that the message is the last page of the statement.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmPagination);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Pagination> getValue(InterestPaymentStatementV03 obj) {
			return obj.getPagination();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, Optional<Pagination> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, InterestStatement3> mmInterestStatement = new MMMessageBuildingBlock<InterestPaymentStatementV03, InterestStatement3>() {
		{
			xmlTag = "IntrstStmt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "InterestStatement";
			definition = "Provides details on the interest statement.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmInterestStatement);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InterestStatement3 getValue(InterestPaymentStatementV03 obj) {
			return obj.getInterestStatement();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, InterestStatement3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<InterestPaymentStatementV03, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<InterestPaymentStatementV03, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that can not be captured in the structured fields and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(InterestPaymentStatementV03 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(InterestPaymentStatementV03 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				name = "InterestPaymentStatementV03";
				definition = "Scope\r\nThis message is sent by either the collateral giver or its collateral manager to the collateral taker or its collateral manager. It is used to report the interest amounts calculated based on the effective posted collateral amount, over a specific period of time agreed by both parties.\r\n\r\nThe message definition is intended for use with the ISO20022 Business Application Header.\r\n\r\nUsage\r\nThe InterestPaymentStatement message is used for reporting the interest per period on collateral held.";
				nextVersions_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmObject());
	...
	public InterestPaymentStatementV03 setTransactionIdentification(Max35Text transactionIdentification) {
	...
	public InterestPaymentStatementV03 setAgreement(Agreement2 agreement) {
	...
	public InterestPaymentStatementV03 setObligation(Obligation3 obligation) {
	...
	public InterestPaymentStatementV03 setStatementParameters(Statement32 statementParameters) {
	...
	public InterestPaymentStatementV03 setPagination(Pagination pagination) {
	...
	public InterestPaymentStatementV03 setInterestStatement(InterestStatement3 interestStatement) {
	...
	public InterestPaymentStatementV03 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
