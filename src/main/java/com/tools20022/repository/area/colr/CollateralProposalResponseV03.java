 ...
 * {@linkplain com.tools20022.repository.area.colr.CollateralProposalResponseV03#identifier
 * CollateralProposalResponseV03.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock TransactionIdentification = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.colr.CollateralProposalResponseV04.TransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Obligation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.colr.CollateralProposalResponseV04.Obligation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock ProposalResponse = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.colr.CollateralProposalResponseV04.ProposalResponse);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.colr.CollateralProposalResponseV04.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.colr.CollateralProposalResponseV03.TransactionIdentification, com.tools20022.repository.area.colr.CollateralProposalResponseV03.Obligation,
						com.tools20022.repository.area.colr.CollateralProposalResponseV03.ProposalResponse, com.tools20022.repository.area.colr.CollateralProposalResponseV03.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.colr.CollateralProposalResponseV03.identifier;
			}
		});
