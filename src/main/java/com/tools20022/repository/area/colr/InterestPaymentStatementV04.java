		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(InterestPaymentStatementV04.mmTransactionIdentification, InterestPaymentStatementV04.mmAgreement, InterestPaymentStatementV04.mmObligation,
						InterestPaymentStatementV04.mmStatementParameters, InterestPaymentStatementV04.mmPagination, InterestPaymentStatementV04.mmInterestStatement, InterestPaymentStatementV04.mmSupplementaryData);
