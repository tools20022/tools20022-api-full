...
@XmlType(name = "CollateralManagementCancellationRequestV03", propOrder = {"transactionIdentification", "reference", "obligation", "cancellationReason", "supplementaryData"})
public class CollateralManagementCancellationRequestV03 {
	...
	public static final MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Max35Text> mmTransactionIdentification = new MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralManagementCancellationRequestV04.mmTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Reference2Choice> mmReference = new MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Reference2Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralManagementCancellationRequestV04.mmReference);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Obligation3> mmObligation = new MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, Obligation3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralManagementCancellationRequestV04.mmObligation);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, CollateralCancellationReason1> mmCancellationReason = new MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, CollateralCancellationReason1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralManagementCancellationRequestV04.mmCancellationReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CollateralManagementCancellationRequestV03, List<SupplementaryData1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralManagementCancellationRequestV04.mmSupplementaryData);
			minOccurs = 0;
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return CollateralManagementCancellationRequestV03.class;
			}
		});
	...
	public CollateralManagementCancellationRequestV03 setTransactionIdentification(Max35Text transactionIdentification) {
	...
	public CollateralManagementCancellationRequestV03 setReference(Reference2Choice reference) {
	...
	public CollateralManagementCancellationRequestV03 setObligation(Obligation3 obligation) {
	...
	public CollateralManagementCancellationRequestV03 setCancellationReason(CollateralCancellationReason1 cancellationReason) {
	...
	public CollateralManagementCancellationRequestV03 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CollateralManagementCancellationRequestV03 messageBody;
	}
}