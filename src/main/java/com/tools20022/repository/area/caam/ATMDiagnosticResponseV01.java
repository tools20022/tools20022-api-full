...
public class ATMDiagnosticResponseV01 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ATMDiagnosticResponseV01.mmHeader, ATMDiagnosticResponseV01.mmProtectedATMDiagnosticResponse, ATMDiagnosticResponseV01.mmATMDiagnosticResponse,
						ATMDiagnosticResponseV01.mmSecurityTrailer);
	...
	public ATMDiagnosticResponse1 getATMDiagnosticResponse() {
		return aTMDiagnosticResponse;
	}

	public void setATMDiagnosticResponse(ATMDiagnosticResponse1 aTMDiagnosticResponse) {
