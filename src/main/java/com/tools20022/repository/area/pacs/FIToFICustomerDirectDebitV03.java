		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFICustomerDirectDebitV03.mmGroupHeader, FIToFICustomerDirectDebitV03.mmDirectDebitTransactionInformation, FIToFICustomerDirectDebitV03.mmSupplementaryData);
