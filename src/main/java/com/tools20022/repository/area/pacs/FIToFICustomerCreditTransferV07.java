 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintInstructingAgentRule#forFIToFICustomerCreditTransferV07
 * ConstraintInstructingAgentRule.forFIToFICustomerCreditTransferV07}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndSumRule#forFIToFICustomerCreditTransferV07
 ...
 * forFIToFICustomerCreditTransferV07}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule#forFIToFICustomerCreditTransferV07
 * ConstraintPaymentTypeInformationRule.forFIToFICustomerCreditTransferV07}</li>
 * <li>
...
public class FIToFICustomerCreditTransferV07 {
	...
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, GroupHeader70> mmGroupHeader = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, GroupHeader70>() {
		{
			...
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV06.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, List<CreditTransferTransaction30>> mmCreditTransferTransactionInformation = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, List<CreditTransferTransaction30>>() {
		{
			...
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV06.mmCreditTransferTransactionInformation;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV07, List<SupplementaryData1>>() {
		{
			...
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV06.mmSupplementaryData;
			minOccurs = 0;
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInstructedAgentRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintInstructingAgentRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndSumRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintGroupHeaderInterbankSettlementDateRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintTransactionInterbankSettlementDateRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintNumberOfTransactionsAndCreditTransfersRule.forFIToFICustomerCreditTransferV07,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forFIToFICustomerCreditTransferV07);
