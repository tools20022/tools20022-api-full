...
public class FIToFIPaymentReversalV06 {
	...
	public static final MMMessageBuildingBlock mmGroupHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV07.mmGroupHeader);
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.FIToFIPaymentReversalV05.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmOriginalGroupInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV07.mmOriginalGroupInformation);
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.FIToFIPaymentReversalV05.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmTransactionInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV07.mmTransactionInformation);
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.FIToFIPaymentReversalV05.mmTransactionInformation;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV07.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.FIToFIPaymentReversalV05.mmSupplementaryData;
			minOccurs = 0;
	...
	public void setTransactionInformation(List<PaymentTransaction60> transactionInformation) {
