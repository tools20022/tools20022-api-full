 ...
 * ConstraintOriginalGroupInformationAbsenceRule.forFIToFIPaymentStatusReportV09
 * }</li>
 * <li>
...
public class FIToFIPaymentStatusReportV09 {
	...
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, GroupHeader53> mmGroupHeader = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, GroupHeader53>() {
		{
			...
			previousVersion_lazy = () -> FIToFIPaymentStatusReportV08.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<OriginalGroupHeader13>> mmOriginalGroupInformationAndStatus = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<OriginalGroupHeader13>>() {
		{
			...
			previousVersion_lazy = () -> FIToFIPaymentStatusReportV08.mmOriginalGroupInformationAndStatus;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<PaymentTransaction91>> mmTransactionInformationAndStatus = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<PaymentTransaction91>>() {
		{
			...
			previousVersion_lazy = () -> FIToFIPaymentStatusReportV08.mmTransactionInformationAndStatus;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV09, List<SupplementaryData1>>() {
		{
			...
			previousVersion_lazy = () -> FIToFIPaymentStatusReportV08.mmSupplementaryData;
			minOccurs = 0;
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupStatusAcceptedRule.forFIToFIPaymentStatusReportV09,
						com.tools20022.repository.constraints.ConstraintGroupStatusPendingRule.forFIToFIPaymentStatusReportV09, com.tools20022.repository.constraints.ConstraintGroupStatusRejectedRule.forFIToFIPaymentStatusReportV09,
						com.tools20022.repository.constraints.ConstraintGroupStatusReceivedRule.forFIToFIPaymentStatusReportV09, com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forFIToFIPaymentStatusReportV09,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationAbsenceRule.forFIToFIPaymentStatusReportV09,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationSinglePresenceRule.forFIToFIPaymentStatusReportV09,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationMultiplePresenceRule.forFIToFIPaymentStatusReportV09);
