		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FinancialInstitutionCreditTransferV03.mmGroupHeader, FinancialInstitutionCreditTransferV03.mmCreditTransferTransactionInformation,
						FinancialInstitutionCreditTransferV03.mmSupplementaryData);
