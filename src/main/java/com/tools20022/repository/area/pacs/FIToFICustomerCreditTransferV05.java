		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFICustomerCreditTransferV05.mmGroupHeader, FIToFICustomerCreditTransferV05.mmCreditTransferTransactionInformation, FIToFICustomerCreditTransferV05.mmSupplementaryData);
