 ...
 * ConstraintPaymentTypeInformationRule.for_pacs_FIToFICustomerCreditTransferV05
 * }</li>
 * <li>
 ...
 * ConstraintSupplementaryDataRule.for_pacs_FIToFICustomerCreditTransferV05}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FIToFICustomerCreditTransferV05", propOrder = {"groupHeader", "creditTransferTransactionInformation", "supplementaryData"})
public class FIToFICustomerCreditTransferV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, GroupHeader49> mmGroupHeader = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, GroupHeader49>() {
		{
			xmlTag = "GrpHdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupHeader";
			definition = "Set of characteristics shared by all individual transactions included in the message.";
			nextVersions_lazy = () -> Arrays.asList(FIToFICustomerCreditTransferV06.mmGroupHeader);
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV04.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GroupHeader49 getValue(FIToFICustomerCreditTransferV05 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(FIToFICustomerCreditTransferV05 obj, GroupHeader49 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, List<CreditTransferTransaction19>> mmCreditTransferTransactionInformation = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, List<CreditTransferTransaction19>>() {
		{
			xmlTag = "CdtTrfTxInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CreditTransferTransactionInformation";
			definition = "Set of elements providing information specific to the individual credit transfer(s).";
			nextVersions_lazy = () -> Arrays.asList(FIToFICustomerCreditTransferV06.mmCreditTransferTransactionInformation);
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV04.mmCreditTransferTransactionInformation;
			minOccurs = 1;
			complexType_lazy = () -> CreditTransferTransaction19.mmObject();
		}

		@Override
		public List<CreditTransferTransaction19> getValue(FIToFICustomerCreditTransferV05 obj) {
			return obj.getCreditTransferTransactionInformation();
		}

		@Override
		public void setValue(FIToFICustomerCreditTransferV05 obj, List<CreditTransferTransaction19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FIToFICustomerCreditTransferV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(FIToFICustomerCreditTransferV06.mmSupplementaryData);
			previousVersion_lazy = () -> FIToFICustomerCreditTransferV04.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(FIToFICustomerCreditTransferV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(FIToFICustomerCreditTransferV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInstructedAgentRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintInstructingAgentRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndSumRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintGroupHeaderInterbankSettlementDateRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintTransactionInterbankSettlementDateRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintNumberOfTransactionsAndCreditTransfersRule.for_pacs_FIToFICustomerCreditTransferV05,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pacs_FIToFICustomerCreditTransferV05);
			...
			public Class<?> getInstanceClass() {
				return FIToFICustomerCreditTransferV05.class;
			}
		});
	...
	public FIToFICustomerCreditTransferV05 setGroupHeader(GroupHeader49 groupHeader) {
	...
	public FIToFICustomerCreditTransferV05 setCreditTransferTransactionInformation(List<CreditTransferTransaction19> creditTransferTransactionInformation) {
	...
	public FIToFICustomerCreditTransferV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public FIToFICustomerCreditTransferV05 messageBody;
	}
}