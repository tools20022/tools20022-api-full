 ...
 * {@linkplain com.tools20022.repository.area.pacs.PaymentReturnV04#identifier
 * PaymentReturnV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV05.GroupHeader);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OriginalGroupInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV05.OriginalGroupInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock TransactionInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV05.TransactionInformation);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV05.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV04.GroupHeader, com.tools20022.repository.area.pacs.PaymentReturnV04.OriginalGroupInformation,
						com.tools20022.repository.area.pacs.PaymentReturnV04.TransactionInformation, com.tools20022.repository.area.pacs.PaymentReturnV04.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV04.identifier;
			}
		});
