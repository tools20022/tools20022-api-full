...
public class FIToFIPaymentStatusReportV04 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFIPaymentStatusReportV04.mmGroupHeader, FIToFIPaymentStatusReportV04.mmOriginalGroupInformationAndStatus, FIToFIPaymentStatusReportV04.mmTransactionInformationAndStatus,
						FIToFIPaymentStatusReportV04.mmSupplementaryData);
	...
	public void setTransactionInformationAndStatus(List<PaymentTransaction33> transactionInformationAndStatus) {
