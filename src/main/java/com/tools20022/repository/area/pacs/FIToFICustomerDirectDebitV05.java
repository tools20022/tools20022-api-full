		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFICustomerDirectDebitV05.mmGroupHeader, FIToFICustomerDirectDebitV05.mmDirectDebitTransactionInformation, FIToFICustomerDirectDebitV05.mmSupplementaryData);
