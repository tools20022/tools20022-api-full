 ...
 * {@linkplain com.tools20022.repository.area.pacs.PaymentReturnV06#identifier
 * PaymentReturnV06.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV05.GroupHeader;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV07.GroupHeader);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OriginalGroupInformation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV05.OriginalGroupInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV07.OriginalGroupInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock TransactionInformation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV05.TransactionInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV07.TransactionInformation);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV05.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV07.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.PaymentReturnV06.GroupHeader, com.tools20022.repository.area.pacs.PaymentReturnV06.OriginalGroupInformation,
						com.tools20022.repository.area.pacs.PaymentReturnV06.TransactionInformation, com.tools20022.repository.area.pacs.PaymentReturnV06.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.pacs.PaymentReturnV06.identifier;
			}
		});
