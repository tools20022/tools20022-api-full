...
public class PaymentReturnV06 {
	...
	public void setTransactionInformation(List<PaymentTransaction65> transactionInformation) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.004.06.06")
