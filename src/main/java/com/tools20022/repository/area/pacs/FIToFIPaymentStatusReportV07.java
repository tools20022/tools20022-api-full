 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOriginalGroupInformationSinglePresenceRule#for_pacs_FIToFIPaymentStatusReportV07
 * ConstraintOriginalGroupInformationSinglePresenceRule.
 * for_pacs_FIToFIPaymentStatusReportV07}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOriginalGroupInformationMultiplePresenceRule#for_pacs_FIToFIPaymentStatusReportV07
...
public class FIToFIPaymentStatusReportV07 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, GroupHeader53> mmGroupHeader = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, GroupHeader53>() {
		{
			xmlTag = "GrpHdr";
		...
		@Override
		public GroupHeader53 getValue(FIToFIPaymentStatusReportV07 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(FIToFIPaymentStatusReportV07 obj, GroupHeader53 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<OriginalGroupHeader1>> mmOriginalGroupInformationAndStatus = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<OriginalGroupHeader1>>() {
		{
		...
		@Override
		public List<OriginalGroupHeader1> getValue(FIToFIPaymentStatusReportV07 obj) {
			return obj.getOriginalGroupInformationAndStatus();
		}

		@Override
		public void setValue(FIToFIPaymentStatusReportV07 obj, List<OriginalGroupHeader1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<PaymentTransaction63>> mmTransactionInformationAndStatus = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<PaymentTransaction63>>() {
		{
			xmlTag = "TxInfAndSts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PaymentTransaction63> getValue(FIToFIPaymentStatusReportV07 obj) {
			return obj.getTransactionInformationAndStatus();
		}

		@Override
		public void setValue(FIToFIPaymentStatusReportV07 obj, List<PaymentTransaction63> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FIToFIPaymentStatusReportV07, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(FIToFIPaymentStatusReportV07 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(FIToFIPaymentStatusReportV07 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupStatusAcceptedRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintGroupStatusPendingRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintGroupStatusRejectedRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintGroupStatusReceivedRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationAbsenceRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationSinglePresenceRule.for_pacs_FIToFIPaymentStatusReportV07,
						com.tools20022.repository.constraints.ConstraintOriginalGroupInformationMultiplePresenceRule.for_pacs_FIToFIPaymentStatusReportV07);
	...
	public FIToFIPaymentStatusReportV07 setGroupHeader(GroupHeader53 groupHeader) {
	...
	public FIToFIPaymentStatusReportV07 setOriginalGroupInformationAndStatus(List<OriginalGroupHeader1> originalGroupInformationAndStatus) {
	...
	public FIToFIPaymentStatusReportV07 setTransactionInformationAndStatus(List<PaymentTransaction63> transactionInformationAndStatus) {
	...
	public FIToFIPaymentStatusReportV07 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
