		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcquirerReversalInitiation.mmHeader, AcquirerReversalInitiation.mmReversalInitiation, AcquirerReversalInitiation.mmSecurityTrailer);
