		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ForeignExchangeTradeInstructionCancellationV02.mmTradeInformation, ForeignExchangeTradeInstructionCancellationV02.mmTradingSideIdentification,
						ForeignExchangeTradeInstructionCancellationV02.mmCounterpartySideIdentification, ForeignExchangeTradeInstructionCancellationV02.mmAgreedRate,
						...
						ForeignExchangeTradeInstructionCancellationV02.mmOptionalGeneralInformation, ForeignExchangeTradeInstructionCancellationV02.mmTradeAmounts, ForeignExchangeTradeInstructionCancellationV02.mmRegulatoryReporting,
						ForeignExchangeTradeInstructionCancellationV02.mmSupplementaryData);
