...
public class CertificateManagementResponseV02 {
	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return CertificateManagementResponseV02.class.getMethod("getHeader", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmCertificateManagementResponse = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return CertificateManagementResponseV02.class.getMethod("getCertificateManagementResponse", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return CertificateManagementResponseV02.class.getMethod("getSecurityTrailer", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
