		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MaintenanceDelegationRequestV03.mmHeader, MaintenanceDelegationRequestV03.mmMaintenanceDelegationRequest, MaintenanceDelegationRequestV03.mmSecurityTrailer);
