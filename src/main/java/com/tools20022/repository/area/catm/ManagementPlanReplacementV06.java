		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ManagementPlanReplacementV06.mmHeader, ManagementPlanReplacementV06.mmManagementPlan, ManagementPlanReplacementV06.mmSecurityTrailer);
