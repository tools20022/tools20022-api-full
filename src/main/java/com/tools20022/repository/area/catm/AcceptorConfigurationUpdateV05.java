		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorConfigurationUpdateV05.mmHeader, AcceptorConfigurationUpdateV05.mmAcceptorConfiguration, AcceptorConfigurationUpdateV05.mmSecurityTrailer);
