...
@XmlType(name = "StatusReportV04", propOrder = {"header", "statusReport", "securityTrailer"})
public class StatusReportV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusReportV04, Header14> mmHeader = new MMMessageBuildingBlock<StatusReportV04, Header14>() {
		{
			xmlTag = "Hdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Header";
			definition = "Set of characteristics related to the transfer of the status report.";
			nextVersions_lazy = () -> Arrays.asList(StatusReportV05.mmHeader);
			previousVersion_lazy = () -> StatusReportV03.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Header14 getValue(StatusReportV04 obj) {
			return obj.getHeader();
		}

		@Override
		public void setValue(StatusReportV04 obj, Header14 value) {
			obj.setHeader(value);
		}
	};
	@XmlElement(name = "StsRpt", required = true)
	protected StatusReport4 statusReport;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusReportV04, StatusReport4> mmStatusReport = new MMMessageBuildingBlock<StatusReportV04, StatusReport4>() {
		{
			xmlTag = "StsRpt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "StatusReport";
			definition = "Status of the point of interaction (POI), its components and their installed versions.";
			nextVersions_lazy = () -> Arrays.asList(StatusReportV05.mmStatusReport);
			previousVersion_lazy = () -> StatusReportV03.mmStatusReport;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public StatusReport4 getValue(StatusReportV04 obj) {
			return obj.getStatusReport();
		}

		@Override
		public void setValue(StatusReportV04 obj, StatusReport4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusReportV04, ContentInformationType12> mmSecurityTrailer = new MMMessageBuildingBlock<StatusReportV04, ContentInformationType12>() {
		{
			xmlTag = "SctyTrlr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityTrailer";
			definition = "Trailer of the message containing a MAC or a digital signature.";
			nextVersions_lazy = () -> Arrays.asList(StatusReportV05.mmSecurityTrailer);
			previousVersion_lazy = () -> StatusReportV03.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ContentInformationType12 getValue(StatusReportV04 obj) {
			return obj.getSecurityTrailer();
		}

		@Override
		public void setValue(StatusReportV04 obj, ContentInformationType12 value) {
	...
	public StatusReportV04 setHeader(Header14 header) {
	...
	public StatusReportV04 setStatusReport(StatusReport4 statusReport) {
	...
	public StatusReportV04 setSecurityTrailer(ContentInformationType12 securityTrailer) {
	...
	static public class Document {
		@XmlElement(name = "StsRpt", required = true)
		public StatusReportV04 messageBody;
	}
}