	...
	public static final MMMessageBuildingBlock mmHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.StatusReportV05.mmHeader);
			previousVersion_lazy = () -> com.tools20022.repository.area.catm.StatusReportV03.mmHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmStatusReport = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.StatusReportV05.mmStatusReport);
			previousVersion_lazy = () -> com.tools20022.repository.area.catm.StatusReportV03.mmStatusReport;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSecurityTrailer = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.StatusReportV05.mmSecurityTrailer);
			previousVersion_lazy = () -> com.tools20022.repository.area.catm.StatusReportV03.mmSecurityTrailer;
			maxOccurs = 1;
			minOccurs = 1;
