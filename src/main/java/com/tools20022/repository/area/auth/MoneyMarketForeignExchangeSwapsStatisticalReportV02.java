 ...
 * {@linkplain com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV02#identifier
 * MoneyMarketForeignExchangeSwapsStatisticalReportV02.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock ReportHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV01.ReportHeader;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock ForeignExchangeSwapsReport = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV01.ForeignExchangeSwapsReport;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV01.SupplementaryData;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV02.ReportHeader,
						com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV02.ForeignExchangeSwapsReport,
						com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV02.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.auth.MoneyMarketForeignExchangeSwapsStatisticalReportV02.identifier;
			}
		});
