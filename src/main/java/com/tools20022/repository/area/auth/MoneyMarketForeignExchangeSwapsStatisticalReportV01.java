...
public class MoneyMarketForeignExchangeSwapsStatisticalReportV01 {
	...
	public MoneyMarketForeignExchangeSwapsStatisticalReportV01 setReportHeader(MoneyMarketReportHeader1 reportHeader) {
	...
	public MoneyMarketForeignExchangeSwapsStatisticalReportV01 setForeignExchangeSwapsReport(ForeignExchangeSwap2Choice foreignExchangeSwapsReport) {
	...
	public MoneyMarketForeignExchangeSwapsStatisticalReportV01 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
