...
public class FinancialInstrumentReportingEquityTransparencyDataReportV01 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, SecuritiesMarketReportHeader1> mmReportHeader = new MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, SecuritiesMarketReportHeader1>() {
		{
			xmlTag = "RptHdr";
		...
		@Override
		public SecuritiesMarketReportHeader1 getValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj) {
			return obj.getReportHeader();
		}

		@Override
		public void setValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj, SecuritiesMarketReportHeader1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, List<TransparencyDataReport11>> mmEquityTransparencyData = new MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, List<TransparencyDataReport11>>() {
		{
		...
		@Override
		public List<TransparencyDataReport11> getValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj) {
			return obj.getEquityTransparencyData();
		}

		@Override
		public void setValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj, List<TransparencyDataReport11> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FinancialInstrumentReportingEquityTransparencyDataReportV01, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(FinancialInstrumentReportingEquityTransparencyDataReportV01 obj, List<SupplementaryData1> value) {
