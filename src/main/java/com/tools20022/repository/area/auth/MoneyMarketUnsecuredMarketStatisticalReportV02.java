		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MoneyMarketUnsecuredMarketStatisticalReportV02.mmReportHeader, MoneyMarketUnsecuredMarketStatisticalReportV02.mmUnsecuredMarketReport,
						MoneyMarketUnsecuredMarketStatisticalReportV02.mmSupplementaryData);
