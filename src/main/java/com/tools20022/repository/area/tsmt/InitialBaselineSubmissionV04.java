 ...
 * {@linkplain com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04#identifier
 * InitialBaselineSubmissionV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock SubmissionIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.SubmissionIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.SubmissionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SubmitterTransactionReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.SubmitterTransactionReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.SubmitterTransactionReference);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Instruction = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.Instruction;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.Instruction);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Baseline = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.Baseline;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.Baseline);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock BuyerContactPerson = new MMMessageBuildingBlock() {
		{
			...
			definition = "Person to be contacted in the organisation of the buyer. ";
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.BuyerContactPerson;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.BuyerContactPerson);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock SellerContactPerson = new MMMessageBuildingBlock() {
		{
			...
			definition = "Person to be contacted in the organisation of the seller.";
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.SellerContactPerson;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.SellerContactPerson);
			minOccurs = 0;
			complexType_lazy = () -> ContactIdentification1.mmObject();
		}
	};
	...
	public static final MMMessageBuildingBlock BankContactPerson = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.BankContactPerson);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OtherBankContactPerson = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV03.OtherBankContactPerson;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV05.OtherBankContactPerson);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.SubmissionIdentification,
						com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.SubmitterTransactionReference, com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.Instruction,
						com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.Baseline, com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.BuyerContactPerson,
						com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.SellerContactPerson, com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.BankContactPerson,
						com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.OtherBankContactPerson);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.tsmt.InitialBaselineSubmissionV04.identifier;
			}
		});
