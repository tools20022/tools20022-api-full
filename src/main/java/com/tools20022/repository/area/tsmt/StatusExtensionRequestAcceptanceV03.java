		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(StatusExtensionRequestAcceptanceV03.mmAcceptanceIdentification, StatusExtensionRequestAcceptanceV03.mmTransactionIdentification,
						StatusExtensionRequestAcceptanceV03.mmSubmitterTransactionReference, StatusExtensionRequestAcceptanceV03.mmExtendedStatus);
