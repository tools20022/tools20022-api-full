 ...
 * messageDefinition} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.area.remt.RemittanceAdviceV01
 ...
 * "Payments Remittance Advice - Archive - master"</li>
 ...
 * </ul>
 */
public class PaymentsRemittanceAdviceArchive {
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessArea() {
			{
				...
				name = "Payments Remittance Advice - Archive - master";
				...
				messageDefinition_lazy = () -> Arrays.asList(RemittanceAdviceV01.mmObject());
				code = "remt";
			}
		});
