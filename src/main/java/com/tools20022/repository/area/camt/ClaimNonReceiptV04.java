 ...
 * {@linkplain com.tools20022.repository.area.camt.ClaimNonReceiptV04#identifier
 * ClaimNonReceiptV04.identifier}</li>
 * <li>
...
public class ClaimNonReceiptV04 {
	...
	public static final MMMessageBuildingBlock Assignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV05.Assignment);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.area.camt.ClaimNonReceiptV05#Case
	...
	public static final MMMessageBuildingBlock Case = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV05.Case);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Underlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV05.Underlying);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CoverDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV05.CoverDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV05.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV04.Assignment, com.tools20022.repository.area.camt.ClaimNonReceiptV04.Case,
						com.tools20022.repository.area.camt.ClaimNonReceiptV04.Underlying, com.tools20022.repository.area.camt.ClaimNonReceiptV04.CoverDetails, com.tools20022.repository.area.camt.ClaimNonReceiptV04.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.camt.ClaimNonReceiptV04.identifier;
			}
		});
