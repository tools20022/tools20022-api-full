 ...
 * ConstraintMessageOrReportPaginationRule.forBankToCustomerAccountReportV05}</li>
 * <li>
...
public class BankToCustomerAccountReportV05 {
	...
	public static final MMMessageBuildingBlock mmGroupHeader = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerAccountReportV05.class.getMethod("getGroupHeader", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmReport = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerAccountReportV05.class.getMethod("getReport", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerAccountReportV05.class.getMethod("getSupplementaryData", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrReportPaginationRule.forBankToCustomerAccountReportV05,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forBankToCustomerAccountReportV05);
