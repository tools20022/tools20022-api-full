		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(BankToCustomerAccountReportV04.mmGroupHeader, BankToCustomerAccountReportV04.mmReport, BankToCustomerAccountReportV04.mmSupplementaryData);
