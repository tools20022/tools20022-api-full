...
@XmlType(name = "FIToFIPaymentCancellationRequestV04", propOrder = {"assignment", "case", "controlData", "underlying", "supplementaryData"})
public class FIToFIPaymentCancellationRequestV04 {
	...
	public void setUnderlying(List<UnderlyingTransaction10> underlying) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.056.04.04")
