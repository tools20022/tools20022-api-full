...
public class RequestToModifyPaymentV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestToModifyPaymentV04, CaseAssignment3> mmAssignment = new MMMessageBuildingBlock<RequestToModifyPaymentV04, CaseAssignment3>() {
		{
			xmlTag = "Assgnmt";
		...
		@Override
		public CaseAssignment3 getValue(RequestToModifyPaymentV04 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(RequestToModifyPaymentV04 obj, CaseAssignment3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestToModifyPaymentV04, Case3> mmCase = new MMMessageBuildingBlock<RequestToModifyPaymentV04, Case3>() {
		{
			xmlTag = "Case";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Case";
		...
		@Override
		public Case3 getValue(RequestToModifyPaymentV04 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(RequestToModifyPaymentV04 obj, Case3 value) {
			obj.setCase(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestToModifyPaymentV04, UnderlyingTransaction3Choice> mmUnderlying = new MMMessageBuildingBlock<RequestToModifyPaymentV04, UnderlyingTransaction3Choice>() {
		{
			xmlTag = "Undrlyg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Underlying";
		...
		@Override
		public UnderlyingTransaction3Choice getValue(RequestToModifyPaymentV04 obj) {
			return obj.getUnderlying();
		}

		@Override
		public void setValue(RequestToModifyPaymentV04 obj, UnderlyingTransaction3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestToModifyPaymentV04, RequestedModification6> mmModification = new MMMessageBuildingBlock<RequestToModifyPaymentV04, RequestedModification6>() {
		{
			xmlTag = "Mod";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Modification";
		...
		@Override
		public RequestedModification6 getValue(RequestToModifyPaymentV04 obj) {
			return obj.getModification();
		}

		@Override
		public void setValue(RequestToModifyPaymentV04 obj, RequestedModification6 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RequestToModifyPaymentV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<RequestToModifyPaymentV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(RequestToModifyPaymentV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(RequestToModifyPaymentV04 obj, List<SupplementaryData1> value) {
