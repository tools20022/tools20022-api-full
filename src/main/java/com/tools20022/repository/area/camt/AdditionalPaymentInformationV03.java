...
public class AdditionalPaymentInformationV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AdditionalPaymentInformationV03, CaseAssignment2> mmAssignment = new MMMessageBuildingBlock<AdditionalPaymentInformationV03, CaseAssignment2>() {
		{
			xmlTag = "Assgnmt";
		...
		@Override
		public CaseAssignment2 getValue(AdditionalPaymentInformationV03 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(AdditionalPaymentInformationV03 obj, CaseAssignment2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AdditionalPaymentInformationV03, Case2> mmCase = new MMMessageBuildingBlock<AdditionalPaymentInformationV03, Case2>() {
		{
			xmlTag = "Case";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Case";
		...
		@Override
		public Case2 getValue(AdditionalPaymentInformationV03 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(AdditionalPaymentInformationV03 obj, Case2 value) {
			obj.setCase(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AdditionalPaymentInformationV03, UnderlyingTransaction1Choice> mmUnderlying = new MMMessageBuildingBlock<AdditionalPaymentInformationV03, UnderlyingTransaction1Choice>() {
		{
			xmlTag = "Undrlyg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Underlying";
		...
		@Override
		public UnderlyingTransaction1Choice getValue(AdditionalPaymentInformationV03 obj) {
			return obj.getUnderlying();
		}

		@Override
		public void setValue(AdditionalPaymentInformationV03 obj, UnderlyingTransaction1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AdditionalPaymentInformationV03, PaymentComplementaryInformation2> mmInformation = new MMMessageBuildingBlock<AdditionalPaymentInformationV03, PaymentComplementaryInformation2>() {
		{
			xmlTag = "Inf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Information";
		...
		@Override
		public PaymentComplementaryInformation2 getValue(AdditionalPaymentInformationV03 obj) {
			return obj.getInformation();
		}

		@Override
		public void setValue(AdditionalPaymentInformationV03 obj, PaymentComplementaryInformation2 value) {
