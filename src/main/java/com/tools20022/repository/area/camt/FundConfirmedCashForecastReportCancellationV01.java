...
public class FundConfirmedCashForecastReportCancellationV01 {
	...
	public static final MMMessageBuildingBlock mmPoolReference = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return FundConfirmedCashForecastReportCancellationV01.class.getMethod("getPoolReference", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmPreviousReference = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return FundConfirmedCashForecastReportCancellationV01.class.getMethod("getPreviousReference", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmRelatedReference = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return FundConfirmedCashForecastReportCancellationV01.class.getMethod("getRelatedReference", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmCashForecastReportToBeCancelled = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return FundConfirmedCashForecastReportCancellationV01.class.getMethod("getCashForecastReportToBeCancelled", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
