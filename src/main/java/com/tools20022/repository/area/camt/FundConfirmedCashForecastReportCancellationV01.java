...
@XmlType(name = "camt.044.001.01", propOrder = {"poolReference", "previousReference", "relatedReference", "cashForecastReportToBeCancelled"})
public class FundConfirmedCashForecastReportCancellationV01 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
		...
		@Override
		public Optional<AdditionalReference3> getValue(FundConfirmedCashForecastReportCancellationV01 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(FundConfirmedCashForecastReportCancellationV01 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, AdditionalReference3> mmPreviousReference = new MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, AdditionalReference3>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public AdditionalReference3 getValue(FundConfirmedCashForecastReportCancellationV01 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(FundConfirmedCashForecastReportCancellationV01 obj, AdditionalReference3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, List<AdditionalReference3>> mmRelatedReference = new MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, List<AdditionalReference3>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<AdditionalReference3> getValue(FundConfirmedCashForecastReportCancellationV01 obj) {
			return obj.getRelatedReference();
		}

		@Override
		public void setValue(FundConfirmedCashForecastReportCancellationV01 obj, List<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, Optional<FundConfirmedCashForecastReport1>> mmCashForecastReportToBeCancelled = new MMMessageBuildingBlock<FundConfirmedCashForecastReportCancellationV01, Optional<FundConfirmedCashForecastReport1>>() {
		{
		...
		@Override
		public Optional<FundConfirmedCashForecastReport1> getValue(FundConfirmedCashForecastReportCancellationV01 obj) {
			return obj.getCashForecastReportToBeCancelled();
		}

		@Override
		public void setValue(FundConfirmedCashForecastReportCancellationV01 obj, Optional<FundConfirmedCashForecastReport1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return FundConfirmedCashForecastReportCancellationV01.class;
			}
		});
	...
	public FundConfirmedCashForecastReportCancellationV01 setPoolReference(AdditionalReference3 poolReference) {
	...
	public FundConfirmedCashForecastReportCancellationV01 setPreviousReference(AdditionalReference3 previousReference) {
	...
	public FundConfirmedCashForecastReportCancellationV01 setRelatedReference(List<AdditionalReference3> relatedReference) {
	...
	public FundConfirmedCashForecastReportCancellationV01 setCashForecastReportToBeCancelled(FundConfirmedCashForecastReport1 cashForecastReportToBeCancelled) {
		this.cashForecastReportToBeCancelled = cashForecastReportToBeCancelled;
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.044.001.01")
	static public class Document {
		@XmlElement(name = "camt.044.001.01", required = true)
		public FundConfirmedCashForecastReportCancellationV01 messageBody;
	}
}