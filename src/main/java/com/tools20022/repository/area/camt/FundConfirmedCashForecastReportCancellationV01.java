		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FundConfirmedCashForecastReportCancellationV01.mmPoolReference, FundConfirmedCashForecastReportCancellationV01.mmPreviousReference,
						FundConfirmedCashForecastReportCancellationV01.mmRelatedReference, FundConfirmedCashForecastReportCancellationV01.mmCashForecastReportToBeCancelled);
