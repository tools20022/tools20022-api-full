 ...
 * {@linkplain com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04#identifier
 * CustomerPaymentCancellationRequestV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Assignment = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.Assignment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.Assignment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Case = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.Case;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.Case);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock ControlData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.ControlData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.ControlData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Underlying = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.Underlying;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.Underlying);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.Assignment, com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.Case,
						com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.ControlData, com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.Underlying,
						com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV04.identifier;
			}
		});
