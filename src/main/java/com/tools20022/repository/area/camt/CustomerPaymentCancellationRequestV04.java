...
public class CustomerPaymentCancellationRequestV04 {
	...
	public static final MMMessageBuildingBlock mmAssignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.mmAssignment);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmAssignment;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCase = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.mmCase);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmCase;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmControlData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.mmControlData);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmControlData;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmUnderlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.mmUnderlying);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmUnderlying;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV05.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmSupplementaryData;
			minOccurs = 0;
	...
	public void setUnderlying(List<UnderlyingTransaction11> underlying) {
