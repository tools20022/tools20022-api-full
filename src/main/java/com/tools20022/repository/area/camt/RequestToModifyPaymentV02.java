	...
	public static final MMMessageBuildingBlock mmAssignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.mmAssignment);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.mmAssignment;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCase = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.mmCase);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.mmCase;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmUnderlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.mmUnderlying);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.mmUnderlying;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmModification = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.mmModification);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.mmModification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.mmSupplementaryData;
			minOccurs = 0;
