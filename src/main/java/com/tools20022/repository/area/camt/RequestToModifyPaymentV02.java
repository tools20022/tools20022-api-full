		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(RequestToModifyPaymentV02.mmAssignment, RequestToModifyPaymentV02.mmCase, RequestToModifyPaymentV02.mmUnderlying, RequestToModifyPaymentV02.mmModification,
						RequestToModifyPaymentV02.mmSupplementaryData);
