		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AdditionalPaymentInformationV04.mmAssignment, AdditionalPaymentInformationV04.mmCase, AdditionalPaymentInformationV04.mmUnderlying,
						AdditionalPaymentInformationV04.mmInformation, AdditionalPaymentInformationV04.mmSupplementaryData);
