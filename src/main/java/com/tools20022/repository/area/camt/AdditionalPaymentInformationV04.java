...
@XmlType(name = "AdditionalPaymentInformationV04", propOrder = {"assignment", "case", "underlying", "information", "supplementaryData"})
public class AdditionalPaymentInformationV04 {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.028.04.04")
