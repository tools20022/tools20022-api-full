...
public class AdditionalPaymentInformationV04 {
	...
	public static final MMMessageBuildingBlock mmAssignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.AdditionalPaymentInformationV05.mmAssignment);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCase = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.AdditionalPaymentInformationV05.mmCase);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmUnderlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.AdditionalPaymentInformationV05.mmUnderlying);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.AdditionalPaymentInformationV05.mmInformation);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.AdditionalPaymentInformationV05.mmSupplementaryData);
			minOccurs = 0;
	...
	public void setInformation(PaymentComplementaryInformation3 information) {
