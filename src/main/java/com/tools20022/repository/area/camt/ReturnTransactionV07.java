 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCurrencyGuideline#for_camt_ReturnTransactionV07
 * ConstraintCurrencyGuideline.for_camt_ReturnTransactionV07}</li>
 * </ul>
 * </li>
 * <li>
...
public class ReturnTransactionV07 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCurrencyGuideline.for_camt_ReturnTransactionV07);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
