 ...
 * ConstraintSupplementaryDataRule.forBankToCustomerDebitCreditNotificationV04}</li>
 * </ul>
 * </li>
 * <li>
...
public class BankToCustomerDebitCreditNotificationV04 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrNotificationPaginationRule.forBankToCustomerDebitCreditNotificationV04,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forBankToCustomerDebitCreditNotificationV04);
