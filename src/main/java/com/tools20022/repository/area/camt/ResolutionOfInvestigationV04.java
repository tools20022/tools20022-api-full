...
public class ResolutionOfInvestigationV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, CaseAssignment3> mmAssignment = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, CaseAssignment3>() {
		{
			xmlTag = "Assgnmt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Assignment";
			definition = "Identifies the assignment of an investigation case from an assigner to an assignee.\nUsage: The Assigner must be the sender of this confirmation and the Assignee must be the receiver.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmAssignment);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CaseAssignment3 getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, CaseAssignment3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<Case3>> mmResolvedCase = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<Case3>>() {
		{
			xmlTag = "RslvdCase";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ResolvedCase";
			definition = "Identifies a resolved case.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmResolvedCase);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Case3> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getResolvedCase();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, InvestigationStatus3Choice> mmStatus = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, InvestigationStatus3Choice>() {
		{
			xmlTag = "Sts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Status";
			definition = "Indicates the status of the investigation.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmStatus);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InvestigationStatus3Choice getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, InvestigationStatus3Choice value) {
			obj.setStatus(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, List<UnderlyingTransaction4>> mmCancellationDetails = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, List<UnderlyingTransaction4>>() {
		{
			xmlTag = "CxlDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CancellationDetails";
			definition = "Specifies the details of the underlying transactions being cancelled.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmCancellationDetails);
			minOccurs = 0;
			complexType_lazy = () -> UnderlyingTransaction4.mmObject();
		}

		@Override
		public List<UnderlyingTransaction4> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getCancellationDetails();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, List<UnderlyingTransaction4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<StatementResolutionEntry2>> mmStatementDetails = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<StatementResolutionEntry2>>() {
		{
			xmlTag = "StmtDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "StatementDetails";
			definition = "Details on the underlying statement entry.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmStatementDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StatementResolutionEntry2> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getStatementDetails();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, Optional<StatementResolutionEntry2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<CorrectiveTransaction1Choice>> mmCorrectionTransaction = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<CorrectiveTransaction1Choice>>() {
		{
			xmlTag = "CrrctnTx";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorrectionTransaction";
			definition = "References a transaction initiated to fix the case under investigation.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmCorrectionTransaction);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CorrectiveTransaction1Choice> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getCorrectionTransaction();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, Optional<CorrectiveTransaction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<ResolutionInformation1>> mmResolutionRelatedInformation = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, Optional<ResolutionInformation1>>() {
		{
			xmlTag = "RsltnRltdInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmResolutionRelatedInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ResolutionInformation1> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getResolutionRelatedInformation();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, Optional<ResolutionInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<ResolutionOfInvestigationV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<ResolutionOfInvestigationV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(ResolutionOfInvestigationV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(ResolutionOfInvestigationV04 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPartialOrRejectedCancellationRule.for_camt_ResolutionOfInvestigationV04,
						com.tools20022.repository.constraints.ConstraintMessageOrGroupResolvedCaseRule.for_camt_ResolutionOfInvestigationV04,
						com.tools20022.repository.constraints.ConstraintMessageOrPaymentInformationResolvedCaseRule.for_camt_ResolutionOfInvestigationV04,
						com.tools20022.repository.constraints.ConstraintMessageOrInitiationTransactionResolvedCaseRule.for_camt_ResolutionOfInvestigationV04,
						com.tools20022.repository.constraints.ConstraintMessageOrInterbankTransactionResolvedCaseRule.for_camt_ResolutionOfInvestigationV04);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ResolutionOfInvestigationV04";
				definition = "Scope\r\nThe Resolution Of Investigation message is sent by a case assignee to a case creator/case assigner.\r\nThis message is used to inform of the resolution of a case, and optionally provides details about.\r\n- the corrective action undertaken by the case assignee\r\n- information on the return where applicable\r\nUsage\r\nThe Resolution Of Investigation message is used by the case assignee to inform a case creator or case assigner about the resolution of a:\r\n- request to cancel payment case\r\n- request to modify payment case\r\n- unable to apply case\r\n- claim non receipt case\r\nThe Resolution Of Investigation message covers one and only one case at a time. If the case assignee needs to communicate about several cases, then several Resolution Of Investigation messages must be sent.\r\nThe Resolution Of Investigation message provides:\r\n- the final outcome of the case, whether positive or negative\r\n- optionally, the details of the corrective action undertaken by the case assignee and the information of the return\r\nWhenever a payment instruction has been generated to solve the case under investigation following a claim non receipt or an unable to apply, the optional CorrectionTransaction component present in the message must be completed.\r\nWhenever the action of modifying or cancelling a payment results in funds being returned or reversed, an investigating agent may provide the details in the resolution related investigation component, to identify the return or reversal transaction. These details will facilitate the account reconciliations at the initiating bank and the intermediaries. It must be stressed that the return or reversal of funds is outside the scope of this Exceptions and Investigation service. The features given here is only meant to transmit the information of return or reversal when it is available through the resolution of the case.\r\nThe Resolution Of Investigation message must:\r\n- be forwarded by all subsequent case assignee(s) until it reaches the case creator\r\n- not be used in place of a Reject Case Assignment or Case Status Report or Notification Of Case Assignment message\r\nTake note of an exceptional rule that allows the use of Resolution Of Investigation in lieu of a Case Status Report. Case Status Report is a response-message to a Case Status Report Request. The latter which is sent when the assigner has reached its own time-out threshold to receive a response. However it may happen that when the Request arrives, the investigating agent has just obtained a resolution. In such a situation, it would be redundant to send a Case Status Report when then followed immediately by a Resolution Of Investigation. It is therefore quite acceptable for the investigating agent, the assignee, to skip the Case Status Report and send the Resolution Of Investigation message directly.\r\nThe Resolution Of Investigation message should be the sole message to respond to a cancellation request. Details of the underlying transactions and the related statuses for which the cancellation request has been issued may be provided in the Cancellation Details component.";
				nextVersions_lazy = () -> Arrays.asList(ResolutionOfInvestigationV05.mmObject());
				previousVersion_lazy = () -> ResolutionOfInvestigationV03.mmObject();
