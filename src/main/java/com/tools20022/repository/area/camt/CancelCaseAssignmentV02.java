...
public class CancelCaseAssignmentV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CancelCaseAssignmentV02, CaseAssignment2> mmAssignment = new MMMessageBuildingBlock<CancelCaseAssignmentV02, CaseAssignment2>() {
		{
			xmlTag = "Assgnmt";
		...
		@Override
		public CaseAssignment2 getValue(CancelCaseAssignmentV02 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(CancelCaseAssignmentV02 obj, CaseAssignment2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CancelCaseAssignmentV02, Case2> mmCase = new MMMessageBuildingBlock<CancelCaseAssignmentV02, Case2>() {
		{
			xmlTag = "Case";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Case";
		...
		@Override
		public Case2 getValue(CancelCaseAssignmentV02 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(CancelCaseAssignmentV02 obj, Case2 value) {
			obj.setCase(value);
		}
	};
