 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule#forCustomerPaymentCancellationRequestV03
 * ConstraintMessageOrGroupCaseRule.forCustomerPaymentCancellationRequestV03}</li>
 * <li>
 ...
 * ConstraintSupplementaryDataRule.forCustomerPaymentCancellationRequestV03}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CustomerPaymentCancellationRequestV03", propOrder = {"assignment", "case_", "controlData", "underlying", "supplementaryData"})
public class CustomerPaymentCancellationRequestV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, CaseAssignment3> mmAssignment = new MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, CaseAssignment3>() {
		{
			xmlTag = "Assgnmt";
		...
		@Override
		public CaseAssignment3 getValue(CustomerPaymentCancellationRequestV03 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(CustomerPaymentCancellationRequestV03 obj, CaseAssignment3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, Optional<Case3>> mmCase = new MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, Optional<Case3>>() {
		{
			xmlTag = "Case";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Case";
		...
		@Override
		public Optional<Case3> getValue(CustomerPaymentCancellationRequestV03 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(CustomerPaymentCancellationRequestV03 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, Optional<ControlData1>> mmControlData = new MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, Optional<ControlData1>>() {
		{
			xmlTag = "CtrlData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ControlData";
		...
		@Override
		public Optional<ControlData1> getValue(CustomerPaymentCancellationRequestV03 obj) {
			return obj.getControlData();
		}

		@Override
		public void setValue(CustomerPaymentCancellationRequestV03 obj, Optional<ControlData1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, List<UnderlyingTransaction7>> mmUnderlying = new MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, List<UnderlyingTransaction7>>() {
		{
			xmlTag = "Undrlyg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Underlying";
		...
		@Override
		public List<UnderlyingTransaction7> getValue(CustomerPaymentCancellationRequestV03 obj) {
			return obj.getUnderlying();
		}

		@Override
		public void setValue(CustomerPaymentCancellationRequestV03 obj, List<UnderlyingTransaction7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerPaymentCancellationRequestV03, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(CustomerPaymentCancellationRequestV03 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerPaymentCancellationRequestV03 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule.forCustomerPaymentCancellationRequestV03,
						com.tools20022.repository.constraints.ConstraintMessageOrPaymentInformationCaseRule.forCustomerPaymentCancellationRequestV03,
						com.tools20022.repository.constraints.ConstraintMessageOrTransactionCaseRule.forCustomerPaymentCancellationRequestV03,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forCustomerPaymentCancellationRequestV03);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmAssignment, com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmCase,
						com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmControlData, com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmUnderlying,
						com.tools20022.repository.area.camt.CustomerPaymentCancellationRequestV03.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return CustomerPaymentCancellationRequestV03.class;
			}
		});
	...
	public CustomerPaymentCancellationRequestV03 setAssignment(CaseAssignment3 assignment) {
	...
	public CustomerPaymentCancellationRequestV03 setCase(Case3 case_) {
		this.case_ = case_;
		return this;
	}
	...
	public CustomerPaymentCancellationRequestV03 setControlData(ControlData1 controlData) {
	...
	public CustomerPaymentCancellationRequestV03 setUnderlying(List<UnderlyingTransaction7> underlying) {
	...
	public CustomerPaymentCancellationRequestV03 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerPaymentCancellationRequestV03 messageBody;
	}
}