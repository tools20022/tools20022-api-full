...
@XmlType(name = "camt.038.001.01", propOrder = {"requestHeader", "case_"})
public class CaseStatusReportRequest {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return CaseStatusReportRequest.class;
			}
		});
	...
	public CaseStatusReportRequest setRequestHeader(ReportHeader requestHeader) {
	...
	public CaseStatusReportRequest setCase(Case case_) {
	...
	static public class Document {
		...
		public CaseStatusReportRequest messageBody;
	}
}