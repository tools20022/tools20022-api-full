 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule#for_camt_FIToFIPaymentCancellationRequestV02
 * ConstraintMessageOrGroupCaseRule.for_camt_FIToFIPaymentCancellationRequestV02
 * }</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMessageOrTransactionCaseRule#for_camt_FIToFIPaymentCancellationRequestV02
 * ConstraintMessageOrTransactionCaseRule.
 * for_camt_FIToFIPaymentCancellationRequestV02}</li>
 * </ul>
 * </li>
 * <li>
...
public class FIToFIPaymentCancellationRequestV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, CaseAssignment3> mmAssignment = new MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, CaseAssignment3>() {
		{
			xmlTag = "Assgnmt";
		...
		@Override
		public CaseAssignment3 getValue(FIToFIPaymentCancellationRequestV02 obj) {
			return obj.getAssignment();
		}

		@Override
		public void setValue(FIToFIPaymentCancellationRequestV02 obj, CaseAssignment3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, Optional<Case3>> mmCase = new MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, Optional<Case3>>() {
		{
			xmlTag = "Case";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Case";
		...
		@Override
		public Optional<Case3> getValue(FIToFIPaymentCancellationRequestV02 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(FIToFIPaymentCancellationRequestV02 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, Optional<ControlData1>> mmControlData = new MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, Optional<ControlData1>>() {
		{
			xmlTag = "CtrlData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ControlData";
		...
		@Override
		public Optional<ControlData1> getValue(FIToFIPaymentCancellationRequestV02 obj) {
			return obj.getControlData();
		}

		@Override
		public void setValue(FIToFIPaymentCancellationRequestV02 obj, Optional<ControlData1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, List<UnderlyingTransaction5>> mmUnderlying = new MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, List<UnderlyingTransaction5>>() {
		{
			xmlTag = "Undrlyg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Underlying";
		...
		@Override
		public List<UnderlyingTransaction5> getValue(FIToFIPaymentCancellationRequestV02 obj) {
			return obj.getUnderlying();
		}

		@Override
		public void setValue(FIToFIPaymentCancellationRequestV02 obj, List<UnderlyingTransaction5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<FIToFIPaymentCancellationRequestV02, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(FIToFIPaymentCancellationRequestV02 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(FIToFIPaymentCancellationRequestV02 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule.for_camt_FIToFIPaymentCancellationRequestV02,
						com.tools20022.repository.constraints.ConstraintMessageOrTransactionCaseRule.for_camt_FIToFIPaymentCancellationRequestV02);
