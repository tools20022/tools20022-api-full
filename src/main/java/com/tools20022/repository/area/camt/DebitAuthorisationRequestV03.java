...
@XmlType(name = "DebitAuthorisationRequestV03", propOrder = {"assignment", "case", "underlying", "detail"})
public class DebitAuthorisationRequestV03 {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.037.03.03")
