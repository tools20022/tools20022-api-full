 ...
 * {@linkplain com.tools20022.repository.area.camt.RequestToModifyPaymentV01#identifier
 * RequestToModifyPaymentV01.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Assignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Assignment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Case = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Case);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Underlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Underlying);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Modification = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Modification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV02.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV01.Assignment, com.tools20022.repository.area.camt.RequestToModifyPaymentV01.Case,
						com.tools20022.repository.area.camt.RequestToModifyPaymentV01.Underlying, com.tools20022.repository.area.camt.RequestToModifyPaymentV01.Modification,
						com.tools20022.repository.area.camt.RequestToModifyPaymentV01.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV01.identifier;
			}
		});
