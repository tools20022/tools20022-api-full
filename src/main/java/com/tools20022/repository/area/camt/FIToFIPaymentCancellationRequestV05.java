...
@XmlType(name = "FIToFIPaymentCancellationRequestV05", propOrder = {"assignment", "case", "controlData", "underlying", "supplementaryData"})
public class FIToFIPaymentCancellationRequestV05 {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.056.05.05")
