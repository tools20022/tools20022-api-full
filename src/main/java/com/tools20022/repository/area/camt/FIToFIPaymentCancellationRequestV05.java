 ...
 * {@linkplain com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05#identifier
 * FIToFIPaymentCancellationRequestV05.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Assignment = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.Assignment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.Assignment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Case = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.Case;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.Case);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock ControlData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.ControlData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.ControlData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Underlying = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.Underlying;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.Underlying);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.Assignment, com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.Case,
						com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.ControlData, com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.Underlying,
						com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV05.identifier;
			}
		});
