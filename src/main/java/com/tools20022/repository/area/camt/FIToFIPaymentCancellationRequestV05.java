...
public class FIToFIPaymentCancellationRequestV05 {
	...
	public static final MMMessageBuildingBlock mmAssignment = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.mmAssignment);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.mmAssignment;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmCase = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.mmCase);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.mmCase;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmControlData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.mmControlData);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.mmControlData;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmUnderlying = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.mmUnderlying);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.mmUnderlying;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV06.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.FIToFIPaymentCancellationRequestV04.mmSupplementaryData;
			minOccurs = 0;
	...
	public void setUnderlying(List<UnderlyingTransaction13> underlying) {
