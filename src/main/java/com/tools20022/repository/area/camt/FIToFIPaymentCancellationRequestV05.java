 ...
 * ConstraintMessageOrTransactionCaseRule.forFIToFIPaymentCancellationRequestV05
 * }</li>
 * <li>
...
public class FIToFIPaymentCancellationRequestV05 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule.forFIToFIPaymentCancellationRequestV05,
						com.tools20022.repository.constraints.ConstraintMessageOrTransactionCaseRule.forFIToFIPaymentCancellationRequestV05,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forFIToFIPaymentCancellationRequestV05);
