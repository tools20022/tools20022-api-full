		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFIPaymentCancellationRequestV05.mmAssignment, FIToFIPaymentCancellationRequestV05.mmCase, FIToFIPaymentCancellationRequestV05.mmControlData,
						FIToFIPaymentCancellationRequestV05.mmUnderlying, FIToFIPaymentCancellationRequestV05.mmSupplementaryData);
