...
public class BankToCustomerStatementV04 {
	...
	public static final MMMessageBuildingBlock mmGroupHeader = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerStatementV04.class.getMethod("getGroupHeader", new Class[]{});
	...
	public static final MMMessageBuildingBlock mmStatement = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerStatementV04.class.getMethod("getStatement", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		...
		public Method getGetterMethod() {
			try {
				return BankToCustomerStatementV04.class.getMethod("getSupplementaryData", new Class[]{});
			} catch (NoSuchMethodException e) {
				throw new RuntimeException(e);
			}
		}
	...
	public void setStatement(List<AccountStatement4> statement) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.04.04")
