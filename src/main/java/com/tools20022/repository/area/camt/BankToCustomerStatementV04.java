		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(BankToCustomerStatementV04.mmGroupHeader, BankToCustomerStatementV04.mmStatement, BankToCustomerStatementV04.mmSupplementaryData);
