 ...
 * {@linkplain com.tools20022.repository.area.camt.RequestToModifyPaymentV03#identifier
 * RequestToModifyPaymentV03.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock Assignment = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Assignment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV04.Assignment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Case = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Case;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV04.Case);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Underlying = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Underlying;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV04.Underlying);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Modification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV02.Modification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV04.Modification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV02.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV04.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.RequestToModifyPaymentV03.Assignment, com.tools20022.repository.area.camt.RequestToModifyPaymentV03.Case,
						com.tools20022.repository.area.camt.RequestToModifyPaymentV03.Underlying, com.tools20022.repository.area.camt.RequestToModifyPaymentV03.Modification,
						com.tools20022.repository.area.camt.RequestToModifyPaymentV03.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.camt.RequestToModifyPaymentV03.identifier;
			}
		});
