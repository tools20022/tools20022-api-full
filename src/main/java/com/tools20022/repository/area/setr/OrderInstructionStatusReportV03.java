 ...
 * ConstraintOtherReferenceGuideline.for_setr_OrderInstructionStatusReportV03}</li>
 * </ul>
 * </li>
 * <li>
...
public class OrderInstructionStatusReportV03 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageNameAndReferenceGuideline.for_setr_OrderInstructionStatusReportV03,
						com.tools20022.repository.constraints.ConstraintOtherReferenceGuideline.for_setr_OrderInstructionStatusReportV03);
