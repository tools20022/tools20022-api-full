 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAccountIdentificationRule#for_setr_SubscriptionBulkOrderCancellationInstructionV02
 * ConstraintAccountIdentificationRule.
 * for_setr_SubscriptionBulkOrderCancellationInstructionV02}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "setr.008.001.02", propOrder = {"masterReference", "poolReference", "previousReference", "orderToBeCancelled"})
public class SubscriptionBulkOrderCancellationInstructionV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmMasterReference = new MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<AdditionalReference3> getValue(SubscriptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(SubscriptionBulkOrderCancellationInstructionV02 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, AdditionalReference3> mmPreviousReference = new MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, AdditionalReference3>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public AdditionalReference3 getValue(SubscriptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(SubscriptionBulkOrderCancellationInstructionV02 obj, AdditionalReference3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<SubscriptionBulkOrderInstruction1>> mmOrderToBeCancelled = new MMMessageBuildingBlock<SubscriptionBulkOrderCancellationInstructionV02, Optional<SubscriptionBulkOrderInstruction1>>() {
		{
			xmlTag = "OrdrToBeCanc";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<SubscriptionBulkOrderInstruction1> getValue(SubscriptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getOrderToBeCancelled();
		}

		@Override
		public void setValue(SubscriptionBulkOrderCancellationInstructionV02 obj, Optional<SubscriptionBulkOrderInstruction1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAccountIdentificationRule.for_setr_SubscriptionBulkOrderCancellationInstructionV02);
			...
			public Class<?> getInstanceClass() {
				return SubscriptionBulkOrderCancellationInstructionV02.class;
			}
		});
	...
	public SubscriptionBulkOrderCancellationInstructionV02 setMasterReference(AdditionalReference3 masterReference) {
	...
	public SubscriptionBulkOrderCancellationInstructionV02 setPoolReference(AdditionalReference3 poolReference) {
	...
	public SubscriptionBulkOrderCancellationInstructionV02 setPreviousReference(AdditionalReference3 previousReference) {
	...
	public SubscriptionBulkOrderCancellationInstructionV02 setOrderToBeCancelled(SubscriptionBulkOrderInstruction1 orderToBeCancelled) {
		this.orderToBeCancelled = orderToBeCancelled;
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:setr.008.001.02")
	static public class Document {
		@XmlElement(name = "setr.008.001.02", required = true)
		public SubscriptionBulkOrderCancellationInstructionV02 messageBody;
	}
}