...
public class RedemptionBulkOrderConfirmationV02 {
	...
	public void setBulkExecutionDetails(RedemptionBulkExecution2 bulkExecutionDetails) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:setr.003.02.02")
