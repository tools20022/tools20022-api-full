 ...
 * {@linkplain com.tools20022.repository.area.setr.SubscriptionOrderV04#identifier
 * SubscriptionOrderV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.MessageIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.PoolReference;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.PreviousReference;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock MultipleOrderDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.MultipleOrderDetails;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.CopyDetails;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV03.Extension;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderV04.MessageIdentification, com.tools20022.repository.area.setr.SubscriptionOrderV04.PoolReference,
						com.tools20022.repository.area.setr.SubscriptionOrderV04.PreviousReference, com.tools20022.repository.area.setr.SubscriptionOrderV04.MultipleOrderDetails,
						com.tools20022.repository.area.setr.SubscriptionOrderV04.CopyDetails, com.tools20022.repository.area.setr.SubscriptionOrderV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderV04.identifier;
			}
		});
