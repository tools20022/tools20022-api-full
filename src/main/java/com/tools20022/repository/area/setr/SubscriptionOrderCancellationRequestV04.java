		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SubscriptionOrderCancellationRequestV04.mmMessageIdentification, SubscriptionOrderCancellationRequestV04.mmPoolReference,
						SubscriptionOrderCancellationRequestV04.mmPreviousReference, SubscriptionOrderCancellationRequestV04.mmMasterReference, SubscriptionOrderCancellationRequestV04.mmOrderReferences,
						SubscriptionOrderCancellationRequestV04.mmCopyDetails);
