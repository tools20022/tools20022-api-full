...
public class SwitchOrderCancellationInstructionV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmMasterReference = new MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<AdditionalReference3> getValue(SwitchOrderCancellationInstructionV02 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(SwitchOrderCancellationInstructionV02 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, AdditionalReference3> mmPreviousReference = new MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, AdditionalReference3>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public AdditionalReference3 getValue(SwitchOrderCancellationInstructionV02 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(SwitchOrderCancellationInstructionV02 obj, AdditionalReference3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<SwitchOrderInstruction1>> mmOrderToBeCancelled = new MMMessageBuildingBlock<SwitchOrderCancellationInstructionV02, Optional<SwitchOrderInstruction1>>() {
		{
			xmlTag = "OrdrToBeCanc";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<SwitchOrderInstruction1> getValue(SwitchOrderCancellationInstructionV02 obj) {
			return obj.getOrderToBeCancelled();
		}

		@Override
		public void setValue(SwitchOrderCancellationInstructionV02 obj, Optional<SwitchOrderInstruction1> value) {
	...
	public SwitchOrderCancellationInstructionV02 setMasterReference(AdditionalReference3 masterReference) {
	...
	public SwitchOrderCancellationInstructionV02 setPoolReference(AdditionalReference3 poolReference) {
	...
	public SwitchOrderCancellationInstructionV02 setPreviousReference(AdditionalReference3 previousReference) {
	...
	public SwitchOrderCancellationInstructionV02 setOrderToBeCancelled(SwitchOrderInstruction1 orderToBeCancelled) {
		this.orderToBeCancelled = orderToBeCancelled;
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:setr.014.001.02")
