		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationCancellationInstructionV02.mmMessageIdentification, SubscriptionOrderConfirmationCancellationInstructionV02.mmPoolReference,
						SubscriptionOrderConfirmationCancellationInstructionV02.mmPreviousReference, SubscriptionOrderConfirmationCancellationInstructionV02.mmRelatedReference,
						SubscriptionOrderConfirmationCancellationInstructionV02.mmAmendmentIndicator, SubscriptionOrderConfirmationCancellationInstructionV02.mmMasterReference,
						SubscriptionOrderConfirmationCancellationInstructionV02.mmOrderReferences, SubscriptionOrderConfirmationCancellationInstructionV02.mmCopyDetails);
