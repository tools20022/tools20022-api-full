 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAccountIdentificationRule#forSubscriptionMultipleOrderCancellationInstructionV02
 * ConstraintAccountIdentificationRule.
 * forSubscriptionMultipleOrderCancellationInstructionV02}</li>
 * </ul>
 * </li>
 * <li>
...
public class SubscriptionMultipleOrderCancellationInstructionV02 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAccountIdentificationRule.forSubscriptionMultipleOrderCancellationInstructionV02);
