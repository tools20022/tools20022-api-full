...
public class SubscriptionMultipleOrderCancellationInstructionV02 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SubscriptionMultipleOrderCancellationInstructionV02.mmMasterReference, SubscriptionMultipleOrderCancellationInstructionV02.mmPoolReference,
						SubscriptionMultipleOrderCancellationInstructionV02.mmPreviousReference, SubscriptionMultipleOrderCancellationInstructionV02.mmOrderToBeCancelled);
	...
	public SubscriptionMultipleOrderInstruction1 getOrderToBeCancelled() {
		return orderToBeCancelled;
	}

	public void setOrderToBeCancelled(SubscriptionMultipleOrderInstruction1 orderToBeCancelled) {
