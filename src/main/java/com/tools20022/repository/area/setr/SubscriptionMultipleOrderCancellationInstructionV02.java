 ...
 * instructing party, eg, an investment manager or its authorised representative
 * , to an executing party, eg, a transfer agent. There may be one or more
 * intermediary parties between the instructing party and the executing party.
 ...
 * {@linkplain com.tools20022.repository.area.setr.SubscriptionMultipleOrderCancellationInstructionV02#identifier
 * SubscriptionMultipleOrderCancellationInstructionV02.identifier}</li>
 * <li>
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionMultipleOrderCancellationInstructionV02.MasterReference,
						...
						com.tools20022.repository.area.setr.SubscriptionMultipleOrderCancellationInstructionV02.OrderToBeCancelled);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.setr.SubscriptionMultipleOrderCancellationInstructionV02.identifier;
			}
		});
