 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03#CancellationByOrderDetails
 * SubscriptionOrderCancellationRequestV03.CancellationByOrderDetails}</li>
 * <li>
 ...
 * {@linkplain com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03#identifier
 * SubscriptionOrderCancellationRequestV03.identifier}</li>
 * <li>
	...
	public static final MMXor CancellationByReferenceOrByOrderDetailsRule = new MMXor() {
		{
			...
			impactedMessageBuildingBlocks_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.CancellationByReference,
					com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.CancellationByOrderDetails);
		}
	};
	/**
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV04.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV04.PoolReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV04.PreviousReference);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV04.CopyDetails);
			minOccurs = 0;
			maxOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.MessageIdentification,
						...
						com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.CancellationByReference, com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.CancellationByOrderDetails,
						com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.CopyDetails);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderCancellationRequestV03.identifier;
			}
		});
