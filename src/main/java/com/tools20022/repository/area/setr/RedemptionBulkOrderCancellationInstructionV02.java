 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAccountIdentificationRule#for_setr_RedemptionBulkOrderCancellationInstructionV02
 * ConstraintAccountIdentificationRule.
 * for_setr_RedemptionBulkOrderCancellationInstructionV02}</li>
 * </ul>
 * </li>
 * <li>
...
public class RedemptionBulkOrderCancellationInstructionV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmMasterReference = new MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<AdditionalReference3> getValue(RedemptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(RedemptionBulkOrderCancellationInstructionV02 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, AdditionalReference3> mmPreviousReference = new MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, AdditionalReference3>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public AdditionalReference3 getValue(RedemptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(RedemptionBulkOrderCancellationInstructionV02 obj, AdditionalReference3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<RedemptionBulkOrderInstruction1>> mmOrderToBeCancelled = new MMMessageBuildingBlock<RedemptionBulkOrderCancellationInstructionV02, Optional<RedemptionBulkOrderInstruction1>>() {
		{
			xmlTag = "OrdrToBeCanc";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<RedemptionBulkOrderInstruction1> getValue(RedemptionBulkOrderCancellationInstructionV02 obj) {
			return obj.getOrderToBeCancelled();
		}

		@Override
		public void setValue(RedemptionBulkOrderCancellationInstructionV02 obj, Optional<RedemptionBulkOrderInstruction1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAccountIdentificationRule.for_setr_RedemptionBulkOrderCancellationInstructionV02);
