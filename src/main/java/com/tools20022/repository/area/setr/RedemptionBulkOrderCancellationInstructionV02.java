		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(RedemptionBulkOrderCancellationInstructionV02.mmMasterReference, RedemptionBulkOrderCancellationInstructionV02.mmPoolReference,
						RedemptionBulkOrderCancellationInstructionV02.mmPreviousReference, RedemptionBulkOrderCancellationInstructionV02.mmOrderToBeCancelled);
