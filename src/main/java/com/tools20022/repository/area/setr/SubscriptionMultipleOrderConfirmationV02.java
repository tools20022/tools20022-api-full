		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SubscriptionMultipleOrderConfirmationV02.mmMasterReference, SubscriptionMultipleOrderConfirmationV02.mmPoolReference,
						SubscriptionMultipleOrderConfirmationV02.mmPreviousReference, SubscriptionMultipleOrderConfirmationV02.mmRelatedReference, SubscriptionMultipleOrderConfirmationV02.mmMultipleExecutionDetails,
						SubscriptionMultipleOrderConfirmationV02.mmIntermediaryDetails, SubscriptionMultipleOrderConfirmationV02.mmCopyDetails, SubscriptionMultipleOrderConfirmationV02.mmExtension);
