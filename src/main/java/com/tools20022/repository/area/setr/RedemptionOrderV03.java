 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintRelatedPartiesDetailsRule#for_setr_RedemptionOrderV03
 * ConstraintRelatedPartiesDetailsRule.for_setr_RedemptionOrderV03}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "RedemptionOrderV03", propOrder = {"messageIdentification", "poolReference", "previousReference", "multipleOrderDetails", "relatedPartyDetails", "copyDetails", "extension"})
public class RedemptionOrderV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<RedemptionOrderV03, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageIdentification";
			definition = "Reference that uniquely identifies a message from a business application standpoint.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(RedemptionOrderV03 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<RedemptionOrderV03, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
			definition = "Collective reference identifying a set of messages.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmPoolReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference3> getValue(RedemptionOrderV03 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, List<AdditionalReference3>> mmPreviousReference = new MMMessageBuildingBlock<RedemptionOrderV03, List<AdditionalReference3>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousReference";
			definition = "Reference to a linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmPreviousReference);
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}

		@Override
		public List<AdditionalReference3> getValue(RedemptionOrderV03 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, List<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, RedemptionMultipleOrder4> mmMultipleOrderDetails = new MMMessageBuildingBlock<RedemptionOrderV03, RedemptionMultipleOrder4>() {
		{
			xmlTag = "MltplOrdrDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MultipleOrderDetails";
			definition = "General information related to the order.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmMultipleOrderDetails);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RedemptionMultipleOrder4 getValue(RedemptionOrderV03 obj) {
			return obj.getMultipleOrderDetails();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, RedemptionMultipleOrder4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, List<Intermediary8>> mmRelatedPartyDetails = new MMMessageBuildingBlock<RedemptionOrderV03, List<Intermediary8>>() {
		{
			xmlTag = "RltdPtyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<Intermediary8> getValue(RedemptionOrderV03 obj) {
			return obj.getRelatedPartyDetails();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, List<Intermediary8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, Optional<CopyInformation2>> mmCopyDetails = new MMMessageBuildingBlock<RedemptionOrderV03, Optional<CopyInformation2>>() {
		{
			xmlTag = "CpyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CopyDetails";
			definition = "Information provided when the message is a copy of a previous message.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmCopyDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyInformation2> getValue(RedemptionOrderV03 obj) {
			return obj.getCopyDetails();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, Optional<CopyInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<RedemptionOrderV03, List<Extension1>> mmExtension = new MMMessageBuildingBlock<RedemptionOrderV03, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionOrderV04.mmExtension);
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(RedemptionOrderV03 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(RedemptionOrderV03 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAccountIdentificationRule.for_setr_RedemptionOrderV03,
						com.tools20022.repository.constraints.ConstraintRelatedPartiesDetailsRule.for_setr_RedemptionOrderV03);
			...
			public Class<?> getInstanceClass() {
				return RedemptionOrderV03.class;
			}
		});
	...
	public RedemptionOrderV03 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public RedemptionOrderV03 setPoolReference(AdditionalReference3 poolReference) {
	...
	public RedemptionOrderV03 setPreviousReference(List<AdditionalReference3> previousReference) {
	...
	public RedemptionOrderV03 setMultipleOrderDetails(RedemptionMultipleOrder4 multipleOrderDetails) {
	...
	public RedemptionOrderV03 setRelatedPartyDetails(List<Intermediary8> relatedPartyDetails) {
	...
	public RedemptionOrderV03 setCopyDetails(CopyInformation2 copyDetails) {
	...
	public RedemptionOrderV03 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:setr.004.001.03")
	static public class Document {
		@XmlElement(name = "RedOrdrV03", required = true)
		public RedemptionOrderV03 messageBody;
	}
}