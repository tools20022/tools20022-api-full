...
@XmlType(name = "SubscriptionOrderConfirmationV03", propOrder = {"messageIdentification", "poolReference", "previousReference", "relatedReference", "multipleExecutionDetails", "relatedPartyDetails", "copyDetails", "extension"})
public class SubscriptionOrderConfirmationV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, MessageIdentification1> mmMessageIdentification = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, MessageIdentification1>() {
		{
			xmlTag = "MsgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MessageIdentification";
			definition = "Reference that uniquely identifies a message from a business application standpoint.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public MessageIdentification1 getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<AdditionalReference3>> mmPoolReference = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<AdditionalReference3>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
			definition = "Collective reference identifying a set of messages.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmPoolReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference3> getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, Optional<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<AdditionalReference3>> mmPreviousReference = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<AdditionalReference3>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousReference";
			definition = "Reference to a linked message that was previously sent.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmPreviousReference);
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}

		@Override
		public List<AdditionalReference3> getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, List<AdditionalReference3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<AdditionalReference3>> mmRelatedReference = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<AdditionalReference3>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RelatedReference";
			definition = "Reference to a linked message that was previously received.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmRelatedReference);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> AdditionalReference3.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, SubscriptionMultipleExecution3> mmMultipleExecutionDetails = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, SubscriptionMultipleExecution3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmMultipleExecutionDetails);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SubscriptionMultipleExecution3 getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getMultipleExecutionDetails();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, SubscriptionMultipleExecution3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<Intermediary9>> mmRelatedPartyDetails = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<Intermediary9>>() {
		{
			xmlTag = "RltdPtyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<Intermediary9> getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getRelatedPartyDetails();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, List<Intermediary9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<CopyInformation2>> mmCopyDetails = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, Optional<CopyInformation2>>() {
		{
			xmlTag = "CpyDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CopyDetails";
			definition = "Information provided when the message is a copy of a previous message.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmCopyDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyInformation2> getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getCopyDetails();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, Optional<CopyInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<Extension1>> mmExtension = new MMMessageBuildingBlock<SubscriptionOrderConfirmationV03, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV04.mmExtension);
			minOccurs = 0;
			complexType_lazy = () -> Extension1.mmObject();
		}

		@Override
		public List<Extension1> getValue(SubscriptionOrderConfirmationV03 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(SubscriptionOrderConfirmationV03 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return SubscriptionOrderConfirmationV03.class;
			}
		});
	...
	public SubscriptionOrderConfirmationV03 setMessageIdentification(MessageIdentification1 messageIdentification) {
	...
	public SubscriptionOrderConfirmationV03 setPoolReference(AdditionalReference3 poolReference) {
	...
	public SubscriptionOrderConfirmationV03 setPreviousReference(List<AdditionalReference3> previousReference) {
	...
	public SubscriptionOrderConfirmationV03 setRelatedReference(AdditionalReference3 relatedReference) {
	...
	public SubscriptionOrderConfirmationV03 setMultipleExecutionDetails(SubscriptionMultipleExecution3 multipleExecutionDetails) {
	...
	public SubscriptionOrderConfirmationV03 setRelatedPartyDetails(List<Intermediary9> relatedPartyDetails) {
	...
	public SubscriptionOrderConfirmationV03 setCopyDetails(CopyInformation2 copyDetails) {
	...
	public SubscriptionOrderConfirmationV03 setExtension(List<Extension1> extension) {
		this.extension = Objects.requireNonNull(extension);
		return this;
	}

	@XmlRootElement(name = "Document", namespace = "urn:iso:std:iso:20022:tech:xsd:setr.012.001.03")
	static public class Document {
		@XmlElement(name = "SbcptOrdrConfV03", required = true)
		public SubscriptionOrderConfirmationV03 messageBody;
	}
}