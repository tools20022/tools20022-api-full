		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SubscriptionOrderConfirmationV03.mmMessageIdentification, SubscriptionOrderConfirmationV03.mmPoolReference, SubscriptionOrderConfirmationV03.mmPreviousReference,
						SubscriptionOrderConfirmationV03.mmRelatedReference, SubscriptionOrderConfirmationV03.mmMultipleExecutionDetails, SubscriptionOrderConfirmationV03.mmRelatedPartyDetails,
						SubscriptionOrderConfirmationV03.mmCopyDetails, SubscriptionOrderConfirmationV03.mmExtension);
