 ...
 * {@linkplain com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04#identifier
 * SubscriptionOrderConfirmationV04.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock MessageIdentification = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.MessageIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PoolReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.PoolReference;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PreviousReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.PreviousReference;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock RelatedReference = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.RelatedReference;
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> AdditionalReference8.mmObject();
		}
	...
	public static final MMMessageBuildingBlock MultipleExecutionDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.MultipleExecutionDetails;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock CopyDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.CopyDetails;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock Extension = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV03.Extension;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.MessageIdentification, com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.PoolReference,
						...
						com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.MultipleExecutionDetails, com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.CopyDetails,
						com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.Extension);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.setr.SubscriptionOrderConfirmationV04.identifier;
			}
		});
