		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatusAdviceV05.mmInstructionIdentification, CorporateActionInstructionStatusAdviceV05.mmOtherDocumentIdentification,
						CorporateActionInstructionStatusAdviceV05.mmCorporateActionGeneralInformation, CorporateActionInstructionStatusAdviceV05.mmInstructionProcessingStatus,
						CorporateActionInstructionStatusAdviceV05.mmCorporateActionInstruction, CorporateActionInstructionStatusAdviceV05.mmAdditionalInformation, CorporateActionInstructionStatusAdviceV05.mmSupplementaryData);
