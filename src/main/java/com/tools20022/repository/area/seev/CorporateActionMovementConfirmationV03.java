...
public class CorporateActionMovementConfirmationV03 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementConfirmationV03.mmNotificationIdentification, CorporateActionMovementConfirmationV03.mmMovementPreliminaryAdviceIdentification,
						CorporateActionMovementConfirmationV03.mmInstructionIdentification, CorporateActionMovementConfirmationV03.mmOtherDocumentIdentification, CorporateActionMovementConfirmationV03.mmEventsLinkage,
						CorporateActionMovementConfirmationV03.mmCorporateActionGeneralInformation, CorporateActionMovementConfirmationV03.mmAccountDetails, CorporateActionMovementConfirmationV03.mmCorporateActionConfirmationDetails,
						CorporateActionMovementConfirmationV03.mmAdditionalInformation, CorporateActionMovementConfirmationV03.mmIssuerAgent, CorporateActionMovementConfirmationV03.mmPayingAgent,
						CorporateActionMovementConfirmationV03.mmSubPayingAgent, CorporateActionMovementConfirmationV03.mmSupplementaryData);
	...
	public void setCorporateActionGeneralInformation(CorporateActionGeneralInformation39 corporateActionGeneralInformation) {
	...
	public void setAccountDetails(AccountAndBalance16 accountDetails) {
	...
	public void setCorporateActionConfirmationDetails(CorporateActionOption37 corporateActionConfirmationDetails) {
