		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionCancellationRequestV04.mmChangeInstructionIndicator, CorporateActionInstructionCancellationRequestV04.mmInstructionIdentification,
						CorporateActionInstructionCancellationRequestV04.mmCorporateActionGeneralInformation, CorporateActionInstructionCancellationRequestV04.mmAccountDetails,
						CorporateActionInstructionCancellationRequestV04.mmCorporateActionInstruction, CorporateActionInstructionCancellationRequestV04.mmSupplementaryData);
