 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCorporateActionEventIdentificationRule#for_seev_CorporateActionInstructionV05
 ...
 * ConstraintAdditionalInformationRule.for_seev_CorporateActionInstructionV05}</li>
 * <li>
 ...
 * ConstraintCoexistenceCharacterSetXRule.for_seev_CorporateActionInstructionV05
 * }</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#for_seev_CorporateActionInstructionV05
 * ConstraintCoexistenceIdentificationRule.
 * for_seev_CorporateActionInstructionV05}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOptionTypeRule#for_seev_CorporateActionInstructionV05
 * ConstraintOptionTypeRule.for_seev_CorporateActionInstructionV05}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionInstructionV05", propOrder = {"changeInstructionIndicator", "cancelledInstructionIdentification", "instructionCancellationRequestIdentification", "otherDocumentIdentification", "eventsLinkage",
...
public class CorporateActionInstructionV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<YesNoIndicator>> mmChangeInstructionIndicator = new MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<YesNoIndicator>>() {
		{
			xmlTag = "ChngInstrInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmChangeInstructionIndicator);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmChangeInstructionIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CorporateActionInstructionV05 obj) {
			return obj.getChangeInstructionIndicator();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<DocumentIdentification15>> mmCancelledInstructionIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<DocumentIdentification15>>() {
		{
			xmlTag = "CancInstrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CancelledInstructionIdentification";
			definition = "Identification of a previously sent cancelled instruction document.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmCancelledInstructionIdentification);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmCancelledInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DocumentIdentification15> getValue(CorporateActionInstructionV05 obj) {
			return obj.getCancelledInstructionIdentification();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, Optional<DocumentIdentification15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<DocumentIdentification15>> mmInstructionCancellationRequestIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<DocumentIdentification15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmInstructionCancellationRequestIdentification);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmInstructionCancellationRequestIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> DocumentIdentification15.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, List<DocumentIdentification13>> mmOtherDocumentIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV05, List<DocumentIdentification13>>() {
		{
			xmlTag = "OthrDocId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OtherDocumentIdentification";
			definition = "Identification of other documents as well as the document number.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmOtherDocumentIdentification);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmOtherDocumentIdentification;
			minOccurs = 0;
			complexType_lazy = () -> DocumentIdentification13.mmObject();
		}

		@Override
		public List<DocumentIdentification13> getValue(CorporateActionInstructionV05 obj) {
			return obj.getOtherDocumentIdentification();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, List<DocumentIdentification13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, List<CorporateActionEventReference1>> mmEventsLinkage = new MMMessageBuildingBlock<CorporateActionInstructionV05, List<CorporateActionEventReference1>>() {
		{
			xmlTag = "EvtsLkg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "EventsLinkage";
			definition = "Identification of an other corporate action event that needs to be closely linked to the processing of the event notified in this document.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmEventsLinkage);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmEventsLinkage;
			minOccurs = 0;
			complexType_lazy = () -> CorporateActionEventReference1.mmObject();
		}

		@Override
		public List<CorporateActionEventReference1> getValue(CorporateActionInstructionV05 obj) {
			return obj.getEventsLinkage();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, List<CorporateActionEventReference1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, CorporateActionGeneralInformation71> mmCorporateActionGeneralInformation = new MMMessageBuildingBlock<CorporateActionInstructionV05, CorporateActionGeneralInformation71>() {
		{
			xmlTag = "CorpActnGnlInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorporateActionGeneralInformation";
			definition = "General information about the corporate action event.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmCorporateActionGeneralInformation);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmCorporateActionGeneralInformation;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionGeneralInformation71 getValue(CorporateActionInstructionV05 obj) {
			return obj.getCorporateActionGeneralInformation();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, CorporateActionGeneralInformation71 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, AccountAndBalance17> mmAccountDetails = new MMMessageBuildingBlock<CorporateActionInstructionV05, AccountAndBalance17>() {
		{
			xmlTag = "AcctDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountDetails";
			definition = "General information about the safekeeping account, owner and account balance.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmAccountDetails);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmAccountDetails;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AccountAndBalance17 getValue(CorporateActionInstructionV05 obj) {
			return obj.getAccountDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, AccountAndBalance17 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, List<PartyIdentification56>> mmBeneficialOwnerDetails = new MMMessageBuildingBlock<CorporateActionInstructionV05, List<PartyIdentification56>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmBeneficialOwnerDetails);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmBeneficialOwnerDetails;
			minOccurs = 0;
			complexType_lazy = () -> PartyIdentification56.mmObject();
		}

		@Override
		public List<PartyIdentification56> getValue(CorporateActionInstructionV05 obj) {
			return obj.getBeneficialOwnerDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, List<PartyIdentification56> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, CorporateActionOption103> mmCorporateActionInstruction = new MMMessageBuildingBlock<CorporateActionInstructionV05, CorporateActionOption103>() {
		{
			xmlTag = "CorpActnInstr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorporateActionInstruction";
			definition = "Information about the corporate action instruction.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmCorporateActionInstruction);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmCorporateActionInstruction;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionOption103 getValue(CorporateActionInstructionV05 obj) {
			return obj.getCorporateActionInstruction();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, CorporateActionOption103 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<CorporateActionNarrative21>> mmAdditionalInformation = new MMMessageBuildingBlock<CorporateActionInstructionV05, Optional<CorporateActionNarrative21>>() {
		{
			xmlTag = "AddtlInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AdditionalInformation";
			definition = "Provides additional information.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmAdditionalInformation);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmAdditionalInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CorporateActionNarrative21> getValue(CorporateActionInstructionV05 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, Optional<CorporateActionNarrative21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CorporateActionInstructionV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that can not be captured in the structured fields and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmSupplementaryData);
			previousVersion_lazy = () -> CorporateActionInstructionV04.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CorporateActionInstructionV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CorporateActionInstructionV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInstructionCancellationRequestIdentificationRule.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintCorporateActionEventIdentificationRule.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintChangeInstructionIndicatorGuideline.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintAdditionalInformationRule.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetXRule.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.for_seev_CorporateActionInstructionV05,
						com.tools20022.repository.constraints.ConstraintOptionTypeRule.for_seev_CorporateActionInstructionV05);
			...
			public Class<?> getInstanceClass() {
				return CorporateActionInstructionV05.class;
			}
		});
	...
	public CorporateActionInstructionV05 setChangeInstructionIndicator(YesNoIndicator changeInstructionIndicator) {
	...
	public CorporateActionInstructionV05 setCancelledInstructionIdentification(DocumentIdentification15 cancelledInstructionIdentification) {
	...
	public CorporateActionInstructionV05 setInstructionCancellationRequestIdentification(DocumentIdentification15 instructionCancellationRequestIdentification) {
	...
	public CorporateActionInstructionV05 setOtherDocumentIdentification(List<DocumentIdentification13> otherDocumentIdentification) {
	...
	public CorporateActionInstructionV05 setEventsLinkage(List<CorporateActionEventReference1> eventsLinkage) {
	...
	public CorporateActionInstructionV05 setCorporateActionGeneralInformation(CorporateActionGeneralInformation71 corporateActionGeneralInformation) {
	...
	public CorporateActionInstructionV05 setAccountDetails(AccountAndBalance17 accountDetails) {
	...
	public CorporateActionInstructionV05 setBeneficialOwnerDetails(List<PartyIdentification56> beneficialOwnerDetails) {
	...
	public CorporateActionInstructionV05 setCorporateActionInstruction(CorporateActionOption103 corporateActionInstruction) {
	...
	public CorporateActionInstructionV05 setAdditionalInformation(CorporateActionNarrative21 additionalInformation) {
	...
	public CorporateActionInstructionV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		@XmlElement(name = "CorpActnInstr", required = true)
		public CorporateActionInstructionV05 messageBody;
	}
}