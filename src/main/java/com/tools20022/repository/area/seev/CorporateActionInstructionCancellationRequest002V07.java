...
public class CorporateActionInstructionCancellationRequest002V07 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionCancellationRequest002V07.mmChangeInstructionIndicator, CorporateActionInstructionCancellationRequest002V07.mmInstructionIdentification,
						CorporateActionInstructionCancellationRequest002V07.mmCorporateActionGeneralInformation, CorporateActionInstructionCancellationRequest002V07.mmAccountDetails,
						CorporateActionInstructionCancellationRequest002V07.mmCorporateActionInstruction, CorporateActionInstructionCancellationRequest002V07.mmSupplementaryData);
	...
	public void setInstructionIdentification(DocumentIdentification37 instructionIdentification) {
	...
	public void setCorporateActionGeneralInformation(CorporateActionGeneralInformation121 corporateActionGeneralInformation) {
	...
	public void setCorporateActionInstruction(CorporateActionOption128 corporateActionInstruction) {
