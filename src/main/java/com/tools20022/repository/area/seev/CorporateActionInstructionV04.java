 ...
 * messageDefinitionIdentifier} = {@code seev.033.001.04}</li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCorporateActionEventIdentificationRule#for_seev_CorporateActionInstructionV04
 ...
 * ConstraintAdditionalInformationRule.for_seev_CorporateActionInstructionV04}</li>
 * <li>
 ...
 * ConstraintCoexistenceCharacterSetXRule.for_seev_CorporateActionInstructionV04
 * }</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#for_seev_CorporateActionInstructionV04
 * ConstraintCoexistenceIdentificationRule.
 * for_seev_CorporateActionInstructionV04}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOptionTypeRule#for_seev_CorporateActionInstructionV04
 * ConstraintOptionTypeRule.for_seev_CorporateActionInstructionV04}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionInstructionV04", propOrder = {"changeInstructionIndicator", "cancelledInstructionIdentification", "instructionCancellationRequestIdentification", "otherDocumentIdentification", "eventsLinkage",
...
public class CorporateActionInstructionV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<YesNoIndicator>> mmChangeInstructionIndicator = new MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<YesNoIndicator>>() {
		{
			xmlTag = "ChngInstrInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmChangeInstructionIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CorporateActionInstructionV04 obj) {
			return obj.getChangeInstructionIndicator();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<DocumentIdentification15>> mmCancelledInstructionIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<DocumentIdentification15>>() {
		{
			xmlTag = "CancInstrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CancelledInstructionIdentification";
			definition = "Identification of a previously sent cancelled instruction document.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmCancelledInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DocumentIdentification15> getValue(CorporateActionInstructionV04 obj) {
			return obj.getCancelledInstructionIdentification();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, Optional<DocumentIdentification15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<DocumentIdentification15>> mmInstructionCancellationRequestIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<DocumentIdentification15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmInstructionCancellationRequestIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> DocumentIdentification15.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, List<DocumentIdentification13>> mmOtherDocumentIdentification = new MMMessageBuildingBlock<CorporateActionInstructionV04, List<DocumentIdentification13>>() {
		{
			xmlTag = "OthrDocId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OtherDocumentIdentification";
			definition = "Identification of other documents as well as the document number.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmOtherDocumentIdentification);
			minOccurs = 0;
			complexType_lazy = () -> DocumentIdentification13.mmObject();
		}

		@Override
		public List<DocumentIdentification13> getValue(CorporateActionInstructionV04 obj) {
			return obj.getOtherDocumentIdentification();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, List<DocumentIdentification13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, List<CorporateActionEventReference1>> mmEventsLinkage = new MMMessageBuildingBlock<CorporateActionInstructionV04, List<CorporateActionEventReference1>>() {
		{
			xmlTag = "EvtsLkg";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "EventsLinkage";
			definition = "Identification of an other corporate action event that needs to be closely linked to the processing of the event notified in this document.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmEventsLinkage);
			minOccurs = 0;
			complexType_lazy = () -> CorporateActionEventReference1.mmObject();
		}

		@Override
		public List<CorporateActionEventReference1> getValue(CorporateActionInstructionV04 obj) {
			return obj.getEventsLinkage();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, List<CorporateActionEventReference1> value) {
			obj.setEventsLinkage(value);
		}
	};
	@XmlElement(name = "CorpActnGnlInf", required = true)
	protected CorporateActionGeneralInformation55 corporateActionGeneralInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, CorporateActionGeneralInformation55> mmCorporateActionGeneralInformation = new MMMessageBuildingBlock<CorporateActionInstructionV04, CorporateActionGeneralInformation55>() {
		{
			xmlTag = "CorpActnGnlInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorporateActionGeneralInformation";
			definition = "General information about the corporate action event.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmCorporateActionGeneralInformation);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> CorporateActionGeneralInformation55.mmObject();
		}

		@Override
		public CorporateActionGeneralInformation55 getValue(CorporateActionInstructionV04 obj) {
			return obj.getCorporateActionGeneralInformation();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, CorporateActionGeneralInformation55 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, AccountAndBalance17> mmAccountDetails = new MMMessageBuildingBlock<CorporateActionInstructionV04, AccountAndBalance17>() {
		{
			xmlTag = "AcctDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountDetails";
			definition = "General information about the safekeeping account, owner and account balance.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmAccountDetails);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AccountAndBalance17 getValue(CorporateActionInstructionV04 obj) {
			return obj.getAccountDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, AccountAndBalance17 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, List<PartyIdentification56>> mmBeneficialOwnerDetails = new MMMessageBuildingBlock<CorporateActionInstructionV04, List<PartyIdentification56>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmBeneficialOwnerDetails);
			minOccurs = 0;
			complexType_lazy = () -> PartyIdentification56.mmObject();
		}

		@Override
		public List<PartyIdentification56> getValue(CorporateActionInstructionV04 obj) {
			return obj.getBeneficialOwnerDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, List<PartyIdentification56> value) {
			obj.setBeneficialOwnerDetails(value);
		}
	};
	@XmlElement(name = "CorpActnInstr", required = true)
	protected CorporateActionOption57 corporateActionInstruction;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, CorporateActionOption57> mmCorporateActionInstruction = new MMMessageBuildingBlock<CorporateActionInstructionV04, CorporateActionOption57>() {
		{
			xmlTag = "CorpActnInstr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorporateActionInstruction";
			definition = "Information about the corporate action instruction.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmCorporateActionInstruction);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> CorporateActionOption57.mmObject();
		}

		@Override
		public CorporateActionOption57 getValue(CorporateActionInstructionV04 obj) {
			return obj.getCorporateActionInstruction();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, CorporateActionOption57 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<CorporateActionNarrative21>> mmAdditionalInformation = new MMMessageBuildingBlock<CorporateActionInstructionV04, Optional<CorporateActionNarrative21>>() {
		{
			xmlTag = "AddtlInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AdditionalInformation";
			definition = "Provides additional information.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmAdditionalInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CorporateActionNarrative21> getValue(CorporateActionInstructionV04 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, Optional<CorporateActionNarrative21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CorporateActionInstructionV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that can not be captured in the structured fields and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CorporateActionInstructionV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CorporateActionInstructionV04 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInstructionCancellationRequestIdentificationRule.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintCorporateActionEventIdentificationRule.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintChangeInstructionIndicatorGuideline.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintAdditionalInformationRule.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetXRule.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.for_seev_CorporateActionInstructionV04,
						com.tools20022.repository.constraints.ConstraintOptionTypeRule.for_seev_CorporateActionInstructionV04);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionInstructionV04";
				definition = "Scope\nAn account owner sends the CorporateActionInstruction message to an account servicer to instruct election on a corporate action event.\r\nThis message is used to provide the custodian with instructions on how the account owner wishes to proceed with a corporate action event. Instructions include investment decisions regarding the exercise of rights issues, the election of stock or cash when the option is available, and decisions on the conversion or tendering of securities.\nUsage\nThe message may also be used to:\n- re-send a message previously sent (the sub-function of the message is Duplicate),\n- provide a third party with a copy of a message for information (the sub-function of the message is Copy),\n- re-send to a third party a copy of a message for information (the sub-function of the message is Copy Duplicate),\nusing the relevant elements in the business application header (BAH).\nISO 15022 - 20022 COEXISTENCE\r\nThis ISO 20022 message is reversed engineered from ISO 15022. Both standards will coexist for a certain number of years. Until this coexistence period ends, the usage of certain data types is restricted to ensure interoperability between ISO 15022 and 20022 users. Compliance to these rules is mandatory in a coexistence environment. The coexistence restrictions are described in a Textual Rule linked to the Message Items they concern. These coexistence textual rules are clearly identified as follows: “CoexistenceXxxxRule”.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmObject());
				previousVersion_lazy = () -> CorporateActionInstructionV03.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "CorpActnInstr";
				businessArea_lazy = () -> SecuritiesEventsArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmChangeInstructionIndicator,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmCancelledInstructionIdentification,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmInstructionCancellationRequestIdentification, com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmOtherDocumentIdentification,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmEventsLinkage, com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmCorporateActionGeneralInformation,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmAccountDetails, com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmBeneficialOwnerDetails,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmCorporateActionInstruction, com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmAdditionalInformation,
						com.tools20022.repository.area.seev.CorporateActionInstructionV04.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return CorporateActionInstructionV04.class;
			}
		});
	...
	public CorporateActionInstructionV04 setChangeInstructionIndicator(YesNoIndicator changeInstructionIndicator) {
	...
	public CorporateActionInstructionV04 setCancelledInstructionIdentification(DocumentIdentification15 cancelledInstructionIdentification) {
	...
	public CorporateActionInstructionV04 setInstructionCancellationRequestIdentification(DocumentIdentification15 instructionCancellationRequestIdentification) {
	...
	public CorporateActionInstructionV04 setOtherDocumentIdentification(List<DocumentIdentification13> otherDocumentIdentification) {
	...
	public CorporateActionInstructionV04 setEventsLinkage(List<CorporateActionEventReference1> eventsLinkage) {
	...
	public CorporateActionInstructionV04 setCorporateActionGeneralInformation(CorporateActionGeneralInformation55 corporateActionGeneralInformation) {
	...
	public CorporateActionInstructionV04 setAccountDetails(AccountAndBalance17 accountDetails) {
	...
	public CorporateActionInstructionV04 setBeneficialOwnerDetails(List<PartyIdentification56> beneficialOwnerDetails) {
	...
	public CorporateActionInstructionV04 setCorporateActionInstruction(CorporateActionOption57 corporateActionInstruction) {
	...
	public CorporateActionInstructionV04 setAdditionalInformation(CorporateActionNarrative21 additionalInformation) {
	...
	public CorporateActionInstructionV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		@XmlElement(name = "CorpActnInstr", required = true)
		public CorporateActionInstructionV04 messageBody;
	}
}