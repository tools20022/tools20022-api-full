		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV02.mmPagination, CorporateActionInstructionStatementReportV02.mmStatementGeneralDetails,
						CorporateActionInstructionStatementReportV02.mmAccountAndStatementDetails, CorporateActionInstructionStatementReportV02.mmSupplementaryData);
