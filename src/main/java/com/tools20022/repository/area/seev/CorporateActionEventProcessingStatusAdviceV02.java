		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionEventProcessingStatusAdviceV02.mmNotificationIdentification, CorporateActionEventProcessingStatusAdviceV02.mmOtherDocumentIdentification,
						CorporateActionEventProcessingStatusAdviceV02.mmCorporateActionGeneralInformation, CorporateActionEventProcessingStatusAdviceV02.mmEventProcessingStatus,
						CorporateActionEventProcessingStatusAdviceV02.mmAdditionalInformation, CorporateActionEventProcessingStatusAdviceV02.mmSupplementaryData);
