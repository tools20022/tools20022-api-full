...
@XmlType(name = "IntraPositionMovementPostingReport002V06", propOrder = {"pagination", "statementGeneralDetails", "accountOwner", "safekeepingAccount", "financialInstrument"})
public class IntraPositionMovementPostingReport002V06 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.IntraPositionMovementPostingReport002V06.mmPagination,
						com.tools20022.repository.area.seev.IntraPositionMovementPostingReport002V06.mmStatementGeneralDetails, com.tools20022.repository.area.seev.IntraPositionMovementPostingReport002V06.mmAccountOwner,
						com.tools20022.repository.area.seev.IntraPositionMovementPostingReport002V06.mmSafekeepingAccount, com.tools20022.repository.area.seev.IntraPositionMovementPostingReport002V06.mmFinancialInstrument);
			...
			public Class<?> getInstanceClass() {
				return IntraPositionMovementPostingReport002V06.class;
			}
		});
	...
	public IntraPositionMovementPostingReport002V06 setPagination(Pagination pagination) {
	...
	public IntraPositionMovementPostingReport002V06 setStatementGeneralDetails(Statement49 statementGeneralDetails) {
	...
	public IntraPositionMovementPostingReport002V06 setAccountOwner(PartyIdentification103Choice accountOwner) {
	...
	public IntraPositionMovementPostingReport002V06 setSafekeepingAccount(SecuritiesAccount27 safekeepingAccount) {
	...
	public IntraPositionMovementPostingReport002V06 setFinancialInstrument(List<FinancialInstrumentDetails26> financialInstrument) {
	...
	static public class Document {
		...
		public IntraPositionMovementPostingReport002V06 messageBody;
	}
}