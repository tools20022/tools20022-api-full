		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV04.mmPagination, CorporateActionInstructionStatementReportV04.mmStatementGeneralDetails,
						CorporateActionInstructionStatementReportV04.mmAccountAndStatementDetails, CorporateActionInstructionStatementReportV04.mmSupplementaryData);
