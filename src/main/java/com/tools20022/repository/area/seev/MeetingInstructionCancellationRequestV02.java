		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MeetingInstructionCancellationRequestV02.mmInstructionCancellationIdentification, MeetingInstructionCancellationRequestV02.mmPreviousReference,
						MeetingInstructionCancellationRequestV02.mmMeetingReference, MeetingInstructionCancellationRequestV02.mmRequestingParty, MeetingInstructionCancellationRequestV02.mmSecurityIdentification,
						MeetingInstructionCancellationRequestV02.mmInstructedPosition);
