		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReport002V06.mmPagination, CorporateActionInstructionStatementReport002V06.mmStatementGeneralDetails,
						CorporateActionInstructionStatementReport002V06.mmAccountAndStatementDetails, CorporateActionInstructionStatementReport002V06.mmSupplementaryData);
