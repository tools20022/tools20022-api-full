		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmMovementPreliminaryAdviceIdentification,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmCorporateActionGeneralInformation, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmAccountDetails,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmCorporateActionDetails, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmIssuerAgent,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmPayingAgent, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmSubPayingAgent,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmRegistrar, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmResellingAgent,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmPhysicalSecuritiesAgent, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmDropAgent,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmSolicitationAgent, CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmInformationAgent,
						CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.mmSupplementaryData);
