		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementConfirmationV02.mmNotificationIdentification, CorporateActionMovementConfirmationV02.mmMovementPreliminaryAdviceIdentification,
						CorporateActionMovementConfirmationV02.mmInstructionIdentification, CorporateActionMovementConfirmationV02.mmOtherDocumentIdentification, CorporateActionMovementConfirmationV02.mmEventsLinkage,
						CorporateActionMovementConfirmationV02.mmCorporateActionGeneralInformation, CorporateActionMovementConfirmationV02.mmAccountDetails, CorporateActionMovementConfirmationV02.mmCorporateActionConfirmationDetails,
						CorporateActionMovementConfirmationV02.mmAdditionalInformation, CorporateActionMovementConfirmationV02.mmIssuerAgent, CorporateActionMovementConfirmationV02.mmPayingAgent,
						CorporateActionMovementConfirmationV02.mmSubPayingAgent, CorporateActionMovementConfirmationV02.mmSupplementaryData);
