...
public class CorporateActionInstructionStatementReportV05 {
	...
	public void setAccountAndStatementDetails(List<AccountIdentification33> accountAndStatementDetails) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:seev.042.05.05")
