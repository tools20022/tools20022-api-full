 ...
 * CorporateActionInstructionStatementReportV05.mmAccountAndStatementDetails}</li>
 * <li>
...
@XmlType(name = "CorporateActionInstructionStatementReportV05", propOrder = {"pagination", "statementGeneralDetails", "accountAndStatementDetails", "supplementaryData"})
public class CorporateActionInstructionStatementReportV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, Pagination> mmPagination = new MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, Pagination>() {
		{
			xmlTag = "Pgntn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Pagination";
			definition = "Page number of the message (within a statement) and continuation indicator to indicate that the statement is to continue or that the message is the last page of the statement.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV06.mmPagination);
			previousVersion_lazy = () -> CorporateActionInstructionStatementReportV04.mmPagination;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Pagination getValue(CorporateActionInstructionStatementReportV05 obj) {
			return obj.getPagination();
		}

		@Override
		public void setValue(CorporateActionInstructionStatementReportV05 obj, Pagination value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, Statement47> mmStatementGeneralDetails = new MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, Statement47>() {
		{
			xmlTag = "StmtGnlDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "StatementGeneralDetails";
			definition = "General characteristics related to a statement which reports information.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV06.mmStatementGeneralDetails);
			previousVersion_lazy = () -> CorporateActionInstructionStatementReportV04.mmStatementGeneralDetails;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Statement47 getValue(CorporateActionInstructionStatementReportV05 obj) {
			return obj.getStatementGeneralDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionStatementReportV05 obj, Statement47 value) {
			obj.setStatementGeneralDetails(value);
		}
	};
	@XmlElement(name = "AcctAndStmtDtls", required = true)
	protected List<AccountIdentification33> accountAndStatementDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * CorporateActionInstructionStatementReportV06.mmAccountAndStatementDetails
	 * }</li>
	 * </ul>
	 * </li>
	 * <li>
	 ...
	 * CorporateActionInstructionStatementReportV04.mmAccountAndStatementDetails
	 * }</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, List<AccountIdentification33>> mmAccountAndStatementDetails = new MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, List<AccountIdentification33>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV06.mmAccountAndStatementDetails);
			previousVersion_lazy = () -> CorporateActionInstructionStatementReportV04.mmAccountAndStatementDetails;
			minOccurs = 1;
			complexType_lazy = () -> AccountIdentification33.mmObject();
		}

		@Override
		public List<AccountIdentification33> getValue(CorporateActionInstructionStatementReportV05 obj) {
			return obj.getAccountAndStatementDetails();
		}

		@Override
		public void setValue(CorporateActionInstructionStatementReportV05 obj, List<AccountIdentification33> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CorporateActionInstructionStatementReportV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that can not be captured in the structured fields and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV06.mmSupplementaryData);
			previousVersion_lazy = () -> CorporateActionInstructionStatementReportV04.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CorporateActionInstructionStatementReportV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CorporateActionInstructionStatementReportV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMultipleAccountAndStatementDetailsRule.for_seev_CorporateActionInstructionStatementReportV05,
						com.tools20022.repository.constraints.ConstraintCorporateActionEventAndBalanceRule.for_seev_CorporateActionInstructionStatementReportV05);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionInstructionStatementReportV05";
				definition = "Scope\r\nAn account servicer sends the CorporateActionInstructionStatementReport message to an account owner or its designated agent to report balances at the safekeeping account level for one or more corporate action events or at the corporate action event level for one or more safekeeping accounts.\r\nUsage\r\nThe message may also be used to:\r\n- re-send a message previously sent (the sub-function of the message is Duplicate),\r\n- provide a third party with a copy of a message for information (the sub-function of the message is Copy),\r\n- re-send to a third party a copy of a message for information (the sub-function of the message is Copy Duplicate),\r\nusing the relevant elements in the business application header (BAH).";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReportV06.mmObject());
				previousVersion_lazy = () -> CorporateActionInstructionStatementReportV04.mmObject();
			...
			public Class<?> getInstanceClass() {
				return CorporateActionInstructionStatementReportV05.class;
			}
		});
	...
	public CorporateActionInstructionStatementReportV05 setPagination(Pagination pagination) {
	...
	public CorporateActionInstructionStatementReportV05 setStatementGeneralDetails(Statement47 statementGeneralDetails) {
		this.statementGeneralDetails = Objects.requireNonNull(statementGeneralDetails);
		return this;
	}

	public List<AccountIdentification33> getAccountAndStatementDetails() {
		return accountAndStatementDetails == null ? accountAndStatementDetails = new ArrayList<>() : accountAndStatementDetails;
	}

	public CorporateActionInstructionStatementReportV05 setAccountAndStatementDetails(List<AccountIdentification33> accountAndStatementDetails) {
	...
	public CorporateActionInstructionStatementReportV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CorporateActionInstructionStatementReportV05 messageBody;
	}
}