 ...
 * {@linkplain com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05#identifier
 * CorporateActionInstructionStatementReportV05.identifier}</li>
 * <li>
...
public class CorporateActionInstructionStatementReportV05 {
	...
	public static final MMMessageBuildingBlock Pagination = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV04.Pagination;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV06.Pagination);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock StatementGeneralDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV04.StatementGeneralDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV06.StatementGeneralDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock AccountAndStatementDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV04.AccountAndStatementDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV06.AccountAndStatementDetails);
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV04#SupplementaryData
	 * CorporateActionInstructionStatementReportV04.SupplementaryData}</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV04.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV06.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05.Pagination,
						com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05.StatementGeneralDetails, com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05.AccountAndStatementDetails,
						com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.seev.CorporateActionInstructionStatementReportV05.identifier;
			}
		});
