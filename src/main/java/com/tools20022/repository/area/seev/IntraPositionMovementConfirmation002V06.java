 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06#mmSupplementaryData
...
public class IntraPositionMovementConfirmation002V06 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<AdditionalParameters25>> mmAdditionalParameters = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<AdditionalParameters25>>() {
		{
			xmlTag = "AddtlParams";
		...
		@Override
		public Optional<AdditionalParameters25> getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getAdditionalParameters();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, Optional<AdditionalParameters25> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<PartyIdentification103Choice>> mmAccountOwner = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<PartyIdentification103Choice>>() {
		{
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
		...
		@Override
		public Optional<PartyIdentification103Choice> getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, Optional<PartyIdentification103Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, SecuritiesAccount27> mmSafekeepingAccount = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, SecuritiesAccount27>() {
		{
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SecuritiesAccount27 getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, SecuritiesAccount27 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<SafekeepingPlaceFormat17Choice>> mmSafekeepingPlace = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<SafekeepingPlaceFormat17Choice>>() {
		{
			xmlTag = "SfkpgPlc";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<SafekeepingPlaceFormat17Choice> getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, Optional<SafekeepingPlaceFormat17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, SecurityIdentification20> mmFinancialInstrumentIdentification = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, SecurityIdentification20>() {
		{
			xmlTag = "FinInstrmId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SecurityIdentification20 getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, SecurityIdentification20 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<FinancialInstrumentAttributes75>> mmFinancialInstrumentAttributes = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, Optional<FinancialInstrumentAttributes75>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentAttributes75> getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getFinancialInstrumentAttributes();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, Optional<FinancialInstrumentAttributes75> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, IntraPositionDetails43> mmIntraPositionDetails = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, IntraPositionDetails43>() {
		{
			xmlTag = "IntraPosDtls";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public IntraPositionDetails43 getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getIntraPositionDetails();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, IntraPositionDetails43 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<IntraPositionMovementConfirmation002V06, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(IntraPositionMovementConfirmation002V06 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(IntraPositionMovementConfirmation002V06 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				definition = "Scope\r\nAn account servicer sends a IntraPositionMovementConfirmation to an account owner to confirm the movement of securities within its holding from one sub-balance to another, for example, blocking of securities. \r\nThe account servicer/owner relationship may be:\r\n- a central securities depository or another settlement market infrastructure acting on behalf of their participants\r\n- an agent (sub-custodian) acting on behalf of their global custodian customer, or \r\n- a custodian acting on behalf of an investment management institution or a broker/dealer.\r\n\r\nUsage\r\nThe message may also be used to:\r\n- re-send a message previously sent,\r\n- provide a third party with a copy of a message for information,\r\n- re-send to a third party a copy of a message for information\r\nusing the relevant elements in the Business Application Header.";
				nextVersions_lazy = () -> Arrays.asList(IntraPositionMovementConfirmation002V07.mmObject());
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmAdditionalParameters,
						com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmAccountOwner, com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmSafekeepingAccount,
						com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmSafekeepingPlace, com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmFinancialInstrumentIdentification,
						com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmFinancialInstrumentAttributes, com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmIntraPositionDetails,
						com.tools20022.repository.area.seev.IntraPositionMovementConfirmation002V06.mmSupplementaryData);
