		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerPaymentReversalV04.mmGroupHeader, CustomerPaymentReversalV04.mmOriginalGroupInformation, CustomerPaymentReversalV04.mmOriginalPaymentInformationAndReversal,
						CustomerPaymentReversalV04.mmSupplementaryData);
