...
import com.tools20022.repository.msg.PaymentInstruction9;
 ...
 * messageDefinitionIdentifier} = {@code pain.001.001.05}</li>
 ...
 * ConstraintSupplementaryDataRule.for_pain_CustomerCreditTransferInitiationV05}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CustomerCreditTransferInitiationV05", propOrder = {"groupHeader", "paymentInformation", "supplementaryData"})
public class CustomerCreditTransferInitiationV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, GroupHeader48> mmGroupHeader = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, GroupHeader48>() {
		{
			xmlTag = "GrpHdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupHeader";
			definition = "Set of characteristics shared by all individual transactions included in the message.";
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV06.mmGroupHeader);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GroupHeader48 getValue(CustomerCreditTransferInitiationV05 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV05 obj, GroupHeader48 value) {
			obj.setGroupHeader(value);
		}
	};
	@XmlElement(name = "PmtInf", required = true)
	protected List<PaymentInstruction9> paymentInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, List<PaymentInstruction9>> mmPaymentInformation = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, List<PaymentInstruction9>>() {
		{
			xmlTag = "PmtInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV06.mmPaymentInformation);
			minOccurs = 1;
			complexType_lazy = () -> PaymentInstruction9.mmObject();
		}

		@Override
		public List<PaymentInstruction9> getValue(CustomerCreditTransferInitiationV05 obj) {
			return obj.getPaymentInformation();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV05 obj, List<PaymentInstruction9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV06.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CustomerCreditTransferInitiationV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_CustomerCreditTransferInitiationV05);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CustomerCreditTransferInitiationV05";
				definition = "Scope\r\nThe CustomerCreditTransferInitiation message is sent by the initiating party to the forwarding agent or debtor agent. It is used to request movement of funds from the debtor account to a creditor.\r\nUsage\r\nThe CustomerCreditTransferInitiation message can contain one or more customer credit transfer instructions.\r\nThe CustomerCreditTransferInitiation message is used to exchange:\r\n- One or more instances of a credit transfer initiation;\r\n- Payment transactions that result in book transfers at the debtor agent or payments to another financial institution;\r\n- Payment transactions that result in an electronic cash transfer to the creditor account or in the emission of a cheque.\r\nThe message can be used in a direct or a relay scenario:\r\n- In a direct scenario, the message is sent directly to the debtor agent. The debtor agent is the account servicer of the debtor.\r\n- In a relay scenario, the message is sent to a forwarding agent. The forwarding agent acts as a concentrating financial institution. It will forward the CustomerCreditTransferInitiation message to the debtor agent.\r\nThe message can also be used by an initiating party that has authority to send the message on behalf of the debtor. This caters for example for the scenario of a payments factory initiating all payments on behalf of a large corporate.\r\nThe CustomerCreditTransferInitiation message can be used in domestic and cross-border scenarios.\r\nThe CustomerCreditTransferInitiation message must not be used by the debtor agent to execute the credit transfer instruction(s). The FIToFICustomerCreditTransfer message must be used instead.";
				nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV06.mmObject());
				previousVersion_lazy = () -> CustomerCreditTransferInitiationV04.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "CstmrCdtTrfInitn";
				businessArea_lazy = () -> PaymentsInitiationArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV05.mmGroupHeader,
						com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV05.mmPaymentInformation, com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV05.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return CustomerCreditTransferInitiationV05.class;
			}
		});
	...
	public CustomerCreditTransferInitiationV05 setGroupHeader(GroupHeader48 groupHeader) {
		this.groupHeader = Objects.requireNonNull(groupHeader);
		return this;
	}

	public List<PaymentInstruction9> getPaymentInformation() {
		return paymentInformation == null ? paymentInformation = new ArrayList<>() : paymentInformation;
	}

	public CustomerCreditTransferInitiationV05 setPaymentInformation(List<PaymentInstruction9> paymentInformation) {
	...
	public CustomerCreditTransferInitiationV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerCreditTransferInitiationV05 messageBody;
	}
}