	...
	public static final MMMessageBuildingBlock mmGroupHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> MandateAmendmentRequestV04.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmUnderlyingAmendmentDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> MandateAmendmentRequestV04.mmUnderlyingAmendmentDetails;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> MandateAmendmentRequestV04.mmSupplementaryData;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MandateAmendmentRequestV05.mmGroupHeader, MandateAmendmentRequestV05.mmUnderlyingAmendmentDetails, MandateAmendmentRequestV05.mmSupplementaryData);
