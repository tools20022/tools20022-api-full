		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerPaymentStatusReportV05.mmGroupHeader, CustomerPaymentStatusReportV05.mmOriginalGroupInformationAndStatus,
						CustomerPaymentStatusReportV05.mmOriginalPaymentInformationAndStatus, CustomerPaymentStatusReportV05.mmSupplementaryData);
