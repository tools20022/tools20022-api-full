 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGroupStatusAcceptedRule#for_pain_CustomerPaymentStatusReportV05
 * ConstraintGroupStatusAcceptedRule.for_pain_CustomerPaymentStatusReportV05}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGroupStatusPendingRule#for_pain_CustomerPaymentStatusReportV05
 * ConstraintGroupStatusPendingRule.for_pain_CustomerPaymentStatusReportV05}</li>
 * <li>
 ...
 * ConstraintGroupStatusRejectedRule.for_pain_CustomerPaymentStatusReportV05}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGroupStatusReceivedRule#for_pain_CustomerPaymentStatusReportV05
 * ConstraintGroupStatusReceivedRule.for_pain_CustomerPaymentStatusReportV05}</li>
 * <li>
...
@XmlType(name = "CustomerPaymentStatusReportV05", propOrder = {"groupHeader", "originalGroupInformationAndStatus", "originalPaymentInformationAndStatus", "supplementaryData"})
public class CustomerPaymentStatusReportV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentStatusReportV05, GroupHeader52> mmGroupHeader = new MMMessageBuildingBlock<CustomerPaymentStatusReportV05, GroupHeader52>() {
		{
			xmlTag = "GrpHdr";
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentStatusReportV06.mmGroupHeader);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GroupHeader52 getValue(CustomerPaymentStatusReportV05 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerPaymentStatusReportV05 obj, GroupHeader52 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentStatusReportV05, OriginalGroupHeader1> mmOriginalGroupInformationAndStatus = new MMMessageBuildingBlock<CustomerPaymentStatusReportV05, OriginalGroupHeader1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentStatusReportV06.mmOriginalGroupInformationAndStatus);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OriginalGroupHeader1 getValue(CustomerPaymentStatusReportV05 obj) {
			return obj.getOriginalGroupInformationAndStatus();
		}

		@Override
		public void setValue(CustomerPaymentStatusReportV05 obj, OriginalGroupHeader1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentStatusReportV05, List<OriginalPaymentInstruction6>> mmOriginalPaymentInformationAndStatus = new MMMessageBuildingBlock<CustomerPaymentStatusReportV05, List<OriginalPaymentInstruction6>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentStatusReportV06.mmOriginalPaymentInformationAndStatus);
			minOccurs = 0;
			complexType_lazy = () -> OriginalPaymentInstruction6.mmObject();
		}

		@Override
		public List<OriginalPaymentInstruction6> getValue(CustomerPaymentStatusReportV05 obj) {
			return obj.getOriginalPaymentInformationAndStatus();
		}

		@Override
		public void setValue(CustomerPaymentStatusReportV05 obj, List<OriginalPaymentInstruction6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentStatusReportV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerPaymentStatusReportV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentStatusReportV06.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CustomerPaymentStatusReportV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerPaymentStatusReportV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupStatusAcceptedRule.for_pain_CustomerPaymentStatusReportV05,
						com.tools20022.repository.constraints.ConstraintGroupStatusPendingRule.for_pain_CustomerPaymentStatusReportV05,
						com.tools20022.repository.constraints.ConstraintGroupStatusRejectedRule.for_pain_CustomerPaymentStatusReportV05,
						com.tools20022.repository.constraints.ConstraintGroupStatusReceivedRule.for_pain_CustomerPaymentStatusReportV05,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_CustomerPaymentStatusReportV05);
			...
			public Class<?> getInstanceClass() {
				return CustomerPaymentStatusReportV05.class;
			}
		});
	...
	public CustomerPaymentStatusReportV05 setGroupHeader(GroupHeader52 groupHeader) {
	...
	public CustomerPaymentStatusReportV05 setOriginalGroupInformationAndStatus(OriginalGroupHeader1 originalGroupInformationAndStatus) {
	...
	public CustomerPaymentStatusReportV05 setOriginalPaymentInformationAndStatus(List<OriginalPaymentInstruction6> originalPaymentInformationAndStatus) {
	...
	public CustomerPaymentStatusReportV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerPaymentStatusReportV05 messageBody;
	}
}