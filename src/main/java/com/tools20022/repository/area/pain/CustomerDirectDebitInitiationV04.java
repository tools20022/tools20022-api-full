 ...
 * ConstraintSupplementaryDataRule.for_pain_CustomerDirectDebitInitiationV04}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CustomerDirectDebitInitiationV04", propOrder = {"groupHeader", "paymentInformation", "supplementaryData"})
public class CustomerDirectDebitInitiationV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, GroupHeader55> mmGroupHeader = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, GroupHeader55>() {
		{
			xmlTag = "GrpHdr";
		...
		@Override
		public GroupHeader55 getValue(CustomerDirectDebitInitiationV04 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV04 obj, GroupHeader55 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, List<PaymentInstruction10>> mmPaymentInformation = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, List<PaymentInstruction10>>() {
		{
			xmlTag = "PmtInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PaymentInstruction10> getValue(CustomerDirectDebitInitiationV04 obj) {
			return obj.getPaymentInformation();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV04 obj, List<PaymentInstruction10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(CustomerDirectDebitInitiationV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV04 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_CustomerDirectDebitInitiationV04);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV04.mmGroupHeader, com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV04.mmPaymentInformation,
						com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV04.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return CustomerDirectDebitInitiationV04.class;
			}
		});
	...
	public CustomerDirectDebitInitiationV04 setGroupHeader(GroupHeader55 groupHeader) {
	...
	public CustomerDirectDebitInitiationV04 setPaymentInformation(List<PaymentInstruction10> paymentInformation) {
	...
	public CustomerDirectDebitInitiationV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerDirectDebitInitiationV04 messageBody;
	}
}