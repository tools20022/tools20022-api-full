		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerDirectDebitInitiationV06.mmGroupHeader, CustomerDirectDebitInitiationV06.mmPaymentInformation, CustomerDirectDebitInitiationV06.mmSupplementaryData);
