...
public class MandateInitiationRequestV04 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_MandateInitiationRequestV04);
	...
	public MandateInitiationRequestV04 setGroupHeader(GroupHeader47 groupHeader) {
	...
	public MandateInitiationRequestV04 setMandate(List<Mandate7> mandate) {
	...
	public MandateInitiationRequestV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
