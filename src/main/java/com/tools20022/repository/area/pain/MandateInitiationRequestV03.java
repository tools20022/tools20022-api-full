		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MandateInitiationRequestV03.mmGroupHeader, MandateInitiationRequestV03.mmMandate, MandateInitiationRequestV03.mmSupplementaryData);
