...
public class CustomerPaymentReversalV06 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentReversalV06, GroupHeader56> mmGroupHeader = new MMMessageBuildingBlock<CustomerPaymentReversalV06, GroupHeader56>() {
		{
			xmlTag = "GrpHdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupHeader";
			definition = "Set of characteristics shared by all individual transactions included in the message.";
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentReversalV07.mmGroupHeader);
			previousVersion_lazy = () -> CustomerPaymentReversalV05.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GroupHeader56 getValue(CustomerPaymentReversalV06 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerPaymentReversalV06 obj, GroupHeader56 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentReversalV06, OriginalGroupHeader3> mmOriginalGroupInformation = new MMMessageBuildingBlock<CustomerPaymentReversalV06, OriginalGroupHeader3>() {
		{
			xmlTag = "OrgnlGrpInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OriginalGroupInformation";
			definition = "Information concerning the original group of transactions, to which the message refers.";
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentReversalV07.mmOriginalGroupInformation);
			previousVersion_lazy = () -> CustomerPaymentReversalV05.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OriginalGroupHeader3 getValue(CustomerPaymentReversalV06 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(CustomerPaymentReversalV06 obj, OriginalGroupHeader3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentReversalV06, List<OriginalPaymentInstruction16>> mmOriginalPaymentInformationAndReversal = new MMMessageBuildingBlock<CustomerPaymentReversalV06, List<OriginalPaymentInstruction16>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentReversalV07.mmOriginalPaymentInformationAndReversal);
		...
		@Override
		public List<OriginalPaymentInstruction16> getValue(CustomerPaymentReversalV06 obj) {
			return obj.getOriginalPaymentInformationAndReversal();
		}

		@Override
		public void setValue(CustomerPaymentReversalV06 obj, List<OriginalPaymentInstruction16> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerPaymentReversalV06, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerPaymentReversalV06, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CustomerPaymentReversalV07.mmSupplementaryData);
			previousVersion_lazy = () -> CustomerPaymentReversalV05.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CustomerPaymentReversalV06 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerPaymentReversalV06 obj, List<SupplementaryData1> value) {
	...
	public CustomerPaymentReversalV06 setGroupHeader(GroupHeader56 groupHeader) {
	...
	public CustomerPaymentReversalV06 setOriginalGroupInformation(OriginalGroupHeader3 originalGroupInformation) {
	...
	public CustomerPaymentReversalV06 setOriginalPaymentInformationAndReversal(List<OriginalPaymentInstruction16> originalPaymentInformationAndReversal) {
	...
	public CustomerPaymentReversalV06 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
