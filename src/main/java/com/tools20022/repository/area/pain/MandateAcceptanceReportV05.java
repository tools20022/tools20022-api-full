	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.MandateAcceptanceReportV04.GroupHeader;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock UnderlyingAcceptanceDetails = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.MandateAcceptanceReportV04.UnderlyingAcceptanceDetails;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.MandateAcceptanceReportV04.SupplementaryData;
			minOccurs = 0;
