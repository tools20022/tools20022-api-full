 ...
 * {@linkplain com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV03#identifier
 * CreditorPaymentActivationRequestV03.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV04.GroupHeader);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock PaymentInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV04.PaymentInformation);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV04.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV03.GroupHeader,
						com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV03.PaymentInformation, com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV03.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV03.identifier;
			}
		});
