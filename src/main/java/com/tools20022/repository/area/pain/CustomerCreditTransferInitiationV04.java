		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV04.mmGroupHeader, CustomerCreditTransferInitiationV04.mmPaymentInformation, CustomerCreditTransferInitiationV04.mmSupplementaryData);
