...
import com.tools20022.repository.msg.PaymentInstruction6;
 ...
 * messageDefinitionIdentifier} = {@code pain.001.001.04}</li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV04#mmGroupHeader
 * CustomerCreditTransferInitiationV04.mmGroupHeader}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV04#mmSupplementaryData
 * CustomerCreditTransferInitiationV04.mmSupplementaryData}</li>
 * </ul>
 * </li>
...
@XmlType(name = "CustomerCreditTransferInitiationV04", propOrder = {"groupHeader", "paymentInformation", "supplementaryData"})
public class CustomerCreditTransferInitiationV04 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, GroupHeader48> mmGroupHeader = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, GroupHeader48>() {
		{
			xmlTag = "GrpHdr";
		...
		@Override
		public GroupHeader48 getValue(CustomerCreditTransferInitiationV04 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV04 obj, GroupHeader48 value) {
			obj.setGroupHeader(value);
		}
	};
	@XmlElement(name = "PmtInf", required = true)
	protected List<PaymentInstruction6> paymentInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, List<PaymentInstruction6>> mmPaymentInformation = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, List<PaymentInstruction6>>() {
		{
			xmlTag = "PmtInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			minOccurs = 1;
			complexType_lazy = () -> PaymentInstruction6.mmObject();
		}

		@Override
		public List<PaymentInstruction6> getValue(CustomerCreditTransferInitiationV04 obj) {
			return obj.getPaymentInformation();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV04 obj, List<PaymentInstruction6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV04, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(CustomerCreditTransferInitiationV04 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV04 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				name = "CustomerCreditTransferInitiationV04";
				definition = "Scope\r\nThe CustomerCreditTransferInitiation message is sent by the initiating party to the forwarding agent or debtor agent. It is used to request movement of funds from the debtor account to a creditor.\r\nUsage\r\nThe CustomerCreditTransferInitiation message can contain one or more customer credit transfer instructions.\r\nThe CustomerCreditTransferInitiation message is used to exchange:\r\n- One or more instances of a credit transfer initiation;\r\n- Payment transactions that result in book transfers at the debtor agent or payments to another financial institution;\r\n- Payment transactions that result in an electronic cash transfer to the creditor account or in the emission of a cheque.\r\nThe message can be used in a direct or a relay scenario:\r\n- In a direct scenario, the message is sent directly to the debtor agent. The debtor agent is the account servicer of the debtor.\r\n- In a relay scenario, the message is sent to a forwarding agent. The forwarding agent acts as a concentrating financial institution. It will forward the CustomerCreditTransferInitiation message to the debtor agent.\r\nThe message can also be used by an initiating party that has authority to send the message on behalf of the debtor. This caters for example for the scenario of a payments factory initiating all payments on behalf of a large corporate.\r\nThe CustomerCreditTransferInitiation message can be used in domestic and cross-border scenarios.\r\nThe CustomerCreditTransferInitiation message must not be used by the debtor agent to execute the credit transfer instruction(s). The FIToFICustomerCreditTransfer message must be used instead.";
				nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV05.mmObject());
				previousVersion_lazy = () -> CustomerCreditTransferInitiationV03.mmObject();
				messageSet_lazy = () -> Arrays.asList(ISOArchive.mmObject());
				rootElement = "Document";
				xmlTag = "CstmrCdtTrfInitn";
				businessArea_lazy = () -> PaymentsInitiationArchive.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV04.mmGroupHeader,
						com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV04.mmPaymentInformation, com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV04.mmSupplementaryData);
			...
			public Class<?> getInstanceClass() {
				return CustomerCreditTransferInitiationV04.class;
			}
		});
	...
	public CustomerCreditTransferInitiationV04 setGroupHeader(GroupHeader48 groupHeader) {
		this.groupHeader = Objects.requireNonNull(groupHeader);
		return this;
	}

	public List<PaymentInstruction6> getPaymentInformation() {
		return paymentInformation == null ? paymentInformation = new ArrayList<>() : paymentInformation;
	}

	public CustomerCreditTransferInitiationV04 setPaymentInformation(List<PaymentInstruction6> paymentInformation) {
	...
	public CustomerCreditTransferInitiationV04 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerCreditTransferInitiationV04 messageBody;
	}
}