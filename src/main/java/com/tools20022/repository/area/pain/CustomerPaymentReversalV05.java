 ...
 * {@linkplain com.tools20022.repository.area.pain.CustomerPaymentReversalV05#identifier
 * CustomerPaymentReversalV05.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.GroupHeader;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.GroupHeader);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OriginalGroupInformation = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.OriginalGroupInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.OriginalGroupInformation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock OriginalPaymentInformationAndReversal = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.OriginalPaymentInformationAndReversal;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.OriginalPaymentInformationAndReversal);
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV05.GroupHeader, com.tools20022.repository.area.pain.CustomerPaymentReversalV05.OriginalGroupInformation,
						com.tools20022.repository.area.pain.CustomerPaymentReversalV05.OriginalPaymentInformationAndReversal, com.tools20022.repository.area.pain.CustomerPaymentReversalV05.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV05.identifier;
			}
		});
