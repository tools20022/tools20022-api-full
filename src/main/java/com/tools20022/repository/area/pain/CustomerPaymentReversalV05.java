		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerPaymentReversalV05.mmGroupHeader, CustomerPaymentReversalV05.mmOriginalGroupInformation, CustomerPaymentReversalV05.mmOriginalPaymentInformationAndReversal,
						CustomerPaymentReversalV05.mmSupplementaryData);
