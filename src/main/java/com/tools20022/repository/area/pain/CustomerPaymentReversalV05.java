...
public class CustomerPaymentReversalV05 {
	...
	public static final MMMessageBuildingBlock mmGroupHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.mmGroupHeader);
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmOriginalGroupInformation = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.mmOriginalGroupInformation);
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock mmOriginalPaymentInformationAndReversal = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.mmOriginalPaymentInformationAndReversal);
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.mmOriginalPaymentInformationAndReversal;
			minOccurs = 0;
	...
	public static final MMMessageBuildingBlock mmSupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.area.pain.CustomerPaymentReversalV04.mmSupplementaryData;
			minOccurs = 0;
	...
	public void setOriginalPaymentInformationAndReversal(List<OriginalPaymentInstruction11> originalPaymentInformationAndReversal) {
