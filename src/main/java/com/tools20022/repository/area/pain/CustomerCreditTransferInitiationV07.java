...
import com.tools20022.repository.msg.PaymentInstruction20;
 ...
 * ConstraintSupplementaryDataRule.for_pain_CustomerCreditTransferInitiationV07}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CustomerCreditTransferInitiationV07", propOrder = {"groupHeader", "paymentInformation", "supplementaryData"})
public class CustomerCreditTransferInitiationV07 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, GroupHeader48> mmGroupHeader = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, GroupHeader48>() {
		{
			xmlTag = "GrpHdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupHeader";
			definition = "Set of characteristics shared by all individual transactions included in the message.";
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV08.mmGroupHeader);
			previousVersion_lazy = () -> CustomerCreditTransferInitiationV06.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GroupHeader48 getValue(CustomerCreditTransferInitiationV07 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV07 obj, GroupHeader48 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, List<PaymentInstruction20>> mmPaymentInformation = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, List<PaymentInstruction20>>() {
		{
			xmlTag = "PmtInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV08.mmPaymentInformation);
			previousVersion_lazy = () -> CustomerCreditTransferInitiationV06.mmPaymentInformation;
			minOccurs = 1;
			complexType_lazy = () -> PaymentInstruction20.mmObject();
		}

		@Override
		public List<PaymentInstruction20> getValue(CustomerCreditTransferInitiationV07 obj) {
			return obj.getPaymentInformation();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV07 obj, List<PaymentInstruction20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerCreditTransferInitiationV07, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SupplementaryData";
			definition = "Additional information that cannot be captured in the structured elements and/or any other specific block.";
			nextVersions_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV08.mmSupplementaryData);
			previousVersion_lazy = () -> CustomerCreditTransferInitiationV06.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CustomerCreditTransferInitiationV07 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerCreditTransferInitiationV07 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_CustomerCreditTransferInitiationV07);
			...
			public Class<?> getInstanceClass() {
				return CustomerCreditTransferInitiationV07.class;
			}
		});
	...
	public CustomerCreditTransferInitiationV07 setGroupHeader(GroupHeader48 groupHeader) {
	...
	public CustomerCreditTransferInitiationV07 setPaymentInformation(List<PaymentInstruction20> paymentInformation) {
	...
	public CustomerCreditTransferInitiationV07 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
	...
	static public class Document {
		...
		public CustomerCreditTransferInitiationV07 messageBody;
	}
}