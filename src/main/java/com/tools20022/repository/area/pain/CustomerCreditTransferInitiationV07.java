		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV07.mmGroupHeader, CustomerCreditTransferInitiationV07.mmPaymentInformation, CustomerCreditTransferInitiationV07.mmSupplementaryData);
