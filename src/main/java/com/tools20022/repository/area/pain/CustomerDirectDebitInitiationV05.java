 ...
 * ConstraintSupplementaryDataRule.for_pain_CustomerDirectDebitInitiationV05}</li>
 * </ul>
 * </li>
 * <li>
...
public class CustomerDirectDebitInitiationV05 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, GroupHeader55> mmGroupHeader = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, GroupHeader55>() {
		{
			xmlTag = "GrpHdr";
		...
		@Override
		public GroupHeader55 getValue(CustomerDirectDebitInitiationV05 obj) {
			return obj.getGroupHeader();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV05 obj, GroupHeader55 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, List<PaymentInstruction15>> mmPaymentInformation = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, List<PaymentInstruction15>>() {
		{
			xmlTag = "PmtInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PaymentInstruction15> getValue(CustomerDirectDebitInitiationV05 obj) {
			return obj.getPaymentInformation();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV05 obj, List<PaymentInstruction15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<CustomerDirectDebitInitiationV05, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(CustomerDirectDebitInitiationV05 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CustomerDirectDebitInitiationV05 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_pain_CustomerDirectDebitInitiationV05);
