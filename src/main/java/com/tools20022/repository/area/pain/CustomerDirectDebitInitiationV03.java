		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerDirectDebitInitiationV03.mmGroupHeader, CustomerDirectDebitInitiationV03.mmPaymentInformation, CustomerDirectDebitInitiationV03.mmSupplementaryData);
