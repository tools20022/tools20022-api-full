		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(MandateAmendmentRequestV03.mmGroupHeader, MandateAmendmentRequestV03.mmUnderlyingAmendmentDetails, MandateAmendmentRequestV03.mmSupplementaryData);
