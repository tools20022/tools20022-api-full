 ...
 * {@linkplain com.tools20022.repository.area.pain.MandateAmendmentRequestV03#identifier
 * MandateAmendmentRequestV03.identifier}</li>
 * <li>
	...
	public static final MMMessageBuildingBlock GroupHeader = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.MandateAmendmentRequestV04.GroupHeader);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageBuildingBlock UnderlyingAmendmentDetails = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.MandateAmendmentRequestV04.UnderlyingAmendmentDetails);
			minOccurs = 1;
	...
	public static final MMMessageBuildingBlock SupplementaryData = new MMMessageBuildingBlock() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.MandateAmendmentRequestV04.SupplementaryData);
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.MandateAmendmentRequestV03.GroupHeader, com.tools20022.repository.area.pain.MandateAmendmentRequestV03.UnderlyingAmendmentDetails,
						com.tools20022.repository.area.pain.MandateAmendmentRequestV03.SupplementaryData);
				messageDefinitionIdentifier_lazy = () -> com.tools20022.repository.area.pain.MandateAmendmentRequestV03.identifier;
			}
		});
