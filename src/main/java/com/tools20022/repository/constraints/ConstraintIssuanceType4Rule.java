...
/**
 * If IssuanceType is "ISSU" then LocalUndertakingDetails must not be present.
 */
public class ConstraintIssuanceType4Rule {
	...
	public static final MMConstraint<UndertakingIssuanceV01> forUndertakingIssuanceV01 = new MMConstraint<UndertakingIssuanceV01>() {
		{
			validator = ConstraintIssuanceType4Rule::checkUndertakingIssuanceV01;
	...
	public static final MMConstraint<UndertakingAdvice2> forUndertakingAdvice2 = new MMConstraint<UndertakingAdvice2>() {
		{
			validator = ConstraintIssuanceType4Rule::checkUndertakingAdvice2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IssuanceType4Rule";
			definition = "If IssuanceType is \"ISSU\" then LocalUndertakingDetails must not be present.";
	...
	/**
	 * If IssuanceType is "ISSU" then LocalUndertakingDetails must not be
	 * present.
	 */
