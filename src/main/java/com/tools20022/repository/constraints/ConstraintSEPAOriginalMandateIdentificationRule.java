...
/**
 * SEPA TVS 3.x rule OriginalMandateIdentification field is mandatory if changes
 * occur in MandateIdentification, otherwise not to be used.
 */
public class ConstraintSEPAOriginalMandateIdentificationRule {
	 ...
	 * name} = "SEPAOriginalMandateIdentificationRule"</li>
	 * <li>
	...
	/**
	 * SEPA TVS 3.x rule OriginalMandateIdentification field is mandatory if
	 * changes occur in MandateIdentification, otherwise not to be used.
	 */
