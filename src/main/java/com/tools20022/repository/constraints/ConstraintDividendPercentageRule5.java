	...
	public static final MMConstraint<AccountDetailsConfirmationV03> for_acmt_AccountDetailsConfirmationV03 = new MMConstraint<AccountDetailsConfirmationV03>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage5Rule.for_acmt_AccountDetailsConfirmationV04);
	...
	public static final MMConstraint<AccountOpeningInstructionV03> for_acmt_AccountOpeningInstructionV03 = new MMConstraint<AccountOpeningInstructionV03>() {
		{
			...
			name = "DividendPercentageRule5";
			definition = "SavingsInvestmentPlan\\CashSettlement\\InterestPaymentInstrument\\DividendPercentage is not allowed.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage5Rule.for_acmt_AccountOpeningInstructionV04);
	...
	public static final MMConstraint<AccountModificationInstructionV03> for_acmt_AccountModificationInstructionV03 = new MMConstraint<AccountModificationInstructionV03>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage5Rule.for_acmt_AccountModificationInstructionV04);
