...
/**
 * If Legal Entity Identifier is not present, then Identification or Name must
 * be present. Identification, Name and Legal Entity Identifier may all be
 * present.
 */
public class ConstraintFundIdentification3Rule {
	 ...
	 * name} = "FundIdentification3Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If Legal Entity Identifier is not present, then Identification or Name must be present. Identification, Name and Legal Entity Identifier may all be present."
	 * </li>
	...
	/**
	 * If Legal Entity Identifier is not present, then Identification or Name
