...
/**
 * An attached document MAY be compressed in a self-describing format.
 */
public class ConstraintCompressedFormatRule {
	 ...
	 * name} = "CompressedFormatRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "An attached document MAY be compressed in a self-describing format."</li>
	 * </ul>
	 */
