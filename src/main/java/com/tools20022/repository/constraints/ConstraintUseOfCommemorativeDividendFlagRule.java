...
/**
 * CommemorativeDividendFlag can only be used with corporate action event type
 * code DVCA.
 */
public class ConstraintUseOfCommemorativeDividendFlagRule {
	 ...
	 * name} = "UseOfCommemorativeDividendFlagRule"</li>
	 * <li>
