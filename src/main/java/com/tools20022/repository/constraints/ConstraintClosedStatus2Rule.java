...
/**
 * If Closed is present then Disabled is not allowed.
 */
public class ConstraintClosedStatus2Rule {
	 ...
	 * name} = "ClosedStatus2Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "If Closed is present then Disabled is not allowed."</li>
	 * </ul>
	 */
	public static final MMConstraint<AccountStatus2> forAccountStatus2 = new MMConstraint<AccountStatus2>() {
		{
			validator = ConstraintClosedStatus2Rule::checkAccountStatus2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ClosedStatus2Rule";
			definition = "If Closed is present then Disabled is not allowed.";
