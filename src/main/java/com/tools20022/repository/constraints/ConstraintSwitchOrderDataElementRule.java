...
/**
 * One of the elements (SettlementAmount, SettlementMethod, AdditionalAmount,
 * UnitCurrency, QuotedCurrency) must be present.
 */
public class ConstraintSwitchOrderDataElementRule {
	...
	/**
	 * One of the elements (SettlementAmount, SettlementMethod,
	 * AdditionalAmount, UnitCurrency, QuotedCurrency) must be present.
	 */
	public static void checkFundOrderData6(FundOrderData6 obj) throws Exception {
