 ...
 * present.
 */
public class ConstraintDateTimeAndCondition4Rule {
	 ...
	 * name} = " DateTimeAndCondition4Rule"</li>
	 * <li>
	...
	public static final MMConstraint<ExpiryTerms1> forExpiryTerms1 = new MMConstraint<ExpiryTerms1>() {
		{
			validator = ConstraintDateTimeAndCondition4Rule::checkExpiryTerms1;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = " DateTimeAndCondition4Rule";
