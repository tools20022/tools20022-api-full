...
/**
 * If InstructionCancellationIdentification is present, then CancellationStatus
 * must be present.
 */
public class ConstraintStatus2Rule {
	...
	public static final MMConstraint<MeetingInstructionStatusV04> for_seev_MeetingInstructionStatusV04 = new MMConstraint<MeetingInstructionStatusV04>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintStatus2Rule.for_seev_MeetingInstructionStatusV05);
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.constraints.ConstraintStatus2Rule#for_seev_MeetingInstructionStatusV04
	 * ConstraintStatus2Rule.for_seev_MeetingInstructionStatusV04}</li>
	 * </ul>
	 */
	public static final MMConstraint<MeetingInstructionStatusV05> for_seev_MeetingInstructionStatusV05 = new MMConstraint<MeetingInstructionStatusV05>() {
		{
			...
			name = "Status2Rule";
			definition = "If InstructionType/InstructionCancellationIdentification is present, then InstructionTypeStatus/CancellationStatus must be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintStatus2Rule.for_seev_MeetingInstructionStatusV04;
