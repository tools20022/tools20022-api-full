...
public class ConstraintPreviousInstructingAgent3AccountRule {
	...
	public static final MMConstraint<PaymentComplementaryInformation7> forPaymentComplementaryInformation7 = new MMConstraint<PaymentComplementaryInformation7>() {
		{
			validator = ConstraintPreviousInstructingAgent3AccountRule::checkPaymentComplementaryInformation7;
	...
	public static final MMConstraint<CreditTransferTransaction31> forCreditTransferTransaction31 = new MMConstraint<CreditTransferTransaction31>() {
		{
			validator = ConstraintPreviousInstructingAgent3AccountRule::checkCreditTransferTransaction31;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousInstructingAgent3AccountRule";
			definition = "If PreviousInstructingAgent3Account is present, then PreviousInstructingAgent3 must be present.";
	...
	public static final MMConstraint<CreditTransferTransaction32> forCreditTransferTransaction32 = new MMConstraint<CreditTransferTransaction32>() {
		{
			validator = ConstraintPreviousInstructingAgent3AccountRule::checkCreditTransferTransaction32;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousInstructingAgent3AccountRule";
			definition = "If PreviousInstructingAgent3Account is present, then PreviousInstructingAgent3 must be present.";
	...
	public static final MMConstraint<CreditTransferTransaction30> forCreditTransferTransaction30 = new MMConstraint<CreditTransferTransaction30>() {
		{
			validator = ConstraintPreviousInstructingAgent3AccountRule::checkCreditTransferTransaction30;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PreviousInstructingAgent3AccountRule";
			definition = "If PreviousInstructingAgent3Account is present, then PreviousInstructingAgent3 must be present.";
