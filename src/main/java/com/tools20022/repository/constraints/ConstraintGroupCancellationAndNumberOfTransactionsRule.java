...
public class ConstraintGroupCancellationAndNumberOfTransactionsRule {
	...
	public static final MMConstraint<UnderlyingTransaction16> forUnderlyingTransaction16 = new MMConstraint<UnderlyingTransaction16>() {
		{
			...
			name = "GroupCancellationAndNumberOfTransactionsRule";
			definition = "If OriginalGroupInformationAndCancellation/GroupCancellation is false, then NumberOfTransactions must equal the number of occurrences of TransactionInformation.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupCancellationAndNumberOfTransactionsRule.forUnderlyingTransaction20);
	...
	public static final MMConstraint<UnderlyingTransaction15> forUnderlyingTransaction15 = new MMConstraint<UnderlyingTransaction15>() {
		{
			...
			name = "GroupCancellationAndNumberOfTransactionsRule";
			definition = "If OriginalGroupInformationAndCancellation/GroupCancellation is false, then NumberOfTransactions must equal the number of occurrences of TransactionInformation.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupCancellationAndNumberOfTransactionsRule.forUnderlyingTransaction21);
	...
	public static final MMConstraint<UnderlyingTransaction20> forUnderlyingTransaction20 = new MMConstraint<UnderlyingTransaction20>() {
		{
			validator = ConstraintGroupCancellationAndNumberOfTransactionsRule::checkUnderlyingTransaction20;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupCancellationAndNumberOfTransactionsRule";
			definition = "If OriginalGroupInformationAndCancellation/GroupCancellation is false, then NumberOfTransactions must equal the number of occurrences of TransactionInformation.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintGroupCancellationAndNumberOfTransactionsRule.forUnderlyingTransaction16;
	...
	public static final MMConstraint<UnderlyingTransaction21> forUnderlyingTransaction21 = new MMConstraint<UnderlyingTransaction21>() {
		{
			validator = ConstraintGroupCancellationAndNumberOfTransactionsRule::checkUnderlyingTransaction21;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GroupCancellationAndNumberOfTransactionsRule";
			definition = "If OriginalGroupInformationAndCancellation/GroupCancellation is false, then NumberOfTransactions must equal the number of occurrences of TransactionInformation.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintGroupCancellationAndNumberOfTransactionsRule.forUnderlyingTransaction15;
