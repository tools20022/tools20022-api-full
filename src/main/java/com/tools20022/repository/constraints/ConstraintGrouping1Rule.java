...
/**
 * If GroupHeader/Grouping is present and equals GRPD, then one and only one
 * occurrence of PaymentInformation must be present.
 */
public class ConstraintGrouping1Rule {
