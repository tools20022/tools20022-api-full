...
/**
 * If CounterUndertakingIndicator is "false" or "0" (No), then
 * CounterUndertakingDetails must not be present.
 */
public class ConstraintCounterUndertakingNoRule {
	 ...
	 * name} = "CounterUndertakingNoRule"</li>
	 * <li>
