...
public class ConstraintChequeAndCreditorAccountRule {
	...
	public static final MMConstraint<PaymentInstructionInformation3> forPaymentInstructionInformation3 = new MMConstraint<PaymentInstructionInformation3>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstructionInformation3;
	...
	public static final MMConstraint<PaymentInstruction6> forPaymentInstruction6 = new MMConstraint<PaymentInstruction6>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction6;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK, then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
	...
	public static final MMConstraint<PaymentInstruction9> forPaymentInstruction9 = new MMConstraint<PaymentInstruction9>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction9;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK, then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
	...
	public static final MMConstraint<PaymentInstruction16> forPaymentInstruction16 = new MMConstraint<PaymentInstruction16>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction16;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK, then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction20);
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction9;
	...
	public static final MMConstraint<PaymentInstruction20> forPaymentInstruction20 = new MMConstraint<PaymentInstruction20>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction20;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK (Cheque), then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction22,
					com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction24);
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction16;
	...
	public static final MMConstraint<PaymentInstruction22> forPaymentInstruction22 = new MMConstraint<PaymentInstruction22>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction22;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK (Cheque), then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
	...
	public static final MMConstraint<PaymentInstruction24> forPaymentInstruction24 = new MMConstraint<PaymentInstruction24>() {
		{
			validator = ConstraintChequeAndCreditorAccountRule::checkPaymentInstruction24;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ChequeAndCreditorAccountRule";
			definition = "If PaymentMethod is CHK (Cheque), then CreditTransferTransactionInformation/CreditorAccount is not allowed.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction20;
