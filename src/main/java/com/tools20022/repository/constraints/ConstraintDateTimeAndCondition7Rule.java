 ...
 * present.
 */
public class ConstraintDateTimeAndCondition7Rule {
	 ...
	 * name} = " DateTimeAndCondition7Rule"</li>
	 * <li>
	...
	public static final MMConstraint<ExpiryTerms2> forExpiryTerms2 = new MMConstraint<ExpiryTerms2>() {
		{
			validator = ConstraintDateTimeAndCondition7Rule::checkExpiryTerms2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = " DateTimeAndCondition7Rule";
