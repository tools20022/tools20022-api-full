...
public class ConstraintIntermediaryAgent3Rule {
	...
	public static final MMConstraint<CreditTransferTransaction23> forCreditTransferTransaction23 = new MMConstraint<CreditTransferTransaction23>() {
		{
			...
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forCreditTransferTransaction31);
	...
	public static final MMConstraint<CreditTransferTransaction24> forCreditTransferTransaction24 = new MMConstraint<CreditTransferTransaction24>() {
		{
			...
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forCreditTransferTransaction32);
	...
	public static final MMConstraint<PaymentComplementaryInformation6> forPaymentComplementaryInformation6 = new MMConstraint<PaymentComplementaryInformation6>() {
		{
			...
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forPaymentComplementaryInformation7);
	...
	public static final MMConstraint<CreditTransferTransaction27> forCreditTransferTransaction27 = new MMConstraint<CreditTransferTransaction27>() {
		{
			validator = ConstraintIntermediaryAgent3Rule::checkCreditTransferTransaction27;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
	...
	public static final MMConstraint<PaymentComplementaryInformation7> forPaymentComplementaryInformation7 = new MMConstraint<PaymentComplementaryInformation7>() {
		{
			validator = ConstraintIntermediaryAgent3Rule::checkPaymentComplementaryInformation7;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forPaymentComplementaryInformation6;
	...
	public static final MMConstraint<CreditTransferTransaction31> forCreditTransferTransaction31 = new MMConstraint<CreditTransferTransaction31>() {
		{
			validator = ConstraintIntermediaryAgent3Rule::checkCreditTransferTransaction31;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forCreditTransferTransaction23;
	...
	public static final MMConstraint<CreditTransferTransaction32> forCreditTransferTransaction32 = new MMConstraint<CreditTransferTransaction32>() {
		{
			validator = ConstraintIntermediaryAgent3Rule::checkCreditTransferTransaction32;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forCreditTransferTransaction24;
	...
	public static final MMConstraint<CreditTransferTransaction30> forCreditTransferTransaction30 = new MMConstraint<CreditTransferTransaction30>() {
		{
			validator = ConstraintIntermediaryAgent3Rule::checkCreditTransferTransaction30;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IntermediaryAgent3Rule";
			definition = "If IntermediaryAgent3 is present, then IntermediaryAgent2 must be present.";
