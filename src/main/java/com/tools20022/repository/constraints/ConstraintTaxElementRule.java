...
/**
 * One of the elements (TaxableIncomePerDividend, EUCapitalGain,
 * EUDividendStatus, PercentageOfDebtClaim, IndividualTax) must be present.
 */
public class ConstraintTaxElementRule {
	 ...
	 * EUDividendStatus, PercentageOfDebtClaim, IndividualTax) must be present.
	 */
	public static void checkInformativeTax1(InformativeTax1 obj) throws Exception {
