...
/**
 * If OwnerIdentification is not present, then AccountIdentification must be
 * present. Both OwnerIdentification and AccountIdentification may be present.
 */
public class ConstraintAccountOrOwner2Rule {
	 ...
	 * name} = "AccountOrOwner2Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If OwnerIdentification is not present, then AccountIdentification must be present. Both OwnerIdentification and AccountIdentification may be present."
	 * </li>
	 * </ul>
	 */
	...
	/**
	 * If OwnerIdentification is not present, then AccountIdentification must be
	 * present. Both OwnerIdentification and AccountIdentification may be
	 * present.
	 */
