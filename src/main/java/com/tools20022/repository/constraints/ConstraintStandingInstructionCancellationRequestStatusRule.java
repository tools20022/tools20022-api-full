...
/**
 * If AgentCAStandingInstructionCancellationRequestIdentification is present,
 * then StandingInstructionCancellationRequestStatus must be present.
 */
public class ConstraintStandingInstructionCancellationRequestStatusRule {
	 ...
	 * name} = "StandingInstructionCancellationRequestStatusRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If AgentCAStandingInstructionCancellationRequestIdentification is present, then StandingInstructionCancellationRequestStatus must be present."
	 * </li>
	 * </ul>
	 */
	...
	/**
	 * If AgentCAStandingInstructionCancellationRequestIdentification is
	 * present, then StandingInstructionCancellationRequestStatus must be
	 * present.
	 */
