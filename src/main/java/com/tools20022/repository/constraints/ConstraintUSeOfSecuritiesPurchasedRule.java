...
import com.tools20022.repository.msg.CorporateActionEventStageFormat4SD1;

/**
 * The value of SecuritiesPurchased should be the actual number, or 0 (if, as a
 * result, TEND or BIDS will not take place).
 */
public class ConstraintUSeOfSecuritiesPurchasedRule {
	...
	/**
	 * The value of SecuritiesPurchased should be the actual number, or 0 (if,
	 * as a result, TEND or BIDS will not take place).
	 */
	public static void checkCorporateActionEventStageFormat4SD1(CorporateActionEventStageFormat4SD1 obj) throws Exception {
