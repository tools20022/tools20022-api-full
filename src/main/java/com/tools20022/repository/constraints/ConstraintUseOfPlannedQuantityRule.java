...
/**
 * PlannedQuantityCode can only be used with corporate action event type codes
 * TEND or BIDS.
 */
public class ConstraintUseOfPlannedQuantityRule {
	...
	/**
	 * PlannedQuantityCode can only be used with corporate action event type
	 * codes TEND or BIDS.
	 */
