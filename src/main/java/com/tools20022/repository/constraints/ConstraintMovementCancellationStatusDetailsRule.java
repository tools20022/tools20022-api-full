...
/**
 * If AgentCAMovementCancellationRequestIdentification is present then
 * MovementCancellationStatusDetails must be present.
 */
public class ConstraintMovementCancellationStatusDetailsRule {
