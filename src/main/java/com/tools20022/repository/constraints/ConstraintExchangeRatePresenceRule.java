...
import com.tools20022.repository.msg.CurrencyExchange11;

/**
 * ExchangeRate must be present or ForwardExchangeRate must be present.
 */
public class ConstraintExchangeRatePresenceRule {
	 ...
	 * name} = "ExchangeRatePresenceRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "ExchangeRate must be present or ForwardExchangeRate must be present."</li>
	 * </ul>
	 */
	 ...
	 * ExchangeRate must be present or ForwardExchangeRate must be present.
	 */
	public static void checkCurrencyExchange11(CurrencyExchange11 obj) throws Exception {
