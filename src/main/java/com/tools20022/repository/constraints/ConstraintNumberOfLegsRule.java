 ...
 */
public class ConstraintNumberOfLegsRule {
	...
	/**
	 * If IOI Quantity or RelativeSize is present, NumberOfLegs must not be
	 * present.
	 */
	public static void checkIndicationOfInterest1(IndicationOfInterest1 obj) throws Exception {
