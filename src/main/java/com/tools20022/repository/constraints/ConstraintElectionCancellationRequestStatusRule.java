...
/**
 * If AgentCAElectionCancellationRequestIdentification is present, then
 * ElectionCancellationRequestStatus must be present.
 */
public class ConstraintElectionCancellationRequestStatusRule {
	 ...
	 * name} = "ElectionCancellationRequestStatusRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If AgentCAElectionCancellationRequestIdentification is present, then ElectionCancellationRequestStatus must be present."
	 * </li>
	 * </ul>
	 */
	public static final MMConstraint<AgentCAElectionStatusAdviceV01> forAgentCAElectionStatusAdviceV01 = new MMConstraint<AgentCAElectionStatusAdviceV01>() {
		{
			validator = ConstraintElectionCancellationRequestStatusRule::checkAgentCAElectionStatusAdviceV01;
