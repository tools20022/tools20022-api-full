...
/**
 * If SettlementDetails/CashPartiesDetails is present then SettlementCurrency
 * must be present.
 */
public class ConstraintCashPartiesCurrencyPresenceRule {
	 ...
	 * name} = "CashPartiesCurrencyPresenceRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If SettlementDetails/CashPartiesDetails is present then SettlementCurrency must be present."
	 * </li>
	 * </ul>
	 */
