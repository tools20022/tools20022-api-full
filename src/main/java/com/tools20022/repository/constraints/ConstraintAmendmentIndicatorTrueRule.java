...
public class ConstraintAmendmentIndicatorTrueRule {
	...
	public static final MMConstraint<MandateRelatedInformation6> forMandateRelatedInformation6 = new MMConstraint<MandateRelatedInformation6>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation6;
	...
	public static final MMConstraint<MandateRelatedInformation7> forMandateRelatedInformation7 = new MMConstraint<MandateRelatedInformation7>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation7;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
	...
	public static final MMConstraint<MandateRelatedInformation8> forMandateRelatedInformation8 = new MMConstraint<MandateRelatedInformation8>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation8;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAmendmentIndicatorTrueRule.forMandateRelatedInformation10);
	...
	public static final MMConstraint<MandateRelatedInformation9> forMandateRelatedInformation9 = new MMConstraint<MandateRelatedInformation9>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation9;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
	...
	public static final MMConstraint<MandateRelatedInformation10> forMandateRelatedInformation10 = new MMConstraint<MandateRelatedInformation10>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation10;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAmendmentIndicatorTrueRule.forMandateRelatedInformation11);
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintAmendmentIndicatorTrueRule.forMandateRelatedInformation8;
	...
	public static final MMConstraint<MandateRelatedInformation11> forMandateRelatedInformation11 = new MMConstraint<MandateRelatedInformation11>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation11;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
			...
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintAmendmentIndicatorTrueRule.forMandateRelatedInformation10;
	...
	public static final MMConstraint<MandateRelatedInformation12> forMandateRelatedInformation12 = new MMConstraint<MandateRelatedInformation12>() {
		{
			validator = ConstraintAmendmentIndicatorTrueRule::checkMandateRelatedInformation12;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AmendmentIndicatorTrueRule";
			definition = "If AmendmentIndicator is true, then AmendementInformationDetails must be present.";
