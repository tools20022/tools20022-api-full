...
/**
 * If Closed is present then Enabled is not allowed.
 */
public class ConstraintClosedStatus1Rule {
	 ...
	 * name} = "ClosedStatus1Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "If Closed is present then Enabled is not allowed."</li>
	 * </ul>
	 */
	public static final MMConstraint<AccountStatus2> forAccountStatus2 = new MMConstraint<AccountStatus2>() {
		{
			validator = ConstraintClosedStatus1Rule::checkAccountStatus2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ClosedStatus1Rule";
			definition = "If Closed is present then Enabled is not allowed.";
