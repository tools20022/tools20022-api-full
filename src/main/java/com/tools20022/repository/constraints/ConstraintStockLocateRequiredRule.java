...
/**
 * If Type contains the value SSHO (SellShort), then StockLocatedRequired must
 * be present and must contain the value "true" or "1" (Yes).
 */
public class ConstraintStockLocateRequiredRule {
	 ...
	 * name} = "StockLocateRequiredRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If Type contains the value SSHO (SellShort), then StockLocatedRequired must be present and must contain the value \"true\" or \"1\" (Yes)."
	 * </li>
	 * </ul>
	 */
	...
	/**
	 * If Type contains the value SSHO (SellShort), then StockLocatedRequired
	 * must be present and must contain the value "true" or "1" (Yes).
	 */
