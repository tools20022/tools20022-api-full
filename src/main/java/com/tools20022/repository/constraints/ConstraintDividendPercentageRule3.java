 ...
 */
public class ConstraintDividendPercentageRule3 {
	 ...
	 * name} = "DividendPercentageRule3"</li>
	 * <li>
	...
	public static final MMConstraint<AccountDetailsConfirmationV03> forAccountDetailsConfirmationV03 = new MMConstraint<AccountDetailsConfirmationV03>() {
		{
			validator = ConstraintDividendPercentageRule3::checkAccountDetailsConfirmationV03;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage3Rule.forAccountDetailsConfirmationV04);
	 ...
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "ModifiedWithdrawalInvestmentPlan\\InvestmentPlan\\ModifiedCashSettlement\\RedemptionPaymentInstrument\\DividendPercentage is not allowed."
	 * </li>
	 * <li>{@linkplain com.tools20022.metamodel.MMModelEntity#getNextVersions
	 * nextVersions} =
	 * <ul>
	...
	public static final MMConstraint<AccountModificationInstructionV03> forAccountModificationInstructionV03 = new MMConstraint<AccountModificationInstructionV03>() {
		{
			validator = ConstraintDividendPercentageRule3::checkAccountModificationInstructionV03;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DividendPercentageRule3";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage3Rule.forAccountModificationInstructionV04);
	...
	public static final MMConstraint<AccountOpeningInstructionV03> forAccountOpeningInstructionV03 = new MMConstraint<AccountOpeningInstructionV03>() {
		{
			validator = ConstraintDividendPercentageRule3::checkAccountOpeningInstructionV03;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DividendPercentageRule3";
			definition = "WithdrawalInvestmentPlan\\CashSettlement\\RedemptionPaymentInstrument\\DividendPercentage is not allowed.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDividendPercentage3Rule.forAccountOpeningInstructionV04);
