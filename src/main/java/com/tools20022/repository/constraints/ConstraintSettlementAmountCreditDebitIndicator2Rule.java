 ...
 * InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator
 * is present, then CreditDebitIndicator is not allowed If
 * InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator
 * is not present, then CreditDebitIndicator is optional.
 */
public class ConstraintSettlementAmountCreditDebitIndicator2Rule {
	 ...
	 * name} = "SettlementAmountCreditDebitIndicator2Rule"</li>
	 * <li>
	...
	public static final MMConstraint<PaymentSearch2> forPaymentSearch2 = new MMConstraint<PaymentSearch2>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
	...
	public static final MMConstraint<PaymentSearch3> forPaymentSearch3 = new MMConstraint<PaymentSearch3>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch3;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
	...
	public static final MMConstraint<PaymentSearch4> forPaymentSearch4 = new MMConstraint<PaymentSearch4>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch4;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed.\r\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch5);
	...
	public static final MMConstraint<PaymentSearch5> forPaymentSearch5 = new MMConstraint<PaymentSearch5>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch5;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed.\r\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch6);
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch4;
	...
	public static final MMConstraint<PaymentSearch6> forPaymentSearch6 = new MMConstraint<PaymentSearch6>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch6;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed.\r\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch7);
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch5;
	...
	public static final MMConstraint<PaymentSearch7> forPaymentSearch7 = new MMConstraint<PaymentSearch7>() {
		{
			validator = ConstraintSettlementAmountCreditDebitIndicator2Rule::checkPaymentSearch7;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementAmountCreditDebitIndicator2Rule";
			definition = "If at least one occurrence of InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is present, then CreditDebitIndicator is not allowed.\r\nIf InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/CreditDebitIndicator is not present, then CreditDebitIndicator is optional.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintSettlementAmountCreditDebitIndicator2Rule.forPaymentSearch6;
	...
	/**
	 * If at least one occurrence of
	 * InterbankSettlementAmount/ImpliedCurrencyAndAmountRange
	 * /CreditDebitIndicator is present, then CreditDebitIndicator is not
	 * allowed If InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/
	 * CreditDebitIndicator is not present, then CreditDebitIndicator is
	 * optional.
	 */
	 ...
	 * /CreditDebitIndicator is present, then CreditDebitIndicator is not
	 * allowed.<br>
	 * If InterbankSettlementAmount/ImpliedCurrencyAndAmountRange/
	 * CreditDebitIndicator is not present, then CreditDebitIndicator is
	 * optional.
	 */
