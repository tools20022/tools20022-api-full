...
/**
 * If Condition and OpenEndedIndicator are not present, DateTime must be
 * present.
 */
public class ConstraintDateTimeAndCondition2Rule {
	 ...
	 * name} = " DateTimeAndCondition2Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If Condition and OpenEndedIndicator are not present, DateTime must be present."
	 * </li>
	 * </ul>
	 */
	public static final MMConstraint<ExpiryTerms1> forExpiryTerms1 = new MMConstraint<ExpiryTerms1>() {
		{
			validator = ConstraintDateTimeAndCondition2Rule::checkExpiryTerms1;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = " DateTimeAndCondition2Rule";
