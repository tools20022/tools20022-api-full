...
/**
 * If RequestResponder is "true" or "1" (Yes), then Reference and Request
 * Rejected must be present.<br>
 * If RequestResponder is "false" or "0" (No), then TradeDetail and
 * TradingSideIdentification and CounterpartySideIdentification must be present.
 */
public class ConstraintRequestResponderRule {
