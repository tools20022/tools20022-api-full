...
/**
 * If Status is Pending, then AdditionalInformation is allowed. If Status is not
 * Pending, then AdditionalInformation is not allowed.
 */
public class ConstraintPendingAdditionalInformation {
	...
	/**
	 * If Status is Pending, then AdditionalInformation is allowed. If Status is
	 * not Pending, then AdditionalInformation is not allowed.
	 */
	public static void checkTransferCancellationStatus(TransferCancellationStatus obj) throws Exception {
