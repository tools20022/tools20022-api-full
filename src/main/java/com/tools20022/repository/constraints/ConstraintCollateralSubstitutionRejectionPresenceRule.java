...
/**
 * If Response Type equals Rejected then CollateralSubstitutionRejectionDetails
 * must be present.
 */
public class ConstraintCollateralSubstitutionRejectionPresenceRule {
	 ...
	 * name} = "CollateralSubstitutionRejectionPresenceRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If Response Type equals Rejected then CollateralSubstitutionRejectionDetails must be present."
	 * </li>
	 * </ul>
	 */
	...
	/**
	 * If Response Type equals Rejected then
	 * CollateralSubstitutionRejectionDetails must be present.
	 */
