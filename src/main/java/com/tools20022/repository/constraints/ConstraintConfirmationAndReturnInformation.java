...
import com.tools20022.repository.msg.InvestigationStatus;

/**
 * If the InvestigationStatus is NOT a Confirmation with value MODI or CNCL,
 * then ReturnInformation is not allowed.
 */
public class ConstraintConfirmationAndReturnInformation {
	 ...
	 * then ReturnInformation is not allowed.
	 */
	public static void checkInvestigationStatus(InvestigationStatus obj) throws Exception {
