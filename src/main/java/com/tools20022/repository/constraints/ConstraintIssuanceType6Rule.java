...
/**
 * If IssuanceType is "ISCO" then LocalUndertakingDetails must not be present.
 */
public class ConstraintIssuanceType6Rule {
	...
	public static final MMConstraint<UndertakingIssuanceV01> forUndertakingIssuanceV01 = new MMConstraint<UndertakingIssuanceV01>() {
		{
			validator = ConstraintIssuanceType6Rule::checkUndertakingIssuanceV01;
	...
	public static final MMConstraint<UndertakingAdvice2> forUndertakingAdvice2 = new MMConstraint<UndertakingAdvice2>() {
		{
			validator = ConstraintIssuanceType6Rule::checkUndertakingAdvice2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IssuanceType6Rule";
			definition = "If IssuanceType is \"ISCO\" then LocalUndertakingDetails must not be present.";
