...
/**
 * One of the elements (Name, Designation, FundType, FundFamilyName,
 * SecurityDetails, AccountOwner, Intermediary, Account Servicer) must be
 * present.
 */
public class ConstraintAccountDataElementRule {
	 ...
	 * present.
	 */
	public static void checkInvestmentAccount64(InvestmentAccount64 obj) throws Exception {
