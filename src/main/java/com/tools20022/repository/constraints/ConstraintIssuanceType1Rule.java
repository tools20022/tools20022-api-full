...
/**
 * If IssuanceType is "CRQL" then LocalUndertakingDetails must be present.
 */
public class ConstraintIssuanceType1Rule {
	...
	public static final MMConstraint<UndertakingIssuanceV01> forUndertakingIssuanceV01 = new MMConstraint<UndertakingIssuanceV01>() {
		{
			validator = ConstraintIssuanceType1Rule::checkUndertakingIssuanceV01;
	...
	public static final MMConstraint<UndertakingAdvice2> forUndertakingAdvice2 = new MMConstraint<UndertakingAdvice2>() {
		{
			validator = ConstraintIssuanceType1Rule::checkUndertakingAdvice2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "IssuanceType1Rule";
			definition = "If IssuanceType is \"CRQL\" then LocalUndertakingDetails must be present.";
