...
/**
 * If BlockHolding is “CERT” then PartialHoldingUnits must not be present.
 */
public class ConstraintPartialHoldingUnits3Rule {
	...
	public static final MMConstraint<BlockedHoldingDetails1> forBlockedHoldingDetails1 = new MMConstraint<BlockedHoldingDetails1>() {
		{
			validator = ConstraintPartialHoldingUnits3Rule::checkBlockedHoldingDetails1;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PartialHoldingUnits3Rule";
			definition = "If BlockHolding is “CERT” then PartialHoldingUnits must not be present.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPartialHoldingUnits3Rule.forBlockedHoldingDetails2);
	...
	public static final MMConstraint<BlockedHoldingDetails2> forBlockedHoldingDetails2 = new MMConstraint<BlockedHoldingDetails2>() {
		{
			validator = ConstraintPartialHoldingUnits3Rule::checkBlockedHoldingDetails2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PartialHoldingUnits3Rule";
			definition = "If BlockHolding is CERT (Certificate) then PartialHoldingUnits must not be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintPartialHoldingUnits3Rule.forBlockedHoldingDetails1;
