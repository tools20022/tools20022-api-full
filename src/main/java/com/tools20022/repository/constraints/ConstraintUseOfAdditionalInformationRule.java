...
/**
 * AdditionalInformation can only be used when the corporate action event type
 * code is TEND.
 */
public class ConstraintUseOfAdditionalInformationRule {
	 ...
	 * name} = "UseOfAdditionalInformationRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "AdditionalInformation can only be used when the corporate action event type code is TEND."
	 * </li>
	 * </ul>
	 */
	...
	/**
	 * AdditionalInformation can only be used when the corporate action event
	 * type code is TEND.
	 */
