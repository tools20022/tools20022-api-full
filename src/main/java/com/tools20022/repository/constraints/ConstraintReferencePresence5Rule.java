 ...
 */
public class ConstraintReferencePresence5Rule {
	 ...
	 * expression} =
	 * "&lt;RuleDefinition&gt;&lt;ComplexRule xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"ComplexRule\"&gt;&lt;mustBe&gt;&lt;connector&gt;AND&lt;/connector&gt;&lt;BooleanRule xsi:type=\"Presence\"&gt;&lt;leftOperand&gt;/MarketInfrastructureTransactionIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;/mustBe&gt;&lt;onCondition&gt;&lt;connector&gt;AND&lt;/connector&gt;&lt;BooleanRule xsi:type=\"Absence\"&gt;&lt;leftOperand&gt;/AccountOwnerTransactionIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;BooleanRule xsi:type=\"Absence\"&gt;&lt;leftOperand&gt;/PoolIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;BooleanRule xsi:type=\"Absence\"&gt;&lt;leftOperand&gt;/AccountServicerTransactionIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;BooleanRule xsi:type=\"Absence\"&gt;&lt;leftOperand&gt;/CommonIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;BooleanRule xsi:type=\"Absence\"&gt;&lt;leftOperand&gt;/TradeIdentification&lt;/leftOperand&gt;&lt;/BooleanRule&gt;&lt;/onCondition&gt;&lt;/ComplexRule&gt;&lt;/RuleDefinition&gt;"
	 * </li>
	 * <li>
	 ...
	 * name} = "ReferencePresence5Rule"</li>
	 * <li>
	...
	public static final MMConstraint<References1> forReferences1 = new MMConstraint<References1>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences1;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
	...
	public static final MMConstraint<References2> forReferences2 = new MMConstraint<References2>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
			definition = "If used, then at least one reference must be present.";
	...
	public static final MMConstraint<References7> forReferences7 = new MMConstraint<References7>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences7;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
			definition = "If used, then at least one reference must be present.";
	...
	public static final MMConstraint<References8> forReferences8 = new MMConstraint<References8>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences8;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
			definition = "If used, then at least one reference must be present.";
	...
	public static final MMConstraint<References9> forReferences9 = new MMConstraint<References9>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences9;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
			definition = "If used, then at least one reference must be present.";
	...
	public static final MMConstraint<References13> forReferences13 = new MMConstraint<References13>() {
		{
			validator = ConstraintReferencePresence5Rule::checkReferences13;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReferencePresence5Rule";
			definition = "If used, then at least one reference must be present.";
