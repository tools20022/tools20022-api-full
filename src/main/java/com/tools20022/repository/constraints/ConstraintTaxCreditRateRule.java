 ...
 * - TaxCreditRate/RateTypeAndAmountAndRateStatus must be present and<br>
 ...
 */
public class ConstraintTaxCreditRateRule {
	...
	public static final MMConstraint<CorporateActionRate10> forCorporateActionRate10 = new MMConstraint<CorporateActionRate10>() {
		{
			validator = ConstraintTaxCreditRateRule::checkCorporateActionRate10;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TaxCreditRateRule";
			definition = "If TaxCreditRate is repeated, then:\r\n- TaxCreditRate/RateTypeAndAmountAndRateStatus must be present and\r\n- RateTypeAndAmountAndRateStatus/RateType/Code value must all be different in each occurrence of TaxCreditRate.\r\n\r\n(MT 566 NVR C3 and C4).";
	...
	public static final MMConstraint<CorporateActionRate5> forCorporateActionRate5 = new MMConstraint<CorporateActionRate5>() {
		{
			validator = ConstraintTaxCreditRateRule::checkCorporateActionRate5;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TaxCreditRateRule";
			definition = "If TaxCreditRate is repeated, then:\r\n- TaxCreditRate/RateTypeAndAmountAndRateStatus must be present and\r\n- RateTypeAndAmountAndRateStatus/RateType/Code value must all be different in each occurrence of TaxCreditRate.\r\n\r\n(MT 564 NVR C8 and C9).";
	...
	public static final MMConstraint<CorporateActionRate12> forCorporateActionRate12 = new MMConstraint<CorporateActionRate12>() {
		{
			validator = ConstraintTaxCreditRateRule::checkCorporateActionRate12;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TaxCreditRateRule";
			definition = "If TaxCreditRate is repeated, then:\r\n- TaxCreditRate/RateTypeAndAmountAndRateStatus must be present and\r\n- RateTypeAndAmountAndRateStatus/RateType/Code value must all be different in each occurrence of TaxCreditRate.\r\n\r\n(MT 564 NVR C8 and C9).";
