...
public class ConstraintDescriptionPresenceRule {
	...
	public static final MMConstraint<SecurityIdentification14> forSecurityIdentification14 = new MMConstraint<SecurityIdentification14>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification14;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDescriptionPresenceRule.forSecurityIdentification19);
	...
	public static final MMConstraint<SecurityIdentification15> forSecurityIdentification15 = new MMConstraint<SecurityIdentification15>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification15;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
	...
	public static final MMConstraint<SecurityIdentification16> forSecurityIdentification16 = new MMConstraint<SecurityIdentification16>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification16;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
	...
	public static final MMConstraint<SecurityIdentification19> forSecurityIdentification19 = new MMConstraint<SecurityIdentification19>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification19;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
			previousVersion_lazy = () -> com.tools20022.repository.constraints.ConstraintDescriptionPresenceRule.forSecurityIdentification14;
	...
	public static final MMConstraint<SecurityIdentification20> forSecurityIdentification20 = new MMConstraint<SecurityIdentification20>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification20;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
	...
	public static final MMConstraint<SecurityIdentification32> forSecurityIdentification32 = new MMConstraint<SecurityIdentification32>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification32;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
	...
	public static final MMConstraint<SecurityIdentification21> forSecurityIdentification21 = new MMConstraint<SecurityIdentification21>() {
		{
			validator = ConstraintDescriptionPresenceRule::checkSecurityIdentification21;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DescriptionPresenceRule";
			definition = "If Description is not present then either ISIN or at least one occurrence of OtherIdentification must be present.";
