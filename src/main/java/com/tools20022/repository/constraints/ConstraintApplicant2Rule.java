...
/**
 * If IssuanceType is "ISAD" then Applicant must be present.
 */
public class ConstraintApplicant2Rule {
	 ...
	 * name} = "Applicant2Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If IssuanceType is \"ISAD\" then Applicant must be present."</li>
	 * </ul>
	 */
	public static final MMConstraint<UndertakingIssuanceV01> forUndertakingIssuanceV01 = new MMConstraint<UndertakingIssuanceV01>() {
		{
			validator = ConstraintApplicant2Rule::checkUndertakingIssuanceV01;
	...
	public static final MMConstraint<UndertakingAdvice2> forUndertakingAdvice2 = new MMConstraint<UndertakingAdvice2>() {
		{
			validator = ConstraintApplicant2Rule::checkUndertakingAdvice2;
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Applicant2Rule";
			definition = "If IssuanceType is \"ISAD\" then Applicant must be present.";
