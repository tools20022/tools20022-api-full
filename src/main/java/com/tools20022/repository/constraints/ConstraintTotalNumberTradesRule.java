...
/**
 * If TotalNumberTrades is not equal to 0, then Trade Information and
 * TradingSideIdentification and CounterpartySideIdentification must be present.
 */
public class ConstraintTotalNumberTradesRule {
	 ...
	 * name} = "TotalNumberTradesRule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If TotalNumberTrades is not equal to 0, then Trade Information and TradingSideIdentification and CounterpartySideIdentification must be present."
	 * </li>
	 * </ul>
	 */
