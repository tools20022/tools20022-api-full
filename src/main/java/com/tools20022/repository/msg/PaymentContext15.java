...
public class PaymentContext15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext15.mmCardPresent, PaymentContext15.mmCardholderPresent, PaymentContext15.mmOnLineContext, PaymentContext15.mmAttendanceContext,
						PaymentContext15.mmTransactionEnvironment, PaymentContext15.mmTransactionChannel, PaymentContext15.mmCardDataEntryMode, PaymentContext15.mmFallbackIndicator, PaymentContext15.mmSupportedOption);
