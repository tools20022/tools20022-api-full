 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext15#mmCardPresent
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.PaymentContext9
 * PaymentContext9}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PaymentContext15", propOrder = {"cardPresent", "cardholderPresent", "onLineContext", "attendanceContext", "transactionEnvironment", "transactionChannel", "cardDataEntryMode", "fallbackIndicator", "supportedOption"})
public class PaymentContext15 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PaymentContext15
	 * PaymentContext15}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext15.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CardPresent";
			definition = "Indicates whether the transaction has been initiated by a card physically present or not.";
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmCardPresent);
			previousVersion_lazy = () -> PaymentContext9.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext15 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext15 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmCardholderPresent);
			previousVersion_lazy = () -> PaymentContext9.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>> mmOnLineContext = new MMMessageAttribute<PaymentContext15, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmOnLineContext);
			previousVersion_lazy = () -> PaymentContext9.mmOnLineContext;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext15, Optional<AttendanceContext1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmAttendanceContext);
			previousVersion_lazy = () -> PaymentContext9.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext15 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext15 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext15, Optional<TransactionEnvironment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmTransactionEnvironment);
			previousVersion_lazy = () -> PaymentContext9.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext15 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext15 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext15, Optional<TransactionChannel3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmTransactionChannel);
			previousVersion_lazy = () -> PaymentContext9.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext15 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext15 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, CardDataReading5Code> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext15, CardDataReading5Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmCardDataEntryMode);
			previousVersion_lazy = () -> PaymentContext9.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CardDataReading5Code getValue(PaymentContext15 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext15 obj, CardDataReading5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext15, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext15.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmFallbackIndicator);
			previousVersion_lazy = () -> PaymentContext9.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext15 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext15 obj, Optional<CardFallback1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext15, List<SupportedPaymentOption1Code>> mmSupportedOption = new MMMessageAttribute<PaymentContext15, List<SupportedPaymentOption1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext15.mmObject();
			isDerived = false;
			xmlTag = "SpprtdOptn";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmSupportedOption);
			previousVersion_lazy = () -> PaymentContext9.mmSupportedOption;
			minOccurs = 0;
			simpleType_lazy = () -> SupportedPaymentOption1Code.mmObject();
		}

		@Override
		public List<SupportedPaymentOption1Code> getValue(PaymentContext15 obj) {
			return obj.getSupportedOption();
		}

		@Override
		public void setValue(PaymentContext15 obj, List<SupportedPaymentOption1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext15.mmCardPresent, com.tools20022.repository.msg.PaymentContext15.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext15.mmOnLineContext, com.tools20022.repository.msg.PaymentContext15.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext15.mmTransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext15.mmTransactionChannel, com.tools20022.repository.msg.PaymentContext15.mmCardDataEntryMode, com.tools20022.repository.msg.PaymentContext15.mmFallbackIndicator,
						com.tools20022.repository.msg.PaymentContext15.mmSupportedOption);
				trace_lazy = () -> CardPaymentAcquiring.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentContext15";
				definition = "Payment context in which the transaction is performed.";
				nextVersions_lazy = () -> Arrays.asList(PaymentContext21.mmObject());
				previousVersion_lazy = () -> PaymentContext9.mmObject();
			}
		});
	...
	public PaymentContext15 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext15 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext15 setOnLineContext(TrueFalseIndicator onLineContext) {
	...
	public PaymentContext15 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext15 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext15 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext15 setCardDataEntryMode(CardDataReading5Code cardDataEntryMode) {
	...
	public PaymentContext15 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
	...
	public PaymentContext15 setSupportedOption(List<SupportedPaymentOption1Code> supportedOption) {
