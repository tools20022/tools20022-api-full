 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext15#CardPresent
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext15#OnLineContext
...
public class PaymentContext15 {
	...
	public static final MMMessageAttribute CardPresent = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentContext15.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.CardPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.CardPresent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardholderPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.CardholderPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.CardholderPresent);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute OnLineContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.OnLineContext;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.OnLineContext);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.AttendanceContext;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.AttendanceContext);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionEnvironment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.TransactionEnvironment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.TransactionEnvironment);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionChannel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.TransactionChannel;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.TransactionChannel);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardDataEntryMode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.CardDataEntryMode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.CardDataEntryMode);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PaymentContext21#FallbackIndicator
	 * PaymentContext21.FallbackIndicator}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	...
	public static final MMMessageAttribute FallbackIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.FallbackIndicator;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.FallbackIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PaymentContext21#SupportedOption
	 * PaymentContext21.SupportedOption}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	...
	public static final MMMessageAttribute SupportedOption = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext9.SupportedOption;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext21.SupportedOption);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext15.CardPresent, com.tools20022.repository.msg.PaymentContext15.CardholderPresent,
						com.tools20022.repository.msg.PaymentContext15.OnLineContext, com.tools20022.repository.msg.PaymentContext15.AttendanceContext, com.tools20022.repository.msg.PaymentContext15.TransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext15.TransactionChannel, com.tools20022.repository.msg.PaymentContext15.CardDataEntryMode, com.tools20022.repository.msg.PaymentContext15.FallbackIndicator,
						com.tools20022.repository.msg.PaymentContext15.SupportedOption);
