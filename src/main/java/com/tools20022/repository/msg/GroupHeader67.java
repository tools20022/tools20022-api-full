...
import com.tools20022.repository.datatype.Exact1Text;
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.GroupHeader63
 * GroupHeader63}</li>
 * </ul>
 */
...
public class GroupHeader67 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.GroupHeader67 GroupHeader67}</li>
	...
	public static final MMMessageAttribute<GroupHeader67, Max35Text> mmMessageIdentification = new MMMessageAttribute<GroupHeader67, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> GroupHeader63.mmMessageIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<GroupHeader67, ISODateTime> mmCreationDateTime = new MMMessageAttribute<GroupHeader67, ISODateTime>() {
		{
			...
			previousVersion_lazy = () -> GroupHeader63.mmCreationDateTime;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected Exact1Text numberOfTransactions;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageAttribute#getSimpleType
	 * simpleType} = {@linkplain com.tools20022.repository.datatype.Exact1Text
	 * Exact1Text}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAttribute<GroupHeader67, Exact1Text> mmNumberOfTransactions = new MMMessageAttribute<GroupHeader67, Exact1Text>() {
		{
			...
			previousVersion_lazy = () -> GroupHeader63.mmNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader67.mmMessageIdentification, com.tools20022.repository.msg.GroupHeader67.mmCreationDateTime,
						com.tools20022.repository.msg.GroupHeader67.mmNumberOfTransactions);
				trace_lazy = () -> PaymentExecution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "GroupHeader67";
				definition = "Set of characteristics shared by all individual transactions included in the message.";
				previousVersion_lazy = () -> GroupHeader63.mmObject();
			}
		});
	...
	public GroupHeader67 setMessageIdentification(Max35Text messageIdentification) {
	...
	public GroupHeader67 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public GroupHeader67 setNumberOfTransactions(Exact1Text numberOfTransactions) {
