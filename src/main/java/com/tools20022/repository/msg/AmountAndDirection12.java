 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection12#Amount
...
public class AmountAndDirection12 {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AmountAndDirection12.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection12.Amount, com.tools20022.repository.msg.AmountAndDirection12.CreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection12.OriginalCurrencyAndOrderedAmount);
