...
public class SettlementTypeAndAdditionalParameters20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters20.mmSecuritiesMovementType, SettlementTypeAndAdditionalParameters20.mmPayment, SettlementTypeAndAdditionalParameters20.mmCommonIdentification,
						SettlementTypeAndAdditionalParameters20.mmCorporateActionEventIdentification, SettlementTypeAndAdditionalParameters20.mmReconciliationIndicator,
						SettlementTypeAndAdditionalParameters20.mmClientCollateralInstructionIdentification, SettlementTypeAndAdditionalParameters20.mmClientCollateralTransactionIdentification,
						SettlementTypeAndAdditionalParameters20.mmTripartyAgentServiceProviderCollateralTransactionIdentification, SettlementTypeAndAdditionalParameters20.mmTripartyAgentServiceProviderCollateralInstructionIdentification);
