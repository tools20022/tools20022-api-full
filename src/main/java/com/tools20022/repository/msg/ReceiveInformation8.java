 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forReceiveInformation8
 * ConstraintPhysicalTransferDetailsRule.forReceiveInformation8}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule#forReceiveInformation8
 * ConstraintReceiversCustodianDetailsRule.forReceiveInformation8}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule#forReceiveInformation8
 * ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation8}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "ReceiveInformation8", propOrder = {"effectiveSettlementDate", "settlementAmount", "stampDuty", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "settlementPartiesDetails", "physicalTransfer",
...
public class ReceiveInformation8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation8, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<ReceiveInformation8, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation8.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(ReceiveInformation8 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation8, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation8, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation8 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation8, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation8, Optional<StampDutyType2Code>>() {
		{
		...
		@Override
		public Optional<StampDutyType2Code> getValue(ReceiveInformation8 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation8, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation8, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation8, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation8, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(ReceiveInformation8 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation8, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation8, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(ReceiveInformation8 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation8, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation8, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(ReceiveInformation8 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation8, ReceivingPartiesAndAccount8> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation8, ReceivingPartiesAndAccount8>() {
		{
		...
		@Override
		public ReceivingPartiesAndAccount8 getValue(ReceiveInformation8 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, ReceivingPartiesAndAccount8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation8, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation8, Optional<PhysicalTransferType1Code>>() {
		{
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(ReceiveInformation8 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation8, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation8, Optional<DeliveryParameters4>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation8 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation8 obj, Optional<DeliveryParameters4> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation8,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation8, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation8);
	...
	public ReceiveInformation8 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public ReceiveInformation8 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation8 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation8 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation8 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public ReceiveInformation8 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public ReceiveInformation8 setTaxDetails(List<Tax15> taxDetails) {
	...
	public ReceiveInformation8 setSettlementPartiesDetails(ReceivingPartiesAndAccount8 settlementPartiesDetails) {
	...
	public ReceiveInformation8 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation8 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
