...
public class StatementResolutionEntry3 {
	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOriginalStatementIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmOriginalStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountServicerReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmAccountServicerReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmCorrectedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmCorrectedAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCharges = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmCharges;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPurpose = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> StatementResolutionEntry2.mmPurpose;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> StatementResolutionEntry2.mmObject();
			}
		});
	...
	public StatementResolutionEntry3 setOriginalGroupInformation(com.tools20022.repository.msg.OriginalGroupInformation29 originalGroupInformation) {
	...
	public StatementResolutionEntry3 setCharges(List<com.tools20022.repository.msg.Charges3> charges) {
