...
public class PaymentTransaction76 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>> mmReturnIdentification = new MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmReturnIdentification);
			previousVersion_lazy = () -> PaymentTransaction65.mmReturnIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction76 obj) {
			return obj.getReturnIdentification();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction76, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalGroupInformation);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction76 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalTransactionIdentification);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction76, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction76 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, ActiveCurrencyAndAmount> mmReturnedInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction76, ActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> CashSettlement.mmInterbankSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction76.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmReturnedInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction65.mmReturnedInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(PaymentTransaction76 obj) {
			return obj.getReturnedInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction76, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmInterbankSettlementDate);
			previousVersion_lazy = () -> PaymentTransaction65.mmInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction76 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<Priority3Code>> mmSettlementPriority = new MMMessageAttribute<PaymentTransaction76, Optional<Priority3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmSettlementPriority);
			previousVersion_lazy = () -> PaymentTransaction65.mmSettlementPriority;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Priority3Code> getValue(PaymentTransaction76 obj) {
			return obj.getSettlementPriority();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<Priority3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>> mmReturnedInstructedAmount = new MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmReturnedInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction65.mmReturnedInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<BaseOneRate>> mmExchangeRate = new MMMessageAttribute<PaymentTransaction76, Optional<BaseOneRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmExchangeRate);
			previousVersion_lazy = () -> PaymentTransaction65.mmExchangeRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOneRate> getValue(PaymentTransaction76 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>> mmCompensationAmount = new MMMessageAttribute<PaymentTransaction76, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmCompensationAmount);
			previousVersion_lazy = () -> PaymentTransaction65.mmCompensationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentTransaction76, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmChargeBearer);
			previousVersion_lazy = () -> PaymentTransaction65.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentTransaction76 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction76, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction65.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction76 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<PaymentTransaction76, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmInstructingAgent);
			previousVersion_lazy = () -> PaymentTransaction65.mmInstructingAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentTransaction76 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<PaymentTransaction76, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction76.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmInstructedAgent);
			previousVersion_lazy = () -> PaymentTransaction65.mmInstructedAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, List<PaymentReturnReason1>> mmReturnReasonInformation = new MMMessageAssociationEnd<PaymentTransaction76, List<PaymentReturnReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmReturnReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction65.mmReturnReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReturnReason1> getValue(PaymentTransaction76 obj) {
			return obj.getReturnReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, List<PaymentReturnReason1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction76, Optional<OriginalTransactionReference24>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction76, Optional<OriginalTransactionReference24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction65.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference24> getValue(PaymentTransaction76 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, Optional<OriginalTransactionReference24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction76, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction76, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction76.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction65.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction76 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction76 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction87.mmObject());
				previousVersion_lazy = () -> PaymentTransaction65.mmObject();
			}
		});
	...
	public PaymentTransaction76 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction76 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction76 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public PaymentTransaction76 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
	...
	public PaymentTransaction76 setReturnReasonInformation(List<PaymentReturnReason1> returnReasonInformation) {
	...
	public PaymentTransaction76 setOriginalTransactionReference(OriginalTransactionReference24 originalTransactionReference) {
	...
	public PaymentTransaction76 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
