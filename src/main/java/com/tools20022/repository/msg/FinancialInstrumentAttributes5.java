...
public class FinancialInstrumentAttributes5 {
	...
	public static final MMMessageAttribute mmSecurityIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentAttributes5.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	public PriceFormat11Choice getIssuePrice() {
		return issuePrice;
	}

	public void setIssuePrice(PriceFormat11Choice issuePrice) {
