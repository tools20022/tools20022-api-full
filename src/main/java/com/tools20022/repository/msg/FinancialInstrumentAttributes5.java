...
public class FinancialInstrumentAttributes5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes5.mmSecurityIdentification, FinancialInstrumentAttributes5.mmPlaceOfListing, FinancialInstrumentAttributes5.mmDayCountBasis,
						FinancialInstrumentAttributes5.mmClassificationType, FinancialInstrumentAttributes5.mmOptionStyle, FinancialInstrumentAttributes5.mmDenominationCurrency, FinancialInstrumentAttributes5.mmNextCouponDate,
						FinancialInstrumentAttributes5.mmFloatingRateFixingDate, FinancialInstrumentAttributes5.mmMaturityDate, FinancialInstrumentAttributes5.mmIssueDate, FinancialInstrumentAttributes5.mmNextCallableDate,
						FinancialInstrumentAttributes5.mmPutableDate, FinancialInstrumentAttributes5.mmDatedDate, FinancialInstrumentAttributes5.mmConversionDate, FinancialInstrumentAttributes5.mmPreviousFactor,
						FinancialInstrumentAttributes5.mmNextFactor, FinancialInstrumentAttributes5.mmInterestRate, FinancialInstrumentAttributes5.mmNextInterestRate, FinancialInstrumentAttributes5.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes5.mmMinimumExercisableQuantity, FinancialInstrumentAttributes5.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes5.mmContractSize,
						FinancialInstrumentAttributes5.mmIssuePrice);
