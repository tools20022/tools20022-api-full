...
public class AdditionalInformation7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalInformation7.mmAccountOwnerTransactionIdentification, AdditionalInformation7.mmClassificationType, AdditionalInformation7.mmSafekeepingAccount,
						AdditionalInformation7.mmFinancialInstrumentIdentification, AdditionalInformation7.mmQuantity, AdditionalInformation7.mmEffectiveDate, AdditionalInformation7.mmExpiryDate, AdditionalInformation7.mmCutOffDate,
						AdditionalInformation7.mmInvestor, AdditionalInformation7.mmDeliveringParty1, AdditionalInformation7.mmReceivingParty1);
