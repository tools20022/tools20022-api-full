...
public class RejectionOrRepairReason28 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason28.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason28.mmCode, RejectionOrRepairReason28.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason28Choice code) {
		this.code = code;
	}
