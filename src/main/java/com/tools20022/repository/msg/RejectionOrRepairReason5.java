...
public class RejectionOrRepairReason5 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason5.mmCode, RejectionOrRepairReason5.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason5Choice code) {
		this.code = code;
	}
