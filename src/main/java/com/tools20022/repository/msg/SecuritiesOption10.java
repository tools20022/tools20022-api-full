...
public class SecuritiesOption10 {
	...
	public static final MMMessageAssociationEnd mmSecurityDetails = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption10.mmObject();
			isDerived = false;
			xmlTag = "SctyDtls";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption10.mmSecurityDetails, SecuritiesOption10.mmCreditDebitIndicator, SecuritiesOption10.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption10.mmNonEligibleProceedsIndicator, SecuritiesOption10.mmEntitledQuantity, SecuritiesOption10.mmSafekeepingPlace, SecuritiesOption10.mmFractionDisposition, SecuritiesOption10.mmCurrencyOption,
						SecuritiesOption10.mmTradingPeriod, SecuritiesOption10.mmDateDetails, SecuritiesOption10.mmRateDetails, SecuritiesOption10.mmPriceDetails);
