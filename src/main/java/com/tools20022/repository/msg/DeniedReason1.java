...
public class DeniedReason1 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason12.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason12.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setCode(DeniedReason3Choice code) {
		this.code = code;
	}
