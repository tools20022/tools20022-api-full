...
public class CorporateActionPrice67 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice67.MaximumPrice, com.tools20022.repository.msg.CorporateActionPrice67.MinimumPrice);
