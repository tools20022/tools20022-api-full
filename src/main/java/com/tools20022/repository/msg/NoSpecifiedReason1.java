 ...
 * definition} = "No specified reason available for the status."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "NoSpecifiedReason1", propOrder = "noSpecifiedReason")
public class NoSpecifiedReason1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.NoSpecifiedReason1
	 * NoSpecifiedReason1}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.NoSpecifiedReason1.mmNoSpecifiedReason);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NoSpecifiedReason1";
				definition = "No specified reason available for the status.";
			}
		});
	...
	public NoSpecifiedReason1 setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
