...
public class AlternatePartyIdentification4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AlternatePartyIdentification4.mmIdentificationType, AlternatePartyIdentification4.mmCountry, AlternatePartyIdentification4.mmAlternateIdentification);
