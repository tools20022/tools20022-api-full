...
public class AlternatePartyIdentification4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AlternatePartyIdentification4.IdentificationType, com.tools20022.repository.msg.AlternatePartyIdentification4.Country,
						com.tools20022.repository.msg.AlternatePartyIdentification4.AlternateIdentification);
