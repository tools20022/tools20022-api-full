...
public class CorporateActionOption107 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption107.mmOptionNumber, CorporateActionOption107.mmOptionType, CorporateActionOption107.mmFractionDisposition, CorporateActionOption107.mmChangeType,
						CorporateActionOption107.mmEligibleForCollateralIndicator, CorporateActionOption107.mmCurrencyToBuy, CorporateActionOption107.mmCurrencyToSell, CorporateActionOption107.mmCurrencyOption,
						CorporateActionOption107.mmSecurityIdentification, CorporateActionOption107.mmSecuritiesQuantity, CorporateActionOption107.mmExecutionRequestedDateTime, CorporateActionOption107.mmRateAndAmountDetails,
						CorporateActionOption107.mmPriceDetails, CorporateActionOption107.mmAdditionalInformation);
