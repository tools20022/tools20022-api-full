...
import com.tools20022.repository.choice.CorporateActionOption9Choice;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.InstructedCorporateActionOption2#mmDefaultAction
 * InstructedCorporateActionOption2.mmDefaultAction}</li>
 * <li>
...
@XmlType(name = "InstructedCorporateActionOption2", propOrder = {"optionNumber", "optionType", "instructedBalance", "defaultAction", "deadlineDateTime", "deadlineType"})
public class InstructedCorporateActionOption2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InstructedCorporateActionOption2, Optional<Exact3NumericText>> mmOptionNumber = new MMMessageAttribute<InstructedCorporateActionOption2, Optional<Exact3NumericText>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.InstructedCorporateActionOption2.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
		...
		@Override
		public Optional<Exact3NumericText> getValue(InstructedCorporateActionOption2 obj) {
			return obj.getOptionNumber();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, Optional<Exact3NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructedCorporateActionOption2, CorporateActionOption9Choice> mmOptionType = new MMMessageAssociationEnd<InstructedCorporateActionOption2, CorporateActionOption9Choice>() {
		{
		...
		@Override
		public CorporateActionOption9Choice getValue(InstructedCorporateActionOption2 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, CorporateActionOption9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructedCorporateActionOption2, BalanceFormat2Choice> mmInstructedBalance = new MMMessageAssociationEnd<InstructedCorporateActionOption2, BalanceFormat2Choice>() {
		{
		...
		@Override
		public BalanceFormat2Choice getValue(InstructedCorporateActionOption2 obj) {
			return obj.getInstructedBalance();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, BalanceFormat2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructedCorporateActionOption2, Optional<DefaultProcessingOrStandingInstruction1Choice>> mmDefaultAction = new MMMessageAssociationEnd<InstructedCorporateActionOption2, Optional<DefaultProcessingOrStandingInstruction1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InstructedCorporateActionOption2.mmObject();
			isDerived = false;
			xmlTag = "DfltActn";
		...
		@Override
		public Optional<DefaultProcessingOrStandingInstruction1Choice> getValue(InstructedCorporateActionOption2 obj) {
			return obj.getDefaultAction();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, Optional<DefaultProcessingOrStandingInstruction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InstructedCorporateActionOption2, ISODateTime> mmDeadlineDateTime = new MMMessageAttribute<InstructedCorporateActionOption2, ISODateTime>() {
		{
		...
		@Override
		public ISODateTime getValue(InstructedCorporateActionOption2 obj) {
			return obj.getDeadlineDateTime();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, ISODateTime value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructedCorporateActionOption2, DeadlineCode2Choice> mmDeadlineType = new MMMessageAssociationEnd<InstructedCorporateActionOption2, DeadlineCode2Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmDeadline;
			componentContext_lazy = () -> com.tools20022.repository.msg.InstructedCorporateActionOption2.mmObject();
			isDerived = false;
		...
		@Override
		public DeadlineCode2Choice getValue(InstructedCorporateActionOption2 obj) {
			return obj.getDeadlineType();
		}

		@Override
		public void setValue(InstructedCorporateActionOption2 obj, DeadlineCode2Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InstructedCorporateActionOption2.mmOptionNumber, com.tools20022.repository.msg.InstructedCorporateActionOption2.mmOptionType,
						com.tools20022.repository.msg.InstructedCorporateActionOption2.mmInstructedBalance, com.tools20022.repository.msg.InstructedCorporateActionOption2.mmDefaultAction,
				...
				name = "InstructedCorporateActionOption2";
				definition = "Provides corporate action option details about total instructed balance.";
				nextVersions_lazy = () -> Arrays.asList(InstructedCorporateActionOption5.mmObject());
			}
		});
	...
	public InstructedCorporateActionOption2 setOptionNumber(Exact3NumericText optionNumber) {
	...
	public InstructedCorporateActionOption2 setOptionType(CorporateActionOption9Choice optionType) {
	...
	public InstructedCorporateActionOption2 setInstructedBalance(BalanceFormat2Choice instructedBalance) {
	...
	public InstructedCorporateActionOption2 setDefaultAction(DefaultProcessingOrStandingInstruction1Choice defaultAction) {
	...
	public InstructedCorporateActionOption2 setDeadlineDateTime(ISODateTime deadlineDateTime) {
	...
	public InstructedCorporateActionOption2 setDeadlineType(DeadlineCode2Choice deadlineType) {
