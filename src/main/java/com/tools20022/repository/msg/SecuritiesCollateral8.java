 ...
 * <li>{@linkplain com.tools20022.repository.msg.SecuritiesCollateral8#Quantity
 * SecuritiesCollateral8.Quantity}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SecuritiesCollateral8#Price
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SecuritiesCollateral8#Haircut
...
public class SecuritiesCollateral8 {
	...
	public static final MMMessageAttribute CollateralIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SecuritiesCollateral8.mmObject();
			isDerived = false;
			xmlTag = "CollId";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CollateralIdentification";
			definition = "Provides the identification of the proposed collateral.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.CollateralIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecurityIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.SecurityIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MaturityDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.MaturityDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LimitedCoverageIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.LimitedCoverageIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Quantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.Quantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Price = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.Price;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MarketValue = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.MarketValue;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Haircut = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.Haircut;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CollateralValue = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.CollateralValue;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAttribute ValueDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.ValueDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.SafekeepingAccount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.SafekeepingPlace;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementParameters = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SecuritiesCollateral5.SettlementParameters;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesCollateral8.CollateralIdentification, com.tools20022.repository.msg.SecuritiesCollateral8.SecurityIdentification,
						com.tools20022.repository.msg.SecuritiesCollateral8.MaturityDate, com.tools20022.repository.msg.SecuritiesCollateral8.LimitedCoverageIndicator, com.tools20022.repository.msg.SecuritiesCollateral8.Quantity,
						com.tools20022.repository.msg.SecuritiesCollateral8.Price, com.tools20022.repository.msg.SecuritiesCollateral8.MarketValue, com.tools20022.repository.msg.SecuritiesCollateral8.Haircut,
						com.tools20022.repository.msg.SecuritiesCollateral8.CollateralValue, com.tools20022.repository.msg.SecuritiesCollateral8.ValueDate, com.tools20022.repository.msg.SecuritiesCollateral8.SafekeepingAccount,
						com.tools20022.repository.msg.SecuritiesCollateral8.SafekeepingPlace, com.tools20022.repository.msg.SecuritiesCollateral8.SettlementParameters);
