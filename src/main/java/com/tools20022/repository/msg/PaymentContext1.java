...
public class PaymentContext1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext1.mmCardPresent, PaymentContext1.mmCardholderPresent, PaymentContext1.mmOnLineContext, PaymentContext1.mmAttendanceContext, PaymentContext1.mmTransactionEnvironment,
						PaymentContext1.mmTransactionChannel, PaymentContext1.mmAttendantMessageCapable, PaymentContext1.mmAttendantLanguage, PaymentContext1.mmCardDataEntryMode, PaymentContext1.mmFallbackIndicator);
