...
@XmlType(name = "SystemStatus1", propOrder = {"status", "validityTime"})
public class SystemStatus1 {
	...
	public static final MMMessageAssociationEnd<SystemStatus1, SystemStatus1Choice> mmStatus = new MMMessageAssociationEnd<SystemStatus1, SystemStatus1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SystemStatus2.mmStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public SystemStatus1 setValidityTime(DateTimePeriodChoice validityTime) {
