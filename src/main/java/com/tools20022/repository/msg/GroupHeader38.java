 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGroupReturnAndNumberOfTransactionsGuideline#forGroupHeader38
 * ConstraintGroupReturnAndNumberOfTransactionsGuideline.forGroupHeader38}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndDateRule#forGroupHeader38
 * ConstraintTotalInterbankSettlementAmountAndDateRule.forGroupHeader38}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintControlSumAndGroupReturnRule#forGroupHeader38
 * ConstraintControlSumAndGroupReturnRule.forGroupHeader38}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "GroupHeader38", propOrder = {"messageIdentification", "creationDateTime", "authorisation", "batchBooking", "numberOfTransactions", "controlSum", "groupReturn", "totalReturnedInterbankSettlementAmount",
...
public class GroupHeader38 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Max35Text> mmMessageIdentification = new MMMessageAttribute<GroupHeader38, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
		...
		@Override
		public Max35Text getValue(GroupHeader38 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(GroupHeader38 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, ISODateTime> mmCreationDateTime = new MMMessageAttribute<GroupHeader38, ISODateTime>() {
		{
		...
		@Override
		public ISODateTime getValue(GroupHeader38 obj) {
			return obj.getCreationDateTime();
		}

		@Override
		public void setValue(GroupHeader38 obj, ISODateTime value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, List<Authorisation1Choice>> mmAuthorisation = new MMMessageAttribute<GroupHeader38, List<Authorisation1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "Authstn";
		...
		@Override
		public List<Authorisation1Choice> getValue(GroupHeader38 obj) {
			return obj.getAuthorisation();
		}

		@Override
		public void setValue(GroupHeader38 obj, List<Authorisation1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<GroupHeader38, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(GroupHeader38 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Max15NumericText> mmNumberOfTransactions = new MMMessageAttribute<GroupHeader38, Max15NumericText>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "NbOfTxs";
		...
		@Override
		public Max15NumericText getValue(GroupHeader38 obj) {
			return obj.getNumberOfTransactions();
		}

		@Override
		public void setValue(GroupHeader38 obj, Max15NumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Optional<DecimalNumber>> mmControlSum = new MMMessageAttribute<GroupHeader38, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "CtrlSum";
		...
		@Override
		public Optional<DecimalNumber> getValue(GroupHeader38 obj) {
			return obj.getControlSum();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Optional<TrueFalseIndicator>> mmGroupReturn = new MMMessageAttribute<GroupHeader38, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
			xmlTag = "GrpRtr";
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(GroupHeader38 obj) {
			return obj.getGroupReturn();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Optional<ActiveCurrencyAndAmount>> mmTotalReturnedInterbankSettlementAmount = new MMMessageAttribute<GroupHeader38, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(GroupHeader38 obj) {
			return obj.getTotalReturnedInterbankSettlementAmount();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader38, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<GroupHeader38, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(GroupHeader38 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader38, SettlementInformation13> mmSettlementInformation = new MMMessageAssociationEnd<GroupHeader38, SettlementInformation13>() {
		{
		...
		@Override
		public SettlementInformation13 getValue(GroupHeader38 obj) {
			return obj.getSettlementInformation();
		}

		@Override
		public void setValue(GroupHeader38 obj, SettlementInformation13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader38, Optional<BranchAndFinancialInstitutionIdentification4>> mmInstructingAgent = new MMMessageAssociationEnd<GroupHeader38, Optional<BranchAndFinancialInstitutionIdentification4>>() {
		{
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification4> getValue(GroupHeader38 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(GroupHeader38 obj, Optional<BranchAndFinancialInstitutionIdentification4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader38, Optional<BranchAndFinancialInstitutionIdentification4>> mmInstructedAgent = new MMMessageAssociationEnd<GroupHeader38, Optional<BranchAndFinancialInstitutionIdentification4>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader38.mmObject();
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(PaymentReturnV02.mmGroupHeader);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGroupReturnAndNumberOfTransactionsGuideline.forGroupHeader38,
						com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndDateRule.forGroupHeader38, com.tools20022.repository.constraints.ConstraintControlSumAndGroupReturnRule.forGroupHeader38);
	...
	public GroupHeader38 setMessageIdentification(Max35Text messageIdentification) {
	...
	public GroupHeader38 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public GroupHeader38 setAuthorisation(List<Authorisation1Choice> authorisation) {
	...
	public GroupHeader38 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public GroupHeader38 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public GroupHeader38 setControlSum(DecimalNumber controlSum) {
	...
	public GroupHeader38 setGroupReturn(TrueFalseIndicator groupReturn) {
	...
	public GroupHeader38 setTotalReturnedInterbankSettlementAmount(ActiveCurrencyAndAmount totalReturnedInterbankSettlementAmount) {
	...
	public GroupHeader38 setInterbankSettlementDate(ISODate interbankSettlementDate) {
	...
	public GroupHeader38 setSettlementInformation(SettlementInformation13 settlementInformation) {
	...
	public GroupHeader38 setInstructingAgent(BranchAndFinancialInstitutionIdentification4 instructingAgent) {
	...
	public GroupHeader38 setInstructedAgent(BranchAndFinancialInstitutionIdentification4 instructedAgent) {
