...
public class GroupHeader38 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader38.mmMessageIdentification, GroupHeader38.mmCreationDateTime, GroupHeader38.mmAuthorisation, GroupHeader38.mmBatchBooking, GroupHeader38.mmNumberOfTransactions,
						GroupHeader38.mmControlSum, GroupHeader38.mmGroupReturn, GroupHeader38.mmTotalReturnedInterbankSettlementAmount, GroupHeader38.mmInterbankSettlementDate, GroupHeader38.mmSettlementInformation,
						GroupHeader38.mmInstructingAgent, GroupHeader38.mmInstructedAgent);
