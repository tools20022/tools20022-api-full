...
public class SettlementDetails138 {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails138.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails138.mmSecuritiesTransactionType, SettlementDetails138.mmSettlementTransactionCondition, SettlementDetails138.mmBeneficialOwnership,
						SettlementDetails138.mmCCPEligibility, SettlementDetails138.mmDeliveryReturnReason, SettlementDetails138.mmCashClearingSystem, SettlementDetails138.mmExposureType, SettlementDetails138.mmFXStandingInstruction,
						SettlementDetails138.mmMarketClientSide, SettlementDetails138.mmNettingEligibility, SettlementDetails138.mmRegistration, SettlementDetails138.mmLegalRestrictions, SettlementDetails138.mmSettlingCapacity,
						SettlementDetails138.mmTaxCapacity, SettlementDetails138.mmStampDutyTaxBasis, SettlementDetails138.mmTracking, SettlementDetails138.mmLetterOfGuarantee, SettlementDetails138.mmReturnLeg,
						SettlementDetails138.mmModificationCancellationAllowed, SettlementDetails138.mmEligibleForCollateral, SettlementDetails138.mmSecuritiesSubBalanceType, SettlementDetails138.mmCashSubBalanceType);
