...
public class SubAccountIdentification21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification21.mmAccountOwner, SubAccountIdentification21.mmSafekeepingAccount, SubAccountIdentification21.mmActivityIndicator,
						SubAccountIdentification21.mmFinancialInstrumentDetails);
