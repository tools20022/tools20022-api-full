 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Rate3 Rate3}</li>
 * </ul>
 */
...
public class Rate4 {
	...
	public static final MMMessageAssociationEnd mmType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> Rate3.mmType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Rate3#mmValidityRange
	...
	public static final MMMessageAssociationEnd mmValidityRange = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> Rate3.mmValidityRange;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> Rate3.mmObject();
			}
		});
