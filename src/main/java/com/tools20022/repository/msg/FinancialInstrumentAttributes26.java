...
public class FinancialInstrumentAttributes26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes26.mmPlaceOfListing, FinancialInstrumentAttributes26.mmDayCountBasis, FinancialInstrumentAttributes26.mmRegistrationForm,
						FinancialInstrumentAttributes26.mmPaymentFrequency, FinancialInstrumentAttributes26.mmPaymentStatus, FinancialInstrumentAttributes26.mmPaymentDirection, FinancialInstrumentAttributes26.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes26.mmPreferenceToIncome, FinancialInstrumentAttributes26.mmClassificationType, FinancialInstrumentAttributes26.mmOptionStyle, FinancialInstrumentAttributes26.mmOptionType,
						FinancialInstrumentAttributes26.mmDenominationCurrency, FinancialInstrumentAttributes26.mmCouponDate, FinancialInstrumentAttributes26.mmExpiryDate, FinancialInstrumentAttributes26.mmFloatingRateFixingDate,
						FinancialInstrumentAttributes26.mmMaturityDate, FinancialInstrumentAttributes26.mmIssueDate, FinancialInstrumentAttributes26.mmNextCallableDate, FinancialInstrumentAttributes26.mmPutableDate,
						FinancialInstrumentAttributes26.mmDatedDate, FinancialInstrumentAttributes26.mmFirstPaymentDate, FinancialInstrumentAttributes26.mmPreviousFactor, FinancialInstrumentAttributes26.mmCurrentFactor,
						FinancialInstrumentAttributes26.mmNextFactor, FinancialInstrumentAttributes26.mmInterestRate, FinancialInstrumentAttributes26.mmNextInterestRate, FinancialInstrumentAttributes26.mmIndexRateBasis,
						FinancialInstrumentAttributes26.mmCouponAttachedNumber, FinancialInstrumentAttributes26.mmPoolNumber, FinancialInstrumentAttributes26.mmQuantityBreakdown, FinancialInstrumentAttributes26.mmVariableRateIndicator,
						FinancialInstrumentAttributes26.mmCallableIndicator, FinancialInstrumentAttributes26.mmPutableIndicator, FinancialInstrumentAttributes26.mmMarketOrIndicativePrice, FinancialInstrumentAttributes26.mmExercisePrice,
						FinancialInstrumentAttributes26.mmSubscriptionPrice, FinancialInstrumentAttributes26.mmConversionPrice, FinancialInstrumentAttributes26.mmStrikePrice, FinancialInstrumentAttributes26.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes26.mmContractSize, FinancialInstrumentAttributes26.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes26.mmFinancialInstrumentAttributeAdditionalDetails);
