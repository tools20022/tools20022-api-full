...
public class ATMWithdrawalCompletionAcknowledgement1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ATMWithdrawalCompletionAcknowledgement1.mmATM, ATMWithdrawalCompletionAcknowledgement1.mmContext, ATMWithdrawalCompletionAcknowledgement1.mmTransaction);
