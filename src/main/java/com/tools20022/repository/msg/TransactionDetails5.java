...
public class TransactionDetails5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails5.mmTradeIdentification, TransactionDetails5.mmPoolIdentification, TransactionDetails5.mmCorporateActionEventIdentification,
						TransactionDetails5.mmTripartyAgentCollateralTransactionIdentification, TransactionDetails5.mmClientTripartyCollateralTransactionIdentification, TransactionDetails5.mmAccountOwner,
						TransactionDetails5.mmSafekeepingAccount, TransactionDetails5.mmSafekeepingPlace, TransactionDetails5.mmPlaceOfTrade, TransactionDetails5.mmPlaceOfClearing, TransactionDetails5.mmFinancialInstrumentIdentification,
						TransactionDetails5.mmSettlementQuantity, TransactionDetails5.mmSettlementAmount, TransactionDetails5.mmLateDeliveryDate, TransactionDetails5.mmExpectedSettlementDate, TransactionDetails5.mmExpectedValueDate,
						TransactionDetails5.mmSettlementDate, TransactionDetails5.mmTradeDate, TransactionDetails5.mmSecuritiesMovementType, TransactionDetails5.mmPayment, TransactionDetails5.mmSettlementParameters,
						TransactionDetails5.mmReceivingSettlementParties, TransactionDetails5.mmDeliveringSettlementParties, TransactionDetails5.mmInvestor, TransactionDetails5.mmQualifiedForeignIntermediary,
						TransactionDetails5.mmSettlementInstructionProcessingAdditionalDetails);
