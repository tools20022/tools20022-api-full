 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.GenericInformation1#mmName
 * GenericInformation1.mmName}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GenericInformation1#mmValue
 * GenericInformation1.mmValue}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "GenericInformation exchanged with a name and value."</li>
 * <li>
...
@XmlType(name = "GenericInformation1", propOrder = {"name", "value"})
public class GenericInformation1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.GenericInformation1
	 * GenericInformation1}</li>
	...
	public GenericInformation1 setName(Max70Text name) {
		this.name = Objects.requireNonNull(name);
		return this;
	}

	public Optional<Max140Text> getValue() {
		return value == null ? Optional.empty() : Optional.of(value);
	}

	public GenericInformation1 setValue(Max140Text value) {
		this.value = value;
		return this;
	}
}