...
public class TransactionDetails47 {
	...
	public static final MMMessageAttribute mmTradeIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionDetails47.mmObject();
			isDerived = false;
			xmlTag = "TradId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails47.mmTradeIdentification, TransactionDetails47.mmPoolIdentification, TransactionDetails47.mmCorporateActionEventIdentification,
						TransactionDetails47.mmTripartyAgentCollateralTransactionIdentification, TransactionDetails47.mmClientTripartyCollateralTransactionIdentification, TransactionDetails47.mmAccountOwner,
						TransactionDetails47.mmSafekeepingAccount, TransactionDetails47.mmSafekeepingPlace, TransactionDetails47.mmPlaceOfTrade, TransactionDetails47.mmPlaceOfClearing,
						TransactionDetails47.mmFinancialInstrumentIdentification, TransactionDetails47.mmSettlementQuantity, TransactionDetails47.mmSettlementAmount, TransactionDetails47.mmLateDeliveryDate,
						TransactionDetails47.mmExpectedSettlementDate, TransactionDetails47.mmExpectedValueDate, TransactionDetails47.mmSettlementDate, TransactionDetails47.mmTradeDate, TransactionDetails47.mmSecuritiesMovementType,
						TransactionDetails47.mmPayment, TransactionDetails47.mmSettlementParameters, TransactionDetails47.mmReceivingSettlementParties, TransactionDetails47.mmDeliveringSettlementParties, TransactionDetails47.mmInvestor,
						TransactionDetails47.mmQualifiedForeignIntermediary, TransactionDetails47.mmSettlementInstructionProcessingAdditionalDetails);
	...
	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails53 settlementParameters) {
