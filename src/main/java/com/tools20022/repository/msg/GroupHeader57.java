 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#CreationDateTime
 * GroupHeader57.CreationDateTime}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#Authorisation
 * GroupHeader57.Authorisation}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#BatchBooking
 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#ControlSum
 * GroupHeader57.ControlSum}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#GroupReversal
 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#InstructingAgent
 * GroupHeader57.InstructingAgent}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader57#InstructedAgent
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.pacs.FIToFIPaymentReversalV03#GroupHeader
 * FIToFIPaymentReversalV03.GroupHeader}</li>
 * <li>
...
public class GroupHeader57 {
	...
	public static final MMMessageAttribute MessageIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.MessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreationDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.CreationDateTime);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.GroupHeader71#Authorisation
	...
	public static final MMMessageAttribute Authorisation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.Authorisation);
			minOccurs = 0;
			maxOccurs = 2;
	...
	public static final MMMessageAttribute BatchBooking = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.BatchBooking);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfTransactions = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.NumberOfTransactions);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ControlSum = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.ControlSum);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.GroupHeader71#GroupReversal
	...
	public static final MMMessageAttribute GroupReversal = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.GroupReversal);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TotalReversedInterbankSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.TotalReversedInterbankSettlementAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute InterbankSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.InterbankSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.SettlementInformation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InstructingAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.InstructingAgent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InstructedAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader71.InstructedAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader57.MessageIdentification, com.tools20022.repository.msg.GroupHeader57.CreationDateTime,
						com.tools20022.repository.msg.GroupHeader57.Authorisation, com.tools20022.repository.msg.GroupHeader57.BatchBooking, com.tools20022.repository.msg.GroupHeader57.NumberOfTransactions,
						com.tools20022.repository.msg.GroupHeader57.ControlSum, com.tools20022.repository.msg.GroupHeader57.GroupReversal, com.tools20022.repository.msg.GroupHeader57.TotalReversedInterbankSettlementAmount,
						com.tools20022.repository.msg.GroupHeader57.InterbankSettlementDate, com.tools20022.repository.msg.GroupHeader57.SettlementInformation, com.tools20022.repository.msg.GroupHeader57.InstructingAgent,
						com.tools20022.repository.msg.GroupHeader57.InstructedAgent);
				trace_lazy = () -> Payment.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV03.GroupHeader, com.tools20022.repository.area.pacs.FIToFIPaymentReversalV04.GroupHeader,
						com.tools20022.repository.area.pacs.FIToFIPaymentReversalV05.GroupHeader);
