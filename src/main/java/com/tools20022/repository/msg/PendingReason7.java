...
public class PendingReason7 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingReason7.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingReason7.mmCode, PendingReason7.mmAdditionalReasonInformation);
	...
	public void setCode(PendingReason15Choice code) {
		this.code = code;
	}
