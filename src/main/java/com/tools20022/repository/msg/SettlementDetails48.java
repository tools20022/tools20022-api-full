 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails75
...
@XmlType(name = "SettlementDetails48", propOrder = {"settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "registration", "beneficialOwnership", "cashClearingSystem", "taxCapacity", "repurchaseType",
...
public class SettlementDetails48 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, List<SettlementTransactionCondition12Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails48, List<SettlementTransactionCondition12Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails48.mmObject();
			isDerived = false;
			xmlTag = "SttlmTxCond";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmSettlementTransactionCondition);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition12Choice> getValue(SettlementDetails48 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails48 obj, List<SettlementTransactionCondition12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<SettlingCapacity1Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails48, Optional<SettlingCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmSettlingCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity1Choice> getValue(SettlementDetails48 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<SettlingCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails48, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmStampDutyTaxBasis);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails48 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails48, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmSecuritiesRTGS);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails48 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<Registration1Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails48, Optional<Registration1Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmRegistration);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration1Choice> getValue(SettlementDetails48 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<Registration1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails48, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmBeneficialOwnership);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails48 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails48, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmCashClearingSystem);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails48 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails48, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmTaxCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails48 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<RepurchaseType3Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails48, Optional<RepurchaseType3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmRepurchaseType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType3Choice> getValue(SettlementDetails48 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<RepurchaseType3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails48, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmMarketClientSide);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails48 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails48, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmBlockTrade);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails48 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails48, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmLegalRestrictions);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails48 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails48, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmSettlementSystemMethod);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails48 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails48, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmNettingEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails48 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails48, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmCCPEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails48 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails48, Optional<LetterOfGuarantee1Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails48, Optional<LetterOfGuarantee1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmLetterOfGuarantee);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee1Choice> getValue(SettlementDetails48 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<LetterOfGuarantee1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails48, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails48, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmPartialSettlementIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails48 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails48 obj, Optional<SettlementTransactionCondition5Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails48.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails48.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails48.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails48.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails48.mmRegistration,
						com.tools20022.repository.msg.SettlementDetails48.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails48.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails48.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails48.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails48.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails48.mmBlockTrade,
						com.tools20022.repository.msg.SettlementDetails48.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails48.mmSettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails48.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails48.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails48.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails48.mmPartialSettlementIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails48,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails48);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails48";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails75.mmObject());
				previousVersion_lazy = () -> SettlementDetails27.mmObject();
			}
		});
	...
	public SettlementDetails48 setSettlementTransactionCondition(List<SettlementTransactionCondition12Choice> settlementTransactionCondition) {
	...
	public SettlementDetails48 setSettlingCapacity(SettlingCapacity1Choice settlingCapacity) {
	...
	public SettlementDetails48 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails48 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails48 setRegistration(Registration1Choice registration) {
	...
	public SettlementDetails48 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails48 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails48 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails48 setRepurchaseType(RepurchaseType3Choice repurchaseType) {
	...
	public SettlementDetails48 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails48 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails48 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails48 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails48 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails48 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails48 setLetterOfGuarantee(LetterOfGuarantee1Choice letterOfGuarantee) {
	...
	public SettlementDetails48 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
