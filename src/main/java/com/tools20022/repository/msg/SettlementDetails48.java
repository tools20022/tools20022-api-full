 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails48#BlockTrade
...
public class SettlementDetails48 {
	...
	public static final MMMessageAssociationEnd SettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> SettlementDetails48.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.SettlementTransactionCondition);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd SettlingCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.SettlingCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StampDutyTaxBasis = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.StampDutyTaxBasis);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesRTGS = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.SecuritiesRTGS);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Registration = new MMMessageAssociationEnd() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.Registration);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BeneficialOwnership = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.BeneficialOwnership);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashClearingSystem = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.CashClearingSystem);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TaxCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.TaxCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RepurchaseType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.RepurchaseType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MarketClientSide = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.MarketClientSide);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BlockTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.BlockTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LegalRestrictions = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.LegalRestrictions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementSystemMethod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.SettlementSystemMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd NettingEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.NettingEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CCPEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.CCPEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LetterOfGuarantee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.LetterOfGuarantee);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlementIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails75.PartialSettlementIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails48.SettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails48.SettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails48.StampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails48.SecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails48.Registration,
						com.tools20022.repository.msg.SettlementDetails48.BeneficialOwnership, com.tools20022.repository.msg.SettlementDetails48.CashClearingSystem, com.tools20022.repository.msg.SettlementDetails48.TaxCapacity,
						com.tools20022.repository.msg.SettlementDetails48.RepurchaseType, com.tools20022.repository.msg.SettlementDetails48.MarketClientSide, com.tools20022.repository.msg.SettlementDetails48.BlockTrade,
						com.tools20022.repository.msg.SettlementDetails48.LegalRestrictions, com.tools20022.repository.msg.SettlementDetails48.SettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails48.NettingEligibility,
						com.tools20022.repository.msg.SettlementDetails48.CCPEligibility, com.tools20022.repository.msg.SettlementDetails48.LetterOfGuarantee, com.tools20022.repository.msg.SettlementDetails48.PartialSettlementIndicator);
