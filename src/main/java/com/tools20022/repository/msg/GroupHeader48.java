		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV04.mmGroupHeader, CustomerCreditTransferInitiationV05.mmGroupHeader, CustomerCreditTransferInitiationV06.mmGroupHeader,
						CustomerCreditTransferInitiationV07.mmGroupHeader, CustomerCreditTransferInitiationV08.mmGroupHeader);
