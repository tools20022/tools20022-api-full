 ...
 * <li>{@linkplain com.tools20022.repository.msg.Option5#mmEarliestExerciseDate
 * Option5.mmEarliestExerciseDate}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Option5#mmExpiryDateAndTime
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Option5#mmAdditionalOptionInformation
 * Option5.mmAdditionalOptionInformation}</li>
...
public class Option5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Option5, AmountsAndValueDate4> mmOptionAmounts = new MMMessageAssociationEnd<Option5, AmountsAndValueDate4>() {
		{
		...
		@Override
		public AmountsAndValueDate4 getValue(Option5 obj) {
			return obj.getOptionAmounts();
		}

		@Override
		public void setValue(Option5 obj, AmountsAndValueDate4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Option5, AgreedRate1> mmStrikePrice = new MMMessageAssociationEnd<Option5, AgreedRate1>() {
		{
		...
		@Override
		public AgreedRate1 getValue(Option5 obj) {
			return obj.getStrikePrice();
		}

		@Override
		public void setValue(Option5 obj, AgreedRate1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, OptionStyle2Code> mmExerciseStyle = new MMMessageAttribute<Option5, OptionStyle2Code>() {
		{
		...
		@Override
		public OptionStyle2Code getValue(Option5 obj) {
			return obj.getExerciseStyle();
		}

		@Override
		public void setValue(Option5 obj, OptionStyle2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, Optional<ISODate>> mmEarliestExerciseDate = new MMMessageAttribute<Option5, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(Option5 obj) {
			return obj.getEarliestExerciseDate();
		}

		@Override
		public void setValue(Option5 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, ISODateTime> mmExpiryDateAndTime = new MMMessageAttribute<Option5, ISODateTime>() {
		{
		...
		@Override
		public ISODateTime getValue(Option5 obj) {
			return obj.getExpiryDateAndTime();
		}

		@Override
		public void setValue(Option5 obj, ISODateTime value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, Max4AlphaNumericText> mmExpiryLocation = new MMMessageAttribute<Option5, Max4AlphaNumericText>() {
		{
		...
		@Override
		public Max4AlphaNumericText getValue(Option5 obj) {
			return obj.getExpiryLocation();
		}

		@Override
		public void setValue(Option5 obj, Max4AlphaNumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, SettlementType1Code> mmSettlementType = new MMMessageAttribute<Option5, SettlementType1Code>() {
		{
		...
		@Override
		public SettlementType1Code getValue(Option5 obj) {
			return obj.getSettlementType();
		}

		@Override
		public void setValue(Option5 obj, SettlementType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Option5, Optional<Max140Text>> mmAdditionalOptionInformation = new MMMessageAttribute<Option5, Optional<Max140Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Option5.mmObject();
			isDerived = false;
			xmlTag = "AddtlOptnInf";
		...
		@Override
		public Optional<Max140Text> getValue(Option5 obj) {
			return obj.getAdditionalOptionInformation();
		}

		@Override
		public void setValue(Option5 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Option5, PremiumAmount2> mmPremium = new MMMessageAssociationEnd<Option5, PremiumAmount2>() {
		{
		...
		@Override
		public PremiumAmount2 getValue(Option5 obj) {
			return obj.getPremium();
		}

		@Override
		public void setValue(Option5 obj, PremiumAmount2 value) {
	...
	public Option5 setOptionAmounts(AmountsAndValueDate4 optionAmounts) {
	...
	public Option5 setStrikePrice(AgreedRate1 strikePrice) {
	...
	public Option5 setPremium(PremiumAmount2 premium) {
