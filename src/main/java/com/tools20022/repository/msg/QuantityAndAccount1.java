...
public class QuantityAndAccount1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount1.mmSettlementQuantity, QuantityAndAccount1.mmDenominationChoice, QuantityAndAccount1.mmAccountOwner, QuantityAndAccount1.mmSafekeepingAccount,
						QuantityAndAccount1.mmCashAccount, QuantityAndAccount1.mmSafekeepingPlace, QuantityAndAccount1.mmQuantityBreakdown);
