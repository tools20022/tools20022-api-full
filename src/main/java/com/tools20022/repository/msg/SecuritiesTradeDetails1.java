...
public class SecuritiesTradeDetails1 {
	...
	public static final MMMessageAttribute mmTradeIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecuritiesTradeDetails1.mmObject();
			isDerived = false;
			xmlTag = "TradId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails1.mmTradeIdentification, SecuritiesTradeDetails1.mmCollateralTransactionIdentification, SecuritiesTradeDetails1.mmPlaceOfTrade,
						SecuritiesTradeDetails1.mmPlaceOfClearing, SecuritiesTradeDetails1.mmTradeDate, SecuritiesTradeDetails1.mmSettlementDate, SecuritiesTradeDetails1.mmLateDeliveryDate, SecuritiesTradeDetails1.mmDealPrice,
						SecuritiesTradeDetails1.mmNumberOfDaysAccrued, SecuritiesTradeDetails1.mmOpeningClosing, SecuritiesTradeDetails1.mmReporting, SecuritiesTradeDetails1.mmTradeTransactionCondition,
						SecuritiesTradeDetails1.mmInvestorCapacity, SecuritiesTradeDetails1.mmTradeOriginatorRole, SecuritiesTradeDetails1.mmTypeOfPrice, SecuritiesTradeDetails1.mmCurrencyToBuyOrSell,
						SecuritiesTradeDetails1.mmMatchingStatus, SecuritiesTradeDetails1.mmAffirmationStatus, SecuritiesTradeDetails1.mmFXAdditionalDetails, SecuritiesTradeDetails1.mmSettlementInstructionProcessingAdditionalDetails);
