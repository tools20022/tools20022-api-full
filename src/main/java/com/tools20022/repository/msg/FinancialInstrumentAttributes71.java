...
public class FinancialInstrumentAttributes71 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes71.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes71.mmPlaceOfListing, FinancialInstrumentAttributes71.mmDayCountBasis,
						FinancialInstrumentAttributes71.mmClassificationType, FinancialInstrumentAttributes71.mmOptionStyle, FinancialInstrumentAttributes71.mmDenominationCurrency, FinancialInstrumentAttributes71.mmNextCouponDate,
						FinancialInstrumentAttributes71.mmFloatingRateFixingDate, FinancialInstrumentAttributes71.mmMaturityDate, FinancialInstrumentAttributes71.mmIssueDate, FinancialInstrumentAttributes71.mmNextCallableDate,
						FinancialInstrumentAttributes71.mmPutableDate, FinancialInstrumentAttributes71.mmDatedDate, FinancialInstrumentAttributes71.mmConversionDate, FinancialInstrumentAttributes71.mmPreviousFactor,
						FinancialInstrumentAttributes71.mmNextFactor, FinancialInstrumentAttributes71.mmInterestRate, FinancialInstrumentAttributes71.mmNextInterestRate, FinancialInstrumentAttributes71.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes71.mmMinimumQuantityToInstruct, FinancialInstrumentAttributes71.mmMinimumMultipleQuantityToInstruct, FinancialInstrumentAttributes71.mmContractSize,
						FinancialInstrumentAttributes71.mmIssuePrice);
	...
	public FinancialInstrumentQuantity15Choice getMinimumQuantityToInstruct() {
		return minimumQuantityToInstruct;
	}

	public void setMinimumQuantityToInstruct(FinancialInstrumentQuantity15Choice minimumQuantityToInstruct) {
		this.minimumQuantityToInstruct = minimumQuantityToInstruct;
	}

	@XmlElement(name = "MinMltplQtyToInst")
	public FinancialInstrumentQuantity15Choice getMinimumMultipleQuantityToInstruct() {
		return minimumMultipleQuantityToInstruct;
	}

	public void setMinimumMultipleQuantityToInstruct(FinancialInstrumentQuantity15Choice minimumMultipleQuantityToInstruct) {
	...
	public PriceFormat57Choice getIssuePrice() {
		return issuePrice;
	}

	public void setIssuePrice(PriceFormat57Choice issuePrice) {
