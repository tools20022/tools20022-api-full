...
public class PriceInformation11 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PriceInformation9#mmValue
	...
	public static final MMMessageAttribute mmValue = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceInformation9.mmValue;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmQuotationDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceInformation9.mmQuotationDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPriceCalculationPeriod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceInformation9.mmPriceCalculationPeriod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSourceOfPrice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceInformation9.mmSourceOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceInformation11.mmValue, PriceInformation11.mmQuotationDate, PriceInformation11.mmPriceCalculationPeriod, PriceInformation11.mmSourceOfPrice);
	...
	public void setSourceOfPrice(com.tools20022.repository.msg.MarketIdentification79 sourceOfPrice) {
