...
public class CorporateActionConfirmationCashMovementDetailsSD3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD3.mmPlaceAndName, CorporateActionConfirmationCashMovementDetailsSD3.mmCreditDebitIndicator,
						CorporateActionConfirmationCashMovementDetailsSD3.mmPayoutType, CorporateActionConfirmationCashMovementDetailsSD3.mmTransactionAmount, CorporateActionConfirmationCashMovementDetailsSD3.mmReasonCode,
						CorporateActionConfirmationCashMovementDetailsSD3.mmSubReasonCode, CorporateActionConfirmationCashMovementDetailsSD3.mmContraParticipantNumber, CorporateActionConfirmationCashMovementDetailsSD3.mmPostingDate,
						CorporateActionConfirmationCashMovementDetailsSD3.mmTaxAdjustmentRate, CorporateActionConfirmationCashMovementDetailsSD3.mmRDPReferenceNumber);
