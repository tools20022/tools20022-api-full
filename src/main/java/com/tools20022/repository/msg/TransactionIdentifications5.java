...
public class TransactionIdentifications5 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications5.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications5.mmAccountOwnerTransactionIdentification, TransactionIdentifications5.mmAccountServicerTransactionIdentification,
						TransactionIdentifications5.mmMarketInfrastructureTransactionIdentification);
