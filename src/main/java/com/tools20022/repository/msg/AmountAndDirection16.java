...
public class AmountAndDirection16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection16.mmAccruedInterestIndicator, AmountAndDirection16.mmStampDutyIndicator, AmountAndDirection16.mmAmount, AmountAndDirection16.mmCreditDebitIndicator,
						AmountAndDirection16.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection16.mmForeignExchangeDetails, AmountAndDirection16.mmValueDate);
