...
public class ForeignExchangeTerms26 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, Optional<ActiveCurrencyAnd13DecimalAmount>> mmToAmount = new MMMessageAttribute<ForeignExchangeTerms26, Optional<ActiveCurrencyAnd13DecimalAmount>>() {
		{
			businessElementTrace_lazy = () -> ForeignExchangeTrade.mmBuyAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms26.mmObject();
			isDerived = false;
			xmlTag = "ToAmt";
		...
		@Override
		public Optional<ActiveCurrencyAnd13DecimalAmount> getValue(ForeignExchangeTerms26 obj) {
			return obj.getToAmount();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, Optional<ActiveCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, Optional<ActiveCurrencyAndAmount>> mmFromAmount = new MMMessageAttribute<ForeignExchangeTerms26, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ForeignExchangeTerms26 obj) {
			return obj.getFromAmount();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, ActiveOrHistoricCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms26, ActiveOrHistoricCurrencyCode>() {
		{
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ForeignExchangeTerms26 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms26, ActiveOrHistoricCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms26, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms26 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, Optional<ISODateTime>> mmQuotationDate = new MMMessageAttribute<ForeignExchangeTerms26, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(ForeignExchangeTerms26 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms26, Optional<PartyIdentification70Choice>> mmQuotingInstitution = new MMMessageAttribute<ForeignExchangeTerms26, Optional<PartyIdentification70Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification70Choice> getValue(ForeignExchangeTerms26 obj) {
			return obj.getQuotingInstitution();
		}

		@Override
		public void setValue(ForeignExchangeTerms26 obj, Optional<PartyIdentification70Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms26.mmToAmount, com.tools20022.repository.msg.ForeignExchangeTerms26.mmFromAmount,
						com.tools20022.repository.msg.ForeignExchangeTerms26.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms26.mmQuotedCurrency, com.tools20022.repository.msg.ForeignExchangeTerms26.mmExchangeRate,
						com.tools20022.repository.msg.ForeignExchangeTerms26.mmQuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms26.mmQuotingInstitution);
	...
	public ForeignExchangeTerms26 setToAmount(ActiveCurrencyAnd13DecimalAmount toAmount) {
	...
	public ForeignExchangeTerms26 setFromAmount(ActiveCurrencyAndAmount fromAmount) {
	...
	public ForeignExchangeTerms26 setUnitCurrency(ActiveOrHistoricCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms26 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms26 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms26 setQuotationDate(ISODateTime quotationDate) {
		this.quotationDate = quotationDate;
		return this;
	}

	public Optional<PartyIdentification70Choice> getQuotingInstitution() {
		return quotingInstitution == null ? Optional.empty() : Optional.of(quotingInstitution);
	}

	public ForeignExchangeTerms26 setQuotingInstitution(PartyIdentification70Choice quotingInstitution) {
