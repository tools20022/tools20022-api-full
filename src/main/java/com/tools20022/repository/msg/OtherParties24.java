...
public class OtherParties24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OtherParties24.mmInvestor, OtherParties24.mmQualifiedForeignIntermediary, OtherParties24.mmStockExchange, OtherParties24.mmTradeRegulator, OtherParties24.mmTripartyAgent,
						OtherParties24.mmBroker);
