...
public class RateTypeAndAmountAndStatus8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus8.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus8.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus8.RateStatus);
