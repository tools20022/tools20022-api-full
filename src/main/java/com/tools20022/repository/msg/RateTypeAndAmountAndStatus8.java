...
public class RateTypeAndAmountAndStatus8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus8.mmRateType, RateTypeAndAmountAndStatus8.mmAmount, RateTypeAndAmountAndStatus8.mmRateStatus);
