...
public class PartyIdentification17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification17.Name, com.tools20022.repository.msg.PartyIdentification17.Identification);
