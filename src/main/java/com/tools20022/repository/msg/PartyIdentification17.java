 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PartyIdentification17#mmName
...
@XmlType(name = "PartyIdentification17", propOrder = {"name", "identification"})
public class PartyIdentification17 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PartyIdentification17
	 * PartyIdentification17}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification17.mmName, com.tools20022.repository.msg.PartyIdentification17.mmIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PartyIdentification17";
	...
	public PartyIdentification17 setName(Max70Text name) {
		this.name = name;
		return this;
	}

	public Optional<PartyPrivate1> getIdentification() {
		return identification == null ? Optional.empty() : Optional.of(identification);
	}

	public PartyIdentification17 setIdentification(PartyPrivate1 identification) {
