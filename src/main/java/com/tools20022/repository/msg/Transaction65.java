...
public class Transaction65 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails112.mmObject();
		}
	};
	...
	public Transaction65 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails112 transactionDetails) {
	...
	public Transaction65 setSupplementaryData(List<com.tools20022.repository.msg.SupplementaryData1> supplementaryData) {
