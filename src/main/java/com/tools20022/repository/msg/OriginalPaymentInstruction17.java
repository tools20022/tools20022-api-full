...
public class OriginalPaymentInstruction17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalPaymentInformationCancellationIdentification, OriginalPaymentInstruction17.mmResolvedCase,
						OriginalPaymentInstruction17.mmOriginalPaymentInformationIdentification, OriginalPaymentInstruction17.mmOriginalGroupInformation, OriginalPaymentInstruction17.mmOriginalNumberOfTransactions,
						OriginalPaymentInstruction17.mmOriginalControlSum, OriginalPaymentInstruction17.mmPaymentInformationCancellationStatus, OriginalPaymentInstruction17.mmCancellationStatusReasonInformation,
						OriginalPaymentInstruction17.mmNumberOfTransactionsPerCancellationStatus, OriginalPaymentInstruction17.mmTransactionInformationAndStatus);
