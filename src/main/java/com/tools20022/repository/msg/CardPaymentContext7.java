...
public class CardPaymentContext7 {
	...
	public static final MMMessageAssociationEnd mmPaymentContext = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CardPaymentContext7.mmObject();
			isDerived = false;
			xmlTag = "PmtCntxt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentContext7.mmPaymentContext, CardPaymentContext7.mmSaleContext);
	...
	public PaymentContext7 getPaymentContext() {
		return paymentContext;
	}

	public void setPaymentContext(com.tools20022.repository.msg.PaymentContext7 paymentContext) {
