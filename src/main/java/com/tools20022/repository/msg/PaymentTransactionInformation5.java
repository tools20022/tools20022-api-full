...
public class PaymentTransactionInformation5 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pacs.FIToFIPaymentReversalV01.mmTransactionInformation);
	...
	public void setReversedInterbankSettlementAmount(CurrencyAndAmount reversedInterbankSettlementAmount) {
