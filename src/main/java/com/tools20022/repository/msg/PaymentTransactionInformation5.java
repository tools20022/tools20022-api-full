...
public class PaymentTransactionInformation5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation5.mmReversalIdentification, PaymentTransactionInformation5.mmOriginalPaymentInformationIdentification,
						PaymentTransactionInformation5.mmOriginalInstructionIdentification, PaymentTransactionInformation5.mmOriginalEndToEndIdentification, PaymentTransactionInformation5.mmOriginalTransactionIdentification,
						PaymentTransactionInformation5.mmOriginalInterbankSettlementAmount, PaymentTransactionInformation5.mmReversedInterbankSettlementAmount, PaymentTransactionInformation5.mmInterbankSettlementDate,
						PaymentTransactionInformation5.mmReversedInstructedAmount, PaymentTransactionInformation5.mmExchangeRate, PaymentTransactionInformation5.mmCompensationAmount, PaymentTransactionInformation5.mmChargeBearer,
						PaymentTransactionInformation5.mmChargesInformation, PaymentTransactionInformation5.mmInstructingAgent, PaymentTransactionInformation5.mmInstructedAgent, PaymentTransactionInformation5.mmReversalReasonInformation,
						PaymentTransactionInformation5.mmOriginalTransactionReference);
