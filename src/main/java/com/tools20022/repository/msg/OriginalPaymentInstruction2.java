...
import com.tools20022.repository.msg.PaymentTransaction35;
import java.util.*;
...
public class OriginalPaymentInstruction2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Optional<Max35Text>> mmReversalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction2, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getReversalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Max35Text> mmOriginalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction2, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(OriginalPaymentInstruction2 obj) {
			return obj.getOriginalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Optional<Max15NumericText>> mmOriginalNumberOfTransactions = new MMMessageAttribute<OriginalPaymentInstruction2, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "OrgnlNbOfTxs";
		...
		@Override
		public Optional<Max15NumericText> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getOriginalNumberOfTransactions();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Optional<DecimalNumber>> mmOriginalControlSum = new MMMessageAttribute<OriginalPaymentInstruction2, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "OrgnlCtrlSum";
		...
		@Override
		public Optional<DecimalNumber> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getOriginalControlSum();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<OriginalPaymentInstruction2, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction2, Optional<TrueFalseIndicator>> mmPaymentInformationReversal = new MMMessageAttribute<OriginalPaymentInstruction2, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "PmtInfRvsl";
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getPaymentInformationReversal();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction2, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction2, List<PaymentReversalReason7>>() {
		{
		...
		@Override
		public List<PaymentReversalReason7> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, List<PaymentReversalReason7> value) {
			obj.setReversalReasonInformation(value);
		}
	};
	@XmlElement(name = "TxInf")
	protected List<PaymentTransaction35> transactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction2, List<PaymentTransaction35>> mmTransactionInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction2, List<PaymentTransaction35>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PaymentTransaction35.mmObject();
		}

		@Override
		public List<PaymentTransaction35> getValue(OriginalPaymentInstruction2 obj) {
			return obj.getTransactionInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction2 obj, List<PaymentTransaction35> value) {
	...
	public OriginalPaymentInstruction2 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
	...
	public OriginalPaymentInstruction2 setTransactionInformation(List<PaymentTransaction35> transactionInformation) {
