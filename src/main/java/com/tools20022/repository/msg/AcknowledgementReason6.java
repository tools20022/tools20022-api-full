...
public class AcknowledgementReason6 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason6.mmCode, AcknowledgementReason6.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason8Choice code) {
		this.code = code;
	}
