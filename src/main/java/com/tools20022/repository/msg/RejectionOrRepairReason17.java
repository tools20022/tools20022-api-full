...
public class RejectionOrRepairReason17 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason17.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason17.mmCode, RejectionOrRepairReason17.mmAdditionalReasonInformation);
	...
	public void setCode(List<RejectionAndRepairReason17Choice> code) {
		this.code = code;
	}
