	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationReason7.mmCode, com.tools20022.repository.msg.CancellationReason9.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationReason7.mmAdditionalReasonInformation, com.tools20022.repository.msg.CancellationReason9.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
