...
public class RateTypeAndAmountAndStatus19 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RateTypeAndAmountAndStatus19.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus19.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus19.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus19.RateStatus);
