...
public class QuantityAndAccount51 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount51.mmSettledQuantity, QuantityAndAccount51.mmPreviouslySettledQuantity, QuantityAndAccount51.mmRemainingToBeSettledQuantity,
						QuantityAndAccount51.mmPreviouslySettledAmount, QuantityAndAccount51.mmRemainingToBeSettledAmount, QuantityAndAccount51.mmDenominationChoice, QuantityAndAccount51.mmAccountOwner,
						QuantityAndAccount51.mmSafekeepingAccount, QuantityAndAccount51.mmCashAccount, QuantityAndAccount51.mmQuantityBreakdown, QuantityAndAccount51.mmSafekeepingPlace);
