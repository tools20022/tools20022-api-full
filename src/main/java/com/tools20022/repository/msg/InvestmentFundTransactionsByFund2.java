...
public class InvestmentFundTransactionsByFund2 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.Identification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.Name);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupplementaryIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.SupplementaryIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesForm = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.SecuritiesForm);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ClassType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.ClassType);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute DistributionPolicy = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.DistributionPolicy);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.TransactionDetails);
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd BalanceByPage = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund3.BalanceByPage);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.Identification, com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.Name,
						com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.SupplementaryIdentification, com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.SecuritiesForm,
						com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.ClassType, com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.DistributionPolicy,
						com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.TransactionDetails, com.tools20022.repository.msg.InvestmentFundTransactionsByFund2.BalanceByPage);
				trace_lazy = () -> InvestmentFundTransaction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.StatementOfInvestmentFundTransactionsV02.TransactionOnAccount);
