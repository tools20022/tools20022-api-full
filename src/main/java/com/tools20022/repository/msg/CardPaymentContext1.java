...
public class CardPaymentContext1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext1, PaymentContext1> mmPaymentContext = new MMMessageAssociationEnd<CardPaymentContext1, PaymentContext1>() {
		{
		...
		@Override
		public PaymentContext1 getValue(CardPaymentContext1 obj) {
			return obj.getPaymentContext();
		}

		@Override
		public void setValue(CardPaymentContext1 obj, PaymentContext1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext1, Optional<SaleContext1>> mmSaleContext = new MMMessageAssociationEnd<CardPaymentContext1, Optional<SaleContext1>>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext1.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<SaleContext1> getValue(CardPaymentContext1 obj) {
			return obj.getSaleContext();
		}

		@Override
		public void setValue(CardPaymentContext1 obj, Optional<SaleContext1> value) {
	...
	public CardPaymentContext1 setPaymentContext(PaymentContext1 paymentContext) {
	...
	public CardPaymentContext1 setSaleContext(SaleContext1 saleContext) {
