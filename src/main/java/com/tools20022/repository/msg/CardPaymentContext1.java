...
public class CardPaymentContext1 {
	...
	public static final MMMessageAssociationEnd PaymentContext = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CardPaymentContext1.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext5.PaymentContext, com.tools20022.repository.msg.CardPaymentContext10.PaymentContext);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SaleContext = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext5.SaleContext, com.tools20022.repository.msg.CardPaymentContext10.SaleContext);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext1.PaymentContext, com.tools20022.repository.msg.CardPaymentContext1.SaleContext);
