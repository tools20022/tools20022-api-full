...
public class CorporateActionGeneralInformation44 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation44.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation44.mmCorporateActionEventIdentification, CorporateActionGeneralInformation44.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation44.mmEventType, CorporateActionGeneralInformation44.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes38 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes38 underlyingSecurity) {
