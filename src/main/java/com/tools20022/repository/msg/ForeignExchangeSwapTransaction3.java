 ...
 * ForeignExchangeSwapTransaction3.RelatedProprietaryTransactionIdentification}</li>
 * <li>
...
public class ForeignExchangeSwapTransaction3 {
	...
	public static final MMMessageAttribute ReportedTransactionStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.ReportedTransactionStatus;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute BranchIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.BranchIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute UniqueTransactionIdentifier = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.UniqueTransactionIdentifier;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ProprietaryTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.ProprietaryTransactionIdentification;
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max105Text.mmObject();
		}
	...
	public static final MMMessageAttribute CounterpartyProprietaryTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.CounterpartyProprietaryTransactionIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max105Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd CounterpartyIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.CounterpartyIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TradeDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.TradeDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SpotValueDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.SpotValueDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MaturityDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.MaturityDate;
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	public static final MMMessageAttribute TransactionType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.TransactionType;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionNominalAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.TransactionNominalAmount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ForeignExchange = new MMMessageAssociationEnd() {
		{
			...
			definition = "Provides the details of the foreign exchange transaction.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.ForeignExchange;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SupplementaryData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.SupplementaryData;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.ReportedTransactionStatus, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.NovationStatus,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.BranchIdentification, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.UniqueTransactionIdentifier,
						...
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.CounterpartyProprietaryTransactionIdentification, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.CounterpartyIdentification,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.TradeDate, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.SpotValueDate,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.MaturityDate, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.TransactionType,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.TransactionNominalAmount, com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.ForeignExchange,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction3.SupplementaryData);
