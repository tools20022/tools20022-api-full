...
public class SecuritiesTradeDetails11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails11.mmPlaceOfTrade, SecuritiesTradeDetails11.mmPlaceOfClearing, SecuritiesTradeDetails11.mmTradeDate, SecuritiesTradeDetails11.mmOpeningSettlementDate,
						SecuritiesTradeDetails11.mmDealPrice, SecuritiesTradeDetails11.mmNumberOfDaysAccrued, SecuritiesTradeDetails11.mmReporting, SecuritiesTradeDetails11.mmTradeTransactionCondition,
						SecuritiesTradeDetails11.mmInvestorCapacity, SecuritiesTradeDetails11.mmTradeOriginatorRole, SecuritiesTradeDetails11.mmCurrencyToBuyOrSell, SecuritiesTradeDetails11.mmAffirmationStatus,
						SecuritiesTradeDetails11.mmMatchingStatus, SecuritiesTradeDetails11.mmSettlementInstructionProcessingAdditionalDetails, SecuritiesTradeDetails11.mmFXAdditionalDetails);
