...
@XmlType(name = "PaymentCancellationReason2", propOrder = {"originator", "reason", "additionalInformation"})
public class PaymentCancellationReason2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCancellationReason2, Optional<PartyIdentification43>> mmOriginator = new MMMessageAssociationEnd<PaymentCancellationReason2, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCancellationReason2.mmObject();
			isDerived = false;
			xmlTag = "Orgtr";
		...
		@Override
		public Optional<PartyIdentification43> getValue(PaymentCancellationReason2 obj) {
			return obj.getOriginator();
		}

		@Override
		public void setValue(PaymentCancellationReason2 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCancellationReason2, Optional<CancellationReason14Choice>> mmReason = new MMMessageAssociationEnd<PaymentCancellationReason2, Optional<CancellationReason14Choice>>() {
		{
		...
		@Override
		public Optional<CancellationReason14Choice> getValue(PaymentCancellationReason2 obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(PaymentCancellationReason2 obj, Optional<CancellationReason14Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCancellationReason2, List<Max105Text>> mmAdditionalInformation = new MMMessageAttribute<PaymentCancellationReason2, List<Max105Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCancellationReason2.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
		...
		@Override
		public List<Max105Text> getValue(PaymentCancellationReason2 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(PaymentCancellationReason2 obj, List<Max105Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCancellationReason2.mmOriginator, com.tools20022.repository.msg.PaymentCancellationReason2.mmReason,
						com.tools20022.repository.msg.PaymentCancellationReason2.mmAdditionalInformation);
	...
	public PaymentCancellationReason2 setOriginator(PartyIdentification43 originator) {
		this.originator = originator;
		return this;
	}

	public Optional<CancellationReason14Choice> getReason() {
		return reason == null ? Optional.empty() : Optional.of(reason);
	}

	public PaymentCancellationReason2 setReason(CancellationReason14Choice reason) {
		this.reason = reason;
		return this;
	}
	...
	public PaymentCancellationReason2 setAdditionalInformation(List<Max105Text> additionalInformation) {
