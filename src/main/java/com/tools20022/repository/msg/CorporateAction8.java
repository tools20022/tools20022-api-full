...
public class CorporateAction8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateAction8.mmDateDetails, CorporateAction8.mmPeriodDetails, CorporateAction8.mmRateAndAmountDetails, CorporateAction8.mmPriceDetails, CorporateAction8.mmSecuritiesQuantity,
						CorporateAction8.mmInterestAccruedNumberOfDays, CorporateAction8.mmCouponNumber, CorporateAction8.mmCertificationBreakdownIndicator, CorporateAction8.mmChargesAppliedIndicator,
						CorporateAction8.mmRestrictionIndicator, CorporateAction8.mmAccruedInterestIndicator, CorporateAction8.mmDividendType, CorporateAction8.mmConversionType, CorporateAction8.mmPaymentOccurrenceType,
						CorporateAction8.mmOfferType, CorporateAction8.mmRenounceableEntitlementStatusType, CorporateAction8.mmEventStage, CorporateAction8.mmAdditionalBusinessProcessIndicator, CorporateAction8.mmChangeType,
						CorporateAction8.mmIntermediateSecuritiesDistributionType, CorporateAction8.mmCapitalGainInOutIndicator, CorporateAction8.mmTaxableIncomePerShareCalculated, CorporateAction8.mmElectionType,
						CorporateAction8.mmLotteryType, CorporateAction8.mmCertificationType, CorporateAction8.mmNewPlaceOfIncorporation, CorporateAction8.mmAdditionalInformation);
	...
	public CorporateActionDate25 getDateDetails() {
		return dateDetails;
	}

	public void setDateDetails(com.tools20022.repository.msg.CorporateActionDate25 dateDetails) {
	...
	public CorporateActionRate32 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate32 rateAndAmountDetails) {
