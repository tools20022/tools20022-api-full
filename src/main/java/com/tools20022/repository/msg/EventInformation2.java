...
public class EventInformation2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation2.mmCorporateActionEventIdentification, EventInformation2.mmOfficialCorporateActionEventIdentification, EventInformation2.mmEventType,
						EventInformation2.mmMandatoryVoluntaryEventType, EventInformation2.mmLastNotificationIdentification);
