...
public class CorporateActionPrice57 {
	...
	public static final MMMessageAssociationEnd MaximumPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice42.MaximumPrice;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MinimumPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice42.MinimumPrice;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PriceFormat44Choice.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice57.MaximumPrice, com.tools20022.repository.msg.CorporateActionPrice57.MinimumPrice);
