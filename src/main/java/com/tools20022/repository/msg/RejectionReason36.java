...
public class RejectionReason36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason36.Code, com.tools20022.repository.msg.RejectionReason36.AdditionalReasonInformation);
