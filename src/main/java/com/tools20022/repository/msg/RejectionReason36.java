...
public class RejectionReason36 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason36.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason36.mmCode, RejectionReason36.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason30Choice code) {
		this.code = code;
	}
