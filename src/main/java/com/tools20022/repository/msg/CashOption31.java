 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption31#mmExemptionType
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption31#mmAmountDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption31#mmPriceDetails
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CashOption25
 * CashOption25}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CashOption31", propOrder = {"creditDebitIndicator", "contractualPaymentIndicator", "nonEligibleProceedsIndicator", "issuerOfferorTaxabilityIndicator", "incomeType", "exemptionType", "cashAccountIdentification",
		"amountDetails", "dateDetails", "foreignExchangeDetails", "rateAndAmountDetails", "priceDetails"})
public class CashOption31 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption31, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashOption31, CreditDebitCode>() {
		{
			businessElementTrace_lazy = () -> ProceedsDefinition.mmCreditDebitIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption31.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmCreditDebitIndicator);
			previousVersion_lazy = () -> CashOption25.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(CashOption31 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashOption31 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption31, Optional<Payment1Code>> mmContractualPaymentIndicator = new MMMessageAttribute<CashOption31, Optional<Payment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmContractualPaymentIndicator);
			previousVersion_lazy = () -> CashOption25.mmContractualPaymentIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Payment1Code> getValue(CashOption31 obj) {
			return obj.getContractualPaymentIndicator();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<Payment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<NonEligibleProceedsIndicator1Choice>> mmNonEligibleProceedsIndicator = new MMMessageAssociationEnd<CashOption31, Optional<NonEligibleProceedsIndicator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmNonEligibleProceedsIndicator);
			previousVersion_lazy = () -> CashOption25.mmNonEligibleProceedsIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NonEligibleProceedsIndicator1Choice> getValue(CashOption31 obj) {
			return obj.getNonEligibleProceedsIndicator();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<NonEligibleProceedsIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption31, Optional<IssuerTaxability1Code>> mmIssuerOfferorTaxabilityIndicator = new MMMessageAttribute<CashOption31, Optional<IssuerTaxability1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmIssuerOfferorTaxabilityIndicator);
			previousVersion_lazy = () -> CashOption25.mmIssuerOfferorTaxabilityIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<IssuerTaxability1Code> getValue(CashOption31 obj) {
			return obj.getIssuerOfferorTaxabilityIndicator();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<IssuerTaxability1Code> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CashOption25#mmIncomeType
	 * CashOption25.mmIncomeType}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<GenericIdentification20>> mmIncomeType = new MMMessageAssociationEnd<CashOption31, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmIncomeType);
			previousVersion_lazy = () -> CashOption25.mmIncomeType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(CashOption31 obj) {
			return obj.getIncomeType();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, List<GenericIdentification20>> mmExemptionType = new MMMessageAssociationEnd<CashOption31, List<GenericIdentification20>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption31.mmObject();
			isDerived = false;
			xmlTag = "XmptnTp";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmExemptionType);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification20.mmObject();
		}
		...
		@Override
		public List<GenericIdentification20> getValue(CashOption31 obj) {
			return obj.getExemptionType();
		}

		@Override
		public void setValue(CashOption31 obj, List<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<CashAccountIdentification5Choice>> mmCashAccountIdentification = new MMMessageAssociationEnd<CashOption31, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmCashAccountIdentification);
			previousVersion_lazy = () -> CashOption25.mmCashAccountIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(CashOption31 obj) {
			return obj.getCashAccountIdentification();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<CashAccountIdentification5Choice> value) {
			obj.setCashAccountIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "AmtDtls")
	protected CorporateActionAmounts28 amountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<CorporateActionAmounts28>> mmAmountDetails = new MMMessageAssociationEnd<CashOption31, Optional<CorporateActionAmounts28>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmAmountDetails);
			previousVersion_lazy = () -> CashOption25.mmAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionAmounts28.mmObject();
		}

		@Override
		public Optional<CorporateActionAmounts28> getValue(CashOption31 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<CorporateActionAmounts28> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CashOption25#mmDateDetails
	 * CashOption25.mmDateDetails}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, CorporateActionDate23> mmDateDetails = new MMMessageAssociationEnd<CashOption31, CorporateActionDate23>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption31.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmDateDetails);
			previousVersion_lazy = () -> CashOption25.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionDate23 getValue(CashOption31 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CashOption31 obj, CorporateActionDate23 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<ForeignExchangeTerms13>> mmForeignExchangeDetails = new MMMessageAssociationEnd<CashOption31, Optional<ForeignExchangeTerms13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmForeignExchangeDetails);
			previousVersion_lazy = () -> CashOption25.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ForeignExchangeTerms13> getValue(CashOption31 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<ForeignExchangeTerms13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<RateDetails14>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CashOption31, Optional<RateDetails14>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption31.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmRateAndAmountDetails);
			previousVersion_lazy = () -> CashOption25.mmRateAndAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateDetails14> getValue(CashOption31 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<RateDetails14> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption31, Optional<PriceDetails15>> mmPriceDetails = new MMMessageAssociationEnd<CashOption31, Optional<PriceDetails15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashOption42.mmPriceDetails);
			previousVersion_lazy = () -> CashOption25.mmPriceDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceDetails15> getValue(CashOption31 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CashOption31 obj, Optional<PriceDetails15> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOption31.mmCreditDebitIndicator, com.tools20022.repository.msg.CashOption31.mmContractualPaymentIndicator,
						com.tools20022.repository.msg.CashOption31.mmNonEligibleProceedsIndicator, com.tools20022.repository.msg.CashOption31.mmIssuerOfferorTaxabilityIndicator, com.tools20022.repository.msg.CashOption31.mmIncomeType,
						com.tools20022.repository.msg.CashOption31.mmExemptionType, com.tools20022.repository.msg.CashOption31.mmCashAccountIdentification, com.tools20022.repository.msg.CashOption31.mmAmountDetails,
						com.tools20022.repository.msg.CashOption31.mmDateDetails, com.tools20022.repository.msg.CashOption31.mmForeignExchangeDetails, com.tools20022.repository.msg.CashOption31.mmRateAndAmountDetails,
						com.tools20022.repository.msg.CashOption31.mmPriceDetails);
				trace_lazy = () -> CashProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCashOption31,
						com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption31);
				...
				nextVersions_lazy = () -> Arrays.asList(CashOption42.mmObject());
				previousVersion_lazy = () -> CashOption25.mmObject();
			}
		});
	...
	public CashOption31 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption31 setContractualPaymentIndicator(Payment1Code contractualPaymentIndicator) {
	...
	public CashOption31 setNonEligibleProceedsIndicator(NonEligibleProceedsIndicator1Choice nonEligibleProceedsIndicator) {
	...
	public CashOption31 setIssuerOfferorTaxabilityIndicator(IssuerTaxability1Code issuerOfferorTaxabilityIndicator) {
	...
	public CashOption31 setIncomeType(GenericIdentification20 incomeType) {
	...
	public CashOption31 setExemptionType(List<GenericIdentification20> exemptionType) {
	...
	public CashOption31 setCashAccountIdentification(CashAccountIdentification5Choice cashAccountIdentification) {
		this.cashAccountIdentification = cashAccountIdentification;
		return this;
	}

	public Optional<CorporateActionAmounts28> getAmountDetails() {
		return amountDetails == null ? Optional.empty() : Optional.of(amountDetails);
	}

	public CashOption31 setAmountDetails(CorporateActionAmounts28 amountDetails) {
	...
	public CashOption31 setDateDetails(CorporateActionDate23 dateDetails) {
	...
	public CashOption31 setForeignExchangeDetails(ForeignExchangeTerms13 foreignExchangeDetails) {
	...
	public CashOption31 setRateAndAmountDetails(RateDetails14 rateAndAmountDetails) {
	...
	public CashOption31 setPriceDetails(PriceDetails15 priceDetails) {
