...
public class CashOption31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption31.mmCreditDebitIndicator, CashOption31.mmContractualPaymentIndicator, CashOption31.mmNonEligibleProceedsIndicator, CashOption31.mmIssuerOfferorTaxabilityIndicator,
						CashOption31.mmIncomeType, CashOption31.mmExemptionType, CashOption31.mmCashAccountIdentification, CashOption31.mmAmountDetails, CashOption31.mmDateDetails, CashOption31.mmForeignExchangeDetails,
						CashOption31.mmRateAndAmountDetails, CashOption31.mmPriceDetails);
