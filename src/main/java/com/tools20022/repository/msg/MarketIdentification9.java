...
public class MarketIdentification9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification9.Identification, com.tools20022.repository.msg.MarketIdentification9.Type);
