...
public class ReferredDocumentInformation3 {
	...
	public static final MMMessageAssociationEnd Type = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentLineIdentification1.Type, com.tools20022.repository.msg.ReferredDocumentInformation4.Type,
					com.tools20022.repository.msg.ReferredDocumentInformation6.Type);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Number = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentLineIdentification1.Number, com.tools20022.repository.msg.ReferredDocumentInformation4.Number,
					com.tools20022.repository.msg.ReferredDocumentInformation6.Number);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RelatedDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentLineIdentification1.RelatedDate, com.tools20022.repository.msg.ReferredDocumentInformation4.RelatedDate,
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReferredDocumentInformation3.Type, com.tools20022.repository.msg.ReferredDocumentInformation3.Number,
						com.tools20022.repository.msg.ReferredDocumentInformation3.RelatedDate);
