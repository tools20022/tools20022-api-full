...
public class PartyIdentificationAndAccount24 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount24.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount24.mmIdentification, PartyIdentificationAndAccount24.mmCashAccount, PartyIdentificationAndAccount24.mmProcessingIdentification,
						PartyIdentificationAndAccount24.mmAdditionalInformation, PartyIdentificationAndAccount24.mmAlternateIdentification);
	...
	public void setIdentification(PartyIdentification31Choice identification) {
