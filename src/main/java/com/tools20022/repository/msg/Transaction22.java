...
public class Transaction22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction22.mmAccountOwnerTransactionIdentification, Transaction22.mmAccountServicerTransactionIdentification, Transaction22.mmMarketInfrastructureTransactionIdentification,
						Transaction22.mmProcessorTransactionIdentification, Transaction22.mmTradeIdentification, Transaction22.mmPoolIdentification, Transaction22.mmCommonIdentification, Transaction22.mmCorporateActionEventIdentification,
						Transaction22.mmTripartyAgentCollateralTransactionIdentification, Transaction22.mmClientTripartyCollateralTransactionIdentification, Transaction22.mmTransactionDetails, Transaction22.mmStatusAndReason);
