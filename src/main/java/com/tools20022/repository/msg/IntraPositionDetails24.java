...
public class IntraPositionDetails24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails24.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails24.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails24.IntraPositionMovement);
