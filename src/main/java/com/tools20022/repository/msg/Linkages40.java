 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Linkages21
 * Linkages21}</li>
 * </ul>
 */
public class Linkages40 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Linkages21#mmReference
	...
	public static final MMMessageAssociationEnd mmReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Linkages21.mmReference;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> Linkages21.mmObject();
			}
		});
