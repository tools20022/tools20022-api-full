...
public class AccountIdentification20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification20.mmSafekeepingAccount, AccountIdentification20.mmAccountOwner, AccountIdentification20.mmSafekeepingPlace, AccountIdentification20.mmConfirmedBalance);
