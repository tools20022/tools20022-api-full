...
public class CorporateActionEventAndBalance12 {
	...
	public static final MMMessageAssociationEnd mmGeneralInformation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventAndBalance12.mmObject();
			isDerived = false;
			xmlTag = "GnlInf";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance12.mmGeneralInformation, CorporateActionEventAndBalance12.mmUnderlyingSecurity, CorporateActionEventAndBalance12.mmBalance,
						CorporateActionEventAndBalance12.mmSupplementaryData);
	...
	public void setGeneralInformation(com.tools20022.repository.msg.EventInformation10 generalInformation) {
