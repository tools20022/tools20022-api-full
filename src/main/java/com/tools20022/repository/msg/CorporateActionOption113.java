...
public class CorporateActionOption113 {
	...
	public static final MMMessageAssociationEnd mmOptionNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption113.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	protected List<com.tools20022.repository.msg.CashOption41> cashMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmCashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashOption41.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption113.mmOptionNumber, CorporateActionOption113.mmOptionType, CorporateActionOption113.mmOptionFeatures, CorporateActionOption113.mmFractionDisposition,
						CorporateActionOption113.mmCurrencyOption, CorporateActionOption113.mmDateDetails, CorporateActionOption113.mmPeriodDetails, CorporateActionOption113.mmRateAndAmountDetails, CorporateActionOption113.mmPriceDetails,
						CorporateActionOption113.mmPlaceOfTrade, CorporateActionOption113.mmSecuritiesMovementDetails, CorporateActionOption113.mmCashMovementDetails);
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption41> cashMovementDetails) {
