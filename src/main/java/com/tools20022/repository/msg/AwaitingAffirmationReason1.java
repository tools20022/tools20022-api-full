...
public class AwaitingAffirmationReason1 {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AwaitingAffirmationReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AwaitingAffirmationReason1.mmCode, AwaitingAffirmationReason1.mmAdditionalReasonInformation);
	...
	public void setCode(AwaitingAffirmationReason1Choice code) {
		this.code = code;
	}
