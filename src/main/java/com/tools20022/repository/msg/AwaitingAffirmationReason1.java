...
import com.tools20022.repository.choice.AwaitingAffirmationReason1Choice;
...
@XmlType(name = "AwaitingAffirmationReason1", propOrder = {"code", "additionalReasonInformation"})
public class AwaitingAffirmationReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AwaitingAffirmationReason1Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AwaitingAffirmationReason1
	 * AwaitingAffirmationReason1}</li>
	...
	public static final MMMessageAttribute<AwaitingAffirmationReason1, AwaitingAffirmationReason1Choice> mmCode = new MMMessageAttribute<AwaitingAffirmationReason1, AwaitingAffirmationReason1Choice>() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the trade is wainting the affirmation.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AwaitingAffirmationReason1.mmCode, com.tools20022.repository.msg.AwaitingAffirmationReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AwaitingAffirmationReason1";
	...
	public AwaitingAffirmationReason1Choice getCode() {
		return code;
	}

	public AwaitingAffirmationReason1 setCode(AwaitingAffirmationReason1Choice code) {
	...
	public AwaitingAffirmationReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
