...
import com.tools20022.repository.choice.PendingReason9Choice;
...
@XmlType(name = "PendingReason3", propOrder = {"code", "additionalReasonInformation"})
public class PendingReason3 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PendingReason9Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PendingReason3 PendingReason3}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingReason3, PendingReason9Choice> mmCode = new MMMessageAssociationEnd<PendingReason3, PendingReason9Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingReason3.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PendingReason9Choice getValue(PendingReason3 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason3 obj, PendingReason9Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason3, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingReason3, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(PendingReason3 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingReason3 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingReason3.mmCode, com.tools20022.repository.msg.PendingReason3.mmAdditionalReasonInformation);
	...
	public PendingReason9Choice getCode() {
		return code;
	}

	public PendingReason3 setCode(PendingReason9Choice code) {
	...
	public PendingReason3 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
