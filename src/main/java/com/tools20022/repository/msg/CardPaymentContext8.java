...
import com.tools20022.repository.msg.PaymentContext8;
...
@XmlType(name = "CardPaymentContext8", propOrder = {"paymentContext", "saleContext"})
public class CardPaymentContext8 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "PmtCntxt", required = true)
	protected PaymentContext8 paymentContext;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.PaymentContext8
	 * PaymentContext8}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext8, PaymentContext8> mmPaymentContext = new MMMessageAssociationEnd<CardPaymentContext8, PaymentContext8>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext8.mmObject();
			isDerived = false;
			xmlTag = "PmtCntxt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PaymentContext";
			definition = "Context of the card payment transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext14.mmPaymentContext);
			previousVersion_lazy = () -> CardPaymentContext5.mmPaymentContext;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PaymentContext8.mmObject();
		}

		@Override
		public PaymentContext8 getValue(CardPaymentContext8 obj) {
			return obj.getPaymentContext();
		}

		@Override
		public void setValue(CardPaymentContext8 obj, PaymentContext8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext8, Optional<SaleContext1>> mmSaleContext = new MMMessageAssociationEnd<CardPaymentContext8, Optional<SaleContext1>>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext14.mmSaleContext);
			previousVersion_lazy = () -> CardPaymentContext5.mmSaleContext;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SaleContext1> getValue(CardPaymentContext8 obj) {
			return obj.getSaleContext();
		}

		@Override
		public void setValue(CardPaymentContext8 obj, Optional<SaleContext1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext8.mmPaymentContext, com.tools20022.repository.msg.CardPaymentContext8.mmSaleContext);
				trace_lazy = () -> CardPaymentAcquiring.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentContext8";
				definition = "Context in which the transaction is performed (payment and sale).";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentContext14.mmObject());
				previousVersion_lazy = () -> CardPaymentContext5.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public PaymentContext8 getPaymentContext() {
		return paymentContext;
	}

	public CardPaymentContext8 setPaymentContext(PaymentContext8 paymentContext) {
	...
	public CardPaymentContext8 setSaleContext(SaleContext1 saleContext) {
