 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrumentAttributesSD8#OriginatingSecurityIdentification
 * FinancialInstrumentAttributesSD8.OriginatingSecurityIdentification}</li>
 * </ul>
 * </li>
 * <li>
...
public class FinancialInstrumentAttributesSD8 {
	...
	public static final MMMessageAttribute PlaceAndName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> FinancialInstrumentAttributesSD8.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "xPath to the element that is being extended.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.PlaceAndName;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CountryOfListing = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.CountryOfListing;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IncomeSourceCountry = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.IncomeSourceCountry;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	...
	public static final MMMessageAttribute DTCAssetClass = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.DTCAssetClass;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute DTCAssetType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.DTCAssetType;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecurityEligibilityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.SecurityEligibilityIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TickerSymbol = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.TickerSymbol;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LinkedSecurity = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributesSD6.LinkedSecurity;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.PlaceAndName, com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.CountryOfListing,
						com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.IncomeSourceCountry, com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.DTCAssetClass,
						com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.DTCAssetType, com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.SecurityEligibilityIndicator,
						com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.TickerSymbol, com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.LinkedSecurity,
						com.tools20022.repository.msg.FinancialInstrumentAttributesSD8.OriginatingSecurityIdentification);
