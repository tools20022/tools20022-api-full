...
public class CorporateActionEventAndBalance10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance10.mmGeneralInformation, CorporateActionEventAndBalance10.mmUnderlyingSecurity, CorporateActionEventAndBalance10.mmBalance,
						CorporateActionEventAndBalance10.mmSupplementaryData);
