...
public class PartyIdentificationAndAccount55 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount55.mmIdentification, PartyIdentificationAndAccount55.mmAlternateIdentification, PartyIdentificationAndAccount55.mmCashAccount,
						PartyIdentificationAndAccount55.mmChargesAccount, PartyIdentificationAndAccount55.mmCommissionAccount, PartyIdentificationAndAccount55.mmTaxAccount, PartyIdentificationAndAccount55.mmAdditionalInformation);
