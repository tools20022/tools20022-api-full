...
public class AccountAndBalance32 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance32.mmSafekeepingAccount, AccountAndBalance32.mmAccountOwner, AccountAndBalance32.mmSafekeepingPlace, AccountAndBalance32.mmBalance);
