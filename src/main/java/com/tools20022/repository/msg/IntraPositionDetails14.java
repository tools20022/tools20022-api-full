...
public class IntraPositionDetails14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails14.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails14.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails14.IntraPositionMovement);
