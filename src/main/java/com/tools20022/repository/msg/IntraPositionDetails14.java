...
public class IntraPositionDetails14 {
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionDetails14.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlc";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails14.mmSafekeepingPlace, IntraPositionDetails14.mmBalanceFrom, IntraPositionDetails14.mmIntraPositionMovement);
	...
	public void setIntraPositionMovement(List<com.tools20022.repository.msg.IntraPositionMovementDetails4> intraPositionMovement) {
