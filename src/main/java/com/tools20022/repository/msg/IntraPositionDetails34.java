...
@XmlType(name = "IntraPositionDetails34", propOrder = {"settledQuantity", "securitiesSubBalanceIdentification", "collateralMonitorAmount", "previouslySettledQuantity", "remainingToBeSettledQuantity", "settlementDate", "availableDate",
...
public class IntraPositionDetails34 {
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, FinancialInstrumentQuantity1Choice> mmSettledQuantity = new MMMessageAssociationEnd<IntraPositionDetails34, FinancialInstrumentQuantity1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmSettledQuantity);
			previousVersion_lazy = () -> IntraPositionDetails27.mmSettledQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<GenericIdentification37>> mmSecuritiesSubBalanceIdentification = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<GenericIdentification37>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmSecuritiesSubBalanceIdentification);
			previousVersion_lazy = () -> IntraPositionDetails27.mmSecuritiesSubBalanceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<AmountAndDirection44>> mmCollateralMonitorAmount = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<AmountAndDirection44>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmCollateralMonitorAmount);
			previousVersion_lazy = () -> IntraPositionDetails27.mmCollateralMonitorAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<FinancialInstrumentQuantity1Choice>> mmPreviouslySettledQuantity = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmPreviouslySettledQuantity);
			previousVersion_lazy = () -> IntraPositionDetails27.mmPreviouslySettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<FinancialInstrumentQuantity1Choice>> mmRemainingToBeSettledQuantity = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			definition = "Quantity of financial instrument remaining to be settled.";
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmRemainingToBeSettledQuantity);
			previousVersion_lazy = () -> IntraPositionDetails27.mmRemainingToBeSettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, DateAndDateTimeChoice> mmSettlementDate = new MMMessageAssociationEnd<IntraPositionDetails34, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmSettlementDate);
			previousVersion_lazy = () -> IntraPositionDetails27.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<DateAndDateTimeChoice>> mmAvailableDate = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmAvailableDate);
			previousVersion_lazy = () -> IntraPositionDetails27.mmAvailableDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	...
	public static final MMMessageAssociationEnd<IntraPositionDetails34, Optional<CorporateActionEventType29Choice>> mmCorporateActionEventType = new MMMessageAssociationEnd<IntraPositionDetails34, Optional<CorporateActionEventType29Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmCorporateActionEventType);
			previousVersion_lazy = () -> IntraPositionDetails27.mmCorporateActionEventType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<IntraPositionDetails34, SecuritiesSubBalanceTypeAndQuantityBreakdown3> mmBalanceFrom = new MMMessageAttribute<IntraPositionDetails34, SecuritiesSubBalanceTypeAndQuantityBreakdown3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmBalanceFrom);
	...
	public static final MMMessageAttribute<IntraPositionDetails34, SecuritiesSubBalanceTypeAndQuantityBreakdown3> mmBalanceTo = new MMMessageAttribute<IntraPositionDetails34, SecuritiesSubBalanceTypeAndQuantityBreakdown3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmBalanceTo);
	...
	public static final MMMessageAttribute<IntraPositionDetails34, Optional<Max350Text>> mmInstructionProcessingAdditionalDetails = new MMMessageAttribute<IntraPositionDetails34, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails41.mmInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> IntraPositionDetails27.mmInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails34.mmSettledQuantity, com.tools20022.repository.msg.IntraPositionDetails34.mmSecuritiesSubBalanceIdentification,
						com.tools20022.repository.msg.IntraPositionDetails34.mmCollateralMonitorAmount, com.tools20022.repository.msg.IntraPositionDetails34.mmPreviouslySettledQuantity,
						com.tools20022.repository.msg.IntraPositionDetails34.mmRemainingToBeSettledQuantity, com.tools20022.repository.msg.IntraPositionDetails34.mmSettlementDate,
						com.tools20022.repository.msg.IntraPositionDetails34.mmAvailableDate, com.tools20022.repository.msg.IntraPositionDetails34.mmCorporateActionEventType,
						com.tools20022.repository.msg.IntraPositionDetails34.mmBalanceFrom, com.tools20022.repository.msg.IntraPositionDetails34.mmBalanceTo,
						com.tools20022.repository.msg.IntraPositionDetails34.mmInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementConfirmationV05.mmIntraPositionDetails);
				trace_lazy = () -> IntraPositionTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forIntraPositionDetails34,
						com.tools20022.repository.constraints.ConstraintBalanceFromToRule.forIntraPositionDetails34);
	...
	public IntraPositionDetails34 setSettledQuantity(FinancialInstrumentQuantity1Choice settledQuantity) {
	...
	public IntraPositionDetails34 setPreviouslySettledQuantity(FinancialInstrumentQuantity1Choice previouslySettledQuantity) {
	...
	public IntraPositionDetails34 setRemainingToBeSettledQuantity(FinancialInstrumentQuantity1Choice remainingToBeSettledQuantity) {
	...
	public IntraPositionDetails34 setSettlementDate(DateAndDateTimeChoice settlementDate) {
	...
	public IntraPositionDetails34 setAvailableDate(DateAndDateTimeChoice availableDate) {
	...
	public IntraPositionDetails34 setCorporateActionEventType(CorporateActionEventType29Choice corporateActionEventType) {
	...
	public IntraPositionDetails34 setInstructionProcessingAdditionalDetails(Max350Text instructionProcessingAdditionalDetails) {
