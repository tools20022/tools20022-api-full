...
public class ForeignExchangeTerms31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms31.mmUnitCurrency, ForeignExchangeTerms31.mmQuotedCurrency, ForeignExchangeTerms31.mmExchangeRate, ForeignExchangeTerms31.mmQuotationDate,
						ForeignExchangeTerms31.mmQuotingInstitution);
