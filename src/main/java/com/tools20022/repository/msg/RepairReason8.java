 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.RepairReason1
 * RepairReason1}</li>
 * </ul>
 */
public class RepairReason8 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.RepairReason1#mmCode
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RepairReason1.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RepairReason1.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> RepairReason1.mmObject();
			}
		});
