...
public class QuantityAndAccount34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount34.mmSettlementQuantity, QuantityAndAccount34.mmDenominationChoice, QuantityAndAccount34.mmAccountOwner, QuantityAndAccount34.mmSafekeepingAccount,
						QuantityAndAccount34.mmCashAccount, QuantityAndAccount34.mmSafekeepingPlace, QuantityAndAccount34.mmQuantityBreakdown);
