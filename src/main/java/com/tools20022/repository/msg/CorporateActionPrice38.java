...
public class CorporateActionPrice38 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice38, Optional<IndicativeOrMarketPrice5Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice38, Optional<IndicativeOrMarketPrice5Choice>>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionPrice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<IndicativeOrMarketPrice5Choice> getValue(CorporateActionPrice38 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice38 obj, Optional<IndicativeOrMarketPrice5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat19Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat19Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat19Choice> getValue(CorporateActionPrice38 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice38 obj, Optional<PriceFormat19Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice38, Optional<PriceFormat29Choice>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice38, Optional<PriceFormat29Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat29Choice> getValue(CorporateActionPrice38 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice38 obj, Optional<PriceFormat29Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat23Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat23Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat23Choice> getValue(CorporateActionPrice38 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice38 obj, Optional<PriceFormat23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat20Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice38, Optional<PriceFormat20Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat20Choice> getValue(CorporateActionPrice38 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice38 obj, Optional<PriceFormat20Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice38.mmIndicativeOrMarketPrice, com.tools20022.repository.msg.CorporateActionPrice38.mmCashInLieuOfSharePrice,
						com.tools20022.repository.msg.CorporateActionPrice38.mmCashValueForTax, com.tools20022.repository.msg.CorporateActionPrice38.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice38.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice38);
	...
	public CorporateActionPrice38 setIndicativeOrMarketPrice(IndicativeOrMarketPrice5Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice38 setCashInLieuOfSharePrice(PriceFormat19Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice38 setCashValueForTax(PriceFormat29Choice cashValueForTax) {
	...
	public CorporateActionPrice38 setGenericCashPricePaidPerProduct(PriceFormat23Choice genericCashPricePaidPerProduct) {
		this.genericCashPricePaidPerProduct = genericCashPricePaidPerProduct;
		return this;
	}

	public Optional<PriceFormat20Choice> getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct == null ? Optional.empty() : Optional.of(genericCashPriceReceivedPerProduct);
	}

	public CorporateActionPrice38 setGenericCashPriceReceivedPerProduct(PriceFormat20Choice genericCashPriceReceivedPerProduct) {
