...
public class CardPaymentTransaction13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction13.mmTransactionCapture, CardPaymentTransaction13.mmTransactionType, CardPaymentTransaction13.mmAdditionalService, CardPaymentTransaction13.mmServiceAttribute,
						CardPaymentTransaction13.mmMerchantCategoryCode, CardPaymentTransaction13.mmTransactionIdentification, CardPaymentTransaction13.mmOriginalTransaction, CardPaymentTransaction13.mmTransactionSuccess,
						CardPaymentTransaction13.mmReversal, CardPaymentTransaction13.mmMerchantOverride, CardPaymentTransaction13.mmFailureReason, CardPaymentTransaction13.mmInitiatorTransactionIdentification,
						CardPaymentTransaction13.mmRecipientTransactionIdentification, CardPaymentTransaction13.mmReconciliationIdentification, CardPaymentTransaction13.mmInterchangeData, CardPaymentTransaction13.mmTransactionDetails,
						CardPaymentTransaction13.mmAuthorisationResult, CardPaymentTransaction13.mmTransactionVerificationResult, CardPaymentTransaction13.mmAdditionalTransactionData);
