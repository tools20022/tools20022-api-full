 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CashOption50
 * CashOption50}</li>
 * </ul>
 */
...
public class CashOption56 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmNonEligibleProceedsIndicator = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmNonEligibleProceedsIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmIssuerOfferorTaxabilityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmIssuerOfferorTaxabilityIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CashOption50#mmIncomeType
	...
	public static final MMMessageAssociationEnd mmIncomeType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmIncomeType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmExemptionType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmExemptionType;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.GenericIdentification30.mmObject();
		}
	...
	public static final MMMessageAttribute mmCountryOfIncomeSource = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmCountryOfIncomeSource;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCashAccountIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmCashAccountIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionAmounts42.mmObject();
		}
	};
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CashOption50#mmDateDetails
	...
	public static final MMMessageAssociationEnd mmDateDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRateAndAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmRateAndAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CashOption50.mmPriceDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CashOption50.mmObject();
			}
		});
	...
	public CashOption56 setIncomeType(com.tools20022.repository.msg.GenericIdentification30 incomeType) {
	...
	public CashOption56 setExemptionType(List<com.tools20022.repository.msg.GenericIdentification30> exemptionType) {
	...
	public CashOption56 setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts42 amountDetails) {
	...
	public CashOption56 setDateDetails(com.tools20022.repository.msg.CorporateActionDate62 dateDetails) {
	...
	public CashOption56 setForeignExchangeDetails(com.tools20022.repository.msg.ForeignExchangeTerms24 foreignExchangeDetails) {
	...
	public CashOption56 setRateAndAmountDetails(com.tools20022.repository.msg.RateDetails31 rateAndAmountDetails) {
	...
	public CashOption56 setPriceDetails(com.tools20022.repository.msg.PriceDetails22 priceDetails) {
