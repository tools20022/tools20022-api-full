...
public class AggregateBalanceInformation9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation9.mmFinancialInstrumentIdentification, AggregateBalanceInformation9.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation9.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation9.mmValuationHaircutDetails, AggregateBalanceInformation9.mmAggregateBalance,
						AggregateBalanceInformation9.mmAvailableBalance, AggregateBalanceInformation9.mmNotAvailableBalance, AggregateBalanceInformation9.mmSafekeepingPlace, AggregateBalanceInformation9.mmCorporateActionOptionType,
						AggregateBalanceInformation9.mmPriceDetails, AggregateBalanceInformation9.mmForeignExchangeDetails, AggregateBalanceInformation9.mmDaysAccrued, AggregateBalanceInformation9.mmAccountBaseCurrencyAmounts,
						AggregateBalanceInformation9.mmInstrumentCurrencyAmounts, AggregateBalanceInformation9.mmQuantityBreakdown, AggregateBalanceInformation9.mmBalanceBreakdown, AggregateBalanceInformation9.mmAdditionalBalanceBreakdown,
						AggregateBalanceInformation9.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation9.mmHoldingAdditionalDetails, AggregateBalanceInformation9.mmExtension);
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace8> balanceAtSafekeepingPlace) {
