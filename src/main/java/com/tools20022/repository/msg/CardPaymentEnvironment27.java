	...
	public static final MMMessageAssociationEnd mmAcquirer = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CardPaymentEnvironment27.mmObject();
			isDerived = false;
			xmlTag = "Acqrr";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Acquirer";
			definition = "Acquirer involved in the card payment.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmAcquirer);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.mmAcquirer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmMerchant = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmMerchant);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.mmMerchant;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPOI = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmPOI);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.mmPOI;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCard = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmCard);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.mmCard;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmCardholder = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmCardholder);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.mmCardholder;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmProtectedCardholderData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.mmProtectedCardholderData);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
