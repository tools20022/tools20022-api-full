 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment27#POI
 * CardPaymentEnvironment27.POI}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment27#Card
...
public class CardPaymentEnvironment27 {
	...
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.Acquirer;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.Acquirer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Merchant = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.Merchant;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.Merchant);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POI = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.POI;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.POI);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Card = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.Card;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.Card);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Cardholder = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment14.Cardholder;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.Cardholder);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProtectedCardholderData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment40.ProtectedCardholderData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment27.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment27.Merchant,
						com.tools20022.repository.msg.CardPaymentEnvironment27.POI, com.tools20022.repository.msg.CardPaymentEnvironment27.Card, com.tools20022.repository.msg.CardPaymentEnvironment27.Cardholder,
						com.tools20022.repository.msg.CardPaymentEnvironment27.ProtectedCardholderData);
