...
public class CashOption9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption9.mmCreditDebitIndicator, CashOption9.mmContractualPaymentIndicator, CashOption9.mmIncomeType, CashOption9.mmAccount, CashOption9.mmCashParties,
						CashOption9.mmAmountDetails, CashOption9.mmDateDetails, CashOption9.mmForeignExchangeDetails, CashOption9.mmGenericCashPriceReceivedPerProduct, CashOption9.mmTaxVoucherDetails);
	...
	public CashParties5 getCashParties() {
		return cashParties;
	}

	public void setCashParties(com.tools20022.repository.msg.CashParties5 cashParties) {
	...
	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts5 amountDetails) {
