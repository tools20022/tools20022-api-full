 ...
 * <li>{@linkplain com.tools20022.repository.msg.Linkages51#mmReferenceOwner
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Linkages26
 * Linkages26}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Linkages51", propOrder = {"processingPosition", "messageNumber", "reference", "referenceOwner"})
public class Linkages51 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Linkages51
	 * Linkages51}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Linkages51, Optional<ProcessingPosition7Choice>> mmProcessingPosition = new MMMessageAttribute<Linkages51, Optional<ProcessingPosition7Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages51.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
			...
			previousVersion_lazy = () -> Linkages26.mmProcessingPosition;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ProcessingPosition7Choice> getValue(Linkages51 obj) {
			return obj.getProcessingPosition();
		}

		@Override
		public void setValue(Linkages51 obj, Optional<ProcessingPosition7Choice> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Linkages26#mmMessageNumber
	 * Linkages26.mmMessageNumber}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages51, Optional<DocumentNumber5Choice>> mmMessageNumber = new MMMessageAssociationEnd<Linkages51, Optional<DocumentNumber5Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages51.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
			...
			previousVersion_lazy = () -> Linkages26.mmMessageNumber;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DocumentNumber5Choice> getValue(Linkages51 obj) {
			return obj.getMessageNumber();
		}

		@Override
		public void setValue(Linkages51 obj, Optional<DocumentNumber5Choice> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Linkages26#mmReference
	 * Linkages26.mmReference}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages51, References34Choice> mmReference = new MMMessageAssociationEnd<Linkages51, References34Choice>() {
		{
			...
			previousVersion_lazy = () -> Linkages26.mmReference;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public References34Choice getValue(Linkages51 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(Linkages51 obj, References34Choice value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Linkages26#mmReferenceOwner
	 * Linkages26.mmReferenceOwner}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages51, Optional<PartyIdentification92Choice>> mmReferenceOwner = new MMMessageAssociationEnd<Linkages51, Optional<PartyIdentification92Choice>>() {
		{
			...
			previousVersion_lazy = () -> Linkages26.mmReferenceOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification92Choice> getValue(Linkages51 obj) {
			return obj.getReferenceOwner();
		}

		@Override
		public void setValue(Linkages51 obj, Optional<PartyIdentification92Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages51.mmProcessingPosition, com.tools20022.repository.msg.Linkages51.mmMessageNumber, com.tools20022.repository.msg.Linkages51.mmReference,
						com.tools20022.repository.msg.Linkages51.mmReferenceOwner);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Linkages51";
				definition = "Information related to a linked transaction.";
				previousVersion_lazy = () -> Linkages26.mmObject();
			}
		});
	...
	public Linkages51 setProcessingPosition(ProcessingPosition7Choice processingPosition) {
	...
	public Linkages51 setMessageNumber(DocumentNumber5Choice messageNumber) {
	...
	public Linkages51 setReference(References34Choice reference) {
	...
	public Linkages51 setReferenceOwner(PartyIdentification92Choice referenceOwner) {
