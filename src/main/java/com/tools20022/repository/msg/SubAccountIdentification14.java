...
public class SubAccountIdentification14 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification14.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification14.mmAccountOwner, SubAccountIdentification14.mmSafekeepingAccount, SubAccountIdentification14.mmActivityIndicator,
						SubAccountIdentification14.mmFinancialInstrumentDetails);
	...
	public void setFinancialInstrumentDetails(List<com.tools20022.repository.msg.FinancialInstrumentDetails3> financialInstrumentDetails) {
