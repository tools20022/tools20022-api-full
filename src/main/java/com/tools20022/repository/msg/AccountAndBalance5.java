...
public class AccountAndBalance5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance5.mmSafekeepingAccount, AccountAndBalance5.mmAccountOwner, AccountAndBalance5.mmSafekeepingPlace, AccountAndBalance5.mmBalance);
