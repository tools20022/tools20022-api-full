...
import com.tools20022.repository.choice.BalanceQuantity6Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Balance5#mmShortLongIndicator
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forBalance5
 * ConstraintCoexistenceQuantityRule.forBalance5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Balance5", propOrder = {"shortLongIndicator", "quantity"})
public class Balance5 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Balance5
	 * Balance5}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Balance5, Optional<ShortLong1Code>> mmShortLongIndicator = new MMMessageAttribute<Balance5, Optional<ShortLong1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmShortLong;
			componentContext_lazy = () -> com.tools20022.repository.msg.Balance5.mmObject();
			isDerived = false;
			xmlTag = "ShrtLngInd";
		...
		@Override
		public Optional<ShortLong1Code> getValue(Balance5 obj) {
			return obj.getShortLongIndicator();
		}

		@Override
		public void setValue(Balance5 obj, Optional<ShortLong1Code> value) {
			obj.setShortLongIndicator(value.orElse(null));
		}
	};
	@XmlElement(name = "Qty", required = true)
	protected BalanceQuantity6Choice quantity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Balance5, BalanceQuantity6Choice> mmQuantity = new MMMessageAttribute<Balance5, BalanceQuantity6Choice>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> BalanceQuantity6Choice.mmObject();
		}

		@Override
		public BalanceQuantity6Choice getValue(Balance5 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(Balance5 obj, BalanceQuantity6Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Balance5.mmShortLongIndicator, com.tools20022.repository.msg.Balance5.mmQuantity);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forBalance5);
	...
	public Balance5 setShortLongIndicator(ShortLong1Code shortLongIndicator) {
		this.shortLongIndicator = shortLongIndicator;
		return this;
	}

	public BalanceQuantity6Choice getQuantity() {
		return quantity;
	}

	public Balance5 setQuantity(BalanceQuantity6Choice quantity) {
