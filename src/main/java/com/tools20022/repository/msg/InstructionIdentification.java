 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.InstructionIdentification#mmIdentification
 * InstructionIdentification.mmIdentification}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "InstructionIdentification", propOrder = "identification")
public class InstructionIdentification {
	...
	public static final MMMessageAttribute<InstructionIdentification, Max35Text> mmIdentification = new MMMessageAttribute<InstructionIdentification, Max35Text>() {
		{
			...
			name = "Identification";
			definition = "Identification of an instruction.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InstructionIdentification.mmIdentification);
	...
	public InstructionIdentification setIdentification(Max35Text identification) {
