...
public class CardPaymentTransaction46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction46.mmMerchantCategoryCode, CardPaymentTransaction46.mmSaleReferenceIdentification, CardPaymentTransaction46.mmTransactionIdentification,
						CardPaymentTransaction46.mmOriginalTransaction, CardPaymentTransaction46.mmTransactionSuccess, CardPaymentTransaction46.mmReversal, CardPaymentTransaction46.mmFailureReason,
						CardPaymentTransaction46.mmRecipientTransactionIdentification, CardPaymentTransaction46.mmReconciliationIdentification, CardPaymentTransaction46.mmInterchangeData, CardPaymentTransaction46.mmTransactionDetails,
						CardPaymentTransaction46.mmAuthorisationResult, CardPaymentTransaction46.mmAdditionalTransactionData);
