...
import com.tools20022.repository.msg.AuthorisationResult6;
...
@XmlType(name = "CardPaymentTransaction46", propOrder = {"merchantCategoryCode", "saleReferenceIdentification", "transactionIdentification", "originalTransaction", "transactionSuccess", "reversal", "failureReason",
...
public class CardPaymentTransaction46 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<Min3Max4Text>> mmMerchantCategoryCode = new MMMessageAttribute<CardPaymentTransaction46, Optional<Min3Max4Text>>() {
		{
			businessElementTrace_lazy = () -> MerchantRole.mmMerchantCategoryCode;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "MrchntCtgyCd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MerchantCategoryCode";
			definition = "Category code conform to ISO 18245, related to the type of services or goods the merchant provides for the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmMerchantCategoryCode);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Min3Max4Text> getValue(CardPaymentTransaction46 obj) {
			return obj.getMerchantCategoryCode();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<Min3Max4Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction46 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction46, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction46, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction46 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction46, Optional<CardPaymentTransaction37>> mmOriginalTransaction = new MMMessageAssociationEnd<CardPaymentTransaction46, Optional<CardPaymentTransaction37>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmOriginalTransaction);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CardPaymentTransaction37> getValue(CardPaymentTransaction46 obj) {
			return obj.getOriginalTransaction();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<CardPaymentTransaction37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, TrueFalseIndicator> mmTransactionSuccess = new MMMessageAttribute<CardPaymentTransaction46, TrueFalseIndicator>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmTransactionSuccess);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmTransactionSuccess;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TrueFalseIndicator getValue(CardPaymentTransaction46 obj) {
			return obj.getTransactionSuccess();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, TrueFalseIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<TrueFalseIndicator>> mmReversal = new MMMessageAttribute<CardPaymentTransaction46, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmReversal);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmReversal;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(CardPaymentTransaction46 obj) {
			return obj.getReversal();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, List<FailureReason3Code>> mmFailureReason = new MMMessageAttribute<CardPaymentTransaction46, List<FailureReason3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmFailureReason);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmFailureReason;
			minOccurs = 0;
			simpleType_lazy = () -> FailureReason3Code.mmObject();
		}

		@Override
		public List<FailureReason3Code> getValue(CardPaymentTransaction46 obj) {
			return obj.getFailureReason();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, List<FailureReason3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			previousVersion_lazy = () -> CardPaymentTransaction30.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, Optional<Max140Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction46, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(CardPaymentTransaction46 obj) {
			return obj.getInterchangeData();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction46, CardPaymentTransactionDetails9> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction46, CardPaymentTransactionDetails9>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction46.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransactionDetails9 getValue(CardPaymentTransaction46 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, CardPaymentTransactionDetails9 value) {
			obj.setTransactionDetails(value);
		}
	};
	@XmlElement(name = "AuthstnRslt")
	protected AuthorisationResult6 authorisationResult;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction46, Optional<AuthorisationResult6>> mmAuthorisationResult = new MMMessageAssociationEnd<CardPaymentTransaction46, Optional<AuthorisationResult6>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmAuthorisationResult);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmAuthorisationResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AuthorisationResult6> getValue(CardPaymentTransaction46 obj) {
			return obj.getAuthorisationResult();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, Optional<AuthorisationResult6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction46, List<Max70Text>> mmAdditionalTransactionData = new MMMessageAttribute<CardPaymentTransaction46, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxData";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction61.mmAdditionalTransactionData);
			previousVersion_lazy = () -> CardPaymentTransaction30.mmAdditionalTransactionData;
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}

		@Override
		public List<Max70Text> getValue(CardPaymentTransaction46 obj) {
			return obj.getAdditionalTransactionData();
		}

		@Override
		public void setValue(CardPaymentTransaction46 obj, List<Max70Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction46.mmMerchantCategoryCode, com.tools20022.repository.msg.CardPaymentTransaction46.mmSaleReferenceIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction46.mmTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction46.mmOriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction46.mmTransactionSuccess, com.tools20022.repository.msg.CardPaymentTransaction46.mmReversal, com.tools20022.repository.msg.CardPaymentTransaction46.mmFailureReason,
						com.tools20022.repository.msg.CardPaymentTransaction46.mmRecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction46.mmReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction46.mmInterchangeData, com.tools20022.repository.msg.CardPaymentTransaction46.mmTransactionDetails,
						com.tools20022.repository.msg.CardPaymentTransaction46.mmAuthorisationResult, com.tools20022.repository.msg.CardPaymentTransaction46.mmAdditionalTransactionData);
	...
	public CardPaymentTransaction46 setMerchantCategoryCode(Min3Max4Text merchantCategoryCode) {
	...
	public CardPaymentTransaction46 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction46 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction46 setOriginalTransaction(CardPaymentTransaction37 originalTransaction) {
	...
	public CardPaymentTransaction46 setTransactionSuccess(TrueFalseIndicator transactionSuccess) {
	...
	public CardPaymentTransaction46 setReversal(TrueFalseIndicator reversal) {
	...
	public CardPaymentTransaction46 setFailureReason(List<FailureReason3Code> failureReason) {
	...
	public CardPaymentTransaction46 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction46 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction46 setInterchangeData(Max140Text interchangeData) {
	...
	public CardPaymentTransaction46 setTransactionDetails(CardPaymentTransactionDetails9 transactionDetails) {
		this.transactionDetails = Objects.requireNonNull(transactionDetails);
		return this;
	}

	public Optional<AuthorisationResult6> getAuthorisationResult() {
		return authorisationResult == null ? Optional.empty() : Optional.of(authorisationResult);
	}

	public CardPaymentTransaction46 setAuthorisationResult(AuthorisationResult6 authorisationResult) {
	...
	public CardPaymentTransaction46 setAdditionalTransactionData(List<Max70Text> additionalTransactionData) {
