...
public class CorporateActionPrice35 {
	...
	public static final MMMessageAssociationEnd IndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateActionPrice35.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice35.IndicativeOrMarketPrice, com.tools20022.repository.msg.CorporateActionPrice35.IssuePrice,
						com.tools20022.repository.msg.CorporateActionPrice35.GenericCashPriceReceivedPerProduct, com.tools20022.repository.msg.CorporateActionPrice35.GenericCashPricePaidPerProduct);
