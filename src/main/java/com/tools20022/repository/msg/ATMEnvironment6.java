	...
	public static final MMMessageAssociationEnd mmAcquirer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ATMEnvironment3.mmAcquirer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmATMManagerIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMEnvironment3.mmATMManagerIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmHostingEntity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ATMEnvironment3.mmHostingEntity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmATM = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ATMEnvironment3.mmATM;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
