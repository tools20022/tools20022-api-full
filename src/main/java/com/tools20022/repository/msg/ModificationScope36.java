...
public class ModificationScope36 {
	...
	public static final MMMessageAttribute mmModificationScopeIndication = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ModificationScope29.mmModificationScopeIndication;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ModificationScope29.mmFinancialInstrumentDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public ModificationScope36 setFinancialInstrumentDetails(com.tools20022.repository.msg.FinancialInstrument56 financialInstrumentDetails) {
