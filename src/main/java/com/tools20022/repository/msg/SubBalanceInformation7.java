...
public class SubBalanceInformation7 {
	...
	public static final MMMessageAssociationEnd mmSubBalanceType = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubBalanceInformation7.mmObject();
			isDerived = false;
			xmlTag = "SubBalTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation7.mmSubBalanceType, SubBalanceInformation7.mmQuantity, SubBalanceInformation7.mmSubBalanceAdditionalDetails,
						SubBalanceInformation7.mmAdditionalBalanceBreakdownDetails);
	...
	public void setAdditionalBalanceBreakdownDetails(List<com.tools20022.repository.msg.AdditionalBalanceInformation7> additionalBalanceBreakdownDetails) {
