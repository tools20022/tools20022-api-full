...
import com.tools20022.repository.msg.AdditionalBalanceInformation7;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubBalanceInformation7#mmSubBalanceAdditionalDetails
 * SubBalanceInformation7.mmSubBalanceAdditionalDetails}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSubBalanceAdditionalDetailsRule#forSubBalanceInformation7
 * ConstraintSubBalanceAdditionalDetailsRule.forSubBalanceInformation7}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAvailableWithNoStatusRule#forSubBalanceInformation7
 * ConstraintAvailableWithNoStatusRule.forSubBalanceInformation7}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forSubBalanceInformation7
 * ConstraintCoexistenceQuantityRule.forSubBalanceInformation7}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SubBalanceInformation7", propOrder = {"subBalanceType", "quantity", "subBalanceAdditionalDetails", "additionalBalanceBreakdownDetails"})
public class SubBalanceInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubBalanceInformation7, SubBalanceType7Choice> mmSubBalanceType = new MMMessageAssociationEnd<SubBalanceInformation7, SubBalanceType7Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmSecuritiesBalanceType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SubBalanceInformation7.mmObject();
			isDerived = false;
			xmlTag = "SubBalTp";
		...
		@Override
		public SubBalanceType7Choice getValue(SubBalanceInformation7 obj) {
			return obj.getSubBalanceType();
		}

		@Override
		public void setValue(SubBalanceInformation7 obj, SubBalanceType7Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubBalanceInformation7, SubBalanceQuantity4Choice> mmQuantity = new MMMessageAssociationEnd<SubBalanceInformation7, SubBalanceQuantity4Choice>() {
		{
		...
		@Override
		public SubBalanceQuantity4Choice getValue(SubBalanceInformation7 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(SubBalanceInformation7 obj, SubBalanceQuantity4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubBalanceInformation7, Optional<RestrictedFINXMax140Text>> mmSubBalanceAdditionalDetails = new MMMessageAttribute<SubBalanceInformation7, Optional<RestrictedFINXMax140Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SubBalanceInformation7.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<RestrictedFINXMax140Text> getValue(SubBalanceInformation7 obj) {
			return obj.getSubBalanceAdditionalDetails();
		}

		@Override
		public void setValue(SubBalanceInformation7 obj, Optional<RestrictedFINXMax140Text> value) {
			obj.setSubBalanceAdditionalDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "AddtlBalBrkdwnDtls")
	protected List<AdditionalBalanceInformation7> additionalBalanceBreakdownDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubBalanceInformation7, List<AdditionalBalanceInformation7>> mmAdditionalBalanceBreakdownDetails = new MMMessageAssociationEnd<SubBalanceInformation7, List<AdditionalBalanceInformation7>>() {
		{
		...
		@Override
		public List<AdditionalBalanceInformation7> getValue(SubBalanceInformation7 obj) {
			return obj.getAdditionalBalanceBreakdownDetails();
		}

		@Override
		public void setValue(SubBalanceInformation7 obj, List<AdditionalBalanceInformation7> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubBalanceInformation7.mmSubBalanceType, com.tools20022.repository.msg.SubBalanceInformation7.mmQuantity,
						com.tools20022.repository.msg.SubBalanceInformation7.mmSubBalanceAdditionalDetails, com.tools20022.repository.msg.SubBalanceInformation7.mmAdditionalBalanceBreakdownDetails);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSubBalanceAdditionalDetailsRule.forSubBalanceInformation7,
						com.tools20022.repository.constraints.ConstraintAvailableWithNoStatusRule.forSubBalanceInformation7, com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forSubBalanceInformation7);
	...
	public SubBalanceInformation7 setSubBalanceType(SubBalanceType7Choice subBalanceType) {
	...
	public SubBalanceInformation7 setQuantity(SubBalanceQuantity4Choice quantity) {
	...
	public SubBalanceInformation7 setSubBalanceAdditionalDetails(RestrictedFINXMax140Text subBalanceAdditionalDetails) {
		this.subBalanceAdditionalDetails = subBalanceAdditionalDetails;
		return this;
	}

	public List<AdditionalBalanceInformation7> getAdditionalBalanceBreakdownDetails() {
	...
	public SubBalanceInformation7 setAdditionalBalanceBreakdownDetails(List<AdditionalBalanceInformation7> additionalBalanceBreakdownDetails) {
