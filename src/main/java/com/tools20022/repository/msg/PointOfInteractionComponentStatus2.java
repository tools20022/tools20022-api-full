...
public class PointOfInteractionComponentStatus2 {
	...
	public static final MMMessageAttribute VersionNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponentStatus1.VersionNumber;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponentStatus3.VersionNumber);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Status = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponentStatus1.Status;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponentStatus3.Status);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponentStatus2.VersionNumber, com.tools20022.repository.msg.PointOfInteractionComponentStatus2.Status);
