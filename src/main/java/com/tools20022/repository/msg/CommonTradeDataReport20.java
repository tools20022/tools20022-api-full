...
public class CommonTradeDataReport20 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd mmContractModification = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CommonTradeDataReport20.mmObject();
			isDerived = false;
			xmlTag = "CtrctMod";
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ContractModification1.mmObject();
		}
	};
	...
	public CommonTradeDataReport20 setContractData(com.tools20022.repository.msg.ContractType5 contractData) {
	...
	public CommonTradeDataReport20 setTransactionData(com.tools20022.repository.msg.TradeTransaction15 transactionData) {
	...
	public CommonTradeDataReport20 setContractModification(com.tools20022.repository.msg.ContractModification1 contractModification) {
