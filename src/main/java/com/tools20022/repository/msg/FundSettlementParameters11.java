...
public class FundSettlementParameters11 {
	...
	public static final MMMessageAttribute SettlementDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.SettlementDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SettlementPlace = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.SettlementPlace;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SafekeepingPlace = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.SafekeepingPlace;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesSettlementSystemIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.SecuritiesSettlementSystemIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReceivingSideDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.ReceivingSideDetails;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DeliveringSideDetails = new MMMessageAssociationEnd() {
		{
			...
			definition = "Chain of parties involved in the settlement of a transaction resulting in the movement of a security from one account to another.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.FundSettlementParameters4.DeliveringSideDetails;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FundSettlementParameters11.SettlementDate, com.tools20022.repository.msg.FundSettlementParameters11.SettlementPlace,
						com.tools20022.repository.msg.FundSettlementParameters11.SafekeepingPlace, com.tools20022.repository.msg.FundSettlementParameters11.SecuritiesSettlementSystemIdentification,
						com.tools20022.repository.msg.FundSettlementParameters11.TradeTransactionCondition, com.tools20022.repository.msg.FundSettlementParameters11.SettlementTransactionCondition,
