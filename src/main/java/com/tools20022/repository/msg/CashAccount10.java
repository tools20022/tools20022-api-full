 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CashAccount10#mmIdentification
...
@XmlType(name = "CashAccount10", propOrder = "identification")
public class CashAccount10 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CashAccount10 CashAccount10}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashAccount10.mmIdentification);
	...
	public CashAccount10 setIdentification(AccountIdentification3Choice identification) {
