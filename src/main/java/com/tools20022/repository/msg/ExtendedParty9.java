...
public class ExtendedParty9 {
	...
	public static final MMMessageAttribute mmExtendedPartyRole = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ExtendedParty9.mmObject();
			isDerived = false;
			xmlTag = "XtndedPtyRole";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ExtendedPartyRole";
			definition = "Other type of party's role.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty11.mmExtendedPartyRole);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty7.mmExtendedPartyRole;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmOtherPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty11.mmOtherPartyDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty7.mmOtherPartyDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public void setOtherPartyDetails(com.tools20022.repository.msg.InvestmentAccountOwnershipInformation12 otherPartyDetails) {
