...
public class CashOption15 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CashOption15.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
	...
	public CorporateActionAmounts14 getAmountDetails() {
		return amountDetails;
	}

	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts14 amountDetails) {
