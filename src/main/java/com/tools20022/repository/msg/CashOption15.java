...
public class CashOption15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption15.mmCreditDebitIndicator, CashOption15.mmNonEligibleProceedsIndicator, CashOption15.mmIncomeType, CashOption15.mmCashAccountIdentification, CashOption15.mmAmountDetails,
						CashOption15.mmDateDetails, CashOption15.mmForeignExchangeDetails, CashOption15.mmRateAndAmountDetails, CashOption15.mmPriceDetails);
