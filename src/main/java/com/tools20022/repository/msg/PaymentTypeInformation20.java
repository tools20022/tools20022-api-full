...
public class PaymentTypeInformation20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation20.mmInstructionPriority, PaymentTypeInformation20.mmServiceLevel, PaymentTypeInformation20.mmLocalInstrument, PaymentTypeInformation20.mmSequenceType,
						PaymentTypeInformation20.mmCategoryPurpose);
