...
@XmlType(name = "SecuritiesOption42", propOrder = {"financialInstrumentIdentification", "creditDebitIndicator", "temporaryFinancialInstrumentIndicator", "newSecuritiesIssuanceIndicator", "postingQuantity", "safekeepingPlace",
...
public class SecuritiesOption42 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.SecuritiesOption35#mmFinancialInstrumentIdentification
	 * SecuritiesOption35.mmFinancialInstrumentIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<SecuritiesOption42, SecurityIdentification14>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesOption42.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> SecuritiesOption35.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(SecuritiesOption42 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption42, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<SecuritiesOption42, CreditDebitCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmCreditDebitIndicator);
			previousVersion_lazy = () -> SecuritiesOption35.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(SecuritiesOption42 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<TemporaryFinancialInstrumentIndicator1Choice>> mmTemporaryFinancialInstrumentIndicator = new MMMessageAssociationEnd<SecuritiesOption42, Optional<TemporaryFinancialInstrumentIndicator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmTemporaryFinancialInstrumentIndicator);
			previousVersion_lazy = () -> SecuritiesOption35.mmTemporaryFinancialInstrumentIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TemporaryFinancialInstrumentIndicator1Choice> getValue(SecuritiesOption42 obj) {
			return obj.getTemporaryFinancialInstrumentIndicator();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<TemporaryFinancialInstrumentIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption42, Optional<NewSecuritiesIssuanceType3Code>> mmNewSecuritiesIssuanceIndicator = new MMMessageAttribute<SecuritiesOption42, Optional<NewSecuritiesIssuanceType3Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesOption42.mmObject();
			isDerived = false;
			...
			definition = "Indicates whether the securities are newly issued or not.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmNewSecuritiesIssuanceIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<NewSecuritiesIssuanceType3Code> getValue(SecuritiesOption42 obj) {
			return obj.getNewSecuritiesIssuanceIndicator();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<NewSecuritiesIssuanceType3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Quantity6Choice> mmPostingQuantity = new MMMessageAssociationEnd<SecuritiesOption42, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmPostingQuantity);
			previousVersion_lazy = () -> SecuritiesOption35.mmPostingQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(SecuritiesOption42 obj) {
			return obj.getPostingQuantity();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<SecuritiesOption42, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmSafekeepingPlace);
			previousVersion_lazy = () -> SecuritiesOption35.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(SecuritiesOption42 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<FractionDispositionType23Choice>> mmFractionDisposition = new MMMessageAssociationEnd<SecuritiesOption42, Optional<FractionDispositionType23Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmFractionDisposition);
			previousVersion_lazy = () -> SecuritiesOption35.mmFractionDisposition;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FractionDispositionType23Choice> getValue(SecuritiesOption42 obj) {
			return obj.getFractionDisposition();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<FractionDispositionType23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption42, Optional<ActiveCurrencyCode>> mmCurrencyOption = new MMMessageAttribute<SecuritiesOption42, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmCurrencyOption);
			previousVersion_lazy = () -> SecuritiesOption35.mmCurrencyOption;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(SecuritiesOption42 obj) {
			return obj.getCurrencyOption();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, SecurityDate6> mmDateDetails = new MMMessageAssociationEnd<SecuritiesOption42, SecurityDate6>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmDateDetails);
			previousVersion_lazy = () -> SecuritiesOption35.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityDate6 getValue(SecuritiesOption42 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, SecurityDate6 value) {
			obj.setDateDetails(value);
		}
	};
	@XmlElement(name = "RateDtls")
	protected CorporateActionRate49 rateDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionRate49
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<CorporateActionRate49>> mmRateDetails = new MMMessageAssociationEnd<SecuritiesOption42, Optional<CorporateActionRate49>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmRateDetails);
			previousVersion_lazy = () -> SecuritiesOption35.mmRateDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionRate49.mmObject();
		}

		@Override
		public Optional<CorporateActionRate49> getValue(SecuritiesOption42 obj) {
			return obj.getRateDetails();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<CorporateActionRate49> value) {
			obj.setRateDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "PricDtls")
	protected CorporateActionPrice45 priceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionPrice45
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<CorporateActionPrice45>> mmPriceDetails = new MMMessageAssociationEnd<SecuritiesOption42, Optional<CorporateActionPrice45>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmPriceDetails);
			previousVersion_lazy = () -> SecuritiesOption35.mmPriceDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionPrice45.mmObject();
		}

		@Override
		public Optional<CorporateActionPrice45> getValue(SecuritiesOption42 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<CorporateActionPrice45> value) {
			obj.setPriceDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "RcvgSttlmPties")
	protected SettlementParties24 receivingSettlementParties;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.SettlementParties24
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<SettlementParties24>> mmReceivingSettlementParties = new MMMessageAssociationEnd<SecuritiesOption42, Optional<SettlementParties24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmReceivingSettlementParties);
			previousVersion_lazy = () -> SecuritiesOption35.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties24.mmObject();
		}

		@Override
		public Optional<SettlementParties24> getValue(SecuritiesOption42 obj) {
			return obj.getReceivingSettlementParties();
		}

		@Override
		public void setValue(SecuritiesOption42 obj, Optional<SettlementParties24> value) {
			obj.setReceivingSettlementParties(value.orElse(null));
		}
	};
	@XmlElement(name = "DlvrgSttlmPties")
	protected SettlementParties24 deliveringSettlementParties;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption42, Optional<SettlementParties24>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<SecuritiesOption42, Optional<SettlementParties24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> SecuritiesOption35.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties24.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesOption42.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.SecuritiesOption42.mmCreditDebitIndicator,
						com.tools20022.repository.msg.SecuritiesOption42.mmTemporaryFinancialInstrumentIndicator, com.tools20022.repository.msg.SecuritiesOption42.mmNewSecuritiesIssuanceIndicator,
						com.tools20022.repository.msg.SecuritiesOption42.mmPostingQuantity, com.tools20022.repository.msg.SecuritiesOption42.mmSafekeepingPlace, com.tools20022.repository.msg.SecuritiesOption42.mmFractionDisposition,
						com.tools20022.repository.msg.SecuritiesOption42.mmCurrencyOption, com.tools20022.repository.msg.SecuritiesOption42.mmDateDetails, com.tools20022.repository.msg.SecuritiesOption42.mmRateDetails,
						com.tools20022.repository.msg.SecuritiesOption42.mmPriceDetails, com.tools20022.repository.msg.SecuritiesOption42.mmReceivingSettlementParties,
						com.tools20022.repository.msg.SecuritiesOption42.mmDeliveringSettlementParties);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forSecuritiesOption42);
				...
				name = "SecuritiesOption42";
				definition = "Provides information about the corporate action security option.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesOption50.mmObject());
				previousVersion_lazy = () -> SecuritiesOption35.mmObject();
			}
		});
	...
	public SecuritiesOption42 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public SecuritiesOption42 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public SecuritiesOption42 setTemporaryFinancialInstrumentIndicator(TemporaryFinancialInstrumentIndicator1Choice temporaryFinancialInstrumentIndicator) {
	...
	public SecuritiesOption42 setNewSecuritiesIssuanceIndicator(NewSecuritiesIssuanceType3Code newSecuritiesIssuanceIndicator) {
	...
	public SecuritiesOption42 setPostingQuantity(Quantity6Choice postingQuantity) {
	...
	public SecuritiesOption42 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public SecuritiesOption42 setFractionDisposition(FractionDispositionType23Choice fractionDisposition) {
	...
	public SecuritiesOption42 setCurrencyOption(ActiveCurrencyCode currencyOption) {
	...
	public SecuritiesOption42 setDateDetails(SecurityDate6 dateDetails) {
		this.dateDetails = Objects.requireNonNull(dateDetails);
		return this;
	}

	public Optional<CorporateActionRate49> getRateDetails() {
		return rateDetails == null ? Optional.empty() : Optional.of(rateDetails);
	}

	public SecuritiesOption42 setRateDetails(CorporateActionRate49 rateDetails) {
		this.rateDetails = rateDetails;
		return this;
	}

	public Optional<CorporateActionPrice45> getPriceDetails() {
		return priceDetails == null ? Optional.empty() : Optional.of(priceDetails);
	}

	public SecuritiesOption42 setPriceDetails(CorporateActionPrice45 priceDetails) {
		this.priceDetails = priceDetails;
		return this;
	}

	public Optional<SettlementParties24> getReceivingSettlementParties() {
		return receivingSettlementParties == null ? Optional.empty() : Optional.of(receivingSettlementParties);
	}

	public SecuritiesOption42 setReceivingSettlementParties(SettlementParties24 receivingSettlementParties) {
		this.receivingSettlementParties = receivingSettlementParties;
		return this;
	}

	public Optional<SettlementParties24> getDeliveringSettlementParties() {
		return deliveringSettlementParties == null ? Optional.empty() : Optional.of(deliveringSettlementParties);
	}

	public SecuritiesOption42 setDeliveringSettlementParties(SettlementParties24 deliveringSettlementParties) {
