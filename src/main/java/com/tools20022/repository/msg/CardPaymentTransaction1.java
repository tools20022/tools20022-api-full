...
public class CardPaymentTransaction1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction1.mmTransactionCapture, CardPaymentTransaction1.mmTransactionType, CardPaymentTransaction1.mmAdditionalService, CardPaymentTransaction1.mmServiceAttribute,
						CardPaymentTransaction1.mmMerchantCategoryCode, CardPaymentTransaction1.mmTransactionIdentification, CardPaymentTransaction1.mmOriginalTransaction, CardPaymentTransaction1.mmInitiatorTransactionIdentification,
						CardPaymentTransaction1.mmReconciliationIdentification, CardPaymentTransaction1.mmTransactionDetails, CardPaymentTransaction1.mmAdditionalTransactionData);
