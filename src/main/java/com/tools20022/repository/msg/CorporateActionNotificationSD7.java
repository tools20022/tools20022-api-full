...
public class CorporateActionNotificationSD7 {
	...
	public CorporateActionNotificationSD7 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionNotificationSD7 setEventGroup(EventGroup1Code eventGroup) {
	...
	public CorporateActionNotificationSD7 setEventType(ExtendedEventType1Code eventType) {
	...
	public CorporateActionNotificationSD7 setSubEventType(DTCCSubEventType2Code subEventType) {
	...
	public CorporateActionNotificationSD7 setDTCMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary1Code dTCMandatoryVoluntaryEventType) {
	...
	public CorporateActionNotificationSD7 setDeclaredMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary1Code declaredMandatoryVoluntaryEventType) {
