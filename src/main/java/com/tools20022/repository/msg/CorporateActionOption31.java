...
public class CorporateActionOption31 {
	...
	public static final MMMessageAssociationEnd mmOptionNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption31.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	public void setOptionType(CorporateActionOption8Choice optionType) {
	...
	public void setOptionFeatures(List<OptionFeaturesFormat3Choice> optionFeatures) {
		this.optionFeatures = optionFeatures;
	}

	public FractionDispositionType13Choice getFractionDisposition() {
		return fractionDisposition;
	}

	public void setFractionDisposition(FractionDispositionType13Choice fractionDisposition) {
	...
	public CorporateActionDate19 getDateDetails() {
		return dateDetails;
	}

	public void setDateDetails(com.tools20022.repository.msg.CorporateActionDate19 dateDetails) {
		this.dateDetails = dateDetails;
	}

	public CorporateActionPeriod9 getPeriodDetails() {
		return periodDetails;
	}

	public void setPeriodDetails(com.tools20022.repository.msg.CorporateActionPeriod9 periodDetails) {
		this.periodDetails = periodDetails;
	}

	public CorporateActionRate22 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate22 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
	}

	public CorporateActionPrice22 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice22 priceDetails) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption20> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption13> cashMovementDetails) {
