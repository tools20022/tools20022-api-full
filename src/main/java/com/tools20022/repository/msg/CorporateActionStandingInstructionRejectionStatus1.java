 ...
 * CorporateActionStandingInstructionRejectionStatus1.AdditionalInformation}</li>
 * </ul>
 * </li>
...
public class CorporateActionStandingInstructionRejectionStatus1 {
	...
	public static final MMMessageAttribute Reason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CorporateActionStandingInstructionRejectionStatus1.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionStandingInstructionRejectionStatus1.Reason,
						com.tools20022.repository.msg.CorporateActionStandingInstructionRejectionStatus1.AdditionalInformation);
