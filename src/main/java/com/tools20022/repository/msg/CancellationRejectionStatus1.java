...
public class CancellationRejectionStatus1 {
	...
	public static final MMXor ReasonOrExtendedReasonRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.CancellationRejectionStatus1.mmObject();
	...
	public CancellationRejectionStatus1 setReason(RejectionReason2Code reason) {
	...
	public CancellationRejectionStatus1 setExtendedReason(Extended350Code extendedReason) {
	...
	public CancellationRejectionStatus1 setAdditionalInformation(Max350Text additionalInformation) {
