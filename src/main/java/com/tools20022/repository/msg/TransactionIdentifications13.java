...
public class TransactionIdentifications13 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications13.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications13.mmAccountOwnerTransactionIdentification, TransactionIdentifications13.mmAccountServicerTransactionIdentification,
						TransactionIdentifications13.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications13.mmProcessorTransactionIdentification, TransactionIdentifications13.mmCommonIdentification,
						TransactionIdentifications13.mmNettingServiceProviderIdentification);
	...
	public RestrictedFINXMax16Text getNettingServiceProviderIdentification() {
		return nettingServiceProviderIdentification;
	}

	public void setNettingServiceProviderIdentification(RestrictedFINXMax16Text nettingServiceProviderIdentification) {
