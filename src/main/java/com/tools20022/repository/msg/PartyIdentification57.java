...
public class PartyIdentification57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification57.mmOwnerIdentification, PartyIdentification57.mmAlternateIdentification, PartyIdentification57.mmDomicileCountry, PartyIdentification57.mmNonDomicileCountry,
						PartyIdentification57.mmOwnedSecuritiesQuantity, PartyIdentification57.mmCertificationType, PartyIdentification57.mmDeclarationDetails);
	...
	public void setCertificationType(List<BeneficiaryCertificationType8Choice> certificationType) {
