...
public class SecuritiesOption32 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption32.mmFinancialInstrumentIdentification, SecuritiesOption32.mmCreditDebitIndicator, SecuritiesOption32.mmPostingQuantity, SecuritiesOption32.mmPostingDate,
						SecuritiesOption32.mmOriginalPostingDate);
