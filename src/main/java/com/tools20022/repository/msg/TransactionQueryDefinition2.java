 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TransactionQueryDefinition2#QueryType
 * TransactionQueryDefinition2.QueryType}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TransactionQueryDefinition2#TransactionCriteria
 * TransactionQueryDefinition2.TransactionCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class TransactionQueryDefinition2 {
	...
	public static final MMMessageAttribute QueryType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TransactionQueryDefinition2.mmObject();
			isDerived = false;
			xmlTag = "QryTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionQueryDefinition2.QueryType, com.tools20022.repository.msg.TransactionQueryDefinition2.TransactionCriteria);
