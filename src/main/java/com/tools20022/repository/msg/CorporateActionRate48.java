...
public class CorporateActionRate48 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate48.mmAdditionalQuantityForSubscribedResultantSecurities, CorporateActionRate48.mmAdditionalQuantityForExistingSecurities, CorporateActionRate48.mmNewToOld,
						CorporateActionRate48.mmTransformationRate, CorporateActionRate48.mmChargesFees, CorporateActionRate48.mmFiscalStamp, CorporateActionRate48.mmApplicableRate, CorporateActionRate48.mmTaxCreditRate,
						CorporateActionRate48.mmFinancialTransactionTaxRate);
