...
@XmlType(name = "Linkages49", propOrder = "reference")
public class Linkages49 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Linkages49
	 * Linkages49}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages49.mmReference);
	...
	public Linkages49 setReference(References58Choice reference) {
