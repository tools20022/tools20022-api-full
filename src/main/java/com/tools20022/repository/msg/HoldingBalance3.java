...
public class HoldingBalance3 {
	...
	public static final MMMessageAttribute mmBalance = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> HoldingBalance3.mmObject();
			isDerived = false;
			xmlTag = "Bal";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(HoldingBalance3.mmBalance, HoldingBalance3.mmBalanceType, HoldingBalance3.mmSafekeepingPlace, HoldingBalance3.mmDate);
