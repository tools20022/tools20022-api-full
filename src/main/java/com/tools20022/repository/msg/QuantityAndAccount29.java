...
public class QuantityAndAccount29 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount29, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount29, Optional<Max210Text>>() {
		{
			...
			definition = "Denomination of the security to be received or delivered.";
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount44.mmDenominationChoice);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(QuantityAndAccount29 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount29 obj, Optional<Max210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount29, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount29, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount44.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(QuantityAndAccount29 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount29 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount29, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount29, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount44.mmCashAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(QuantityAndAccount29 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount29 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount29, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount29, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount44.mmSafekeepingPlace);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(QuantityAndAccount29 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount29 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount29, List<QuantityBreakdown13>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount29, List<QuantityBreakdown13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount44.mmQuantityBreakdown);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown13> getValue(QuantityAndAccount29 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount29 obj, List<QuantityBreakdown13> value) {
	...
	public QuantityAndAccount29 setQuantityBreakdown(List<QuantityBreakdown13> quantityBreakdown) {
