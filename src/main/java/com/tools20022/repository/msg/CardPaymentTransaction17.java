...
public class CardPaymentTransaction17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction17.mmTransactionIdentification, CardPaymentTransaction17.mmPOIIdentification, CardPaymentTransaction17.mmInitiatorTransactionIdentification,
						CardPaymentTransaction17.mmRecipientTransactionIdentification, CardPaymentTransaction17.mmTransactionType, CardPaymentTransaction17.mmAdditionalService, CardPaymentTransaction17.mmServiceAttribute,
						CardPaymentTransaction17.mmTransactionResult);
