 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment23#mmPOI
...
@XmlType(name = "CardPaymentEnvironment23", propOrder = {"acquirer", "merchant", "pOI", "card"})
public class CardPaymentEnvironment23 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment23, Optional<Acquirer2>> mmAcquirer = new MMMessageAssociationEnd<CardPaymentEnvironment23, Optional<Acquirer2>>() {
		{
			businessComponentTrace_lazy = () -> AcquirerRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment23.mmObject();
			isDerived = false;
			xmlTag = "Acqrr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Acquirer";
			definition = "Acquirer involved in the card payment.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment35.mmAcquirer);
			previousVersion_lazy = () -> CardPaymentEnvironment12.mmAcquirer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Acquirer2> getValue(CardPaymentEnvironment23 obj) {
			return obj.getAcquirer();
		}

		@Override
		public void setValue(CardPaymentEnvironment23 obj, Optional<Acquirer2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment23, Optional<Organisation8>> mmMerchant = new MMMessageAssociationEnd<CardPaymentEnvironment23, Optional<Organisation8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment35.mmMerchant);
			previousVersion_lazy = () -> CardPaymentEnvironment12.mmMerchant;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Organisation8> getValue(CardPaymentEnvironment23 obj) {
			return obj.getMerchant();
		}

		@Override
		public void setValue(CardPaymentEnvironment23 obj, Optional<Organisation8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentEnvironment23, PointOfInteraction3> mmPOI = new MMMessageAttribute<CardPaymentEnvironment23, PointOfInteraction3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment35.mmPOI);
			previousVersion_lazy = () -> CardPaymentEnvironment12.mmPOI;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PointOfInteraction3 getValue(CardPaymentEnvironment23 obj) {
			return obj.getPOI();
		}

		@Override
		public void setValue(CardPaymentEnvironment23 obj, PointOfInteraction3 value) {
			obj.setPOI(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentEnvironment23, PaymentCard8> mmCard = new MMMessageAttribute<CardPaymentEnvironment23, PaymentCard8>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment35.mmCard);
			previousVersion_lazy = () -> CardPaymentEnvironment12.mmCard;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PaymentCard8 getValue(CardPaymentEnvironment23 obj) {
			return obj.getCard();
		}

		@Override
		public void setValue(CardPaymentEnvironment23 obj, PaymentCard8 value) {
			obj.setCard(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment23.mmAcquirer, com.tools20022.repository.msg.CardPaymentEnvironment23.mmMerchant,
						com.tools20022.repository.msg.CardPaymentEnvironment23.mmPOI, com.tools20022.repository.msg.CardPaymentEnvironment23.mmCard);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentEnvironment23";
				definition = "Environment of the cancellation.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment35.mmObject());
				previousVersion_lazy = () -> CardPaymentEnvironment12.mmObject();
			}
		});
	...
	public CardPaymentEnvironment23 setAcquirer(Acquirer2 acquirer) {
	...
	public CardPaymentEnvironment23 setMerchant(Organisation8 merchant) {
	...
	public CardPaymentEnvironment23 setPOI(PointOfInteraction3 pOI) {
	...
	public CardPaymentEnvironment23 setCard(PaymentCard8 card) {
