...
public class PartyIdentificationAndAccount86 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount86.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount86.mmIdentification, PartyIdentificationAndAccount86.mmAlternateIdentification, PartyIdentificationAndAccount86.mmProcessingIdentification,
						PartyIdentificationAndAccount86.mmAdditionalInformation);
