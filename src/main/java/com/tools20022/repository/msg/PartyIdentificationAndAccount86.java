 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forPartyIdentificationAndAccount86
 * ConstraintCoexistenceIdentificationRule.forPartyIdentificationAndAccount86}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PartyIdentificationAndAccount86", propOrder = {"identification", "alternateIdentification", "processingIdentification", "additionalInformation"})
public class PartyIdentificationAndAccount86 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount109.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAlternateIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount109.mmAlternateIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmProcessingIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount109.mmProcessingIdentification);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmAdditionalInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount109.mmAdditionalInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount86.mmIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount86.mmAlternateIdentification,
						com.tools20022.repository.msg.PartyIdentificationAndAccount86.mmProcessingIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount86.mmAdditionalInformation);
				trace_lazy = () -> Party.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forPartyIdentificationAndAccount86);
				...
				name = "PartyIdentificationAndAccount86";
				definition = "Party and account details.";
				nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount109.mmObject());
				previousVersion_lazy = () -> PartyIdentificationAndAccount41.mmObject();
			}
		});
	...
	public PartyIdentificationAndAccount86 setIdentification(PartyIdentification43Choice identification) {
	...
	public PartyIdentificationAndAccount86 setProcessingIdentification(Max35Text processingIdentification) {
