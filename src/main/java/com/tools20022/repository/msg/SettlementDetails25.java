...
public class SettlementDetails25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails25.mmHoldIndicator, SettlementDetails25.mmSecuritiesTransactionType, SettlementDetails25.mmSettlementTransactionCondition,
						SettlementDetails25.mmPartialSettlementIndicator, SettlementDetails25.mmBeneficialOwnership, SettlementDetails25.mmCashClearingSystem, SettlementDetails25.mmMarketClientSide, SettlementDetails25.mmRegistration,
						SettlementDetails25.mmRepurchaseType, SettlementDetails25.mmSecuritiesRTGS, SettlementDetails25.mmStampDutyTaxBasis);
