 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext5#mmCardPresent
...
@XmlType(name = "PaymentContext5", propOrder = {"cardPresent", "cardholderPresent", "attendanceContext", "transactionEnvironment", "transactionChannel", "attendantMessageCapable", "attendantLanguage", "cardDataEntryMode",
...
public class PaymentContext5 {
	...
	public static final MMMessageAttribute mmCardPresent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmCardPresent);
	...
	public static final MMMessageAttribute mmCardholderPresent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmCardholderPresent);
	...
	public static final MMMessageAttribute mmAttendanceContext = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmAttendanceContext);
	...
	public static final MMMessageAttribute mmTransactionEnvironment = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmTransactionEnvironment);
	...
	public static final MMMessageAttribute mmTransactionChannel = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmTransactionChannel);
	...
	public static final MMMessageAttribute mmAttendantMessageCapable = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmAttendantMessageCapable);
	...
	public static final MMMessageAttribute mmAttendantLanguage = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmAttendantLanguage);
	...
	public static final MMMessageAttribute mmCardDataEntryMode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmCardDataEntryMode);
	...
	public static final MMMessageAttribute mmFallbackIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext8.mmFallbackIndicator);
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext5.mmCardPresent, com.tools20022.repository.msg.PaymentContext5.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext5.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext5.mmTransactionEnvironment, com.tools20022.repository.msg.PaymentContext5.mmTransactionChannel,
						com.tools20022.repository.msg.PaymentContext5.mmAttendantMessageCapable, com.tools20022.repository.msg.PaymentContext5.mmAttendantLanguage, com.tools20022.repository.msg.PaymentContext5.mmCardDataEntryMode,
						com.tools20022.repository.msg.PaymentContext5.mmFallbackIndicator, com.tools20022.repository.msg.PaymentContext5.mmSupportedOption);
	...
	public PaymentContext5 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext5 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext5 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext5 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext5 setTransactionChannel(TransactionChannel1Code transactionChannel) {
	...
	public PaymentContext5 setAttendantMessageCapable(TrueFalseIndicator attendantMessageCapable) {
	...
	public PaymentContext5 setAttendantLanguage(ISO2ALanguageCode attendantLanguage) {
	...
	public PaymentContext5 setCardDataEntryMode(CardDataReading1Code cardDataEntryMode) {
	...
	public PaymentContext5 setFallbackIndicator(TrueFalseIndicator fallbackIndicator) {
	...
	public PaymentContext5 setSupportedOption(List<SupportedPaymentOption1Code> supportedOption) {
