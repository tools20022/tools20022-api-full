...
public class PaymentContext5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext5.mmCardPresent, PaymentContext5.mmCardholderPresent, PaymentContext5.mmAttendanceContext, PaymentContext5.mmTransactionEnvironment,
						PaymentContext5.mmTransactionChannel, PaymentContext5.mmAttendantMessageCapable, PaymentContext5.mmAttendantLanguage, PaymentContext5.mmCardDataEntryMode, PaymentContext5.mmFallbackIndicator,
						PaymentContext5.mmSupportedOption);
