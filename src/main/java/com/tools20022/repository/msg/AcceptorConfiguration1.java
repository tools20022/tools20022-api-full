...
public class AcceptorConfiguration1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorConfiguration1.POIIdentification, com.tools20022.repository.msg.AcceptorConfiguration1.TerminalManagerIdentification,
						com.tools20022.repository.msg.AcceptorConfiguration1.DataSet);
				trace_lazy = () -> AcceptorConfiguration.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.AcceptorConfigurationUpdateV01.AcceptorConfiguration);
