...
import com.tools20022.repository.msg.TerminalManagementDataSet3;
import java.util.*;
...
public class AcceptorConfiguration1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorConfiguration1, Optional<GenericIdentification35>> mmPOIIdentification = new MMMessageAssociationEnd<AcceptorConfiguration1, Optional<GenericIdentification35>>() {
		{
		...
		@Override
		public Optional<GenericIdentification35> getValue(AcceptorConfiguration1 obj) {
			return obj.getPOIIdentification();
		}

		@Override
		public void setValue(AcceptorConfiguration1 obj, Optional<GenericIdentification35> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorConfiguration1, GenericIdentification35> mmTerminalManagerIdentification = new MMMessageAssociationEnd<AcceptorConfiguration1, GenericIdentification35>() {
		{
			businessElementTrace_lazy = () -> System.mmSystemIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptorConfiguration1.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification35 getValue(AcceptorConfiguration1 obj) {
			return obj.getTerminalManagerIdentification();
		}

		@Override
		public void setValue(AcceptorConfiguration1 obj, GenericIdentification35 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorConfiguration1, List<TerminalManagementDataSet3>> mmDataSet = new MMMessageAssociationEnd<AcceptorConfiguration1, List<TerminalManagementDataSet3>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> TerminalManagementDataSet3.mmObject();
		}

		@Override
		public List<TerminalManagementDataSet3> getValue(AcceptorConfiguration1 obj) {
			return obj.getDataSet();
		}

		@Override
		public void setValue(AcceptorConfiguration1 obj, List<TerminalManagementDataSet3> value) {
	...
	public AcceptorConfiguration1 setPOIIdentification(GenericIdentification35 pOIIdentification) {
	...
	public AcceptorConfiguration1 setTerminalManagerIdentification(GenericIdentification35 terminalManagerIdentification) {
	...
	public AcceptorConfiguration1 setDataSet(List<TerminalManagementDataSet3> dataSet) {
