...
@XmlType(name = "QuantityAndAccount57", propOrder = {"settledQuantity", "previouslySettledQuantity", "remainingToBeSettledQuantity", "previouslySettledAmount", "remainingToBeSettledAmount", "denominationChoice", "accountOwner",
...
public class QuantityAndAccount57 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Quantity10Choice> mmSettledQuantity = new MMMessageAssociationEnd<QuantityAndAccount57, Quantity10Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount57.mmObject();
			isDerived = false;
			xmlTag = "SttldQty";
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmSettledQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity10Choice getValue(QuantityAndAccount57 obj) {
			return obj.getSettledQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Quantity10Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<FinancialInstrumentQuantity15Choice>> mmPreviouslySettledQuantity = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<FinancialInstrumentQuantity15Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount57.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmPreviouslySettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentQuantity15Choice> getValue(QuantityAndAccount57 obj) {
			return obj.getPreviouslySettledQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<FinancialInstrumentQuantity15Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<FinancialInstrumentQuantity15Choice>> mmRemainingToBeSettledQuantity = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<FinancialInstrumentQuantity15Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount57.mmObject();
			isDerived = false;
			...
			definition = "Quantity of financial instrument remaining to be settled.";
			previousVersion_lazy = () -> QuantityAndAccount51.mmRemainingToBeSettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity15Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<AmountAndDirection57>> mmPreviouslySettledAmount = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<AmountAndDirection57>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmPreviouslySettledAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection57> getValue(QuantityAndAccount57 obj) {
			return obj.getPreviouslySettledAmount();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<AmountAndDirection57> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<AmountAndDirection57>> mmRemainingToBeSettledAmount = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<AmountAndDirection57>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount57.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmRemainingToBeSettledAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> AmountAndDirection57.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount57, Optional<RestrictedFINXMax210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount57, Optional<RestrictedFINXMax210Text>>() {
		{
			...
			definition = "Denomination of the security to be received or delivered.";
			previousVersion_lazy = () -> QuantityAndAccount51.mmDenominationChoice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(QuantityAndAccount57 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<RestrictedFINXMax210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<PartyIdentification119>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<PartyIdentification119>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification119> getValue(QuantityAndAccount57 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<PartyIdentification119> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, SecuritiesAccount27> mmSafekeepingAccount = new MMMessageAssociationEnd<QuantityAndAccount57, SecuritiesAccount27>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount27 getValue(QuantityAndAccount57 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, SecuritiesAccount27 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<CashAccountIdentification6Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<CashAccountIdentification6Choice>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmCashAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification6Choice> getValue(QuantityAndAccount57 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<CashAccountIdentification6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, List<QuantityBreakdown44>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount57, List<QuantityBreakdown44>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown44> getValue(QuantityAndAccount57 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, List<QuantityBreakdown44> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount57, Optional<SafeKeepingPlace2>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount57, Optional<SafeKeepingPlace2>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount51.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace2> getValue(QuantityAndAccount57 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount57 obj, Optional<SafeKeepingPlace2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount57.mmSettledQuantity, com.tools20022.repository.msg.QuantityAndAccount57.mmPreviouslySettledQuantity,
						com.tools20022.repository.msg.QuantityAndAccount57.mmRemainingToBeSettledQuantity, com.tools20022.repository.msg.QuantityAndAccount57.mmPreviouslySettledAmount,
						com.tools20022.repository.msg.QuantityAndAccount57.mmRemainingToBeSettledAmount, com.tools20022.repository.msg.QuantityAndAccount57.mmDenominationChoice,
						com.tools20022.repository.msg.QuantityAndAccount57.mmAccountOwner, com.tools20022.repository.msg.QuantityAndAccount57.mmSafekeepingAccount, com.tools20022.repository.msg.QuantityAndAccount57.mmCashAccount,
						com.tools20022.repository.msg.QuantityAndAccount57.mmQuantityBreakdown, com.tools20022.repository.msg.QuantityAndAccount57.mmSafekeepingPlace);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmation002V07.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionReversalAdvice002V06.mmQuantityAndAccountDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount57, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forQuantityAndAccount57,
						com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline.forQuantityAndAccount57, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount57);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "QuantityAndAccount57";
				definition = "Details on the quantity, account and other related information involved in a transaction.";
				previousVersion_lazy = () -> QuantityAndAccount51.mmObject();
			}
		});
	...
	public QuantityAndAccount57 setSettledQuantity(Quantity10Choice settledQuantity) {
	...
	public QuantityAndAccount57 setPreviouslySettledQuantity(FinancialInstrumentQuantity15Choice previouslySettledQuantity) {
	...
	public QuantityAndAccount57 setRemainingToBeSettledQuantity(FinancialInstrumentQuantity15Choice remainingToBeSettledQuantity) {
	...
	public QuantityAndAccount57 setPreviouslySettledAmount(AmountAndDirection57 previouslySettledAmount) {
	...
	public QuantityAndAccount57 setRemainingToBeSettledAmount(AmountAndDirection57 remainingToBeSettledAmount) {
	...
	public QuantityAndAccount57 setDenominationChoice(RestrictedFINXMax210Text denominationChoice) {
	...
	public QuantityAndAccount57 setAccountOwner(PartyIdentification119 accountOwner) {
	...
	public QuantityAndAccount57 setSafekeepingAccount(SecuritiesAccount27 safekeepingAccount) {
	...
	public QuantityAndAccount57 setCashAccount(CashAccountIdentification6Choice cashAccount) {
	...
	public QuantityAndAccount57 setQuantityBreakdown(List<QuantityBreakdown44> quantityBreakdown) {
	...
	public QuantityAndAccount57 setSafekeepingPlace(SafeKeepingPlace2 safekeepingPlace) {
