 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TransactionReconciliation2#ClosePeriod
 * TransactionReconciliation2.ClosePeriod}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.TransactionReconciliation2#TransactionTotals
 * TransactionReconciliation2.TransactionTotals}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TransactionReconciliation2#AdditionalTransactionData
 * TransactionReconciliation2.AdditionalTransactionData}</li>
 * </ul>
 * </li>
...
public class TransactionReconciliation2 {
	...
	public static final MMMessageAttribute ClosePeriod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.ClosePeriod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReconciliationTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.ReconciliationTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.ReconciliationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionTotals = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.TransactionTotals);
			minOccurs = 0;
	...
	public static final MMMessageAttribute AdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.AdditionalTransactionData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation2.ClosePeriod, com.tools20022.repository.msg.TransactionReconciliation2.ReconciliationTransactionIdentification,
						com.tools20022.repository.msg.TransactionReconciliation2.ReconciliationIdentification, com.tools20022.repository.msg.TransactionReconciliation2.TransactionTotals,
						com.tools20022.repository.msg.TransactionReconciliation2.AdditionalTransactionData);
