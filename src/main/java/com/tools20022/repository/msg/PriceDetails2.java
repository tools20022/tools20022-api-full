...
@XmlType(name = "PriceDetails2", propOrder = {"exercisePrice", "genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails2.mmExercisePrice, com.tools20022.repository.msg.PriceDetails2.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.PriceDetails2.mmGenericCashPriceReceivedPerProduct);
	...
	public Optional<PriceFormat6Choice> getExercisePrice() {
		return exercisePrice == null ? Optional.empty() : Optional.of(exercisePrice);
	}

	public PriceDetails2 setExercisePrice(PriceFormat6Choice exercisePrice) {
	...
	public PriceDetails2 setGenericCashPricePaidPerProduct(PriceFormat5Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails2 setGenericCashPriceReceivedPerProduct(PriceFormat7Choice genericCashPriceReceivedPerProduct) {
