...
public class AccountParties5 {
	...
	public static final MMXor mmAccountOwnerRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(AccountParties5.mmPrimaryOwner, AccountParties5.mmTrustee, AccountParties5.mmCustodianForMinor, AccountParties5.mmNominee, AccountParties5.mmJointOwner);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountParties5.mmPrimaryOwner, AccountParties5.mmTrustee, AccountParties5.mmCustodianForMinor, AccountParties5.mmNominee, AccountParties5.mmJointOwner,
						AccountParties5.mmSecondaryOwner, AccountParties5.mmBeneficiary, AccountParties5.mmPowerOfAttorney, AccountParties5.mmLegalGuardian, AccountParties5.mmSuccessorOnDeath, AccountParties5.mmAdministrator,
						AccountParties5.mmOtherParty, AccountParties5.mmGranter, AccountParties5.mmSettler);
				...
				xors_lazy = () -> Arrays.asList(AccountParties5.mmAccountOwnerRule);
			}
		});
