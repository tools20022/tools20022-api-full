...
@XmlType(name = "AlgorithmIdentification21", propOrder = "algorithm")
public class AlgorithmIdentification21 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Algo", required = true)
	protected Algorithm16Code algorithm;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<AlgorithmIdentification21, Algorithm16Code> mmAlgorithm = new MMMessageAttribute<AlgorithmIdentification21, Algorithm16Code>() {
		{
			...
			previousVersion_lazy = () -> AlgorithmIdentification16.mmAlgorithm;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public Algorithm16Code getAlgorithm() {
		return algorithm;
	}

	public AlgorithmIdentification21 setAlgorithm(Algorithm16Code algorithm) {
