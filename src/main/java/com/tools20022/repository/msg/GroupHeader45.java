		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CreditorPaymentActivationRequestV01.mmGroupHeader, CreditorPaymentActivationRequestV02.mmGroupHeader, CreditorPaymentActivationRequestV03.mmGroupHeader,
						CreditorPaymentActivationRequestV04.mmGroupHeader, CreditorPaymentActivationRequestV05.mmGroupHeader, CreditorPaymentActivationRequestV06.mmGroupHeader);
