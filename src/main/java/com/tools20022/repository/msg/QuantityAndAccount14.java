...
public class QuantityAndAccount14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount14.mmSettlementQuantity, QuantityAndAccount14.mmDenominationChoice, QuantityAndAccount14.mmCashAccount, QuantityAndAccount14.mmQuantityBreakdown,
						QuantityAndAccount14.mmSafekeepingPlace);
