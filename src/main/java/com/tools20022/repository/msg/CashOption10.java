...
public class CashOption10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption10.mmCreditDebitIndicator, CashOption10.mmNonEligibleProceedsIndicator, CashOption10.mmIncomeType, CashOption10.mmCashAccountIdentification, CashOption10.mmAmountDetails,
						CashOption10.mmDateDetails, CashOption10.mmForeignExchangeDetails, CashOption10.mmRateAndAmountDetails, CashOption10.mmPriceDetails);
