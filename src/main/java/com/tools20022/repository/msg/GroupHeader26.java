...
public class GroupHeader26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader26.mmMessageIdentification, GroupHeader26.mmCreationDateTime, GroupHeader26.mmBatchBooking, GroupHeader26.mmNumberOfTransactions, GroupHeader26.mmControlSum,
						GroupHeader26.mmTotalInterbankSettlementAmount, GroupHeader26.mmInterbankSettlementDate, GroupHeader26.mmSettlementInformation, GroupHeader26.mmPaymentTypeInformation, GroupHeader26.mmInstructingAgent,
						GroupHeader26.mmInstructedAgent);
