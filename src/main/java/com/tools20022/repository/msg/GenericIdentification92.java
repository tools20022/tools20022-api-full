...
public class GenericIdentification92 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification92, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification92, Max35Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification92.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public Max35Text getValue(GenericIdentification92 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification92, Optional<PartyType5Code>> mmType = new MMMessageAttribute<GenericIdentification92, Optional<PartyType5Code>>() {
		{
		...
		@Override
		public Optional<PartyType5Code> getValue(GenericIdentification92 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Optional<PartyType5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification92, Optional<PartyType6Code>> mmIssuer = new MMMessageAttribute<GenericIdentification92, Optional<PartyType6Code>>() {
		{
		...
		@Override
		public Optional<PartyType6Code> getValue(GenericIdentification92 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Optional<PartyType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification92, Optional<Min2Max3AlphaText>> mmCountry = new MMMessageAttribute<GenericIdentification92, Optional<Min2Max3AlphaText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification92.mmObject();
			isDerived = false;
			xmlTag = "Ctry";
		...
		@Override
		public Optional<Min2Max3AlphaText> getValue(GenericIdentification92 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Optional<Min2Max3AlphaText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification92, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification92, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification92 obj) {
			return obj.getShortName();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GenericIdentification92, Optional<NetworkParameters5>> mmRemoteAccess = new MMMessageAssociationEnd<GenericIdentification92, Optional<NetworkParameters5>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification92.mmObject();
			isDerived = false;
			xmlTag = "RmotAccs";
		...
		@Override
		public Optional<NetworkParameters5> getValue(GenericIdentification92 obj) {
			return obj.getRemoteAccess();
		}

		@Override
		public void setValue(GenericIdentification92 obj, Optional<NetworkParameters5> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification92.mmIdentification, com.tools20022.repository.msg.GenericIdentification92.mmType,
						com.tools20022.repository.msg.GenericIdentification92.mmIssuer, com.tools20022.repository.msg.GenericIdentification92.mmCountry, com.tools20022.repository.msg.GenericIdentification92.mmShortName,
						com.tools20022.repository.msg.GenericIdentification92.mmRemoteAccess);
	...
	public GenericIdentification92 setIdentification(Max35Text identification) {
	...
	public GenericIdentification92 setType(PartyType5Code type) {
		this.type = type;
		return this;
	}
	...
	public GenericIdentification92 setIssuer(PartyType6Code issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification92 setCountry(Min2Max3AlphaText country) {
	...
	public GenericIdentification92 setShortName(Max35Text shortName) {
	...
	public GenericIdentification92 setRemoteAccess(NetworkParameters5 remoteAccess) {
