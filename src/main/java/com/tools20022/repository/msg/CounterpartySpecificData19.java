...
public class CounterpartySpecificData19 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CounterpartySpecificData19, TradeCounterpartyReport5> mmCounterparty = new MMMessageAssociationEnd<CounterpartySpecificData19, TradeCounterpartyReport5>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> TradeCounterpartyReport5.mmObject();
		}

		@Override
		public TradeCounterpartyReport5 getValue(CounterpartySpecificData19 obj) {
			return obj.getCounterparty();
		}

		@Override
		public void setValue(CounterpartySpecificData19 obj, TradeCounterpartyReport5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CounterpartySpecificData19, Optional<ContractValuationData4>> mmValuation = new MMMessageAssociationEnd<CounterpartySpecificData19, Optional<ContractValuationData4>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CounterpartySpecificData19.mmObject();
			isDerived = false;
			xmlTag = "Valtn";
		...
		@Override
		public Optional<ContractValuationData4> getValue(CounterpartySpecificData19 obj) {
			return obj.getValuation();
		}

		@Override
		public void setValue(CounterpartySpecificData19 obj, Optional<ContractValuationData4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CounterpartySpecificData19, Optional<TradeCollateralReport3>> mmCollateral = new MMMessageAssociationEnd<CounterpartySpecificData19, Optional<TradeCollateralReport3>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CounterpartySpecificData19.mmObject();
			isDerived = false;
			xmlTag = "Coll";
		...
		@Override
		public Optional<TradeCollateralReport3> getValue(CounterpartySpecificData19 obj) {
			return obj.getCollateral();
		}

		@Override
		public void setValue(CounterpartySpecificData19 obj, Optional<TradeCollateralReport3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CounterpartySpecificData19, ISODateTime> mmReportingDateTime = new MMMessageAttribute<CounterpartySpecificData19, ISODateTime>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CounterpartySpecificData19.mmObject();
			isDerived = false;
			xmlTag = "RptgDtTm";
		...
		@Override
		public ISODateTime getValue(CounterpartySpecificData19 obj) {
			return obj.getReportingDateTime();
		}

		@Override
		public void setValue(CounterpartySpecificData19 obj, ISODateTime value) {
	...
	public CounterpartySpecificData19 setCounterparty(TradeCounterpartyReport5 counterparty) {
	...
	public CounterpartySpecificData19 setValuation(ContractValuationData4 valuation) {
	...
	public CounterpartySpecificData19 setCollateral(TradeCollateralReport3 collateral) {
