 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.DeniedReason5
 * DeniedReason5}</li>
 * </ul>
 */
public class DeniedReason10 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DeniedReason5#Code
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason5.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason5.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason10.Code, com.tools20022.repository.msg.DeniedReason10.AdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "DeniedReason10";
				definition = "Specifies the reason why the request or instruction was denied.";
				previousVersion_lazy = () -> DeniedReason5.mmObject();
			}
		});
