...
public class DeniedReason10 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DeniedReason5#mmCode
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason5.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason5.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
