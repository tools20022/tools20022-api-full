...
public class PlainCardData18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PlainCardData18.mmPAN, PlainCardData18.mmCardSequenceNumber, PlainCardData18.mmEffectiveDate, PlainCardData18.mmExpiryDate, PlainCardData18.mmServiceCode, PlainCardData18.mmTrack1,
						PlainCardData18.mmTrack2, PlainCardData18.mmTrack3, PlainCardData18.mmCardholderName);
