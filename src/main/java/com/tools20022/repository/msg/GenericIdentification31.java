...
@XmlType(name = "GenericIdentification31", propOrder = {"identification", "type", "issuer", "shortName"})
public class GenericIdentification31 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification31, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification31, Max35Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification31.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of the entity.";
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification76.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(GenericIdentification31 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification31 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification31, PartyType3Code> mmType = new MMMessageAttribute<GenericIdentification31, PartyType3Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification76.mmType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PartyType3Code getValue(GenericIdentification31 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification31 obj, PartyType3Code value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification31, Optional<PartyType4Code>> mmIssuer = new MMMessageAttribute<GenericIdentification31, Optional<PartyType4Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification76.mmIssuer);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyType4Code> getValue(GenericIdentification31 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification31 obj, Optional<PartyType4Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification31, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification31, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification76.mmShortName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification31 obj) {
			return obj.getShortName();
		}

		@Override
		public void setValue(GenericIdentification31 obj, Optional<Max35Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification31.mmIdentification, com.tools20022.repository.msg.GenericIdentification31.mmType,
						com.tools20022.repository.msg.GenericIdentification31.mmIssuer, com.tools20022.repository.msg.GenericIdentification31.mmShortName);
	...
	public GenericIdentification31 setIdentification(Max35Text identification) {
	...
	public GenericIdentification31 setType(PartyType3Code type) {
	...
	public GenericIdentification31 setIssuer(PartyType4Code issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification31 setShortName(Max35Text shortName) {
