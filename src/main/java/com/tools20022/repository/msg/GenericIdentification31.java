...
public class GenericIdentification31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification31.mmIdentification, GenericIdentification31.mmType, GenericIdentification31.mmIssuer, GenericIdentification31.mmShortName);
