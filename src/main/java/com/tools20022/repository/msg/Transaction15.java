...
public class Transaction15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction15.mmAccountOwnerTransactionIdentification, Transaction15.mmAccountServicerTransactionIdentification, Transaction15.mmMarketInfrastructureTransactionIdentification,
						Transaction15.mmProcessorTransactionIdentification, Transaction15.mmTradeIdentification, Transaction15.mmPoolIdentification, Transaction15.mmCommonIdentification, Transaction15.mmCorporateActionEventIdentification,
						Transaction15.mmTripartyAgentCollateralTransactionIdentification, Transaction15.mmClientTripartyCollateralTransactionIdentification, Transaction15.mmTransactionDetails);
