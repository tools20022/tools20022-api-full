 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.MessageHeader1#MessageIdentification
 * MessageHeader1.MessageIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.MessageHeader1#CreationDateTime
 * MessageHeader1.CreationDateTime}</li>
 * </ul>
 * </li>
 * <li>
...
public class MessageHeader1 {
	 ...
	 * Usage: The sender has to make sure that MessageIdentification is unique
	...
	public static final MMMessageAttribute MessageIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> MessageHeader1.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MessageHeader1.MessageIdentification, com.tools20022.repository.msg.MessageHeader1.CreationDateTime);
