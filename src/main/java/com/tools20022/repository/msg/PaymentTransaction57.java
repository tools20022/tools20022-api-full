...
public class PaymentTransaction57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction57.mmStatusIdentification, PaymentTransaction57.mmOriginalInstructionIdentification, PaymentTransaction57.mmOriginalEndToEndIdentification,
						PaymentTransaction57.mmTransactionStatus, PaymentTransaction57.mmStatusReasonInformation, PaymentTransaction57.mmChargesInformation, PaymentTransaction57.mmAcceptanceDateTime,
						PaymentTransaction57.mmAccountServicerReference, PaymentTransaction57.mmClearingSystemReference, PaymentTransaction57.mmOriginalTransactionReference, PaymentTransaction57.mmSupplementaryData);
