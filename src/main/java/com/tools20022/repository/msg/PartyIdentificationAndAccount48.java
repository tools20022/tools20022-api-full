...
@XmlType(name = "PartyIdentificationAndAccount48", propOrder = {"identification", "alternateIdentification", "cashAccount", "chargesAccount", "commissionAccount", "taxAccount", "additionalInformation"})
public class PartyIdentificationAndAccount48 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, PartyIdentification45Choice> mmIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, PartyIdentification45Choice>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PartyIdentification45Choice getValue(PartyIdentificationAndAccount48 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount48 obj, PartyIdentification45Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<AlternatePartyIdentification2>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<AlternatePartyIdentification2>>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmAlternateIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AlternatePartyIdentification2> getValue(PartyIdentificationAndAccount48 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount48 obj, Optional<AlternatePartyIdentification2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmCashAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(PartyIdentificationAndAccount48 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount48 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>> mmChargesAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmChargesAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>> mmCommissionAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmCommissionAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>> mmTaxAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmTaxAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<PartyTextInformation2>> mmAdditionalInformation = new MMMessageAssociationEnd<PartyIdentificationAndAccount48, Optional<PartyTextInformation2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount111.mmAdditionalInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyTextInformation2> getValue(PartyIdentificationAndAccount48 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount48 obj, Optional<PartyTextInformation2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmAlternateIdentification,
						com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmCashAccount, com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmChargesAccount,
						com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmCommissionAccount, com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmTaxAccount,
						com.tools20022.repository.msg.PartyIdentificationAndAccount48.mmAdditionalInformation);
	...
	public PartyIdentificationAndAccount48 setIdentification(PartyIdentification45Choice identification) {
	...
	public PartyIdentificationAndAccount48 setAlternateIdentification(AlternatePartyIdentification2 alternateIdentification) {
	...
	public PartyIdentificationAndAccount48 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public PartyIdentificationAndAccount48 setChargesAccount(CashAccountIdentification5Choice chargesAccount) {
	...
	public PartyIdentificationAndAccount48 setCommissionAccount(CashAccountIdentification5Choice commissionAccount) {
	...
	public PartyIdentificationAndAccount48 setTaxAccount(CashAccountIdentification5Choice taxAccount) {
	...
	public PartyIdentificationAndAccount48 setAdditionalInformation(PartyTextInformation2 additionalInformation) {
