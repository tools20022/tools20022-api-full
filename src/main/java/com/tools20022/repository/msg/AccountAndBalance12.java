...
public class AccountAndBalance12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance12.mmSafekeepingAccount, AccountAndBalance12.mmAccountOwner, AccountAndBalance12.mmSafekeepingPlace, AccountAndBalance12.mmBalance);
