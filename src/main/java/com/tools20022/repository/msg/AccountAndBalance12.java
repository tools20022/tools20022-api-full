...
public class AccountAndBalance12 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance12.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	public CorporateActionBalanceDetails5 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails5 balance) {
