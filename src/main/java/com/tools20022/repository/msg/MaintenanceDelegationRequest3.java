...
public class MaintenanceDelegationRequest3 {
	...
	public static final MMMessageAssociationEnd TMIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MaintenanceDelegationRequest2.TMIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MasterTMIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MaintenanceDelegationRequest2.MasterTMIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> GenericIdentification72.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd RequestedDelegation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MaintenanceDelegationRequest2.RequestedDelegation;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MaintenanceDelegationRequest3.TMIdentification, com.tools20022.repository.msg.MaintenanceDelegationRequest3.MasterTMIdentification,
						com.tools20022.repository.msg.MaintenanceDelegationRequest3.RequestedDelegation);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.MaintenanceDelegationRequestV03.MaintenanceDelegationRequest);
