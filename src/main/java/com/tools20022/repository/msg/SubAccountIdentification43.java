...
public class SubAccountIdentification43 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubAccountIdentification38.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubAccountIdentification38.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmActivityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubAccountIdentification38.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmBalanceForSubAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubAccountIdentification38.mmBalanceForSubAccount;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification43.mmAccountOwner, SubAccountIdentification43.mmSafekeepingAccount, SubAccountIdentification43.mmActivityIndicator,
						SubAccountIdentification43.mmBalanceForSubAccount);
