...
public class PlainCardData4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PlainCardData4.mmPAN, PlainCardData4.mmCardSequenceNumber, PlainCardData4.mmEffectiveDate, PlainCardData4.mmExpiryDate, PlainCardData4.mmServiceCode, PlainCardData4.mmTrackData,
						PlainCardData4.mmCardSecurityCode);
