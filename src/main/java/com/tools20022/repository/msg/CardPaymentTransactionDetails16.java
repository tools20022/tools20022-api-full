	...
	public static final MMMessageAttribute mmCurrency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmCurrency);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmCurrency;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTotalAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmTotalAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAmountQualifier = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmAmountQualifier);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmAmountQualifier;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmDetailedAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmDetailedAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmValidityDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmValidityDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmValidityDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOnLineReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmOnLineReason);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmOnLineReason;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmUnattendedLevelCategory = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmUnattendedLevelCategory);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmUnattendedLevelCategory;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmAccountType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmAccountType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmInstalment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmInstalment);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAggregationTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmAggregationTransaction);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmProduct = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmProduct);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmProduct;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCardPaymentInvoice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmCardPaymentInvoice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmICCRelatedData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails24.mmICCRelatedData);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
