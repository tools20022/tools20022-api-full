...
public class CardPaymentTransactionDetails16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmCurrency, CardPaymentTransactionDetails16.mmTotalAmount, CardPaymentTransactionDetails16.mmAmountQualifier,
						CardPaymentTransactionDetails16.mmDetailedAmount, CardPaymentTransactionDetails16.mmValidityDate, CardPaymentTransactionDetails16.mmOnLineReason, CardPaymentTransactionDetails16.mmUnattendedLevelCategory,
						CardPaymentTransactionDetails16.mmAccountType, CardPaymentTransactionDetails16.mmInstalment, CardPaymentTransactionDetails16.mmAggregationTransaction, CardPaymentTransactionDetails16.mmProduct,
						CardPaymentTransactionDetails16.mmCardPaymentInvoice, CardPaymentTransactionDetails16.mmICCRelatedData);
