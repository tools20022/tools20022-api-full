...
public class CardPaymentTransaction2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction2.mmTransactionIdentification, CardPaymentTransaction2.mmRecipientTransactionIdentification, CardPaymentTransaction2.mmReconciliationIdentification,
						CardPaymentTransaction2.mmInterchangeData, CardPaymentTransaction2.mmTransactionDetails);
