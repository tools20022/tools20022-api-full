...
public class CashBalanceDetails4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashBalanceDetails4.mmAmount, CashBalanceDetails4.mmCreditDebitIndicator, CashBalanceDetails4.mmType, CashBalanceDetails4.mmStatus, CashBalanceDetails4.mmValueDate,
						CashBalanceDetails4.mmNumberOfPayments);
	...
	public BalanceType6Code getType() {
		return type;
	}

	public void setType(BalanceType6Code type) {
		this.type = type;
	}
