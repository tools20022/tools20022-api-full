...
public class AcceptorCancellationAdviceResponse2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse2.mmEnvironment, AcceptorCancellationAdviceResponse2.mmTransaction, AcceptorCancellationAdviceResponse2.mmTMSTrigger);
