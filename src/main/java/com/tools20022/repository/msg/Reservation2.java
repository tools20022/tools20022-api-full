 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Reservation2#mmStartDateTime
...
@XmlType(name = "Reservation2", propOrder = {"startDateTime", "amount"})
public class Reservation2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.Reservation2 Reservation2}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Reservation2.mmStartDateTime, com.tools20022.repository.msg.Reservation2.mmAmount);
	...
	public Reservation2 setStartDateTime(DateAndDateTimeChoice startDateTime) {
	...
	public Reservation2 setAmount(Amount2Choice amount) {
