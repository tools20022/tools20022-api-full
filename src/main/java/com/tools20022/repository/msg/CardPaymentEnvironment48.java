 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment48#POI
 * CardPaymentEnvironment48.POI}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment48#Card
...
public class CardPaymentEnvironment48 {
	...
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.Acquirer;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Merchant = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.Merchant;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POI = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.POI;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Card = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.Card;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CustomerDevice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.CustomerDevice;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Wallet = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.Wallet;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CustomerDevice1.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PaymentToken = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment35.PaymentToken;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment48.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment48.Merchant,
						com.tools20022.repository.msg.CardPaymentEnvironment48.POI, com.tools20022.repository.msg.CardPaymentEnvironment48.Card, com.tools20022.repository.msg.CardPaymentEnvironment48.CustomerDevice,
						com.tools20022.repository.msg.CardPaymentEnvironment48.Wallet, com.tools20022.repository.msg.CardPaymentEnvironment48.PaymentToken);
