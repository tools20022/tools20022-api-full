...
public class CardPaymentEnvironment48 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment48.mmAcquirer, CardPaymentEnvironment48.mmMerchant, CardPaymentEnvironment48.mmPOI, CardPaymentEnvironment48.mmCard, CardPaymentEnvironment48.mmCustomerDevice,
						CardPaymentEnvironment48.mmWallet, CardPaymentEnvironment48.mmPaymentToken);
