...
@XmlType(name = "AlternatePartyIdentification9", propOrder = {"identificationType", "country", "alternateIdentification"})
public class AlternatePartyIdentification9 {
	...
	public AlternatePartyIdentification9 setIdentificationType(IdentificationType44Choice identificationType) {
	...
	public AlternatePartyIdentification9 setCountry(CountryCode country) {
	...
	public AlternatePartyIdentification9 setAlternateIdentification(RestrictedFINXMax30Text alternateIdentification) {
