...
import com.tools20022.repository.choice.AccountCriteria1Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AccountQuery1#mmQueryType
...
@XmlType(name = "AccountQuery1", propOrder = {"queryType", "accountCriteria"})
public class AccountQuery1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AccountQuery1 AccountQuery1}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountQuery1, Optional<QueryType2Code>> mmQueryType = new MMMessageAttribute<AccountQuery1, Optional<QueryType2Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountQuery1.mmObject();
			isDerived = false;
			xmlTag = "QryTp";
		...
		@Override
		public Optional<QueryType2Code> getValue(AccountQuery1 obj) {
			return obj.getQueryType();
		}

		@Override
		public void setValue(AccountQuery1 obj, Optional<QueryType2Code> value) {
			obj.setQueryType(value.orElse(null));
		}
	};
	@XmlElement(name = "AcctCrit")
	protected AccountCriteria1Choice accountCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountQuery1, Optional<AccountCriteria1Choice>> mmAccountCriteria = new MMMessageAssociationEnd<AccountQuery1, Optional<AccountCriteria1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountQuery1.mmObject();
			isDerived = false;
			xmlTag = "AcctCrit";
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> AccountCriteria1Choice.mmObject();
		}

		@Override
		public Optional<AccountCriteria1Choice> getValue(AccountQuery1 obj) {
			return obj.getAccountCriteria();
		}

		@Override
		public void setValue(AccountQuery1 obj, Optional<AccountCriteria1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountQuery1.mmQueryType, com.tools20022.repository.msg.AccountQuery1.mmAccountCriteria);
	...
	public AccountQuery1 setQueryType(QueryType2Code queryType) {
		this.queryType = queryType;
		return this;
	}

	public Optional<AccountCriteria1Choice> getAccountCriteria() {
		return accountCriteria == null ? Optional.empty() : Optional.of(accountCriteria);
	}

	public AccountQuery1 setAccountCriteria(AccountCriteria1Choice accountCriteria) {
