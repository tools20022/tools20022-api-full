...
public class PaymentTransaction68 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction68.mmStatusIdentification, PaymentTransaction68.mmOriginalInstructionIdentification, PaymentTransaction68.mmOriginalEndToEndIdentification,
						PaymentTransaction68.mmTransactionStatus, PaymentTransaction68.mmStatusReasonInformation, PaymentTransaction68.mmChargesInformation, PaymentTransaction68.mmAcceptanceDateTime,
						PaymentTransaction68.mmAccountServicerReference, PaymentTransaction68.mmClearingSystemReference, PaymentTransaction68.mmOriginalTransactionReference, PaymentTransaction68.mmSupplementaryData);
