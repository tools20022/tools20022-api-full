...
public class EntryTransaction4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EntryTransaction4.mmReferences, EntryTransaction4.mmAmount, EntryTransaction4.mmCreditDebitIndicator, EntryTransaction4.mmAmountDetails, EntryTransaction4.mmAvailability,
						EntryTransaction4.mmBankTransactionCode, EntryTransaction4.mmCharges, EntryTransaction4.mmInterest, EntryTransaction4.mmRelatedParties, EntryTransaction4.mmRelatedAgents, EntryTransaction4.mmPurpose,
						EntryTransaction4.mmRelatedRemittanceInformation, EntryTransaction4.mmRemittanceInformation, EntryTransaction4.mmRelatedDates, EntryTransaction4.mmRelatedPrice, EntryTransaction4.mmRelatedQuantities,
						EntryTransaction4.mmFinancialInstrumentIdentification, EntryTransaction4.mmTax, EntryTransaction4.mmReturnInformation, EntryTransaction4.mmCorporateAction, EntryTransaction4.mmSafekeepingAccount,
						EntryTransaction4.mmCashDeposit, EntryTransaction4.mmCardTransaction, EntryTransaction4.mmAdditionalTransactionInformation, EntryTransaction4.mmSupplementaryData);
