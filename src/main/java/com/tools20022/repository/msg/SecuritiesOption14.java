...
public class SecuritiesOption14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption14.mmSecurityDetails, SecuritiesOption14.mmCreditDebitIndicator, SecuritiesOption14.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption14.mmNonEligibleProceedsIndicator, SecuritiesOption14.mmEntitledQuantity, SecuritiesOption14.mmFractionDisposition, SecuritiesOption14.mmCurrencyOption, SecuritiesOption14.mmTradingPeriod,
						SecuritiesOption14.mmDateDetails, SecuritiesOption14.mmRateDetails, SecuritiesOption14.mmPriceDetails);
