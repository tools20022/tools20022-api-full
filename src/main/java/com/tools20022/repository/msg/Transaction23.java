...
public class Transaction23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction23.mmAccountOwnerTransactionIdentification, Transaction23.mmAccountServicerTransactionIdentification, Transaction23.mmMarketInfrastructureTransactionIdentification,
						Transaction23.mmProcessorTransactionIdentification, Transaction23.mmTradeIdentification, Transaction23.mmPoolIdentification, Transaction23.mmCommonIdentification, Transaction23.mmCorporateActionEventIdentification,
						Transaction23.mmTripartyAgentCollateralTransactionIdentification, Transaction23.mmClientTripartyCollateralTransactionIdentification, Transaction23.mmTransactionDetails);
