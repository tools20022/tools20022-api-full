...
public class CorporateActionGeneralInformation67 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation67.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation67.mmCorporateActionEventIdentification, CorporateActionGeneralInformation67.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation67.mmClassActionNumber, CorporateActionGeneralInformation67.mmEventProcessingType, CorporateActionGeneralInformation67.mmEventType,
						CorporateActionGeneralInformation67.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation67.mmUnderlyingSecurity);
