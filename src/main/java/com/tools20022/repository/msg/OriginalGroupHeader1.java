...
public class OriginalGroupHeader1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalGroupHeader1.mmOriginalMessageIdentification, OriginalGroupHeader1.mmOriginalMessageNameIdentification, OriginalGroupHeader1.mmOriginalCreationDateTime,
						OriginalGroupHeader1.mmOriginalNumberOfTransactions, OriginalGroupHeader1.mmOriginalControlSum, OriginalGroupHeader1.mmGroupStatus, OriginalGroupHeader1.mmStatusReasonInformation,
						OriginalGroupHeader1.mmNumberOfTransactionsPerStatus);
