 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CloseLink1
 * CloseLink1}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CloseLink2", propOrder = {"securityIdentification", "partyIdentification"})
public class CloseLink2 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.CloseLink2
	 * CloseLink2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CloseLink2, ISINOct2015Identifier> mmSecurityIdentification = new MMMessageAttribute<CloseLink2, ISINOct2015Identifier>() {
		{
			businessElementTrace_lazy = () -> Security.mmCloseLink;
			componentContext_lazy = () -> com.tools20022.repository.msg.CloseLink2.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecurityIdentification";
			definition = "Identification of a security by an ISIN.";
			previousVersion_lazy = () -> CloseLink1.mmSecurityIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISINOct2015Identifier getValue(CloseLink2 obj) {
			return obj.getSecurityIdentification();
		}

		@Override
		public void setValue(CloseLink2 obj, ISINOct2015Identifier value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CloseLink2, SystemPartyIdentification1Choice> mmPartyIdentification = new MMMessageAttribute<CloseLink2, SystemPartyIdentification1Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CloseLink2.mmObject();
			isDerived = false;
			xmlTag = "PtyId";
			...
			definition = "Identifies the party for which the close link is defined.";
			previousVersion_lazy = () -> CloseLink1.mmPartyIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SystemPartyIdentification1Choice getValue(CloseLink2 obj) {
			return obj.getPartyIdentification();
		}

		@Override
		public void setValue(CloseLink2 obj, SystemPartyIdentification1Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CloseLink2.mmSecurityIdentification, com.tools20022.repository.msg.CloseLink2.mmPartyIdentification);
				trace_lazy = () -> Security.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CloseLink2";
				definition = "Provides details of the close links as defined in the collateral reference data.";
				previousVersion_lazy = () -> CloseLink1.mmObject();
			}
		});
	...
	public CloseLink2 setSecurityIdentification(ISINOct2015Identifier securityIdentification) {
	...
	public CloseLink2 setPartyIdentification(SystemPartyIdentification1Choice partyIdentification) {
