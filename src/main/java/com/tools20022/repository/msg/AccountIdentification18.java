 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.AccountIdentification18#mmAccountOwner
...
@XmlType(name = "AccountIdentification18", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace", "confirmedBalance"})
public class AccountIdentification18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountIdentification18, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountIdentification18, Max35Text>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesAccount.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountIdentification18.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(AccountIdentification18 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(AccountIdentification18 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification18, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountIdentification18, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(AccountIdentification18 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountIdentification18 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification18, Optional<SafekeepingPlaceFormat2Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountIdentification18, Optional<SafekeepingPlaceFormat2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32.mmSafekeepingPlace);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat2Choice> getValue(AccountIdentification18 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AccountIdentification18 obj, Optional<SafekeepingPlaceFormat2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification18, BalanceFormat1Choice> mmConfirmedBalance = new MMMessageAssociationEnd<AccountIdentification18, BalanceFormat1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32.mmConfirmedBalance);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BalanceFormat1Choice getValue(AccountIdentification18 obj) {
			return obj.getConfirmedBalance();
		}

		@Override
		public void setValue(AccountIdentification18 obj, BalanceFormat1Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountIdentification18.mmSafekeepingAccount, com.tools20022.repository.msg.AccountIdentification18.mmAccountOwner,
						com.tools20022.repository.msg.AccountIdentification18.mmSafekeepingPlace, com.tools20022.repository.msg.AccountIdentification18.mmConfirmedBalance);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forAccountIdentification18);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountIdentification18";
				definition = "Provides account identification information.";
				nextVersions_lazy = () -> Arrays.asList(AccountIdentification32.mmObject());
			}
		});
	...
	public AccountIdentification18 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountIdentification18 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public AccountIdentification18 setSafekeepingPlace(SafekeepingPlaceFormat2Choice safekeepingPlace) {
	...
	public AccountIdentification18 setConfirmedBalance(BalanceFormat1Choice confirmedBalance) {
