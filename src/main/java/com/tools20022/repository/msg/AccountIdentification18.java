...
public class AccountIdentification18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification18.mmSafekeepingAccount, AccountIdentification18.mmAccountOwner, AccountIdentification18.mmSafekeepingPlace, AccountIdentification18.mmConfirmedBalance);
