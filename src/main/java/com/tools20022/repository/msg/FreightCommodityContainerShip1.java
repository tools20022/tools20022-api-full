...
public class FreightCommodityContainerShip1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FreightCommodityContainerShip1.mmBaseProduct, FreightCommodityContainerShip1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType46Code subProduct) {
