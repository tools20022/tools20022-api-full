...
public class AggregateBalancePerSafekeepingPlace25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace25.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace25.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace25.mmPledgee,
						AggregateBalancePerSafekeepingPlace25.mmAggregateBalance, AggregateBalancePerSafekeepingPlace25.mmPriceDetails, AggregateBalancePerSafekeepingPlace25.mmForeignExchangeDetails,
						AggregateBalancePerSafekeepingPlace25.mmDaysAccrued, AggregateBalancePerSafekeepingPlace25.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace25.mmInstrumentCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace25.mmAlternateReportingCurrencyAmounts, AggregateBalancePerSafekeepingPlace25.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace25.mmExposureType,
						AggregateBalancePerSafekeepingPlace25.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace25.mmAdditionalBalanceBreakdown, AggregateBalancePerSafekeepingPlace25.mmHoldingAdditionalDetails);
