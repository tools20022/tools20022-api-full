...
@XmlType(name = "TransferOut13", propOrder = {"cancellationReference", "transferDetails"})
public class TransferOut13 {
	...
	public static final MMMessageAttribute mmCancellationReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferOut18.mmCancellationReference);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public TransferOut13 setCancellationReference(Max35Text cancellationReference) {
