...
public class CreditTransferTransactionInformation11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CreditTransferTransactionInformation11.mmPaymentIdentification, CreditTransferTransactionInformation11.mmPaymentTypeInformation,
						CreditTransferTransactionInformation11.mmInterbankSettlementAmount, CreditTransferTransactionInformation11.mmInterbankSettlementDate, CreditTransferTransactionInformation11.mmSettlementPriority,
						CreditTransferTransactionInformation11.mmSettlementTimeIndication, CreditTransferTransactionInformation11.mmSettlementTimeRequest, CreditTransferTransactionInformation11.mmAcceptanceDateTime,
						CreditTransferTransactionInformation11.mmPoolingAdjustmentDate, CreditTransferTransactionInformation11.mmInstructedAmount, CreditTransferTransactionInformation11.mmExchangeRate,
						CreditTransferTransactionInformation11.mmChargeBearer, CreditTransferTransactionInformation11.mmChargesInformation, CreditTransferTransactionInformation11.mmPreviousInstructingAgent,
						CreditTransferTransactionInformation11.mmPreviousInstructingAgentAccount, CreditTransferTransactionInformation11.mmInstructingAgent, CreditTransferTransactionInformation11.mmInstructedAgent,
						CreditTransferTransactionInformation11.mmIntermediaryAgent1, CreditTransferTransactionInformation11.mmIntermediaryAgent1Account, CreditTransferTransactionInformation11.mmIntermediaryAgent2,
						CreditTransferTransactionInformation11.mmIntermediaryAgent2Account, CreditTransferTransactionInformation11.mmIntermediaryAgent3, CreditTransferTransactionInformation11.mmIntermediaryAgent3Account,
						CreditTransferTransactionInformation11.mmUltimateDebtor, CreditTransferTransactionInformation11.mmInitiatingParty, CreditTransferTransactionInformation11.mmDebtor,
						CreditTransferTransactionInformation11.mmDebtorAccount, CreditTransferTransactionInformation11.mmDebtorAgent, CreditTransferTransactionInformation11.mmDebtorAgentAccount,
						CreditTransferTransactionInformation11.mmCreditorAgent, CreditTransferTransactionInformation11.mmCreditorAgentAccount, CreditTransferTransactionInformation11.mmCreditor,
						CreditTransferTransactionInformation11.mmCreditorAccount, CreditTransferTransactionInformation11.mmUltimateCreditor, CreditTransferTransactionInformation11.mmInstructionForCreditorAgent,
						CreditTransferTransactionInformation11.mmInstructionForNextAgent, CreditTransferTransactionInformation11.mmPurpose, CreditTransferTransactionInformation11.mmRegulatoryReporting,
						CreditTransferTransactionInformation11.mmRelatedRemittanceInformation, CreditTransferTransactionInformation11.mmRemittanceInformation);
