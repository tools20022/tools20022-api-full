 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Statement23#mmReportNumber
 * Statement23.mmReportNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement23#mmQueryReference
 * Statement23.mmQueryReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Statement23#mmStatementIdentification
 * Statement23.mmStatementIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Statement23#mmStatementDateTime
 * Statement23.mmStatementDateTime}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement23#mmFrequency
 * Statement23.mmFrequency}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement23#mmUpdateType
 * Statement23.mmUpdateType}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement23#mmStatementBasis
 * Statement23.mmStatementBasis}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Statement23#mmActivityIndicator
 * Statement23.mmActivityIndicator}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Statement23#mmSubAccountIndicator
 * Statement23.mmSubAccountIndicator}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReportNumberRule#forStatement23
 * ConstraintReportNumberRule.forStatement23}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Statement23", propOrder = {"reportNumber", "queryReference", "statementIdentification", "statementDateTime", "frequency", "updateType", "statementBasis", "activityIndicator", "subAccountIndicator"})
public class Statement23 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement23, Optional<Number3Choice>> mmReportNumber = new MMMessageAssociationEnd<Statement23, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
		...
		@Override
		public Optional<Number3Choice> getValue(Statement23 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(Statement23 obj, Optional<Number3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement23, Optional<RestrictedFINXMax16Text>> mmQueryReference = new MMMessageAttribute<Statement23, Optional<RestrictedFINXMax16Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "QryRef";
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(Statement23 obj) {
			return obj.getQueryReference();
		}

		@Override
		public void setValue(Statement23 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement23, Optional<RestrictedFINXMax16Text>> mmStatementIdentification = new MMMessageAttribute<Statement23, Optional<RestrictedFINXMax16Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "StmtId";
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement23, DateAndDateTimeChoice> mmStatementDateTime = new MMMessageAssociationEnd<Statement23, DateAndDateTimeChoice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "StmtDtTm";
		...
		@Override
		public DateAndDateTimeChoice getValue(Statement23 obj) {
			return obj.getStatementDateTime();
		}

		@Override
		public void setValue(Statement23 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement23, Frequency6Choice> mmFrequency = new MMMessageAssociationEnd<Statement23, Frequency6Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
		...
		@Override
		public Frequency6Choice getValue(Statement23 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(Statement23 obj, Frequency6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement23, UpdateType3Choice> mmUpdateType = new MMMessageAssociationEnd<Statement23, UpdateType3Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
		...
		@Override
		public UpdateType3Choice getValue(Statement23 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(Statement23 obj, UpdateType3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement23, StatementBasis4Choice> mmStatementBasis = new MMMessageAssociationEnd<Statement23, StatementBasis4Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "StmtBsis";
		...
		@Override
		public StatementBasis4Choice getValue(Statement23 obj) {
			return obj.getStatementBasis();
		}

		@Override
		public void setValue(Statement23 obj, StatementBasis4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement23, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<Statement23, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
		...
		@Override
		public YesNoIndicator getValue(Statement23 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(Statement23 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement23, YesNoIndicator> mmSubAccountIndicator = new MMMessageAttribute<Statement23, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement23.mmObject();
			isDerived = false;
			xmlTag = "SubAcctInd";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forStatement23);
	...
	public Statement23 setReportNumber(Number3Choice reportNumber) {
	...
	public Statement23 setQueryReference(RestrictedFINXMax16Text queryReference) {
	...
	public Statement23 setStatementIdentification(RestrictedFINXMax16Text statementIdentification) {
	...
	public Statement23 setStatementDateTime(DateAndDateTimeChoice statementDateTime) {
	...
	public Statement23 setFrequency(Frequency6Choice frequency) {
	...
	public Statement23 setUpdateType(UpdateType3Choice updateType) {
	...
	public Statement23 setStatementBasis(StatementBasis4Choice statementBasis) {
	...
	public Statement23 setActivityIndicator(YesNoIndicator activityIndicator) {
	...
	public Statement23 setSubAccountIndicator(YesNoIndicator subAccountIndicator) {
