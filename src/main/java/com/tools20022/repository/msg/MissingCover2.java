 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.MissingCover2#MissingCoverIndicator
 * MissingCover2.MissingCoverIndicator}</li>
 * <li>{@linkplain com.tools20022.repository.msg.MissingCover2#CoverCorrection
...
public class MissingCover2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MissingCover2.MissingCoverIndicator, com.tools20022.repository.msg.MissingCover2.CoverCorrection);
				trace_lazy = () -> PaymentInvestigationCase.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ClaimNonReceiptV03.CoverDetails);
