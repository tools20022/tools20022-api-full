...
import com.tools20022.repository.choice.PendingReason6Choice;
...
@XmlType(name = "PendingStatusReason1", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason6Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.PendingReason6Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingStatusReason1, PendingReason6Choice> mmReasonCode = new MMMessageAssociationEnd<PendingStatusReason1, PendingReason6Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingStatusReason1.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason5.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PendingReason6Choice.mmObject();
		}

		@Override
		public PendingReason6Choice getValue(PendingStatusReason1 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(PendingStatusReason1 obj, PendingReason6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingStatusReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingStatusReason1, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason5.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(PendingStatusReason1 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingStatusReason1 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason1.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatusReason1";
				definition = "Specifies reasons for the pending status.";
				nextVersions_lazy = () -> Arrays.asList(PendingStatusReason5.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public PendingReason6Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason1 setReasonCode(PendingReason6Choice reasonCode) {
	...
	public PendingStatusReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
