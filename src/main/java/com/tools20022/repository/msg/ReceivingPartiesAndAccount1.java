...
public class ReceivingPartiesAndAccount1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount1.mmReceiverDetails, ReceivingPartiesAndAccount1.mmReceiversCustodianDetails, ReceivingPartiesAndAccount1.mmReceiversIntermediaryDetails,
						ReceivingPartiesAndAccount1.mmReceivingAgentDetails, ReceivingPartiesAndAccount1.mmSecuritiesSettlementSystem, ReceivingPartiesAndAccount1.mmPlaceOfSettlementDetails);
	...
	public void setReceiverDetails(com.tools20022.repository.msg.InvestmentAccount11 receiverDetails) {
		this.receiverDetails = receiverDetails;
	}

	@XmlElement(name = "RcvrsCtdnDtls")
	public PartyIdentificationAndAccount2 getReceiversCustodianDetails() {
		return receiversCustodianDetails;
	}

	public void setReceiversCustodianDetails(com.tools20022.repository.msg.PartyIdentificationAndAccount2 receiversCustodianDetails) {
		this.receiversCustodianDetails = receiversCustodianDetails;
	}

	@XmlElement(name = "RcvrsIntrmyDtls")
	public PartyIdentificationAndAccount2 getReceiversIntermediaryDetails() {
		return receiversIntermediaryDetails;
	}

	public void setReceiversIntermediaryDetails(com.tools20022.repository.msg.PartyIdentificationAndAccount2 receiversIntermediaryDetails) {
	...
	public void setReceivingAgentDetails(com.tools20022.repository.msg.PartyIdentificationAndAccount2 receivingAgentDetails) {
