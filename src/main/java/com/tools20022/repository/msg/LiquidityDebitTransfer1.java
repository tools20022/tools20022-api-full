...
import com.tools20022.repository.area.camt.LiquidityDebitTransferV04;
...
public class LiquidityDebitTransfer1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<PaymentIdentification1>> mmLiquidityTransferIdentification = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<PaymentIdentification1>>() {
		{
		...
		@Override
		public Optional<PaymentIdentification1> getValue(LiquidityDebitTransfer1 obj) {
			return obj.getLiquidityTransferIdentification();
		}

		@Override
		public void setValue(LiquidityDebitTransfer1 obj, Optional<PaymentIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<BranchAndFinancialInstitutionIdentification5>> mmCreditor = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(LiquidityDebitTransfer1 obj) {
			return obj.getCreditor();
		}

		@Override
		public void setValue(LiquidityDebitTransfer1 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<CashAccount24>> mmCreditorAccount = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<CashAccount24>>() {
		{
		...
		@Override
		public Optional<CashAccount24> getValue(LiquidityDebitTransfer1 obj) {
			return obj.getCreditorAccount();
		}

		@Override
		public void setValue(LiquidityDebitTransfer1 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Amount2Choice> mmTransferredAmount = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Amount2Choice>() {
		{
		...
		@Override
		public Amount2Choice getValue(LiquidityDebitTransfer1 obj) {
			return obj.getTransferredAmount();
		}

		@Override
		public void setValue(LiquidityDebitTransfer1 obj, Amount2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<BranchAndFinancialInstitutionIdentification5>> mmDebtor = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessComponentTrace_lazy = () -> Organisation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.LiquidityDebitTransfer1.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<CashAccount24>> mmDebtorAccount = new MMMessageAssociationEnd<LiquidityDebitTransfer1, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.LiquidityDebitTransfer1.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LiquidityDebitTransfer1, Optional<ISODate>> mmSettlementDate = new MMMessageAttribute<LiquidityDebitTransfer1, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(LiquidityDebitTransfer1 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(LiquidityDebitTransfer1 obj, Optional<ISODate> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(LiquidityDebitTransferV04.mmLiquidityDebitTransfer);
	...
	public LiquidityDebitTransfer1 setLiquidityTransferIdentification(PaymentIdentification1 liquidityTransferIdentification) {
	...
	public LiquidityDebitTransfer1 setCreditor(BranchAndFinancialInstitutionIdentification5 creditor) {
	...
	public LiquidityDebitTransfer1 setCreditorAccount(CashAccount24 creditorAccount) {
	...
	public LiquidityDebitTransfer1 setDebtor(BranchAndFinancialInstitutionIdentification5 debtor) {
		this.debtor = debtor;
		return this;
	}
	...
	public LiquidityDebitTransfer1 setDebtorAccount(CashAccount24 debtorAccount) {
