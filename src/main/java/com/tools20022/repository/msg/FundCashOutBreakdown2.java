...
public class FundCashOutBreakdown2 {
	...
	public static final MMXor mmInvestmentFundTransactionOutTypeOrExtendedRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(FundCashOutBreakdown2.mmInvestmentFundTransactionOutType, FundCashOutBreakdown2.mmExtendedInvestmentFundTransactionOutType);
		}
	};
	/**
	...
	public static final MMXor mmOriginalOrderQuantityTypeOrExtendedOriginalOrderQuantityType = new MMXor() {
		{
			...
			messageComponent_lazy = () -> FundCashOutBreakdown2.mmObject();
			impactedElements_lazy = () -> Arrays.asList(FundCashOutBreakdown2.mmOriginalOrderQuantityType, FundCashOutBreakdown2.mmExtendedOriginalOrderQuantityType);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FundCashOutBreakdown2.mmAmount, FundCashOutBreakdown2.mmUnitsNumber, FundCashOutBreakdown2.mmNewAmountIndicator, FundCashOutBreakdown2.mmInvestmentFundTransactionOutType,
						FundCashOutBreakdown2.mmExtendedInvestmentFundTransactionOutType, FundCashOutBreakdown2.mmOriginalOrderQuantityType, FundCashOutBreakdown2.mmExtendedOriginalOrderQuantityType, FundCashOutBreakdown2.mmChargeDetails,
						FundCashOutBreakdown2.mmCommissionDetails);
				...
				xors_lazy = () -> Arrays.asList(FundCashOutBreakdown2.mmInvestmentFundTransactionOutTypeOrExtendedRule, FundCashOutBreakdown2.mmOriginalOrderQuantityTypeOrExtendedOriginalOrderQuantityType);
			}
		});
