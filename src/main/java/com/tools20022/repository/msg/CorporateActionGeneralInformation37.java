...
public class CorporateActionGeneralInformation37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation37.mmCorporateActionEventIdentification, CorporateActionGeneralInformation37.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation37.mmClassActionNumber, CorporateActionGeneralInformation37.mmEventProcessingType, CorporateActionGeneralInformation37.mmEventType,
						CorporateActionGeneralInformation37.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation37.mmUnderlyingSecurity);
