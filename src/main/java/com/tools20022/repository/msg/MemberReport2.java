 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.MemberReport2#mmMemberInformationOrBusinessErrorRule
 * MemberReport2.mmMemberInformationOrBusinessErrorRule}</li>
 * </ul>
 * </li>
 * <li>
...
public class MemberReport2 {
	...
	public static final MMXor mmMemberInformationOrBusinessErrorRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(MemberReport2.mmBusinessError, MemberReport2.mmMemberInformation);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MemberReport2.mmMemberIdentification, MemberReport2.mmBusinessError, MemberReport2.mmMemberInformation);
				...
				xors_lazy = () -> Arrays.asList(MemberReport2.mmMemberInformationOrBusinessErrorRule);
			}
		});
