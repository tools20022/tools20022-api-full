 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext16#CardPresent
...
public class PaymentContext16 {
	...
	public static final MMMessageAttribute CardPresent = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentContext16.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.CardPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.CardPresent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardholderPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.CardholderPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.CardholderPresent);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.AttendanceContext;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.AttendanceContext);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionEnvironment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.TransactionEnvironment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.TransactionEnvironment);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionChannel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.TransactionChannel;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.TransactionChannel);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AttendantMessageCapable = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.AttendantMessageCapable;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.AttendantMessageCapable);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendantLanguage = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.AttendantLanguage;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.AttendantLanguage);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardDataEntryMode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.CardDataEntryMode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.CardDataEntryMode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FallbackIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext10.FallbackIndicator;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.FallbackIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext16.CardPresent, com.tools20022.repository.msg.PaymentContext16.CardholderPresent,
						com.tools20022.repository.msg.PaymentContext16.AttendanceContext, com.tools20022.repository.msg.PaymentContext16.TransactionEnvironment, com.tools20022.repository.msg.PaymentContext16.TransactionChannel,
						com.tools20022.repository.msg.PaymentContext16.AttendantMessageCapable, com.tools20022.repository.msg.PaymentContext16.AttendantLanguage, com.tools20022.repository.msg.PaymentContext16.CardDataEntryMode,
						com.tools20022.repository.msg.PaymentContext16.FallbackIndicator);
