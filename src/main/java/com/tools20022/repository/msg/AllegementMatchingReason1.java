...
import com.tools20022.repository.choice.AllegementReason1Choice;
...
@XmlType(name = "AllegementMatchingReason1", propOrder = {"code", "additionalReasonInformation"})
public class AllegementMatchingReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AllegementReason1Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<AllegementMatchingReason1, AllegementReason1Choice> mmCode = new MMMessageAttribute<AllegementMatchingReason1, AllegementReason1Choice>() {
		{
			...
			previousVersion_lazy = () -> AllegmentMatchingReason1.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AllegementMatchingReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AllegementMatchingReason1, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> AllegmentMatchingReason1.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AllegementMatchingReason1.mmCode, com.tools20022.repository.msg.AllegementMatchingReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AllegementMatchingReason1";
				definition = "The status of an instruction, advice or request.";
				previousVersion_lazy = () -> AllegmentMatchingReason1.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public AllegementReason1Choice getCode() {
		return code;
	}

	public AllegementMatchingReason1 setCode(AllegementReason1Choice code) {
	...
	public AllegementMatchingReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
