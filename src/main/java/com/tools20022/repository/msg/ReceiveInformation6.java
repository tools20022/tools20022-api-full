...
public class ReceiveInformation6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceiveInformation6.mmEffectiveSettlementDate, ReceiveInformation6.mmSettlementAmount, ReceiveInformation6.mmStampDuty, ReceiveInformation6.mmNetAmount,
						ReceiveInformation6.mmChargeDetails, ReceiveInformation6.mmCommissionDetails, ReceiveInformation6.mmTaxDetails, ReceiveInformation6.mmSettlementPartiesDetails, ReceiveInformation6.mmPhysicalTransfer,
						ReceiveInformation6.mmPhysicalTransferDetails);
