 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferOutConfirmationV03#mmSettlementDetails
 * TransferOutConfirmationV03.mmSettlementDetails}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forReceiveInformation6
 * ConstraintPhysicalTransferDetailsRule.forReceiveInformation6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule#forReceiveInformation6
 * ConstraintReceiversCustodianDetailsRule.forReceiveInformation6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule#forReceiveInformation6
 * ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "ReceiveInformation6", propOrder = {"effectiveSettlementDate", "settlementAmount", "stampDuty", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "settlementPartiesDetails", "physicalTransfer",
...
public class ReceiveInformation6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation6, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<ReceiveInformation6, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation6.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(ReceiveInformation6 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation6, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation6, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation6 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation6, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation6, Optional<StampDutyType2Code>>() {
		{
		...
		@Override
		public Optional<StampDutyType2Code> getValue(ReceiveInformation6 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation6, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation6, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation6, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation6, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(ReceiveInformation6 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation6, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation6, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(ReceiveInformation6 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation6, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation6, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(ReceiveInformation6 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation6, ReceivingPartiesAndAccount8> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation6, ReceivingPartiesAndAccount8>() {
		{
		...
		@Override
		public ReceivingPartiesAndAccount8 getValue(ReceiveInformation6 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, ReceivingPartiesAndAccount8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation6, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation6, Optional<PhysicalTransferType1Code>>() {
		{
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(ReceiveInformation6 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation6, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation6, Optional<DeliveryParameters4>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation6 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation6 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation6.mmEffectiveSettlementDate, com.tools20022.repository.msg.ReceiveInformation6.mmSettlementAmount,
						com.tools20022.repository.msg.ReceiveInformation6.mmStampDuty, com.tools20022.repository.msg.ReceiveInformation6.mmNetAmount, com.tools20022.repository.msg.ReceiveInformation6.mmChargeDetails,
						com.tools20022.repository.msg.ReceiveInformation6.mmCommissionDetails, com.tools20022.repository.msg.ReceiveInformation6.mmTaxDetails, com.tools20022.repository.msg.ReceiveInformation6.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.ReceiveInformation6.mmPhysicalTransfer, com.tools20022.repository.msg.ReceiveInformation6.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutConfirmationV03.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation6,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation6, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation6);
	...
	public ReceiveInformation6 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public ReceiveInformation6 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation6 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation6 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation6 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public ReceiveInformation6 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public ReceiveInformation6 setTaxDetails(List<Tax15> taxDetails) {
	...
	public ReceiveInformation6 setSettlementPartiesDetails(ReceivingPartiesAndAccount8 settlementPartiesDetails) {
	...
	public ReceiveInformation6 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation6 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
