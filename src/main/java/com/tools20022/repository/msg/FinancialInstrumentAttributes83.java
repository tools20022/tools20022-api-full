...
public class FinancialInstrumentAttributes83 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes83.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes83.mmPlaceOfListing, FinancialInstrumentAttributes83.mmDayCountBasis,
						FinancialInstrumentAttributes83.mmClassificationType, FinancialInstrumentAttributes83.mmOptionStyle, FinancialInstrumentAttributes83.mmDenominationCurrency, FinancialInstrumentAttributes83.mmNextCouponDate,
						FinancialInstrumentAttributes83.mmFloatingRateFixingDate, FinancialInstrumentAttributes83.mmMaturityDate, FinancialInstrumentAttributes83.mmIssueDate, FinancialInstrumentAttributes83.mmNextCallableDate,
						FinancialInstrumentAttributes83.mmPutableDate, FinancialInstrumentAttributes83.mmDatedDate, FinancialInstrumentAttributes83.mmConversionDate, FinancialInstrumentAttributes83.mmPreviousFactor,
						FinancialInstrumentAttributes83.mmNextFactor, FinancialInstrumentAttributes83.mmInterestRate, FinancialInstrumentAttributes83.mmNextInterestRate, FinancialInstrumentAttributes83.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes83.mmMinimumQuantityToInstruct, FinancialInstrumentAttributes83.mmMinimumMultipleQuantityToInstruct, FinancialInstrumentAttributes83.mmContractSize,
						FinancialInstrumentAttributes83.mmIssuePrice);
