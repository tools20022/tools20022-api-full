...
public class AccountIdentificationAndPurpose {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountIdentificationAndPurpose.Identification, com.tools20022.repository.msg.AccountIdentificationAndPurpose.Purpose);
