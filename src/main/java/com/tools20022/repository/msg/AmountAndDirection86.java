 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection86#mmAmount
 * AmountAndDirection86.mmAmount}</li>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection86#mmSign
 * AmountAndDirection86.mmSign}</li>
 * </ul>
 * </li>
 ...
 * definition} = "Cash posting where the currency is implied by the context."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "AmountAndDirection86", propOrder = {"amount", "sign"})
public class AmountAndDirection86 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AmountAndDirection86
	 * AmountAndDirection86}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection86.mmAmount, com.tools20022.repository.msg.AmountAndDirection86.mmSign);
				trace_lazy = () -> RateAndAmount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "AmountAndDirection86";
				definition = "Cash posting where the currency is implied by the context.";
			}
		});
	...
	public AmountAndDirection86 setAmount(ImpliedCurrencyAndAmount amount) {
	...
	public AmountAndDirection86 setSign(PlusOrMinusIndicator sign) {
