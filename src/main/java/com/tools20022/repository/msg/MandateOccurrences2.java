...
public class MandateOccurrences2 {
	...
	public MandateOccurrences2 setSequenceType(SequenceType2Code sequenceType) {
	...
	public MandateOccurrences2 setFrequency(Frequency6Code frequency) {
	...
	public MandateOccurrences2 setFirstCollectionDate(ISODate firstCollectionDate) {
	...
	public MandateOccurrences2 setFinalCollectionDate(ISODate finalCollectionDate) {
