...
public class PartyIdentificationAndAccount1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount1.mmIdentification, PartyIdentificationAndAccount1.mmAlternateIdentification, PartyIdentificationAndAccount1.mmSafekeepingAccount,
						PartyIdentificationAndAccount1.mmProcessingDate, PartyIdentificationAndAccount1.mmProcessingIdentification, PartyIdentificationAndAccount1.mmAdditionalInformation);
