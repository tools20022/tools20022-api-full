 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Linkages25#mmProcessingPosition
 * Linkages25.mmProcessingPosition}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages25#mmMessageNumber
 * Linkages25.mmMessageNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages25#mmReference
 * Linkages25.mmReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages25#mmReferenceOwner
 * Linkages25.mmReferenceOwner}</li>
 * </ul>
 * </li>
...
@XmlType(name = "Linkages25", propOrder = {"processingPosition", "messageNumber", "reference", "referenceOwner"})
public class Linkages25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages25, Optional<ProcessingPosition3Choice>> mmProcessingPosition = new MMMessageAssociationEnd<Linkages25, Optional<ProcessingPosition3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages25.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
		...
		@Override
		public Optional<ProcessingPosition3Choice> getValue(Linkages25 obj) {
			return obj.getProcessingPosition();
		}

		@Override
		public void setValue(Linkages25 obj, Optional<ProcessingPosition3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages25, Optional<DocumentNumber2Choice>> mmMessageNumber = new MMMessageAssociationEnd<Linkages25, Optional<DocumentNumber2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages25.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
		...
		@Override
		public Optional<DocumentNumber2Choice> getValue(Linkages25 obj) {
			return obj.getMessageNumber();
		}

		@Override
		public void setValue(Linkages25 obj, Optional<DocumentNumber2Choice> value) {
			obj.setMessageNumber(value.orElse(null));
		}
	};
	@XmlElement(name = "Ref", required = true)
	protected References32Choice reference;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages25, References32Choice> mmReference = new MMMessageAssociationEnd<Linkages25, References32Choice>() {
		{
		...
		@Override
		public References32Choice getValue(Linkages25 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(Linkages25 obj, References32Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages25, Optional<PartyIdentification51Choice>> mmReferenceOwner = new MMMessageAssociationEnd<Linkages25, Optional<PartyIdentification51Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification51Choice> getValue(Linkages25 obj) {
			return obj.getReferenceOwner();
		}

		@Override
		public void setValue(Linkages25 obj, Optional<PartyIdentification51Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages25.mmProcessingPosition, com.tools20022.repository.msg.Linkages25.mmMessageNumber, com.tools20022.repository.msg.Linkages25.mmReference,
						com.tools20022.repository.msg.Linkages25.mmReferenceOwner);
	...
	public Linkages25 setProcessingPosition(ProcessingPosition3Choice processingPosition) {
	...
	public Linkages25 setMessageNumber(DocumentNumber2Choice messageNumber) {
		this.messageNumber = messageNumber;
		return this;
	}

	public References32Choice getReference() {
		return reference;
	}

	public Linkages25 setReference(References32Choice reference) {
	...
	public Linkages25 setReferenceOwner(PartyIdentification51Choice referenceOwner) {
