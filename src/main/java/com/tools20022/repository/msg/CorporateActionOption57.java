...
public class CorporateActionOption57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption57.mmOptionNumber, CorporateActionOption57.mmOptionType, CorporateActionOption57.mmFractionDisposition, CorporateActionOption57.mmChangeType,
						CorporateActionOption57.mmEligibleForCollateralIndicator, CorporateActionOption57.mmCurrencyToBuy, CorporateActionOption57.mmCurrencyToSell, CorporateActionOption57.mmCurrencyOption,
						CorporateActionOption57.mmSecurityIdentification, CorporateActionOption57.mmSecuritiesQuantity, CorporateActionOption57.mmExecutionRequestedDateTime, CorporateActionOption57.mmRateAndAmountDetails,
						CorporateActionOption57.mmPriceDetails, CorporateActionOption57.mmAdditionalInformation);
