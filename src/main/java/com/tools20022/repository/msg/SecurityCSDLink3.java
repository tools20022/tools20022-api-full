 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SecurityCSDLink6
 * SecurityCSDLink6}</li>
 * </ul>
 * </li>
 * </ul>
...
public class SecurityCSDLink3 {
	...
	public static final MMMessageAttribute<SecurityCSDLink3, IssuerOrInvestor1Choice> mmIssuerInvestorCSD = new MMMessageAttribute<SecurityCSDLink3, IssuerOrInvestor1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecurityCSDLink6.mmIssuerInvestorCSD);
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecurityCSDLink6#mmValidFrom
	...
	public static final MMMessageAttribute<SecurityCSDLink3, DateAndDateTimeChoice> mmValidFrom = new MMMessageAttribute<SecurityCSDLink3, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecurityCSDLink6.mmValidFrom);
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(SecurityCSDLink6.mmObject());
			}
		});
