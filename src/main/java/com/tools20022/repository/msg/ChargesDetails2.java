...
@XmlType(name = "ChargesDetails2", propOrder = {"type", "otherChargesType", "amount"})
public class ChargesDetails2 {
	...
	public static final MMXor TypeOrOtherChargesTypeRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.ChargesDetails2.mmObject();
	...
	public ChargesDetails2 setType(ChargeType8Code type) {
	...
	public ChargesDetails2 setOtherChargesType(Max35Text otherChargesType) {
	...
	public ChargesDetails2 setAmount(CurrencyAndAmount amount) {
