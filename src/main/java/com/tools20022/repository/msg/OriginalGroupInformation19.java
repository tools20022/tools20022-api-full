...
public class OriginalGroupInformation19 {
	...
	public static final MMXor mmOriginalMessageIdentificationOrNetworkFileNameRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(OriginalGroupInformation19.mmOriginalMessageIdentification, OriginalGroupInformation19.mmNetworkFileName);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalGroupInformation19.mmOriginalMessageIdentification, OriginalGroupInformation19.mmNetworkFileName, OriginalGroupInformation19.mmOriginalMessageNameIdentification,
						OriginalGroupInformation19.mmOriginalCreationDateTime, OriginalGroupInformation19.mmFileOriginator, OriginalGroupInformation19.mmOriginalNumberOfTransactions, OriginalGroupInformation19.mmOriginalControlSum,
						OriginalGroupInformation19.mmGroupStatus, OriginalGroupInformation19.mmStatusReasonInformation, OriginalGroupInformation19.mmNumberOfTransactionsPerStatus);
				...
				xors_lazy = () -> Arrays.asList(OriginalGroupInformation19.mmOriginalMessageIdentificationOrNetworkFileNameRule);
			}
		});
