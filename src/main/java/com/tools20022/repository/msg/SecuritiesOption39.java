...
public class SecuritiesOption39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption39.mmSecurityDetails, SecuritiesOption39.mmCreditDebitIndicator, SecuritiesOption39.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption39.mmNonEligibleProceedsIndicator, SecuritiesOption39.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption39.mmNewSecuritiesIssuanceIndicator, SecuritiesOption39.mmEntitledQuantity,
						SecuritiesOption39.mmSafekeepingPlace, SecuritiesOption39.mmFractionDisposition, SecuritiesOption39.mmCurrencyOption, SecuritiesOption39.mmTradingPeriod, SecuritiesOption39.mmDateDetails,
						SecuritiesOption39.mmRateDetails, SecuritiesOption39.mmPriceDetails);
