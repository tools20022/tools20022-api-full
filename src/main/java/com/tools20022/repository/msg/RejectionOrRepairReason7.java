...
public class RejectionOrRepairReason7 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason7.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason7.mmCode, RejectionOrRepairReason7.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason7Choice code) {
		this.code = code;
	}
