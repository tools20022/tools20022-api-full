...
@XmlType(name = "PostalAddress4", propOrder = {"addressLine", "country"})
public class PostalAddress4 {
	...
	public PostalAddress4 setAddressLine(List<Max70Text> addressLine) {
	...
	public PostalAddress4 setCountry(CountryCode country) {
