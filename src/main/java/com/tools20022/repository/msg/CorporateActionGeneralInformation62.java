...
public class CorporateActionGeneralInformation62 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation62.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation62.mmCorporateActionEventIdentification, CorporateActionGeneralInformation62.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation62.mmClassActionNumber, CorporateActionGeneralInformation62.mmEventType, CorporateActionGeneralInformation62.mmFinancialInstrumentIdentification,
						CorporateActionGeneralInformation62.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation62.mmIntermediateSecuritiesDistributionType, CorporateActionGeneralInformation62.mmFractionalQuantity);
