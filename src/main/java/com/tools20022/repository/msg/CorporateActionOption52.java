...
public class CorporateActionOption52 {
	...
	public static final MMMessageAttribute OptionNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.OptionNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OptionType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.OptionType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FractionDisposition = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.FractionDisposition);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OfferType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.OfferType);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OptionFeatures = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.OptionFeatures);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd IntermediateSecuritiesDistributionType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.IntermediateSecuritiesDistributionType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OptionAvailabilityStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.OptionAvailabilityStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CertificationBreakdownType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.CertificationBreakdownType);
			minOccurs = 0;
	...
	public static final MMMessageAttribute NonDomicileCountry = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.NonDomicileCountry);
			minOccurs = 0;
	...
	public static final MMMessageAttribute ValidDomicileCountry = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.ValidDomicileCountry);
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	};
	...
	public static final MMMessageAttribute CurrencyOption = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.CurrencyOption);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DefaultProcessingOrStandingInstruction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.DefaultProcessingOrStandingInstruction);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ChargesAppliedIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.ChargesAppliedIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CertificationBreakdownIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.CertificationBreakdownIndicator);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute WithdrawalAllowedIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.WithdrawalAllowedIndicator);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute ChangeAllowedIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.ChangeAllowedIndicator);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	public static final MMMessageAssociationEnd SecurityIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.SecurityIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DateDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.DateDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PeriodDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.PeriodDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RateAndAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.RateAndAmountDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PriceDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.PriceDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.SecuritiesQuantity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.SecuritiesMovementDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd CashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.CashMovementDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd AdditionalInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.AdditionalInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption52.OptionNumber, com.tools20022.repository.msg.CorporateActionOption52.OptionType,
						com.tools20022.repository.msg.CorporateActionOption52.FractionDisposition, com.tools20022.repository.msg.CorporateActionOption52.OfferType, com.tools20022.repository.msg.CorporateActionOption52.OptionFeatures,
						com.tools20022.repository.msg.CorporateActionOption52.IntermediateSecuritiesDistributionType, com.tools20022.repository.msg.CorporateActionOption52.OptionAvailabilityStatus,
						com.tools20022.repository.msg.CorporateActionOption52.CertificationBreakdownType, com.tools20022.repository.msg.CorporateActionOption52.NonDomicileCountry,
						com.tools20022.repository.msg.CorporateActionOption52.ValidDomicileCountry, com.tools20022.repository.msg.CorporateActionOption52.CurrencyOption,
						com.tools20022.repository.msg.CorporateActionOption52.DefaultProcessingOrStandingInstruction, com.tools20022.repository.msg.CorporateActionOption52.ChargesAppliedIndicator,
						com.tools20022.repository.msg.CorporateActionOption52.CertificationBreakdownIndicator, com.tools20022.repository.msg.CorporateActionOption52.WithdrawalAllowedIndicator,
						com.tools20022.repository.msg.CorporateActionOption52.ChangeAllowedIndicator, com.tools20022.repository.msg.CorporateActionOption52.SecurityIdentification,
						com.tools20022.repository.msg.CorporateActionOption52.DateDetails, com.tools20022.repository.msg.CorporateActionOption52.PeriodDetails, com.tools20022.repository.msg.CorporateActionOption52.RateAndAmountDetails,
						com.tools20022.repository.msg.CorporateActionOption52.PriceDetails, com.tools20022.repository.msg.CorporateActionOption52.SecuritiesQuantity,
						com.tools20022.repository.msg.CorporateActionOption52.SecuritiesMovementDetails, com.tools20022.repository.msg.CorporateActionOption52.CashMovementDetails,
						com.tools20022.repository.msg.CorporateActionOption52.AdditionalInformation);
				trace_lazy = () -> CorporateActionOption.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV04.CorporateActionMovementDetails);
