...
public class IntraPositionMovementDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionMovementDetails8.mmIdentification, IntraPositionMovementDetails8.mmSettledQuantity, IntraPositionMovementDetails8.mmPreviouslySettledQuantity,
						IntraPositionMovementDetails8.mmRemainingToBeSettledQuantity, IntraPositionMovementDetails8.mmSecuritiesSubBalanceIdentification, IntraPositionMovementDetails8.mmBalanceTo,
						IntraPositionMovementDetails8.mmSettlementDate, IntraPositionMovementDetails8.mmAvailableDate, IntraPositionMovementDetails8.mmCorporateActionEventType, IntraPositionMovementDetails8.mmCollateralMonitorAmount,
						IntraPositionMovementDetails8.mmInstructionProcessingAdditionalDetails, IntraPositionMovementDetails8.mmSupplementaryData);
	...
	@XmlElement(name = "Id")
	public References33Choice getIdentification() {
		return identification;
	}

	public void setIdentification(References33Choice identification) {
