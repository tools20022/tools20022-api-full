 ...
 * definition} = "Provides information on a CA option."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CorporateActionOption2", propOrder = {"optionType", "optionNumber"})
public class CorporateActionOption2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CorporateActionOption2
	 * CorporateActionOption2}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption2.mmOptionType, com.tools20022.repository.msg.CorporateActionOption2.mmOptionNumber);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption2";
				definition = "Provides information on a CA option.";
			}
		});
	...
	public CorporateActionOption2 setOptionType(CorporateActionOption1FormatChoice optionType) {
	...
	public CorporateActionOption2 setOptionNumber(Exact3NumericText optionNumber) {
