 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment54#Card
...
public class CardPaymentEnvironment54 {
	...
	public static final MMMessageAssociationEnd AcquirerIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment66.AcquirerIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MerchantIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment66.MerchantIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POIIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment66.POIIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Card = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment66.Card);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentToken = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment66.PaymentToken);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment54.AcquirerIdentification, com.tools20022.repository.msg.CardPaymentEnvironment54.MerchantIdentification,
						com.tools20022.repository.msg.CardPaymentEnvironment54.POIIdentification, com.tools20022.repository.msg.CardPaymentEnvironment54.Card, com.tools20022.repository.msg.CardPaymentEnvironment54.PaymentToken);
