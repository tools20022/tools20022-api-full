...
public class SubscriptionBulkOrder3 {
	...
	public static final MMXor mmCancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(SubscriptionBulkOrder3.mmCancellationRight, SubscriptionBulkOrder3.mmExtendedCancellationRight);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubscriptionBulkOrder3.mmMasterReference, SubscriptionBulkOrder3.mmPlaceOfTrade, SubscriptionBulkOrder3.mmOrderDateTime, SubscriptionBulkOrder3.mmExpiryDateTime,
						SubscriptionBulkOrder3.mmRequestedFutureTradeDate, SubscriptionBulkOrder3.mmCancellationRight, SubscriptionBulkOrder3.mmExtendedCancellationRight, SubscriptionBulkOrder3.mmFinancialInstrumentDetails,
						SubscriptionBulkOrder3.mmIndividualOrderDetails, SubscriptionBulkOrder3.mmRequestedSettlementCurrency, SubscriptionBulkOrder3.mmRequestedNAVCurrency, SubscriptionBulkOrder3.mmTotalSettlementAmount,
						SubscriptionBulkOrder3.mmCashSettlementDate, SubscriptionBulkOrder3.mmBulkCashSettlementDetails);
				...
				definition = "Order to invest the investor's principal in an investment fund.";
				xors_lazy = () -> Arrays.asList(SubscriptionBulkOrder3.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
