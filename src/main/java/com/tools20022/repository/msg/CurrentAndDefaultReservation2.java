...
public class CurrentAndDefaultReservation2 {
	...
	public static final MMMessageAssociationEnd CurrentReservation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CurrentAndDefaultReservation1.CurrentReservation;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd DefaultReservation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CurrentAndDefaultReservation1.DefaultReservation;
			minOccurs = 0;
			type_lazy = () -> ReservationReport4.mmObject();
			isComposite = true;
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CurrentAndDefaultReservation2.CurrentReservation, com.tools20022.repository.msg.CurrentAndDefaultReservation2.DefaultReservation);
