...
public class CorporateActionEventAndBalance8 {
	...
	public static final MMMessageAssociationEnd mmGeneralInformation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventAndBalance8.mmObject();
			isDerived = false;
			xmlTag = "GnlInf";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance8.mmGeneralInformation, CorporateActionEventAndBalance8.mmUnderlyingSecurity, CorporateActionEventAndBalance8.mmBalance,
						CorporateActionEventAndBalance8.mmSupplementaryData);
	...
	public void setGeneralInformation(com.tools20022.repository.msg.EventInformation6 generalInformation) {
