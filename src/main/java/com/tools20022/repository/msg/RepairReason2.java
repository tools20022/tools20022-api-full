...
public class RepairReason2 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RepairReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairReason2.mmCode, RepairReason2.mmAdditionalReasonInformation);
	...
	public void setCode(RepairReason6Choice code) {
		this.code = code;
	}
