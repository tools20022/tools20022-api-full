...
public class AccountIdentification12 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountIdentification12.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	protected List<com.tools20022.repository.msg.CorporateActionEventAndBalance2> corporateActionEventAndBalance;
	/**
	...
	public static final MMMessageAssociationEnd mmCorporateActionEventAndBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionEventAndBalance2.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification12.mmSafekeepingAccount, AccountIdentification12.mmAccountOwner, AccountIdentification12.mmSafekeepingPlace,
						AccountIdentification12.mmCorporateActionEventAndBalance);
	...
	public void setCorporateActionEventAndBalance(List<com.tools20022.repository.msg.CorporateActionEventAndBalance2> corporateActionEventAndBalance) {
