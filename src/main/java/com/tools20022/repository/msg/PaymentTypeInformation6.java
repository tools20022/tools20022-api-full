 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentTypeInformation6#mmServiceLevelOrClearingChannelRule
 * PaymentTypeInformation6.mmServiceLevelOrClearingChannelRule}</li>
 * </ul>
 * </li>
 * <li>
	...
	public static final MMMessageAttribute mmInstructionPriority = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PaymentTypeInformation6.mmObject();
			isDerived = false;
			xmlTag = "InstrPrty";
	...
	public static final MMXor mmServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> PaymentTypeInformation6.mmObject();
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation6.mmServiceLevelOrClearingChannelRule);
			}
		});
