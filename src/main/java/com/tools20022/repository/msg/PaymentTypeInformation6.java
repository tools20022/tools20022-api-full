...
public class PaymentTypeInformation6 {
	...
	public static final MMXor mmServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(PaymentTypeInformation6.mmServiceLevel, PaymentTypeInformation6.mmClearingChannel);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation6.mmInstructionPriority, PaymentTypeInformation6.mmServiceLevel, PaymentTypeInformation6.mmClearingChannel, PaymentTypeInformation6.mmLocalInstrument,
						PaymentTypeInformation6.mmSequenceType, PaymentTypeInformation6.mmCategoryPurpose);
				...
				xors_lazy = () -> Arrays.asList(PaymentTypeInformation6.mmServiceLevelOrClearingChannelRule);
			}
		});
