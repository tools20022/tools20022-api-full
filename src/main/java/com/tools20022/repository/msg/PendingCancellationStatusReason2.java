 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forPendingCancellationStatusReason2
 * ConstraintAdditionalReasonInforrmationRule.
 * forPendingCancellationStatusReason2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PendingCancellationStatusReason2", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingCancellationStatusReason2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason2.mmReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason2.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingCancellationStatusReason2);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationStatusReason2";
	...
	public PendingCancellationStatusReason2 setReasonCode(PendingCancellationReason2Choice reasonCode) {
	...
	public PendingCancellationStatusReason2 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
