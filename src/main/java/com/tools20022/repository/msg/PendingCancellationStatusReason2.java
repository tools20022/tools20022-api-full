...
public class PendingCancellationStatusReason2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason2.ReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason2.AdditionalReasonInformation);
