...
public class OriginalPaymentInstruction18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction18.mmOriginalPaymentInformationIdentification, OriginalPaymentInstruction18.mmOriginalNumberOfTransactions,
						OriginalPaymentInstruction18.mmOriginalControlSum, OriginalPaymentInstruction18.mmPaymentInformationStatus, OriginalPaymentInstruction18.mmStatusReasonInformation,
						OriginalPaymentInstruction18.mmNumberOfTransactionsPerStatus, OriginalPaymentInstruction18.mmTransactionInformationAndStatus);
