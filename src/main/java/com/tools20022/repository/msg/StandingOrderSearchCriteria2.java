...
@XmlType(name = "StandingOrderSearchCriteria2", propOrder = {"keyAttributesIndicator", "standingOrderIdentification", "type", "account", "currency", "validityPeriod", "systemMember", "responsibleParty", "associatedPoolAccount",
...
public class StandingOrderSearchCriteria2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.StandingOrderSearchCriteria2
	 * StandingOrderSearchCriteria2}</li>
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<TrueFalseIndicator>> mmKeyAttributesIndicator = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<TrueFalseIndicator>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmKeyAttributesIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>> mmStandingOrderIdentification = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmStandingOrderIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<StandingOrderType1Choice>> mmType = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<StandingOrderType1Choice>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<CashAccount24>> mmAccount = new MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<CashAccount24>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<ActiveCurrencyCode>> mmCurrency = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<ActiveCurrencyCode>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmCurrency;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<DatePeriod2Choice>> mmValidityPeriod = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<DatePeriod2Choice>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmValidityPeriod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<BranchAndFinancialInstitutionIdentification5>> mmSystemMember = new MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmSystemMember;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<BranchAndFinancialInstitutionIdentification5>> mmResponsibleParty = new MMMessageAssociationEnd<StandingOrderSearchCriteria2, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmResponsibleParty;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<AccountIdentification4Choice>> mmAssociatedPoolAccount = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<AccountIdentification4Choice>>() {
		{
			...
			definition = "Liquidity transfer origin or destination account within the pool of accounts under management of the requestor.";
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmAssociatedPoolAccount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>> mmLinkSetIdentification = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmLinkSetIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>> mmLinkSetOrderIdentification = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmLinkSetOrderIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Number>> mmLinkSetOrderSequence = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<Number>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmLinkSetOrderSequence;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<StandingOrderSearchCriteria2, Optional<TrueFalseIndicator>> mmZeroSweepIndicator = new MMMessageAttribute<StandingOrderSearchCriteria2, Optional<TrueFalseIndicator>>() {
		{
			...
			previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmZeroSweepIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmKeyAttributesIndicator, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmStandingOrderIdentification,
						com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmType, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmAccount, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmCurrency,
						com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmValidityPeriod, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmSystemMember,
						com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmResponsibleParty, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmAssociatedPoolAccount,
						com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmLinkSetIdentification, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmLinkSetOrderIdentification,
						com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmLinkSetOrderSequence, com.tools20022.repository.msg.StandingOrderSearchCriteria2.mmZeroSweepIndicator);
				trace_lazy = () -> CashStandingOrder.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StandingOrderSearchCriteria2";
				definition = "Defines the criteria which are used to search for standing orders defined within the system.";
				previousVersion_lazy = () -> StandingOrderSearchCriteria1.mmObject();
			}
		});
	...
	public StandingOrderSearchCriteria2 setKeyAttributesIndicator(TrueFalseIndicator keyAttributesIndicator) {
	...
	public StandingOrderSearchCriteria2 setStandingOrderIdentification(Max35Text standingOrderIdentification) {
	...
	public StandingOrderSearchCriteria2 setType(StandingOrderType1Choice type) {
		this.type = type;
		return this;
	}
	...
	public StandingOrderSearchCriteria2 setCurrency(ActiveCurrencyCode currency) {
	...
	public StandingOrderSearchCriteria2 setValidityPeriod(DatePeriod2Choice validityPeriod) {
	...
	public StandingOrderSearchCriteria2 setAssociatedPoolAccount(AccountIdentification4Choice associatedPoolAccount) {
	...
	public StandingOrderSearchCriteria2 setLinkSetIdentification(Max35Text linkSetIdentification) {
	...
	public StandingOrderSearchCriteria2 setLinkSetOrderIdentification(Max35Text linkSetOrderIdentification) {
	...
	public StandingOrderSearchCriteria2 setLinkSetOrderSequence(Number linkSetOrderSequence) {
	...
	public StandingOrderSearchCriteria2 setZeroSweepIndicator(TrueFalseIndicator zeroSweepIndicator) {
