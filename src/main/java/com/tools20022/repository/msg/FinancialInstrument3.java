	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FinancialInstrument3.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmation.mmFinancialInstrumentDetails,
						com.tools20022.repository.area.sese.TransferInInstruction.mmFinancialInstrumentDetails, com.tools20022.repository.area.sese.TransferOutConfirmation.mmFinancialInstrumentDetails,
						com.tools20022.repository.area.sese.TransferOutInstruction.mmFinancialInstrumentDetails);
