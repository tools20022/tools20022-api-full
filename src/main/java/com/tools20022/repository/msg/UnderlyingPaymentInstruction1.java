...
public class UnderlyingPaymentInstruction1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction1.mmOriginalGroupInformation, UnderlyingPaymentInstruction1.mmOriginalPaymentInformationIdentification,
						UnderlyingPaymentInstruction1.mmOriginalInstructionIdentification, UnderlyingPaymentInstruction1.mmOriginalEndToEndIdentification, UnderlyingPaymentInstruction1.mmOriginalInstructedAmount,
						UnderlyingPaymentInstruction1.mmRequestedExecutionDate, UnderlyingPaymentInstruction1.mmRequestedCollectionDate);
