...
public class GeneratedReason2 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> GeneratedReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedReason2.mmCode, GeneratedReason2.mmAdditionalReasonInformation);
	...
	public void setCode(GeneratedReasons2Choice code) {
		this.code = code;
	}
