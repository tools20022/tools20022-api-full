...
import com.tools20022.repository.choice.GeneratedReasons2Choice;
...
@XmlType(name = "GeneratedReason2", propOrder = {"code", "additionalReasonInformation"})
public class GeneratedReason2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected GeneratedReasons2Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.GeneratedReason2
	 * GeneratedReason2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GeneratedReason2, GeneratedReasons2Choice> mmCode = new MMMessageAssociationEnd<GeneratedReason2, GeneratedReasons2Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmGeneratedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.GeneratedReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public GeneratedReasons2Choice getValue(GeneratedReason2 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(GeneratedReason2 obj, GeneratedReasons2Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GeneratedReason2, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<GeneratedReason2, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(GeneratedReason2 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(GeneratedReason2 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GeneratedReason2.mmCode, com.tools20022.repository.msg.GeneratedReason2.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GeneratedReason2";
	...
	public GeneratedReasons2Choice getCode() {
		return code;
	}

	public GeneratedReason2 setCode(GeneratedReasons2Choice code) {
	...
	public GeneratedReason2 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
