	...
	public static final MMMessageAttribute SequenceType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateOccurrences3.SequenceType;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Frequency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateOccurrences3.Frequency;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Duration = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateOccurrences3.Duration;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FirstCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateOccurrences3.FirstCollectionDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FinalCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateOccurrences3.FinalCollectionDate;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
