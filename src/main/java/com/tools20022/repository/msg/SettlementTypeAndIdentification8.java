...
public class SettlementTypeAndIdentification8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification8.mmAccountOwnerTransactionIdentification, SettlementTypeAndIdentification8.mmAccountServicerTransactionIdentification,
						SettlementTypeAndIdentification8.mmMarketInfrastructureTransactionIdentification, SettlementTypeAndIdentification8.mmSecuritiesMovementType, SettlementTypeAndIdentification8.mmPayment,
						SettlementTypeAndIdentification8.mmCommonIdentification, SettlementTypeAndIdentification8.mmPoolIdentification, SettlementTypeAndIdentification8.mmCorporateActionEventIdentification);
