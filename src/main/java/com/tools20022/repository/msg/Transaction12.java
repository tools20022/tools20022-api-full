...
public class Transaction12 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction12.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	 ...
	 * than a central securities depository, for example, Target2-Securitiess.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails25.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction12.mmAccountOwnerTransactionIdentification, Transaction12.mmAccountServicerTransactionIdentification, Transaction12.mmMarketInfrastructureTransactionIdentification,
						Transaction12.mmProcessorTransactionIdentification, Transaction12.mmTradeIdentification, Transaction12.mmPoolIdentification, Transaction12.mmCommonIdentification, Transaction12.mmCorporateActionEventIdentification,
						Transaction12.mmTripartyAgentCollateralTransactionIdentification, Transaction12.mmClientTripartyCollateralTransactionIdentification, Transaction12.mmTransactionDetails, Transaction12.mmStatusAndReason);
	...
	public TransactionDetails25 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails25 transactionDetails) {
