...
import com.tools20022.repository.msg.StatusAndReason2;
import com.tools20022.repository.msg.TransactionDetails25;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction12
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction12}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction12
 * ConstraintCoexistenceIdentificationRule.forTransaction12}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction12", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class Transaction12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction12, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction12.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(Transaction12 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction12 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transaction12 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction12 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
			...
			definition = "Identification of a transaction assigned by a market infrastructure other than a central securities depository, for example, Target2-Securitiess.";
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction12, List<Max35Text>>() {
		{
		...
		@Override
		public List<Max35Text> getValue(Transaction12 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction12 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction12, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction12, Optional<Max35Text>>() {
		{
	...
	protected TransactionDetails25 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails25
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction12, Optional<TransactionDetails25>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction12, Optional<TransactionDetails25>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails25.mmObject();
		}

		@Override
		public Optional<TransactionDetails25> getValue(Transaction12 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction12 obj, Optional<TransactionDetails25> value) {
			obj.setTransactionDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "StsAndRsn")
	protected List<StatusAndReason2> statusAndReason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction12, List<StatusAndReason2>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction12, List<StatusAndReason2>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> StatusAndReason2.mmObject();
		}

		@Override
		public List<StatusAndReason2> getValue(Transaction12 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction12 obj, List<StatusAndReason2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction12.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction12.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction12.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction12.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction12.mmTradeIdentification, com.tools20022.repository.msg.Transaction12.mmPoolIdentification, com.tools20022.repository.msg.Transaction12.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction12.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction12.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction12.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction12.mmTransactionDetails,
						com.tools20022.repository.msg.Transaction12.mmStatusAndReason);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV02.mmTransactions);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction12,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction12);
				...
				name = "Transaction12";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(Transaction19.mmObject());
			}
		});
	...
	public Transaction12 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction12 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction12 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction12 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction12 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction12 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction12 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction12 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction12 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction12 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails25> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction12 setTransactionDetails(TransactionDetails25 transactionDetails) {
	...
	public Transaction12 setStatusAndReason(List<StatusAndReason2> statusAndReason) {
