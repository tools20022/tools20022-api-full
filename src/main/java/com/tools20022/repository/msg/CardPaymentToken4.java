	...
	public static final MMMessageAttribute mmTokenCharacteristic = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentToken3.mmTokenCharacteristic;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTokenRequestor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentToken3.mmTokenRequestor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTokenAssuranceLevel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentToken3.mmTokenAssuranceLevel;
			maxOccurs = 1;
			minOccurs = 0;
