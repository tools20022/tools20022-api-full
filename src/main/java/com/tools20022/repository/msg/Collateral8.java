...
public class Collateral8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Collateral8.mmMarginCallRequestIdentification, Collateral8.mmMarginCallResponseIdentification, Collateral8.mmStandardSettlementInstructions,
						Collateral8.mmCollateralProposalResponseIdentification, Collateral8.mmSecuritiesCollateral, Collateral8.mmCashCollateral, Collateral8.mmOtherCollateral);
