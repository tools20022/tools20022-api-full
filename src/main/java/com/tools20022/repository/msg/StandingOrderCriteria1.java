...
public class StandingOrderCriteria1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StandingOrderCriteria1.mmNewQueryName, StandingOrderCriteria1.mmSearchCriteria, StandingOrderCriteria1.mmReturnCriteria);
