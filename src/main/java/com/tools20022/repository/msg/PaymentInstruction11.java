...
public class PaymentInstruction11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction11.mmPaymentInformationIdentification, PaymentInstruction11.mmPaymentMethod, PaymentInstruction11.mmPaymentTypeInformation,
						PaymentInstruction11.mmRequestedExecutionDate, PaymentInstruction11.mmDebtor, PaymentInstruction11.mmDebtorAccount, PaymentInstruction11.mmDebtorAgent, PaymentInstruction11.mmUltimateDebtor,
						PaymentInstruction11.mmChargeBearer, PaymentInstruction11.mmCreditTransferTransaction);
