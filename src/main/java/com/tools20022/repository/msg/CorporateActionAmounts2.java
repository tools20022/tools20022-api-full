...
public class CorporateActionAmounts2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionAmounts2.mmPostingAmount, CorporateActionAmounts2.mmGrossCashAmount, CorporateActionAmounts2.mmNetCashAmount, CorporateActionAmounts2.mmSolicitationFees,
						CorporateActionAmounts2.mmCashInLieuOfShare, CorporateActionAmounts2.mmCapitalGain, CorporateActionAmounts2.mmInterestAmount, CorporateActionAmounts2.mmMarketClaimAmount, CorporateActionAmounts2.mmIndemnityAmount,
						CorporateActionAmounts2.mmManufacturedDividendAmount, CorporateActionAmounts2.mmReinvestmentAmount, CorporateActionAmounts2.mmFullyFrankedAmount, CorporateActionAmounts2.mmUnfrankedAmount,
						CorporateActionAmounts2.mmSundryOrOtherAmount, CorporateActionAmounts2.mmCashIncentive, CorporateActionAmounts2.mmTaxFreeAmount, CorporateActionAmounts2.mmTaxDeferredAmount,
						CorporateActionAmounts2.mmValueAddedTaxAmount, CorporateActionAmounts2.mmStampDutyAmount, CorporateActionAmounts2.mmTaxReclaimAmount, CorporateActionAmounts2.mmTaxCreditAmount,
						CorporateActionAmounts2.mmWithholdingOfForeignTaxAmount, CorporateActionAmounts2.mmWithholdingOfLocalTaxAmount, CorporateActionAmounts2.mmAdditionalTaxAmount, CorporateActionAmounts2.mmWithholdingTaxAmount,
						CorporateActionAmounts2.mmFiscalStampAmount, CorporateActionAmounts2.mmExecutingBrokerAmount, CorporateActionAmounts2.mmPayingAgentCommissionAmount, CorporateActionAmounts2.mmLocalBrokerCommissionAmount,
						CorporateActionAmounts2.mmPostageFeeAmount, CorporateActionAmounts2.mmRegulatoryFeesAmount, CorporateActionAmounts2.mmShippingFeesAmount, CorporateActionAmounts2.mmChargesAmount,
						CorporateActionAmounts2.mmCashAmountBroughtForward, CorporateActionAmounts2.mmCashAmountCarriedForward, CorporateActionAmounts2.mmNotionalDividendPayableAmount, CorporateActionAmounts2.mmNotionalTaxAmount,
						CorporateActionAmounts2.mmTaxArrearsAmount, CorporateActionAmounts2.mmOriginalAmount, CorporateActionAmounts2.mmPrincipalOrCorpus, CorporateActionAmounts2.mmRedemptionPremiumAmount,
						CorporateActionAmounts2.mmIncomePortion, CorporateActionAmounts2.mmStockExchangeTax, CorporateActionAmounts2.mmEUTaxRetentionAmount, CorporateActionAmounts2.mmAccruedInterestAmount);
