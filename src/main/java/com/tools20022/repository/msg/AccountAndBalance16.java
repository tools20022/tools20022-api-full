...
import com.tools20022.repository.msg.CorporateActionBalanceDetails11;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule#forAccountAndBalance16
 * ConstraintSafekeepingPlaceRule.forAccountAndBalance16}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AccountAndBalance16", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace", "balance"})
public class AccountAndBalance16 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountAndBalance16, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountAndBalance16, Max35Text>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesAccount.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountAndBalance16.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
		...
		@Override
		public Max35Text getValue(AccountAndBalance16 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(AccountAndBalance16 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance16, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountAndBalance16, Optional<PartyIdentification36Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(AccountAndBalance16 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountAndBalance16 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance16, Optional<SafekeepingPlaceFormat2Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountAndBalance16, Optional<SafekeepingPlaceFormat2Choice>>() {
		{
		...
		@Override
		public Optional<SafekeepingPlaceFormat2Choice> getValue(AccountAndBalance16 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AccountAndBalance16 obj, Optional<SafekeepingPlaceFormat2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance16, CorporateActionBalanceDetails11> mmBalance = new MMMessageAssociationEnd<AccountAndBalance16, CorporateActionBalanceDetails11>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CorporateActionBalanceDetails11.mmObject();
		}

		@Override
		public CorporateActionBalanceDetails11 getValue(AccountAndBalance16 obj) {
			return obj.getBalance();
		}

		@Override
		public void setValue(AccountAndBalance16 obj, CorporateActionBalanceDetails11 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountAndBalance16.mmSafekeepingAccount, com.tools20022.repository.msg.AccountAndBalance16.mmAccountOwner,
						com.tools20022.repository.msg.AccountAndBalance16.mmSafekeepingPlace, com.tools20022.repository.msg.AccountAndBalance16.mmBalance);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementConfirmationV03.mmAccountDetails);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forAccountAndBalance16);
	...
	public AccountAndBalance16 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountAndBalance16 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public AccountAndBalance16 setSafekeepingPlace(SafekeepingPlaceFormat2Choice safekeepingPlace) {
	...
	public AccountAndBalance16 setBalance(CorporateActionBalanceDetails11 balance) {
