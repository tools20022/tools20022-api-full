...
public class CardPaymentTransaction14 {
	...
	public static final MMMessageAttribute TransactionType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction14.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.TransactionType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalService = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.AdditionalService);
			minOccurs = 0;
	...
	public static final MMMessageAttribute ServiceAttribute = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.ServiceAttribute);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.MerchantCategoryCode);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.TransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.OriginalTransaction);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionSuccess = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.TransactionSuccess);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Reversal = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.Reversal);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute MerchantOverride = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.MerchantOverride);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute FailureReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.FailureReason);
			minOccurs = 0;
	...
	public static final MMMessageAttribute InitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.InitiatorTransactionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RecipientTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.RecipientTransactionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.ReconciliationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute InterchangeData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.InterchangeData);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd TransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.TransactionDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AuthorisationResult = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.AuthorisationResult);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionVerificationResult = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.TransactionVerificationResult);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction29.AdditionalTransactionData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction14.TransactionType, com.tools20022.repository.msg.CardPaymentTransaction14.AdditionalService,
						com.tools20022.repository.msg.CardPaymentTransaction14.ServiceAttribute, com.tools20022.repository.msg.CardPaymentTransaction14.MerchantCategoryCode,
						com.tools20022.repository.msg.CardPaymentTransaction14.TransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction14.OriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction14.TransactionSuccess, com.tools20022.repository.msg.CardPaymentTransaction14.Reversal, com.tools20022.repository.msg.CardPaymentTransaction14.MerchantOverride,
						com.tools20022.repository.msg.CardPaymentTransaction14.FailureReason, com.tools20022.repository.msg.CardPaymentTransaction14.InitiatorTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction14.RecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction14.ReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction14.InterchangeData, com.tools20022.repository.msg.CardPaymentTransaction14.TransactionDetails,
						com.tools20022.repository.msg.CardPaymentTransaction14.AuthorisationResult, com.tools20022.repository.msg.CardPaymentTransaction14.TransactionVerificationResult,
						com.tools20022.repository.msg.CardPaymentTransaction14.AdditionalTransactionData);
