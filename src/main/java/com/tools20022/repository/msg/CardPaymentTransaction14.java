...
public class CardPaymentTransaction14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction14.mmTransactionType, CardPaymentTransaction14.mmAdditionalService, CardPaymentTransaction14.mmServiceAttribute,
						CardPaymentTransaction14.mmMerchantCategoryCode, CardPaymentTransaction14.mmTransactionIdentification, CardPaymentTransaction14.mmOriginalTransaction, CardPaymentTransaction14.mmTransactionSuccess,
						CardPaymentTransaction14.mmReversal, CardPaymentTransaction14.mmMerchantOverride, CardPaymentTransaction14.mmFailureReason, CardPaymentTransaction14.mmInitiatorTransactionIdentification,
						CardPaymentTransaction14.mmRecipientTransactionIdentification, CardPaymentTransaction14.mmReconciliationIdentification, CardPaymentTransaction14.mmInterchangeData, CardPaymentTransaction14.mmTransactionDetails,
						CardPaymentTransaction14.mmAuthorisationResult, CardPaymentTransaction14.mmTransactionVerificationResult, CardPaymentTransaction14.mmAdditionalTransactionData);
