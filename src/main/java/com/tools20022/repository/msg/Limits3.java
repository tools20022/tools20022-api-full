...
public class Limits3 {
	...
	protected List<com.tools20022.repository.msg.LimitReport3> currentLimit;
	/**
	...
	public static final MMMessageAssociationEnd mmCurrentLimit = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Limits3.mmObject();
			isDerived = false;
			xmlTag = "CurLmt";
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.LimitReport3.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.LimitReport3> defaultLimit;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Limits3.mmCurrentLimit, Limits3.mmDefaultLimit);
	...
	public void setCurrentLimit(List<com.tools20022.repository.msg.LimitReport3> currentLimit) {
	...
	public void setDefaultLimit(List<com.tools20022.repository.msg.LimitReport3> defaultLimit) {
