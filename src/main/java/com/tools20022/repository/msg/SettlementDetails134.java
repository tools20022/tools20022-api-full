...
public class SettlementDetails134 {
	...
	public static final MMMessageAssociationEnd mmPriority = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SettlementDetails134.mmObject();
			isDerived = false;
			xmlTag = "Prty";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementTransactionConfirmation002V07.mmSettlementParameters,
						com.tools20022.repository.area.sese.SecuritiesSettlementTransactionReversalAdvice002V06.mmSettlementParameters);
	...
	public void setSecuritiesTransactionType(SecuritiesTransactionType24Choice securitiesTransactionType) {
	...
	public RepurchaseType24Choice getRepurchaseType() {
		return repurchaseType;
	}

	public void setRepurchaseType(RepurchaseType24Choice repurchaseType) {
