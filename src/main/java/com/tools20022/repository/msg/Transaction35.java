...
public class Transaction35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction35.mmAccountOwnerTransactionIdentification, Transaction35.mmAccountServicerTransactionIdentification, Transaction35.mmMarketInfrastructureTransactionIdentification,
						Transaction35.mmProcessorTransactionIdentification, Transaction35.mmTradeIdentification, Transaction35.mmPoolIdentification, Transaction35.mmCommonIdentification, Transaction35.mmCorporateActionEventIdentification,
						Transaction35.mmTripartyAgentCollateralTransactionIdentification, Transaction35.mmClientTripartyCollateralTransactionIdentification, Transaction35.mmClientCollateralInstructionIdentification,
						Transaction35.mmTripartyCollateralInstructionIdentification, Transaction35.mmTransactionDetails);
