 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Charge12
 * Charge12}</li>
 * </ul>
 */
public class Charge24 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Charge12#mmType
	 * Charge12.mmType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Charge12.mmType;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Charge12#mmCharges
	...
	public static final MMMessageAssociationEnd mmCharges = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Charge12.mmCharges;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> Charge12.mmObject();
			}
		});
