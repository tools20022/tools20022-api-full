...
public class AggregateBalancePerSafekeepingPlace27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace27.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace27.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace27.mmPledgee,
						AggregateBalancePerSafekeepingPlace27.mmAggregateBalance, AggregateBalancePerSafekeepingPlace27.mmAvailableBalance, AggregateBalancePerSafekeepingPlace27.mmNotAvailableBalance,
						AggregateBalancePerSafekeepingPlace27.mmPriceDetails, AggregateBalancePerSafekeepingPlace27.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace27.mmDaysAccrued,
						AggregateBalancePerSafekeepingPlace27.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace27.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace27.mmQuantityBreakdown,
						AggregateBalancePerSafekeepingPlace27.mmExposureType, AggregateBalancePerSafekeepingPlace27.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace27.mmAdditionalBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace27.mmHoldingAdditionalDetails);
