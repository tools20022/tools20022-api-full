...
import com.tools20022.repository.choice.AllegmentReason1Choice;
...
@XmlType(name = "AllegmentMatchingReason1", propOrder = {"code", "additionalReasonInformation"})
public class AllegmentMatchingReason1 {
	 ...
	 * complexType} =
	 * {@linkplain com.tools20022.repository.choice.AllegmentReason1Choice
	 * AllegmentReason1Choice}</li>
	 * <li>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AllegmentMatchingReason1
	 * AllegmentMatchingReason1}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AllegmentMatchingReason1, AllegmentReason1Choice> mmCode = new MMMessageAttribute<AllegmentMatchingReason1, AllegmentReason1Choice>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AllegmentMatchingReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction has been alleged.";
			nextVersions_lazy = () -> Arrays.asList(AllegementMatchingReason1.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AllegmentReason1Choice getValue(AllegmentMatchingReason1 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AllegmentMatchingReason1 obj, AllegmentReason1Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AllegmentMatchingReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AllegmentMatchingReason1, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AllegementMatchingReason1.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(AllegmentMatchingReason1 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(AllegmentMatchingReason1 obj, Optional<Max210Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(AllegementMatchingReason1.mmObject());
			}
		});
	...
	public AllegmentMatchingReason1 setCode(AllegmentReason1Choice code) {
	...
	public AllegmentMatchingReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
