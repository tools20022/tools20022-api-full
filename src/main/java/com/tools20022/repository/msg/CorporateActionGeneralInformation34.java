...
public class CorporateActionGeneralInformation34 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation34.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation34.mmCorporateActionEventIdentification, CorporateActionGeneralInformation34.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation34.mmClassActionNumber, CorporateActionGeneralInformation34.mmEventType);
