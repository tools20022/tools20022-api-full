...
public class QuantityBreakdown10 {
	...
	public static final MMMessageAssociationEnd mmLotNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> QuantityBreakdown10.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown10.mmLotNumber, QuantityBreakdown10.mmLotQuantity, QuantityBreakdown10.mmSecuritiesSubBalanceType, QuantityBreakdown10.mmLotDateTime,
						QuantityBreakdown10.mmLotPrice, QuantityBreakdown10.mmTypeOfPrice);
