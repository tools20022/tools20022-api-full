...
public class RejectionReason14 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason14.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason14.mmCode, RejectionReason14.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason12Choice code) {
		this.code = code;
	}
