...
public class RedemptionBulkExecution2 {
	...
	protected List<com.tools20022.repository.msg.RedemptionExecution3> individualExecutionDetails;
	/**
	 * Execution of a redemption order.
	 * <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmIndividualExecutionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.RedemptionExecution3.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RedemptionBulkExecution2.mmPlaceOfTrade, RedemptionBulkExecution2.mmOrderDateTime, RedemptionBulkExecution2.mmCancellationRight,
						RedemptionBulkExecution2.mmFinancialInstrumentDetails, RedemptionBulkExecution2.mmIndividualExecutionDetails, RedemptionBulkExecution2.mmRequestedSettlementCurrency, RedemptionBulkExecution2.mmRequestedNAVCurrency,
						RedemptionBulkExecution2.mmBulkCashSettlementDetails);
	...
	public void setIndividualExecutionDetails(List<com.tools20022.repository.msg.RedemptionExecution3> individualExecutionDetails) {
