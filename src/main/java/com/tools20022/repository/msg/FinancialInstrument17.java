...
public class FinancialInstrument17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrument17.mmIdentification, FinancialInstrument17.mmName, FinancialInstrument17.mmSupplementaryIdentification, FinancialInstrument17.mmClassType,
						FinancialInstrument17.mmSecuritiesForm, FinancialInstrument17.mmDistributionPolicy, FinancialInstrument17.mmProductGroup);
