...
public class SettlementDetails100 {
	...
	public static final MMMessageAttribute SettlementTransactionCondition = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.SettlementTransactionCondition;
			minOccurs = 0;
	...
	public static final MMMessageAttribute Registration = new MMMessageAttribute() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.Registration;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LegalRestrictions = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.LegalRestrictions;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesRTGS = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.SecuritiesRTGS;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SettlementSystemMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.SettlementSystemMethod;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TaxCapacity = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.TaxCapacity;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute StampDutyTaxBasis = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails4.StampDutyTaxBasis;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails100.SettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails100.Registration,
						com.tools20022.repository.msg.SettlementDetails100.LegalRestrictions, com.tools20022.repository.msg.SettlementDetails100.SecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails100.SettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails100.TaxCapacity, com.tools20022.repository.msg.SettlementDetails100.StampDutyTaxBasis);
