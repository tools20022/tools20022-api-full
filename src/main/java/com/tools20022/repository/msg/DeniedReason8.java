...
public class DeniedReason8 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason8.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedReason8.mmCode, DeniedReason8.mmAdditionalReasonInformation);
	...
	public void setCode(DeniedReason11Choice code) {
		this.code = code;
	}
