...
public class CorporateActionRate49 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate49.mmAdditionalQuantityForSubscribedResultantSecurities, CorporateActionRate49.mmAdditionalQuantityForExistingSecurities, CorporateActionRate49.mmNewToOld,
						CorporateActionRate49.mmChargesFees, CorporateActionRate49.mmFiscalStamp, CorporateActionRate49.mmApplicableRate, CorporateActionRate49.mmTaxCreditRate, CorporateActionRate49.mmFinancialTransactionTaxRate);
