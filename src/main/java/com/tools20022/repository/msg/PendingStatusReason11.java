...
public class PendingStatusReason11 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingStatusReason11.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatusReason11.mmReasonCode, PendingStatusReason11.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingReason34Choice reasonCode) {
