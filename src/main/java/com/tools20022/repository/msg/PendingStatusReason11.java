...
import com.tools20022.repository.choice.PendingReason34Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forPendingStatusReason11
 * ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason11}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PendingStatusReason11", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason11 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason34Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.PendingReason34Choice
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason11.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason11.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason11);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatusReason11";
	...
	public PendingReason34Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason11 setReasonCode(PendingReason34Choice reasonCode) {
	...
	public PendingStatusReason11 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
