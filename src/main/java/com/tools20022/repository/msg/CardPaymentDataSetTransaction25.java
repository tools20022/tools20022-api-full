...
public class CardPaymentDataSetTransaction25 {
	...
	public static final MMMessageAttribute mmTransactionResponse = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction84.mmObject();
		}
	};
	...
	public CardPaymentDataSetTransaction25 setTraceability(List<com.tools20022.repository.msg.Traceability5> traceability) {
	...
	public CardPaymentDataSetTransaction25 setEnvironment(com.tools20022.repository.msg.CardPaymentEnvironment69 environment) {
	...
	public CardPaymentDataSetTransaction25 setTransaction(com.tools20022.repository.msg.CardPaymentTransaction78 transaction) {
	...
	public CardPaymentDataSetTransaction25 setTransactionResponse(com.tools20022.repository.msg.CardPaymentTransaction84 transactionResponse) {
