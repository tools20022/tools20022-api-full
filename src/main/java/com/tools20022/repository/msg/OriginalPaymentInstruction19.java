...
public class OriginalPaymentInstruction19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction19.mmOriginalPaymentInformationIdentification, OriginalPaymentInstruction19.mmOriginalNumberOfTransactions,
						OriginalPaymentInstruction19.mmOriginalControlSum, OriginalPaymentInstruction19.mmPaymentInformationStatus, OriginalPaymentInstruction19.mmStatusReasonInformation,
						OriginalPaymentInstruction19.mmNumberOfTransactionsPerStatus, OriginalPaymentInstruction19.mmTransactionInformationAndStatus);
