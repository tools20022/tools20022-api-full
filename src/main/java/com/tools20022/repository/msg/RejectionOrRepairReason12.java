...
public class RejectionOrRepairReason12 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason12.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason12.mmCode, RejectionOrRepairReason12.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason12Choice code) {
		this.code = code;
	}
