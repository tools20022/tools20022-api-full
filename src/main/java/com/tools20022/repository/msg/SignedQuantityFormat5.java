 ...
 * <li>{@linkplain com.tools20022.repository.msg.SignedQuantityFormat5#Quantity
...
public class SignedQuantityFormat5 {
	...
	public static final MMMessageAttribute ShortLongPosition = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SignedQuantityFormat5.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SignedQuantityFormat5.ShortLongPosition, com.tools20022.repository.msg.SignedQuantityFormat5.Quantity);
