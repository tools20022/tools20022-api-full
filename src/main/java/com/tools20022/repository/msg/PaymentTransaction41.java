...
public class PaymentTransaction41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction41.mmStatusIdentification, PaymentTransaction41.mmOriginalInstructionIdentification, PaymentTransaction41.mmOriginalEndToEndIdentification,
						PaymentTransaction41.mmTransactionStatus, PaymentTransaction41.mmStatusReasonInformation, PaymentTransaction41.mmChargesInformation, PaymentTransaction41.mmAcceptanceDateTime,
						PaymentTransaction41.mmAccountServicerReference, PaymentTransaction41.mmClearingSystemReference, PaymentTransaction41.mmOriginalTransactionReference);
