...
public class RateDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateDetails3.mmAdditionalTax, RateDetails3.mmGrossDividendRate, RateDetails3.mmInterestRateUsedForPayment, RateDetails3.mmTaxRelatedRate, RateDetails3.mmWithholdingTaxRate,
						RateDetails3.mmChargesFees, RateDetails3.mmEarlySolicitationFeeRate, RateDetails3.mmFinalDividendRate, RateDetails3.mmFiscalStamp, RateDetails3.mmFullyFrankedRate, RateDetails3.mmCashIncentiveRate,
						RateDetails3.mmNetDividendRate, RateDetails3.mmNonResidentRate, RateDetails3.mmProvisionalDividendRate, RateDetails3.mmApplicableRate, RateDetails3.mmSolicitationFeeRate, RateDetails3.mmTaxCreditRate,
						RateDetails3.mmTaxOnIncome, RateDetails3.mmTaxOnProfits, RateDetails3.mmTaxReclaimRate, RateDetails3.mmWithholdingOfForeignTax, RateDetails3.mmWithholdingOfLocalTax);
	...
	public SolicitationFeeRateFormat3Choice getEarlySolicitationFeeRate() {
		return earlySolicitationFeeRate;
	}

	public void setEarlySolicitationFeeRate(SolicitationFeeRateFormat3Choice earlySolicitationFeeRate) {
	...
	public SolicitationFeeRateFormat3Choice getSolicitationFeeRate() {
		return solicitationFeeRate;
	}

	public void setSolicitationFeeRate(SolicitationFeeRateFormat3Choice solicitationFeeRate) {
