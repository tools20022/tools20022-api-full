...
import com.tools20022.repository.choice.RejectionAndRepairReason4Choice;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.RejectionOrRepairReason14
...
@XmlType(name = "RejectionOrRepairReason4", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason4 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd")
	protected List<RejectionAndRepairReason4Choice> code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason4.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason4.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairReason4";
				definition = "Reason for the rejection or repair status.";
				nextVersions_lazy = () -> Arrays.asList(RejectionOrRepairReason14.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public List<RejectionAndRepairReason4Choice> getCode() {
		return code == null ? code = new ArrayList<>() : code;
	}

	public RejectionOrRepairReason4 setCode(List<RejectionAndRepairReason4Choice> code) {
	...
	public RejectionOrRepairReason4 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
