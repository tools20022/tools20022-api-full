...
public class RejectionOrRepairReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason4.mmCode, RejectionOrRepairReason4.mmAdditionalReasonInformation);
	...
	public void setCode(List<RejectionAndRepairReason4Choice> code) {
		this.code = code;
	}
