...
@XmlType(name = "CancellationReason12", propOrder = {"code", "additionalReasonInformation"})
public class CancellationReason12 {
	...
	public static final MMMessageAssociationEnd<CancellationReason12, CancellationReason23Choice> mmCode = new MMMessageAssociationEnd<CancellationReason12, CancellationReason23Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason13.mmCode);
			previousVersion_lazy = () -> CancellationReason1.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<CancellationReason12, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancellationReason12, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason13.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> CancellationReason1.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public CancellationReason12 setCode(CancellationReason23Choice code) {
	...
	public CancellationReason12 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
