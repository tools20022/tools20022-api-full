...
public class OtherAmounts5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OtherAmounts5.mmAccruedInterestAmount, OtherAmounts5.mmChargesFees, OtherAmounts5.mmCountryNationalFederalTax, OtherAmounts5.mmTradeAmount, OtherAmounts5.mmExecutingBrokerAmount,
						OtherAmounts5.mmIssueDiscountAllowance, OtherAmounts5.mmPaymentLevyTax, OtherAmounts5.mmLocalTax, OtherAmounts5.mmLocalBrokerCommission, OtherAmounts5.mmMargin, OtherAmounts5.mmOther, OtherAmounts5.mmPostageAmount,
						OtherAmounts5.mmRegulatoryAmount, OtherAmounts5.mmShippingAmount, OtherAmounts5.mmSpecialConcession, OtherAmounts5.mmStampDuty, OtherAmounts5.mmStockExchangeTax, OtherAmounts5.mmTransferTax,
						OtherAmounts5.mmTransactionTax, OtherAmounts5.mmValueAddedTax, OtherAmounts5.mmWithholdingTax, OtherAmounts5.mmNetGainLoss, OtherAmounts5.mmConsumptionTax, OtherAmounts5.mmAccruedCapitalisationAmount,
						OtherAmounts5.mmBookValue);
