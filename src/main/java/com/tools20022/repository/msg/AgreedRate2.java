 ...
 * <li>{@linkplain com.tools20022.repository.msg.AgreedRate2#mmQuotedCurrency
...
@XmlType(name = "AgreedRate2", propOrder = {"exchangeRate", "unitCurrency", "quotedCurrency"})
public class AgreedRate2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AgreedRate2 AgreedRate2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgreedRate2, BaseOneRate> mmExchangeRate = new MMMessageAttribute<AgreedRate2, BaseOneRate>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmExchangeRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.AgreedRate2.mmObject();
			isDerived = false;
			xmlTag = "XchgRate";
		...
		@Override
		public BaseOneRate getValue(AgreedRate2 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(AgreedRate2 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgreedRate2, CurrencyCode> mmUnitCurrency = new MMMessageAttribute<AgreedRate2, CurrencyCode>() {
		{
		...
		@Override
		public CurrencyCode getValue(AgreedRate2 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(AgreedRate2 obj, CurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgreedRate2, CurrencyCode> mmQuotedCurrency = new MMMessageAttribute<AgreedRate2, CurrencyCode>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AgreedRate2.mmExchangeRate, com.tools20022.repository.msg.AgreedRate2.mmUnitCurrency, com.tools20022.repository.msg.AgreedRate2.mmQuotedCurrency);
	...
	public AgreedRate2 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public AgreedRate2 setUnitCurrency(CurrencyCode unitCurrency) {
	...
	public AgreedRate2 setQuotedCurrency(CurrencyCode quotedCurrency) {
