...
public class InvestmentAccountOwnershipInformation9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccountOwnershipInformation9.mmParty, InvestmentAccountOwnershipInformation9.mmMoneyLaunderingCheck, InvestmentAccountOwnershipInformation9.mmInvestorProfileValidation,
						InvestmentAccountOwnershipInformation9.mmOwnershipBeneficiaryRate, InvestmentAccountOwnershipInformation9.mmClientIdentification, InvestmentAccountOwnershipInformation9.mmFiscalExemption,
						InvestmentAccountOwnershipInformation9.mmSignatoryRightIndicator, InvestmentAccountOwnershipInformation9.mmMiFIDClassification, InvestmentAccountOwnershipInformation9.mmInformationDistribution);
