 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentDataSetTransaction21#TransactionSequenceCounter
 * CardPaymentDataSetTransaction21.TransactionSequenceCounter}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentDataSetTransaction21#Traceability
 * CardPaymentDataSetTransaction21.Traceability}</li>
 * <li>
...
public class CardPaymentDataSetTransaction21 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardPaymentDataSetTransaction17#TransactionSequenceCounter
	 * CardPaymentDataSetTransaction17.TransactionSequenceCounter}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute TransactionSequenceCounter = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction17.TransactionSequenceCounter;
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardPaymentDataSetTransaction17#Traceability
	 * CardPaymentDataSetTransaction17.Traceability}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Traceability = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction17.Traceability;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Environment = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction17.Environment;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Transaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction17.Transaction;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionResponse = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction17.TransactionResponse;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction21.TransactionSequenceCounter, com.tools20022.repository.msg.CardPaymentDataSetTransaction21.Traceability,
						com.tools20022.repository.msg.CardPaymentDataSetTransaction21.Environment, com.tools20022.repository.msg.CardPaymentDataSetTransaction21.Transaction,
						com.tools20022.repository.msg.CardPaymentDataSetTransaction21.TransactionResponse);
