...
public class CardPaymentTransaction12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction12.mmTransactionIdentification, CardPaymentTransaction12.mmRecipientTransactionIdentification, CardPaymentTransaction12.mmReconciliationIdentification,
						CardPaymentTransaction12.mmInterchangeData, CardPaymentTransaction12.mmTransactionDetails);
