...
public class SecuritiesSettlementTransactionDetails31 {
	...
	public static final MMMessageAssociationEnd mmSettlementTypeAndAdditionalParameters = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesSettlementTransactionDetails31.mmObject();
			isDerived = false;
	...
	public QuantityAndAccount60 getQuantityAndAccountDetails() {
		return quantityAndAccountDetails;
	}

	public void setQuantityAndAccountDetails(com.tools20022.repository.msg.QuantityAndAccount60 quantityAndAccountDetails) {
