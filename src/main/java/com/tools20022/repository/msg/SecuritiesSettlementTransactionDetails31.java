...
public class SecuritiesSettlementTransactionDetails31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails31.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails31.mmLinkages,
						SecuritiesSettlementTransactionDetails31.mmTradeDetails, SecuritiesSettlementTransactionDetails31.mmFinancialInstrumentIdentification, SecuritiesSettlementTransactionDetails31.mmFinancialInstrumentAttributes,
						SecuritiesSettlementTransactionDetails31.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionDetails31.mmSettlementParameters, SecuritiesSettlementTransactionDetails31.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails31.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails31.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails31.mmCashParties,
						SecuritiesSettlementTransactionDetails31.mmSettlementAmount, SecuritiesSettlementTransactionDetails31.mmOtherAmounts, SecuritiesSettlementTransactionDetails31.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails31.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails31.mmSupplementaryData);
