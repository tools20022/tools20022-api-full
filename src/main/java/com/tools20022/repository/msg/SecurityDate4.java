...
public class SecurityDate4 {
	...
	public static final MMMessageAssociationEnd mmPaymentDate = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecurityDate4.mmObject();
			isDerived = false;
			xmlTag = "PmtDt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecurityDate4.mmPaymentDate, SecurityDate4.mmAvailableDate, SecurityDate4.mmDividendRankingDate, SecurityDate4.mmEarliestPaymentDate, SecurityDate4.mmPariPassuDate);
