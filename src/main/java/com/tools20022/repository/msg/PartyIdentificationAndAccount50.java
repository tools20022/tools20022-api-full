 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PartyIdentificationAndAccount50#AdditionalInformation
 * PartyIdentificationAndAccount50.AdditionalInformation}</li>
 * </ul>
 * </li>
...
public class PartyIdentificationAndAccount50 {
	...
	public static final MMMessageAssociationEnd Identification = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PartyIdentificationAndAccount50.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.Identification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AlternateIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.AlternateIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.CashAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChargesAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.ChargesAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CommissionAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.CommissionAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd TaxAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.TaxAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccountIdentification5Choice.mmObject();
			isComposite = true;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PartyIdentificationAndAccount112#AdditionalInformation
	 * PartyIdentificationAndAccount112.AdditionalInformation}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd AdditionalInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount112.AdditionalInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount50.Identification, com.tools20022.repository.msg.PartyIdentificationAndAccount50.AlternateIdentification,
						...
						com.tools20022.repository.msg.PartyIdentificationAndAccount50.CommissionAccount, com.tools20022.repository.msg.PartyIdentificationAndAccount50.TaxAccount,
						com.tools20022.repository.msg.PartyIdentificationAndAccount50.AdditionalInformation);
