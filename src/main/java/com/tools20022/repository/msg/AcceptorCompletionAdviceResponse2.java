...
public class AcceptorCompletionAdviceResponse2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCompletionAdviceResponse2.mmEnvironment, AcceptorCompletionAdviceResponse2.mmTransaction, AcceptorCompletionAdviceResponse2.mmTMSTrigger);
