...
public class AccountAndBalance37 {
	...
	public static final MMMessageAssociationEnd mmBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionBalanceDetails34.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance37.mmSafekeepingAccount, AccountAndBalance37.mmAccountOwner, AccountAndBalance37.mmSafekeepingPlace, AccountAndBalance37.mmBalance);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstruction002V07.mmAccountDetails);
	...
	@XmlElement(name = "Bal")
	public CorporateActionBalanceDetails34 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails34 balance) {
