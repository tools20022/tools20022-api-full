...
public class FinancialInstrumentAttributes39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes39.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes39.mmPlaceOfListing, FinancialInstrumentAttributes39.mmDayCountBasis,
						FinancialInstrumentAttributes39.mmClassificationType, FinancialInstrumentAttributes39.mmOptionStyle, FinancialInstrumentAttributes39.mmDenominationCurrency, FinancialInstrumentAttributes39.mmNextCouponDate,
						FinancialInstrumentAttributes39.mmExpiryDate, FinancialInstrumentAttributes39.mmFloatingRateFixingDate, FinancialInstrumentAttributes39.mmMaturityDate, FinancialInstrumentAttributes39.mmIssueDate,
						FinancialInstrumentAttributes39.mmNextCallableDate, FinancialInstrumentAttributes39.mmPutableDate, FinancialInstrumentAttributes39.mmDatedDate, FinancialInstrumentAttributes39.mmConversionDate,
						FinancialInstrumentAttributes39.mmInterestRate, FinancialInstrumentAttributes39.mmNextInterestRate, FinancialInstrumentAttributes39.mmPercentageOfDebtClaim, FinancialInstrumentAttributes39.mmPreviousFactor,
						FinancialInstrumentAttributes39.mmNextFactor, FinancialInstrumentAttributes39.mmMinimumNominalQuantity, FinancialInstrumentAttributes39.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes39.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes39.mmContractSize);
