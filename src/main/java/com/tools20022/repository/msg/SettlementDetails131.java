...
public class SettlementDetails131 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails131.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails131.mmHoldIndicator, SettlementDetails131.mmSecuritiesTransactionType, SettlementDetails131.mmSettlementTransactionCondition,
						SettlementDetails131.mmPartialSettlementIndicator, SettlementDetails131.mmBeneficialOwnership, SettlementDetails131.mmCashClearingSystem, SettlementDetails131.mmMarketClientSide, SettlementDetails131.mmRegistration,
						SettlementDetails131.mmRepurchaseType, SettlementDetails131.mmSecuritiesRTGS, SettlementDetails131.mmStampDutyTaxBasis);
	...
	public void setSecuritiesTransactionType(SecuritiesTransactionType35Choice securitiesTransactionType) {
	...
	public void setSettlementTransactionCondition(List<SettlementTransactionCondition26Choice> settlementTransactionCondition) {
	...
	public void setRepurchaseType(RepurchaseType17Choice repurchaseType) {
