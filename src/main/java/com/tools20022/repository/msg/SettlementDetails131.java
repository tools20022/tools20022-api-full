 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementDetailsRule#forSettlementDetails131
 * ConstraintSettlementDetailsRule.forSettlementDetails131}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCashClearingSystemRule#forSettlementDetails131
 * ConstraintCashClearingSystemRule.forSettlementDetails131}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlementDetails131 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails131, Optional<YesNoIndicator>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails131, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails131.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails131 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<YesNoIndicator> value) {
			obj.setHoldIndicator(value.orElse(null));
		}
	};
	@XmlElement(name = "SctiesTxTp", required = true)
	protected SecuritiesTransactionType35Choice securitiesTransactionType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, SecuritiesTransactionType35Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails131, SecuritiesTransactionType35Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SecuritiesTransactionType35Choice.mmObject();
		}

		@Override
		public SecuritiesTransactionType35Choice getValue(SettlementDetails131 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails131 obj, SecuritiesTransactionType35Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, List<SettlementTransactionCondition26Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails131, List<SettlementTransactionCondition26Choice>>() {
		{
		...
		@Override
		public List<SettlementTransactionCondition26Choice> getValue(SettlementDetails131 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails131 obj, List<SettlementTransactionCondition26Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails131, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails131, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails131.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails131 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<BeneficialOwnership5Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails131, Optional<BeneficialOwnership5Choice>>() {
		{
		...
		@Override
		public Optional<BeneficialOwnership5Choice> getValue(SettlementDetails131 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<BeneficialOwnership5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<CashSettlementSystem5Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails131, Optional<CashSettlementSystem5Choice>>() {
		{
		...
		@Override
		public Optional<CashSettlementSystem5Choice> getValue(SettlementDetails131 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<CashSettlementSystem5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<MarketClientSide5Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails131, Optional<MarketClientSide5Choice>>() {
		{
		...
		@Override
		public Optional<MarketClientSide5Choice> getValue(SettlementDetails131 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<MarketClientSide5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<Registration11Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails131, Optional<Registration11Choice>>() {
		{
		...
		@Override
		public Optional<Registration11Choice> getValue(SettlementDetails131 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<Registration11Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<RepurchaseType17Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails131, Optional<RepurchaseType17Choice>>() {
		{
		...
		@Override
		public Optional<RepurchaseType17Choice> getValue(SettlementDetails131 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<RepurchaseType17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<SecuritiesRTGS5Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails131, Optional<SecuritiesRTGS5Choice>>() {
		{
		...
		@Override
		public Optional<SecuritiesRTGS5Choice> getValue(SettlementDetails131 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<SecuritiesRTGS5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails131, Optional<GenericIdentification47>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails131, Optional<GenericIdentification47>>() {
		{
		...
		@Override
		public Optional<GenericIdentification47> getValue(SettlementDetails131 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails131 obj, Optional<GenericIdentification47> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails131.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails131.mmSecuritiesTransactionType,
						...
						com.tools20022.repository.msg.SettlementDetails131.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails131.mmCashClearingSystem,
						com.tools20022.repository.msg.SettlementDetails131.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails131.mmRegistration, com.tools20022.repository.msg.SettlementDetails131.mmRepurchaseType,
						com.tools20022.repository.msg.SettlementDetails131.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails131.mmStampDutyTaxBasis);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAllegementNotification002V06.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails131,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails131);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails131";
	...
	public SettlementDetails131 setHoldIndicator(YesNoIndicator holdIndicator) {
	...
	public SettlementDetails131 setSecuritiesTransactionType(SecuritiesTransactionType35Choice securitiesTransactionType) {
	...
	public SettlementDetails131 setSettlementTransactionCondition(List<SettlementTransactionCondition26Choice> settlementTransactionCondition) {
	...
	public SettlementDetails131 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails131 setBeneficialOwnership(BeneficialOwnership5Choice beneficialOwnership) {
	...
	public SettlementDetails131 setCashClearingSystem(CashSettlementSystem5Choice cashClearingSystem) {
	...
	public SettlementDetails131 setMarketClientSide(MarketClientSide5Choice marketClientSide) {
	...
	public SettlementDetails131 setRegistration(Registration11Choice registration) {
	...
	public SettlementDetails131 setRepurchaseType(RepurchaseType17Choice repurchaseType) {
	...
	public SettlementDetails131 setSecuritiesRTGS(SecuritiesRTGS5Choice securitiesRTGS) {
	...
	public SettlementDetails131 setStampDutyTaxBasis(GenericIdentification47 stampDutyTaxBasis) {
