 ...
 * TransactionIdentifications31.mmMarketInfrastructureTransactionIdentification}
 * </li>
 * <li>
...
@XmlType(name = "TransactionIdentifications31", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class TransactionIdentifications31 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications31, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications31.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			previousVersion_lazy = () -> TransactionIdentifications16.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionIdentifications31 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications31 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications16.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionIdentifications31 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications31 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications16.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications16.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications16.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>> mmNettingServiceProviderIdentification = new MMMessageAttribute<TransactionIdentifications31, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications31.mmObject();
			isDerived = false;
			...
			definition = "Identification assigned by the netting service provider to identify the net transaction resulting from the netting process.";
			previousVersion_lazy = () -> TransactionIdentifications16.mmNettingServiceProviderIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionIdentifications31.mmAccountOwnerTransactionIdentification,
				...
				name = "TransactionIdentifications31";
				definition = "Provides transaction type and identification information.";
				previousVersion_lazy = () -> TransactionIdentifications16.mmObject();
			}
		});
	...
	public TransactionIdentifications31 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionIdentifications31 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionIdentifications31 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public TransactionIdentifications31 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public TransactionIdentifications31 setCommonIdentification(Max35Text commonIdentification) {
	...
	public TransactionIdentifications31 setNettingServiceProviderIdentification(Max35Text nettingServiceProviderIdentification) {
