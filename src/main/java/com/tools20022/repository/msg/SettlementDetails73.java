...
@XmlType(name = "SettlementDetails73", propOrder = {"holdIndicator", "settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "beneficialOwnership", "cashClearingSystem", "taxCapacity",
...
public class SettlementDetails73 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails73, Optional<YesNoIndicator>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails73, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails73.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "HoldIndicator";
			definition = "Specifies whether the transaction is on hold/blocked/frozen.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmHoldIndicator);
			previousVersion_lazy = () -> SettlementDetails61.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails73 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, List<SettlementTransactionCondition7Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails73, List<SettlementTransactionCondition7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails61.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition7Choice> getValue(SettlementDetails73 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails73 obj, List<SettlementTransactionCondition7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<SettlingCapacity4Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails73, Optional<SettlingCapacity4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails61.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity4Choice> getValue(SettlementDetails73 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<SettlingCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails73, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails61.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails73 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails73, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails61.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails73 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails73, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails61.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails73 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails73, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails61.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails73 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails73, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails61.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails73 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails73, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails61.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails73 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails73, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails61.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails73 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails73, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails61.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails73 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails73, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails61.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails73 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails73, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails61.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails73 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails73, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails73, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails61.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails73 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails73, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails73, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails73.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails61.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails73 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails73 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails73, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails73, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmEligibleForCollateral);
			previousVersion_lazy = () -> SettlementDetails61.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails73.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails73.mmSettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails73.mmSettlingCapacity, com.tools20022.repository.msg.SettlementDetails73.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails73.mmSecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails73.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails73.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails73.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails73.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails73.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails73.mmLegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails73.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails73.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails73.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails73.mmPartialSettlementIndicator, com.tools20022.repository.msg.SettlementDetails73.mmEligibleForCollateral);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails73,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails73);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails73";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails98.mmObject());
				previousVersion_lazy = () -> SettlementDetails61.mmObject();
			}
		});
	...
	public SettlementDetails73 setHoldIndicator(YesNoIndicator holdIndicator) {
	...
	public SettlementDetails73 setSettlementTransactionCondition(List<SettlementTransactionCondition7Choice> settlementTransactionCondition) {
	...
	public SettlementDetails73 setSettlingCapacity(SettlingCapacity4Choice settlingCapacity) {
	...
	public SettlementDetails73 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails73 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails73 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails73 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails73 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails73 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails73 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails73 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails73 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails73 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails73 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails73 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails73 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
