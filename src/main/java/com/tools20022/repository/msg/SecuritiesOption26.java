...
public class SecuritiesOption26 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption26.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public CorporateActionPrice27 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice27 priceDetails) {
