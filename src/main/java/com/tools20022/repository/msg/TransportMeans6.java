...
public class TransportMeans6 {
	...
	public static final MMMessageAssociationEnd IndividualTransport = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransportMeans4.IndividualTransport;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MultimodalTransport = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransportMeans4.MultimodalTransport;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportMeans6.IndividualTransport, com.tools20022.repository.msg.TransportMeans6.MultimodalTransport);
