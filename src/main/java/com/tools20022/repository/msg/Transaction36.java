...
import com.tools20022.repository.msg.TransactionDetails63;
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction29
 * Transaction29}</li>
 * </ul>
 */
...
public class Transaction36 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction36, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction36.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction36 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction36 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmAccountServicerTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction36 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction36 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmMarketInfrastructureTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmProcessorTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction36, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmTradeIdentification);
			previousVersion_lazy = () -> Transaction29.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction36 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction36 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmPoolIdentification);
			previousVersion_lazy = () -> Transaction29.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmCommonIdentification);
			previousVersion_lazy = () -> Transaction29.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> Transaction29.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmTripartyAgentCollateralTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmTripartyAgentCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmClientTripartyCollateralTransactionIdentification);
			previousVersion_lazy = () -> Transaction29.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmClientCollateralInstructionIdentification);
			previousVersion_lazy = () -> Transaction29.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction36, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<Transaction36, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction36.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmTripartyCollateralInstructionIdentification);
			previousVersion_lazy = () -> Transaction29.mmTripartyCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected TransactionDetails63 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails63
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction36, Optional<TransactionDetails63>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction36, Optional<TransactionDetails63>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmTransactionDetails);
			previousVersion_lazy = () -> Transaction29.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails63.mmObject();
		}

		@Override
		public Optional<TransactionDetails63> getValue(Transaction36 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction36 obj, Optional<TransactionDetails63> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transaction29#mmSupplementaryData
	 * Transaction29.mmSupplementaryData}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction36, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<Transaction36, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction36.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction46.mmSupplementaryData);
			previousVersion_lazy = () -> Transaction29.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(Transaction36 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(Transaction36 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction36.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction36.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction36.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction36.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction36.mmTradeIdentification, com.tools20022.repository.msg.Transaction36.mmPoolIdentification, com.tools20022.repository.msg.Transaction36.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction36.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction36.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction36.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction36.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.Transaction36.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction36.mmTransactionDetails,
						com.tools20022.repository.msg.Transaction36.mmSupplementaryData);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction36,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction36);
				...
				name = "Transaction36";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(Transaction46.mmObject());
				previousVersion_lazy = () -> Transaction29.mmObject();
			}
		});
	...
	public Transaction36 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction36 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction36 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction36 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction36 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction36 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction36 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction36 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction36 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction36 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public Transaction36 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction36 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
		this.tripartyCollateralInstructionIdentification = tripartyCollateralInstructionIdentification;
		return this;
	}

	public Optional<TransactionDetails63> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction36 setTransactionDetails(TransactionDetails63 transactionDetails) {
	...
	public Transaction36 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
