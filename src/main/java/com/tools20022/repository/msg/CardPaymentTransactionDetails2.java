...
public class CardPaymentTransactionDetails2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails2.mmCurrency, CardPaymentTransactionDetails2.mmTotalAmount, CardPaymentTransactionDetails2.mmDetailedAmount,
						CardPaymentTransactionDetails2.mmValidityDate, CardPaymentTransactionDetails2.mmAccountType, CardPaymentTransactionDetails2.mmICCRelatedData);
