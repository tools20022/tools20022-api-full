...
public class CorporateActionOption30 {
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice20.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption30.mmOptionNumber, CorporateActionOption30.mmOptionType, CorporateActionOption30.mmFractionDisposition, CorporateActionOption30.mmChangeType,
						CorporateActionOption30.mmEligibleForCollateralIndicator, CorporateActionOption30.mmCurrencyToBuy, CorporateActionOption30.mmCurrencyToSell, CorporateActionOption30.mmCurrencyOption,
						CorporateActionOption30.mmSecurityIdentification, CorporateActionOption30.mmSecuritiesQuantity, CorporateActionOption30.mmExecutionRequestedDateTime, CorporateActionOption30.mmRateAndAmountDetails,
						CorporateActionOption30.mmPriceDetails, CorporateActionOption30.mmAdditionalInformation);
	...
	public FractionDispositionType11Choice getFractionDisposition() {
		return fractionDisposition;
	}

	public void setFractionDisposition(FractionDispositionType11Choice fractionDisposition) {
	...
	public CorporateActionPrice20 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice20 priceDetails) {
