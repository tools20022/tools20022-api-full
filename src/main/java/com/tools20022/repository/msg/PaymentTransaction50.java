 ...
 * forPaymentTransaction50}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChargesInformationAndReturnedInstructedAmountRule#forPaymentTransaction50
...
@XmlType(name = "PaymentTransaction50", propOrder = {"returnIdentification", "originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification", "originalTransactionIdentification",
...
public class PaymentTransaction50 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>> mmReturnIdentification = new MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction50.mmObject();
			isDerived = false;
			xmlTag = "RtrId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmReturnIdentification);
			previousVersion_lazy = () -> PaymentTransaction44.mmReturnIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction50 obj) {
			return obj.getReturnIdentification();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction50, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalGroupInformation);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction50 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalTransactionIdentification);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction50, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction50 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, ActiveCurrencyAndAmount> mmReturnedInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction50, ActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> CashSettlement.mmInterbankSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction50.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmReturnedInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction44.mmReturnedInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(PaymentTransaction50 obj) {
			return obj.getReturnedInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction50, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmInterbankSettlementDate);
			previousVersion_lazy = () -> PaymentTransaction44.mmInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction50 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<Priority3Code>> mmSettlementPriority = new MMMessageAttribute<PaymentTransaction50, Optional<Priority3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmSettlementPriority);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Priority3Code> getValue(PaymentTransaction50 obj) {
			return obj.getSettlementPriority();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<Priority3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>> mmReturnedInstructedAmount = new MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmReturnedInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction44.mmReturnedInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<BaseOneRate>> mmExchangeRate = new MMMessageAttribute<PaymentTransaction50, Optional<BaseOneRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmExchangeRate);
			previousVersion_lazy = () -> PaymentTransaction44.mmExchangeRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOneRate> getValue(PaymentTransaction50 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>> mmCompensationAmount = new MMMessageAttribute<PaymentTransaction50, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmCompensationAmount);
			previousVersion_lazy = () -> PaymentTransaction44.mmCompensationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentTransaction50, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmChargeBearer);
			previousVersion_lazy = () -> PaymentTransaction44.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentTransaction50 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction50, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction44.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction50 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<PaymentTransaction50, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmInstructingAgent);
			previousVersion_lazy = () -> PaymentTransaction44.mmInstructingAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentTransaction50 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<PaymentTransaction50, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction50.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmInstructedAgent);
			previousVersion_lazy = () -> PaymentTransaction44.mmInstructedAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, List<PaymentReturnReason1>> mmReturnReasonInformation = new MMMessageAssociationEnd<PaymentTransaction50, List<PaymentReturnReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmReturnReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction44.mmReturnReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReturnReason1> getValue(PaymentTransaction50 obj) {
			return obj.getReturnReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, List<PaymentReturnReason1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction50, Optional<OriginalTransactionReference20>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction50, Optional<OriginalTransactionReference20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction44.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference20> getValue(PaymentTransaction50 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, Optional<OriginalTransactionReference20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction50, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction50, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction50.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction44.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction50 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction50 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction50.mmReturnIdentification, com.tools20022.repository.msg.PaymentTransaction50.mmOriginalGroupInformation,
						com.tools20022.repository.msg.PaymentTransaction50.mmOriginalInstructionIdentification, com.tools20022.repository.msg.PaymentTransaction50.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.PaymentTransaction50.mmOriginalTransactionIdentification, com.tools20022.repository.msg.PaymentTransaction50.mmOriginalClearingSystemReference,
						...
						com.tools20022.repository.msg.PaymentTransaction50.mmInterbankSettlementDate, com.tools20022.repository.msg.PaymentTransaction50.mmSettlementPriority,
						com.tools20022.repository.msg.PaymentTransaction50.mmReturnedInstructedAmount, com.tools20022.repository.msg.PaymentTransaction50.mmExchangeRate,
						com.tools20022.repository.msg.PaymentTransaction50.mmCompensationAmount, com.tools20022.repository.msg.PaymentTransaction50.mmChargeBearer, com.tools20022.repository.msg.PaymentTransaction50.mmChargesInformation,
						com.tools20022.repository.msg.PaymentTransaction50.mmInstructingAgent, com.tools20022.repository.msg.PaymentTransaction50.mmInstructedAgent,
						com.tools20022.repository.msg.PaymentTransaction50.mmReturnReasonInformation, com.tools20022.repository.msg.PaymentTransaction50.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction50.mmSupplementaryData);
				messageBuildingBlock_lazy = () -> Arrays.asList(PaymentReturnV05.mmTransactionInformation);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReturnedInstructedAmountAndExchangeRate1Rule.forPaymentTransaction50,
						com.tools20022.repository.constraints.ConstraintReturnedInstructedAmountAndExchangeRate2Rule.forPaymentTransaction50,
						com.tools20022.repository.constraints.ConstraintChargesInformationAndReturnedInstructedAmountRule.forPaymentTransaction50);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction50";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction65.mmObject());
				previousVersion_lazy = () -> PaymentTransaction44.mmObject();
			}
		});
	...
	public PaymentTransaction50 setReturnIdentification(Max35Text returnIdentification) {
	...
	public PaymentTransaction50 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction50 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction50 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction50 setOriginalTransactionIdentification(Max35Text originalTransactionIdentification) {
	...
	public PaymentTransaction50 setOriginalClearingSystemReference(Max35Text originalClearingSystemReference) {
	...
	public PaymentTransaction50 setOriginalInterbankSettlementAmount(ActiveOrHistoricCurrencyAndAmount originalInterbankSettlementAmount) {
	...
	public PaymentTransaction50 setReturnedInterbankSettlementAmount(ActiveCurrencyAndAmount returnedInterbankSettlementAmount) {
	...
	public PaymentTransaction50 setInterbankSettlementDate(ISODate interbankSettlementDate) {
	...
	public PaymentTransaction50 setSettlementPriority(Priority3Code settlementPriority) {
	...
	public PaymentTransaction50 setReturnedInstructedAmount(ActiveOrHistoricCurrencyAndAmount returnedInstructedAmount) {
	...
	public PaymentTransaction50 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public PaymentTransaction50 setCompensationAmount(ActiveOrHistoricCurrencyAndAmount compensationAmount) {
	...
	public PaymentTransaction50 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentTransaction50 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction50 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public PaymentTransaction50 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
	...
	public PaymentTransaction50 setReturnReasonInformation(List<PaymentReturnReason1> returnReasonInformation) {
	...
	public PaymentTransaction50 setOriginalTransactionReference(OriginalTransactionReference20 originalTransactionReference) {
	...
	public PaymentTransaction50 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
