...
public class AccountAndBalance24 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance24.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	public CorporateActionBalanceDetails20 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails20 balance) {
