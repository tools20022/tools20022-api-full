...
public class AccountAndBalance24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance24.mmSafekeepingAccount, AccountAndBalance24.mmAccountOwner, AccountAndBalance24.mmSafekeepingPlace, AccountAndBalance24.mmBalance);
