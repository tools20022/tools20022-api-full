...
public class PaymentTransaction35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction35.mmReversalIdentification, PaymentTransaction35.mmOriginalInstructionIdentification, PaymentTransaction35.mmOriginalEndToEndIdentification,
						PaymentTransaction35.mmOriginalInstructedAmount, PaymentTransaction35.mmReversedInstructedAmount, PaymentTransaction35.mmChargeBearer, PaymentTransaction35.mmReversalReasonInformation,
						PaymentTransaction35.mmOriginalTransactionReference);
