 ...
 * AdditionalParameters13.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters13#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters13.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters13
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters13}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline#forAdditionalParameters13
 * ConstraintPartialSettlementGuideline.forAdditionalParameters13}</li>
 * </ul>
 * </li>
 * <li>
...
public class AdditionalParameters13 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters13, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters13, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters13.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters13 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters13 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters13, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters13, Optional<PartialSettlement2Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters13 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters13 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters13 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters13 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters13, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters13.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters13.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters13.mmPreviousPartialConfirmationIdentification, com.tools20022.repository.msg.AdditionalParameters13.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters13.mmClientTripartyCollateralTransactionIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters13,
						com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline.forAdditionalParameters13);
	...
	public AdditionalParameters13 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters13 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters13 setPreviousPartialConfirmationIdentification(RestrictedFINXMax16Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters13 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters13 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
