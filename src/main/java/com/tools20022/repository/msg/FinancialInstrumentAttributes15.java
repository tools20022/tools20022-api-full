...
public class FinancialInstrumentAttributes15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes15.mmPlaceOfListing, FinancialInstrumentAttributes15.mmDayCountBasis, FinancialInstrumentAttributes15.mmRegistrationForm,
						FinancialInstrumentAttributes15.mmPaymentFrequency, FinancialInstrumentAttributes15.mmPaymentStatus, FinancialInstrumentAttributes15.mmPaymentDirection, FinancialInstrumentAttributes15.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes15.mmPreferenceToIncome, FinancialInstrumentAttributes15.mmClassificationType, FinancialInstrumentAttributes15.mmOptionStyle, FinancialInstrumentAttributes15.mmOptionType,
						FinancialInstrumentAttributes15.mmDenominationCurrency, FinancialInstrumentAttributes15.mmCouponDate, FinancialInstrumentAttributes15.mmExpiryDate, FinancialInstrumentAttributes15.mmFloatingRateFixingDate,
						FinancialInstrumentAttributes15.mmMaturityDate, FinancialInstrumentAttributes15.mmIssueDate, FinancialInstrumentAttributes15.mmNextCallableDate, FinancialInstrumentAttributes15.mmPutableDate,
						FinancialInstrumentAttributes15.mmDatedDate, FinancialInstrumentAttributes15.mmFirstPaymentDate, FinancialInstrumentAttributes15.mmPreviousFactor, FinancialInstrumentAttributes15.mmCurrentFactor,
						FinancialInstrumentAttributes15.mmNextFactor, FinancialInstrumentAttributes15.mmInterestRate, FinancialInstrumentAttributes15.mmNextInterestRate, FinancialInstrumentAttributes15.mmIndexRateBasis,
						FinancialInstrumentAttributes15.mmCouponAttachedNumber, FinancialInstrumentAttributes15.mmPoolNumber, FinancialInstrumentAttributes15.mmVariableRateIndicator, FinancialInstrumentAttributes15.mmCallableIndicator,
						FinancialInstrumentAttributes15.mmPutableIndicator, FinancialInstrumentAttributes15.mmMarketOrIndicativePrice, FinancialInstrumentAttributes15.mmExercisePrice, FinancialInstrumentAttributes15.mmSubscriptionPrice,
						FinancialInstrumentAttributes15.mmConversionPrice, FinancialInstrumentAttributes15.mmStrikePrice, FinancialInstrumentAttributes15.mmMinimumNominalQuantity, FinancialInstrumentAttributes15.mmContractSize,
						FinancialInstrumentAttributes15.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes15.mmFinancialInstrumentAttributeAdditionalDetails);
