...
import com.tools20022.repository.codeset.EUCapitalGain1Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.EUCapitalGain1#mmStructured
 * EUCapitalGain1.mmStructured}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.EUCapitalGain1#mmAdditionalInformation
 * EUCapitalGain1.mmAdditionalInformation}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherCodeRule#forEUCapitalGain1
 * ConstraintOtherCodeRule.forEUCapitalGain1}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Specification of the EU capital gain."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "EUCapitalGain1", propOrder = {"structured", "additionalInformation"})
public class EUCapitalGain1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Strd", required = true)
	protected EUCapitalGain1Code structured;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EUCapitalGain1.mmStructured, com.tools20022.repository.msg.EUCapitalGain1.mmAdditionalInformation);
				trace_lazy = () -> SecuritiesTax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOtherCodeRule.forEUCapitalGain1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "EUCapitalGain1";
				definition = "Specification of the EU capital gain.";
			}
		});
		return mmObject_lazy.get();
	}

	public EUCapitalGain1Code getStructured() {
		return structured;
	}

	public EUCapitalGain1 setStructured(EUCapitalGain1Code structured) {
	...
	public EUCapitalGain1 setAdditionalInformation(Max350Text additionalInformation) {
