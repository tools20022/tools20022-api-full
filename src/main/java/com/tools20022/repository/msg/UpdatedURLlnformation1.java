...
public class UpdatedURLlnformation1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedURLlnformation1, Optional<RestrictedFINXMax140Text>> mmUpdateDescription = new MMMessageAttribute<UpdatedURLlnformation1, Optional<RestrictedFINXMax140Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax140Text> getValue(UpdatedURLlnformation1 obj) {
			return obj.getUpdateDescription();
		}

		@Override
		public void setValue(UpdatedURLlnformation1 obj, Optional<RestrictedFINXMax140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedURLlnformation1, Optional<ISODate>> mmUpdateDate = new MMMessageAttribute<UpdatedURLlnformation1, Optional<ISODate>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UpdatedURLlnformation1.mmObject();
			isDerived = false;
			xmlTag = "UpdDt";
		...
		@Override
		public Optional<ISODate> getValue(UpdatedURLlnformation1 obj) {
			return obj.getUpdateDate();
		}

		@Override
		public void setValue(UpdatedURLlnformation1 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedURLlnformation1, RestrictedFINZMax256Text> mmURLAddress = new MMMessageAttribute<UpdatedURLlnformation1, RestrictedFINZMax256Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UpdatedURLlnformation1.mmObject();
			isDerived = false;
			xmlTag = "URLAdr";
		...
		@Override
		public RestrictedFINZMax256Text getValue(UpdatedURLlnformation1 obj) {
			return obj.getURLAddress();
		}

		@Override
		public void setValue(UpdatedURLlnformation1 obj, RestrictedFINZMax256Text value) {
