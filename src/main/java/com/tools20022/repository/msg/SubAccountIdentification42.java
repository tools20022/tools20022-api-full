...
public class SubAccountIdentification42 {
	...
	public static final MMMessageAssociationEnd AccountOwner = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> SubAccountIdentification42.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.AccountOwner;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.SafekeepingAccount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ActivityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.ActivityIndicator;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BalanceForSubAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.BalanceForSubAccount;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification42.AccountOwner, com.tools20022.repository.msg.SubAccountIdentification42.SafekeepingAccount,
						com.tools20022.repository.msg.SubAccountIdentification42.ActivityIndicator, com.tools20022.repository.msg.SubAccountIdentification42.BalanceForSubAccount);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesBalanceCustodyReportV09.SubAccountDetails);
