...
public class TransactionIdentifications14 {
	...
	public static final MMMessageAttribute mmAccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications14.mmObject();
			isDerived = false;
			xmlTag = "AcctSvcrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications14.mmAccountServicerTransactionIdentification, TransactionIdentifications14.mmMarketInfrastructureTransactionIdentification,
						TransactionIdentifications14.mmProcessorTransactionIdentification, TransactionIdentifications14.mmAccountOwnerTransactionIdentification);
	...
	public void setAccountOwnerTransactionIdentification(References23Choice accountOwnerTransactionIdentification) {
