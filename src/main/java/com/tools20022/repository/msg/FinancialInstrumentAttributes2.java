...
import com.tools20022.repository.msg.MarketIdentification3;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrumentAttributes2#mmMarketOrIndicativePrice
 * FinancialInstrumentAttributes2.mmMarketOrIndicativePrice}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrumentAttributes2#mmUnderlyingFinancialInstrumentIdentification
 * FinancialInstrumentAttributes2.mmUnderlyingFinancialInstrumentIdentification}
 * </li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrumentAttributes2#mmFinancialInstrumentAttributeAdditionalDetails
 * FinancialInstrumentAttributes2.
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPlaceOfListingRule#forFinancialInstrumentAttributes2
 * ConstraintPlaceOfListingRule.forFinancialInstrumentAttributes2}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule#forFinancialInstrumentAttributes2
 * ConstraintAdditionalDetailsRule.forFinancialInstrumentAttributes2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FinancialInstrumentAttributes2", propOrder = {"placeOfListing", "dayCountBasis", "registrationForm", "paymentFrequency", "paymentStatus", "paymentDirection", "variableRateChangeFrequency", "preferenceToIncome",
		"classificationType", "optionStyle", "optionType", "denominationCurrency", "couponDate", "expiryDate", "resetDate", "maturityDate", "issueDate", "nextCallableDate", "conversionDate", "putableDate", "datedDate", "firstPaymentDate",
		"nextFactorDate", "previousFactor", "currentFactor", "nextFactor", "interestRate", "nextInterestRate", "indexRateBasis", "couponAttachedNumber", "poolNumber", "versionNumber", "convertibleIndicator", "variableRateIndicator",
		"coveredIndicator", "callableIndicator", "putableIndicator", "warrantAttachedOnDelivery", "oddCouponIndicator", "marketOrIndicativePrice", "exercisePrice", "subscriptionPrice", "conversionPrice", "strikePrice",
		"minimumNominalQuantity", "minimumExercisableQuantity", "minimumExercisableMultipleQuantity", "contractSize", "underlyingFinancialInstrumentIdentification", "financialInstrumentAttributeAdditionalDetails"})
public class FinancialInstrumentAttributes2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<MarketIdentification3>> mmPlaceOfListing = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<MarketIdentification3>>() {
		{
			businessElementTrace_lazy = () -> Security.mmPlaceOfListing;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
			xmlTag = "PlcOfListg";
		...
		@Override
		public Optional<MarketIdentification3> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPlaceOfListing();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<MarketIdentification3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<InterestComputationMethod1Choice>> mmDayCountBasis = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<InterestComputationMethod1Choice>>() {
		{
		...
		@Override
		public Optional<InterestComputationMethod1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getDayCountBasis();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<InterestComputationMethod1Choice> value) {
			obj.setDayCountBasis(value.orElse(null));
		}
	};
	@XmlElement(name = "RegnForm")
	protected FormOfSecurity1Choice registrationForm;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<FormOfSecurity1Choice>> mmRegistrationForm = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<FormOfSecurity1Choice>>() {
		{
		...
		@Override
		public Optional<FormOfSecurity1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getRegistrationForm();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<FormOfSecurity1Choice> value) {
			obj.setRegistrationForm(value.orElse(null));
		}
	};
	@XmlElement(name = "PmtFrqcy")
	protected Frequency1Choice paymentFrequency;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Frequency1Choice>> mmPaymentFrequency = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Frequency1Choice>>() {
		{
		...
		@Override
		public Optional<Frequency1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPaymentFrequency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<Frequency1Choice> value) {
			obj.setPaymentFrequency(value.orElse(null));
		}
	};
	@XmlElement(name = "PmtSts")
	protected SecuritiesPaymentStatus1Choice paymentStatus;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<SecuritiesPaymentStatus1Choice>> mmPaymentStatus = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<SecuritiesPaymentStatus1Choice>>() {
		{
		...
		@Override
		public Optional<SecuritiesPaymentStatus1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPaymentStatus();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<SecuritiesPaymentStatus1Choice> value) {
			obj.setPaymentStatus(value.orElse(null));
		}
	};
	@XmlElement(name = "PmtDrctn")
	protected PaymentDirection1Choice paymentDirection;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PaymentDirection1Choice>> mmPaymentDirection = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PaymentDirection1Choice>>() {
		{
		...
		@Override
		public Optional<PaymentDirection1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPaymentDirection();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<PaymentDirection1Choice> value) {
			obj.setPaymentDirection(value.orElse(null));
		}
	};
	@XmlElement(name = "VarblRateChngFrqcy")
	protected Frequency1Choice variableRateChangeFrequency;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Frequency1Choice>> mmVariableRateChangeFrequency = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Frequency1Choice>>() {
		{
	...
	protected PreferenceToIncome1Choice preferenceToIncome;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PreferenceToIncome1Choice>> mmPreferenceToIncome = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PreferenceToIncome1Choice>>() {
		{
		...
		@Override
		public Optional<PreferenceToIncome1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPreferenceToIncome();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<PreferenceToIncome1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ClassificationType1Choice>> mmClassificationType = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ClassificationType1Choice>>() {
		{
		...
		@Override
		public Optional<ClassificationType1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getClassificationType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<ClassificationType1Choice> value) {
			obj.setClassificationType(value.orElse(null));
		}
	};
	@XmlElement(name = "OptnStyle")
	protected OptionStyle2Choice optionStyle;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<OptionStyle2Choice>> mmOptionStyle = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<OptionStyle2Choice>>() {
		{
		...
		@Override
		public Optional<OptionStyle2Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getOptionStyle();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<OptionStyle2Choice> value) {
			obj.setOptionStyle(value.orElse(null));
		}
	};
	@XmlElement(name = "OptnTp")
	protected OptionType1Choice optionType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<OptionType1Choice>> mmOptionType = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<OptionType1Choice>>() {
		{
		...
		@Override
		public Optional<OptionType1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<OptionType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ActiveOrHistoricCurrencyCode>> mmDenominationCurrency = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getDenominationCurrency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmCouponDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getCouponDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmExpiryDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmResetDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
		...
		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<ISODate> value) {
			obj.setResetDate(value.orElse(null));
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmMaturityDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmNextCallableDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmConversionDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmPutableDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmDatedDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmFirstPaymentDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>> mmNextFactorDate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>> mmPreviousFactor = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>>() {
		{
		...
		@Override
		public Optional<BaseOneRate> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>> mmCurrentFactor = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>> mmNextFactor = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<BaseOneRate>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>> mmInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>>() {
		{
		...
		@Override
		public Optional<PercentageRate> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getInterestRate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>> mmNextInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>> mmIndexRateBasis = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<PercentageRate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>> mmCouponAttachedNumber = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>>() {
		{
		...
		@Override
		public Optional<Number1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getCouponAttachedNumber();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<Number1Choice> value) {
			obj.setCouponAttachedNumber(value.orElse(null));
		}
	};
	@XmlElement(name = "PoolNb")
	protected Number1Choice poolNumber;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>> mmPoolNumber = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>> mmVersionNumber = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Number1Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmConvertibleIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
		...
		@Override
		public Optional<YesNoIndicator> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getConvertibleIndicator();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmVariableRateIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmCoveredIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmCallableIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmPutableIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmWarrantAttachedOnDelivery = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>> mmOddCouponIndicator = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<PriceType1Choice>> mmMarketOrIndicativePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<PriceType1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceType1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getMarketOrIndicativePrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<PriceType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>> mmExercisePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>>() {
		{
		...
		@Override
		public Optional<Price2> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getExercisePrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>> mmSubscriptionPrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>> mmConversionPrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>> mmStrikePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<Price2>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumNominalQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getMinimumNominalQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumExercisableQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumExercisableMultipleQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>> mmContractSize = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes2, List<SecurityIdentification11>> mmUnderlyingFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes2, List<SecurityIdentification11>>() {
		{
		...
		@Override
		public List<SecurityIdentification11> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getUnderlyingFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, List<SecurityIdentification11> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Max350Text>> mmFinancialInstrumentAttributeAdditionalDetails = new MMMessageAttribute<FinancialInstrumentAttributes2, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<Max350Text> getValue(FinancialInstrumentAttributes2 obj) {
			return obj.getFinancialInstrumentAttributeAdditionalDetails();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes2 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPlaceOfListing, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmDayCountBasis,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmRegistrationForm, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPaymentFrequency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPaymentStatus, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPaymentDirection,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmVariableRateChangeFrequency, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPreferenceToIncome,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmClassificationType, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmOptionStyle,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmOptionType, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmDenominationCurrency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmCouponDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmExpiryDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmResetDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmMaturityDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmIssueDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmNextCallableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmConversionDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPutableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmDatedDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmFirstPaymentDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmNextFactorDate, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPreviousFactor,
						...
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmIndexRateBasis, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmCouponAttachedNumber,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPoolNumber, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmVersionNumber,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmConvertibleIndicator, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmVariableRateIndicator,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmCoveredIndicator, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmCallableIndicator,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmPutableIndicator, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmWarrantAttachedOnDelivery,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmOddCouponIndicator, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmMarketOrIndicativePrice,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmExercisePrice, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmSubscriptionPrice,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmConversionPrice, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmStrikePrice,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmMinimumNominalQuantity, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmMinimumExercisableQuantity,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmMinimumExercisableMultipleQuantity, com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmContractSize,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmUnderlyingFinancialInstrumentIdentification,
						com.tools20022.repository.msg.FinancialInstrumentAttributes2.mmFinancialInstrumentAttributeAdditionalDetails);
				trace_lazy = () -> Asset.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPlaceOfListingRule.forFinancialInstrumentAttributes2,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forFinancialInstrumentAttributes2);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public FinancialInstrumentAttributes2 setPlaceOfListing(MarketIdentification3 placeOfListing) {
	...
	public FinancialInstrumentAttributes2 setDayCountBasis(InterestComputationMethod1Choice dayCountBasis) {
		this.dayCountBasis = dayCountBasis;
		return this;
	}

	public Optional<FormOfSecurity1Choice> getRegistrationForm() {
		return registrationForm == null ? Optional.empty() : Optional.of(registrationForm);
	}

	public FinancialInstrumentAttributes2 setRegistrationForm(FormOfSecurity1Choice registrationForm) {
		this.registrationForm = registrationForm;
		return this;
	}

	public Optional<Frequency1Choice> getPaymentFrequency() {
		return paymentFrequency == null ? Optional.empty() : Optional.of(paymentFrequency);
	}

	public FinancialInstrumentAttributes2 setPaymentFrequency(Frequency1Choice paymentFrequency) {
		this.paymentFrequency = paymentFrequency;
		return this;
	}

	public Optional<SecuritiesPaymentStatus1Choice> getPaymentStatus() {
		return paymentStatus == null ? Optional.empty() : Optional.of(paymentStatus);
	}

	public FinancialInstrumentAttributes2 setPaymentStatus(SecuritiesPaymentStatus1Choice paymentStatus) {
		this.paymentStatus = paymentStatus;
		return this;
	}

	public Optional<PaymentDirection1Choice> getPaymentDirection() {
		return paymentDirection == null ? Optional.empty() : Optional.of(paymentDirection);
	}

	public FinancialInstrumentAttributes2 setPaymentDirection(PaymentDirection1Choice paymentDirection) {
		this.paymentDirection = paymentDirection;
		return this;
	}

	public Optional<Frequency1Choice> getVariableRateChangeFrequency() {
		return variableRateChangeFrequency == null ? Optional.empty() : Optional.of(variableRateChangeFrequency);
	}

	public FinancialInstrumentAttributes2 setVariableRateChangeFrequency(Frequency1Choice variableRateChangeFrequency) {
		this.variableRateChangeFrequency = variableRateChangeFrequency;
		return this;
	}

	public Optional<PreferenceToIncome1Choice> getPreferenceToIncome() {
		return preferenceToIncome == null ? Optional.empty() : Optional.of(preferenceToIncome);
	}

	public FinancialInstrumentAttributes2 setPreferenceToIncome(PreferenceToIncome1Choice preferenceToIncome) {
	...
	public FinancialInstrumentAttributes2 setClassificationType(ClassificationType1Choice classificationType) {
		this.classificationType = classificationType;
		return this;
	}

	public Optional<OptionStyle2Choice> getOptionStyle() {
		return optionStyle == null ? Optional.empty() : Optional.of(optionStyle);
	}

	public FinancialInstrumentAttributes2 setOptionStyle(OptionStyle2Choice optionStyle) {
		this.optionStyle = optionStyle;
		return this;
	}

	public Optional<OptionType1Choice> getOptionType() {
		return optionType == null ? Optional.empty() : Optional.of(optionType);
	}

	public FinancialInstrumentAttributes2 setOptionType(OptionType1Choice optionType) {
	...
	public FinancialInstrumentAttributes2 setDenominationCurrency(ActiveOrHistoricCurrencyCode denominationCurrency) {
	...
	public FinancialInstrumentAttributes2 setCouponDate(ISODate couponDate) {
	...
	public FinancialInstrumentAttributes2 setExpiryDate(ISODate expiryDate) {
		this.expiryDate = expiryDate;
		return this;
	}

	public Optional<ISODate> getResetDate() {
		return resetDate == null ? Optional.empty() : Optional.of(resetDate);
	}

	public FinancialInstrumentAttributes2 setResetDate(ISODate resetDate) {
	...
	public FinancialInstrumentAttributes2 setMaturityDate(ISODate maturityDate) {
	...
	public FinancialInstrumentAttributes2 setIssueDate(ISODate issueDate) {
	...
	public FinancialInstrumentAttributes2 setNextCallableDate(ISODate nextCallableDate) {
	...
	public FinancialInstrumentAttributes2 setConversionDate(ISODate conversionDate) {
	...
	public FinancialInstrumentAttributes2 setPutableDate(ISODate putableDate) {
	...
	public FinancialInstrumentAttributes2 setDatedDate(ISODate datedDate) {
	...
	public FinancialInstrumentAttributes2 setFirstPaymentDate(ISODate firstPaymentDate) {
	...
	public FinancialInstrumentAttributes2 setNextFactorDate(ISODate nextFactorDate) {
	...
	public FinancialInstrumentAttributes2 setPreviousFactor(BaseOneRate previousFactor) {
	...
	public FinancialInstrumentAttributes2 setCurrentFactor(BaseOneRate currentFactor) {
	...
	public FinancialInstrumentAttributes2 setNextFactor(BaseOneRate nextFactor) {
	...
	public FinancialInstrumentAttributes2 setInterestRate(PercentageRate interestRate) {
	...
	public FinancialInstrumentAttributes2 setNextInterestRate(PercentageRate nextInterestRate) {
	...
	public FinancialInstrumentAttributes2 setIndexRateBasis(PercentageRate indexRateBasis) {
	...
	public FinancialInstrumentAttributes2 setCouponAttachedNumber(Number1Choice couponAttachedNumber) {
		this.couponAttachedNumber = couponAttachedNumber;
		return this;
	}

	public Optional<Number1Choice> getPoolNumber() {
		return poolNumber == null ? Optional.empty() : Optional.of(poolNumber);
	}

	public FinancialInstrumentAttributes2 setPoolNumber(Number1Choice poolNumber) {
	...
	public FinancialInstrumentAttributes2 setVersionNumber(Number1Choice versionNumber) {
	...
	public FinancialInstrumentAttributes2 setConvertibleIndicator(YesNoIndicator convertibleIndicator) {
	...
	public FinancialInstrumentAttributes2 setVariableRateIndicator(YesNoIndicator variableRateIndicator) {
	...
	public FinancialInstrumentAttributes2 setCoveredIndicator(YesNoIndicator coveredIndicator) {
	...
	public FinancialInstrumentAttributes2 setCallableIndicator(YesNoIndicator callableIndicator) {
	...
	public FinancialInstrumentAttributes2 setPutableIndicator(YesNoIndicator putableIndicator) {
	...
	public FinancialInstrumentAttributes2 setWarrantAttachedOnDelivery(YesNoIndicator warrantAttachedOnDelivery) {
	...
	public FinancialInstrumentAttributes2 setOddCouponIndicator(YesNoIndicator oddCouponIndicator) {
	...
	public FinancialInstrumentAttributes2 setMarketOrIndicativePrice(PriceType1Choice marketOrIndicativePrice) {
	...
	public FinancialInstrumentAttributes2 setExercisePrice(Price2 exercisePrice) {
	...
	public FinancialInstrumentAttributes2 setSubscriptionPrice(Price2 subscriptionPrice) {
	...
	public FinancialInstrumentAttributes2 setConversionPrice(Price2 conversionPrice) {
	...
	public FinancialInstrumentAttributes2 setStrikePrice(Price2 strikePrice) {
	...
	public FinancialInstrumentAttributes2 setMinimumNominalQuantity(FinancialInstrumentQuantity1Choice minimumNominalQuantity) {
	...
	public FinancialInstrumentAttributes2 setMinimumExercisableQuantity(FinancialInstrumentQuantity1Choice minimumExercisableQuantity) {
	...
	public FinancialInstrumentAttributes2 setMinimumExercisableMultipleQuantity(FinancialInstrumentQuantity1Choice minimumExercisableMultipleQuantity) {
	...
	public FinancialInstrumentAttributes2 setContractSize(FinancialInstrumentQuantity1Choice contractSize) {
	...
	public FinancialInstrumentAttributes2 setUnderlyingFinancialInstrumentIdentification(List<SecurityIdentification11> underlyingFinancialInstrumentIdentification) {
	...
	public FinancialInstrumentAttributes2 setFinancialInstrumentAttributeAdditionalDetails(Max350Text financialInstrumentAttributeAdditionalDetails) {
