...
public class CorporateActionOption34 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption34.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	protected List<com.tools20022.repository.msg.SecuritiesOption22> securitiesMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmSecuritiesMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SecuritiesOption22.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.CashOption15> cashMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmCashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashOption15.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption34.mmOptionNumber, CorporateActionOption34.mmOptionType, CorporateActionOption34.mmFractionDisposition, CorporateActionOption34.mmOfferType,
						CorporateActionOption34.mmOptionFeatures, CorporateActionOption34.mmOptionAvailabilityStatus, CorporateActionOption34.mmCertificationType, CorporateActionOption34.mmNonDomicileCountry,
						CorporateActionOption34.mmValidDomicileCountry, CorporateActionOption34.mmCurrencyOption, CorporateActionOption34.mmDefaultProcessingOrStandingInstruction, CorporateActionOption34.mmChargesAppliedIndicator,
						CorporateActionOption34.mmCertificationIndicator, CorporateActionOption34.mmWithdrawalAllowedIndicator, CorporateActionOption34.mmChangeAllowedIndicator, CorporateActionOption34.mmSecurityIdentification,
						CorporateActionOption34.mmDateDetails, CorporateActionOption34.mmPeriodDetails, CorporateActionOption34.mmRateAndAmountDetails, CorporateActionOption34.mmPriceDetails, CorporateActionOption34.mmSecuritiesQuantity,
						CorporateActionOption34.mmSecuritiesMovementDetails, CorporateActionOption34.mmCashMovementDetails, CorporateActionOption34.mmAdditionalInformation);
	...
	public void setOptionFeatures(List<OptionFeaturesFormat8Choice> optionFeatures) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption22> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption15> cashMovementDetails) {
