...
public class Mandate1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Mandate1.mmMandateIdentification, Mandate1.mmMandateRequestIdentification, Mandate1.mmType, Mandate1.mmOccurrences, Mandate1.mmCollectionAmount, Mandate1.mmMaximumAmount,
						Mandate1.mmCreditorSchemeIdentification, Mandate1.mmCreditor, Mandate1.mmCreditorAccount, Mandate1.mmCreditorAgent, Mandate1.mmUltimateCreditor, Mandate1.mmDebtor, Mandate1.mmDebtorAccount, Mandate1.mmDebtorAgent,
						Mandate1.mmUltimateDebtor, Mandate1.mmReferredDocument);
