...
public class FailingReason8 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.FailingReason3#Code
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FailingReason3.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.FailingReason3.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FailingReason8.Code, com.tools20022.repository.msg.FailingReason8.AdditionalReasonInformation);
