...
public class AdditionalParameters17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters17.mmPreConfirmation, AdditionalParameters17.mmPartialSettlement, AdditionalParameters17.mmPreviousPartialConfirmationIdentification,
						AdditionalParameters17.mmTripartyAgentCollateralTransactionIdentification, AdditionalParameters17.mmClientTripartyCollateralTransactionIdentification,
						AdditionalParameters17.mmClientCollateralInstructionIdentification, AdditionalParameters17.mmTripartyCollateralInstructionIdentification);
