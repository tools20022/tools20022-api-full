...
public class IntraPositionMovement3 {
	...
	public static final MMMessageAssociationEnd mmMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.IntraPositionMovement4.mmObject();
		}
	};
	...
	public IntraPositionMovement3 setAccountOwner(com.tools20022.repository.msg.SystemPartyIdentification6 accountOwner) {
	...
	public IntraPositionMovement3 setSafekeepingAccount(com.tools20022.repository.msg.SecuritiesAccount19 safekeepingAccount) {
	...
	public IntraPositionMovement3 setStatusAndReason(com.tools20022.repository.msg.IntraPositionStatusAndReason2 statusAndReason) {
	...
	public IntraPositionMovement3 setMovementDetails(com.tools20022.repository.msg.IntraPositionMovement4 movementDetails) {
