...
public class RedemptionBulkOrder4 {
	...
	public static final MMXor mmCancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(RedemptionBulkOrder4.mmCancellationRight, RedemptionBulkOrder4.mmExtendedCancellationRight);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RedemptionBulkOrder4.mmMasterReference, RedemptionBulkOrder4.mmPlaceOfTrade, RedemptionBulkOrder4.mmOrderDateTime, RedemptionBulkOrder4.mmExpiryDateTime,
						RedemptionBulkOrder4.mmRequestedFutureTradeDate, RedemptionBulkOrder4.mmCancellationRight, RedemptionBulkOrder4.mmExtendedCancellationRight, RedemptionBulkOrder4.mmFinancialInstrumentDetails,
						RedemptionBulkOrder4.mmIndividualOrderDetails, RedemptionBulkOrder4.mmRequestedSettlementCurrency, RedemptionBulkOrder4.mmRequestedNAVCurrency, RedemptionBulkOrder4.mmTotalSettlementAmount,
						RedemptionBulkOrder4.mmCashSettlementDate, RedemptionBulkOrder4.mmBulkCashSettlementDetails);
				...
				xors_lazy = () -> Arrays.asList(RedemptionBulkOrder4.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
