...
import com.tools20022.repository.msg.RedemptionOrder7;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.RedemptionBulkOrder4#CancellationRightOrExtendedCancellationRightRule
 * RedemptionBulkOrder4.CancellationRightOrExtendedCancellationRightRule}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCashSettlementDateRule#forRedemptionBulkOrder4
 * ConstraintCashSettlementDateRule.forRedemptionBulkOrder4}</li>
 * <li>
...
@XmlType(name = "RedemptionBulkOrder4", propOrder = {"masterReference", "placeOfTrade", "orderDateTime", "expiryDateTime", "requestedFutureTradeDate", "cancellationRight", "extendedCancellationRight", "financialInstrumentDetails",
...
public class RedemptionBulkOrder4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<RedemptionBulkOrder4, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.RedemptionBulkOrder4.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual orders, as assigned by the instructing party. This identifier links the individual orders together.";
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(RedemptionBulkOrder4 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<PlaceOfTradeIdentification1Choice>> mmPlaceOfTrade = new MMMessageAttribute<RedemptionBulkOrder4, Optional<PlaceOfTradeIdentification1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmPlaceOfTrade);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1Choice> getValue(RedemptionBulkOrder4 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<PlaceOfTradeIdentification1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODateTime>> mmOrderDateTime = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmOrderDateTime);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(RedemptionBulkOrder4 obj) {
			return obj.getOrderDateTime();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<DateAndDateTimeChoice>> mmExpiryDateTime = new MMMessageAttribute<RedemptionBulkOrder4, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmExpiryDateTime);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(RedemptionBulkOrder4 obj) {
			return obj.getExpiryDateTime();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODate>> mmRequestedFutureTradeDate = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmRequestedFutureTradeDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(RedemptionBulkOrder4 obj) {
			return obj.getRequestedFutureTradeDate();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<CancellationRight1Code>> mmCancellationRight = new MMMessageAttribute<RedemptionBulkOrder4, Optional<CancellationRight1Code>>() {
		{
		...
		@Override
		public Optional<CancellationRight1Code> getValue(RedemptionBulkOrder4 obj) {
			return obj.getCancellationRight();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<CancellationRight1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<Extended350Code>> mmExtendedCancellationRight = new MMMessageAttribute<RedemptionBulkOrder4, Optional<Extended350Code>>() {
		{
			businessElementTrace_lazy = () -> InvestmentFundOrder.mmCancellationRight;
			componentContext_lazy = () -> com.tools20022.repository.msg.RedemptionBulkOrder4.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<Extended350Code> getValue(RedemptionBulkOrder4 obj) {
			return obj.getExtendedCancellationRight();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<Extended350Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionBulkOrder4, FinancialInstrument10> mmFinancialInstrumentDetails = new MMMessageAssociationEnd<RedemptionBulkOrder4, FinancialInstrument10>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmFinancialInstrumentDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrument10 getValue(RedemptionBulkOrder4 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, FinancialInstrument10 value) {
			obj.setFinancialInstrumentDetails(value);
		}
	};
	@XmlElement(name = "IndvOrdrDtls", required = true)
	protected List<RedemptionOrder7> individualOrderDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.RedemptionOrder7
	 * RedemptionOrder7}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessComponentTrace
	 * businessComponentTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionBulkOrder4, List<RedemptionOrder7>> mmIndividualOrderDetails = new MMMessageAssociationEnd<RedemptionBulkOrder4, List<RedemptionOrder7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmIndividualOrderDetails);
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RedemptionOrder7.mmObject();
		}

		@Override
		public List<RedemptionOrder7> getValue(RedemptionBulkOrder4 obj) {
			return obj.getIndividualOrderDetails();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, List<RedemptionOrder7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveCurrencyCode>> mmRequestedSettlementCurrency = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmRequestedSettlementCurrency);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(RedemptionBulkOrder4 obj) {
			return obj.getRequestedSettlementCurrency();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveOrHistoricCurrencyCode>> mmRequestedNAVCurrency = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmRequestedNAVCurrency);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(RedemptionBulkOrder4 obj) {
			return obj.getRequestedNAVCurrency();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveCurrencyAndAmount>> mmTotalSettlementAmount = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmTotalSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(RedemptionBulkOrder4 obj) {
			return obj.getTotalSettlementAmount();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODate>> mmCashSettlementDate = new MMMessageAttribute<RedemptionBulkOrder4, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionBulkOrder4, Optional<PaymentTransaction21>> mmBulkCashSettlementDetails = new MMMessageAssociationEnd<RedemptionBulkOrder4, Optional<PaymentTransaction21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmBulkCashSettlementDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTransaction21> getValue(RedemptionBulkOrder4 obj) {
			return obj.getBulkCashSettlementDetails();
		}

		@Override
		public void setValue(RedemptionBulkOrder4 obj, Optional<PaymentTransaction21> value) {
	...
	public static final MMXor CancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.RedemptionBulkOrder4.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionBulkOrder4.mmCancellationRight, com.tools20022.repository.msg.RedemptionBulkOrder4.mmExtendedCancellationRight);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionBulkOrder4.mmMasterReference, com.tools20022.repository.msg.RedemptionBulkOrder4.mmPlaceOfTrade,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmOrderDateTime, com.tools20022.repository.msg.RedemptionBulkOrder4.mmExpiryDateTime, com.tools20022.repository.msg.RedemptionBulkOrder4.mmRequestedFutureTradeDate,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmCancellationRight, com.tools20022.repository.msg.RedemptionBulkOrder4.mmExtendedCancellationRight,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmFinancialInstrumentDetails, com.tools20022.repository.msg.RedemptionBulkOrder4.mmIndividualOrderDetails,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmRequestedSettlementCurrency, com.tools20022.repository.msg.RedemptionBulkOrder4.mmRequestedNAVCurrency,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmTotalSettlementAmount, com.tools20022.repository.msg.RedemptionBulkOrder4.mmCashSettlementDate,
						com.tools20022.repository.msg.RedemptionBulkOrder4.mmBulkCashSettlementDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(RedemptionBulkOrderV03.mmBulkOrderDetails);
				trace_lazy = () -> RedemptionOrder.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementCurrency2Rule.forRedemptionBulkOrder4,
						com.tools20022.repository.constraints.ConstraintBulkCashSettlementDetails5Rule.forRedemptionBulkOrder4, com.tools20022.repository.constraints.ConstraintCashSettlementDateRule.forRedemptionBulkOrder4,
						com.tools20022.repository.constraints.ConstraintRequestedSettlementCurrencyRule.forRedemptionBulkOrder4);
				...
				name = "RedemptionBulkOrder4";
				definition = "Instruction from an investor to sell investment fund units back to the fund.";
				nextVersions_lazy = () -> Arrays.asList(RedemptionBulkOrder6.mmObject());
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionBulkOrder4.CancellationRightOrExtendedCancellationRightRule);
			}
		});
	...
	public RedemptionBulkOrder4 setMasterReference(Max35Text masterReference) {
	...
	public RedemptionBulkOrder4 setPlaceOfTrade(PlaceOfTradeIdentification1Choice placeOfTrade) {
	...
	public RedemptionBulkOrder4 setOrderDateTime(ISODateTime orderDateTime) {
	...
	public RedemptionBulkOrder4 setExpiryDateTime(DateAndDateTimeChoice expiryDateTime) {
	...
	public RedemptionBulkOrder4 setRequestedFutureTradeDate(ISODate requestedFutureTradeDate) {
	...
	public RedemptionBulkOrder4 setCancellationRight(CancellationRight1Code cancellationRight) {
	...
	public RedemptionBulkOrder4 setExtendedCancellationRight(Extended350Code extendedCancellationRight) {
	...
	public RedemptionBulkOrder4 setFinancialInstrumentDetails(FinancialInstrument10 financialInstrumentDetails) {
		this.financialInstrumentDetails = Objects.requireNonNull(financialInstrumentDetails);
		return this;
	}

	public List<RedemptionOrder7> getIndividualOrderDetails() {
		return individualOrderDetails == null ? individualOrderDetails = new ArrayList<>() : individualOrderDetails;
	}

	public RedemptionBulkOrder4 setIndividualOrderDetails(List<RedemptionOrder7> individualOrderDetails) {
	...
	public RedemptionBulkOrder4 setRequestedSettlementCurrency(ActiveCurrencyCode requestedSettlementCurrency) {
	...
	public RedemptionBulkOrder4 setRequestedNAVCurrency(ActiveOrHistoricCurrencyCode requestedNAVCurrency) {
	...
	public RedemptionBulkOrder4 setTotalSettlementAmount(ActiveCurrencyAndAmount totalSettlementAmount) {
	...
	public RedemptionBulkOrder4 setCashSettlementDate(ISODate cashSettlementDate) {
	...
	public RedemptionBulkOrder4 setBulkCashSettlementDetails(PaymentTransaction21 bulkCashSettlementDetails) {
