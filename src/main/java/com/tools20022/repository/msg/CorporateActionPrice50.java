...
public class CorporateActionPrice50 {
	...
	public PriceFormat27Choice getMaximumPrice() {
		return maximumPrice;
	}

	public void setMaximumPrice(PriceFormat27Choice maximumPrice) {
		this.maximumPrice = maximumPrice;
	}

	public PriceFormat27Choice getMinimumPrice() {
		return minimumPrice;
	}

	public void setMinimumPrice(PriceFormat27Choice minimumPrice) {
