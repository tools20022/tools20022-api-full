...
public class OriginalItemReference3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalItemReference3.mmAccount, OriginalItemReference3.mmAccountOwner, OriginalItemReference3.mmAccountServicer, OriginalItemReference3.mmRelatedAccount,
						OriginalItemReference3.mmDebtor, OriginalItemReference3.mmDebtorAgent, OriginalItemReference3.mmIntermediaryAgent, OriginalItemReference3.mmPurpose, OriginalItemReference3.mmRelatedRemittanceInformation,
						OriginalItemReference3.mmRemittanceInformation);
