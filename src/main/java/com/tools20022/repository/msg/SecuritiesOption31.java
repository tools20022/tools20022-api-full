...
public class SecuritiesOption31 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption31.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public CorporateActionPrice33 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice33 priceDetails) {
