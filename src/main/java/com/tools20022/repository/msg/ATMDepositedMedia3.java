	...
	public static final MMMessageAttribute mmMediaType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMDepositedMedia1.mmMediaType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmMediaCategory = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMDepositedMedia1.mmMediaCategory;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmMediaItems = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMDepositedMedia1.mmMediaItems;
			minOccurs = 1;
			isComposite = true;
