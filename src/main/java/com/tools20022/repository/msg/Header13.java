...
public class Header13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Header13.mmMessageFunction, Header13.mmProtocolVersion, Header13.mmExchangeIdentification, Header13.mmCreationDateTime, Header13.mmInitiatingParty, Header13.mmRecipientParty,
						Header13.mmTraceability);
