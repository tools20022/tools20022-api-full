...
import com.tools20022.repository.choice.CancelledReason1Choice;
...
public class CancelledStatusReason4 {
	...
	protected CancelledReason1Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.CancelledReason1Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CancelledStatusReason4, CancelledReason1Choice> mmReasonCode = new MMMessageAssociationEnd<CancelledStatusReason4, CancelledReason1Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.CancelledStatusReason4.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason11.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CancelledReason1Choice.mmObject();
		}

		@Override
		public CancelledReason1Choice getValue(CancelledStatusReason4 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(CancelledStatusReason4 obj, CancelledReason1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledStatusReason4, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancelledStatusReason4, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason11.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(CancelledStatusReason4 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(CancelledStatusReason4 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason4.mmReasonCode, com.tools20022.repository.msg.CancelledStatusReason4.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forCancelledStatusReason4);
				...
				name = "CancelledStatusReason4";
				definition = "Specifies reasons for the cancelled status.";
				nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason11.mmObject());
			}
		});
	...
	public CancelledStatusReason4 setReasonCode(CancelledReason1Choice reasonCode) {
	...
	public CancelledStatusReason4 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
