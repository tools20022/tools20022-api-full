...
public class TransactionDetails31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails31.mmFinancialInstrumentIdentification, TransactionDetails31.mmTradeDate, TransactionDetails31.mmSettlementDate, TransactionDetails31.mmSettlementQuantity,
						TransactionDetails31.mmSettlementAmount, TransactionDetails31.mmDeliveringSettlementParties, TransactionDetails31.mmReceivingSettlementParties, TransactionDetails31.mmInvestor);
