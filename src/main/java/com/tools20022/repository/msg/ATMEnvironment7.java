 ...
 * <li>{@linkplain com.tools20022.repository.msg.ATMEnvironment7#HostingEntity
...
public class ATMEnvironment7 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMEnvironment6#Acquirer
	 * ATMEnvironment6.Acquirer}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> ATMEnvironment7.mmObject();
			isDerived = false;
			xmlTag = "Acqrr";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Acquirer";
			definition = "Acquirer of the ATM transaction, in charge of the funds settlement with the issuer.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMEnvironment6.Acquirer;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMEnvironment8.Acquirer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ATMManager = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMEnvironment6.ATMManagerIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMEnvironment8.ATMManagerIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMEnvironment8#HostingEntity
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMEnvironment6#HostingEntity
	...
	public static final MMMessageAssociationEnd HostingEntity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMEnvironment6.HostingEntity;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMEnvironment8.HostingEntity);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMEnvironment6#ATM
	...
	public static final MMMessageAssociationEnd ATM = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMEnvironment6.ATM;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMEnvironment8.ATM);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMEnvironment7.Acquirer, com.tools20022.repository.msg.ATMEnvironment7.ATMManager, com.tools20022.repository.msg.ATMEnvironment7.HostingEntity,
						com.tools20022.repository.msg.ATMEnvironment7.ATM);
