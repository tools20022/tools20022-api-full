...
public class AccountAndBalance34 {
	...
	public AccountAndBalance34 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountAndBalance34 setAccountOwner(PartyIdentification92Choice accountOwner) {
	...
	public AccountAndBalance34 setSafekeepingPlace(SafekeepingPlaceFormat8Choice safekeepingPlace) {
