...
@XmlType(name = "AccountAndBalance34", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace", "balance"})
public class AccountAndBalance34 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountAndBalance26.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountAndBalance26.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountAndBalance26.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBalance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountAndBalance26.mmBalance;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance34.mmSafekeepingAccount, AccountAndBalance34.mmAccountOwner, AccountAndBalance34.mmSafekeepingPlace, AccountAndBalance34.mmBalance);
