...
public class AdditionalParameters4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters4.mmPreConfirmation, AdditionalParameters4.mmPartialSettlement, AdditionalParameters4.mmTripartyAgentCollateralTransactionIdentification,
