 ...
 * AdditionalParameters4.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters4#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters4.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters4
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters4}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters4", propOrder = {"preConfirmation", "partialSettlement", "tripartyAgentCollateralTransactionIdentification", "clientTripartyCollateralTransactionIdentification"})
public class AdditionalParameters4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters4, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters4, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters4.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters4 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters4 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters4, Optional<PartialSettlement1Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters4, Optional<PartialSettlement1Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement1Code> getValue(AdditionalParameters4 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters4 obj, Optional<PartialSettlement1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters4, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters4, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(AdditionalParameters4 obj) {
			return obj.getTripartyAgentCollateralTransactionIdentification();
		}

		@Override
		public void setValue(AdditionalParameters4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters4, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters4, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters4.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters4.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters4.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters4.mmClientTripartyCollateralTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionReversalAdviceV01.mmAdditionalParameters, SecuritiesSettlementTransactionReversalAdviceV02.mmAdditionalParameters);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters4);
	...
	public AdditionalParameters4 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters4 setPartialSettlement(PartialSettlement1Code partialSettlement) {
	...
	public AdditionalParameters4 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters4 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
