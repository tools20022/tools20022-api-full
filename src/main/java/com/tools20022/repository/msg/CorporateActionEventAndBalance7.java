...
public class CorporateActionEventAndBalance7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance7.mmGeneralInformation, CorporateActionEventAndBalance7.mmUnderlyingSecurity, CorporateActionEventAndBalance7.mmBalance,
						CorporateActionEventAndBalance7.mmSupplementaryData);
