...
public class AggregateBalancePerSafekeepingPlace26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace26.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace26.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace26.mmPledgee,
						AggregateBalancePerSafekeepingPlace26.mmAggregateBalance, AggregateBalancePerSafekeepingPlace26.mmPriceDetails, AggregateBalancePerSafekeepingPlace26.mmForeignExchangeDetails,
						AggregateBalancePerSafekeepingPlace26.mmDaysAccrued, AggregateBalancePerSafekeepingPlace26.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace26.mmInstrumentCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace26.mmAlternateReportingCurrencyAmounts, AggregateBalancePerSafekeepingPlace26.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace26.mmExposureType,
						AggregateBalancePerSafekeepingPlace26.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace26.mmAdditionalBalanceBreakdown, AggregateBalancePerSafekeepingPlace26.mmHoldingAdditionalDetails);
	...
	public ExposureType13Choice getExposureType() {
		return exposureType;
	}

	public void setExposureType(ExposureType13Choice exposureType) {
