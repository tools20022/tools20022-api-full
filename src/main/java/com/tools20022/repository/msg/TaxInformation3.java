...
public class TaxInformation3 {
	...
	public static final MMMessageAssociationEnd mmCreditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmCreditor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmDebtor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdministrationZone = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmAdministrationZone);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmReferenceNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmReferenceNumber);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmMethod = new MMMessageAttribute() {
		{
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Tax.mmMethod;
			componentContext_lazy = () -> TaxInformation3.mmObject();
			isDerived = false;
			xmlTag = "Mtd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmMethod);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmTotalTaxableBaseAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmTotalTaxableBaseAmount);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTotalTaxAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmTotalTaxAmount);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAttribute mmDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSequenceNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmSequenceNumber);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmRecord = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxInformation4.mmRecord);
			minOccurs = 0;
			isComposite = true;
