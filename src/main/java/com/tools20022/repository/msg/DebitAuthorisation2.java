	...
	public static final MMMessageAssociationEnd CancellationReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DebitAuthorisation1.CancellationReason;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AmountToDebit = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DebitAuthorisation1.AmountToDebit;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ValueDateToDebit = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DebitAuthorisation1.ValueDateToDebit;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalCancellationReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DebitAuthorisation1.AdditionalCancellationReasonInformation;
			minOccurs = 0;
