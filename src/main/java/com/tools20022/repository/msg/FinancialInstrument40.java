...
public class FinancialInstrument40 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FinancialInstrument40.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrument40.mmIdentification, FinancialInstrument40.mmName, FinancialInstrument40.mmTransferType, FinancialInstrument40.mmQuantity,
						FinancialInstrument40.mmAverageAcquisitionPrice, FinancialInstrument40.mmTransferCurrency, FinancialInstrument40.mmTotalBookValue, FinancialInstrument40.mmTransfereeAccount,
						FinancialInstrument40.mmSubAccountDetails, FinancialInstrument40.mmReceivingAgentDetails, FinancialInstrument40.mmDeliveringAgentDetails, FinancialInstrument40.mmRequestedSettlementDate);
