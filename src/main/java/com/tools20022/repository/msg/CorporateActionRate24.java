...
public class CorporateActionRate24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate24.mmInterest, CorporateActionRate24.mmPercentageSought, CorporateActionRate24.mmRelatedIndex, CorporateActionRate24.mmSpread,
						CorporateActionRate24.mmBidInterval, CorporateActionRate24.mmPreviousFactor, CorporateActionRate24.mmNextFactor, CorporateActionRate24.mmReinvestmentDiscountRateToMarket);
