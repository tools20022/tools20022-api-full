...
@XmlType(name = "QuantityAndAccount39", propOrder = {"settlementQuantity", "denominationChoice", "accountOwner", "safekeepingAccount", "cashAccount", "safekeepingPlace", "quantityBreakdown"})
public class QuantityAndAccount39 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<QuantityAndAccount39, Quantity6Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount39.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmSettlementQuantity);
			previousVersion_lazy = () -> QuantityAndAccount25.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(QuantityAndAccount39 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount39, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount39, Optional<Max210Text>>() {
		{
			...
			definition = "Denomination of the security to be received or delivered.";
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmDenominationChoice);
			previousVersion_lazy = () -> QuantityAndAccount25.mmDenominationChoice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(QuantityAndAccount39 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, Optional<Max210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, Optional<PartyIdentification98>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount39, Optional<PartyIdentification98>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmAccountOwner);
			previousVersion_lazy = () -> QuantityAndAccount25.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification98> getValue(QuantityAndAccount39 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, Optional<PartyIdentification98> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, SecuritiesAccount19> mmSafekeepingAccount = new MMMessageAssociationEnd<QuantityAndAccount39, SecuritiesAccount19>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmSafekeepingAccount);
			previousVersion_lazy = () -> QuantityAndAccount25.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount19 getValue(QuantityAndAccount39 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, SecuritiesAccount19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount39, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmCashAccount);
			previousVersion_lazy = () -> QuantityAndAccount25.mmCashAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(QuantityAndAccount39 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount39, Optional<SafeKeepingPlace1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmSafekeepingPlace);
			previousVersion_lazy = () -> QuantityAndAccount25.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(QuantityAndAccount39 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount39, List<QuantityBreakdown30>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount39, List<QuantityBreakdown30>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmQuantityBreakdown);
			previousVersion_lazy = () -> QuantityAndAccount25.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown30> getValue(QuantityAndAccount39 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount39 obj, List<QuantityBreakdown30> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount39.mmSettlementQuantity, com.tools20022.repository.msg.QuantityAndAccount39.mmDenominationChoice,
						com.tools20022.repository.msg.QuantityAndAccount39.mmAccountOwner, com.tools20022.repository.msg.QuantityAndAccount39.mmSafekeepingAccount, com.tools20022.repository.msg.QuantityAndAccount39.mmCashAccount,
						com.tools20022.repository.msg.QuantityAndAccount39.mmSafekeepingPlace, com.tools20022.repository.msg.QuantityAndAccount39.mmQuantityBreakdown);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionInstructionV06.mmQuantityAndAccountDetails, SecuritiesFinancingInstructionV06.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionGenerationNotificationV06.mmQuantityAndAccountDetails, SecuritiesFinancingInstructionV07.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionGenerationNotificationV07.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionInstructionV07.mmQuantityAndAccountDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount39, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forQuantityAndAccount39,
						com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount39);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "QuantityAndAccount39";
				definition = "Details on the quantity, account and other related information involved in a transaction.";
				nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount65.mmObject());
				previousVersion_lazy = () -> QuantityAndAccount25.mmObject();
			}
		});
	...
	public QuantityAndAccount39 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public QuantityAndAccount39 setDenominationChoice(Max210Text denominationChoice) {
	...
	public QuantityAndAccount39 setAccountOwner(PartyIdentification98 accountOwner) {
	...
	public QuantityAndAccount39 setSafekeepingAccount(SecuritiesAccount19 safekeepingAccount) {
	...
	public QuantityAndAccount39 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public QuantityAndAccount39 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public QuantityAndAccount39 setQuantityBreakdown(List<QuantityBreakdown30> quantityBreakdown) {
