...
public class CorporateActionOption9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption9.mmOptionNumber, CorporateActionOption9.mmOptionType, CorporateActionOption9.mmAccountOwner, CorporateActionOption9.mmSafekeepingAccount,
						CorporateActionOption9.mmCashAccount, CorporateActionOption9.mmSafekeepingPlace, CorporateActionOption9.mmSecurityIdentification, CorporateActionOption9.mmTotalEligibleBalance,
						CorporateActionOption9.mmInstructedBalance, CorporateActionOption9.mmUninstructedBalance, CorporateActionOption9.mmStatusQuantityOrQuantityToReceive);
