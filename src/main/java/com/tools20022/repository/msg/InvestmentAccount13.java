...
public class InvestmentAccount13 {
	...
	public static final MMMessageAttribute mmAccountIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InvestmentAccount13.mmObject();
			isDerived = false;
			xmlTag = "AcctId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount13.mmAccountIdentification, InvestmentAccount13.mmAccountName, InvestmentAccount13.mmAccountDesignation, InvestmentAccount13.mmOwnerIdentification,
						InvestmentAccount13.mmAccountServicer);
