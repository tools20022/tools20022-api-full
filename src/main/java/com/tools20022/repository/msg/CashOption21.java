...
public class CashOption21 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CashOption21.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
	...
	public CorporateActionAmounts18 getAmountDetails() {
		return amountDetails;
	}

	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts18 amountDetails) {
	...
	public PriceDetails8 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.PriceDetails8 priceDetails) {
