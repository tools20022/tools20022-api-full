...
public class CashOption21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption21.mmCreditDebitIndicator, CashOption21.mmNonEligibleProceedsIndicator, CashOption21.mmIssuerOfferorTaxabilityIndicator, CashOption21.mmIncomeType,
						CashOption21.mmCashAccountIdentification, CashOption21.mmAmountDetails, CashOption21.mmDateDetails, CashOption21.mmForeignExchangeDetails, CashOption21.mmRateAndAmountDetails, CashOption21.mmPriceDetails);
