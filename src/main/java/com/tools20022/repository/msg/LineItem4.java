...
public class LineItem4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, DocumentIdentification7> mmPurchaseOrderReference = new MMMessageAssociationEnd<LineItem4, DocumentIdentification7>() {
		{
		...
		@Override
		public DocumentIdentification7 getValue(LineItem4 obj) {
			return obj.getPurchaseOrderReference();
		}

		@Override
		public void setValue(LineItem4 obj, DocumentIdentification7 value) {
			obj.setPurchaseOrderReference(value);
		}
	};
	@XmlElement(name = "ComrclLineItms", required = true)
	protected List<LineItemDetails6> commercialLineItems;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, List<LineItemDetails6>> mmCommercialLineItems = new MMMessageAssociationEnd<LineItem4, List<LineItemDetails6>>() {
		{
		...
		@Override
		public List<LineItemDetails6> getValue(LineItem4 obj) {
			return obj.getCommercialLineItems();
		}

		@Override
		public void setValue(LineItem4 obj, List<LineItemDetails6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LineItem4, CurrencyAndAmount> mmLineItemsTotalAmount = new MMMessageAttribute<LineItem4, CurrencyAndAmount>() {
		{
		...
		@Override
		public CurrencyAndAmount getValue(LineItem4 obj) {
			return obj.getLineItemsTotalAmount();
		}

		@Override
		public void setValue(LineItem4 obj, CurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, Optional<Incoterms2>> mmIncoterms = new MMMessageAssociationEnd<LineItem4, Optional<Incoterms2>>() {
		{
		...
		@Override
		public Optional<Incoterms2> getValue(LineItem4 obj) {
			return obj.getIncoterms();
		}

		@Override
		public void setValue(LineItem4 obj, Optional<Incoterms2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, List<Adjustment4>> mmAdjustment = new MMMessageAssociationEnd<LineItem4, List<Adjustment4>>() {
		{
		...
		@Override
		public List<Adjustment4> getValue(LineItem4 obj) {
			return obj.getAdjustment();
		}

		@Override
		public void setValue(LineItem4 obj, List<Adjustment4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, Optional<Charge13>> mmFreightCharges = new MMMessageAssociationEnd<LineItem4, Optional<Charge13>>() {
		{
		...
		@Override
		public Optional<Charge13> getValue(LineItem4 obj) {
			return obj.getFreightCharges();
		}

		@Override
		public void setValue(LineItem4 obj, Optional<Charge13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, List<Tax12>> mmTax = new MMMessageAssociationEnd<LineItem4, List<Tax12>>() {
		{
		...
		@Override
		public List<Tax12> getValue(LineItem4 obj) {
			return obj.getTax();
		}

		@Override
		public void setValue(LineItem4 obj, List<Tax12> value) {
			obj.setTax(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LineItem4, CurrencyAndAmount> mmTotalNetAmount = new MMMessageAttribute<LineItem4, CurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> Invoice.mmTotalInvoiceAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.LineItem4.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, List<UserDefinedInformation1>> mmBuyerDefinedInformation = new MMMessageAssociationEnd<LineItem4, List<UserDefinedInformation1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.LineItem4.mmObject();
			isDerived = false;
			xmlTag = "BuyrDfndInf";
		...
		@Override
		public List<UserDefinedInformation1> getValue(LineItem4 obj) {
			return obj.getBuyerDefinedInformation();
		}

		@Override
		public void setValue(LineItem4 obj, List<UserDefinedInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LineItem4, List<UserDefinedInformation1>> mmSellerDefinedInformation = new MMMessageAssociationEnd<LineItem4, List<UserDefinedInformation1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.LineItem4.mmObject();
			isDerived = false;
			xmlTag = "SellrDfndInf";
	...
	public LineItem4 setPurchaseOrderReference(DocumentIdentification7 purchaseOrderReference) {
	...
	public LineItem4 setCommercialLineItems(List<LineItemDetails6> commercialLineItems) {
	...
	public LineItem4 setIncoterms(Incoterms2 incoterms) {
	...
	public LineItem4 setAdjustment(List<Adjustment4> adjustment) {
	...
	public LineItem4 setFreightCharges(Charge13 freightCharges) {
	...
	public LineItem4 setTax(List<Tax12> tax) {
	...
	public LineItem4 setBuyerDefinedInformation(List<UserDefinedInformation1> buyerDefinedInformation) {
	...
	public LineItem4 setSellerDefinedInformation(List<UserDefinedInformation1> sellerDefinedInformation) {
