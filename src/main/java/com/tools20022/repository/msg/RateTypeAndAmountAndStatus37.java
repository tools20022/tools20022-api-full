	...
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, DeemedRateType1Choice> mmRateType = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, DeemedRateType1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus54.mmRateType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<RateTypeAndAmountAndStatus37, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateTypeAndAmountAndStatus37, ActiveCurrencyAnd13DecimalAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus54.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, Optional<RateStatus3Choice>> mmRateStatus = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, Optional<RateStatus3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus54.mmRateStatus);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus54.mmObject());
			}
		});
