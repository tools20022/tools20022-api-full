	...
	public static final MMMessageAttribute mmTimeStamp = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.mmTimeStamp);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.mmTimeStamp;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmResult = new MMMessageAttribute() {
		{
			...
			name = "Result";
			definition = "Final result of the processed terminal management action.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.mmResult);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.mmResult;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmActionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.mmActionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.mmActionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalErrorInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.mmAdditionalErrorInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.mmAdditionalErrorInformation;
			maxOccurs = 1;
			minOccurs = 0;
