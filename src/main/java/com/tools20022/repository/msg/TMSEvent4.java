 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent4#TimeStamp
 * TMSEvent4.TimeStamp}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent4#Result
 * TMSEvent4.Result}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent4#ActionIdentification
...
public class TMSEvent4 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TMSEvent3#TimeStamp
	 * TMSEvent3.TimeStamp}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute TimeStamp = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TMSEvent4.mmObject();
			isDerived = false;
			xmlTag = "TmStmp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TimeStamp";
			definition = "Date time of the terminal management action performed by the point of interaction.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.TimeStamp;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.TimeStamp);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TMSEvent3#Result
	 * TMSEvent3.Result}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute Result = new MMMessageAttribute() {
		{
			...
			name = "Result";
			definition = "Final result of the processed terminal management action.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.Result;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.Result);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.TMSEvent5#ActionIdentification
	...
	public static final MMMessageAssociationEnd ActionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.ActionIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.ActionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalErrorInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TMSEvent3.AdditionalErrorInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent5.AdditionalErrorInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent4.TimeStamp, com.tools20022.repository.msg.TMSEvent4.Result, com.tools20022.repository.msg.TMSEvent4.ActionIdentification,
						com.tools20022.repository.msg.TMSEvent4.AdditionalErrorInformation);
