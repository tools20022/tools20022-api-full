...
public class RequestedModification4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestedModification4.mmInstructionIdentification, RequestedModification4.mmEndToEndIdentification, RequestedModification4.mmTransactionIdentification,
						RequestedModification4.mmPaymentTypeInformation, RequestedModification4.mmRequestedExecutionDate, RequestedModification4.mmRequestedCollectionDate, RequestedModification4.mmInterbankSettlementDate,
						RequestedModification4.mmAmount, RequestedModification4.mmInterbankSettlementAmount, RequestedModification4.mmChargeBearer, RequestedModification4.mmUltimateDebtor, RequestedModification4.mmDebtor,
						RequestedModification4.mmDebtorAccount, RequestedModification4.mmDebtorAgentAccount, RequestedModification4.mmSettlementInformation, RequestedModification4.mmCreditorAgentAccount, RequestedModification4.mmCreditor,
						RequestedModification4.mmCreditorAccount, RequestedModification4.mmUltimateCreditor, RequestedModification4.mmPurpose, RequestedModification4.mmInstructionForDebtorAgent,
						RequestedModification4.mmInstructionForNextAgent, RequestedModification4.mmInstructionForCreditorAgent, RequestedModification4.mmRemittanceInformation);
