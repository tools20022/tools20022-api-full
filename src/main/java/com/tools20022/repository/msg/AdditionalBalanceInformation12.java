...
public class AdditionalBalanceInformation12 {
	...
	public static final MMMessageAttribute mmSubBalanceType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalBalanceInformation12.mmObject();
			isDerived = false;
			xmlTag = "SubBalTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalBalanceInformation12.mmSubBalanceType, AdditionalBalanceInformation12.mmQuantity, AdditionalBalanceInformation12.mmSubBalanceAdditionalDetails,
						AdditionalBalanceInformation12.mmQuantityBreakdown);
