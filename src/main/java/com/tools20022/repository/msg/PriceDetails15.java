...
public class PriceDetails15 {
	...
	public static final MMMessageAssociationEnd GenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceDetails15.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PriceDetails10.GenericCashPricePaidPerProduct;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails22.GenericCashPricePaidPerProduct);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PriceDetails10.GenericCashPriceReceivedPerProduct;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails22.GenericCashPriceReceivedPerProduct);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails15.GenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails15.GenericCashPriceReceivedPerProduct);
