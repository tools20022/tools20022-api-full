...
public class Identification9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification9.mmAccountOwnerTransactionIdentification, Identification9.mmAccountServicerTransactionIdentification, Identification9.mmMarketInfrastructureTransactionIdentification,
						Identification9.mmProcessorTransactionIdentification, Identification9.mmCommonIdentification, Identification9.mmTradeIdentification, Identification9.mmMasterIdentification, Identification9.mmBasketIdentification,
						Identification9.mmIndexIdentification, Identification9.mmListIdentification, Identification9.mmProgramIdentification, Identification9.mmPoolIdentification, Identification9.mmCorporateActionEventIdentification);
