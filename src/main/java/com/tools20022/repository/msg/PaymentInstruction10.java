...
public class PaymentInstruction10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction10.mmPaymentInformationIdentification, PaymentInstruction10.mmPaymentMethod, PaymentInstruction10.mmBatchBooking, PaymentInstruction10.mmNumberOfTransactions,
						PaymentInstruction10.mmControlSum, PaymentInstruction10.mmPaymentTypeInformation, PaymentInstruction10.mmRequestedCollectionDate, PaymentInstruction10.mmCreditor, PaymentInstruction10.mmCreditorAccount,
						PaymentInstruction10.mmCreditorAgent, PaymentInstruction10.mmCreditorAgentAccount, PaymentInstruction10.mmUltimateCreditor, PaymentInstruction10.mmChargeBearer, PaymentInstruction10.mmChargesAccount,
						PaymentInstruction10.mmChargesAccountAgent, PaymentInstruction10.mmCreditorSchemeIdentification, PaymentInstruction10.mmDirectDebitTransactionInformation);
