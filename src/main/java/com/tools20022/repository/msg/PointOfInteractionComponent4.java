...
public class PointOfInteractionComponent4 {
	...
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PointOfInteractionComponent4.mmObject();
			isDerived = false;
			xmlTag = "Tp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Type";
			definition = "Type of component belonging to a POI (Point Of Interaction) Terminal.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmStatus);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmStatus;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStandardCompliance = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmStandardCompliance);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmStandardCompliance;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCharacteristics = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmCharacteristics);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmCharacteristics;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAssessment = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PointOfInteractionComponent5.mmAssessment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PointOfInteractionComponent3.mmAssessment;
			minOccurs = 0;
