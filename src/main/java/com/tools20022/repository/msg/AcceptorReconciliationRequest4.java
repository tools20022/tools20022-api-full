...
public class AcceptorReconciliationRequest4 {
	...
	public static final MMMessageAssociationEnd mmEnvironment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorReconciliationRequest5.mmEnvironment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.AcceptorReconciliationRequest3.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorReconciliationRequest5.mmTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.AcceptorReconciliationRequest3.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.caaa.AcceptorReconciliationRequestV04.mmReconciliationRequest);
	...
	public void setEnvironment(com.tools20022.repository.msg.CardPaymentEnvironment37 environment) {
