...
public class SecuritiesOption30 {
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice37.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption30.mmSecurityDetails, SecuritiesOption30.mmCreditDebitIndicator, SecuritiesOption30.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption30.mmNonEligibleProceedsIndicator, SecuritiesOption30.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption30.mmEntitledQuantity, SecuritiesOption30.mmFractionDisposition,
						SecuritiesOption30.mmCurrencyOption, SecuritiesOption30.mmTradingPeriod, SecuritiesOption30.mmDateDetails, SecuritiesOption30.mmRateDetails, SecuritiesOption30.mmPriceDetails);
	...
	public CorporateActionPrice37 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice37 priceDetails) {
