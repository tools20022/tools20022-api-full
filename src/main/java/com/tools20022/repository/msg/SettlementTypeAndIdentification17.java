...
public class SettlementTypeAndIdentification17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification17.mmAccountOwnerTransactionIdentification, SettlementTypeAndIdentification17.mmAccountServicerTransactionIdentification,
						SettlementTypeAndIdentification17.mmMarketInfrastructureTransactionIdentification, SettlementTypeAndIdentification17.mmProcessorTransactionIdentification, SettlementTypeAndIdentification17.mmSecuritiesMovementType,
						SettlementTypeAndIdentification17.mmPayment, SettlementTypeAndIdentification17.mmCommonIdentification, SettlementTypeAndIdentification17.mmPoolIdentification,
						SettlementTypeAndIdentification17.mmCorporateActionEventIdentification);
