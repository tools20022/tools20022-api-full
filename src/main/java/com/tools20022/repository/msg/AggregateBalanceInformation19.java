...
public class AggregateBalanceInformation19 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AggregateBalanceInformation19.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace18> balanceAtSafekeepingPlace) {
