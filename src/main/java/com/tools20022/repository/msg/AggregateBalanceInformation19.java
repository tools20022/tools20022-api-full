...
public class AggregateBalanceInformation19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation19.mmFinancialInstrumentIdentification, AggregateBalanceInformation19.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation19.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation19.mmAdditionalDerivativeAttributes, AggregateBalanceInformation19.mmAggregateBalance,
						AggregateBalanceInformation19.mmSafekeepingPlace, AggregateBalanceInformation19.mmCorporateActionOptionType, AggregateBalanceInformation19.mmPriceDetails, AggregateBalanceInformation19.mmForeignExchangeDetails,
						AggregateBalanceInformation19.mmDaysAccrued, AggregateBalanceInformation19.mmAccountBaseCurrencyAmounts, AggregateBalanceInformation19.mmInstrumentCurrencyAmounts,
						AggregateBalanceInformation19.mmAlternateReportingCurrencyAmounts, AggregateBalanceInformation19.mmQuantityBreakdown, AggregateBalanceInformation19.mmBalanceBreakdown,
						AggregateBalanceInformation19.mmAdditionalBalanceBreakdown, AggregateBalanceInformation19.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation19.mmHoldingAdditionalDetails,
						AggregateBalanceInformation19.mmSupplementaryData);
