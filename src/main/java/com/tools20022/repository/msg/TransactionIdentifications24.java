...
public class TransactionIdentifications24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications24.mmAccountOwnerTransactionIdentification, TransactionIdentifications24.mmAccountServicerTransactionIdentification,
						TransactionIdentifications24.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications24.mmProcessorTransactionIdentification);
