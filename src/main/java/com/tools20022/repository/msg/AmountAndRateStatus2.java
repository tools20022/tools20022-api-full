...
@XmlType(name = "AmountAndRateStatus2", propOrder = {"amount", "rateStatus"})
public class AmountAndRateStatus2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AmountAndRateStatus2
	 * AmountAndRateStatus2}</li>
	...
	public AmountAndRateStatus2 setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public AmountAndRateStatus2 setRateStatus(RateStatus1Code rateStatus) {
