...
public class PaymentInstrument8 {
	...
	public static final MMXor mmCashAccountOrPaymentCardOrDirectDebitOrChequeOrBankersDraftRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(PaymentInstrument8.mmCashAccountDetails, PaymentInstrument8.mmPaymentCardDetails, PaymentInstrument8.mmDirectDebitDetails, PaymentInstrument8.mmCheque,
					PaymentInstrument8.mmBankersDraft);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstrument8.mmSettlementCurrency, PaymentInstrument8.mmCashAccountDetails, PaymentInstrument8.mmPaymentCardDetails, PaymentInstrument8.mmDirectDebitDetails,
						PaymentInstrument8.mmCheque, PaymentInstrument8.mmBankersDraft);
				...
				xors_lazy = () -> Arrays.asList(PaymentInstrument8.mmCashAccountOrPaymentCardOrDirectDebitOrChequeOrBankersDraftRule);
			}
		});
