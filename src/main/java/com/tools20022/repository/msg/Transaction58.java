...
import com.tools20022.repository.msg.TransactionDetails102;
import java.util.*;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transaction58#mmAccountOwner
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transaction58#mmTripartyAgentServiceProviderCollateralTransactionIdentification
 * Transaction58.
 * mmTripartyAgentServiceProviderCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transaction58#mmTripartyAgentServiceProviderCollateralInstructionIdentification
 * Transaction58.
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction51
 * Transaction51}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction58", propOrder = {"accountOwner", "safekeepingAccount", "statusAndReason", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification",
		...
		"clientTripartyCollateralTransactionIdentification", "tripartyAgentServiceProviderCollateralTransactionIdentification", "tripartyAgentServiceProviderCollateralInstructionIdentification", "transactionDetails"})
public class Transaction58 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction58, Optional<SystemPartyIdentification6>> mmAccountOwner = new MMMessageAssociationEnd<Transaction58, Optional<SystemPartyIdentification6>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction58.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that owns the account.";
			previousVersion_lazy = () -> Transaction51.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SystemPartyIdentification6> getValue(Transaction58 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(Transaction58 obj, Optional<SystemPartyIdentification6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction58, Optional<SecuritiesAccount19>> mmSafekeepingAccount = new MMMessageAssociationEnd<Transaction58, Optional<SecuritiesAccount19>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesAccount19> getValue(Transaction58 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(Transaction58 obj, Optional<SecuritiesAccount19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction58, Optional<StatusAndReason31>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction58, Optional<StatusAndReason31>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmStatusAndReason;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<StatusAndReason31> getValue(Transaction58 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction58 obj, Optional<StatusAndReason31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction58, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction58 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction58 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction58 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction58 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction58, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction58 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction58 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction58.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> Transaction51.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralTransactionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction58.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction58, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralInstructionIdentification = new MMMessageAttribute<Transaction58, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction58.mmObject();
			isDerived = false;
	...
	protected TransactionDetails102 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails102
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction58, Optional<TransactionDetails102>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction58, Optional<TransactionDetails102>>() {
		{
			...
			previousVersion_lazy = () -> Transaction51.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails102.mmObject();
		}

		@Override
		public Optional<TransactionDetails102> getValue(Transaction58 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction58 obj, Optional<TransactionDetails102> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction58.mmAccountOwner, com.tools20022.repository.msg.Transaction58.mmSafekeepingAccount,
						com.tools20022.repository.msg.Transaction58.mmStatusAndReason, com.tools20022.repository.msg.Transaction58.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.Transaction58.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.Transaction58.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.Transaction58.mmProcessorTransactionIdentification, com.tools20022.repository.msg.Transaction58.mmTradeIdentification, com.tools20022.repository.msg.Transaction58.mmPoolIdentification,
						com.tools20022.repository.msg.Transaction58.mmCommonIdentification, com.tools20022.repository.msg.Transaction58.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction58.mmClientCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction58.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction58.mmTripartyAgentServiceProviderCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction58.mmTripartyAgentServiceProviderCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction58.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction58);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Transaction58";
				definition = "Identifies the details of the transaction.";
				previousVersion_lazy = () -> Transaction51.mmObject();
			}
		});
	...
	public Transaction58 setAccountOwner(SystemPartyIdentification6 accountOwner) {
	...
	public Transaction58 setSafekeepingAccount(SecuritiesAccount19 safekeepingAccount) {
	...
	public Transaction58 setStatusAndReason(StatusAndReason31 statusAndReason) {
	...
	public Transaction58 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction58 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction58 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction58 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction58 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction58 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction58 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction58 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction58 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction58 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public Transaction58 setTripartyAgentServiceProviderCollateralTransactionIdentification(Max35Text tripartyAgentServiceProviderCollateralTransactionIdentification) {
	...
	public Transaction58 setTripartyAgentServiceProviderCollateralInstructionIdentification(Max35Text tripartyAgentServiceProviderCollateralInstructionIdentification) {
	...
	public Optional<TransactionDetails102> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction58 setTransactionDetails(TransactionDetails102 transactionDetails) {
