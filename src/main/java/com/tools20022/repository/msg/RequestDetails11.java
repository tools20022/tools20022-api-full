...
public class RequestDetails11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestDetails11.mmReference, RequestDetails11.mmAutomaticBorrowing, RequestDetails11.mmRetainIndicator, RequestDetails11.mmLinkage, RequestDetails11.mmPriority,
						RequestDetails11.mmOtherProcessing, RequestDetails11.mmPartialSettlementIndicator, RequestDetails11.mmSecuritiesRTGS, RequestDetails11.mmHoldIndicator, RequestDetails11.mmMatchingDenial,
						RequestDetails11.mmUnilateralSplit, RequestDetails11.mmLinkages);
