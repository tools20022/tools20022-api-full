...
public class AccountStatement6 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.Identification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute StatementPagination = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.StatementPagination;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ElectronicSequenceNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.ElectronicSequenceNumber;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LegalSequenceNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.LegalSequenceNumber;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Number.mmObject();
		}
	...
	public static final MMMessageAttribute CreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.CreationDateTime;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FromToDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.FromToDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CopyDuplicateIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.CopyDuplicateIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReportingSource = new MMMessageAssociationEnd() {
		{
			...
			definition = "Specifies the application used to generate the reporting.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.ReportingSource;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement5#Account
	...
	public static final MMMessageAssociationEnd Account = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.Account;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RelatedAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.RelatedAccount;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement5#Interest
	...
	public static final MMMessageAssociationEnd Interest = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.Interest;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement5#Balance
	...
	public static final MMMessageAssociationEnd Balance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.Balance;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionsSummary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.TransactionsSummary;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement5#Entry
	...
	public static final MMMessageAssociationEnd Entry = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.Entry;
			minOccurs = 0;
	...
	public static final MMMessageAttribute AdditionalStatementInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AccountStatement5.AdditionalStatementInformation;
			minOccurs = 0;
			maxOccurs = 1;
