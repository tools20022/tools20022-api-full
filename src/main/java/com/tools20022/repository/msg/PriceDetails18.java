...
public class PriceDetails18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails18.GenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails18.GenericCashPriceReceivedPerProduct);
