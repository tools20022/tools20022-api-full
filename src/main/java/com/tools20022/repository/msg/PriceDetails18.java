...
public class PriceDetails18 {
	...
	public static final MMMessageAssociationEnd mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PriceDetails18.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceDetails18.mmGenericCashPricePaidPerProduct, PriceDetails18.mmGenericCashPriceReceivedPerProduct);
