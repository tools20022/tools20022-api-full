...
import com.tools20022.repository.choice.PriceFormat39Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails18
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails18}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails18", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails18, Optional<PriceFormat27Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails18, Optional<PriceFormat27Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails18.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat27Choice> getValue(PriceDetails18 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails18 obj, Optional<PriceFormat27Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails18, Optional<PriceFormat39Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails18, Optional<PriceFormat39Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat39Choice> getValue(PriceDetails18 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails18 obj, Optional<PriceFormat39Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails18.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails18.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails18);
	...
	public PriceDetails18 setGenericCashPricePaidPerProduct(PriceFormat27Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails18 setGenericCashPriceReceivedPerProduct(PriceFormat39Choice genericCashPriceReceivedPerProduct) {
