...
@XmlType(name = "TradeLegStatement2", propOrder = {"clearingAccount", "clearingSegment", "nonClearingMember", "tradeLegsDetails"})
public class TradeLegStatement2 {
	...
	public TradeLegStatement2 setClearingSegment(PartyIdentification35Choice clearingSegment) {
