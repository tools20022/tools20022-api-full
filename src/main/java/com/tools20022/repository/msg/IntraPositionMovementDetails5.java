...
public class IntraPositionMovementDetails5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionMovementDetails5.mmIdentification, IntraPositionMovementDetails5.mmSettledQuantity, IntraPositionMovementDetails5.mmPreviouslySettledQuantity,
						IntraPositionMovementDetails5.mmRemainingToBeSettledQuantity, IntraPositionMovementDetails5.mmLotNumber, IntraPositionMovementDetails5.mmBalanceTo, IntraPositionMovementDetails5.mmSettlementDate,
						IntraPositionMovementDetails5.mmAvailableDate, IntraPositionMovementDetails5.mmCorporateActionEventType, IntraPositionMovementDetails5.mmCollateralMonitorAmount,
						IntraPositionMovementDetails5.mmInstructionProcessingAdditionalDetails, IntraPositionMovementDetails5.mmSupplementaryData);
