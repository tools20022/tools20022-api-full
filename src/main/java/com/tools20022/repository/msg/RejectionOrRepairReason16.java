...
public class RejectionOrRepairReason16 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason16.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason16.mmCode, RejectionOrRepairReason16.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason16Choice code) {
		this.code = code;
	}
