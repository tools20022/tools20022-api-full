...
public class CardPaymentTransactionDetails27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails27.mmCurrency, CardPaymentTransactionDetails27.mmTotalAmount, CardPaymentTransactionDetails27.mmAmountQualifier,
						CardPaymentTransactionDetails27.mmDetailedAmount, CardPaymentTransactionDetails27.mmValidityDate, CardPaymentTransactionDetails27.mmOnLineReason, CardPaymentTransactionDetails27.mmUnattendedLevelCategory,
						CardPaymentTransactionDetails27.mmAccountType, CardPaymentTransactionDetails27.mmCurrencyConversionResult, CardPaymentTransactionDetails27.mmInstalment, CardPaymentTransactionDetails27.mmAggregationTransaction,
						CardPaymentTransactionDetails27.mmProductCodeSetIdentification, CardPaymentTransactionDetails27.mmSaleItem, CardPaymentTransactionDetails27.mmDeliveryLocation, CardPaymentTransactionDetails27.mmCardPaymentInvoice,
						CardPaymentTransactionDetails27.mmICCRelatedData);
