...
public class TransactionDetails57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails57.mmTransactionActivity, TransactionDetails57.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails57.mmSecuritiesMovementType,
						TransactionDetails57.mmPayment, TransactionDetails57.mmSettlementParameters, TransactionDetails57.mmPlaceOfTrade, TransactionDetails57.mmSafekeepingPlace, TransactionDetails57.mmPlaceOfClearing,
						TransactionDetails57.mmPostingQuantity, TransactionDetails57.mmNumberOfDaysAccrued, TransactionDetails57.mmPostingAmount, TransactionDetails57.mmAccruedInterestAmount, TransactionDetails57.mmTradeDate,
						TransactionDetails57.mmEffectiveSettlementDate, TransactionDetails57.mmSettlementDate, TransactionDetails57.mmValueDate, TransactionDetails57.mmDeliveringSettlementParties,
						TransactionDetails57.mmReceivingSettlementParties, TransactionDetails57.mmReversalIndicator, TransactionDetails57.mmTransactionAdditionalDetails);
	...
	public SettlementDetails48 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails48 settlementParameters) {
