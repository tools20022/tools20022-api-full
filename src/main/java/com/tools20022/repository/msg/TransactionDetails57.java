 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails57#Payment
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails57#TradeDate
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails57#ValueDate
...
public class TransactionDetails57 {
	...
	public static final MMMessageAssociationEnd TransactionActivity = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> TransactionDetails57.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.TransactionActivity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementTransactionOrCorporateActionEventType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.SettlementTransactionOrCorporateActionEventType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.SecuritiesMovementType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Payment = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.Payment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementParameters = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.SettlementParameters);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PlaceOfTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.PlaceOfTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.SafekeepingPlace);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PlaceOfClearing = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.PlaceOfClearing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PostingQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.PostingQuantity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfDaysAccrued = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.NumberOfDaysAccrued);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PostingAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.PostingAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AccruedInterestAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.AccruedInterestAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TradeDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.TradeDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd EffectiveSettlementDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.EffectiveSettlementDate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.SettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ValueDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.ValueDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DeliveringSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.DeliveringSettlementParties);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReceivingSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.ReceivingSettlementParties);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> SettlementParties13.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ReversalIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.ReversalIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionAdditionalDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails63.TransactionAdditionalDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails57.TransactionActivity, com.tools20022.repository.msg.TransactionDetails57.SettlementTransactionOrCorporateActionEventType,
						com.tools20022.repository.msg.TransactionDetails57.SecuritiesMovementType, com.tools20022.repository.msg.TransactionDetails57.Payment, com.tools20022.repository.msg.TransactionDetails57.SettlementParameters,
						com.tools20022.repository.msg.TransactionDetails57.PlaceOfTrade, com.tools20022.repository.msg.TransactionDetails57.SafekeepingPlace, com.tools20022.repository.msg.TransactionDetails57.PlaceOfClearing,
						com.tools20022.repository.msg.TransactionDetails57.PostingQuantity, com.tools20022.repository.msg.TransactionDetails57.NumberOfDaysAccrued, com.tools20022.repository.msg.TransactionDetails57.PostingAmount,
						com.tools20022.repository.msg.TransactionDetails57.AccruedInterestAmount, com.tools20022.repository.msg.TransactionDetails57.TradeDate, com.tools20022.repository.msg.TransactionDetails57.EffectiveSettlementDate,
						com.tools20022.repository.msg.TransactionDetails57.SettlementDate, com.tools20022.repository.msg.TransactionDetails57.ValueDate, com.tools20022.repository.msg.TransactionDetails57.DeliveringSettlementParties,
						com.tools20022.repository.msg.TransactionDetails57.ReceivingSettlementParties, com.tools20022.repository.msg.TransactionDetails57.ReversalIndicator,
						com.tools20022.repository.msg.TransactionDetails57.TransactionAdditionalDetails);
