...
import com.tools20022.repository.codeset.PendingSettlementStatusReason1Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherStatusRule#forPendingSettlementStatusReason1
 * ConstraintOtherStatusRule.forPendingSettlementStatusReason1}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PendingSettlementStatusReason1", propOrder = {"structured", "additionalInformation"})
public class PendingSettlementStatusReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Strd", required = true)
	protected PendingSettlementStatusReason1Code structured;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<PendingSettlementStatusReason1, PendingSettlementStatusReason1Code> mmStructured = new MMMessageAttribute<PendingSettlementStatusReason1, PendingSettlementStatusReason1Code>() {
		{
			...
			name = "Structured";
			definition = "Reason for a settlement pending status in structured form.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<PendingSettlementStatusReason1, Optional<Max350Text>> mmAdditionalInformation = new MMMessageAttribute<PendingSettlementStatusReason1, Optional<Max350Text>>() {
		{
			...
			definition = "Additional information about the reason for the settlement pending status in textual form.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingSettlementStatusReason1.mmStructured, com.tools20022.repository.msg.PendingSettlementStatusReason1.mmAdditionalInformation);
	...
	public PendingSettlementStatusReason1Code getStructured() {
		return structured;
	}

	public PendingSettlementStatusReason1 setStructured(PendingSettlementStatusReason1Code structured) {
	...
	public PendingSettlementStatusReason1 setAdditionalInformation(Max350Text additionalInformation) {
