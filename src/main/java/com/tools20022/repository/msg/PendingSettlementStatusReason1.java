...
public class PendingSettlementStatusReason1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingSettlementStatusReason1.Structured, com.tools20022.repository.msg.PendingSettlementStatusReason1.AdditionalInformation);
