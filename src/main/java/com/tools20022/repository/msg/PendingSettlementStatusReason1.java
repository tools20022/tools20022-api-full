...
public class PendingSettlementStatusReason1 {
	...
	public static final MMMessageAttribute mmStructured = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingSettlementStatusReason1.mmObject();
			isDerived = false;
			xmlTag = "Strd";
	...
	/**
	 * Additional information about the reason for the settlement pending status
	 * in textual form.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingSettlementStatusReason1.mmStructured, PendingSettlementStatusReason1.mmAdditionalInformation);
	...
	public void setStructured(PendingSettlementStatusReason1Code structured) {
