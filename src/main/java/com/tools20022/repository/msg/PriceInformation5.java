...
import com.tools20022.repository.choice.TypeOfPrice4Choice;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PriceInformation5#mmValueType
...
@XmlType(name = "PriceInformation5", propOrder = {"type", "value", "valueType", "sourceOfPrice", "quotationDate"})
public class PriceInformation5 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Tp", required = true)
	protected TypeOfPrice4Choice type;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * complexType} =
	 * {@linkplain com.tools20022.repository.choice.TypeOfPrice4Choice
	...
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmValue = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmValue);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmValueType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmValueType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmSourceOfPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmSourceOfPrice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmQuotationDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmQuotationDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation5.mmType, com.tools20022.repository.msg.PriceInformation5.mmValue, com.tools20022.repository.msg.PriceInformation5.mmValueType,
						com.tools20022.repository.msg.PriceInformation5.mmSourceOfPrice, com.tools20022.repository.msg.PriceInformation5.mmQuotationDate);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintValueRule.forPriceInformation5);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PriceInformation5";
				definition = "Amount of money for which goods or services are offered, sold, or bought.";
				nextVersions_lazy = () -> Arrays.asList(PriceInformation12.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public TypeOfPrice4Choice getType() {
		return type;
	}

	public PriceInformation5 setType(TypeOfPrice4Choice type) {
	...
	public PriceInformation5 setValue(PriceRateOrAmountOrUnknownChoice value) {
	...
	public PriceInformation5 setValueType(YieldedOrValueType1Choice valueType) {
	...
	public PriceInformation5 setQuotationDate(DateAndDateTimeChoice quotationDate) {
