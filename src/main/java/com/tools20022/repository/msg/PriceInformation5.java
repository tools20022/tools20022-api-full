...
public class PriceInformation5 {
	...
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PriceInformation5.mmObject();
			isDerived = false;
			xmlTag = "Tp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Type";
			definition = "Specifies the type of price and information about the price.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation12.mmType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmValue = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation12.mmValue);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmValueType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation12.mmValueType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmSourceOfPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation12.mmSourceOfPrice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmQuotationDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceInformation12.mmQuotationDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setType(TypeOfPrice4Choice type) {
		this.type = type;
	}
	...
	public MarketIdentification6 getSourceOfPrice() {
		return sourceOfPrice;
	}

	public void setSourceOfPrice(com.tools20022.repository.msg.MarketIdentification6 sourceOfPrice) {
