...
public class CorporateActionOption124 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption124.mmOptionNumber, CorporateActionOption124.mmOptionType, CorporateActionOption124.mmOptionFeatures, CorporateActionOption124.mmFractionDisposition,
						CorporateActionOption124.mmCurrencyOption, CorporateActionOption124.mmDateDetails, CorporateActionOption124.mmPeriodDetails, CorporateActionOption124.mmRateAndAmountDetails, CorporateActionOption124.mmPriceDetails,
						CorporateActionOption124.mmPlaceOfTrade, CorporateActionOption124.mmSecuritiesMovementDetails, CorporateActionOption124.mmCashMovementDetails);
