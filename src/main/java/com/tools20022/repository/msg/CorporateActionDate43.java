...
public class CorporateActionDate43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDate43.RecordDate, com.tools20022.repository.msg.CorporateActionDate43.ExDividendDate,
						com.tools20022.repository.msg.CorporateActionDate43.LotteryDate);
