...
public class SecuritiesTradeDetails16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails16.mmTradeIdentification, SecuritiesTradeDetails16.mmCollateralTransactionIdentification, SecuritiesTradeDetails16.mmPlaceOfTrade,
						SecuritiesTradeDetails16.mmPlaceOfClearing, SecuritiesTradeDetails16.mmTradeDate, SecuritiesTradeDetails16.mmSettlementDate, SecuritiesTradeDetails16.mmEffectiveSettlementDate, SecuritiesTradeDetails16.mmDealPrice,
						SecuritiesTradeDetails16.mmNumberOfDaysAccrued, SecuritiesTradeDetails16.mmOpeningClosing, SecuritiesTradeDetails16.mmReporting, SecuritiesTradeDetails16.mmTradeTransactionCondition,
						SecuritiesTradeDetails16.mmInvestorCapacity, SecuritiesTradeDetails16.mmTradeOriginatorRole, SecuritiesTradeDetails16.mmTypeOfPrice, SecuritiesTradeDetails16.mmFXAdditionalDetails,
						SecuritiesTradeDetails16.mmSettlementInstructionProcessingAdditionalDetails);
