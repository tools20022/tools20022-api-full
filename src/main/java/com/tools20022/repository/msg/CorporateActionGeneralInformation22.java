...
public class CorporateActionGeneralInformation22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation22.mmCorporateActionEventIdentification, CorporateActionGeneralInformation22.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation22.mmClassActionNumber, CorporateActionGeneralInformation22.mmEventProcessingType, CorporateActionGeneralInformation22.mmEventType,
						CorporateActionGeneralInformation22.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation22.mmUnderlyingSecurity);
