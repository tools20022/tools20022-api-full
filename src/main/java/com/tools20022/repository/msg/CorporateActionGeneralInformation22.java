...
public class CorporateActionGeneralInformation22 {
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes19.mmObject();
		}
	};
	...
	public CorporateActionGeneralInformation22 setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes19 underlyingSecurity) {
