...
import com.tools20022.repository.choice.References50Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Linkages42#mmProcessingPosition
 * Linkages42.mmProcessingPosition}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages42#mmMessageNumber
 * Linkages42.mmMessageNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages42#mmReference
 * Linkages42.mmReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages42#mmReferenceOwner
 * Linkages42.mmReferenceOwner}</li>
 * </ul>
 * </li>
...
@XmlType(name = "Linkages42", propOrder = {"processingPosition", "messageNumber", "reference", "referenceOwner"})
public class Linkages42 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Linkages42
	 * Linkages42}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages42, Optional<ProcessingPosition10Choice>> mmProcessingPosition = new MMMessageAssociationEnd<Linkages42, Optional<ProcessingPosition10Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages42.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
		...
		@Override
		public Optional<ProcessingPosition10Choice> getValue(Linkages42 obj) {
			return obj.getProcessingPosition();
		}

		@Override
		public void setValue(Linkages42 obj, Optional<ProcessingPosition10Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages42, Optional<DocumentNumber6Choice>> mmMessageNumber = new MMMessageAssociationEnd<Linkages42, Optional<DocumentNumber6Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages42.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
		...
		@Override
		public Optional<DocumentNumber6Choice> getValue(Linkages42 obj) {
			return obj.getMessageNumber();
		}

		@Override
		public void setValue(Linkages42 obj, Optional<DocumentNumber6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages42, References50Choice> mmReference = new MMMessageAssociationEnd<Linkages42, References50Choice>() {
		{
		...
		@Override
		public References50Choice getValue(Linkages42 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(Linkages42 obj, References50Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages42, Optional<PartyIdentification103Choice>> mmReferenceOwner = new MMMessageAssociationEnd<Linkages42, Optional<PartyIdentification103Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification103Choice> getValue(Linkages42 obj) {
			return obj.getReferenceOwner();
		}

		@Override
		public void setValue(Linkages42 obj, Optional<PartyIdentification103Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages42.mmProcessingPosition, com.tools20022.repository.msg.Linkages42.mmMessageNumber, com.tools20022.repository.msg.Linkages42.mmReference,
						com.tools20022.repository.msg.Linkages42.mmReferenceOwner);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementInstruction002V04.mmLinkages);
	...
	public Linkages42 setProcessingPosition(ProcessingPosition10Choice processingPosition) {
	...
	public Linkages42 setMessageNumber(DocumentNumber6Choice messageNumber) {
	...
	public Linkages42 setReference(References50Choice reference) {
	...
	public Linkages42 setReferenceOwner(PartyIdentification103Choice referenceOwner) {
