 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD2#mmPlaceAndName
 * CashOptionSD2.mmPlaceAndName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CashOptionSD2#mmReinvestmentIncomeClassification
 * CashOptionSD2.mmReinvestmentIncomeClassification}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD2#mmDTCPayMethod
 * CashOptionSD2.mmDTCPayMethod}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD2#mmDTCPayOrder
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD2#mmCSDCashRate
 * CashOptionSD2.mmCSDCashRate}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD2#mmDTCFeeRate
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD7 CashOptionSD7}</li>
 * </ul>
 * </li>
 * </ul>
 */
...
public class CashOptionSD2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD2 CashOptionSD2}</li>
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD7#mmPlaceAndName
	 * CashOptionSD7.mmPlaceAndName}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Max350Text> mmPlaceAndName = new MMMessageAttribute<CashOptionSD2, Max350Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "xPath to the element that is being extended.";
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmPlaceAndName);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(CashOptionSD2 obj) {
			return obj.getPlaceAndName();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Max350Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<ReinvestmentIncomeClassification1Code>> mmReinvestmentIncomeClassification = new MMMessageAttribute<CashOptionSD2, Optional<ReinvestmentIncomeClassification1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<ReinvestmentIncomeClassification1Code> getValue(CashOptionSD2 obj) {
			return obj.getReinvestmentIncomeClassification();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<ReinvestmentIncomeClassification1Code> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD7#mmDTCPayMethod
	 * CashOptionSD7.mmDTCPayMethod}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<Max3Text>> mmDTCPayMethod = new MMMessageAttribute<CashOptionSD2, Optional<Max3Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "DTCPayMtd";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmDTCPayMethod);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Text> getValue(CashOptionSD2 obj) {
			return obj.getDTCPayMethod();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<Max3Text> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD7#mmDTCPayOrder
	 * CashOptionSD7.mmDTCPayOrder}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<Max3Text>> mmDTCPayOrder = new MMMessageAttribute<CashOptionSD2, Optional<Max3Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "DTCPayOrdr";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmDTCPayOrder);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max3Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<DTCEntitlementCalculationMethod1Code>> mmEntitlementCalculationMethod = new MMMessageAttribute<CashOptionSD2, Optional<DTCEntitlementCalculationMethod1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmEntitlementCalculationMethod);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCEntitlementCalculationMethod1Code> getValue(CashOptionSD2 obj) {
			return obj.getEntitlementCalculationMethod();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<DTCEntitlementCalculationMethod1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>> mmEstimatedRateFlag = new MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmEstimatedRateFlag);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CashOptionSD2 obj) {
			return obj.getEstimatedRateFlag();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>> mmNRATaxReportableFlag = new MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmNRATaxReportableFlag);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>> mmProtectChargeFlag = new MMMessageAttribute<CashOptionSD2, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "PrtctChrgFlg";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmProtectChargeFlag);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD7#mmCSDCashRate
	 * CashOptionSD7.mmCSDCashRate}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<PriceFormatSD1Choice>> mmCSDCashRate = new MMMessageAttribute<CashOptionSD2, Optional<PriceFormatSD1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "CSDCshRate";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmCSDCashRate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PriceFormatSD1Choice> getValue(CashOptionSD2 obj) {
			return obj.getCSDCashRate();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<PriceFormatSD1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<PriceFormatSD1Choice>> mmDTCFeeRate = new MMMessageAttribute<CashOptionSD2, Optional<PriceFormatSD1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			xmlTag = "DTCFeeRate";
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmDTCFeeRate);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PriceFormatSD1Choice.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD2, Optional<Period3>> mmDTCUSTaxInstructionPeriod = new MMMessageAttribute<CashOptionSD2, Optional<Period3>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD2.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmDTCUSTaxInstructionPeriod);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Period3> getValue(CashOptionSD2 obj) {
			return obj.getDTCUSTaxInstructionPeriod();
		}

		@Override
		public void setValue(CashOptionSD2 obj, Optional<Period3> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOptionSD2.mmPlaceAndName, com.tools20022.repository.msg.CashOptionSD2.mmReinvestmentIncomeClassification,
						com.tools20022.repository.msg.CashOptionSD2.mmDTCPayMethod, com.tools20022.repository.msg.CashOptionSD2.mmDTCPayOrder, com.tools20022.repository.msg.CashOptionSD2.mmEntitlementCalculationMethod,
						com.tools20022.repository.msg.CashOptionSD2.mmEstimatedRateFlag, com.tools20022.repository.msg.CashOptionSD2.mmNRATaxReportableFlag, com.tools20022.repository.msg.CashOptionSD2.mmProtectChargeFlag,
						com.tools20022.repository.msg.CashOptionSD2.mmCSDCashRate, com.tools20022.repository.msg.CashOptionSD2.mmDTCFeeRate, com.tools20022.repository.msg.CashOptionSD2.mmDTCUSTaxInstructionPeriod);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CashOptionSD2";
				definition = "Provides additional information regarding corporate action option cash movement details.";
				nextVersions_lazy = () -> Arrays.asList(CashOptionSD7.mmObject());
			}
		});
	...
	public CashOptionSD2 setPlaceAndName(Max350Text placeAndName) {
	...
	public CashOptionSD2 setReinvestmentIncomeClassification(ReinvestmentIncomeClassification1Code reinvestmentIncomeClassification) {
	...
	public CashOptionSD2 setDTCPayMethod(Max3Text dTCPayMethod) {
	...
	public CashOptionSD2 setDTCPayOrder(Max3Text dTCPayOrder) {
	...
	public CashOptionSD2 setEntitlementCalculationMethod(DTCEntitlementCalculationMethod1Code entitlementCalculationMethod) {
	...
	public CashOptionSD2 setEstimatedRateFlag(YesNoIndicator estimatedRateFlag) {
	...
	public CashOptionSD2 setNRATaxReportableFlag(YesNoIndicator nRATaxReportableFlag) {
	...
	public CashOptionSD2 setProtectChargeFlag(YesNoIndicator protectChargeFlag) {
	...
	public CashOptionSD2 setCSDCashRate(PriceFormatSD1Choice cSDCashRate) {
	...
	public CashOptionSD2 setDTCFeeRate(PriceFormatSD1Choice dTCFeeRate) {
	...
	public CashOptionSD2 setDTCUSTaxInstructionPeriod(Period3 dTCUSTaxInstructionPeriod) {
