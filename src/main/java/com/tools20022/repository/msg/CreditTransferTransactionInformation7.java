...
public class CreditTransferTransactionInformation7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CreditTransferTransactionInformation7.mmPaymentIdentification, CreditTransferTransactionInformation7.mmPaymentTypeInformation,
						CreditTransferTransactionInformation7.mmInterbankSettlementAmount, CreditTransferTransactionInformation7.mmInterbankSettlementDate, CreditTransferTransactionInformation7.mmSettlementTimeIndication,
						CreditTransferTransactionInformation7.mmSettlementTimeRequest, CreditTransferTransactionInformation7.mmAcceptanceDateTime, CreditTransferTransactionInformation7.mmPoolingAdjustmentDate,
						CreditTransferTransactionInformation7.mmInstructedAmount, CreditTransferTransactionInformation7.mmExchangeRate, CreditTransferTransactionInformation7.mmChargeBearer,
						CreditTransferTransactionInformation7.mmChargesInformation, CreditTransferTransactionInformation7.mmPreviousInstructingAgent, CreditTransferTransactionInformation7.mmPreviousInstructingAgentAccount,
						CreditTransferTransactionInformation7.mmInstructingAgent, CreditTransferTransactionInformation7.mmInstructedAgent, CreditTransferTransactionInformation7.mmIntermediaryAgent1,
						CreditTransferTransactionInformation7.mmIntermediaryAgent1Account, CreditTransferTransactionInformation7.mmIntermediaryAgent2, CreditTransferTransactionInformation7.mmIntermediaryAgent2Account,
						CreditTransferTransactionInformation7.mmIntermediaryAgent3, CreditTransferTransactionInformation7.mmIntermediaryAgent3Account, CreditTransferTransactionInformation7.mmUltimateDebtor,
						CreditTransferTransactionInformation7.mmInitiatingParty, CreditTransferTransactionInformation7.mmDebtor, CreditTransferTransactionInformation7.mmDebtorAccount, CreditTransferTransactionInformation7.mmDebtorAgent,
						CreditTransferTransactionInformation7.mmDebtorAgentAccount, CreditTransferTransactionInformation7.mmCreditorAgent, CreditTransferTransactionInformation7.mmCreditorAgentAccount,
						CreditTransferTransactionInformation7.mmCreditor, CreditTransferTransactionInformation7.mmCreditorAccount, CreditTransferTransactionInformation7.mmUltimateCreditor,
						CreditTransferTransactionInformation7.mmInstructionForCreditorAgent, CreditTransferTransactionInformation7.mmInstructionForNextAgent, CreditTransferTransactionInformation7.mmPurpose,
						CreditTransferTransactionInformation7.mmRegulatoryReporting, CreditTransferTransactionInformation7.mmRelatedRemittanceInformation, CreditTransferTransactionInformation7.mmRemittanceInformation);
