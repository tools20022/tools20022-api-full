...
@XmlType(name = "AcceptorCancellationResponse7", propOrder = {"environment", "transaction", "transactionResponse"})
public class AcceptorCancellationResponse7 {
	...
	public static final MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentEnvironment69> mmEnvironment = new MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentEnvironment69>() {
		{
			...
			previousVersion_lazy = () -> AcceptorCancellationResponse6.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentTransaction57> mmTransaction = new MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentTransaction57>() {
		{
			...
			previousVersion_lazy = () -> AcceptorCancellationResponse6.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentTransaction68> mmTransactionResponse = new MMMessageAssociationEnd<AcceptorCancellationResponse7, CardPaymentTransaction68>() {
		{
			...
			previousVersion_lazy = () -> AcceptorCancellationResponse6.mmTransactionResponse;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorCancellationResponse7.mmEnvironment, com.tools20022.repository.msg.AcceptorCancellationResponse7.mmTransaction,
						com.tools20022.repository.msg.AcceptorCancellationResponse7.mmTransactionResponse);
