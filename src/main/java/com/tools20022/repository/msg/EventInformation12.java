 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation12#mmEventType
...
@XmlType(name = "EventInformation12", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "mandatoryVoluntaryEventType", "lastNotificationIdentification"})
public class EventInformation12 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.EventInformation12
	 * EventInformation12}</li>
	...
	protected NotificationIdentification6 lastNotificationIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation12.mmCorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation12.mmOfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation12.mmEventType, com.tools20022.repository.msg.EventInformation12.mmMandatoryVoluntaryEventType,
						com.tools20022.repository.msg.EventInformation12.mmLastNotificationIdentification);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "EventInformation12";
	...
	public EventInformation12 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public EventInformation12 setOfficialCorporateActionEventIdentification(RestrictedFINXMax16Text officialCorporateActionEventIdentification) {
	...
	public EventInformation12 setEventType(CorporateActionEventType58Choice eventType) {
	...
	public EventInformation12 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary4Choice mandatoryVoluntaryEventType) {
		this.mandatoryVoluntaryEventType = Objects.requireNonNull(mandatoryVoluntaryEventType);
		return this;
	}

	public Optional<NotificationIdentification6> getLastNotificationIdentification() {
