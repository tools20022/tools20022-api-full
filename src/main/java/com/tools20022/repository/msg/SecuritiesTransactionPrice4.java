 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTransactionPrice4#mmValue
 * SecuritiesTransactionPrice4.mmValue}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTransactionPrice4#mmType
 * SecuritiesTransactionPrice4.mmType}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Price with notation."</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getConstraint
 * constraint} =
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOneElementPresentRule#forSecuritiesTransactionPrice4
 * ConstraintOneElementPresentRule.forSecuritiesTransactionPrice4}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SecuritiesTransactionPrice4", propOrder = {"value", "type"})
public class SecuritiesTransactionPrice4 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Val")
	protected LongDecimalNumberFraction21 value;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<SecuritiesTransactionPrice4, Optional<Max35Text>> mmType = new MMMessageAttribute<SecuritiesTransactionPrice4, Optional<Max35Text>>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Type";
			definition = "Notation of the price.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTransactionPrice4.mmValue, com.tools20022.repository.msg.SecuritiesTransactionPrice4.mmType);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOneElementPresentRule.forSecuritiesTransactionPrice4);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SecuritiesTransactionPrice4";
				definition = "Price with notation.";
			}
		});
		return mmObject_lazy.get();
	}

	public Optional<LongDecimalNumberFraction21> getValue() {
		return value == null ? Optional.empty() : Optional.of(value);
	}

	public SecuritiesTransactionPrice4 setValue(LongDecimalNumberFraction21 value) {
		this.value = value;
		return this;
	}
	...
	public SecuritiesTransactionPrice4 setType(Max35Text type) {
		this.type = type;
		return this;
	}
}