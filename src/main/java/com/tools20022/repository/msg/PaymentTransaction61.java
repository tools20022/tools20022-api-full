...
@XmlType(name = "PaymentTransaction61", propOrder = {"cancellationIdentification", "case_", "originalInstructionIdentification", "originalEndToEndIdentification", "originalInstructedAmount", "originalRequestedExecutionDate",
...
public class PaymentTransaction61 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>> mmCancellationIdentification = new MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.mmObject();
			isDerived = false;
			xmlTag = "CxlId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmCancellationIdentification);
			previousVersion_lazy = () -> PaymentTransaction58.mmCancellationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction61 obj) {
			return obj.getCancellationIdentification();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction61, Optional<Case3>> mmCase = new MMMessageAssociationEnd<PaymentTransaction61, Optional<Case3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmCase);
			previousVersion_lazy = () -> PaymentTransaction58.mmCase;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Case3> getValue(PaymentTransaction61 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction61, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInstructedAmount = new MMMessageAttribute<PaymentTransaction61, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction61 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<ISODate>> mmOriginalRequestedExecutionDate = new MMMessageAttribute<PaymentTransaction61, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalRequestedExecutionDate);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalRequestedExecutionDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction61 obj) {
			return obj.getOriginalRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, Optional<ISODate>> mmOriginalRequestedCollectionDate = new MMMessageAttribute<PaymentTransaction61, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalRequestedCollectionDate);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalRequestedCollectionDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction61, List<PaymentCancellationReason2>> mmCancellationReasonInformation = new MMMessageAssociationEnd<PaymentTransaction61, List<PaymentCancellationReason2>>() {
		{
			...
			definition = "Provides detailed information on the cancellation reason.";
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmCancellationReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction58.mmCancellationReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentCancellationReason2> getValue(PaymentTransaction61 obj) {
			return obj.getCancellationReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, List<PaymentCancellationReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction61, Optional<OriginalTransactionReference22>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction61, Optional<OriginalTransactionReference22>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction58.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference22> getValue(PaymentTransaction61 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, Optional<OriginalTransactionReference22> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction61, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction61, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction74.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction58.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction61 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction61 obj, List<SupplementaryData1> value) {
	...
	public PaymentTransaction61 setCancellationIdentification(Max35Text cancellationIdentification) {
	...
	public PaymentTransaction61 setCase(Case3 case_) {
		this.case_ = case_;
		return this;
	}
	...
	public PaymentTransaction61 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction61 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction61 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public PaymentTransaction61 setOriginalRequestedExecutionDate(ISODate originalRequestedExecutionDate) {
	...
	public PaymentTransaction61 setOriginalRequestedCollectionDate(ISODate originalRequestedCollectionDate) {
	...
	public PaymentTransaction61 setCancellationReasonInformation(List<PaymentCancellationReason2> cancellationReasonInformation) {
	...
	public PaymentTransaction61 setOriginalTransactionReference(OriginalTransactionReference22 originalTransactionReference) {
	...
	public PaymentTransaction61 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
