...
@XmlType(name = "PaymentTransaction61", propOrder = {"cancellationIdentification", "case", "originalInstructionIdentification", "originalEndToEndIdentification", "originalInstructedAmount", "originalRequestedExecutionDate",
...
public class PaymentTransaction61 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction61.mmCancellationIdentification, PaymentTransaction61.mmCase, PaymentTransaction61.mmOriginalInstructionIdentification,
						PaymentTransaction61.mmOriginalEndToEndIdentification, PaymentTransaction61.mmOriginalInstructedAmount, PaymentTransaction61.mmOriginalRequestedExecutionDate, PaymentTransaction61.mmOriginalRequestedCollectionDate,
						PaymentTransaction61.mmCancellationReasonInformation, PaymentTransaction61.mmOriginalTransactionReference, PaymentTransaction61.mmSupplementaryData);
