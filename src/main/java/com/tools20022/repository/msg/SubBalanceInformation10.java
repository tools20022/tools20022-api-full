...
public class SubBalanceInformation10 {
	...
	protected List<com.tools20022.repository.msg.AdditionalBalanceInformation10> additionalBalanceBreakdownDetails;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation10.mmSubBalanceType, SubBalanceInformation10.mmQuantity, SubBalanceInformation10.mmSubBalanceAdditionalDetails, SubBalanceInformation10.mmQuantityBreakdown,
						SubBalanceInformation10.mmAdditionalBalanceBreakdownDetails);
	...
	public void setSubBalanceType(SubBalanceType7Choice subBalanceType) {
	...
	public void setAdditionalBalanceBreakdownDetails(List<com.tools20022.repository.msg.AdditionalBalanceInformation10> additionalBalanceBreakdownDetails) {
