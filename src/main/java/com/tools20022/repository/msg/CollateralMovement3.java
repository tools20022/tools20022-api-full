 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CollateralMovement3#Deliver
...
public class CollateralMovement3 {
	...
	public static final MMMessageAssociationEnd Deliver = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CollateralMovement3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement6.Deliver);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Return = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement6.Return);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Collateral4.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement3.Deliver, com.tools20022.repository.msg.CollateralMovement3.Return);
