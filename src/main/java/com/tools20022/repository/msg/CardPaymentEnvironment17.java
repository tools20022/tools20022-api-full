 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentEnvironment17#AcquirerParametersVersion
 * CardPaymentEnvironment17.AcquirerParametersVersion}</li>
 * <li>
...
public class CardPaymentEnvironment17 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute AcquirerParametersVersion = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentEnvironment17.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd MerchantIdentification = new MMMessageAssociationEnd() {
		{
			...
			definition = "Identification of the merchant requesting the diagnostic.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment29.MerchantIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd POIIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment29.POIIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> GenericIdentification32.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment17.AcquirerParametersVersion, com.tools20022.repository.msg.CardPaymentEnvironment17.MerchantIdentification,
						com.tools20022.repository.msg.CardPaymentEnvironment17.POIIdentification);
