...
public class CardPaymentEnvironment17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment17.mmAcquirerParametersVersion, CardPaymentEnvironment17.mmMerchantIdentification, CardPaymentEnvironment17.mmPOIIdentification);
	...
	public void setAcquirerParametersVersion(Max35Text acquirerParametersVersion) {
