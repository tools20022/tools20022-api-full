 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.TradeAgreement5#mmTradeDate
 * TradeAgreement5.mmTradeDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TradeAgreement5#mmNotificationIdentification
 * TradeAgreement5.mmNotificationIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.TradeAgreement5#mmOperationType
 * TradeAgreement5.mmOperationType}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TradeAgreement5#mmOperationScope
 * TradeAgreement5.mmOperationScope}</li>
 * </ul>
 * </li>
...
@XmlType(name = "TradeAgreement5", propOrder = {"tradeDate", "notificationIdentification", "commonReference", "amendOrCancelReason", "relatedReference", "operationType", "operationScope"})
public class TradeAgreement5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TradeAgreement5
	 * TradeAgreement5}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, ISODate> mmTradeDate = new MMMessageAttribute<TradeAgreement5, ISODate>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement5.mmObject();
			isDerived = false;
			xmlTag = "TradDt";
		...
		@Override
		public ISODate getValue(TradeAgreement5 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TradeAgreement5 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Max35Text> mmNotificationIdentification = new MMMessageAttribute<TradeAgreement5, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement5.mmObject();
			isDerived = false;
			xmlTag = "NtfctnId";
		...
		@Override
		public Max35Text getValue(TradeAgreement5 obj) {
			return obj.getNotificationIdentification();
		}

		@Override
		public void setValue(TradeAgreement5 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Optional<Max35Text>> mmCommonReference = new MMMessageAttribute<TradeAgreement5, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(TradeAgreement5 obj) {
			return obj.getCommonReference();
		}

		@Override
		public void setValue(TradeAgreement5 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Optional<Max35Text>> mmAmendOrCancelReason = new MMMessageAttribute<TradeAgreement5, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Optional<Max35Text>> mmRelatedReference = new MMMessageAttribute<TradeAgreement5, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Optional<Max4Text>> mmOperationType = new MMMessageAttribute<TradeAgreement5, Optional<Max4Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement5.mmObject();
			isDerived = false;
			xmlTag = "OprTp";
		...
		@Override
		public Optional<Max4Text> getValue(TradeAgreement5 obj) {
			return obj.getOperationType();
		}

		@Override
		public void setValue(TradeAgreement5 obj, Optional<Max4Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement5, Optional<Max4Text>> mmOperationScope = new MMMessageAttribute<TradeAgreement5, Optional<Max4Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement5.mmObject();
			isDerived = false;
			xmlTag = "OprScp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TradeAgreement5.mmTradeDate, com.tools20022.repository.msg.TradeAgreement5.mmNotificationIdentification,
						com.tools20022.repository.msg.TradeAgreement5.mmCommonReference, com.tools20022.repository.msg.TradeAgreement5.mmAmendOrCancelReason, com.tools20022.repository.msg.TradeAgreement5.mmRelatedReference,
						com.tools20022.repository.msg.TradeAgreement5.mmOperationType, com.tools20022.repository.msg.TradeAgreement5.mmOperationScope);
				trace_lazy = () -> TreasuryTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeAgreement5";
	...
	public TradeAgreement5 setTradeDate(ISODate tradeDate) {
	...
	public TradeAgreement5 setNotificationIdentification(Max35Text notificationIdentification) {
	...
	public TradeAgreement5 setCommonReference(Max35Text commonReference) {
	...
	public TradeAgreement5 setAmendOrCancelReason(Max35Text amendOrCancelReason) {
	...
	public TradeAgreement5 setRelatedReference(Max35Text relatedReference) {
	...
	public TradeAgreement5 setOperationType(Max4Text operationType) {
	...
	public TradeAgreement5 setOperationScope(Max4Text operationScope) {
