...
public class Acquirer2 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Acquirer2.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of the acquirer (for example the bank identification number BIN).";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Acquirer4.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmParametersVersion = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Acquirer4.mmParametersVersion);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setParametersVersion(Max35Text parametersVersion) {
