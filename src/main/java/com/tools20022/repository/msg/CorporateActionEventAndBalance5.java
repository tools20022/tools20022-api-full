...
public class CorporateActionEventAndBalance5 {
	...
	public static final MMMessageAssociationEnd mmGeneralInformation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventAndBalance5.mmObject();
			isDerived = false;
			xmlTag = "GnlInf";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.EventInformation3.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance5.mmGeneralInformation, CorporateActionEventAndBalance5.mmUnderlyingSecurity, CorporateActionEventAndBalance5.mmBalance,
						CorporateActionEventAndBalance5.mmSupplementaryData);
	...
	public void setGeneralInformation(com.tools20022.repository.msg.EventInformation3 generalInformation) {
