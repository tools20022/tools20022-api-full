 ...
 * CorporateActionConfirmationCashMovementDetailsSD4.mmCreditDebitIndicator}</li>
 * <li>
 ...
 * CorporateActionConfirmationCashMovementDetailsSD4.mmContraParticipantNumber}</li>
 * <li>
...
@XmlType(name = "CorporateActionConfirmationCashMovementDetailsSD4", propOrder = {"placeAndName", "creditDebitIndicator", "payoutType", "transactionAmount", "reasonCode", "subReasonCode", "contraParticipantNumber", "postingDate",
		"taxAdjustmentRate", "rDPReferenceNumber"})
public class CorporateActionConfirmationCashMovementDetailsSD4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Max350Text> mmPlaceAndName = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Max350Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "xPath to the element that is being extended.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmPlaceAndName);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getPlaceAndName();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Max350Text value) {
	 ...
	 * CorporateActionConfirmationCashMovementDetailsSD5.mmCreditDebitIndicator}
	 * </li>
	 * </ul>
	 * </li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, CreditDebitCode>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmCreditDebitIndicator);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, DTCCPayoutType5Code> mmPayoutType = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, DTCCPayoutType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "PyoutTp";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmPayoutType);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmPayoutType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DTCCPayoutType5Code getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getPayoutType();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, DTCCPayoutType5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<RestrictedFINActiveCurrencyAndAmount>> mmTransactionAmount = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<RestrictedFINActiveCurrencyAndAmount>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "TxAmt";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmTransactionAmount);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmTransactionAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RestrictedFINActiveCurrencyAndAmount> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getTransactionAmount();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<RestrictedFINActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DTCAdjustmentPaymentType2Code>> mmReasonCode = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DTCAdjustmentPaymentType2Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmReasonCode);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCAdjustmentPaymentType2Code> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<DTCAdjustmentPaymentType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DTCAdjustmentPaymentSubReason1Code>> mmSubReasonCode = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DTCAdjustmentPaymentSubReason1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "SubRsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmSubReasonCode);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmSubReasonCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCAdjustmentPaymentSubReason1Code> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getSubReasonCode();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<DTCAdjustmentPaymentSubReason1Code> value) {
	 ...
	 * CorporateActionConfirmationCashMovementDetailsSD5.
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<Max8Text>> mmContraParticipantNumber = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<Max8Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmContraParticipantNumber);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmContraParticipantNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max8Text> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getContraParticipantNumber();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<Max8Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DateFormat28Choice>> mmPostingDate = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<DateFormat28Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "PstngDt";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmPostingDate);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmPostingDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateFormat28Choice> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getPostingDate();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<DateFormat28Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<PercentageRate>> mmTaxAdjustmentRate = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<PercentageRate>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmTaxAdjustmentRate);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmTaxAdjustmentRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PercentageRate> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getTaxAdjustmentRate();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<Exact32AlphaNumericText>> mmRDPReferenceNumber = new MMMessageAttribute<CorporateActionConfirmationCashMovementDetailsSD4, Optional<Exact32AlphaNumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmObject();
			isDerived = false;
			xmlTag = "RDPRefNb";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmRDPReferenceNumber);
			previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmRDPReferenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Exact32AlphaNumericText> getValue(CorporateActionConfirmationCashMovementDetailsSD4 obj) {
			return obj.getRDPReferenceNumber();
		}

		@Override
		public void setValue(CorporateActionConfirmationCashMovementDetailsSD4 obj, Optional<Exact32AlphaNumericText> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmPlaceAndName,
						com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmCreditDebitIndicator, com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmPayoutType,
						com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmTransactionAmount, com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmReasonCode,
						com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmSubReasonCode, com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmContraParticipantNumber,
						com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmPostingDate, com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmTaxAdjustmentRate,
						com.tools20022.repository.msg.CorporateActionConfirmationCashMovementDetailsSD4.mmRDPReferenceNumber);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CorporateActionConfirmationCashMovementDetailsSD4";
				definition = "Provides additional information regarding corporate action confirmation cash movement details.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionConfirmationCashMovementDetailsSD5.mmObject());
				previousVersion_lazy = () -> CorporateActionConfirmationCashMovementDetailsSD3.mmObject();
			}
		});
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setPayoutType(DTCCPayoutType5Code payoutType) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setTransactionAmount(RestrictedFINActiveCurrencyAndAmount transactionAmount) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setReasonCode(DTCAdjustmentPaymentType2Code reasonCode) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setSubReasonCode(DTCAdjustmentPaymentSubReason1Code subReasonCode) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setContraParticipantNumber(Max8Text contraParticipantNumber) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setPostingDate(DateFormat28Choice postingDate) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setTaxAdjustmentRate(PercentageRate taxAdjustmentRate) {
	...
	public CorporateActionConfirmationCashMovementDetailsSD4 setRDPReferenceNumber(Exact32AlphaNumericText rDPReferenceNumber) {
