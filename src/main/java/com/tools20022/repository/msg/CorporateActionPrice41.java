...
public class CorporateActionPrice41 {
	...
	public static final MMMessageAssociationEnd mmIndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice41.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice41.mmIndicativeOrMarketPrice, CorporateActionPrice41.mmCashInLieuOfSharePrice, CorporateActionPrice41.mmCashValueForTax,
						CorporateActionPrice41.mmGenericCashPricePaidPerProduct, CorporateActionPrice41.mmGenericCashPriceReceivedPerProduct);
	...
	public PriceFormat31Choice getCashValueForTax() {
		return cashValueForTax;
	}

	public void setCashValueForTax(PriceFormat31Choice cashValueForTax) {
