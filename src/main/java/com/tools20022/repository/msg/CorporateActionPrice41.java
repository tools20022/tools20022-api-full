 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCorporateActionPrice41
 * ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice41}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice41", propOrder = {"indicativeOrMarketPrice", "cashInLieuOfSharePrice", "cashValueForTax", "genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class CorporateActionPrice41 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice41, Optional<IndicativeOrMarketPrice6Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice41, Optional<IndicativeOrMarketPrice6Choice>>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionPrice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice41.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<IndicativeOrMarketPrice6Choice> getValue(CorporateActionPrice41 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice41 obj, Optional<IndicativeOrMarketPrice6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat25Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat25Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat25Choice> getValue(CorporateActionPrice41 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice41 obj, Optional<PriceFormat25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice41, Optional<PriceFormat31Choice>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice41, Optional<PriceFormat31Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat31Choice> getValue(CorporateActionPrice41 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice41 obj, Optional<PriceFormat31Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat27Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat27Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat27Choice> getValue(CorporateActionPrice41 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice41 obj, Optional<PriceFormat27Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat26Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice41, Optional<PriceFormat26Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat26Choice> getValue(CorporateActionPrice41 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice41 obj, Optional<PriceFormat26Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice41.mmIndicativeOrMarketPrice, com.tools20022.repository.msg.CorporateActionPrice41.mmCashInLieuOfSharePrice,
						com.tools20022.repository.msg.CorporateActionPrice41.mmCashValueForTax, com.tools20022.repository.msg.CorporateActionPrice41.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice41.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice41);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CorporateActionPrice41";
	...
	public CorporateActionPrice41 setIndicativeOrMarketPrice(IndicativeOrMarketPrice6Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice41 setCashInLieuOfSharePrice(PriceFormat25Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice41 setCashValueForTax(PriceFormat31Choice cashValueForTax) {
	...
	public CorporateActionPrice41 setGenericCashPricePaidPerProduct(PriceFormat27Choice genericCashPricePaidPerProduct) {
	...
	public CorporateActionPrice41 setGenericCashPriceReceivedPerProduct(PriceFormat26Choice genericCashPriceReceivedPerProduct) {
