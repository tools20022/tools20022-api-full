...
public class TerminalManagementDataSet14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TerminalManagementDataSet14.mmIdentification, TerminalManagementDataSet14.mmSequenceCounter, TerminalManagementDataSet14.mmContent);
