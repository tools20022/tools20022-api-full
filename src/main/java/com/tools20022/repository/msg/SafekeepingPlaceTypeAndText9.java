...
@XmlType(name = "SafekeepingPlaceTypeAndText9", propOrder = {"safekeepingPlaceType", "identification"})
public class SafekeepingPlaceTypeAndText9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SafekeepingPlaceTypeAndText9, SafekeepingPlace2Code> mmSafekeepingPlaceType = new MMMessageAttribute<SafekeepingPlaceTypeAndText9, SafekeepingPlace2Code>() {
		{
			businessElementTrace_lazy = () -> SafekeepingPlace.mmSafekeepingPlaceType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SafekeepingPlaceTypeAndText9.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlcTp";
		...
		@Override
		public SafekeepingPlace2Code getValue(SafekeepingPlaceTypeAndText9 obj) {
			return obj.getSafekeepingPlaceType();
		}

		@Override
		public void setValue(SafekeepingPlaceTypeAndText9 obj, SafekeepingPlace2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SafekeepingPlaceTypeAndText9, Optional<RestrictedFINXMax30Text>> mmIdentification = new MMMessageAttribute<SafekeepingPlaceTypeAndText9, Optional<RestrictedFINXMax30Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax30Text> getValue(SafekeepingPlaceTypeAndText9 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(SafekeepingPlaceTypeAndText9 obj, Optional<RestrictedFINXMax30Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText9.mmSafekeepingPlaceType, com.tools20022.repository.msg.SafekeepingPlaceTypeAndText9.mmIdentification);
				trace_lazy = () -> SafekeepingPlace.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SafekeepingPlaceTypeAndText9";
	...
	public SafekeepingPlaceTypeAndText9 setSafekeepingPlaceType(SafekeepingPlace2Code safekeepingPlaceType) {
	...
	public SafekeepingPlaceTypeAndText9 setIdentification(RestrictedFINXMax30Text identification) {
