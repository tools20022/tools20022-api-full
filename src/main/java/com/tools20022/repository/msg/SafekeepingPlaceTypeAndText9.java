...
public class SafekeepingPlaceTypeAndText9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText9.SafekeepingPlaceType, com.tools20022.repository.msg.SafekeepingPlaceTypeAndText9.Identification);
