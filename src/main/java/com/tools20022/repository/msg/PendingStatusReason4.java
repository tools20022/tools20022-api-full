...
public class PendingStatusReason4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason4.ReasonCode, com.tools20022.repository.msg.PendingStatusReason4.AdditionalReasonInformation);
