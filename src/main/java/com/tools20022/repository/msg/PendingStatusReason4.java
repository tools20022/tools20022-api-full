...
public class PendingStatusReason4 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingStatusReason4.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatusReason4.mmReasonCode, PendingStatusReason4.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingReason7Choice reasonCode) {
