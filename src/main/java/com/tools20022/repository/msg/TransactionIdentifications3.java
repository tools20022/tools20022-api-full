...
public class TransactionIdentifications3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications3.mmAccountOwnerTransactionIdentification, TransactionIdentifications3.mmAccountServicerTransactionIdentification,
						TransactionIdentifications3.mmMarketInfrastructureTransactionIdentification);
