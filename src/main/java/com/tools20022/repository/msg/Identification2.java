...
public class Identification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification2.mmAccountOwnerTransactionIdentification, Identification2.mmAccountServicerTransactionIdentification, Identification2.mmMarketInfrastructureTransactionIdentification,
						Identification2.mmCommonIdentification, Identification2.mmTradeIdentification, Identification2.mmMasterIdentification, Identification2.mmBasketIdentification, Identification2.mmIndexIdentification,
						Identification2.mmListIdentification, Identification2.mmProgramIdentification, Identification2.mmPoolIdentification, Identification2.mmCorporateActionEventIdentification);
