...
public class CorporateActionRate23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate23.mmAdditionalQuantityForSubscribedResultantSecurities, CorporateActionRate23.mmAdditionalQuantityForExistingSecurities, CorporateActionRate23.mmNewToOld);
