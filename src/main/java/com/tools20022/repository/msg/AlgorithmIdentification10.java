...
public class AlgorithmIdentification10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AlgorithmIdentification10, Algorithm10Code> mmAlgorithm = new MMMessageAttribute<AlgorithmIdentification10, Algorithm10Code>() {
		{
		...
		@Override
		public Algorithm10Code getValue(AlgorithmIdentification10 obj) {
			return obj.getAlgorithm();
		}

		@Override
		public void setValue(AlgorithmIdentification10 obj, Algorithm10Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AlgorithmIdentification10, Optional<Parameter1>> mmParameter = new MMMessageAssociationEnd<AlgorithmIdentification10, Optional<Parameter1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AlgorithmIdentification10.mmObject();
			isDerived = false;
			xmlTag = "Param";
		...
		@Override
		public Optional<Parameter1> getValue(AlgorithmIdentification10 obj) {
			return obj.getParameter();
		}

		@Override
		public void setValue(AlgorithmIdentification10 obj, Optional<Parameter1> value) {
	...
	public AlgorithmIdentification10 setParameter(Parameter1 parameter) {
