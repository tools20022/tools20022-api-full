...
public class AccountAndBalance8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountAndBalance8.SafekeepingAccount, com.tools20022.repository.msg.AccountAndBalance8.ConfirmedBalance);
