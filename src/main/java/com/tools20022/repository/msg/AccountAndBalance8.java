...
public class AccountAndBalance8 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AccountAndBalance8
	 * AccountAndBalance8}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountAndBalance8.mmSafekeepingAccount, com.tools20022.repository.msg.AccountAndBalance8.mmConfirmedBalance);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountAndBalance8";
	...
	public AccountAndBalance8 setSafekeepingAccount(RestrictedFINXMax35Text safekeepingAccount) {
	...
	public AccountAndBalance8 setConfirmedBalance(BalanceFormat2Choice confirmedBalance) {
