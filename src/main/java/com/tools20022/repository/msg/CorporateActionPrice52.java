...
public class CorporateActionPrice52 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice52.mmIndicativeOrMarketPrice, CorporateActionPrice52.mmIssuePrice, CorporateActionPrice52.mmGenericCashPriceReceivedPerProduct,
						CorporateActionPrice52.mmGenericCashPricePaidPerProduct);
