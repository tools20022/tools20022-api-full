...
public class Linkages10 {
	...
	public static final MMMessageAssociationEnd mmProcessingPosition = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Linkages10.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Linkages10.mmProcessingPosition, Linkages10.mmMessageNumber, Linkages10.mmReference, Linkages10.mmReferenceOwner);
	...
	public void setReference(References13Choice reference) {
