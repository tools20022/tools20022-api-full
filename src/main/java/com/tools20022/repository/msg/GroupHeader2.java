...
public class GroupHeader2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader2.mmMessageIdentification, GroupHeader2.mmCreationDateTime, GroupHeader2.mmBatchBooking, GroupHeader2.mmNumberOfTransactions, GroupHeader2.mmControlSum,
						GroupHeader2.mmTotalInterbankSettlementAmount, GroupHeader2.mmInterbankSettlementDate, GroupHeader2.mmSettlementInformation, GroupHeader2.mmPaymentTypeInformation, GroupHeader2.mmInstructingAgent,
						GroupHeader2.mmInstructedAgent);
