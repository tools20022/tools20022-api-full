...
public class CardPaymentTransaction49 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction49.mmTransactionCapture, CardPaymentTransaction49.mmTransactionType, CardPaymentTransaction49.mmAdditionalService, CardPaymentTransaction49.mmServiceAttribute,
						CardPaymentTransaction49.mmMerchantCategoryCode, CardPaymentTransaction49.mmSaleReferenceIdentification, CardPaymentTransaction49.mmTransactionIdentification, CardPaymentTransaction49.mmOriginalTransaction,
						CardPaymentTransaction49.mmTransactionDetails, CardPaymentTransaction49.mmAdditionalTransactionData);
