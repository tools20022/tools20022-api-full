...
public class SecuritiesOption20 {
	...
	public static final MMMessageAssociationEnd mmSecurityIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption20.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	public void setDateDetails(com.tools20022.repository.msg.SecurityDate7 dateDetails) {
		this.dateDetails = dateDetails;
	}

	public CorporateActionRate23 getRateDetails() {
		return rateDetails;
	}

	public void setRateDetails(com.tools20022.repository.msg.CorporateActionRate23 rateDetails) {
	...
	public SettlementParties16 getReceivingSettlementParties() {
		return receivingSettlementParties;
	}

	public void setReceivingSettlementParties(com.tools20022.repository.msg.SettlementParties16 receivingSettlementParties) {
		this.receivingSettlementParties = receivingSettlementParties;
	}

	public SettlementParties16 getDeliveringSettlementParties() {
		return deliveringSettlementParties;
	}

	public void setDeliveringSettlementParties(com.tools20022.repository.msg.SettlementParties16 deliveringSettlementParties) {
