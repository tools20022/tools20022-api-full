...
public class CorporateActionOption48 {
	...
	public static final MMMessageAssociationEnd mmOptionNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption48.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	protected List<com.tools20022.repository.msg.SecuritiesOption32> securitiesMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmSecuritiesMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SecuritiesOption32.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.CashOption23> cashMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmCashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashOption23.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption48.mmOptionNumber, CorporateActionOption48.mmOptionType, CorporateActionOption48.mmSecuritiesMovementDetails, CorporateActionOption48.mmCashMovementDetails);
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption32> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption23> cashMovementDetails) {
