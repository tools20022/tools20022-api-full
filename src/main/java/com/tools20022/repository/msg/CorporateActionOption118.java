...
public class CorporateActionOption118 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption118.mmOptionNumber, CorporateActionOption118.mmOptionType, CorporateActionOption118.mmFractionDisposition, CorporateActionOption118.mmChangeType,
						CorporateActionOption118.mmEligibleForCollateralIndicator, CorporateActionOption118.mmCurrencyToBuy, CorporateActionOption118.mmCurrencyToSell, CorporateActionOption118.mmCurrencyOption,
						CorporateActionOption118.mmSecurityIdentification, CorporateActionOption118.mmSecuritiesQuantity, CorporateActionOption118.mmExecutionRequestedDateTime, CorporateActionOption118.mmRateAndAmountDetails,
						CorporateActionOption118.mmPriceDetails, CorporateActionOption118.mmAdditionalInformation);
