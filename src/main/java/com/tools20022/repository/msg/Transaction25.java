...
public class Transaction25 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Transaction25.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction25.mmAccountOwner, Transaction25.mmSafekeepingAccount, Transaction25.mmStatusAndReason, Transaction25.mmAccountOwnerTransactionIdentification,
						Transaction25.mmAccountServicerTransactionIdentification, Transaction25.mmMarketInfrastructureTransactionIdentification, Transaction25.mmProcessorTransactionIdentification, Transaction25.mmTradeIdentification,
						Transaction25.mmPoolIdentification, Transaction25.mmCommonIdentification, Transaction25.mmCorporateActionEventIdentification, Transaction25.mmTripartyAgentCollateralTransactionIdentification,
						Transaction25.mmClientTripartyCollateralTransactionIdentification, Transaction25.mmTransactionDetails);
	...
	public TransactionDetails51 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails51 transactionDetails) {
