...
import com.tools20022.repository.msg.TransactionDetails51;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transaction25#mmAccountOwner
 * Transaction25.mmAccountOwner}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction25
 * ConstraintCoexistenceIdentificationRule.forTransaction25}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction25", propOrder = {"accountOwner", "safekeepingAccount", "statusAndReason", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification",
		"processorTransactionIdentification", "tradeIdentification", "poolIdentification", "commonIdentification", "corporateActionEventIdentification", "tripartyAgentCollateralTransactionIdentification",
		"clientTripartyCollateralTransactionIdentification", "transactionDetails"})
public class Transaction25 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Transaction51#mmAccountOwner
	 * Transaction51.mmAccountOwner}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction25, Optional<SystemPartyIdentification5>> mmAccountOwner = new MMMessageAssociationEnd<Transaction25, Optional<SystemPartyIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction25.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that owns the account.";
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SystemPartyIdentification5> getValue(Transaction25 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(Transaction25 obj, Optional<SystemPartyIdentification5> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 * {@linkplain com.tools20022.repository.entity.Entry#mmAccount
	 * Entry.mmAccount}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction25, Optional<SecuritiesAccount13>> mmSafekeepingAccount = new MMMessageAssociationEnd<Transaction25, Optional<SecuritiesAccount13>>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction25.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesAccount13> getValue(Transaction25 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(Transaction25 obj, Optional<SecuritiesAccount13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction25, Optional<StatusAndReason15>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction25, Optional<StatusAndReason15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmStatusAndReason);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<StatusAndReason15> getValue(Transaction25 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction25 obj, Optional<StatusAndReason15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction25, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction25 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction25 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction25 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction25 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmMarketInfrastructureTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmProcessorTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Transaction51#mmTradeIdentification
	 * Transaction51.mmTradeIdentification}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction25, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmTradeIdentification);
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction25 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction25 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Transaction51#mmCommonIdentification
	 * Transaction51.mmCommonIdentification}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmCommonIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmTripartyAgentCollateralTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction25, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmClientTripartyCollateralTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected TransactionDetails51 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails51
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction25, Optional<TransactionDetails51>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction25, Optional<TransactionDetails51>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction51.mmTransactionDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails51.mmObject();
		}

		@Override
		public Optional<TransactionDetails51> getValue(Transaction25 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction25 obj, Optional<TransactionDetails51> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction25.mmAccountOwner, com.tools20022.repository.msg.Transaction25.mmSafekeepingAccount,
						com.tools20022.repository.msg.Transaction25.mmStatusAndReason, com.tools20022.repository.msg.Transaction25.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.Transaction25.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.Transaction25.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.Transaction25.mmProcessorTransactionIdentification, com.tools20022.repository.msg.Transaction25.mmTradeIdentification, com.tools20022.repository.msg.Transaction25.mmPoolIdentification,
						com.tools20022.repository.msg.Transaction25.mmCommonIdentification, com.tools20022.repository.msg.Transaction25.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction25.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction25.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction25.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction25,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction25);
				...
				nextVersions_lazy = () -> Arrays.asList(Transaction51.mmObject());
			}
		});
	...
	public Transaction25 setAccountOwner(SystemPartyIdentification5 accountOwner) {
	...
	public Transaction25 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public Transaction25 setStatusAndReason(StatusAndReason15 statusAndReason) {
	...
	public Transaction25 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction25 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction25 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction25 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction25 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction25 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction25 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction25 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction25 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction25 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails51> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction25 setTransactionDetails(TransactionDetails51 transactionDetails) {
