...
public class SecuritiesSettlementTransactionDetails16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails16.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails16.mmLinkages,
						SecuritiesSettlementTransactionDetails16.mmTradeDetails, SecuritiesSettlementTransactionDetails16.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails16.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails16.mmSettlementParameters, SecuritiesSettlementTransactionDetails16.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails16.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails16.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails16.mmCashParties,
						SecuritiesSettlementTransactionDetails16.mmSettlementAmount, SecuritiesSettlementTransactionDetails16.mmOtherAmounts, SecuritiesSettlementTransactionDetails16.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails16.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails16.mmSupplementaryData);
