...
public class CorporateActionOption14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption14.mmOptionNumber, CorporateActionOption14.mmOptionType, CorporateActionOption14.mmOptionFeatures, CorporateActionOption14.mmFractionDisposition,
						CorporateActionOption14.mmCurrencyOption, CorporateActionOption14.mmDateDetails, CorporateActionOption14.mmPeriodDetails, CorporateActionOption14.mmRateAndAmountDetails, CorporateActionOption14.mmPriceDetails,
						CorporateActionOption14.mmPlaceOfTrade, CorporateActionOption14.mmSecuritiesMovementDetails, CorporateActionOption14.mmCashMovementDetails);
