...
public class CorporateActionOption14 {
	...
	public static final MMMessageAssociationEnd mmOptionNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption14.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	public CorporateActionDate10 getDateDetails() {
		return dateDetails;
	}

	public void setDateDetails(com.tools20022.repository.msg.CorporateActionDate10 dateDetails) {
	...
	public CorporateActionRate10 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate10 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
	}

	public CorporateActionPrice7 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice7 priceDetails) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption8> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption9> cashMovementDetails) {
