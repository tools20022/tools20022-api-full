...
public class CancelledStatusReason5 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledStatusReason5.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatusReason5.mmReasonCode, CancelledStatusReason5.mmAdditionalReasonInformation);
	...
	public void setReasonCode(CancelledReason2Choice reasonCode) {
