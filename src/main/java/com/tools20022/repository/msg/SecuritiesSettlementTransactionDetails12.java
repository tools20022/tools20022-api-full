...
public class SecuritiesSettlementTransactionDetails12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails12.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails12.mmLinkages,
						SecuritiesSettlementTransactionDetails12.mmTradeDetails, SecuritiesSettlementTransactionDetails12.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails12.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails12.mmSettlementParameters, SecuritiesSettlementTransactionDetails12.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails12.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails12.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails12.mmCashParties,
						SecuritiesSettlementTransactionDetails12.mmSettlementAmount, SecuritiesSettlementTransactionDetails12.mmOtherAmounts, SecuritiesSettlementTransactionDetails12.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails12.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails12.mmSupplementaryData);
