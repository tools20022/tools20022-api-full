 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext20#CardPresent
 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.PaymentContext14 PaymentContext14}</li>
 * </ul>
 */
public class PaymentContext20 {
	...
	public static final MMMessageAttribute CardPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.CardPresent;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardholderPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.CardholderPresent;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.AttendanceContext;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionEnvironment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.TransactionEnvironment;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionChannel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.TransactionChannel;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AttendantMessageCapable = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.AttendantMessageCapable;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendantLanguage = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.AttendantLanguage;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardDataEntryMode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.CardDataEntryMode;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FallbackIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.FallbackIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupportedOption = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext14.SupportedOption;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext20.CardPresent, com.tools20022.repository.msg.PaymentContext20.CardholderPresent,
						com.tools20022.repository.msg.PaymentContext20.AttendanceContext, com.tools20022.repository.msg.PaymentContext20.TransactionEnvironment, com.tools20022.repository.msg.PaymentContext20.TransactionChannel,
						com.tools20022.repository.msg.PaymentContext20.AttendantMessageCapable, com.tools20022.repository.msg.PaymentContext20.AttendantLanguage, com.tools20022.repository.msg.PaymentContext20.CardDataEntryMode,
						com.tools20022.repository.msg.PaymentContext20.FallbackIndicator, com.tools20022.repository.msg.PaymentContext20.SupportedOption);
				...
				previousVersion_lazy = () -> PaymentContext14.mmObject();
			}
		});
