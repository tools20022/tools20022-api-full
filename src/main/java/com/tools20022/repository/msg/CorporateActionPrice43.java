...
public class CorporateActionPrice43 {
	...
	public static final MMMessageAssociationEnd mmIndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice43.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice56.mmIndicativeOrMarketPrice);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmIndicativeOrMarketPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCashInLieuOfSharePrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice56.mmCashInLieuOfSharePrice);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmCashInLieuOfSharePrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmCashValueForTax = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice56.mmCashValueForTax);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmCashValueForTax;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice56.mmGenericCashPricePaidPerProduct);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmGenericCashPricePaidPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice56.mmGenericCashPriceReceivedPerProduct);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice38.mmGenericCashPriceReceivedPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public PriceFormat32Choice getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct;
	}

	public void setGenericCashPriceReceivedPerProduct(PriceFormat32Choice genericCashPriceReceivedPerProduct) {
