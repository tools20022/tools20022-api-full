...
public class AccountAndBalance21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance21.mmSafekeepingAccount, AccountAndBalance21.mmAccountOwner, AccountAndBalance21.mmSafekeepingPlace, AccountAndBalance21.mmBalance);
