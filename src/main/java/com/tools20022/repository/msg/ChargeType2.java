...
import com.tools20022.repository.codeset.ChargeType7Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherCodeRule#forChargeType2
 * ConstraintOtherCodeRule.forChargeType2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "ChargeType2", propOrder = {"structured", "additionalInformation"})
public class ChargeType2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Strd", required = true)
	protected ChargeType7Code structured;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ChargeType2.mmStructured, com.tools20022.repository.msg.ChargeType2.mmAdditionalInformation);
				trace_lazy = () -> Charges.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOtherCodeRule.forChargeType2);
	...
	public ChargeType7Code getStructured() {
		return structured;
	}

	public ChargeType2 setStructured(ChargeType7Code structured) {
	...
	public ChargeType2 setAdditionalInformation(Max350Text additionalInformation) {
