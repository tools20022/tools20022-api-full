...
public class CorporateActionGeneralInformation28 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation28.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes22.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation28.mmCorporateActionEventIdentification, CorporateActionGeneralInformation28.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation28.mmEventType, CorporateActionGeneralInformation28.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes22 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes22 underlyingSecurity) {
