...
public class GenericIdentification70 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification70.mmIdentification, GenericIdentification70.mmType, GenericIdentification70.mmIssuer, GenericIdentification70.mmCountry, GenericIdentification70.mmShortName);
