...
public class GenericIdentification70 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification70, Optional<Max35Text>> mmIdentification = new MMMessageAttribute<GenericIdentification70, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification70 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification70 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification70, PartyType3Code> mmType = new MMMessageAttribute<GenericIdentification70, PartyType3Code>() {
		{
		...
		@Override
		public PartyType3Code getValue(GenericIdentification70 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification70 obj, PartyType3Code value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification70, Optional<PartyType4Code>> mmIssuer = new MMMessageAttribute<GenericIdentification70, Optional<PartyType4Code>>() {
		{
		...
		@Override
		public Optional<PartyType4Code> getValue(GenericIdentification70 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification70 obj, Optional<PartyType4Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification70, Optional<Min2Max3AlphaText>> mmCountry = new MMMessageAttribute<GenericIdentification70, Optional<Min2Max3AlphaText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification70.mmObject();
			isDerived = false;
			xmlTag = "Ctry";
		...
		@Override
		public Optional<Min2Max3AlphaText> getValue(GenericIdentification70 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(GenericIdentification70 obj, Optional<Min2Max3AlphaText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification70, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification70, Optional<Max35Text>>() {
		{
