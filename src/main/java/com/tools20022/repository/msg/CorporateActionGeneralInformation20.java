...
public class CorporateActionGeneralInformation20 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation20.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation20.mmCorporateActionEventIdentification, CorporateActionGeneralInformation20.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation20.mmClassActionNumber, CorporateActionGeneralInformation20.mmEventType, CorporateActionGeneralInformation20.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation20.mmUnderlyingSecurityIdentification);
	...
	public void setUnderlyingSecurityIdentification(com.tools20022.repository.msg.SecurityIdentification12 underlyingSecurityIdentification) {
