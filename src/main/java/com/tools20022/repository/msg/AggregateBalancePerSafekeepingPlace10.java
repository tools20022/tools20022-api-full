...
public class AggregateBalancePerSafekeepingPlace10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace10.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace10.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace10.mmAggregateBalance,
						AggregateBalancePerSafekeepingPlace10.mmPriceDetails, AggregateBalancePerSafekeepingPlace10.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace10.mmDaysAccrued,
						AggregateBalancePerSafekeepingPlace10.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace10.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace10.mmAlternateReportingCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace10.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace10.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace10.mmAdditionalBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace10.mmHoldingAdditionalDetails);
