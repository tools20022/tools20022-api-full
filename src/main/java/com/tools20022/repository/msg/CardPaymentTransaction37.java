...
public class CardPaymentTransaction37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction37.mmSaleReferenceIdentification, CardPaymentTransaction37.mmTransactionIdentification, CardPaymentTransaction37.mmPOIIdentification,
						CardPaymentTransaction37.mmInitiatorTransactionIdentification, CardPaymentTransaction37.mmRecipientTransactionIdentification, CardPaymentTransaction37.mmTransactionType, CardPaymentTransaction37.mmAdditionalService,
						CardPaymentTransaction37.mmServiceAttribute, CardPaymentTransaction37.mmTransactionResult);
