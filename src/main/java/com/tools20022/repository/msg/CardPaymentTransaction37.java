...
@XmlType(name = "CardPaymentTransaction37", propOrder = {"saleReferenceIdentification", "transactionIdentification", "pOIIdentification", "initiatorTransactionIdentification", "recipientTransactionIdentification", "transactionType",
...
public class CardPaymentTransaction37 {
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPOIIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmPOIIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmPOIIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmInitiatorTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmRecipientTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmTransactionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmTransactionType);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAdditionalService = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmAdditionalService);
	...
	public static final MMMessageAttribute mmServiceAttribute = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmServiceAttribute);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
	...
	protected CardPaymentTransactionResult2 transactionResult;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmTransactionResult = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmTransactionResult);
			previousVersion_lazy = () -> CardPaymentTransaction21.mmTransactionResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction37.mmSaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction37.mmTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction37.mmPOIIdentification, com.tools20022.repository.msg.CardPaymentTransaction37.mmInitiatorTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction37.mmRecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction37.mmTransactionType,
						com.tools20022.repository.msg.CardPaymentTransaction37.mmAdditionalService, com.tools20022.repository.msg.CardPaymentTransaction37.mmServiceAttribute,
						com.tools20022.repository.msg.CardPaymentTransaction37.mmTransactionResult);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction37";
				definition = "Identification of the original transaction.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction52.mmObject());
	...
	public CardPaymentTransaction37 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction37 setInitiatorTransactionIdentification(Max35Text initiatorTransactionIdentification) {
	...
	public CardPaymentTransaction37 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction37 setTransactionType(CardPaymentServiceType5Code transactionType) {
	...
	public CardPaymentTransaction37 setAdditionalService(List<CardPaymentServiceType6Code> additionalService) {
	...
	public CardPaymentTransaction37 setServiceAttribute(CardPaymentServiceType3Code serviceAttribute) {
		this.serviceAttribute = serviceAttribute;
		return this;
	}

	public Optional<CardPaymentTransactionResult2> getTransactionResult() {
