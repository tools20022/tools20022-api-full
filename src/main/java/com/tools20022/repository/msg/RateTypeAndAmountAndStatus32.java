...
public class RateTypeAndAmountAndStatus32 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus32.mmRateType, RateTypeAndAmountAndStatus32.mmAmount, RateTypeAndAmountAndStatus32.mmRateStatus);
	...
	public void setRateType(RateType45Choice rateType) {
