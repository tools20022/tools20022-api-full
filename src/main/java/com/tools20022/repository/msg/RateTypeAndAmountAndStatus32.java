...
@XmlType(name = "RateTypeAndAmountAndStatus32", propOrder = {"rateType", "amount", "rateStatus"})
public class RateTypeAndAmountAndStatus32 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RateTp", required = true)
	protected RateType45Choice rateType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus32, RateType45Choice> mmRateType = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus32, RateType45Choice>() {
		{
			businessElementTrace_lazy = () -> Interest.mmInterestCalculation;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus32.mmObject();
			isDerived = false;
			xmlTag = "RateTp";
		...
		@Override
		public RateType45Choice getValue(RateTypeAndAmountAndStatus32 obj) {
			return obj.getRateType();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus32 obj, RateType45Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateTypeAndAmountAndStatus32, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateTypeAndAmountAndStatus32, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(RateTypeAndAmountAndStatus32 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus32 obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus32, Optional<RateStatus4Choice>> mmRateStatus = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus32, Optional<RateStatus4Choice>>() {
		{
		...
		@Override
		public Optional<RateStatus4Choice> getValue(RateTypeAndAmountAndStatus32 obj) {
			return obj.getRateStatus();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus32 obj, Optional<RateStatus4Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus32.mmRateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus32.mmAmount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus32.mmRateStatus);
	...
	public RateType45Choice getRateType() {
		return rateType;
	}

	public RateTypeAndAmountAndStatus32 setRateType(RateType45Choice rateType) {
	...
	public RateTypeAndAmountAndStatus32 setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateTypeAndAmountAndStatus32 setRateStatus(RateStatus4Choice rateStatus) {
