...
public class FinancialInstrumentAttributes70 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes70.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes70.mmPlaceOfListing, FinancialInstrumentAttributes70.mmDayCountBasis,
						FinancialInstrumentAttributes70.mmClassificationType, FinancialInstrumentAttributes70.mmOptionStyle, FinancialInstrumentAttributes70.mmDenominationCurrency, FinancialInstrumentAttributes70.mmNextCouponDate,
						FinancialInstrumentAttributes70.mmExpiryDate, FinancialInstrumentAttributes70.mmFloatingRateFixingDate, FinancialInstrumentAttributes70.mmMaturityDate, FinancialInstrumentAttributes70.mmIssueDate,
						FinancialInstrumentAttributes70.mmNextCallableDate, FinancialInstrumentAttributes70.mmPutableDate, FinancialInstrumentAttributes70.mmDatedDate, FinancialInstrumentAttributes70.mmConversionDate,
						FinancialInstrumentAttributes70.mmInterestRate, FinancialInstrumentAttributes70.mmNextInterestRate, FinancialInstrumentAttributes70.mmPercentageOfDebtClaim, FinancialInstrumentAttributes70.mmPreviousFactor,
						FinancialInstrumentAttributes70.mmNextFactor, FinancialInstrumentAttributes70.mmWarrantParity, FinancialInstrumentAttributes70.mmMinimumNominalQuantity, FinancialInstrumentAttributes70.mmContractSize);
