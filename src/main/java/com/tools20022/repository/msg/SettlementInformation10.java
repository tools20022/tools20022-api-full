...
public class SettlementInformation10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementInformation10.SettlementMethod, com.tools20022.repository.msg.SettlementInformation10.SettlementAccount,
						com.tools20022.repository.msg.SettlementInformation10.ClearingSystem);
