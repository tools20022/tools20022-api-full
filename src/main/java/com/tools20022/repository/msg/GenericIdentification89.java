...
@XmlType(name = "GenericIdentification89", propOrder = {"type", "identification"})
public class GenericIdentification89 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification89.mmType, com.tools20022.repository.msg.GenericIdentification89.mmIdentification);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GenericIdentification89";
	...
	public GenericIdentification89 setIdentification(RestrictedFINXMax30Text identification) {
