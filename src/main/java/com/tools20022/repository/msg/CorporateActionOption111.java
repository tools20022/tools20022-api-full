...
public class CorporateActionOption111 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption111.mmOptionNumber, CorporateActionOption111.mmOptionType, CorporateActionOption111.mmOptionFeatures, CorporateActionOption111.mmFractionDisposition,
						CorporateActionOption111.mmCurrencyOption, CorporateActionOption111.mmDateDetails, CorporateActionOption111.mmPeriodDetails, CorporateActionOption111.mmRateAndAmountDetails, CorporateActionOption111.mmPriceDetails,
						CorporateActionOption111.mmPlaceOfTrade, CorporateActionOption111.mmSecuritiesMovementDetails, CorporateActionOption111.mmCashMovementDetails);
