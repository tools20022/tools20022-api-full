...
public class InstructedBalanceDetails1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InstructedBalanceDetails1.TotalInstructedBalance, com.tools20022.repository.msg.InstructedBalanceDetails1.OptionDetails);
