...
public class InstructedBalanceDetails1 {
	...
	public static final MMMessageAttribute mmTotalInstructedBalance = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InstructedBalanceDetails1.mmObject();
			isDerived = false;
			xmlTag = "TtlInstdBal";
	...
	protected List<com.tools20022.repository.msg.InstructedCorporateActionOption1> optionDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmOptionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.InstructedCorporateActionOption1.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructedBalanceDetails1.mmTotalInstructedBalance, InstructedBalanceDetails1.mmOptionDetails);
	...
	public void setOptionDetails(List<com.tools20022.repository.msg.InstructedCorporateActionOption1> optionDetails) {
