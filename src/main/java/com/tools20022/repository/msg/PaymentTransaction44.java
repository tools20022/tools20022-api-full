...
public class PaymentTransaction44 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction44.mmReturnIdentification, PaymentTransaction44.mmOriginalGroupInformation, PaymentTransaction44.mmOriginalInstructionIdentification,
						PaymentTransaction44.mmOriginalEndToEndIdentification, PaymentTransaction44.mmOriginalTransactionIdentification, PaymentTransaction44.mmOriginalClearingSystemReference,
						PaymentTransaction44.mmOriginalInterbankSettlementAmount, PaymentTransaction44.mmReturnedInterbankSettlementAmount, PaymentTransaction44.mmInterbankSettlementDate, PaymentTransaction44.mmReturnedInstructedAmount,
						PaymentTransaction44.mmExchangeRate, PaymentTransaction44.mmCompensationAmount, PaymentTransaction44.mmChargeBearer, PaymentTransaction44.mmChargesInformation, PaymentTransaction44.mmInstructingAgent,
						PaymentTransaction44.mmInstructedAgent, PaymentTransaction44.mmReturnReasonInformation, PaymentTransaction44.mmOriginalTransactionReference, PaymentTransaction44.mmSupplementaryData);
