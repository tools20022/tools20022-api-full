 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.UnderlyingSecurity2#mmSecurityIdentification
 * UnderlyingSecurity2.mmSecurityIdentification}</li>
 * </ul>
 * </li>
...
public class UnderlyingSecurity2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.UnderlyingSecurity2
	 * UnderlyingSecurity2}</li>
	...
	public static final MMMessageAssociationEnd mmSecurityIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnderlyingSecurity2.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingSecurity2.mmSecurityIdentification);
				trace_lazy = () -> Security.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.mmdataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "UnderlyingSecurity2";
