...
public class RejectionOrRepairReason11 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason11.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason11.mmCode, RejectionOrRepairReason11.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason11Choice code) {
		this.code = code;
	}
