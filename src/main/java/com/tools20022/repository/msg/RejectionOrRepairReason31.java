...
public class RejectionOrRepairReason31 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason31.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason31.mmCode, RejectionOrRepairReason31.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason31Choice code) {
		this.code = code;
	}
