...
import com.tools20022.repository.choice.RejectionAndRepairReason31Choice;
...
@XmlType(name = "RejectionOrRepairReason31", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason31 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionAndRepairReason31Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.RejectionAndRepairReason31Choice
	 * RejectionAndRepairReason31Choice}</li>
	 * <li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason31.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason31.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairReason31";
	...
	public RejectionAndRepairReason31Choice getCode() {
		return code;
	}

	public RejectionOrRepairReason31 setCode(RejectionAndRepairReason31Choice code) {
	...
	public RejectionOrRepairReason31 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
