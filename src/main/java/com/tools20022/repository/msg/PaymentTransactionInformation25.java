...
public class PaymentTransactionInformation25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation25.mmStatusIdentification, PaymentTransactionInformation25.mmOriginalInstructionIdentification,
						PaymentTransactionInformation25.mmOriginalEndToEndIdentification, PaymentTransactionInformation25.mmTransactionStatus, PaymentTransactionInformation25.mmStatusReasonInformation,
						PaymentTransactionInformation25.mmChargesInformation, PaymentTransactionInformation25.mmAcceptanceDateTime, PaymentTransactionInformation25.mmAccountServicerReference,
						PaymentTransactionInformation25.mmClearingSystemReference, PaymentTransactionInformation25.mmOriginalTransactionReference);
