...
public class AccountAndBalance14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance14.mmSafekeepingAccount, AccountAndBalance14.mmAccountOwner, AccountAndBalance14.mmSafekeepingPlace, AccountAndBalance14.mmBalance);
