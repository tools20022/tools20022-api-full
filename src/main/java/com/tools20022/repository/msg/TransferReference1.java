...
import com.tools20022.repository.area.sese.TransferOutCancellationRequestV03;
...
@XmlType(name = "TransferReference1", propOrder = {"masterReference", "transferReference", "clientReference", "cancellationReference"})
public class TransferReference1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference1, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<TransferReference1, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransferReference1.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual transfers as assigned by the instructing party. This identifier links the individual transfers together.";
			nextVersions_lazy = () -> Arrays.asList(TransferReference5.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(TransferReference1 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(TransferReference1 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference1, Max35Text> mmTransferReference = new MMMessageAttribute<TransferReference1, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference5.mmTransferReference, TransferReference8.mmTransferReference);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(TransferReference1 obj) {
			return obj.getTransferReference();
		}

		@Override
		public void setValue(TransferReference1 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference1, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<TransferReference1, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference5.mmClientReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference1, Optional<Max35Text>> mmCancellationReference = new MMMessageAttribute<TransferReference1, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransferReference1.mmObject();
			isDerived = false;
			xmlTag = "CxlRef";
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference5.mmCancellationReference, TransferReference8.mmCancellationReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference1.mmMasterReference, com.tools20022.repository.msg.TransferReference1.mmTransferReference,
						com.tools20022.repository.msg.TransferReference1.mmClientReference, com.tools20022.repository.msg.TransferReference1.mmCancellationReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInCancellationRequestV02.mmCancellationByReference, TransferInCancellationRequestV03.mmCancellationByReference,
						TransferOutCancellationRequestV02.mmCancellationByReference, TransferOutCancellationRequestV03.mmCancellationByReference);
	...
	public TransferReference1 setMasterReference(Max35Text masterReference) {
	...
	public TransferReference1 setTransferReference(Max35Text transferReference) {
	...
	public TransferReference1 setClientReference(Max35Text clientReference) {
	...
	public TransferReference1 setCancellationReference(Max35Text cancellationReference) {
