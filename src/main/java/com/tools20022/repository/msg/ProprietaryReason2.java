...
public class ProprietaryReason2 {
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProprietaryReason2.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProprietaryReason2.mmReason, ProprietaryReason2.mmAdditionalReasonInformation);
	...
	@XmlElement(name = "Rsn")
	public GenericIdentification25 getReason() {
		return reason;
	}

	public void setReason(com.tools20022.repository.msg.GenericIdentification25 reason) {
		this.reason = reason;
	}
