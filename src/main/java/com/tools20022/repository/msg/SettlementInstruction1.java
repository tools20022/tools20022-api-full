...
public class SettlementInstruction1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementInstruction1.mmSettlementMethod, SettlementInstruction1.mmSettlementAccount, SettlementInstruction1.mmClearingSystem,
						SettlementInstruction1.mmInstructingReimbursementAgent, SettlementInstruction1.mmInstructingReimbursementAgentAccount, SettlementInstruction1.mmInstructedReimbursementAgent,
						SettlementInstruction1.mmInstructedReimbursementAgentAccount, SettlementInstruction1.mmThirdReimbursementAgent, SettlementInstruction1.mmThirdReimbursementAgentAccount);
