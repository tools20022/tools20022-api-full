...
public class RejectionReason37 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason37.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason37.mmCode, RejectionReason37.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason31Choice code) {
		this.code = code;
	}
