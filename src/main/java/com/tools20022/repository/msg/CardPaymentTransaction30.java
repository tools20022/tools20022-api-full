...
public class CardPaymentTransaction30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction30.mmMerchantCategoryCode, CardPaymentTransaction30.mmSaleReferenceIdentification, CardPaymentTransaction30.mmTransactionIdentification,
						CardPaymentTransaction30.mmOriginalTransaction, CardPaymentTransaction30.mmTransactionSuccess, CardPaymentTransaction30.mmReversal, CardPaymentTransaction30.mmFailureReason,
						CardPaymentTransaction30.mmRecipientTransactionIdentification, CardPaymentTransaction30.mmReconciliationIdentification, CardPaymentTransaction30.mmInterchangeData, CardPaymentTransaction30.mmTransactionDetails,
						CardPaymentTransaction30.mmAuthorisationResult, CardPaymentTransaction30.mmAdditionalTransactionData);
