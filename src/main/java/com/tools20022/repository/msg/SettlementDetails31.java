...
public class SettlementDetails31 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails31.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails31.mmHoldIndicator, SettlementDetails31.mmPriority, SettlementDetails31.mmSettlementTransactionCondition, SettlementDetails31.mmSettlingCapacity,
						SettlementDetails31.mmStampDutyTaxBasis, SettlementDetails31.mmSecuritiesRTGS, SettlementDetails31.mmBeneficialOwnership, SettlementDetails31.mmCashClearingSystem, SettlementDetails31.mmTaxCapacity,
						SettlementDetails31.mmMarketClientSide, SettlementDetails31.mmFXStandingInstruction, SettlementDetails31.mmBlockTrade, SettlementDetails31.mmLegalRestrictions, SettlementDetails31.mmSettlementSystemMethod,
						SettlementDetails31.mmNettingEligibility, SettlementDetails31.mmCCPEligibility, SettlementDetails31.mmTracking, SettlementDetails31.mmAutomaticBorrowing, SettlementDetails31.mmPartialSettlementIndicator,
						SettlementDetails31.mmEligibleForCollateral);
