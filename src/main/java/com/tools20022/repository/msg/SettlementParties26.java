 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties26#mmParty2
 * SettlementParties26.mmParty2}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties26#mmParty3
 * SettlementParties26.mmParty3}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties26#mmParty4
 * SettlementParties26.mmParty4}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties26#mmParty5
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintParty4PresenceRule#forSettlementParties26
 * ConstraintParty4PresenceRule.forSettlementParties26}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementChainGuideline#forSettlementParties26
 * ConstraintSettlementChainGuideline.forSettlementParties26}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDepositoryGuideline#forSettlementParties26
 * ConstraintDepositoryGuideline.forSettlementParties26}</li>
 * <li>
...
@XmlType(name = "SettlementParties26", propOrder = {"party2", "party3", "party4", "party5"})
public class SettlementParties26 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>> mmParty2 = new MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties26.mmObject();
			isDerived = false;
			xmlTag = "Pty2";
		...
		@Override
		public Optional<PartyIdentificationAndAccount42> getValue(SettlementParties26 obj) {
			return obj.getParty2();
		}

		@Override
		public void setValue(SettlementParties26 obj, Optional<PartyIdentificationAndAccount42> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>> mmParty3 = new MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties26.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>> mmParty4 = new MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties26.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>> mmParty5 = new MMMessageAssociationEnd<SettlementParties26, Optional<PartyIdentificationAndAccount42>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties26.mmObject();
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintParty3PresenceRule.forSettlementParties26, com.tools20022.repository.constraints.ConstraintParty4PresenceRule.forSettlementParties26,
						com.tools20022.repository.constraints.ConstraintParty5PresenceRule.forSettlementParties26, com.tools20022.repository.constraints.ConstraintSettlementChainGuideline.forSettlementParties26,
						com.tools20022.repository.constraints.ConstraintDepositoryGuideline.forSettlementParties26, com.tools20022.repository.constraints.ConstraintBookTransferGuideline.forSettlementParties26);
	...
	public SettlementParties26 setParty2(PartyIdentificationAndAccount42 party2) {
		this.party2 = party2;
		return this;
	}
	...
	public SettlementParties26 setParty3(PartyIdentificationAndAccount42 party3) {
		this.party3 = party3;
		return this;
	}
	...
	public SettlementParties26 setParty4(PartyIdentificationAndAccount42 party4) {
		this.party4 = party4;
		return this;
	}
	...
	public SettlementParties26 setParty5(PartyIdentificationAndAccount42 party5) {
		this.party5 = party5;
		return this;
	}
}