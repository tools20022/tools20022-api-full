	...
	public static final MMMessageAssociationEnd mmPaymentIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmPaymentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInstructedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmInstructedAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmChargeBearer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmDirectDebitTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmDirectDebitTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmUltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmDebtorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmDebtorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmDebtor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PartyIdentification43.mmObject();
	...
	public static final MMMessageAssociationEnd mmDebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmDebtorAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccount24.mmObject();
	...
	public static final MMMessageAssociationEnd mmUltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmUltimateDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PartyIdentification43.mmObject();
	...
	public static final MMMessageAttribute mmInstructionForCreditorAgent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmInstructionForCreditorAgent;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPurpose = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmPurpose;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRegulatoryReporting = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmRegulatoryReporting;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTax = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRelatedRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmRelatedRemittanceInformation;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DirectDebitTransactionInformation19.mmRemittanceInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
