 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.AccountReport1
 * AccountReport1}</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountReportV02.mmReport);
				...
				previousVersion_lazy = () -> AccountReport1.mmObject();
			}
		});
