...
public class SettlementDetails126 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails126, List<SettlementTransactionCondition16Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails126.mmObject();
			isDerived = false;
			xmlTag = "SttlmTxCond";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementTransactionCondition";
			definition = "Conditions under which the order/trade is to be settled.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails91.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails126 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails126 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails126, Optional<SettlingCapacity7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails91.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails126 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails126, Optional<GenericIdentification30>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails91.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails126 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails126, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails91.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails126 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails126, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmRegistration);
			previousVersion_lazy = () -> SettlementDetails91.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails126 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails126, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails91.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails126 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails126, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails91.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails126 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails126, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails91.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails126 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<RepurchaseType22Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails126, Optional<RepurchaseType22Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmRepurchaseType);
			previousVersion_lazy = () -> SettlementDetails91.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType22Choice> getValue(SettlementDetails126 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<RepurchaseType22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<MarketClientSide4Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails126, Optional<MarketClientSide4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails91.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide4Choice> getValue(SettlementDetails126 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<MarketClientSide4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails126, Optional<BlockTrade4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails91.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails126 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails126, Optional<Restriction5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails91.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails126 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails126, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails91.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails126 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails126, Optional<NettingEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails91.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails126 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails126, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails91.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails126 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails126, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails126, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmLetterOfGuarantee);
			previousVersion_lazy = () -> SettlementDetails91.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails126 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails126, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails126, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails126.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails91.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails126 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails126 obj, Optional<SettlementTransactionCondition5Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails126.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails126.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails126.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails126.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails126.mmRegistration,
						com.tools20022.repository.msg.SettlementDetails126.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails126.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails126.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails126.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails126.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails126.mmBlockTrade,
						com.tools20022.repository.msg.SettlementDetails126.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails126.mmSettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails126.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails126.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails126.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails126.mmPartialSettlementIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails126,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails126);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails126";
				definition = "Details of settlement of a transaction.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails150.mmObject());
				previousVersion_lazy = () -> SettlementDetails91.mmObject();
			}
		});
	...
	public SettlementDetails126 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails126 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails126 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails126 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails126 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails126 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails126 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails126 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails126 setRepurchaseType(RepurchaseType22Choice repurchaseType) {
	...
	public SettlementDetails126 setMarketClientSide(MarketClientSide4Choice marketClientSide) {
	...
	public SettlementDetails126 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails126 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails126 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails126 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails126 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails126 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails126 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
