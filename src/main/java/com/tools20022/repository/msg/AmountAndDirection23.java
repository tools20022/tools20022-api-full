...
public class AmountAndDirection23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection23.mmAmount, AmountAndDirection23.mmCreditDebitIndicator, AmountAndDirection23.mmForeignExchangeDetails);
