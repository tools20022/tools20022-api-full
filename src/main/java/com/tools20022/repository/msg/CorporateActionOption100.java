...
import com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV05;
...
public class CorporateActionOption100 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Exact3NumericText> mmOptionNumber = new MMMessageAttribute<CorporateActionOption100, Exact3NumericText>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption100.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmOptionNumber);
			previousVersion_lazy = () -> CorporateActionOption52.mmOptionNumber;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Exact3NumericText getValue(CorporateActionOption100 obj) {
			return obj.getOptionNumber();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Exact3NumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, CorporateActionOption10Choice> mmOptionType = new MMMessageAssociationEnd<CorporateActionOption100, CorporateActionOption10Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmOptionType);
			previousVersion_lazy = () -> CorporateActionOption52.mmOptionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionOption10Choice getValue(CorporateActionOption100 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, CorporateActionOption10Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<FractionDispositionType19Choice>> mmFractionDisposition = new MMMessageAssociationEnd<CorporateActionOption100, Optional<FractionDispositionType19Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmFractionDisposition);
			previousVersion_lazy = () -> CorporateActionOption52.mmFractionDisposition;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FractionDispositionType19Choice> getValue(CorporateActionOption100 obj) {
			return obj.getFractionDisposition();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<FractionDispositionType19Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, List<OfferTypeFormat5Choice>> mmOfferType = new MMMessageAssociationEnd<CorporateActionOption100, List<OfferTypeFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmOfferType);
			previousVersion_lazy = () -> CorporateActionOption52.mmOfferType;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<OfferTypeFormat5Choice> getValue(CorporateActionOption100 obj) {
			return obj.getOfferType();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<OfferTypeFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, List<OptionFeaturesFormat9Choice>> mmOptionFeatures = new MMMessageAssociationEnd<CorporateActionOption100, List<OptionFeaturesFormat9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmOptionFeatures);
			previousVersion_lazy = () -> CorporateActionOption52.mmOptionFeatures;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<OptionFeaturesFormat9Choice> getValue(CorporateActionOption100 obj) {
			return obj.getOptionFeatures();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<OptionFeaturesFormat9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<IntermediateSecuritiesDistributionTypeFormat9Choice>> mmIntermediateSecuritiesDistributionType = new MMMessageAssociationEnd<CorporateActionOption100, Optional<IntermediateSecuritiesDistributionTypeFormat9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmIntermediateSecuritiesDistributionType);
			previousVersion_lazy = () -> CorporateActionOption52.mmIntermediateSecuritiesDistributionType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<IntermediateSecuritiesDistributionTypeFormat9Choice> getValue(CorporateActionOption100 obj) {
			return obj.getIntermediateSecuritiesDistributionType();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<IntermediateSecuritiesDistributionTypeFormat9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<OptionAvailabilityStatus1Choice>> mmOptionAvailabilityStatus = new MMMessageAssociationEnd<CorporateActionOption100, Optional<OptionAvailabilityStatus1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmOptionAvailabilityStatus);
			previousVersion_lazy = () -> CorporateActionOption52.mmOptionAvailabilityStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionAvailabilityStatus1Choice> getValue(CorporateActionOption100 obj) {
			return obj.getOptionAvailabilityStatus();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<OptionAvailabilityStatus1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, List<BeneficiaryCertificationType5Choice>> mmCertificationBreakdownType = new MMMessageAssociationEnd<CorporateActionOption100, List<BeneficiaryCertificationType5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmCertificationBreakdownType);
			previousVersion_lazy = () -> CorporateActionOption52.mmCertificationBreakdownType;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<BeneficiaryCertificationType5Choice> getValue(CorporateActionOption100 obj) {
			return obj.getCertificationBreakdownType();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<BeneficiaryCertificationType5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, List<CountryCode>> mmNonDomicileCountry = new MMMessageAttribute<CorporateActionOption100, List<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmNonDomicileCountry);
			previousVersion_lazy = () -> CorporateActionOption52.mmNonDomicileCountry;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}

		@Override
		public List<CountryCode> getValue(CorporateActionOption100 obj) {
			return obj.getNonDomicileCountry();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, List<CountryCode>> mmValidDomicileCountry = new MMMessageAttribute<CorporateActionOption100, List<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmValidDomicileCountry);
			previousVersion_lazy = () -> CorporateActionOption52.mmValidDomicileCountry;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Optional<ActiveCurrencyCode>> mmCurrencyOption = new MMMessageAttribute<CorporateActionOption100, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmCurrencyOption);
			previousVersion_lazy = () -> CorporateActionOption52.mmCurrencyOption;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(CorporateActionOption100 obj) {
			return obj.getCurrencyOption();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, DefaultProcessingOrStandingInstruction1Choice> mmDefaultProcessingOrStandingInstruction = new MMMessageAssociationEnd<CorporateActionOption100, DefaultProcessingOrStandingInstruction1Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption100.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmDefaultProcessingOrStandingInstruction);
			previousVersion_lazy = () -> CorporateActionOption52.mmDefaultProcessingOrStandingInstruction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DefaultProcessingOrStandingInstruction1Choice getValue(CorporateActionOption100 obj) {
			return obj.getDefaultProcessingOrStandingInstruction();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, DefaultProcessingOrStandingInstruction1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>> mmChargesAppliedIndicator = new MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmChargesAppliedIndicator);
			previousVersion_lazy = () -> CorporateActionOption52.mmChargesAppliedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CorporateActionOption100 obj) {
			return obj.getChargesAppliedIndicator();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>> mmCertificationBreakdownIndicator = new MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>> mmWithdrawalAllowedIndicator = new MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmWithdrawalAllowedIndicator);
			previousVersion_lazy = () -> CorporateActionOption52.mmWithdrawalAllowedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>> mmChangeAllowedIndicator = new MMMessageAttribute<CorporateActionOption100, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmChangeAllowedIndicator);
			previousVersion_lazy = () -> CorporateActionOption52.mmChangeAllowedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<SecurityIdentification14>> mmSecurityIdentification = new MMMessageAssociationEnd<CorporateActionOption100, Optional<SecurityIdentification14>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmSecurityIdentification);
			previousVersion_lazy = () -> CorporateActionOption52.mmSecurityIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecurityIdentification14> getValue(CorporateActionOption100 obj) {
			return obj.getSecurityIdentification();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<SecurityIdentification14> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionDate29>> mmDateDetails = new MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionDate29>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmDateDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionDate29.mmObject();
		}

		@Override
		public Optional<CorporateActionDate29> getValue(CorporateActionOption100 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<CorporateActionDate29> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionPeriod7>> mmPeriodDetails = new MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionPeriod7>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption100.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmPeriodDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmPeriodDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionPeriod7> getValue(CorporateActionOption100 obj) {
			return obj.getPeriodDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<CorporateActionPeriod7> value) {
			obj.setPeriodDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "RateAndAmtDtls")
	protected CorporateActionRate45 rateAndAmountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionRate45
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionRate45>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionRate45>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption100.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmRateAndAmountDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmRateAndAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionRate45.mmObject();
		}

		@Override
		public Optional<CorporateActionRate45> getValue(CorporateActionOption100 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<CorporateActionRate45> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionPrice28>> mmPriceDetails = new MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionPrice28>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmPriceDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmPriceDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionPrice28> getValue(CorporateActionOption100 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<CorporateActionPrice28> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<SecuritiesOption23>> mmSecuritiesQuantity = new MMMessageAssociationEnd<CorporateActionOption100, Optional<SecuritiesOption23>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmSecuritiesQuantity);
			previousVersion_lazy = () -> CorporateActionOption52.mmSecuritiesQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesOption23> getValue(CorporateActionOption100 obj) {
			return obj.getSecuritiesQuantity();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<SecuritiesOption23> value) {
			obj.setSecuritiesQuantity(value.orElse(null));
		}
	};
	@XmlElement(name = "SctiesMvmntDtls")
	protected List<SecuritiesOption40> securitiesMovementDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, List<SecuritiesOption40>> mmSecuritiesMovementDetails = new MMMessageAssociationEnd<CorporateActionOption100, List<SecuritiesOption40>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmSecuritiesMovementDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmSecuritiesMovementDetails;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SecuritiesOption40.mmObject();
		}

		@Override
		public List<SecuritiesOption40> getValue(CorporateActionOption100 obj) {
			return obj.getSecuritiesMovementDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<SecuritiesOption40> value) {
			obj.setSecuritiesMovementDetails(value);
		}
	};
	@XmlElement(name = "CshMvmntDtls")
	protected List<CashOption31> cashMovementDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CashOption31
	 * CashOption31}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, List<CashOption31>> mmCashMovementDetails = new MMMessageAssociationEnd<CorporateActionOption100, List<CashOption31>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmCashMovementDetails);
			previousVersion_lazy = () -> CorporateActionOption52.mmCashMovementDetails;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashOption31.mmObject();
		}

		@Override
		public List<CashOption31> getValue(CorporateActionOption100 obj) {
			return obj.getCashMovementDetails();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, List<CashOption31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionNarrative20>> mmAdditionalInformation = new MMMessageAssociationEnd<CorporateActionOption100, Optional<CorporateActionNarrative20>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption100.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmAdditionalInformation);
			previousVersion_lazy = () -> CorporateActionOption52.mmAdditionalInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionNarrative20> getValue(CorporateActionOption100 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(CorporateActionOption100 obj, Optional<CorporateActionNarrative20> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption100.mmOptionNumber, com.tools20022.repository.msg.CorporateActionOption100.mmOptionType,
						com.tools20022.repository.msg.CorporateActionOption100.mmFractionDisposition, com.tools20022.repository.msg.CorporateActionOption100.mmOfferType,
						com.tools20022.repository.msg.CorporateActionOption100.mmOptionFeatures, com.tools20022.repository.msg.CorporateActionOption100.mmIntermediateSecuritiesDistributionType,
						com.tools20022.repository.msg.CorporateActionOption100.mmOptionAvailabilityStatus, com.tools20022.repository.msg.CorporateActionOption100.mmCertificationBreakdownType,
						com.tools20022.repository.msg.CorporateActionOption100.mmNonDomicileCountry, com.tools20022.repository.msg.CorporateActionOption100.mmValidDomicileCountry,
						com.tools20022.repository.msg.CorporateActionOption100.mmCurrencyOption, com.tools20022.repository.msg.CorporateActionOption100.mmDefaultProcessingOrStandingInstruction,
						com.tools20022.repository.msg.CorporateActionOption100.mmChargesAppliedIndicator, com.tools20022.repository.msg.CorporateActionOption100.mmCertificationBreakdownIndicator,
						com.tools20022.repository.msg.CorporateActionOption100.mmWithdrawalAllowedIndicator, com.tools20022.repository.msg.CorporateActionOption100.mmChangeAllowedIndicator,
						com.tools20022.repository.msg.CorporateActionOption100.mmSecurityIdentification, com.tools20022.repository.msg.CorporateActionOption100.mmDateDetails,
						...
						com.tools20022.repository.msg.CorporateActionOption100.mmPriceDetails, com.tools20022.repository.msg.CorporateActionOption100.mmSecuritiesQuantity,
						com.tools20022.repository.msg.CorporateActionOption100.mmSecuritiesMovementDetails, com.tools20022.repository.msg.CorporateActionOption100.mmCashMovementDetails,
						com.tools20022.repository.msg.CorporateActionOption100.mmAdditionalInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdviceV05.mmCorporateActionMovementDetails, CorporateActionMovementPreliminaryAdviceV06.mmCorporateActionMovementDetails);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalTextRule.forCorporateActionOption100,
						com.tools20022.repository.constraints.ConstraintOptionNumberGuideline.forCorporateActionOption100, com.tools20022.repository.constraints.ConstraintRevocabilityPeriodRule.forCorporateActionOption100,
						com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forCorporateActionOption100, com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCorporateActionOption100);
				...
				name = "CorporateActionOption100";
				definition = "Provides information about the corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionOption115.mmObject());
				previousVersion_lazy = () -> CorporateActionOption52.mmObject();
			}
		});
	...
	public CorporateActionOption100 setOptionNumber(Exact3NumericText optionNumber) {
	...
	public CorporateActionOption100 setOptionType(CorporateActionOption10Choice optionType) {
	...
	public CorporateActionOption100 setFractionDisposition(FractionDispositionType19Choice fractionDisposition) {
	...
	public CorporateActionOption100 setOfferType(List<OfferTypeFormat5Choice> offerType) {
	...
	public CorporateActionOption100 setOptionFeatures(List<OptionFeaturesFormat9Choice> optionFeatures) {
	...
	public CorporateActionOption100 setIntermediateSecuritiesDistributionType(IntermediateSecuritiesDistributionTypeFormat9Choice intermediateSecuritiesDistributionType) {
	...
	public CorporateActionOption100 setOptionAvailabilityStatus(OptionAvailabilityStatus1Choice optionAvailabilityStatus) {
	...
	public CorporateActionOption100 setCertificationBreakdownType(List<BeneficiaryCertificationType5Choice> certificationBreakdownType) {
	...
	public CorporateActionOption100 setNonDomicileCountry(List<CountryCode> nonDomicileCountry) {
	...
	public CorporateActionOption100 setValidDomicileCountry(List<CountryCode> validDomicileCountry) {
	...
	public CorporateActionOption100 setCurrencyOption(ActiveCurrencyCode currencyOption) {
	...
	public CorporateActionOption100 setDefaultProcessingOrStandingInstruction(DefaultProcessingOrStandingInstruction1Choice defaultProcessingOrStandingInstruction) {
	...
	public CorporateActionOption100 setChargesAppliedIndicator(YesNoIndicator chargesAppliedIndicator) {
	...
	public CorporateActionOption100 setCertificationBreakdownIndicator(YesNoIndicator certificationBreakdownIndicator) {
	...
	public CorporateActionOption100 setWithdrawalAllowedIndicator(YesNoIndicator withdrawalAllowedIndicator) {
	...
	public CorporateActionOption100 setChangeAllowedIndicator(YesNoIndicator changeAllowedIndicator) {
	...
	public CorporateActionOption100 setSecurityIdentification(SecurityIdentification14 securityIdentification) {
		this.securityIdentification = securityIdentification;
		return this;
	}

	public Optional<CorporateActionDate29> getDateDetails() {
		return dateDetails == null ? Optional.empty() : Optional.of(dateDetails);
	}

	public CorporateActionOption100 setDateDetails(CorporateActionDate29 dateDetails) {
	...
	public CorporateActionOption100 setPeriodDetails(CorporateActionPeriod7 periodDetails) {
		this.periodDetails = periodDetails;
		return this;
	}

	public Optional<CorporateActionRate45> getRateAndAmountDetails() {
		return rateAndAmountDetails == null ? Optional.empty() : Optional.of(rateAndAmountDetails);
	}

	public CorporateActionOption100 setRateAndAmountDetails(CorporateActionRate45 rateAndAmountDetails) {
	...
	public CorporateActionOption100 setPriceDetails(CorporateActionPrice28 priceDetails) {
	...
	public CorporateActionOption100 setSecuritiesQuantity(SecuritiesOption23 securitiesQuantity) {
	...
	public CorporateActionOption100 setSecuritiesMovementDetails(List<SecuritiesOption40> securitiesMovementDetails) {
	...
	public CorporateActionOption100 setCashMovementDetails(List<CashOption31> cashMovementDetails) {
	...
	public CorporateActionOption100 setAdditionalInformation(CorporateActionNarrative20 additionalInformation) {
