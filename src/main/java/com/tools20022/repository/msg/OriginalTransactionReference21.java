...
public class OriginalTransactionReference21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalTransactionReference21.mmAmount, OriginalTransactionReference21.mmRequestedExecutionDate, OriginalTransactionReference21.mmPaymentTypeInformation,
						OriginalTransactionReference21.mmPaymentMethod, OriginalTransactionReference21.mmRemittanceInformation, OriginalTransactionReference21.mmUltimateDebtor, OriginalTransactionReference21.mmDebtor,
						OriginalTransactionReference21.mmDebtorAccount, OriginalTransactionReference21.mmDebtorAgent, OriginalTransactionReference21.mmCreditorAgent, OriginalTransactionReference21.mmCreditor,
						OriginalTransactionReference21.mmCreditorAccount, OriginalTransactionReference21.mmUltimateCreditor);
