...
public class OriginalTransactionReference21 {
	...
	public static final MMMessageAssociationEnd mmAmount = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> OriginalTransactionReference21.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmRequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmRequestedExecutionDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmRequestedExecutionDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmPaymentTypeInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPaymentMethod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmPaymentMethod);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmPaymentMethod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmRemittanceInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmRemittanceInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmUltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmUltimateDebtor);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmUltimateDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmDebtor);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PartyIdentification43.mmObject();
	...
	public static final MMMessageAssociationEnd mmDebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmDebtorAccount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmDebtorAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmDebtorAgent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmDebtorAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmCreditorAgent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmCreditorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmCreditor);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmCreditor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PartyIdentification43.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmCreditorAccount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmCreditorAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccount24.mmObject();
	...
	public static final MMMessageAssociationEnd mmUltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalTransactionReference23.mmUltimateCreditor);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference19.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PartyIdentification43.mmObject();
	...
	public void setRemittanceInformation(com.tools20022.repository.msg.RemittanceInformation6 remittanceInformation) {
