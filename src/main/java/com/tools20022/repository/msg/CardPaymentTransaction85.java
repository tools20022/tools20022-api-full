...
public class CardPaymentTransaction85 {
	...
	public static final MMMessageAttribute mmTransactionCapture = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmTransactionCapture;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransactionType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAdditionalService = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmAdditionalService;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmServiceAttribute = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmMerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction86.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails46.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmAdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction72.mmAdditionalTransactionData;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CardPaymentTransaction72.mmObject();
			}
		});
	...
	public CardPaymentTransaction85 setTransactionIdentification(com.tools20022.repository.msg.TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction85 setOriginalTransaction(com.tools20022.repository.msg.CardPaymentTransaction86 originalTransaction) {
	...
	public CardPaymentTransaction85 setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails46 transactionDetails) {
