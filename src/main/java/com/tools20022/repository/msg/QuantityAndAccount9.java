...
public class QuantityAndAccount9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount9.mmSettlementQuantity, QuantityAndAccount9.mmDenominationChoice, QuantityAndAccount9.mmCertificateNumber, QuantityAndAccount9.mmCashAccount,
						QuantityAndAccount9.mmQuantityBreakdown, QuantityAndAccount9.mmSafekeepingPlace);
