 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDenominationRule#forQuantityAndAccount9
 * ConstraintDenominationRule.forQuantityAndAccount9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule#forQuantityAndAccount9
 * ConstraintSafekeepingPlaceRule.forQuantityAndAccount9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityAndAccount9
 * ConstraintCoexistenceQuantityRule.forQuantityAndAccount9}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "QuantityAndAccount9", propOrder = {"settlementQuantity", "denominationChoice", "certificateNumber", "cashAccount", "quantityBreakdown", "safekeepingPlace"})
public class QuantityAndAccount9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount9, FinancialInstrumentQuantity15Choice> mmSettlementQuantity = new MMMessageAssociationEnd<QuantityAndAccount9, FinancialInstrumentQuantity15Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount9.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
		...
		@Override
		public FinancialInstrumentQuantity15Choice getValue(QuantityAndAccount9 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, FinancialInstrumentQuantity15Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount9, Optional<RestrictedFINXMax210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount9, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(QuantityAndAccount9 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, Optional<RestrictedFINXMax210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount9, List<SecuritiesCertificate2>> mmCertificateNumber = new MMMessageAssociationEnd<QuantityAndAccount9, List<SecuritiesCertificate2>>() {
		{
		...
		@Override
		public List<SecuritiesCertificate2> getValue(QuantityAndAccount9 obj) {
			return obj.getCertificateNumber();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, List<SecuritiesCertificate2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount9, Optional<CashAccountIdentification6Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount9, Optional<CashAccountIdentification6Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification6Choice> getValue(QuantityAndAccount9 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, Optional<CashAccountIdentification6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount9, List<QuantityBreakdown7>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount9, List<QuantityBreakdown7>>() {
		{
		...
		@Override
		public List<QuantityBreakdown7> getValue(QuantityAndAccount9 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, List<QuantityBreakdown7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount9, Optional<SafekeepingPlaceFormat4Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount9, Optional<SafekeepingPlaceFormat4Choice>>() {
		{
		...
		@Override
		public Optional<SafekeepingPlaceFormat4Choice> getValue(QuantityAndAccount9 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount9 obj, Optional<SafekeepingPlaceFormat4Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount9.mmSettlementQuantity, com.tools20022.repository.msg.QuantityAndAccount9.mmDenominationChoice,
						com.tools20022.repository.msg.QuantityAndAccount9.mmCertificateNumber, com.tools20022.repository.msg.QuantityAndAccount9.mmCashAccount, com.tools20022.repository.msg.QuantityAndAccount9.mmQuantityBreakdown,
						com.tools20022.repository.msg.QuantityAndAccount9.mmSafekeepingPlace);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount9, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forQuantityAndAccount9,
						com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityAndAccount9);
	...
	public QuantityAndAccount9 setSettlementQuantity(FinancialInstrumentQuantity15Choice settlementQuantity) {
	...
	public QuantityAndAccount9 setDenominationChoice(RestrictedFINXMax210Text denominationChoice) {
	...
	public QuantityAndAccount9 setCertificateNumber(List<SecuritiesCertificate2> certificateNumber) {
	...
	public QuantityAndAccount9 setCashAccount(CashAccountIdentification6Choice cashAccount) {
	...
	public QuantityAndAccount9 setQuantityBreakdown(List<QuantityBreakdown7> quantityBreakdown) {
	...
	public QuantityAndAccount9 setSafekeepingPlace(SafekeepingPlaceFormat4Choice safekeepingPlace) {
