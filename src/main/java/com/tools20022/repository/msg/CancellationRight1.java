 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CancellationRight1#Structured
...
public class CancellationRight1 {
	...
	public static final MMMessageAttribute Structured = new MMMessageAttribute() {
		{
			...
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.SecuritiesTradeStatus.CancellationRight;
			isDerived = false;
			xmlTag = "Strd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationRight1.Structured, com.tools20022.repository.msg.CancellationRight1.AdditionalInformation);
