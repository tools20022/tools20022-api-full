...
public class SecuritiesFinancingTransactionDetails10 {
	...
	public static final MMMessageAssociationEnd mmSettlementParameters = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SettlementDetails41.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesFinancingTransactionDetails10.mmSecuritiesFinancingTradeIdentification, SecuritiesFinancingTransactionDetails10.mmClosingLegIdentification,
						SecuritiesFinancingTransactionDetails10.mmPoolIdentification, SecuritiesFinancingTransactionDetails10.mmCorporateActionEventIdentification,
						SecuritiesFinancingTransactionDetails10.mmTripartyAgentCollateralTransactionIdentification, SecuritiesFinancingTransactionDetails10.mmClientTripartyCollateralTransactionIdentification,
						SecuritiesFinancingTransactionDetails10.mmAccountOwner, SecuritiesFinancingTransactionDetails10.mmSafekeepingAccount, SecuritiesFinancingTransactionDetails10.mmSafekeepingPlace,
						SecuritiesFinancingTransactionDetails10.mmPlaceOfTrade, SecuritiesFinancingTransactionDetails10.mmFinancialInstrumentIdentification, SecuritiesFinancingTransactionDetails10.mmSettlementQuantity,
						SecuritiesFinancingTransactionDetails10.mmOpeningSettlementAmount, SecuritiesFinancingTransactionDetails10.mmTerminationTransactionAmount, SecuritiesFinancingTransactionDetails10.mmOpeningSettlementDate,
						SecuritiesFinancingTransactionDetails10.mmTerminationDate, SecuritiesFinancingTransactionDetails10.mmTradeDate, SecuritiesFinancingTransactionDetails10.mmExpectedSettlementDate,
						SecuritiesFinancingTransactionDetails10.mmExpectedValueDate, SecuritiesFinancingTransactionDetails10.mmLateDeliveryDate, SecuritiesFinancingTransactionDetails10.mmRateChangeDate,
						SecuritiesFinancingTransactionDetails10.mmSecuritiesFinancingTransactionType, SecuritiesFinancingTransactionDetails10.mmSecuritiesMovementType, SecuritiesFinancingTransactionDetails10.mmPayment,
						SecuritiesFinancingTransactionDetails10.mmSettlementParameters, SecuritiesFinancingTransactionDetails10.mmRateType, SecuritiesFinancingTransactionDetails10.mmVariableRateSupport,
						SecuritiesFinancingTransactionDetails10.mmRepurchaseRate, SecuritiesFinancingTransactionDetails10.mmStockLoanMargin, SecuritiesFinancingTransactionDetails10.mmSecuritiesHaircut,
						SecuritiesFinancingTransactionDetails10.mmPricingRate, SecuritiesFinancingTransactionDetails10.mmSpread, SecuritiesFinancingTransactionDetails10.mmDeliveringSettlementParties,
						SecuritiesFinancingTransactionDetails10.mmReceivingSettlementParties, SecuritiesFinancingTransactionDetails10.mmInvestor, SecuritiesFinancingTransactionDetails10.mmSettlementInstructionProcessingAdditionalDetails);
	...
	public SettlementDetails41 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails41 settlementParameters) {
