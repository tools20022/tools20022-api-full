...
public class StatusAndReason26 {
	...
	public static final MMMessageAssociationEnd mmStatusAndReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> StatusAndReason26.mmObject();
			isDerived = false;
			xmlTag = "StsAndRsn";
	...
	protected List<com.tools20022.repository.msg.Transaction42> transaction;
	/**
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Transaction42.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StatusAndReason26.mmStatusAndReason, StatusAndReason26.mmTransaction);
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction42> transaction) {
