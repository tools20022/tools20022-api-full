...
public class InvestmentAccount24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount24.mmOwnerIdentification, InvestmentAccount24.mmAccountIdentification, InvestmentAccount24.mmAccountName, InvestmentAccount24.mmAccountDesignation,
						InvestmentAccount24.mmIntermediaryInformation, InvestmentAccount24.mmSecuritiesForm, InvestmentAccount24.mmDematerialisedIndicator, InvestmentAccount24.mmIncomePreference,
						InvestmentAccount24.mmBeneficiaryCertificationCompletion, InvestmentAccount24.mmAccountServicer, InvestmentAccount24.mmSubAccountDetails);
