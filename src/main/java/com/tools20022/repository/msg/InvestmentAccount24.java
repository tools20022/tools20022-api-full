...
import com.tools20022.repository.msg.Intermediary10;
...
@XmlType(name = "InvestmentAccount24", propOrder = {"ownerIdentification", "accountIdentification", "accountName", "accountDesignation", "intermediaryInformation", "securitiesForm", "dematerialisedIndicator", "incomePreference",
...
public class InvestmentAccount24 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, List<PartyIdentification2Choice>> mmOwnerIdentification = new MMMessageAttribute<InvestmentAccount24, List<PartyIdentification2Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount24.mmObject();
			isDerived = false;
			xmlTag = "OwnrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OwnerIdentification";
			definition = "Party that legally owns the account.";
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmOwnerIdentification);
			minOccurs = 0;
			complexType_lazy = () -> PartyIdentification2Choice.mmObject();
		}

		@Override
		public List<PartyIdentification2Choice> getValue(InvestmentAccount24 obj) {
			return obj.getOwnerIdentification();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, List<PartyIdentification2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<AccountIdentification1>> mmAccountIdentification = new MMMessageAttribute<InvestmentAccount24, Optional<AccountIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmAccountIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountIdentification1> getValue(InvestmentAccount24 obj) {
			return obj.getAccountIdentification();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<AccountIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<Max35Text>> mmAccountName = new MMMessageAttribute<InvestmentAccount24, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmAccountName);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(InvestmentAccount24 obj) {
			return obj.getAccountName();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<Max35Text>> mmAccountDesignation = new MMMessageAttribute<InvestmentAccount24, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmAccountDesignation);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected List<Intermediary10> intermediaryInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.Intermediary10
	 * Intermediary10}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount24, List<Intermediary10>> mmIntermediaryInformation = new MMMessageAssociationEnd<InvestmentAccount24, List<Intermediary10>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmIntermediaryInformation);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Intermediary10.mmObject();
		}

		@Override
		public List<Intermediary10> getValue(InvestmentAccount24 obj) {
			return obj.getIntermediaryInformation();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, List<Intermediary10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<FormOfSecurity1Code>> mmSecuritiesForm = new MMMessageAttribute<InvestmentAccount24, Optional<FormOfSecurity1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmSecuritiesForm);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<FormOfSecurity1Code> getValue(InvestmentAccount24 obj) {
			return obj.getSecuritiesForm();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<FormOfSecurity1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<YesNoIndicator>> mmDematerialisedIndicator = new MMMessageAttribute<InvestmentAccount24, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmDematerialisedIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(InvestmentAccount24 obj) {
			return obj.getDematerialisedIndicator();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<IncomePreference1Code>> mmIncomePreference = new MMMessageAttribute<InvestmentAccount24, Optional<IncomePreference1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmIncomePreference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<IncomePreference1Code> getValue(InvestmentAccount24 obj) {
			return obj.getIncomePreference();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<IncomePreference1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<BeneficiaryCertificationCompletion1Code>> mmBeneficiaryCertificationCompletion = new MMMessageAttribute<InvestmentAccount24, Optional<BeneficiaryCertificationCompletion1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmBeneficiaryCertificationCompletion);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BeneficiaryCertificationCompletion1Code> getValue(InvestmentAccount24 obj) {
			return obj.getBeneficiaryCertificationCompletion();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<BeneficiaryCertificationCompletion1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount24, Optional<PartyIdentification2Choice>> mmAccountServicer = new MMMessageAttribute<InvestmentAccount24, Optional<PartyIdentification2Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount24.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmAccountServicer);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PartyIdentification2Choice.mmObject();
		}
		...
		@Override
		public Optional<PartyIdentification2Choice> getValue(InvestmentAccount24 obj) {
			return obj.getAccountServicer();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<PartyIdentification2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount24, Optional<SubAccount1>> mmSubAccountDetails = new MMMessageAssociationEnd<InvestmentAccount24, Optional<SubAccount1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmSubAccountDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SubAccount1> getValue(InvestmentAccount24 obj) {
			return obj.getSubAccountDetails();
		}

		@Override
		public void setValue(InvestmentAccount24 obj, Optional<SubAccount1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount24.mmOwnerIdentification, com.tools20022.repository.msg.InvestmentAccount24.mmAccountIdentification,
						com.tools20022.repository.msg.InvestmentAccount24.mmAccountName, com.tools20022.repository.msg.InvestmentAccount24.mmAccountDesignation, com.tools20022.repository.msg.InvestmentAccount24.mmIntermediaryInformation,
						com.tools20022.repository.msg.InvestmentAccount24.mmSecuritiesForm, com.tools20022.repository.msg.InvestmentAccount24.mmDematerialisedIndicator, com.tools20022.repository.msg.InvestmentAccount24.mmIncomePreference,
						com.tools20022.repository.msg.InvestmentAccount24.mmBeneficiaryCertificationCompletion, com.tools20022.repository.msg.InvestmentAccount24.mmAccountServicer,
						com.tools20022.repository.msg.InvestmentAccount24.mmSubAccountDetails);
				trace_lazy = () -> InvestmentAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAccountIdentificationRule.forInvestmentAccount24,
						com.tools20022.repository.constraints.ConstraintAccountIdentificationGuideline.forInvestmentAccount24);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestmentAccount24";
				definition = "Account between an investor(s) and a fund manager or a fund. The account can contain holdings in any investment fund or investment fund class managed (or distributed) by the fund manager, within the same fund family.";
				nextVersions_lazy = () -> Arrays.asList(InvestmentAccount41.mmObject());
			}
		});
	...
	public InvestmentAccount24 setOwnerIdentification(List<PartyIdentification2Choice> ownerIdentification) {
	...
	public InvestmentAccount24 setAccountIdentification(AccountIdentification1 accountIdentification) {
	...
	public InvestmentAccount24 setAccountName(Max35Text accountName) {
	...
	public InvestmentAccount24 setAccountDesignation(Max35Text accountDesignation) {
		this.accountDesignation = accountDesignation;
		return this;
	}

	public List<Intermediary10> getIntermediaryInformation() {
		return intermediaryInformation == null ? intermediaryInformation = new ArrayList<>() : intermediaryInformation;
	}

	public InvestmentAccount24 setIntermediaryInformation(List<Intermediary10> intermediaryInformation) {
	...
	public InvestmentAccount24 setSecuritiesForm(FormOfSecurity1Code securitiesForm) {
	...
	public InvestmentAccount24 setDematerialisedIndicator(YesNoIndicator dematerialisedIndicator) {
	...
	public InvestmentAccount24 setIncomePreference(IncomePreference1Code incomePreference) {
	...
	public InvestmentAccount24 setBeneficiaryCertificationCompletion(BeneficiaryCertificationCompletion1Code beneficiaryCertificationCompletion) {
	...
	public InvestmentAccount24 setAccountServicer(PartyIdentification2Choice accountServicer) {
	...
	public InvestmentAccount24 setSubAccountDetails(SubAccount1 subAccountDetails) {
