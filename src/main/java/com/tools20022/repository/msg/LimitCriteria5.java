...
public class LimitCriteria5 {
	...
	protected List<com.tools20022.repository.msg.LimitSearchCriteria5> searchCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmSearchCriteria = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.LimitSearchCriteria5.mmObject();
		}
	};
	...
	public LimitCriteria5 setSearchCriteria(List<com.tools20022.repository.msg.LimitSearchCriteria5> searchCriteria) {
	...
	public LimitCriteria5 setReturnCriteria(com.tools20022.repository.msg.LimitReturnCriteria2 returnCriteria) {
