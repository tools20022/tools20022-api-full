	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> UnderlyingStatementEntry1.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOriginalStatementIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> UnderlyingStatementEntry1.mmOriginalStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalEntryIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> UnderlyingStatementEntry1.mmOriginalEntryIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> UnderlyingStatementEntry1.mmObject();
			}
		});
