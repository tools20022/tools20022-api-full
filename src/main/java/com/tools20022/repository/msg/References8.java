...
public class References8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References8.mmAccountOwnerTransactionIdentification, References8.mmAccountServicerTransactionIdentification, References8.mmMarketInfrastructureTransactionIdentification,
						References8.mmProcessorTransactionIdentification, References8.mmPoolIdentification, References8.mmCommonIdentification, References8.mmTradeIdentification);
