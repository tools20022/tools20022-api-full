...
public class CorporateActionGeneralInformation41 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation41.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation41.mmCorporateActionEventIdentification, CorporateActionGeneralInformation41.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation41.mmEventType, CorporateActionGeneralInformation41.mmFinancialInstrumentIdentification);
