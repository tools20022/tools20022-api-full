...
public class CorporateActionGeneralInformation15 {
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes9.mmObject();
		}
	};
	...
	public CorporateActionGeneralInformation15 setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes9 underlyingSecurity) {
