...
public class CorporateActionGeneralInformation15 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation15.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation15.mmCorporateActionEventIdentification, CorporateActionGeneralInformation15.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation15.mmEventType, CorporateActionGeneralInformation15.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes9 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes9 underlyingSecurity) {
