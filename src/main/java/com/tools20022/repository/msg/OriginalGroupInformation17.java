...
public class OriginalGroupInformation17 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation17, Max35Text> mmOriginalMessageIdentification = new MMMessageAttribute<OriginalGroupInformation17, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(OriginalGroupInformation17 obj) {
			return obj.getOriginalMessageIdentification();
		}

		@Override
		public void setValue(OriginalGroupInformation17 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation17, Max35Text> mmNetworkFileName = new MMMessageAttribute<OriginalGroupInformation17, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation17.mmObject();
			isDerived = false;
			xmlTag = "NtwkFileNm";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation17, Max35Text> mmOriginalMessageNameIdentification = new MMMessageAttribute<OriginalGroupInformation17, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation17.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgNmId";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation17, Optional<TransactionGroupStatus2Code>> mmGroupStatus = new MMMessageAttribute<OriginalGroupInformation17, Optional<TransactionGroupStatus2Code>>() {
		{
		...
		@Override
		public Optional<TransactionGroupStatus2Code> getValue(OriginalGroupInformation17 obj) {
			return obj.getGroupStatus();
		}

		@Override
		public void setValue(OriginalGroupInformation17 obj, Optional<TransactionGroupStatus2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalGroupInformation17, Optional<StatusReasonInformation6>> mmStatusReasonInformation = new MMMessageAssociationEnd<OriginalGroupInformation17, Optional<StatusReasonInformation6>>() {
		{
		...
		@Override
		public Optional<StatusReasonInformation6> getValue(OriginalGroupInformation17 obj) {
			return obj.getStatusReasonInformation();
		}

		@Override
		public void setValue(OriginalGroupInformation17 obj, Optional<StatusReasonInformation6> value) {
	...
	public OriginalGroupInformation17 setStatusReasonInformation(StatusReasonInformation6 statusReasonInformation) {
