...
@XmlType(name = "PaymentTransaction39", propOrder = {"cancellationStatusIdentification", "resolvedCase", "originalInstructionIdentification", "originalEndToEndIdentification", "transactionCancellationStatus",
...
public class PaymentTransaction39 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>> mmCancellationStatusIdentification = new MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction39.mmObject();
			isDerived = false;
			xmlTag = "CxlStsId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmCancellationStatusIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction39 obj) {
			return obj.getCancellationStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction39, Optional<Case3>> mmResolvedCase = new MMMessageAssociationEnd<PaymentTransaction39, Optional<Case3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmResolvedCase);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Case3> getValue(PaymentTransaction39 obj) {
			return obj.getResolvedCase();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction39, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalEndToEndIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<CancellationIndividualStatus1Code>> mmTransactionCancellationStatus = new MMMessageAttribute<PaymentTransaction39, Optional<CancellationIndividualStatus1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmTransactionCancellationStatus);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CancellationIndividualStatus1Code> getValue(PaymentTransaction39 obj) {
			return obj.getTransactionCancellationStatus();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<CancellationIndividualStatus1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction39, List<CancellationStatusReason2>> mmCancellationStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction39, List<CancellationStatusReason2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmCancellationStatusReasonInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<CancellationStatusReason2> getValue(PaymentTransaction39 obj) {
			return obj.getCancellationStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, List<CancellationStatusReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInstructedAmount = new MMMessageAttribute<PaymentTransaction39, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalInstructedAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction39 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<ISODate>> mmOriginalRequestedExecutionDate = new MMMessageAttribute<PaymentTransaction39, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalRequestedExecutionDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction39 obj) {
			return obj.getOriginalRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction39, Optional<ISODate>> mmOriginalRequestedCollectionDate = new MMMessageAttribute<PaymentTransaction39, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction39.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalRequestedCollectionDate);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction39, Optional<OriginalTransactionReference16>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction39, Optional<OriginalTransactionReference16>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmOriginalTransactionReference);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference16> getValue(PaymentTransaction39 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction39 obj, Optional<OriginalTransactionReference16> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction39.mmCancellationStatusIdentification, com.tools20022.repository.msg.PaymentTransaction39.mmResolvedCase,
						com.tools20022.repository.msg.PaymentTransaction39.mmOriginalInstructionIdentification, com.tools20022.repository.msg.PaymentTransaction39.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.PaymentTransaction39.mmTransactionCancellationStatus, com.tools20022.repository.msg.PaymentTransaction39.mmCancellationStatusReasonInformation,
						com.tools20022.repository.msg.PaymentTransaction39.mmOriginalInstructedAmount, com.tools20022.repository.msg.PaymentTransaction39.mmOriginalRequestedExecutionDate,
						com.tools20022.repository.msg.PaymentTransaction39.mmOriginalRequestedCollectionDate, com.tools20022.repository.msg.PaymentTransaction39.mmOriginalTransactionReference);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction39";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction54.mmObject());
			}
		});
	...
	public PaymentTransaction39 setCancellationStatusIdentification(Max35Text cancellationStatusIdentification) {
	...
	public PaymentTransaction39 setResolvedCase(Case3 resolvedCase) {
	...
	public PaymentTransaction39 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction39 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction39 setTransactionCancellationStatus(CancellationIndividualStatus1Code transactionCancellationStatus) {
	...
	public PaymentTransaction39 setCancellationStatusReasonInformation(List<CancellationStatusReason2> cancellationStatusReasonInformation) {
	...
	public PaymentTransaction39 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public PaymentTransaction39 setOriginalRequestedExecutionDate(ISODate originalRequestedExecutionDate) {
	...
	public PaymentTransaction39 setOriginalRequestedCollectionDate(ISODate originalRequestedCollectionDate) {
	...
	public PaymentTransaction39 setOriginalTransactionReference(OriginalTransactionReference16 originalTransactionReference) {
