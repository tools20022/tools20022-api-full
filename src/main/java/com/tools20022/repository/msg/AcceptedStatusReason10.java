...
public class AcceptedStatusReason10 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcceptedStatusReason10.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatusReason10.mmReasonCode, AcceptedStatusReason10.mmAdditionalReasonInformation);
	...
	public void setReasonCode(AcceptedReason11Choice reasonCode) {
