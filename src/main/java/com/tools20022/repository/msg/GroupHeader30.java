...
public class GroupHeader30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader30.mmMessageIdentification, GroupHeader30.mmCreationDateTime, GroupHeader30.mmAuthorisation, GroupHeader30.mmBatchBooking, GroupHeader30.mmNumberOfTransactions,
						GroupHeader30.mmControlSum, GroupHeader30.mmGroupReversal, GroupHeader30.mmTotalReversedInterbankSettlementAmount, GroupHeader30.mmInterbankSettlementDate, GroupHeader30.mmSettlementInformation,
						GroupHeader30.mmInstructingAgent, GroupHeader30.mmInstructedAgent);
