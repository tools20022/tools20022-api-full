...
public class TransactionTypeAndAdditionalParameters14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters14.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters14.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters14.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters14.mmPayment, TransactionTypeAndAdditionalParameters14.mmModificationType,
						TransactionTypeAndAdditionalParameters14.mmCommonIdentification, TransactionTypeAndAdditionalParameters14.mmPoolIdentification);
