...
public class TransactionTypeAndAdditionalParameters14 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionTypeAndAdditionalParameters14.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	public RepurchaseType16Choice getModificationType() {
		return modificationType;
	}

	public void setModificationType(RepurchaseType16Choice modificationType) {
