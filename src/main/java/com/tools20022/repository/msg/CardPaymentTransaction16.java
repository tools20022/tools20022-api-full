...
public class CardPaymentTransaction16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction16.mmMerchantCategoryCode, CardPaymentTransaction16.mmTransactionIdentification, CardPaymentTransaction16.mmOriginalTransaction,
						CardPaymentTransaction16.mmTransactionSuccess, CardPaymentTransaction16.mmReversal, CardPaymentTransaction16.mmFailureReason, CardPaymentTransaction16.mmRecipientTransactionIdentification,
						CardPaymentTransaction16.mmReconciliationIdentification, CardPaymentTransaction16.mmInterchangeData, CardPaymentTransaction16.mmTransactionDetails, CardPaymentTransaction16.mmAuthorisationResult,
						CardPaymentTransaction16.mmAdditionalTransactionData);
