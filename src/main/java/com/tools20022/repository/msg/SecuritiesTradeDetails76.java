 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails76#mmReporting
 * SecuritiesTradeDetails76.mmReporting}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails76#mmSettlementInstructionProcessingAdditionalDetails
 * SecuritiesTradeDetails76.mmSettlementInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SecuritiesTradeDetails76", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "placeOfTrade", "placeOfClearing", "tradeDate", "settlementDate", "effectiveSettlementDate", "dealPrice",
...
public class SecuritiesTradeDetails76 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails76, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails76.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails76, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<PlaceOfTradeIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfClearingIdentification1> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<PlaceOfClearingIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<TradeDate8Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<TradeDate8Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate8Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<TradeDate8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<SettlementDate17Choice>> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<SettlementDate17Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDate17Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<SettlementDate17Choice> value) {
			obj.setSettlementDate(value.orElse(null));
		}
	};
	@XmlElement(name = "FctvSttlmDt", required = true)
	protected SettlementDate18Choice effectiveSettlementDate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.SettlementDate18Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails76, SettlementDate18Choice> mmEffectiveSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails76, SettlementDate18Choice>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SettlementDate18Choice.mmObject();
		}

		@Override
		public SettlementDate18Choice getValue(SecuritiesTradeDetails76 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, SettlementDate18Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<Price7>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails76, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price7> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<Price7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max3Number>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<OpeningClosing3Choice>> mmOpeningClosing = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<OpeningClosing3Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmOpeningClosing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OpeningClosing3Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getOpeningClosing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<OpeningClosing3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, List<Reporting6Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails76, List<Reporting6Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails76.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmReporting;
			minOccurs = 0;
			complexType_lazy = () -> Reporting6Choice.mmObject();
		}

		@Override
		public List<Reporting6Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, List<Reporting6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, List<TradeTransactionCondition5Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails76, List<TradeTransactionCondition5Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmTradeTransactionCondition;
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition5Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition5Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, List<TradeTransactionCondition5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<InvestorCapacity4Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<InvestorCapacity4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmInvestorCapacity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity4Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<InvestorCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<TradeOriginator3Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<TradeOriginator3Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmTradeOriginatorRole;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator3Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<TradeOriginator3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<TypeOfPrice29Choice>> mmTypeOfPrice = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<TypeOfPrice29Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfPrice29Choice> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<TypeOfPrice29Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max350Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmFXAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails76 obj) {
			return obj.getFXAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails76 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails76, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails76.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails53.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails76.mmTradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmCollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmPlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmTradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmSettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmEffectiveSettlementDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmDealPrice, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmNumberOfDaysAccrued,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmOpeningClosing, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmReporting,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmTradeTransactionCondition, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmInvestorCapacity,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmTradeOriginatorRole, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmTypeOfPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails76.mmFXAdditionalDetails, com.tools20022.repository.msg.SecuritiesTradeDetails76.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmationV08.mmTradeDetails, SecuritiesSettlementTransactionReversalAdviceV07.mmTradeDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails76,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails76, com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails76,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails76, com.tools20022.repository.constraints.ConstraintTradeDateGuideline.forSecuritiesTradeDetails76);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTradeDetails76";
				definition = "Details of the securities trade.";
				previousVersion_lazy = () -> SecuritiesTradeDetails53.mmObject();
			}
		});
	...
	public SecuritiesTradeDetails76 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails76 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails76 setPlaceOfTrade(PlaceOfTradeIdentification1 placeOfTrade) {
	...
	public SecuritiesTradeDetails76 setPlaceOfClearing(PlaceOfClearingIdentification1 placeOfClearing) {
	...
	public SecuritiesTradeDetails76 setTradeDate(TradeDate8Choice tradeDate) {
	...
	public SecuritiesTradeDetails76 setSettlementDate(SettlementDate17Choice settlementDate) {
		this.settlementDate = settlementDate;
		return this;
	}

	public SettlementDate18Choice getEffectiveSettlementDate() {
		return effectiveSettlementDate;
	}

	public SecuritiesTradeDetails76 setEffectiveSettlementDate(SettlementDate18Choice effectiveSettlementDate) {
	...
	public SecuritiesTradeDetails76 setDealPrice(Price7 dealPrice) {
	...
	public SecuritiesTradeDetails76 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails76 setOpeningClosing(OpeningClosing3Choice openingClosing) {
	...
	public SecuritiesTradeDetails76 setReporting(List<Reporting6Choice> reporting) {
	...
	public SecuritiesTradeDetails76 setTradeTransactionCondition(List<TradeTransactionCondition5Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails76 setInvestorCapacity(InvestorCapacity4Choice investorCapacity) {
	...
	public SecuritiesTradeDetails76 setTradeOriginatorRole(TradeOriginator3Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails76 setTypeOfPrice(TypeOfPrice29Choice typeOfPrice) {
	...
	public SecuritiesTradeDetails76 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
	...
	public SecuritiesTradeDetails76 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
