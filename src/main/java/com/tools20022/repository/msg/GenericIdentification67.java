...
public class GenericIdentification67 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification67.Identification, com.tools20022.repository.msg.GenericIdentification67.Issuer,
						com.tools20022.repository.msg.GenericIdentification67.SchemeName);
