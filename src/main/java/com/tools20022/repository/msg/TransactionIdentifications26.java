...
public class TransactionIdentifications26 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications26.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications26.mmAccountOwnerTransactionIdentification, TransactionIdentifications26.mmAccountServicerTransactionIdentification,
						TransactionIdentifications26.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications26.mmProcessorTransactionIdentification, TransactionIdentifications26.mmOtherIdentification);
