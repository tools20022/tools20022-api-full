...
public class SecurityIdentification21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecurityIdentification21.mmISIN, SecurityIdentification21.mmOtherIdentification, SecurityIdentification21.mmDescription);
