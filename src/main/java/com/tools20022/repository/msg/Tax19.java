...
public class Tax19 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Tax19, TaxDetailsType1Choice> mmTaxType = new MMMessageAssociationEnd<Tax19, TaxDetailsType1Choice>() {
		{
			businessComponentTrace_lazy = () -> Tax.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.Tax19.mmObject();
			isDerived = false;
			xmlTag = "TaxTp";
		...
		@Override
		public TaxDetailsType1Choice getValue(Tax19 obj) {
			return obj.getTaxType();
		}

		@Override
		public void setValue(Tax19 obj, TaxDetailsType1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Tax19, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<Tax19, ActiveCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(Tax19 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(Tax19 obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Tax19, Optional<PercentageRate>> mmRate = new MMMessageAttribute<Tax19, Optional<PercentageRate>>() {
		{
		...
		@Override
		public Optional<PercentageRate> getValue(Tax19 obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(Tax19 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Tax19, Optional<CountryCode>> mmCountry = new MMMessageAttribute<Tax19, Optional<CountryCode>>() {
		{
		...
		@Override
		public Optional<CountryCode> getValue(Tax19 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(Tax19 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Tax19, Optional<EUDividendStatusType1Choice>> mmEUDividendStatusType = new MMMessageAssociationEnd<Tax19, Optional<EUDividendStatusType1Choice>>() {
		{
		...
		@Override
		public Optional<EUDividendStatusType1Choice> getValue(Tax19 obj) {
			return obj.getEUDividendStatusType();
		}

		@Override
		public void setValue(Tax19 obj, Optional<EUDividendStatusType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Tax19, Optional<EUCapitalGainType1Choice>> mmEUCapitalGainType = new MMMessageAssociationEnd<Tax19, Optional<EUCapitalGainType1Choice>>() {
		{
		...
		@Override
		public Optional<EUCapitalGainType1Choice> getValue(Tax19 obj) {
			return obj.getEUCapitalGainType();
		}

		@Override
		public void setValue(Tax19 obj, Optional<EUCapitalGainType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Tax19, Optional<PartyIdentification2Choice>> mmRecipientIdentification = new MMMessageAttribute<Tax19, Optional<PartyIdentification2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Tax19.mmObject();
			isDerived = false;
			xmlTag = "RcptId";
		...
		@Override
		public Optional<PartyIdentification2Choice> getValue(Tax19 obj) {
			return obj.getRecipientIdentification();
		}

		@Override
		public void setValue(Tax19 obj, Optional<PartyIdentification2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Tax19, YesNoIndicator> mmExemptionIndicator = new MMMessageAttribute<Tax19, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(Tax19 obj) {
			return obj.getExemptionIndicator();
		}

		@Override
		public void setValue(Tax19 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Tax19, Optional<ExemptionReasonType1Choice>> mmExemptionReasonType = new MMMessageAssociationEnd<Tax19, Optional<ExemptionReasonType1Choice>>() {
		{
		...
		@Override
		public Optional<ExemptionReasonType1Choice> getValue(Tax19 obj) {
			return obj.getExemptionReasonType();
		}

		@Override
		public void setValue(Tax19 obj, Optional<ExemptionReasonType1Choice> value) {
	...
	public Tax19 setTaxType(TaxDetailsType1Choice taxType) {
	...
	public Tax19 setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public Tax19 setRate(PercentageRate rate) {
		this.rate = rate;
		return this;
	}
	...
	public Tax19 setCountry(CountryCode country) {
	...
	public Tax19 setEUDividendStatusType(EUDividendStatusType1Choice eUDividendStatusType) {
	...
	public Tax19 setEUCapitalGainType(EUCapitalGainType1Choice eUCapitalGainType) {
	...
	public Tax19 setRecipientIdentification(PartyIdentification2Choice recipientIdentification) {
	...
	public Tax19 setExemptionIndicator(YesNoIndicator exemptionIndicator) {
	...
	public Tax19 setExemptionReasonType(ExemptionReasonType1Choice exemptionReasonType) {
