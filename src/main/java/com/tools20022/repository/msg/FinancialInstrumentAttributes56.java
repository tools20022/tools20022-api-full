...
public class FinancialInstrumentAttributes56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes56.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes56.mmPlaceOfListing, FinancialInstrumentAttributes56.mmDayCountBasis,
						FinancialInstrumentAttributes56.mmClassificationType, FinancialInstrumentAttributes56.mmOptionStyle, FinancialInstrumentAttributes56.mmDenominationCurrency, FinancialInstrumentAttributes56.mmNextCouponDate,
						FinancialInstrumentAttributes56.mmFloatingRateFixingDate, FinancialInstrumentAttributes56.mmMaturityDate, FinancialInstrumentAttributes56.mmIssueDate, FinancialInstrumentAttributes56.mmNextCallableDate,
						FinancialInstrumentAttributes56.mmPutableDate, FinancialInstrumentAttributes56.mmDatedDate, FinancialInstrumentAttributes56.mmConversionDate, FinancialInstrumentAttributes56.mmPreviousFactor,
						FinancialInstrumentAttributes56.mmNextFactor, FinancialInstrumentAttributes56.mmInterestRate, FinancialInstrumentAttributes56.mmNextInterestRate, FinancialInstrumentAttributes56.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes56.mmMinimumExercisableQuantity, FinancialInstrumentAttributes56.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes56.mmContractSize,
						FinancialInstrumentAttributes56.mmIssuePrice);
