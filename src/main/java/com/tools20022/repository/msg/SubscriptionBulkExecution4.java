...
public class SubscriptionBulkExecution4 {
	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmMasterReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPlaceOfTrade = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOrderDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmOrderDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedFutureTradeDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmRequestedFutureTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmFinancialInstrumentDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmIndividualExecutionDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmIndividualExecutionDetails;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmRequestedSettlementCurrency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmRequestedSettlementCurrency;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedNAVCurrency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmRequestedNAVCurrency;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTotalSettlementAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmTotalSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmBulkCashSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SubscriptionBulkExecution3.mmBulkCashSettlementDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public SubscriptionBulkExecution4 setFinancialInstrumentDetails(com.tools20022.repository.msg.FinancialInstrument57 financialInstrumentDetails) {
	...
	public SubscriptionBulkExecution4 setIndividualExecutionDetails(List<com.tools20022.repository.msg.SubscriptionExecution12> individualExecutionDetails) {
	...
	public SubscriptionBulkExecution4 setBulkCashSettlementDetails(com.tools20022.repository.msg.PaymentTransaction70 bulkCashSettlementDetails) {
