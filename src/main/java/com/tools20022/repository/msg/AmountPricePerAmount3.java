...
@XmlType(name = "AmountPricePerAmount3", propOrder = {"amountPriceType", "priceValue", "amount"})
public class AmountPricePerAmount3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountPricePerAmount3, AmountPriceType1Code> mmAmountPriceType = new MMMessageAttribute<AmountPricePerAmount3, AmountPriceType1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmTypeOfAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountPricePerAmount3.mmObject();
			isDerived = false;
			xmlTag = "AmtPricTp";
		...
		@Override
		public AmountPriceType1Code getValue(AmountPricePerAmount3 obj) {
			return obj.getAmountPriceType();
		}

		@Override
		public void setValue(AmountPricePerAmount3 obj, AmountPriceType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountPricePerAmount3, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmPriceValue = new MMMessageAttribute<AmountPricePerAmount3, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(AmountPricePerAmount3 obj) {
			return obj.getPriceValue();
		}

		@Override
		public void setValue(AmountPricePerAmount3 obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountPricePerAmount3, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<AmountPricePerAmount3, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
	...
	public AmountPricePerAmount3 setAmountPriceType(AmountPriceType1Code amountPriceType) {
	...
	public AmountPricePerAmount3 setPriceValue(RestrictedFINActiveCurrencyAnd13DecimalAmount priceValue) {
	...
	public AmountPricePerAmount3 setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
