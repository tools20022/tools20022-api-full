...
public class AcceptedStatusReason2 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcceptedStatusReason2.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatusReason2.mmReasonCode, AcceptedStatusReason2.mmAdditionalReasonInformation);
	...
	public void setReasonCode(AcceptedReason2Choice reasonCode) {
