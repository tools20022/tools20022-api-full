...
public class PartyIdentificationAndAccount45 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount45.mmIdentification, PartyIdentificationAndAccount45.mmAlternateIdentification, PartyIdentificationAndAccount45.mmSafekeepingAccount,
						PartyIdentificationAndAccount45.mmProcessingDate, PartyIdentificationAndAccount45.mmProcessingIdentification, PartyIdentificationAndAccount45.mmAdditionalInformation);
