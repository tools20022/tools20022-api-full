 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification20#mmType
...
@XmlType(name = "MarketIdentification20", propOrder = {"identification", "type"})
public class MarketIdentification20 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification20, Optional<MarketIdentification1Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification20, Optional<MarketIdentification1Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification20.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification84.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification1Choice> getValue(MarketIdentification20 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification20 obj, Optional<MarketIdentification1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification20, MarketType8Choice> mmType = new MMMessageAssociationEnd<MarketIdentification20, MarketType8Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification84.mmType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public MarketType8Choice getValue(MarketIdentification20 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification20 obj, MarketType8Choice value) {
			obj.setType(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification20.mmIdentification, com.tools20022.repository.msg.MarketIdentification20.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification20);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketIdentification20";
				...
				nextVersions_lazy = () -> Arrays.asList(MarketIdentification84.mmObject());
			}
		});
	...
	public MarketIdentification20 setIdentification(MarketIdentification1Choice identification) {
	...
	public MarketIdentification20 setType(MarketType8Choice type) {
