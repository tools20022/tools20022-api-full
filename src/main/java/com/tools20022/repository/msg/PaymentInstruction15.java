...
public class PaymentInstruction15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction15.mmPaymentInformationIdentification, PaymentInstruction15.mmPaymentMethod, PaymentInstruction15.mmBatchBooking, PaymentInstruction15.mmNumberOfTransactions,
						PaymentInstruction15.mmControlSum, PaymentInstruction15.mmPaymentTypeInformation, PaymentInstruction15.mmRequestedCollectionDate, PaymentInstruction15.mmCreditor, PaymentInstruction15.mmCreditorAccount,
						PaymentInstruction15.mmCreditorAgent, PaymentInstruction15.mmCreditorAgentAccount, PaymentInstruction15.mmUltimateCreditor, PaymentInstruction15.mmChargeBearer, PaymentInstruction15.mmChargesAccount,
						PaymentInstruction15.mmChargesAccountAgent, PaymentInstruction15.mmCreditorSchemeIdentification, PaymentInstruction15.mmDirectDebitTransactionInformation);
