...
import com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV05;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChargesAccountRule#forPaymentInstruction15
 * ConstraintChargesAccountRule.forPaymentInstruction15}</li>
 * <li>
...
@XmlType(name = "PaymentInstruction15", propOrder = {"paymentInformationIdentification", "paymentMethod", "batchBooking", "numberOfTransactions", "controlSum", "paymentTypeInformation", "requestedCollectionDate", "creditor",
...
public class PaymentInstruction15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, Max35Text> mmPaymentInformationIdentification = new MMMessageAttribute<PaymentInstruction15, Max35Text>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			xmlTag = "PmtInfId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmPaymentInformationIdentification);
			previousVersion_lazy = () -> PaymentInstruction10.mmPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(PaymentInstruction15 obj) {
			return obj.getPaymentInformationIdentification();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, PaymentMethod2Code> mmPaymentMethod = new MMMessageAttribute<PaymentInstruction15, PaymentMethod2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmPaymentMethod);
			previousVersion_lazy = () -> PaymentInstruction10.mmPaymentMethod;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PaymentMethod2Code getValue(PaymentInstruction15 obj) {
			return obj.getPaymentMethod();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, PaymentMethod2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<PaymentInstruction15, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmBatchBooking);
			previousVersion_lazy = () -> PaymentInstruction10.mmBatchBooking;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(PaymentInstruction15 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, Optional<Max15NumericText>> mmNumberOfTransactions = new MMMessageAttribute<PaymentInstruction15, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			xmlTag = "NbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmNumberOfTransactions);
			previousVersion_lazy = () -> PaymentInstruction10.mmNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(PaymentInstruction15 obj) {
			return obj.getNumberOfTransactions();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, Optional<DecimalNumber>> mmControlSum = new MMMessageAttribute<PaymentInstruction15, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			xmlTag = "CtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmControlSum);
			previousVersion_lazy = () -> PaymentInstruction10.mmControlSum;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(PaymentInstruction15 obj) {
			return obj.getControlSum();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<PaymentTypeInformation24>> mmPaymentTypeInformation = new MMMessageAssociationEnd<PaymentInstruction15, Optional<PaymentTypeInformation24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmPaymentTypeInformation);
			previousVersion_lazy = () -> PaymentInstruction10.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTypeInformation24> getValue(PaymentInstruction15 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<PaymentTypeInformation24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, ISODate> mmRequestedCollectionDate = new MMMessageAttribute<PaymentInstruction15, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmRequestedCollectionDate);
			previousVersion_lazy = () -> PaymentInstruction10.mmRequestedCollectionDate;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(PaymentInstruction15 obj) {
			return obj.getRequestedCollectionDate();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, PartyIdentification43> mmCreditor = new MMMessageAssociationEnd<PaymentInstruction15, PartyIdentification43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmCreditor);
			previousVersion_lazy = () -> PaymentInstruction10.mmCreditor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PartyIdentification43 getValue(PaymentInstruction15 obj) {
			return obj.getCreditor();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, PartyIdentification43 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, CashAccount24> mmCreditorAccount = new MMMessageAssociationEnd<PaymentInstruction15, CashAccount24>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmCreditorAccount);
			previousVersion_lazy = () -> PaymentInstruction10.mmCreditorAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CashAccount24 getValue(PaymentInstruction15 obj) {
			return obj.getCreditorAccount();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, CashAccount24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, BranchAndFinancialInstitutionIdentification5> mmCreditorAgent = new MMMessageAssociationEnd<PaymentInstruction15, BranchAndFinancialInstitutionIdentification5>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmCreditorAgent);
			previousVersion_lazy = () -> PaymentInstruction10.mmCreditorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(PaymentInstruction15 obj) {
			return obj.getCreditorAgent();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<CashAccount24>> mmCreditorAgentAccount = new MMMessageAssociationEnd<PaymentInstruction15, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmCreditorAgentAccount);
			previousVersion_lazy = () -> PaymentInstruction10.mmCreditorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
		...
		@Override
		public Optional<CashAccount24> getValue(PaymentInstruction15 obj) {
			return obj.getCreditorAgentAccount();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<PartyIdentification43>> mmUltimateCreditor = new MMMessageAssociationEnd<PaymentInstruction15, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmUltimateCreditor);
			previousVersion_lazy = () -> PaymentInstruction10.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
		...
		@Override
		public Optional<PartyIdentification43> getValue(PaymentInstruction15 obj) {
			return obj.getUltimateCreditor();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction15, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentInstruction15, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmChargeBearer);
			previousVersion_lazy = () -> PaymentInstruction10.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentInstruction15 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<CashAccount24>> mmChargesAccount = new MMMessageAssociationEnd<PaymentInstruction15, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmChargesAccount);
			previousVersion_lazy = () -> PaymentInstruction10.mmChargesAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<BranchAndFinancialInstitutionIdentification5>> mmChargesAccountAgent = new MMMessageAssociationEnd<PaymentInstruction15, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmChargesAccountAgent);
			previousVersion_lazy = () -> PaymentInstruction10.mmChargesAccountAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentInstruction15 obj) {
			return obj.getChargesAccountAgent();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, Optional<PartyIdentification43>> mmCreditorSchemeIdentification = new MMMessageAssociationEnd<PaymentInstruction15, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmCreditorSchemeIdentification);
			previousVersion_lazy = () -> PaymentInstruction10.mmCreditorSchemeIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
	...
	protected List<DirectDebitTransactionInformation18> directDebitTransactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction15, List<DirectDebitTransactionInformation18>> mmDirectDebitTransactionInformation = new MMMessageAssociationEnd<PaymentInstruction15, List<DirectDebitTransactionInformation18>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction18.mmDirectDebitTransactionInformation);
			previousVersion_lazy = () -> PaymentInstruction10.mmDirectDebitTransactionInformation;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<DirectDebitTransactionInformation18> getValue(PaymentInstruction15 obj) {
			return obj.getDirectDebitTransactionInformation();
		}

		@Override
		public void setValue(PaymentInstruction15 obj, List<DirectDebitTransactionInformation18> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction15.mmPaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction15.mmPaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction15.mmBatchBooking, com.tools20022.repository.msg.PaymentInstruction15.mmNumberOfTransactions, com.tools20022.repository.msg.PaymentInstruction15.mmControlSum,
						com.tools20022.repository.msg.PaymentInstruction15.mmPaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction15.mmRequestedCollectionDate,
						com.tools20022.repository.msg.PaymentInstruction15.mmCreditor, com.tools20022.repository.msg.PaymentInstruction15.mmCreditorAccount, com.tools20022.repository.msg.PaymentInstruction15.mmCreditorAgent,
						com.tools20022.repository.msg.PaymentInstruction15.mmCreditorAgentAccount, com.tools20022.repository.msg.PaymentInstruction15.mmUltimateCreditor, com.tools20022.repository.msg.PaymentInstruction15.mmChargeBearer,
						com.tools20022.repository.msg.PaymentInstruction15.mmChargesAccount, com.tools20022.repository.msg.PaymentInstruction15.mmChargesAccountAgent,
						com.tools20022.repository.msg.PaymentInstruction15.mmCreditorSchemeIdentification, com.tools20022.repository.msg.PaymentInstruction15.mmDirectDebitTransactionInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerDirectDebitInitiationV05.mmPaymentInformation);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintChargeBearerRule.forPaymentInstruction15,
						com.tools20022.repository.constraints.ConstraintUltimateCreditorGuideline.forPaymentInstruction15, com.tools20022.repository.constraints.ConstraintChargesAccountRule.forPaymentInstruction15,
						com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule.forPaymentInstruction15, com.tools20022.repository.constraints.ConstraintCreditorSchemeIdentificationRule.forPaymentInstruction15,
						com.tools20022.repository.constraints.ConstraintUltimateCreditorRule.forPaymentInstruction15, com.tools20022.repository.constraints.ConstraintChargesAccountAgentRule.forPaymentInstruction15);
	...
	public PaymentInstruction15 setPaymentInformationIdentification(Max35Text paymentInformationIdentification) {
	...
	public PaymentInstruction15 setPaymentMethod(PaymentMethod2Code paymentMethod) {
	...
	public PaymentInstruction15 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public PaymentInstruction15 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public PaymentInstruction15 setControlSum(DecimalNumber controlSum) {
	...
	public PaymentInstruction15 setPaymentTypeInformation(PaymentTypeInformation24 paymentTypeInformation) {
	...
	public PaymentInstruction15 setRequestedCollectionDate(ISODate requestedCollectionDate) {
	...
	public PaymentInstruction15 setCreditor(PartyIdentification43 creditor) {
	...
	public PaymentInstruction15 setCreditorAccount(CashAccount24 creditorAccount) {
	...
	public PaymentInstruction15 setCreditorAgent(BranchAndFinancialInstitutionIdentification5 creditorAgent) {
	...
	public PaymentInstruction15 setCreditorAgentAccount(CashAccount24 creditorAgentAccount) {
	...
	public PaymentInstruction15 setUltimateCreditor(PartyIdentification43 ultimateCreditor) {
	...
	public PaymentInstruction15 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentInstruction15 setChargesAccount(CashAccount24 chargesAccount) {
	...
	public PaymentInstruction15 setChargesAccountAgent(BranchAndFinancialInstitutionIdentification5 chargesAccountAgent) {
	...
	public PaymentInstruction15 setCreditorSchemeIdentification(PartyIdentification43 creditorSchemeIdentification) {
		this.creditorSchemeIdentification = creditorSchemeIdentification;
		return this;
	}

	public List<DirectDebitTransactionInformation18> getDirectDebitTransactionInformation() {
	...
	public PaymentInstruction15 setDirectDebitTransactionInformation(List<DirectDebitTransactionInformation18> directDebitTransactionInformation) {
