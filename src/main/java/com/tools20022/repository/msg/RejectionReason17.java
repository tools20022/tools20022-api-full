...
@XmlType(name = "RejectionReason17", propOrder = {"code", "additionalReasonInformation"})
public class RejectionReason17 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionReason14Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionReason17, RejectionReason14Choice> mmCode = new MMMessageAssociationEnd<RejectionReason17, RejectionReason14Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionReason17.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction/request has a rejected or repair status.";
			nextVersions_lazy = () -> Arrays.asList(RejectionReason30.mmCode);
		...
		@Override
		public RejectionReason14Choice getValue(RejectionReason17 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason17 obj, RejectionReason14Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason17, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason17, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionReason30.mmAdditionalReasonInformation);
		...
		@Override
		public Optional<Max210Text> getValue(RejectionReason17 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionReason17 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason17.mmCode, com.tools20022.repository.msg.RejectionReason17.mmAdditionalReasonInformation);
	...
	public RejectionReason14Choice getCode() {
		return code;
	}

	public RejectionReason17 setCode(RejectionReason14Choice code) {
	...
	public RejectionReason17 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
