...
public class SecuritiesSettlementTransactionDetails25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails25.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails25.mmLinkages,
						SecuritiesSettlementTransactionDetails25.mmTradeDetails, SecuritiesSettlementTransactionDetails25.mmFinancialInstrumentIdentification, SecuritiesSettlementTransactionDetails25.mmFinancialInstrumentAttributes,
						SecuritiesSettlementTransactionDetails25.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionDetails25.mmSettlementParameters, SecuritiesSettlementTransactionDetails25.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails25.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails25.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails25.mmCashParties,
						SecuritiesSettlementTransactionDetails25.mmSettlementAmount, SecuritiesSettlementTransactionDetails25.mmOtherAmounts, SecuritiesSettlementTransactionDetails25.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails25.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails25.mmSupplementaryData);
