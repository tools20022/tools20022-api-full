...
public class AccountIdentification25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification25.mmSafekeepingAccount, AccountIdentification25.mmAccountOwner, AccountIdentification25.mmSafekeepingPlace,
						AccountIdentification25.mmCorporateActionEventAndBalance);
