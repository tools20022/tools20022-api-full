...
public class SettlementDetails34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails34.mmHoldIndicator, SettlementDetails34.mmSecuritiesTransactionType, SettlementDetails34.mmSettlementTransactionCondition,
						SettlementDetails34.mmPartialSettlementIndicator, SettlementDetails34.mmBeneficialOwnership, SettlementDetails34.mmCashClearingSystem, SettlementDetails34.mmMarketClientSide, SettlementDetails34.mmRegistration,
						SettlementDetails34.mmRepurchaseType, SettlementDetails34.mmSecuritiesRTGS, SettlementDetails34.mmStampDutyTaxBasis);
