 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CashBalanceAvailability2#Date
...
public class CashBalanceAvailability2 {
	...
	public static final MMMessageAssociationEnd Date = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CashBalanceAvailability2.mmObject();
			...
			name = "Date";
			definition = "Indicates when the amount of money will become available.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashAvailability1.Date);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashAvailability1.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashAvailability1.CreditDebitIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalanceAvailability2.Date, com.tools20022.repository.msg.CashBalanceAvailability2.Amount,
						com.tools20022.repository.msg.CashBalanceAvailability2.CreditDebitIndicator);
