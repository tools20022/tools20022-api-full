...
public class SecuritiesAccount15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesAccount15.mmIdentification, SecuritiesAccount15.mmType, SecuritiesAccount15.mmName, SecuritiesAccount15.mmDesignation);
