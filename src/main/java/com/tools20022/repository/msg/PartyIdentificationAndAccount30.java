...
public class PartyIdentificationAndAccount30 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount30.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount30.mmIdentification, PartyIdentificationAndAccount30.mmAlternateIdentification, PartyIdentificationAndAccount30.mmSafekeepingAccount,
						PartyIdentificationAndAccount30.mmProcessingIdentification, PartyIdentificationAndAccount30.mmAdditionalInformation);
