...
public class GenericIdentification84 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> GenericIdentification84.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification84.Identification, com.tools20022.repository.msg.GenericIdentification84.Issuer,
						com.tools20022.repository.msg.GenericIdentification84.SchemeName);
