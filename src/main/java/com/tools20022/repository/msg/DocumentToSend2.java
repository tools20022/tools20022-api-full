...
public class DocumentToSend2 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DocumentToSend1#Type
	...
	public static final MMMessageAttribute Type = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DocumentToSend1.Type;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentToSend3.Type);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DocumentToSend1#Recipient
	...
	public static final MMMessageAttribute Recipient = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DocumentToSend1.Recipient;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentToSend3.Recipient);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MethodOfTransmission = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentToSend3.MethodOfTransmission);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentToSend2.Type, com.tools20022.repository.msg.DocumentToSend2.Recipient, com.tools20022.repository.msg.DocumentToSend2.MethodOfTransmission);
				messageBuildingBlock_lazy = () -> Arrays
						.asList(com.tools20022.repository.area.acmt.AccountOpeningInstructionV05.ServiceLevelAgreement, com.tools20022.repository.area.acmt.AccountDetailsConfirmationV05.ServiceLevelAgreement);
