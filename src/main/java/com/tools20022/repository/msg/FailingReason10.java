...
public class FailingReason10 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FailingReason10.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingReason10.mmCode, FailingReason10.mmAdditionalReasonInformation);
	...
	public void setCode(FailingReason11Choice code) {
		this.code = code;
	}
