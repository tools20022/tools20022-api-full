...
public class QuantityAndAccount60 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount60.mmSettlementQuantity, QuantityAndAccount60.mmDenominationChoice, QuantityAndAccount60.mmAccountOwner, QuantityAndAccount60.mmSafekeepingAccount,
						QuantityAndAccount60.mmCashAccount, QuantityAndAccount60.mmSafekeepingPlace, QuantityAndAccount60.mmQuantityBreakdown);
