...
import com.tools20022.repository.codeset.AssetClassSubProductType22Code;
...
@XmlType(name = "AgriculturalCommodityLiveStock1", propOrder = {"baseProduct", "subProduct"})
public class AgriculturalCommodityLiveStock1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgriculturalCommodityLiveStock1, AssetClassProductType1Code> mmBaseProduct = new MMMessageAttribute<AgriculturalCommodityLiveStock1, AssetClassProductType1Code>() {
		{
			businessElementTrace_lazy = () -> Commodity.mmBaseProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.AgriculturalCommodityLiveStock1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
		...
		@Override
		public AssetClassProductType1Code getValue(AgriculturalCommodityLiveStock1 obj) {
			return obj.getBaseProduct();
		}

		@Override
		public void setValue(AgriculturalCommodityLiveStock1 obj, AssetClassProductType1Code value) {
			obj.setBaseProduct(value);
		}
	};
	@XmlElement(name = "SubPdct", required = true)
	protected AssetClassSubProductType22Code subProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgriculturalCommodityLiveStock1, AssetClassSubProductType22Code> mmSubProduct = new MMMessageAttribute<AgriculturalCommodityLiveStock1, AssetClassSubProductType22Code>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> AssetClassSubProductType22Code.mmObject();
		}

		@Override
		public AssetClassSubProductType22Code getValue(AgriculturalCommodityLiveStock1 obj) {
			return obj.getSubProduct();
		}

		@Override
		public void setValue(AgriculturalCommodityLiveStock1 obj, AssetClassSubProductType22Code value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AgriculturalCommodityLiveStock1.mmBaseProduct, com.tools20022.repository.msg.AgriculturalCommodityLiveStock1.mmSubProduct);
				trace_lazy = () -> Commodity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AgriculturalCommodityLiveStock1";
				definition = "Defines commodity sub-product attributes of an agricultural derivative of type livestock.";
			}
		});
	...
	public AgriculturalCommodityLiveStock1 setBaseProduct(AssetClassProductType1Code baseProduct) {
		this.baseProduct = Objects.requireNonNull(baseProduct);
		return this;
	}

	public AssetClassSubProductType22Code getSubProduct() {
		return subProduct;
	}

	public AgriculturalCommodityLiveStock1 setSubProduct(AssetClassSubProductType22Code subProduct) {
