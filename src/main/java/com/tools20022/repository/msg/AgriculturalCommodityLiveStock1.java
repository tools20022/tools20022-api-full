...
public class AgriculturalCommodityLiveStock1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AgriculturalCommodityLiveStock1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AgriculturalCommodityLiveStock1.mmBaseProduct, AgriculturalCommodityLiveStock1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType22Code subProduct) {
