...
public class PartyIdentificationAndAccount60 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount60.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount60.mmIdentification, PartyIdentificationAndAccount60.mmAlternateIdentification, PartyIdentificationAndAccount60.mmCashAccount,
						PartyIdentificationAndAccount60.mmChargesAccount, PartyIdentificationAndAccount60.mmCommissionAccount, PartyIdentificationAndAccount60.mmTaxAccount, PartyIdentificationAndAccount60.mmAdditionalInformation);
	...
	public void setIdentification(PartyIdentification61Choice identification) {
