...
public class PartyIdentificationAndAccount72 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount72.mmIdentification, PartyIdentificationAndAccount72.mmAlternateIdentification, PartyIdentificationAndAccount72.mmCashAccount,
						PartyIdentificationAndAccount72.mmChargesAccount, PartyIdentificationAndAccount72.mmCommissionAccount, PartyIdentificationAndAccount72.mmTaxAccount, PartyIdentificationAndAccount72.mmAdditionalInformation);
