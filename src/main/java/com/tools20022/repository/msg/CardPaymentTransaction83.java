...
public class CardPaymentTransaction83 {
	...
	public static final MMMessageAttribute mmMerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCustomerConsent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmCustomerConsent;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCardProgrammeProposed = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmCardProgrammeProposed;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCardProgrammeApplied = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmCardProgrammeApplied;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTransactionSuccess = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmTransactionSuccess;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmReversal = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmReversal;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmFailureReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmFailureReason;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmInitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmRecipientTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmInterchangeData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAuthorisationResult = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmAuthorisationResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction75.mmAdditionalTransactionData;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CardPaymentTransaction75.mmObject();
			}
		});
	...
	public CardPaymentTransaction83 setTransactionIdentification(com.tools20022.repository.msg.TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction83 setOriginalTransaction(com.tools20022.repository.msg.CardPaymentTransaction79 originalTransaction) {
	...
	public CardPaymentTransaction83 setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails34 transactionDetails) {
	...
	public CardPaymentTransaction83 setAuthorisationResult(com.tools20022.repository.msg.AuthorisationResult12 authorisationResult) {
