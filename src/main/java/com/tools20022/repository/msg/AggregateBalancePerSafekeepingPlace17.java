...
public class AggregateBalancePerSafekeepingPlace17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace17.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace17.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace17.mmAggregateBalance,
						AggregateBalancePerSafekeepingPlace17.mmAvailableBalance, AggregateBalancePerSafekeepingPlace17.mmNotAvailableBalance, AggregateBalancePerSafekeepingPlace17.mmPriceDetails,
						AggregateBalancePerSafekeepingPlace17.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace17.mmDaysAccrued, AggregateBalancePerSafekeepingPlace17.mmAccountBaseCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace17.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace17.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace17.mmBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace17.mmAdditionalBalanceBreakdown, AggregateBalancePerSafekeepingPlace17.mmHoldingAdditionalDetails);
