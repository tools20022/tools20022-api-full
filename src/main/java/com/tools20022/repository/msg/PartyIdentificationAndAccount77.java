...
public class PartyIdentificationAndAccount77 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount77.mmIdentification, PartyIdentificationAndAccount77.mmAlternateIdentification, PartyIdentificationAndAccount77.mmSafekeepingAccount,
						PartyIdentificationAndAccount77.mmProcessingIdentification, PartyIdentificationAndAccount77.mmAdditionalInformation);
