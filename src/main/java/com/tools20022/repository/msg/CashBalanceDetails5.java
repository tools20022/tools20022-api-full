...
public class CashBalanceDetails5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashBalanceDetails5.mmAmount, CashBalanceDetails5.mmCreditDebitIndicator, CashBalanceDetails5.mmType, CashBalanceDetails5.mmStatus, CashBalanceDetails5.mmValueDate,
						CashBalanceDetails5.mmNumberOfPayments);
	...
	public BalanceType7Code getType() {
		return type;
	}

	public void setType(BalanceType7Code type) {
		this.type = type;
	}
