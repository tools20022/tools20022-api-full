...
public class SecuritiesSettlementTransactionDetails18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails18.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails18.mmLinkages,
						SecuritiesSettlementTransactionDetails18.mmTradeDetails, SecuritiesSettlementTransactionDetails18.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails18.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails18.mmSettlementParameters, SecuritiesSettlementTransactionDetails18.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails18.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails18.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails18.mmCashParties,
						SecuritiesSettlementTransactionDetails18.mmSettlementAmount, SecuritiesSettlementTransactionDetails18.mmOtherAmounts, SecuritiesSettlementTransactionDetails18.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails18.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails18.mmSupplementaryData);
