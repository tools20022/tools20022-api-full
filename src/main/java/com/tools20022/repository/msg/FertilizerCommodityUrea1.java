...
public class FertilizerCommodityUrea1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FertilizerCommodityUrea1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FertilizerCommodityUrea1.mmBaseProduct, FertilizerCommodityUrea1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType43Code subProduct) {
