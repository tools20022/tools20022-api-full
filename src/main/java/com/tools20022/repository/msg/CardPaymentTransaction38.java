...
import com.tools20022.repository.msg.CardPaymentTransactionDetails20;
...
@XmlType(name = "CardPaymentTransaction38", propOrder = {"saleReferenceIdentification", "transactionIdentification", "recipientTransactionIdentification", "reconciliationIdentification", "interchangeData", "transactionDetails"})
public class CardPaymentTransaction38 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction23#mmSaleReferenceIdentification
	 * CardPaymentTransaction23.mmSaleReferenceIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction38.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SaleReferenceIdentification";
			definition = "Global reference of the sale transaction for the sale system.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction38 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction38 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction38, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction38, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction38 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction38 obj, TransactionIdentifier1 value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction23#mmRecipientTransactionIdentification
	 * CardPaymentTransaction23.mmRecipientTransactionIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction38.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction38, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction38, Optional<Max140Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction38, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(CardPaymentTransaction38 obj) {
			return obj.getInterchangeData();
		}

		@Override
		public void setValue(CardPaymentTransaction38 obj, Optional<Max140Text> value) {
			obj.setInterchangeData(value.orElse(null));
		}
	};
	@XmlElement(name = "TxDtls", required = true)
	protected CardPaymentTransactionDetails20 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction38, CardPaymentTransactionDetails20> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction38, CardPaymentTransactionDetails20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction23.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransactionDetails20 getValue(CardPaymentTransaction38 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction38 obj, CardPaymentTransactionDetails20 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction38.mmSaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction38.mmTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction38.mmRecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction38.mmReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction38.mmInterchangeData, com.tools20022.repository.msg.CardPaymentTransaction38.mmTransactionDetails);
	...
	public CardPaymentTransaction38 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction38 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction38 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction38 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction38 setInterchangeData(Max140Text interchangeData) {
		this.interchangeData = interchangeData;
		return this;
	}

	public CardPaymentTransactionDetails20 getTransactionDetails() {
		return transactionDetails;
	}

	public CardPaymentTransaction38 setTransactionDetails(CardPaymentTransactionDetails20 transactionDetails) {
