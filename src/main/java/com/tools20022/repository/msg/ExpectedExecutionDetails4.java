...
public class ExpectedExecutionDetails4 {
	...
	public static final MMMessageAttribute ExpectedTradeDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExpectedExecutionDetails2.ExpectedTradeDateTime;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ExpectedCashSettlementDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExpectedExecutionDetails2.ExpectedCashSettlementDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExpectedExecutionDetails4.ExpectedTradeDateTime, com.tools20022.repository.msg.ExpectedExecutionDetails4.ExpectedCashSettlementDate);
