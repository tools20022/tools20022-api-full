	...
	public static final MMMessageAttribute mmExpectedTradeDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExpectedExecutionDetails2.mmExpectedTradeDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmExpectedCashSettlementDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExpectedExecutionDetails2.mmExpectedCashSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
