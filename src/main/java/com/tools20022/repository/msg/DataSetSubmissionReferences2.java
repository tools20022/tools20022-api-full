...
public class DataSetSubmissionReferences2 {
	...
	public static final MMMessageAttribute mmTransactionIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DataSetSubmissionReferences2.mmObject();
			isDerived = false;
			xmlTag = "TxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DataSetSubmissionReferences2.mmTransactionIdentification, DataSetSubmissionReferences2.mmSubmitterTransactionReference);
