...
public class CorporateActionRate59 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate59.mmProposedRate, CorporateActionRate59.mmOversubscriptionRate, CorporateActionRate59.mmRequestedTaxationRate,
						CorporateActionRate59.mmRequestedWithholdingOfForeignTax, CorporateActionRate59.mmRequestedWithholdingOfLocalTax);
