...
@XmlType(name = "NotificationIdentification4", propOrder = {"identification", "creationDateTime"})
public class NotificationIdentification4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.NotificationIdentification4.mmIdentification, com.tools20022.repository.msg.NotificationIdentification4.mmCreationDateTime);
				trace_lazy = () -> CorporateActionNotification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NotificationIdentification4";
	...
	public NotificationIdentification4 setIdentification(RestrictedFINXMax16Text identification) {
	...
	public NotificationIdentification4 setCreationDateTime(DateAndDateTimeChoice creationDateTime) {
