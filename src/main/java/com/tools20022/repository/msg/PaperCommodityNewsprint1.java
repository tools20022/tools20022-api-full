...
public class PaperCommodityNewsprint1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PaperCommodityNewsprint1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaperCommodityNewsprint1.mmBaseProduct, PaperCommodityNewsprint1.mmSubProduct);
	...
	public AssetClassSubProductType36Code getSubProduct() {
		return subProduct;
	}

	public void setSubProduct(AssetClassSubProductType36Code subProduct) {
