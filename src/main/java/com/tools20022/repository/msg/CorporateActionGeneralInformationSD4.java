...
public class CorporateActionGeneralInformationSD4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformationSD4.mmPlaceAndName, CorporateActionGeneralInformationSD4.mmEventType, CorporateActionGeneralInformationSD4.mmSubEventType);
