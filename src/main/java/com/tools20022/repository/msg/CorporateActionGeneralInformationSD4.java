...
public class CorporateActionGeneralInformationSD4 {
	...
	public static final MMMessageAttribute PlaceAndName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD15.PlaceAndName);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD15.EventType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SubEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD15.SubEventType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.PlaceAndName, com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.EventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.SubEventType);
