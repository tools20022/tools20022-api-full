...
public class RejectionOrRepairReason6 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason6.mmCode, RejectionOrRepairReason6.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason6Choice code) {
		this.code = code;
	}
