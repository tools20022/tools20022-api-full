 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.TradeAgreement2#mmTradeDate
 * TradeAgreement2.mmTradeDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TradeAgreement2#mmNotificationIdentification
 * TradeAgreement2.mmNotificationIdentification}</li>
 * <li>
...
@XmlType(name = "TradeAgreement2", propOrder = {"tradeDate", "notificationIdentification", "commonReference", "amendOrCancelReason", "relatedReference"})
public class TradeAgreement2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TradeAgreement2
	 * TradeAgreement2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement2, ISODate> mmTradeDate = new MMMessageAttribute<TradeAgreement2, ISODate>() {
		{
			businessElementTrace_lazy = () -> Trade.mmTradeDateTime;
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement2.mmObject();
			isDerived = false;
			xmlTag = "TradDt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeDate";
			definition = "Date at which the trading parties have agreed to amend or cancel a treasury trade.";
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(TradeAgreement2 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TradeAgreement2 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement2, Max35Text> mmNotificationIdentification = new MMMessageAttribute<TradeAgreement2, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TradeAgreement2.mmObject();
			isDerived = false;
			xmlTag = "NtfctnId";
		...
		@Override
		public Max35Text getValue(TradeAgreement2 obj) {
			return obj.getNotificationIdentification();
		}

		@Override
		public void setValue(TradeAgreement2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement2, Optional<Max35Text>> mmCommonReference = new MMMessageAttribute<TradeAgreement2, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(TradeAgreement2 obj) {
			return obj.getCommonReference();
		}

		@Override
		public void setValue(TradeAgreement2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement2, Optional<Max35Text>> mmAmendOrCancelReason = new MMMessageAttribute<TradeAgreement2, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeAgreement2, Max35Text> mmRelatedReference = new MMMessageAttribute<TradeAgreement2, Max35Text>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TradeAgreement2.mmTradeDate, com.tools20022.repository.msg.TradeAgreement2.mmNotificationIdentification,
						com.tools20022.repository.msg.TradeAgreement2.mmCommonReference, com.tools20022.repository.msg.TradeAgreement2.mmAmendOrCancelReason, com.tools20022.repository.msg.TradeAgreement2.mmRelatedReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(AmendNonDeliverableForwardOpeningV02.mmTradeInformation, CancelNonDeliverableForwardOpeningV02.mmTradeInformation, AmendNonDeliverableForwardValuationV02.mmTradeInformation,
						CancelNonDeliverableForwardValuationV02.mmTradeInformation, AmendForeignExchangeOptionV02.mmTradeInformation, CancelForeignExchangeOptionV02.mmTradeInformation);
				trace_lazy = () -> TreasuryTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeAgreement2";
	...
	public TradeAgreement2 setTradeDate(ISODate tradeDate) {
	...
	public TradeAgreement2 setNotificationIdentification(Max35Text notificationIdentification) {
	...
	public TradeAgreement2 setCommonReference(Max35Text commonReference) {
	...
	public TradeAgreement2 setAmendOrCancelReason(Max35Text amendOrCancelReason) {
	...
	public TradeAgreement2 setRelatedReference(Max35Text relatedReference) {
