...
public class QuantityAndAccount21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount21.mmSettlementQuantity, QuantityAndAccount21.mmAccountOwner, QuantityAndAccount21.mmSafekeepingAccount, QuantityAndAccount21.mmCashAccount,
						QuantityAndAccount21.mmSafekeepingPlace);
