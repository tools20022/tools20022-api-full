...
public class CorporateActionEventAndBalance4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventAndBalance4.mmGeneralInformation, CorporateActionEventAndBalance4.mmUnderlyingSecurity, CorporateActionEventAndBalance4.mmBalance,
						CorporateActionEventAndBalance4.mmSupplementaryData);
