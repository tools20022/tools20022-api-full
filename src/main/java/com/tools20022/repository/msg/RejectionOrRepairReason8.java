...
public class RejectionOrRepairReason8 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason8.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason8.mmCode, RejectionOrRepairReason8.mmAdditionalReasonInformation);
	...
	public void setCode(List<RejectionAndRepairReason8Choice> code) {
		this.code = code;
	}
