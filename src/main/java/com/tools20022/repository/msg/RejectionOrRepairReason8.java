...
public class RejectionOrRepairReason8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason8.Code, com.tools20022.repository.msg.RejectionOrRepairReason8.AdditionalReasonInformation);
