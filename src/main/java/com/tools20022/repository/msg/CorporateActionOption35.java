...
public class CorporateActionOption35 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption35.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV03.mmCorporateActionMovementDetails);
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption24> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption16> cashMovementDetails) {
