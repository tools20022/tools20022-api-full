...
public class QuantityAndAccount5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount5.mmSettlementQuantity, QuantityAndAccount5.mmDenominationChoice, QuantityAndAccount5.mmAccountOwner, QuantityAndAccount5.mmSafekeepingAccount,
						QuantityAndAccount5.mmCashAccount, QuantityAndAccount5.mmSafekeepingPlace, QuantityAndAccount5.mmQuantityBreakdown);
