	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmMasterReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmMasterReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransferIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmTransferIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmTransferIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmTransferConfirmationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmTransferConfirmationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmTransferConfirmationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmRequestedTransferDate = new MMMessageAttribute() {
		{
			...
			definition = "Requested date at which the assets should be transferred.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmRequestedTransferDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmRequestedTransferDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPortfolio = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmPortfolio);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmPortfolio;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmResidualCash = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmResidualCash);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmResidualCash;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAllOtherCash = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmAllOtherCash);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmAllOtherCash;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd() {
		{
			...
			definition = "Specifies the underlying assets for the ISA or portfolio.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer22.mmFinancialInstrumentAssetForTransfer);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer16.mmFinancialInstrumentAssetForTransfer;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferInstructionV06.mmProductTransfer);
