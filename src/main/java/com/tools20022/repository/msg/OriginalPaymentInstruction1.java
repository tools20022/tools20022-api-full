...
public class OriginalPaymentInstruction1 {
	...
	protected List<com.tools20022.repository.msg.PaymentTransaction32> transactionInformationAndStatus;
	/**
	...
	public static final MMMessageAssociationEnd mmTransactionInformationAndStatus = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentTransaction32.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction1.mmOriginalPaymentInformationIdentification, OriginalPaymentInstruction1.mmOriginalNumberOfTransactions, OriginalPaymentInstruction1.mmOriginalControlSum,
						OriginalPaymentInstruction1.mmPaymentInformationStatus, OriginalPaymentInstruction1.mmStatusReasonInformation, OriginalPaymentInstruction1.mmNumberOfTransactionsPerStatus,
						OriginalPaymentInstruction1.mmTransactionInformationAndStatus);
	...
	public void setTransactionInformationAndStatus(List<com.tools20022.repository.msg.PaymentTransaction32> transactionInformationAndStatus) {
