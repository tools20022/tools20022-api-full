...
public class GenericIdentification40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification40.Identification, com.tools20022.repository.msg.GenericIdentification40.Issuer,
						com.tools20022.repository.msg.GenericIdentification40.SchemeName);
