...
public class CashOption13 {
	...
	public static final MMMessageAssociationEnd mmAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionAmounts12.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmRateAndAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.RateDetails4.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PriceDetails4.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption13.mmCreditDebitIndicator, CashOption13.mmContractualPaymentIndicator, CashOption13.mmIncomeType, CashOption13.mmAccount, CashOption13.mmCashParties,
						CashOption13.mmAmountDetails, CashOption13.mmDateDetails, CashOption13.mmForeignExchangeDetails, CashOption13.mmTaxVoucherDetails, CashOption13.mmRateAndAmountDetails, CashOption13.mmPriceDetails);
	...
	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts12 amountDetails) {
	...
	public RateDetails4 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.RateDetails4 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
	}

	public PriceDetails4 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.PriceDetails4 priceDetails) {
