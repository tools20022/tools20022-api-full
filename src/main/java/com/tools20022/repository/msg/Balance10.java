 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Balance10#ShortLongIndicator
...
public class Balance10 {
	...
	public static final MMMessageAttribute ShortLongIndicator = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Balance10.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Balance10.ShortLongIndicator, com.tools20022.repository.msg.Balance10.Quantity);
