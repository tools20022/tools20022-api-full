...
public class PaymentTransaction54 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>> mmCancellationStatusIdentification = new MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction54.mmObject();
			isDerived = false;
			xmlTag = "CxlStsId";
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction54 obj) {
			return obj.getCancellationStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction54, Optional<Case3>> mmResolvedCase = new MMMessageAssociationEnd<PaymentTransaction54, Optional<Case3>>() {
		{
		...
		@Override
		public Optional<Case3> getValue(PaymentTransaction54 obj) {
			return obj.getResolvedCase();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction54, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<CancellationIndividualStatus1Code>> mmTransactionCancellationStatus = new MMMessageAttribute<PaymentTransaction54, Optional<CancellationIndividualStatus1Code>>() {
		{
		...
		@Override
		public Optional<CancellationIndividualStatus1Code> getValue(PaymentTransaction54 obj) {
			return obj.getTransactionCancellationStatus();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<CancellationIndividualStatus1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction54, List<CancellationStatusReason2>> mmCancellationStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction54, List<CancellationStatusReason2>>() {
		{
		...
		@Override
		public List<CancellationStatusReason2> getValue(PaymentTransaction54 obj) {
			return obj.getCancellationStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, List<CancellationStatusReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInstructedAmount = new MMMessageAttribute<PaymentTransaction54, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction54 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<ISODate>> mmOriginalRequestedExecutionDate = new MMMessageAttribute<PaymentTransaction54, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction54 obj) {
			return obj.getOriginalRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction54, Optional<ISODate>> mmOriginalRequestedCollectionDate = new MMMessageAttribute<PaymentTransaction54, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction54.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction54, Optional<OriginalTransactionReference20>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction54, Optional<OriginalTransactionReference20>>() {
		{
		...
		@Override
		public Optional<OriginalTransactionReference20> getValue(PaymentTransaction54 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction54 obj, Optional<OriginalTransactionReference20> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction54.mmCancellationStatusIdentification, com.tools20022.repository.msg.PaymentTransaction54.mmResolvedCase,
						com.tools20022.repository.msg.PaymentTransaction54.mmOriginalInstructionIdentification, com.tools20022.repository.msg.PaymentTransaction54.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.PaymentTransaction54.mmTransactionCancellationStatus, com.tools20022.repository.msg.PaymentTransaction54.mmCancellationStatusReasonInformation,
						com.tools20022.repository.msg.PaymentTransaction54.mmOriginalInstructedAmount, com.tools20022.repository.msg.PaymentTransaction54.mmOriginalRequestedExecutionDate,
						com.tools20022.repository.msg.PaymentTransaction54.mmOriginalRequestedCollectionDate, com.tools20022.repository.msg.PaymentTransaction54.mmOriginalTransactionReference);
	...
	public PaymentTransaction54 setCancellationStatusIdentification(Max35Text cancellationStatusIdentification) {
	...
	public PaymentTransaction54 setResolvedCase(Case3 resolvedCase) {
	...
	public PaymentTransaction54 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction54 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction54 setTransactionCancellationStatus(CancellationIndividualStatus1Code transactionCancellationStatus) {
	...
	public PaymentTransaction54 setCancellationStatusReasonInformation(List<CancellationStatusReason2> cancellationStatusReasonInformation) {
	...
	public PaymentTransaction54 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public PaymentTransaction54 setOriginalRequestedExecutionDate(ISODate originalRequestedExecutionDate) {
	...
	public PaymentTransaction54 setOriginalRequestedCollectionDate(ISODate originalRequestedCollectionDate) {
	...
	public PaymentTransaction54 setOriginalTransactionReference(OriginalTransactionReference20 originalTransactionReference) {
