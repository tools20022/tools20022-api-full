...
public class IntraPositionDetails38 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails38.mmPoolIdentification, IntraPositionDetails38.mmAccountOwner, IntraPositionDetails38.mmSafekeepingAccount,
						IntraPositionDetails38.mmFinancialInstrumentIdentification, IntraPositionDetails38.mmSettlementQuantity, IntraPositionDetails38.mmLotNumber, IntraPositionDetails38.mmSettlementDate,
						IntraPositionDetails38.mmBalanceFrom, IntraPositionDetails38.mmBalanceTo);
