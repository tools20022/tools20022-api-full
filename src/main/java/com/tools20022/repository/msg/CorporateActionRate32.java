...
public class CorporateActionRate32 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate32.mmInterest, CorporateActionRate32.mmPercentageSought, CorporateActionRate32.mmRelatedIndex, CorporateActionRate32.mmSpread,
						CorporateActionRate32.mmBidInterval, CorporateActionRate32.mmPreviousFactor, CorporateActionRate32.mmNextFactor, CorporateActionRate32.mmReinvestmentDiscountRateToMarket, CorporateActionRate32.mmInterestShortfall,
						CorporateActionRate32.mmRealisedLoss);
