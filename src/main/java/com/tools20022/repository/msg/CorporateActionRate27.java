...
public class CorporateActionRate27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate27.mmInterest, CorporateActionRate27.mmPercentageSought, CorporateActionRate27.mmRelatedIndex, CorporateActionRate27.mmSpread,
						CorporateActionRate27.mmBidInterval, CorporateActionRate27.mmPreviousFactor, CorporateActionRate27.mmNextFactor, CorporateActionRate27.mmReinvestmentDiscountRateToMarket, CorporateActionRate27.mmInterestShortfall,
						CorporateActionRate27.mmRealisedLoss);
