 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.EnergyCommodityNaturalGas1#mmAdditionalSubProduct
 * EnergyCommodityNaturalGas1.mmAdditionalSubProduct}</li>
 * </ul>
 * </li>
...
@XmlType(name = "EnergyCommodityNaturalGas1", propOrder = {"baseProduct", "subProduct", "additionalSubProduct"})
public class EnergyCommodityNaturalGas1 {
	...
	protected AssetClassSubProductType7Code subProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	protected AssetClassDetailedSubProductType6Code additionalSubProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EnergyCommodityNaturalGas1.mmBaseProduct, com.tools20022.repository.msg.EnergyCommodityNaturalGas1.mmSubProduct,
						com.tools20022.repository.msg.EnergyCommodityNaturalGas1.mmAdditionalSubProduct);
	...
	public EnergyCommodityNaturalGas1 setBaseProduct(AssetClassProductType2Code baseProduct) {
		this.baseProduct = Objects.requireNonNull(baseProduct);
		return this;
	}

	public AssetClassSubProductType7Code getSubProduct() {
		return subProduct;
	}

	public EnergyCommodityNaturalGas1 setSubProduct(AssetClassSubProductType7Code subProduct) {
		this.subProduct = Objects.requireNonNull(subProduct);
		return this;
	}

	public Optional<AssetClassDetailedSubProductType6Code> getAdditionalSubProduct() {
		return additionalSubProduct == null ? Optional.empty() : Optional.of(additionalSubProduct);
	}

	public EnergyCommodityNaturalGas1 setAdditionalSubProduct(AssetClassDetailedSubProductType6Code additionalSubProduct) {
