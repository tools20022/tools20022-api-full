...
public class EnergyCommodityNaturalGas1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EnergyCommodityNaturalGas1.mmBaseProduct, EnergyCommodityNaturalGas1.mmSubProduct, EnergyCommodityNaturalGas1.mmAdditionalSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType7Code subProduct) {
		this.subProduct = subProduct;
	}

	@XmlElement(name = "AddtlSubPdct")
	public AssetClassDetailedSubProductType6Code getAdditionalSubProduct() {
		return additionalSubProduct;
	}

	public void setAdditionalSubProduct(AssetClassDetailedSubProductType6Code additionalSubProduct) {
