...
public class CorporateActionPrice39 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice39, Optional<PriceFormat5Choice>> mmCashInLieuOfSharePrice = new MMMessageAttribute<CorporateActionPrice39, Optional<PriceFormat5Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmCashInLieuOfSharePrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice45.mmCashInLieuOfSharePrice);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PriceFormat5Choice> getValue(CorporateActionPrice39 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice39 obj, Optional<PriceFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice39, Optional<IndicativeOrMarketPrice2Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice39, Optional<IndicativeOrMarketPrice2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice45.mmIndicativeOrMarketPrice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<IndicativeOrMarketPrice2Choice> getValue(CorporateActionPrice39 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice39 obj, Optional<IndicativeOrMarketPrice2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice39, Optional<AmountPrice2>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice39, Optional<AmountPrice2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice45.mmCashValueForTax);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AmountPrice2> getValue(CorporateActionPrice39 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice39 obj, Optional<AmountPrice2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice39, Optional<PriceFormat6Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice39, Optional<PriceFormat6Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice45.mmGenericCashPricePaidPerProduct);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat6Choice> getValue(CorporateActionPrice39 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice39 obj, Optional<PriceFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice39, Optional<PriceFormat7Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice39, Optional<PriceFormat7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice45.mmGenericCashPriceReceivedPerProduct);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat7Choice> getValue(CorporateActionPrice39 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice39 obj, Optional<PriceFormat7Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice39.mmCashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice39.mmIndicativeOrMarketPrice,
						com.tools20022.repository.msg.CorporateActionPrice39.mmCashValueForTax, com.tools20022.repository.msg.CorporateActionPrice39.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice39.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice39);
	...
	public CorporateActionPrice39 setCashInLieuOfSharePrice(PriceFormat5Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice39 setIndicativeOrMarketPrice(IndicativeOrMarketPrice2Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice39 setCashValueForTax(AmountPrice2 cashValueForTax) {
	...
	public CorporateActionPrice39 setGenericCashPricePaidPerProduct(PriceFormat6Choice genericCashPricePaidPerProduct) {
	...
	public CorporateActionPrice39 setGenericCashPriceReceivedPerProduct(PriceFormat7Choice genericCashPriceReceivedPerProduct) {
