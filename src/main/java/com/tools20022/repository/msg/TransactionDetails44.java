...
public class TransactionDetails44 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails44.mmFinancialInstrumentIdentification, TransactionDetails44.mmTradeDate, TransactionDetails44.mmSettlementDate, TransactionDetails44.mmSettlementQuantity,
						TransactionDetails44.mmSettlementAmount, TransactionDetails44.mmDeliveringSettlementParties, TransactionDetails44.mmReceivingSettlementParties, TransactionDetails44.mmInvestor);
