...
import com.tools20022.repository.msg.InvestmentFundCashSettlementInformation5;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.InvestmentPlan6#mmFrequency
 * InvestmentPlan6.mmFrequency}</li>
 * <li>{@linkplain com.tools20022.repository.msg.InvestmentPlan6#mmStartDate
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.InvestmentPlan4
 * InvestmentPlan4}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "InvestmentPlan6", propOrder = {"frequency", "startDate", "endDate", "quantity", "grossAmountIndicator", "incomePreference", "initialNumberOfInstalment", "totalNumberOfInstalment", "roundingDirection", "securityDetails",
...
public class InvestmentPlan6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Frequency19Choice> mmFrequency = new MMMessageAttribute<InvestmentPlan6, Frequency19Choice>() {
		{
			businessElementTrace_lazy = () -> InvestmentPlan.mmFrequency;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Frequency";
			definition = "Frequency of the investment or divestment.";
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmFrequency);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Frequency19Choice getValue(InvestmentPlan6 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Frequency19Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<ISODate>> mmStartDate = new MMMessageAttribute<InvestmentPlan6, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmStartDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(InvestmentPlan6 obj) {
			return obj.getStartDate();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<ISODate>> mmEndDate = new MMMessageAttribute<InvestmentPlan6, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmEndDate);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, UnitsOrAmount1Choice> mmQuantity = new MMMessageAttribute<InvestmentPlan6, UnitsOrAmount1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmQuantity);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public UnitsOrAmount1Choice getValue(InvestmentPlan6 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, UnitsOrAmount1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<YesNoIndicator>> mmGrossAmountIndicator = new MMMessageAttribute<InvestmentPlan6, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmGrossAmountIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(InvestmentPlan6 obj) {
			return obj.getGrossAmountIndicator();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<IncomePreference1Code>> mmIncomePreference = new MMMessageAttribute<InvestmentPlan6, Optional<IncomePreference1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmIncomePreference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<IncomePreference1Code> getValue(InvestmentPlan6 obj) {
			return obj.getIncomePreference();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<IncomePreference1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Number>> mmInitialNumberOfInstalment = new MMMessageAttribute<InvestmentPlan6, Optional<Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmInitialNumberOfInstalments);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number> getValue(InvestmentPlan6 obj) {
			return obj.getInitialNumberOfInstalment();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Number>> mmTotalNumberOfInstalment = new MMMessageAttribute<InvestmentPlan6, Optional<Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmTotalNumberOfInstalments);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Number.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<RoundingDirection1Code>> mmRoundingDirection = new MMMessageAttribute<InvestmentPlan6, Optional<RoundingDirection1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmRoundingDirection);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RoundingDirection1Code> getValue(InvestmentPlan6 obj) {
			return obj.getRoundingDirection();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<RoundingDirection1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentPlan6, List<Repartition2>> mmSecurityDetails = new MMMessageAssociationEnd<InvestmentPlan6, List<Repartition2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmSecurityDetails);
			maxOccurs = 50;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<Repartition2> getValue(InvestmentPlan6 obj) {
			return obj.getSecurityDetails();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, List<Repartition2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentPlan6, List<InvestmentFundCashSettlementInformation5>> mmCashSettlement = new MMMessageAssociationEnd<InvestmentPlan6, List<InvestmentFundCashSettlementInformation5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmCashSettlement);
			maxOccurs = 8;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> InvestmentFundCashSettlementInformation5.mmObject();
		}

		@Override
		public List<InvestmentFundCashSettlementInformation5> getValue(InvestmentPlan6 obj) {
			return obj.getCashSettlement();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, List<InvestmentFundCashSettlementInformation5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>> mmContractReference = new MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			xmlTag = "CtrctRef";
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmContractReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(InvestmentPlan6 obj) {
			return obj.getContractReference();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>> mmRelatedContractReference = new MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			xmlTag = "RltdCtrctRef";
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmRelatedContractReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>> mmProductIdentification = new MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			xmlTag = "PdctId";
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmProductIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>> mmSLAChargeAndCommissionReference = new MMMessageAttribute<InvestmentPlan6, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmSLAChargeAndCommissionReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentPlan6, Optional<InsuranceType1Choice>> mmInsuranceCover = new MMMessageAttribute<InvestmentPlan6, Optional<InsuranceType1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentPlan6.mmObject();
			isDerived = false;
			xmlTag = "InsrncCover";
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmInsuranceCover);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InsuranceType1Choice> getValue(InvestmentPlan6 obj) {
			return obj.getInsuranceCover();
		}

		@Override
		public void setValue(InvestmentPlan6 obj, Optional<InsuranceType1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentPlan6.mmFrequency, com.tools20022.repository.msg.InvestmentPlan6.mmStartDate, com.tools20022.repository.msg.InvestmentPlan6.mmEndDate,
						com.tools20022.repository.msg.InvestmentPlan6.mmQuantity, com.tools20022.repository.msg.InvestmentPlan6.mmGrossAmountIndicator, com.tools20022.repository.msg.InvestmentPlan6.mmIncomePreference,
						com.tools20022.repository.msg.InvestmentPlan6.mmInitialNumberOfInstalment, com.tools20022.repository.msg.InvestmentPlan6.mmTotalNumberOfInstalment, com.tools20022.repository.msg.InvestmentPlan6.mmRoundingDirection,
						com.tools20022.repository.msg.InvestmentPlan6.mmSecurityDetails, com.tools20022.repository.msg.InvestmentPlan6.mmCashSettlement, com.tools20022.repository.msg.InvestmentPlan6.mmContractReference,
						com.tools20022.repository.msg.InvestmentPlan6.mmRelatedContractReference, com.tools20022.repository.msg.InvestmentPlan6.mmProductIdentification,
						com.tools20022.repository.msg.InvestmentPlan6.mmSLAChargeAndCommissionReference, com.tools20022.repository.msg.InvestmentPlan6.mmInsuranceCover);
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountDetailsConfirmationV03.mmSavingsInvestmentPlan, AccountDetailsConfirmationV03.mmWithdrawalInvestmentPlan, AccountOpeningInstructionV03.mmSavingsInvestmentPlan,
						AccountOpeningInstructionV03.mmWithdrawalInvestmentPlan);
				trace_lazy = () -> InvestmentPlan.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAmountRule.forInvestmentPlan6);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestmentPlan6";
				...
				nextVersions_lazy = () -> Arrays.asList(InvestmentPlan9.mmObject());
				previousVersion_lazy = () -> InvestmentPlan4.mmObject();
			}
		});
	...
	public InvestmentPlan6 setFrequency(Frequency19Choice frequency) {
	...
	public InvestmentPlan6 setStartDate(ISODate startDate) {
	...
	public InvestmentPlan6 setEndDate(ISODate endDate) {
	...
	public InvestmentPlan6 setQuantity(UnitsOrAmount1Choice quantity) {
	...
	public InvestmentPlan6 setGrossAmountIndicator(YesNoIndicator grossAmountIndicator) {
	...
	public InvestmentPlan6 setIncomePreference(IncomePreference1Code incomePreference) {
	...
	public InvestmentPlan6 setInitialNumberOfInstalment(Number initialNumberOfInstalment) {
	...
	public InvestmentPlan6 setTotalNumberOfInstalment(Number totalNumberOfInstalment) {
	...
	public InvestmentPlan6 setRoundingDirection(RoundingDirection1Code roundingDirection) {
	...
	public InvestmentPlan6 setSecurityDetails(List<Repartition2> securityDetails) {
	...
	public InvestmentPlan6 setCashSettlement(List<InvestmentFundCashSettlementInformation5> cashSettlement) {
	...
	public InvestmentPlan6 setContractReference(Max35Text contractReference) {
	...
	public InvestmentPlan6 setRelatedContractReference(Max35Text relatedContractReference) {
	...
	public InvestmentPlan6 setProductIdentification(Max35Text productIdentification) {
	...
	public InvestmentPlan6 setSLAChargeAndCommissionReference(Max35Text sLAChargeAndCommissionReference) {
	...
	public InvestmentPlan6 setInsuranceCover(InsuranceType1Choice insuranceCover) {
