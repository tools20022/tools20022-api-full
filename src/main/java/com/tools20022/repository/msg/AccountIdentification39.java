...
public class AccountIdentification39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification39.mmSafekeepingAccount, AccountIdentification39.mmAccountOwner, AccountIdentification39.mmSafekeepingPlace);
