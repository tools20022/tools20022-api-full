...
public class PEPISATransfer6 {
	...
	public static final MMXor mmProductRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(PEPISATransfer6.mmISA, PEPISATransfer6.mmPEP, PEPISATransfer6.mmPortfolio);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PEPISATransfer6.mmMasterReference, PEPISATransfer6.mmTransferIdentification, PEPISATransfer6.mmResidualCashIndicator, PEPISATransfer6.mmISA, PEPISATransfer6.mmPEP,
						PEPISATransfer6.mmPortfolio, PEPISATransfer6.mmFinancialInstrumentAssetForTransfer);
				...
				xors_lazy = () -> Arrays.asList(PEPISATransfer6.mmProductRule);
			}
		});
