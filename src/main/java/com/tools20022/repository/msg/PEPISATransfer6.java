...
import com.tools20022.repository.msg.ISAYearsOfIssue1;
 ...
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PEPISATransfer6#ProductRule
 * PEPISATransfer6.ProductRule}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PEPISATransfer6#mmTransferIdentification
 * PEPISATransfer6.mmTransferIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PEPISATransfer6#mmResidualCashIndicator
 * PEPISATransfer6.mmResidualCashIndicator}</li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PEPISATransfer6#mmPortfolio
...
@XmlType(name = "PEPISATransfer6", propOrder = {"masterReference", "transferIdentification", "residualCashIndicator", "iSA", "pEP", "portfolio", "financialInstrumentAssetForTransfer"})
public class PEPISATransfer6 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PEPISATransfer6
	 * PEPISATransfer6}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer6, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<PEPISATransfer6, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<Max35Text> getValue(PEPISATransfer6 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer6, Max35Text> mmTransferIdentification = new MMMessageAttribute<PEPISATransfer6, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "TrfId";
		...
		@Override
		public Max35Text getValue(PEPISATransfer6 obj) {
			return obj.getTransferIdentification();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer6, YesNoIndicator> mmResidualCashIndicator = new MMMessageAttribute<PEPISATransfer6, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "RsdlCshInd";
		...
		@Override
		public YesNoIndicator getValue(PEPISATransfer6 obj) {
			return obj.getResidualCashIndicator();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer6, ISAYearsOfIssue1> mmISA = new MMMessageAssociationEnd<PEPISATransfer6, ISAYearsOfIssue1>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> ISAYearsOfIssue1.mmObject();
		}

		@Override
		public ISAYearsOfIssue1 getValue(PEPISATransfer6 obj) {
			return obj.getISA();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, ISAYearsOfIssue1 value) {
			obj.setISA(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer6, PreviousYearChoice> mmPEP = new MMMessageAssociationEnd<PEPISATransfer6, PreviousYearChoice>() {
		{
			businessComponentTrace_lazy = () -> PortfolioTransfer.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer6.mmObject();
			isDerived = false;
		...
		@Override
		public PreviousYearChoice getValue(PEPISATransfer6 obj) {
			return obj.getPEP();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, PreviousYearChoice value) {
			obj.setPEP(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer6, Portfolio1> mmPortfolio = new MMMessageAssociationEnd<PEPISATransfer6, Portfolio1>() {
		{
		...
		@Override
		public Portfolio1 getValue(PEPISATransfer6 obj) {
			return obj.getPortfolio();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, Portfolio1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer6, List<FinancialInstrument12>> mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd<PEPISATransfer6, List<FinancialInstrument12>>() {
		{
		...
		@Override
		public List<FinancialInstrument12> getValue(PEPISATransfer6 obj) {
			return obj.getFinancialInstrumentAssetForTransfer();
		}

		@Override
		public void setValue(PEPISATransfer6 obj, List<FinancialInstrument12> value) {
	...
	public static final MMXor ProductRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.PEPISATransfer6.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PEPISATransfer6.mmISA, com.tools20022.repository.msg.PEPISATransfer6.mmPEP, com.tools20022.repository.msg.PEPISATransfer6.mmPortfolio);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PEPISATransfer6.mmMasterReference, com.tools20022.repository.msg.PEPISATransfer6.mmTransferIdentification,
						com.tools20022.repository.msg.PEPISATransfer6.mmResidualCashIndicator, com.tools20022.repository.msg.PEPISATransfer6.mmISA, com.tools20022.repository.msg.PEPISATransfer6.mmPEP,
						com.tools20022.repository.msg.PEPISATransfer6.mmPortfolio, com.tools20022.repository.msg.PEPISATransfer6.mmFinancialInstrumentAssetForTransfer);
				messageBuildingBlock_lazy = () -> Arrays.asList(PEPOrISAOrPortfolioInformationV01.mmProductTransfer);
				...
				name = "PEPISATransfer6";
				definition = "Describes the type of product and the assets to be transferred.";
				nextVersions_lazy = () -> Arrays.asList(ISATransfer4.mmObject());
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PEPISATransfer6.ProductRule);
			}
		});
	...
	public PEPISATransfer6 setMasterReference(Max35Text masterReference) {
	...
	public PEPISATransfer6 setTransferIdentification(Max35Text transferIdentification) {
	...
	public PEPISATransfer6 setResidualCashIndicator(YesNoIndicator residualCashIndicator) {
	...
	public PEPISATransfer6 setISA(ISAYearsOfIssue1 iSA) {
	...
	public PEPISATransfer6 setPEP(PreviousYearChoice pEP) {
	...
	public PEPISATransfer6 setPortfolio(Portfolio1 portfolio) {
	...
	public PEPISATransfer6 setFinancialInstrumentAssetForTransfer(List<FinancialInstrument12> financialInstrumentAssetForTransfer) {
