 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails70#mmPriority
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails90
...
@XmlType(name = "SettlementDetails70", propOrder = {"priority", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "blockTrade", "cCPEligibility", "cashClearingSystem",
...
public class SettlementDetails70 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<PriorityNumeric1Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails70, Optional<PriorityNumeric1Choice>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails70.mmObject();
			isDerived = false;
			xmlTag = "Prty";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Priority";
			definition = "Specifies whether the transaction was executed with a high priority.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmPriority);
			previousVersion_lazy = () -> SettlementDetails45.mmPriority;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric1Choice> getValue(SettlementDetails70 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<PriorityNumeric1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, SecuritiesTransactionType10Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails70, SecuritiesTransactionType10Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSecuritiesTransactionType);
			previousVersion_lazy = () -> SettlementDetails45.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesTransactionType10Choice getValue(SettlementDetails70 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails70 obj, SecuritiesTransactionType10Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, List<SettlementTransactionCondition12Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails70, List<SettlementTransactionCondition12Choice>>() {
		{
			...
			definition = "Conditions under which the order/trade was to be settled.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails45.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition12Choice> getValue(SettlementDetails70 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails70 obj, List<SettlementTransactionCondition12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails70, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails70, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails45.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails70 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails70, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails45.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails70 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails70, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails45.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails70 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails70, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails45.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails70 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails70, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails45.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails70 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<ExposureType10Choice>> mmExposureType = new MMMessageAssociationEnd<SettlementDetails70, Optional<ExposureType10Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmExposureType);
			previousVersion_lazy = () -> SettlementDetails45.mmExposureType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ExposureType10Choice> getValue(SettlementDetails70 obj) {
			return obj.getExposureType();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<ExposureType10Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails70, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails45.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails70 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails70, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails45.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails70 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<Registration1Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails70, Optional<Registration1Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration was to occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmRegistration);
			previousVersion_lazy = () -> SettlementDetails45.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration1Choice> getValue(SettlementDetails70 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<Registration1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<RepurchaseType3Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails70, Optional<RepurchaseType3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmRepurchaseType);
			previousVersion_lazy = () -> SettlementDetails45.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType3Choice> getValue(SettlementDetails70 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<RepurchaseType3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails70, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails45.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails70 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails70, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails45.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails70 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<SettlingCapacity4Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails70, Optional<SettlingCapacity4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails45.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity4Choice> getValue(SettlementDetails70 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<SettlingCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails70, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails45.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails70 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails70, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails45.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails70 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails45.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails70 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<AutomaticBorrowing1Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails70, Optional<AutomaticBorrowing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmAutomaticBorrowing);
			previousVersion_lazy = () -> SettlementDetails45.mmAutomaticBorrowing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing1Choice> getValue(SettlementDetails70 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<AutomaticBorrowing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<LetterOfGuarantee1Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails70, Optional<LetterOfGuarantee1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmLetterOfGuarantee);
			previousVersion_lazy = () -> SettlementDetails45.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee1Choice> getValue(SettlementDetails70 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<LetterOfGuarantee1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails70, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails70, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmEligibleForCollateral);
			previousVersion_lazy = () -> SettlementDetails45.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails70 obj) {
			return obj.getEligibleForCollateral();
		}

		@Override
		public void setValue(SettlementDetails70 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>> mmSecuritiesSubBalanceType = new MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmSecuritiesSubBalanceType);
			previousVersion_lazy = () -> SettlementDetails45.mmSecuritiesSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification20.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>> mmCashSubBalanceType = new MMMessageAssociationEnd<SettlementDetails70, Optional<GenericIdentification20>>() {
		{
			businessElementTrace_lazy = () -> Balance.mmType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmCashSubBalanceType);
			previousVersion_lazy = () -> SettlementDetails45.mmCashSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification20.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails70.mmPriority, com.tools20022.repository.msg.SettlementDetails70.mmSecuritiesTransactionType,
						...
						com.tools20022.repository.msg.SettlementDetails70.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails70.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails70.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails70.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails70.mmExposureType, com.tools20022.repository.msg.SettlementDetails70.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails70.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails70.mmRegistration, com.tools20022.repository.msg.SettlementDetails70.mmRepurchaseType,
						com.tools20022.repository.msg.SettlementDetails70.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails70.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails70.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails70.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails70.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails70.mmStampDutyTaxBasis,
						com.tools20022.repository.msg.SettlementDetails70.mmAutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails70.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails70.mmEligibleForCollateral, com.tools20022.repository.msg.SettlementDetails70.mmSecuritiesSubBalanceType,
						com.tools20022.repository.msg.SettlementDetails70.mmCashSubBalanceType);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionReversalAdviceV04.mmSettlementParameters, SecuritiesSettlementTransactionConfirmationV05.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails70,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails70);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails70";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails90.mmObject());
				previousVersion_lazy = () -> SettlementDetails45.mmObject();
			}
		});
	...
	public SettlementDetails70 setPriority(PriorityNumeric1Choice priority) {
	...
	public SettlementDetails70 setSecuritiesTransactionType(SecuritiesTransactionType10Choice securitiesTransactionType) {
	...
	public SettlementDetails70 setSettlementTransactionCondition(List<SettlementTransactionCondition12Choice> settlementTransactionCondition) {
	...
	public SettlementDetails70 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails70 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails70 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails70 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails70 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails70 setExposureType(ExposureType10Choice exposureType) {
	...
	public SettlementDetails70 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails70 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails70 setRegistration(Registration1Choice registration) {
	...
	public SettlementDetails70 setRepurchaseType(RepurchaseType3Choice repurchaseType) {
	...
	public SettlementDetails70 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails70 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails70 setSettlingCapacity(SettlingCapacity4Choice settlingCapacity) {
	...
	public SettlementDetails70 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails70 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails70 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails70 setAutomaticBorrowing(AutomaticBorrowing1Choice automaticBorrowing) {
	...
	public SettlementDetails70 setLetterOfGuarantee(LetterOfGuarantee1Choice letterOfGuarantee) {
	...
	public SettlementDetails70 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
	...
	public SettlementDetails70 setSecuritiesSubBalanceType(GenericIdentification20 securitiesSubBalanceType) {
	...
	public SettlementDetails70 setCashSubBalanceType(GenericIdentification20 cashSubBalanceType) {
