	...
	public static final MMMessageAttribute mmAmountPriceType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountPrice7.mmAmountPriceType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmPriceValue = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountPrice7.mmPriceValue);
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(AmountPrice7.mmObject());
			}
		});
