...
public class FinancialInstrumentAttributes41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes41.mmPlaceOfListing, FinancialInstrumentAttributes41.mmDayCountBasis, FinancialInstrumentAttributes41.mmRegistrationForm,
						FinancialInstrumentAttributes41.mmPaymentFrequency, FinancialInstrumentAttributes41.mmPaymentStatus, FinancialInstrumentAttributes41.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes41.mmClassificationType, FinancialInstrumentAttributes41.mmOptionStyle, FinancialInstrumentAttributes41.mmOptionType, FinancialInstrumentAttributes41.mmDenominationCurrency,
						FinancialInstrumentAttributes41.mmCouponDate, FinancialInstrumentAttributes41.mmExpiryDate, FinancialInstrumentAttributes41.mmFloatingRateFixingDate, FinancialInstrumentAttributes41.mmMaturityDate,
						FinancialInstrumentAttributes41.mmIssueDate, FinancialInstrumentAttributes41.mmNextCallableDate, FinancialInstrumentAttributes41.mmPutableDate, FinancialInstrumentAttributes41.mmDatedDate,
						FinancialInstrumentAttributes41.mmFirstPaymentDate, FinancialInstrumentAttributes41.mmPreviousFactor, FinancialInstrumentAttributes41.mmCurrentFactor, FinancialInstrumentAttributes41.mmNextFactor,
						FinancialInstrumentAttributes41.mmInterestRate, FinancialInstrumentAttributes41.mmYieldToMaturityRate, FinancialInstrumentAttributes41.mmNextInterestRate, FinancialInstrumentAttributes41.mmIndexRateBasis,
						FinancialInstrumentAttributes41.mmCouponAttachedNumber, FinancialInstrumentAttributes41.mmPoolNumber, FinancialInstrumentAttributes41.mmVariableRateIndicator, FinancialInstrumentAttributes41.mmCallableIndicator,
						FinancialInstrumentAttributes41.mmPutableIndicator, FinancialInstrumentAttributes41.mmMarketOrIndicativePrice, FinancialInstrumentAttributes41.mmExercisePrice, FinancialInstrumentAttributes41.mmSubscriptionPrice,
						FinancialInstrumentAttributes41.mmConversionPrice, FinancialInstrumentAttributes41.mmStrikePrice, FinancialInstrumentAttributes41.mmMinimumNominalQuantity, FinancialInstrumentAttributes41.mmContractSize,
						FinancialInstrumentAttributes41.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes41.mmFinancialInstrumentAttributeAdditionalDetails);
