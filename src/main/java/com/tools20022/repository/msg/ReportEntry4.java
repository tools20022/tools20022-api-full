 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ReportEntry4#EntryReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.ReportEntry4#ReversalIndicator
...
public class ReportEntry4 {
	...
	public static final MMMessageAttribute EntryReference = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ReportEntry4.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.EntryReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			definition = "Indicates whether the entry is a credit or a debit entry.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.CreditDebitIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReversalIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.ReversalIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Status = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.Status);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BookingDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.BookingDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ValueDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.ValueDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute AccountServicerReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.AccountServicerReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd Availability = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.Availability);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd BankTransactionCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.BankTransactionCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CommissionWaiverIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.CommissionWaiverIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AdditionalInformationIndicator = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.AdditionalInformationIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.AmountDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Charges = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.Charges);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TechnicalInputChannel = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.TechnicalInputChannel);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Interest = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.Interest);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ReportEntry7#CardTransaction
	...
	public static final MMMessageAssociationEnd CardTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.CardTransaction);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd EntryDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.EntryDetails);
			minOccurs = 0;
	...
	public static final MMMessageAttribute AdditionalEntryInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry7.AdditionalEntryInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReportEntry4.EntryReference, com.tools20022.repository.msg.ReportEntry4.Amount, com.tools20022.repository.msg.ReportEntry4.CreditDebitIndicator,
						com.tools20022.repository.msg.ReportEntry4.ReversalIndicator, com.tools20022.repository.msg.ReportEntry4.Status, com.tools20022.repository.msg.ReportEntry4.BookingDate,
						com.tools20022.repository.msg.ReportEntry4.ValueDate, com.tools20022.repository.msg.ReportEntry4.AccountServicerReference, com.tools20022.repository.msg.ReportEntry4.Availability,
						com.tools20022.repository.msg.ReportEntry4.BankTransactionCode, com.tools20022.repository.msg.ReportEntry4.CommissionWaiverIndicator, com.tools20022.repository.msg.ReportEntry4.AdditionalInformationIndicator,
						com.tools20022.repository.msg.ReportEntry4.AmountDetails, com.tools20022.repository.msg.ReportEntry4.Charges, com.tools20022.repository.msg.ReportEntry4.TechnicalInputChannel,
						com.tools20022.repository.msg.ReportEntry4.Interest, com.tools20022.repository.msg.ReportEntry4.CardTransaction, com.tools20022.repository.msg.ReportEntry4.EntryDetails,
						com.tools20022.repository.msg.ReportEntry4.AdditionalEntryInformation);
