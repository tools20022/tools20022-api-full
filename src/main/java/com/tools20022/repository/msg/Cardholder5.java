...
public class Cardholder5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Cardholder5.mmIdentification, Cardholder5.mmName, Cardholder5.mmLanguage, Cardholder5.mmBillingAddress, Cardholder5.mmShippingAddress, Cardholder5.mmAuthentication,
						Cardholder5.mmAddressVerification, Cardholder5.mmPersonalData);
