...
public class ForeignExchangeTerms3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms3.mmUnitCurrency, ForeignExchangeTerms3.mmQuotedCurrency, ForeignExchangeTerms3.mmExchangeRate, ForeignExchangeTerms3.mmQuotationDate,
						ForeignExchangeTerms3.mmQuotingInstitution);
