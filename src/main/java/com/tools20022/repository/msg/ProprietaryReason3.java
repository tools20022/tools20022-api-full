...
public class ProprietaryReason3 {
	...
	public static final MMMessageAttribute Reason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ProprietaryReason3.mmObject();
			...
			name = "Reason";
			definition = "Proprietary identification of the reason related to a status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProprietaryReason1Choice.Reason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ProprietaryReason3.Reason, com.tools20022.repository.msg.ProprietaryReason3.AdditionalReasonInformation);
