...
public class ProprietaryReason3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProprietaryReason3.mmReason, ProprietaryReason3.mmAdditionalReasonInformation);
	...
	public void setReason(com.tools20022.repository.msg.GenericIdentification40 reason) {
		this.reason = reason;
	}
