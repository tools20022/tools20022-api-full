...
public class PartyIdentificationAndAccount36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount36.mmIdentification, PartyIdentificationAndAccount36.mmAlternateIdentification, PartyIdentificationAndAccount36.mmCountryOfResidence,
						PartyIdentificationAndAccount36.mmSafekeepingAccount, PartyIdentificationAndAccount36.mmProcessingIdentification, PartyIdentificationAndAccount36.mmAdditionalInformation);
