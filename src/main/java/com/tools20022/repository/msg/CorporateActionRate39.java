...
public class CorporateActionRate39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate39.mmGrossDividendRate, CorporateActionRate39.mmNetDividendRate, CorporateActionRate39.mmIndexFactor, CorporateActionRate39.mmInterestRateUsedForPayment,
						CorporateActionRate39.mmMaximumAllowedOversubscriptionRate, CorporateActionRate39.mmProrationRate, CorporateActionRate39.mmTaxRelatedRate, CorporateActionRate39.mmWithholdingTaxRate,
						CorporateActionRate39.mmAdditionalTax, CorporateActionRate39.mmWithholdingOfForeignTax, CorporateActionRate39.mmTaxableIncomePerDividendShare);
