...
public class CorporateActionGeneralInformation51 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation51.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation51.mmCorporateActionEventIdentification, CorporateActionGeneralInformation51.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation51.mmClassActionNumber, CorporateActionGeneralInformation51.mmEventProcessingType, CorporateActionGeneralInformation51.mmEventType,
						CorporateActionGeneralInformation51.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation51.mmUnderlyingSecurity);
	...
	public void setEventType(CorporateActionEventType13Choice eventType) {
