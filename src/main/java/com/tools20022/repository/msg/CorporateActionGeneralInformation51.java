...
public class CorporateActionGeneralInformation51 {
	...
	public static final MMMessageAttribute CorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.CorporateActionEventIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OfficialCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.OfficialCorporateActionEventIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute ClassActionNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.ClassActionNumber);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd EventProcessingType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.EventProcessingType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd EventType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.EventType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MandatoryVoluntaryEventType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.MandatoryVoluntaryEventType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation70.UnderlyingSecurity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation51.CorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.OfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation51.ClassActionNumber,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.EventProcessingType, com.tools20022.repository.msg.CorporateActionGeneralInformation51.EventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.MandatoryVoluntaryEventType, com.tools20022.repository.msg.CorporateActionGeneralInformation51.UnderlyingSecurity);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionNotificationV04.CorporateActionGeneralInformation);
