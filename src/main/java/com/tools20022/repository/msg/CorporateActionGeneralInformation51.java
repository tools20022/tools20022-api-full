 ...
 * CorporateActionGeneralInformation51.mmCorporateActionEventIdentification}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation51", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "classActionNumber", "eventProcessingType", "eventType", "mandatoryVoluntaryEventType",
		"underlyingSecurity"})
public class CorporateActionGeneralInformation51 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation51, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation51, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation51, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmOfficialCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation51, Optional<Max35Text>> mmClassActionNumber = new MMMessageAttribute<CorporateActionGeneralInformation51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmClassActionNumber);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation51, Optional<CorporateActionEventProcessingTypeChoice>> mmEventProcessingType = new MMMessageAssociationEnd<CorporateActionGeneralInformation51, Optional<CorporateActionEventProcessingTypeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmEventProcessingType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionEventProcessingTypeChoice> getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getEventProcessingType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, Optional<CorporateActionEventProcessingTypeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation51, CorporateActionEventType13Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation51, CorporateActionEventType13Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmEventType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionEventType13Choice getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, CorporateActionEventType13Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation51, CorporateActionMandatoryVoluntary1Choice> mmMandatoryVoluntaryEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation51, CorporateActionMandatoryVoluntary1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmMandatoryVoluntaryEventType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionMandatoryVoluntary1Choice getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, CorporateActionMandatoryVoluntary1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation51, FinancialInstrumentAttributes43> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation51, FinancialInstrumentAttributes43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmUnderlyingSecurity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrumentAttributes43 getValue(CorporateActionGeneralInformation51 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation51 obj, FinancialInstrumentAttributes43 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmClassActionNumber,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmEventProcessingType, com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmMandatoryVoluntaryEventType, com.tools20022.repository.msg.CorporateActionGeneralInformation51.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNotificationV04.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation51,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation51,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation51);
				...
				name = "CorporateActionGeneralInformation51";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation70.mmObject());
				previousVersion_lazy = () -> CorporateActionGeneralInformation37.mmObject();
			}
		});
	...
	public CorporateActionGeneralInformation51 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation51 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation51 setClassActionNumber(Max35Text classActionNumber) {
	...
	public CorporateActionGeneralInformation51 setEventProcessingType(CorporateActionEventProcessingTypeChoice eventProcessingType) {
	...
	public CorporateActionGeneralInformation51 setEventType(CorporateActionEventType13Choice eventType) {
	...
	public CorporateActionGeneralInformation51 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary1Choice mandatoryVoluntaryEventType) {
	...
	public CorporateActionGeneralInformation51 setUnderlyingSecurity(FinancialInstrumentAttributes43 underlyingSecurity) {
