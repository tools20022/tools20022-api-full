...
public class CashOption22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption22.mmCreditDebitIndicator, CashOption22.mmContractualPaymentIndicator, CashOption22.mmIncomeType, CashOption22.mmAccount, CashOption22.mmCashParties,
						CashOption22.mmAmountDetails, CashOption22.mmDateDetails, CashOption22.mmForeignExchangeDetails, CashOption22.mmTaxVoucherDetails, CashOption22.mmRateAndAmountDetails, CashOption22.mmPriceDetails);
