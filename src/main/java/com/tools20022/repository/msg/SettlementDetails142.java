 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SettlementDetails142#mmModificationCancellationAllowed
 * SettlementDetails142.mmModificationCancellationAllowed}</li>
 * <li>
...
@XmlType(name = "SettlementDetails142", propOrder = {"holdIndicator", "priority", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "blockTrade", "cCPEligibility",
...
public class SettlementDetails142 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<HoldIndicator6>> mmHoldIndicator = new MMMessageAssociationEnd<SettlementDetails142, Optional<HoldIndicator6>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails142.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "HoldIndicator";
			definition = "Specifies whether the transaction is on hold/blocked/frozen.";
			previousVersion_lazy = () -> SettlementDetails119.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<HoldIndicator6> getValue(SettlementDetails142 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<HoldIndicator6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<PriorityNumeric4Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails142, Optional<PriorityNumeric4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmPriority;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric4Choice> getValue(SettlementDetails142 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<PriorityNumeric4Choice> value) {
			obj.setPriority(value.orElse(null));
		}
	};
	@XmlElement(name = "SctiesTxTp", required = true)
	protected SecuritiesTransactionType37Choice securitiesTransactionType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, SecuritiesTransactionType37Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails142, SecuritiesTransactionType37Choice>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SecuritiesTransactionType37Choice.mmObject();
		}

		@Override
		public SecuritiesTransactionType37Choice getValue(SettlementDetails142 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails142 obj, SecuritiesTransactionType37Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails142, List<SettlementTransactionCondition16Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails142 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails142 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails142, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails142, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails142.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementDetails119.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails142 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails142, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails142 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails142, Optional<BlockTrade4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails142 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails142, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails142 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<DeliveryReturn3Choice>> mmDeliveryReturnReason = new MMMessageAssociationEnd<SettlementDetails142, Optional<DeliveryReturn3Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmDeliveryReturnReason;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveryReturn3Choice> getValue(SettlementDetails142 obj) {
			return obj.getDeliveryReturnReason();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<DeliveryReturn3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails142, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails142 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<ExposureType16Choice>> mmExposureType = new MMMessageAssociationEnd<SettlementDetails142, Optional<ExposureType16Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmExposureType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ExposureType16Choice> getValue(SettlementDetails142 obj) {
			return obj.getExposureType();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<ExposureType16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<FXStandingInstruction4Choice>> mmFXStandingInstruction = new MMMessageAssociationEnd<SettlementDetails142, Optional<FXStandingInstruction4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmFXStandingInstruction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FXStandingInstruction4Choice> getValue(SettlementDetails142 obj) {
			return obj.getFXStandingInstruction();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<FXStandingInstruction4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<MarketClientSide6Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails142, Optional<MarketClientSide6Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide6Choice> getValue(SettlementDetails142 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<MarketClientSide6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails142, Optional<NettingEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails142 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails142, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			previousVersion_lazy = () -> SettlementDetails119.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails142 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<RepurchaseType23Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails142, Optional<RepurchaseType23Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType23Choice> getValue(SettlementDetails142 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<RepurchaseType23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails142, Optional<Restriction5Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails142 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails142, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails142 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails142, Optional<SettlingCapacity7Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails142 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails142, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails142 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails142, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails142 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails142 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<Tracking4Choice>> mmTracking = new MMMessageAssociationEnd<SettlementDetails142, Optional<Tracking4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmTracking;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Tracking4Choice> getValue(SettlementDetails142 obj) {
			return obj.getTracking();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<Tracking4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<AutomaticBorrowing6Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails142, Optional<AutomaticBorrowing6Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmAutomaticBorrowing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing6Choice> getValue(SettlementDetails142 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<AutomaticBorrowing6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails142, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails142 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails142, Optional<YesNoIndicator>> mmReturnLeg = new MMMessageAttribute<SettlementDetails142, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmReturnLeg;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails142 obj) {
			return obj.getReturnLeg();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<ModificationCancellationAllowed4Choice>> mmModificationCancellationAllowed = new MMMessageAssociationEnd<SettlementDetails142, Optional<ModificationCancellationAllowed4Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails142.mmObject();
			isDerived = false;
			xmlTag = "ModCxlAllwd";
			...
			previousVersion_lazy = () -> SettlementDetails119.mmModificationCancellationAllowed;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ModificationCancellationAllowed4Choice> getValue(SettlementDetails142 obj) {
			return obj.getModificationCancellationAllowed();
		}

		@Override
		public void setValue(SettlementDetails142 obj, Optional<ModificationCancellationAllowed4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails142, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails142, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>> mmDeliveringSecuritiesSubBalanceType = new MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails119.mmSecuritiesSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification30.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>> mmReceivingSecuritiesSubBalanceType = new MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>>() {
		{
			businessElementTrace_lazy = () -> Balance.mmType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails142.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>> mmCashSubBalanceType = new MMMessageAssociationEnd<SettlementDetails142, Optional<GenericIdentification30>>() {
		{
			businessElementTrace_lazy = () -> Balance.mmType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails142.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementDetails119.mmCashSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification30.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails142.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails142.mmPriority,
						com.tools20022.repository.msg.SettlementDetails142.mmSecuritiesTransactionType, com.tools20022.repository.msg.SettlementDetails142.mmSettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails142.mmPartialSettlementIndicator, com.tools20022.repository.msg.SettlementDetails142.mmBeneficialOwnership,
						com.tools20022.repository.msg.SettlementDetails142.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails142.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails142.mmDeliveryReturnReason,
						com.tools20022.repository.msg.SettlementDetails142.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails142.mmExposureType, com.tools20022.repository.msg.SettlementDetails142.mmFXStandingInstruction,
						com.tools20022.repository.msg.SettlementDetails142.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails142.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails142.mmRegistration,
						com.tools20022.repository.msg.SettlementDetails142.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails142.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails142.mmSecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails142.mmSettlingCapacity, com.tools20022.repository.msg.SettlementDetails142.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails142.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails142.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails142.mmTracking, com.tools20022.repository.msg.SettlementDetails142.mmAutomaticBorrowing,
						com.tools20022.repository.msg.SettlementDetails142.mmLetterOfGuarantee, com.tools20022.repository.msg.SettlementDetails142.mmReturnLeg,
						com.tools20022.repository.msg.SettlementDetails142.mmModificationCancellationAllowed, com.tools20022.repository.msg.SettlementDetails142.mmEligibleForCollateral,
						com.tools20022.repository.msg.SettlementDetails142.mmDeliveringSecuritiesSubBalanceType, com.tools20022.repository.msg.SettlementDetails142.mmReceivingSecuritiesSubBalanceType,
						com.tools20022.repository.msg.SettlementDetails142.mmCashSubBalanceType);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionInstructionV08.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails142,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails142, com.tools20022.repository.constraints.ConstraintFXStandingInstructionPresenceRule.forSettlementDetails142,
						com.tools20022.repository.constraints.ConstraintSettlementParametersGuideline.forSettlementDetails142);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails142";
				definition = "Details of settlement of a transaction.";
				previousVersion_lazy = () -> SettlementDetails119.mmObject();
			}
		});
	...
	public SettlementDetails142 setHoldIndicator(HoldIndicator6 holdIndicator) {
	...
	public SettlementDetails142 setPriority(PriorityNumeric4Choice priority) {
		this.priority = priority;
		return this;
	}

	public SecuritiesTransactionType37Choice getSecuritiesTransactionType() {
		return securitiesTransactionType;
	}

	public SettlementDetails142 setSecuritiesTransactionType(SecuritiesTransactionType37Choice securitiesTransactionType) {
	...
	public SettlementDetails142 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails142 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails142 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails142 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails142 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails142 setDeliveryReturnReason(DeliveryReturn3Choice deliveryReturnReason) {
	...
	public SettlementDetails142 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails142 setExposureType(ExposureType16Choice exposureType) {
	...
	public SettlementDetails142 setFXStandingInstruction(FXStandingInstruction4Choice fXStandingInstruction) {
	...
	public SettlementDetails142 setMarketClientSide(MarketClientSide6Choice marketClientSide) {
	...
	public SettlementDetails142 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails142 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails142 setRepurchaseType(RepurchaseType23Choice repurchaseType) {
	...
	public SettlementDetails142 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails142 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails142 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails142 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails142 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails142 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails142 setTracking(Tracking4Choice tracking) {
	...
	public SettlementDetails142 setAutomaticBorrowing(AutomaticBorrowing6Choice automaticBorrowing) {
	...
	public SettlementDetails142 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails142 setReturnLeg(YesNoIndicator returnLeg) {
	...
	public SettlementDetails142 setModificationCancellationAllowed(ModificationCancellationAllowed4Choice modificationCancellationAllowed) {
	...
	public SettlementDetails142 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
	...
	public SettlementDetails142 setDeliveringSecuritiesSubBalanceType(GenericIdentification30 deliveringSecuritiesSubBalanceType) {
	...
	public SettlementDetails142 setReceivingSecuritiesSubBalanceType(GenericIdentification30 receivingSecuritiesSubBalanceType) {
	...
	public SettlementDetails142 setCashSubBalanceType(GenericIdentification30 cashSubBalanceType) {
