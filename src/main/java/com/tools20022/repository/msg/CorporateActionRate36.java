...
public class CorporateActionRate36 {
	...
	public static final MMMessageAssociationEnd AdditionalTax = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateActionRate36.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.AdditionalTax);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GrossDividendRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.GrossDividendRate);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd NetDividendRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.NetDividendRate);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd IndexFactor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.IndexFactor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd InterestRateUsedForPayment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.InterestRateUsedForPayment);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd MaximumAllowedOversubscriptionRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.MaximumAllowedOversubscriptionRate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProrationRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.ProrationRate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateFormat6Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd WithholdingTaxRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.WithholdingTaxRate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateFormat6Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute WithholdingOfForeignTax = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.WithholdingOfForeignTax);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TaxRelatedRate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.TaxRelatedRate);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd TaxableIncomePerDividendShare = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.TaxableIncomePerDividendShare);
			minOccurs = 0;
	...
	public static final MMMessageAttribute IssuerDeclaredExchangeRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate44.IssuerDeclaredExchangeRate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate36.AdditionalTax, com.tools20022.repository.msg.CorporateActionRate36.GrossDividendRate,
						com.tools20022.repository.msg.CorporateActionRate36.NetDividendRate, com.tools20022.repository.msg.CorporateActionRate36.IndexFactor, com.tools20022.repository.msg.CorporateActionRate36.InterestRateUsedForPayment,
						com.tools20022.repository.msg.CorporateActionRate36.MaximumAllowedOversubscriptionRate, com.tools20022.repository.msg.CorporateActionRate36.ProrationRate,
						com.tools20022.repository.msg.CorporateActionRate36.WithholdingTaxRate, com.tools20022.repository.msg.CorporateActionRate36.WithholdingOfForeignTax,
						com.tools20022.repository.msg.CorporateActionRate36.TaxRelatedRate, com.tools20022.repository.msg.CorporateActionRate36.TaxableIncomePerDividendShare,
						com.tools20022.repository.msg.CorporateActionRate36.IssuerDeclaredExchangeRate);
