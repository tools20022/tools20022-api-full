 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Statement39
 * Statement39}</li>
 * </ul>
 */
...
public class Statement63 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement39#mmReportNumber
	...
	public static final MMMessageAttribute mmReportNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmReportNumber;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmQueryReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStatementIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmStatementDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmStatementDateTime;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement39#mmFrequency
	...
	public static final MMMessageAttribute mmFrequency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmFrequency;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement39#mmUpdateType
	...
	public static final MMMessageAssociationEnd mmUpdateType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmUpdateType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmActivityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement39.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> Statement39.mmObject();
			}
		});
