...
public class AcknowledgementReason2 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason2.mmCode, AcknowledgementReason2.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason3Choice code) {
		this.code = code;
	}
