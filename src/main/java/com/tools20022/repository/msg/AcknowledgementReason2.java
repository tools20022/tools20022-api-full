...
import com.tools20022.repository.choice.AcknowledgementReason3Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcknowledgementReason2#mmCode
...
@XmlType(name = "AcknowledgementReason2", propOrder = {"code", "additionalReasonInformation"})
public class AcknowledgementReason2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AcknowledgementReason3Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<AcknowledgementReason2, AcknowledgementReason3Choice> mmCode = new MMMessageAssociationEnd<AcknowledgementReason2, AcknowledgementReason3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason10.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<AcknowledgementReason2, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcknowledgementReason2, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason10.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcknowledgementReason2.mmCode, com.tools20022.repository.msg.AcknowledgementReason2.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason2";
				definition = "The status of an instruction, advice or request.";
				nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason10.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public AcknowledgementReason3Choice getCode() {
		return code;
	}

	public AcknowledgementReason2 setCode(AcknowledgementReason3Choice code) {
	...
	public AcknowledgementReason2 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
