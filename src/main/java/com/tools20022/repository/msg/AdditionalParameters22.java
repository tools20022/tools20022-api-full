...
public class AdditionalParameters22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters22.mmPreConfirmation, AdditionalParameters22.mmPartialSettlement, AdditionalParameters22.mmPreviousPartialConfirmationIdentification,
						AdditionalParameters22.mmTripartyAgentCollateralTransactionIdentification, AdditionalParameters22.mmClientTripartyCollateralTransactionIdentification,
						AdditionalParameters22.mmClientCollateralInstructionIdentification, AdditionalParameters22.mmTripartyCollateralInstructionIdentification);
