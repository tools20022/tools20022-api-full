...
public class SettlementInformation12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementInformation12.SettlementMethod, com.tools20022.repository.msg.SettlementInformation12.SettlementAccount,
						com.tools20022.repository.msg.SettlementInformation12.ClearingSystem);
