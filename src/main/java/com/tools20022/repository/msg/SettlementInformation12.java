...
public class SettlementInformation12 {
	...
	public static final MMMessageAttribute mmSettlementMethod = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementInformation12.mmObject();
			isDerived = false;
			xmlTag = "SttlmMtd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementInformation12.mmSettlementMethod, SettlementInformation12.mmSettlementAccount, SettlementInformation12.mmClearingSystem);
