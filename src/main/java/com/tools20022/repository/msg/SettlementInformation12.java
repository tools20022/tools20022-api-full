 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementMethod1Rule#forSettlementInformation12
 * ConstraintSettlementMethod1Rule.forSettlementInformation12}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementMethod2Rule#forSettlementInformation12
 * ConstraintSettlementMethod2Rule.forSettlementInformation12}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SettlementInformation12", propOrder = {"settlementMethod", "settlementAccount", "clearingSystem"})
public class SettlementInformation12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementInformation12, SettlementMethod2Code> mmSettlementMethod = new MMMessageAttribute<SettlementInformation12, SettlementMethod2Code>() {
		{
			businessElementTrace_lazy = () -> CashSettlement.mmSettlementMethod;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementInformation12.mmObject();
			isDerived = false;
			xmlTag = "SttlmMtd";
		...
		@Override
		public SettlementMethod2Code getValue(SettlementInformation12 obj) {
			return obj.getSettlementMethod();
		}

		@Override
		public void setValue(SettlementInformation12 obj, SettlementMethod2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation12, Optional<CashAccount10>> mmSettlementAccount = new MMMessageAssociationEnd<SettlementInformation12, Optional<CashAccount10>>() {
		{
		...
		@Override
		public Optional<CashAccount10> getValue(SettlementInformation12 obj) {
			return obj.getSettlementAccount();
		}

		@Override
		public void setValue(SettlementInformation12 obj, Optional<CashAccount10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation12, Optional<ClearingSystemIdentification1Choice>> mmClearingSystem = new MMMessageAssociationEnd<SettlementInformation12, Optional<ClearingSystemIdentification1Choice>>() {
		{
		...
		@Override
		public Optional<ClearingSystemIdentification1Choice> getValue(SettlementInformation12 obj) {
			return obj.getClearingSystem();
		}

		@Override
		public void setValue(SettlementInformation12 obj, Optional<ClearingSystemIdentification1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementInformation12.mmSettlementMethod, com.tools20022.repository.msg.SettlementInformation12.mmSettlementAccount,
						com.tools20022.repository.msg.SettlementInformation12.mmClearingSystem);
				trace_lazy = () -> CashSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementMethod1Rule.forSettlementInformation12,
						com.tools20022.repository.constraints.ConstraintSettlementMethod2Rule.forSettlementInformation12);
				registrationStatus = MMRegistrationStatus.OBSOLETE;
				name = "SettlementInformation12";
	...
	public SettlementInformation12 setSettlementMethod(SettlementMethod2Code settlementMethod) {
	...
	public SettlementInformation12 setSettlementAccount(CashAccount10 settlementAccount) {
	...
	public SettlementInformation12 setClearingSystem(ClearingSystemIdentification1Choice clearingSystem) {
