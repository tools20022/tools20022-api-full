...
public class AcceptorAuthorisationRequest4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorAuthorisationRequest4.mmEnvironment, AcceptorAuthorisationRequest4.mmContext, AcceptorAuthorisationRequest4.mmTransaction, AcceptorAuthorisationRequest4.mmSupplementaryData);
