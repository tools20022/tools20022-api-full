...
public class AccountIdentification23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification23.mmSafekeepingAccount, AccountIdentification23.mmAccountOwner, AccountIdentification23.mmSafekeepingPlace,
						AccountIdentification23.mmCorporateActionEventAndBalance);
	...
	public void setCorporateActionEventAndBalance(List<com.tools20022.repository.msg.CorporateActionEventAndBalance5> corporateActionEventAndBalance) {
