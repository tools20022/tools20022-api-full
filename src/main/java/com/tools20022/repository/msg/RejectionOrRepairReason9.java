...
public class RejectionOrRepairReason9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason9.mmCode, RejectionOrRepairReason9.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason9Choice code) {
		this.code = code;
	}
