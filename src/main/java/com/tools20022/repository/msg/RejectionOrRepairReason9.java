...
public class RejectionOrRepairReason9 {
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RejectionOrRepairReason9.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason9.Code, com.tools20022.repository.msg.RejectionOrRepairReason9.AdditionalReasonInformation);
