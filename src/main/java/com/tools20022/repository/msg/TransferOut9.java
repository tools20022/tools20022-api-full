...
public class TransferOut9 {
	...
	public static final MMMessageAttribute mmRequestedTransferDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut11.mmRequestedTransferDate);
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> DateFormat1Choice.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.Transfer20> transferDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmTransferDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Transfer20.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut11.mmAccountDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut11.mmSettlementDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmExtension = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut11.mmExtension);
			minOccurs = 0;
			isComposite = true;
	...
	public void setTransferDetails(List<com.tools20022.repository.msg.Transfer20> transferDetails) {
	...
	public void setSettlementDetails(com.tools20022.repository.msg.ReceiveInformation9 settlementDetails) {
