...
public class TransferOut9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferOut9.mmRequestedTransferDate, TransferOut9.mmTransferDetails, TransferOut9.mmAccountDetails, TransferOut9.mmSettlementDetails, TransferOut9.mmExtension);
