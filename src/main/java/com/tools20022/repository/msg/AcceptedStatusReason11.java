...
public class AcceptedStatusReason11 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcceptedStatusReason11.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatusReason11.mmReasonCode, AcceptedStatusReason11.mmAdditionalReasonInformation);
	...
	public void setReasonCode(AcceptedReason12Choice reasonCode) {
