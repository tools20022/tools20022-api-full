...
public class CorporateActionEventAndBalance3 {
	...
	public static final MMMessageAssociationEnd mmGeneralInformation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventAndBalance3.mmObject();
			isDerived = false;
			xmlTag = "GnlInf";
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.UnderlyingSecurity3.mmObject();
		}
	};
	...
	public void setUnderlyingSecurity(com.tools20022.repository.msg.UnderlyingSecurity3 underlyingSecurity) {
