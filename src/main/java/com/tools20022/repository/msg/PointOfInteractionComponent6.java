...
public class PointOfInteractionComponent6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PointOfInteractionComponent6.mmType, PointOfInteractionComponent6.mmIdentification, PointOfInteractionComponent6.mmStatus, PointOfInteractionComponent6.mmStandardCompliance,
						PointOfInteractionComponent6.mmCharacteristics, PointOfInteractionComponent6.mmAssessment);
