...
public class RejectionReason15 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason15.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason15.mmCode, RejectionReason15.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason13Choice code) {
		this.code = code;
	}
