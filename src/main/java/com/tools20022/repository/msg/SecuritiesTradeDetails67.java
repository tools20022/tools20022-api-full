 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails67#mmAcknowledgedStatusTimeStamp
 * SecuritiesTradeDetails67.mmAcknowledgedStatusTimeStamp}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails67#mmMatchedStatusTimeStamp
 * SecuritiesTradeDetails67.mmMatchedStatusTimeStamp}</li>
 * <li>
 ...
 * SecuritiesTradeDetails67.mmSettlementInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SecuritiesTradeDetails67", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "placeOfTrade", "placeOfClearing", "tradeDate", "settlementDate", "lateDeliveryDate", "acknowledgedStatusTimeStamp",
...
public class SecuritiesTradeDetails67 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails67, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmTradeIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails67, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmCollateralTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmPlaceOfTrade);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<PlaceOfTradeIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmPlaceOfClearing);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfClearingIdentification1> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<PlaceOfClearingIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<TradeDate5Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<TradeDate5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmTradeDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate5Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<TradeDate5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails67, SettlementDate9Choice> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails67, SettlementDate9Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate9Choice getValue(SecuritiesTradeDetails67 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, SettlementDate9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmLateDeliveryDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmLateDeliveryDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getLateDeliveryDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails75#mmAcknowledgedStatusTimeStamp
	 * SecuritiesTradeDetails75.mmAcknowledgedStatusTimeStamp}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<ISODateTime>> mmAcknowledgedStatusTimeStamp = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<ISODateTime>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmAcknowledgedStatusTimeStamp);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getAcknowledgedStatusTimeStamp();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<ISODateTime> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails75#mmMatchedStatusTimeStamp
	 * SecuritiesTradeDetails75.mmMatchedStatusTimeStamp}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<ISODateTime>> mmMatchedStatusTimeStamp = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<ISODateTime>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmMatchedStatusTimeStamp);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODateTime.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails67, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmDealPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<OpeningClosing3Choice>> mmOpeningClosing = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<OpeningClosing3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmOpeningClosing);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmOpeningClosing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OpeningClosing3Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getOpeningClosing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<OpeningClosing3Choice> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails75#mmReporting
	 * SecuritiesTradeDetails75.mmReporting}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, List<Reporting6Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails67, List<Reporting6Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmReporting);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmReporting;
			minOccurs = 0;
			complexType_lazy = () -> Reporting6Choice.mmObject();
		}

		@Override
		public List<Reporting6Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, List<Reporting6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, List<TradeTransactionCondition5Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails67, List<TradeTransactionCondition5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmTradeTransactionCondition);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmTradeTransactionCondition;
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition5Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition5Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, List<TradeTransactionCondition5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<InvestorCapacity4Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<InvestorCapacity4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmInvestorCapacity);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmInvestorCapacity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity4Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<InvestorCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<TradeOriginator3Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<TradeOriginator3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmTradeOriginatorRole);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmTradeOriginatorRole;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator3Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<TradeOriginator3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<TypeOfPrice29Choice>> mmTypeOfPrice = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<TypeOfPrice29Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmTypeOfPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfPrice29Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<TypeOfPrice29Choice> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails75#mmCurrencyToBuyOrSell
	 * SecuritiesTradeDetails75.mmCurrencyToBuyOrSell}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<CurrencyToBuyOrSell1Choice>> mmCurrencyToBuyOrSell = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<CurrencyToBuyOrSell1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmCurrencyToBuyOrSell);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmCurrencyToBuyOrSell;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyToBuyOrSell1Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getCurrencyToBuyOrSell();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<CurrencyToBuyOrSell1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<MatchingStatus27Choice>> mmMatchingStatus = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<MatchingStatus27Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmMatchingStatus);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmMatchingStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<MatchingStatus27Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getMatchingStatus();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<MatchingStatus27Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<AffirmationStatus8Choice>> mmAffirmationStatus = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<AffirmationStatus8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmAffirmationStatus);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmAffirmationStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AffirmationStatus8Choice> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getAffirmationStatus();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<AffirmationStatus8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmFXAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmFXAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails67 obj) {
			return obj.getFXAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails67 obj, Optional<Max350Text> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SecuritiesTradeDetails75#mmSettlementInstructionProcessingAdditionalDetails
	 * SecuritiesTradeDetails75.
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails67, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails51.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails67.mmTradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmCollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmPlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmTradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmSettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmLateDeliveryDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmAcknowledgedStatusTimeStamp, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmMatchedStatusTimeStamp,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmDealPrice, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmNumberOfDaysAccrued,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmOpeningClosing, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmReporting,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmTradeTransactionCondition, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmInvestorCapacity,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmTradeOriginatorRole, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmTypeOfPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmCurrencyToBuyOrSell, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmMatchingStatus,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmAffirmationStatus, com.tools20022.repository.msg.SecuritiesTradeDetails67.mmFXAdditionalDetails,
						com.tools20022.repository.msg.SecuritiesTradeDetails67.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionGenerationNotificationV07.mmTradeDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCurrencyToBuyOrSellRule.forSecuritiesTradeDetails67,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails67, com.tools20022.repository.constraints.ConstraintLateDeliveryDateRule.forSecuritiesTradeDetails67,
						com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails67, com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails67,
						com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails67, com.tools20022.repository.constraints.ConstraintTradeDateGuideline.forSecuritiesTradeDetails67);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTradeDetails67";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails75.mmObject());
				previousVersion_lazy = () -> SecuritiesTradeDetails51.mmObject();
			}
		});
	...
	public SecuritiesTradeDetails67 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails67 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails67 setPlaceOfTrade(PlaceOfTradeIdentification1 placeOfTrade) {
	...
	public SecuritiesTradeDetails67 setPlaceOfClearing(PlaceOfClearingIdentification1 placeOfClearing) {
	...
	public SecuritiesTradeDetails67 setTradeDate(TradeDate5Choice tradeDate) {
	...
	public SecuritiesTradeDetails67 setSettlementDate(SettlementDate9Choice settlementDate) {
	...
	public SecuritiesTradeDetails67 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public SecuritiesTradeDetails67 setAcknowledgedStatusTimeStamp(ISODateTime acknowledgedStatusTimeStamp) {
	...
	public SecuritiesTradeDetails67 setMatchedStatusTimeStamp(ISODateTime matchedStatusTimeStamp) {
	...
	public SecuritiesTradeDetails67 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails67 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails67 setOpeningClosing(OpeningClosing3Choice openingClosing) {
	...
	public SecuritiesTradeDetails67 setReporting(List<Reporting6Choice> reporting) {
	...
	public SecuritiesTradeDetails67 setTradeTransactionCondition(List<TradeTransactionCondition5Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails67 setInvestorCapacity(InvestorCapacity4Choice investorCapacity) {
	...
	public SecuritiesTradeDetails67 setTradeOriginatorRole(TradeOriginator3Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails67 setTypeOfPrice(TypeOfPrice29Choice typeOfPrice) {
	...
	public SecuritiesTradeDetails67 setCurrencyToBuyOrSell(CurrencyToBuyOrSell1Choice currencyToBuyOrSell) {
	...
	public SecuritiesTradeDetails67 setMatchingStatus(MatchingStatus27Choice matchingStatus) {
	...
	public SecuritiesTradeDetails67 setAffirmationStatus(AffirmationStatus8Choice affirmationStatus) {
	...
	public SecuritiesTradeDetails67 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
	...
	public SecuritiesTradeDetails67 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
