...
public class ForeignExchangeTerms24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms24.mmUnitCurrency, ForeignExchangeTerms24.mmQuotedCurrency, ForeignExchangeTerms24.mmExchangeRate, ForeignExchangeTerms24.mmResultingAmount);
