...
@XmlType(name = "ForeignExchangeTerms24", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "resultingAmount"})
public class ForeignExchangeTerms24 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms24
	 * ForeignExchangeTerms24}</li>
	...
	public static final MMMessageAttribute<ForeignExchangeTerms24, ActiveCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms24, ActiveCurrencyCode>() {
		{
			...
			previousVersion_lazy = () -> ForeignExchangeTerms13.mmUnitCurrency;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<ForeignExchangeTerms24, ActiveCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms24, ActiveCurrencyCode>() {
		{
			...
			previousVersion_lazy = () -> ForeignExchangeTerms13.mmQuotedCurrency;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> ActiveCurrencyCode.mmObject();
		}
	...
	public static final MMMessageAttribute<ForeignExchangeTerms24, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms24, BaseOneRate>() {
		{
			...
			previousVersion_lazy = () -> ForeignExchangeTerms13.mmExchangeRate;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<ForeignExchangeTerms24, Optional<ActiveCurrencyAndAmount>> mmResultingAmount = new MMMessageAttribute<ForeignExchangeTerms24, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> ForeignExchangeTerms13.mmResultingAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms24.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms24.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms24.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms24.mmResultingAmount);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms24";
				definition = "Provides information about the terms of the foreign exchange transaction.";
				previousVersion_lazy = () -> ForeignExchangeTerms13.mmObject();
			}
		});
	...
	public ForeignExchangeTerms24 setUnitCurrency(ActiveCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms24 setQuotedCurrency(ActiveCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms24 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms24 setResultingAmount(ActiveCurrencyAndAmount resultingAmount) {
