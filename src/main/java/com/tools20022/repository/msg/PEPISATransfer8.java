...
public class PEPISATransfer8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer8, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<PEPISATransfer8, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(PEPISATransfer8 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer8, Max35Text> mmTransferIdentification = new MMMessageAttribute<PEPISATransfer8, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer8.mmObject();
			isDerived = false;
			xmlTag = "TrfId";
		...
		@Override
		public Max35Text getValue(PEPISATransfer8 obj) {
			return obj.getTransferIdentification();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer8, Optional<Max35Text>> mmCancellationReference = new MMMessageAttribute<PEPISATransfer8, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer8.mmObject();
			isDerived = false;
			xmlTag = "CxlRef";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PEPISATransfer8, YesNoIndicator> mmResidualCashIndicator = new MMMessageAttribute<PEPISATransfer8, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer8.mmObject();
			isDerived = false;
			xmlTag = "RsdlCshInd";
		...
		@Override
		public YesNoIndicator getValue(PEPISATransfer8 obj) {
			return obj.getResidualCashIndicator();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer8, ISAYearsOfIssue1> mmISA = new MMMessageAssociationEnd<PEPISATransfer8, ISAYearsOfIssue1>() {
		{
		...
		@Override
		public ISAYearsOfIssue1 getValue(PEPISATransfer8 obj) {
			return obj.getISA();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, ISAYearsOfIssue1 value) {
			obj.setISA(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer8, PreviousYearChoice> mmPEP = new MMMessageAssociationEnd<PEPISATransfer8, PreviousYearChoice>() {
		{
			businessComponentTrace_lazy = () -> PortfolioTransfer.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PEPISATransfer8.mmObject();
			isDerived = false;
		...
		@Override
		public PreviousYearChoice getValue(PEPISATransfer8 obj) {
			return obj.getPEP();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, PreviousYearChoice value) {
			obj.setPEP(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer8, Portfolio1> mmPortfolio = new MMMessageAssociationEnd<PEPISATransfer8, Portfolio1>() {
		{
		...
		@Override
		public Portfolio1 getValue(PEPISATransfer8 obj) {
			return obj.getPortfolio();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, Portfolio1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PEPISATransfer8, List<FinancialInstrument11>> mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd<PEPISATransfer8, List<FinancialInstrument11>>() {
		{
		...
		@Override
		public List<FinancialInstrument11> getValue(PEPISATransfer8 obj) {
			return obj.getFinancialInstrumentAssetForTransfer();
		}

		@Override
		public void setValue(PEPISATransfer8 obj, List<FinancialInstrument11> value) {
	...
	public PEPISATransfer8 setISA(ISAYearsOfIssue1 iSA) {
	...
	public PEPISATransfer8 setPortfolio(Portfolio1 portfolio) {
	...
	public PEPISATransfer8 setFinancialInstrumentAssetForTransfer(List<FinancialInstrument11> financialInstrumentAssetForTransfer) {
