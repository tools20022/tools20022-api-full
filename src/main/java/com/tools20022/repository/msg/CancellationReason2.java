...
import com.tools20022.repository.choice.CancellationReason3Choice;
...
@XmlType(name = "CancellationReason2", propOrder = {"code", "additionalReasonInformation"})
public class CancellationReason2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CancellationReason3Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CancellationReason2
	 * CancellationReason2}</li>
	...
	public static final MMMessageAssociationEnd<CancellationReason2, CancellationReason3Choice> mmCode = new MMMessageAssociationEnd<CancellationReason2, CancellationReason3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason10.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<CancellationReason2, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancellationReason2, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason10.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationReason2.mmCode, com.tools20022.repository.msg.CancellationReason2.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationReason2";
				definition = "The status of an instruction, advice or request.";
				nextVersions_lazy = () -> Arrays.asList(CancellationReason10.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public CancellationReason3Choice getCode() {
		return code;
	}

	public CancellationReason2 setCode(CancellationReason3Choice code) {
	...
	public CancellationReason2 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
