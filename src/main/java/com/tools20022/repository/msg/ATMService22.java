	...
	public static final MMMessageAttribute mmServiceReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService23.mmServiceReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService15.mmServiceReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmATMServiceCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService23.mmATMServiceCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService15.mmATMServiceCode;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmServiceType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService23.mmServiceType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService15.mmServiceType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmServiceVariantIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService23.mmServiceVariantIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService15.mmServiceVariantIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	};
