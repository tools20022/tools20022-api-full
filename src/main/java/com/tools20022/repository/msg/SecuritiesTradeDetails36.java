...
@XmlType(name = "SecuritiesTradeDetails36", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "accountOwnerTransactionIdentification", "processorTransactionIdentification", "placeOfTrade", "placeOfClearing",
...
public class SecuritiesTradeDetails36 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails36.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmTradeIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmCollateralTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails36, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmAccountOwnerTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails36, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmProcessorTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getProcessorTransactionIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<MarketIdentification78>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<MarketIdentification78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmPlaceOfTrade);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification78> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<MarketIdentification78> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails36, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmPlaceOfClearing);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmTradeDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, SettlementDate1Choice> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails36, SettlementDate1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate1Choice getValue(SecuritiesTradeDetails36 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, SettlementDate1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmDealPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails36, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails36, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, List<TradeTransactionCondition1Choice>> mmTradeTransactionCondition = new MMMessageAssociationEnd<SecuritiesTradeDetails36, List<TradeTransactionCondition1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmTradeTransactionCondition);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmTradeTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<TradeTransactionCondition1Choice> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, List<TradeTransactionCondition1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails36, Optional<TypeOfPrice3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmTypeOfPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails18.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(SecuritiesTradeDetails36 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails36 obj, Optional<TypeOfPrice3Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails36.mmTradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmCollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails36.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails36.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmPlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmTradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails36.mmSettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmDealPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails36.mmNumberOfDaysAccrued, com.tools20022.repository.msg.SecuritiesTradeDetails36.mmTradeTransactionCondition,
						com.tools20022.repository.msg.SecuritiesTradeDetails36.mmTypeOfPrice);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAllegementNotificationV04.mmTradeDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails36,
						com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails36, com.tools20022.repository.constraints.ConstraintLateDeliveryDateRule.forSecuritiesTradeDetails36,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forSecuritiesTradeDetails36);
				...
				name = "SecuritiesTradeDetails36";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails54.mmObject());
				previousVersion_lazy = () -> SecuritiesTradeDetails18.mmObject();
			}
		});
	...
	public SecuritiesTradeDetails36 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails36 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails36 setAccountOwnerTransactionIdentification(List<Max35Text> accountOwnerTransactionIdentification) {
	...
	public SecuritiesTradeDetails36 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public SecuritiesTradeDetails36 setPlaceOfTrade(MarketIdentification78 placeOfTrade) {
	...
	public SecuritiesTradeDetails36 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public SecuritiesTradeDetails36 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public SecuritiesTradeDetails36 setSettlementDate(SettlementDate1Choice settlementDate) {
	...
	public SecuritiesTradeDetails36 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails36 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails36 setTradeTransactionCondition(List<TradeTransactionCondition1Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails36 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
