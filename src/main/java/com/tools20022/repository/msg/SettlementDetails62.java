 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails62#Priority
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails62#BlockTrade
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails62#Tracking
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.SecuritiesFinancingInstructionV03#SettlementParameters
 * SecuritiesFinancingInstructionV03.SettlementParameters}</li>
 * <li>
...
public class SettlementDetails62 {
	...
	public static final MMMessageAttribute HoldIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.HoldIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Priority = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.Priority);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.SettlementTransactionCondition);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd SettlingCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.SettlingCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StampDutyTaxBasis = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.StampDutyTaxBasis);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesRTGS = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.SecuritiesRTGS);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BeneficialOwnership = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.BeneficialOwnership);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashClearingSystem = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.CashClearingSystem);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TaxCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.TaxCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MarketClientSide = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.MarketClientSide);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FXStandingInstruction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.FXStandingInstruction);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BlockTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.BlockTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LegalRestrictions = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.LegalRestrictions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementSystemMethod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.SettlementSystemMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd NettingEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.NettingEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CCPEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.CCPEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Tracking = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.Tracking);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AutomaticBorrowing = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.AutomaticBorrowing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlementIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.PartialSettlementIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EligibleForCollateral = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.EligibleForCollateral);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails62.HoldIndicator, com.tools20022.repository.msg.SettlementDetails62.Priority,
						com.tools20022.repository.msg.SettlementDetails62.SettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails62.SettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails62.StampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails62.SecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails62.BeneficialOwnership,
						com.tools20022.repository.msg.SettlementDetails62.CashClearingSystem, com.tools20022.repository.msg.SettlementDetails62.TaxCapacity, com.tools20022.repository.msg.SettlementDetails62.MarketClientSide,
						com.tools20022.repository.msg.SettlementDetails62.FXStandingInstruction, com.tools20022.repository.msg.SettlementDetails62.BlockTrade, com.tools20022.repository.msg.SettlementDetails62.LegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails62.SettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails62.NettingEligibility, com.tools20022.repository.msg.SettlementDetails62.CCPEligibility,
						com.tools20022.repository.msg.SettlementDetails62.Tracking, com.tools20022.repository.msg.SettlementDetails62.AutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails62.PartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails62.EligibleForCollateral);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesFinancingInstructionV03.SettlementParameters,
						com.tools20022.repository.area.sese.SecuritiesFinancingInstructionV04.SettlementParameters, com.tools20022.repository.area.sese.SecuritiesFinancingModificationInstructionV03.SettlementParameters);
