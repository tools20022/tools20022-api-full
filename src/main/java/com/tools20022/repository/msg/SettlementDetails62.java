 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails62#mmPriority
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails62#mmTracking
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails72
...
@XmlType(name = "SettlementDetails62", propOrder = {"holdIndicator", "priority", "settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "beneficialOwnership", "cashClearingSystem", "taxCapacity",
...
public class SettlementDetails62 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails62, Optional<YesNoIndicator>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails62, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails62.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmHoldIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails62 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<PriorityNumeric1Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails62, Optional<PriorityNumeric1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmPriority);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric1Choice> getValue(SettlementDetails62 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<PriorityNumeric1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, List<SettlementTransactionCondition7Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails62, List<SettlementTransactionCondition7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmSettlementTransactionCondition);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition7Choice> getValue(SettlementDetails62 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails62 obj, List<SettlementTransactionCondition7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<SettlingCapacity1Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails62, Optional<SettlingCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmSettlingCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity1Choice> getValue(SettlementDetails62 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<SettlingCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails62, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmStampDutyTaxBasis);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails62 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails62, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmSecuritiesRTGS);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails62 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails62, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmBeneficialOwnership);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails62 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails62, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmCashClearingSystem);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails62 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails62, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmTaxCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails62 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails62, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmMarketClientSide);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails62 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<FXStandingInstruction1Choice>> mmFXStandingInstruction = new MMMessageAssociationEnd<SettlementDetails62, Optional<FXStandingInstruction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmFXStandingInstruction);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FXStandingInstruction1Choice> getValue(SettlementDetails62 obj) {
			return obj.getFXStandingInstruction();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<FXStandingInstruction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails62, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmBlockTrade);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails62 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails62, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmLegalRestrictions);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails62 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails62, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmSettlementSystemMethod);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails62 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails62, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmNettingEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails62 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails62, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmCCPEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails62 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<Tracking1Choice>> mmTracking = new MMMessageAssociationEnd<SettlementDetails62, Optional<Tracking1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmTracking);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Tracking1Choice> getValue(SettlementDetails62 obj) {
			return obj.getTracking();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<Tracking1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails62, Optional<AutomaticBorrowing1Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails62, Optional<AutomaticBorrowing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmAutomaticBorrowing);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing1Choice> getValue(SettlementDetails62 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<AutomaticBorrowing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails62, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails62, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails62.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmPartialSettlementIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails62 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails62 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails62, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails62, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmEligibleForCollateral);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails62.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails62.mmPriority,
						com.tools20022.repository.msg.SettlementDetails62.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails62.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails62.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails62.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails62.mmBeneficialOwnership,
						com.tools20022.repository.msg.SettlementDetails62.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails62.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails62.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails62.mmFXStandingInstruction, com.tools20022.repository.msg.SettlementDetails62.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails62.mmLegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails62.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails62.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails62.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails62.mmTracking, com.tools20022.repository.msg.SettlementDetails62.mmAutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails62.mmPartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails62.mmEligibleForCollateral);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV03.mmSettlementParameters, SecuritiesFinancingInstructionV04.mmSettlementParameters,
						SecuritiesFinancingModificationInstructionV03.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails62,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails62, com.tools20022.repository.constraints.ConstraintFXStandingInstructionPresenceRule.forSettlementDetails62);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails62";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails72.mmObject());
				previousVersion_lazy = () -> SettlementDetails31.mmObject();
			}
		});
	...
	public SettlementDetails62 setHoldIndicator(YesNoIndicator holdIndicator) {
	...
	public SettlementDetails62 setPriority(PriorityNumeric1Choice priority) {
	...
	public SettlementDetails62 setSettlementTransactionCondition(List<SettlementTransactionCondition7Choice> settlementTransactionCondition) {
	...
	public SettlementDetails62 setSettlingCapacity(SettlingCapacity1Choice settlingCapacity) {
	...
	public SettlementDetails62 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails62 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails62 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails62 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails62 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails62 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails62 setFXStandingInstruction(FXStandingInstruction1Choice fXStandingInstruction) {
	...
	public SettlementDetails62 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails62 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails62 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails62 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails62 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails62 setTracking(Tracking1Choice tracking) {
	...
	public SettlementDetails62 setAutomaticBorrowing(AutomaticBorrowing1Choice automaticBorrowing) {
	...
	public SettlementDetails62 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails62 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
