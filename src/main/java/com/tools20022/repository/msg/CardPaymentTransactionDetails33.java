...
@XmlType(name = "CardPaymentTransactionDetails33", propOrder = {"currency", "totalAmount", "amountQualifier", "detailedAmount", "iCCRelatedData"})
public class CardPaymentTransactionDetails33 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails33, CurrencyCode> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails33, CurrencyCode>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmCurrency);
			previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmCurrency;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CurrencyCode getValue(CardPaymentTransactionDetails33 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails33 obj, CurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails33, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails33, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmTotalAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails33 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails33 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails33, Optional<TypeOfAmount1Code>> mmAmountQualifier = new MMMessageAttribute<CardPaymentTransactionDetails33, Optional<TypeOfAmount1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmAmountQualifier);
			previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmAmountQualifier;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfAmount1Code> getValue(CardPaymentTransactionDetails33 obj) {
			return obj.getAmountQualifier();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails33 obj, Optional<TypeOfAmount1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails33, Optional<DetailedAmount15>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails33, Optional<DetailedAmount15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmDetailedAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DetailedAmount15> getValue(CardPaymentTransactionDetails33 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails33 obj, Optional<DetailedAmount15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails33, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails33, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmICCRelatedData);
			previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails33 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails33 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmAmountQualifier, com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmDetailedAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails33.mmICCRelatedData);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransactionDetails33";
				definition = "Details of the payment transaction.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails40.mmObject());
				previousVersion_lazy = () -> CardPaymentTransactionDetails26.mmObject();
			}
		});
	...
	public CardPaymentTransactionDetails33 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails33 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails33 setAmountQualifier(TypeOfAmount1Code amountQualifier) {
	...
	public CardPaymentTransactionDetails33 setDetailedAmount(DetailedAmount15 detailedAmount) {
	...
	public CardPaymentTransactionDetails33 setICCRelatedData(Max10000Binary iCCRelatedData) {
