...
public class QuantityAndAccount4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount4.mmSettlementQuantity, QuantityAndAccount4.mmDenominationChoice, QuantityAndAccount4.mmCertificateNumber, QuantityAndAccount4.mmAccountOwner,
						QuantityAndAccount4.mmSafekeepingAccount, QuantityAndAccount4.mmCashAccount, QuantityAndAccount4.mmQuantityBreakdown, QuantityAndAccount4.mmSafekeepingPlace);
