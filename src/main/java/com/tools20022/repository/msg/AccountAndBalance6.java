...
public class AccountAndBalance6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance6.mmSafekeepingAccount, AccountAndBalance6.mmAccountOwner, AccountAndBalance6.mmSafekeepingPlace, AccountAndBalance6.mmBalance);
