...
public class SettlementDetails2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails2.mmSettlementTransactionCondition, SettlementDetails2.mmSettlingCapacity, SettlementDetails2.mmStampDutyTaxBasis, SettlementDetails2.mmSecuritiesRTGS,
						SettlementDetails2.mmRegistration, SettlementDetails2.mmBeneficialOwnership, SettlementDetails2.mmCashClearingSystem, SettlementDetails2.mmTaxCapacity, SettlementDetails2.mmRepurchaseType,
						SettlementDetails2.mmMarketClientSide, SettlementDetails2.mmBlockTrade, SettlementDetails2.mmLegalRestrictions, SettlementDetails2.mmSettlementSystemMethod, SettlementDetails2.mmNettingEligibility,
						SettlementDetails2.mmCCPEligibility, SettlementDetails2.mmLetterOfGuarantee, SettlementDetails2.mmPartialSettlementIndicator);
