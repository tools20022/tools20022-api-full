...
public class TradeLeg5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TradeLeg5.mmTradeLegIdentification, TradeLeg5.mmTradeIdentification, TradeLeg5.mmTradeExecutionIdentification, TradeLeg5.mmStatus, TradeLeg5.mmTradeDate, TradeLeg5.mmSettlementDate,
						TradeLeg5.mmFinancialInstrumentIdentification, TradeLeg5.mmTradingCurrency, TradeLeg5.mmBuySellIndicator, TradeLeg5.mmTradeQuantity, TradeLeg5.mmDealPrice, TradeLeg5.mmAccruedInterestAmount,
						TradeLeg5.mmPlaceOfTrade, TradeLeg5.mmPlaceOfListing, TradeLeg5.mmTradeType, TradeLeg5.mmDerivativeRelatedTrade, TradeLeg5.mmTradingParty, TradeLeg5.mmTradingPartyAccount, TradeLeg5.mmTradingCapacity,
						TradeLeg5.mmTradePostingCode);
