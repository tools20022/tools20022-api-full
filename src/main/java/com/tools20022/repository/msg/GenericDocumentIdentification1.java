 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forGenericDocumentIdentification1
 * ConstraintCoexistenceIdentificationRule.forGenericDocumentIdentification1}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.GenericDocumentIdentification4
...
@XmlType(name = "GenericDocumentIdentification1", propOrder = {"messageNumber", "identification"})
public class GenericDocumentIdentification1 {
	...
	public static final MMMessageAttribute mmMessageNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericDocumentIdentification4.mmMessageNumber);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericDocumentIdentification4.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericDocumentIdentification1.mmMessageNumber, com.tools20022.repository.msg.GenericDocumentIdentification1.mmIdentification);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forGenericDocumentIdentification1);
				...
				name = "GenericDocumentIdentification1";
				definition = "Generic identification scheme for a document.";
				nextVersions_lazy = () -> Arrays.asList(GenericDocumentIdentification4.mmObject());
			}
		});
	...
	public GenericDocumentIdentification1 setMessageNumber(DocumentNumber1Choice messageNumber) {
	...
	public GenericDocumentIdentification1 setIdentification(Max35Text identification) {
