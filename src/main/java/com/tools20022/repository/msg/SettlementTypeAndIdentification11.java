...
public class SettlementTypeAndIdentification11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification11.mmAccountOwnerTransactionIdentification, SettlementTypeAndIdentification11.mmAccountServicerTransactionIdentification,
						SettlementTypeAndIdentification11.mmMarketInfrastructureTransactionIdentification, SettlementTypeAndIdentification11.mmProcessorTransactionIdentification, SettlementTypeAndIdentification11.mmSecuritiesMovementType,
						SettlementTypeAndIdentification11.mmPayment, SettlementTypeAndIdentification11.mmCommonIdentification, SettlementTypeAndIdentification11.mmPoolIdentification,
						SettlementTypeAndIdentification11.mmCorporateActionEventIdentification);
