 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails44#BlockTrade
...
public class SettlementDetails44 {
	...
	public static final MMMessageAssociationEnd HoldIndicator = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.HoldIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.SettlementTransactionCondition);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd SecuritiesTransactionType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.SecuritiesTransactionType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlingCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.SettlingCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StampDutyTaxBasis = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.StampDutyTaxBasis);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesRTGS = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.SecuritiesRTGS);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Registration = new MMMessageAssociationEnd() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.Registration);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BeneficialOwnership = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.BeneficialOwnership);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ExposureType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.ExposureType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashClearingSystem = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.CashClearingSystem);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TaxCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.TaxCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RepurchaseType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.RepurchaseType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MarketClientSide = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.MarketClientSide);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BlockTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.BlockTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LegalRestrictions = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.LegalRestrictions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementSystemMethod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.SettlementSystemMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd NettingEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.NettingEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CCPEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.CCPEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LetterOfGuarantee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.LetterOfGuarantee);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlementIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.PartialSettlementIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EligibleForCollateral = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails69.EligibleForCollateral);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails44.HoldIndicator, com.tools20022.repository.msg.SettlementDetails44.SettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails44.SecuritiesTransactionType, com.tools20022.repository.msg.SettlementDetails44.SettlingCapacity, com.tools20022.repository.msg.SettlementDetails44.StampDutyTaxBasis,
						com.tools20022.repository.msg.SettlementDetails44.SecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails44.Registration, com.tools20022.repository.msg.SettlementDetails44.BeneficialOwnership,
						com.tools20022.repository.msg.SettlementDetails44.ExposureType, com.tools20022.repository.msg.SettlementDetails44.CashClearingSystem, com.tools20022.repository.msg.SettlementDetails44.TaxCapacity,
						com.tools20022.repository.msg.SettlementDetails44.RepurchaseType, com.tools20022.repository.msg.SettlementDetails44.MarketClientSide, com.tools20022.repository.msg.SettlementDetails44.BlockTrade,
						com.tools20022.repository.msg.SettlementDetails44.LegalRestrictions, com.tools20022.repository.msg.SettlementDetails44.SettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails44.NettingEligibility,
						com.tools20022.repository.msg.SettlementDetails44.CCPEligibility, com.tools20022.repository.msg.SettlementDetails44.LetterOfGuarantee, com.tools20022.repository.msg.SettlementDetails44.PartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails44.EligibleForCollateral);
