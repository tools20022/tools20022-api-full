...
public class PendingReason21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingReason21.Code, com.tools20022.repository.msg.PendingReason21.AdditionalReasonInformation);
