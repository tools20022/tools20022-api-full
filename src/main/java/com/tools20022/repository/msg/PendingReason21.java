...
public class PendingReason21 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingReason21.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingReason21.mmCode, PendingReason21.mmAdditionalReasonInformation);
	...
	public void setCode(PendingReason38Choice code) {
		this.code = code;
	}
