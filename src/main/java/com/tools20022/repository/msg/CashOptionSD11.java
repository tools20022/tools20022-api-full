 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD11#mmPlaceAndName
 * CashOptionSD11.mmPlaceAndName}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD11#mmPayoutType
 * CashOptionSD11.mmPayoutType}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD11#mmDTCPayMethod
 * CashOptionSD11.mmDTCPayMethod}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CashOptionSD11#mmDTCPayOrder
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CashOptionSD10
 * CashOptionSD10}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CashOptionSD11", propOrder = {"placeAndName", "payoutType", "dTCPayMethod", "dTCPayOrder", "entitlementCalculationMethod", "estimatedRateFlag", "nRATaxReportableFlag", "protectChargeFlag", "declaredCashRate",
...
public class CashOptionSD11 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CashOptionSD11 CashOptionSD11}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<Max350Text>> mmPlaceAndName = new MMMessageAttribute<CashOptionSD11, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "Xpath to the element that is being extended.";
			previousVersion_lazy = () -> CashOptionSD10.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(CashOptionSD11 obj) {
			return obj.getPlaceAndName();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, DTCCPayoutType5Code> mmPayoutType = new MMMessageAttribute<CashOptionSD11, DTCCPayoutType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "PyoutTp";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmPayoutType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DTCCPayoutType5Code getValue(CashOptionSD11 obj) {
			return obj.getPayoutType();
		}

		@Override
		public void setValue(CashOptionSD11 obj, DTCCPayoutType5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<Max3Text>> mmDTCPayMethod = new MMMessageAttribute<CashOptionSD11, Optional<Max3Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "DTCPayMtd";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDTCPayMethod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Text> getValue(CashOptionSD11 obj) {
			return obj.getDTCPayMethod();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<Max3Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<Max3Text>> mmDTCPayOrder = new MMMessageAttribute<CashOptionSD11, Optional<Max3Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "DTCPayOrdr";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDTCPayOrder;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max3Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<DTCEntitlementCalculationMethod1Code>> mmEntitlementCalculationMethod = new MMMessageAttribute<CashOptionSD11, Optional<DTCEntitlementCalculationMethod1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashOptionSD10.mmEntitlementCalculationMethod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCEntitlementCalculationMethod1Code> getValue(CashOptionSD11 obj) {
			return obj.getEntitlementCalculationMethod();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<DTCEntitlementCalculationMethod1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>> mmEstimatedRateFlag = new MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashOptionSD10.mmEstimatedRateFlag;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CashOptionSD11 obj) {
			return obj.getEstimatedRateFlag();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>> mmNRATaxReportableFlag = new MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashOptionSD10.mmNRATaxReportableFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>> mmProtectChargeFlag = new MMMessageAttribute<CashOptionSD11, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "PrtctChrgFlg";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmProtectChargeFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	protected PriceFormatSD3Choice declaredCashRate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>> mmDeclaredCashRate = new MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "DclrdCshRate";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDeclaredCashRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PriceFormatSD3Choice> getValue(CashOptionSD11 obj) {
			return obj.getDeclaredCashRate();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<PriceFormatSD3Choice> value) {
			obj.setDeclaredCashRate(value.orElse(null));
		}
	};
	@XmlElement(name = "DclrdGrssRate")
	protected PriceFormatSD3Choice declaredGrossRate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>> mmDeclaredGrossRate = new MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDeclaredGrossRate;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PriceFormatSD3Choice.mmObject();
		}
	...
	protected PriceFormatSD3Choice declaredNetRate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>> mmDeclaredNetRate = new MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "DclrdNetRate";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDeclaredNetRate;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PriceFormatSD3Choice.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>> mmDeclaredFeeRate = new MMMessageAttribute<CashOptionSD11, Optional<PriceFormatSD3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "DclrdFeeRate";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDeclaredFeeRate;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PriceFormatSD3Choice.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<Period13>> mmDTCUSTaxInstructionPeriod = new MMMessageAttribute<CashOptionSD11, Optional<Period13>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashOptionSD10.mmDTCUSTaxInstructionPeriod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Period13> getValue(CashOptionSD11 obj) {
			return obj.getDTCUSTaxInstructionPeriod();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<Period13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOptionSD11, Optional<Exact32AlphaNumericText>> mmRDPReferenceNumber = new MMMessageAttribute<CashOptionSD11, Optional<Exact32AlphaNumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOptionSD11.mmObject();
			isDerived = false;
			xmlTag = "RDPRefNb";
			...
			previousVersion_lazy = () -> CashOptionSD10.mmRDPReferenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Exact32AlphaNumericText> getValue(CashOptionSD11 obj) {
			return obj.getRDPReferenceNumber();
		}

		@Override
		public void setValue(CashOptionSD11 obj, Optional<Exact32AlphaNumericText> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOptionSD11.mmPlaceAndName, com.tools20022.repository.msg.CashOptionSD11.mmPayoutType, com.tools20022.repository.msg.CashOptionSD11.mmDTCPayMethod,
						com.tools20022.repository.msg.CashOptionSD11.mmDTCPayOrder, com.tools20022.repository.msg.CashOptionSD11.mmEntitlementCalculationMethod, com.tools20022.repository.msg.CashOptionSD11.mmEstimatedRateFlag,
						com.tools20022.repository.msg.CashOptionSD11.mmNRATaxReportableFlag, com.tools20022.repository.msg.CashOptionSD11.mmProtectChargeFlag, com.tools20022.repository.msg.CashOptionSD11.mmDeclaredCashRate,
						com.tools20022.repository.msg.CashOptionSD11.mmDeclaredGrossRate, com.tools20022.repository.msg.CashOptionSD11.mmDeclaredNetRate, com.tools20022.repository.msg.CashOptionSD11.mmDeclaredFeeRate,
						com.tools20022.repository.msg.CashOptionSD11.mmDTCUSTaxInstructionPeriod, com.tools20022.repository.msg.CashOptionSD11.mmRDPReferenceNumber);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CashOptionSD11";
				definition = "Provides additional information regarding corporate action option cash movement details.";
				previousVersion_lazy = () -> CashOptionSD10.mmObject();
			}
		});
	...
	public CashOptionSD11 setPlaceAndName(Max350Text placeAndName) {
	...
	public CashOptionSD11 setPayoutType(DTCCPayoutType5Code payoutType) {
	...
	public CashOptionSD11 setDTCPayMethod(Max3Text dTCPayMethod) {
	...
	public CashOptionSD11 setDTCPayOrder(Max3Text dTCPayOrder) {
	...
	public CashOptionSD11 setEntitlementCalculationMethod(DTCEntitlementCalculationMethod1Code entitlementCalculationMethod) {
	...
	public CashOptionSD11 setEstimatedRateFlag(YesNoIndicator estimatedRateFlag) {
	...
	public CashOptionSD11 setNRATaxReportableFlag(YesNoIndicator nRATaxReportableFlag) {
	...
	public CashOptionSD11 setProtectChargeFlag(YesNoIndicator protectChargeFlag) {
		this.protectChargeFlag = protectChargeFlag;
		return this;
	}

	public Optional<PriceFormatSD3Choice> getDeclaredCashRate() {
		return declaredCashRate == null ? Optional.empty() : Optional.of(declaredCashRate);
	}

	public CashOptionSD11 setDeclaredCashRate(PriceFormatSD3Choice declaredCashRate) {
		this.declaredCashRate = declaredCashRate;
		return this;
	}

	public Optional<PriceFormatSD3Choice> getDeclaredGrossRate() {
		return declaredGrossRate == null ? Optional.empty() : Optional.of(declaredGrossRate);
	}

	public CashOptionSD11 setDeclaredGrossRate(PriceFormatSD3Choice declaredGrossRate) {
		this.declaredGrossRate = declaredGrossRate;
		return this;
	}

	public Optional<PriceFormatSD3Choice> getDeclaredNetRate() {
		return declaredNetRate == null ? Optional.empty() : Optional.of(declaredNetRate);
	}

	public CashOptionSD11 setDeclaredNetRate(PriceFormatSD3Choice declaredNetRate) {
	...
	public CashOptionSD11 setDeclaredFeeRate(PriceFormatSD3Choice declaredFeeRate) {
	...
	public CashOptionSD11 setDTCUSTaxInstructionPeriod(Period13 dTCUSTaxInstructionPeriod) {
	...
	public CashOptionSD11 setRDPReferenceNumber(Exact32AlphaNumericText rDPReferenceNumber) {
