...
public class CorporateActionRate42 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate42.mmAdditionalTax, CorporateActionRate42.mmGrossDividendRate, CorporateActionRate42.mmNetDividendRate, CorporateActionRate42.mmIndexFactor,
						CorporateActionRate42.mmInterestRateUsedForPayment, CorporateActionRate42.mmMaximumAllowedOversubscriptionRate, CorporateActionRate42.mmProrationRate, CorporateActionRate42.mmWithholdingTaxRate,
						CorporateActionRate42.mmWithholdingOfForeignTax, CorporateActionRate42.mmTaxRelatedRate, CorporateActionRate42.mmTaxableIncomePerDividendShare, CorporateActionRate42.mmIssuerDeclaredExchangeRate);
