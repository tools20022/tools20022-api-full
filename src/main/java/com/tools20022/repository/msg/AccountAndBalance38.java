...
public class AccountAndBalance38 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance38.mmSafekeepingAccount, AccountAndBalance38.mmAccountOwner, AccountAndBalance38.mmSafekeepingPlace, AccountAndBalance38.mmBalance);
