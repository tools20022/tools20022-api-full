...
public class AccountAndBalance38 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance38.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementConfirmation002V08.mmAccountDetails);
	...
	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails35 balance) {
