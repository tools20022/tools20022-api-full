...
public class RateTypeAndAmountAndStatus26 {
	...
	public static final MMMessageAssociationEnd mmRateType = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RateTypeAndAmountAndStatus26.mmObject();
			isDerived = false;
			xmlTag = "RateTp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RateType";
			definition = "Value expressed as a rate type.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus11.mmRateType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus11.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmRateStatus = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus11.mmRateStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public void setRateType(RateType36Choice rateType) {
