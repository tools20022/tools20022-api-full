...
public class RejectionReason22 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason22.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason22.mmCode, RejectionReason22.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason20Choice code) {
		this.code = code;
	}
