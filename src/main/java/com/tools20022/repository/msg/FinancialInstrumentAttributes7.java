...
public class FinancialInstrumentAttributes7 {
	...
	public static final MMMessageAttribute mmSecurityIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentAttributes7.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes7.mmSecurityIdentification, FinancialInstrumentAttributes7.mmPlaceOfListing, FinancialInstrumentAttributes7.mmDayCountBasis,
						FinancialInstrumentAttributes7.mmClassificationType, FinancialInstrumentAttributes7.mmOptionStyle, FinancialInstrumentAttributes7.mmDenominationCurrency, FinancialInstrumentAttributes7.mmNextCouponDate,
						FinancialInstrumentAttributes7.mmExpiryDate, FinancialInstrumentAttributes7.mmFloatingRateFixingDate, FinancialInstrumentAttributes7.mmMaturityDate, FinancialInstrumentAttributes7.mmIssueDate,
						FinancialInstrumentAttributes7.mmNextCallableDate, FinancialInstrumentAttributes7.mmPutableDate, FinancialInstrumentAttributes7.mmDatedDate, FinancialInstrumentAttributes7.mmConversionDate,
						FinancialInstrumentAttributes7.mmInterestRate, FinancialInstrumentAttributes7.mmNextInterestRate, FinancialInstrumentAttributes7.mmPercentageOfDebtClaim, FinancialInstrumentAttributes7.mmPreviousFactor,
						FinancialInstrumentAttributes7.mmNextFactor, FinancialInstrumentAttributes7.mmMinimumNominalQuantity, FinancialInstrumentAttributes7.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes7.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes7.mmContractSize);
