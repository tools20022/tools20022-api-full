 ...
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown48#mmLotPrice
...
@XmlType(name = "QuantityBreakdown48", propOrder = {"lotNumber", "lotQuantity", "lotDateTime", "lotPrice", "typeOfPrice"})
public class QuantityBreakdown48 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.QuantityBreakdown48
	 * QuantityBreakdown48}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown48, Optional<GenericIdentification39>> mmLotNumber = new MMMessageAttribute<QuantityBreakdown48, Optional<GenericIdentification39>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown48.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<GenericIdentification39> getValue(QuantityBreakdown48 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown48 obj, Optional<GenericIdentification39> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown48, Optional<FinancialInstrumentQuantity15Choice>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown48, Optional<FinancialInstrumentQuantity15Choice>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity15Choice> getValue(QuantityBreakdown48 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown48 obj, Optional<FinancialInstrumentQuantity15Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown48, Optional<DateAndDateTime2Choice>> mmLotDateTime = new MMMessageAttribute<QuantityBreakdown48, Optional<DateAndDateTime2Choice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTime2Choice> getValue(QuantityBreakdown48 obj) {
			return obj.getLotDateTime();
		}

		@Override
		public void setValue(QuantityBreakdown48 obj, Optional<DateAndDateTime2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown48, Optional<Price3>> mmLotPrice = new MMMessageAssociationEnd<QuantityBreakdown48, Optional<Price3>>() {
		{
		...
		@Override
		public Optional<Price3> getValue(QuantityBreakdown48 obj) {
			return obj.getLotPrice();
		}

		@Override
		public void setValue(QuantityBreakdown48 obj, Optional<Price3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown48, Optional<TypeOfPrice32Choice>> mmTypeOfPrice = new MMMessageAttribute<QuantityBreakdown48, Optional<TypeOfPrice32Choice>>() {
		{
		...
		@Override
		public Optional<TypeOfPrice32Choice> getValue(QuantityBreakdown48 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(QuantityBreakdown48 obj, Optional<TypeOfPrice32Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown48.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown48.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown48.mmLotDateTime, com.tools20022.repository.msg.QuantityBreakdown48.mmLotPrice, com.tools20022.repository.msg.QuantityBreakdown48.mmTypeOfPrice);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "QuantityBreakdown48";
	...
	public QuantityBreakdown48 setLotNumber(GenericIdentification39 lotNumber) {
	...
	public QuantityBreakdown48 setLotQuantity(FinancialInstrumentQuantity15Choice lotQuantity) {
	...
	public QuantityBreakdown48 setLotDateTime(DateAndDateTime2Choice lotDateTime) {
	...
	public QuantityBreakdown48 setLotPrice(Price3 lotPrice) {
	...
	public QuantityBreakdown48 setTypeOfPrice(TypeOfPrice32Choice typeOfPrice) {
