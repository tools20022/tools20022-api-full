...
public class CashOption26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption26.mmCreditDebitIndicator, CashOption26.mmContractualPaymentIndicator, CashOption26.mmIncomeType, CashOption26.mmAccount, CashOption26.mmCashParties,
						CashOption26.mmAmountDetails, CashOption26.mmDateDetails, CashOption26.mmForeignExchangeDetails, CashOption26.mmTaxVoucherDetails, CashOption26.mmRateAndAmountDetails, CashOption26.mmPriceDetails);
