 ...
 * CorporateActionRate6.mmAdditionalQuantityForSubscribedResultantSecurities}</li>
 * <li>
...
@XmlType(name = "CorporateActionRate6", propOrder = {"additionalQuantityForSubscribedResultantSecurities", "additionalQuantityForExistingSecurities", "newToOld", "newSecuritiesToUnderlyingSecurities"})
public class CorporateActionRate6 {
	...
	protected RatioFormat4Choice newToOld;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	protected RatioFormat4Choice newSecuritiesToUnderlyingSecurities;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate6.mmAdditionalQuantityForSubscribedResultantSecurities,
						com.tools20022.repository.msg.CorporateActionRate6.mmAdditionalQuantityForExistingSecurities, com.tools20022.repository.msg.CorporateActionRate6.mmNewToOld,
						com.tools20022.repository.msg.CorporateActionRate6.mmNewSecuritiesToUnderlyingSecurities);
	...
	public CorporateActionRate6 setAdditionalQuantityForSubscribedResultantSecurities(RatioFormat3Choice additionalQuantityForSubscribedResultantSecurities) {
	...
	public CorporateActionRate6 setAdditionalQuantityForExistingSecurities(RatioFormat3Choice additionalQuantityForExistingSecurities) {
		this.additionalQuantityForExistingSecurities = additionalQuantityForExistingSecurities;
		return this;
	}

	public Optional<RatioFormat4Choice> getNewToOld() {
		return newToOld == null ? Optional.empty() : Optional.of(newToOld);
	}

	public CorporateActionRate6 setNewToOld(RatioFormat4Choice newToOld) {
		this.newToOld = newToOld;
		return this;
	}

	public Optional<RatioFormat4Choice> getNewSecuritiesToUnderlyingSecurities() {
		return newSecuritiesToUnderlyingSecurities == null ? Optional.empty() : Optional.of(newSecuritiesToUnderlyingSecurities);
	}

	public CorporateActionRate6 setNewSecuritiesToUnderlyingSecurities(RatioFormat4Choice newSecuritiesToUnderlyingSecurities) {
