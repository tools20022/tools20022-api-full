...
public class CorporateActionAmounts5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionAmounts5.mmPostingAmount, CorporateActionAmounts5.mmGrossCashAmount, CorporateActionAmounts5.mmNetCashAmount, CorporateActionAmounts5.mmSolicitationFees,
						CorporateActionAmounts5.mmCashInLieuOfShare, CorporateActionAmounts5.mmCapitalGain, CorporateActionAmounts5.mmInterestAmount, CorporateActionAmounts5.mmMarketClaimAmount, CorporateActionAmounts5.mmIndemnityAmount,
						CorporateActionAmounts5.mmManufacturedDividendAmount, CorporateActionAmounts5.mmReinvestmentAmount, CorporateActionAmounts5.mmFullyFrankedAmount, CorporateActionAmounts5.mmUnfrankedAmount,
						CorporateActionAmounts5.mmSundryOrOtherAmount, CorporateActionAmounts5.mmCashIncentive, CorporateActionAmounts5.mmTaxFreeAmount, CorporateActionAmounts5.mmTaxDeferredAmount,
						CorporateActionAmounts5.mmValueAddedTaxAmount, CorporateActionAmounts5.mmStampDutyAmount, CorporateActionAmounts5.mmTaxReclaimAmount, CorporateActionAmounts5.mmTaxCreditAmount,
						CorporateActionAmounts5.mmWithholdingOfForeignTaxAmount, CorporateActionAmounts5.mmWithholdingOfLocalTaxAmount, CorporateActionAmounts5.mmAdditionalTaxAmount, CorporateActionAmounts5.mmWithholdingTaxAmount,
						CorporateActionAmounts5.mmFiscalStampAmount, CorporateActionAmounts5.mmExecutingBrokerAmount, CorporateActionAmounts5.mmPayingAgentCommissionAmount, CorporateActionAmounts5.mmLocalBrokerCommissionAmount,
						CorporateActionAmounts5.mmPostageFeeAmount, CorporateActionAmounts5.mmRegulatoryFeesAmount, CorporateActionAmounts5.mmShippingFeesAmount, CorporateActionAmounts5.mmChargesAmount,
						CorporateActionAmounts5.mmCashAmountBroughtForward, CorporateActionAmounts5.mmCashAmountCarriedForward, CorporateActionAmounts5.mmNotionalDividendPayableAmount, CorporateActionAmounts5.mmNotionalTaxAmount,
						CorporateActionAmounts5.mmTaxArrearsAmount, CorporateActionAmounts5.mmOriginalAmount, CorporateActionAmounts5.mmPrincipalOrCorpus, CorporateActionAmounts5.mmRedemptionPremiumAmount,
						CorporateActionAmounts5.mmIncomePortion, CorporateActionAmounts5.mmStockExchangeTax, CorporateActionAmounts5.mmEUTaxRetentionAmount, CorporateActionAmounts5.mmAccruedInterestAmount);
