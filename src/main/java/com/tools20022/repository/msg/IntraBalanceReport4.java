...
@XmlType(name = "IntraBalanceReport4", propOrder = {"reportNumber", "queryReference", "reportIdentification", "reportDateTime", "reportPeriod", "frequency", "updateType", "activityIndicator"})
public class IntraBalanceReport4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, Optional<Number3Choice>> mmReportNumber = new MMMessageAttribute<IntraBalanceReport4, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmReportNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number3Choice> getValue(IntraBalanceReport4 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, Optional<Number3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, Optional<Max35Text>> mmQueryReference = new MMMessageAttribute<IntraBalanceReport4, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "QryRef";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(IntraBalanceReport4 obj) {
			return obj.getQueryReference();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, Optional<Max35Text>> mmReportIdentification = new MMMessageAttribute<IntraBalanceReport4, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "RptId";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmReportIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, Optional<DateAndDateTimeChoice>> mmReportDateTime = new MMMessageAttribute<IntraBalanceReport4, Optional<DateAndDateTimeChoice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "RptDtTm";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmReportDateTime;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(IntraBalanceReport4 obj) {
			return obj.getReportDateTime();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, Optional<Period2Choice>> mmReportPeriod = new MMMessageAttribute<IntraBalanceReport4, Optional<Period2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "RptPrd";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmReportPeriod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Period2Choice> getValue(IntraBalanceReport4 obj) {
			return obj.getReportPeriod();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, Optional<Period2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraBalanceReport4, Optional<Frequency22Choice>> mmFrequency = new MMMessageAssociationEnd<IntraBalanceReport4, Optional<Frequency22Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmFrequency;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Frequency22Choice> getValue(IntraBalanceReport4 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, Optional<Frequency22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraBalanceReport4, UpdateType15Choice> mmUpdateType = new MMMessageAssociationEnd<IntraBalanceReport4, UpdateType15Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmUpdateType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public UpdateType15Choice getValue(IntraBalanceReport4 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, UpdateType15Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceReport4, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<IntraBalanceReport4, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraBalanceReport4.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
			...
			previousVersion_lazy = () -> IntraBalanceReport2.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(IntraBalanceReport4 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(IntraBalanceReport4 obj, YesNoIndicator value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraBalanceReport4.mmReportNumber, com.tools20022.repository.msg.IntraBalanceReport4.mmQueryReference,
						com.tools20022.repository.msg.IntraBalanceReport4.mmReportIdentification, com.tools20022.repository.msg.IntraBalanceReport4.mmReportDateTime, com.tools20022.repository.msg.IntraBalanceReport4.mmReportPeriod,
						com.tools20022.repository.msg.IntraBalanceReport4.mmFrequency, com.tools20022.repository.msg.IntraBalanceReport4.mmUpdateType, com.tools20022.repository.msg.IntraBalanceReport4.mmActivityIndicator);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forIntraBalanceReport4);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "IntraBalanceReport4";
				definition = "Characteristics of the report.";
				previousVersion_lazy = () -> IntraBalanceReport2.mmObject();
			}
		});
	...
	public IntraBalanceReport4 setReportNumber(Number3Choice reportNumber) {
	...
	public IntraBalanceReport4 setQueryReference(Max35Text queryReference) {
	...
	public IntraBalanceReport4 setReportIdentification(Max35Text reportIdentification) {
	...
	public IntraBalanceReport4 setReportDateTime(DateAndDateTimeChoice reportDateTime) {
	...
	public IntraBalanceReport4 setReportPeriod(Period2Choice reportPeriod) {
	...
	public IntraBalanceReport4 setFrequency(Frequency22Choice frequency) {
	...
	public IntraBalanceReport4 setUpdateType(UpdateType15Choice updateType) {
	...
	public IntraBalanceReport4 setActivityIndicator(YesNoIndicator activityIndicator) {
