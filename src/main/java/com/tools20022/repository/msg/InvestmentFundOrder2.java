...
@XmlType(name = "InvestmentFundOrder2", propOrder = {"masterReference", "orderReference", "clientReference", "cancellationReference", "dealReference", "investmentAccountDetails", "financialInstrumentDetails"})
public class InvestmentFundOrder2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentFundOrder2.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Reference assigned to a set of orders or trades in order to link them together.";
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(InvestmentFundOrder2 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(InvestmentFundOrder2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentFundOrder2, Max35Text> mmOrderReference = new MMMessageAttribute<InvestmentFundOrder2, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmOrderReference);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(InvestmentFundOrder2 obj) {
			return obj.getOrderReference();
		}

		@Override
		public void setValue(InvestmentFundOrder2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmClientReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>> mmCancellationReference = new MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmCancellationReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>> mmDealReference = new MMMessageAttribute<InvestmentFundOrder2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmDealReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentFundOrder2, Optional<InvestmentAccount13>> mmInvestmentAccountDetails = new MMMessageAssociationEnd<InvestmentFundOrder2, Optional<InvestmentAccount13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmInvestmentAccountDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InvestmentAccount13> getValue(InvestmentFundOrder2 obj) {
			return obj.getInvestmentAccountDetails();
		}

		@Override
		public void setValue(InvestmentFundOrder2 obj, Optional<InvestmentAccount13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentFundOrder2, Optional<FinancialInstrument10>> mmFinancialInstrumentDetails = new MMMessageAssociationEnd<InvestmentFundOrder2, Optional<FinancialInstrument10>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmFinancialInstrumentDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrument10> getValue(InvestmentFundOrder2 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(InvestmentFundOrder2 obj, Optional<FinancialInstrument10> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentFundOrder2.mmMasterReference, com.tools20022.repository.msg.InvestmentFundOrder2.mmOrderReference,
						com.tools20022.repository.msg.InvestmentFundOrder2.mmClientReference, com.tools20022.repository.msg.InvestmentFundOrder2.mmCancellationReference, com.tools20022.repository.msg.InvestmentFundOrder2.mmDealReference,
						com.tools20022.repository.msg.InvestmentFundOrder2.mmInvestmentAccountDetails, com.tools20022.repository.msg.InvestmentFundOrder2.mmFinancialInstrumentDetails);
				trace_lazy = () -> InvestmentFundOrder.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestmentFundOrder2";
				definition = "Reference of an order and of an order cancellation.";
				nextVersions_lazy = () -> Arrays.asList(InvestmentFundOrder8.mmObject());
			}
		});
	...
	public InvestmentFundOrder2 setMasterReference(Max35Text masterReference) {
	...
	public InvestmentFundOrder2 setOrderReference(Max35Text orderReference) {
	...
	public InvestmentFundOrder2 setClientReference(Max35Text clientReference) {
	...
	public InvestmentFundOrder2 setCancellationReference(Max35Text cancellationReference) {
	...
	public InvestmentFundOrder2 setDealReference(Max35Text dealReference) {
	...
	public InvestmentFundOrder2 setInvestmentAccountDetails(InvestmentAccount13 investmentAccountDetails) {
	...
	public InvestmentFundOrder2 setFinancialInstrumentDetails(FinancialInstrument10 financialInstrumentDetails) {
