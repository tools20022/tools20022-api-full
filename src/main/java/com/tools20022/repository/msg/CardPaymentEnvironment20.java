...
public class CardPaymentEnvironment20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment20.mmAcquirer, CardPaymentEnvironment20.mmMerchant, CardPaymentEnvironment20.mmPOI, CardPaymentEnvironment20.mmCard, CardPaymentEnvironment20.mmCardholder,
						CardPaymentEnvironment20.mmProtectedCardholderData);
