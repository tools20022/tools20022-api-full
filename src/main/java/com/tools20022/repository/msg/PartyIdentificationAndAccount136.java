...
public class PartyIdentificationAndAccount136 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount136.mmIdentification, PartyIdentificationAndAccount136.mmLEI, PartyIdentificationAndAccount136.mmAlternateIdentification,
						PartyIdentificationAndAccount136.mmSafekeepingAccount, PartyIdentificationAndAccount136.mmProcessingIdentification, PartyIdentificationAndAccount136.mmAdditionalInformation);
