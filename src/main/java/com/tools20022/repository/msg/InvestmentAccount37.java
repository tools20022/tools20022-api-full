 ...
 * <li>{@linkplain com.tools20022.repository.msg.InvestmentAccount37#mmLanguage
...
@XmlType(name = "InvestmentAccount37", propOrder = {"identification", "name", "designation", "type", "ownershipType", "taxExemption", "statementFrequency", "referenceCurrency", "language", "incomePreference", "reinvestmentDetails",
		"taxWithholdingMethod", "letterIntentDetails", "accumulationRightReference", "requiredSignatoriesNumber", "fundFamilyName", "fundDetails", "roundingDetails", "accountServicer", "blockedStatus", "accountUsageType",
		"foreignStatusCertification", "accountSignatureDateTime", "transactionChannelType", "investmentAccountCategory"})
public class InvestmentAccount37 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<AccountIdentification1>> mmIdentification = new MMMessageAttribute<InvestmentAccount37, Optional<AccountIdentification1>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount37.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Unique and unambiguous identification for the account between the account owner and the account servicer.";
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmIdentification);
			previousVersion_lazy = () -> InvestmentAccount34.mmIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountIdentification1> getValue(InvestmentAccount37 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<AccountIdentification1> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InvestmentAccount34#mmName
	 * InvestmentAccount34.mmName}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>> mmName = new MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmName);
			previousVersion_lazy = () -> InvestmentAccount34.mmName;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(InvestmentAccount37 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>> mmDesignation = new MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmDesignation);
			previousVersion_lazy = () -> InvestmentAccount34.mmDesignation;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InvestmentAccount34#mmType
	 * InvestmentAccount34.mmType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<AccountType1Choice>> mmType = new MMMessageAttribute<InvestmentAccount37, Optional<AccountType1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmType);
			previousVersion_lazy = () -> InvestmentAccount34.mmType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountType1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<AccountType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, OwnershipType1Choice> mmOwnershipType = new MMMessageAttribute<InvestmentAccount37, OwnershipType1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmOwnershipType);
			previousVersion_lazy = () -> InvestmentAccount34.mmOwnershipType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OwnershipType1Choice getValue(InvestmentAccount37 obj) {
			return obj.getOwnershipType();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, OwnershipType1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<TaxExemptionReason1Choice>> mmTaxExemption = new MMMessageAttribute<InvestmentAccount37, Optional<TaxExemptionReason1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmTaxExemption);
			previousVersion_lazy = () -> InvestmentAccount34.mmTaxExemption;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TaxExemptionReason1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getTaxExemption();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<TaxExemptionReason1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<StatementFrequencyReason1Choice>> mmStatementFrequency = new MMMessageAttribute<InvestmentAccount37, Optional<StatementFrequencyReason1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmStatementFrequency);
			previousVersion_lazy = () -> InvestmentAccount34.mmStatementFrequency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StatementFrequencyReason1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getStatementFrequency();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<StatementFrequencyReason1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<ActiveCurrencyCode>> mmReferenceCurrency = new MMMessageAttribute<InvestmentAccount37, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmReferenceCurrency);
			previousVersion_lazy = () -> InvestmentAccount34.mmReferenceCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(InvestmentAccount37 obj) {
			return obj.getReferenceCurrency();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<LanguageCode>> mmLanguage = new MMMessageAttribute<InvestmentAccount37, Optional<LanguageCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmLanguage);
			previousVersion_lazy = () -> InvestmentAccount34.mmLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(InvestmentAccount37 obj) {
			return obj.getLanguage();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<IncomePreference1Code>> mmIncomePreference = new MMMessageAttribute<InvestmentAccount37, Optional<IncomePreference1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmIncomePreference);
			previousVersion_lazy = () -> InvestmentAccount34.mmIncomePreference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<IncomePreference1Code> getValue(InvestmentAccount37 obj) {
			return obj.getIncomePreference();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<IncomePreference1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, List<Reinvestment1>> mmReinvestmentDetails = new MMMessageAssociationEnd<InvestmentAccount37, List<Reinvestment1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmReinvestmentDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Reinvestment1> getValue(InvestmentAccount37 obj) {
			return obj.getReinvestmentDetails();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, List<Reinvestment1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<TaxWithholdingMethod2Code>> mmTaxWithholdingMethod = new MMMessageAttribute<InvestmentAccount37, Optional<TaxWithholdingMethod2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmTaxWithholdingMethod);
			previousVersion_lazy = () -> InvestmentAccount34.mmTaxWithholdingMethod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TaxWithholdingMethod2Code> getValue(InvestmentAccount37 obj) {
			return obj.getTaxWithholdingMethod();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<TaxWithholdingMethod2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<LetterIntent1>> mmLetterIntentDetails = new MMMessageAttribute<InvestmentAccount37, Optional<LetterIntent1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmLetterIntentDetails);
			previousVersion_lazy = () -> InvestmentAccount34.mmLetterIntentDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LetterIntent1> getValue(InvestmentAccount37 obj) {
			return obj.getLetterIntentDetails();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<LetterIntent1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>> mmAccumulationRightReference = new MMMessageAttribute<InvestmentAccount37, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmAccumulationRightReference);
			previousVersion_lazy = () -> InvestmentAccount34.mmAccumulationRightReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Number>> mmRequiredSignatoriesNumber = new MMMessageAttribute<InvestmentAccount37, Optional<Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmRequiredSignatoriesNumber);
			previousVersion_lazy = () -> InvestmentAccount34.mmRequiredSignatoriesNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number> getValue(InvestmentAccount37 obj) {
			return obj.getRequiredSignatoriesNumber();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Max350Text>> mmFundFamilyName = new MMMessageAttribute<InvestmentAccount37, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmFundFamilyName);
			previousVersion_lazy = () -> InvestmentAccount34.mmFundFamilyName;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(InvestmentAccount37 obj) {
			return obj.getFundFamilyName();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, List<FinancialInstrument29>> mmFundDetails = new MMMessageAssociationEnd<InvestmentAccount37, List<FinancialInstrument29>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmFinancialInstrumentDetails);
			previousVersion_lazy = () -> InvestmentAccount34.mmFundDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<FinancialInstrument29> getValue(InvestmentAccount37 obj) {
			return obj.getFundDetails();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, List<FinancialInstrument29> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, Optional<RoundingParameters1>> mmRoundingDetails = new MMMessageAssociationEnd<InvestmentAccount37, Optional<RoundingParameters1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmRoundingDetails);
			previousVersion_lazy = () -> InvestmentAccount34.mmRoundingDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RoundingParameters1> getValue(InvestmentAccount37 obj) {
			return obj.getRoundingDetails();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<RoundingParameters1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, Optional<PartyIdentification2Choice>> mmAccountServicer = new MMMessageAssociationEnd<InvestmentAccount37, Optional<PartyIdentification2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmAccountServicer);
			previousVersion_lazy = () -> InvestmentAccount34.mmAccountServicer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification2Choice> getValue(InvestmentAccount37 obj) {
			return obj.getAccountServicer();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<PartyIdentification2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, List<Blocked1>> mmBlockedStatus = new MMMessageAttribute<InvestmentAccount37, List<Blocked1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmBlockedStatus);
			previousVersion_lazy = () -> InvestmentAccount34.mmBlockedStatus;
			minOccurs = 0;
			complexType_lazy = () -> Blocked1.mmObject();
		}

		@Override
		public List<Blocked1> getValue(InvestmentAccount37 obj) {
			return obj.getBlockedStatus();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, List<Blocked1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<AccountUsageType1Choice>> mmAccountUsageType = new MMMessageAttribute<InvestmentAccount37, Optional<AccountUsageType1Choice>>() {
		{
			businessComponentTrace_lazy = () -> InvestmentAccount.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount37.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmAccountUsageType);
			previousVersion_lazy = () -> InvestmentAccount34.mmAccountUsageType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountUsageType1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getAccountUsageType();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<AccountUsageType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<Provided1Code>> mmForeignStatusCertification = new MMMessageAttribute<InvestmentAccount37, Optional<Provided1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount37.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmForeignStatusCertification);
			previousVersion_lazy = () -> InvestmentAccount34.mmForeignStatusCertification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Provided1Code> getValue(InvestmentAccount37 obj) {
			return obj.getForeignStatusCertification();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<Provided1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount37, Optional<DateAndDateTimeChoice>> mmAccountSignatureDateTime = new MMMessageAttribute<InvestmentAccount37, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmAccountSignatureDateTime);
			previousVersion_lazy = () -> InvestmentAccount34.mmAccountSignatureDateTime;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(InvestmentAccount37 obj) {
			return obj.getAccountSignatureDateTime();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, Optional<TransactionChannelType1Choice>> mmTransactionChannelType = new MMMessageAssociationEnd<InvestmentAccount37, Optional<TransactionChannelType1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmTransactionChannelType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TransactionChannelType1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getTransactionChannelType();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<TransactionChannelType1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount37, Optional<InvestmentAccountCategory1Choice>> mmInvestmentAccountCategory = new MMMessageAssociationEnd<InvestmentAccount37, Optional<InvestmentAccountCategory1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount49.mmInvestmentAccountCategory);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InvestmentAccountCategory1Choice> getValue(InvestmentAccount37 obj) {
			return obj.getInvestmentAccountCategory();
		}

		@Override
		public void setValue(InvestmentAccount37 obj, Optional<InvestmentAccountCategory1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount37.mmIdentification, com.tools20022.repository.msg.InvestmentAccount37.mmName,
						com.tools20022.repository.msg.InvestmentAccount37.mmDesignation, com.tools20022.repository.msg.InvestmentAccount37.mmType, com.tools20022.repository.msg.InvestmentAccount37.mmOwnershipType,
						com.tools20022.repository.msg.InvestmentAccount37.mmTaxExemption, com.tools20022.repository.msg.InvestmentAccount37.mmStatementFrequency, com.tools20022.repository.msg.InvestmentAccount37.mmReferenceCurrency,
						com.tools20022.repository.msg.InvestmentAccount37.mmLanguage, com.tools20022.repository.msg.InvestmentAccount37.mmIncomePreference, com.tools20022.repository.msg.InvestmentAccount37.mmReinvestmentDetails,
						com.tools20022.repository.msg.InvestmentAccount37.mmTaxWithholdingMethod, com.tools20022.repository.msg.InvestmentAccount37.mmLetterIntentDetails,
						com.tools20022.repository.msg.InvestmentAccount37.mmAccumulationRightReference, com.tools20022.repository.msg.InvestmentAccount37.mmRequiredSignatoriesNumber,
						com.tools20022.repository.msg.InvestmentAccount37.mmFundFamilyName, com.tools20022.repository.msg.InvestmentAccount37.mmFundDetails, com.tools20022.repository.msg.InvestmentAccount37.mmRoundingDetails,
						com.tools20022.repository.msg.InvestmentAccount37.mmAccountServicer, com.tools20022.repository.msg.InvestmentAccount37.mmBlockedStatus, com.tools20022.repository.msg.InvestmentAccount37.mmAccountUsageType,
						com.tools20022.repository.msg.InvestmentAccount37.mmForeignStatusCertification, com.tools20022.repository.msg.InvestmentAccount37.mmAccountSignatureDateTime,
						com.tools20022.repository.msg.InvestmentAccount37.mmTransactionChannelType, com.tools20022.repository.msg.InvestmentAccount37.mmInvestmentAccountCategory);
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountOpeningInstructionV04.mmInvestmentAccount, AccountOpeningInstructionV05.mmInvestmentAccount);
				trace_lazy = () -> InvestmentAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintFundDetailsGuideline.forInvestmentAccount37,
						com.tools20022.repository.constraints.ConstraintReinvestmentPercentage1Rule.forInvestmentAccount37, com.tools20022.repository.constraints.ConstraintIncomePreferenceReinvestment1Rule.forInvestmentAccount37);
	...
	public InvestmentAccount37 setIdentification(AccountIdentification1 identification) {
	...
	public InvestmentAccount37 setName(Max35Text name) {
		this.name = name;
		return this;
	}
	...
	public InvestmentAccount37 setDesignation(Max35Text designation) {
	...
	public InvestmentAccount37 setType(AccountType1Choice type) {
		this.type = type;
		return this;
	}
	...
	public InvestmentAccount37 setOwnershipType(OwnershipType1Choice ownershipType) {
	...
	public InvestmentAccount37 setTaxExemption(TaxExemptionReason1Choice taxExemption) {
	...
	public InvestmentAccount37 setStatementFrequency(StatementFrequencyReason1Choice statementFrequency) {
	...
	public InvestmentAccount37 setReferenceCurrency(ActiveCurrencyCode referenceCurrency) {
	...
	public InvestmentAccount37 setLanguage(LanguageCode language) {
	...
	public InvestmentAccount37 setIncomePreference(IncomePreference1Code incomePreference) {
	...
	public InvestmentAccount37 setReinvestmentDetails(List<Reinvestment1> reinvestmentDetails) {
	...
	public InvestmentAccount37 setTaxWithholdingMethod(TaxWithholdingMethod2Code taxWithholdingMethod) {
	...
	public InvestmentAccount37 setLetterIntentDetails(LetterIntent1 letterIntentDetails) {
	...
	public InvestmentAccount37 setAccumulationRightReference(Max35Text accumulationRightReference) {
	...
	public InvestmentAccount37 setRequiredSignatoriesNumber(Number requiredSignatoriesNumber) {
	...
	public InvestmentAccount37 setFundFamilyName(Max350Text fundFamilyName) {
	...
	public InvestmentAccount37 setFundDetails(List<FinancialInstrument29> fundDetails) {
	...
	public InvestmentAccount37 setRoundingDetails(RoundingParameters1 roundingDetails) {
	...
	public InvestmentAccount37 setAccountServicer(PartyIdentification2Choice accountServicer) {
	...
	public InvestmentAccount37 setBlockedStatus(List<Blocked1> blockedStatus) {
	...
	public InvestmentAccount37 setAccountUsageType(AccountUsageType1Choice accountUsageType) {
	...
	public InvestmentAccount37 setForeignStatusCertification(Provided1Code foreignStatusCertification) {
	...
	public InvestmentAccount37 setAccountSignatureDateTime(DateAndDateTimeChoice accountSignatureDateTime) {
	...
	public InvestmentAccount37 setTransactionChannelType(TransactionChannelType1Choice transactionChannelType) {
	...
	public InvestmentAccount37 setInvestmentAccountCategory(InvestmentAccountCategory1Choice investmentAccountCategory) {
