...
public class EventInformation10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation10.mmCorporateActionEventIdentification, EventInformation10.mmOfficialCorporateActionEventIdentification, EventInformation10.mmEventType,
						EventInformation10.mmMandatoryVoluntaryEventType, EventInformation10.mmLastNotificationIdentification);
