...
import com.tools20022.repository.msg.NotificationIdentification4;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation10#mmEventType
...
@XmlType(name = "EventInformation10", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "mandatoryVoluntaryEventType", "lastNotificationIdentification"})
public class EventInformation10 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.EventInformation10
	 * EventInformation10}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation10, RestrictedFINXMax16Text> mmCorporateActionEventIdentification = new MMMessageAttribute<EventInformation10, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.EventInformation10.mmObject();
			isDerived = false;
		...
		@Override
		public RestrictedFINXMax16Text getValue(EventInformation10 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation10 obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation10, Optional<RestrictedFINXMax16Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<EventInformation10, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(EventInformation10 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation10 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation10, CorporateActionEventType58Choice> mmEventType = new MMMessageAttribute<EventInformation10, CorporateActionEventType58Choice>() {
		{
		...
		@Override
		public CorporateActionEventType58Choice getValue(EventInformation10 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(EventInformation10 obj, CorporateActionEventType58Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation10, CorporateActionMandatoryVoluntary4Choice> mmMandatoryVoluntaryEventType = new MMMessageAttribute<EventInformation10, CorporateActionMandatoryVoluntary4Choice>() {
		{
		...
		@Override
		public CorporateActionMandatoryVoluntary4Choice getValue(EventInformation10 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(EventInformation10 obj, CorporateActionMandatoryVoluntary4Choice value) {
			obj.setMandatoryVoluntaryEventType(value);
		}
	};
	@XmlElement(name = "LastNtfctnId")
	protected NotificationIdentification4 lastNotificationIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.msg.NotificationIdentification4
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<EventInformation10, Optional<NotificationIdentification4>> mmLastNotificationIdentification = new MMMessageAssociationEnd<EventInformation10, Optional<NotificationIdentification4>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> NotificationIdentification4.mmObject();
		}

		@Override
		public Optional<NotificationIdentification4> getValue(EventInformation10 obj) {
			return obj.getLastNotificationIdentification();
		}

		@Override
		public void setValue(EventInformation10 obj, Optional<NotificationIdentification4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation10.mmCorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation10.mmOfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation10.mmEventType, com.tools20022.repository.msg.EventInformation10.mmMandatoryVoluntaryEventType,
						com.tools20022.repository.msg.EventInformation10.mmLastNotificationIdentification);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "EventInformation10";
	...
	public EventInformation10 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public EventInformation10 setOfficialCorporateActionEventIdentification(RestrictedFINXMax16Text officialCorporateActionEventIdentification) {
	...
	public EventInformation10 setEventType(CorporateActionEventType58Choice eventType) {
	...
	public EventInformation10 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary4Choice mandatoryVoluntaryEventType) {
		this.mandatoryVoluntaryEventType = Objects.requireNonNull(mandatoryVoluntaryEventType);
		return this;
	}

	public Optional<NotificationIdentification4> getLastNotificationIdentification() {
		return lastNotificationIdentification == null ? Optional.empty() : Optional.of(lastNotificationIdentification);
	}

	public EventInformation10 setLastNotificationIdentification(NotificationIdentification4 lastNotificationIdentification) {
