...
public class ISATransfer10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer10.mmMasterReference, ISATransfer10.mmTransferConfirmationIdentification, ISATransfer10.mmTransferInstructionReference, ISATransfer10.mmActualTransferDate,
						ISATransfer10.mmResidualCash, ISATransfer10.mmPortfolio, ISATransfer10.mmAllOtherCash, ISATransfer10.mmFinancialInstrumentAssetForTransfer);
