...
public class PaymentContext21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext21.mmCardPresent, PaymentContext21.mmCardholderPresent, PaymentContext21.mmOnLineContext, PaymentContext21.mmAttendanceContext,
						PaymentContext21.mmTransactionEnvironment, PaymentContext21.mmTransactionChannel, PaymentContext21.mmCardDataEntryMode, PaymentContext21.mmFallbackIndicator, PaymentContext21.mmSupportedOption);
