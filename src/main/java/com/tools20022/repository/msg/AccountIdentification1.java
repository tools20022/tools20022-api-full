...
@XmlType(name = "AccountIdentification1", propOrder = "proprietary")
public class AccountIdentification1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification1.mmProprietary);
				...
				name = "AccountIdentification1";
				definition = "Unique identifier of an account, as assigned by the account servicer.";
				nextVersions_lazy = () -> Arrays.asList(AccountIdentification26.mmObject());
			}
		});
