...
public class PendingCancellationStatusReason6 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingCancellationStatusReason6.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingCancellationStatusReason6.mmReasonCode, PendingCancellationStatusReason6.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingCancellationReason4Choice reasonCode) {
