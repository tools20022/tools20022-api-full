...
public class AggregateBalanceInformation24 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AggregateBalanceInformation24.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace23> balanceAtSafekeepingPlace) {
