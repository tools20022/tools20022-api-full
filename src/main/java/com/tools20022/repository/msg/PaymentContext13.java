...
public class PaymentContext13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext13.mmCardPresent, PaymentContext13.mmCardholderPresent, PaymentContext13.mmOnLineContext, PaymentContext13.mmAttendanceContext,
						PaymentContext13.mmTransactionEnvironment, PaymentContext13.mmTransactionChannel, PaymentContext13.mmAttendantMessageCapable, PaymentContext13.mmAttendantLanguage, PaymentContext13.mmCardDataEntryMode,
						PaymentContext13.mmFallbackIndicator);
