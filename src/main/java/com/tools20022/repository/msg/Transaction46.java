...
public class Transaction46 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction46.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction46.mmAccountOwnerTransactionIdentification, Transaction46.mmAccountServicerTransactionIdentification, Transaction46.mmMarketInfrastructureTransactionIdentification,
						Transaction46.mmProcessorTransactionIdentification, Transaction46.mmTradeIdentification, Transaction46.mmPoolIdentification, Transaction46.mmCommonIdentification, Transaction46.mmCorporateActionEventIdentification,
						Transaction46.mmTripartyAgentCollateralTransactionIdentification, Transaction46.mmClientTripartyCollateralTransactionIdentification, Transaction46.mmClientCollateralInstructionIdentification,
						Transaction46.mmTripartyCollateralInstructionIdentification, Transaction46.mmTransactionDetails, Transaction46.mmSupplementaryData);
	...
	public TransactionDetails78 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails78 transactionDetails) {
