...
import com.tools20022.repository.msg.TransactionDetails78;
import java.util.*;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transaction46#mmSupplementaryData
 * Transaction46.mmSupplementaryData}</li>
 * </ul>
 * </li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction36
 * Transaction36}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction46", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class Transaction46 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction46, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction46.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction46 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction46 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmAccountServicerTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction46 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction46 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmMarketInfrastructureTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmProcessorTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction46, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmTradeIdentification);
			previousVersion_lazy = () -> Transaction36.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction46 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction46 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmPoolIdentification);
			previousVersion_lazy = () -> Transaction36.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmCommonIdentification);
			previousVersion_lazy = () -> Transaction36.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> Transaction36.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmTripartyAgentServiceProviderCollateralTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmTripartyAgentCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmClientTripartyCollateralTransactionIdentification);
			previousVersion_lazy = () -> Transaction36.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmClientCollateralInstructionIdentification);
			previousVersion_lazy = () -> Transaction36.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction46, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<Transaction46, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction46.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmTripartyAgentServiceProviderCollateralInstructionIdentification);
			previousVersion_lazy = () -> Transaction36.mmTripartyCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected TransactionDetails78 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails78
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction46, Optional<TransactionDetails78>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction46, Optional<TransactionDetails78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmTransactionDetails);
			previousVersion_lazy = () -> Transaction36.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails78.mmObject();
		}

		@Override
		public Optional<TransactionDetails78> getValue(Transaction46 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction46 obj, Optional<TransactionDetails78> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transaction36#mmSupplementaryData
	 * Transaction36.mmSupplementaryData}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction46, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<Transaction46, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction46.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction52.mmSupplementaryData);
			previousVersion_lazy = () -> Transaction36.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(Transaction46 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(Transaction46 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction46.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction46.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction46.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction46.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction46.mmTradeIdentification, com.tools20022.repository.msg.Transaction46.mmPoolIdentification, com.tools20022.repository.msg.Transaction46.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction46.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction46.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction46.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction46.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.Transaction46.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction46.mmTransactionDetails,
						com.tools20022.repository.msg.Transaction46.mmSupplementaryData);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction46);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Transaction46";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(Transaction52.mmObject());
				previousVersion_lazy = () -> Transaction36.mmObject();
			}
		});
	...
	public Transaction46 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction46 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction46 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction46 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction46 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction46 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction46 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction46 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction46 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction46 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public Transaction46 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction46 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
		this.tripartyCollateralInstructionIdentification = tripartyCollateralInstructionIdentification;
		return this;
	}

	public Optional<TransactionDetails78> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction46 setTransactionDetails(TransactionDetails78 transactionDetails) {
	...
	public Transaction46 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
