 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#ReportNumber
 * Statement17.ReportNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#QueryReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#StatementDateTime
 * Statement17.StatementDateTime}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#Frequency
 * Statement17.Frequency}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#UpdateType
 * Statement17.UpdateType}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Statement17#ActivityIndicator
 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV02#StatementGeneralDetails
 * SecuritiesSettlementTransactionAllegementReportV02.StatementGeneralDetails}</li>
 * <li>
 * {@linkplain com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV03#StatementGeneralDetails
 * SecuritiesSettlementTransactionAllegementReportV03.StatementGeneralDetails}</li>
 * <li>
 * {@linkplain com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV04#StatementGeneralDetails
 * SecuritiesSettlementTransactionAllegementReportV04.StatementGeneralDetails}</li>
 * </ul>
 * </li>
 * <li>
...
public class Statement17 {
	...
	public static final MMMessageAttribute ReportNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.ReportNumber);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute QueryReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.QueryReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute StatementIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.StatementIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Statement39#StatementDateTime
	...
	public static final MMMessageAttribute StatementDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.StatementDateTime);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Frequency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.Frequency);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UpdateType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.UpdateType);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Statement39#ActivityIndicator
	...
	public static final MMMessageAttribute ActivityIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement39.ActivityIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement17.ReportNumber, com.tools20022.repository.msg.Statement17.QueryReference, com.tools20022.repository.msg.Statement17.StatementIdentification,
						com.tools20022.repository.msg.Statement17.StatementDateTime, com.tools20022.repository.msg.Statement17.Frequency, com.tools20022.repository.msg.Statement17.UpdateType,
						com.tools20022.repository.msg.Statement17.ActivityIndicator);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV01.StatementGeneralDetails,
						com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV02.StatementGeneralDetails,
						com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV03.StatementGeneralDetails,
						com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReportV04.StatementGeneralDetails);
