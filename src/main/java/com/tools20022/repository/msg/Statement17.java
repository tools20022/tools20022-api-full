 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forStatement17
 * ConstraintCoexistenceIdentificationRule.forStatement17}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Statement17", propOrder = {"reportNumber", "queryReference", "statementIdentification", "statementDateTime", "frequency", "updateType", "activityIndicator"})
public class Statement17 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forStatement17, com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forStatement17);
	...
	public Statement17 setReportNumber(Number3Choice reportNumber) {
	...
	public Statement17 setQueryReference(Max35Text queryReference) {
	...
	public Statement17 setStatementIdentification(Max35Text statementIdentification) {
	...
	public Statement17 setStatementDateTime(DateAndDateTimeChoice statementDateTime) {
	...
	public Statement17 setFrequency(Frequency4Choice frequency) {
	...
	public Statement17 setUpdateType(UpdateType2Choice updateType) {
	...
	public Statement17 setActivityIndicator(YesNoIndicator activityIndicator) {
