 ...
 * <li>{@linkplain com.tools20022.repository.msg.PartyIdentification91#mmLEI
...
@XmlType(name = "PartyIdentification91", propOrder = {"identification", "lEI", "processingIdentification"})
public class PartyIdentification91 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PartyIdentification91
	 * PartyIdentification91}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification91, PartyIdentification44Choice> mmIdentification = new MMMessageAssociationEnd<PartyIdentification91, PartyIdentification44Choice>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification91.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			previousVersion_lazy = () -> PartyIdentification46.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PartyIdentification44Choice getValue(PartyIdentification91 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(PartyIdentification91 obj, PartyIdentification44Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification91, Optional<LEIIdentifier>> mmLEI = new MMMessageAttribute<PartyIdentification91, Optional<LEIIdentifier>>() {
		{
		...
		@Override
		public Optional<LEIIdentifier> getValue(PartyIdentification91 obj) {
			return obj.getLEI();
		}

		@Override
		public void setValue(PartyIdentification91 obj, Optional<LEIIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification91, Optional<Max35Text>> mmProcessingIdentification = new MMMessageAttribute<PartyIdentification91, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification91.mmObject();
			isDerived = false;
			xmlTag = "PrcgId";
			...
			previousVersion_lazy = () -> PartyIdentification46.mmProcessingIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PartyIdentification91 obj) {
			return obj.getProcessingIdentification();
		}

		@Override
		public void setValue(PartyIdentification91 obj, Optional<Max35Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification91.mmIdentification, com.tools20022.repository.msg.PartyIdentification91.mmLEI,
						com.tools20022.repository.msg.PartyIdentification91.mmProcessingIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PartyIdentification91";
				definition = "Identification of an entity involved in an activity.";
				previousVersion_lazy = () -> PartyIdentification46.mmObject();
			}
		});
	...
	public PartyIdentification91 setIdentification(PartyIdentification44Choice identification) {
	...
	public PartyIdentification91 setLEI(LEIIdentifier lEI) {
		this.lEI = lEI;
		return this;
	}
	...
	public PartyIdentification91 setProcessingIdentification(Max35Text processingIdentification) {
