...
public class IntraBalanceModification3 {
	...
	protected List<com.tools20022.repository.msg.IntraBalanceModification4> modification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmModification = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.IntraBalanceModification4.mmObject();
		}
	};
	...
	public IntraBalanceModification3 setAccountOwner(com.tools20022.repository.msg.SystemPartyIdentification6 accountOwner) {
	...
	public IntraBalanceModification3 setCashAccount(com.tools20022.repository.msg.CashAccount24 cashAccount) {
	...
	public IntraBalanceModification3 setModification(List<com.tools20022.repository.msg.IntraBalanceModification4> modification) {
