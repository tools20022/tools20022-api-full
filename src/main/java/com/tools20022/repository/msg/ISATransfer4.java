...
public class ISATransfer4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer4.mmMasterReference, ISATransfer4.mmTransferIdentification, ISATransfer4.mmResidualCash, ISATransfer4.mmPortfolio, ISATransfer4.mmAllOtherCash,
						ISATransfer4.mmFinancialInstrumentAssetForTransfer);
