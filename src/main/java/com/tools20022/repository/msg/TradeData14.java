	...
	public static final MMMessageAttribute mmCurrentStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TradeData9.mmCurrentStatus;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCurrentStatusSubType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TradeData9.mmCurrentStatusSubType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPreviousStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TradeData9.mmPreviousStatus;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAllegedTrade = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TradeData9.mmAllegedTrade;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPreviousStatusSubType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TradeData9.mmPreviousStatusSubType;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> StatusSubType2Code.mmObject();
		}
