...
public class AmendmentInformationDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmendmentInformationDetails9.mmOriginalMandateIdentification, AmendmentInformationDetails9.mmOriginalCreditorSchemeIdentification,
						AmendmentInformationDetails9.mmOriginalCreditorAgent, AmendmentInformationDetails9.mmOriginalDebtor, AmendmentInformationDetails9.mmOriginalDebtorAccount, AmendmentInformationDetails9.mmOriginalDebtorAgent,
						AmendmentInformationDetails9.mmOriginalFinalCollectionDate, AmendmentInformationDetails9.mmOriginalFrequency);
