...
import com.tools20022.repository.choice.RejectionReason15Choice;
...
public class RejectionReason18 {
	...
	protected RejectionReason15Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.RejectionReason15Choice
	 * RejectionReason15Choice}</li>
	 * <li>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason18
	 * RejectionReason18}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionReason18, RejectionReason15Choice> mmCode = new MMMessageAssociationEnd<RejectionReason18, RejectionReason15Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionReason18.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction/request has a rejected or repair status.";
			nextVersions_lazy = () -> Arrays.asList(RejectionReason28.mmCode);
			previousVersion_lazy = () -> RejectionReason6.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectionReason15Choice.mmObject();
		}

		@Override
		public RejectionReason15Choice getValue(RejectionReason18 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason18 obj, RejectionReason15Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason18, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason18, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionReason28.mmAdditionalReasonInformation);
		...
		@Override
		public Optional<Max210Text> getValue(RejectionReason18 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionReason18 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason18.mmCode, com.tools20022.repository.msg.RejectionReason18.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionReason18";
				definition = "The status of an instruction, advice or request.";
				nextVersions_lazy = () -> Arrays.asList(RejectionReason28.mmObject());
	...
	public RejectionReason18 setCode(RejectionReason15Choice code) {
	...
	public RejectionReason18 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
