...
public class AcknowledgementReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason4.mmCode, AcknowledgementReason4.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason6Choice code) {
		this.code = code;
	}
