...
public class TotalEligibleBalanceFormat8 {
	...
	public static final MMMessageAssociationEnd Balance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TotalEligibleBalanceFormat1.Balance;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FullPeriodUnits = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TotalEligibleBalanceFormat1.FullPeriodUnits;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartWayPeriodUnits = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TotalEligibleBalanceFormat1.PartWayPeriodUnits;
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> SignedQuantityFormat6.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalEligibleBalanceFormat8.Balance, com.tools20022.repository.msg.TotalEligibleBalanceFormat8.FullPeriodUnits,
						com.tools20022.repository.msg.TotalEligibleBalanceFormat8.PartWayPeriodUnits);
