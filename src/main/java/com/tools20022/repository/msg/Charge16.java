...
public class Charge16 {
	...
	public static final MMXor mmTypeOrExtendedTypeRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(Charge16.mmType, Charge16.mmExtendedType);
		}
	};
	/**
	...
	public static final MMXor mmAmountOrRateRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> Charge16.mmObject();
			impactedElements_lazy = () -> Arrays.asList(Charge16.mmAmount, Charge16.mmRate);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Charge16.mmType, Charge16.mmExtendedType, Charge16.mmAmount, Charge16.mmRate);
				...
				xors_lazy = () -> Arrays.asList(Charge16.mmTypeOrExtendedTypeRule, Charge16.mmAmountOrRateRule);
			}
		});
