...
public class ModificationScope25 {
	...
	public static final MMMessageAttribute mmModificationScopeIndication = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ModificationScope28.mmModificationScopeIndication);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ModificationScope18.mmModificationScopeIndication;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmInvestmentPlan = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ModificationScope28.mmInvestmentPlan);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ModificationScope18.mmInvestmentPlan;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountModificationInstructionV05.mmModifiedSavingsInvestmentPlan,
						com.tools20022.repository.area.acmt.AccountModificationInstructionV05.mmModifiedWithdrawalInvestmentPlan);
	...
	public void setInvestmentPlan(com.tools20022.repository.msg.InvestmentPlan11 investmentPlan) {
