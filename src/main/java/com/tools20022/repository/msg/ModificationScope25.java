...
import com.tools20022.repository.msg.InvestmentPlan11;
...
@XmlType(name = "ModificationScope25", propOrder = {"modificationScopeIndication", "investmentPlan"})
public class ModificationScope25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ModificationScope25, DataModification1Code> mmModificationScopeIndication = new MMMessageAttribute<ModificationScope25, DataModification1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ModificationScope25.mmObject();
			isDerived = false;
			xmlTag = "ModScpIndctn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ModificationScopeIndication";
			definition = "Specifies the type of modification to be applied on a set of information.";
			nextVersions_lazy = () -> Arrays.asList(ModificationScope28.mmModificationScopeIndication);
			previousVersion_lazy = () -> ModificationScope18.mmModificationScopeIndication;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DataModification1Code getValue(ModificationScope25 obj) {
			return obj.getModificationScopeIndication();
		}

		@Override
		public void setValue(ModificationScope25 obj, DataModification1Code value) {
			obj.setModificationScopeIndication(value);
		}
	};
	@XmlElement(name = "InvstmtPlan", required = true)
	protected InvestmentPlan11 investmentPlan;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationScope25, InvestmentPlan11> mmInvestmentPlan = new MMMessageAssociationEnd<ModificationScope25, InvestmentPlan11>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ModificationScope25.mmObject();
			isDerived = false;
			xmlTag = "InvstmtPlan";
			...
			nextVersions_lazy = () -> Arrays.asList(ModificationScope28.mmInvestmentPlan);
			previousVersion_lazy = () -> ModificationScope18.mmInvestmentPlan;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public InvestmentPlan11 getValue(ModificationScope25 obj) {
			return obj.getInvestmentPlan();
		}

		@Override
		public void setValue(ModificationScope25 obj, InvestmentPlan11 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ModificationScope25.mmModificationScopeIndication, com.tools20022.repository.msg.ModificationScope25.mmInvestmentPlan);
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountModificationInstructionV05.mmModifiedSavingsInvestmentPlan, AccountModificationInstructionV05.mmModifiedWithdrawalInvestmentPlan);
	...
	public ModificationScope25 setModificationScopeIndication(DataModification1Code modificationScopeIndication) {
		this.modificationScopeIndication = Objects.requireNonNull(modificationScopeIndication);
		return this;
	}

	public InvestmentPlan11 getInvestmentPlan() {
		return investmentPlan;
	}

	public ModificationScope25 setInvestmentPlan(InvestmentPlan11 investmentPlan) {
