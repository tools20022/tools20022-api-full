...
public class PaymentTransaction81 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>> mmReversalIdentification = new MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmReversalIdentification);
			previousVersion_lazy = () -> PaymentTransaction60.mmReversalIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction81 obj) {
			return obj.getReversalIdentification();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction81, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalGroupInformation);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction81 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalTransactionIdentification);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction81, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction81 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, ActiveCurrencyAndAmount> mmReversedInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction81, ActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> CashSettlement.mmInterbankSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction81.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmReversedInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction60.mmReversedInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(PaymentTransaction81 obj) {
			return obj.getReversedInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction81, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmInterbankSettlementDate);
			previousVersion_lazy = () -> PaymentTransaction60.mmInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction81 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<Priority3Code>> mmSettlementPriority = new MMMessageAttribute<PaymentTransaction81, Optional<Priority3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmSettlementPriority);
			previousVersion_lazy = () -> PaymentTransaction60.mmSettlementPriority;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Priority3Code> getValue(PaymentTransaction81 obj) {
			return obj.getSettlementPriority();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<Priority3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>> mmReversedInstructedAmount = new MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmReversedInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction60.mmReversedInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<BaseOneRate>> mmExchangeRate = new MMMessageAttribute<PaymentTransaction81, Optional<BaseOneRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmExchangeRate);
			previousVersion_lazy = () -> PaymentTransaction60.mmExchangeRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOneRate> getValue(PaymentTransaction81 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>> mmCompensationAmount = new MMMessageAttribute<PaymentTransaction81, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmCompensationAmount);
			previousVersion_lazy = () -> PaymentTransaction60.mmCompensationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentTransaction81, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmChargeBearer);
			previousVersion_lazy = () -> PaymentTransaction60.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentTransaction81 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction81, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction60.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction81 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<PaymentTransaction81, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmInstructingAgent);
			previousVersion_lazy = () -> PaymentTransaction60.mmInstructingAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentTransaction81 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<PaymentTransaction81, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction81.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmInstructedAgent);
			previousVersion_lazy = () -> PaymentTransaction60.mmInstructedAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<PaymentTransaction81, List<PaymentReversalReason7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmReversalReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction60.mmReversalReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReversalReason7> getValue(PaymentTransaction81 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, List<PaymentReversalReason7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction81, Optional<OriginalTransactionReference24>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction81, Optional<OriginalTransactionReference24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction60.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference24> getValue(PaymentTransaction81 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, Optional<OriginalTransactionReference24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction81, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction81, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction81.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction60.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction81 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction81 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction88.mmObject());
				previousVersion_lazy = () -> PaymentTransaction60.mmObject();
			}
		});
	...
	public PaymentTransaction81 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction81 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction81 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public PaymentTransaction81 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
	...
	public PaymentTransaction81 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
	...
	public PaymentTransaction81 setOriginalTransactionReference(OriginalTransactionReference24 originalTransactionReference) {
	...
	public PaymentTransaction81 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
