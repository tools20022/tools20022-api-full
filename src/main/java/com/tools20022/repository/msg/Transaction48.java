...
public class Transaction48 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction48.mmAccountOwnerTransactionIdentification, Transaction48.mmAccountServicerTransactionIdentification, Transaction48.mmMarketInfrastructureTransactionIdentification,
						Transaction48.mmProcessorTransactionIdentification, Transaction48.mmTradeIdentification, Transaction48.mmPoolIdentification, Transaction48.mmCommonIdentification, Transaction48.mmCorporateActionEventIdentification,
						Transaction48.mmTripartyAgentCollateralTransactionIdentification, Transaction48.mmClientTripartyCollateralTransactionIdentification, Transaction48.mmClientCollateralInstructionIdentification,
						Transaction48.mmTripartyCollateralInstructionIdentification, Transaction48.mmTransactionDetails);
