...
public class Linkages4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Linkages4.mmProcessingPosition, Linkages4.mmMessageNumber, Linkages4.mmReference, Linkages4.mmLinkedQuantity);
	...
	public void setReference(References12Choice reference) {
