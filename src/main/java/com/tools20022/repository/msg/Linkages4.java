 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages4#ProcessingPosition
 * Linkages4.ProcessingPosition}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages4#MessageNumber
 * Linkages4.MessageNumber}</li>
...
public class Linkages4 {
	...
	public static final MMMessageAssociationEnd ProcessingPosition = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Linkages4.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages4.ProcessingPosition, com.tools20022.repository.msg.Linkages4.MessageNumber, com.tools20022.repository.msg.Linkages4.Reference,
						com.tools20022.repository.msg.Linkages4.LinkedQuantity);
