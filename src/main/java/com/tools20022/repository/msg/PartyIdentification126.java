 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PartyIdentification126#mmName
...
@XmlType(name = "PartyIdentification126", propOrder = {"name", "postalAddress", "identification", "countryOfResidence", "contactDetails"})
public class PartyIdentification126 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PartyIdentification126
	 * PartyIdentification126}</li>
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification126.mmObject();
			isDerived = false;
			xmlTag = "Nm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Name";
			definition = "Name by which a party is known and which is usually used to identify that party.";
			previousVersion_lazy = () -> PartyIdentification40.mmName;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPostalAddress = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification40.mmPostalAddress;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	@XmlElement(name = "Id")
	protected PersonIdentification13 identification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification40.mmIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PersonIdentification13.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmCountryOfResidence = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification40.mmCountryOfResidence;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmContactDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification40.mmContactDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.msg.PartyIdentification126.mmName, com.tools20022.repository.msg.PartyIdentification126.mmPostalAddress, com.tools20022.repository.msg.PartyIdentification126.mmIdentification,
								com.tools20022.repository.msg.PartyIdentification126.mmCountryOfResidence, com.tools20022.repository.msg.PartyIdentification126.mmContactDetails);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PartyIdentification126";
				definition = "Set of elements used to identify a person or an organisation.";
				previousVersion_lazy = () -> PartyIdentification40.mmObject();
			}
		});
	...
	public PartyIdentification126 setName(Max140Text name) {
		this.name = name;
		return this;
	}
	...
	public PartyIdentification126 setPostalAddress(com.tools20022.repository.msg.PostalAddress6 postalAddress) {
		this.postalAddress = postalAddress;
		return this;
	}

	public Optional<PersonIdentification13> getIdentification() {
		return identification == null ? Optional.empty() : Optional.of(identification);
	}

	public PartyIdentification126 setIdentification(com.tools20022.repository.msg.PersonIdentification13 identification) {
	...
	public PartyIdentification126 setCountryOfResidence(CountryCode countryOfResidence) {
	...
	public PartyIdentification126 setContactDetails(com.tools20022.repository.msg.ContactDetails2 contactDetails) {
