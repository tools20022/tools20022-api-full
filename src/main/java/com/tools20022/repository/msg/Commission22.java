 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Commission17
 * Commission17}</li>
 * </ul>
 */
...
public class Commission22 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.Commission22 Commission22}</li>
	...
	public static final MMMessageAssociationEnd<Commission22, CommissionType3Choice> mmType = new MMMessageAssociationEnd<Commission22, CommissionType3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmType);
			previousVersion_lazy = () -> Commission17.mmType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<Commission22, Optional<CommissionBasis1Choice>> mmBasis = new MMMessageAssociationEnd<Commission22, Optional<CommissionBasis1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmBasis);
			previousVersion_lazy = () -> Commission17.mmBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<Commission22, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<Commission22, ActiveCurrencyAnd13DecimalAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmAmount);
			previousVersion_lazy = () -> Commission17.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<Commission22, Optional<PartyIdentification2Choice>> mmRecipientIdentification = new MMMessageAttribute<Commission22, Optional<PartyIdentification2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmRecipientIdentification);
			previousVersion_lazy = () -> Commission17.mmRecipientIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<Commission22, Optional<Max35Text>> mmCommercialAgreementReference = new MMMessageAttribute<Commission22, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmCommercialAgreementReference);
			previousVersion_lazy = () -> Commission17.mmCommercialAgreementReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<Commission22, Optional<CommissionWaiver4>> mmWaivingDetails = new MMMessageAssociationEnd<Commission22, Optional<CommissionWaiver4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Commission23.mmWaivingDetails);
			previousVersion_lazy = () -> Commission17.mmWaivingDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public Commission22 setType(CommissionType3Choice type) {
	...
	public Commission22 setBasis(CommissionBasis1Choice basis) {
		this.basis = basis;
		return this;
	}
	...
	public Commission22 setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public Commission22 setRecipientIdentification(PartyIdentification2Choice recipientIdentification) {
	...
	public Commission22 setCommercialAgreementReference(Max35Text commercialAgreementReference) {
