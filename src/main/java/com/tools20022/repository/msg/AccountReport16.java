 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AccountReport16#Identification
 ...
 * <li>{@linkplain com.tools20022.repository.msg.AccountReport16#FromToDate
...
public class AccountReport16 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountReport18#Identification
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AccountReport16.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.Identification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReportPagination = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.ReportPagination);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ElectronicSequenceNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.ElectronicSequenceNumber);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LegalSequenceNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.LegalSequenceNumber);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Number.mmObject();
		}
	...
	public static final MMMessageAttribute CreationDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.CreationDateTime);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FromToDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.FromToDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CopyDuplicateIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.CopyDuplicateIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReportingSource = new MMMessageAssociationEnd() {
		{
			...
			definition = "Specifies the application used to generate the reporting.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.ReportingSource);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Account = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.Account);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountReport18#RelatedAccount
	...
	public static final MMMessageAssociationEnd RelatedAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.RelatedAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Interest = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.Interest);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Balance = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.Balance);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd TransactionsSummary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.TransactionsSummary);
			minOccurs = 0;
			maxOccurs = 1;
	...
	/**
	 * Set of elements used to specify an entry in the report. Usage: At least
	 * one reference must be provided to identify the entry and its underlying
	 * transaction(s).
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAssociationEnd Entry = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.Entry);
			minOccurs = 0;
	...
	public static final MMMessageAttribute AdditionalReportInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport18.AdditionalReportInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountReport16.Identification, com.tools20022.repository.msg.AccountReport16.ReportPagination,
						com.tools20022.repository.msg.AccountReport16.ElectronicSequenceNumber, com.tools20022.repository.msg.AccountReport16.LegalSequenceNumber, com.tools20022.repository.msg.AccountReport16.CreationDateTime,
						com.tools20022.repository.msg.AccountReport16.FromToDate, com.tools20022.repository.msg.AccountReport16.CopyDuplicateIndicator, com.tools20022.repository.msg.AccountReport16.ReportingSource,
						com.tools20022.repository.msg.AccountReport16.Account, com.tools20022.repository.msg.AccountReport16.RelatedAccount, com.tools20022.repository.msg.AccountReport16.Interest,
						com.tools20022.repository.msg.AccountReport16.Balance, com.tools20022.repository.msg.AccountReport16.TransactionsSummary, com.tools20022.repository.msg.AccountReport16.Entry,
						com.tools20022.repository.msg.AccountReport16.AdditionalReportInformation);
				trace_lazy = () -> CashBalance.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.BankToCustomerAccountReportV04.Report);
