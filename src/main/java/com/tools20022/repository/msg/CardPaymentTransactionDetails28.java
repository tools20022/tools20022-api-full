...
public class CardPaymentTransactionDetails28 {
	...
	public static final MMMessageAttribute Currency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.Currency;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.Currency);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TotalAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.TotalAmount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.TotalAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DetailedAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.DetailedAmount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.DetailedAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InvoiceAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.InvoiceAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ValidityDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.ValidityDate;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.ValidityDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AccountType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.AccountType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.AccountType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ICCRelatedData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails20.ICCRelatedData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails42.ICCRelatedData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails28.Currency, com.tools20022.repository.msg.CardPaymentTransactionDetails28.TotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails28.DetailedAmount, com.tools20022.repository.msg.CardPaymentTransactionDetails28.InvoiceAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails28.ValidityDate, com.tools20022.repository.msg.CardPaymentTransactionDetails28.AccountType,
						com.tools20022.repository.msg.CardPaymentTransactionDetails28.ICCRelatedData);
				...
				previousVersion_lazy = () -> CardPaymentTransactionDetails20.mmObject();
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails42.mmObject());
			}
		});
