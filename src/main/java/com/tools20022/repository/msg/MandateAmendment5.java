	...
	public static final MMMessageAssociationEnd mmOriginalMessageInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> MandateAmendment4.mmOriginalMessageInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmendmentReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> MandateAmendment4.mmAmendmentReason;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmMandate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> MandateAmendment4.mmMandate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalMandate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> MandateAmendment4.mmOriginalMandate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmSupplementaryData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> MandateAmendment4.mmSupplementaryData;
			minOccurs = 0;
