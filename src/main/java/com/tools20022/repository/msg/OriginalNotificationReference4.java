...
public class OriginalNotificationReference4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalNotificationReference4.mmAccount, OriginalNotificationReference4.mmAccountOwner, OriginalNotificationReference4.mmAccountServicer,
						OriginalNotificationReference4.mmRelatedAccount, OriginalNotificationReference4.mmTotalAmount, OriginalNotificationReference4.mmExpectedValueDate, OriginalNotificationReference4.mmDebtor,
						OriginalNotificationReference4.mmDebtorAgent, OriginalNotificationReference4.mmIntermediaryAgent, OriginalNotificationReference4.mmOriginalItem);
