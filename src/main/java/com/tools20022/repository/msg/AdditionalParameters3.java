...
public class AdditionalParameters3 {
	...
	public static final MMMessageAttribute mmPartialSettlement = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalParameters3.mmObject();
			isDerived = false;
			xmlTag = "PrtlSttlm";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.IntraPositionMovementConfirmationV01.mmAdditionalParameters);
	...
	public PartialSettlement1Code getPartialSettlement() {
		return partialSettlement;
	}

	public void setPartialSettlement(PartialSettlement1Code partialSettlement) {
