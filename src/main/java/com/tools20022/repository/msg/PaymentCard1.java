...
public class PaymentCard1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentCard1.mmProtectedCardData, PaymentCard1.mmPlainCardData, PaymentCard1.mmCardCountryCode, PaymentCard1.mmCardProductProfile, PaymentCard1.mmCardBrand,
						PaymentCard1.mmAdditionalCardData);
