...
public class PartyIdentificationAndAccount67 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount67.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount67.mmIdentification, PartyIdentificationAndAccount67.mmAlternateIdentification, PartyIdentificationAndAccount67.mmSafekeepingAccount,
						PartyIdentificationAndAccount67.mmProcessingIdentification, PartyIdentificationAndAccount67.mmAdditionalInformation);
	...
	public void setIdentification(PartyIdentification63Choice identification) {
