...
public class DeniedReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedReason4.mmCode, DeniedReason4.mmAdditionalReasonInformation);
	...
	public void setCode(DeniedReason6Choice code) {
		this.code = code;
	}
