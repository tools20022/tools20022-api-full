...
public class CorporateActionGeneralInformation54 {
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes43.mmObject();
		}
	};
	...
	public CorporateActionGeneralInformation54 setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes43 underlyingSecurity) {
