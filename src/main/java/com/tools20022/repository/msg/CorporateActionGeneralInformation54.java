...
import com.tools20022.repository.msg.FinancialInstrumentAttributes43;
 ...
 * CorporateActionGeneralInformation54.mmCorporateActionEventIdentification}</li>
 * <li>
 ...
 * CorporateActionGeneralInformation54.mmAdditionalBusinessProcessIndicator}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation54", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "classActionNumber", "eventProcessingType", "eventType", "mandatoryVoluntaryEventType",
...
public class CorporateActionGeneralInformation54 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation54, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation54, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation54, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation54, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmOfficialCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation54, Optional<Max35Text>> mmClassActionNumber = new MMMessageAttribute<CorporateActionGeneralInformation54, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmClassActionNumber);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation54, Optional<CorporateActionEventProcessingTypeChoice>> mmEventProcessingType = new MMMessageAssociationEnd<CorporateActionGeneralInformation54, Optional<CorporateActionEventProcessingTypeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmEventProcessingType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionEventProcessingTypeChoice> getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getEventProcessingType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, Optional<CorporateActionEventProcessingTypeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation54, CorporateActionEventType14Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation54, CorporateActionEventType14Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmEventType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionEventType14Choice getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, CorporateActionEventType14Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation54, CorporateActionMandatoryVoluntary1Choice> mmMandatoryVoluntaryEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation54, CorporateActionMandatoryVoluntary1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmMandatoryVoluntaryEventType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionMandatoryVoluntary1Choice getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, CorporateActionMandatoryVoluntary1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation54, Optional<AdditionalBusinessProcessFormat2Choice>> mmAdditionalBusinessProcessIndicator = new MMMessageAssociationEnd<CorporateActionGeneralInformation54, Optional<AdditionalBusinessProcessFormat2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmAdditionalBusinessProcessIndicator);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AdditionalBusinessProcessFormat2Choice> getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getAdditionalBusinessProcessIndicator();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, Optional<AdditionalBusinessProcessFormat2Choice> value) {
			obj.setAdditionalBusinessProcessIndicator(value.orElse(null));
		}
	};
	@XmlElement(name = "UndrlygScty", required = true)
	protected FinancialInstrumentAttributes43 underlyingSecurity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation54, FinancialInstrumentAttributes43> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation54, FinancialInstrumentAttributes43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmUnderlyingSecurity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentAttributes43.mmObject();
		}

		@Override
		public FinancialInstrumentAttributes43 getValue(CorporateActionGeneralInformation54 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation54 obj, FinancialInstrumentAttributes43 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmClassActionNumber,
						com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmEventProcessingType, com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmMandatoryVoluntaryEventType, com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmAdditionalBusinessProcessIndicator,
						com.tools20022.repository.msg.CorporateActionGeneralInformation54.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdviceV04.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation54,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation54);
				...
				name = "CorporateActionGeneralInformation54";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmObject());
				previousVersion_lazy = () -> CorporateActionGeneralInformation38.mmObject();
			}
		});
	...
	public CorporateActionGeneralInformation54 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation54 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation54 setClassActionNumber(Max35Text classActionNumber) {
	...
	public CorporateActionGeneralInformation54 setEventProcessingType(CorporateActionEventProcessingTypeChoice eventProcessingType) {
	...
	public CorporateActionGeneralInformation54 setEventType(CorporateActionEventType14Choice eventType) {
	...
	public CorporateActionGeneralInformation54 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary1Choice mandatoryVoluntaryEventType) {
	...
	public CorporateActionGeneralInformation54 setAdditionalBusinessProcessIndicator(AdditionalBusinessProcessFormat2Choice additionalBusinessProcessIndicator) {
		this.additionalBusinessProcessIndicator = additionalBusinessProcessIndicator;
		return this;
	}

	public FinancialInstrumentAttributes43 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public CorporateActionGeneralInformation54 setUnderlyingSecurity(FinancialInstrumentAttributes43 underlyingSecurity) {
