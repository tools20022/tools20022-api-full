...
public class CorporateActionOption6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption6.mmOptionNumber, CorporateActionOption6.mmOptionType, CorporateActionOption6.mmInstructedOrQuantityToReceive);
