...
public class CardPaymentDataSetTransaction17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction17.mmTransactionSequenceCounter, CardPaymentDataSetTransaction17.mmTraceability, CardPaymentDataSetTransaction17.mmEnvironment,
						CardPaymentDataSetTransaction17.mmTransaction, CardPaymentDataSetTransaction17.mmTransactionResponse);
