...
public class CorporateActionOption20 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption20.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	protected List<com.tools20022.repository.msg.SecuritiesOption13> securitiesMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmSecuritiesMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SecuritiesOption13.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.CashOption11> cashMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmCashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashOption11.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption20.mmOptionNumber, CorporateActionOption20.mmOptionType, CorporateActionOption20.mmFractionDisposition, CorporateActionOption20.mmOfferType,
						CorporateActionOption20.mmOptionFeatures, CorporateActionOption20.mmIntermediateSecuritiesDistributionType, CorporateActionOption20.mmOptionAvailabilityStatus, CorporateActionOption20.mmCertificationType,
						CorporateActionOption20.mmNonDomicileCountry, CorporateActionOption20.mmValidDomicileCountry, CorporateActionOption20.mmCurrencyOption, CorporateActionOption20.mmDefaultProcessingOrStandingInstruction,
						CorporateActionOption20.mmChargesAppliedIndicator, CorporateActionOption20.mmCertificationIndicator, CorporateActionOption20.mmWithdrawalAllowedIndicator, CorporateActionOption20.mmChangeAllowedIndicator,
						CorporateActionOption20.mmSecurityIdentification, CorporateActionOption20.mmDateDetails, CorporateActionOption20.mmPeriodDetails, CorporateActionOption20.mmRateAndAmountDetails,
						CorporateActionOption20.mmPriceDetails, CorporateActionOption20.mmSecuritiesQuantity, CorporateActionOption20.mmSecuritiesMovementDetails, CorporateActionOption20.mmCashMovementDetails,
						CorporateActionOption20.mmAdditionalInformation);
	...
	public void setOptionFeatures(List<OptionFeaturesFormat6Choice> optionFeatures) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption13> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption11> cashMovementDetails) {
