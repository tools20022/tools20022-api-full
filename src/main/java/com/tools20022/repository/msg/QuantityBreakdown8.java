...
public class QuantityBreakdown8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown8.mmLotNumber, QuantityBreakdown8.mmLotQuantity, QuantityBreakdown8.mmLotDateTime, QuantityBreakdown8.mmLotPrice, QuantityBreakdown8.mmTypeOfPrice,
						QuantityBreakdown8.mmAccountBaseCurrencyAmounts, QuantityBreakdown8.mmInstrumentCurrencyAmounts, QuantityBreakdown8.mmAlternateReportingCurrencyAmounts);
