...
public class StandingSettlementInstruction11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StandingSettlementInstruction11.mmSettlementStandingInstructionDatabase, StandingSettlementInstruction11.mmCounterparty, StandingSettlementInstruction11.mmVendor,
						StandingSettlementInstruction11.mmOtherDeliveringSettlementParties, StandingSettlementInstruction11.mmOtherReceivingSettlementParties);
