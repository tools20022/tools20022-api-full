...
public class GenericIdentification51 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification51.Identification, com.tools20022.repository.msg.GenericIdentification51.Issuer,
						com.tools20022.repository.msg.GenericIdentification51.SchemeName);
