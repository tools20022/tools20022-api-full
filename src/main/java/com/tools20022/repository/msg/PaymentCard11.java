...
@XmlType(name = "PaymentCard11", propOrder = {"protectedCardData", "plainCardData", "maskedPAN", "issuerBIN", "cardCountryCode", "cardCurrencyCode", "cardProductProfile", "cardBrand", "cardProductType", "additionalCardData"})
public class PaymentCard11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCard11, Optional<ContentInformationType10>> mmProtectedCardData = new MMMessageAssociationEnd<PaymentCard11, Optional<ContentInformationType10>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard13.mmProtectedCardData, PaymentCard20.mmProtectedCardData);
		...
		@Override
		public Optional<ContentInformationType10> getValue(PaymentCard11 obj) {
			return obj.getProtectedCardData();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<ContentInformationType10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCard11, Optional<PlainCardData9>> mmPlainCardData = new MMMessageAssociationEnd<PaymentCard11, Optional<PlainCardData9>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard13.mmPlainCardData, PaymentCard20.mmPlainCardData);
		...
		@Override
		public Optional<PlainCardData9> getValue(PaymentCard11 obj) {
			return obj.getPlainCardData();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<PlainCardData9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max30Text>> mmMaskedPAN = new MMMessageAttribute<PaymentCard11, Optional<Max30Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			xmlTag = "MskdPAN";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard13.mmMaskedPAN, PaymentCard20.mmMaskedPAN);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max30Text> getValue(PaymentCard11 obj) {
			return obj.getMaskedPAN();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Max30Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max15NumericText>> mmIssuerBIN = new MMMessageAttribute<PaymentCard11, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			xmlTag = "IssrBIN";
			...
			name = "IssuerBIN";
			definition = "Bank identifier number of the issuer for routing purpose.";
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmIssuerBIN);
		...
		@Override
		public Optional<Max15NumericText> getValue(PaymentCard11 obj) {
			return obj.getIssuerBIN();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max3Text>> mmCardCountryCode = new MMMessageAttribute<PaymentCard11, Optional<Max3Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmCardCountryCode);
		...
		@Override
		public Optional<Max3Text> getValue(PaymentCard11 obj) {
			return obj.getCardCountryCode();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Max3Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Exact3AlphaNumericText>> mmCardCurrencyCode = new MMMessageAttribute<PaymentCard11, Optional<Exact3AlphaNumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			xmlTag = "CardCcyCd";
			...
			definition = "Currency code of the card issuer (ISO 4217 numeric code).";
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmCardCurrencyCode);
		...
		@Override
		public Optional<Exact3AlphaNumericText> getValue(PaymentCard11 obj) {
			return obj.getCardCurrencyCode();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Exact3AlphaNumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max35Text>> mmCardProductProfile = new MMMessageAttribute<PaymentCard11, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			xmlTag = "CardPdctPrfl";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmCardProductProfile);
		...
		@Override
		public Optional<Max35Text> getValue(PaymentCard11 obj) {
			return obj.getCardProductProfile();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max35Text>> mmCardBrand = new MMMessageAttribute<PaymentCard11, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmCardBrand);
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<CardProductType1Code>> mmCardProductType = new MMMessageAttribute<PaymentCard11, Optional<CardProductType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			xmlTag = "CardPdctTp";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard13.mmCardProductType, PaymentCard20.mmCardProductType);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardProductType1Code> getValue(PaymentCard11 obj) {
			return obj.getCardProductType();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<CardProductType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCard11, Optional<Max70Text>> mmAdditionalCardData = new MMMessageAttribute<PaymentCard11, Optional<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCard11.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentCard20.mmAdditionalCardData);
		...
		@Override
		public Optional<Max70Text> getValue(PaymentCard11 obj) {
			return obj.getAdditionalCardData();
		}

		@Override
		public void setValue(PaymentCard11 obj, Optional<Max70Text> value) {
	...
	public PaymentCard11 setProtectedCardData(ContentInformationType10 protectedCardData) {
	...
	public PaymentCard11 setPlainCardData(PlainCardData9 plainCardData) {
	...
	public PaymentCard11 setMaskedPAN(Max30Text maskedPAN) {
	...
	public PaymentCard11 setIssuerBIN(Max15NumericText issuerBIN) {
	...
	public PaymentCard11 setCardCountryCode(Max3Text cardCountryCode) {
	...
	public PaymentCard11 setCardCurrencyCode(Exact3AlphaNumericText cardCurrencyCode) {
	...
	public PaymentCard11 setCardProductProfile(Max35Text cardProductProfile) {
	...
	public PaymentCard11 setCardBrand(Max35Text cardBrand) {
	...
	public PaymentCard11 setCardProductType(CardProductType1Code cardProductType) {
	...
	public PaymentCard11 setAdditionalCardData(Max70Text additionalCardData) {
