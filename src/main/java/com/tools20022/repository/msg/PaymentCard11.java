...
public class PaymentCard11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentCard11.mmProtectedCardData, PaymentCard11.mmPlainCardData, PaymentCard11.mmMaskedPAN, PaymentCard11.mmIssuerBIN, PaymentCard11.mmCardCountryCode,
						PaymentCard11.mmCardCurrencyCode, PaymentCard11.mmCardProductProfile, PaymentCard11.mmCardBrand, PaymentCard11.mmCardProductType, PaymentCard11.mmAdditionalCardData);
