 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown9#mmLotNumber
 ...
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown9#mmLotPrice
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityBreakdown9
 * ConstraintCoexistenceQuantityRule.forQuantityBreakdown9}</li>
 * </ul>
 * </li>
 * <li>
...
public class QuantityBreakdown9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<Number2Choice>> mmLotNumber = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<Number2Choice>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown9.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<Number2Choice> getValue(QuantityBreakdown9 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<Number2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<FinancialInstrumentQuantity1Choice>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(QuantityBreakdown9 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<GenericIdentification19>> mmSecuritiesSubBalanceType = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<GenericIdentification19>>() {
		{
		...
		@Override
		public Optional<GenericIdentification19> getValue(QuantityBreakdown9 obj) {
			return obj.getSecuritiesSubBalanceType();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<GenericIdentification19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<DateAndDateTimeChoice>> mmLotDateTime = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(QuantityBreakdown9 obj) {
			return obj.getLotDateTime();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<Price2>> mmLotPrice = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<Price2>>() {
		{
		...
		@Override
		public Optional<Price2> getValue(QuantityBreakdown9 obj) {
			return obj.getLotPrice();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown9, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAssociationEnd<QuantityBreakdown9, Optional<TypeOfPrice3Choice>>() {
		{
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(QuantityBreakdown9 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(QuantityBreakdown9 obj, Optional<TypeOfPrice3Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown9.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown9.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown9.mmSecuritiesSubBalanceType, com.tools20022.repository.msg.QuantityBreakdown9.mmLotDateTime, com.tools20022.repository.msg.QuantityBreakdown9.mmLotPrice,
						com.tools20022.repository.msg.QuantityBreakdown9.mmTypeOfPrice);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityBreakdown9);
	...
	public QuantityBreakdown9 setLotNumber(Number2Choice lotNumber) {
	...
	public QuantityBreakdown9 setLotQuantity(FinancialInstrumentQuantity1Choice lotQuantity) {
	...
	public QuantityBreakdown9 setSecuritiesSubBalanceType(GenericIdentification19 securitiesSubBalanceType) {
	...
	public QuantityBreakdown9 setLotDateTime(DateAndDateTimeChoice lotDateTime) {
	...
	public QuantityBreakdown9 setLotPrice(Price2 lotPrice) {
	...
	public QuantityBreakdown9 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
