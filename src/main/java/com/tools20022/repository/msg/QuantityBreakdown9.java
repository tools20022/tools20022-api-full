...
public class QuantityBreakdown9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown9.mmLotNumber, QuantityBreakdown9.mmLotQuantity, QuantityBreakdown9.mmSecuritiesSubBalanceType, QuantityBreakdown9.mmLotDateTime, QuantityBreakdown9.mmLotPrice,
						QuantityBreakdown9.mmTypeOfPrice);
