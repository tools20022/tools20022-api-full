...
public class PartyIdentificationAndAccount40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount40.mmIdentification, PartyIdentificationAndAccount40.mmAlternateIdentification, PartyIdentificationAndAccount40.mmCountryOfResidence,
						PartyIdentificationAndAccount40.mmSafekeepingAccount, PartyIdentificationAndAccount40.mmProcessingIdentification, PartyIdentificationAndAccount40.mmAdditionalInformation);
