...
public class FinancialInstrumentAttributes18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes18.mmSecurityIdentification, FinancialInstrumentAttributes18.mmPlaceOfListing, FinancialInstrumentAttributes18.mmDayCountBasis,
						FinancialInstrumentAttributes18.mmClassificationType, FinancialInstrumentAttributes18.mmDenominationCurrency, FinancialInstrumentAttributes18.mmNextCouponDate, FinancialInstrumentAttributes18.mmExpiryDate,
						FinancialInstrumentAttributes18.mmFloatingRateFixingDate, FinancialInstrumentAttributes18.mmMaturityDate, FinancialInstrumentAttributes18.mmIssueDate, FinancialInstrumentAttributes18.mmNextCallableDate,
						FinancialInstrumentAttributes18.mmPutableDate, FinancialInstrumentAttributes18.mmDatedDate, FinancialInstrumentAttributes18.mmConversionDate, FinancialInstrumentAttributes18.mmPreviousFactor,
						FinancialInstrumentAttributes18.mmNextFactor, FinancialInstrumentAttributes18.mmInterestRate, FinancialInstrumentAttributes18.mmNextInterestRate, FinancialInstrumentAttributes18.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes18.mmMinimumExercisableQuantity, FinancialInstrumentAttributes18.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes18.mmContractSize);
