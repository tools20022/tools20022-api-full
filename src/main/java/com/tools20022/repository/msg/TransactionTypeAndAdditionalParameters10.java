...
public class TransactionTypeAndAdditionalParameters10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters10.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters10.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters10.mmSecuritiesMovementType, TransactionTypeAndAdditionalParameters10.mmPayment,
						TransactionTypeAndAdditionalParameters10.mmCommonIdentification, TransactionTypeAndAdditionalParameters10.mmPoolIdentification, TransactionTypeAndAdditionalParameters10.mmCorporateActionEventIdentification);
