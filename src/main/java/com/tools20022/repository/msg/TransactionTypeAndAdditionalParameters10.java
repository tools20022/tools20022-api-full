 ...
 * TransactionTypeAndAdditionalParameters10.mmSecuritiesFinancingTransactionType
 * }</li>
 * <li>
 ...
 * TransactionTypeAndAdditionalParameters10.mmCorporateActionEventIdentification
 * }</li>
 * </ul>
 * </li>
...
public class TransactionTypeAndAdditionalParameters10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionTypeAndAdditionalParameters10 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters10 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmAccountServicerTransactionIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionTypeAndAdditionalParameters10 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters10 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, SecuritiesFinancingTransactionType1Code> mmSecuritiesFinancingTransactionType = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, SecuritiesFinancingTransactionType1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmSecuritiesFinancingTransactionType);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmSecuritiesFinancingTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesFinancingTransactionType1Code getValue(TransactionTypeAndAdditionalParameters10 obj) {
			return obj.getSecuritiesFinancingTransactionType();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters10 obj, SecuritiesFinancingTransactionType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmSecuritiesMovementType);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionTypeAndAdditionalParameters10 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters10 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmPayment);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionTypeAndAdditionalParameters10 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters10 obj, DeliveryReceiptType2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmCommonIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmPoolIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmSecuritiesFinancingTransactionType, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmSecuritiesMovementType,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmPayment, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmCommonIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmPoolIdentification, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters10.mmCorporateActionEventIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingConfirmationV06.mmTransactionIdentificationDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosingRule.forTransactionTypeAndAdditionalParameters10);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionTypeAndAdditionalParameters10";
				definition = "Specifies the conditions under which the order/trade is to be settled.";
				nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters16.mmObject());
				previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters3.mmObject();
			}
		});
	...
	public TransactionTypeAndAdditionalParameters10 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionTypeAndAdditionalParameters10 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionTypeAndAdditionalParameters10 setSecuritiesFinancingTransactionType(SecuritiesFinancingTransactionType1Code securitiesFinancingTransactionType) {
	...
	public TransactionTypeAndAdditionalParameters10 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionTypeAndAdditionalParameters10 setPayment(DeliveryReceiptType2Code payment) {
	...
	public TransactionTypeAndAdditionalParameters10 setCommonIdentification(Max35Text commonIdentification) {
	...
	public TransactionTypeAndAdditionalParameters10 setPoolIdentification(Max35Text poolIdentification) {
	...
	public TransactionTypeAndAdditionalParameters10 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
