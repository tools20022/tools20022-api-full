...
public class StatusAndReason4 {
	...
	public static final MMMessageAssociationEnd mmStatusAndReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> StatusAndReason4.mmObject();
			isDerived = false;
			xmlTag = "StsAndRsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StatusAndReason4.mmStatusAndReason, StatusAndReason4.mmTransaction);
	...
	public void setStatusAndReason(Status4Choice statusAndReason) {
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction9> transaction) {
