...
public class CancellationReason18 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancellationReason18.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationReason18.mmCode, CancellationReason18.mmAdditionalReasonInformation);
	...
	public void setCode(CancellationReason28Choice code) {
		this.code = code;
	}
