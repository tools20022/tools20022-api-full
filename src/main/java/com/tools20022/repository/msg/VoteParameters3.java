...
public class VoteParameters3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(VoteParameters3.mmSecuritiesQuantityRequiredToVote, VoteParameters3.mmPartialVoteAllowed, VoteParameters3.mmSplitVoteAllowed, VoteParameters3.mmVoteDeadline,
						VoteParameters3.mmVoteSTPDeadline, VoteParameters3.mmVoteMarketDeadline, VoteParameters3.mmVoteMethods, VoteParameters3.mmVotingBallotElectronicAddress, VoteParameters3.mmVotingBallotRequestAddress,
						VoteParameters3.mmRevocabilityDeadline, VoteParameters3.mmRevocabilitySTPDeadline, VoteParameters3.mmRevocabilityMarketDeadline, VoteParameters3.mmBeneficialOwnerDisclosure, VoteParameters3.mmVoteInstructionType,
						VoteParameters3.mmIncentivePremium, VoteParameters3.mmVoteWithPremiumDeadline, VoteParameters3.mmVoteWithPremiumSTPDeadline, VoteParameters3.mmVoteWithPremiumMarketDeadline,
						VoteParameters3.mmAdditionalVotingRequirements);
