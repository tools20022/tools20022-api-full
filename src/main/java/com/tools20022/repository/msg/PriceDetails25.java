...
import com.tools20022.repository.choice.PriceFormat60Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails25
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails25}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails25", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails25, Optional<PriceFormat59Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails25, Optional<PriceFormat59Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails25.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat59Choice> getValue(PriceDetails25 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails25 obj, Optional<PriceFormat59Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails25, Optional<PriceFormat60Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails25, Optional<PriceFormat60Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat60Choice> getValue(PriceDetails25 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails25 obj, Optional<PriceFormat60Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails25.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails25.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails25);
	...
	public PriceDetails25 setGenericCashPricePaidPerProduct(PriceFormat59Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails25 setGenericCashPriceReceivedPerProduct(PriceFormat60Choice genericCashPriceReceivedPerProduct) {
