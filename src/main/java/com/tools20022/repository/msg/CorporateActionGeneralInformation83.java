...
public class CorporateActionGeneralInformation83 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation83.mmCorporateActionEventIdentification, CorporateActionGeneralInformation83.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation83.mmClassActionNumber, CorporateActionGeneralInformation83.mmEventType, CorporateActionGeneralInformation83.mmFinancialInstrumentIdentification,
						CorporateActionGeneralInformation83.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation83.mmIntermediateSecuritiesDistributionType, CorporateActionGeneralInformation83.mmFractionalQuantity);
