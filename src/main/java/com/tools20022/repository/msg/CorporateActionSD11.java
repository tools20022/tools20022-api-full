...
@XmlType(name = "CorporateActionSD11", propOrder = {"placeAndName", "noticeType", "eventCashValue", "numberOfSharesToBeIssued", "totalNumberOfSharesOffered", "cutOffDays", "dTCAutomatedOfferProgram", "dTCRecycleCutOffIndicator",
...
public class CorporateActionSD11 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEDSMessagingCountryCodeGuideline.forCorporateActionSD11);
	...
	public CorporateActionSD11 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionSD11 setNoticeType(NoticeType1Code noticeType) {
	...
	public CorporateActionSD11 setEventCashValue(RestrictedFINActiveCurrencyAnd13DecimalAmount eventCashValue) {
	...
	public CorporateActionSD11 setNumberOfSharesToBeIssued(DecimalNumber numberOfSharesToBeIssued) {
	...
	public CorporateActionSD11 setTotalNumberOfSharesOffered(DecimalNumber totalNumberOfSharesOffered) {
	...
	public CorporateActionSD11 setCutOffDays(Max3Number cutOffDays) {
	...
	public CorporateActionSD11 setDTCAutomatedOfferProgram(DTCAutoOfferProgram1Code dTCAutomatedOfferProgram) {
	...
	public CorporateActionSD11 setDTCRecycleCutOffIndicator(CutOff1Code dTCRecycleCutOffIndicator) {
	...
	public CorporateActionSD11 setLongShortPaymentIndicator(AccrualPeriodType1Code longShortPaymentIndicator) {
	...
	public CorporateActionSD11 setOversubscriptionType(OversubscriptionType1Code oversubscriptionType) {
	...
	public CorporateActionSD11 setConditionalPaymentApplicableFlag(YesNoIndicator conditionalPaymentApplicableFlag) {
	...
	public CorporateActionSD11 setSolicitationDealerFeeFlag(YesNoIndicator solicitationDealerFeeFlag) {
	...
	public CorporateActionSD11 setDTCCustodyEligibleFlag(YesNoIndicator dTCCustodyEligibleFlag) {
	...
	public CorporateActionSD11 setDTCReorganisationCustodyEligibleFlag(YesNoIndicator dTCReorganisationCustodyEligibleFlag) {
	...
	public CorporateActionSD11 setDTCReorganisationDepositEligibleFlag(YesNoIndicator dTCReorganisationDepositEligibleFlag) {
	...
	public CorporateActionSD11 setSurrenderSharesToAgentFlag(YesNoIndicator surrenderSharesToAgentFlag) {
	...
	public CorporateActionSD11 setStepUpPrivilegeFlag(YesNoIndicator stepUpPrivilegeFlag) {
	...
	public CorporateActionSD11 setRightsOversubscriptionFlag(YesNoIndicator rightsOversubscriptionFlag) {
	...
	public CorporateActionSD11 setRightsRoundUpPrivilegeFlag(YesNoIndicator rightsRoundUpPrivilegeFlag) {
	...
	public CorporateActionSD11 setRightsTransferableFlag(YesNoIndicator rightsTransferableFlag) {
	...
	public CorporateActionSD11 setEDSMessagingCountryCode(CountryCode eDSMessagingCountryCode) {
	...
	public CorporateActionSD11 setRDPReferenceNumber(Exact32AlphaNumericText rDPReferenceNumber) {
