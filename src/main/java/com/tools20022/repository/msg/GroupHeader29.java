...
public class GroupHeader29 {
	...
	public static final MMMessageAssociationEnd mmSettlementInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SettlementInformation9.mmObject();
		}
	};
	...
	public GroupHeader29 setSettlementInformation(com.tools20022.repository.msg.SettlementInformation9 settlementInformation) {
	...
	public GroupHeader29 setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation17 paymentTypeInformation) {
	...
	public GroupHeader29 setInstructingAgent(com.tools20022.repository.msg.FinancialInstitution2 instructingAgent) {
	...
	public GroupHeader29 setInstructedAgent(com.tools20022.repository.msg.FinancialInstitution2 instructedAgent) {
