...
public class GroupHeader29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader29.mmMessageIdentification, GroupHeader29.mmCreationDateTime, GroupHeader29.mmAuthorisation, GroupHeader29.mmBatchBooking, GroupHeader29.mmNumberOfTransactions,
						GroupHeader29.mmControlSum, GroupHeader29.mmTotalInterbankSettlementAmount, GroupHeader29.mmInterbankSettlementDate, GroupHeader29.mmSettlementInformation, GroupHeader29.mmPaymentTypeInformation,
						GroupHeader29.mmInstructingAgent, GroupHeader29.mmInstructedAgent);
