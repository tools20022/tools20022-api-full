...
public class GroupHeader29 {
	...
	public static final MMMessageAttribute mmMessageIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GroupHeader29.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
	...
	public void setSettlementInformation(com.tools20022.repository.msg.SettlementInformation9 settlementInformation) {
		this.settlementInformation = settlementInformation;
	}

	public PaymentTypeInformation17 getPaymentTypeInformation() {
		return paymentTypeInformation;
	}

	public void setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation17 paymentTypeInformation) {
