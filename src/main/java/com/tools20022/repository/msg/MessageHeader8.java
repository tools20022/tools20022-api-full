 ...
 * <li>{@linkplain com.tools20022.repository.msg.MessageHeader8#mmRequestType
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.MessageHeader5
 * MessageHeader5}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "MessageHeader8", propOrder = {"messageIdentification", "creationDateTime", "messagePagination", "originalBusinessQuery", "requestType", "queryName"})
public class MessageHeader8 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.MessageHeader8 MessageHeader8}</li>
	...
	public static final MMMessageAttribute<MessageHeader8, Max35Text> mmMessageIdentification = new MMMessageAttribute<MessageHeader8, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> MessageHeader5.mmMessageIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<MessageHeader8, Optional<ISODateTime>> mmCreationDateTime = new MMMessageAttribute<MessageHeader8, Optional<ISODateTime>>() {
		{
			...
			previousVersion_lazy = () -> MessageHeader5.mmCreationDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<MessageHeader8, Optional<OriginalBusinessQuery1>> mmOriginalBusinessQuery = new MMMessageAssociationEnd<MessageHeader8, Optional<OriginalBusinessQuery1>>() {
		{
			...
			previousVersion_lazy = () -> MessageHeader5.mmOriginalBusinessQuery;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.MessageHeader5#mmRequestType
	...
	public static final MMMessageAttribute<MessageHeader8, Optional<RequestType4Choice>> mmRequestType = new MMMessageAttribute<MessageHeader8, Optional<RequestType4Choice>>() {
		{
			...
			previousVersion_lazy = () -> MessageHeader5.mmRequestType;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.MessageHeader5#mmQueryName
	...
	public static final MMMessageAttribute<MessageHeader8, Optional<Max35Text>> mmQueryName = new MMMessageAttribute<MessageHeader8, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> MessageHeader5.mmQueryName;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MessageHeader8.mmMessageIdentification, com.tools20022.repository.msg.MessageHeader8.mmCreationDateTime,
						com.tools20022.repository.msg.MessageHeader8.mmMessagePagination, com.tools20022.repository.msg.MessageHeader8.mmOriginalBusinessQuery, com.tools20022.repository.msg.MessageHeader8.mmRequestType,
						com.tools20022.repository.msg.MessageHeader8.mmQueryName);
				messageBuildingBlock_lazy = () -> Arrays.asList(ReturnTransactionV07.mmMessageHeader);
				...
				previousVersion_lazy = () -> MessageHeader5.mmObject();
			}
		});
	...
	public MessageHeader8 setMessageIdentification(Max35Text messageIdentification) {
	...
	public MessageHeader8 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public MessageHeader8 setRequestType(RequestType4Choice requestType) {
	...
	public MessageHeader8 setQueryName(Max35Text queryName) {
