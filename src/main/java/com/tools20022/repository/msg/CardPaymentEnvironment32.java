...
@XmlType(name = "CardPaymentEnvironment32", propOrder = {"acquirer", "merchant", "pOI", "card", "customerDevice", "wallet", "paymentToken", "cardholder", "protectedCardholderData"})
public class CardPaymentEnvironment32 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Acquirer4>> mmAcquirer = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Acquirer4>>() {
		{
			businessComponentTrace_lazy = () -> AcquirerRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment32.mmObject();
			isDerived = false;
			xmlTag = "Acqrr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Acquirer";
			definition = "Acquirer involved in the card payment.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmAcquirer, CardPaymentEnvironment45.mmAcquirer);
			previousVersion_lazy = () -> CardPaymentEnvironment20.mmAcquirer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Acquirer4> getValue(CardPaymentEnvironment32 obj) {
			return obj.getAcquirer();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<Acquirer4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Organisation8>> mmMerchant = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Organisation8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmMerchant, CardPaymentEnvironment45.mmMerchant);
			previousVersion_lazy = () -> CardPaymentEnvironment20.mmMerchant;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Organisation8> getValue(CardPaymentEnvironment32 obj) {
			return obj.getMerchant();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<Organisation8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentEnvironment32, PointOfInteraction4> mmPOI = new MMMessageAttribute<CardPaymentEnvironment32, PointOfInteraction4>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmPOI, CardPaymentEnvironment45.mmPOI);
		...
		@Override
		public PointOfInteraction4 getValue(CardPaymentEnvironment32 obj) {
			return obj.getPOI();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, PointOfInteraction4 value) {
			obj.setPOI(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentEnvironment32, PaymentCard9> mmCard = new MMMessageAttribute<CardPaymentEnvironment32, PaymentCard9>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmCard, CardPaymentEnvironment45.mmCard);
		...
		@Override
		public PaymentCard9 getValue(CardPaymentEnvironment32 obj) {
			return obj.getCard();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, PaymentCard9 value) {
			obj.setCard(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CustomerDevice1>> mmCustomerDevice = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CustomerDevice1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment32.mmObject();
			isDerived = false;
			xmlTag = "CstmrDvc";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmCustomerDevice, CardPaymentEnvironment45.mmCustomerDevice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CustomerDevice1> getValue(CardPaymentEnvironment32 obj) {
			return obj.getCustomerDevice();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<CustomerDevice1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CustomerDevice1>> mmWallet = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CustomerDevice1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment32.mmObject();
			isDerived = false;
			xmlTag = "Wllt";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmWallet, CardPaymentEnvironment45.mmWallet);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CustomerDevice1.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CardPaymentToken1>> mmPaymentToken = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<CardPaymentToken1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment32.mmObject();
			isDerived = false;
			xmlTag = "PmtTkn";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmPaymentToken, CardPaymentEnvironment45.mmPaymentToken);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CardPaymentToken1> getValue(CardPaymentEnvironment32 obj) {
			return obj.getPaymentToken();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<CardPaymentToken1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Cardholder7>> mmCardholder = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<Cardholder7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmCardholder, CardPaymentEnvironment45.mmCardholder);
			previousVersion_lazy = () -> CardPaymentEnvironment20.mmCardholder;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Cardholder7> getValue(CardPaymentEnvironment32 obj) {
			return obj.getCardholder();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<Cardholder7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<ContentInformationType10>> mmProtectedCardholderData = new MMMessageAssociationEnd<CardPaymentEnvironment32, Optional<ContentInformationType10>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment32.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmProtectedCardholderData, CardPaymentEnvironment45.mmProtectedCardholderData);
			previousVersion_lazy = () -> CardPaymentEnvironment20.mmProtectedCardholderData;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ContentInformationType10> getValue(CardPaymentEnvironment32 obj) {
			return obj.getProtectedCardholderData();
		}

		@Override
		public void setValue(CardPaymentEnvironment32 obj, Optional<ContentInformationType10> value) {
	...
	public CardPaymentEnvironment32 setAcquirer(Acquirer4 acquirer) {
	...
	public CardPaymentEnvironment32 setMerchant(Organisation8 merchant) {
	...
	public CardPaymentEnvironment32 setPOI(PointOfInteraction4 pOI) {
	...
	public CardPaymentEnvironment32 setCard(PaymentCard9 card) {
	...
	public CardPaymentEnvironment32 setCustomerDevice(CustomerDevice1 customerDevice) {
	...
	public CardPaymentEnvironment32 setWallet(CustomerDevice1 wallet) {
		this.wallet = wallet;
		return this;
	}
	...
	public CardPaymentEnvironment32 setPaymentToken(CardPaymentToken1 paymentToken) {
		this.paymentToken = paymentToken;
		return this;
	}

	public Optional<Cardholder7> getCardholder() {
		return cardholder == null ? Optional.empty() : Optional.of(cardholder);
	}

	public CardPaymentEnvironment32 setCardholder(Cardholder7 cardholder) {
	...
	public CardPaymentEnvironment32 setProtectedCardholderData(ContentInformationType10 protectedCardholderData) {
