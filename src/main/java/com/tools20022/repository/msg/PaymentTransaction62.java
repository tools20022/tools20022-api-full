...
@XmlType(name = "PaymentTransaction62", propOrder = {"cancellationIdentification", "case", "originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification", "originalTransactionIdentification",
...
public class PaymentTransaction62 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction62.mmCancellationIdentification, PaymentTransaction62.mmCase, PaymentTransaction62.mmOriginalGroupInformation,
						PaymentTransaction62.mmOriginalInstructionIdentification, PaymentTransaction62.mmOriginalEndToEndIdentification, PaymentTransaction62.mmOriginalTransactionIdentification,
						PaymentTransaction62.mmOriginalClearingSystemReference, PaymentTransaction62.mmOriginalInterbankSettlementAmount, PaymentTransaction62.mmOriginalInterbankSettlementDate, PaymentTransaction62.mmAssigner,
						PaymentTransaction62.mmAssignee, PaymentTransaction62.mmCancellationReasonInformation, PaymentTransaction62.mmOriginalTransactionReference, PaymentTransaction62.mmSupplementaryData);
