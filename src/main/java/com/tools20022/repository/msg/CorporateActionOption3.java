...
public class CorporateActionOption3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption3.mmOptionNumber, CorporateActionOption3.mmOptionType, CorporateActionOption3.mmFractionDisposition, CorporateActionOption3.mmOfferType,
						CorporateActionOption3.mmOptionFeatures, CorporateActionOption3.mmIntermediateSecuritiesDistributionType, CorporateActionOption3.mmOptionAvailabilityStatus, CorporateActionOption3.mmCertificationType,
						CorporateActionOption3.mmNonDomicileCountry, CorporateActionOption3.mmValidDomicileCountry, CorporateActionOption3.mmCurrencyOption, CorporateActionOption3.mmDefaultProcessingOrStandingInstruction,
						CorporateActionOption3.mmChargesAppliedIndicator, CorporateActionOption3.mmCertificationIndicator, CorporateActionOption3.mmWithdrawalAllowedIndicator, CorporateActionOption3.mmChangeAllowedIndicator,
						CorporateActionOption3.mmSecurityIdentification, CorporateActionOption3.mmDateDetails, CorporateActionOption3.mmPeriodDetails, CorporateActionOption3.mmRateAndAmountDetails, CorporateActionOption3.mmPriceDetails,
						CorporateActionOption3.mmSecuritiesQuantity, CorporateActionOption3.mmSecuritiesMovementDetails, CorporateActionOption3.mmCashMovementDetails, CorporateActionOption3.mmAdditionalInformation);
