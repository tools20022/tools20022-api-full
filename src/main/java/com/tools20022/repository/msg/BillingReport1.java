...
import com.tools20022.repository.msg.ServiceCategoryTotals1;
import java.util.*;
...
public class BillingReport1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BillingReport1, InvoiceLegalIssue1> mmRegulatoryData = new MMMessageAssociationEnd<BillingReport1, InvoiceLegalIssue1>() {
		{
		...
		@Override
		public InvoiceLegalIssue1 getValue(BillingReport1 obj) {
			return obj.getRegulatoryData();
		}

		@Override
		public void setValue(BillingReport1 obj, InvoiceLegalIssue1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BillingReport1, ISODate> mmInvoiceDate = new MMMessageAttribute<BillingReport1, ISODate>() {
		{
		...
		@Override
		public ISODate getValue(BillingReport1 obj) {
			return obj.getInvoiceDate();
		}

		@Override
		public void setValue(BillingReport1 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BillingReport1, Max35Text> mmBillingIdentification = new MMMessageAttribute<BillingReport1, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(BillingReport1 obj) {
			return obj.getBillingIdentification();
		}

		@Override
		public void setValue(BillingReport1 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BillingReport1, DatePeriodDetails> mmBillingPeriod = new MMMessageAttribute<BillingReport1, DatePeriodDetails>() {
		{
		...
		@Override
		public DatePeriodDetails getValue(BillingReport1 obj) {
			return obj.getBillingPeriod();
		}

		@Override
		public void setValue(BillingReport1 obj, DatePeriodDetails value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BillingReport1, Optional<CSDOrNCB1Choice>> mmCSDOrNCB = new MMMessageAssociationEnd<BillingReport1, Optional<CSDOrNCB1Choice>>() {
		{
		...
		@Override
		public Optional<CSDOrNCB1Choice> getValue(BillingReport1 obj) {
			return obj.getCSDOrNCB();
		}

		@Override
		public void setValue(BillingReport1 obj, Optional<CSDOrNCB1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BillingReport1, InvoiceTotals2> mmInvoiceTotals = new MMMessageAssociationEnd<BillingReport1, InvoiceTotals2>() {
		{
			businessComponentTrace_lazy = () -> Invoice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.BillingReport1.mmObject();
			isDerived = false;
		...
		@Override
		public InvoiceTotals2 getValue(BillingReport1 obj) {
			return obj.getInvoiceTotals();
		}

		@Override
		public void setValue(BillingReport1 obj, InvoiceTotals2 value) {
			obj.setInvoiceTotals(value);
		}
	};
	@XmlElement(name = "SvcCtgyTtls", required = true)
	protected List<ServiceCategoryTotals1> serviceCategoryTotals;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BillingReport1, List<ServiceCategoryTotals1>> mmServiceCategoryTotals = new MMMessageAssociationEnd<BillingReport1, List<ServiceCategoryTotals1>>() {
		{
			businessComponentTrace_lazy = () -> Invoice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.BillingReport1.mmObject();
			isDerived = false;
		...
		@Override
		public List<ServiceCategoryTotals1> getValue(BillingReport1 obj) {
			return obj.getServiceCategoryTotals();
		}

		@Override
		public void setValue(BillingReport1 obj, List<ServiceCategoryTotals1> value) {
	...
	public BillingReport1 setRegulatoryData(InvoiceLegalIssue1 regulatoryData) {
	...
	public BillingReport1 setBillingPeriod(DatePeriodDetails billingPeriod) {
	...
	public BillingReport1 setInvoiceTotals(InvoiceTotals2 invoiceTotals) {
	...
	public BillingReport1 setServiceCategoryTotals(List<ServiceCategoryTotals1> serviceCategoryTotals) {
