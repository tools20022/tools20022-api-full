...
@XmlType(name = "Unit5", propOrder = {"unitsNumber", "group1Or2Units"})
public class Unit5 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Unit5
	 * Unit5}</li>
	...
	public Unit5 setGroup1Or2Units(UKTaxGroupUnitCode group1Or2Units) {
