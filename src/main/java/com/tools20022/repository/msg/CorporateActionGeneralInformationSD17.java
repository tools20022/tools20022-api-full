...
public class CorporateActionGeneralInformationSD17 {
	...
	public static final MMMessageAttribute mmPlaceAndName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.mmPlaceAndName);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSecurityIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.mmSecurityIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.mmSecurityIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.mmSafekeepingAccount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmUnallocatedDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.mmUnallocatedDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.mmUnallocatedDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public void setUnallocatedDetails(List<com.tools20022.repository.msg.CorporateActionUnallocatedDetailsSD3> unallocatedDetails) {
