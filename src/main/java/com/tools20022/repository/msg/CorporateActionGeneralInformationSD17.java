...
public class CorporateActionGeneralInformationSD17 {
	...
	public static final MMMessageAttribute PlaceAndName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CorporateActionGeneralInformationSD17.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "xPath to the element that is being extended.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.PlaceAndName;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.PlaceAndName);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecurityIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.SecurityIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.SecurityIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SafekeepingAccount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.SafekeepingAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.SafekeepingAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UnallocatedDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD16.UnallocatedDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD20.UnallocatedDetails);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD17.PlaceAndName, com.tools20022.repository.msg.CorporateActionGeneralInformationSD17.SecurityIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformationSD17.SafekeepingAccount, com.tools20022.repository.msg.CorporateActionGeneralInformationSD17.UnallocatedDetails);
