...
public class CorporateActionOption135 {
	...
	public static final MMMessageAssociationEnd mmRateAndAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionRate84.mmObject();
		}
	};
	...
	protected List<com.tools20022.repository.msg.CashOption54> cashMovementDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmCashMovementDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashOption54.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption135.mmOptionNumber, CorporateActionOption135.mmOptionType, CorporateActionOption135.mmFractionDisposition, CorporateActionOption135.mmOfferType,
						CorporateActionOption135.mmOptionFeatures, CorporateActionOption135.mmIntermediateSecuritiesDistributionType, CorporateActionOption135.mmOptionAvailabilityStatus,
						CorporateActionOption135.mmCertificationBreakdownType, CorporateActionOption135.mmNonDomicileCountry, CorporateActionOption135.mmValidDomicileCountry, CorporateActionOption135.mmCurrencyOption,
						CorporateActionOption135.mmDefaultProcessingOrStandingInstruction, CorporateActionOption135.mmChargesAppliedIndicator, CorporateActionOption135.mmCertificationBreakdownIndicator,
						CorporateActionOption135.mmWithdrawalAllowedIndicator, CorporateActionOption135.mmChangeAllowedIndicator, CorporateActionOption135.mmAppliedOptionIndicator, CorporateActionOption135.mmSecurityIdentification,
						CorporateActionOption135.mmDateDetails, CorporateActionOption135.mmPeriodDetails, CorporateActionOption135.mmRateAndAmountDetails, CorporateActionOption135.mmPriceDetails,
						CorporateActionOption135.mmSecuritiesQuantity, CorporateActionOption135.mmSecuritiesMovementDetails, CorporateActionOption135.mmCashMovementDetails, CorporateActionOption135.mmAdditionalInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdvice002V08.mmCorporateActionMovementDetails);
	...
	public CorporateActionRate84 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate84 rateAndAmountDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption54> cashMovementDetails) {
