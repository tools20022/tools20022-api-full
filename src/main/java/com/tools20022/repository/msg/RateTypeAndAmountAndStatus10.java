...
public class RateTypeAndAmountAndStatus10 {
	...
	public static final MMMessageAssociationEnd mmRateType = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RateTypeAndAmountAndStatus10.mmObject();
			isDerived = false;
			xmlTag = "RateTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus10.mmRateType, RateTypeAndAmountAndStatus10.mmAmount, RateTypeAndAmountAndStatus10.mmRateStatus);
	...
	public void setRateType(RateType14Choice rateType) {
