 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.RedemptionMultipleOrder4#mmCancellationRightOrExtendedCancellationRightRule
 * RedemptionMultipleOrder4.mmCancellationRightOrExtendedCancellationRightRule}</li>
 * </ul>
 * </li>
 * <li>
...
public class RedemptionMultipleOrder4 {
	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RedemptionMultipleOrder4.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual orders, as assigned by the instructing party. This identifier links the individual orders together.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPlaceOfTrade = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmPlaceOfTrade);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOrderDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmOrderDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmExpiryDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmExpiryDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedFutureTradeDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmRequestedFutureTradeDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCancellationRight = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmCancellationRight);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmInvestmentAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmInvestmentAccountDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBeneficiaryDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmBeneficiaryDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	protected List<com.tools20022.repository.msg.RedemptionOrder8> individualOrderDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmIndividualOrderDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmIndividualOrderDetails);
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.RedemptionOrder8.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmBulkCashSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmBulkCashSettlementDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTotalSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder6.mmTotalSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMXor mmCancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> RedemptionMultipleOrder4.mmObject();
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.RedemptionOrderV03.mmMultipleOrderDetails);
				...
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionMultipleOrder4.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
	...
	public void setIndividualOrderDetails(List<com.tools20022.repository.msg.RedemptionOrder8> individualOrderDetails) {
