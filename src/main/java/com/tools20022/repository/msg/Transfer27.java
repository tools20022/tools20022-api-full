...
import com.tools20022.repository.area.sese.TransferOutInstructionV06;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmTransferReference
 * Transfer27.mmTransferReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmClientReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmBusinessFlowType
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmTransferReason
 * Transfer27.mmTransferReason}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmHoldingsPlanType
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer27#mmTransferCurrency
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transfer19
 * Transfer19}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transfer27", propOrder = {"transferReference", "clientReference", "counterpartyReference", "businessFlowType", "requestedSettlementDate", "transferOrderDateForm", "transferReason", "holdingsPlanType",
...
public class Transfer27 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Transfer27
	 * Transfer27}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Max35Text> mmTransferReference = new MMMessageAttribute<Transfer27, Max35Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer27.mmObject();
			isDerived = false;
			xmlTag = "TrfRef";
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmTransferReference);
			previousVersion_lazy = () -> Transfer19.mmTransferReference;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transfer27 obj) {
			return obj.getTransferReference();
		}

		@Override
		public void setValue(Transfer27 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<Transfer27, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmClientReference);
			previousVersion_lazy = () -> Transfer19.mmClientReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transfer27 obj) {
			return obj.getClientReference();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<AdditionalReference2>> mmCounterpartyReference = new MMMessageAttribute<Transfer27, Optional<AdditionalReference2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmCounterpartyReference);
			previousVersion_lazy = () -> Transfer19.mmCounterpartyReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AdditionalReference2> getValue(Transfer27 obj) {
			return obj.getCounterpartyReference();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<AdditionalReference2> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transfer19#mmBusinessFlowType
	 * Transfer19.mmBusinessFlowType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<BusinessFlowType1Code>> mmBusinessFlowType = new MMMessageAttribute<Transfer27, Optional<BusinessFlowType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer27.mmObject();
			isDerived = false;
			xmlTag = "BizFlowTp";
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmBusinessFlowType);
			previousVersion_lazy = () -> Transfer19.mmBusinessFlowType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BusinessFlowType1Code> getValue(Transfer27 obj) {
			return obj.getBusinessFlowType();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<BusinessFlowType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<Transfer27, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmRequestedSettlementDate);
			previousVersion_lazy = () -> Transfer19.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(Transfer27 obj) {
			return obj.getRequestedSettlementDate();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<ISODate>> mmTransferOrderDateForm = new MMMessageAttribute<Transfer27, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmTransferOrderDateForm);
			previousVersion_lazy = () -> Transfer19.mmTransferOrderDateForm;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<TransferReason1>> mmTransferReason = new MMMessageAttribute<Transfer27, Optional<TransferReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmTransferReason);
			previousVersion_lazy = () -> Transfer19.mmTransferReason;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransferReason1> getValue(Transfer27 obj) {
			return obj.getTransferReason();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<TransferReason1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, List<HoldingsPlanType1Code>> mmHoldingsPlanType = new MMMessageAttribute<Transfer27, List<HoldingsPlanType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmHoldingsPlanType);
			previousVersion_lazy = () -> Transfer19.mmHoldingsPlanType;
			maxOccurs = 3;
			minOccurs = 0;
		...
		@Override
		public List<HoldingsPlanType1Code> getValue(Transfer27 obj) {
			return obj.getHoldingsPlanType();
		}

		@Override
		public void setValue(Transfer27 obj, List<HoldingsPlanType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer27, FinancialInstrument13> mmFinancialInstrumentDetails = new MMMessageAssociationEnd<Transfer27, FinancialInstrument13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmFinancialInstrumentDetails);
			previousVersion_lazy = () -> Transfer19.mmFinancialInstrumentDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrument13 getValue(Transfer27 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(Transfer27 obj, FinancialInstrument13 value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transfer19#mmQuantity
	 * Transfer19.mmQuantity}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Quantity13Choice> mmQuantity = new MMMessageAttribute<Transfer27, Quantity13Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmQuantity);
			previousVersion_lazy = () -> Transfer19.mmQuantity;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Quantity13Choice getValue(Transfer27 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(Transfer27 obj, Quantity13Choice value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transfer19#mmUnitsDetails
	 * Transfer19.mmUnitsDetails}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer27, List<Unit3>> mmUnitsDetails = new MMMessageAssociationEnd<Transfer27, List<Unit3>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmTransferredQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer27.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmUnitsDetails);
			previousVersion_lazy = () -> Transfer19.mmUnitsDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Unit3> getValue(Transfer27 obj) {
			return obj.getUnitsDetails();
		}

		@Override
		public void setValue(Transfer27 obj, List<Unit3> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transfer19#mmRounding
	 * Transfer19.mmRounding}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<RoundingDirection2Code>> mmRounding = new MMMessageAttribute<Transfer27, Optional<RoundingDirection2Code>>() {
		{
			...
			name = "Rounding";
			definition = "Indicates the rounding direction applied to nearest unit.";
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmRounding);
			previousVersion_lazy = () -> Transfer19.mmRounding;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RoundingDirection2Code> getValue(Transfer27 obj) {
			return obj.getRounding();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<RoundingDirection2Code> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transfer19#mmAveragePrice
	 * Transfer19.mmAveragePrice}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>> mmAveragePrice = new MMMessageAttribute<Transfer27, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmAveragePrice);
			previousVersion_lazy = () -> Transfer19.mmAveragePrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> getValue(Transfer27 obj) {
			return obj.getAveragePrice();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<CurrencyCode>> mmTransferCurrency = new MMMessageAttribute<Transfer27, Optional<CurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmTransferCurrency);
			previousVersion_lazy = () -> Transfer19.mmTransferCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyCode> getValue(Transfer27 obj) {
			return obj.getTransferCurrency();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<YesNoIndicator>> mmOwnAccountTransferIndicator = new MMMessageAttribute<Transfer27, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmOwnAccountTransferIndicator);
			previousVersion_lazy = () -> Transfer19.mmOwnAccountTransferIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(Transfer27 obj) {
			return obj.getOwnAccountTransferIndicator();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<Max350Text>> mmNonStandardSettlementInformation = new MMMessageAttribute<Transfer27, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmNonStandardSettlementInformation);
			previousVersion_lazy = () -> Transfer19.mmNonStandardSettlementInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(Transfer27 obj) {
			return obj.getNonStandardSettlementInformation();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<PartyIdentificationAndAccount93>> mmReceivingAgentDetails = new MMMessageAttribute<Transfer27, Optional<PartyIdentificationAndAccount93>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmReceivingAgentDetails);
			previousVersion_lazy = () -> Transfer19.mmReceivingAgentDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyIdentificationAndAccount93> getValue(Transfer27 obj) {
			return obj.getReceivingAgentDetails();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<PartyIdentificationAndAccount93> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer27, Optional<PartyIdentificationAndAccount93>> mmDeliveringAgentDetails = new MMMessageAttribute<Transfer27, Optional<PartyIdentificationAndAccount93>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer27.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmDeliveringAgentDetails);
			previousVersion_lazy = () -> Transfer19.mmDeliveringAgentDetails;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> PartyIdentificationAndAccount93.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer27, Optional<ChargePaymentMethod1Choice>> mmTransferExpensesPaymentType = new MMMessageAssociationEnd<Transfer27, Optional<ChargePaymentMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transfer30.mmTransferExpensesPaymentType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ChargePaymentMethod1Choice> getValue(Transfer27 obj) {
			return obj.getTransferExpensesPaymentType();
		}

		@Override
		public void setValue(Transfer27 obj, Optional<ChargePaymentMethod1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer27.mmTransferReference, com.tools20022.repository.msg.Transfer27.mmClientReference,
						com.tools20022.repository.msg.Transfer27.mmCounterpartyReference, com.tools20022.repository.msg.Transfer27.mmBusinessFlowType, com.tools20022.repository.msg.Transfer27.mmRequestedSettlementDate,
						com.tools20022.repository.msg.Transfer27.mmTransferOrderDateForm, com.tools20022.repository.msg.Transfer27.mmTransferReason, com.tools20022.repository.msg.Transfer27.mmHoldingsPlanType,
						com.tools20022.repository.msg.Transfer27.mmFinancialInstrumentDetails, com.tools20022.repository.msg.Transfer27.mmQuantity, com.tools20022.repository.msg.Transfer27.mmUnitsDetails,
						com.tools20022.repository.msg.Transfer27.mmRounding, com.tools20022.repository.msg.Transfer27.mmAveragePrice, com.tools20022.repository.msg.Transfer27.mmTransferCurrency,
						com.tools20022.repository.msg.Transfer27.mmOwnAccountTransferIndicator, com.tools20022.repository.msg.Transfer27.mmNonStandardSettlementInformation, com.tools20022.repository.msg.Transfer27.mmReceivingAgentDetails,
						com.tools20022.repository.msg.Transfer27.mmDeliveringAgentDetails, com.tools20022.repository.msg.Transfer27.mmTransferExpensesPaymentType);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutInstructionV05.mmTransferDetails, TransferOutInstructionV06.mmTransferDetails);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule.forTransfer27, com.tools20022.repository.constraints.ConstraintMasterAndTransferReferencesGuideline1.forTransfer27);
				...
				nextVersions_lazy = () -> Arrays.asList(Transfer30.mmObject());
				previousVersion_lazy = () -> Transfer19.mmObject();
			}
		});
	...
	public Transfer27 setTransferReference(Max35Text transferReference) {
	...
	public Transfer27 setClientReference(Max35Text clientReference) {
	...
	public Transfer27 setCounterpartyReference(AdditionalReference2 counterpartyReference) {
	...
	public Transfer27 setBusinessFlowType(BusinessFlowType1Code businessFlowType) {
	...
	public Transfer27 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public Transfer27 setTransferOrderDateForm(ISODate transferOrderDateForm) {
	...
	public Transfer27 setTransferReason(TransferReason1 transferReason) {
	...
	public Transfer27 setHoldingsPlanType(List<HoldingsPlanType1Code> holdingsPlanType) {
	...
	public Transfer27 setFinancialInstrumentDetails(FinancialInstrument13 financialInstrumentDetails) {
	...
	public Transfer27 setQuantity(Quantity13Choice quantity) {
	...
	public Transfer27 setUnitsDetails(List<Unit3> unitsDetails) {
	...
	public Transfer27 setRounding(RoundingDirection2Code rounding) {
	...
	public Transfer27 setAveragePrice(ActiveOrHistoricCurrencyAnd13DecimalAmount averagePrice) {
	...
	public Transfer27 setTransferCurrency(CurrencyCode transferCurrency) {
	...
	public Transfer27 setOwnAccountTransferIndicator(YesNoIndicator ownAccountTransferIndicator) {
	...
	public Transfer27 setNonStandardSettlementInformation(Max350Text nonStandardSettlementInformation) {
	...
	public Transfer27 setReceivingAgentDetails(PartyIdentificationAndAccount93 receivingAgentDetails) {
	...
	public Transfer27 setDeliveringAgentDetails(PartyIdentificationAndAccount93 deliveringAgentDetails) {
	...
	public Transfer27 setTransferExpensesPaymentType(ChargePaymentMethod1Choice transferExpensesPaymentType) {
