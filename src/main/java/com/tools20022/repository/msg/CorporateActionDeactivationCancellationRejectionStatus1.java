...
public class CorporateActionDeactivationCancellationRejectionStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionDeactivationCancellationRejectionStatus1.mmReason, CorporateActionDeactivationCancellationRejectionStatus1.mmAdditionalInformation);
