 ...
 * CorporateActionDeactivationCancellationRejectionStatus1.AdditionalInformation
 * }</li>
 * </ul>
 * </li>
...
public class CorporateActionDeactivationCancellationRejectionStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDeactivationCancellationRejectionStatus1.Reason,
						com.tools20022.repository.msg.CorporateActionDeactivationCancellationRejectionStatus1.AdditionalInformation);
