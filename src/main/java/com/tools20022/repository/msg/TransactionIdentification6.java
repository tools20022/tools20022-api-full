...
public class TransactionIdentification6 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentification6.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentification6.mmAccountOwnerTransactionIdentification, TransactionIdentification6.mmAccountServicerTransactionIdentification,
						TransactionIdentification6.mmMarketInfrastructureTransactionIdentification, TransactionIdentification6.mmProcessorTransactionIdentification);
