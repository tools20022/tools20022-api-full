...
public class ForeignExchangeTerms14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms14.mmUnitCurrency, ForeignExchangeTerms14.mmQuotedCurrency, ForeignExchangeTerms14.mmExchangeRate, ForeignExchangeTerms14.mmQuotationDate,
						ForeignExchangeTerms14.mmQuotingInstitution);
