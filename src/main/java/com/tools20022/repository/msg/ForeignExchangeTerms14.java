...
@XmlType(name = "ForeignExchangeTerms14", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "quotationDate", "quotingInstitution"})
public class ForeignExchangeTerms14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms14, ActiveOrHistoricCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms14, ActiveOrHistoricCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms14.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmUnitCurrency);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ForeignExchangeTerms14 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms14 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms14, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms14, ActiveOrHistoricCurrencyCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmQuotedCurrency);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyCode.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms14, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms14, BaseOneRate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmExchangeRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms14 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms14 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms14, Optional<ISODateTime>> mmQuotationDate = new MMMessageAttribute<ForeignExchangeTerms14, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmQuotationDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(ForeignExchangeTerms14 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(ForeignExchangeTerms14 obj, Optional<ISODateTime> value) {
			obj.setQuotationDate(value.orElse(null));
		}
	};
	@XmlElement(name = "QtgInstn")
	protected PartyIdentification49Choice quotingInstitution;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeTerms14, Optional<PartyIdentification49Choice>> mmQuotingInstitution = new MMMessageAssociationEnd<ForeignExchangeTerms14, Optional<PartyIdentification49Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmQuotingInstitution);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification49Choice> getValue(ForeignExchangeTerms14 obj) {
			return obj.getQuotingInstitution();
		}

		@Override
		public void setValue(ForeignExchangeTerms14 obj, Optional<PartyIdentification49Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms14.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms14.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms14.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms14.mmQuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms14.mmQuotingInstitution);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms14";
				definition = "Information needed to process a currency exchange or conversion.";
				nextVersions_lazy = () -> Arrays.asList(ForeignExchangeTerms22.mmObject());
			}
		});
	...
	public ForeignExchangeTerms14 setUnitCurrency(ActiveOrHistoricCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms14 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms14 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms14 setQuotationDate(ISODateTime quotationDate) {
		this.quotationDate = quotationDate;
		return this;
	}

	public Optional<PartyIdentification49Choice> getQuotingInstitution() {
		return quotingInstitution == null ? Optional.empty() : Optional.of(quotingInstitution);
	}

	public ForeignExchangeTerms14 setQuotingInstitution(PartyIdentification49Choice quotingInstitution) {
