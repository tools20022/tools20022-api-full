...
public class AccountAndBalance19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance19.mmSafekeepingAccount, AccountAndBalance19.mmAccountOwner, AccountAndBalance19.mmSafekeepingPlace, AccountAndBalance19.mmBalance);
