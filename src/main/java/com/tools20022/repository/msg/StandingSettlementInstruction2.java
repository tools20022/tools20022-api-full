...
public class StandingSettlementInstruction2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StandingSettlementInstruction2.mmSettlementStandingInstructionDatabase, StandingSettlementInstruction2.mmCounterparty, StandingSettlementInstruction2.mmVendor,
						StandingSettlementInstruction2.mmOtherDeliveringSettlementParties, StandingSettlementInstruction2.mmOtherReceivingSettlementParties);
