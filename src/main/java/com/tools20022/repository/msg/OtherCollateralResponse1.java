	...
	public static final MMMessageAttribute mmResponseType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCollateralResponse2.mmResponseType);
	...
	public static final MMMessageAttribute mmCollateralIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCollateralResponse2.mmCollateralIdentification);
	...
	public static final MMMessageAttribute mmAssetNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCollateralResponse2.mmAssetNumber);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmRejectionReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCollateralResponse2.mmRejectionReason);
	...
	public static final MMMessageAttribute mmRejectionInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCollateralResponse2.mmRejectionInformation);
