...
@XmlType(name = "DataSetIdentification4", propOrder = {"name", "type", "version", "creationDateTime"})
public class DataSetIdentification4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DataSetIdentification4, Optional<Max256Text>> mmName = new MMMessageAttribute<DataSetIdentification4, Optional<Max256Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.DataSetIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Nm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Name";
			definition = "Name of the data set.";
			nextVersions_lazy = () -> Arrays.asList(DataSetIdentification6.mmName);
			previousVersion_lazy = () -> DataSetIdentification3.mmName;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max256Text> getValue(DataSetIdentification4 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(DataSetIdentification4 obj, Optional<Max256Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DataSetIdentification4, DataSetCategory4Code> mmType = new MMMessageAttribute<DataSetIdentification4, DataSetCategory4Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.DataSetIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Tp";
			...
			nextVersions_lazy = () -> Arrays.asList(DataSetIdentification6.mmType);
			previousVersion_lazy = () -> DataSetIdentification3.mmType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DataSetCategory4Code getValue(DataSetIdentification4 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(DataSetIdentification4 obj, DataSetCategory4Code value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DataSetIdentification4, Optional<Max256Text>> mmVersion = new MMMessageAttribute<DataSetIdentification4, Optional<Max256Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.DataSetIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Vrsn";
			...
			nextVersions_lazy = () -> Arrays.asList(DataSetIdentification6.mmVersion);
			previousVersion_lazy = () -> DataSetIdentification3.mmVersion;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max256Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DataSetIdentification4, Optional<ISODateTime>> mmCreationDateTime = new MMMessageAttribute<DataSetIdentification4, Optional<ISODateTime>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.DataSetIdentification4.mmObject();
			isDerived = false;
			xmlTag = "CreDtTm";
			...
			nextVersions_lazy = () -> Arrays.asList(DataSetIdentification6.mmCreationDateTime);
			previousVersion_lazy = () -> DataSetIdentification3.mmCreationDateTime;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(DataSetIdentification4 obj) {
			return obj.getCreationDateTime();
		}

		@Override
		public void setValue(DataSetIdentification4 obj, Optional<ISODateTime> value) {
	...
	public DataSetIdentification4 setName(Max256Text name) {
		this.name = name;
		return this;
	}
	...
	public DataSetIdentification4 setType(DataSetCategory4Code type) {
	...
	public DataSetIdentification4 setVersion(Max256Text version) {
	...
	public DataSetIdentification4 setCreationDateTime(ISODateTime creationDateTime) {
