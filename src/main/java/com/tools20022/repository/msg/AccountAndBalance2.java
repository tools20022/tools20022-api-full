...
public class AccountAndBalance2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance2.mmSafekeepingAccount, AccountAndBalance2.mmAccountOwner, AccountAndBalance2.mmSafekeepingPlace, AccountAndBalance2.mmBalance);
