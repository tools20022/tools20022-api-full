...
public class OptionData3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionData3.mmTradeDate, OptionData3.mmNotificationIdentification, OptionData3.mmCommonReference, OptionData3.mmRelatedReference, OptionData3.mmAmendOrCancelReason,
						OptionData3.mmOption);
