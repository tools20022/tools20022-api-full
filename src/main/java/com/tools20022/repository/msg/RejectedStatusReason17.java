...
public class RejectedStatusReason17 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason17.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReasonCode";
			definition = "Specifies the reason why the instruction or instruction cancellation has been rejected.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason21.mmReasonCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectedStatusReason13.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason21.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectedStatusReason13.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setReasonCode(RejectedReason13Choice reasonCode) {
