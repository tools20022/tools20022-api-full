...
import com.tools20022.repository.choice.RejectedReason13Choice;
...
@XmlType(name = "RejectedStatusReason17", propOrder = {"reasonCode", "additionalReasonInformation"})
public class RejectedStatusReason17 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected RejectedReason13Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.RejectedReason13Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectedStatusReason17, RejectedReason13Choice> mmReasonCode = new MMMessageAssociationEnd<RejectedStatusReason17, RejectedReason13Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectedStatusReason17.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason21.mmReasonCode);
			previousVersion_lazy = () -> RejectedStatusReason13.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectedReason13Choice.mmObject();
		}

		@Override
		public RejectedReason13Choice getValue(RejectedStatusReason17 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(RejectedStatusReason17 obj, RejectedReason13Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedStatusReason17, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectedStatusReason17, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason21.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> RejectedStatusReason13.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(RejectedStatusReason17 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectedStatusReason17 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason17.mmReasonCode, com.tools20022.repository.msg.RejectedStatusReason17.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forRejectedStatusReason17);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatusReason17";
				definition = "Specifies reasons for the rejected status.";
				nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason21.mmObject());
				previousVersion_lazy = () -> RejectedStatusReason13.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public RejectedReason13Choice getReasonCode() {
		return reasonCode;
	}

	public RejectedStatusReason17 setReasonCode(RejectedReason13Choice reasonCode) {
	...
	public RejectedStatusReason17 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
