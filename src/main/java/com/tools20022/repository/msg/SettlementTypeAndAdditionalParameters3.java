...
public class SettlementTypeAndAdditionalParameters3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters3.SecuritiesMovementType, com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters3.Payment,
						com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters3.CommonIdentification);
