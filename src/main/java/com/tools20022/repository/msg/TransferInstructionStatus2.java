...
import com.tools20022.repository.codeset.TransferStatus2Code;
...
@XmlType(name = "TransferInstructionStatus2", propOrder = {"status", "reason"})
public class TransferInstructionStatus2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferInstructionStatus2, TransferStatus2Code> mmStatus = new MMMessageAttribute<TransferInstructionStatus2, TransferStatus2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatus.mmTransferStatus;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransferInstructionStatus2.mmObject();
			isDerived = false;
			xmlTag = "Sts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Status";
			definition = "Status of the transfer is accepted, sent to next party, matched, already executed, or settled.";
			nextVersions_lazy = () -> Arrays.asList(TransferInstructionStatus3.mmStatus);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TransferStatus2Code getValue(TransferInstructionStatus2 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(TransferInstructionStatus2 obj, TransferStatus2Code value) {
			obj.setStatus(value);
		}
	};
	@XmlElement(name = "Rsn")
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferInstructionStatus2, Optional<Max350Text>> mmReason = new MMMessageAttribute<TransferInstructionStatus2, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferInstructionStatus3.mmReason);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransferInstructionStatus2 obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(TransferInstructionStatus2 obj, Optional<Max350Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(TransferInstructionStatus3.mmObject());
			}
		});
	...
	public TransferInstructionStatus2 setStatus(TransferStatus2Code status) {
	...
	public TransferInstructionStatus2 setReason(Max350Text reason) {
		this.reason = reason;
		return this;
	}
}