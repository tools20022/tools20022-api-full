...
public class CorporateAction30 {
	...
	public static final MMMessageAssociationEnd mmDateDetails = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateAction30.mmObject();
			isDerived = false;
			xmlTag = "DtDtls";
	...
	public CorporateActionEventStageFormat12Choice getEventStage() {
		return eventStage;
	}

	public void setEventStage(CorporateActionEventStageFormat12Choice eventStage) {
