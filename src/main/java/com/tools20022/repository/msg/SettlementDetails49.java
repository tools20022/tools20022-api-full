 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails99
...
@XmlType(name = "SettlementDetails49", propOrder = {"holdIndicator", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "cashClearingSystem", "marketClientSide",
...
public class SettlementDetails49 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails49, Optional<YesNoIndicator>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails49, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails49.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmHoldIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails49 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<YesNoIndicator> value) {
			obj.setHoldIndicator(value.orElse(null));
		}
	};
	@XmlElement(name = "SctiesTxTp", required = true)
	protected SecuritiesTransactionType12Choice securitiesTransactionType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.SecuritiesTransactionType12Choice
	 * SecuritiesTransactionType12Choice}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, SecuritiesTransactionType12Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails49, SecuritiesTransactionType12Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmSecuritiesTransactionType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SecuritiesTransactionType12Choice.mmObject();
		}

		@Override
		public SecuritiesTransactionType12Choice getValue(SettlementDetails49 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails49 obj, SecuritiesTransactionType12Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, List<SettlementTransactionCondition5Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails49, List<SettlementTransactionCondition5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmSettlementTransactionCondition);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition5Choice> getValue(SettlementDetails49 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails49 obj, List<SettlementTransactionCondition5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails49, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails49, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails49.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmPartialSettlementIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails49 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails49, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmBeneficialOwnership);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails49 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails49, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmCashClearingSystem);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails49 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails49, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmMarketClientSide);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails49 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<Registration1Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails49, Optional<Registration1Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmRegistration);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration1Choice> getValue(SettlementDetails49 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<Registration1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<RepurchaseType8Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails49, Optional<RepurchaseType8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmRepurchaseType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType8Choice> getValue(SettlementDetails49 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<RepurchaseType8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails49, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmSecuritiesRTGS);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails49 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails49, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails49, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmStampDutyTaxBasis);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails49 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails49 obj, Optional<GenericIdentification20> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails49.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails49.mmSecuritiesTransactionType,
						...
						com.tools20022.repository.msg.SettlementDetails49.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails49.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails49.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails49.mmRegistration, com.tools20022.repository.msg.SettlementDetails49.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails49.mmSecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails49.mmStampDutyTaxBasis);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAllegementNotificationV03.mmSettlementParameters, SecuritiesSettlementTransactionAllegementNotificationV04.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails49,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails49);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails49";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails99.mmObject());
				previousVersion_lazy = () -> SettlementDetails25.mmObject();
			}
		});
	...
	public SettlementDetails49 setHoldIndicator(YesNoIndicator holdIndicator) {
		this.holdIndicator = holdIndicator;
		return this;
	}

	public SecuritiesTransactionType12Choice getSecuritiesTransactionType() {
		return securitiesTransactionType;
	}

	public SettlementDetails49 setSecuritiesTransactionType(SecuritiesTransactionType12Choice securitiesTransactionType) {
	...
	public SettlementDetails49 setSettlementTransactionCondition(List<SettlementTransactionCondition5Choice> settlementTransactionCondition) {
	...
	public SettlementDetails49 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails49 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails49 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails49 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails49 setRegistration(Registration1Choice registration) {
	...
	public SettlementDetails49 setRepurchaseType(RepurchaseType8Choice repurchaseType) {
	...
	public SettlementDetails49 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails49 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
