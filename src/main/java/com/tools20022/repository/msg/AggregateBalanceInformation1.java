...
public class AggregateBalanceInformation1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation1.mmAggregateQuantity, AggregateBalanceInformation1.mmAvailableQuantity, AggregateBalanceInformation1.mmNotAvailableQuantity,
						AggregateBalanceInformation1.mmDaysAccrued, AggregateBalanceInformation1.mmHoldingValue, AggregateBalanceInformation1.mmAccruedInterestAmount, AggregateBalanceInformation1.mmBookValue,
						AggregateBalanceInformation1.mmSafekeepingPlace, AggregateBalanceInformation1.mmFinancialInstrumentDetails, AggregateBalanceInformation1.mmPriceDetails, AggregateBalanceInformation1.mmForeignExchangeDetails,
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace1> balanceAtSafekeepingPlace) {
