...
public class RedemptionOrder15 {
	...
	public static final MMMessageAttribute mmOrderReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmOrderReference;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmClientReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmClientReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmInvestmentAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmInvestmentAccountDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOrderType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmOrderType;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBeneficiaryDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmBeneficiaryDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmRounding = new MMMessageAttribute() {
		{
			...
			name = "Rounding";
			definition = "Indicates the rounding direction applied to nearest unit.";
			previousVersion_lazy = () -> RedemptionOrder7.mmRounding;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSettlementAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCashSettlementDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmCashSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSettlementMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmSettlementMethod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmIncomePreference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmIncomePreference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmGroup1Or2Units = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmGroup1Or2Units;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmSettlementAndCustodyDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmSettlementAndCustodyDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPhysicalDeliveryIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmPhysicalDeliveryIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmPhysicalDeliveryDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmPhysicalDeliveryDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCashSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmCashSettlementDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmNonStandardSettlementInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmNonStandardSettlementInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmStaffClientBreakdown = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmStaffClientBreakdown;
			maxOccurs = 4;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmFinancialAdvice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmFinancialAdvice;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmNegotiatedTrade = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmNegotiatedTrade;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmRelatedPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmRelatedPartyDetails;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmEqualisation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RedemptionOrder7.mmEqualisation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public RedemptionOrder15 setInvestmentAccountDetails(com.tools20022.repository.msg.InvestmentAccount58 investmentAccountDetails) {
	...
	public RedemptionOrder15 setBeneficiaryDetails(List<com.tools20022.repository.msg.IndividualPerson32> beneficiaryDetails) {
	...
	public RedemptionOrder15 setForeignExchangeDetails(com.tools20022.repository.msg.ForeignExchangeTerms32 foreignExchangeDetails) {
	...
	public RedemptionOrder15 setTransactionOverhead(com.tools20022.repository.msg.FeeAndTax1 transactionOverhead) {
	...
	public RedemptionOrder15 setSettlementAndCustodyDetails(com.tools20022.repository.msg.FundSettlementParameters12 settlementAndCustodyDetails) {
	...
	public RedemptionOrder15 setPhysicalDeliveryDetails(com.tools20022.repository.msg.DeliveryParameters3 physicalDeliveryDetails) {
	...
	public RedemptionOrder15 setCashSettlementDetails(com.tools20022.repository.msg.PaymentTransaction72 cashSettlementDetails) {
	...
	public RedemptionOrder15 setStaffClientBreakdown(List<com.tools20022.repository.msg.InvestmentFundsOrderBreakdown2> staffClientBreakdown) {
	...
	public RedemptionOrder15 setRelatedPartyDetails(List<com.tools20022.repository.msg.Intermediary40> relatedPartyDetails) {
	...
	public RedemptionOrder15 setEqualisation(com.tools20022.repository.msg.Equalisation1 equalisation) {
	...
	public RedemptionOrder15 setOrderWaiverDetails(com.tools20022.repository.msg.OrderWaiver1 orderWaiverDetails) {
