...
import com.tools20022.repository.choice.AcceptedReason4Choice;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcceptedStatusReason8
...
@XmlType(name = "AcceptedStatusReason4", propOrder = {"reasonCode", "additionalReasonInformation"})
public class AcceptedStatusReason4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedStatusReason4, AcceptedReason4Choice> mmReasonCode = new MMMessageAssociationEnd<AcceptedStatusReason4, AcceptedReason4Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmAcknowledgedAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptedStatusReason4.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReasonCode";
			definition = "Specifies the reason why the instruction has been accepted.";
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatusReason8.mmReasonCode);
		...
		@Override
		public AcceptedReason4Choice getValue(AcceptedStatusReason4 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(AcceptedStatusReason4 obj, AcceptedReason4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedStatusReason4, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcceptedStatusReason4, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatusReason8.mmAdditionalReasonInformation);
		...
		@Override
		public Optional<Max210Text> getValue(AcceptedStatusReason4 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(AcceptedStatusReason4 obj, Optional<Max210Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInformationRule.forAcceptedStatusReason4);
	...
	public AcceptedStatusReason4 setReasonCode(AcceptedReason4Choice reasonCode) {
	...
	public AcceptedStatusReason4 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
