...
public class PartyIdentificationAndAccount51 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount51.mmIdentification, PartyIdentificationAndAccount51.mmSafekeepingAccount, PartyIdentificationAndAccount51.mmProcessingIdentification,
						PartyIdentificationAndAccount51.mmAdditionalInformation, PartyIdentificationAndAccount51.mmAlternateIdentification);
