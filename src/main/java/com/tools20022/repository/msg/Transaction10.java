...
import com.tools20022.repository.msg.TransactionDetails17;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction10
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction10}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction10
 * ConstraintCoexistenceIdentificationRule.forTransaction10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction10", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "tradeIdentification", "poolIdentification",
		"commonIdentification", "corporateActionEventIdentification", "tripartyAgentCollateralTransactionIdentification", "clientTripartyCollateralTransactionIdentification", "transactionDetails", "statusAndReason"})
public class Transaction10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, RestrictedFINXMax16Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction10, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction10.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public RestrictedFINXMax16Text getValue(Transaction10 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction10 obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(Transaction10 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction10 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, List<RestrictedFINXMax16Text>> mmTradeIdentification = new MMMessageAttribute<Transaction10, List<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public List<RestrictedFINXMax16Text> getValue(Transaction10 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction10 obj, List<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmPoolIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmCommonIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction10, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	protected TransactionDetails17 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails17
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction10, Optional<TransactionDetails17>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction10, Optional<TransactionDetails17>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails17.mmObject();
		}

		@Override
		public Optional<TransactionDetails17> getValue(Transaction10 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction10 obj, Optional<TransactionDetails17> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction10, List<StatusAndReason5>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction10, List<StatusAndReason5>>() {
		{
		...
		@Override
		public List<StatusAndReason5> getValue(Transaction10 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction10 obj, List<StatusAndReason5> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction10.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction10.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction10.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction10.mmTradeIdentification,
						com.tools20022.repository.msg.Transaction10.mmPoolIdentification, com.tools20022.repository.msg.Transaction10.mmCommonIdentification, com.tools20022.repository.msg.Transaction10.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction10.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction10.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction10.mmTransactionDetails, com.tools20022.repository.msg.Transaction10.mmStatusAndReason);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction10,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction10);
	...
	public Transaction10 setAccountOwnerTransactionIdentification(RestrictedFINXMax16Text accountOwnerTransactionIdentification) {
	...
	public Transaction10 setAccountServicerTransactionIdentification(RestrictedFINXMax16Text accountServicerTransactionIdentification) {
	...
	public Transaction10 setMarketInfrastructureTransactionIdentification(RestrictedFINXMax16Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction10 setTradeIdentification(List<RestrictedFINXMax16Text> tradeIdentification) {
	...
	public Transaction10 setPoolIdentification(RestrictedFINXMax16Text poolIdentification) {
	...
	public Transaction10 setCommonIdentification(RestrictedFINXMax16Text commonIdentification) {
	...
	public Transaction10 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public Transaction10 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction10 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails17> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction10 setTransactionDetails(TransactionDetails17 transactionDetails) {
	...
	public Transaction10 setStatusAndReason(List<StatusAndReason5> statusAndReason) {
