...
public class GenericIdentification62 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification62.Identification, com.tools20022.repository.msg.GenericIdentification62.Issuer,
						com.tools20022.repository.msg.GenericIdentification62.SchemeName);
