...
public class DeniedReason9 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason9.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedReason9.mmCode, DeniedReason9.mmAdditionalReasonInformation);
	...
	public void setCode(DeniedReason13Choice code) {
		this.code = code;
	}
