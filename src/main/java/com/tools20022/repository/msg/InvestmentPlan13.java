...
public class InvestmentPlan13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentPlan13.mmFrequency, InvestmentPlan13.mmStartDate, InvestmentPlan13.mmEndDate, InvestmentPlan13.mmQuantity, InvestmentPlan13.mmGrossAmountIndicator,
						InvestmentPlan13.mmIncomePreference, InvestmentPlan13.mmInitialAmount, InvestmentPlan13.mmTotalNumberOfInstalments, InvestmentPlan13.mmRoundingDirection, InvestmentPlan13.mmSecurityDetails,
						InvestmentPlan13.mmModifiedCashSettlement, InvestmentPlan13.mmContractReference, InvestmentPlan13.mmRelatedContractReference, InvestmentPlan13.mmProductIdentification,
						InvestmentPlan13.mmSLAChargeAndCommissionReference, InvestmentPlan13.mmInsuranceCover, InvestmentPlan13.mmPlanStatus, InvestmentPlan13.mmInstalmentManagerRole);
