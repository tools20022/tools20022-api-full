...
public class CorporateActionGeneralInformation58 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation58.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation58.mmCorporateActionEventIdentification, CorporateActionGeneralInformation58.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation58.mmClassActionNumber, CorporateActionGeneralInformation58.mmEventType);
