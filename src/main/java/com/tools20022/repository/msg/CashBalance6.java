...
@XmlType(name = "CashBalance6", propOrder = {"amount", "creditDebitIndicator", "type", "status", "valueDate", "numberOfPayments"})
public class CashBalance6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalance6, ImpliedCurrencyAndAmount> mmAmount = new MMMessageAttribute<CashBalance6, ImpliedCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> CashBalance.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashBalance6.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Currency and amount of money of the cash balance.";
			nextVersions_lazy = () -> Arrays.asList(ContractBalance1.mmAmount, CashBalance11.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CashBalance6 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(CashBalance6 obj, ImpliedCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalance6, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashBalance6, CreditDebitCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ContractBalance1.mmCreditDebitIndicator, CashBalance11.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(CashBalance6 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashBalance6 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashBalance6, Optional<BalanceType9Choice>> mmType = new MMMessageAssociationEnd<CashBalance6, Optional<BalanceType9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ContractBalance1.mmType, CashBalance11.mmType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BalanceType9Choice> getValue(CashBalance6 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(CashBalance6 obj, Optional<BalanceType9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalance6, Optional<BalanceStatus1Code>> mmStatus = new MMMessageAttribute<CashBalance6, Optional<BalanceStatus1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashBalance11.mmStatus);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BalanceStatus1Code> getValue(CashBalance6 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(CashBalance6 obj, Optional<BalanceStatus1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalance6, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAttribute<CashBalance6, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashBalance11.mmValueDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(CashBalance6 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(CashBalance6 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalance6, Optional<Number>> mmNumberOfPayments = new MMMessageAttribute<CashBalance6, Optional<Number>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashBalance6.mmObject();
			isDerived = false;
			xmlTag = "NbOfPmts";
			...
			nextVersions_lazy = () -> Arrays.asList(CashBalance11.mmNumberOfPayments);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number> getValue(CashBalance6 obj) {
			return obj.getNumberOfPayments();
		}

		@Override
		public void setValue(CashBalance6 obj, Optional<Number> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance6.mmAmount, com.tools20022.repository.msg.CashBalance6.mmCreditDebitIndicator, com.tools20022.repository.msg.CashBalance6.mmType,
						com.tools20022.repository.msg.CashBalance6.mmStatus, com.tools20022.repository.msg.CashBalance6.mmValueDate, com.tools20022.repository.msg.CashBalance6.mmNumberOfPayments);
				trace_lazy = () -> CashBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CashBalance6";
				definition = "Balance details for a cash account.";
				nextVersions_lazy = () -> Arrays.asList(ContractBalance1.mmObject(), CashBalance11.mmObject());
			}
		});
	...
	public CashBalance6 setAmount(ImpliedCurrencyAndAmount amount) {
	...
	public CashBalance6 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashBalance6 setType(BalanceType9Choice type) {
		this.type = type;
		return this;
	}
	...
	public CashBalance6 setStatus(BalanceStatus1Code status) {
		this.status = status;
		return this;
	}
	...
	public CashBalance6 setValueDate(DateAndDateTimeChoice valueDate) {
	...
	public CashBalance6 setNumberOfPayments(Number numberOfPayments) {
