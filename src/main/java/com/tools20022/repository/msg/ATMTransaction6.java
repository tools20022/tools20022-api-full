...
public class ATMTransaction6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMTransaction6, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<ATMTransaction6, TransactionIdentifier1>() {
		{
			businessElementTrace_lazy = () -> CardPayment.mmCardPaymentAcquiring;
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.mmObject();
			isDerived = false;
			xmlTag = "TxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionIdentification";
			definition = "Identification of the transaction assigned by the ATM.";
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction9.mmTransactionIdentification, ATMTransaction29.mmTransactionIdentification);
		...
		@Override
		public TransactionIdentifier1 getValue(ATMTransaction6 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(ATMTransaction6 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMTransaction6, Optional<CardAccount3>> mmAccountData = new MMMessageAssociationEnd<ATMTransaction6, Optional<CardAccount3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction29.mmAccountData);
		...
		@Override
		public Optional<CardAccount3> getValue(ATMTransaction6 obj) {
			return obj.getAccountData();
		}

		@Override
		public void setValue(ATMTransaction6 obj, Optional<CardAccount3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMTransaction6, Optional<ContentInformationType10>> mmProtectedAccountData = new MMMessageAssociationEnd<ATMTransaction6, Optional<ContentInformationType10>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction29.mmProtectedAccountData);
		...
		@Override
		public Optional<ContentInformationType10> getValue(ATMTransaction6 obj) {
			return obj.getProtectedAccountData();
		}

		@Override
		public void setValue(ATMTransaction6 obj, Optional<ContentInformationType10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMTransaction6, Optional<AmountAndCurrency1>> mmTotalRequestedAmount = new MMMessageAssociationEnd<ATMTransaction6, Optional<AmountAndCurrency1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction29.mmTotalRequestedAmount);
			previousVersion_lazy = () -> ATMTransaction1.mmTotalRequestedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndCurrency1> getValue(ATMTransaction6 obj) {
			return obj.getTotalRequestedAmount();
		}

		@Override
		public void setValue(ATMTransaction6 obj, Optional<AmountAndCurrency1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMTransaction6, Optional<DetailedAmount12>> mmDetailedRequestedAmount = new MMMessageAssociationEnd<ATMTransaction6, Optional<DetailedAmount12>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction29.mmDetailedRequestedAmount);
			previousVersion_lazy = () -> ATMTransaction1.mmDetailedRequestedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DetailedAmount12> getValue(ATMTransaction6 obj) {
			return obj.getDetailedRequestedAmount();
		}

		@Override
		public void setValue(ATMTransaction6 obj, Optional<DetailedAmount12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ATMTransaction6, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<ATMTransaction6, Optional<Max10000Binary>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.mmObject();
			isDerived = false;
			xmlTag = "ICCRltdData";
			...
			nextVersions_lazy = () -> Arrays.asList(ATMTransaction9.mmICCRelatedData, ATMTransaction29.mmICCRelatedData);
		...
		@Override
		public Optional<Max10000Binary> getValue(ATMTransaction6 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(ATMTransaction6 obj, Optional<Max10000Binary> value) {
	...
	public ATMTransaction6 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public ATMTransaction6 setAccountData(CardAccount3 accountData) {
	...
	public ATMTransaction6 setProtectedAccountData(ContentInformationType10 protectedAccountData) {
	...
	public ATMTransaction6 setTotalRequestedAmount(AmountAndCurrency1 totalRequestedAmount) {
	...
	public ATMTransaction6 setDetailedRequestedAmount(DetailedAmount12 detailedRequestedAmount) {
	...
	public ATMTransaction6 setICCRelatedData(Max10000Binary iCCRelatedData) {
