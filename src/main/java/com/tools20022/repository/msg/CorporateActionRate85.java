...
public class CorporateActionRate85 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate85.mmGrossDividendRate, CorporateActionRate85.mmNetDividendRate, CorporateActionRate85.mmIndexFactor, CorporateActionRate85.mmInterestRateUsedForPayment,
						CorporateActionRate85.mmMaximumAllowedOversubscriptionRate, CorporateActionRate85.mmProrationRate, CorporateActionRate85.mmWithholdingTaxRate, CorporateActionRate85.mmSecondLevelTax,
						CorporateActionRate85.mmAdditionalTax, CorporateActionRate85.mmTaxableIncomePerDividendShare);
