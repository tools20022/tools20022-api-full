...
@XmlType(name = "ProprietaryReason1", propOrder = {"reason", "additionalReasonInformation"})
public class ProprietaryReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn")
	protected GenericIdentification20 reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ProprietaryReason4#mmReason
	...
	public static final MMMessageAttribute<ProprietaryReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<ProprietaryReason1, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ProprietaryReason4.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ProprietaryReason1.mmReason, com.tools20022.repository.msg.ProprietaryReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forProprietaryReason1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ProprietaryReason1";
				definition = "Proprietary identification of the reason related to a status.";
				nextVersions_lazy = () -> Arrays.asList(ProprietaryReason4.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public Optional<GenericIdentification20> getReason() {
	...
	public ProprietaryReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
