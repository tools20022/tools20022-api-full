...
public class SecuritiesTradeDetails27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails27.mmTradeIdentification, SecuritiesTradeDetails27.mmCollateralTransactionIdentification, SecuritiesTradeDetails27.mmPlaceOfTrade,
						SecuritiesTradeDetails27.mmPlaceOfClearing, SecuritiesTradeDetails27.mmTradeDate, SecuritiesTradeDetails27.mmLateDeliveryDate, SecuritiesTradeDetails27.mmDealPrice, SecuritiesTradeDetails27.mmNumberOfDaysAccrued,
						SecuritiesTradeDetails27.mmOpeningClosing, SecuritiesTradeDetails27.mmReporting, SecuritiesTradeDetails27.mmTradeTransactionCondition, SecuritiesTradeDetails27.mmInvestorCapacity,
						SecuritiesTradeDetails27.mmTradeOriginatorRole, SecuritiesTradeDetails27.mmTypeOfPrice, SecuritiesTradeDetails27.mmCurrencyToBuyOrSell, SecuritiesTradeDetails27.mmMatchingStatus,
						SecuritiesTradeDetails27.mmAffirmationStatus, SecuritiesTradeDetails27.mmFXAdditionalDetails, SecuritiesTradeDetails27.mmSettlementInstructionProcessingAdditionalDetails);
