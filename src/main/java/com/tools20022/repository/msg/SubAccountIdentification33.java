...
public class SubAccountIdentification33 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification33.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	protected List<com.tools20022.repository.msg.FinancialInstrumentDetails16> financialInstrumentDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentDetails16.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification33.mmAccountOwner, SubAccountIdentification33.mmSafekeepingAccount, SubAccountIdentification33.mmActivityIndicator,
						SubAccountIdentification33.mmFinancialInstrumentDetails);
	...
	public void setFinancialInstrumentDetails(List<com.tools20022.repository.msg.FinancialInstrumentDetails16> financialInstrumentDetails) {
