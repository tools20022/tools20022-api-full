...
public class InvestmentAccount17 {
	...
	public static final MMXor mmTypeOrExtendedTypeRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(InvestmentAccount17.mmType, InvestmentAccount17.mmExtendedType);
		}
	};
	/**
	...
	public static final MMXor mmOwnershipTypeOrExtendedOwnershipTypeRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> InvestmentAccount17.mmObject();
			impactedElements_lazy = () -> Arrays.asList(InvestmentAccount17.mmOwnershipType, InvestmentAccount17.mmExtendedOwnershipType);
		}
	};
	/**
	...
	public static final MMXor mmTaxExemptionReasonOrExtendedTaxExemptionReasonRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> InvestmentAccount17.mmObject();
			impactedElements_lazy = () -> Arrays.asList(InvestmentAccount17.mmTaxExemptionReason, InvestmentAccount17.mmExtendedTaxExemptionReason);
		}
	};
	/**
	...
	public static final MMXor mmStatementFrequencyOrExtendedStatementFrequencyRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> InvestmentAccount17.mmObject();
			impactedElements_lazy = () -> Arrays.asList(InvestmentAccount17.mmStatementFrequency, InvestmentAccount17.mmExtendedStatementFrequency);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount17.mmIdentification, InvestmentAccount17.mmStatus, InvestmentAccount17.mmName, InvestmentAccount17.mmDesignation, InvestmentAccount17.mmType,
						InvestmentAccount17.mmExtendedType, InvestmentAccount17.mmOwnershipType, InvestmentAccount17.mmExtendedOwnershipType, InvestmentAccount17.mmTaxExemptionReason, InvestmentAccount17.mmExtendedTaxExemptionReason,
						InvestmentAccount17.mmStatementFrequency, InvestmentAccount17.mmExtendedStatementFrequency, InvestmentAccount17.mmReferenceCurrency, InvestmentAccount17.mmLanguage, InvestmentAccount17.mmIncomePreference,
						InvestmentAccount17.mmTaxWithholdingMethod, InvestmentAccount17.mmLetterIntentReference, InvestmentAccount17.mmAccumulationRightReference, InvestmentAccount17.mmRequiredSignatoriesNumber,
						InvestmentAccount17.mmFundFamilyName, InvestmentAccount17.mmFundDetails, InvestmentAccount17.mmRoundingDetails, InvestmentAccount17.mmAccountServicer, InvestmentAccount17.mmCashAccount,
						InvestmentAccount17.mmSecuritiesAccount);
				...
				xors_lazy = () -> Arrays.asList(InvestmentAccount17.mmTypeOrExtendedTypeRule, InvestmentAccount17.mmOwnershipTypeOrExtendedOwnershipTypeRule, InvestmentAccount17.mmTaxExemptionReasonOrExtendedTaxExemptionReasonRule,
						InvestmentAccount17.mmStatementFrequencyOrExtendedStatementFrequencyRule);
			}
		});
