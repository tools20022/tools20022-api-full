...
public class SettlementTypeAndAdditionalParameters1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters1.mmSecuritiesMovementType, SettlementTypeAndAdditionalParameters1.mmPayment, SettlementTypeAndAdditionalParameters1.mmCommonIdentification,
						SettlementTypeAndAdditionalParameters1.mmCorporateActionEventIdentification, SettlementTypeAndAdditionalParameters1.mmReconciliationIndicator);
