...
public class CorporateActionOption23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption23.mmOptionNumber, CorporateActionOption23.mmOptionType, CorporateActionOption23.mmOptionFeatures, CorporateActionOption23.mmFractionDisposition,
						CorporateActionOption23.mmCurrencyOption, CorporateActionOption23.mmDateDetails, CorporateActionOption23.mmPeriodDetails, CorporateActionOption23.mmRateAndAmountDetails, CorporateActionOption23.mmPriceDetails,
						CorporateActionOption23.mmPlaceOfTrade, CorporateActionOption23.mmSecuritiesMovementDetails, CorporateActionOption23.mmCashMovementDetails);
