...
@XmlType(name = "ForeignExchangeTerms8", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "resultingAmount"})
public class ForeignExchangeTerms8 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms8
	 * ForeignExchangeTerms8}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms8.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
		...
		@Override
		public ActiveCurrencyCode getValue(ForeignExchangeTerms8 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms8 obj, ActiveCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms8, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms8, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms8 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms8 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyAndAmount> mmResultingAmount = new MMMessageAttribute<ForeignExchangeTerms8, ActiveCurrencyAndAmount>() {
		{
		...
		@Override
		public ActiveCurrencyAndAmount getValue(ForeignExchangeTerms8 obj) {
			return obj.getResultingAmount();
		}

		@Override
		public void setValue(ForeignExchangeTerms8 obj, ActiveCurrencyAndAmount value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms8.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms8.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms8.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms8.mmResultingAmount);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms8";
	...
	public ForeignExchangeTerms8 setUnitCurrency(ActiveCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms8 setQuotedCurrency(ActiveCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms8 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms8 setResultingAmount(ActiveCurrencyAndAmount resultingAmount) {
