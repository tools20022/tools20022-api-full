...
public class CorporateAction29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateAction29.mmDateDetails, CorporateAction29.mmEventStage, CorporateAction29.mmLotteryType);
	...
	public CorporateActionEventStageFormat11Choice getEventStage() {
		return eventStage;
	}

	public void setEventStage(CorporateActionEventStageFormat11Choice eventStage) {
