...
public class TransactionDetails18 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails18.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	public SettlementOrCorporateActionEvent4Choice getSettlementTransactionOrCorporateActionEventType() {
		return settlementTransactionOrCorporateActionEventType;
	}

	public void setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent4Choice settlementTransactionOrCorporateActionEventType) {
	...
	public SettlementDetails13 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails13 settlementParameters) {
