...
@XmlType(name = "ReceivingPartiesAndAccount10", propOrder = {"depository", "party1", "party2"})
public class ReceivingPartiesAndAccount10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceivingPartiesAndAccount10, PartyIdentification34Choice> mmDepository = new MMMessageAssociationEnd<ReceivingPartiesAndAccount10, PartyIdentification34Choice>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount10.mmObject();
			isDerived = false;
			xmlTag = "Dpstry";
			...
			nextVersions_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount15.mmDepository);
		...
		@Override
		public PartyIdentification34Choice getValue(ReceivingPartiesAndAccount10 obj) {
			return obj.getDepository();
		}

		@Override
		public void setValue(ReceivingPartiesAndAccount10 obj, PartyIdentification34Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceivingPartiesAndAccount10, PartyIdentificationAndAccount102> mmParty1 = new MMMessageAssociationEnd<ReceivingPartiesAndAccount10, PartyIdentificationAndAccount102>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount15.mmParty1);
		...
		@Override
		public PartyIdentificationAndAccount102 getValue(ReceivingPartiesAndAccount10 obj) {
			return obj.getParty1();
		}

		@Override
		public void setValue(ReceivingPartiesAndAccount10 obj, PartyIdentificationAndAccount102 value) {
			obj.setParty1(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceivingPartiesAndAccount10, Optional<PartyIdentificationAndAccount77>> mmParty2 = new MMMessageAssociationEnd<ReceivingPartiesAndAccount10, Optional<PartyIdentificationAndAccount77>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesSettlementPartyRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount15.mmParty2);
		...
		@Override
		public Optional<PartyIdentificationAndAccount77> getValue(ReceivingPartiesAndAccount10 obj) {
			return obj.getParty2();
		}

		@Override
		public void setValue(ReceivingPartiesAndAccount10 obj, Optional<PartyIdentificationAndAccount77> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceivingPartiesAndAccount10.mmDepository, com.tools20022.repository.msg.ReceivingPartiesAndAccount10.mmParty1,
						com.tools20022.repository.msg.ReceivingPartiesAndAccount10.mmParty2);
				trace_lazy = () -> SecuritiesSettlementPartyRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDepositoryGuideline.forReceivingPartiesAndAccount10);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ReceivingPartiesAndAccount10";
				definition = "Chain of parties involved in the settlement of a transaction, including receipts and deliveries, book transfers, treasury deals, or other activities, resulting in the movement of a security or amount of money from one account to another.";
				nextVersions_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount15.mmObject());
	...
	public ReceivingPartiesAndAccount10 setDepository(PartyIdentification34Choice depository) {
	...
	public ReceivingPartiesAndAccount10 setParty1(PartyIdentificationAndAccount102 party1) {
	...
	public ReceivingPartiesAndAccount10 setParty2(PartyIdentificationAndAccount77 party2) {
		this.party2 = party2;
		return this;
	}
}