...
public class ReceivingPartiesAndAccount10 {
	...
	public static final MMMessageAssociationEnd mmDepository = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ReceivingPartiesAndAccount10.mmObject();
			isDerived = false;
			xmlTag = "Dpstry";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceivingPartiesAndAccount15.mmDepository);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount7.mmDepository;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmParty1 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceivingPartiesAndAccount15.mmParty1);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount7.mmParty1;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmParty2 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceivingPartiesAndAccount15.mmParty2);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount7.mmParty2;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public PartyIdentificationAndAccount77 getParty2() {
		return party2;
	}

	public void setParty2(com.tools20022.repository.msg.PartyIdentificationAndAccount77 party2) {
		this.party2 = party2;
	}
}