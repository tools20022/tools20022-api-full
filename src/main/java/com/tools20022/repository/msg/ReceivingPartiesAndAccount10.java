...
public class ReceivingPartiesAndAccount10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount10.mmDepository, ReceivingPartiesAndAccount10.mmParty1, ReceivingPartiesAndAccount10.mmParty2);
