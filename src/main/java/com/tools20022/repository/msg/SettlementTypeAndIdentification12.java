...
public class SettlementTypeAndIdentification12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification12.mmAccountOwnerTransactionIdentification, SettlementTypeAndIdentification12.mmAccountServicerTransactionIdentification,
						SettlementTypeAndIdentification12.mmMarketInfrastructureTransactionIdentification, SettlementTypeAndIdentification12.mmProcessorTransactionIdentification, SettlementTypeAndIdentification12.mmSecuritiesMovementType,
						SettlementTypeAndIdentification12.mmPayment, SettlementTypeAndIdentification12.mmCommonIdentification, SettlementTypeAndIdentification12.mmPoolIdentification,
						SettlementTypeAndIdentification12.mmCorporateActionEventIdentification);
