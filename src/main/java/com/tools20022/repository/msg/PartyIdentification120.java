...
public class PartyIdentification120 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification120.mmIdentification, PartyIdentification120.mmProcessingIdentification, PartyIdentification120.mmAlternateIdentification);
