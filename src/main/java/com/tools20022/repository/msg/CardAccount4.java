...
public class CardAccount4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardAccount4.mmSelectionMethod, CardAccount4.mmSelectedAccountType, CardAccount4.mmAccountName, CardAccount4.mmAccountOwner, CardAccount4.mmCurrency,
						CardAccount4.mmAccountIdentifier, CardAccount4.mmCreditReference, CardAccount4.mmServicer, CardAccount4.mmBalance, CardAccount4.mmBalanceDisplayFlag, CardAccount4.mmDefaultAccountIndicator);
