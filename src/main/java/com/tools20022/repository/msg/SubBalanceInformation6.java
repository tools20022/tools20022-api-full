...
public class SubBalanceInformation6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation6.mmSubBalanceType, SubBalanceInformation6.mmQuantity, SubBalanceInformation6.mmSubBalanceAdditionalDetails,
						SubBalanceInformation6.mmAdditionalBalanceBreakdownDetails);
