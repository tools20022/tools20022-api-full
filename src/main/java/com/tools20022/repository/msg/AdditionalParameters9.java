 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters9
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters9}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters9", propOrder = {"partialSettlement", "previousPartialConfirmationIdentification", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "poolIdentification",
...
public class AdditionalParameters9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<PartialSettlement1Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters9, Optional<PartialSettlement1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmPartialSettlementType;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters9.mmObject();
			isDerived = false;
			xmlTag = "PrtlSttlm";
		...
		@Override
		public Optional<PartialSettlement1Code> getValue(AdditionalParameters9 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters9 obj, Optional<PartialSettlement1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters9 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters9 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmPoolIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<AdditionalParameters9, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters9.mmPartialSettlement, com.tools20022.repository.msg.AdditionalParameters9.mmPreviousPartialConfirmationIdentification,
						com.tools20022.repository.msg.AdditionalParameters9.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters9.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters9.mmPoolIdentification, com.tools20022.repository.msg.AdditionalParameters9.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.AdditionalParameters9.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters9.mmProcessorTransactionIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters9);
	...
	public AdditionalParameters9 setPartialSettlement(PartialSettlement1Code partialSettlement) {
	...
	public AdditionalParameters9 setPreviousPartialConfirmationIdentification(RestrictedFINXMax16Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters9 setAccountOwnerTransactionIdentification(RestrictedFINXMax16Text accountOwnerTransactionIdentification) {
	...
	public AdditionalParameters9 setAccountServicerTransactionIdentification(RestrictedFINXMax16Text accountServicerTransactionIdentification) {
	...
	public AdditionalParameters9 setPoolIdentification(RestrictedFINXMax16Text poolIdentification) {
	...
	public AdditionalParameters9 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public AdditionalParameters9 setMarketInfrastructureTransactionIdentification(RestrictedFINXMax16Text marketInfrastructureTransactionIdentification) {
	...
	public AdditionalParameters9 setProcessorTransactionIdentification(RestrictedFINXMax16Text processorTransactionIdentification) {
