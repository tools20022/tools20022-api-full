...
public class AdditionalParameters9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters9.mmPartialSettlement, AdditionalParameters9.mmPreviousPartialConfirmationIdentification, AdditionalParameters9.mmAccountOwnerTransactionIdentification,
						AdditionalParameters9.mmAccountServicerTransactionIdentification, AdditionalParameters9.mmPoolIdentification, AdditionalParameters9.mmCorporateActionEventIdentification,
						AdditionalParameters9.mmMarketInfrastructureTransactionIdentification, AdditionalParameters9.mmProcessorTransactionIdentification);
