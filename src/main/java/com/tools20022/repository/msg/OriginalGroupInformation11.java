 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.OriginalGroupInformation11#mmOriginalMessageNameIdentification
 * OriginalGroupInformation11.mmOriginalMessageNameIdentification}</li>
 * <li>
...
@XmlType(name = "OriginalGroupInformation11", propOrder = {"originalMessageIdentification", "originalMessageNameIdentification", "originalCreationDateTime", "returnReasonInformation"})
public class OriginalGroupInformation11 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.OriginalGroupInformation11
	 * OriginalGroupInformation11}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation11, Max35Text> mmOriginalMessageIdentification = new MMMessageAttribute<OriginalGroupInformation11, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation11.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgId";
		...
		@Override
		public Max35Text getValue(OriginalGroupInformation11 obj) {
			return obj.getOriginalMessageIdentification();
		}

		@Override
		public void setValue(OriginalGroupInformation11 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation11, Max35Text> mmOriginalMessageNameIdentification = new MMMessageAttribute<OriginalGroupInformation11, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation11.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgNmId";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation11, Optional<ISODateTime>> mmOriginalCreationDateTime = new MMMessageAttribute<OriginalGroupInformation11, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(OriginalGroupInformation11 obj) {
			return obj.getOriginalCreationDateTime();
		}

		@Override
		public void setValue(OriginalGroupInformation11 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalGroupInformation11, List<ReturnReasonInformation3>> mmReturnReasonInformation = new MMMessageAssociationEnd<OriginalGroupInformation11, List<ReturnReasonInformation3>>() {
		{
		...
		@Override
		public List<ReturnReasonInformation3> getValue(OriginalGroupInformation11 obj) {
			return obj.getReturnReasonInformation();
		}

		@Override
		public void setValue(OriginalGroupInformation11 obj, List<ReturnReasonInformation3> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalGroupInformation11.mmOriginalMessageIdentification,
						com.tools20022.repository.msg.OriginalGroupInformation11.mmOriginalMessageNameIdentification, com.tools20022.repository.msg.OriginalGroupInformation11.mmOriginalCreationDateTime,
						com.tools20022.repository.msg.OriginalGroupInformation11.mmReturnReasonInformation);
				...
				name = "OriginalGroupInformation11";
	...
	public OriginalGroupInformation11 setOriginalMessageIdentification(Max35Text originalMessageIdentification) {
	...
	public OriginalGroupInformation11 setOriginalMessageNameIdentification(Max35Text originalMessageNameIdentification) {
	...
	public OriginalGroupInformation11 setOriginalCreationDateTime(ISODateTime originalCreationDateTime) {
	...
	public OriginalGroupInformation11 setReturnReasonInformation(List<ReturnReasonInformation3> returnReasonInformation) {
