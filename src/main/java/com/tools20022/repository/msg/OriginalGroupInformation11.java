...
public class OriginalGroupInformation11 {
	...
	public static final MMMessageAttribute mmOriginalMessageIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OriginalGroupInformation11.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalGroupInformation11.mmOriginalMessageIdentification, OriginalGroupInformation11.mmOriginalMessageNameIdentification, OriginalGroupInformation11.mmOriginalCreationDateTime,
						OriginalGroupInformation11.mmReturnReasonInformation);
