...
@XmlType(name = "SecuritiesReferenceDataChange2", propOrder = {"financialInstrumentIdentification", "fieldName", "oldFieldValue", "newFieldValue", "operationTimeStamp"})
public class SecuritiesReferenceDataChange2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesReferenceDataChange2, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<SecuritiesReferenceDataChange2, SecurityIdentification19>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "FinancialInstrumentIdentification";
			definition = "Identifies the financial instrument for which the changes are listed in the advice.";
			previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(SecuritiesReferenceDataChange2 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(SecuritiesReferenceDataChange2 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesReferenceDataChange2, Max35Text> mmFieldName = new MMMessageAttribute<SecuritiesReferenceDataChange2, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmObject();
			isDerived = false;
			xmlTag = "FldNm";
			...
			previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmFieldName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(SecuritiesReferenceDataChange2 obj) {
			return obj.getFieldName();
		}

		@Override
		public void setValue(SecuritiesReferenceDataChange2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesReferenceDataChange2, Max350Text> mmOldFieldValue = new MMMessageAttribute<SecuritiesReferenceDataChange2, Max350Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmObject();
			isDerived = false;
			xmlTag = "OdFldVal";
			...
			name = "OldFieldValue";
			definition = "Value of the related field before the change was applied.";
			previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmOldFieldValue;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(SecuritiesReferenceDataChange2 obj) {
			return obj.getOldFieldValue();
		}

		@Override
		public void setValue(SecuritiesReferenceDataChange2 obj, Max350Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesReferenceDataChange2, Max350Text> mmNewFieldValue = new MMMessageAttribute<SecuritiesReferenceDataChange2, Max350Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmObject();
			isDerived = false;
			xmlTag = "NewFldVal";
			...
			previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmNewFieldValue;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesReferenceDataChange2, ISODateTime> mmOperationTimeStamp = new MMMessageAttribute<SecuritiesReferenceDataChange2, ISODateTime>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmObject();
			isDerived = false;
			xmlTag = "OprTmStmp";
			...
			previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmOperationTimeStamp;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODateTime getValue(SecuritiesReferenceDataChange2 obj) {
			return obj.getOperationTimeStamp();
		}

		@Override
		public void setValue(SecuritiesReferenceDataChange2 obj, ISODateTime value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmFieldName,
						com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmOldFieldValue, com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmNewFieldValue,
						com.tools20022.repository.msg.SecuritiesReferenceDataChange2.mmOperationTimeStamp);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SecuritiesReferenceDataChange2";
				definition = "Describes the comparison between the currently established baseline elements and the proposed ones.";
				previousVersion_lazy = () -> SecuritiesReferenceDataChange1.mmObject();
			}
		});
	...
	public SecuritiesReferenceDataChange2 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public SecuritiesReferenceDataChange2 setFieldName(Max35Text fieldName) {
	...
	public SecuritiesReferenceDataChange2 setOldFieldValue(Max350Text oldFieldValue) {
	...
	public SecuritiesReferenceDataChange2 setNewFieldValue(Max350Text newFieldValue) {
	...
	public SecuritiesReferenceDataChange2 setOperationTimeStamp(ISODateTime operationTimeStamp) {
