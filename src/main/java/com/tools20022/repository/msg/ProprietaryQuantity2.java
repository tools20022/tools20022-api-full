 ...
 * <li>{@linkplain com.tools20022.repository.msg.ProprietaryQuantity2#mmIssuer
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forProprietaryQuantity2
 * ConstraintCoexistenceQuantityRule.forProprietaryQuantity2}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule#forProprietaryQuantity2
 * ConstraintCoexistenceIssuerSchemeNameRule.forProprietaryQuantity2}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ProprietaryQuantity8
...
@XmlType(name = "ProprietaryQuantity2", propOrder = {"quantity", "quantityType", "issuer", "schemeName"})
public class ProprietaryQuantity2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity2, DecimalNumber> mmQuantity = new MMMessageAttribute<ProprietaryQuantity2, DecimalNumber>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ProprietaryQuantity2.mmObject();
			isDerived = false;
			xmlTag = "Qty";
		...
		@Override
		public DecimalNumber getValue(ProprietaryQuantity2 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(ProprietaryQuantity2 obj, DecimalNumber value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity2, Exact4AlphaNumericText> mmQuantityType = new MMMessageAttribute<ProprietaryQuantity2, Exact4AlphaNumericText>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ProprietaryQuantity2.mmObject();
			isDerived = false;
			xmlTag = "QtyTp";
		...
		@Override
		public Exact4AlphaNumericText getValue(ProprietaryQuantity2 obj) {
			return obj.getQuantityType();
		}

		@Override
		public void setValue(ProprietaryQuantity2 obj, Exact4AlphaNumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity2, Max35Text> mmIssuer = new MMMessageAttribute<ProprietaryQuantity2, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(ProprietaryQuantity2 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(ProprietaryQuantity2 obj, Max35Text value) {
			obj.setIssuer(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity2, Optional<Max35Text>> mmSchemeName = new MMMessageAttribute<ProprietaryQuantity2, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(ProprietaryQuantity2 obj) {
			return obj.getSchemeName();
		}

		@Override
		public void setValue(ProprietaryQuantity2 obj, Optional<Max35Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forProprietaryQuantity2,
						com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule.forProprietaryQuantity2);
				...
				name = "ProprietaryQuantity2";
				definition = "Proprietary quantity format.";
				nextVersions_lazy = () -> Arrays.asList(ProprietaryQuantity8.mmObject());
			}
		});
	...
	public ProprietaryQuantity2 setQuantity(DecimalNumber quantity) {
	...
	public ProprietaryQuantity2 setQuantityType(Exact4AlphaNumericText quantityType) {
	...
	public ProprietaryQuantity2 setIssuer(Max35Text issuer) {
	...
	public ProprietaryQuantity2 setSchemeName(Max35Text schemeName) {
