 ...
 * AdditionalParameters12.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters12#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters12.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters12
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters12}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline#forAdditionalParameters12
 * ConstraintPartialSettlementGuideline.forAdditionalParameters12}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters12", propOrder = {"preConfirmation", "partialSettlement", "previousPartialConfirmationIdentification", "tripartyAgentCollateralTransactionIdentification",
...
public class AdditionalParameters12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters12, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters12, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters12.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters12 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters12 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters12, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters12, Optional<PartialSettlement2Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters12 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters12 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(AdditionalParameters12 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters12 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters12, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters12.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters12.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters12.mmPreviousPartialConfirmationIdentification, com.tools20022.repository.msg.AdditionalParameters12.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters12.mmClientTripartyCollateralTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingConfirmationV03.mmAdditionalParameters, SecuritiesSettlementTransactionConfirmationV03.mmAdditionalParameters);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters12,
						com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline.forAdditionalParameters12);
				...
				name = "AdditionalParameters12";
				definition = "Specifies additional parameters to the message or transaction.";
				nextVersions_lazy = () -> Arrays.asList(AdditionalParameters18.mmObject(), AdditionalParameters17.mmObject());
			}
		});
	...
	public AdditionalParameters12 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters12 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters12 setPreviousPartialConfirmationIdentification(Max35Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters12 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters12 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
