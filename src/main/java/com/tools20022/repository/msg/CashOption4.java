...
import com.tools20022.repository.msg.CorporateActionAmounts4;
import com.tools20022.repository.msg.CorporateActionDate9;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption4#mmAmountDetails
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forCashOption4
 * ConstraintCoexistenceAmountRule.forCashOption4}</li>
 * </ul>
 * </li>
 * <li>
...
public class CashOption4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption4, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashOption4, CreditDebitCode>() {
		{
			businessElementTrace_lazy = () -> ProceedsDefinition.mmCreditDebitIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption4.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
		...
		@Override
		public CreditDebitCode getValue(CashOption4 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashOption4 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption4, Optional<NonEligibleProceedsIndicator1Choice>> mmNonEligibleProceedsIndicator = new MMMessageAttribute<CashOption4, Optional<NonEligibleProceedsIndicator1Choice>>() {
		{
		...
		@Override
		public Optional<NonEligibleProceedsIndicator1Choice> getValue(CashOption4 obj) {
			return obj.getNonEligibleProceedsIndicator();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<NonEligibleProceedsIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption4, Optional<GenericIdentification20>> mmIncomeType = new MMMessageAttribute<CashOption4, Optional<GenericIdentification20>>() {
		{
		...
		@Override
		public Optional<GenericIdentification20> getValue(CashOption4 obj) {
			return obj.getIncomeType();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption4, Optional<CashAccountIdentification5Choice>> mmCashAccountIdentification = new MMMessageAttribute<CashOption4, Optional<CashAccountIdentification5Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(CashOption4 obj) {
			return obj.getCashAccountIdentification();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<CashAccountIdentification5Choice> value) {
			obj.setCashAccountIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "AmtDtls")
	protected CorporateActionAmounts4 amountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption4, Optional<CorporateActionAmounts4>> mmAmountDetails = new MMMessageAssociationEnd<CashOption4, Optional<CorporateActionAmounts4>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionAmounts4.mmObject();
		}

		@Override
		public Optional<CorporateActionAmounts4> getValue(CashOption4 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<CorporateActionAmounts4> value) {
			obj.setAmountDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "DtDtls", required = true)
	protected CorporateActionDate9 dateDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption4, CorporateActionDate9> mmDateDetails = new MMMessageAssociationEnd<CashOption4, CorporateActionDate9>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption4.mmObject();
			isDerived = false;
		...
		@Override
		public CorporateActionDate9 getValue(CashOption4 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CashOption4 obj, CorporateActionDate9 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption4, Optional<ForeignExchangeTerms11>> mmForeignExchangeDetails = new MMMessageAssociationEnd<CashOption4, Optional<ForeignExchangeTerms11>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms11> getValue(CashOption4 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<ForeignExchangeTerms11> value) {
			obj.setForeignExchangeDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "GncCshPricRcvdPerPdct")
	protected PriceFormat10Choice genericCashPriceReceivedPerProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption4, Optional<PriceFormat10Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAttribute<CashOption4, Optional<PriceFormat10Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat10Choice> getValue(CashOption4 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CashOption4 obj, Optional<PriceFormat10Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOption4.mmCreditDebitIndicator, com.tools20022.repository.msg.CashOption4.mmNonEligibleProceedsIndicator,
						com.tools20022.repository.msg.CashOption4.mmIncomeType, com.tools20022.repository.msg.CashOption4.mmCashAccountIdentification, com.tools20022.repository.msg.CashOption4.mmAmountDetails,
						com.tools20022.repository.msg.CashOption4.mmDateDetails, com.tools20022.repository.msg.CashOption4.mmForeignExchangeDetails, com.tools20022.repository.msg.CashOption4.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CashProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCashOption4);
	...
	public CashOption4 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption4 setNonEligibleProceedsIndicator(NonEligibleProceedsIndicator1Choice nonEligibleProceedsIndicator) {
	...
	public CashOption4 setIncomeType(GenericIdentification20 incomeType) {
	...
	public CashOption4 setCashAccountIdentification(CashAccountIdentification5Choice cashAccountIdentification) {
		this.cashAccountIdentification = cashAccountIdentification;
		return this;
	}

	public Optional<CorporateActionAmounts4> getAmountDetails() {
		return amountDetails == null ? Optional.empty() : Optional.of(amountDetails);
	}

	public CashOption4 setAmountDetails(CorporateActionAmounts4 amountDetails) {
	...
	public CashOption4 setDateDetails(CorporateActionDate9 dateDetails) {
	...
	public CashOption4 setForeignExchangeDetails(ForeignExchangeTerms11 foreignExchangeDetails) {
		this.foreignExchangeDetails = foreignExchangeDetails;
		return this;
	}

	public Optional<PriceFormat10Choice> getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct == null ? Optional.empty() : Optional.of(genericCashPriceReceivedPerProduct);
	}

	public CashOption4 setGenericCashPriceReceivedPerProduct(PriceFormat10Choice genericCashPriceReceivedPerProduct) {
