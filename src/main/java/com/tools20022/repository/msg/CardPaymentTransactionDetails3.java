...
public class CardPaymentTransactionDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails3.mmCurrency, CardPaymentTransactionDetails3.mmTotalAmount, CardPaymentTransactionDetails3.mmAmountQualifier,
						CardPaymentTransactionDetails3.mmDetailedAmount, CardPaymentTransactionDetails3.mmValidityDate, CardPaymentTransactionDetails3.mmUnattendedLevelCategory, CardPaymentTransactionDetails3.mmAccountType,
						CardPaymentTransactionDetails3.mmRecurringTransaction, CardPaymentTransactionDetails3.mmProduct, CardPaymentTransactionDetails3.mmICCRelatedData);
