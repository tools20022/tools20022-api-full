...
@XmlType(name = "CardPaymentTransactionDetails3", propOrder = {"currency", "totalAmount", "amountQualifier", "detailedAmount", "validityDate", "unattendedLevelCategory", "accountType", "recurringTransaction", "product", "iCCRelatedData"})
public class CardPaymentTransactionDetails3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, CurrencyCode> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails3, CurrencyCode>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmCurrency);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CurrencyCode getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, CurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails3, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmTotalAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, Optional<TypeOfAmount1Code>> mmAmountQualifier = new MMMessageAttribute<CardPaymentTransactionDetails3, Optional<TypeOfAmount1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmAmountQualifier);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfAmount1Code> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getAmountQualifier();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<TypeOfAmount1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails3, List<DetailedAmount1>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails3, List<DetailedAmount1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmDetailedAmount);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<DetailedAmount1> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, List<DetailedAmount1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails3, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmValidityDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, Optional<Max35NumericText>> mmUnattendedLevelCategory = new MMMessageAttribute<CardPaymentTransactionDetails3, Optional<Max35NumericText>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmUnattendedLevelCategory);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35NumericText> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getUnattendedLevelCategory();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<Max35NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, Optional<CardAccountType1Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails3, Optional<CardAccountType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmAccountType);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType1Code> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<CardAccountType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails3, Optional<RecurringTransaction1>> mmRecurringTransaction = new MMMessageAssociationEnd<CardPaymentTransactionDetails3, Optional<RecurringTransaction1>>() {
		{
		...
		@Override
		public Optional<RecurringTransaction1> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getRecurringTransaction();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<RecurringTransaction1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails3, List<Product1>> mmProduct = new MMMessageAssociationEnd<CardPaymentTransactionDetails3, List<Product1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmProduct);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Product1> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getProduct();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, List<Product1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails3, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails3, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmICCRelatedData);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails3 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails3 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmAmountQualifier, com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmDetailedAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmValidityDate, com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmUnattendedLevelCategory,
						com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmAccountType, com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmRecurringTransaction,
						com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmProduct, com.tools20022.repository.msg.CardPaymentTransactionDetails3.mmICCRelatedData);
				...
				name = "CardPaymentTransactionDetails3";
				definition = "Details of the transaction in the completion advice.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails14.mmObject());
			}
		});
	...
	public CardPaymentTransactionDetails3 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails3 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails3 setAmountQualifier(TypeOfAmount1Code amountQualifier) {
	...
	public CardPaymentTransactionDetails3 setDetailedAmount(List<DetailedAmount1> detailedAmount) {
	...
	public CardPaymentTransactionDetails3 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails3 setUnattendedLevelCategory(Max35NumericText unattendedLevelCategory) {
	...
	public CardPaymentTransactionDetails3 setAccountType(CardAccountType1Code accountType) {
	...
	public CardPaymentTransactionDetails3 setRecurringTransaction(RecurringTransaction1 recurringTransaction) {
	...
	public CardPaymentTransactionDetails3 setProduct(List<Product1> product) {
	...
	public CardPaymentTransactionDetails3 setICCRelatedData(Max10000Binary iCCRelatedData) {
