...
public class RejectedStatusReason22 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason22.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason22.mmReasonCode, RejectedStatusReason22.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason23Choice reasonCode) {
