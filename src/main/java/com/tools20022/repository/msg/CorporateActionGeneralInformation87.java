...
public class CorporateActionGeneralInformation87 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation87.mmCorporateActionEventIdentification, CorporateActionGeneralInformation87.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation87.mmClassActionNumber, CorporateActionGeneralInformation87.mmEventType, CorporateActionGeneralInformation87.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation87.mmFinancialInstrumentIdentification);
