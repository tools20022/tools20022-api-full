	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmName);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmName;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmShortName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmShortName);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSupplementaryIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmSupplementaryIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmSupplementaryIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmClassType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmClassType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmClassType;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmSecuritiesForm = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmSecuritiesForm);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmSecuritiesForm;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmDistributionPolicy = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmDistributionPolicy);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmDistributionPolicy;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmProductGroup = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmProductGroup);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmProductGroup;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmBlockedHoldingDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmBlockedHoldingDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.FinancialInstrument29.mmBlockedHoldingDetails;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPledging = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmPledging);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCollateral = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmCollateral);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmThirdPartyRights = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmThirdPartyRights);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmFundOwnership = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmFundOwnership);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmFundIntention = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmFundIntention);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOperationalStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument56.mmOperationalStatus);
			maxOccurs = 1;
			minOccurs = 0;
