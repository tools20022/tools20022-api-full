 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule#forCorporateActionRate70
 * ConstraintGrossDividendRate2Rule.forCorporateActionRate70}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNettDividendRate1Rule#forCorporateActionRate70
 * ConstraintNettDividendRate1Rule.forCorporateActionRate70}</li>
 * <li>
...
@XmlType(name = "CorporateActionRate70", propOrder = {"grossDividendRate", "netDividendRate", "indexFactor", "interestRateUsedForPayment", "maximumAllowedOversubscriptionRate", "prorationRate", "withholdingTaxRate", "secondLevelTax",
...
public class CorporateActionRate70 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, List<GrossDividendRateFormat21Choice>> mmGrossDividendRate = new MMMessageAssociationEnd<CorporateActionRate70, List<GrossDividendRateFormat21Choice>>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmGrossDividend;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate70.mmObject();
			isDerived = false;
			xmlTag = "GrssDvddRate";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmGrossDividendRate);
			previousVersion_lazy = () -> CorporateActionRate46.mmGrossDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<GrossDividendRateFormat21Choice> getValue(CorporateActionRate70 obj) {
			return obj.getGrossDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, List<GrossDividendRateFormat21Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, List<NetDividendRateFormat23Choice>> mmNetDividendRate = new MMMessageAssociationEnd<CorporateActionRate70, List<NetDividendRateFormat23Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmNetDividendRate);
			previousVersion_lazy = () -> CorporateActionRate46.mmNetDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<NetDividendRateFormat23Choice> getValue(CorporateActionRate70 obj) {
			return obj.getNetDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, List<NetDividendRateFormat23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, Optional<RateAndAmountFormat39Choice>> mmIndexFactor = new MMMessageAssociationEnd<CorporateActionRate70, Optional<RateAndAmountFormat39Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmIndexFactor);
			previousVersion_lazy = () -> CorporateActionRate46.mmIndexFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateAndAmountFormat39Choice> getValue(CorporateActionRate70 obj) {
			return obj.getIndexFactor();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, Optional<RateAndAmountFormat39Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, List<InterestRateUsedForPaymentFormat7Choice>> mmInterestRateUsedForPayment = new MMMessageAssociationEnd<CorporateActionRate70, List<InterestRateUsedForPaymentFormat7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmInterestRateUsedForPayment);
			previousVersion_lazy = () -> CorporateActionRate46.mmInterestRateUsedForPayment;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<InterestRateUsedForPaymentFormat7Choice> getValue(CorporateActionRate70 obj) {
			return obj.getInterestRateUsedForPayment();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, List<InterestRateUsedForPaymentFormat7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate70, Optional<PercentageRate>> mmMaximumAllowedOversubscriptionRate = new MMMessageAttribute<CorporateActionRate70, Optional<PercentageRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmMaximumAllowedOversubscriptionRate);
			previousVersion_lazy = () -> CorporateActionRate46.mmMaximumAllowedOversubscriptionRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PercentageRate> getValue(CorporateActionRate70 obj) {
			return obj.getMaximumAllowedOversubscriptionRate();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate70, Optional<PercentageRate>> mmProrationRate = new MMMessageAttribute<CorporateActionRate70, Optional<PercentageRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmProrationRate);
			previousVersion_lazy = () -> CorporateActionRate46.mmProrationRate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate70, List<RateAndAmountFormat40Choice>> mmWithholdingTaxRate = new MMMessageAttribute<CorporateActionRate70, List<RateAndAmountFormat40Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmWithholdingTaxRate);
			previousVersion_lazy = () -> CorporateActionRate46.mmWithholdingTaxRate;
			minOccurs = 0;
			complexType_lazy = () -> RateAndAmountFormat40Choice.mmObject();
		}

		@Override
		public List<RateAndAmountFormat40Choice> getValue(CorporateActionRate70 obj) {
			return obj.getWithholdingTaxRate();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, List<RateAndAmountFormat40Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, List<RateAndAmountFormat40Choice>> mmSecondLevelTax = new MMMessageAssociationEnd<CorporateActionRate70, List<RateAndAmountFormat40Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmSecondLevelTax);
			minOccurs = 0;
			isComposite = true;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, Optional<RateAndAmountFormat39Choice>> mmAdditionalTax = new MMMessageAssociationEnd<CorporateActionRate70, Optional<RateAndAmountFormat39Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmAdditionalTax);
			previousVersion_lazy = () -> CorporateActionRate46.mmAdditionalTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat39Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate70, List<RateTypeAndAmountAndStatus26>> mmTaxableIncomePerDividendShare = new MMMessageAssociationEnd<CorporateActionRate70, List<RateTypeAndAmountAndStatus26>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmTaxableIncomePerDividendShare);
			previousVersion_lazy = () -> CorporateActionRate46.mmTaxableIncomePerDividendShare;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateTypeAndAmountAndStatus26> getValue(CorporateActionRate70 obj) {
			return obj.getTaxableIncomePerDividendShare();
		}

		@Override
		public void setValue(CorporateActionRate70 obj, List<RateTypeAndAmountAndStatus26> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate70.mmGrossDividendRate, com.tools20022.repository.msg.CorporateActionRate70.mmNetDividendRate,
						com.tools20022.repository.msg.CorporateActionRate70.mmIndexFactor, com.tools20022.repository.msg.CorporateActionRate70.mmInterestRateUsedForPayment,
						com.tools20022.repository.msg.CorporateActionRate70.mmMaximumAllowedOversubscriptionRate, com.tools20022.repository.msg.CorporateActionRate70.mmProrationRate,
						com.tools20022.repository.msg.CorporateActionRate70.mmWithholdingTaxRate, com.tools20022.repository.msg.CorporateActionRate70.mmSecondLevelTax, com.tools20022.repository.msg.CorporateActionRate70.mmAdditionalTax,
						com.tools20022.repository.msg.CorporateActionRate70.mmTaxableIncomePerDividendShare);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule.forCorporateActionRate70,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule.forCorporateActionRate70, com.tools20022.repository.constraints.ConstraintNettDividendRate1Rule.forCorporateActionRate70,
						com.tools20022.repository.constraints.ConstraintNettDividendRate2Rule.forCorporateActionRate70, com.tools20022.repository.constraints.ConstraintSecondLevelTax1Rule.forCorporateActionRate70);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionRate70";
				definition = "Specifies rates.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionRate82.mmObject());
				previousVersion_lazy = () -> CorporateActionRate46.mmObject();
			}
		});
	...
	public CorporateActionRate70 setGrossDividendRate(List<GrossDividendRateFormat21Choice> grossDividendRate) {
	...
	public CorporateActionRate70 setNetDividendRate(List<NetDividendRateFormat23Choice> netDividendRate) {
	...
	public CorporateActionRate70 setIndexFactor(RateAndAmountFormat39Choice indexFactor) {
	...
	public CorporateActionRate70 setInterestRateUsedForPayment(List<InterestRateUsedForPaymentFormat7Choice> interestRateUsedForPayment) {
	...
	public CorporateActionRate70 setMaximumAllowedOversubscriptionRate(PercentageRate maximumAllowedOversubscriptionRate) {
	...
	public CorporateActionRate70 setProrationRate(PercentageRate prorationRate) {
	...
	public CorporateActionRate70 setWithholdingTaxRate(List<RateAndAmountFormat40Choice> withholdingTaxRate) {
	...
	public CorporateActionRate70 setSecondLevelTax(List<RateAndAmountFormat40Choice> secondLevelTax) {
	...
	public CorporateActionRate70 setAdditionalTax(RateAndAmountFormat39Choice additionalTax) {
	...
	public CorporateActionRate70 setTaxableIncomePerDividendShare(List<RateTypeAndAmountAndStatus26> taxableIncomePerDividendShare) {
