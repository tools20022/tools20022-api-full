...
public class CorporateActionRate18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate18.mmAdditionalTax, CorporateActionRate18.mmGrossDividendRate, CorporateActionRate18.mmIndexFactor, CorporateActionRate18.mmInterestRateUsedForPayment,
						CorporateActionRate18.mmMaximumAllowedOversubscriptionRate, CorporateActionRate18.mmProrationRate, CorporateActionRate18.mmWithholdingTaxRate, CorporateActionRate18.mmTaxRelatedRate,
						CorporateActionRate18.mmTaxableIncomePerDividendShare);
