...
public class CorporateActionGeneralInformation108 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation108.mmCorporateActionEventIdentification, CorporateActionGeneralInformation108.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation108.mmClassActionNumber, CorporateActionGeneralInformation108.mmEventType, CorporateActionGeneralInformation108.mmMandatoryVoluntaryEventType,
