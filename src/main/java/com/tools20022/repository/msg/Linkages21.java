...
@XmlType(name = "Linkages21", propOrder = "reference")
public class Linkages21 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Linkages21
	 * Linkages21}</li>
	...
	public static final MMMessageAssociationEnd mmReference = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Linkages40.mmReference);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages21.mmReference);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Linkages21";
				definition = "Information related to a linked transaction.";
				nextVersions_lazy = () -> Arrays.asList(Linkages40.mmObject());
			}
		});
	...
	public Linkages21 setReference(References1Choice reference) {
