...
public class OtherAmounts23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OtherAmounts23.mmAccruedInterestAmount, OtherAmounts23.mmChargesFees, OtherAmounts23.mmCountryNationalFederalTax, OtherAmounts23.mmTradeAmount,
						OtherAmounts23.mmExecutingBrokerAmount, OtherAmounts23.mmIssueDiscountAllowance, OtherAmounts23.mmPaymentLevyTax, OtherAmounts23.mmLocalTax, OtherAmounts23.mmLocalBrokerCommission, OtherAmounts23.mmMargin,
						OtherAmounts23.mmOther, OtherAmounts23.mmRegulatoryAmount, OtherAmounts23.mmShippingAmount, OtherAmounts23.mmSpecialConcession, OtherAmounts23.mmStampDuty, OtherAmounts23.mmStockExchangeTax,
						OtherAmounts23.mmTransferTax, OtherAmounts23.mmTransactionTax, OtherAmounts23.mmValueAddedTax, OtherAmounts23.mmWithholdingTax, OtherAmounts23.mmNetGainLoss, OtherAmounts23.mmConsumptionTax,
						OtherAmounts23.mmAccruedCapitalisationAmount, OtherAmounts23.mmBookValue);
