...
public class SecuritiesOption12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption12.mmSecurityDetails, SecuritiesOption12.mmCreditDebitIndicator, SecuritiesOption12.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption12.mmNonEligibleProceedsIndicator, SecuritiesOption12.mmEntitledQuantity, SecuritiesOption12.mmFractionDisposition, SecuritiesOption12.mmCurrencyOption, SecuritiesOption12.mmTradingPeriod,
						SecuritiesOption12.mmDateDetails, SecuritiesOption12.mmRateDetails, SecuritiesOption12.mmPriceDetails);
