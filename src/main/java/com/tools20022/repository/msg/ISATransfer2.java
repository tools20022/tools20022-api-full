...
import com.tools20022.repository.area.sese.PortfolioTransferConfirmationV03;
...
import com.tools20022.repository.msg.FinancialInstrument24;
import java.util.*;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer2#mmMasterReference
 * ISATransfer2.mmMasterReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.ISATransfer2#mmTransferConfirmationIdentification
 * ISATransfer2.mmTransferConfirmationIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.ISATransfer2#mmTransferInstructionReference
 * ISATransfer2.mmTransferInstructionReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.ISATransfer2#mmActualTransferDate
 * ISATransfer2.mmActualTransferDate}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer2#mmResidualCash
 * ISATransfer2.mmResidualCash}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer2#mmPortfolio
 * ISATransfer2.mmPortfolio}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer2#mmAllOtherCash
 * ISATransfer2.mmAllOtherCash}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintISARule#forISATransfer2
 * ConstraintISARule.forISATransfer2}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDesignationRule#forISATransfer2
 * ConstraintDesignationRule.forISATransfer2}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.PEPISATransfer4
 * PEPISATransfer4}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ISATransfer2", propOrder = {"masterReference", "transferConfirmationIdentification", "transferInstructionReference", "actualTransferDate", "residualCash", "portfolio", "allOtherCash", "financialInstrumentAssetForTransfer"})
public class ISATransfer2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<ISATransfer2, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer2.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<Max35Text> getValue(ISATransfer2 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(ISATransfer2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, Max35Text> mmTransferConfirmationIdentification = new MMMessageAttribute<ISATransfer2, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer2.mmObject();
			isDerived = false;
			xmlTag = "TrfConfId";
		...
		@Override
		public Max35Text getValue(ISATransfer2 obj) {
			return obj.getTransferConfirmationIdentification();
		}

		@Override
		public void setValue(ISATransfer2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, Max35Text> mmTransferInstructionReference = new MMMessageAttribute<ISATransfer2, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer2.mmObject();
			isDerived = false;
			xmlTag = "TrfInstrRef";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, ISODate> mmActualTransferDate = new MMMessageAttribute<ISATransfer2, ISODate>() {
		{
		...
		@Override
		public ISODate getValue(ISATransfer2 obj) {
			return obj.getActualTransferDate();
		}

		@Override
		public void setValue(ISATransfer2 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, Optional<ResidualCash1Code>> mmResidualCash = new MMMessageAttribute<ISATransfer2, Optional<ResidualCash1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer2.mmObject();
			isDerived = false;
			xmlTag = "RsdlCsh";
		...
		@Override
		public Optional<ResidualCash1Code> getValue(ISATransfer2 obj) {
			return obj.getResidualCash();
		}

		@Override
		public void setValue(ISATransfer2 obj, Optional<ResidualCash1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ISATransfer2, ISAPortfolio2Choice> mmPortfolio = new MMMessageAssociationEnd<ISATransfer2, ISAPortfolio2Choice>() {
		{
		...
		@Override
		public ISAPortfolio2Choice getValue(ISATransfer2 obj) {
			return obj.getPortfolio();
		}

		@Override
		public void setValue(ISATransfer2 obj, ISAPortfolio2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer2, YesNoIndicator> mmAllOtherCash = new MMMessageAttribute<ISATransfer2, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer2.mmObject();
			isDerived = false;
			xmlTag = "AllOthrCsh";
		...
		@Override
		public YesNoIndicator getValue(ISATransfer2 obj) {
			return obj.getAllOtherCash();
		}

		@Override
		public void setValue(ISATransfer2 obj, YesNoIndicator value) {
			obj.setAllOtherCash(value);
		}
	};
	@XmlElement(name = "FinInstrmAsstForTrf")
	protected List<FinancialInstrument24> financialInstrumentAssetForTransfer;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.FinancialInstrument24
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ISATransfer2, List<FinancialInstrument24>> mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd<ISATransfer2, List<FinancialInstrument24>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrument24.mmObject();
		}

		@Override
		public List<FinancialInstrument24> getValue(ISATransfer2 obj) {
			return obj.getFinancialInstrumentAssetForTransfer();
		}

		@Override
		public void setValue(ISATransfer2 obj, List<FinancialInstrument24> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer2.mmMasterReference, com.tools20022.repository.msg.ISATransfer2.mmTransferConfirmationIdentification,
						com.tools20022.repository.msg.ISATransfer2.mmTransferInstructionReference, com.tools20022.repository.msg.ISATransfer2.mmActualTransferDate, com.tools20022.repository.msg.ISATransfer2.mmResidualCash,
						com.tools20022.repository.msg.ISATransfer2.mmPortfolio, com.tools20022.repository.msg.ISATransfer2.mmAllOtherCash, com.tools20022.repository.msg.ISATransfer2.mmFinancialInstrumentAssetForTransfer);
				messageBuildingBlock_lazy = () -> Arrays.asList(PortfolioTransferConfirmationV03.mmProductTransfer);
				trace_lazy = () -> PortfolioTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintISARule.forISATransfer2, com.tools20022.repository.constraints.ConstraintDesignationRule.forISATransfer2);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ISATransfer2";
				definition = "Describes the type of product and the assets to be transferred.";
				nextVersions_lazy = () -> Arrays.asList(ISATransfer10.mmObject());
				previousVersion_lazy = () -> PEPISATransfer4.mmObject();
			}
		});
	...
	public ISATransfer2 setMasterReference(Max35Text masterReference) {
	...
	public ISATransfer2 setTransferConfirmationIdentification(Max35Text transferConfirmationIdentification) {
	...
	public ISATransfer2 setTransferInstructionReference(Max35Text transferInstructionReference) {
	...
	public ISATransfer2 setActualTransferDate(ISODate actualTransferDate) {
	...
	public ISATransfer2 setResidualCash(ResidualCash1Code residualCash) {
	...
	public ISATransfer2 setPortfolio(ISAPortfolio2Choice portfolio) {
	...
	public ISATransfer2 setAllOtherCash(YesNoIndicator allOtherCash) {
		this.allOtherCash = Objects.requireNonNull(allOtherCash);
		return this;
	}

	public List<FinancialInstrument24> getFinancialInstrumentAssetForTransfer() {
	...
	public ISATransfer2 setFinancialInstrumentAssetForTransfer(List<FinancialInstrument24> financialInstrumentAssetForTransfer) {
