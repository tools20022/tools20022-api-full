...
@XmlType(name = "StructuredRemittanceInformation9", propOrder = {"referredDocumentInformation", "referredDocumentAmount", "creditorReferenceInformation", "invoicer", "invoicee", "additionalRemittanceInformation"})
public class StructuredRemittanceInformation9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation9, List<ReferredDocumentInformation3>> mmReferredDocumentInformation = new MMMessageAssociationEnd<StructuredRemittanceInformation9, List<ReferredDocumentInformation3>>() {
		{
			businessComponentTrace_lazy = () -> Document.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation9.mmObject();
			isDerived = false;
			xmlTag = "RfrdDocInf";
		...
		@Override
		public List<ReferredDocumentInformation3> getValue(StructuredRemittanceInformation9 obj) {
			return obj.getReferredDocumentInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation9 obj, List<ReferredDocumentInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<RemittanceAmount2>> mmReferredDocumentAmount = new MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<RemittanceAmount2>>() {
		{
		...
		@Override
		public Optional<RemittanceAmount2> getValue(StructuredRemittanceInformation9 obj) {
			return obj.getReferredDocumentAmount();
		}

		@Override
		public void setValue(StructuredRemittanceInformation9 obj, Optional<RemittanceAmount2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<CreditorReferenceInformation2>> mmCreditorReferenceInformation = new MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<CreditorReferenceInformation2>>() {
		{
		...
		@Override
		public Optional<CreditorReferenceInformation2> getValue(StructuredRemittanceInformation9 obj) {
			return obj.getCreditorReferenceInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation9 obj, Optional<CreditorReferenceInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<PartyIdentification43>> mmInvoicer = new MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<PartyIdentification43>>() {
		{
		...
		@Override
		public Optional<PartyIdentification43> getValue(StructuredRemittanceInformation9 obj) {
			return obj.getInvoicer();
		}

		@Override
		public void setValue(StructuredRemittanceInformation9 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<PartyIdentification43>> mmInvoicee = new MMMessageAssociationEnd<StructuredRemittanceInformation9, Optional<PartyIdentification43>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<StructuredRemittanceInformation9, List<Max140Text>> mmAdditionalRemittanceInformation = new MMMessageAttribute<StructuredRemittanceInformation9, List<Max140Text>>() {
		{
			businessComponentTrace_lazy = () -> Document.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation9.mmObject();
			isDerived = false;
		...
		@Override
		public List<Max140Text> getValue(StructuredRemittanceInformation9 obj) {
			return obj.getAdditionalRemittanceInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation9 obj, List<Max140Text> value) {
	...
	public StructuredRemittanceInformation9 setReferredDocumentInformation(List<ReferredDocumentInformation3> referredDocumentInformation) {
	...
	public StructuredRemittanceInformation9 setReferredDocumentAmount(RemittanceAmount2 referredDocumentAmount) {
	...
	public StructuredRemittanceInformation9 setCreditorReferenceInformation(CreditorReferenceInformation2 creditorReferenceInformation) {
	...
	public StructuredRemittanceInformation9 setInvoicer(PartyIdentification43 invoicer) {
	...
	public StructuredRemittanceInformation9 setInvoicee(PartyIdentification43 invoicee) {
	...
	public StructuredRemittanceInformation9 setAdditionalRemittanceInformation(List<Max140Text> additionalRemittanceInformation) {
