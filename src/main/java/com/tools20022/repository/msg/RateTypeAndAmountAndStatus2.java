...
public class RateTypeAndAmountAndStatus2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus2.mmRateType, RateTypeAndAmountAndStatus2.mmAmount, RateTypeAndAmountAndStatus2.mmRateStatus);
