...
public class CorporateActionRate45 {
	...
	public static final MMMessageAssociationEnd mmAdditionalTax = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionRate45.mmObject();
			isDerived = false;
			xmlTag = "AddtlTax";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate45.mmAdditionalTax, CorporateActionRate45.mmGrossDividendRate, CorporateActionRate45.mmNetDividendRate, CorporateActionRate45.mmIndexFactor,
						CorporateActionRate45.mmInterestRateUsedForPayment, CorporateActionRate45.mmMaximumAllowedOversubscriptionRate, CorporateActionRate45.mmProrationRate, CorporateActionRate45.mmWithholdingTaxRate,
						CorporateActionRate45.mmWithholdingOfForeignTax, CorporateActionRate45.mmTaxRelatedRate, CorporateActionRate45.mmTaxableIncomePerDividendShare, CorporateActionRate45.mmTaxOnIncome);
