...
public class ForeignExchangeTerms15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms15.mmUnitCurrency, ForeignExchangeTerms15.mmQuotedCurrency, ForeignExchangeTerms15.mmExchangeRate, ForeignExchangeTerms15.mmResultingAmount);
