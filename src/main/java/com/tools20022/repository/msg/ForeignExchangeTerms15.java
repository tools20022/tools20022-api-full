...
public class ForeignExchangeTerms15 {
	...
	public static final MMMessageAttribute UnitCurrency = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ForeignExchangeTerms15.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms15.UnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms15.QuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms15.ExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms15.ResultingAmount);
