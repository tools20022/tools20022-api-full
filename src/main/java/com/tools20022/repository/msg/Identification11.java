...
public class Identification11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification11.mmAccountOwnerTransactionIdentification, Identification11.mmAccountServicerTransactionIdentification,
						Identification11.mmMarketInfrastructureTransactionIdentification, Identification11.mmProcessorTransactionIdentification, Identification11.mmCommonIdentification, Identification11.mmTradeIdentification,
						Identification11.mmMasterIdentification, Identification11.mmBasketIdentification, Identification11.mmIndexIdentification, Identification11.mmListIdentification, Identification11.mmProgramIdentification,
						Identification11.mmPoolIdentification, Identification11.mmCorporateActionEventIdentification);
