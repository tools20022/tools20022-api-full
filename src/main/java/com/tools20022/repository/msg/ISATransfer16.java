...
public class ISATransfer16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer16.mmMasterReference, ISATransfer16.mmTransferIdentification, ISATransfer16.mmTransferConfirmationIdentification, ISATransfer16.mmRequestedTransferDate,
						ISATransfer16.mmPortfolio, ISATransfer16.mmResidualCash, ISATransfer16.mmAllOtherCash, ISATransfer16.mmFinancialInstrumentAssetForTransfer);
