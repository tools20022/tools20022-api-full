...
public class AccountIdentification37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification37.mmSafekeepingAccount, AccountIdentification37.mmAccountOwner, AccountIdentification37.mmSafekeepingPlace, AccountIdentification37.mmConfirmedBalance);
