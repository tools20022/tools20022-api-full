...
@XmlType(name = "RejectionReason25", propOrder = {"code", "additionalReasonInformation"})
public class RejectionReason25 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionReason23Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason10#mmCode
	...
	public static final MMMessageAssociationEnd<RejectionReason25, RejectionReason23Choice> mmCode = new MMMessageAssociationEnd<RejectionReason25, RejectionReason23Choice>() {
		{
			...
			previousVersion_lazy = () -> RejectionReason10.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<RejectionReason25, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason25, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> RejectionReason10.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason25.mmCode, com.tools20022.repository.msg.RejectionReason25.mmAdditionalReasonInformation);
	...
	public RejectionReason23Choice getCode() {
		return code;
	}

	public RejectionReason25 setCode(RejectionReason23Choice code) {
	...
	public RejectionReason25 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
