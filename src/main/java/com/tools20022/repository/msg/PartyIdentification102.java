...
import com.tools20022.repository.choice.PartyIdentification111Choice;
...
@XmlType(name = "PartyIdentification102", propOrder = {"identification", "processingIdentification", "alternateIdentification"})
public class PartyIdentification102 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Id", required = true)
	protected PartyIdentification111Choice identification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification102, PartyIdentification111Choice> mmIdentification = new MMMessageAssociationEnd<PartyIdentification102, PartyIdentification111Choice>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification102.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentification120.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PartyIdentification111Choice.mmObject();
		}

		@Override
		public PartyIdentification111Choice getValue(PartyIdentification102 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(PartyIdentification102 obj, PartyIdentification111Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification102, Optional<RestrictedFINXMax16Text>> mmProcessingIdentification = new MMMessageAttribute<PartyIdentification102, Optional<RestrictedFINXMax16Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification102.mmObject();
			isDerived = false;
			xmlTag = "PrcgId";
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentification120.mmProcessingIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(PartyIdentification102 obj) {
			return obj.getProcessingIdentification();
		}

		@Override
		public void setValue(PartyIdentification102 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification102, List<AlternatePartyIdentification9>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentification102, List<AlternatePartyIdentification9>>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification102.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentification120.mmAlternateIdentification);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<AlternatePartyIdentification9> getValue(PartyIdentification102 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(PartyIdentification102 obj, List<AlternatePartyIdentification9> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification102.mmIdentification, com.tools20022.repository.msg.PartyIdentification102.mmProcessingIdentification,
						com.tools20022.repository.msg.PartyIdentification102.mmAlternateIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalInforrmationRule.forPartyIdentification102);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PartyIdentification102";
				definition = "Provides information about identification of the party.";
				nextVersions_lazy = () -> Arrays.asList(PartyIdentification120.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public PartyIdentification111Choice getIdentification() {
		return identification;
	}

	public PartyIdentification102 setIdentification(PartyIdentification111Choice identification) {
	...
	public PartyIdentification102 setProcessingIdentification(RestrictedFINXMax16Text processingIdentification) {
	...
	public PartyIdentification102 setAlternateIdentification(List<AlternatePartyIdentification9> alternateIdentification) {
