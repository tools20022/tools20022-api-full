 ...
 * <li>{@linkplain com.tools20022.repository.msg.CorporateAction35#EventStage
 * CorporateAction35.EventStage}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CorporateAction35#LotteryType
...
public class CorporateAction35 {
	...
	public static final MMMessageAssociationEnd DateDetails = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateAction35.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateAction35.DateDetails, com.tools20022.repository.msg.CorporateAction35.EventStage, com.tools20022.repository.msg.CorporateAction35.LotteryType);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionCancellationAdvice002V07.CorporateActionDetails,
