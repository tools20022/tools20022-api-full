...
public class FinancialInstrumentAttributes29 {
	...
	public static final MMMessageAssociationEnd mmPlaceOfListing = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentAttributes29.mmObject();
			isDerived = false;
			xmlTag = "PlcOfListg";
	 ...
	 * securities, that is, whether the repaid capital is distributed (payment
	...
	public void setUnderlyingFinancialInstrumentIdentification(List<com.tools20022.repository.msg.SecurityIdentification15> underlyingFinancialInstrumentIdentification) {
