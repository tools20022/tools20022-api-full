 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.UnderlyingPaymentInstruction2#OriginalGroupInformation
 * UnderlyingPaymentInstruction2.OriginalGroupInformation}</li>
 * <li>
...
public class UnderlyingPaymentInstruction2 {
	...
	public static final MMMessageAssociationEnd OriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> UnderlyingPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "OrgnlGrpInf";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OriginalGroupInformation";
			definition = "Set of elements used to provide information on the original message.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.OriginalGroupInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.OriginalPaymentInformationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalInstructionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.OriginalInstructionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.OriginalEndToEndIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalInstructedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.OriginalInstructedAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.RequestedExecutionDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedCollectionDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction3.RequestedCollectionDate);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction2.OriginalGroupInformation,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.OriginalPaymentInformationIdentification, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.OriginalInstructionIdentification,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.OriginalEndToEndIdentification, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.OriginalInstructedAmount,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.RequestedExecutionDate, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.RequestedCollectionDate);
