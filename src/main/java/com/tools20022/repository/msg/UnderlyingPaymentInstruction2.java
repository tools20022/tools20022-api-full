 ...
 * UnderlyingPaymentInstruction2.mmOriginalPaymentInformationIdentification}</li>
 * <li>
...
public class UnderlyingPaymentInstruction2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<UnderlyingPaymentInstruction2, Optional<UnderlyingGroupInformation1>> mmOriginalGroupInformation = new MMMessageAssociationEnd<UnderlyingPaymentInstruction2, Optional<UnderlyingGroupInformation1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmObject();
			isDerived = false;
			xmlTag = "OrgnlGrpInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OriginalGroupInformation";
			definition = "Set of elements used to provide information on the original message.";
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmOriginalGroupInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<UnderlyingGroupInformation1> getValue(UnderlyingPaymentInstruction2 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(UnderlyingPaymentInstruction2 obj, Optional<UnderlyingGroupInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>> mmOriginalPaymentInformationIdentification = new MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmOriginalPaymentInformationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(UnderlyingPaymentInstruction2 obj) {
			return obj.getOriginalPaymentInformationIdentification();
		}

		@Override
		public void setValue(UnderlyingPaymentInstruction2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmOriginalInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmOriginalEndToEndIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, ActiveOrHistoricCurrencyAndAmount> mmOriginalInstructedAmount = new MMMessageAttribute<UnderlyingPaymentInstruction2, ActiveOrHistoricCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmOriginalInstructedAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyAndAmount getValue(UnderlyingPaymentInstruction2 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(UnderlyingPaymentInstruction2 obj, ActiveOrHistoricCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<ISODate>> mmRequestedExecutionDate = new MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmRequestedExecutionDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(UnderlyingPaymentInstruction2 obj) {
			return obj.getRequestedExecutionDate();
		}

		@Override
		public void setValue(UnderlyingPaymentInstruction2 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<ISODate>> mmRequestedCollectionDate = new MMMessageAttribute<UnderlyingPaymentInstruction2, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmRequestedCollectionDate);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmOriginalGroupInformation,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmOriginalPaymentInformationIdentification, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmOriginalInstructedAmount,
						com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmRequestedExecutionDate, com.tools20022.repository.msg.UnderlyingPaymentInstruction2.mmRequestedCollectionDate);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOriginalIdentificationRule.forUnderlyingPaymentInstruction2,
						com.tools20022.repository.constraints.ConstraintOriginalRequestedDateRule.forUnderlyingPaymentInstruction2);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnderlyingPaymentInstruction2";
				definition = "Reference information concerning the original payment initiation, to which the investigation message refers.";
				nextVersions_lazy = () -> Arrays.asList(UnderlyingPaymentInstruction3.mmObject());
			}
		});
	...
	public UnderlyingPaymentInstruction2 setOriginalGroupInformation(UnderlyingGroupInformation1 originalGroupInformation) {
	...
	public UnderlyingPaymentInstruction2 setOriginalPaymentInformationIdentification(Max35Text originalPaymentInformationIdentification) {
	...
	public UnderlyingPaymentInstruction2 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public UnderlyingPaymentInstruction2 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public UnderlyingPaymentInstruction2 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public UnderlyingPaymentInstruction2 setRequestedExecutionDate(ISODate requestedExecutionDate) {
	...
	public UnderlyingPaymentInstruction2 setRequestedCollectionDate(ISODate requestedCollectionDate) {
