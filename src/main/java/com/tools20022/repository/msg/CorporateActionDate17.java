...
public class CorporateActionDate17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionDate17.mmPaymentDate, CorporateActionDate17.mmValueDate, CorporateActionDate17.mmForeignExchangeRateFixingDate, CorporateActionDate17.mmEarliestPaymentDate);
