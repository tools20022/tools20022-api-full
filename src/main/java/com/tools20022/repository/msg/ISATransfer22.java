	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmMasterReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransferIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmTransferIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmTransferConfirmationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmTransferConfirmationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmRequestedTransferDate = new MMMessageAttribute() {
		{
			...
			definition = "Requested date at which the assets should be transferred.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmRequestedTransferDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPortfolio = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmPortfolio;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmResidualCash = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmResidualCash;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAllOtherCash = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmAllOtherCash;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd() {
		{
			...
			definition = "Specifies the underlying assets for the ISA or portfolio.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.ISATransfer18.mmFinancialInstrumentAssetForTransfer;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferInstructionV07.mmProductTransfer);
