 ...
 * <li>{@linkplain com.tools20022.repository.msg.CreditTransferTransaction6#Tax
...
public class CreditTransferTransaction6 {
	...
	public static final MMMessageAssociationEnd PaymentIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.PaymentIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.PaymentTypeInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Amount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ExchangeRateInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.ExchangeRateInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.ChargeBearer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChequeInstruction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.ChequeInstruction);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.UltimateDebtor);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent1 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent1);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent1Account = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent1Account);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent2 = new MMMessageAssociationEnd() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If more than two intermediary agents are present, then IntermediaryAgent2 identifies the agent between the IntermediaryAgent1 and the IntermediaryAgent3.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent2);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent2Account = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent2Account);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent3 = new MMMessageAssociationEnd() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If IntermediaryAgent3 is present, then it identifies the agent between the IntermediaryAgent 2 and the CreditorAgent.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent3);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent3Account = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.IntermediaryAgent3Account);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.CreditorAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.CreditorAgentAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Creditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.Creditor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.CreditorAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd UltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.UltimateCreditor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd InstructionForCreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.InstructionForCreditorAgent);
			minOccurs = 0;
	...
	public static final MMMessageAttribute InstructionForDebtorAgent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.InstructionForDebtorAgent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Purpose = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.Purpose);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RegulatoryReporting = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.RegulatoryReporting);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd Tax = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.Tax);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RelatedRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.RelatedRemittanceInformation);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd RemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.RemittanceInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupplementaryData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction20.SupplementaryData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction6.PaymentIdentification, com.tools20022.repository.msg.CreditTransferTransaction6.PaymentTypeInformation,
						com.tools20022.repository.msg.CreditTransferTransaction6.Amount, com.tools20022.repository.msg.CreditTransferTransaction6.ExchangeRateInformation,
						com.tools20022.repository.msg.CreditTransferTransaction6.ChargeBearer, com.tools20022.repository.msg.CreditTransferTransaction6.ChequeInstruction,
						com.tools20022.repository.msg.CreditTransferTransaction6.UltimateDebtor, com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent1,
						com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent1Account, com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent2,
						com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent2Account, com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent3,
						com.tools20022.repository.msg.CreditTransferTransaction6.IntermediaryAgent3Account, com.tools20022.repository.msg.CreditTransferTransaction6.CreditorAgent,
						com.tools20022.repository.msg.CreditTransferTransaction6.CreditorAgentAccount, com.tools20022.repository.msg.CreditTransferTransaction6.Creditor,
						com.tools20022.repository.msg.CreditTransferTransaction6.CreditorAccount, com.tools20022.repository.msg.CreditTransferTransaction6.UltimateCreditor,
						com.tools20022.repository.msg.CreditTransferTransaction6.InstructionForCreditorAgent, com.tools20022.repository.msg.CreditTransferTransaction6.InstructionForDebtorAgent,
						com.tools20022.repository.msg.CreditTransferTransaction6.Purpose, com.tools20022.repository.msg.CreditTransferTransaction6.RegulatoryReporting, com.tools20022.repository.msg.CreditTransferTransaction6.Tax,
						com.tools20022.repository.msg.CreditTransferTransaction6.RelatedRemittanceInformation, com.tools20022.repository.msg.CreditTransferTransaction6.RemittanceInformation,
						com.tools20022.repository.msg.CreditTransferTransaction6.SupplementaryData);
