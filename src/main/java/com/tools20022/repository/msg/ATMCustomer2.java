...
public class ATMCustomer2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMCustomer2, Optional<ATMCustomerProfile2>> mmProfile = new MMMessageAssociationEnd<ATMCustomer2, Optional<ATMCustomerProfile2>>() {
		{
		...
		@Override
		public Optional<ATMCustomerProfile2> getValue(ATMCustomer2 obj) {
			return obj.getProfile();
		}

		@Override
		public void setValue(ATMCustomer2 obj, Optional<ATMCustomerProfile2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMCustomer2, List<TransactionVerificationResult5>> mmAuthenticationResult = new MMMessageAssociationEnd<ATMCustomer2, List<TransactionVerificationResult5>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMCustomer2.mmObject();
			isDerived = false;
			xmlTag = "AuthntcnRslt";
		...
		@Override
		public List<TransactionVerificationResult5> getValue(ATMCustomer2 obj) {
			return obj.getAuthenticationResult();
		}

		@Override
		public void setValue(ATMCustomer2 obj, List<TransactionVerificationResult5> value) {
	...
	public ATMCustomer2 setProfile(ATMCustomerProfile2 profile) {
	...
	public ATMCustomer2 setAuthenticationResult(List<TransactionVerificationResult5> authenticationResult) {
