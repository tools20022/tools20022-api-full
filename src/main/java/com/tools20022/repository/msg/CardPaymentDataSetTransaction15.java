...
public class CardPaymentDataSetTransaction15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction15.mmTransactionSequenceCounter, CardPaymentDataSetTransaction15.mmTraceability, CardPaymentDataSetTransaction15.mmEnvironment,
						CardPaymentDataSetTransaction15.mmContext, CardPaymentDataSetTransaction15.mmTransaction);
