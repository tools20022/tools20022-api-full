...
public class CardPaymentDataSetTransaction15 {
	...
	public static final MMMessageAttribute mmTransactionSequenceCounter = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.mmTransactionSequenceCounter);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.mmTransactionSequenceCounter;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmTraceability = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.mmTraceability);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.mmTraceability;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmEnvironment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.mmEnvironment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmContext = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.mmContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.mmContext;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.mmTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public void setEnvironment(com.tools20022.repository.msg.CardPaymentEnvironment52 environment) {
		this.environment = environment;
	}

	public CardPaymentContext19 getContext() {
		return context;
	}

	public void setContext(com.tools20022.repository.msg.CardPaymentContext19 context) {
	...
	public void setTransaction(com.tools20022.repository.msg.CardPaymentTransaction61 transaction) {
