...
public class CardPaymentDataSetTransaction15 {
	...
	public static final MMMessageAttribute TransactionSequenceCounter = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentDataSetTransaction15.mmObject();
			isDerived = false;
			xmlTag = "TxSeqCntr";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionSequenceCounter";
			definition = "Sequential counter of the transaction.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.TransactionSequenceCounter;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.TransactionSequenceCounter);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Traceability = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.Traceability;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.Traceability);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Environment = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.Environment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.Environment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Context = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.Context;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.Context);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Transaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction11.Transaction;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction19.Transaction);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction15.TransactionSequenceCounter, com.tools20022.repository.msg.CardPaymentDataSetTransaction15.Traceability,
						com.tools20022.repository.msg.CardPaymentDataSetTransaction15.Environment, com.tools20022.repository.msg.CardPaymentDataSetTransaction15.Context,
						com.tools20022.repository.msg.CardPaymentDataSetTransaction15.Transaction);
