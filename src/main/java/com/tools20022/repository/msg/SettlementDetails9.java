...
public class SettlementDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails9.mmPriority, SettlementDetails9.mmSettlementTransactionCondition, SettlementDetails9.mmSettlingCapacity, SettlementDetails9.mmStampDutyTaxBasis,
						SettlementDetails9.mmSecuritiesRTGS, SettlementDetails9.mmBeneficialOwnership, SettlementDetails9.mmCashClearingSystem, SettlementDetails9.mmTaxCapacity, SettlementDetails9.mmMarketClientSide,
						SettlementDetails9.mmBlockTrade, SettlementDetails9.mmLegalRestrictions, SettlementDetails9.mmSettlementSystemMethod, SettlementDetails9.mmNettingEligibility, SettlementDetails9.mmCCPEligibility,
						SettlementDetails9.mmAutomaticBorrowing, SettlementDetails9.mmPartialSettlementIndicator, SettlementDetails9.mmEligibleForCollateral);
