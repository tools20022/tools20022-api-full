...
public class PendingStatusReason6 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingStatusReason6.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatusReason6.mmReasonCode, PendingStatusReason6.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingReason23Choice reasonCode) {
