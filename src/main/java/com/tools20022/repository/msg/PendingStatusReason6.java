...
import com.tools20022.repository.choice.PendingReason23Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forPendingStatusReason6
 * ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PendingStatusReason6", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason6 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason23Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason6.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason6.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason6);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatusReason6";
	...
	public PendingReason23Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason6 setReasonCode(PendingReason23Choice reasonCode) {
	...
	public PendingStatusReason6 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
