...
public class QuantityAndAccount16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount16.mmSettlementQuantity, QuantityAndAccount16.mmAccountOwner, QuantityAndAccount16.mmSafekeepingAccount, QuantityAndAccount16.mmCashAccount,
						QuantityAndAccount16.mmSafekeepingPlace);
