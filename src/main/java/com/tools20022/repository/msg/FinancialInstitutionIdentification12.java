 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstitutionIdentification12#mmLEI
 * FinancialInstitutionIdentification12.mmLEI}</li>
 * </ul>
 * </li>
...
@XmlType(name = "FinancialInstitutionIdentification12", propOrder = {"bICFI", "lEI"})
public class FinancialInstitutionIdentification12 {
	...
	public static final MMMessageAttribute<FinancialInstitutionIdentification12, Optional<LEIIdentifier>> mmLEI = new MMMessageAttribute<FinancialInstitutionIdentification12, Optional<LEIIdentifier>>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "LEI";
			definition = "Legal entity identification as an alternate identification.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstitutionIdentification12.mmBICFI, com.tools20022.repository.msg.FinancialInstitutionIdentification12.mmLEI);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "FinancialInstitutionIdentification12";
	...
	public FinancialInstitutionIdentification12 setBICFI(BICFIIdentifier bICFI) {
	...
	public FinancialInstitutionIdentification12 setLEI(LEIIdentifier lEI) {
		this.lEI = lEI;
		return this;
	}
}