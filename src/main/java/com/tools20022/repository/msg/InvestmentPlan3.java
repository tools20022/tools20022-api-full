 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.InvestmentPlan3#mmFrequencyOrExtendedFrequencyRule
 * InvestmentPlan3.mmFrequencyOrExtendedFrequencyRule}</li>
 * </ul>
 * </li>
 * <li>
...
public class InvestmentPlan3 {
	...
	public static final MMMessageAttribute mmFrequency = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InvestmentPlan3.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
	...
	public static final MMXor mmFrequencyOrExtendedFrequencyRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> InvestmentPlan3.mmObject();
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentPlan3.mmFrequencyOrExtendedFrequencyRule);
			}
		});
	...
	public void setModifiedCashSettlement(List<com.tools20022.repository.msg.InvestmentFundCashSettlementInformation2> modifiedCashSettlement) {
