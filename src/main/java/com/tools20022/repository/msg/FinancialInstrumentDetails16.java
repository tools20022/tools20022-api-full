...
public class FinancialInstrumentDetails16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails16.mmFinancialInstrumentIdentification, FinancialInstrumentDetails16.mmPriceDetails, FinancialInstrumentDetails16.mmSafekeepingPlace,
						FinancialInstrumentDetails16.mmOpeningBalance, FinancialInstrumentDetails16.mmClosingBalance, FinancialInstrumentDetails16.mmTransaction);
