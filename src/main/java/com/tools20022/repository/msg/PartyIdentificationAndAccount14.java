...
public class PartyIdentificationAndAccount14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount14.mmIdentification, PartyIdentificationAndAccount14.mmSafekeepingAccount, PartyIdentificationAndAccount14.mmProcessingIdentification,
						PartyIdentificationAndAccount14.mmAdditionalInformation, PartyIdentificationAndAccount14.mmAlternateIdentification);
