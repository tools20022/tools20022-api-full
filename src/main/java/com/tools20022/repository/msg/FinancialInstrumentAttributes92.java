 ...
 * FinancialInstrumentAttributes92.mmUnderlyingFinancialInstrumentIdentification
 * }</li>
 * <li>
...
@XmlType(name = "FinancialInstrumentAttributes92", propOrder = {"placeOfListing", "dayCountBasis", "registrationForm", "paymentFrequency", "paymentStatus", "variableRateChangeFrequency", "classificationType", "optionStyle", "optionType",
...
public class FinancialInstrumentAttributes92 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<MarketIdentification3Choice>> mmPlaceOfListing = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<MarketIdentification3Choice>>() {
		{
			businessElementTrace_lazy = () -> Security.mmPlaceOfListing;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			xmlTag = "PlcOfListg";
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPlaceOfListing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification3Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getPlaceOfListing();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<MarketIdentification3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<InterestComputationMethodFormat4Choice>> mmDayCountBasis = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<InterestComputationMethodFormat4Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmDayCountBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InterestComputationMethodFormat4Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getDayCountBasis();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<InterestComputationMethodFormat4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FormOfSecurity6Choice>> mmRegistrationForm = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FormOfSecurity6Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmRegistrationForm;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FormOfSecurity6Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getRegistrationForm();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<FormOfSecurity6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Frequency23Choice>> mmPaymentFrequency = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Frequency23Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPaymentFrequency;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Frequency23Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getPaymentFrequency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<Frequency23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<SecuritiesPaymentStatus5Choice>> mmPaymentStatus = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<SecuritiesPaymentStatus5Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPaymentStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesPaymentStatus5Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getPaymentStatus();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<SecuritiesPaymentStatus5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Frequency23Choice>> mmVariableRateChangeFrequency = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Frequency23Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmVariableRateChangeFrequency;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Frequency23Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<ClassificationType32Choice>> mmClassificationType = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<ClassificationType32Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmClassificationType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ClassificationType32Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getClassificationType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<ClassificationType32Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<OptionStyle8Choice>> mmOptionStyle = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<OptionStyle8Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmOptionStyle;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionStyle8Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getOptionStyle();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<OptionStyle8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<OptionType6Choice>> mmOptionType = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<OptionType6Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmOptionType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionType6Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<OptionType6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ActiveOrHistoricCurrencyCode>> mmDenominationCurrency = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmDenominationCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getDenominationCurrency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmCouponDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmCouponDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getCouponDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmExpiryDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmExpiryDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmFloatingRateFixingDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmFloatingRateFixingDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmMaturityDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmMaturityDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmIssueDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmNextCallableDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmNextCallableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmPutableDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPutableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmDatedDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			name = "DatedDate";
			definition = "First date at which a security begins to accrue interest.";
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmDatedDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>> mmFirstPaymentDate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmFirstPaymentDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>> mmPreviousFactor = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPreviousFactor;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOneRate> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>> mmCurrentFactor = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmCurrentFactor;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> BaseOneRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>> mmNextFactor = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<BaseOneRate>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmNextFactor;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> BaseOneRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>> mmInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PercentageRate> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getInterestRate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>> mmYieldToMaturityRate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmYieldToMaturityRate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>> mmNextInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmNextInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>> mmIndexRateBasis = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<PercentageRate>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmIndexRateBasis;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Number22Choice>> mmCouponAttachedNumber = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Number22Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmCouponAttachedNumber;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Number22Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getCouponAttachedNumber();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<Number22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<GenericIdentification37>> mmPoolNumber = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<GenericIdentification37>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPoolNumber;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification37> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getPoolNumber();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<GenericIdentification37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, List<QuantityBreakdown31>> mmQuantityBreakdown = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, List<QuantityBreakdown31>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown31> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, List<QuantityBreakdown31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>> mmVariableRateIndicator = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmVariableRateIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getVariableRateIndicator();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>> mmCallableIndicator = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmCallableIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>> mmPutableIndicator = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmPutableIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<PriceType4Choice>> mmMarketOrIndicativePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<PriceType4Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmMarketOrIndicativePrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceType4Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getMarketOrIndicativePrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<PriceType4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>> mmExercisePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmExercisePrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price7> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getExercisePrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<Price7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>> mmSubscriptionPrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmSubscriptionPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Price7.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>> mmConversionPrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmConversionPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Price7.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>> mmStrikePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmStrikePrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Price7.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumNominalQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmMinimumNominalQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getMinimumNominalQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FinancialInstrumentQuantity1Choice>> mmContractSize = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmContractSize;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes92, List<SecurityIdentification19>> mmUnderlyingFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes92, List<SecurityIdentification19>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmUnderlyingFinancialInstrumentIdentification;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SecurityIdentification19> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getUnderlyingFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, List<SecurityIdentification19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes92, Optional<Max350Text>> mmFinancialInstrumentAttributeAdditionalDetails = new MMMessageAttribute<FinancialInstrumentAttributes92, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmFinancialInstrumentAttributeAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(FinancialInstrumentAttributes92 obj) {
			return obj.getFinancialInstrumentAttributeAdditionalDetails();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes92 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPlaceOfListing, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmDayCountBasis,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmRegistrationForm, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPaymentFrequency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPaymentStatus, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmVariableRateChangeFrequency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmClassificationType, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmOptionStyle,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmOptionType, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmDenominationCurrency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmCouponDate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmExpiryDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmFloatingRateFixingDate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmMaturityDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmIssueDate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmNextCallableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPutableDate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmDatedDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmFirstPaymentDate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPreviousFactor,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmCurrentFactor, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmNextFactor,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmInterestRate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmYieldToMaturityRate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmNextInterestRate, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmIndexRateBasis,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmCouponAttachedNumber, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPoolNumber,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmQuantityBreakdown, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmVariableRateIndicator,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmCallableIndicator, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmPutableIndicator,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmMarketOrIndicativePrice, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmExercisePrice,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmSubscriptionPrice, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmConversionPrice,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmStrikePrice, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmMinimumNominalQuantity,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmContractSize, com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmUnderlyingFinancialInstrumentIdentification,
						com.tools20022.repository.msg.FinancialInstrumentAttributes92.mmFinancialInstrumentAttributeAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementConfirmationV07.mmFinancialInstrumentAttributes);
				trace_lazy = () -> Asset.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPlaceOfListingRule.forFinancialInstrumentAttributes92,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forFinancialInstrumentAttributes92);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentAttributes92";
				definition = "Elements characterising a financial instrument.";
				previousVersion_lazy = () -> FinancialInstrumentAttributes63.mmObject();
			}
		});
	...
	public FinancialInstrumentAttributes92 setPlaceOfListing(MarketIdentification3Choice placeOfListing) {
	...
	public FinancialInstrumentAttributes92 setDayCountBasis(InterestComputationMethodFormat4Choice dayCountBasis) {
	...
	public FinancialInstrumentAttributes92 setRegistrationForm(FormOfSecurity6Choice registrationForm) {
	...
	public FinancialInstrumentAttributes92 setPaymentFrequency(Frequency23Choice paymentFrequency) {
	...
	public FinancialInstrumentAttributes92 setPaymentStatus(SecuritiesPaymentStatus5Choice paymentStatus) {
	...
	public FinancialInstrumentAttributes92 setVariableRateChangeFrequency(Frequency23Choice variableRateChangeFrequency) {
	...
	public FinancialInstrumentAttributes92 setClassificationType(ClassificationType32Choice classificationType) {
	...
	public FinancialInstrumentAttributes92 setOptionStyle(OptionStyle8Choice optionStyle) {
	...
	public FinancialInstrumentAttributes92 setOptionType(OptionType6Choice optionType) {
	...
	public FinancialInstrumentAttributes92 setDenominationCurrency(ActiveOrHistoricCurrencyCode denominationCurrency) {
	...
	public FinancialInstrumentAttributes92 setCouponDate(ISODate couponDate) {
	...
	public FinancialInstrumentAttributes92 setExpiryDate(ISODate expiryDate) {
	...
	public FinancialInstrumentAttributes92 setFloatingRateFixingDate(ISODate floatingRateFixingDate) {
	...
	public FinancialInstrumentAttributes92 setMaturityDate(ISODate maturityDate) {
	...
	public FinancialInstrumentAttributes92 setIssueDate(ISODate issueDate) {
	...
	public FinancialInstrumentAttributes92 setNextCallableDate(ISODate nextCallableDate) {
	...
	public FinancialInstrumentAttributes92 setPutableDate(ISODate putableDate) {
	...
	public FinancialInstrumentAttributes92 setDatedDate(ISODate datedDate) {
	...
	public FinancialInstrumentAttributes92 setFirstPaymentDate(ISODate firstPaymentDate) {
	...
	public FinancialInstrumentAttributes92 setPreviousFactor(BaseOneRate previousFactor) {
	...
	public FinancialInstrumentAttributes92 setCurrentFactor(BaseOneRate currentFactor) {
	...
	public FinancialInstrumentAttributes92 setNextFactor(BaseOneRate nextFactor) {
	...
	public FinancialInstrumentAttributes92 setInterestRate(PercentageRate interestRate) {
	...
	public FinancialInstrumentAttributes92 setYieldToMaturityRate(PercentageRate yieldToMaturityRate) {
	...
	public FinancialInstrumentAttributes92 setNextInterestRate(PercentageRate nextInterestRate) {
	...
	public FinancialInstrumentAttributes92 setIndexRateBasis(PercentageRate indexRateBasis) {
	...
	public FinancialInstrumentAttributes92 setCouponAttachedNumber(Number22Choice couponAttachedNumber) {
	...
	public FinancialInstrumentAttributes92 setPoolNumber(GenericIdentification37 poolNumber) {
	...
	public FinancialInstrumentAttributes92 setQuantityBreakdown(List<QuantityBreakdown31> quantityBreakdown) {
	...
	public FinancialInstrumentAttributes92 setVariableRateIndicator(YesNoIndicator variableRateIndicator) {
	...
	public FinancialInstrumentAttributes92 setCallableIndicator(YesNoIndicator callableIndicator) {
	...
	public FinancialInstrumentAttributes92 setPutableIndicator(YesNoIndicator putableIndicator) {
	...
	public FinancialInstrumentAttributes92 setMarketOrIndicativePrice(PriceType4Choice marketOrIndicativePrice) {
	...
	public FinancialInstrumentAttributes92 setExercisePrice(Price7 exercisePrice) {
	...
	public FinancialInstrumentAttributes92 setSubscriptionPrice(Price7 subscriptionPrice) {
	...
	public FinancialInstrumentAttributes92 setConversionPrice(Price7 conversionPrice) {
	...
	public FinancialInstrumentAttributes92 setStrikePrice(Price7 strikePrice) {
	...
	public FinancialInstrumentAttributes92 setMinimumNominalQuantity(FinancialInstrumentQuantity1Choice minimumNominalQuantity) {
	...
	public FinancialInstrumentAttributes92 setContractSize(FinancialInstrumentQuantity1Choice contractSize) {
	...
	public FinancialInstrumentAttributes92 setUnderlyingFinancialInstrumentIdentification(List<SecurityIdentification19> underlyingFinancialInstrumentIdentification) {
	...
	public FinancialInstrumentAttributes92 setFinancialInstrumentAttributeAdditionalDetails(Max350Text financialInstrumentAttributeAdditionalDetails) {
