...
public class SettlementDetails111 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails111.mmHoldIndicator, SettlementDetails111.mmPriority, SettlementDetails111.mmSecuritiesTransactionType, SettlementDetails111.mmSettlementTransactionCondition,
						SettlementDetails111.mmPartialSettlementIndicator, SettlementDetails111.mmBeneficialOwnership, SettlementDetails111.mmBlockTrade, SettlementDetails111.mmCCPEligibility, SettlementDetails111.mmDeliveryReturnReason,
						SettlementDetails111.mmCashClearingSystem, SettlementDetails111.mmExposureType, SettlementDetails111.mmFXStandingInstruction, SettlementDetails111.mmMarketClientSide, SettlementDetails111.mmNettingEligibility,
						SettlementDetails111.mmRegistration, SettlementDetails111.mmRepurchaseType, SettlementDetails111.mmLegalRestrictions, SettlementDetails111.mmSecuritiesRTGS, SettlementDetails111.mmSettlingCapacity,
						SettlementDetails111.mmSettlementSystemMethod, SettlementDetails111.mmTaxCapacity, SettlementDetails111.mmStampDutyTaxBasis, SettlementDetails111.mmTracking, SettlementDetails111.mmAutomaticBorrowing,
						SettlementDetails111.mmLetterOfGuarantee, SettlementDetails111.mmReturnLeg, SettlementDetails111.mmModificationCancellationAllowed, SettlementDetails111.mmEligibleForCollateral,
						SettlementDetails111.mmSecuritiesSubBalanceType, SettlementDetails111.mmCashSubBalanceType);
