...
import com.tools20022.repository.choice.AcknowledgementReason12Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcknowledgementReason9#mmCode
 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.AcknowledgementReason3
 * AcknowledgementReason3}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "AcknowledgementReason9", propOrder = {"code", "additionalReasonInformation"})
public class AcknowledgementReason9 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AcknowledgementReason12Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AcknowledgementReason9
	 * AcknowledgementReason9}</li>
	...
	public static final MMMessageAssociationEnd<AcknowledgementReason9, AcknowledgementReason12Choice> mmCode = new MMMessageAssociationEnd<AcknowledgementReason9, AcknowledgementReason12Choice>() {
		{
			...
			previousVersion_lazy = () -> AcknowledgementReason3.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<AcknowledgementReason9, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcknowledgementReason9, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> AcknowledgementReason3.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcknowledgementReason9.mmCode, com.tools20022.repository.msg.AcknowledgementReason9.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason9";
				definition = "Specifies additional information about the processed instruction.";
				previousVersion_lazy = () -> AcknowledgementReason3.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public AcknowledgementReason12Choice getCode() {
		return code;
	}

	public AcknowledgementReason9 setCode(AcknowledgementReason12Choice code) {
	...
	public AcknowledgementReason9 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
