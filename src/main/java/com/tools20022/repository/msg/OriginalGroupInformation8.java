 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.OriginalGroupInformation8#mmOriginalMessageNameIdentification
 * OriginalGroupInformation8.mmOriginalMessageNameIdentification}</li>
 * </ul>
 * </li>
...
@XmlType(name = "OriginalGroupInformation8", propOrder = {"originalMessageIdentification", "originalMessageNameIdentification"})
public class OriginalGroupInformation8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation8, Max35Text> mmOriginalMessageIdentification = new MMMessageAttribute<OriginalGroupInformation8, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation8.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgId";
		...
		@Override
		public Max35Text getValue(OriginalGroupInformation8 obj) {
			return obj.getOriginalMessageIdentification();
		}

		@Override
		public void setValue(OriginalGroupInformation8 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation8, Max35Text> mmOriginalMessageNameIdentification = new MMMessageAttribute<OriginalGroupInformation8, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation8.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgNmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalGroupInformation8.mmOriginalMessageIdentification, com.tools20022.repository.msg.OriginalGroupInformation8.mmOriginalMessageNameIdentification);
				...
				name = "OriginalGroupInformation8";
	...
	public OriginalGroupInformation8 setOriginalMessageIdentification(Max35Text originalMessageIdentification) {
	...
	public OriginalGroupInformation8 setOriginalMessageNameIdentification(Max35Text originalMessageNameIdentification) {
