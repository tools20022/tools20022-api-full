...
@XmlType(name = "OriginalPaymentInstruction8", propOrder = {"paymentCancellationIdentification", "case", "originalPaymentInformationIdentification", "originalGroupInformation", "numberOfTransactions", "controlSum",
...
public class OriginalPaymentInstruction8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction8.mmPaymentCancellationIdentification, OriginalPaymentInstruction8.mmCase, OriginalPaymentInstruction8.mmOriginalPaymentInformationIdentification,
						OriginalPaymentInstruction8.mmOriginalGroupInformation, OriginalPaymentInstruction8.mmNumberOfTransactions, OriginalPaymentInstruction8.mmControlSum, OriginalPaymentInstruction8.mmPaymentInformationCancellation,
						OriginalPaymentInstruction8.mmCancellationReasonInformation, OriginalPaymentInstruction8.mmTransactionInformation);
