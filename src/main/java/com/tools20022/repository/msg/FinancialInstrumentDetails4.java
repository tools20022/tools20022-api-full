...
public class FinancialInstrumentDetails4 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentDetails4.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public FinancialInstrumentAttributes13 getFinancialInstrumentAttributes() {
		return financialInstrumentAttributes;
	}

	public void setFinancialInstrumentAttributes(com.tools20022.repository.msg.FinancialInstrumentAttributes13 financialInstrumentAttributes) {
	...
	public void setSubBalance(List<com.tools20022.repository.msg.IntraPositionDetails6> subBalance) {
