...
public class CardPaymentTransactionDetails15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmCurrency, CardPaymentTransactionDetails15.mmTotalAmount, CardPaymentTransactionDetails15.mmAmountQualifier,
						CardPaymentTransactionDetails15.mmDetailedAmount, CardPaymentTransactionDetails15.mmRequestedAmount, CardPaymentTransactionDetails15.mmAuthorisedAmount, CardPaymentTransactionDetails15.mmValidityDate,
						CardPaymentTransactionDetails15.mmUnattendedLevelCategory, CardPaymentTransactionDetails15.mmAccountType, CardPaymentTransactionDetails15.mmConversionAccepted, CardPaymentTransactionDetails15.mmCurrencyConversion,
						CardPaymentTransactionDetails15.mmInstalment, CardPaymentTransactionDetails15.mmAggregationTransaction, CardPaymentTransactionDetails15.mmProduct, CardPaymentTransactionDetails15.mmCardPaymentInvoice,
						CardPaymentTransactionDetails15.mmICCRelatedData);
