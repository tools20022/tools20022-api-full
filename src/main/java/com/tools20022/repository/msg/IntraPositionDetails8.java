...
public class IntraPositionDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails8.mmSettledQuantity, IntraPositionDetails8.mmPreviouslySettledQuantity, IntraPositionDetails8.mmRemainingToBeSettledQuantity,
						IntraPositionDetails8.mmSettlementDate, IntraPositionDetails8.mmAvailableDate, IntraPositionDetails8.mmCorporateActionEventType, IntraPositionDetails8.mmBalanceFrom, IntraPositionDetails8.mmBalanceTo,
						IntraPositionDetails8.mmInstructionProcessingAdditionalDetails);
