...
public class PartyIdentificationAndAccount133 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount133.mmIdentification, PartyIdentificationAndAccount133.mmLEI, PartyIdentificationAndAccount133.mmAlternateIdentification,
						PartyIdentificationAndAccount133.mmCashAccount, PartyIdentificationAndAccount133.mmChargesAccount, PartyIdentificationAndAccount133.mmCommissionAccount, PartyIdentificationAndAccount133.mmTaxAccount,
						PartyIdentificationAndAccount133.mmAdditionalInformation);
