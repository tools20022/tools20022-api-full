...
public class SubAccountIdentification4 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	protected List<com.tools20022.repository.msg.InvestmentFundTransactionsByFund1> transactionOnSubAccount;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification4.mmIdentification, SubAccountIdentification4.mmActivityIndicator, SubAccountIdentification4.mmTransactionOnSubAccount);
	...
	public void setTransactionOnSubAccount(List<com.tools20022.repository.msg.InvestmentFundTransactionsByFund1> transactionOnSubAccount) {
