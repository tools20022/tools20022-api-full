	...
	public static final MMMessageAttribute mmCollateralIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmCollateralIdentification);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCashAccountIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmCashAccountIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmDepositAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmDepositAmount);
	...
	public static final MMMessageAttribute mmDepositType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmDepositType);
	...
	public static final MMMessageAttribute mmMaturityDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmMaturityDate);
	...
	public static final MMMessageAttribute mmValueDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmValueDate);
	...
	public static final MMMessageAttribute mmExchangeRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmExchangeRate);
	...
	public static final MMMessageAttribute mmCollateralValue = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmCollateralValue);
	...
	public static final MMMessageAttribute mmHaircut = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashCollateral5.mmHaircut);
