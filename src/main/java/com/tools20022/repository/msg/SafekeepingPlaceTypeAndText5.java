...
public class SafekeepingPlaceTypeAndText5 {
	...
	public static final MMMessageAttribute mmSafekeepingPlaceType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SafekeepingPlaceTypeAndText5.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlcTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SafekeepingPlaceTypeAndText5.mmSafekeepingPlaceType, SafekeepingPlaceTypeAndText5.mmIdentification);
