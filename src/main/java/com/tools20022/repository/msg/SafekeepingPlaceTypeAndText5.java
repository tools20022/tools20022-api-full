 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule#forSafekeepingPlaceTypeAndText5
 * ConstraintCoexistence35to30TextFieldRule.forSafekeepingPlaceTypeAndText5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SafekeepingPlaceTypeAndText5", propOrder = {"safekeepingPlaceType", "identification"})
public class SafekeepingPlaceTypeAndText5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SafekeepingPlaceTypeAndText5, SafekeepingPlace2Code> mmSafekeepingPlaceType = new MMMessageAttribute<SafekeepingPlaceTypeAndText5, SafekeepingPlace2Code>() {
		{
			businessElementTrace_lazy = () -> SafekeepingPlace.mmSafekeepingPlaceType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SafekeepingPlaceTypeAndText5.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlcTp";
		...
		@Override
		public SafekeepingPlace2Code getValue(SafekeepingPlaceTypeAndText5 obj) {
			return obj.getSafekeepingPlaceType();
		}

		@Override
		public void setValue(SafekeepingPlaceTypeAndText5 obj, SafekeepingPlace2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SafekeepingPlaceTypeAndText5, Optional<RestrictedFINXMax30Text>> mmIdentification = new MMMessageAttribute<SafekeepingPlaceTypeAndText5, Optional<RestrictedFINXMax30Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax30Text> getValue(SafekeepingPlaceTypeAndText5 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(SafekeepingPlaceTypeAndText5 obj, Optional<RestrictedFINXMax30Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText5.mmSafekeepingPlaceType, com.tools20022.repository.msg.SafekeepingPlaceTypeAndText5.mmIdentification);
				trace_lazy = () -> SafekeepingPlace.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule.forSafekeepingPlaceTypeAndText5);
				...
				name = "SafekeepingPlaceTypeAndText5";
	...
	public SafekeepingPlaceTypeAndText5 setSafekeepingPlaceType(SafekeepingPlace2Code safekeepingPlaceType) {
	...
	public SafekeepingPlaceTypeAndText5 setIdentification(RestrictedFINXMax30Text identification) {
