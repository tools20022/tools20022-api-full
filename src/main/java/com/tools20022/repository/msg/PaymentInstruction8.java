...
public class PaymentInstruction8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction8.mmPaymentInformationIdentification, PaymentInstruction8.mmPaymentMethod, PaymentInstruction8.mmPaymentTypeInformation,
						PaymentInstruction8.mmRequestedExecutionDate, PaymentInstruction8.mmDebtor, PaymentInstruction8.mmDebtorAccount, PaymentInstruction8.mmDebtorAgent, PaymentInstruction8.mmUltimateDebtor,
						PaymentInstruction8.mmChargeBearer, PaymentInstruction8.mmCreditTransferTransaction);
	...
	public void setCreditTransferTransaction(List<com.tools20022.repository.msg.CreditTransferTransaction5> creditTransferTransaction) {
