...
public class PaymentInstruction8 {
	...
	protected List<com.tools20022.repository.msg.CreditTransferTransaction5> creditTransferTransaction;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmCreditTransferTransaction = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction5.mmObject();
		}
	};
	...
	public PaymentInstruction8 setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation19 paymentTypeInformation) {
	...
	public PaymentInstruction8 setDebtor(com.tools20022.repository.msg.PartyIdentification43 debtor) {
	...
	public PaymentInstruction8 setDebtorAccount(com.tools20022.repository.msg.CashAccount24 debtorAccount) {
	...
	public PaymentInstruction8 setDebtorAgent(com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public PaymentInstruction8 setUltimateDebtor(com.tools20022.repository.msg.PartyIdentification43 ultimateDebtor) {
	...
	public PaymentInstruction8 setCreditTransferTransaction(List<com.tools20022.repository.msg.CreditTransferTransaction5> creditTransferTransaction) {
