...
public class CardPaymentEnvironment53 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment53.mmAcquirer, CardPaymentEnvironment53.mmMerchant, CardPaymentEnvironment53.mmPOI, CardPaymentEnvironment53.mmCard, CardPaymentEnvironment53.mmCustomerDevice,
						CardPaymentEnvironment53.mmWallet, CardPaymentEnvironment53.mmPaymentToken, CardPaymentEnvironment53.mmCardholder, CardPaymentEnvironment53.mmProtectedCardholderData);
