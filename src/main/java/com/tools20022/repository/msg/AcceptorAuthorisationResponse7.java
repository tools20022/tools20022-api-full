...
public class AcceptorAuthorisationResponse7 {
	...
	public static final MMMessageAssociationEnd mmTransactionResponse = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction84.mmObject();
		}
	};
	...
	public AcceptorAuthorisationResponse7 setEnvironment(com.tools20022.repository.msg.CardPaymentEnvironment69 environment) {
	...
	public AcceptorAuthorisationResponse7 setTransaction(com.tools20022.repository.msg.CardPaymentTransaction77 transaction) {
	...
	public AcceptorAuthorisationResponse7 setTransactionResponse(com.tools20022.repository.msg.CardPaymentTransaction84 transactionResponse) {
	...
	public AcceptorAuthorisationResponse7 setSupplementaryData(List<com.tools20022.repository.msg.SupplementaryData1> supplementaryData) {
