...
public class SecuritiesSettlementTransactionDetails4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails4.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails4.mmLinkages,
						SecuritiesSettlementTransactionDetails4.mmTradeDetails, SecuritiesSettlementTransactionDetails4.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails4.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails4.mmSettlementParameters, SecuritiesSettlementTransactionDetails4.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionDetails4.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionDetails4.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails4.mmCashParties, SecuritiesSettlementTransactionDetails4.mmSettlementAmount,
						SecuritiesSettlementTransactionDetails4.mmOtherAmounts, SecuritiesSettlementTransactionDetails4.mmOtherBusinessParties, SecuritiesSettlementTransactionDetails4.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionDetails4.mmSupplementaryData);
