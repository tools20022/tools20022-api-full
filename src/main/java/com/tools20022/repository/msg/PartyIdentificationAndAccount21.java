...
public class PartyIdentificationAndAccount21 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount21.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount21.mmIdentification, PartyIdentificationAndAccount21.mmAlternateIdentification, PartyIdentificationAndAccount21.mmSafekeepingAccount,
						PartyIdentificationAndAccount21.mmProcessingIdentification, PartyIdentificationAndAccount21.mmAdditionalInformation);
