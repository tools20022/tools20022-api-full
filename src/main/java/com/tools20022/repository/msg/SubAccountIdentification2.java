...
public class SubAccountIdentification2 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification2.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	protected List<com.tools20022.repository.msg.AggregateBalanceInformation2> balanceForSubAccount;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification2.mmIdentification, SubAccountIdentification2.mmFungibleIndicator, SubAccountIdentification2.mmActivityIndicator,
						SubAccountIdentification2.mmBalanceForSubAccount);
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation2> balanceForSubAccount) {
