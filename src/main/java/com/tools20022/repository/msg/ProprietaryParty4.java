...
public class ProprietaryParty4 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ProprietaryParty3#mmType
	...
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryParty3.mmType;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ProprietaryParty3#mmParty
	...
	public static final MMMessageAssociationEnd mmParty = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ProprietaryParty3.mmParty;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> ProprietaryParty3.mmObject();
			}
		});
