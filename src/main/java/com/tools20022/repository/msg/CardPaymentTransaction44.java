...
public class CardPaymentTransaction44 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction44.mmMerchantCategoryCode, CardPaymentTransaction44.mmSaleReferenceIdentification, CardPaymentTransaction44.mmTransactionIdentification,
						CardPaymentTransaction44.mmOriginalTransaction, CardPaymentTransaction44.mmTransactionSuccess, CardPaymentTransaction44.mmReversal, CardPaymentTransaction44.mmFailureReason,
						CardPaymentTransaction44.mmRecipientTransactionIdentification, CardPaymentTransaction44.mmReconciliationIdentification, CardPaymentTransaction44.mmInterchangeData, CardPaymentTransaction44.mmTransactionDetails,
						CardPaymentTransaction44.mmAuthorisationResult, CardPaymentTransaction44.mmAdditionalTransactionData);
