...
public class AuthorisationResult5 {
	...
	public static final MMMessageAssociationEnd AuthorisationEntity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.AuthorisationEntity;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.AuthorisationEntity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ResponseToAuthorisation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.ResponseToAuthorisation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.ResponseToAuthorisation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AuthorisationCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.AuthorisationCode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.AuthorisationCode);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult5.AuthorisationEntity, com.tools20022.repository.msg.AuthorisationResult5.ResponseToAuthorisation,
						com.tools20022.repository.msg.AuthorisationResult5.AuthorisationCode);
