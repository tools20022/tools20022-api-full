	...
	public static final MMMessageAssociationEnd mmAuthorisationEntity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AuthorisationResult5.mmObject();
			isDerived = false;
			xmlTag = "AuthstnNtty";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.mmAuthorisationEntity);
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.mmAuthorisationEntity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmResponseToAuthorisation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.mmResponseToAuthorisation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.mmResponseToAuthorisation;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAuthorisationCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult11.mmAuthorisationCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.AuthorisationResult2.mmAuthorisationCode;
			maxOccurs = 1;
			minOccurs = 0;
