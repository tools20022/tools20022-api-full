...
public class CorporateActionGeneralInformation68 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation68.mmCorporateActionEventIdentification, CorporateActionGeneralInformation68.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation68.mmEventType, CorporateActionGeneralInformation68.mmFinancialInstrumentIdentification);
