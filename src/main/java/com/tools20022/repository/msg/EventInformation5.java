 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation5#mmEventType
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forEventInformation5
 * ConstraintCoexistenceIdentificationRule.forEventInformation5}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation7
...
@XmlType(name = "EventInformation5", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "mandatoryVoluntaryEventType", "lastNotificationIdentification"})
public class EventInformation5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation5, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<EventInformation5, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(EventInformation5 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation5 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation5, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<EventInformation5, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmOfficialCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(EventInformation5 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation5 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation5, CorporateActionEventType11Choice> mmEventType = new MMMessageAttribute<EventInformation5, CorporateActionEventType11Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmEventType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventType11Choice getValue(EventInformation5 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(EventInformation5 obj, CorporateActionEventType11Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation5, CorporateActionMandatoryVoluntary1Choice> mmMandatoryVoluntaryEventType = new MMMessageAttribute<EventInformation5, CorporateActionMandatoryVoluntary1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmMandatoryVoluntaryEventType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionMandatoryVoluntary1Choice getValue(EventInformation5 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(EventInformation5 obj, CorporateActionMandatoryVoluntary1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<EventInformation5, Optional<NotificationIdentification1>> mmLastNotificationIdentification = new MMMessageAssociationEnd<EventInformation5, Optional<NotificationIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmLastNotificationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NotificationIdentification1> getValue(EventInformation5 obj) {
			return obj.getLastNotificationIdentification();
		}

		@Override
		public void setValue(EventInformation5 obj, Optional<NotificationIdentification1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation5.mmCorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation5.mmOfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation5.mmEventType, com.tools20022.repository.msg.EventInformation5.mmMandatoryVoluntaryEventType,
						com.tools20022.repository.msg.EventInformation5.mmLastNotificationIdentification);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forEventInformation5);
				...
				name = "EventInformation5";
				definition = "Provides information about event of a corporate action.";
				nextVersions_lazy = () -> Arrays.asList(EventInformation7.mmObject());
				previousVersion_lazy = () -> EventInformation3.mmObject();
			}
		});
	...
	public EventInformation5 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public EventInformation5 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public EventInformation5 setEventType(CorporateActionEventType11Choice eventType) {
	...
	public EventInformation5 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary1Choice mandatoryVoluntaryEventType) {
	...
	public EventInformation5 setLastNotificationIdentification(NotificationIdentification1 lastNotificationIdentification) {
