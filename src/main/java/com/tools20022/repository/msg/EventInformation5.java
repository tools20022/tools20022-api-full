...
public class EventInformation5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation5.mmCorporateActionEventIdentification, EventInformation5.mmOfficialCorporateActionEventIdentification, EventInformation5.mmEventType,
						EventInformation5.mmMandatoryVoluntaryEventType, EventInformation5.mmLastNotificationIdentification);
