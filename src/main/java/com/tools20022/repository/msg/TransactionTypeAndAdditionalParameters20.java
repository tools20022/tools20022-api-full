...
public class TransactionTypeAndAdditionalParameters20 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionTypeAndAdditionalParameters20.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters20.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters20.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters20.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters20.mmPayment, TransactionTypeAndAdditionalParameters20.mmModificationType,
						TransactionTypeAndAdditionalParameters20.mmCommonIdentification, TransactionTypeAndAdditionalParameters20.mmPoolIdentification);
	...
	public RepurchaseType31Choice getModificationType() {
		return modificationType;
	}

	public void setModificationType(RepurchaseType31Choice modificationType) {
