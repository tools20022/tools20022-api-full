	...
	public static final MMMessageAttribute mmStatusIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmStatusIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalInstructionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmTransactionStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmTransactionStatus;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmStatusReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmStatusReasonInformation;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmChargesInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAcceptanceDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmAcceptanceDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountServicerReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmAccountServicerReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmClearingSystemReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmOriginalTransactionReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmSupplementaryData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentTransaction69.mmSupplementaryData;
			minOccurs = 0;
