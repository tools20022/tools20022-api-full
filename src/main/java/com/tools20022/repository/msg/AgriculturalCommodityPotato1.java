...
public class AgriculturalCommodityPotato1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AgriculturalCommodityPotato1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AgriculturalCommodityPotato1.mmBaseProduct, AgriculturalCommodityPotato1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType45Code subProduct) {
