...
import com.tools20022.repository.codeset.AssetClassSubProductType45Code;
...
@XmlType(name = "AgriculturalCommodityPotato1", propOrder = {"baseProduct", "subProduct"})
public class AgriculturalCommodityPotato1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgriculturalCommodityPotato1, AssetClassProductType1Code> mmBaseProduct = new MMMessageAttribute<AgriculturalCommodityPotato1, AssetClassProductType1Code>() {
		{
			businessElementTrace_lazy = () -> Commodity.mmBaseProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.AgriculturalCommodityPotato1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
		...
		@Override
		public AssetClassProductType1Code getValue(AgriculturalCommodityPotato1 obj) {
			return obj.getBaseProduct();
		}

		@Override
		public void setValue(AgriculturalCommodityPotato1 obj, AssetClassProductType1Code value) {
			obj.setBaseProduct(value);
		}
	};
	@XmlElement(name = "SubPdct", required = true)
	protected AssetClassSubProductType45Code subProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AgriculturalCommodityPotato1, AssetClassSubProductType45Code> mmSubProduct = new MMMessageAttribute<AgriculturalCommodityPotato1, AssetClassSubProductType45Code>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> AssetClassSubProductType45Code.mmObject();
		}

		@Override
		public AssetClassSubProductType45Code getValue(AgriculturalCommodityPotato1 obj) {
			return obj.getSubProduct();
		}

		@Override
		public void setValue(AgriculturalCommodityPotato1 obj, AssetClassSubProductType45Code value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AgriculturalCommodityPotato1.mmBaseProduct, com.tools20022.repository.msg.AgriculturalCommodityPotato1.mmSubProduct);
				trace_lazy = () -> Commodity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AgriculturalCommodityPotato1";
				definition = "Defines commodity sub-product attributes of an agricultural derivative of type potato.";
			}
		});
	...
	public AgriculturalCommodityPotato1 setBaseProduct(AssetClassProductType1Code baseProduct) {
		this.baseProduct = Objects.requireNonNull(baseProduct);
		return this;
	}

	public AssetClassSubProductType45Code getSubProduct() {
		return subProduct;
	}

	public AgriculturalCommodityPotato1 setSubProduct(AssetClassSubProductType45Code subProduct) {
