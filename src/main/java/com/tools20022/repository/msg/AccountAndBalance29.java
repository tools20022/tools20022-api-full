...
public class AccountAndBalance29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance29.mmSafekeepingAccount, AccountAndBalance29.mmAccountOwner, AccountAndBalance29.mmSafekeepingPlace, AccountAndBalance29.mmBalance);
