...
public class RejectionReason34 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason34.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason34.mmCode, RejectionReason34.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason28Choice code) {
		this.code = code;
	}
