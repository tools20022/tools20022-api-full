...
public class RejectionReason34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason34.Code, com.tools20022.repository.msg.RejectionReason34.AdditionalReasonInformation);
