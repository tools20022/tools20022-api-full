...
public class GenericIdentification47 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> GenericIdentification47.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification47.Identification, com.tools20022.repository.msg.GenericIdentification47.Issuer,
						com.tools20022.repository.msg.GenericIdentification47.SchemeName);
				...
				previousVersion_lazy = () -> GenericIdentification25.mmObject();
			}
		});
