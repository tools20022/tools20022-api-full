...
public class SubAccountIdentification16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification16.mmAccountOwner, SubAccountIdentification16.mmSafekeepingAccount, SubAccountIdentification16.mmActivityIndicator,
						SubAccountIdentification16.mmBalanceForSubAccount);
