...
public class CorporateActionNarrative37 {
	...
	public static final MMMessageAssociationEnd mmAdditionalText = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateActionNarrative37.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNarrative37.mmAdditionalText, CorporateActionNarrative37.mmNarrativeVersion, CorporateActionNarrative37.mmInformationConditions,
						CorporateActionNarrative37.mmInformationToComplyWith, CorporateActionNarrative37.mmTaxationConditions, CorporateActionNarrative37.mmDisclaimer, CorporateActionNarrative37.mmPartyContactNarrative,
						CorporateActionNarrative37.mmRegistrationDetails, CorporateActionNarrative37.mmBasketOrIndexInformation, CorporateActionNarrative37.mmCertificationBreakdown);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdvice002V08.mmAdditionalInformation);
