...
public class SecuritiesSettlementTransactionDetails24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails24.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails24.mmLinkages,
						SecuritiesSettlementTransactionDetails24.mmTradeDetails, SecuritiesSettlementTransactionDetails24.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails24.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails24.mmSettlementParameters, SecuritiesSettlementTransactionDetails24.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails24.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails24.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails24.mmCashParties,
						SecuritiesSettlementTransactionDetails24.mmSettlementAmount, SecuritiesSettlementTransactionDetails24.mmOtherAmounts, SecuritiesSettlementTransactionDetails24.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails24.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails24.mmSupplementaryData);
