...
public class CardPaymentEnvironment29 {
	...
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment31.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment42.Acquirer);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AcquirerAvailabilityRequested = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment42.AcquirerAvailabilityRequested);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MerchantIdentification = new MMMessageAssociationEnd() {
		{
			...
			definition = "Identification of the merchant requesting the diagnostic.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment17.MerchantIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment31.MerchantIdentification, com.tools20022.repository.msg.CardPaymentEnvironment42.MerchantIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd POIIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment17.POIIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment31.POIIdentification, com.tools20022.repository.msg.CardPaymentEnvironment42.POIIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> GenericIdentification32.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd POIComponent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment42.POIComponent);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment29.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment29.AcquirerAvailabilityRequested,
						com.tools20022.repository.msg.CardPaymentEnvironment29.MerchantIdentification, com.tools20022.repository.msg.CardPaymentEnvironment29.POIIdentification,
						com.tools20022.repository.msg.CardPaymentEnvironment29.POIComponent);
