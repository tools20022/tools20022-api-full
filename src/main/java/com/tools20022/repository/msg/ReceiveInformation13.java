	...
	public static final MMMessageAttribute mmRequestedSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmRequestedSettlementDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmSettlementAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStampDuty = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmStampDuty);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmStampDuty;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmNetAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmNetAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmNetAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmSettlementPartiesDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmSettlementPartiesDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmChargeDetails = new MMMessageAssociationEnd() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmChargeDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmChargeDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCommissionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmCommissionDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmCommissionDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTaxDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmTaxDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmTaxDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmForeignExchangeDetails);
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPhysicalTransfer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmPhysicalTransfer);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmPhysicalTransfer;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPhysicalTransferDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmPhysicalTransferDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmPhysicalTransferDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmClientReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmClientReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutInstructionV05.mmSettlementDetails);
