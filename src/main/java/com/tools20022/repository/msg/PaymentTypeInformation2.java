...
public class PaymentTypeInformation2 {
	...
	public static final MMXor mmServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(PaymentTypeInformation2.mmServiceLevel, PaymentTypeInformation2.mmClearingChannel);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation2.mmInstructionPriority, PaymentTypeInformation2.mmServiceLevel, PaymentTypeInformation2.mmClearingChannel, PaymentTypeInformation2.mmLocalInstrument,
						PaymentTypeInformation2.mmSequenceType, PaymentTypeInformation2.mmCategoryPurpose);
				...
				xors_lazy = () -> Arrays.asList(PaymentTypeInformation2.mmServiceLevelOrClearingChannelRule);
			}
		});
