...
public class PartyIdentificationAndAccount23 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount23.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount23.mmIdentification, PartyIdentificationAndAccount23.mmCashAccount, PartyIdentificationAndAccount23.mmProcessingIdentification,
						PartyIdentificationAndAccount23.mmAdditionalInformation, PartyIdentificationAndAccount23.mmAlternateIdentification);
