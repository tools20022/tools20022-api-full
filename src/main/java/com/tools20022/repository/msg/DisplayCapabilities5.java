 ...
 * <li>{@linkplain com.tools20022.repository.msg.DisplayCapabilities5#LineWidth
...
public class DisplayCapabilities5 {
	...
	public static final MMMessageAttribute Destination = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DisplayCapabilities4.Destination;
			minOccurs = 1;
	...
	public static final MMMessageAttribute AvailableFormat = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DisplayCapabilities4.AvailableFormat;
			minOccurs = 0;
	...
	public static final MMMessageAttribute NumberOfLines = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DisplayCapabilities4.NumberOfLines;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LineWidth = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DisplayCapabilities4.LineWidth;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Number.mmObject();
		}
	...
	public static final MMMessageAttribute AvailableLanguage = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DisplayCapabilities4.AvailableLanguage;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DisplayCapabilities5.Destination, com.tools20022.repository.msg.DisplayCapabilities5.AvailableFormat,
						com.tools20022.repository.msg.DisplayCapabilities5.NumberOfLines, com.tools20022.repository.msg.DisplayCapabilities5.LineWidth, com.tools20022.repository.msg.DisplayCapabilities5.AvailableLanguage);
