...
public class RejectedStatusReason5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason5.Structured, com.tools20022.repository.msg.RejectedStatusReason5.AdditionalInformation);
