 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransportDataSet3#Buyer
 * TransportDataSet3.Buyer}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TransportDataSet3#Seller
 * TransportDataSet3.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TransportDataSet3#Consignor
 * TransportDataSet3.Consignor}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TransportDataSet3#Consignee
 * TransportDataSet3.Consignee}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TransportDataSet3#ShipTo
...
public class TransportDataSet3 {
	...
	public static final MMMessageAssociationEnd DataSetIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.DataSetIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Buyer = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.Buyer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Seller = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.Seller);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification26.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Consignor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.Consignor);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification26.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Consignee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.Consignee);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification26.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ShipTo = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.ShipTo);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification26.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd TransportInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet4.TransportInformation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportDataSet3.DataSetIdentification, com.tools20022.repository.msg.TransportDataSet3.Buyer, com.tools20022.repository.msg.TransportDataSet3.Seller,
						com.tools20022.repository.msg.TransportDataSet3.Consignor, com.tools20022.repository.msg.TransportDataSet3.Consignee, com.tools20022.repository.msg.TransportDataSet3.ShipTo,
						com.tools20022.repository.msg.TransportDataSet3.TransportInformation);
				trace_lazy = () -> Transport.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.tsmt.DataSetSubmissionV03.TransportDataSet, com.tools20022.repository.area.tsmt.ForwardDataSetSubmissionReportV03.TransportDataSet);
