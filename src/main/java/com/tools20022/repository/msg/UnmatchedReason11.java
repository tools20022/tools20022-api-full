...
import com.tools20022.repository.choice.UnmatchedReason14Choice;
...
@XmlType(name = "UnmatchedReason11", propOrder = {"code", "additionalReasonInformation"})
public class UnmatchedReason11 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected UnmatchedReason14Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<UnmatchedReason11, UnmatchedReason14Choice> mmCode = new MMMessageAssociationEnd<UnmatchedReason11, UnmatchedReason14Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmUnmatchedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.UnmatchedReason11.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15.mmCode);
			previousVersion_lazy = () -> UnmatchedReason6.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> UnmatchedReason14Choice.mmObject();
		}

		@Override
		public UnmatchedReason14Choice getValue(UnmatchedReason11 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(UnmatchedReason11 obj, UnmatchedReason14Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnmatchedReason11, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<UnmatchedReason11, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15.mmAdditionalReasonInformation);
		...
		@Override
		public Optional<Max210Text> getValue(UnmatchedReason11 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(UnmatchedReason11 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnmatchedReason11.mmCode, com.tools20022.repository.msg.UnmatchedReason11.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnmatchedReason11";
				definition = "Status of an instruction, advice or request.";
				nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15.mmObject());
	...
	public UnmatchedReason14Choice getCode() {
		return code;
	}

	public UnmatchedReason11 setCode(UnmatchedReason14Choice code) {
	...
	public UnmatchedReason11 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
