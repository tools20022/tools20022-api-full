...
public class UnmatchedReason11 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason11.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnmatchedReason15.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.UnmatchedReason6.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnmatchedReason15.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.UnmatchedReason6.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setCode(UnmatchedReason14Choice code) {
		this.code = code;
	}
