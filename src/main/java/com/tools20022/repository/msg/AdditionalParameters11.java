...
public class AdditionalParameters11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters11.mmPartialSettlement, AdditionalParameters11.mmPreviousPartialConfirmationIdentification, AdditionalParameters11.mmAccountOwnerTransactionIdentification,
						AdditionalParameters11.mmAccountServicerTransactionIdentification, AdditionalParameters11.mmPoolIdentification, AdditionalParameters11.mmCorporateActionEventIdentification,
						AdditionalParameters11.mmMarketInfrastructureTransactionIdentification, AdditionalParameters11.mmProcessorTransactionIdentification);
