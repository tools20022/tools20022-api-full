...
public class FinancialInstrumentDetails27 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentDetails27.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PriceInformation16.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmOpeningBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.OpeningBalance4.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmClosingBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ClosingBalance4.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.Transaction55> transaction;
	/**
	 * Transaction details.
	 * <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Transaction55.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails27.mmFinancialInstrumentIdentification, FinancialInstrumentDetails27.mmPriceDetails, FinancialInstrumentDetails27.mmSafekeepingPlace,
						FinancialInstrumentDetails27.mmOpeningBalance, FinancialInstrumentDetails27.mmClosingBalance, FinancialInstrumentDetails27.mmTransaction);
	...
	public PriceInformation16 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.PriceInformation16 priceDetails) {
	...
	public OpeningBalance4 getOpeningBalance() {
		return openingBalance;
	}

	public void setOpeningBalance(com.tools20022.repository.msg.OpeningBalance4 openingBalance) {
		this.openingBalance = openingBalance;
	}

	public ClosingBalance4 getClosingBalance() {
		return closingBalance;
	}

	public void setClosingBalance(com.tools20022.repository.msg.ClosingBalance4 closingBalance) {
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction55> transaction) {
