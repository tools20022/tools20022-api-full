...
public class TradeNewPosition3 {
	...
	protected List<com.tools20022.repository.msg.CounterpartySpecificData19> counterpartySpecificData;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmCounterpartySpecificData = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CounterpartySpecificData19.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmCommonTradeData = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CommonTradeDataReport19.mmObject();
		}
	};
	...
	public TradeNewPosition3 setCounterpartySpecificData(List<com.tools20022.repository.msg.CounterpartySpecificData19> counterpartySpecificData) {
	...
	public TradeNewPosition3 setCommonTradeData(com.tools20022.repository.msg.CommonTradeDataReport19 commonTradeData) {
	...
	public TradeNewPosition3 setTechnicalAttributes(com.tools20022.repository.msg.TechnicalAttributes1 technicalAttributes) {
	...
	public TradeNewPosition3 setSupplementaryData(List<com.tools20022.repository.msg.SupplementaryData1> supplementaryData) {
