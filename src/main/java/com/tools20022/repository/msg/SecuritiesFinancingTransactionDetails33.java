...
public class SecuritiesFinancingTransactionDetails33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesFinancingTransactionDetails33.mmSecuritiesFinancingTradeIdentification, SecuritiesFinancingTransactionDetails33.mmClosingLegIdentification,
						SecuritiesFinancingTransactionDetails33.mmPoolIdentification, SecuritiesFinancingTransactionDetails33.mmCorporateActionEventIdentification,
						SecuritiesFinancingTransactionDetails33.mmTripartyAgentCollateralTransactionIdentification, SecuritiesFinancingTransactionDetails33.mmClientTripartyCollateralTransactionIdentification,
						SecuritiesFinancingTransactionDetails33.mmAccountOwner, SecuritiesFinancingTransactionDetails33.mmSafekeepingAccount, SecuritiesFinancingTransactionDetails33.mmSafekeepingPlace,
						SecuritiesFinancingTransactionDetails33.mmPlaceOfTrade, SecuritiesFinancingTransactionDetails33.mmFinancialInstrumentIdentification, SecuritiesFinancingTransactionDetails33.mmSettlementQuantity,
						SecuritiesFinancingTransactionDetails33.mmOpeningSettlementAmount, SecuritiesFinancingTransactionDetails33.mmTerminationTransactionAmount, SecuritiesFinancingTransactionDetails33.mmOpeningSettlementDate,
						SecuritiesFinancingTransactionDetails33.mmTerminationDate, SecuritiesFinancingTransactionDetails33.mmTradeDate, SecuritiesFinancingTransactionDetails33.mmExpectedSettlementDate,
						SecuritiesFinancingTransactionDetails33.mmExpectedValueDate, SecuritiesFinancingTransactionDetails33.mmLateDeliveryDate, SecuritiesFinancingTransactionDetails33.mmRateChangeDate,
						SecuritiesFinancingTransactionDetails33.mmSecuritiesFinancingTransactionType, SecuritiesFinancingTransactionDetails33.mmSecuritiesMovementType, SecuritiesFinancingTransactionDetails33.mmPayment,
						SecuritiesFinancingTransactionDetails33.mmSettlementParameters, SecuritiesFinancingTransactionDetails33.mmRateType, SecuritiesFinancingTransactionDetails33.mmVariableRateSupport,
						SecuritiesFinancingTransactionDetails33.mmRepurchaseRate, SecuritiesFinancingTransactionDetails33.mmStockLoanMargin, SecuritiesFinancingTransactionDetails33.mmSecuritiesHaircut,
						SecuritiesFinancingTransactionDetails33.mmPricingRate, SecuritiesFinancingTransactionDetails33.mmSpread, SecuritiesFinancingTransactionDetails33.mmDeliveringSettlementParties,
						SecuritiesFinancingTransactionDetails33.mmReceivingSettlementParties, SecuritiesFinancingTransactionDetails33.mmInvestor, SecuritiesFinancingTransactionDetails33.mmSettlementInstructionProcessingAdditionalDetails);
