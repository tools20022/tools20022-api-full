...
public class SubAccountIdentification46 {
	...
	protected List<com.tools20022.repository.msg.AggregateBalanceInformation33> balanceForSubAccount;
	/**
	...
	public static final MMMessageAssociationEnd mmBalanceForSubAccount = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation33.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification46.mmAccountOwner, SubAccountIdentification46.mmSafekeepingAccount, SubAccountIdentification46.mmActivityIndicator,
						SubAccountIdentification46.mmBalanceForSubAccount);
	...
	public void setSafekeepingAccount(com.tools20022.repository.msg.SecuritiesAccount34 safekeepingAccount) {
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation33> balanceForSubAccount) {
