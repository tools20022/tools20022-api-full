 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentTypeInformation1#ServiceLevelOrClearingChannelRule
 * PaymentTypeInformation1.ServiceLevelOrClearingChannelRule}</li>
 * </ul>
 * </li>
 * <li>
...
public class PaymentTypeInformation1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation1, Optional<Priority2Code>> mmInstructionPriority = new MMMessageAttribute<PaymentTypeInformation1, Optional<Priority2Code>>() {
		{
			businessElementTrace_lazy = () -> PaymentProcessing.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTypeInformation1.mmObject();
			isDerived = false;
			xmlTag = "InstrPrty";
		...
		@Override
		public Optional<Priority2Code> getValue(PaymentTypeInformation1 obj) {
			return obj.getInstructionPriority();
		}

		@Override
		public void setValue(PaymentTypeInformation1 obj, Optional<Priority2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation1, Optional<ServiceLevel2Choice>> mmServiceLevel = new MMMessageAssociationEnd<PaymentTypeInformation1, Optional<ServiceLevel2Choice>>() {
		{
		...
		@Override
		public Optional<ServiceLevel2Choice> getValue(PaymentTypeInformation1 obj) {
			return obj.getServiceLevel();
		}

		@Override
		public void setValue(PaymentTypeInformation1 obj, Optional<ServiceLevel2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation1, Optional<ClearingChannel2Code>> mmClearingChannel = new MMMessageAttribute<PaymentTypeInformation1, Optional<ClearingChannel2Code>>() {
		{
		...
		@Override
		public Optional<ClearingChannel2Code> getValue(PaymentTypeInformation1 obj) {
			return obj.getClearingChannel();
		}

		@Override
		public void setValue(PaymentTypeInformation1 obj, Optional<ClearingChannel2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation1, Optional<LocalInstrument1Choice>> mmLocalInstrument = new MMMessageAssociationEnd<PaymentTypeInformation1, Optional<LocalInstrument1Choice>>() {
		{
		...
		@Override
		public Optional<LocalInstrument1Choice> getValue(PaymentTypeInformation1 obj) {
			return obj.getLocalInstrument();
		}

		@Override
		public void setValue(PaymentTypeInformation1 obj, Optional<LocalInstrument1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation1, Optional<PaymentCategoryPurpose1Code>> mmCategoryPurpose = new MMMessageAttribute<PaymentTypeInformation1, Optional<PaymentCategoryPurpose1Code>>() {
		{
		...
		@Override
		public Optional<PaymentCategoryPurpose1Code> getValue(PaymentTypeInformation1 obj) {
			return obj.getCategoryPurpose();
		}

		@Override
		public void setValue(PaymentTypeInformation1 obj, Optional<PaymentCategoryPurpose1Code> value) {
	...
	public static final MMXor ServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.PaymentTypeInformation1.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation1.mmServiceLevel, com.tools20022.repository.msg.PaymentTypeInformation1.mmClearingChannel);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation1.mmInstructionPriority, com.tools20022.repository.msg.PaymentTypeInformation1.mmServiceLevel,
						com.tools20022.repository.msg.PaymentTypeInformation1.mmClearingChannel, com.tools20022.repository.msg.PaymentTypeInformation1.mmLocalInstrument,
						com.tools20022.repository.msg.PaymentTypeInformation1.mmCategoryPurpose);
				...
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation1.ServiceLevelOrClearingChannelRule);
			}
		});
	...
	public PaymentTypeInformation1 setInstructionPriority(Priority2Code instructionPriority) {
	...
	public PaymentTypeInformation1 setServiceLevel(ServiceLevel2Choice serviceLevel) {
	...
	public PaymentTypeInformation1 setClearingChannel(ClearingChannel2Code clearingChannel) {
	...
	public PaymentTypeInformation1 setLocalInstrument(LocalInstrument1Choice localInstrument) {
	...
	public PaymentTypeInformation1 setCategoryPurpose(PaymentCategoryPurpose1Code categoryPurpose) {
