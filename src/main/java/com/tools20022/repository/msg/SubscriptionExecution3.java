 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubscriptionExecution3#mmPhysicalDeliveryIndicator
 * SubscriptionExecution3.mmPhysicalDeliveryIndicator}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalDeliveryDetailsRule#forSubscriptionExecution3
 * ConstraintPhysicalDeliveryDetailsRule.forSubscriptionExecution3}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SubscriptionExecution3", propOrder = {"orderReference", "dealReference", "orderType", "investmentAccountDetails", "beneficiaryDetails", "unitsNumber", "rounding", "netAmount", "grossAmount", "tradeDateTime",
		"priceDetails", "partiallyExecutedIndicator", "cumDividendIndicator", "interimProfitAmount", "foreignExchangeDetails", "incomePreference", "letterIntentReference", "accumulationRightReference", "chargeGeneralDetails",
		"commissionGeneralDetails", "taxGeneralDetails", "settlementAndCustodyDetails", "physicalDeliveryIndicator", "physicalDeliveryDetails", "refund", "subscriptionInterest", "cashSettlementDetails"})
public class SubscriptionExecution3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Max35Text> mmOrderReference = new MMMessageAttribute<SubscriptionExecution3, Max35Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesOrder.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SubscriptionExecution3.mmObject();
			isDerived = false;
			xmlTag = "OrdrRef";
		...
		@Override
		public Max35Text getValue(SubscriptionExecution3 obj) {
			return obj.getOrderReference();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Max35Text> mmDealReference = new MMMessageAttribute<SubscriptionExecution3, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, List<FundOrderType1>> mmOrderType = new MMMessageAttribute<SubscriptionExecution3, List<FundOrderType1>>() {
		{
		...
		@Override
		public List<FundOrderType1> getValue(SubscriptionExecution3 obj) {
			return obj.getOrderType();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, List<FundOrderType1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, InvestmentAccount13> mmInvestmentAccountDetails = new MMMessageAssociationEnd<SubscriptionExecution3, InvestmentAccount13>() {
		{
		...
		@Override
		public InvestmentAccount13 getValue(SubscriptionExecution3 obj) {
			return obj.getInvestmentAccountDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, InvestmentAccount13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<IndividualPerson2>> mmBeneficiaryDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<IndividualPerson2>>() {
		{
		...
		@Override
		public Optional<IndividualPerson2> getValue(SubscriptionExecution3 obj) {
			return obj.getBeneficiaryDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<IndividualPerson2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, FinancialInstrumentQuantity1> mmUnitsNumber = new MMMessageAttribute<SubscriptionExecution3, FinancialInstrumentQuantity1>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity1 getValue(SubscriptionExecution3 obj) {
			return obj.getUnitsNumber();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, FinancialInstrumentQuantity1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<RoundingDirection2Code>> mmRounding = new MMMessageAttribute<SubscriptionExecution3, Optional<RoundingDirection2Code>>() {
		{
		...
		@Override
		public Optional<RoundingDirection2Code> getValue(SubscriptionExecution3 obj) {
			return obj.getRounding();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<RoundingDirection2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, ActiveCurrencyAndAmount> mmNetAmount = new MMMessageAttribute<SubscriptionExecution3, ActiveCurrencyAndAmount>() {
		{
		...
		@Override
		public ActiveCurrencyAndAmount getValue(SubscriptionExecution3 obj) {
			return obj.getNetAmount();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>> mmGrossAmount = new MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(SubscriptionExecution3 obj) {
			return obj.getGrossAmount();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, DateAndDateTimeChoice> mmTradeDateTime = new MMMessageAttribute<SubscriptionExecution3, DateAndDateTimeChoice>() {
		{
		...
		@Override
		public DateAndDateTimeChoice getValue(SubscriptionExecution3 obj) {
			return obj.getTradeDateTime();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, UnitPrice5> mmPriceDetails = new MMMessageAssociationEnd<SubscriptionExecution3, UnitPrice5>() {
		{
		...
		@Override
		public UnitPrice5 getValue(SubscriptionExecution3 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, UnitPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, YesNoIndicator> mmPartiallyExecutedIndicator = new MMMessageAttribute<SubscriptionExecution3, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(SubscriptionExecution3 obj) {
			return obj.getPartiallyExecutedIndicator();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, YesNoIndicator> mmCumDividendIndicator = new MMMessageAttribute<SubscriptionExecution3, YesNoIndicator>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<ProfitAndLoss1Choice>> mmInterimProfitAmount = new MMMessageAttribute<SubscriptionExecution3, Optional<ProfitAndLoss1Choice>>() {
		{
		...
		@Override
		public Optional<ProfitAndLoss1Choice> getValue(SubscriptionExecution3 obj) {
			return obj.getInterimProfitAmount();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<ProfitAndLoss1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, List<ForeignExchangeTerms4>> mmForeignExchangeDetails = new MMMessageAssociationEnd<SubscriptionExecution3, List<ForeignExchangeTerms4>>() {
		{
		...
		@Override
		public List<ForeignExchangeTerms4> getValue(SubscriptionExecution3 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, List<ForeignExchangeTerms4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<IncomePreference1Code>> mmIncomePreference = new MMMessageAttribute<SubscriptionExecution3, Optional<IncomePreference1Code>>() {
		{
		...
		@Override
		public Optional<IncomePreference1Code> getValue(SubscriptionExecution3 obj) {
			return obj.getIncomePreference();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<IncomePreference1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<Max35Text>> mmLetterIntentReference = new MMMessageAttribute<SubscriptionExecution3, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(SubscriptionExecution3 obj) {
			return obj.getLetterIntentReference();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<Max35Text>> mmAccumulationRightReference = new MMMessageAttribute<SubscriptionExecution3, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalCharges2>> mmChargeGeneralDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalCharges2>>() {
		{
		...
		@Override
		public Optional<TotalCharges2> getValue(SubscriptionExecution3 obj) {
			return obj.getChargeGeneralDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<TotalCharges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalCommissions2>> mmCommissionGeneralDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalCommissions2>>() {
		{
		...
		@Override
		public Optional<TotalCommissions2> getValue(SubscriptionExecution3 obj) {
			return obj.getCommissionGeneralDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<TotalCommissions2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalTaxes2>> mmTaxGeneralDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<TotalTaxes2>>() {
		{
		...
		@Override
		public Optional<TotalTaxes2> getValue(SubscriptionExecution3 obj) {
			return obj.getTaxGeneralDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<TotalTaxes2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<FundSettlementParameters3>> mmSettlementAndCustodyDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<FundSettlementParameters3>>() {
		{
		...
		@Override
		public Optional<FundSettlementParameters3> getValue(SubscriptionExecution3 obj) {
			return obj.getSettlementAndCustodyDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<FundSettlementParameters3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, YesNoIndicator> mmPhysicalDeliveryIndicator = new MMMessageAttribute<SubscriptionExecution3, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SubscriptionExecution3.mmObject();
			isDerived = false;
			xmlTag = "PhysDlvryInd";
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<DeliveryParameters3>> mmPhysicalDeliveryDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<DeliveryParameters3>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters3> getValue(SubscriptionExecution3 obj) {
			return obj.getPhysicalDeliveryDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<DeliveryParameters3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>> mmRefund = new MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>> mmSubscriptionInterest = new MMMessageAttribute<SubscriptionExecution3, Optional<ActiveCurrencyAndAmount>>() {
		{
	...
	protected PaymentTransaction16 cashSettlementDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubscriptionExecution3, Optional<PaymentTransaction16>> mmCashSettlementDetails = new MMMessageAssociationEnd<SubscriptionExecution3, Optional<PaymentTransaction16>>() {
		{
		...
		@Override
		public Optional<PaymentTransaction16> getValue(SubscriptionExecution3 obj) {
			return obj.getCashSettlementDetails();
		}

		@Override
		public void setValue(SubscriptionExecution3 obj, Optional<PaymentTransaction16> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionExecution3.mmOrderReference, com.tools20022.repository.msg.SubscriptionExecution3.mmDealReference,
						com.tools20022.repository.msg.SubscriptionExecution3.mmOrderType, com.tools20022.repository.msg.SubscriptionExecution3.mmInvestmentAccountDetails,
						com.tools20022.repository.msg.SubscriptionExecution3.mmBeneficiaryDetails, com.tools20022.repository.msg.SubscriptionExecution3.mmUnitsNumber, com.tools20022.repository.msg.SubscriptionExecution3.mmRounding,
						com.tools20022.repository.msg.SubscriptionExecution3.mmNetAmount, com.tools20022.repository.msg.SubscriptionExecution3.mmGrossAmount, com.tools20022.repository.msg.SubscriptionExecution3.mmTradeDateTime,
						com.tools20022.repository.msg.SubscriptionExecution3.mmPriceDetails, com.tools20022.repository.msg.SubscriptionExecution3.mmPartiallyExecutedIndicator,
						com.tools20022.repository.msg.SubscriptionExecution3.mmCumDividendIndicator, com.tools20022.repository.msg.SubscriptionExecution3.mmInterimProfitAmount,
						com.tools20022.repository.msg.SubscriptionExecution3.mmForeignExchangeDetails, com.tools20022.repository.msg.SubscriptionExecution3.mmIncomePreference,
						com.tools20022.repository.msg.SubscriptionExecution3.mmLetterIntentReference, com.tools20022.repository.msg.SubscriptionExecution3.mmAccumulationRightReference,
						com.tools20022.repository.msg.SubscriptionExecution3.mmChargeGeneralDetails, com.tools20022.repository.msg.SubscriptionExecution3.mmCommissionGeneralDetails,
						com.tools20022.repository.msg.SubscriptionExecution3.mmTaxGeneralDetails, com.tools20022.repository.msg.SubscriptionExecution3.mmSettlementAndCustodyDetails,
						com.tools20022.repository.msg.SubscriptionExecution3.mmPhysicalDeliveryIndicator, com.tools20022.repository.msg.SubscriptionExecution3.mmPhysicalDeliveryDetails,
						com.tools20022.repository.msg.SubscriptionExecution3.mmRefund, com.tools20022.repository.msg.SubscriptionExecution3.mmSubscriptionInterest,
						com.tools20022.repository.msg.SubscriptionExecution3.mmCashSettlementDetails);
				trace_lazy = () -> SubscriptionExecution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalDeliveryDetailsRule.forSubscriptionExecution3);
	...
	public SubscriptionExecution3 setOrderReference(Max35Text orderReference) {
	...
	public SubscriptionExecution3 setDealReference(Max35Text dealReference) {
	...
	public SubscriptionExecution3 setOrderType(List<FundOrderType1> orderType) {
	...
	public SubscriptionExecution3 setInvestmentAccountDetails(InvestmentAccount13 investmentAccountDetails) {
	...
	public SubscriptionExecution3 setBeneficiaryDetails(IndividualPerson2 beneficiaryDetails) {
	...
	public SubscriptionExecution3 setUnitsNumber(FinancialInstrumentQuantity1 unitsNumber) {
	...
	public SubscriptionExecution3 setRounding(RoundingDirection2Code rounding) {
	...
	public SubscriptionExecution3 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public SubscriptionExecution3 setGrossAmount(ActiveCurrencyAndAmount grossAmount) {
	...
	public SubscriptionExecution3 setTradeDateTime(DateAndDateTimeChoice tradeDateTime) {
	...
	public SubscriptionExecution3 setPriceDetails(UnitPrice5 priceDetails) {
	...
	public SubscriptionExecution3 setPartiallyExecutedIndicator(YesNoIndicator partiallyExecutedIndicator) {
	...
	public SubscriptionExecution3 setCumDividendIndicator(YesNoIndicator cumDividendIndicator) {
	...
	public SubscriptionExecution3 setInterimProfitAmount(ProfitAndLoss1Choice interimProfitAmount) {
	...
	public SubscriptionExecution3 setForeignExchangeDetails(List<ForeignExchangeTerms4> foreignExchangeDetails) {
	...
	public SubscriptionExecution3 setIncomePreference(IncomePreference1Code incomePreference) {
	...
	public SubscriptionExecution3 setLetterIntentReference(Max35Text letterIntentReference) {
	...
	public SubscriptionExecution3 setAccumulationRightReference(Max35Text accumulationRightReference) {
	...
	public SubscriptionExecution3 setChargeGeneralDetails(TotalCharges2 chargeGeneralDetails) {
	...
	public SubscriptionExecution3 setCommissionGeneralDetails(TotalCommissions2 commissionGeneralDetails) {
	...
	public SubscriptionExecution3 setTaxGeneralDetails(TotalTaxes2 taxGeneralDetails) {
	...
	public SubscriptionExecution3 setSettlementAndCustodyDetails(FundSettlementParameters3 settlementAndCustodyDetails) {
	...
	public SubscriptionExecution3 setPhysicalDeliveryIndicator(YesNoIndicator physicalDeliveryIndicator) {
	...
	public SubscriptionExecution3 setPhysicalDeliveryDetails(DeliveryParameters3 physicalDeliveryDetails) {
	...
	public SubscriptionExecution3 setRefund(ActiveCurrencyAndAmount refund) {
		this.refund = refund;
		return this;
	}
	...
	public SubscriptionExecution3 setSubscriptionInterest(ActiveCurrencyAndAmount subscriptionInterest) {
		this.subscriptionInterest = subscriptionInterest;
		return this;
	}

	public Optional<PaymentTransaction16> getCashSettlementDetails() {
		return cashSettlementDetails == null ? Optional.empty() : Optional.of(cashSettlementDetails);
	}

	public SubscriptionExecution3 setCashSettlementDetails(PaymentTransaction16 cashSettlementDetails) {
