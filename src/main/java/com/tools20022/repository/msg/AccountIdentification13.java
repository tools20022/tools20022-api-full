...
public class AccountIdentification13 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountIdentification13.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification13.mmSafekeepingAccount, AccountIdentification13.mmAccountOwner, AccountIdentification13.mmSafekeepingPlace, AccountIdentification13.mmConfirmedBalance);
