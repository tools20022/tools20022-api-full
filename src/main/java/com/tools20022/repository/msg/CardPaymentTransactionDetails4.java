...
public class CardPaymentTransactionDetails4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute mmRecurringTransaction = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.RecurringTransaction1.mmObject();
		}
	};
	...
	public CardPaymentTransactionDetails4 setDetailedAmount(List<com.tools20022.repository.msg.DetailedAmount1> detailedAmount) {
	...
	public CardPaymentTransactionDetails4 setRecurringTransaction(com.tools20022.repository.msg.RecurringTransaction1 recurringTransaction) {
	...
	public CardPaymentTransactionDetails4 setProduct(List<com.tools20022.repository.msg.Product1> product) {
