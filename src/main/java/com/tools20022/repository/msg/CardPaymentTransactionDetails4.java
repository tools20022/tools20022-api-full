...
@XmlType(name = "CardPaymentTransactionDetails4", propOrder = {"currency", "totalAmount", "amountQualifier", "detailedAmount", "validityDate", "unattendedLevelCategory", "accountType", "recurringTransaction", "product", "iCCRelatedData"})
public class CardPaymentTransactionDetails4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<CurrencyCode>> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<CurrencyCode>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmCurrency);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyCode> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails4, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmTotalAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<TypeOfAmount1Code>> mmAmountQualifier = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<TypeOfAmount1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmAmountQualifier);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfAmount1Code> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getAmountQualifier();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<TypeOfAmount1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails4, List<DetailedAmount1>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails4, List<DetailedAmount1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmDetailedAmount);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<DetailedAmount1> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, List<DetailedAmount1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmValidityDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<Max35NumericText>> mmUnattendedLevelCategory = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<Max35NumericText>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmUnattendedLevelCategory);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35NumericText> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getUnattendedLevelCategory();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<Max35NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<CardAccountType1Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<CardAccountType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmAccountType);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType1Code> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<CardAccountType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<RecurringTransaction1>> mmRecurringTransaction = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<RecurringTransaction1>>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> RecurringTransaction1.mmObject();
		}

		@Override
		public Optional<RecurringTransaction1> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getRecurringTransaction();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<RecurringTransaction1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails4, List<Product1>> mmProduct = new MMMessageAssociationEnd<CardPaymentTransactionDetails4, List<Product1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmProduct);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Product1> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getProduct();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, List<Product1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails4, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails4, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmICCRelatedData);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails4 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails4 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmAmountQualifier, com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmDetailedAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmValidityDate, com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmUnattendedLevelCategory,
						com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmAccountType, com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmRecurringTransaction,
						com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmProduct, com.tools20022.repository.msg.CardPaymentTransactionDetails4.mmICCRelatedData);
				...
				name = "CardPaymentTransactionDetails4";
				definition = "Details of the transaction to capture.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails15.mmObject());
			}
		});
	...
	public CardPaymentTransactionDetails4 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails4 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails4 setAmountQualifier(TypeOfAmount1Code amountQualifier) {
	...
	public CardPaymentTransactionDetails4 setDetailedAmount(List<DetailedAmount1> detailedAmount) {
	...
	public CardPaymentTransactionDetails4 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails4 setUnattendedLevelCategory(Max35NumericText unattendedLevelCategory) {
	...
	public CardPaymentTransactionDetails4 setAccountType(CardAccountType1Code accountType) {
	...
	public CardPaymentTransactionDetails4 setRecurringTransaction(RecurringTransaction1 recurringTransaction) {
	...
	public CardPaymentTransactionDetails4 setProduct(List<Product1> product) {
	...
	public CardPaymentTransactionDetails4 setICCRelatedData(Max10000Binary iCCRelatedData) {
