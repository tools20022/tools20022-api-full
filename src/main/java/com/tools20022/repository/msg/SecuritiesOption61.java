...
public class SecuritiesOption61 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption61.mmSecurityDetails, SecuritiesOption61.mmCreditDebitIndicator, SecuritiesOption61.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption61.mmNonEligibleProceedsIndicator, SecuritiesOption61.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption61.mmNewSecuritiesIssuanceIndicator, SecuritiesOption61.mmIncomeType,
						SecuritiesOption61.mmExemptionType, SecuritiesOption61.mmEntitledQuantity, SecuritiesOption61.mmSafekeepingPlace, SecuritiesOption61.mmCountryOfIncomeSource, SecuritiesOption61.mmFractionDisposition,
						SecuritiesOption61.mmCurrencyOption, SecuritiesOption61.mmTradingPeriod, SecuritiesOption61.mmDateDetails, SecuritiesOption61.mmRateDetails, SecuritiesOption61.mmPriceDetails);
