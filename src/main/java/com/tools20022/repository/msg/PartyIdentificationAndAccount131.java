...
public class PartyIdentificationAndAccount131 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount131.mmIdentification, PartyIdentificationAndAccount131.mmLEI, PartyIdentificationAndAccount131.mmAlternateIdentification,
						PartyIdentificationAndAccount131.mmSafekeepingAccount, PartyIdentificationAndAccount131.mmProcessingDate, PartyIdentificationAndAccount131.mmProcessingIdentification,
						PartyIdentificationAndAccount131.mmAdditionalInformation);
