...
public class CardPaymentEnvironment21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment21.mmAcquirerIdentification, CardPaymentEnvironment21.mmMerchantIdentification, CardPaymentEnvironment21.mmPOIIdentification,
						CardPaymentEnvironment21.mmProtectedCardData, CardPaymentEnvironment21.mmPlainCardData);
