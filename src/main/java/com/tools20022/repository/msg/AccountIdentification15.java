...
@XmlType(name = "AccountIdentification15", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace"})
public class AccountIdentification15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountIdentification15, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountIdentification15, Max35Text>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesAccount.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountIdentification15.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification31.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(AccountIdentification15 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(AccountIdentification15 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification15, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountIdentification15, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification31.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(AccountIdentification15 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountIdentification15 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification15, Optional<SafekeepingPlaceFormat2Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountIdentification15, Optional<SafekeepingPlaceFormat2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification31.mmSafekeepingPlace);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat2Choice> getValue(AccountIdentification15 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AccountIdentification15 obj, Optional<SafekeepingPlaceFormat2Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountIdentification15.mmSafekeepingAccount, com.tools20022.repository.msg.AccountIdentification15.mmAccountOwner,
						com.tools20022.repository.msg.AccountIdentification15.mmSafekeepingPlace);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionCancellationRequestV05.mmAccountDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forAccountIdentification15);
				...
				name = "AccountIdentification15";
				definition = "Provides account identification information.";
				nextVersions_lazy = () -> Arrays.asList(AccountIdentification31.mmObject());
			}
		});
	...
	public AccountIdentification15 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountIdentification15 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public AccountIdentification15 setSafekeepingPlace(SafekeepingPlaceFormat2Choice safekeepingPlace) {
