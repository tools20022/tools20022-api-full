...
public class CardPaymentTransactionDetails13 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails13, CurrencyCode> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails13, CurrencyCode>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails18.mmCurrency, CardPaymentTransactionDetails20.mmCurrency);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmCurrency;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CurrencyCode getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, CurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails13, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails13, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails18.mmTotalAmount, CardPaymentTransactionDetails20.mmTotalAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails13, Optional<DetailedAmount5>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails13, Optional<DetailedAmount5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails18.mmDetailedAmount, CardPaymentTransactionDetails20.mmDetailedAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DetailedAmount5> getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, Optional<DetailedAmount5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails13, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails13, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails20.mmValidityDate);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmValidityDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails13, Optional<CardAccountType1Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails13, Optional<CardAccountType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails20.mmAccountType);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmAccountType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType1Code> getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, Optional<CardAccountType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails13, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails13, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails18.mmICCRelatedData, CardPaymentTransactionDetails20.mmICCRelatedData);
			previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails13 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails13 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmDetailedAmount, com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmValidityDate,
						com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmAccountType, com.tools20022.repository.msg.CardPaymentTransactionDetails13.mmICCRelatedData);
				...
				name = "CardPaymentTransactionDetails13";
				definition = "Details of the transaction in the authorisation response.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails18.mmObject(), CardPaymentTransactionDetails20.mmObject());
				previousVersion_lazy = () -> CardPaymentTransactionDetails2.mmObject();
			}
		});
	...
	public CardPaymentTransactionDetails13 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails13 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails13 setDetailedAmount(DetailedAmount5 detailedAmount) {
	...
	public CardPaymentTransactionDetails13 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails13 setAccountType(CardAccountType1Code accountType) {
	...
	public CardPaymentTransactionDetails13 setICCRelatedData(Max10000Binary iCCRelatedData) {
