...
public class Transaction19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction19.mmAccountOwnerTransactionIdentification, Transaction19.mmAccountServicerTransactionIdentification, Transaction19.mmMarketInfrastructureTransactionIdentification,
						Transaction19.mmProcessorTransactionIdentification, Transaction19.mmTradeIdentification, Transaction19.mmPoolIdentification, Transaction19.mmCommonIdentification, Transaction19.mmCorporateActionEventIdentification,
						Transaction19.mmTripartyAgentCollateralTransactionIdentification, Transaction19.mmClientTripartyCollateralTransactionIdentification, Transaction19.mmTransactionDetails, Transaction19.mmStatusAndReason);
