 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCorporateActionPrice27
 * ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice27}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice27", propOrder = {"cashInLieuOfSharePrice", "indicativeOrMarketPrice", "cashValueForTax", "genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class CorporateActionPrice27 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice27, Optional<PriceFormat5Choice>> mmCashInLieuOfSharePrice = new MMMessageAttribute<CorporateActionPrice27, Optional<PriceFormat5Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmCashInLieuOfSharePrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice27.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat5Choice> getValue(CorporateActionPrice27 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice27 obj, Optional<PriceFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice27, Optional<IndicativeOrMarketPrice2Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice27, Optional<IndicativeOrMarketPrice2Choice>>() {
		{
		...
		@Override
		public Optional<IndicativeOrMarketPrice2Choice> getValue(CorporateActionPrice27 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice27 obj, Optional<IndicativeOrMarketPrice2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice27, Optional<AmountPrice2>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice27, Optional<AmountPrice2>>() {
		{
		...
		@Override
		public Optional<AmountPrice2> getValue(CorporateActionPrice27 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice27 obj, Optional<AmountPrice2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice27, Optional<PriceFormat6Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice27, Optional<PriceFormat6Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat6Choice> getValue(CorporateActionPrice27 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice27 obj, Optional<PriceFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice27, Optional<PriceFormat7Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice27, Optional<PriceFormat7Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat7Choice> getValue(CorporateActionPrice27 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice27 obj, Optional<PriceFormat7Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice27.mmCashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice27.mmIndicativeOrMarketPrice,
						com.tools20022.repository.msg.CorporateActionPrice27.mmCashValueForTax, com.tools20022.repository.msg.CorporateActionPrice27.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice27.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice27);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionPrice27";
				definition = "Specifies prices.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionPrice39.mmObject());
				previousVersion_lazy = () -> CorporateActionPrice9.mmObject();
			}
		});
	...
	public CorporateActionPrice27 setCashInLieuOfSharePrice(PriceFormat5Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice27 setIndicativeOrMarketPrice(IndicativeOrMarketPrice2Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice27 setCashValueForTax(AmountPrice2 cashValueForTax) {
	...
	public CorporateActionPrice27 setGenericCashPricePaidPerProduct(PriceFormat6Choice genericCashPricePaidPerProduct) {
	...
	public CorporateActionPrice27 setGenericCashPriceReceivedPerProduct(PriceFormat7Choice genericCashPriceReceivedPerProduct) {
