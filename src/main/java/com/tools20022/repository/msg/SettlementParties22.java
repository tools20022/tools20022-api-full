...
public class SettlementParties22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementParties22.mmDepository, SettlementParties22.mmParty1, SettlementParties22.mmParty2, SettlementParties22.mmParty3, SettlementParties22.mmParty4,
						SettlementParties22.mmParty5);
