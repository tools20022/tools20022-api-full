...
import com.tools20022.repository.msg.CardPaymentTransaction79;
...
@XmlType(name = "CardPaymentTransaction82", propOrder = {"transactionCapture", "merchantCategoryCode", "customerConsent", "cardProgrammeProposed", "cardProgrammeApplied", "saleReferenceIdentification", "transactionIdentification",
...
public class CardPaymentTransaction82 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Optional<TrueFalseIndicator>> mmTransactionCapture = new MMMessageAttribute<CardPaymentTransaction82, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmTransactionCapture;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(CardPaymentTransaction82 obj) {
			return obj.getTransactionCapture();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Min3Max4Text> mmMerchantCategoryCode = new MMMessageAttribute<CardPaymentTransaction82, Min3Max4Text>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Min3Max4Text getValue(CardPaymentTransaction82 obj) {
			return obj.getMerchantCategoryCode();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, Min3Max4Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, List<TrueFalseIndicator>> mmCustomerConsent = new MMMessageAttribute<CardPaymentTransaction82, List<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "CstmrCnsnt";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmCustomerConsent;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}

		@Override
		public List<TrueFalseIndicator> getValue(CardPaymentTransaction82 obj) {
			return obj.getCustomerConsent();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, List<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, List<Max35Text>> mmCardProgrammeProposed = new MMMessageAttribute<CardPaymentTransaction82, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmCardProgrammeProposed;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(CardPaymentTransaction82 obj) {
			return obj.getCardProgrammeProposed();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, List<Max35Text>> mmCardProgrammeApplied = new MMMessageAttribute<CardPaymentTransaction82, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> PaymentCard.mmCardProgramme;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmCardProgrammeApplied;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction82 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction82, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction82, TransactionIdentifier1>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction82 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction82, CardPaymentTransaction79> mmOriginalTransaction = new MMMessageAssociationEnd<CardPaymentTransaction82, CardPaymentTransaction79>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransaction79 getValue(CardPaymentTransaction82 obj) {
			return obj.getOriginalTransaction();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, CardPaymentTransaction79 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>> mmInitiatorTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "InitrTxId";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction82, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction82, CardPaymentTransactionDetails34> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction82, CardPaymentTransactionDetails34>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransactionDetails34 getValue(CardPaymentTransaction82 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, CardPaymentTransactionDetails34 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction82, List<Max70Text>> mmAdditionalTransactionData = new MMMessageAttribute<CardPaymentTransaction82, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction82.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxData";
			...
			previousVersion_lazy = () -> CardPaymentTransaction74.mmAdditionalTransactionData;
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}

		@Override
		public List<Max70Text> getValue(CardPaymentTransaction82 obj) {
			return obj.getAdditionalTransactionData();
		}

		@Override
		public void setValue(CardPaymentTransaction82 obj, List<Max70Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction82.mmTransactionCapture, com.tools20022.repository.msg.CardPaymentTransaction82.mmMerchantCategoryCode,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmCustomerConsent, com.tools20022.repository.msg.CardPaymentTransaction82.mmCardProgrammeProposed,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmCardProgrammeApplied, com.tools20022.repository.msg.CardPaymentTransaction82.mmSaleReferenceIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction82.mmOriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmInitiatorTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction82.mmRecipientTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmReconciliationIdentification, com.tools20022.repository.msg.CardPaymentTransaction82.mmTransactionDetails,
						com.tools20022.repository.msg.CardPaymentTransaction82.mmAdditionalTransactionData);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction82";
				definition = "Transaction information in the cancellation request.";
				previousVersion_lazy = () -> CardPaymentTransaction74.mmObject();
			}
		});
	...
	public CardPaymentTransaction82 setTransactionCapture(TrueFalseIndicator transactionCapture) {
	...
	public CardPaymentTransaction82 setMerchantCategoryCode(Min3Max4Text merchantCategoryCode) {
	...
	public CardPaymentTransaction82 setCustomerConsent(List<TrueFalseIndicator> customerConsent) {
	...
	public CardPaymentTransaction82 setCardProgrammeProposed(List<Max35Text> cardProgrammeProposed) {
	...
	public CardPaymentTransaction82 setCardProgrammeApplied(List<Max35Text> cardProgrammeApplied) {
	...
	public CardPaymentTransaction82 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction82 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
		this.transactionIdentification = Objects.requireNonNull(transactionIdentification);
		return this;
	}

	public CardPaymentTransaction79 getOriginalTransaction() {
		return originalTransaction;
	}

	public CardPaymentTransaction82 setOriginalTransaction(CardPaymentTransaction79 originalTransaction) {
	...
	public CardPaymentTransaction82 setInitiatorTransactionIdentification(Max35Text initiatorTransactionIdentification) {
	...
	public CardPaymentTransaction82 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction82 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction82 setTransactionDetails(CardPaymentTransactionDetails34 transactionDetails) {
	...
	public CardPaymentTransaction82 setAdditionalTransactionData(List<Max70Text> additionalTransactionData) {
