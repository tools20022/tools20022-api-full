...
public class AcknowledgementReason15 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason15.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason15.mmCode, AcknowledgementReason15.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason18Choice code) {
		this.code = code;
	}
