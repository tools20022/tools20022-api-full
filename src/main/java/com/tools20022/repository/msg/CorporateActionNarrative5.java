...
public class CorporateActionNarrative5 {
	...
	public static final MMMessageAssociationEnd mmAdditionalText = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateActionNarrative5.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNarrative5.mmAdditionalText, CorporateActionNarrative5.mmNarrativeVersion, CorporateActionNarrative5.mmInformationConditions,
						CorporateActionNarrative5.mmInformationToComplyWith, CorporateActionNarrative5.mmSecurityRestriction, CorporateActionNarrative5.mmTaxationConditions, CorporateActionNarrative5.mmDisclaimer);
