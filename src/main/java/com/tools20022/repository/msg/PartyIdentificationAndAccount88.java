...
public class PartyIdentificationAndAccount88 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount88.mmIdentification, PartyIdentificationAndAccount88.mmAlternateIdentification, PartyIdentificationAndAccount88.mmNationality,
						PartyIdentificationAndAccount88.mmSafekeepingAccount, PartyIdentificationAndAccount88.mmProcessingIdentification, PartyIdentificationAndAccount88.mmAdditionalInformation);
