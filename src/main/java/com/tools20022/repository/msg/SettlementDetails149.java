...
public class SettlementDetails149 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.HoldIndicator6.mmObject();
		}
	};
	...
	public SettlementDetails149 setHoldIndicator(com.tools20022.repository.msg.HoldIndicator6 holdIndicator) {
	...
	public SettlementDetails149 setStampDutyTaxBasis(com.tools20022.repository.msg.GenericIdentification30 stampDutyTaxBasis) {
