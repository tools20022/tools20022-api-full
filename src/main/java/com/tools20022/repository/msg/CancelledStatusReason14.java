...
public class CancelledStatusReason14 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledStatusReason14.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatusReason14.mmReasonCode, CancelledStatusReason14.mmAdditionalReasonInformation);
	...
	public void setReasonCode(CancelledReason11Choice reasonCode) {
