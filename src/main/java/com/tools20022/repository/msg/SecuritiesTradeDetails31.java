 ...
 * SecuritiesTradeDetails31.mmSettlementInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SecuritiesTradeDetails31", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "placeOfTrade", "placeOfClearing", "tradeDate", "settlementDate", "effectiveSettlementDate", "dealPrice",
...
public class SecuritiesTradeDetails31 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails31, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails31.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmTradeIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails31, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmCollateralTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<MarketIdentification78>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<MarketIdentification78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmPlaceOfTrade);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification78> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<MarketIdentification78> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmPlaceOfClearing);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmTradeDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<SettlementDate1Choice>> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<SettlementDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDate1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<SettlementDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails31, SettlementDate3Choice> mmEffectiveSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails31, SettlementDate3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate3Choice getValue(SecuritiesTradeDetails31 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, SettlementDate3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails31, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmDealPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<OpeningClosing1Choice>> mmOpeningClosing = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<OpeningClosing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmOpeningClosing);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmOpeningClosing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OpeningClosing1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getOpeningClosing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<OpeningClosing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, List<Reporting2Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails31, List<Reporting2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails31.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmReporting);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmReporting;
			minOccurs = 0;
			complexType_lazy = () -> Reporting2Choice.mmObject();
		}

		@Override
		public List<Reporting2Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, List<Reporting2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, List<TradeTransactionCondition1Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails31, List<TradeTransactionCondition1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmTradeTransactionCondition);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmTradeTransactionCondition;
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition1Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, List<TradeTransactionCondition1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<InvestorCapacity1Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<InvestorCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmInvestorCapacity);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmInvestorCapacity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<InvestorCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<TradeOriginator1Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<TradeOriginator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmTradeOriginatorRole);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmTradeOriginatorRole;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator1Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<TradeOriginator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<TypeOfPrice3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmTypeOfPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<TypeOfPrice3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmFXAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmFXAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails31 obj) {
			return obj.getFXAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails31 obj, Optional<Max350Text> value) {
	 ...
	 * SecuritiesTradeDetails2.
	 * mmSettlementInstructionProcessingAdditionalDetails}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails31, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails31.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails2.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails31.mmTradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmCollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmPlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmTradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmSettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmEffectiveSettlementDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmDealPrice, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmNumberOfDaysAccrued,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmOpeningClosing, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmReporting,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmTradeTransactionCondition, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmInvestorCapacity,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmTradeOriginatorRole, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmTypeOfPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails31.mmFXAdditionalDetails, com.tools20022.repository.msg.SecuritiesTradeDetails31.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionReversalAdviceV04.mmTradeDetails, SecuritiesSettlementTransactionConfirmationV05.mmTradeDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails31,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails31, com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails31,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails31, com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forSecuritiesTradeDetails31,
						com.tools20022.repository.constraints.ConstraintTradeDateGuideline.forSecuritiesTradeDetails31);
				...
				name = "SecuritiesTradeDetails31";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails53.mmObject());
				previousVersion_lazy = () -> SecuritiesTradeDetails2.mmObject();
			}
		});
	...
	public SecuritiesTradeDetails31 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails31 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails31 setPlaceOfTrade(MarketIdentification78 placeOfTrade) {
	...
	public SecuritiesTradeDetails31 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public SecuritiesTradeDetails31 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public SecuritiesTradeDetails31 setSettlementDate(SettlementDate1Choice settlementDate) {
	...
	public SecuritiesTradeDetails31 setEffectiveSettlementDate(SettlementDate3Choice effectiveSettlementDate) {
	...
	public SecuritiesTradeDetails31 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails31 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails31 setOpeningClosing(OpeningClosing1Choice openingClosing) {
	...
	public SecuritiesTradeDetails31 setReporting(List<Reporting2Choice> reporting) {
	...
	public SecuritiesTradeDetails31 setTradeTransactionCondition(List<TradeTransactionCondition1Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails31 setInvestorCapacity(InvestorCapacity1Choice investorCapacity) {
	...
	public SecuritiesTradeDetails31 setTradeOriginatorRole(TradeOriginator1Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails31 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
	...
	public SecuritiesTradeDetails31 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
	...
	public SecuritiesTradeDetails31 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
