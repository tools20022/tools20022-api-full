...
public class Header12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Header12.mmDownloadTransfer, Header12.mmFormatVersion, Header12.mmExchangeIdentification, Header12.mmCreationDateTime, Header12.mmInitiatingParty, Header12.mmRecipientParty);
