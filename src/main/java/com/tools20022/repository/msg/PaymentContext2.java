...
public class PaymentContext2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext2.mmCardPresent, PaymentContext2.mmCardholderPresent, PaymentContext2.mmOnLineContext, PaymentContext2.mmAttendanceContext, PaymentContext2.mmTransactionEnvironment,
						PaymentContext2.mmTransactionChannel, PaymentContext2.mmCardDataEntryMode, PaymentContext2.mmFallbackIndicator);
