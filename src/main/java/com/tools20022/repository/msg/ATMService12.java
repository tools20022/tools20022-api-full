 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ATMService12#ServiceReference
 * ATMService12.ServiceReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ATMService12#ATMServiceCode
 * ATMService12.ATMServiceCode}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ATMService12#HostServiceCode
...
public class ATMService12 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMService13#ServiceReference
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMService11#ServiceReference
	 * ATMService11.ServiceReference}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute ServiceReference = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ATMService12.mmObject();
			isDerived = false;
			xmlTag = "SvcRef";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ServiceReference";
			definition = "Unique identification of the deposit service provided by the ATM inside the session.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.ServiceReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.ServiceReference);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMService13#ATMServiceCode
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMService11#ATMServiceCode
	...
	public static final MMMessageAttribute ATMServiceCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.ATMServiceCode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.ATMServiceCode);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMService13#HostServiceCode
	...
	public static final MMMessageAttribute HostServiceCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.HostServiceCode);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMService11#ServiceType
	...
	public static final MMMessageAttribute ServiceType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.ServiceType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.ServiceType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ServiceVariantIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.ServiceVariantIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.ServiceVariantIdentification);
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	};
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMService11#CashBack
	...
	public static final MMMessageAttribute CashBack = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.CashBack;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.CashBack);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMService11#MultiAccount
	...
	public static final MMMessageAttribute MultiAccount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMService11.MultiAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService13.MultiAccount);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMService12.ServiceReference, com.tools20022.repository.msg.ATMService12.ATMServiceCode, com.tools20022.repository.msg.ATMService12.HostServiceCode,
						com.tools20022.repository.msg.ATMService12.ServiceType, com.tools20022.repository.msg.ATMService12.ServiceVariantIdentification, com.tools20022.repository.msg.ATMService12.CashBack,
						com.tools20022.repository.msg.ATMService12.MultiAccount);
