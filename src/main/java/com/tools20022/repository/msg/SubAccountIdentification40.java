...
public class SubAccountIdentification40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification40.mmAccountOwner, SubAccountIdentification40.mmSafekeepingAccount, SubAccountIdentification40.mmActivityIndicator,
						SubAccountIdentification40.mmBalanceForSubAccount);
