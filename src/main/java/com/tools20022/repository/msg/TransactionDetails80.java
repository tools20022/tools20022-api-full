...
public class TransactionDetails80 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails80.mmAccountOwner, TransactionDetails80.mmSafekeepingAccount, TransactionDetails80.mmFinancialInstrumentIdentification, TransactionDetails80.mmSettlementQuantity,
						TransactionDetails80.mmSettlementAmount, TransactionDetails80.mmTradeDate, TransactionDetails80.mmSettlementDate, TransactionDetails80.mmDeliveringSettlementParties,
						TransactionDetails80.mmReceivingSettlementParties, TransactionDetails80.mmInvestor);
