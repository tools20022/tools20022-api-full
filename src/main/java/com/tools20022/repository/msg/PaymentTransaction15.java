...
public class PaymentTransaction15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction15.SettlementAmount, com.tools20022.repository.msg.PaymentTransaction15.SettlementDate,
						com.tools20022.repository.msg.PaymentTransaction15.PaymentInstrument);
