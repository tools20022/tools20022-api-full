...
import com.tools20022.repository.msg.TransactionDetails93;
import java.util.*;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transaction51#mmAccountOwner
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transaction51#mmClientCollateralInstructionIdentification
 * Transaction51.mmClientCollateralInstructionIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transaction51#mmTripartyCollateralInstructionIdentification
 * Transaction51.mmTripartyCollateralInstructionIdentification}</li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction25
 * Transaction25}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction51", propOrder = {"accountOwner", "safekeepingAccount", "statusAndReason", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification",
		"processorTransactionIdentification", "tradeIdentification", "poolIdentification", "commonIdentification", "corporateActionEventIdentification", "clientCollateralInstructionIdentification",
		"tripartyAgentCollateralTransactionIdentification", "tripartyCollateralInstructionIdentification", "clientTripartyCollateralTransactionIdentification", "transactionDetails"})
public class Transaction51 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Transaction58#mmAccountOwner
	 * Transaction58.mmAccountOwner}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Transaction25#mmAccountOwner
	 * Transaction25.mmAccountOwner}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction51, Optional<SystemPartyIdentification6>> mmAccountOwner = new MMMessageAssociationEnd<Transaction51, Optional<SystemPartyIdentification6>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction51.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that owns the account.";
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmAccountOwner);
			previousVersion_lazy = () -> Transaction25.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SystemPartyIdentification6> getValue(Transaction51 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(Transaction51 obj, Optional<SystemPartyIdentification6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction51, Optional<SecuritiesAccount19>> mmSafekeepingAccount = new MMMessageAssociationEnd<Transaction51, Optional<SecuritiesAccount19>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmSafekeepingAccount);
			previousVersion_lazy = () -> Transaction25.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesAccount19> getValue(Transaction51 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(Transaction51 obj, Optional<SecuritiesAccount19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction51, Optional<StatusAndReason31>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction51, Optional<StatusAndReason31>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmStatusAndReason);
			previousVersion_lazy = () -> Transaction25.mmStatusAndReason;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<StatusAndReason31> getValue(Transaction51 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction51 obj, Optional<StatusAndReason31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction51, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> Transaction25.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction51 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction51 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmAccountServicerTransactionIdentification);
			previousVersion_lazy = () -> Transaction25.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction51 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction51 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmMarketInfrastructureTransactionIdentification);
			previousVersion_lazy = () -> Transaction25.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmProcessorTransactionIdentification);
			previousVersion_lazy = () -> Transaction25.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction51, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmTradeIdentification);
			previousVersion_lazy = () -> Transaction25.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction51 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction51 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmPoolIdentification);
			previousVersion_lazy = () -> Transaction25.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmCommonIdentification);
			previousVersion_lazy = () -> Transaction25.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> Transaction25.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Transaction58#mmClientCollateralInstructionIdentification
	 * Transaction58.mmClientCollateralInstructionIdentification}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction51.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmClientCollateralInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction25.mmTripartyAgentCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction51.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction51, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction51, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmClientTripartyCollateralTransactionIdentification);
			previousVersion_lazy = () -> Transaction25.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected TransactionDetails93 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails93
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction51, Optional<TransactionDetails93>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction51, Optional<TransactionDetails93>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Transaction58.mmTransactionDetails);
			previousVersion_lazy = () -> Transaction25.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails93.mmObject();
		}

		@Override
		public Optional<TransactionDetails93> getValue(Transaction51 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction51 obj, Optional<TransactionDetails93> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction51.mmAccountOwner, com.tools20022.repository.msg.Transaction51.mmSafekeepingAccount,
						com.tools20022.repository.msg.Transaction51.mmStatusAndReason, com.tools20022.repository.msg.Transaction51.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.Transaction51.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.Transaction51.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.Transaction51.mmProcessorTransactionIdentification, com.tools20022.repository.msg.Transaction51.mmTradeIdentification, com.tools20022.repository.msg.Transaction51.mmPoolIdentification,
						com.tools20022.repository.msg.Transaction51.mmCommonIdentification, com.tools20022.repository.msg.Transaction51.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction51.mmClientCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction51.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction51.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction51.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction51.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction51);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Transaction51";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(Transaction58.mmObject());
				previousVersion_lazy = () -> Transaction25.mmObject();
			}
		});
	...
	public Transaction51 setAccountOwner(SystemPartyIdentification6 accountOwner) {
	...
	public Transaction51 setSafekeepingAccount(SecuritiesAccount19 safekeepingAccount) {
	...
	public Transaction51 setStatusAndReason(StatusAndReason31 statusAndReason) {
	...
	public Transaction51 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction51 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction51 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction51 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction51 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction51 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction51 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction51 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction51 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction51 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction51 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
	...
	public Transaction51 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails93> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction51 setTransactionDetails(TransactionDetails93 transactionDetails) {
