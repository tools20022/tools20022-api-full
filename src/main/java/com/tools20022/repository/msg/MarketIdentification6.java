...
import com.tools20022.repository.choice.MarketType4Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule#forMarketIdentification6
 * ConstraintCoexistence35to30TextFieldRule.forMarketIdentification6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "MarketIdentification6", propOrder = {"identification", "type"})
public class MarketIdentification6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification6, Optional<MarketIdentification1Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification6, Optional<MarketIdentification1Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification6.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification89.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification1Choice> getValue(MarketIdentification6 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification6 obj, Optional<MarketIdentification1Choice> value) {
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.choice.MarketType4Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification6, MarketType4Choice> mmType = new MMMessageAssociationEnd<MarketIdentification6, MarketType4Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification89.mmType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public MarketType4Choice getValue(MarketIdentification6 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification6 obj, MarketType4Choice value) {
			obj.setType(value);
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule.forMarketIdentification6);
				...
				nextVersions_lazy = () -> Arrays.asList(MarketIdentification89.mmObject());
			}
		});
	...
	public MarketIdentification6 setIdentification(MarketIdentification1Choice identification) {
	...
	public MarketIdentification6 setType(MarketType4Choice type) {
