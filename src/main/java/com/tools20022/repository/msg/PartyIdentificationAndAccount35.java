...
public class PartyIdentificationAndAccount35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount35.mmIdentification, PartyIdentificationAndAccount35.mmAlternateIdentification, PartyIdentificationAndAccount35.mmSafekeepingAccount,
						PartyIdentificationAndAccount35.mmProcessingDate, PartyIdentificationAndAccount35.mmProcessingIdentification, PartyIdentificationAndAccount35.mmAdditionalInformation);
