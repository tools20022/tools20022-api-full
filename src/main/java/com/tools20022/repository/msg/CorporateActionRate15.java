...
public class CorporateActionRate15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate15.mmAdditionalTax, CorporateActionRate15.mmGrossDividendRate, CorporateActionRate15.mmIndexFactor, CorporateActionRate15.mmInterestRateUsedForPayment,
						CorporateActionRate15.mmMaximumAllowedOversubscriptionRate, CorporateActionRate15.mmProrationRate, CorporateActionRate15.mmWithholdingTaxRate, CorporateActionRate15.mmTaxRelatedRate,
						CorporateActionRate15.mmTaxableIncomePerDividendShare);
