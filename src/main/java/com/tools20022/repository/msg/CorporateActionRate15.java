...
import com.tools20022.repository.choice.GrossDividendRateFormat5Choice;
import com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate1Rule#forCorporateActionRate15
 * ConstraintGrossDividendRate1Rule.forCorporateActionRate15}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule#forCorporateActionRate15
 * ConstraintGrossDividendRate2Rule.forCorporateActionRate15}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTaxRelatedRateRule#forCorporateActionRate15
 * ConstraintTaxRelatedRateRule.forCorporateActionRate15}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule#forCorporateActionRate15
 * ConstraintGrossDividendRate3Rule.forCorporateActionRate15}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionRate25
...
@XmlType(name = "CorporateActionRate15", propOrder = {"additionalTax", "grossDividendRate", "indexFactor", "interestRateUsedForPayment", "maximumAllowedOversubscriptionRate", "prorationRate", "withholdingTaxRate", "taxRelatedRate",
...
public class CorporateActionRate15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, Optional<RateAndAmountFormat14Choice>> mmAdditionalTax = new MMMessageAssociationEnd<CorporateActionRate15, Optional<RateAndAmountFormat14Choice>>() {
		{
			businessComponentTrace_lazy = () -> Tax.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate15.mmObject();
			isDerived = false;
			xmlTag = "AddtlTax";
		...
		@Override
		public Optional<RateAndAmountFormat14Choice> getValue(CorporateActionRate15 obj) {
			return obj.getAdditionalTax();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, Optional<RateAndAmountFormat14Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, List<GrossDividendRateFormat5Choice>> mmGrossDividendRate = new MMMessageAssociationEnd<CorporateActionRate15, List<GrossDividendRateFormat5Choice>>() {
		{
		...
		@Override
		public List<GrossDividendRateFormat5Choice> getValue(CorporateActionRate15 obj) {
			return obj.getGrossDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, List<GrossDividendRateFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, Optional<RateAndAmountFormat14Choice>> mmIndexFactor = new MMMessageAssociationEnd<CorporateActionRate15, Optional<RateAndAmountFormat14Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, List<InterestRateUsedForPaymentFormat5Choice>> mmInterestRateUsedForPayment = new MMMessageAssociationEnd<CorporateActionRate15, List<InterestRateUsedForPaymentFormat5Choice>>() {
		{
		...
		@Override
		public List<InterestRateUsedForPaymentFormat5Choice> getValue(CorporateActionRate15 obj) {
			return obj.getInterestRateUsedForPayment();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, List<InterestRateUsedForPaymentFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>> mmMaximumAllowedOversubscriptionRate = new MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>>() {
		{
		...
		@Override
		public Optional<RateFormat6Choice> getValue(CorporateActionRate15 obj) {
			return obj.getMaximumAllowedOversubscriptionRate();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, Optional<RateFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>> mmProrationRate = new MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>> mmWithholdingTaxRate = new MMMessageAssociationEnd<CorporateActionRate15, Optional<RateFormat6Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, List<RateTypeAndAmountAndStatus6>> mmTaxRelatedRate = new MMMessageAssociationEnd<CorporateActionRate15, List<RateTypeAndAmountAndStatus6>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate15.mmObject();
			isDerived = false;
		...
		@Override
		public List<RateTypeAndAmountAndStatus6> getValue(CorporateActionRate15 obj) {
			return obj.getTaxRelatedRate();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, List<RateTypeAndAmountAndStatus6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate15, List<RateTypeAndAmountAndStatus11>> mmTaxableIncomePerDividendShare = new MMMessageAssociationEnd<CorporateActionRate15, List<RateTypeAndAmountAndStatus11>>() {
		{
		...
		@Override
		public List<RateTypeAndAmountAndStatus11> getValue(CorporateActionRate15 obj) {
			return obj.getTaxableIncomePerDividendShare();
		}

		@Override
		public void setValue(CorporateActionRate15 obj, List<RateTypeAndAmountAndStatus11> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate15.mmAdditionalTax, com.tools20022.repository.msg.CorporateActionRate15.mmGrossDividendRate,
						com.tools20022.repository.msg.CorporateActionRate15.mmIndexFactor, com.tools20022.repository.msg.CorporateActionRate15.mmInterestRateUsedForPayment,
						com.tools20022.repository.msg.CorporateActionRate15.mmMaximumAllowedOversubscriptionRate, com.tools20022.repository.msg.CorporateActionRate15.mmProrationRate,
						com.tools20022.repository.msg.CorporateActionRate15.mmWithholdingTaxRate, com.tools20022.repository.msg.CorporateActionRate15.mmTaxRelatedRate,
						com.tools20022.repository.msg.CorporateActionRate15.mmTaxableIncomePerDividendShare);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGrossDividendRate1Rule.forCorporateActionRate15,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule.forCorporateActionRate15, com.tools20022.repository.constraints.ConstraintTaxRelatedRateRule.forCorporateActionRate15,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule.forCorporateActionRate15);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionRate15";
				definition = "Specifies rates related to a corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionRate25.mmObject());
			}
		});
	...
	public CorporateActionRate15 setAdditionalTax(RateAndAmountFormat14Choice additionalTax) {
	...
	public CorporateActionRate15 setGrossDividendRate(List<GrossDividendRateFormat5Choice> grossDividendRate) {
	...
	public CorporateActionRate15 setIndexFactor(RateAndAmountFormat14Choice indexFactor) {
	...
	public CorporateActionRate15 setInterestRateUsedForPayment(List<InterestRateUsedForPaymentFormat5Choice> interestRateUsedForPayment) {
	...
	public CorporateActionRate15 setMaximumAllowedOversubscriptionRate(RateFormat6Choice maximumAllowedOversubscriptionRate) {
	...
	public CorporateActionRate15 setProrationRate(RateFormat6Choice prorationRate) {
	...
	public CorporateActionRate15 setWithholdingTaxRate(RateFormat6Choice withholdingTaxRate) {
	...
	public CorporateActionRate15 setTaxRelatedRate(List<RateTypeAndAmountAndStatus6> taxRelatedRate) {
	...
	public CorporateActionRate15 setTaxableIncomePerDividendShare(List<RateTypeAndAmountAndStatus11> taxableIncomePerDividendShare) {
