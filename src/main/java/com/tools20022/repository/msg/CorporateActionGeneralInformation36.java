...
public class CorporateActionGeneralInformation36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation36.mmCorporateActionEventIdentification, CorporateActionGeneralInformation36.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation36.mmEventType, CorporateActionGeneralInformation36.mmUnderlyingSecurity);
