...
public class GroupHeader27 {
	...
	public static final MMMessageAttribute mmMessageIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GroupHeader27.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader27.mmMessageIdentification, GroupHeader27.mmCreationDateTime, GroupHeader27.mmAuthorisation, GroupHeader27.mmBatchBooking, GroupHeader27.mmNumberOfTransactions,
						GroupHeader27.mmControlSum, GroupHeader27.mmGroupReturn, GroupHeader27.mmTotalReturnedInterbankSettlementAmount, GroupHeader27.mmInterbankSettlementDate, GroupHeader27.mmSettlementInformation,
						GroupHeader27.mmInstructingAgent, GroupHeader27.mmInstructedAgent);
	...
	public void setTotalReturnedInterbankSettlementAmount(EuroMax15Amount totalReturnedInterbankSettlementAmount) {
