...
public class IntraPositionDetails20 {
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionDetails20.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlc";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails20.mmSafekeepingPlace, IntraPositionDetails20.mmBalanceFrom, IntraPositionDetails20.mmIntraPositionMovement);
	...
	public void setIntraPositionMovement(List<com.tools20022.repository.msg.IntraPositionMovementDetails7> intraPositionMovement) {
