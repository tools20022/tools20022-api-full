...
public class IntraPositionDetails20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails20.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails20.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails20.IntraPositionMovement);
