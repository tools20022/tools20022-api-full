...
@XmlType(name = "PaymentTransaction46", propOrder = {"statusIdentification", "originalInstructionIdentification", "originalEndToEndIdentification", "transactionStatus", "statusReasonInformation", "chargesInformation", "acceptanceDateTime",
...
public class PaymentTransaction46 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>> mmStatusIdentification = new MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "StsId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmStatusIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction46 obj) {
			return obj.getStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmOriginalInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmOriginalEndToEndIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<TransactionIndividualStatus3Code>> mmTransactionStatus = new MMMessageAttribute<PaymentTransaction46, Optional<TransactionIndividualStatus3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmTransactionStatus);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionIndividualStatus3Code> getValue(PaymentTransaction46 obj) {
			return obj.getTransactionStatus();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, Optional<TransactionIndividualStatus3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction46, List<StatusReasonInformation9>> mmStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction46, List<StatusReasonInformation9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmStatusReasonInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<StatusReasonInformation9> getValue(PaymentTransaction46 obj) {
			return obj.getStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, List<StatusReasonInformation9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction46, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction46, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmChargesInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction46 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<ISODateTime>> mmAcceptanceDateTime = new MMMessageAttribute<PaymentTransaction46, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmAcceptanceDateTime);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(PaymentTransaction46 obj) {
			return obj.getAcceptanceDateTime();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>> mmAccountServicerReference = new MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmAccountServicerReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>> mmClearingSystemReference = new MMMessageAttribute<PaymentTransaction46, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmClearingSystemReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction46, Optional<OriginalTransactionReference16>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction46, Optional<OriginalTransactionReference16>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmOriginalTransactionReference);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference16> getValue(PaymentTransaction46 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, Optional<OriginalTransactionReference16> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction46, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction46, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction46.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction57.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction46 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction46 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction46.mmStatusIdentification, com.tools20022.repository.msg.PaymentTransaction46.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction46.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction46.mmTransactionStatus,
						com.tools20022.repository.msg.PaymentTransaction46.mmStatusReasonInformation, com.tools20022.repository.msg.PaymentTransaction46.mmChargesInformation,
						com.tools20022.repository.msg.PaymentTransaction46.mmAcceptanceDateTime, com.tools20022.repository.msg.PaymentTransaction46.mmAccountServicerReference,
						com.tools20022.repository.msg.PaymentTransaction46.mmClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction46.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction46.mmSupplementaryData);
	...
	public PaymentTransaction46 setStatusIdentification(Max35Text statusIdentification) {
	...
	public PaymentTransaction46 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction46 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction46 setTransactionStatus(TransactionIndividualStatus3Code transactionStatus) {
	...
	public PaymentTransaction46 setStatusReasonInformation(List<StatusReasonInformation9> statusReasonInformation) {
	...
	public PaymentTransaction46 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction46 setAcceptanceDateTime(ISODateTime acceptanceDateTime) {
	...
	public PaymentTransaction46 setAccountServicerReference(Max35Text accountServicerReference) {
	...
	public PaymentTransaction46 setClearingSystemReference(Max35Text clearingSystemReference) {
	...
	public PaymentTransaction46 setOriginalTransactionReference(OriginalTransactionReference16 originalTransactionReference) {
	...
	public PaymentTransaction46 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
