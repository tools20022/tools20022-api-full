...
public class PaymentTransaction46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction46.mmStatusIdentification, PaymentTransaction46.mmOriginalInstructionIdentification, PaymentTransaction46.mmOriginalEndToEndIdentification,
						PaymentTransaction46.mmTransactionStatus, PaymentTransaction46.mmStatusReasonInformation, PaymentTransaction46.mmChargesInformation, PaymentTransaction46.mmAcceptanceDateTime,
						PaymentTransaction46.mmAccountServicerReference, PaymentTransaction46.mmClearingSystemReference, PaymentTransaction46.mmOriginalTransactionReference, PaymentTransaction46.mmSupplementaryData);
