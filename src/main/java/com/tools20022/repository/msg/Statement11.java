...
public class Statement11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement11.mmReportNumber, Statement11.mmQueryReference, Statement11.mmStatementIdentification, Statement11.mmStatementPeriod, Statement11.mmFrequency, Statement11.mmUpdateType,
						Statement11.mmStatementBasis, Statement11.mmActivityIndicator, Statement11.mmSubAccountIndicator);
