...
public class IntraPositionDetails18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails18.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails18.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails18.IntraPositionMovement);
