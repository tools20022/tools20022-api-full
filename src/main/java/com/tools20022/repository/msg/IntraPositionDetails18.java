...
public class IntraPositionDetails18 {
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionDetails18.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlc";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails18.mmSafekeepingPlace, IntraPositionDetails18.mmBalanceFrom, IntraPositionDetails18.mmIntraPositionMovement);
	...
	public void setIntraPositionMovement(List<com.tools20022.repository.msg.IntraPositionMovementDetails6> intraPositionMovement) {
