...
public class PendingCancellationStatusReason7 {
	...
	public static final MMMessageAssociationEnd ReasonCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingCancellationStatusReason5.ReasonCode;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingCancellationStatusReason5.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason7.ReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason7.AdditionalReasonInformation);
