...
public class QuantityToQuantityRatio2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityToQuantityRatio2.Quantity1, com.tools20022.repository.msg.QuantityToQuantityRatio2.Quantity2);
