...
public class TMSAction3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TMSAction3.mmType, TMSAction3.mmAddress, TMSAction3.mmDataSetIdentification, TMSAction3.mmTrigger, TMSAction3.mmAdditionalProcess, TMSAction3.mmReTry, TMSAction3.mmTimeCondition,
						TMSAction3.mmTMChallenge, TMSAction3.mmKeyEnciphermentCertificate, TMSAction3.mmErrorAction);
