...
public class PartyIdentificationAndAccount57 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount57, PartyIdentification54Choice> mmIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount57, PartyIdentification54Choice>() {
		{
		...
		@Override
		public PartyIdentification54Choice getValue(PartyIdentificationAndAccount57 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount57 obj, PartyIdentification54Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount57, Optional<CashAccountIdentification6Choice>> mmCashAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount57, Optional<CashAccountIdentification6Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification6Choice> getValue(PartyIdentificationAndAccount57 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount57 obj, Optional<CashAccountIdentification6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentificationAndAccount57, Optional<RestrictedFINXMax16Text>> mmProcessingIdentification = new MMMessageAttribute<PartyIdentificationAndAccount57, Optional<RestrictedFINXMax16Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount57.mmObject();
			isDerived = false;
			xmlTag = "PrcgId";
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(PartyIdentificationAndAccount57 obj) {
			return obj.getProcessingIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount57 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentificationAndAccount57, Optional<RestrictedFINXMax350Text>> mmAdditionalInformation = new MMMessageAttribute<PartyIdentificationAndAccount57, Optional<RestrictedFINXMax350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount57.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
		...
		@Override
		public Optional<RestrictedFINXMax350Text> getValue(PartyIdentificationAndAccount57 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount57 obj, Optional<RestrictedFINXMax350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount57, Optional<AlternatePartyIdentification3>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount57, Optional<AlternatePartyIdentification3>>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount57.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<AlternatePartyIdentification3> getValue(PartyIdentificationAndAccount57 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount57 obj, Optional<AlternatePartyIdentification3> value) {
	...
	public PartyIdentificationAndAccount57 setAlternateIdentification(AlternatePartyIdentification3 alternateIdentification) {
