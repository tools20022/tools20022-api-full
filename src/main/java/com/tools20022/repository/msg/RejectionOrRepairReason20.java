...
public class RejectionOrRepairReason20 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason20.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason20.mmCode, RejectionOrRepairReason20.mmAdditionalReasonInformation);
	...
	public void setCode(List<RejectionAndRepairReason20Choice> code) {
		this.code = code;
	}
