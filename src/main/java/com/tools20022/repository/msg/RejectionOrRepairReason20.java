...
import com.tools20022.repository.choice.RejectionAndRepairReason20Choice;
...
@XmlType(name = "RejectionOrRepairReason20", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason20 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd")
	protected List<RejectionAndRepairReason20Choice> code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionOrRepairReason20, List<RejectionAndRepairReason20Choice>> mmCode = new MMMessageAssociationEnd<RejectionOrRepairReason20, List<RejectionAndRepairReason20Choice>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionOrRepairReason20.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public List<RejectionAndRepairReason20Choice> getValue(RejectionOrRepairReason20 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionOrRepairReason20 obj, List<RejectionAndRepairReason20Choice> value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionOrRepairReason20, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionOrRepairReason20, Optional<Max210Text>>() {
		{
		...
		@Override
		public Optional<Max210Text> getValue(RejectionOrRepairReason20 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionOrRepairReason20 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason20.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason20.mmAdditionalReasonInformation);
	...
	public List<RejectionAndRepairReason20Choice> getCode() {
		return code == null ? code = new ArrayList<>() : code;
	}

	public RejectionOrRepairReason20 setCode(List<RejectionAndRepairReason20Choice> code) {
	...
	public RejectionOrRepairReason20 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
