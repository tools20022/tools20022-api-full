...
public class TransactionIdentifications7 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications7.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications7.mmAccountOwnerTransactionIdentification, TransactionIdentifications7.mmAccountServicerTransactionIdentification,
						TransactionIdentifications7.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications7.mmCommonIdentification);
