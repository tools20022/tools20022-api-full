...
public class IntraPositionMovementDetails7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionMovementDetails7.mmIdentification, IntraPositionMovementDetails7.mmSettledQuantity, IntraPositionMovementDetails7.mmPreviouslySettledQuantity,
						IntraPositionMovementDetails7.mmRemainingToBeSettledQuantity, IntraPositionMovementDetails7.mmSecuritiesSubBalanceIdentification, IntraPositionMovementDetails7.mmBalanceTo,
						IntraPositionMovementDetails7.mmSettlementDate, IntraPositionMovementDetails7.mmAvailableDate, IntraPositionMovementDetails7.mmCorporateActionEventType, IntraPositionMovementDetails7.mmCollateralMonitorAmount,
						IntraPositionMovementDetails7.mmInstructionProcessingAdditionalDetails, IntraPositionMovementDetails7.mmSupplementaryData);
