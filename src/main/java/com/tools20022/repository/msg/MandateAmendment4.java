 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.pain.MandateAmendmentRequestV04#UnderlyingAmendmentDetails
 * MandateAmendmentRequestV04.UnderlyingAmendmentDetails}</li>
 * </ul>
 * </li>
 * <li>
...
public class MandateAmendment4 {
	...
	public static final MMMessageAssociationEnd OriginalMessageInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateAmendment3.OriginalMessageInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment5.OriginalMessageInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmendmentReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateAmendment3.AmendmentReason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment5.AmendmentReason);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.MandateAmendment3#Mandate
	...
	public static final MMMessageAssociationEnd Mandate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateAmendment3.Mandate;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment5.Mandate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalMandate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateAmendment3.OriginalMandate;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment5.OriginalMandate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupplementaryData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateAmendment3.SupplementaryData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment5.SupplementaryData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MandateAmendment4.OriginalMessageInformation, com.tools20022.repository.msg.MandateAmendment4.AmendmentReason,
						com.tools20022.repository.msg.MandateAmendment4.Mandate, com.tools20022.repository.msg.MandateAmendment4.OriginalMandate, com.tools20022.repository.msg.MandateAmendment4.SupplementaryData);
				trace_lazy = () -> com.tools20022.repository.entity.Mandate.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.MandateAmendmentRequestV04.UnderlyingAmendmentDetails);
