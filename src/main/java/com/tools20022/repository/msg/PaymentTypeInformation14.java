...
public class PaymentTypeInformation14 {
	...
	public static final MMMessageAssociationEnd ServiceLevel = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PaymentTypeInformation14.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation14.ServiceLevel, com.tools20022.repository.msg.PaymentTypeInformation14.LocalInstrument,
						com.tools20022.repository.msg.PaymentTypeInformation14.SequenceType, com.tools20022.repository.msg.PaymentTypeInformation14.CategoryPurpose);
