...
public class PaymentTypeInformation14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation14.mmServiceLevel, PaymentTypeInformation14.mmLocalInstrument, PaymentTypeInformation14.mmSequenceType, PaymentTypeInformation14.mmCategoryPurpose);
