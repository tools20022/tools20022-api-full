...
public class OriginalPaymentInstruction16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction16.mmReversalPaymentInformationIdentification, OriginalPaymentInstruction16.mmOriginalPaymentInformationIdentification,
						OriginalPaymentInstruction16.mmOriginalNumberOfTransactions, OriginalPaymentInstruction16.mmOriginalControlSum, OriginalPaymentInstruction16.mmBatchBooking, OriginalPaymentInstruction16.mmPaymentInformationReversal,
						OriginalPaymentInstruction16.mmReversalReasonInformation, OriginalPaymentInstruction16.mmTransactionInformation);
