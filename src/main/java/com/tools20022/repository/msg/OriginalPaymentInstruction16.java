...
public class OriginalPaymentInstruction16 {
	...
	public static final MMMessageAttribute mmReversalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmReversalPaymentInformationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmReversalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmOriginalPaymentInformationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmOriginalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalNumberOfTransactions = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmOriginalNumberOfTransactions);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmOriginalNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalControlSum = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmOriginalControlSum);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmOriginalControlSum;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmBatchBooking = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmBatchBooking);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmBatchBooking;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPaymentInformationReversal = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmPaymentInformationReversal);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmPaymentInformationReversal;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmReversalReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmReversalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmReversalReasonInformation;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentReversalReason7.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.PaymentTransaction64> transactionInformation;
	/**
	...
	public static final MMMessageAssociationEnd mmTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction21.mmTransactionInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction11.mmTransactionInformation;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentTransaction64.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentReversalV06.mmOriginalPaymentInformationAndReversal);
	...
	public void setTransactionInformation(List<com.tools20022.repository.msg.PaymentTransaction64> transactionInformation) {
