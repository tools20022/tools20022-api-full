...
import com.tools20022.repository.msg.PaymentTransaction64;
import java.util.*;
...
@XmlType(name = "OriginalPaymentInstruction16", propOrder = {"reversalPaymentInformationIdentification", "originalPaymentInformationIdentification", "originalNumberOfTransactions", "originalControlSum", "batchBooking",
...
public class OriginalPaymentInstruction16 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Optional<Max35Text>> mmReversalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction16, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmInstructionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction16.mmObject();
			isDerived = false;
			xmlTag = "RvslPmtInfId";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmReversalPaymentInformationIdentification);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmReversalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getReversalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Max35Text> mmOriginalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction16, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmOriginalPaymentInformationIdentification);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmOriginalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(OriginalPaymentInstruction16 obj) {
			return obj.getOriginalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Optional<Max15NumericText>> mmOriginalNumberOfTransactions = new MMMessageAttribute<OriginalPaymentInstruction16, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction16.mmObject();
			isDerived = false;
			xmlTag = "OrgnlNbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmOriginalNumberOfTransactions);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmOriginalNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getOriginalNumberOfTransactions();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Optional<DecimalNumber>> mmOriginalControlSum = new MMMessageAttribute<OriginalPaymentInstruction16, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction16.mmObject();
			isDerived = false;
			xmlTag = "OrgnlCtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmOriginalControlSum);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmOriginalControlSum;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getOriginalControlSum();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<OriginalPaymentInstruction16, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction16.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmBatchBooking);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmBatchBooking;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction16, Optional<TrueFalseIndicator>> mmPaymentInformationReversal = new MMMessageAttribute<OriginalPaymentInstruction16, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction16.mmObject();
			isDerived = false;
			xmlTag = "PmtInfRvsl";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmPaymentInformationReversal);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmPaymentInformationReversal;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getPaymentInformationReversal();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction16, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction16, List<PaymentReversalReason7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmReversalReasonInformation);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmReversalReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReversalReason7> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, List<PaymentReversalReason7> value) {
			obj.setReversalReasonInformation(value);
		}
	};
	@XmlElement(name = "TxInf")
	protected List<PaymentTransaction64> transactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction16, List<PaymentTransaction64>> mmTransactionInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction16, List<PaymentTransaction64>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction21.mmTransactionInformation);
			previousVersion_lazy = () -> OriginalPaymentInstruction11.mmTransactionInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentTransaction64> getValue(OriginalPaymentInstruction16 obj) {
			return obj.getTransactionInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction16 obj, List<PaymentTransaction64> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction16.mmReversalPaymentInformationIdentification,
						com.tools20022.repository.msg.OriginalPaymentInstruction16.mmOriginalPaymentInformationIdentification, com.tools20022.repository.msg.OriginalPaymentInstruction16.mmOriginalNumberOfTransactions,
						com.tools20022.repository.msg.OriginalPaymentInstruction16.mmOriginalControlSum, com.tools20022.repository.msg.OriginalPaymentInstruction16.mmBatchBooking,
						com.tools20022.repository.msg.OriginalPaymentInstruction16.mmPaymentInformationReversal, com.tools20022.repository.msg.OriginalPaymentInstruction16.mmReversalReasonInformation,
						com.tools20022.repository.msg.OriginalPaymentInstruction16.mmTransactionInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerPaymentReversalV06.mmOriginalPaymentInformationAndReversal);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndTransactionInformationNotPresentRule.forOriginalPaymentInstruction16,
						com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndTransactionInformationPresentRule.forOriginalPaymentInstruction16,
						com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndReasonRule.forOriginalPaymentInstruction16);
	...
	public OriginalPaymentInstruction16 setReversalPaymentInformationIdentification(Max35Text reversalPaymentInformationIdentification) {
	...
	public OriginalPaymentInstruction16 setOriginalPaymentInformationIdentification(Max35Text originalPaymentInformationIdentification) {
	...
	public OriginalPaymentInstruction16 setOriginalNumberOfTransactions(Max15NumericText originalNumberOfTransactions) {
	...
	public OriginalPaymentInstruction16 setOriginalControlSum(DecimalNumber originalControlSum) {
	...
	public OriginalPaymentInstruction16 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public OriginalPaymentInstruction16 setPaymentInformationReversal(TrueFalseIndicator paymentInformationReversal) {
	...
	public OriginalPaymentInstruction16 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
		this.reversalReasonInformation = Objects.requireNonNull(reversalReasonInformation);
		return this;
	}

	public List<PaymentTransaction64> getTransactionInformation() {
		return transactionInformation == null ? transactionInformation = new ArrayList<>() : transactionInformation;
	}

	public OriginalPaymentInstruction16 setTransactionInformation(List<PaymentTransaction64> transactionInformation) {
