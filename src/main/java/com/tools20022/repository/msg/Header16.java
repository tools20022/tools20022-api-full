 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Header16#ProtocolVersion
...
public class Header16 {
	...
	public static final MMMessageAttribute ProtocolVersion = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Header16.mmObject();
			isDerived = false;
			xmlTag = "PrtcolVrsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ProtocolVersion";
			definition = "Version of the terminal management protocol specifications.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header29.ProtocolVersion);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ExchangeIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Header15.ExchangeIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header29.ExchangeIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Header15#CreationDateTime
	...
	public static final MMMessageAttribute CreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Header15.CreationDateTime;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header29.CreationDateTime);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Header15#InitiatingParty
	...
	public static final MMMessageAssociationEnd InitiatingParty = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Header15.InitiatingParty;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header29.InitiatingParty);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Header15#RecipientParty
	...
	public static final MMMessageAssociationEnd RecipientParty = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Header15.RecipientParty;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header29.RecipientParty);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> GenericIdentification72.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Header16.ProtocolVersion, com.tools20022.repository.msg.Header16.ExchangeIdentification, com.tools20022.repository.msg.Header16.CreationDateTime,
						com.tools20022.repository.msg.Header16.InitiatingParty, com.tools20022.repository.msg.Header16.RecipientParty);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.MaintenanceDelegationResponseV01.Header, com.tools20022.repository.area.catm.MaintenanceDelegationRequestV01.Header);
