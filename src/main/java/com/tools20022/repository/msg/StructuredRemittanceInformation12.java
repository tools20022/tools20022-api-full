...
public class StructuredRemittanceInformation12 {
	...
	protected List<ReferredDocumentInformation6> referredDocumentInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, List<ReferredDocumentInformation6>> mmReferredDocumentInformation = new MMMessageAssociationEnd<StructuredRemittanceInformation12, List<ReferredDocumentInformation6>>() {
		{
		...
		@Override
		public List<ReferredDocumentInformation6> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getReferredDocumentInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, List<ReferredDocumentInformation6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<RemittanceAmount2>> mmReferredDocumentAmount = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<RemittanceAmount2>>() {
		{
		...
		@Override
		public Optional<RemittanceAmount2> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getReferredDocumentAmount();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, Optional<RemittanceAmount2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<CreditorReferenceInformation2>> mmCreditorReferenceInformation = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<CreditorReferenceInformation2>>() {
		{
		...
		@Override
		public Optional<CreditorReferenceInformation2> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getCreditorReferenceInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, Optional<CreditorReferenceInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<PartyIdentification43>> mmInvoicer = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<PartyIdentification43>>() {
		{
		...
		@Override
		public Optional<PartyIdentification43> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getInvoicer();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<PartyIdentification43>> mmInvoicee = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<PartyIdentification43>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<TaxInformation4>> mmTaxRemittance = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<TaxInformation4>>() {
		{
		...
		@Override
		public Optional<TaxInformation4> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getTaxRemittance();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, Optional<TaxInformation4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<Garnishment1>> mmGarnishmentRemittance = new MMMessageAssociationEnd<StructuredRemittanceInformation12, Optional<Garnishment1>>() {
		{
		...
		@Override
		public Optional<Garnishment1> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getGarnishmentRemittance();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, Optional<Garnishment1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<StructuredRemittanceInformation12, List<Max140Text>> mmAdditionalRemittanceInformation = new MMMessageAttribute<StructuredRemittanceInformation12, List<Max140Text>>() {
		{
			businessComponentTrace_lazy = () -> Document.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.mmObject();
			isDerived = false;
		...
		@Override
		public List<Max140Text> getValue(StructuredRemittanceInformation12 obj) {
			return obj.getAdditionalRemittanceInformation();
		}

		@Override
		public void setValue(StructuredRemittanceInformation12 obj, List<Max140Text> value) {
	...
	public StructuredRemittanceInformation12 setReferredDocumentInformation(List<ReferredDocumentInformation6> referredDocumentInformation) {
	...
	public StructuredRemittanceInformation12 setReferredDocumentAmount(RemittanceAmount2 referredDocumentAmount) {
	...
	public StructuredRemittanceInformation12 setCreditorReferenceInformation(CreditorReferenceInformation2 creditorReferenceInformation) {
	...
	public StructuredRemittanceInformation12 setInvoicer(PartyIdentification43 invoicer) {
	...
	public StructuredRemittanceInformation12 setInvoicee(PartyIdentification43 invoicee) {
	...
	public StructuredRemittanceInformation12 setTaxRemittance(TaxInformation4 taxRemittance) {
	...
	public StructuredRemittanceInformation12 setGarnishmentRemittance(Garnishment1 garnishmentRemittance) {
