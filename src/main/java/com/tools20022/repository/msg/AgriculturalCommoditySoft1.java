...
public class AgriculturalCommoditySoft1 {
	...
	public static final MMMessageAttribute AdditionalSubProduct = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AgriculturalCommoditySoft1.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Commodity.DetailedSubProduct;
			isDerived = false;
			xmlTag = "AddtlSubPdct";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AgriculturalCommoditySoft1.BaseProduct, com.tools20022.repository.msg.AgriculturalCommoditySoft1.SubProduct,
						com.tools20022.repository.msg.AgriculturalCommoditySoft1.AdditionalSubProduct);
