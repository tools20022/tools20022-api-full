...
public class TransferIn3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferIn3.mmTransferDetails, TransferIn3.mmFinancialInstrumentDetails, TransferIn3.mmAccountDetails, TransferIn3.mmSettlementDetails, TransferIn3.mmExtension);
	...
	public void setTransferDetails(com.tools20022.repository.msg.Transfer6 transferDetails) {
	...
	public void setSettlementDetails(com.tools20022.repository.msg.DeliverInformation3 settlementDetails) {
