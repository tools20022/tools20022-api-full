...
public class AdditionalParameters23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters23.mmPreConfirmation, AdditionalParameters23.mmPartialSettlement, AdditionalParameters23.mmTripartyAgentCollateralTransactionIdentification,
						AdditionalParameters23.mmClientTripartyCollateralTransactionIdentification);
