...
public class Transaction9 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails16.mmObject();
		}
	};
	...
	public Transaction9 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails16 transactionDetails) {
