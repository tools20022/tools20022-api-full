...
public class Transaction9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction9.mmAccountOwnerTransactionIdentification, Transaction9.mmAccountServicerTransactionIdentification, Transaction9.mmMarketInfrastructureTransactionIdentification,
						Transaction9.mmTradeIdentification, Transaction9.mmPoolIdentification, Transaction9.mmCommonIdentification, Transaction9.mmCorporateActionEventIdentification,
						Transaction9.mmTripartyAgentCollateralTransactionIdentification, Transaction9.mmClientTripartyCollateralTransactionIdentification, Transaction9.mmTransactionDetails);
