...
import com.tools20022.repository.msg.TransactionDetails16;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction9
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction9
 * ConstraintCoexistenceIdentificationRule.forTransaction9}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction9", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "tradeIdentification", "poolIdentification",
...
public class Transaction9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, RestrictedFINXMax16Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction9, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction9.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public RestrictedFINXMax16Text getValue(Transaction9 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction9 obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(Transaction9 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction9 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, List<RestrictedFINXMax16Text>> mmTradeIdentification = new MMMessageAttribute<Transaction9, List<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public List<RestrictedFINXMax16Text> getValue(Transaction9 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction9 obj, List<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmPoolIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmCommonIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction9, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	protected TransactionDetails16 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails16
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction9, Optional<TransactionDetails16>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction9, Optional<TransactionDetails16>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails16.mmObject();
		}

		@Override
		public Optional<TransactionDetails16> getValue(Transaction9 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction9 obj, Optional<TransactionDetails16> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction9.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction9.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction9.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction9.mmTradeIdentification,
						com.tools20022.repository.msg.Transaction9.mmPoolIdentification, com.tools20022.repository.msg.Transaction9.mmCommonIdentification, com.tools20022.repository.msg.Transaction9.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction9.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction9.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction9.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction9,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction9);
	...
	public Transaction9 setAccountOwnerTransactionIdentification(RestrictedFINXMax16Text accountOwnerTransactionIdentification) {
	...
	public Transaction9 setAccountServicerTransactionIdentification(RestrictedFINXMax16Text accountServicerTransactionIdentification) {
	...
	public Transaction9 setMarketInfrastructureTransactionIdentification(RestrictedFINXMax16Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction9 setTradeIdentification(List<RestrictedFINXMax16Text> tradeIdentification) {
	...
	public Transaction9 setPoolIdentification(RestrictedFINXMax16Text poolIdentification) {
	...
	public Transaction9 setCommonIdentification(RestrictedFINXMax16Text commonIdentification) {
	...
	public Transaction9 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public Transaction9 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction9 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails16> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction9 setTransactionDetails(TransactionDetails16 transactionDetails) {
