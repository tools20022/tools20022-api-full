...
public class FinancialInstrumentAttributes8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes8.mmPlaceOfListing, FinancialInstrumentAttributes8.mmDayCountBasis, FinancialInstrumentAttributes8.mmRegistrationForm,
						FinancialInstrumentAttributes8.mmPaymentFrequency, FinancialInstrumentAttributes8.mmPaymentStatus, FinancialInstrumentAttributes8.mmPaymentDirection, FinancialInstrumentAttributes8.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes8.mmPreferenceToIncome, FinancialInstrumentAttributes8.mmClassificationType, FinancialInstrumentAttributes8.mmOptionStyle, FinancialInstrumentAttributes8.mmOptionType,
						FinancialInstrumentAttributes8.mmDenominationCurrency, FinancialInstrumentAttributes8.mmCouponDate, FinancialInstrumentAttributes8.mmExpiryDate, FinancialInstrumentAttributes8.mmFloatingRateFixingDate,
						FinancialInstrumentAttributes8.mmMaturityDate, FinancialInstrumentAttributes8.mmIssueDate, FinancialInstrumentAttributes8.mmNextCallableDate, FinancialInstrumentAttributes8.mmPutableDate,
						FinancialInstrumentAttributes8.mmDatedDate, FinancialInstrumentAttributes8.mmFirstPaymentDate, FinancialInstrumentAttributes8.mmPreviousFactor, FinancialInstrumentAttributes8.mmCurrentFactor,
						FinancialInstrumentAttributes8.mmNextFactor, FinancialInstrumentAttributes8.mmInterestRate, FinancialInstrumentAttributes8.mmNextInterestRate, FinancialInstrumentAttributes8.mmIndexRateBasis,
						FinancialInstrumentAttributes8.mmCouponAttachedNumber, FinancialInstrumentAttributes8.mmPoolNumber, FinancialInstrumentAttributes8.mmVariableRateIndicator, FinancialInstrumentAttributes8.mmCallableIndicator,
						FinancialInstrumentAttributes8.mmPutableIndicator, FinancialInstrumentAttributes8.mmMarketOrIndicativePrice, FinancialInstrumentAttributes8.mmExercisePrice, FinancialInstrumentAttributes8.mmSubscriptionPrice,
						FinancialInstrumentAttributes8.mmConversionPrice, FinancialInstrumentAttributes8.mmStrikePrice, FinancialInstrumentAttributes8.mmMinimumNominalQuantity, FinancialInstrumentAttributes8.mmContractSize,
						FinancialInstrumentAttributes8.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes8.mmFinancialInstrumentAttributeAdditionalDetails);
