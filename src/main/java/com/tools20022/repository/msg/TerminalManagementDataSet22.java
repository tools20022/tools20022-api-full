...
public class TerminalManagementDataSet22 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TerminalManagementDataSet22
	 * TerminalManagementDataSet22}</li>
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TerminalManagementDataSet24.mmIdentification);
	...
	public static final MMMessageAttribute mmSequenceCounter = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TerminalManagementDataSet24.mmSequenceCounter);
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.ManagementPlanContent6
	...
	public static final MMMessageAssociationEnd mmContent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TerminalManagementDataSet24.mmContent);
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(TerminalManagementDataSet24.mmObject());
	...
	public TerminalManagementDataSet22 setIdentification(com.tools20022.repository.msg.DataSetIdentification6 identification) {
	...
	public TerminalManagementDataSet22 setContent(com.tools20022.repository.msg.ManagementPlanContent6 content) {
