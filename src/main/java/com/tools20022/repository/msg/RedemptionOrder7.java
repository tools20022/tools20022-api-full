 ...
 * <li>{@linkplain com.tools20022.repository.msg.RedemptionOrder7#UnitsNumber
 * RedemptionOrder7.UnitsNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.RedemptionOrder7#GrossAmount
 ...
 * <li>{@linkplain com.tools20022.repository.msg.RedemptionOrder7#ChargeDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.RedemptionOrder7#TaxDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.RedemptionOrder7#Equalisation
...
public class RedemptionOrder7 {
	...
	public static final MMMessageAttribute OrderReference = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RedemptionOrder7.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.OrderReference);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ClientReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.ClientReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd InvestmentAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.InvestmentAccountDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OrderType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.OrderType);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd BeneficiaryDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.BeneficiaryDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Rounding = new MMMessageAttribute() {
		{
			...
			name = "Rounding";
			definition = "Indicates the rounding direction applied to nearest unit.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.Rounding);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.SettlementAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CashSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.CashSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SettlementMethod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.SettlementMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.ForeignExchangeDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IncomePreference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.IncomePreference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Group1Or2Units = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.Group1Or2Units);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementAndCustodyDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.SettlementAndCustodyDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PhysicalDeliveryIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.PhysicalDeliveryIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PhysicalDeliveryDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.PhysicalDeliveryDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.CashSettlementDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NonStandardSettlementInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.NonStandardSettlementInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StaffClientBreakdown = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.StaffClientBreakdown);
			minOccurs = 0;
			maxOccurs = 4;
	...
	public static final MMMessageAttribute FinancialAdvice = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.FinancialAdvice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NegotiatedTrade = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.NegotiatedTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RelatedPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.RelatedPartyDetails);
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd Equalisation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder15.Equalisation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMXor UnitsNumberOrGrossAmountOrNetAmountOrRateRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder7.UnitsNumber, com.tools20022.repository.msg.RedemptionOrder7.GrossAmount, com.tools20022.repository.msg.RedemptionOrder7.NetAmount,
					com.tools20022.repository.msg.RedemptionOrder7.HoldingsRedemptionRate);
			messageComponent_lazy = () -> RedemptionOrder7.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionOrder7.OrderReference, com.tools20022.repository.msg.RedemptionOrder7.ClientReference,
						com.tools20022.repository.msg.RedemptionOrder7.InvestmentAccountDetails, com.tools20022.repository.msg.RedemptionOrder7.OrderType, com.tools20022.repository.msg.RedemptionOrder7.BeneficiaryDetails,
						com.tools20022.repository.msg.RedemptionOrder7.UnitsNumber, com.tools20022.repository.msg.RedemptionOrder7.GrossAmount, com.tools20022.repository.msg.RedemptionOrder7.NetAmount,
						com.tools20022.repository.msg.RedemptionOrder7.HoldingsRedemptionRate, com.tools20022.repository.msg.RedemptionOrder7.Rounding, com.tools20022.repository.msg.RedemptionOrder7.SettlementAmount,
						com.tools20022.repository.msg.RedemptionOrder7.CashSettlementDate, com.tools20022.repository.msg.RedemptionOrder7.SettlementMethod, com.tools20022.repository.msg.RedemptionOrder7.ForeignExchangeDetails,
						com.tools20022.repository.msg.RedemptionOrder7.IncomePreference, com.tools20022.repository.msg.RedemptionOrder7.Group1Or2Units, com.tools20022.repository.msg.RedemptionOrder7.ChargeDetails,
						com.tools20022.repository.msg.RedemptionOrder7.CommissionDetails, com.tools20022.repository.msg.RedemptionOrder7.TaxDetails, com.tools20022.repository.msg.RedemptionOrder7.SettlementAndCustodyDetails,
						com.tools20022.repository.msg.RedemptionOrder7.PhysicalDeliveryIndicator, com.tools20022.repository.msg.RedemptionOrder7.PhysicalDeliveryDetails, com.tools20022.repository.msg.RedemptionOrder7.CashSettlementDetails,
						com.tools20022.repository.msg.RedemptionOrder7.NonStandardSettlementInformation, com.tools20022.repository.msg.RedemptionOrder7.StaffClientBreakdown, com.tools20022.repository.msg.RedemptionOrder7.FinancialAdvice,
						com.tools20022.repository.msg.RedemptionOrder7.NegotiatedTrade, com.tools20022.repository.msg.RedemptionOrder7.RelatedPartyDetails, com.tools20022.repository.msg.RedemptionOrder7.Equalisation);
