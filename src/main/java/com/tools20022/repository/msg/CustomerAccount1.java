...
public class CustomerAccount1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CustomerAccount1.mmIdentification, CustomerAccount1.mmName, CustomerAccount1.mmStatus, CustomerAccount1.mmType, CustomerAccount1.mmCurrency, CustomerAccount1.mmMonthlyPaymentValue,
						CustomerAccount1.mmMonthlyReceivedValue, CustomerAccount1.mmMonthlyTransactionNumber, CustomerAccount1.mmAverageBalance, CustomerAccount1.mmAccountPurpose, CustomerAccount1.mmFloorNotificationAmount,
						CustomerAccount1.mmCeilingNotificationAmount, CustomerAccount1.mmStatementCycle, CustomerAccount1.mmClosingDate, CustomerAccount1.mmRestriction);
