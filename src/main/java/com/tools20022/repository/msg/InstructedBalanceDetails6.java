...
public class InstructedBalanceDetails6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InstructedBalanceDetails6.TotalInstructedBalance, com.tools20022.repository.msg.InstructedBalanceDetails6.OptionDetails);
