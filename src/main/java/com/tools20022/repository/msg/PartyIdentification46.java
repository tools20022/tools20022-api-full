 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forPartyIdentification46
 * ConstraintCoexistenceIdentificationRule.forPartyIdentification46}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PartyIdentification46", propOrder = {"identification", "processingIdentification"})
public class PartyIdentification46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification46.mmIdentification, com.tools20022.repository.msg.PartyIdentification46.mmProcessingIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forPartyIdentification46);
	...
	public PartyIdentification46 setIdentification(PartyIdentification44Choice identification) {
	...
	public PartyIdentification46 setProcessingIdentification(Max35Text processingIdentification) {
