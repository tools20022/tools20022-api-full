	...
	public static final MMMessageAttribute mmPlaceAndName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD19.mmPlaceAndName);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD19.mmEventType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.mmEventType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSubEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD19.mmSubEventType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD4.mmSubEventType;
			maxOccurs = 1;
			minOccurs = 0;
