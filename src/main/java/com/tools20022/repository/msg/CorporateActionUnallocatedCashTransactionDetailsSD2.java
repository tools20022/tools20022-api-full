 ...
 * CorporateActionUnallocatedCashTransactionDetailsSD2.mmCreditDebitIndicator}</li>
 * <li>
 ...
 * CorporateActionUnallocatedCashTransactionDetailsSD2.mmUnallocatedReasonCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2#mmContraParticipantNumber
 * CorporateActionUnallocatedCashTransactionDetailsSD2.mmContraParticipantNumber
 * }</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2#mmEarliestPaymentDate
 * CorporateActionUnallocatedCashTransactionDetailsSD2.mmEarliestPaymentDate}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionUnallocatedCashTransactionDetailsSD2", propOrder = {"creditDebitIndicator", "reasonCode", "transactionAmount", "unallocatedReasonCode", "contraParticipantNumber", "earliestPaymentDate"})
public class CorporateActionUnallocatedCashTransactionDetailsSD2 {
	 ...
	 * CorporateActionUnallocatedCashTransactionDetailsSD1.
	 * mmCreditDebitIndicator}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, CreditDebitCode>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmCreditDebitIndicator);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DTCAdjustmentPaymentType1Code>> mmReasonCode = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DTCAdjustmentPaymentType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmReasonCode);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCAdjustmentPaymentType1Code> getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, Optional<DTCAdjustmentPaymentType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<RestrictedFINActiveCurrencyAndAmount>> mmTransactionAmount = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<RestrictedFINActiveCurrencyAndAmount>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			xmlTag = "TxAmt";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmTransactionAmount);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmTransactionAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RestrictedFINActiveCurrencyAndAmount> getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getTransactionAmount();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, Optional<RestrictedFINActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DTCUnallocatedAdjustmentReason1Code>> mmUnallocatedReasonCode = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DTCUnallocatedAdjustmentReason1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			xmlTag = "UallctdRsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmUnallocatedReasonCode);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmUnallocatedReasonCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCUnallocatedAdjustmentReason1Code> getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getUnallocatedReasonCode();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, Optional<DTCUnallocatedAdjustmentReason1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<Max8Text>> mmContraParticipantNumber = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<Max8Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmContraParticipantNumber);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmContraParticipantNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max8Text> getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getContraParticipantNumber();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, Optional<Max8Text> value) {
	 ...
	 * CorporateActionUnallocatedCashTransactionDetailsSD1.mmEarliestPaymentDate
	 * }</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DateFormat28Choice>> mmEarliestPaymentDate = new MMMessageAttribute<CorporateActionUnallocatedCashTransactionDetailsSD2, Optional<DateFormat28Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmObject();
			isDerived = false;
			xmlTag = "EarlstPmtDt";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmEarliestPaymentDate);
			previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmEarliestPaymentDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateFormat28Choice> getValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj) {
			return obj.getEarliestPaymentDate();
		}

		@Override
		public void setValue(CorporateActionUnallocatedCashTransactionDetailsSD2 obj, Optional<DateFormat28Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmCreditDebitIndicator,
						com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmReasonCode, com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmTransactionAmount,
						com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmUnallocatedReasonCode, com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmContraParticipantNumber,
						com.tools20022.repository.msg.CorporateActionUnallocatedCashTransactionDetailsSD2.mmEarliestPaymentDate);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionUnallocatedCashTransactionDetailsSD2";
				definition = "Breakdown of unallocated cash transactions.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmObject());
				previousVersion_lazy = () -> CorporateActionUnallocatedCashTransactionDetailsSD1.mmObject();
			}
		});
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setReasonCode(DTCAdjustmentPaymentType1Code reasonCode) {
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setTransactionAmount(RestrictedFINActiveCurrencyAndAmount transactionAmount) {
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setUnallocatedReasonCode(DTCUnallocatedAdjustmentReason1Code unallocatedReasonCode) {
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setContraParticipantNumber(Max8Text contraParticipantNumber) {
	...
	public CorporateActionUnallocatedCashTransactionDetailsSD2 setEarliestPaymentDate(DateFormat28Choice earliestPaymentDate) {
