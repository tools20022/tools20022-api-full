...
public class CardPaymentTransaction41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction41.mmTransactionCapture, CardPaymentTransaction41.mmMerchantCategoryCode, CardPaymentTransaction41.mmSaleReferenceIdentification,
						CardPaymentTransaction41.mmTransactionIdentification, CardPaymentTransaction41.mmOriginalTransaction, CardPaymentTransaction41.mmReconciliationIdentification, CardPaymentTransaction41.mmTransactionDetails,
						CardPaymentTransaction41.mmAdditionalTransactionData);
