...
public class CorporateActionPrice21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice21.GenericCashPriceReceivedPerProduct, com.tools20022.repository.msg.CorporateActionPrice21.CashInLieuOfSharePrice,
						com.tools20022.repository.msg.CorporateActionPrice21.OverSubscriptionDepositPrice);
