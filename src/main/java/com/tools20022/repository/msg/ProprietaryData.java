 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ProprietaryData#Type
 * ProprietaryData.Type}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ProprietaryData#Any
 * ProprietaryData.Any}</li>
 * </ul>
 * </li>
 * <li>
...
public class ProprietaryData {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ProprietaryData.Type, com.tools20022.repository.msg.ProprietaryData.Any);
