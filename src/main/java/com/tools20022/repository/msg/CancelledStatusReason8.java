...
public class CancelledStatusReason8 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledStatusReason8.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReasonCode";
			definition = "Specifies the reason why the instruction or instruction cancellation has been cancelled.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason12.mmReasonCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CancelledStatusReason6.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason12.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CancelledStatusReason6.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setReasonCode(CancelledReason5Choice reasonCode) {
