...
import com.tools20022.repository.choice.CancelledReason5Choice;
...
@XmlType(name = "CancelledStatusReason8", propOrder = {"reasonCode", "additionalReasonInformation"})
public class CancelledStatusReason8 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected CancelledReason5Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CancelledStatusReason8, CancelledReason5Choice> mmReasonCode = new MMMessageAssociationEnd<CancelledStatusReason8, CancelledReason5Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.CancelledStatusReason8.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason12.mmReasonCode);
			previousVersion_lazy = () -> CancelledStatusReason6.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CancelledReason5Choice.mmObject();
		}

		@Override
		public CancelledReason5Choice getValue(CancelledStatusReason8 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(CancelledStatusReason8 obj, CancelledReason5Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledStatusReason8, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancelledStatusReason8, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason12.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> CancelledStatusReason6.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(CancelledStatusReason8 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(CancelledStatusReason8 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason8.mmReasonCode, com.tools20022.repository.msg.CancelledStatusReason8.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forCancelledStatusReason8);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancelledStatusReason8";
				definition = "Specifies reasons for the cancelled status.";
				nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason12.mmObject());
				previousVersion_lazy = () -> CancelledStatusReason6.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public CancelledReason5Choice getReasonCode() {
		return reasonCode;
	}

	public CancelledStatusReason8 setReasonCode(CancelledReason5Choice reasonCode) {
	...
	public CancelledStatusReason8 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
