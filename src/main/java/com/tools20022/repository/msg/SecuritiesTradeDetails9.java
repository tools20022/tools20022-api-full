...
public class SecuritiesTradeDetails9 {
	...
	public static final MMMessageAttribute mmTradeIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecuritiesTradeDetails9.mmObject();
			isDerived = false;
			xmlTag = "TradId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails9.mmTradeIdentification, SecuritiesTradeDetails9.mmCollateralTransactionIdentification, SecuritiesTradeDetails9.mmAccountOwnerTransactionIdentification,
						SecuritiesTradeDetails9.mmPlaceOfTrade, SecuritiesTradeDetails9.mmPlaceOfClearing, SecuritiesTradeDetails9.mmTradeDate, SecuritiesTradeDetails9.mmSettlementDate, SecuritiesTradeDetails9.mmLateDeliveryDate,
						SecuritiesTradeDetails9.mmDealPrice, SecuritiesTradeDetails9.mmNumberOfDaysAccrued, SecuritiesTradeDetails9.mmOpeningClosing, SecuritiesTradeDetails9.mmReporting, SecuritiesTradeDetails9.mmTradeTransactionCondition,
						SecuritiesTradeDetails9.mmTypeOfPrice);
