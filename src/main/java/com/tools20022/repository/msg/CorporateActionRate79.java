...
public class CorporateActionRate79 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate79.mmAdditionalTax, CorporateActionRate79.mmGrossDividendRate, CorporateActionRate79.mmNetDividendRate, CorporateActionRate79.mmIndexFactor,
						CorporateActionRate79.mmInterestRateUsedForPayment, CorporateActionRate79.mmMaximumAllowedOversubscriptionRate, CorporateActionRate79.mmProrationRate, CorporateActionRate79.mmWithholdingTaxRate,
						CorporateActionRate79.mmSecondLevelTax, CorporateActionRate79.mmTaxableIncomePerDividendShare, CorporateActionRate79.mmIssuerDeclaredExchangeRate, CorporateActionRate79.mmTaxOnIncome);
