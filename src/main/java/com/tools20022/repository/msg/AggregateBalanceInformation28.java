...
public class AggregateBalanceInformation28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation28.mmFinancialInstrumentIdentification, AggregateBalanceInformation28.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation28.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation28.mmValuationHaircutDetails, AggregateBalanceInformation28.mmAggregateBalance,
						AggregateBalanceInformation28.mmAvailableBalance, AggregateBalanceInformation28.mmNotAvailableBalance, AggregateBalanceInformation28.mmSafekeepingPlace, AggregateBalanceInformation28.mmCorporateActionOptionType,
						AggregateBalanceInformation28.mmPriceDetails, AggregateBalanceInformation28.mmForeignExchangeDetails, AggregateBalanceInformation28.mmDaysAccrued, AggregateBalanceInformation28.mmAccountBaseCurrencyAmounts,
						AggregateBalanceInformation28.mmInstrumentCurrencyAmounts, AggregateBalanceInformation28.mmQuantityBreakdown, AggregateBalanceInformation28.mmBalanceBreakdown,
						AggregateBalanceInformation28.mmAdditionalBalanceBreakdown, AggregateBalanceInformation28.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation28.mmHoldingAdditionalDetails,
						AggregateBalanceInformation28.mmSupplementaryData);
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace27> balanceAtSafekeepingPlace) {
