...
@XmlType(name = "CardPaymentTransactionAdviceResponse4", propOrder = {"saleReferenceIdentification", "transactionIdentification", "reconciliationIdentification", "response"})
public class CardPaymentTransactionAdviceResponse4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SaleReferenceIdentification";
			definition = "Global reference of the sale transaction for the sale system.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionAdviceResponse6.mmSaleReferenceIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransactionAdviceResponse4 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransactionAdviceResponse4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionAdviceResponse4, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransactionAdviceResponse4, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionAdviceResponse6.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse3.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransactionAdviceResponse4 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransactionAdviceResponse4 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmObject();
			isDerived = false;
			xmlTag = "RcncltnId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionAdviceResponse6.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse3.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Response1Code> mmResponse = new MMMessageAttribute<CardPaymentTransactionAdviceResponse4, Response1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionAdviceResponse6.mmResponse);
			previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse3.mmResponse;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Response1Code getValue(CardPaymentTransactionAdviceResponse4 obj) {
			return obj.getResponse();
		}

		@Override
		public void setValue(CardPaymentTransactionAdviceResponse4 obj, Response1Code value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmSaleReferenceIdentification,
						com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransactionAdviceResponse4.mmResponse);
				trace_lazy = () -> Response.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransactionAdviceResponse4";
				definition = "Card payment completion advice response from the acquirer.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionAdviceResponse6.mmObject());
				previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse3.mmObject();
			}
		});
	...
	public CardPaymentTransactionAdviceResponse4 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransactionAdviceResponse4 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransactionAdviceResponse4 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransactionAdviceResponse4 setResponse(Response1Code response) {
