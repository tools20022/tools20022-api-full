...
public class SubAccountIdentification13 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification13.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification13.mmAccountOwner, SubAccountIdentification13.mmSafekeepingAccount, SubAccountIdentification13.mmActivityIndicator,
						SubAccountIdentification13.mmBalanceForSubAccount);
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation11> balanceForSubAccount) {
