...
public class FinancialInstrument30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrument30.mmIdentification, FinancialInstrument30.mmName, FinancialInstrument30.mmQuantity, FinancialInstrument30.mmAverageAcquisitionPrice,
						FinancialInstrument30.mmTotalBookValue, FinancialInstrument30.mmTransfereeAccount, FinancialInstrument30.mmDeliveringAgentDetails);
