 ...
 * <li>{@linkplain com.tools20022.repository.msg.FinancialInstrument30#mmName
 ...
 * ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument30
 * }</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FinancialInstrument30", propOrder = {"identification", "name", "quantity", "averageAcquisitionPrice", "totalBookValue", "transfereeAccount", "deliveringAgentDetails"})
public class FinancialInstrument30 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, SecurityIdentification3Choice> mmIdentification = new MMMessageAttribute<FinancialInstrument30, SecurityIdentification3Choice>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrument30.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecurityIdentification3Choice getValue(FinancialInstrument30 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, SecurityIdentification3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<Max350Text>> mmName = new MMMessageAttribute<FinancialInstrument30, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmName);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(FinancialInstrument30 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<Quantity12Choice>> mmQuantity = new MMMessageAttribute<FinancialInstrument30, Optional<Quantity12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmQuantity);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Quantity12Choice> getValue(FinancialInstrument30 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, Optional<Quantity12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<ActiveOrHistoricCurrencyAndAmount>> mmAverageAcquisitionPrice = new MMMessageAttribute<FinancialInstrument30, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmAverageAcquisitionPrice);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(FinancialInstrument30 obj) {
			return obj.getAverageAcquisitionPrice();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<ActiveOrHistoricCurrencyAndAmount>> mmTotalBookValue = new MMMessageAttribute<FinancialInstrument30, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmTotalBookValue);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<Account6>> mmTransfereeAccount = new MMMessageAttribute<FinancialInstrument30, Optional<Account6>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmTransfereeAccount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Account6> getValue(FinancialInstrument30 obj) {
			return obj.getTransfereeAccount();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, Optional<Account6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument30, Optional<PartyIdentificationAndAccount93>> mmDeliveringAgentDetails = new MMMessageAttribute<FinancialInstrument30, Optional<PartyIdentificationAndAccount93>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmDeliveringAgentDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyIdentificationAndAccount93> getValue(FinancialInstrument30 obj) {
			return obj.getDeliveringAgentDetails();
		}

		@Override
		public void setValue(FinancialInstrument30 obj, Optional<PartyIdentificationAndAccount93> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument30.mmIdentification, com.tools20022.repository.msg.FinancialInstrument30.mmName,
						com.tools20022.repository.msg.FinancialInstrument30.mmQuantity, com.tools20022.repository.msg.FinancialInstrument30.mmAverageAcquisitionPrice, com.tools20022.repository.msg.FinancialInstrument30.mmTotalBookValue,
						com.tools20022.repository.msg.FinancialInstrument30.mmTransfereeAccount, com.tools20022.repository.msg.FinancialInstrument30.mmDeliveringAgentDetails);
				trace_lazy = () -> InvestmentFundClass.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument30);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrument30";
				definition = "Security that is a sub-set of an investment fund, and is governed by the same investment fund policy, eg, dividend option or valuation currency.";
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrument37.mmObject());
				previousVersion_lazy = () -> FinancialInstrument26.mmObject();
			}
		});
	...
	public FinancialInstrument30 setIdentification(SecurityIdentification3Choice identification) {
	...
	public FinancialInstrument30 setName(Max350Text name) {
		this.name = name;
		return this;
	}
	...
	public FinancialInstrument30 setQuantity(Quantity12Choice quantity) {
	...
	public FinancialInstrument30 setAverageAcquisitionPrice(ActiveOrHistoricCurrencyAndAmount averageAcquisitionPrice) {
	...
	public FinancialInstrument30 setTotalBookValue(ActiveOrHistoricCurrencyAndAmount totalBookValue) {
	...
	public FinancialInstrument30 setTransfereeAccount(Account6 transfereeAccount) {
	...
	public FinancialInstrument30 setDeliveringAgentDetails(PartyIdentificationAndAccount93 deliveringAgentDetails) {
