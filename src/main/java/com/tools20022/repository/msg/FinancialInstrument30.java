 ...
 * <li>{@linkplain com.tools20022.repository.msg.FinancialInstrument30#Quantity
...
public class FinancialInstrument30 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> FinancialInstrument30.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.Identification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.Name);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Quantity = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.Quantity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AverageAcquisitionPrice = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.AverageAcquisitionPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TotalBookValue = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.TotalBookValue);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAttribute TransfereeAccount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.TransfereeAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute DeliveringAgentDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument37.DeliveringAgentDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument30.Identification, com.tools20022.repository.msg.FinancialInstrument30.Name,
						com.tools20022.repository.msg.FinancialInstrument30.Quantity, com.tools20022.repository.msg.FinancialInstrument30.AverageAcquisitionPrice, com.tools20022.repository.msg.FinancialInstrument30.TotalBookValue,
						com.tools20022.repository.msg.FinancialInstrument30.TransfereeAccount, com.tools20022.repository.msg.FinancialInstrument30.DeliveringAgentDetails);
