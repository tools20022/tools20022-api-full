...
@XmlType(name = "SecuritiesTradeDetails53", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "placeOfTrade", "placeOfClearing", "tradeDate", "settlementDate", "effectiveSettlementDate", "dealPrice",
...
public class SecuritiesTradeDetails53 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails53, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails53.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmTradeIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails53, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmCollateralTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmPlaceOfTrade);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<PlaceOfTradeIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmPlaceOfClearing);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfClearingIdentification1> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<PlaceOfClearingIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<TradeDate5Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<TradeDate5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmTradeDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate5Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<TradeDate5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<SettlementDate9Choice>> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<SettlementDate9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDate9Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<SettlementDate9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails53, SettlementDate11Choice> mmEffectiveSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails53, SettlementDate11Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate11Choice getValue(SecuritiesTradeDetails53 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, SettlementDate11Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails53, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmDealPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<OpeningClosing3Choice>> mmOpeningClosing = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<OpeningClosing3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmOpeningClosing);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmOpeningClosing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OpeningClosing3Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getOpeningClosing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<OpeningClosing3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, List<Reporting6Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails53, List<Reporting6Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails53.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmReporting);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmReporting;
			minOccurs = 0;
			complexType_lazy = () -> Reporting6Choice.mmObject();
		}

		@Override
		public List<Reporting6Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, List<Reporting6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, List<TradeTransactionCondition5Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails53, List<TradeTransactionCondition5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmTradeTransactionCondition);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmTradeTransactionCondition;
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition5Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition5Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, List<TradeTransactionCondition5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<InvestorCapacity4Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<InvestorCapacity4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmInvestorCapacity);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmInvestorCapacity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity4Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<InvestorCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<TradeOriginator3Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<TradeOriginator3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmTradeOriginatorRole);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmTradeOriginatorRole;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator3Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<TradeOriginator3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<TypeOfPrice29Choice>> mmTypeOfPrice = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<TypeOfPrice29Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmTypeOfPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfPrice29Choice> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<TypeOfPrice29Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmFXAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmFXAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails53 obj) {
			return obj.getFXAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails53 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails53, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails31.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmationV06.mmTradeDetails, SecuritiesSettlementTransactionReversalAdviceV05.mmTradeDetails,
						SecuritiesSettlementTransactionConfirmationV07.mmTradeDetails, SecuritiesSettlementTransactionReversalAdviceV06.mmTradeDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails53,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails53, com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails53,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails53, com.tools20022.repository.constraints.ConstraintTradeDateGuideline.forSecuritiesTradeDetails53);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTradeDetails53";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails76.mmObject());
	...
	public SecuritiesTradeDetails53 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails53 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails53 setPlaceOfTrade(PlaceOfTradeIdentification1 placeOfTrade) {
	...
	public SecuritiesTradeDetails53 setPlaceOfClearing(PlaceOfClearingIdentification1 placeOfClearing) {
	...
	public SecuritiesTradeDetails53 setTradeDate(TradeDate5Choice tradeDate) {
	...
	public SecuritiesTradeDetails53 setSettlementDate(SettlementDate9Choice settlementDate) {
	...
	public SecuritiesTradeDetails53 setEffectiveSettlementDate(SettlementDate11Choice effectiveSettlementDate) {
	...
	public SecuritiesTradeDetails53 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails53 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails53 setOpeningClosing(OpeningClosing3Choice openingClosing) {
	...
	public SecuritiesTradeDetails53 setReporting(List<Reporting6Choice> reporting) {
	...
	public SecuritiesTradeDetails53 setTradeTransactionCondition(List<TradeTransactionCondition5Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails53 setInvestorCapacity(InvestorCapacity4Choice investorCapacity) {
	...
	public SecuritiesTradeDetails53 setTradeOriginatorRole(TradeOriginator3Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails53 setTypeOfPrice(TypeOfPrice29Choice typeOfPrice) {
	...
	public SecuritiesTradeDetails53 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
	...
	public SecuritiesTradeDetails53 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
