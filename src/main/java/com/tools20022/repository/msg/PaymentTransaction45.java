...
public class PaymentTransaction45 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction45.mmReversalIdentification, PaymentTransaction45.mmOriginalInstructionIdentification, PaymentTransaction45.mmOriginalEndToEndIdentification,
						PaymentTransaction45.mmOriginalTransactionIdentification, PaymentTransaction45.mmOriginalClearingSystemReference, PaymentTransaction45.mmOriginalInterbankSettlementAmount,
						PaymentTransaction45.mmReversedInterbankSettlementAmount, PaymentTransaction45.mmInterbankSettlementDate, PaymentTransaction45.mmReversedInstructedAmount, PaymentTransaction45.mmExchangeRate,
						PaymentTransaction45.mmCompensationAmount, PaymentTransaction45.mmChargeBearer, PaymentTransaction45.mmChargesInformation, PaymentTransaction45.mmInstructingAgent, PaymentTransaction45.mmInstructedAgent,
						PaymentTransaction45.mmReversalReasonInformation, PaymentTransaction45.mmOriginalTransactionReference, PaymentTransaction45.mmSupplementaryData);
