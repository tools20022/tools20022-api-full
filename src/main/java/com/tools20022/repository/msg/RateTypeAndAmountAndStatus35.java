...
public class RateTypeAndAmountAndStatus35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus35.mmRateType, RateTypeAndAmountAndStatus35.mmAmount, RateTypeAndAmountAndStatus35.mmRateStatus);
