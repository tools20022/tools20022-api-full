...
import com.tools20022.repository.msg.TransactionDetails37;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction18
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction18}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction18
 * ConstraintCoexistenceIdentificationRule.forTransaction18}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction13
 * Transaction13}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction18", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class Transaction18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction18, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction18.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(Transaction18 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction18 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transaction18 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction18 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction18, List<Max35Text>>() {
		{
		...
		@Override
		public List<Max35Text> getValue(Transaction18 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction18 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction18, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction18, Optional<Max35Text>>() {
		{
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails37
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction18, Optional<TransactionDetails37>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction18, Optional<TransactionDetails37>>() {
		{
		...
		@Override
		public Optional<TransactionDetails37> getValue(Transaction18 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction18 obj, Optional<TransactionDetails37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction18, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<Transaction18, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction18.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
		...
		@Override
		public List<SupplementaryData1> getValue(Transaction18 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(Transaction18 obj, List<SupplementaryData1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction18,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction18);
				...
				name = "Transaction18";
				definition = "Identifies the details of the transaction.";
				previousVersion_lazy = () -> Transaction13.mmObject();
			}
		});
	...
	public Transaction18 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction18 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction18 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction18 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction18 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction18 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction18 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction18 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction18 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction18 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails37> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction18 setTransactionDetails(TransactionDetails37 transactionDetails) {
	...
	public Transaction18 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
