...
public class Transaction18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction18.mmAccountOwnerTransactionIdentification, Transaction18.mmAccountServicerTransactionIdentification, Transaction18.mmMarketInfrastructureTransactionIdentification,
						Transaction18.mmProcessorTransactionIdentification, Transaction18.mmTradeIdentification, Transaction18.mmPoolIdentification, Transaction18.mmCommonIdentification, Transaction18.mmCorporateActionEventIdentification,
						Transaction18.mmTripartyAgentCollateralTransactionIdentification, Transaction18.mmClientTripartyCollateralTransactionIdentification, Transaction18.mmTransactionDetails, Transaction18.mmSupplementaryData);
