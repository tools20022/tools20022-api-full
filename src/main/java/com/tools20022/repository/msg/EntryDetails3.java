...
public class EntryDetails3 {
	...
	public static final MMMessageAssociationEnd mmBatch = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EntryDetails6.mmBatch);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	protected List<com.tools20022.repository.msg.EntryTransaction4> transactionDetails;
	/**
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EntryDetails6.mmTransactionDetails);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.EntryTransaction4.mmObject();
		}
	};
	...
	public void setTransactionDetails(List<com.tools20022.repository.msg.EntryTransaction4> transactionDetails) {
