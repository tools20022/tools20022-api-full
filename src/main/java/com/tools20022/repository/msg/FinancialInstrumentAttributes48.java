...
public class FinancialInstrumentAttributes48 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes48.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes48.mmPlaceOfListing, FinancialInstrumentAttributes48.mmDayCountBasis,
						FinancialInstrumentAttributes48.mmClassificationType, FinancialInstrumentAttributes48.mmOptionStyle, FinancialInstrumentAttributes48.mmDenominationCurrency, FinancialInstrumentAttributes48.mmNextCouponDate,
						FinancialInstrumentAttributes48.mmExpiryDate, FinancialInstrumentAttributes48.mmFloatingRateFixingDate, FinancialInstrumentAttributes48.mmMaturityDate, FinancialInstrumentAttributes48.mmIssueDate,
						FinancialInstrumentAttributes48.mmNextCallableDate, FinancialInstrumentAttributes48.mmPutableDate, FinancialInstrumentAttributes48.mmDatedDate, FinancialInstrumentAttributes48.mmConversionDate,
						FinancialInstrumentAttributes48.mmInterestRate, FinancialInstrumentAttributes48.mmNextInterestRate, FinancialInstrumentAttributes48.mmPercentageOfDebtClaim, FinancialInstrumentAttributes48.mmPreviousFactor,
						FinancialInstrumentAttributes48.mmNextFactor, FinancialInstrumentAttributes48.mmWarrantParity, FinancialInstrumentAttributes48.mmMinimumNominalQuantity, FinancialInstrumentAttributes48.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes48.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes48.mmContractSize);
