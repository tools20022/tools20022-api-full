...
public class QuantityAndAccount62 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount62.mmSettledQuantity, QuantityAndAccount62.mmPreviouslySettledQuantity, QuantityAndAccount62.mmRemainingToBeSettledQuantity,
						QuantityAndAccount62.mmPreviouslySettledAmount, QuantityAndAccount62.mmRemainingToBeSettledAmount, QuantityAndAccount62.mmAccountOwner, QuantityAndAccount62.mmSafekeepingAccount, QuantityAndAccount62.mmCashAccount,
						QuantityAndAccount62.mmSafekeepingPlace);
