...
public class QuantityAndAccount62 {
	...
	public static final MMMessageAssociationEnd SettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.SettledQuantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PreviouslySettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.PreviouslySettledQuantity;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RemainingToBeSettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			definition = "Quantity of financial instrument remaining to be settled.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.RemainingToBeSettledQuantity;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> FinancialInstrumentQuantity15Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PreviouslySettledAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.PreviouslySettledAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RemainingToBeSettledAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.RemainingToBeSettledAmount;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> AmountAndDirection19.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd AccountOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.AccountOwner;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.SafekeepingAccount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.CashAccount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount46.SafekeepingPlace;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount62.SettledQuantity, com.tools20022.repository.msg.QuantityAndAccount62.PreviouslySettledQuantity,
						com.tools20022.repository.msg.QuantityAndAccount62.RemainingToBeSettledQuantity, com.tools20022.repository.msg.QuantityAndAccount62.PreviouslySettledAmount,
						com.tools20022.repository.msg.QuantityAndAccount62.RemainingToBeSettledAmount, com.tools20022.repository.msg.QuantityAndAccount62.AccountOwner, com.tools20022.repository.msg.QuantityAndAccount62.SafekeepingAccount,
						com.tools20022.repository.msg.QuantityAndAccount62.CashAccount, com.tools20022.repository.msg.QuantityAndAccount62.SafekeepingPlace);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesFinancingConfirmation002V07.QuantityAndAccountDetails);
