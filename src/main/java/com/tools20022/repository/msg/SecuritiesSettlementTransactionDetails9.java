...
public class SecuritiesSettlementTransactionDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails9.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails9.mmLinkages,
						SecuritiesSettlementTransactionDetails9.mmTradeDetails, SecuritiesSettlementTransactionDetails9.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails9.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails9.mmSettlementParameters, SecuritiesSettlementTransactionDetails9.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionDetails9.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionDetails9.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails9.mmCashParties, SecuritiesSettlementTransactionDetails9.mmSettlementAmount,
						SecuritiesSettlementTransactionDetails9.mmOtherAmounts, SecuritiesSettlementTransactionDetails9.mmOtherBusinessParties, SecuritiesSettlementTransactionDetails9.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionDetails9.mmSupplementaryData);
