...
public class PartyIdentificationAndAccount17 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount17.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount17.mmIdentification, PartyIdentificationAndAccount17.mmCashAccount, PartyIdentificationAndAccount17.mmProcessingIdentification,
						PartyIdentificationAndAccount17.mmAdditionalInformation, PartyIdentificationAndAccount17.mmAlternateIdentification);
