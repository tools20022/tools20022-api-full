...
public class PartyIdentification19 {
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification19.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification19.Name, com.tools20022.repository.msg.PartyIdentification19.PostalAddress,
						com.tools20022.repository.msg.PartyIdentification19.Identification);
