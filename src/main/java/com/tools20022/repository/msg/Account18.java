 ...
 * <li>{@linkplain com.tools20022.repository.msg.Account18#mmAccountServicer
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Account13
 * Account13}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Account18", propOrder = {"identification", "accountServicer"})
public class Account18 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Account18
	 * Account18}</li>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Account13#mmIdentification
	...
	public static final MMMessageAssociationEnd<Account18, AccountIdentification26> mmIdentification = new MMMessageAssociationEnd<Account18, AccountIdentification26>() {
		{
			...
			previousVersion_lazy = () -> Account13.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Account13#mmAccountServicer
	...
	public static final MMMessageAssociationEnd<Account18, Optional<PartyIdentification71Choice>> mmAccountServicer = new MMMessageAssociationEnd<Account18, Optional<PartyIdentification71Choice>>() {
		{
			...
			previousVersion_lazy = () -> Account13.mmAccountServicer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Account18.mmIdentification, com.tools20022.repository.msg.Account18.mmAccountServicer);
				trace_lazy = () -> Account.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Account18";
				definition = "Business relationship between two entities; one entity is the account owner, the other entity is the account servicer.";
				previousVersion_lazy = () -> Account13.mmObject();
			}
		});
	...
	public Account18 setAccountServicer(PartyIdentification71Choice accountServicer) {
