...
public class FinancialInstrumentAttributes9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes9.mmSecurityIdentification, FinancialInstrumentAttributes9.mmPlaceOfListing, FinancialInstrumentAttributes9.mmDayCountBasis,
						FinancialInstrumentAttributes9.mmClassificationType, FinancialInstrumentAttributes9.mmDenominationCurrency, FinancialInstrumentAttributes9.mmNextCouponDate, FinancialInstrumentAttributes9.mmExpiryDate,
						FinancialInstrumentAttributes9.mmFloatingRateFixingDate, FinancialInstrumentAttributes9.mmMaturityDate, FinancialInstrumentAttributes9.mmIssueDate, FinancialInstrumentAttributes9.mmNextCallableDate,
						FinancialInstrumentAttributes9.mmPutableDate, FinancialInstrumentAttributes9.mmDatedDate, FinancialInstrumentAttributes9.mmConversionDate, FinancialInstrumentAttributes9.mmPreviousFactor,
						FinancialInstrumentAttributes9.mmNextFactor, FinancialInstrumentAttributes9.mmInterestRate, FinancialInstrumentAttributes9.mmNextInterestRate, FinancialInstrumentAttributes9.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes9.mmMinimumExercisableQuantity, FinancialInstrumentAttributes9.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes9.mmContractSize);
