...
import com.tools20022.repository.msg.NotificationIdentification2;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation4#mmEventType
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forEventInformation4
 * ConstraintCoexistenceIdentificationRule.forEventInformation4}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "EventInformation4", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "mandatoryVoluntaryEventType", "lastNotificationIdentification"})
public class EventInformation4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation4, RestrictedFINXMax16Text> mmCorporateActionEventIdentification = new MMMessageAttribute<EventInformation4, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.EventInformation4.mmObject();
			isDerived = false;
		...
		@Override
		public RestrictedFINXMax16Text getValue(EventInformation4 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation4 obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation4, Optional<RestrictedFINXMax16Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<EventInformation4, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(EventInformation4 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation4 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation4, CorporateActionEventType9Choice> mmEventType = new MMMessageAttribute<EventInformation4, CorporateActionEventType9Choice>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> CorporateActionEventType9Choice.mmObject();
		}

		@Override
		public CorporateActionEventType9Choice getValue(EventInformation4 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(EventInformation4 obj, CorporateActionEventType9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation4, CorporateActionMandatoryVoluntary2Choice> mmMandatoryVoluntaryEventType = new MMMessageAttribute<EventInformation4, CorporateActionMandatoryVoluntary2Choice>() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> CorporateActionMandatoryVoluntary2Choice.mmObject();
		}

		@Override
		public CorporateActionMandatoryVoluntary2Choice getValue(EventInformation4 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(EventInformation4 obj, CorporateActionMandatoryVoluntary2Choice value) {
			obj.setMandatoryVoluntaryEventType(value);
		}
	};
	@XmlElement(name = "LastNtfctnId")
	protected NotificationIdentification2 lastNotificationIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<EventInformation4, Optional<NotificationIdentification2>> mmLastNotificationIdentification = new MMMessageAssociationEnd<EventInformation4, Optional<NotificationIdentification2>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> NotificationIdentification2.mmObject();
		}

		@Override
		public Optional<NotificationIdentification2> getValue(EventInformation4 obj) {
			return obj.getLastNotificationIdentification();
		}

		@Override
		public void setValue(EventInformation4 obj, Optional<NotificationIdentification2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation4.mmCorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation4.mmOfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation4.mmEventType, com.tools20022.repository.msg.EventInformation4.mmMandatoryVoluntaryEventType,
						com.tools20022.repository.msg.EventInformation4.mmLastNotificationIdentification);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forEventInformation4);
	...
	public EventInformation4 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public EventInformation4 setOfficialCorporateActionEventIdentification(RestrictedFINXMax16Text officialCorporateActionEventIdentification) {
	...
	public EventInformation4 setEventType(CorporateActionEventType9Choice eventType) {
	...
	public EventInformation4 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary2Choice mandatoryVoluntaryEventType) {
		this.mandatoryVoluntaryEventType = Objects.requireNonNull(mandatoryVoluntaryEventType);
		return this;
	}

	public Optional<NotificationIdentification2> getLastNotificationIdentification() {
		return lastNotificationIdentification == null ? Optional.empty() : Optional.of(lastNotificationIdentification);
	}

	public EventInformation4 setLastNotificationIdentification(NotificationIdentification2 lastNotificationIdentification) {
