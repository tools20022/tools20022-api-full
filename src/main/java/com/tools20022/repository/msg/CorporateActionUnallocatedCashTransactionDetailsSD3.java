...
public class CorporateActionUnallocatedCashTransactionDetailsSD3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionUnallocatedCashTransactionDetailsSD3.mmCreditDebitIndicator, CorporateActionUnallocatedCashTransactionDetailsSD3.mmReasonCode,
						CorporateActionUnallocatedCashTransactionDetailsSD3.mmTransactionAmount, CorporateActionUnallocatedCashTransactionDetailsSD3.mmUnallocatedReasonCode,
						CorporateActionUnallocatedCashTransactionDetailsSD3.mmContraParticipantNumber, CorporateActionUnallocatedCashTransactionDetailsSD3.mmEarliestPaymentDate);
