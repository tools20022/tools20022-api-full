...
public class AccountIdentification24 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountIdentification24.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification24.mmSafekeepingAccount, AccountIdentification24.mmAccountOwner, AccountIdentification24.mmSafekeepingPlace,
						AccountIdentification24.mmCorporateActionEventAndBalance);
	...
	public void setCorporateActionEventAndBalance(List<com.tools20022.repository.msg.CorporateActionEventAndBalance6> corporateActionEventAndBalance) {
