...
public class PriceDetails11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails11, Optional<PriceFormat6Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails11, Optional<PriceFormat6Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails11.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PriceDetails14.mmGenericCashPricePaidPerProduct);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat6Choice> getValue(PriceDetails11 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails11 obj, Optional<PriceFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails11, Optional<PriceFormat7Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails11, Optional<PriceFormat7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceDetails14.mmGenericCashPriceReceivedPerProduct);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat7Choice> getValue(PriceDetails11 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails11 obj, Optional<PriceFormat7Choice> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails11);
	...
	public PriceDetails11 setGenericCashPricePaidPerProduct(PriceFormat6Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails11 setGenericCashPriceReceivedPerProduct(PriceFormat7Choice genericCashPriceReceivedPerProduct) {
