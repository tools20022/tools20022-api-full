...
public class CorporateActionNarrative24 {
	...
	public static final MMMessageAssociationEnd Offeror = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNarrative26.Offeror);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd NewCompanyName = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNarrative26.NewCompanyName);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> UpdatedAdditionalInformation3.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd URLAddress = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNarrative26.URLAddress);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNarrative24.Offeror, com.tools20022.repository.msg.CorporateActionNarrative24.NewCompanyName,
						com.tools20022.repository.msg.CorporateActionNarrative24.URLAddress);
