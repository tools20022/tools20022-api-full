...
public class CorporateActionNotificationSD8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNotificationSD8.mmPlaceAndName, CorporateActionNotificationSD8.mmEventGroup, CorporateActionNotificationSD8.mmEventType,
						CorporateActionNotificationSD8.mmSubEventType, CorporateActionNotificationSD8.mmDTCMandatoryVoluntaryEventType);
