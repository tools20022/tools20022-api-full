	...
	public static final MMMessageAttribute OriginalMessageIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification8.OriginalMessageIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalCreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification8.OriginalCreationDateTime;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalNotificationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification8.OriginalNotificationIdentification;
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute NotificationCancellation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification8.NotificationCancellation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalNotificationReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification8.OriginalNotificationReference;
			minOccurs = 0;
