 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson4#mmGivenName
 * IndividualPerson4.mmGivenName}</li>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson4#mmMiddleName
 ...
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson4#mmBirthDate
...
@XmlType(name = "IndividualPerson4", propOrder = {"givenName", "middleName", "name", "gender", "birthDate"})
public class IndividualPerson4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson4, Max35Text> mmGivenName = new MMMessageAttribute<IndividualPerson4, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PersonName.mmGivenName;
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson4.mmObject();
			isDerived = false;
			xmlTag = "GvnNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "GivenName";
			definition = "First name of a person.";
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmGivenName);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(IndividualPerson4 obj) {
			return obj.getGivenName();
		}

		@Override
		public void setValue(IndividualPerson4 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson4, Optional<Max35Text>> mmMiddleName = new MMMessageAttribute<IndividualPerson4, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmMiddleName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(IndividualPerson4 obj) {
			return obj.getMiddleName();
		}

		@Override
		public void setValue(IndividualPerson4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson4, Max350Text> mmName = new MMMessageAttribute<IndividualPerson4, Max350Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmName);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(IndividualPerson4 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(IndividualPerson4 obj, Max350Text value) {
			obj.setName(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson4, Optional<GenderCode>> mmGender = new MMMessageAttribute<IndividualPerson4, Optional<GenderCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmGender);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<GenderCode> getValue(IndividualPerson4 obj) {
			return obj.getGender();
		}

		@Override
		public void setValue(IndividualPerson4 obj, Optional<GenderCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson4, Optional<ISODate>> mmBirthDate = new MMMessageAttribute<IndividualPerson4, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmBirthDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(IndividualPerson4 obj) {
			return obj.getBirthDate();
		}

		@Override
		public void setValue(IndividualPerson4 obj, Optional<ISODate> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IndividualPerson4.mmGivenName, com.tools20022.repository.msg.IndividualPerson4.mmMiddleName, com.tools20022.repository.msg.IndividualPerson4.mmName,
						com.tools20022.repository.msg.IndividualPerson4.mmGender, com.tools20022.repository.msg.IndividualPerson4.mmBirthDate);
				trace_lazy = () -> Person.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "IndividualPerson4";
				definition = "Human entity, as distinguished from a corporate entity (which is sometimes referred to as an 'artificial person').";
				nextVersions_lazy = () -> Arrays.asList(IndividualPerson30.mmObject());
			}
		});
	...
	public IndividualPerson4 setGivenName(Max35Text givenName) {
	...
	public IndividualPerson4 setMiddleName(Max35Text middleName) {
	...
	public IndividualPerson4 setName(Max350Text name) {
	...
	public IndividualPerson4 setGender(GenderCode gender) {
		this.gender = gender;
		return this;
	}
	...
	public IndividualPerson4 setBirthDate(ISODate birthDate) {
