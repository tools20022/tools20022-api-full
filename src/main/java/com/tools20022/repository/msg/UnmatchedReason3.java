...
public class UnmatchedReason3 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason3.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason3.mmCode, UnmatchedReason3.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason5Choice code) {
		this.code = code;
	}
