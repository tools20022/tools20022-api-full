...
import com.tools20022.repository.msg.PaymentTransaction42;
import java.util.*;
...
@XmlType(name = "OriginalPaymentInstruction7", propOrder = {"reversalPaymentInformationIdentification", "originalPaymentInformationIdentification", "originalNumberOfTransactions", "originalControlSum", "batchBooking",
...
public class OriginalPaymentInstruction7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Optional<Max35Text>> mmReversalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction7, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmInstructionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction7.mmObject();
			isDerived = false;
			xmlTag = "RvslPmtInfId";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmReversalPaymentInformationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getReversalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Max35Text> mmOriginalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction7, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmOriginalPaymentInformationIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(OriginalPaymentInstruction7 obj) {
			return obj.getOriginalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Optional<Max15NumericText>> mmOriginalNumberOfTransactions = new MMMessageAttribute<OriginalPaymentInstruction7, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction7.mmObject();
			isDerived = false;
			xmlTag = "OrgnlNbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmOriginalNumberOfTransactions);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getOriginalNumberOfTransactions();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Optional<DecimalNumber>> mmOriginalControlSum = new MMMessageAttribute<OriginalPaymentInstruction7, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction7.mmObject();
			isDerived = false;
			xmlTag = "OrgnlCtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmOriginalControlSum);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getOriginalControlSum();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<OriginalPaymentInstruction7, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction7.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmBatchBooking);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction7, Optional<TrueFalseIndicator>> mmPaymentInformationReversal = new MMMessageAttribute<OriginalPaymentInstruction7, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction7.mmObject();
			isDerived = false;
			xmlTag = "PmtInfRvsl";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmPaymentInformationReversal);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getPaymentInformationReversal();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction7, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction7, List<PaymentReversalReason7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmReversalReasonInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReversalReason7> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, List<PaymentReversalReason7> value) {
			obj.setReversalReasonInformation(value);
		}
	};
	@XmlElement(name = "TxInf")
	protected List<PaymentTransaction42> transactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.PaymentTransaction42
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction7, List<PaymentTransaction42>> mmTransactionInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction7, List<PaymentTransaction42>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmTransactionInformation);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PaymentTransaction42.mmObject();
		}

		@Override
		public List<PaymentTransaction42> getValue(OriginalPaymentInstruction7 obj) {
			return obj.getTransactionInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction7 obj, List<PaymentTransaction42> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction7.mmReversalPaymentInformationIdentification,
						com.tools20022.repository.msg.OriginalPaymentInstruction7.mmOriginalPaymentInformationIdentification, com.tools20022.repository.msg.OriginalPaymentInstruction7.mmOriginalNumberOfTransactions,
						com.tools20022.repository.msg.OriginalPaymentInstruction7.mmOriginalControlSum, com.tools20022.repository.msg.OriginalPaymentInstruction7.mmBatchBooking,
						com.tools20022.repository.msg.OriginalPaymentInstruction7.mmPaymentInformationReversal, com.tools20022.repository.msg.OriginalPaymentInstruction7.mmReversalReasonInformation,
						com.tools20022.repository.msg.OriginalPaymentInstruction7.mmTransactionInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerPaymentReversalV04.mmOriginalPaymentInformationAndReversal);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndTransactionInformationNotPresentRule.forOriginalPaymentInstruction7,
						com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndTransactionInformationPresentRule.forOriginalPaymentInstruction7,
						com.tools20022.repository.constraints.ConstraintPaymentInformationReversalAndReasonRule.forOriginalPaymentInstruction7);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OriginalPaymentInstruction7";
				definition = "Provides details on the original transactions, to which the status report message refers.";
				nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction11.mmObject());
				previousVersion_lazy = () -> OriginalPaymentInstruction2.mmObject();
			}
		});
	...
	public OriginalPaymentInstruction7 setReversalPaymentInformationIdentification(Max35Text reversalPaymentInformationIdentification) {
	...
	public OriginalPaymentInstruction7 setOriginalPaymentInformationIdentification(Max35Text originalPaymentInformationIdentification) {
	...
	public OriginalPaymentInstruction7 setOriginalNumberOfTransactions(Max15NumericText originalNumberOfTransactions) {
	...
	public OriginalPaymentInstruction7 setOriginalControlSum(DecimalNumber originalControlSum) {
	...
	public OriginalPaymentInstruction7 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public OriginalPaymentInstruction7 setPaymentInformationReversal(TrueFalseIndicator paymentInformationReversal) {
	...
	public OriginalPaymentInstruction7 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
		this.reversalReasonInformation = Objects.requireNonNull(reversalReasonInformation);
		return this;
	}

	public List<PaymentTransaction42> getTransactionInformation() {
		return transactionInformation == null ? transactionInformation = new ArrayList<>() : transactionInformation;
	}

	public OriginalPaymentInstruction7 setTransactionInformation(List<PaymentTransaction42> transactionInformation) {
