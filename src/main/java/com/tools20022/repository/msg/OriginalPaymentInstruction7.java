...
public class OriginalPaymentInstruction7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction7.mmReversalPaymentInformationIdentification, OriginalPaymentInstruction7.mmOriginalPaymentInformationIdentification,
						OriginalPaymentInstruction7.mmOriginalNumberOfTransactions, OriginalPaymentInstruction7.mmOriginalControlSum, OriginalPaymentInstruction7.mmBatchBooking, OriginalPaymentInstruction7.mmPaymentInformationReversal,
						OriginalPaymentInstruction7.mmReversalReasonInformation, OriginalPaymentInstruction7.mmTransactionInformation);
