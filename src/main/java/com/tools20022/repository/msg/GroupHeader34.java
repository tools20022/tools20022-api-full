...
public class GroupHeader34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader34.mmMessageIdentification, GroupHeader34.mmCreationDateTime, GroupHeader34.mmAuthorisation, GroupHeader34.mmBatchBooking, GroupHeader34.mmNumberOfTransactions,
						GroupHeader34.mmControlSum, GroupHeader34.mmTotalInterbankSettlementAmount, GroupHeader34.mmInterbankSettlementDate, GroupHeader34.mmSettlementInformation, GroupHeader34.mmPaymentTypeInformation,
						GroupHeader34.mmInstructingAgent, GroupHeader34.mmInstructedAgent);
