...
public class AggregateBalancePerSafekeepingPlace21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace21.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace21.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace21.mmAggregateBalance,
						AggregateBalancePerSafekeepingPlace21.mmPriceDetails, AggregateBalancePerSafekeepingPlace21.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace21.mmDaysAccrued,
						AggregateBalancePerSafekeepingPlace21.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace21.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace21.mmAlternateReportingCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace21.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace21.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace21.mmAdditionalBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace21.mmHoldingAdditionalDetails);
