...
public class CorporateActionRate75 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate75.mmAdditionalQuantityForSubscribedResultantSecurities, CorporateActionRate75.mmAdditionalQuantityForExistingSecurities, CorporateActionRate75.mmNewToOld,
						CorporateActionRate75.mmChargesFees, CorporateActionRate75.mmFiscalStamp, CorporateActionRate75.mmApplicableRate, CorporateActionRate75.mmTaxCreditRate, CorporateActionRate75.mmFinancialTransactionTaxRate);
