...
public class CorporateActionOption58 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption58.mmOptionNumber, CorporateActionOption58.mmOptionType, CorporateActionOption58.mmFractionDisposition, CorporateActionOption58.mmChangeType,
						CorporateActionOption58.mmEligibleForCollateralIndicator, CorporateActionOption58.mmCurrencyToBuy, CorporateActionOption58.mmCurrencyToSell, CorporateActionOption58.mmCurrencyOption,
						CorporateActionOption58.mmSecurityIdentification, CorporateActionOption58.mmSecuritiesQuantity, CorporateActionOption58.mmExecutionRequestedDateTime, CorporateActionOption58.mmRateAndAmountDetails,
						CorporateActionOption58.mmPriceDetails, CorporateActionOption58.mmAdditionalInformation);
