...
public class PartyIdentificationAndAccount65 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount65.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount65.mmIdentification, PartyIdentificationAndAccount65.mmAlternateIdentification, PartyIdentificationAndAccount65.mmCountryOfResidence,
						PartyIdentificationAndAccount65.mmSafekeepingAccount, PartyIdentificationAndAccount65.mmProcessingIdentification, PartyIdentificationAndAccount65.mmAdditionalInformation);
