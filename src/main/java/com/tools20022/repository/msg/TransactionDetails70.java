 ...
 * TransactionDetails70.mmClientTripartyCollateralTransactionIdentification}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails70#mmPayment
...
public class TransactionDetails70 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<TransactionDetails70, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmTradeIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(TransactionDetails70 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(TransactionDetails70 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmPoolIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionDetails70 obj) {
			return obj.getPoolIdentification();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmTripartyAgentCollateralTransactionIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmTripartyAgentCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmClientTripartyCollateralTransactionIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmClientCollateralInstructionIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails70, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmTripartyCollateralInstructionIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmTripartyCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmAccountOwner);
			previousVersion_lazy = () -> TransactionDetails61.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(TransactionDetails70 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageAssociationEnd<TransactionDetails70, SecuritiesAccount13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSafekeepingAccount);
			previousVersion_lazy = () -> TransactionDetails61.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount13 getValue(TransactionDetails70 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(TransactionDetails70 obj, SecuritiesAccount13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<TransactionDetails70, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSafekeepingPlace);
			previousVersion_lazy = () -> TransactionDetails61.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(TransactionDetails70 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<MarketIdentification78>> mmPlaceOfTrade = new MMMessageAssociationEnd<TransactionDetails70, Optional<MarketIdentification78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmPlaceOfTrade);
			previousVersion_lazy = () -> TransactionDetails61.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification78> getValue(TransactionDetails70 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<MarketIdentification78> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<TransactionDetails70, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmPlaceOfClearing);
			previousVersion_lazy = () -> TransactionDetails61.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(TransactionDetails70 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<TransactionDetails70, SecurityIdentification14>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> TransactionDetails61.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(TransactionDetails70 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(TransactionDetails70 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<TransactionDetails70, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSettlementQuantity);
			previousVersion_lazy = () -> TransactionDetails61.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails70 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<AmountAndDirection8>> mmSettlementAmount = new MMMessageAssociationEnd<TransactionDetails70, Optional<AmountAndDirection8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSettlementAmount);
			previousVersion_lazy = () -> TransactionDetails61.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection8> getValue(TransactionDetails70 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<AmountAndDirection8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmLateDeliveryDate);
			previousVersion_lazy = () -> TransactionDetails61.mmLateDeliveryDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(TransactionDetails70 obj) {
			return obj.getLateDeliveryDate();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>> mmExpectedSettlementDate = new MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmExpectedSettlementDate);
			previousVersion_lazy = () -> TransactionDetails61.mmExpectedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>> mmExpectedValueDate = new MMMessageAssociationEnd<TransactionDetails70, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmExpectedValueDate);
			previousVersion_lazy = () -> TransactionDetails61.mmExpectedValueDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, SettlementDate2Choice> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails70, SettlementDate2Choice>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSettlementDate);
			previousVersion_lazy = () -> TransactionDetails61.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate2Choice getValue(TransactionDetails70 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails70 obj, SettlementDate2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails70, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmTradeDate);
			previousVersion_lazy = () -> TransactionDetails61.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(TransactionDetails70 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionDetails70, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSecuritiesMovementType);
			previousVersion_lazy = () -> TransactionDetails61.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionDetails70 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionDetails70 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionDetails70, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmPayment);
			previousVersion_lazy = () -> TransactionDetails61.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionDetails70 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionDetails70 obj, DeliveryReceiptType2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, SettlementDetails69> mmSettlementParameters = new MMMessageAssociationEnd<TransactionDetails70, SettlementDetails69>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSettlementParameters);
			previousVersion_lazy = () -> TransactionDetails61.mmSettlementParameters;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SettlementDetails69.mmObject();
		}

		@Override
		public SettlementDetails69 getValue(TransactionDetails70 obj) {
			return obj.getSettlementParameters();
		}

		@Override
		public void setValue(TransactionDetails70 obj, SettlementDetails69 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<SettlementParties13>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails70, Optional<SettlementParties13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmReceivingSettlementParties);
			previousVersion_lazy = () -> TransactionDetails61.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties13> getValue(TransactionDetails70 obj) {
			return obj.getReceivingSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<SettlementParties13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<SettlementParties13>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails70, Optional<SettlementParties13>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> TransactionDetails61.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties13.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification37Choice>> mmInvestor = new MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification37Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmInvestor);
			previousVersion_lazy = () -> TransactionDetails61.mmInvestor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification37Choice> getValue(TransactionDetails70 obj) {
			return obj.getInvestor();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<PartyIdentification37Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification45Choice>> mmQualifiedForeignIntermediary = new MMMessageAssociationEnd<TransactionDetails70, Optional<PartyIdentification45Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmQualifiedForeignIntermediary);
			previousVersion_lazy = () -> TransactionDetails61.mmQualifiedForeignIntermediary;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification45Choice> getValue(TransactionDetails70 obj) {
			return obj.getQualifiedForeignIntermediary();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<PartyIdentification45Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails70, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<TransactionDetails70, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails70.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> TransactionDetails61.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransactionDetails70 obj) {
			return obj.getSettlementInstructionProcessingAdditionalDetails();
		}

		@Override
		public void setValue(TransactionDetails70 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails70.mmTradeIdentification, com.tools20022.repository.msg.TransactionDetails70.mmPoolIdentification,
						com.tools20022.repository.msg.TransactionDetails70.mmCorporateActionEventIdentification, com.tools20022.repository.msg.TransactionDetails70.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails70.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.TransactionDetails70.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.TransactionDetails70.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.TransactionDetails70.mmAccountOwner,
						com.tools20022.repository.msg.TransactionDetails70.mmSafekeepingAccount, com.tools20022.repository.msg.TransactionDetails70.mmSafekeepingPlace, com.tools20022.repository.msg.TransactionDetails70.mmPlaceOfTrade,
						com.tools20022.repository.msg.TransactionDetails70.mmPlaceOfClearing, com.tools20022.repository.msg.TransactionDetails70.mmFinancialInstrumentIdentification,
						com.tools20022.repository.msg.TransactionDetails70.mmSettlementQuantity, com.tools20022.repository.msg.TransactionDetails70.mmSettlementAmount, com.tools20022.repository.msg.TransactionDetails70.mmLateDeliveryDate,
						com.tools20022.repository.msg.TransactionDetails70.mmExpectedSettlementDate, com.tools20022.repository.msg.TransactionDetails70.mmExpectedValueDate,
						com.tools20022.repository.msg.TransactionDetails70.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails70.mmTradeDate, com.tools20022.repository.msg.TransactionDetails70.mmSecuritiesMovementType,
						com.tools20022.repository.msg.TransactionDetails70.mmPayment, com.tools20022.repository.msg.TransactionDetails70.mmSettlementParameters,
						com.tools20022.repository.msg.TransactionDetails70.mmReceivingSettlementParties, com.tools20022.repository.msg.TransactionDetails70.mmDeliveringSettlementParties,
						com.tools20022.repository.msg.TransactionDetails70.mmInvestor, com.tools20022.repository.msg.TransactionDetails70.mmQualifiedForeignIntermediary,
						com.tools20022.repository.msg.TransactionDetails70.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionStatusAdviceV06.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCountryCodeRule.forTransactionDetails70,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionDetails70, com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forTransactionDetails70,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forTransactionDetails70, com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing1Rule.forTransactionDetails70,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing2Rule.forTransactionDetails70);
				...
				name = "TransactionDetails70";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails79.mmObject());
				previousVersion_lazy = () -> TransactionDetails61.mmObject();
			}
		});
	...
	public TransactionDetails70 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public TransactionDetails70 setPoolIdentification(Max35Text poolIdentification) {
	...
	public TransactionDetails70 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public TransactionDetails70 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public TransactionDetails70 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public TransactionDetails70 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public TransactionDetails70 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
	...
	public TransactionDetails70 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public TransactionDetails70 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public TransactionDetails70 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public TransactionDetails70 setPlaceOfTrade(MarketIdentification78 placeOfTrade) {
	...
	public TransactionDetails70 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public TransactionDetails70 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public TransactionDetails70 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public TransactionDetails70 setSettlementAmount(AmountAndDirection8 settlementAmount) {
	...
	public TransactionDetails70 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public TransactionDetails70 setExpectedSettlementDate(DateAndDateTimeChoice expectedSettlementDate) {
	...
	public TransactionDetails70 setExpectedValueDate(DateAndDateTimeChoice expectedValueDate) {
	...
	public TransactionDetails70 setSettlementDate(SettlementDate2Choice settlementDate) {
	...
	public TransactionDetails70 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public TransactionDetails70 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionDetails70 setPayment(DeliveryReceiptType2Code payment) {
	...
	public TransactionDetails70 setSettlementParameters(SettlementDetails69 settlementParameters) {
	...
	public TransactionDetails70 setReceivingSettlementParties(SettlementParties13 receivingSettlementParties) {
	...
	public TransactionDetails70 setDeliveringSettlementParties(SettlementParties13 deliveringSettlementParties) {
	...
	public TransactionDetails70 setInvestor(PartyIdentification37Choice investor) {
	...
	public TransactionDetails70 setQualifiedForeignIntermediary(PartyIdentification45Choice qualifiedForeignIntermediary) {
	...
	public TransactionDetails70 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
