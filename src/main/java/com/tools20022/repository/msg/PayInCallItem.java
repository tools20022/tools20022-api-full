...
@XmlType(name = "PayInCallItem", propOrder = "amount")
public class PayInCallItem {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PayInCallItem PayInCallItem}</li>
	...
	public static final MMMessageAttribute<PayInCallItem, ActiveOrHistoricCurrencyAndAmount> mmAmount = new MMMessageAttribute<PayInCallItem, ActiveOrHistoricCurrencyAndAmount>() {
		{
			...
			name = "Amount";
			definition = "Specifies the currency and amount of the called item.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PayInCallItem.mmAmount);
	...
	public PayInCallItem setAmount(ActiveOrHistoricCurrencyAndAmount amount) {
