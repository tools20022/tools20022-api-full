...
import com.tools20022.repository.msg.MarketIdentification10;
...
public class PriceInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceInformation7, TypeOfPrice7Choice> mmType = new MMMessageAssociationEnd<PriceInformation7, TypeOfPrice7Choice>() {
		{
		...
		@Override
		public TypeOfPrice7Choice getValue(PriceInformation7 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(PriceInformation7 obj, TypeOfPrice7Choice value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceInformation7, PriceRateOrAmountOrUnknown1Choice> mmValue = new MMMessageAssociationEnd<PriceInformation7, PriceRateOrAmountOrUnknown1Choice>() {
		{
		...
		@Override
		public PriceRateOrAmountOrUnknown1Choice getValue(PriceInformation7 obj) {
			return obj.getValue();
		}

		@Override
		public void setValue(PriceInformation7 obj, PriceRateOrAmountOrUnknown1Choice value) {
			obj.setValue(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceInformation7, YieldedOrValueType1Choice> mmValueType = new MMMessageAssociationEnd<PriceInformation7, YieldedOrValueType1Choice>() {
		{
		...
		@Override
		public YieldedOrValueType1Choice getValue(PriceInformation7 obj) {
			return obj.getValueType();
		}

		@Override
		public void setValue(PriceInformation7 obj, YieldedOrValueType1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceInformation7, Optional<MarketIdentification10>> mmSourceOfPrice = new MMMessageAssociationEnd<PriceInformation7, Optional<MarketIdentification10>>() {
		{
		...
		@Override
		public Optional<MarketIdentification10> getValue(PriceInformation7 obj) {
			return obj.getSourceOfPrice();
		}

		@Override
		public void setValue(PriceInformation7 obj, Optional<MarketIdentification10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceInformation7, Optional<DateAndDateTimeChoice>> mmQuotationDate = new MMMessageAssociationEnd<PriceInformation7, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(PriceInformation7 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(PriceInformation7 obj, Optional<DateAndDateTimeChoice> value) {
	...
	public PriceInformation7 setSourceOfPrice(MarketIdentification10 sourceOfPrice) {
