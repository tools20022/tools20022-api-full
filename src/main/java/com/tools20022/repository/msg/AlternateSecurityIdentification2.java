...
public class AlternateSecurityIdentification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AlternateSecurityIdentification2.Type, com.tools20022.repository.msg.AlternateSecurityIdentification2.Identification);
