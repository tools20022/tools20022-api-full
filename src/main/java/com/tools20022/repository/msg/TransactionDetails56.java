...
public class TransactionDetails56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails56.mmTransactionActivity, TransactionDetails56.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails56.mmSecuritiesMovementType,
						TransactionDetails56.mmPayment, TransactionDetails56.mmSettlementParameters, TransactionDetails56.mmPlaceOfTrade, TransactionDetails56.mmSafekeepingPlace, TransactionDetails56.mmPlaceOfClearing,
						TransactionDetails56.mmFinancialInstrumentIdentification, TransactionDetails56.mmPostingQuantity, TransactionDetails56.mmPostingAmount, TransactionDetails56.mmTradeDate,
						TransactionDetails56.mmExpectedSettlementDate, TransactionDetails56.mmSettlementDate, TransactionDetails56.mmLateDeliveryDate, TransactionDetails56.mmExpectedValueDate,
						TransactionDetails56.mmDeliveringSettlementParties, TransactionDetails56.mmReceivingSettlementParties, TransactionDetails56.mmTransactionAdditionalDetails, TransactionDetails56.mmSupplementaryData);
