 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails56#Payment
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails56#TradeDate
...
public class TransactionDetails56 {
	...
	public static final MMMessageAssociationEnd TransactionActivity = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> TransactionDetails56.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.TransactionActivity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementTransactionOrCorporateActionEventType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SettlementTransactionOrCorporateActionEventType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SecuritiesMovementType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Payment = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.Payment);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementParameters = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SettlementParameters);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PlaceOfTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.PlaceOfTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SafekeepingPlace);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PlaceOfClearing = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.PlaceOfClearing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.FinancialInstrumentIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PostingQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.PostingQuantity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PostingAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.PostingAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TradeDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.TradeDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ExpectedSettlementDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.ExpectedSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementDate = new MMMessageAssociationEnd() {
		{
			...
			name = "SettlementDate";
			definition = "Date and time at which the securities are to be delivered or received.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SettlementDate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LateDeliveryDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.LateDeliveryDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ExpectedValueDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.ExpectedValueDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DeliveringSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.DeliveringSettlementParties);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReceivingSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.ReceivingSettlementParties);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> SettlementParties13.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute TransactionAdditionalDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.TransactionAdditionalDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SupplementaryData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.SupplementaryData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails56.TransactionActivity, com.tools20022.repository.msg.TransactionDetails56.SettlementTransactionOrCorporateActionEventType,
						com.tools20022.repository.msg.TransactionDetails56.SecuritiesMovementType, com.tools20022.repository.msg.TransactionDetails56.Payment, com.tools20022.repository.msg.TransactionDetails56.SettlementParameters,
						com.tools20022.repository.msg.TransactionDetails56.PlaceOfTrade, com.tools20022.repository.msg.TransactionDetails56.SafekeepingPlace, com.tools20022.repository.msg.TransactionDetails56.PlaceOfClearing,
						com.tools20022.repository.msg.TransactionDetails56.FinancialInstrumentIdentification, com.tools20022.repository.msg.TransactionDetails56.PostingQuantity,
						com.tools20022.repository.msg.TransactionDetails56.PostingAmount, com.tools20022.repository.msg.TransactionDetails56.TradeDate, com.tools20022.repository.msg.TransactionDetails56.ExpectedSettlementDate,
						com.tools20022.repository.msg.TransactionDetails56.SettlementDate, com.tools20022.repository.msg.TransactionDetails56.LateDeliveryDate, com.tools20022.repository.msg.TransactionDetails56.ExpectedValueDate,
						...
						com.tools20022.repository.msg.TransactionDetails56.TransactionAdditionalDetails, com.tools20022.repository.msg.TransactionDetails56.SupplementaryData);
