...
@XmlType(name = "TransportByRail1", propOrder = {"placeOfReceipt", "placeOfDelivery"})
public class TransportByRail1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TransportByRail1
	 * TransportByRail1}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRail1.mmPlaceOfReceipt, com.tools20022.repository.msg.TransportByRail1.mmPlaceOfDelivery);
				trace_lazy = () -> TransportByRail.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TransportByRail1";
	...
	public TransportByRail1 setPlaceOfReceipt(List<Max35Text> placeOfReceipt) {
	...
	public TransportByRail1 setPlaceOfDelivery(List<Max35Text> placeOfDelivery) {
