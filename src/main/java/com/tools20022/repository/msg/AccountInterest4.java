 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.AccountInterest3 AccountInterest3}</li>
 * </ul>
 */
...
public class AccountInterest4 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountInterest3#mmType
	...
	public static final MMMessageAssociationEnd mmType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountInterest3.mmType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	protected List<com.tools20022.repository.msg.Rate4> rate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountInterest3#mmRate
	...
	public static final MMMessageAssociationEnd mmRate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountInterest3.mmRate;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmFromToDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountInterest3.mmFromToDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountInterest3#mmReason
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountInterest3.mmReason;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountInterest3#mmTax
	...
	public static final MMMessageAttribute mmTax = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountInterest3.mmTax;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> AccountInterest3.mmObject();
			}
		});
	...
	public AccountInterest4 setRate(List<com.tools20022.repository.msg.Rate4> rate) {
	...
	public AccountInterest4 setFromToDate(com.tools20022.repository.msg.DateTimePeriod1 fromToDate) {
	...
	public AccountInterest4 setTax(com.tools20022.repository.msg.TaxCharges2 tax) {
		this.tax = tax;
		return this;
	}
}