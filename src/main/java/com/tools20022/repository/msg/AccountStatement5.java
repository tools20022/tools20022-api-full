 ...
 * <li>{@linkplain com.tools20022.repository.msg.AccountStatement5#mmFromToDate
 ...
 * <li>{@linkplain com.tools20022.repository.msg.AccountStatement5#mmAccount
 ...
 * <li>{@linkplain com.tools20022.repository.msg.AccountStatement5#mmInterest
...
@XmlType(name = "AccountStatement5", propOrder = {"identification", "statementPagination", "electronicSequenceNumber", "legalSequenceNumber", "creationDateTime", "fromToDate", "copyDuplicateIndicator", "reportingSource", "account",
...
public class AccountStatement5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Max35Text> mmIdentification = new MMMessageAttribute<AccountStatement5, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmIdentification);
			previousVersion_lazy = () -> AccountStatement4.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(AccountStatement5 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(AccountStatement5 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Optional<Pagination>> mmStatementPagination = new MMMessageAttribute<AccountStatement5, Optional<Pagination>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "StmtPgntn";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmStatementPagination);
			previousVersion_lazy = () -> AccountStatement4.mmStatementPagination;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Pagination> getValue(AccountStatement5 obj) {
			return obj.getStatementPagination();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<Pagination> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Optional<Number>> mmElectronicSequenceNumber = new MMMessageAttribute<AccountStatement5, Optional<Number>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "ElctrncSeqNb";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmElectronicSequenceNumber);
			previousVersion_lazy = () -> AccountStatement4.mmElectronicSequenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number> getValue(AccountStatement5 obj) {
			return obj.getElectronicSequenceNumber();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Optional<Number>> mmLegalSequenceNumber = new MMMessageAttribute<AccountStatement5, Optional<Number>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "LglSeqNb";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmLegalSequenceNumber);
			previousVersion_lazy = () -> AccountStatement4.mmLegalSequenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Number.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, ISODateTime> mmCreationDateTime = new MMMessageAttribute<AccountStatement5, ISODateTime>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "CreDtTm";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmCreationDateTime);
			previousVersion_lazy = () -> AccountStatement4.mmCreationDateTime;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODateTime getValue(AccountStatement5 obj) {
			return obj.getCreationDateTime();
		}

		@Override
		public void setValue(AccountStatement5 obj, ISODateTime value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountStatement6#mmFromToDate
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement4#mmFromToDate
	 * AccountStatement4.mmFromToDate}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, Optional<DateTimePeriodDetails>> mmFromToDate = new MMMessageAssociationEnd<AccountStatement5, Optional<DateTimePeriodDetails>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "FrToDt";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmFromToDate);
			previousVersion_lazy = () -> AccountStatement4.mmFromToDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateTimePeriodDetails> getValue(AccountStatement5 obj) {
			return obj.getFromToDate();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<DateTimePeriodDetails> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Optional<CopyDuplicate1Code>> mmCopyDuplicateIndicator = new MMMessageAttribute<AccountStatement5, Optional<CopyDuplicate1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "CpyDplctInd";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmCopyDuplicateIndicator);
			previousVersion_lazy = () -> AccountStatement4.mmCopyDuplicateIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CopyDuplicate1Code> getValue(AccountStatement5 obj) {
			return obj.getCopyDuplicateIndicator();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<CopyDuplicate1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, Optional<ReportingSource1Choice>> mmReportingSource = new MMMessageAssociationEnd<AccountStatement5, Optional<ReportingSource1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "RptgSrc";
			...
			definition = "Specifies the application used to generate the reporting.";
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmReportingSource);
			previousVersion_lazy = () -> AccountStatement4.mmReportingSource;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ReportingSource1Choice> getValue(AccountStatement5 obj) {
			return obj.getReportingSource();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<ReportingSource1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, CashAccount25> mmAccount = new MMMessageAssociationEnd<AccountStatement5, CashAccount25>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmAccount);
			previousVersion_lazy = () -> AccountStatement4.mmAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CashAccount25 getValue(AccountStatement5 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(AccountStatement5 obj, CashAccount25 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, Optional<CashAccount24>> mmRelatedAccount = new MMMessageAssociationEnd<AccountStatement5, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmRelatedAccount);
			previousVersion_lazy = () -> AccountStatement4.mmRelatedAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccount24> getValue(AccountStatement5 obj) {
			return obj.getRelatedAccount();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, List<AccountInterest3>> mmInterest = new MMMessageAssociationEnd<AccountStatement5, List<AccountInterest3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmInterest);
			previousVersion_lazy = () -> AccountStatement4.mmInterest;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<AccountInterest3> getValue(AccountStatement5 obj) {
			return obj.getInterest();
		}

		@Override
		public void setValue(AccountStatement5 obj, List<AccountInterest3> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountStatement6#mmBalance
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement4#mmBalance
	 * AccountStatement4.mmBalance}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, List<CashBalance3>> mmBalance = new MMMessageAssociationEnd<AccountStatement5, List<CashBalance3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmBalance);
			previousVersion_lazy = () -> AccountStatement4.mmBalance;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<CashBalance3> getValue(AccountStatement5 obj) {
			return obj.getBalance();
		}

		@Override
		public void setValue(AccountStatement5 obj, List<CashBalance3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, Optional<TotalTransactions4>> mmTransactionsSummary = new MMMessageAssociationEnd<AccountStatement5, Optional<TotalTransactions4>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "TxsSummry";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmTransactionsSummary);
			previousVersion_lazy = () -> AccountStatement4.mmTransactionsSummary;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TotalTransactions4> getValue(AccountStatement5 obj) {
			return obj.getTransactionsSummary();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<TotalTransactions4> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountStatement4#mmEntry
	 * AccountStatement4.mmEntry}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountStatement5, List<ReportEntry7>> mmEntry = new MMMessageAssociationEnd<AccountStatement5, List<ReportEntry7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmEntry);
			previousVersion_lazy = () -> AccountStatement4.mmEntry;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<ReportEntry7> getValue(AccountStatement5 obj) {
			return obj.getEntry();
		}

		@Override
		public void setValue(AccountStatement5 obj, List<ReportEntry7> value) {
			obj.setEntry(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountStatement5, Optional<Max500Text>> mmAdditionalStatementInformation = new MMMessageAttribute<AccountStatement5, Optional<Max500Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountStatement5.mmObject();
			isDerived = false;
			xmlTag = "AddtlStmtInf";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmAdditionalStatementInformation);
			previousVersion_lazy = () -> AccountStatement4.mmAdditionalStatementInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max500Text> getValue(AccountStatement5 obj) {
			return obj.getAdditionalStatementInformation();
		}

		@Override
		public void setValue(AccountStatement5 obj, Optional<Max500Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountStatement5.mmIdentification, com.tools20022.repository.msg.AccountStatement5.mmStatementPagination,
						com.tools20022.repository.msg.AccountStatement5.mmElectronicSequenceNumber, com.tools20022.repository.msg.AccountStatement5.mmLegalSequenceNumber, com.tools20022.repository.msg.AccountStatement5.mmCreationDateTime,
						com.tools20022.repository.msg.AccountStatement5.mmFromToDate, com.tools20022.repository.msg.AccountStatement5.mmCopyDuplicateIndicator, com.tools20022.repository.msg.AccountStatement5.mmReportingSource,
						com.tools20022.repository.msg.AccountStatement5.mmAccount, com.tools20022.repository.msg.AccountStatement5.mmRelatedAccount, com.tools20022.repository.msg.AccountStatement5.mmInterest,
						com.tools20022.repository.msg.AccountStatement5.mmBalance, com.tools20022.repository.msg.AccountStatement5.mmTransactionsSummary, com.tools20022.repository.msg.AccountStatement5.mmEntry,
						com.tools20022.repository.msg.AccountStatement5.mmAdditionalStatementInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(BankToCustomerStatementV05.mmStatement);
				trace_lazy = () -> CashBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountStatement5";
				definition = "Provides further details of the account statement.";
				nextVersions_lazy = () -> Arrays.asList(AccountStatement6.mmObject());
				previousVersion_lazy = () -> AccountStatement4.mmObject();
			}
		});
	...
	public AccountStatement5 setIdentification(Max35Text identification) {
	...
	public AccountStatement5 setStatementPagination(Pagination statementPagination) {
	...
	public AccountStatement5 setElectronicSequenceNumber(Number electronicSequenceNumber) {
	...
	public AccountStatement5 setLegalSequenceNumber(Number legalSequenceNumber) {
	...
	public AccountStatement5 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public AccountStatement5 setFromToDate(DateTimePeriodDetails fromToDate) {
	...
	public AccountStatement5 setCopyDuplicateIndicator(CopyDuplicate1Code copyDuplicateIndicator) {
	...
	public AccountStatement5 setReportingSource(ReportingSource1Choice reportingSource) {
	...
	public AccountStatement5 setAccount(CashAccount25 account) {
	...
	public AccountStatement5 setRelatedAccount(CashAccount24 relatedAccount) {
	...
	public AccountStatement5 setInterest(List<AccountInterest3> interest) {
	...
	public AccountStatement5 setBalance(List<CashBalance3> balance) {
	...
	public AccountStatement5 setTransactionsSummary(TotalTransactions4 transactionsSummary) {
	...
	public AccountStatement5 setEntry(List<ReportEntry7> entry) {
	...
	public AccountStatement5 setAdditionalStatementInformation(Max500Text additionalStatementInformation) {
