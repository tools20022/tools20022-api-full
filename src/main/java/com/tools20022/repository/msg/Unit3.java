...
public class Unit3 {
	...
	public static final MMMessageAttribute mmUnitsNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit6.mmUnitsNumber);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAcquisitionDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit6.mmAcquisitionDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCertificateNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit6.mmCertificateNumber);
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmGroup1Or2Units = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit6.mmGroup1Or2Units);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit6.mmPriceDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public void setPriceDetails(com.tools20022.repository.msg.UnitPrice12 priceDetails) {
