...
public class CorporateActionGeneralInformation26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation26.mmCorporateActionEventIdentification, CorporateActionGeneralInformation26.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation26.mmEventType, CorporateActionGeneralInformation26.mmUnderlyingSecurityIdentification);
