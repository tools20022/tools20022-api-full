...
public class TransactionDetails72 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails72.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails72.mmTransactionActivity, TransactionDetails72.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails72.mmSecuritiesMovementType,
						TransactionDetails72.mmPayment, TransactionDetails72.mmSettlementParameters, TransactionDetails72.mmPlaceOfTrade, TransactionDetails72.mmSafekeepingPlace, TransactionDetails72.mmPlaceOfClearing,
						TransactionDetails72.mmFinancialInstrumentIdentification, TransactionDetails72.mmPostingQuantity, TransactionDetails72.mmPostingAmount, TransactionDetails72.mmTradeDate,
						TransactionDetails72.mmExpectedSettlementDate, TransactionDetails72.mmSettlementDate, TransactionDetails72.mmLateDeliveryDate, TransactionDetails72.mmExpectedValueDate,
						TransactionDetails72.mmDeliveringSettlementParties, TransactionDetails72.mmReceivingSettlementParties, TransactionDetails72.mmTransactionAdditionalDetails, TransactionDetails72.mmSupplementaryData);
	...
	public SettlementOrCorporateActionEvent11Choice getSettlementTransactionOrCorporateActionEventType() {
		return settlementTransactionOrCorporateActionEventType;
	}

	public void setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent11Choice settlementTransactionOrCorporateActionEventType) {
	...
	public SettlementDetails86 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails86 settlementParameters) {
