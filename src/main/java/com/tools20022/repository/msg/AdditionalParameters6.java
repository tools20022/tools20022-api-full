 ...
 * AdditionalParameters6.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters6#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters6.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters6
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline#forAdditionalParameters6
 * ConstraintPartialSettlementGuideline.forAdditionalParameters6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters6", propOrder = {"preConfirmation", "partialSettlement", "previousPartialConfirmationIdentification", "tripartyAgentCollateralTransactionIdentification",
...
public class AdditionalParameters6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters6, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters6, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters6.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters6 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters6 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters6, Optional<PartialSettlement1Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters6, Optional<PartialSettlement1Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement1Code> getValue(AdditionalParameters6 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters6 obj, Optional<PartialSettlement1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters6 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters6 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters6, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters6.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters6.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters6.mmPreviousPartialConfirmationIdentification, com.tools20022.repository.msg.AdditionalParameters6.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters6.mmClientTripartyCollateralTransactionIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters6,
						com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline.forAdditionalParameters6);
	...
	public AdditionalParameters6 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters6 setPartialSettlement(PartialSettlement1Code partialSettlement) {
	...
	public AdditionalParameters6 setPreviousPartialConfirmationIdentification(RestrictedFINXMax16Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters6 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters6 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
