...
public class CorporateActionPrice32 {
	...
	public static final MMMessageAssociationEnd mmIndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice32.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice32.mmIndicativeOrMarketPrice, CorporateActionPrice32.mmCashInLieuOfSharePrice, CorporateActionPrice32.mmCashValueForTax,
						CorporateActionPrice32.mmGenericCashPricePaidPerProduct, CorporateActionPrice32.mmGenericCashPriceReceivedPerProduct);
