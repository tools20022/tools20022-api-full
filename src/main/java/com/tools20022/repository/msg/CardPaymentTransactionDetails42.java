...
public class CardPaymentTransactionDetails42 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails42, ActiveCurrencyCode> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails42, ActiveCurrencyCode>() {
		{
		...
		@Override
		public ActiveCurrencyCode getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, ActiveCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails42, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails42, ImpliedCurrencyAndAmount>() {
		{
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails42, Optional<DetailedAmount15>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails42, Optional<DetailedAmount15>>() {
		{
		...
		@Override
		public Optional<DetailedAmount15> getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, Optional<DetailedAmount15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails42, Optional<DetailedAmount4>> mmInvoiceAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails42, Optional<DetailedAmount4>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails42.mmObject();
			isDerived = false;
			xmlTag = "InvcAmt";
		...
		@Override
		public Optional<DetailedAmount4> getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getInvoiceAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, Optional<DetailedAmount4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails42, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails42, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails42, Optional<CardAccountType3Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails42, Optional<CardAccountType3Code>>() {
		{
		...
		@Override
		public Optional<CardAccountType3Code> getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, Optional<CardAccountType3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails42, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails42, Optional<Max10000Binary>>() {
		{
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails42 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails42 obj, Optional<Max10000Binary> value) {
	...
	public CardPaymentTransactionDetails42 setDetailedAmount(DetailedAmount15 detailedAmount) {
	...
	public CardPaymentTransactionDetails42 setInvoiceAmount(DetailedAmount4 invoiceAmount) {
