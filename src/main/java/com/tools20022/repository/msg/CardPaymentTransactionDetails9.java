...
public class CardPaymentTransactionDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails9.mmCurrency, CardPaymentTransactionDetails9.mmTotalAmount, CardPaymentTransactionDetails9.mmValidityDate,
						CardPaymentTransactionDetails9.mmICCRelatedData);
