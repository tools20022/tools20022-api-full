	...
	public static final MMMessageAttribute mmBalance = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> HoldingBalance6.mmBalance;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmBalanceType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> HoldingBalance6.mmBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSafekeepingPlace = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> HoldingBalance6.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> HoldingBalance6.mmDate;
			maxOccurs = 1;
			minOccurs = 0;
