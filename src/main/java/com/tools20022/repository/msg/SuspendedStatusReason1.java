...
import com.tools20022.repository.codeset.SuspendedStatusReason2Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherCodeRule#forSuspendedStatusReason1
 * ConstraintOtherCodeRule.forSuspendedStatusReason1}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SuspendedStatusReason1", propOrder = {"structured", "additionalInformation"})
public class SuspendedStatusReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Strd", required = true)
	protected List<SuspendedStatusReason2Code> structured;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<SuspendedStatusReason1, List<SuspendedStatusReason2Code>> mmStructured = new MMMessageAttribute<SuspendedStatusReason1, List<SuspendedStatusReason2Code>>() {
		{
			...
			name = "Structured";
			definition = "Reason for a suspended status in structured form.";
			maxOccurs = 3;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<SuspendedStatusReason1, Optional<Max350Text>> mmAdditionalInformation = new MMMessageAttribute<SuspendedStatusReason1, Optional<Max350Text>>() {
		{
			...
			definition = "Reason for a suspended status in free format text.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SuspendedStatusReason1.mmStructured, com.tools20022.repository.msg.SuspendedStatusReason1.mmAdditionalInformation);
				trace_lazy = () -> SecuritiesOrderStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOtherCodeRule.forSuspendedStatusReason1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SuspendedStatusReason1";
	...
	public List<SuspendedStatusReason2Code> getStructured() {
		return structured == null ? structured = new ArrayList<>() : structured;
	}

	public SuspendedStatusReason1 setStructured(List<SuspendedStatusReason2Code> structured) {
	...
	public SuspendedStatusReason1 setAdditionalInformation(Max350Text additionalInformation) {
