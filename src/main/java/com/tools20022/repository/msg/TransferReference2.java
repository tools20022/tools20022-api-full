...
public class TransferReference2 {
	...
	public static final MMMessageAttribute MasterReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference6.MasterReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransferReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference6.TransferReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute ClientReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference6.ClientReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute TransferConfirmationReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference6.TransferConfirmationReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferReference2.MasterReference, com.tools20022.repository.msg.TransferReference2.TransferReference,
						com.tools20022.repository.msg.TransferReference2.ClientReference, com.tools20022.repository.msg.TransferReference2.TransferConfirmationReference);
				trace_lazy = () -> InvestmentFundOrder.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV02.ReversalByReference,
						com.tools20022.repository.area.sese.ReversalOfTransferInConfirmationV03.ReversalByReference, com.tools20022.repository.area.sese.ReversalOfTransferOutConfirmationV02.ReversalByReference,
						com.tools20022.repository.area.sese.ReversalOfTransferOutConfirmationV03.ReversalByReference);
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "TransferReference2";
				definition = "Reference of a transfer and of a transfer confirmation.";
				nextVersions_lazy = () -> Arrays.asList(TransferReference6.mmObject());
			}
		});
