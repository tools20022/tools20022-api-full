...
public class TransferReference2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference2, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<TransferReference2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference6.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(TransferReference2 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(TransferReference2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference2, Optional<Max35Text>> mmTransferReference = new MMMessageAttribute<TransferReference2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference6.mmTransferReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference2, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<TransferReference2, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference6.mmClientReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransferReference2, Optional<Max35Text>> mmTransferConfirmationReference = new MMMessageAttribute<TransferReference2, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransferReference2.mmObject();
			isDerived = false;
			xmlTag = "TrfConfRef";
			...
			nextVersions_lazy = () -> Arrays.asList(TransferReference6.mmTransferConfirmationReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
