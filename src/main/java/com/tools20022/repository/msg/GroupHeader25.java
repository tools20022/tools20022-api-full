...
public class GroupHeader25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader25.mmMessageIdentification, GroupHeader25.mmCreationDateTime, GroupHeader25.mmNumberOfTransactions, GroupHeader25.mmTotalInterbankSettlementAmount,
						GroupHeader25.mmInterbankSettlementDate, GroupHeader25.mmSettlementInformation, GroupHeader25.mmPaymentTypeInformation, GroupHeader25.mmInstructingAgent, GroupHeader25.mmInstructedAgent);
