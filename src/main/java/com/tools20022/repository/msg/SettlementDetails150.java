...
@XmlType(name = "SettlementDetails150", propOrder = {"settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "registration", "beneficialOwnership", "cashClearingSystem", "taxCapacity", "repurchaseType",
...
public class SettlementDetails150 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails150, List<SettlementTransactionCondition16Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails150.mmObject();
			isDerived = false;
			xmlTag = "SttlmTxCond";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementTransactionCondition";
			definition = "Conditions under which the order/trade is to be settled.";
			previousVersion_lazy = () -> SettlementDetails126.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails150 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails150 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails150, Optional<SettlingCapacity7Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails150 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails150, Optional<GenericIdentification30>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails150 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails150, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails150 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails150, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			previousVersion_lazy = () -> SettlementDetails126.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails150 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails150, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails150 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails150, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails150 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails150, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails150 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<RepurchaseType22Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails150, Optional<RepurchaseType22Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType22Choice> getValue(SettlementDetails150 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<RepurchaseType22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<MarketClientSide6Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails150, Optional<MarketClientSide6Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide6Choice> getValue(SettlementDetails150 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<MarketClientSide6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails150, Optional<BlockTrade4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails150 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails150, Optional<Restriction5Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails150 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails150, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails150 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails150, Optional<NettingEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails150 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails150, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails150 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails150, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails150, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails126.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails150 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails150, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails150, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails150.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementDetails126.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails150 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails150 obj, Optional<SettlementTransactionCondition5Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails150.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails150.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails150.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails150.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails150.mmRegistration,
						com.tools20022.repository.msg.SettlementDetails150.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails150.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails150.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails150.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails150.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails150.mmBlockTrade,
						com.tools20022.repository.msg.SettlementDetails150.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails150.mmSettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails150.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails150.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails150.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails150.mmPartialSettlementIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails150,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails150);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails150";
				definition = "Details of settlement of a transaction.";
				previousVersion_lazy = () -> SettlementDetails126.mmObject();
			}
		});
	...
	public SettlementDetails150 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails150 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails150 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails150 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails150 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails150 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails150 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails150 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails150 setRepurchaseType(RepurchaseType22Choice repurchaseType) {
	...
	public SettlementDetails150 setMarketClientSide(MarketClientSide6Choice marketClientSide) {
	...
	public SettlementDetails150 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails150 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails150 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails150 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails150 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails150 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails150 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
