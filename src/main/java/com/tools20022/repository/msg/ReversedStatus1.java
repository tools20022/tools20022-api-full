...
public class ReversedStatus1 {
	...
	public static final MMXor mmReasonOrDataSourceSchemeOrNoSpecifiedReasonRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(ReversedStatus1.mmReason, ReversedStatus1.mmDataSourceScheme, ReversedStatus1.mmNoSpecifiedReason);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReversedStatus1.mmReason, ReversedStatus1.mmDataSourceScheme, ReversedStatus1.mmNoSpecifiedReason);
				...
				xors_lazy = () -> Arrays.asList(ReversedStatus1.mmReasonOrDataSourceSchemeOrNoSpecifiedReasonRule);
			}
		});
