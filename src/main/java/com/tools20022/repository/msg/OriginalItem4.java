...
public class OriginalItem4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalItem4, Max35Text> mmOriginalItemIdentification = new MMMessageAttribute<OriginalItem4, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalItem4.mmObject();
			isDerived = false;
			xmlTag = "OrgnlItmId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "OriginalItemIdentification";
			definition = "Identification of the original notification item.";
			nextVersions_lazy = () -> Arrays.asList(OriginalItem5.mmOriginalItemIdentification);
			previousVersion_lazy = () -> OriginalItem3.mmOriginalItemIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(OriginalItem4 obj) {
			return obj.getOriginalItemIdentification();
		}

		@Override
		public void setValue(OriginalItem4 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalItem4, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<OriginalItem4, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalItem5.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> OriginalItem3.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(OriginalItem4 obj) {
			return obj.getOriginalEndToEndIdentification();
		}

		@Override
		public void setValue(OriginalItem4 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalItem4, ActiveOrHistoricCurrencyAndAmount> mmAmount = new MMMessageAttribute<OriginalItem4, ActiveOrHistoricCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalItem5.mmAmount);
			previousVersion_lazy = () -> OriginalItem3.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyAndAmount getValue(OriginalItem4 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(OriginalItem4 obj, ActiveOrHistoricCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalItem4, Optional<ISODate>> mmExpectedValueDate = new MMMessageAttribute<OriginalItem4, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalItem5.mmExpectedValueDate);
			previousVersion_lazy = () -> OriginalItem3.mmExpectedValueDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(OriginalItem4 obj) {
			return obj.getExpectedValueDate();
		}

		@Override
		public void setValue(OriginalItem4 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItem4, Optional<OriginalItemReference3>> mmOriginalItemReference = new MMMessageAssociationEnd<OriginalItem4, Optional<OriginalItemReference3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalItem5.mmOriginalItemReference);
			previousVersion_lazy = () -> OriginalItem3.mmOriginalItemReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalItemReference3> getValue(OriginalItem4 obj) {
			return obj.getOriginalItemReference();
		}

		@Override
		public void setValue(OriginalItem4 obj, Optional<OriginalItemReference3> value) {
	...
	public OriginalItem4 setOriginalItemIdentification(Max35Text originalItemIdentification) {
	...
	public OriginalItem4 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public OriginalItem4 setAmount(ActiveOrHistoricCurrencyAndAmount amount) {
	...
	public OriginalItem4 setExpectedValueDate(ISODate expectedValueDate) {
	...
	public OriginalItem4 setOriginalItemReference(OriginalItemReference3 originalItemReference) {
