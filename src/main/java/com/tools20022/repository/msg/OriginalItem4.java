...
public class OriginalItem4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalItem4.mmOriginalItemIdentification, OriginalItem4.mmOriginalEndToEndIdentification, OriginalItem4.mmAmount, OriginalItem4.mmExpectedValueDate,
						OriginalItem4.mmOriginalItemReference);
