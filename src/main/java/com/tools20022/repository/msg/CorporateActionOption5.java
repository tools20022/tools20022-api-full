...
public class CorporateActionOption5 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption5.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption5.mmOptionNumber, CorporateActionOption5.mmOptionType, CorporateActionOption5.mmFractionDisposition, CorporateActionOption5.mmChangeType,
						CorporateActionOption5.mmEligibleForCollateralIndicator, CorporateActionOption5.mmCurrencyToBuy, CorporateActionOption5.mmCurrencyToSell, CorporateActionOption5.mmCurrencyOption,
						CorporateActionOption5.mmSecurityIdentification, CorporateActionOption5.mmSecuritiesQuantity, CorporateActionOption5.mmExecutionRequestedDateTime, CorporateActionOption5.mmRateAndAmountDetails,
						CorporateActionOption5.mmPriceDetails, CorporateActionOption5.mmAdditionalInformation);
	...
	public FractionDispositionType2Choice getFractionDisposition() {
		return fractionDisposition;
	}

	public void setFractionDisposition(FractionDispositionType2Choice fractionDisposition) {
	...
	public CorporateActionPrice8 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice8 priceDetails) {
