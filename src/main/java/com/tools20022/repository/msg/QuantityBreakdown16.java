 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown16#LotNumber
 ...
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown16#LotPrice
...
public class QuantityBreakdown16 {
	...
	public static final MMMessageAssociationEnd LotNumber = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.LotNumber);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LotQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.LotQuantity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesSubBalanceType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.SecuritiesSubBalanceType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LotDateTime = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.LotDateTime);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LotPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.LotPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TypeOfPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown29.TypeOfPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown16.LotNumber, com.tools20022.repository.msg.QuantityBreakdown16.LotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown16.SecuritiesSubBalanceType, com.tools20022.repository.msg.QuantityBreakdown16.LotDateTime, com.tools20022.repository.msg.QuantityBreakdown16.LotPrice,
						com.tools20022.repository.msg.QuantityBreakdown16.TypeOfPrice);
