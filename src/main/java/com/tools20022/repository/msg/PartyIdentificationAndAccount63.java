...
public class PartyIdentificationAndAccount63 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount63.mmIdentification, PartyIdentificationAndAccount63.mmAlternateIdentification, PartyIdentificationAndAccount63.mmSafekeepingAccount,
						PartyIdentificationAndAccount63.mmProcessingDate, PartyIdentificationAndAccount63.mmProcessingIdentification, PartyIdentificationAndAccount63.mmAdditionalInformation);
