 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails82#Payment
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails82#TradeDate
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails82#Investor
...
public class TransactionDetails82 {
	...
	public static final MMMessageAttribute FinancialInstrumentIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.FinancialInstrumentIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.SecuritiesMovementType;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Payment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.Payment;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.SettlementQuantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.SafekeepingAccount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.SettlementAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.SettlementDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TradeDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.TradeDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DeliveringSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.DeliveringSettlementParties;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReceivingSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.ReceivingSettlementParties;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> SettlementParties40.mmObject();
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TransactionDetails40#Investor
	...
	public static final MMMessageAssociationEnd Investor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionDetails40.Investor;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails82.FinancialInstrumentIdentification, com.tools20022.repository.msg.TransactionDetails82.SecuritiesMovementType,
						com.tools20022.repository.msg.TransactionDetails82.Payment, com.tools20022.repository.msg.TransactionDetails82.SettlementQuantity, com.tools20022.repository.msg.TransactionDetails82.SafekeepingAccount,
						com.tools20022.repository.msg.TransactionDetails82.SettlementAmount, com.tools20022.repository.msg.TransactionDetails82.SettlementDate, com.tools20022.repository.msg.TransactionDetails82.TradeDate,
						...
						com.tools20022.repository.msg.TransactionDetails82.Investor);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementTransactionCounterpartyResponseV02.TransactionDetails);
