...
public class TransferOut1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferOut1.mmTransferDetails, TransferOut1.mmFinancialInstrumentDetails, TransferOut1.mmAccountDetails, TransferOut1.mmSettlementDetails, TransferOut1.mmExtension);
	...
	public void setTransferDetails(com.tools20022.repository.msg.Transfer2 transferDetails) {
	...
	public void setSettlementDetails(com.tools20022.repository.msg.ReceiveInformation2 settlementDetails) {
