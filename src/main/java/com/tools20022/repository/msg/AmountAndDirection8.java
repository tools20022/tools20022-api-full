 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection8#mmAmount
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndDirection8
 * ConstraintCoexistenceAmountRule.forAmountAndDirection8}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AmountAndDirection8", propOrder = {"amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount"})
public class AmountAndDirection8 {
	...
	public static final MMMessageAttribute<AmountAndDirection8, ActiveCurrencyAndAmount> mmAmount = new MMMessageAttribute<AmountAndDirection8, ActiveCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection51.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AmountAndDirection8, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection8, CreditDebitCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection51.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AmountAndDirection8, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection8, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection51.mmOriginalCurrencyAndOrderedAmount);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection8.mmAmount, com.tools20022.repository.msg.AmountAndDirection8.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection8.mmOriginalCurrencyAndOrderedAmount);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection8);
				...
				name = "AmountAndDirection8";
				definition = "Amount of money debited or credited on the books of an account servicer.";
				nextVersions_lazy = () -> Arrays.asList(AmountAndDirection51.mmObject());
			}
		});
	...
	public AmountAndDirection8 setAmount(ActiveCurrencyAndAmount amount) {
	...
	public AmountAndDirection8 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection8 setOriginalCurrencyAndOrderedAmount(ActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
