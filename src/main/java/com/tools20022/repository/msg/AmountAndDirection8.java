	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection8.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Amount of money in the cash entry.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.mmOriginalCurrencyAndOrderedAmount);
			maxOccurs = 1;
			minOccurs = 0;
