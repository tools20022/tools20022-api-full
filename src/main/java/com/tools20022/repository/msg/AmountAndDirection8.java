...
public class AmountAndDirection8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection8.mmAmount, AmountAndDirection8.mmCreditDebitIndicator, AmountAndDirection8.mmOriginalCurrencyAndOrderedAmount);
