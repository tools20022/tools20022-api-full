...
public class AmountAndDirection8 {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.CreditDebitIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalCurrencyAndOrderedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection51.OriginalCurrencyAndOrderedAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection8.Amount, com.tools20022.repository.msg.AmountAndDirection8.CreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection8.OriginalCurrencyAndOrderedAmount);
