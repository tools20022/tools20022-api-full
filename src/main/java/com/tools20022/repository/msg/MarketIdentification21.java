 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification21#mmType
...
@XmlType(name = "MarketIdentification21", propOrder = {"identification", "type"})
public class MarketIdentification21 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification85.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification85.mmType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification21.mmIdentification, com.tools20022.repository.msg.MarketIdentification21.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification21);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public MarketIdentification21 setIdentification(MarketIdentification1Choice identification) {
	...
	public MarketIdentification21 setType(MarketType9Choice type) {
