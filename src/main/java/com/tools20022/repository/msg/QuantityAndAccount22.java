...
public class QuantityAndAccount22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount22.mmSettlementQuantity, QuantityAndAccount22.mmDenominationChoice, QuantityAndAccount22.mmAccountOwner, QuantityAndAccount22.mmSafekeepingAccount,
						QuantityAndAccount22.mmCashAccount, QuantityAndAccount22.mmQuantityBreakdown, QuantityAndAccount22.mmSafekeepingPlace);
