	...
	public static final MMMessageAttribute mmSecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndAdditionalParameters14.mmObject();
			isDerived = false;
			xmlTag = "SctiesMvmntTp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SecuritiesMovementType";
			definition = "Specifies if the movement on a securities account results from a deliver or a receive instruction.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters5.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPayment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters5.mmPayment;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCommonIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters5.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters5.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmReconciliationIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters5.mmReconciliationIndicator;
			maxOccurs = 1;
			minOccurs = 0;
