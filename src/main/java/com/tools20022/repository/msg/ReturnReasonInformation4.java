...
public class ReturnReasonInformation4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReturnReasonInformation4.mmReturnOriginator, ReturnReasonInformation4.mmReturnReason);
	...
	public void setReturnReason(ReturnReason3Choice returnReason) {
