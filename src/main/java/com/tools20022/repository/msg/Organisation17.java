...
public class Organisation17 {
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmName;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPurpose = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmPurpose;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTaxationCountry = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmTaxationCountry;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRegistrationCountry = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmRegistrationCountry;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	...
	public static final MMMessageAttribute mmRegistrationDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmRegistrationDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTaxIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmTaxIdentificationNumber;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmNationalRegistrationNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmNationalRegistrationNumber;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmModifiedPostalAddress = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmModifiedPostalAddress;
			maxOccurs = 5;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPrimaryCommunicationAddress = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmPrimaryCommunicationAddress;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSecondaryCommunicationAddress = new MMMessageAssociationEnd() {
		{
			...
			definition = "Communication device number or electronic address used for communication.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmSecondaryCommunicationAddress;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CommunicationAddress3.mmObject();
	...
	public static final MMMessageAttribute mmAdditionalRegulatoryInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Organisation15.mmAdditionalRegulatoryInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public TaxIdentification2 getTaxIdentification() {
		return taxIdentification;
	}

	public void setTaxIdentification(com.tools20022.repository.msg.TaxIdentification2 taxIdentification) {
