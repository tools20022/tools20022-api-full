...
public class SecuritiesTradeDetails30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails30.mmNotificationSenderTransactionIdentification, SecuritiesTradeDetails30.mmNotificationReceiverTransactionIdentification,
						SecuritiesTradeDetails30.mmCommonIdentification, SecuritiesTradeDetails30.mmSecuritiesMovementType, SecuritiesTradeDetails30.mmPayment, SecuritiesTradeDetails30.mmTradeDate,
						SecuritiesTradeDetails30.mmSettlementDate, SecuritiesTradeDetails30.mmNumberOfDaysAccrued, SecuritiesTradeDetails30.mmFinancialInstrumentIdentification, SecuritiesTradeDetails30.mmFinancialInstrumentAttributes,
						SecuritiesTradeDetails30.mmReporting, SecuritiesTradeDetails30.mmQuantityDetails, SecuritiesTradeDetails30.mmSettlementParameters, SecuritiesTradeDetails30.mmDeliveringSettlementParties,
						SecuritiesTradeDetails30.mmReceivingSettlementParties, SecuritiesTradeDetails30.mmSettlementAmount, SecuritiesTradeDetails30.mmOtherAmounts, SecuritiesTradeDetails30.mmOtherBusinessParties,
						SecuritiesTradeDetails30.mmSupplementaryData);
