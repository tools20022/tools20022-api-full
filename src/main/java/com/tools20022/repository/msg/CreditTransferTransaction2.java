...
public class CreditTransferTransaction2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CreditTransferTransaction2.mmPaymentIdentification, CreditTransferTransaction2.mmPaymentTypeInformation, CreditTransferTransaction2.mmInterbankSettlementAmount,
						CreditTransferTransaction2.mmInterbankSettlementDate, CreditTransferTransaction2.mmSettlementPriority, CreditTransferTransaction2.mmSettlementTimeIndication, CreditTransferTransaction2.mmSettlementTimeRequest,
						CreditTransferTransaction2.mmAcceptanceDateTime, CreditTransferTransaction2.mmPoolingAdjustmentDate, CreditTransferTransaction2.mmInstructedAmount, CreditTransferTransaction2.mmExchangeRate,
						CreditTransferTransaction2.mmChargeBearer, CreditTransferTransaction2.mmChargesInformation, CreditTransferTransaction2.mmPreviousInstructingAgent, CreditTransferTransaction2.mmPreviousInstructingAgentAccount,
						CreditTransferTransaction2.mmInstructingAgent, CreditTransferTransaction2.mmInstructedAgent, CreditTransferTransaction2.mmIntermediaryAgent1, CreditTransferTransaction2.mmIntermediaryAgent1Account,
						CreditTransferTransaction2.mmIntermediaryAgent2, CreditTransferTransaction2.mmIntermediaryAgent2Account, CreditTransferTransaction2.mmIntermediaryAgent3, CreditTransferTransaction2.mmIntermediaryAgent3Account,
						CreditTransferTransaction2.mmUltimateDebtor, CreditTransferTransaction2.mmInitiatingParty, CreditTransferTransaction2.mmDebtor, CreditTransferTransaction2.mmDebtorAccount, CreditTransferTransaction2.mmDebtorAgent,
						CreditTransferTransaction2.mmDebtorAgentAccount, CreditTransferTransaction2.mmCreditorAgent, CreditTransferTransaction2.mmCreditorAgentAccount, CreditTransferTransaction2.mmCreditor,
						CreditTransferTransaction2.mmCreditorAccount, CreditTransferTransaction2.mmUltimateCreditor, CreditTransferTransaction2.mmInstructionForCreditorAgent, CreditTransferTransaction2.mmInstructionForNextAgent,
						CreditTransferTransaction2.mmPurpose, CreditTransferTransaction2.mmRegulatoryReporting, CreditTransferTransaction2.mmRelatedRemittanceInformation, CreditTransferTransaction2.mmRemittanceInformation);
