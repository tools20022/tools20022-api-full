...
public class QuantityBreakdown40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown40.mmLotNumber, QuantityBreakdown40.mmLotQuantity, QuantityBreakdown40.mmLotDateTime, QuantityBreakdown40.mmLotPrice, QuantityBreakdown40.mmTypeOfPrice);
