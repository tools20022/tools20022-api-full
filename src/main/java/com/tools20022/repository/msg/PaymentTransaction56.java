...
public class PaymentTransaction56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction56.mmReversalIdentification, PaymentTransaction56.mmOriginalInstructionIdentification, PaymentTransaction56.mmOriginalEndToEndIdentification,
						PaymentTransaction56.mmOriginalInstructedAmount, PaymentTransaction56.mmReversedInstructedAmount, PaymentTransaction56.mmChargeBearer, PaymentTransaction56.mmReversalReasonInformation,
						PaymentTransaction56.mmOriginalTransactionReference, PaymentTransaction56.mmSupplementaryData);
