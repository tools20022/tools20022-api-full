...
public class RateTypeAndAmountAndStatus7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus7.mmRateType, RateTypeAndAmountAndStatus7.mmAmount, RateTypeAndAmountAndStatus7.mmRateStatus);
