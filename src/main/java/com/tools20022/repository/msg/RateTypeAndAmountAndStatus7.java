...
public class RateTypeAndAmountAndStatus7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus7.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus7.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus7.RateStatus);
