...
public class TransactionIdentifications10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications10.mmAccountOwnerTransactionIdentification, TransactionIdentifications10.mmAccountServicerTransactionIdentification,
						TransactionIdentifications10.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications10.mmProcessorTransactionIdentification);
