 ...
 * TransactionIdentifications10.mmMarketInfrastructureTransactionIdentification}
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransactionIdentifications10
 * ConstraintNoAccountOwnerTransactionIdentificationRule.
 * forTransactionIdentifications10}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransactionIdentifications10
 * ConstraintCoexistenceIdentificationRule.forTransactionIdentifications10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "TransactionIdentifications10", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification"})
public class TransactionIdentifications10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications10, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications10, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications10.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(TransactionIdentifications10 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications10 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(TransactionIdentifications10 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications10 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<TransactionIdentifications10, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionIdentifications10.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications10.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.TransactionIdentifications10.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications10.mmProcessorTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementStatusAdviceV02.mmTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransactionIdentifications10,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionIdentifications10);
				...
				name = "TransactionIdentifications10";
				definition = "Unique identifier of a document, message or transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications15.mmObject());
			}
		});
	...
	public TransactionIdentifications10 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionIdentifications10 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionIdentifications10 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public TransactionIdentifications10 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
