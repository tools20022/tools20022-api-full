 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Intermediary27#Identification
 * Intermediary27.Identification}</li>
...
public class Intermediary27 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Intermediary27.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Intermediary27.Identification, com.tools20022.repository.msg.Intermediary27.Account, com.tools20022.repository.msg.Intermediary27.Role);
