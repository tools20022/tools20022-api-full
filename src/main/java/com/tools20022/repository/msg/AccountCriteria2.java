...
public class AccountCriteria2 {
	...
	protected List<com.tools20022.repository.msg.CashAccountSearchCriteria2> searchCriteria;
	/**
	...
	public static final MMMessageAssociationEnd mmSearchCriteria = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccountSearchCriteria2.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountCriteria2.mmNewQueryName, AccountCriteria2.mmSearchCriteria, AccountCriteria2.mmReturnCriteria);
	...
	public void setSearchCriteria(List<com.tools20022.repository.msg.CashAccountSearchCriteria2> searchCriteria) {
