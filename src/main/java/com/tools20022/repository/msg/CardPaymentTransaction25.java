...
@XmlType(name = "CardPaymentTransaction25", propOrder = {"transactionCapture", "transactionType", "additionalService", "serviceAttribute", "merchantCategoryCode", "saleReferenceIdentification", "transactionIdentification",
...
public class CardPaymentTransaction25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>> mmTransactionCapture = new MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionCapture);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionCapture;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionCapture();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, CardPaymentServiceType5Code> mmTransactionType = new MMMessageAttribute<CardPaymentTransaction25, CardPaymentServiceType5Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionType);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CardPaymentServiceType5Code getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionType();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, CardPaymentServiceType5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, List<CardPaymentServiceType6Code>> mmAdditionalService = new MMMessageAttribute<CardPaymentTransaction25, List<CardPaymentServiceType6Code>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPaymentService;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmAdditionalService);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmAdditionalService;
			minOccurs = 0;
			simpleType_lazy = () -> CardPaymentServiceType6Code.mmObject();
		}

		@Override
		public List<CardPaymentServiceType6Code> getValue(CardPaymentTransaction25 obj) {
			return obj.getAdditionalService();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, List<CardPaymentServiceType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<CardPaymentServiceType3Code>> mmServiceAttribute = new MMMessageAttribute<CardPaymentTransaction25, Optional<CardPaymentServiceType3Code>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPaymentService;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmServiceAttribute);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardPaymentServiceType3Code> getValue(CardPaymentTransaction25 obj) {
			return obj.getServiceAttribute();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<CardPaymentServiceType3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Min3Max4Text> mmMerchantCategoryCode = new MMMessageAttribute<CardPaymentTransaction25, Min3Max4Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmMerchantCategoryCode);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Min3Max4Text getValue(CardPaymentTransaction25 obj) {
			return obj.getMerchantCategoryCode();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Min3Max4Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmSaleReferenceIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction25 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction25, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction25, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction25, Optional<CardPaymentTransaction21>> mmOriginalTransaction = new MMMessageAssociationEnd<CardPaymentTransaction25, Optional<CardPaymentTransaction21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmOriginalTransaction);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CardPaymentTransaction21> getValue(CardPaymentTransaction25 obj) {
			return obj.getOriginalTransaction();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<CardPaymentTransaction21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, TrueFalseIndicator> mmTransactionSuccess = new MMMessageAttribute<CardPaymentTransaction25, TrueFalseIndicator>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionSuccess);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionSuccess;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
		...
		@Override
		public TrueFalseIndicator getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionSuccess();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, TrueFalseIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>> mmReversal = new MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmReversal);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmReversal;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>> mmMerchantOverride = new MMMessageAttribute<CardPaymentTransaction25, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmMerchantOverride);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmMerchantOverride;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, List<FailureReason3Code>> mmFailureReason = new MMMessageAttribute<CardPaymentTransaction25, List<FailureReason3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmFailureReason);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmFailureReason;
			minOccurs = 0;
			simpleType_lazy = () -> FailureReason3Code.mmObject();
		}

		@Override
		public List<FailureReason3Code> getValue(CardPaymentTransaction25 obj) {
			return obj.getFailureReason();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, List<FailureReason3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>> mmInitiatorTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmInitiatorTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected CardPaymentTransactionDetails14 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction25, CardPaymentTransactionDetails14> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction25, CardPaymentTransactionDetails14>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CardPaymentTransactionDetails14.mmObject();
		}

		@Override
		public CardPaymentTransactionDetails14 getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, CardPaymentTransactionDetails14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction25, Optional<AuthorisationResult2>> mmAuthorisationResult = new MMMessageAssociationEnd<CardPaymentTransaction25, Optional<AuthorisationResult2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmAuthorisationResult);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmAuthorisationResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AuthorisationResult2> getValue(CardPaymentTransaction25 obj) {
			return obj.getAuthorisationResult();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<AuthorisationResult2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction25, Optional<TransactionVerificationResult2>> mmTransactionVerificationResult = new MMMessageAssociationEnd<CardPaymentTransaction25, Optional<TransactionVerificationResult2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			xmlTag = "TxVrfctnRslt";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmTransactionVerificationResult);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmTransactionVerificationResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TransactionVerificationResult2> getValue(CardPaymentTransaction25 obj) {
			return obj.getTransactionVerificationResult();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, Optional<TransactionVerificationResult2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction25, List<Max70Text>> mmAdditionalTransactionData = new MMMessageAttribute<CardPaymentTransaction25, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction25.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxData";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmAdditionalTransactionData);
			previousVersion_lazy = () -> CardPaymentTransaction13.mmAdditionalTransactionData;
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}

		@Override
		public List<Max70Text> getValue(CardPaymentTransaction25 obj) {
			return obj.getAdditionalTransactionData();
		}

		@Override
		public void setValue(CardPaymentTransaction25 obj, List<Max70Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionCapture, com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionType,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmAdditionalService, com.tools20022.repository.msg.CardPaymentTransaction25.mmServiceAttribute,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmMerchantCategoryCode, com.tools20022.repository.msg.CardPaymentTransaction25.mmSaleReferenceIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction25.mmOriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionSuccess, com.tools20022.repository.msg.CardPaymentTransaction25.mmReversal,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmMerchantOverride, com.tools20022.repository.msg.CardPaymentTransaction25.mmFailureReason,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmInitiatorTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction25.mmRecipientTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmReconciliationIdentification, com.tools20022.repository.msg.CardPaymentTransaction25.mmInterchangeData,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionDetails, com.tools20022.repository.msg.CardPaymentTransaction25.mmAuthorisationResult,
						com.tools20022.repository.msg.CardPaymentTransaction25.mmTransactionVerificationResult, com.tools20022.repository.msg.CardPaymentTransaction25.mmAdditionalTransactionData);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction25";
				definition = "Transaction information in the completion advice message.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction40.mmObject());
				previousVersion_lazy = () -> CardPaymentTransaction13.mmObject();
			}
		});
	...
	public CardPaymentTransaction25 setTransactionCapture(TrueFalseIndicator transactionCapture) {
	...
	public CardPaymentTransaction25 setTransactionType(CardPaymentServiceType5Code transactionType) {
	...
	public CardPaymentTransaction25 setAdditionalService(List<CardPaymentServiceType6Code> additionalService) {
	...
	public CardPaymentTransaction25 setServiceAttribute(CardPaymentServiceType3Code serviceAttribute) {
	...
	public CardPaymentTransaction25 setMerchantCategoryCode(Min3Max4Text merchantCategoryCode) {
	...
	public CardPaymentTransaction25 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction25 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction25 setOriginalTransaction(CardPaymentTransaction21 originalTransaction) {
	...
	public CardPaymentTransaction25 setTransactionSuccess(TrueFalseIndicator transactionSuccess) {
	...
	public CardPaymentTransaction25 setReversal(TrueFalseIndicator reversal) {
	...
	public CardPaymentTransaction25 setMerchantOverride(TrueFalseIndicator merchantOverride) {
	...
	public CardPaymentTransaction25 setFailureReason(List<FailureReason3Code> failureReason) {
	...
	public CardPaymentTransaction25 setInitiatorTransactionIdentification(Max35Text initiatorTransactionIdentification) {
	...
	public CardPaymentTransaction25 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction25 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction25 setInterchangeData(Max35Text interchangeData) {
		this.interchangeData = interchangeData;
		return this;
	}

	public CardPaymentTransactionDetails14 getTransactionDetails() {
		return transactionDetails;
	}

	public CardPaymentTransaction25 setTransactionDetails(CardPaymentTransactionDetails14 transactionDetails) {
	...
	public CardPaymentTransaction25 setAuthorisationResult(AuthorisationResult2 authorisationResult) {
	...
	public CardPaymentTransaction25 setTransactionVerificationResult(TransactionVerificationResult2 transactionVerificationResult) {
	...
	public CardPaymentTransaction25 setAdditionalTransactionData(List<Max70Text> additionalTransactionData) {
