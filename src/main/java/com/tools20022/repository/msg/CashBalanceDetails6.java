...
public class CashBalanceDetails6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashBalanceDetails6.mmAmount, CashBalanceDetails6.mmCreditDebitIndicator, CashBalanceDetails6.mmType, CashBalanceDetails6.mmStatus, CashBalanceDetails6.mmValueDate,
						CashBalanceDetails6.mmNumberOfPayments);
