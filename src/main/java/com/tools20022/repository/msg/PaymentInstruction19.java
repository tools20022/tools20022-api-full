 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction19#Debtor
...
public class PaymentInstruction19 {
	...
	public static final MMMessageAttribute PaymentInformationIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentInstruction19.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.PaymentInformationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.PaymentInformationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.PaymentMethod;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.PaymentMethod);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.PaymentTypeInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.PaymentTypeInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.RequestedExecutionDate;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.RequestedExecutionDate);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentInstruction17#Debtor
	...
	public static final MMMessageAssociationEnd Debtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.Debtor;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.Debtor);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.DebtorAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.DebtorAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.DebtorAgent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.DebtorAgent);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.UltimateDebtor;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.UltimateDebtor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.ChargeBearer;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.ChargeBearer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditTransferTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction17.CreditTransferTransaction;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction23.CreditTransferTransaction);
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction19.PaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction19.PaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction19.PaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction19.RequestedExecutionDate, com.tools20022.repository.msg.PaymentInstruction19.Debtor,
						com.tools20022.repository.msg.PaymentInstruction19.DebtorAccount, com.tools20022.repository.msg.PaymentInstruction19.DebtorAgent, com.tools20022.repository.msg.PaymentInstruction19.UltimateDebtor,
						com.tools20022.repository.msg.PaymentInstruction19.ChargeBearer, com.tools20022.repository.msg.PaymentInstruction19.CreditTransferTransaction);
				trace_lazy = () -> PaymentInstruction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CreditorPaymentActivationRequestV05.PaymentInformation);
