 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity7#mmSettlementQuantity
 * Quantity7.mmSettlementQuantity}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity7#mmDenominationChoice
 * Quantity7.mmDenominationChoice}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity7#mmCertificateNumber
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantity7
 * ConstraintCoexistenceQuantityRule.forQuantity7}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Quantity5
 * Quantity5}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Quantity7", propOrder = {"settlementQuantity", "denominationChoice", "certificateNumber", "quantityBreakdown"})
public class Quantity7 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Quantity7
	 * Quantity7}</li>
	...
	public static final MMMessageAssociationEnd<Quantity7, FinancialInstrumentQuantity1Choice> mmSettlementQuantity = new MMMessageAssociationEnd<Quantity7, FinancialInstrumentQuantity1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Quantity11.mmSettlementQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<Quantity7, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<Quantity7, Optional<Max210Text>>() {
		{
			...
			definition = "Denomination of the security to be received or delivered.";
			nextVersions_lazy = () -> Arrays.asList(Quantity11.mmDenominationChoice);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Quantity7.mmSettlementQuantity, com.tools20022.repository.msg.Quantity7.mmDenominationChoice,
						com.tools20022.repository.msg.Quantity7.mmCertificateNumber, com.tools20022.repository.msg.Quantity7.mmQuantityBreakdown);
				trace_lazy = () -> SecuritiesQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantity7);
				...
				nextVersions_lazy = () -> Arrays.asList(Quantity11.mmObject());
				previousVersion_lazy = () -> Quantity5.mmObject();
			}
		});
	...
	public Quantity7 setSettlementQuantity(FinancialInstrumentQuantity1Choice settlementQuantity) {
	...
	public Quantity7 setDenominationChoice(Max210Text denominationChoice) {
