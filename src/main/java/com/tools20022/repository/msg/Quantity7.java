...
public class Quantity7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Quantity7.mmSettlementQuantity, Quantity7.mmDenominationChoice, Quantity7.mmCertificateNumber, Quantity7.mmQuantityBreakdown);
