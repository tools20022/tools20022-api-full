...
@XmlType(name = "CardAccount5", propOrder = {"selectionMethod", "selectedAccountType", "accountName", "currency", "accountIdentifier", "creditReference", "servicer"})
public class CardAccount5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardAccount5, Optional<AccountChoiceMethod1Code>> mmSelectionMethod = new MMMessageAttribute<CardAccount5, Optional<AccountChoiceMethod1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardAccount5.mmObject();
			isDerived = false;
			xmlTag = "SelctnMtd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SelectionMethod";
			definition = "Method used by the cardholder and the terminal for the choice of the account.";
			previousVersion_lazy = () -> CardAccount4.mmSelectionMethod;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountChoiceMethod1Code> getValue(CardAccount5 obj) {
			return obj.getSelectionMethod();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<AccountChoiceMethod1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardAccount5, Optional<CardAccountType2Code>> mmSelectedAccountType = new MMMessageAttribute<CardAccount5, Optional<CardAccountType2Code>>() {
		{
		...
		@Override
		public Optional<CardAccountType2Code> getValue(CardAccount5 obj) {
			return obj.getSelectedAccountType();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<CardAccountType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardAccount5, Optional<Max70Text>> mmAccountName = new MMMessageAttribute<CardAccount5, Optional<Max70Text>>() {
		{
		...
		@Override
		public Optional<Max70Text> getValue(CardAccount5 obj) {
			return obj.getAccountName();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<Max70Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardAccount5, Optional<ActiveCurrencyCode>> mmCurrency = new MMMessageAttribute<CardAccount5, Optional<ActiveCurrencyCode>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(CardAccount5 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardAccount5, Optional<AccountIdentification31Choice>> mmAccountIdentifier = new MMMessageAssociationEnd<CardAccount5, Optional<AccountIdentification31Choice>>() {
		{
		...
		@Override
		public Optional<AccountIdentification31Choice> getValue(CardAccount5 obj) {
			return obj.getAccountIdentifier();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<AccountIdentification31Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardAccount5, Optional<Max35Text>> mmCreditReference = new MMMessageAttribute<CardAccount5, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardAccount5.mmObject();
			isDerived = false;
			xmlTag = "CdtRef";
		...
		@Override
		public Optional<Max35Text> getValue(CardAccount5 obj) {
			return obj.getCreditReference();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardAccount5, Optional<PartyIdentification72Choice>> mmServicer = new MMMessageAssociationEnd<CardAccount5, Optional<PartyIdentification72Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification72Choice> getValue(CardAccount5 obj) {
			return obj.getServicer();
		}

		@Override
		public void setValue(CardAccount5 obj, Optional<PartyIdentification72Choice> value) {
	...
	public CardAccount5 setSelectionMethod(AccountChoiceMethod1Code selectionMethod) {
	...
	public CardAccount5 setSelectedAccountType(CardAccountType2Code selectedAccountType) {
	...
	public CardAccount5 setAccountName(Max70Text accountName) {
	...
	public CardAccount5 setCurrency(ActiveCurrencyCode currency) {
	...
	public CardAccount5 setAccountIdentifier(AccountIdentification31Choice accountIdentifier) {
	...
	public CardAccount5 setCreditReference(Max35Text creditReference) {
	...
	public CardAccount5 setServicer(PartyIdentification72Choice servicer) {
