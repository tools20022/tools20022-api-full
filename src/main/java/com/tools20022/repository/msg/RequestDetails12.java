 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.RequestDetails12#mmReference
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.RequestDetails12#mmRetainIndicator
 * RequestDetails12.mmRetainIndicator}</li>
 * <li>{@linkplain com.tools20022.repository.msg.RequestDetails12#mmLinkage
 * RequestDetails12.mmLinkage}</li>
 * <li>{@linkplain com.tools20022.repository.msg.RequestDetails12#mmPriority
 * RequestDetails12.mmPriority}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.RequestDetails12#mmOtherProcessing
 * RequestDetails12.mmOtherProcessing}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.RequestDetails12#mmLinkages
 * RequestDetails12.mmLinkages}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintModificationRequestPresenceRule#forRequestDetails12
 * ConstraintModificationRequestPresenceRule.forRequestDetails12}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherProcessingRule#forRequestDetails12
 * ConstraintOtherProcessingRule.forRequestDetails12}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementConditionModificationApplicabilityRule#forRequestDetails12
 * ConstraintSettlementConditionModificationApplicabilityRule.
 * forRequestDetails12}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "RequestDetails12", propOrder = {"reference", "automaticBorrowing", "retainIndicator", "linkage", "priority", "otherProcessing", "partialSettlementIndicator", "securitiesRTGS", "holdIndicator", "matchingDenial",
...
public class RequestDetails12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, References13> mmReference = new MMMessageAssociationEnd<RequestDetails12, References13>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTradeRelatedIdentifications;
			componentContext_lazy = () -> com.tools20022.repository.msg.RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "Ref";
		...
		@Override
		public References13 getValue(RequestDetails12 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(RequestDetails12 obj, References13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<AutomaticBorrowing3Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<RequestDetails12, Optional<AutomaticBorrowing3Choice>>() {
		{
		...
		@Override
		public Optional<AutomaticBorrowing3Choice> getValue(RequestDetails12 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<AutomaticBorrowing3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RequestDetails12, Optional<YesNoIndicator>> mmRetainIndicator = new MMMessageAttribute<RequestDetails12, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "RtnInd";
		...
		@Override
		public Optional<YesNoIndicator> getValue(RequestDetails12 obj) {
			return obj.getRetainIndicator();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<LinkageType2Choice>> mmLinkage = new MMMessageAssociationEnd<RequestDetails12, Optional<LinkageType2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "Lkg";
		...
		@Override
		public Optional<LinkageType2Choice> getValue(RequestDetails12 obj) {
			return obj.getLinkage();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<LinkageType2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<PriorityNumeric2Choice>> mmPriority = new MMMessageAssociationEnd<RequestDetails12, Optional<PriorityNumeric2Choice>>() {
		{
		...
		@Override
		public Optional<PriorityNumeric2Choice> getValue(RequestDetails12 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<PriorityNumeric2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, List<GenericIdentification25>> mmOtherProcessing = new MMMessageAssociationEnd<RequestDetails12, List<GenericIdentification25>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "OthrPrcg";
		...
		@Override
		public List<GenericIdentification25> getValue(RequestDetails12 obj) {
			return obj.getOtherProcessing();
		}

		@Override
		public void setValue(RequestDetails12 obj, List<GenericIdentification25> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RequestDetails12, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<RequestDetails12, Optional<SettlementTransactionCondition5Code>>() {
		{
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(RequestDetails12 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<SecuritiesRTGS2Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<RequestDetails12, Optional<SecuritiesRTGS2Choice>>() {
		{
		...
		@Override
		public Optional<SecuritiesRTGS2Choice> getValue(RequestDetails12 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<SecuritiesRTGS2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<HoldIndicator5>> mmHoldIndicator = new MMMessageAssociationEnd<RequestDetails12, Optional<HoldIndicator5>>() {
		{
		...
		@Override
		public Optional<HoldIndicator5> getValue(RequestDetails12 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<HoldIndicator5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<MatchingDenied2Choice>> mmMatchingDenial = new MMMessageAssociationEnd<RequestDetails12, Optional<MatchingDenied2Choice>>() {
		{
		...
		@Override
		public Optional<MatchingDenied2Choice> getValue(RequestDetails12 obj) {
			return obj.getMatchingDenial();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<MatchingDenied2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, Optional<UnilateralSplit2Choice>> mmUnilateralSplit = new MMMessageAssociationEnd<RequestDetails12, Optional<UnilateralSplit2Choice>>() {
		{
		...
		@Override
		public Optional<UnilateralSplit2Choice> getValue(RequestDetails12 obj) {
			return obj.getUnilateralSplit();
		}

		@Override
		public void setValue(RequestDetails12 obj, Optional<UnilateralSplit2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RequestDetails12, List<Linkages28>> mmLinkages = new MMMessageAssociationEnd<RequestDetails12, List<Linkages28>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "Lnkgs";
		...
		@Override
		public List<Linkages28> getValue(RequestDetails12 obj) {
			return obj.getLinkages();
		}

		@Override
		public void setValue(RequestDetails12 obj, List<Linkages28> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RequestDetails12.mmReference, com.tools20022.repository.msg.RequestDetails12.mmAutomaticBorrowing,
						com.tools20022.repository.msg.RequestDetails12.mmRetainIndicator, com.tools20022.repository.msg.RequestDetails12.mmLinkage, com.tools20022.repository.msg.RequestDetails12.mmPriority,
						com.tools20022.repository.msg.RequestDetails12.mmOtherProcessing, com.tools20022.repository.msg.RequestDetails12.mmPartialSettlementIndicator, com.tools20022.repository.msg.RequestDetails12.mmSecuritiesRTGS,
						com.tools20022.repository.msg.RequestDetails12.mmHoldIndicator, com.tools20022.repository.msg.RequestDetails12.mmMatchingDenial, com.tools20022.repository.msg.RequestDetails12.mmUnilateralSplit,
						com.tools20022.repository.msg.RequestDetails12.mmLinkages);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintModificationRequestPresenceRule.forRequestDetails12,
						com.tools20022.repository.constraints.ConstraintOtherProcessingRule.forRequestDetails12, com.tools20022.repository.constraints.ConstraintSettlementConditionModificationApplicabilityRule.forRequestDetails12);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RequestDetails12";
	...
	public RequestDetails12 setReference(References13 reference) {
	...
	public RequestDetails12 setAutomaticBorrowing(AutomaticBorrowing3Choice automaticBorrowing) {
	...
	public RequestDetails12 setRetainIndicator(YesNoIndicator retainIndicator) {
	...
	public RequestDetails12 setLinkage(LinkageType2Choice linkage) {
	...
	public RequestDetails12 setPriority(PriorityNumeric2Choice priority) {
	...
	public RequestDetails12 setOtherProcessing(List<GenericIdentification25> otherProcessing) {
	...
	public RequestDetails12 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public RequestDetails12 setSecuritiesRTGS(SecuritiesRTGS2Choice securitiesRTGS) {
	...
	public RequestDetails12 setHoldIndicator(HoldIndicator5 holdIndicator) {
	...
	public RequestDetails12 setMatchingDenial(MatchingDenied2Choice matchingDenial) {
	...
	public RequestDetails12 setUnilateralSplit(UnilateralSplit2Choice unilateralSplit) {
	...
	public RequestDetails12 setLinkages(List<Linkages28> linkages) {
