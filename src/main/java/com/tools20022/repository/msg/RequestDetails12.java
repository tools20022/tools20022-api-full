...
public class RequestDetails12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestDetails12.mmReference, RequestDetails12.mmAutomaticBorrowing, RequestDetails12.mmRetainIndicator, RequestDetails12.mmLinkage, RequestDetails12.mmPriority,
						RequestDetails12.mmOtherProcessing, RequestDetails12.mmPartialSettlementIndicator, RequestDetails12.mmSecuritiesRTGS, RequestDetails12.mmHoldIndicator, RequestDetails12.mmMatchingDenial,
						RequestDetails12.mmUnilateralSplit, RequestDetails12.mmLinkages);
