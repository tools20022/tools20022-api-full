...
public class RequestDetails12 {
	...
	public static final MMMessageAssociationEnd mmReference = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RequestDetails12.mmObject();
			isDerived = false;
			xmlTag = "Ref";
	...
	public void setReference(com.tools20022.repository.msg.References13 reference) {
	...
	public void setLinkages(List<com.tools20022.repository.msg.Linkages28> linkages) {
