...
public class CorporateActionGeneralInformation31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation31.mmCorporateActionEventIdentification, CorporateActionGeneralInformation31.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation31.mmClassActionNumber, CorporateActionGeneralInformation31.mmEventProcessingType, CorporateActionGeneralInformation31.mmEventType,
						CorporateActionGeneralInformation31.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation31.mmUnderlyingSecurity);
