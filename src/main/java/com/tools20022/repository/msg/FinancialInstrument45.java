 ...
 * ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument45
 * }</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FinancialInstrument45", propOrder = {"identification", "name", "shortName", "supplementaryIdentification", "classType", "securitiesForm", "distributionPolicy", "productGroup"})
public class FinancialInstrument45 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, SecurityIdentification23Choice> mmIdentification = new MMMessageAttribute<FinancialInstrument45, SecurityIdentification23Choice>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrument45.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of a security by an ISIN.";
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmIdentification, FinancialInstrument55.mmIdentification);
		...
		@Override
		public SecurityIdentification23Choice getValue(FinancialInstrument45 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, SecurityIdentification23Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<Max350Text>> mmName = new MMMessageAttribute<FinancialInstrument45, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmName, FinancialInstrument55.mmName);
		...
		@Override
		public Optional<Max350Text> getValue(FinancialInstrument45 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>> mmShortName = new MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmShortName, FinancialInstrument55.mmShortName);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(FinancialInstrument45 obj) {
			return obj.getShortName();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>> mmSupplementaryIdentification = new MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrument45.mmObject();
			isDerived = false;
			xmlTag = "SplmtryId";
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmSupplementaryIdentification, FinancialInstrument55.mmSupplementaryIdentification);
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>> mmClassType = new MMMessageAttribute<FinancialInstrument45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmClassType, FinancialInstrument55.mmClassType);
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<FormOfSecurity1Code>> mmSecuritiesForm = new MMMessageAttribute<FinancialInstrument45, Optional<FormOfSecurity1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmSecuritiesForm, FinancialInstrument55.mmSecuritiesForm);
		...
		@Override
		public Optional<FormOfSecurity1Code> getValue(FinancialInstrument45 obj) {
			return obj.getSecuritiesForm();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, Optional<FormOfSecurity1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<DistributionPolicy1Code>> mmDistributionPolicy = new MMMessageAttribute<FinancialInstrument45, Optional<DistributionPolicy1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument49.mmDistributionPolicy, FinancialInstrument55.mmDistributionPolicy);
		...
		@Override
		public Optional<DistributionPolicy1Code> getValue(FinancialInstrument45 obj) {
			return obj.getDistributionPolicy();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, Optional<DistributionPolicy1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument45, Optional<Max140Text>> mmProductGroup = new MMMessageAttribute<FinancialInstrument45, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrument55.mmProductGroup);
		...
		@Override
		public Optional<Max140Text> getValue(FinancialInstrument45 obj) {
			return obj.getProductGroup();
		}

		@Override
		public void setValue(FinancialInstrument45 obj, Optional<Max140Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument45);
	...
	public FinancialInstrument45 setIdentification(SecurityIdentification23Choice identification) {
	...
	public FinancialInstrument45 setName(Max350Text name) {
		this.name = name;
		return this;
	}
	...
	public FinancialInstrument45 setShortName(Max35Text shortName) {
	...
	public FinancialInstrument45 setSupplementaryIdentification(Max35Text supplementaryIdentification) {
	...
	public FinancialInstrument45 setClassType(Max35Text classType) {
	...
	public FinancialInstrument45 setSecuritiesForm(FormOfSecurity1Code securitiesForm) {
	...
	public FinancialInstrument45 setDistributionPolicy(DistributionPolicy1Code distributionPolicy) {
	...
	public FinancialInstrument45 setProductGroup(Max140Text productGroup) {
