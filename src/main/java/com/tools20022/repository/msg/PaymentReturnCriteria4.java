...
public class PaymentReturnCriteria4 {
	...
	public static final MMMessageAttribute mmInstructionStatusReturnCriteria = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.InstructionStatusReturnCriteria1.mmObject();
		}
	};
	...
	public PaymentReturnCriteria4 setInstructionStatusReturnCriteria(com.tools20022.repository.msg.InstructionStatusReturnCriteria1 instructionStatusReturnCriteria) {
