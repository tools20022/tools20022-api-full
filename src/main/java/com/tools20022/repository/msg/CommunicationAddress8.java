...
@XmlType(name = "CommunicationAddress8", propOrder = {"postalAddress", "phoneNumber", "faxNumber", "emailAddress"})
public class CommunicationAddress8 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CommunicationAddress8
	 * CommunicationAddress8}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CommunicationAddress8, LongPostalAddress1Choice> mmPostalAddress = new MMMessageAttribute<CommunicationAddress8, LongPostalAddress1Choice>() {
		{
			businessComponentTrace_lazy = () -> PostalAddress.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CommunicationAddress8.mmObject();
			isDerived = false;
			xmlTag = "PstlAdr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PostalAddress";
			definition = "Information that locates and identifies a specific address, as defined by postal services.";
			previousVersion_lazy = () -> CommunicationAddressDetails.mmPostalAddress;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public LongPostalAddress1Choice getValue(CommunicationAddress8 obj) {
			return obj.getPostalAddress();
		}

		@Override
		public void setValue(CommunicationAddress8 obj, LongPostalAddress1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CommunicationAddress8, PhoneNumber> mmPhoneNumber = new MMMessageAttribute<CommunicationAddress8, PhoneNumber>() {
		{
			...
			previousVersion_lazy = () -> CommunicationAddressDetails.mmPhoneNumber;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PhoneNumber getValue(CommunicationAddress8 obj) {
			return obj.getPhoneNumber();
		}

		@Override
		public void setValue(CommunicationAddress8 obj, PhoneNumber value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CommunicationAddress8, Optional<PhoneNumber>> mmFaxNumber = new MMMessageAttribute<CommunicationAddress8, Optional<PhoneNumber>>() {
		{
			...
			previousVersion_lazy = () -> CommunicationAddressDetails.mmFaxNumber;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PhoneNumber.mmObject();
		}
		...
		@Override
		public Optional<PhoneNumber> getValue(CommunicationAddress8 obj) {
			return obj.getFaxNumber();
		}

		@Override
		public void setValue(CommunicationAddress8 obj, Optional<PhoneNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CommunicationAddress8, Optional<Max256Text>> mmEmailAddress = new MMMessageAttribute<CommunicationAddress8, Optional<Max256Text>>() {
		{
			...
			previousVersion_lazy = () -> CommunicationAddressDetails.mmEmailAddress;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max256Text> getValue(CommunicationAddress8 obj) {
			return obj.getEmailAddress();
		}

		@Override
		public void setValue(CommunicationAddress8 obj, Optional<Max256Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CommunicationAddress8.mmPostalAddress, com.tools20022.repository.msg.CommunicationAddress8.mmPhoneNumber,
						com.tools20022.repository.msg.CommunicationAddress8.mmFaxNumber, com.tools20022.repository.msg.CommunicationAddress8.mmEmailAddress);
				trace_lazy = () -> ContactPoint.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CommunicationAddress8";
				definition = "Communication device number or electronic address used for communication.";
				previousVersion_lazy = () -> CommunicationAddressDetails.mmObject();
			}
		});
	...
	public CommunicationAddress8 setPostalAddress(LongPostalAddress1Choice postalAddress) {
	...
	public CommunicationAddress8 setPhoneNumber(PhoneNumber phoneNumber) {
	...
	public CommunicationAddress8 setFaxNumber(PhoneNumber faxNumber) {
	...
	public CommunicationAddress8 setEmailAddress(Max256Text emailAddress) {
