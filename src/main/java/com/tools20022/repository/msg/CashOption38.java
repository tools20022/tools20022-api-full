...
public class CashOption38 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CashOption38.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption38.mmCreditDebitIndicator, CashOption38.mmContractualPaymentIndicator, CashOption38.mmIncomeType, CashOption38.mmExemptionType, CashOption38.mmAccount,
						CashOption38.mmCashParties, CashOption38.mmAmountDetails, CashOption38.mmDateDetails, CashOption38.mmForeignExchangeDetails, CashOption38.mmTaxVoucherDetails, CashOption38.mmRateAndAmountDetails,
						CashOption38.mmPriceDetails);
	...
	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts35 amountDetails) {
	...
	public RateDetails21 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.RateDetails21 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
	}

	public PriceDetails21 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.PriceDetails21 priceDetails) {
