...
public class CurrencyExchangeDetails {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CurrencyExchangeDetails.ExchangeRate, com.tools20022.repository.msg.CurrencyExchangeDetails.QuotedCurrency,
						com.tools20022.repository.msg.CurrencyExchangeDetails.QuotationDate);
