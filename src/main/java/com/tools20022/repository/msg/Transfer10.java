...
import com.tools20022.repository.area.sese.TransferOutConfirmationV02;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer10#mmMasterReference
 * Transfer10.mmMasterReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer10#mmTransferConfirmationReference
 * Transfer10.mmTransferConfirmationReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer10#mmTransferReference
 * Transfer10.mmTransferReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer10#mmClientReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer10#mmTotalUnitsNumber
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer10#mmPortfolioTransferOutRate
 * Transfer10.mmPortfolioTransferOutRate}</li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferOutConfirmationV02#mmTransferDetails
 * TransferOutConfirmationV02.mmTransferDetails}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule#forTransfer10
 * ConstraintTotalUnitsNumberRule.forTransfer10}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintRoundingRule#forTransfer10
 * ConstraintRoundingRule.forTransfer10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transfer10", propOrder = {"masterReference", "transferConfirmationReference", "transferReference", "clientReference", "effectiveTransferDate", "tradeDate", "totalUnitsNumber", "unitsDetails", "portfolioTransferOutRate",
		"rounding", "ownAccountTransferIndicator", "averagePrice", "nonStandardSettlementInformation"})
public class Transfer10 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Transfer10
	 * Transfer10}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<Transfer10, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer10.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<Max35Text> getValue(Transfer10 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Max35Text> mmTransferConfirmationReference = new MMMessageAttribute<Transfer10, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer10.mmObject();
			isDerived = false;
			xmlTag = "TrfConfRef";
		...
		@Override
		public Max35Text getValue(Transfer10 obj) {
			return obj.getTransferConfirmationReference();
		}

		@Override
		public void setValue(Transfer10 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Max35Text> mmTransferReference = new MMMessageAttribute<Transfer10, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<Transfer10, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, DateAndDateTimeChoice> mmEffectiveTransferDate = new MMMessageAttribute<Transfer10, DateAndDateTimeChoice>() {
		{
		...
		@Override
		public DateAndDateTimeChoice getValue(Transfer10 obj) {
			return obj.getEffectiveTransferDate();
		}

		@Override
		public void setValue(Transfer10 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, DateAndDateTimeChoice> mmTradeDate = new MMMessageAttribute<Transfer10, DateAndDateTimeChoice>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, FinancialInstrumentQuantity1> mmTotalUnitsNumber = new MMMessageAttribute<Transfer10, FinancialInstrumentQuantity1>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity1 getValue(Transfer10 obj) {
			return obj.getTotalUnitsNumber();
		}

		@Override
		public void setValue(Transfer10 obj, FinancialInstrumentQuantity1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer10, List<Unit3>> mmUnitsDetails = new MMMessageAssociationEnd<Transfer10, List<Unit3>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmTransferredQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer10.mmObject();
			isDerived = false;
		...
		@Override
		public List<Unit3> getValue(Transfer10 obj) {
			return obj.getUnitsDetails();
		}

		@Override
		public void setValue(Transfer10 obj, List<Unit3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<PercentageRate>> mmPortfolioTransferOutRate = new MMMessageAttribute<Transfer10, Optional<PercentageRate>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer10.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PercentageRate> getValue(Transfer10 obj) {
			return obj.getPortfolioTransferOutRate();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<RoundingDirection2Code>> mmRounding = new MMMessageAttribute<Transfer10, Optional<RoundingDirection2Code>>() {
		{
		...
		@Override
		public Optional<RoundingDirection2Code> getValue(Transfer10 obj) {
			return obj.getRounding();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<RoundingDirection2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<YesNoIndicator>> mmOwnAccountTransferIndicator = new MMMessageAttribute<Transfer10, Optional<YesNoIndicator>>() {
		{
		...
		@Override
		public Optional<YesNoIndicator> getValue(Transfer10 obj) {
			return obj.getOwnAccountTransferIndicator();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>> mmAveragePrice = new MMMessageAttribute<Transfer10, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> getValue(Transfer10 obj) {
			return obj.getAveragePrice();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer10, Optional<Max350Text>> mmNonStandardSettlementInformation = new MMMessageAttribute<Transfer10, Optional<Max350Text>>() {
		{
		...
		@Override
		public Optional<Max350Text> getValue(Transfer10 obj) {
			return obj.getNonStandardSettlementInformation();
		}

		@Override
		public void setValue(Transfer10 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer10.mmMasterReference, com.tools20022.repository.msg.Transfer10.mmTransferConfirmationReference,
						com.tools20022.repository.msg.Transfer10.mmTransferReference, com.tools20022.repository.msg.Transfer10.mmClientReference, com.tools20022.repository.msg.Transfer10.mmEffectiveTransferDate,
						com.tools20022.repository.msg.Transfer10.mmTradeDate, com.tools20022.repository.msg.Transfer10.mmTotalUnitsNumber, com.tools20022.repository.msg.Transfer10.mmUnitsDetails,
						com.tools20022.repository.msg.Transfer10.mmPortfolioTransferOutRate, com.tools20022.repository.msg.Transfer10.mmRounding, com.tools20022.repository.msg.Transfer10.mmOwnAccountTransferIndicator,
						com.tools20022.repository.msg.Transfer10.mmAveragePrice, com.tools20022.repository.msg.Transfer10.mmNonStandardSettlementInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutConfirmationV02.mmTransferDetails);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule.forTransfer10, com.tools20022.repository.constraints.ConstraintRoundingRule.forTransfer10);
				...
				nextVersions_lazy = () -> Arrays.asList(Transfer14.mmObject(), Transfer13.mmObject());
			}
		});
	...
	public Transfer10 setMasterReference(Max35Text masterReference) {
	...
	public Transfer10 setTransferConfirmationReference(Max35Text transferConfirmationReference) {
	...
	public Transfer10 setTransferReference(Max35Text transferReference) {
	...
	public Transfer10 setClientReference(Max35Text clientReference) {
	...
	public Transfer10 setEffectiveTransferDate(DateAndDateTimeChoice effectiveTransferDate) {
	...
	public Transfer10 setTradeDate(DateAndDateTimeChoice tradeDate) {
	...
	public Transfer10 setTotalUnitsNumber(FinancialInstrumentQuantity1 totalUnitsNumber) {
	...
	public Transfer10 setUnitsDetails(List<Unit3> unitsDetails) {
	...
	public Transfer10 setPortfolioTransferOutRate(PercentageRate portfolioTransferOutRate) {
	...
	public Transfer10 setRounding(RoundingDirection2Code rounding) {
	...
	public Transfer10 setOwnAccountTransferIndicator(YesNoIndicator ownAccountTransferIndicator) {
	...
	public Transfer10 setAveragePrice(ActiveOrHistoricCurrencyAnd13DecimalAmount averagePrice) {
	...
	public Transfer10 setNonStandardSettlementInformation(Max350Text nonStandardSettlementInformation) {
