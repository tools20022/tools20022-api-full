...
public class CorporateActionPrice19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice19.mmIndicativeOrMarketPrice, CorporateActionPrice19.mmExercisePrice, CorporateActionPrice19.mmIssuePrice,
						CorporateActionPrice19.mmGenericCashPriceReceivedPerProduct, CorporateActionPrice19.mmGenericCashPricePaidPerProduct);
