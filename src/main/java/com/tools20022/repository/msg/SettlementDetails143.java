...
public class SettlementDetails143 {
	...
	public static final MMMessageAssociationEnd mmHoldIndicator = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSecuritiesTransactionType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlingCapacity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmStampDutyTaxBasis = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSecuritiesRTGS = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRegistration = new MMMessageAssociationEnd() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			previousVersion_lazy = () -> SettlementDetails121.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBeneficialOwnership = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmExposureType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmExposureType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCashClearingSystem = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTaxCapacity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRepurchaseType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmMarketClientSide = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBlockTrade = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmLegalRestrictions = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementSystemMethod = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmNettingEligibility = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCCPEligibility = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmLetterOfGuarantee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPartialSettlementIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmEligibleForCollateral = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails121.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> SettlementDetails121.mmObject();
			}
		});
	...
	public SettlementDetails143 setHoldIndicator(com.tools20022.repository.msg.HoldIndicator6 holdIndicator) {
	...
	public SettlementDetails143 setStampDutyTaxBasis(com.tools20022.repository.msg.GenericIdentification30 stampDutyTaxBasis) {
