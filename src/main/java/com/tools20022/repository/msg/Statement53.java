 ...
 * <li>
 * {@linkplain com.tools20022.repository.area.semt.SecuritiesSettlementTransactionAllegementReport002V06#mmStatementGeneralDetails
...
public class Statement53 {
	...
	public static final MMMessageAttribute mmReportNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Statement53.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement53.mmReportNumber, Statement53.mmQueryReference, Statement53.mmStatementIdentification, Statement53.mmStatementDateTime, Statement53.mmFrequency, Statement53.mmUpdateType,
						Statement53.mmActivityIndicator);
