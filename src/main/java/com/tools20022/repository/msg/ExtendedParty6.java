	...
	public static final MMMessageAttribute mmExtendedPartyRole = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty7.mmExtendedPartyRole);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty3.mmExtendedPartyRole;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmOtherPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty7.mmOtherPartyDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty3.mmOtherPartyDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
