...
public class ExtendedParty6 {
	...
	public static final MMMessageAttribute ExtendedPartyRole = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty3.ExtendedPartyRole;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty7.ExtendedPartyRole);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OtherPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ExtendedParty3.OtherPartyDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty7.OtherPartyDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty6.ExtendedPartyRole, com.tools20022.repository.msg.ExtendedParty6.OtherPartyDetails);
