...
public class PartyIdentificationAndAccount127 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount127.mmIdentification, PartyIdentificationAndAccount127.mmAlternateIdentification, PartyIdentificationAndAccount127.mmSafekeepingAccount,
						PartyIdentificationAndAccount127.mmProcessingIdentification, PartyIdentificationAndAccount127.mmAdditionalInformation);
