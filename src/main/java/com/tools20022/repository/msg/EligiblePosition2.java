...
public class EligiblePosition2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EligiblePosition2.mmAccountIdentification, EligiblePosition2.mmAccountOwner, EligiblePosition2.mmHoldingBalance, EligiblePosition2.mmRightsHolder);
