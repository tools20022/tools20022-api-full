...
import com.tools20022.repository.area.sese.SecuritiesSettlementAllegementRemovalAdviceV04;
...
@XmlType(name = "TransactionDetails74", propOrder = {"financialInstrumentIdentification", "tradeDate", "settlementDate", "settlementQuantity", "settlementAmount", "deliveringSettlementParties", "receivingSettlementParties", "investor"})
public class TransactionDetails74 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TransactionDetails29#mmFinancialInstrumentIdentification
	 * TransactionDetails29.mmFinancialInstrumentIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<TransactionDetails74, SecurityIdentification19>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails74.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> TransactionDetails29.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(TransactionDetails74 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(TransactionDetails74 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Optional<TradeDate5Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails74, Optional<TradeDate5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmTradeDate);
			previousVersion_lazy = () -> TransactionDetails29.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate5Choice> getValue(TransactionDetails74 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails74 obj, Optional<TradeDate5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, SettlementDate9Choice> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails74, SettlementDate9Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmSettlementDate);
			previousVersion_lazy = () -> TransactionDetails29.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate9Choice getValue(TransactionDetails74 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails74 obj, SettlementDate9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<TransactionDetails74, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmSettlementQuantity);
			previousVersion_lazy = () -> TransactionDetails29.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails74 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(TransactionDetails74 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Optional<AmountAndDirection51>> mmSettlementAmount = new MMMessageAssociationEnd<TransactionDetails74, Optional<AmountAndDirection51>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmSettlementAmount);
			previousVersion_lazy = () -> TransactionDetails29.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection51> getValue(TransactionDetails74 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(TransactionDetails74 obj, Optional<AmountAndDirection51> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Optional<SettlementParties40>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails74, Optional<SettlementParties40>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> TransactionDetails29.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties40> getValue(TransactionDetails74 obj) {
			return obj.getDeliveringSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails74 obj, Optional<SettlementParties40> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Optional<SettlementParties40>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails74, Optional<SettlementParties40>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails74.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmReceivingSettlementParties);
			previousVersion_lazy = () -> TransactionDetails29.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties40.mmObject();
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TransactionDetails29#mmInvestor
	 * TransactionDetails29.mmInvestor}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails74, Optional<PartyIdentification99>> mmInvestor = new MMMessageAssociationEnd<TransactionDetails74, Optional<PartyIdentification99>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmInvestor);
			previousVersion_lazy = () -> TransactionDetails29.mmInvestor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification99> getValue(TransactionDetails74 obj) {
			return obj.getInvestor();
		}

		@Override
		public void setValue(TransactionDetails74 obj, Optional<PartyIdentification99> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails74.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.TransactionDetails74.mmTradeDate,
						com.tools20022.repository.msg.TransactionDetails74.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails74.mmSettlementQuantity, com.tools20022.repository.msg.TransactionDetails74.mmSettlementAmount,
						com.tools20022.repository.msg.TransactionDetails74.mmDeliveringSettlementParties, com.tools20022.repository.msg.TransactionDetails74.mmReceivingSettlementParties,
						com.tools20022.repository.msg.TransactionDetails74.mmInvestor);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementAllegementRemovalAdviceV04.mmTransactionDetails, SecuritiesTransactionCancellationRequestV05.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionDetails74";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails107.mmObject());
	...
	public TransactionDetails74 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public TransactionDetails74 setTradeDate(TradeDate5Choice tradeDate) {
	...
	public TransactionDetails74 setSettlementDate(SettlementDate9Choice settlementDate) {
	...
	public TransactionDetails74 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public TransactionDetails74 setSettlementAmount(AmountAndDirection51 settlementAmount) {
	...
	public TransactionDetails74 setDeliveringSettlementParties(SettlementParties40 deliveringSettlementParties) {
	...
	public TransactionDetails74 setReceivingSettlementParties(SettlementParties40 receivingSettlementParties) {
	...
	public TransactionDetails74 setInvestor(PartyIdentification99 investor) {
