...
public class TransactionDetails74 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails74.mmFinancialInstrumentIdentification, TransactionDetails74.mmTradeDate, TransactionDetails74.mmSettlementDate, TransactionDetails74.mmSettlementQuantity,
						TransactionDetails74.mmSettlementAmount, TransactionDetails74.mmDeliveringSettlementParties, TransactionDetails74.mmReceivingSettlementParties, TransactionDetails74.mmInvestor);
