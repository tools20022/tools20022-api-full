...
public class QuantityBreakdown21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown21.mmLotNumber, QuantityBreakdown21.mmLotQuantity, QuantityBreakdown21.mmSecuritiesSubBalanceType, QuantityBreakdown21.mmLotDateTime,
						QuantityBreakdown21.mmLotPrice, QuantityBreakdown21.mmTypeOfPrice);
