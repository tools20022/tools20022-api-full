 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DeliverInformation14
...
@XmlType(name = "DeliverInformation12", propOrder = {"requestedSettlementDate", "effectiveSettlementDate", "settlementAmount", "stampDuty", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "foreignExchangeDetails",
...
public class DeliverInformation12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<DeliverInformation12, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmObject();
			isDerived = false;
			xmlTag = "ReqdSttlmDt";
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmRequestedSettlementDate);
			previousVersion_lazy = () -> DeliverInformation11.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(DeliverInformation12 obj) {
			return obj.getRequestedSettlementDate();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<DeliverInformation12, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> DeliverInformation11.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(DeliverInformation12 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<DeliverInformation12, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmSettlementAmount);
			previousVersion_lazy = () -> DeliverInformation11.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(DeliverInformation12 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<DeliverInformation12, Optional<StampDutyType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmStampDuty);
			previousVersion_lazy = () -> DeliverInformation11.mmStampDuty;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StampDutyType2Code> getValue(DeliverInformation12 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<DeliverInformation12, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmNetAmount);
			previousVersion_lazy = () -> DeliverInformation11.mmNetAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<DeliverInformation12, List<Charge20>>() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmChargeDetails);
			previousVersion_lazy = () -> DeliverInformation11.mmChargeDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charge20> getValue(DeliverInformation12 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, List<Commission17>> mmCommissionDetails = new MMMessageAssociationEnd<DeliverInformation12, List<Commission17>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmCommissionDetails);
			previousVersion_lazy = () -> DeliverInformation11.mmCommissionDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Commission17> getValue(DeliverInformation12 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, List<Commission17> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, List<Tax21>> mmTaxDetails = new MMMessageAssociationEnd<DeliverInformation12, List<Tax21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmTaxDetails);
			previousVersion_lazy = () -> DeliverInformation11.mmTaxDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Tax21> getValue(DeliverInformation12 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, List<Tax21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, List<ForeignExchangeTerms7>> mmForeignExchangeDetails = new MMMessageAssociationEnd<DeliverInformation12, List<ForeignExchangeTerms7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmForeignExchangeDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<ForeignExchangeTerms7> getValue(DeliverInformation12 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, List<ForeignExchangeTerms7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, Optional<DeliveringPartiesAndAccount9>> mmSettlementPartiesDetails = new MMMessageAssociationEnd<DeliverInformation12, Optional<DeliveringPartiesAndAccount9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmSettlementPartiesDetails);
			previousVersion_lazy = () -> DeliverInformation11.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveringPartiesAndAccount9> getValue(DeliverInformation12 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<DeliveringPartiesAndAccount9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<DeliverInformation12, Optional<PhysicalTransferType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmPhysicalTransfer);
			previousVersion_lazy = () -> DeliverInformation11.mmPhysicalTransfer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(DeliverInformation12 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation12, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<DeliverInformation12, Optional<DeliveryParameters4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmPhysicalTransferDetails);
			previousVersion_lazy = () -> DeliverInformation11.mmPhysicalTransferDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(DeliverInformation12 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<DeliveryParameters4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation12, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<DeliverInformation12, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmClientReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(DeliverInformation12 obj) {
			return obj.getClientReference();
		}

		@Override
		public void setValue(DeliverInformation12 obj, Optional<Max35Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation12.mmRequestedSettlementDate, com.tools20022.repository.msg.DeliverInformation12.mmEffectiveSettlementDate,
						com.tools20022.repository.msg.DeliverInformation12.mmSettlementAmount, com.tools20022.repository.msg.DeliverInformation12.mmStampDuty, com.tools20022.repository.msg.DeliverInformation12.mmNetAmount,
						com.tools20022.repository.msg.DeliverInformation12.mmChargeDetails, com.tools20022.repository.msg.DeliverInformation12.mmCommissionDetails, com.tools20022.repository.msg.DeliverInformation12.mmTaxDetails,
						com.tools20022.repository.msg.DeliverInformation12.mmForeignExchangeDetails, com.tools20022.repository.msg.DeliverInformation12.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.DeliverInformation12.mmPhysicalTransfer, com.tools20022.repository.msg.DeliverInformation12.mmPhysicalTransferDetails,
						com.tools20022.repository.msg.DeliverInformation12.mmClientReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInConfirmationV05.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forDeliverInformation12,
						com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule.forDeliverInformation12, com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation12);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeliverInformation12";
				definition = "Parameters applied to the settlement of a security transfer.";
				nextVersions_lazy = () -> Arrays.asList(DeliverInformation14.mmObject());
				previousVersion_lazy = () -> DeliverInformation11.mmObject();
			}
		});
	...
	public DeliverInformation12 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public DeliverInformation12 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public DeliverInformation12 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public DeliverInformation12 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public DeliverInformation12 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public DeliverInformation12 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public DeliverInformation12 setCommissionDetails(List<Commission17> commissionDetails) {
	...
	public DeliverInformation12 setTaxDetails(List<Tax21> taxDetails) {
	...
	public DeliverInformation12 setForeignExchangeDetails(List<ForeignExchangeTerms7> foreignExchangeDetails) {
	...
	public DeliverInformation12 setSettlementPartiesDetails(DeliveringPartiesAndAccount9 settlementPartiesDetails) {
	...
	public DeliverInformation12 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public DeliverInformation12 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
	...
	public DeliverInformation12 setClientReference(Max35Text clientReference) {
