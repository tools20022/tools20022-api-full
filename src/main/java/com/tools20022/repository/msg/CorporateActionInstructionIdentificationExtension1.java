...
public class CorporateActionInstructionIdentificationExtension1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionInstructionIdentificationExtension1.mmPlaceAndName, CorporateActionInstructionIdentificationExtension1.mmEntryDate);
