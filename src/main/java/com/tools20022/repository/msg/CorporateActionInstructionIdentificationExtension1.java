 ...
 * "CorporateActionInstructionIdentificationExtension1"</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
 * definition} =
 * "Provides additional information regarding corporate action instruction identification."
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionInstructionIdentificationExtension1", propOrder = {"placeAndName", "entryDate"})
public class CorporateActionInstructionIdentificationExtension1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CorporateActionInstructionIdentificationExtension1
	 * CorporateActionInstructionIdentificationExtension1}</li>
	 ...
	 * semanticMarkup} = DTCCSynonym: Entry Date</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getRegistrationStatus
	 * registrationStatus} =
	 * com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED</li>
	...
	public static final MMMessageAttribute<CorporateActionInstructionIdentificationExtension1, ISODate> mmEntryDate = new MMMessageAttribute<CorporateActionInstructionIdentificationExtension1, ISODate>() {
		{
			...
			isDerived = false;
			xmlTag = "NtryDt";
			semanticMarkup_lazy = () -> Arrays.asList(new DTCCSynonym(this, "Entry Date"));
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "EntryDate";
	...
	public CorporateActionInstructionIdentificationExtension1 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionInstructionIdentificationExtension1 setEntryDate(ISODate entryDate) {
