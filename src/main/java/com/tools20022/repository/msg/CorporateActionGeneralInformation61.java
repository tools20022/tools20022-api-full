...
public class CorporateActionGeneralInformation61 {
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes38.mmObject();
		}
	};
	...
	public CorporateActionGeneralInformation61 setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes38 underlyingSecurity) {
