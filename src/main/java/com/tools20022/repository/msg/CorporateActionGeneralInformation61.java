...
public class CorporateActionGeneralInformation61 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation61.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation61.mmCorporateActionEventIdentification, CorporateActionGeneralInformation61.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation61.mmEventType, CorporateActionGeneralInformation61.mmUnderlyingSecurity);
