 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Statement64 Statement64}</li>
 * </ul>
 * </li>
...
@XmlType(name = "Statement41", propOrder = {"reportNumber", "queryReference", "statementIdentification", "statementDateTime", "frequency", "updateType", "statementStructure", "activityIndicator"})
public class Statement41 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, Optional<Number3Choice>> mmReportNumber = new MMMessageAttribute<Statement41, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmReportNumber);
			previousVersion_lazy = () -> Statement14.mmReportNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number3Choice> getValue(Statement41 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(Statement41 obj, Optional<Number3Choice> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Statement64#mmQueryReference
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, Optional<Max35Text>> mmQueryReference = new MMMessageAttribute<Statement41, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "QryRef";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmQueryReference);
			previousVersion_lazy = () -> Statement14.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(Statement41 obj) {
			return obj.getQueryReference();
		}

		@Override
		public void setValue(Statement41 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, Optional<Max35Text>> mmStatementIdentification = new MMMessageAttribute<Statement41, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "StmtId";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmStatementIdentification);
			previousVersion_lazy = () -> Statement14.mmStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, DateAndDateTimeChoice> mmStatementDateTime = new MMMessageAttribute<Statement41, DateAndDateTimeChoice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "StmtDtTm";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmStatementDateTime);
			previousVersion_lazy = () -> Statement14.mmStatementDateTime;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DateAndDateTimeChoice getValue(Statement41 obj) {
			return obj.getStatementDateTime();
		}

		@Override
		public void setValue(Statement41 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, Optional<Frequency25Choice>> mmFrequency = new MMMessageAttribute<Statement41, Optional<Frequency25Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmFrequency);
			previousVersion_lazy = () -> Statement14.mmFrequency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Frequency25Choice> getValue(Statement41 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(Statement41 obj, Optional<Frequency25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement41, Optional<UpdateType15Choice>> mmUpdateType = new MMMessageAssociationEnd<Statement41, Optional<UpdateType15Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmUpdateType);
			previousVersion_lazy = () -> Statement14.mmUpdateType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<UpdateType15Choice> getValue(Statement41 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(Statement41 obj, Optional<UpdateType15Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, StatementStructure1Code> mmStatementStructure = new MMMessageAttribute<Statement41, StatementStructure1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "StmtStr";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmStatementStructure);
			previousVersion_lazy = () -> Statement14.mmStatementStructure;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public StatementStructure1Code getValue(Statement41 obj) {
			return obj.getStatementStructure();
		}

		@Override
		public void setValue(Statement41 obj, StatementStructure1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement41, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<Statement41, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement41.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement64.mmActivityIndicator);
			previousVersion_lazy = () -> Statement14.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(Statement41 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(Statement41 obj, YesNoIndicator value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV07.mmStatementGeneralDetails, SecuritiesTransactionPendingReportV08.mmStatementGeneralDetails);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forStatement41);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Statement41";
				definition = "Characteristics of the statement.";
				nextVersions_lazy = () -> Arrays.asList(Statement64.mmObject());
	...
	public Statement41 setReportNumber(Number3Choice reportNumber) {
	...
	public Statement41 setQueryReference(Max35Text queryReference) {
	...
	public Statement41 setStatementIdentification(Max35Text statementIdentification) {
	...
	public Statement41 setStatementDateTime(DateAndDateTimeChoice statementDateTime) {
	...
	public Statement41 setFrequency(Frequency25Choice frequency) {
	...
	public Statement41 setUpdateType(UpdateType15Choice updateType) {
	...
	public Statement41 setStatementStructure(StatementStructure1Code statementStructure) {
	...
	public Statement41 setActivityIndicator(YesNoIndicator activityIndicator) {
