...
public class PartyIdentificationAndAccount70 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount70.mmIdentification, PartyIdentificationAndAccount70.mmAlternateIdentification, PartyIdentificationAndAccount70.mmCashAccount,
						PartyIdentificationAndAccount70.mmChargesAccount, PartyIdentificationAndAccount70.mmCommissionAccount, PartyIdentificationAndAccount70.mmTaxAccount, PartyIdentificationAndAccount70.mmAdditionalInformation);
