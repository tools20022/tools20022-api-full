...
public class CorporateActionGeneralInformation6 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation6.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation6.mmCorporateActionEventIdentification, CorporateActionGeneralInformation6.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation6.mmEventType, CorporateActionGeneralInformation6.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes6 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes6 underlyingSecurity) {
