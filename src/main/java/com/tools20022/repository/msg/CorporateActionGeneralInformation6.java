...
public class CorporateActionGeneralInformation6 {
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes6.mmObject();
		}
	};
	...
	public CorporateActionGeneralInformation6 setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes6 underlyingSecurity) {
