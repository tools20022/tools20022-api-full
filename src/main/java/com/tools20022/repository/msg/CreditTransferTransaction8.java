...
import com.tools20022.repository.area.pacs.FinancialInstitutionCreditTransferV04;
 ...
 * ConstraintPreviousInstructingAgentAccountRule.forCreditTransferTransaction8}</li>
 * <li>
...
@XmlType(name = "CreditTransferTransaction8", propOrder = {"paymentIdentification", "paymentTypeInformation", "interbankSettlementAmount", "interbankSettlementDate", "settlementPriority", "settlementTimeIndication",
...
public class CreditTransferTransaction8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, PaymentIdentification3> mmPaymentIdentification = new MMMessageAssociationEnd<CreditTransferTransaction8, PaymentIdentification3>() {
		{
			businessElementTrace_lazy = () -> Payment.mmPaymentRelatedIdentifications;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			xmlTag = "PmtId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PaymentIdentification";
			definition = "Set of elements used to reference a payment instruction.";
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmPaymentIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PaymentIdentification3 getValue(CreditTransferTransaction8 obj) {
			return obj.getPaymentIdentification();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, PaymentIdentification3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<PaymentTypeInformation21>> mmPaymentTypeInformation = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<PaymentTypeInformation21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmPaymentTypeInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTypeInformation21> getValue(CreditTransferTransaction8 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<PaymentTypeInformation21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CreditTransferTransaction8, ActiveCurrencyAndAmount> mmInterbankSettlementAmount = new MMMessageAttribute<CreditTransferTransaction8, ActiveCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInterbankSettlementAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(CreditTransferTransaction8 obj) {
			return obj.getInterbankSettlementAmount();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CreditTransferTransaction8, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<CreditTransferTransaction8, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInterbankSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CreditTransferTransaction8 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CreditTransferTransaction8, Optional<Priority3Code>> mmSettlementPriority = new MMMessageAttribute<CreditTransferTransaction8, Optional<Priority3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmSettlementPriority);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Priority3Code> getValue(CreditTransferTransaction8 obj) {
			return obj.getSettlementPriority();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<Priority3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<SettlementDateTimeIndication1>> mmSettlementTimeIndication = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<SettlementDateTimeIndication1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmSettlementTimeIndication);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDateTimeIndication1> getValue(CreditTransferTransaction8 obj) {
			return obj.getSettlementTimeIndication();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<SettlementDateTimeIndication1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<SettlementTimeRequest2>> mmSettlementTimeRequest = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<SettlementTimeRequest2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmSettlementTimeRequest);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementTimeRequest2> getValue(CreditTransferTransaction8 obj) {
			return obj.getSettlementTimeRequest();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<SettlementTimeRequest2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmPreviousInstructingAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmPreviousInstructingAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(CreditTransferTransaction8 obj) {
			return obj.getPreviousInstructingAgent();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmPreviousInstructingAgentAccount = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmPreviousInstructingAgentAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccount24> getValue(CreditTransferTransaction8 obj) {
			return obj.getPreviousInstructingAgentAccount();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInstructingAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInstructedAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent1 = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent1);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmIntermediaryAgent1Account = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent1Account);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent2 = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If more than two intermediary agents are present, then IntermediaryAgent2 identifies the agent between the IntermediaryAgent1 and the IntermediaryAgent3.";
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent2);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmIntermediaryAgent2Account = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent2Account);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent3 = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If IntermediaryAgent3 is present, then it identifies the agent between the IntermediaryAgent 2 and the CreditorAgent.";
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent3);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmIntermediaryAgent3Account = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmIntermediaryAgent3Account);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmUltimateDebtor = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmUltimateDebtor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, BranchAndFinancialInstitutionIdentification5> mmDebtor = new MMMessageAssociationEnd<CreditTransferTransaction8, BranchAndFinancialInstitutionIdentification5>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmDebtor);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(CreditTransferTransaction8 obj) {
			return obj.getDebtor();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, BranchAndFinancialInstitutionIdentification5 value) {
			obj.setDebtor(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmDebtorAccount = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmDebtorAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmDebtorAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmDebtorAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmDebtorAgentAccount = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmDebtorAgentAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmCreditorAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmCreditorAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmCreditorAgentAccount = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmCreditorAgentAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, BranchAndFinancialInstitutionIdentification5> mmCreditor = new MMMessageAssociationEnd<CreditTransferTransaction8, BranchAndFinancialInstitutionIdentification5>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmCreditor);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>> mmCreditorAccount = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmCreditorAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>> mmUltimateCreditor = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmUltimateCreditor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, List<InstructionForCreditorAgent2>> mmInstructionForCreditorAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, List<InstructionForCreditorAgent2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInstructionForCreditorAgent);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<InstructionForCreditorAgent2> getValue(CreditTransferTransaction8 obj) {
			return obj.getInstructionForCreditorAgent();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, List<InstructionForCreditorAgent2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, List<InstructionForNextAgent1>> mmInstructionForNextAgent = new MMMessageAssociationEnd<CreditTransferTransaction8, List<InstructionForNextAgent1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmInstructionForNextAgent);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<InstructionForNextAgent1> getValue(CreditTransferTransaction8 obj) {
			return obj.getInstructionForNextAgent();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, List<InstructionForNextAgent1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<RemittanceInformation2>> mmRemittanceInformation = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<RemittanceInformation2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmRemittanceInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RemittanceInformation2> getValue(CreditTransferTransaction8 obj) {
			return obj.getRemittanceInformation();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<RemittanceInformation2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CreditTransferTransaction3>> mmUnderlyingCustomerCreditTransfer = new MMMessageAssociationEnd<CreditTransferTransaction8, Optional<CreditTransferTransaction3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmUnderlyingCustomerCreditTransfer);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CreditTransferTransaction3> getValue(CreditTransferTransaction8 obj) {
			return obj.getUnderlyingCustomerCreditTransfer();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, Optional<CreditTransferTransaction3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CreditTransferTransaction8, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<CreditTransferTransaction8, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction8.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(CreditTransferTransaction8 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(CreditTransferTransaction8 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CreditTransferTransaction8.mmPaymentIdentification, com.tools20022.repository.msg.CreditTransferTransaction8.mmPaymentTypeInformation,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmInterbankSettlementAmount, com.tools20022.repository.msg.CreditTransferTransaction8.mmInterbankSettlementDate,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmSettlementPriority, com.tools20022.repository.msg.CreditTransferTransaction8.mmSettlementTimeIndication,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmSettlementTimeRequest, com.tools20022.repository.msg.CreditTransferTransaction8.mmPreviousInstructingAgent,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmPreviousInstructingAgentAccount, com.tools20022.repository.msg.CreditTransferTransaction8.mmInstructingAgent,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmInstructedAgent, com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent1,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent1Account, com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent2,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent2Account, com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent3,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmIntermediaryAgent3Account, com.tools20022.repository.msg.CreditTransferTransaction8.mmUltimateDebtor,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmDebtor, com.tools20022.repository.msg.CreditTransferTransaction8.mmDebtorAccount, com.tools20022.repository.msg.CreditTransferTransaction8.mmDebtorAgent,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmDebtorAgentAccount, com.tools20022.repository.msg.CreditTransferTransaction8.mmCreditorAgent,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmCreditorAgentAccount, com.tools20022.repository.msg.CreditTransferTransaction8.mmCreditor,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmCreditorAccount, com.tools20022.repository.msg.CreditTransferTransaction8.mmUltimateCreditor,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmInstructionForCreditorAgent, com.tools20022.repository.msg.CreditTransferTransaction8.mmInstructionForNextAgent,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmRemittanceInformation, com.tools20022.repository.msg.CreditTransferTransaction8.mmUnderlyingCustomerCreditTransfer,
						com.tools20022.repository.msg.CreditTransferTransaction8.mmSupplementaryData);
				messageBuildingBlock_lazy = () -> Arrays.asList(FinancialInstitutionCreditTransferV04.mmCreditTransferTransactionInformation);
				trace_lazy = () -> CreditTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintUltimateDebtorGuideline.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintUltimateCreditorGuideline.forCreditTransferTransaction8, com.tools20022.repository.constraints.ConstraintIntermediaryAgent2Rule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgent3Rule.forCreditTransferTransaction8, com.tools20022.repository.constraints.ConstraintIntermediaryAgent1Rule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgent1AccountRule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgent2AccountRule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgent3AccountRule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintPreviousInstructingAgentAccountRule.forCreditTransferTransaction8,
						com.tools20022.repository.constraints.ConstraintDebtorAgentAccountRule.forCreditTransferTransaction8, com.tools20022.repository.constraints.ConstraintCreditorAgentAccountRule.forCreditTransferTransaction8);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CreditTransferTransaction8";
				definition = "Provide further details specific to the individual transaction(s) included in the message.";
				nextVersions_lazy = () -> Arrays.asList(CreditTransferTransaction17.mmObject());
				previousVersion_lazy = () -> CreditTransferTransaction4.mmObject();
			}
		});
	...
	public CreditTransferTransaction8 setPaymentIdentification(PaymentIdentification3 paymentIdentification) {
	...
	public CreditTransferTransaction8 setPaymentTypeInformation(PaymentTypeInformation21 paymentTypeInformation) {
	...
	public CreditTransferTransaction8 setInterbankSettlementAmount(ActiveCurrencyAndAmount interbankSettlementAmount) {
	...
	public CreditTransferTransaction8 setInterbankSettlementDate(ISODate interbankSettlementDate) {
	...
	public CreditTransferTransaction8 setSettlementPriority(Priority3Code settlementPriority) {
	...
	public CreditTransferTransaction8 setSettlementTimeIndication(SettlementDateTimeIndication1 settlementTimeIndication) {
	...
	public CreditTransferTransaction8 setSettlementTimeRequest(SettlementTimeRequest2 settlementTimeRequest) {
	...
	public CreditTransferTransaction8 setPreviousInstructingAgent(BranchAndFinancialInstitutionIdentification5 previousInstructingAgent) {
	...
	public CreditTransferTransaction8 setPreviousInstructingAgentAccount(CashAccount24 previousInstructingAgentAccount) {
	...
	public CreditTransferTransaction8 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public CreditTransferTransaction8 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent1(BranchAndFinancialInstitutionIdentification5 intermediaryAgent1) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent1Account(CashAccount24 intermediaryAgent1Account) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent2(BranchAndFinancialInstitutionIdentification5 intermediaryAgent2) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent2Account(CashAccount24 intermediaryAgent2Account) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent3(BranchAndFinancialInstitutionIdentification5 intermediaryAgent3) {
	...
	public CreditTransferTransaction8 setIntermediaryAgent3Account(CashAccount24 intermediaryAgent3Account) {
	...
	public CreditTransferTransaction8 setUltimateDebtor(BranchAndFinancialInstitutionIdentification5 ultimateDebtor) {
	...
	public CreditTransferTransaction8 setDebtor(BranchAndFinancialInstitutionIdentification5 debtor) {
	...
	public CreditTransferTransaction8 setDebtorAccount(CashAccount24 debtorAccount) {
	...
	public CreditTransferTransaction8 setDebtorAgent(BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public CreditTransferTransaction8 setDebtorAgentAccount(CashAccount24 debtorAgentAccount) {
	...
	public CreditTransferTransaction8 setCreditorAgent(BranchAndFinancialInstitutionIdentification5 creditorAgent) {
	...
	public CreditTransferTransaction8 setCreditorAgentAccount(CashAccount24 creditorAgentAccount) {
	...
	public CreditTransferTransaction8 setCreditor(BranchAndFinancialInstitutionIdentification5 creditor) {
	...
	public CreditTransferTransaction8 setCreditorAccount(CashAccount24 creditorAccount) {
	...
	public CreditTransferTransaction8 setUltimateCreditor(BranchAndFinancialInstitutionIdentification5 ultimateCreditor) {
	...
	public CreditTransferTransaction8 setInstructionForCreditorAgent(List<InstructionForCreditorAgent2> instructionForCreditorAgent) {
	...
	public CreditTransferTransaction8 setInstructionForNextAgent(List<InstructionForNextAgent1> instructionForNextAgent) {
	...
	public CreditTransferTransaction8 setRemittanceInformation(RemittanceInformation2 remittanceInformation) {
	...
	public CreditTransferTransaction8 setUnderlyingCustomerCreditTransfer(CreditTransferTransaction3 underlyingCustomerCreditTransfer) {
	...
	public CreditTransferTransaction8 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
