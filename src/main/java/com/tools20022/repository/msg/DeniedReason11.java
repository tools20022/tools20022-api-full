...
public class DeniedReason11 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DeniedReason2#Code
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason2.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason2.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason11.Code, com.tools20022.repository.msg.DeniedReason11.AdditionalReasonInformation);
