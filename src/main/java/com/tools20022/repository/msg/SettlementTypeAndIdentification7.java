...
public class SettlementTypeAndIdentification7 {
	...
	public static final MMMessageAttribute mmTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndIdentification7.mmObject();
			isDerived = false;
			xmlTag = "TxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification7.mmTransactionIdentification, SettlementTypeAndIdentification7.mmSecuritiesMovementType, SettlementTypeAndIdentification7.mmPayment);
