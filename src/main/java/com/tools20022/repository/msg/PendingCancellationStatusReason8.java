...
public class PendingCancellationStatusReason8 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingCancellationStatusReason8.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingCancellationStatusReason8.mmReasonCode, PendingCancellationStatusReason8.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingCancellationReason6Choice reasonCode) {
