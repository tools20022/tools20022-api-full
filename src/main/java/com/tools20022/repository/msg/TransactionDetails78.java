 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails78#mmPayment
...
@XmlType(name = "TransactionDetails78", propOrder = {"transactionActivity", "settlementTransactionOrCorporateActionEventType", "securitiesMovementType", "payment", "settlementParameters", "placeOfTrade", "safekeepingPlace",
...
public class TransactionDetails78 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, TransactionActivity3Choice> mmTransactionActivity = new MMMessageAssociationEnd<TransactionDetails78, TransactionActivity3Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmActivity;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails78.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionActivity";
			definition = "Specifies the type of activity to which this instruction relates.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmTransactionActivity);
			previousVersion_lazy = () -> TransactionDetails63.mmTransactionActivity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionActivity3Choice getValue(TransactionDetails78 obj) {
			return obj.getTransactionActivity();
		}

		@Override
		public void setValue(TransactionDetails78 obj, TransactionActivity3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementOrCorporateActionEvent13Choice>> mmSettlementTransactionOrCorporateActionEventType = new MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementOrCorporateActionEvent13Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails78.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmSettlementTransactionOrCorporateActionEventType);
			previousVersion_lazy = () -> TransactionDetails63.mmSettlementTransactionOrCorporateActionEventType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementOrCorporateActionEvent13Choice> getValue(TransactionDetails78 obj) {
			return obj.getSettlementTransactionOrCorporateActionEventType();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<SettlementOrCorporateActionEvent13Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionDetails78, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmSecuritiesMovementType);
			previousVersion_lazy = () -> TransactionDetails63.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionDetails78 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionDetails78 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionDetails78, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmPayment);
			previousVersion_lazy = () -> TransactionDetails63.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionDetails78 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionDetails78 obj, DeliveryReceiptType2Code value) {
			obj.setPayment(value);
		}
	};
	@XmlElement(name = "SttlmParams")
	protected SettlementDetails91 settlementParameters;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.SettlementDetails91
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementDetails91>> mmSettlementParameters = new MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementDetails91>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmSettlementParameters);
			previousVersion_lazy = () -> TransactionDetails63.mmSettlementParameters;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementDetails91.mmObject();
		}

		@Override
		public Optional<SettlementDetails91> getValue(TransactionDetails78 obj) {
			return obj.getSettlementParameters();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<SettlementDetails91> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<TransactionDetails78, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmPlaceOfTrade);
			previousVersion_lazy = () -> TransactionDetails63.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1> getValue(TransactionDetails78 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<PlaceOfTradeIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<TransactionDetails78, Optional<SafeKeepingPlace1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmSafekeepingPlace);
			previousVersion_lazy = () -> TransactionDetails63.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(TransactionDetails78 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<TransactionDetails78, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmPlaceOfClearing);
			previousVersion_lazy = () -> TransactionDetails63.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfClearingIdentification1> getValue(TransactionDetails78 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<PlaceOfClearingIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Quantity6Choice> mmPostingQuantity = new MMMessageAssociationEnd<TransactionDetails78, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmPostingQuantity);
			previousVersion_lazy = () -> TransactionDetails63.mmPostingQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails78 obj) {
			return obj.getPostingQuantity();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<TransactionDetails78, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> TransactionDetails63.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(TransactionDetails78 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<AmountAndDirection3>> mmPostingAmount = new MMMessageAssociationEnd<TransactionDetails78, Optional<AmountAndDirection3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmPostingAmount);
			previousVersion_lazy = () -> TransactionDetails63.mmPostingAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection3> getValue(TransactionDetails78 obj) {
			return obj.getPostingAmount();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<AmountAndDirection3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<AmountAndDirection21>> mmAccruedInterestAmount = new MMMessageAssociationEnd<TransactionDetails78, Optional<AmountAndDirection21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmAccruedInterestAmount);
			previousVersion_lazy = () -> TransactionDetails63.mmAccruedInterestAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection21> getValue(TransactionDetails78 obj) {
			return obj.getAccruedInterestAmount();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<AmountAndDirection21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<TradeDate5Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails78, Optional<TradeDate5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmTradeDate);
			previousVersion_lazy = () -> TransactionDetails63.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate5Choice> getValue(TransactionDetails78 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<TradeDate5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, DateAndDateTimeChoice> mmEffectiveSettlementDate = new MMMessageAssociationEnd<TransactionDetails78, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> TransactionDetails63.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DateAndDateTimeChoice getValue(TransactionDetails78 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails78 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementDate9Choice>> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementDate9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmSettlementDate);
			previousVersion_lazy = () -> TransactionDetails63.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDate9Choice> getValue(TransactionDetails78 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<SettlementDate9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAssociationEnd<TransactionDetails78, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmValueDate);
			previousVersion_lazy = () -> TransactionDetails63.mmValueDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(TransactionDetails78 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementParties40>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementParties40>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> TransactionDetails63.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties40> getValue(TransactionDetails78 obj) {
			return obj.getDeliveringSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<SettlementParties40> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementParties40>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails78, Optional<SettlementParties40>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails78.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmReceivingSettlementParties);
			previousVersion_lazy = () -> TransactionDetails63.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties40.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, Optional<YesNoIndicator>> mmReversalIndicator = new MMMessageAttribute<TransactionDetails78, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails78.mmObject();
			isDerived = false;
			xmlTag = "RvslInd";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmReversalIndicator);
			previousVersion_lazy = () -> TransactionDetails63.mmReversalIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(TransactionDetails78 obj) {
			return obj.getReversalIndicator();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails78, Optional<Max350Text>> mmTransactionAdditionalDetails = new MMMessageAttribute<TransactionDetails78, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails78.mmObject();
			isDerived = false;
			xmlTag = "TxAddtlDtls";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmTransactionAdditionalDetails);
			previousVersion_lazy = () -> TransactionDetails63.mmTransactionAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransactionDetails78 obj) {
			return obj.getTransactionAdditionalDetails();
		}

		@Override
		public void setValue(TransactionDetails78 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails78.mmTransactionActivity, com.tools20022.repository.msg.TransactionDetails78.mmSettlementTransactionOrCorporateActionEventType,
						com.tools20022.repository.msg.TransactionDetails78.mmSecuritiesMovementType, com.tools20022.repository.msg.TransactionDetails78.mmPayment, com.tools20022.repository.msg.TransactionDetails78.mmSettlementParameters,
						com.tools20022.repository.msg.TransactionDetails78.mmPlaceOfTrade, com.tools20022.repository.msg.TransactionDetails78.mmSafekeepingPlace, com.tools20022.repository.msg.TransactionDetails78.mmPlaceOfClearing,
						com.tools20022.repository.msg.TransactionDetails78.mmPostingQuantity, com.tools20022.repository.msg.TransactionDetails78.mmNumberOfDaysAccrued, com.tools20022.repository.msg.TransactionDetails78.mmPostingAmount,
						com.tools20022.repository.msg.TransactionDetails78.mmAccruedInterestAmount, com.tools20022.repository.msg.TransactionDetails78.mmTradeDate,
						com.tools20022.repository.msg.TransactionDetails78.mmEffectiveSettlementDate, com.tools20022.repository.msg.TransactionDetails78.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails78.mmValueDate,
						com.tools20022.repository.msg.TransactionDetails78.mmDeliveringSettlementParties, com.tools20022.repository.msg.TransactionDetails78.mmReceivingSettlementParties,
						com.tools20022.repository.msg.TransactionDetails78.mmReversalIndicator, com.tools20022.repository.msg.TransactionDetails78.mmTransactionAdditionalDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPostingAmountRule.forTransactionDetails78, com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forTransactionDetails78,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing1Rule.forTransactionDetails78,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing2Rule.forTransactionDetails78);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionDetails78";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails95.mmObject());
				previousVersion_lazy = () -> TransactionDetails63.mmObject();
			}
		});
	...
	public TransactionDetails78 setTransactionActivity(TransactionActivity3Choice transactionActivity) {
	...
	public TransactionDetails78 setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent13Choice settlementTransactionOrCorporateActionEventType) {
	...
	public TransactionDetails78 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionDetails78 setPayment(DeliveryReceiptType2Code payment) {
		this.payment = Objects.requireNonNull(payment);
		return this;
	}

	public Optional<SettlementDetails91> getSettlementParameters() {
		return settlementParameters == null ? Optional.empty() : Optional.of(settlementParameters);
	}

	public TransactionDetails78 setSettlementParameters(SettlementDetails91 settlementParameters) {
	...
	public TransactionDetails78 setPlaceOfTrade(PlaceOfTradeIdentification1 placeOfTrade) {
	...
	public TransactionDetails78 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public TransactionDetails78 setPlaceOfClearing(PlaceOfClearingIdentification1 placeOfClearing) {
	...
	public TransactionDetails78 setPostingQuantity(Quantity6Choice postingQuantity) {
	...
	public TransactionDetails78 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public TransactionDetails78 setPostingAmount(AmountAndDirection3 postingAmount) {
	...
	public TransactionDetails78 setAccruedInterestAmount(AmountAndDirection21 accruedInterestAmount) {
	...
	public TransactionDetails78 setTradeDate(TradeDate5Choice tradeDate) {
	...
	public TransactionDetails78 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public TransactionDetails78 setSettlementDate(SettlementDate9Choice settlementDate) {
	...
	public TransactionDetails78 setValueDate(DateAndDateTimeChoice valueDate) {
	...
	public TransactionDetails78 setDeliveringSettlementParties(SettlementParties40 deliveringSettlementParties) {
	...
	public TransactionDetails78 setReceivingSettlementParties(SettlementParties40 receivingSettlementParties) {
	...
	public TransactionDetails78 setReversalIndicator(YesNoIndicator reversalIndicator) {
	...
	public TransactionDetails78 setTransactionAdditionalDetails(Max350Text transactionAdditionalDetails) {
