...
public class RepairReason5 {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairReason5.mmCode, RepairReason5.mmAdditionalReasonInformation);
	...
	public void setCode(RepairReason9Choice code) {
		this.code = code;
	}
