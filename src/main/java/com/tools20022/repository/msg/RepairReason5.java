...
import com.tools20022.repository.choice.RepairReason9Choice;
...
@XmlType(name = "RepairReason5", propOrder = {"code", "additionalReasonInformation"})
public class RepairReason5 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RepairReason9Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * complexType} =
	 * {@linkplain com.tools20022.repository.choice.RepairReason9Choice
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RepairReason5 RepairReason5}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RepairReason5.mmCode, com.tools20022.repository.msg.RepairReason5.mmAdditionalReasonInformation);
	...
	public RepairReason9Choice getCode() {
		return code;
	}

	public RepairReason5 setCode(RepairReason9Choice code) {
	...
	public RepairReason5 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
