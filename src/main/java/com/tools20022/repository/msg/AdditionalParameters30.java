 ...
 * AdditionalParameters30.ClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
...
public class AdditionalParameters30 {
	...
	public static final MMMessageAttribute PreConfirmation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalParameters23.PreConfirmation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlement = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalParameters23.PartialSettlement;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TripartyAgentServiceProviderCollateralTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalParameters23.TripartyAgentCollateralTransactionIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ClientTripartyCollateralTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalParameters23.ClientTripartyCollateralTransactionIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters30.PreConfirmation, com.tools20022.repository.msg.AdditionalParameters30.PartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters30.TripartyAgentServiceProviderCollateralTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters30.ClientTripartyCollateralTransactionIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementTransactionReversalAdviceV06.AdditionalParameters);
