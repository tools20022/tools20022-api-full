...
public class StatusAndReason21 {
	...
	public static final MMMessageAssociationEnd mmStatusAndReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> StatusAndReason21.mmObject();
			isDerived = false;
			xmlTag = "StsAndRsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StatusAndReason21.mmStatusAndReason, StatusAndReason21.mmTransaction);
	...
	public void setStatusAndReason(Status16Choice statusAndReason) {
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction37> transaction) {
