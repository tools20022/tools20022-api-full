 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction18#Creditor
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV06#PaymentInformation
 * CustomerDirectDebitInitiationV06.PaymentInformation}</li>
 * </ul>
 * </li>
 * <li>
...
public class PaymentInstruction18 {
	...
	public static final MMMessageAttribute PaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.PaymentInformationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.PaymentInformationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.PaymentMethod;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.PaymentMethod);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute BatchBooking = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.BatchBooking;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.BatchBooking);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfTransactions = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.NumberOfTransactions;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.NumberOfTransactions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ControlSum = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.ControlSum;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.ControlSum);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.PaymentTypeInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.PaymentTypeInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.RequestedCollectionDate;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.RequestedCollectionDate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Creditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.Creditor;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.Creditor);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.CreditorAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.CreditorAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.CreditorAgent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.CreditorAgent);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.CreditorAgentAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.CreditorAgentAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd UltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.UltimateCreditor;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.UltimateCreditor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.ChargeBearer;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.ChargeBearer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChargesAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.ChargesAccount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.ChargesAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ChargesAccountAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.ChargesAccountAgent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.ChargesAccountAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorSchemeIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.CreditorSchemeIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.CreditorSchemeIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DirectDebitTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction15.DirectDebitTransactionInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction21.DirectDebitTransactionInformation);
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction18.PaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction18.PaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction18.BatchBooking, com.tools20022.repository.msg.PaymentInstruction18.NumberOfTransactions, com.tools20022.repository.msg.PaymentInstruction18.ControlSum,
						com.tools20022.repository.msg.PaymentInstruction18.PaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction18.RequestedCollectionDate, com.tools20022.repository.msg.PaymentInstruction18.Creditor,
						com.tools20022.repository.msg.PaymentInstruction18.CreditorAccount, com.tools20022.repository.msg.PaymentInstruction18.CreditorAgent, com.tools20022.repository.msg.PaymentInstruction18.CreditorAgentAccount,
						com.tools20022.repository.msg.PaymentInstruction18.UltimateCreditor, com.tools20022.repository.msg.PaymentInstruction18.ChargeBearer, com.tools20022.repository.msg.PaymentInstruction18.ChargesAccount,
						com.tools20022.repository.msg.PaymentInstruction18.ChargesAccountAgent, com.tools20022.repository.msg.PaymentInstruction18.CreditorSchemeIdentification,
						com.tools20022.repository.msg.PaymentInstruction18.DirectDebitTransactionInformation);
				trace_lazy = () -> PaymentInstruction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerDirectDebitInitiationV06.PaymentInformation);
