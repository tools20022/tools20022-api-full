...
public class PaymentInstruction18 {
	...
	public static final MMMessageAttribute mmPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PaymentInstruction18.mmObject();
			isDerived = false;
			xmlTag = "PmtInfId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction18.mmPaymentInformationIdentification, PaymentInstruction18.mmPaymentMethod, PaymentInstruction18.mmBatchBooking, PaymentInstruction18.mmNumberOfTransactions,
						PaymentInstruction18.mmControlSum, PaymentInstruction18.mmPaymentTypeInformation, PaymentInstruction18.mmRequestedCollectionDate, PaymentInstruction18.mmCreditor, PaymentInstruction18.mmCreditorAccount,
						PaymentInstruction18.mmCreditorAgent, PaymentInstruction18.mmCreditorAgentAccount, PaymentInstruction18.mmUltimateCreditor, PaymentInstruction18.mmChargeBearer, PaymentInstruction18.mmChargesAccount,
						PaymentInstruction18.mmChargesAccountAgent, PaymentInstruction18.mmCreditorSchemeIdentification, PaymentInstruction18.mmDirectDebitTransactionInformation);
	...
	public void setDirectDebitTransactionInformation(List<com.tools20022.repository.msg.DirectDebitTransactionInformation19> directDebitTransactionInformation) {
