 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmBatchBooking
 * PaymentInstruction18.mmBatchBooking}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmNumberOfTransactions
 * PaymentInstruction18.mmNumberOfTransactions}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmControlSum
 * PaymentInstruction18.mmControlSum}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmCreditor
 * PaymentInstruction18.mmCreditor}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmCreditorAccount
 * PaymentInstruction18.mmCreditorAccount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmCreditorAgent
 * PaymentInstruction18.mmCreditorAgent}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmCreditorAgentAccount
 * PaymentInstruction18.mmCreditorAgentAccount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmUltimateCreditor
 * PaymentInstruction18.mmUltimateCreditor}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmChargesAccountAgent
 * PaymentInstruction18.mmChargesAccountAgent}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction18#mmCreditorSchemeIdentification
 * PaymentInstruction18.mmCreditorSchemeIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChargesAccountRule#forPaymentInstruction18
 * ConstraintChargesAccountRule.forPaymentInstruction18}</li>
 * <li>
...
@XmlType(name = "PaymentInstruction18", propOrder = {"paymentInformationIdentification", "paymentMethod", "batchBooking", "numberOfTransactions", "controlSum", "paymentTypeInformation", "requestedCollectionDate", "creditor",
...
public class PaymentInstruction18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, Max35Text> mmPaymentInformationIdentification = new MMMessageAttribute<PaymentInstruction18, Max35Text>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			xmlTag = "PmtInfId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmPaymentInformationIdentification);
			previousVersion_lazy = () -> PaymentInstruction15.mmPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(PaymentInstruction18 obj) {
			return obj.getPaymentInformationIdentification();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, PaymentMethod2Code> mmPaymentMethod = new MMMessageAttribute<PaymentInstruction18, PaymentMethod2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmPaymentMethod);
			previousVersion_lazy = () -> PaymentInstruction15.mmPaymentMethod;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PaymentMethod2Code getValue(PaymentInstruction18 obj) {
			return obj.getPaymentMethod();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, PaymentMethod2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<PaymentInstruction18, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmBatchBooking);
			previousVersion_lazy = () -> PaymentInstruction15.mmBatchBooking;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(PaymentInstruction18 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, Optional<Max15NumericText>> mmNumberOfTransactions = new MMMessageAttribute<PaymentInstruction18, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			xmlTag = "NbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmNumberOfTransactions);
			previousVersion_lazy = () -> PaymentInstruction15.mmNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(PaymentInstruction18 obj) {
			return obj.getNumberOfTransactions();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, Optional<DecimalNumber>> mmControlSum = new MMMessageAttribute<PaymentInstruction18, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			xmlTag = "CtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmControlSum);
			previousVersion_lazy = () -> PaymentInstruction15.mmControlSum;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(PaymentInstruction18 obj) {
			return obj.getControlSum();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<PaymentTypeInformation24>> mmPaymentTypeInformation = new MMMessageAssociationEnd<PaymentInstruction18, Optional<PaymentTypeInformation24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmPaymentTypeInformation);
			previousVersion_lazy = () -> PaymentInstruction15.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTypeInformation24> getValue(PaymentInstruction18 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<PaymentTypeInformation24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, ISODate> mmRequestedCollectionDate = new MMMessageAttribute<PaymentInstruction18, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmRequestedCollectionDate);
			previousVersion_lazy = () -> PaymentInstruction15.mmRequestedCollectionDate;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(PaymentInstruction18 obj) {
			return obj.getRequestedCollectionDate();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, PartyIdentification43> mmCreditor = new MMMessageAssociationEnd<PaymentInstruction18, PartyIdentification43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmCreditor);
			previousVersion_lazy = () -> PaymentInstruction15.mmCreditor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PartyIdentification43 getValue(PaymentInstruction18 obj) {
			return obj.getCreditor();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, PartyIdentification43 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, CashAccount24> mmCreditorAccount = new MMMessageAssociationEnd<PaymentInstruction18, CashAccount24>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmCreditorAccount);
			previousVersion_lazy = () -> PaymentInstruction15.mmCreditorAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CashAccount24 getValue(PaymentInstruction18 obj) {
			return obj.getCreditorAccount();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, CashAccount24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, BranchAndFinancialInstitutionIdentification5> mmCreditorAgent = new MMMessageAssociationEnd<PaymentInstruction18, BranchAndFinancialInstitutionIdentification5>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmCreditorAgent);
			previousVersion_lazy = () -> PaymentInstruction15.mmCreditorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(PaymentInstruction18 obj) {
			return obj.getCreditorAgent();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<CashAccount24>> mmCreditorAgentAccount = new MMMessageAssociationEnd<PaymentInstruction18, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmCreditorAgentAccount);
			previousVersion_lazy = () -> PaymentInstruction15.mmCreditorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
		...
		@Override
		public Optional<CashAccount24> getValue(PaymentInstruction18 obj) {
			return obj.getCreditorAgentAccount();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<PartyIdentification43>> mmUltimateCreditor = new MMMessageAssociationEnd<PaymentInstruction18, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmUltimateCreditor);
			previousVersion_lazy = () -> PaymentInstruction15.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
		...
		@Override
		public Optional<PartyIdentification43> getValue(PaymentInstruction18 obj) {
			return obj.getUltimateCreditor();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction18, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentInstruction18, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmChargeBearer);
			previousVersion_lazy = () -> PaymentInstruction15.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentInstruction18 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<CashAccount24>> mmChargesAccount = new MMMessageAssociationEnd<PaymentInstruction18, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmChargesAccount);
			previousVersion_lazy = () -> PaymentInstruction15.mmChargesAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<BranchAndFinancialInstitutionIdentification5>> mmChargesAccountAgent = new MMMessageAssociationEnd<PaymentInstruction18, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmChargesAccountAgent);
			previousVersion_lazy = () -> PaymentInstruction15.mmChargesAccountAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentInstruction18 obj) {
			return obj.getChargesAccountAgent();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, Optional<PartyIdentification43>> mmCreditorSchemeIdentification = new MMMessageAssociationEnd<PaymentInstruction18, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmCreditorSchemeIdentification);
			previousVersion_lazy = () -> PaymentInstruction15.mmCreditorSchemeIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
	...
	protected List<DirectDebitTransactionInformation19> directDebitTransactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction18, List<DirectDebitTransactionInformation19>> mmDirectDebitTransactionInformation = new MMMessageAssociationEnd<PaymentInstruction18, List<DirectDebitTransactionInformation19>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmDirectDebitTransactionInformation);
			previousVersion_lazy = () -> PaymentInstruction15.mmDirectDebitTransactionInformation;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> DirectDebitTransactionInformation19.mmObject();
		}

		@Override
		public List<DirectDebitTransactionInformation19> getValue(PaymentInstruction18 obj) {
			return obj.getDirectDebitTransactionInformation();
		}

		@Override
		public void setValue(PaymentInstruction18 obj, List<DirectDebitTransactionInformation19> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction18.mmPaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction18.mmPaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction18.mmBatchBooking, com.tools20022.repository.msg.PaymentInstruction18.mmNumberOfTransactions, com.tools20022.repository.msg.PaymentInstruction18.mmControlSum,
						com.tools20022.repository.msg.PaymentInstruction18.mmPaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction18.mmRequestedCollectionDate,
						com.tools20022.repository.msg.PaymentInstruction18.mmCreditor, com.tools20022.repository.msg.PaymentInstruction18.mmCreditorAccount, com.tools20022.repository.msg.PaymentInstruction18.mmCreditorAgent,
						com.tools20022.repository.msg.PaymentInstruction18.mmCreditorAgentAccount, com.tools20022.repository.msg.PaymentInstruction18.mmUltimateCreditor, com.tools20022.repository.msg.PaymentInstruction18.mmChargeBearer,
						com.tools20022.repository.msg.PaymentInstruction18.mmChargesAccount, com.tools20022.repository.msg.PaymentInstruction18.mmChargesAccountAgent,
						com.tools20022.repository.msg.PaymentInstruction18.mmCreditorSchemeIdentification, com.tools20022.repository.msg.PaymentInstruction18.mmDirectDebitTransactionInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerDirectDebitInitiationV06.mmPaymentInformation);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintChargeBearerRule.forPaymentInstruction18,
						com.tools20022.repository.constraints.ConstraintUltimateCreditorGuideline.forPaymentInstruction18, com.tools20022.repository.constraints.ConstraintChargesAccountRule.forPaymentInstruction18,
						com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule.forPaymentInstruction18, com.tools20022.repository.constraints.ConstraintCreditorSchemeIdentificationRule.forPaymentInstruction18,
						com.tools20022.repository.constraints.ConstraintUltimateCreditorRule.forPaymentInstruction18, com.tools20022.repository.constraints.ConstraintChargesAccountAgentRule.forPaymentInstruction18);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentInstruction18";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentInstruction21.mmObject());
				previousVersion_lazy = () -> PaymentInstruction15.mmObject();
			}
		});
	...
	public PaymentInstruction18 setPaymentInformationIdentification(Max35Text paymentInformationIdentification) {
	...
	public PaymentInstruction18 setPaymentMethod(PaymentMethod2Code paymentMethod) {
	...
	public PaymentInstruction18 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public PaymentInstruction18 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public PaymentInstruction18 setControlSum(DecimalNumber controlSum) {
	...
	public PaymentInstruction18 setPaymentTypeInformation(PaymentTypeInformation24 paymentTypeInformation) {
	...
	public PaymentInstruction18 setRequestedCollectionDate(ISODate requestedCollectionDate) {
	...
	public PaymentInstruction18 setCreditor(PartyIdentification43 creditor) {
	...
	public PaymentInstruction18 setCreditorAccount(CashAccount24 creditorAccount) {
	...
	public PaymentInstruction18 setCreditorAgent(BranchAndFinancialInstitutionIdentification5 creditorAgent) {
	...
	public PaymentInstruction18 setCreditorAgentAccount(CashAccount24 creditorAgentAccount) {
	...
	public PaymentInstruction18 setUltimateCreditor(PartyIdentification43 ultimateCreditor) {
	...
	public PaymentInstruction18 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentInstruction18 setChargesAccount(CashAccount24 chargesAccount) {
	...
	public PaymentInstruction18 setChargesAccountAgent(BranchAndFinancialInstitutionIdentification5 chargesAccountAgent) {
	...
	public PaymentInstruction18 setCreditorSchemeIdentification(PartyIdentification43 creditorSchemeIdentification) {
		this.creditorSchemeIdentification = creditorSchemeIdentification;
		return this;
	}

	public List<DirectDebitTransactionInformation19> getDirectDebitTransactionInformation() {
	...
	public PaymentInstruction18 setDirectDebitTransactionInformation(List<DirectDebitTransactionInformation19> directDebitTransactionInformation) {
