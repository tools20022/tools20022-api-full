...
public class Transaction42 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction42.mmAccountOwnerTransactionIdentification, Transaction42.mmAccountServicerTransactionIdentification, Transaction42.mmMarketInfrastructureTransactionIdentification,
						Transaction42.mmProcessorTransactionIdentification, Transaction42.mmTradeIdentification, Transaction42.mmPoolIdentification, Transaction42.mmCommonIdentification, Transaction42.mmCorporateActionEventIdentification,
						Transaction42.mmTripartyAgentCollateralTransactionIdentification, Transaction42.mmClientTripartyCollateralTransactionIdentification, Transaction42.mmClientCollateralInstructionIdentification,
						Transaction42.mmTripartyCollateralInstructionIdentification, Transaction42.mmTransactionDetails);
