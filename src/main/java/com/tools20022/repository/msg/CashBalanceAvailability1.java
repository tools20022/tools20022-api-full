...
/**
 * Set of elements used to indicate when the booked amount of money will become
...
@XmlType(name = "CashBalanceAvailability1", propOrder = {"date", "amount", "creditDebitIndicator"})
public class CashBalanceAvailability1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashBalanceAvailability1, CashBalanceAvailabilityDate1> mmDate = new MMMessageAssociationEnd<CashBalanceAvailability1, CashBalanceAvailabilityDate1>() {
		{
			businessElementTrace_lazy = () -> CashAvailability.mmDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashBalanceAvailability1.mmObject();
			isDerived = false;
			xmlTag = "Dt";
		...
		@Override
		public CashBalanceAvailabilityDate1 getValue(CashBalanceAvailability1 obj) {
			return obj.getDate();
		}

		@Override
		public void setValue(CashBalanceAvailability1 obj, CashBalanceAvailabilityDate1 value) {
			obj.setDate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalanceAvailability1, CurrencyAndAmount> mmAmount = new MMMessageAttribute<CashBalanceAvailability1, CurrencyAndAmount>() {
		{
		...
		@Override
		public CurrencyAndAmount getValue(CashBalanceAvailability1 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(CashBalanceAvailability1 obj, CurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashBalanceAvailability1, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashBalanceAvailability1, CreditDebitCode>() {
		{
		...
		@Override
		public CreditDebitCode getValue(CashBalanceAvailability1 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashBalanceAvailability1 obj, CreditDebitCode value) {
	...
	public CashBalanceAvailability1 setDate(CashBalanceAvailabilityDate1 date) {
	...
	public CashBalanceAvailability1 setAmount(CurrencyAndAmount amount) {
	...
	public CashBalanceAvailability1 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
