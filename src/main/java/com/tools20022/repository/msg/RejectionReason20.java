...
public class RejectionReason20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason20.mmCode, RejectionReason20.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason18Choice code) {
		this.code = code;
	}
