...
public class SettlementParties43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementParties43.mmDepository, SettlementParties43.mmParty1, SettlementParties43.mmParty2, SettlementParties43.mmParty3);
