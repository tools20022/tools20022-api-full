...
import com.tools20022.repository.msg.PartyIdentification102;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties43#mmParty1
 * SettlementParties43.mmParty1}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties43#mmParty2
 * SettlementParties43.mmParty2}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties43#mmParty3
...
@XmlType(name = "SettlementParties43", propOrder = {"depository", "party1", "party2", "party3"})
public class SettlementParties43 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Dpstry")
	protected PartyIdentification102 depository;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentification102>> mmDepository = new MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentification102>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties43.mmObject();
			isDerived = false;
			xmlTag = "Dpstry";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementParties61.mmDepository);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification102> getValue(SettlementParties43 obj) {
			return obj.getDepository();
		}

		@Override
		public void setValue(SettlementParties43 obj, Optional<PartyIdentification102> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SettlementParties61#mmParty1
	 * SettlementParties61.mmParty1}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>> mmParty1 = new MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties43.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementParties61.mmParty1);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentificationAndAccount128> getValue(SettlementParties43 obj) {
			return obj.getParty1();
		}

		@Override
		public void setValue(SettlementParties43 obj, Optional<PartyIdentificationAndAccount128> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SettlementParties61#mmParty2
	 * SettlementParties61.mmParty2}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>> mmParty2 = new MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties43.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementParties61.mmParty2);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentificationAndAccount128.mmObject();
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SettlementParties61#mmParty3
	 * SettlementParties61.mmParty3}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>> mmParty3 = new MMMessageAssociationEnd<SettlementParties43, Optional<PartyIdentificationAndAccount128>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties43.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementParties61.mmParty3);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentificationAndAccount128.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties43.mmDepository, com.tools20022.repository.msg.SettlementParties43.mmParty1,
						com.tools20022.repository.msg.SettlementParties43.mmParty2, com.tools20022.repository.msg.SettlementParties43.mmParty3);
				trace_lazy = () -> SecuritiesSettlementPartyRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintParty2PresenceRule.forSettlementParties43, com.tools20022.repository.constraints.ConstraintParty3PresenceRule.forSettlementParties43);
	...
	public Optional<PartyIdentification102> getDepository() {
		return depository == null ? Optional.empty() : Optional.of(depository);
	}

	public SettlementParties43 setDepository(PartyIdentification102 depository) {
	...
	public SettlementParties43 setParty1(PartyIdentificationAndAccount128 party1) {
		this.party1 = party1;
		return this;
	}
	...
	public SettlementParties43 setParty2(PartyIdentificationAndAccount128 party2) {
		this.party2 = party2;
		return this;
	}
	...
	public SettlementParties43 setParty3(PartyIdentificationAndAccount128 party3) {
		this.party3 = party3;
		return this;
	}
}