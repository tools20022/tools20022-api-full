...
public class PendingProcessingReason11 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason11.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason11.mmCode, PendingProcessingReason11.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason13Choice code) {
		this.code = code;
	}
