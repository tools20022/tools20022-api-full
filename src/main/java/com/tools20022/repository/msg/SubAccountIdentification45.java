...
public class SubAccountIdentification45 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification45.mmAccountOwner, SubAccountIdentification45.mmSafekeepingAccount, SubAccountIdentification45.mmActivityIndicator,
						SubAccountIdentification45.mmBalanceForSubAccount);
