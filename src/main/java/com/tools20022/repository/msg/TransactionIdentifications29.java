 ...
 * TransactionIdentifications29.mmMarketInfrastructureTransactionIdentification}
 * </li>
 * <li>
...
@XmlType(name = "TransactionIdentifications29", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification"})
public class TransactionIdentifications29 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications29, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications29, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications29.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			previousVersion_lazy = () -> TransactionIdentifications15.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionIdentifications29 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications29 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications15.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionIdentifications29 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications29 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications15.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<TransactionIdentifications29, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionIdentifications15.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionIdentifications29.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications29.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.TransactionIdentifications29.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications29.mmProcessorTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementStatusAdviceV04.mmTransactionIdentification, SecuritiesSettlementTransactionAuditTrailReportV03.mmTransactionIdentification,
						IntraPositionMovementStatusAdviceV05.mmTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransactionIdentifications29);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionIdentifications29";
				definition = "Unique identifier of a document, message or transaction.";
				previousVersion_lazy = () -> TransactionIdentifications15.mmObject();
			}
		});
	...
	public TransactionIdentifications29 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionIdentifications29 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionIdentifications29 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public TransactionIdentifications29 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
