...
public class TransactionIdentifications29 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications29.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications29.mmAccountOwnerTransactionIdentification, TransactionIdentifications29.mmAccountServicerTransactionIdentification,
						TransactionIdentifications29.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications29.mmProcessorTransactionIdentification);
