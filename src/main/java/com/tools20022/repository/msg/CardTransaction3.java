...
@XmlType(name = "CardTransaction3", propOrder = {"acceptorTransactionDateTime", "initiatorTransactionIdentification", "initiatorIdentification"})
public class CardTransaction3 {
	...
	public CardTransaction3 setAcceptorTransactionDateTime(ISODateTime acceptorTransactionDateTime) {
	...
	public CardTransaction3 setInitiatorTransactionIdentification(Max35Text initiatorTransactionIdentification) {
	...
	public CardTransaction3 setInitiatorIdentification(Max35Text initiatorIdentification) {
		this.initiatorIdentification = Objects.requireNonNull(initiatorIdentification);
		return this;
	}
}