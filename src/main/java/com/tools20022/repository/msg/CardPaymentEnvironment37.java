...
public class CardPaymentEnvironment37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment37.mmAcquirer, CardPaymentEnvironment37.mmMerchantIdentification, CardPaymentEnvironment37.mmPOIIdentification, CardPaymentEnvironment37.mmPOIComponent);
