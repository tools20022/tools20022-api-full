...
import com.tools20022.repository.choice.MarketType2Choice;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification5#mmType
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule#forMarketIdentification5
 * ConstraintCoexistence35to30TextFieldRule.forMarketIdentification5}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule#forMarketIdentification5
 * ConstraintMarketTypeAndIdentificationRule.forMarketIdentification5}</li>
 * </ul>
 * </li>
 * <li>
...
public class MarketIdentification5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification5, Optional<MarketIdentification1Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification5, Optional<MarketIdentification1Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification5.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public Optional<MarketIdentification1Choice> getValue(MarketIdentification5 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification5 obj, Optional<MarketIdentification1Choice> value) {
			obj.setIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "Tp", required = true)
	protected MarketType2Choice type;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.choice.MarketType2Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification5, MarketType2Choice> mmType = new MMMessageAssociationEnd<MarketIdentification5, MarketType2Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> MarketType2Choice.mmObject();
		}

		@Override
		public MarketType2Choice getValue(MarketIdentification5 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification5 obj, MarketType2Choice value) {
			obj.setType(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification5.mmIdentification, com.tools20022.repository.msg.MarketIdentification5.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule.forMarketIdentification5,
						com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification5);
	...
	public MarketIdentification5 setIdentification(MarketIdentification1Choice identification) {
	...
	public MarketIdentification5 setType(MarketType2Choice type) {
