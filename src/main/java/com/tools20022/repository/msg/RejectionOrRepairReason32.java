...
import com.tools20022.repository.choice.RejectionAndRepairReason32Choice;
...
@XmlType(name = "RejectionOrRepairReason32", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason32 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd")
	protected List<RejectionAndRepairReason32Choice> code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<RejectionOrRepairReason32, List<RejectionAndRepairReason32Choice>> mmCode = new MMMessageAssociationEnd<RejectionOrRepairReason32, List<RejectionAndRepairReason32Choice>>() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairReason20.mmCode;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<RejectionOrRepairReason32, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionOrRepairReason32, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairReason20.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason32.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason32.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RejectionOrRepairReason32";
				definition = "Reason for the rejection or repair status.";
				previousVersion_lazy = () -> RejectionOrRepairReason20.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public List<RejectionAndRepairReason32Choice> getCode() {
		return code == null ? code = new ArrayList<>() : code;
	}

	public RejectionOrRepairReason32 setCode(List<RejectionAndRepairReason32Choice> code) {
	...
	public RejectionOrRepairReason32 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
