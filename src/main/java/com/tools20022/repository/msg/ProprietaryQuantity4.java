 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forProprietaryQuantity4
 * ConstraintCoexistenceQuantityRule.forProprietaryQuantity4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule#forProprietaryQuantity4
 * ConstraintCoexistenceIssuerSchemeNameRule.forProprietaryQuantity4}</li>
 * </ul>
 * </li>
 * <li>
...
public class ProprietaryQuantity4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity4, RestrictedFINDecimalNumber> mmQuantity = new MMMessageAttribute<ProprietaryQuantity4, RestrictedFINDecimalNumber>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ProprietaryQuantity4.mmObject();
			isDerived = false;
			xmlTag = "Qty";
		...
		@Override
		public RestrictedFINDecimalNumber getValue(ProprietaryQuantity4 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(ProprietaryQuantity4 obj, RestrictedFINDecimalNumber value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity4, Exact4AlphaNumericText> mmQuantityType = new MMMessageAttribute<ProprietaryQuantity4, Exact4AlphaNumericText>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ProprietaryQuantity4.mmObject();
			isDerived = false;
			xmlTag = "QtyTp";
		...
		@Override
		public Exact4AlphaNumericText getValue(ProprietaryQuantity4 obj) {
			return obj.getQuantityType();
		}

		@Override
		public void setValue(ProprietaryQuantity4 obj, Exact4AlphaNumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity4, Max4AlphaNumericText> mmIssuer = new MMMessageAttribute<ProprietaryQuantity4, Max4AlphaNumericText>() {
		{
		...
		@Override
		public Max4AlphaNumericText getValue(ProprietaryQuantity4 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(ProprietaryQuantity4 obj, Max4AlphaNumericText value) {
			obj.setIssuer(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ProprietaryQuantity4, Optional<Max4AlphaNumericText>> mmSchemeName = new MMMessageAttribute<ProprietaryQuantity4, Optional<Max4AlphaNumericText>>() {
		{
		...
		@Override
		public Optional<Max4AlphaNumericText> getValue(ProprietaryQuantity4 obj) {
			return obj.getSchemeName();
		}

		@Override
		public void setValue(ProprietaryQuantity4 obj, Optional<Max4AlphaNumericText> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ProprietaryQuantity4.mmQuantity, com.tools20022.repository.msg.ProprietaryQuantity4.mmQuantityType,
						com.tools20022.repository.msg.ProprietaryQuantity4.mmIssuer, com.tools20022.repository.msg.ProprietaryQuantity4.mmSchemeName);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forProprietaryQuantity4,
						com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule.forProprietaryQuantity4);
	...
	public ProprietaryQuantity4 setQuantity(RestrictedFINDecimalNumber quantity) {
	...
	public ProprietaryQuantity4 setQuantityType(Exact4AlphaNumericText quantityType) {
	...
	public ProprietaryQuantity4 setIssuer(Max4AlphaNumericText issuer) {
	...
	public ProprietaryQuantity4 setSchemeName(Max4AlphaNumericText schemeName) {
