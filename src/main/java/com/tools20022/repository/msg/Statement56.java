...
public class Statement56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement56.mmReportNumber, Statement56.mmQueryReference, Statement56.mmStatementIdentification, Statement56.mmStatementPeriod, Statement56.mmFrequency, Statement56.mmUpdateType,
						Statement56.mmStatementBasis, Statement56.mmActivityIndicator, Statement56.mmSubAccountIndicator);
	...
	public void setStatementBasis(StatementBasis12Choice statementBasis) {
