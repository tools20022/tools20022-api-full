 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forReceiveInformation5
 * ConstraintPhysicalTransferDetailsRule.forReceiveInformation5}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule#forReceiveInformation5
 * ConstraintReceiversCustodianDetailsRule.forReceiveInformation5}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule#forReceiveInformation5
 * ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation5}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation9
...
@XmlType(name = "ReceiveInformation5", propOrder = {"settlementAmount", "stampDuty", "netAmount", "settlementPartiesDetails", "chargeDetails", "commissionDetails", "taxDetails", "physicalTransfer", "physicalTransferDetails"})
public class ReceiveInformation5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation5, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation5, Optional<ActiveCurrencyAndAmount>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation5.mmObject();
			isDerived = false;
			xmlTag = "SttlmAmt";
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation5 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation5, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation5, Optional<StampDutyType2Code>>() {
		{
		...
		@Override
		public Optional<StampDutyType2Code> getValue(ReceiveInformation5 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation5, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation5, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation5, ReceivingPartiesAndAccount8> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation5, ReceivingPartiesAndAccount8>() {
		{
		...
		@Override
		public ReceivingPartiesAndAccount8 getValue(ReceiveInformation5 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, ReceivingPartiesAndAccount8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation5, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation5, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(ReceiveInformation5 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation5, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation5, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(ReceiveInformation5 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation5, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation5, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(ReceiveInformation5 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation5, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation5, Optional<PhysicalTransferType1Code>>() {
		{
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(ReceiveInformation5 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation5, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation5, Optional<DeliveryParameters4>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation5 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation5 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation5.mmSettlementAmount, com.tools20022.repository.msg.ReceiveInformation5.mmStampDuty,
						com.tools20022.repository.msg.ReceiveInformation5.mmNetAmount, com.tools20022.repository.msg.ReceiveInformation5.mmSettlementPartiesDetails, com.tools20022.repository.msg.ReceiveInformation5.mmChargeDetails,
						com.tools20022.repository.msg.ReceiveInformation5.mmCommissionDetails, com.tools20022.repository.msg.ReceiveInformation5.mmTaxDetails, com.tools20022.repository.msg.ReceiveInformation5.mmPhysicalTransfer,
						com.tools20022.repository.msg.ReceiveInformation5.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutInstructionV03.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation5,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation5, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation5);
				...
				name = "ReceiveInformation5";
				definition = "Parameters applied to the settlement of a security transfer.";
				nextVersions_lazy = () -> Arrays.asList(ReceiveInformation9.mmObject());
	...
	public ReceiveInformation5 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation5 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation5 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation5 setSettlementPartiesDetails(ReceivingPartiesAndAccount8 settlementPartiesDetails) {
	...
	public ReceiveInformation5 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public ReceiveInformation5 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public ReceiveInformation5 setTaxDetails(List<Tax15> taxDetails) {
	...
	public ReceiveInformation5 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation5 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
