...
public class UnderlyingTransaction5 {
	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformationAndCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnderlyingTransaction5.mmObject();
			isDerived = false;
	...
	protected List<com.tools20022.repository.msg.PaymentTransaction38> transactionInformation;
	/**
	...
	public static final MMMessageAssociationEnd mmTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentTransaction38.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnderlyingTransaction5.mmOriginalGroupInformationAndCancellation, UnderlyingTransaction5.mmTransactionInformation);
	...
	public void setTransactionInformation(List<com.tools20022.repository.msg.PaymentTransaction38> transactionInformation) {
