...
public class AdditionalParameters10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters10.mmPartialSettlement, AdditionalParameters10.mmPreviousPartialConfirmationIdentification, AdditionalParameters10.mmAccountOwnerTransactionIdentification,
						AdditionalParameters10.mmAccountServicerTransactionIdentification, AdditionalParameters10.mmPoolIdentification, AdditionalParameters10.mmCorporateActionEventIdentification,
						AdditionalParameters10.mmMarketInfrastructureTransactionIdentification, AdditionalParameters10.mmProcessorTransactionIdentification);
