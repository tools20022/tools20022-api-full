 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters10
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters10", propOrder = {"partialSettlement", "previousPartialConfirmationIdentification", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "poolIdentification",
...
public class AdditionalParameters10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters10, Optional<PartialSettlement2Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmPartialSettlementType;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters10.mmObject();
			isDerived = false;
			xmlTag = "PrtlSttlm";
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmPartialSettlement);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters10 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters10 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmPreviousPartialConfirmationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(AdditionalParameters10 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters10 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmMarketInfrastructureTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<AdditionalParameters10, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmProcessorTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters10.mmPartialSettlement, com.tools20022.repository.msg.AdditionalParameters10.mmPreviousPartialConfirmationIdentification,
						com.tools20022.repository.msg.AdditionalParameters10.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters10.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters10.mmPoolIdentification, com.tools20022.repository.msg.AdditionalParameters10.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.AdditionalParameters10.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters10.mmProcessorTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementConfirmationV03.mmAdditionalParameters, IntraPositionMovementConfirmationV04.mmAdditionalParameters);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters10);
				...
				name = "AdditionalParameters10";
				definition = "Specifies additional parameters to the message or transaction.";
				nextVersions_lazy = () -> Arrays.asList(AdditionalParameters21.mmObject());
				previousVersion_lazy = () -> AdditionalParameters8.mmObject();
			}
		});
	...
	public AdditionalParameters10 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters10 setPreviousPartialConfirmationIdentification(Max35Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters10 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public AdditionalParameters10 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public AdditionalParameters10 setPoolIdentification(Max35Text poolIdentification) {
	...
	public AdditionalParameters10 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public AdditionalParameters10 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public AdditionalParameters10 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
