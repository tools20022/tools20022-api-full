...
public class ForeignExchangeTerms6 {
	...
	public static final MMMessageAttribute UnitCurrency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms32.UnitCurrency);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute QuotedCurrency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms32.QuotedCurrency);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyCode.mmObject();
		}
	...
	public static final MMMessageAttribute ExchangeRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms32.ExchangeRate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute QuotationDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms32.QuotationDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute QuotingInstitution = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms32.QuotingInstitution);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms6.UnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms6.QuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms6.ExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms6.QuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms6.QuotingInstitution);
