...
public class CashOption48 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption48.mmCreditDebitIndicator, CashOption48.mmAccount, CashOption48.mmPostingDate, CashOption48.mmOriginalPostingDate, CashOption48.mmValueDate, CashOption48.mmPostingAmount);
