...
import com.tools20022.repository.choice.RejectionReason2Choice;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.RejectionReason18
...
@XmlType(name = "RejectionReason6", propOrder = {"code", "additionalReasonInformation"})
public class RejectionReason6 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason6
	 * RejectionReason6}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionReason6, RejectionReason2Choice> mmCode = new MMMessageAssociationEnd<RejectionReason6, RejectionReason2Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionReason16.mmReason, RejectionReason18.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public RejectionReason2Choice getValue(RejectionReason6 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason6 obj, RejectionReason2Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason6, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason6, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionReason16.mmAdditionalReasonInformation, RejectionReason18.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(RejectionReason6 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionReason6 obj, Optional<Max210Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(RejectionReason16.mmObject(), RejectionReason18.mmObject());
			}
		});
	...
	public RejectionReason6 setCode(RejectionReason2Choice code) {
	...
	public RejectionReason6 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
