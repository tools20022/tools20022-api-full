...
public class CorporateActionGeneralInformation77 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation77.mmCorporateActionEventIdentification, CorporateActionGeneralInformation77.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation77.mmEventType, CorporateActionGeneralInformation77.mmUnderlyingSecurity);
