...
public class CorporateActionGeneralInformation35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation35.mmCorporateActionEventIdentification, CorporateActionGeneralInformation35.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation35.mmClassActionNumber, CorporateActionGeneralInformation35.mmEventType, CorporateActionGeneralInformation35.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation35.mmFinancialInstrumentIdentification);
