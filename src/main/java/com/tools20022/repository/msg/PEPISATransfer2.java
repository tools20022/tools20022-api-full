...
public class PEPISATransfer2 {
	...
	public PEPISATransfer2 setISA(com.tools20022.repository.msg.ISAYearsOfIssue iSA) {
	...
	public PEPISATransfer2 setAssets(List<com.tools20022.repository.msg.Unit2> assets) {
