 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction53
 * Transaction53}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction60", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class Transaction60 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction60, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction60.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			previousVersion_lazy = () -> Transaction53.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction60 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction60 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction60 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction60 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction60, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction60 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction60 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralTransactionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmTripartyAgentServiceProviderCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction60, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralInstructionIdentification = new MMMessageAttribute<Transaction60, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction60.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> Transaction53.mmTripartyAgentServiceProviderCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected TransactionDetails104 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails104
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction60, Optional<TransactionDetails104>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction60, Optional<TransactionDetails104>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails104.mmObject();
		}

		@Override
		public Optional<TransactionDetails104> getValue(Transaction60 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction60 obj, Optional<TransactionDetails104> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction60, List<Status18Choice>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction60, List<Status18Choice>>() {
		{
			...
			previousVersion_lazy = () -> Transaction53.mmStatusAndReason;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Status18Choice> getValue(Transaction60 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction60 obj, List<Status18Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction60.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction60.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction60.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction60.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction60.mmTradeIdentification, com.tools20022.repository.msg.Transaction60.mmPoolIdentification, com.tools20022.repository.msg.Transaction60.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction60.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction60.mmTripartyAgentServiceProviderCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction60.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction60.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.Transaction60.mmTripartyAgentServiceProviderCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction60.mmTransactionDetails,
						com.tools20022.repository.msg.Transaction60.mmStatusAndReason);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV09.mmTransactions);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction60);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Transaction60";
				definition = "Specifies the details of the transaction.";
				previousVersion_lazy = () -> Transaction53.mmObject();
			}
		});
	...
	public Transaction60 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction60 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction60 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction60 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction60 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction60 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction60 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction60 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction60 setTripartyAgentServiceProviderCollateralTransactionIdentification(Max35Text tripartyAgentServiceProviderCollateralTransactionIdentification) {
	...
	public Transaction60 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public Transaction60 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction60 setTripartyAgentServiceProviderCollateralInstructionIdentification(Max35Text tripartyAgentServiceProviderCollateralInstructionIdentification) {
	...
	public Optional<TransactionDetails104> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction60 setTransactionDetails(TransactionDetails104 transactionDetails) {
	...
	public Transaction60 setStatusAndReason(List<Status18Choice> statusAndReason) {
