...
public class RateTypeAndAmountAndStatus18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus18.mmRateType, RateTypeAndAmountAndStatus18.mmAmount, RateTypeAndAmountAndStatus18.mmRateStatus);
	...
	public void setRateType(RateType25Choice rateType) {
