...
public class RateTypeAndAmountAndStatus18 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RateTypeAndAmountAndStatus18.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus18.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus18.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus18.RateStatus);
