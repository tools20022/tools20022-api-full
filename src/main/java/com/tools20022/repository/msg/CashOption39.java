...
public class CashOption39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption39.mmCreditDebitIndicator, CashOption39.mmContractualPaymentIndicator, CashOption39.mmIncomeType, CashOption39.mmExemptionType, CashOption39.mmAccount,
						CashOption39.mmCashParties, CashOption39.mmAmountDetails, CashOption39.mmDateDetails, CashOption39.mmForeignExchangeDetails, CashOption39.mmTaxVoucherDetails, CashOption39.mmRateAndAmountDetails,
						CashOption39.mmPriceDetails);
