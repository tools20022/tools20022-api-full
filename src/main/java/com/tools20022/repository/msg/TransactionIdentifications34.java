...
public class TransactionIdentifications34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications34.mmAccountOwnerTransactionIdentification, TransactionIdentifications34.mmAccountServicerTransactionIdentification,
						TransactionIdentifications34.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications34.mmProcessorTransactionIdentification);
