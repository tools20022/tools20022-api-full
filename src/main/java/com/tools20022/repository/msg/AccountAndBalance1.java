...
public class AccountAndBalance1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance1.mmSafekeepingAccount, AccountAndBalance1.mmAccountOwner, AccountAndBalance1.mmSafekeepingPlace, AccountAndBalance1.mmBalance);
