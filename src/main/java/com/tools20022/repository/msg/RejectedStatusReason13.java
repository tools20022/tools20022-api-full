...
import com.tools20022.repository.choice.RejectedReason9Choice;
...
@XmlType(name = "RejectedStatusReason13", propOrder = {"reasonCode", "additionalReasonInformation"})
public class RejectedStatusReason13 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected RejectedReason9Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.RejectedReason9Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectedStatusReason13, RejectedReason9Choice> mmReasonCode = new MMMessageAssociationEnd<RejectedStatusReason13, RejectedReason9Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectedStatusReason13.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason17.mmReasonCode);
			previousVersion_lazy = () -> RejectedStatusReason10.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectedReason9Choice.mmObject();
		}

		@Override
		public RejectedReason9Choice getValue(RejectedStatusReason13 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(RejectedStatusReason13 obj, RejectedReason9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedStatusReason13, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectedStatusReason13, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason17.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> RejectedStatusReason10.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(RejectedStatusReason13 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectedStatusReason13 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason13.mmReasonCode, com.tools20022.repository.msg.RejectedStatusReason13.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forRejectedStatusReason13);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatusReason13";
				definition = "Specifies reasons for the rejected status.";
				nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason17.mmObject());
				previousVersion_lazy = () -> RejectedStatusReason10.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public RejectedReason9Choice getReasonCode() {
		return reasonCode;
	}

	public RejectedStatusReason13 setReasonCode(RejectedReason9Choice reasonCode) {
	...
	public RejectedStatusReason13 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
