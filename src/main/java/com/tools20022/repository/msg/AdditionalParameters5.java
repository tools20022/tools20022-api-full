 ...
 * AdditionalParameters5.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters5#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters5.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters5
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters5", propOrder = {"preConfirmation", "partialSettlement", "tripartyAgentCollateralTransactionIdentification", "clientTripartyCollateralTransactionIdentification"})
public class AdditionalParameters5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters5, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters5, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters5.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters5 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters5 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters5, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters5, Optional<PartialSettlement2Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters5 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters5 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters5, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters5, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters5 obj) {
			return obj.getTripartyAgentCollateralTransactionIdentification();
		}

		@Override
		public void setValue(AdditionalParameters5 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters5, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters5, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters5.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters5.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters5.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters5.mmClientTripartyCollateralTransactionIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters5);
	...
	public AdditionalParameters5 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters5 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters5 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters5 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
