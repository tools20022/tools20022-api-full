...
public class AdditionalParameters5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalParameters5.mmPreConfirmation, AdditionalParameters5.mmPartialSettlement, AdditionalParameters5.mmTripartyAgentCollateralTransactionIdentification,
