 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentTypeInformation10#mmServiceLevelOrClearingChannelRule
 * PaymentTypeInformation10.mmServiceLevelOrClearingChannelRule}</li>
 * </ul>
 * </li>
 * <li>
...
public class PaymentTypeInformation10 {
	...
	public static final MMMessageAttribute mmInstructionPriority = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PaymentTypeInformation10.mmObject();
			isDerived = false;
			xmlTag = "InstrPrty";
	...
	public static final MMXor mmServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> PaymentTypeInformation10.mmObject();
			impactedElements_lazy = () -> Arrays.asList(PaymentTypeInformation10.mmServiceLevel, PaymentTypeInformation10.mmClearingChannel);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation10.mmInstructionPriority, PaymentTypeInformation10.mmServiceLevel, PaymentTypeInformation10.mmClearingChannel, PaymentTypeInformation10.mmLocalInstrument,
						PaymentTypeInformation10.mmCategoryPurpose);
				...
				xors_lazy = () -> Arrays.asList(PaymentTypeInformation10.mmServiceLevelOrClearingChannelRule);
			}
		});
