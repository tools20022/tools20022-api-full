		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFICustomerDirectDebitV03.mmGroupHeader, FIToFICustomerDirectDebitV04.mmGroupHeader, FIToFICustomerDirectDebitV05.mmGroupHeader, FIToFICustomerDirectDebitV06.mmGroupHeader,
						FIToFICustomerDirectDebitV07.mmGroupHeader);
