...
public class TransactionDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails8.mmTransactionActivity, TransactionDetails8.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails8.mmSecuritiesMovementType,
						TransactionDetails8.mmPayment, TransactionDetails8.mmSettlementParameters, TransactionDetails8.mmPlaceOfTrade, TransactionDetails8.mmSafekeepingPlace, TransactionDetails8.mmFinancialInstrumentIdentification,
						TransactionDetails8.mmPostingQuantity, TransactionDetails8.mmPostingAmount, TransactionDetails8.mmTradeDate, TransactionDetails8.mmExpectedSettlementDate, TransactionDetails8.mmSettlementDate,
						TransactionDetails8.mmLateDeliveryDate, TransactionDetails8.mmExpectedValueDate, TransactionDetails8.mmDeliveringSettlementParties, TransactionDetails8.mmReceivingSettlementParties,
						TransactionDetails8.mmTransactionAdditionalDetails, TransactionDetails8.mmExtension);
