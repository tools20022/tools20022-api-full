...
public class AssetClassCommodityInflation1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AssetClassCommodityInflation1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AssetClassCommodityInflation1.mmBaseProduct);
	...
	public void setBaseProduct(AssetClassProductType12Code baseProduct) {
