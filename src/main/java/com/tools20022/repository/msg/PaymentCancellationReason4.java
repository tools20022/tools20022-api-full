...
public class PaymentCancellationReason4 {
	...
	public static final MMMessageAssociationEnd mmOriginator = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentCancellationReason3.mmOriginator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentCancellationReason3.mmReason;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentCancellationReason3.mmAdditionalInformation;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CancelTransactionV07.mmCancellationReason);
				...
				previousVersion_lazy = () -> PaymentCancellationReason3.mmObject();
			}
		});
	...
	public PaymentCancellationReason4 setOriginator(com.tools20022.repository.msg.PartyIdentification125 originator) {
