 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forDeliverInformation4
 * ConstraintPhysicalTransferDetailsRule.forDeliverInformation4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule#forDeliverInformation4
 * ConstraintDeliverersCustodianDetailsRule.forDeliverInformation4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule#forDeliverInformation4
 * ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation4}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DeliverInformation7
 * DeliverInformation7}</li>
 * <li>{@linkplain com.tools20022.repository.msg.DeliverInformation6
...
@XmlType(name = "DeliverInformation4", propOrder = {"effectiveSettlementDate", "settlementAmount", "stampDutyIndicator", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "settlementPartiesDetails",
...
public class DeliverInformation4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation4, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<DeliverInformation4, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation4.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(DeliverInformation4 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(DeliverInformation4 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation4, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<DeliverInformation4, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(DeliverInformation4 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(DeliverInformation4 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation4, YesNoIndicator> mmStampDutyIndicator = new MMMessageAttribute<DeliverInformation4, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(DeliverInformation4 obj) {
			return obj.getStampDutyIndicator();
		}

		@Override
		public void setValue(DeliverInformation4 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation4, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<DeliverInformation4, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation4, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<DeliverInformation4, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(DeliverInformation4 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(DeliverInformation4 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation4, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<DeliverInformation4, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(DeliverInformation4 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(DeliverInformation4 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation4, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<DeliverInformation4, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(DeliverInformation4 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(DeliverInformation4 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation4, DeliveringPartiesAndAccount4> mmSettlementPartiesDetails = new MMMessageAssociationEnd<DeliverInformation4, DeliveringPartiesAndAccount4>() {
		{
		...
		@Override
		public DeliveringPartiesAndAccount4 getValue(DeliverInformation4 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(DeliverInformation4 obj, DeliveringPartiesAndAccount4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation4, YesNoIndicator> mmPhysicalTransferIndicator = new MMMessageAttribute<DeliverInformation4, YesNoIndicator>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation4, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<DeliverInformation4, Optional<DeliveryParameters4>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmPhysicalDelivery;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation4.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(DeliverInformation4 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(DeliverInformation4 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation4.mmEffectiveSettlementDate, com.tools20022.repository.msg.DeliverInformation4.mmSettlementAmount,
						com.tools20022.repository.msg.DeliverInformation4.mmStampDutyIndicator, com.tools20022.repository.msg.DeliverInformation4.mmNetAmount, com.tools20022.repository.msg.DeliverInformation4.mmChargeDetails,
						com.tools20022.repository.msg.DeliverInformation4.mmCommissionDetails, com.tools20022.repository.msg.DeliverInformation4.mmTaxDetails, com.tools20022.repository.msg.DeliverInformation4.mmSettlementPartiesDetails,
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInConfirmationV02.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forDeliverInformation4,
						com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule.forDeliverInformation4, com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation4);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeliverInformation4";
				...
				nextVersions_lazy = () -> Arrays.asList(DeliverInformation7.mmObject(), DeliverInformation6.mmObject());
			}
		});
	...
	public DeliverInformation4 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public DeliverInformation4 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public DeliverInformation4 setStampDutyIndicator(YesNoIndicator stampDutyIndicator) {
	...
	public DeliverInformation4 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public DeliverInformation4 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public DeliverInformation4 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public DeliverInformation4 setTaxDetails(List<Tax15> taxDetails) {
	...
	public DeliverInformation4 setSettlementPartiesDetails(DeliveringPartiesAndAccount4 settlementPartiesDetails) {
	...
	public DeliverInformation4 setPhysicalTransferIndicator(YesNoIndicator physicalTransferIndicator) {
	...
	public DeliverInformation4 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
