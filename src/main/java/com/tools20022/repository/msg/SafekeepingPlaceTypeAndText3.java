...
public class SafekeepingPlaceTypeAndText3 {
	...
	public static final MMMessageAttribute SafekeepingPlaceType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SafekeepingPlaceTypeAndText3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText8.SafekeepingPlaceType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText8.Identification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText3.SafekeepingPlaceType, com.tools20022.repository.msg.SafekeepingPlaceTypeAndText3.Identification);
