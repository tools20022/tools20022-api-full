...
public class Mandate6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Mandate6.mmMandateIdentification, Mandate6.mmMandateRequestIdentification, Mandate6.mmType, Mandate6.mmOccurrences, Mandate6.mmCollectionAmount, Mandate6.mmMaximumAmount,
						Mandate6.mmReason, Mandate6.mmCreditorSchemeIdentification, Mandate6.mmCreditor, Mandate6.mmCreditorAccount, Mandate6.mmCreditorAgent, Mandate6.mmUltimateCreditor, Mandate6.mmDebtor, Mandate6.mmDebtorAccount,
						Mandate6.mmDebtorAgent, Mandate6.mmUltimateDebtor, Mandate6.mmReferredDocument);
