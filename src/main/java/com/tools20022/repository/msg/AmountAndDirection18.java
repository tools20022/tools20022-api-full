 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection18#mmAmount
...
@XmlType(name = "AmountAndDirection18", propOrder = {"amount", "creditDebit"})
public class AmountAndDirection18 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AmountAndDirection18
	 * AmountAndDirection18}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection18.mmAmount, com.tools20022.repository.msg.AmountAndDirection18.mmCreditDebit);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AmountAndDirection18";
	...
	public AmountAndDirection18 setAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount amount) {
	...
	public AmountAndDirection18 setCreditDebit(CreditDebitCode creditDebit) {
