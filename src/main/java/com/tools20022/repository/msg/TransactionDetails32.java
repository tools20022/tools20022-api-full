...
public class TransactionDetails32 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails32.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails32.mmFinancialInstrumentIdentification, TransactionDetails32.mmTradeDate, TransactionDetails32.mmSettlementDate, TransactionDetails32.mmSettlementQuantity,
						TransactionDetails32.mmSettlementAmount, TransactionDetails32.mmDeliveringSettlementParties, TransactionDetails32.mmReceivingSettlementParties, TransactionDetails32.mmInvestor);
	...
	public SettlementParties22 getDeliveringSettlementParties() {
		return deliveringSettlementParties;
	}

	public void setDeliveringSettlementParties(com.tools20022.repository.msg.SettlementParties22 deliveringSettlementParties) {
		this.deliveringSettlementParties = deliveringSettlementParties;
	}

	@XmlElement(name = "RcvgSttlmPties")
	public SettlementParties22 getReceivingSettlementParties() {
		return receivingSettlementParties;
	}

	public void setReceivingSettlementParties(com.tools20022.repository.msg.SettlementParties22 receivingSettlementParties) {
		this.receivingSettlementParties = receivingSettlementParties;
	}

	@XmlElement(name = "Invstr")
	public PartyIdentification67Choice getInvestor() {
		return investor;
	}

	public void setInvestor(PartyIdentification67Choice investor) {
