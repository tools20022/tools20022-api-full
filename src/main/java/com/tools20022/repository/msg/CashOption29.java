...
public class CashOption29 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CashOption29.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption29.mmCreditDebitIndicator, CashOption29.mmNonEligibleProceedsIndicator, CashOption29.mmIssuerOfferorTaxabilityIndicator, CashOption29.mmIncomeType,
						CashOption29.mmCashAccountIdentification, CashOption29.mmAmountDetails, CashOption29.mmDateDetails, CashOption29.mmForeignExchangeDetails, CashOption29.mmRateAndAmountDetails, CashOption29.mmPriceDetails);
	...
	public CorporateActionAmounts26 getAmountDetails() {
		return amountDetails;
	}

	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts26 amountDetails) {
