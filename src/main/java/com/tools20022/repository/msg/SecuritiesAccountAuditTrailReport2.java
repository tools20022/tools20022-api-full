...
@XmlType(name = "SecuritiesAccountAuditTrailReport2", propOrder = {"securitiesAccountAuditTrailOrError", "datePeriod", "securitiesAccountIdentification"})
public class SecuritiesAccountAuditTrailReport2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "SctiesAcctAudtTrlOrErr", required = true)
	protected AuditTrailOrBusinessError2Choice securitiesAccountAuditTrailOrError;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<SecuritiesAccountAuditTrailReport2, AuditTrailOrBusinessError2Choice> mmSecuritiesAccountAuditTrailOrError = new MMMessageAssociationEnd<SecuritiesAccountAuditTrailReport2, AuditTrailOrBusinessError2Choice>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesAccountAuditTrailReport1.mmSecuritiesAccountAuditTrailOrError;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<SecuritiesAccountAuditTrailReport2, Optional<DateSearchChoice>> mmDatePeriod = new MMMessageAttribute<SecuritiesAccountAuditTrailReport2, Optional<DateSearchChoice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesAccountAuditTrailReport1.mmDatePeriod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesAccountAuditTrailReport2.mmSecuritiesAccountAuditTrailOrError, com.tools20022.repository.msg.SecuritiesAccountAuditTrailReport2.mmDatePeriod,
						com.tools20022.repository.msg.SecuritiesAccountAuditTrailReport2.mmSecuritiesAccountIdentification);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SecuritiesAccountAuditTrailReport2";
				definition = "Report information about securities account reference data.";
				previousVersion_lazy = () -> SecuritiesAccountAuditTrailReport1.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public AuditTrailOrBusinessError2Choice getSecuritiesAccountAuditTrailOrError() {
		return securitiesAccountAuditTrailOrError;
	}

	public SecuritiesAccountAuditTrailReport2 setSecuritiesAccountAuditTrailOrError(AuditTrailOrBusinessError2Choice securitiesAccountAuditTrailOrError) {
	...
	public SecuritiesAccountAuditTrailReport2 setDatePeriod(DateSearchChoice datePeriod) {
