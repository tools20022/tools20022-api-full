...
public class SubBalanceInformation17 {
	...
	protected List<com.tools20022.repository.msg.AdditionalBalanceInformation17> additionalBalanceBreakdownDetails;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation17.mmSubBalanceType, SubBalanceInformation17.mmQuantity, SubBalanceInformation17.mmSubBalanceAdditionalDetails, SubBalanceInformation17.mmQuantityBreakdown,
						SubBalanceInformation17.mmAdditionalBalanceBreakdownDetails);
	...
	public void setAdditionalBalanceBreakdownDetails(List<com.tools20022.repository.msg.AdditionalBalanceInformation17> additionalBalanceBreakdownDetails) {
