...
public class SecuritiesSettlementTransactionDetails29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails29.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails29.mmLinkages,
						SecuritiesSettlementTransactionDetails29.mmTradeDetails, SecuritiesSettlementTransactionDetails29.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails29.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails29.mmSettlementParameters, SecuritiesSettlementTransactionDetails29.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails29.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails29.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails29.mmCashParties,
						SecuritiesSettlementTransactionDetails29.mmSettlementAmount, SecuritiesSettlementTransactionDetails29.mmOtherAmounts, SecuritiesSettlementTransactionDetails29.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails29.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails29.mmSupplementaryData);
