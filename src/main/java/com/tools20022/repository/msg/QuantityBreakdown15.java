 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityBreakdown15
 * ConstraintCoexistenceQuantityRule.forQuantityBreakdown15}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "QuantityBreakdown15", propOrder = {"lotNumber", "lotQuantity"})
public class QuantityBreakdown15 {
	...
	public static final MMMessageAssociationEnd mmLotQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityBreakdown31.mmLotQuantity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown15.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown15.mmLotQuantity);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityBreakdown15);
				...
				name = "QuantityBreakdown15";
				definition = "Details of breakdown of a quantity.";
				nextVersions_lazy = () -> Arrays.asList(QuantityBreakdown31.mmObject());
				previousVersion_lazy = () -> QuantityBreakdown5.mmObject();
			}
		});
	...
	public QuantityBreakdown15 setLotQuantity(FinancialInstrumentQuantity1Choice lotQuantity) {
