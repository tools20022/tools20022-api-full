 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown15#LotNumber
...
public class QuantityBreakdown15 {
	...
	public static final MMMessageAttribute LotNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> QuantityBreakdown15.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown31.LotNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LotQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown31.LotQuantity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown15.LotNumber, com.tools20022.repository.msg.QuantityBreakdown15.LotQuantity);
