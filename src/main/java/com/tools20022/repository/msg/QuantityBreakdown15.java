	...
	public static final MMMessageAttribute mmLotNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown31.mmLotNumber);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmLotQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown31.mmLotQuantity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
