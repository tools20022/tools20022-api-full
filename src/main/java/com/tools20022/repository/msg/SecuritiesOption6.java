...
public class SecuritiesOption6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption6.mmSecurityDetails, SecuritiesOption6.mmCreditDebitIndicator, SecuritiesOption6.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption6.mmNonEligibleProceedsIndicator, SecuritiesOption6.mmEntitledQuantity, SecuritiesOption6.mmFractionDisposition, SecuritiesOption6.mmCurrencyOption, SecuritiesOption6.mmTradingPeriod,
						SecuritiesOption6.mmDateDetails, SecuritiesOption6.mmRateDetails, SecuritiesOption6.mmPriceDetails);
