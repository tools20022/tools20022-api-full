...
public class InvestmentAccount41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount41.mmOwnerIdentification, InvestmentAccount41.mmAccountIdentification, InvestmentAccount41.mmAccountName, InvestmentAccount41.mmAccountDesignation,
						InvestmentAccount41.mmIntermediaryInformation, InvestmentAccount41.mmSecuritiesForm, InvestmentAccount41.mmDematerialisedIndicator, InvestmentAccount41.mmIncomePreference,
						InvestmentAccount41.mmBeneficiaryCertificationCompletion, InvestmentAccount41.mmAccountServicer, InvestmentAccount41.mmSubAccountDetails);
