...
public class TransactionIdentifications23 {
	...
	public static final MMMessageAttribute mmAccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications23.mmObject();
			isDerived = false;
			xmlTag = "AcctSvcrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications23.mmAccountServicerTransactionIdentification, TransactionIdentifications23.mmMarketInfrastructureTransactionIdentification,
						TransactionIdentifications23.mmProcessorTransactionIdentification, TransactionIdentifications23.mmAccountOwnerTransactionIdentification);
	...
	public void setAccountOwnerTransactionIdentification(References30Choice accountOwnerTransactionIdentification) {
