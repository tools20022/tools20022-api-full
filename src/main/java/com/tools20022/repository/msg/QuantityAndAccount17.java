...
public class QuantityAndAccount17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount17.mmSettlementQuantity, QuantityAndAccount17.mmDenominationChoice, QuantityAndAccount17.mmAccountOwner, QuantityAndAccount17.mmSafekeepingAccount,
						QuantityAndAccount17.mmCashAccount, QuantityAndAccount17.mmSafekeepingPlace, QuantityAndAccount17.mmQuantityBreakdown);
