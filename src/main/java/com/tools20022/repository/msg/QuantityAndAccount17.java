 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDenominationRule#forQuantityAndAccount17
 * ConstraintDenominationRule.forQuantityAndAccount17}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule#forQuantityAndAccount17
 * ConstraintSafekeepingPlaceRule.forQuantityAndAccount17}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityAndAccount17
 * ConstraintCoexistenceQuantityRule.forQuantityAndAccount17}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline#forQuantityAndAccount17
 * ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount17}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "QuantityAndAccount17", propOrder = {"settlementQuantity", "denominationChoice", "accountOwner", "safekeepingAccount", "cashAccount", "safekeepingPlace", "quantityBreakdown"})
public class QuantityAndAccount17 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<QuantityAndAccount17, Quantity6Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount17.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
		...
		@Override
		public Quantity6Choice getValue(QuantityAndAccount17 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount17, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount17, Optional<Max210Text>>() {
		{
		...
		@Override
		public Optional<Max210Text> getValue(QuantityAndAccount17 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, Optional<Max210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount17, Optional<PartyIdentification36Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(QuantityAndAccount17 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageAssociationEnd<QuantityAndAccount17, SecuritiesAccount13>() {
		{
		...
		@Override
		public SecuritiesAccount13 getValue(QuantityAndAccount17 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, SecuritiesAccount13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount17, Optional<CashAccountIdentification5Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(QuantityAndAccount17 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount17, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(QuantityAndAccount17 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount17, List<QuantityBreakdown3>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount17, List<QuantityBreakdown3>>() {
		{
		...
		@Override
		public List<QuantityBreakdown3> getValue(QuantityAndAccount17 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount17 obj, List<QuantityBreakdown3> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV02.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionGenerationNotificationV02.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionInstructionV02.mmQuantityAndAccountDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount17, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forQuantityAndAccount17,
						com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityAndAccount17, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount17);
	...
	public QuantityAndAccount17 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public QuantityAndAccount17 setDenominationChoice(Max210Text denominationChoice) {
	...
	public QuantityAndAccount17 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public QuantityAndAccount17 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public QuantityAndAccount17 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public QuantityAndAccount17 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public QuantityAndAccount17 setQuantityBreakdown(List<QuantityBreakdown3> quantityBreakdown) {
