...
public class UnmatchedReason19 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason19.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason19.mmCode, UnmatchedReason19.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason26Choice code) {
		this.code = code;
	}
