...
public class CardPaymentContext15 {
	...
	public static final MMMessageAssociationEnd mmPaymentContext = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext21.mmPaymentContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentContext9.mmPaymentContext;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentContext15.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmSaleContext = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext21.mmSaleContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentContext9.mmSaleContext;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public void setPaymentContext(com.tools20022.repository.msg.PaymentContext15 paymentContext) {
