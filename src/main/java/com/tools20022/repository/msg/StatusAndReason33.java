 ...
 * <li>{@linkplain com.tools20022.repository.msg.StatusAndReason33#Transaction
 * StatusAndReason33.Transaction}</li>
 * </ul>
 * </li>
...
public class StatusAndReason33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusAndReason33.StatusAndReason, com.tools20022.repository.msg.StatusAndReason33.Transaction);
				trace_lazy = () -> Status.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V08.Status);
