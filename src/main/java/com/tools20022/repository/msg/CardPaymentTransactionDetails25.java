...
public class CardPaymentTransactionDetails25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmCurrency, CardPaymentTransactionDetails25.mmTotalAmount, CardPaymentTransactionDetails25.mmDetailedAmount,
						CardPaymentTransactionDetails25.mmValidityDate, CardPaymentTransactionDetails25.mmAccountType, CardPaymentTransactionDetails25.mmICCRelatedData);
