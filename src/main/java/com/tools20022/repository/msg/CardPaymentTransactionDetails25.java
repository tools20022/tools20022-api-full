	...
	public static final MMMessageAttribute mmCurrency = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CardPaymentTransactionDetails25.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmCurrency);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmCurrency;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTotalAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmTotalAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmDetailedAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmDetailedAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmValidityDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmValidityDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmValidityDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmAccountType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmAccountType;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmICCRelatedData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails32.mmICCRelatedData);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
