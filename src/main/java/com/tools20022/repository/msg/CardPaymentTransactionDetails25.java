...
import com.tools20022.repository.msg.DetailedAmount7;
...
@XmlType(name = "CardPaymentTransactionDetails25", propOrder = {"currency", "totalAmount", "detailedAmount", "validityDate", "accountType", "iCCRelatedData"})
public class CardPaymentTransactionDetails25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails25, Optional<CurrencyCode>> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails25, Optional<CurrencyCode>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmCurrency);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyCode> getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails25, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails25, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmTotalAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails25, Optional<DetailedAmount7>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails25, Optional<DetailedAmount7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmDetailedAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DetailedAmount7> getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, Optional<DetailedAmount7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails25, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails25, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmValidityDate);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmValidityDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails25, Optional<CardAccountType2Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails25, Optional<CardAccountType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmAccountType);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmAccountType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType2Code> getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, Optional<CardAccountType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails25, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails25, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmICCRelatedData);
			previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails25 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails25 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmDetailedAmount, com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmValidityDate,
						com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmAccountType, com.tools20022.repository.msg.CardPaymentTransactionDetails25.mmICCRelatedData);
				...
				name = "CardPaymentTransactionDetails25";
				definition = "Details of the transaction in the authorisation response contained in a batch.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails32.mmObject());
				previousVersion_lazy = () -> CardPaymentTransactionDetails17.mmObject();
			}
		});
	...
	public CardPaymentTransactionDetails25 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails25 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails25 setDetailedAmount(DetailedAmount7 detailedAmount) {
	...
	public CardPaymentTransactionDetails25 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails25 setAccountType(CardAccountType2Code accountType) {
	...
	public CardPaymentTransactionDetails25 setICCRelatedData(Max10000Binary iCCRelatedData) {
