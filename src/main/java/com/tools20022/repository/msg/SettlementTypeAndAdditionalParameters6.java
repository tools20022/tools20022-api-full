 ...
 * SettlementTypeAndAdditionalParameters6.mmCorporateActionEventIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forSettlementTypeAndAdditionalParameters6
 * ConstraintCoexistenceIdentificationRule.
 * forSettlementTypeAndAdditionalParameters6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SettlementTypeAndAdditionalParameters6", propOrder = {"commonIdentification", "corporateActionEventIdentification", "reconciliationIndicator"})
public class SettlementTypeAndAdditionalParameters6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmCommonIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters6.mmObject();
			isDerived = false;
			xmlTag = "CmonId";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters13.mmCommonIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(SettlementTypeAndAdditionalParameters6 obj) {
			return obj.getCommonIdentification();
		}

		@Override
		public void setValue(SettlementTypeAndAdditionalParameters6 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters13.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<YesNoIndicator>> mmReconciliationIndicator = new MMMessageAttribute<SettlementTypeAndAdditionalParameters6, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters6.mmObject();
			isDerived = false;
			xmlTag = "RcncltnInd";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters13.mmReconciliationIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementTypeAndAdditionalParameters6 obj) {
			return obj.getReconciliationIndicator();
		}

		@Override
		public void setValue(SettlementTypeAndAdditionalParameters6 obj, Optional<YesNoIndicator> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters6.mmCommonIdentification,
						com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters6.mmCorporateActionEventIdentification, com.tools20022.repository.msg.SettlementTypeAndAdditionalParameters6.mmReconciliationIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forSettlementTypeAndAdditionalParameters6);
				...
				name = "SettlementTypeAndAdditionalParameters6";
				definition = "Provides transaction type and identification information.";
				nextVersions_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters13.mmObject());
			}
		});
	...
	public SettlementTypeAndAdditionalParameters6 setCommonIdentification(Max35Text commonIdentification) {
	...
	public SettlementTypeAndAdditionalParameters6 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public SettlementTypeAndAdditionalParameters6 setReconciliationIndicator(YesNoIndicator reconciliationIndicator) {
