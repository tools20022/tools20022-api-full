...
public class AggregateBalancePerSafekeepingPlace16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace16.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace16.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace16.mmAggregateBalance,
						AggregateBalancePerSafekeepingPlace16.mmPriceDetails, AggregateBalancePerSafekeepingPlace16.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace16.mmDaysAccrued,
						AggregateBalancePerSafekeepingPlace16.mmAccountBaseCurrencyAmounts, AggregateBalancePerSafekeepingPlace16.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace16.mmAlternateReportingCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace16.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace16.mmBalanceBreakdown, AggregateBalancePerSafekeepingPlace16.mmAdditionalBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace16.mmHoldingAdditionalDetails);
