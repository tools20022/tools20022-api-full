...
public class QuantityAndAccount26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount26.mmSettlementQuantity, QuantityAndAccount26.mmDenominationChoice, QuantityAndAccount26.mmCashAccount, QuantityAndAccount26.mmQuantityBreakdown,
						QuantityAndAccount26.mmSafekeepingPlace);
