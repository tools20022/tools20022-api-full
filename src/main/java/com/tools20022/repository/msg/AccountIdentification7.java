...
public class AccountIdentification7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification7.mmSafekeepingAccount, AccountIdentification7.mmAccountOwner, AccountIdentification7.mmSafekeepingPlace, AccountIdentification7.mmConfirmedBalance);
