...
public class QuantityAndAccount43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount43.mmSettlementQuantity, QuantityAndAccount43.mmDenominationChoice, QuantityAndAccount43.mmAccountOwner, QuantityAndAccount43.mmSafekeepingAccount,
						QuantityAndAccount43.mmCashAccount, QuantityAndAccount43.mmSafekeepingPlace, QuantityAndAccount43.mmQuantityBreakdown);
