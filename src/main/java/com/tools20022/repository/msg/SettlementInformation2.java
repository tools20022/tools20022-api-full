...
public class SettlementInformation2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementInformation2.mmSettlementMethod, SettlementInformation2.mmSettlementAccount, SettlementInformation2.mmClearingSystem);
