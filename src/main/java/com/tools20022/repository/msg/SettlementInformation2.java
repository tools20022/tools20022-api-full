...
public class SettlementInformation2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementInformation2, SettlementMethod2Code> mmSettlementMethod = new MMMessageAttribute<SettlementInformation2, SettlementMethod2Code>() {
		{
		...
		@Override
		public SettlementMethod2Code getValue(SettlementInformation2 obj) {
			return obj.getSettlementMethod();
		}

		@Override
		public void setValue(SettlementInformation2 obj, SettlementMethod2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation2, Optional<CashAccount7>> mmSettlementAccount = new MMMessageAssociationEnd<SettlementInformation2, Optional<CashAccount7>>() {
		{
		...
		@Override
		public Optional<CashAccount7> getValue(SettlementInformation2 obj) {
			return obj.getSettlementAccount();
		}

		@Override
		public void setValue(SettlementInformation2 obj, Optional<CashAccount7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation2, Optional<ClearingSystemIdentification1Choice>> mmClearingSystem = new MMMessageAssociationEnd<SettlementInformation2, Optional<ClearingSystemIdentification1Choice>>() {
		{
		...
		@Override
		public Optional<ClearingSystemIdentification1Choice> getValue(SettlementInformation2 obj) {
			return obj.getClearingSystem();
		}

		@Override
		public void setValue(SettlementInformation2 obj, Optional<ClearingSystemIdentification1Choice> value) {
	...
	public SettlementInformation2 setSettlementAccount(CashAccount7 settlementAccount) {
