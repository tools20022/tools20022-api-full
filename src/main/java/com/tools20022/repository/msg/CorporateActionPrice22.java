 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPriceReceivedPerProductGuideline#forCorporateActionPrice22
 * ConstraintGenericCashPriceReceivedPerProductGuideline.
 * forCorporateActionPrice22}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice22", propOrder = {"genericCashPriceReceivedPerProduct", "cashInLieuOfSharePrice", "overSubscriptionDepositPrice"})
public class CorporateActionPrice22 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice22, List<PriceFormat13Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice22, List<PriceFormat13Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPriceReceivedPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice22.mmObject();
			isDerived = false;
		...
		@Override
		public List<PriceFormat13Choice> getValue(CorporateActionPrice22 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice22 obj, List<PriceFormat13Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice22, Optional<PriceFormat17Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice22, Optional<PriceFormat17Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat17Choice> getValue(CorporateActionPrice22 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice22 obj, Optional<PriceFormat17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice22, Optional<PriceFormat17Choice>> mmOverSubscriptionDepositPrice = new MMMessageAssociationEnd<CorporateActionPrice22, Optional<PriceFormat17Choice>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice22.mmGenericCashPriceReceivedPerProduct, com.tools20022.repository.msg.CorporateActionPrice22.mmCashInLieuOfSharePrice,
						com.tools20022.repository.msg.CorporateActionPrice22.mmOverSubscriptionDepositPrice);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPriceReceivedPerProductGuideline.forCorporateActionPrice22);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionPrice22";
	...
	public CorporateActionPrice22 setGenericCashPriceReceivedPerProduct(List<PriceFormat13Choice> genericCashPriceReceivedPerProduct) {
	...
	public CorporateActionPrice22 setCashInLieuOfSharePrice(PriceFormat17Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice22 setOverSubscriptionDepositPrice(PriceFormat17Choice overSubscriptionDepositPrice) {
