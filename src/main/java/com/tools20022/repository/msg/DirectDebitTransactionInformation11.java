...
public class DirectDebitTransactionInformation11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DirectDebitTransactionInformation11.mmPaymentIdentification, DirectDebitTransactionInformation11.mmPaymentTypeInformation, DirectDebitTransactionInformation11.mmInstructedAmount,
						DirectDebitTransactionInformation11.mmChargeBearer, DirectDebitTransactionInformation11.mmDirectDebitTransaction, DirectDebitTransactionInformation11.mmUltimateCreditor,
						DirectDebitTransactionInformation11.mmDebtorAgent, DirectDebitTransactionInformation11.mmDebtorAgentAccount, DirectDebitTransactionInformation11.mmDebtor, DirectDebitTransactionInformation11.mmDebtorAccount,
						DirectDebitTransactionInformation11.mmUltimateDebtor, DirectDebitTransactionInformation11.mmInstructionForCreditorAgent, DirectDebitTransactionInformation11.mmPurpose,
						DirectDebitTransactionInformation11.mmRegulatoryReporting, DirectDebitTransactionInformation11.mmTax, DirectDebitTransactionInformation11.mmRelatedRemittanceInformation,
						DirectDebitTransactionInformation11.mmRemittanceInformation);
