 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties24#Depository
 * SettlementParties24.Depository}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties24#Party1
 * SettlementParties24.Party1}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties24#Party2
 * SettlementParties24.Party2}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties24#Party3
 * SettlementParties24.Party3}</li>
 * </ul>
 * </li>
...
public class SettlementParties24 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SettlementParties42#Depository
	 * SettlementParties42.Depository}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Depository = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> SettlementParties24.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties42.Depository);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * nextVersions} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties42#Party1
	 * SettlementParties42.Party1}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Party1 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties42.Party1);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * nextVersions} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties42#Party2
	 * SettlementParties42.Party2}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Party2 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties42.Party2);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentificationAndAccount51.mmObject();
			isComposite = true;
	 ...
	 * nextVersions} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties42#Party3
	 * SettlementParties42.Party3}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Party3 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties42.Party3);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentificationAndAccount51.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties24.Depository, com.tools20022.repository.msg.SettlementParties24.Party1, com.tools20022.repository.msg.SettlementParties24.Party2,
						com.tools20022.repository.msg.SettlementParties24.Party3);
