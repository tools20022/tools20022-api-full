...
public class InvestmentAccount45 {
	...
	public static final MMMessageAttribute<InvestmentAccount45, AccountIdentification1> mmAccountIdentification = new MMMessageAttribute<InvestmentAccount45, AccountIdentification1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount53.mmAccountIdentification);
	...
	public static final MMMessageAttribute<InvestmentAccount45, Optional<Max35Text>> mmAccountName = new MMMessageAttribute<InvestmentAccount45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount53.mmAccountName);
			previousVersion_lazy = () -> InvestmentAccount14.mmAccountName;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<InvestmentAccount45, Optional<Max35Text>> mmAccountDesignation = new MMMessageAttribute<InvestmentAccount45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount53.mmAccountDesignation);
			previousVersion_lazy = () -> InvestmentAccount14.mmAccountDesignation;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd<InvestmentAccount45, Optional<OwnerIdentification1Choice>> mmOwnerIdentification = new MMMessageAssociationEnd<InvestmentAccount45, Optional<OwnerIdentification1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount53.mmOwnerIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<InvestmentAccount45, Optional<PartyIdentification2Choice>> mmAccountServicer = new MMMessageAssociationEnd<InvestmentAccount45, Optional<PartyIdentification2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount53.mmAccountServicer);
			previousVersion_lazy = () -> InvestmentAccount14.mmAccountServicer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public InvestmentAccount45 setAccountName(Max35Text accountName) {
	...
	public InvestmentAccount45 setAccountDesignation(Max35Text accountDesignation) {
	...
	public InvestmentAccount45 setOwnerIdentification(OwnerIdentification1Choice ownerIdentification) {
	...
	public InvestmentAccount45 setAccountServicer(PartyIdentification2Choice accountServicer) {
