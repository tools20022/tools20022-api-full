...
public class PendingProcessingReason2 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason2.mmCode, PendingProcessingReason2.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason2Choice code) {
		this.code = code;
	}
