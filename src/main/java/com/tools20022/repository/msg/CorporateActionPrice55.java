...
public class CorporateActionPrice55 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice55.mmCashInLieuOfSharePrice, CorporateActionPrice55.mmIndicativeOrMarketPrice, CorporateActionPrice55.mmCashValueForTax,
						CorporateActionPrice55.mmGenericCashPricePaidPerProduct, CorporateActionPrice55.mmGenericCashPriceReceivedPerProduct);
	...
	public PriceFormat43Choice getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct;
	}

	public void setGenericCashPriceReceivedPerProduct(PriceFormat43Choice genericCashPriceReceivedPerProduct) {
