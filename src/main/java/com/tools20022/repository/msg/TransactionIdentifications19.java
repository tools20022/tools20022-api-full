...
public class TransactionIdentifications19 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications19.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications19.mmAccountOwnerTransactionIdentification, TransactionIdentifications19.mmAccountServicerTransactionIdentification,
						TransactionIdentifications19.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications19.mmProcessorTransactionIdentification);
