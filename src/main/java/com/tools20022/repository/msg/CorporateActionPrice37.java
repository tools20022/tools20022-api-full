...
public class CorporateActionPrice37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice37.mmIndicativeOrMarketPrice, CorporateActionPrice37.mmCashInLieuOfSharePrice, CorporateActionPrice37.mmCashValueForTax,
						CorporateActionPrice37.mmGenericCashPricePaidPerProduct, CorporateActionPrice37.mmGenericCashPriceReceivedPerProduct);
