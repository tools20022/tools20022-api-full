	...
	public static final MMMessageAttribute mmShortLongPosition = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryQuantity3.mmShortLongPosition;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmQuantity = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryQuantity3.mmQuantity;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmQuantityType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryQuantity3.mmQuantityType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmIssuer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryQuantity3.mmIssuer;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSchemeName = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProprietaryQuantity3.mmSchemeName;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
