 ...
 * <li>{@linkplain com.tools20022.repository.msg.Account2#AccountServicer
 * Account2.AccountServicer}</li>
 * </ul>
 * </li>
...
public class Account2 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Account2.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Account20.Identification);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * nextVersions} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.Account20#AccountServicer
	 * Account20.AccountServicer}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute AccountServicer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Account20.AccountServicer);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Account2.Identification, com.tools20022.repository.msg.Account2.AccountServicer);
