 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown31#LotNumber
...
public class QuantityBreakdown31 {
	...
	public static final MMMessageAttribute LotNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> QuantityBreakdown31.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown15.LotNumber;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LotQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown15.LotQuantity;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown31.LotNumber, com.tools20022.repository.msg.QuantityBreakdown31.LotQuantity);
				...
				previousVersion_lazy = () -> QuantityBreakdown15.mmObject();
			}
		});
