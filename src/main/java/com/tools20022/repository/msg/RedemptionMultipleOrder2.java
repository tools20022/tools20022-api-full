...
public class RedemptionMultipleOrder2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionMultipleOrder2, Optional<CountryCode>> mmPlaceOfTrade = new MMMessageAttribute<RedemptionMultipleOrder2, Optional<CountryCode>>() {
		{
		...
		@Override
		public Optional<CountryCode> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionMultipleOrder2, Optional<ISODateTime>> mmOrderDateTime = new MMMessageAttribute<RedemptionMultipleOrder2, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getOrderDateTime();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionMultipleOrder2, Optional<ISODateTime>> mmExpiryDateTime = new MMMessageAttribute<RedemptionMultipleOrder2, Optional<ISODateTime>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RedemptionMultipleOrder2, Optional<CancellationRight1>> mmCancellationRight = new MMMessageAttribute<RedemptionMultipleOrder2, Optional<CancellationRight1>>() {
		{
		...
		@Override
		public Optional<CancellationRight1> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getCancellationRight();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, Optional<CancellationRight1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionMultipleOrder2, InvestmentAccount13> mmInvestmentAccountDetails = new MMMessageAssociationEnd<RedemptionMultipleOrder2, InvestmentAccount13>() {
		{
		...
		@Override
		public InvestmentAccount13 getValue(RedemptionMultipleOrder2 obj) {
			return obj.getInvestmentAccountDetails();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, InvestmentAccount13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionMultipleOrder2, Optional<IndividualPerson2>> mmBeneficiaryDetails = new MMMessageAssociationEnd<RedemptionMultipleOrder2, Optional<IndividualPerson2>>() {
		{
		...
		@Override
		public Optional<IndividualPerson2> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getBeneficiaryDetails();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, Optional<IndividualPerson2> value) {
			obj.setBeneficiaryDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "IndvOrdrDtls", required = true)
	protected List<RedemptionOrder4> individualOrderDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionMultipleOrder2, List<RedemptionOrder4>> mmIndividualOrderDetails = new MMMessageAssociationEnd<RedemptionMultipleOrder2, List<RedemptionOrder4>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RedemptionOrder4.mmObject();
		}

		@Override
		public List<RedemptionOrder4> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getIndividualOrderDetails();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, List<RedemptionOrder4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RedemptionMultipleOrder2, Optional<PaymentTransaction15>> mmBulkCashSettlementDetails = new MMMessageAssociationEnd<RedemptionMultipleOrder2, Optional<PaymentTransaction15>>() {
		{
		...
		@Override
		public Optional<PaymentTransaction15> getValue(RedemptionMultipleOrder2 obj) {
			return obj.getBulkCashSettlementDetails();
		}

		@Override
		public void setValue(RedemptionMultipleOrder2 obj, Optional<PaymentTransaction15> value) {
	...
	public RedemptionMultipleOrder2 setCancellationRight(CancellationRight1 cancellationRight) {
	...
	public RedemptionMultipleOrder2 setInvestmentAccountDetails(InvestmentAccount13 investmentAccountDetails) {
	...
	public RedemptionMultipleOrder2 setBeneficiaryDetails(IndividualPerson2 beneficiaryDetails) {
	...
	public RedemptionMultipleOrder2 setIndividualOrderDetails(List<RedemptionOrder4> individualOrderDetails) {
	...
	public RedemptionMultipleOrder2 setBulkCashSettlementDetails(PaymentTransaction15 bulkCashSettlementDetails) {
