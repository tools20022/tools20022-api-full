...
@XmlType(name = "QuantityAndAccount68", propOrder = {"settlementQuantity", "denominationChoice", "accountOwner", "safekeepingAccount", "cashAccount", "safekeepingPlace", "quantityBreakdown"})
public class QuantityAndAccount68 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, Optional<Quantity6Choice>> mmSettlementQuantity = new MMMessageAssociationEnd<QuantityAndAccount68, Optional<Quantity6Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount68.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SettlementQuantity";
			definition = "Total quantity of securities to be settled.";
			previousVersion_lazy = () -> QuantityAndAccount43.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Quantity6Choice> getValue(QuantityAndAccount68 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<Quantity6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount68, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount68, Optional<Max210Text>>() {
		{
			...
			definition = "Denomination of the security to be received or delivered.";
			previousVersion_lazy = () -> QuantityAndAccount43.mmDenominationChoice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(QuantityAndAccount68 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<Max210Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, Optional<PartyIdentification98>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount68, Optional<PartyIdentification98>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount43.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification98> getValue(QuantityAndAccount68 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<PartyIdentification98> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, Optional<SecuritiesAccount19>> mmSafekeepingAccount = new MMMessageAssociationEnd<QuantityAndAccount68, Optional<SecuritiesAccount19>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount43.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesAccount19> getValue(QuantityAndAccount68 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<SecuritiesAccount19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount68, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount43.mmCashAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(QuantityAndAccount68 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount68, Optional<SafeKeepingPlace1>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount43.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(QuantityAndAccount68 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount68, List<QuantityBreakdown46>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount68, List<QuantityBreakdown46>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount43.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown46> getValue(QuantityAndAccount68 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount68 obj, List<QuantityBreakdown46> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount68.mmSettlementQuantity, com.tools20022.repository.msg.QuantityAndAccount68.mmDenominationChoice,
						com.tools20022.repository.msg.QuantityAndAccount68.mmAccountOwner, com.tools20022.repository.msg.QuantityAndAccount68.mmSafekeepingAccount, com.tools20022.repository.msg.QuantityAndAccount68.mmCashAccount,
						com.tools20022.repository.msg.QuantityAndAccount68.mmSafekeepingPlace, com.tools20022.repository.msg.QuantityAndAccount68.mmQuantityBreakdown);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount68, com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forQuantityAndAccount68,
						com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount68);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "QuantityAndAccount68";
				definition = "Details on the quantity, account and other related information involved in a transaction.";
				previousVersion_lazy = () -> QuantityAndAccount43.mmObject();
			}
		});
	...
	public QuantityAndAccount68 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public QuantityAndAccount68 setDenominationChoice(Max210Text denominationChoice) {
	...
	public QuantityAndAccount68 setAccountOwner(PartyIdentification98 accountOwner) {
	...
	public QuantityAndAccount68 setSafekeepingAccount(SecuritiesAccount19 safekeepingAccount) {
	...
	public QuantityAndAccount68 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public QuantityAndAccount68 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public QuantityAndAccount68 setQuantityBreakdown(List<QuantityBreakdown46> quantityBreakdown) {
