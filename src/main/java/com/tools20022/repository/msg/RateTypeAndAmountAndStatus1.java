...
public class RateTypeAndAmountAndStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus1.mmRateType, RateTypeAndAmountAndStatus1.mmAmount, RateTypeAndAmountAndStatus1.mmRateStatus);
