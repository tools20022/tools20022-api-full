...
public class RateTypeAndAmountAndStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus1.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus1.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus1.RateStatus);
