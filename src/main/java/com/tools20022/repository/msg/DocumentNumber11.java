...
public class DocumentNumber11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DocumentNumber11.mmNumber, DocumentNumber11.mmReferences);
	...
	public void setReferences(List<com.tools20022.repository.msg.Identification13> references) {
