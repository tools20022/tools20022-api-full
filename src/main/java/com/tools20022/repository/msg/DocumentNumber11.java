 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DocumentNumber11#Number
 * DocumentNumber11.Number}</li>
 * <li>{@linkplain com.tools20022.repository.msg.DocumentNumber11#References
 * DocumentNumber11.References}</li>
 * </ul>
 * </li>
...
public class DocumentNumber11 {
	...
	public static final MMMessageAssociationEnd Number = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> DocumentNumber11.mmObject();
			isDerived = false;
			xmlTag = "Nb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentNumber11.Number, com.tools20022.repository.msg.DocumentNumber11.References);
