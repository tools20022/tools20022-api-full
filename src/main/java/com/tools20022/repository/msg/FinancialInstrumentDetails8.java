...
public class FinancialInstrumentDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails8.mmFinancialInstrumentIdentification, FinancialInstrumentDetails8.mmPriceDetails, FinancialInstrumentDetails8.mmSafekeepingPlace,
						FinancialInstrumentDetails8.mmOpeningBalance, FinancialInstrumentDetails8.mmClosingBalance, FinancialInstrumentDetails8.mmTransaction);
