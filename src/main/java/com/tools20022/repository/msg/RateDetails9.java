...
public class RateDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateDetails9.mmAdditionalTax, RateDetails9.mmChargesFees, RateDetails9.mmFinalDividendRate, RateDetails9.mmFiscalStamp, RateDetails9.mmFullyFrankedRate,
						RateDetails9.mmGrossDividendRate, RateDetails9.mmEarlySolicitationFeeRate, RateDetails9.mmCashIncentiveRate, RateDetails9.mmInterestRateUsedForPayment, RateDetails9.mmNetDividendRate, RateDetails9.mmNonResidentRate,
						RateDetails9.mmProvisionalDividendRate, RateDetails9.mmApplicableRate, RateDetails9.mmSolicitationFeeRate, RateDetails9.mmTaxCreditRate, RateDetails9.mmTaxRelatedRate, RateDetails9.mmWithholdingTaxRate,
						RateDetails9.mmTaxOnIncome, RateDetails9.mmTaxOnProfits, RateDetails9.mmTaxReclaimRate, RateDetails9.mmWithholdingOfForeignTax, RateDetails9.mmWithholdingOfLocalTax);
	...
	public void setNetDividendRate(List<NetDividendRateFormat3Choice> netDividendRate) {
	...
	public RateAndAmountFormat6Choice getWithholdingOfLocalTax() {
		return withholdingOfLocalTax;
	}

	public void setWithholdingOfLocalTax(RateAndAmountFormat6Choice withholdingOfLocalTax) {
