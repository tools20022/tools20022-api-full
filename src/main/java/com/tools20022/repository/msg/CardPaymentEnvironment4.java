...
public class CardPaymentEnvironment4 {
	...
	public static final MMMessageAttribute mmCard = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.msg.PaymentCard3.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment4.mmAcquirer, CardPaymentEnvironment4.mmMerchant, CardPaymentEnvironment4.mmPOI, CardPaymentEnvironment4.mmCard);
	...
	public void setCard(com.tools20022.repository.msg.PaymentCard3 card) {
		this.card = card;
	}
}