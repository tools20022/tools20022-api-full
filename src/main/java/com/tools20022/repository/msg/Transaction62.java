...
public class Transaction62 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails103.mmObject();
		}
	};
	...
	public Transaction62 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails103 transactionDetails) {
	...
	public Transaction62 setSupplementaryData(List<com.tools20022.repository.msg.SupplementaryData1> supplementaryData) {
