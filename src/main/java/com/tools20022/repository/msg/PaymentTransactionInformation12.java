...
public class PaymentTransactionInformation12 {
	...
	public static final MMMessageAttribute mmStatusIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentTransactionInformation12.mmObject();
			isDerived = false;
			xmlTag = "StsId";
	...
	public static final MMMessageAssociationEnd mmOriginalTransactionReference = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.OriginalTransactionReference8.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation12.mmStatusIdentification, PaymentTransactionInformation12.mmOriginalInstructionIdentification,
						PaymentTransactionInformation12.mmOriginalEndToEndIdentification, PaymentTransactionInformation12.mmOriginalTransactionIdentification, PaymentTransactionInformation12.mmTransactionStatus,
						PaymentTransactionInformation12.mmStatusReasonInformation, PaymentTransactionInformation12.mmInstructingAgent, PaymentTransactionInformation12.mmInstructedAgent,
						PaymentTransactionInformation12.mmOriginalTransactionReference);
	...
	public void setOriginalTransactionReference(com.tools20022.repository.msg.OriginalTransactionReference8 originalTransactionReference) {
