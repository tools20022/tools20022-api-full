 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation13
...
@XmlType(name = "ReceiveInformation9", propOrder = {"requestedSettlementDate", "settlementAmount", "stampDuty", "netAmount", "settlementPartiesDetails", "chargeDetails", "commissionDetails", "taxDetails", "physicalTransfer",
...
public class ReceiveInformation9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation9, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<ReceiveInformation9, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation9.mmObject();
			isDerived = false;
			xmlTag = "ReqdSttlmDt";
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmRequestedSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(ReceiveInformation9 obj) {
			return obj.getRequestedSettlementDate();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation9, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation9, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation9 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation9, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation9, Optional<StampDutyType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmStampDuty);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StampDutyType2Code> getValue(ReceiveInformation9 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation9, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation9, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmNetAmount);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation9, Optional<ReceivingPartiesAndAccount8>> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation9, Optional<ReceivingPartiesAndAccount8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmSettlementPartiesDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ReceivingPartiesAndAccount8> getValue(ReceiveInformation9 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<ReceivingPartiesAndAccount8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation9, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation9, List<Charge20>>() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmChargeDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charge20> getValue(ReceiveInformation9 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation9, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation9, List<Commission12>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmCommissionDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Commission12> getValue(ReceiveInformation9 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation9, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation9, List<Tax15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmTaxDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Tax15> getValue(ReceiveInformation9 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation9, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation9, Optional<PhysicalTransferType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmPhysicalTransfer);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(ReceiveInformation9 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation9, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation9, Optional<DeliveryParameters4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmPhysicalTransferDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation9 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation9 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation9.mmRequestedSettlementDate, com.tools20022.repository.msg.ReceiveInformation9.mmSettlementAmount,
						com.tools20022.repository.msg.ReceiveInformation9.mmStampDuty, com.tools20022.repository.msg.ReceiveInformation9.mmNetAmount, com.tools20022.repository.msg.ReceiveInformation9.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.ReceiveInformation9.mmChargeDetails, com.tools20022.repository.msg.ReceiveInformation9.mmCommissionDetails, com.tools20022.repository.msg.ReceiveInformation9.mmTaxDetails,
						com.tools20022.repository.msg.ReceiveInformation9.mmPhysicalTransfer, com.tools20022.repository.msg.ReceiveInformation9.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutInstructionV04.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation9,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation9, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation9);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ReceiveInformation9";
				definition = "Parameters applied to the settlement of a security transfer.";
				nextVersions_lazy = () -> Arrays.asList(ReceiveInformation13.mmObject());
				previousVersion_lazy = () -> ReceiveInformation5.mmObject();
			}
		});
	...
	public ReceiveInformation9 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public ReceiveInformation9 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation9 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation9 setNetAmount(ActiveCurrencyAndAmount netAmount) {
		this.netAmount = netAmount;
		return this;
	}

	public Optional<ReceivingPartiesAndAccount8> getSettlementPartiesDetails() {
		return settlementPartiesDetails == null ? Optional.empty() : Optional.of(settlementPartiesDetails);
	}

	public ReceiveInformation9 setSettlementPartiesDetails(ReceivingPartiesAndAccount8 settlementPartiesDetails) {
	...
	public ReceiveInformation9 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public ReceiveInformation9 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public ReceiveInformation9 setTaxDetails(List<Tax15> taxDetails) {
	...
	public ReceiveInformation9 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation9 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
