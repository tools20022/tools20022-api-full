...
public class AlternatePartyIdentification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AlternatePartyIdentification2.mmIdentificationType, AlternatePartyIdentification2.mmCountry, AlternatePartyIdentification2.mmAlternateIdentification);
