 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule#forAlternatePartyIdentification2
 * ConstraintCoexistence35to30TextFieldRule.forAlternatePartyIdentification2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AlternatePartyIdentification2", propOrder = {"identificationType", "country", "alternateIdentification"})
public class AlternatePartyIdentification2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AlternatePartyIdentification2, IdentificationType4Choice> mmIdentificationType = new MMMessageAttribute<AlternatePartyIdentification2, IdentificationType4Choice>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AlternatePartyIdentification2.mmObject();
			isDerived = false;
			xmlTag = "IdTp";
			...
			nextVersions_lazy = () -> Arrays.asList(AlternatePartyIdentification7.mmIdentificationType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public IdentificationType4Choice getValue(AlternatePartyIdentification2 obj) {
			return obj.getIdentificationType();
		}

		@Override
		public void setValue(AlternatePartyIdentification2 obj, IdentificationType4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AlternatePartyIdentification2, CountryCode> mmCountry = new MMMessageAttribute<AlternatePartyIdentification2, CountryCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternatePartyIdentification7.mmCountry);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CountryCode getValue(AlternatePartyIdentification2 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(AlternatePartyIdentification2 obj, CountryCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AlternatePartyIdentification2, Max35Text> mmAlternateIdentification = new MMMessageAttribute<AlternatePartyIdentification2, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternatePartyIdentification7.mmAlternateIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(AlternatePartyIdentification2 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(AlternatePartyIdentification2 obj, Max35Text value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule.forAlternatePartyIdentification2);
	...
	public AlternatePartyIdentification2 setIdentificationType(IdentificationType4Choice identificationType) {
	...
	public AlternatePartyIdentification2 setCountry(CountryCode country) {
	...
	public AlternatePartyIdentification2 setAlternateIdentification(Max35Text alternateIdentification) {
