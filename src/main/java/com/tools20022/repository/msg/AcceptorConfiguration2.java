...
public class AcceptorConfiguration2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorConfiguration2.mmPOIIdentification, AcceptorConfiguration2.mmTerminalManagerIdentification, AcceptorConfiguration2.mmDataSet);
