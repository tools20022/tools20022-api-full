...
public class CorporateActionQuantity2 {
	...
	public static final MMMessageAssociationEnd mmMinimumExercisableQuantity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionQuantity2.mmObject();
			isDerived = false;
			xmlTag = "MinExrcblQty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionQuantity2.mmMinimumExercisableQuantity, CorporateActionQuantity2.mmMinimumExercisableMultipleQuantity, CorporateActionQuantity2.mmMaximumQuantity,
						CorporateActionQuantity2.mmMinimumQuantitySought, CorporateActionQuantity2.mmNewBoardLotQuantity, CorporateActionQuantity2.mmNewDenominationQuantity, CorporateActionQuantity2.mmBaseDenomination,
						CorporateActionQuantity2.mmIncrementalDenomination);
	...
	public FinancialInstrumentQuantity14Choice getMaximumQuantity() {
		return maximumQuantity;
	}

	public void setMaximumQuantity(FinancialInstrumentQuantity14Choice maximumQuantity) {
		this.maximumQuantity = maximumQuantity;
	}

	public FinancialInstrumentQuantity14Choice getMinimumQuantitySought() {
		return minimumQuantitySought;
	}

	public void setMinimumQuantitySought(FinancialInstrumentQuantity14Choice minimumQuantitySought) {
