	...
	public static final MMMessageAttribute RemittanceIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RemittanceInformation12.RemittanceIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Unstructured = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RemittanceInformation12.Unstructured;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Structured = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RemittanceInformation12.Structured;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OriginalPaymentInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RemittanceInformation12.OriginalPaymentInformation;
			minOccurs = 1;
			maxOccurs = 1;
