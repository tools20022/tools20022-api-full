...
public class CorporateActionPrice45 {
	...
	public static final MMMessageAttribute CashInLieuOfSharePrice = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CorporateActionPrice45.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.CashInLieuOfSharePrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice59.CashInLieuOfSharePrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.IndicativeOrMarketPrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice59.IndicativeOrMarketPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CashValueForTax = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.CashValueForTax;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice59.CashValueForTax);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.GenericCashPricePaidPerProduct;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice59.GenericCashPricePaidPerProduct);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice39.GenericCashPriceReceivedPerProduct;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice59.GenericCashPriceReceivedPerProduct);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice45.CashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice45.IndicativeOrMarketPrice,
						com.tools20022.repository.msg.CorporateActionPrice45.CashValueForTax, com.tools20022.repository.msg.CorporateActionPrice45.GenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice45.GenericCashPriceReceivedPerProduct);
