...
public class PartyIdentificationAndAccount26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount26.mmIdentification, PartyIdentificationAndAccount26.mmAlternateIdentification, PartyIdentificationAndAccount26.mmSafekeepingAccount,
						PartyIdentificationAndAccount26.mmProcessingDate, PartyIdentificationAndAccount26.mmProcessingIdentification, PartyIdentificationAndAccount26.mmAdditionalInformation);
