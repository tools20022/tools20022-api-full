 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransactionIdentifications1
 * ConstraintCoexistenceIdentificationRule.forTransactionIdentifications1}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "TransactionIdentifications1", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "commonIdentification"})
public class TransactionIdentifications1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications1, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications1, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications1.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications32.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionIdentifications1 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications1 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications1, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications1, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications32.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionIdentifications1 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications1 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications1, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<TransactionIdentifications1, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications32.mmCommonIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionIdentifications1.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications1.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.TransactionIdentifications1.mmCommonIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingStatusAdviceV01.mmTransactionIdentification, SecuritiesFinancingStatusAdviceV02.mmTransactionIdentification,
						SecuritiesFinancingStatusAdviceV03.mmTransactionIdentification, SecuritiesFinancingStatusAdviceV04.mmTransactionIdentification, SecuritiesFinancingStatusAdviceV05.mmTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransactionIdentifications1,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionIdentifications1);
				...
				name = "TransactionIdentifications1";
				definition = "Provides transaction type and identification information.";
				nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications32.mmObject());
			}
		});
	...
	public TransactionIdentifications1 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionIdentifications1 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionIdentifications1 setCommonIdentification(Max35Text commonIdentification) {
