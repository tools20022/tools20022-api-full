 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.BusinessDayInformation2#BusinessDayInformationReport
 * BusinessDayInformation2.BusinessDayInformationReport}</li>
 * </ul>
 * </li>
 * <li>
...
public class BusinessDayInformation2 {
	...
	public static final MMMessageAssociationEnd BusinessDayInformationReport = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> BusinessDayInformation2.mmObject();
			isDerived = false;
			xmlTag = "BizDayInfRpt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BusinessDayInformation2.BusinessDayInformationReport);
