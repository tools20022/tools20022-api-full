...
public class BusinessDayInformation2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BusinessDayInformation2.mmBusinessDayInformationReport);
	...
	public void setBusinessDayInformationReport(List<com.tools20022.repository.msg.BusinessDayInformationReport2> businessDayInformationReport) {
