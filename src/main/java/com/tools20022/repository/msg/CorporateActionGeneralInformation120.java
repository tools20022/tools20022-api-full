...
public class CorporateActionGeneralInformation120 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation120.mmCorporateActionEventIdentification, CorporateActionGeneralInformation120.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation120.mmClassActionNumber, CorporateActionGeneralInformation120.mmEventType, CorporateActionGeneralInformation120.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation120.mmFinancialInstrumentIdentification);
