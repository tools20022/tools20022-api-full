 ...
 * FinancialInstitutionIdentification1.mmClearingSystemMemberIdentification}</li>
 * <li>
...
public class FinancialInstitutionIdentification1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstitutionIdentification1, Optional<BICIdentifier>> mmBIC = new MMMessageAttribute<FinancialInstitutionIdentification1, Optional<BICIdentifier>>() {
		{
		...
		@Override
		public Optional<BICIdentifier> getValue(FinancialInstitutionIdentification1 obj) {
			return obj.getBIC();
		}

		@Override
		public void setValue(FinancialInstitutionIdentification1 obj, Optional<BICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstitutionIdentification1, Optional<ClearingSystemMemberIdentificationChoice>> mmClearingSystemMemberIdentification = new MMMessageAttribute<FinancialInstitutionIdentification1, Optional<ClearingSystemMemberIdentificationChoice>>() {
		{
		...
		@Override
		public Optional<ClearingSystemMemberIdentificationChoice> getValue(FinancialInstitutionIdentification1 obj) {
			return obj.getClearingSystemMemberIdentification();
		}

		@Override
		public void setValue(FinancialInstitutionIdentification1 obj, Optional<ClearingSystemMemberIdentificationChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstitutionIdentification1, Optional<Max70Text>> mmName = new MMMessageAttribute<FinancialInstitutionIdentification1, Optional<Max70Text>>() {
		{
		...
		@Override
		public Optional<Max70Text> getValue(FinancialInstitutionIdentification1 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(FinancialInstitutionIdentification1 obj, Optional<Max70Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstitutionIdentification1, Optional<PostalAddress1>> mmPostalAddress = new MMMessageAssociationEnd<FinancialInstitutionIdentification1, Optional<PostalAddress1>>() {
		{
		...
		@Override
		public Optional<PostalAddress1> getValue(FinancialInstitutionIdentification1 obj) {
			return obj.getPostalAddress();
		}

		@Override
		public void setValue(FinancialInstitutionIdentification1 obj, Optional<PostalAddress1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstitutionIdentification1, Optional<GenericIdentification3>> mmProprietaryIdentification = new MMMessageAssociationEnd<FinancialInstitutionIdentification1, Optional<GenericIdentification3>>() {
		{
		...
		@Override
		public Optional<GenericIdentification3> getValue(FinancialInstitutionIdentification1 obj) {
			return obj.getProprietaryIdentification();
		}

		@Override
		public void setValue(FinancialInstitutionIdentification1 obj, Optional<GenericIdentification3> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				name = "FinancialInstitutionIdentification1";
	...
	public FinancialInstitutionIdentification1 setPostalAddress(PostalAddress1 postalAddress) {
	...
	public FinancialInstitutionIdentification1 setProprietaryIdentification(GenericIdentification3 proprietaryIdentification) {
