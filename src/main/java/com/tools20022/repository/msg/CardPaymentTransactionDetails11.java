...
public class CardPaymentTransactionDetails11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails11.mmCurrency, CardPaymentTransactionDetails11.mmTotalAmount, CardPaymentTransactionDetails11.mmDetailedAmount,
						CardPaymentTransactionDetails11.mmValidityDate, CardPaymentTransactionDetails11.mmAccountType, CardPaymentTransactionDetails11.mmICCRelatedData);
