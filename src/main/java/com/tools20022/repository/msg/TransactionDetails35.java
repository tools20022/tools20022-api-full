...
public class TransactionDetails35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails35.mmAccountOwner, TransactionDetails35.mmSafekeepingAccount, TransactionDetails35.mmFinancialInstrumentIdentification, TransactionDetails35.mmSettlementQuantity,
						TransactionDetails35.mmSettlementAmount, TransactionDetails35.mmTradeDate, TransactionDetails35.mmSettlementDate, TransactionDetails35.mmDeliveringSettlementParties,
						TransactionDetails35.mmReceivingSettlementParties, TransactionDetails35.mmInvestor);
