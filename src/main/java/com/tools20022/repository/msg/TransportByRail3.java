...
public class TransportByRail3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRail3.PlaceOfReceipt, com.tools20022.repository.msg.TransportByRail3.PlaceOfDelivery,
						com.tools20022.repository.msg.TransportByRail3.RailCarrierName);
