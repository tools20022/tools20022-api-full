	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse1.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmResponse = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardPaymentTransactionAdviceResponse1.mmResponse;
			maxOccurs = 1;
			minOccurs = 1;
