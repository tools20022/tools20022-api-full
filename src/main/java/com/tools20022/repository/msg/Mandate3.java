 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#MandateIdentification
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#Type Mandate3.Type}</li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#Creditor
 * Mandate3.Creditor}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#CreditorAccount
 * Mandate3.CreditorAccount}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#CreditorAgent
 * Mandate3.CreditorAgent}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#UltimateCreditor
 * Mandate3.UltimateCreditor}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#Debtor
 * Mandate3.Debtor}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#DebtorAccount
 * Mandate3.DebtorAccount}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#DebtorAgent
 * Mandate3.DebtorAgent}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Mandate3#UltimateDebtor
...
public class Mandate3 {
	...
	public static final MMMessageAttribute MandateIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Mandate3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.MandateIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MandateRequestIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.MandateRequestIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd Type = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.Type);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Occurrences = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.Occurrences);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CollectionAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.CollectionAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MaximumAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.MaximumAmount);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd CreditorSchemeIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.CreditorSchemeIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Creditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.Creditor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.CreditorAccount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.CreditorAgent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.UltimateCreditor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Debtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.Debtor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.DebtorAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.DebtorAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.UltimateDebtor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ReferredDocument = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate6.ReferredDocument);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Mandate3.MandateIdentification, com.tools20022.repository.msg.Mandate3.MandateRequestIdentification, com.tools20022.repository.msg.Mandate3.Type,
						com.tools20022.repository.msg.Mandate3.Occurrences, com.tools20022.repository.msg.Mandate3.CollectionAmount, com.tools20022.repository.msg.Mandate3.MaximumAmount,
						com.tools20022.repository.msg.Mandate3.CreditorSchemeIdentification, com.tools20022.repository.msg.Mandate3.Creditor, com.tools20022.repository.msg.Mandate3.CreditorAccount,
						com.tools20022.repository.msg.Mandate3.CreditorAgent, com.tools20022.repository.msg.Mandate3.UltimateCreditor, com.tools20022.repository.msg.Mandate3.Debtor, com.tools20022.repository.msg.Mandate3.DebtorAccount,
						com.tools20022.repository.msg.Mandate3.DebtorAgent, com.tools20022.repository.msg.Mandate3.UltimateDebtor, com.tools20022.repository.msg.Mandate3.ReferredDocument);
