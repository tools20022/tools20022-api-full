...
public class Mandate3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Mandate3.mmMandateIdentification, Mandate3.mmMandateRequestIdentification, Mandate3.mmType, Mandate3.mmOccurrences, Mandate3.mmCollectionAmount, Mandate3.mmMaximumAmount,
						Mandate3.mmCreditorSchemeIdentification, Mandate3.mmCreditor, Mandate3.mmCreditorAccount, Mandate3.mmCreditorAgent, Mandate3.mmUltimateCreditor, Mandate3.mmDebtor, Mandate3.mmDebtorAccount, Mandate3.mmDebtorAgent,
						Mandate3.mmUltimateDebtor, Mandate3.mmReferredDocument);
