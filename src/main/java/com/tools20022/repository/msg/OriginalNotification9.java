	...
	public static final MMMessageAttribute OriginalMessageIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.OriginalMessageIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalCreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.OriginalCreationDateTime;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalNotificationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.OriginalNotificationIdentification;
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute NotificationStatus = new MMMessageAttribute() {
		{
			...
			definition = "Specifies the status of the notification in a coded form.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.NotificationStatus;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalStatusInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.AdditionalStatusInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalNotificationReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalNotification7.OriginalNotificationReference;
			minOccurs = 0;
