...
public class SecuritiesTradeDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails8.mmTradeIdentification, SecuritiesTradeDetails8.mmCollateralTransactionIdentification, SecuritiesTradeDetails8.mmAccountOwnerTransactionIdentification,
						SecuritiesTradeDetails8.mmPlaceOfTrade, SecuritiesTradeDetails8.mmPlaceOfClearing, SecuritiesTradeDetails8.mmTradeDate, SecuritiesTradeDetails8.mmSettlementDate, SecuritiesTradeDetails8.mmLateDeliveryDate,
						SecuritiesTradeDetails8.mmDealPrice, SecuritiesTradeDetails8.mmNumberOfDaysAccrued, SecuritiesTradeDetails8.mmOpeningClosing, SecuritiesTradeDetails8.mmReporting, SecuritiesTradeDetails8.mmTradeTransactionCondition,
						SecuritiesTradeDetails8.mmTypeOfPrice);
