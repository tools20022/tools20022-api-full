 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification13#mmType
...
@XmlType(name = "MarketIdentification13", propOrder = {"identification", "type"})
public class MarketIdentification13 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification13, Optional<MarketIdentification3Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification13, Optional<MarketIdentification3Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification13.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification80.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification3Choice> getValue(MarketIdentification13 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification13 obj, Optional<MarketIdentification3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification13, Optional<MarketType12Choice>> mmType = new MMMessageAssociationEnd<MarketIdentification13, Optional<MarketType12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification80.mmType);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketType12Choice> getValue(MarketIdentification13 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification13 obj, Optional<MarketType12Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification13.mmIdentification, com.tools20022.repository.msg.MarketIdentification13.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification13,
						com.tools20022.repository.constraints.ConstraintIdentificationPresenceRule.forMarketIdentification13, com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forMarketIdentification13);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketIdentification13";
				...
				nextVersions_lazy = () -> Arrays.asList(MarketIdentification80.mmObject());
			}
		});
	...
	public MarketIdentification13 setIdentification(MarketIdentification3Choice identification) {
	...
	public MarketIdentification13 setType(MarketType12Choice type) {
		this.type = type;
		return this;
	}
}