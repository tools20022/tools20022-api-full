...
public class SecuritiesOption35 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption35.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption35.mmFinancialInstrumentIdentification, SecuritiesOption35.mmCreditDebitIndicator, SecuritiesOption35.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption35.mmPostingQuantity, SecuritiesOption35.mmSafekeepingPlace, SecuritiesOption35.mmFractionDisposition, SecuritiesOption35.mmCurrencyOption, SecuritiesOption35.mmDateDetails,
						SecuritiesOption35.mmRateDetails, SecuritiesOption35.mmPriceDetails, SecuritiesOption35.mmReceivingSettlementParties, SecuritiesOption35.mmDeliveringSettlementParties);
	...
	public CorporateActionRate29 getRateDetails() {
		return rateDetails;
	}

	public void setRateDetails(com.tools20022.repository.msg.CorporateActionRate29 rateDetails) {
		this.rateDetails = rateDetails;
	}

	@XmlElement(name = "PricDtls")
	public CorporateActionPrice39 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice39 priceDetails) {
