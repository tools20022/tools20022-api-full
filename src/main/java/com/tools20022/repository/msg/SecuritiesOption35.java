...
@XmlType(name = "SecuritiesOption35", propOrder = {"financialInstrumentIdentification", "creditDebitIndicator", "temporaryFinancialInstrumentIndicator", "postingQuantity", "safekeepingPlace", "fractionDisposition", "currencyOption",
...
public class SecuritiesOption35 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<SecuritiesOption35, SecurityIdentification14>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesOption35.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmFinancialInstrumentIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(SecuritiesOption35 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption35, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<SecuritiesOption35, CreditDebitCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(SecuritiesOption35 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<TemporaryFinancialInstrumentIndicator1Choice>> mmTemporaryFinancialInstrumentIndicator = new MMMessageAssociationEnd<SecuritiesOption35, Optional<TemporaryFinancialInstrumentIndicator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmTemporaryFinancialInstrumentIndicator);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TemporaryFinancialInstrumentIndicator1Choice> getValue(SecuritiesOption35 obj) {
			return obj.getTemporaryFinancialInstrumentIndicator();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<TemporaryFinancialInstrumentIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Quantity6Choice> mmPostingQuantity = new MMMessageAssociationEnd<SecuritiesOption35, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmPostingQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(SecuritiesOption35 obj) {
			return obj.getPostingQuantity();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<SecuritiesOption35, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmSafekeepingPlace);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(SecuritiesOption35 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<FractionDispositionType23Choice>> mmFractionDisposition = new MMMessageAssociationEnd<SecuritiesOption35, Optional<FractionDispositionType23Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmFractionDisposition);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FractionDispositionType23Choice> getValue(SecuritiesOption35 obj) {
			return obj.getFractionDisposition();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<FractionDispositionType23Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption35, Optional<ActiveCurrencyCode>> mmCurrencyOption = new MMMessageAttribute<SecuritiesOption35, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmCurrencyOption);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(SecuritiesOption35 obj) {
			return obj.getCurrencyOption();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, SecurityDate6> mmDateDetails = new MMMessageAssociationEnd<SecuritiesOption35, SecurityDate6>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmDateDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityDate6 getValue(SecuritiesOption35 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, SecurityDate6 value) {
			obj.setDateDetails(value);
		}
	};
	@XmlElement(name = "RateDtls")
	protected CorporateActionRate29 rateDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionRate29
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<CorporateActionRate29>> mmRateDetails = new MMMessageAssociationEnd<SecuritiesOption35, Optional<CorporateActionRate29>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmRateDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionRate29.mmObject();
		}

		@Override
		public Optional<CorporateActionRate29> getValue(SecuritiesOption35 obj) {
			return obj.getRateDetails();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<CorporateActionRate29> value) {
			obj.setRateDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "PricDtls")
	protected CorporateActionPrice39 priceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionPrice39
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<CorporateActionPrice39>> mmPriceDetails = new MMMessageAssociationEnd<SecuritiesOption35, Optional<CorporateActionPrice39>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmPriceDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionPrice39.mmObject();
		}

		@Override
		public Optional<CorporateActionPrice39> getValue(SecuritiesOption35 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<CorporateActionPrice39> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<SettlementParties24>> mmReceivingSettlementParties = new MMMessageAssociationEnd<SecuritiesOption35, Optional<SettlementParties24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmReceivingSettlementParties);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties24> getValue(SecuritiesOption35 obj) {
			return obj.getReceivingSettlementParties();
		}

		@Override
		public void setValue(SecuritiesOption35 obj, Optional<SettlementParties24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption35, Optional<SettlementParties24>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<SecuritiesOption35, Optional<SettlementParties24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmDeliveringSettlementParties);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties24.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesOption35.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.SecuritiesOption35.mmCreditDebitIndicator,
						com.tools20022.repository.msg.SecuritiesOption35.mmTemporaryFinancialInstrumentIndicator, com.tools20022.repository.msg.SecuritiesOption35.mmPostingQuantity,
						com.tools20022.repository.msg.SecuritiesOption35.mmSafekeepingPlace, com.tools20022.repository.msg.SecuritiesOption35.mmFractionDisposition, com.tools20022.repository.msg.SecuritiesOption35.mmCurrencyOption,
						com.tools20022.repository.msg.SecuritiesOption35.mmDateDetails, com.tools20022.repository.msg.SecuritiesOption35.mmRateDetails, com.tools20022.repository.msg.SecuritiesOption35.mmPriceDetails,
						com.tools20022.repository.msg.SecuritiesOption35.mmReceivingSettlementParties, com.tools20022.repository.msg.SecuritiesOption35.mmDeliveringSettlementParties);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forSecuritiesOption35);
				...
				name = "SecuritiesOption35";
				definition = "Provides information about the corporate action security option.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesOption42.mmObject());
				previousVersion_lazy = () -> SecuritiesOption26.mmObject();
			}
		});
	...
	public SecuritiesOption35 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public SecuritiesOption35 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public SecuritiesOption35 setTemporaryFinancialInstrumentIndicator(TemporaryFinancialInstrumentIndicator1Choice temporaryFinancialInstrumentIndicator) {
	...
	public SecuritiesOption35 setPostingQuantity(Quantity6Choice postingQuantity) {
	...
	public SecuritiesOption35 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public SecuritiesOption35 setFractionDisposition(FractionDispositionType23Choice fractionDisposition) {
	...
	public SecuritiesOption35 setCurrencyOption(ActiveCurrencyCode currencyOption) {
	...
	public SecuritiesOption35 setDateDetails(SecurityDate6 dateDetails) {
		this.dateDetails = Objects.requireNonNull(dateDetails);
		return this;
	}

	public Optional<CorporateActionRate29> getRateDetails() {
		return rateDetails == null ? Optional.empty() : Optional.of(rateDetails);
	}

	public SecuritiesOption35 setRateDetails(CorporateActionRate29 rateDetails) {
		this.rateDetails = rateDetails;
		return this;
	}

	public Optional<CorporateActionPrice39> getPriceDetails() {
		return priceDetails == null ? Optional.empty() : Optional.of(priceDetails);
	}

	public SecuritiesOption35 setPriceDetails(CorporateActionPrice39 priceDetails) {
	...
	public SecuritiesOption35 setReceivingSettlementParties(SettlementParties24 receivingSettlementParties) {
	...
	public SecuritiesOption35 setDeliveringSettlementParties(SettlementParties24 deliveringSettlementParties) {
