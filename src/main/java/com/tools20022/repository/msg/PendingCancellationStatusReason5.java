...
@XmlType(name = "PendingCancellationStatusReason5", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingCancellationStatusReason5 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingCancellationReason3Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<PendingCancellationStatusReason5, PendingCancellationReason3Choice> mmReasonCode = new MMMessageAssociationEnd<PendingCancellationStatusReason5, PendingCancellationReason3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationStatusReason7.mmReasonCode);
			previousVersion_lazy = () -> PendingCancellationStatusReason3.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<PendingCancellationStatusReason5, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingCancellationStatusReason5, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationStatusReason7.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> PendingCancellationStatusReason3.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason5.mmReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason5.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingCancellationStatusReason5,
						com.tools20022.repository.constraints.ConstraintAccountServicerDeadlineMissedGuideline.forPendingCancellationStatusReason5);
	...
	public PendingCancellationReason3Choice getReasonCode() {
		return reasonCode;
	}

	public PendingCancellationStatusReason5 setReasonCode(PendingCancellationReason3Choice reasonCode) {
	...
	public PendingCancellationStatusReason5 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
