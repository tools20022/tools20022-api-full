...
public class UnmatchedReason1 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason1.mmCode, UnmatchedReason1.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason1Choice code) {
		this.code = code;
	}
