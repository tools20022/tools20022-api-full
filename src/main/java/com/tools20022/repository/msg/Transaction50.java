...
public class Transaction50 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction50.mmAccountOwnerTransactionIdentification, Transaction50.mmAccountServicerTransactionIdentification, Transaction50.mmMarketInfrastructureTransactionIdentification,
						Transaction50.mmProcessorTransactionIdentification, Transaction50.mmTradeIdentification, Transaction50.mmPoolIdentification, Transaction50.mmCommonIdentification, Transaction50.mmCorporateActionEventIdentification,
						Transaction50.mmTripartyAgentCollateralTransactionIdentification, Transaction50.mmClientTripartyCollateralTransactionIdentification, Transaction50.mmClientCollateralInstructionIdentification,
						Transaction50.mmTripartyCollateralInstructionIdentification, Transaction50.mmTransactionDetails, Transaction50.mmSupplementaryData);
