...
public class AcquirerProtocolParameters4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcquirerProtocolParameters4.mmFinancialCapture, AcquirerProtocolParameters4.mmBatchTransfer, AcquirerProtocolParameters4.mmCompletionExchange,
						AcquirerProtocolParameters4.mmCancellationExchange);
