...
@XmlType(name = "AcquirerProtocolParameters4", propOrder = {"financialCapture", "batchTransfer", "completionExchange", "cancellationExchange"})
public class AcquirerProtocolParameters4 {
	...
	public static final MMMessageAttribute mmFinancialCapture = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcquirerProtocolParameters5.mmFinancialCapture);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmBatchTransfer = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcquirerProtocolParameters5.mmBatchTransfer);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCompletionExchange = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcquirerProtocolParameters5.mmCompletionExchange);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmCancellationExchange = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcquirerProtocolParameters5.mmCancellationExchange);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public AcquirerProtocolParameters4 setFinancialCapture(FinancialCapture1Code financialCapture) {
		this.financialCapture = Objects.requireNonNull(financialCapture);
		return this;
	}

	public Optional<ExchangeConfiguration2> getBatchTransfer() {
	...
	public Optional<ExchangeConfiguration3> getCompletionExchange() {
	...
	public AcquirerProtocolParameters4 setCancellationExchange(CancellationProcess1Code cancellationExchange) {
