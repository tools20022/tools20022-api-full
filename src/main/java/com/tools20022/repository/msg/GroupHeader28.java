...
public class GroupHeader28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader28.mmMessageIdentification, GroupHeader28.mmCreationDateTime, GroupHeader28.mmNumberOfTransactions, GroupHeader28.mmGroupReversal,
						GroupHeader28.mmTotalReversedInterbankSettlementAmount, GroupHeader28.mmInterbankSettlementDate, GroupHeader28.mmSettlementInformation, GroupHeader28.mmInstructingAgent, GroupHeader28.mmInstructedAgent);
