...
@XmlType(name = "CorporateActionGeneralInformationSD30", propOrder = {"placeAndName", "eventGroup", "eventType", "subEventType", "redemptionIdentification"})
public class CorporateActionGeneralInformationSD30 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<Max350Text>> mmPlaceAndName = new MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
		...
		@Override
		public Optional<Max350Text> getValue(CorporateActionGeneralInformationSD30 obj) {
			return obj.getPlaceAndName();
		}

		@Override
		public void setValue(CorporateActionGeneralInformationSD30 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<EventGroup1Code>> mmEventGroup = new MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<EventGroup1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmObject();
			isDerived = false;
			xmlTag = "EvtGrp";
		...
		@Override
		public Optional<EventGroup1Code> getValue(CorporateActionGeneralInformationSD30 obj) {
			return obj.getEventGroup();
		}

		@Override
		public void setValue(CorporateActionGeneralInformationSD30 obj, Optional<EventGroup1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<ExtendedEventType6Code>> mmEventType = new MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<ExtendedEventType6Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmObject();
			isDerived = false;
			xmlTag = "EvtTp";
		...
		@Override
		public Optional<ExtendedEventType6Code> getValue(CorporateActionGeneralInformationSD30 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformationSD30 obj, Optional<ExtendedEventType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<DTCCSubEventType6Code>> mmSubEventType = new MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<DTCCSubEventType6Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmObject();
			isDerived = false;
			xmlTag = "SubEvtTp";
		...
		@Override
		public Optional<DTCCSubEventType6Code> getValue(CorporateActionGeneralInformationSD30 obj) {
			return obj.getSubEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformationSD30 obj, Optional<DTCCSubEventType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<Max10NumericText>> mmRedemptionIdentification = new MMMessageAttribute<CorporateActionGeneralInformationSD30, Optional<Max10NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmObject();
			isDerived = false;
			xmlTag = "RedId";
		...
		@Override
		public Optional<Max10NumericText> getValue(CorporateActionGeneralInformationSD30 obj) {
			return obj.getRedemptionIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformationSD30 obj, Optional<Max10NumericText> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmPlaceAndName, com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmEventGroup,
						com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmEventType, com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmSubEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformationSD30.mmRedemptionIdentification);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionGeneralInformationSD30";
	...
	public CorporateActionGeneralInformationSD30 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionGeneralInformationSD30 setEventGroup(EventGroup1Code eventGroup) {
	...
	public CorporateActionGeneralInformationSD30 setEventType(ExtendedEventType6Code eventType) {
	...
	public CorporateActionGeneralInformationSD30 setSubEventType(DTCCSubEventType6Code subEventType) {
	...
	public CorporateActionGeneralInformationSD30 setRedemptionIdentification(Max10NumericText redemptionIdentification) {
