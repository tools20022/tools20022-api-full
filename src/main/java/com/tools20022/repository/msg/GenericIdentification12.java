...
@XmlType(name = "GenericIdentification12", propOrder = {"identification", "issuer", "otherIdentificationType"})
public class GenericIdentification12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification12.mmIdentification, com.tools20022.repository.msg.GenericIdentification12.mmIssuer,
						com.tools20022.repository.msg.GenericIdentification12.mmOtherIdentificationType);
	...
	public GenericIdentification12 setIdentification(Max35Text identification) {
	...
	public GenericIdentification12 setIssuer(Max35Text issuer) {
		this.issuer = issuer;
		return this;
	}

	public Optional<IdentificationType1Choice> getOtherIdentificationType() {
		return otherIdentificationType == null ? Optional.empty() : Optional.of(otherIdentificationType);
	}

	public GenericIdentification12 setOtherIdentificationType(IdentificationType1Choice otherIdentificationType) {
