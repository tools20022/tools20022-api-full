 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeclarationDetailsRule#forPartyIdentification51
 * ConstraintDeclarationDetailsRule.forPartyIdentification51}</li>
 * </ul>
 * </li>
 * <li>
...
public class PartyIdentification51 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification51, PartyIdentification52Choice> mmOwnerIdentification = new MMMessageAssociationEnd<PartyIdentification51, PartyIdentification52Choice>() {
		{
			businessComponentTrace_lazy = () -> BeneficialOwner.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification51.mmObject();
			isDerived = false;
			xmlTag = "OwnrId";
		...
		@Override
		public PartyIdentification52Choice getValue(PartyIdentification51 obj) {
			return obj.getOwnerIdentification();
		}

		@Override
		public void setValue(PartyIdentification51 obj, PartyIdentification52Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification51, List<AlternatePartyIdentification3>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentification51, List<AlternatePartyIdentification3>>() {
		{
		...
		@Override
		public List<AlternatePartyIdentification3> getValue(PartyIdentification51 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(PartyIdentification51 obj, List<AlternatePartyIdentification3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification51, Optional<CountryCode>> mmDomicileCountry = new MMMessageAttribute<PartyIdentification51, Optional<CountryCode>>() {
		{
		...
		@Override
		public Optional<CountryCode> getValue(PartyIdentification51 obj) {
			return obj.getDomicileCountry();
		}

		@Override
		public void setValue(PartyIdentification51 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification51, List<CountryCode>> mmNonDomicileCountry = new MMMessageAttribute<PartyIdentification51, List<CountryCode>>() {
		{
			businessElementTrace_lazy = () -> Country.mmCode;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentification51.mmObject();
			isDerived = false;
		...
		@Override
		public List<CountryCode> getValue(PartyIdentification51 obj) {
			return obj.getNonDomicileCountry();
		}

		@Override
		public void setValue(PartyIdentification51 obj, List<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification51, FinancialInstrumentQuantity15Choice> mmOwnedSecuritiesQuantity = new MMMessageAssociationEnd<PartyIdentification51, FinancialInstrumentQuantity15Choice>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity15Choice getValue(PartyIdentification51 obj) {
			return obj.getOwnedSecuritiesQuantity();
		}

		@Override
		public void setValue(PartyIdentification51 obj, FinancialInstrumentQuantity15Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification51, List<BeneficiaryCertificationType4Choice>> mmCertificationType = new MMMessageAssociationEnd<PartyIdentification51, List<BeneficiaryCertificationType4Choice>>() {
		{
		...
		@Override
		public List<BeneficiaryCertificationType4Choice> getValue(PartyIdentification51 obj) {
			return obj.getCertificationType();
		}

		@Override
		public void setValue(PartyIdentification51 obj, List<BeneficiaryCertificationType4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification51, Optional<RestrictedFINXMax350Text>> mmDeclarationDetails = new MMMessageAttribute<PartyIdentification51, Optional<RestrictedFINXMax350Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax350Text> getValue(PartyIdentification51 obj) {
			return obj.getDeclarationDetails();
		}

		@Override
		public void setValue(PartyIdentification51 obj, Optional<RestrictedFINXMax350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification51.mmOwnerIdentification, com.tools20022.repository.msg.PartyIdentification51.mmAlternateIdentification,
						com.tools20022.repository.msg.PartyIdentification51.mmDomicileCountry, com.tools20022.repository.msg.PartyIdentification51.mmNonDomicileCountry,
						com.tools20022.repository.msg.PartyIdentification51.mmOwnedSecuritiesQuantity, com.tools20022.repository.msg.PartyIdentification51.mmCertificationType,
						com.tools20022.repository.msg.PartyIdentification51.mmDeclarationDetails);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDeclarationDetailsRule.forPartyIdentification51);
	...
	public PartyIdentification51 setOwnerIdentification(PartyIdentification52Choice ownerIdentification) {
	...
	public PartyIdentification51 setAlternateIdentification(List<AlternatePartyIdentification3> alternateIdentification) {
	...
	public PartyIdentification51 setDomicileCountry(CountryCode domicileCountry) {
	...
	public PartyIdentification51 setNonDomicileCountry(List<CountryCode> nonDomicileCountry) {
	...
	public PartyIdentification51 setOwnedSecuritiesQuantity(FinancialInstrumentQuantity15Choice ownedSecuritiesQuantity) {
	...
	public PartyIdentification51 setCertificationType(List<BeneficiaryCertificationType4Choice> certificationType) {
	...
	public PartyIdentification51 setDeclarationDetails(RestrictedFINXMax350Text declarationDetails) {
