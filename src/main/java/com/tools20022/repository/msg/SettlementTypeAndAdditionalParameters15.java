...
public class SettlementTypeAndAdditionalParameters15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters15.mmSecuritiesMovementType, SettlementTypeAndAdditionalParameters15.mmPayment, SettlementTypeAndAdditionalParameters15.mmCommonIdentification);
