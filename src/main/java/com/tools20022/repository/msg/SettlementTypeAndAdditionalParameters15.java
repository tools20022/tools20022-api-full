...
@XmlType(name = "SettlementTypeAndAdditionalParameters15", propOrder = {"securitiesMovementType", "payment", "commonIdentification"})
public class SettlementTypeAndAdditionalParameters15 {
	...
	public SettlementTypeAndAdditionalParameters15 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public SettlementTypeAndAdditionalParameters15 setPayment(DeliveryReceiptType2Code payment) {
	...
	public SettlementTypeAndAdditionalParameters15 setCommonIdentification(RestrictedFINXMax16Text commonIdentification) {
