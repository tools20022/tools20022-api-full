...
public class CorporateActionPrice36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice36.CashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice36.OverSubscriptionDepositPrice);
