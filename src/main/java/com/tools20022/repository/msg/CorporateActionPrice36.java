 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPriceReceivedPerProductGuideline#forCorporateActionPrice36
 * ConstraintGenericCashPriceReceivedPerProductGuideline.
 * forCorporateActionPrice36}</li>
 * </ul>
 * </li>
 * <li>
...
public class CorporateActionPrice36 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice36, Optional<PriceFormat17Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice36, Optional<PriceFormat17Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmCashInLieuOfSharePrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice36.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat17Choice> getValue(CorporateActionPrice36 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice36 obj, Optional<PriceFormat17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice36, Optional<PriceFormat17Choice>> mmOverSubscriptionDepositPrice = new MMMessageAssociationEnd<CorporateActionPrice36, Optional<PriceFormat17Choice>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice36.mmCashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice36.mmOverSubscriptionDepositPrice);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPriceReceivedPerProductGuideline.forCorporateActionPrice36);
	...
	public CorporateActionPrice36 setCashInLieuOfSharePrice(PriceFormat17Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice36 setOverSubscriptionDepositPrice(PriceFormat17Choice overSubscriptionDepositPrice) {
