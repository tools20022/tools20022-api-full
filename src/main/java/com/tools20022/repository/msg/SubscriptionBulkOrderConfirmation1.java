...
public class SubscriptionBulkOrderConfirmation1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubscriptionBulkOrderConfirmation1.mmAmendmentIndicator, SubscriptionBulkOrderConfirmation1.mmBulkExecutionDetails, SubscriptionBulkOrderConfirmation1.mmRelatedPartyDetails,
						SubscriptionBulkOrderConfirmation1.mmExtension);
