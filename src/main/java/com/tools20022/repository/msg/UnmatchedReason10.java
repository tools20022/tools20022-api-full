...
public class UnmatchedReason10 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason10.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason10.mmCode, UnmatchedReason10.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason11Choice code) {
		this.code = code;
	}
