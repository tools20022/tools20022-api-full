 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption35#mmExemptionType
 * CashOption35.mmExemptionType}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption35#mmAmountDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption35#mmPriceDetails
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCashOption35
 * ConstraintGenericCashPricePerProductGuideline.forCashOption35}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forCashOption35
 * ConstraintCoexistenceAmountRule.forCashOption35}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule#forCashOption35
 * ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption35}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CashOption35", propOrder = {"creditDebitIndicator", "nonEligibleProceedsIndicator", "issuerOfferorTaxabilityIndicator", "incomeType", "exemptionType", "cashAccountIdentification", "amountDetails", "dateDetails",
...
public class CashOption35 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption35, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashOption35, CreditDebitCode>() {
		{
			businessElementTrace_lazy = () -> ProceedsDefinition.mmCreditDebitIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption35.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
		...
		@Override
		public CreditDebitCode getValue(CashOption35 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashOption35 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<NonEligibleProceedsIndicator2Choice>> mmNonEligibleProceedsIndicator = new MMMessageAssociationEnd<CashOption35, Optional<NonEligibleProceedsIndicator2Choice>>() {
		{
		...
		@Override
		public Optional<NonEligibleProceedsIndicator2Choice> getValue(CashOption35 obj) {
			return obj.getNonEligibleProceedsIndicator();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<NonEligibleProceedsIndicator2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption35, Optional<IssuerTaxability1Code>> mmIssuerOfferorTaxabilityIndicator = new MMMessageAttribute<CashOption35, Optional<IssuerTaxability1Code>>() {
		{
		...
		@Override
		public Optional<IssuerTaxability1Code> getValue(CashOption35 obj) {
			return obj.getIssuerOfferorTaxabilityIndicator();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<IssuerTaxability1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<GenericIdentification25>> mmIncomeType = new MMMessageAssociationEnd<CashOption35, Optional<GenericIdentification25>>() {
		{
		...
		@Override
		public Optional<GenericIdentification25> getValue(CashOption35 obj) {
			return obj.getIncomeType();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<GenericIdentification25> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, List<GenericIdentification51>> mmExemptionType = new MMMessageAssociationEnd<CashOption35, List<GenericIdentification51>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption35.mmObject();
			isDerived = false;
			xmlTag = "XmptnTp";
		...
		@Override
		public List<GenericIdentification51> getValue(CashOption35 obj) {
			return obj.getExemptionType();
		}

		@Override
		public void setValue(CashOption35 obj, List<GenericIdentification51> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<CashAccountIdentification6Choice>> mmCashAccountIdentification = new MMMessageAssociationEnd<CashOption35, Optional<CashAccountIdentification6Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification6Choice> getValue(CashOption35 obj) {
			return obj.getCashAccountIdentification();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<CashAccountIdentification6Choice> value) {
			obj.setCashAccountIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "AmtDtls")
	protected CorporateActionAmounts32 amountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<CorporateActionAmounts32>> mmAmountDetails = new MMMessageAssociationEnd<CashOption35, Optional<CorporateActionAmounts32>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionAmounts32.mmObject();
		}

		@Override
		public Optional<CorporateActionAmounts32> getValue(CashOption35 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<CorporateActionAmounts32> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, CorporateActionDate26> mmDateDetails = new MMMessageAssociationEnd<CashOption35, CorporateActionDate26>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption35.mmObject();
			isDerived = false;
		...
		@Override
		public CorporateActionDate26 getValue(CashOption35 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CashOption35 obj, CorporateActionDate26 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<ForeignExchangeTerms15>> mmForeignExchangeDetails = new MMMessageAssociationEnd<CashOption35, Optional<ForeignExchangeTerms15>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms15> getValue(CashOption35 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<ForeignExchangeTerms15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<RateDetails18>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CashOption35, Optional<RateDetails18>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption35.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<RateDetails18> getValue(CashOption35 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<RateDetails18> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption35, Optional<PriceDetails18>> mmPriceDetails = new MMMessageAssociationEnd<CashOption35, Optional<PriceDetails18>>() {
		{
		...
		@Override
		public Optional<PriceDetails18> getValue(CashOption35 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CashOption35 obj, Optional<PriceDetails18> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOption35.mmCreditDebitIndicator, com.tools20022.repository.msg.CashOption35.mmNonEligibleProceedsIndicator,
						com.tools20022.repository.msg.CashOption35.mmIssuerOfferorTaxabilityIndicator, com.tools20022.repository.msg.CashOption35.mmIncomeType, com.tools20022.repository.msg.CashOption35.mmExemptionType,
						com.tools20022.repository.msg.CashOption35.mmCashAccountIdentification, com.tools20022.repository.msg.CashOption35.mmAmountDetails, com.tools20022.repository.msg.CashOption35.mmDateDetails,
						com.tools20022.repository.msg.CashOption35.mmForeignExchangeDetails, com.tools20022.repository.msg.CashOption35.mmRateAndAmountDetails, com.tools20022.repository.msg.CashOption35.mmPriceDetails);
				trace_lazy = () -> CashProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCashOption35,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCashOption35, com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption35);
	...
	public CashOption35 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption35 setNonEligibleProceedsIndicator(NonEligibleProceedsIndicator2Choice nonEligibleProceedsIndicator) {
	...
	public CashOption35 setIssuerOfferorTaxabilityIndicator(IssuerTaxability1Code issuerOfferorTaxabilityIndicator) {
	...
	public CashOption35 setIncomeType(GenericIdentification25 incomeType) {
	...
	public CashOption35 setExemptionType(List<GenericIdentification51> exemptionType) {
	...
	public CashOption35 setCashAccountIdentification(CashAccountIdentification6Choice cashAccountIdentification) {
		this.cashAccountIdentification = cashAccountIdentification;
		return this;
	}

	public Optional<CorporateActionAmounts32> getAmountDetails() {
		return amountDetails == null ? Optional.empty() : Optional.of(amountDetails);
	}

	public CashOption35 setAmountDetails(CorporateActionAmounts32 amountDetails) {
	...
	public CashOption35 setDateDetails(CorporateActionDate26 dateDetails) {
	...
	public CashOption35 setForeignExchangeDetails(ForeignExchangeTerms15 foreignExchangeDetails) {
	...
	public CashOption35 setRateAndAmountDetails(RateDetails18 rateAndAmountDetails) {
	...
	public CashOption35 setPriceDetails(PriceDetails18 priceDetails) {
