 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader49#mmBatchBooking
 * GroupHeader49.mmBatchBooking}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.GroupHeader49#mmNumberOfTransactions
 * GroupHeader49.mmNumberOfTransactions}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader49#mmControlSum
 * GroupHeader49.mmControlSum}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.GroupHeader49#mmInstructingAgent
 * GroupHeader49.mmInstructingAgent}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.GroupHeader49#mmInstructedAgent
 * GroupHeader49.mmInstructedAgent}</li>
 * </ul>
 * </li>
...
@XmlType(name = "GroupHeader49", propOrder = {"messageIdentification", "creationDateTime", "batchBooking", "numberOfTransactions", "controlSum", "totalInterbankSettlementAmount", "interbankSettlementDate", "settlementInformation",
...
public class GroupHeader49 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Max35Text> mmMessageIdentification = new MMMessageAttribute<GroupHeader49, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader49.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
		...
		@Override
		public Max35Text getValue(GroupHeader49 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(GroupHeader49 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, ISODateTime> mmCreationDateTime = new MMMessageAttribute<GroupHeader49, ISODateTime>() {
		{
		...
		@Override
		public ISODateTime getValue(GroupHeader49 obj) {
			return obj.getCreationDateTime();
		}

		@Override
		public void setValue(GroupHeader49 obj, ISODateTime value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.GroupHeader70#mmBatchBooking
	 * GroupHeader70.mmBatchBooking}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<GroupHeader49, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader49.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(GroupHeader49 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Max15NumericText> mmNumberOfTransactions = new MMMessageAttribute<GroupHeader49, Max15NumericText>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader49.mmObject();
			isDerived = false;
			xmlTag = "NbOfTxs";
		...
		@Override
		public Max15NumericText getValue(GroupHeader49 obj) {
			return obj.getNumberOfTransactions();
		}

		@Override
		public void setValue(GroupHeader49 obj, Max15NumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Optional<DecimalNumber>> mmControlSum = new MMMessageAttribute<GroupHeader49, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader49.mmObject();
			isDerived = false;
			xmlTag = "CtrlSum";
		...
		@Override
		public Optional<DecimalNumber> getValue(GroupHeader49 obj) {
			return obj.getControlSum();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Optional<ActiveCurrencyAndAmount>> mmTotalInterbankSettlementAmount = new MMMessageAttribute<GroupHeader49, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(GroupHeader49 obj) {
			return obj.getTotalInterbankSettlementAmount();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader49, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<GroupHeader49, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(GroupHeader49 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader49, SettlementInstruction1> mmSettlementInformation = new MMMessageAssociationEnd<GroupHeader49, SettlementInstruction1>() {
		{
		...
		@Override
		public SettlementInstruction1 getValue(GroupHeader49 obj) {
			return obj.getSettlementInformation();
		}

		@Override
		public void setValue(GroupHeader49 obj, SettlementInstruction1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader49, Optional<PaymentTypeInformation21>> mmPaymentTypeInformation = new MMMessageAssociationEnd<GroupHeader49, Optional<PaymentTypeInformation21>>() {
		{
		...
		@Override
		public Optional<PaymentTypeInformation21> getValue(GroupHeader49 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<PaymentTypeInformation21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader49, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<GroupHeader49, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(GroupHeader49 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(GroupHeader49 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader49, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<GroupHeader49, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader49.mmObject();
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalInterbankSettlementAmountAndDateRule.forGroupHeader49);
	...
	public GroupHeader49 setMessageIdentification(Max35Text messageIdentification) {
	...
	public GroupHeader49 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public GroupHeader49 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public GroupHeader49 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public GroupHeader49 setControlSum(DecimalNumber controlSum) {
	...
	public GroupHeader49 setTotalInterbankSettlementAmount(ActiveCurrencyAndAmount totalInterbankSettlementAmount) {
	...
	public GroupHeader49 setInterbankSettlementDate(ISODate interbankSettlementDate) {
	...
	public GroupHeader49 setSettlementInformation(SettlementInstruction1 settlementInformation) {
	...
	public GroupHeader49 setPaymentTypeInformation(PaymentTypeInformation21 paymentTypeInformation) {
	...
	public GroupHeader49 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public GroupHeader49 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
