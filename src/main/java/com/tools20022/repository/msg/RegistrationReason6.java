 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.RegistrationReason6#AdditionalInformation
 * RegistrationReason6.AdditionalInformation}</li>
 * </ul>
 * </li>
...
public class RegistrationReason6 {
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RegistrationReason6.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RegistrationReason6.Code, com.tools20022.repository.msg.RegistrationReason6.AdditionalInformation);
