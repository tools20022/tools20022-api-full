 ...
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer9#UnitsOrRateRule
 * Transfer9.UnitsOrRateRule}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer9#mmMasterReference
 * Transfer9.mmMasterReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer9#mmTransferReference
 * Transfer9.mmTransferReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer9#mmClientReference
 * Transfer9.mmClientReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer9#mmCancellationReference
 * Transfer9.mmCancellationReference}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer9#mmRequestedTransferDate
 * Transfer9.mmRequestedTransferDate}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer9#mmTotalUnitsNumber
 * Transfer9.mmTotalUnitsNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer9#mmPortfolioTransferOutRate
 * Transfer9.mmPortfolioTransferOutRate}</li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule#forTransfer9
 * ConstraintTotalUnitsNumberRule.forTransfer9}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transfer9", propOrder = {"masterReference", "transferReference", "clientReference", "cancellationReference", "requestedTransferDate", "totalUnitsNumber", "portfolioTransferOutRate", "unitsDetails", "rounding",
		"ownAccountTransferIndicator", "averagePrice", "nonStandardSettlementInformation"})
public class Transfer9 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Transfer9
	 * Transfer9}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<Transfer9, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer9.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
		...
		@Override
		public Optional<Max35Text> getValue(Transfer9 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(Transfer9 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Max35Text> mmTransferReference = new MMMessageAttribute<Transfer9, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(Transfer9 obj) {
			return obj.getTransferReference();
		}

		@Override
		public void setValue(Transfer9 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<Transfer9, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<Max35Text>> mmCancellationReference = new MMMessageAttribute<Transfer9, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer9.mmObject();
			isDerived = false;
			xmlTag = "CxlRef";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, DateFormat1Choice> mmRequestedTransferDate = new MMMessageAttribute<Transfer9, DateFormat1Choice>() {
		{
		...
		@Override
		public DateFormat1Choice getValue(Transfer9 obj) {
			return obj.getRequestedTransferDate();
		}

		@Override
		public void setValue(Transfer9 obj, DateFormat1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, FinancialInstrumentQuantity1> mmTotalUnitsNumber = new MMMessageAttribute<Transfer9, FinancialInstrumentQuantity1>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity1 getValue(Transfer9 obj) {
			return obj.getTotalUnitsNumber();
		}

		@Override
		public void setValue(Transfer9 obj, FinancialInstrumentQuantity1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, PercentageRate> mmPortfolioTransferOutRate = new MMMessageAttribute<Transfer9, PercentageRate>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer9.mmObject();
			isDerived = false;
		...
		@Override
		public PercentageRate getValue(Transfer9 obj) {
			return obj.getPortfolioTransferOutRate();
		}

		@Override
		public void setValue(Transfer9 obj, PercentageRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer9, List<Unit3>> mmUnitsDetails = new MMMessageAssociationEnd<Transfer9, List<Unit3>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmTransferredQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer9.mmObject();
			isDerived = false;
		...
		@Override
		public List<Unit3> getValue(Transfer9 obj) {
			return obj.getUnitsDetails();
		}

		@Override
		public void setValue(Transfer9 obj, List<Unit3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<RoundingDirection2Code>> mmRounding = new MMMessageAttribute<Transfer9, Optional<RoundingDirection2Code>>() {
		{
		...
		@Override
		public Optional<RoundingDirection2Code> getValue(Transfer9 obj) {
			return obj.getRounding();
		}

		@Override
		public void setValue(Transfer9 obj, Optional<RoundingDirection2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<YesNoIndicator>> mmOwnAccountTransferIndicator = new MMMessageAttribute<Transfer9, Optional<YesNoIndicator>>() {
		{
		...
		@Override
		public Optional<YesNoIndicator> getValue(Transfer9 obj) {
			return obj.getOwnAccountTransferIndicator();
		}

		@Override
		public void setValue(Transfer9 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>> mmAveragePrice = new MMMessageAttribute<Transfer9, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> getValue(Transfer9 obj) {
			return obj.getAveragePrice();
		}

		@Override
		public void setValue(Transfer9 obj, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer9, Optional<Max350Text>> mmNonStandardSettlementInformation = new MMMessageAttribute<Transfer9, Optional<Max350Text>>() {
		{
		...
		@Override
		public Optional<Max350Text> getValue(Transfer9 obj) {
			return obj.getNonStandardSettlementInformation();
		}

		@Override
		public void setValue(Transfer9 obj, Optional<Max350Text> value) {
	 ...
	 * messageComponent} = {@linkplain com.tools20022.repository.msg.Transfer9
	 * Transfer9}</li>
	...
	public static final MMXor UnitsOrRateRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.Transfer9.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer9.mmTotalUnitsNumber, com.tools20022.repository.msg.Transfer9.mmPortfolioTransferOutRate);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer9.mmMasterReference, com.tools20022.repository.msg.Transfer9.mmTransferReference, com.tools20022.repository.msg.Transfer9.mmClientReference,
						com.tools20022.repository.msg.Transfer9.mmCancellationReference, com.tools20022.repository.msg.Transfer9.mmRequestedTransferDate, com.tools20022.repository.msg.Transfer9.mmTotalUnitsNumber,
						com.tools20022.repository.msg.Transfer9.mmPortfolioTransferOutRate, com.tools20022.repository.msg.Transfer9.mmUnitsDetails, com.tools20022.repository.msg.Transfer9.mmRounding,
						com.tools20022.repository.msg.Transfer9.mmOwnAccountTransferIndicator, com.tools20022.repository.msg.Transfer9.mmAveragePrice, com.tools20022.repository.msg.Transfer9.mmNonStandardSettlementInformation);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule.forTransfer9);
				...
				nextVersions_lazy = () -> Arrays.asList(Transfer12.mmObject());
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer9.UnitsOrRateRule);
			}
		});
	...
	public Transfer9 setMasterReference(Max35Text masterReference) {
	...
	public Transfer9 setTransferReference(Max35Text transferReference) {
	...
	public Transfer9 setClientReference(Max35Text clientReference) {
	...
	public Transfer9 setCancellationReference(Max35Text cancellationReference) {
	...
	public Transfer9 setRequestedTransferDate(DateFormat1Choice requestedTransferDate) {
	...
	public Transfer9 setTotalUnitsNumber(FinancialInstrumentQuantity1 totalUnitsNumber) {
	...
	public Transfer9 setPortfolioTransferOutRate(PercentageRate portfolioTransferOutRate) {
	...
	public Transfer9 setUnitsDetails(List<Unit3> unitsDetails) {
	...
	public Transfer9 setRounding(RoundingDirection2Code rounding) {
	...
	public Transfer9 setOwnAccountTransferIndicator(YesNoIndicator ownAccountTransferIndicator) {
	...
	public Transfer9 setAveragePrice(ActiveOrHistoricCurrencyAnd13DecimalAmount averagePrice) {
	...
	public Transfer9 setNonStandardSettlementInformation(Max350Text nonStandardSettlementInformation) {
