...
@XmlType(name = "CardPaymentTransaction45", propOrder = {"transactionType", "additionalService", "serviceAttribute", "merchantCategoryCode", "saleReferenceIdentification", "transactionIdentification", "originalTransaction",
...
public class CardPaymentTransaction45 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<CardPaymentServiceType5Code>> mmTransactionType = new MMMessageAttribute<CardPaymentTransaction45, Optional<CardPaymentServiceType5Code>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPaymentService;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			xmlTag = "TxTp";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionType";
			definition = "Type of transaction being undertaken for the main service.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmTransactionType);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardPaymentServiceType5Code> getValue(CardPaymentTransaction45 obj) {
			return obj.getTransactionType();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<CardPaymentServiceType5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, List<CardPaymentServiceType6Code>> mmAdditionalService = new MMMessageAttribute<CardPaymentTransaction45, List<CardPaymentServiceType6Code>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPaymentService;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmAdditionalService);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmAdditionalService;
			minOccurs = 0;
			simpleType_lazy = () -> CardPaymentServiceType6Code.mmObject();
		}

		@Override
		public List<CardPaymentServiceType6Code> getValue(CardPaymentTransaction45 obj) {
			return obj.getAdditionalService();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, List<CardPaymentServiceType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<CardPaymentServiceType3Code>> mmServiceAttribute = new MMMessageAttribute<CardPaymentTransaction45, Optional<CardPaymentServiceType3Code>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPaymentService;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmServiceAttribute);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardPaymentServiceType3Code> getValue(CardPaymentTransaction45 obj) {
			return obj.getServiceAttribute();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<CardPaymentServiceType3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Min3Max4Text>> mmMerchantCategoryCode = new MMMessageAttribute<CardPaymentTransaction45, Optional<Min3Max4Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmMerchantCategoryCode);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Min3Max4Text> getValue(CardPaymentTransaction45 obj) {
			return obj.getMerchantCategoryCode();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<Min3Max4Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction45 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction45, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction45, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction45 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction45, Optional<CardPaymentTransaction37>> mmOriginalTransaction = new MMMessageAssociationEnd<CardPaymentTransaction45, Optional<CardPaymentTransaction37>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmOriginalTransaction);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CardPaymentTransaction37> getValue(CardPaymentTransaction45 obj) {
			return obj.getOriginalTransaction();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<CardPaymentTransaction37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, TrueFalseIndicator> mmTransactionSuccess = new MMMessageAttribute<CardPaymentTransaction45, TrueFalseIndicator>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmTransactionSuccess);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmTransactionSuccess;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TrueFalseIndicator getValue(CardPaymentTransaction45 obj) {
			return obj.getTransactionSuccess();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, TrueFalseIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<TrueFalseIndicator>> mmReversal = new MMMessageAttribute<CardPaymentTransaction45, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmReversal);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmReversal;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(CardPaymentTransaction45 obj) {
			return obj.getReversal();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<TrueFalseIndicator>> mmMerchantOverride = new MMMessageAttribute<CardPaymentTransaction45, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmMerchantOverride);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmMerchantOverride;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, List<FailureReason3Code>> mmFailureReason = new MMMessageAttribute<CardPaymentTransaction45, List<FailureReason3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmFailureReason);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmFailureReason;
			minOccurs = 0;
			simpleType_lazy = () -> FailureReason3Code.mmObject();
		}

		@Override
		public List<FailureReason3Code> getValue(CardPaymentTransaction45 obj) {
			return obj.getFailureReason();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, List<FailureReason3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>> mmInitiatorTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmInitiatorTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction45, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, Optional<Max140Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction45, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(CardPaymentTransaction45 obj) {
			return obj.getInterchangeData();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<Max140Text> value) {
			obj.setInterchangeData(value.orElse(null));
		}
	};
	@XmlElement(name = "TxDtls", required = true)
	protected CardPaymentTransactionDetails23 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction45, CardPaymentTransactionDetails23> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction45, CardPaymentTransactionDetails23>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CardPaymentTransactionDetails23.mmObject();
		}

		@Override
		public CardPaymentTransactionDetails23 getValue(CardPaymentTransaction45 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, CardPaymentTransactionDetails23 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction45, Optional<AuthorisationResult4>> mmAuthorisationResult = new MMMessageAssociationEnd<CardPaymentTransaction45, Optional<AuthorisationResult4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmAuthorisationResult);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmAuthorisationResult;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AuthorisationResult4> getValue(CardPaymentTransaction45 obj) {
			return obj.getAuthorisationResult();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, Optional<AuthorisationResult4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction45, List<TransactionVerificationResult3>> mmTransactionVerificationResult = new MMMessageAssociationEnd<CardPaymentTransaction45, List<TransactionVerificationResult3>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			xmlTag = "TxVrfctnRslt";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmTransactionVerificationResult);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmTransactionVerificationResult;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<TransactionVerificationResult3> getValue(CardPaymentTransaction45 obj) {
			return obj.getTransactionVerificationResult();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, List<TransactionVerificationResult3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction45, List<Max70Text>> mmAdditionalTransactionData = new MMMessageAttribute<CardPaymentTransaction45, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction45.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxData";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmAdditionalTransactionData);
			previousVersion_lazy = () -> CardPaymentTransaction29.mmAdditionalTransactionData;
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}

		@Override
		public List<Max70Text> getValue(CardPaymentTransaction45 obj) {
			return obj.getAdditionalTransactionData();
		}

		@Override
		public void setValue(CardPaymentTransaction45 obj, List<Max70Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction45.mmTransactionType, com.tools20022.repository.msg.CardPaymentTransaction45.mmAdditionalService,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmServiceAttribute, com.tools20022.repository.msg.CardPaymentTransaction45.mmMerchantCategoryCode,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmSaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction45.mmTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmOriginalTransaction, com.tools20022.repository.msg.CardPaymentTransaction45.mmTransactionSuccess,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmReversal, com.tools20022.repository.msg.CardPaymentTransaction45.mmMerchantOverride, com.tools20022.repository.msg.CardPaymentTransaction45.mmFailureReason,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmInitiatorTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction45.mmRecipientTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmReconciliationIdentification, com.tools20022.repository.msg.CardPaymentTransaction45.mmInterchangeData,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmTransactionDetails, com.tools20022.repository.msg.CardPaymentTransaction45.mmAuthorisationResult,
						com.tools20022.repository.msg.CardPaymentTransaction45.mmTransactionVerificationResult, com.tools20022.repository.msg.CardPaymentTransaction45.mmAdditionalTransactionData);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction45";
				definition = "Transaction information in the batch capture.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction60.mmObject());
				previousVersion_lazy = () -> CardPaymentTransaction29.mmObject();
			}
		});
	...
	public CardPaymentTransaction45 setTransactionType(CardPaymentServiceType5Code transactionType) {
	...
	public CardPaymentTransaction45 setAdditionalService(List<CardPaymentServiceType6Code> additionalService) {
	...
	public CardPaymentTransaction45 setServiceAttribute(CardPaymentServiceType3Code serviceAttribute) {
	...
	public CardPaymentTransaction45 setMerchantCategoryCode(Min3Max4Text merchantCategoryCode) {
	...
	public CardPaymentTransaction45 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction45 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction45 setOriginalTransaction(CardPaymentTransaction37 originalTransaction) {
	...
	public CardPaymentTransaction45 setTransactionSuccess(TrueFalseIndicator transactionSuccess) {
	...
	public CardPaymentTransaction45 setReversal(TrueFalseIndicator reversal) {
	...
	public CardPaymentTransaction45 setMerchantOverride(TrueFalseIndicator merchantOverride) {
	...
	public CardPaymentTransaction45 setFailureReason(List<FailureReason3Code> failureReason) {
	...
	public CardPaymentTransaction45 setInitiatorTransactionIdentification(Max35Text initiatorTransactionIdentification) {
	...
	public CardPaymentTransaction45 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction45 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction45 setInterchangeData(Max140Text interchangeData) {
		this.interchangeData = interchangeData;
		return this;
	}

	public CardPaymentTransactionDetails23 getTransactionDetails() {
		return transactionDetails;
	}

	public CardPaymentTransaction45 setTransactionDetails(CardPaymentTransactionDetails23 transactionDetails) {
		this.transactionDetails = Objects.requireNonNull(transactionDetails);
		return this;
	}

	public Optional<AuthorisationResult4> getAuthorisationResult() {
		return authorisationResult == null ? Optional.empty() : Optional.of(authorisationResult);
	}

	public CardPaymentTransaction45 setAuthorisationResult(AuthorisationResult4 authorisationResult) {
	...
	public CardPaymentTransaction45 setTransactionVerificationResult(List<TransactionVerificationResult3> transactionVerificationResult) {
	...
	public CardPaymentTransaction45 setAdditionalTransactionData(List<Max70Text> additionalTransactionData) {
