 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CancellationReason14#mmCode
...
@XmlType(name = "CancellationReason14", propOrder = {"code", "additionalReasonInformation"})
public class CancellationReason14 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CancellationReason14
	 * CancellationReason14}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationReason14.mmCode, com.tools20022.repository.msg.CancellationReason14.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationReason14";
	...
	public CancellationReason14 setCode(CancellationReason24Choice code) {
	...
	public CancellationReason14 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
