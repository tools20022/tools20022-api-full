...
public class TransactionDetails92 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails92.mmFinancialInstrumentIdentification, TransactionDetails92.mmSecuritiesMovementType, TransactionDetails92.mmPayment, TransactionDetails92.mmSettlementQuantity,
						TransactionDetails92.mmSafekeepingAccount, TransactionDetails92.mmSettlementAmount, TransactionDetails92.mmSettlementDate, TransactionDetails92.mmTradeDate, TransactionDetails92.mmDeliveringSettlementParties,
						TransactionDetails92.mmReceivingSettlementParties, TransactionDetails92.mmInvestor);
