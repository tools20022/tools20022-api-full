 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCorporateActionPrice11
 * ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice11}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice11", propOrder = {"indicativeOrMarketPrice", "exercisePrice", "issuePrice", "genericCashPriceReceivedPerProduct", "genericCashPricePaidPerProduct"})
public class CorporateActionPrice11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice11, Optional<IndicativeOrMarketPrice4Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice11, Optional<IndicativeOrMarketPrice4Choice>>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionPrice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice11.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<IndicativeOrMarketPrice4Choice> getValue(CorporateActionPrice11 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice11 obj, Optional<IndicativeOrMarketPrice4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>> mmExercisePrice = new MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat17Choice> getValue(CorporateActionPrice11 obj) {
			return obj.getExercisePrice();
		}

		@Override
		public void setValue(CorporateActionPrice11 obj, Optional<PriceFormat17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>> mmIssuePrice = new MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat18Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat18Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat18Choice> getValue(CorporateActionPrice11 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice11 obj, Optional<PriceFormat18Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice11, Optional<PriceFormat17Choice>>() {
		{
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice11);
	...
	public CorporateActionPrice11 setIndicativeOrMarketPrice(IndicativeOrMarketPrice4Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice11 setExercisePrice(PriceFormat17Choice exercisePrice) {
	...
	public CorporateActionPrice11 setIssuePrice(PriceFormat17Choice issuePrice) {
		this.issuePrice = issuePrice;
		return this;
	}

	public Optional<PriceFormat18Choice> getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct == null ? Optional.empty() : Optional.of(genericCashPriceReceivedPerProduct);
	}

	public CorporateActionPrice11 setGenericCashPriceReceivedPerProduct(PriceFormat18Choice genericCashPriceReceivedPerProduct) {
	...
	public CorporateActionPrice11 setGenericCashPricePaidPerProduct(PriceFormat17Choice genericCashPricePaidPerProduct) {
