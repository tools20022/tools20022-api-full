 ...
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson23#mmGivenName
 ...
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson23#mmGender
 * IndividualPerson23.mmGender}</li>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson23#mmLanguage
 * IndividualPerson23.mmLanguage}</li>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson23#mmBirthDate
...
@XmlType(name = "IndividualPerson23", propOrder = {"namePrefix", "givenName", "middleName", "name", "nameSuffix", "gender", "language", "birthDate", "countryOfBirth", "provinceOfBirth", "cityOfBirth", "profession", "taxationCountry",
...
public class IndividualPerson23 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<NamePrefix1Choice>> mmNamePrefix = new MMMessageAttribute<IndividualPerson23, Optional<NamePrefix1Choice>>() {
		{
			businessElementTrace_lazy = () -> PersonName.mmNamePrefix;
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson23.mmObject();
			isDerived = false;
			xmlTag = "NmPrfx";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NamePrefix";
			definition = "Term used to address a person.";
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmNamePrefix);
			previousVersion_lazy = () -> IndividualPerson22.mmNamePrefix;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<NamePrefix1Choice> getValue(IndividualPerson23 obj) {
			return obj.getNamePrefix();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<NamePrefix1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Max35Text> mmGivenName = new MMMessageAttribute<IndividualPerson23, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmGivenName);
			previousVersion_lazy = () -> IndividualPerson22.mmGivenName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(IndividualPerson23 obj) {
			return obj.getGivenName();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmMiddleName = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmMiddleName);
			previousVersion_lazy = () -> IndividualPerson22.mmMiddleName;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(IndividualPerson23 obj) {
			return obj.getMiddleName();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<Max35Text> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.IndividualPerson22#mmName
	 * IndividualPerson22.mmName}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Max350Text> mmName = new MMMessageAttribute<IndividualPerson23, Max350Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmName);
			previousVersion_lazy = () -> IndividualPerson22.mmName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(IndividualPerson23 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Max350Text value) {
			obj.setName(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmNameSuffix = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmNameSuffix);
			previousVersion_lazy = () -> IndividualPerson22.mmNameSuffix;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<GenderCode>> mmGender = new MMMessageAttribute<IndividualPerson23, Optional<GenderCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmGender);
			previousVersion_lazy = () -> IndividualPerson22.mmGender;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<GenderCode> getValue(IndividualPerson23 obj) {
			return obj.getGender();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<GenderCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<LanguageCode>> mmLanguage = new MMMessageAttribute<IndividualPerson23, Optional<LanguageCode>>() {
		{
			...
			previousVersion_lazy = () -> IndividualPerson22.mmLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(IndividualPerson23 obj) {
			return obj.getLanguage();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, ISODate> mmBirthDate = new MMMessageAttribute<IndividualPerson23, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmBirthDate);
			previousVersion_lazy = () -> IndividualPerson22.mmBirthDate;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(IndividualPerson23 obj) {
			return obj.getBirthDate();
		}

		@Override
		public void setValue(IndividualPerson23 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<CountryCode>> mmCountryOfBirth = new MMMessageAttribute<IndividualPerson23, Optional<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmCountryOfBirth);
			previousVersion_lazy = () -> IndividualPerson22.mmCountryOfBirth;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CountryCode> getValue(IndividualPerson23 obj) {
			return obj.getCountryOfBirth();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmProvinceOfBirth = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Person.mmPlaceOfBirth;
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson23.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmProvinceOfBirth);
			previousVersion_lazy = () -> IndividualPerson22.mmProvinceOfBirth;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmCityOfBirth = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Person.mmPlaceOfBirth;
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson23.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmCityOfBirth);
			previousVersion_lazy = () -> IndividualPerson22.mmCityOfBirth;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmProfession = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmProfession);
			previousVersion_lazy = () -> IndividualPerson22.mmProfession;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<CountryCode>> mmTaxationCountry = new MMMessageAttribute<IndividualPerson23, Optional<CountryCode>>() {
		{
			...
			previousVersion_lazy = () -> IndividualPerson22.mmTaxationCountry;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<CountryAndResidentialStatusType1>> mmCountryAndResidentialStatus = new MMMessageAttribute<IndividualPerson23, Optional<CountryAndResidentialStatusType1>>() {
		{
			...
			previousVersion_lazy = () -> IndividualPerson22.mmCountryAndResidentialStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CountryAndResidentialStatusType1> getValue(IndividualPerson23 obj) {
			return obj.getCountryAndResidentialStatus();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<CountryAndResidentialStatusType1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, List<PostalAddress3>> mmPostalAddress = new MMMessageAssociationEnd<IndividualPerson23, List<PostalAddress3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmPostalAddress);
			previousVersion_lazy = () -> IndividualPerson22.mmPostalAddress;
			maxOccurs = 5;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<PostalAddress3> getValue(IndividualPerson23 obj) {
			return obj.getPostalAddress();
		}

		@Override
		public void setValue(IndividualPerson23 obj, List<PostalAddress3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, List<CitizenshipInformation>> mmCitizenship = new MMMessageAssociationEnd<IndividualPerson23, List<CitizenshipInformation>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmCitizenship);
			previousVersion_lazy = () -> IndividualPerson22.mmCitizenship;
			maxOccurs = 3;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<CitizenshipInformation> getValue(IndividualPerson23 obj) {
			return obj.getCitizenship();
		}

		@Override
		public void setValue(IndividualPerson23 obj, List<CitizenshipInformation> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max140Text>> mmEmployingCompany = new MMMessageAttribute<IndividualPerson23, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmEmployingCompany);
			previousVersion_lazy = () -> IndividualPerson22.mmEmployingCompany;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(IndividualPerson23 obj) {
			return obj.getEmployingCompany();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<Max35Text>> mmBusinessFunction = new MMMessageAttribute<IndividualPerson23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmBusinessFunction);
			previousVersion_lazy = () -> IndividualPerson22.mmBusinessFunction;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, Optional<CommunicationAddress3>> mmPrimaryCommunicationAddress = new MMMessageAssociationEnd<IndividualPerson23, Optional<CommunicationAddress3>>() {
		{
			...
			previousVersion_lazy = () -> IndividualPerson22.mmPrimaryCommunicationAddress;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CommunicationAddress3> getValue(IndividualPerson23 obj) {
			return obj.getPrimaryCommunicationAddress();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<CommunicationAddress3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, Optional<CommunicationAddress3>> mmSecondaryCommunicationAddress = new MMMessageAssociationEnd<IndividualPerson23, Optional<CommunicationAddress3>>() {
		{
			businessComponentTrace_lazy = () -> ElectronicAddress.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson23.mmObject();
			isDerived = false;
			...
			definition = "Communication device number or electronic address used for communication.";
			previousVersion_lazy = () -> IndividualPerson22.mmSecondaryCommunicationAddress;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CommunicationAddress3.mmObject();
	...
	protected List<GenericIdentification55> otherIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, List<GenericIdentification55>> mmOtherIdentification = new MMMessageAssociationEnd<IndividualPerson23, List<GenericIdentification55>>() {
		{
			...
			previousVersion_lazy = () -> IndividualPerson22.mmOtherIdentification;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<GenericIdentification55> getValue(IndividualPerson23 obj) {
			return obj.getOtherIdentification();
		}

		@Override
		public void setValue(IndividualPerson23 obj, List<GenericIdentification55> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson23, Optional<RegulatoryInformation1>> mmAdditionalRegulatoryInformation = new MMMessageAttribute<IndividualPerson23, Optional<RegulatoryInformation1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson23.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> IndividualPerson22.mmAdditionalRegulatoryInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RegulatoryInformation1> getValue(IndividualPerson23 obj) {
			return obj.getAdditionalRegulatoryInformation();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<RegulatoryInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IndividualPerson23, Optional<PoliticalExposureType1Choice>> mmPoliticallyExposedPersonType = new MMMessageAssociationEnd<IndividualPerson23, Optional<PoliticalExposureType1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmPoliticallyExposedPersonType);
			previousVersion_lazy = () -> IndividualPerson22.mmPoliticallyExposedPersonType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PoliticalExposureType1Choice> getValue(IndividualPerson23 obj) {
			return obj.getPoliticallyExposedPersonType();
		}

		@Override
		public void setValue(IndividualPerson23 obj, Optional<PoliticalExposureType1Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IndividualPerson23.mmNamePrefix, com.tools20022.repository.msg.IndividualPerson23.mmGivenName,
						com.tools20022.repository.msg.IndividualPerson23.mmMiddleName, com.tools20022.repository.msg.IndividualPerson23.mmName, com.tools20022.repository.msg.IndividualPerson23.mmNameSuffix,
						com.tools20022.repository.msg.IndividualPerson23.mmGender, com.tools20022.repository.msg.IndividualPerson23.mmLanguage, com.tools20022.repository.msg.IndividualPerson23.mmBirthDate,
						com.tools20022.repository.msg.IndividualPerson23.mmCountryOfBirth, com.tools20022.repository.msg.IndividualPerson23.mmProvinceOfBirth, com.tools20022.repository.msg.IndividualPerson23.mmCityOfBirth,
						com.tools20022.repository.msg.IndividualPerson23.mmProfession, com.tools20022.repository.msg.IndividualPerson23.mmTaxationCountry, com.tools20022.repository.msg.IndividualPerson23.mmCountryAndResidentialStatus,
						com.tools20022.repository.msg.IndividualPerson23.mmPostalAddress, com.tools20022.repository.msg.IndividualPerson23.mmCitizenship, com.tools20022.repository.msg.IndividualPerson23.mmEmployingCompany,
						com.tools20022.repository.msg.IndividualPerson23.mmBusinessFunction, com.tools20022.repository.msg.IndividualPerson23.mmPrimaryCommunicationAddress,
						com.tools20022.repository.msg.IndividualPerson23.mmSecondaryCommunicationAddress, com.tools20022.repository.msg.IndividualPerson23.mmOtherIdentification,
						com.tools20022.repository.msg.IndividualPerson23.mmAdditionalRegulatoryInformation, com.tools20022.repository.msg.IndividualPerson23.mmPoliticallyExposedPersonType);
				trace_lazy = () -> Person.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "IndividualPerson23";
				definition = "Human entity, as distinguished from a corporate entity (which is sometimes referred to as an 'artificial person').";
				nextVersions_lazy = () -> Arrays.asList(IndividualPerson27.mmObject());
				previousVersion_lazy = () -> IndividualPerson22.mmObject();
			}
		});
	...
	public IndividualPerson23 setNamePrefix(NamePrefix1Choice namePrefix) {
	...
	public IndividualPerson23 setGivenName(Max35Text givenName) {
	...
	public IndividualPerson23 setMiddleName(Max35Text middleName) {
	...
	public IndividualPerson23 setName(Max350Text name) {
	...
	public IndividualPerson23 setNameSuffix(Max35Text nameSuffix) {
	...
	public IndividualPerson23 setGender(GenderCode gender) {
		this.gender = gender;
		return this;
	}
	...
	public IndividualPerson23 setLanguage(LanguageCode language) {
	...
	public IndividualPerson23 setBirthDate(ISODate birthDate) {
	...
	public IndividualPerson23 setCountryOfBirth(CountryCode countryOfBirth) {
	...
	public IndividualPerson23 setProvinceOfBirth(Max35Text provinceOfBirth) {
	...
	public IndividualPerson23 setCityOfBirth(Max35Text cityOfBirth) {
	...
	public IndividualPerson23 setProfession(Max35Text profession) {
	...
	public IndividualPerson23 setTaxationCountry(CountryCode taxationCountry) {
	...
	public IndividualPerson23 setCountryAndResidentialStatus(CountryAndResidentialStatusType1 countryAndResidentialStatus) {
	...
	public IndividualPerson23 setPostalAddress(List<PostalAddress3> postalAddress) {
	...
	public IndividualPerson23 setCitizenship(List<CitizenshipInformation> citizenship) {
	...
	public IndividualPerson23 setEmployingCompany(Max140Text employingCompany) {
	...
	public IndividualPerson23 setBusinessFunction(Max35Text businessFunction) {
	...
	public IndividualPerson23 setPrimaryCommunicationAddress(CommunicationAddress3 primaryCommunicationAddress) {
	...
	public IndividualPerson23 setSecondaryCommunicationAddress(CommunicationAddress3 secondaryCommunicationAddress) {
		this.secondaryCommunicationAddress = secondaryCommunicationAddress;
		return this;
	}

	public List<GenericIdentification55> getOtherIdentification() {
		return otherIdentification == null ? otherIdentification = new ArrayList<>() : otherIdentification;
	}

	public IndividualPerson23 setOtherIdentification(List<GenericIdentification55> otherIdentification) {
	...
	public IndividualPerson23 setAdditionalRegulatoryInformation(RegulatoryInformation1 additionalRegulatoryInformation) {
	...
	public IndividualPerson23 setPoliticallyExposedPersonType(PoliticalExposureType1Choice politicallyExposedPersonType) {
