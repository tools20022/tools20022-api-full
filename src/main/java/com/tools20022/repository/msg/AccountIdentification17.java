...
public class AccountIdentification17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification17.mmSafekeepingAccount, AccountIdentification17.mmAccountOwner, AccountIdentification17.mmSafekeepingPlace);
