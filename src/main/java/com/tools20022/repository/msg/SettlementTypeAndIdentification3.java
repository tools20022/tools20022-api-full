...
public class SettlementTypeAndIdentification3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification3.mmTransactionIdentification, SettlementTypeAndIdentification3.mmSecuritiesMovementType, SettlementTypeAndIdentification3.mmPayment);
