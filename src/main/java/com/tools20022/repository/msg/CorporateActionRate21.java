 ...
 * CorporateActionRate21.mmAdditionalQuantityForSubscribedResultantSecurities}</li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionRate29
...
@XmlType(name = "CorporateActionRate21", propOrder = {"additionalQuantityForSubscribedResultantSecurities", "additionalQuantityForExistingSecurities", "newToOld"})
public class CorporateActionRate21 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat3Choice>> mmAdditionalQuantityForSubscribedResultantSecurities = new MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmAdditionalQuantityForSubscribedResultantSecurities;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate21.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<RatioFormat3Choice> getValue(CorporateActionRate21 obj) {
			return obj.getAdditionalQuantityForSubscribedResultantSecurities();
		}

		@Override
		public void setValue(CorporateActionRate21 obj, Optional<RatioFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat3Choice>> mmAdditionalQuantityForExistingSecurities = new MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat3Choice>>() {
		{
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.choice.RatioFormat4Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat4Choice>> mmNewToOld = new MMMessageAssociationEnd<CorporateActionRate21, Optional<RatioFormat4Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RatioFormat4Choice.mmObject();
		}

		@Override
		public Optional<RatioFormat4Choice> getValue(CorporateActionRate21 obj) {
			return obj.getNewToOld();
		}

		@Override
		public void setValue(CorporateActionRate21 obj, Optional<RatioFormat4Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate21.mmAdditionalQuantityForSubscribedResultantSecurities,
						com.tools20022.repository.msg.CorporateActionRate21.mmAdditionalQuantityForExistingSecurities, com.tools20022.repository.msg.CorporateActionRate21.mmNewToOld);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionRate21";
				definition = "Specifies rate details.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionRate29.mmObject());
			}
		});
	...
	public CorporateActionRate21 setAdditionalQuantityForSubscribedResultantSecurities(RatioFormat3Choice additionalQuantityForSubscribedResultantSecurities) {
	...
	public CorporateActionRate21 setAdditionalQuantityForExistingSecurities(RatioFormat3Choice additionalQuantityForExistingSecurities) {
	...
	public CorporateActionRate21 setNewToOld(RatioFormat4Choice newToOld) {
