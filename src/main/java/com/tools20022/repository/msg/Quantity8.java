...
public class Quantity8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Quantity8.mmSettlementQuantity, Quantity8.mmDenominationChoice, Quantity8.mmCertificateNumber, Quantity8.mmQuantityBreakdown);
