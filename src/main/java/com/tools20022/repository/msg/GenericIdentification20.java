 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule#forGenericIdentification20
 * ConstraintCoexistenceIssuerSchemeNameRule.forGenericIdentification20}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "GenericIdentification20", propOrder = {"identification", "issuer", "schemeName"})
public class GenericIdentification20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification20.mmIdentification, com.tools20022.repository.msg.GenericIdentification20.mmIssuer,
						com.tools20022.repository.msg.GenericIdentification20.mmSchemeName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIssuerSchemeNameRule.forGenericIdentification20);
	...
	public GenericIdentification20 setIdentification(Exact4AlphaNumericText identification) {
	...
	public GenericIdentification20 setIssuer(Max35Text issuer) {
	...
	public GenericIdentification20 setSchemeName(Max35Text schemeName) {
