...
public class GenericIdentification20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification20.Identification, com.tools20022.repository.msg.GenericIdentification20.Issuer,
						com.tools20022.repository.msg.GenericIdentification20.SchemeName);
