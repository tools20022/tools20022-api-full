...
public class AccountIdentification22 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountIdentification22.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	protected List<com.tools20022.repository.msg.CorporateActionEventAndBalance4> corporateActionEventAndBalance;
	/**
	...
	public static final MMMessageAssociationEnd mmCorporateActionEventAndBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionEventAndBalance4.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification22.mmSafekeepingAccount, AccountIdentification22.mmAccountOwner, AccountIdentification22.mmSafekeepingPlace,
						AccountIdentification22.mmCorporateActionEventAndBalance);
	...
	public void setCorporateActionEventAndBalance(List<com.tools20022.repository.msg.CorporateActionEventAndBalance4> corporateActionEventAndBalance) {
