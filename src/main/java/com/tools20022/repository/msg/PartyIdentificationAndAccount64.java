...
public class PartyIdentificationAndAccount64 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount64.mmIdentification, PartyIdentificationAndAccount64.mmAlternateIdentification, PartyIdentificationAndAccount64.mmCashAccount,
						PartyIdentificationAndAccount64.mmChargesAccount, PartyIdentificationAndAccount64.mmCommissionAccount, PartyIdentificationAndAccount64.mmTaxAccount, PartyIdentificationAndAccount64.mmAdditionalInformation);
