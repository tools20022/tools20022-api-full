 ...
 * ConstraintBalanceAtSafekeepingPlaceRule.forAggregateBalanceInformation34}</li>
 * <li>
 ...
 * ConstraintFinancialInstrumentAttributesRule.forAggregateBalanceInformation34}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AggregateBalanceInformation34", propOrder = {"balanceDate", "financialInstrumentIdentification", "financialInstrumentAttributes", "investmentFundsFinancialInstrumentAttributes", "valuationHaircutDetails",
...
public class AggregateBalanceInformation34 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, DateAndDateTime1Choice> mmBalanceDate = new MMMessageAssociationEnd<AggregateBalanceInformation34, DateAndDateTime1Choice>() {
		{
			businessElementTrace_lazy = () -> Balance.mmCalculationDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			xmlTag = "BalDt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "BalanceDate";
			definition = "Specifies the date of the balance position.";
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmBalanceDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DateAndDateTime1Choice getValue(AggregateBalanceInformation34 obj) {
			return obj.getBalanceDate();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, DateAndDateTime1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<AggregateBalanceInformation34, SecurityIdentification19>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(AggregateBalanceInformation34 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<FinancialInstrumentAttributes64>> mmFinancialInstrumentAttributes = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<FinancialInstrumentAttributes64>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmFinancialInstrumentAttributes;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentAttributes64> getValue(AggregateBalanceInformation34 obj) {
			return obj.getFinancialInstrumentAttributes();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<FinancialInstrumentAttributes64> value) {
	 ...
	 * AggregateBalanceInformation20.
	 * mmInvestmentFundsFinancialInstrumentAttributes}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<FinancialInstrument21>> mmInvestmentFundsFinancialInstrumentAttributes = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<FinancialInstrument21>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmInvestmentFundsFinancialInstrumentAttributes;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrument21> getValue(AggregateBalanceInformation34 obj) {
			return obj.getInvestmentFundsFinancialInstrumentAttributes();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<FinancialInstrument21> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BasicCollateralValuation1Details>> mmValuationHaircutDetails = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BasicCollateralValuation1Details>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmValuationHaircutDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BasicCollateralValuation1Details> getValue(AggregateBalanceInformation34 obj) {
			return obj.getValuationHaircutDetails();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<BasicCollateralValuation1Details> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<Balance6>> mmAggregateBalance = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<Balance6>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmAggregateBalance;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Balance6> getValue(AggregateBalanceInformation34 obj) {
			return obj.getAggregateBalance();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<Balance6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<Balance8>> mmAvailableBalance = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<Balance8>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmAvailableBalance;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Balance8> getValue(AggregateBalanceInformation34 obj) {
			return obj.getAvailableBalance();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<Balance8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceQuantity8Choice>> mmNotAvailableBalance = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceQuantity8Choice>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesBalance.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmNotAvailableBalance;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BalanceQuantity8Choice> getValue(AggregateBalanceInformation34 obj) {
			return obj.getNotAvailableBalance();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<BalanceQuantity8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<SafeKeepingPlace1>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(AggregateBalanceInformation34 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AggregateBalanceInformation34, Optional<CorporateActionOption5Code>> mmCorporateActionOptionType = new MMMessageAttribute<AggregateBalanceInformation34, Optional<CorporateActionOption5Code>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmCorporateActionOptionType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CorporateActionOption5Code> getValue(AggregateBalanceInformation34 obj) {
			return obj.getCorporateActionOptionType();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<CorporateActionOption5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<PriceInformation12>> mmPriceDetails = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<PriceInformation12>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmPriceDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PriceInformation12> getValue(AggregateBalanceInformation34 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<PriceInformation12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<ForeignExchangeTerms22>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<ForeignExchangeTerms22>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmForeignExchangeDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<ForeignExchangeTerms22> getValue(AggregateBalanceInformation34 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<ForeignExchangeTerms22> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AggregateBalanceInformation34, Optional<Number>> mmDaysAccrued = new MMMessageAttribute<AggregateBalanceInformation34, Optional<Number>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number> getValue(AggregateBalanceInformation34 obj) {
			return obj.getDaysAccrued();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceAmounts3>> mmAccountBaseCurrencyAmounts = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceAmounts3>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmAccountBaseCurrencyAmounts;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BalanceAmounts3> getValue(AggregateBalanceInformation34 obj) {
			return obj.getAccountBaseCurrencyAmounts();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<BalanceAmounts3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceAmounts3>> mmInstrumentCurrencyAmounts = new MMMessageAssociationEnd<AggregateBalanceInformation34, Optional<BalanceAmounts3>>() {
		{
			businessElementTrace_lazy = () -> Balance.mmAssetHolding;
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmInstrumentCurrencyAmounts;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BalanceAmounts3.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<QuantityBreakdown27>> mmQuantityBreakdown = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<QuantityBreakdown27>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown27> getValue(AggregateBalanceInformation34 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<QuantityBreakdown27> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<SubBalanceInformation15>> mmBalanceBreakdown = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<SubBalanceInformation15>>() {
		{
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmBalanceBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SubBalanceInformation15> getValue(AggregateBalanceInformation34 obj) {
			return obj.getBalanceBreakdown();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<SubBalanceInformation15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<AdditionalBalanceInformation15>> mmAdditionalBalanceBreakdown = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<AdditionalBalanceInformation15>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmSecuritiesSubBalance;
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmAdditionalBalanceBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<AdditionalBalanceInformation15> getValue(AggregateBalanceInformation34 obj) {
			return obj.getAdditionalBalanceBreakdown();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<AdditionalBalanceInformation15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<AggregateBalancePerSafekeepingPlace28>> mmBalanceAtSafekeepingPlace = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<AggregateBalancePerSafekeepingPlace28>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmSecuritiesSubBalance;
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmBalanceAtSafekeepingPlace;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<AggregateBalancePerSafekeepingPlace28> getValue(AggregateBalanceInformation34 obj) {
			return obj.getBalanceAtSafekeepingPlace();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<AggregateBalancePerSafekeepingPlace28> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AggregateBalanceInformation34, Optional<Max350Text>> mmHoldingAdditionalDetails = new MMMessageAttribute<AggregateBalanceInformation34, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmHoldingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(AggregateBalanceInformation34 obj) {
			return obj.getHoldingAdditionalDetails();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AggregateBalanceInformation34, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<AggregateBalanceInformation34, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation34.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			previousVersion_lazy = () -> AggregateBalanceInformation20.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(AggregateBalanceInformation34 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(AggregateBalanceInformation34 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AggregateBalanceInformation34.mmBalanceDate, com.tools20022.repository.msg.AggregateBalanceInformation34.mmFinancialInstrumentIdentification,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmFinancialInstrumentAttributes, com.tools20022.repository.msg.AggregateBalanceInformation34.mmInvestmentFundsFinancialInstrumentAttributes,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmValuationHaircutDetails, com.tools20022.repository.msg.AggregateBalanceInformation34.mmAggregateBalance,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmAvailableBalance, com.tools20022.repository.msg.AggregateBalanceInformation34.mmNotAvailableBalance,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmSafekeepingPlace, com.tools20022.repository.msg.AggregateBalanceInformation34.mmCorporateActionOptionType,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmPriceDetails, com.tools20022.repository.msg.AggregateBalanceInformation34.mmForeignExchangeDetails,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmDaysAccrued, com.tools20022.repository.msg.AggregateBalanceInformation34.mmAccountBaseCurrencyAmounts,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmInstrumentCurrencyAmounts, com.tools20022.repository.msg.AggregateBalanceInformation34.mmQuantityBreakdown,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmBalanceBreakdown, com.tools20022.repository.msg.AggregateBalanceInformation34.mmAdditionalBalanceBreakdown,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmBalanceAtSafekeepingPlace, com.tools20022.repository.msg.AggregateBalanceInformation34.mmHoldingAdditionalDetails,
						com.tools20022.repository.msg.AggregateBalanceInformation34.mmSupplementaryData);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintBalanceAtSafekeepingPlaceRule.forAggregateBalanceInformation34,
						com.tools20022.repository.constraints.ConstraintAggregateBalanceGuideline.forAggregateBalanceInformation34,
						com.tools20022.repository.constraints.ConstraintFinancialInstrumentAttributesRule.forAggregateBalanceInformation34);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "AggregateBalanceInformation34";
				definition = "Overall position, in a single security, held in a securities account at a specified place of safekeeping.";
				previousVersion_lazy = () -> AggregateBalanceInformation20.mmObject();
			}
		});
	...
	public AggregateBalanceInformation34 setBalanceDate(DateAndDateTime1Choice balanceDate) {
	...
	public AggregateBalanceInformation34 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public AggregateBalanceInformation34 setFinancialInstrumentAttributes(FinancialInstrumentAttributes64 financialInstrumentAttributes) {
	...
	public AggregateBalanceInformation34 setInvestmentFundsFinancialInstrumentAttributes(FinancialInstrument21 investmentFundsFinancialInstrumentAttributes) {
	...
	public AggregateBalanceInformation34 setValuationHaircutDetails(BasicCollateralValuation1Details valuationHaircutDetails) {
		this.valuationHaircutDetails = valuationHaircutDetails;
		return this;
	}

	public Optional<Balance6> getAggregateBalance() {
		return aggregateBalance == null ? Optional.empty() : Optional.of(aggregateBalance);
	}

	public AggregateBalanceInformation34 setAggregateBalance(Balance6 aggregateBalance) {
	...
	public AggregateBalanceInformation34 setAvailableBalance(Balance8 availableBalance) {
	...
	public AggregateBalanceInformation34 setNotAvailableBalance(BalanceQuantity8Choice notAvailableBalance) {
	...
	public AggregateBalanceInformation34 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public AggregateBalanceInformation34 setCorporateActionOptionType(CorporateActionOption5Code corporateActionOptionType) {
	...
	public AggregateBalanceInformation34 setPriceDetails(List<PriceInformation12> priceDetails) {
	...
	public AggregateBalanceInformation34 setForeignExchangeDetails(List<ForeignExchangeTerms22> foreignExchangeDetails) {
	...
	public AggregateBalanceInformation34 setDaysAccrued(Number daysAccrued) {
	...
	public AggregateBalanceInformation34 setAccountBaseCurrencyAmounts(BalanceAmounts3 accountBaseCurrencyAmounts) {
	...
	public AggregateBalanceInformation34 setInstrumentCurrencyAmounts(BalanceAmounts3 instrumentCurrencyAmounts) {
	...
	public AggregateBalanceInformation34 setQuantityBreakdown(List<QuantityBreakdown27> quantityBreakdown) {
	...
	public AggregateBalanceInformation34 setBalanceBreakdown(List<SubBalanceInformation15> balanceBreakdown) {
	...
	public AggregateBalanceInformation34 setAdditionalBalanceBreakdown(List<AdditionalBalanceInformation15> additionalBalanceBreakdown) {
	...
	public AggregateBalanceInformation34 setBalanceAtSafekeepingPlace(List<AggregateBalancePerSafekeepingPlace28> balanceAtSafekeepingPlace) {
	...
	public AggregateBalanceInformation34 setHoldingAdditionalDetails(Max350Text holdingAdditionalDetails) {
	...
	public AggregateBalanceInformation34 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
