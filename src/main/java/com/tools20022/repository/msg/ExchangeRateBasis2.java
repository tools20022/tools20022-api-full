...
@XmlType(name = "ExchangeRateBasis2", propOrder = {"baseCurrency", "quotedCurrency"})
public class ExchangeRateBasis2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ExchangeRateBasis2
	 * ExchangeRateBasis2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExchangeRateBasis2, ActiveOrHistoricCurrencyCode> mmBaseCurrency = new MMMessageAttribute<ExchangeRateBasis2, ActiveOrHistoricCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ExchangeRateBasis2.mmObject();
			isDerived = false;
			xmlTag = "BaseCcy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "BaseCurrency";
			definition = "Currency in which the rate of exchange is expressed in a currency exchange.\r\n\r\nUsage: In the example one GBP equals xxxUSD, the unit currency is GBP.";
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ExchangeRateBasis2 obj) {
			return obj.getBaseCurrency();
		}

		@Override
		public void setValue(ExchangeRateBasis2 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExchangeRateBasis2, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ExchangeRateBasis2, ActiveOrHistoricCurrencyCode>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExchangeRateBasis2.mmBaseCurrency, com.tools20022.repository.msg.ExchangeRateBasis2.mmQuotedCurrency);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "ExchangeRateBasis2";
	...
	public ExchangeRateBasis2 setBaseCurrency(ActiveOrHistoricCurrencyCode baseCurrency) {
	...
	public ExchangeRateBasis2 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
