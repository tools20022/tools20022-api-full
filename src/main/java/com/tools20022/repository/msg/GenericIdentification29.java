...
public class GenericIdentification29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification29.Identification, com.tools20022.repository.msg.GenericIdentification29.Issuer,
						com.tools20022.repository.msg.GenericIdentification29.SchemeName);
