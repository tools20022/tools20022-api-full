 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Unit5 Unit5}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Unit10", propOrder = {"unitsNumber", "group1Or2Units"})
public class Unit10 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Unit10
	 * Unit10}</li>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Unit5#mmUnitsNumber
	...
	public static final MMMessageAttribute<Unit10, DecimalNumber> mmUnitsNumber = new MMMessageAttribute<Unit10, DecimalNumber>() {
		{
			...
			previousVersion_lazy = () -> Unit5.mmUnitsNumber;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Unit5#mmGroup1Or2Units
	...
	public static final MMMessageAttribute<Unit10, UKTaxGroupUnit1Code> mmGroup1Or2Units = new MMMessageAttribute<Unit10, UKTaxGroupUnit1Code>() {
		{
			...
			previousVersion_lazy = () -> Unit5.mmGroup1Or2Units;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Unit10.mmUnitsNumber, com.tools20022.repository.msg.Unit10.mmGroup1Or2Units);
				trace_lazy = () -> SecuritiesQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Unit10";
				definition = "Quantity expressed as a number and its details.";
				previousVersion_lazy = () -> Unit5.mmObject();
			}
		});
	...
	public Unit10 setUnitsNumber(DecimalNumber unitsNumber) {
	...
	public Unit10 setGroup1Or2Units(UKTaxGroupUnit1Code group1Or2Units) {
