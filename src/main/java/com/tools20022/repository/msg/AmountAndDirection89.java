...
public class AmountAndDirection89 {
	...
	public static final MMMessageAttribute mmAccruedInterestIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmAccruedInterestIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStampDutyIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmStampDutyIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmBrokerageAmountIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmBrokerageAmountIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmOriginalCurrencyAndOrderedAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmValueDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection45.mmValueDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> AmountAndDirection45.mmObject();
			}
		});
	...
	public AmountAndDirection89 setForeignExchangeDetails(com.tools20022.repository.msg.ForeignExchangeTerms23 foreignExchangeDetails) {
