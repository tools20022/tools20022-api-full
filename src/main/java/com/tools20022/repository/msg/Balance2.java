 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Balance2#mmShortLongIndicator
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forBalance2
 * ConstraintCoexistenceQuantityRule.forBalance2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Balance2", propOrder = {"shortLongIndicator", "quantity"})
public class Balance2 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Balance2
	 * Balance2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Balance2, ShortLong1Code> mmShortLongIndicator = new MMMessageAttribute<Balance2, ShortLong1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmShortLong;
			componentContext_lazy = () -> com.tools20022.repository.msg.Balance2.mmObject();
			isDerived = false;
			xmlTag = "ShrtLngInd";
		...
		@Override
		public ShortLong1Code getValue(Balance2 obj) {
			return obj.getShortLongIndicator();
		}

		@Override
		public void setValue(Balance2 obj, ShortLong1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Balance2, BalanceQuantity6Choice> mmQuantity = new MMMessageAssociationEnd<Balance2, BalanceQuantity6Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> BalanceQuantity6Choice.mmObject();
		}

		@Override
		public BalanceQuantity6Choice getValue(Balance2 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(Balance2 obj, BalanceQuantity6Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Balance2.mmShortLongIndicator, com.tools20022.repository.msg.Balance2.mmQuantity);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forBalance2);
	...
	public Balance2 setShortLongIndicator(ShortLong1Code shortLongIndicator) {
	...
	public Balance2 setQuantity(BalanceQuantity6Choice quantity) {
