 ...
 * CorporateActionGeneralInformation10.mmCorporateActionEventIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionGeneralInformation10#mmNarrativeType
 * CorporateActionGeneralInformation10.mmNarrativeType}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forCorporateActionGeneralInformation10
 * ConstraintCoexistenceIdentificationRule.
 * forCorporateActionGeneralInformation10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation10", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "narrativeType"})
public class CorporateActionGeneralInformation10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation10.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation10.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation10.mmNarrativeType);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNarrativeV01.mmCorporateActionGeneralInformation, CorporateActionNarrativeV02.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation10);
				...
				name = "CorporateActionGeneralInformation10";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation40.mmObject());
			}
		});
	...
	public CorporateActionGeneralInformation10 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation10 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation10 setNarrativeType(CorporateActionNarrative1Choice narrativeType) {
