...
public class ActiveOrHistoricCurrencyAndAmountRange1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange1.Amount, com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange1.CreditDebitIndicator,
						com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange1.Currency);
