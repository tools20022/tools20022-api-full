...
@XmlType(name = "ActiveOrHistoricCurrencyAndAmountRange1", propOrder = {"amount", "creditDebitIndicator", "currency"})
public class ActiveOrHistoricCurrencyAndAmountRange1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, ImpliedCurrencyAmountRangeChoice> mmAmount = new MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, ImpliedCurrencyAmountRangeChoice>() {
		{
			businessComponentTrace_lazy = () -> AmountRange.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange1.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Specified amount or amount range.";
			nextVersions_lazy = () -> Arrays.asList(ActiveOrHistoricCurrencyAndAmountRange2.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAmountRangeChoice getValue(ActiveOrHistoricCurrencyAndAmountRange1 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(ActiveOrHistoricCurrencyAndAmountRange1 obj, ImpliedCurrencyAmountRangeChoice value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, Optional<CreditDebitCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ActiveOrHistoricCurrencyAndAmountRange2.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CreditDebitCode> getValue(ActiveOrHistoricCurrencyAndAmountRange1 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(ActiveOrHistoricCurrencyAndAmountRange1 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, ActiveOrHistoricCurrencyCode> mmCurrency = new MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange1, ActiveOrHistoricCurrencyCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ActiveOrHistoricCurrencyAndAmountRange2.mmCurrency);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ActiveOrHistoricCurrencyAndAmountRange1 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(ActiveOrHistoricCurrencyAndAmountRange1 obj, ActiveOrHistoricCurrencyCode value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(ActiveOrHistoricCurrencyAndAmountRange2.mmObject());
			}
		});
	...
	public ActiveOrHistoricCurrencyAndAmountRange1 setAmount(ImpliedCurrencyAmountRangeChoice amount) {
	...
	public ActiveOrHistoricCurrencyAndAmountRange1 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public ActiveOrHistoricCurrencyAndAmountRange1 setCurrency(ActiveOrHistoricCurrencyCode currency) {
