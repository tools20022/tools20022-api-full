...
@XmlType(name = "ForeignExchangeSwapTransaction2", propOrder = {"reportedTransactionStatus", "branchIdentification", "uniqueTransactionIdentifier", "proprietaryTransactionIdentification", "counterpartyProprietaryTransactionIdentification",
...
public class ForeignExchangeSwapTransaction2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, TransactionOperationType1Code> mmReportedTransactionStatus = new MMMessageAttribute<ForeignExchangeSwapTransaction2, TransactionOperationType1Code>() {
		{
			businessElementTrace_lazy = () -> RegulatoryReport.mmType;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmObject();
			isDerived = false;
			xmlTag = "RptdTxSts";
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmReportedTransactionStatus);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmReportedTransactionStatus;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TransactionOperationType1Code getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getReportedTransactionStatus();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, TransactionOperationType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<LEIIdentifier>> mmBranchIdentification = new MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<LEIIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmBranchIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LEIIdentifier> getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getBranchIdentification();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, Optional<LEIIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<Max105Text>> mmUniqueTransactionIdentifier = new MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<Max105Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmUniqueTransactionIdentifier);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmUniqueTransactionIdentifier;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max105Text> getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getUniqueTransactionIdentifier();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, Optional<Max105Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, Max105Text> mmProprietaryTransactionIdentification = new MMMessageAttribute<ForeignExchangeSwapTransaction2, Max105Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmProprietaryTransactionIdentification);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmProprietaryTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max105Text.mmObject();
		}
		...
		@Override
		public Max105Text getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getProprietaryTransactionIdentification();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, Max105Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<Max105Text>> mmCounterpartyProprietaryTransactionIdentification = new MMMessageAttribute<ForeignExchangeSwapTransaction2, Optional<Max105Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmCounterpartyProprietaryTransactionIdentification);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmCounterpartyProprietaryTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max105Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, CounterpartyIdentification2Choice> mmCounterpartyIdentification = new MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, CounterpartyIdentification2Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmCounterpartyIdentification);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmCounterpartyIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CounterpartyIdentification2Choice getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getCounterpartyIdentification();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, CounterpartyIdentification2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, DateAndDateTimeChoice> mmTradeDate = new MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmTradeDate);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DateAndDateTimeChoice getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, ISODate> mmSpotValueDate = new MMMessageAttribute<ForeignExchangeSwapTransaction2, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmSpotValueDate);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmSpotValueDate;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getSpotValueDate();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, ISODate> mmMaturityDate = new MMMessageAttribute<ForeignExchangeSwapTransaction2, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmMaturityDate);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmMaturityDate;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, SecuritiesTransactionType15Code> mmTransactionType = new MMMessageAttribute<ForeignExchangeSwapTransaction2, SecuritiesTransactionType15Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmTransactionType);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesTransactionType15Code getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getTransactionType();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, SecuritiesTransactionType15Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeSwapTransaction2, ActiveCurrencyAndAmount> mmTransactionNominalAmount = new MMMessageAttribute<ForeignExchangeSwapTransaction2, ActiveCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmTransactionNominalAmount);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmTransactionNominalAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getTransactionNominalAmount();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, ForeignExchange1> mmForeignExchange = new MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, ForeignExchange1>() {
		{
			...
			definition = "Provides the details of the foreign exchange transaction.";
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmForeignExchange);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmForeignExchange;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public ForeignExchange1 getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getForeignExchange();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, ForeignExchange1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<ForeignExchangeSwapTransaction2, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmSupplementaryData);
			previousVersion_lazy = () -> ForeignExchangeSwapTransaction1.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(ForeignExchangeSwapTransaction2 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(ForeignExchangeSwapTransaction2 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmReportedTransactionStatus, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmBranchIdentification,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmUniqueTransactionIdentifier, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmProprietaryTransactionIdentification,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmCounterpartyProprietaryTransactionIdentification, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmCounterpartyIdentification,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmTradeDate, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmSpotValueDate,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmMaturityDate, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmTransactionType,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmTransactionNominalAmount, com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmForeignExchange,
						com.tools20022.repository.msg.ForeignExchangeSwapTransaction2.mmSupplementaryData);
	...
	public ForeignExchangeSwapTransaction2 setReportedTransactionStatus(TransactionOperationType1Code reportedTransactionStatus) {
	...
	public ForeignExchangeSwapTransaction2 setBranchIdentification(LEIIdentifier branchIdentification) {
	...
	public ForeignExchangeSwapTransaction2 setUniqueTransactionIdentifier(Max105Text uniqueTransactionIdentifier) {
	...
	public ForeignExchangeSwapTransaction2 setProprietaryTransactionIdentification(Max105Text proprietaryTransactionIdentification) {
	...
	public ForeignExchangeSwapTransaction2 setCounterpartyProprietaryTransactionIdentification(Max105Text counterpartyProprietaryTransactionIdentification) {
	...
	public ForeignExchangeSwapTransaction2 setCounterpartyIdentification(CounterpartyIdentification2Choice counterpartyIdentification) {
	...
	public ForeignExchangeSwapTransaction2 setTradeDate(DateAndDateTimeChoice tradeDate) {
	...
	public ForeignExchangeSwapTransaction2 setSpotValueDate(ISODate spotValueDate) {
	...
	public ForeignExchangeSwapTransaction2 setMaturityDate(ISODate maturityDate) {
	...
	public ForeignExchangeSwapTransaction2 setTransactionType(SecuritiesTransactionType15Code transactionType) {
	...
	public ForeignExchangeSwapTransaction2 setTransactionNominalAmount(ActiveCurrencyAndAmount transactionNominalAmount) {
	...
	public ForeignExchangeSwapTransaction2 setForeignExchange(ForeignExchange1 foreignExchange) {
	...
	public ForeignExchangeSwapTransaction2 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
