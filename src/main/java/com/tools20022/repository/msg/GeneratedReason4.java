...
public class GeneratedReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> GeneratedReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedReason4.mmCode, GeneratedReason4.mmAdditionalReasonInformation);
	...
	public void setCode(GeneratedReasons4Choice code) {
		this.code = code;
	}
