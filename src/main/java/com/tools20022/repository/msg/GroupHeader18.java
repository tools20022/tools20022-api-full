...
public class GroupHeader18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader18.mmMessageIdentification, GroupHeader18.mmCreationDateTime, GroupHeader18.mmAuthorisation, GroupHeader18.mmBatchBooking, GroupHeader18.mmNumberOfTransactions,
						GroupHeader18.mmControlSum, GroupHeader18.mmGroupReversal, GroupHeader18.mmTotalReversedInterbankSettlementAmount, GroupHeader18.mmInterbankSettlementDate, GroupHeader18.mmSettlementInformation,
						GroupHeader18.mmInstructingAgent, GroupHeader18.mmInstructedAgent);
