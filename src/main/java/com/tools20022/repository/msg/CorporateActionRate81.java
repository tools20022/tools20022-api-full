...
public class CorporateActionRate81 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate81.mmAdditionalTax, CorporateActionRate81.mmGrossDividendRate, CorporateActionRate81.mmNetDividendRate, CorporateActionRate81.mmIndexFactor,
						CorporateActionRate81.mmInterestRateUsedForPayment, CorporateActionRate81.mmMaximumAllowedOversubscriptionRate, CorporateActionRate81.mmProrationRate, CorporateActionRate81.mmWithholdingTaxRate,
						CorporateActionRate81.mmSecondLevelTax, CorporateActionRate81.mmTaxableIncomePerDividendShare, CorporateActionRate81.mmTaxOnIncome);
