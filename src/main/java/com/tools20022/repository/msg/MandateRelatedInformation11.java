	...
	public static final MMMessageAttribute MandateIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.MandateIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute DateOfSignature = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.DateOfSignature;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AmendmentIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.AmendmentIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmendmentInformationDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.AmendmentInformationDetails;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ElectronicSignature = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.ElectronicSignature;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FirstCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.FirstCollectionDate;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	public static final MMMessageAttribute FinalCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.FinalCollectionDate;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	public static final MMMessageAttribute Frequency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.Frequency;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation10.Reason;
			minOccurs = 0;
			maxOccurs = 1;
