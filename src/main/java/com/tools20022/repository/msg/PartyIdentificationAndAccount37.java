...
public class PartyIdentificationAndAccount37 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount37.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount37.mmIdentification, PartyIdentificationAndAccount37.mmAlternateIdentification, PartyIdentificationAndAccount37.mmSafekeepingAccount,
						PartyIdentificationAndAccount37.mmProcessingIdentification, PartyIdentificationAndAccount37.mmAdditionalInformation);
