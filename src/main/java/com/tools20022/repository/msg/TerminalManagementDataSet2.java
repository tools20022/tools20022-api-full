...
public class TerminalManagementDataSet2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TerminalManagementDataSet2.mmIdentification, TerminalManagementDataSet2.mmSequenceCounter, TerminalManagementDataSet2.mmContent);
	...
	public ManagementPlanContent1 getContent() {
		return content;
	}

	public void setContent(com.tools20022.repository.msg.ManagementPlanContent1 content) {
