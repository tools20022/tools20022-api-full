...
public class CorporateActionGeneralInformation117 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation117.mmCorporateActionEventIdentification, CorporateActionGeneralInformation117.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation117.mmClassActionNumber, CorporateActionGeneralInformation117.mmEventProcessingType, CorporateActionGeneralInformation117.mmEventType,
						CorporateActionGeneralInformation117.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation117.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdvice002V08.mmCorporateActionGeneralInformation);
