...
public class CorporateActionNotification4 {
	...
	public static final MMMessageAttribute NotificationType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CorporateActionNotification4.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionNotification3.NotificationType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNotification5.NotificationType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProcessingStatus = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionNotification3.ProcessingStatus;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNotification5.ProcessingStatus);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EligibleBalanceIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CorporateActionNotification3.EligibleBalanceIndicator;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNotification5.EligibleBalanceIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionNotification4.NotificationType, com.tools20022.repository.msg.CorporateActionNotification4.ProcessingStatus,
						com.tools20022.repository.msg.CorporateActionNotification4.EligibleBalanceIndicator);
				trace_lazy = () -> CorporateActionNotification.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionNotificationV05.NotificationGeneralInformation);
