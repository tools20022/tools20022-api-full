...
public class RateTypeAndAmountAndStatus12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus12.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus12.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus12.RateStatus);
