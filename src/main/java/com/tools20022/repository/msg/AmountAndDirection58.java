...
public class AmountAndDirection58 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection58.mmAmount, AmountAndDirection58.mmCreditDebitIndicator, AmountAndDirection58.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection58.mmForeignExchangeDetails);
