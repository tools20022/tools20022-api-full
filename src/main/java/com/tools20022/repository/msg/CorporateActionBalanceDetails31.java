...
public class CorporateActionBalanceDetails31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionBalanceDetails31.mmConfirmedBalance, CorporateActionBalanceDetails31.mmTotalEligibleBalance, CorporateActionBalanceDetails31.mmBlockedBalance,
