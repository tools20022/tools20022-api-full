...
import com.tools20022.repository.choice.AcknowledgementReason7Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcknowledgementReason5#mmCode
...
@XmlType(name = "AcknowledgementReason5", propOrder = {"code", "additionalReasonInformation"})
public class AcknowledgementReason5 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AcknowledgementReason7Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AcknowledgementReason5
	 * AcknowledgementReason5}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcknowledgementReason5.mmCode, com.tools20022.repository.msg.AcknowledgementReason5.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason5";
	...
	public AcknowledgementReason7Choice getCode() {
		return code;
	}

	public AcknowledgementReason5 setCode(AcknowledgementReason7Choice code) {
	...
	public AcknowledgementReason5 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
