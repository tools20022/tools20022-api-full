...
public class AcknowledgementReason5 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason5.mmCode, AcknowledgementReason5.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason7Choice code) {
		this.code = code;
	}
