 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.TaxVoucher5#mmIdentification
...
@XmlType(name = "TaxVoucher5", propOrder = {"identification", "bargainDate", "bargainSettlementDate"})
public class TaxVoucher5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TaxVoucher5 TaxVoucher5}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TaxVoucher5.mmIdentification, com.tools20022.repository.msg.TaxVoucher5.mmBargainDate,
						com.tools20022.repository.msg.TaxVoucher5.mmBargainSettlementDate);
	...
	public TaxVoucher5 setIdentification(RestrictedFINXMax16Text identification) {
	...
	public TaxVoucher5 setBargainDate(DateAndDateTime2Choice bargainDate) {
	...
	public TaxVoucher5 setBargainSettlementDate(DateAndDateTime2Choice bargainSettlementDate) {
