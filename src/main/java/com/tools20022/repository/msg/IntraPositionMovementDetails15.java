...
public class IntraPositionMovementDetails15 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmSettledQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPreviouslySettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmPreviouslySettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	public static final MMMessageAssociationEnd mmRemainingToBeSettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			definition = "Quantity of financial instrument remaining to be settled.";
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmRemainingToBeSettledQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	public static final MMMessageAssociationEnd mmSecuritiesSubBalanceIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmSecuritiesSubBalanceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBalanceTo = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmBalanceTo;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAvailableDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmAvailableDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTime2Choice.mmObject();
	...
	public static final MMMessageAttribute mmAcknowledgedStatusTimeStamp = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmAcknowledgedStatusTimeStamp;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCorporateActionEventType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmCorporateActionEventType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCollateralMonitorAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmCollateralMonitorAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInstructionProcessingAdditionalDetails = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmSupplementaryData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> IntraPositionMovementDetails13.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> IntraPositionMovementDetails13.mmObject();
			}
		});
	...
	public IntraPositionMovementDetails15 setSecuritiesSubBalanceIdentification(com.tools20022.repository.msg.GenericIdentification37 securitiesSubBalanceIdentification) {
	...
	public IntraPositionMovementDetails15 setCollateralMonitorAmount(com.tools20022.repository.msg.AmountAndDirection44 collateralMonitorAmount) {
	...
	public IntraPositionMovementDetails15 setSupplementaryData(List<com.tools20022.repository.msg.SupplementaryData1> supplementaryData) {
