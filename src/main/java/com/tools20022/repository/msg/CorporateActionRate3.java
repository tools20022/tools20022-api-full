...
public class CorporateActionRate3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate3.mmInterest, CorporateActionRate3.mmPercentageSought, CorporateActionRate3.mmRelatedIndex, CorporateActionRate3.mmSpread, CorporateActionRate3.mmBidInterval,
						CorporateActionRate3.mmPreviousFactor, CorporateActionRate3.mmNextFactor, CorporateActionRate3.mmReinvestmentDiscountRateToMarket);
