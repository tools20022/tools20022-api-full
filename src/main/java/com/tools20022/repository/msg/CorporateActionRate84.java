...
public class CorporateActionRate84 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate84.mmAdditionalTax, CorporateActionRate84.mmGrossDividendRate, CorporateActionRate84.mmNetDividendRate, CorporateActionRate84.mmIndexFactor,
						CorporateActionRate84.mmInterestRateUsedForPayment, CorporateActionRate84.mmMaximumAllowedOversubscriptionRate, CorporateActionRate84.mmProrationRate, CorporateActionRate84.mmWithholdingTaxRate,
						CorporateActionRate84.mmSecondLevelTax, CorporateActionRate84.mmTaxableIncomePerDividendShare, CorporateActionRate84.mmTaxOnIncome);
