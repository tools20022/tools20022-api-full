...
public class SecuritiesOption48 {
	...
	public static final MMMessageAssociationEnd mmRateDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionRate65.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice55.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption48.mmFinancialInstrumentIdentification, SecuritiesOption48.mmCreditDebitIndicator, SecuritiesOption48.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption48.mmNewSecuritiesIssuanceIndicator, SecuritiesOption48.mmPostingQuantity, SecuritiesOption48.mmSafekeepingPlace, SecuritiesOption48.mmFractionDisposition, SecuritiesOption48.mmCurrencyOption,
						SecuritiesOption48.mmDateDetails, SecuritiesOption48.mmRateDetails, SecuritiesOption48.mmPriceDetails, SecuritiesOption48.mmReceivingSettlementParties, SecuritiesOption48.mmDeliveringSettlementParties);
	...
	public CorporateActionRate65 getRateDetails() {
		return rateDetails;
	}

	public void setRateDetails(com.tools20022.repository.msg.CorporateActionRate65 rateDetails) {
		this.rateDetails = rateDetails;
	}

	public CorporateActionPrice55 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice55 priceDetails) {
