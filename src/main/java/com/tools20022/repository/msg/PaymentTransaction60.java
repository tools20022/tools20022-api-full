...
public class PaymentTransaction60 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction60.mmReversalIdentification, PaymentTransaction60.mmOriginalGroupInformation, PaymentTransaction60.mmOriginalInstructionIdentification,
						PaymentTransaction60.mmOriginalEndToEndIdentification, PaymentTransaction60.mmOriginalTransactionIdentification, PaymentTransaction60.mmOriginalClearingSystemReference,
						PaymentTransaction60.mmOriginalInterbankSettlementAmount, PaymentTransaction60.mmReversedInterbankSettlementAmount, PaymentTransaction60.mmInterbankSettlementDate, PaymentTransaction60.mmSettlementPriority,
						PaymentTransaction60.mmReversedInstructedAmount, PaymentTransaction60.mmExchangeRate, PaymentTransaction60.mmCompensationAmount, PaymentTransaction60.mmChargeBearer, PaymentTransaction60.mmChargesInformation,
						PaymentTransaction60.mmInstructingAgent, PaymentTransaction60.mmInstructedAgent, PaymentTransaction60.mmReversalReasonInformation, PaymentTransaction60.mmOriginalTransactionReference,
						PaymentTransaction60.mmSupplementaryData);
