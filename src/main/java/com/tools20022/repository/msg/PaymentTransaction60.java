 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReversedInstructedAmountAndExchangeRate1Rule#forPaymentTransaction60
...
@XmlType(name = "PaymentTransaction60", propOrder = {"reversalIdentification", "originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification", "originalTransactionIdentification",
...
public class PaymentTransaction60 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>> mmReversalIdentification = new MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction60.mmObject();
			isDerived = false;
			xmlTag = "RvslId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmReversalIdentification);
			previousVersion_lazy = () -> PaymentTransaction51.mmReversalIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction60 obj) {
			return obj.getReversalIdentification();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction60, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalGroupInformation);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction60 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalTransactionIdentification);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction60, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction60 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, ActiveCurrencyAndAmount> mmReversedInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction60, ActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> CashSettlement.mmInterbankSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction60.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmReversedInterbankSettlementAmount);
			previousVersion_lazy = () -> PaymentTransaction51.mmReversedInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(PaymentTransaction60 obj) {
			return obj.getReversedInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, ActiveCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<ISODate>> mmInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction60, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmInterbankSettlementDate);
			previousVersion_lazy = () -> PaymentTransaction51.mmInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction60 obj) {
			return obj.getInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<Priority3Code>> mmSettlementPriority = new MMMessageAttribute<PaymentTransaction60, Optional<Priority3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmSettlementPriority);
			previousVersion_lazy = () -> PaymentTransaction51.mmSettlementPriority;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Priority3Code> getValue(PaymentTransaction60 obj) {
			return obj.getSettlementPriority();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<Priority3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>> mmReversedInstructedAmount = new MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmReversedInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction51.mmReversedInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<BaseOneRate>> mmExchangeRate = new MMMessageAttribute<PaymentTransaction60, Optional<BaseOneRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmExchangeRate);
			previousVersion_lazy = () -> PaymentTransaction51.mmExchangeRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOneRate> getValue(PaymentTransaction60 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<BaseOneRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>> mmCompensationAmount = new MMMessageAttribute<PaymentTransaction60, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmCompensationAmount);
			previousVersion_lazy = () -> PaymentTransaction51.mmCompensationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentTransaction60, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmChargeBearer);
			previousVersion_lazy = () -> PaymentTransaction51.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentTransaction60 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction60, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction51.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction60 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructingAgent = new MMMessageAssociationEnd<PaymentTransaction60, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmInstructingAgent);
			previousVersion_lazy = () -> PaymentTransaction51.mmInstructingAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentTransaction60 obj) {
			return obj.getInstructingAgent();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, Optional<BranchAndFinancialInstitutionIdentification5>> mmInstructedAgent = new MMMessageAssociationEnd<PaymentTransaction60, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction60.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmInstructedAgent);
			previousVersion_lazy = () -> PaymentTransaction51.mmInstructedAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<PaymentTransaction60, List<PaymentReversalReason7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmReversalReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction51.mmReversalReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReversalReason7> getValue(PaymentTransaction60 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, List<PaymentReversalReason7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction60, Optional<OriginalTransactionReference22>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction60, Optional<OriginalTransactionReference22>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction51.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference22> getValue(PaymentTransaction60 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, Optional<OriginalTransactionReference22> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction60, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction60, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction60.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction51.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction60 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction60 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction60.mmReversalIdentification, com.tools20022.repository.msg.PaymentTransaction60.mmOriginalGroupInformation,
						com.tools20022.repository.msg.PaymentTransaction60.mmOriginalInstructionIdentification, com.tools20022.repository.msg.PaymentTransaction60.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.PaymentTransaction60.mmOriginalTransactionIdentification, com.tools20022.repository.msg.PaymentTransaction60.mmOriginalClearingSystemReference,
						com.tools20022.repository.msg.PaymentTransaction60.mmOriginalInterbankSettlementAmount, com.tools20022.repository.msg.PaymentTransaction60.mmReversedInterbankSettlementAmount,
						com.tools20022.repository.msg.PaymentTransaction60.mmInterbankSettlementDate, com.tools20022.repository.msg.PaymentTransaction60.mmSettlementPriority,
						com.tools20022.repository.msg.PaymentTransaction60.mmReversedInstructedAmount, com.tools20022.repository.msg.PaymentTransaction60.mmExchangeRate,
						com.tools20022.repository.msg.PaymentTransaction60.mmCompensationAmount, com.tools20022.repository.msg.PaymentTransaction60.mmChargeBearer, com.tools20022.repository.msg.PaymentTransaction60.mmChargesInformation,
						com.tools20022.repository.msg.PaymentTransaction60.mmInstructingAgent, com.tools20022.repository.msg.PaymentTransaction60.mmInstructedAgent,
						com.tools20022.repository.msg.PaymentTransaction60.mmReversalReasonInformation, com.tools20022.repository.msg.PaymentTransaction60.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction60.mmSupplementaryData);
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFIPaymentReversalV06.mmTransactionInformation);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReversedInstructedAmountAndExchangeRate1Rule.forPaymentTransaction60,
						com.tools20022.repository.constraints.ConstraintReversedInstructedAmountAndExchangeRate2Rule.forPaymentTransaction60,
						com.tools20022.repository.constraints.ConstraintChargesInformationAndReversedInstructedAmountRule.forPaymentTransaction60);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction60";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction81.mmObject());
				previousVersion_lazy = () -> PaymentTransaction51.mmObject();
			}
		});
	...
	public PaymentTransaction60 setReversalIdentification(Max35Text reversalIdentification) {
	...
	public PaymentTransaction60 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction60 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction60 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction60 setOriginalTransactionIdentification(Max35Text originalTransactionIdentification) {
	...
	public PaymentTransaction60 setOriginalClearingSystemReference(Max35Text originalClearingSystemReference) {
	...
	public PaymentTransaction60 setOriginalInterbankSettlementAmount(ActiveOrHistoricCurrencyAndAmount originalInterbankSettlementAmount) {
	...
	public PaymentTransaction60 setReversedInterbankSettlementAmount(ActiveCurrencyAndAmount reversedInterbankSettlementAmount) {
	...
	public PaymentTransaction60 setInterbankSettlementDate(ISODate interbankSettlementDate) {
	...
	public PaymentTransaction60 setSettlementPriority(Priority3Code settlementPriority) {
	...
	public PaymentTransaction60 setReversedInstructedAmount(ActiveOrHistoricCurrencyAndAmount reversedInstructedAmount) {
	...
	public PaymentTransaction60 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public PaymentTransaction60 setCompensationAmount(ActiveOrHistoricCurrencyAndAmount compensationAmount) {
	...
	public PaymentTransaction60 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentTransaction60 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction60 setInstructingAgent(BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public PaymentTransaction60 setInstructedAgent(BranchAndFinancialInstitutionIdentification5 instructedAgent) {
	...
	public PaymentTransaction60 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
	...
	public PaymentTransaction60 setOriginalTransactionReference(OriginalTransactionReference22 originalTransactionReference) {
	...
	public PaymentTransaction60 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
