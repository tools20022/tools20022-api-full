...
public class SecuritiesOption25 {
	...
	public static final MMMessageAssociationEnd mmPriceDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice31.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption25.mmSecurityDetails, SecuritiesOption25.mmCreditDebitIndicator, SecuritiesOption25.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption25.mmNonEligibleProceedsIndicator, SecuritiesOption25.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption25.mmEntitledQuantity, SecuritiesOption25.mmFractionDisposition,
						SecuritiesOption25.mmCurrencyOption, SecuritiesOption25.mmTradingPeriod, SecuritiesOption25.mmDateDetails, SecuritiesOption25.mmRateDetails, SecuritiesOption25.mmPriceDetails);
	...
	public CorporateActionPrice31 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice31 priceDetails) {
