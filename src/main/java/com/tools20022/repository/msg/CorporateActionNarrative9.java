...
public class CorporateActionNarrative9 {
	...
	public CorporateActionNarrative9 setAdditionalText(List<Max350Text> additionalText) {
	...
	public CorporateActionNarrative9 setInformationConditions(List<Max350Text> informationConditions) {
	...
	public CorporateActionNarrative9 setInformationToComplyWith(List<Max350Text> informationToComplyWith) {
	...
	public CorporateActionNarrative9 setPartyContactNarrative(List<Max350Text> partyContactNarrative) {
