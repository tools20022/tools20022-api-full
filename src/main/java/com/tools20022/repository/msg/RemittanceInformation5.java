...
public class RemittanceInformation5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RemittanceInformation5
	 * RemittanceInformation5}</li>
	...
	public static final MMMessageAttribute mmUnstructured = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RemittanceInformation5.mmObject();
			isDerived = false;
			xmlTag = "Ustrd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceInformation5.mmUnstructured, com.tools20022.repository.msg.RemittanceInformation5.mmStructured);
	...
	public void setStructured(List<com.tools20022.repository.msg.StructuredRemittanceInformation7> structured) {
