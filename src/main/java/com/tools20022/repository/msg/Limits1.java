...
public class Limits1 {
	...
	protected List<com.tools20022.repository.msg.LimitReport1> currentLimit;
	/**
	...
	public static final MMMessageAssociationEnd mmCurrentLimit = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Limits1.mmObject();
			isDerived = false;
			xmlTag = "CurLmt";
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.LimitReport1.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.LimitReport1> defaultLimit;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Limits1.mmCurrentLimit, Limits1.mmDefaultLimit);
	...
	public void setCurrentLimit(List<com.tools20022.repository.msg.LimitReport1> currentLimit) {
	...
	public void setDefaultLimit(List<com.tools20022.repository.msg.LimitReport1> defaultLimit) {
