...
public class RejectionOrRepairReason3 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason3.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason3.mmCode, RejectionOrRepairReason3.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason3Choice code) {
		this.code = code;
	}
