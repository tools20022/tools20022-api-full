 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection55#mmAmount
...
@XmlType(name = "AmountAndDirection55", propOrder = {"amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails"})
public class AmountAndDirection55 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AmountAndDirection55
	 * AmountAndDirection55}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection55, RestrictedFINActiveOrHistoricCurrencyAndAmount> mmAmount = new MMMessageAttribute<AmountAndDirection55, RestrictedFINActiveOrHistoricCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection55.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveOrHistoricCurrencyAndAmount getValue(AmountAndDirection55 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection55 obj, RestrictedFINActiveOrHistoricCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection55, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection55, Optional<CreditDebitCode>>() {
		{
		...
		@Override
		public Optional<CreditDebitCode> getValue(AmountAndDirection55 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection55 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection55, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection55, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection55 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection55 obj, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection55, Optional<ForeignExchangeTerms23>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection55, Optional<ForeignExchangeTerms23>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms23> getValue(AmountAndDirection55 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection55 obj, Optional<ForeignExchangeTerms23> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection55.mmAmount, com.tools20022.repository.msg.AmountAndDirection55.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection55.mmOriginalCurrencyAndOrderedAmount, com.tools20022.repository.msg.AmountAndDirection55.mmForeignExchangeDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AmountAndDirection55";
	...
	public AmountAndDirection55 setAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount amount) {
	...
	public AmountAndDirection55 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection55 setOriginalCurrencyAndOrderedAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection55 setForeignExchangeDetails(ForeignExchangeTerms23 foreignExchangeDetails) {
