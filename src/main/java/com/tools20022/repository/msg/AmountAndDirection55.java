...
public class AmountAndDirection55 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection55.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection55.mmAmount, AmountAndDirection55.mmCreditDebitIndicator, AmountAndDirection55.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection55.mmForeignExchangeDetails);
