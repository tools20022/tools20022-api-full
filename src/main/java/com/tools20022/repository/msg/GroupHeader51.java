...
public class GroupHeader51 {
	...
	public static final MMMessageAttribute mmMessageIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GroupHeader51.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader51.mmMessageIdentification, GroupHeader51.mmCreationDateTime, GroupHeader51.mmBatchBooking, GroupHeader51.mmNumberOfTransactions, GroupHeader51.mmControlSum,
						GroupHeader51.mmTotalInterbankSettlementAmount, GroupHeader51.mmInterbankSettlementDate, GroupHeader51.mmSettlementInformation, GroupHeader51.mmPaymentTypeInformation, GroupHeader51.mmInstructingAgent,
						GroupHeader51.mmInstructedAgent);
