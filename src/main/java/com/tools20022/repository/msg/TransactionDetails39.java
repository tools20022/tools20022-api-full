...
public class TransactionDetails39 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails39.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	public SettlementOrCorporateActionEvent6Choice getSettlementTransactionOrCorporateActionEventType() {
		return settlementTransactionOrCorporateActionEventType;
	}

	public void setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent6Choice settlementTransactionOrCorporateActionEventType) {
	...
	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails47 settlementParameters) {
