	...
	public static final MMMessageAttribute Unit = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InterestRateContractTerm2.Unit);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Value = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InterestRateContractTerm2.Value);
			minOccurs = 1;
			maxOccurs = 1;
