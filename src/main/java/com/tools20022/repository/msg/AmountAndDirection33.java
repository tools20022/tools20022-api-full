 ...
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection33#mmAmount
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndDirection33
 * ConstraintCoexistenceAmountRule.forAmountAndDirection33}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AmountAndDirection33", propOrder = {"accruedInterestIndicator", "stampDutyIndicator", "amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails", "valueDate"})
public class AmountAndDirection33 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<YesNoIndicator>> mmAccruedInterestIndicator = new MMMessageAttribute<AmountAndDirection33, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAccruedInterestIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection33.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<YesNoIndicator> getValue(AmountAndDirection33 obj) {
			return obj.getAccruedInterestIndicator();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<YesNoIndicator>> mmStampDutyIndicator = new MMMessageAttribute<AmountAndDirection33, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<RestrictedFINActiveCurrencyAndAmount>> mmAmount = new MMMessageAttribute<AmountAndDirection33, Optional<RestrictedFINActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<RestrictedFINActiveCurrencyAndAmount> getValue(AmountAndDirection33 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<RestrictedFINActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection33, Optional<CreditDebitCode>>() {
		{
		...
		@Override
		public Optional<CreditDebitCode> getValue(AmountAndDirection33 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection33, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection33 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection33, Optional<ForeignExchangeTerms12>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection33, Optional<ForeignExchangeTerms12>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms12> getValue(AmountAndDirection33 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<ForeignExchangeTerms12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection33, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAttribute<AmountAndDirection33, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(AmountAndDirection33 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(AmountAndDirection33 obj, Optional<DateAndDateTimeChoice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection33.mmAccruedInterestIndicator, com.tools20022.repository.msg.AmountAndDirection33.mmStampDutyIndicator,
						com.tools20022.repository.msg.AmountAndDirection33.mmAmount, com.tools20022.repository.msg.AmountAndDirection33.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection33.mmOriginalCurrencyAndOrderedAmount, com.tools20022.repository.msg.AmountAndDirection33.mmForeignExchangeDetails,
						com.tools20022.repository.msg.AmountAndDirection33.mmValueDate);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection33);
	...
	public AmountAndDirection33 setAccruedInterestIndicator(YesNoIndicator accruedInterestIndicator) {
	...
	public AmountAndDirection33 setStampDutyIndicator(YesNoIndicator stampDutyIndicator) {
	...
	public AmountAndDirection33 setAmount(RestrictedFINActiveCurrencyAndAmount amount) {
		this.amount = amount;
		return this;
	}
	...
	public AmountAndDirection33 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection33 setOriginalCurrencyAndOrderedAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection33 setForeignExchangeDetails(ForeignExchangeTerms12 foreignExchangeDetails) {
	...
	public AmountAndDirection33 setValueDate(DateAndDateTimeChoice valueDate) {
