...
public class AmountAndDirection33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection33.mmAccruedInterestIndicator, AmountAndDirection33.mmStampDutyIndicator, AmountAndDirection33.mmAmount, AmountAndDirection33.mmCreditDebitIndicator,
						AmountAndDirection33.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection33.mmForeignExchangeDetails, AmountAndDirection33.mmValueDate);
