...
public class Identification8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification8.mmAccountOwnerTransactionIdentification, Identification8.mmAccountServicerTransactionIdentification, Identification8.mmMarketInfrastructureTransactionIdentification,
						Identification8.mmProcessorTransactionIdentification, Identification8.mmCommonIdentification, Identification8.mmTradeIdentification, Identification8.mmMasterIdentification, Identification8.mmBasketIdentification,
						Identification8.mmIndexIdentification, Identification8.mmListIdentification, Identification8.mmProgramIdentification, Identification8.mmPoolIdentification, Identification8.mmCorporateActionEventIdentification);
