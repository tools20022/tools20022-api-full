...
public class QuantityAndAccount33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount33.mmSettlementQuantity, QuantityAndAccount33.mmDenominationChoice, QuantityAndAccount33.mmAccountOwner, QuantityAndAccount33.mmSafekeepingAccount,
						QuantityAndAccount33.mmCashAccount, QuantityAndAccount33.mmSafekeepingPlace, QuantityAndAccount33.mmQuantityBreakdown);
