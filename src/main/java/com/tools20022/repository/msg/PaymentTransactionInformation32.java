...
public class PaymentTransactionInformation32 {
	...
	public static final MMMessageAttribute mmCancellationStatusIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentTransactionInformation32.mmObject();
			isDerived = false;
			xmlTag = "CxlStsId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation32.mmCancellationStatusIdentification, PaymentTransactionInformation32.mmResolvedCase,
						PaymentTransactionInformation32.mmOriginalInstructionIdentification, PaymentTransactionInformation32.mmOriginalEndToEndIdentification, PaymentTransactionInformation32.mmTransactionCancellationStatus,
						PaymentTransactionInformation32.mmCancellationStatusReasonInformation, PaymentTransactionInformation32.mmOriginalInstructedAmount, PaymentTransactionInformation32.mmOriginalRequestedExecutionDate,
						PaymentTransactionInformation32.mmOriginalRequestedCollectionDate, PaymentTransactionInformation32.mmOriginalTransactionReference);
