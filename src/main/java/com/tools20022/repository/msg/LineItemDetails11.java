...
public class LineItemDetails11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(LineItemDetails11.mmLineItemIdentification, LineItemDetails11.mmQuantity, LineItemDetails11.mmUnitPrice, LineItemDetails11.mmProductName, LineItemDetails11.mmProductIdentifier,
						LineItemDetails11.mmProductCharacteristics, LineItemDetails11.mmProductCategory, LineItemDetails11.mmProductOrigin, LineItemDetails11.mmAdjustment, LineItemDetails11.mmFreightCharges, LineItemDetails11.mmTax,
						LineItemDetails11.mmTotalAmount);
