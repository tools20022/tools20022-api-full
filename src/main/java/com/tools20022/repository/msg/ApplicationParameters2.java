...
public class ApplicationParameters2 {
	...
	public static final MMMessageAttribute<ApplicationParameters2, Max35Text> mmApplicationIdentification = new MMMessageAttribute<ApplicationParameters2, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ApplicationParameters3.mmApplicationIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<ApplicationParameters2, Max16Text> mmVersion = new MMMessageAttribute<ApplicationParameters2, Max16Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ApplicationParameters3.mmVersion);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<ApplicationParameters2, Optional<ContentInformationType5>> mmEncryptedParameters = new MMMessageAssociationEnd<ApplicationParameters2, Optional<ContentInformationType5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ApplicationParameters3.mmEncryptedParameters);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public ApplicationParameters2 setApplicationIdentification(Max35Text applicationIdentification) {
	...
	public ApplicationParameters2 setVersion(Max16Text version) {
	...
	public ApplicationParameters2 setParameters(List<Max10000Binary> parameters) {
		this.parameters = Objects.requireNonNull(parameters);
		return this;
	}

	public Optional<ContentInformationType5> getEncryptedParameters() {
