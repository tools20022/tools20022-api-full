...
public class ApplicationParameters2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ApplicationParameters2.mmApplicationIdentification, ApplicationParameters2.mmVersion, ApplicationParameters2.mmParameters, ApplicationParameters2.mmEncryptedParameters);
