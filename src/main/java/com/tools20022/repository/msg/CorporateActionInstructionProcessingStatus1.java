...
public class CorporateActionInstructionProcessingStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionInstructionProcessingStatus1.mmStatus, CorporateActionInstructionProcessingStatus1.mmAdditionalInformation);
