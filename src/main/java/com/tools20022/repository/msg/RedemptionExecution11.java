...
public class RedemptionExecution11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RedemptionExecution11.InvestmentAccountDetails, com.tools20022.repository.msg.RedemptionExecution11.FinancialInstrumentDetails,
						com.tools20022.repository.msg.RedemptionExecution11.FinancialInstrumentQuantity);
