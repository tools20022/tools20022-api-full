...
public class ForeignExchangeTerms17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms17.mmUnitCurrency, ForeignExchangeTerms17.mmQuotedCurrency, ForeignExchangeTerms17.mmExchangeRate, ForeignExchangeTerms17.mmResultingAmount);
