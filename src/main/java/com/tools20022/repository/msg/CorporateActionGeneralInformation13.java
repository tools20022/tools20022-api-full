...
public class CorporateActionGeneralInformation13 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation13.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation13.mmCorporateActionEventIdentification, CorporateActionGeneralInformation13.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation13.mmClassActionNumber, CorporateActionGeneralInformation13.mmEventType);
