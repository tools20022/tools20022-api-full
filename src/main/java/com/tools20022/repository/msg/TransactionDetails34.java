...
public class TransactionDetails34 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails34.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails34.mmTransactionActivity, TransactionDetails34.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails34.mmSecuritiesMovementType,
						TransactionDetails34.mmPayment, TransactionDetails34.mmSettlementParameters, TransactionDetails34.mmPlaceOfTrade, TransactionDetails34.mmSafekeepingPlace, TransactionDetails34.mmPlaceOfClearing,
						TransactionDetails34.mmPostingQuantity, TransactionDetails34.mmNumberOfDaysAccrued, TransactionDetails34.mmPostingAmount, TransactionDetails34.mmAccruedInterestAmount, TransactionDetails34.mmTradeDate,
						TransactionDetails34.mmEffectiveSettlementDate, TransactionDetails34.mmSettlementDate, TransactionDetails34.mmValueDate, TransactionDetails34.mmDeliveringSettlementParties,
						TransactionDetails34.mmReceivingSettlementParties, TransactionDetails34.mmReversalIndicator, TransactionDetails34.mmTransactionAdditionalDetails);
	...
	public SettlementDetails39 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails39 settlementParameters) {
