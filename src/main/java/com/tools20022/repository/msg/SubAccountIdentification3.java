 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubAccountIdentification3#ActivityIndicator
 * SubAccountIdentification3.ActivityIndicator}</li>
 * <li>
...
public class SubAccountIdentification3 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SubAccountIdentification3.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification3.Identification, com.tools20022.repository.msg.SubAccountIdentification3.FungibleIndicator,
						com.tools20022.repository.msg.SubAccountIdentification3.ActivityIndicator, com.tools20022.repository.msg.SubAccountIdentification3.BalanceForSubAccount);
				trace_lazy = () -> AccountIdentification.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.AccountingStatementOfHoldingsV02.SubAccountDetails);
