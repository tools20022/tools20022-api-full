 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification10#Type
...
public class MarketIdentification10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification10.Identification, com.tools20022.repository.msg.MarketIdentification10.Type);
