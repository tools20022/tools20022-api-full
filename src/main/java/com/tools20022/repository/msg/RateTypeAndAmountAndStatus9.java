...
public class RateTypeAndAmountAndStatus9 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RateTypeAndAmountAndStatus9.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus9.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus9.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus9.RateStatus);
