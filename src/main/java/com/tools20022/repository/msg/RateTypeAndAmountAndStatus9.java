...
public class RateTypeAndAmountAndStatus9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus9.mmRateType, RateTypeAndAmountAndStatus9.mmAmount, RateTypeAndAmountAndStatus9.mmRateStatus);
	...
	public void setRateType(RateType12Choice rateType) {
