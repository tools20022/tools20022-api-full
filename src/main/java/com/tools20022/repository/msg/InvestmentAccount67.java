...
public class InvestmentAccount67 {
	...
	public static final MMMessageAttribute mmOwnerIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmOwnerIdentification;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmAccountIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAccountName = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmAccountName;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmAccountDesignation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmAccountDesignation;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmIntermediaryInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmIntermediaryInformation;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmSecuritiesForm = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmSecuritiesForm;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmDematerialisedIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmDematerialisedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmIncomePreference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmIncomePreference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmBeneficiaryCertificationCompletion = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmBeneficiaryCertificationCompletion;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSafekeepingPlace = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAccountServicer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmAccountServicer;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.PartyIdentification113.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmSubAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmSubAccountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementPartiesDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InvestmentAccount56.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ReceivingPartiesAndAccount18.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> InvestmentAccount56.mmObject();
			}
		});
	...
	public InvestmentAccount67 setOwnerIdentification(List<com.tools20022.repository.msg.PartyIdentification113> ownerIdentification) {
	...
	public InvestmentAccount67 setIntermediaryInformation(List<com.tools20022.repository.msg.Intermediary41> intermediaryInformation) {
	...
	public InvestmentAccount67 setAccountServicer(com.tools20022.repository.msg.PartyIdentification113 accountServicer) {
	...
	public InvestmentAccount67 setSubAccountDetails(com.tools20022.repository.msg.SubAccount5 subAccountDetails) {
	...
	public InvestmentAccount67 setSettlementPartiesDetails(com.tools20022.repository.msg.ReceivingPartiesAndAccount18 settlementPartiesDetails) {
