 ...
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation11#StampDuty
 * ReceiveInformation11.StampDuty}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation11#NetAmount
...
public class ReceiveInformation11 {
	...
	public static final MMMessageAttribute RequestedSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.RequestedSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EffectiveSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.EffectiveSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.SettlementAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute StampDuty = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.StampDuty);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NetAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.NetAmount);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd ChargeDetails = new MMMessageAssociationEnd() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.ChargeDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd CommissionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.CommissionDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd TaxDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.TaxDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd SettlementPartiesDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.SettlementPartiesDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PhysicalTransfer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.PhysicalTransfer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PhysicalTransferDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation12.PhysicalTransferDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation11.RequestedSettlementDate, com.tools20022.repository.msg.ReceiveInformation11.EffectiveSettlementDate,
						com.tools20022.repository.msg.ReceiveInformation11.SettlementAmount, com.tools20022.repository.msg.ReceiveInformation11.StampDuty, com.tools20022.repository.msg.ReceiveInformation11.NetAmount,
						com.tools20022.repository.msg.ReceiveInformation11.ChargeDetails, com.tools20022.repository.msg.ReceiveInformation11.CommissionDetails, com.tools20022.repository.msg.ReceiveInformation11.TaxDetails,
						com.tools20022.repository.msg.ReceiveInformation11.SettlementPartiesDetails, com.tools20022.repository.msg.ReceiveInformation11.PhysicalTransfer,
						com.tools20022.repository.msg.ReceiveInformation11.PhysicalTransferDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV04.SettlementDetails);
