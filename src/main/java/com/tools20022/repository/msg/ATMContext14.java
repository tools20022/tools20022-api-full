...
import com.tools20022.repository.msg.ATMService15;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ATMContext18 ATMContext18}</li>
 * </ul>
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ATMContext14", propOrder = {"sessionReference", "service"})
public class ATMContext14 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ATMContext14 ATMContext14}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ATMContext14, Optional<Max35Text>> mmSessionReference = new MMMessageAttribute<ATMContext14, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMContext14.mmObject();
			isDerived = false;
			xmlTag = "SsnRef";
			...
			nextVersions_lazy = () -> Arrays.asList(ATMContext18.mmSessionReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ATMContext14 obj) {
			return obj.getSessionReference();
		}

		@Override
		public void setValue(ATMContext14 obj, Optional<Max35Text> value) {
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.ATMService15
	 * ATMService15}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ATMContext14, ATMService15> mmService = new MMMessageAssociationEnd<ATMContext14, ATMService15>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMContext14.mmObject();
			isDerived = false;
			xmlTag = "Svc";
			...
			nextVersions_lazy = () -> Arrays.asList(ATMContext18.mmService);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public ATMService15 getValue(ATMContext14 obj) {
			return obj.getService();
		}

		@Override
		public void setValue(ATMContext14 obj, ATMService15 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(ATMContext18.mmObject());
			}
		});
	...
	public ATMContext14 setSessionReference(Max35Text sessionReference) {
	...
	public ATMContext14 setService(ATMService15 service) {
