...
import com.tools20022.repository.choice.PendingOpeningStatusReason2Choice;
 ...
 * definition} = "Reason for a pending account opening status."</li>
 * <li>
...
@XmlType(name = "PendingOpeningStatusReason1", propOrder = {"code", "additionalInformation"})
public class PendingOpeningStatusReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PendingOpeningStatusReason2Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PendingOpeningStatusReason1
	 * PendingOpeningStatusReason1}</li>
	 ...
	 * definition} = "Reason for the pending account opening status."</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getRegistrationStatus
	 * registrationStatus} =
	...
	public static final MMMessageAssociationEnd<PendingOpeningStatusReason1, PendingOpeningStatusReason2Choice> mmCode = new MMMessageAssociationEnd<PendingOpeningStatusReason1, PendingOpeningStatusReason2Choice>() {
		{
			...
			previousVersion_lazy = () -> PendingStatusReason14.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<PendingOpeningStatusReason1, Optional<Max350Text>> mmAdditionalInformation = new MMMessageAttribute<PendingOpeningStatusReason1, Optional<Max350Text>>() {
		{
			...
			definition = "Additional information about the reason for the pending account opening status.";
			previousVersion_lazy = () -> PendingStatusReason14.mmAdditionalInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingOpeningStatusReason1.mmCode, com.tools20022.repository.msg.PendingOpeningStatusReason1.mmAdditionalInformation);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingOpeningStatusReason1";
				definition = "Reason for a pending account opening status.";
				previousVersion_lazy = () -> PendingStatusReason14.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public PendingOpeningStatusReason2Choice getCode() {
		return code;
	}

	public PendingOpeningStatusReason1 setCode(PendingOpeningStatusReason2Choice code) {
	...
	public PendingOpeningStatusReason1 setAdditionalInformation(Max350Text additionalInformation) {
