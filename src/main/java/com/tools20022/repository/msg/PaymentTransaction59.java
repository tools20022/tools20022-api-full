...
import com.tools20022.repository.msg.OriginalTransactionReference21;
...
@XmlType(name = "PaymentTransaction59", propOrder = {"statusIdentification", "originalInstructionIdentification", "originalEndToEndIdentification", "transactionStatus", "statusReasonInformation", "chargesInformation", "acceptanceDateTime",
...
public class PaymentTransaction59 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction59
	 * PaymentTransaction59}</li>
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction69#mmStatusIdentification
	 * PaymentTransaction69.mmStatusIdentification}</li>
	 * </ul>
	 * </li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>> mmStatusIdentification = new MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction59.mmObject();
			isDerived = false;
			xmlTag = "StsId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmStatusIdentification);
			previousVersion_lazy = () -> PaymentTransaction49.mmStatusIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction59 obj) {
			return obj.getStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction49.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction49.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<TransactionIndividualStatus3Code>> mmTransactionStatus = new MMMessageAttribute<PaymentTransaction59, Optional<TransactionIndividualStatus3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmTransactionStatus);
			previousVersion_lazy = () -> PaymentTransaction49.mmTransactionStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionIndividualStatus3Code> getValue(PaymentTransaction59 obj) {
			return obj.getTransactionStatus();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, Optional<TransactionIndividualStatus3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction59, List<StatusReasonInformation9>> mmStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction59, List<StatusReasonInformation9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmStatusReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction49.mmStatusReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<StatusReasonInformation9> getValue(PaymentTransaction59 obj) {
			return obj.getStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, List<StatusReasonInformation9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction59, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction59, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction49.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction59 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<ISODateTime>> mmAcceptanceDateTime = new MMMessageAttribute<PaymentTransaction59, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmAcceptanceDateTime);
			previousVersion_lazy = () -> PaymentTransaction49.mmAcceptanceDateTime;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(PaymentTransaction59 obj) {
			return obj.getAcceptanceDateTime();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>> mmAccountServicerReference = new MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmAccountServicerReference);
			previousVersion_lazy = () -> PaymentTransaction49.mmAccountServicerReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>> mmClearingSystemReference = new MMMessageAttribute<PaymentTransaction59, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction49.mmClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected OriginalTransactionReference21 originalTransactionReference;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction59, Optional<OriginalTransactionReference21>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction59, Optional<OriginalTransactionReference21>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction49.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> OriginalTransactionReference21.mmObject();
		}

		@Override
		public Optional<OriginalTransactionReference21> getValue(PaymentTransaction59 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, Optional<OriginalTransactionReference21> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction69#mmSupplementaryData
	 * PaymentTransaction69.mmSupplementaryData}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction59, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction59, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction59.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction49.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction59 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction59 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction59.mmStatusIdentification, com.tools20022.repository.msg.PaymentTransaction59.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction59.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction59.mmTransactionStatus,
						com.tools20022.repository.msg.PaymentTransaction59.mmStatusReasonInformation, com.tools20022.repository.msg.PaymentTransaction59.mmChargesInformation,
						com.tools20022.repository.msg.PaymentTransaction59.mmAcceptanceDateTime, com.tools20022.repository.msg.PaymentTransaction59.mmAccountServicerReference,
						com.tools20022.repository.msg.PaymentTransaction59.mmClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction59.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction59.mmSupplementaryData);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction59";
				definition = "Provides further details on the original transactions, to which the status report message refers.";
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction69.mmObject());
				previousVersion_lazy = () -> PaymentTransaction49.mmObject();
			}
		});
	...
	public PaymentTransaction59 setStatusIdentification(Max35Text statusIdentification) {
	...
	public PaymentTransaction59 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction59 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction59 setTransactionStatus(TransactionIndividualStatus3Code transactionStatus) {
	...
	public PaymentTransaction59 setStatusReasonInformation(List<StatusReasonInformation9> statusReasonInformation) {
	...
	public PaymentTransaction59 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction59 setAcceptanceDateTime(ISODateTime acceptanceDateTime) {
	...
	public PaymentTransaction59 setAccountServicerReference(Max35Text accountServicerReference) {
	...
	public PaymentTransaction59 setClearingSystemReference(Max35Text clearingSystemReference) {
		this.clearingSystemReference = clearingSystemReference;
		return this;
	}

	public Optional<OriginalTransactionReference21> getOriginalTransactionReference() {
		return originalTransactionReference == null ? Optional.empty() : Optional.of(originalTransactionReference);
	}

	public PaymentTransaction59 setOriginalTransactionReference(OriginalTransactionReference21 originalTransactionReference) {
	...
	public PaymentTransaction59 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
