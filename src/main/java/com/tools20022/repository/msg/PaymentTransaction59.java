...
public class PaymentTransaction59 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction59.mmStatusIdentification, PaymentTransaction59.mmOriginalInstructionIdentification, PaymentTransaction59.mmOriginalEndToEndIdentification,
						PaymentTransaction59.mmTransactionStatus, PaymentTransaction59.mmStatusReasonInformation, PaymentTransaction59.mmChargesInformation, PaymentTransaction59.mmAcceptanceDateTime,
						PaymentTransaction59.mmAccountServicerReference, PaymentTransaction59.mmClearingSystemReference, PaymentTransaction59.mmOriginalTransactionReference, PaymentTransaction59.mmSupplementaryData);
