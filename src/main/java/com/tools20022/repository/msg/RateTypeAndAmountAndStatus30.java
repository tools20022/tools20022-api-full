...
public class RateTypeAndAmountAndStatus30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus30.mmRateType, RateTypeAndAmountAndStatus30.mmAmount, RateTypeAndAmountAndStatus30.mmRateStatus);
