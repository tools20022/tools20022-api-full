 ...
 * <li>{@linkplain com.tools20022.repository.msg.LineItemDetails8#ProductName
 ...
 * <li>{@linkplain com.tools20022.repository.msg.LineItemDetails8#OrderedAmount
 ...
 * <li>{@linkplain com.tools20022.repository.msg.LineItemDetails8#PendingAmount
...
public class LineItemDetails8 {
	...
	public static final MMMessageAttribute LineItemIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.LineItemIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ProductName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.ProductName);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max70Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd ProductIdentifier = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.ProductIdentifier);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd ProductCharacteristics = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.ProductCharacteristics);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd ProductCategory = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.ProductCategory);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OrderedQuantity = new MMMessageAssociationEnd() {
		{
			...
			definition = "Quantity ordered for a line as indicated in the baseline.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.OrderedQuantity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AcceptedQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.AcceptedQuantity);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> Quantity4.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd OutstandingQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.OutstandingQuantity);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> Quantity4.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PendingQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.PendingQuantity);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> Quantity4.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd QuantityTolerance = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.QuantityTolerance);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OrderedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.OrderedAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AcceptedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.AcceptedAmount);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> CurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAttribute OutstandingAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.OutstandingAmount);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> CurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAttribute PendingAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.PendingAmount);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> CurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd PriceTolerance = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails12.PriceTolerance);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PercentageTolerance1.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItemDetails8.LineItemIdentification, com.tools20022.repository.msg.LineItemDetails8.ProductName,
						com.tools20022.repository.msg.LineItemDetails8.ProductIdentifier, com.tools20022.repository.msg.LineItemDetails8.ProductCharacteristics, com.tools20022.repository.msg.LineItemDetails8.ProductCategory,
						com.tools20022.repository.msg.LineItemDetails8.OrderedQuantity, com.tools20022.repository.msg.LineItemDetails8.AcceptedQuantity, com.tools20022.repository.msg.LineItemDetails8.OutstandingQuantity,
						com.tools20022.repository.msg.LineItemDetails8.PendingQuantity, com.tools20022.repository.msg.LineItemDetails8.QuantityTolerance, com.tools20022.repository.msg.LineItemDetails8.OrderedAmount,
						com.tools20022.repository.msg.LineItemDetails8.AcceptedAmount, com.tools20022.repository.msg.LineItemDetails8.OutstandingAmount, com.tools20022.repository.msg.LineItemDetails8.PendingAmount,
						com.tools20022.repository.msg.LineItemDetails8.PriceTolerance);
