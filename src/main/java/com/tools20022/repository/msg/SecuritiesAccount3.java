...
public class SecuritiesAccount3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesAccount3.Identification, com.tools20022.repository.msg.SecuritiesAccount3.Type, com.tools20022.repository.msg.SecuritiesAccount3.Name);
