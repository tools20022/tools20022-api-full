...
public class AccountSubLevel7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountSubLevel7.mmAccountIdentification, AccountSubLevel7.mmAccountOwner, AccountSubLevel7.mmAccountServicer, AccountSubLevel7.mmBeneficialOwner,
						AccountSubLevel7.mmBalanceForAccount, AccountSubLevel7.mmAccountSubLevel8, AccountSubLevel7.mmAccountSubLevel8Difference, AccountSubLevel7.mmAgent, AccountSubLevel7.mmSupplementaryData);
