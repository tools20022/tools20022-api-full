...
@XmlType(name = "AccountSubLevel7", propOrder = {"accountIdentification", "accountOwner", "accountServicer", "beneficialOwner", "balanceForAccount", "accountSubLevel8", "accountSubLevel8Difference", "agent", "supplementaryData"})
public class AccountSubLevel7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, SecuritiesAccount19> mmAccountIdentification = new MMMessageAssociationEnd<AccountSubLevel7, SecuritiesAccount19>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel7.mmObject();
			isDerived = false;
			xmlTag = "AcctId";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmAccountIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount19 getValue(AccountSubLevel7 obj) {
			return obj.getAccountIdentification();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, SecuritiesAccount19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountSubLevel7, PartyIdentification100> mmAccountOwner = new MMMessageAttribute<AccountSubLevel7, PartyIdentification100>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PartyIdentification100 getValue(AccountSubLevel7 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, PartyIdentification100 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountSubLevel7, PartyIdentification100> mmAccountServicer = new MMMessageAttribute<AccountSubLevel7, PartyIdentification100>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel7.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmAccountServicer);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> PartyIdentification100.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<BeneficialOwner2>> mmBeneficialOwner = new MMMessageAssociationEnd<AccountSubLevel7, List<BeneficialOwner2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmBeneficialOwner);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<BeneficialOwner2> getValue(AccountSubLevel7 obj) {
			return obj.getBeneficialOwner();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<BeneficialOwner2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<AggregateHoldingBalance1>> mmBalanceForAccount = new MMMessageAssociationEnd<AccountSubLevel7, List<AggregateHoldingBalance1>>() {
		{
		...
		@Override
		public List<AggregateHoldingBalance1> getValue(AccountSubLevel7 obj) {
			return obj.getBalanceForAccount();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<AggregateHoldingBalance1> value) {
			obj.setBalanceForAccount(value);
		}
	};
	@XmlElement(name = "AcctSubLvl8")
	protected List<AccountSubLevel8> accountSubLevel8;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<AccountSubLevel8>> mmAccountSubLevel8 = new MMMessageAssociationEnd<AccountSubLevel7, List<AccountSubLevel8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmAccountSubLevel8);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> AccountSubLevel8.mmObject();
		}

		@Override
		public List<AccountSubLevel8> getValue(AccountSubLevel7 obj) {
			return obj.getAccountSubLevel8();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<AccountSubLevel8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<AggregateHoldingBalance2>> mmAccountSubLevel8Difference = new MMMessageAssociationEnd<AccountSubLevel7, List<AggregateHoldingBalance2>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesBalance.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel7.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmAccountSubLevel8Difference);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<AggregateHoldingBalance2> getValue(AccountSubLevel7 obj) {
			return obj.getAccountSubLevel8Difference();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<AggregateHoldingBalance2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<Intermediary29>> mmAgent = new MMMessageAssociationEnd<AccountSubLevel7, List<Intermediary29>>() {
		{
		...
		@Override
		public List<Intermediary29> getValue(AccountSubLevel7 obj) {
			return obj.getAgent();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<Intermediary29> value) {
			obj.setAgent(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel7, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<AccountSubLevel7, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel7.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel17.mmSupplementaryData);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(AccountSubLevel7 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(AccountSubLevel7 obj, List<SupplementaryData1> value) {
	...
	public AccountSubLevel7 setAccountIdentification(SecuritiesAccount19 accountIdentification) {
	...
	public AccountSubLevel7 setAccountOwner(PartyIdentification100 accountOwner) {
	...
	public AccountSubLevel7 setAccountServicer(PartyIdentification100 accountServicer) {
	...
	public AccountSubLevel7 setBeneficialOwner(List<BeneficialOwner2> beneficialOwner) {
	...
	public AccountSubLevel7 setBalanceForAccount(List<AggregateHoldingBalance1> balanceForAccount) {
	...
	public AccountSubLevel7 setAccountSubLevel8(List<AccountSubLevel8> accountSubLevel8) {
	...
	public AccountSubLevel7 setAccountSubLevel8Difference(List<AggregateHoldingBalance2> accountSubLevel8Difference) {
	...
	public AccountSubLevel7 setAgent(List<Intermediary29> agent) {
	...
	public AccountSubLevel7 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
