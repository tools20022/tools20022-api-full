...
public class PartyIdentification1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification1.Name, com.tools20022.repository.msg.PartyIdentification1.PostalAddress,
						com.tools20022.repository.msg.PartyIdentification1.Identification);
