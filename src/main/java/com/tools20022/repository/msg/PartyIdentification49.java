...
public class PartyIdentification49 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification49.mmIdentification, PartyIdentification49.mmProcessingIdentification, PartyIdentification49.mmAdditionalInformation,
						PartyIdentification49.mmAlternateIdentification);
	...
	public void setIdentification(PartyIdentification53Choice identification) {
