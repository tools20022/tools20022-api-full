...
public class AdditionalParameters18 {
	...
	public static final MMMessageAttribute PreConfirmation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters24.PreConfirmation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlement = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters24.PartialSettlement);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PreviousPartialConfirmationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters24.PreviousPartialConfirmationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters18.PreConfirmation, com.tools20022.repository.msg.AdditionalParameters18.PartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters18.PreviousPartialConfirmationIdentification);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesFinancingConfirmationV04.AdditionalParameters,
						com.tools20022.repository.area.sese.SecuritiesFinancingConfirmationV05.AdditionalParameters);
