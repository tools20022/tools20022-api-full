 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Statement60 Statement60}</li>
 * </ul>
 * </li>
...
public class Statement43 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, Optional<Number3Choice>> mmReportNumber = new MMMessageAttribute<Statement43, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmReportNumber);
			previousVersion_lazy = () -> Statement15.mmReportNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number3Choice> getValue(Statement43 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(Statement43 obj, Optional<Number3Choice> value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Statement60#mmQueryReference
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, Optional<Max35Text>> mmQueryReference = new MMMessageAttribute<Statement43, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "QryRef";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmQueryReference);
			previousVersion_lazy = () -> Statement15.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(Statement43 obj) {
			return obj.getQueryReference();
		}

		@Override
		public void setValue(Statement43 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, Optional<Max35Text>> mmStatementIdentification = new MMMessageAttribute<Statement43, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "StmtId";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmStatementIdentification);
			previousVersion_lazy = () -> Statement15.mmStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Statement60#mmStatementPeriod
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, Period2Choice> mmStatementPeriod = new MMMessageAttribute<Statement43, Period2Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "StmtPrd";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmStatementPeriod);
			previousVersion_lazy = () -> Statement15.mmStatementPeriod;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Period2Choice getValue(Statement43 obj) {
			return obj.getStatementPeriod();
		}

		@Override
		public void setValue(Statement43 obj, Period2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, Optional<Frequency25Choice>> mmFrequency = new MMMessageAttribute<Statement43, Optional<Frequency25Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmFrequency);
			previousVersion_lazy = () -> Statement15.mmFrequency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Frequency25Choice> getValue(Statement43 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(Statement43 obj, Optional<Frequency25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement43, Optional<UpdateType15Choice>> mmUpdateType = new MMMessageAssociationEnd<Statement43, Optional<UpdateType15Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmUpdateType);
			previousVersion_lazy = () -> Statement15.mmUpdateType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<UpdateType15Choice> getValue(Statement43 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(Statement43 obj, Optional<UpdateType15Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement43, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<Statement43, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement43.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
			...
			nextVersions_lazy = () -> Arrays.asList(Statement60.mmActivityIndicator);
			previousVersion_lazy = () -> Statement15.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(Statement43 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(Statement43 obj, YesNoIndicator value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementPostingReportV05.mmStatementGeneralDetails, IntraPositionMovementPostingReportV06.mmStatementGeneralDetails);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forStatement43);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Statement43";
				definition = "Characteristics of the statement.";
				nextVersions_lazy = () -> Arrays.asList(Statement60.mmObject());
	...
	public Statement43 setReportNumber(Number3Choice reportNumber) {
	...
	public Statement43 setQueryReference(Max35Text queryReference) {
	...
	public Statement43 setStatementIdentification(Max35Text statementIdentification) {
	...
	public Statement43 setStatementPeriod(Period2Choice statementPeriod) {
	...
	public Statement43 setFrequency(Frequency25Choice frequency) {
	...
	public Statement43 setUpdateType(UpdateType15Choice updateType) {
	...
	public Statement43 setActivityIndicator(YesNoIndicator activityIndicator) {
