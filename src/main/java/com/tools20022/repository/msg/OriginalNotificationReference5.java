...
public class OriginalNotificationReference5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalNotificationReference5.mmAccount, OriginalNotificationReference5.mmAccountOwner, OriginalNotificationReference5.mmAccountServicer,
						OriginalNotificationReference5.mmRelatedAccount, OriginalNotificationReference5.mmTotalAmount, OriginalNotificationReference5.mmExpectedValueDate, OriginalNotificationReference5.mmDebtor,
						OriginalNotificationReference5.mmDebtorAgent, OriginalNotificationReference5.mmIntermediaryAgent, OriginalNotificationReference5.mmOriginalItemAndStatus);
	...
	public void setOriginalItemAndStatus(List<com.tools20022.repository.msg.OriginalItemAndStatus4> originalItemAndStatus) {
