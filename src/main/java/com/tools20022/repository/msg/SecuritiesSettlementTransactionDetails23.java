...
public class SecuritiesSettlementTransactionDetails23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails23.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails23.mmLinkages,
						SecuritiesSettlementTransactionDetails23.mmTradeDetails, SecuritiesSettlementTransactionDetails23.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails23.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails23.mmSettlementParameters, SecuritiesSettlementTransactionDetails23.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails23.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails23.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails23.mmCashParties,
						SecuritiesSettlementTransactionDetails23.mmSettlementAmount, SecuritiesSettlementTransactionDetails23.mmOtherAmounts, SecuritiesSettlementTransactionDetails23.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails23.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails23.mmSupplementaryData);
