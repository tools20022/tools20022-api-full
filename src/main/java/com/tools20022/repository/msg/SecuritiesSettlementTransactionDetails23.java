...
public class SecuritiesSettlementTransactionDetails23 {
	...
	public static final MMMessageAssociationEnd mmSettlementTypeAndAdditionalParameters = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesSettlementTransactionDetails23.mmObject();
			isDerived = false;
	...
	public QuantityAndAccount54 getQuantityAndAccountDetails() {
		return quantityAndAccountDetails;
	}

	public void setQuantityAndAccountDetails(com.tools20022.repository.msg.QuantityAndAccount54 quantityAndAccountDetails) {
