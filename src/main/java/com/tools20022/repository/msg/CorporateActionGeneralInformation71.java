...
import com.tools20022.repository.msg.FinancialInstrumentAttributes50;
 ...
 * CorporateActionGeneralInformation71.mmCorporateActionEventIdentification}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation71", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "underlyingSecurity"})
public class CorporateActionGeneralInformation71 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation71, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation71, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation71.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation88.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation55.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation71 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation71 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation71, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation71, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation88.mmOfficialCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation55.mmOfficialCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation71 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation71 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation71, CorporateActionEventType11Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation71, CorporateActionEventType11Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation88.mmEventType);
			previousVersion_lazy = () -> CorporateActionGeneralInformation55.mmEventType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionEventType11Choice getValue(CorporateActionGeneralInformation71 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation71 obj, CorporateActionEventType11Choice value) {
			obj.setEventType(value);
		}
	};
	@XmlElement(name = "UndrlygScty")
	protected FinancialInstrumentAttributes50 underlyingSecurity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation71, Optional<FinancialInstrumentAttributes50>> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation71, Optional<FinancialInstrumentAttributes50>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation88.mmUnderlyingSecurity);
			previousVersion_lazy = () -> CorporateActionGeneralInformation55.mmUnderlyingSecurity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentAttributes50.mmObject();
		}

		@Override
		public Optional<FinancialInstrumentAttributes50> getValue(CorporateActionGeneralInformation71 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation71 obj, Optional<FinancialInstrumentAttributes50> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation71.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation71.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation71.mmEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation71.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionV05.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation71,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation71,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation71);
				...
				name = "CorporateActionGeneralInformation71";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation88.mmObject());
				previousVersion_lazy = () -> CorporateActionGeneralInformation55.mmObject();
			}
		});
	...
	public CorporateActionGeneralInformation71 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation71 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation71 setEventType(CorporateActionEventType11Choice eventType) {
		this.eventType = Objects.requireNonNull(eventType);
		return this;
	}

	public Optional<FinancialInstrumentAttributes50> getUnderlyingSecurity() {
		return underlyingSecurity == null ? Optional.empty() : Optional.of(underlyingSecurity);
	}

	public CorporateActionGeneralInformation71 setUnderlyingSecurity(FinancialInstrumentAttributes50 underlyingSecurity) {
