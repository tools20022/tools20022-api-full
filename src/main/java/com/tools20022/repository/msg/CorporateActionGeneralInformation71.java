...
public class CorporateActionGeneralInformation71 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation71.mmCorporateActionEventIdentification, CorporateActionGeneralInformation71.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation71.mmEventType, CorporateActionGeneralInformation71.mmUnderlyingSecurity);
