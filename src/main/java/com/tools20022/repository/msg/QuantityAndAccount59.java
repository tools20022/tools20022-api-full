...
public class QuantityAndAccount59 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount59.mmDenominationChoice, QuantityAndAccount59.mmAccountOwner, QuantityAndAccount59.mmCashAccount, QuantityAndAccount59.mmSafekeepingPlace,
						QuantityAndAccount59.mmQuantityBreakdown);
