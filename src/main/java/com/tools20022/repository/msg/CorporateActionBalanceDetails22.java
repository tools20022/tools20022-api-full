...
public class CorporateActionBalanceDetails22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionBalanceDetails22.mmConfirmedBalance, CorporateActionBalanceDetails22.mmTotalEligibleBalance, CorporateActionBalanceDetails22.mmBlockedBalance,
						CorporateActionBalanceDetails22.mmBorrowedBalance, CorporateActionBalanceDetails22.mmCollateralInBalance, CorporateActionBalanceDetails22.mmCollateralOutBalance, CorporateActionBalanceDetails22.mmOnLoanBalance,
						CorporateActionBalanceDetails22.mmPendingDeliveryBalance, CorporateActionBalanceDetails22.mmPendingReceiptBalance, CorporateActionBalanceDetails22.mmOutForRegistrationBalance,
						CorporateActionBalanceDetails22.mmSettlementPositionBalance, CorporateActionBalanceDetails22.mmStreetPositionBalance, CorporateActionBalanceDetails22.mmTradeDatePositionBalance,
						CorporateActionBalanceDetails22.mmInTransshipmentBalance, CorporateActionBalanceDetails22.mmRegisteredBalance, CorporateActionBalanceDetails22.mmAffectedBalance, CorporateActionBalanceDetails22.mmUnaffectedBalance);
