...
public class GenericIdentification27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification27.Identification, com.tools20022.repository.msg.GenericIdentification27.SchemeName,
						com.tools20022.repository.msg.GenericIdentification27.Issuer);
