...
public class OriginalPaymentInstruction6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalPaymentInstruction6.mmOriginalPaymentInformationIdentification, OriginalPaymentInstruction6.mmOriginalNumberOfTransactions, OriginalPaymentInstruction6.mmOriginalControlSum,
						OriginalPaymentInstruction6.mmPaymentInformationStatus, OriginalPaymentInstruction6.mmStatusReasonInformation, OriginalPaymentInstruction6.mmNumberOfTransactionsPerStatus,
						OriginalPaymentInstruction6.mmTransactionInformationAndStatus);
