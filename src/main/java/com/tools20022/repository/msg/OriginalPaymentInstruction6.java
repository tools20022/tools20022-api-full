 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.OriginalPaymentInstruction6#OriginalNumberOfTransactions
 * OriginalPaymentInstruction6.OriginalNumberOfTransactions}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.OriginalPaymentInstruction6#OriginalControlSum
 * OriginalPaymentInstruction6.OriginalControlSum}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.OriginalPaymentInstruction6#NumberOfTransactionsPerStatus
 * OriginalPaymentInstruction6.NumberOfTransactionsPerStatus}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.pain.CustomerPaymentStatusReportV05#OriginalPaymentInformationAndStatus
 * CustomerPaymentStatusReportV05.OriginalPaymentInformationAndStatus}</li>
 * </ul>
 * </li>
 * <li>
...
public class OriginalPaymentInstruction6 {
	...
	public static final MMMessageAttribute OriginalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OriginalPaymentInstruction6.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.OriginalPaymentInformationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalNumberOfTransactions = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.OriginalNumberOfTransactions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalControlSum = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.OriginalControlSum);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentInformationStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.PaymentInformationStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StatusReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.StatusReasonInformation);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd NumberOfTransactionsPerStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.NumberOfTransactionsPerStatus);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd TransactionInformationAndStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction12.TransactionInformationAndStatus);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction6.OriginalPaymentInformationIdentification,
						com.tools20022.repository.msg.OriginalPaymentInstruction6.OriginalNumberOfTransactions, com.tools20022.repository.msg.OriginalPaymentInstruction6.OriginalControlSum,
						com.tools20022.repository.msg.OriginalPaymentInstruction6.PaymentInformationStatus, com.tools20022.repository.msg.OriginalPaymentInstruction6.StatusReasonInformation,
						com.tools20022.repository.msg.OriginalPaymentInstruction6.NumberOfTransactionsPerStatus, com.tools20022.repository.msg.OriginalPaymentInstruction6.TransactionInformationAndStatus);
				trace_lazy = () -> Payment.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerPaymentStatusReportV05.OriginalPaymentInformationAndStatus);
