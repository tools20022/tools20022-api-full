...
public class TransferOut11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferOut11.mmRequestedTransferDate, TransferOut11.mmMasterReference, TransferOut11.mmTransferAndReferences, TransferOut11.mmAccountDetails, TransferOut11.mmSettlementDetails,
						TransferOut11.mmExtension);
