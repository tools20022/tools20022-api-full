...
public class CardPaymentEnvironment6 {
	...
	public static final MMMessageAssociationEnd mmAcquirer = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CardPaymentEnvironment6.mmObject();
			isDerived = false;
			xmlTag = "Acqrr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment6.mmAcquirer, CardPaymentEnvironment6.mmMerchant, CardPaymentEnvironment6.mmPOI, CardPaymentEnvironment6.mmCard, CardPaymentEnvironment6.mmCardholder);
	...
	public Cardholder2 getCardholder() {
		return cardholder;
	}

	public void setCardholder(com.tools20022.repository.msg.Cardholder2 cardholder) {
