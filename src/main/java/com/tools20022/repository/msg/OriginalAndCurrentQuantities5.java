...
public class OriginalAndCurrentQuantities5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalAndCurrentQuantities5.mmShortLongPosition, OriginalAndCurrentQuantities5.mmFaceAmount, OriginalAndCurrentQuantities5.mmAmortisedValue);
