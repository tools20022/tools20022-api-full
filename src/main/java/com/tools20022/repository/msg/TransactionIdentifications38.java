...
public class TransactionIdentifications38 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications38.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications38.mmAccountOwnerTransactionIdentification, TransactionIdentifications38.mmAccountServicerTransactionIdentification,
						TransactionIdentifications38.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications38.mmProcessorTransactionIdentification, TransactionIdentifications38.mmCommonIdentification,
						TransactionIdentifications38.mmNettingServiceProviderIdentification);
