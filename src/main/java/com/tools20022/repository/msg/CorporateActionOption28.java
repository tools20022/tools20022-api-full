 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOptionNumber1Rule#forCorporateActionOption28
 * ConstraintOptionNumber1Rule.forCorporateActionOption28}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOptionNumber2Rule#forCorporateActionOption28
 * ConstraintOptionNumber2Rule.forCorporateActionOption28}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionOption28", propOrder = {"optionNumber", "optionType", "instructedOrQuantityToReceive"})
public class CorporateActionOption28 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption28, OptionNumber1Choice> mmOptionNumber = new MMMessageAssociationEnd<CorporateActionOption28, OptionNumber1Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption28.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
		...
		@Override
		public OptionNumber1Choice getValue(CorporateActionOption28 obj) {
			return obj.getOptionNumber();
		}

		@Override
		public void setValue(CorporateActionOption28 obj, OptionNumber1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption28, CorporateActionOption6Choice> mmOptionType = new MMMessageAssociationEnd<CorporateActionOption28, CorporateActionOption6Choice>() {
		{
		...
		@Override
		public CorporateActionOption6Choice getValue(CorporateActionOption28 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(CorporateActionOption28 obj, CorporateActionOption6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption28, InstructedOrQuantityToReceive2Choice> mmInstructedOrQuantityToReceive = new MMMessageAssociationEnd<CorporateActionOption28, InstructedOrQuantityToReceive2Choice>() {
		{
		...
		@Override
		public InstructedOrQuantityToReceive2Choice getValue(CorporateActionOption28 obj) {
			return obj.getInstructedOrQuantityToReceive();
		}

		@Override
		public void setValue(CorporateActionOption28 obj, InstructedOrQuantityToReceive2Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption28.mmOptionNumber, com.tools20022.repository.msg.CorporateActionOption28.mmOptionType,
						com.tools20022.repository.msg.CorporateActionOption28.mmInstructedOrQuantityToReceive);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOptionNumber1Rule.forCorporateActionOption28,
						com.tools20022.repository.constraints.ConstraintOptionNumber2Rule.forCorporateActionOption28);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption28";
				definition = "Provides information about the corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionOption43.mmObject());
			}
		});
	...
	public CorporateActionOption28 setOptionNumber(OptionNumber1Choice optionNumber) {
	...
	public CorporateActionOption28 setOptionType(CorporateActionOption6Choice optionType) {
	...
	public CorporateActionOption28 setInstructedOrQuantityToReceive(InstructedOrQuantityToReceive2Choice instructedOrQuantityToReceive) {
