...
public class CorporateActionOption28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption28.OptionNumber, com.tools20022.repository.msg.CorporateActionOption28.OptionType,
						com.tools20022.repository.msg.CorporateActionOption28.InstructedOrQuantityToReceive);
