...
public class CorporateActionOption28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption28.mmOptionNumber, CorporateActionOption28.mmOptionType, CorporateActionOption28.mmInstructedOrQuantityToReceive);
