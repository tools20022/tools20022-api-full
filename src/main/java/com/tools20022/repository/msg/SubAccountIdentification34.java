...
public class SubAccountIdentification34 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification34.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwner";
			definition = "Party that legally owns the account.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification44.mmAccountOwner);
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification30.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification44.mmSafekeepingAccount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification30.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmActivityIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification44.mmActivityIndicator);
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification30.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification44.mmFinancialInstrumentDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification30.mmFinancialInstrumentDetails;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV05.mmSubAccountDetails);
	...
	public void setFinancialInstrumentDetails(List<com.tools20022.repository.msg.FinancialInstrumentDetails17> financialInstrumentDetails) {
