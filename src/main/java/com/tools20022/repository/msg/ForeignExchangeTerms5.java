...
public class ForeignExchangeTerms5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms5.mmUnitCurrency, ForeignExchangeTerms5.mmQuotedCurrency, ForeignExchangeTerms5.mmExchangeRate, ForeignExchangeTerms5.mmQuotationDate,
						ForeignExchangeTerms5.mmQuotingInstitution);
