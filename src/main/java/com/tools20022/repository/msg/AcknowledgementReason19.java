...
public class AcknowledgementReason19 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason19.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason19.mmCode, AcknowledgementReason19.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason22Choice code) {
		this.code = code;
	}
