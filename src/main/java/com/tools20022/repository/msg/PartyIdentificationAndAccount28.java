...
public class PartyIdentificationAndAccount28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount28.mmIdentification, PartyIdentificationAndAccount28.mmAlternateIdentification, PartyIdentificationAndAccount28.mmCountryOfResidence,
						PartyIdentificationAndAccount28.mmSafekeepingAccount, PartyIdentificationAndAccount28.mmProcessingIdentification, PartyIdentificationAndAccount28.mmAdditionalInformation);
