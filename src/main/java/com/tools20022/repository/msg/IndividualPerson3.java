 ...
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson3#mmGivenName
 * IndividualPerson3.mmGivenName}</li>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson3#mmNamePrefix
 * IndividualPerson3.mmNamePrefix}</li>
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson3#mmNameSuffix
 ...
 * <li>{@linkplain com.tools20022.repository.msg.IndividualPerson3#mmBirthDate
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintBirthDateGuideline#forIndividualPerson3
 * ConstraintBirthDateGuideline.forIndividualPerson3}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSocialSecurityNumberGuideline#forIndividualPerson3
 * ConstraintSocialSecurityNumberGuideline.forIndividualPerson3}</li>
 * </ul>
 * </li>
 * <li>
...
public class IndividualPerson3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Max35Text> mmName = new MMMessageAttribute<IndividualPerson3, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PersonName.mmBirthName;
			componentContext_lazy = () -> com.tools20022.repository.msg.IndividualPerson3.mmObject();
			isDerived = false;
			xmlTag = "Nm";
		...
		@Override
		public Max35Text getValue(IndividualPerson3 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(IndividualPerson3 obj, Max35Text value) {
			obj.setName(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Max35Text> mmGivenName = new MMMessageAttribute<IndividualPerson3, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Optional<NamePrefix1Code>> mmNamePrefix = new MMMessageAttribute<IndividualPerson3, Optional<NamePrefix1Code>>() {
		{
		...
		@Override
		public Optional<NamePrefix1Code> getValue(IndividualPerson3 obj) {
			return obj.getNamePrefix();
		}

		@Override
		public void setValue(IndividualPerson3 obj, Optional<NamePrefix1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Optional<Max35Text>> mmNameSuffix = new MMMessageAttribute<IndividualPerson3, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(IndividualPerson3 obj) {
			return obj.getNameSuffix();
		}

		@Override
		public void setValue(IndividualPerson3 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Optional<GenderCode>> mmGender = new MMMessageAttribute<IndividualPerson3, Optional<GenderCode>>() {
		{
		...
		@Override
		public Optional<GenderCode> getValue(IndividualPerson3 obj) {
			return obj.getGender();
		}

		@Override
		public void setValue(IndividualPerson3 obj, Optional<GenderCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Optional<ISODate>> mmBirthDate = new MMMessageAttribute<IndividualPerson3, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(IndividualPerson3 obj) {
			return obj.getBirthDate();
		}

		@Override
		public void setValue(IndividualPerson3 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IndividualPerson3, Optional<Max35Text>> mmSocialSecurityNumber = new MMMessageAttribute<IndividualPerson3, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IndividualPerson3.mmName, com.tools20022.repository.msg.IndividualPerson3.mmGivenName, com.tools20022.repository.msg.IndividualPerson3.mmNamePrefix,
						com.tools20022.repository.msg.IndividualPerson3.mmNameSuffix, com.tools20022.repository.msg.IndividualPerson3.mmGender, com.tools20022.repository.msg.IndividualPerson3.mmBirthDate,
						com.tools20022.repository.msg.IndividualPerson3.mmSocialSecurityNumber);
				trace_lazy = () -> Person.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintBirthDateGuideline.forIndividualPerson3,
						com.tools20022.repository.constraints.ConstraintSocialSecurityNumberGuideline.forIndividualPerson3);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "IndividualPerson3";
	...
	public IndividualPerson3 setName(Max35Text name) {
	...
	public IndividualPerson3 setGivenName(Max35Text givenName) {
	...
	public IndividualPerson3 setNamePrefix(NamePrefix1Code namePrefix) {
	...
	public IndividualPerson3 setNameSuffix(Max35Text nameSuffix) {
	...
	public IndividualPerson3 setGender(GenderCode gender) {
		this.gender = gender;
		return this;
	}
	...
	public IndividualPerson3 setBirthDate(ISODate birthDate) {
	...
	public IndividualPerson3 setSocialSecurityNumber(Max35Text socialSecurityNumber) {
