 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.AccountReport19
 * AccountReport19}</li>
 * </ul>
 */
...
public class AccountReport22 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmReportPagination = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmReportPagination;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmElectronicSequenceNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmElectronicSequenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmLegalSequenceNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmLegalSequenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Number.mmObject();
		}
	...
	public static final MMMessageAttribute mmCreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmCreationDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmFromToDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmFromToDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmCopyDuplicateIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmCopyDuplicateIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmReportingSource = new MMMessageAssociationEnd() {
		{
			...
			definition = "Specifies the application used to generate the reporting.";
			previousVersion_lazy = () -> AccountReport19.mmReportingSource;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountReport19#mmAccount
	...
	public static final MMMessageAssociationEnd mmAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmRelatedAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmRelatedAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountReport19#mmInterest
	...
	public static final MMMessageAssociationEnd mmInterest = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmInterest;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountReport19#mmBalance
	...
	public static final MMMessageAssociationEnd mmBalance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmBalance;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransactionsSummary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmTransactionsSummary;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.AccountReport19#mmEntry
	...
	public static final MMMessageAssociationEnd mmEntry = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmEntry;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReportInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AccountReport19.mmAdditionalReportInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> AccountReport19.mmObject();
			}
		});
	...
	public AccountReport22 setReportPagination(com.tools20022.repository.msg.Pagination1 reportPagination) {
	...
	public AccountReport22 setFromToDate(com.tools20022.repository.msg.DateTimePeriod1 fromToDate) {
	...
	public AccountReport22 setAccount(com.tools20022.repository.msg.CashAccount36 account) {
	...
	public AccountReport22 setRelatedAccount(com.tools20022.repository.msg.CashAccount24 relatedAccount) {
	...
	public AccountReport22 setInterest(List<com.tools20022.repository.msg.AccountInterest4> interest) {
	...
	public AccountReport22 setBalance(List<com.tools20022.repository.msg.CashBalance8> balance) {
	...
	public AccountReport22 setTransactionsSummary(com.tools20022.repository.msg.TotalTransactions6 transactionsSummary) {
	...
	public AccountReport22 setEntry(List<com.tools20022.repository.msg.ReportEntry9> entry) {
