...
public class Statement50 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement50, Optional<RestrictedFINXMax16Text>> mmCounterpartyPortfolioTransferNotificationReference = new MMMessageAttribute<Statement50, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(Statement50 obj) {
			return obj.getCounterpartyPortfolioTransferNotificationReference();
		}

		@Override
		public void setValue(Statement50 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement50, Optional<Number3Choice>> mmReportNumber = new MMMessageAttribute<Statement50, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement50.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
		...
		@Override
		public Optional<Number3Choice> getValue(Statement50 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(Statement50 obj, Optional<Number3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement50, Optional<RestrictedFINXMax16Text>> mmStatementIdentification = new MMMessageAttribute<Statement50, Optional<RestrictedFINXMax16Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement50.mmObject();
			isDerived = false;
			xmlTag = "StmtId";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement50, DateAndDateTimeChoice> mmStatementDateTime = new MMMessageAttribute<Statement50, DateAndDateTimeChoice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement50.mmObject();
			isDerived = false;
			xmlTag = "StmtDtTm";
		...
		@Override
		public DateAndDateTimeChoice getValue(Statement50 obj) {
			return obj.getStatementDateTime();
		}

		@Override
		public void setValue(Statement50 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Statement50, Optional<UpdateType16Choice>> mmUpdateType = new MMMessageAssociationEnd<Statement50, Optional<UpdateType16Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement50.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
		...
		@Override
		public Optional<UpdateType16Choice> getValue(Statement50 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(Statement50 obj, Optional<UpdateType16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Statement50, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<Statement50, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Statement50.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
		...
		@Override
		public YesNoIndicator getValue(Statement50 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(Statement50 obj, YesNoIndicator value) {
