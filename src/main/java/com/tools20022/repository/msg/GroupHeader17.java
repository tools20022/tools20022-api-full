...
public class GroupHeader17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader17.mmMessageIdentification, GroupHeader17.mmCreationDateTime, GroupHeader17.mmAuthorisation, GroupHeader17.mmBatchBooking, GroupHeader17.mmNumberOfTransactions,
						GroupHeader17.mmControlSum, GroupHeader17.mmGroupReturn, GroupHeader17.mmTotalReturnedInterbankSettlementAmount, GroupHeader17.mmInterbankSettlementDate, GroupHeader17.mmSettlementInformation,
						GroupHeader17.mmInstructingAgent, GroupHeader17.mmInstructedAgent);
