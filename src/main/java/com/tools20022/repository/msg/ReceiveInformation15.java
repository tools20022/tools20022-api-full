...
@XmlType(name = "ReceiveInformation15", propOrder = {"requestedSettlementDate", "settlementAmount", "stampDuty", "netAmount", "settlementPartiesDetails", "chargeDetails", "commissionDetails", "taxDetails", "foreignExchangeDetails",
...
public class ReceiveInformation15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<ReceiveInformation15, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation15.mmObject();
			isDerived = false;
			xmlTag = "ReqdSttlmDt";
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmRequestedSettlementDate);
			previousVersion_lazy = () -> ReceiveInformation13.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(ReceiveInformation15 obj) {
			return obj.getRequestedSettlementDate();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation15, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmSettlementAmount);
			previousVersion_lazy = () -> ReceiveInformation13.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation15 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation15, Optional<StampDutyType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmStampDuty);
			previousVersion_lazy = () -> ReceiveInformation13.mmStampDuty;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StampDutyType2Code> getValue(ReceiveInformation15 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation15, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmNetAmount);
			previousVersion_lazy = () -> ReceiveInformation13.mmNetAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, Optional<ReceivingPartiesAndAccount9>> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation15, Optional<ReceivingPartiesAndAccount9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmSettlementPartiesDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ReceivingPartiesAndAccount9> getValue(ReceiveInformation15 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<ReceivingPartiesAndAccount9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, List<Charge27>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation15, List<Charge27>>() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmChargeDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmChargeDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charge27> getValue(ReceiveInformation15 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, List<Charge27> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, List<Commission22>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation15, List<Commission22>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmCommissionDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmCommissionDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Commission22> getValue(ReceiveInformation15 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, List<Commission22> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, List<Tax25>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation15, List<Tax25>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmTaxDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmTaxDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Tax25> getValue(ReceiveInformation15 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, List<Tax25> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, List<ForeignExchangeTerms7>> mmForeignExchangeDetails = new MMMessageAssociationEnd<ReceiveInformation15, List<ForeignExchangeTerms7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmForeignExchangeDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmForeignExchangeDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<ForeignExchangeTerms7> getValue(ReceiveInformation15 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, List<ForeignExchangeTerms7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation15, Optional<PhysicalTransferType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmPhysicalTransfer);
			previousVersion_lazy = () -> ReceiveInformation13.mmPhysicalTransfer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(ReceiveInformation15 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation15, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation15, Optional<DeliveryParameters4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmPhysicalTransferDetails);
			previousVersion_lazy = () -> ReceiveInformation13.mmPhysicalTransferDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation15 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<DeliveryParameters4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation15, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<ReceiveInformation15, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation16.mmClientReference);
			previousVersion_lazy = () -> ReceiveInformation13.mmClientReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ReceiveInformation15 obj) {
			return obj.getClientReference();
		}

		@Override
		public void setValue(ReceiveInformation15 obj, Optional<Max35Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation15.mmRequestedSettlementDate, com.tools20022.repository.msg.ReceiveInformation15.mmSettlementAmount,
						com.tools20022.repository.msg.ReceiveInformation15.mmStampDuty, com.tools20022.repository.msg.ReceiveInformation15.mmNetAmount, com.tools20022.repository.msg.ReceiveInformation15.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.ReceiveInformation15.mmChargeDetails, com.tools20022.repository.msg.ReceiveInformation15.mmCommissionDetails, com.tools20022.repository.msg.ReceiveInformation15.mmTaxDetails,
						com.tools20022.repository.msg.ReceiveInformation15.mmForeignExchangeDetails, com.tools20022.repository.msg.ReceiveInformation15.mmPhysicalTransfer,
						com.tools20022.repository.msg.ReceiveInformation15.mmPhysicalTransferDetails, com.tools20022.repository.msg.ReceiveInformation15.mmClientReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutInstructionV06.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation15,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation15, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation15);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public ReceiveInformation15 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public ReceiveInformation15 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation15 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation15 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation15 setSettlementPartiesDetails(ReceivingPartiesAndAccount9 settlementPartiesDetails) {
	...
	public ReceiveInformation15 setChargeDetails(List<Charge27> chargeDetails) {
	...
	public ReceiveInformation15 setCommissionDetails(List<Commission22> commissionDetails) {
	...
	public ReceiveInformation15 setTaxDetails(List<Tax25> taxDetails) {
	...
	public ReceiveInformation15 setForeignExchangeDetails(List<ForeignExchangeTerms7> foreignExchangeDetails) {
	...
	public ReceiveInformation15 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation15 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
	...
	public ReceiveInformation15 setClientReference(Max35Text clientReference) {
