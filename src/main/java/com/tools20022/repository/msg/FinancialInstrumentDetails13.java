...
public class FinancialInstrumentDetails13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails13.mmFinancialInstrumentIdentification, FinancialInstrumentDetails13.mmPriceDetails, FinancialInstrumentDetails13.mmSafekeepingPlace,
						FinancialInstrumentDetails13.mmOpeningBalance, FinancialInstrumentDetails13.mmClosingBalance, FinancialInstrumentDetails13.mmTransaction);
