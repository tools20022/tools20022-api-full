...
public class OriginalTransactionReference23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalTransactionReference23.mmAmount, OriginalTransactionReference23.mmRequestedExecutionDate, OriginalTransactionReference23.mmPaymentTypeInformation,
						OriginalTransactionReference23.mmPaymentMethod, OriginalTransactionReference23.mmRemittanceInformation, OriginalTransactionReference23.mmUltimateDebtor, OriginalTransactionReference23.mmDebtor,
						OriginalTransactionReference23.mmDebtorAccount, OriginalTransactionReference23.mmDebtorAgent, OriginalTransactionReference23.mmCreditorAgent, OriginalTransactionReference23.mmCreditor,
						OriginalTransactionReference23.mmCreditorAccount, OriginalTransactionReference23.mmUltimateCreditor);
