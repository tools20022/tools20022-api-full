 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionRate35#Interest
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionRate35#Spread
...
public class CorporateActionRate35 {
	...
	public static final MMMessageAssociationEnd Interest = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.Interest);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PercentageSought = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.PercentageSought);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RelatedIndex = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.RelatedIndex);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Spread = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.Spread);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateFormat6Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd BidInterval = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.BidInterval);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PreviousFactor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.PreviousFactor);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd NextFactor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.NextFactor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateFormat3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ReinvestmentDiscountRateToMarket = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.ReinvestmentDiscountRateToMarket);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RateFormat6Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute InterestShortfall = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.InterestShortfall);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RealisedLoss = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.RealisedLoss);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> RateAndAmountFormat12Choice.mmObject();
		}
	...
	public static final MMMessageAttribute DeclaredRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate43.DeclaredRate);
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> RateAndAmountFormat12Choice.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate35.Interest, com.tools20022.repository.msg.CorporateActionRate35.PercentageSought,
						com.tools20022.repository.msg.CorporateActionRate35.RelatedIndex, com.tools20022.repository.msg.CorporateActionRate35.Spread, com.tools20022.repository.msg.CorporateActionRate35.BidInterval,
						com.tools20022.repository.msg.CorporateActionRate35.PreviousFactor, com.tools20022.repository.msg.CorporateActionRate35.NextFactor,
						com.tools20022.repository.msg.CorporateActionRate35.ReinvestmentDiscountRateToMarket, com.tools20022.repository.msg.CorporateActionRate35.InterestShortfall,
						com.tools20022.repository.msg.CorporateActionRate35.RealisedLoss, com.tools20022.repository.msg.CorporateActionRate35.DeclaredRate);
