...
public class CorporateActionRate78 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate78.mmInterest, CorporateActionRate78.mmPercentageSought, CorporateActionRate78.mmRelatedIndex, CorporateActionRate78.mmSpread,
						CorporateActionRate78.mmBidInterval, CorporateActionRate78.mmPreviousFactor, CorporateActionRate78.mmNextFactor, CorporateActionRate78.mmReinvestmentDiscountRateToMarket, CorporateActionRate78.mmInterestShortfall,
						CorporateActionRate78.mmRealisedLoss, CorporateActionRate78.mmDeclaredRate);
