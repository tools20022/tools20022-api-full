 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption1#mmAmountDetails
...
public class CashOption1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CashOption1 CashOption1}</li>
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			definition = "Indicates wether it is a debit or a credit.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCurrency = new MMMessageAttribute() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency of the option.";
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionDate5
	...
	public CashOption1 setDateDetails(com.tools20022.repository.msg.CorporateActionDate5 dateDetails) {
	...
	public CashOption1 setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts1 amountDetails) {
	...
	public CashOption1 setExchangeRate(com.tools20022.repository.msg.ForeignExchangeTerms8 exchangeRate) {
