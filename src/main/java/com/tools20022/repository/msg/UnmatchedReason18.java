...
public class UnmatchedReason18 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason18.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason18.mmCode, UnmatchedReason18.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason25Choice code) {
		this.code = code;
	}
