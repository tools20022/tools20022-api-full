	...
	public static final MMMessageAttribute mmDisplayType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DisplayCapabilities2.mmDisplayType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmNumberOfLines = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DisplayCapabilities2.mmNumberOfLines);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmLineWidth = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DisplayCapabilities2.mmLineWidth);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max3NumericText.mmObject();
		}
