...
public class RejectionOrRepairReason27 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason27.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason27.mmCode, RejectionOrRepairReason27.mmAdditionalReasonInformation);
	...
	public void setCode(List<RejectionAndRepairReason27Choice> code) {
		this.code = code;
	}
