...
public class ForeignExchangeTerms23 {
	...
	public static final MMMessageAttribute UnitCurrency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms11.UnitCurrency;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute QuotedCurrency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms11.QuotedCurrency;
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> ActiveCurrencyCode.mmObject();
		}
	...
	public static final MMMessageAttribute ExchangeRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms11.ExchangeRate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ResultingAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms11.ResultingAmount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms23.UnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms23.QuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms23.ExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms23.ResultingAmount);
				...
				previousVersion_lazy = () -> ForeignExchangeTerms11.mmObject();
			}
		});
