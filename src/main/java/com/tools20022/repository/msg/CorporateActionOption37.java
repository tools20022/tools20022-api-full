...
public class CorporateActionOption37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption37.mmOptionNumber, CorporateActionOption37.mmOptionType, CorporateActionOption37.mmOptionFeatures, CorporateActionOption37.mmFractionDisposition,
						CorporateActionOption37.mmCurrencyOption, CorporateActionOption37.mmDateDetails, CorporateActionOption37.mmPeriodDetails, CorporateActionOption37.mmRateAndAmountDetails, CorporateActionOption37.mmPriceDetails,
						CorporateActionOption37.mmPlaceOfTrade, CorporateActionOption37.mmSecuritiesMovementDetails, CorporateActionOption37.mmCashMovementDetails);
