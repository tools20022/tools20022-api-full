...
public class CashOption24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption24.mmCreditDebitIndicator, CashOption24.mmNonEligibleProceedsIndicator, CashOption24.mmIssuerOfferorTaxabilityIndicator, CashOption24.mmIncomeType,
						CashOption24.mmCashAccountIdentification, CashOption24.mmAmountDetails, CashOption24.mmDateDetails, CashOption24.mmForeignExchangeDetails, CashOption24.mmRateAndAmountDetails, CashOption24.mmPriceDetails);
