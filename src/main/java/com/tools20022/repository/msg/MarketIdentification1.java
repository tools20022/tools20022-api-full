...
import com.tools20022.repository.codeset.MarketType1Code;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification1#mmType
...
@XmlType(name = "MarketIdentification1", propOrder = {"identification", "type"})
public class MarketIdentification1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	protected PartyIdentification6Choice identification;
	/**
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.MarketIdentification1
	 * MarketIdentification1}</li>
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> MarketIdentification1.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	protected MarketType1Code type;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MarketIdentification1.mmIdentification, MarketIdentification1.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "MarketIdentification1";
	...
	public PartyIdentification6Choice getIdentification() {
		return identification;
	}

	public void setIdentification(com.tools20022.repository.msg.PartyIdentification6Choice identification) {
		this.identification = identification;
	}

	@XmlElement(name = "Tp", required = true)
	public MarketType1Code getType() {
		return type;
	}

	public void setType(MarketType1Code type) {
		this.type = type;
	}
}