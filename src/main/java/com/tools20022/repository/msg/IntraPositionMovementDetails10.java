...
public class IntraPositionMovementDetails10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionMovementDetails10.mmIdentification, IntraPositionMovementDetails10.mmSettledQuantity, IntraPositionMovementDetails10.mmPreviouslySettledQuantity,
						IntraPositionMovementDetails10.mmRemainingToBeSettledQuantity, IntraPositionMovementDetails10.mmSecuritiesSubBalanceIdentification, IntraPositionMovementDetails10.mmBalanceTo,
						IntraPositionMovementDetails10.mmSettlementDate, IntraPositionMovementDetails10.mmAvailableDate, IntraPositionMovementDetails10.mmCorporateActionEventType, IntraPositionMovementDetails10.mmCollateralMonitorAmount,
						IntraPositionMovementDetails10.mmInstructionProcessingAdditionalDetails, IntraPositionMovementDetails10.mmSupplementaryData);
