...
public class CardPaymentTransaction51 {
	...
	public static final MMMessageAttribute mmTransactionCapture = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmTransactionCapture);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmTransactionCapture;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmTransactionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmTransactionType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAdditionalService = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmAdditionalService);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmAdditionalService;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmServiceAttribute = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmServiceAttribute);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmMerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmMerchantCategoryCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmTransactionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmOriginalTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmInitiatorTransactionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmReconciliationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmTransactionDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails27.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmMerchantReferenceData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmMerchantReferenceData);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction76.mmAdditionalTransactionData);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction36.mmAdditionalTransactionData;
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}
	};
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails27 transactionDetails) {
