...
public class CardPaymentTransaction51 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction51.mmTransactionCapture, CardPaymentTransaction51.mmTransactionType, CardPaymentTransaction51.mmAdditionalService, CardPaymentTransaction51.mmServiceAttribute,
						CardPaymentTransaction51.mmMerchantCategoryCode, CardPaymentTransaction51.mmSaleReferenceIdentification, CardPaymentTransaction51.mmTransactionIdentification, CardPaymentTransaction51.mmOriginalTransaction,
						CardPaymentTransaction51.mmInitiatorTransactionIdentification, CardPaymentTransaction51.mmReconciliationIdentification, CardPaymentTransaction51.mmTransactionDetails,
						CardPaymentTransaction51.mmMerchantReferenceData, CardPaymentTransaction51.mmAdditionalTransactionData);
