 ...
 * TransactionDetails53.mmClientTripartyCollateralTransactionIdentification}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails53#mmPayment
...
@XmlType(name = "TransactionDetails53", propOrder = {"tradeIdentification", "poolIdentification", "corporateActionEventIdentification", "tripartyAgentCollateralTransactionIdentification",
...
public class TransactionDetails53 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<TransactionDetails53, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmTradeIdentification);
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(TransactionDetails53 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(TransactionDetails53 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionDetails53 obj) {
			return obj.getPoolIdentification();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmTripartyAgentCollateralTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmClientTripartyCollateralTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmClientCollateralInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails53, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmTripartyCollateralInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(TransactionDetails53 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageAssociationEnd<TransactionDetails53, SecuritiesAccount13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount13 getValue(TransactionDetails53 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(TransactionDetails53 obj, SecuritiesAccount13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<TransactionDetails53, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSafekeepingPlace);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(TransactionDetails53 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<MarketIdentification4>> mmPlaceOfTrade = new MMMessageAssociationEnd<TransactionDetails53, Optional<MarketIdentification4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmPlaceOfTrade);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification4> getValue(TransactionDetails53 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<MarketIdentification4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<TransactionDetails53, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmPlaceOfClearing);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(TransactionDetails53 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<TransactionDetails53, SecurityIdentification14>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmFinancialInstrumentIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(TransactionDetails53 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(TransactionDetails53 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<TransactionDetails53, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSettlementQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails53 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<AmountAndDirection8>> mmSettlementAmount = new MMMessageAssociationEnd<TransactionDetails53, Optional<AmountAndDirection8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection8> getValue(TransactionDetails53 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<AmountAndDirection8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmLateDeliveryDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(TransactionDetails53 obj) {
			return obj.getLateDeliveryDate();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>> mmExpectedSettlementDate = new MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmExpectedSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>> mmExpectedValueDate = new MMMessageAssociationEnd<TransactionDetails53, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmExpectedValueDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, SettlementDate2Choice> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails53, SettlementDate2Choice>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			name = "SettlementDate";
			definition = "Date and time at which the securities are to be delivered or received.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSettlementDate);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate2Choice getValue(TransactionDetails53 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails53 obj, SettlementDate2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails53, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmTradeDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(TransactionDetails53 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionDetails53, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSecuritiesMovementType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionDetails53 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionDetails53 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionDetails53, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmPayment);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionDetails53 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionDetails53 obj, DeliveryReceiptType2Code value) {
			obj.setPayment(value);
		}
	};
	@XmlElement(name = "SttlmParams", required = true)
	protected SettlementDetails44 settlementParameters;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, SettlementDetails44> mmSettlementParameters = new MMMessageAssociationEnd<TransactionDetails53, SettlementDetails44>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSettlementParameters);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDetails44 getValue(TransactionDetails53 obj) {
			return obj.getSettlementParameters();
		}

		@Override
		public void setValue(TransactionDetails53 obj, SettlementDetails44 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<SettlementParties13>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails53, Optional<SettlementParties13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmReceivingSettlementParties);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties13> getValue(TransactionDetails53 obj) {
			return obj.getReceivingSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<SettlementParties13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<SettlementParties13>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails53, Optional<SettlementParties13>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmDeliveringSettlementParties);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties13.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification37Choice>> mmInvestor = new MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification37Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmInvestor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification37Choice> getValue(TransactionDetails53 obj) {
			return obj.getInvestor();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<PartyIdentification37Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification45Choice>> mmQualifiedForeignIntermediary = new MMMessageAssociationEnd<TransactionDetails53, Optional<PartyIdentification45Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmQualifiedForeignIntermediary);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification45Choice> getValue(TransactionDetails53 obj) {
			return obj.getQualifiedForeignIntermediary();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<PartyIdentification45Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails53, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<TransactionDetails53, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails53.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails61.mmSettlementInstructionProcessingAdditionalDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransactionDetails53 obj) {
			return obj.getSettlementInstructionProcessingAdditionalDetails();
		}

		@Override
		public void setValue(TransactionDetails53 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails53.mmTradeIdentification, com.tools20022.repository.msg.TransactionDetails53.mmPoolIdentification,
						com.tools20022.repository.msg.TransactionDetails53.mmCorporateActionEventIdentification, com.tools20022.repository.msg.TransactionDetails53.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails53.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.TransactionDetails53.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.TransactionDetails53.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.TransactionDetails53.mmAccountOwner,
						com.tools20022.repository.msg.TransactionDetails53.mmSafekeepingAccount, com.tools20022.repository.msg.TransactionDetails53.mmSafekeepingPlace, com.tools20022.repository.msg.TransactionDetails53.mmPlaceOfTrade,
						com.tools20022.repository.msg.TransactionDetails53.mmPlaceOfClearing, com.tools20022.repository.msg.TransactionDetails53.mmFinancialInstrumentIdentification,
						com.tools20022.repository.msg.TransactionDetails53.mmSettlementQuantity, com.tools20022.repository.msg.TransactionDetails53.mmSettlementAmount, com.tools20022.repository.msg.TransactionDetails53.mmLateDeliveryDate,
						com.tools20022.repository.msg.TransactionDetails53.mmExpectedSettlementDate, com.tools20022.repository.msg.TransactionDetails53.mmExpectedValueDate,
						com.tools20022.repository.msg.TransactionDetails53.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails53.mmTradeDate, com.tools20022.repository.msg.TransactionDetails53.mmSecuritiesMovementType,
						com.tools20022.repository.msg.TransactionDetails53.mmPayment, com.tools20022.repository.msg.TransactionDetails53.mmSettlementParameters,
						...
						com.tools20022.repository.msg.TransactionDetails53.mmInvestor, com.tools20022.repository.msg.TransactionDetails53.mmQualifiedForeignIntermediary,
						com.tools20022.repository.msg.TransactionDetails53.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionStatusAdviceV04.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCountryCodeRule.forTransactionDetails53,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionDetails53, com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forTransactionDetails53,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forTransactionDetails53, com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing1Rule.forTransactionDetails53,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing2Rule.forTransactionDetails53);
	...
	public TransactionDetails53 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public TransactionDetails53 setPoolIdentification(Max35Text poolIdentification) {
	...
	public TransactionDetails53 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public TransactionDetails53 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public TransactionDetails53 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public TransactionDetails53 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public TransactionDetails53 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
	...
	public TransactionDetails53 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public TransactionDetails53 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public TransactionDetails53 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public TransactionDetails53 setPlaceOfTrade(MarketIdentification4 placeOfTrade) {
	...
	public TransactionDetails53 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public TransactionDetails53 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public TransactionDetails53 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public TransactionDetails53 setSettlementAmount(AmountAndDirection8 settlementAmount) {
	...
	public TransactionDetails53 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public TransactionDetails53 setExpectedSettlementDate(DateAndDateTimeChoice expectedSettlementDate) {
	...
	public TransactionDetails53 setExpectedValueDate(DateAndDateTimeChoice expectedValueDate) {
	...
	public TransactionDetails53 setSettlementDate(SettlementDate2Choice settlementDate) {
	...
	public TransactionDetails53 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public TransactionDetails53 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionDetails53 setPayment(DeliveryReceiptType2Code payment) {
		this.payment = Objects.requireNonNull(payment);
		return this;
	}

	public SettlementDetails44 getSettlementParameters() {
		return settlementParameters;
	}

	public TransactionDetails53 setSettlementParameters(SettlementDetails44 settlementParameters) {
	...
	public TransactionDetails53 setReceivingSettlementParties(SettlementParties13 receivingSettlementParties) {
	...
	public TransactionDetails53 setDeliveringSettlementParties(SettlementParties13 deliveringSettlementParties) {
	...
	public TransactionDetails53 setInvestor(PartyIdentification37Choice investor) {
	...
	public TransactionDetails53 setQualifiedForeignIntermediary(PartyIdentification45Choice qualifiedForeignIntermediary) {
	...
	public TransactionDetails53 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
