...
public class EnergyCommodityRenewableEnergy1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> EnergyCommodityRenewableEnergy1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EnergyCommodityRenewableEnergy1.mmBaseProduct, EnergyCommodityRenewableEnergy1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType28Code subProduct) {
