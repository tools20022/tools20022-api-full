...
public class QuantityAndAccount27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount27.mmSettlementQuantity, QuantityAndAccount27.mmDenominationChoice, QuantityAndAccount27.mmAccountOwner, QuantityAndAccount27.mmSafekeepingAccount,
						QuantityAndAccount27.mmCashAccount, QuantityAndAccount27.mmQuantityBreakdown, QuantityAndAccount27.mmSafekeepingPlace);
