...
public class PendingProcessingReason6 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason6.mmCode, PendingProcessingReason6.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason6Choice code) {
		this.code = code;
	}
