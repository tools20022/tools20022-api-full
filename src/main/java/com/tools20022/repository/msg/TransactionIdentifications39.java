...
public class TransactionIdentifications39 {
	...
	public static final MMMessageAttribute mmAccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications39.mmObject();
			isDerived = false;
			xmlTag = "AcctSvcrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications39.mmAccountServicerTransactionIdentification, TransactionIdentifications39.mmMarketInfrastructureTransactionIdentification,
						TransactionIdentifications39.mmProcessorTransactionIdentification, TransactionIdentifications39.mmAccountOwnerTransactionIdentification);
	...
	public void setAccountOwnerTransactionIdentification(References59Choice accountOwnerTransactionIdentification) {
