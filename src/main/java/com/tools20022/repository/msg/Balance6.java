 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Balance6#mmShortLongIndicator
...
@XmlType(name = "Balance6", propOrder = {"shortLongIndicator", "quantity"})
public class Balance6 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Balance6
	 * Balance6}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Balance6, ShortLong1Code> mmShortLongIndicator = new MMMessageAttribute<Balance6, ShortLong1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmShortLong;
			componentContext_lazy = () -> com.tools20022.repository.msg.Balance6.mmObject();
			isDerived = false;
			xmlTag = "ShrtLngInd";
			...
			nextVersions_lazy = () -> Arrays.asList(Balance8.mmShortLongIndicator);
			previousVersion_lazy = () -> Balance1.mmShortLongIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ShortLong1Code getValue(Balance6 obj) {
			return obj.getShortLongIndicator();
		}

		@Override
		public void setValue(Balance6 obj, ShortLong1Code value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Balance1#mmQuantity
	 * Balance1.mmQuantity}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Balance6, BalanceQuantity9Choice> mmQuantity = new MMMessageAttribute<Balance6, BalanceQuantity9Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Balance8.mmQuantity);
			previousVersion_lazy = () -> Balance1.mmQuantity;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public BalanceQuantity9Choice getValue(Balance6 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(Balance6 obj, BalanceQuantity9Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Balance6.mmShortLongIndicator, com.tools20022.repository.msg.Balance6.mmQuantity);
				...
				nextVersions_lazy = () -> Arrays.asList(Balance8.mmObject());
	...
	public Balance6 setShortLongIndicator(ShortLong1Code shortLongIndicator) {
	...
	public Balance6 setQuantity(BalanceQuantity9Choice quantity) {
