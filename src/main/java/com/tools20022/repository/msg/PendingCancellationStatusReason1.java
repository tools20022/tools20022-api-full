...
import com.tools20022.repository.choice.PendingCancellationReason1Choice;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forPendingCancellationStatusReason1
 * ConstraintAdditionalReasonInforrmationRule.
 * forPendingCancellationStatusReason1}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PendingCancellationStatusReason1", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingCancellationStatusReason1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason1.mmReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingCancellationStatusReason1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationStatusReason1";
				definition = "Specifies reasons for the pending cancellation status.";
				nextVersions_lazy = () -> Arrays.asList(PendingCancellationStatusReason3.mmObject());
			}
		});
	...
	public PendingCancellationStatusReason1 setReasonCode(PendingCancellationReason1Choice reasonCode) {
	...
	public PendingCancellationStatusReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
