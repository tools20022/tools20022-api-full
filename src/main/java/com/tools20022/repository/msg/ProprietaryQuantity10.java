		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(ProprietaryQuantity10.mmShortLongPosition, ProprietaryQuantity10.mmQuantity, ProprietaryQuantity10.mmQuantityType, ProprietaryQuantity10.mmIssuer, ProprietaryQuantity10.mmSchemeName);
