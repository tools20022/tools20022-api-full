	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DocumentIdentification28.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmDateOfIssue = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.DocumentIdentification28.mmDateOfIssue;
			maxOccurs = 1;
			minOccurs = 1;
