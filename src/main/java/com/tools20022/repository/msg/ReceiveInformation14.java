...
public class ReceiveInformation14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceiveInformation14.mmRequestedSettlementDate, ReceiveInformation14.mmEffectiveSettlementDate, ReceiveInformation14.mmSettlementAmount, ReceiveInformation14.mmStampDuty,
						ReceiveInformation14.mmNetAmount, ReceiveInformation14.mmChargeDetails, ReceiveInformation14.mmCommissionDetails, ReceiveInformation14.mmTaxDetails, ReceiveInformation14.mmForeignExchangeDetails,
						ReceiveInformation14.mmSettlementPartiesDetails, ReceiveInformation14.mmPhysicalTransfer, ReceiveInformation14.mmPhysicalTransferDetails, ReceiveInformation14.mmClientReference);
