...
@XmlType(name = "ReceiveInformation14", propOrder = {"requestedSettlementDate", "effectiveSettlementDate", "settlementAmount", "stampDuty", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "foreignExchangeDetails",
...
public class ReceiveInformation14 {
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<ReceiveInformation14, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmRequestedSettlementDate);
			previousVersion_lazy = () -> ReceiveInformation12.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<ReceiveInformation14, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> ReceiveInformation12.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation14, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmSettlementAmount);
			previousVersion_lazy = () -> ReceiveInformation12.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<ReceiveInformation14, Optional<StampDutyType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmStampDuty);
			previousVersion_lazy = () -> ReceiveInformation12.mmStampDuty;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation14, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmNetAmount);
			previousVersion_lazy = () -> ReceiveInformation12.mmNetAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, List<Charge27>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation14, List<Charge27>>() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmChargeDetails);
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, List<Commission22>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation14, List<Commission22>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmCommissionDetails);
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, List<Tax25>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation14, List<Tax25>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmTaxDetails);
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, List<ForeignExchangeTerms7>> mmForeignExchangeDetails = new MMMessageAssociationEnd<ReceiveInformation14, List<ForeignExchangeTerms7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmForeignExchangeDetails);
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, Optional<ReceivingPartiesAndAccount9>> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation14, Optional<ReceivingPartiesAndAccount9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmSettlementPartiesDetails);
			previousVersion_lazy = () -> ReceiveInformation12.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<ReceiveInformation14, Optional<PhysicalTransferType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmPhysicalTransfer);
			previousVersion_lazy = () -> ReceiveInformation12.mmPhysicalTransfer;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<ReceiveInformation14, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation14, Optional<DeliveryParameters4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmPhysicalTransferDetails);
			previousVersion_lazy = () -> ReceiveInformation12.mmPhysicalTransferDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<ReceiveInformation14, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<ReceiveInformation14, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReceiveInformation17.mmClientReference);
			previousVersion_lazy = () -> ReceiveInformation12.mmClientReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutConfirmationV06.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation14,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation14, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation14);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public ReceiveInformation14 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public ReceiveInformation14 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public ReceiveInformation14 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation14 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public ReceiveInformation14 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation14 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public ReceiveInformation14 setClientReference(Max35Text clientReference) {
