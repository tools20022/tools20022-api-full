...
public class PostalAddress13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PostalAddress13.mmAddressLine, PostalAddress13.mmStreetName, PostalAddress13.mmBuildingNumber, PostalAddress13.mmPostCode, PostalAddress13.mmTownName,
						PostalAddress13.mmCountrySubDivision, PostalAddress13.mmCountry);
