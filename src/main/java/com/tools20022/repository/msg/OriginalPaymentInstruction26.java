	...
	public static final MMMessageAttribute mmOriginalPaymentInformationCancellationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmOriginalPaymentInformationCancellationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmResolvedCase = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmResolvedCase;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOriginalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmOriginalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOriginalNumberOfTransactions = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmOriginalNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalControlSum = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmOriginalControlSum;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPaymentInformationCancellationStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalPaymentInstruction22.mmPaymentInformationCancellationStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> OriginalPaymentInstruction22.mmObject();
			}
		});
