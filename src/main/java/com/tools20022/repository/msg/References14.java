...
public class References14 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References14.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References14.mmAccountOwnerTransactionIdentification, References14.mmAccountServicerTransactionIdentification, References14.mmMarketInfrastructureTransactionIdentification,
						References14.mmProcessorTransactionIdentification, References14.mmPoolIdentification);
