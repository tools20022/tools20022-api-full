...
public class CardPaymentTransaction77 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails28.mmObject();
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute mmMerchantReferenceData = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction77.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction77.mmSaleReferenceIdentification, CardPaymentTransaction77.mmTransactionIdentification, CardPaymentTransaction77.mmInitiatorTransactionIdentification,
						CardPaymentTransaction77.mmRecipientTransactionIdentification, CardPaymentTransaction77.mmReconciliationIdentification, CardPaymentTransaction77.mmInterchangeData, CardPaymentTransaction77.mmTransactionDetails,
						CardPaymentTransaction77.mmMerchantReferenceData);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails28 transactionDetails) {
	...
	public void setMerchantReferenceData(Max70Text merchantReferenceData) {
