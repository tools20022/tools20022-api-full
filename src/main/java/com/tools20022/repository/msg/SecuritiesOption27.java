 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesOption27#mmFinancialInstrumentIdentification
 * SecuritiesOption27.mmFinancialInstrumentIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forSecuritiesOption27
 * ConstraintCoexistenceQuantityRule.forSecuritiesOption27}</li>
 * </ul>
 * </li>
 * <li>
...
public class SecuritiesOption27 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption27, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<SecuritiesOption27, SecurityIdentification14>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesOption27.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmFinancialInstrumentIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(SecuritiesOption27 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(SecuritiesOption27 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesOption27, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<SecuritiesOption27, CreditDebitCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(SecuritiesOption27 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(SecuritiesOption27 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption27, Quantity6Choice> mmPostingQuantity = new MMMessageAssociationEnd<SecuritiesOption27, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmPostingQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(SecuritiesOption27 obj) {
			return obj.getPostingQuantity();
		}

		@Override
		public void setValue(SecuritiesOption27 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption27, DateAndDateTimeChoice> mmPostingDate = new MMMessageAssociationEnd<SecuritiesOption27, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmPostingDate);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DateAndDateTimeChoice getValue(SecuritiesOption27 obj) {
			return obj.getPostingDate();
		}

		@Override
		public void setValue(SecuritiesOption27 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesOption27, Optional<DateAndDateTimeChoice>> mmOriginalPostingDate = new MMMessageAssociationEnd<SecuritiesOption27, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionDistribution.mmPostingDateTime;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesOption27.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmOriginalPostingDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(SecuritiesOption27 obj) {
			return obj.getOriginalPostingDate();
		}

		@Override
		public void setValue(SecuritiesOption27 obj, Optional<DateAndDateTimeChoice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesOption27.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.SecuritiesOption27.mmCreditDebitIndicator,
						com.tools20022.repository.msg.SecuritiesOption27.mmPostingQuantity, com.tools20022.repository.msg.SecuritiesOption27.mmPostingDate, com.tools20022.repository.msg.SecuritiesOption27.mmOriginalPostingDate);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forSecuritiesOption27);
				...
				name = "SecuritiesOption27";
				definition = "Provides information about the corporate action security option.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesOption53.mmObject());
				previousVersion_lazy = () -> SecuritiesOption19.mmObject();
			}
		});
	...
	public SecuritiesOption27 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public SecuritiesOption27 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public SecuritiesOption27 setPostingQuantity(Quantity6Choice postingQuantity) {
	...
	public SecuritiesOption27 setPostingDate(DateAndDateTimeChoice postingDate) {
	...
	public SecuritiesOption27 setOriginalPostingDate(DateAndDateTimeChoice originalPostingDate) {
