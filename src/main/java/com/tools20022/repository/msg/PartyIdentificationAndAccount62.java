...
public class PartyIdentificationAndAccount62 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount62.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount62.mmIdentification, PartyIdentificationAndAccount62.mmAlternateIdentification, PartyIdentificationAndAccount62.mmSafekeepingAccount,
						PartyIdentificationAndAccount62.mmProcessingIdentification, PartyIdentificationAndAccount62.mmAdditionalInformation);
