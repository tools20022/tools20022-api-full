...
public class EventInformation7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation7.mmCorporateActionEventIdentification, EventInformation7.mmOfficialCorporateActionEventIdentification, EventInformation7.mmEventType,
						EventInformation7.mmMandatoryVoluntaryEventType, EventInformation7.mmLastNotificationIdentification);
