...
public class EventInformation7 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> EventInformation7.mmObject();
			isDerived = false;
			xmlTag = "CorpActnEvtId";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CorporateActionEventIdentification";
			definition = "Reference assigned by the account servicer to unambiguously identify a corporate action event.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmOfficialCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.mmOfficialCorporateActionEventIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmOfficialCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.mmEventType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmEventType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmMandatoryVoluntaryEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.mmMandatoryVoluntaryEventType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmMandatoryVoluntaryEventType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmLastNotificationIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.mmLastNotificationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.mmLastNotificationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.NotificationIdentification3.mmObject();
		}
	};
	...
	public NotificationIdentification3 getLastNotificationIdentification() {
		return lastNotificationIdentification;
	}

	public void setLastNotificationIdentification(com.tools20022.repository.msg.NotificationIdentification3 lastNotificationIdentification) {
