...
import com.tools20022.repository.msg.NotificationIdentification3;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation7#mmEventType
...
@XmlType(name = "EventInformation7", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "mandatoryVoluntaryEventType", "lastNotificationIdentification"})
public class EventInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation7, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<EventInformation7, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.EventInformation7.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> EventInformation5.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(EventInformation7 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation7 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation7, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<EventInformation7, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmOfficialCorporateActionEventIdentification);
			previousVersion_lazy = () -> EventInformation5.mmOfficialCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(EventInformation7 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(EventInformation7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation7, CorporateActionEventType32Choice> mmEventType = new MMMessageAttribute<EventInformation7, CorporateActionEventType32Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmEventType);
			previousVersion_lazy = () -> EventInformation5.mmEventType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventType32Choice getValue(EventInformation7 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(EventInformation7 obj, CorporateActionEventType32Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EventInformation7, CorporateActionMandatoryVoluntary3Choice> mmMandatoryVoluntaryEventType = new MMMessageAttribute<EventInformation7, CorporateActionMandatoryVoluntary3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmMandatoryVoluntaryEventType);
			previousVersion_lazy = () -> EventInformation5.mmMandatoryVoluntaryEventType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionMandatoryVoluntary3Choice getValue(EventInformation7 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(EventInformation7 obj, CorporateActionMandatoryVoluntary3Choice value) {
			obj.setMandatoryVoluntaryEventType(value);
		}
	};
	@XmlElement(name = "LastNtfctnId")
	protected NotificationIdentification3 lastNotificationIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<EventInformation7, Optional<NotificationIdentification3>> mmLastNotificationIdentification = new MMMessageAssociationEnd<EventInformation7, Optional<NotificationIdentification3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmLastNotificationIdentification);
			previousVersion_lazy = () -> EventInformation5.mmLastNotificationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> NotificationIdentification3.mmObject();
		}

		@Override
		public Optional<NotificationIdentification3> getValue(EventInformation7 obj) {
			return obj.getLastNotificationIdentification();
		}

		@Override
		public void setValue(EventInformation7 obj, Optional<NotificationIdentification3> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation7.mmCorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation7.mmOfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation7.mmEventType, com.tools20022.repository.msg.EventInformation7.mmMandatoryVoluntaryEventType,
						com.tools20022.repository.msg.EventInformation7.mmLastNotificationIdentification);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "EventInformation7";
				definition = "Provides information about event of a corporate action.";
				nextVersions_lazy = () -> Arrays.asList(EventInformation9.mmObject());
				previousVersion_lazy = () -> EventInformation5.mmObject();
			}
		});
	...
	public EventInformation7 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public EventInformation7 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public EventInformation7 setEventType(CorporateActionEventType32Choice eventType) {
	...
	public EventInformation7 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary3Choice mandatoryVoluntaryEventType) {
		this.mandatoryVoluntaryEventType = Objects.requireNonNull(mandatoryVoluntaryEventType);
		return this;
	}

	public Optional<NotificationIdentification3> getLastNotificationIdentification() {
		return lastNotificationIdentification == null ? Optional.empty() : Optional.of(lastNotificationIdentification);
	}

	public EventInformation7 setLastNotificationIdentification(NotificationIdentification3 lastNotificationIdentification) {
