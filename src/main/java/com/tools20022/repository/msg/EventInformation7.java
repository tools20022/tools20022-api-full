 ...
 * <li>{@linkplain com.tools20022.repository.msg.EventInformation7#EventType
...
public class EventInformation7 {
	...
	public static final MMMessageAttribute CorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.CorporateActionEventIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.CorporateActionEventIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OfficialCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.OfficialCorporateActionEventIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.OfficialCorporateActionEventIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute EventType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.EventType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.EventType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MandatoryVoluntaryEventType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.MandatoryVoluntaryEventType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.MandatoryVoluntaryEventType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LastNotificationIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.EventInformation5.LastNotificationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation9.LastNotificationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EventInformation7.CorporateActionEventIdentification, com.tools20022.repository.msg.EventInformation7.OfficialCorporateActionEventIdentification,
						com.tools20022.repository.msg.EventInformation7.EventType, com.tools20022.repository.msg.EventInformation7.MandatoryVoluntaryEventType, com.tools20022.repository.msg.EventInformation7.LastNotificationIdentification);
