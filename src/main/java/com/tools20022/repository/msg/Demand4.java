 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Demand4#Identification
 * Demand4.Identification}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Demand4#Amount Demand4.Amount}</li>
 * </ul>
 * </li>
...
public class Demand4 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Demand4.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Demand4.Identification, com.tools20022.repository.msg.Demand4.Amount);
