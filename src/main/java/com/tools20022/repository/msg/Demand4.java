 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Demand4#mmIdentification
 * Demand4.mmIdentification}</li>
 ...
 * definition} = "Information about a demand."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Demand4", propOrder = {"identification", "amount"})
public class Demand4 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Demand4
	 * Demand4}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Demand4.mmIdentification, com.tools20022.repository.msg.Demand4.mmAmount);
				trace_lazy = () -> Demand.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Demand4";
				definition = "Information about a demand.";
			}
		});
	...
	public Demand4 setIdentification(Max35Text identification) {
	...
	public Demand4 setAmount(ActiveCurrencyAndAmount amount) {
