...
import com.tools20022.repository.msg.CardPaymentTransactionDetails22;
...
@XmlType(name = "CardPaymentTransaction42", propOrder = {"saleReferenceIdentification", "transactionIdentification", "recipientTransactionIdentification", "reconciliationIdentification", "interchangeData", "transactionDetails"})
public class CardPaymentTransaction42 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction35#mmSaleReferenceIdentification
	 * CardPaymentTransaction35.mmSaleReferenceIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SaleReferenceIdentification";
			definition = "Global reference of the sale transaction for the sale system.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction42 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction42 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction42, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction42, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction42 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction42 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction42, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction42, Optional<Max140Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction42, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(CardPaymentTransaction42 obj) {
			return obj.getInterchangeData();
		}

		@Override
		public void setValue(CardPaymentTransaction42 obj, Optional<Max140Text> value) {
			obj.setInterchangeData(value.orElse(null));
		}
	};
	@XmlElement(name = "TxDtls", required = true)
	protected CardPaymentTransactionDetails22 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction42, CardPaymentTransactionDetails22> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction42, CardPaymentTransactionDetails22>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction35.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CardPaymentTransactionDetails22.mmObject();
		}

		@Override
		public CardPaymentTransactionDetails22 getValue(CardPaymentTransaction42 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction42 obj, CardPaymentTransactionDetails22 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction42.mmSaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction42.mmTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction42.mmRecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction42.mmReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction42.mmInterchangeData, com.tools20022.repository.msg.CardPaymentTransaction42.mmTransactionDetails);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction42";
				definition = "Transaction information in the cancellation response.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmObject());
				previousVersion_lazy = () -> CardPaymentTransaction35.mmObject();
			}
		});
	...
	public CardPaymentTransaction42 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction42 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction42 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction42 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction42 setInterchangeData(Max140Text interchangeData) {
		this.interchangeData = interchangeData;
		return this;
	}

	public CardPaymentTransactionDetails22 getTransactionDetails() {
		return transactionDetails;
	}

	public CardPaymentTransaction42 setTransactionDetails(CardPaymentTransactionDetails22 transactionDetails) {
