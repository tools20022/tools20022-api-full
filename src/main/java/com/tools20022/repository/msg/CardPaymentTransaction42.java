...
public class CardPaymentTransaction42 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction42.mmSaleReferenceIdentification, CardPaymentTransaction42.mmTransactionIdentification, CardPaymentTransaction42.mmRecipientTransactionIdentification,
						CardPaymentTransaction42.mmReconciliationIdentification, CardPaymentTransaction42.mmInterchangeData, CardPaymentTransaction42.mmTransactionDetails);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails22 transactionDetails) {
