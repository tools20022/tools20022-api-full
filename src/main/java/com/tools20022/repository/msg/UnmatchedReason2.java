...
public class UnmatchedReason2 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason2.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason2.mmCode, UnmatchedReason2.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason3Choice code) {
		this.code = code;
	}
