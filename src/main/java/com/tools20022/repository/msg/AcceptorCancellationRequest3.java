...
public class AcceptorCancellationRequest3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationRequest3.mmEnvironment, AcceptorCancellationRequest3.mmContext, AcceptorCancellationRequest3.mmTransaction);
