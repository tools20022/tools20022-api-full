...
public class CardPaymentTransaction32 {
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction32.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction32.mmSaleReferenceIdentification, CardPaymentTransaction32.mmTransactionIdentification, CardPaymentTransaction32.mmRecipientTransactionIdentification,
						CardPaymentTransaction32.mmReconciliationIdentification, CardPaymentTransaction32.mmInterchangeData, CardPaymentTransaction32.mmTransactionDetails);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails17 transactionDetails) {
