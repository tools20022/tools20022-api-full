...
public class RateTypeAndAmountAndStatus28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus28.mmRateType, RateTypeAndAmountAndStatus28.mmAmount, RateTypeAndAmountAndStatus28.mmRateStatus);
