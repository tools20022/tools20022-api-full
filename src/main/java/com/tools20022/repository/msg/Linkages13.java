...
public class Linkages13 {
	...
	public static final MMMessageAssociationEnd mmProcessingPosition = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Linkages13.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Linkages13.mmProcessingPosition, Linkages13.mmMessageNumber, Linkages13.mmReference, Linkages13.mmReferenceOwner);
	...
	public PartyIdentification51Choice getReferenceOwner() {
		return referenceOwner;
	}

	public void setReferenceOwner(PartyIdentification51Choice referenceOwner) {
