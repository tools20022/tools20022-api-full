...
public class CardPaymentTransactionDetails1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails1.mmCurrency, CardPaymentTransactionDetails1.mmTotalAmount, CardPaymentTransactionDetails1.mmAmountQualifier,
						CardPaymentTransactionDetails1.mmDetailedAmount, CardPaymentTransactionDetails1.mmValidityDate, CardPaymentTransactionDetails1.mmOnLineReason, CardPaymentTransactionDetails1.mmUnattendedLevelCategory,
						CardPaymentTransactionDetails1.mmAccountType, CardPaymentTransactionDetails1.mmRecurringTransaction, CardPaymentTransactionDetails1.mmProduct, CardPaymentTransactionDetails1.mmICCRelatedData);
