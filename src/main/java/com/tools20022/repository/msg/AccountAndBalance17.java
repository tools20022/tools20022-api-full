...
import com.tools20022.repository.msg.CorporateActionBalanceDetails12;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.AccountAndBalance17#mmBalance
...
@XmlType(name = "AccountAndBalance17", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace", "balance"})
public class AccountAndBalance17 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountAndBalance17, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountAndBalance17, Max35Text>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesAccount.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountAndBalance17.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
		...
		@Override
		public Max35Text getValue(AccountAndBalance17 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(AccountAndBalance17 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance17, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountAndBalance17, Optional<PartyIdentification36Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(AccountAndBalance17 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountAndBalance17 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance17, Optional<SafekeepingPlaceFormat2Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountAndBalance17, Optional<SafekeepingPlaceFormat2Choice>>() {
		{
		...
		@Override
		public Optional<SafekeepingPlaceFormat2Choice> getValue(AccountAndBalance17 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AccountAndBalance17 obj, Optional<SafekeepingPlaceFormat2Choice> value) {
			obj.setSafekeepingPlace(value.orElse(null));
		}
	};
	@XmlElement(name = "Bal")
	protected CorporateActionBalanceDetails12 balance;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance17, Optional<CorporateActionBalanceDetails12>> mmBalance = new MMMessageAssociationEnd<AccountAndBalance17, Optional<CorporateActionBalanceDetails12>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionBalanceDetails12.mmObject();
		}

		@Override
		public Optional<CorporateActionBalanceDetails12> getValue(AccountAndBalance17 obj) {
			return obj.getBalance();
		}

		@Override
		public void setValue(AccountAndBalance17 obj, Optional<CorporateActionBalanceDetails12> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forAccountAndBalance17);
				...
				previousVersion_lazy = () -> AccountAndBalance10.mmObject();
			}
		});
	...
	public AccountAndBalance17 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountAndBalance17 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public AccountAndBalance17 setSafekeepingPlace(SafekeepingPlaceFormat2Choice safekeepingPlace) {
		this.safekeepingPlace = safekeepingPlace;
		return this;
	}

	public Optional<CorporateActionBalanceDetails12> getBalance() {
		return balance == null ? Optional.empty() : Optional.of(balance);
	}

	public AccountAndBalance17 setBalance(CorporateActionBalanceDetails12 balance) {
