...
public class PriceInformation8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceInformation8.mmType, PriceInformation8.mmValueType, PriceInformation8.mmValue, PriceInformation8.mmSourceOfPrice, PriceInformation8.mmQuotationDate);
