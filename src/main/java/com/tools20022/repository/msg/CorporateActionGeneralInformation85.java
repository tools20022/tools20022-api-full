...
public class CorporateActionGeneralInformation85 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation85.mmCorporateActionEventIdentification, CorporateActionGeneralInformation85.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation85.mmClassActionNumber, CorporateActionGeneralInformation85.mmEventProcessingType, CorporateActionGeneralInformation85.mmEventType,
						CorporateActionGeneralInformation85.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation85.mmUnderlyingSecurity);
