 ...
 * CorporateActionGeneralInformation85.mmCorporateActionEventIdentification}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation85", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "classActionNumber", "eventProcessingType", "eventType", "mandatoryVoluntaryEventType",
		"underlyingSecurity"})
public class CorporateActionGeneralInformation85 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation85, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation85, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation85, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation85, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmOfficialCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmOfficialCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation85, Optional<Max35Text>> mmClassActionNumber = new MMMessageAttribute<CorporateActionGeneralInformation85, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmClassActionNumber);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmClassActionNumber;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation85, Optional<CorporateActionEventProcessingType2Choice>> mmEventProcessingType = new MMMessageAssociationEnd<CorporateActionGeneralInformation85, Optional<CorporateActionEventProcessingType2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmEventProcessingType);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmEventProcessingType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionEventProcessingType2Choice> getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getEventProcessingType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, Optional<CorporateActionEventProcessingType2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation85, CorporateActionEventType33Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation85, CorporateActionEventType33Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmEventType);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmEventType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionEventType33Choice getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, CorporateActionEventType33Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation85, CorporateActionMandatoryVoluntary3Choice> mmMandatoryVoluntaryEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation85, CorporateActionMandatoryVoluntary3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmMandatoryVoluntaryEventType);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmMandatoryVoluntaryEventType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionMandatoryVoluntary3Choice getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getMandatoryVoluntaryEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, CorporateActionMandatoryVoluntary3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation85, FinancialInstrumentAttributes66> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation85, FinancialInstrumentAttributes66>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmUnderlyingSecurity);
			previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmUnderlyingSecurity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrumentAttributes66 getValue(CorporateActionGeneralInformation85 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation85 obj, FinancialInstrumentAttributes66 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmClassActionNumber,
						com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmEventProcessingType, com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmMandatoryVoluntaryEventType, com.tools20022.repository.msg.CorporateActionGeneralInformation85.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNotificationV06.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation85,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation85);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionGeneralInformation85";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation105.mmObject());
				previousVersion_lazy = () -> CorporateActionGeneralInformation70.mmObject();
			}
		});
	...
	public CorporateActionGeneralInformation85 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation85 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation85 setClassActionNumber(Max35Text classActionNumber) {
	...
	public CorporateActionGeneralInformation85 setEventProcessingType(CorporateActionEventProcessingType2Choice eventProcessingType) {
	...
	public CorporateActionGeneralInformation85 setEventType(CorporateActionEventType33Choice eventType) {
	...
	public CorporateActionGeneralInformation85 setMandatoryVoluntaryEventType(CorporateActionMandatoryVoluntary3Choice mandatoryVoluntaryEventType) {
	...
	public CorporateActionGeneralInformation85 setUnderlyingSecurity(FinancialInstrumentAttributes66 underlyingSecurity) {
