 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Transaction54
 * Transaction54}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Transaction61", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
		...
		"clientCollateralInstructionIdentification", "tripartyAgentServiceProviderCollateralInstructionIdentification", "transactionDetails"})
public class Transaction61 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction61, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction61.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			previousVersion_lazy = () -> Transaction54.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(Transaction61 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction61 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(Transaction61 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction61 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction61, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(Transaction61 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction61 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralTransactionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmTripartyAgentServiceProviderCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction61, Optional<Max35Text>> mmTripartyAgentServiceProviderCollateralInstructionIdentification = new MMMessageAttribute<Transaction61, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction61.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> Transaction54.mmTripartyAgentServiceProviderCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction61, Optional<TransactionDetails104>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction61, Optional<TransactionDetails104>>() {
		{
			...
			previousVersion_lazy = () -> Transaction54.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TransactionDetails104> getValue(Transaction61 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction61 obj, Optional<TransactionDetails104> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction61.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction61.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction61.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction61.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction61.mmTradeIdentification, com.tools20022.repository.msg.Transaction61.mmPoolIdentification, com.tools20022.repository.msg.Transaction61.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction61.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction61.mmTripartyAgentServiceProviderCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction61.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction61.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.Transaction61.mmTripartyAgentServiceProviderCollateralInstructionIdentification, com.tools20022.repository.msg.Transaction61.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction61);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Transaction61";
				definition = "Specifies the details of the transaction.";
				previousVersion_lazy = () -> Transaction54.mmObject();
			}
		});
	...
	public Transaction61 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction61 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction61 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction61 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public Transaction61 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction61 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction61 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction61 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction61 setTripartyAgentServiceProviderCollateralTransactionIdentification(Max35Text tripartyAgentServiceProviderCollateralTransactionIdentification) {
	...
	public Transaction61 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public Transaction61 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public Transaction61 setTripartyAgentServiceProviderCollateralInstructionIdentification(Max35Text tripartyAgentServiceProviderCollateralInstructionIdentification) {
	...
	public Transaction61 setTransactionDetails(TransactionDetails104 transactionDetails) {
