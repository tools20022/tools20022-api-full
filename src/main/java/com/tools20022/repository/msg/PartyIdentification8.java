...
public class PartyIdentification8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification8.mmName, PartyIdentification8.mmPostalAddress, PartyIdentification8.mmIdentification, PartyIdentification8.mmCountryOfResidence);
	...
	public Party2Choice getIdentification() {
		return identification;
	}

	public void setIdentification(Party2Choice identification) {
