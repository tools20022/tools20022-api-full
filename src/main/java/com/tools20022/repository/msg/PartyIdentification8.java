...
public class PartyIdentification8 {
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification8.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification8.Name, com.tools20022.repository.msg.PartyIdentification8.PostalAddress,
						com.tools20022.repository.msg.PartyIdentification8.Identification, com.tools20022.repository.msg.PartyIdentification8.CountryOfResidence);
