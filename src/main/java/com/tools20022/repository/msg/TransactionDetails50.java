...
public class TransactionDetails50 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails50.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails50.mmTransactionActivity, TransactionDetails50.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails50.mmSecuritiesMovementType,
						TransactionDetails50.mmPayment, TransactionDetails50.mmSettlementParameters, TransactionDetails50.mmPlaceOfTrade, TransactionDetails50.mmSafekeepingPlace, TransactionDetails50.mmPlaceOfClearing,
						TransactionDetails50.mmFinancialInstrumentIdentification, TransactionDetails50.mmPostingQuantity, TransactionDetails50.mmPostingAmount, TransactionDetails50.mmTradeDate,
						TransactionDetails50.mmExpectedSettlementDate, TransactionDetails50.mmSettlementDate, TransactionDetails50.mmLateDeliveryDate, TransactionDetails50.mmExpectedValueDate,
						TransactionDetails50.mmDeliveringSettlementParties, TransactionDetails50.mmReceivingSettlementParties, TransactionDetails50.mmTransactionAdditionalDetails, TransactionDetails50.mmSupplementaryData);
	...
	public SettlementOrCorporateActionEvent8Choice getSettlementTransactionOrCorporateActionEventType() {
		return settlementTransactionOrCorporateActionEventType;
	}

	public void setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent8Choice settlementTransactionOrCorporateActionEventType) {
	...
	public SettlementDetails56 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails56 settlementParameters) {
