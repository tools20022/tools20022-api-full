...
public class CancelledStatusReason7 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledStatusReason7.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatusReason7.mmReasonCode, CancelledStatusReason7.mmAdditionalReasonInformation);
	...
	public void setReasonCode(CancelledReason4Choice reasonCode) {
