...
public class IntraPositionMovementDetails9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionMovementDetails9.mmIdentification, IntraPositionMovementDetails9.mmSettledQuantity, IntraPositionMovementDetails9.mmPreviouslySettledQuantity,
						IntraPositionMovementDetails9.mmRemainingToBeSettledQuantity, IntraPositionMovementDetails9.mmSecuritiesSubBalanceIdentification, IntraPositionMovementDetails9.mmBalanceTo,
						IntraPositionMovementDetails9.mmSettlementDate, IntraPositionMovementDetails9.mmAvailableDate, IntraPositionMovementDetails9.mmCorporateActionEventType, IntraPositionMovementDetails9.mmCollateralMonitorAmount,
						IntraPositionMovementDetails9.mmInstructionProcessingAdditionalDetails, IntraPositionMovementDetails9.mmSupplementaryData);
