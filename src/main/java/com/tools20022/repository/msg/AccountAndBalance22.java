...
import com.tools20022.repository.msg.CorporateActionBalanceDetails18;
...
public class AccountAndBalance22 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountAndBalance22, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountAndBalance22, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(AccountAndBalance22 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(AccountAndBalance22 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance22, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountAndBalance22, Optional<PartyIdentification36Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(AccountAndBalance22 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountAndBalance22 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance22, Optional<SafekeepingPlaceFormat2Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountAndBalance22, Optional<SafekeepingPlaceFormat2Choice>>() {
		{
		...
		@Override
		public Optional<SafekeepingPlaceFormat2Choice> getValue(AccountAndBalance22 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(AccountAndBalance22 obj, Optional<SafekeepingPlaceFormat2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountAndBalance22, CorporateActionBalanceDetails18> mmBalance = new MMMessageAssociationEnd<AccountAndBalance22, CorporateActionBalanceDetails18>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CorporateActionBalanceDetails18.mmObject();
		}

		@Override
		public CorporateActionBalanceDetails18 getValue(AccountAndBalance22 obj) {
			return obj.getBalance();
		}

		@Override
		public void setValue(AccountAndBalance22 obj, CorporateActionBalanceDetails18 value) {
	...
	public AccountAndBalance22 setBalance(CorporateActionBalanceDetails18 balance) {
