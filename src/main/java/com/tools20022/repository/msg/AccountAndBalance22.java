...
public class AccountAndBalance22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance22.mmSafekeepingAccount, AccountAndBalance22.mmAccountOwner, AccountAndBalance22.mmSafekeepingPlace, AccountAndBalance22.mmBalance);
