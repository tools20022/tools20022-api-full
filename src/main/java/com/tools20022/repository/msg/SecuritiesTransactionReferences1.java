 ...
 * SecuritiesTransactionReferences1.mmAccountOwnerTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SecuritiesTransactionReferences1#mmAccountServicerTransactionIdentification
 * SecuritiesTransactionReferences1.mmAccountServicerTransactionIdentification}</li>
 * <li>
 ...
 * definition} = "Identifies the underlying securities transaction."</li>
...
@XmlType(name = "SecuritiesTransactionReferences1", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processingIdentification"})
public class SecuritiesTransactionReferences1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			previousVersion_lazy = () -> TransactionReferences3.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(SecuritiesTransactionReferences1 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(SecuritiesTransactionReferences1 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionReferences3.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> TransactionReferences3.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>> mmProcessingIdentification = new MMMessageAttribute<SecuritiesTransactionReferences1, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmObject();
			isDerived = false;
			xmlTag = "PrcgId";
			...
			previousVersion_lazy = () -> TransactionReferences3.mmProcessingIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.SecuritiesTransactionReferences1.mmProcessingIdentification);
				trace_lazy = () -> TradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTransactionReferences1";
				definition = "Identifies the underlying securities transaction.";
	...
	public SecuritiesTransactionReferences1 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public SecuritiesTransactionReferences1 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public SecuritiesTransactionReferences1 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public SecuritiesTransactionReferences1 setProcessingIdentification(Max35Text processingIdentification) {
