...
public class RejectionOrRepairReason1 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason1.mmCode, RejectionOrRepairReason1.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason1Choice code) {
		this.code = code;
	}
