	...
	public static final MMMessageAttribute mmActionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmActionType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmVendorIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmVendorIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmVendorIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmVersion = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmVersion);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmVersion;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmClockSynchronisation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmClockSynchronisation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmClockSynchronisation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTimeZoneLine = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmTimeZoneLine);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmTimeZoneLine;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmLocalDateTime = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmLocalDateTime);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmLocalDateTime;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOtherParameters = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTerminalParameters4.mmOtherParameters);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTerminalParameters2.mmOtherParameters;
			maxOccurs = 1;
			minOccurs = 0;
