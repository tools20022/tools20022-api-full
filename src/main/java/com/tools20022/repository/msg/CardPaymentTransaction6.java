...
public class CardPaymentTransaction6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction6.mmTransactionIdentification, CardPaymentTransaction6.mmRecipientTransactionIdentification, CardPaymentTransaction6.mmReconciliationIdentification,
						CardPaymentTransaction6.mmInterchangeData, CardPaymentTransaction6.mmTransactionDetails);
