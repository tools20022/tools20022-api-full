...
public class Transaction17 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails34.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction17.mmAccountOwnerTransactionIdentification, Transaction17.mmAccountServicerTransactionIdentification, Transaction17.mmMarketInfrastructureTransactionIdentification,
						Transaction17.mmProcessorTransactionIdentification, Transaction17.mmTradeIdentification, Transaction17.mmPoolIdentification, Transaction17.mmCommonIdentification, Transaction17.mmCorporateActionEventIdentification,
						Transaction17.mmTripartyAgentCollateralTransactionIdentification, Transaction17.mmClientTripartyCollateralTransactionIdentification, Transaction17.mmTransactionDetails, Transaction17.mmSupplementaryData);
	...
	public TransactionDetails34 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails34 transactionDetails) {
