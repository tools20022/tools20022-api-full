...
public class CardPaymentTransactionDetails24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails24.mmCurrency, CardPaymentTransactionDetails24.mmTotalAmount, CardPaymentTransactionDetails24.mmAmountQualifier,
						CardPaymentTransactionDetails24.mmDetailedAmount, CardPaymentTransactionDetails24.mmValidityDate, CardPaymentTransactionDetails24.mmOnLineReason, CardPaymentTransactionDetails24.mmUnattendedLevelCategory,
						CardPaymentTransactionDetails24.mmAccountType, CardPaymentTransactionDetails24.mmInstalment, CardPaymentTransactionDetails24.mmAggregationTransaction, CardPaymentTransactionDetails24.mmProduct,
						CardPaymentTransactionDetails24.mmCardPaymentInvoice, CardPaymentTransactionDetails24.mmICCRelatedData);
