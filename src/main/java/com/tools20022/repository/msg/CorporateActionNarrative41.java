...
public class CorporateActionNarrative41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNarrative41.mmAdditionalText, CorporateActionNarrative41.mmNarrativeVersion, CorporateActionNarrative41.mmInformationConditions,
						CorporateActionNarrative41.mmInformationToComplyWith, CorporateActionNarrative41.mmTaxationConditions, CorporateActionNarrative41.mmDisclaimer, CorporateActionNarrative41.mmPartyContactNarrative,
						CorporateActionNarrative41.mmRegistrationDetails, CorporateActionNarrative41.mmBasketOrIndexInformation, CorporateActionNarrative41.mmCertificationBreakdown);
