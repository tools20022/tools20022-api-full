...
public class CorporateActionGeneralInformation100 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation100.mmCorporateActionEventIdentification, CorporateActionGeneralInformation100.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation100.mmClassActionNumber, CorporateActionGeneralInformation100.mmEventProcessingType, CorporateActionGeneralInformation100.mmEventType,
						CorporateActionGeneralInformation100.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation100.mmUnderlyingSecurity);
