 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TotalsPerBankTransactionCode3#NumberOfEntries
 * TotalsPerBankTransactionCode3.NumberOfEntries}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TotalsPerBankTransactionCode3#Sum
 * TotalsPerBankTransactionCode3.Sum}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TotalsPerBankTransactionCode3#TotalNetEntry
 * TotalsPerBankTransactionCode3.TotalNetEntry}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TotalsPerBankTransactionCode3#ForecastIndicator
 * TotalsPerBankTransactionCode3.ForecastIndicator}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TotalsPerBankTransactionCode3#BankTransactionCode
 * TotalsPerBankTransactionCode3.BankTransactionCode}</li>
 * <li>
...
public class TotalsPerBankTransactionCode3 {
	...
	public static final MMMessageAttribute NumberOfEntries = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TotalsPerBankTransactionCode3.mmObject();
			isDerived = false;
			xmlTag = "NbOfNtries";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NumberOfEntries";
			definition = "Number of individual entries for the bank transaction code.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.NumberOfEntries);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Sum = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.Sum);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TotalNetEntry = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.TotalNetEntry);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ForecastIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.ForecastIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BankTransactionCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.BankTransactionCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Availability = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode4.Availability);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalsPerBankTransactionCode3.NumberOfEntries, com.tools20022.repository.msg.TotalsPerBankTransactionCode3.Sum,
						com.tools20022.repository.msg.TotalsPerBankTransactionCode3.TotalNetEntry, com.tools20022.repository.msg.TotalsPerBankTransactionCode3.ForecastIndicator,
						com.tools20022.repository.msg.TotalsPerBankTransactionCode3.BankTransactionCode, com.tools20022.repository.msg.TotalsPerBankTransactionCode3.Availability);
