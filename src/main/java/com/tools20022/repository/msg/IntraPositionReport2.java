...
public class IntraPositionReport2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionReport2.mmReportNumber, IntraPositionReport2.mmQueryReference, IntraPositionReport2.mmReportIdentification, IntraPositionReport2.mmReportDateTime,
						IntraPositionReport2.mmReportPeriod, IntraPositionReport2.mmFrequency, IntraPositionReport2.mmUpdateType, IntraPositionReport2.mmActivityIndicator);
