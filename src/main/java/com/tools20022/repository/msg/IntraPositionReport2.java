 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.IntraPositionReport5
...
@XmlType(name = "IntraPositionReport2", propOrder = {"reportNumber", "queryReference", "reportIdentification", "reportDateTime", "reportPeriod", "frequency", "updateType", "activityIndicator"})
public class IntraPositionReport2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, Optional<Number3Choice>> mmReportNumber = new MMMessageAttribute<IntraPositionReport2, Optional<Number3Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmReportNumber);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Number3Choice> getValue(IntraPositionReport2 obj) {
			return obj.getReportNumber();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, Optional<Number3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, Optional<Max35Text>> mmQueryReference = new MMMessageAttribute<IntraPositionReport2, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "QryRef";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmQueryReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(IntraPositionReport2 obj) {
			return obj.getQueryReference();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, Optional<Max35Text>> mmReportIdentification = new MMMessageAttribute<IntraPositionReport2, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "RptId";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmReportIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, Optional<DateAndDateTimeChoice>> mmReportDateTime = new MMMessageAttribute<IntraPositionReport2, Optional<DateAndDateTimeChoice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "RptDtTm";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmReportDateTime);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(IntraPositionReport2 obj) {
			return obj.getReportDateTime();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, Optional<Period2Choice>> mmReportPeriod = new MMMessageAttribute<IntraPositionReport2, Optional<Period2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "RptPrd";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmReportPeriod);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Period2Choice> getValue(IntraPositionReport2 obj) {
			return obj.getReportPeriod();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, Optional<Period2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionReport2, Optional<Frequency9Choice>> mmFrequency = new MMMessageAssociationEnd<IntraPositionReport2, Optional<Frequency9Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "Frqcy";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmFrequency);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Frequency9Choice> getValue(IntraPositionReport2 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, Optional<Frequency9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionReport2, UpdateType2Choice> mmUpdateType = new MMMessageAssociationEnd<IntraPositionReport2, UpdateType2Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "UpdTp";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmUpdateType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public UpdateType2Choice getValue(IntraPositionReport2 obj) {
			return obj.getUpdateType();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, UpdateType2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionReport2, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<IntraPositionReport2, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionReport2.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmActivityIndicator);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(IntraPositionReport2 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(IntraPositionReport2 obj, YesNoIndicator value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionReport2.mmReportNumber, com.tools20022.repository.msg.IntraPositionReport2.mmQueryReference,
						com.tools20022.repository.msg.IntraPositionReport2.mmReportIdentification, com.tools20022.repository.msg.IntraPositionReport2.mmReportDateTime, com.tools20022.repository.msg.IntraPositionReport2.mmReportPeriod,
						com.tools20022.repository.msg.IntraPositionReport2.mmFrequency, com.tools20022.repository.msg.IntraPositionReport2.mmUpdateType, com.tools20022.repository.msg.IntraPositionReport2.mmActivityIndicator);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forIntraPositionReport2);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "IntraPositionReport2";
				definition = "Characteristics of the report.";
				nextVersions_lazy = () -> Arrays.asList(IntraPositionReport5.mmObject());
			}
		});
	...
	public IntraPositionReport2 setReportNumber(Number3Choice reportNumber) {
	...
	public IntraPositionReport2 setQueryReference(Max35Text queryReference) {
	...
	public IntraPositionReport2 setReportIdentification(Max35Text reportIdentification) {
	...
	public IntraPositionReport2 setReportDateTime(DateAndDateTimeChoice reportDateTime) {
	...
	public IntraPositionReport2 setReportPeriod(Period2Choice reportPeriod) {
	...
	public IntraPositionReport2 setFrequency(Frequency9Choice frequency) {
	...
	public IntraPositionReport2 setUpdateType(UpdateType2Choice updateType) {
	...
	public IntraPositionReport2 setActivityIndicator(YesNoIndicator activityIndicator) {
