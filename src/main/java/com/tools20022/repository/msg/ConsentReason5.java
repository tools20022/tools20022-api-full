...
@XmlType(name = "ConsentReason5", propOrder = {"code", "additionalReasonInformation"})
public class ConsentReason5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ConsentReason5 ConsentReason5}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ConsentReason5.mmCode, com.tools20022.repository.msg.ConsentReason5.mmAdditionalReasonInformation);
	...
	public ConsentReason5 setCode(ConsentOrRejectionReason5Choice code) {
	...
	public ConsentReason5 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
