 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintLimitCriteriaGuideline#forLimitCriteria1
 * ConstraintLimitCriteriaGuideline.forLimitCriteria1}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReturnCriteriaAndOrSearchCriteriaRule#forLimitCriteria1
 * ConstraintReturnCriteriaAndOrSearchCriteriaRule.forLimitCriteria1}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "LimitCriteria1", propOrder = {"newQueryName", "searchCriteria", "returnCriteria"})
public class LimitCriteria1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LimitCriteria1, Optional<Max35Text>> mmNewQueryName = new MMMessageAttribute<LimitCriteria1, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.LimitCriteria1.mmObject();
			isDerived = false;
			xmlTag = "NewQryNm";
		...
		@Override
		public Optional<Max35Text> getValue(LimitCriteria1 obj) {
			return obj.getNewQueryName();
		}

		@Override
		public void setValue(LimitCriteria1 obj, Optional<Max35Text> value) {
			obj.setNewQueryName(value.orElse(null));
		}
	};
	@XmlElement(name = "SchCrit")
	protected List<LimitSearchCriteria1> searchCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.LimitSearchCriteria1
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LimitCriteria1, List<LimitSearchCriteria1>> mmSearchCriteria = new MMMessageAssociationEnd<LimitCriteria1, List<LimitSearchCriteria1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.LimitCriteria1.mmObject();
			isDerived = false;
			xmlTag = "SchCrit";
		...
		@Override
		public List<LimitSearchCriteria1> getValue(LimitCriteria1 obj) {
			return obj.getSearchCriteria();
		}

		@Override
		public void setValue(LimitCriteria1 obj, List<LimitSearchCriteria1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LimitCriteria1, Optional<LimitReturnCriteria>> mmReturnCriteria = new MMMessageAssociationEnd<LimitCriteria1, Optional<LimitReturnCriteria>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.LimitCriteria1.mmObject();
			isDerived = false;
			xmlTag = "RtrCrit";
		...
		@Override
		public Optional<LimitReturnCriteria> getValue(LimitCriteria1 obj) {
			return obj.getReturnCriteria();
		}

		@Override
		public void setValue(LimitCriteria1 obj, Optional<LimitReturnCriteria> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintLimitCriteriaGuideline.forLimitCriteria1,
						com.tools20022.repository.constraints.ConstraintReturnCriteriaAndOrSearchCriteriaRule.forLimitCriteria1);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "LimitCriteria1";
	...
	public LimitCriteria1 setNewQueryName(Max35Text newQueryName) {
	...
	public LimitCriteria1 setSearchCriteria(List<LimitSearchCriteria1> searchCriteria) {
	...
	public LimitCriteria1 setReturnCriteria(LimitReturnCriteria returnCriteria) {
