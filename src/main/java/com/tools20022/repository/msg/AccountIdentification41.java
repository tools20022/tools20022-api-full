...
public class AccountIdentification41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification41.mmSafekeepingAccount, AccountIdentification41.mmAccountOwner, AccountIdentification41.mmSafekeepingPlace,
						AccountIdentification41.mmCorporateActionEventAndBalance);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatementReport002V06.mmAccountAndStatementDetails);
