 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CreditLine2
 * CreditLine2}</li>
 * </ul>
 */
...
public class CreditLine3 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CreditLine2#mmIncluded
	...
	public static final MMMessageAttribute<CreditLine3, TrueFalseIndicator> mmIncluded = new MMMessageAttribute<CreditLine3, TrueFalseIndicator>() {
		{
			...
			previousVersion_lazy = () -> CreditLine2.mmIncluded;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CreditLine2#mmAmount
	...
	public static final MMMessageAttribute<CreditLine3, Optional<ActiveOrHistoricCurrencyAndAmount>> mmAmount = new MMMessageAttribute<CreditLine3, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CreditLine2.mmAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CreditLine2.mmObject();
			}
		});
