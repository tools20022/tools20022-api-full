 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCorporateActionPrice33
 * ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice33}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice33", propOrder = {"cashInLieuOfSharePrice", "indicativeOrMarketPrice", "cashValueForTax", "genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class CorporateActionPrice33 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice33, Optional<PriceFormat17Choice>> mmCashInLieuOfSharePrice = new MMMessageAttribute<CorporateActionPrice33, Optional<PriceFormat17Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmCashInLieuOfSharePrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice33.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat17Choice> getValue(CorporateActionPrice33 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice33 obj, Optional<PriceFormat17Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice33, Optional<IndicativeOrMarketPrice4Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice33, Optional<IndicativeOrMarketPrice4Choice>>() {
		{
		...
		@Override
		public Optional<IndicativeOrMarketPrice4Choice> getValue(CorporateActionPrice33 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice33 obj, Optional<IndicativeOrMarketPrice4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice33, Optional<AmountPrice4>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice33, Optional<AmountPrice4>>() {
		{
		...
		@Override
		public Optional<AmountPrice4> getValue(CorporateActionPrice33 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice33 obj, Optional<AmountPrice4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice33, Optional<PriceFormat12Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice33, Optional<PriceFormat12Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat12Choice> getValue(CorporateActionPrice33 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice33 obj, Optional<PriceFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice33, Optional<PriceFormat13Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice33, Optional<PriceFormat13Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat13Choice> getValue(CorporateActionPrice33 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice33 obj, Optional<PriceFormat13Choice> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice33);
	...
	public CorporateActionPrice33 setCashInLieuOfSharePrice(PriceFormat17Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice33 setIndicativeOrMarketPrice(IndicativeOrMarketPrice4Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice33 setCashValueForTax(AmountPrice4 cashValueForTax) {
	...
	public CorporateActionPrice33 setGenericCashPricePaidPerProduct(PriceFormat12Choice genericCashPricePaidPerProduct) {
	...
	public CorporateActionPrice33 setGenericCashPriceReceivedPerProduct(PriceFormat13Choice genericCashPriceReceivedPerProduct) {
