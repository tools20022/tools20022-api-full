 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.StatusReasonInformation4#StatusOriginator
 * StatusReasonInformation4.StatusOriginator}</li>
 * <li>
...
public class StatusReasonInformation4 {
	...
	public static final MMMessageAssociationEnd StatusOriginator = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> StatusReasonInformation4.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReasonInformation4.StatusOriginator, com.tools20022.repository.msg.StatusReasonInformation4.StatusReason);
