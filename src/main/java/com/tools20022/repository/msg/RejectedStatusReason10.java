...
import com.tools20022.repository.choice.RejectedReason5Choice;
...
@XmlType(name = "RejectedStatusReason10", propOrder = {"reasonCode", "additionalReasonInformation"})
public class RejectedStatusReason10 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected RejectedReason5Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<RejectedStatusReason10, RejectedReason5Choice> mmReasonCode = new MMMessageAssociationEnd<RejectedStatusReason10, RejectedReason5Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason13.mmReasonCode);
	...
	public static final MMMessageAttribute<RejectedStatusReason10, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectedStatusReason10, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason13.mmAdditionalReasonInformation);
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason10.mmReasonCode, com.tools20022.repository.msg.RejectedStatusReason10.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forRejectedStatusReason10);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatusReason10";
				definition = "Specifies reasons for the rejected status.";
				nextVersions_lazy = () -> Arrays.asList(RejectedStatusReason13.mmObject());
	...
	public RejectedReason5Choice getReasonCode() {
		return reasonCode;
	}

	public RejectedStatusReason10 setReasonCode(RejectedReason5Choice reasonCode) {
	...
	public RejectedStatusReason10 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
