...
public class Identification24 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Identification24.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification24.mmAccountOwnerTransactionIdentification, Identification24.mmAccountServicerTransactionIdentification,
						Identification24.mmMarketInfrastructureTransactionIdentification, Identification24.mmProcessorTransactionIdentification, Identification24.mmCommonIdentification, Identification24.mmTradeIdentification,
						Identification24.mmMasterIdentification, Identification24.mmBasketIdentification, Identification24.mmIndexIdentification, Identification24.mmListIdentification, Identification24.mmProgramIdentification,
						Identification24.mmPoolIdentification, Identification24.mmCorporateActionEventIdentification);
