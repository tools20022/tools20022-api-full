...
@XmlType(name = "OriginalPaymentInstruction10", propOrder = {"originalPaymentInformationCancellationIdentification", "resolvedCase", "originalPaymentInformationIdentification", "originalGroupInformation", "originalNumberOfTransactions",
...
public class OriginalPaymentInstruction10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction10, Optional<Max35Text>> mmOriginalPaymentInformationCancellationIdentification = new MMMessageAttribute<OriginalPaymentInstruction10, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalPaymentInformationCancellationIdentification);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmOriginalPaymentInformationCancellationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getOriginalPaymentInformationCancellationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction10, Optional<Case3>> mmResolvedCase = new MMMessageAssociationEnd<OriginalPaymentInstruction10, Optional<Case3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmResolvedCase);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmResolvedCase;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Case3> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getResolvedCase();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction10, Max35Text> mmOriginalPaymentInformationIdentification = new MMMessageAttribute<OriginalPaymentInstruction10, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalPaymentInformationIdentification);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmOriginalPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(OriginalPaymentInstruction10 obj) {
			return obj.getOriginalPaymentInformationIdentification();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction10, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction10, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalGroupInformation);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction10, Optional<Max15NumericText>> mmOriginalNumberOfTransactions = new MMMessageAttribute<OriginalPaymentInstruction10, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction10.mmObject();
			isDerived = false;
			xmlTag = "OrgnlNbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalNumberOfTransactions);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmOriginalNumberOfTransactions;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getOriginalNumberOfTransactions();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction10, Optional<DecimalNumber>> mmOriginalControlSum = new MMMessageAttribute<OriginalPaymentInstruction10, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction10.mmObject();
			isDerived = false;
			xmlTag = "OrgnlCtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmOriginalControlSum);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmOriginalControlSum;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getOriginalControlSum();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalPaymentInstruction10, Optional<GroupCancellationStatus1Code>> mmPaymentInformationCancellationStatus = new MMMessageAttribute<OriginalPaymentInstruction10, Optional<GroupCancellationStatus1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmPaymentInformationCancellationStatus);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmPaymentInformationCancellationStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<GroupCancellationStatus1Code> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getPaymentInformationCancellationStatus();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, Optional<GroupCancellationStatus1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction10, List<CancellationStatusReason2>> mmCancellationStatusReasonInformation = new MMMessageAssociationEnd<OriginalPaymentInstruction10, List<CancellationStatusReason2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmCancellationStatusReasonInformation);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmCancellationStatusReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<CancellationStatusReason2> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getCancellationStatusReasonInformation();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, List<CancellationStatusReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction10, List<NumberOfCancellationsPerStatus1>> mmNumberOfTransactionsPerCancellationStatus = new MMMessageAssociationEnd<OriginalPaymentInstruction10, List<NumberOfCancellationsPerStatus1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmNumberOfTransactionsPerCancellationStatus);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmNumberOfTransactionsPerCancellationStatus;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<NumberOfCancellationsPerStatus1> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getNumberOfTransactionsPerCancellationStatus();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, List<NumberOfCancellationsPerStatus1> value) {
			obj.setNumberOfTransactionsPerCancellationStatus(value);
		}
	};
	@XmlElement(name = "TxInfAndSts")
	protected List<PaymentTransaction54> transactionInformationAndStatus;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalPaymentInstruction10, List<PaymentTransaction54>> mmTransactionInformationAndStatus = new MMMessageAssociationEnd<OriginalPaymentInstruction10, List<PaymentTransaction54>>() {
		{
			businessComponentTrace_lazy = () -> Payment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalPaymentInstruction17.mmTransactionInformationAndStatus);
			previousVersion_lazy = () -> OriginalPaymentInstruction3.mmTransactionInformationAndStatus;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PaymentTransaction54.mmObject();
		}

		@Override
		public List<PaymentTransaction54> getValue(OriginalPaymentInstruction10 obj) {
			return obj.getTransactionInformationAndStatus();
		}

		@Override
		public void setValue(OriginalPaymentInstruction10 obj, List<PaymentTransaction54> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCancellationStatusReasonInformationRule.forOriginalPaymentInstruction10,
						com.tools20022.repository.constraints.ConstraintNumberOfTransactionsPerCancellationStatusGuideline.forOriginalPaymentInstruction10,
						com.tools20022.repository.constraints.ConstraintPaymentInformationOrTransactionResolvedCaseRule.forOriginalPaymentInstruction10);
	...
	public OriginalPaymentInstruction10 setOriginalPaymentInformationCancellationIdentification(Max35Text originalPaymentInformationCancellationIdentification) {
	...
	public OriginalPaymentInstruction10 setResolvedCase(Case3 resolvedCase) {
	...
	public OriginalPaymentInstruction10 setOriginalPaymentInformationIdentification(Max35Text originalPaymentInformationIdentification) {
	...
	public OriginalPaymentInstruction10 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public OriginalPaymentInstruction10 setOriginalNumberOfTransactions(Max15NumericText originalNumberOfTransactions) {
	...
	public OriginalPaymentInstruction10 setOriginalControlSum(DecimalNumber originalControlSum) {
	...
	public OriginalPaymentInstruction10 setPaymentInformationCancellationStatus(GroupCancellationStatus1Code paymentInformationCancellationStatus) {
	...
	public OriginalPaymentInstruction10 setCancellationStatusReasonInformation(List<CancellationStatusReason2> cancellationStatusReasonInformation) {
	...
	public OriginalPaymentInstruction10 setNumberOfTransactionsPerCancellationStatus(List<NumberOfCancellationsPerStatus1> numberOfTransactionsPerCancellationStatus) {
	...
	public OriginalPaymentInstruction10 setTransactionInformationAndStatus(List<PaymentTransaction54> transactionInformationAndStatus) {
