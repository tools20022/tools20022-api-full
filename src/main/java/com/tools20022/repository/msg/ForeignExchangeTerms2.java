...
public class ForeignExchangeTerms2 {
	...
	public static final MMMessageAttribute mmUnitCurrency = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ForeignExchangeTerms2.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
	...
	public PartyIdentification16Choice getQuotingInstitution() {
		return quotingInstitution;
	}

	public void setQuotingInstitution(PartyIdentification16Choice quotingInstitution) {
