...
public class ForeignExchangeTerms2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms2.mmUnitCurrency, ForeignExchangeTerms2.mmQuotedCurrency, ForeignExchangeTerms2.mmExchangeRate, ForeignExchangeTerms2.mmQuotationDate,
						ForeignExchangeTerms2.mmQuotingInstitution);
