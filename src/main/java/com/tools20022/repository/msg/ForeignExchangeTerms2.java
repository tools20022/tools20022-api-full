 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms2#mmQuotingInstitution
 * ForeignExchangeTerms2.mmQuotingInstitution}</li>
 * </ul>
 * </li>
...
@XmlType(name = "ForeignExchangeTerms2", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "quotationDate", "quotingInstitution"})
public class ForeignExchangeTerms2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms2
	 * ForeignExchangeTerms2}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms2, ActiveOrHistoricCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms2, ActiveOrHistoricCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms2.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ForeignExchangeTerms2 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms2 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms2, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms2, ActiveOrHistoricCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms2, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms2, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms2 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms2 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms2, Optional<ISODateTime>> mmQuotationDate = new MMMessageAttribute<ForeignExchangeTerms2, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(ForeignExchangeTerms2 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(ForeignExchangeTerms2 obj, Optional<ISODateTime> value) {
			obj.setQuotationDate(value.orElse(null));
		}
	};
	@XmlElement(name = "QtgInstn")
	protected PartyIdentification16Choice quotingInstitution;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeTerms2, Optional<PartyIdentification16Choice>> mmQuotingInstitution = new MMMessageAssociationEnd<ForeignExchangeTerms2, Optional<PartyIdentification16Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification16Choice> getValue(ForeignExchangeTerms2 obj) {
			return obj.getQuotingInstitution();
		}

		@Override
		public void setValue(ForeignExchangeTerms2 obj, Optional<PartyIdentification16Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms2.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms2.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms2.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms2.mmQuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms2.mmQuotingInstitution);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms2";
	...
	public ForeignExchangeTerms2 setUnitCurrency(ActiveOrHistoricCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms2 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms2 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms2 setQuotationDate(ISODateTime quotationDate) {
		this.quotationDate = quotationDate;
		return this;
	}

	public Optional<PartyIdentification16Choice> getQuotingInstitution() {
		return quotingInstitution == null ? Optional.empty() : Optional.of(quotingInstitution);
	}

	public ForeignExchangeTerms2 setQuotingInstitution(PartyIdentification16Choice quotingInstitution) {
