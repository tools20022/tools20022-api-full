 ...
 * CorporateActionStandingInstructionProcessingStatus1.AdditionalInformation}</li>
 * </ul>
 * </li>
...
public class CorporateActionStandingInstructionProcessingStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionStandingInstructionProcessingStatus1.Status,
						com.tools20022.repository.msg.CorporateActionStandingInstructionProcessingStatus1.AdditionalInformation);
