...
public class NetCashForecast2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetCashForecast2, ISODate> mmCashSettlementDate = new MMMessageAttribute<NetCashForecast2, ISODate>() {
		{
		...
		@Override
		public ISODate getValue(NetCashForecast2 obj) {
			return obj.getCashSettlementDate();
		}

		@Override
		public void setValue(NetCashForecast2 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetCashForecast2, Optional<ActiveOrHistoricCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<NetCashForecast2, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(NetCashForecast2 obj) {
			return obj.getNetAmount();
		}

		@Override
		public void setValue(NetCashForecast2 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetCashForecast2, Optional<FinancialInstrumentQuantity1>> mmNetUnitsNumber = new MMMessageAttribute<NetCashForecast2, Optional<FinancialInstrumentQuantity1>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity1> getValue(NetCashForecast2 obj) {
			return obj.getNetUnitsNumber();
		}

		@Override
		public void setValue(NetCashForecast2 obj, Optional<FinancialInstrumentQuantity1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetCashForecast2, FlowDirectionType1Code> mmFlowDirection = new MMMessageAttribute<NetCashForecast2, FlowDirectionType1Code>() {
		{
		...
		@Override
		public FlowDirectionType1Code getValue(NetCashForecast2 obj) {
			return obj.getFlowDirection();
		}

		@Override
		public void setValue(NetCashForecast2 obj, FlowDirectionType1Code value) {
	...
	public NetCashForecast2 setNetUnitsNumber(FinancialInstrumentQuantity1 netUnitsNumber) {
