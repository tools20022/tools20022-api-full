...
public class PartyIdentificationAndAccount134 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount134.mmIdentification, PartyIdentificationAndAccount134.mmLEI, PartyIdentificationAndAccount134.mmAlternateIdentification,
						PartyIdentificationAndAccount134.mmCashAccount, PartyIdentificationAndAccount134.mmChargesAccount, PartyIdentificationAndAccount134.mmCommissionAccount, PartyIdentificationAndAccount134.mmTaxAccount,
						PartyIdentificationAndAccount134.mmAdditionalInformation);
