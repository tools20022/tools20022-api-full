...
@XmlType(name = "GenericIdentification33", propOrder = {"identification", "type", "issuer", "shortName"})
public class GenericIdentification33 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification33, Optional<Max35Text>> mmIdentification = new MMMessageAttribute<GenericIdentification33, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification33.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of the entity.";
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification70.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification33 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification33 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification33, PartyType3Code> mmType = new MMMessageAttribute<GenericIdentification33, PartyType3Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification70.mmType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PartyType3Code getValue(GenericIdentification33 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification33 obj, PartyType3Code value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification33, Optional<PartyType4Code>> mmIssuer = new MMMessageAttribute<GenericIdentification33, Optional<PartyType4Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification70.mmIssuer);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyType4Code> getValue(GenericIdentification33 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification33 obj, Optional<PartyType4Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification33, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification33, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification70.mmShortName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification33.mmIdentification, com.tools20022.repository.msg.GenericIdentification33.mmType,
						com.tools20022.repository.msg.GenericIdentification33.mmIssuer, com.tools20022.repository.msg.GenericIdentification33.mmShortName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GenericIdentification33";
				definition = "Identification of an entity.";
				nextVersions_lazy = () -> Arrays.asList(GenericIdentification70.mmObject());
			}
		});
	...
	public GenericIdentification33 setIdentification(Max35Text identification) {
	...
	public GenericIdentification33 setType(PartyType3Code type) {
	...
	public GenericIdentification33 setIssuer(PartyType4Code issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification33 setShortName(Max35Text shortName) {
