...
public class PartyIdentification52 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification52.mmIdentification, PartyIdentification52.mmAlternateIdentification, PartyIdentification52.mmProcessingDate, PartyIdentification52.mmProcessingIdentification,
						PartyIdentification52.mmAdditionalInformation);
