...
public class LiquidityCreditTransfer1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(LiquidityCreditTransfer1.mmLiquidityTransferIdentification, LiquidityCreditTransfer1.mmCreditor, LiquidityCreditTransfer1.mmCreditorAccount,
						LiquidityCreditTransfer1.mmTransferredAmount, LiquidityCreditTransfer1.mmDebtor, LiquidityCreditTransfer1.mmDebtorAccount, LiquidityCreditTransfer1.mmSettlementDate);
