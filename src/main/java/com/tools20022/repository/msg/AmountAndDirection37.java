 ...
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection37#mmAmount
...
@XmlType(name = "AmountAndDirection37", propOrder = {"accruedInterestIndicator", "stampDutyIndicator", "brokerageAmountIndicator", "amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails", "valueDate"})
public class AmountAndDirection37 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>> mmAccruedInterestIndicator = new MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAccruedInterestIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection37.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmAccruedInterestIndicator);
			previousVersion_lazy = () -> AmountAndDirection32.mmAccruedInterestIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(AmountAndDirection37 obj) {
			return obj.getAccruedInterestIndicator();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>> mmStampDutyIndicator = new MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmStampDutyIndicator);
			previousVersion_lazy = () -> AmountAndDirection32.mmStampDutyIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>> mmBrokerageAmountIndicator = new MMMessageAttribute<AmountAndDirection37, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection37.mmObject();
			isDerived = false;
			xmlTag = "BrkrgAmtInd";
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmBrokerageAmountIndicator);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<ActiveCurrencyAndAmount>> mmAmount = new MMMessageAttribute<AmountAndDirection37, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmAmount);
			previousVersion_lazy = () -> AmountAndDirection32.mmAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(AmountAndDirection37 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection37, Optional<CreditDebitCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmCreditDebitIndicator);
			previousVersion_lazy = () -> AmountAndDirection32.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CreditDebitCode> getValue(AmountAndDirection37 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection37, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmOriginalCurrencyAndOrderedAmount);
			previousVersion_lazy = () -> AmountAndDirection32.mmOriginalCurrencyAndOrderedAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection37 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection37, Optional<ForeignExchangeTerms11>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection37, Optional<ForeignExchangeTerms11>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmForeignExchangeDetails);
			previousVersion_lazy = () -> AmountAndDirection32.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ForeignExchangeTerms11> getValue(AmountAndDirection37 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<ForeignExchangeTerms11> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection37, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAttribute<AmountAndDirection37, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmValueDate);
			previousVersion_lazy = () -> AmountAndDirection32.mmValueDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(AmountAndDirection37 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(AmountAndDirection37 obj, Optional<DateAndDateTimeChoice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection37.mmAccruedInterestIndicator, com.tools20022.repository.msg.AmountAndDirection37.mmStampDutyIndicator,
						com.tools20022.repository.msg.AmountAndDirection37.mmBrokerageAmountIndicator, com.tools20022.repository.msg.AmountAndDirection37.mmAmount, com.tools20022.repository.msg.AmountAndDirection37.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection37.mmOriginalCurrencyAndOrderedAmount, com.tools20022.repository.msg.AmountAndDirection37.mmForeignExchangeDetails,
						com.tools20022.repository.msg.AmountAndDirection37.mmValueDate);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection37);
				...
				name = "AmountAndDirection37";
				definition = "Posting of an item to a cash account, in the context of a cash transaction, that results in an increase or decrease to the balance of the account.";
				nextVersions_lazy = () -> Arrays.asList(AmountAndDirection45.mmObject());
				previousVersion_lazy = () -> AmountAndDirection32.mmObject();
			}
		});
	...
	public AmountAndDirection37 setAccruedInterestIndicator(YesNoIndicator accruedInterestIndicator) {
	...
	public AmountAndDirection37 setStampDutyIndicator(YesNoIndicator stampDutyIndicator) {
	...
	public AmountAndDirection37 setBrokerageAmountIndicator(YesNoIndicator brokerageAmountIndicator) {
	...
	public AmountAndDirection37 setAmount(ActiveCurrencyAndAmount amount) {
		this.amount = amount;
		return this;
	}
	...
	public AmountAndDirection37 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection37 setOriginalCurrencyAndOrderedAmount(ActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection37 setForeignExchangeDetails(ForeignExchangeTerms11 foreignExchangeDetails) {
	...
	public AmountAndDirection37 setValueDate(DateAndDateTimeChoice valueDate) {
