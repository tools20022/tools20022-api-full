...
public class PartyIdentification16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification16.mmName, PartyIdentification16.mmPostalAddress, PartyIdentification16.mmIdentification, PartyIdentification16.mmCountryOfResidence);
