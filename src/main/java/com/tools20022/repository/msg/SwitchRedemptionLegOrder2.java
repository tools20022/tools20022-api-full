 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SwitchRedemptionLegOrder2#mmLegIdentification
 * SwitchRedemptionLegOrder2.mmLegIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SwitchRedemptionLegOrder2#mmPhysicalDeliveryIndicator
 * SwitchRedemptionLegOrder2.mmPhysicalDeliveryIndicator}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalDeliveryDetailsRule#forSwitchRedemptionLegOrder2
 * ConstraintPhysicalDeliveryDetailsRule.forSwitchRedemptionLegOrder2}</li>
 * </ul>
 * </li>
 * <li>
...
public class SwitchRedemptionLegOrder2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<Max35Text>> mmLegIdentification = new MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmObject();
			isDerived = false;
			xmlTag = "LegId";
		...
		@Override
		public Optional<Max35Text> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getLegIdentification();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, FinancialInstrument6> mmFinancialInstrumentDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, FinancialInstrument6>() {
		{
		...
		@Override
		public FinancialInstrument6 getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, FinancialInstrument6 value) {
			obj.setFinancialInstrumentDetails(value);
		}
	};
	@XmlElement(name = "FinInstrmQtyChc")
	protected FinancialInstrumentQuantity3Choice financialInstrumentQuantityChoice;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<FinancialInstrumentQuantity3Choice>> mmFinancialInstrumentQuantityChoice = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<FinancialInstrumentQuantity3Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity3Choice.mmObject();
		}

		@Override
		public Optional<FinancialInstrumentQuantity3Choice> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getFinancialInstrumentQuantityChoice();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<FinancialInstrumentQuantity3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<IncomePreference1Code>> mmIncomePreference = new MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<IncomePreference1Code>>() {
		{
		...
		@Override
		public Optional<IncomePreference1Code> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getIncomePreference();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<IncomePreference1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<UKTaxGroupUnitCode>> mmGroup1Or2Units = new MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<UKTaxGroupUnitCode>>() {
		{
		...
		@Override
		public Optional<UKTaxGroupUnitCode> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getGroup1Or2Units();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<UKTaxGroupUnitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<CurrencyCode>> mmRequestedSettlementCurrency = new MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<CurrencyCode>>() {
		{
		...
		@Override
		public Optional<CurrencyCode> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getRequestedSettlementCurrency();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<CurrencyCode>> mmRequestedNAVCurrency = new MMMessageAttribute<SwitchRedemptionLegOrder2, Optional<CurrencyCode>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Charge8>> mmChargeDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Charge8>>() {
		{
		...
		@Override
		public List<Charge8> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, List<Charge8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Commission6>> mmCommissionDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Commission6>>() {
		{
		...
		@Override
		public List<Commission6> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, List<Commission6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Tax6>> mmTaxDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, List<Tax6>>() {
		{
		...
		@Override
		public List<Tax6> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, List<Tax6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<FundSettlementParameters3>> mmSettlementAndCustodyDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<FundSettlementParameters3>>() {
		{
		...
		@Override
		public Optional<FundSettlementParameters3> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getSettlementAndCustodyDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<FundSettlementParameters3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SwitchRedemptionLegOrder2, YesNoIndicator> mmPhysicalDeliveryIndicator = new MMMessageAttribute<SwitchRedemptionLegOrder2, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmObject();
			isDerived = false;
			xmlTag = "PhysDlvryInd";
		...
		@Override
		public YesNoIndicator getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getPhysicalDeliveryIndicator();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<DeliveryParameters3>> mmPhysicalDeliveryDetails = new MMMessageAssociationEnd<SwitchRedemptionLegOrder2, Optional<DeliveryParameters3>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters3> getValue(SwitchRedemptionLegOrder2 obj) {
			return obj.getPhysicalDeliveryDetails();
		}

		@Override
		public void setValue(SwitchRedemptionLegOrder2 obj, Optional<DeliveryParameters3> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmLegIdentification, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmFinancialInstrumentDetails,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmFinancialInstrumentQuantityChoice, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmIncomePreference,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmGroup1Or2Units, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmRequestedSettlementCurrency,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmRequestedNAVCurrency, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmChargeDetails,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmCommissionDetails, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmTaxDetails,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmSettlementAndCustodyDetails, com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmPhysicalDeliveryIndicator,
						com.tools20022.repository.msg.SwitchRedemptionLegOrder2.mmPhysicalDeliveryDetails);
				trace_lazy = () -> SwitchRedemptionLeg.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalDeliveryDetailsRule.forSwitchRedemptionLegOrder2);
				...
				name = "SwitchRedemptionLegOrder2";
	...
	public SwitchRedemptionLegOrder2 setLegIdentification(Max35Text legIdentification) {
	...
	public SwitchRedemptionLegOrder2 setFinancialInstrumentDetails(FinancialInstrument6 financialInstrumentDetails) {
		this.financialInstrumentDetails = Objects.requireNonNull(financialInstrumentDetails);
		return this;
	}

	public Optional<FinancialInstrumentQuantity3Choice> getFinancialInstrumentQuantityChoice() {
		return financialInstrumentQuantityChoice == null ? Optional.empty() : Optional.of(financialInstrumentQuantityChoice);
	}

	public SwitchRedemptionLegOrder2 setFinancialInstrumentQuantityChoice(FinancialInstrumentQuantity3Choice financialInstrumentQuantityChoice) {
	...
	public SwitchRedemptionLegOrder2 setIncomePreference(IncomePreference1Code incomePreference) {
	...
	public SwitchRedemptionLegOrder2 setGroup1Or2Units(UKTaxGroupUnitCode group1Or2Units) {
	...
	public SwitchRedemptionLegOrder2 setRequestedSettlementCurrency(CurrencyCode requestedSettlementCurrency) {
	...
	public SwitchRedemptionLegOrder2 setRequestedNAVCurrency(CurrencyCode requestedNAVCurrency) {
	...
	public SwitchRedemptionLegOrder2 setChargeDetails(List<Charge8> chargeDetails) {
	...
	public SwitchRedemptionLegOrder2 setCommissionDetails(List<Commission6> commissionDetails) {
	...
	public SwitchRedemptionLegOrder2 setTaxDetails(List<Tax6> taxDetails) {
	...
	public SwitchRedemptionLegOrder2 setSettlementAndCustodyDetails(FundSettlementParameters3 settlementAndCustodyDetails) {
	...
	public SwitchRedemptionLegOrder2 setPhysicalDeliveryIndicator(YesNoIndicator physicalDeliveryIndicator) {
	...
	public SwitchRedemptionLegOrder2 setPhysicalDeliveryDetails(DeliveryParameters3 physicalDeliveryDetails) {
