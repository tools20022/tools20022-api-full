...
public class AdditionalQueryParameters6 {
	...
	public static final MMMessageAssociationEnd mmStatus = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AdditionalQueryParameters6.mmObject();
			isDerived = false;
			xmlTag = "Sts";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalQueryParameters6.mmStatus, AdditionalQueryParameters6.mmReason, AdditionalQueryParameters6.mmFinancialInstrumentIdentification);
	...
	public void setReason(List<Reason11Choice> reason) {
		this.reason = reason;
	}
