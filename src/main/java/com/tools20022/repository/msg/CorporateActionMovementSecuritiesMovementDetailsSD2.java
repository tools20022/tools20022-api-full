...
public class CorporateActionMovementSecuritiesMovementDetailsSD2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionMovementSecuritiesMovementDetailsSD2.mmPlaceAndName, CorporateActionMovementSecuritiesMovementDetailsSD2.mmCreditDebitIndicator,
						CorporateActionMovementSecuritiesMovementDetailsSD2.mmTransactionQuantity, CorporateActionMovementSecuritiesMovementDetailsSD2.mmReasonCode, CorporateActionMovementSecuritiesMovementDetailsSD2.mmSubReasonCode,
						CorporateActionMovementSecuritiesMovementDetailsSD2.mmContraParticipantNumber, CorporateActionMovementSecuritiesMovementDetailsSD2.mmEarliestPaymentDate,
						CorporateActionMovementSecuritiesMovementDetailsSD2.mmTaxAdjustmentRate);
