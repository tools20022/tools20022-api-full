...
public class CorporateActionOption43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption43.OptionNumber, com.tools20022.repository.msg.CorporateActionOption43.OptionType,
						com.tools20022.repository.msg.CorporateActionOption43.InstructedOrQuantityToReceive);
