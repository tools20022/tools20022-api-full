...
public class CorporateActionOption43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption43.mmOptionNumber, CorporateActionOption43.mmOptionType, CorporateActionOption43.mmInstructedOrQuantityToReceive);
