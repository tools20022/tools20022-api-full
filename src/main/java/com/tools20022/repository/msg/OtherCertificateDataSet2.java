...
public class OtherCertificateDataSet2 {
	...
	public static final MMMessageAssociationEnd DataSetIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.DataSetIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CertificateIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.CertificateIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CertificateType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.CertificateType;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IssueDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.IssueDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Issuer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.Issuer;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CertificateInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OtherCertificateDataSet1.CertificateInformation;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherCertificateDataSet2.DataSetIdentification, com.tools20022.repository.msg.OtherCertificateDataSet2.CertificateIdentification,
						com.tools20022.repository.msg.OtherCertificateDataSet2.CertificateType, com.tools20022.repository.msg.OtherCertificateDataSet2.IssueDate, com.tools20022.repository.msg.OtherCertificateDataSet2.Issuer,
						com.tools20022.repository.msg.OtherCertificateDataSet2.CertificateInformation);
				trace_lazy = () -> TradeCertificate.mmObject();
				messageBuildingBlock_lazy = () -> Arrays
						.asList(com.tools20022.repository.area.tsmt.ForwardDataSetSubmissionReportV05.OtherCertificateDataSet, com.tools20022.repository.area.tsmt.DataSetSubmissionV05.OtherCertificateDataSet);
