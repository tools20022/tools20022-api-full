...
public class AmountAndDirection57 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection57.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection57.mmAmount, AmountAndDirection57.mmCreditDebitIndicator);
