		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ResolutionOfInvestigationV04.StatementDetails, com.tools20022.repository.area.camt.ResolutionOfInvestigationV05.StatementDetails,
						com.tools20022.repository.area.camt.ResolutionOfInvestigationV06.StatementDetails, com.tools20022.repository.area.camt.ResolutionOfInvestigationV07.StatementDetails);
