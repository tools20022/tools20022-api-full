...
@XmlType(name = "GenericIdentification168", propOrder = {"identification", "description", "issuer", "schemeName"})
public class GenericIdentification168 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification168, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification168, Max35Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification168.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Proprietary code that uniquely identifies the object or subject of interest.";
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification169.mmIdentification);
		...
		@Override
		public Max35Text getValue(GenericIdentification168 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification168 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification168, Max140Text> mmDescription = new MMMessageAttribute<GenericIdentification168, Max140Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification168.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification169.mmDescription);
		...
		@Override
		public Max140Text getValue(GenericIdentification168 obj) {
			return obj.getDescription();
		}

		@Override
		public void setValue(GenericIdentification168 obj, Max140Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification168, Optional<Max35Text>> mmIssuer = new MMMessageAttribute<GenericIdentification168, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification169.mmIssuer);
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification168 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification168 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification168, Optional<Max35Text>> mmSchemeName = new MMMessageAttribute<GenericIdentification168, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification169.mmSchemeName);
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification168.mmIdentification, com.tools20022.repository.msg.GenericIdentification168.mmDescription,
						com.tools20022.repository.msg.GenericIdentification168.mmIssuer, com.tools20022.repository.msg.GenericIdentification168.mmSchemeName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "GenericIdentification168";
				definition = "Identification using a proprietary scheme.";
				nextVersions_lazy = () -> Arrays.asList(GenericIdentification169.mmObject());
	...
	public GenericIdentification168 setIdentification(Max35Text identification) {
	...
	public GenericIdentification168 setDescription(Max140Text description) {
	...
	public GenericIdentification168 setIssuer(Max35Text issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification168 setSchemeName(Max35Text schemeName) {
