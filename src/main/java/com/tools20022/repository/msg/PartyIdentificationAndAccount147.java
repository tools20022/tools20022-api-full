...
public class PartyIdentificationAndAccount147 {
	...
	public static final MMMessageAttribute mmPartyIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount3.mmPartyIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAccountIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount3.mmAccountIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> PartyIdentificationAndAccount3.mmObject();
			}
		});
	...
	public PartyIdentificationAndAccount147 setPartyIdentification(com.tools20022.repository.msg.PartyIdentification113 partyIdentification) {
