...
public class AcceptorCompletionAdviceResponse4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCompletionAdviceResponse4.mmEnvironment, AcceptorCompletionAdviceResponse4.mmTransaction, AcceptorCompletionAdviceResponse4.mmTMSTrigger,
						AcceptorCompletionAdviceResponse4.mmSupplementaryData);
