...
@XmlType(name = "CardPaymentTransaction15", propOrder = {"transactionCapture", "merchantCategoryCode", "transactionIdentification", "originalTransaction", "reconciliationIdentification", "transactionDetails", "additionalTransactionData"})
public class CardPaymentTransaction15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction15, Optional<TrueFalseIndicator>> mmTransactionCapture = new MMMessageAttribute<CardPaymentTransaction15, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction15.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmTransactionCapture);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(CardPaymentTransaction15 obj) {
			return obj.getTransactionCapture();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction15, Min3Max4Text> mmMerchantCategoryCode = new MMMessageAttribute<CardPaymentTransaction15, Min3Max4Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmMerchantCategoryCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Min3Max4Text getValue(CardPaymentTransaction15 obj) {
			return obj.getMerchantCategoryCode();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, Min3Max4Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction15, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction15, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction15 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction15, CardPaymentTransaction17> mmOriginalTransaction = new MMMessageAssociationEnd<CardPaymentTransaction15, CardPaymentTransaction17>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmOriginalTransaction);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransaction17 getValue(CardPaymentTransaction15 obj) {
			return obj.getOriginalTransaction();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, CardPaymentTransaction17 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction15, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction15, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmReconciliationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction15 obj) {
			return obj.getReconciliationIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction15, CardPaymentTransactionDetails5> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction15, CardPaymentTransactionDetails5>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction15.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmTransactionDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransactionDetails5 getValue(CardPaymentTransaction15 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, CardPaymentTransactionDetails5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction15, List<Max70Text>> mmAdditionalTransactionData = new MMMessageAttribute<CardPaymentTransaction15, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction15.mmObject();
			isDerived = false;
			xmlTag = "AddtlTxData";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction26.mmAdditionalTransactionData);
			minOccurs = 0;
			simpleType_lazy = () -> Max70Text.mmObject();
		}

		@Override
		public List<Max70Text> getValue(CardPaymentTransaction15 obj) {
			return obj.getAdditionalTransactionData();
		}

		@Override
		public void setValue(CardPaymentTransaction15 obj, List<Max70Text> value) {
	...
	public CardPaymentTransaction15 setTransactionCapture(TrueFalseIndicator transactionCapture) {
	...
	public CardPaymentTransaction15 setMerchantCategoryCode(Min3Max4Text merchantCategoryCode) {
	...
	public CardPaymentTransaction15 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction15 setOriginalTransaction(CardPaymentTransaction17 originalTransaction) {
	...
	public CardPaymentTransaction15 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction15 setTransactionDetails(CardPaymentTransactionDetails5 transactionDetails) {
	...
	public CardPaymentTransaction15 setAdditionalTransactionData(List<Max70Text> additionalTransactionData) {
