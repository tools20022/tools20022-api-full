 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction15#TransactionCapture
 * CardPaymentTransaction15.TransactionCapture}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction15#AdditionalTransactionData
 * CardPaymentTransaction15.AdditionalTransactionData}</li>
 * </ul>
 * </li>
...
public class CardPaymentTransaction15 {
	...
	public static final MMMessageAttribute TransactionCapture = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.TransactionCapture);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.MerchantCategoryCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.TransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.OriginalTransaction);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.ReconciliationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.TransactionDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction26.AdditionalTransactionData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction15.TransactionCapture, com.tools20022.repository.msg.CardPaymentTransaction15.MerchantCategoryCode,
						com.tools20022.repository.msg.CardPaymentTransaction15.TransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction15.OriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction15.ReconciliationIdentification, com.tools20022.repository.msg.CardPaymentTransaction15.TransactionDetails,
						com.tools20022.repository.msg.CardPaymentTransaction15.AdditionalTransactionData);
