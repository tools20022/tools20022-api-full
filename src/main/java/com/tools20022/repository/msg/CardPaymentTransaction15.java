...
public class CardPaymentTransaction15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction15.mmTransactionCapture, CardPaymentTransaction15.mmMerchantCategoryCode, CardPaymentTransaction15.mmTransactionIdentification,
						CardPaymentTransaction15.mmOriginalTransaction, CardPaymentTransaction15.mmReconciliationIdentification, CardPaymentTransaction15.mmTransactionDetails, CardPaymentTransaction15.mmAdditionalTransactionData);
