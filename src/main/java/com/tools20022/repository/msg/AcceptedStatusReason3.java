...
@XmlType(name = "AcceptedStatusReason3", propOrder = {"reasonCode", "additionalReasonInformation"})
public class AcceptedStatusReason3 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected AcceptedReason3Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedStatusReason3, AcceptedReason3Choice> mmReasonCode = new MMMessageAssociationEnd<AcceptedStatusReason3, AcceptedReason3Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptedStatusReason3.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> AcceptedReason3Choice.mmObject();
		}

		@Override
		public AcceptedReason3Choice getValue(AcceptedStatusReason3 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(AcceptedStatusReason3 obj, AcceptedReason3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedStatusReason3, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcceptedStatusReason3, Optional<Max210Text>>() {
		{
		...
		@Override
		public Optional<Max210Text> getValue(AcceptedStatusReason3 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(AcceptedStatusReason3 obj, Optional<Max210Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forAcceptedStatusReason3);
	...
	public AcceptedReason3Choice getReasonCode() {
		return reasonCode;
	}

	public AcceptedStatusReason3 setReasonCode(AcceptedReason3Choice reasonCode) {
	...
	public AcceptedStatusReason3 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
