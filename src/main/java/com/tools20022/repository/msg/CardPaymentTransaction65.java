...
public class CardPaymentTransaction65 {
	...
	public static final MMMessageAttribute<CardPaymentTransaction65, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction65, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction73.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction50.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<CardPaymentTransaction65, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction65, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction73.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction50.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CardPaymentTransaction65, GenericIdentification32> mmPOIIdentification = new MMMessageAssociationEnd<CardPaymentTransaction65, GenericIdentification32>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction73.mmPOIIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction50.mmPOIIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CardPaymentTransaction65, CurrencyConversion7> mmCurrencyConversion = new MMMessageAssociationEnd<CardPaymentTransaction65, CurrencyConversion7>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction73.mmCurrencyConversion);
			previousVersion_lazy = () -> CardPaymentTransaction50.mmCurrencyConversion;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public CardPaymentTransaction65 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
