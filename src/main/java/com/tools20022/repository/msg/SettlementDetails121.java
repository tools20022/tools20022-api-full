...
public class SettlementDetails121 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<HoldIndicator6>> mmHoldIndicator = new MMMessageAssociationEnd<SettlementDetails121, Optional<HoldIndicator6>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails121.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "HoldIndicator";
			definition = "Specifies whether the transaction is on hold/blocked/frozen.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmHoldIndicator);
			previousVersion_lazy = () -> SettlementDetails95.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<HoldIndicator6> getValue(SettlementDetails121 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<HoldIndicator6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails121, List<SettlementTransactionCondition16Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails95.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails121 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails121 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, SecuritiesTransactionType32Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails121, SecuritiesTransactionType32Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmSecuritiesTransactionType);
			previousVersion_lazy = () -> SettlementDetails95.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesTransactionType32Choice getValue(SettlementDetails121 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails121 obj, SecuritiesTransactionType32Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails121, Optional<SettlingCapacity7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails95.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails121 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails121, Optional<GenericIdentification30>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails95.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails121 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails121, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails95.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails121 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails121, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmRegistration);
			previousVersion_lazy = () -> SettlementDetails95.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails121 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails121, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails95.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails121 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<ExposureType16Choice>> mmExposureType = new MMMessageAssociationEnd<SettlementDetails121, Optional<ExposureType16Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmExposureType);
			previousVersion_lazy = () -> SettlementDetails95.mmExposureType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ExposureType16Choice> getValue(SettlementDetails121 obj) {
			return obj.getExposureType();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<ExposureType16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails121, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails95.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails121 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails121, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails95.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails121 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<RepurchaseType22Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails121, Optional<RepurchaseType22Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmRepurchaseType);
			previousVersion_lazy = () -> SettlementDetails95.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType22Choice> getValue(SettlementDetails121 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<RepurchaseType22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<MarketClientSide4Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails121, Optional<MarketClientSide4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails95.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide4Choice> getValue(SettlementDetails121 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<MarketClientSide4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails121, Optional<BlockTrade4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails95.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails121 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails121, Optional<Restriction5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails95.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails121 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails121, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails95.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails121 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails121, Optional<NettingEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails95.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails121 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails121, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails95.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails121 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails121, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails121, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmLetterOfGuarantee);
			previousVersion_lazy = () -> SettlementDetails95.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails121 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails121, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails121, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails121.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails95.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails121 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails121, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails121, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmEligibleForCollateral);
			previousVersion_lazy = () -> SettlementDetails95.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails121 obj) {
			return obj.getEligibleForCollateral();
		}

		@Override
		public void setValue(SettlementDetails121 obj, Optional<YesNoIndicator> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails121.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails121.mmSettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails121.mmSecuritiesTransactionType, com.tools20022.repository.msg.SettlementDetails121.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails121.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails121.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails121.mmRegistration,
						com.tools20022.repository.msg.SettlementDetails121.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails121.mmExposureType, com.tools20022.repository.msg.SettlementDetails121.mmCashClearingSystem,
						com.tools20022.repository.msg.SettlementDetails121.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails121.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails121.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails121.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails121.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails121.mmSettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails121.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails121.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails121.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails121.mmPartialSettlementIndicator, com.tools20022.repository.msg.SettlementDetails121.mmEligibleForCollateral);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails121,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails121);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails121";
				definition = "Details of settlement of a transaction.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails143.mmObject());
				previousVersion_lazy = () -> SettlementDetails95.mmObject();
			}
		});
	...
	public SettlementDetails121 setHoldIndicator(HoldIndicator6 holdIndicator) {
	...
	public SettlementDetails121 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails121 setSecuritiesTransactionType(SecuritiesTransactionType32Choice securitiesTransactionType) {
	...
	public SettlementDetails121 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails121 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails121 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails121 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails121 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails121 setExposureType(ExposureType16Choice exposureType) {
	...
	public SettlementDetails121 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails121 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails121 setRepurchaseType(RepurchaseType22Choice repurchaseType) {
	...
	public SettlementDetails121 setMarketClientSide(MarketClientSide4Choice marketClientSide) {
	...
	public SettlementDetails121 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails121 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails121 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails121 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails121 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails121 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails121 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails121 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
