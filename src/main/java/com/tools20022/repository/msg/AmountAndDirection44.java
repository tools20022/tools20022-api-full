...
public class AmountAndDirection44 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection44.mmAmount, AmountAndDirection44.mmCreditDebitIndicator, AmountAndDirection44.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection44.mmForeignExchangeDetails);
