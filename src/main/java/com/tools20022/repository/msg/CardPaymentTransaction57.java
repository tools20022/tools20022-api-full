...
public class CardPaymentTransaction57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction57.mmSaleReferenceIdentification, CardPaymentTransaction57.mmTransactionIdentification, CardPaymentTransaction57.mmInitiatorTransactionIdentification,
						CardPaymentTransaction57.mmRecipientTransactionIdentification, CardPaymentTransaction57.mmReconciliationIdentification, CardPaymentTransaction57.mmInterchangeData, CardPaymentTransaction57.mmTransactionDetails);
