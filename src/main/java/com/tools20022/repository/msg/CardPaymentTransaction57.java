 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentTransaction57#InitiatorTransactionIdentification
 * CardPaymentTransaction57.InitiatorTransactionIdentification}</li>
 * <li>
...
public class CardPaymentTransaction57 {
	...
	public static final MMMessageAttribute SaleReferenceIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction57.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SaleReferenceIdentification";
			definition = "Global reference of the sale transaction for the sale system.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.SaleReferenceIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.TransactionIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RecipientTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.RecipientTransactionIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.ReconciliationIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute InterchangeData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.InterchangeData;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction42.TransactionDetails;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction57.SaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction57.TransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction57.InitiatorTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction57.RecipientTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction57.ReconciliationIdentification, com.tools20022.repository.msg.CardPaymentTransaction57.InterchangeData,
						com.tools20022.repository.msg.CardPaymentTransaction57.TransactionDetails);
