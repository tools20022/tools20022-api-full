...
@XmlType(name = "PendingStatusReason2", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason2 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason4Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingStatusReason2, PendingReason4Choice> mmReasonCode = new MMMessageAssociationEnd<PendingStatusReason2, PendingReason4Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingStatusReason2.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason9.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PendingReason4Choice getValue(PendingStatusReason2 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(PendingStatusReason2 obj, PendingReason4Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingStatusReason2, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingStatusReason2, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason9.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(PendingStatusReason2 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingStatusReason2 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason2.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason2.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason2);
	...
	public PendingReason4Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason2 setReasonCode(PendingReason4Choice reasonCode) {
	...
	public PendingStatusReason2 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
