...
public class PendingStatusReason2 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason9.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason9.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setReasonCode(PendingReason4Choice reasonCode) {
