 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters8
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters8}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters8", propOrder = {"partialSettlement", "previousPartialConfirmationIdentification", "accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "poolIdentification",
...
public class AdditionalParameters8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<PartialSettlement1Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters8, Optional<PartialSettlement1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmPartialSettlementType;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters8.mmObject();
			isDerived = false;
			xmlTag = "PrtlSttlm";
		...
		@Override
		public Optional<PartialSettlement1Code> getValue(AdditionalParameters8 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters8 obj, Optional<PartialSettlement1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(AdditionalParameters8 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters8 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<AdditionalParameters8, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters8.mmPartialSettlement, com.tools20022.repository.msg.AdditionalParameters8.mmPreviousPartialConfirmationIdentification,
						com.tools20022.repository.msg.AdditionalParameters8.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters8.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.AdditionalParameters8.mmPoolIdentification, com.tools20022.repository.msg.AdditionalParameters8.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.AdditionalParameters8.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.AdditionalParameters8.mmProcessorTransactionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementConfirmationV02.mmAdditionalParameters);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters8);
				...
				name = "AdditionalParameters8";
				definition = "Specifies additional parameters to the message or transaction.";
				nextVersions_lazy = () -> Arrays.asList(AdditionalParameters10.mmObject());
			}
		});
	...
	public AdditionalParameters8 setPartialSettlement(PartialSettlement1Code partialSettlement) {
	...
	public AdditionalParameters8 setPreviousPartialConfirmationIdentification(Max35Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters8 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public AdditionalParameters8 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public AdditionalParameters8 setPoolIdentification(Max35Text poolIdentification) {
	...
	public AdditionalParameters8 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public AdditionalParameters8 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public AdditionalParameters8 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
