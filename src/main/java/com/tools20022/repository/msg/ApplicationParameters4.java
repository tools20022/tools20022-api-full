	...
	public static final MMMessageAttribute mmApplicationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ApplicationParameters5.mmApplicationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ApplicationParameters3.mmApplicationIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmVersion = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ApplicationParameters5.mmVersion);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ApplicationParameters3.mmVersion;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmParameters = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ApplicationParameters5.mmParameters);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ApplicationParameters3.mmParameters;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmEncryptedParameters = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ApplicationParameters5.mmEncryptedParameters);
			previousVersion_lazy = () -> com.tools20022.repository.msg.ApplicationParameters3.mmEncryptedParameters;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
