...
public class ApplicationParameters4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ApplicationParameters4.mmApplicationIdentification, ApplicationParameters4.mmVersion, ApplicationParameters4.mmParameters, ApplicationParameters4.mmEncryptedParameters);
