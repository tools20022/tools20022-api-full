...
public class CorporateActionGeneralInformation90 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation90.mmCorporateActionEventIdentification, CorporateActionGeneralInformation90.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation90.mmEventType, CorporateActionGeneralInformation90.mmFinancialInstrumentIdentification);
