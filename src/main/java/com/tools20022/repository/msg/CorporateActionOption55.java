...
public class CorporateActionOption55 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption55.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	public void setOfferType(List<OfferTypeFormat4Choice> offerType) {
	...
	public IntermediateSecuritiesDistributionTypeFormat10Choice getIntermediateSecuritiesDistributionType() {
		return intermediateSecuritiesDistributionType;
	}

	public void setIntermediateSecuritiesDistributionType(IntermediateSecuritiesDistributionTypeFormat10Choice intermediateSecuritiesDistributionType) {
	...
	public CorporateActionRate40 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate40 rateAndAmountDetails) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption39> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption28> cashMovementDetails) {
