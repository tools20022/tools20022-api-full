...
public class CommonData1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CommonData1.mmEnvironment, CommonData1.mmContext, CommonData1.mmTransactionType, CommonData1.mmAdditionalService, CommonData1.mmServiceAttribute, CommonData1.mmMerchantCategoryCode,
						CommonData1.mmReconciliationIdentification, CommonData1.mmCurrency);
