...
public class SettlementDetails108 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails108.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementTransactionAllegementNotification002V05.mmSettlementParameters);
	...
	public void setSecuritiesTransactionType(SecuritiesTransactionType22Choice securitiesTransactionType) {
