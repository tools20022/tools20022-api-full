...
public class SettlementDetails108 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails108.mmHoldIndicator, SettlementDetails108.mmSecuritiesTransactionType, SettlementDetails108.mmSettlementTransactionCondition,
						SettlementDetails108.mmPartialSettlementIndicator, SettlementDetails108.mmBeneficialOwnership, SettlementDetails108.mmCashClearingSystem, SettlementDetails108.mmMarketClientSide, SettlementDetails108.mmRegistration,
						SettlementDetails108.mmRepurchaseType, SettlementDetails108.mmSecuritiesRTGS, SettlementDetails108.mmStampDutyTaxBasis);
