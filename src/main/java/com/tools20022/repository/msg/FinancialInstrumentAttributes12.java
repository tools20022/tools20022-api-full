...
public class FinancialInstrumentAttributes12 {
	...
	public static final MMMessageAssociationEnd mmTradingPeriod = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Period3.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes12.mmSecurityIdentification, FinancialInstrumentAttributes12.mmQuantity, FinancialInstrumentAttributes12.mmRenounceableEntitlementStatusType,
						FinancialInstrumentAttributes12.mmFractionDisposition, FinancialInstrumentAttributes12.mmIntermediateSecuritiesToUnderlyingRatio, FinancialInstrumentAttributes12.mmMarketPrice,
						FinancialInstrumentAttributes12.mmExpiryDate, FinancialInstrumentAttributes12.mmPostingDate, FinancialInstrumentAttributes12.mmTradingPeriod, FinancialInstrumentAttributes12.mmUninstructedBalance,
						FinancialInstrumentAttributes12.mmInstructedBalance);
	...
	public FractionDispositionType5Choice getFractionDisposition() {
		return fractionDisposition;
	}

	public void setFractionDisposition(FractionDispositionType5Choice fractionDisposition) {
	...
	public void setExpiryDate(DateFormat8Choice expiryDate) {
	...
	public void setPostingDate(DateFormat8Choice postingDate) {
