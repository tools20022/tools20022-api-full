...
public class TransferOut14 {
	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransferOut14.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual transfers as assigned by the instructing party. This identifier links the individual transfers together.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut16.mmMasterReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransferOut12.mmMasterReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransferDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut16.mmTransferDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransferOut12.mmTransferDetails;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut16.mmAccountDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransferOut12.mmAccountDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut16.mmSettlementDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransferOut12.mmSettlementDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ReceiveInformation14.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmExtension = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut16.mmExtension);
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransferOut12.mmExtension;
			minOccurs = 0;
			isComposite = true;
	...
	public void setSettlementDetails(com.tools20022.repository.msg.ReceiveInformation14 settlementDetails) {
