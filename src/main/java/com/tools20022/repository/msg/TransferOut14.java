...
public class TransferOut14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferOut14.mmMasterReference, TransferOut14.mmTransferDetails, TransferOut14.mmAccountDetails, TransferOut14.mmSettlementDetails, TransferOut14.mmExtension);
