...
public class PendingReason25 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingReason25.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingReason25.mmCode, PendingReason25.mmAdditionalReasonInformation);
	...
	public void setCode(PendingReason42Choice code) {
		this.code = code;
	}
