...
public class IntraPositionDetails30 {
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionDetails30.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlc";
	...
	protected List<com.tools20022.repository.msg.IntraPositionMovementDetails10> intraPositionMovement;
	/**
	...
	public static final MMMessageAssociationEnd mmIntraPositionMovement = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.IntraPositionMovementDetails10.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails30.mmSafekeepingPlace, IntraPositionDetails30.mmBalanceFrom, IntraPositionDetails30.mmIntraPositionMovement);
	...
	public void setIntraPositionMovement(List<com.tools20022.repository.msg.IntraPositionMovementDetails10> intraPositionMovement) {
