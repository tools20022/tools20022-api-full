...
public class IntraPositionDetails30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails30.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails30.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails30.IntraPositionMovement);
