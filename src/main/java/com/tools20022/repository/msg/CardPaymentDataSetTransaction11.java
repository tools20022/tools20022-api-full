...
public class CardPaymentDataSetTransaction11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction11.mmTransactionSequenceCounter, CardPaymentDataSetTransaction11.mmTraceability, CardPaymentDataSetTransaction11.mmEnvironment,
						CardPaymentDataSetTransaction11.mmContext, CardPaymentDataSetTransaction11.mmTransaction);
