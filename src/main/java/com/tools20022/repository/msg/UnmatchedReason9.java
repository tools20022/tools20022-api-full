...
public class UnmatchedReason9 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason9.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason9.mmCode, UnmatchedReason9.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason13Choice code) {
		this.code = code;
	}
