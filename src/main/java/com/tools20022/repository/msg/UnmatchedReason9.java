...
public class UnmatchedReason9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnmatchedReason9.Code, com.tools20022.repository.msg.UnmatchedReason9.AdditionalReasonInformation);
