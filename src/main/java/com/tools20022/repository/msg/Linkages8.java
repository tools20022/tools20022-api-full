...
import com.tools20022.repository.choice.References14Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages8#mmProcessingPosition
 * Linkages8.mmProcessingPosition}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages8#mmMessageNumber
 * Linkages8.mmMessageNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages8#mmReference
 * Linkages8.mmReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Linkages8#mmReferenceOwner
 * Linkages8.mmReferenceOwner}</li>
 * </ul>
 * </li>
...
@XmlType(name = "Linkages8", propOrder = {"processingPosition", "messageNumber", "reference", "referenceOwner"})
public class Linkages8 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Linkages8
	 * Linkages8}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages8, Optional<ProcessingPosition1Choice>> mmProcessingPosition = new MMMessageAssociationEnd<Linkages8, Optional<ProcessingPosition1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages8.mmObject();
			isDerived = false;
			xmlTag = "PrcgPos";
		...
		@Override
		public Optional<ProcessingPosition1Choice> getValue(Linkages8 obj) {
			return obj.getProcessingPosition();
		}

		@Override
		public void setValue(Linkages8 obj, Optional<ProcessingPosition1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages8, Optional<DocumentNumber1Choice>> mmMessageNumber = new MMMessageAssociationEnd<Linkages8, Optional<DocumentNumber1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages8.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
		...
		@Override
		public Optional<DocumentNumber1Choice> getValue(Linkages8 obj) {
			return obj.getMessageNumber();
		}

		@Override
		public void setValue(Linkages8 obj, Optional<DocumentNumber1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages8, References14Choice> mmReference = new MMMessageAssociationEnd<Linkages8, References14Choice>() {
		{
		...
		@Override
		public References14Choice getValue(Linkages8 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(Linkages8 obj, References14Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages8, Optional<PartyIdentification36Choice>> mmReferenceOwner = new MMMessageAssociationEnd<Linkages8, Optional<PartyIdentification36Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(Linkages8 obj) {
			return obj.getReferenceOwner();
		}

		@Override
		public void setValue(Linkages8 obj, Optional<PartyIdentification36Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Linkages8.mmProcessingPosition, com.tools20022.repository.msg.Linkages8.mmMessageNumber, com.tools20022.repository.msg.Linkages8.mmReference,
						com.tools20022.repository.msg.Linkages8.mmReferenceOwner);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementInstructionV02.mmLinkages);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Linkages8";
				definition = "Information related to a linked transaction.";
				nextVersions_lazy = () -> Arrays.asList(Linkages19.mmObject());
			}
		});
	...
	public Linkages8 setProcessingPosition(ProcessingPosition1Choice processingPosition) {
	...
	public Linkages8 setMessageNumber(DocumentNumber1Choice messageNumber) {
	...
	public Linkages8 setReference(References14Choice reference) {
	...
	public Linkages8 setReferenceOwner(PartyIdentification36Choice referenceOwner) {
