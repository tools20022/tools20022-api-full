...
public class GroupHeader15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader15.mmMessageIdentification, GroupHeader15.mmCreationDateTime, GroupHeader15.mmBatchBooking, GroupHeader15.mmNumberOfTransactions, GroupHeader15.mmControlSum,
						GroupHeader15.mmTotalInterbankSettlementAmount, GroupHeader15.mmInterbankSettlementDate, GroupHeader15.mmSettlementInformation, GroupHeader15.mmPaymentTypeInformation, GroupHeader15.mmInstructingAgent,
						GroupHeader15.mmInstructedAgent);
