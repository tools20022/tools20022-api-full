...
public class FinancialInstrumentAttributesSD13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributesSD13.mmPlaceAndName, FinancialInstrumentAttributesSD13.mmDTCSecurityTransferableFlag,
						FinancialInstrumentAttributesSD13.mmDeclaredDisbursedSecurityDetails, FinancialInstrumentAttributesSD13.mmDTCDisbursedSecurityAssetType, FinancialInstrumentAttributesSD13.mmDTCDisbursedSecurityAssetClass,
						FinancialInstrumentAttributesSD13.mmBabyBondDenomination);
