 ...
 * <li>{@linkplain com.tools20022.repository.msg.MessageHeader3#mmRequestType
 ...
 * <li>{@linkplain com.tools20022.repository.msg.MessageHeader3#mmQueryName
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.MessageHeader7 MessageHeader7}</li>
 * </ul>
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "MessageHeader3", propOrder = {"messageIdentification", "creationDateTime", "requestType", "originalBusinessQuery", "queryName"})
public class MessageHeader3 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.MessageHeader3 MessageHeader3}</li>
	...
	public static final MMMessageAttribute<MessageHeader3, Max35Text> mmMessageIdentification = new MMMessageAttribute<MessageHeader3, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<MessageHeader3, Optional<ISODateTime>> mmCreationDateTime = new MMMessageAttribute<MessageHeader3, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmCreationDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.MessageHeader7#mmRequestType
	...
	public static final MMMessageAttribute<MessageHeader3, Optional<RequestType2Choice>> mmRequestType = new MMMessageAttribute<MessageHeader3, Optional<RequestType2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmRequestType);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<MessageHeader3, Optional<OriginalBusinessQuery1>> mmOriginalBusinessQuery = new MMMessageAssociationEnd<MessageHeader3, Optional<OriginalBusinessQuery1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmOriginalBusinessQuery);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<MessageHeader3, Optional<Max35Text>> mmQueryName = new MMMessageAttribute<MessageHeader3, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmQueryName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(PartyReportV01.mmMessageHeader);
				...
				nextVersions_lazy = () -> Arrays.asList(MessageHeader7.mmObject());
			}
		});
	...
	public MessageHeader3 setMessageIdentification(Max35Text messageIdentification) {
	...
	public MessageHeader3 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public MessageHeader3 setRequestType(RequestType2Choice requestType) {
	...
	public MessageHeader3 setQueryName(Max35Text queryName) {
