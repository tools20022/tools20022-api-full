...
public class ISATransfer26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer26.mmMasterReference, ISATransfer26.mmTransferConfirmationIdentification, ISATransfer26.mmTransferInstructionReference, ISATransfer26.mmClientReference,
						ISATransfer26.mmCounterpartyReference, ISATransfer26.mmBusinessFlowType, ISATransfer26.mmActualTransferDate, ISATransfer26.mmResidualCash, ISATransfer26.mmPortfolio, ISATransfer26.mmAllOtherCash,
						ISATransfer26.mmFinancialInstrumentAssetForTransfer);
	...
	public void setFinancialInstrumentAssetForTransfer(List<com.tools20022.repository.msg.FinancialInstrument48> financialInstrumentAssetForTransfer) {
