...
public class SecuritiesSettlementTransactionDetails5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails5.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails5.mmLinkages,
						SecuritiesSettlementTransactionDetails5.mmTradeDetails, SecuritiesSettlementTransactionDetails5.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails5.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails5.mmSettlementParameters, SecuritiesSettlementTransactionDetails5.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionDetails5.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionDetails5.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails5.mmCashParties, SecuritiesSettlementTransactionDetails5.mmSettlementAmount,
						SecuritiesSettlementTransactionDetails5.mmOtherAmounts, SecuritiesSettlementTransactionDetails5.mmOtherBusinessParties, SecuritiesSettlementTransactionDetails5.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionDetails5.mmSupplementaryData);
