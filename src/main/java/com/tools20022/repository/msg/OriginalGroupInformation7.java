...
@XmlType(name = "OriginalGroupInformation7", propOrder = {"originalMessageIdentification", "originalMessageNameIdentification"})
public class OriginalGroupInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation7, Max35Text> mmOriginalMessageIdentification = new MMMessageAttribute<OriginalGroupInformation7, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation7.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgId";
		...
		@Override
		public Max35Text getValue(OriginalGroupInformation7 obj) {
			return obj.getOriginalMessageIdentification();
		}

		@Override
		public void setValue(OriginalGroupInformation7 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OriginalGroupInformation7, Max35Text> mmOriginalMessageNameIdentification = new MMMessageAttribute<OriginalGroupInformation7, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalGroupInformation7.mmObject();
			isDerived = false;
			xmlTag = "OrgnlMsgNmId";
	...
	public OriginalGroupInformation7 setOriginalMessageIdentification(Max35Text originalMessageIdentification) {
	...
	public OriginalGroupInformation7 setOriginalMessageNameIdentification(Max35Text originalMessageNameIdentification) {
