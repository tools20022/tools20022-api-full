 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence1Rule#forReferences9
 * ConstraintReferencePresence1Rule.forReferences9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence2Rule#forReferences9
 * ConstraintReferencePresence2Rule.forReferences9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence3Rule#forReferences9
 * ConstraintReferencePresence3Rule.forReferences9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence4Rule#forReferences9
 * ConstraintReferencePresence4Rule.forReferences9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence5Rule#forReferences9
 * ConstraintReferencePresence5Rule.forReferences9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReferencePresence6Rule#forReferences9
 * ConstraintReferencePresence6Rule.forReferences9}</li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.References7
 * References7}</li>
 * </ul>
 */
...
public class References9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.References9.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(References9 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(References9 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmMarketInfrastructureTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmProcessorTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmCommonIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References9, Optional<Max35Text>> mmTradeIdentification = new MMMessageAttribute<References9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References16.mmTradeIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.References9.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.References9.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.References9.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.References9.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.References9.mmPoolIdentification, com.tools20022.repository.msg.References9.mmCommonIdentification, com.tools20022.repository.msg.References9.mmTradeIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReferencePresence1Rule.forReferences9, com.tools20022.repository.constraints.ConstraintReferencePresence2Rule.forReferences9,
						com.tools20022.repository.constraints.ConstraintReferencePresence3Rule.forReferences9, com.tools20022.repository.constraints.ConstraintReferencePresence4Rule.forReferences9,
						com.tools20022.repository.constraints.ConstraintReferencePresence5Rule.forReferences9, com.tools20022.repository.constraints.ConstraintReferencePresence6Rule.forReferences9,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forReferences9);
				...
				nextVersions_lazy = () -> Arrays.asList(References16.mmObject());
				previousVersion_lazy = () -> References7.mmObject();
			}
		});
	...
	public References9 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public References9 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References9 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public References9 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public References9 setPoolIdentification(Max35Text poolIdentification) {
	...
	public References9 setCommonIdentification(Max35Text commonIdentification) {
	...
	public References9 setTradeIdentification(Max35Text tradeIdentification) {
