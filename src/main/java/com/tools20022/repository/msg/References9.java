...
public class References9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References9.mmAccountOwnerTransactionIdentification, References9.mmAccountServicerTransactionIdentification, References9.mmMarketInfrastructureTransactionIdentification,
						References9.mmProcessorTransactionIdentification, References9.mmPoolIdentification, References9.mmCommonIdentification, References9.mmTradeIdentification);
