...
@XmlType(name = "CopyInformation2", propOrder = {"copyIndicator", "originalReceiver"})
public class CopyInformation2 {
	...
	public CopyInformation2 setCopyIndicator(YesNoIndicator copyIndicator) {
		this.copyIndicator = Objects.requireNonNull(copyIndicator);
		return this;
	}

	public Optional<BICIdentification1> getOriginalReceiver() {
