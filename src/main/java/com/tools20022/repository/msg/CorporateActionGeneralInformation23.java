...
public class CorporateActionGeneralInformation23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation23.mmCorporateActionEventIdentification, CorporateActionGeneralInformation23.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation23.mmClassActionNumber, CorporateActionGeneralInformation23.mmEventProcessingType, CorporateActionGeneralInformation23.mmEventType,
						CorporateActionGeneralInformation23.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation23.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation23.mmUnderlyingSecurity);
