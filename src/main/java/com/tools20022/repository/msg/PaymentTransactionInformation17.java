...
public class PaymentTransactionInformation17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation17.mmReversalIdentification, PaymentTransactionInformation17.mmOriginalPaymentInformationIdentification,
						PaymentTransactionInformation17.mmOriginalInstructionIdentification, PaymentTransactionInformation17.mmOriginalEndToEndIdentification, PaymentTransactionInformation17.mmOriginalTransactionIdentification,
						PaymentTransactionInformation17.mmOriginalInterbankSettlementAmount, PaymentTransactionInformation17.mmReversedInterbankSettlementAmount, PaymentTransactionInformation17.mmInterbankSettlementDate,
						PaymentTransactionInformation17.mmReversedInstructedAmount, PaymentTransactionInformation17.mmExchangeRate, PaymentTransactionInformation17.mmCompensationAmount, PaymentTransactionInformation17.mmChargeBearer,
						PaymentTransactionInformation17.mmChargesInformation, PaymentTransactionInformation17.mmInstructingAgent, PaymentTransactionInformation17.mmInstructedAgent,
						PaymentTransactionInformation17.mmReversalReasonInformation, PaymentTransactionInformation17.mmOriginalTransactionReference);
