...
import com.tools20022.repository.choice.RejectionAndRepairReason34Choice;
...
@XmlType(name = "RejectionOrRepairReason34", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason34 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionAndRepairReason34Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairReason21.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairReason21.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason34.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason34.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RejectionOrRepairReason34";
				definition = "Reason for the rejection or repair status.";
				previousVersion_lazy = () -> RejectionOrRepairReason21.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public RejectionAndRepairReason34Choice getCode() {
		return code;
	}

	public RejectionOrRepairReason34 setCode(RejectionAndRepairReason34Choice code) {
	...
	public RejectionOrRepairReason34 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
