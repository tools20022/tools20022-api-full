...
public class AcceptedStatusReason5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatusReason5.mmReasonCode, AcceptedStatusReason5.mmAdditionalReasonInformation);
	...
	public void setReasonCode(AcceptedReason5Choice reasonCode) {
