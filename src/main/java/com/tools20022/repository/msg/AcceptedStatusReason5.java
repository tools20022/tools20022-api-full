 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forAcceptedStatusReason5
 * ConstraintAdditionalReasonInforrmationRule.forAcceptedStatusReason5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AcceptedStatusReason5", propOrder = {"reasonCode", "additionalReasonInformation"})
public class AcceptedStatusReason5 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected AcceptedReason5Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedStatusReason5, AcceptedReason5Choice> mmReasonCode = new MMMessageAssociationEnd<AcceptedStatusReason5, AcceptedReason5Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptedStatusReason5.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
		...
		@Override
		public AcceptedReason5Choice getValue(AcceptedStatusReason5 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(AcceptedStatusReason5 obj, AcceptedReason5Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedStatusReason5, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcceptedStatusReason5, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(AcceptedStatusReason5 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(AcceptedStatusReason5 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptedStatusReason5.mmReasonCode, com.tools20022.repository.msg.AcceptedStatusReason5.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forAcceptedStatusReason5);
	...
	public AcceptedReason5Choice getReasonCode() {
		return reasonCode;
	}

	public AcceptedStatusReason5 setReasonCode(AcceptedReason5Choice reasonCode) {
	...
	public AcceptedStatusReason5 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
