...
@XmlType(name = "PaymentContext11", propOrder = {"cardPresent", "cardholderPresent", "onLineContext", "attendanceContext", "transactionEnvironment", "transactionChannel", "cardDataEntryMode", "fallbackIndicator"})
public class PaymentContext11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext11.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext11 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext11 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>> mmOnLineContext = new MMMessageAttribute<PaymentContext11, Optional<TrueFalseIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext11, Optional<AttendanceContext1Code>>() {
		{
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext11 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext11 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext11, Optional<TransactionEnvironment1Code>>() {
		{
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext11 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext11 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext11, Optional<TransactionChannel3Code>>() {
		{
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext11 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext11 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, CardDataReading1Code> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext11, CardDataReading1Code>() {
		{
		...
		@Override
		public CardDataReading1Code getValue(PaymentContext11 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext11 obj, CardDataReading1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext11, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext11, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext11.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext11 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext11 obj, Optional<CardFallback1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext11.mmCardPresent, com.tools20022.repository.msg.PaymentContext11.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext11.mmOnLineContext, com.tools20022.repository.msg.PaymentContext11.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext11.mmTransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext11.mmTransactionChannel, com.tools20022.repository.msg.PaymentContext11.mmCardDataEntryMode, com.tools20022.repository.msg.PaymentContext11.mmFallbackIndicator);
	...
	public PaymentContext11 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext11 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext11 setOnLineContext(TrueFalseIndicator onLineContext) {
	...
	public PaymentContext11 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext11 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext11 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext11 setCardDataEntryMode(CardDataReading1Code cardDataEntryMode) {
	...
	public PaymentContext11 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
