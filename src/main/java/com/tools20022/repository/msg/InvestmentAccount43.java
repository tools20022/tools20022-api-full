...
public class InvestmentAccount43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount43.mmIdentification, InvestmentAccount43.mmName, InvestmentAccount43.mmDesignation, InvestmentAccount43.mmIntermediaryInformation,
						InvestmentAccount43.mmAccountServicer);
	...
	public void setIntermediaryInformation(List<com.tools20022.repository.msg.Intermediary27> intermediaryInformation) {
