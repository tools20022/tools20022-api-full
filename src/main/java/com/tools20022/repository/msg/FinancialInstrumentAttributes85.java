...
public class FinancialInstrumentAttributes85 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes85.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes85.mmPlaceOfListing, FinancialInstrumentAttributes85.mmDayCountBasis,
						FinancialInstrumentAttributes85.mmClassificationType, FinancialInstrumentAttributes85.mmOptionStyle, FinancialInstrumentAttributes85.mmDenominationCurrency, FinancialInstrumentAttributes85.mmNextCouponDate,
						FinancialInstrumentAttributes85.mmExpiryDate, FinancialInstrumentAttributes85.mmFloatingRateFixingDate, FinancialInstrumentAttributes85.mmMaturityDate, FinancialInstrumentAttributes85.mmIssueDate,
						FinancialInstrumentAttributes85.mmNextCallableDate, FinancialInstrumentAttributes85.mmPutableDate, FinancialInstrumentAttributes85.mmDatedDate, FinancialInstrumentAttributes85.mmConversionDate,
						FinancialInstrumentAttributes85.mmInterestRate, FinancialInstrumentAttributes85.mmNextInterestRate, FinancialInstrumentAttributes85.mmPercentageOfDebtClaim, FinancialInstrumentAttributes85.mmPreviousFactor,
						FinancialInstrumentAttributes85.mmNextFactor, FinancialInstrumentAttributes85.mmWarrantParity, FinancialInstrumentAttributes85.mmMinimumNominalQuantity, FinancialInstrumentAttributes85.mmContractSize);
