...
import com.tools20022.repository.area.sese.TransferInConfirmationV03;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer18#mmTransferConfirmationReference
 * Transfer18.mmTransferConfirmationReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmTransferReference
 * Transfer18.mmTransferReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmClientReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmTransferReason
 * Transfer18.mmTransferReason}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmHoldingsPlanType
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmTotalUnitsNumber
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer18#mmTransferCurrency
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule#forTransfer18
 * ConstraintTotalUnitsNumberRule.forTransfer18}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSingleAndMultipleTransferConfirmationReferencesGuideline1#forTransfer18
...
@XmlType(name = "Transfer18", propOrder = {"transferConfirmationReference", "transferReference", "clientReference", "counterpartyReference", "effectiveTransferDate", "tradeDate", "transferOrderDateForm", "transferReason",
		"holdingsPlanType", "financialInstrumentDetails", "totalUnitsNumber", "unitsDetails", "averagePrice", "transferCurrency", "ownAccountTransferIndicator", "nonStandardSettlementInformation"})
public class Transfer18 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Transfer18
	 * Transfer18}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Max35Text> mmTransferConfirmationReference = new MMMessageAttribute<Transfer18, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer18.mmObject();
			isDerived = false;
			xmlTag = "TrfConfRef";
		...
		@Override
		public Max35Text getValue(Transfer18 obj) {
			return obj.getTransferConfirmationReference();
		}

		@Override
		public void setValue(Transfer18 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Max35Text> mmTransferReference = new MMMessageAttribute<Transfer18, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<Max35Text>> mmClientReference = new MMMessageAttribute<Transfer18, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transfer18 obj) {
			return obj.getClientReference();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<AdditionalReference2>> mmCounterpartyReference = new MMMessageAttribute<Transfer18, Optional<AdditionalReference2>>() {
		{
		...
		@Override
		public Optional<AdditionalReference2> getValue(Transfer18 obj) {
			return obj.getCounterpartyReference();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<AdditionalReference2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, DateAndDateTimeChoice> mmEffectiveTransferDate = new MMMessageAttribute<Transfer18, DateAndDateTimeChoice>() {
		{
		...
		@Override
		public DateAndDateTimeChoice getValue(Transfer18 obj) {
			return obj.getEffectiveTransferDate();
		}

		@Override
		public void setValue(Transfer18 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<DateAndDateTimeChoice>> mmTradeDate = new MMMessageAttribute<Transfer18, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(Transfer18 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<ISODate>> mmTransferOrderDateForm = new MMMessageAttribute<Transfer18, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Trade.mmTradeDateTime;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer18.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<ISODate> getValue(Transfer18 obj) {
			return obj.getTransferOrderDateForm();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<TransferReason1>> mmTransferReason = new MMMessageAttribute<Transfer18, Optional<TransferReason1>>() {
		{
		...
		@Override
		public Optional<TransferReason1> getValue(Transfer18 obj) {
			return obj.getTransferReason();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<TransferReason1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, List<HoldingsPlanType1Code>> mmHoldingsPlanType = new MMMessageAttribute<Transfer18, List<HoldingsPlanType1Code>>() {
		{
		...
		@Override
		public List<HoldingsPlanType1Code> getValue(Transfer18 obj) {
			return obj.getHoldingsPlanType();
		}

		@Override
		public void setValue(Transfer18 obj, List<HoldingsPlanType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, FinancialInstrument13> mmFinancialInstrumentDetails = new MMMessageAttribute<Transfer18, FinancialInstrument13>() {
		{
		...
		@Override
		public FinancialInstrument13 getValue(Transfer18 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(Transfer18 obj, FinancialInstrument13 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, FinancialInstrumentQuantity1> mmTotalUnitsNumber = new MMMessageAttribute<Transfer18, FinancialInstrumentQuantity1>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity1 getValue(Transfer18 obj) {
			return obj.getTotalUnitsNumber();
		}

		@Override
		public void setValue(Transfer18 obj, FinancialInstrumentQuantity1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer18, List<Unit3>> mmUnitsDetails = new MMMessageAssociationEnd<Transfer18, List<Unit3>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmTransferredQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer18.mmObject();
			isDerived = false;
		...
		@Override
		public List<Unit3> getValue(Transfer18 obj) {
			return obj.getUnitsDetails();
		}

		@Override
		public void setValue(Transfer18 obj, List<Unit3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>> mmAveragePrice = new MMMessageAttribute<Transfer18, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> getValue(Transfer18 obj) {
			return obj.getAveragePrice();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<CurrencyCode>> mmTransferCurrency = new MMMessageAttribute<Transfer18, Optional<CurrencyCode>>() {
		{
		...
		@Override
		public Optional<CurrencyCode> getValue(Transfer18 obj) {
			return obj.getTransferCurrency();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<YesNoIndicator>> mmOwnAccountTransferIndicator = new MMMessageAttribute<Transfer18, Optional<YesNoIndicator>>() {
		{
		...
		@Override
		public Optional<YesNoIndicator> getValue(Transfer18 obj) {
			return obj.getOwnAccountTransferIndicator();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer18, Optional<Max350Text>> mmNonStandardSettlementInformation = new MMMessageAttribute<Transfer18, Optional<Max350Text>>() {
		{
		...
		@Override
		public Optional<Max350Text> getValue(Transfer18 obj) {
			return obj.getNonStandardSettlementInformation();
		}

		@Override
		public void setValue(Transfer18 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transfer18.mmTransferConfirmationReference, com.tools20022.repository.msg.Transfer18.mmTransferReference,
						com.tools20022.repository.msg.Transfer18.mmClientReference, com.tools20022.repository.msg.Transfer18.mmCounterpartyReference, com.tools20022.repository.msg.Transfer18.mmEffectiveTransferDate,
						com.tools20022.repository.msg.Transfer18.mmTradeDate, com.tools20022.repository.msg.Transfer18.mmTransferOrderDateForm, com.tools20022.repository.msg.Transfer18.mmTransferReason,
						com.tools20022.repository.msg.Transfer18.mmHoldingsPlanType, com.tools20022.repository.msg.Transfer18.mmFinancialInstrumentDetails, com.tools20022.repository.msg.Transfer18.mmTotalUnitsNumber,
						com.tools20022.repository.msg.Transfer18.mmUnitsDetails, com.tools20022.repository.msg.Transfer18.mmAveragePrice, com.tools20022.repository.msg.Transfer18.mmTransferCurrency,
						com.tools20022.repository.msg.Transfer18.mmOwnAccountTransferIndicator, com.tools20022.repository.msg.Transfer18.mmNonStandardSettlementInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInConfirmationV03.mmTransferDetails);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule.forTransfer18,
						com.tools20022.repository.constraints.ConstraintSingleAndMultipleTransferConfirmationReferencesGuideline1.forTransfer18);
				...
				nextVersions_lazy = () -> Arrays.asList(Transfer26.mmObject());
	...
	public Transfer18 setTransferConfirmationReference(Max35Text transferConfirmationReference) {
	...
	public Transfer18 setTransferReference(Max35Text transferReference) {
	...
	public Transfer18 setClientReference(Max35Text clientReference) {
	...
	public Transfer18 setCounterpartyReference(AdditionalReference2 counterpartyReference) {
	...
	public Transfer18 setEffectiveTransferDate(DateAndDateTimeChoice effectiveTransferDate) {
	...
	public Transfer18 setTradeDate(DateAndDateTimeChoice tradeDate) {
	...
	public Transfer18 setTransferOrderDateForm(ISODate transferOrderDateForm) {
	...
	public Transfer18 setTransferReason(TransferReason1 transferReason) {
	...
	public Transfer18 setHoldingsPlanType(List<HoldingsPlanType1Code> holdingsPlanType) {
	...
	public Transfer18 setFinancialInstrumentDetails(FinancialInstrument13 financialInstrumentDetails) {
	...
	public Transfer18 setTotalUnitsNumber(FinancialInstrumentQuantity1 totalUnitsNumber) {
	...
	public Transfer18 setUnitsDetails(List<Unit3> unitsDetails) {
	...
	public Transfer18 setAveragePrice(ActiveOrHistoricCurrencyAnd13DecimalAmount averagePrice) {
	...
	public Transfer18 setTransferCurrency(CurrencyCode transferCurrency) {
	...
	public Transfer18 setOwnAccountTransferIndicator(YesNoIndicator ownAccountTransferIndicator) {
	...
	public Transfer18 setNonStandardSettlementInformation(Max350Text nonStandardSettlementInformation) {
