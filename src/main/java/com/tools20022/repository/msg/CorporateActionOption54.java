...
public class CorporateActionOption54 {
	...
	public static final MMMessageAssociationEnd mmOptionNumber = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption54.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption54.mmOptionNumber, CorporateActionOption54.mmOptionType, CorporateActionOption54.mmOptionFeatures, CorporateActionOption54.mmFractionDisposition,
						CorporateActionOption54.mmCurrencyOption, CorporateActionOption54.mmDateDetails, CorporateActionOption54.mmPeriodDetails, CorporateActionOption54.mmRateAndAmountDetails, CorporateActionOption54.mmPriceDetails,
						CorporateActionOption54.mmPlaceOfTrade, CorporateActionOption54.mmSecuritiesMovementDetails, CorporateActionOption54.mmCashMovementDetails);
	...
	public FractionDispositionType24Choice getFractionDisposition() {
		return fractionDisposition;
	}

	public void setFractionDisposition(FractionDispositionType24Choice fractionDisposition) {
	...
	public CorporateActionRate39 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate39 rateAndAmountDetails) {
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption36> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption27> cashMovementDetails) {
