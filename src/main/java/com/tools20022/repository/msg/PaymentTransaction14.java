...
public class PaymentTransaction14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd CashInOrOutChoice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PaymentTransaction14.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction14.SettlementAmount, com.tools20022.repository.msg.PaymentTransaction14.SettlementDate,
						com.tools20022.repository.msg.PaymentTransaction14.CashInOrOutChoice);
