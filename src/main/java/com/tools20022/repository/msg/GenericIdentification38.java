...
public class GenericIdentification38 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification38.Identification, com.tools20022.repository.msg.GenericIdentification38.Issuer,
						com.tools20022.repository.msg.GenericIdentification38.SchemeName);
