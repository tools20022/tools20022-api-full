...
public class OptionData1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionData1.mmTradeDate, OptionData1.mmNotificationIdentification, OptionData1.mmCommonReference, OptionData1.mmRelatedReference, OptionData1.mmAmendOrCancelReason,
						OptionData1.mmOption);
