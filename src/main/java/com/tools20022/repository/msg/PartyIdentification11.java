...
@XmlType(name = "PartyIdentification11", propOrder = "identification")
public class PartyIdentification11 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PartyIdentification11
	 * PartyIdentification11}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentification11.mmIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PartyIdentification11";
	...
	public PartyIdentification11 setIdentification(PartyPrivate1 identification) {
