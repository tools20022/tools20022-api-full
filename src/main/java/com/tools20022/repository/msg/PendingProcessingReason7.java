...
public class PendingProcessingReason7 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason7.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason7.mmCode, PendingProcessingReason7.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason7Choice code) {
		this.code = code;
	}
