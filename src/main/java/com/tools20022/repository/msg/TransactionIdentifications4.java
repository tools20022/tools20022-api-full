...
public class TransactionIdentifications4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications4.mmAccountServicerTransactionIdentification, TransactionIdentifications4.mmMarketInfrastructureTransactionIdentification,
						TransactionIdentifications4.mmAccountOwnerTransactionIdentification);
