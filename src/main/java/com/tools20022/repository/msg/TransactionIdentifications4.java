...
public class TransactionIdentifications4 {
	...
	public static final MMMessageAttribute mmAccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications4.mmObject();
			isDerived = false;
			xmlTag = "AcctSvcrTxId";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV01.mmTransactionIdentification);
	...
	public void setAccountOwnerTransactionIdentification(References4Choice accountOwnerTransactionIdentification) {
