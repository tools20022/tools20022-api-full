 ...
 * SecuritiesTradeDetails26.SettlementInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
...
public class SecuritiesTradeDetails26 {
	...
	public static final MMMessageAttribute TradeIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.TradeIdentification);
			minOccurs = 0;
	...
	public static final MMMessageAttribute CollateralTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.CollateralTransactionIdentification);
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd PlaceOfTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.PlaceOfTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PlaceOfClearing = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.PlaceOfClearing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TradeDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.TradeDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.SettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LateDeliveryDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.LateDeliveryDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DealPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.DealPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfDaysAccrued = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.NumberOfDaysAccrued);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OpeningClosing = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.OpeningClosing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Reporting = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.Reporting);
			minOccurs = 0;
	...
	public static final MMMessageAttribute TradeTransactionCondition = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.TradeTransactionCondition);
			minOccurs = 0;
	...
	public static final MMMessageAttribute InvestorCapacity = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.InvestorCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TradeOriginatorRole = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.TradeOriginatorRole);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TypeOfPrice = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.TypeOfPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CurrencyToBuyOrSell = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.CurrencyToBuyOrSell);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MatchingStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.MatchingStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AffirmationStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.AffirmationStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FXAdditionalDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.FXAdditionalDetails);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * SecuritiesTradeDetails34.SettlementInstructionProcessingAdditionalDetails
	 * }</li>
	 * </ul>
	 * </li>
	 * </ul>
	...
	public static final MMMessageAttribute SettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails34.SettlementInstructionProcessingAdditionalDetails);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails26.TradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails26.CollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.PlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails26.PlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails26.TradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.SettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails26.LateDeliveryDate, com.tools20022.repository.msg.SecuritiesTradeDetails26.DealPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.NumberOfDaysAccrued, com.tools20022.repository.msg.SecuritiesTradeDetails26.OpeningClosing, com.tools20022.repository.msg.SecuritiesTradeDetails26.Reporting,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.TradeTransactionCondition, com.tools20022.repository.msg.SecuritiesTradeDetails26.InvestorCapacity,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.TradeOriginatorRole, com.tools20022.repository.msg.SecuritiesTradeDetails26.TypeOfPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.CurrencyToBuyOrSell, com.tools20022.repository.msg.SecuritiesTradeDetails26.MatchingStatus,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.AffirmationStatus, com.tools20022.repository.msg.SecuritiesTradeDetails26.FXAdditionalDetails,
						com.tools20022.repository.msg.SecuritiesTradeDetails26.SettlementInstructionProcessingAdditionalDetails);
