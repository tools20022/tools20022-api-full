...
public class CardPaymentTransaction20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction20.mmMerchantCategoryCode, CardPaymentTransaction20.mmTransactionIdentification, CardPaymentTransaction20.mmOriginalTransaction,
						CardPaymentTransaction20.mmTransactionSuccess, CardPaymentTransaction20.mmReversal, CardPaymentTransaction20.mmFailureReason, CardPaymentTransaction20.mmRecipientTransactionIdentification,
						CardPaymentTransaction20.mmReconciliationIdentification, CardPaymentTransaction20.mmInterchangeData, CardPaymentTransaction20.mmTransactionDetails, CardPaymentTransaction20.mmAuthorisationResult,
						CardPaymentTransaction20.mmAdditionalTransactionData);
