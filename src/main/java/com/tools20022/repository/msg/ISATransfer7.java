...
public class ISATransfer7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer7.mmMasterReference, ISATransfer7.mmTransferIdentification, ISATransfer7.mmRequestedTransferDate, ISATransfer7.mmPortfolio, ISATransfer7.mmResidualCash,
						ISATransfer7.mmAllOtherCash, ISATransfer7.mmFinancialInstrumentAssetForTransfer);
