...
import com.tools20022.repository.area.sese.PortfolioTransferInstructionV04;
...
import com.tools20022.repository.msg.FinancialInstrument31;
import java.util.*;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer7#mmMasterReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer7#mmResidualCash
 * ISATransfer7.mmResidualCash}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer7#mmAllOtherCash
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintISARule#forISATransfer7
 * ConstraintISARule.forISATransfer7}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDesignationRule#forISATransfer7
 * ConstraintDesignationRule.forISATransfer7}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.ISATransfer1
 * ISATransfer1}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ISATransfer7", propOrder = {"masterReference", "transferIdentification", "requestedTransferDate", "portfolio", "residualCash", "allOtherCash", "financialInstrumentAssetForTransfer"})
public class ISATransfer7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<ISATransfer7, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer7.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual transfers as assigned by the instructing party. This identifier links the individual transfers together.";
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ISATransfer7 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(ISATransfer7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, Max35Text> mmTransferIdentification = new MMMessageAttribute<ISATransfer7, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer7.mmObject();
			isDerived = false;
			xmlTag = "TrfId";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmTransferIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(ISATransfer7 obj) {
			return obj.getTransferIdentification();
		}

		@Override
		public void setValue(ISATransfer7 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, Optional<DateFormat1Choice>> mmRequestedTransferDate = new MMMessageAttribute<ISATransfer7, Optional<DateFormat1Choice>>() {
		{
			...
			definition = "Requested date at which the assets should be transferred.";
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmRequestedTransferDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateFormat1Choice> getValue(ISATransfer7 obj) {
			return obj.getRequestedTransferDate();
		}

		@Override
		public void setValue(ISATransfer7 obj, Optional<DateFormat1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, ISAPortfolio1Choice> mmPortfolio = new MMMessageAttribute<ISATransfer7, ISAPortfolio1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmPortfolio);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISAPortfolio1Choice getValue(ISATransfer7 obj) {
			return obj.getPortfolio();
		}

		@Override
		public void setValue(ISATransfer7 obj, ISAPortfolio1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, Optional<ResidualCash1Code>> mmResidualCash = new MMMessageAttribute<ISATransfer7, Optional<ResidualCash1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer7.mmObject();
			isDerived = false;
			xmlTag = "RsdlCsh";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmResidualCash);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ResidualCash1Code> getValue(ISATransfer7 obj) {
			return obj.getResidualCash();
		}

		@Override
		public void setValue(ISATransfer7 obj, Optional<ResidualCash1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer7, YesNoIndicator> mmAllOtherCash = new MMMessageAttribute<ISATransfer7, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer7.mmObject();
			isDerived = false;
			xmlTag = "AllOthrCsh";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmAllOtherCash);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(ISATransfer7 obj) {
			return obj.getAllOtherCash();
		}

		@Override
		public void setValue(ISATransfer7 obj, YesNoIndicator value) {
			obj.setAllOtherCash(value);
		}
	};
	@XmlElement(name = "FinInstrmAsstForTrf")
	protected List<FinancialInstrument31> financialInstrumentAssetForTransfer;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.FinancialInstrument31
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ISATransfer7, List<FinancialInstrument31>> mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd<ISATransfer7, List<FinancialInstrument31>>() {
		{
			...
			definition = "Specifies the underlying assets for the ISA or portfolio.";
			nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmFinancialInstrumentAssetForTransfer);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrument31.mmObject();
		}

		@Override
		public List<FinancialInstrument31> getValue(ISATransfer7 obj) {
			return obj.getFinancialInstrumentAssetForTransfer();
		}

		@Override
		public void setValue(ISATransfer7 obj, List<FinancialInstrument31> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer7.mmMasterReference, com.tools20022.repository.msg.ISATransfer7.mmTransferIdentification,
						com.tools20022.repository.msg.ISATransfer7.mmRequestedTransferDate, com.tools20022.repository.msg.ISATransfer7.mmPortfolio, com.tools20022.repository.msg.ISATransfer7.mmResidualCash,
						com.tools20022.repository.msg.ISATransfer7.mmAllOtherCash, com.tools20022.repository.msg.ISATransfer7.mmFinancialInstrumentAssetForTransfer);
				messageBuildingBlock_lazy = () -> Arrays.asList(PortfolioTransferInstructionV04.mmProductTransfer);
				trace_lazy = () -> PortfolioTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintISARule.forISATransfer7, com.tools20022.repository.constraints.ConstraintDesignationRule.forISATransfer7);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ISATransfer7";
				definition = "Describes the type of product and the assets to be transferred.";
				nextVersions_lazy = () -> Arrays.asList(ISATransfer16.mmObject());
				previousVersion_lazy = () -> ISATransfer1.mmObject();
			}
		});
	...
	public ISATransfer7 setMasterReference(Max35Text masterReference) {
	...
	public ISATransfer7 setTransferIdentification(Max35Text transferIdentification) {
	...
	public ISATransfer7 setRequestedTransferDate(DateFormat1Choice requestedTransferDate) {
	...
	public ISATransfer7 setPortfolio(ISAPortfolio1Choice portfolio) {
	...
	public ISATransfer7 setResidualCash(ResidualCash1Code residualCash) {
	...
	public ISATransfer7 setAllOtherCash(YesNoIndicator allOtherCash) {
		this.allOtherCash = Objects.requireNonNull(allOtherCash);
		return this;
	}

	public List<FinancialInstrument31> getFinancialInstrumentAssetForTransfer() {
	...
	public ISATransfer7 setFinancialInstrumentAssetForTransfer(List<FinancialInstrument31> financialInstrumentAssetForTransfer) {
