...
public class AmountAndDirection47 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection23.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection23.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AmountAndDirection23.mmForeignExchangeDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public AmountAndDirection47 setForeignExchangeDetails(com.tools20022.repository.msg.ForeignExchangeTerms23 foreignExchangeDetails) {
