 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails62#mmPayment
...
@XmlType(name = "TransactionDetails62", propOrder = {"transactionActivity", "settlementTransactionOrCorporateActionEventType", "securitiesMovementType", "payment", "settlementParameters", "placeOfTrade", "safekeepingPlace",
...
public class TransactionDetails62 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, TransactionActivity1Choice> mmTransactionActivity = new MMMessageAssociationEnd<TransactionDetails62, TransactionActivity1Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmActivity;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TransactionActivity";
			definition = "Specifies the type of activity to which this instruction relates.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmTransactionActivity);
			previousVersion_lazy = () -> TransactionDetails56.mmTransactionActivity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionActivity1Choice getValue(TransactionDetails62 obj) {
			return obj.getTransactionActivity();
		}

		@Override
		public void setValue(TransactionDetails62 obj, TransactionActivity1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementOrCorporateActionEvent10Choice>> mmSettlementTransactionOrCorporateActionEventType = new MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementOrCorporateActionEvent10Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSettlementTransactionOrCorporateActionEventType);
			previousVersion_lazy = () -> TransactionDetails56.mmSettlementTransactionOrCorporateActionEventType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementOrCorporateActionEvent10Choice> getValue(TransactionDetails62 obj) {
			return obj.getSettlementTransactionOrCorporateActionEventType();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<SettlementOrCorporateActionEvent10Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails62, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionDetails62, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSecuritiesMovementType);
			previousVersion_lazy = () -> TransactionDetails56.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionDetails62 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionDetails62 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails62, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionDetails62, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmPayment);
			previousVersion_lazy = () -> TransactionDetails56.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionDetails62 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionDetails62 obj, DeliveryReceiptType2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementDetails74>> mmSettlementParameters = new MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementDetails74>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSettlementParameters);
			previousVersion_lazy = () -> TransactionDetails56.mmSettlementParameters;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDetails74> getValue(TransactionDetails62 obj) {
			return obj.getSettlementParameters();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<SettlementDetails74> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<MarketIdentification78>> mmPlaceOfTrade = new MMMessageAssociationEnd<TransactionDetails62, Optional<MarketIdentification78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmPlaceOfTrade);
			previousVersion_lazy = () -> TransactionDetails56.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification78> getValue(TransactionDetails62 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<MarketIdentification78> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<SafekeepingPlaceFormat3Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<TransactionDetails62, Optional<SafekeepingPlaceFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSafekeepingPlace);
			previousVersion_lazy = () -> TransactionDetails56.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafekeepingPlaceFormat3Choice> getValue(TransactionDetails62 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<SafekeepingPlaceFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails62, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<TransactionDetails62, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmPlaceOfClearing);
			previousVersion_lazy = () -> TransactionDetails56.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(TransactionDetails62 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, SecurityIdentification14> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<TransactionDetails62, SecurityIdentification14>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> TransactionDetails56.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification14 getValue(TransactionDetails62 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(TransactionDetails62 obj, SecurityIdentification14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Quantity6Choice> mmPostingQuantity = new MMMessageAssociationEnd<TransactionDetails62, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmPostingQuantity);
			previousVersion_lazy = () -> TransactionDetails56.mmPostingQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails62 obj) {
			return obj.getPostingQuantity();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<AmountAndDirection8>> mmPostingAmount = new MMMessageAssociationEnd<TransactionDetails62, Optional<AmountAndDirection8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmPostingAmount);
			previousVersion_lazy = () -> TransactionDetails56.mmPostingAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection8> getValue(TransactionDetails62 obj) {
			return obj.getPostingAmount();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<AmountAndDirection8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails62, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmTradeDate);
			previousVersion_lazy = () -> TransactionDetails56.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(TransactionDetails62 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>> mmExpectedSettlementDate = new MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmExpectedSettlementDate);
			previousVersion_lazy = () -> TransactionDetails56.mmExpectedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(TransactionDetails62 obj) {
			return obj.getExpectedSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, SettlementDate2Choice> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails62, SettlementDate2Choice>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			...
			name = "SettlementDate";
			definition = "Date and time at which the securities are to be delivered or received.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSettlementDate);
			previousVersion_lazy = () -> TransactionDetails56.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate2Choice getValue(TransactionDetails62 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails62 obj, SettlementDate2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmLateDeliveryDate);
			previousVersion_lazy = () -> TransactionDetails56.mmLateDeliveryDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>> mmExpectedValueDate = new MMMessageAssociationEnd<TransactionDetails62, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmExpectedValueDate);
			previousVersion_lazy = () -> TransactionDetails56.mmExpectedValueDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementParties13>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementParties13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> TransactionDetails56.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties13> getValue(TransactionDetails62 obj) {
			return obj.getDeliveringSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<SettlementParties13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementParties13>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails62, Optional<SettlementParties13>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmReceivingSettlementParties);
			previousVersion_lazy = () -> TransactionDetails56.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties13.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails62, Optional<Max350Text>> mmTransactionAdditionalDetails = new MMMessageAttribute<TransactionDetails62, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			xmlTag = "TxAddtlDtls";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmTransactionAdditionalDetails);
			previousVersion_lazy = () -> TransactionDetails56.mmTransactionAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransactionDetails62 obj) {
			return obj.getTransactionAdditionalDetails();
		}

		@Override
		public void setValue(TransactionDetails62 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails62, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<TransactionDetails62, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails62.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmSupplementaryData);
			previousVersion_lazy = () -> TransactionDetails56.mmSupplementaryData;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(TransactionDetails62 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(TransactionDetails62 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails62.mmTransactionActivity, com.tools20022.repository.msg.TransactionDetails62.mmSettlementTransactionOrCorporateActionEventType,
						com.tools20022.repository.msg.TransactionDetails62.mmSecuritiesMovementType, com.tools20022.repository.msg.TransactionDetails62.mmPayment, com.tools20022.repository.msg.TransactionDetails62.mmSettlementParameters,
						com.tools20022.repository.msg.TransactionDetails62.mmPlaceOfTrade, com.tools20022.repository.msg.TransactionDetails62.mmSafekeepingPlace, com.tools20022.repository.msg.TransactionDetails62.mmPlaceOfClearing,
						com.tools20022.repository.msg.TransactionDetails62.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.TransactionDetails62.mmPostingQuantity,
						com.tools20022.repository.msg.TransactionDetails62.mmPostingAmount, com.tools20022.repository.msg.TransactionDetails62.mmTradeDate, com.tools20022.repository.msg.TransactionDetails62.mmExpectedSettlementDate,
						com.tools20022.repository.msg.TransactionDetails62.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails62.mmLateDeliveryDate, com.tools20022.repository.msg.TransactionDetails62.mmExpectedValueDate,
						com.tools20022.repository.msg.TransactionDetails62.mmDeliveringSettlementParties, com.tools20022.repository.msg.TransactionDetails62.mmReceivingSettlementParties,
						com.tools20022.repository.msg.TransactionDetails62.mmTransactionAdditionalDetails, com.tools20022.repository.msg.TransactionDetails62.mmSupplementaryData);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forTransactionDetails62, com.tools20022.repository.constraints.ConstraintPostingAmountRule.forTransactionDetails62,
						com.tools20022.repository.constraints.ConstraintLateDeliveryDateRule.forTransactionDetails62, com.tools20022.repository.constraints.ConstraintReceivingParty1Rule.forTransactionDetails62,
						com.tools20022.repository.constraints.ConstraintDeliveringParty1Rule.forTransactionDetails62, com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forTransactionDetails62,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forTransactionDetails62, com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing1Rule.forTransactionDetails62,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing2Rule.forTransactionDetails62);
				...
				name = "TransactionDetails62";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails69.mmObject());
				previousVersion_lazy = () -> TransactionDetails56.mmObject();
			}
		});
	...
	public TransactionDetails62 setTransactionActivity(TransactionActivity1Choice transactionActivity) {
	...
	public TransactionDetails62 setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent10Choice settlementTransactionOrCorporateActionEventType) {
	...
	public TransactionDetails62 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionDetails62 setPayment(DeliveryReceiptType2Code payment) {
	...
	public TransactionDetails62 setSettlementParameters(SettlementDetails74 settlementParameters) {
	...
	public TransactionDetails62 setPlaceOfTrade(MarketIdentification78 placeOfTrade) {
	...
	public TransactionDetails62 setSafekeepingPlace(SafekeepingPlaceFormat3Choice safekeepingPlace) {
	...
	public TransactionDetails62 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public TransactionDetails62 setFinancialInstrumentIdentification(SecurityIdentification14 financialInstrumentIdentification) {
	...
	public TransactionDetails62 setPostingQuantity(Quantity6Choice postingQuantity) {
	...
	public TransactionDetails62 setPostingAmount(AmountAndDirection8 postingAmount) {
	...
	public TransactionDetails62 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public TransactionDetails62 setExpectedSettlementDate(DateAndDateTimeChoice expectedSettlementDate) {
	...
	public TransactionDetails62 setSettlementDate(SettlementDate2Choice settlementDate) {
	...
	public TransactionDetails62 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public TransactionDetails62 setExpectedValueDate(DateAndDateTimeChoice expectedValueDate) {
	...
	public TransactionDetails62 setDeliveringSettlementParties(SettlementParties13 deliveringSettlementParties) {
	...
	public TransactionDetails62 setReceivingSettlementParties(SettlementParties13 receivingSettlementParties) {
	...
	public TransactionDetails62 setTransactionAdditionalDetails(Max350Text transactionAdditionalDetails) {
	...
	public TransactionDetails62 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
