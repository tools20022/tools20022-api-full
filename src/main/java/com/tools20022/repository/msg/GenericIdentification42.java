...
@XmlType(name = "GenericIdentification42", propOrder = {"schemeName", "issuer"})
public class GenericIdentification42 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification42, Optional<Max35Text>> mmSchemeName = new MMMessageAttribute<GenericIdentification42, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Scheme.mmNameShort;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification42.mmObject();
			isDerived = false;
			xmlTag = "SchmeNm";
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification42 obj) {
			return obj.getSchemeName();
		}

		@Override
		public void setValue(GenericIdentification42 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification42, Optional<Max35Text>> mmIssuer = new MMMessageAttribute<GenericIdentification42, Optional<Max35Text>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification42.mmSchemeName, com.tools20022.repository.msg.GenericIdentification42.mmIssuer);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "GenericIdentification42";
	...
	public GenericIdentification42 setSchemeName(Max35Text schemeName) {
	...
	public GenericIdentification42 setIssuer(Max35Text issuer) {
		this.issuer = issuer;
		return this;
	}
}