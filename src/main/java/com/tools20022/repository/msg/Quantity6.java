 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity6#SettlementQuantity
 * Quantity6.SettlementQuantity}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity6#DenominationChoice
 * Quantity6.DenominationChoice}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Quantity6#CertificateNumber
...
public class Quantity6 {
	...
	public static final MMMessageAssociationEnd SettlementQuantity = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Quantity6.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Quantity6.SettlementQuantity, com.tools20022.repository.msg.Quantity6.DenominationChoice, com.tools20022.repository.msg.Quantity6.CertificateNumber,
						com.tools20022.repository.msg.Quantity6.QuantityBreakdown);
