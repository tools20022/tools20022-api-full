...
public class CorporateActionSD1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionSD1.mmPlaceAndName, CorporateActionSD1.mmNoticeType, CorporateActionSD1.mmEventCashValue, CorporateActionSD1.mmNumberOfSharesToBeIssued,
						CorporateActionSD1.mmTotalNumberOfSharesOffered, CorporateActionSD1.mmCutOffDays, CorporateActionSD1.mmDTCAutomatedOfferProgram, CorporateActionSD1.mmDTCRecycleCutOffIndicator,
						CorporateActionSD1.mmLongShortPaymentIndicator, CorporateActionSD1.mmOversubscriptionType, CorporateActionSD1.mmConditionalPaymentApplicableFlag, CorporateActionSD1.mmSolicitationDealerFeeFlag,
						CorporateActionSD1.mmDTCCustodyEligibleFlag, CorporateActionSD1.mmDTCReorganisationCustodyEligibleFlag, CorporateActionSD1.mmDTCReorganisationDepositEligibleFlag, CorporateActionSD1.mmSurrenderSharesToAgentFlag,
						CorporateActionSD1.mmStepUpPrivilegeFlag, CorporateActionSD1.mmRightsOversubscriptionFlag, CorporateActionSD1.mmRightsRoundUpPrivilegeFlag, CorporateActionSD1.mmRightsTransferableFlag,
						CorporateActionSD1.mmCertificateDetails);
