...
public class CardPaymentTransaction22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction22.mmTransactionCapture, CardPaymentTransaction22.mmTransactionType, CardPaymentTransaction22.mmAdditionalService, CardPaymentTransaction22.mmServiceAttribute,
						CardPaymentTransaction22.mmMerchantCategoryCode, CardPaymentTransaction22.mmSaleReferenceIdentification, CardPaymentTransaction22.mmTransactionIdentification, CardPaymentTransaction22.mmOriginalTransaction,
						CardPaymentTransaction22.mmInitiatorTransactionIdentification, CardPaymentTransaction22.mmReconciliationIdentification, CardPaymentTransaction22.mmTransactionDetails,
						CardPaymentTransaction22.mmAdditionalTransactionData);
