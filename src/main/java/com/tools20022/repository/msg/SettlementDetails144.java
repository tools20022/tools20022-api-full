...
@XmlType(name = "SettlementDetails144", propOrder = {"priority", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "blockTrade", "cCPEligibility", "cashClearingSystem",
...
public class SettlementDetails144 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<PriorityNumeric4Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails144, Optional<PriorityNumeric4Choice>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails144.mmObject();
			isDerived = false;
			xmlTag = "Prty";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Priority";
			definition = "Specifies whether the transaction was executed with a high priority.";
			previousVersion_lazy = () -> SettlementDetails128.mmPriority;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric4Choice> getValue(SettlementDetails144 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<PriorityNumeric4Choice> value) {
			obj.setPriority(value.orElse(null));
		}
	};
	@XmlElement(name = "SctiesTxTp", required = true)
	protected SecuritiesTransactionType36Choice securitiesTransactionType;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, SecuritiesTransactionType36Choice> mmSecuritiesTransactionType = new MMMessageAssociationEnd<SettlementDetails144, SecuritiesTransactionType36Choice>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SecuritiesTransactionType36Choice.mmObject();
		}

		@Override
		public SecuritiesTransactionType36Choice getValue(SettlementDetails144 obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementDetails144 obj, SecuritiesTransactionType36Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails144, List<SettlementTransactionCondition16Choice>>() {
		{
			...
			definition = "Conditions under which the order/trade was to be settled.";
			previousVersion_lazy = () -> SettlementDetails128.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails144 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails144 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails144, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails144, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails144.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementDetails128.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails144 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails144, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails144 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails144, Optional<BlockTrade4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails144 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails144, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails144 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails144, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails144 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<ExposureType16Choice>> mmExposureType = new MMMessageAssociationEnd<SettlementDetails144, Optional<ExposureType16Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmExposureType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ExposureType16Choice> getValue(SettlementDetails144 obj) {
			return obj.getExposureType();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<ExposureType16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<MarketClientSide6Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails144, Optional<MarketClientSide6Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide6Choice> getValue(SettlementDetails144 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<MarketClientSide6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails144, Optional<NettingEligibility4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails144 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails144, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration was to occur upon receipt.";
			previousVersion_lazy = () -> SettlementDetails128.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails144 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<RepurchaseType22Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails144, Optional<RepurchaseType22Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType22Choice> getValue(SettlementDetails144 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<RepurchaseType22Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails144, Optional<Restriction5Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails144 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails144, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails144 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails144, Optional<SettlingCapacity7Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails144 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails144, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails144 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails144, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails144 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails144 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<AutomaticBorrowing6Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails144, Optional<AutomaticBorrowing6Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmAutomaticBorrowing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing6Choice> getValue(SettlementDetails144 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<AutomaticBorrowing6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails144, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails144 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails144, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails144, Optional<YesNoIndicator>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails144 obj) {
			return obj.getEligibleForCollateral();
		}

		@Override
		public void setValue(SettlementDetails144 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>> mmSecuritiesSubBalanceType = new MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>>() {
		{
			...
			previousVersion_lazy = () -> SettlementDetails128.mmSecuritiesSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification30.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>> mmCashSubBalanceType = new MMMessageAssociationEnd<SettlementDetails144, Optional<GenericIdentification30>>() {
		{
			businessElementTrace_lazy = () -> Balance.mmType;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails144.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementDetails128.mmCashSubBalanceType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification30.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails144.mmPriority, com.tools20022.repository.msg.SettlementDetails144.mmSecuritiesTransactionType,
						com.tools20022.repository.msg.SettlementDetails144.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails144.mmPartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails144.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails144.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails144.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails144.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails144.mmExposureType, com.tools20022.repository.msg.SettlementDetails144.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails144.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails144.mmRegistration, com.tools20022.repository.msg.SettlementDetails144.mmRepurchaseType,
						com.tools20022.repository.msg.SettlementDetails144.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails144.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails144.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails144.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails144.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails144.mmStampDutyTaxBasis,
						com.tools20022.repository.msg.SettlementDetails144.mmAutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails144.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails144.mmEligibleForCollateral, com.tools20022.repository.msg.SettlementDetails144.mmSecuritiesSubBalanceType,
						com.tools20022.repository.msg.SettlementDetails144.mmCashSubBalanceType);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmationV08.mmSettlementParameters, SecuritiesSettlementTransactionReversalAdviceV07.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails144,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails144);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails144";
				definition = "Details of settlement of a transaction.";
				previousVersion_lazy = () -> SettlementDetails128.mmObject();
			}
		});
	...
	public SettlementDetails144 setPriority(PriorityNumeric4Choice priority) {
		this.priority = priority;
		return this;
	}

	public SecuritiesTransactionType36Choice getSecuritiesTransactionType() {
		return securitiesTransactionType;
	}

	public SettlementDetails144 setSecuritiesTransactionType(SecuritiesTransactionType36Choice securitiesTransactionType) {
	...
	public SettlementDetails144 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails144 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails144 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails144 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails144 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails144 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails144 setExposureType(ExposureType16Choice exposureType) {
	...
	public SettlementDetails144 setMarketClientSide(MarketClientSide6Choice marketClientSide) {
	...
	public SettlementDetails144 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails144 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails144 setRepurchaseType(RepurchaseType22Choice repurchaseType) {
	...
	public SettlementDetails144 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails144 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails144 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails144 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails144 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails144 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails144 setAutomaticBorrowing(AutomaticBorrowing6Choice automaticBorrowing) {
	...
	public SettlementDetails144 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails144 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
	...
	public SettlementDetails144 setSecuritiesSubBalanceType(GenericIdentification30 securitiesSubBalanceType) {
	...
	public SettlementDetails144 setCashSubBalanceType(GenericIdentification30 cashSubBalanceType) {
