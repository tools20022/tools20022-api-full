 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails60#mmPriority
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails71
...
@XmlType(name = "SettlementDetails60", propOrder = {"priority", "settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "beneficialOwnership", "cashClearingSystem", "taxCapacity", "marketClientSide",
...
public class SettlementDetails60 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<PriorityNumeric1Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails60, Optional<PriorityNumeric1Choice>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails60.mmObject();
			isDerived = false;
			xmlTag = "Prty";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmPriority);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric1Choice> getValue(SettlementDetails60 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<PriorityNumeric1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, List<SettlementTransactionCondition7Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails60, List<SettlementTransactionCondition7Choice>>() {
		{
			...
			definition = "Conditions under which the order/trade was to be settled.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmSettlementTransactionCondition);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition7Choice> getValue(SettlementDetails60 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails60 obj, List<SettlementTransactionCondition7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<SettlingCapacity1Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails60, Optional<SettlingCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmSettlingCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity1Choice> getValue(SettlementDetails60 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<SettlingCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails60, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmStampDutyTaxBasis);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails60 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails60, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmSecuritiesRTGS);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails60 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails60, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmBeneficialOwnership);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails60 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails60, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmCashClearingSystem);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails60 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails60, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmTaxCapacity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails60 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails60, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmMarketClientSide);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails60 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails60, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmBlockTrade);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails60 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails60, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmLegalRestrictions);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails60 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails60, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmSettlementSystemMethod);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails60 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails60, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmNettingEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails60 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails60, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmCCPEligibility);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails60 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails60, Optional<AutomaticBorrowing1Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails60, Optional<AutomaticBorrowing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmAutomaticBorrowing);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing1Choice> getValue(SettlementDetails60 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<AutomaticBorrowing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails60, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails60, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails60.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmPartialSettlementIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails60 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails60, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails60, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmEligibleForCollateral);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails60 obj) {
			return obj.getEligibleForCollateral();
		}

		@Override
		public void setValue(SettlementDetails60 obj, Optional<YesNoIndicator> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails60.mmPriority, com.tools20022.repository.msg.SettlementDetails60.mmSettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails60.mmSettlingCapacity, com.tools20022.repository.msg.SettlementDetails60.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails60.mmSecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails60.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails60.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails60.mmTaxCapacity,
						com.tools20022.repository.msg.SettlementDetails60.mmMarketClientSide, com.tools20022.repository.msg.SettlementDetails60.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails60.mmLegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails60.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails60.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails60.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails60.mmAutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails60.mmPartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails60.mmEligibleForCollateral);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingConfirmationV03.mmSettlementParameters, SecuritiesFinancingConfirmationV04.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails60,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails60);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails60";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails71.mmObject());
				previousVersion_lazy = () -> SettlementDetails30.mmObject();
			}
		});
	...
	public SettlementDetails60 setPriority(PriorityNumeric1Choice priority) {
	...
	public SettlementDetails60 setSettlementTransactionCondition(List<SettlementTransactionCondition7Choice> settlementTransactionCondition) {
	...
	public SettlementDetails60 setSettlingCapacity(SettlingCapacity1Choice settlingCapacity) {
	...
	public SettlementDetails60 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails60 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails60 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails60 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails60 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails60 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails60 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails60 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails60 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails60 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails60 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails60 setAutomaticBorrowing(AutomaticBorrowing1Choice automaticBorrowing) {
	...
	public SettlementDetails60 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails60 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
