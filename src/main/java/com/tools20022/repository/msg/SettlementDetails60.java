 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails60#Priority
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails60#BlockTrade
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.SecuritiesFinancingConfirmationV03#SettlementParameters
 * SecuritiesFinancingConfirmationV03.SettlementParameters}</li>
 * <li>
...
public class SettlementDetails60 {
	...
	public static final MMMessageAssociationEnd Priority = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.Priority);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			...
			definition = "Conditions under which the order/trade was to be settled.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.SettlementTransactionCondition);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd SettlingCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.SettlingCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd StampDutyTaxBasis = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.StampDutyTaxBasis);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesRTGS = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.SecuritiesRTGS);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BeneficialOwnership = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.BeneficialOwnership);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CashClearingSystem = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.CashClearingSystem);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TaxCapacity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.TaxCapacity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MarketClientSide = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.MarketClientSide);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd BlockTrade = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.BlockTrade);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd LegalRestrictions = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.LegalRestrictions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementSystemMethod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.SettlementSystemMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd NettingEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.NettingEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CCPEligibility = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.CCPEligibility);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AutomaticBorrowing = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.AutomaticBorrowing);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PartialSettlementIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.PartialSettlementIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute EligibleForCollateral = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails71.EligibleForCollateral);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails60.Priority, com.tools20022.repository.msg.SettlementDetails60.SettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails60.SettlingCapacity, com.tools20022.repository.msg.SettlementDetails60.StampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails60.SecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails60.BeneficialOwnership, com.tools20022.repository.msg.SettlementDetails60.CashClearingSystem, com.tools20022.repository.msg.SettlementDetails60.TaxCapacity,
						com.tools20022.repository.msg.SettlementDetails60.MarketClientSide, com.tools20022.repository.msg.SettlementDetails60.BlockTrade, com.tools20022.repository.msg.SettlementDetails60.LegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails60.SettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails60.NettingEligibility, com.tools20022.repository.msg.SettlementDetails60.CCPEligibility,
						com.tools20022.repository.msg.SettlementDetails60.AutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails60.PartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails60.EligibleForCollateral);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesFinancingConfirmationV03.SettlementParameters,
						com.tools20022.repository.area.sese.SecuritiesFinancingConfirmationV04.SettlementParameters);
