...
public class CorporateActionOption128 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption128.OptionNumber, com.tools20022.repository.msg.CorporateActionOption128.OptionType,
						com.tools20022.repository.msg.CorporateActionOption128.InstructedQuantity);
				trace_lazy = () -> CorporateActionOption.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionCancellationRequest002V07.CorporateActionInstruction);
