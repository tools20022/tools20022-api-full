...
public class SubAccountIdentification29 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification29.mmAccountOwner, SubAccountIdentification29.mmSafekeepingAccount, SubAccountIdentification29.mmActivityIndicator,
						SubAccountIdentification29.mmBalanceForSubAccount);
