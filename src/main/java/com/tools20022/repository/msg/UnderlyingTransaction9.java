	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformationAndStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingTransaction14.mmOriginalGroupInformationAndStatus);
			previousVersion_lazy = () -> com.tools20022.repository.msg.UnderlyingTransaction4.mmOriginalGroupInformationAndStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalPaymentInformationAndStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingTransaction14.mmOriginalPaymentInformationAndStatus);
			previousVersion_lazy = () -> com.tools20022.repository.msg.UnderlyingTransaction4.mmOriginalPaymentInformationAndStatus;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransactionInformationAndStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingTransaction14.mmTransactionInformationAndStatus);
			previousVersion_lazy = () -> com.tools20022.repository.msg.UnderlyingTransaction4.mmTransactionInformationAndStatus;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ResolutionOfInvestigationV05.mmCancellationDetails);
