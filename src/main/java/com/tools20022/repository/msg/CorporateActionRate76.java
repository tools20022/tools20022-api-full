...
public class CorporateActionRate76 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate76.mmAdditionalTax, CorporateActionRate76.mmGrossDividendRate, CorporateActionRate76.mmNetDividendRate, CorporateActionRate76.mmIndexFactor,
						CorporateActionRate76.mmInterestRateUsedForPayment, CorporateActionRate76.mmMaximumAllowedOversubscriptionRate, CorporateActionRate76.mmProrationRate, CorporateActionRate76.mmWithholdingTaxRate,
						CorporateActionRate76.mmSecondLevelTax, CorporateActionRate76.mmTaxableIncomePerDividendShare, CorporateActionRate76.mmTaxOnIncome);
