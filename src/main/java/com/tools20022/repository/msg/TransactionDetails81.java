...
public class TransactionDetails81 {
	...
	public static final MMMessageAttribute mmFinancialInstrumentIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmPayment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmSettlementQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTradeDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDeliveringSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmReceivingSettlementParties = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SettlementParties40.mmObject();
	...
	public static final MMMessageAssociationEnd mmInvestor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionDetails45.mmInvestor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> TransactionDetails45.mmObject();
			}
		});
	...
	public TransactionDetails81 setFinancialInstrumentIdentification(com.tools20022.repository.msg.SecurityIdentification19 financialInstrumentIdentification) {
	...
	public TransactionDetails81 setSettlementAmount(com.tools20022.repository.msg.AmountAndDirection51 settlementAmount) {
	...
	public TransactionDetails81 setDeliveringSettlementParties(com.tools20022.repository.msg.SettlementParties40 deliveringSettlementParties) {
	...
	public TransactionDetails81 setReceivingSettlementParties(com.tools20022.repository.msg.SettlementParties40 receivingSettlementParties) {
	...
	public TransactionDetails81 setInvestor(com.tools20022.repository.msg.PartyIdentification99 investor) {
