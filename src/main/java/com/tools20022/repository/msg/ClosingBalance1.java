	...
	public static final MMMessageAttribute mmShortLongIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ClosingBalance3.mmShortLongIndicator);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmClosingBalance = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ClosingBalance3.mmClosingBalance);
			maxOccurs = 1;
			minOccurs = 1;
