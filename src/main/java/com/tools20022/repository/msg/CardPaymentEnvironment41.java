 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentEnvironment41#mmCard
 * CardPaymentEnvironment41.mmCard}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CardPaymentEnvironment41#mmPaymentToken
 * CardPaymentEnvironment41.mmPaymentToken}</li>
 * </ul>
 * </li>
...
public class CardPaymentEnvironment41 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification53>> mmAcquirerIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification53>>() {
		{
			businessComponentTrace_lazy = () -> AcquirerRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment41.mmObject();
			isDerived = false;
			xmlTag = "AcqrrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AcquirerIdentification";
			definition = "Acquirer involved in the card payment.";
			previousVersion_lazy = () -> CardPaymentEnvironment28.mmAcquirerIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification53> getValue(CardPaymentEnvironment41 obj) {
			return obj.getAcquirerIdentification();
		}

		@Override
		public void setValue(CardPaymentEnvironment41 obj, Optional<GenericIdentification53> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification32>> mmMerchantIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification32>>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentEnvironment28.mmMerchantIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification32> getValue(CardPaymentEnvironment41 obj) {
			return obj.getMerchantIdentification();
		}

		@Override
		public void setValue(CardPaymentEnvironment41 obj, Optional<GenericIdentification32> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification32>> mmPOIIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<GenericIdentification32>>() {
		{
			...
			previousVersion_lazy = () -> CardPaymentEnvironment28.mmPOIIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GenericIdentification32.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<PaymentCard10>> mmCard = new MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<PaymentCard10>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment41.mmObject();
			isDerived = false;
			xmlTag = "Card";
		...
		@Override
		public Optional<PaymentCard10> getValue(CardPaymentEnvironment41 obj) {
			return obj.getCard();
		}

		@Override
		public void setValue(CardPaymentEnvironment41 obj, Optional<PaymentCard10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<CardPaymentToken2>> mmPaymentToken = new MMMessageAssociationEnd<CardPaymentEnvironment41, Optional<CardPaymentToken2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment41.mmObject();
			isDerived = false;
			xmlTag = "PmtTkn";
		...
		@Override
		public Optional<CardPaymentToken2> getValue(CardPaymentEnvironment41 obj) {
			return obj.getPaymentToken();
		}

		@Override
		public void setValue(CardPaymentEnvironment41 obj, Optional<CardPaymentToken2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment41.mmAcquirerIdentification, com.tools20022.repository.msg.CardPaymentEnvironment41.mmMerchantIdentification,
						com.tools20022.repository.msg.CardPaymentEnvironment41.mmPOIIdentification, com.tools20022.repository.msg.CardPaymentEnvironment41.mmCard, com.tools20022.repository.msg.CardPaymentEnvironment41.mmPaymentToken);
	...
	public CardPaymentEnvironment41 setAcquirerIdentification(GenericIdentification53 acquirerIdentification) {
	...
	public CardPaymentEnvironment41 setMerchantIdentification(GenericIdentification32 merchantIdentification) {
	...
	public CardPaymentEnvironment41 setPOIIdentification(GenericIdentification32 pOIIdentification) {
	...
	public CardPaymentEnvironment41 setCard(PaymentCard10 card) {
		this.card = card;
		return this;
	}
	...
	public CardPaymentEnvironment41 setPaymentToken(CardPaymentToken2 paymentToken) {
