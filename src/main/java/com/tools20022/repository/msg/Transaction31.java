...
public class Transaction31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction31.mmAccountOwnerTransactionIdentification, Transaction31.mmAccountServicerTransactionIdentification, Transaction31.mmMarketInfrastructureTransactionIdentification,
						Transaction31.mmProcessorTransactionIdentification, Transaction31.mmTradeIdentification, Transaction31.mmPoolIdentification, Transaction31.mmCommonIdentification, Transaction31.mmCorporateActionEventIdentification,
						Transaction31.mmTripartyAgentCollateralTransactionIdentification, Transaction31.mmClientTripartyCollateralTransactionIdentification, Transaction31.mmClientCollateralInstructionIdentification,
						Transaction31.mmTripartyCollateralInstructionIdentification, Transaction31.mmTransactionDetails, Transaction31.mmStatusAndReason);
