...
public class TransactionIdentifications12 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications12.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications12.mmAccountOwnerTransactionIdentification, TransactionIdentifications12.mmAccountServicerTransactionIdentification,
						TransactionIdentifications12.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications12.mmProcessorTransactionIdentification);
