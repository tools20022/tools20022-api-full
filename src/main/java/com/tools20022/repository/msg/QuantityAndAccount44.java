...
public class QuantityAndAccount44 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityAndAccount44, Optional<Max210Text>> mmDenominationChoice = new MMMessageAttribute<QuantityAndAccount44, Optional<Max210Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmDenominationChoice;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount44.mmObject();
			isDerived = false;
			xmlTag = "DnmtnChc";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "DenominationChoice";
			definition = "Denomination of the security to be received or delivered.";
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmDenominationChoice);
			previousVersion_lazy = () -> QuantityAndAccount29.mmDenominationChoice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(QuantityAndAccount44 obj) {
			return obj.getDenominationChoice();
		}

		@Override
		public void setValue(QuantityAndAccount44 obj, Optional<Max210Text> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.QuantityAndAccount29#mmAccountOwner
	 * QuantityAndAccount29.mmAccountOwner}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount44, Optional<PartyIdentification98>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount44, Optional<PartyIdentification98>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmAccountOwner);
			previousVersion_lazy = () -> QuantityAndAccount29.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification98> getValue(QuantityAndAccount44 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount44 obj, Optional<PartyIdentification98> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount44, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount44, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmCashAccount);
			previousVersion_lazy = () -> QuantityAndAccount29.mmCashAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(QuantityAndAccount44 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount44 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount44, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount44, Optional<SafeKeepingPlace1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmSafekeepingPlace);
			previousVersion_lazy = () -> QuantityAndAccount29.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(QuantityAndAccount44 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount44 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount44, List<QuantityBreakdown30>> mmQuantityBreakdown = new MMMessageAssociationEnd<QuantityAndAccount44, List<QuantityBreakdown30>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmQuantityBreakdown);
			previousVersion_lazy = () -> QuantityAndAccount29.mmQuantityBreakdown;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<QuantityBreakdown30> getValue(QuantityAndAccount44 obj) {
			return obj.getQuantityBreakdown();
		}

		@Override
		public void setValue(QuantityAndAccount44 obj, List<QuantityBreakdown30> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount44.mmDenominationChoice, com.tools20022.repository.msg.QuantityAndAccount44.mmAccountOwner,
						com.tools20022.repository.msg.QuantityAndAccount44.mmCashAccount, com.tools20022.repository.msg.QuantityAndAccount44.mmSafekeepingPlace, com.tools20022.repository.msg.QuantityAndAccount44.mmQuantityBreakdown);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDenominationRule.forQuantityAndAccount44,
						com.tools20022.repository.constraints.ConstraintSafekeepingPlaceGuideline.forQuantityAndAccount44);
				...
				nextVersions_lazy = () -> Arrays.asList(QuantityAndAccount66.mmObject());
				previousVersion_lazy = () -> QuantityAndAccount29.mmObject();
			}
		});
	...
	public QuantityAndAccount44 setDenominationChoice(Max210Text denominationChoice) {
	...
	public QuantityAndAccount44 setAccountOwner(PartyIdentification98 accountOwner) {
	...
	public QuantityAndAccount44 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public QuantityAndAccount44 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public QuantityAndAccount44 setQuantityBreakdown(List<QuantityBreakdown30> quantityBreakdown) {
