...
public class CorporateActionPrice17 {
	...
	public static final MMMessageAssociationEnd MaximumPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice42.MaximumPrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MinimumPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice42.MinimumPrice);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PriceFormat19Choice.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice17.MaximumPrice, com.tools20022.repository.msg.CorporateActionPrice17.MinimumPrice);
