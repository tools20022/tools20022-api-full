...
public class DeniedReason16 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason16.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedReason16.mmCode, DeniedReason16.mmAdditionalReasonInformation);
	...
	public void setCode(DeniedReason21Choice code) {
		this.code = code;
	}
