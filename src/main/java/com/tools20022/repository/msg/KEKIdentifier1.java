	...
	public static final MMMessageAttribute mmKeyIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.KEKIdentifier2.mmKeyIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmKeyVersion = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.KEKIdentifier2.mmKeyVersion);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmDerivationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.KEKIdentifier2.mmDerivationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
