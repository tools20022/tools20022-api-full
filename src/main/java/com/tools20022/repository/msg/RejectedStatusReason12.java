...
public class RejectedStatusReason12 {
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason12.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason12.mmReason, RejectedStatusReason12.mmAdditionalReasonInformation);
	...
	public void setReason(RejectedReason8Choice reason) {
		this.reason = reason;
	}
