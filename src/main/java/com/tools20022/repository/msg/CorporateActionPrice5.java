...
public class CorporateActionPrice5 {
	...
	public static final MMMessageAttribute mmExercisePrice = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice5.mmObject();
			isDerived = false;
			xmlTag = "ExrcPric";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice5.mmExercisePrice, CorporateActionPrice5.mmGenericCashPriceReceivedPerProduct, CorporateActionPrice5.mmGenericCashPricePaidPerProduct,
						CorporateActionPrice5.mmTaxableIncomePerDividendShare, CorporateActionPrice5.mmCashInLieuOfSharePrice, CorporateActionPrice5.mmOverSubscriptionDepositPrice);
