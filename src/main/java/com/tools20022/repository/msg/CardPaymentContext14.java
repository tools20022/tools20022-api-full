...
public class CardPaymentContext14 {
	...
	public static final MMMessageAssociationEnd mmPaymentContext = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext20.mmPaymentContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentContext8.mmPaymentContext;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSaleContext = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext20.mmSaleContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentContext8.mmSaleContext;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public void setPaymentContext(com.tools20022.repository.msg.PaymentContext14 paymentContext) {
