 ...
 * <li>{@linkplain com.tools20022.repository.msg.BillingService1#PaymentMethod
 ...
 * <li>{@linkplain com.tools20022.repository.msg.BillingService1#TaxDesignation
 * BillingService1.TaxDesignation}</li>
 * <li>{@linkplain com.tools20022.repository.msg.BillingService1#TaxCalculation
...
public class BillingService1 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.BillingService2#ServiceDetail
	...
	public static final MMMessageAttribute ServiceDetail = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> BillingService1.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.ServiceDetail);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Price = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.Price);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentMethod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.PaymentMethod);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalChargePrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.OriginalChargePrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalChargeSettlementAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.OriginalChargeSettlementAmount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> AmountAndDirection34.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd BalanceRequiredAccountAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.BalanceRequiredAccountAmount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> AmountAndDirection34.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute TaxDesignation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.TaxDesignation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TaxCalculation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService2.TaxCalculation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingService1.ServiceDetail, com.tools20022.repository.msg.BillingService1.Price, com.tools20022.repository.msg.BillingService1.PaymentMethod,
						com.tools20022.repository.msg.BillingService1.OriginalChargePrice, com.tools20022.repository.msg.BillingService1.OriginalChargeSettlementAmount,
						com.tools20022.repository.msg.BillingService1.BalanceRequiredAccountAmount, com.tools20022.repository.msg.BillingService1.TaxDesignation, com.tools20022.repository.msg.BillingService1.TaxCalculation);
