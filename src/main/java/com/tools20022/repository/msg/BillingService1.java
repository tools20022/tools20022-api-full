...
public class BillingService1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BillingService1.mmServiceDetail, BillingService1.mmPrice, BillingService1.mmPaymentMethod, BillingService1.mmOriginalChargePrice, BillingService1.mmOriginalChargeSettlementAmount,
						BillingService1.mmBalanceRequiredAccountAmount, BillingService1.mmTaxDesignation, BillingService1.mmTaxCalculation);
