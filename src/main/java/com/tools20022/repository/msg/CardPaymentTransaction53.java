...
public class CardPaymentTransaction53 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction53.mmSaleReferenceIdentification, CardPaymentTransaction53.mmTransactionIdentification, CardPaymentTransaction53.mmInitiatorTransactionIdentification,
						CardPaymentTransaction53.mmRecipientTransactionIdentification, CardPaymentTransaction53.mmReconciliationIdentification, CardPaymentTransaction53.mmInterchangeData, CardPaymentTransaction53.mmTransactionDetails,
						CardPaymentTransaction53.mmMerchantReferenceData);
