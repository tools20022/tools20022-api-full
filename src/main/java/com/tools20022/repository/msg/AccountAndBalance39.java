...
public class AccountAndBalance39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance39.mmSafekeepingAccount, AccountAndBalance39.mmAccountOwner, AccountAndBalance39.mmSafekeepingPlace, AccountAndBalance39.mmBalance);
