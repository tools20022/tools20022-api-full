...
public class AccountAndBalance39 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance39.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	public CorporateActionBalanceDetails36 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails36 balance) {
