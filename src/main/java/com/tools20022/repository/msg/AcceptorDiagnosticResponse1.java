...
import com.tools20022.repository.area.caaa.AcceptorDiagnosticResponseV01;
import com.tools20022.repository.entity.CardPayment;
import com.tools20022.repository.entity.CardPaymentAcquiring;
import com.tools20022.repository.GeneratedRepository;
import com.tools20022.repository.msg.CardPaymentEnvironment8;
...
@XmlType(name = "AcceptorDiagnosticResponse1", propOrder = {"environment", "tMSTrigger"})
public class AcceptorDiagnosticResponse1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorDiagnosticResponse1, CardPaymentEnvironment8> mmEnvironment = new MMMessageAssociationEnd<AcceptorDiagnosticResponse1, CardPaymentEnvironment8>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptorDiagnosticResponse1.mmObject();
			isDerived = false;
			xmlTag = "Envt";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CardPaymentEnvironment8.mmObject();
		}

		@Override
		public CardPaymentEnvironment8 getValue(AcceptorDiagnosticResponse1 obj) {
			return obj.getEnvironment();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponse1 obj, CardPaymentEnvironment8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorDiagnosticResponse1, Optional<TMSTrigger1>> mmTMSTrigger = new MMMessageAssociationEnd<AcceptorDiagnosticResponse1, Optional<TMSTrigger1>>() {
		{
		...
		@Override
		public Optional<TMSTrigger1> getValue(AcceptorDiagnosticResponse1 obj) {
			return obj.getTMSTrigger();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponse1 obj, Optional<TMSTrigger1> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorDiagnosticResponseV01.mmDiagnosticResponse);
	...
	public AcceptorDiagnosticResponse1 setEnvironment(CardPaymentEnvironment8 environment) {
	...
	public AcceptorDiagnosticResponse1 setTMSTrigger(TMSTrigger1 tMSTrigger) {
