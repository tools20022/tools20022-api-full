...
public class PriceDetails12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails12.GenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails12.GenericCashPriceReceivedPerProduct);
