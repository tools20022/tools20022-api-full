...
public class PriceDetails12 {
	...
	public static final MMMessageAssociationEnd mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PriceDetails12.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceDetails12.mmGenericCashPricePaidPerProduct, PriceDetails12.mmGenericCashPriceReceivedPerProduct);
