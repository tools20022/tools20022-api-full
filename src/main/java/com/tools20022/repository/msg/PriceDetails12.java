 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails12
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails12}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails12", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails12, Optional<PriceFormat12Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails12, Optional<PriceFormat12Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails12.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat12Choice> getValue(PriceDetails12 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails12 obj, Optional<PriceFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails12, Optional<PriceFormat13Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails12, Optional<PriceFormat13Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat13Choice> getValue(PriceDetails12 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails12 obj, Optional<PriceFormat13Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails12.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails12.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails12);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PriceDetails12";
	...
	public PriceDetails12 setGenericCashPricePaidPerProduct(PriceFormat12Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails12 setGenericCashPriceReceivedPerProduct(PriceFormat13Choice genericCashPriceReceivedPerProduct) {
