...
public class SubAccountIdentification5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification5.mmIdentification, SubAccountIdentification5.mmFungibleIndicator, SubAccountIdentification5.mmActivityIndicator,
						SubAccountIdentification5.mmBalanceForSubAccount);
