 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubAccountIdentification5#mmActivityIndicator
 * SubAccountIdentification5.mmActivityIndicator}</li>
 * <li>
...
@XmlType(name = "SubAccountIdentification5", propOrder = {"identification", "fungibleIndicator", "activityIndicator", "balanceForSubAccount"})
public class SubAccountIdentification5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubAccountIdentification5, AccountIdentificationFormatChoice> mmIdentification = new MMMessageAttribute<SubAccountIdentification5, AccountIdentificationFormatChoice>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification5.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public AccountIdentificationFormatChoice getValue(SubAccountIdentification5 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(SubAccountIdentification5 obj, AccountIdentificationFormatChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubAccountIdentification5, YesNoIndicator> mmFungibleIndicator = new MMMessageAttribute<SubAccountIdentification5, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(SubAccountIdentification5 obj) {
			return obj.getFungibleIndicator();
		}

		@Override
		public void setValue(SubAccountIdentification5 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubAccountIdentification5, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<SubAccountIdentification5, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification5.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
	...
	protected List<AggregateBalanceInformation4> balanceForSubAccount;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification5, List<AggregateBalanceInformation4>> mmBalanceForSubAccount = new MMMessageAssociationEnd<SubAccountIdentification5, List<AggregateBalanceInformation4>>() {
		{
		...
		@Override
		public List<AggregateBalanceInformation4> getValue(SubAccountIdentification5 obj) {
			return obj.getBalanceForSubAccount();
		}

		@Override
		public void setValue(SubAccountIdentification5 obj, List<AggregateBalanceInformation4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification5.mmIdentification, com.tools20022.repository.msg.SubAccountIdentification5.mmFungibleIndicator,
						com.tools20022.repository.msg.SubAccountIdentification5.mmActivityIndicator, com.tools20022.repository.msg.SubAccountIdentification5.mmBalanceForSubAccount);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustodyStatementOfHoldingsV02.mmSubAccountDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SubAccountIdentification5";
	...
	public SubAccountIdentification5 setIdentification(AccountIdentificationFormatChoice identification) {
	...
	public SubAccountIdentification5 setFungibleIndicator(YesNoIndicator fungibleIndicator) {
	...
	public SubAccountIdentification5 setActivityIndicator(YesNoIndicator activityIndicator) {
		this.activityIndicator = Objects.requireNonNull(activityIndicator);
		return this;
	}

	public List<AggregateBalanceInformation4> getBalanceForSubAccount() {
		return balanceForSubAccount == null ? balanceForSubAccount = new ArrayList<>() : balanceForSubAccount;
	}

	public SubAccountIdentification5 setBalanceForSubAccount(List<AggregateBalanceInformation4> balanceForSubAccount) {
