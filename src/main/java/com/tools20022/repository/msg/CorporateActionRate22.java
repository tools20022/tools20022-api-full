...
public class CorporateActionRate22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate22.mmGrossDividendRate, CorporateActionRate22.mmIndexFactor, CorporateActionRate22.mmInterestRateUsedForPayment,
						CorporateActionRate22.mmMaximumAllowedOversubscriptionRate, CorporateActionRate22.mmProrationRate, CorporateActionRate22.mmTaxRelatedRate, CorporateActionRate22.mmWithholdingTaxRate,
						CorporateActionRate22.mmAdditionalTax, CorporateActionRate22.mmTaxableIncomePerDividendShare);
