	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmTradeIdentification;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails80, List<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmAccountOwnerTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails80, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails80, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<TradeDate8Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<TradeDate8Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, SettlementDate17Choice> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails80, SettlementDate17Choice>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<Price7>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<Price7>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<SecuritiesTradeDetails80, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails80, Optional<Max3Number>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, List<TradeTransactionCondition5Choice>> mmTradeTransactionCondition = new MMMessageAssociationEnd<SecuritiesTradeDetails80, List<TradeTransactionCondition5Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmTradeTransactionCondition;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<TypeOfPrice29Choice>> mmTypeOfPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails80, Optional<TypeOfPrice29Choice>>() {
		{
			...
			previousVersion_lazy = () -> SecuritiesTradeDetails54.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> SecuritiesTradeDetails54.mmObject();
			}
		});
