...
public class PartyIdentificationAndAccount46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount46.mmIdentification, PartyIdentificationAndAccount46.mmAlternateIdentification, PartyIdentificationAndAccount46.mmCountryOfResidence,
						PartyIdentificationAndAccount46.mmSafekeepingAccount, PartyIdentificationAndAccount46.mmProcessingIdentification, PartyIdentificationAndAccount46.mmAdditionalInformation);
