...
public class NotificationItem3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NotificationItem3.mmIdentification, NotificationItem3.mmEndToEndIdentification, NotificationItem3.mmAccount, NotificationItem3.mmAccountOwner, NotificationItem3.mmAccountServicer,
						NotificationItem3.mmRelatedAccount, NotificationItem3.mmAmount, NotificationItem3.mmExpectedValueDate, NotificationItem3.mmDebtor, NotificationItem3.mmDebtorAgent, NotificationItem3.mmIntermediaryAgent,
						NotificationItem3.mmPurpose, NotificationItem3.mmRelatedRemittanceInformation, NotificationItem3.mmRemittanceInformation);
