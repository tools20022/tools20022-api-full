...
public class Transaction7 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction7.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction7.mmAccountOwnerTransactionIdentification, Transaction7.mmAccountServicerTransactionIdentification, Transaction7.mmMarketInfrastructureTransactionIdentification,
						Transaction7.mmTradeIdentification, Transaction7.mmPoolIdentification, Transaction7.mmCommonIdentification, Transaction7.mmCorporateActionEventIdentification,
						Transaction7.mmTripartyAgentCollateralTransactionIdentification, Transaction7.mmClientTripartyCollateralTransactionIdentification, Transaction7.mmTransactionDetails);
	...
	public TransactionDetails7 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails7 transactionDetails) {
