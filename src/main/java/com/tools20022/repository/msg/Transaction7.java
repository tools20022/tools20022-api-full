...
import com.tools20022.repository.msg.TransactionDetails7;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction7
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction7}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction7
 * ConstraintCoexistenceIdentificationRule.forTransaction7}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction7", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "tradeIdentification", "poolIdentification",
		"commonIdentification", "corporateActionEventIdentification", "tripartyAgentCollateralTransactionIdentification", "clientTripartyCollateralTransactionIdentification", "transactionDetails"})
public class Transaction7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction7, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction7.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(Transaction7 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction7 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transaction7 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction7, List<Max35Text>>() {
		{
		...
		@Override
		public List<Max35Text> getValue(Transaction7 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction7 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction7, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction7, Optional<Max35Text>>() {
		{
	...
	protected TransactionDetails7 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails7
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction7, Optional<TransactionDetails7>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction7, Optional<TransactionDetails7>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails7.mmObject();
		}

		@Override
		public Optional<TransactionDetails7> getValue(Transaction7 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction7 obj, Optional<TransactionDetails7> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction7.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction7.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction7.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction7.mmTradeIdentification,
						com.tools20022.repository.msg.Transaction7.mmPoolIdentification, com.tools20022.repository.msg.Transaction7.mmCommonIdentification, com.tools20022.repository.msg.Transaction7.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction7.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction7.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction7.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction7,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction7);
	...
	public Transaction7 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction7 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction7 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction7 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction7 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction7 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction7 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction7 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction7 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails7> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction7 setTransactionDetails(TransactionDetails7 transactionDetails) {
