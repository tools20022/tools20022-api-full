...
public class PartyIdentificationAndAccount18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount18.mmIdentification, PartyIdentificationAndAccount18.mmCashAccount, PartyIdentificationAndAccount18.mmProcessingIdentification,
						PartyIdentificationAndAccount18.mmAdditionalInformation, PartyIdentificationAndAccount18.mmAlternateIdentification);
	...
	public void setIdentification(PartyIdentification30Choice identification) {
