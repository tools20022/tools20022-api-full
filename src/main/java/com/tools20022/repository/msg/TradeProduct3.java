 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.TradeProduct2
 * TradeProduct2}</li>
 * </ul>
 */
...
public class TradeProduct3 {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TradeProduct2#mmName
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TradeProduct2.mmName;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmDescription = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TradeProduct2.mmDescription;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmGlobalSerialIdentifier = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TradeProduct2.mmGlobalSerialIdentifier;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	};
