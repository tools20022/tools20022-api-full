...
public class DeliveringPartiesAndAccount7 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDepositoryGuideline.forDeliveringPartiesAndAccount7);
	...
	public DeliveringPartiesAndAccount7 setDepository(PartyIdentification34Choice depository) {
	...
	public DeliveringPartiesAndAccount7 setSecuritiesSettlementSystem(Max35Text securitiesSettlementSystem) {
