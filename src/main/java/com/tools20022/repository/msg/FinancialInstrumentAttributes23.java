...
public class FinancialInstrumentAttributes23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes23.mmSecurityIdentification, FinancialInstrumentAttributes23.mmPlaceOfListing, FinancialInstrumentAttributes23.mmDayCountBasis,
						FinancialInstrumentAttributes23.mmClassificationType, FinancialInstrumentAttributes23.mmOptionStyle, FinancialInstrumentAttributes23.mmDenominationCurrency, FinancialInstrumentAttributes23.mmNextCouponDate,
						FinancialInstrumentAttributes23.mmExpiryDate, FinancialInstrumentAttributes23.mmFloatingRateFixingDate, FinancialInstrumentAttributes23.mmMaturityDate, FinancialInstrumentAttributes23.mmIssueDate,
						FinancialInstrumentAttributes23.mmNextCallableDate, FinancialInstrumentAttributes23.mmPutableDate, FinancialInstrumentAttributes23.mmDatedDate, FinancialInstrumentAttributes23.mmConversionDate,
						FinancialInstrumentAttributes23.mmInterestRate, FinancialInstrumentAttributes23.mmNextInterestRate, FinancialInstrumentAttributes23.mmPercentageOfDebtClaim, FinancialInstrumentAttributes23.mmPreviousFactor,
						FinancialInstrumentAttributes23.mmNextFactor, FinancialInstrumentAttributes23.mmMinimumNominalQuantity, FinancialInstrumentAttributes23.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes23.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes23.mmContractSize);
