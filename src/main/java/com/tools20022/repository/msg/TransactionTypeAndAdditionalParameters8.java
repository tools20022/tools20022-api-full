...
public class TransactionTypeAndAdditionalParameters8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters8.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters8.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters8.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters8.mmPayment, TransactionTypeAndAdditionalParameters8.mmModificationType,
						TransactionTypeAndAdditionalParameters8.mmCommonIdentification, TransactionTypeAndAdditionalParameters8.mmPoolIdentification);
