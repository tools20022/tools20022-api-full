...
public class TransactionTypeAndAdditionalParameters8 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionTypeAndAdditionalParameters8.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	public RepurchaseType9Choice getModificationType() {
		return modificationType;
	}

	public void setModificationType(RepurchaseType9Choice modificationType) {
