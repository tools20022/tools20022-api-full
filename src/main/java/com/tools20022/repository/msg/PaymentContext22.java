 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext22#CardPresent
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentContext22#FallbackIndicator
 * PaymentContext22.FallbackIndicator}</li>
 * </ul>
 * </li>
...
public class PaymentContext22 {
	...
	public static final MMMessageAttribute CardPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.CardPresent;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardholderPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.CardholderPresent;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.AttendanceContext;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionEnvironment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.TransactionEnvironment;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionChannel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.TransactionChannel;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AttendantMessageCapable = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.AttendantMessageCapable;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendantLanguage = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.AttendantLanguage;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardDataEntryMode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.CardDataEntryMode;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FallbackIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext16.FallbackIndicator;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext22.CardPresent, com.tools20022.repository.msg.PaymentContext22.CardholderPresent,
						com.tools20022.repository.msg.PaymentContext22.AttendanceContext, com.tools20022.repository.msg.PaymentContext22.TransactionEnvironment, com.tools20022.repository.msg.PaymentContext22.TransactionChannel,
						com.tools20022.repository.msg.PaymentContext22.AttendantMessageCapable, com.tools20022.repository.msg.PaymentContext22.AttendantLanguage, com.tools20022.repository.msg.PaymentContext22.CardDataEntryMode,
						com.tools20022.repository.msg.PaymentContext22.FallbackIndicator);
