 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalInforrmationRule#forUpdatedAdditionalInformation7
 * ConstraintAdditionalInforrmationRule.forUpdatedAdditionalInformation7}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetZRule#forUpdatedAdditionalInformation7
 * ConstraintCoexistenceCharacterSetZRule.forUpdatedAdditionalInformation7}</li>
 * </ul>
 * </li>
 * <li>
...
public class UpdatedAdditionalInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedAdditionalInformation7, Optional<RestrictedFINXMax140Text>> mmUpdateDescription = new MMMessageAttribute<UpdatedAdditionalInformation7, Optional<RestrictedFINXMax140Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UpdatedAdditionalInformation7.mmObject();
			isDerived = false;
			xmlTag = "UpdDesc";
		...
		@Override
		public Optional<RestrictedFINXMax140Text> getValue(UpdatedAdditionalInformation7 obj) {
			return obj.getUpdateDescription();
		}

		@Override
		public void setValue(UpdatedAdditionalInformation7 obj, Optional<RestrictedFINXMax140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedAdditionalInformation7, Optional<ISODate>> mmUpdateDate = new MMMessageAttribute<UpdatedAdditionalInformation7, Optional<ISODate>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UpdatedAdditionalInformation7.mmObject();
			isDerived = false;
			xmlTag = "UpdDt";
		...
		@Override
		public Optional<ISODate> getValue(UpdatedAdditionalInformation7 obj) {
			return obj.getUpdateDate();
		}

		@Override
		public void setValue(UpdatedAdditionalInformation7 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdatedAdditionalInformation7, List<Max8000Text>> mmAdditionalInformation = new MMMessageAttribute<UpdatedAdditionalInformation7, List<Max8000Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UpdatedAdditionalInformation7.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
		...
		@Override
		public List<Max8000Text> getValue(UpdatedAdditionalInformation7 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(UpdatedAdditionalInformation7 obj, List<Max8000Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalInforrmationRule.forUpdatedAdditionalInformation7,
						com.tools20022.repository.constraints.ConstraintCoexistenceCharacterSetZRule.forUpdatedAdditionalInformation7);
	...
	public UpdatedAdditionalInformation7 setUpdateDescription(RestrictedFINXMax140Text updateDescription) {
	...
	public UpdatedAdditionalInformation7 setUpdateDate(ISODate updateDate) {
	...
	public UpdatedAdditionalInformation7 setAdditionalInformation(List<Max8000Text> additionalInformation) {
