...
public class TotalValueInPageAndStatement4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TotalValueInPageAndStatement4, Optional<AmountAndDirection14>> mmTotalHoldingsValueOfPage = new MMMessageAssociationEnd<TotalValueInPageAndStatement4, Optional<AmountAndDirection14>>() {
		{
		...
		@Override
		public Optional<AmountAndDirection14> getValue(TotalValueInPageAndStatement4 obj) {
			return obj.getTotalHoldingsValueOfPage();
		}

		@Override
		public void setValue(TotalValueInPageAndStatement4 obj, Optional<AmountAndDirection14> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TotalValueInPageAndStatement4, AmountAndDirection14> mmTotalHoldingsValueOfStatement = new MMMessageAssociationEnd<TotalValueInPageAndStatement4, AmountAndDirection14>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TotalValueInPageAndStatement4.mmObject();
			isDerived = false;
		...
		@Override
		public AmountAndDirection14 getValue(TotalValueInPageAndStatement4 obj) {
			return obj.getTotalHoldingsValueOfStatement();
		}

		@Override
		public void setValue(TotalValueInPageAndStatement4 obj, AmountAndDirection14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TotalValueInPageAndStatement4, Optional<AmountAndDirection14>> mmTotalBookValueOfStatement = new MMMessageAssociationEnd<TotalValueInPageAndStatement4, Optional<AmountAndDirection14>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TotalValueInPageAndStatement4.mmObject();
			isDerived = false;
	...
	public TotalValueInPageAndStatement4 setTotalHoldingsValueOfPage(AmountAndDirection14 totalHoldingsValueOfPage) {
	...
	public TotalValueInPageAndStatement4 setTotalHoldingsValueOfStatement(AmountAndDirection14 totalHoldingsValueOfStatement) {
	...
	public TotalValueInPageAndStatement4 setTotalBookValueOfStatement(AmountAndDirection14 totalBookValueOfStatement) {
