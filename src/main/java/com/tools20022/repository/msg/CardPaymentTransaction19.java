...
public class CardPaymentTransaction19 {
	...
	public static final MMMessageAttribute mmTransactionCapture = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction19.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction19.mmTransactionCapture, CardPaymentTransaction19.mmTransactionType, CardPaymentTransaction19.mmAdditionalService, CardPaymentTransaction19.mmServiceAttribute,
						CardPaymentTransaction19.mmMerchantCategoryCode, CardPaymentTransaction19.mmTransactionIdentification, CardPaymentTransaction19.mmOriginalTransaction, CardPaymentTransaction19.mmInitiatorTransactionIdentification,
						CardPaymentTransaction19.mmReconciliationIdentification, CardPaymentTransaction19.mmTransactionDetails, CardPaymentTransaction19.mmAdditionalTransactionData);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails10 transactionDetails) {
