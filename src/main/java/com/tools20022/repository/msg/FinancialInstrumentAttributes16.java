...
public class FinancialInstrumentAttributes16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes16.mmSecurityIdentification, FinancialInstrumentAttributes16.mmPlaceOfListing, FinancialInstrumentAttributes16.mmDayCountBasis,
						FinancialInstrumentAttributes16.mmClassificationType, FinancialInstrumentAttributes16.mmOptionStyle, FinancialInstrumentAttributes16.mmDenominationCurrency, FinancialInstrumentAttributes16.mmNextCouponDate,
						FinancialInstrumentAttributes16.mmFloatingRateFixingDate, FinancialInstrumentAttributes16.mmMaturityDate, FinancialInstrumentAttributes16.mmIssueDate, FinancialInstrumentAttributes16.mmNextCallableDate,
						FinancialInstrumentAttributes16.mmPutableDate, FinancialInstrumentAttributes16.mmDatedDate, FinancialInstrumentAttributes16.mmConversionDate, FinancialInstrumentAttributes16.mmPreviousFactor,
						FinancialInstrumentAttributes16.mmNextFactor, FinancialInstrumentAttributes16.mmInterestRate, FinancialInstrumentAttributes16.mmNextInterestRate, FinancialInstrumentAttributes16.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes16.mmMinimumExercisableQuantity, FinancialInstrumentAttributes16.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes16.mmContractSize,
						FinancialInstrumentAttributes16.mmIssuePrice);
