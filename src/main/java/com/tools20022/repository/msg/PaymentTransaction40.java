...
@XmlType(name = "PaymentTransaction40", propOrder = {"cancellationStatusIdentification", "resolvedCase", "originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification",
...
public class PaymentTransaction40 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>> mmCancellationStatusIdentification = new MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction40.mmObject();
			isDerived = false;
			xmlTag = "CxlStsId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmCancellationStatusIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction40 obj) {
			return obj.getCancellationStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<Case3>> mmResolvedCase = new MMMessageAssociationEnd<PaymentTransaction40, Optional<Case3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmResolvedCase);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Case3> getValue(PaymentTransaction40 obj) {
			return obj.getResolvedCase();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction40, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalGroupInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction40 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalEndToEndIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction40, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalClearingSystemReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<CancellationIndividualStatus1Code>> mmTransactionCancellationStatus = new MMMessageAttribute<PaymentTransaction40, Optional<CancellationIndividualStatus1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmTransactionCancellationStatus);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CancellationIndividualStatus1Code> getValue(PaymentTransaction40 obj) {
			return obj.getTransactionCancellationStatus();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<CancellationIndividualStatus1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, List<CancellationStatusReason2>> mmCancellationStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction40, List<CancellationStatusReason2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmCancellationStatusReasonInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<CancellationStatusReason2> getValue(PaymentTransaction40 obj) {
			return obj.getCancellationStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, List<CancellationStatusReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<ResolutionInformation1>> mmResolutionRelatedInformation = new MMMessageAssociationEnd<PaymentTransaction40, Optional<ResolutionInformation1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmResolutionRelatedInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ResolutionInformation1> getValue(PaymentTransaction40 obj) {
			return obj.getResolutionRelatedInformation();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<ResolutionInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction40, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalInterbankSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction40 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction40, Optional<ISODate>> mmOriginalInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction40, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalInterbankSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction40 obj) {
			return obj.getOriginalInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<Party12Choice>> mmAssigner = new MMMessageAssociationEnd<PaymentTransaction40, Optional<Party12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmAssigner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Party12Choice> getValue(PaymentTransaction40 obj) {
			return obj.getAssigner();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<Party12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<Party12Choice>> mmAssignee = new MMMessageAssociationEnd<PaymentTransaction40, Optional<Party12Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction40.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmAssignee);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Party12Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction40, Optional<OriginalTransactionReference16>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction40, Optional<OriginalTransactionReference16>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmOriginalTransactionReference);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference16> getValue(PaymentTransaction40 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction40 obj, Optional<OriginalTransactionReference16> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction40.mmCancellationStatusIdentification, com.tools20022.repository.msg.PaymentTransaction40.mmResolvedCase,
						com.tools20022.repository.msg.PaymentTransaction40.mmOriginalGroupInformation, com.tools20022.repository.msg.PaymentTransaction40.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction40.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction40.mmOriginalTransactionIdentification,
						com.tools20022.repository.msg.PaymentTransaction40.mmOriginalClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction40.mmTransactionCancellationStatus,
						com.tools20022.repository.msg.PaymentTransaction40.mmCancellationStatusReasonInformation, com.tools20022.repository.msg.PaymentTransaction40.mmResolutionRelatedInformation,
						com.tools20022.repository.msg.PaymentTransaction40.mmOriginalInterbankSettlementAmount, com.tools20022.repository.msg.PaymentTransaction40.mmOriginalInterbankSettlementDate,
						com.tools20022.repository.msg.PaymentTransaction40.mmAssigner, com.tools20022.repository.msg.PaymentTransaction40.mmAssignee, com.tools20022.repository.msg.PaymentTransaction40.mmOriginalTransactionReference);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction40";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction53.mmObject());
			}
		});
	...
	public PaymentTransaction40 setCancellationStatusIdentification(Max35Text cancellationStatusIdentification) {
	...
	public PaymentTransaction40 setResolvedCase(Case3 resolvedCase) {
	...
	public PaymentTransaction40 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction40 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction40 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction40 setOriginalTransactionIdentification(Max35Text originalTransactionIdentification) {
	...
	public PaymentTransaction40 setOriginalClearingSystemReference(Max35Text originalClearingSystemReference) {
	...
	public PaymentTransaction40 setTransactionCancellationStatus(CancellationIndividualStatus1Code transactionCancellationStatus) {
	...
	public PaymentTransaction40 setCancellationStatusReasonInformation(List<CancellationStatusReason2> cancellationStatusReasonInformation) {
	...
	public PaymentTransaction40 setResolutionRelatedInformation(ResolutionInformation1 resolutionRelatedInformation) {
	...
	public PaymentTransaction40 setOriginalInterbankSettlementAmount(ActiveOrHistoricCurrencyAndAmount originalInterbankSettlementAmount) {
	...
	public PaymentTransaction40 setOriginalInterbankSettlementDate(ISODate originalInterbankSettlementDate) {
	...
	public PaymentTransaction40 setAssigner(Party12Choice assigner) {
	...
	public PaymentTransaction40 setAssignee(Party12Choice assignee) {
	...
	public PaymentTransaction40 setOriginalTransactionReference(OriginalTransactionReference16 originalTransactionReference) {
