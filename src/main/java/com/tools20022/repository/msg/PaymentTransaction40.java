...
public class PaymentTransaction40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction40.mmCancellationStatusIdentification, PaymentTransaction40.mmResolvedCase, PaymentTransaction40.mmOriginalGroupInformation,
						PaymentTransaction40.mmOriginalInstructionIdentification, PaymentTransaction40.mmOriginalEndToEndIdentification, PaymentTransaction40.mmOriginalTransactionIdentification,
						PaymentTransaction40.mmOriginalClearingSystemReference, PaymentTransaction40.mmTransactionCancellationStatus, PaymentTransaction40.mmCancellationStatusReasonInformation,
						PaymentTransaction40.mmResolutionRelatedInformation, PaymentTransaction40.mmOriginalInterbankSettlementAmount, PaymentTransaction40.mmOriginalInterbankSettlementDate, PaymentTransaction40.mmAssigner,
						PaymentTransaction40.mmAssignee, PaymentTransaction40.mmOriginalTransactionReference);
