...
public class QuantityAndAccount37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount37.mmSettledQuantity, QuantityAndAccount37.mmPreviouslySettledQuantity, QuantityAndAccount37.mmRemainingToBeSettledQuantity,
						QuantityAndAccount37.mmPreviouslySettledAmount, QuantityAndAccount37.mmRemainingToBeSettledAmount, QuantityAndAccount37.mmDenominationChoice, QuantityAndAccount37.mmAccountOwner,
						QuantityAndAccount37.mmSafekeepingAccount, QuantityAndAccount37.mmCashAccount, QuantityAndAccount37.mmQuantityBreakdown, QuantityAndAccount37.mmSafekeepingPlace);
