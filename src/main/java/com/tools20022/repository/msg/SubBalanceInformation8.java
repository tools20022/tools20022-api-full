...
public class SubBalanceInformation8 {
	...
	protected List<com.tools20022.repository.msg.AdditionalBalanceInformation8> additionalBalanceBreakdownDetails;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation8.mmSubBalanceType, SubBalanceInformation8.mmQuantity, SubBalanceInformation8.mmSubBalanceAdditionalDetails, SubBalanceInformation8.mmQuantityBreakdown,
						SubBalanceInformation8.mmAdditionalBalanceBreakdownDetails);
	...
	public void setAdditionalBalanceBreakdownDetails(List<com.tools20022.repository.msg.AdditionalBalanceInformation8> additionalBalanceBreakdownDetails) {
