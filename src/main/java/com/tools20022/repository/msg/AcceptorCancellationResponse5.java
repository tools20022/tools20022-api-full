...
public class AcceptorCancellationResponse5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationResponse5.mmEnvironment, AcceptorCancellationResponse5.mmTransaction, AcceptorCancellationResponse5.mmTransactionResponse);
