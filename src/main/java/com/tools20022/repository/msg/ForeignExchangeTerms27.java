...
public class ForeignExchangeTerms27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms27.mmUnitCurrency, ForeignExchangeTerms27.mmQuotedCurrency, ForeignExchangeTerms27.mmExchangeRate, ForeignExchangeTerms27.mmResultingAmount);
