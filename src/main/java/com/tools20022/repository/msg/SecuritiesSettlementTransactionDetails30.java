...
public class SecuritiesSettlementTransactionDetails30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails30.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails30.mmLinkages,
						SecuritiesSettlementTransactionDetails30.mmTradeDetails, SecuritiesSettlementTransactionDetails30.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails30.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails30.mmSettlementParameters, SecuritiesSettlementTransactionDetails30.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails30.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails30.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails30.mmCashParties,
						SecuritiesSettlementTransactionDetails30.mmSettlementAmount, SecuritiesSettlementTransactionDetails30.mmOtherAmounts, SecuritiesSettlementTransactionDetails30.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails30.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails30.mmSupplementaryData);
