 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection10#mmAmount
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndDirection10
 * ConstraintCoexistenceAmountRule.forAmountAndDirection10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AmountAndDirection10", propOrder = {"amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails"})
public class AmountAndDirection10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection10, ActiveCurrencyAndAmount> mmAmount = new MMMessageAttribute<AmountAndDirection10, ActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection10.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection49.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAndAmount getValue(AmountAndDirection10 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection10 obj, ActiveCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection10, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection10, Optional<CreditDebitCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection49.mmCreditDebitIndicator);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CreditDebitCode> getValue(AmountAndDirection10 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection10 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection10, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection10, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection49.mmOriginalCurrencyAndOrderedAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection10 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection10 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection10, Optional<ForeignExchangeTerms11>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection10, Optional<ForeignExchangeTerms11>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AmountAndDirection49.mmForeignExchangeDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ForeignExchangeTerms11> getValue(AmountAndDirection10 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection10 obj, Optional<ForeignExchangeTerms11> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection10.mmAmount, com.tools20022.repository.msg.AmountAndDirection10.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection10.mmOriginalCurrencyAndOrderedAmount, com.tools20022.repository.msg.AmountAndDirection10.mmForeignExchangeDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingModificationInstructionV01.mmOpeningSettlementAmount, SecuritiesFinancingModificationInstructionV02.mmOpeningSettlementAmount,
						SecuritiesFinancingModificationInstructionV03.mmOpeningSettlementAmount, SecuritiesFinancingModificationInstructionV04.mmOpeningSettlementAmount);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection10);
				...
				name = "AmountAndDirection10";
				definition = "Amount of money debited or credited on the books of an account servicer.";
				nextVersions_lazy = () -> Arrays.asList(AmountAndDirection49.mmObject());
			}
		});
	...
	public AmountAndDirection10 setAmount(ActiveCurrencyAndAmount amount) {
	...
	public AmountAndDirection10 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection10 setOriginalCurrencyAndOrderedAmount(ActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection10 setForeignExchangeDetails(ForeignExchangeTerms11 foreignExchangeDetails) {
