...
public class SubBalanceInformation9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubBalanceInformation9.mmSubBalanceType, SubBalanceInformation9.mmQuantity, SubBalanceInformation9.mmSubBalanceAdditionalDetails, SubBalanceInformation9.mmQuantityBreakdown,
						SubBalanceInformation9.mmAdditionalBalanceBreakdownDetails);
