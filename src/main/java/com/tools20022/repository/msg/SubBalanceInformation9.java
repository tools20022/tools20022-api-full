...
public class SubBalanceInformation9 {
	...
	public static final MMMessageAttribute mmSubBalanceType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SubBalanceInformation9.mmObject();
			isDerived = false;
			xmlTag = "SubBalTp";
	...
	protected List<com.tools20022.repository.msg.AdditionalBalanceInformation9> additionalBalanceBreakdownDetails;
	/**
	...
	public void setAdditionalBalanceBreakdownDetails(List<com.tools20022.repository.msg.AdditionalBalanceInformation9> additionalBalanceBreakdownDetails) {
