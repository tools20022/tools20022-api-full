...
public class RateTypeAndAmountAndStatus17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus17.mmRateType, RateTypeAndAmountAndStatus17.mmAmount, RateTypeAndAmountAndStatus17.mmRateStatus);
