...
public class PaymentInstruction22 {
	...
	public static final MMMessageAttribute PaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.PaymentInformationIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.PaymentMethod;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute BatchBooking = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.BatchBooking;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfTransactions = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.NumberOfTransactions;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ControlSum = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.ControlSum;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.PaymentTypeInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.RequestedExecutionDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PoolingAdjustmentDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.PoolingAdjustmentDate;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentInstruction20#Debtor
	...
	public static final MMMessageAssociationEnd Debtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.Debtor;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.DebtorAccount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.DebtorAgent;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.DebtorAgentAccount;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute InstructionForDebtorAgent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.InstructionForDebtorAgent;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.UltimateDebtor;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.ChargeBearer;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChargesAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.ChargesAccount;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ChargesAccountAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.ChargesAccountAgent;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditTransferTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction20.CreditTransferTransactionInformation;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> PaymentInstruction20.mmObject();
			}
		});
