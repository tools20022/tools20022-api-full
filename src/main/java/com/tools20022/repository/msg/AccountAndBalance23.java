...
public class AccountAndBalance23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance23.mmSafekeepingAccount, AccountAndBalance23.mmAccountOwner, AccountAndBalance23.mmSafekeepingPlace, AccountAndBalance23.mmBalance);
