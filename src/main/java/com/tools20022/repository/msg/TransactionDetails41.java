...
@XmlType(name = "TransactionDetails41", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class TransactionDetails41 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails41, SettlementTypeAndIdentification3> mmAccountOwnerTransactionIdentification = new MMMessageAssociationEnd<TransactionDetails41, SettlementTypeAndIdentification3>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails41.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementTypeAndIdentification3 getValue(TransactionDetails41 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionDetails41 obj, SettlementTypeAndIdentification3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails41, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionDetails41, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(TransactionDetails41 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionDetails41 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails41, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<TransactionDetails41, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmMarketInfrastructureTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails41, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<TransactionDetails41, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmProcessorTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails41, Optional<Max35Text>> mmOtherTransactionIdentification = new MMMessageAttribute<TransactionDetails41, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmOtherTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails41, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<TransactionDetails41, Optional<PartyIdentification36Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(TransactionDetails41 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(TransactionDetails41 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails41, SecuritiesAccount13> mmSafekeepingAccount = new MMMessageAssociationEnd<TransactionDetails41, SecuritiesAccount13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmSafekeepingAccount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount13 getValue(TransactionDetails41 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(TransactionDetails41 obj, SecuritiesAccount13 value) {
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails29
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails41, Optional<TransactionDetails29>> mmTransactionDetails = new MMMessageAssociationEnd<TransactionDetails41, Optional<TransactionDetails29>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmTransactionDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails29.mmObject();
		}

		@Override
		public Optional<TransactionDetails29> getValue(TransactionDetails41 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(TransactionDetails41 obj, Optional<TransactionDetails29> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails41.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails41.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.TransactionDetails41.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails41.mmProcessorTransactionIdentification, com.tools20022.repository.msg.TransactionDetails41.mmOtherTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails41.mmAccountOwner, com.tools20022.repository.msg.TransactionDetails41.mmSafekeepingAccount, com.tools20022.repository.msg.TransactionDetails41.mmTransactionDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionModificationRequestV01.mmModifiedTransactionDetails, SecuritiesSettlementTransactionModificationRequestV02.mmModifiedTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTransactionIdentificationPresenceRule.forTransactionDetails41);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionDetails41";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails64.mmObject());
			}
		});
	...
	public TransactionDetails41 setAccountOwnerTransactionIdentification(SettlementTypeAndIdentification3 accountOwnerTransactionIdentification) {
	...
	public TransactionDetails41 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionDetails41 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public TransactionDetails41 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public TransactionDetails41 setOtherTransactionIdentification(Max35Text otherTransactionIdentification) {
	...
	public TransactionDetails41 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public TransactionDetails41 setSafekeepingAccount(SecuritiesAccount13 safekeepingAccount) {
	...
	public TransactionDetails41 setTransactionDetails(TransactionDetails29 transactionDetails) {
