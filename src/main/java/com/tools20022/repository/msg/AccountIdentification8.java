...
public class AccountIdentification8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification8.mmSafekeepingAccount, AccountIdentification8.mmAccountOwner, AccountIdentification8.mmSafekeepingPlace);
