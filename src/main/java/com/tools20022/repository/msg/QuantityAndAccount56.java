...
public class QuantityAndAccount56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount56.mmSettlementQuantity, QuantityAndAccount56.mmDenominationChoice, QuantityAndAccount56.mmAccountOwner, QuantityAndAccount56.mmSafekeepingAccount,
						QuantityAndAccount56.mmCashAccount, QuantityAndAccount56.mmSafekeepingPlace, QuantityAndAccount56.mmQuantityBreakdown);
