...
public class CorporateActionGeneralInformation104 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation104.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation104.mmCorporateActionEventIdentification, CorporateActionGeneralInformation104.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation104.mmEventType, CorporateActionGeneralInformation104.mmFinancialInstrumentIdentification);
	...
	public void setEventType(CorporateActionEventType50Choice eventType) {
		this.eventType = eventType;
	}

	@XmlElement(name = "FinInstrmId")
	public SecurityIdentification21 getFinancialInstrumentIdentification() {
		return financialInstrumentIdentification;
	}

	public void setFinancialInstrumentIdentification(com.tools20022.repository.msg.SecurityIdentification21 financialInstrumentIdentification) {
