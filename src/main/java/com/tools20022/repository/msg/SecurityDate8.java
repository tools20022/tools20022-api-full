...
public class SecurityDate8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecurityDate8.mmPaymentDate, SecurityDate8.mmAvailableDate, SecurityDate8.mmDividendRankingDate, SecurityDate8.mmEarliestPaymentDate, SecurityDate8.mmPariPassuDate);
