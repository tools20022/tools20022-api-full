 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.PriceDetails11
 * PriceDetails11}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PriceDetails14", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails14, Optional<PriceFormat6Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails14, Optional<PriceFormat6Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PriceDetails23.mmGenericCashPricePaidPerProduct);
			previousVersion_lazy = () -> PriceDetails11.mmGenericCashPricePaidPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat6Choice> getValue(PriceDetails14 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails14 obj, Optional<PriceFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails14, Optional<PriceFormat34Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails14, Optional<PriceFormat34Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceDetails23.mmGenericCashPriceReceivedPerProduct);
			previousVersion_lazy = () -> PriceDetails11.mmGenericCashPriceReceivedPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat34Choice> getValue(PriceDetails14 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails14 obj, Optional<PriceFormat34Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails14.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails14.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails14);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PriceDetails14";
				definition = "Provides information about the prices related to a corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(PriceDetails23.mmObject());
				previousVersion_lazy = () -> PriceDetails11.mmObject();
			}
		});
	...
	public PriceDetails14 setGenericCashPricePaidPerProduct(PriceFormat6Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails14 setGenericCashPriceReceivedPerProduct(PriceFormat34Choice genericCashPriceReceivedPerProduct) {
