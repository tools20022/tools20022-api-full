...
public class PriceDetails14 {
	...
	public static final MMMessageAssociationEnd mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PriceDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails23.mmGenericCashPricePaidPerProduct);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PriceDetails11.mmGenericCashPricePaidPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails23.mmGenericCashPriceReceivedPerProduct);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PriceDetails11.mmGenericCashPriceReceivedPerProduct;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public PriceFormat34Choice getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct;
	}

	public void setGenericCashPriceReceivedPerProduct(PriceFormat34Choice genericCashPriceReceivedPerProduct) {
