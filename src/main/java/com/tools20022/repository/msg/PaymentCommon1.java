...
public class PaymentCommon1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentCommon1.mmPaymentFrom, PaymentCommon1.mmPaymentTo, PaymentCommon1.mmCommonStatus, PaymentCommon1.mmRequestedExecutionDate, PaymentCommon1.mmEntryDate,
						PaymentCommon1.mmCreditDebitIndicator, PaymentCommon1.mmPaymentMethod);
