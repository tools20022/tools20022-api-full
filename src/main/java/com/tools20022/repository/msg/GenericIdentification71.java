...
@XmlType(name = "GenericIdentification71", propOrder = {"identification", "type", "issuer", "country", "shortName"})
public class GenericIdentification71 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification71, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification71, Max35Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification71.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of the entity.";
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification72.mmIdentification, GenericIdentification92.mmIdentification);
			previousVersion_lazy = () -> GenericIdentification35.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(GenericIdentification71 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification71 obj, Max35Text value) {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.GenericIdentification92#mmType
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.GenericIdentification35#mmType
	 * GenericIdentification35.mmType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification71, Optional<PartyType5Code>> mmType = new MMMessageAttribute<GenericIdentification71, Optional<PartyType5Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification92.mmType);
			previousVersion_lazy = () -> GenericIdentification35.mmType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyType5Code> getValue(GenericIdentification71 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification71 obj, Optional<PartyType5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification71, Optional<PartyType6Code>> mmIssuer = new MMMessageAttribute<GenericIdentification71, Optional<PartyType6Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification72.mmIssuer, GenericIdentification92.mmIssuer);
			previousVersion_lazy = () -> GenericIdentification35.mmIssuer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PartyType6Code> getValue(GenericIdentification71 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification71 obj, Optional<PartyType6Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification71, Optional<Min2Max3AlphaText>> mmCountry = new MMMessageAttribute<GenericIdentification71, Optional<Min2Max3AlphaText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification71.mmObject();
			isDerived = false;
			xmlTag = "Ctry";
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification72.mmCountry, GenericIdentification92.mmCountry);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Min2Max3AlphaText> getValue(GenericIdentification71 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(GenericIdentification71 obj, Optional<Min2Max3AlphaText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification71, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification71, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification72.mmShortName, GenericIdentification92.mmShortName);
			previousVersion_lazy = () -> GenericIdentification35.mmShortName;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification71 obj) {
			return obj.getShortName();
		}

		@Override
		public void setValue(GenericIdentification71 obj, Optional<Max35Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification71.mmIdentification, com.tools20022.repository.msg.GenericIdentification71.mmType,
						com.tools20022.repository.msg.GenericIdentification71.mmIssuer, com.tools20022.repository.msg.GenericIdentification71.mmCountry, com.tools20022.repository.msg.GenericIdentification71.mmShortName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GenericIdentification71";
				definition = "Identification of an entity.";
				nextVersions_lazy = () -> Arrays.asList(GenericIdentification72.mmObject(), GenericIdentification92.mmObject());
				previousVersion_lazy = () -> GenericIdentification35.mmObject();
			}
		});
	...
	public GenericIdentification71 setIdentification(Max35Text identification) {
		this.identification = Objects.requireNonNull(identification);
		return this;
	}

	public Optional<PartyType5Code> getType() {
		return type == null ? Optional.empty() : Optional.of(type);
	}

	public GenericIdentification71 setType(PartyType5Code type) {
		this.type = type;
		return this;
	}
	...
	public GenericIdentification71 setIssuer(PartyType6Code issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification71 setCountry(Min2Max3AlphaText country) {
	...
	public GenericIdentification71 setShortName(Max35Text shortName) {
