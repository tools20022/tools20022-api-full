 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.CardTransaction2 CardTransaction2}</li>
 * </ul>
 */
...
public class CardTransaction16 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardTransaction2#mmCard
	...
	public static final MMMessageAssociationEnd mmCard = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardTransaction2.mmCard;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardTransaction2#mmPOI
	...
	public static final MMMessageAssociationEnd mmPOI = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardTransaction2.mmPOI;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardTransaction2.mmTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPrePaidAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardTransaction2.mmPrePaidAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CardTransaction2.mmObject();
			}
		});
	...
	public CardTransaction16 setCard(com.tools20022.repository.msg.PaymentCard4 card) {
		this.card = card;
		return this;
	}
	...
	public CardTransaction16 setPOI(com.tools20022.repository.msg.PointOfInteraction1 pOI) {
		this.pOI = pOI;
		return this;
	}
	...
	public CardTransaction16 setPrePaidAccount(com.tools20022.repository.msg.CashAccount24 prePaidAccount) {
