 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment62#POI
 * CardPaymentEnvironment62.POI}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment62#Card
...
public class CardPaymentEnvironment62 {
	...
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.Acquirer;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Merchant = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.Merchant;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POI = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.POI;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Card = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.Card;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CustomerDevice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.CustomerDevice;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Wallet = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.Wallet;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CustomerDevice1.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PaymentToken = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.PaymentToken;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Cardholder = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.Cardholder;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProtectedCardholderData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment53.ProtectedCardholderData;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment62.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment62.Merchant,
						com.tools20022.repository.msg.CardPaymentEnvironment62.POI, com.tools20022.repository.msg.CardPaymentEnvironment62.Card, com.tools20022.repository.msg.CardPaymentEnvironment62.CustomerDevice,
						com.tools20022.repository.msg.CardPaymentEnvironment62.Wallet, com.tools20022.repository.msg.CardPaymentEnvironment62.PaymentToken, com.tools20022.repository.msg.CardPaymentEnvironment62.Cardholder,
						com.tools20022.repository.msg.CardPaymentEnvironment62.ProtectedCardholderData);
