...
public class CardPaymentEnvironment28 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>> mmAcquirerIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>>() {
		{
		...
		@Override
		public Optional<GenericIdentification32> getValue(CardPaymentEnvironment28 obj) {
			return obj.getAcquirerIdentification();
		}

		@Override
		public void setValue(CardPaymentEnvironment28 obj, Optional<GenericIdentification32> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>> mmMerchantIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>> mmPOIIdentification = new MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<GenericIdentification32>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<ContentInformationType7>> mmProtectedCardData = new MMMessageAssociationEnd<CardPaymentEnvironment28, Optional<ContentInformationType7>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment28.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<ContentInformationType7> getValue(CardPaymentEnvironment28 obj) {
			return obj.getProtectedCardData();
		}

		@Override
		public void setValue(CardPaymentEnvironment28 obj, Optional<ContentInformationType7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentEnvironment28, Optional<PlainCardData3>> mmPlainCardData = new MMMessageAttribute<CardPaymentEnvironment28, Optional<PlainCardData3>>() {
		{
		...
		@Override
		public Optional<PlainCardData3> getValue(CardPaymentEnvironment28 obj) {
			return obj.getPlainCardData();
		}

		@Override
		public void setValue(CardPaymentEnvironment28 obj, Optional<PlainCardData3> value) {
	...
	public CardPaymentEnvironment28 setAcquirerIdentification(GenericIdentification32 acquirerIdentification) {
	...
	public CardPaymentEnvironment28 setMerchantIdentification(GenericIdentification32 merchantIdentification) {
	...
	public CardPaymentEnvironment28 setPOIIdentification(GenericIdentification32 pOIIdentification) {
	...
	public CardPaymentEnvironment28 setProtectedCardData(ContentInformationType7 protectedCardData) {
	...
	public CardPaymentEnvironment28 setPlainCardData(PlainCardData3 plainCardData) {
