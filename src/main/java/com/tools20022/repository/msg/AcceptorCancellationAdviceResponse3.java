...
@XmlType(name = "AcceptorCancellationAdviceResponse3", propOrder = {"environment", "transaction", "tMSTrigger"})
public class AcceptorCancellationAdviceResponse3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, CardPaymentEnvironment21> mmEnvironment = new MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, CardPaymentEnvironment21>() {
		{
			businessComponentTrace_lazy = () -> CardPayment.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptorCancellationAdviceResponse3.mmObject();
			isDerived = false;
			xmlTag = "Envt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Environment";
			definition = "Environment of the transaction.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse4.mmEnvironment);
			previousVersion_lazy = () -> AcceptorCancellationAdviceResponse2.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentEnvironment21 getValue(AcceptorCancellationAdviceResponse3 obj) {
			return obj.getEnvironment();
		}

		@Override
		public void setValue(AcceptorCancellationAdviceResponse3 obj, CardPaymentEnvironment21 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, CardPaymentTransactionAdviceResponse4> mmTransaction = new MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, CardPaymentTransactionAdviceResponse4>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse4.mmTransaction);
			previousVersion_lazy = () -> AcceptorCancellationAdviceResponse2.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CardPaymentTransactionAdviceResponse4 getValue(AcceptorCancellationAdviceResponse3 obj) {
			return obj.getTransaction();
		}

		@Override
		public void setValue(AcceptorCancellationAdviceResponse3 obj, CardPaymentTransactionAdviceResponse4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, Optional<TMSTrigger1>> mmTMSTrigger = new MMMessageAssociationEnd<AcceptorCancellationAdviceResponse3, Optional<TMSTrigger1>>() {
		{
			...
			name = "TMSTrigger";
			definition = "Instructions for contacting the terminal management host.";
			nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse4.mmTMSTrigger);
			previousVersion_lazy = () -> AcceptorCancellationAdviceResponse2.mmTMSTrigger;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TMSTrigger1> getValue(AcceptorCancellationAdviceResponse3 obj) {
			return obj.getTMSTrigger();
		}

		@Override
		public void setValue(AcceptorCancellationAdviceResponse3 obj, Optional<TMSTrigger1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptorCancellationAdviceResponse3.mmEnvironment, com.tools20022.repository.msg.AcceptorCancellationAdviceResponse3.mmTransaction,
						com.tools20022.repository.msg.AcceptorCancellationAdviceResponse3.mmTMSTrigger);
				messageBuildingBlock_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponseV03.mmCancellationAdviceResponse);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptorCancellationAdviceResponse3";
				definition = "Cancellation advice response from the acquirer.";
				nextVersions_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse4.mmObject());
				previousVersion_lazy = () -> AcceptorCancellationAdviceResponse2.mmObject();
			}
		});
	...
	public AcceptorCancellationAdviceResponse3 setEnvironment(CardPaymentEnvironment21 environment) {
	...
	public AcceptorCancellationAdviceResponse3 setTransaction(CardPaymentTransactionAdviceResponse4 transaction) {
	...
	public AcceptorCancellationAdviceResponse3 setTMSTrigger(TMSTrigger1 tMSTrigger) {
