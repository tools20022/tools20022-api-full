...
public class AcceptorCancellationAdviceResponse3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse3.mmEnvironment, AcceptorCancellationAdviceResponse3.mmTransaction, AcceptorCancellationAdviceResponse3.mmTMSTrigger);
