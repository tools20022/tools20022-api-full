...
public class RejectionReason33 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason16#Reason
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectionReason16.Reason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason32.Reason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectionReason16.AdditionalReasonInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason32.AdditionalReasonInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason33.Reason, com.tools20022.repository.msg.RejectionReason33.AdditionalReasonInformation);
