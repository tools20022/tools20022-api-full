...
public class IntraPositionDetails27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails27.mmSettledQuantity, IntraPositionDetails27.mmSecuritiesSubBalanceIdentification, IntraPositionDetails27.mmCollateralMonitorAmount,
						IntraPositionDetails27.mmPreviouslySettledQuantity, IntraPositionDetails27.mmRemainingToBeSettledQuantity, IntraPositionDetails27.mmSettlementDate, IntraPositionDetails27.mmAvailableDate,
						IntraPositionDetails27.mmCorporateActionEventType, IntraPositionDetails27.mmBalanceFrom, IntraPositionDetails27.mmBalanceTo, IntraPositionDetails27.mmInstructionProcessingAdditionalDetails);
