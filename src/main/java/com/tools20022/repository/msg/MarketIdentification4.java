 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification4#mmType
...
@XmlType(name = "MarketIdentification4", propOrder = {"identification", "type"})
public class MarketIdentification4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification4, Optional<MarketIdentification1Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification4, Optional<MarketIdentification1Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification78.mmIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification1Choice> getValue(MarketIdentification4 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification4 obj, Optional<MarketIdentification1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification4, MarketType3Choice> mmType = new MMMessageAssociationEnd<MarketIdentification4, MarketType3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MarketIdentification78.mmType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public MarketType3Choice getValue(MarketIdentification4 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification4 obj, MarketType3Choice value) {
			obj.setType(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification4.mmIdentification, com.tools20022.repository.msg.MarketIdentification4.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistence35to30TextFieldRule.forMarketIdentification4,
						com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification4);
				...
				nextVersions_lazy = () -> Arrays.asList(MarketIdentification78.mmObject());
			}
		});
	...
	public MarketIdentification4 setIdentification(MarketIdentification1Choice identification) {
	...
	public MarketIdentification4 setType(MarketType3Choice type) {
