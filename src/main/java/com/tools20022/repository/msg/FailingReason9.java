...
import com.tools20022.repository.choice.FailingReason10Choice;
...
@XmlType(name = "FailingReason9", propOrder = {"code", "additionalReasonInformation"})
public class FailingReason9 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected FailingReason10Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.FailingReason9 FailingReason9}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FailingReason9.mmCode, com.tools20022.repository.msg.FailingReason9.mmAdditionalReasonInformation);
	...
	public FailingReason10Choice getCode() {
		return code;
	}

	public FailingReason9 setCode(FailingReason10Choice code) {
	...
	public FailingReason9 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
