...
public class FailingReason9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FailingReason9.Code, com.tools20022.repository.msg.FailingReason9.AdditionalReasonInformation);
