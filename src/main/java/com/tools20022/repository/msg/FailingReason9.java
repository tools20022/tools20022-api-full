...
public class FailingReason9 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FailingReason9.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingReason9.mmCode, FailingReason9.mmAdditionalReasonInformation);
	...
	public void setCode(FailingReason10Choice code) {
		this.code = code;
	}
