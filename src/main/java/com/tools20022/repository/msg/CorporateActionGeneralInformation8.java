...
public class CorporateActionGeneralInformation8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation8.mmCorporateActionEventIdentification, CorporateActionGeneralInformation8.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation8.mmClassActionNumber, CorporateActionGeneralInformation8.mmEventType, CorporateActionGeneralInformation8.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation8.mmUnderlyingSecurityIdentification);
