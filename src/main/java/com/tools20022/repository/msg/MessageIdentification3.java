...
public class MessageIdentification3 {
	...
	public MessageIdentification3 setIdentification(RestrictedFINMax16Text identification) {
	...
	public MessageIdentification3 setCreationDateTime(ISODateTime creationDateTime) {
