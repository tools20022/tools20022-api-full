...
@XmlType(name = "GeneratedReason6", propOrder = {"code", "additionalReasonInformation"})
public class GeneratedReason6 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	protected GeneratedReasons6Choice code;
	/**
	 * Specifies the reason why the transaction was generated.
	 * <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> GeneratedReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedReason6.mmCode, GeneratedReason6.mmAdditionalReasonInformation);
	...
	public GeneratedReasons6Choice getCode() {
		return code;
	}

	public void setCode(GeneratedReasons6Choice code) {
		this.code = code;
	}
