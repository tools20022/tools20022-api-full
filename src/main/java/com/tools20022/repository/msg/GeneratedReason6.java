...
public class GeneratedReason6 {
	...
	public GeneratedReason6 setCode(GeneratedReasons6Choice code) {
	...
	public GeneratedReason6 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
