...
public class CorporateActionNotification6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNotification6.mmNotificationType, CorporateActionNotification6.mmProcessingStatus, CorporateActionNotification6.mmEligibleBalanceIndicator);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNotification002V07.mmNotificationGeneralInformation);
