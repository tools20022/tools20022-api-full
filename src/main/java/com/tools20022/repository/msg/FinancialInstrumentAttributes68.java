...
public class FinancialInstrumentAttributes68 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, SecurityIdentification19> mmSecurityIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, SecurityIdentification19>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmSecurityIdentification);
		...
		@Override
		public SecurityIdentification19 getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getSecurityIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes68, Optional<DecimalNumber>> mmQuantity = new MMMessageAttribute<FinancialInstrumentAttributes68, Optional<DecimalNumber>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmQuantity);
		...
		@Override
		public Optional<DecimalNumber> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<RenounceableEntitlementStatusTypeFormat3Choice>> mmRenounceableEntitlementStatusType = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<RenounceableEntitlementStatusTypeFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmRenounceableEntitlementStatusType);
		...
		@Override
		public Optional<RenounceableEntitlementStatusTypeFormat3Choice> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getRenounceableEntitlementStatusType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<RenounceableEntitlementStatusTypeFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<FractionDispositionType25Choice>> mmFractionDisposition = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<FractionDispositionType25Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmFractionDisposition);
		...
		@Override
		public Optional<FractionDispositionType25Choice> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getFractionDisposition();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<FractionDispositionType25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<QuantityToQuantityRatio1>> mmIntermediateSecuritiesToUnderlyingRatio = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<QuantityToQuantityRatio1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmIntermediateSecuritiesToUnderlyingRatio);
		...
		@Override
		public Optional<QuantityToQuantityRatio1> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getIntermediateSecuritiesToUnderlyingRatio();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<QuantityToQuantityRatio1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<AmountPrice2>> mmMarketPrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<AmountPrice2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmMarketPrice);
		...
		@Override
		public Optional<AmountPrice2> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getMarketPrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<AmountPrice2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, DateFormat30Choice> mmExpiryDate = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, DateFormat30Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmExpiryDate);
		...
		@Override
		public DateFormat30Choice getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getExpiryDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, DateFormat30Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, DateFormat30Choice> mmPostingDate = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, DateFormat30Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmPostingDate);
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<Period4>> mmTradingPeriod = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<Period4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmTradingPeriod);
		...
		@Override
		public Optional<Period4> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getTradingPeriod();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<Period4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<BalanceFormat5Choice>> mmUninstructedBalance = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<BalanceFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmUninstructedBalance);
		...
		@Override
		public Optional<BalanceFormat5Choice> getValue(FinancialInstrumentAttributes68 obj) {
			return obj.getUninstructedBalance();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes68 obj, Optional<BalanceFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<BalanceFormat5Choice>> mmInstructedBalance = new MMMessageAssociationEnd<FinancialInstrumentAttributes68, Optional<BalanceFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmInstructedBalance);
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes93.mmObject());
	...
	public FinancialInstrumentAttributes68 setSecurityIdentification(SecurityIdentification19 securityIdentification) {
	...
	public FinancialInstrumentAttributes68 setIntermediateSecuritiesToUnderlyingRatio(QuantityToQuantityRatio1 intermediateSecuritiesToUnderlyingRatio) {
	...
	public FinancialInstrumentAttributes68 setMarketPrice(AmountPrice2 marketPrice) {
	...
	public FinancialInstrumentAttributes68 setTradingPeriod(Period4 tradingPeriod) {
