 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.IntraPositionDetails21#mmSecuritiesSubBalanceIdentification
 * IntraPositionDetails21.mmSecuritiesSubBalanceIdentification}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.IntraPositionDetails21#mmInstructionProcessingAdditionalDetails
 * IntraPositionDetails21.mmInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forIntraPositionDetails21
 * ConstraintCoexistenceQuantityRule.forIntraPositionDetails21}</li>
 * <li>
...
@XmlType(name = "IntraPositionDetails21", propOrder = {"priority", "settlementQuantity", "securitiesSubBalanceIdentification", "settlementDate", "balanceFrom", "balanceTo", "instructionProcessingAdditionalDetails"})
public class IntraPositionDetails21 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionDetails21, Optional<PriorityNumeric1Choice>> mmPriority = new MMMessageAssociationEnd<IntraPositionDetails21, Optional<PriorityNumeric1Choice>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionDetails21.mmObject();
			isDerived = false;
			xmlTag = "Prty";
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmPriority);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric1Choice> getValue(IntraPositionDetails21 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, Optional<PriorityNumeric1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionDetails21, FinancialInstrumentQuantity1Choice> mmSettlementQuantity = new MMMessageAssociationEnd<IntraPositionDetails21, FinancialInstrumentQuantity1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmSettlementQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrumentQuantity1Choice getValue(IntraPositionDetails21 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, FinancialInstrumentQuantity1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionDetails21, Optional<GenericIdentification37>> mmSecuritiesSubBalanceIdentification = new MMMessageAssociationEnd<IntraPositionDetails21, Optional<GenericIdentification37>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionDetails21.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmSecuritiesSubBalanceIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification37> getValue(IntraPositionDetails21 obj) {
			return obj.getSecuritiesSubBalanceIdentification();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, Optional<GenericIdentification37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraPositionDetails21, DateAndDateTimeChoice> mmSettlementDate = new MMMessageAssociationEnd<IntraPositionDetails21, DateAndDateTimeChoice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmSettlementDate);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DateAndDateTimeChoice getValue(IntraPositionDetails21 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionDetails21, SecuritiesSubBalanceTypeAndQuantityBreakdown1> mmBalanceFrom = new MMMessageAttribute<IntraPositionDetails21, SecuritiesSubBalanceTypeAndQuantityBreakdown1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmBalanceFrom);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesSubBalanceTypeAndQuantityBreakdown1 getValue(IntraPositionDetails21 obj) {
			return obj.getBalanceFrom();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, SecuritiesSubBalanceTypeAndQuantityBreakdown1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionDetails21, SecuritiesSubBalanceTypeAndQuantityBreakdown1> mmBalanceTo = new MMMessageAttribute<IntraPositionDetails21, SecuritiesSubBalanceTypeAndQuantityBreakdown1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesBalance.mmSecuritiesBalanceType;
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionDetails21.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmBalanceTo);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> SecuritiesSubBalanceTypeAndQuantityBreakdown1.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraPositionDetails21, Optional<Max350Text>> mmInstructionProcessingAdditionalDetails = new MMMessageAttribute<IntraPositionDetails21, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.IntraPositionDetails21.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmInstructionProcessingAdditionalDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(IntraPositionDetails21 obj) {
			return obj.getInstructionProcessingAdditionalDetails();
		}

		@Override
		public void setValue(IntraPositionDetails21 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails21.mmPriority, com.tools20022.repository.msg.IntraPositionDetails21.mmSettlementQuantity,
						com.tools20022.repository.msg.IntraPositionDetails21.mmSecuritiesSubBalanceIdentification, com.tools20022.repository.msg.IntraPositionDetails21.mmSettlementDate,
						com.tools20022.repository.msg.IntraPositionDetails21.mmBalanceFrom, com.tools20022.repository.msg.IntraPositionDetails21.mmBalanceTo,
						com.tools20022.repository.msg.IntraPositionDetails21.mmInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(IntraPositionMovementInstructionV03.mmIntraPositionDetails);
				trace_lazy = () -> IntraPositionTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forIntraPositionDetails21,
						com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forIntraPositionDetails21, com.tools20022.repository.constraints.ConstraintBalanceFromToRule.forIntraPositionDetails21);
				...
				name = "IntraPositionDetails21";
				definition = "Details of the intra-position movement.";
				nextVersions_lazy = () -> Arrays.asList(IntraPositionDetails33.mmObject());
				previousVersion_lazy = () -> IntraPositionDetails11.mmObject();
			}
		});
	...
	public IntraPositionDetails21 setPriority(PriorityNumeric1Choice priority) {
	...
	public IntraPositionDetails21 setSettlementQuantity(FinancialInstrumentQuantity1Choice settlementQuantity) {
	...
	public IntraPositionDetails21 setSecuritiesSubBalanceIdentification(GenericIdentification37 securitiesSubBalanceIdentification) {
	...
	public IntraPositionDetails21 setSettlementDate(DateAndDateTimeChoice settlementDate) {
	...
	public IntraPositionDetails21 setBalanceFrom(SecuritiesSubBalanceTypeAndQuantityBreakdown1 balanceFrom) {
	...
	public IntraPositionDetails21 setBalanceTo(SecuritiesSubBalanceTypeAndQuantityBreakdown1 balanceTo) {
	...
	public IntraPositionDetails21 setInstructionProcessingAdditionalDetails(Max350Text instructionProcessingAdditionalDetails) {
