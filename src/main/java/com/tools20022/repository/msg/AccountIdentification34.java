...
public class AccountIdentification34 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountIdentification34.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification34.mmSafekeepingAccount, AccountIdentification34.mmAccountOwner, AccountIdentification34.mmSafekeepingPlace);
