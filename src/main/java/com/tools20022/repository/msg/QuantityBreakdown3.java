 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown3#mmLotNumber
 ...
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown3#mmLotPrice
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityBreakdown3
 * ConstraintCoexistenceQuantityRule.forQuantityBreakdown3}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "QuantityBreakdown3", propOrder = {"lotNumber", "lotQuantity", "lotDateTime", "lotPrice", "typeOfPrice"})
public class QuantityBreakdown3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown3, Optional<Number2Choice>> mmLotNumber = new MMMessageAttribute<QuantityBreakdown3, Optional<Number2Choice>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown3.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<Number2Choice> getValue(QuantityBreakdown3 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown3 obj, Optional<Number2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown3, Optional<FinancialInstrumentQuantity1Choice>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown3, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(QuantityBreakdown3 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown3 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown3, Optional<DateAndDateTimeChoice>> mmLotDateTime = new MMMessageAttribute<QuantityBreakdown3, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(QuantityBreakdown3 obj) {
			return obj.getLotDateTime();
		}

		@Override
		public void setValue(QuantityBreakdown3 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown3, Optional<Price2>> mmLotPrice = new MMMessageAssociationEnd<QuantityBreakdown3, Optional<Price2>>() {
		{
		...
		@Override
		public Optional<Price2> getValue(QuantityBreakdown3 obj) {
			return obj.getLotPrice();
		}

		@Override
		public void setValue(QuantityBreakdown3 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown3, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAttribute<QuantityBreakdown3, Optional<TypeOfPrice3Choice>>() {
		{
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(QuantityBreakdown3 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(QuantityBreakdown3 obj, Optional<TypeOfPrice3Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown3.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown3.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown3.mmLotDateTime, com.tools20022.repository.msg.QuantityBreakdown3.mmLotPrice, com.tools20022.repository.msg.QuantityBreakdown3.mmTypeOfPrice);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityBreakdown3);
				...
				name = "QuantityBreakdown3";
				definition = "Details of breakdown of a quantity.";
				nextVersions_lazy = () -> Arrays.asList(QuantityBreakdown13.mmObject());
			}
		});
	...
	public QuantityBreakdown3 setLotNumber(Number2Choice lotNumber) {
	...
	public QuantityBreakdown3 setLotQuantity(FinancialInstrumentQuantity1Choice lotQuantity) {
	...
	public QuantityBreakdown3 setLotDateTime(DateAndDateTimeChoice lotDateTime) {
	...
	public QuantityBreakdown3 setLotPrice(Price2 lotPrice) {
	...
	public QuantityBreakdown3 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
