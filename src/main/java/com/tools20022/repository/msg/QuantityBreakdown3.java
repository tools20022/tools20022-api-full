...
public class QuantityBreakdown3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown3.mmLotNumber, QuantityBreakdown3.mmLotQuantity, QuantityBreakdown3.mmLotDateTime, QuantityBreakdown3.mmLotPrice, QuantityBreakdown3.mmTypeOfPrice);
