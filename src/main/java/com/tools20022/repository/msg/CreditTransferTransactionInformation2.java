...
public class CreditTransferTransactionInformation2 {
	...
	public static final MMMessageAssociationEnd mmPaymentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CreditTransferTransactionInformation2.mmObject();
			isDerived = false;
			xmlTag = "PmtId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CreditTransferTransactionInformation2.mmPaymentIdentification, CreditTransferTransactionInformation2.mmPaymentTypeInformation,
						CreditTransferTransactionInformation2.mmInterbankSettlementAmount, CreditTransferTransactionInformation2.mmInterbankSettlementDate, CreditTransferTransactionInformation2.mmSettlementTimeIndication,
						CreditTransferTransactionInformation2.mmSettlementTimeRequest, CreditTransferTransactionInformation2.mmAcceptanceDateTime, CreditTransferTransactionInformation2.mmPoolingAdjustmentDate,
						CreditTransferTransactionInformation2.mmInstructedAmount, CreditTransferTransactionInformation2.mmExchangeRate, CreditTransferTransactionInformation2.mmChargeBearer,
						CreditTransferTransactionInformation2.mmChargesInformation, CreditTransferTransactionInformation2.mmPreviousInstructingAgent, CreditTransferTransactionInformation2.mmPreviousInstructingAgentAccount,
						CreditTransferTransactionInformation2.mmInstructingAgent, CreditTransferTransactionInformation2.mmInstructedAgent, CreditTransferTransactionInformation2.mmIntermediaryAgent1,
						CreditTransferTransactionInformation2.mmIntermediaryAgent1Account, CreditTransferTransactionInformation2.mmIntermediaryAgent2, CreditTransferTransactionInformation2.mmIntermediaryAgent2Account,
						CreditTransferTransactionInformation2.mmIntermediaryAgent3, CreditTransferTransactionInformation2.mmIntermediaryAgent3Account, CreditTransferTransactionInformation2.mmUltimateDebtor,
						CreditTransferTransactionInformation2.mmInitiatingParty, CreditTransferTransactionInformation2.mmDebtor, CreditTransferTransactionInformation2.mmDebtorAccount, CreditTransferTransactionInformation2.mmDebtorAgent,
						CreditTransferTransactionInformation2.mmDebtorAgentAccount, CreditTransferTransactionInformation2.mmCreditorAgent, CreditTransferTransactionInformation2.mmCreditorAgentAccount,
						CreditTransferTransactionInformation2.mmCreditor, CreditTransferTransactionInformation2.mmCreditorAccount, CreditTransferTransactionInformation2.mmUltimateCreditor,
						CreditTransferTransactionInformation2.mmInstructionForCreditorAgent, CreditTransferTransactionInformation2.mmInstructionForNextAgent, CreditTransferTransactionInformation2.mmPurpose,
						CreditTransferTransactionInformation2.mmRegulatoryReporting, CreditTransferTransactionInformation2.mmRelatedRemittanceInformation, CreditTransferTransactionInformation2.mmRemittanceInformation);
	...
	public PaymentTypeInformation3 getPaymentTypeInformation() {
		return paymentTypeInformation;
	}

	public void setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation3 paymentTypeInformation) {
	...
	public void setChargesInformation(List<com.tools20022.repository.msg.ChargesInformation1> chargesInformation) {
