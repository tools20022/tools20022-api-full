...
public class CorporateActionGeneralInformation55 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation55.mmCorporateActionEventIdentification, CorporateActionGeneralInformation55.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation55.mmEventType, CorporateActionGeneralInformation55.mmUnderlyingSecurity);
