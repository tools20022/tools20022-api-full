...
public class RejectedStatusReason4 {
	...
	public static final MMMessageAttribute mmStructured = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason4.mmObject();
			isDerived = false;
			xmlTag = "Strd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason4.mmStructured, RejectedStatusReason4.mmAdditionalInformation);
	...
	public void setStructured(RejectedStatusReason4Code structured) {
