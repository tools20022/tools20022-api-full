...
public class CardPaymentEnvironment60 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment60.mmAcquirer, CardPaymentEnvironment60.mmMerchant, CardPaymentEnvironment60.mmPOI, CardPaymentEnvironment60.mmCard, CardPaymentEnvironment60.mmCustomerDevice,
						CardPaymentEnvironment60.mmWallet, CardPaymentEnvironment60.mmPaymentToken, CardPaymentEnvironment60.mmCardholder, CardPaymentEnvironment60.mmProtectedCardholderData);
