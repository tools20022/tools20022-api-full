 ...
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment60#POI
 * CardPaymentEnvironment60.POI}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CardPaymentEnvironment60#Card
...
public class CardPaymentEnvironment60 {
	...
	public static final MMMessageAssociationEnd Acquirer = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CardPaymentEnvironment60.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.Acquirer;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Merchant = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.Merchant;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POI = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.POI;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Card = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.Card;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CustomerDevice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.CustomerDevice;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Wallet = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.Wallet;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CustomerDevice1.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd PaymentToken = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.PaymentToken;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Cardholder = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.Cardholder;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProtectedCardholderData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentEnvironment47.ProtectedCardholderData;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentEnvironment60.Acquirer, com.tools20022.repository.msg.CardPaymentEnvironment60.Merchant,
						com.tools20022.repository.msg.CardPaymentEnvironment60.POI, com.tools20022.repository.msg.CardPaymentEnvironment60.Card, com.tools20022.repository.msg.CardPaymentEnvironment60.CustomerDevice,
						com.tools20022.repository.msg.CardPaymentEnvironment60.Wallet, com.tools20022.repository.msg.CardPaymentEnvironment60.PaymentToken, com.tools20022.repository.msg.CardPaymentEnvironment60.Cardholder,
						com.tools20022.repository.msg.CardPaymentEnvironment60.ProtectedCardholderData);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "CardPaymentEnvironment60";
				definition = "Environment of the transaction.";
				previousVersion_lazy = () -> CardPaymentEnvironment47.mmObject();
			}
		});
