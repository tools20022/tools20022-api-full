 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DataSetIdentification3#Name
 * DataSetIdentification3.Name}</li>
 * <li>{@linkplain com.tools20022.repository.msg.DataSetIdentification3#Type
 * DataSetIdentification3.Type}</li>
 * <li>{@linkplain com.tools20022.repository.msg.DataSetIdentification3#Version
...
public class DataSetIdentification3 {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.DataSetIdentification4#Name
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DataSetIdentification3.mmObject();
			isDerived = false;
			xmlTag = "Nm";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Name";
			definition = "Name of the data set.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DataSetIdentification4.Name);
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.DataSetIdentification4#Type
	...
	public static final MMMessageAttribute Type = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DataSetIdentification4.Type);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.DataSetIdentification4#Version
	...
	public static final MMMessageAttribute Version = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DataSetIdentification4.Version);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max256Text.mmObject();
		}
	...
	public static final MMMessageAttribute CreationDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DataSetIdentification4.CreationDateTime);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DataSetIdentification3.Name, com.tools20022.repository.msg.DataSetIdentification3.Type, com.tools20022.repository.msg.DataSetIdentification3.Version,
						com.tools20022.repository.msg.DataSetIdentification3.CreationDateTime);
