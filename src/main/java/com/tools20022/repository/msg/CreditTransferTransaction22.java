	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, PaymentIdentification1> mmPaymentIdentification = new MMMessageAssociationEnd<CreditTransferTransaction22, PaymentIdentification1>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmPaymentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PaymentTypeInformation19>> mmPaymentTypeInformation = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PaymentTypeInformation19>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, AmountType4Choice> mmAmount = new MMMessageAssociationEnd<CreditTransferTransaction22, AmountType4Choice>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<CreditTransferTransaction22, ChargeBearerType1Code> mmChargeBearer = new MMMessageAttribute<CreditTransferTransaction22, ChargeBearerType1Code>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<Cheque7>> mmChequeInstruction = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<Cheque7>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmChequeInstruction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PartyIdentification43>> mmUltimateDebtor = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PartyIdentification43>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmUltimateDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent1 = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmIntermediaryAgent1;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent2 = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If more than two intermediary agents are present, then IntermediaryAgent2 identifies the agent between the IntermediaryAgent1 and the IntermediaryAgent3.";
			previousVersion_lazy = () -> CreditTransferTransaction21.mmIntermediaryAgent2;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent3 = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If IntermediaryAgent3 is present, then it identifies the agent between the IntermediaryAgent 2 and the CreditorAgent.";
			previousVersion_lazy = () -> CreditTransferTransaction21.mmIntermediaryAgent3;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, BranchAndFinancialInstitutionIdentification5> mmCreditorAgent = new MMMessageAssociationEnd<CreditTransferTransaction22, BranchAndFinancialInstitutionIdentification5>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmCreditorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, PartyIdentification43> mmCreditor = new MMMessageAssociationEnd<CreditTransferTransaction22, PartyIdentification43>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmCreditor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<CashAccount24>> mmCreditorAccount = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<CashAccount24>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmCreditorAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PartyIdentification43>> mmUltimateCreditor = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<PartyIdentification43>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, List<InstructionForCreditorAgent1>> mmInstructionForCreditorAgent = new MMMessageAssociationEnd<CreditTransferTransaction22, List<InstructionForCreditorAgent1>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmInstructionForCreditorAgent;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<Purpose2Choice>> mmPurpose = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<Purpose2Choice>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmPurpose;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, List<RegulatoryReporting3>> mmRegulatoryReporting = new MMMessageAssociationEnd<CreditTransferTransaction22, List<RegulatoryReporting3>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmRegulatoryReporting;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<TaxInformation3>> mmTax = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<TaxInformation3>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, List<RemittanceLocation4>> mmRelatedRemittanceInformation = new MMMessageAssociationEnd<CreditTransferTransaction22, List<RemittanceLocation4>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmRelatedRemittanceInformation;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<CreditTransferTransaction22, Optional<RemittanceInformation11>> mmRemittanceInformation = new MMMessageAssociationEnd<CreditTransferTransaction22, Optional<RemittanceInformation11>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmRemittanceInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<CreditTransferTransaction22, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<CreditTransferTransaction22, List<SupplementaryData1>>() {
		{
			...
			previousVersion_lazy = () -> CreditTransferTransaction21.mmSupplementaryData;
			minOccurs = 0;
