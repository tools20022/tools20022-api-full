	...
	public static final MMMessageAssociationEnd PaymentIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.PaymentIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.PaymentTypeInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Amount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.Amount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.ChargeBearer;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChequeInstruction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.ChequeInstruction;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.UltimateDebtor;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent1 = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.IntermediaryAgent1;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent2 = new MMMessageAssociationEnd() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If more than two intermediary agents are present, then IntermediaryAgent2 identifies the agent between the IntermediaryAgent1 and the IntermediaryAgent3.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.IntermediaryAgent2;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd IntermediaryAgent3 = new MMMessageAssociationEnd() {
		{
			...
			definition = "Agent between the debtor's agent and the creditor's agent.\n\nUsage: If IntermediaryAgent3 is present, then it identifies the agent between the IntermediaryAgent 2 and the CreditorAgent.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.IntermediaryAgent3;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.CreditorAgent;
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Creditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.Creditor;
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.CreditorAccount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.UltimateCreditor;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd InstructionForCreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.InstructionForCreditorAgent;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Purpose = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.Purpose;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RegulatoryReporting = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.RegulatoryReporting;
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd Tax = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.Tax;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RelatedRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.RelatedRemittanceInformation;
			minOccurs = 0;
			maxOccurs = 10;
	...
	public static final MMMessageAssociationEnd RemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.RemittanceInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupplementaryData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CreditTransferTransaction21.SupplementaryData;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CreditTransferTransaction21.mmObject();
			}
		});
