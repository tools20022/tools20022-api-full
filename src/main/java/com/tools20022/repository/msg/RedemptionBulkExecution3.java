...
public class RedemptionBulkExecution3 {
	...
	public static final MMXor mmCancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(RedemptionBulkExecution3.mmCancellationRight, RedemptionBulkExecution3.mmExtendedCancellationRight);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RedemptionBulkExecution3.mmMasterReference, RedemptionBulkExecution3.mmPlaceOfTrade, RedemptionBulkExecution3.mmOrderDateTime, RedemptionBulkExecution3.mmRequestedFutureTradeDate,
						RedemptionBulkExecution3.mmCancellationRight, RedemptionBulkExecution3.mmExtendedCancellationRight, RedemptionBulkExecution3.mmFinancialInstrumentDetails, RedemptionBulkExecution3.mmIndividualExecutionDetails,
						RedemptionBulkExecution3.mmRequestedSettlementCurrency, RedemptionBulkExecution3.mmRequestedNAVCurrency, RedemptionBulkExecution3.mmTotalSettlementAmount, RedemptionBulkExecution3.mmCashSettlementDate,
						RedemptionBulkExecution3.mmBulkCashSettlementDetails);
				...
				xors_lazy = () -> Arrays.asList(RedemptionBulkExecution3.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
