 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityBreakdown23
 * ConstraintCoexistenceQuantityRule.forQuantityBreakdown23}</li>
 * </ul>
 * </li>
 * <li>
...
public class QuantityBreakdown23 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown23, Optional<GenericIdentification37>> mmLotNumber = new MMMessageAttribute<QuantityBreakdown23, Optional<GenericIdentification37>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown23.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<GenericIdentification37> getValue(QuantityBreakdown23 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown23 obj, Optional<GenericIdentification37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown23, Optional<Balance4>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown23, Optional<Balance4>>() {
		{
		...
		@Override
		public Optional<Balance4> getValue(QuantityBreakdown23 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown23 obj, Optional<Balance4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown23, Optional<DateAndDateTimeChoice>> mmLotDateTime = new MMMessageAttribute<QuantityBreakdown23, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(QuantityBreakdown23 obj) {
			return obj.getLotDateTime();
		}

		@Override
		public void setValue(QuantityBreakdown23 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown23, Optional<Price2>> mmLotPrice = new MMMessageAssociationEnd<QuantityBreakdown23, Optional<Price2>>() {
		{
		...
		@Override
		public Optional<Price2> getValue(QuantityBreakdown23 obj) {
			return obj.getLotPrice();
		}

		@Override
		public void setValue(QuantityBreakdown23 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown23, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAttribute<QuantityBreakdown23, Optional<TypeOfPrice3Choice>>() {
		{
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(QuantityBreakdown23 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(QuantityBreakdown23 obj, Optional<TypeOfPrice3Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown23.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown23.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown23.mmLotDateTime, com.tools20022.repository.msg.QuantityBreakdown23.mmLotPrice, com.tools20022.repository.msg.QuantityBreakdown23.mmTypeOfPrice);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityBreakdown23);
	...
	public QuantityBreakdown23 setLotNumber(GenericIdentification37 lotNumber) {
	...
	public QuantityBreakdown23 setLotQuantity(Balance4 lotQuantity) {
	...
	public QuantityBreakdown23 setLotDateTime(DateAndDateTimeChoice lotDateTime) {
	...
	public QuantityBreakdown23 setLotPrice(Price2 lotPrice) {
	...
	public QuantityBreakdown23 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
