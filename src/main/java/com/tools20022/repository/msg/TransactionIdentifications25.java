 ...
 * TransactionIdentifications25.mmMarketInfrastructureTransactionIdentification}
 * </li>
 * <li>
...
public class TransactionIdentifications25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications25, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications25, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications25.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmAccountOwnerTransactionIdentification);
			previousVersion_lazy = () -> TransactionIdentifications18.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionIdentifications25 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications25 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmAccountServicerTransactionIdentification);
			previousVersion_lazy = () -> TransactionIdentifications18.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionIdentifications25 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionIdentifications25 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmMarketInfrastructureTransactionIdentification);
			previousVersion_lazy = () -> TransactionIdentifications18.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmProcessorTransactionIdentification);
			previousVersion_lazy = () -> TransactionIdentifications18.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TransactionIdentifications18#mmOtherIdentification
	 * TransactionIdentifications18.mmOtherIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>> mmOtherIdentification = new MMMessageAttribute<TransactionIdentifications25, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionIdentifications25.mmObject();
			isDerived = false;
			xmlTag = "OthrId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmOtherIdentification);
			previousVersion_lazy = () -> TransactionIdentifications18.mmOtherIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionIdentifications25.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications25.mmAccountServicerTransactionIdentification, com.tools20022.repository.msg.TransactionIdentifications25.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.msg.TransactionIdentifications25.mmProcessorTransactionIdentification, com.tools20022.repository.msg.TransactionIdentifications25.mmOtherIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionModificationRequestStatusAdviceV02.mmTransactionIdentification,
						SecuritiesSettlementTransactionModificationRequestStatusAdviceV03.mmTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransactionIdentifications25,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionIdentifications25,
						com.tools20022.repository.constraints.ConstraintAccountOwnerTransactionIdentificationRule.forTransactionIdentifications25);
				...
				name = "TransactionIdentifications25";
				definition = "Unique identifier of a document, message or transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionIdentifications33.mmObject());
	...
	public TransactionIdentifications25 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionIdentifications25 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionIdentifications25 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public TransactionIdentifications25 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public TransactionIdentifications25 setOtherIdentification(Max35Text otherIdentification) {
