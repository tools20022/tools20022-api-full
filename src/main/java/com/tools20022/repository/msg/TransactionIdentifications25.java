...
public class TransactionIdentifications25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications25.mmAccountOwnerTransactionIdentification, TransactionIdentifications25.mmAccountServicerTransactionIdentification,
						TransactionIdentifications25.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications25.mmProcessorTransactionIdentification, TransactionIdentifications25.mmOtherIdentification);
