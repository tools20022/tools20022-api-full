...
public class TransportDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransportDetails3.mmTransportDocumentReference, TransportDetails3.mmTransportedGoods, TransportDetails3.mmConsignment, TransportDetails3.mmRoutingSummary,
						TransportDetails3.mmShipmentDate, TransportDetails3.mmFreightCharges, TransportDetails3.mmIncoterms);
