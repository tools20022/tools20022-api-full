...
public class PaymentTransactionInformation21 {
	...
	protected List<com.tools20022.repository.msg.ReturnReasonInformation7> returnReasonInformation;
	/**
	...
	public static final MMMessageAssociationEnd mmReturnReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.ReturnReasonInformation7.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransactionInformation21.mmReturnIdentification, PaymentTransactionInformation21.mmOriginalGroupInformation,
						PaymentTransactionInformation21.mmOriginalInstructionIdentification, PaymentTransactionInformation21.mmOriginalEndToEndIdentification, PaymentTransactionInformation21.mmOriginalTransactionIdentification,
						PaymentTransactionInformation21.mmOriginalInterbankSettlementAmount, PaymentTransactionInformation21.mmReturnedInterbankSettlementAmount, PaymentTransactionInformation21.mmInterbankSettlementDate,
						PaymentTransactionInformation21.mmReturnedInstructedAmount, PaymentTransactionInformation21.mmExchangeRate, PaymentTransactionInformation21.mmCompensationAmount, PaymentTransactionInformation21.mmChargeBearer,
						PaymentTransactionInformation21.mmChargesInformation, PaymentTransactionInformation21.mmInstructingAgent, PaymentTransactionInformation21.mmInstructedAgent, PaymentTransactionInformation21.mmReturnReasonInformation,
						PaymentTransactionInformation21.mmOriginalTransactionReference);
	...
	public void setReturnReasonInformation(List<com.tools20022.repository.msg.ReturnReasonInformation7> returnReasonInformation) {
