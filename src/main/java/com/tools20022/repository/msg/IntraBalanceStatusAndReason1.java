...
public class IntraBalanceStatusAndReason1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntraBalanceStatusAndReason1, List<ProcessingStatus35Choice>> mmProcessingStatus = new MMMessageAttribute<IntraBalanceStatusAndReason1, List<ProcessingStatus35Choice>>() {
		{
		...
		@Override
		public List<ProcessingStatus35Choice> getValue(IntraBalanceStatusAndReason1 obj) {
			return obj.getProcessingStatus();
		}

		@Override
		public void setValue(IntraBalanceStatusAndReason1 obj, List<ProcessingStatus35Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraBalanceStatusAndReason1, List<SettlementStatus9Choice>> mmSettlementStatus = new MMMessageAssociationEnd<IntraBalanceStatusAndReason1, List<SettlementStatus9Choice>>() {
		{
		...
		@Override
		public List<SettlementStatus9Choice> getValue(IntraBalanceStatusAndReason1 obj) {
			return obj.getSettlementStatus();
		}

		@Override
		public void setValue(IntraBalanceStatusAndReason1 obj, List<SettlementStatus9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntraBalanceStatusAndReason1, Optional<ProprietaryReason1>> mmSettled = new MMMessageAssociationEnd<IntraBalanceStatusAndReason1, Optional<ProprietaryReason1>>() {
		{
		...
		@Override
		public Optional<ProprietaryReason1> getValue(IntraBalanceStatusAndReason1 obj) {
			return obj.getSettled();
		}

		@Override
		public void setValue(IntraBalanceStatusAndReason1 obj, Optional<ProprietaryReason1> value) {
	...
	public IntraBalanceStatusAndReason1 setSettled(ProprietaryReason1 settled) {
