...
public class TransactionTypeAndAdditionalParameters18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters18.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters18.mmPayment,
						TransactionTypeAndAdditionalParameters18.mmCommonIdentification, TransactionTypeAndAdditionalParameters18.mmReconciliationIndicator);
