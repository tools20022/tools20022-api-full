	...
	public static final MMMessageAttribute mmTransactionSequenceCounter = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSet15.mmTransactionSequenceCounter);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSet8.mmTransactionSequenceCounter;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmTransactionResponse = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSet15.mmTransactionResponse);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSet8.mmTransactionResponse;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmEnvironment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSet15.mmEnvironment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSet8.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSet15.mmTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSet8.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
