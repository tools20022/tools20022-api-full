...
public class CardPaymentDataSet11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSet11.mmTransactionSequenceCounter, CardPaymentDataSet11.mmTransactionResponse, CardPaymentDataSet11.mmEnvironment, CardPaymentDataSet11.mmTransaction);
