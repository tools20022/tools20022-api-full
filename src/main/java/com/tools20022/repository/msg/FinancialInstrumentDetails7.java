...
public class FinancialInstrumentDetails7 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentDetails7.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentAttributes = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes27.mmObject();
		}
	};
	protected List<com.tools20022.repository.msg.IntraPositionDetails18> subBalance;
	/**
	...
	public static final MMMessageAssociationEnd mmSubBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.IntraPositionDetails18.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails7.mmFinancialInstrumentIdentification, FinancialInstrumentDetails7.mmFinancialInstrumentAttributes, FinancialInstrumentDetails7.mmSubBalance);
	...
	public FinancialInstrumentAttributes27 getFinancialInstrumentAttributes() {
		return financialInstrumentAttributes;
	}

	public void setFinancialInstrumentAttributes(com.tools20022.repository.msg.FinancialInstrumentAttributes27 financialInstrumentAttributes) {
	...
	public void setSubBalance(List<com.tools20022.repository.msg.IntraPositionDetails18> subBalance) {
