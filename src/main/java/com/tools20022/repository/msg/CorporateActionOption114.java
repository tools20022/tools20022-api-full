 ...
 * ConstraintOptionTypeUnknownProceedsUsageRule.forCorporateActionOption114}</li>
 * <li>
...
@XmlType(name = "CorporateActionOption114", propOrder = {"optionNumber", "optionType", "fractionDisposition", "offerType", "optionFeatures", "optionAvailabilityStatus", "certificationBreakdownType", "nonDomicileCountry",
...
public class CorporateActionOption114 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Exact3NumericText> mmOptionNumber = new MMMessageAttribute<CorporateActionOption114, Exact3NumericText>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmOptionNumber);
			previousVersion_lazy = () -> CorporateActionOption101.mmOptionNumber;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Exact3NumericText getValue(CorporateActionOption114 obj) {
			return obj.getOptionNumber();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Exact3NumericText value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, CorporateActionOption18Choice> mmOptionType = new MMMessageAssociationEnd<CorporateActionOption114, CorporateActionOption18Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmOptionType);
			previousVersion_lazy = () -> CorporateActionOption101.mmOptionType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionOption18Choice getValue(CorporateActionOption114 obj) {
			return obj.getOptionType();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, CorporateActionOption18Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<FractionDispositionType26Choice>> mmFractionDisposition = new MMMessageAssociationEnd<CorporateActionOption114, Optional<FractionDispositionType26Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmFractionDisposition);
			previousVersion_lazy = () -> CorporateActionOption101.mmFractionDisposition;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FractionDispositionType26Choice> getValue(CorporateActionOption114 obj) {
			return obj.getFractionDisposition();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<FractionDispositionType26Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, List<OfferTypeFormat10Choice>> mmOfferType = new MMMessageAssociationEnd<CorporateActionOption114, List<OfferTypeFormat10Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmOfferType);
			previousVersion_lazy = () -> CorporateActionOption101.mmOfferType;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<OfferTypeFormat10Choice> getValue(CorporateActionOption114 obj) {
			return obj.getOfferType();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<OfferTypeFormat10Choice> value) {
			obj.setOfferType(value);
		}
	};
	@XmlElement(name = "OptnFeatrs")
	protected List<OptionFeaturesFormat16Choice> optionFeatures;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, List<OptionFeaturesFormat16Choice>> mmOptionFeatures = new MMMessageAssociationEnd<CorporateActionOption114, List<OptionFeaturesFormat16Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmOptionFeatures);
			previousVersion_lazy = () -> CorporateActionOption101.mmOptionFeatures;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> OptionFeaturesFormat16Choice.mmObject();
		}

		@Override
		public List<OptionFeaturesFormat16Choice> getValue(CorporateActionOption114 obj) {
			return obj.getOptionFeatures();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<OptionFeaturesFormat16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<OptionAvailabilityStatus3Choice>> mmOptionAvailabilityStatus = new MMMessageAssociationEnd<CorporateActionOption114, Optional<OptionAvailabilityStatus3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmOptionAvailabilityStatus);
			previousVersion_lazy = () -> CorporateActionOption101.mmOptionAvailabilityStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionAvailabilityStatus3Choice> getValue(CorporateActionOption114 obj) {
			return obj.getOptionAvailabilityStatus();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<OptionAvailabilityStatus3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, List<BeneficiaryCertificationType9Choice>> mmCertificationBreakdownType = new MMMessageAssociationEnd<CorporateActionOption114, List<BeneficiaryCertificationType9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmCertificationBreakdownType);
			previousVersion_lazy = () -> CorporateActionOption101.mmCertificationBreakdownType;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<BeneficiaryCertificationType9Choice> getValue(CorporateActionOption114 obj) {
			return obj.getCertificationBreakdownType();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<BeneficiaryCertificationType9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, List<CountryCode>> mmNonDomicileCountry = new MMMessageAttribute<CorporateActionOption114, List<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmNonDomicileCountry);
			previousVersion_lazy = () -> CorporateActionOption101.mmNonDomicileCountry;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}

		@Override
		public List<CountryCode> getValue(CorporateActionOption114 obj) {
			return obj.getNonDomicileCountry();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, List<CountryCode>> mmValidDomicileCountry = new MMMessageAttribute<CorporateActionOption114, List<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmValidDomicileCountry);
			previousVersion_lazy = () -> CorporateActionOption101.mmValidDomicileCountry;
			minOccurs = 0;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<ActiveCurrencyCode>> mmCurrencyOption = new MMMessageAttribute<CorporateActionOption114, Optional<ActiveCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmCurrencyOption);
			previousVersion_lazy = () -> CorporateActionOption101.mmCurrencyOption;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyCode> getValue(CorporateActionOption114 obj) {
			return obj.getCurrencyOption();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<ActiveCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, DefaultProcessingOrStandingInstruction1Choice> mmDefaultProcessingOrStandingInstruction = new MMMessageAssociationEnd<CorporateActionOption114, DefaultProcessingOrStandingInstruction1Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmDefaultProcessingOrStandingInstruction);
			previousVersion_lazy = () -> CorporateActionOption101.mmDefaultProcessingOrStandingInstruction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public DefaultProcessingOrStandingInstruction1Choice getValue(CorporateActionOption114 obj) {
			return obj.getDefaultProcessingOrStandingInstruction();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, DefaultProcessingOrStandingInstruction1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>> mmChargesAppliedIndicator = new MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmChargesAppliedIndicator);
			previousVersion_lazy = () -> CorporateActionOption101.mmChargesAppliedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CorporateActionOption114 obj) {
			return obj.getChargesAppliedIndicator();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>> mmCertificationBreakdownIndicator = new MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmCertificationBreakdownIndicator);
			previousVersion_lazy = () -> CorporateActionOption101.mmCertificationBreakdownIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>> mmWithdrawalAllowedIndicator = new MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmWithdrawalAllowedIndicator);
			previousVersion_lazy = () -> CorporateActionOption101.mmWithdrawalAllowedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>> mmChangeAllowedIndicator = new MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmChangeAllowedIndicator);
			previousVersion_lazy = () -> CorporateActionOption101.mmChangeAllowedIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>> mmAppliedOptionIndicator = new MMMessageAttribute<CorporateActionOption114, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			xmlTag = "ApldOptnInd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmAppliedOptionIndicator);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<SecurityIdentification19>> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<CorporateActionOption114, Optional<SecurityIdentification19>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> CorporateActionOption101.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecurityIdentification19> getValue(CorporateActionOption114 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<SecurityIdentification19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionDate48>> mmDateDetails = new MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionDate48>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmDateDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionDate48> getValue(CorporateActionOption114 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<CorporateActionDate48> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionPeriod7>> mmPeriodDetails = new MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionPeriod7>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmPeriodDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmPeriodDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionPeriod7> getValue(CorporateActionOption114 obj) {
			return obj.getPeriodDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<CorporateActionPeriod7> value) {
			obj.setPeriodDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "RateAndAmtDtls")
	protected CorporateActionRate68 rateAndAmountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CorporateActionRate68
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionRate68>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionRate68>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmRateAndAmountDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmRateAndAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionRate68.mmObject();
		}

		@Override
		public Optional<CorporateActionRate68> getValue(CorporateActionOption114 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<CorporateActionRate68> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionPrice58>> mmPriceDetails = new MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionPrice58>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmPriceDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmPriceDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionPrice58> getValue(CorporateActionOption114 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<CorporateActionPrice58> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<SecuritiesOption51>> mmSecuritiesQuantity = new MMMessageAssociationEnd<CorporateActionOption114, Optional<SecuritiesOption51>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmSecuritiesQuantity);
			previousVersion_lazy = () -> CorporateActionOption101.mmSecuritiesQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesOption51> getValue(CorporateActionOption114 obj) {
			return obj.getSecuritiesQuantity();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<SecuritiesOption51> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, List<SecuritiesOption49>> mmSecuritiesMovementDetails = new MMMessageAssociationEnd<CorporateActionOption114, List<SecuritiesOption49>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmSecuritiesMovementDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmSecuritiesMovementDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SecuritiesOption49> getValue(CorporateActionOption114 obj) {
			return obj.getSecuritiesMovementDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<SecuritiesOption49> value) {
			obj.setSecuritiesMovementDetails(value);
		}
	};
	@XmlElement(name = "CshMvmntDtls")
	protected List<CashOption43> cashMovementDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.CashOption43
	 * CashOption43}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, List<CashOption43>> mmCashMovementDetails = new MMMessageAssociationEnd<CorporateActionOption114, List<CashOption43>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmCashMovementDetails);
			previousVersion_lazy = () -> CorporateActionOption101.mmCashMovementDetails;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashOption43.mmObject();
		}

		@Override
		public List<CashOption43> getValue(CorporateActionOption114 obj) {
			return obj.getCashMovementDetails();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, List<CashOption43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionNarrative29>> mmAdditionalInformation = new MMMessageAssociationEnd<CorporateActionOption114, Optional<CorporateActionNarrative29>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionOption114.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmAdditionalInformation);
			previousVersion_lazy = () -> CorporateActionOption101.mmAdditionalInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CorporateActionNarrative29> getValue(CorporateActionOption114 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(CorporateActionOption114 obj, Optional<CorporateActionNarrative29> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption114.mmOptionNumber, com.tools20022.repository.msg.CorporateActionOption114.mmOptionType,
						com.tools20022.repository.msg.CorporateActionOption114.mmFractionDisposition, com.tools20022.repository.msg.CorporateActionOption114.mmOfferType,
						com.tools20022.repository.msg.CorporateActionOption114.mmOptionFeatures, com.tools20022.repository.msg.CorporateActionOption114.mmOptionAvailabilityStatus,
						com.tools20022.repository.msg.CorporateActionOption114.mmCertificationBreakdownType, com.tools20022.repository.msg.CorporateActionOption114.mmNonDomicileCountry,
						com.tools20022.repository.msg.CorporateActionOption114.mmValidDomicileCountry, com.tools20022.repository.msg.CorporateActionOption114.mmCurrencyOption,
						com.tools20022.repository.msg.CorporateActionOption114.mmDefaultProcessingOrStandingInstruction, com.tools20022.repository.msg.CorporateActionOption114.mmChargesAppliedIndicator,
						com.tools20022.repository.msg.CorporateActionOption114.mmCertificationBreakdownIndicator, com.tools20022.repository.msg.CorporateActionOption114.mmWithdrawalAllowedIndicator,
						com.tools20022.repository.msg.CorporateActionOption114.mmChangeAllowedIndicator, com.tools20022.repository.msg.CorporateActionOption114.mmAppliedOptionIndicator,
						com.tools20022.repository.msg.CorporateActionOption114.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.CorporateActionOption114.mmDateDetails,
						com.tools20022.repository.msg.CorporateActionOption114.mmPeriodDetails, com.tools20022.repository.msg.CorporateActionOption114.mmRateAndAmountDetails,
						com.tools20022.repository.msg.CorporateActionOption114.mmPriceDetails, com.tools20022.repository.msg.CorporateActionOption114.mmSecuritiesQuantity,
						com.tools20022.repository.msg.CorporateActionOption114.mmSecuritiesMovementDetails, com.tools20022.repository.msg.CorporateActionOption114.mmCashMovementDetails,
						com.tools20022.repository.msg.CorporateActionOption114.mmAdditionalInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNotificationV06.mmCorporateActionOptionDetails);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalTextRule.forCorporateActionOption114,
						com.tools20022.repository.constraints.ConstraintOptionNumberGuideline.forCorporateActionOption114, com.tools20022.repository.constraints.ConstraintRevocabilityPeriodRule.forCorporateActionOption114,
						com.tools20022.repository.constraints.ConstraintOptionTypeUnknownProceedsUsageRule.forCorporateActionOption114, com.tools20022.repository.constraints.ConstraintAppliedOptionRule.forCorporateActionOption114);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption114";
				definition = "Provides information about the corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionOption130.mmObject());
				previousVersion_lazy = () -> CorporateActionOption101.mmObject();
			}
		});
	...
	public CorporateActionOption114 setOptionNumber(Exact3NumericText optionNumber) {
	...
	public CorporateActionOption114 setOptionType(CorporateActionOption18Choice optionType) {
	...
	public CorporateActionOption114 setFractionDisposition(FractionDispositionType26Choice fractionDisposition) {
	...
	public CorporateActionOption114 setOfferType(List<OfferTypeFormat10Choice> offerType) {
		this.offerType = Objects.requireNonNull(offerType);
		return this;
	}

	public List<OptionFeaturesFormat16Choice> getOptionFeatures() {
		return optionFeatures == null ? optionFeatures = new ArrayList<>() : optionFeatures;
	}

	public CorporateActionOption114 setOptionFeatures(List<OptionFeaturesFormat16Choice> optionFeatures) {
	...
	public CorporateActionOption114 setOptionAvailabilityStatus(OptionAvailabilityStatus3Choice optionAvailabilityStatus) {
	...
	public CorporateActionOption114 setCertificationBreakdownType(List<BeneficiaryCertificationType9Choice> certificationBreakdownType) {
	...
	public CorporateActionOption114 setNonDomicileCountry(List<CountryCode> nonDomicileCountry) {
	...
	public CorporateActionOption114 setValidDomicileCountry(List<CountryCode> validDomicileCountry) {
	...
	public CorporateActionOption114 setCurrencyOption(ActiveCurrencyCode currencyOption) {
	...
	public CorporateActionOption114 setDefaultProcessingOrStandingInstruction(DefaultProcessingOrStandingInstruction1Choice defaultProcessingOrStandingInstruction) {
	...
	public CorporateActionOption114 setChargesAppliedIndicator(YesNoIndicator chargesAppliedIndicator) {
	...
	public CorporateActionOption114 setCertificationBreakdownIndicator(YesNoIndicator certificationBreakdownIndicator) {
	...
	public CorporateActionOption114 setWithdrawalAllowedIndicator(YesNoIndicator withdrawalAllowedIndicator) {
	...
	public CorporateActionOption114 setChangeAllowedIndicator(YesNoIndicator changeAllowedIndicator) {
	...
	public CorporateActionOption114 setAppliedOptionIndicator(YesNoIndicator appliedOptionIndicator) {
	...
	public CorporateActionOption114 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public CorporateActionOption114 setDateDetails(CorporateActionDate48 dateDetails) {
	...
	public CorporateActionOption114 setPeriodDetails(CorporateActionPeriod7 periodDetails) {
		this.periodDetails = periodDetails;
		return this;
	}

	public Optional<CorporateActionRate68> getRateAndAmountDetails() {
		return rateAndAmountDetails == null ? Optional.empty() : Optional.of(rateAndAmountDetails);
	}

	public CorporateActionOption114 setRateAndAmountDetails(CorporateActionRate68 rateAndAmountDetails) {
	...
	public CorporateActionOption114 setPriceDetails(CorporateActionPrice58 priceDetails) {
	...
	public CorporateActionOption114 setSecuritiesQuantity(SecuritiesOption51 securitiesQuantity) {
	...
	public CorporateActionOption114 setSecuritiesMovementDetails(List<SecuritiesOption49> securitiesMovementDetails) {
		this.securitiesMovementDetails = Objects.requireNonNull(securitiesMovementDetails);
		return this;
	}

	public List<CashOption43> getCashMovementDetails() {
		return cashMovementDetails == null ? cashMovementDetails = new ArrayList<>() : cashMovementDetails;
	}

	public CorporateActionOption114 setCashMovementDetails(List<CashOption43> cashMovementDetails) {
	...
	public CorporateActionOption114 setAdditionalInformation(CorporateActionNarrative29 additionalInformation) {
