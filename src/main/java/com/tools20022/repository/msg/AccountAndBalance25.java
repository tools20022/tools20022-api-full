...
public class AccountAndBalance25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance25.mmSafekeepingAccount, AccountAndBalance25.mmAccountOwner, AccountAndBalance25.mmSafekeepingPlace, AccountAndBalance25.mmBalance);
