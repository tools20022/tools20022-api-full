...
public class SettlementDetails113 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails113.mmSecuritiesTransactionType, SettlementDetails113.mmSettlementTransactionCondition, SettlementDetails113.mmBeneficialOwnership,
						SettlementDetails113.mmCCPEligibility, SettlementDetails113.mmDeliveryReturnReason, SettlementDetails113.mmCashClearingSystem, SettlementDetails113.mmExposureType, SettlementDetails113.mmFXStandingInstruction,
						SettlementDetails113.mmMarketClientSide, SettlementDetails113.mmNettingEligibility, SettlementDetails113.mmRegistration, SettlementDetails113.mmLegalRestrictions, SettlementDetails113.mmSettlingCapacity,
						SettlementDetails113.mmTaxCapacity, SettlementDetails113.mmStampDutyTaxBasis, SettlementDetails113.mmTracking, SettlementDetails113.mmLetterOfGuarantee, SettlementDetails113.mmReturnLeg,
						SettlementDetails113.mmModificationCancellationAllowed, SettlementDetails113.mmEligibleForCollateral, SettlementDetails113.mmSecuritiesSubBalanceType, SettlementDetails113.mmCashSubBalanceType);
