...
public class IndividualPerson2 {
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IndividualPerson2.mmObject();
			isDerived = false;
			xmlTag = "Nm";
	...
	protected List<com.tools20022.repository.msg.GenericIdentification8> otherIdentification;
	/**
	...
	public static final MMMessageAssociationEnd mmOtherIdentification = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.GenericIdentification8.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IndividualPerson2.mmName, IndividualPerson2.mmBirthDate, IndividualPerson2.mmCountryAndResidentialStatus, IndividualPerson2.mmOtherIdentification);
	...
	public void setOtherIdentification(List<com.tools20022.repository.msg.GenericIdentification8> otherIdentification) {
