...
@XmlType(name = "StatusAndReason2", propOrder = "statusAndReason")
public class StatusAndReason2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.StatusAndReason2
	 * StatusAndReason2}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusAndReason2.mmStatusAndReason);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StatusAndReason2";
	...
	public StatusAndReason2 setStatusAndReason(Status2Choice statusAndReason) {
