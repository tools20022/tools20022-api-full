...
import com.tools20022.repository.msg.TransactionDetails8;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction8
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction8}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction8
 * ConstraintCoexistenceIdentificationRule.forTransaction8}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction8", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "tradeIdentification", "poolIdentification",
...
public class Transaction8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction8, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction8.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(Transaction8 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction8 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transaction8 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction8 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction8, List<Max35Text>>() {
		{
		...
		@Override
		public List<Max35Text> getValue(Transaction8 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction8 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction8, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction8, Optional<TransactionDetails8>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction8, Optional<TransactionDetails8>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails8.mmObject();
		}

		@Override
		public Optional<TransactionDetails8> getValue(Transaction8 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction8 obj, Optional<TransactionDetails8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction8, List<StatusAndReason2>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction8, List<StatusAndReason2>>() {
		{
		...
		@Override
		public List<StatusAndReason2> getValue(Transaction8 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction8 obj, List<StatusAndReason2> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV01.mmTransactions);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction8,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction8);
	...
	public Transaction8 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction8 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction8 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction8 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction8 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction8 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction8 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction8 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction8 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails8> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction8 setTransactionDetails(TransactionDetails8 transactionDetails) {
	...
	public Transaction8 setStatusAndReason(List<StatusAndReason2> statusAndReason) {
