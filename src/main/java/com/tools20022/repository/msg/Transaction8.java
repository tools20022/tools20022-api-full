...
public class Transaction8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction8.mmAccountOwnerTransactionIdentification, Transaction8.mmAccountServicerTransactionIdentification, Transaction8.mmMarketInfrastructureTransactionIdentification,
						Transaction8.mmTradeIdentification, Transaction8.mmPoolIdentification, Transaction8.mmCommonIdentification, Transaction8.mmCorporateActionEventIdentification,
						Transaction8.mmTripartyAgentCollateralTransactionIdentification, Transaction8.mmClientTripartyCollateralTransactionIdentification, Transaction8.mmTransactionDetails, Transaction8.mmStatusAndReason);
