...
public class CancelledCompleteReason1 {
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledCompleteReason1.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledCompleteReason1.mmReason, CancelledCompleteReason1.mmAdditionalReasonInformation);
	...
	public void setReason(CancellationCompleteReason1Choice reason) {
		this.reason = reason;
	}
