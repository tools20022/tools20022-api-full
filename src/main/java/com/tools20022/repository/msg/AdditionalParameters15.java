 ...
 * AdditionalParameters15.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters15#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters15.mmClientTripartyCollateralTransactionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forAdditionalParameters15
 * ConstraintCoexistenceIdentificationRule.forAdditionalParameters15}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters15", propOrder = {"preConfirmation", "partialSettlement", "tripartyAgentCollateralTransactionIdentification", "clientTripartyCollateralTransactionIdentification"})
public class AdditionalParameters15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters15, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters15, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters15.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters15 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters15 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters15, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters15, Optional<PartialSettlement2Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters15 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters15 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters15, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters15, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters15 obj) {
			return obj.getTripartyAgentCollateralTransactionIdentification();
		}

		@Override
		public void setValue(AdditionalParameters15 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters15, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters15, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forAdditionalParameters15);
	...
	public AdditionalParameters15 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters15 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters15 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters15 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
