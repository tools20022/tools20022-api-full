...
public class RejectionOrRepairReason22 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason22.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason22.mmCode, RejectionOrRepairReason22.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason22Choice code) {
		this.code = code;
	}
