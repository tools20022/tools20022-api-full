...
public class RejectionOrRepairReason22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason22.Code, com.tools20022.repository.msg.RejectionOrRepairReason22.AdditionalReasonInformation);
