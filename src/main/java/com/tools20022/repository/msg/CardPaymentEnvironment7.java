...
public class CardPaymentEnvironment7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment7.mmAcquirer, CardPaymentEnvironment7.mmMerchantIdentification, CardPaymentEnvironment7.mmPOIIdentification);
