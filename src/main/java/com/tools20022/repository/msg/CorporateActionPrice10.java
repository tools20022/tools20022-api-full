...
public class CorporateActionPrice10 {
	...
	public static final MMMessageAssociationEnd mmIndicativeOrMarketPrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice10.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice10.mmIndicativeOrMarketPrice, CorporateActionPrice10.mmCashInLieuOfSharePrice);
	...
	public IndicativeOrMarketPrice1Choice getIndicativeOrMarketPrice() {
		return indicativeOrMarketPrice;
	}

	public void setIndicativeOrMarketPrice(IndicativeOrMarketPrice1Choice indicativeOrMarketPrice) {
	...
	public void setCashInLieuOfSharePrice(PriceFormat11Choice cashInLieuOfSharePrice) {
