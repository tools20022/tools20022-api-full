...
public class AlternatePartyIdentification3 {
	...
	public static final MMMessageAssociationEnd IdentificationType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> AlternatePartyIdentification3.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AlternatePartyIdentification3.IdentificationType, com.tools20022.repository.msg.AlternatePartyIdentification3.Country,
						com.tools20022.repository.msg.AlternatePartyIdentification3.AlternateIdentification);
