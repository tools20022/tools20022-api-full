...
public class AuthorisationResult2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AuthorisationResult2.mmAuthorisationEntity, AuthorisationResult2.mmResponseToAuthorisation, AuthorisationResult2.mmAuthorisationCode);
