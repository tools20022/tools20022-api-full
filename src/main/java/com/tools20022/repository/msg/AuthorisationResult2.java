	...
	public static final MMMessageAssociationEnd mmAuthorisationEntity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult5.mmAuthorisationEntity);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmResponseToAuthorisation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult5.mmResponseToAuthorisation);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAuthorisationCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult5.mmAuthorisationCode);
			maxOccurs = 1;
			minOccurs = 0;
