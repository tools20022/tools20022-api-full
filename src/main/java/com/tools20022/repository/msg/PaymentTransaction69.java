...
public class PaymentTransaction69 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction69.mmStatusIdentification, PaymentTransaction69.mmOriginalInstructionIdentification, PaymentTransaction69.mmOriginalEndToEndIdentification,
						PaymentTransaction69.mmTransactionStatus, PaymentTransaction69.mmStatusReasonInformation, PaymentTransaction69.mmChargesInformation, PaymentTransaction69.mmAcceptanceDateTime,
						PaymentTransaction69.mmAccountServicerReference, PaymentTransaction69.mmClearingSystemReference, PaymentTransaction69.mmOriginalTransactionReference, PaymentTransaction69.mmSupplementaryData);
