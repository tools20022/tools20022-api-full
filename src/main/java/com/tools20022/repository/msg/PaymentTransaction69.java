...
import com.tools20022.repository.msg.OriginalTransactionReference23;
...
@XmlType(name = "PaymentTransaction69", propOrder = {"statusIdentification", "originalInstructionIdentification", "originalEndToEndIdentification", "transactionStatus", "statusReasonInformation", "chargesInformation", "acceptanceDateTime",
...
public class PaymentTransaction69 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>> mmStatusIdentification = new MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction69.mmObject();
			isDerived = false;
			xmlTag = "StsId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmStatusIdentification);
			previousVersion_lazy = () -> PaymentTransaction59.mmStatusIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction69 obj) {
			return obj.getStatusIdentification();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction59.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction59.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<TransactionIndividualStatus3Code>> mmTransactionStatus = new MMMessageAttribute<PaymentTransaction69, Optional<TransactionIndividualStatus3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmTransactionStatus);
			previousVersion_lazy = () -> PaymentTransaction59.mmTransactionStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionIndividualStatus3Code> getValue(PaymentTransaction69 obj) {
			return obj.getTransactionStatus();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, Optional<TransactionIndividualStatus3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction69, List<StatusReasonInformation9>> mmStatusReasonInformation = new MMMessageAssociationEnd<PaymentTransaction69, List<StatusReasonInformation9>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmStatusReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction59.mmStatusReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<StatusReasonInformation9> getValue(PaymentTransaction69 obj) {
			return obj.getStatusReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, List<StatusReasonInformation9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction69, List<Charges2>> mmChargesInformation = new MMMessageAssociationEnd<PaymentTransaction69, List<Charges2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmChargesInformation);
			previousVersion_lazy = () -> PaymentTransaction59.mmChargesInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charges2> getValue(PaymentTransaction69 obj) {
			return obj.getChargesInformation();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, List<Charges2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<ISODateTime>> mmAcceptanceDateTime = new MMMessageAttribute<PaymentTransaction69, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmAcceptanceDateTime);
			previousVersion_lazy = () -> PaymentTransaction59.mmAcceptanceDateTime;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODateTime> getValue(PaymentTransaction69 obj) {
			return obj.getAcceptanceDateTime();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, Optional<ISODateTime> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>> mmAccountServicerReference = new MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmAccountServicerReference);
			previousVersion_lazy = () -> PaymentTransaction59.mmAccountServicerReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>> mmClearingSystemReference = new MMMessageAttribute<PaymentTransaction69, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmClearingSystemReference);
			previousVersion_lazy = () -> PaymentTransaction59.mmClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected OriginalTransactionReference23 originalTransactionReference;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction69, Optional<OriginalTransactionReference23>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction69, Optional<OriginalTransactionReference23>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction59.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> OriginalTransactionReference23.mmObject();
		}

		@Override
		public Optional<OriginalTransactionReference23> getValue(PaymentTransaction69 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, Optional<OriginalTransactionReference23> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction69, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction69, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction69.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction59.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction69 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction69 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction69.mmStatusIdentification, com.tools20022.repository.msg.PaymentTransaction69.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction69.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction69.mmTransactionStatus,
						com.tools20022.repository.msg.PaymentTransaction69.mmStatusReasonInformation, com.tools20022.repository.msg.PaymentTransaction69.mmChargesInformation,
						com.tools20022.repository.msg.PaymentTransaction69.mmAcceptanceDateTime, com.tools20022.repository.msg.PaymentTransaction69.mmAccountServicerReference,
						com.tools20022.repository.msg.PaymentTransaction69.mmClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction69.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction69.mmSupplementaryData);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction69";
				definition = "Provides further details on the original transactions, to which the status report message refers.";
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction83.mmObject());
				previousVersion_lazy = () -> PaymentTransaction59.mmObject();
			}
		});
	...
	public PaymentTransaction69 setStatusIdentification(Max35Text statusIdentification) {
	...
	public PaymentTransaction69 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction69 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction69 setTransactionStatus(TransactionIndividualStatus3Code transactionStatus) {
	...
	public PaymentTransaction69 setStatusReasonInformation(List<StatusReasonInformation9> statusReasonInformation) {
	...
	public PaymentTransaction69 setChargesInformation(List<Charges2> chargesInformation) {
	...
	public PaymentTransaction69 setAcceptanceDateTime(ISODateTime acceptanceDateTime) {
	...
	public PaymentTransaction69 setAccountServicerReference(Max35Text accountServicerReference) {
	...
	public PaymentTransaction69 setClearingSystemReference(Max35Text clearingSystemReference) {
		this.clearingSystemReference = clearingSystemReference;
		return this;
	}

	public Optional<OriginalTransactionReference23> getOriginalTransactionReference() {
		return originalTransactionReference == null ? Optional.empty() : Optional.of(originalTransactionReference);
	}

	public PaymentTransaction69 setOriginalTransactionReference(OriginalTransactionReference23 originalTransactionReference) {
	...
	public PaymentTransaction69 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
