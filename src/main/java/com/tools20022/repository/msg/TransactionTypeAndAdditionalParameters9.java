 ...
 * TransactionTypeAndAdditionalParameters9.mmSecuritiesFinancingTransactionType}
 * </li>
 * <li>
...
@XmlType(name = "TransactionTypeAndAdditionalParameters9", propOrder = {"securitiesFinancingTransactionType", "payment", "commonIdentification", "reconciliationIndicator"})
public class TransactionTypeAndAdditionalParameters9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters9, SecuritiesFinancingTransactionType1Code> mmSecuritiesFinancingTransactionType = new MMMessageAttribute<TransactionTypeAndAdditionalParameters9, SecuritiesFinancingTransactionType1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters15.mmSecuritiesFinancingTransactionType);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters1.mmSecuritiesFinancingTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesFinancingTransactionType1Code getValue(TransactionTypeAndAdditionalParameters9 obj) {
			return obj.getSecuritiesFinancingTransactionType();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters9 obj, SecuritiesFinancingTransactionType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters9, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionTypeAndAdditionalParameters9, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters15.mmPayment);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters1.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionTypeAndAdditionalParameters9 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters9 obj, DeliveryReceiptType2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters9, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters9, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters15.mmCommonIdentification);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters1.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(TransactionTypeAndAdditionalParameters9 obj) {
			return obj.getCommonIdentification();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters9 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters9, Optional<YesNoIndicator>> mmReconciliationIndicator = new MMMessageAttribute<TransactionTypeAndAdditionalParameters9, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmObject();
			isDerived = false;
			xmlTag = "RcncltnInd";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters15.mmReconciliationIndicator);
			previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters1.mmReconciliationIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(TransactionTypeAndAdditionalParameters9 obj) {
			return obj.getReconciliationIndicator();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters9 obj, Optional<YesNoIndicator> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmSecuritiesFinancingTransactionType,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmPayment, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmCommonIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters9.mmReconciliationIndicator);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV06.mmTransactionTypeAndAdditionalParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionTypeAndAdditionalParameters9";
				...
				nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters15.mmObject());
				previousVersion_lazy = () -> TransactionTypeAndAdditionalParameters1.mmObject();
			}
		});
	...
	public TransactionTypeAndAdditionalParameters9 setSecuritiesFinancingTransactionType(SecuritiesFinancingTransactionType1Code securitiesFinancingTransactionType) {
	...
	public TransactionTypeAndAdditionalParameters9 setPayment(DeliveryReceiptType2Code payment) {
	...
	public TransactionTypeAndAdditionalParameters9 setCommonIdentification(Max35Text commonIdentification) {
	...
	public TransactionTypeAndAdditionalParameters9 setReconciliationIndicator(YesNoIndicator reconciliationIndicator) {
