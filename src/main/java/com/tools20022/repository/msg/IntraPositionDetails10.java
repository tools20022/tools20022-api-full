...
public class IntraPositionDetails10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraPositionDetails10.SafekeepingPlace, com.tools20022.repository.msg.IntraPositionDetails10.BalanceFrom,
						com.tools20022.repository.msg.IntraPositionDetails10.IntraPositionMovement);
