...
public class CashBalanceDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashBalanceDetails3.mmAmount, CashBalanceDetails3.mmCreditDebitIndicator, CashBalanceDetails3.mmType, CashBalanceDetails3.mmStatus, CashBalanceDetails3.mmValueDate,
						CashBalanceDetails3.mmNumberOfPayments);
