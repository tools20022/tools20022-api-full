...
@XmlType(name = "PaymentInstructionReferenceDetails4", propOrder = {"paymentInstructionReference", "interbankSettlementAmount", "interbankValueDate", "paymentMethod", "instructingAgentIdentification", "instructedAgentIdentification",
		"entryType", "relatedReference"})
public class PaymentInstructionReferenceDetails4 {
	...
	public PaymentInstructionReferenceDetails4 setPaymentInstructionReference(Max35Text paymentInstructionReference) {
	...
	public PaymentInstructionReferenceDetails4 setInterbankSettlementAmount(ImpliedCurrencyAndAmount interbankSettlementAmount) {
	...
	public PaymentInstructionReferenceDetails4 setInterbankValueDate(ISODate interbankValueDate) {
	...
	public PaymentInstructionReferenceDetails4 setPaymentMethod(PaymentOrigin1Choice paymentMethod) {
	...
	public PaymentInstructionReferenceDetails4 setInstructingAgentIdentification(BICIdentifier instructingAgentIdentification) {
	...
	public PaymentInstructionReferenceDetails4 setInstructedAgentIdentification(BICIdentifier instructedAgentIdentification) {
	...
	public PaymentInstructionReferenceDetails4 setEntryType(EntryTypeIdentifier entryType) {
	...
	public PaymentInstructionReferenceDetails4 setRelatedReference(Max35Text relatedReference) {
