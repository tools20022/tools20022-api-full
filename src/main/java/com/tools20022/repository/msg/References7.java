...
public class References7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References7.mmAccountOwnerTransactionIdentification, References7.mmAccountServicerTransactionIdentification, References7.mmMarketInfrastructureTransactionIdentification,
						References7.mmProcessorTransactionIdentification, References7.mmPoolIdentification, References7.mmCommonIdentification, References7.mmTradeIdentification);
