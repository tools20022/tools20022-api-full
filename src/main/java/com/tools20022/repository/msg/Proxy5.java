...
public class Proxy5 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Proxy3#ProxyType
	 * Proxy3.ProxyType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute ProxyType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Proxy3.ProxyType;
			minOccurs = 1;
			maxOccurs = 2;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Proxy3#PreassignedProxy
	...
	public static final MMMessageAssociationEnd PreassignedProxy = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.Proxy3.PreassignedProxy;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Proxy5.ProxyType, com.tools20022.repository.msg.Proxy5.PreassignedProxy);
