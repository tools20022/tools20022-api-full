...
public class AdditionalBalanceInformation10 {
	...
	public static final MMMessageAttribute mmSubBalanceType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalBalanceInformation10.mmObject();
			isDerived = false;
			xmlTag = "SubBalTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalBalanceInformation10.mmSubBalanceType, AdditionalBalanceInformation10.mmQuantity, AdditionalBalanceInformation10.mmSubBalanceAdditionalDetails,
						AdditionalBalanceInformation10.mmQuantityBreakdown);
