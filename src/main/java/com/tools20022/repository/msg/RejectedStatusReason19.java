...
public class RejectedStatusReason19 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason19.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason19.mmReasonCode, RejectedStatusReason19.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason18Choice reasonCode) {
