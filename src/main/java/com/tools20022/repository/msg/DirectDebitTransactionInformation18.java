 ...
 * ConstraintUltimateCreditorGuideline.forDirectDebitTransactionInformation18}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintUltimateDebtorGuideline#forDirectDebitTransactionInformation18
 * ConstraintUltimateDebtorGuideline.forDirectDebitTransactionInformation18}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "DirectDebitTransactionInformation18", propOrder = {"paymentIdentification", "paymentTypeInformation", "instructedAmount", "chargeBearer", "directDebitTransaction", "ultimateCreditor", "debtorAgent", "debtorAgentAccount",
...
public class DirectDebitTransactionInformation18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, PaymentIdentification1> mmPaymentIdentification = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, PaymentIdentification1>() {
		{
			businessElementTrace_lazy = () -> Payment.mmPaymentRelatedIdentifications;
			componentContext_lazy = () -> com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmObject();
			isDerived = false;
			xmlTag = "PmtId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PaymentIdentification";
			definition = "Set of elements used to reference a payment instruction.";
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmPaymentIdentification);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmPaymentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PaymentIdentification1 getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getPaymentIdentification();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, PaymentIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PaymentTypeInformation24>> mmPaymentTypeInformation = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PaymentTypeInformation24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmPaymentTypeInformation);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTypeInformation24> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<PaymentTypeInformation24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DirectDebitTransactionInformation18, ActiveOrHistoricCurrencyAndAmount> mmInstructedAmount = new MMMessageAttribute<DirectDebitTransactionInformation18, ActiveOrHistoricCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmInstructedAmount);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmInstructedAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyAndAmount getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getInstructedAmount();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, ActiveOrHistoricCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DirectDebitTransactionInformation18, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<DirectDebitTransactionInformation18, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmChargeBearer);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<DirectDebitTransaction8>> mmDirectDebitTransaction = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<DirectDebitTransaction8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmDirectDebitTransaction);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmDirectDebitTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DirectDebitTransaction8> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getDirectDebitTransaction();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<DirectDebitTransaction8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PartyIdentification43>> mmUltimateCreditor = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PartyIdentification43>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmUltimateCreditor);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification43> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getUltimateCreditor();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, BranchAndFinancialInstitutionIdentification5> mmDebtorAgent = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, BranchAndFinancialInstitutionIdentification5>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmDebtorAgent);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmDebtorAgent;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getDebtorAgent();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<CashAccount24>> mmDebtorAgentAccount = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmDebtorAgentAccount);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmDebtorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccount24> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getDebtorAgentAccount();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, PartyIdentification43> mmDebtor = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, PartyIdentification43>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmDebtor);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmDebtor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
		...
		@Override
		public PartyIdentification43 getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getDebtor();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, PartyIdentification43 value) {
			obj.setDebtor(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, CashAccount24> mmDebtorAccount = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, CashAccount24>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmDebtorAccount);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmDebtorAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
		...
		@Override
		public CashAccount24 getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getDebtorAccount();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, CashAccount24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PartyIdentification43>> mmUltimateDebtor = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmUltimateDebtor);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmUltimateDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DirectDebitTransactionInformation18, Optional<Max140Text>> mmInstructionForCreditorAgent = new MMMessageAttribute<DirectDebitTransactionInformation18, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmInstructionForCreditorAgent);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmInstructionForCreditorAgent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getInstructionForCreditorAgent();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<Purpose2Choice>> mmPurpose = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<Purpose2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmPurpose);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmPurpose;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Purpose2Choice> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getPurpose();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<Purpose2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, List<RegulatoryReporting3>> mmRegulatoryReporting = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, List<RegulatoryReporting3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmRegulatoryReporting);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmRegulatoryReporting;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RegulatoryReporting3> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getRegulatoryReporting();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, List<RegulatoryReporting3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<TaxInformation3>> mmTax = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<TaxInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmTax);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxInformation3> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getTax();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<TaxInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, List<RemittanceLocation4>> mmRelatedRemittanceInformation = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, List<RemittanceLocation4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmRelatedRemittanceInformation);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmRelatedRemittanceInformation;
			maxOccurs = 10;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RemittanceLocation4> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getRelatedRemittanceInformation();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, List<RemittanceLocation4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<RemittanceInformation10>> mmRemittanceInformation = new MMMessageAssociationEnd<DirectDebitTransactionInformation18, Optional<RemittanceInformation10>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmRemittanceInformation);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmRemittanceInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RemittanceInformation10> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getRemittanceInformation();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, Optional<RemittanceInformation10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DirectDebitTransactionInformation18, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<DirectDebitTransactionInformation18, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmSupplementaryData);
			previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(DirectDebitTransactionInformation18 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(DirectDebitTransactionInformation18 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmPaymentIdentification,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmPaymentTypeInformation, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmInstructedAmount,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmChargeBearer, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmDirectDebitTransaction,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmUltimateCreditor, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmDebtorAgent,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmDebtorAgentAccount, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmDebtor,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmDebtorAccount, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmUltimateDebtor,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmInstructionForCreditorAgent, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmPurpose,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmRegulatoryReporting, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmTax,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmRelatedRemittanceInformation, com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmRemittanceInformation,
						com.tools20022.repository.msg.DirectDebitTransactionInformation18.mmSupplementaryData);
				trace_lazy = () -> DirectDebit.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintUltimateCreditorGuideline.forDirectDebitTransactionInformation18,
						com.tools20022.repository.constraints.ConstraintUltimateDebtorGuideline.forDirectDebitTransactionInformation18);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DirectDebitTransactionInformation18";
				definition = "Provides further details specific to the individual direct debit transaction(s) included in the message.";
				nextVersions_lazy = () -> Arrays.asList(DirectDebitTransactionInformation19.mmObject());
				previousVersion_lazy = () -> DirectDebitTransactionInformation13.mmObject();
			}
		});
	...
	public DirectDebitTransactionInformation18 setPaymentIdentification(PaymentIdentification1 paymentIdentification) {
	...
	public DirectDebitTransactionInformation18 setPaymentTypeInformation(PaymentTypeInformation24 paymentTypeInformation) {
	...
	public DirectDebitTransactionInformation18 setInstructedAmount(ActiveOrHistoricCurrencyAndAmount instructedAmount) {
	...
	public DirectDebitTransactionInformation18 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public DirectDebitTransactionInformation18 setDirectDebitTransaction(DirectDebitTransaction8 directDebitTransaction) {
	...
	public DirectDebitTransactionInformation18 setUltimateCreditor(PartyIdentification43 ultimateCreditor) {
	...
	public DirectDebitTransactionInformation18 setDebtorAgent(BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public DirectDebitTransactionInformation18 setDebtorAgentAccount(CashAccount24 debtorAgentAccount) {
	...
	public DirectDebitTransactionInformation18 setDebtor(PartyIdentification43 debtor) {
	...
	public DirectDebitTransactionInformation18 setDebtorAccount(CashAccount24 debtorAccount) {
	...
	public DirectDebitTransactionInformation18 setUltimateDebtor(PartyIdentification43 ultimateDebtor) {
	...
	public DirectDebitTransactionInformation18 setInstructionForCreditorAgent(Max140Text instructionForCreditorAgent) {
	...
	public DirectDebitTransactionInformation18 setPurpose(Purpose2Choice purpose) {
	...
	public DirectDebitTransactionInformation18 setRegulatoryReporting(List<RegulatoryReporting3> regulatoryReporting) {
	...
	public DirectDebitTransactionInformation18 setTax(TaxInformation3 tax) {
		this.tax = tax;
		return this;
	}
	...
	public DirectDebitTransactionInformation18 setRelatedRemittanceInformation(List<RemittanceLocation4> relatedRemittanceInformation) {
	...
	public DirectDebitTransactionInformation18 setRemittanceInformation(RemittanceInformation10 remittanceInformation) {
	...
	public DirectDebitTransactionInformation18 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
