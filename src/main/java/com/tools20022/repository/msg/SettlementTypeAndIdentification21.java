...
public class SettlementTypeAndIdentification21 {
	...
	public static final MMMessageAttribute mmPayment = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndIdentification21.mmObject();
			isDerived = false;
			xmlTag = "Pmt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification21.mmPayment, SettlementTypeAndIdentification21.mmTransactionIdentification, SettlementTypeAndIdentification21.mmSettlementDate);
