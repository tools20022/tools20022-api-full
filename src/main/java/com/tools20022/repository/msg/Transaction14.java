...
public class Transaction14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction14.mmAccountOwnerTransactionIdentification, Transaction14.mmAccountServicerTransactionIdentification, Transaction14.mmMarketInfrastructureTransactionIdentification,
						Transaction14.mmProcessorTransactionIdentification, Transaction14.mmTradeIdentification, Transaction14.mmPoolIdentification, Transaction14.mmCommonIdentification, Transaction14.mmCorporateActionEventIdentification,
						Transaction14.mmTripartyAgentCollateralTransactionIdentification, Transaction14.mmClientTripartyCollateralTransactionIdentification, Transaction14.mmTransactionDetails);
