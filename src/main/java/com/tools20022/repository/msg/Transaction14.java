...
public class Transaction14 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction14.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	public TransactionDetails26 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails26 transactionDetails) {
