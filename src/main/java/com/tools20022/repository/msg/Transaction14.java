...
public class Transaction14 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails26.mmObject();
		}
	};
	...
	public Transaction14 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails26 transactionDetails) {
