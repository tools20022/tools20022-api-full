...
public class SettlementParties14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementParties14.mmDepository, SettlementParties14.mmParty1, SettlementParties14.mmParty2, SettlementParties14.mmParty3, SettlementParties14.mmParty4,
						SettlementParties14.mmParty5);
