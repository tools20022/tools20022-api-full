...
public class ReceiveInformation4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceiveInformation4.mmEffectiveSettlementDate, ReceiveInformation4.mmSettlementAmount, ReceiveInformation4.mmStampDutyIndicator, ReceiveInformation4.mmNetAmount,
						ReceiveInformation4.mmChargeDetails, ReceiveInformation4.mmCommissionDetails, ReceiveInformation4.mmTaxDetails, ReceiveInformation4.mmSettlementPartiesDetails, ReceiveInformation4.mmPhysicalTransferIndicator,
						ReceiveInformation4.mmPhysicalTransferDetails);
