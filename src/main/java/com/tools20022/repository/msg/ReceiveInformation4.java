 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forReceiveInformation4
 * ConstraintPhysicalTransferDetailsRule.forReceiveInformation4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule#forReceiveInformation4
 * ConstraintReceiversCustodianDetailsRule.forReceiveInformation4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule#forReceiveInformation4
 * ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation4}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation8
 * ReceiveInformation8}</li>
 * <li>{@linkplain com.tools20022.repository.msg.ReceiveInformation6
...
@XmlType(name = "ReceiveInformation4", propOrder = {"effectiveSettlementDate", "settlementAmount", "stampDutyIndicator", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "settlementPartiesDetails",
		"physicalTransferIndicator", "physicalTransferDetails"})
public class ReceiveInformation4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation4, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<ReceiveInformation4, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation4.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(ReceiveInformation4 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation4, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<ReceiveInformation4, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(ReceiveInformation4 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation4, YesNoIndicator> mmStampDutyIndicator = new MMMessageAttribute<ReceiveInformation4, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(ReceiveInformation4 obj) {
			return obj.getStampDutyIndicator();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation4, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<ReceiveInformation4, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation4, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<ReceiveInformation4, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(ReceiveInformation4 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation4, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<ReceiveInformation4, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(ReceiveInformation4 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation4, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<ReceiveInformation4, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(ReceiveInformation4 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, List<Tax15> value) {
			obj.setTaxDetails(value);
		}
	};
	@XmlElement(name = "SttlmPtiesDtls", required = true)
	protected ReceivingPartiesAndAccount4 settlementPartiesDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation4, ReceivingPartiesAndAccount4> mmSettlementPartiesDetails = new MMMessageAssociationEnd<ReceiveInformation4, ReceivingPartiesAndAccount4>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> ReceivingPartiesAndAccount4.mmObject();
		}

		@Override
		public ReceivingPartiesAndAccount4 getValue(ReceiveInformation4 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, ReceivingPartiesAndAccount4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReceiveInformation4, YesNoIndicator> mmPhysicalTransferIndicator = new MMMessageAttribute<ReceiveInformation4, YesNoIndicator>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReceiveInformation4, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<ReceiveInformation4, Optional<DeliveryParameters4>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmPhysicalDelivery;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReceiveInformation4.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(ReceiveInformation4 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(ReceiveInformation4 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation4.mmEffectiveSettlementDate, com.tools20022.repository.msg.ReceiveInformation4.mmSettlementAmount,
						com.tools20022.repository.msg.ReceiveInformation4.mmStampDutyIndicator, com.tools20022.repository.msg.ReceiveInformation4.mmNetAmount, com.tools20022.repository.msg.ReceiveInformation4.mmChargeDetails,
						com.tools20022.repository.msg.ReceiveInformation4.mmCommissionDetails, com.tools20022.repository.msg.ReceiveInformation4.mmTaxDetails, com.tools20022.repository.msg.ReceiveInformation4.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.ReceiveInformation4.mmPhysicalTransferIndicator, com.tools20022.repository.msg.ReceiveInformation4.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferOutConfirmationV02.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forReceiveInformation4,
						com.tools20022.repository.constraints.ConstraintReceiversCustodianDetailsRule.forReceiveInformation4, com.tools20022.repository.constraints.ConstraintReceiversIntermediaryDetailsRule.forReceiveInformation4);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ReceiveInformation4";
				...
				nextVersions_lazy = () -> Arrays.asList(ReceiveInformation8.mmObject(), ReceiveInformation6.mmObject());
			}
		});
	...
	public ReceiveInformation4 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public ReceiveInformation4 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public ReceiveInformation4 setStampDutyIndicator(YesNoIndicator stampDutyIndicator) {
	...
	public ReceiveInformation4 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public ReceiveInformation4 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public ReceiveInformation4 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public ReceiveInformation4 setTaxDetails(List<Tax15> taxDetails) {
		this.taxDetails = Objects.requireNonNull(taxDetails);
		return this;
	}

	public ReceivingPartiesAndAccount4 getSettlementPartiesDetails() {
		return settlementPartiesDetails;
	}

	public ReceiveInformation4 setSettlementPartiesDetails(ReceivingPartiesAndAccount4 settlementPartiesDetails) {
	...
	public ReceiveInformation4 setPhysicalTransferIndicator(YesNoIndicator physicalTransferIndicator) {
	...
	public ReceiveInformation4 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
