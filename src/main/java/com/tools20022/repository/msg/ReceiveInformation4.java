...
public class ReceiveInformation4 {
	...
	public static final MMMessageAttribute mmEffectiveSettlementDate = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ReceiveInformation4.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmationV02.mmSettlementDetails);
	...
	public void setSettlementPartiesDetails(com.tools20022.repository.msg.ReceivingPartiesAndAccount4 settlementPartiesDetails) {
