...
public class RateTypeAndAmountAndStatus13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus13.mmRateType, RateTypeAndAmountAndStatus13.mmAmount, RateTypeAndAmountAndStatus13.mmRateStatus);
