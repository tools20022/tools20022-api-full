...
public class RateTypeAndAmountAndStatus13 {
	...
	public static final MMMessageAssociationEnd mmRateType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus28.mmRateType);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus28.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmRateStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus28.mmRateStatus);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public void setRateType(RateType20Choice rateType) {
	...
	public RateStatus1Choice getRateStatus() {
		return rateStatus;
	}

	public void setRateStatus(RateStatus1Choice rateStatus) {
