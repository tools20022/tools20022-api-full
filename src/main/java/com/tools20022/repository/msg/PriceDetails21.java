 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails21
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails21}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails21", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails21 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails21, Optional<PriceFormat12Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails21, Optional<PriceFormat12Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails21.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat12Choice> getValue(PriceDetails21 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails21 obj, Optional<PriceFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails21, Optional<PriceFormat43Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails21, Optional<PriceFormat43Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat43Choice> getValue(PriceDetails21 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails21 obj, Optional<PriceFormat43Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails21.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails21.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails21);
	...
	public PriceDetails21 setGenericCashPricePaidPerProduct(PriceFormat12Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails21 setGenericCashPriceReceivedPerProduct(PriceFormat43Choice genericCashPriceReceivedPerProduct) {
