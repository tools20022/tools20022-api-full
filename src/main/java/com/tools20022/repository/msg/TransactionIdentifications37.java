...
public class TransactionIdentifications37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications37.mmAccountOwnerTransactionIdentification, TransactionIdentifications37.mmAccountServicerTransactionIdentification,
						TransactionIdentifications37.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications37.mmProcessorTransactionIdentification, TransactionIdentifications37.mmOtherIdentification);
