...
public class PartyIdentification20 {
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification20.mmObject();
			isDerived = false;
			xmlTag = "Nm";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification20.mmName, PartyIdentification20.mmPostalAddress, PartyIdentification20.mmIdentification, PartyIdentification20.mmCountryOfResidence);
