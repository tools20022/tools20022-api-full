...
import com.tools20022.repository.msg.NotificationItem5;
import java.util.*;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDebtorRule#forAccountNotification10
 * ConstraintDebtorRule.forAccountNotification10}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalAmountAndAmount1Rule#forAccountNotification10
 * ConstraintTotalAmountAndAmount1Rule.forAccountNotification10}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintExpectedValueDateRule#forAccountNotification10
 * ConstraintExpectedValueDateRule.forAccountNotification10}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintRelatedAccountRule#forAccountNotification10
 * ConstraintRelatedAccountRule.forAccountNotification10}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AccountNotification10", propOrder = {"identification", "account", "accountOwner", "accountServicer", "relatedAccount", "totalAmount", "expectedValueDate", "debtor", "debtorAgent", "intermediaryAgent", "item"})
public class AccountNotification10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountNotification10, Max35Text> mmIdentification = new MMMessageAttribute<AccountNotification10, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmIdentification);
			previousVersion_lazy = () -> AccountNotification6.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(AccountNotification10 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(AccountNotification10 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<CashAccount24>> mmAccount = new MMMessageAssociationEnd<AccountNotification10, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmAccount);
			previousVersion_lazy = () -> AccountNotification6.mmAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccount24> getValue(AccountNotification10 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(AccountNotification10 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<Party12Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountNotification10, Optional<Party12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmAccountOwner);
			previousVersion_lazy = () -> AccountNotification6.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Party12Choice> getValue(AccountNotification10 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountNotification10 obj, Optional<Party12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>> mmAccountServicer = new MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmAccountServicer);
			previousVersion_lazy = () -> AccountNotification6.mmAccountServicer;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(AccountNotification10 obj) {
			return obj.getAccountServicer();
		}

		@Override
		public void setValue(AccountNotification10 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<CashAccount24>> mmRelatedAccount = new MMMessageAssociationEnd<AccountNotification10, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> CashBalance.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmRelatedAccount);
			previousVersion_lazy = () -> AccountNotification6.mmRelatedAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountNotification10, Optional<ActiveOrHistoricCurrencyAndAmount>> mmTotalAmount = new MMMessageAttribute<AccountNotification10, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			xmlTag = "TtlAmt";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmTotalAmount);
			previousVersion_lazy = () -> AccountNotification6.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(AccountNotification10 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(AccountNotification10 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountNotification10, Optional<ISODate>> mmExpectedValueDate = new MMMessageAttribute<AccountNotification10, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmExpectedValueDate);
			previousVersion_lazy = () -> AccountNotification6.mmExpectedValueDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(AccountNotification10 obj) {
			return obj.getExpectedValueDate();
		}

		@Override
		public void setValue(AccountNotification10 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<Party12Choice>> mmDebtor = new MMMessageAssociationEnd<AccountNotification10, Optional<Party12Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmDebtor);
			previousVersion_lazy = () -> AccountNotification6.mmDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Party12Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>> mmDebtorAgent = new MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmDebtorAgent);
			previousVersion_lazy = () -> AccountNotification6.mmDebtorAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent = new MMMessageAssociationEnd<AccountNotification10, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountNotification10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmIntermediaryAgent);
			previousVersion_lazy = () -> AccountNotification6.mmIntermediaryAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	protected List<NotificationItem5> item;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.NotificationItem5
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountNotification10, List<NotificationItem5>> mmItem = new MMMessageAssociationEnd<AccountNotification10, List<NotificationItem5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountNotification13.mmItem);
			previousVersion_lazy = () -> AccountNotification6.mmItem;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<NotificationItem5> getValue(AccountNotification10 obj) {
			return obj.getItem();
		}

		@Override
		public void setValue(AccountNotification10 obj, List<NotificationItem5> value) {
			obj.setItem(value);
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(NotificationToReceiveV04.mmNotification);
				trace_lazy = () -> CashBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDebtorRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintDebtorAgentRule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgentRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintMandatoryDebtorRule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintIntermediaryAgentAndDebtorAgentRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintTotalAmountAndAmount1Rule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintAccountAndCurrencyRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintTotalAmountAndAmount2Rule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintAccountRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintAccountOwnerRule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintAccountServicerRule.forAccountNotification10, com.tools20022.repository.constraints.ConstraintExpectedValueDateRule.forAccountNotification10,
						com.tools20022.repository.constraints.ConstraintRelatedAccountRule.forAccountNotification10);
	...
	public AccountNotification10 setIdentification(Max35Text identification) {
	...
	public AccountNotification10 setAccount(CashAccount24 account) {
	...
	public AccountNotification10 setAccountOwner(Party12Choice accountOwner) {
	...
	public AccountNotification10 setAccountServicer(BranchAndFinancialInstitutionIdentification5 accountServicer) {
	...
	public AccountNotification10 setRelatedAccount(CashAccount24 relatedAccount) {
	...
	public AccountNotification10 setTotalAmount(ActiveOrHistoricCurrencyAndAmount totalAmount) {
	...
	public AccountNotification10 setExpectedValueDate(ISODate expectedValueDate) {
	...
	public AccountNotification10 setDebtor(Party12Choice debtor) {
		this.debtor = debtor;
		return this;
	}
	...
	public AccountNotification10 setDebtorAgent(BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public AccountNotification10 setIntermediaryAgent(BranchAndFinancialInstitutionIdentification5 intermediaryAgent) {
	...
	public AccountNotification10 setItem(List<NotificationItem5> item) {
