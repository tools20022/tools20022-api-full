...
public class TotalCharges4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalCharges4.TotalAmountOfCharges, com.tools20022.repository.msg.TotalCharges4.ChargeDetails);
