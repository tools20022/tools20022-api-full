...
public class CorporateActionRate57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate57.mmAdditionalTax, CorporateActionRate57.mmGrossDividendRate, CorporateActionRate57.mmNetDividendRate, CorporateActionRate57.mmIndexFactor,
						CorporateActionRate57.mmInterestRateUsedForPayment, CorporateActionRate57.mmMaximumAllowedOversubscriptionRate, CorporateActionRate57.mmProrationRate, CorporateActionRate57.mmWithholdingTaxRate,
						CorporateActionRate57.mmWithholdingOfForeignTax, CorporateActionRate57.mmTaxRelatedRate, CorporateActionRate57.mmTaxableIncomePerDividendShare, CorporateActionRate57.mmIssuerDeclaredExchangeRate,
						CorporateActionRate57.mmTaxOnIncome);
