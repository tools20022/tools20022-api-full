...
public class QuantityAndAccount12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount12.mmSettledQuantity, QuantityAndAccount12.mmPreviouslySettledQuantity, QuantityAndAccount12.mmRemainingToBeSettledQuantity,
						QuantityAndAccount12.mmPreviouslySettledAmount, QuantityAndAccount12.mmRemainingToBeSettledAmount, QuantityAndAccount12.mmDenominationChoice, QuantityAndAccount12.mmAccountOwner,
						QuantityAndAccount12.mmSafekeepingAccount, QuantityAndAccount12.mmCashAccount, QuantityAndAccount12.mmQuantityBreakdown, QuantityAndAccount12.mmSafekeepingPlace);
