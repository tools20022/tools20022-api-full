...
public class CardPaymentTransaction36 {
	...
	public static final MMMessageAttribute TransactionCapture = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction36.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.TransactionCapture;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.TransactionCapture);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.TransactionType;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.TransactionType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalService = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.AdditionalService;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.AdditionalService);
			minOccurs = 0;
	...
	public static final MMMessageAttribute ServiceAttribute = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.ServiceAttribute;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.ServiceAttribute);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.MerchantCategoryCode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.MerchantCategoryCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.SaleReferenceIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.SaleReferenceIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.TransactionIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.TransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.OriginalTransaction;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.OriginalTransaction);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute InitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.InitiatorTransactionIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.InitiatorTransactionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.ReconciliationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.ReconciliationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd TransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.TransactionDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.TransactionDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.AdditionalTransactionData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.AdditionalTransactionData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction36.TransactionCapture, com.tools20022.repository.msg.CardPaymentTransaction36.TransactionType,
						com.tools20022.repository.msg.CardPaymentTransaction36.AdditionalService, com.tools20022.repository.msg.CardPaymentTransaction36.ServiceAttribute,
						com.tools20022.repository.msg.CardPaymentTransaction36.MerchantCategoryCode, com.tools20022.repository.msg.CardPaymentTransaction36.SaleReferenceIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction36.TransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction36.OriginalTransaction,
						com.tools20022.repository.msg.CardPaymentTransaction36.InitiatorTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction36.ReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction36.TransactionDetails, com.tools20022.repository.msg.CardPaymentTransaction36.AdditionalTransactionData);
