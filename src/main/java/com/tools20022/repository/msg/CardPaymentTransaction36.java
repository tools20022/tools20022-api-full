...
public class CardPaymentTransaction36 {
	...
	public static final MMMessageAttribute mmTransactionCapture = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmTransactionCapture);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmTransactionCapture;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmTransactionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmTransactionType);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAdditionalService = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmAdditionalService);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmAdditionalService;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmServiceAttribute = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmServiceAttribute);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmServiceAttribute;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmMerchantCategoryCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmMerchantCategoryCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmMerchantCategoryCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSaleReferenceIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmSaleReferenceIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmSaleReferenceIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmTransactionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmOriginalTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmOriginalTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInitiatorTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmInitiatorTransactionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmInitiatorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmReconciliationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmTransactionDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction51.mmAdditionalTransactionData);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction22.mmAdditionalTransactionData;
			minOccurs = 0;
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails19 transactionDetails) {
