...
public class CardPaymentTransaction36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction36.mmTransactionCapture, CardPaymentTransaction36.mmTransactionType, CardPaymentTransaction36.mmAdditionalService, CardPaymentTransaction36.mmServiceAttribute,
						CardPaymentTransaction36.mmMerchantCategoryCode, CardPaymentTransaction36.mmSaleReferenceIdentification, CardPaymentTransaction36.mmTransactionIdentification, CardPaymentTransaction36.mmOriginalTransaction,
						CardPaymentTransaction36.mmInitiatorTransactionIdentification, CardPaymentTransaction36.mmReconciliationIdentification, CardPaymentTransaction36.mmTransactionDetails,
						CardPaymentTransaction36.mmAdditionalTransactionData);
