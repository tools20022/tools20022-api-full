 ...
 * ConstraintCoexistenceIdentificationRule.forPartyIdentificationAndAccount54}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PartyIdentificationAndAccount54", propOrder = {"identification", "cashAccount", "processingIdentification", "additionalInformation", "alternateIdentification"})
public class PartyIdentificationAndAccount54 {
	...
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount54, PartyIdentification42Choice> mmIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount54, PartyIdentification42Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount54, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount54, Optional<CashAccountIdentification5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmCashAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<PartyIdentificationAndAccount54, Optional<Max35Text>> mmProcessingIdentification = new MMMessageAttribute<PartyIdentificationAndAccount54, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmProcessingIdentification);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<PartyIdentificationAndAccount54, Optional<Max350Text>> mmAdditionalInformation = new MMMessageAttribute<PartyIdentificationAndAccount54, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmAdditionalInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount54, Optional<AlternatePartyIdentification2>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount54, Optional<AlternatePartyIdentification2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmAlternateIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount54.mmIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount54.mmCashAccount,
						com.tools20022.repository.msg.PartyIdentificationAndAccount54.mmProcessingIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount54.mmAdditionalInformation,
						com.tools20022.repository.msg.PartyIdentificationAndAccount54.mmAlternateIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalInforrmationRule.forPartyIdentificationAndAccount54,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forPartyIdentificationAndAccount54);
				...
				name = "PartyIdentificationAndAccount54";
				definition = "Provides information about identification and account of the party.";
				nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount101.mmObject());
			}
		});
	...
	public PartyIdentificationAndAccount54 setIdentification(PartyIdentification42Choice identification) {
	...
	public PartyIdentificationAndAccount54 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public PartyIdentificationAndAccount54 setProcessingIdentification(Max35Text processingIdentification) {
	...
	public PartyIdentificationAndAccount54 setAdditionalInformation(Max350Text additionalInformation) {
