...
public class SubAccountIdentification12 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification12.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation10> balanceForSubAccount) {
