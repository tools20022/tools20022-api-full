...
public class SubAccountIdentification12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification12.mmAccountOwner, SubAccountIdentification12.mmSafekeepingAccount, SubAccountIdentification12.mmActivityIndicator,
						SubAccountIdentification12.mmBalanceForSubAccount);
