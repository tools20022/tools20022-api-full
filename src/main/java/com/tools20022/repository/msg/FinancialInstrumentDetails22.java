...
import com.tools20022.repository.msg.IntraPositionDetails37;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrumentDetails22#mmFinancialInstrumentIdentification
 * FinancialInstrumentDetails22.mmFinancialInstrumentIdentification}</li>
 * <li>
...
@XmlType(name = "FinancialInstrumentDetails22", propOrder = {"financialInstrumentIdentification", "financialInstrumentAttributes", "subBalance"})
public class FinancialInstrumentDetails22 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentDetails22, SecurityIdentification20> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentDetails22, SecurityIdentification20>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentDetails22.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
		...
		@Override
		public SecurityIdentification20 getValue(FinancialInstrumentDetails22 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentDetails22 obj, SecurityIdentification20 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentDetails22, Optional<FinancialInstrumentAttributes75>> mmFinancialInstrumentAttributes = new MMMessageAssociationEnd<FinancialInstrumentDetails22, Optional<FinancialInstrumentAttributes75>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentAttributes75> getValue(FinancialInstrumentDetails22 obj) {
			return obj.getFinancialInstrumentAttributes();
		}

		@Override
		public void setValue(FinancialInstrumentDetails22 obj, Optional<FinancialInstrumentAttributes75> value) {
			obj.setFinancialInstrumentAttributes(value.orElse(null));
		}
	};
	@XmlElement(name = "SubBal", required = true)
	protected List<IntraPositionDetails37> subBalance;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.IntraPositionDetails37
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentDetails22, List<IntraPositionDetails37>> mmSubBalance = new MMMessageAssociationEnd<FinancialInstrumentDetails22, List<IntraPositionDetails37>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> IntraPositionDetails37.mmObject();
		}

		@Override
		public List<IntraPositionDetails37> getValue(FinancialInstrumentDetails22 obj) {
			return obj.getSubBalance();
		}

		@Override
		public void setValue(FinancialInstrumentDetails22 obj, List<IntraPositionDetails37> value) {
	...
	public FinancialInstrumentDetails22 setFinancialInstrumentIdentification(SecurityIdentification20 financialInstrumentIdentification) {
	...
	public FinancialInstrumentDetails22 setFinancialInstrumentAttributes(FinancialInstrumentAttributes75 financialInstrumentAttributes) {
		this.financialInstrumentAttributes = financialInstrumentAttributes;
		return this;
	}

	public List<IntraPositionDetails37> getSubBalance() {
		return subBalance == null ? subBalance = new ArrayList<>() : subBalance;
	}

	public FinancialInstrumentDetails22 setSubBalance(List<IntraPositionDetails37> subBalance) {
