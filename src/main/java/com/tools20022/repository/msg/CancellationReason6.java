...
public class CancellationReason6 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancellationReason6.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationReason6.mmCode, CancellationReason6.mmAdditionalReasonInformation);
	...
	public void setCode(CancellationReason13Choice code) {
		this.code = code;
	}
