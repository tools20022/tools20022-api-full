 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.StatementGroup1#GroupIdentification
 * StatementGroup1.GroupIdentification}</li>
 * <li>{@linkplain com.tools20022.repository.msg.StatementGroup1#Sender
 * StatementGroup1.Sender}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.StatementGroup1#SenderIndividualContact
 * StatementGroup1.SenderIndividualContact}</li>
 * <li>{@linkplain com.tools20022.repository.msg.StatementGroup1#Receiver
 * StatementGroup1.Receiver}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.StatementGroup1#ReceiverIndividualContact
 * StatementGroup1.ReceiverIndividualContact}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.StatementGroup1#BillingStatement
 * StatementGroup1.BillingStatement}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementGroup1 {
	...
	public static final MMMessageAttribute GroupIdentification = new MMMessageAttribute() {
		{
			...
			definition = "Identification of a group of customer billing statements.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.GroupIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Sender = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.Sender);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SenderIndividualContact = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.SenderIndividualContact);
			minOccurs = 0;
			maxOccurs = 2;
	...
	public static final MMMessageAssociationEnd Receiver = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.Receiver);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification58.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ReceiverIndividualContact = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.ReceiverIndividualContact);
			minOccurs = 0;
			maxOccurs = 2;
			complexType_lazy = () -> ContactDetails3.mmObject();
		}
	...
	public static final MMMessageAssociationEnd BillingStatement = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup2.BillingStatement);
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatementGroup1.GroupIdentification, com.tools20022.repository.msg.StatementGroup1.Sender,
						com.tools20022.repository.msg.StatementGroup1.SenderIndividualContact, com.tools20022.repository.msg.StatementGroup1.Receiver, com.tools20022.repository.msg.StatementGroup1.ReceiverIndividualContact,
						com.tools20022.repository.msg.StatementGroup1.BillingStatement);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.BankServicesBillingStatementV01.BillingStatementGroup);
