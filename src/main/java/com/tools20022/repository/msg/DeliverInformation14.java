	...
	public static final MMMessageAttribute mmRequestedSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmRequestedSettlementDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmRequestedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmEffectiveSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmEffectiveSettlementDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmEffectiveSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmSettlementAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStampDuty = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmStampDuty);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmStampDuty;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmNetAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmNetAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmNetAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmChargeDetails = new MMMessageAssociationEnd() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmChargeDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmChargeDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmCommissionDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmCommissionDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmCommissionDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTaxDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmTaxDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmTaxDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmForeignExchangeDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmForeignExchangeDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmForeignExchangeDetails;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementPartiesDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmSettlementPartiesDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmSettlementPartiesDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPhysicalTransfer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmPhysicalTransfer);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmPhysicalTransfer;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmPhysicalTransferDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmPhysicalTransferDetails);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmPhysicalTransferDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmClientReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation17.mmClientReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeliverInformation12.mmClientReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferInConfirmationV06.mmSettlementDetails);
