...
public class DeliverInformation14 {
	...
	public static final MMMessageAttribute mmRequestedSettlementDate = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> DeliverInformation14.mmObject();
			isDerived = false;
			xmlTag = "ReqdSttlmDt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation14.mmRequestedSettlementDate, DeliverInformation14.mmEffectiveSettlementDate, DeliverInformation14.mmSettlementAmount, DeliverInformation14.mmStampDuty,
						DeliverInformation14.mmNetAmount, DeliverInformation14.mmChargeDetails, DeliverInformation14.mmCommissionDetails, DeliverInformation14.mmTaxDetails, DeliverInformation14.mmForeignExchangeDetails,
						DeliverInformation14.mmSettlementPartiesDetails, DeliverInformation14.mmPhysicalTransfer, DeliverInformation14.mmPhysicalTransferDetails, DeliverInformation14.mmClientReference);
