...
public class PartyIdentificationAndAccount71 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount71.mmIdentification, PartyIdentificationAndAccount71.mmAlternateIdentification, PartyIdentificationAndAccount71.mmSafekeepingAccount,
						PartyIdentificationAndAccount71.mmProcessingDate, PartyIdentificationAndAccount71.mmProcessingIdentification, PartyIdentificationAndAccount71.mmAdditionalInformation);
