...
import com.tools20022.repository.area.camt.NotificationToReceiveCancellationAdviceV03;
...
@XmlType(name = "OriginalNotification6", propOrder = {"originalMessageIdentification", "originalCreationDateTime", "originalNotificationIdentification", "notificationCancellation", "originalNotificationReference"})
public class OriginalNotification6 {
	...
	public static final MMMessageAttribute<OriginalNotification6, Max35Text> mmOriginalMessageIdentification = new MMMessageAttribute<OriginalNotification6, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalNotification8.mmOriginalMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<OriginalNotification6, Optional<ISODateTime>> mmOriginalCreationDateTime = new MMMessageAttribute<OriginalNotification6, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalNotification8.mmOriginalCreationDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<OriginalNotification6, Max35Text> mmOriginalNotificationIdentification = new MMMessageAttribute<OriginalNotification6, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalNotification8.mmOriginalNotificationIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute<OriginalNotification6, Optional<GroupCancellationIndicator>> mmNotificationCancellation = new MMMessageAttribute<OriginalNotification6, Optional<GroupCancellationIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OriginalNotification8.mmNotificationCancellation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification6.mmOriginalMessageIdentification, com.tools20022.repository.msg.OriginalNotification6.mmOriginalCreationDateTime,
						com.tools20022.repository.msg.OriginalNotification6.mmOriginalNotificationIdentification, com.tools20022.repository.msg.OriginalNotification6.mmNotificationCancellation,
						com.tools20022.repository.msg.OriginalNotification6.mmOriginalNotificationReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(NotificationToReceiveCancellationAdviceV03.mmOriginalNotification);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OriginalNotification6";
				definition = "Identifies the original notification, to which the cancellation advice refers.";
				nextVersions_lazy = () -> Arrays.asList(OriginalNotification8.mmObject());
			}
		});
	...
	public OriginalNotification6 setOriginalMessageIdentification(Max35Text originalMessageIdentification) {
	...
	public OriginalNotification6 setOriginalCreationDateTime(ISODateTime originalCreationDateTime) {
	...
	public OriginalNotification6 setOriginalNotificationIdentification(Max35Text originalNotificationIdentification) {
	...
	public OriginalNotification6 setNotificationCancellation(GroupCancellationIndicator notificationCancellation) {
		this.notificationCancellation = notificationCancellation;
		return this;
	}

	public List<OriginalNotificationReference4> getOriginalNotificationReference() {
