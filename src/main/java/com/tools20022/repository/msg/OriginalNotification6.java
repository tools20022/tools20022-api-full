...
public class OriginalNotification6 {
	...
	public static final MMMessageAttribute OriginalMessageIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification8.OriginalMessageIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalCreationDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification8.OriginalCreationDateTime);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalNotificationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification8.OriginalNotificationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute NotificationCancellation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification8.NotificationCancellation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalNotificationReference = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification8.OriginalNotificationReference);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalNotification6.OriginalMessageIdentification, com.tools20022.repository.msg.OriginalNotification6.OriginalCreationDateTime,
						com.tools20022.repository.msg.OriginalNotification6.OriginalNotificationIdentification, com.tools20022.repository.msg.OriginalNotification6.NotificationCancellation,
						com.tools20022.repository.msg.OriginalNotification6.OriginalNotificationReference);
				trace_lazy = () -> PaymentInstruction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.NotificationToReceiveCancellationAdviceV03.OriginalNotification);
