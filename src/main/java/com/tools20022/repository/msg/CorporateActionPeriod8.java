 ...
 * CorporateActionPeriod8.DepositorySuspensionPeriodForWithdrawalInNomineeName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionPeriod8#DepositorySuspensionPeriodForWithdrawalInStreetName
 * CorporateActionPeriod8.DepositorySuspensionPeriodForWithdrawalInStreetName}</li>
 * <li>
...
public class CorporateActionPeriod8 {
	...
	public static final MMMessageAssociationEnd PriceCalculationPeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.PriceCalculationPeriod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InterestPeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.InterestPeriod);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CompulsoryPurchasePeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.CompulsoryPurchasePeriod);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd BlockingPeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.BlockingPeriod);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ClaimPeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.ClaimPeriod);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForBookEntryTransfer = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForBookEntryTransfer);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForDepositAtAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForDepositAtAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForDeposit = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForDeposit);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForPledge = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForPledge);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForSegregation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForSegregation);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForWithdrawalAtAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForWithdrawalAtAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForWithdrawalInNomineeName = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForWithdrawalInNomineeName);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd DepositorySuspensionPeriodForWithdrawalInStreetName = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.DepositorySuspensionPeriodForWithdrawalInStreetName);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd BookClosurePeriod = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.BookClosurePeriod);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> Period3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute CoDepositoriesSuspensionPeriod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod10.CoDepositoriesSuspensionPeriod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPeriod8.PriceCalculationPeriod, com.tools20022.repository.msg.CorporateActionPeriod8.InterestPeriod,
						com.tools20022.repository.msg.CorporateActionPeriod8.CompulsoryPurchasePeriod, com.tools20022.repository.msg.CorporateActionPeriod8.BlockingPeriod, com.tools20022.repository.msg.CorporateActionPeriod8.ClaimPeriod,
						com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForBookEntryTransfer, com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForDepositAtAgent,
						com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForDeposit, com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForPledge,
						com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForSegregation, com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForWithdrawalAtAgent,
						com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForWithdrawalInNomineeName, com.tools20022.repository.msg.CorporateActionPeriod8.DepositorySuspensionPeriodForWithdrawalInStreetName,
						com.tools20022.repository.msg.CorporateActionPeriod8.BookClosurePeriod, com.tools20022.repository.msg.CorporateActionPeriod8.CoDepositoriesSuspensionPeriod);
