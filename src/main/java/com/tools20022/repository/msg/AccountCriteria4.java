...
public class AccountCriteria4 {
	...
	public static final MMMessageAttribute mmNewQueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AccountCriteria4.mmObject();
			isDerived = false;
			xmlTag = "NewQryNm";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountCriteria4.mmNewQueryName, AccountCriteria4.mmSearchCriteria, AccountCriteria4.mmReturnCriteria);
	...
	public void setSearchCriteria(List<com.tools20022.repository.msg.CashAccountSearchCriteria4> searchCriteria) {
