...
public class AccountCriteria4 {
	...
	protected List<com.tools20022.repository.msg.CashAccountSearchCriteria4> searchCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmSearchCriteria = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccountSearchCriteria4.mmObject();
		}
	};
	...
	public AccountCriteria4 setSearchCriteria(List<com.tools20022.repository.msg.CashAccountSearchCriteria4> searchCriteria) {
	...
	public AccountCriteria4 setReturnCriteria(com.tools20022.repository.msg.CashAccountReturnCriteria2 returnCriteria) {
