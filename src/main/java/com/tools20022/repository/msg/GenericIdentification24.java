...
public class GenericIdentification24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification24.mmIdentification, GenericIdentification24.mmIssuer, GenericIdentification24.mmSchemeName);
	...
	public void setIdentification(RestrictedFINXMax34Text identification) {
