...
public class GenericIdentification24 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> GenericIdentification24.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification24.Identification, com.tools20022.repository.msg.GenericIdentification24.Issuer,
						com.tools20022.repository.msg.GenericIdentification24.SchemeName);
