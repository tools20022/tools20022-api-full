...
public class SettlementDetails5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails5.mmHoldIndicator, SettlementDetails5.mmPriority, SettlementDetails5.mmSecuritiesTransactionType, SettlementDetails5.mmSettlementTransactionCondition,
						SettlementDetails5.mmPartialSettlementIndicator, SettlementDetails5.mmBeneficialOwnership, SettlementDetails5.mmCCPEligibility, SettlementDetails5.mmCashClearingSystem, SettlementDetails5.mmMarketClientSide,
						SettlementDetails5.mmNettingEligibility, SettlementDetails5.mmRegistration, SettlementDetails5.mmRepurchaseType, SettlementDetails5.mmLegalRestrictions, SettlementDetails5.mmSecuritiesRTGS,
						SettlementDetails5.mmSettlingCapacity, SettlementDetails5.mmSettlementSystemMethod, SettlementDetails5.mmTaxCapacity, SettlementDetails5.mmStampDutyTaxBasis, SettlementDetails5.mmLetterOfGuarantee);
