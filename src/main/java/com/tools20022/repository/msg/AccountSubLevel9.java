 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.AccountSubLevel9#mmAccountOwner
 * AccountSubLevel9.mmAccountOwner}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AccountSubLevel9#mmAccountServicer
 * AccountSubLevel9.mmAccountServicer}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.AccountSubLevel9#mmSupplementaryData
 * AccountSubLevel9.mmSupplementaryData}</li>
 * </ul>
 * </li>
...
public class AccountSubLevel9 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AccountSubLevel9
	 * AccountSubLevel9}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel9, SecuritiesAccount19> mmAccountIdentification = new MMMessageAssociationEnd<AccountSubLevel9, SecuritiesAccount19>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel9.mmObject();
			isDerived = false;
			xmlTag = "AcctId";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmAccountIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount19 getValue(AccountSubLevel9 obj) {
			return obj.getAccountIdentification();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, SecuritiesAccount19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountSubLevel9, PartyIdentification100> mmAccountOwner = new MMMessageAttribute<AccountSubLevel9, PartyIdentification100>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PartyIdentification100 getValue(AccountSubLevel9 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, PartyIdentification100 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountSubLevel9, PartyIdentification100> mmAccountServicer = new MMMessageAttribute<AccountSubLevel9, PartyIdentification100>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmAccountServicer);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> PartyIdentification100.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel9, List<BeneficialOwner2>> mmBeneficialOwner = new MMMessageAssociationEnd<AccountSubLevel9, List<BeneficialOwner2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmBeneficialOwner);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<BeneficialOwner2> getValue(AccountSubLevel9 obj) {
			return obj.getBeneficialOwner();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, List<BeneficialOwner2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel9, List<AggregateHoldingBalance1>> mmBalanceForAccount = new MMMessageAssociationEnd<AccountSubLevel9, List<AggregateHoldingBalance1>>() {
		{
		...
		@Override
		public List<AggregateHoldingBalance1> getValue(AccountSubLevel9 obj) {
			return obj.getBalanceForAccount();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, List<AggregateHoldingBalance1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel9, List<Intermediary29>> mmAgent = new MMMessageAssociationEnd<AccountSubLevel9, List<Intermediary29>>() {
		{
		...
		@Override
		public List<Intermediary29> getValue(AccountSubLevel9 obj) {
			return obj.getAgent();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, List<Intermediary29> value) {
			obj.setAgent(value);
		}
	};
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountSubLevel19#mmSupplementaryData
	 * AccountSubLevel19.mmSupplementaryData}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountSubLevel9, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAssociationEnd<AccountSubLevel9, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AccountSubLevel9.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmSupplementaryData);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SupplementaryData1> getValue(AccountSubLevel9 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(AccountSubLevel9 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel9.mmAccountIdentification, com.tools20022.repository.msg.AccountSubLevel9.mmAccountOwner,
						com.tools20022.repository.msg.AccountSubLevel9.mmAccountServicer, com.tools20022.repository.msg.AccountSubLevel9.mmBeneficialOwner, com.tools20022.repository.msg.AccountSubLevel9.mmBalanceForAccount,
						com.tools20022.repository.msg.AccountSubLevel9.mmAgent, com.tools20022.repository.msg.AccountSubLevel9.mmSupplementaryData);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountSubLevel9";
				definition = "Account and holding of the next sub-level (Level 9).";
				nextVersions_lazy = () -> Arrays.asList(AccountSubLevel19.mmObject());
			}
		});
	...
	public AccountSubLevel9 setAccountIdentification(SecuritiesAccount19 accountIdentification) {
	...
	public AccountSubLevel9 setAccountOwner(PartyIdentification100 accountOwner) {
	...
	public AccountSubLevel9 setAccountServicer(PartyIdentification100 accountServicer) {
	...
	public AccountSubLevel9 setBeneficialOwner(List<BeneficialOwner2> beneficialOwner) {
	...
	public AccountSubLevel9 setBalanceForAccount(List<AggregateHoldingBalance1> balanceForAccount) {
	...
	public AccountSubLevel9 setAgent(List<Intermediary29> agent) {
	...
	public AccountSubLevel9 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
