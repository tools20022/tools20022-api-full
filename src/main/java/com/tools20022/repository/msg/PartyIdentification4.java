...
public class PartyIdentification4 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentification4.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification4.mmIdentification, PartyIdentification4.mmAlternateIdentification, PartyIdentification4.mmProcessingDate, PartyIdentification4.mmProcessingIdentification,
						PartyIdentification4.mmAdditionalInformation);
