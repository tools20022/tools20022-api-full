...
public class PaymentReturnReason4 {
	...
	public static final MMMessageAssociationEnd mmOriginator = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentReturnReason1.mmOriginator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentReturnReason1#mmReason
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PaymentReturnReason1.mmReason;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PaymentReturnReason1.mmAdditionalInformation;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> PaymentReturnReason1.mmObject();
			}
		});
	...
	public PaymentReturnReason4 setOriginator(com.tools20022.repository.msg.PartyIdentification125 originator) {
