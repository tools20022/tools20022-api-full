 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.seev.CorporateActionInstructionCancellationRequestV03#CorporateActionInstruction
 * CorporateActionInstructionCancellationRequestV03.CorporateActionInstruction}</li>
 * <li>
...
public class CorporateActionOption42 {
	...
	public static final MMMessageAssociationEnd OptionNumber = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption120.OptionNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OptionType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption120.OptionType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionOption42.OptionNumber, com.tools20022.repository.msg.CorporateActionOption42.OptionType,
						com.tools20022.repository.msg.CorporateActionOption42.InstructedOrQuantityToReceive);
				trace_lazy = () -> CorporateActionOption.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstructionCancellationRequestV03.CorporateActionInstruction,
						com.tools20022.repository.area.seev.CorporateActionInstructionCancellationRequestV04.CorporateActionInstruction,
						com.tools20022.repository.area.seev.CorporateActionInstructionCancellationRequestV05.CorporateActionInstruction);
