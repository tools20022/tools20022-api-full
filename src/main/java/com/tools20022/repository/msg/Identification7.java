...
public class Identification7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification7.mmAccountOwnerTransactionIdentification, Identification7.mmAccountServicerTransactionIdentification, Identification7.mmMarketInfrastructureTransactionIdentification,
						Identification7.mmProcessorTransactionIdentification, Identification7.mmCommonIdentification, Identification7.mmTradeIdentification, Identification7.mmMasterIdentification, Identification7.mmBasketIdentification,
						Identification7.mmIndexIdentification, Identification7.mmListIdentification, Identification7.mmProgramIdentification, Identification7.mmPoolIdentification, Identification7.mmCorporateActionEventIdentification);
