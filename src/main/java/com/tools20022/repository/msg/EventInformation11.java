...
public class EventInformation11 {
	...
	public static final MMMessageAssociationEnd mmLastNotificationIdentification = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.NotificationIdentification5.mmObject();
		}
	};
	...
	public EventInformation11 setLastNotificationIdentification(com.tools20022.repository.msg.NotificationIdentification5 lastNotificationIdentification) {
