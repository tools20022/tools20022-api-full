...
public class PaymentTransaction17 {
	...
	public static final MMMessageAttribute mmSettlementAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PaymentTransaction17.mmObject();
			isDerived = false;
			xmlTag = "SttlmAmt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction17.mmSettlementAmount, PaymentTransaction17.mmSettlementDate, PaymentTransaction17.mmPaymentInstrument);
	...
	public PaymentInstrument9Choice getPaymentInstrument() {
		return paymentInstrument;
	}

	public void setPaymentInstrument(PaymentInstrument9Choice paymentInstrument) {
