...
import com.tools20022.repository.choice.RejectionAndRepairReason23Choice;
...
public class RejectionOrRepairReason23 {
	...
	@XmlElement(name = "Cd")
	protected List<RejectionAndRepairReason23Choice> code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RejectionOrRepairReason23
	 * RejectionOrRepairReason23}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionOrRepairReason23, List<RejectionAndRepairReason23Choice>> mmCode = new MMMessageAssociationEnd<RejectionOrRepairReason23, List<RejectionAndRepairReason23Choice>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionOrRepairReason23.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> RejectionOrRepairReason14.mmCode;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RejectionAndRepairReason23Choice.mmObject();
		}

		@Override
		public List<RejectionAndRepairReason23Choice> getValue(RejectionOrRepairReason23 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionOrRepairReason23 obj, List<RejectionAndRepairReason23Choice> value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionOrRepairReason23, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionOrRepairReason23, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairReason14.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(RejectionOrRepairReason23 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionOrRepairReason23 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason23.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason23.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairReason23";
				definition = "Reason for the rejection or repair status.";
				previousVersion_lazy = () -> RejectionOrRepairReason14.mmObject();
			}
		});
	...
	public RejectionOrRepairReason23 setCode(List<RejectionAndRepairReason23Choice> code) {
	...
	public RejectionOrRepairReason23 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
