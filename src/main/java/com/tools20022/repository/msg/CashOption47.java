...
public class CashOption47 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption47.mmCreditDebitIndicator, CashOption47.mmContractualPaymentIndicator, CashOption47.mmNonEligibleProceedsIndicator, CashOption47.mmIssuerOfferorTaxabilityIndicator,
						CashOption47.mmIncomeType, CashOption47.mmExemptionType, CashOption47.mmCountryOfIncomeSource, CashOption47.mmCashAccountIdentification, CashOption47.mmAmountDetails, CashOption47.mmDateDetails,
						CashOption47.mmForeignExchangeDetails, CashOption47.mmRateAndAmountDetails, CashOption47.mmPriceDetails);
