 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Statement43
 * Statement43}</li>
 * </ul>
 */
...
public class Statement60 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement43#mmReportNumber
	...
	public static final MMMessageAttribute mmReportNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmReportNumber;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmQueryReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmStatementIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmStatementIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmStatementPeriod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmStatementPeriod;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement43#mmFrequency
	...
	public static final MMMessageAttribute mmFrequency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmFrequency;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement43#mmUpdateType
	...
	public static final MMMessageAssociationEnd mmUpdateType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmUpdateType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmActivityIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Statement43.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> Statement43.mmObject();
			}
		});
