...
public class Transaction6 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails6.mmObject();
		}
	};
	...
	public Transaction6 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails6 transactionDetails) {
	...
	public Transaction6 setExtension(List<com.tools20022.repository.msg.Extension2> extension) {
