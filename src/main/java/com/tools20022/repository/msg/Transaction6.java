...
import com.tools20022.repository.msg.TransactionDetails6;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transaction6#mmExtension
 * Transaction6.mmExtension}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction6
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction6
 * ConstraintCoexistenceIdentificationRule.forTransaction6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction6", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "tradeIdentification", "poolIdentification",
...
public class Transaction6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction6, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction6.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public Max35Text getValue(Transaction6 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction6 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(Transaction6 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction6 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<Transaction6, List<Max35Text>>() {
		{
		...
		@Override
		public List<Max35Text> getValue(Transaction6 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction6 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction6, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction6, Optional<Max35Text>>() {
		{
	...
	protected TransactionDetails6 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails6
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction6, Optional<TransactionDetails6>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction6, Optional<TransactionDetails6>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails6.mmObject();
		}

		@Override
		public Optional<TransactionDetails6> getValue(Transaction6 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction6 obj, Optional<TransactionDetails6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction6, List<Extension2>> mmExtension = new MMMessageAssociationEnd<Transaction6, List<Extension2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction6.mmObject();
			isDerived = false;
			xmlTag = "Xtnsn";
		...
		@Override
		public List<Extension2> getValue(Transaction6 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(Transaction6 obj, List<Extension2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction6.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction6.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction6.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction6.mmTradeIdentification,
						com.tools20022.repository.msg.Transaction6.mmPoolIdentification, com.tools20022.repository.msg.Transaction6.mmCommonIdentification, com.tools20022.repository.msg.Transaction6.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.Transaction6.mmTripartyAgentCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction6.mmClientTripartyCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction6.mmTransactionDetails, com.tools20022.repository.msg.Transaction6.mmExtension);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction6,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction6);
	...
	public Transaction6 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public Transaction6 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public Transaction6 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction6 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public Transaction6 setPoolIdentification(Max35Text poolIdentification) {
	...
	public Transaction6 setCommonIdentification(Max35Text commonIdentification) {
	...
	public Transaction6 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public Transaction6 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction6 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails6> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction6 setTransactionDetails(TransactionDetails6 transactionDetails) {
	...
	public Transaction6 setExtension(List<Extension2> extension) {
