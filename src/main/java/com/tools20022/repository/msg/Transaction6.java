...
public class Transaction6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction6.mmAccountOwnerTransactionIdentification, Transaction6.mmAccountServicerTransactionIdentification, Transaction6.mmMarketInfrastructureTransactionIdentification,
						Transaction6.mmTradeIdentification, Transaction6.mmPoolIdentification, Transaction6.mmCommonIdentification, Transaction6.mmCorporateActionEventIdentification,
						Transaction6.mmTripartyAgentCollateralTransactionIdentification, Transaction6.mmClientTripartyCollateralTransactionIdentification, Transaction6.mmTransactionDetails, Transaction6.mmExtension);
