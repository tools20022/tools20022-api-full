...
public class CardEntry2 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardEntry1#Card
	 * CardEntry1.Card}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Card = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardEntry1.Card;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardEntry1#POI CardEntry1.POI}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd POI = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardEntry1.POI;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CardEntry1#AggregatedEntry
	...
	public static final MMMessageAssociationEnd AggregatedEntry = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardEntry1.AggregatedEntry;
			minOccurs = 0;
			maxOccurs = 1;
