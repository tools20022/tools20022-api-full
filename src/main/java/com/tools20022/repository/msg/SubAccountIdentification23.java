...
public class SubAccountIdentification23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification23.mmAccountOwner, SubAccountIdentification23.mmSafekeepingAccount, SubAccountIdentification23.mmActivityIndicator,
						SubAccountIdentification23.mmBalanceForSubAccount);
