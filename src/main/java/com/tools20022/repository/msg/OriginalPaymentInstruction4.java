...
@XmlType(name = "OriginalPaymentInstruction4", propOrder = {"paymentCancellationIdentification", "case", "originalPaymentInformationIdentification", "originalGroupInformation", "numberOfTransactions", "controlSum",
...
public class OriginalPaymentInstruction4 {
	...
	public void setTransactionInformation(List<com.tools20022.repository.msg.PaymentTransaction37> transactionInformation) {
