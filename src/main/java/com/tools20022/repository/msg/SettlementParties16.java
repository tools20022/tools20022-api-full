...
public class SettlementParties16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementParties16.mmDepository, SettlementParties16.mmParty1, SettlementParties16.mmParty2, SettlementParties16.mmParty3);
