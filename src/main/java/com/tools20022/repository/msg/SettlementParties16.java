 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SettlementParties16#mmDepository
 * SettlementParties16.mmDepository}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties16#mmParty1
 * SettlementParties16.mmParty1}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties16#mmParty2
 * SettlementParties16.mmParty2}</li>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementParties16#mmParty3
 * SettlementParties16.mmParty3}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintParty2PresenceRule#forSettlementParties16
 * ConstraintParty2PresenceRule.forSettlementParties16}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintParty3PresenceRule#forSettlementParties16
 * ConstraintParty3PresenceRule.forSettlementParties16}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SettlementParties16", propOrder = {"depository", "party1", "party2", "party3"})
public class SettlementParties16 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties16, PartyIdentification49> mmDepository = new MMMessageAssociationEnd<SettlementParties16, PartyIdentification49>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties16.mmObject();
			isDerived = false;
			xmlTag = "Dpstry";
		...
		@Override
		public PartyIdentification49 getValue(SettlementParties16 obj) {
			return obj.getDepository();
		}

		@Override
		public void setValue(SettlementParties16 obj, PartyIdentification49 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties16, PartyIdentificationAndAccount56> mmParty1 = new MMMessageAssociationEnd<SettlementParties16, PartyIdentificationAndAccount56>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties16.mmObject();
			isDerived = false;
		...
		@Override
		public PartyIdentificationAndAccount56 getValue(SettlementParties16 obj) {
			return obj.getParty1();
		}

		@Override
		public void setValue(SettlementParties16 obj, PartyIdentificationAndAccount56 value) {
			obj.setParty1(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties16, Optional<PartyIdentificationAndAccount56>> mmParty2 = new MMMessageAssociationEnd<SettlementParties16, Optional<PartyIdentificationAndAccount56>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties16.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PartyIdentificationAndAccount56> getValue(SettlementParties16 obj) {
			return obj.getParty2();
		}

		@Override
		public void setValue(SettlementParties16 obj, Optional<PartyIdentificationAndAccount56> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementParties16, Optional<PartyIdentificationAndAccount56>> mmParty3 = new MMMessageAssociationEnd<SettlementParties16, Optional<PartyIdentificationAndAccount56>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementParties16.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementParties16.mmDepository, com.tools20022.repository.msg.SettlementParties16.mmParty1,
						com.tools20022.repository.msg.SettlementParties16.mmParty2, com.tools20022.repository.msg.SettlementParties16.mmParty3);
				trace_lazy = () -> SecuritiesSettlementPartyRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintParty2PresenceRule.forSettlementParties16, com.tools20022.repository.constraints.ConstraintParty3PresenceRule.forSettlementParties16);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementParties16";
	...
	public SettlementParties16 setDepository(PartyIdentification49 depository) {
	...
	public SettlementParties16 setParty1(PartyIdentificationAndAccount56 party1) {
	...
	public SettlementParties16 setParty2(PartyIdentificationAndAccount56 party2) {
		this.party2 = party2;
		return this;
	}
	...
	public SettlementParties16 setParty3(PartyIdentificationAndAccount56 party3) {
		this.party3 = party3;
		return this;
	}
}