...
public class SecurityDate7 {
	...
	public static final MMMessageAssociationEnd mmPostingDate = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecurityDate7.mmObject();
			isDerived = false;
			xmlTag = "PstngDt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecurityDate7.mmPostingDate, SecurityDate7.mmAvailableDate, SecurityDate7.mmPariPassuDate, SecurityDate7.mmDividendRankingDate, SecurityDate7.mmEarliestPaymentDate,
						SecurityDate7.mmPaymentDate);
