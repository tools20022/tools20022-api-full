 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentCard5#ProtectedCardData
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentCard5#CardCountryCode
...
public class PaymentCard5 {
	...
	public static final MMMessageAssociationEnd ProtectedCardData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.ProtectedCardData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PlainCardData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.PlainCardData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardCountryCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.CardCountryCode);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardProductProfile = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.CardProductProfile);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardBrand = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.CardBrand);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalCardData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard7.AdditionalCardData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentCard5.ProtectedCardData, com.tools20022.repository.msg.PaymentCard5.PlainCardData, com.tools20022.repository.msg.PaymentCard5.CardCountryCode,
						com.tools20022.repository.msg.PaymentCard5.CardProductProfile, com.tools20022.repository.msg.PaymentCard5.CardBrand, com.tools20022.repository.msg.PaymentCard5.AdditionalCardData);
