 ...
 * definition} = "Transfer cancellation status is in pending."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "TransferCancellationPendingStatus1", propOrder = "reason")
public class TransferCancellationPendingStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferCancellationPendingStatus1.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransferCancellationPendingStatus1";
				definition = "Transfer cancellation status is in pending.";
			}
		});
	...
	public TransferCancellationPendingStatus1 setReason(Max350Text reason) {
		this.reason = reason;
		return this;
	}
}