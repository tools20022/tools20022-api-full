...
public class Header28 {
	...
	public static final MMMessageAttribute mmDownloadTransfer = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Header28.mmObject();
			isDerived = false;
			xmlTag = "DwnldTrf";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Header28.mmDownloadTransfer, Header28.mmFormatVersion, Header28.mmExchangeIdentification, Header28.mmCreationDateTime, Header28.mmInitiatingParty, Header28.mmRecipientParty);
