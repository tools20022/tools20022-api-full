...
import com.tools20022.repository.msg.PaymentContext9;
...
@XmlType(name = "CardPaymentContext9", propOrder = {"paymentContext", "saleContext"})
public class CardPaymentContext9 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "PmtCntxt", required = true)
	protected PaymentContext9 paymentContext;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.PaymentContext9
	 * PaymentContext9}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext9, PaymentContext9> mmPaymentContext = new MMMessageAssociationEnd<CardPaymentContext9, PaymentContext9>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext9.mmObject();
			isDerived = false;
			xmlTag = "PmtCntxt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PaymentContext";
			definition = "Context of the card payment transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext15.mmPaymentContext);
			previousVersion_lazy = () -> CardPaymentContext6.mmPaymentContext;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PaymentContext9.mmObject();
		}

		@Override
		public PaymentContext9 getValue(CardPaymentContext9 obj) {
			return obj.getPaymentContext();
		}

		@Override
		public void setValue(CardPaymentContext9 obj, PaymentContext9 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext9, Optional<SaleContext1>> mmSaleContext = new MMMessageAssociationEnd<CardPaymentContext9, Optional<SaleContext1>>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext15.mmSaleContext);
			previousVersion_lazy = () -> CardPaymentContext6.mmSaleContext;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SaleContext1> getValue(CardPaymentContext9 obj) {
			return obj.getSaleContext();
		}

		@Override
		public void setValue(CardPaymentContext9 obj, Optional<SaleContext1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext9.mmPaymentContext, com.tools20022.repository.msg.CardPaymentContext9.mmSaleContext);
				trace_lazy = () -> CardPaymentAcquiring.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentContext9";
				definition = "Context in which the transaction is performed (payment and sale).";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentContext15.mmObject());
				previousVersion_lazy = () -> CardPaymentContext6.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public PaymentContext9 getPaymentContext() {
		return paymentContext;
	}

	public CardPaymentContext9 setPaymentContext(PaymentContext9 paymentContext) {
	...
	public CardPaymentContext9 setSaleContext(SaleContext1 saleContext) {
