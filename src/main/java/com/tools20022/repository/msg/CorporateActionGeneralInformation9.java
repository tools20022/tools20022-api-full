 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintEventTypeRule#forCorporateActionGeneralInformation9
 * ConstraintEventTypeRule.forCorporateActionGeneralInformation9}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forCorporateActionGeneralInformation9
 * ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation9
 * }</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation9", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "classActionNumber", "eventType"})
public class CorporateActionGeneralInformation9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation9, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation9, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation9.mmObject();
			isDerived = false;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation9 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation9 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation9, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation9, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation9 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation9 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation9, Optional<Max35Text>> mmClassActionNumber = new MMMessageAttribute<CorporateActionGeneralInformation9, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation9, CorporateActionEventType3Choice> mmEventType = new MMMessageAttribute<CorporateActionGeneralInformation9, CorporateActionEventType3Choice>() {
		{
		...
		@Override
		public CorporateActionEventType3Choice getValue(CorporateActionGeneralInformation9 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation9 obj, CorporateActionEventType3Choice value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation9.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation9.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation9.mmClassActionNumber,
						com.tools20022.repository.msg.CorporateActionGeneralInformation9.mmEventType);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionEventProcessingStatusAdviceV01.mmCorporateActionGeneralInformation, CorporateActionEventProcessingStatusAdviceV02.mmCorporateActionGeneralInformation,
						CorporateActionInstructionCancellationRequestStatusAdviceV01.mmCorporateActionGeneralInformation, CorporateActionInstructionCancellationRequestStatusAdviceV02.mmCorporateActionGeneralInformation,
						CorporateActionInstructionStatusAdviceV01.mmCorporateActionGeneralInformation, CorporateActionInstructionStatusAdviceV02.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation9,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionGeneralInformation9);
				...
				name = "CorporateActionGeneralInformation9";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation34.mmObject());
			}
		});
	...
	public CorporateActionGeneralInformation9 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation9 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation9 setClassActionNumber(Max35Text classActionNumber) {
	...
	public CorporateActionGeneralInformation9 setEventType(CorporateActionEventType3Choice eventType) {
