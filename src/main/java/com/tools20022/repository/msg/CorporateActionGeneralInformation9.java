...
public class CorporateActionGeneralInformation9 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation9.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation9.mmCorporateActionEventIdentification, CorporateActionGeneralInformation9.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation9.mmClassActionNumber, CorporateActionGeneralInformation9.mmEventType);
