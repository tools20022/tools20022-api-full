...
public class TerminalManagementDataSet1 {
	...
	public static final MMMessageAssociationEnd mmContent = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.StatusReportContent1.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TerminalManagementDataSet1.mmIdentification, TerminalManagementDataSet1.mmSequenceCounter, TerminalManagementDataSet1.mmContent);
	...
	public void setContent(com.tools20022.repository.msg.StatusReportContent1 content) {
