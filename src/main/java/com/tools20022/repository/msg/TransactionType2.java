 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.TransactionType1 TransactionType1}</li>
 * </ul>
 */
...
public class TransactionType2 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TransactionType1#mmStatus
	...
	public static final MMMessageAttribute mmStatus = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TransactionType1.mmStatus;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TransactionType1.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmFloorLimit = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TransactionType1.mmFloorLimit;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> TransactionType1.mmObject();
			}
		});
	...
	public TransactionType2 setFloorLimit(List<com.tools20022.repository.msg.Limit2> floorLimit) {
