...
public class SubAccountIdentification17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification17.mmAccountOwner, SubAccountIdentification17.mmSafekeepingAccount, SubAccountIdentification17.mmActivityIndicator,
						SubAccountIdentification17.mmBalanceForSubAccount);
