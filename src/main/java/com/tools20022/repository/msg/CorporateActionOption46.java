...
public class CorporateActionOption46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption46.mmOptionNumber, CorporateActionOption46.mmOptionType, CorporateActionOption46.mmOptionFeatures, CorporateActionOption46.mmFractionDisposition,
						CorporateActionOption46.mmCurrencyOption, CorporateActionOption46.mmDateDetails, CorporateActionOption46.mmPeriodDetails, CorporateActionOption46.mmRateAndAmountDetails, CorporateActionOption46.mmPriceDetails,
						CorporateActionOption46.mmPlaceOfTrade, CorporateActionOption46.mmSecuritiesMovementDetails, CorporateActionOption46.mmCashMovementDetails);
