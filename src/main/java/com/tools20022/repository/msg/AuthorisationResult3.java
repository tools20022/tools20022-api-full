...
public class AuthorisationResult3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AuthorisationResult3.mmAuthorisationEntity, AuthorisationResult3.mmResponseToAuthorisation, AuthorisationResult3.mmAuthorisationCode, AuthorisationResult3.mmTMSTrigger);
