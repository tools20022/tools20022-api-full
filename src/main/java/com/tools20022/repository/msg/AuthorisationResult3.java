...
public class AuthorisationResult3 {
	...
	public static final MMMessageAssociationEnd AuthorisationEntity = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> AuthorisationResult3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult6.AuthorisationEntity);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ResponseToAuthorisation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult6.ResponseToAuthorisation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AuthorisationCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult6.AuthorisationCode);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TMSTrigger = new MMMessageAttribute() {
		{
			...
			name = "TMSTrigger";
			definition = "Acquirer has requested a contact to the maintenance host.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult6.TMSTrigger);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AuthorisationResult3.AuthorisationEntity, com.tools20022.repository.msg.AuthorisationResult3.ResponseToAuthorisation,
						com.tools20022.repository.msg.AuthorisationResult3.AuthorisationCode, com.tools20022.repository.msg.AuthorisationResult3.TMSTrigger);
