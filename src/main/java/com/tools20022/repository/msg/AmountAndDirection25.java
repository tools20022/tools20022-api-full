 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection25#mmAmount
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndDirection25
 * ConstraintCoexistenceAmountRule.forAmountAndDirection25}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AmountAndDirection25", propOrder = {"amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails", "valueDate"})
public class AmountAndDirection25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection25, RestrictedFINActiveCurrencyAndAmount> mmAmount = new MMMessageAttribute<AmountAndDirection25, RestrictedFINActiveCurrencyAndAmount>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection25.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAndAmount getValue(AmountAndDirection25 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection25 obj, RestrictedFINActiveCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection25, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection25, CreditDebitCode>() {
		{
		...
		@Override
		public CreditDebitCode getValue(AmountAndDirection25 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection25 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection25, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection25, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection25 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection25 obj, Optional<RestrictedFINActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection25, Optional<ForeignExchangeTerms12>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection25, Optional<ForeignExchangeTerms12>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms12> getValue(AmountAndDirection25 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection25 obj, Optional<ForeignExchangeTerms12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection25, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAssociationEnd<AmountAndDirection25, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(AmountAndDirection25 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(AmountAndDirection25 obj, Optional<DateAndDateTimeChoice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection25.mmAmount, com.tools20022.repository.msg.AmountAndDirection25.mmCreditDebitIndicator,
						com.tools20022.repository.msg.AmountAndDirection25.mmOriginalCurrencyAndOrderedAmount, com.tools20022.repository.msg.AmountAndDirection25.mmForeignExchangeDetails,
						com.tools20022.repository.msg.AmountAndDirection25.mmValueDate);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection25);
	...
	public AmountAndDirection25 setAmount(RestrictedFINActiveCurrencyAndAmount amount) {
	...
	public AmountAndDirection25 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection25 setOriginalCurrencyAndOrderedAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection25 setForeignExchangeDetails(ForeignExchangeTerms12 foreignExchangeDetails) {
	...
	public AmountAndDirection25 setValueDate(DateAndDateTimeChoice valueDate) {
