...
public class PartyIdentificationAndAccount58 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount58.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount58.mmIdentification, PartyIdentificationAndAccount58.mmCashAccount, PartyIdentificationAndAccount58.mmProcessingIdentification,
						PartyIdentificationAndAccount58.mmAdditionalInformation, PartyIdentificationAndAccount58.mmAlternateIdentification);
