...
public class TransactionDetails28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails28.mmFinancialInstrumentIdentification, TransactionDetails28.mmTradeDate, TransactionDetails28.mmSettlementDate, TransactionDetails28.mmSettlementQuantity,
						TransactionDetails28.mmSettlementAmount, TransactionDetails28.mmDeliveringSettlementParties, TransactionDetails28.mmReceivingSettlementParties, TransactionDetails28.mmInvestor);
