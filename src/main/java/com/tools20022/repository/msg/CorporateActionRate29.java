 ...
 * CorporateActionRate29.AdditionalQuantityForSubscribedResultantSecurities}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionRate29#NewToOld
...
public class CorporateActionRate29 {
	...
	public static final MMMessageAssociationEnd AdditionalQuantityForSubscribedResultantSecurities = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.AdditionalQuantityForSubscribedResultantSecurities);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AdditionalQuantityForExistingSecurities = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.AdditionalQuantityForExistingSecurities);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> RatioFormat3Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd NewToOld = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.NewToOld);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ChargesFees = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.ChargesFees);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FiscalStamp = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.FiscalStamp);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ApplicableRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.ApplicableRate);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	...
	public static final MMMessageAttribute TaxCreditRate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate49.TaxCreditRate);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate29.AdditionalQuantityForSubscribedResultantSecurities,
						com.tools20022.repository.msg.CorporateActionRate29.AdditionalQuantityForExistingSecurities, com.tools20022.repository.msg.CorporateActionRate29.NewToOld,
						com.tools20022.repository.msg.CorporateActionRate29.ChargesFees, com.tools20022.repository.msg.CorporateActionRate29.FiscalStamp, com.tools20022.repository.msg.CorporateActionRate29.ApplicableRate,
						com.tools20022.repository.msg.CorporateActionRate29.TaxCreditRate);
