...
@XmlType(name = "FinancialInstrumentAttributes67", propOrder = {"financialInstrumentIdentification", "placeOfListing", "dayCountBasis", "classificationType", "optionStyle", "denominationCurrency", "nextCouponDate",
...
public class FinancialInstrumentAttributes67 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, SecurityIdentification19>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<MarketIdentification3Choice>> mmPlaceOfListing = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<MarketIdentification3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmPlaceOfListing);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmPlaceOfListing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification3Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getPlaceOfListing();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<MarketIdentification3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<InterestComputationMethodFormat4Choice>> mmDayCountBasis = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<InterestComputationMethodFormat4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmDayCountBasis);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmDayCountBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InterestComputationMethodFormat4Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getDayCountBasis();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<InterestComputationMethodFormat4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<ClassificationType32Choice>> mmClassificationType = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<ClassificationType32Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmClassificationType);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmClassificationType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ClassificationType32Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getClassificationType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<ClassificationType32Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<OptionStyle8Choice>> mmOptionStyle = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<OptionStyle8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmOptionStyle);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmOptionStyle;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionStyle8Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getOptionStyle();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<OptionStyle8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ActiveOrHistoricCurrencyCode>> mmDenominationCurrency = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmDenominationCurrency);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmDenominationCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getDenominationCurrency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmNextCouponDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmNextCouponDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmNextCouponDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getNextCouponDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmFloatingRateFixingDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmFloatingRateFixingDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmFloatingRateFixingDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmMaturityDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmMaturityDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmMaturityDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmIssueDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmIssueDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmNextCallableDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmNextCallableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmNextCallableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmPutableDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmPutableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmPutableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmDatedDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmDatedDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmDatedDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>> mmConversionDate = new MMMessageAttribute<FinancialInstrumentAttributes67, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmConversionDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmConversionDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat12Choice>> mmPreviousFactor = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmPreviousFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmPreviousFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat12Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<RateFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat12Choice>> mmNextFactor = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat12Choice>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmNextFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmNextFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat12Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat3Choice>> mmInterestRate = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat3Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getInterestRate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<RateFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat3Choice>> mmNextInterestRate = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<RateFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmNextInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmNextInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumNominalQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmMinimumNominalQuantity);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmMinimumNominalQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getMinimumNominalQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumQuantityToInstruct = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmMinimumQuantityToInstruct);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmMinimumExercisableQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumMultipleQuantityToInstruct = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmMinimumMultipleQuantityToInstruct);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmMinimumExercisableMultipleQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>> mmContractSize = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmContractSize);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmContractSize;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<PriceFormat45Choice>> mmIssuePrice = new MMMessageAssociationEnd<FinancialInstrumentAttributes67, Optional<PriceFormat45Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmIssuePrice);
			previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmIssuePrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriceFormat45Choice> getValue(FinancialInstrumentAttributes67 obj) {
			return obj.getIssuePrice();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes67 obj, Optional<PriceFormat45Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmPlaceOfListing,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmDayCountBasis, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmClassificationType,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmOptionStyle, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmDenominationCurrency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmNextCouponDate, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmFloatingRateFixingDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmMaturityDate, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmIssueDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmNextCallableDate, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmPutableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmDatedDate, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmConversionDate,
						...
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmInterestRate, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmNextInterestRate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmMinimumNominalQuantity, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmMinimumQuantityToInstruct,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmMinimumMultipleQuantityToInstruct, com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmContractSize,
						com.tools20022.repository.msg.FinancialInstrumentAttributes67.mmIssuePrice);
				trace_lazy = () -> Asset.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPreviousNextFactorRule.forFinancialInstrumentAttributes67,
						com.tools20022.repository.constraints.ConstraintMaturityDateRule.forFinancialInstrumentAttributes67);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentAttributes67";
				definition = "Description of the financial instrument.";
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes80.mmObject());
				previousVersion_lazy = () -> FinancialInstrumentAttributes49.mmObject();
			}
		});
	...
	public FinancialInstrumentAttributes67 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public FinancialInstrumentAttributes67 setPlaceOfListing(MarketIdentification3Choice placeOfListing) {
	...
	public FinancialInstrumentAttributes67 setDayCountBasis(InterestComputationMethodFormat4Choice dayCountBasis) {
	...
	public FinancialInstrumentAttributes67 setClassificationType(ClassificationType32Choice classificationType) {
	...
	public FinancialInstrumentAttributes67 setOptionStyle(OptionStyle8Choice optionStyle) {
	...
	public FinancialInstrumentAttributes67 setDenominationCurrency(ActiveOrHistoricCurrencyCode denominationCurrency) {
	...
	public FinancialInstrumentAttributes67 setNextCouponDate(ISODate nextCouponDate) {
	...
	public FinancialInstrumentAttributes67 setFloatingRateFixingDate(ISODate floatingRateFixingDate) {
	...
	public FinancialInstrumentAttributes67 setMaturityDate(ISODate maturityDate) {
	...
	public FinancialInstrumentAttributes67 setIssueDate(ISODate issueDate) {
	...
	public FinancialInstrumentAttributes67 setNextCallableDate(ISODate nextCallableDate) {
	...
	public FinancialInstrumentAttributes67 setPutableDate(ISODate putableDate) {
	...
	public FinancialInstrumentAttributes67 setDatedDate(ISODate datedDate) {
	...
	public FinancialInstrumentAttributes67 setConversionDate(ISODate conversionDate) {
	...
	public FinancialInstrumentAttributes67 setPreviousFactor(RateFormat12Choice previousFactor) {
	...
	public FinancialInstrumentAttributes67 setNextFactor(RateFormat12Choice nextFactor) {
	...
	public FinancialInstrumentAttributes67 setInterestRate(RateFormat3Choice interestRate) {
	...
	public FinancialInstrumentAttributes67 setNextInterestRate(RateFormat3Choice nextInterestRate) {
	...
	public FinancialInstrumentAttributes67 setMinimumNominalQuantity(FinancialInstrumentQuantity1Choice minimumNominalQuantity) {
	...
	public FinancialInstrumentAttributes67 setMinimumQuantityToInstruct(FinancialInstrumentQuantity1Choice minimumQuantityToInstruct) {
	...
	public FinancialInstrumentAttributes67 setMinimumMultipleQuantityToInstruct(FinancialInstrumentQuantity1Choice minimumMultipleQuantityToInstruct) {
	...
	public FinancialInstrumentAttributes67 setContractSize(FinancialInstrumentQuantity1Choice contractSize) {
	...
	public FinancialInstrumentAttributes67 setIssuePrice(PriceFormat45Choice issuePrice) {
