...
public class AdditionalBalanceInformation8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalBalanceInformation8.mmSubBalanceType, AdditionalBalanceInformation8.mmQuantity, AdditionalBalanceInformation8.mmSubBalanceAdditionalDetails,
						AdditionalBalanceInformation8.mmQuantityBreakdown);
