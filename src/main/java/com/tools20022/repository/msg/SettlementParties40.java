...
public class SettlementParties40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementParties40.mmDepository, SettlementParties40.mmParty1, SettlementParties40.mmParty2, SettlementParties40.mmParty3, SettlementParties40.mmParty4,
						SettlementParties40.mmParty5);
