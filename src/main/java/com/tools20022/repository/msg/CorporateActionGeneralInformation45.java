...
public class CorporateActionGeneralInformation45 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation45.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes39.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation45.mmCorporateActionEventIdentification, CorporateActionGeneralInformation45.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation45.mmClassActionNumber, CorporateActionGeneralInformation45.mmEventProcessingType, CorporateActionGeneralInformation45.mmEventType,
						CorporateActionGeneralInformation45.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation45.mmUnderlyingSecurity);
	...
	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes39 underlyingSecurity) {
