...
public class PartyIdentificationAndAccount49 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount49.mmIdentification, PartyIdentificationAndAccount49.mmAlternateIdentification, PartyIdentificationAndAccount49.mmSafekeepingAccount,
						PartyIdentificationAndAccount49.mmProcessingDate, PartyIdentificationAndAccount49.mmProcessingIdentification, PartyIdentificationAndAccount49.mmAdditionalInformation);
