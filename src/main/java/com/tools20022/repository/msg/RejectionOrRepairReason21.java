...
public class RejectionOrRepairReason21 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason21.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason21.mmCode, RejectionOrRepairReason21.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason21Choice code) {
		this.code = code;
	}
