...
public class CashOption6 {
	...
	public static final MMMessageAssociationEnd mmAmountDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionAmounts6.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption6.mmCreditDebitIndicator, CashOption6.mmContractualPaymentIndicator, CashOption6.mmNonEligibleProceedsIndicator, CashOption6.mmIncomeType,
						CashOption6.mmCashAccountIdentification, CashOption6.mmAmountDetails, CashOption6.mmDateDetails, CashOption6.mmForeignExchangeDetails, CashOption6.mmGenericCashPriceReceivedPerProduct);
	...
	public CorporateActionAmounts6 getAmountDetails() {
		return amountDetails;
	}

	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts6 amountDetails) {
