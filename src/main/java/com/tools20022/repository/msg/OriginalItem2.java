...
public class OriginalItem2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalItem2.mmOriginalItemIdentification, OriginalItem2.mmOriginalEndToEndIdentification, OriginalItem2.mmAmount, OriginalItem2.mmExpectedValueDate,
						OriginalItem2.mmOriginalItemReference);
