...
public class Transaction43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction43.mmAccountOwnerTransactionIdentification, Transaction43.mmAccountServicerTransactionIdentification, Transaction43.mmMarketInfrastructureTransactionIdentification,
						Transaction43.mmProcessorTransactionIdentification, Transaction43.mmTradeIdentification, Transaction43.mmPoolIdentification, Transaction43.mmCommonIdentification, Transaction43.mmCorporateActionEventIdentification,
						Transaction43.mmTripartyAgentCollateralTransactionIdentification, Transaction43.mmClientTripartyCollateralTransactionIdentification, Transaction43.mmClientCollateralInstructionIdentification,
						Transaction43.mmTripartyCollateralInstructionIdentification, Transaction43.mmTransactionDetails, Transaction43.mmStatusAndReason);
