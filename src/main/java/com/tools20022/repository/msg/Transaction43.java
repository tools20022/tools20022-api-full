...
public class Transaction43 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails72.mmObject();
		}
	};
	...
	public Transaction43 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails72 transactionDetails) {
