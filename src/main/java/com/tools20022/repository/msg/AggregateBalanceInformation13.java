...
public class AggregateBalanceInformation13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation13.mmFinancialInstrumentIdentification, AggregateBalanceInformation13.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation13.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation13.mmAdditionalDerivativeAttributes, AggregateBalanceInformation13.mmAggregateBalance,
						AggregateBalanceInformation13.mmSafekeepingPlace, AggregateBalanceInformation13.mmCorporateActionOptionType, AggregateBalanceInformation13.mmPriceDetails, AggregateBalanceInformation13.mmForeignExchangeDetails,
						AggregateBalanceInformation13.mmDaysAccrued, AggregateBalanceInformation13.mmAccountBaseCurrencyAmounts, AggregateBalanceInformation13.mmInstrumentCurrencyAmounts,
						AggregateBalanceInformation13.mmAlternateReportingCurrencyAmounts, AggregateBalanceInformation13.mmQuantityBreakdown, AggregateBalanceInformation13.mmBalanceBreakdown,
						AggregateBalanceInformation13.mmAdditionalBalanceBreakdown, AggregateBalanceInformation13.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation13.mmHoldingAdditionalDetails,
						AggregateBalanceInformation13.mmSupplementaryData);
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace12> balanceAtSafekeepingPlace) {
