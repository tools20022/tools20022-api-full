...
public class AccountAndBalance11 {
	...
	public static final MMMessageAssociationEnd mmBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionBalanceDetails2.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance11.mmSafekeepingAccount, AccountAndBalance11.mmAccountOwner, AccountAndBalance11.mmSafekeepingPlace, AccountAndBalance11.mmBalance);
	...
	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails2 balance) {
