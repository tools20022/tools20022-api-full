...
public class PaymentTransaction52 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction52.mmStatusIdentification, PaymentTransaction52.mmOriginalGroupInformation, PaymentTransaction52.mmOriginalInstructionIdentification,
						PaymentTransaction52.mmOriginalEndToEndIdentification, PaymentTransaction52.mmOriginalTransactionIdentification, PaymentTransaction52.mmTransactionStatus, PaymentTransaction52.mmStatusReasonInformation,
						PaymentTransaction52.mmChargesInformation, PaymentTransaction52.mmAcceptanceDateTime, PaymentTransaction52.mmAccountServicerReference, PaymentTransaction52.mmClearingSystemReference,
						PaymentTransaction52.mmInstructingAgent, PaymentTransaction52.mmInstructedAgent, PaymentTransaction52.mmOriginalTransactionReference, PaymentTransaction52.mmSupplementaryData);
