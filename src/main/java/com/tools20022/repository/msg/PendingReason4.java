...
public class PendingReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingReason4.mmCode, PendingReason4.mmAdditionalReasonInformation);
	...
	public void setCode(PendingReason10Choice code) {
		this.code = code;
	}
