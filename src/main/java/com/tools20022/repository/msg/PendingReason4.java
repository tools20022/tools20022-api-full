...
import com.tools20022.repository.choice.PendingReason10Choice;
...
@XmlType(name = "PendingReason4", propOrder = {"code", "additionalReasonInformation"})
public class PendingReason4 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PendingReason10Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PendingReason4 PendingReason4}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingReason4.mmCode, com.tools20022.repository.msg.PendingReason4.mmAdditionalReasonInformation);
	...
	public PendingReason10Choice getCode() {
		return code;
	}

	public PendingReason4 setCode(PendingReason10Choice code) {
	...
	public PendingReason4 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
