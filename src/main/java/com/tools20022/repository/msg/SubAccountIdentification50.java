...
import com.tools20022.repository.msg.FinancialInstrumentDetails27;
...
public class SubAccountIdentification50 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification50, Optional<PartyIdentification119>> mmAccountOwner = new MMMessageAssociationEnd<SubAccountIdentification50, Optional<PartyIdentification119>>() {
		{
		...
		@Override
		public Optional<PartyIdentification119> getValue(SubAccountIdentification50 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(SubAccountIdentification50 obj, Optional<PartyIdentification119> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification50, SecuritiesAccount34> mmSafekeepingAccount = new MMMessageAssociationEnd<SubAccountIdentification50, SecuritiesAccount34>() {
		{
		...
		@Override
		public SecuritiesAccount34 getValue(SubAccountIdentification50 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(SubAccountIdentification50 obj, SecuritiesAccount34 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubAccountIdentification50, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<SubAccountIdentification50, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification50.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
		...
		@Override
		public YesNoIndicator getValue(SubAccountIdentification50 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(SubAccountIdentification50 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification50, List<FinancialInstrumentDetails27>> mmFinancialInstrumentDetails = new MMMessageAssociationEnd<SubAccountIdentification50, List<FinancialInstrumentDetails27>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentDetails27.mmObject();
		}

		@Override
		public List<FinancialInstrumentDetails27> getValue(SubAccountIdentification50 obj) {
			return obj.getFinancialInstrumentDetails();
		}

		@Override
		public void setValue(SubAccountIdentification50 obj, List<FinancialInstrumentDetails27> value) {
	...
	public SubAccountIdentification50 setAccountOwner(PartyIdentification119 accountOwner) {
	...
	public SubAccountIdentification50 setSafekeepingAccount(SecuritiesAccount34 safekeepingAccount) {
	...
	public SubAccountIdentification50 setFinancialInstrumentDetails(List<FinancialInstrumentDetails27> financialInstrumentDetails) {
