...
public class CardPaymentDataSetTransaction6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction6.mmTransactionSequenceCounter, CardPaymentDataSetTransaction6.mmTraceability, CardPaymentDataSetTransaction6.mmEnvironment,
						CardPaymentDataSetTransaction6.mmContext, CardPaymentDataSetTransaction6.mmTransaction);
