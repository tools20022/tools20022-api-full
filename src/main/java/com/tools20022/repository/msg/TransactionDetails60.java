...
public class TransactionDetails60 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails60.mmTransactionActivity, TransactionDetails60.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails60.mmSecuritiesMovementType,
						TransactionDetails60.mmPayment, TransactionDetails60.mmSettlementParameters, TransactionDetails60.mmPlaceOfTrade, TransactionDetails60.mmSafekeepingPlace, TransactionDetails60.mmPlaceOfClearing,
						TransactionDetails60.mmPostingQuantity, TransactionDetails60.mmNumberOfDaysAccrued, TransactionDetails60.mmPostingAmount, TransactionDetails60.mmAccruedInterestAmount, TransactionDetails60.mmTradeDate,
						TransactionDetails60.mmEffectiveSettlementDate, TransactionDetails60.mmSettlementDate, TransactionDetails60.mmValueDate, TransactionDetails60.mmDeliveringSettlementParties,
						TransactionDetails60.mmReceivingSettlementParties, TransactionDetails60.mmReversalIndicator, TransactionDetails60.mmTransactionAdditionalDetails);
