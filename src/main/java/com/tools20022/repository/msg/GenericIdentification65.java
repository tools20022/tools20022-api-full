...
public class GenericIdentification65 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification65.Identification, com.tools20022.repository.msg.GenericIdentification65.Issuer,
						com.tools20022.repository.msg.GenericIdentification65.SchemeName);
