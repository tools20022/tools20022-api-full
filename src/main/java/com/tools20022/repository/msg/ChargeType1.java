...
public class ChargeType1 {
	...
	public static final MMMessageAttribute mmStructured = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ChargeType1.mmObject();
			isDerived = false;
			xmlTag = "Strd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ChargeType1.mmStructured, ChargeType1.mmAdditionalInformation);
	...
	public void setStructured(ChargeType6Code structured) {
