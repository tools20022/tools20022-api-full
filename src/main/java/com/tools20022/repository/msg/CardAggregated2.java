 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CardAggregated1
 * CardAggregated1}</li>
 * </ul>
 */
...
public class CardAggregated2 {
	...
	public static final MMMessageAttribute mmAdditionalService = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardAggregated1.mmAdditionalService;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransactionCategory = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardAggregated1.mmTransactionCategory;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmSaleReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CardAggregated1.mmSaleReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmSequenceNumberRange = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardAggregated1.mmSequenceNumberRange;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransactionDateRange = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CardAggregated1.mmTransactionDateRange;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CardAggregated1.mmObject();
			}
		});
	...
	public CardAggregated2 setSequenceNumberRange(com.tools20022.repository.msg.CardSequenceNumberRange1 sequenceNumberRange) {
