...
public class CorporateActionGeneralInformation38 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation38.mmCorporateActionEventIdentification, CorporateActionGeneralInformation38.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation38.mmClassActionNumber, CorporateActionGeneralInformation38.mmEventProcessingType, CorporateActionGeneralInformation38.mmEventType,
						CorporateActionGeneralInformation38.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation38.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation38.mmUnderlyingSecurity);
