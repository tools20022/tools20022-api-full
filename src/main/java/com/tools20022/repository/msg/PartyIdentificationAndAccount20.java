...
public class PartyIdentificationAndAccount20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount20.mmIdentification, PartyIdentificationAndAccount20.mmAlternateIdentification, PartyIdentificationAndAccount20.mmCashAccount,
						PartyIdentificationAndAccount20.mmChargesAccount, PartyIdentificationAndAccount20.mmCommissionAccount, PartyIdentificationAndAccount20.mmTaxAccount, PartyIdentificationAndAccount20.mmAdditionalInformation);
