...
public class RateTypeAndAmountAndStatus20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus20.mmRateType, RateTypeAndAmountAndStatus20.mmAmount, RateTypeAndAmountAndStatus20.mmRateStatus);
