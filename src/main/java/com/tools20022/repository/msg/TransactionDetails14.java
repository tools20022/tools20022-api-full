...
public class TransactionDetails14 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails14.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails14.mmAccountOwner, TransactionDetails14.mmSafekeepingAccount, TransactionDetails14.mmFinancialInstrumentIdentification, TransactionDetails14.mmSettlementQuantity,
						TransactionDetails14.mmSettlementAmount, TransactionDetails14.mmTradeDate, TransactionDetails14.mmSettlementDate, TransactionDetails14.mmDeliveringSettlementParties,
						TransactionDetails14.mmReceivingSettlementParties, TransactionDetails14.mmInvestor);
