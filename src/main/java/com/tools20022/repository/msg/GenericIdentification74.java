...
public class GenericIdentification74 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification74.mmIdentification, GenericIdentification74.mmType, GenericIdentification74.mmIssuer, GenericIdentification74.mmCountry, GenericIdentification74.mmShortName);
