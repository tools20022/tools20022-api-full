...
public class AcceptorDiagnosticResponse2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorDiagnosticResponse2, CardPaymentEnvironment17> mmEnvironment = new MMMessageAssociationEnd<AcceptorDiagnosticResponse2, CardPaymentEnvironment17>() {
		{
		...
		@Override
		public CardPaymentEnvironment17 getValue(AcceptorDiagnosticResponse2 obj) {
			return obj.getEnvironment();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponse2 obj, CardPaymentEnvironment17 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptorDiagnosticResponse2, Optional<TMSTrigger1>> mmTMSTrigger = new MMMessageAssociationEnd<AcceptorDiagnosticResponse2, Optional<TMSTrigger1>>() {
		{
		...
		@Override
		public Optional<TMSTrigger1> getValue(AcceptorDiagnosticResponse2 obj) {
			return obj.getTMSTrigger();
		}

		@Override
		public void setValue(AcceptorDiagnosticResponse2 obj, Optional<TMSTrigger1> value) {
	...
	public AcceptorDiagnosticResponse2 setEnvironment(CardPaymentEnvironment17 environment) {
	...
	public AcceptorDiagnosticResponse2 setTMSTrigger(TMSTrigger1 tMSTrigger) {
