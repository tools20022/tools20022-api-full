...
public class GenericIdentification36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification36.Identification, com.tools20022.repository.msg.GenericIdentification36.Issuer,
						com.tools20022.repository.msg.GenericIdentification36.SchemeName);
