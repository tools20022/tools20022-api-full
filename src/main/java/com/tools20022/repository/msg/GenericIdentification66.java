...
public class GenericIdentification66 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification66.Identification, com.tools20022.repository.msg.GenericIdentification66.Issuer,
						com.tools20022.repository.msg.GenericIdentification66.SchemeName);
