...
public class GroupHeader37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader37.mmMessageIdentification, GroupHeader37.mmCreationDateTime, GroupHeader37.mmInstructingAgent, GroupHeader37.mmInstructedAgent);
