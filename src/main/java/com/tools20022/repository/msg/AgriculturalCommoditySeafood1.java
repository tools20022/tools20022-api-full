...
public class AgriculturalCommoditySeafood1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AgriculturalCommoditySeafood1.BaseProduct, com.tools20022.repository.msg.AgriculturalCommoditySeafood1.SubProduct);
