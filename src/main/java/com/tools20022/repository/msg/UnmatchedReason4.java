...
public class UnmatchedReason4 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason4.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason4.mmCode, UnmatchedReason4.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason6Choice code) {
		this.code = code;
	}
