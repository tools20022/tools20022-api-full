...
public class UnmatchedReason4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnmatchedReason4.Code, com.tools20022.repository.msg.UnmatchedReason4.AdditionalReasonInformation);
