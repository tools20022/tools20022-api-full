...
public class CorporateActionOption4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption4.mmOptionNumber, CorporateActionOption4.mmOptionType, CorporateActionOption4.mmOptionFeatures, CorporateActionOption4.mmFractionDisposition,
						CorporateActionOption4.mmCurrencyOption, CorporateActionOption4.mmDateDetails, CorporateActionOption4.mmPeriodDetails, CorporateActionOption4.mmRateAndAmountDetails, CorporateActionOption4.mmPriceDetails,
						CorporateActionOption4.mmPlaceOfTrade, CorporateActionOption4.mmSecuritiesMovementDetails, CorporateActionOption4.mmCashMovementDetails);
