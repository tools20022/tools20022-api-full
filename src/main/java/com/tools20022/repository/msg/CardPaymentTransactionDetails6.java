...
public class CardPaymentTransactionDetails6 {
	...
	public static final MMMessageAttribute Currency = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransactionDetails6.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails22.Currency);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TotalAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails22.TotalAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails6.Currency, com.tools20022.repository.msg.CardPaymentTransactionDetails6.TotalAmount);
