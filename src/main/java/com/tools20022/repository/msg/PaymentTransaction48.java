 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentTransaction48#CancellationIdentification
 * PaymentTransaction48.CancellationIdentification}</li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentTransaction48#Assigner
 * PaymentTransaction48.Assigner}</li>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentTransaction48#Assignee
 * PaymentTransaction48.Assignee}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentTransaction48#SupplementaryData
 * PaymentTransaction48.SupplementaryData}</li>
 * </ul>
 * </li>
...
public class PaymentTransaction48 {
	...
	public static final MMMessageAttribute CancellationIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentTransaction48.mmObject();
			isDerived = false;
			xmlTag = "CxlId";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.CancellationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Case = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.Case);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalGroupInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalInstructionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalInstructionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalEndToEndIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalTransactionIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalClearingSystemReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalClearingSystemReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalInterbankSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalInterbankSettlementAmount);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalInterbankSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalInterbankSettlementDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Assigner = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.Assigner);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Assignee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.Assignee);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CancellationReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			definition = "Provides detailed information on the cancellation reason.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.CancellationReasonInformation);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OriginalTransactionReference = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.OriginalTransactionReference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute SupplementaryData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction55.SupplementaryData);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction48.CancellationIdentification, com.tools20022.repository.msg.PaymentTransaction48.Case,
						com.tools20022.repository.msg.PaymentTransaction48.OriginalGroupInformation, com.tools20022.repository.msg.PaymentTransaction48.OriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction48.OriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction48.OriginalTransactionIdentification,
						com.tools20022.repository.msg.PaymentTransaction48.OriginalClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction48.OriginalInterbankSettlementAmount,
						com.tools20022.repository.msg.PaymentTransaction48.OriginalInterbankSettlementDate, com.tools20022.repository.msg.PaymentTransaction48.Assigner, com.tools20022.repository.msg.PaymentTransaction48.Assignee,
						com.tools20022.repository.msg.PaymentTransaction48.CancellationReasonInformation, com.tools20022.repository.msg.PaymentTransaction48.OriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction48.SupplementaryData);
