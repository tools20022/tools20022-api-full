 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentTransaction48#mmCase
...
@XmlType(name = "PaymentTransaction48", propOrder = {"cancellationIdentification", "case_", "originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification", "originalTransactionIdentification",
...
public class PaymentTransaction48 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>> mmCancellationIdentification = new MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmObject();
			isDerived = false;
			xmlTag = "CxlId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmCancellationIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction48 obj) {
			return obj.getCancellationIdentification();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, Optional<Case3>> mmCase = new MMMessageAssociationEnd<PaymentTransaction48, Optional<Case3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmCase);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Case3> getValue(PaymentTransaction48 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<Case3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, Optional<OriginalGroupInformation3>> mmOriginalGroupInformation = new MMMessageAssociationEnd<PaymentTransaction48, Optional<OriginalGroupInformation3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalGroupInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalGroupInformation3> getValue(PaymentTransaction48 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<OriginalGroupInformation3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalInstructionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalEndToEndIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>> mmOriginalClearingSystemReference = new MMMessageAttribute<PaymentTransaction48, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalClearingSystemReference);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<PaymentTransaction48, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalInterbankSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction48 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, Optional<ISODate>> mmOriginalInterbankSettlementDate = new MMMessageAttribute<PaymentTransaction48, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalInterbankSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction48 obj) {
			return obj.getOriginalInterbankSettlementDate();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, Optional<BranchAndFinancialInstitutionIdentification5>> mmAssigner = new MMMessageAssociationEnd<PaymentTransaction48, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmAssigner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentTransaction48 obj) {
			return obj.getAssigner();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, Optional<BranchAndFinancialInstitutionIdentification5>> mmAssignee = new MMMessageAssociationEnd<PaymentTransaction48, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmAssignee);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, List<PaymentCancellationReason2>> mmCancellationReasonInformation = new MMMessageAssociationEnd<PaymentTransaction48, List<PaymentCancellationReason2>>() {
		{
			...
			definition = "Provides detailed information on the cancellation reason.";
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmCancellationReasonInformation);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentCancellationReason2> getValue(PaymentTransaction48 obj) {
			return obj.getCancellationReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, List<PaymentCancellationReason2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction48, Optional<OriginalTransactionReference16>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction48, Optional<OriginalTransactionReference16>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmOriginalTransactionReference);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference16> getValue(PaymentTransaction48 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, Optional<OriginalTransactionReference16> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction48, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction48, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmSupplementaryData);
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction48 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction48 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction48.mmCancellationIdentification, com.tools20022.repository.msg.PaymentTransaction48.mmCase,
						com.tools20022.repository.msg.PaymentTransaction48.mmOriginalGroupInformation, com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction48.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction48.mmOriginalTransactionIdentification,
						com.tools20022.repository.msg.PaymentTransaction48.mmOriginalClearingSystemReference, com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInterbankSettlementAmount,
						com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInterbankSettlementDate, com.tools20022.repository.msg.PaymentTransaction48.mmAssigner, com.tools20022.repository.msg.PaymentTransaction48.mmAssignee,
						com.tools20022.repository.msg.PaymentTransaction48.mmCancellationReasonInformation, com.tools20022.repository.msg.PaymentTransaction48.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction48.mmSupplementaryData);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction48";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction55.mmObject());
				previousVersion_lazy = () -> PaymentTransaction38.mmObject();
			}
		});
	...
	public PaymentTransaction48 setCancellationIdentification(Max35Text cancellationIdentification) {
	...
	public PaymentTransaction48 setCase(Case3 case_) {
		this.case_ = case_;
		return this;
	}
	...
	public PaymentTransaction48 setOriginalGroupInformation(OriginalGroupInformation3 originalGroupInformation) {
	...
	public PaymentTransaction48 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction48 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction48 setOriginalTransactionIdentification(Max35Text originalTransactionIdentification) {
	...
	public PaymentTransaction48 setOriginalClearingSystemReference(Max35Text originalClearingSystemReference) {
	...
	public PaymentTransaction48 setOriginalInterbankSettlementAmount(ActiveOrHistoricCurrencyAndAmount originalInterbankSettlementAmount) {
	...
	public PaymentTransaction48 setOriginalInterbankSettlementDate(ISODate originalInterbankSettlementDate) {
	...
	public PaymentTransaction48 setAssigner(BranchAndFinancialInstitutionIdentification5 assigner) {
	...
	public PaymentTransaction48 setAssignee(BranchAndFinancialInstitutionIdentification5 assignee) {
	...
	public PaymentTransaction48 setCancellationReasonInformation(List<PaymentCancellationReason2> cancellationReasonInformation) {
	...
	public PaymentTransaction48 setOriginalTransactionReference(OriginalTransactionReference16 originalTransactionReference) {
	...
	public PaymentTransaction48 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
