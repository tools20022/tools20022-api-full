 ...
 * <li>{@linkplain com.tools20022.repository.msg.AmountsAndValueDate3#PutAmount
...
public class AmountsAndValueDate3 {
	...
	public static final MMMessageAttribute CallAmount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AmountsAndValueDate3.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountsAndValueDate3.CallAmount, com.tools20022.repository.msg.AmountsAndValueDate3.PutAmount,
						com.tools20022.repository.msg.AmountsAndValueDate3.FinalSettlementDate);
