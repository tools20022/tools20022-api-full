...
public class QuantityAndAccount24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount24.mmSettlementQuantity, QuantityAndAccount24.mmDenominationChoice, QuantityAndAccount24.mmAccountOwner, QuantityAndAccount24.mmSafekeepingAccount,
						QuantityAndAccount24.mmCashAccount, QuantityAndAccount24.mmSafekeepingPlace, QuantityAndAccount24.mmQuantityBreakdown);
