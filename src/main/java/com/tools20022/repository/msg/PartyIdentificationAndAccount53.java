...
public class PartyIdentificationAndAccount53 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount53.mmIdentification, PartyIdentificationAndAccount53.mmAlternateIdentification, PartyIdentificationAndAccount53.mmCashAccount,
						PartyIdentificationAndAccount53.mmChargesAccount, PartyIdentificationAndAccount53.mmCommissionAccount, PartyIdentificationAndAccount53.mmTaxAccount, PartyIdentificationAndAccount53.mmAdditionalInformation);
