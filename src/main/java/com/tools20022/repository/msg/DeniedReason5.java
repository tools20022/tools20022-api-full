...
public class DeniedReason5 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeniedReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason10.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason2.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason10.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.DeniedReason2.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setCode(DeniedReason7Choice code) {
		this.code = code;
	}
