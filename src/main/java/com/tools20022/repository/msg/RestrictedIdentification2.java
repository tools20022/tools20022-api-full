...
public class RestrictedIdentification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RestrictedIdentification2.mmIdentification, RestrictedIdentification2.mmIdentificationType);
	...
	public void setIdentificationType(RestrictedSEPACodeText identificationType) {
