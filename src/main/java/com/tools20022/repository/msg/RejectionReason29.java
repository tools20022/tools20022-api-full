...
public class RejectionReason29 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason12#Code
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectionReason12.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RejectionReason12.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason29.Code, com.tools20022.repository.msg.RejectionReason29.AdditionalReasonInformation);
