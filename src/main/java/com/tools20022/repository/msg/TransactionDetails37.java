...
public class TransactionDetails37 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails37.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails37.mmTransactionActivity, TransactionDetails37.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails37.mmSecuritiesMovementType,
						TransactionDetails37.mmPayment, TransactionDetails37.mmSettlementParameters, TransactionDetails37.mmPlaceOfTrade, TransactionDetails37.mmSafekeepingPlace, TransactionDetails37.mmPlaceOfClearing,
						TransactionDetails37.mmPostingQuantity, TransactionDetails37.mmNumberOfDaysAccrued, TransactionDetails37.mmPostingAmount, TransactionDetails37.mmAccruedInterestAmount, TransactionDetails37.mmTradeDate,
						TransactionDetails37.mmEffectiveSettlementDate, TransactionDetails37.mmSettlementDate, TransactionDetails37.mmValueDate, TransactionDetails37.mmDeliveringSettlementParties,
						TransactionDetails37.mmReceivingSettlementParties, TransactionDetails37.mmReversalIndicator, TransactionDetails37.mmTransactionAdditionalDetails);
