...
public class CorporateActionRate66 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate66.mmInterest, CorporateActionRate66.mmPercentageSought, CorporateActionRate66.mmRelatedIndex, CorporateActionRate66.mmSpread,
						CorporateActionRate66.mmBidInterval, CorporateActionRate66.mmPreviousFactor, CorporateActionRate66.mmNextFactor, CorporateActionRate66.mmReinvestmentDiscountRateToMarket, CorporateActionRate66.mmInterestShortfall,
						CorporateActionRate66.mmRealisedLoss, CorporateActionRate66.mmDeclaredRate);
