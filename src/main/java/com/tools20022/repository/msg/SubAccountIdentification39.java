...
public class SubAccountIdentification39 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification39.mmAccountOwner, SubAccountIdentification39.mmSafekeepingAccount, SubAccountIdentification39.mmActivityIndicator,
						SubAccountIdentification39.mmBalanceForSubAccount);
