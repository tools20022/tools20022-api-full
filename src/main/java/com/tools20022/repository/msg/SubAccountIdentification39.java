...
public class SubAccountIdentification39 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification39.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation27> balanceForSubAccount) {
