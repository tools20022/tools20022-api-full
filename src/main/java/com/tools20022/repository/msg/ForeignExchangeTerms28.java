...
public class ForeignExchangeTerms28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms28.mmUnitCurrency, ForeignExchangeTerms28.mmQuotedCurrency, ForeignExchangeTerms28.mmExchangeRate, ForeignExchangeTerms28.mmResultingAmount);
