...
@XmlType(name = "ForeignExchangeTerms28", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "resultingAmount"})
public class ForeignExchangeTerms28 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms28
	 * ForeignExchangeTerms28}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms28, ActiveCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms28, ActiveCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms28.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
		...
		@Override
		public ActiveCurrencyCode getValue(ForeignExchangeTerms28 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms28 obj, ActiveCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms28, ActiveCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms28, ActiveCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms28, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms28, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms28 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms28 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms28, Optional<RestrictedFINActiveCurrencyAndAmount>> mmResultingAmount = new MMMessageAttribute<ForeignExchangeTerms28, Optional<RestrictedFINActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<RestrictedFINActiveCurrencyAndAmount> getValue(ForeignExchangeTerms28 obj) {
			return obj.getResultingAmount();
		}

		@Override
		public void setValue(ForeignExchangeTerms28 obj, Optional<RestrictedFINActiveCurrencyAndAmount> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms28.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms28.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms28.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms28.mmResultingAmount);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms28";
	...
	public ForeignExchangeTerms28 setUnitCurrency(ActiveCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms28 setQuotedCurrency(ActiveCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms28 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms28 setResultingAmount(RestrictedFINActiveCurrencyAndAmount resultingAmount) {
