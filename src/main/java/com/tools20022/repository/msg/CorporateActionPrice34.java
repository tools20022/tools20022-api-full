...
@XmlType(name = "CorporateActionPrice34", propOrder = {"cashInLieuOfSharePrice", "overSubscriptionDepositPrice"})
public class CorporateActionPrice34 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CorporateActionPrice34
	 * CorporateActionPrice34}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice34, Optional<PriceFormat25Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice34, Optional<PriceFormat25Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmCashInLieuOfSharePrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice34.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat25Choice> getValue(CorporateActionPrice34 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice34 obj, Optional<PriceFormat25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice34, Optional<PriceFormat25Choice>> mmOverSubscriptionDepositPrice = new MMMessageAssociationEnd<CorporateActionPrice34, Optional<PriceFormat25Choice>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice34.mmCashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice34.mmOverSubscriptionDepositPrice);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionPrice34";
	...
	public CorporateActionPrice34 setCashInLieuOfSharePrice(PriceFormat25Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice34 setOverSubscriptionDepositPrice(PriceFormat25Choice overSubscriptionDepositPrice) {
