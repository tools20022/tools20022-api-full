...
public class CorporateActionPrice34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice34.CashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice34.OverSubscriptionDepositPrice);
