...
public class CorporateAction17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateAction17.mmDateDetails, CorporateAction17.mmPeriodDetails, CorporateAction17.mmRateAndAmountDetails, CorporateAction17.mmPriceDetails,
						CorporateAction17.mmSecuritiesQuantity, CorporateAction17.mmInterestAccruedNumberOfDays, CorporateAction17.mmCouponNumber, CorporateAction17.mmCertificationBreakdownIndicator,
						CorporateAction17.mmChargesAppliedIndicator, CorporateAction17.mmRestrictionIndicator, CorporateAction17.mmAccruedInterestIndicator, CorporateAction17.mmLetterOfGuaranteedDeliveryIndicator,
						CorporateAction17.mmDividendType, CorporateAction17.mmConversionType, CorporateAction17.mmOccurrenceType, CorporateAction17.mmOfferType, CorporateAction17.mmRenounceableEntitlementStatusType,
						CorporateAction17.mmEventStage, CorporateAction17.mmAdditionalBusinessProcessIndicator, CorporateAction17.mmChangeType, CorporateAction17.mmIntermediateSecuritiesDistributionType,
						CorporateAction17.mmCapitalGainInOutIndicator, CorporateAction17.mmTaxableIncomePerShareCalculated, CorporateAction17.mmElectionType, CorporateAction17.mmLotteryType, CorporateAction17.mmCertificationType,
						CorporateAction17.mmConsentType, CorporateAction17.mmInformationType, CorporateAction17.mmNewPlaceOfIncorporation, CorporateAction17.mmAdditionalInformation);
	...
	public CorporateActionRate56 getRateAndAmountDetails() {
		return rateAndAmountDetails;
	}

	public void setRateAndAmountDetails(com.tools20022.repository.msg.CorporateActionRate56 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
	}

	@XmlElement(name = "PricDtls")
	public CorporateActionPrice50 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice50 priceDetails) {
	...
	public DividendTypeFormat8Choice getDividendType() {
		return dividendType;
	}

	public void setDividendType(DividendTypeFormat8Choice dividendType) {
	...
	public DistributionTypeFormat6Choice getOccurrenceType() {
		return occurrenceType;
	}

	public void setOccurrenceType(DistributionTypeFormat6Choice occurrenceType) {
	...
	public void setEventStage(List<CorporateActionEventStageFormat9Choice> eventStage) {
	...
	public ConsentTypeFormat3Choice getConsentType() {
		return consentType;
	}

	public void setConsentType(ConsentTypeFormat3Choice consentType) {
		this.consentType = consentType;
	}

	@XmlElement(name = "InfTp")
	public InformationTypeFormat3Choice getInformationType() {
		return informationType;
	}

	public void setInformationType(InformationTypeFormat3Choice informationType) {
