 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CorporateActionSD17
...
public class CorporateActionSD14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Max350Text> mmPlaceAndName = new MMMessageAttribute<CorporateActionSD14, Max350Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "PlcAndNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PlaceAndName";
			definition = "xPath to the element that is being extended.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmPlaceAndName);
			previousVersion_lazy = () -> CorporateActionSD13.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max350Text getValue(CorporateActionSD14 obj) {
			return obj.getPlaceAndName();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Max350Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<NoticeType1Code>> mmNoticeType = new MMMessageAttribute<CorporateActionSD14, Optional<NoticeType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "NtceTp";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmNoticeType);
			previousVersion_lazy = () -> CorporateActionSD13.mmNoticeType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<NoticeType1Code> getValue(CorporateActionSD14 obj) {
			return obj.getNoticeType();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<NoticeType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<RestrictedFINActiveCurrencyAnd13DecimalAmount>> mmEventCashValue = new MMMessageAttribute<CorporateActionSD14, Optional<RestrictedFINActiveCurrencyAnd13DecimalAmount>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "EvtCshVal";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmEventCashValue);
			previousVersion_lazy = () -> CorporateActionSD13.mmEventCashValue;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<RestrictedFINActiveCurrencyAnd13DecimalAmount> getValue(CorporateActionSD14 obj) {
			return obj.getEventCashValue();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<RestrictedFINActiveCurrencyAnd13DecimalAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<DecimalNumber>> mmNumberOfSharesToBeIssued = new MMMessageAttribute<CorporateActionSD14, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmNumberOfSharesToBeIssued);
			previousVersion_lazy = () -> CorporateActionSD13.mmNumberOfSharesToBeIssued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(CorporateActionSD14 obj) {
			return obj.getNumberOfSharesToBeIssued();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<DecimalNumber>> mmTotalNumberOfSharesOffered = new MMMessageAttribute<CorporateActionSD14, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmTotalNumberOfSharesOffered);
			previousVersion_lazy = () -> CorporateActionSD13.mmTotalNumberOfSharesOffered;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> DecimalNumber.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<Max3Number>> mmCutOffDays = new MMMessageAttribute<CorporateActionSD14, Optional<Max3Number>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "CutOffDays";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmCutOffDays);
			previousVersion_lazy = () -> CorporateActionSD13.mmCutOffDays;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(CorporateActionSD14 obj) {
			return obj.getCutOffDays();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<DTCAutoOfferProgram1Code>> mmDTCAutomatedOfferProgram = new MMMessageAttribute<CorporateActionSD14, Optional<DTCAutoOfferProgram1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmDTCAutomatedOfferProgram);
			previousVersion_lazy = () -> CorporateActionSD13.mmDTCAutomatedOfferProgram;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DTCAutoOfferProgram1Code> getValue(CorporateActionSD14 obj) {
			return obj.getDTCAutomatedOfferProgram();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<DTCAutoOfferProgram1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<CutOff1Code>> mmDTCRecycleCutOffIndicator = new MMMessageAttribute<CorporateActionSD14, Optional<CutOff1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmDTCRecycleCutOffIndicator);
			previousVersion_lazy = () -> CorporateActionSD13.mmDTCRecycleCutOffIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CutOff1Code> getValue(CorporateActionSD14 obj) {
			return obj.getDTCRecycleCutOffIndicator();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<CutOff1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<AccrualPeriodType1Code>> mmLongShortPaymentIndicator = new MMMessageAttribute<CorporateActionSD14, Optional<AccrualPeriodType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmLongShortPaymentIndicator);
			previousVersion_lazy = () -> CorporateActionSD13.mmLongShortPaymentIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccrualPeriodType1Code> getValue(CorporateActionSD14 obj) {
			return obj.getLongShortPaymentIndicator();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<AccrualPeriodType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<OversubscriptionType1Code>> mmOversubscriptionType = new MMMessageAttribute<CorporateActionSD14, Optional<OversubscriptionType1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "OvrsbcptTp";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmOversubscriptionType);
			previousVersion_lazy = () -> CorporateActionSD13.mmOversubscriptionType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OversubscriptionType1Code> getValue(CorporateActionSD14 obj) {
			return obj.getOversubscriptionType();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<OversubscriptionType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmConditionalPaymentApplicableFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmConditionalPaymentApplicableFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmConditionalPaymentApplicableFlag;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(CorporateActionSD14 obj) {
			return obj.getConditionalPaymentApplicableFlag();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmSolicitationDealerFeeFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmSolicitationDealerFeeFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmSolicitationDealerFeeFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmDTCCustodyEligibleFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmDTCCustodyEligibleFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmDTCCustodyEligibleFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmDTCReorganisationCustodyEligibleFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmDTCReorganisationCustodyEligibleFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmDTCReorganisationCustodyEligibleFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmDTCReorganisationDepositEligibleFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmDTCReorganisationDepositEligibleFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmDTCReorganisationDepositEligibleFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmSurrenderSharesToAgentFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmSurrenderSharesToAgentFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmSurrenderSharesToAgentFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmStepUpPrivilegeFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmStepUpPrivilegeFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmStepUpPrivilegeFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmRightsOversubscriptionFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmRightsOversubscriptionFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmRightsOversubscriptionFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmRightsRoundUpPrivilegeFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmRightsRoundUpPrivilegeFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmRightsRoundUpPrivilegeFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>> mmRightsTransferableFlag = new MMMessageAttribute<CorporateActionSD14, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmRightsTransferableFlag);
			previousVersion_lazy = () -> CorporateActionSD13.mmRightsTransferableFlag;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionSD14, List<CorporateActionSD15>> mmCertificateDetails = new MMMessageAssociationEnd<CorporateActionSD14, List<CorporateActionSD15>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "CertDtls";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmCertificateDetails);
			previousVersion_lazy = () -> CorporateActionSD13.mmCertificateDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<CorporateActionSD15> getValue(CorporateActionSD14 obj) {
			return obj.getCertificateDetails();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, List<CorporateActionSD15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<CountryCode>> mmEDSMessagingCountryCode = new MMMessageAttribute<CorporateActionSD14, Optional<CountryCode>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmEDSMessagingCountryCode);
			previousVersion_lazy = () -> CorporateActionSD13.mmEDSMessagingCountryCode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CountryCode> getValue(CorporateActionSD14 obj) {
			return obj.getEDSMessagingCountryCode();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionSD14, Optional<Exact32AlphaNumericText>> mmRDPReferenceNumber = new MMMessageAttribute<CorporateActionSD14, Optional<Exact32AlphaNumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionSD14.mmObject();
			isDerived = false;
			xmlTag = "RDPRefNb";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmRDPReferenceNumber);
			previousVersion_lazy = () -> CorporateActionSD13.mmRDPReferenceNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Exact32AlphaNumericText> getValue(CorporateActionSD14 obj) {
			return obj.getRDPReferenceNumber();
		}

		@Override
		public void setValue(CorporateActionSD14 obj, Optional<Exact32AlphaNumericText> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEDSMessagingCountryCodeGuideline.forCorporateActionSD14);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionSD14";
				definition = "Provides additional information regarding corporate action details.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionSD17.mmObject());
	...
	public CorporateActionSD14 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionSD14 setNoticeType(NoticeType1Code noticeType) {
	...
	public CorporateActionSD14 setEventCashValue(RestrictedFINActiveCurrencyAnd13DecimalAmount eventCashValue) {
	...
	public CorporateActionSD14 setNumberOfSharesToBeIssued(DecimalNumber numberOfSharesToBeIssued) {
	...
	public CorporateActionSD14 setTotalNumberOfSharesOffered(DecimalNumber totalNumberOfSharesOffered) {
	...
	public CorporateActionSD14 setCutOffDays(Max3Number cutOffDays) {
	...
	public CorporateActionSD14 setDTCAutomatedOfferProgram(DTCAutoOfferProgram1Code dTCAutomatedOfferProgram) {
	...
	public CorporateActionSD14 setDTCRecycleCutOffIndicator(CutOff1Code dTCRecycleCutOffIndicator) {
	...
	public CorporateActionSD14 setLongShortPaymentIndicator(AccrualPeriodType1Code longShortPaymentIndicator) {
	...
	public CorporateActionSD14 setOversubscriptionType(OversubscriptionType1Code oversubscriptionType) {
	...
	public CorporateActionSD14 setConditionalPaymentApplicableFlag(YesNoIndicator conditionalPaymentApplicableFlag) {
	...
	public CorporateActionSD14 setSolicitationDealerFeeFlag(YesNoIndicator solicitationDealerFeeFlag) {
	...
	public CorporateActionSD14 setDTCCustodyEligibleFlag(YesNoIndicator dTCCustodyEligibleFlag) {
	...
	public CorporateActionSD14 setDTCReorganisationCustodyEligibleFlag(YesNoIndicator dTCReorganisationCustodyEligibleFlag) {
	...
	public CorporateActionSD14 setDTCReorganisationDepositEligibleFlag(YesNoIndicator dTCReorganisationDepositEligibleFlag) {
	...
	public CorporateActionSD14 setSurrenderSharesToAgentFlag(YesNoIndicator surrenderSharesToAgentFlag) {
	...
	public CorporateActionSD14 setStepUpPrivilegeFlag(YesNoIndicator stepUpPrivilegeFlag) {
	...
	public CorporateActionSD14 setRightsOversubscriptionFlag(YesNoIndicator rightsOversubscriptionFlag) {
	...
	public CorporateActionSD14 setRightsRoundUpPrivilegeFlag(YesNoIndicator rightsRoundUpPrivilegeFlag) {
	...
	public CorporateActionSD14 setRightsTransferableFlag(YesNoIndicator rightsTransferableFlag) {
	...
	public CorporateActionSD14 setCertificateDetails(List<CorporateActionSD15> certificateDetails) {
	...
	public CorporateActionSD14 setEDSMessagingCountryCode(CountryCode eDSMessagingCountryCode) {
	...
	public CorporateActionSD14 setRDPReferenceNumber(Exact32AlphaNumericText rDPReferenceNumber) {
