...
public class PaymentInstruction13 {
	...
	public static final MMMessageAttribute RequestedExecutionDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction3.RequestedExecutionDateTime;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction3.PaymentType;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction13.RequestedExecutionDateTime, com.tools20022.repository.msg.PaymentInstruction13.PaymentType);
