...
public class PaymentTypeInformation22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTypeInformation22.mmInstructionPriority, PaymentTypeInformation22.mmClearingChannel, PaymentTypeInformation22.mmServiceLevel, PaymentTypeInformation22.mmLocalInstrument,
						PaymentTypeInformation22.mmSequenceType, PaymentTypeInformation22.mmCategoryPurpose);
