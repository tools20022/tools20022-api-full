...
public class IntraBalanceCancellation2 {
	...
	public static final MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<SystemPartyIdentification5>> mmAccountOwner = new MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<SystemPartyIdentification5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<CashAccount24>> mmCashAccount = new MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmCashAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<ProcessingStatus32Choice>> mmProcessingStatus = new MMMessageAssociationEnd<IntraBalanceCancellation2, Optional<ProcessingStatus32Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmProcessingStatus);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<IntraBalanceCancellation2, Max35Text> mmRequestReference = new MMMessageAttribute<IntraBalanceCancellation2, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmRequestReference);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<IntraBalanceCancellation2, Optional<ISODateTime>> mmStatusDate = new MMMessageAttribute<IntraBalanceCancellation2, Optional<ISODateTime>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmStatusDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.IntraBalanceCancellation2.mmAccountOwner, com.tools20022.repository.msg.IntraBalanceCancellation2.mmCashAccount,
						com.tools20022.repository.msg.IntraBalanceCancellation2.mmProcessingStatus, com.tools20022.repository.msg.IntraBalanceCancellation2.mmRequestReference,
						com.tools20022.repository.msg.IntraBalanceCancellation2.mmStatusDate, com.tools20022.repository.msg.IntraBalanceCancellation2.mmTransactionIdentification,
						com.tools20022.repository.msg.IntraBalanceCancellation2.mmUnderlyingIntraBalance);
				trace_lazy = () -> BookEntry.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "IntraBalanceCancellation2";
				definition = "Provides the details of the cancellation requests.";
				nextVersions_lazy = () -> Arrays.asList(IntraBalanceCancellation4.mmObject());
			}
		});
	...
	public IntraBalanceCancellation2 setProcessingStatus(ProcessingStatus32Choice processingStatus) {
	...
	public IntraBalanceCancellation2 setRequestReference(Max35Text requestReference) {
	...
	public IntraBalanceCancellation2 setStatusDate(ISODateTime statusDate) {
