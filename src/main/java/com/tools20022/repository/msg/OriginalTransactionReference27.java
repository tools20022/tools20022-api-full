...
public class OriginalTransactionReference27 {
	...
	public static final MMMessageAttribute mmInterbankSettlementAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmInterbankSettlementDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmRequestedCollectionDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	public static final MMMessageAttribute mmRequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmRequestedExecutionDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCreditorSchemeIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmCreditorSchemeIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSettlementInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmSettlementInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmPaymentTypeInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPaymentMethod = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmPaymentMethod;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmMandateRelatedInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmMandateRelatedInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.MandateRelatedInformation12.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmRemittanceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmRemittanceInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmUltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmUltimateDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmDebtor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Party35Choice.mmObject();
	...
	public static final MMMessageAssociationEnd mmDebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmDebtorAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmDebtorAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDebtorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmDebtorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccount24.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditorAgent = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmCreditorAgent;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmCreditorAgentAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccount24.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Party35Choice.mmObject();
	...
	public static final MMMessageAssociationEnd mmCreditorAccount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmCreditorAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CashAccount24.mmObject();
	...
	public static final MMMessageAssociationEnd mmUltimateCreditor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalTransactionReference24.mmUltimateCreditor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Party35Choice.mmObject();
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> OriginalTransactionReference24.mmObject();
			}
		});
	...
	public OriginalTransactionReference27 setCreditorSchemeIdentification(com.tools20022.repository.msg.PartyIdentification125 creditorSchemeIdentification) {
	...
	public OriginalTransactionReference27 setSettlementInformation(com.tools20022.repository.msg.SettlementInstruction4 settlementInformation) {
	...
	public OriginalTransactionReference27 setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation25 paymentTypeInformation) {
	...
	public OriginalTransactionReference27 setMandateRelatedInformation(com.tools20022.repository.msg.MandateRelatedInformation12 mandateRelatedInformation) {
	...
	public OriginalTransactionReference27 setRemittanceInformation(com.tools20022.repository.msg.RemittanceInformation15 remittanceInformation) {
	...
	public OriginalTransactionReference27 setDebtorAccount(com.tools20022.repository.msg.CashAccount24 debtorAccount) {
	...
	public OriginalTransactionReference27 setDebtorAgent(com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public OriginalTransactionReference27 setDebtorAgentAccount(com.tools20022.repository.msg.CashAccount24 debtorAgentAccount) {
	...
	public OriginalTransactionReference27 setCreditorAgent(com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5 creditorAgent) {
	...
	public OriginalTransactionReference27 setCreditorAgentAccount(com.tools20022.repository.msg.CashAccount24 creditorAgentAccount) {
	...
	public OriginalTransactionReference27 setCreditorAccount(com.tools20022.repository.msg.CashAccount24 creditorAccount) {
