...
public class UnmatchedReason14 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason14.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason14.mmCode, UnmatchedReason14.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason18Choice code) {
		this.code = code;
	}
