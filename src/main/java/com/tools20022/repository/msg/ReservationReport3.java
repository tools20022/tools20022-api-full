	...
	public static final MMMessageAssociationEnd mmReservationIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReservationReport4.mmReservationIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmReservationOrError = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReservationReport4.mmReservationOrError);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
