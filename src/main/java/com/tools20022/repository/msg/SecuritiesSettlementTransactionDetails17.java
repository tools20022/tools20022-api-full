...
public class SecuritiesSettlementTransactionDetails17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails17.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails17.mmLinkages,
						SecuritiesSettlementTransactionDetails17.mmTradeDetails, SecuritiesSettlementTransactionDetails17.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails17.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails17.mmSettlementParameters, SecuritiesSettlementTransactionDetails17.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails17.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails17.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails17.mmCashParties,
						SecuritiesSettlementTransactionDetails17.mmSettlementAmount, SecuritiesSettlementTransactionDetails17.mmOtherAmounts, SecuritiesSettlementTransactionDetails17.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails17.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails17.mmSupplementaryData);
