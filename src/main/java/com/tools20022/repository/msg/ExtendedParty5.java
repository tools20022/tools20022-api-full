...
@XmlType(name = "ExtendedParty5", propOrder = {"extendedPartyRole", "otherPartyDetails"})
public class ExtendedParty5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExtendedParty5, Extended350Code> mmExtendedPartyRole = new MMMessageAttribute<ExtendedParty5, Extended350Code>() {
		{
			businessComponentTrace_lazy = () -> InvestmentAccountPartyRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ExtendedParty5.mmObject();
			isDerived = false;
			xmlTag = "XtndedPtyRole";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ExtendedPartyRole";
			definition = "Other type of party's role.";
			nextVersions_lazy = () -> Arrays.asList(ExtendedParty8.mmExtendedPartyRole);
			previousVersion_lazy = () -> ExtendedParty4.mmExtendedPartyRole;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Extended350Code getValue(ExtendedParty5 obj) {
			return obj.getExtendedPartyRole();
		}

		@Override
		public void setValue(ExtendedParty5 obj, Extended350Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExtendedParty5, InvestmentAccountOwnershipInformation8> mmOtherPartyDetails = new MMMessageAssociationEnd<ExtendedParty5, InvestmentAccountOwnershipInformation8>() {
		{
			businessComponentTrace_lazy = () -> InvestmentAccountPartyRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ExtendedParty5.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ExtendedParty8.mmOtherPartyDetails);
			previousVersion_lazy = () -> ExtendedParty4.mmOtherPartyDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public InvestmentAccountOwnershipInformation8 getValue(ExtendedParty5 obj) {
			return obj.getOtherPartyDetails();
		}

		@Override
		public void setValue(ExtendedParty5 obj, InvestmentAccountOwnershipInformation8 value) {
	...
	public ExtendedParty5 setExtendedPartyRole(Extended350Code extendedPartyRole) {
	...
	public ExtendedParty5 setOtherPartyDetails(InvestmentAccountOwnershipInformation8 otherPartyDetails) {
