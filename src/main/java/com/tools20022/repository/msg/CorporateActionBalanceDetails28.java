...
public class CorporateActionBalanceDetails28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionBalanceDetails28.mmConfirmedBalance, CorporateActionBalanceDetails28.mmTotalEligibleBalance, CorporateActionBalanceDetails28.mmBlockedBalance,
						CorporateActionBalanceDetails28.mmBorrowedBalance, CorporateActionBalanceDetails28.mmCollateralInBalance, CorporateActionBalanceDetails28.mmCollateralOutBalance, CorporateActionBalanceDetails28.mmOnLoanBalance,
						CorporateActionBalanceDetails28.mmPendingDeliveryBalance, CorporateActionBalanceDetails28.mmPendingReceiptBalance, CorporateActionBalanceDetails28.mmOutForRegistrationBalance,
						CorporateActionBalanceDetails28.mmSettlementPositionBalance, CorporateActionBalanceDetails28.mmStreetPositionBalance, CorporateActionBalanceDetails28.mmTradeDatePositionBalance,
						CorporateActionBalanceDetails28.mmInTransshipmentBalance, CorporateActionBalanceDetails28.mmRegisteredBalance, CorporateActionBalanceDetails28.mmAffectedBalance, CorporateActionBalanceDetails28.mmUnaffectedBalance);
