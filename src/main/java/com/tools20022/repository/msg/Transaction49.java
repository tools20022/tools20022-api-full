...
public class Transaction49 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction49.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction49.mmAccountOwnerTransactionIdentification, Transaction49.mmAccountServicerTransactionIdentification, Transaction49.mmMarketInfrastructureTransactionIdentification,
						Transaction49.mmProcessorTransactionIdentification, Transaction49.mmTradeIdentification, Transaction49.mmPoolIdentification, Transaction49.mmCommonIdentification, Transaction49.mmCorporateActionEventIdentification,
						Transaction49.mmTripartyAgentCollateralTransactionIdentification, Transaction49.mmClientTripartyCollateralTransactionIdentification, Transaction49.mmClientCollateralInstructionIdentification,
						Transaction49.mmTripartyCollateralInstructionIdentification, Transaction49.mmTransactionDetails, Transaction49.mmStatusAndReason);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails90 transactionDetails) {
