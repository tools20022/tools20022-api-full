...
public class TransactionTypeAndAdditionalParameters12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters12.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters12.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters12.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters12.mmSecuritiesMovementType, TransactionTypeAndAdditionalParameters12.mmPayment,
						TransactionTypeAndAdditionalParameters12.mmCommonIdentification, TransactionTypeAndAdditionalParameters12.mmPoolIdentification, TransactionTypeAndAdditionalParameters12.mmCorporateActionEventIdentification);
