...
public class PendingProcessingReason12 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason12.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason12.mmCode, PendingProcessingReason12.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason14Choice code) {
		this.code = code;
	}
