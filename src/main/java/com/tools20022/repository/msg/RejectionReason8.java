...
public class RejectionReason8 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason8.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason8.mmCode, RejectionReason8.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason8Choice code) {
		this.code = code;
	}
