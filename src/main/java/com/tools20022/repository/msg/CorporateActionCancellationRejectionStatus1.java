...
public class CorporateActionCancellationRejectionStatus1 {
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionCancellationRejectionStatus1.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionCancellationRejectionStatus1.mmReason, CorporateActionCancellationRejectionStatus1.mmAdditionalInformation);
	...
	public void setReason(List<RejectionReason9FormatChoice> reason) {
		this.reason = reason;
	}
