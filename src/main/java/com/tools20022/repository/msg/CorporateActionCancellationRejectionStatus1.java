...
import com.tools20022.repository.choice.RejectionReason9FormatChoice;
 ...
 * definition} =
 * "Provides reason of the rejection of an election cancellation request."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CorporateActionCancellationRejectionStatus1", propOrder = {"reason", "additionalInformation"})
public class CorporateActionCancellationRejectionStatus1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectionReason9FormatChoice> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.msg.CorporateActionCancellationRejectionStatus1.mmReason, com.tools20022.repository.msg.CorporateActionCancellationRejectionStatus1.mmAdditionalInformation);
				trace_lazy = () -> CorporateActionStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionCancellationRejectionStatus1";
				definition = "Provides reason of the rejection of an election cancellation request.";
			}
		});
		return mmObject_lazy.get();
	}

	public List<RejectionReason9FormatChoice> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public CorporateActionCancellationRejectionStatus1 setReason(List<RejectionReason9FormatChoice> reason) {
	...
	public CorporateActionCancellationRejectionStatus1 setAdditionalInformation(Max350Text additionalInformation) {
