...
public class SecuritiesAccount18 {
	...
	/**
	 * Specifies if the account is a House, a Client or a Liquidity Provider
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesAccount18.Identification, com.tools20022.repository.msg.SecuritiesAccount18.Type, com.tools20022.repository.msg.SecuritiesAccount18.Name);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.secl.TradeLegNotificationV03.ClearingAccount, com.tools20022.repository.area.secl.TradeLegStatementV03.ClearingAccount,
						com.tools20022.repository.area.secl.TradeLegNotificationCancellationV03.ClearingAccount);
