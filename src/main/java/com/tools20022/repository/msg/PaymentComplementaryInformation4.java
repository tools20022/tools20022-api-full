...
public class PaymentComplementaryInformation4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentComplementaryInformation4.mmInstructionIdentification, PaymentComplementaryInformation4.mmEndToEndIdentification,
						PaymentComplementaryInformation4.mmTransactionIdentification, PaymentComplementaryInformation4.mmPaymentTypeInformation, PaymentComplementaryInformation4.mmRequestedExecutionDate,
						PaymentComplementaryInformation4.mmRequestedCollectionDate, PaymentComplementaryInformation4.mmInterbankSettlementDate, PaymentComplementaryInformation4.mmAmount,
						PaymentComplementaryInformation4.mmInterbankSettlementAmount, PaymentComplementaryInformation4.mmChargeBearer, PaymentComplementaryInformation4.mmUltimateDebtor, PaymentComplementaryInformation4.mmDebtor,
						PaymentComplementaryInformation4.mmDebtorAccount, PaymentComplementaryInformation4.mmDebtorAgent, PaymentComplementaryInformation4.mmDebtorAgentAccount, PaymentComplementaryInformation4.mmSettlementInformation,
						PaymentComplementaryInformation4.mmIntermediaryAgent1, PaymentComplementaryInformation4.mmIntermediaryAgent1Account, PaymentComplementaryInformation4.mmIntermediaryAgent2,
						PaymentComplementaryInformation4.mmIntermediaryAgent2Account, PaymentComplementaryInformation4.mmIntermediaryAgent3, PaymentComplementaryInformation4.mmIntermediaryAgent3Account,
						PaymentComplementaryInformation4.mmCreditorAgent, PaymentComplementaryInformation4.mmCreditorAgentAccount, PaymentComplementaryInformation4.mmCreditor, PaymentComplementaryInformation4.mmCreditorAccount,
						PaymentComplementaryInformation4.mmUltimateCreditor, PaymentComplementaryInformation4.mmPurpose, PaymentComplementaryInformation4.mmInstructionForDebtorAgent,
						PaymentComplementaryInformation4.mmPreviousInstructingAgent, PaymentComplementaryInformation4.mmPreviousInstructingAgentAccount, PaymentComplementaryInformation4.mmInstructionForNextAgent,
						PaymentComplementaryInformation4.mmInstructionForCreditorAgent, PaymentComplementaryInformation4.mmRemittanceInformation);
