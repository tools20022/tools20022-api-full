...
public class TransactionTotals2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTotals2.mmPOIGroupIdentification, TransactionTotals2.mmCardProductProfile, TransactionTotals2.mmCurrency, TransactionTotals2.mmType, TransactionTotals2.mmTotalNumber,
						TransactionTotals2.mmCumulativeAmount);
