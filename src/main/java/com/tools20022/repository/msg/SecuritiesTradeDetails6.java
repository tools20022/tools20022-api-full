 ...
 * SecuritiesTradeDetails6.mmSettlementInstructionProcessingAdditionalDetails}</li>
 * <li>
...
public class SecuritiesTradeDetails6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<MarketIdentification4>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<MarketIdentification4>>() {
		{
			businessElementTrace_lazy = () -> Security.mmTradingMarket;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails6.mmObject();
			isDerived = false;
			xmlTag = "PlcOfTrad";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmPlaceOfTrade);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification4> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<MarketIdentification4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmPlaceOfClearing);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmTradeDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<SettlementDate1Choice>> mmSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<SettlementDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementDate1Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<SettlementDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails6, SettlementDate3Choice> mmEffectiveSettlementDate = new MMMessageAssociationEnd<SecuritiesTradeDetails6, SettlementDate3Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmEffectiveSettlementDate);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate3Choice getValue(SecuritiesTradeDetails6 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, SettlementDate3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails6, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmDealPrice);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, List<Reporting2Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails6, List<Reporting2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails6.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmReporting);
			minOccurs = 0;
			complexType_lazy = () -> Reporting2Choice.mmObject();
		}

		@Override
		public List<Reporting2Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, List<Reporting2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmNumberOfDaysAccrued);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, List<TradeTransactionCondition1Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails6, List<TradeTransactionCondition1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmTradeTransactionCondition);
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition1Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition1Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, List<TradeTransactionCondition1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<InvestorCapacity1Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<InvestorCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmInvestorCapacity);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity1Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<InvestorCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<TradeOriginator1Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<TradeOriginator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmTradeOriginatorRole);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator1Choice> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<TradeOriginator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails6.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmSettlementInstructionProcessingAdditionalDetails);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails6 obj) {
			return obj.getSettlementInstructionProcessingAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails6 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails6, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmFXAdditionalDetails);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails6.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmPlaceOfClearing,
						com.tools20022.repository.msg.SecuritiesTradeDetails6.mmTradeDate, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmSettlementDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails6.mmEffectiveSettlementDate, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmDealPrice, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmReporting,
						com.tools20022.repository.msg.SecuritiesTradeDetails6.mmNumberOfDaysAccrued, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmTradeTransactionCondition,
						com.tools20022.repository.msg.SecuritiesTradeDetails6.mmInvestorCapacity, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmTradeOriginatorRole,
						com.tools20022.repository.msg.SecuritiesTradeDetails6.mmSettlementInstructionProcessingAdditionalDetails, com.tools20022.repository.msg.SecuritiesTradeDetails6.mmFXAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingConfirmationV01.mmTradeDetails, SecuritiesFinancingConfirmationV02.mmTradeDetails, SecuritiesFinancingConfirmationV03.mmTradeDetails,
						SecuritiesFinancingConfirmationV04.mmTradeDetails);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails6,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails6, com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails6,
						com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails6, com.tools20022.repository.constraints.ConstraintCurrencyToBuyOrSellRule.forSecuritiesTradeDetails6);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTradeDetails6";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails38.mmObject());
			}
		});
	...
	public SecuritiesTradeDetails6 setPlaceOfTrade(MarketIdentification4 placeOfTrade) {
	...
	public SecuritiesTradeDetails6 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public SecuritiesTradeDetails6 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public SecuritiesTradeDetails6 setSettlementDate(SettlementDate1Choice settlementDate) {
	...
	public SecuritiesTradeDetails6 setEffectiveSettlementDate(SettlementDate3Choice effectiveSettlementDate) {
	...
	public SecuritiesTradeDetails6 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails6 setReporting(List<Reporting2Choice> reporting) {
	...
	public SecuritiesTradeDetails6 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails6 setTradeTransactionCondition(List<TradeTransactionCondition1Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails6 setInvestorCapacity(InvestorCapacity1Choice investorCapacity) {
	...
	public SecuritiesTradeDetails6 setTradeOriginatorRole(TradeOriginator1Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails6 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
	...
	public SecuritiesTradeDetails6 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
