...
public class AccountSubLevel3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountSubLevel3.mmAccountIdentification, AccountSubLevel3.mmAccountOwner, AccountSubLevel3.mmAccountServicer, AccountSubLevel3.mmBeneficialOwner,
						AccountSubLevel3.mmBalanceForAccount, AccountSubLevel3.mmAccountSubLevel4, AccountSubLevel3.mmAccountSubLevel4Difference, AccountSubLevel3.mmAgent, AccountSubLevel3.mmSupplementaryData);
