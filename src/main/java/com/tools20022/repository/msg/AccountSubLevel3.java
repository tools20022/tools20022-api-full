...
public class AccountSubLevel3 {
	...
	public static final MMMessageAssociationEnd mmAccountIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountSubLevel3.mmObject();
			isDerived = false;
			xmlTag = "AcctId";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmAccountIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAccountOwner = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmAccountOwner);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAccountServicer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmAccountServicer);
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.msg.PartyIdentification100.mmObject();
		}
	...
	public static final MMMessageAssociationEnd mmBeneficialOwner = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmBeneficialOwner);
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAccountSubLevel4 = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmAccountSubLevel4);
			minOccurs = 0;
			isComposite = true;
	...
	/**
	 * Difference in holdings betweensub-account at level 3 and the sub-accounts
	 * of level 4.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAssociationEnd mmAccountSubLevel4Difference = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmAccountSubLevel4Difference);
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSupplementaryData = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountSubLevel13.mmSupplementaryData);
			minOccurs = 0;
			isComposite = true;
	...
	public void setAccountSubLevel4(List<com.tools20022.repository.msg.AccountSubLevel4> accountSubLevel4) {
