...
public class CorporateAction44 {
	...
	public static final MMMessageAssociationEnd mmDateDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateAction33.mmDateDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionDate59.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmEventStage = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateAction33.mmEventStage;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAdditionalBusinessProcessIndicator = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateAction33.mmAdditionalBusinessProcessIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmLotteryType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateAction33.mmLotteryType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CorporateAction33.mmObject();
			}
		});
	...
	public CorporateAction44 setDateDetails(com.tools20022.repository.msg.CorporateActionDate59 dateDetails) {
