...
public class IntraPositionDetails22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails22.mmSettledQuantity, IntraPositionDetails22.mmSecuritiesSubBalanceIdentification, IntraPositionDetails22.mmCollateralMonitorAmount,
						IntraPositionDetails22.mmPreviouslySettledQuantity, IntraPositionDetails22.mmRemainingToBeSettledQuantity, IntraPositionDetails22.mmSettlementDate, IntraPositionDetails22.mmAvailableDate,
						IntraPositionDetails22.mmCorporateActionEventType, IntraPositionDetails22.mmBalanceFrom, IntraPositionDetails22.mmBalanceTo, IntraPositionDetails22.mmInstructionProcessingAdditionalDetails);
