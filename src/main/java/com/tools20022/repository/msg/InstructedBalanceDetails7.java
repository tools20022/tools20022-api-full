...
@XmlType(name = "InstructedBalanceDetails7", propOrder = {"totalInstructedBalance", "optionDetails"})
public class InstructedBalanceDetails7 {
	...
	public static final MMMessageAttribute mmTotalInstructedBalance = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InstructedBalanceDetails5.mmTotalInstructedBalance;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InstructedBalanceDetails7.mmTotalInstructedBalance, com.tools20022.repository.msg.InstructedBalanceDetails7.mmOptionDetails);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InstructedBalanceDetails7";
				definition = "Provides information about total instructed balance.";
				previousVersion_lazy = () -> InstructedBalanceDetails5.mmObject();
			}
		});
	...
	public InstructedBalanceDetails7 setTotalInstructedBalance(BalanceFormat5Choice totalInstructedBalance) {
		this.totalInstructedBalance = Objects.requireNonNull(totalInstructedBalance);
		return this;
	}

	public List<InstructedCorporateActionOption8> getOptionDetails() {
