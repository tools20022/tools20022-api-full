...
public class Linkages5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages5, Optional<ProcessingPosition3Choice>> mmProcessingPosition = new MMMessageAssociationEnd<Linkages5, Optional<ProcessingPosition3Choice>>() {
		{
		...
		@Override
		public Optional<ProcessingPosition3Choice> getValue(Linkages5 obj) {
			return obj.getProcessingPosition();
		}

		@Override
		public void setValue(Linkages5 obj, Optional<ProcessingPosition3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages5, Optional<DocumentNumber2Choice>> mmMessageNumber = new MMMessageAssociationEnd<Linkages5, Optional<DocumentNumber2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Linkages5.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
		...
		@Override
		public Optional<DocumentNumber2Choice> getValue(Linkages5 obj) {
			return obj.getMessageNumber();
		}

		@Override
		public void setValue(Linkages5 obj, Optional<DocumentNumber2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Linkages5, References12Choice> mmReference = new MMMessageAssociationEnd<Linkages5, References12Choice>() {
		{
		...
		@Override
		public References12Choice getValue(Linkages5 obj) {
			return obj.getReference();
		}

		@Override
		public void setValue(Linkages5 obj, References12Choice value) {
