...
public class DeliverInformation8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation8.mmSettlementAmount, DeliverInformation8.mmStampDuty, DeliverInformation8.mmNetAmount, DeliverInformation8.mmSettlementPartiesDetails,
						DeliverInformation8.mmChargeDetails, DeliverInformation8.mmCommissionDetails, DeliverInformation8.mmTaxDetails, DeliverInformation8.mmPhysicalTransfer, DeliverInformation8.mmPhysicalTransferDetails);
