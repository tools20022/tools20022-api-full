...
public class References1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References1.mmAccountOwnerTransactionIdentification, References1.mmAccountServicerTransactionIdentification, References1.mmMarketInfrastructureTransactionIdentification,
						References1.mmPoolIdentification, References1.mmCommonIdentification, References1.mmTradeIdentification);
