...
import com.tools20022.repository.msg.AmendmentInformationDetails7;
...
public class MandateRelatedInformation7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<Max35Text>> mmMandateIdentification = new MMMessageAttribute<MandateRelatedInformation7, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(MandateRelatedInformation7 obj) {
			return obj.getMandateIdentification();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>> mmDateOfSignature = new MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>>() {
		{
		...
		@Override
		public Optional<ISODate> getValue(MandateRelatedInformation7 obj) {
			return obj.getDateOfSignature();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<TrueFalseIndicator>> mmAmendmentIndicator = new MMMessageAttribute<MandateRelatedInformation7, Optional<TrueFalseIndicator>>() {
		{
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(MandateRelatedInformation7 obj) {
			return obj.getAmendmentIndicator();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MandateRelatedInformation7, Optional<AmendmentInformationDetails7>> mmAmendmentInformationDetails = new MMMessageAssociationEnd<MandateRelatedInformation7, Optional<AmendmentInformationDetails7>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> AmendmentInformationDetails7.mmObject();
		}

		@Override
		public Optional<AmendmentInformationDetails7> getValue(MandateRelatedInformation7 obj) {
			return obj.getAmendmentInformationDetails();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<AmendmentInformationDetails7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<Max1025Text>> mmElectronicSignature = new MMMessageAttribute<MandateRelatedInformation7, Optional<Max1025Text>>() {
		{
		...
		@Override
		public Optional<Max1025Text> getValue(MandateRelatedInformation7 obj) {
			return obj.getElectronicSignature();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<Max1025Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>> mmFirstCollectionDate = new MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>> mmFinalCollectionDate = new MMMessageAttribute<MandateRelatedInformation7, Optional<ISODate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MandateRelatedInformation7, Optional<Frequency1Code>> mmFrequency = new MMMessageAttribute<MandateRelatedInformation7, Optional<Frequency1Code>>() {
		{
		...
		@Override
		public Optional<Frequency1Code> getValue(MandateRelatedInformation7 obj) {
			return obj.getFrequency();
		}

		@Override
		public void setValue(MandateRelatedInformation7 obj, Optional<Frequency1Code> value) {
	...
	public MandateRelatedInformation7 setAmendmentInformationDetails(AmendmentInformationDetails7 amendmentInformationDetails) {
