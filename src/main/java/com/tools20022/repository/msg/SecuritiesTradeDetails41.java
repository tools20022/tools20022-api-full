...
public class SecuritiesTradeDetails41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails41.mmTradeIdentification, SecuritiesTradeDetails41.mmCollateralTransactionIdentification, SecuritiesTradeDetails41.mmAccountOwnerTransactionIdentification,
						SecuritiesTradeDetails41.mmProcessorTransactionIdentification, SecuritiesTradeDetails41.mmPlaceOfTrade, SecuritiesTradeDetails41.mmPlaceOfClearing, SecuritiesTradeDetails41.mmTradeDate,
						SecuritiesTradeDetails41.mmSettlementDate, SecuritiesTradeDetails41.mmDealPrice, SecuritiesTradeDetails41.mmNumberOfDaysAccrued, SecuritiesTradeDetails41.mmTradeTransactionCondition,
						SecuritiesTradeDetails41.mmTypeOfPrice);
