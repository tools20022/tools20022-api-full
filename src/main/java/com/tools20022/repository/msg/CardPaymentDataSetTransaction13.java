	...
	public static final MMMessageAttribute mmTransactionSequenceCounter = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction17.mmTransactionSequenceCounter);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction9.mmTransactionSequenceCounter;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmTraceability = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction17.mmTraceability);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction9.mmTraceability;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmEnvironment = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction17.mmEnvironment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction9.mmEnvironment;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction17.mmTransaction);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction9.mmTransaction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTransactionResponse = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentDataSetTransaction17.mmTransactionResponse);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CardPaymentDataSetTransaction9.mmTransactionResponse;
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction39.mmObject();
		}
	};
