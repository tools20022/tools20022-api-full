...
public class BusinessInformationQueryDefinition {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BusinessInformationQueryDefinition.mmQueryType, BusinessInformationQueryDefinition.mmGeneralBusinessInformationCriteria);
