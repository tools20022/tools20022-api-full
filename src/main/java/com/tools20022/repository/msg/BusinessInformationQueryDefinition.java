 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.BusinessInformationQueryDefinition#QueryType
 * BusinessInformationQueryDefinition.QueryType}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.BusinessInformationQueryDefinition#GeneralBusinessInformationCriteria
 * BusinessInformationQueryDefinition.GeneralBusinessInformationCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class BusinessInformationQueryDefinition {
	...
	public static final MMMessageAttribute QueryType = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> BusinessInformationQueryDefinition.mmObject();
			isDerived = false;
			xmlTag = "QryTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BusinessInformationQueryDefinition.QueryType, com.tools20022.repository.msg.BusinessInformationQueryDefinition.GeneralBusinessInformationCriteria);
