...
public class FinancialInstrumentAttributes22 {
	...
	public static final MMMessageAssociationEnd mmSecurityIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentAttributes22.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes22.mmSecurityIdentification, FinancialInstrumentAttributes22.mmPlaceOfListing, FinancialInstrumentAttributes22.mmDayCountBasis,
						FinancialInstrumentAttributes22.mmClassificationType, FinancialInstrumentAttributes22.mmDenominationCurrency, FinancialInstrumentAttributes22.mmNextCouponDate, FinancialInstrumentAttributes22.mmExpiryDate,
						FinancialInstrumentAttributes22.mmFloatingRateFixingDate, FinancialInstrumentAttributes22.mmMaturityDate, FinancialInstrumentAttributes22.mmIssueDate, FinancialInstrumentAttributes22.mmNextCallableDate,
						FinancialInstrumentAttributes22.mmPutableDate, FinancialInstrumentAttributes22.mmDatedDate, FinancialInstrumentAttributes22.mmConversionDate, FinancialInstrumentAttributes22.mmPreviousFactor,
						FinancialInstrumentAttributes22.mmNextFactor, FinancialInstrumentAttributes22.mmInterestRate, FinancialInstrumentAttributes22.mmNextInterestRate, FinancialInstrumentAttributes22.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes22.mmMinimumExercisableQuantity, FinancialInstrumentAttributes22.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes22.mmContractSize);
