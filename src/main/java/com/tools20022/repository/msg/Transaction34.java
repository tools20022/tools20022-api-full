...
public class Transaction34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction34.mmAccountOwnerTransactionIdentification, Transaction34.mmAccountServicerTransactionIdentification, Transaction34.mmMarketInfrastructureTransactionIdentification,
						Transaction34.mmProcessorTransactionIdentification, Transaction34.mmTradeIdentification, Transaction34.mmPoolIdentification, Transaction34.mmCommonIdentification, Transaction34.mmCorporateActionEventIdentification,
						Transaction34.mmTripartyAgentCollateralTransactionIdentification, Transaction34.mmClientTripartyCollateralTransactionIdentification, Transaction34.mmClientCollateralInstructionIdentification,
						Transaction34.mmTripartyCollateralInstructionIdentification, Transaction34.mmTransactionDetails, Transaction34.mmStatusAndReason);
