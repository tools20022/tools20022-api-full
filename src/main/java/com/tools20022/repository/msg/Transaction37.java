...
public class Transaction37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction37.mmAccountOwnerTransactionIdentification, Transaction37.mmAccountServicerTransactionIdentification, Transaction37.mmMarketInfrastructureTransactionIdentification,
						Transaction37.mmProcessorTransactionIdentification, Transaction37.mmTradeIdentification, Transaction37.mmPoolIdentification, Transaction37.mmCommonIdentification, Transaction37.mmCorporateActionEventIdentification,
						Transaction37.mmTripartyAgentCollateralTransactionIdentification, Transaction37.mmClientTripartyCollateralTransactionIdentification, Transaction37.mmClientCollateralInstructionIdentification,
						Transaction37.mmTripartyCollateralInstructionIdentification, Transaction37.mmTransactionDetails);
