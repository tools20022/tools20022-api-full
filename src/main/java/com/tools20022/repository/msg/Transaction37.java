...
public class Transaction37 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails67.mmObject();
		}
	};
	...
	public Transaction37 setTransactionDetails(com.tools20022.repository.msg.TransactionDetails67 transactionDetails) {
