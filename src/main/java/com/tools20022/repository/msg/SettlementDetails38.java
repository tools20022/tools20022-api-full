...
public class SettlementDetails38 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> com.tools20022.repository.msg.HoldIndicator3.mmObject();
		}
	};
	...
	public SettlementDetails38 setHoldIndicator(com.tools20022.repository.msg.HoldIndicator3 holdIndicator) {
	...
	public SettlementDetails38 setStampDutyTaxBasis(com.tools20022.repository.msg.GenericIdentification25 stampDutyTaxBasis) {
