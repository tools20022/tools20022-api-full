 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CalculationBasis1#Structured
...
public class CalculationBasis1 {
	 ...
	 * {@linkplain com.tools20022.repository.entity.Charges#CalculationBasis
	...
	public static final MMMessageAttribute Structured = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CalculationBasis1.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Charges.CalculationBasis;
			isDerived = false;
			xmlTag = "Strd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CalculationBasis1.Structured, com.tools20022.repository.msg.CalculationBasis1.AdditionalInformation);
