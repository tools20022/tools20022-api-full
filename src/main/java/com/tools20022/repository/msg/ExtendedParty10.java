 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.ExtendedParty8
 * ExtendedParty8}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ExtendedParty10", propOrder = {"extendedPartyRole", "otherPartyDetails"})
public class ExtendedParty10 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ExtendedParty10
	 * ExtendedParty10}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExtendedParty10, Extended350Code> mmExtendedPartyRole = new MMMessageAttribute<ExtendedParty10, Extended350Code>() {
		{
			businessComponentTrace_lazy = () -> InvestmentAccountPartyRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ExtendedParty10.mmObject();
			isDerived = false;
			xmlTag = "XtndedPtyRole";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ExtendedPartyRole";
			definition = "Other type of party's role.";
			nextVersions_lazy = () -> Arrays.asList(ExtendedParty12.mmExtendedPartyRole);
			previousVersion_lazy = () -> ExtendedParty8.mmExtendedPartyRole;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Extended350Code getValue(ExtendedParty10 obj) {
			return obj.getExtendedPartyRole();
		}

		@Override
		public void setValue(ExtendedParty10 obj, Extended350Code value) {
			obj.setExtendedPartyRole(value);
		}
	};
	@XmlElement(name = "OthrPtyDtls", required = true)
	protected InvestmentAccountOwnershipInformation13 otherPartyDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExtendedParty10, InvestmentAccountOwnershipInformation13> mmOtherPartyDetails = new MMMessageAssociationEnd<ExtendedParty10, InvestmentAccountOwnershipInformation13>() {
		{
			businessComponentTrace_lazy = () -> InvestmentAccountPartyRole.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.ExtendedParty10.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ExtendedParty12.mmOtherPartyDetails);
			previousVersion_lazy = () -> ExtendedParty8.mmOtherPartyDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public InvestmentAccountOwnershipInformation13 getValue(ExtendedParty10 obj) {
			return obj.getOtherPartyDetails();
		}

		@Override
		public void setValue(ExtendedParty10 obj, InvestmentAccountOwnershipInformation13 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty10.mmExtendedPartyRole, com.tools20022.repository.msg.ExtendedParty10.mmOtherPartyDetails);
				trace_lazy = () -> InvestmentAccountPartyRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ExtendedParty10";
				definition = "Other type of party.";
				nextVersions_lazy = () -> Arrays.asList(ExtendedParty12.mmObject());
				previousVersion_lazy = () -> ExtendedParty8.mmObject();
			}
		});
	...
	public ExtendedParty10 setExtendedPartyRole(Extended350Code extendedPartyRole) {
		this.extendedPartyRole = Objects.requireNonNull(extendedPartyRole);
		return this;
	}

	public InvestmentAccountOwnershipInformation13 getOtherPartyDetails() {
		return otherPartyDetails;
	}

	public ExtendedParty10 setOtherPartyDetails(InvestmentAccountOwnershipInformation13 otherPartyDetails) {
