...
public class GenericIdentification63 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification63.Identification, com.tools20022.repository.msg.GenericIdentification63.Issuer,
						com.tools20022.repository.msg.GenericIdentification63.SchemeName);
