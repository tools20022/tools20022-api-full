...
public class Accounts2 {
	...
	public static final MMMessageAssociationEnd mmAccountReport = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Accounts2.mmObject();
			isDerived = false;
			xmlTag = "AcctRpt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Accounts2.mmAccountReport);
	...
	public void setAccountReport(List<com.tools20022.repository.msg.AccountReport7> accountReport) {
