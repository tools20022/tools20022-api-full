...
public class GenericIdentification35 {
	...
	public static final MMMessageAttribute<GenericIdentification35, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification35, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification71.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<GenericIdentification35, Optional<PartyType5Code>> mmType = new MMMessageAttribute<GenericIdentification35, Optional<PartyType5Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification71.mmType);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<GenericIdentification35, Optional<PartyType6Code>> mmIssuer = new MMMessageAttribute<GenericIdentification35, Optional<PartyType6Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification71.mmIssuer);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<GenericIdentification35, Optional<Max35Text>> mmShortName = new MMMessageAttribute<GenericIdentification35, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(GenericIdentification71.mmShortName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification35.mmIdentification, com.tools20022.repository.msg.GenericIdentification35.mmType,
						com.tools20022.repository.msg.GenericIdentification35.mmIssuer, com.tools20022.repository.msg.GenericIdentification35.mmShortName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GenericIdentification35";
				definition = "Identification of an entity.";
				nextVersions_lazy = () -> Arrays.asList(GenericIdentification71.mmObject());
			}
		});
	...
	public GenericIdentification35 setIdentification(Max35Text identification) {
	...
	public GenericIdentification35 setType(PartyType5Code type) {
		this.type = type;
		return this;
	}
	...
	public GenericIdentification35 setIssuer(PartyType6Code issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification35 setShortName(Max35Text shortName) {
