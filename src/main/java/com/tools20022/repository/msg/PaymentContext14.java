 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext14#mmCardPresent
...
@XmlType(name = "PaymentContext14", propOrder = {"cardPresent", "cardholderPresent", "attendanceContext", "transactionEnvironment", "transactionChannel", "attendantMessageCapable", "attendantLanguage", "cardDataEntryMode",
...
public class PaymentContext14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext14.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CardPresent";
			definition = "Indicates whether the transaction has been initiated by a card physically present or not.";
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmCardPresent);
			previousVersion_lazy = () -> PaymentContext8.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext14 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmCardholderPresent);
			previousVersion_lazy = () -> PaymentContext8.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext14, Optional<AttendanceContext1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmAttendanceContext);
			previousVersion_lazy = () -> PaymentContext8.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext14 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext14, Optional<TransactionEnvironment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmTransactionEnvironment);
			previousVersion_lazy = () -> PaymentContext8.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext14 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext14, Optional<TransactionChannel3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmTransactionChannel);
			previousVersion_lazy = () -> PaymentContext8.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext14 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>> mmAttendantMessageCapable = new MMMessageAttribute<PaymentContext14, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmAttendantMessageCapable);
			previousVersion_lazy = () -> PaymentContext8.mmAttendantMessageCapable;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<LanguageCode>> mmAttendantLanguage = new MMMessageAttribute<PaymentContext14, Optional<LanguageCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmAttendantLanguage);
			previousVersion_lazy = () -> PaymentContext8.mmAttendantLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(PaymentContext14 obj) {
			return obj.getAttendantLanguage();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, CardDataReading5Code> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext14, CardDataReading5Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmCardDataEntryMode);
			previousVersion_lazy = () -> PaymentContext8.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CardDataReading5Code getValue(PaymentContext14 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext14 obj, CardDataReading5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext14, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext14.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmFallbackIndicator);
			previousVersion_lazy = () -> PaymentContext8.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext14 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext14 obj, Optional<CardFallback1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext14, List<SupportedPaymentOption1Code>> mmSupportedOption = new MMMessageAttribute<PaymentContext14, List<SupportedPaymentOption1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext14.mmObject();
			isDerived = false;
			xmlTag = "SpprtdOptn";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext20.mmSupportedOption);
			previousVersion_lazy = () -> PaymentContext8.mmSupportedOption;
			minOccurs = 0;
			simpleType_lazy = () -> SupportedPaymentOption1Code.mmObject();
		}

		@Override
		public List<SupportedPaymentOption1Code> getValue(PaymentContext14 obj) {
			return obj.getSupportedOption();
		}

		@Override
		public void setValue(PaymentContext14 obj, List<SupportedPaymentOption1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext14.mmCardPresent, com.tools20022.repository.msg.PaymentContext14.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext14.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext14.mmTransactionEnvironment, com.tools20022.repository.msg.PaymentContext14.mmTransactionChannel,
						com.tools20022.repository.msg.PaymentContext14.mmAttendantMessageCapable, com.tools20022.repository.msg.PaymentContext14.mmAttendantLanguage, com.tools20022.repository.msg.PaymentContext14.mmCardDataEntryMode,
						com.tools20022.repository.msg.PaymentContext14.mmFallbackIndicator, com.tools20022.repository.msg.PaymentContext14.mmSupportedOption);
	...
	public PaymentContext14 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext14 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext14 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext14 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext14 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext14 setAttendantMessageCapable(TrueFalseIndicator attendantMessageCapable) {
	...
	public PaymentContext14 setAttendantLanguage(LanguageCode attendantLanguage) {
	...
	public PaymentContext14 setCardDataEntryMode(CardDataReading5Code cardDataEntryMode) {
	...
	public PaymentContext14 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
	...
	public PaymentContext14 setSupportedOption(List<SupportedPaymentOption1Code> supportedOption) {
