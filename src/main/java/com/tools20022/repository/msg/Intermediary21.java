...
import com.tools20022.repository.msg.Account11;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Intermediary21#mmIdentification
 * Intermediary21.mmIdentification}</li>
...
@XmlType(name = "Intermediary21", propOrder = {"identification", "role", "account"})
public class Intermediary21 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.Intermediary21 Intermediary21}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Intermediary21, PartyIdentification49Choice> mmIdentification = new MMMessageAssociationEnd<Intermediary21, PartyIdentification49Choice>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Intermediary21.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public PartyIdentification49Choice getValue(Intermediary21 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(Intermediary21 obj, PartyIdentification49Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Intermediary21, Optional<Role2Choice>> mmRole = new MMMessageAssociationEnd<Intermediary21, Optional<Role2Choice>>() {
		{
		...
		@Override
		public Optional<Role2Choice> getValue(Intermediary21 obj) {
			return obj.getRole();
		}

		@Override
		public void setValue(Intermediary21 obj, Optional<Role2Choice> value) {
			obj.setRole(value.orElse(null));
		}
	};
	@XmlElement(name = "Acct")
	protected Account11 account;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.Account11 Account11}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Intermediary21, Optional<Account11>> mmAccount = new MMMessageAssociationEnd<Intermediary21, Optional<Account11>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Account11.mmObject();
		}

		@Override
		public Optional<Account11> getValue(Intermediary21 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(Intermediary21 obj, Optional<Account11> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Intermediary21.mmIdentification, com.tools20022.repository.msg.Intermediary21.mmRole, com.tools20022.repository.msg.Intermediary21.mmAccount);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesBalanceAccountingReportV04.mmIntermediaryInformation, SecuritiesBalanceAccountingReportV05.mmIntermediaryInformation,
						SecuritiesBalanceCustodyReportV04.mmIntermediaryInformation, SecuritiesBalanceCustodyReportV05.mmIntermediaryInformation);
				...
				nextVersions_lazy = () -> Arrays.asList(Intermediary23.mmObject());
			}
		});
	...
	public Intermediary21 setIdentification(PartyIdentification49Choice identification) {
	...
	public Intermediary21 setRole(Role2Choice role) {
		this.role = role;
		return this;
	}

	public Optional<Account11> getAccount() {
		return account == null ? Optional.empty() : Optional.of(account);
	}

	public Intermediary21 setAccount(Account11 account) {
