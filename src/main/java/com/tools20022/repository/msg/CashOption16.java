 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption16#mmAmountDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption16#mmPriceDetails
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forCashOption16
 * ConstraintCoexistenceAmountRule.forCashOption16}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule#forCashOption16
 * ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption16}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.CashOption11
 * CashOption11}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CashOption16", propOrder = {"creditDebitIndicator", "contractualPaymentIndicator", "nonEligibleProceedsIndicator", "issuerOfferorTaxabilityIndicator", "incomeType", "cashAccountIdentification", "amountDetails",
...
public class CashOption16 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption16, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashOption16, CreditDebitCode>() {
		{
			businessElementTrace_lazy = () -> ProceedsDefinition.mmCreditDebitIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption16.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
		...
		@Override
		public CreditDebitCode getValue(CashOption16 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashOption16 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption16, Optional<Payment1Code>> mmContractualPaymentIndicator = new MMMessageAttribute<CashOption16, Optional<Payment1Code>>() {
		{
		...
		@Override
		public Optional<Payment1Code> getValue(CashOption16 obj) {
			return obj.getContractualPaymentIndicator();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<Payment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<NonEligibleProceedsIndicator1Choice>> mmNonEligibleProceedsIndicator = new MMMessageAssociationEnd<CashOption16, Optional<NonEligibleProceedsIndicator1Choice>>() {
		{
		...
		@Override
		public Optional<NonEligibleProceedsIndicator1Choice> getValue(CashOption16 obj) {
			return obj.getNonEligibleProceedsIndicator();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<NonEligibleProceedsIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption16, Optional<IssuerTaxability1Code>> mmIssuerOfferorTaxabilityIndicator = new MMMessageAttribute<CashOption16, Optional<IssuerTaxability1Code>>() {
		{
		...
		@Override
		public Optional<IssuerTaxability1Code> getValue(CashOption16 obj) {
			return obj.getIssuerOfferorTaxabilityIndicator();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<IssuerTaxability1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<GenericIdentification20>> mmIncomeType = new MMMessageAssociationEnd<CashOption16, Optional<GenericIdentification20>>() {
		{
		...
		@Override
		public Optional<GenericIdentification20> getValue(CashOption16 obj) {
			return obj.getIncomeType();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<CashAccountIdentification5Choice>> mmCashAccountIdentification = new MMMessageAssociationEnd<CashOption16, Optional<CashAccountIdentification5Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(CashOption16 obj) {
			return obj.getCashAccountIdentification();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<CashAccountIdentification5Choice> value) {
			obj.setCashAccountIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "AmtDtls")
	protected CorporateActionAmounts16 amountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<CorporateActionAmounts16>> mmAmountDetails = new MMMessageAssociationEnd<CashOption16, Optional<CorporateActionAmounts16>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionAmounts16.mmObject();
		}

		@Override
		public Optional<CorporateActionAmounts16> getValue(CashOption16 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<CorporateActionAmounts16> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, CorporateActionDate23> mmDateDetails = new MMMessageAssociationEnd<CashOption16, CorporateActionDate23>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption16.mmObject();
			isDerived = false;
		...
		@Override
		public CorporateActionDate23 getValue(CashOption16 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CashOption16 obj, CorporateActionDate23 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<ForeignExchangeTerms13>> mmForeignExchangeDetails = new MMMessageAssociationEnd<CashOption16, Optional<ForeignExchangeTerms13>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms13> getValue(CashOption16 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<ForeignExchangeTerms13> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<RateDetails3>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CashOption16, Optional<RateDetails3>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption16.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<RateDetails3> getValue(CashOption16 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<RateDetails3> value) {
			obj.setRateAndAmountDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "PricDtls")
	protected PriceDetails6 priceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.PriceDetails6
	 * PriceDetails6}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption16, Optional<PriceDetails6>> mmPriceDetails = new MMMessageAssociationEnd<CashOption16, Optional<PriceDetails6>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PriceDetails6.mmObject();
		}

		@Override
		public Optional<PriceDetails6> getValue(CashOption16 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CashOption16 obj, Optional<PriceDetails6> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOption16.mmCreditDebitIndicator, com.tools20022.repository.msg.CashOption16.mmContractualPaymentIndicator,
						com.tools20022.repository.msg.CashOption16.mmNonEligibleProceedsIndicator, com.tools20022.repository.msg.CashOption16.mmIssuerOfferorTaxabilityIndicator, com.tools20022.repository.msg.CashOption16.mmIncomeType,
						com.tools20022.repository.msg.CashOption16.mmCashAccountIdentification, com.tools20022.repository.msg.CashOption16.mmAmountDetails, com.tools20022.repository.msg.CashOption16.mmDateDetails,
						com.tools20022.repository.msg.CashOption16.mmForeignExchangeDetails, com.tools20022.repository.msg.CashOption16.mmRateAndAmountDetails, com.tools20022.repository.msg.CashOption16.mmPriceDetails);
				trace_lazy = () -> CashProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCashOption16,
						com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption16);
				...
				nextVersions_lazy = () -> Arrays.asList(CashOption25.mmObject());
				previousVersion_lazy = () -> CashOption11.mmObject();
			}
		});
	...
	public CashOption16 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption16 setContractualPaymentIndicator(Payment1Code contractualPaymentIndicator) {
	...
	public CashOption16 setNonEligibleProceedsIndicator(NonEligibleProceedsIndicator1Choice nonEligibleProceedsIndicator) {
	...
	public CashOption16 setIssuerOfferorTaxabilityIndicator(IssuerTaxability1Code issuerOfferorTaxabilityIndicator) {
	...
	public CashOption16 setIncomeType(GenericIdentification20 incomeType) {
	...
	public CashOption16 setCashAccountIdentification(CashAccountIdentification5Choice cashAccountIdentification) {
		this.cashAccountIdentification = cashAccountIdentification;
		return this;
	}

	public Optional<CorporateActionAmounts16> getAmountDetails() {
		return amountDetails == null ? Optional.empty() : Optional.of(amountDetails);
	}

	public CashOption16 setAmountDetails(CorporateActionAmounts16 amountDetails) {
	...
	public CashOption16 setDateDetails(CorporateActionDate23 dateDetails) {
	...
	public CashOption16 setForeignExchangeDetails(ForeignExchangeTerms13 foreignExchangeDetails) {
	...
	public CashOption16 setRateAndAmountDetails(RateDetails3 rateAndAmountDetails) {
		this.rateAndAmountDetails = rateAndAmountDetails;
		return this;
	}

	public Optional<PriceDetails6> getPriceDetails() {
		return priceDetails == null ? Optional.empty() : Optional.of(priceDetails);
	}

	public CashOption16 setPriceDetails(PriceDetails6 priceDetails) {
