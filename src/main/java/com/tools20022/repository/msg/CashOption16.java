...
public class CashOption16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption16.mmCreditDebitIndicator, CashOption16.mmContractualPaymentIndicator, CashOption16.mmNonEligibleProceedsIndicator, CashOption16.mmIssuerOfferorTaxabilityIndicator,
						CashOption16.mmIncomeType, CashOption16.mmCashAccountIdentification, CashOption16.mmAmountDetails, CashOption16.mmDateDetails, CashOption16.mmForeignExchangeDetails, CashOption16.mmRateAndAmountDetails,
						CashOption16.mmPriceDetails);
