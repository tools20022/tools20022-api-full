...
public class ExtendedParty2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty2.ExtendedPartyRole, com.tools20022.repository.msg.ExtendedParty2.OtherPartyDetails);
