...
import com.tools20022.repository.codeset.WaivingInstruction2Code;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.WaivingType1#mmAdditionalInformation
 * WaivingType1.mmAdditionalInformation}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintOtherCodeRule#forWaivingType1
 * ConstraintOtherCodeRule.forWaivingType1}</li>
 * </ul>
 * </li>
 * <li>
...
public class WaivingType1 {
	...
	protected WaivingInstruction2Code structured;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute mmAdditionalInformation = new MMMessageAttribute() {
		{
			...
			definition = "Additional information about the type of waiving.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.WaivingType1.mmStructured, com.tools20022.repository.msg.WaivingType1.mmAdditionalInformation);
				trace_lazy = () -> CommissionWaiver.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOtherCodeRule.forWaivingType1);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "WaivingType1";
				definition = "Specification of the waiving type.";
			}
		});
	...
	public WaivingType1 setStructured(WaivingInstruction2Code structured) {
	...
	public WaivingType1 setAdditionalInformation(Max350Text additionalInformation) {
