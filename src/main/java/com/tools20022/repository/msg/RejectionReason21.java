...
public class RejectionReason21 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason21.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason21.mmCode, RejectionReason21.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason19Choice code) {
		this.code = code;
	}
