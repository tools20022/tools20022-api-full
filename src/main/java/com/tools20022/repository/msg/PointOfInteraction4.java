...
public class PointOfInteraction4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PointOfInteraction4.mmIdentification, PointOfInteraction4.mmSystemName, PointOfInteraction4.mmGroupIdentification, PointOfInteraction4.mmCapabilities,
						PointOfInteraction4.mmComponent);
