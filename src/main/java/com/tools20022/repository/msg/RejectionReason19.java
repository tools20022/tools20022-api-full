...
public class RejectionReason19 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason19.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason19.mmCode, RejectionReason19.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason17Choice code) {
		this.code = code;
	}
