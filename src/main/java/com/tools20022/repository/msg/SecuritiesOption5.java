...
public class SecuritiesOption5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption5.mmSecurityIdentification, SecuritiesOption5.mmCreditDebitIndicator, SecuritiesOption5.mmPostingQuantity, SecuritiesOption5.mmPostingDate,
						SecuritiesOption5.mmOriginalPostingDate);
