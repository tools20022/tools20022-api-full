 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintISO8532AndIssuerSchemeNameRule#forSecuritiesCertificate5
 * ConstraintISO8532AndIssuerSchemeNameRule.forSecuritiesCertificate5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SecuritiesCertificate5", propOrder = {"number", "issuer", "schemeName"})
public class SecuritiesCertificate5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesCertificate5, RestrictedFINXMax30Text> mmNumber = new MMMessageAttribute<SecuritiesCertificate5, RestrictedFINXMax30Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesCertificate5.mmObject();
			isDerived = false;
			xmlTag = "Nb";
		...
		@Override
		public RestrictedFINXMax30Text getValue(SecuritiesCertificate5 obj) {
			return obj.getNumber();
		}

		@Override
		public void setValue(SecuritiesCertificate5 obj, RestrictedFINXMax30Text value) {
			obj.setNumber(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesCertificate5, Optional<Max4AlphaNumericText>> mmIssuer = new MMMessageAttribute<SecuritiesCertificate5, Optional<Max4AlphaNumericText>>() {
		{
		...
		@Override
		public Optional<Max4AlphaNumericText> getValue(SecuritiesCertificate5 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(SecuritiesCertificate5 obj, Optional<Max4AlphaNumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesCertificate5, Optional<Max4AlphaNumericText>> mmSchemeName = new MMMessageAttribute<SecuritiesCertificate5, Optional<Max4AlphaNumericText>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesCertificate5.mmNumber, com.tools20022.repository.msg.SecuritiesCertificate5.mmIssuer,
						com.tools20022.repository.msg.SecuritiesCertificate5.mmSchemeName);
				trace_lazy = () -> SecuritiesCertificate.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintISO8532AndIssuerSchemeNameRule.forSecuritiesCertificate5);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesCertificate5";
	...
	public SecuritiesCertificate5 setNumber(RestrictedFINXMax30Text number) {
	...
	public SecuritiesCertificate5 setIssuer(Max4AlphaNumericText issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public SecuritiesCertificate5 setSchemeName(Max4AlphaNumericText schemeName) {
