...
public class AccountAndBalance10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance10.mmSafekeepingAccount, AccountAndBalance10.mmAccountOwner, AccountAndBalance10.mmSafekeepingPlace, AccountAndBalance10.mmBalance);
