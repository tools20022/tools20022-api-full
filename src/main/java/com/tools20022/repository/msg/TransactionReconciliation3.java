...
public class TransactionReconciliation3 {
	...
	public static final MMMessageAttribute ClosePeriod = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TransactionReconciliation3.mmObject();
			isDerived = false;
			xmlTag = "ClsPrd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ClosePeriod";
			definition = "Indicates if the transaction requires a closure of the reconciliation period.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionReconciliation2.ClosePeriod;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation4.ClosePeriod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ReconciliationTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionReconciliation2.ReconciliationTransactionIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation4.ReconciliationTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReconciliationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionReconciliation2.ReconciliationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation4.ReconciliationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TransactionTotals = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionReconciliation2.TransactionTotals;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation4.TransactionTotals);
			minOccurs = 0;
	...
	public static final MMMessageAttribute AdditionalTransactionData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransactionReconciliation2.AdditionalTransactionData;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation4.AdditionalTransactionData);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionReconciliation3.ClosePeriod, com.tools20022.repository.msg.TransactionReconciliation3.ReconciliationTransactionIdentification,
						com.tools20022.repository.msg.TransactionReconciliation3.ReconciliationIdentification, com.tools20022.repository.msg.TransactionReconciliation3.TransactionTotals,
						com.tools20022.repository.msg.TransactionReconciliation3.AdditionalTransactionData);
