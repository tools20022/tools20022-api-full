 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Balance12#ShortLongIndicator
...
public class Balance12 {
	...
	public static final MMMessageAttribute ShortLongIndicator = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Balance12.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Balance12.ShortLongIndicator, com.tools20022.repository.msg.Balance12.Quantity);
