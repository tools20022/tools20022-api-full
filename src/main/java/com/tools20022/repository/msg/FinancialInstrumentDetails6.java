...
public class FinancialInstrumentDetails6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails6.mmFinancialInstrumentIdentification, FinancialInstrumentDetails6.mmFinancialInstrumentAttributes, FinancialInstrumentDetails6.mmSubBalance);
	...
	public void setFinancialInstrumentAttributes(com.tools20022.repository.msg.FinancialInstrumentAttributes21 financialInstrumentAttributes) {
	...
	public void setSubBalance(List<com.tools20022.repository.msg.IntraPositionDetails17> subBalance) {
