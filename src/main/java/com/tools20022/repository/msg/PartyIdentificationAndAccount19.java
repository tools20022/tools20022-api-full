...
public class PartyIdentificationAndAccount19 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount19.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount19.mmIdentification, PartyIdentificationAndAccount19.mmAlternateIdentification, PartyIdentificationAndAccount19.mmCountryOfResidence,
						PartyIdentificationAndAccount19.mmSafekeepingAccount, PartyIdentificationAndAccount19.mmProcessingIdentification, PartyIdentificationAndAccount19.mmAdditionalInformation);
