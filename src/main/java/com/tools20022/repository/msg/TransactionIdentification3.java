...
public class TransactionIdentification3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentification3.mmAccountOwnerTransactionIdentification, TransactionIdentification3.mmAccountServicerTransactionIdentification,
						TransactionIdentification3.mmMarketInfrastructureTransactionIdentification, TransactionIdentification3.mmProcessorTransactionIdentification);
