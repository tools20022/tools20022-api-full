...
import com.tools20022.repository.msg.FinancialInstrumentAttributes65;
 ...
 * CorporateActionGeneralInformation88.mmCorporateActionEventIdentification}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation88", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "underlyingSecurity"})
public class CorporateActionGeneralInformation88 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation88, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation88, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation88.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation71.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation88 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation88 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation88, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation88, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmOfficialCorporateActionEventIdentification);
			previousVersion_lazy = () -> CorporateActionGeneralInformation71.mmOfficialCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation88 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation88 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation88, CorporateActionEventType32Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation88, CorporateActionEventType32Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmEventType);
			previousVersion_lazy = () -> CorporateActionGeneralInformation71.mmEventType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CorporateActionEventType32Choice getValue(CorporateActionGeneralInformation88 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation88 obj, CorporateActionEventType32Choice value) {
			obj.setEventType(value);
		}
	};
	@XmlElement(name = "UndrlygScty")
	protected FinancialInstrumentAttributes65 underlyingSecurity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation88, Optional<FinancialInstrumentAttributes65>> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation88, Optional<FinancialInstrumentAttributes65>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmUnderlyingSecurity);
			previousVersion_lazy = () -> CorporateActionGeneralInformation71.mmUnderlyingSecurity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentAttributes65.mmObject();
		}

		@Override
		public Optional<FinancialInstrumentAttributes65> getValue(CorporateActionGeneralInformation88 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation88 obj, Optional<FinancialInstrumentAttributes65> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionGeneralInformation88.mmCorporateActionEventIdentification,
						com.tools20022.repository.msg.CorporateActionGeneralInformation88.mmOfficialCorporateActionEventIdentification, com.tools20022.repository.msg.CorporateActionGeneralInformation88.mmEventType,
						com.tools20022.repository.msg.CorporateActionGeneralInformation88.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionV06.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation88,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation88);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionGeneralInformation88";
				definition = "General information about the corporate action event.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmObject());
				previousVersion_lazy = () -> CorporateActionGeneralInformation71.mmObject();
			}
		});
	...
	public CorporateActionGeneralInformation88 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation88 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation88 setEventType(CorporateActionEventType32Choice eventType) {
		this.eventType = Objects.requireNonNull(eventType);
		return this;
	}

	public Optional<FinancialInstrumentAttributes65> getUnderlyingSecurity() {
		return underlyingSecurity == null ? Optional.empty() : Optional.of(underlyingSecurity);
	}

	public CorporateActionGeneralInformation88 setUnderlyingSecurity(FinancialInstrumentAttributes65 underlyingSecurity) {
