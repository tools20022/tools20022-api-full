...
public class OriginalTransactionReference17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalTransactionReference17.mmInterbankSettlementAmount, OriginalTransactionReference17.mmAmount, OriginalTransactionReference17.mmInterbankSettlementDate,
						OriginalTransactionReference17.mmRequestedCollectionDate, OriginalTransactionReference17.mmRequestedExecutionDate, OriginalTransactionReference17.mmCreditorSchemeIdentification,
						OriginalTransactionReference17.mmSettlementInformation, OriginalTransactionReference17.mmPaymentTypeInformation, OriginalTransactionReference17.mmPaymentMethod,
						OriginalTransactionReference17.mmMandateRelatedInformation, OriginalTransactionReference17.mmRemittanceInformation, OriginalTransactionReference17.mmUltimateDebtor, OriginalTransactionReference17.mmDebtor,
						OriginalTransactionReference17.mmDebtorAccount, OriginalTransactionReference17.mmDebtorAgent, OriginalTransactionReference17.mmCreditorAgent, OriginalTransactionReference17.mmCreditor,
						OriginalTransactionReference17.mmCreditorAccount, OriginalTransactionReference17.mmUltimateCreditor);
