...
public class OriginalTransactionReference17 {
	...
	public static final MMMessageAttribute mmInterbankSettlementAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OriginalTransactionReference17.mmObject();
			isDerived = false;
	...
	public MandateRelatedInformation9 getMandateRelatedInformation() {
		return mandateRelatedInformation;
	}

	public void setMandateRelatedInformation(com.tools20022.repository.msg.MandateRelatedInformation9 mandateRelatedInformation) {
