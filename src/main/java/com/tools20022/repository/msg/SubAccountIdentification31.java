...
public class SubAccountIdentification31 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification31.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification31.mmAccountOwner, SubAccountIdentification31.mmSafekeepingAccount, SubAccountIdentification31.mmActivityIndicator,
						SubAccountIdentification31.mmBalanceForSubAccount);
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation23> balanceForSubAccount) {
