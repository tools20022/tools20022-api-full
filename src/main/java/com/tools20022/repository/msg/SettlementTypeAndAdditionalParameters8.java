...
public class SettlementTypeAndAdditionalParameters8 {
	...
	public static final MMMessageAttribute mmSecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndAdditionalParameters8.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters8.mmSecuritiesMovementType, SettlementTypeAndAdditionalParameters8.mmPayment, SettlementTypeAndAdditionalParameters8.mmCommonIdentification,
						SettlementTypeAndAdditionalParameters8.mmCorporateActionEventIdentification, SettlementTypeAndAdditionalParameters8.mmReconciliationIndicator);
