...
public class SettlementInformation11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementInformation11, SettlementMethod2Code> mmSettlementMethod = new MMMessageAttribute<SettlementInformation11, SettlementMethod2Code>() {
		{
		...
		@Override
		public SettlementMethod2Code getValue(SettlementInformation11 obj) {
			return obj.getSettlementMethod();
		}

		@Override
		public void setValue(SettlementInformation11 obj, SettlementMethod2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation11, Optional<CashAccount10>> mmSettlementAccount = new MMMessageAssociationEnd<SettlementInformation11, Optional<CashAccount10>>() {
		{
		...
		@Override
		public Optional<CashAccount10> getValue(SettlementInformation11 obj) {
			return obj.getSettlementAccount();
		}

		@Override
		public void setValue(SettlementInformation11 obj, Optional<CashAccount10> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementInformation11, Optional<ClearingSystemIdentification1Choice>> mmClearingSystem = new MMMessageAssociationEnd<SettlementInformation11, Optional<ClearingSystemIdentification1Choice>>() {
		{
		...
		@Override
		public Optional<ClearingSystemIdentification1Choice> getValue(SettlementInformation11 obj) {
			return obj.getClearingSystem();
		}

		@Override
		public void setValue(SettlementInformation11 obj, Optional<ClearingSystemIdentification1Choice> value) {
	...
	public SettlementInformation11 setSettlementAccount(CashAccount10 settlementAccount) {
