...
public class SettlementInformation11 {
	...
	public static final MMMessageAttribute SettlementMethod = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlementInformation11.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementInformation11.SettlementMethod, com.tools20022.repository.msg.SettlementInformation11.SettlementAccount,
						com.tools20022.repository.msg.SettlementInformation11.ClearingSystem);
