...
import com.tools20022.repository.msg.CardPaymentTransactionDetails13;
...
@XmlType(name = "CardPaymentTransaction23", propOrder = {"saleReferenceIdentification", "transactionIdentification", "recipientTransactionIdentification", "reconciliationIdentification", "interchangeData", "transactionDetails"})
public class CardPaymentTransaction23 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>> mmSaleReferenceIdentification = new MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction23.mmObject();
			isDerived = false;
			xmlTag = "SaleRefId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SaleReferenceIdentification";
			definition = "Global reference of the sale transaction for the sale system.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmSaleReferenceIdentification);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(CardPaymentTransaction23 obj) {
			return obj.getSaleReferenceIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction23 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction23, TransactionIdentifier1> mmTransactionIdentification = new MMMessageAssociationEnd<CardPaymentTransaction23, TransactionIdentifier1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction2.mmTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public TransactionIdentifier1 getValue(CardPaymentTransaction23 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(CardPaymentTransaction23 obj, TransactionIdentifier1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>> mmRecipientTransactionIdentification = new MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransaction23.mmObject();
			isDerived = false;
			xmlTag = "RcptTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmRecipientTransactionIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction2.mmRecipientTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>> mmReconciliationIdentification = new MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmReconciliationIdentification);
			previousVersion_lazy = () -> CardPaymentTransaction2.mmReconciliationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>> mmInterchangeData = new MMMessageAttribute<CardPaymentTransaction23, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmInterchangeData);
			previousVersion_lazy = () -> CardPaymentTransaction2.mmInterchangeData;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	protected CardPaymentTransactionDetails13 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransaction23, CardPaymentTransactionDetails13> mmTransactionDetails = new MMMessageAssociationEnd<CardPaymentTransaction23, CardPaymentTransactionDetails13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmTransactionDetails);
			previousVersion_lazy = () -> CardPaymentTransaction2.mmTransactionDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CardPaymentTransactionDetails13.mmObject();
		}

		@Override
		public CardPaymentTransactionDetails13 getValue(CardPaymentTransaction23 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(CardPaymentTransaction23 obj, CardPaymentTransactionDetails13 value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransaction23.mmSaleReferenceIdentification, com.tools20022.repository.msg.CardPaymentTransaction23.mmTransactionIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction23.mmRecipientTransactionIdentification, com.tools20022.repository.msg.CardPaymentTransaction23.mmReconciliationIdentification,
						com.tools20022.repository.msg.CardPaymentTransaction23.mmInterchangeData, com.tools20022.repository.msg.CardPaymentTransaction23.mmTransactionDetails);
				trace_lazy = () -> CardPayment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentTransaction23";
				definition = "Transaction information in the authorisation response.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransaction38.mmObject());
				previousVersion_lazy = () -> CardPaymentTransaction2.mmObject();
			}
		});
	...
	public CardPaymentTransaction23 setSaleReferenceIdentification(Max35Text saleReferenceIdentification) {
	...
	public CardPaymentTransaction23 setTransactionIdentification(TransactionIdentifier1 transactionIdentification) {
	...
	public CardPaymentTransaction23 setRecipientTransactionIdentification(Max35Text recipientTransactionIdentification) {
	...
	public CardPaymentTransaction23 setReconciliationIdentification(Max35Text reconciliationIdentification) {
	...
	public CardPaymentTransaction23 setInterchangeData(Max35Text interchangeData) {
		this.interchangeData = interchangeData;
		return this;
	}

	public CardPaymentTransactionDetails13 getTransactionDetails() {
		return transactionDetails;
	}

	public CardPaymentTransaction23 setTransactionDetails(CardPaymentTransactionDetails13 transactionDetails) {
