...
public class FinancialInstrumentAttributes27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes27.mmPlaceOfListing, FinancialInstrumentAttributes27.mmDayCountBasis, FinancialInstrumentAttributes27.mmRegistrationForm,
						FinancialInstrumentAttributes27.mmPaymentFrequency, FinancialInstrumentAttributes27.mmPaymentStatus, FinancialInstrumentAttributes27.mmPaymentDirection, FinancialInstrumentAttributes27.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes27.mmPreferenceToIncome, FinancialInstrumentAttributes27.mmClassificationType, FinancialInstrumentAttributes27.mmOptionStyle, FinancialInstrumentAttributes27.mmOptionType,
						FinancialInstrumentAttributes27.mmDenominationCurrency, FinancialInstrumentAttributes27.mmCouponDate, FinancialInstrumentAttributes27.mmExpiryDate, FinancialInstrumentAttributes27.mmFloatingRateFixingDate,
						FinancialInstrumentAttributes27.mmMaturityDate, FinancialInstrumentAttributes27.mmIssueDate, FinancialInstrumentAttributes27.mmNextCallableDate, FinancialInstrumentAttributes27.mmPutableDate,
						FinancialInstrumentAttributes27.mmDatedDate, FinancialInstrumentAttributes27.mmFirstPaymentDate, FinancialInstrumentAttributes27.mmPreviousFactor, FinancialInstrumentAttributes27.mmCurrentFactor,
						FinancialInstrumentAttributes27.mmNextFactor, FinancialInstrumentAttributes27.mmInterestRate, FinancialInstrumentAttributes27.mmNextInterestRate, FinancialInstrumentAttributes27.mmIndexRateBasis,
						FinancialInstrumentAttributes27.mmCouponAttachedNumber, FinancialInstrumentAttributes27.mmPoolNumber, FinancialInstrumentAttributes27.mmQuantityBreakdown, FinancialInstrumentAttributes27.mmVariableRateIndicator,
						FinancialInstrumentAttributes27.mmCallableIndicator, FinancialInstrumentAttributes27.mmPutableIndicator, FinancialInstrumentAttributes27.mmMarketOrIndicativePrice, FinancialInstrumentAttributes27.mmExercisePrice,
						FinancialInstrumentAttributes27.mmSubscriptionPrice, FinancialInstrumentAttributes27.mmConversionPrice, FinancialInstrumentAttributes27.mmStrikePrice, FinancialInstrumentAttributes27.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes27.mmContractSize, FinancialInstrumentAttributes27.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes27.mmFinancialInstrumentAttributeAdditionalDetails);
