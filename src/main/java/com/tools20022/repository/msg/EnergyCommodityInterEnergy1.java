...
import com.tools20022.repository.codeset.AssetClassSubProductType26Code;
...
@XmlType(name = "EnergyCommodityInterEnergy1", propOrder = {"baseProduct", "subProduct"})
public class EnergyCommodityInterEnergy1 {
	...
	protected AssetClassSubProductType26Code subProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EnergyCommodityInterEnergy1.mmBaseProduct, com.tools20022.repository.msg.EnergyCommodityInterEnergy1.mmSubProduct);
				trace_lazy = () -> Commodity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "EnergyCommodityInterEnergy1";
				definition = "Defines commodity sub-product attributes of an energy derivative of type inter energy.";
			}
		});
	...
	public EnergyCommodityInterEnergy1 setBaseProduct(AssetClassProductType2Code baseProduct) {
		this.baseProduct = Objects.requireNonNull(baseProduct);
		return this;
	}

	public AssetClassSubProductType26Code getSubProduct() {
		return subProduct;
	}

	public EnergyCommodityInterEnergy1 setSubProduct(AssetClassSubProductType26Code subProduct) {
