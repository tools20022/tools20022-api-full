 ...
 * <li>{@linkplain com.tools20022.repository.msg.StatusReportContent2#Event
 * StatusReportContent2.Event}</li>
 * <li>{@linkplain com.tools20022.repository.msg.StatusReportContent2#Errors
...
public class StatusReportContent2 {
	...
	public static final MMMessageAssociationEnd POICapabilities = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.POICapabilities);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd POIComponent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.POIComponent);
			minOccurs = 0;
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			definition = "Human attendance at the POI location during transactions.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.AttendanceContext);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute POIDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.POIDateTime);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DataSetRequired = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.DataSetRequired);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Event = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.Event);
			minOccurs = 0;
	...
	public static final MMMessageAttribute Errors = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent3.Errors);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent2.POICapabilities, com.tools20022.repository.msg.StatusReportContent2.POIComponent,
						com.tools20022.repository.msg.StatusReportContent2.AttendanceContext, com.tools20022.repository.msg.StatusReportContent2.POIDateTime, com.tools20022.repository.msg.StatusReportContent2.DataSetRequired,
						com.tools20022.repository.msg.StatusReportContent2.Event, com.tools20022.repository.msg.StatusReportContent2.Errors);
