...
public class AmountAndDirection67 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection67.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection67.mmAmount, AmountAndDirection67.mmCreditDebitIndicator, AmountAndDirection67.mmOriginalCurrencyAndOrderedAmount);
