...
public class RateTypeAndAmountAndStatus4 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RateTypeAndAmountAndStatus4.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus4.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus4.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus4.RateStatus);
