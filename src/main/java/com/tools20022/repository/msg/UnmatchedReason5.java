...
public class UnmatchedReason5 {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason5.mmCode, UnmatchedReason5.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason7Choice code) {
		this.code = code;
	}
