...
public class SecuritiesSettlementTransactionDetails11 {
	...
	public static final MMMessageAssociationEnd mmSettlementTypeAndAdditionalParameters = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesSettlementTransactionDetails11.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails11.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails11.mmLinkages,
						SecuritiesSettlementTransactionDetails11.mmTradeDetails, SecuritiesSettlementTransactionDetails11.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails11.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails11.mmSettlementParameters, SecuritiesSettlementTransactionDetails11.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionDetails11.mmDeliveringSettlementParties, SecuritiesSettlementTransactionDetails11.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails11.mmCashParties,
						SecuritiesSettlementTransactionDetails11.mmSettlementAmount, SecuritiesSettlementTransactionDetails11.mmOtherAmounts, SecuritiesSettlementTransactionDetails11.mmOtherBusinessParties,
						SecuritiesSettlementTransactionDetails11.mmAdditionalPhysicalOrRegistrationDetails, SecuritiesSettlementTransactionDetails11.mmSupplementaryData);
