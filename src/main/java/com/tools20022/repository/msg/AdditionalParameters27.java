 ...
 * AdditionalParameters27.mmTripartyAgentCollateralTransactionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.AdditionalParameters27#mmClientTripartyCollateralTransactionIdentification
 * AdditionalParameters27.mmClientTripartyCollateralTransactionIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline#forAdditionalParameters27
 * ConstraintPartialSettlementGuideline.forAdditionalParameters27}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AdditionalParameters27", propOrder = {"preConfirmation", "partialSettlement", "previousPartialConfirmationIdentification", "tripartyAgentCollateralTransactionIdentification",
...
public class AdditionalParameters27 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<PreConfirmation1Code>> mmPreConfirmation = new MMMessageAttribute<AdditionalParameters27, Optional<PreConfirmation1Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPreConfirmation;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters27.mmObject();
			isDerived = false;
			xmlTag = "PreConf";
		...
		@Override
		public Optional<PreConfirmation1Code> getValue(AdditionalParameters27 obj) {
			return obj.getPreConfirmation();
		}

		@Override
		public void setValue(AdditionalParameters27 obj, Optional<PreConfirmation1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<PartialSettlement2Code>> mmPartialSettlement = new MMMessageAttribute<AdditionalParameters27, Optional<PartialSettlement2Code>>() {
		{
		...
		@Override
		public Optional<PartialSettlement2Code> getValue(AdditionalParameters27 obj) {
			return obj.getPartialSettlement();
		}

		@Override
		public void setValue(AdditionalParameters27 obj, Optional<PartialSettlement2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>> mmPreviousPartialConfirmationIdentification = new MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(AdditionalParameters27 obj) {
			return obj.getPreviousPartialConfirmationIdentification();
		}

		@Override
		public void setValue(AdditionalParameters27 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmClientTripartyCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters27.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<AdditionalParameters27, Optional<RestrictedFINXMax16Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalParameters27.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalParameters27.mmPreConfirmation, com.tools20022.repository.msg.AdditionalParameters27.mmPartialSettlement,
						com.tools20022.repository.msg.AdditionalParameters27.mmPreviousPartialConfirmationIdentification, com.tools20022.repository.msg.AdditionalParameters27.mmTripartyAgentCollateralTransactionIdentification,
						...
						com.tools20022.repository.msg.AdditionalParameters27.mmTripartyCollateralInstructionIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmation002V06.mmAdditionalParameters);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPartialSettlementGuideline.forAdditionalParameters27);
	...
	public AdditionalParameters27 setPreConfirmation(PreConfirmation1Code preConfirmation) {
	...
	public AdditionalParameters27 setPartialSettlement(PartialSettlement2Code partialSettlement) {
	...
	public AdditionalParameters27 setPreviousPartialConfirmationIdentification(RestrictedFINXMax16Text previousPartialConfirmationIdentification) {
	...
	public AdditionalParameters27 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public AdditionalParameters27 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
	...
	public AdditionalParameters27 setClientCollateralInstructionIdentification(RestrictedFINXMax16Text clientCollateralInstructionIdentification) {
	...
	public AdditionalParameters27 setTripartyCollateralInstructionIdentification(RestrictedFINXMax16Text tripartyCollateralInstructionIdentification) {
