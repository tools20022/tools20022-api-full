...
public class PaymentCommon3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCommon3, Optional<System1>> mmPaymentFrom = new MMMessageAssociationEnd<PaymentCommon3, Optional<System1>>() {
		{
		...
		@Override
		public Optional<System1> getValue(PaymentCommon3 obj) {
			return obj.getPaymentFrom();
		}

		@Override
		public void setValue(PaymentCommon3 obj, Optional<System1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCommon3, Optional<System1>> mmPaymentTo = new MMMessageAssociationEnd<PaymentCommon3, Optional<System1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentCommon3.mmObject();
			isDerived = false;
			xmlTag = "PmtTo";
	...
	protected List<PaymentStatus3> commonStatus;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCommon3, List<PaymentStatus3>> mmCommonStatus = new MMMessageAssociationEnd<PaymentCommon3, List<PaymentStatus3>>() {
		{
		...
		@Override
		public List<PaymentStatus3> getValue(PaymentCommon3 obj) {
			return obj.getCommonStatus();
		}

		@Override
		public void setValue(PaymentCommon3 obj, List<PaymentStatus3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCommon3, Optional<DateAndDateTime2Choice>> mmRequestedExecutionDate = new MMMessageAttribute<PaymentCommon3, Optional<DateAndDateTime2Choice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTime2Choice> getValue(PaymentCommon3 obj) {
			return obj.getRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentCommon3 obj, Optional<DateAndDateTime2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCommon3, Optional<DateAndDateTime2Choice>> mmEntryDate = new MMMessageAttribute<PaymentCommon3, Optional<DateAndDateTime2Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentCommon3, Optional<CreditDebitCode>> mmCreditDebitIndicator = new MMMessageAttribute<PaymentCommon3, Optional<CreditDebitCode>>() {
		{
		...
		@Override
		public Optional<CreditDebitCode> getValue(PaymentCommon3 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(PaymentCommon3 obj, Optional<CreditDebitCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentCommon3, Optional<PaymentOrigin1Choice>> mmPaymentMethod = new MMMessageAssociationEnd<PaymentCommon3, Optional<PaymentOrigin1Choice>>() {
		{
		...
		@Override
		public Optional<PaymentOrigin1Choice> getValue(PaymentCommon3 obj) {
			return obj.getPaymentMethod();
		}

		@Override
		public void setValue(PaymentCommon3 obj, Optional<PaymentOrigin1Choice> value) {
	...
	public PaymentCommon3 setPaymentFrom(System1 paymentFrom) {
	...
	public PaymentCommon3 setPaymentTo(System1 paymentTo) {
	...
	public PaymentCommon3 setCommonStatus(List<PaymentStatus3> commonStatus) {
