...
public class TransferInstructionStatus {
	...
	public static final MMMessageAttribute mmStatus = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransferInstructionStatus.mmObject();
			isDerived = false;
			xmlTag = "Sts";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferInstructionStatus.mmStatus, TransferInstructionStatus.mmAdditionalInformation);
	...
	public void setStatus(TransferStatus1Code status) {
		this.status = status;
	}
