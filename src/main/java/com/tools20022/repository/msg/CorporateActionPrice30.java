...
public class CorporateActionPrice30 {
	...
	public static final MMMessageAssociationEnd CashInLieuOfSharePrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice61.CashInLieuOfSharePrice);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OverSubscriptionDepositPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice61.OverSubscriptionDepositPrice);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PriceFormat5Choice.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice30.CashInLieuOfSharePrice, com.tools20022.repository.msg.CorporateActionPrice30.OverSubscriptionDepositPrice);
