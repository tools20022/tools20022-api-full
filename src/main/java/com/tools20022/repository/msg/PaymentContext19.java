 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext19#mmCardPresent
...
@XmlType(name = "PaymentContext19", propOrder = {"cardPresent", "cardholderPresent", "onLineContext", "attendanceContext", "transactionEnvironment", "transactionChannel", "attendantMessageCapable", "attendantLanguage", "cardDataEntryMode",
		"fallbackIndicator"})
public class PaymentContext19 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext19.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CardPresent";
			definition = "Indicates whether the transaction has been initiated by a card physically present or not.";
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmCardPresent);
			previousVersion_lazy = () -> PaymentContext13.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext19 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmCardholderPresent);
			previousVersion_lazy = () -> PaymentContext13.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>> mmOnLineContext = new MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext19.mmObject();
			isDerived = false;
			xmlTag = "OnLineCntxt";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmOnLineContext);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext19, Optional<AttendanceContext1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmAttendanceContext);
			previousVersion_lazy = () -> PaymentContext13.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext19 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext19, Optional<TransactionEnvironment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmTransactionEnvironment);
			previousVersion_lazy = () -> PaymentContext13.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext19 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext19, Optional<TransactionChannel3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmTransactionChannel);
			previousVersion_lazy = () -> PaymentContext13.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext19 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>> mmAttendantMessageCapable = new MMMessageAttribute<PaymentContext19, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmAttendantMessageCapable);
			previousVersion_lazy = () -> PaymentContext13.mmAttendantMessageCapable;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<LanguageCode>> mmAttendantLanguage = new MMMessageAttribute<PaymentContext19, Optional<LanguageCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmAttendantLanguage);
			previousVersion_lazy = () -> PaymentContext13.mmAttendantLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(PaymentContext19 obj) {
			return obj.getAttendantLanguage();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<CardDataReading5Code>> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext19, Optional<CardDataReading5Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmCardDataEntryMode);
			previousVersion_lazy = () -> PaymentContext13.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardDataReading5Code> getValue(PaymentContext19 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<CardDataReading5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext19, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext19, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext19.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext25.mmFallbackIndicator);
			previousVersion_lazy = () -> PaymentContext13.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext19 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext19 obj, Optional<CardFallback1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext19.mmCardPresent, com.tools20022.repository.msg.PaymentContext19.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext19.mmOnLineContext, com.tools20022.repository.msg.PaymentContext19.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext19.mmTransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext19.mmTransactionChannel, com.tools20022.repository.msg.PaymentContext19.mmAttendantMessageCapable, com.tools20022.repository.msg.PaymentContext19.mmAttendantLanguage,
						com.tools20022.repository.msg.PaymentContext19.mmCardDataEntryMode, com.tools20022.repository.msg.PaymentContext19.mmFallbackIndicator);
	...
	public PaymentContext19 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext19 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext19 setOnLineContext(TrueFalseIndicator onLineContext) {
	...
	public PaymentContext19 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext19 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext19 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext19 setAttendantMessageCapable(TrueFalseIndicator attendantMessageCapable) {
	...
	public PaymentContext19 setAttendantLanguage(LanguageCode attendantLanguage) {
	...
	public PaymentContext19 setCardDataEntryMode(CardDataReading5Code cardDataEntryMode) {
	...
	public PaymentContext19 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
