...
public class PaymentContext19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext19.mmCardPresent, PaymentContext19.mmCardholderPresent, PaymentContext19.mmOnLineContext, PaymentContext19.mmAttendanceContext,
						PaymentContext19.mmTransactionEnvironment, PaymentContext19.mmTransactionChannel, PaymentContext19.mmAttendantMessageCapable, PaymentContext19.mmAttendantLanguage, PaymentContext19.mmCardDataEntryMode,
						PaymentContext19.mmFallbackIndicator);
