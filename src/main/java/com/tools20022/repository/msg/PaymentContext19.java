	...
	public static final MMMessageAttribute mmCardPresent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmCardPresent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCardholderPresent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmCardholderPresent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmOnLineContext = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmOnLineContext);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmAttendanceContext = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmAttendanceContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransactionEnvironment = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmTransactionEnvironment);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmTransactionChannel = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmTransactionChannel);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmAttendantMessageCapable = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmAttendantMessageCapable);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmAttendantMessageCapable;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute mmAttendantLanguage = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmAttendantLanguage);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmAttendantLanguage;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCardDataEntryMode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmCardDataEntryMode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmFallbackIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext25.mmFallbackIndicator);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext13.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
