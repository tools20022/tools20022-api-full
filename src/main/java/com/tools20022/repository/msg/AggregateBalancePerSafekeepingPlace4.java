...
public class AggregateBalancePerSafekeepingPlace4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute mmAggregateBalance = new MMMessageAttribute() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace4.mmAggregateBalance, AggregateBalancePerSafekeepingPlace4.mmDaysAccrued, AggregateBalancePerSafekeepingPlace4.mmHoldingValue,
						AggregateBalancePerSafekeepingPlace4.mmPreviousHoldingValue, AggregateBalancePerSafekeepingPlace4.mmAccruedInterestAmount, AggregateBalancePerSafekeepingPlace4.mmAccruedInterestAmountSign,
						AggregateBalancePerSafekeepingPlace4.mmBookValue, AggregateBalancePerSafekeepingPlace4.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace4.mmPriceDetails,
						AggregateBalancePerSafekeepingPlace4.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace4.mmBalanceBreakdownDetails, AggregateBalancePerSafekeepingPlace4.mmAdditionalBalanceBreakdownDetails);
	...
	public void setAggregateBalance(BalanceQuantity1Choice aggregateBalance) {
