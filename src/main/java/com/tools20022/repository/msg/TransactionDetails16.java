...
public class TransactionDetails16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails16.mmTransactionActivity, TransactionDetails16.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails16.mmSecuritiesMovementType,
						TransactionDetails16.mmPayment, TransactionDetails16.mmSettlementParameters, TransactionDetails16.mmPlaceOfTrade, TransactionDetails16.mmSafekeepingPlace, TransactionDetails16.mmPlaceOfClearing,
						TransactionDetails16.mmFinancialInstrumentIdentification, TransactionDetails16.mmPostingQuantity, TransactionDetails16.mmPostingAmount, TransactionDetails16.mmTradeDate,
						TransactionDetails16.mmExpectedSettlementDate, TransactionDetails16.mmSettlementDate, TransactionDetails16.mmLateDeliveryDate, TransactionDetails16.mmExpectedValueDate,
						TransactionDetails16.mmDeliveringSettlementParties, TransactionDetails16.mmReceivingSettlementParties, TransactionDetails16.mmTransactionAdditionalDetails, TransactionDetails16.mmExtension);
