...
public class CancellationReason15 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancellationReason15.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationReason15.mmCode, CancellationReason15.mmAdditionalReasonInformation);
	...
	public void setCode(CancellationReason25Choice code) {
		this.code = code;
	}
