...
@XmlType(name = "PartyIdentificationAndAccount3", propOrder = {"partyIdentification", "accountIdentification"})
public class PartyIdentificationAndAccount3 {
	...
	public static final MMMessageAttribute<PartyIdentificationAndAccount3, PartyIdentification2Choice> mmPartyIdentification = new MMMessageAttribute<PartyIdentificationAndAccount3, PartyIdentification2Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PartyIdentificationAndAccount147.mmPartyIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PartyIdentificationAndAccount3.mmPartyIdentification, com.tools20022.repository.msg.PartyIdentificationAndAccount3.mmAccountIdentification);
	...
	public PartyIdentificationAndAccount3 setPartyIdentification(PartyIdentification2Choice partyIdentification) {
