...
public class Transaction30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction30.mmAccountOwnerTransactionIdentification, Transaction30.mmAccountServicerTransactionIdentification, Transaction30.mmMarketInfrastructureTransactionIdentification,
						Transaction30.mmProcessorTransactionIdentification, Transaction30.mmTradeIdentification, Transaction30.mmPoolIdentification, Transaction30.mmCommonIdentification, Transaction30.mmCorporateActionEventIdentification,
						Transaction30.mmTripartyAgentCollateralTransactionIdentification, Transaction30.mmClientTripartyCollateralTransactionIdentification, Transaction30.mmClientCollateralInstructionIdentification,
						Transaction30.mmTripartyCollateralInstructionIdentification, Transaction30.mmTransactionDetails);
