...
public class TransactionIdentifications22 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications22.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications22.mmAccountOwnerTransactionIdentification, TransactionIdentifications22.mmAccountServicerTransactionIdentification,
						TransactionIdentifications22.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications22.mmProcessorTransactionIdentification, TransactionIdentifications22.mmCommonIdentification,
						TransactionIdentifications22.mmNettingServiceProviderIdentification);
