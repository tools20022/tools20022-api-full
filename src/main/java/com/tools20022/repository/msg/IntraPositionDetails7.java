...
public class IntraPositionDetails7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails7.mmPriority, IntraPositionDetails7.mmSettlementQuantity, IntraPositionDetails7.mmSettlementDate, IntraPositionDetails7.mmBalanceFrom,
						IntraPositionDetails7.mmBalanceTo, IntraPositionDetails7.mmInstructionProcessingAdditionalDetails);
