...
public class SettlementTypeAndIdentification10 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndIdentification10.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification10.mmAccountOwnerTransactionIdentification, SettlementTypeAndIdentification10.mmAccountServicerTransactionIdentification,
						SettlementTypeAndIdentification10.mmMarketInfrastructureTransactionIdentification, SettlementTypeAndIdentification10.mmProcessorTransactionIdentification, SettlementTypeAndIdentification10.mmSecuritiesMovementType,
						SettlementTypeAndIdentification10.mmPayment, SettlementTypeAndIdentification10.mmCommonIdentification, SettlementTypeAndIdentification10.mmPoolIdentification,
						SettlementTypeAndIdentification10.mmCorporateActionEventIdentification);
