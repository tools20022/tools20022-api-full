 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent2#TimeStamp
 * TMSEvent2.TimeStamp}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent2#Result
 * TMSEvent2.Result}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent2#ActionIdentification
 * TMSEvent2.ActionIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.TMSEvent2#AdditionalErrorInformation
 * TMSEvent2.AdditionalErrorInformation}</li>
 * </ul>
 * </li>
...
public class TMSEvent2 {
	 ...
	 * nextVersions} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.TMSEvent3#TimeStamp
	 * TMSEvent3.TimeStamp}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute TimeStamp = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TMSEvent2.mmObject();
			isDerived = false;
			xmlTag = "TmStmp";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TimeStamp";
			definition = "Date time of the terminal management action performed by the point of interaction.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent3.TimeStamp);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Result = new MMMessageAttribute() {
		{
			...
			name = "Result";
			definition = "Final result of the processed terminal management action.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent3.Result);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.TMSEvent3#ActionIdentification
	 * TMSEvent3.ActionIdentification}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd ActionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent3.ActionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.TMSEvent3#AdditionalErrorInformation
	 * TMSEvent3.AdditionalErrorInformation}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute AdditionalErrorInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent3.AdditionalErrorInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSEvent2.TimeStamp, com.tools20022.repository.msg.TMSEvent2.Result, com.tools20022.repository.msg.TMSEvent2.ActionIdentification,
						com.tools20022.repository.msg.TMSEvent2.AdditionalErrorInformation);
