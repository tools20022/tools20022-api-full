 ...
 * SecuritiesTradeDetails32.mmSettlementInstructionProcessingAdditionalDetails}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SecuritiesTradeDetails32", propOrder = {"tradeIdentification", "collateralTransactionIdentification", "placeOfTrade", "placeOfClearing", "tradeDate", "lateDeliveryDate", "dealPrice", "numberOfDaysAccrued",
...
public class SecuritiesTradeDetails32 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<SecuritiesTradeDetails32, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails32.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmTradeIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, List<Max35Text>> mmCollateralTransactionIdentification = new MMMessageAttribute<SecuritiesTradeDetails32, List<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmCollateralTransactionIdentification);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmCollateralTransactionIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<MarketIdentification78>> mmPlaceOfTrade = new MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<MarketIdentification78>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmPlaceOfTrade);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification78> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<MarketIdentification78> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<AnyBICIdentifier>> mmPlaceOfClearing = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<AnyBICIdentifier>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmPlaceOfClearing);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<TradeDate1Choice>> mmTradeDate = new MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<TradeDate1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmTradeDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<TradeDate1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmLateDeliveryDate);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmLateDeliveryDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getLateDeliveryDate();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<Price2>> mmDealPrice = new MMMessageAssociationEnd<SecuritiesTradeDetails32, Optional<Price2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmDealPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmDealPrice;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Price2> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getDealPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<Price2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max3Number>> mmNumberOfDaysAccrued = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max3Number>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmNumberOfDaysAccrued);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmNumberOfDaysAccrued;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max3Number> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getNumberOfDaysAccrued();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<Max3Number> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<OpeningClosing1Choice>> mmOpeningClosing = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<OpeningClosing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmOpeningClosing);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmOpeningClosing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OpeningClosing1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getOpeningClosing();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<OpeningClosing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, List<Reporting2Choice>> mmReporting = new MMMessageAttribute<SecuritiesTradeDetails32, List<Reporting2Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails32.mmObject();
			isDerived = false;
			xmlTag = "Rptg";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmReporting);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmReporting;
			minOccurs = 0;
			complexType_lazy = () -> Reporting2Choice.mmObject();
		}

		@Override
		public List<Reporting2Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getReporting();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, List<Reporting2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, List<TradeTransactionCondition1Choice>> mmTradeTransactionCondition = new MMMessageAttribute<SecuritiesTradeDetails32, List<TradeTransactionCondition1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmTradeTransactionCondition);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmTradeTransactionCondition;
			minOccurs = 0;
			complexType_lazy = () -> TradeTransactionCondition1Choice.mmObject();
		}

		@Override
		public List<TradeTransactionCondition1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getTradeTransactionCondition();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, List<TradeTransactionCondition1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<InvestorCapacity1Choice>> mmInvestorCapacity = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<InvestorCapacity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmInvestorCapacity);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmInvestorCapacity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<InvestorCapacity1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getInvestorCapacity();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<InvestorCapacity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<TradeOriginator1Choice>> mmTradeOriginatorRole = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<TradeOriginator1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmTradeOriginatorRole);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmTradeOriginatorRole;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TradeOriginator1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getTradeOriginatorRole();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<TradeOriginator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<TypeOfPrice3Choice>> mmTypeOfPrice = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<TypeOfPrice3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmTypeOfPrice);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmTypeOfPrice;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfPrice3Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<TypeOfPrice3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<CurrencyToBuyOrSell1Choice>> mmCurrencyToBuyOrSell = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<CurrencyToBuyOrSell1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails32.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmCurrencyToBuyOrSell);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmCurrencyToBuyOrSell;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyToBuyOrSell1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getCurrencyToBuyOrSell();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<CurrencyToBuyOrSell1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<MatchingStatus1Choice>> mmMatchingStatus = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<MatchingStatus1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmMatchingStatus);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmMatchingStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<MatchingStatus1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getMatchingStatus();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<MatchingStatus1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<AffirmationStatus1Choice>> mmAffirmationStatus = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<AffirmationStatus1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmAffirmationStatus);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmAffirmationStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AffirmationStatus1Choice> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getAffirmationStatus();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<AffirmationStatus1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max350Text>> mmFXAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max350Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmFXAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmFXAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(SecuritiesTradeDetails32 obj) {
			return obj.getFXAdditionalDetails();
		}

		@Override
		public void setValue(SecuritiesTradeDetails32 obj, Optional<Max350Text> value) {
	 ...
	 * SecuritiesTradeDetails25.
	 * mmSettlementInstructionProcessingAdditionalDetails}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<SecuritiesTradeDetails32, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SecuritiesTradeDetails32.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> SecuritiesTradeDetails25.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max350Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesTradeDetails32.mmTradeIdentification, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmCollateralTransactionIdentification,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmPlaceOfTrade, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmPlaceOfClearing, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmTradeDate,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmLateDeliveryDate, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmDealPrice,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmNumberOfDaysAccrued, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmOpeningClosing,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmReporting, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmTradeTransactionCondition,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmInvestorCapacity, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmTradeOriginatorRole,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmTypeOfPrice, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmCurrencyToBuyOrSell,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmMatchingStatus, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmAffirmationStatus,
						com.tools20022.repository.msg.SecuritiesTradeDetails32.mmFXAdditionalDetails, com.tools20022.repository.msg.SecuritiesTradeDetails32.mmSettlementInstructionProcessingAdditionalDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCurrencyToBuyOrSellRule.forSecuritiesTradeDetails32,
						com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forSecuritiesTradeDetails32, com.tools20022.repository.constraints.ConstraintLateDeliveryDateRule.forSecuritiesTradeDetails32,
						com.tools20022.repository.constraints.ConstraintTradeDateTimeUTCRule.forSecuritiesTradeDetails32, com.tools20022.repository.constraints.ConstraintAdditionalDetailsRule.forSecuritiesTradeDetails32,
						com.tools20022.repository.constraints.ConstraintInvestorCapacityRule.forSecuritiesTradeDetails32, com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forSecuritiesTradeDetails32,
						com.tools20022.repository.constraints.ConstraintTradeDateGuideline.forSecuritiesTradeDetails32);
				...
				name = "SecuritiesTradeDetails32";
				definition = "Details of the securities trade.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTradeDetails50.mmObject());
				previousVersion_lazy = () -> SecuritiesTradeDetails25.mmObject();
			}
		});
	...
	public SecuritiesTradeDetails32 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public SecuritiesTradeDetails32 setCollateralTransactionIdentification(List<Max35Text> collateralTransactionIdentification) {
	...
	public SecuritiesTradeDetails32 setPlaceOfTrade(MarketIdentification78 placeOfTrade) {
	...
	public SecuritiesTradeDetails32 setPlaceOfClearing(AnyBICIdentifier placeOfClearing) {
	...
	public SecuritiesTradeDetails32 setTradeDate(TradeDate1Choice tradeDate) {
	...
	public SecuritiesTradeDetails32 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public SecuritiesTradeDetails32 setDealPrice(Price2 dealPrice) {
	...
	public SecuritiesTradeDetails32 setNumberOfDaysAccrued(Max3Number numberOfDaysAccrued) {
	...
	public SecuritiesTradeDetails32 setOpeningClosing(OpeningClosing1Choice openingClosing) {
	...
	public SecuritiesTradeDetails32 setReporting(List<Reporting2Choice> reporting) {
	...
	public SecuritiesTradeDetails32 setTradeTransactionCondition(List<TradeTransactionCondition1Choice> tradeTransactionCondition) {
	...
	public SecuritiesTradeDetails32 setInvestorCapacity(InvestorCapacity1Choice investorCapacity) {
	...
	public SecuritiesTradeDetails32 setTradeOriginatorRole(TradeOriginator1Choice tradeOriginatorRole) {
	...
	public SecuritiesTradeDetails32 setTypeOfPrice(TypeOfPrice3Choice typeOfPrice) {
	...
	public SecuritiesTradeDetails32 setCurrencyToBuyOrSell(CurrencyToBuyOrSell1Choice currencyToBuyOrSell) {
	...
	public SecuritiesTradeDetails32 setMatchingStatus(MatchingStatus1Choice matchingStatus) {
	...
	public SecuritiesTradeDetails32 setAffirmationStatus(AffirmationStatus1Choice affirmationStatus) {
	...
	public SecuritiesTradeDetails32 setFXAdditionalDetails(Max350Text fXAdditionalDetails) {
	...
	public SecuritiesTradeDetails32 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
