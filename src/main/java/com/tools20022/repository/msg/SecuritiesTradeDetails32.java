...
public class SecuritiesTradeDetails32 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails32.mmTradeIdentification, SecuritiesTradeDetails32.mmCollateralTransactionIdentification, SecuritiesTradeDetails32.mmPlaceOfTrade,
						SecuritiesTradeDetails32.mmPlaceOfClearing, SecuritiesTradeDetails32.mmTradeDate, SecuritiesTradeDetails32.mmLateDeliveryDate, SecuritiesTradeDetails32.mmDealPrice, SecuritiesTradeDetails32.mmNumberOfDaysAccrued,
						SecuritiesTradeDetails32.mmOpeningClosing, SecuritiesTradeDetails32.mmReporting, SecuritiesTradeDetails32.mmTradeTransactionCondition, SecuritiesTradeDetails32.mmInvestorCapacity,
						SecuritiesTradeDetails32.mmTradeOriginatorRole, SecuritiesTradeDetails32.mmTypeOfPrice, SecuritiesTradeDetails32.mmCurrencyToBuyOrSell, SecuritiesTradeDetails32.mmMatchingStatus,
						SecuritiesTradeDetails32.mmAffirmationStatus, SecuritiesTradeDetails32.mmFXAdditionalDetails, SecuritiesTradeDetails32.mmSettlementInstructionProcessingAdditionalDetails);
