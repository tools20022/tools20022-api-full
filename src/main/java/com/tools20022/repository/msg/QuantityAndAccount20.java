...
public class QuantityAndAccount20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount20.mmSettledQuantity, QuantityAndAccount20.mmPreviouslySettledQuantity, QuantityAndAccount20.mmRemainingToBeSettledQuantity,
						QuantityAndAccount20.mmPreviouslySettledAmount, QuantityAndAccount20.mmRemainingToBeSettledAmount, QuantityAndAccount20.mmDenominationChoice, QuantityAndAccount20.mmAccountOwner,
						QuantityAndAccount20.mmSafekeepingAccount, QuantityAndAccount20.mmCashAccount, QuantityAndAccount20.mmQuantityBreakdown, QuantityAndAccount20.mmSafekeepingPlace);
