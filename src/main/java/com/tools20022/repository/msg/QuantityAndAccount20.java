...
public class QuantityAndAccount20 {
	...
	public static final MMMessageAssociationEnd mmSettledQuantity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> QuantityAndAccount20.mmObject();
			isDerived = false;
			xmlTag = "SttldQty";
	...
	public void setQuantityBreakdown(List<com.tools20022.repository.msg.QuantityBreakdown10> quantityBreakdown) {
