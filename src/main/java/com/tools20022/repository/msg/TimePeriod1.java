...
@XmlType(name = "TimePeriod1", propOrder = {"fromTime", "toTime"})
public class TimePeriod1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.TimePeriod1 TimePeriod1}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TimePeriod1, ISOTime> mmFromTime = new MMMessageAttribute<TimePeriod1, ISOTime>() {
		{
			businessElementTrace_lazy = () -> TimePeriod.mmFromTime;
			componentContext_lazy = () -> com.tools20022.repository.msg.TimePeriod1.mmObject();
			isDerived = false;
			xmlTag = "FrTm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "FromTime";
			definition = "Time at which the time span starts.";
			previousVersion_lazy = () -> TimePeriodDetails.mmFromTime;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISOTime getValue(TimePeriod1 obj) {
			return obj.getFromTime();
		}

		@Override
		public void setValue(TimePeriod1 obj, ISOTime value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.TimePeriodDetails#mmToTime
	 * TimePeriodDetails.mmToTime}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<TimePeriod1, ISOTime> mmToTime = new MMMessageAttribute<TimePeriod1, ISOTime>() {
		{
			...
			previousVersion_lazy = () -> TimePeriodDetails.mmToTime;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> ISOTime.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TimePeriod1.mmFromTime, com.tools20022.repository.msg.TimePeriod1.mmToTime);
				...
				previousVersion_lazy = () -> TimePeriodDetails.mmObject();
			}
		});
	...
	public TimePeriod1 setFromTime(ISOTime fromTime) {
	...
	public TimePeriod1 setToTime(ISOTime toTime) {
