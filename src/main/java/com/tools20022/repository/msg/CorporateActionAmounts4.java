...
public class CorporateActionAmounts4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionAmounts4.mmGrossCashAmount, CorporateActionAmounts4.mmNetCashAmount, CorporateActionAmounts4.mmSolicitationFees, CorporateActionAmounts4.mmCashInLieuOfShare,
						CorporateActionAmounts4.mmCapitalGain, CorporateActionAmounts4.mmInterestAmount, CorporateActionAmounts4.mmIndemnityAmount, CorporateActionAmounts4.mmManufacturedDividendAmount,
						CorporateActionAmounts4.mmReinvestmentAmount, CorporateActionAmounts4.mmFullyFrankedAmount, CorporateActionAmounts4.mmUnfrankedAmount, CorporateActionAmounts4.mmSundryOrOtherAmount,
						CorporateActionAmounts4.mmCashIncentive, CorporateActionAmounts4.mmTaxFreeAmount, CorporateActionAmounts4.mmTaxDeferredAmount, CorporateActionAmounts4.mmValueAddedTaxAmount,
						CorporateActionAmounts4.mmStampDutyAmount, CorporateActionAmounts4.mmTaxReclaimAmount, CorporateActionAmounts4.mmTaxCreditAmount, CorporateActionAmounts4.mmWithholdingOfForeignTaxAmount,
						CorporateActionAmounts4.mmWithholdingOfLocalTaxAmount, CorporateActionAmounts4.mmAdditionalTaxAmount, CorporateActionAmounts4.mmWithholdingTaxAmount, CorporateActionAmounts4.mmFiscalStampAmount,
						CorporateActionAmounts4.mmExecutingBrokerAmount, CorporateActionAmounts4.mmPayingAgentCommissionAmount, CorporateActionAmounts4.mmLocalBrokerCommissionAmount, CorporateActionAmounts4.mmPostageFeeAmount,
						CorporateActionAmounts4.mmRegulatoryFeesAmount, CorporateActionAmounts4.mmShippingFeesAmount, CorporateActionAmounts4.mmChargesAmount, CorporateActionAmounts4.mmEntitledAmount,
						CorporateActionAmounts4.mmOriginalAmount, CorporateActionAmounts4.mmPrincipalOrCorpus, CorporateActionAmounts4.mmRedemptionPremiumAmount, CorporateActionAmounts4.mmIncomePortion,
						CorporateActionAmounts4.mmStockExchangeTax, CorporateActionAmounts4.mmEUTaxRetentionAmount, CorporateActionAmounts4.mmAccruedInterestAmount);
