...
public class PartyIdentificationAndAccount74 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount74.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount74.mmIdentification, PartyIdentificationAndAccount74.mmAlternateIdentification, PartyIdentificationAndAccount74.mmSafekeepingAccount,
						PartyIdentificationAndAccount74.mmProcessingIdentification, PartyIdentificationAndAccount74.mmAdditionalInformation);
