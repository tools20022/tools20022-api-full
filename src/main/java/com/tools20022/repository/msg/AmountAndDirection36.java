...
@XmlType(name = "AmountAndDirection36", propOrder = {"accruedInterestIndicator", "stampDutyIndicator", "brokerageAmountIndicator", "amount", "creditDebitIndicator", "originalCurrencyAndOrderedAmount", "foreignExchangeDetails", "valueDate"})
public class AmountAndDirection36 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>> mmAccruedInterestIndicator = new MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAccruedInterestIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection36.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<YesNoIndicator> getValue(AmountAndDirection36 obj) {
			return obj.getAccruedInterestIndicator();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>> mmStampDutyIndicator = new MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>> mmBrokerageAmountIndicator = new MMMessageAttribute<AmountAndDirection36, Optional<YesNoIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.AmountAndDirection36.mmObject();
			isDerived = false;
			xmlTag = "BrkrgAmtInd";
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, ActiveCurrencyAndAmount> mmAmount = new MMMessageAttribute<AmountAndDirection36, ActiveCurrencyAndAmount>() {
		{
		...
		@Override
		public ActiveCurrencyAndAmount getValue(AmountAndDirection36 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, ActiveCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<AmountAndDirection36, CreditDebitCode>() {
		{
		...
		@Override
		public CreditDebitCode getValue(AmountAndDirection36 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalCurrencyAndOrderedAmount = new MMMessageAttribute<AmountAndDirection36, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(AmountAndDirection36 obj) {
			return obj.getOriginalCurrencyAndOrderedAmount();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AmountAndDirection36, Optional<ForeignExchangeTerms11>> mmForeignExchangeDetails = new MMMessageAssociationEnd<AmountAndDirection36, Optional<ForeignExchangeTerms11>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms11> getValue(AmountAndDirection36 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, Optional<ForeignExchangeTerms11> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AmountAndDirection36, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAttribute<AmountAndDirection36, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(AmountAndDirection36 obj) {
			return obj.getValueDate();
		}

		@Override
		public void setValue(AmountAndDirection36 obj, Optional<DateAndDateTimeChoice> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection36);
	...
	public AmountAndDirection36 setAccruedInterestIndicator(YesNoIndicator accruedInterestIndicator) {
	...
	public AmountAndDirection36 setStampDutyIndicator(YesNoIndicator stampDutyIndicator) {
	...
	public AmountAndDirection36 setBrokerageAmountIndicator(YesNoIndicator brokerageAmountIndicator) {
	...
	public AmountAndDirection36 setAmount(ActiveCurrencyAndAmount amount) {
	...
	public AmountAndDirection36 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public AmountAndDirection36 setOriginalCurrencyAndOrderedAmount(ActiveOrHistoricCurrencyAndAmount originalCurrencyAndOrderedAmount) {
	...
	public AmountAndDirection36 setForeignExchangeDetails(ForeignExchangeTerms11 foreignExchangeDetails) {
	...
	public AmountAndDirection36 setValueDate(DateAndDateTimeChoice valueDate) {
