...
public class TransactionDetails43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails43.mmAccountOwnerTransactionIdentification, TransactionDetails43.mmAccountServicerTransactionIdentification,
						TransactionDetails43.mmMarketInfrastructureTransactionIdentification, TransactionDetails43.mmProcessorTransactionIdentification, TransactionDetails43.mmOtherTransactionIdentification,
						TransactionDetails43.mmAccountOwner, TransactionDetails43.mmSafekeepingAccount, TransactionDetails43.mmTransactionDetails);
