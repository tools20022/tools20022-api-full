...
public class FinancialInstrument31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrument31.mmIdentification, FinancialInstrument31.mmName, FinancialInstrument31.mmTransferType, FinancialInstrument31.mmQuantity,
						FinancialInstrument31.mmAverageAcquisitionPrice, FinancialInstrument31.mmTotalBookValue, FinancialInstrument31.mmTransfereeAccount, FinancialInstrument31.mmReceivingAgentDetails,
						FinancialInstrument31.mmDeliveringAgentDetails);
