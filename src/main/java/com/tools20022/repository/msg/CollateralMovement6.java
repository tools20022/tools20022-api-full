...
import com.tools20022.repository.msg.Collateral8;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.CollateralMovement6#mmDeliver
 * CollateralMovement6.mmDeliver}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CollateralMovement6#mmReturn
...
@XmlType(name = "CollateralMovement6", propOrder = {"deliver", "return_"})
public class CollateralMovement6 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Dlvr", required = true)
	protected Collateral8 deliver;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CollateralMovement6, Collateral8> mmDeliver = new MMMessageAssociationEnd<CollateralMovement6, Collateral8>() {
		{
			businessElementTrace_lazy = () -> CollateralProposal.mmProposedCollateralMovement;
			componentContext_lazy = () -> com.tools20022.repository.msg.CollateralMovement6.mmObject();
			isDerived = false;
			xmlTag = "Dlvr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Deliver";
			definition = "Provides the collateral movement direction that is a delivery only.";
			nextVersions_lazy = () -> Arrays.asList(CollateralMovement8.mmDeliver);
			previousVersion_lazy = () -> CollateralMovement3.mmDeliver;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Collateral8 getValue(CollateralMovement6 obj) {
			return obj.getDeliver();
		}

		@Override
		public void setValue(CollateralMovement6 obj, Collateral8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CollateralMovement6, Optional<Collateral7>> mmReturn = new MMMessageAssociationEnd<CollateralMovement6, Optional<Collateral7>>() {
		{
			businessElementTrace_lazy = () -> CollateralProposal.mmProposedCollateralMovement;
			componentContext_lazy = () -> com.tools20022.repository.msg.CollateralMovement6.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CollateralMovement8.mmReturn);
			previousVersion_lazy = () -> CollateralMovement3.mmReturn;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Collateral7> getValue(CollateralMovement6 obj) {
			return obj.getReturn();
		}

		@Override
		public void setValue(CollateralMovement6 obj, Optional<Collateral7> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement6.mmDeliver, com.tools20022.repository.msg.CollateralMovement6.mmReturn);
	...
	public Collateral8 getDeliver() {
		return deliver;
	}

	public CollateralMovement6 setDeliver(Collateral8 deliver) {
		this.deliver = Objects.requireNonNull(deliver);
		return this;
	}

	public Optional<Collateral7> getReturn() {
		return return_ == null ? Optional.empty() : Optional.of(return_);
	}

	public CollateralMovement6 setReturn(Collateral7 return_) {
