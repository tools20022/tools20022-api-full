 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.InterestRecord1
 * InterestRecord1}</li>
 * </ul>
 */
...
public class InterestRecord2 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InterestRecord1#mmAmount
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InterestRecord1#mmType
	...
	public static final MMMessageAssociationEnd mmType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InterestRecord1#mmRate
	...
	public static final MMMessageAssociationEnd mmRate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Rate4.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmFromToDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmFromToDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InterestRecord1#mmReason
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmReason;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.InterestRecord1#mmTax
	...
	public static final MMMessageAttribute mmTax = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> InterestRecord1.mmTax;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> InterestRecord1.mmObject();
			}
		});
	...
	public InterestRecord2 setRate(com.tools20022.repository.msg.Rate4 rate) {
		this.rate = rate;
		return this;
	}
	...
	public InterestRecord2 setFromToDate(com.tools20022.repository.msg.DateTimePeriod1 fromToDate) {
	...
	public InterestRecord2 setTax(com.tools20022.repository.msg.TaxCharges2 tax) {
		this.tax = tax;
		return this;
	}
}