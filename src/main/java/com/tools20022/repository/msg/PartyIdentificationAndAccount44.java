...
public class PartyIdentificationAndAccount44 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount44.mmIdentification, PartyIdentificationAndAccount44.mmSafekeepingAccount, PartyIdentificationAndAccount44.mmProcessingIdentification);
