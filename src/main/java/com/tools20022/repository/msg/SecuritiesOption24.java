...
public class SecuritiesOption24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption24.mmSecurityDetails, SecuritiesOption24.mmCreditDebitIndicator, SecuritiesOption24.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption24.mmNonEligibleProceedsIndicator, SecuritiesOption24.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption24.mmEntitledQuantity, SecuritiesOption24.mmSafekeepingPlace,
						SecuritiesOption24.mmFractionDisposition, SecuritiesOption24.mmCurrencyOption, SecuritiesOption24.mmTradingPeriod, SecuritiesOption24.mmDateDetails, SecuritiesOption24.mmRateDetails,
						SecuritiesOption24.mmPriceDetails);
	...
	public CorporateActionPrice26 getPriceDetails() {
		return priceDetails;
	}

	public void setPriceDetails(com.tools20022.repository.msg.CorporateActionPrice26 priceDetails) {
