...
public class SettlementDetails112 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails112.mmHoldIndicator, SettlementDetails112.mmPriority, SettlementDetails112.mmSecuritiesTransactionType, SettlementDetails112.mmSettlementTransactionCondition,
						SettlementDetails112.mmPartialSettlementIndicator, SettlementDetails112.mmBeneficialOwnership, SettlementDetails112.mmBlockTrade, SettlementDetails112.mmCCPEligibility, SettlementDetails112.mmDeliveryReturnReason,
						SettlementDetails112.mmCashClearingSystem, SettlementDetails112.mmExposureType, SettlementDetails112.mmFXStandingInstruction, SettlementDetails112.mmMarketClientSide, SettlementDetails112.mmNettingEligibility,
						SettlementDetails112.mmRegistration, SettlementDetails112.mmRepurchaseType, SettlementDetails112.mmLegalRestrictions, SettlementDetails112.mmSecuritiesRTGS, SettlementDetails112.mmSettlingCapacity,
						SettlementDetails112.mmSettlementSystemMethod, SettlementDetails112.mmTaxCapacity, SettlementDetails112.mmStampDutyTaxBasis, SettlementDetails112.mmTracking, SettlementDetails112.mmAutomaticBorrowing,
						SettlementDetails112.mmLetterOfGuarantee, SettlementDetails112.mmReturnLeg, SettlementDetails112.mmModificationCancellationAllowed, SettlementDetails112.mmEligibleForCollateral,
						SettlementDetails112.mmSecuritiesSubBalanceType, SettlementDetails112.mmCashSubBalanceType);
