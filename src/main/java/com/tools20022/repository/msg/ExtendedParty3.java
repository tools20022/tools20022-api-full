...
public class ExtendedParty3 {
	...
	public static final MMMessageAttribute ExtendedPartyRole = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ExtendedParty3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty6.ExtendedPartyRole);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OtherPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty6.OtherPartyDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ExtendedParty3.ExtendedPartyRole, com.tools20022.repository.msg.ExtendedParty3.OtherPartyDetails);
