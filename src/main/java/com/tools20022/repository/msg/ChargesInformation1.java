 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.ChargesInformation1#ChargesParty
 * ChargesInformation1.ChargesParty}</li>
 * </ul>
 * </li>
...
public class ChargesInformation1 {
	...
	public static final MMMessageAttribute ChargesAmount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ChargesInformation1.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ChargesInformation1.ChargesAmount, com.tools20022.repository.msg.ChargesInformation1.ChargesParty);
