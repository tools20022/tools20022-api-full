...
public class FinancialInstrumentAttributes55 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes55.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes55.mmPlaceOfListing, FinancialInstrumentAttributes55.mmDayCountBasis,
						FinancialInstrumentAttributes55.mmClassificationType, FinancialInstrumentAttributes55.mmOptionStyle, FinancialInstrumentAttributes55.mmDenominationCurrency, FinancialInstrumentAttributes55.mmNextCouponDate,
						FinancialInstrumentAttributes55.mmExpiryDate, FinancialInstrumentAttributes55.mmFloatingRateFixingDate, FinancialInstrumentAttributes55.mmMaturityDate, FinancialInstrumentAttributes55.mmIssueDate,
						FinancialInstrumentAttributes55.mmNextCallableDate, FinancialInstrumentAttributes55.mmPutableDate, FinancialInstrumentAttributes55.mmDatedDate, FinancialInstrumentAttributes55.mmConversionDate,
						FinancialInstrumentAttributes55.mmInterestRate, FinancialInstrumentAttributes55.mmNextInterestRate, FinancialInstrumentAttributes55.mmPercentageOfDebtClaim, FinancialInstrumentAttributes55.mmPreviousFactor,
						FinancialInstrumentAttributes55.mmNextFactor, FinancialInstrumentAttributes55.mmWarrantParity, FinancialInstrumentAttributes55.mmMinimumNominalQuantity, FinancialInstrumentAttributes55.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes55.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes55.mmContractSize);
