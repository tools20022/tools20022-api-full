 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext10#mmCardPresent
...
@XmlType(name = "PaymentContext10", propOrder = {"cardPresent", "cardholderPresent", "onLineContext", "attendanceContext", "transactionEnvironment", "transactionChannel", "attendantMessageCapable", "attendantLanguage", "cardDataEntryMode",
		"fallbackIndicator"})
public class PaymentContext10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext10.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CardPresent";
			definition = "Indicates whether the transaction has been initiated by a card physically present or not.";
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmCardPresent);
			previousVersion_lazy = () -> PaymentContext1.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext10 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmCardholderPresent);
			previousVersion_lazy = () -> PaymentContext1.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>> mmOnLineContext = new MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>>() {
		{
			...
			previousVersion_lazy = () -> PaymentContext1.mmOnLineContext;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext10, Optional<AttendanceContext1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmAttendanceContext);
			previousVersion_lazy = () -> PaymentContext1.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext10 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext10, Optional<TransactionEnvironment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmTransactionEnvironment);
			previousVersion_lazy = () -> PaymentContext1.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext10 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext10, Optional<TransactionChannel3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmTransactionChannel);
			previousVersion_lazy = () -> PaymentContext1.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext10 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>> mmAttendantMessageCapable = new MMMessageAttribute<PaymentContext10, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmAttendantMessageCapable);
			previousVersion_lazy = () -> PaymentContext1.mmAttendantMessageCapable;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<LanguageCode>> mmAttendantLanguage = new MMMessageAttribute<PaymentContext10, Optional<LanguageCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmAttendantLanguage);
			previousVersion_lazy = () -> PaymentContext1.mmAttendantLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(PaymentContext10 obj) {
			return obj.getAttendantLanguage();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, CardDataReading1Code> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext10, CardDataReading1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmCardDataEntryMode);
			previousVersion_lazy = () -> PaymentContext1.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CardDataReading1Code getValue(PaymentContext10 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext10 obj, CardDataReading1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext10, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext10, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext10.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext16.mmFallbackIndicator);
			previousVersion_lazy = () -> PaymentContext1.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext10 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext10 obj, Optional<CardFallback1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext10.mmCardPresent, com.tools20022.repository.msg.PaymentContext10.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext10.mmOnLineContext, com.tools20022.repository.msg.PaymentContext10.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext10.mmTransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext10.mmTransactionChannel, com.tools20022.repository.msg.PaymentContext10.mmAttendantMessageCapable, com.tools20022.repository.msg.PaymentContext10.mmAttendantLanguage,
						com.tools20022.repository.msg.PaymentContext10.mmCardDataEntryMode, com.tools20022.repository.msg.PaymentContext10.mmFallbackIndicator);
	...
	public PaymentContext10 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext10 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext10 setOnLineContext(TrueFalseIndicator onLineContext) {
	...
	public PaymentContext10 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext10 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext10 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext10 setAttendantMessageCapable(TrueFalseIndicator attendantMessageCapable) {
	...
	public PaymentContext10 setAttendantLanguage(LanguageCode attendantLanguage) {
	...
	public PaymentContext10 setCardDataEntryMode(CardDataReading1Code cardDataEntryMode) {
	...
	public PaymentContext10 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
