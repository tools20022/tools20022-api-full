...
public class AmountAndDirection72 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection72.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection72.mmAmount, AmountAndDirection72.mmCreditDebitIndicator, AmountAndDirection72.mmForeignExchangeDetails);
