...
public class Statement4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement4.mmReference, Statement4.mmStatementDateTime, Statement4.mmCreationDateTime, Statement4.mmFrequency, Statement4.mmUpdateType, Statement4.mmActivityIndicator,
						Statement4.mmStatementBasis, Statement4.mmReportNumber, Statement4.mmAuditedIndicator);
