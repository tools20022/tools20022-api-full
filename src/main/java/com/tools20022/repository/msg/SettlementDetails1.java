...
public class SettlementDetails1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails1.mmHoldIndicator, SettlementDetails1.mmPriority, SettlementDetails1.mmSecuritiesTransactionType, SettlementDetails1.mmSettlementTransactionCondition,
						SettlementDetails1.mmPartialSettlementIndicator, SettlementDetails1.mmBeneficialOwnership, SettlementDetails1.mmBlockTrade, SettlementDetails1.mmCCPEligibility, SettlementDetails1.mmDeliveryReturnReason,
						SettlementDetails1.mmCashClearingSystem, SettlementDetails1.mmExposureType, SettlementDetails1.mmFXStandingInstruction, SettlementDetails1.mmMarketClientSide, SettlementDetails1.mmNettingEligibility,
						SettlementDetails1.mmRegistration, SettlementDetails1.mmRepurchaseType, SettlementDetails1.mmLegalRestrictions, SettlementDetails1.mmSecuritiesRTGS, SettlementDetails1.mmSettlingCapacity,
						SettlementDetails1.mmSettlementSystemMethod, SettlementDetails1.mmTaxCapacity, SettlementDetails1.mmStampDutyTaxBasis, SettlementDetails1.mmTracking, SettlementDetails1.mmAutomaticBorrowing,
						SettlementDetails1.mmLetterOfGuarantee, SettlementDetails1.mmReturnLeg, SettlementDetails1.mmModificationCancellationAllowed, SettlementDetails1.mmEligibleForCollateral);
