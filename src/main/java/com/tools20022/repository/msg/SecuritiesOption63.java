...
public class SecuritiesOption63 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption63.mmFinancialInstrumentIdentification, SecuritiesOption63.mmCreditDebitIndicator, SecuritiesOption63.mmTemporaryFinancialInstrumentIndicator,
						SecuritiesOption63.mmNewSecuritiesIssuanceIndicator, SecuritiesOption63.mmIssuerOfferorTaxabilityIndicator, SecuritiesOption63.mmIncomeType, SecuritiesOption63.mmExemptionType,
						SecuritiesOption63.mmCountryOfIncomeSource, SecuritiesOption63.mmPostingQuantity, SecuritiesOption63.mmSafekeepingPlace, SecuritiesOption63.mmFractionDisposition, SecuritiesOption63.mmCurrencyOption,
						SecuritiesOption63.mmDateDetails, SecuritiesOption63.mmRateDetails, SecuritiesOption63.mmPriceDetails, SecuritiesOption63.mmReceivingSettlementParties, SecuritiesOption63.mmDeliveringSettlementParties);
	...
	public SettlementParties61 getReceivingSettlementParties() {
		return receivingSettlementParties;
	}

	public void setReceivingSettlementParties(com.tools20022.repository.msg.SettlementParties61 receivingSettlementParties) {
		this.receivingSettlementParties = receivingSettlementParties;
	}

	public SettlementParties61 getDeliveringSettlementParties() {
		return deliveringSettlementParties;
	}

	public void setDeliveringSettlementParties(com.tools20022.repository.msg.SettlementParties61 deliveringSettlementParties) {
