...
public class SafekeepingPlaceTypeAndText8 {
	...
	public static final MMMessageAttribute SafekeepingPlaceType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SafekeepingPlaceTypeAndText3.SafekeepingPlaceType;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SafekeepingPlaceTypeAndText3.Identification;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SafekeepingPlaceTypeAndText8.SafekeepingPlaceType, com.tools20022.repository.msg.SafekeepingPlaceTypeAndText8.Identification);
				...
				previousVersion_lazy = () -> SafekeepingPlaceTypeAndText3.mmObject();
			}
		});
