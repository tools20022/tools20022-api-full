...
public class ForeignExchangeTerms12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms12.mmUnitCurrency, ForeignExchangeTerms12.mmQuotedCurrency, ForeignExchangeTerms12.mmExchangeRate, ForeignExchangeTerms12.mmResultingAmount);
