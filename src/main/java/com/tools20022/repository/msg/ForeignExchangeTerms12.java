...
public class ForeignExchangeTerms12 {
	...
	public static final MMMessageAttribute UnitCurrency = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ForeignExchangeTerms12.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms12.UnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms12.QuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms12.ExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms12.ResultingAmount);
