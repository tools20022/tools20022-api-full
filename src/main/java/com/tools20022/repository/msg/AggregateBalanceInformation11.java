...
public class AggregateBalanceInformation11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation11.mmFinancialInstrumentIdentification, AggregateBalanceInformation11.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation11.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation11.mmAdditionalDerivativeAttributes, AggregateBalanceInformation11.mmAggregateBalance,
						AggregateBalanceInformation11.mmSafekeepingPlace, AggregateBalanceInformation11.mmCorporateActionOptionType, AggregateBalanceInformation11.mmPriceDetails, AggregateBalanceInformation11.mmForeignExchangeDetails,
						AggregateBalanceInformation11.mmDaysAccrued, AggregateBalanceInformation11.mmAccountBaseCurrencyAmounts, AggregateBalanceInformation11.mmInstrumentCurrencyAmounts,
						AggregateBalanceInformation11.mmAlternateReportingCurrencyAmounts, AggregateBalanceInformation11.mmQuantityBreakdown, AggregateBalanceInformation11.mmBalanceBreakdown,
						AggregateBalanceInformation11.mmAdditionalBalanceBreakdown, AggregateBalanceInformation11.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation11.mmHoldingAdditionalDetails,
						AggregateBalanceInformation11.mmExtension);
