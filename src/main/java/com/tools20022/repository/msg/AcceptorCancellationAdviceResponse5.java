...
public class AcceptorCancellationAdviceResponse5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationAdviceResponse5.mmEnvironment, AcceptorCancellationAdviceResponse5.mmTransaction, AcceptorCancellationAdviceResponse5.mmTMSTrigger);
