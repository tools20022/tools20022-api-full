...
public class CorporateActionGeneralInformation43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation43.mmCorporateActionEventIdentification, CorporateActionGeneralInformation43.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation43.mmClassActionNumber, CorporateActionGeneralInformation43.mmEventType, CorporateActionGeneralInformation43.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation43.mmFinancialInstrumentIdentification);
