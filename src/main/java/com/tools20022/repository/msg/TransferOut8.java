 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransferOut8#SettlementDetails
 * TransferOut8.SettlementDetails}</li>
 * <li>{@linkplain com.tools20022.repository.msg.TransferOut8#Extension
 * TransferOut8.Extension}</li>
 * </ul>
 * </li>
...
public class TransferOut8 {
	...
	public static final MMMessageAssociationEnd TransferDetails = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> TransferOut8.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransferOut8.TransferDetails, com.tools20022.repository.msg.TransferOut8.AccountDetails, com.tools20022.repository.msg.TransferOut8.SettlementDetails,
						com.tools20022.repository.msg.TransferOut8.Extension);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.ReversalOfTransferOutConfirmationV03.ReversalByTransferOutConfirmationDetails);
