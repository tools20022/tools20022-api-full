...
public class TransferOut8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransferOut8.mmTransferDetails, TransferOut8.mmAccountDetails, TransferOut8.mmSettlementDetails, TransferOut8.mmExtension);
