 ...
 * TransactionDetails79.mmClientTripartyCollateralTransactionIdentification}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.TransactionDetails79#mmPayment
...
@XmlType(name = "TransactionDetails79", propOrder = {"tradeIdentification", "poolIdentification", "corporateActionEventIdentification", "tripartyAgentCollateralTransactionIdentification",
...
public class TransactionDetails79 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, List<Max35Text>> mmTradeIdentification = new MMMessageAttribute<TransactionDetails79, List<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			xmlTag = "TradId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TradeIdentification";
			definition = "Reference assigned to the trade by the investor or the trading party. This reference will be used throughout the trade life cycle to access/update the trade details.";
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmTradeIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmTradeIdentification;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}

		@Override
		public List<Max35Text> getValue(TransactionDetails79 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(TransactionDetails79 obj, List<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmPoolIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionDetails79 obj) {
			return obj.getPoolIdentification();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmCorporateActionEventIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmCorporateActionEventIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmTripartyAgentServiceProviderCollateralTransactionIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmTripartyAgentCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmClientTripartyCollateralTransactionIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmClientTripartyCollateralTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmClientCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmClientCollateralInstructionIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmClientCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max35Text>> mmTripartyCollateralInstructionIdentification = new MMMessageAttribute<TransactionDetails79, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeIdentification.mmTripartyAgentCollateralTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmTripartyAgentServiceProviderCollateralInstructionIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmTripartyCollateralInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification98>> mmAccountOwner = new MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification98>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmAccountOwner);
			previousVersion_lazy = () -> TransactionDetails70.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification98> getValue(TransactionDetails79 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<PartyIdentification98> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, SecuritiesAccount24> mmSafekeepingAccount = new MMMessageAssociationEnd<TransactionDetails79, SecuritiesAccount24>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSafekeepingAccount);
			previousVersion_lazy = () -> TransactionDetails70.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount24 getValue(TransactionDetails79 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(TransactionDetails79 obj, SecuritiesAccount24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<SafeKeepingPlace1>> mmSafekeepingPlace = new MMMessageAssociationEnd<TransactionDetails79, Optional<SafeKeepingPlace1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSafekeepingPlace);
			previousVersion_lazy = () -> TransactionDetails70.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace1> getValue(TransactionDetails79 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<SafeKeepingPlace1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<PlaceOfTradeIdentification1>> mmPlaceOfTrade = new MMMessageAssociationEnd<TransactionDetails79, Optional<PlaceOfTradeIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmPlaceOfTrade);
			previousVersion_lazy = () -> TransactionDetails70.mmPlaceOfTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PlaceOfTradeIdentification1> getValue(TransactionDetails79 obj) {
			return obj.getPlaceOfTrade();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<PlaceOfTradeIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<PlaceOfClearingIdentification1>> mmPlaceOfClearing = new MMMessageAttribute<TransactionDetails79, Optional<PlaceOfClearingIdentification1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmPlaceOfClearing);
			previousVersion_lazy = () -> TransactionDetails70.mmPlaceOfClearing;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PlaceOfClearingIdentification1> getValue(TransactionDetails79 obj) {
			return obj.getPlaceOfClearing();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<PlaceOfClearingIdentification1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<TransactionDetails79, SecurityIdentification19>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> TransactionDetails70.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(TransactionDetails79 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(TransactionDetails79 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Quantity6Choice> mmSettlementQuantity = new MMMessageAssociationEnd<TransactionDetails79, Quantity6Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSettlementQuantity);
			previousVersion_lazy = () -> TransactionDetails70.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Quantity6Choice getValue(TransactionDetails79 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Quantity6Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<AmountAndDirection51>> mmSettlementAmount = new MMMessageAssociationEnd<TransactionDetails79, Optional<AmountAndDirection51>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSettlementAmount);
			previousVersion_lazy = () -> TransactionDetails70.mmSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndDirection51> getValue(TransactionDetails79 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<AmountAndDirection51> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>> mmLateDeliveryDate = new MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmLateDeliveryDate);
			previousVersion_lazy = () -> TransactionDetails70.mmLateDeliveryDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(TransactionDetails79 obj) {
			return obj.getLateDeliveryDate();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>> mmExpectedSettlementDate = new MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmExpectedSettlementDate);
			previousVersion_lazy = () -> TransactionDetails70.mmExpectedSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>> mmExpectedValueDate = new MMMessageAssociationEnd<TransactionDetails79, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmExpectedValueDate);
			previousVersion_lazy = () -> TransactionDetails70.mmExpectedValueDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, SettlementDate10Choice> mmSettlementDate = new MMMessageAssociationEnd<TransactionDetails79, SettlementDate10Choice>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSettlementDate);
			previousVersion_lazy = () -> TransactionDetails70.mmSettlementDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SettlementDate10Choice getValue(TransactionDetails79 obj) {
			return obj.getSettlementDate();
		}

		@Override
		public void setValue(TransactionDetails79 obj, SettlementDate10Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<TradeDate5Choice>> mmTradeDate = new MMMessageAssociationEnd<TransactionDetails79, Optional<TradeDate5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmTradeDate);
			previousVersion_lazy = () -> TransactionDetails70.mmTradeDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TradeDate5Choice> getValue(TransactionDetails79 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<TradeDate5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionDetails79, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSecuritiesMovementType);
			previousVersion_lazy = () -> TransactionDetails70.mmSecuritiesMovementType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionDetails79 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionDetails79 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionDetails79, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmPayment);
			previousVersion_lazy = () -> TransactionDetails70.mmPayment;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionDetails79 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionDetails79 obj, DeliveryReceiptType2Code value) {
			obj.setPayment(value);
		}
	};
	@XmlElement(name = "SttlmParams", required = true)
	protected SettlementDetails95 settlementParameters;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.SettlementDetails95
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, SettlementDetails95> mmSettlementParameters = new MMMessageAssociationEnd<TransactionDetails79, SettlementDetails95>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSettlementParameters);
			previousVersion_lazy = () -> TransactionDetails70.mmSettlementParameters;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SettlementDetails95.mmObject();
		}

		@Override
		public SettlementDetails95 getValue(TransactionDetails79 obj) {
			return obj.getSettlementParameters();
		}

		@Override
		public void setValue(TransactionDetails79 obj, SettlementDetails95 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<SettlementParties40>> mmReceivingSettlementParties = new MMMessageAssociationEnd<TransactionDetails79, Optional<SettlementParties40>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmReceivingSettlementParties);
			previousVersion_lazy = () -> TransactionDetails70.mmReceivingSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementParties40> getValue(TransactionDetails79 obj) {
			return obj.getReceivingSettlementParties();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<SettlementParties40> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<SettlementParties40>> mmDeliveringSettlementParties = new MMMessageAssociationEnd<TransactionDetails79, Optional<SettlementParties40>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmPartyRole;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmDeliveringSettlementParties);
			previousVersion_lazy = () -> TransactionDetails70.mmDeliveringSettlementParties;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SettlementParties40.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification99>> mmInvestor = new MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification99>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmInvestor);
			previousVersion_lazy = () -> TransactionDetails70.mmInvestor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification99> getValue(TransactionDetails79 obj) {
			return obj.getInvestor();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<PartyIdentification99> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification100>> mmQualifiedForeignIntermediary = new MMMessageAssociationEnd<TransactionDetails79, Optional<PartyIdentification100>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmQualifiedForeignIntermediary);
			previousVersion_lazy = () -> TransactionDetails70.mmQualifiedForeignIntermediary;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification100> getValue(TransactionDetails79 obj) {
			return obj.getQualifiedForeignIntermediary();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<PartyIdentification100> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionDetails79, Optional<Max350Text>> mmSettlementInstructionProcessingAdditionalDetails = new MMMessageAttribute<TransactionDetails79, Optional<Max350Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionDetails79.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmSettlementInstructionProcessingAdditionalDetails);
			previousVersion_lazy = () -> TransactionDetails70.mmSettlementInstructionProcessingAdditionalDetails;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max350Text> getValue(TransactionDetails79 obj) {
			return obj.getSettlementInstructionProcessingAdditionalDetails();
		}

		@Override
		public void setValue(TransactionDetails79 obj, Optional<Max350Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionDetails79.mmTradeIdentification, com.tools20022.repository.msg.TransactionDetails79.mmPoolIdentification,
						com.tools20022.repository.msg.TransactionDetails79.mmCorporateActionEventIdentification, com.tools20022.repository.msg.TransactionDetails79.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.TransactionDetails79.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.TransactionDetails79.mmClientCollateralInstructionIdentification,
						com.tools20022.repository.msg.TransactionDetails79.mmTripartyCollateralInstructionIdentification, com.tools20022.repository.msg.TransactionDetails79.mmAccountOwner,
						com.tools20022.repository.msg.TransactionDetails79.mmSafekeepingAccount, com.tools20022.repository.msg.TransactionDetails79.mmSafekeepingPlace, com.tools20022.repository.msg.TransactionDetails79.mmPlaceOfTrade,
						com.tools20022.repository.msg.TransactionDetails79.mmPlaceOfClearing, com.tools20022.repository.msg.TransactionDetails79.mmFinancialInstrumentIdentification,
						com.tools20022.repository.msg.TransactionDetails79.mmSettlementQuantity, com.tools20022.repository.msg.TransactionDetails79.mmSettlementAmount, com.tools20022.repository.msg.TransactionDetails79.mmLateDeliveryDate,
						com.tools20022.repository.msg.TransactionDetails79.mmExpectedSettlementDate, com.tools20022.repository.msg.TransactionDetails79.mmExpectedValueDate,
						com.tools20022.repository.msg.TransactionDetails79.mmSettlementDate, com.tools20022.repository.msg.TransactionDetails79.mmTradeDate, com.tools20022.repository.msg.TransactionDetails79.mmSecuritiesMovementType,
						com.tools20022.repository.msg.TransactionDetails79.mmPayment, com.tools20022.repository.msg.TransactionDetails79.mmSettlementParameters,
						com.tools20022.repository.msg.TransactionDetails79.mmReceivingSettlementParties, com.tools20022.repository.msg.TransactionDetails79.mmDeliveringSettlementParties,
						com.tools20022.repository.msg.TransactionDetails79.mmInvestor, com.tools20022.repository.msg.TransactionDetails79.mmQualifiedForeignIntermediary,
						com.tools20022.repository.msg.TransactionDetails79.mmSettlementInstructionProcessingAdditionalDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionStatusAdviceV07.mmTransactionDetails);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCountryCodeRule.forTransactionDetails79,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing1Rule.forTransactionDetails79,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosing2Rule.forTransactionDetails79);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TransactionDetails79";
				definition = "Identifies the details of the transaction.";
				nextVersions_lazy = () -> Arrays.asList(TransactionDetails97.mmObject());
				previousVersion_lazy = () -> TransactionDetails70.mmObject();
			}
		});
	...
	public TransactionDetails79 setTradeIdentification(List<Max35Text> tradeIdentification) {
	...
	public TransactionDetails79 setPoolIdentification(Max35Text poolIdentification) {
	...
	public TransactionDetails79 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public TransactionDetails79 setTripartyAgentCollateralTransactionIdentification(Max35Text tripartyAgentCollateralTransactionIdentification) {
	...
	public TransactionDetails79 setClientTripartyCollateralTransactionIdentification(Max35Text clientTripartyCollateralTransactionIdentification) {
	...
	public TransactionDetails79 setClientCollateralInstructionIdentification(Max35Text clientCollateralInstructionIdentification) {
	...
	public TransactionDetails79 setTripartyCollateralInstructionIdentification(Max35Text tripartyCollateralInstructionIdentification) {
	...
	public TransactionDetails79 setAccountOwner(PartyIdentification98 accountOwner) {
	...
	public TransactionDetails79 setSafekeepingAccount(SecuritiesAccount24 safekeepingAccount) {
	...
	public TransactionDetails79 setSafekeepingPlace(SafeKeepingPlace1 safekeepingPlace) {
	...
	public TransactionDetails79 setPlaceOfTrade(PlaceOfTradeIdentification1 placeOfTrade) {
	...
	public TransactionDetails79 setPlaceOfClearing(PlaceOfClearingIdentification1 placeOfClearing) {
	...
	public TransactionDetails79 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public TransactionDetails79 setSettlementQuantity(Quantity6Choice settlementQuantity) {
	...
	public TransactionDetails79 setSettlementAmount(AmountAndDirection51 settlementAmount) {
	...
	public TransactionDetails79 setLateDeliveryDate(DateAndDateTimeChoice lateDeliveryDate) {
	...
	public TransactionDetails79 setExpectedSettlementDate(DateAndDateTimeChoice expectedSettlementDate) {
	...
	public TransactionDetails79 setExpectedValueDate(DateAndDateTimeChoice expectedValueDate) {
	...
	public TransactionDetails79 setSettlementDate(SettlementDate10Choice settlementDate) {
	...
	public TransactionDetails79 setTradeDate(TradeDate5Choice tradeDate) {
	...
	public TransactionDetails79 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionDetails79 setPayment(DeliveryReceiptType2Code payment) {
		this.payment = Objects.requireNonNull(payment);
		return this;
	}

	public SettlementDetails95 getSettlementParameters() {
		return settlementParameters;
	}

	public TransactionDetails79 setSettlementParameters(SettlementDetails95 settlementParameters) {
	...
	public TransactionDetails79 setReceivingSettlementParties(SettlementParties40 receivingSettlementParties) {
	...
	public TransactionDetails79 setDeliveringSettlementParties(SettlementParties40 deliveringSettlementParties) {
	...
	public TransactionDetails79 setInvestor(PartyIdentification99 investor) {
	...
	public TransactionDetails79 setQualifiedForeignIntermediary(PartyIdentification100 qualifiedForeignIntermediary) {
	...
	public TransactionDetails79 setSettlementInstructionProcessingAdditionalDetails(Max350Text settlementInstructionProcessingAdditionalDetails) {
