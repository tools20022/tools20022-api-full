...
public class CorporateActionDate41 {
	...
	public static final MMMessageAssociationEnd RecordDate = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CorporateActionDate41.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDate45.RecordDate);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ExDividendDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDate45.ExDividendDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateFormat19Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd LotteryDate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDate45.LotteryDate);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> DateFormat19Choice.mmObject();
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDate41.RecordDate, com.tools20022.repository.msg.CorporateActionDate41.ExDividendDate,
						com.tools20022.repository.msg.CorporateActionDate41.LotteryDate);
