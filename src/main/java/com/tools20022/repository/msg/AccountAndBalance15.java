...
public class AccountAndBalance15 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance15.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	public CorporateActionBalanceDetails10 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails10 balance) {
