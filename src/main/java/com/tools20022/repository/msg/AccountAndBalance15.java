...
public class AccountAndBalance15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance15.mmSafekeepingAccount, AccountAndBalance15.mmAccountOwner, AccountAndBalance15.mmSafekeepingPlace, AccountAndBalance15.mmBalance);
