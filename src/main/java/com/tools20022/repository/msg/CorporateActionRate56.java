 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeclaredRateRule#forCorporateActionRate56
 * ConstraintDeclaredRateRule.forCorporateActionRate56}</li>
 * </ul>
 * </li>
 * <li>
...
public class CorporateActionRate56 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateAndAmountFormat16Choice>> mmInterest = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateAndAmountFormat16Choice>>() {
		{
			businessElementTrace_lazy = () -> CashProceedsDefinition.mmInterest;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate56.mmObject();
			isDerived = false;
			xmlTag = "Intrst";
		...
		@Override
		public Optional<RateAndAmountFormat16Choice> getValue(CorporateActionRate56 obj) {
			return obj.getInterest();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateAndAmountFormat16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat7Choice>> mmPercentageSought = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat7Choice>>() {
		{
		...
		@Override
		public Optional<RateFormat7Choice> getValue(CorporateActionRate56 obj) {
			return obj.getPercentageSought();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateFormat7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>> mmRelatedIndex = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>>() {
		{
		...
		@Override
		public Optional<RateFormat3Choice> getValue(CorporateActionRate56 obj) {
			return obj.getRelatedIndex();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>> mmSpread = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateAndAmountFormat28Choice>> mmBidInterval = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateAndAmountFormat28Choice>>() {
		{
		...
		@Override
		public Optional<RateAndAmountFormat28Choice> getValue(CorporateActionRate56 obj) {
			return obj.getBidInterval();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateAndAmountFormat28Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat12Choice>> mmPreviousFactor = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat12Choice>>() {
		{
		...
		@Override
		public Optional<RateFormat12Choice> getValue(CorporateActionRate56 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat12Choice>> mmNextFactor = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat12Choice>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate56.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>> mmReinvestmentDiscountRateToMarket = new MMMessageAssociationEnd<CorporateActionRate56, Optional<RateFormat3Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>> mmInterestShortfall = new MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>>() {
		{
		...
		@Override
		public Optional<RateAndAmountFormat6Choice> getValue(CorporateActionRate56 obj) {
			return obj.getInterestShortfall();
		}

		@Override
		public void setValue(CorporateActionRate56 obj, Optional<RateAndAmountFormat6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>> mmRealisedLoss = new MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>> mmDeclaredRate = new MMMessageAttribute<CorporateActionRate56, Optional<RateAndAmountFormat6Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate56.mmObject();
			isDerived = false;
			xmlTag = "DclrdRate";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate56.mmInterest, com.tools20022.repository.msg.CorporateActionRate56.mmPercentageSought,
						com.tools20022.repository.msg.CorporateActionRate56.mmRelatedIndex, com.tools20022.repository.msg.CorporateActionRate56.mmSpread, com.tools20022.repository.msg.CorporateActionRate56.mmBidInterval,
						com.tools20022.repository.msg.CorporateActionRate56.mmPreviousFactor, com.tools20022.repository.msg.CorporateActionRate56.mmNextFactor,
						com.tools20022.repository.msg.CorporateActionRate56.mmReinvestmentDiscountRateToMarket, com.tools20022.repository.msg.CorporateActionRate56.mmInterestShortfall,
						com.tools20022.repository.msg.CorporateActionRate56.mmRealisedLoss, com.tools20022.repository.msg.CorporateActionRate56.mmDeclaredRate);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintDeclaredRateRule.forCorporateActionRate56);
	...
	public CorporateActionRate56 setInterest(RateAndAmountFormat16Choice interest) {
	...
	public CorporateActionRate56 setPercentageSought(RateFormat7Choice percentageSought) {
	...
	public CorporateActionRate56 setRelatedIndex(RateFormat3Choice relatedIndex) {
	...
	public CorporateActionRate56 setSpread(RateFormat3Choice spread) {
		this.spread = spread;
		return this;
	}

	public Optional<RateAndAmountFormat28Choice> getBidInterval() {
		return bidInterval == null ? Optional.empty() : Optional.of(bidInterval);
	}

	public CorporateActionRate56 setBidInterval(RateAndAmountFormat28Choice bidInterval) {
	...
	public CorporateActionRate56 setPreviousFactor(RateFormat12Choice previousFactor) {
	...
	public CorporateActionRate56 setNextFactor(RateFormat12Choice nextFactor) {
	...
	public CorporateActionRate56 setReinvestmentDiscountRateToMarket(RateFormat3Choice reinvestmentDiscountRateToMarket) {
		this.reinvestmentDiscountRateToMarket = reinvestmentDiscountRateToMarket;
		return this;
	}

	public Optional<RateAndAmountFormat6Choice> getInterestShortfall() {
		return interestShortfall == null ? Optional.empty() : Optional.of(interestShortfall);
	}

	public CorporateActionRate56 setInterestShortfall(RateAndAmountFormat6Choice interestShortfall) {
		this.interestShortfall = interestShortfall;
		return this;
	}

	public Optional<RateAndAmountFormat6Choice> getRealisedLoss() {
		return realisedLoss == null ? Optional.empty() : Optional.of(realisedLoss);
	}

	public CorporateActionRate56 setRealisedLoss(RateAndAmountFormat6Choice realisedLoss) {
		this.realisedLoss = realisedLoss;
		return this;
	}

	public Optional<RateAndAmountFormat6Choice> getDeclaredRate() {
		return declaredRate == null ? Optional.empty() : Optional.of(declaredRate);
	}

	public CorporateActionRate56 setDeclaredRate(RateAndAmountFormat6Choice declaredRate) {
