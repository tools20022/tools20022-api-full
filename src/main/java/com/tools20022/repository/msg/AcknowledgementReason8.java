...
import com.tools20022.repository.choice.AcknowledgementReason10Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcknowledgementReason8#mmCode
...
@XmlType(name = "AcknowledgementReason8", propOrder = {"code", "additionalReasonInformation"})
public class AcknowledgementReason8 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AcknowledgementReason10Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcknowledgementReason8.mmCode, com.tools20022.repository.msg.AcknowledgementReason8.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason8";
	...
	public AcknowledgementReason10Choice getCode() {
		return code;
	}

	public AcknowledgementReason8 setCode(AcknowledgementReason10Choice code) {
	...
	public AcknowledgementReason8 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
