...
public class AcknowledgementReason8 {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason8.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason8.mmCode, AcknowledgementReason8.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason10Choice code) {
		this.code = code;
	}
