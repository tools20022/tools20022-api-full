...
public class FailingReason5 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FailingReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingReason5.mmCode, FailingReason5.mmAdditionalReasonInformation);
	...
	public void setCode(FailingReason5Choice code) {
		this.code = code;
	}
