...
@XmlType(name = "CorporateActionPrice25", propOrder = {"maximumPrice", "minimumPrice"})
public class CorporateActionPrice25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice25, Optional<PriceFormat25Choice>> mmMaximumPrice = new MMMessageAssociationEnd<CorporateActionPrice25, Optional<PriceFormat25Choice>>() {
		{
			businessElementTrace_lazy = () -> BiddingConditions.mmMaximumPrice;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice25.mmObject();
			isDerived = false;
			xmlTag = "MaxPric";
		...
		@Override
		public Optional<PriceFormat25Choice> getValue(CorporateActionPrice25 obj) {
			return obj.getMaximumPrice();
		}

		@Override
		public void setValue(CorporateActionPrice25 obj, Optional<PriceFormat25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice25, Optional<PriceFormat25Choice>> mmMinimumPrice = new MMMessageAssociationEnd<CorporateActionPrice25, Optional<PriceFormat25Choice>>() {
		{
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice25.mmMaximumPrice, com.tools20022.repository.msg.CorporateActionPrice25.mmMinimumPrice);
	...
	public Optional<PriceFormat25Choice> getMaximumPrice() {
		return maximumPrice == null ? Optional.empty() : Optional.of(maximumPrice);
	}

	public CorporateActionPrice25 setMaximumPrice(PriceFormat25Choice maximumPrice) {
		this.maximumPrice = maximumPrice;
		return this;
	}

	public Optional<PriceFormat25Choice> getMinimumPrice() {
		return minimumPrice == null ? Optional.empty() : Optional.of(minimumPrice);
	}

	public CorporateActionPrice25 setMinimumPrice(PriceFormat25Choice minimumPrice) {
