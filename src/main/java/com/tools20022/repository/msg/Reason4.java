 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Reason3 Reason3}
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Reason4", propOrder = "reason")
public class Reason4 {
	 ...
	 * componentContext} = {@linkplain com.tools20022.repository.msg.Reason4
	 * Reason4}</li>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Reason3#mmReason
	 * Reason3.mmReason}</li>
	 * </ul>
	 */
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Reason4.mmReason);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Reason4";
				definition = "Specifies whether the status is provided with a reason or not.";
				previousVersion_lazy = () -> Reason3.mmObject();
			}
		});
