...
public class PartyIdentificationAndAccount42 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount42.mmIdentification, PartyIdentificationAndAccount42.mmAlternateIdentification, PartyIdentificationAndAccount42.mmSafekeepingAccount,
						PartyIdentificationAndAccount42.mmProcessingDate, PartyIdentificationAndAccount42.mmProcessingIdentification, PartyIdentificationAndAccount42.mmAdditionalInformation);
