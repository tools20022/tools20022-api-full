...
public class RateTypeAndAmountAndStatus5 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus27.RateType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus27.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RateStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus27.RateStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.RateStatus);
