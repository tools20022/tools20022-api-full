...
import com.tools20022.repository.msg.Account14;
...
public class Intermediary25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Intermediary25, PartyIdentification2Choice> mmIdentification = new MMMessageAttribute<Intermediary25, PartyIdentification2Choice>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Intermediary25.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public PartyIdentification2Choice getValue(Intermediary25 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(Intermediary25 obj, PartyIdentification2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Intermediary25, Optional<Account14>> mmAccount = new MMMessageAssociationEnd<Intermediary25, Optional<Account14>>() {
		{
		...
		@Override
		public Optional<Account14> getValue(Intermediary25 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(Intermediary25 obj, Optional<Account14> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Intermediary25, Optional<Role4Choice>> mmRole = new MMMessageAssociationEnd<Intermediary25, Optional<Role4Choice>>() {
		{
		...
		@Override
		public Optional<Role4Choice> getValue(Intermediary25 obj) {
			return obj.getRole();
		}

		@Override
		public void setValue(Intermediary25 obj, Optional<Role4Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Intermediary25.mmIdentification, com.tools20022.repository.msg.Intermediary25.mmAccount, com.tools20022.repository.msg.Intermediary25.mmRole);
	...
	public Intermediary25 setIdentification(PartyIdentification2Choice identification) {
	...
	public Intermediary25 setAccount(Account14 account) {
	...
	public Intermediary25 setRole(Role4Choice role) {
		this.role = role;
		return this;
	}
}