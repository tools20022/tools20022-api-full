...
public class SettlementDetails7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails7.mmHoldIndicator, SettlementDetails7.mmSettlementTransactionCondition, SettlementDetails7.mmSettlingCapacity, SettlementDetails7.mmStampDutyTaxBasis,
						SettlementDetails7.mmSecuritiesRTGS, SettlementDetails7.mmRegistration, SettlementDetails7.mmBeneficialOwnership, SettlementDetails7.mmCashClearingSystem, SettlementDetails7.mmTaxCapacity,
						SettlementDetails7.mmRepurchaseType, SettlementDetails7.mmMarketClientSide, SettlementDetails7.mmBlockTrade, SettlementDetails7.mmLegalRestrictions, SettlementDetails7.mmSettlementSystemMethod,
						SettlementDetails7.mmNettingEligibility, SettlementDetails7.mmCCPEligibility, SettlementDetails7.mmLetterOfGuarantee, SettlementDetails7.mmPartialSettlementIndicator);
