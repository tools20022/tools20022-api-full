...
public class AcknowledgementReason7 {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason7.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason7.mmCode, AcknowledgementReason7.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason9Choice code) {
		this.code = code;
	}
