...
public class UnmatchedReason13 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason13.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason13.mmCode, UnmatchedReason13.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason17Choice code) {
		this.code = code;
	}
