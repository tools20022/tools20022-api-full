...
public class RateTypeAndAmountAndStatus16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus16.mmRateType, RateTypeAndAmountAndStatus16.mmAmount, RateTypeAndAmountAndStatus16.mmRateStatus);
