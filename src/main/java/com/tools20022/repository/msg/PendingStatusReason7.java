...
public class PendingStatusReason7 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingStatusReason7.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReasonCode";
			definition = "Specifies the reason why the instruction's processing is pending.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason10.mmReasonCode);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason5.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason10.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason5.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setReasonCode(PendingReason24Choice reasonCode) {
