...
public class PendingStatusReason7 {
	...
	public static final MMMessageAssociationEnd ReasonCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason5.ReasonCode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason10.ReasonCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason5.AdditionalReasonInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason10.AdditionalReasonInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason7.ReasonCode, com.tools20022.repository.msg.PendingStatusReason7.AdditionalReasonInformation);
