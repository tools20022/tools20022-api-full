...
import com.tools20022.repository.choice.PendingReason24Choice;
...
@XmlType(name = "PendingStatusReason7", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason7 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason24Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingStatusReason7, PendingReason24Choice> mmReasonCode = new MMMessageAssociationEnd<PendingStatusReason7, PendingReason24Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingStatusReason7.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason10.mmReasonCode);
			previousVersion_lazy = () -> PendingStatusReason5.mmReasonCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PendingReason24Choice.mmObject();
		}

		@Override
		public PendingReason24Choice getValue(PendingStatusReason7 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(PendingStatusReason7 obj, PendingReason24Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingStatusReason7, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingStatusReason7, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatusReason10.mmAdditionalReasonInformation);
			previousVersion_lazy = () -> PendingStatusReason5.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(PendingStatusReason7 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingStatusReason7 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason7.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason7.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason7);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatusReason7";
				definition = "Specifies reasons for the pending status.";
				nextVersions_lazy = () -> Arrays.asList(PendingStatusReason10.mmObject());
				previousVersion_lazy = () -> PendingStatusReason5.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public PendingReason24Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason7 setReasonCode(PendingReason24Choice reasonCode) {
	...
	public PendingStatusReason7 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
