...
@XmlType(name = "ServiceLevel5", propOrder = "code")
public class ServiceLevel5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ServiceLevel5 ServiceLevel5}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ServiceLevel5, ServiceLevel3Code> mmCode = new MMMessageAttribute<ServiceLevel5, ServiceLevel3Code>() {
		{
			businessElementTrace_lazy = () -> ServiceLevel.mmCode;
			componentContext_lazy = () -> com.tools20022.repository.msg.ServiceLevel5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ServiceLevel3Code getValue(ServiceLevel5 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ServiceLevel5 obj, ServiceLevel3Code value) {
			obj.setCode(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ServiceLevel5.mmCode);
	...
	public ServiceLevel5 setCode(ServiceLevel3Code code) {
