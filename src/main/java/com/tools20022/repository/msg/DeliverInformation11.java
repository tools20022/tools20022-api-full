...
public class DeliverInformation11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation11.mmRequestedSettlementDate, DeliverInformation11.mmEffectiveSettlementDate, DeliverInformation11.mmSettlementAmount, DeliverInformation11.mmStampDuty,
						DeliverInformation11.mmNetAmount, DeliverInformation11.mmChargeDetails, DeliverInformation11.mmCommissionDetails, DeliverInformation11.mmTaxDetails, DeliverInformation11.mmSettlementPartiesDetails,
						DeliverInformation11.mmPhysicalTransfer, DeliverInformation11.mmPhysicalTransferDetails);
