...
public class CashOption17 {
	...
	public static final MMMessageAttribute mmCreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CashOption17.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
	...
	public CorporateActionAmounts15 getAmountDetails() {
		return amountDetails;
	}

	public void setAmountDetails(com.tools20022.repository.msg.CorporateActionAmounts15 amountDetails) {
