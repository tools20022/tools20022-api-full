...
public class CorporateActionGeneralInformation32 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation32.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation32.mmCorporateActionEventIdentification, CorporateActionGeneralInformation32.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation32.mmClassActionNumber, CorporateActionGeneralInformation32.mmEventType, CorporateActionGeneralInformation32.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation32.mmUnderlyingSecurityIdentification);
