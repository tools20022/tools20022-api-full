...
public class FinancialInstrumentDetails5 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentDetails5.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentDetails5.mmFinancialInstrumentIdentification, FinancialInstrumentDetails5.mmPriceDetails, FinancialInstrumentDetails5.mmSafekeepingPlace,
						FinancialInstrumentDetails5.mmOpeningBalance, FinancialInstrumentDetails5.mmClosingBalance, FinancialInstrumentDetails5.mmTransaction);
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction13> transaction) {
