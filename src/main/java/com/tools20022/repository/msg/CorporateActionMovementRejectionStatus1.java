...
public class CorporateActionMovementRejectionStatus1 {
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionMovementRejectionStatus1.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionMovementRejectionStatus1.mmReason, CorporateActionMovementRejectionStatus1.mmAdditionalInformation);
	...
	public void setReason(List<RejectionReason13FormatChoice> reason) {
		this.reason = reason;
	}
