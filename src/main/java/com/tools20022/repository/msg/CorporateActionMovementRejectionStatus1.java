...
public class CorporateActionMovementRejectionStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionMovementRejectionStatus1.Reason, com.tools20022.repository.msg.CorporateActionMovementRejectionStatus1.AdditionalInformation);
