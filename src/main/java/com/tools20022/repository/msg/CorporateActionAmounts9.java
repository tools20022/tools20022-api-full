...
public class CorporateActionAmounts9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionAmounts9.mmGrossCashAmount, CorporateActionAmounts9.mmNetCashAmount, CorporateActionAmounts9.mmSolicitationFees, CorporateActionAmounts9.mmCashInLieuOfShare,
						CorporateActionAmounts9.mmCapitalGain, CorporateActionAmounts9.mmInterestAmount, CorporateActionAmounts9.mmMarketClaimAmount, CorporateActionAmounts9.mmIndemnityAmount,
						CorporateActionAmounts9.mmManufacturedDividendPaymentAmount, CorporateActionAmounts9.mmReinvestmentAmount, CorporateActionAmounts9.mmFullyFrankedAmount, CorporateActionAmounts9.mmUnfrankedAmount,
						CorporateActionAmounts9.mmSundryOrOtherAmount, CorporateActionAmounts9.mmCashIncentive, CorporateActionAmounts9.mmTaxFreeAmount, CorporateActionAmounts9.mmTaxDeferredAmount,
						CorporateActionAmounts9.mmValueAddedTaxAmount, CorporateActionAmounts9.mmStampDutyAmount, CorporateActionAmounts9.mmTaxReclaimAmount, CorporateActionAmounts9.mmTaxCreditAmount,
						CorporateActionAmounts9.mmWithholdingOfForeignTaxAmount, CorporateActionAmounts9.mmWithholdingOfLocalTaxAmount, CorporateActionAmounts9.mmAdditionalTaxAmount, CorporateActionAmounts9.mmWithholdingTaxAmount,
						CorporateActionAmounts9.mmFiscalStampAmount, CorporateActionAmounts9.mmExecutingBrokerAmount, CorporateActionAmounts9.mmPayingAgentCommissionAmount, CorporateActionAmounts9.mmLocalBrokerCommissionAmount,
						CorporateActionAmounts9.mmPostageFeeAmount, CorporateActionAmounts9.mmRegulatoryFeesAmount, CorporateActionAmounts9.mmShippingFeesAmount, CorporateActionAmounts9.mmChargesAmount,
						CorporateActionAmounts9.mmEntitledAmount, CorporateActionAmounts9.mmOriginalAmount, CorporateActionAmounts9.mmAccruedInterestAmount, CorporateActionAmounts9.mmIncomePortion);
