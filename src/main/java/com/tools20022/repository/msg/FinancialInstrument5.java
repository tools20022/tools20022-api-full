...
public class FinancialInstrument5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrument5.mmIdentification, FinancialInstrument5.mmName, FinancialInstrument5.mmSupplementaryIdentification, FinancialInstrument5.mmRequestedNAVCurrency,
						FinancialInstrument5.mmClassType, FinancialInstrument5.mmSecuritiesForm, FinancialInstrument5.mmDistributionPolicy, FinancialInstrument5.mmDualFundIndicator);
