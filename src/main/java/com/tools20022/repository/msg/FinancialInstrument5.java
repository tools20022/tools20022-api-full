 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrument5#mmIdentification
 * FinancialInstrument5.mmIdentification}</li>
 * <li>{@linkplain com.tools20022.repository.msg.FinancialInstrument5#mmName
 * FinancialInstrument5.mmName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrument5#mmSupplementaryIdentification
 * FinancialInstrument5.mmSupplementaryIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintFinancialInstrumentIdentificationGuideline#forFinancialInstrument5
 * ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument5}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FinancialInstrument5", propOrder = {"identification", "name", "supplementaryIdentification", "requestedNAVCurrency", "classType", "securitiesForm", "distributionPolicy", "dualFundIndicator"})
public class FinancialInstrument5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, SecurityIdentification1Choice> mmIdentification = new MMMessageAttribute<FinancialInstrument5, SecurityIdentification1Choice>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrument5.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public SecurityIdentification1Choice getValue(FinancialInstrument5 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, SecurityIdentification1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<Max350Text>> mmName = new MMMessageAttribute<FinancialInstrument5, Optional<Max350Text>>() {
		{
		...
		@Override
		public Optional<Max350Text> getValue(FinancialInstrument5 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, Optional<Max350Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<Max35Text>> mmSupplementaryIdentification = new MMMessageAttribute<FinancialInstrument5, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrument5.mmObject();
			isDerived = false;
			xmlTag = "SplmtryId";
		...
		@Override
		public Optional<Max35Text> getValue(FinancialInstrument5 obj) {
			return obj.getSupplementaryIdentification();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<ActiveOrHistoricCurrencyCode>> mmRequestedNAVCurrency = new MMMessageAttribute<FinancialInstrument5, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrument5 obj) {
			return obj.getRequestedNAVCurrency();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<Max35Text>> mmClassType = new MMMessageAttribute<FinancialInstrument5, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<FormOfSecurity1Code>> mmSecuritiesForm = new MMMessageAttribute<FinancialInstrument5, Optional<FormOfSecurity1Code>>() {
		{
		...
		@Override
		public Optional<FormOfSecurity1Code> getValue(FinancialInstrument5 obj) {
			return obj.getSecuritiesForm();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, Optional<FormOfSecurity1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, Optional<DistributionPolicy1Code>> mmDistributionPolicy = new MMMessageAttribute<FinancialInstrument5, Optional<DistributionPolicy1Code>>() {
		{
		...
		@Override
		public Optional<DistributionPolicy1Code> getValue(FinancialInstrument5 obj) {
			return obj.getDistributionPolicy();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, Optional<DistributionPolicy1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrument5, YesNoIndicator> mmDualFundIndicator = new MMMessageAttribute<FinancialInstrument5, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(FinancialInstrument5 obj) {
			return obj.getDualFundIndicator();
		}

		@Override
		public void setValue(FinancialInstrument5 obj, YesNoIndicator value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrument5.mmIdentification, com.tools20022.repository.msg.FinancialInstrument5.mmName,
						com.tools20022.repository.msg.FinancialInstrument5.mmSupplementaryIdentification, com.tools20022.repository.msg.FinancialInstrument5.mmRequestedNAVCurrency,
						com.tools20022.repository.msg.FinancialInstrument5.mmClassType, com.tools20022.repository.msg.FinancialInstrument5.mmSecuritiesForm, com.tools20022.repository.msg.FinancialInstrument5.mmDistributionPolicy,
						com.tools20022.repository.msg.FinancialInstrument5.mmDualFundIndicator);
				trace_lazy = () -> InvestmentFundClass.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintFinancialInstrumentIdentificationGuideline.forFinancialInstrument5);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrument5";
	...
	public FinancialInstrument5 setIdentification(SecurityIdentification1Choice identification) {
	...
	public FinancialInstrument5 setName(Max350Text name) {
		this.name = name;
		return this;
	}
	...
	public FinancialInstrument5 setSupplementaryIdentification(Max35Text supplementaryIdentification) {
	...
	public FinancialInstrument5 setRequestedNAVCurrency(ActiveOrHistoricCurrencyCode requestedNAVCurrency) {
	...
	public FinancialInstrument5 setClassType(Max35Text classType) {
	...
	public FinancialInstrument5 setSecuritiesForm(FormOfSecurity1Code securitiesForm) {
	...
	public FinancialInstrument5 setDistributionPolicy(DistributionPolicy1Code distributionPolicy) {
	...
	public FinancialInstrument5 setDualFundIndicator(YesNoIndicator dualFundIndicator) {
