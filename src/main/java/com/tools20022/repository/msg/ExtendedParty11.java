 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.ExtendedParty9
 * ExtendedParty9}</li>
 * </ul>
 */
...
public class ExtendedParty11 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ExtendedParty11
	 * ExtendedParty11}</li>
	...
	public static final MMMessageAttribute mmExtendedPartyRole = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ExtendedParty9.mmExtendedPartyRole;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmOtherPartyDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ExtendedParty9.mmOtherPartyDetails;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> ExtendedParty9.mmObject();
			}
		});
	...
	public ExtendedParty11 setOtherPartyDetails(com.tools20022.repository.msg.InvestmentAccountOwnershipInformation14 otherPartyDetails) {
