...
public class PaymentTransaction33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction33.mmStatusIdentification, PaymentTransaction33.mmOriginalInstructionIdentification, PaymentTransaction33.mmOriginalEndToEndIdentification,
						PaymentTransaction33.mmOriginalTransactionIdentification, PaymentTransaction33.mmTransactionStatus, PaymentTransaction33.mmStatusReasonInformation, PaymentTransaction33.mmChargesInformation,
						PaymentTransaction33.mmAcceptanceDateTime, PaymentTransaction33.mmAccountServicerReference, PaymentTransaction33.mmClearingSystemReference, PaymentTransaction33.mmInstructingAgent,
						PaymentTransaction33.mmInstructedAgent, PaymentTransaction33.mmOriginalTransactionReference);
