 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forAmountAndQuantityRatio3
 * ConstraintCoexistenceQuantityRule.forAmountAndQuantityRatio3}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndQuantityRatio3
 * ConstraintCoexistenceAmountRule.forAmountAndQuantityRatio3}</li>
 * </ul>
 * </li>
 * <li>
...
public class AmountAndQuantityRatio3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndQuantityRatio3.mmAmount, com.tools20022.repository.msg.AmountAndQuantityRatio3.mmQuantity);
				trace_lazy = () -> AmountAndQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forAmountAndQuantityRatio3,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndQuantityRatio3);
	...
	public AmountAndQuantityRatio3 setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public AmountAndQuantityRatio3 setQuantity(RestrictedFINDecimalNumber quantity) {
