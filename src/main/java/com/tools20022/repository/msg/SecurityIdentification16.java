...
public class SecurityIdentification16 {
	...
	public static final MMMessageAttribute mmISIN = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecurityIdentification16.mmObject();
			isDerived = false;
			xmlTag = "ISIN";
	...
	protected List<com.tools20022.repository.msg.OtherIdentification3> otherIdentification;
	/**
	...
	public static final MMMessageAssociationEnd mmOtherIdentification = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.OtherIdentification3.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecurityIdentification16.mmISIN, SecurityIdentification16.mmOtherIdentification, SecurityIdentification16.mmDescription);
	...
	public void setOtherIdentification(List<com.tools20022.repository.msg.OtherIdentification3> otherIdentification) {
