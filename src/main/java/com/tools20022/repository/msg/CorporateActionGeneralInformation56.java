...
public class CorporateActionGeneralInformation56 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation56.mmCorporateActionEventIdentification, CorporateActionGeneralInformation56.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation56.mmClassActionNumber, CorporateActionGeneralInformation56.mmEventType, CorporateActionGeneralInformation56.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation56.mmFinancialInstrumentIdentification);
