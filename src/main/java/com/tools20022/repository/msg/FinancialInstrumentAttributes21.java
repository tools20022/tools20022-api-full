...
public class FinancialInstrumentAttributes21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes21.mmPlaceOfListing, FinancialInstrumentAttributes21.mmDayCountBasis, FinancialInstrumentAttributes21.mmRegistrationForm,
						FinancialInstrumentAttributes21.mmPaymentFrequency, FinancialInstrumentAttributes21.mmPaymentStatus, FinancialInstrumentAttributes21.mmPaymentDirection, FinancialInstrumentAttributes21.mmVariableRateChangeFrequency,
						FinancialInstrumentAttributes21.mmPreferenceToIncome, FinancialInstrumentAttributes21.mmClassificationType, FinancialInstrumentAttributes21.mmOptionStyle, FinancialInstrumentAttributes21.mmOptionType,
						FinancialInstrumentAttributes21.mmDenominationCurrency, FinancialInstrumentAttributes21.mmCouponDate, FinancialInstrumentAttributes21.mmExpiryDate, FinancialInstrumentAttributes21.mmFloatingRateFixingDate,
						FinancialInstrumentAttributes21.mmMaturityDate, FinancialInstrumentAttributes21.mmIssueDate, FinancialInstrumentAttributes21.mmNextCallableDate, FinancialInstrumentAttributes21.mmPutableDate,
						FinancialInstrumentAttributes21.mmDatedDate, FinancialInstrumentAttributes21.mmFirstPaymentDate, FinancialInstrumentAttributes21.mmPreviousFactor, FinancialInstrumentAttributes21.mmCurrentFactor,
						FinancialInstrumentAttributes21.mmNextFactor, FinancialInstrumentAttributes21.mmInterestRate, FinancialInstrumentAttributes21.mmNextInterestRate, FinancialInstrumentAttributes21.mmIndexRateBasis,
						FinancialInstrumentAttributes21.mmCouponAttachedNumber, FinancialInstrumentAttributes21.mmPoolNumber, FinancialInstrumentAttributes21.mmQuantityBreakdown, FinancialInstrumentAttributes21.mmVariableRateIndicator,
						FinancialInstrumentAttributes21.mmCallableIndicator, FinancialInstrumentAttributes21.mmPutableIndicator, FinancialInstrumentAttributes21.mmMarketOrIndicativePrice, FinancialInstrumentAttributes21.mmExercisePrice,
						FinancialInstrumentAttributes21.mmSubscriptionPrice, FinancialInstrumentAttributes21.mmConversionPrice, FinancialInstrumentAttributes21.mmStrikePrice, FinancialInstrumentAttributes21.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes21.mmContractSize, FinancialInstrumentAttributes21.mmUnderlyingFinancialInstrumentIdentification, FinancialInstrumentAttributes21.mmFinancialInstrumentAttributeAdditionalDetails);
