...
public class SecuritiesOption15 {
	...
	public static final MMMessageAssociationEnd mmMaximumExercisableQuantity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SecuritiesOption15.mmObject();
			isDerived = false;
			xmlTag = "MaxExrcblQty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesOption15.mmMaximumExercisableQuantity, SecuritiesOption15.mmMinimumExercisableQuantity, SecuritiesOption15.mmMinimumExercisableMultipleQuantity,
						SecuritiesOption15.mmNewBoardLotQuantity, SecuritiesOption15.mmNewDenominationQuantity, SecuritiesOption15.mmFrontEndOddLotQuantity, SecuritiesOption15.mmBackEndOddLotQuantity);
	...
	public FinancialInstrumentQuantity16Choice getFrontEndOddLotQuantity() {
		return frontEndOddLotQuantity;
	}

	public void setFrontEndOddLotQuantity(FinancialInstrumentQuantity16Choice frontEndOddLotQuantity) {
		this.frontEndOddLotQuantity = frontEndOddLotQuantity;
	}

	@XmlElement(name = "BckEndOddLotQty")
	public FinancialInstrumentQuantity16Choice getBackEndOddLotQuantity() {
		return backEndOddLotQuantity;
	}

	public void setBackEndOddLotQuantity(FinancialInstrumentQuantity16Choice backEndOddLotQuantity) {
