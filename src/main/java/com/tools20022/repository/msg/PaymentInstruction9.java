...
import com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV05;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction9#mmDebtor
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChargesAccountRule#forPaymentInstruction9
 * ConstraintChargesAccountRule.forPaymentInstruction9}</li>
 * <li>
 ...
 * ConstraintChequeInstructionDeliverToDebtorGuideline.forPaymentInstruction9}</li>
 * <li>
 ...
 * ConstraintChequeInstructionDeliverToCreditorGuideline.forPaymentInstruction9}
 * </li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule#forPaymentInstruction9
 * ConstraintChequeAndCreditorAccountRule.forPaymentInstruction9}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintChequeDeliveryAndNoCreditorAgentRule#forPaymentInstruction9
 * ConstraintChequeDeliveryAndNoCreditorAgentRule.forPaymentInstruction9}</li>
 * <li>
...
@XmlType(name = "PaymentInstruction9", propOrder = {"paymentInformationIdentification", "paymentMethod", "batchBooking", "numberOfTransactions", "controlSum", "paymentTypeInformation", "requestedExecutionDate", "poolingAdjustmentDate",
...
public class PaymentInstruction9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Max35Text> mmPaymentInformationIdentification = new MMMessageAttribute<PaymentInstruction9, Max35Text>() {
		{
			businessElementTrace_lazy = () -> TradeIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			xmlTag = "PmtInfId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmPaymentInformationIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(PaymentInstruction9 obj) {
			return obj.getPaymentInformationIdentification();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, PaymentMethod3Code> mmPaymentMethod = new MMMessageAttribute<PaymentInstruction9, PaymentMethod3Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmPaymentMethod);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PaymentMethod3Code getValue(PaymentInstruction9 obj) {
			return obj.getPaymentMethod();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, PaymentMethod3Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<BatchBookingIndicator>> mmBatchBooking = new MMMessageAttribute<PaymentInstruction9, Optional<BatchBookingIndicator>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			xmlTag = "BtchBookg";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmBatchBooking);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BatchBookingIndicator> getValue(PaymentInstruction9 obj) {
			return obj.getBatchBooking();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<BatchBookingIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<Max15NumericText>> mmNumberOfTransactions = new MMMessageAttribute<PaymentInstruction9, Optional<Max15NumericText>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			xmlTag = "NbOfTxs";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmNumberOfTransactions);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max15NumericText> getValue(PaymentInstruction9 obj) {
			return obj.getNumberOfTransactions();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<Max15NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<DecimalNumber>> mmControlSum = new MMMessageAttribute<PaymentInstruction9, Optional<DecimalNumber>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			xmlTag = "CtrlSum";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmControlSum);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<DecimalNumber> getValue(PaymentInstruction9 obj) {
			return obj.getControlSum();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<DecimalNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, Optional<PaymentTypeInformation19>> mmPaymentTypeInformation = new MMMessageAssociationEnd<PaymentInstruction9, Optional<PaymentTypeInformation19>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmPaymentTypeInformation);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PaymentTypeInformation19> getValue(PaymentInstruction9 obj) {
			return obj.getPaymentTypeInformation();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<PaymentTypeInformation19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, ISODate> mmRequestedExecutionDate = new MMMessageAttribute<PaymentInstruction9, ISODate>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmRequestedExecutionDate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ISODate getValue(PaymentInstruction9 obj) {
			return obj.getRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<ISODate>> mmPoolingAdjustmentDate = new MMMessageAttribute<PaymentInstruction9, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmPoolingAdjustmentDate);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
		...
		@Override
		public Optional<ISODate> getValue(PaymentInstruction9 obj) {
			return obj.getPoolingAdjustmentDate();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, PartyIdentification43> mmDebtor = new MMMessageAssociationEnd<PaymentInstruction9, PartyIdentification43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmDebtor);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PartyIdentification43 getValue(PaymentInstruction9 obj) {
			return obj.getDebtor();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, PartyIdentification43 value) {
			obj.setDebtor(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, CashAccount24> mmDebtorAccount = new MMMessageAssociationEnd<PaymentInstruction9, CashAccount24>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmDebtorAccount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CashAccount24 getValue(PaymentInstruction9 obj) {
			return obj.getDebtorAccount();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, CashAccount24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, BranchAndFinancialInstitutionIdentification5> mmDebtorAgent = new MMMessageAssociationEnd<PaymentInstruction9, BranchAndFinancialInstitutionIdentification5>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmDebtorAgent);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(PaymentInstruction9 obj) {
			return obj.getDebtorAgent();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, Optional<CashAccount24>> mmDebtorAgentAccount = new MMMessageAssociationEnd<PaymentInstruction9, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> PaymentPartyRole.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmDebtorAgentAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
		...
		@Override
		public Optional<CashAccount24> getValue(PaymentInstruction9 obj) {
			return obj.getDebtorAgentAccount();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<Max140Text>> mmInstructionForDebtorAgent = new MMMessageAttribute<PaymentInstruction9, Optional<Max140Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmInstructionForDebtorAgent);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(PaymentInstruction9 obj) {
			return obj.getInstructionForDebtorAgent();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, Optional<PartyIdentification43>> mmUltimateDebtor = new MMMessageAssociationEnd<PaymentInstruction9, Optional<PartyIdentification43>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmUltimateDebtor);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification43.mmObject();
		...
		@Override
		public Optional<PartyIdentification43> getValue(PaymentInstruction9 obj) {
			return obj.getUltimateDebtor();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<PartyIdentification43> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentInstruction9, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentInstruction9, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmChargeBearer);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentInstruction9 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, Optional<CashAccount24>> mmChargesAccount = new MMMessageAssociationEnd<PaymentInstruction9, Optional<CashAccount24>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmChargesAccount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CashAccount24.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, Optional<BranchAndFinancialInstitutionIdentification5>> mmChargesAccountAgent = new MMMessageAssociationEnd<PaymentInstruction9, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessElementTrace_lazy = () -> Organisation.mmOrganisationIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentInstruction9.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmChargesAccountAgent);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(PaymentInstruction9 obj) {
			return obj.getChargesAccountAgent();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
			obj.setChargesAccountAgent(value.orElse(null));
		}
	};
	@XmlElement(name = "CdtTrfTxInf", required = true)
	protected List<CreditTransferTransaction6> creditTransferTransactionInformation;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentInstruction9, List<CreditTransferTransaction6>> mmCreditTransferTransactionInformation = new MMMessageAssociationEnd<PaymentInstruction9, List<CreditTransferTransaction6>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmCreditTransferTransactionInformation);
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CreditTransferTransaction6.mmObject();
		}

		@Override
		public List<CreditTransferTransaction6> getValue(PaymentInstruction9 obj) {
			return obj.getCreditTransferTransactionInformation();
		}

		@Override
		public void setValue(PaymentInstruction9 obj, List<CreditTransferTransaction6> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction9.mmPaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction9.mmPaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction9.mmBatchBooking, com.tools20022.repository.msg.PaymentInstruction9.mmNumberOfTransactions, com.tools20022.repository.msg.PaymentInstruction9.mmControlSum,
						com.tools20022.repository.msg.PaymentInstruction9.mmPaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction9.mmRequestedExecutionDate,
						com.tools20022.repository.msg.PaymentInstruction9.mmPoolingAdjustmentDate, com.tools20022.repository.msg.PaymentInstruction9.mmDebtor, com.tools20022.repository.msg.PaymentInstruction9.mmDebtorAccount,
						com.tools20022.repository.msg.PaymentInstruction9.mmDebtorAgent, com.tools20022.repository.msg.PaymentInstruction9.mmDebtorAgentAccount, com.tools20022.repository.msg.PaymentInstruction9.mmInstructionForDebtorAgent,
						com.tools20022.repository.msg.PaymentInstruction9.mmUltimateDebtor, com.tools20022.repository.msg.PaymentInstruction9.mmChargeBearer, com.tools20022.repository.msg.PaymentInstruction9.mmChargesAccount,
						com.tools20022.repository.msg.PaymentInstruction9.mmChargesAccountAgent, com.tools20022.repository.msg.PaymentInstruction9.mmCreditTransferTransactionInformation);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV05.mmPaymentInformation);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPaymentTypeInformationRule.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeInstructionRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintChargesAccountRule.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChargesAccountAgentRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintUltimateDebtorGuideline.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeInstructionDeliverToDebtorGuideline.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeInstructionDeliverToCreditorGuideline.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeInstructionDeliverToCreditorAgentGuideline.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintChequeFromGuideline.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChargeBearerRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintUltimateDebtorRule.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeAndCreditorAccountRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintChequeDeliveryAndCreditorAgentRule.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeDeliveryAndNoCreditorAgentRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintNonChequePaymentMethodRule.forPaymentInstruction9,
						com.tools20022.repository.constraints.ConstraintChequeNoDeliveryAndNoCreditorAgentRule.forPaymentInstruction9, com.tools20022.repository.constraints.ConstraintInstructionForDebtorAgentRule.forPaymentInstruction9);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentInstruction9";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentInstruction16.mmObject());
				previousVersion_lazy = () -> PaymentInstruction6.mmObject();
			}
		});
	...
	public PaymentInstruction9 setPaymentInformationIdentification(Max35Text paymentInformationIdentification) {
	...
	public PaymentInstruction9 setPaymentMethod(PaymentMethod3Code paymentMethod) {
	...
	public PaymentInstruction9 setBatchBooking(BatchBookingIndicator batchBooking) {
	...
	public PaymentInstruction9 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public PaymentInstruction9 setControlSum(DecimalNumber controlSum) {
	...
	public PaymentInstruction9 setPaymentTypeInformation(PaymentTypeInformation19 paymentTypeInformation) {
	...
	public PaymentInstruction9 setRequestedExecutionDate(ISODate requestedExecutionDate) {
	...
	public PaymentInstruction9 setPoolingAdjustmentDate(ISODate poolingAdjustmentDate) {
	...
	public PaymentInstruction9 setDebtor(PartyIdentification43 debtor) {
	...
	public PaymentInstruction9 setDebtorAccount(CashAccount24 debtorAccount) {
	...
	public PaymentInstruction9 setDebtorAgent(BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public PaymentInstruction9 setDebtorAgentAccount(CashAccount24 debtorAgentAccount) {
	...
	public PaymentInstruction9 setInstructionForDebtorAgent(Max140Text instructionForDebtorAgent) {
	...
	public PaymentInstruction9 setUltimateDebtor(PartyIdentification43 ultimateDebtor) {
	...
	public PaymentInstruction9 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentInstruction9 setChargesAccount(CashAccount24 chargesAccount) {
	...
	public PaymentInstruction9 setChargesAccountAgent(BranchAndFinancialInstitutionIdentification5 chargesAccountAgent) {
		this.chargesAccountAgent = chargesAccountAgent;
		return this;
	}

	public List<CreditTransferTransaction6> getCreditTransferTransactionInformation() {
	...
	public PaymentInstruction9 setCreditTransferTransactionInformation(List<CreditTransferTransaction6> creditTransferTransactionInformation) {
