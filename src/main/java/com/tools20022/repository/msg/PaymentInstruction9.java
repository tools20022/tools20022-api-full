 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#BatchBooking
 * PaymentInstruction9.BatchBooking}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#NumberOfTransactions
 * PaymentInstruction9.NumberOfTransactions}</li>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction9#ControlSum
 * PaymentInstruction9.ControlSum}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction9#Debtor
 * PaymentInstruction9.Debtor}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#DebtorAccount
 * PaymentInstruction9.DebtorAccount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#DebtorAgent
 * PaymentInstruction9.DebtorAgent}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#DebtorAgentAccount
 * PaymentInstruction9.DebtorAgentAccount}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#UltimateDebtor
 * PaymentInstruction9.UltimateDebtor}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PaymentInstruction9#ChargesAccountAgent
 * PaymentInstruction9.ChargesAccountAgent}</li>
 * <li>
...
public class PaymentInstruction9 {
	...
	public static final MMMessageAttribute PaymentInformationIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentInstruction9.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.PaymentInformationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentMethod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.PaymentMethod);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute BatchBooking = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.BatchBooking);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfTransactions = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.NumberOfTransactions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ControlSum = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.ControlSum);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.PaymentTypeInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.RequestedExecutionDate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PoolingAdjustmentDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.PoolingAdjustmentDate);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	public static final MMMessageAssociationEnd Debtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.Debtor);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.DebtorAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.DebtorAgent);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DebtorAgentAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.DebtorAgentAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute InstructionForDebtorAgent = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.InstructionForDebtorAgent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UltimateDebtor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.UltimateDebtor);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute ChargeBearer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.ChargeBearer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ChargesAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.ChargesAccount);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> CashAccount24.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd ChargesAccountAgent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.ChargesAccountAgent);
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> BranchAndFinancialInstitutionIdentification5.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CreditTransferTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction16.CreditTransferTransactionInformation);
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction9.PaymentInformationIdentification, com.tools20022.repository.msg.PaymentInstruction9.PaymentMethod,
						com.tools20022.repository.msg.PaymentInstruction9.BatchBooking, com.tools20022.repository.msg.PaymentInstruction9.NumberOfTransactions, com.tools20022.repository.msg.PaymentInstruction9.ControlSum,
						com.tools20022.repository.msg.PaymentInstruction9.PaymentTypeInformation, com.tools20022.repository.msg.PaymentInstruction9.RequestedExecutionDate,
						com.tools20022.repository.msg.PaymentInstruction9.PoolingAdjustmentDate, com.tools20022.repository.msg.PaymentInstruction9.Debtor, com.tools20022.repository.msg.PaymentInstruction9.DebtorAccount,
						com.tools20022.repository.msg.PaymentInstruction9.DebtorAgent, com.tools20022.repository.msg.PaymentInstruction9.DebtorAgentAccount, com.tools20022.repository.msg.PaymentInstruction9.InstructionForDebtorAgent,
						com.tools20022.repository.msg.PaymentInstruction9.UltimateDebtor, com.tools20022.repository.msg.PaymentInstruction9.ChargeBearer, com.tools20022.repository.msg.PaymentInstruction9.ChargesAccount,
						com.tools20022.repository.msg.PaymentInstruction9.ChargesAccountAgent, com.tools20022.repository.msg.PaymentInstruction9.CreditTransferTransactionInformation);
				trace_lazy = () -> PaymentInstruction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.pain.CustomerCreditTransferInitiationV05.PaymentInformation);
