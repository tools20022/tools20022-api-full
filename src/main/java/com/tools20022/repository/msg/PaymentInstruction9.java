...
public class PaymentInstruction9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstruction9.mmPaymentInformationIdentification, PaymentInstruction9.mmPaymentMethod, PaymentInstruction9.mmBatchBooking, PaymentInstruction9.mmNumberOfTransactions,
						PaymentInstruction9.mmControlSum, PaymentInstruction9.mmPaymentTypeInformation, PaymentInstruction9.mmRequestedExecutionDate, PaymentInstruction9.mmPoolingAdjustmentDate, PaymentInstruction9.mmDebtor,
						PaymentInstruction9.mmDebtorAccount, PaymentInstruction9.mmDebtorAgent, PaymentInstruction9.mmDebtorAgentAccount, PaymentInstruction9.mmInstructionForDebtorAgent, PaymentInstruction9.mmUltimateDebtor,
						PaymentInstruction9.mmChargeBearer, PaymentInstruction9.mmChargesAccount, PaymentInstruction9.mmChargesAccountAgent, PaymentInstruction9.mmCreditTransferTransactionInformation);
