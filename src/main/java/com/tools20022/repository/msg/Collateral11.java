 ...
 * <li>{@linkplain com.tools20022.repository.msg.Collateral11#OtherCollateral
...
public class Collateral11 {
	...
	public static final MMMessageAttribute MarginCallRequestIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.MarginCallRequestIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute MarginCallResponseIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.MarginCallResponseIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute StandardSettlementInstructions = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.StandardSettlementInstructions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CollateralProposalResponseIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.CollateralProposalResponseIdentification);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd SecuritiesCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.SecuritiesCollateral);
			minOccurs = 0;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.Collateral17#CashCollateral
	...
	public static final MMMessageAssociationEnd CashCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.CashCollateral);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OtherCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral17.OtherCollateral);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Collateral11.MarginCallRequestIdentification, com.tools20022.repository.msg.Collateral11.MarginCallResponseIdentification,
						com.tools20022.repository.msg.Collateral11.StandardSettlementInstructions, com.tools20022.repository.msg.Collateral11.CollateralProposalResponseIdentification,
						com.tools20022.repository.msg.Collateral11.SecuritiesCollateral, com.tools20022.repository.msg.Collateral11.CashCollateral, com.tools20022.repository.msg.Collateral11.OtherCollateral);
