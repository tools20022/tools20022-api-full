...
public class CorporateActionGeneralInformation97 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation97.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes69.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation97.mmCorporateActionEventIdentification, CorporateActionGeneralInformation97.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation97.mmEventType, CorporateActionGeneralInformation97.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes69 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes69 underlyingSecurity) {
