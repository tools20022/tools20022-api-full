...
@XmlType(name = "AcceptedStatusReason1", propOrder = {"reasonCode", "additionalReasonInformation"})
public class AcceptedStatusReason1 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected AcceptedReason1Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedStatusReason1, AcceptedReason1Choice> mmReasonCode = new MMMessageAssociationEnd<AcceptedStatusReason1, AcceptedReason1Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.AcceptedStatusReason1.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatusReason3.mmReasonCode, AcceptedStatusReason4.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AcceptedReason1Choice getValue(AcceptedStatusReason1 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(AcceptedStatusReason1 obj, AcceptedReason1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedStatusReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<AcceptedStatusReason1, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatusReason3.mmAdditionalReasonInformation, AcceptedStatusReason4.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(AcceptedStatusReason1 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(AcceptedStatusReason1 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcceptedStatusReason1.mmReasonCode, com.tools20022.repository.msg.AcceptedStatusReason1.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forAcceptedStatusReason1);
	...
	public AcceptedReason1Choice getReasonCode() {
		return reasonCode;
	}

	public AcceptedStatusReason1 setReasonCode(AcceptedReason1Choice reasonCode) {
	...
	public AcceptedStatusReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
