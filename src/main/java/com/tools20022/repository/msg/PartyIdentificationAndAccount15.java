 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.PartyIdentificationAndAccount15#mmAdditionalInformation
 * PartyIdentificationAndAccount15.mmAdditionalInformation}</li>
 * </ul>
 * </li>
...
@XmlType(name = "PartyIdentificationAndAccount15", propOrder = {"identification", "alternateIdentification", "cashAccount", "chargesAccount", "commissionAccount", "taxAccount", "additionalInformation"})
public class PartyIdentificationAndAccount15 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentificationAndAccount15, PartyIdentification30Choice> mmIdentification = new MMMessageAttribute<PartyIdentificationAndAccount15, PartyIdentification30Choice>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public PartyIdentification30Choice getValue(PartyIdentificationAndAccount15 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount15 obj, PartyIdentification30Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<AlternatePartyIdentification2>> mmAlternateIdentification = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<AlternatePartyIdentification2>>() {
		{
			businessComponentTrace_lazy = () -> PartyIdentificationInformation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<AlternatePartyIdentification2> getValue(PartyIdentificationAndAccount15 obj) {
			return obj.getAlternateIdentification();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount15 obj, Optional<AlternatePartyIdentification2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>> mmCashAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(PartyIdentificationAndAccount15 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount15 obj, Optional<CashAccountIdentification5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>> mmChargesAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>> mmCommissionAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>> mmTaxAccount = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<CashAccountIdentification5Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<PartyTextInformation2>> mmAdditionalInformation = new MMMessageAssociationEnd<PartyIdentificationAndAccount15, Optional<PartyTextInformation2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PartyIdentificationAndAccount15.mmObject();
			isDerived = false;
			xmlTag = "AddtlInf";
		...
		@Override
		public Optional<PartyTextInformation2> getValue(PartyIdentificationAndAccount15 obj) {
			return obj.getAdditionalInformation();
		}

		@Override
		public void setValue(PartyIdentificationAndAccount15 obj, Optional<PartyTextInformation2> value) {
	...
	public PartyIdentificationAndAccount15 setIdentification(PartyIdentification30Choice identification) {
	...
	public PartyIdentificationAndAccount15 setAlternateIdentification(AlternatePartyIdentification2 alternateIdentification) {
	...
	public PartyIdentificationAndAccount15 setCashAccount(CashAccountIdentification5Choice cashAccount) {
	...
	public PartyIdentificationAndAccount15 setChargesAccount(CashAccountIdentification5Choice chargesAccount) {
	...
	public PartyIdentificationAndAccount15 setCommissionAccount(CashAccountIdentification5Choice commissionAccount) {
	...
	public PartyIdentificationAndAccount15 setTaxAccount(CashAccountIdentification5Choice taxAccount) {
	...
	public PartyIdentificationAndAccount15 setAdditionalInformation(PartyTextInformation2 additionalInformation) {
