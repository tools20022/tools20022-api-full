...
public class AmountAndDirection22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection22.mmAmount, AmountAndDirection22.mmCreditDebitIndicator, AmountAndDirection22.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection22.mmForeignExchangeDetails,
						AmountAndDirection22.mmValueDate);
