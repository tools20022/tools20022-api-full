...
public class PartyIdentification37 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification37.mmIdentification, PartyIdentification37.mmProcessingIdentification, PartyIdentification37.mmAdditionalInformation,
						PartyIdentification37.mmAlternateIdentification);
