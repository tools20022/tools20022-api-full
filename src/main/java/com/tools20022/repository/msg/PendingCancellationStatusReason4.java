 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule#forPendingCancellationStatusReason4
 * ConstraintAdditionalReasonInforrmationRule.
 * forPendingCancellationStatusReason4}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAccountServicerDeadlineMissedGuideline#forPendingCancellationStatusReason4
...
public class PendingCancellationStatusReason4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingCancellationStatusReason4, PendingCancellationReason2Choice> mmReasonCode = new MMMessageAssociationEnd<PendingCancellationStatusReason4, PendingCancellationReason2Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingCancellationStatusReason4.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
		...
		@Override
		public PendingCancellationReason2Choice getValue(PendingCancellationStatusReason4 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(PendingCancellationStatusReason4 obj, PendingCancellationReason2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingCancellationStatusReason4, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingCancellationStatusReason4, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(PendingCancellationStatusReason4 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingCancellationStatusReason4 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingCancellationStatusReason4.mmReasonCode, com.tools20022.repository.msg.PendingCancellationStatusReason4.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingCancellationStatusReason4,
						com.tools20022.repository.constraints.ConstraintAccountServicerDeadlineMissedGuideline.forPendingCancellationStatusReason4);
	...
	public PendingCancellationStatusReason4 setReasonCode(PendingCancellationReason2Choice reasonCode) {
	...
	public PendingCancellationStatusReason4 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
