 ...
 * <li>{@linkplain com.tools20022.repository.msg.ATMTransaction29#AccountData
...
public class ATMTransaction29 {
	...
	public static final MMMessageAssociationEnd AccountData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.AccountData;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProtectedAccountData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.ProtectedAccountData;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TotalRequestedAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.TotalRequestedAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DetailedRequestedAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ATMTransaction6.DetailedRequestedAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTransaction29.TransactionIdentification, com.tools20022.repository.msg.ATMTransaction29.AccountData,
						com.tools20022.repository.msg.ATMTransaction29.ProtectedAccountData, com.tools20022.repository.msg.ATMTransaction29.TotalRequestedAmount, com.tools20022.repository.msg.ATMTransaction29.DetailedRequestedAmount,
						com.tools20022.repository.msg.ATMTransaction29.ICCRelatedData);
