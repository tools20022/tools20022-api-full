...
public class RejectionOrRepairReason19 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason19.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason19.mmCode, RejectionOrRepairReason19.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason19Choice code) {
		this.code = code;
	}
