...
public class SecuritiesFinancingTransactionDetails2 {
	...
	public static final MMMessageAttribute mmSecuritiesFinancingTradeIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SecuritiesFinancingTransactionDetails2.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesFinancingTransactionDetails2.mmSecuritiesFinancingTradeIdentification, SecuritiesFinancingTransactionDetails2.mmClosingLegIdentification,
						SecuritiesFinancingTransactionDetails2.mmPoolIdentification, SecuritiesFinancingTransactionDetails2.mmCorporateActionEventIdentification,
						SecuritiesFinancingTransactionDetails2.mmTripartyAgentCollateralTransactionIdentification, SecuritiesFinancingTransactionDetails2.mmClientTripartyCollateralTransactionIdentification,
						SecuritiesFinancingTransactionDetails2.mmAccountOwner, SecuritiesFinancingTransactionDetails2.mmSafekeepingAccount, SecuritiesFinancingTransactionDetails2.mmSafekeepingPlace,
						SecuritiesFinancingTransactionDetails2.mmPlaceOfTrade, SecuritiesFinancingTransactionDetails2.mmFinancialInstrumentIdentification, SecuritiesFinancingTransactionDetails2.mmSettlementQuantity,
						SecuritiesFinancingTransactionDetails2.mmOpeningSettlementAmount, SecuritiesFinancingTransactionDetails2.mmTerminationTransactionAmount, SecuritiesFinancingTransactionDetails2.mmOpeningSettlementDate,
						SecuritiesFinancingTransactionDetails2.mmTerminationDate, SecuritiesFinancingTransactionDetails2.mmTradeDate, SecuritiesFinancingTransactionDetails2.mmExpectedSettlementDate,
						SecuritiesFinancingTransactionDetails2.mmExpectedValueDate, SecuritiesFinancingTransactionDetails2.mmLateDeliveryDate, SecuritiesFinancingTransactionDetails2.mmRateChangeDate,
						SecuritiesFinancingTransactionDetails2.mmSecuritiesFinancingTransactionType, SecuritiesFinancingTransactionDetails2.mmSecuritiesMovementType, SecuritiesFinancingTransactionDetails2.mmPayment,
						SecuritiesFinancingTransactionDetails2.mmSettlementParameters, SecuritiesFinancingTransactionDetails2.mmRateType, SecuritiesFinancingTransactionDetails2.mmVariableRateSupport,
						SecuritiesFinancingTransactionDetails2.mmRepurchaseRate, SecuritiesFinancingTransactionDetails2.mmStockLoanMargin, SecuritiesFinancingTransactionDetails2.mmSecuritiesHaircut,
						SecuritiesFinancingTransactionDetails2.mmPricingRate, SecuritiesFinancingTransactionDetails2.mmSpread, SecuritiesFinancingTransactionDetails2.mmDeliveringSettlementParties,
						SecuritiesFinancingTransactionDetails2.mmReceivingSettlementParties, SecuritiesFinancingTransactionDetails2.mmInvestor, SecuritiesFinancingTransactionDetails2.mmSettlementInstructionProcessingAdditionalDetails);
	...
	public SettlementDetails10 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails10 settlementParameters) {
