...
public class CardPaymentEnvironment57 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment57.mmAcquirer, CardPaymentEnvironment57.mmMerchant, CardPaymentEnvironment57.mmPOI, CardPaymentEnvironment57.mmCard, CardPaymentEnvironment57.mmCustomerDevice,
						CardPaymentEnvironment57.mmWallet, CardPaymentEnvironment57.mmPaymentToken, CardPaymentEnvironment57.mmCardholder, CardPaymentEnvironment57.mmProtectedCardholderData);
