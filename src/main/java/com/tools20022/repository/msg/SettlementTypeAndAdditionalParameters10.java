...
public class SettlementTypeAndAdditionalParameters10 {
	...
	public static final MMMessageAttribute mmSecuritiesMovementType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndAdditionalParameters10.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndAdditionalParameters10.mmSecuritiesMovementType, SettlementTypeAndAdditionalParameters10.mmPayment, SettlementTypeAndAdditionalParameters10.mmCommonIdentification,
						SettlementTypeAndAdditionalParameters10.mmCorporateActionEventIdentification, SettlementTypeAndAdditionalParameters10.mmReconciliationIndicator,
						SettlementTypeAndAdditionalParameters10.mmClientCollateralInstructionIdentification, SettlementTypeAndAdditionalParameters10.mmClientCollateralTransactionIdentification,
						SettlementTypeAndAdditionalParameters10.mmTripartyAgentCollateralTransactionIdentification, SettlementTypeAndAdditionalParameters10.mmTripartyCollateralInstructionIdentification);
