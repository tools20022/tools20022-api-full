...
public class PartyIdentificationAndAccount66 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount66.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount66.mmIdentification, PartyIdentificationAndAccount66.mmAlternateIdentification, PartyIdentificationAndAccount66.mmSafekeepingAccount,
						PartyIdentificationAndAccount66.mmProcessingIdentification, PartyIdentificationAndAccount66.mmAdditionalInformation);
