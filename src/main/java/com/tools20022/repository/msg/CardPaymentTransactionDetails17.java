...
@XmlType(name = "CardPaymentTransactionDetails17", propOrder = {"currency", "totalAmount", "detailedAmount", "validityDate", "accountType", "iCCRelatedData"})
public class CardPaymentTransactionDetails17 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails17, Optional<CurrencyCode>> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails17, Optional<CurrencyCode>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmCurrency);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyCode> getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails17, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails17, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmTotalAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmTotalAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails17, Optional<DetailedAmount5>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails17, Optional<DetailedAmount5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmDetailedAmount);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmDetailedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DetailedAmount5> getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, Optional<DetailedAmount5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails17, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails17, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmValidityDate);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmValidityDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails17, Optional<CardAccountType1Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails17, Optional<CardAccountType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmAccountType);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmAccountType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType1Code> getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, Optional<CardAccountType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails17, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails17, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmICCRelatedData);
			previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmICCRelatedData;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails17 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails17 obj, Optional<Max10000Binary> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmCurrency, com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmTotalAmount,
						com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmDetailedAmount, com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmValidityDate,
						com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmAccountType, com.tools20022.repository.msg.CardPaymentTransactionDetails17.mmICCRelatedData);
				...
				name = "CardPaymentTransactionDetails17";
				definition = "Details of the transaction in the authorisation response contained in a batch.";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails25.mmObject());
				previousVersion_lazy = () -> CardPaymentTransactionDetails11.mmObject();
			}
		});
	...
	public CardPaymentTransactionDetails17 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails17 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails17 setDetailedAmount(DetailedAmount5 detailedAmount) {
	...
	public CardPaymentTransactionDetails17 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails17 setAccountType(CardAccountType1Code accountType) {
	...
	public CardPaymentTransactionDetails17 setICCRelatedData(Max10000Binary iCCRelatedData) {
