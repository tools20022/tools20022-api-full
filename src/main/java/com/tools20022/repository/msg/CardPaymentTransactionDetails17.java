...
public class CardPaymentTransactionDetails17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransactionDetails17.mmCurrency, CardPaymentTransactionDetails17.mmTotalAmount, CardPaymentTransactionDetails17.mmDetailedAmount,
						CardPaymentTransactionDetails17.mmValidityDate, CardPaymentTransactionDetails17.mmAccountType, CardPaymentTransactionDetails17.mmICCRelatedData);
