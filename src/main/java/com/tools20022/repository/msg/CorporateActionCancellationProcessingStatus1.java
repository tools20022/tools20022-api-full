...
public class CorporateActionCancellationProcessingStatus1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionCancellationProcessingStatus1.Status, com.tools20022.repository.msg.CorporateActionCancellationProcessingStatus1.AdditionalInformation);
