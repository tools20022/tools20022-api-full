...
public class CorporateActionCancellationProcessingStatus1 {
	...
	public static final MMMessageAttribute mmStatus = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionCancellationProcessingStatus1.mmObject();
			isDerived = false;
			xmlTag = "Sts";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionCancellationProcessingStatus1.mmStatus, CorporateActionCancellationProcessingStatus1.mmAdditionalInformation);
