...
public class QuantityAndAccount49 {
	...
	public static final MMMessageAssociationEnd mmSettlementQuantity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> QuantityAndAccount49.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount49.mmSettlementQuantity, QuantityAndAccount49.mmDenominationChoice, QuantityAndAccount49.mmAccountOwner, QuantityAndAccount49.mmSafekeepingAccount,
						QuantityAndAccount49.mmCashAccount, QuantityAndAccount49.mmQuantityBreakdown, QuantityAndAccount49.mmSafekeepingPlace);
