...
public class TransactionDetails59 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails59.mmTransactionActivity, TransactionDetails59.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails59.mmSecuritiesMovementType,
						TransactionDetails59.mmPayment, TransactionDetails59.mmSettlementParameters, TransactionDetails59.mmPlaceOfTrade, TransactionDetails59.mmSafekeepingPlace, TransactionDetails59.mmPlaceOfClearing,
						TransactionDetails59.mmFinancialInstrumentIdentification, TransactionDetails59.mmPostingQuantity, TransactionDetails59.mmPostingAmount, TransactionDetails59.mmTradeDate,
						TransactionDetails59.mmExpectedSettlementDate, TransactionDetails59.mmSettlementDate, TransactionDetails59.mmLateDeliveryDate, TransactionDetails59.mmExpectedValueDate,
						TransactionDetails59.mmDeliveringSettlementParties, TransactionDetails59.mmReceivingSettlementParties, TransactionDetails59.mmTransactionAdditionalDetails, TransactionDetails59.mmSupplementaryData);
