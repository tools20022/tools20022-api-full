...
import com.tools20022.repository.msg.StatusAndReason5;
import com.tools20022.repository.msg.TransactionDetails33;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule#forTransaction16
 * ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction16}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransaction16
 * ConstraintCoexistenceIdentificationRule.forTransaction16}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transaction16", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
		...
		"transactionDetails", "statusAndReason"})
public class Transaction16 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, RestrictedFINXMax16Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<Transaction16, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transaction16.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
		...
		@Override
		public RestrictedFINXMax16Text getValue(Transaction16 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction16 obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax16Text> getValue(Transaction16 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(Transaction16 obj, Optional<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, List<RestrictedFINXMax16Text>> mmTradeIdentification = new MMMessageAttribute<Transaction16, List<RestrictedFINXMax16Text>>() {
		{
		...
		@Override
		public List<RestrictedFINXMax16Text> getValue(Transaction16 obj) {
			return obj.getTradeIdentification();
		}

		@Override
		public void setValue(Transaction16 obj, List<RestrictedFINXMax16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmPoolIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmCommonIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmTripartyAgentCollateralTransactionIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>> mmClientTripartyCollateralTransactionIdentification = new MMMessageAttribute<Transaction16, Optional<RestrictedFINXMax16Text>>() {
		{
	...
	protected TransactionDetails33 transactionDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionDetails33
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction16, Optional<TransactionDetails33>> mmTransactionDetails = new MMMessageAssociationEnd<Transaction16, Optional<TransactionDetails33>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> TransactionDetails33.mmObject();
		}

		@Override
		public Optional<TransactionDetails33> getValue(Transaction16 obj) {
			return obj.getTransactionDetails();
		}

		@Override
		public void setValue(Transaction16 obj, Optional<TransactionDetails33> value) {
			obj.setTransactionDetails(value.orElse(null));
		}
	};
	@XmlElement(name = "StsAndRsn")
	protected List<StatusAndReason5> statusAndReason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.StatusAndReason5
	 * StatusAndReason5}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transaction16, List<StatusAndReason5>> mmStatusAndReason = new MMMessageAssociationEnd<Transaction16, List<StatusAndReason5>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> StatusAndReason5.mmObject();
		}

		@Override
		public List<StatusAndReason5> getValue(Transaction16 obj) {
			return obj.getStatusAndReason();
		}

		@Override
		public void setValue(Transaction16 obj, List<StatusAndReason5> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Transaction16.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.Transaction16.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.Transaction16.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.Transaction16.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.Transaction16.mmTradeIdentification, com.tools20022.repository.msg.Transaction16.mmPoolIdentification, com.tools20022.repository.msg.Transaction16.mmCommonIdentification,
						com.tools20022.repository.msg.Transaction16.mmCorporateActionEventIdentification, com.tools20022.repository.msg.Transaction16.mmTripartyAgentCollateralTransactionIdentification,
						com.tools20022.repository.msg.Transaction16.mmClientTripartyCollateralTransactionIdentification, com.tools20022.repository.msg.Transaction16.mmTransactionDetails,
						com.tools20022.repository.msg.Transaction16.mmStatusAndReason);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNoAccountOwnerTransactionIdentificationRule.forTransaction16,
						com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransaction16);
	...
	public Transaction16 setAccountOwnerTransactionIdentification(RestrictedFINXMax16Text accountOwnerTransactionIdentification) {
	...
	public Transaction16 setAccountServicerTransactionIdentification(RestrictedFINXMax16Text accountServicerTransactionIdentification) {
	...
	public Transaction16 setMarketInfrastructureTransactionIdentification(RestrictedFINXMax16Text marketInfrastructureTransactionIdentification) {
	...
	public Transaction16 setProcessorTransactionIdentification(RestrictedFINXMax16Text processorTransactionIdentification) {
	...
	public Transaction16 setTradeIdentification(List<RestrictedFINXMax16Text> tradeIdentification) {
	...
	public Transaction16 setPoolIdentification(RestrictedFINXMax16Text poolIdentification) {
	...
	public Transaction16 setCommonIdentification(RestrictedFINXMax16Text commonIdentification) {
	...
	public Transaction16 setCorporateActionEventIdentification(RestrictedFINXMax16Text corporateActionEventIdentification) {
	...
	public Transaction16 setTripartyAgentCollateralTransactionIdentification(RestrictedFINXMax16Text tripartyAgentCollateralTransactionIdentification) {
	...
	public Transaction16 setClientTripartyCollateralTransactionIdentification(RestrictedFINXMax16Text clientTripartyCollateralTransactionIdentification) {
		this.clientTripartyCollateralTransactionIdentification = clientTripartyCollateralTransactionIdentification;
		return this;
	}

	public Optional<TransactionDetails33> getTransactionDetails() {
		return transactionDetails == null ? Optional.empty() : Optional.of(transactionDetails);
	}

	public Transaction16 setTransactionDetails(TransactionDetails33 transactionDetails) {
		this.transactionDetails = transactionDetails;
		return this;
	}

	public List<StatusAndReason5> getStatusAndReason() {
		return statusAndReason == null ? statusAndReason = new ArrayList<>() : statusAndReason;
	}

	public Transaction16 setStatusAndReason(List<StatusAndReason5> statusAndReason) {
