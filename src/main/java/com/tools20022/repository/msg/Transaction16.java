...
public class Transaction16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction16.mmAccountOwnerTransactionIdentification, Transaction16.mmAccountServicerTransactionIdentification, Transaction16.mmMarketInfrastructureTransactionIdentification,
						Transaction16.mmProcessorTransactionIdentification, Transaction16.mmTradeIdentification, Transaction16.mmPoolIdentification, Transaction16.mmCommonIdentification, Transaction16.mmCorporateActionEventIdentification,
						Transaction16.mmTripartyAgentCollateralTransactionIdentification, Transaction16.mmClientTripartyCollateralTransactionIdentification, Transaction16.mmTransactionDetails, Transaction16.mmStatusAndReason);
