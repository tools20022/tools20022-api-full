...
public class CardPaymentTransaction31 {
	...
	public static final MMMessageAttribute mmTransactionCapture = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CardPaymentTransaction31.mmObject();
			isDerived = false;
			xmlTag = "TxCaptr";
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails16.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction31.mmTransactionCapture, CardPaymentTransaction31.mmTransactionType, CardPaymentTransaction31.mmAdditionalService, CardPaymentTransaction31.mmServiceAttribute,
						CardPaymentTransaction31.mmMerchantCategoryCode, CardPaymentTransaction31.mmSaleReferenceIdentification, CardPaymentTransaction31.mmTransactionIdentification, CardPaymentTransaction31.mmOriginalTransaction,
						CardPaymentTransaction31.mmInitiatorTransactionIdentification, CardPaymentTransaction31.mmReconciliationIdentification, CardPaymentTransaction31.mmTransactionDetails,
						CardPaymentTransaction31.mmAdditionalTransactionData);
	...
	public void setTransactionDetails(com.tools20022.repository.msg.CardPaymentTransactionDetails16 transactionDetails) {
