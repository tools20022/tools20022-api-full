...
public class RemittanceInformation10 {
	...
	public static final MMMessageAttribute Unstructured = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceInformation11.Unstructured);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd Structured = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceInformation11.Structured);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceInformation10.Unstructured, com.tools20022.repository.msg.RemittanceInformation10.Structured);
