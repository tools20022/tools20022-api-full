...
public class CorporateActionPrice14 {
	...
	public static final MMMessageAssociationEnd mmCashInLieuOfSharePrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CorporateActionPrice14.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice14.mmCashInLieuOfSharePrice, CorporateActionPrice14.mmExercisePrice, CorporateActionPrice14.mmGenericCashPriceReceivedPerProduct,
						CorporateActionPrice14.mmOverSubscriptionDepositPrice, CorporateActionPrice14.mmGenericCashPricePaidPerProduct, CorporateActionPrice14.mmTaxableIncomePerDividendShare);
	...
	public PriceFormat16Choice getExercisePrice() {
		return exercisePrice;
	}

	public void setExercisePrice(PriceFormat16Choice exercisePrice) {
	...
	public void setGenericCashPriceReceivedPerProduct(List<PriceFormat18Choice> genericCashPriceReceivedPerProduct) {
		this.genericCashPriceReceivedPerProduct = genericCashPriceReceivedPerProduct;
	}

	public PriceFormat15Choice getOverSubscriptionDepositPrice() {
		return overSubscriptionDepositPrice;
	}

	public void setOverSubscriptionDepositPrice(PriceFormat15Choice overSubscriptionDepositPrice) {
		this.overSubscriptionDepositPrice = overSubscriptionDepositPrice;
	}

	public PriceFormat15Choice getGenericCashPricePaidPerProduct() {
		return genericCashPricePaidPerProduct;
	}

	public void setGenericCashPricePaidPerProduct(PriceFormat15Choice genericCashPricePaidPerProduct) {
