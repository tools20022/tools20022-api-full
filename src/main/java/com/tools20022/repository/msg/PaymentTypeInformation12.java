...
public class PaymentTypeInformation12 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation12, Optional<Priority2Code>> mmInstructionPriority = new MMMessageAttribute<PaymentTypeInformation12, Optional<Priority2Code>>() {
		{
		...
		@Override
		public Optional<Priority2Code> getValue(PaymentTypeInformation12 obj) {
			return obj.getInstructionPriority();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<Priority2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation12, Optional<ServiceLevel6Choice>> mmServiceLevel = new MMMessageAssociationEnd<PaymentTypeInformation12, Optional<ServiceLevel6Choice>>() {
		{
		...
		@Override
		public Optional<ServiceLevel6Choice> getValue(PaymentTypeInformation12 obj) {
			return obj.getServiceLevel();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<ServiceLevel6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation12, Optional<ClearingChannel2Code>> mmClearingChannel = new MMMessageAttribute<PaymentTypeInformation12, Optional<ClearingChannel2Code>>() {
		{
		...
		@Override
		public Optional<ClearingChannel2Code> getValue(PaymentTypeInformation12 obj) {
			return obj.getClearingChannel();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<ClearingChannel2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation12, Optional<LocalInstrument1Choice>> mmLocalInstrument = new MMMessageAssociationEnd<PaymentTypeInformation12, Optional<LocalInstrument1Choice>>() {
		{
		...
		@Override
		public Optional<LocalInstrument1Choice> getValue(PaymentTypeInformation12 obj) {
			return obj.getLocalInstrument();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<LocalInstrument1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation12, Optional<SequenceType1Code>> mmSequenceType = new MMMessageAttribute<PaymentTypeInformation12, Optional<SequenceType1Code>>() {
		{
		...
		@Override
		public Optional<SequenceType1Code> getValue(PaymentTypeInformation12 obj) {
			return obj.getSequenceType();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<SequenceType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation12, Optional<PaymentCategoryPurpose1Code>> mmCategoryPurpose = new MMMessageAttribute<PaymentTypeInformation12, Optional<PaymentCategoryPurpose1Code>>() {
		{
		...
		@Override
		public Optional<PaymentCategoryPurpose1Code> getValue(PaymentTypeInformation12 obj) {
			return obj.getCategoryPurpose();
		}

		@Override
		public void setValue(PaymentTypeInformation12 obj, Optional<PaymentCategoryPurpose1Code> value) {
