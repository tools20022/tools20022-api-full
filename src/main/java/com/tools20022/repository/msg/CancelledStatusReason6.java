...
import com.tools20022.repository.choice.CancelledReason3Choice;
...
@XmlType(name = "CancelledStatusReason6", propOrder = {"reasonCode", "additionalReasonInformation"})
public class CancelledStatusReason6 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected CancelledReason3Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CancelledStatusReason6, CancelledReason3Choice> mmReasonCode = new MMMessageAssociationEnd<CancelledStatusReason6, CancelledReason3Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.CancelledStatusReason6.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason8.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CancelledReason3Choice.mmObject();
		}

		@Override
		public CancelledReason3Choice getValue(CancelledStatusReason6 obj) {
			return obj.getReasonCode();
		}

		@Override
		public void setValue(CancelledStatusReason6 obj, CancelledReason3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledStatusReason6, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancelledStatusReason6, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason8.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(CancelledStatusReason6 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(CancelledStatusReason6 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason6.mmReasonCode, com.tools20022.repository.msg.CancelledStatusReason6.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forCancelledStatusReason6);
				...
				name = "CancelledStatusReason6";
				definition = "Specifies reasons for the cancelled status.";
				nextVersions_lazy = () -> Arrays.asList(CancelledStatusReason8.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public CancelledReason3Choice getReasonCode() {
		return reasonCode;
	}

	public CancelledStatusReason6 setReasonCode(CancelledReason3Choice reasonCode) {
	...
	public CancelledStatusReason6 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
