...
public class CancelledStatusReason6 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancelledStatusReason6.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ReasonCode";
			definition = "Specifies the reason why the instruction or instruction cancellation has been cancelled.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason8.mmReasonCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason8.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public void setReasonCode(CancelledReason3Choice reasonCode) {
