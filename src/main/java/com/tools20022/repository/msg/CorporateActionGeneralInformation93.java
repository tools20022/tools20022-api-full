...
public class CorporateActionGeneralInformation93 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation93.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation93.mmCorporateActionEventIdentification, CorporateActionGeneralInformation93.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation93.mmClassActionNumber, CorporateActionGeneralInformation93.mmEventType, CorporateActionGeneralInformation93.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation93.mmFinancialInstrumentIdentification);
