...
public class CardPaymentEnvironment12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment12.mmAcquirer, CardPaymentEnvironment12.mmMerchant, CardPaymentEnvironment12.mmPOI, CardPaymentEnvironment12.mmCard);
