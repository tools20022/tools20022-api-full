 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms1#mmQuotingInstitution
 * ForeignExchangeTerms1.mmQuotingInstitution}</li>
 * </ul>
 * </li>
...
@XmlType(name = "ForeignExchangeTerms1", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "quotationDate", "quotingInstitution"})
public class ForeignExchangeTerms1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms1
	 * ForeignExchangeTerms1}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms1, ActiveOrHistoricCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms1, ActiveOrHistoricCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms1.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ForeignExchangeTerms1 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms1 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms1, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms1, ActiveOrHistoricCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms1, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms1, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms1 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms1 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms1, Optional<ISODateTime>> mmQuotationDate = new MMMessageAttribute<ForeignExchangeTerms1, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(ForeignExchangeTerms1 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(ForeignExchangeTerms1 obj, Optional<ISODateTime> value) {
			obj.setQuotationDate(value.orElse(null));
		}
	};
	@XmlElement(name = "QtgInstn")
	protected PartyIdentification10Choice quotingInstitution;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms1, Optional<PartyIdentification10Choice>> mmQuotingInstitution = new MMMessageAttribute<ForeignExchangeTerms1, Optional<PartyIdentification10Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification10Choice> getValue(ForeignExchangeTerms1 obj) {
			return obj.getQuotingInstitution();
		}

		@Override
		public void setValue(ForeignExchangeTerms1 obj, Optional<PartyIdentification10Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms1.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms1.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms1.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms1.mmQuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms1.mmQuotingInstitution);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms1";
	...
	public ForeignExchangeTerms1 setUnitCurrency(ActiveOrHistoricCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms1 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms1 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms1 setQuotationDate(ISODateTime quotationDate) {
		this.quotationDate = quotationDate;
		return this;
	}

	public Optional<PartyIdentification10Choice> getQuotingInstitution() {
		return quotingInstitution == null ? Optional.empty() : Optional.of(quotingInstitution);
	}

	public ForeignExchangeTerms1 setQuotingInstitution(PartyIdentification10Choice quotingInstitution) {
