...
public class CorrectivePaymentInitiation3 {
	...
	public static final MMMessageAssociationEnd mmGroupHeader = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmGroupHeader;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmPaymentInformationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmInstructionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmInstructedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmInstructedAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmRequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmRequestedExecutionDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmRequestedCollectionDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CorrectivePaymentInitiation2.mmObject();
			}
		});
	...
	public CorrectivePaymentInitiation3 setGroupHeader(com.tools20022.repository.msg.CorrectiveGroupInformation1 groupHeader) {
