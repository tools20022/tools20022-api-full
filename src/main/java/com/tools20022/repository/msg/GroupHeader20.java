...
public class GroupHeader20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader20.mmMessageIdentification, GroupHeader20.mmCreationDateTime, GroupHeader20.mmNumberOfTransactions, GroupHeader20.mmTotalInterbankSettlementAmount,
						GroupHeader20.mmInterbankSettlementDate, GroupHeader20.mmSettlementInformation, GroupHeader20.mmPaymentTypeInformation, GroupHeader20.mmInstructingAgent, GroupHeader20.mmInstructedAgent);
