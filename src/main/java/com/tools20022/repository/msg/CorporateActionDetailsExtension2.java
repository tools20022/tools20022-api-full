 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionDetailsExtension2#mmPlaceAndName
 * CorporateActionDetailsExtension2.mmPlaceAndName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionDetailsExtension2#mmContraParticipantNumber
 * CorporateActionDetailsExtension2.mmContraParticipantNumber}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * "CorporateActionDetailsExtension2"</li>
...
@XmlType(name = "CorporateActionDetailsExtension2", propOrder = {"placeAndName", "contraParticipantNumber"})
public class CorporateActionDetailsExtension2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CorporateActionDetailsExtension2
	 * CorporateActionDetailsExtension2}</li>
	 ...
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "Contra participant identification for stock loans reorganisation transactions."
	 * </li>
	 * <li>
	...
	public static final MMMessageAttribute<CorporateActionDetailsExtension2, Optional<Max8Text>> mmContraParticipantNumber = new MMMessageAttribute<CorporateActionDetailsExtension2, Optional<Max8Text>>() {
		{
			...
			definition = "Contra participant identification for stock loans reorganisation transactions.";
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionDetailsExtension2.mmPlaceAndName, com.tools20022.repository.msg.CorporateActionDetailsExtension2.mmContraParticipantNumber);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CorporateActionDetailsExtension2";
	...
	public CorporateActionDetailsExtension2 setPlaceAndName(Max350Text placeAndName) {
	...
	public CorporateActionDetailsExtension2 setContraParticipantNumber(Max8Text contraParticipantNumber) {
