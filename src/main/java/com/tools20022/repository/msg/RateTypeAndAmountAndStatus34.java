...
public class RateTypeAndAmountAndStatus34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus34.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus34.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus34.RateStatus);
