...
@XmlType(name = "RateTypeAndAmountAndStatus34", propOrder = {"rateType", "amount", "rateStatus"})
public class RateTypeAndAmountAndStatus34 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus34, RateType48Choice> mmRateType = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus34, RateType48Choice>() {
		{
			businessElementTrace_lazy = () -> Interest.mmInterestCalculation;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus34.mmObject();
			isDerived = false;
			xmlTag = "RateTp";
		...
		@Override
		public RateType48Choice getValue(RateTypeAndAmountAndStatus34 obj) {
			return obj.getRateType();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus34 obj, RateType48Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateTypeAndAmountAndStatus34, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateTypeAndAmountAndStatus34, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(RateTypeAndAmountAndStatus34 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus34 obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus34, Optional<RateStatus4Choice>> mmRateStatus = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus34, Optional<RateStatus4Choice>>() {
		{
		...
		@Override
		public Optional<RateStatus4Choice> getValue(RateTypeAndAmountAndStatus34 obj) {
			return obj.getRateStatus();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus34 obj, Optional<RateStatus4Choice> value) {
	...
	public RateTypeAndAmountAndStatus34 setRateType(RateType48Choice rateType) {
	...
	public RateTypeAndAmountAndStatus34 setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateTypeAndAmountAndStatus34 setRateStatus(RateStatus4Choice rateStatus) {
