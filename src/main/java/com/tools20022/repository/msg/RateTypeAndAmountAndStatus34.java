...
public class RateTypeAndAmountAndStatus34 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus34.mmRateType, RateTypeAndAmountAndStatus34.mmAmount, RateTypeAndAmountAndStatus34.mmRateStatus);
