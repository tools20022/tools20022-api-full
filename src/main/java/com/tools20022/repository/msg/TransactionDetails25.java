...
public class TransactionDetails25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails25.mmTransactionActivity, TransactionDetails25.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails25.mmSecuritiesMovementType,
						TransactionDetails25.mmPayment, TransactionDetails25.mmSettlementParameters, TransactionDetails25.mmPlaceOfTrade, TransactionDetails25.mmSafekeepingPlace, TransactionDetails25.mmFinancialInstrumentIdentification,
						TransactionDetails25.mmPostingQuantity, TransactionDetails25.mmPostingAmount, TransactionDetails25.mmTradeDate, TransactionDetails25.mmExpectedSettlementDate, TransactionDetails25.mmSettlementDate,
						TransactionDetails25.mmLateDeliveryDate, TransactionDetails25.mmExpectedValueDate, TransactionDetails25.mmDeliveringSettlementParties, TransactionDetails25.mmReceivingSettlementParties,
						TransactionDetails25.mmTransactionAdditionalDetails, TransactionDetails25.mmSupplementaryData);
