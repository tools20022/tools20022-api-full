...
public class PartyIdentificationAndAccount158 {
	...
	public static final MMMessageAttribute mmPartyIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmPartyIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAccountIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmAccountIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmProcessingReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmProcessingReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmProcessingDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmProcessingDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmSubAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmSubAccountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmContactPerson = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmContactPerson;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> PartyIdentificationAndAccount123.mmObject();
			}
		});
	...
	public PartyIdentificationAndAccount158 setPartyIdentification(com.tools20022.repository.msg.PartyIdentification113 partyIdentification) {
	...
	public PartyIdentificationAndAccount158 setSubAccountDetails(com.tools20022.repository.msg.SubAccount5 subAccountDetails) {
	...
	public PartyIdentificationAndAccount158 setContactPerson(com.tools20022.repository.msg.ContactIdentification2 contactPerson) {
