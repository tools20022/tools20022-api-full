...
@XmlType(name = "GenericIdentification170", propOrder = {"identification", "description", "issuer", "schemeName"})
public class GenericIdentification170 {
	...
	public static final MMMessageAttribute<GenericIdentification170, Max35Text> mmSchemeName = new MMMessageAttribute<GenericIdentification170, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> GenericIdentification165.mmSchemeName;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification170.mmIdentification, com.tools20022.repository.msg.GenericIdentification170.mmDescription,
						com.tools20022.repository.msg.GenericIdentification170.mmIssuer, com.tools20022.repository.msg.GenericIdentification170.mmSchemeName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "GenericIdentification170";
	...
	public GenericIdentification170 setIdentification(Max35Text identification) {
	...
	public GenericIdentification170 setDescription(Max140Text description) {
	...
	public GenericIdentification170 setIssuer(Max35Text issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification170 setSchemeName(Max35Text schemeName) {
