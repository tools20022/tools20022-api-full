...
public class AmountAndDirection17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection17.mmAmount, AmountAndDirection17.mmCreditDebitIndicator, AmountAndDirection17.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection17.mmForeignExchangeDetails);
