...
public class TotalCommissions3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TotalCommissions3.TotalAmountOfCommissions, com.tools20022.repository.msg.TotalCommissions3.CommissionDetails);
