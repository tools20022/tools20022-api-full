 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.References16
 * References16}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "References18", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification", "poolIdentification",
...
public class References18 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.References18.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			previousVersion_lazy = () -> References16.mmAccountOwnerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(References18 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(References18 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmMarketInfrastructureTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmProcessorTransactionIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmProcessorTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmCommonIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References18, Optional<Max35Text>> mmTradeIdentification = new MMMessageAttribute<References18, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> References16.mmTradeIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.References18.mmAccountOwnerTransactionIdentification, com.tools20022.repository.msg.References18.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.References18.mmMarketInfrastructureTransactionIdentification, com.tools20022.repository.msg.References18.mmProcessorTransactionIdentification,
						com.tools20022.repository.msg.References18.mmPoolIdentification, com.tools20022.repository.msg.References18.mmCommonIdentification, com.tools20022.repository.msg.References18.mmTradeIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReferencePresenceRule.forReferences18);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "References18";
				definition = "Provides a set if identifications to reference to a securities settlement transaction.";
				previousVersion_lazy = () -> References16.mmObject();
			}
		});
	...
	public References18 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public References18 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References18 setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public References18 setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
	...
	public References18 setPoolIdentification(Max35Text poolIdentification) {
	...
	public References18 setCommonIdentification(Max35Text commonIdentification) {
	...
	public References18 setTradeIdentification(Max35Text tradeIdentification) {
