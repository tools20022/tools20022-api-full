...
public class CorporateActionGeneralInformation115 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation115.mmCorporateActionEventIdentification, CorporateActionGeneralInformation115.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation115.mmEventType, CorporateActionGeneralInformation115.mmUnderlyingSecurity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstruction002V07.mmCorporateActionGeneralInformation);
