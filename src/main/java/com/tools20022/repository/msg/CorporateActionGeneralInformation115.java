...
public class CorporateActionGeneralInformation115 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation115.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes84.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionInstruction002V07.mmCorporateActionGeneralInformation);
	...
	public void setEventType(CorporateActionEventType58Choice eventType) {
	...
	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes84 underlyingSecurity) {
