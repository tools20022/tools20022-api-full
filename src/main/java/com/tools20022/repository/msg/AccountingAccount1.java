...
public class AccountingAccount1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute CostReferencePattern = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AccountingAccount1.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.AccountIdentification.CostReferencePattern;
			isDerived = false;
			xmlTag = "CostRefPttrn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountingAccount1.Identification, com.tools20022.repository.msg.AccountingAccount1.CostReferencePattern);
