...
public class GenericIdentification55 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, Max35Text> mmIdentification = new MMMessageAttribute<GenericIdentification55, Max35Text>() {
		{
			businessElementTrace_lazy = () -> GenericIdentification.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification55.mmObject();
			isDerived = false;
			xmlTag = "Id";
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmIdentification, GenericIdentification82.mmIdentification);
			previousVersion_lazy = () -> GenericIdentification44.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(GenericIdentification55 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification55 obj, Max35Text value) {
			obj.setIdentification(value);
		}
	};
	@XmlElement(name = "Tp", required = true)
	protected OtherIdentification2Choice type;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.GenericIdentification82#mmType
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.GenericIdentification44#mmType
	 * GenericIdentification44.mmType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, OtherIdentification2Choice> mmType = new MMMessageAttribute<GenericIdentification55, OtherIdentification2Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmType, GenericIdentification82.mmType);
			previousVersion_lazy = () -> GenericIdentification44.mmType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OtherIdentification2Choice getValue(GenericIdentification55 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification55 obj, OtherIdentification2Choice value) {
			obj.setType(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, Optional<Max35Text>> mmIssuer = new MMMessageAttribute<GenericIdentification55, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmIssuer, GenericIdentification82.mmIssuer);
			previousVersion_lazy = () -> GenericIdentification44.mmIssuer;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(GenericIdentification55 obj) {
			return obj.getIssuer();
		}

		@Override
		public void setValue(GenericIdentification55 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<GenericIdentification55, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmIssueDate, GenericIdentification82.mmIssueDate);
			previousVersion_lazy = () -> GenericIdentification44.mmIssueDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(GenericIdentification55 obj) {
			return obj.getIssueDate();
		}

		@Override
		public void setValue(GenericIdentification55 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, Optional<ISODate>> mmExpiryDate = new MMMessageAttribute<GenericIdentification55, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmExpiryDate, GenericIdentification82.mmExpiryDate);
			previousVersion_lazy = () -> GenericIdentification44.mmExpiryDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification55, Optional<CountryCode>> mmIssuerCountry = new MMMessageAttribute<GenericIdentification55, Optional<CountryCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AlternateIdentification4.mmIssuerCountry, GenericIdentification82.mmIssuerCountry);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CountryCode> getValue(GenericIdentification55 obj) {
			return obj.getIssuerCountry();
		}

		@Override
		public void setValue(GenericIdentification55 obj, Optional<CountryCode> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification55.mmIdentification, com.tools20022.repository.msg.GenericIdentification55.mmType,
						com.tools20022.repository.msg.GenericIdentification55.mmIssuer, com.tools20022.repository.msg.GenericIdentification55.mmIssueDate, com.tools20022.repository.msg.GenericIdentification55.mmExpiryDate,
						com.tools20022.repository.msg.GenericIdentification55.mmIssuerCountry);
	...
	public GenericIdentification55 setIdentification(Max35Text identification) {
	...
	public GenericIdentification55 setType(OtherIdentification2Choice type) {
	...
	public GenericIdentification55 setIssuer(Max35Text issuer) {
		this.issuer = issuer;
		return this;
	}
	...
	public GenericIdentification55 setIssueDate(ISODate issueDate) {
	...
	public GenericIdentification55 setExpiryDate(ISODate expiryDate) {
	...
	public GenericIdentification55 setIssuerCountry(CountryCode issuerCountry) {
