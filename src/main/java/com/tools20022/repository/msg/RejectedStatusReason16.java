...
public class RejectedStatusReason16 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason16.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason16.mmReasonCode, RejectedStatusReason16.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason12Choice reasonCode) {
