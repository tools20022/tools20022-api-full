...
public class GenericIdentification94 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification94.mmIdentification, GenericIdentification94.mmType, GenericIdentification94.mmIssuer, GenericIdentification94.mmCountry, GenericIdentification94.mmShortName,
						GenericIdentification94.mmRemoteAccess);
