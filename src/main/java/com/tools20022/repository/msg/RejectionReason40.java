...
public class RejectionReason40 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason40.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason40.mmCode, RejectionReason40.mmAdditionalReasonInformation);
	...
	public void setCode(ConsentOrRejectionReason5Choice code) {
		this.code = code;
	}
