...
import com.tools20022.repository.choice.ConsentOrRejectionReason5Choice;
...
@XmlType(name = "RejectionReason40", propOrder = {"code", "additionalReasonInformation"})
public class RejectionReason40 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ConsentOrRejectionReason5Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.ConsentOrRejectionReason5Choice
	 * ConsentOrRejectionReason5Choice}</li>
	 * <li>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason40
	 * RejectionReason40}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionReason40, ConsentOrRejectionReason5Choice> mmCode = new MMMessageAssociationEnd<RejectionReason40, ConsentOrRejectionReason5Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmCounterpartyStatusReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionReason40.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ConsentOrRejectionReason5Choice getValue(RejectionReason40 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason40 obj, ConsentOrRejectionReason5Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason40, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason40, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(RejectionReason40 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionReason40 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason40.mmCode, com.tools20022.repository.msg.RejectionReason40.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionReason40";
	...
	public ConsentOrRejectionReason5Choice getCode() {
		return code;
	}

	public RejectionReason40 setCode(ConsentOrRejectionReason5Choice code) {
	...
	public RejectionReason40 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
