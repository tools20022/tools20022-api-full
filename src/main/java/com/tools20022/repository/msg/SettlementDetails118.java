 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails118#TradeDate
...
public class SettlementDetails118 {
	...
	public static final MMMessageAttribute TradeDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails102.TradeDate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SettlementParties = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails102.SettlementParties;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CollateralOwnership = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.SettlementDetails102.CollateralOwnership;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails118.TradeDate, com.tools20022.repository.msg.SettlementDetails118.SettlementParties,
						com.tools20022.repository.msg.SettlementDetails118.CollateralOwnership);
