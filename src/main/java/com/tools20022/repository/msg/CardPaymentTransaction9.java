...
public class CardPaymentTransaction9 {
	...
	public static final MMMessageAssociationEnd mmAuthorisationResult = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CardPaymentTransaction9.mmObject();
			isDerived = false;
			xmlTag = "AuthstnRslt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction9.mmAuthorisationResult, CardPaymentTransaction9.mmTransactionVerificationResult, CardPaymentTransaction9.mmBalance, CardPaymentTransaction9.mmCurrency,
						CardPaymentTransaction9.mmAction);
