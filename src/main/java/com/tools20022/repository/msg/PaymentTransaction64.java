...
@XmlType(name = "PaymentTransaction64", propOrder = {"reversalIdentification", "originalInstructionIdentification", "originalEndToEndIdentification", "originalInstructedAmount", "reversedInstructedAmount", "chargeBearer",
...
public class PaymentTransaction64 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>> mmReversalIdentification = new MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction64.mmObject();
			isDerived = false;
			xmlTag = "RvslId";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmReversalIdentification);
			previousVersion_lazy = () -> PaymentTransaction56.mmReversalIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction64 obj) {
			return obj.getReversalIdentification();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> PaymentTransaction56.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction64, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> PaymentTransaction56.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInstructedAmount = new MMMessageAttribute<PaymentTransaction64, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmOriginalInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction56.mmOriginalInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction64 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<ActiveOrHistoricCurrencyAndAmount>> mmReversedInstructedAmount = new MMMessageAttribute<PaymentTransaction64, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmInstructedAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction64.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmReversedInstructedAmount);
			previousVersion_lazy = () -> PaymentTransaction56.mmReversedInstructedAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveOrHistoricCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, Optional<ChargeBearerType1Code>> mmChargeBearer = new MMMessageAttribute<PaymentTransaction64, Optional<ChargeBearerType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmChargeBearer);
			previousVersion_lazy = () -> PaymentTransaction56.mmChargeBearer;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ChargeBearerType1Code> getValue(PaymentTransaction64 obj) {
			return obj.getChargeBearer();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, Optional<ChargeBearerType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction64, List<PaymentReversalReason7>> mmReversalReasonInformation = new MMMessageAssociationEnd<PaymentTransaction64, List<PaymentReversalReason7>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmReversalReasonInformation);
			previousVersion_lazy = () -> PaymentTransaction56.mmReversalReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<PaymentReversalReason7> getValue(PaymentTransaction64 obj) {
			return obj.getReversalReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, List<PaymentReversalReason7> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction64, Optional<OriginalTransactionReference22>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction64, Optional<OriginalTransactionReference22>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmOriginalTransactionReference);
			previousVersion_lazy = () -> PaymentTransaction56.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OriginalTransactionReference22> getValue(PaymentTransaction64 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, Optional<OriginalTransactionReference22> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction64, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction64, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction64.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmSupplementaryData);
			previousVersion_lazy = () -> PaymentTransaction56.mmSupplementaryData;
			minOccurs = 0;
			complexType_lazy = () -> SupplementaryData1.mmObject();
		}

		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction64 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction64 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction64.mmReversalIdentification, com.tools20022.repository.msg.PaymentTransaction64.mmOriginalInstructionIdentification,
						com.tools20022.repository.msg.PaymentTransaction64.mmOriginalEndToEndIdentification, com.tools20022.repository.msg.PaymentTransaction64.mmOriginalInstructedAmount,
						com.tools20022.repository.msg.PaymentTransaction64.mmReversedInstructedAmount, com.tools20022.repository.msg.PaymentTransaction64.mmChargeBearer,
						com.tools20022.repository.msg.PaymentTransaction64.mmReversalReasonInformation, com.tools20022.repository.msg.PaymentTransaction64.mmOriginalTransactionReference,
						com.tools20022.repository.msg.PaymentTransaction64.mmSupplementaryData);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction64";
				...
				nextVersions_lazy = () -> Arrays.asList(PaymentTransaction77.mmObject());
				previousVersion_lazy = () -> PaymentTransaction56.mmObject();
			}
		});
	...
	public PaymentTransaction64 setReversalIdentification(Max35Text reversalIdentification) {
	...
	public PaymentTransaction64 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction64 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction64 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public PaymentTransaction64 setReversedInstructedAmount(ActiveOrHistoricCurrencyAndAmount reversedInstructedAmount) {
	...
	public PaymentTransaction64 setChargeBearer(ChargeBearerType1Code chargeBearer) {
	...
	public PaymentTransaction64 setReversalReasonInformation(List<PaymentReversalReason7> reversalReasonInformation) {
	...
	public PaymentTransaction64 setOriginalTransactionReference(OriginalTransactionReference22 originalTransactionReference) {
	...
	public PaymentTransaction64 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
