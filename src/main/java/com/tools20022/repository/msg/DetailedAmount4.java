 ...
 * <li>{@linkplain com.tools20022.repository.msg.DetailedAmount4#Label
...
public class DetailedAmount4 {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DetailedAmount6.Amount, com.tools20022.repository.msg.DetailedAmount13.Amount, com.tools20022.repository.msg.DetailedAmount8.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <li>{@linkplain com.tools20022.repository.msg.DetailedAmount13#Label
	...
	public static final MMMessageAttribute Label = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DetailedAmount6.Label, com.tools20022.repository.msg.DetailedAmount13.Label, com.tools20022.repository.msg.DetailedAmount8.Label);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DetailedAmount4.Amount, com.tools20022.repository.msg.DetailedAmount4.Label);
