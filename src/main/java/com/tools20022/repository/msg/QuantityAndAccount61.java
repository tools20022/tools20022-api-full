...
public class QuantityAndAccount61 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount61.mmSettlementQuantity, QuantityAndAccount61.mmAccountOwner, QuantityAndAccount61.mmSafekeepingAccount, QuantityAndAccount61.mmCashAccount,
						QuantityAndAccount61.mmSafekeepingPlace);
