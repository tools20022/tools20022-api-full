...
@XmlType(name = "QuantityAndAccount61", propOrder = {"settlementQuantity", "accountOwner", "safekeepingAccount", "cashAccount", "safekeepingPlace"})
public class QuantityAndAccount61 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount61, FinancialInstrumentQuantity15Choice> mmSettlementQuantity = new MMMessageAssociationEnd<QuantityAndAccount61, FinancialInstrumentQuantity15Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityAndAccount61.mmObject();
			isDerived = false;
			xmlTag = "SttlmQty";
			...
			previousVersion_lazy = () -> QuantityAndAccount48.mmSettlementQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public FinancialInstrumentQuantity15Choice getValue(QuantityAndAccount61 obj) {
			return obj.getSettlementQuantity();
		}

		@Override
		public void setValue(QuantityAndAccount61 obj, FinancialInstrumentQuantity15Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount61, Optional<PartyIdentification119>> mmAccountOwner = new MMMessageAssociationEnd<QuantityAndAccount61, Optional<PartyIdentification119>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount48.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PartyIdentification119> getValue(QuantityAndAccount61 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(QuantityAndAccount61 obj, Optional<PartyIdentification119> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount61, SecuritiesAccount30> mmSafekeepingAccount = new MMMessageAssociationEnd<QuantityAndAccount61, SecuritiesAccount30>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount48.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecuritiesAccount30 getValue(QuantityAndAccount61 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(QuantityAndAccount61 obj, SecuritiesAccount30 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount61, Optional<CashAccountIdentification6Choice>> mmCashAccount = new MMMessageAssociationEnd<QuantityAndAccount61, Optional<CashAccountIdentification6Choice>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount48.mmCashAccount;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashAccountIdentification6Choice> getValue(QuantityAndAccount61 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(QuantityAndAccount61 obj, Optional<CashAccountIdentification6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityAndAccount61, Optional<SafeKeepingPlace2>> mmSafekeepingPlace = new MMMessageAssociationEnd<QuantityAndAccount61, Optional<SafeKeepingPlace2>>() {
		{
			...
			previousVersion_lazy = () -> QuantityAndAccount48.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SafeKeepingPlace2> getValue(QuantityAndAccount61 obj) {
			return obj.getSafekeepingPlace();
		}

		@Override
		public void setValue(QuantityAndAccount61 obj, Optional<SafeKeepingPlace2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityAndAccount61.mmSettlementQuantity, com.tools20022.repository.msg.QuantityAndAccount61.mmAccountOwner,
						com.tools20022.repository.msg.QuantityAndAccount61.mmSafekeepingAccount, com.tools20022.repository.msg.QuantityAndAccount61.mmCashAccount, com.tools20022.repository.msg.QuantityAndAccount61.mmSafekeepingPlace);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingModificationInstruction002V06.mmQuantityAndAccountDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "QuantityAndAccount61";
				definition = "Details on the quantity, account and other related information involved in a transaction.";
				previousVersion_lazy = () -> QuantityAndAccount48.mmObject();
			}
		});
	...
	public QuantityAndAccount61 setSettlementQuantity(FinancialInstrumentQuantity15Choice settlementQuantity) {
	...
	public QuantityAndAccount61 setAccountOwner(PartyIdentification119 accountOwner) {
	...
	public QuantityAndAccount61 setSafekeepingAccount(SecuritiesAccount30 safekeepingAccount) {
	...
	public QuantityAndAccount61 setCashAccount(CashAccountIdentification6Choice cashAccount) {
	...
	public QuantityAndAccount61 setSafekeepingPlace(SafeKeepingPlace2 safekeepingPlace) {
