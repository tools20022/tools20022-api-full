...
public class ATMWithdrawalCompletionAdvice1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ATMWithdrawalCompletionAdvice1.mmEnvironment, ATMWithdrawalCompletionAdvice1.mmContext, ATMWithdrawalCompletionAdvice1.mmTransaction);
