...
public class SubAccountIdentification24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification24.mmAccountOwner, SubAccountIdentification24.mmSafekeepingAccount, SubAccountIdentification24.mmActivityIndicator,
						SubAccountIdentification24.mmFinancialInstrumentDetails);
