...
public class CorporateActionPrice51 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice51.mmIndicativeOrMarketPrice, CorporateActionPrice51.mmCashInLieuOfSharePrice, CorporateActionPrice51.mmCashValueForTax,
						CorporateActionPrice51.mmGenericCashPricePaidPerProduct, CorporateActionPrice51.mmGenericCashPriceReceivedPerProduct);
