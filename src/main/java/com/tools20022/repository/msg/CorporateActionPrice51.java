 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forCorporateActionPrice51
 * ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice51}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionPrice51", propOrder = {"indicativeOrMarketPrice", "cashInLieuOfSharePrice", "cashValueForTax", "genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class CorporateActionPrice51 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice51, Optional<IndicativeOrMarketPrice6Choice>> mmIndicativeOrMarketPrice = new MMMessageAssociationEnd<CorporateActionPrice51, Optional<IndicativeOrMarketPrice6Choice>>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionPrice.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionPrice51.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<IndicativeOrMarketPrice6Choice> getValue(CorporateActionPrice51 obj) {
			return obj.getIndicativeOrMarketPrice();
		}

		@Override
		public void setValue(CorporateActionPrice51 obj, Optional<IndicativeOrMarketPrice6Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat25Choice>> mmCashInLieuOfSharePrice = new MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat25Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat25Choice> getValue(CorporateActionPrice51 obj) {
			return obj.getCashInLieuOfSharePrice();
		}

		@Override
		public void setValue(CorporateActionPrice51 obj, Optional<PriceFormat25Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionPrice51, Optional<PriceFormat31Choice>> mmCashValueForTax = new MMMessageAttribute<CorporateActionPrice51, Optional<PriceFormat31Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat31Choice> getValue(CorporateActionPrice51 obj) {
			return obj.getCashValueForTax();
		}

		@Override
		public void setValue(CorporateActionPrice51 obj, Optional<PriceFormat31Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat27Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat27Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat27Choice> getValue(CorporateActionPrice51 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice51 obj, Optional<PriceFormat27Choice> value) {
			obj.setGenericCashPricePaidPerProduct(value.orElse(null));
		}
	};
	@XmlElement(name = "GncCshPricRcvdPerPdct")
	protected PriceFormat39Choice genericCashPriceReceivedPerProduct;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.choice.PriceFormat39Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat39Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<CorporateActionPrice51, Optional<PriceFormat39Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PriceFormat39Choice.mmObject();
		}

		@Override
		public Optional<PriceFormat39Choice> getValue(CorporateActionPrice51 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(CorporateActionPrice51 obj, Optional<PriceFormat39Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionPrice51.mmIndicativeOrMarketPrice, com.tools20022.repository.msg.CorporateActionPrice51.mmCashInLieuOfSharePrice,
						com.tools20022.repository.msg.CorporateActionPrice51.mmCashValueForTax, com.tools20022.repository.msg.CorporateActionPrice51.mmGenericCashPricePaidPerProduct,
						com.tools20022.repository.msg.CorporateActionPrice51.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> CorporateActionPrice.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCorporateActionPrice51);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionPrice51";
	...
	public CorporateActionPrice51 setIndicativeOrMarketPrice(IndicativeOrMarketPrice6Choice indicativeOrMarketPrice) {
	...
	public CorporateActionPrice51 setCashInLieuOfSharePrice(PriceFormat25Choice cashInLieuOfSharePrice) {
	...
	public CorporateActionPrice51 setCashValueForTax(PriceFormat31Choice cashValueForTax) {
	...
	public CorporateActionPrice51 setGenericCashPricePaidPerProduct(PriceFormat27Choice genericCashPricePaidPerProduct) {
		this.genericCashPricePaidPerProduct = genericCashPricePaidPerProduct;
		return this;
	}

	public Optional<PriceFormat39Choice> getGenericCashPriceReceivedPerProduct() {
		return genericCashPriceReceivedPerProduct == null ? Optional.empty() : Optional.of(genericCashPriceReceivedPerProduct);
	}

	public CorporateActionPrice51 setGenericCashPriceReceivedPerProduct(PriceFormat39Choice genericCashPriceReceivedPerProduct) {
