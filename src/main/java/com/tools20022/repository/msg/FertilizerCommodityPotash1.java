...
public class FertilizerCommodityPotash1 {
	...
	public static final MMMessageAttribute mmBaseProduct = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FertilizerCommodityPotash1.mmObject();
			isDerived = false;
			xmlTag = "BasePdct";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FertilizerCommodityPotash1.mmBaseProduct, FertilizerCommodityPotash1.mmSubProduct);
	...
	public void setSubProduct(AssetClassSubProductType41Code subProduct) {
