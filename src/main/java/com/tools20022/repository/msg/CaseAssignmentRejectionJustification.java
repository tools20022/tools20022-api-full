...
import com.tools20022.repository.area.camt.RejectCaseAssignment;
...
@XmlType(name = "CaseAssignmentRejectionJustification", propOrder = "rejectionReason")
public class CaseAssignmentRejectionJustification {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(RejectCaseAssignment.mmJustification);
	...
	public CaseAssignmentRejectionJustification setRejectionReason(CaseAssignmentRejection1Code rejectionReason) {
