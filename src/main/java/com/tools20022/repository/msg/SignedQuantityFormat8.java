...
import com.tools20022.repository.choice.Quantity21Choice;
...
@XmlType(name = "SignedQuantityFormat8", propOrder = {"shortLongPosition", "quantityChoice"})
public class SignedQuantityFormat8 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.SignedQuantityFormat8
	 * SignedQuantityFormat8}</li>
	...
	protected Quantity21Choice quantityChoice;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.choice.Quantity21Choice
	 * Quantity21Choice}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SignedQuantityFormat8.mmShortLongPosition, com.tools20022.repository.msg.SignedQuantityFormat8.mmQuantityChoice);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SignedQuantityFormat8";
	...
	public SignedQuantityFormat8 setShortLongPosition(ShortLong1Code shortLongPosition) {
		this.shortLongPosition = Objects.requireNonNull(shortLongPosition);
		return this;
	}

	public Quantity21Choice getQuantityChoice() {
		return quantityChoice;
	}

	public SignedQuantityFormat8 setQuantityChoice(Quantity21Choice quantityChoice) {
