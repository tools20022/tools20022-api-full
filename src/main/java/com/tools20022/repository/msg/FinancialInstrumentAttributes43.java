...
public class FinancialInstrumentAttributes43 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes43.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes43.mmPlaceOfListing, FinancialInstrumentAttributes43.mmDayCountBasis,
						FinancialInstrumentAttributes43.mmClassificationType, FinancialInstrumentAttributes43.mmOptionStyle, FinancialInstrumentAttributes43.mmDenominationCurrency, FinancialInstrumentAttributes43.mmNextCouponDate,
						FinancialInstrumentAttributes43.mmExpiryDate, FinancialInstrumentAttributes43.mmFloatingRateFixingDate, FinancialInstrumentAttributes43.mmMaturityDate, FinancialInstrumentAttributes43.mmIssueDate,
						FinancialInstrumentAttributes43.mmNextCallableDate, FinancialInstrumentAttributes43.mmPutableDate, FinancialInstrumentAttributes43.mmDatedDate, FinancialInstrumentAttributes43.mmConversionDate,
						FinancialInstrumentAttributes43.mmInterestRate, FinancialInstrumentAttributes43.mmNextInterestRate, FinancialInstrumentAttributes43.mmPercentageOfDebtClaim, FinancialInstrumentAttributes43.mmPreviousFactor,
						FinancialInstrumentAttributes43.mmNextFactor, FinancialInstrumentAttributes43.mmWarrantParity, FinancialInstrumentAttributes43.mmMinimumNominalQuantity, FinancialInstrumentAttributes43.mmMinimumExercisableQuantity,
						FinancialInstrumentAttributes43.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes43.mmContractSize);
