	...
	public static final MMMessageAssociationEnd Date = new MMMessageAssociationEnd() {
		{
			...
			name = "Date";
			definition = "Indicates when the amount of money will become available.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.CashBalanceAvailability2.Date;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CashBalanceAvailability2.Amount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CashBalanceAvailability2.CreditDebitIndicator;
			minOccurs = 1;
			maxOccurs = 1;
