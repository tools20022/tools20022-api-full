...
public class ISATransfer6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ISATransfer6.mmMasterReference, ISATransfer6.mmTransferIdentification, ISATransfer6.mmResidualCash, ISATransfer6.mmPortfolio, ISATransfer6.mmAllOtherCash,
						ISATransfer6.mmFinancialInstrumentAssetForTransfer);
