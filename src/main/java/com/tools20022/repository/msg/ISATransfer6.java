...
import com.tools20022.repository.area.sese.AccountHoldingInformationV03;
...
import com.tools20022.repository.msg.FinancialInstrument30;
import java.util.*;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer6#mmMasterReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer6#mmResidualCash
 ...
 * <li>{@linkplain com.tools20022.repository.msg.ISATransfer6#mmAllOtherCash
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintISARule#forISATransfer6
 * ConstraintISARule.forISATransfer6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDesignationRule#forISATransfer6
 * ConstraintDesignationRule.forISATransfer6}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.ISATransfer4
 * ISATransfer4}</li>
 * </ul>
 */
...
public class ISATransfer6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer6, Optional<Max35Text>> mmMasterReference = new MMMessageAttribute<ISATransfer6, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Order.mmMasterIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "MstrRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "MasterReference";
			definition = "Unique and unambiguous identifier for a group of individual transfers as assigned by the instructing party. This identifier links the individual transfers together.";
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ISATransfer6 obj) {
			return obj.getMasterReference();
		}

		@Override
		public void setValue(ISATransfer6 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer6, Max35Text> mmTransferIdentification = new MMMessageAttribute<ISATransfer6, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "TrfId";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmTransferIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Max35Text getValue(ISATransfer6 obj) {
			return obj.getTransferIdentification();
		}

		@Override
		public void setValue(ISATransfer6 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer6, Optional<ResidualCash1Code>> mmResidualCash = new MMMessageAttribute<ISATransfer6, Optional<ResidualCash1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "RsdlCsh";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmResidualCash);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ResidualCash1Code> getValue(ISATransfer6 obj) {
			return obj.getResidualCash();
		}

		@Override
		public void setValue(ISATransfer6 obj, Optional<ResidualCash1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ISATransfer6, ISAPortfolio1Choice> mmPortfolio = new MMMessageAssociationEnd<ISATransfer6, ISAPortfolio1Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmPortfolio);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public ISAPortfolio1Choice getValue(ISATransfer6 obj) {
			return obj.getPortfolio();
		}

		@Override
		public void setValue(ISATransfer6 obj, ISAPortfolio1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ISATransfer6, YesNoIndicator> mmAllOtherCash = new MMMessageAttribute<ISATransfer6, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ISATransfer6.mmObject();
			isDerived = false;
			xmlTag = "AllOthrCsh";
			...
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmAllOtherCash);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(ISATransfer6 obj) {
			return obj.getAllOtherCash();
		}

		@Override
		public void setValue(ISATransfer6 obj, YesNoIndicator value) {
			obj.setAllOtherCash(value);
		}
	};
	@XmlElement(name = "FinInstrmAsstForTrf")
	protected List<FinancialInstrument30> financialInstrumentAssetForTransfer;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.FinancialInstrument30
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ISATransfer6, List<FinancialInstrument30>> mmFinancialInstrumentAssetForTransfer = new MMMessageAssociationEnd<ISATransfer6, List<FinancialInstrument30>>() {
		{
			...
			definition = "Specifies the underlying assets for the ISA or portfolio.";
			nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmFinancialInstrumentAssetForTransfer);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrument30.mmObject();
		}

		@Override
		public List<FinancialInstrument30> getValue(ISATransfer6 obj) {
			return obj.getFinancialInstrumentAssetForTransfer();
		}

		@Override
		public void setValue(ISATransfer6 obj, List<FinancialInstrument30> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ISATransfer6.mmMasterReference, com.tools20022.repository.msg.ISATransfer6.mmTransferIdentification,
						com.tools20022.repository.msg.ISATransfer6.mmResidualCash, com.tools20022.repository.msg.ISATransfer6.mmPortfolio, com.tools20022.repository.msg.ISATransfer6.mmAllOtherCash,
						com.tools20022.repository.msg.ISATransfer6.mmFinancialInstrumentAssetForTransfer);
				messageBuildingBlock_lazy = () -> Arrays.asList(AccountHoldingInformationV03.mmProductTransfer);
				trace_lazy = () -> PortfolioTransfer.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintISARule.forISATransfer6, com.tools20022.repository.constraints.ConstraintDesignationRule.forISATransfer6);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ISATransfer6";
				definition = "Describes the type of product and the assets to be transferred.";
				nextVersions_lazy = () -> Arrays.asList(ISATransfer14.mmObject());
				previousVersion_lazy = () -> ISATransfer4.mmObject();
			}
		});
	...
	public ISATransfer6 setMasterReference(Max35Text masterReference) {
	...
	public ISATransfer6 setTransferIdentification(Max35Text transferIdentification) {
	...
	public ISATransfer6 setResidualCash(ResidualCash1Code residualCash) {
	...
	public ISATransfer6 setPortfolio(ISAPortfolio1Choice portfolio) {
	...
	public ISATransfer6 setAllOtherCash(YesNoIndicator allOtherCash) {
	...
	public ISATransfer6 setFinancialInstrumentAssetForTransfer(List<FinancialInstrument30> financialInstrumentAssetForTransfer) {
