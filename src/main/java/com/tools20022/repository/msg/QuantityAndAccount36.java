...
public class QuantityAndAccount36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount36.mmSettlementQuantity, QuantityAndAccount36.mmDenominationChoice, QuantityAndAccount36.mmAccountOwner, QuantityAndAccount36.mmSafekeepingAccount,
						QuantityAndAccount36.mmCashAccount, QuantityAndAccount36.mmQuantityBreakdown, QuantityAndAccount36.mmSafekeepingPlace);
