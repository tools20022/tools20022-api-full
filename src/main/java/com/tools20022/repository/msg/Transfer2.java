 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer2#mmTransferConfirmationReference
 * Transfer2.mmTransferConfirmationReference}</li>
 * <li>{@linkplain com.tools20022.repository.msg.Transfer2#mmTransferReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Transfer2#mmTotalUnitsNumber
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.Transfer2#mmPortfolioTransferOutRate
 * Transfer2.mmPortfolioTransferOutRate}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule#forTransfer2
 * ConstraintTotalUnitsNumberRule.forTransfer2}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Transfer2", propOrder = {"transferConfirmationReference", "transferReference", "effectiveTransferDate", "tradeDate", "totalUnitsNumber", "unitsDetails", "portfolioTransferOutRate", "ownAccountTransferIndicator",
		"averagePrice"})
public class Transfer2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, Max35Text> mmTransferConfirmationReference = new MMMessageAttribute<Transfer2, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer2.mmObject();
			isDerived = false;
			xmlTag = "TrfConfRef";
		...
		@Override
		public Max35Text getValue(Transfer2 obj) {
			return obj.getTransferConfirmationReference();
		}

		@Override
		public void setValue(Transfer2 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, Max35Text> mmTransferReference = new MMMessageAttribute<Transfer2, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, DateAndDateTimeChoice> mmEffectiveTransferDate = new MMMessageAttribute<Transfer2, DateAndDateTimeChoice>() {
		{
		...
		@Override
		public DateAndDateTimeChoice getValue(Transfer2 obj) {
			return obj.getEffectiveTransferDate();
		}

		@Override
		public void setValue(Transfer2 obj, DateAndDateTimeChoice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, ISODate> mmTradeDate = new MMMessageAttribute<Transfer2, ISODate>() {
		{
		...
		@Override
		public ISODate getValue(Transfer2 obj) {
			return obj.getTradeDate();
		}

		@Override
		public void setValue(Transfer2 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, FinancialInstrumentQuantity1> mmTotalUnitsNumber = new MMMessageAttribute<Transfer2, FinancialInstrumentQuantity1>() {
		{
		...
		@Override
		public FinancialInstrumentQuantity1 getValue(Transfer2 obj) {
			return obj.getTotalUnitsNumber();
		}

		@Override
		public void setValue(Transfer2 obj, FinancialInstrumentQuantity1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Transfer2, List<Unit1>> mmUnitsDetails = new MMMessageAssociationEnd<Transfer2, List<Unit1>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTransfer.mmTransferredQuantity;
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer2.mmObject();
			isDerived = false;
		...
		@Override
		public List<Unit1> getValue(Transfer2 obj) {
			return obj.getUnitsDetails();
		}

		@Override
		public void setValue(Transfer2 obj, List<Unit1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, Optional<PercentageRate>> mmPortfolioTransferOutRate = new MMMessageAttribute<Transfer2, Optional<PercentageRate>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.Transfer2.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PercentageRate> getValue(Transfer2 obj) {
			return obj.getPortfolioTransferOutRate();
		}

		@Override
		public void setValue(Transfer2 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, YesNoIndicator> mmOwnAccountTransferIndicator = new MMMessageAttribute<Transfer2, YesNoIndicator>() {
		{
		...
		@Override
		public YesNoIndicator getValue(Transfer2 obj) {
			return obj.getOwnAccountTransferIndicator();
		}

		@Override
		public void setValue(Transfer2 obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Transfer2, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>> mmAveragePrice = new MMMessageAttribute<Transfer2, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> getValue(Transfer2 obj) {
			return obj.getAveragePrice();
		}

		@Override
		public void setValue(Transfer2 obj, Optional<ActiveOrHistoricCurrencyAnd13DecimalAmount> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintTotalUnitsNumberRule.forTransfer2);
	...
	public Transfer2 setTransferConfirmationReference(Max35Text transferConfirmationReference) {
	...
	public Transfer2 setTransferReference(Max35Text transferReference) {
	...
	public Transfer2 setEffectiveTransferDate(DateAndDateTimeChoice effectiveTransferDate) {
	...
	public Transfer2 setTradeDate(ISODate tradeDate) {
	...
	public Transfer2 setTotalUnitsNumber(FinancialInstrumentQuantity1 totalUnitsNumber) {
	...
	public Transfer2 setUnitsDetails(List<Unit1> unitsDetails) {
	...
	public Transfer2 setPortfolioTransferOutRate(PercentageRate portfolioTransferOutRate) {
	...
	public Transfer2 setOwnAccountTransferIndicator(YesNoIndicator ownAccountTransferIndicator) {
	...
	public Transfer2 setAveragePrice(ActiveOrHistoricCurrencyAnd13DecimalAmount averagePrice) {
