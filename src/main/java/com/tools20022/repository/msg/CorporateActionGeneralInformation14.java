...
public class CorporateActionGeneralInformation14 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation14.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation14.mmCorporateActionEventIdentification, CorporateActionGeneralInformation14.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation14.mmEventType, CorporateActionGeneralInformation14.mmUnderlyingSecurityIdentification);
