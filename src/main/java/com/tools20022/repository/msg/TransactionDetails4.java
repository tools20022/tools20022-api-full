...
public class TransactionDetails4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails4.mmAccountOwner, TransactionDetails4.mmSafekeepingAccount, TransactionDetails4.mmFinancialInstrumentIdentification, TransactionDetails4.mmSettlementQuantity,
						TransactionDetails4.mmSettlementAmount, TransactionDetails4.mmTradeDate, TransactionDetails4.mmSettlementDate, TransactionDetails4.mmDeliveringSettlementParties, TransactionDetails4.mmReceivingSettlementParties,
						TransactionDetails4.mmInvestor);
