...
public class RemittanceInformation6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceInformation6.Unstructured, com.tools20022.repository.msg.RemittanceInformation6.Structured);
