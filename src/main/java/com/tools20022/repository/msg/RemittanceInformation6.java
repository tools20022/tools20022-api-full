...
public class RemittanceInformation6 {
	...
	public static final MMMessageAttribute mmUnstructured = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RemittanceInformation6.mmObject();
			isDerived = false;
			xmlTag = "Ustrd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RemittanceInformation6.mmUnstructured, RemittanceInformation6.mmStructured);
	...
	public void setStructured(List<com.tools20022.repository.msg.StructuredRemittanceInformation8> structured) {
