 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown5#mmLotNumber
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forQuantityBreakdown5
 * ConstraintCoexistenceQuantityRule.forQuantityBreakdown5}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "QuantityBreakdown5", propOrder = {"lotNumber", "lotQuantity"})
public class QuantityBreakdown5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown5.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown5.mmLotQuantity);
				trace_lazy = () -> LotBreakdown.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forQuantityBreakdown5);
				...
				name = "QuantityBreakdown5";
				definition = "Details of breakdown of a quantity.";
				nextVersions_lazy = () -> Arrays.asList(QuantityBreakdown15.mmObject());
			}
		});
	...
	public QuantityBreakdown5 setLotNumber(Number2Choice lotNumber) {
	...
	public QuantityBreakdown5 setLotQuantity(FinancialInstrumentQuantity1Choice lotQuantity) {
