 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown5#LotNumber
 * QuantityBreakdown5.LotNumber}</li>
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown5#LotQuantity
...
public class QuantityBreakdown5 {
	...
	public static final MMMessageAttribute LotNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> QuantityBreakdown5.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown5.LotNumber, com.tools20022.repository.msg.QuantityBreakdown5.LotQuantity);
