...
public class Transaction45 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction45.mmAccountOwnerTransactionIdentification, Transaction45.mmAccountServicerTransactionIdentification, Transaction45.mmMarketInfrastructureTransactionIdentification,
						Transaction45.mmProcessorTransactionIdentification, Transaction45.mmTradeIdentification, Transaction45.mmPoolIdentification, Transaction45.mmCommonIdentification, Transaction45.mmCorporateActionEventIdentification,
						Transaction45.mmTripartyAgentCollateralTransactionIdentification, Transaction45.mmClientTripartyCollateralTransactionIdentification, Transaction45.mmClientCollateralInstructionIdentification,
						Transaction45.mmTripartyCollateralInstructionIdentification, Transaction45.mmTransactionDetails);
