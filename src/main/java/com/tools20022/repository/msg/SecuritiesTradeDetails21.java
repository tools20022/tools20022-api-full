...
public class SecuritiesTradeDetails21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTradeDetails21.mmTradeIdentification, SecuritiesTradeDetails21.mmCollateralTransactionIdentification, SecuritiesTradeDetails21.mmAccountOwnerTransactionIdentification,
						SecuritiesTradeDetails21.mmProcessorTransactionIdentification, SecuritiesTradeDetails21.mmPlaceOfTrade, SecuritiesTradeDetails21.mmPlaceOfClearing, SecuritiesTradeDetails21.mmTradeDate,
						SecuritiesTradeDetails21.mmSettlementDate, SecuritiesTradeDetails21.mmDealPrice, SecuritiesTradeDetails21.mmNumberOfDaysAccrued, SecuritiesTradeDetails21.mmTradeTransactionCondition,
						SecuritiesTradeDetails21.mmTypeOfPrice);
