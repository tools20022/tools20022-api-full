...
public class CashAccountDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashAccountDetails3.mmName, CashAccountDetails3.mmType, CashAccountDetails3.mmCurrency, CashAccountDetails3.mmCurrentMultilateralLimit, CashAccountDetails3.mmAccountOwner,
						CashAccountDetails3.mmAccountServicer, CashAccountDetails3.mmMultilateralBalance, CashAccountDetails3.mmCurrentBilateralLimit, CashAccountDetails3.mmStandingOrder);
