...
import com.tools20022.repository.choice.AcknowledgementReason21Choice;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AcknowledgementReason18#mmCode
...
@XmlType(name = "AcknowledgementReason18", propOrder = {"code", "additionalReasonInformation"})
public class AcknowledgementReason18 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AcknowledgementReason21Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * complexType} =
	 * {@linkplain com.tools20022.repository.choice.AcknowledgementReason21Choice
	 * AcknowledgementReason21Choice}</li>
	 * <li>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AcknowledgementReason18
	 * AcknowledgementReason18}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AcknowledgementReason18.mmCode, com.tools20022.repository.msg.AcknowledgementReason18.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason18";
	...
	public AcknowledgementReason21Choice getCode() {
		return code;
	}

	public AcknowledgementReason18 setCode(AcknowledgementReason21Choice code) {
	...
	public AcknowledgementReason18 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
