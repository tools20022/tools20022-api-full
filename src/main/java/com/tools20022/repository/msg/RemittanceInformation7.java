...
public class RemittanceInformation7 {
	...
	public static final MMMessageAttribute mmUnstructured = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RemittanceInformation8.mmUnstructured, RemittanceInformation10.mmUnstructured);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmStructured = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RemittanceInformation8.mmStructured, RemittanceInformation10.mmStructured);
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RemittanceInformation7.mmUnstructured, RemittanceInformation7.mmStructured);
