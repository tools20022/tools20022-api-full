...
public class CancellationReason3 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CancellationReason3.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationReason3.mmCode, CancellationReason3.mmAdditionalReasonInformation);
	...
	public void setCode(CancellationReason7Choice code) {
		this.code = code;
	}
