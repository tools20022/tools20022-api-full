...
import com.tools20022.repository.choice.CancellationReason7Choice;
...
@XmlType(name = "CancellationReason3", propOrder = {"code", "additionalReasonInformation"})
public class CancellationReason3 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CancellationReason7Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CancellationReason3
	 * CancellationReason3}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancellationReason3.mmCode, com.tools20022.repository.msg.CancellationReason3.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationReason3";
	...
	public CancellationReason7Choice getCode() {
		return code;
	}

	public CancellationReason3 setCode(CancellationReason7Choice code) {
	...
	public CancellationReason3 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
