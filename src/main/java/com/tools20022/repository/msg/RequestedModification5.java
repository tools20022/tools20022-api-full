...
public class RequestedModification5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestedModification5.mmInstructionIdentification, RequestedModification5.mmEndToEndIdentification, RequestedModification5.mmTransactionIdentification,
						RequestedModification5.mmPaymentTypeInformation, RequestedModification5.mmRequestedExecutionDate, RequestedModification5.mmRequestedCollectionDate, RequestedModification5.mmInterbankSettlementDate,
						RequestedModification5.mmAmount, RequestedModification5.mmInterbankSettlementAmount, RequestedModification5.mmChargeBearer, RequestedModification5.mmUltimateDebtor, RequestedModification5.mmDebtor,
						RequestedModification5.mmDebtorAccount, RequestedModification5.mmDebtorAgentAccount, RequestedModification5.mmSettlementInformation, RequestedModification5.mmCreditorAgentAccount, RequestedModification5.mmCreditor,
						RequestedModification5.mmCreditorAccount, RequestedModification5.mmUltimateCreditor, RequestedModification5.mmPurpose, RequestedModification5.mmInstructionForDebtorAgent,
						RequestedModification5.mmInstructionForNextAgent, RequestedModification5.mmInstructionForCreditorAgent, RequestedModification5.mmRemittanceInformation);
