...
public class OriginalGroupHeader12 {
	...
	public static final MMMessageAttribute mmOriginalMessageIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalGroupHeader2.mmOriginalMessageIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmOriginalMessageNameIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalGroupHeader2.mmOriginalMessageNameIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalCreationDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OriginalGroupHeader2.mmOriginalCreationDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmReturnReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> OriginalGroupHeader2.mmReturnReasonInformation;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> OriginalGroupHeader2.mmObject();
			}
		});
	...
	public OriginalGroupHeader12 setReturnReasonInformation(List<com.tools20022.repository.msg.PaymentReturnReason4> returnReasonInformation) {
