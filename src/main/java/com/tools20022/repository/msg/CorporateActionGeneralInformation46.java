...
public class CorporateActionGeneralInformation46 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation46.mmCorporateActionEventIdentification, CorporateActionGeneralInformation46.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation46.mmClassActionNumber, CorporateActionGeneralInformation46.mmEventProcessingType, CorporateActionGeneralInformation46.mmEventType,
						CorporateActionGeneralInformation46.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation46.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation46.mmUnderlyingSecurity);
