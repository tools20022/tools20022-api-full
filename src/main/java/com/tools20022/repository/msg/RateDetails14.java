 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule#forRateDetails14
 * ConstraintGrossDividendRate2Rule.forRateDetails14}</li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.RateDetails22 RateDetails22}</li>
 * </ul>
 * </li>
 * <li>{@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
 * previousVersion} = {@linkplain com.tools20022.repository.msg.RateDetails10
 * RateDetails10}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "RateDetails14", propOrder = {"additionalTax", "grossDividendRate", "interestRateUsedForPayment", "taxRelatedRate", "withholdingTaxRate", "chargesFees", "earlySolicitationFeeRate", "finalDividendRate", "fiscalStamp",
...
public class RateDetails14 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>> mmAdditionalTax = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionDistribution.mmTaxVoucher;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			xmlTag = "AddtlTax";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AdditionalTax";
			definition = "Rate used for additional tax that cannot be categorised.";
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmAdditionalTax);
			previousVersion_lazy = () -> RateDetails10.mmAdditionalTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateAndAmountFormat14Choice> getValue(RateDetails14 obj) {
			return obj.getAdditionalTax();
		}

		@Override
		public void setValue(RateDetails14 obj, Optional<RateAndAmountFormat14Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<GrossDividendRateFormat7Choice>> mmGrossDividendRate = new MMMessageAssociationEnd<RateDetails14, List<GrossDividendRateFormat7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmGrossDividendRate);
			previousVersion_lazy = () -> RateDetails10.mmGrossDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<GrossDividendRateFormat7Choice> getValue(RateDetails14 obj) {
			return obj.getGrossDividendRate();
		}

		@Override
		public void setValue(RateDetails14 obj, List<GrossDividendRateFormat7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<InterestRateUsedForPaymentFormat5Choice>> mmInterestRateUsedForPayment = new MMMessageAssociationEnd<RateDetails14, List<InterestRateUsedForPaymentFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmInterestRateUsedForPayment);
			previousVersion_lazy = () -> RateDetails10.mmInterestRateUsedForPayment;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<InterestRateUsedForPaymentFormat5Choice> getValue(RateDetails14 obj) {
			return obj.getInterestRateUsedForPayment();
		}

		@Override
		public void setValue(RateDetails14 obj, List<InterestRateUsedForPaymentFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<RateTypeAndAmountAndStatus6>> mmTaxRelatedRate = new MMMessageAssociationEnd<RateDetails14, List<RateTypeAndAmountAndStatus6>>() {
		{
			...
			previousVersion_lazy = () -> RateDetails10.mmTaxRelatedRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateTypeAndAmountAndStatus6> getValue(RateDetails14 obj) {
			return obj.getTaxRelatedRate();
		}

		@Override
		public void setValue(RateDetails14 obj, List<RateTypeAndAmountAndStatus6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<RateFormat10Choice>> mmWithholdingTaxRate = new MMMessageAssociationEnd<RateDetails14, List<RateFormat10Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmWithholdingTaxRate);
			previousVersion_lazy = () -> RateDetails10.mmWithholdingTaxRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateFormat10Choice> getValue(RateDetails14 obj) {
			return obj.getWithholdingTaxRate();
		}

		@Override
		public void setValue(RateDetails14 obj, List<RateFormat10Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>> mmChargesFees = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmChargesFees);
			previousVersion_lazy = () -> RateDetails10.mmChargesFees;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<SolicitationFeeRateFormat5Choice>> mmEarlySolicitationFeeRate = new MMMessageAssociationEnd<RateDetails14, Optional<SolicitationFeeRateFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmEarlySolicitationFeeRate);
			previousVersion_lazy = () -> RateDetails10.mmEarlySolicitationFeeRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SolicitationFeeRateFormat5Choice> getValue(RateDetails14 obj) {
			return obj.getEarlySolicitationFeeRate();
		}

		@Override
		public void setValue(RateDetails14 obj, Optional<SolicitationFeeRateFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat15Choice>> mmFinalDividendRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat15Choice>>() {
		{
			...
			previousVersion_lazy = () -> RateDetails10.mmFinalDividendRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateAndAmountFormat15Choice> getValue(RateDetails14 obj) {
			return obj.getFinalDividendRate();
		}

		@Override
		public void setValue(RateDetails14 obj, Optional<RateAndAmountFormat15Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>> mmFiscalStamp = new MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmFiscalStamp);
			previousVersion_lazy = () -> RateDetails10.mmFiscalStamp;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat3Choice> getValue(RateDetails14 obj) {
			return obj.getFiscalStamp();
		}

		@Override
		public void setValue(RateDetails14 obj, Optional<RateFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>> mmFullyFrankedRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmFullyFrankedRate);
			previousVersion_lazy = () -> RateDetails10.mmFullyFrankedRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateFormat8Choice>> mmThirdPartyIncentiveRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateFormat8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmThirdPartyIncentiveRate);
			previousVersion_lazy = () -> RateDetails10.mmThirdPartyIncentiveRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat8Choice> getValue(RateDetails14 obj) {
			return obj.getThirdPartyIncentiveRate();
		}

		@Override
		public void setValue(RateDetails14 obj, Optional<RateFormat8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<NetDividendRateFormat9Choice>> mmNetDividendRate = new MMMessageAssociationEnd<RateDetails14, List<NetDividendRateFormat9Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmNetDividendRate);
			previousVersion_lazy = () -> RateDetails10.mmNetDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<NetDividendRateFormat9Choice> getValue(RateDetails14 obj) {
			return obj.getNetDividendRate();
		}

		@Override
		public void setValue(RateDetails14 obj, List<NetDividendRateFormat9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>> mmNonResidentRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmNonResidentRate);
			previousVersion_lazy = () -> RateDetails10.mmNonResidentRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat15Choice>> mmProvisionalDividendRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat15Choice>>() {
		{
			...
			previousVersion_lazy = () -> RateDetails10.mmProvisionalDividendRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat15Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>> mmApplicableRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmApplicableRate);
			previousVersion_lazy = () -> RateDetails10.mmApplicableRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<SolicitationFeeRateFormat5Choice>> mmSolicitationFeeRate = new MMMessageAssociationEnd<RateDetails14, Optional<SolicitationFeeRateFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmSolicitationFeeRate);
			previousVersion_lazy = () -> RateDetails10.mmSolicitationFeeRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> SolicitationFeeRateFormat5Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<TaxCreditRateFormat5Choice>> mmTaxCreditRate = new MMMessageAssociationEnd<RateDetails14, List<TaxCreditRateFormat5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmTaxCreditRate);
			previousVersion_lazy = () -> RateDetails10.mmTaxCreditRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<TaxCreditRateFormat5Choice> getValue(RateDetails14 obj) {
			return obj.getTaxCreditRate();
		}

		@Override
		public void setValue(RateDetails14 obj, List<TaxCreditRateFormat5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>> mmTaxOnIncome = new MMMessageAssociationEnd<RateDetails14, Optional<RateAndAmountFormat14Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmTaxOnIncome);
			previousVersion_lazy = () -> RateDetails10.mmTaxOnIncome;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat14Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>> mmTaxOnProfits = new MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmTaxOnProfits);
			previousVersion_lazy = () -> RateDetails10.mmTaxOnProfits;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>> mmTaxReclaimRate = new MMMessageAssociationEnd<RateDetails14, Optional<RateFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmTaxReclaimRate);
			previousVersion_lazy = () -> RateDetails10.mmTaxReclaimRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<RateAndAmountFormat20Choice>> mmWithholdingOfForeignTax = new MMMessageAssociationEnd<RateDetails14, List<RateAndAmountFormat20Choice>>() {
		{
			...
			previousVersion_lazy = () -> RateDetails10.mmWithholdingOfForeignTax;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateAndAmountFormat20Choice> getValue(RateDetails14 obj) {
			return obj.getWithholdingOfForeignTax();
		}

		@Override
		public void setValue(RateDetails14 obj, List<RateAndAmountFormat20Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateDetails14, List<RateAndAmountFormat20Choice>> mmWithholdingOfLocalTax = new MMMessageAssociationEnd<RateDetails14, List<RateAndAmountFormat20Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateDetails14.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> RateDetails10.mmWithholdingOfLocalTax;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat20Choice.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateDetails14, Optional<RateAndAmountFormat15Choice>> mmEqualisationRate = new MMMessageAttribute<RateDetails14, Optional<RateAndAmountFormat15Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateDetails22.mmEqualisationRate);
			previousVersion_lazy = () -> RateDetails10.mmEqualisationRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNetDividendRate1Rule.forRateDetails14, com.tools20022.repository.constraints.ConstraintTaxCreditRate1Rule.forRateDetails14,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule.forRateDetails14, com.tools20022.repository.constraints.ConstraintTaxRelatedRateRule.forRateDetails14,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule.forRateDetails14, com.tools20022.repository.constraints.ConstraintNetDividendRate2Rule.forRateDetails14,
						com.tools20022.repository.constraints.ConstraintTaxCreditRate2Rule.forRateDetails14);
	...
	public RateDetails14 setAdditionalTax(RateAndAmountFormat14Choice additionalTax) {
	...
	public RateDetails14 setGrossDividendRate(List<GrossDividendRateFormat7Choice> grossDividendRate) {
	...
	public RateDetails14 setInterestRateUsedForPayment(List<InterestRateUsedForPaymentFormat5Choice> interestRateUsedForPayment) {
	...
	public RateDetails14 setTaxRelatedRate(List<RateTypeAndAmountAndStatus6> taxRelatedRate) {
	...
	public RateDetails14 setWithholdingTaxRate(List<RateFormat10Choice> withholdingTaxRate) {
	...
	public RateDetails14 setChargesFees(RateAndAmountFormat14Choice chargesFees) {
	...
	public RateDetails14 setEarlySolicitationFeeRate(SolicitationFeeRateFormat5Choice earlySolicitationFeeRate) {
	...
	public RateDetails14 setFinalDividendRate(RateAndAmountFormat15Choice finalDividendRate) {
	...
	public RateDetails14 setFiscalStamp(RateFormat3Choice fiscalStamp) {
	...
	public RateDetails14 setFullyFrankedRate(RateAndAmountFormat14Choice fullyFrankedRate) {
	...
	public RateDetails14 setThirdPartyIncentiveRate(RateFormat8Choice thirdPartyIncentiveRate) {
	...
	public RateDetails14 setNetDividendRate(List<NetDividendRateFormat9Choice> netDividendRate) {
	...
	public RateDetails14 setNonResidentRate(RateAndAmountFormat14Choice nonResidentRate) {
	...
	public RateDetails14 setProvisionalDividendRate(RateAndAmountFormat15Choice provisionalDividendRate) {
	...
	public RateDetails14 setApplicableRate(RateFormat3Choice applicableRate) {
	...
	public RateDetails14 setSolicitationFeeRate(SolicitationFeeRateFormat5Choice solicitationFeeRate) {
	...
	public RateDetails14 setTaxCreditRate(List<TaxCreditRateFormat5Choice> taxCreditRate) {
	...
	public RateDetails14 setTaxOnIncome(RateAndAmountFormat14Choice taxOnIncome) {
	...
	public RateDetails14 setTaxOnProfits(RateFormat3Choice taxOnProfits) {
	...
	public RateDetails14 setTaxReclaimRate(RateFormat3Choice taxReclaimRate) {
	...
	public RateDetails14 setWithholdingOfForeignTax(List<RateAndAmountFormat20Choice> withholdingOfForeignTax) {
	...
	public RateDetails14 setWithholdingOfLocalTax(List<RateAndAmountFormat20Choice> withholdingOfLocalTax) {
	...
	public RateDetails14 setEqualisationRate(RateAndAmountFormat15Choice equalisationRate) {
