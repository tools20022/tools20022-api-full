...
public class PaymentTransaction53 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction53.mmCancellationStatusIdentification, PaymentTransaction53.mmResolvedCase, PaymentTransaction53.mmOriginalGroupInformation,
						PaymentTransaction53.mmOriginalInstructionIdentification, PaymentTransaction53.mmOriginalEndToEndIdentification, PaymentTransaction53.mmOriginalTransactionIdentification,
						PaymentTransaction53.mmOriginalClearingSystemReference, PaymentTransaction53.mmTransactionCancellationStatus, PaymentTransaction53.mmCancellationStatusReasonInformation,
						PaymentTransaction53.mmResolutionRelatedInformation, PaymentTransaction53.mmOriginalInterbankSettlementAmount, PaymentTransaction53.mmOriginalInterbankSettlementDate, PaymentTransaction53.mmAssigner,
						PaymentTransaction53.mmAssignee, PaymentTransaction53.mmOriginalTransactionReference);
