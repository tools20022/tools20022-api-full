...
public class SecuritiesSettlementTransactionDetails3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails3.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails3.mmLinkages,
						SecuritiesSettlementTransactionDetails3.mmTradeDetails, SecuritiesSettlementTransactionDetails3.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails3.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails3.mmSettlementParameters, SecuritiesSettlementTransactionDetails3.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionDetails3.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionDetails3.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails3.mmCashParties, SecuritiesSettlementTransactionDetails3.mmSettlementAmount,
						SecuritiesSettlementTransactionDetails3.mmOtherAmounts, SecuritiesSettlementTransactionDetails3.mmOtherBusinessParties, SecuritiesSettlementTransactionDetails3.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionDetails3.mmSupplementaryData);
