...
public class ModificationReason5 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ModificationReason5.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ModificationReason5.mmCode, ModificationReason5.mmAdditionalReasonInformation);
	...
	public void setCode(ModificationReason5Choice code) {
		this.code = code;
	}
