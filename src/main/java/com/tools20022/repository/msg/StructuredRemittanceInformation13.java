	...
	public static final MMMessageAssociationEnd ReferredDocumentInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.ReferredDocumentInformation;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd ReferredDocumentAmount = new MMMessageAssociationEnd() {
		{
			...
			definition = "Provides details on the amounts of the referred document.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.ReferredDocumentAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditorReferenceInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.CreditorReferenceInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Invoicer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.Invoicer;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Invoicee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.Invoicee;
			minOccurs = 0;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentification43.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd TaxRemittance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.TaxRemittance;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GarnishmentRemittance = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.GarnishmentRemittance;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalRemittanceInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.StructuredRemittanceInformation12.AdditionalRemittanceInformation;
			minOccurs = 0;
			maxOccurs = 3;
