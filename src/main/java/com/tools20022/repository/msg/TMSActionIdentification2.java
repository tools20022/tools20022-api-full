...
public class TMSActionIdentification2 {
	...
	public static final MMMessageAttribute ActionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSActionIdentification3.ActionType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DataSetIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSActionIdentification3.DataSetIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TMSActionIdentification2.ActionType, com.tools20022.repository.msg.TMSActionIdentification2.DataSetIdentification);
