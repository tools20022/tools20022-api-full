...
public class PaymentComplementaryInformation2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentComplementaryInformation2.mmInstructionIdentification, PaymentComplementaryInformation2.mmEndToEndIdentification,
						PaymentComplementaryInformation2.mmTransactionIdentification, PaymentComplementaryInformation2.mmPaymentTypeInformation, PaymentComplementaryInformation2.mmRequestedExecutionDate,
						PaymentComplementaryInformation2.mmRequestedCollectionDate, PaymentComplementaryInformation2.mmInterbankSettlementDate, PaymentComplementaryInformation2.mmAmount,
						PaymentComplementaryInformation2.mmInterbankSettlementAmount, PaymentComplementaryInformation2.mmChargeBearer, PaymentComplementaryInformation2.mmUltimateDebtor, PaymentComplementaryInformation2.mmDebtor,
						PaymentComplementaryInformation2.mmDebtorAccount, PaymentComplementaryInformation2.mmDebtorAgent, PaymentComplementaryInformation2.mmDebtorAgentAccount, PaymentComplementaryInformation2.mmSettlementInformation,
						PaymentComplementaryInformation2.mmIntermediaryAgent1, PaymentComplementaryInformation2.mmIntermediaryAgent1Account, PaymentComplementaryInformation2.mmIntermediaryAgent2,
						PaymentComplementaryInformation2.mmIntermediaryAgent2Account, PaymentComplementaryInformation2.mmIntermediaryAgent3, PaymentComplementaryInformation2.mmIntermediaryAgent3Account,
						PaymentComplementaryInformation2.mmCreditorAgent, PaymentComplementaryInformation2.mmCreditorAgentAccount, PaymentComplementaryInformation2.mmCreditor, PaymentComplementaryInformation2.mmCreditorAccount,
						PaymentComplementaryInformation2.mmUltimateCreditor, PaymentComplementaryInformation2.mmPurpose, PaymentComplementaryInformation2.mmInstructionForDebtorAgent,
						PaymentComplementaryInformation2.mmPreviousInstructingAgent, PaymentComplementaryInformation2.mmPreviousInstructingAgentAccount, PaymentComplementaryInformation2.mmInstructionForNextAgent,
						PaymentComplementaryInformation2.mmInstructionForCreditorAgent, PaymentComplementaryInformation2.mmRemittanceInformation);
	...
	public void setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation22 paymentTypeInformation) {
