...
public class AggregateBalancePerSafekeepingPlace15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalancePerSafekeepingPlace15.mmSafekeepingPlace, AggregateBalancePerSafekeepingPlace15.mmPlaceOfListing, AggregateBalancePerSafekeepingPlace15.mmAggregateBalance,
						AggregateBalancePerSafekeepingPlace15.mmAvailableBalance, AggregateBalancePerSafekeepingPlace15.mmNotAvailableBalance, AggregateBalancePerSafekeepingPlace15.mmPriceDetails,
						AggregateBalancePerSafekeepingPlace15.mmForeignExchangeDetails, AggregateBalancePerSafekeepingPlace15.mmDaysAccrued, AggregateBalancePerSafekeepingPlace15.mmAccountBaseCurrencyAmounts,
						AggregateBalancePerSafekeepingPlace15.mmInstrumentCurrencyAmounts, AggregateBalancePerSafekeepingPlace15.mmQuantityBreakdown, AggregateBalancePerSafekeepingPlace15.mmBalanceBreakdown,
						AggregateBalancePerSafekeepingPlace15.mmAdditionalBalanceBreakdown, AggregateBalancePerSafekeepingPlace15.mmHoldingAdditionalDetails);
