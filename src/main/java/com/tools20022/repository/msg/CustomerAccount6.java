 ...
 * <li>{@linkplain com.tools20022.repository.msg.CustomerAccount6#mmCurrency
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CustomerAccount6#mmClosingDate
 * CustomerAccount6.mmClosingDate}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CustomerAccount6#mmRestriction
 * CustomerAccount6.mmRestriction}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CustomerAccount6#mmOpeningDate
 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.CustomerAccount3 CustomerAccount3}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CustomerAccount6", propOrder = {"identification", "name", "status", "type", "currency", "monthlyPaymentValue", "monthlyReceivedValue", "monthlyTransactionNumber", "averageBalance", "accountPurpose",
		"floorNotificationAmount", "ceilingNotificationAmount", "statementFrequencyAndFormat", "closingDate", "restriction", "openingDate"})
public class CustomerAccount6 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CustomerAccount6
	 * CustomerAccount6}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<AccountIdentification4Choice>> mmIdentification = new MMMessageAttribute<CustomerAccount6, Optional<AccountIdentification4Choice>>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CustomerAccount6.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identification of the account.";
			previousVersion_lazy = () -> CustomerAccount3.mmIdentification;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountIdentification4Choice> getValue(CustomerAccount6 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<AccountIdentification4Choice> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CustomerAccount3#mmName
	 * CustomerAccount3.mmName}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<Max70Text>> mmName = new MMMessageAttribute<CustomerAccount6, Optional<Max70Text>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmName;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max70Text> getValue(CustomerAccount6 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<Max70Text> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CustomerAccount3#mmStatus
	 * CustomerAccount3.mmStatus}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<AccountStatus3Code>> mmStatus = new MMMessageAttribute<CustomerAccount6, Optional<AccountStatus3Code>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmStatus;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AccountStatus3Code> getValue(CustomerAccount6 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<AccountStatus3Code> value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.CustomerAccount3#mmType
	 * CustomerAccount3.mmType}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<CashAccountType2Choice>> mmType = new MMMessageAttribute<CustomerAccount6, Optional<CashAccountType2Choice>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmType;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CashAccountType2Choice> getValue(CustomerAccount6 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<CashAccountType2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, ActiveCurrencyCode> mmCurrency = new MMMessageAttribute<CustomerAccount6, ActiveCurrencyCode>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmCurrency;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyCode getValue(CustomerAccount6 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CustomerAccount6 obj, ActiveCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>> mmMonthlyPaymentValue = new MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmMonthlyPaymentValue;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ImpliedCurrencyAndAmount> getValue(CustomerAccount6 obj) {
			return obj.getMonthlyPaymentValue();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<ImpliedCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>> mmMonthlyReceivedValue = new MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmMonthlyReceivedValue;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ImpliedCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<Max5NumericText>> mmMonthlyTransactionNumber = new MMMessageAttribute<CustomerAccount6, Optional<Max5NumericText>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmMonthlyTransactionNumber;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max5NumericText> getValue(CustomerAccount6 obj) {
			return obj.getMonthlyTransactionNumber();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<Max5NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>> mmAverageBalance = new MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmAverageBalance;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ImpliedCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<Max140Text>> mmAccountPurpose = new MMMessageAttribute<CustomerAccount6, Optional<Max140Text>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmAccountPurpose;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max140Text> getValue(CustomerAccount6 obj) {
			return obj.getAccountPurpose();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>> mmFloorNotificationAmount = new MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmFloorNotificationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ImpliedCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>> mmCeilingNotificationAmount = new MMMessageAttribute<CustomerAccount6, Optional<ImpliedCurrencyAndAmount>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmCeilingNotificationAmount;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ImpliedCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, List<StatementFrequencyAndForm1>> mmStatementFrequencyAndFormat = new MMMessageAttribute<CustomerAccount6, List<StatementFrequencyAndForm1>>() {
		{
		...
		@Override
		public List<StatementFrequencyAndForm1> getValue(CustomerAccount6 obj) {
			return obj.getStatementFrequencyAndFormat();
		}

		@Override
		public void setValue(CustomerAccount6 obj, List<StatementFrequencyAndForm1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ISODate>> mmClosingDate = new MMMessageAttribute<CustomerAccount6, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmClosingDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CustomerAccount6 obj) {
			return obj.getClosingDate();
		}

		@Override
		public void setValue(CustomerAccount6 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CustomerAccount6, List<Restriction1>> mmRestriction = new MMMessageAssociationEnd<CustomerAccount6, List<Restriction1>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmRestriction;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Restriction1> getValue(CustomerAccount6 obj) {
			return obj.getRestriction();
		}

		@Override
		public void setValue(CustomerAccount6 obj, List<Restriction1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CustomerAccount6, Optional<ISODate>> mmOpeningDate = new MMMessageAttribute<CustomerAccount6, Optional<ISODate>>() {
		{
			...
			previousVersion_lazy = () -> CustomerAccount3.mmOpeningDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CustomerAccount6.mmIdentification, com.tools20022.repository.msg.CustomerAccount6.mmName, com.tools20022.repository.msg.CustomerAccount6.mmStatus,
						com.tools20022.repository.msg.CustomerAccount6.mmType, com.tools20022.repository.msg.CustomerAccount6.mmCurrency, com.tools20022.repository.msg.CustomerAccount6.mmMonthlyPaymentValue,
						com.tools20022.repository.msg.CustomerAccount6.mmMonthlyReceivedValue, com.tools20022.repository.msg.CustomerAccount6.mmMonthlyTransactionNumber, com.tools20022.repository.msg.CustomerAccount6.mmAverageBalance,
						com.tools20022.repository.msg.CustomerAccount6.mmAccountPurpose, com.tools20022.repository.msg.CustomerAccount6.mmFloorNotificationAmount, com.tools20022.repository.msg.CustomerAccount6.mmCeilingNotificationAmount,
						com.tools20022.repository.msg.CustomerAccount6.mmStatementFrequencyAndFormat, com.tools20022.repository.msg.CustomerAccount6.mmClosingDate, com.tools20022.repository.msg.CustomerAccount6.mmRestriction,
						com.tools20022.repository.msg.CustomerAccount6.mmOpeningDate);
				trace_lazy = () -> CashAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CustomerAccount6";
				definition = "Account owned by a customer.";
				previousVersion_lazy = () -> CustomerAccount3.mmObject();
			}
		});
	...
	public CustomerAccount6 setIdentification(AccountIdentification4Choice identification) {
	...
	public CustomerAccount6 setName(Max70Text name) {
		this.name = name;
		return this;
	}
	...
	public CustomerAccount6 setStatus(AccountStatus3Code status) {
		this.status = status;
		return this;
	}
	...
	public CustomerAccount6 setType(CashAccountType2Choice type) {
		this.type = type;
		return this;
	}
	...
	public CustomerAccount6 setCurrency(ActiveCurrencyCode currency) {
	...
	public CustomerAccount6 setMonthlyPaymentValue(ImpliedCurrencyAndAmount monthlyPaymentValue) {
	...
	public CustomerAccount6 setMonthlyReceivedValue(ImpliedCurrencyAndAmount monthlyReceivedValue) {
	...
	public CustomerAccount6 setMonthlyTransactionNumber(Max5NumericText monthlyTransactionNumber) {
	...
	public CustomerAccount6 setAverageBalance(ImpliedCurrencyAndAmount averageBalance) {
	...
	public CustomerAccount6 setAccountPurpose(Max140Text accountPurpose) {
	...
	public CustomerAccount6 setFloorNotificationAmount(ImpliedCurrencyAndAmount floorNotificationAmount) {
	...
	public CustomerAccount6 setCeilingNotificationAmount(ImpliedCurrencyAndAmount ceilingNotificationAmount) {
	...
	public CustomerAccount6 setStatementFrequencyAndFormat(List<StatementFrequencyAndForm1> statementFrequencyAndFormat) {
	...
	public CustomerAccount6 setClosingDate(ISODate closingDate) {
	...
	public CustomerAccount6 setRestriction(List<Restriction1> restriction) {
	...
	public CustomerAccount6 setOpeningDate(ISODate openingDate) {
