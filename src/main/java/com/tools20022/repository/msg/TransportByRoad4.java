...
public class TransportByRoad4 {
	...
	public static final MMMessageAttribute PlaceOfReceipt = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransportByRoad2.PlaceOfReceipt;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.PlaceOfReceipt);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PlaceOfDelivery = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransportByRoad2.PlaceOfDelivery;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.PlaceOfDelivery);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute RoadCarrierName = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.TransportByRoad2.RoadCarrierName;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.RoadCarrierName);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RoadCarrierCountry = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.RoadCarrierCountry);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CarrierAgentName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.CarrierAgentName);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max70Text.mmObject();
		}
	...
	public static final MMMessageAttribute CarrierAgentCountry = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad5.CarrierAgentCountry);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> CountryCode.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransportByRoad4.PlaceOfReceipt, com.tools20022.repository.msg.TransportByRoad4.PlaceOfDelivery,
						com.tools20022.repository.msg.TransportByRoad4.RoadCarrierName, com.tools20022.repository.msg.TransportByRoad4.RoadCarrierCountry, com.tools20022.repository.msg.TransportByRoad4.CarrierAgentName,
						com.tools20022.repository.msg.TransportByRoad4.CarrierAgentCountry);
