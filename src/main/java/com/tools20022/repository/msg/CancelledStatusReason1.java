...
@XmlType(name = "CancelledStatusReason1", propOrder = "additionalInformation")
public class CancelledStatusReason1 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CancelledStatusReason1
	 * CancelledStatusReason1}</li>
	...
	public static final MMMessageAttribute<CancelledStatusReason1, Max350Text> mmAdditionalInformation = new MMMessageAttribute<CancelledStatusReason1, Max350Text>() {
		{
			...
			definition = "Reason for a cancelled status in free format text.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CancelledStatusReason1.mmAdditionalInformation);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancelledStatusReason1";
	...
	public CancelledStatusReason1 setAdditionalInformation(Max350Text additionalInformation) {
