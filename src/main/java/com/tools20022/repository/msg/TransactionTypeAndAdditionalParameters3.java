 ...
 * TransactionTypeAndAdditionalParameters3.mmSecuritiesFinancingTransactionType}
 * </li>
 * <li>
 ...
 * TransactionTypeAndAdditionalParameters3.mmCorporateActionEventIdentification}
 * </li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forTransactionTypeAndAdditionalParameters3
...
@XmlType(name = "TransactionTypeAndAdditionalParameters3", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "securitiesFinancingTransactionType", "securitiesMovementType", "payment",
...
public class TransactionTypeAndAdditionalParameters3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(TransactionTypeAndAdditionalParameters3 obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters3 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>> mmAccountServicerTransactionIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		@Override
		public Optional<Max35Text> getValue(TransactionTypeAndAdditionalParameters3 obj) {
			return obj.getAccountServicerTransactionIdentification();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters3 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, SecuritiesFinancingTransactionType1Code> mmSecuritiesFinancingTransactionType = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, SecuritiesFinancingTransactionType1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmSecuritiesFinancingTransactionType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesFinancingTransactionType1Code getValue(TransactionTypeAndAdditionalParameters3 obj) {
			return obj.getSecuritiesFinancingTransactionType();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters3 obj, SecuritiesFinancingTransactionType1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, ReceiveDelivery1Code> mmSecuritiesMovementType = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, ReceiveDelivery1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmSecuritiesMovementType);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ReceiveDelivery1Code getValue(TransactionTypeAndAdditionalParameters3 obj) {
			return obj.getSecuritiesMovementType();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters3 obj, ReceiveDelivery1Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, DeliveryReceiptType2Code> mmPayment = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, DeliveryReceiptType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmPayment);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeliveryReceiptType2Code getValue(TransactionTypeAndAdditionalParameters3 obj) {
			return obj.getPayment();
		}

		@Override
		public void setValue(TransactionTypeAndAdditionalParameters3 obj, DeliveryReceiptType2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>> mmCommonIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmCommonIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>> mmPoolIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>> mmCorporateActionEventIdentification = new MMMessageAttribute<TransactionTypeAndAdditionalParameters3, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmAccountOwnerTransactionIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmSecuritiesFinancingTransactionType, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmSecuritiesMovementType,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmPayment, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmCommonIdentification,
						com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmPoolIdentification, com.tools20022.repository.msg.TransactionTypeAndAdditionalParameters3.mmCorporateActionEventIdentification);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingConfirmationV01.mmTransactionIdentificationDetails, SecuritiesFinancingConfirmationV02.mmTransactionIdentificationDetails,
						SecuritiesFinancingConfirmationV03.mmTransactionIdentificationDetails, SecuritiesFinancingConfirmationV04.mmTransactionIdentificationDetails, SecuritiesFinancingConfirmationV05.mmTransactionIdentificationDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forTransactionTypeAndAdditionalParameters3,
						com.tools20022.repository.constraints.ConstraintTwoLegTransactionOpeningClosingRule.forTransactionTypeAndAdditionalParameters3);
				...
				name = "TransactionTypeAndAdditionalParameters3";
				definition = "Specifies the conditions under which the order/trade is to be settled.";
				nextVersions_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters10.mmObject());
			}
		});
	...
	public TransactionTypeAndAdditionalParameters3 setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public TransactionTypeAndAdditionalParameters3 setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public TransactionTypeAndAdditionalParameters3 setSecuritiesFinancingTransactionType(SecuritiesFinancingTransactionType1Code securitiesFinancingTransactionType) {
	...
	public TransactionTypeAndAdditionalParameters3 setSecuritiesMovementType(ReceiveDelivery1Code securitiesMovementType) {
	...
	public TransactionTypeAndAdditionalParameters3 setPayment(DeliveryReceiptType2Code payment) {
	...
	public TransactionTypeAndAdditionalParameters3 setCommonIdentification(Max35Text commonIdentification) {
	...
	public TransactionTypeAndAdditionalParameters3 setPoolIdentification(Max35Text poolIdentification) {
	...
	public TransactionTypeAndAdditionalParameters3 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
