...
public class TransactionTypeAndAdditionalParameters3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters3.mmAccountOwnerTransactionIdentification, TransactionTypeAndAdditionalParameters3.mmAccountServicerTransactionIdentification,
						TransactionTypeAndAdditionalParameters3.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters3.mmSecuritiesMovementType, TransactionTypeAndAdditionalParameters3.mmPayment,
						TransactionTypeAndAdditionalParameters3.mmCommonIdentification, TransactionTypeAndAdditionalParameters3.mmPoolIdentification, TransactionTypeAndAdditionalParameters3.mmCorporateActionEventIdentification);
