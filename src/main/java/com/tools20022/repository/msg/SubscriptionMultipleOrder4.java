 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubscriptionMultipleOrder4#mmCancellationRightOrExtendedCancellationRightRule
 * SubscriptionMultipleOrder4.mmCancellationRightOrExtendedCancellationRightRule
 * }</li>
 * </ul>
 * </li>
 * <li>
...
public class SubscriptionMultipleOrder4 {
	...
	public static final MMMessageAttribute mmMasterReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmMasterReference);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPlaceOfTrade = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmPlaceOfTrade);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOrderDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmOrderDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmExpiryDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmExpiryDateTime);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmRequestedFutureTradeDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmRequestedFutureTradeDate);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmCancellationRight = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmCancellationRight);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmInvestmentAccountDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmInvestmentAccountDetails);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmBeneficiaryDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmBeneficiaryDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	protected List<com.tools20022.repository.msg.SubscriptionOrder8> individualOrderDetails;
	/**
	 * Order to invest the investor's principal in an investment fund.
	 * <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd mmIndividualOrderDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmIndividualOrderDetails);
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SubscriptionOrder8.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmTotalSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmTotalSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmBulkCashSettlementDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder6.mmBulkCashSettlementDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.SubscriptionOrderV03.mmMultipleOrderDetails);
				...
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubscriptionMultipleOrder4.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
	...
	public void setIndividualOrderDetails(List<com.tools20022.repository.msg.SubscriptionOrder8> individualOrderDetails) {
