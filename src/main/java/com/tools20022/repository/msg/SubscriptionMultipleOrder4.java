...
public class SubscriptionMultipleOrder4 {
	...
	public static final MMXor mmCancellationRightOrExtendedCancellationRightRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(SubscriptionMultipleOrder4.mmCancellationRight, SubscriptionMultipleOrder4.mmExtendedCancellationRight);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubscriptionMultipleOrder4.mmMasterReference, SubscriptionMultipleOrder4.mmPlaceOfTrade, SubscriptionMultipleOrder4.mmOrderDateTime, SubscriptionMultipleOrder4.mmExpiryDateTime,
						SubscriptionMultipleOrder4.mmRequestedFutureTradeDate, SubscriptionMultipleOrder4.mmCancellationRight, SubscriptionMultipleOrder4.mmExtendedCancellationRight, SubscriptionMultipleOrder4.mmInvestmentAccountDetails,
						SubscriptionMultipleOrder4.mmBeneficiaryDetails, SubscriptionMultipleOrder4.mmIndividualOrderDetails, SubscriptionMultipleOrder4.mmTotalSettlementAmount, SubscriptionMultipleOrder4.mmCashSettlementDate,
						SubscriptionMultipleOrder4.mmBulkCashSettlementDetails);
				...
				xors_lazy = () -> Arrays.asList(SubscriptionMultipleOrder4.mmCancellationRightOrExtendedCancellationRightRule);
			}
		});
