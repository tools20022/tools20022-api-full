...
public class SettlementDetails26 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementTransactionReversalAdviceV02.mmSettlementParameters);
	...
	public ExposureType5Choice getExposureType() {
		return exposureType;
	}

	public void setExposureType(ExposureType5Choice exposureType) {
