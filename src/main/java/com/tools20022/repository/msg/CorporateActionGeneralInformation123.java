...
public class CorporateActionGeneralInformation123 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation123.mmCorporateActionEventIdentification, CorporateActionGeneralInformation123.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation123.mmClassActionNumber, CorporateActionGeneralInformation123.mmEventType, CorporateActionGeneralInformation123.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation123.mmFinancialInstrumentIdentification);
