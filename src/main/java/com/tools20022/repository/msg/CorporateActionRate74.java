...
public class CorporateActionRate74 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate74.mmGrossDividendRate, CorporateActionRate74.mmNetDividendRate, CorporateActionRate74.mmIndexFactor, CorporateActionRate74.mmInterestRateUsedForPayment,
						CorporateActionRate74.mmMaximumAllowedOversubscriptionRate, CorporateActionRate74.mmProrationRate, CorporateActionRate74.mmWithholdingTaxRate, CorporateActionRate74.mmSecondLevelTax,
						CorporateActionRate74.mmAdditionalTax, CorporateActionRate74.mmTaxableIncomePerDividendShare);
