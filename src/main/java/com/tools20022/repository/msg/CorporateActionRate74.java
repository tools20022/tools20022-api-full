 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule#forCorporateActionRate74
 * ConstraintGrossDividendRate2Rule.forCorporateActionRate74}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule#forCorporateActionRate74
 * ConstraintGrossDividendRate3Rule.forCorporateActionRate74}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNettDividendRate1Rule#forCorporateActionRate74
 * ConstraintNettDividendRate1Rule.forCorporateActionRate74}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNettDividendRate2Rule#forCorporateActionRate74
 * ConstraintNettDividendRate2Rule.forCorporateActionRate74}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSecondLevelTax1Rule#forCorporateActionRate74
 * ConstraintSecondLevelTax1Rule.forCorporateActionRate74}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionRate74", propOrder = {"grossDividendRate", "netDividendRate", "indexFactor", "interestRateUsedForPayment", "maximumAllowedOversubscriptionRate", "prorationRate", "withholdingTaxRate", "secondLevelTax",
		"additionalTax", "taxableIncomePerDividendShare"})
public class CorporateActionRate74 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "GrssDvddRate")
	protected List<GrossDividendRateFormat23Choice> grossDividendRate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, List<GrossDividendRateFormat23Choice>> mmGrossDividendRate = new MMMessageAssociationEnd<CorporateActionRate74, List<GrossDividendRateFormat23Choice>>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmGrossDividend;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate74.mmObject();
			isDerived = false;
			xmlTag = "GrssDvddRate";
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> GrossDividendRateFormat23Choice.mmObject();
		}

		@Override
		public List<GrossDividendRateFormat23Choice> getValue(CorporateActionRate74 obj) {
			return obj.getGrossDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, List<GrossDividendRateFormat23Choice> value) {
			obj.setGrossDividendRate(value);
		}
	};
	@XmlElement(name = "NetDvddRate")
	protected List<NetDividendRateFormat25Choice> netDividendRate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, List<NetDividendRateFormat25Choice>> mmNetDividendRate = new MMMessageAssociationEnd<CorporateActionRate74, List<NetDividendRateFormat25Choice>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> NetDividendRateFormat25Choice.mmObject();
		}

		@Override
		public List<NetDividendRateFormat25Choice> getValue(CorporateActionRate74 obj) {
			return obj.getNetDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, List<NetDividendRateFormat25Choice> value) {
			obj.setNetDividendRate(value);
		}
	};
	@XmlElement(name = "IndxFctr")
	protected RateAndAmountFormat43Choice indexFactor;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, Optional<RateAndAmountFormat43Choice>> mmIndexFactor = new MMMessageAssociationEnd<CorporateActionRate74, Optional<RateAndAmountFormat43Choice>>() {
		{
		...
		@Override
		public Optional<RateAndAmountFormat43Choice> getValue(CorporateActionRate74 obj) {
			return obj.getIndexFactor();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, Optional<RateAndAmountFormat43Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, List<InterestRateUsedForPaymentFormat9Choice>> mmInterestRateUsedForPayment = new MMMessageAssociationEnd<CorporateActionRate74, List<InterestRateUsedForPaymentFormat9Choice>>() {
		{
		...
		@Override
		public List<InterestRateUsedForPaymentFormat9Choice> getValue(CorporateActionRate74 obj) {
			return obj.getInterestRateUsedForPayment();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, List<InterestRateUsedForPaymentFormat9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate74, Optional<PercentageRate>> mmMaximumAllowedOversubscriptionRate = new MMMessageAttribute<CorporateActionRate74, Optional<PercentageRate>>() {
		{
		...
		@Override
		public Optional<PercentageRate> getValue(CorporateActionRate74 obj) {
			return obj.getMaximumAllowedOversubscriptionRate();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate74, Optional<PercentageRate>> mmProrationRate = new MMMessageAttribute<CorporateActionRate74, Optional<PercentageRate>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionRate74, List<RateAndAmountFormat45Choice>> mmWithholdingTaxRate = new MMMessageAttribute<CorporateActionRate74, List<RateAndAmountFormat45Choice>>() {
		{
		...
		@Override
		public List<RateAndAmountFormat45Choice> getValue(CorporateActionRate74 obj) {
			return obj.getWithholdingTaxRate();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, List<RateAndAmountFormat45Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, List<RateAndAmountFormat45Choice>> mmSecondLevelTax = new MMMessageAssociationEnd<CorporateActionRate74, List<RateAndAmountFormat45Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate74.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, Optional<RateAndAmountFormat43Choice>> mmAdditionalTax = new MMMessageAssociationEnd<CorporateActionRate74, Optional<RateAndAmountFormat43Choice>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate74, List<RateTypeAndAmountAndStatus33>> mmTaxableIncomePerDividendShare = new MMMessageAssociationEnd<CorporateActionRate74, List<RateTypeAndAmountAndStatus33>>() {
		{
		...
		@Override
		public List<RateTypeAndAmountAndStatus33> getValue(CorporateActionRate74 obj) {
			return obj.getTaxableIncomePerDividendShare();
		}

		@Override
		public void setValue(CorporateActionRate74 obj, List<RateTypeAndAmountAndStatus33> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate74.mmGrossDividendRate, com.tools20022.repository.msg.CorporateActionRate74.mmNetDividendRate,
						com.tools20022.repository.msg.CorporateActionRate74.mmIndexFactor, com.tools20022.repository.msg.CorporateActionRate74.mmInterestRateUsedForPayment,
						com.tools20022.repository.msg.CorporateActionRate74.mmMaximumAllowedOversubscriptionRate, com.tools20022.repository.msg.CorporateActionRate74.mmProrationRate,
						com.tools20022.repository.msg.CorporateActionRate74.mmWithholdingTaxRate, com.tools20022.repository.msg.CorporateActionRate74.mmSecondLevelTax, com.tools20022.repository.msg.CorporateActionRate74.mmAdditionalTax,
						com.tools20022.repository.msg.CorporateActionRate74.mmTaxableIncomePerDividendShare);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule.forCorporateActionRate74,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule.forCorporateActionRate74, com.tools20022.repository.constraints.ConstraintNettDividendRate1Rule.forCorporateActionRate74,
						com.tools20022.repository.constraints.ConstraintNettDividendRate2Rule.forCorporateActionRate74, com.tools20022.repository.constraints.ConstraintSecondLevelTax1Rule.forCorporateActionRate74);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionRate74";
	...
	public List<GrossDividendRateFormat23Choice> getGrossDividendRate() {
		return grossDividendRate == null ? grossDividendRate = new ArrayList<>() : grossDividendRate;
	}

	public CorporateActionRate74 setGrossDividendRate(List<GrossDividendRateFormat23Choice> grossDividendRate) {
		this.grossDividendRate = Objects.requireNonNull(grossDividendRate);
		return this;
	}

	public List<NetDividendRateFormat25Choice> getNetDividendRate() {
		return netDividendRate == null ? netDividendRate = new ArrayList<>() : netDividendRate;
	}

	public CorporateActionRate74 setNetDividendRate(List<NetDividendRateFormat25Choice> netDividendRate) {
		this.netDividendRate = Objects.requireNonNull(netDividendRate);
		return this;
	}

	public Optional<RateAndAmountFormat43Choice> getIndexFactor() {
		return indexFactor == null ? Optional.empty() : Optional.of(indexFactor);
	}

	public CorporateActionRate74 setIndexFactor(RateAndAmountFormat43Choice indexFactor) {
	...
	public CorporateActionRate74 setInterestRateUsedForPayment(List<InterestRateUsedForPaymentFormat9Choice> interestRateUsedForPayment) {
	...
	public CorporateActionRate74 setMaximumAllowedOversubscriptionRate(PercentageRate maximumAllowedOversubscriptionRate) {
	...
	public CorporateActionRate74 setProrationRate(PercentageRate prorationRate) {
	...
	public CorporateActionRate74 setWithholdingTaxRate(List<RateAndAmountFormat45Choice> withholdingTaxRate) {
	...
	public CorporateActionRate74 setSecondLevelTax(List<RateAndAmountFormat45Choice> secondLevelTax) {
	...
	public CorporateActionRate74 setAdditionalTax(RateAndAmountFormat43Choice additionalTax) {
	...
	public CorporateActionRate74 setTaxableIncomePerDividendShare(List<RateTypeAndAmountAndStatus33> taxableIncomePerDividendShare) {
