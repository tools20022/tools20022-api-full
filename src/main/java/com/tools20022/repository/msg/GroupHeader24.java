...
public class GroupHeader24 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader24.mmMessageIdentification, GroupHeader24.mmCreationDateTime, GroupHeader24.mmNumberOfTransactions, GroupHeader24.mmTotalInterbankSettlementAmount,
						GroupHeader24.mmInterbankSettlementDate, GroupHeader24.mmSettlementInformation, GroupHeader24.mmPaymentTypeInformation, GroupHeader24.mmInstructingAgent, GroupHeader24.mmInstructedAgent);
