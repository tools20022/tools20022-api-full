...
import com.tools20022.repository.msg.PaymentContext16;
...
@XmlType(name = "CardPaymentContext16", propOrder = {"paymentContext", "saleContext"})
public class CardPaymentContext16 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "PmtCntxt", required = true)
	protected PaymentContext16 paymentContext;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.PaymentContext16
	 * PaymentContext16}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext16, PaymentContext16> mmPaymentContext = new MMMessageAssociationEnd<CardPaymentContext16, PaymentContext16>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext16.mmObject();
			isDerived = false;
			xmlTag = "PmtCntxt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PaymentContext";
			definition = "Context of the card payment transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext22.mmPaymentContext);
			previousVersion_lazy = () -> CardPaymentContext10.mmPaymentContext;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PaymentContext16.mmObject();
		}

		@Override
		public PaymentContext16 getValue(CardPaymentContext16 obj) {
			return obj.getPaymentContext();
		}

		@Override
		public void setValue(CardPaymentContext16 obj, PaymentContext16 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentContext16, Optional<SaleContext2>> mmSaleContext = new MMMessageAssociationEnd<CardPaymentContext16, Optional<SaleContext2>>() {
		{
			businessComponentTrace_lazy = () -> CardPaymentAcquiring.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentContext16.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentContext22.mmSaleContext);
			previousVersion_lazy = () -> CardPaymentContext10.mmSaleContext;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SaleContext2> getValue(CardPaymentContext16 obj) {
			return obj.getSaleContext();
		}

		@Override
		public void setValue(CardPaymentContext16 obj, Optional<SaleContext2> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CardPaymentContext16.mmPaymentContext, com.tools20022.repository.msg.CardPaymentContext16.mmSaleContext);
				trace_lazy = () -> CardPaymentAcquiring.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CardPaymentContext16";
				definition = "Context in which the transaction is performed (payment and sale).";
				nextVersions_lazy = () -> Arrays.asList(CardPaymentContext22.mmObject());
				previousVersion_lazy = () -> CardPaymentContext10.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public PaymentContext16 getPaymentContext() {
		return paymentContext;
	}

	public CardPaymentContext16 setPaymentContext(PaymentContext16 paymentContext) {
	...
	public CardPaymentContext16 setSaleContext(SaleContext2 saleContext) {
