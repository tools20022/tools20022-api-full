...
public class PriceInformation14 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceInformation14.mmType, PriceInformation14.mmValue, PriceInformation14.mmValueType, PriceInformation14.mmSourceOfPrice, PriceInformation14.mmQuotationDate);
