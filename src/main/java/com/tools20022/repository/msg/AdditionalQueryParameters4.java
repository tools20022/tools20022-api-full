...
public class AdditionalQueryParameters4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AdditionalQueryParameters4, Optional<Status10Choice>> mmStatus = new MMMessageAssociationEnd<AdditionalQueryParameters4, Optional<Status10Choice>>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatus.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.AdditionalQueryParameters4.mmObject();
			isDerived = false;
			xmlTag = "Sts";
		...
		@Override
		public Optional<Status10Choice> getValue(AdditionalQueryParameters4 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(AdditionalQueryParameters4 obj, Optional<Status10Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AdditionalQueryParameters4, List<Reason10Choice>> mmReason = new MMMessageAssociationEnd<AdditionalQueryParameters4, List<Reason10Choice>>() {
		{
		...
		@Override
		public List<Reason10Choice> getValue(AdditionalQueryParameters4 obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(AdditionalQueryParameters4 obj, List<Reason10Choice> value) {
			obj.setReason(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AdditionalQueryParameters4, List<SecurityIdentification15>> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<AdditionalQueryParameters4, List<SecurityIdentification15>>() {
		{
		...
		@Override
		public List<SecurityIdentification15> getValue(AdditionalQueryParameters4 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(AdditionalQueryParameters4 obj, List<SecurityIdentification15> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalQueryParameters4.mmStatus, com.tools20022.repository.msg.AdditionalQueryParameters4.mmReason,
						com.tools20022.repository.msg.AdditionalQueryParameters4.mmFinancialInstrumentIdentification);
	...
	public AdditionalQueryParameters4 setStatus(Status10Choice status) {
		this.status = status;
		return this;
	}
	...
	public AdditionalQueryParameters4 setReason(List<Reason10Choice> reason) {
	...
	public AdditionalQueryParameters4 setFinancialInstrumentIdentification(List<SecurityIdentification15> financialInstrumentIdentification) {
