...
public class DeniedReason6 {
	...
	public static final MMMessageAssociationEnd Code = new MMMessageAssociationEnd() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason17.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason17.AdditionalReasonInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason6.Code, com.tools20022.repository.msg.DeniedReason6.AdditionalReasonInformation);
