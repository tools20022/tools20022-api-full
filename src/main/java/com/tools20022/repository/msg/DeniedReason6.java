...
import com.tools20022.repository.choice.DeniedReason9Choice;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DeniedReason17 DeniedReason17}</li>
 * </ul>
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "DeniedReason6", propOrder = {"code", "additionalReasonInformation"})
public class DeniedReason6 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected DeniedReason9Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.choice.DeniedReason9Choice
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.DeniedReason6 DeniedReason6}</li>
	...
	public static final MMMessageAssociationEnd<DeniedReason6, DeniedReason9Choice> mmCode = new MMMessageAssociationEnd<DeniedReason6, DeniedReason9Choice>() {
		{
			...
			name = "Code";
			definition = "Specifies the reason why the request has a denied status.";
			nextVersions_lazy = () -> Arrays.asList(DeniedReason17.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<DeniedReason6, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<DeniedReason6, Optional<RestrictedFINXMax210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeniedReason17.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeniedReason6.mmCode, com.tools20022.repository.msg.DeniedReason6.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "DeniedReason6";
				definition = "The status of an instruction, advice or request.";
				nextVersions_lazy = () -> Arrays.asList(DeniedReason17.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public DeniedReason9Choice getCode() {
		return code;
	}

	public DeniedReason6 setCode(DeniedReason9Choice code) {
	...
	public DeniedReason6 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
