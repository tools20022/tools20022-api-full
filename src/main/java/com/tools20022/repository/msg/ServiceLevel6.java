...
public class ServiceLevel6 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ServiceLevel6 ServiceLevel6}</li>
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ServiceLevel6.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ServiceLevel6.Code);
