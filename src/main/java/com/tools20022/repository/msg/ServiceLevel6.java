...
@XmlType(name = "ServiceLevel6", propOrder = "code")
public class ServiceLevel6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ServiceLevel6.mmCode);
	...
	public ServiceLevel6 setCode(ServiceLevel3Code code) {
