...
import com.tools20022.repository.msg.AggregateBalanceInformation25;
 ...
 * ConstraintActivityAndBalanceForSubAccount1Rule.forSubAccountIdentification37}
 * </li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintActivityAndBalanceForSubAccount2Rule#forSubAccountIdentification37
 * ConstraintActivityAndBalanceForSubAccount2Rule.forSubAccountIdentification37}
 * </li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "SubAccountIdentification37", propOrder = {"accountOwner", "safekeepingAccount", "activityIndicator", "balanceForSubAccount"})
public class SubAccountIdentification37 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification37, Optional<PartyIdentification36Choice>> mmAccountOwner = new MMMessageAssociationEnd<SubAccountIdentification37, Optional<PartyIdentification36Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
		...
		@Override
		public Optional<PartyIdentification36Choice> getValue(SubAccountIdentification37 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(SubAccountIdentification37 obj, Optional<PartyIdentification36Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification37, SecuritiesAccount14> mmSafekeepingAccount = new MMMessageAssociationEnd<SubAccountIdentification37, SecuritiesAccount14>() {
		{
		...
		@Override
		public SecuritiesAccount14 getValue(SubAccountIdentification37 obj) {
			return obj.getSafekeepingAccount();
		}

		@Override
		public void setValue(SubAccountIdentification37 obj, SecuritiesAccount14 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SubAccountIdentification37, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<SubAccountIdentification37, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.SubAccountIdentification37.mmObject();
			isDerived = false;
			xmlTag = "ActvtyInd";
		...
		@Override
		public YesNoIndicator getValue(SubAccountIdentification37 obj) {
			return obj.getActivityIndicator();
		}

		@Override
		public void setValue(SubAccountIdentification37 obj, YesNoIndicator value) {
			obj.setActivityIndicator(value);
		}
	};
	@XmlElement(name = "BalForSubAcct")
	protected List<AggregateBalanceInformation25> balanceForSubAccount;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SubAccountIdentification37, List<AggregateBalanceInformation25>> mmBalanceForSubAccount = new MMMessageAssociationEnd<SubAccountIdentification37, List<AggregateBalanceInformation25>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> AggregateBalanceInformation25.mmObject();
		}

		@Override
		public List<AggregateBalanceInformation25> getValue(SubAccountIdentification37 obj) {
			return obj.getBalanceForSubAccount();
		}

		@Override
		public void setValue(SubAccountIdentification37 obj, List<AggregateBalanceInformation25> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSubSafekeepingReportingRule.forSubAccountIdentification37,
						com.tools20022.repository.constraints.ConstraintActivityAndBalanceForSubAccount1Rule.forSubAccountIdentification37,
						com.tools20022.repository.constraints.ConstraintActivityAndBalanceForSubAccount2Rule.forSubAccountIdentification37);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SubAccountIdentification37";
				definition = "Account to or from which a securities entry is made.";
				nextVersions_lazy = () -> Arrays.asList(SubAccountIdentification42.mmObject());
				previousVersion_lazy = () -> SubAccountIdentification28.mmObject();
			}
		});
	...
	public SubAccountIdentification37 setAccountOwner(PartyIdentification36Choice accountOwner) {
	...
	public SubAccountIdentification37 setSafekeepingAccount(SecuritiesAccount14 safekeepingAccount) {
	...
	public SubAccountIdentification37 setActivityIndicator(YesNoIndicator activityIndicator) {
		this.activityIndicator = Objects.requireNonNull(activityIndicator);
		return this;
	}

	public List<AggregateBalanceInformation25> getBalanceForSubAccount() {
		return balanceForSubAccount == null ? balanceForSubAccount = new ArrayList<>() : balanceForSubAccount;
	}

	public SubAccountIdentification37 setBalanceForSubAccount(List<AggregateBalanceInformation25> balanceForSubAccount) {
