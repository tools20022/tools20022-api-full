...
@XmlType(name = "ReportEntry7", propOrder = {"entryReference", "amount", "creditDebitIndicator", "reversalIndicator", "status", "bookingDate", "valueDate", "accountServicerReference", "availability", "bankTransactionCode",
...
public class ReportEntry7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, Optional<Max35Text>> mmEntryReference = new MMMessageAttribute<ReportEntry7, Optional<Max35Text>>() {
		{
			businessElementTrace_lazy = () -> Entry.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReportEntry7.mmObject();
			isDerived = false;
			xmlTag = "NtryRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "EntryReference";
			definition = "Unique reference for the entry.";
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmEntryReference);
			previousVersion_lazy = () -> ReportEntry4.mmEntryReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ReportEntry7 obj) {
			return obj.getEntryReference();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, ActiveOrHistoricCurrencyAndAmount> mmAmount = new MMMessageAttribute<ReportEntry7, ActiveOrHistoricCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAmount);
			previousVersion_lazy = () -> ReportEntry4.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveOrHistoricCurrencyAndAmount getValue(ReportEntry7 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(ReportEntry7 obj, ActiveOrHistoricCurrencyAndAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<ReportEntry7, CreditDebitCode>() {
		{
			...
			definition = "Indicates whether the entry is a credit or a debit entry.";
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmCreditDebitIndicator);
			previousVersion_lazy = () -> ReportEntry4.mmCreditDebitIndicator;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CreditDebitCode getValue(ReportEntry7 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(ReportEntry7 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, Optional<TrueFalseIndicator>> mmReversalIndicator = new MMMessageAttribute<ReportEntry7, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmReversalIndicator);
			previousVersion_lazy = () -> ReportEntry4.mmReversalIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(ReportEntry7 obj) {
			return obj.getReversalIndicator();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, EntryStatus2Code> mmStatus = new MMMessageAttribute<ReportEntry7, EntryStatus2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmStatus);
			previousVersion_lazy = () -> ReportEntry4.mmStatus;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public EntryStatus2Code getValue(ReportEntry7 obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(ReportEntry7 obj, EntryStatus2Code value) {
			obj.setStatus(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<DateAndDateTimeChoice>> mmBookingDate = new MMMessageAssociationEnd<ReportEntry7, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmBookingDate);
			previousVersion_lazy = () -> ReportEntry4.mmBookingDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(ReportEntry7 obj) {
			return obj.getBookingDate();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<DateAndDateTimeChoice>> mmValueDate = new MMMessageAssociationEnd<ReportEntry7, Optional<DateAndDateTimeChoice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmValueDate);
			previousVersion_lazy = () -> ReportEntry4.mmValueDate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> DateAndDateTimeChoice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, Optional<Max35Text>> mmAccountServicerReference = new MMMessageAttribute<ReportEntry7, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAccountServicerReference);
			previousVersion_lazy = () -> ReportEntry4.mmAccountServicerReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, List<CashBalanceAvailability2>> mmAvailability = new MMMessageAssociationEnd<ReportEntry7, List<CashBalanceAvailability2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAvailability);
			previousVersion_lazy = () -> ReportEntry4.mmAvailability;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<CashBalanceAvailability2> getValue(ReportEntry7 obj) {
			return obj.getAvailability();
		}

		@Override
		public void setValue(ReportEntry7 obj, List<CashBalanceAvailability2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, BankTransactionCodeStructure4> mmBankTransactionCode = new MMMessageAssociationEnd<ReportEntry7, BankTransactionCodeStructure4>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmBankTransactionCode);
			previousVersion_lazy = () -> ReportEntry4.mmBankTransactionCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public BankTransactionCodeStructure4 getValue(ReportEntry7 obj) {
			return obj.getBankTransactionCode();
		}

		@Override
		public void setValue(ReportEntry7 obj, BankTransactionCodeStructure4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, Optional<YesNoIndicator>> mmCommissionWaiverIndicator = new MMMessageAttribute<ReportEntry7, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmCommissionWaiverIndicator);
			previousVersion_lazy = () -> ReportEntry4.mmCommissionWaiverIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(ReportEntry7 obj) {
			return obj.getCommissionWaiverIndicator();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<MessageIdentification2>> mmAdditionalInformationIndicator = new MMMessageAssociationEnd<ReportEntry7, Optional<MessageIdentification2>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ReportEntry7.mmObject();
			isDerived = false;
			xmlTag = "AddtlInfInd";
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAdditionalInformationIndicator);
			previousVersion_lazy = () -> ReportEntry4.mmAdditionalInformationIndicator;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MessageIdentification2> getValue(ReportEntry7 obj) {
			return obj.getAdditionalInformationIndicator();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<MessageIdentification2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<AmountAndCurrencyExchange3>> mmAmountDetails = new MMMessageAssociationEnd<ReportEntry7, Optional<AmountAndCurrencyExchange3>>() {
		{
			businessElementTrace_lazy = () -> CashEntry.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.ReportEntry7.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAmountDetails);
			previousVersion_lazy = () -> ReportEntry4.mmAmountDetails;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AmountAndCurrencyExchange3> getValue(ReportEntry7 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<AmountAndCurrencyExchange3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<Charges4>> mmCharges = new MMMessageAssociationEnd<ReportEntry7, Optional<Charges4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmCharges);
			previousVersion_lazy = () -> ReportEntry4.mmCharges;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Charges4> getValue(ReportEntry7 obj) {
			return obj.getCharges();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<Charges4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<TechnicalInputChannel1Choice>> mmTechnicalInputChannel = new MMMessageAssociationEnd<ReportEntry7, Optional<TechnicalInputChannel1Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ReportEntry7.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmTechnicalInputChannel);
			previousVersion_lazy = () -> ReportEntry4.mmTechnicalInputChannel;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TechnicalInputChannel1Choice> getValue(ReportEntry7 obj) {
			return obj.getTechnicalInputChannel();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<TechnicalInputChannel1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<TransactionInterest3>> mmInterest = new MMMessageAssociationEnd<ReportEntry7, Optional<TransactionInterest3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmInterest);
			previousVersion_lazy = () -> ReportEntry4.mmInterest;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TransactionInterest3> getValue(ReportEntry7 obj) {
			return obj.getInterest();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<TransactionInterest3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, Optional<CardEntry2>> mmCardTransaction = new MMMessageAssociationEnd<ReportEntry7, Optional<CardEntry2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmCardTransaction);
			previousVersion_lazy = () -> ReportEntry4.mmCardTransaction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CardEntry2> getValue(ReportEntry7 obj) {
			return obj.getCardTransaction();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<CardEntry2> value) {
			obj.setCardTransaction(value.orElse(null));
		}
	};
	@XmlElement(name = "NtryDtls")
	protected List<EntryDetails6> entryDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ReportEntry7, List<EntryDetails6>> mmEntryDetails = new MMMessageAssociationEnd<ReportEntry7, List<EntryDetails6>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmEntryDetails);
			previousVersion_lazy = () -> ReportEntry4.mmEntryDetails;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<EntryDetails6> getValue(ReportEntry7 obj) {
			return obj.getEntryDetails();
		}

		@Override
		public void setValue(ReportEntry7 obj, List<EntryDetails6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReportEntry7, Optional<Max500Text>> mmAdditionalEntryInformation = new MMMessageAttribute<ReportEntry7, Optional<Max500Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ReportEntry7.mmObject();
			isDerived = false;
			xmlTag = "AddtlNtryInf";
			...
			nextVersions_lazy = () -> Arrays.asList(ReportEntry8.mmAdditionalEntryInformation);
			previousVersion_lazy = () -> ReportEntry4.mmAdditionalEntryInformation;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max500Text> getValue(ReportEntry7 obj) {
			return obj.getAdditionalEntryInformation();
		}

		@Override
		public void setValue(ReportEntry7 obj, Optional<Max500Text> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReferenceGuideline.forReportEntry7);
	...
	public ReportEntry7 setEntryReference(Max35Text entryReference) {
	...
	public ReportEntry7 setAmount(ActiveOrHistoricCurrencyAndAmount amount) {
	...
	public ReportEntry7 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public ReportEntry7 setReversalIndicator(TrueFalseIndicator reversalIndicator) {
	...
	public ReportEntry7 setStatus(EntryStatus2Code status) {
	...
	public ReportEntry7 setBookingDate(DateAndDateTimeChoice bookingDate) {
	...
	public ReportEntry7 setValueDate(DateAndDateTimeChoice valueDate) {
	...
	public ReportEntry7 setAccountServicerReference(Max35Text accountServicerReference) {
	...
	public ReportEntry7 setAvailability(List<CashBalanceAvailability2> availability) {
	...
	public ReportEntry7 setBankTransactionCode(BankTransactionCodeStructure4 bankTransactionCode) {
	...
	public ReportEntry7 setCommissionWaiverIndicator(YesNoIndicator commissionWaiverIndicator) {
	...
	public ReportEntry7 setAdditionalInformationIndicator(MessageIdentification2 additionalInformationIndicator) {
	...
	public ReportEntry7 setAmountDetails(AmountAndCurrencyExchange3 amountDetails) {
	...
	public ReportEntry7 setCharges(Charges4 charges) {
	...
	public ReportEntry7 setTechnicalInputChannel(TechnicalInputChannel1Choice technicalInputChannel) {
	...
	public ReportEntry7 setInterest(TransactionInterest3 interest) {
	...
	public ReportEntry7 setCardTransaction(CardEntry2 cardTransaction) {
	...
	public ReportEntry7 setEntryDetails(List<EntryDetails6> entryDetails) {
	...
	public ReportEntry7 setAdditionalEntryInformation(Max500Text additionalEntryInformation) {
