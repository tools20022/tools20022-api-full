...
public class CardPaymentDataSetTransaction5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction5.mmTransactionSequenceCounter, CardPaymentDataSetTransaction5.mmTraceability, CardPaymentDataSetTransaction5.mmEnvironment,
						CardPaymentDataSetTransaction5.mmTransaction, CardPaymentDataSetTransaction5.mmTransactionResponse);
