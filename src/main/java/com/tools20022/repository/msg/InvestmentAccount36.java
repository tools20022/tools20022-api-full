...
public class InvestmentAccount36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccount36.mmName, InvestmentAccount36.mmDesignation, InvestmentAccount36.mmType, InvestmentAccount36.mmOwnershipType, InvestmentAccount36.mmTaxExemption,
						InvestmentAccount36.mmStatementFrequency, InvestmentAccount36.mmReferenceCurrency, InvestmentAccount36.mmLanguage, InvestmentAccount36.mmIncomePreference, InvestmentAccount36.mmTaxWithholdingMethod,
						InvestmentAccount36.mmLetterIntentDetails, InvestmentAccount36.mmAccumulationRightReference, InvestmentAccount36.mmRequiredSignatoriesNumber, InvestmentAccount36.mmFundFamilyName,
						InvestmentAccount36.mmModifiedFundDetails, InvestmentAccount36.mmRoundingDetails, InvestmentAccount36.mmAccountServicer, InvestmentAccount36.mmBlockedStatus, InvestmentAccount36.mmAccountUsageType,
						InvestmentAccount36.mmForeignStatusCertification, InvestmentAccount36.mmAccountSignatureDateTime);
