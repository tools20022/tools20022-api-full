 ...
 * <li>{@linkplain com.tools20022.repository.msg.InvestmentAccount36#Language
...
public class InvestmentAccount36 {
	...
	public static final MMMessageAttribute Name = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InvestmentAccount36.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.Name);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Designation = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.Designation);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute Type = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.Type);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OwnershipType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.OwnershipType);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TaxExemption = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.TaxExemption);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute StatementFrequency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.StatementFrequency);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ReferenceCurrency = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.ReferenceCurrency);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Language = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.Language);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IncomePreference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.IncomePreference);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TaxWithholdingMethod = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.TaxWithholdingMethod);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LetterIntentDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.LetterIntentDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AccumulationRightReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.AccumulationRightReference);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute RequiredSignatoriesNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.RequiredSignatoriesNumber);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FundFamilyName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.FundFamilyName);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ModifiedFundDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.ModifiedFundDetails);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd RoundingDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.RoundingDetails);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AccountServicer = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.AccountServicer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute BlockedStatus = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.BlockedStatus);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AccountUsageType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.AccountUsageType);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ForeignStatusCertification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.ForeignStatusCertification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AccountSignatureDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount39.AccountSignatureDateTime);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount36.Name, com.tools20022.repository.msg.InvestmentAccount36.Designation, com.tools20022.repository.msg.InvestmentAccount36.Type,
						com.tools20022.repository.msg.InvestmentAccount36.OwnershipType, com.tools20022.repository.msg.InvestmentAccount36.TaxExemption, com.tools20022.repository.msg.InvestmentAccount36.StatementFrequency,
						com.tools20022.repository.msg.InvestmentAccount36.ReferenceCurrency, com.tools20022.repository.msg.InvestmentAccount36.Language, com.tools20022.repository.msg.InvestmentAccount36.IncomePreference,
						com.tools20022.repository.msg.InvestmentAccount36.TaxWithholdingMethod, com.tools20022.repository.msg.InvestmentAccount36.LetterIntentDetails,
						com.tools20022.repository.msg.InvestmentAccount36.AccumulationRightReference, com.tools20022.repository.msg.InvestmentAccount36.RequiredSignatoriesNumber,
						com.tools20022.repository.msg.InvestmentAccount36.FundFamilyName, com.tools20022.repository.msg.InvestmentAccount36.ModifiedFundDetails, com.tools20022.repository.msg.InvestmentAccount36.RoundingDetails,
						com.tools20022.repository.msg.InvestmentAccount36.AccountServicer, com.tools20022.repository.msg.InvestmentAccount36.BlockedStatus, com.tools20022.repository.msg.InvestmentAccount36.AccountUsageType,
						com.tools20022.repository.msg.InvestmentAccount36.ForeignStatusCertification, com.tools20022.repository.msg.InvestmentAccount36.AccountSignatureDateTime);
				trace_lazy = () -> InvestmentAccount.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountModificationInstructionV03.ModifiedInvestmentAccount);
