...
public class QuantityAndAccount45 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount45.mmSettlementQuantity, QuantityAndAccount45.mmDenominationChoice, QuantityAndAccount45.mmCashAccount, QuantityAndAccount45.mmQuantityBreakdown,
						QuantityAndAccount45.mmSafekeepingPlace);
