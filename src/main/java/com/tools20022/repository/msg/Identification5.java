...
public class Identification5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification5.mmAccountOwnerTransactionIdentification, Identification5.mmAccountServicerTransactionIdentification, Identification5.mmMarketInfrastructureTransactionIdentification,
						Identification5.mmCommonIdentification, Identification5.mmTradeIdentification, Identification5.mmMasterIdentification, Identification5.mmBasketIdentification, Identification5.mmIndexIdentification,
						Identification5.mmListIdentification, Identification5.mmProgramIdentification, Identification5.mmPoolIdentification, Identification5.mmCorporateActionEventIdentification);
