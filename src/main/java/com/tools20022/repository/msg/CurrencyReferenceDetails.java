...
@XmlType(name = "CurrencyReferenceDetails", propOrder = {"sourceCurrency", "targetCurrency"})
public class CurrencyReferenceDetails {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CurrencyReferenceDetails.mmSourceCurrency, com.tools20022.repository.msg.CurrencyReferenceDetails.mmTargetCurrency);
	...
	public CurrencyReferenceDetails setSourceCurrency(CurrencyCode sourceCurrency) {
	...
	public CurrencyReferenceDetails setTargetCurrency(CurrencyCode targetCurrency) {
