...
public class Linkages12 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Linkages12.mmProcessingPosition, Linkages12.mmMessageNumber, Linkages12.mmReference, Linkages12.mmLinkedQuantity, Linkages12.mmReferenceOwner);
