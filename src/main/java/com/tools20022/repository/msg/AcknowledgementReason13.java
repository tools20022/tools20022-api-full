...
public class AcknowledgementReason13 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason13.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason13.mmCode, AcknowledgementReason13.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason16Choice code) {
		this.code = code;
	}
