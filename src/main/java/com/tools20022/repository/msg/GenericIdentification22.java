...
public class GenericIdentification22 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericIdentification22.mmIdentification, GenericIdentification22.mmIssuer, GenericIdentification22.mmSchemeName, GenericIdentification22.mmBalance);
