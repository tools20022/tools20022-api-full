	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GenericIdentification22.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Proprietary information, often a code, issued by the data source scheme issuer.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification56.mmIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmIssuer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification56.mmIssuer);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmSchemeName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification56.mmSchemeName);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmBalance = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification56.mmBalance);
			maxOccurs = 1;
			minOccurs = 1;
