...
public class GroupHeader9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader9.mmMessageIdentification, GroupHeader9.mmCreationDateTime, GroupHeader9.mmAuthorisation, GroupHeader9.mmBatchBooking, GroupHeader9.mmNumberOfTransactions,
						GroupHeader9.mmControlSum, GroupHeader9.mmGroupReversal, GroupHeader9.mmTotalReversedInterbankSettlementAmount, GroupHeader9.mmInterbankSettlementDate, GroupHeader9.mmSettlementInformation,
						GroupHeader9.mmInstructingAgent, GroupHeader9.mmInstructedAgent);
	...
	public CurrencyAndAmount getTotalReversedInterbankSettlementAmount() {
		return totalReversedInterbankSettlementAmount;
	}

	public void setTotalReversedInterbankSettlementAmount(CurrencyAndAmount totalReversedInterbankSettlementAmount) {
