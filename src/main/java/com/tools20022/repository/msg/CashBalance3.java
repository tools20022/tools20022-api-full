...
public class CashBalance3 {
	...
	public static final MMMessageAssociationEnd Type = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CashBalance3.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.Type);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CreditLine = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.CreditLine);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.Amount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CreditDebitIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.CreditDebitIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Date = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.Date);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Availability = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance7.Availability);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashBalance3.Type, com.tools20022.repository.msg.CashBalance3.CreditLine, com.tools20022.repository.msg.CashBalance3.Amount,
						com.tools20022.repository.msg.CashBalance3.CreditDebitIndicator, com.tools20022.repository.msg.CashBalance3.Date, com.tools20022.repository.msg.CashBalance3.Availability);
