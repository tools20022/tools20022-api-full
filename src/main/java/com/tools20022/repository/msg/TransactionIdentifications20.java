...
public class TransactionIdentifications20 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionIdentifications20.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionIdentifications20.mmAccountOwnerTransactionIdentification, TransactionIdentifications20.mmAccountServicerTransactionIdentification,
						TransactionIdentifications20.mmMarketInfrastructureTransactionIdentification, TransactionIdentifications20.mmProcessorTransactionIdentification, TransactionIdentifications20.mmOtherIdentification);
	...
	public RestrictedFINXMax16Text getOtherIdentification() {
		return otherIdentification;
	}

	public void setOtherIdentification(RestrictedFINXMax16Text otherIdentification) {
