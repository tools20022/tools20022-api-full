...
public class SecuritiesSettlementTransactionDetails8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionDetails8.mmSettlementTypeAndAdditionalParameters, SecuritiesSettlementTransactionDetails8.mmLinkages,
						SecuritiesSettlementTransactionDetails8.mmTradeDetails, SecuritiesSettlementTransactionDetails8.mmFinancialInstrumentAttributes, SecuritiesSettlementTransactionDetails8.mmQuantityAndAccountDetails,
						SecuritiesSettlementTransactionDetails8.mmSettlementParameters, SecuritiesSettlementTransactionDetails8.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionDetails8.mmDeliveringSettlementParties,
						SecuritiesSettlementTransactionDetails8.mmReceivingSettlementParties, SecuritiesSettlementTransactionDetails8.mmCashParties, SecuritiesSettlementTransactionDetails8.mmSettlementAmount,
						SecuritiesSettlementTransactionDetails8.mmOtherAmounts, SecuritiesSettlementTransactionDetails8.mmOtherBusinessParties, SecuritiesSettlementTransactionDetails8.mmAdditionalPhysicalOrRegistrationDetails,
						SecuritiesSettlementTransactionDetails8.mmSupplementaryData);
