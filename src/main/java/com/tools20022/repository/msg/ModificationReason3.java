...
public class ModificationReason3 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ModificationReason3.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ModificationReason3.mmCode, ModificationReason3.mmAdditionalReasonInformation);
	...
	public void setCode(ModificationReason3Choice code) {
		this.code = code;
	}
