...
public class RateTypeAndAmountAndStatus33 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus33.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus33.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus33.RateStatus);
