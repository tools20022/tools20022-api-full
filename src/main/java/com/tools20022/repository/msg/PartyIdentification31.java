...
public class PartyIdentification31 {
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification31.mmObject();
			isDerived = false;
			xmlTag = "Nm";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification31.mmName, PartyIdentification31.mmPostalAddress, PartyIdentification31.mmIdentification, PartyIdentification31.mmCountryOfResidence);
