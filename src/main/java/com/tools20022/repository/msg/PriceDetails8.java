...
public class PriceDetails8 {
	...
	public static final MMMessageAssociationEnd mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PriceDetails8.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceDetails8.mmGenericCashPricePaidPerProduct, PriceDetails8.mmGenericCashPriceReceivedPerProduct);
