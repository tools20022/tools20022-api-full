 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails8
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails8}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails8", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails8, Optional<PriceFormat27Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails8, Optional<PriceFormat27Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails8.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat27Choice> getValue(PriceDetails8 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails8 obj, Optional<PriceFormat27Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails8, Optional<PriceFormat26Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails8, Optional<PriceFormat26Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat26Choice> getValue(PriceDetails8 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails8 obj, Optional<PriceFormat26Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PriceDetails8.mmGenericCashPricePaidPerProduct, com.tools20022.repository.msg.PriceDetails8.mmGenericCashPriceReceivedPerProduct);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails8);
	...
	public PriceDetails8 setGenericCashPricePaidPerProduct(PriceFormat27Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails8 setGenericCashPriceReceivedPerProduct(PriceFormat26Choice genericCashPriceReceivedPerProduct) {
