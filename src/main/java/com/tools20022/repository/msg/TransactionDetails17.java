...
public class TransactionDetails17 {
	...
	public static final MMMessageAssociationEnd mmTransactionActivity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> TransactionDetails17.mmObject();
			isDerived = false;
			xmlTag = "TxActvty";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails17.mmTransactionActivity, TransactionDetails17.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails17.mmSecuritiesMovementType,
						TransactionDetails17.mmPayment, TransactionDetails17.mmSettlementParameters, TransactionDetails17.mmPlaceOfTrade, TransactionDetails17.mmSafekeepingPlace, TransactionDetails17.mmFinancialInstrumentIdentification,
						TransactionDetails17.mmPostingQuantity, TransactionDetails17.mmPostingAmount, TransactionDetails17.mmTradeDate, TransactionDetails17.mmExpectedSettlementDate, TransactionDetails17.mmSettlementDate,
						TransactionDetails17.mmLateDeliveryDate, TransactionDetails17.mmExpectedValueDate, TransactionDetails17.mmDeliveringSettlementParties, TransactionDetails17.mmReceivingSettlementParties,
						TransactionDetails17.mmTransactionAdditionalDetails, TransactionDetails17.mmExtension);
	...
	public SettlementOrCorporateActionEvent3Choice getSettlementTransactionOrCorporateActionEventType() {
		return settlementTransactionOrCorporateActionEventType;
	}

	public void setSettlementTransactionOrCorporateActionEventType(SettlementOrCorporateActionEvent3Choice settlementTransactionOrCorporateActionEventType) {
	...
	public SettlementDetails12 getSettlementParameters() {
		return settlementParameters;
	}

	public void setSettlementParameters(com.tools20022.repository.msg.SettlementDetails12 settlementParameters) {
	...
	public void setPostingAmount(com.tools20022.repository.msg.AmountAndDirection12 postingAmount) {
