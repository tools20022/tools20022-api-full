...
public class GenericIdentification64 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification64.Identification, com.tools20022.repository.msg.GenericIdentification64.Issuer,
						com.tools20022.repository.msg.GenericIdentification64.SchemeName);
