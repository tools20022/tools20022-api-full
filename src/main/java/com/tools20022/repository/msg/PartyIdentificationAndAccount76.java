...
public class PartyIdentificationAndAccount76 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount76.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount76.mmIdentification, PartyIdentificationAndAccount76.mmSafekeepingAccount, PartyIdentificationAndAccount76.mmProcessingIdentification);
	...
	public void setIdentification(PartyIdentification66Choice identification) {
