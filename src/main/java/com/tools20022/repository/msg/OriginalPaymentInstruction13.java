...
public class OriginalPaymentInstruction13 {
	...
	public static final MMMessageAttribute PaymentCancellationIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OriginalPaymentInstruction13.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.PaymentCancellationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.PaymentCancellationIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Case = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.Case;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.Case);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalPaymentInformationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.OriginalPaymentInformationIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.OriginalPaymentInformationIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAssociationEnd OriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.OriginalGroupInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.OriginalGroupInformation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfTransactions = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.NumberOfTransactions;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.NumberOfTransactions);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ControlSum = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.ControlSum;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.ControlSum);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PaymentInformationCancellation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.PaymentInformationCancellation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.PaymentInformationCancellation);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CancellationReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.CancellationReasonInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.CancellationReasonInformation);
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd TransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.OriginalPaymentInstruction8.TransactionInformation;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction15.TransactionInformation);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalPaymentInstruction13.PaymentCancellationIdentification, com.tools20022.repository.msg.OriginalPaymentInstruction13.Case,
						com.tools20022.repository.msg.OriginalPaymentInstruction13.OriginalPaymentInformationIdentification, com.tools20022.repository.msg.OriginalPaymentInstruction13.OriginalGroupInformation,
						com.tools20022.repository.msg.OriginalPaymentInstruction13.NumberOfTransactions, com.tools20022.repository.msg.OriginalPaymentInstruction13.ControlSum,
						com.tools20022.repository.msg.OriginalPaymentInstruction13.PaymentInformationCancellation, com.tools20022.repository.msg.OriginalPaymentInstruction13.CancellationReasonInformation,
						com.tools20022.repository.msg.OriginalPaymentInstruction13.TransactionInformation);
