...
public class SubAccountIdentification27 {
	...
	protected List<com.tools20022.repository.msg.AggregateBalanceInformation20> balanceForSubAccount;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification27.mmAccountOwner, SubAccountIdentification27.mmSafekeepingAccount, SubAccountIdentification27.mmActivityIndicator,
						SubAccountIdentification27.mmBalanceForSubAccount);
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation20> balanceForSubAccount) {
