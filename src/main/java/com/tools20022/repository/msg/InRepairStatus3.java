...
import com.tools20022.repository.choice.InRepairStatus4Choice;
...
@XmlType(name = "InRepairStatus3", propOrder = {"reason", "dataSourceScheme", "noSpecifiedReason"})
public class InRepairStatus3 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.InRepairStatus3
	 * InRepairStatus3}</li>
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InRepairStatus4Choice.mmReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmDataSourceScheme = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InRepairStatus4Choice.mmDataSourceScheme);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(InRepairStatus4Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMXor mmReasonOrDataSourceSchemeOrNoSpecifiedReasonRule = new MMXor() {
		{
			...
			impactedElements_lazy = () -> Arrays.asList(InRepairStatus3.mmReason, InRepairStatus3.mmDataSourceScheme, InRepairStatus3.mmNoSpecifiedReason);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InRepairStatus3.mmReason, InRepairStatus3.mmDataSourceScheme, InRepairStatus3.mmNoSpecifiedReason);
				...
				xors_lazy = () -> Arrays.asList(InRepairStatus3.mmReasonOrDataSourceSchemeOrNoSpecifiedReasonRule);
			}
		});
