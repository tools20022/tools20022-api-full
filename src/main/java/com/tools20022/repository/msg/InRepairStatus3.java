...
public class InRepairStatus3 {
	...
	public static final MMXor ReasonOrDataSourceSchemeOrNoSpecifiedReasonRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.InRepairStatus3.mmObject();
	...
	public InRepairStatus3 setReason(Max350Text reason) {
	...
	public InRepairStatus3 setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
