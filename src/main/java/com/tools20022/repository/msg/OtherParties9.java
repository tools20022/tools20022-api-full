...
public class OtherParties9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OtherParties9.mmInvestor, OtherParties9.mmQualifiedForeignIntermediary, OtherParties9.mmStockExchange, OtherParties9.mmTradeRegulator, OtherParties9.mmTripartyAgent);
