...
public class PartyIdentificationAndAccount157 {
	...
	public static final MMMessageAttribute mmPartyIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount124.mmPartyIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAccountIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount124.mmAccountIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmProcessingReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount124.mmProcessingReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmProcessingDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PartyIdentificationAndAccount124.mmProcessingDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> PartyIdentificationAndAccount124.mmObject();
			}
		});
	...
	public PartyIdentificationAndAccount157 setPartyIdentification(com.tools20022.repository.msg.PartyIdentification113 partyIdentification) {
