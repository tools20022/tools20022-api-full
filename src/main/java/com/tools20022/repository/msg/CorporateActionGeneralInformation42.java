...
public class CorporateActionGeneralInformation42 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation42.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation42.mmCorporateActionEventIdentification, CorporateActionGeneralInformation42.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation42.mmClassActionNumber, CorporateActionGeneralInformation42.mmEventType);
