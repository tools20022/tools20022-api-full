...
public class RejectionOrRepairReason29 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason29.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason29.mmCode, RejectionOrRepairReason29.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason29Choice code) {
		this.code = code;
	}
