...
public class CorporateActionRate19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate19.mmAdditionalQuantityForSubscribedResultantSecurities, CorporateActionRate19.mmAdditionalQuantityForExistingSecurities, CorporateActionRate19.mmNewToOld,
						CorporateActionRate19.mmTransformationRate);
