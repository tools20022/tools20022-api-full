...
public class CorporateActionNarrative36 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionNarrative36.mmAdditionalText, CorporateActionNarrative36.mmNarrativeVersion, CorporateActionNarrative36.mmInformationConditions,
						CorporateActionNarrative36.mmInformationToComplyWith, CorporateActionNarrative36.mmSecurityRestriction, CorporateActionNarrative36.mmTaxationConditions, CorporateActionNarrative36.mmDisclaimer,
						CorporateActionNarrative36.mmCertificationBreakdown);
