...
import com.tools20022.repository.codeset.AssetClassSubProductType27Code;
...
public class EnergyCommodityLightEnd1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.EnergyCommodityLightEnd1.BaseProduct, com.tools20022.repository.msg.EnergyCommodityLightEnd1.SubProduct);
