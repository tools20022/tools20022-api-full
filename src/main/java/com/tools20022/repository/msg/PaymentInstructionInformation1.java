...
public class PaymentInstructionInformation1 {
	...
	public static final MMMessageAssociationEnd mmPaymentTypeInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.PaymentTypeInformation1.mmObject();
		}
	};
	...
	protected List<com.tools20022.repository.msg.CreditTransferTransactionInformation1> creditTransferTransactionInformation;
	/**
	...
	public static final MMMessageAssociationEnd mmCreditTransferTransactionInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CreditTransferTransactionInformation1.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentInstructionInformation1.mmPaymentInformationIdentification, PaymentInstructionInformation1.mmPaymentMethod, PaymentInstructionInformation1.mmPaymentTypeInformation,
						PaymentInstructionInformation1.mmRequestedExecutionDate, PaymentInstructionInformation1.mmPoolingAdjustmentDate, PaymentInstructionInformation1.mmDebtor, PaymentInstructionInformation1.mmDebtorAccount,
						PaymentInstructionInformation1.mmDebtorAgent, PaymentInstructionInformation1.mmDebtorAgentAccount, PaymentInstructionInformation1.mmUltimateDebtor, PaymentInstructionInformation1.mmChargeBearer,
						PaymentInstructionInformation1.mmChargesAccount, PaymentInstructionInformation1.mmChargesAccountAgent, PaymentInstructionInformation1.mmCreditTransferTransactionInformation);
	...
	public PaymentTypeInformation1 getPaymentTypeInformation() {
		return paymentTypeInformation;
	}

	public void setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation1 paymentTypeInformation) {
	...
	public void setCreditTransferTransactionInformation(List<com.tools20022.repository.msg.CreditTransferTransactionInformation1> creditTransferTransactionInformation) {
