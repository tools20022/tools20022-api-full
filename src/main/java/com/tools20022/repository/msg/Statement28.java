...
public class Statement28 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement28.mmReportNumber, Statement28.mmQueryReference, Statement28.mmStatementIdentification, Statement28.mmStatementDateTime, Statement28.mmFrequency, Statement28.mmUpdateType,
						Statement28.mmActivityIndicator);
