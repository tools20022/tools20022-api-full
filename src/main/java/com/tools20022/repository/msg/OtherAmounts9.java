...
public class OtherAmounts9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OtherAmounts9.mmAccruedInterestAmount, OtherAmounts9.mmChargesFees, OtherAmounts9.mmCountryNationalFederalTax, OtherAmounts9.mmTradeAmount, OtherAmounts9.mmExecutingBrokerAmount,
						OtherAmounts9.mmIssueDiscountAllowance, OtherAmounts9.mmPaymentLevyTax, OtherAmounts9.mmLocalTax, OtherAmounts9.mmLocalTaxCountrySpecific, OtherAmounts9.mmLocalBrokerCommission, OtherAmounts9.mmMargin,
						OtherAmounts9.mmOther, OtherAmounts9.mmPostageAmount, OtherAmounts9.mmRegulatoryAmount, OtherAmounts9.mmShippingAmount, OtherAmounts9.mmSpecialConcession, OtherAmounts9.mmStampDuty, OtherAmounts9.mmStockExchangeTax,
						OtherAmounts9.mmTransferTax, OtherAmounts9.mmTransactionTax, OtherAmounts9.mmValueAddedTax, OtherAmounts9.mmWithholdingTax, OtherAmounts9.mmNetGainLoss, OtherAmounts9.mmConsumptionTax,
						OtherAmounts9.mmAccruedCapitalisationAmount, OtherAmounts9.mmBookValue, OtherAmounts9.mmCollateralMonitorAmount);
