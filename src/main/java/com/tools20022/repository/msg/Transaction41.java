...
public class Transaction41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction41.mmAccountOwnerTransactionIdentification, Transaction41.mmAccountServicerTransactionIdentification, Transaction41.mmMarketInfrastructureTransactionIdentification,
						Transaction41.mmProcessorTransactionIdentification, Transaction41.mmTradeIdentification, Transaction41.mmPoolIdentification, Transaction41.mmCommonIdentification, Transaction41.mmCorporateActionEventIdentification,
						Transaction41.mmTripartyAgentCollateralTransactionIdentification, Transaction41.mmClientTripartyCollateralTransactionIdentification, Transaction41.mmClientCollateralInstructionIdentification,
						Transaction41.mmTripartyCollateralInstructionIdentification, Transaction41.mmTransactionDetails, Transaction41.mmStatusAndReason);
