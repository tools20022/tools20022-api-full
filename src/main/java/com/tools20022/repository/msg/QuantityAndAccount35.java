...
public class QuantityAndAccount35 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityAndAccount35.mmSettlementQuantity, QuantityAndAccount35.mmDenominationChoice, QuantityAndAccount35.mmCashAccount, QuantityAndAccount35.mmQuantityBreakdown,
						QuantityAndAccount35.mmSafekeepingPlace);
