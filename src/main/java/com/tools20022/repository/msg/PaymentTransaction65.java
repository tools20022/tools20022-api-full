...
public class PaymentTransaction65 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction65.mmReturnIdentification, PaymentTransaction65.mmOriginalGroupInformation, PaymentTransaction65.mmOriginalInstructionIdentification,
						PaymentTransaction65.mmOriginalEndToEndIdentification, PaymentTransaction65.mmOriginalTransactionIdentification, PaymentTransaction65.mmOriginalClearingSystemReference,
						PaymentTransaction65.mmOriginalInterbankSettlementAmount, PaymentTransaction65.mmReturnedInterbankSettlementAmount, PaymentTransaction65.mmInterbankSettlementDate, PaymentTransaction65.mmSettlementPriority,
						PaymentTransaction65.mmReturnedInstructedAmount, PaymentTransaction65.mmExchangeRate, PaymentTransaction65.mmCompensationAmount, PaymentTransaction65.mmChargeBearer, PaymentTransaction65.mmChargesInformation,
						PaymentTransaction65.mmInstructingAgent, PaymentTransaction65.mmInstructedAgent, PaymentTransaction65.mmReturnReasonInformation, PaymentTransaction65.mmOriginalTransactionReference,
						PaymentTransaction65.mmSupplementaryData);
