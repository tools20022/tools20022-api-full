...
public class PendingStatusReason15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason15.ReasonCode, com.tools20022.repository.msg.PendingStatusReason15.AdditionalReasonInformation);
