...
public class PendingStatusReason15 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingStatusReason15.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatusReason15.mmReasonCode, PendingStatusReason15.mmAdditionalReasonInformation);
	...
	public void setReasonCode(PendingReason49Choice reasonCode) {
