...
import com.tools20022.repository.msg.Balance11;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.QuantityBreakdown39#mmLotPrice
...
@XmlType(name = "QuantityBreakdown39", propOrder = {"lotNumber", "lotQuantity", "lotDateTime", "lotPrice", "typeOfPrice", "accountBaseCurrencyAmounts", "instrumentCurrencyAmounts", "alternateReportingCurrencyAmounts"})
public class QuantityBreakdown39 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.QuantityBreakdown39
	 * QuantityBreakdown39}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown39, Optional<GenericIdentification39>> mmLotNumber = new MMMessageAttribute<QuantityBreakdown39, Optional<GenericIdentification39>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown39.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<GenericIdentification39> getValue(QuantityBreakdown39 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<GenericIdentification39> value) {
			obj.setLotNumber(value.orElse(null));
		}
	};
	@XmlElement(name = "LotQty")
	protected Balance11 lotQuantity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.Balance11 Balance11}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown39, Optional<Balance11>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown39, Optional<Balance11>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> Balance11.mmObject();
		}

		@Override
		public Optional<Balance11> getValue(QuantityBreakdown39 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<Balance11> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown39, Optional<DateAndDateTimeChoice>> mmLotDateTime = new MMMessageAttribute<QuantityBreakdown39, Optional<DateAndDateTimeChoice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(QuantityBreakdown39 obj) {
			return obj.getLotDateTime();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown39, Optional<Price3>> mmLotPrice = new MMMessageAssociationEnd<QuantityBreakdown39, Optional<Price3>>() {
		{
		...
		@Override
		public Optional<Price3> getValue(QuantityBreakdown39 obj) {
			return obj.getLotPrice();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<Price3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<QuantityBreakdown39, Optional<TypeOfPrice32Choice>> mmTypeOfPrice = new MMMessageAttribute<QuantityBreakdown39, Optional<TypeOfPrice32Choice>>() {
		{
		...
		@Override
		public Optional<TypeOfPrice32Choice> getValue(QuantityBreakdown39 obj) {
			return obj.getTypeOfPrice();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<TypeOfPrice32Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>> mmAccountBaseCurrencyAmounts = new MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>>() {
		{
		...
		@Override
		public Optional<BalanceAmounts6> getValue(QuantityBreakdown39 obj) {
			return obj.getAccountBaseCurrencyAmounts();
		}

		@Override
		public void setValue(QuantityBreakdown39 obj, Optional<BalanceAmounts6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>> mmInstrumentCurrencyAmounts = new MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>>() {
		{
			businessElementTrace_lazy = () -> Asset.mmAssetValue;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown39.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>> mmAlternateReportingCurrencyAmounts = new MMMessageAssociationEnd<QuantityBreakdown39, Optional<BalanceAmounts6>>() {
		{
			businessElementTrace_lazy = () -> Asset.mmAssetValue;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown39.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown39.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown39.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown39.mmLotDateTime, com.tools20022.repository.msg.QuantityBreakdown39.mmLotPrice, com.tools20022.repository.msg.QuantityBreakdown39.mmTypeOfPrice,
	...
	public QuantityBreakdown39 setLotNumber(GenericIdentification39 lotNumber) {
		this.lotNumber = lotNumber;
		return this;
	}

	public Optional<Balance11> getLotQuantity() {
		return lotQuantity == null ? Optional.empty() : Optional.of(lotQuantity);
	}

	public QuantityBreakdown39 setLotQuantity(Balance11 lotQuantity) {
	...
	public QuantityBreakdown39 setLotDateTime(DateAndDateTimeChoice lotDateTime) {
	...
	public QuantityBreakdown39 setLotPrice(Price3 lotPrice) {
	...
	public QuantityBreakdown39 setTypeOfPrice(TypeOfPrice32Choice typeOfPrice) {
	...
	public QuantityBreakdown39 setAccountBaseCurrencyAmounts(BalanceAmounts6 accountBaseCurrencyAmounts) {
	...
	public QuantityBreakdown39 setInstrumentCurrencyAmounts(BalanceAmounts6 instrumentCurrencyAmounts) {
	...
	public QuantityBreakdown39 setAlternateReportingCurrencyAmounts(BalanceAmounts6 alternateReportingCurrencyAmounts) {
