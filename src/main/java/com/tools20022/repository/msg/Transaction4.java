...
public class Transaction4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction4.mmPaymentTo, Transaction4.mmPaymentFrom, Transaction4.mmCreditDebitIndicator, Transaction4.mmPayment, Transaction4.mmAccountEntry);
