...
public class RateTypeAndAmountAndStatus6 {
	...
	public static final MMMessageAssociationEnd RateType = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RateTypeAndAmountAndStatus6.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus6.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus6.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus6.RateStatus);
