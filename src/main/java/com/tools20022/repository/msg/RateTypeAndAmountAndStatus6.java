...
public class RateTypeAndAmountAndStatus6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus6.mmRateType, RateTypeAndAmountAndStatus6.mmAmount, RateTypeAndAmountAndStatus6.mmRateStatus);
	...
	public void setRateType(RateType11Choice rateType) {
