...
public class CorporateActionGeneralInformation30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation30.mmCorporateActionEventIdentification, CorporateActionGeneralInformation30.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation30.mmClassActionNumber, CorporateActionGeneralInformation30.mmEventProcessingType, CorporateActionGeneralInformation30.mmEventType,
						CorporateActionGeneralInformation30.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation30.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation30.mmUnderlyingSecurity);
