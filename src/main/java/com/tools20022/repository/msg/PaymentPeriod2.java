 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentPeriod2#NumberOfDays
...
public class PaymentPeriod2 {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentPeriod3.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NumberOfDays = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentPeriod3.NumberOfDays);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentPeriod2.Code, com.tools20022.repository.msg.PaymentPeriod2.NumberOfDays);
