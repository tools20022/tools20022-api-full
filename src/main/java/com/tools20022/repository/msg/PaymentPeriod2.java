...
public class PaymentPeriod2 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentPeriod2, PaymentTime2Code> mmCode = new MMMessageAttribute<PaymentPeriod2, PaymentTime2Code>() {
		{
		...
		@Override
		public PaymentTime2Code getValue(PaymentPeriod2 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PaymentPeriod2 obj, PaymentTime2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentPeriod2, Optional<Number>> mmNumberOfDays = new MMMessageAttribute<PaymentPeriod2, Optional<Number>>() {
		{
		...
		@Override
		public Optional<Number> getValue(PaymentPeriod2 obj) {
			return obj.getNumberOfDays();
		}

		@Override
		public void setValue(PaymentPeriod2 obj, Optional<Number> value) {
