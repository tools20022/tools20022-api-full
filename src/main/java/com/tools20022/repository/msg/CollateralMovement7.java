...
public class CollateralMovement7 {
	...
	public static final MMMessageAttribute AgreedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CollateralMovement5.AgreedAmount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement10.AgreedAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MovementDirection = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.CollateralMovement5.MovementDirection;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement10.MovementDirection);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement7.AgreedAmount, com.tools20022.repository.msg.CollateralMovement7.MovementDirection);
