...
public class CollateralMovement7 {
	...
	public static final MMMessageAttribute mmAgreedAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement10.mmAgreedAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CollateralMovement5.mmAgreedAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmMovementDirection = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement10.mmMovementDirection);
			previousVersion_lazy = () -> com.tools20022.repository.msg.CollateralMovement5.mmMovementDirection;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralMovement7.mmAgreedAmount, com.tools20022.repository.msg.CollateralMovement7.mmMovementDirection);
