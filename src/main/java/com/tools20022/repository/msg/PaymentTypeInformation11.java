...
@XmlType(name = "PaymentTypeInformation11", propOrder = {"instructionPriority", "serviceLevel", "clearingChannel", "localInstrument", "sequenceType", "categoryPurpose"})
public class PaymentTypeInformation11 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation11, Optional<Priority2Code>> mmInstructionPriority = new MMMessageAttribute<PaymentTypeInformation11, Optional<Priority2Code>>() {
		{
			businessElementTrace_lazy = () -> PaymentProcessing.mmPriority;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTypeInformation11.mmObject();
			isDerived = false;
			xmlTag = "InstrPrty";
		...
		@Override
		public Optional<Priority2Code> getValue(PaymentTypeInformation11 obj) {
			return obj.getInstructionPriority();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<Priority2Code> value) {
			obj.setInstructionPriority(value.orElse(null));
		}
	};
	@XmlElement(name = "SvcLvl")
	protected ServiceLevel7Choice serviceLevel;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation11, Optional<ServiceLevel7Choice>> mmServiceLevel = new MMMessageAssociationEnd<PaymentTypeInformation11, Optional<ServiceLevel7Choice>>() {
		{
		...
		@Override
		public Optional<ServiceLevel7Choice> getValue(PaymentTypeInformation11 obj) {
			return obj.getServiceLevel();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<ServiceLevel7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation11, Optional<ClearingChannel2Code>> mmClearingChannel = new MMMessageAttribute<PaymentTypeInformation11, Optional<ClearingChannel2Code>>() {
		{
		...
		@Override
		public Optional<ClearingChannel2Code> getValue(PaymentTypeInformation11 obj) {
			return obj.getClearingChannel();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<ClearingChannel2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation11, Optional<LocalInstrument1Choice>> mmLocalInstrument = new MMMessageAssociationEnd<PaymentTypeInformation11, Optional<LocalInstrument1Choice>>() {
		{
		...
		@Override
		public Optional<LocalInstrument1Choice> getValue(PaymentTypeInformation11 obj) {
			return obj.getLocalInstrument();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<LocalInstrument1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation11, Optional<SequenceType1Code>> mmSequenceType = new MMMessageAttribute<PaymentTypeInformation11, Optional<SequenceType1Code>>() {
		{
		...
		@Override
		public Optional<SequenceType1Code> getValue(PaymentTypeInformation11 obj) {
			return obj.getSequenceType();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<SequenceType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation11, Optional<PaymentCategoryPurpose1Code>> mmCategoryPurpose = new MMMessageAttribute<PaymentTypeInformation11, Optional<PaymentCategoryPurpose1Code>>() {
		{
		...
		@Override
		public Optional<PaymentCategoryPurpose1Code> getValue(PaymentTypeInformation11 obj) {
			return obj.getCategoryPurpose();
		}

		@Override
		public void setValue(PaymentTypeInformation11 obj, Optional<PaymentCategoryPurpose1Code> value) {
	...
	public static final MMXor ServiceLevelOrClearingChannelRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.PaymentTypeInformation11.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation11.mmServiceLevel, com.tools20022.repository.msg.PaymentTypeInformation11.mmClearingChannel);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTypeInformation11.mmInstructionPriority, com.tools20022.repository.msg.PaymentTypeInformation11.mmServiceLevel,
						com.tools20022.repository.msg.PaymentTypeInformation11.mmClearingChannel, com.tools20022.repository.msg.PaymentTypeInformation11.mmLocalInstrument,
						com.tools20022.repository.msg.PaymentTypeInformation11.mmSequenceType, com.tools20022.repository.msg.PaymentTypeInformation11.mmCategoryPurpose);
	...
	public PaymentTypeInformation11 setInstructionPriority(Priority2Code instructionPriority) {
		this.instructionPriority = instructionPriority;
		return this;
	}

	public Optional<ServiceLevel7Choice> getServiceLevel() {
		return serviceLevel == null ? Optional.empty() : Optional.of(serviceLevel);
	}

	public PaymentTypeInformation11 setServiceLevel(ServiceLevel7Choice serviceLevel) {
	...
	public PaymentTypeInformation11 setClearingChannel(ClearingChannel2Code clearingChannel) {
	...
	public PaymentTypeInformation11 setLocalInstrument(LocalInstrument1Choice localInstrument) {
	...
	public PaymentTypeInformation11 setSequenceType(SequenceType1Code sequenceType) {
	...
	public PaymentTypeInformation11 setCategoryPurpose(PaymentCategoryPurpose1Code categoryPurpose) {
