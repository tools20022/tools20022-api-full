...
public class RateTypeAndAmountAndStatus21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus21.RateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus21.Amount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus21.RateStatus);
