...
public class AccountAndBalance18 {
	...
	public static final MMMessageAttribute mmSafekeepingAccount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AccountAndBalance18.mmObject();
			isDerived = false;
			xmlTag = "SfkpgAcct";
	...
	public static final MMMessageAssociationEnd mmBalance = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CorporateActionBalanceDetails13.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance18.mmSafekeepingAccount, AccountAndBalance18.mmAccountOwner, AccountAndBalance18.mmSafekeepingPlace, AccountAndBalance18.mmBalance);
	...
	public CorporateActionBalanceDetails13 getBalance() {
		return balance;
	}

	public void setBalance(com.tools20022.repository.msg.CorporateActionBalanceDetails13 balance) {
