...
public class ManagementPlan3 {
	...
	public static final MMMessageAssociationEnd POIIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ManagementPlan2.POIIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ManagementPlan4.POIIdentification);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd TerminalManagerIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ManagementPlan2.TerminalManagerIdentification;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ManagementPlan4.TerminalManagerIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> GenericIdentification35.mmObject();
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ManagementPlan2#DataSet
	...
	public static final MMMessageAssociationEnd DataSet = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.ManagementPlan2.DataSet;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ManagementPlan4.DataSet);
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ManagementPlan3.POIIdentification, com.tools20022.repository.msg.ManagementPlan3.TerminalManagerIdentification,
						com.tools20022.repository.msg.ManagementPlan3.DataSet);
				trace_lazy = () -> TerminalManagementAction.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.catm.ManagementPlanReplacementV03.ManagementPlan);
