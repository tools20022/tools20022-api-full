...
public class TransactionDetails27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionDetails27.mmTransactionActivity, TransactionDetails27.mmSettlementTransactionOrCorporateActionEventType, TransactionDetails27.mmSecuritiesMovementType,
						TransactionDetails27.mmPayment, TransactionDetails27.mmSettlementParameters, TransactionDetails27.mmPlaceOfTrade, TransactionDetails27.mmSafekeepingPlace, TransactionDetails27.mmPlaceOfClearing,
						TransactionDetails27.mmFinancialInstrumentIdentification, TransactionDetails27.mmPostingQuantity, TransactionDetails27.mmPostingAmount, TransactionDetails27.mmTradeDate,
						TransactionDetails27.mmExpectedSettlementDate, TransactionDetails27.mmSettlementDate, TransactionDetails27.mmLateDeliveryDate, TransactionDetails27.mmExpectedValueDate,
						TransactionDetails27.mmDeliveringSettlementParties, TransactionDetails27.mmReceivingSettlementParties, TransactionDetails27.mmTransactionAdditionalDetails, TransactionDetails27.mmSupplementaryData);
