...
public class GenericDocumentIdentification2 {
	...
	public static final MMMessageAssociationEnd mmMessageNumber = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> GenericDocumentIdentification2.mmObject();
			isDerived = false;
			xmlTag = "MsgNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GenericDocumentIdentification2.mmMessageNumber, GenericDocumentIdentification2.mmIdentification);
