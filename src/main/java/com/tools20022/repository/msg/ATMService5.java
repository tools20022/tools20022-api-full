...
@XmlType(name = "ATMService5", propOrder = {"serviceReference", "aTMServiceCode", "serviceType"})
public class ATMService5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ATMService5, Optional<Max35Text>> mmServiceReference = new MMMessageAttribute<ATMService5, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMService5.mmObject();
			isDerived = false;
			xmlTag = "SvcRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ServiceReference";
			definition = "Unique identification of the withdrawal service provided by the ATM inside the session.";
			nextVersions_lazy = () -> Arrays.asList(ATMService8.mmServiceReference);
			previousVersion_lazy = () -> ATMService3.mmServiceReference;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(ATMService5 obj) {
			return obj.getServiceReference();
		}

		@Override
		public void setValue(ATMService5 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ATMService5, Optional<Max35Text>> mmATMServiceCode = new MMMessageAttribute<ATMService5, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMService5.mmObject();
			isDerived = false;
			xmlTag = "ATMSvcCd";
			...
			nextVersions_lazy = () -> Arrays.asList(ATMService8.mmATMServiceCode);
			previousVersion_lazy = () -> ATMService3.mmATMServiceCode;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ATMService5, ATMServiceType3Code> mmServiceType = new MMMessageAttribute<ATMService5, ATMServiceType3Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.ATMService5.mmObject();
			isDerived = false;
			xmlTag = "SvcTp";
			...
			nextVersions_lazy = () -> Arrays.asList(ATMService7.mmServiceType, ATMService8.mmServiceType);
			previousVersion_lazy = () -> ATMService3.mmServiceType;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ATMServiceType3Code getValue(ATMService5 obj) {
			return obj.getServiceType();
		}

		@Override
		public void setValue(ATMService5 obj, ATMServiceType3Code value) {
	...
	public ATMService5 setServiceReference(Max35Text serviceReference) {
	...
	public ATMService5 setATMServiceCode(Max35Text aTMServiceCode) {
	...
	public ATMService5 setServiceType(ATMServiceType3Code serviceType) {
