...
public class SubAccountIdentification32 {
	...
	protected List<com.tools20022.repository.msg.AggregateBalanceInformation24> balanceForSubAccount;
	/**
	...
	public static final MMMessageAssociationEnd mmBalanceForSubAccount = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation24.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification32.mmAccountOwner, SubAccountIdentification32.mmSafekeepingAccount, SubAccountIdentification32.mmActivityIndicator,
						SubAccountIdentification32.mmBalanceForSubAccount);
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation24> balanceForSubAccount) {
