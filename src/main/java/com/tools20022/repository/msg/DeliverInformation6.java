 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forDeliverInformation6
 * ConstraintPhysicalTransferDetailsRule.forDeliverInformation6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule#forDeliverInformation6
 * ConstraintDeliverersCustodianDetailsRule.forDeliverInformation6}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule#forDeliverInformation6
 * ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation6}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "DeliverInformation6", propOrder = {"effectiveSettlementDate", "settlementAmount", "stampDuty", "netAmount", "chargeDetails", "commissionDetails", "taxDetails", "settlementPartiesDetails", "physicalTransfer",
...
public class DeliverInformation6 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation6, Optional<DateAndDateTimeChoice>> mmEffectiveSettlementDate = new MMMessageAttribute<DeliverInformation6, Optional<DateAndDateTimeChoice>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation6.mmObject();
			isDerived = false;
			xmlTag = "FctvSttlmDt";
		...
		@Override
		public Optional<DateAndDateTimeChoice> getValue(DeliverInformation6 obj) {
			return obj.getEffectiveSettlementDate();
		}

		@Override
		public void setValue(DeliverInformation6 obj, Optional<DateAndDateTimeChoice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation6, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<DeliverInformation6, Optional<ActiveCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(DeliverInformation6 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(DeliverInformation6 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation6, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<DeliverInformation6, Optional<StampDutyType2Code>>() {
		{
		...
		@Override
		public Optional<StampDutyType2Code> getValue(DeliverInformation6 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(DeliverInformation6 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation6, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<DeliverInformation6, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation6, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<DeliverInformation6, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(DeliverInformation6 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(DeliverInformation6 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation6, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<DeliverInformation6, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(DeliverInformation6 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(DeliverInformation6 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation6, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<DeliverInformation6, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(DeliverInformation6 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(DeliverInformation6 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation6, DeliveringPartiesAndAccount8> mmSettlementPartiesDetails = new MMMessageAssociationEnd<DeliverInformation6, DeliveringPartiesAndAccount8>() {
		{
		...
		@Override
		public DeliveringPartiesAndAccount8 getValue(DeliverInformation6 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(DeliverInformation6 obj, DeliveringPartiesAndAccount8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation6, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<DeliverInformation6, Optional<PhysicalTransferType1Code>>() {
		{
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(DeliverInformation6 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(DeliverInformation6 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation6, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<DeliverInformation6, Optional<DeliveryParameters4>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters4> getValue(DeliverInformation6 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(DeliverInformation6 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation6.mmEffectiveSettlementDate, com.tools20022.repository.msg.DeliverInformation6.mmSettlementAmount,
						com.tools20022.repository.msg.DeliverInformation6.mmStampDuty, com.tools20022.repository.msg.DeliverInformation6.mmNetAmount, com.tools20022.repository.msg.DeliverInformation6.mmChargeDetails,
						com.tools20022.repository.msg.DeliverInformation6.mmCommissionDetails, com.tools20022.repository.msg.DeliverInformation6.mmTaxDetails, com.tools20022.repository.msg.DeliverInformation6.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.DeliverInformation6.mmPhysicalTransfer, com.tools20022.repository.msg.DeliverInformation6.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInConfirmationV03.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forDeliverInformation6,
						com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule.forDeliverInformation6, com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation6);
	...
	public DeliverInformation6 setEffectiveSettlementDate(DateAndDateTimeChoice effectiveSettlementDate) {
	...
	public DeliverInformation6 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public DeliverInformation6 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public DeliverInformation6 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public DeliverInformation6 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public DeliverInformation6 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public DeliverInformation6 setTaxDetails(List<Tax15> taxDetails) {
	...
	public DeliverInformation6 setSettlementPartiesDetails(DeliveringPartiesAndAccount8 settlementPartiesDetails) {
	...
	public DeliverInformation6 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public DeliverInformation6 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
