...
public class CorporateActionGeneralInformation63 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation63.mmCorporateActionEventIdentification, CorporateActionGeneralInformation63.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation63.mmClassActionNumber, CorporateActionGeneralInformation63.mmEventType, CorporateActionGeneralInformation63.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation63.mmFinancialInstrumentIdentification);
