...
public class AmountAndDirection26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection26.mmAmount, AmountAndDirection26.mmCreditDebitIndicator, AmountAndDirection26.mmForeignExchangeDetails);
