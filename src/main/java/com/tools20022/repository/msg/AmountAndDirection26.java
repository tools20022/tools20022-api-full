 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forAmountAndDirection26
 * ConstraintCoexistenceAmountRule.forAmountAndDirection26}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "AmountAndDirection26", propOrder = {"amount", "creditDebitIndicator", "foreignExchangeDetails"})
public class AmountAndDirection26 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forAmountAndDirection26);
	...
	public AmountAndDirection26 setAmount(RestrictedFINActiveOrHistoricCurrencyAndAmount amount) {
	...
	public AmountAndDirection26 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
