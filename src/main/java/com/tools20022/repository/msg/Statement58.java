 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Statement58#mmQueryReference
 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.Statement36
 * Statement36}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Statement58", propOrder = {"queryReference", "reportIdentification", "historicData", "activityIndicator", "subAccountIndicator"})
public class Statement58 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement36#mmQueryReference
	...
	public static final MMMessageAttribute<Statement58, Optional<Max35Text>> mmQueryReference = new MMMessageAttribute<Statement58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Statement36.mmQueryReference;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute<Statement58, Optional<Max35Text>> mmReportIdentification = new MMMessageAttribute<Statement58, Optional<Max35Text>>() {
		{
			...
			previousVersion_lazy = () -> Statement36.mmReportIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Statement36#mmHistoricData
	...
	public static final MMMessageAttribute<Statement58, TrueFalseIndicator> mmHistoricData = new MMMessageAttribute<Statement58, TrueFalseIndicator>() {
		{
			...
			previousVersion_lazy = () -> Statement36.mmHistoricData;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<Statement58, YesNoIndicator> mmActivityIndicator = new MMMessageAttribute<Statement58, YesNoIndicator>() {
		{
			...
			previousVersion_lazy = () -> Statement36.mmActivityIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<Statement58, YesNoIndicator> mmSubAccountIndicator = new MMMessageAttribute<Statement58, YesNoIndicator>() {
		{
			...
			previousVersion_lazy = () -> Statement36.mmSubAccountIndicator;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Statement58.mmQueryReference, com.tools20022.repository.msg.Statement58.mmReportIdentification,
						com.tools20022.repository.msg.Statement58.mmHistoricData, com.tools20022.repository.msg.Statement58.mmActivityIndicator, com.tools20022.repository.msg.Statement58.mmSubAccountIndicator);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintReportNumberRule.forStatement58);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Statement58";
				definition = "Characteristics of the report.";
				previousVersion_lazy = () -> Statement36.mmObject();
			}
		});
	...
	public Statement58 setQueryReference(Max35Text queryReference) {
	...
	public Statement58 setReportIdentification(Max35Text reportIdentification) {
	...
	public Statement58 setHistoricData(TrueFalseIndicator historicData) {
	...
	public Statement58 setActivityIndicator(YesNoIndicator activityIndicator) {
	...
	public Statement58 setSubAccountIndicator(YesNoIndicator subAccountIndicator) {
