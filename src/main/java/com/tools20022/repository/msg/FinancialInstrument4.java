 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrument4#mmIdentification
 * FinancialInstrument4.mmIdentification}</li>
 * <li>{@linkplain com.tools20022.repository.msg.FinancialInstrument4#mmName
 * FinancialInstrument4.mmName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.FinancialInstrument4#mmSupplementaryIdentification
 * FinancialInstrument4.mmSupplementaryIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintFinancialInstrumentdentificationGuideline#forFinancialInstrument4
 * ConstraintFinancialInstrumentdentificationGuideline.forFinancialInstrument4}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "FinancialInstrument4", propOrder = {"identification", "name", "supplementaryIdentification", "securitiesForm", "classType", "distributionPolicy"})
public class FinancialInstrument4 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintFinancialInstrumentdentificationGuideline.forFinancialInstrument4);
	...
	public FinancialInstrument4 setIdentification(SecurityIdentification1Choice identification) {
	...
	public FinancialInstrument4 setName(Max350Text name) {
		this.name = name;
		return this;
	}
	...
	public FinancialInstrument4 setSupplementaryIdentification(Max35Text supplementaryIdentification) {
	...
	public FinancialInstrument4 setSecuritiesForm(FormOfSecurity1Code securitiesForm) {
	...
	public FinancialInstrument4 setClassType(Max35Text classType) {
	...
	public FinancialInstrument4 setDistributionPolicy(DistributionPolicy1Code distributionPolicy) {
