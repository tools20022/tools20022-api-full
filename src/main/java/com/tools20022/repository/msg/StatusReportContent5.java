	...
	public static final MMMessageAssociationEnd mmPOICapabilities = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmPOICapabilities);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmPOICapabilities;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmPOIComponent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmPOIComponent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmPOIComponent;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAttendanceContext = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmAttendanceContext);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmPOIDateTime = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmPOIDateTime);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmPOIDateTime;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmDataSetRequired = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmDataSetRequired);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmDataSetRequired;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmEvent = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmEvent);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmEvent;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmErrors = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusReportContent6.mmErrors);
			previousVersion_lazy = () -> com.tools20022.repository.msg.StatusReportContent4.mmErrors;
			minOccurs = 0;
