...
public class CorporateActionPrice20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionPrice20.mmIndicativeOrMarketPrice, CorporateActionPrice20.mmExercisePrice, CorporateActionPrice20.mmIssuePrice,
						CorporateActionPrice20.mmGenericCashPriceReceivedPerProduct, CorporateActionPrice20.mmGenericCashPricePaidPerProduct);
