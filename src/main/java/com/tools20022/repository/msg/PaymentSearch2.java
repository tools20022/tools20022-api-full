...
public class PaymentSearch2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentSearch2.mmTransactionReference, PaymentSearch2.mmTransferValueDate, PaymentSearch2.mmInstructionReference, PaymentSearch2.mmInstructionStatus,
						PaymentSearch2.mmInstructedAmount, PaymentSearch2.mmInstructedAmountCurrency, PaymentSearch2.mmCreditDebitIndicator, PaymentSearch2.mmInterbankSettlementAmount, PaymentSearch2.mmInterbankSettlementAmountCurrency,
						PaymentSearch2.mmPaymentMethod, PaymentSearch2.mmPriority, PaymentSearch2.mmProcessingValidityTime, PaymentSearch2.mmInstruction, PaymentSearch2.mmPaymentType, PaymentSearch2.mmPaymentInstructionReference,
						PaymentSearch2.mmInterbankValueDate, PaymentSearch2.mmRelatedReference, PaymentSearch2.mmPaymentTransactionParty);
