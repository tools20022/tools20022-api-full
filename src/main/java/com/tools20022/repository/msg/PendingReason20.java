...
import com.tools20022.repository.choice.PendingReason37Choice;
...
@XmlType(name = "PendingReason20", propOrder = {"code", "additionalReasonInformation"})
public class PendingReason20 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PendingReason37Choice code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PendingReason20
	 * PendingReason20}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingReason20, PendingReason37Choice> mmCode = new MMMessageAssociationEnd<PendingReason20, PendingReason37Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.PendingReason20.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PendingReason37Choice getValue(PendingReason20 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason20 obj, PendingReason37Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason20, Optional<RestrictedFINXMax210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<PendingReason20, Optional<RestrictedFINXMax210Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax210Text> getValue(PendingReason20 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(PendingReason20 obj, Optional<RestrictedFINXMax210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingReason20.mmCode, com.tools20022.repository.msg.PendingReason20.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason20";
	...
	public PendingReason37Choice getCode() {
		return code;
	}

	public PendingReason20 setCode(PendingReason37Choice code) {
	...
	public PendingReason20 setAdditionalReasonInformation(RestrictedFINXMax210Text additionalReasonInformation) {
