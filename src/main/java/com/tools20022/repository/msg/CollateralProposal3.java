...
public class CollateralProposal3 {
	...
	public static final MMMessageAssociationEnd mmVariationMargin = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> CollateralProposal3.mmObject();
			isDerived = false;
			xmlTag = "VartnMrgn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "VariationMargin";
			definition = "Provides details about the proposal for the variation margin.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralProposal4.mmVariationMargin);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmSegregatedIndependentAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CollateralProposal4.mmSegregatedIndependentAmount);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.CollateralMovement4.mmObject();
	...
	public void setVariationMargin(com.tools20022.repository.msg.CollateralMovement4 variationMargin) {
	...
	public void setSegregatedIndependentAmount(com.tools20022.repository.msg.CollateralMovement4 segregatedIndependentAmount) {
