...
public class CardPaymentTransaction11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentTransaction11.mmTransactionCapture, CardPaymentTransaction11.mmTransactionType, CardPaymentTransaction11.mmAdditionalService, CardPaymentTransaction11.mmServiceAttribute,
						CardPaymentTransaction11.mmMerchantCategoryCode, CardPaymentTransaction11.mmTransactionIdentification, CardPaymentTransaction11.mmOriginalTransaction, CardPaymentTransaction11.mmInitiatorTransactionIdentification,
						CardPaymentTransaction11.mmReconciliationIdentification, CardPaymentTransaction11.mmTransactionDetails, CardPaymentTransaction11.mmAdditionalTransactionData);
