 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.ATMCommand4
 * ATMCommand4}</li>
 * </ul>
 */
...
public class ATMCommand10 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMCommand4#mmType
	...
	public static final MMMessageAttribute mmType = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmType;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMCommand4#mmUrgency
	...
	public static final MMMessageAttribute mmUrgency = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmUrgency;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMCommand4#mmDateTime
	...
	public static final MMMessageAttribute mmDateTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmDateTime;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCommandIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmCommandIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMCommand4#mmReason
	...
	public static final MMMessageAttribute mmReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmReason;
			maxOccurs = 1;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ATMCommand4#mmTraceReason
	...
	public static final MMMessageAttribute mmTraceReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmTraceReason;
			minOccurs = 0;
			simpleType_lazy = () -> ATMCommandReason1Code.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmAdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCommandParameters = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ATMCommand4.mmCommandParameters;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> ATMCommand4.mmObject();
			}
		});
	...
	public ATMCommand10 setType(rATMCommand6Code type) {
	...
	public ATMCommand10 setCommandIdentification(com.tools20022.repository.msg.ATMCommandIdentification1 commandIdentification) {
