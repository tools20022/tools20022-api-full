...
public class RateTypeAndAmountAndStatus31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus31.mmRateType, RateTypeAndAmountAndStatus31.mmAmount, RateTypeAndAmountAndStatus31.mmRateStatus);
