...
@XmlType(name = "AccountIdentification32", propOrder = {"safekeepingAccount", "accountOwner", "safekeepingPlace", "confirmedBalance"})
public class AccountIdentification32 {
	...
	public static final MMMessageAttribute<AccountIdentification32, Max35Text> mmSafekeepingAccount = new MMMessageAttribute<AccountIdentification32, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> AccountIdentification18.mmSafekeepingAccount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<AccountIdentification32, Optional<PartyIdentification92Choice>> mmAccountOwner = new MMMessageAssociationEnd<AccountIdentification32, Optional<PartyIdentification92Choice>>() {
		{
			...
			previousVersion_lazy = () -> AccountIdentification18.mmAccountOwner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<AccountIdentification32, Optional<SafekeepingPlaceFormat8Choice>> mmSafekeepingPlace = new MMMessageAssociationEnd<AccountIdentification32, Optional<SafekeepingPlaceFormat8Choice>>() {
		{
			...
			previousVersion_lazy = () -> AccountIdentification18.mmSafekeepingPlace;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<AccountIdentification32, BalanceFormat5Choice> mmConfirmedBalance = new MMMessageAssociationEnd<AccountIdentification32, BalanceFormat5Choice>() {
		{
			...
			previousVersion_lazy = () -> AccountIdentification18.mmConfirmedBalance;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountIdentification32.mmSafekeepingAccount, com.tools20022.repository.msg.AccountIdentification32.mmAccountOwner,
						com.tools20022.repository.msg.AccountIdentification32.mmSafekeepingPlace, com.tools20022.repository.msg.AccountIdentification32.mmConfirmedBalance);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSafekeepingPlaceRule.forAccountIdentification32);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountIdentification32";
				definition = "Provides account identification information.";
				previousVersion_lazy = () -> AccountIdentification18.mmObject();
			}
		});
	...
	public AccountIdentification32 setSafekeepingAccount(Max35Text safekeepingAccount) {
	...
	public AccountIdentification32 setAccountOwner(PartyIdentification92Choice accountOwner) {
	...
	public AccountIdentification32 setSafekeepingPlace(SafekeepingPlaceFormat8Choice safekeepingPlace) {
	...
	public AccountIdentification32 setConfirmedBalance(BalanceFormat5Choice confirmedBalance) {
