...
@XmlType(name = "SettlementDetails92", propOrder = {"holdIndicator", "settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "registration", "beneficialOwnership", "cashClearingSystem", "taxCapacity",
...
public class SettlementDetails92 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails92, Optional<HoldIndicator6>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails92, Optional<HoldIndicator6>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails92.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "HoldIndicator";
			definition = "Specifies whether the transaction is on hold/blocked/frozen.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmHoldIndicator);
			previousVersion_lazy = () -> SettlementDetails74.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<HoldIndicator6> getValue(SettlementDetails92 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<HoldIndicator6> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, List<SettlementTransactionCondition16Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails92, List<SettlementTransactionCondition16Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails74.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition16Choice> getValue(SettlementDetails92 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails92 obj, List<SettlementTransactionCondition16Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<SettlingCapacity7Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails92, Optional<SettlingCapacity7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails74.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity7Choice> getValue(SettlementDetails92 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<SettlingCapacity7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<GenericIdentification30>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails92, Optional<GenericIdentification30>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails74.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification30> getValue(SettlementDetails92 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<SecuritiesRTGS4Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails92, Optional<SecuritiesRTGS4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails74.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS4Choice> getValue(SettlementDetails92 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<SecuritiesRTGS4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<Registration9Choice>> mmRegistration = new MMMessageAssociationEnd<SettlementDetails92, Optional<Registration9Choice>>() {
		{
			...
			name = "Registration";
			definition = "Specifies whether registration should occur upon receipt.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmRegistration);
			previousVersion_lazy = () -> SettlementDetails74.mmRegistration;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Registration9Choice> getValue(SettlementDetails92 obj) {
			return obj.getRegistration();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<Registration9Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<BeneficialOwnership4Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails92, Optional<BeneficialOwnership4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails74.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership4Choice> getValue(SettlementDetails92 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<BeneficialOwnership4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<CashSettlementSystem4Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails92, Optional<CashSettlementSystem4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails74.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem4Choice> getValue(SettlementDetails92 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<CashSettlementSystem4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<TaxCapacityParty4Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails92, Optional<TaxCapacityParty4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails74.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty4Choice> getValue(SettlementDetails92 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<TaxCapacityParty4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<RepurchaseType12Choice>> mmRepurchaseType = new MMMessageAssociationEnd<SettlementDetails92, Optional<RepurchaseType12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmRepurchaseType);
			previousVersion_lazy = () -> SettlementDetails74.mmRepurchaseType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RepurchaseType12Choice> getValue(SettlementDetails92 obj) {
			return obj.getRepurchaseType();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<RepurchaseType12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<MarketClientSide4Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails92, Optional<MarketClientSide4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails74.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide4Choice> getValue(SettlementDetails92 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<MarketClientSide4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<BlockTrade4Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails92, Optional<BlockTrade4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails74.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade4Choice> getValue(SettlementDetails92 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<BlockTrade4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<Restriction5Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails92, Optional<Restriction5Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails74.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction5Choice> getValue(SettlementDetails92 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<Restriction5Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<SettlementSystemMethod4Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails92, Optional<SettlementSystemMethod4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails74.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod4Choice> getValue(SettlementDetails92 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<SettlementSystemMethod4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<NettingEligibility4Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails92, Optional<NettingEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails74.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility4Choice> getValue(SettlementDetails92 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<NettingEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<CentralCounterPartyEligibility4Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails92, Optional<CentralCounterPartyEligibility4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails74.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility4Choice> getValue(SettlementDetails92 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<CentralCounterPartyEligibility4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails92, Optional<LetterOfGuarantee4Choice>> mmLetterOfGuarantee = new MMMessageAssociationEnd<SettlementDetails92, Optional<LetterOfGuarantee4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmLetterOfGuarantee);
			previousVersion_lazy = () -> SettlementDetails74.mmLetterOfGuarantee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<LetterOfGuarantee4Choice> getValue(SettlementDetails92 obj) {
			return obj.getLetterOfGuarantee();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<LetterOfGuarantee4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails92, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails92, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails92.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails74.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails92 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails92 obj, Optional<SettlementTransactionCondition5Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails92.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails92.mmSettlementTransactionCondition,
						com.tools20022.repository.msg.SettlementDetails92.mmSettlingCapacity, com.tools20022.repository.msg.SettlementDetails92.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails92.mmSecuritiesRTGS,
						com.tools20022.repository.msg.SettlementDetails92.mmRegistration, com.tools20022.repository.msg.SettlementDetails92.mmBeneficialOwnership, com.tools20022.repository.msg.SettlementDetails92.mmCashClearingSystem,
						com.tools20022.repository.msg.SettlementDetails92.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails92.mmRepurchaseType, com.tools20022.repository.msg.SettlementDetails92.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails92.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails92.mmLegalRestrictions, com.tools20022.repository.msg.SettlementDetails92.mmSettlementSystemMethod,
						com.tools20022.repository.msg.SettlementDetails92.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails92.mmCCPEligibility, com.tools20022.repository.msg.SettlementDetails92.mmLetterOfGuarantee,
						com.tools20022.repository.msg.SettlementDetails92.mmPartialSettlementIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails92,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails92);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails92";
				definition = "Details of settlement of a transaction.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails127.mmObject());
				previousVersion_lazy = () -> SettlementDetails74.mmObject();
			}
		});
	...
	public SettlementDetails92 setHoldIndicator(HoldIndicator6 holdIndicator) {
	...
	public SettlementDetails92 setSettlementTransactionCondition(List<SettlementTransactionCondition16Choice> settlementTransactionCondition) {
	...
	public SettlementDetails92 setSettlingCapacity(SettlingCapacity7Choice settlingCapacity) {
	...
	public SettlementDetails92 setStampDutyTaxBasis(GenericIdentification30 stampDutyTaxBasis) {
	...
	public SettlementDetails92 setSecuritiesRTGS(SecuritiesRTGS4Choice securitiesRTGS) {
	...
	public SettlementDetails92 setRegistration(Registration9Choice registration) {
	...
	public SettlementDetails92 setBeneficialOwnership(BeneficialOwnership4Choice beneficialOwnership) {
	...
	public SettlementDetails92 setCashClearingSystem(CashSettlementSystem4Choice cashClearingSystem) {
	...
	public SettlementDetails92 setTaxCapacity(TaxCapacityParty4Choice taxCapacity) {
	...
	public SettlementDetails92 setRepurchaseType(RepurchaseType12Choice repurchaseType) {
	...
	public SettlementDetails92 setMarketClientSide(MarketClientSide4Choice marketClientSide) {
	...
	public SettlementDetails92 setBlockTrade(BlockTrade4Choice blockTrade) {
	...
	public SettlementDetails92 setLegalRestrictions(Restriction5Choice legalRestrictions) {
	...
	public SettlementDetails92 setSettlementSystemMethod(SettlementSystemMethod4Choice settlementSystemMethod) {
	...
	public SettlementDetails92 setNettingEligibility(NettingEligibility4Choice nettingEligibility) {
	...
	public SettlementDetails92 setCCPEligibility(CentralCounterPartyEligibility4Choice cCPEligibility) {
	...
	public SettlementDetails92 setLetterOfGuarantee(LetterOfGuarantee4Choice letterOfGuarantee) {
	...
	public SettlementDetails92 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
