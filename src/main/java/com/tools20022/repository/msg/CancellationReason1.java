...
@XmlType(name = "CancellationReason1", propOrder = {"code", "additionalReasonInformation"})
public class CancellationReason1 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CancellationReason1, CancellationReason5Choice> mmCode = new MMMessageAssociationEnd<CancellationReason1, CancellationReason5Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.CancellationReason1.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason12.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CancellationReason5Choice getValue(CancellationReason1 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancellationReason1 obj, CancellationReason5Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationReason1, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<CancellationReason1, Optional<Max210Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason12.mmAdditionalReasonInformation);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max210Text> getValue(CancellationReason1 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(CancellationReason1 obj, Optional<Max210Text> value) {
	...
	public CancellationReason1 setCode(CancellationReason5Choice code) {
	...
	public CancellationReason1 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
