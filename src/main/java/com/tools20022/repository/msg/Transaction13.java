...
public class Transaction13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction13.mmAccountOwnerTransactionIdentification, Transaction13.mmAccountServicerTransactionIdentification, Transaction13.mmMarketInfrastructureTransactionIdentification,
						Transaction13.mmProcessorTransactionIdentification, Transaction13.mmTradeIdentification, Transaction13.mmPoolIdentification, Transaction13.mmCommonIdentification, Transaction13.mmCorporateActionEventIdentification,
						Transaction13.mmTripartyAgentCollateralTransactionIdentification, Transaction13.mmClientTripartyCollateralTransactionIdentification, Transaction13.mmTransactionDetails, Transaction13.mmSupplementaryData);
