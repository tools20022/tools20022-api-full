...
public class Transaction13 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction13.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	public TransactionDetails24 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails24 transactionDetails) {
