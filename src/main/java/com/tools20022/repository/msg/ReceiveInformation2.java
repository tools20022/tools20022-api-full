...
public class ReceiveInformation2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ReceiveInformation2.ChargeDetails, com.tools20022.repository.msg.ReceiveInformation2.TaxDetails,
						com.tools20022.repository.msg.ReceiveInformation2.SettlementPartiesDetails, com.tools20022.repository.msg.ReceiveInformation2.PhysicalTransferIndicator,
						com.tools20022.repository.msg.ReceiveInformation2.PhysicalTransferDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutConfirmation.SettlementDetails);
