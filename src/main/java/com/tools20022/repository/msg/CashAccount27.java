...
public class CashAccount27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashAccount27.mmIdentification, CashAccount27.mmType, CashAccount27.mmCurrency, CashAccount27.mmName, CashAccount27.mmOwner, CashAccount27.mmServicer);
