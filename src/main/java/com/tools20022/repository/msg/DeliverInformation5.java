...
import com.tools20022.repository.area.sese.TransferInInstructionV03;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.TransferInInstructionV03#mmSettlementDetails
 * TransferInInstructionV03.mmSettlementDetails}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule#forDeliverInformation5
 * ConstraintPhysicalTransferDetailsRule.forDeliverInformation5}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule#forDeliverInformation5
 * ConstraintDeliverersCustodianDetailsRule.forDeliverInformation5}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule#forDeliverInformation5
 * ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation5}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DeliverInformation9
...
@XmlType(name = "DeliverInformation5", propOrder = {"settlementAmount", "stampDuty", "netAmount", "settlementPartiesDetails", "chargeDetails", "commissionDetails", "taxDetails", "physicalTransfer", "physicalTransferDetails"})
public class DeliverInformation5 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation5, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<DeliverInformation5, Optional<ActiveCurrencyAndAmount>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementAmount;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation5.mmObject();
			isDerived = false;
			xmlTag = "SttlmAmt";
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(DeliverInformation5 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(DeliverInformation5 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation5, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<DeliverInformation5, Optional<StampDutyType2Code>>() {
		{
		...
		@Override
		public Optional<StampDutyType2Code> getValue(DeliverInformation5 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(DeliverInformation5 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation5, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<DeliverInformation5, Optional<ActiveCurrencyAndAmount>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation5, DeliveringPartiesAndAccount8> mmSettlementPartiesDetails = new MMMessageAssociationEnd<DeliverInformation5, DeliveringPartiesAndAccount8>() {
		{
		...
		@Override
		public DeliveringPartiesAndAccount8 getValue(DeliverInformation5 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(DeliverInformation5 obj, DeliveringPartiesAndAccount8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation5, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<DeliverInformation5, List<Charge20>>() {
		{
		...
		@Override
		public List<Charge20> getValue(DeliverInformation5 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(DeliverInformation5 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation5, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<DeliverInformation5, List<Commission12>>() {
		{
		...
		@Override
		public List<Commission12> getValue(DeliverInformation5 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(DeliverInformation5 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation5, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<DeliverInformation5, List<Tax15>>() {
		{
		...
		@Override
		public List<Tax15> getValue(DeliverInformation5 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(DeliverInformation5 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation5, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<DeliverInformation5, Optional<PhysicalTransferType1Code>>() {
		{
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(DeliverInformation5 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(DeliverInformation5 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation5, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<DeliverInformation5, Optional<DeliveryParameters4>>() {
		{
		...
		@Override
		public Optional<DeliveryParameters4> getValue(DeliverInformation5 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(DeliverInformation5 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation5.mmSettlementAmount, com.tools20022.repository.msg.DeliverInformation5.mmStampDuty,
						com.tools20022.repository.msg.DeliverInformation5.mmNetAmount, com.tools20022.repository.msg.DeliverInformation5.mmSettlementPartiesDetails, com.tools20022.repository.msg.DeliverInformation5.mmChargeDetails,
						com.tools20022.repository.msg.DeliverInformation5.mmCommissionDetails, com.tools20022.repository.msg.DeliverInformation5.mmTaxDetails, com.tools20022.repository.msg.DeliverInformation5.mmPhysicalTransfer,
						com.tools20022.repository.msg.DeliverInformation5.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInInstructionV03.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forDeliverInformation5,
						com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule.forDeliverInformation5, com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation5);
				...
				name = "DeliverInformation5";
				definition = "Parameters applied to the settlement of a security transfer.";
				nextVersions_lazy = () -> Arrays.asList(DeliverInformation9.mmObject());
				previousVersion_lazy = () -> DeliverInformation3.mmObject();
			}
		});
	...
	public DeliverInformation5 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public DeliverInformation5 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public DeliverInformation5 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public DeliverInformation5 setSettlementPartiesDetails(DeliveringPartiesAndAccount8 settlementPartiesDetails) {
	...
	public DeliverInformation5 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public DeliverInformation5 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public DeliverInformation5 setTaxDetails(List<Tax15> taxDetails) {
	...
	public DeliverInformation5 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public DeliverInformation5 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
