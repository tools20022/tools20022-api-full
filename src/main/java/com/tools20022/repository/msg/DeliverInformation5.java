...
public class DeliverInformation5 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation5.mmSettlementAmount, DeliverInformation5.mmStampDuty, DeliverInformation5.mmNetAmount, DeliverInformation5.mmSettlementPartiesDetails,
						DeliverInformation5.mmChargeDetails, DeliverInformation5.mmCommissionDetails, DeliverInformation5.mmTaxDetails, DeliverInformation5.mmPhysicalTransfer, DeliverInformation5.mmPhysicalTransferDetails);
