...
@XmlType(name = "ProprietaryReason4", propOrder = {"reason", "additionalReasonInformation"})
public class ProprietaryReason4 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn")
	protected GenericIdentification30 reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.ProprietaryReason1#mmReason
	...
	public static final MMMessageAttribute<ProprietaryReason4, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<ProprietaryReason4, Optional<Max210Text>>() {
		{
			...
			previousVersion_lazy = () -> ProprietaryReason1.mmAdditionalReasonInformation;
			maxOccurs = 1;
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ProprietaryReason4.mmReason, com.tools20022.repository.msg.ProprietaryReason4.mmAdditionalReasonInformation);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forProprietaryReason4);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ProprietaryReason4";
				definition = "Proprietary identification of the reason related to a status.";
				previousVersion_lazy = () -> ProprietaryReason1.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public Optional<GenericIdentification30> getReason() {
	...
	public ProprietaryReason4 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
