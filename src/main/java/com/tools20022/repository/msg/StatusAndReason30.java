 ...
 * <li>{@linkplain com.tools20022.repository.msg.StatusAndReason30#Transaction
 * StatusAndReason30.Transaction}</li>
 * </ul>
 * </li>
...
public class StatusAndReason30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.StatusAndReason30.StatusAndReason, com.tools20022.repository.msg.StatusAndReason30.Transaction);
				trace_lazy = () -> Status.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V07.Status);
