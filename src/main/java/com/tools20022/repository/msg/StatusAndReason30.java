...
public class StatusAndReason30 {
	...
	public static final MMMessageAssociationEnd mmStatusAndReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> StatusAndReason30.mmObject();
			isDerived = false;
			xmlTag = "StsAndRsn";
	...
	protected List<com.tools20022.repository.msg.Transaction48> transaction;
	/**
	...
	public static final MMMessageAssociationEnd mmTransaction = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Transaction48.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPendingReport002V07.mmStatus);
	...
	public void setTransaction(List<com.tools20022.repository.msg.Transaction48> transaction) {
