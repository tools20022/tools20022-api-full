...
public class Limits5 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Limits4#CurrentLimit
	...
	public static final MMMessageAssociationEnd CurrentLimit = new MMMessageAssociationEnd() {
		{
			...
			name = "CurrentLimit";
			definition = "Report is given for a current risk management type limit.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.Limits4.CurrentLimit;
			minOccurs = 0;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.Limits4#DefaultLimit
	...
	public static final MMMessageAssociationEnd DefaultLimit = new MMMessageAssociationEnd() {
		{
			...
			name = "DefaultLimit";
			definition = "Report is given for a default risk management type limit.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.Limits4.DefaultLimit;
			minOccurs = 0;
			type_lazy = () -> LimitReport5.mmObject();
			isComposite = true;
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Limits5.CurrentLimit, com.tools20022.repository.msg.Limits5.DefaultLimit);
