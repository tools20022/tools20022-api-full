...
public class CorporateActionRate30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionRate30.mmAdditionalTax, CorporateActionRate30.mmGrossDividendRate, CorporateActionRate30.mmNetDividendRate, CorporateActionRate30.mmIndexFactor,
						CorporateActionRate30.mmInterestRateUsedForPayment, CorporateActionRate30.mmMaximumAllowedOversubscriptionRate, CorporateActionRate30.mmProrationRate, CorporateActionRate30.mmWithholdingTaxRate,
						CorporateActionRate30.mmWithholdingOfForeignTax, CorporateActionRate30.mmTaxRelatedRate, CorporateActionRate30.mmTaxableIncomePerDividendShare);
