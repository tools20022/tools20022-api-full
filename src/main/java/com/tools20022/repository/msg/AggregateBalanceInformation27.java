...
public class AggregateBalanceInformation27 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AggregateBalanceInformation27.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	public void setQuantityBreakdown(List<com.tools20022.repository.msg.QuantityBreakdown25> quantityBreakdown) {
	...
	public void setBalanceAtSafekeepingPlace(List<com.tools20022.repository.msg.AggregateBalancePerSafekeepingPlace26> balanceAtSafekeepingPlace) {
