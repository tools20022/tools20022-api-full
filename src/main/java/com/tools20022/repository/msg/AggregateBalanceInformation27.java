...
public class AggregateBalanceInformation27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AggregateBalanceInformation27.mmFinancialInstrumentIdentification, AggregateBalanceInformation27.mmFinancialInstrumentAttributes,
						AggregateBalanceInformation27.mmInvestmentFundsFinancialInstrumentAttributes, AggregateBalanceInformation27.mmAdditionalDerivativeAttributes, AggregateBalanceInformation27.mmAggregateBalance,
						AggregateBalanceInformation27.mmSafekeepingPlace, AggregateBalanceInformation27.mmCorporateActionOptionType, AggregateBalanceInformation27.mmPriceDetails, AggregateBalanceInformation27.mmForeignExchangeDetails,
						AggregateBalanceInformation27.mmDaysAccrued, AggregateBalanceInformation27.mmAccountBaseCurrencyAmounts, AggregateBalanceInformation27.mmInstrumentCurrencyAmounts,
						AggregateBalanceInformation27.mmAlternateReportingCurrencyAmounts, AggregateBalanceInformation27.mmQuantityBreakdown, AggregateBalanceInformation27.mmBalanceBreakdown,
						AggregateBalanceInformation27.mmAdditionalBalanceBreakdown, AggregateBalanceInformation27.mmBalanceAtSafekeepingPlace, AggregateBalanceInformation27.mmHoldingAdditionalDetails,
						AggregateBalanceInformation27.mmSupplementaryData);
