...
@XmlType(name = "CorporateActionOption39", propOrder = {"optionNumber", "optionType", "securitiesMovementDetails", "cashMovementDetails"})
public class CorporateActionOption39 {
	...
	public CorporateActionOption39 setOptionNumber(OptionNumber1Choice optionNumber) {
	...
	public CorporateActionOption39 setOptionType(CorporateActionOption11Choice optionType) {
