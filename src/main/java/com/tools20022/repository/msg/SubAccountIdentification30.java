...
public class SubAccountIdentification30 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification30.mmAccountOwner, SubAccountIdentification30.mmSafekeepingAccount, SubAccountIdentification30.mmActivityIndicator,
						SubAccountIdentification30.mmFinancialInstrumentDetails);
