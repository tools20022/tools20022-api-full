 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubAccountIdentification30#AccountOwner
 * SubAccountIdentification30.AccountOwner}</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.SubAccountIdentification30#ActivityIndicator
 * SubAccountIdentification30.ActivityIndicator}</li>
 * <li>
...
public class SubAccountIdentification30 {
	...
	public static final MMMessageAssociationEnd AccountOwner = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> SubAccountIdentification30.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification34.AccountOwner);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SafekeepingAccount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification34.SafekeepingAccount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ActivityIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification34.ActivityIndicator);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FinancialInstrumentDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification34.FinancialInstrumentDetails);
			minOccurs = 0;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SubAccountIdentification30.AccountOwner, com.tools20022.repository.msg.SubAccountIdentification30.SafekeepingAccount,
						com.tools20022.repository.msg.SubAccountIdentification30.ActivityIndicator, com.tools20022.repository.msg.SubAccountIdentification30.FinancialInstrumentDetails);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.semt.SecuritiesTransactionPostingReportV04.SubAccountDetails);
