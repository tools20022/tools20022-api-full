...
public class MarketIdentification91 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> MarketIdentification91.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MarketIdentification91.mmIdentification, MarketIdentification91.mmType);
	...
	public void setType(MarketType17Choice type) {
		this.type = type;
	}
}