...
public class GenericIdentification23 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification23.Identification, com.tools20022.repository.msg.GenericIdentification23.Issuer,
						com.tools20022.repository.msg.GenericIdentification23.SchemeName);
