...
public class OriginalNotificationReference3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OriginalNotificationReference3.mmAccount, OriginalNotificationReference3.mmAccountOwner, OriginalNotificationReference3.mmAccountServicer,
						OriginalNotificationReference3.mmRelatedAccount, OriginalNotificationReference3.mmTotalAmount, OriginalNotificationReference3.mmExpectedValueDate, OriginalNotificationReference3.mmDebtor,
						OriginalNotificationReference3.mmDebtorAgent, OriginalNotificationReference3.mmIntermediaryAgent, OriginalNotificationReference3.mmOriginalItemAndStatus);
