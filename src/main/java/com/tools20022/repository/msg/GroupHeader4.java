...
public class GroupHeader4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader4.mmMessageIdentification, GroupHeader4.mmCreationDateTime, GroupHeader4.mmBatchBooking, GroupHeader4.mmNumberOfTransactions, GroupHeader4.mmControlSum,
						GroupHeader4.mmTotalInterbankSettlementAmount, GroupHeader4.mmInterbankSettlementDate, GroupHeader4.mmSettlementInformation, GroupHeader4.mmPaymentTypeInformation, GroupHeader4.mmInstructingAgent,
						GroupHeader4.mmInstructedAgent);
