...
public class AmountAndDirection24 {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AmountAndDirection24.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection24.mmAmount, AmountAndDirection24.mmCreditDebitIndicator, AmountAndDirection24.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection24.mmForeignExchangeDetails);
