...
public class PaymentTransaction74 {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction61#CancellationIdentification
	 * PaymentTransaction61.CancellationIdentification}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute CancellationIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.CancellationIdentification;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction61#Case
	...
	public static final MMMessageAssociationEnd Case = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.Case;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalInstructionIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalInstructionIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalEndToEndIdentification;
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OriginalInstructedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalInstructedAmount;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalRequestedExecutionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalRequestedExecutionDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute OriginalRequestedCollectionDate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalRequestedCollectionDate;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CancellationReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			definition = "Provides detailed information on the cancellation reason.";
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.CancellationReasonInformation;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd OriginalTransactionReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.OriginalTransactionReference;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction61#SupplementaryData
	 * PaymentTransaction61.SupplementaryData}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute SupplementaryData = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction61.SupplementaryData;
			minOccurs = 0;
