...
public class EventInformation8 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> EventInformation8.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation8.mmCorporateActionEventIdentification, EventInformation8.mmOfficialCorporateActionEventIdentification, EventInformation8.mmEventType,
						EventInformation8.mmMandatoryVoluntaryEventType, EventInformation8.mmLastNotificationIdentification);
	...
	public NotificationIdentification4 getLastNotificationIdentification() {
		return lastNotificationIdentification;
	}

	public void setLastNotificationIdentification(com.tools20022.repository.msg.NotificationIdentification4 lastNotificationIdentification) {
