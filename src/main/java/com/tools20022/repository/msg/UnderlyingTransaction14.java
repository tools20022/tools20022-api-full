		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(UnderlyingTransaction14.mmOriginalGroupInformationAndStatus, UnderlyingTransaction14.mmOriginalPaymentInformationAndStatus, UnderlyingTransaction14.mmTransactionInformationAndStatus);
