...
public class ForeignExchangeTerms16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms16.mmUnitCurrency, ForeignExchangeTerms16.mmQuotedCurrency, ForeignExchangeTerms16.mmExchangeRate, ForeignExchangeTerms16.mmQuotationDate,
						ForeignExchangeTerms16.mmQuotingInstitution);
