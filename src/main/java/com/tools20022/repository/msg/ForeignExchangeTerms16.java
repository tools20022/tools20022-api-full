 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms16#mmQuotingInstitution
 * ForeignExchangeTerms16.mmQuotingInstitution}</li>
 * </ul>
 * </li>
...
@XmlType(name = "ForeignExchangeTerms16", propOrder = {"unitCurrency", "quotedCurrency", "exchangeRate", "quotationDate", "quotingInstitution"})
public class ForeignExchangeTerms16 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms16
	 * ForeignExchangeTerms16}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms16, ActiveOrHistoricCurrencyCode> mmUnitCurrency = new MMMessageAttribute<ForeignExchangeTerms16, ActiveOrHistoricCurrencyCode>() {
		{
			businessElementTrace_lazy = () -> CurrencyExchange.mmUnitCurrency;
			componentContext_lazy = () -> com.tools20022.repository.msg.ForeignExchangeTerms16.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
		...
		@Override
		public ActiveOrHistoricCurrencyCode getValue(ForeignExchangeTerms16 obj) {
			return obj.getUnitCurrency();
		}

		@Override
		public void setValue(ForeignExchangeTerms16 obj, ActiveOrHistoricCurrencyCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms16, ActiveOrHistoricCurrencyCode> mmQuotedCurrency = new MMMessageAttribute<ForeignExchangeTerms16, ActiveOrHistoricCurrencyCode>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms16, BaseOneRate> mmExchangeRate = new MMMessageAttribute<ForeignExchangeTerms16, BaseOneRate>() {
		{
		...
		@Override
		public BaseOneRate getValue(ForeignExchangeTerms16 obj) {
			return obj.getExchangeRate();
		}

		@Override
		public void setValue(ForeignExchangeTerms16 obj, BaseOneRate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ForeignExchangeTerms16, Optional<ISODateTime>> mmQuotationDate = new MMMessageAttribute<ForeignExchangeTerms16, Optional<ISODateTime>>() {
		{
		...
		@Override
		public Optional<ISODateTime> getValue(ForeignExchangeTerms16 obj) {
			return obj.getQuotationDate();
		}

		@Override
		public void setValue(ForeignExchangeTerms16 obj, Optional<ISODateTime> value) {
			obj.setQuotationDate(value.orElse(null));
		}
	};
	@XmlElement(name = "QtgInstn")
	protected PartyIdentification59Choice quotingInstitution;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ForeignExchangeTerms16, Optional<PartyIdentification59Choice>> mmQuotingInstitution = new MMMessageAssociationEnd<ForeignExchangeTerms16, Optional<PartyIdentification59Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification59Choice> getValue(ForeignExchangeTerms16 obj) {
			return obj.getQuotingInstitution();
		}

		@Override
		public void setValue(ForeignExchangeTerms16 obj, Optional<PartyIdentification59Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ForeignExchangeTerms16.mmUnitCurrency, com.tools20022.repository.msg.ForeignExchangeTerms16.mmQuotedCurrency,
						com.tools20022.repository.msg.ForeignExchangeTerms16.mmExchangeRate, com.tools20022.repository.msg.ForeignExchangeTerms16.mmQuotationDate, com.tools20022.repository.msg.ForeignExchangeTerms16.mmQuotingInstitution);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms16";
	...
	public ForeignExchangeTerms16 setUnitCurrency(ActiveOrHistoricCurrencyCode unitCurrency) {
	...
	public ForeignExchangeTerms16 setQuotedCurrency(ActiveOrHistoricCurrencyCode quotedCurrency) {
	...
	public ForeignExchangeTerms16 setExchangeRate(BaseOneRate exchangeRate) {
	...
	public ForeignExchangeTerms16 setQuotationDate(ISODateTime quotationDate) {
		this.quotationDate = quotationDate;
		return this;
	}

	public Optional<PartyIdentification59Choice> getQuotingInstitution() {
		return quotingInstitution == null ? Optional.empty() : Optional.of(quotingInstitution);
	}

	public ForeignExchangeTerms16 setQuotingInstitution(PartyIdentification59Choice quotingInstitution) {
