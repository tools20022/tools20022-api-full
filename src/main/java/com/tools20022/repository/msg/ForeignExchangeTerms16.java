...
public class ForeignExchangeTerms16 {
	...
	public static final MMMessageAttribute mmUnitCurrency = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ForeignExchangeTerms16.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
	...
	public PartyIdentification59Choice getQuotingInstitution() {
		return quotingInstitution;
	}

	public void setQuotingInstitution(PartyIdentification59Choice quotingInstitution) {
