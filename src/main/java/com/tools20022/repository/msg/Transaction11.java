...
public class Transaction11 {
	...
	public static final MMMessageAssociationEnd mmTransactionDetails = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.TransactionDetails18.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction11.mmAccountOwnerTransactionIdentification, Transaction11.mmAccountServicerTransactionIdentification, Transaction11.mmMarketInfrastructureTransactionIdentification,
						Transaction11.mmTradeIdentification, Transaction11.mmPoolIdentification, Transaction11.mmCommonIdentification, Transaction11.mmCorporateActionEventIdentification,
						Transaction11.mmTripartyAgentCollateralTransactionIdentification, Transaction11.mmClientTripartyCollateralTransactionIdentification, Transaction11.mmTransactionDetails, Transaction11.mmExtension);
	...
	public TransactionDetails18 getTransactionDetails() {
		return transactionDetails;
	}

	public void setTransactionDetails(com.tools20022.repository.msg.TransactionDetails18 transactionDetails) {
