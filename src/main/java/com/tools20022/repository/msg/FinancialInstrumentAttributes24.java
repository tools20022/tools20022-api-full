...
public class FinancialInstrumentAttributes24 {
	...
	public static final MMMessageAssociationEnd mmSecurityIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentAttributes24.mmObject();
			isDerived = false;
			xmlTag = "SctyId";
	...
	public PriceFormat25Choice getIssuePrice() {
		return issuePrice;
	}

	public void setIssuePrice(PriceFormat25Choice issuePrice) {
