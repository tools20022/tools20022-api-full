	...
	public static final MMMessageAssociationEnd mmAdditionalQuantityForSubscribedResultantSecurities = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmAdditionalQuantityForSubscribedResultantSecurities;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAdditionalQuantityForExistingSecurities = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmAdditionalQuantityForExistingSecurities;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RatioFormat17Choice.mmObject();
	...
	public static final MMMessageAssociationEnd mmNewToOld = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmNewToOld;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmTransformationRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmTransformationRate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmChargesFees = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmChargesFees;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmFiscalStamp = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmFiscalStamp;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmApplicableRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmApplicableRate;
			maxOccurs = 1;
			minOccurs = 0;
			complexType_lazy = () -> RateFormat3Choice.mmObject();
		}
	...
	public static final MMMessageAttribute mmTaxCreditRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmTaxCreditRate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmFinancialTransactionTaxRate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateActionRate69.mmFinancialTransactionTaxRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> CorporateActionRate69.mmObject();
			}
		});
