...
public class SubscriptionInformation {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubscriptionInformation.mmDateOfFirstSubscription, SubscriptionInformation.mmEquityComponent, SubscriptionInformation.mmCashComponent,
						SubscriptionInformation.mmTotalAmountYearToDate);
