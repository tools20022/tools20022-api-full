...
public class RejectedStatusReason20 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason20.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason20.mmReasonCode, RejectedStatusReason20.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason19Choice reasonCode) {
