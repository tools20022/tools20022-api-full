...
public class RejectedStatusReason20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason20.ReasonCode, com.tools20022.repository.msg.RejectedStatusReason20.AdditionalReasonInformation);
