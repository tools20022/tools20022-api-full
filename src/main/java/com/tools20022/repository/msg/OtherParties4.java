 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintInvestorCountryCodeRule#forOtherParties4
 * ConstraintInvestorCountryCodeRule.forOtherParties4}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "OtherParties4", propOrder = {"investor", "stockExchange", "tradeRegulator"})
public class OtherParties4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherParties4.mmInvestor, com.tools20022.repository.msg.OtherParties4.mmStockExchange, com.tools20022.repository.msg.OtherParties4.mmTradeRegulator);
				trace_lazy = () -> Role.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintInvestorCountryCodeRule.forOtherParties4);
	...
	public OtherParties4 setInvestor(PartyIdentification14Choice investor) {
	...
	public OtherParties4 setStockExchange(PartyIdentification10Choice stockExchange) {
	...
	public OtherParties4 setTradeRegulator(PartyIdentification10Choice tradeRegulator) {
