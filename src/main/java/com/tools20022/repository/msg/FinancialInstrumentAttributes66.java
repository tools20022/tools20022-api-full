...
@XmlType(name = "FinancialInstrumentAttributes66", propOrder = {"financialInstrumentIdentification", "placeOfListing", "dayCountBasis", "classificationType", "optionStyle", "denominationCurrency", "nextCouponDate", "expiryDate",
...
public class FinancialInstrumentAttributes66 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, SecurityIdentification19> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, SecurityIdentification19>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public SecurityIdentification19 getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, SecurityIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<MarketIdentification3Choice>> mmPlaceOfListing = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<MarketIdentification3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmPlaceOfListing);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmPlaceOfListing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification3Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getPlaceOfListing();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<MarketIdentification3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<InterestComputationMethodFormat4Choice>> mmDayCountBasis = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<InterestComputationMethodFormat4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmDayCountBasis);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmDayCountBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InterestComputationMethodFormat4Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getDayCountBasis();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<InterestComputationMethodFormat4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<ClassificationType32Choice>> mmClassificationType = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<ClassificationType32Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmClassificationType);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmClassificationType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ClassificationType32Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getClassificationType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<ClassificationType32Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<OptionStyle8Choice>> mmOptionStyle = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<OptionStyle8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmOptionStyle);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmOptionStyle;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<OptionStyle8Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getOptionStyle();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<OptionStyle8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ActiveOrHistoricCurrencyCode>> mmDenominationCurrency = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmDenominationCurrency);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmDenominationCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getDenominationCurrency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmNextCouponDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmNextCouponDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmNextCouponDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getNextCouponDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmExpiryDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmExpiryDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmExpiryDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmFloatingRateFixingDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmFloatingRateFixingDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmFloatingRateFixingDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmMaturityDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmMaturityDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmMaturityDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmIssueDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmIssueDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmNextCallableDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmNextCallableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmNextCallableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmPutableDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmPutableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmPutableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmDatedDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmDatedDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmDatedDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>> mmConversionDate = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmConversionDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmConversionDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>> mmInterestRate = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat3Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getInterestRate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<RateFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>> mmNextInterestRate = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmNextInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmNextInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>> mmPercentageOfDebtClaim = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmPercentageOfDebtClaim);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmPercentageOfDebtClaim;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat12Choice>> mmPreviousFactor = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat12Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmPreviousFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmPreviousFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat12Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<RateFormat12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat12Choice>> mmNextFactor = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<RateFormat12Choice>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmNextFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmNextFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat12Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes66, Optional<QuantityToQuantityRatio1>> mmWarrantParity = new MMMessageAttribute<FinancialInstrumentAttributes66, Optional<QuantityToQuantityRatio1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmWarrantParity);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmWarrantParity;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<QuantityToQuantityRatio1> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getWarrantParity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<QuantityToQuantityRatio1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumNominalQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmMinimumNominalQuantity);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmMinimumNominalQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(FinancialInstrumentAttributes66 obj) {
			return obj.getMinimumNominalQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes66 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<FinancialInstrumentQuantity1Choice>> mmContractSize = new MMMessageAssociationEnd<FinancialInstrumentAttributes66, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmContractSize);
			previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmContractSize;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmPlaceOfListing,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmDayCountBasis, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmClassificationType,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmOptionStyle, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmDenominationCurrency,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmNextCouponDate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmExpiryDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmFloatingRateFixingDate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmMaturityDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmIssueDate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmNextCallableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmPutableDate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmDatedDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmConversionDate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmInterestRate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmNextInterestRate, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmPercentageOfDebtClaim,
						...
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmWarrantParity, com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmMinimumNominalQuantity,
						com.tools20022.repository.msg.FinancialInstrumentAttributes66.mmContractSize);
				trace_lazy = () -> Asset.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPreviousNextFactorRule.forFinancialInstrumentAttributes66,
						com.tools20022.repository.constraints.ConstraintMaturityDateRule.forFinancialInstrumentAttributes66);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentAttributes66";
				definition = "Description of the financial instrument.";
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmObject());
				previousVersion_lazy = () -> FinancialInstrumentAttributes48.mmObject();
			}
		});
	...
	public FinancialInstrumentAttributes66 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public FinancialInstrumentAttributes66 setPlaceOfListing(MarketIdentification3Choice placeOfListing) {
	...
	public FinancialInstrumentAttributes66 setDayCountBasis(InterestComputationMethodFormat4Choice dayCountBasis) {
	...
	public FinancialInstrumentAttributes66 setClassificationType(ClassificationType32Choice classificationType) {
	...
	public FinancialInstrumentAttributes66 setOptionStyle(OptionStyle8Choice optionStyle) {
	...
	public FinancialInstrumentAttributes66 setDenominationCurrency(ActiveOrHistoricCurrencyCode denominationCurrency) {
	...
	public FinancialInstrumentAttributes66 setNextCouponDate(ISODate nextCouponDate) {
	...
	public FinancialInstrumentAttributes66 setExpiryDate(ISODate expiryDate) {
	...
	public FinancialInstrumentAttributes66 setFloatingRateFixingDate(ISODate floatingRateFixingDate) {
	...
	public FinancialInstrumentAttributes66 setMaturityDate(ISODate maturityDate) {
	...
	public FinancialInstrumentAttributes66 setIssueDate(ISODate issueDate) {
	...
	public FinancialInstrumentAttributes66 setNextCallableDate(ISODate nextCallableDate) {
	...
	public FinancialInstrumentAttributes66 setPutableDate(ISODate putableDate) {
	...
	public FinancialInstrumentAttributes66 setDatedDate(ISODate datedDate) {
	...
	public FinancialInstrumentAttributes66 setConversionDate(ISODate conversionDate) {
	...
	public FinancialInstrumentAttributes66 setInterestRate(RateFormat3Choice interestRate) {
	...
	public FinancialInstrumentAttributes66 setNextInterestRate(RateFormat3Choice nextInterestRate) {
	...
	public FinancialInstrumentAttributes66 setPercentageOfDebtClaim(RateFormat3Choice percentageOfDebtClaim) {
	...
	public FinancialInstrumentAttributes66 setPreviousFactor(RateFormat12Choice previousFactor) {
	...
	public FinancialInstrumentAttributes66 setNextFactor(RateFormat12Choice nextFactor) {
	...
	public FinancialInstrumentAttributes66 setWarrantParity(QuantityToQuantityRatio1 warrantParity) {
	...
	public FinancialInstrumentAttributes66 setMinimumNominalQuantity(FinancialInstrumentQuantity1Choice minimumNominalQuantity) {
	...
	public FinancialInstrumentAttributes66 setContractSize(FinancialInstrumentQuantity1Choice contractSize) {
