...
public class CorporateActionGeneralInformation19 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation19.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation19.mmCorporateActionEventIdentification, CorporateActionGeneralInformation19.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation19.mmClassActionNumber, CorporateActionGeneralInformation19.mmEventProcessingType, CorporateActionGeneralInformation19.mmEventType,
						CorporateActionGeneralInformation19.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation19.mmUnderlyingSecurity);
