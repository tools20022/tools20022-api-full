...
public class AmountAndDirection11 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmountAndDirection11.mmAmount, AmountAndDirection11.mmCreditDebitIndicator, AmountAndDirection11.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection11.mmForeignExchangeDetails);
