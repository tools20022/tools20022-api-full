...
public class SubAccountIdentification25 {
	...
	public static final MMMessageAssociationEnd mmAccountOwner = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SubAccountIdentification25.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnr";
	...
	protected List<com.tools20022.repository.msg.AggregateBalanceInformation18> balanceForSubAccount;
	/**
	...
	public static final MMMessageAssociationEnd mmBalanceForSubAccount = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.AggregateBalanceInformation18.mmObject();
		}
	};
	...
	public void setBalanceForSubAccount(List<com.tools20022.repository.msg.AggregateBalanceInformation18> balanceForSubAccount) {
