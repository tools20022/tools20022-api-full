...
public class SubAccountIdentification25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification25.mmAccountOwner, SubAccountIdentification25.mmSafekeepingAccount, SubAccountIdentification25.mmActivityIndicator,
						SubAccountIdentification25.mmBalanceForSubAccount);
