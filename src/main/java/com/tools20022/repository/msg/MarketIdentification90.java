...
public class MarketIdentification90 {
	...
	public static final MMMessageAssociationEnd mmIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> MarketIdentification90.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MarketIdentification90.mmIdentification, MarketIdentification90.mmType);
	...
	@XmlElement(name = "Id")
	public MarketIdentification2Choice getIdentification() {
		return identification;
	}

	public void setIdentification(MarketIdentification2Choice identification) {
	...
	public void setType(MarketType16Choice type) {
		this.type = type;
	}
}