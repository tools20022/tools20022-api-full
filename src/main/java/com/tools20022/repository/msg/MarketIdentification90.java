...
import com.tools20022.repository.choice.MarketType16Choice;
 ...
 * <li>{@linkplain com.tools20022.repository.msg.MarketIdentification90#mmType
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule#forMarketIdentification90
 * ConstraintMarketTypeAndIdentificationRule.forMarketIdentification90}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "MarketIdentification90", propOrder = {"identification", "type"})
public class MarketIdentification90 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification90, Optional<MarketIdentification2Choice>> mmIdentification = new MMMessageAssociationEnd<MarketIdentification90, Optional<MarketIdentification2Choice>>() {
		{
			businessComponentTrace_lazy = () -> TradingMarket.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.MarketIdentification90.mmObject();
			isDerived = false;
			xmlTag = "Id";
		...
		@Override
		public Optional<MarketIdentification2Choice> getValue(MarketIdentification90 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(MarketIdentification90 obj, Optional<MarketIdentification2Choice> value) {
			obj.setIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "Tp", required = true)
	protected MarketType16Choice type;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.choice.MarketType16Choice
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketIdentification90, MarketType16Choice> mmType = new MMMessageAssociationEnd<MarketIdentification90, MarketType16Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> MarketType16Choice.mmObject();
		}

		@Override
		public MarketType16Choice getValue(MarketIdentification90 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(MarketIdentification90 obj, MarketType16Choice value) {
			obj.setType(value);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification90.mmIdentification, com.tools20022.repository.msg.MarketIdentification90.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification90);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketIdentification90";
	...
	public MarketIdentification90 setIdentification(MarketIdentification2Choice identification) {
		this.identification = identification;
		return this;
	}

	public MarketType16Choice getType() {
		return type;
	}

	public MarketIdentification90 setType(MarketType16Choice type) {
