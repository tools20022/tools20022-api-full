...
public class SecuritiesAccount2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SecuritiesAccount2.Identification, com.tools20022.repository.msg.SecuritiesAccount2.Type, com.tools20022.repository.msg.SecuritiesAccount2.Name);
