...
public class TransactionTypeAndAdditionalParameters1 {
	...
	public static final MMMessageAttribute mmSecuritiesFinancingTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TransactionTypeAndAdditionalParameters1.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionTypeAndAdditionalParameters1.mmSecuritiesFinancingTransactionType, TransactionTypeAndAdditionalParameters1.mmPayment,
						TransactionTypeAndAdditionalParameters1.mmCommonIdentification, TransactionTypeAndAdditionalParameters1.mmReconciliationIndicator);
