 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule#forCorporateActionRate67
 * ConstraintGrossDividendRate2Rule.forCorporateActionRate67}</li>
 * <li>
...
@XmlType(name = "CorporateActionRate67", propOrder = {"additionalTax", "grossDividendRate", "netDividendRate", "indexFactor", "interestRateUsedForPayment", "maximumAllowedOversubscriptionRate", "prorationRate", "withholdingTaxRate",
...
public class CorporateActionRate67 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>> mmAdditionalTax = new MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>>() {
		{
			businessComponentTrace_lazy = () -> Tax.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate67.mmObject();
			isDerived = false;
			xmlTag = "AddtlTax";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmAdditionalTax);
			previousVersion_lazy = () -> CorporateActionRate45.mmAdditionalTax;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateAndAmountFormat37Choice> getValue(CorporateActionRate67 obj) {
			return obj.getAdditionalTax();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, Optional<RateAndAmountFormat37Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<GrossDividendRateFormat19Choice>> mmGrossDividendRate = new MMMessageAssociationEnd<CorporateActionRate67, List<GrossDividendRateFormat19Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmGrossDividendRate);
			previousVersion_lazy = () -> CorporateActionRate45.mmGrossDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<GrossDividendRateFormat19Choice> getValue(CorporateActionRate67 obj) {
			return obj.getGrossDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, List<GrossDividendRateFormat19Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<NetDividendRateFormat21Choice>> mmNetDividendRate = new MMMessageAssociationEnd<CorporateActionRate67, List<NetDividendRateFormat21Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmNetDividendRate);
			previousVersion_lazy = () -> CorporateActionRate45.mmNetDividendRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<NetDividendRateFormat21Choice> getValue(CorporateActionRate67 obj) {
			return obj.getNetDividendRate();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, List<NetDividendRateFormat21Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>> mmIndexFactor = new MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmIndexFactor);
			previousVersion_lazy = () -> CorporateActionRate45.mmIndexFactor;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat37Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<InterestRateUsedForPaymentFormat8Choice>> mmInterestRateUsedForPayment = new MMMessageAssociationEnd<CorporateActionRate67, List<InterestRateUsedForPaymentFormat8Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmInterestRateUsedForPayment);
			previousVersion_lazy = () -> CorporateActionRate45.mmInterestRateUsedForPayment;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<InterestRateUsedForPaymentFormat8Choice> getValue(CorporateActionRate67 obj) {
			return obj.getInterestRateUsedForPayment();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, List<InterestRateUsedForPaymentFormat8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, Optional<RateFormat3Choice>> mmMaximumAllowedOversubscriptionRate = new MMMessageAssociationEnd<CorporateActionRate67, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmMaximumAllowedOversubscriptionRate);
			previousVersion_lazy = () -> CorporateActionRate45.mmMaximumAllowedOversubscriptionRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<RateFormat3Choice> getValue(CorporateActionRate67 obj) {
			return obj.getMaximumAllowedOversubscriptionRate();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, Optional<RateFormat3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, Optional<RateFormat3Choice>> mmProrationRate = new MMMessageAssociationEnd<CorporateActionRate67, Optional<RateFormat3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmProrationRate);
			previousVersion_lazy = () -> CorporateActionRate45.mmProrationRate;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateFormat3Choice.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<RateAndAmountFormat41Choice>> mmWithholdingTaxRate = new MMMessageAssociationEnd<CorporateActionRate67, List<RateAndAmountFormat41Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmWithholdingTaxRate);
			previousVersion_lazy = () -> CorporateActionRate45.mmWithholdingTaxRate;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateAndAmountFormat41Choice> getValue(CorporateActionRate67 obj) {
			return obj.getWithholdingTaxRate();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, List<RateAndAmountFormat41Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<RateAndAmountFormat41Choice>> mmSecondLevelTax = new MMMessageAssociationEnd<CorporateActionRate67, List<RateAndAmountFormat41Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmSecondLevelTax);
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat41Choice.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, List<RateTypeAndAmountAndStatus26>> mmTaxableIncomePerDividendShare = new MMMessageAssociationEnd<CorporateActionRate67, List<RateTypeAndAmountAndStatus26>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmTaxableIncomePerDividendShare);
			previousVersion_lazy = () -> CorporateActionRate45.mmTaxableIncomePerDividendShare;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<RateTypeAndAmountAndStatus26> getValue(CorporateActionRate67 obj) {
			return obj.getTaxableIncomePerDividendShare();
		}

		@Override
		public void setValue(CorporateActionRate67 obj, List<RateTypeAndAmountAndStatus26> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>> mmTaxOnIncome = new MMMessageAssociationEnd<CorporateActionRate67, Optional<RateAndAmountFormat37Choice>>() {
		{
			businessElementTrace_lazy = () -> Tax.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionRate67.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmTaxOnIncome);
			previousVersion_lazy = () -> CorporateActionRate45.mmTaxOnIncome;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> RateAndAmountFormat37Choice.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateActionRate67.mmAdditionalTax, com.tools20022.repository.msg.CorporateActionRate67.mmGrossDividendRate,
						com.tools20022.repository.msg.CorporateActionRate67.mmNetDividendRate, com.tools20022.repository.msg.CorporateActionRate67.mmIndexFactor,
						com.tools20022.repository.msg.CorporateActionRate67.mmInterestRateUsedForPayment, com.tools20022.repository.msg.CorporateActionRate67.mmMaximumAllowedOversubscriptionRate,
						com.tools20022.repository.msg.CorporateActionRate67.mmProrationRate, com.tools20022.repository.msg.CorporateActionRate67.mmWithholdingTaxRate, com.tools20022.repository.msg.CorporateActionRate67.mmSecondLevelTax,
						com.tools20022.repository.msg.CorporateActionRate67.mmTaxableIncomePerDividendShare, com.tools20022.repository.msg.CorporateActionRate67.mmTaxOnIncome);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGrossDividendRate2Rule.forCorporateActionRate67,
						com.tools20022.repository.constraints.ConstraintGrossDividendRate3Rule.forCorporateActionRate67, com.tools20022.repository.constraints.ConstraintNetDividendRate1Rule.forCorporateActionRate67,
						com.tools20022.repository.constraints.ConstraintNetDividendRate2Rule.forCorporateActionRate67, com.tools20022.repository.constraints.ConstraintSecondLevelTax1Rule.forCorporateActionRate67);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionRate67";
				definition = "Specifies rates related to a corporate action option.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionRate81.mmObject());
				previousVersion_lazy = () -> CorporateActionRate45.mmObject();
			}
		});
	...
	public CorporateActionRate67 setAdditionalTax(RateAndAmountFormat37Choice additionalTax) {
	...
	public CorporateActionRate67 setGrossDividendRate(List<GrossDividendRateFormat19Choice> grossDividendRate) {
	...
	public CorporateActionRate67 setNetDividendRate(List<NetDividendRateFormat21Choice> netDividendRate) {
	...
	public CorporateActionRate67 setIndexFactor(RateAndAmountFormat37Choice indexFactor) {
	...
	public CorporateActionRate67 setInterestRateUsedForPayment(List<InterestRateUsedForPaymentFormat8Choice> interestRateUsedForPayment) {
	...
	public CorporateActionRate67 setMaximumAllowedOversubscriptionRate(RateFormat3Choice maximumAllowedOversubscriptionRate) {
	...
	public CorporateActionRate67 setProrationRate(RateFormat3Choice prorationRate) {
	...
	public CorporateActionRate67 setWithholdingTaxRate(List<RateAndAmountFormat41Choice> withholdingTaxRate) {
	...
	public CorporateActionRate67 setSecondLevelTax(List<RateAndAmountFormat41Choice> secondLevelTax) {
	...
	public CorporateActionRate67 setTaxableIncomePerDividendShare(List<RateTypeAndAmountAndStatus26> taxableIncomePerDividendShare) {
	...
	public CorporateActionRate67 setTaxOnIncome(RateAndAmountFormat37Choice taxOnIncome) {
