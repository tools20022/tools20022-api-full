...
public class DeliverInformation15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation15.mmRequestedSettlementDate, DeliverInformation15.mmSettlementAmount, DeliverInformation15.mmStampDuty, DeliverInformation15.mmNetAmount,
						DeliverInformation15.mmSettlementPartiesDetails, DeliverInformation15.mmChargeDetails, DeliverInformation15.mmCommissionDetails, DeliverInformation15.mmTaxDetails, DeliverInformation15.mmForeignExchangeDetails,
						DeliverInformation15.mmPhysicalTransfer, DeliverInformation15.mmPhysicalTransferDetails, DeliverInformation15.mmClientReference);
