...
@XmlType(name = "FinancialInstrumentAttributesSD17", propOrder = {"placeAndName", "originatingSecurityIdentification"})
public class FinancialInstrumentAttributesSD17 {
	...
	public static final MMMessageAttribute<FinancialInstrumentAttributesSD17, Optional<Max350Text>> mmPlaceAndName = new MMMessageAttribute<FinancialInstrumentAttributesSD17, Optional<Max350Text>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributesSD9.mmPlaceAndName;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributesSD17, Optional<OtherIdentification2>> mmOriginatingSecurityIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributesSD17, Optional<OtherIdentification2>>() {
		{
			...
			previousVersion_lazy = () -> FinancialInstrumentAttributesSD9.mmOriginatingSecurityIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributesSD17.mmPlaceAndName, com.tools20022.repository.msg.FinancialInstrumentAttributesSD17.mmOriginatingSecurityIdentification);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentAttributesSD17";
				definition = "Provides additional information regarding underlying security details.";
				previousVersion_lazy = () -> FinancialInstrumentAttributesSD9.mmObject();
			}
		});
	...
	public FinancialInstrumentAttributesSD17 setPlaceAndName(Max350Text placeAndName) {
