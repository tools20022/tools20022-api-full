...
public class CorporateActionGeneralInformation7 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation7.mmObject();
			isDerived = false;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation7.mmCorporateActionEventIdentification, CorporateActionGeneralInformation7.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation7.mmEventType, CorporateActionGeneralInformation7.mmUnderlyingSecurityIdentification);
