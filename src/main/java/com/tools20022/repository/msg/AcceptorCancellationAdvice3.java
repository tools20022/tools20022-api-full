...
public class AcceptorCancellationAdvice3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptorCancellationAdvice3.mmEnvironment, AcceptorCancellationAdvice3.mmContext, AcceptorCancellationAdvice3.mmTransaction);
