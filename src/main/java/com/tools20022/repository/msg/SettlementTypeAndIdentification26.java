...
@XmlType(name = "SettlementTypeAndIdentification26", propOrder = {"payment", "transactionIdentification", "settlementDate"})
public class SettlementTypeAndIdentification26 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementTypeAndIdentification26.mmPayment, com.tools20022.repository.msg.SettlementTypeAndIdentification26.mmTransactionIdentification,
						com.tools20022.repository.msg.SettlementTypeAndIdentification26.mmSettlementDate);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementTypeAndIdentification26";
	...
	public SettlementTypeAndIdentification26 setPayment(DeliveryReceiptType2Code payment) {
	...
	public SettlementTypeAndIdentification26 setTransactionIdentification(RestrictedFINXMax16Text transactionIdentification) {
	...
	public SettlementTypeAndIdentification26 setSettlementDate(DateAndDateTime2Choice settlementDate) {
