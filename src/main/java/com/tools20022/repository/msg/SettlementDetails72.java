 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails72#mmPriority
 ...
 * <li>{@linkplain com.tools20022.repository.msg.SettlementDetails72#mmTracking
...
public class SettlementDetails72 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails72, Optional<YesNoIndicator>> mmHoldIndicator = new MMMessageAttribute<SettlementDetails72, Optional<YesNoIndicator>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmHoldIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails72.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "HoldIndicator";
			definition = "Specifies whether the transaction is on hold/blocked/frozen.";
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmHoldIndicator);
			previousVersion_lazy = () -> SettlementDetails62.mmHoldIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<YesNoIndicator> getValue(SettlementDetails72 obj) {
			return obj.getHoldIndicator();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<YesNoIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<PriorityNumeric1Choice>> mmPriority = new MMMessageAssociationEnd<SettlementDetails72, Optional<PriorityNumeric1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmPriority);
			previousVersion_lazy = () -> SettlementDetails62.mmPriority;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<PriorityNumeric1Choice> getValue(SettlementDetails72 obj) {
			return obj.getPriority();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<PriorityNumeric1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, List<SettlementTransactionCondition7Choice>> mmSettlementTransactionCondition = new MMMessageAssociationEnd<SettlementDetails72, List<SettlementTransactionCondition7Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmSettlementTransactionCondition);
			previousVersion_lazy = () -> SettlementDetails62.mmSettlementTransactionCondition;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<SettlementTransactionCondition7Choice> getValue(SettlementDetails72 obj) {
			return obj.getSettlementTransactionCondition();
		}

		@Override
		public void setValue(SettlementDetails72 obj, List<SettlementTransactionCondition7Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<SettlingCapacity4Choice>> mmSettlingCapacity = new MMMessageAssociationEnd<SettlementDetails72, Optional<SettlingCapacity4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmSettlingCapacity);
			previousVersion_lazy = () -> SettlementDetails62.mmSettlingCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlingCapacity4Choice> getValue(SettlementDetails72 obj) {
			return obj.getSettlingCapacity();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<SettlingCapacity4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<GenericIdentification20>> mmStampDutyTaxBasis = new MMMessageAssociationEnd<SettlementDetails72, Optional<GenericIdentification20>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmStampDutyTaxBasis);
			previousVersion_lazy = () -> SettlementDetails62.mmStampDutyTaxBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<GenericIdentification20> getValue(SettlementDetails72 obj) {
			return obj.getStampDutyTaxBasis();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<GenericIdentification20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<SecuritiesRTGS1Choice>> mmSecuritiesRTGS = new MMMessageAssociationEnd<SettlementDetails72, Optional<SecuritiesRTGS1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmSecuritiesRTGS);
			previousVersion_lazy = () -> SettlementDetails62.mmSecuritiesRTGS;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecuritiesRTGS1Choice> getValue(SettlementDetails72 obj) {
			return obj.getSecuritiesRTGS();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<SecuritiesRTGS1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<BeneficialOwnership1Choice>> mmBeneficialOwnership = new MMMessageAssociationEnd<SettlementDetails72, Optional<BeneficialOwnership1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmBeneficialOwnership);
			previousVersion_lazy = () -> SettlementDetails62.mmBeneficialOwnership;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BeneficialOwnership1Choice> getValue(SettlementDetails72 obj) {
			return obj.getBeneficialOwnership();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<BeneficialOwnership1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<CashSettlementSystem1Choice>> mmCashClearingSystem = new MMMessageAssociationEnd<SettlementDetails72, Optional<CashSettlementSystem1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmCashClearingSystem);
			previousVersion_lazy = () -> SettlementDetails62.mmCashClearingSystem;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CashSettlementSystem1Choice> getValue(SettlementDetails72 obj) {
			return obj.getCashClearingSystem();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<CashSettlementSystem1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<TaxCapacityParty1Choice>> mmTaxCapacity = new MMMessageAssociationEnd<SettlementDetails72, Optional<TaxCapacityParty1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmTaxCapacity);
			previousVersion_lazy = () -> SettlementDetails62.mmTaxCapacity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<TaxCapacityParty1Choice> getValue(SettlementDetails72 obj) {
			return obj.getTaxCapacity();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<TaxCapacityParty1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<MarketClientSide1Choice>> mmMarketClientSide = new MMMessageAssociationEnd<SettlementDetails72, Optional<MarketClientSide1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmMarketClientSide);
			previousVersion_lazy = () -> SettlementDetails62.mmMarketClientSide;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketClientSide1Choice> getValue(SettlementDetails72 obj) {
			return obj.getMarketClientSide();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<MarketClientSide1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<FXStandingInstruction1Choice>> mmFXStandingInstruction = new MMMessageAssociationEnd<SettlementDetails72, Optional<FXStandingInstruction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmFXStandingInstruction);
			previousVersion_lazy = () -> SettlementDetails62.mmFXStandingInstruction;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FXStandingInstruction1Choice> getValue(SettlementDetails72 obj) {
			return obj.getFXStandingInstruction();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<FXStandingInstruction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<BlockTrade1Choice>> mmBlockTrade = new MMMessageAssociationEnd<SettlementDetails72, Optional<BlockTrade1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmBlockTrade);
			previousVersion_lazy = () -> SettlementDetails62.mmBlockTrade;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<BlockTrade1Choice> getValue(SettlementDetails72 obj) {
			return obj.getBlockTrade();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<BlockTrade1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<Restriction1Choice>> mmLegalRestrictions = new MMMessageAssociationEnd<SettlementDetails72, Optional<Restriction1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmLegalRestrictions);
			previousVersion_lazy = () -> SettlementDetails62.mmLegalRestrictions;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Restriction1Choice> getValue(SettlementDetails72 obj) {
			return obj.getLegalRestrictions();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<Restriction1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<SettlementSystemMethod1Choice>> mmSettlementSystemMethod = new MMMessageAssociationEnd<SettlementDetails72, Optional<SettlementSystemMethod1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmSettlementSystemMethod);
			previousVersion_lazy = () -> SettlementDetails62.mmSettlementSystemMethod;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SettlementSystemMethod1Choice> getValue(SettlementDetails72 obj) {
			return obj.getSettlementSystemMethod();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<SettlementSystemMethod1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<NettingEligibility1Choice>> mmNettingEligibility = new MMMessageAssociationEnd<SettlementDetails72, Optional<NettingEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmNettingEligibility);
			previousVersion_lazy = () -> SettlementDetails62.mmNettingEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<NettingEligibility1Choice> getValue(SettlementDetails72 obj) {
			return obj.getNettingEligibility();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<NettingEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<CentralCounterPartyEligibility1Choice>> mmCCPEligibility = new MMMessageAssociationEnd<SettlementDetails72, Optional<CentralCounterPartyEligibility1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmCCPEligibility);
			previousVersion_lazy = () -> SettlementDetails62.mmCCPEligibility;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<CentralCounterPartyEligibility1Choice> getValue(SettlementDetails72 obj) {
			return obj.getCCPEligibility();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<CentralCounterPartyEligibility1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<Tracking1Choice>> mmTracking = new MMMessageAssociationEnd<SettlementDetails72, Optional<Tracking1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmTracking);
			previousVersion_lazy = () -> SettlementDetails62.mmTracking;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<Tracking1Choice> getValue(SettlementDetails72 obj) {
			return obj.getTracking();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<Tracking1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementDetails72, Optional<AutomaticBorrowing1Choice>> mmAutomaticBorrowing = new MMMessageAssociationEnd<SettlementDetails72, Optional<AutomaticBorrowing1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmAutomaticBorrowing);
			previousVersion_lazy = () -> SettlementDetails62.mmAutomaticBorrowing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<AutomaticBorrowing1Choice> getValue(SettlementDetails72 obj) {
			return obj.getAutomaticBorrowing();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<AutomaticBorrowing1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails72, Optional<SettlementTransactionCondition5Code>> mmPartialSettlementIndicator = new MMMessageAttribute<SettlementDetails72, Optional<SettlementTransactionCondition5Code>>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.msg.SettlementDetails72.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmPartialSettlementIndicator);
			previousVersion_lazy = () -> SettlementDetails62.mmPartialSettlementIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<SettlementTransactionCondition5Code> getValue(SettlementDetails72 obj) {
			return obj.getPartialSettlementIndicator();
		}

		@Override
		public void setValue(SettlementDetails72 obj, Optional<SettlementTransactionCondition5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementDetails72, Optional<YesNoIndicator>> mmEligibleForCollateral = new MMMessageAttribute<SettlementDetails72, Optional<YesNoIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmEligibleForCollateral);
			previousVersion_lazy = () -> SettlementDetails62.mmEligibleForCollateral;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> YesNoIndicator.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementDetails72.mmHoldIndicator, com.tools20022.repository.msg.SettlementDetails72.mmPriority,
						com.tools20022.repository.msg.SettlementDetails72.mmSettlementTransactionCondition, com.tools20022.repository.msg.SettlementDetails72.mmSettlingCapacity,
						com.tools20022.repository.msg.SettlementDetails72.mmStampDutyTaxBasis, com.tools20022.repository.msg.SettlementDetails72.mmSecuritiesRTGS, com.tools20022.repository.msg.SettlementDetails72.mmBeneficialOwnership,
						com.tools20022.repository.msg.SettlementDetails72.mmCashClearingSystem, com.tools20022.repository.msg.SettlementDetails72.mmTaxCapacity, com.tools20022.repository.msg.SettlementDetails72.mmMarketClientSide,
						com.tools20022.repository.msg.SettlementDetails72.mmFXStandingInstruction, com.tools20022.repository.msg.SettlementDetails72.mmBlockTrade, com.tools20022.repository.msg.SettlementDetails72.mmLegalRestrictions,
						com.tools20022.repository.msg.SettlementDetails72.mmSettlementSystemMethod, com.tools20022.repository.msg.SettlementDetails72.mmNettingEligibility, com.tools20022.repository.msg.SettlementDetails72.mmCCPEligibility,
						com.tools20022.repository.msg.SettlementDetails72.mmTracking, com.tools20022.repository.msg.SettlementDetails72.mmAutomaticBorrowing, com.tools20022.repository.msg.SettlementDetails72.mmPartialSettlementIndicator,
						com.tools20022.repository.msg.SettlementDetails72.mmEligibleForCollateral);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV05.mmSettlementParameters, SecuritiesFinancingModificationInstructionV04.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintSettlementDetailsRule.forSettlementDetails72,
						com.tools20022.repository.constraints.ConstraintCashClearingSystemRule.forSettlementDetails72, com.tools20022.repository.constraints.ConstraintFXStandingInstructionPresenceRule.forSettlementDetails72);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails72";
				definition = "Parameters which explicitly state the conditions that must be fulfilled before a particular transaction of a financial instrument can be settled. These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.";
				nextVersions_lazy = () -> Arrays.asList(SettlementDetails97.mmObject());
				previousVersion_lazy = () -> SettlementDetails62.mmObject();
			}
		});
	...
	public SettlementDetails72 setHoldIndicator(YesNoIndicator holdIndicator) {
	...
	public SettlementDetails72 setPriority(PriorityNumeric1Choice priority) {
	...
	public SettlementDetails72 setSettlementTransactionCondition(List<SettlementTransactionCondition7Choice> settlementTransactionCondition) {
	...
	public SettlementDetails72 setSettlingCapacity(SettlingCapacity4Choice settlingCapacity) {
	...
	public SettlementDetails72 setStampDutyTaxBasis(GenericIdentification20 stampDutyTaxBasis) {
	...
	public SettlementDetails72 setSecuritiesRTGS(SecuritiesRTGS1Choice securitiesRTGS) {
	...
	public SettlementDetails72 setBeneficialOwnership(BeneficialOwnership1Choice beneficialOwnership) {
	...
	public SettlementDetails72 setCashClearingSystem(CashSettlementSystem1Choice cashClearingSystem) {
	...
	public SettlementDetails72 setTaxCapacity(TaxCapacityParty1Choice taxCapacity) {
	...
	public SettlementDetails72 setMarketClientSide(MarketClientSide1Choice marketClientSide) {
	...
	public SettlementDetails72 setFXStandingInstruction(FXStandingInstruction1Choice fXStandingInstruction) {
	...
	public SettlementDetails72 setBlockTrade(BlockTrade1Choice blockTrade) {
	...
	public SettlementDetails72 setLegalRestrictions(Restriction1Choice legalRestrictions) {
	...
	public SettlementDetails72 setSettlementSystemMethod(SettlementSystemMethod1Choice settlementSystemMethod) {
	...
	public SettlementDetails72 setNettingEligibility(NettingEligibility1Choice nettingEligibility) {
	...
	public SettlementDetails72 setCCPEligibility(CentralCounterPartyEligibility1Choice cCPEligibility) {
	...
	public SettlementDetails72 setTracking(Tracking1Choice tracking) {
	...
	public SettlementDetails72 setAutomaticBorrowing(AutomaticBorrowing1Choice automaticBorrowing) {
	...
	public SettlementDetails72 setPartialSettlementIndicator(SettlementTransactionCondition5Code partialSettlementIndicator) {
	...
	public SettlementDetails72 setEligibleForCollateral(YesNoIndicator eligibleForCollateral) {
