...
@XmlType(name = "CardPaymentTransactionDetails10", propOrder = {"currency", "totalAmount", "amountQualifier", "detailedAmount", "validityDate", "onLineReason", "unattendedLevelCategory", "accountType", "recurringTransaction", "product",
		"iCCRelatedData"})
public class CardPaymentTransactionDetails10 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<CurrencyCode>> mmCurrency = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<CurrencyCode>>() {
		{
			businessElementTrace_lazy = () -> Payment.mmCurrencyOfTransfer;
			componentContext_lazy = () -> com.tools20022.repository.msg.CardPaymentTransactionDetails10.mmObject();
			isDerived = false;
			xmlTag = "Ccy";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Currency";
			definition = "Currency associated with the transaction.";
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmCurrency);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CurrencyCode> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getCurrency();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<CurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, ImpliedCurrencyAndAmount> mmTotalAmount = new MMMessageAttribute<CardPaymentTransactionDetails10, ImpliedCurrencyAndAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmTotalAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getTotalAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<TypeOfAmount1Code>> mmAmountQualifier = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<TypeOfAmount1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmAmountQualifier);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TypeOfAmount1Code> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getAmountQualifier();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<TypeOfAmount1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails10, List<DetailedAmount1>> mmDetailedAmount = new MMMessageAssociationEnd<CardPaymentTransactionDetails10, List<DetailedAmount1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmDetailedAmount);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<DetailedAmount1> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getDetailedAmount();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, List<DetailedAmount1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<ISODate>> mmValidityDate = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmValidityDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getValidityDate();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<OnLineReason1Code>> mmOnLineReason = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<OnLineReason1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmOnLineReason);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<OnLineReason1Code> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getOnLineReason();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<OnLineReason1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<Max35NumericText>> mmUnattendedLevelCategory = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<Max35NumericText>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmUnattendedLevelCategory);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35NumericText> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getUnattendedLevelCategory();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<Max35NumericText> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<CardAccountType1Code>> mmAccountType = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<CardAccountType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmAccountType);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardAccountType1Code> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getAccountType();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<CardAccountType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails10, Optional<RecurringTransaction1>> mmRecurringTransaction = new MMMessageAssociationEnd<CardPaymentTransactionDetails10, Optional<RecurringTransaction1>>() {
		{
		...
		@Override
		public Optional<RecurringTransaction1> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getRecurringTransaction();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<RecurringTransaction1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CardPaymentTransactionDetails10, List<Product1>> mmProduct = new MMMessageAssociationEnd<CardPaymentTransactionDetails10, List<Product1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmProduct);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Product1> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getProduct();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, List<Product1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CardPaymentTransactionDetails10, Optional<Max10000Binary>> mmICCRelatedData = new MMMessageAttribute<CardPaymentTransactionDetails10, Optional<Max10000Binary>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CardPaymentTransactionDetails16.mmICCRelatedData);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max10000Binary> getValue(CardPaymentTransactionDetails10 obj) {
			return obj.getICCRelatedData();
		}

		@Override
		public void setValue(CardPaymentTransactionDetails10 obj, Optional<Max10000Binary> value) {
	...
	public CardPaymentTransactionDetails10 setCurrency(CurrencyCode currency) {
	...
	public CardPaymentTransactionDetails10 setTotalAmount(ImpliedCurrencyAndAmount totalAmount) {
	...
	public CardPaymentTransactionDetails10 setAmountQualifier(TypeOfAmount1Code amountQualifier) {
	...
	public CardPaymentTransactionDetails10 setDetailedAmount(List<DetailedAmount1> detailedAmount) {
	...
	public CardPaymentTransactionDetails10 setValidityDate(ISODate validityDate) {
	...
	public CardPaymentTransactionDetails10 setOnLineReason(OnLineReason1Code onLineReason) {
	...
	public CardPaymentTransactionDetails10 setUnattendedLevelCategory(Max35NumericText unattendedLevelCategory) {
	...
	public CardPaymentTransactionDetails10 setAccountType(CardAccountType1Code accountType) {
	...
	public CardPaymentTransactionDetails10 setRecurringTransaction(RecurringTransaction1 recurringTransaction) {
	...
	public CardPaymentTransactionDetails10 setProduct(List<Product1> product) {
	...
	public CardPaymentTransactionDetails10 setICCRelatedData(Max10000Binary iCCRelatedData) {
