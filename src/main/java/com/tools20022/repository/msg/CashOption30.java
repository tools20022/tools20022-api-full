...
public class CashOption30 {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forCashOption30);
	...
	public CashOption30 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption30 setContractualPaymentIndicator(Payment1Code contractualPaymentIndicator) {
	...
	public CashOption30 setAccount(Account8Choice account) {
