...
public class CorporateActionGeneralInformation69 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation69.mmCorporateActionEventIdentification, CorporateActionGeneralInformation69.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation69.mmClassActionNumber, CorporateActionGeneralInformation69.mmEventProcessingType, CorporateActionGeneralInformation69.mmEventType,
						CorporateActionGeneralInformation69.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation69.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation69.mmUnderlyingSecurity);
