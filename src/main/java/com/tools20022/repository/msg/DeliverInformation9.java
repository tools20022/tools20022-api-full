...
public class DeliverInformation9 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation9.mmRequestedSettlementDate, DeliverInformation9.mmSettlementAmount, DeliverInformation9.mmStampDuty, DeliverInformation9.mmNetAmount,
						DeliverInformation9.mmSettlementPartiesDetails, DeliverInformation9.mmChargeDetails, DeliverInformation9.mmCommissionDetails, DeliverInformation9.mmTaxDetails, DeliverInformation9.mmPhysicalTransfer,
						DeliverInformation9.mmPhysicalTransferDetails);
