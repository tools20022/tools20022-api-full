 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DeliverInformation13
...
@XmlType(name = "DeliverInformation9", propOrder = {"requestedSettlementDate", "settlementAmount", "stampDuty", "netAmount", "settlementPartiesDetails", "chargeDetails", "commissionDetails", "taxDetails", "physicalTransfer",
...
public class DeliverInformation9 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation9, Optional<ISODate>> mmRequestedSettlementDate = new MMMessageAttribute<DeliverInformation9, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.DeliverInformation9.mmObject();
			isDerived = false;
			xmlTag = "ReqdSttlmDt";
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmRequestedSettlementDate);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(DeliverInformation9 obj) {
			return obj.getRequestedSettlementDate();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation9, Optional<ActiveCurrencyAndAmount>> mmSettlementAmount = new MMMessageAttribute<DeliverInformation9, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmSettlementAmount);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveCurrencyAndAmount> getValue(DeliverInformation9 obj) {
			return obj.getSettlementAmount();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<ActiveCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation9, Optional<StampDutyType2Code>> mmStampDuty = new MMMessageAttribute<DeliverInformation9, Optional<StampDutyType2Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmStampDuty);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<StampDutyType2Code> getValue(DeliverInformation9 obj) {
			return obj.getStampDuty();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<StampDutyType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation9, Optional<ActiveCurrencyAndAmount>> mmNetAmount = new MMMessageAttribute<DeliverInformation9, Optional<ActiveCurrencyAndAmount>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmNetAmount);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ActiveCurrencyAndAmount.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation9, Optional<DeliveringPartiesAndAccount8>> mmSettlementPartiesDetails = new MMMessageAssociationEnd<DeliverInformation9, Optional<DeliveringPartiesAndAccount8>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmSettlementPartiesDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveringPartiesAndAccount8> getValue(DeliverInformation9 obj) {
			return obj.getSettlementPartiesDetails();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<DeliveringPartiesAndAccount8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation9, List<Charge20>> mmChargeDetails = new MMMessageAssociationEnd<DeliverInformation9, List<Charge20>>() {
		{
			...
			name = "ChargeDetails";
			definition = "Charge related to the transfer of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmChargeDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Charge20> getValue(DeliverInformation9 obj) {
			return obj.getChargeDetails();
		}

		@Override
		public void setValue(DeliverInformation9 obj, List<Charge20> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation9, List<Commission12>> mmCommissionDetails = new MMMessageAssociationEnd<DeliverInformation9, List<Commission12>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmCommissionDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Commission12> getValue(DeliverInformation9 obj) {
			return obj.getCommissionDetails();
		}

		@Override
		public void setValue(DeliverInformation9 obj, List<Commission12> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation9, List<Tax15>> mmTaxDetails = new MMMessageAssociationEnd<DeliverInformation9, List<Tax15>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmTaxDetails);
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public List<Tax15> getValue(DeliverInformation9 obj) {
			return obj.getTaxDetails();
		}

		@Override
		public void setValue(DeliverInformation9 obj, List<Tax15> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeliverInformation9, Optional<PhysicalTransferType1Code>> mmPhysicalTransfer = new MMMessageAttribute<DeliverInformation9, Optional<PhysicalTransferType1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmPhysicalTransfer);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PhysicalTransferType1Code> getValue(DeliverInformation9 obj) {
			return obj.getPhysicalTransfer();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<PhysicalTransferType1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DeliverInformation9, Optional<DeliveryParameters4>> mmPhysicalTransferDetails = new MMMessageAssociationEnd<DeliverInformation9, Optional<DeliveryParameters4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmPhysicalTransferDetails);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<DeliveryParameters4> getValue(DeliverInformation9 obj) {
			return obj.getPhysicalTransferDetails();
		}

		@Override
		public void setValue(DeliverInformation9 obj, Optional<DeliveryParameters4> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DeliverInformation9.mmRequestedSettlementDate, com.tools20022.repository.msg.DeliverInformation9.mmSettlementAmount,
						com.tools20022.repository.msg.DeliverInformation9.mmStampDuty, com.tools20022.repository.msg.DeliverInformation9.mmNetAmount, com.tools20022.repository.msg.DeliverInformation9.mmSettlementPartiesDetails,
						com.tools20022.repository.msg.DeliverInformation9.mmChargeDetails, com.tools20022.repository.msg.DeliverInformation9.mmCommissionDetails, com.tools20022.repository.msg.DeliverInformation9.mmTaxDetails,
						com.tools20022.repository.msg.DeliverInformation9.mmPhysicalTransfer, com.tools20022.repository.msg.DeliverInformation9.mmPhysicalTransferDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInInstructionV04.mmSettlementDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPhysicalTransferDetailsRule.forDeliverInformation9,
						com.tools20022.repository.constraints.ConstraintDeliverersCustodianDetailsRule.forDeliverInformation9, com.tools20022.repository.constraints.ConstraintDeliverersIntermediaryDetailsRule.forDeliverInformation9);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeliverInformation9";
				definition = "Parameters applied to the settlement of a security transfer.";
				nextVersions_lazy = () -> Arrays.asList(DeliverInformation13.mmObject());
				previousVersion_lazy = () -> DeliverInformation5.mmObject();
			}
		});
	...
	public DeliverInformation9 setRequestedSettlementDate(ISODate requestedSettlementDate) {
	...
	public DeliverInformation9 setSettlementAmount(ActiveCurrencyAndAmount settlementAmount) {
	...
	public DeliverInformation9 setStampDuty(StampDutyType2Code stampDuty) {
	...
	public DeliverInformation9 setNetAmount(ActiveCurrencyAndAmount netAmount) {
	...
	public DeliverInformation9 setSettlementPartiesDetails(DeliveringPartiesAndAccount8 settlementPartiesDetails) {
	...
	public DeliverInformation9 setChargeDetails(List<Charge20> chargeDetails) {
	...
	public DeliverInformation9 setCommissionDetails(List<Commission12> commissionDetails) {
	...
	public DeliverInformation9 setTaxDetails(List<Tax15> taxDetails) {
	...
	public DeliverInformation9 setPhysicalTransfer(PhysicalTransferType1Code physicalTransfer) {
	...
	public DeliverInformation9 setPhysicalTransferDetails(DeliveryParameters4 physicalTransferDetails) {
