...
public class SubAccountIdentification19 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccountIdentification19.mmAccountOwner, SubAccountIdentification19.mmSafekeepingAccount, SubAccountIdentification19.mmActivityIndicator,
						SubAccountIdentification19.mmBalanceForSubAccount);
