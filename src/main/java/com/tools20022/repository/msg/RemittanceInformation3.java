...
public class RemittanceInformation3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RemittanceInformation3, Max140Text> mmUnstructured = new MMMessageAttribute<RemittanceInformation3, Max140Text>() {
		{
		...
		@Override
		public Max140Text getValue(RemittanceInformation3 obj) {
			return obj.getUnstructured();
		}

		@Override
		public void setValue(RemittanceInformation3 obj, Max140Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RemittanceInformation3, StructuredRemittanceInformation6> mmStructured = new MMMessageAssociationEnd<RemittanceInformation3, StructuredRemittanceInformation6>() {
		{
			businessComponentTrace_lazy = () -> Document.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.RemittanceInformation3.mmObject();
			isDerived = false;
		...
		@Override
		public StructuredRemittanceInformation6 getValue(RemittanceInformation3 obj) {
			return obj.getStructured();
		}

		@Override
		public void setValue(RemittanceInformation3 obj, StructuredRemittanceInformation6 value) {
	...
	public RemittanceInformation3 setStructured(StructuredRemittanceInformation6 structured) {
