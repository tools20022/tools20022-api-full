...
public class CorporateAction6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateAction6.mmDateDetails, CorporateAction6.mmPeriodDetails, CorporateAction6.mmRateAndAmountDetails, CorporateAction6.mmPriceDetails, CorporateAction6.mmSecuritiesQuantity,
						CorporateAction6.mmInterestAccruedNumberOfDays, CorporateAction6.mmCouponNumber, CorporateAction6.mmCertificationRequiredIndicator, CorporateAction6.mmChargesAppliedIndicator,
						CorporateAction6.mmRestrictionIndicator, CorporateAction6.mmAccruedInterestIndicator, CorporateAction6.mmDividendType, CorporateAction6.mmConversionType, CorporateAction6.mmDistributionType,
						CorporateAction6.mmOfferType, CorporateAction6.mmRenounceableEntitlementStatusType, CorporateAction6.mmEventStage, CorporateAction6.mmAdditionalBusinessProcessIndicator, CorporateAction6.mmChangeType,
						CorporateAction6.mmIntermediateSecuritiesDistributionType, CorporateAction6.mmCapitalGainInOutIndicator, CorporateAction6.mmTaxableIncomePerShareCalculated, CorporateAction6.mmElectionType,
						CorporateAction6.mmLotteryType, CorporateAction6.mmCertificationType, CorporateAction6.mmNewPlaceOfIncorporation, CorporateAction6.mmAdditionalInformation);
