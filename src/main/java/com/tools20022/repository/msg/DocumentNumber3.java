 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.DocumentNumber3#mmNumber
 * DocumentNumber3.mmNumber}</li>
 * </ul>
 * </li>
...
@XmlType(name = "DocumentNumber3", propOrder = "number")
public class DocumentNumber3 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.DocumentNumber3
	 * DocumentNumber3}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentNumber3.mmNumber);
	...
	public DocumentNumber3 setNumber(DocumentNumber2Choice number) {
