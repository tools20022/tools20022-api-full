...
public class IntraPositionDetails25 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails25.mmPriority, IntraPositionDetails25.mmSettlementQuantity, IntraPositionDetails25.mmSecuritiesSubBalanceIdentification, IntraPositionDetails25.mmSettlementDate,
						IntraPositionDetails25.mmBalanceFrom, IntraPositionDetails25.mmBalanceTo, IntraPositionDetails25.mmInstructionProcessingAdditionalDetails);
