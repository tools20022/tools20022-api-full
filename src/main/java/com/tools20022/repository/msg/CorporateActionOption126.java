...
public class CorporateActionOption126 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption126.mmOptionNumber, CorporateActionOption126.mmOptionType, CorporateActionOption126.mmSecuritiesMovementDetails, CorporateActionOption126.mmCashMovementDetails);
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption58> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption48> cashMovementDetails) {
