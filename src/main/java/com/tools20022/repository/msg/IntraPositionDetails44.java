...
public class IntraPositionDetails44 {
	...
	public static final MMMessageAssociationEnd mmSafekeepingPlace = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionDetails44.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlc";
	...
	protected List<com.tools20022.repository.msg.IntraPositionMovementDetails14> intraPositionMovement;
	/**
	...
	public static final MMMessageAssociationEnd mmIntraPositionMovement = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.IntraPositionMovementDetails14.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionDetails44.mmSafekeepingPlace, IntraPositionDetails44.mmBalanceFrom, IntraPositionDetails44.mmIntraPositionMovement);
	...
	public void setIntraPositionMovement(List<com.tools20022.repository.msg.IntraPositionMovementDetails14> intraPositionMovement) {
