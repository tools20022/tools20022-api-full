...
public class RequestedModification2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestedModification2.mmInstructionIdentification, RequestedModification2.mmEndToEndIdentification, RequestedModification2.mmTransactionIdentification,
						RequestedModification2.mmPaymentTypeInformation, RequestedModification2.mmRequestedExecutionDate, RequestedModification2.mmRequestedCollectionDate, RequestedModification2.mmInterbankSettlementDate,
						RequestedModification2.mmAmount, RequestedModification2.mmInterbankSettlementAmount, RequestedModification2.mmChargeBearer, RequestedModification2.mmUltimateDebtor, RequestedModification2.mmDebtor,
						RequestedModification2.mmDebtorAccount, RequestedModification2.mmDebtorAgentAccount, RequestedModification2.mmSettlementInformation, RequestedModification2.mmCreditorAgentAccount, RequestedModification2.mmCreditor,
						RequestedModification2.mmCreditorAccount, RequestedModification2.mmUltimateCreditor, RequestedModification2.mmPurpose, RequestedModification2.mmInstructionForDebtorAgent,
						RequestedModification2.mmInstructionForNextAgent, RequestedModification2.mmInstructionForCreditorAgent, RequestedModification2.mmRemittanceInformation);
	...
	public void setSettlementInformation(com.tools20022.repository.msg.SettlementInformation15 settlementInformation) {
