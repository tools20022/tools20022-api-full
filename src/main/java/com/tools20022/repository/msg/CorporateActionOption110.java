...
public class CorporateActionOption110 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption110.mmOptionNumber, CorporateActionOption110.mmOptionType, CorporateActionOption110.mmOptionFeatures, CorporateActionOption110.mmFractionDisposition,
						CorporateActionOption110.mmCurrencyOption, CorporateActionOption110.mmDateDetails, CorporateActionOption110.mmPeriodDetails, CorporateActionOption110.mmRateAndAmountDetails, CorporateActionOption110.mmPriceDetails,
						CorporateActionOption110.mmPlaceOfTrade, CorporateActionOption110.mmSecuritiesMovementDetails, CorporateActionOption110.mmCashMovementDetails);
