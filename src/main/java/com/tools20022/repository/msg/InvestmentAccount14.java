 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.msg.InvestmentAccount14#IndividualOrOrganisationOwnerIdentificationRule
 * InvestmentAccount14.IndividualOrOrganisationOwnerIdentificationRule}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.msg.InvestmentAccount14#mmOrganisationOwnerIdentification
 * InvestmentAccount14.mmOrganisationOwnerIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.InvestmentAccount14#mmAccountServicer
...
public class InvestmentAccount14 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.InvestmentAccount14
	 * InvestmentAccount14}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount14, AccountIdentification1> mmAccountIdentification = new MMMessageAttribute<InvestmentAccount14, AccountIdentification1>() {
		{
			businessElementTrace_lazy = () -> Account.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.InvestmentAccount14.mmObject();
			isDerived = false;
			xmlTag = "AcctId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountIdentification";
			definition = "Unique and unambiguous identification for the account between the account owner and the account servicer.";
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount45.mmAccountIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AccountIdentification1 getValue(InvestmentAccount14 obj) {
			return obj.getAccountIdentification();
		}

		@Override
		public void setValue(InvestmentAccount14 obj, AccountIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount14, Optional<Max35Text>> mmAccountName = new MMMessageAttribute<InvestmentAccount14, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount45.mmAccountName);
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<Max35Text> getValue(InvestmentAccount14 obj) {
			return obj.getAccountName();
		}

		@Override
		public void setValue(InvestmentAccount14 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestmentAccount14, Optional<Max35Text>> mmAccountDesignation = new MMMessageAttribute<InvestmentAccount14, Optional<Max35Text>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount45.mmAccountDesignation);
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount14, Optional<IndividualPersonIdentificationChoice>> mmIndividualOwnerIdentification = new MMMessageAssociationEnd<InvestmentAccount14, Optional<IndividualPersonIdentificationChoice>>() {
		{
		...
		@Override
		public Optional<IndividualPersonIdentificationChoice> getValue(InvestmentAccount14 obj) {
			return obj.getIndividualOwnerIdentification();
		}

		@Override
		public void setValue(InvestmentAccount14 obj, Optional<IndividualPersonIdentificationChoice> value) {
			obj.setIndividualOwnerIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "OrgOwnrId")
	protected PartyIdentification2Choice organisationOwnerIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount14, Optional<PartyIdentification2Choice>> mmOrganisationOwnerIdentification = new MMMessageAssociationEnd<InvestmentAccount14, Optional<PartyIdentification2Choice>>() {
		{
		...
		@Override
		public Optional<PartyIdentification2Choice> getValue(InvestmentAccount14 obj) {
			return obj.getOrganisationOwnerIdentification();
		}

		@Override
		public void setValue(InvestmentAccount14 obj, Optional<PartyIdentification2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InvestmentAccount14, Optional<PartyIdentification2Choice>> mmAccountServicer = new MMMessageAssociationEnd<InvestmentAccount14, Optional<PartyIdentification2Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestmentAccount45.mmAccountServicer);
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> PartyIdentification2Choice.mmObject();
	...
	public static final MMXor IndividualOrOrganisationOwnerIdentificationRule = new MMXor() {
		{
			...
			messageComponent_lazy = () -> com.tools20022.repository.msg.InvestmentAccount14.mmObject();
			impactedElements_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount14.mmIndividualOwnerIdentification, com.tools20022.repository.msg.InvestmentAccount14.mmOrganisationOwnerIdentification);
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount14.mmAccountIdentification, com.tools20022.repository.msg.InvestmentAccount14.mmAccountName,
						com.tools20022.repository.msg.InvestmentAccount14.mmAccountDesignation, com.tools20022.repository.msg.InvestmentAccount14.mmIndividualOwnerIdentification,
						com.tools20022.repository.msg.InvestmentAccount14.mmOrganisationOwnerIdentification, com.tools20022.repository.msg.InvestmentAccount14.mmAccountServicer);
				...
				name = "InvestmentAccount14";
				definition = "Account between an investor(s) and a fund manager or a fund. The account can contain holdings in any investment fund or investment fund class managed (or distributed) by the fund manager, within the same fund family.";
				nextVersions_lazy = () -> Arrays.asList(InvestmentAccount45.mmObject());
				xors_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InvestmentAccount14.IndividualOrOrganisationOwnerIdentificationRule);
			}
		});
	...
	public InvestmentAccount14 setAccountIdentification(AccountIdentification1 accountIdentification) {
	...
	public InvestmentAccount14 setAccountName(Max35Text accountName) {
	...
	public InvestmentAccount14 setAccountDesignation(Max35Text accountDesignation) {
	...
	public InvestmentAccount14 setIndividualOwnerIdentification(IndividualPersonIdentificationChoice individualOwnerIdentification) {
		this.individualOwnerIdentification = individualOwnerIdentification;
		return this;
	}

	public Optional<PartyIdentification2Choice> getOrganisationOwnerIdentification() {
		return organisationOwnerIdentification == null ? Optional.empty() : Optional.of(organisationOwnerIdentification);
	}

	public InvestmentAccount14 setOrganisationOwnerIdentification(PartyIdentification2Choice organisationOwnerIdentification) {
	...
	public InvestmentAccount14 setAccountServicer(PartyIdentification2Choice accountServicer) {
