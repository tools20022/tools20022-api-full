...
public class DeliverInformation17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliverInformation17.mmTransferor, DeliverInformation17.mmTransferorRegisteredAccount, DeliverInformation17.mmIntermediaryInformation,
						DeliverInformation17.mmRequestedSettlementDate, DeliverInformation17.mmEffectiveSettlementDate, DeliverInformation17.mmSettlementAmount, DeliverInformation17.mmStampDuty, DeliverInformation17.mmNetAmount,
						DeliverInformation17.mmChargeDetails, DeliverInformation17.mmCommissionDetails, DeliverInformation17.mmTaxDetails, DeliverInformation17.mmForeignExchangeDetails, DeliverInformation17.mmSettlementPartiesDetails,
						DeliverInformation17.mmPhysicalTransfer, DeliverInformation17.mmPhysicalTransferDetails, DeliverInformation17.mmClientReference);
