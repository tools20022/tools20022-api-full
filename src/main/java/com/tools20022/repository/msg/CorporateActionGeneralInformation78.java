...
public class CorporateActionGeneralInformation78 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation78.mmCorporateActionEventIdentification, CorporateActionGeneralInformation78.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation78.mmClassActionNumber, CorporateActionGeneralInformation78.mmEventProcessingType, CorporateActionGeneralInformation78.mmEventType,
						CorporateActionGeneralInformation78.mmMandatoryVoluntaryEventType, CorporateActionGeneralInformation78.mmAdditionalBusinessProcessIndicator, CorporateActionGeneralInformation78.mmUnderlyingSecurity);
