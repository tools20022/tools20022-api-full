	...
	public static final MMMessageAssociationEnd mmRateType = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.mmRateType;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmRateStatus = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus5.mmRateStatus;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
