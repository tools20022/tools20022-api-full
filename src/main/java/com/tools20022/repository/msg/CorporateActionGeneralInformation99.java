...
public class CorporateActionGeneralInformation99 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation99.mmCorporateActionEventIdentification, CorporateActionGeneralInformation99.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation99.mmClassActionNumber, CorporateActionGeneralInformation99.mmEventType, CorporateActionGeneralInformation99.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation99.mmFinancialInstrumentIdentification);
