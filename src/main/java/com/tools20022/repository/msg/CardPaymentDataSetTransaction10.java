...
public class CardPaymentDataSetTransaction10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentDataSetTransaction10.mmTransactionSequenceCounter, CardPaymentDataSetTransaction10.mmTraceability, CardPaymentDataSetTransaction10.mmEnvironment,
						CardPaymentDataSetTransaction10.mmContext, CardPaymentDataSetTransaction10.mmTransaction);
