...
public class Identification3 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Identification3.mmAccountOwnerTransactionIdentification, Identification3.mmAccountServicerTransactionIdentification, Identification3.mmMarketInfrastructureTransactionIdentification,
						Identification3.mmCommonIdentification, Identification3.mmTradeIdentification, Identification3.mmMasterIdentification, Identification3.mmBasketIdentification, Identification3.mmIndexIdentification,
						Identification3.mmListIdentification, Identification3.mmProgramIdentification, Identification3.mmPoolIdentification, Identification3.mmCorporateActionEventIdentification);
