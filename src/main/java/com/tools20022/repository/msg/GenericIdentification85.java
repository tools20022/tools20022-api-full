...
@XmlType(name = "GenericIdentification85", propOrder = {"type", "identification"})
public class GenericIdentification85 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification85, GenericIdentification47> mmType = new MMMessageAttribute<GenericIdentification85, GenericIdentification47>() {
		{
			businessComponentTrace_lazy = () -> GenericIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification85.mmObject();
			isDerived = false;
			xmlTag = "Tp";
		...
		@Override
		public GenericIdentification47 getValue(GenericIdentification85 obj) {
			return obj.getType();
		}

		@Override
		public void setValue(GenericIdentification85 obj, GenericIdentification47 value) {
			obj.setType(value);
		}
	};
	@XmlElement(name = "Id")
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GenericIdentification85, Optional<RestrictedFINXMax30Text>> mmIdentification = new MMMessageAttribute<GenericIdentification85, Optional<RestrictedFINXMax30Text>>() {
		{
		...
		@Override
		public Optional<RestrictedFINXMax30Text> getValue(GenericIdentification85 obj) {
			return obj.getIdentification();
		}

		@Override
		public void setValue(GenericIdentification85 obj, Optional<RestrictedFINXMax30Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification85.mmType, com.tools20022.repository.msg.GenericIdentification85.mmIdentification);
	...
	public GenericIdentification85 setType(GenericIdentification47 type) {
	...
	public GenericIdentification85 setIdentification(RestrictedFINXMax30Text identification) {
