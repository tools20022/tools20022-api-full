...
public class AdditionalQueryParameters10 {
	...
	public static final MMMessageAssociationEnd mmStatus = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AdditionalQueryParameters10.mmObject();
			isDerived = false;
			xmlTag = "Sts";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalQueryParameters10.mmStatus, AdditionalQueryParameters10.mmReason, AdditionalQueryParameters10.mmFinancialInstrumentIdentification);
	...
	public void setReason(List<Reason15Choice> reason) {
		this.reason = reason;
	}
