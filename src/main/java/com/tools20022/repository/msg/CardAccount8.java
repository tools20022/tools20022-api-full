...
public class CardAccount8 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardAccount8.mmSelectionMethod, CardAccount8.mmSelectedAccountType, CardAccount8.mmAccountName, CardAccount8.mmAccountOwner, CardAccount8.mmCurrency,
						CardAccount8.mmAccountIdentifier, CardAccount8.mmCreditReference, CardAccount8.mmServicer, CardAccount8.mmBalance, CardAccount8.mmBalanceDisplayFlag, CardAccount8.mmDefaultAccountIndicator);
