...
public class PaymentTransaction13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction13.SettlementAmount, com.tools20022.repository.msg.PaymentTransaction13.SettlementDate,
						com.tools20022.repository.msg.PaymentTransaction13.PaymentInstrument);
