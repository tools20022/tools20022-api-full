...
public class GroupHeader41 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader41.mmMessageIdentification, GroupHeader41.mmCreationDateTime, GroupHeader41.mmAuthorisation, GroupHeader41.mmBatchBooking, GroupHeader41.mmNumberOfTransactions,
						GroupHeader41.mmControlSum, GroupHeader41.mmGroupReversal, GroupHeader41.mmTotalReversedInterbankSettlementAmount, GroupHeader41.mmInterbankSettlementDate, GroupHeader41.mmSettlementInformation,
						GroupHeader41.mmInstructingAgent, GroupHeader41.mmInstructedAgent);
