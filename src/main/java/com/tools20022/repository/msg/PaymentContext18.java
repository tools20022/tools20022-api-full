 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext18#mmCardPresent
 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.msg.PaymentContext12 PaymentContext12}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PaymentContext18", propOrder = {"cardPresent", "cardholderPresent", "onLineContext", "attendanceContext", "transactionEnvironment", "transactionChannel", "attendantMessageCapable", "attendantLanguage", "cardDataEntryMode",
...
public class PaymentContext18 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PaymentContext18
	 * PaymentContext18}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>> mmCardPresent = new MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>>() {
		{
			businessElementTrace_lazy = () -> CardPaymentAcquiring.mmCardPresent;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext18.mmObject();
			isDerived = false;
			xmlTag = "CardPres";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CardPresent";
			definition = "Indicates whether the transaction has been initiated by a card physically present or not.";
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmCardPresent);
			previousVersion_lazy = () -> PaymentContext12.mmCardPresent;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TrueFalseIndicator> getValue(PaymentContext18 obj) {
			return obj.getCardPresent();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<TrueFalseIndicator> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>> mmCardholderPresent = new MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmCardholderPresent);
			previousVersion_lazy = () -> PaymentContext12.mmCardholderPresent;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>> mmOnLineContext = new MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmOnLineContext);
			previousVersion_lazy = () -> PaymentContext12.mmOnLineContext;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<AttendanceContext1Code>> mmAttendanceContext = new MMMessageAttribute<PaymentContext18, Optional<AttendanceContext1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmAttendanceContext);
			previousVersion_lazy = () -> PaymentContext12.mmAttendanceContext;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<AttendanceContext1Code> getValue(PaymentContext18 obj) {
			return obj.getAttendanceContext();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<AttendanceContext1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TransactionEnvironment1Code>> mmTransactionEnvironment = new MMMessageAttribute<PaymentContext18, Optional<TransactionEnvironment1Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmTransactionEnvironment);
			previousVersion_lazy = () -> PaymentContext12.mmTransactionEnvironment;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionEnvironment1Code> getValue(PaymentContext18 obj) {
			return obj.getTransactionEnvironment();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<TransactionEnvironment1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TransactionChannel3Code>> mmTransactionChannel = new MMMessageAttribute<PaymentContext18, Optional<TransactionChannel3Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmTransactionChannel);
			previousVersion_lazy = () -> PaymentContext12.mmTransactionChannel;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<TransactionChannel3Code> getValue(PaymentContext18 obj) {
			return obj.getTransactionChannel();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<TransactionChannel3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>> mmAttendantMessageCapable = new MMMessageAttribute<PaymentContext18, Optional<TrueFalseIndicator>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmAttendantMessageCapable);
			previousVersion_lazy = () -> PaymentContext12.mmAttendantMessageCapable;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<LanguageCode>> mmAttendantLanguage = new MMMessageAttribute<PaymentContext18, Optional<LanguageCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmAttendantLanguage);
			previousVersion_lazy = () -> PaymentContext12.mmAttendantLanguage;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<LanguageCode> getValue(PaymentContext18 obj) {
			return obj.getAttendantLanguage();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<LanguageCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<CardDataReading5Code>> mmCardDataEntryMode = new MMMessageAttribute<PaymentContext18, Optional<CardDataReading5Code>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmCardDataEntryMode);
			previousVersion_lazy = () -> PaymentContext12.mmCardDataEntryMode;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardDataReading5Code> getValue(PaymentContext18 obj) {
			return obj.getCardDataEntryMode();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<CardDataReading5Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, Optional<CardFallback1Code>> mmFallbackIndicator = new MMMessageAttribute<PaymentContext18, Optional<CardFallback1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext18.mmObject();
			isDerived = false;
			xmlTag = "FllbckInd";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmFallbackIndicator);
			previousVersion_lazy = () -> PaymentContext12.mmFallbackIndicator;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<CardFallback1Code> getValue(PaymentContext18 obj) {
			return obj.getFallbackIndicator();
		}

		@Override
		public void setValue(PaymentContext18 obj, Optional<CardFallback1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentContext18, List<SupportedPaymentOption1Code>> mmSupportedOption = new MMMessageAttribute<PaymentContext18, List<SupportedPaymentOption1Code>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentContext18.mmObject();
			isDerived = false;
			xmlTag = "SpprtdOptn";
			...
			nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmSupportedOption);
			previousVersion_lazy = () -> PaymentContext12.mmSupportedOption;
			minOccurs = 0;
			simpleType_lazy = () -> SupportedPaymentOption1Code.mmObject();
		}

		@Override
		public List<SupportedPaymentOption1Code> getValue(PaymentContext18 obj) {
			return obj.getSupportedOption();
		}

		@Override
		public void setValue(PaymentContext18 obj, List<SupportedPaymentOption1Code> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext18.mmCardPresent, com.tools20022.repository.msg.PaymentContext18.mmCardholderPresent,
						com.tools20022.repository.msg.PaymentContext18.mmOnLineContext, com.tools20022.repository.msg.PaymentContext18.mmAttendanceContext, com.tools20022.repository.msg.PaymentContext18.mmTransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext18.mmTransactionChannel, com.tools20022.repository.msg.PaymentContext18.mmAttendantMessageCapable, com.tools20022.repository.msg.PaymentContext18.mmAttendantLanguage,
						com.tools20022.repository.msg.PaymentContext18.mmCardDataEntryMode, com.tools20022.repository.msg.PaymentContext18.mmFallbackIndicator, com.tools20022.repository.msg.PaymentContext18.mmSupportedOption);
				trace_lazy = () -> CardPaymentAcquiring.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentContext18";
				definition = "Payment context in which the transaction is performed.";
				nextVersions_lazy = () -> Arrays.asList(PaymentContext24.mmObject());
				previousVersion_lazy = () -> PaymentContext12.mmObject();
			}
		});
	...
	public PaymentContext18 setCardPresent(TrueFalseIndicator cardPresent) {
	...
	public PaymentContext18 setCardholderPresent(TrueFalseIndicator cardholderPresent) {
	...
	public PaymentContext18 setOnLineContext(TrueFalseIndicator onLineContext) {
	...
	public PaymentContext18 setAttendanceContext(AttendanceContext1Code attendanceContext) {
	...
	public PaymentContext18 setTransactionEnvironment(TransactionEnvironment1Code transactionEnvironment) {
	...
	public PaymentContext18 setTransactionChannel(TransactionChannel3Code transactionChannel) {
	...
	public PaymentContext18 setAttendantMessageCapable(TrueFalseIndicator attendantMessageCapable) {
	...
	public PaymentContext18 setAttendantLanguage(LanguageCode attendantLanguage) {
	...
	public PaymentContext18 setCardDataEntryMode(CardDataReading5Code cardDataEntryMode) {
	...
	public PaymentContext18 setFallbackIndicator(CardFallback1Code fallbackIndicator) {
	...
	public PaymentContext18 setSupportedOption(List<SupportedPaymentOption1Code> supportedOption) {
