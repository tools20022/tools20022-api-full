...
public class PaymentContext18 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext18.mmCardPresent, PaymentContext18.mmCardholderPresent, PaymentContext18.mmOnLineContext, PaymentContext18.mmAttendanceContext,
						PaymentContext18.mmTransactionEnvironment, PaymentContext18.mmTransactionChannel, PaymentContext18.mmAttendantMessageCapable, PaymentContext18.mmAttendantLanguage, PaymentContext18.mmCardDataEntryMode,
						PaymentContext18.mmFallbackIndicator, PaymentContext18.mmSupportedOption);
