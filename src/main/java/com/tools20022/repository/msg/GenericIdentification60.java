...
public class GenericIdentification60 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification60.Identification, com.tools20022.repository.msg.GenericIdentification60.Issuer,
						com.tools20022.repository.msg.GenericIdentification60.SchemeName);
