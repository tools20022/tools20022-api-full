...
public class DeliveringPartiesAndAccount4 {
	...
	public static final MMMessageAssociationEnd mmDelivererDetails = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> DeliveringPartiesAndAccount4.mmObject();
			isDerived = false;
			xmlTag = "DlvrrDtls";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeliveringPartiesAndAccount4.mmDelivererDetails, DeliveringPartiesAndAccount4.mmDeliverersCustodianDetails, DeliveringPartiesAndAccount4.mmDeliverersIntermediaryDetails,
						DeliveringPartiesAndAccount4.mmDeliveringAgentDetails, DeliveringPartiesAndAccount4.mmSecuritiesSettlementSystem, DeliveringPartiesAndAccount4.mmPlaceOfSettlementDetails);
