...
public class QuantityBreakdown7 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(QuantityBreakdown7.mmLotNumber, QuantityBreakdown7.mmLotQuantity, QuantityBreakdown7.mmLotDateTime, QuantityBreakdown7.mmLotPrice, QuantityBreakdown7.mmTypeOfPrice);
