 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentInstruction12#Priority
...
public class PaymentInstruction12 {
	...
	public static final MMMessageAttribute Instruction = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction2.Instruction;
			minOccurs = 0;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.PaymentInstruction2#Type
	...
	public static final MMMessageAttribute Type = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction2.Type;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Priority = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction2.Priority;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ProcessingValidityTime = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentInstruction2.ProcessingValidityTime;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentInstruction12.Instruction, com.tools20022.repository.msg.PaymentInstruction12.Type, com.tools20022.repository.msg.PaymentInstruction12.Priority,
						com.tools20022.repository.msg.PaymentInstruction12.ProcessingValidityTime);
