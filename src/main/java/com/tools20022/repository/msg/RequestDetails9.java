...
public class RequestDetails9 {
	...
	protected List<com.tools20022.repository.msg.Linkages23> linkages;
	/**
	...
	public static final MMMessageAssociationEnd mmLinkages = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.Linkages23.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RequestDetails9.mmReference, RequestDetails9.mmAutomaticBorrowing, RequestDetails9.mmRetainIndicator, RequestDetails9.mmLinkage, RequestDetails9.mmPriority,
						RequestDetails9.mmOtherProcessing, RequestDetails9.mmPartialSettlementIndicator, RequestDetails9.mmSecuritiesRTGS, RequestDetails9.mmHoldIndicator, RequestDetails9.mmMatchingDenial,
						RequestDetails9.mmUnilateralSplit, RequestDetails9.mmLinkages);
	...
	public void setLinkages(List<com.tools20022.repository.msg.Linkages23> linkages) {
