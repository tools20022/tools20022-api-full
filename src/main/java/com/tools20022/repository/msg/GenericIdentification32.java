	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification53.Identification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Type = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification53.Type);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Issuer = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification53.Issuer);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ShortName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification53.ShortName);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(GenericIdentification53.mmObject());
			}
		});
