...
public class AccountAndBalance20 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountAndBalance20.mmSafekeepingAccount, AccountAndBalance20.mmAccountOwner, AccountAndBalance20.mmSafekeepingPlace, AccountAndBalance20.mmBalance);
