...
public class EventInformation6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(EventInformation6.mmCorporateActionEventIdentification, EventInformation6.mmOfficialCorporateActionEventIdentification, EventInformation6.mmEventType,
						EventInformation6.mmMandatoryVoluntaryEventType, EventInformation6.mmLastNotificationIdentification);
