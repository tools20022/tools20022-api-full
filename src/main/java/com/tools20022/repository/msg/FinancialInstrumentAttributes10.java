...
public class FinancialInstrumentAttributes10 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes10.mmSecurityIdentification, FinancialInstrumentAttributes10.mmPlaceOfListing, FinancialInstrumentAttributes10.mmDayCountBasis,
						FinancialInstrumentAttributes10.mmClassificationType, FinancialInstrumentAttributes10.mmOptionStyle, FinancialInstrumentAttributes10.mmDenominationCurrency, FinancialInstrumentAttributes10.mmNextCouponDate,
						FinancialInstrumentAttributes10.mmFloatingRateFixingDate, FinancialInstrumentAttributes10.mmMaturityDate, FinancialInstrumentAttributes10.mmIssueDate, FinancialInstrumentAttributes10.mmNextCallableDate,
						FinancialInstrumentAttributes10.mmPutableDate, FinancialInstrumentAttributes10.mmDatedDate, FinancialInstrumentAttributes10.mmConversionDate, FinancialInstrumentAttributes10.mmPreviousFactor,
						FinancialInstrumentAttributes10.mmNextFactor, FinancialInstrumentAttributes10.mmInterestRate, FinancialInstrumentAttributes10.mmNextInterestRate, FinancialInstrumentAttributes10.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes10.mmMinimumExercisableQuantity, FinancialInstrumentAttributes10.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes10.mmContractSize,
						FinancialInstrumentAttributes10.mmIssuePrice);
