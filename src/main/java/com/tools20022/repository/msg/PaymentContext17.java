...
public class PaymentContext17 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentContext17.mmCardPresent, PaymentContext17.mmCardholderPresent, PaymentContext17.mmOnLineContext, PaymentContext17.mmAttendanceContext,
						PaymentContext17.mmTransactionEnvironment, PaymentContext17.mmTransactionChannel, PaymentContext17.mmCardDataEntryMode, PaymentContext17.mmFallbackIndicator);
