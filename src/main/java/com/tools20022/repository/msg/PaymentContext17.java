 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext17#CardPresent
 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentContext17#OnLineContext
...
public class PaymentContext17 {
	...
	public static final MMMessageAttribute CardPresent = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentContext17.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.CardPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.CardPresent);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardholderPresent = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.CardholderPresent;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.CardholderPresent);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute OnLineContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.OnLineContext;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.OnLineContext);
			minOccurs = 0;
			maxOccurs = 1;
			simpleType_lazy = () -> TrueFalseIndicator.mmObject();
		}
	...
	public static final MMMessageAttribute AttendanceContext = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.AttendanceContext;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.AttendanceContext);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionEnvironment = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.TransactionEnvironment;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.TransactionEnvironment);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute TransactionChannel = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.TransactionChannel;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.TransactionChannel);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CardDataEntryMode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.CardDataEntryMode;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.CardDataEntryMode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute FallbackIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentContext11.FallbackIndicator;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext23.FallbackIndicator);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentContext17.CardPresent, com.tools20022.repository.msg.PaymentContext17.CardholderPresent,
						com.tools20022.repository.msg.PaymentContext17.OnLineContext, com.tools20022.repository.msg.PaymentContext17.AttendanceContext, com.tools20022.repository.msg.PaymentContext17.TransactionEnvironment,
						com.tools20022.repository.msg.PaymentContext17.TransactionChannel, com.tools20022.repository.msg.PaymentContext17.CardDataEntryMode, com.tools20022.repository.msg.PaymentContext17.FallbackIndicator);
