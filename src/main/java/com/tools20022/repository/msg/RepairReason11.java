...
public class RepairReason11 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RepairReason11.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairReason11.mmCode, RepairReason11.mmAdditionalReasonInformation);
	...
	public void setCode(RepairReason13Choice code) {
		this.code = code;
	}
