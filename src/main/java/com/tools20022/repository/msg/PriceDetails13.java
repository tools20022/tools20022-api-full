 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline#forPriceDetails13
 * ConstraintGenericCashPricePerProductGuideline.forPriceDetails13}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceDetails13", propOrder = {"genericCashPricePaidPerProduct", "genericCashPriceReceivedPerProduct"})
public class PriceDetails13 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails13, Optional<PriceFormat27Choice>> mmGenericCashPricePaidPerProduct = new MMMessageAssociationEnd<PriceDetails13, Optional<PriceFormat27Choice>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionPrice.mmGenericCashPricePaidPerProduct;
			componentContext_lazy = () -> com.tools20022.repository.msg.PriceDetails13.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<PriceFormat27Choice> getValue(PriceDetails13 obj) {
			return obj.getGenericCashPricePaidPerProduct();
		}

		@Override
		public void setValue(PriceDetails13 obj, Optional<PriceFormat27Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceDetails13, Optional<PriceFormat26Choice>> mmGenericCashPriceReceivedPerProduct = new MMMessageAssociationEnd<PriceDetails13, Optional<PriceFormat26Choice>>() {
		{
		...
		@Override
		public Optional<PriceFormat26Choice> getValue(PriceDetails13 obj) {
			return obj.getGenericCashPriceReceivedPerProduct();
		}

		@Override
		public void setValue(PriceDetails13 obj, Optional<PriceFormat26Choice> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forPriceDetails13);
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PriceDetails13";
	...
	public PriceDetails13 setGenericCashPricePaidPerProduct(PriceFormat27Choice genericCashPricePaidPerProduct) {
	...
	public PriceDetails13 setGenericCashPriceReceivedPerProduct(PriceFormat26Choice genericCashPriceReceivedPerProduct) {
