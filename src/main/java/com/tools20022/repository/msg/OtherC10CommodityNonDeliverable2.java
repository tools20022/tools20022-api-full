...
public class OtherC10CommodityNonDeliverable2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OtherC10CommodityNonDeliverable2.BaseProduct, com.tools20022.repository.msg.OtherC10CommodityNonDeliverable2.SubProduct);
