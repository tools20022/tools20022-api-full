...
public class IntraPosition4 {
	...
	public static final MMMessageAssociationEnd mmFinancialInstrumentIdentification = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPosition4.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPosition4.mmFinancialInstrumentIdentification, IntraPosition4.mmSettlementQuantity, IntraPosition4.mmSettlementDate, IntraPosition4.mmBalanceFrom, IntraPosition4.mmBalanceTo,
						IntraPosition4.mmSecuritiesSubBalanceIdentification, IntraPosition4.mmPriority);
