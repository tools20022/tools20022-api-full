...
public class AccountIdentification31 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification31.mmSafekeepingAccount, AccountIdentification31.mmAccountOwner, AccountIdentification31.mmSafekeepingPlace);
