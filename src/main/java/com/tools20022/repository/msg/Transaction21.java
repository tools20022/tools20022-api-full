...
public class Transaction21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction21.mmAccountOwnerTransactionIdentification, Transaction21.mmAccountServicerTransactionIdentification, Transaction21.mmMarketInfrastructureTransactionIdentification,
						Transaction21.mmProcessorTransactionIdentification, Transaction21.mmTradeIdentification, Transaction21.mmPoolIdentification, Transaction21.mmCommonIdentification, Transaction21.mmCorporateActionEventIdentification,
						Transaction21.mmTripartyAgentCollateralTransactionIdentification, Transaction21.mmClientTripartyCollateralTransactionIdentification, Transaction21.mmTransactionDetails, Transaction21.mmSupplementaryData);
