	...
	public static final MMMessageAttribute mmCancellationIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmCancellationIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmCancellationIdentification;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmCase = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmCase);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmCase;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalGroupInformation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalGroupInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalGroupInformation;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmOriginalInstructionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalInstructionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInstructionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalEndToEndIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalEndToEndIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalEndToEndIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalTransactionIdentification);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalClearingSystemReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalClearingSystemReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalClearingSystemReference;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute mmOriginalInterbankSettlementAmount = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalInterbankSettlementAmount);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInterbankSettlementAmount;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAttribute mmOriginalInterbankSettlementDate = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalInterbankSettlementDate);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalInterbankSettlementDate;
			maxOccurs = 1;
			minOccurs = 0;
	...
	public static final MMMessageAssociationEnd mmAssigner = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmAssigner);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmAssigner;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAssignee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmAssignee);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmAssignee;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5.mmObject();
	...
	public static final MMMessageAssociationEnd mmCancellationReasonInformation = new MMMessageAssociationEnd() {
		{
			...
			definition = "Provides detailed information on the cancellation reason.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmCancellationReasonInformation);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmCancellationReasonInformation;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmOriginalTransactionReference = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmOriginalTransactionReference);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmOriginalTransactionReference;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute mmSupplementaryData = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction62.mmSupplementaryData);
			previousVersion_lazy = () -> com.tools20022.repository.msg.PaymentTransaction48.mmSupplementaryData;
			minOccurs = 0;
