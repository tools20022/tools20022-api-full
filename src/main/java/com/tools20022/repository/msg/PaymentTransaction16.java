...
public class PaymentTransaction16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction16.SettlementAmount, com.tools20022.repository.msg.PaymentTransaction16.SettlementDate,
						com.tools20022.repository.msg.PaymentTransaction16.PaymentInstrument);
