...
public class References16 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References16.mmAccountOwnerTransactionIdentification, References16.mmAccountServicerTransactionIdentification, References16.mmMarketInfrastructureTransactionIdentification,
						References16.mmProcessorTransactionIdentification, References16.mmPoolIdentification, References16.mmCommonIdentification, References16.mmTradeIdentification);
