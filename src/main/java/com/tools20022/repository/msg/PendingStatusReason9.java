...
public class PendingStatusReason9 {
	...
	public static final MMMessageAssociationEnd ReasonCode = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PendingStatusReason9.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason2.ReasonCode;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalReasonInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.PendingStatusReason2.AdditionalReasonInformation;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason9.ReasonCode, com.tools20022.repository.msg.PendingStatusReason9.AdditionalReasonInformation);
