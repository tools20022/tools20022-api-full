...
public class CorporateActionGeneralInformation86 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation86.mmCorporateActionEventIdentification, CorporateActionGeneralInformation86.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation86.mmClassActionNumber, CorporateActionGeneralInformation86.mmEventType, CorporateActionGeneralInformation86.mmMandatoryVoluntaryEventType,
						CorporateActionGeneralInformation86.mmFinancialInstrumentIdentification);
