...
public class SystemDetails2 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SystemDetails2.mmSystemIdentification, SystemDetails2.mmMemberIdentification, SystemDetails2.mmCountry, SystemDetails2.mmAccountIdentification);
	...
	public CashClearingSystem1Code getSystemIdentification() {
		return systemIdentification;
	}

	public void setSystemIdentification(CashClearingSystem1Code systemIdentification) {
