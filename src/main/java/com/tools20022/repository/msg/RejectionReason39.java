...
public class RejectionReason39 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason39.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason39.mmCode, RejectionReason39.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason33Choice code) {
		this.code = code;
	}
