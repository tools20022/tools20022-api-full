...
public class AdditionalRights2 {
	...
	public static final MMMessageAttribute AdditionalRight = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalRights1.AdditionalRight;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalRightInformationURLAddress = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalRights1.AdditionalRightInformationURLAddress;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalRightDeadline = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalRights1.AdditionalRightDeadline;
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AdditionalRightMarketDeadline = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalRights1.AdditionalRightMarketDeadline;
			minOccurs = 0;
			maxOccurs = 1;
			complexType_lazy = () -> DateFormat29Choice.mmObject();
		}
	...
	public static final MMMessageAttribute AdditionalRightThreshold = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.msg.AdditionalRights1.AdditionalRightThreshold;
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AdditionalRights2.AdditionalRight, com.tools20022.repository.msg.AdditionalRights2.AdditionalRightInformationURLAddress,
						com.tools20022.repository.msg.AdditionalRights2.AdditionalRightDeadline, com.tools20022.repository.msg.AdditionalRights2.AdditionalRightMarketDeadline,
