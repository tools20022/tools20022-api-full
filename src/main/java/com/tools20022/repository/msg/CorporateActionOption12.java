...
public class CorporateActionOption12 {
	...
	public static final MMMessageAttribute mmOptionNumber = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption12.mmObject();
			isDerived = false;
			xmlTag = "OptnNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption12.mmOptionNumber, CorporateActionOption12.mmOptionType, CorporateActionOption12.mmSecuritiesMovementDetails, CorporateActionOption12.mmCashMovementDetails);
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption5> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption5> cashMovementDetails) {
