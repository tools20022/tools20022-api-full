...
public class SettlementTypeAndIdentification6 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SettlementTypeAndIdentification6.TransactionIdentification, com.tools20022.repository.msg.SettlementTypeAndIdentification6.SecuritiesMovementType,
						com.tools20022.repository.msg.SettlementTypeAndIdentification6.Payment);
