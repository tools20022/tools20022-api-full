...
public class SettlementTypeAndIdentification6 {
	...
	public static final MMMessageAttribute mmTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTypeAndIdentification6.mmObject();
			isDerived = false;
			xmlTag = "TxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTypeAndIdentification6.mmTransactionIdentification, SettlementTypeAndIdentification6.mmSecuritiesMovementType, SettlementTypeAndIdentification6.mmPayment);
