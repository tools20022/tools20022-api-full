...
public class FinancialInstrumentAttributes40 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentAttributes40.mmFinancialInstrumentIdentification, FinancialInstrumentAttributes40.mmPlaceOfListing, FinancialInstrumentAttributes40.mmDayCountBasis,
						FinancialInstrumentAttributes40.mmClassificationType, FinancialInstrumentAttributes40.mmOptionStyle, FinancialInstrumentAttributes40.mmDenominationCurrency, FinancialInstrumentAttributes40.mmNextCouponDate,
						FinancialInstrumentAttributes40.mmFloatingRateFixingDate, FinancialInstrumentAttributes40.mmMaturityDate, FinancialInstrumentAttributes40.mmIssueDate, FinancialInstrumentAttributes40.mmNextCallableDate,
						FinancialInstrumentAttributes40.mmPutableDate, FinancialInstrumentAttributes40.mmDatedDate, FinancialInstrumentAttributes40.mmConversionDate, FinancialInstrumentAttributes40.mmPreviousFactor,
						FinancialInstrumentAttributes40.mmNextFactor, FinancialInstrumentAttributes40.mmInterestRate, FinancialInstrumentAttributes40.mmNextInterestRate, FinancialInstrumentAttributes40.mmMinimumNominalQuantity,
						FinancialInstrumentAttributes40.mmMinimumExercisableQuantity, FinancialInstrumentAttributes40.mmMinimumExercisableMultipleQuantity, FinancialInstrumentAttributes40.mmContractSize,
						FinancialInstrumentAttributes40.mmIssuePrice);
