 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.AmountAndDirection19#mmAmount
...
@XmlType(name = "AmountAndDirection19", propOrder = {"amount", "creditDebit"})
public class AmountAndDirection19 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.AmountAndDirection19
	 * AmountAndDirection19}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AmountAndDirection19.mmAmount, com.tools20022.repository.msg.AmountAndDirection19.mmCreditDebit);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AmountAndDirection19";
	...
	public AmountAndDirection19 setAmount(RestrictedFINActiveCurrencyAndAmount amount) {
	...
	public AmountAndDirection19 setCreditDebit(CreditDebitCode creditDebit) {
