...
@XmlType(name = "FinancialInstrumentAttributes65", propOrder = {"financialInstrumentIdentification", "placeOfListing", "dayCountBasis", "classificationType", "denominationCurrency", "nextCouponDate", "expiryDate", "floatingRateFixingDate",
...
public class FinancialInstrumentAttributes65 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<SecurityIdentification19>> mmFinancialInstrumentIdentification = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<SecurityIdentification19>>() {
		{
			businessElementTrace_lazy = () -> Security.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmObject();
			isDerived = false;
			xmlTag = "FinInstrmId";
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmFinancialInstrumentIdentification);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmFinancialInstrumentIdentification;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<SecurityIdentification19> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getFinancialInstrumentIdentification();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<SecurityIdentification19> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<MarketIdentification3Choice>> mmPlaceOfListing = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<MarketIdentification3Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmPlaceOfListing);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmPlaceOfListing;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<MarketIdentification3Choice> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getPlaceOfListing();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<MarketIdentification3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<InterestComputationMethodFormat4Choice>> mmDayCountBasis = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<InterestComputationMethodFormat4Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmDayCountBasis);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmDayCountBasis;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<InterestComputationMethodFormat4Choice> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getDayCountBasis();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<InterestComputationMethodFormat4Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<ClassificationType32Choice>> mmClassificationType = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<ClassificationType32Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmClassificationType);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmClassificationType;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<ClassificationType32Choice> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getClassificationType();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<ClassificationType32Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ActiveOrHistoricCurrencyCode>> mmDenominationCurrency = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ActiveOrHistoricCurrencyCode>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmDenominationCurrency);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmDenominationCurrency;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyCode> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getDenominationCurrency();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<ActiveOrHistoricCurrencyCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmNextCouponDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmNextCouponDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmNextCouponDate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<ISODate> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getNextCouponDate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmExpiryDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmExpiryDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmExpiryDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmFloatingRateFixingDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmFloatingRateFixingDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmFloatingRateFixingDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmMaturityDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmMaturityDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmMaturityDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmIssueDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmIssueDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmIssueDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmNextCallableDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmNextCallableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmNextCallableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmPutableDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmPutableDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmPutableDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmDatedDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmDatedDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmDatedDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>> mmConversionDate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<ISODate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmConversionDate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmConversionDate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<BaseOne14Rate>> mmPreviousFactor = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<BaseOne14Rate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmPreviousFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmPreviousFactor;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<BaseOne14Rate> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getPreviousFactor();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<BaseOne14Rate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<BaseOne14Rate>> mmNextFactor = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<BaseOne14Rate>>() {
		{
			businessElementTrace_lazy = () -> Debt.mmFactor;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmNextFactor);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmNextFactor;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> BaseOne14Rate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<PercentageRate>> mmInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<PercentageRate>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
		...
		@Override
		public Optional<PercentageRate> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getInterestRate();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<PercentageRate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentAttributes65, Optional<PercentageRate>> mmNextInterestRate = new MMMessageAttribute<FinancialInstrumentAttributes65, Optional<PercentageRate>>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmNextInterestRate);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmNextInterestRate;
			maxOccurs = 1;
			minOccurs = 0;
			simpleType_lazy = () -> PercentageRate.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<FinancialInstrumentQuantity1Choice>> mmMinimumNominalQuantity = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmMinimumNominalQuantity);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmMinimumNominalQuantity;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(FinancialInstrumentAttributes65 obj) {
			return obj.getMinimumNominalQuantity();
		}

		@Override
		public void setValue(FinancialInstrumentAttributes65 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<FinancialInstrumentQuantity1Choice>> mmContractSize = new MMMessageAssociationEnd<FinancialInstrumentAttributes65, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmContractSize);
			previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmContractSize;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentQuantity1Choice.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmFinancialInstrumentIdentification, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmPlaceOfListing,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmDayCountBasis, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmClassificationType,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmDenominationCurrency, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmNextCouponDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmExpiryDate, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmFloatingRateFixingDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmMaturityDate, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmIssueDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmNextCallableDate, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmPutableDate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmDatedDate, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmConversionDate,
						...
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmInterestRate, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmNextInterestRate,
						com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmMinimumNominalQuantity, com.tools20022.repository.msg.FinancialInstrumentAttributes65.mmContractSize);
				trace_lazy = () -> Asset.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPreviousNextFactorRule.forFinancialInstrumentAttributes65);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentAttributes65";
				definition = "Description of the financial instrument.";
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentAttributes81.mmObject());
				previousVersion_lazy = () -> FinancialInstrumentAttributes50.mmObject();
			}
		});
	...
	public FinancialInstrumentAttributes65 setFinancialInstrumentIdentification(SecurityIdentification19 financialInstrumentIdentification) {
	...
	public FinancialInstrumentAttributes65 setPlaceOfListing(MarketIdentification3Choice placeOfListing) {
	...
	public FinancialInstrumentAttributes65 setDayCountBasis(InterestComputationMethodFormat4Choice dayCountBasis) {
	...
	public FinancialInstrumentAttributes65 setClassificationType(ClassificationType32Choice classificationType) {
	...
	public FinancialInstrumentAttributes65 setDenominationCurrency(ActiveOrHistoricCurrencyCode denominationCurrency) {
	...
	public FinancialInstrumentAttributes65 setNextCouponDate(ISODate nextCouponDate) {
	...
	public FinancialInstrumentAttributes65 setExpiryDate(ISODate expiryDate) {
	...
	public FinancialInstrumentAttributes65 setFloatingRateFixingDate(ISODate floatingRateFixingDate) {
	...
	public FinancialInstrumentAttributes65 setMaturityDate(ISODate maturityDate) {
	...
	public FinancialInstrumentAttributes65 setIssueDate(ISODate issueDate) {
	...
	public FinancialInstrumentAttributes65 setNextCallableDate(ISODate nextCallableDate) {
	...
	public FinancialInstrumentAttributes65 setPutableDate(ISODate putableDate) {
	...
	public FinancialInstrumentAttributes65 setDatedDate(ISODate datedDate) {
	...
	public FinancialInstrumentAttributes65 setConversionDate(ISODate conversionDate) {
	...
	public FinancialInstrumentAttributes65 setPreviousFactor(BaseOne14Rate previousFactor) {
	...
	public FinancialInstrumentAttributes65 setNextFactor(BaseOne14Rate nextFactor) {
	...
	public FinancialInstrumentAttributes65 setInterestRate(PercentageRate interestRate) {
	...
	public FinancialInstrumentAttributes65 setNextInterestRate(PercentageRate nextInterestRate) {
	...
	public FinancialInstrumentAttributes65 setMinimumNominalQuantity(FinancialInstrumentQuantity1Choice minimumNominalQuantity) {
	...
	public FinancialInstrumentAttributes65 setContractSize(FinancialInstrumentQuantity1Choice contractSize) {
