...
public class AmendmentReasonInformation1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AmendmentReasonInformation1.mmOriginator, AmendmentReasonInformation1.mmReason, AmendmentReasonInformation1.mmAdditionalInformation);
