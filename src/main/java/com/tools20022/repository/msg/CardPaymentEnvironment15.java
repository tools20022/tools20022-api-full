...
public class CardPaymentEnvironment15 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CardPaymentEnvironment15.mmAcquirer, CardPaymentEnvironment15.mmMerchantIdentification, CardPaymentEnvironment15.mmPOIIdentification);
