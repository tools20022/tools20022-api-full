...
public class ActiveCurrencyAndAmountRange1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ActiveCurrencyAndAmountRange1.mmAmount, ActiveCurrencyAndAmountRange1.mmCreditDebitIndicator, ActiveCurrencyAndAmountRange1.mmCurrency);
