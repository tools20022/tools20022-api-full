...
public class ActiveCurrencyAndAmountRange1 {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ActiveCurrencyAndAmountRange1.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ActiveCurrencyAndAmountRange1.Amount, com.tools20022.repository.msg.ActiveCurrencyAndAmountRange1.CreditDebitIndicator,
						com.tools20022.repository.msg.ActiveCurrencyAndAmountRange1.Currency);
