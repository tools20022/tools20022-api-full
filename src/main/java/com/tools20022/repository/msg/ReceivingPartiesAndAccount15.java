...
public class ReceivingPartiesAndAccount15 {
	...
	public static final MMMessageAssociationEnd mmDepository = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ReceivingPartiesAndAccount10.mmDepository;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmParty1 = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ReceivingPartiesAndAccount10.mmParty1;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmParty2 = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> ReceivingPartiesAndAccount10.mmParty2;
			maxOccurs = 1;
			minOccurs = 0;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				previousVersion_lazy = () -> ReceivingPartiesAndAccount10.mmObject();
			}
		});
	...
	public ReceivingPartiesAndAccount15 setParty1(com.tools20022.repository.msg.PartyIdentificationAndAccount126 party1) {
	...
	public ReceivingPartiesAndAccount15 setParty2(com.tools20022.repository.msg.PartyIdentificationAndAccount127 party2) {
		this.party2 = party2;
		return this;
	}
}