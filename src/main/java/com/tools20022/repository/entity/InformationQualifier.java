...
public class InformationQualifier {
	...
	public static final MMBusinessAttribute IsFormatted = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InformationQualifierType.IsFormatted);
			elementContext_lazy = () -> InformationQualifier.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "IsFormatted";
	...
	public static final MMBusinessAttribute Priority = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.InformationQualifierType.Priority);
			elementContext_lazy = () -> InformationQualifier.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Priority";
