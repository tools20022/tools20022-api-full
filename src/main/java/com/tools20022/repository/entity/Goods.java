 ...
 * Baseline5.Goods}</li>
 * <li>{@linkplain com.tools20022.repository.msg.CommercialDataSet5#Goods
 * CommercialDataSet5.Goods}</li>
 * </ul>
 * </li>
...
public class Goods extends Product {
	...
	public static final MMBusinessAttribute Analysis = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CertifiedCharacteristics1Choice.Analysis, com.tools20022.repository.choice.CertifiedCharacteristics2Choice.Analysis);
			elementContext_lazy = () -> Goods.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Analysis";
	...
	public static final MMBusinessAttribute HealthCheck = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CertifiedCharacteristics1Choice.HealthIndication, com.tools20022.repository.choice.CertifiedCharacteristics2Choice.HealthIndication);
			elementContext_lazy = () -> Goods.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "HealthCheck";
	...
	public static final MMBusinessAttribute PhytosanitaryInspection = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CertifiedCharacteristics1Choice.PhytosanitaryIndication, com.tools20022.repository.choice.CertifiedCharacteristics2Choice.PhytosanitaryIndication);
			elementContext_lazy = () -> Goods.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CommercialDataSet2.Goods, com.tools20022.repository.msg.CommercialDataSet3.Goods, com.tools20022.repository.msg.Baseline4.Goods,
						com.tools20022.repository.msg.CommercialDataSet4.Goods, com.tools20022.repository.msg.Baseline5.Goods, com.tools20022.repository.msg.CommercialDataSet5.Goods);
