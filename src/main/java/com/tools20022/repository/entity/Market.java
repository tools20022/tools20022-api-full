...
public class Market {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.MarketIdentification92#Country
	...
	public static final MMBusinessAssociationEnd Country = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification92.Country);
			elementContext_lazy = () -> Market.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Country";
	...
	public static final MMBusinessAttribute GeographicalEnvironment = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Trade2.PlaceOfConfirmation, com.tools20022.repository.msg.Trade1.PlaceOfConfirmation);
			elementContext_lazy = () -> Market.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	 ...
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.MarketIdentification92#Segment
	...
	public static final MMBusinessAssociationEnd Identification = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeMarket1Choice.Code, com.tools20022.repository.choice.TradeMarket1Choice.Proprietary, com.tools20022.repository.msg.MarketIdentification92.Operating,
					com.tools20022.repository.msg.MarketIdentification92.Segment);
			elementContext_lazy = () -> Market.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Identification";
