...
public class ContactPoint {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ContactAttributes1#Identification
	 * ContactAttributes1.Identification}</li>
	 * <li>
	...
	public static final MMBusinessAttribute BICAddress = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ContactAttributes1.Identification, com.tools20022.repository.msg.MemberDetails.MemberReturnAddress, com.tools20022.repository.msg.Member1.ReturnAddress);
			elementContext_lazy = () -> ContactPoint.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "BICAddress";
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.PostalAddress3#NameAndAddress
	...
	public static final MMBusinessAssociationEnd RelatedParty = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PostalAddress3.NameAndAddress);
			elementContext_lazy = () -> ContactPoint.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "RelatedParty";
	...
	public static final MMBusinessAssociationEnd ReturnAddress = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MemberDetails1.MemberReturnAddress);
			elementContext_lazy = () -> ContactPoint.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "ReturnAddress";
	...
	public static final MMBusinessAssociationEnd InvestmentFundClassProcessing = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OrderDeskContactDetails.ApplicationForms, com.tools20022.repository.msg.OrderDeskContactDetails.SignatureRequiredInitialSubscription,
					com.tools20022.repository.msg.OrderDeskContactDetails.SignatureRequiredSubsequentSubscription, com.tools20022.repository.msg.OrderDeskContactDetails.SignatureRequiredRedemption,
					com.tools20022.repository.msg.OrderDeskContactDetails.SubscriptionProcessingCharacteristics, com.tools20022.repository.msg.OrderDeskContactDetails.RedemptionProcessingCharacteristics);
			elementContext_lazy = () -> ContactPoint.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RemittanceLocation1.RemittanceLocationElectronicAddress, com.tools20022.repository.msg.RemittanceLocation2.RemittanceLocationElectronicAddress,
						com.tools20022.repository.msg.RemittanceLocation3.RemittanceLocationDetails, com.tools20022.repository.msg.RemittanceLocation4.RemittanceLocationDetails);
