...
public class AccountLink {
	...
	public static final MMBusinessAssociationEnd CashAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountLink1.CashAccount, com.tools20022.repository.msg.AccountLink2.CashAccount);
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountLink1#SecuritiesAccount
	 * AccountLink1.SecuritiesAccount}</li>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountLink2#SecuritiesAccount
	...
	public static final MMBusinessAssociationEnd SecuritiesAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountLink1.SecuritiesAccount, com.tools20022.repository.msg.AccountLink2.SecuritiesAccount);
			elementContext_lazy = () -> AccountLink.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute CashSettlementIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountLink1.CashSettlementIndicator);
			elementContext_lazy = () -> AccountLink.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute CollateralisationIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountLink1.CollateralisationIndicator);
			elementContext_lazy = () -> AccountLink.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AccountLink1#DefaultIndicator
	...
	public static final MMBusinessAttribute DefaultIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AccountLink1.DefaultIndicator);
			elementContext_lazy = () -> AccountLink.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
