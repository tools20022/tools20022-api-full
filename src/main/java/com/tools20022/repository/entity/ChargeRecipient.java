 ...
 * <p>
 * <embed name="ChargeRecipient" src="doc-files/ChargeRecipient.svg">
 * <p>
 ...
 * </ul>
 */
public class ChargeRecipient extends ChargePartyRole {
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Charges5.mmChargesPayee);
