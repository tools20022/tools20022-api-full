...
public class SystemAvailability {
	...
	public static final MMBusinessAssociationEnd AvailableSessionPeriod = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.SystemAvailabilityAndEventsDetails1.SessionPeriod, com.tools20022.repository.msg.SystemAvailabilityAndEvents1.SessionPeriod);
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.NettingCutOff1.NewCutOff);
