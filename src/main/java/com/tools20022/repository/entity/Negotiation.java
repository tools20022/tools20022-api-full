...
public class Negotiation {
	...
	public static final MMBusinessAttribute TradingMethod = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GeneralInformation1.DealingMethod, com.tools20022.repository.msg.GeneralInformation4.DealingMethod,
					com.tools20022.repository.msg.GeneralInformation2.DealingMethod, com.tools20022.repository.msg.GeneralInformation5.DealingMethod);
	...
	public static final MMBusinessAttribute NegotiationIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ListExecution1.ClientBidIdentification);
			elementContext_lazy = () -> Negotiation.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
