...
public class Discretion {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.DiscretionInstructions1#Offset
	...
	public static final MMBusinessAttribute Offset = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.Offset);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Offset";
	...
	public static final MMBusinessAttribute OffsetSign = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.OffsetSign);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "OffsetSign";
	...
	public static final MMBusinessAttribute RelatedPriceType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.RelatedPriceType);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute MoveType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.MoveType);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "MoveType";
	...
	public static final MMBusinessAttribute LimitType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.LimitType);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "LimitType";
	...
	public static final MMBusinessAttribute RoundDirection = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.RoundDirection);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "RoundDirection";
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.DiscretionInstructions1#Scope
	...
	public static final MMBusinessAttribute Scope = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.Scope, com.tools20022.repository.msg.OrderParameters1.PriceProtectionScope);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Scope";
	...
	public static final MMBusinessAttribute OffsetType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DiscretionInstructions1.OffsetType);
			elementContext_lazy = () -> Discretion.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "OffsetType";
