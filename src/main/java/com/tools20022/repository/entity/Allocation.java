...
public class Allocation {
	...
	public static final MMBusinessAttribute Percentage = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingAttributes.AllocationPercent, com.tools20022.repository.msg.UnderlyingAttributes2.AllocationPercentage);
	...
	public static final MMBusinessAssociationEnd AllocatedQuantity = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PreAllocation1.AllocatedQuantity, com.tools20022.repository.msg.SyndicatedLoan1.Share);
			elementContext_lazy = () -> Allocation.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute SettlementCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PreAllocation1.AllocatedSettlementCurrency);
			elementContext_lazy = () -> Allocation.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd AllocationAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PreAllocation1.AllocationAccountDetails);
			elementContext_lazy = () -> Allocation.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
