...
import com.tools20022.repository.msg.Consignment1;
 ...
 * derivationElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.Packaging1#Type
 * Packaging1.Type}</li>
 * </ul>
 * </li>
 * <li>
...
public class Packaging {
	...
	public static final MMBusinessAssociationEnd Quantity = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItem10.PackageQuantity, com.tools20022.repository.msg.LineItem16.PackageQuantity);
	...
	public static final MMBusinessAssociationEnd PerPackageUnitQuantity = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LineItem10.PerPackageUnitQuantity, com.tools20022.repository.msg.LineItem16.PerPackageUnitQuantity);
			elementContext_lazy = () -> Packaging.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	 ...
	 * derivation} =
	 * <ul>
	 * <li>{@linkplain com.tools20022.repository.msg.Packaging1#Name
	 * Packaging1.Name}</li>
	 * </ul>
	 * </li>
	 * <li>
	...
	public static final MMBusinessAttribute PackagingName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Packaging1.Name);
			elementContext_lazy = () -> Packaging.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "PackagingName";
	...
	public static final MMBusinessAssociationEnd TotalConsignmentQuantity = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Consignment1.TotalQuantity, com.tools20022.repository.msg.Consignment3.TotalQuantity);
			elementContext_lazy = () -> Packaging.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd TotalVolume = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Consignment1.TotalVolume, com.tools20022.repository.msg.Consignment3.TotalVolume);
			elementContext_lazy = () -> Packaging.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "TotalVolume";
	...
	public static final MMBusinessAssociationEnd TotalWeight = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Consignment1.TotalWeight, com.tools20022.repository.msg.Consignment3.TotalWeight);
			elementContext_lazy = () -> Packaging.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "TotalWeight";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Packaging1.Type);
