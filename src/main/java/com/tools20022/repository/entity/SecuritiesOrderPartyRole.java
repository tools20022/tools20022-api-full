 ...
 * IntroducingFirm}</li>
 * <li>{@linkplain com.tools20022.repository.entity.EnteringFirm EnteringFirm}</li>
 * <li>{@linkplain com.tools20022.repository.entity.OrderOriginationFirm
 * OrderOriginationFirm}</li>
 * <li>{@linkplain com.tools20022.repository.entity.SponsoringFirm
 * SponsoringFirm}</li>
 * <li>{@linkplain com.tools20022.repository.entity.OrderOriginationTrader
