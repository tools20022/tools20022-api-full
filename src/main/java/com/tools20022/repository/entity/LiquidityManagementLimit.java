...
public class LiquidityManagementLimit extends Limit {
	...
	public static final MMBusinessAttribute VolatilityMargin = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CurrencyFactors1.VolatilityMargin);
	...
	public static final MMBusinessAssociationEnd CurrencyExchange = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CurrencyFactors1.Rate);
			elementContext_lazy = () -> LiquidityManagementLimit.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute LiquidityLimitType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.LiquidityManagementLimitIdentificationDetails.Type);
			elementContext_lazy = () -> LiquidityManagementLimit.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CurrentLimitChoice.LiquidityManagementCurrentLimitIdentification);
