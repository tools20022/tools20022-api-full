 ...
 * subType} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.entity.MeetingInitiatorRole
 * MeetingInitiatorRole}</li>
 * <li>{@linkplain com.tools20022.repository.entity.AssignedProxyRole
 * AssignedProxyRole}</li>
 * <li>{@linkplain com.tools20022.repository.entity.RegistrationBeneficiary
 * RegistrationBeneficiary}</li>
 * <li>{@linkplain com.tools20022.repository.entity.MeetingAttendeeRole
 * MeetingAttendeeRole}</li>
 * <li>{@linkplain com.tools20022.repository.entity.ProxyAgent ProxyAgent}</li>
 * <li>{@linkplain com.tools20022.repository.entity.ProxyAssignerRole
 * ProxyAssignerRole}</li>
 * <li>{@linkplain com.tools20022.repository.entity.RightsHolder RightsHolder}</li>
 * <li>{@linkplain com.tools20022.repository.entity.VotingPartyRole
 * VotingPartyRole}</li>
 * </ul>
 * </li>
