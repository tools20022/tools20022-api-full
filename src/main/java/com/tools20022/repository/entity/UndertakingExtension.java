...
public class UndertakingExtension {
	...
	public static final MMBusinessAttribute AutoExtensionPeriod = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AutoExtension1.Period);
			elementContext_lazy = () -> UndertakingExtension.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.AutoExtension1#FinalExpiryDate
	...
	public static final MMBusinessAttribute AutoExtensionFinalExpiryDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.AutoExtension1.FinalExpiryDate);
			elementContext_lazy = () -> UndertakingExtension.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute NonExtensionNoticePeriod = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.NonExtension1.NotificationPeriod);
			elementContext_lazy = () -> UndertakingExtension.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
