...
public class Reinvestment {
	...
	public static final MMBusinessAssociationEnd InvestmentFundClass = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Reinvestment1.FundDetails, com.tools20022.repository.msg.Reinvestment2.FinancialInstrumentDetails,
					com.tools20022.repository.msg.Reinvestment3.FinancialInstrumentDetails);
			elementContext_lazy = () -> Reinvestment.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute Percentage = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.Reinvestment1.ReinvestmentPercentage, com.tools20022.repository.msg.Reinvestment2.ReinvestmentPercentage,
