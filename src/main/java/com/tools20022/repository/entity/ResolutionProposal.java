...
public class ResolutionProposal {
	...
	public static final MMBusinessAttribute ResolutionProposalThreshold = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MeetingNotice1.ResolutionProposalThreshold, com.tools20022.repository.msg.MeetingNotice2.ResolutionProposalThreshold);
	...
	public static final MMBusinessAttribute ResolutionProposalThresholdPercentage = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MeetingNotice1.ResolutionProposalThresholdPercentage, com.tools20022.repository.msg.MeetingNotice2.ResolutionProposalThresholdPercentage);
			elementContext_lazy = () -> ResolutionProposal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
