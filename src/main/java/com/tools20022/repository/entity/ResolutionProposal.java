...
public class ResolutionProposal {
	...
	public static final MMBusinessAttribute mmResolutionProposalThreshold = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MeetingNotice1.mmResolutionProposalThreshold, com.tools20022.repository.msg.MeetingNotice2.mmResolutionProposalThreshold);
	...
	public static final MMBusinessAttribute mmResolutionProposalThresholdPercentage = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MeetingNotice1.mmResolutionProposalThresholdPercentage, com.tools20022.repository.msg.MeetingNotice2.mmResolutionProposalThresholdPercentage);
			elementContext_lazy = () -> ResolutionProposal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
