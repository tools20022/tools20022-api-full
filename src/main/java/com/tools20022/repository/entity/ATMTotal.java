...
public class ATMTotal {
	...
	public static final MMBusinessAttribute ATMBalance = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals1.ATMBalance);
	...
	public static final MMBusinessAttribute Currency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals1.Currency, com.tools20022.repository.msg.ATMTotals3.Currency);
			elementContext_lazy = () -> ATMTotal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "Currency";
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMTotals1#ATMCurrentNumber
	...
	public static final MMBusinessAttribute ATMCurrentNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals1.ATMCurrentNumber, com.tools20022.repository.msg.ATMTotals3.Count);
			elementContext_lazy = () -> ATMTotal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.ATMTotals1#ATMBalanceNumber
	...
	public static final MMBusinessAttribute ATMBalanceNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals1.ATMBalanceNumber);
			elementContext_lazy = () -> ATMTotal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute ATMCurrent = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals1.ATMCurrent, com.tools20022.repository.msg.ATMTotals3.Amount);
			elementContext_lazy = () -> ATMTotal.mmObject();
			isDerived = false;
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
			name = "ATMCurrent";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ATMTotals3.Period);
