...
@XmlType(name = "ConversionTypeFormat2Choice", propOrder = {"code", "proprietary"})
public class ConversionTypeFormat2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ConversionTypeFormat2Choice, ConversionType1Code> mmCode = new MMMessageAttribute<ConversionTypeFormat2Choice, ConversionType1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesConversion.mmConversionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ConversionTypeFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ConversionType1Code getValue(ConversionTypeFormat2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ConversionTypeFormat2Choice obj, ConversionType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ConversionTypeFormat2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ConversionTypeFormat2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesConversion.mmConversionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ConversionTypeFormat2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(ConversionTypeFormat2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ConversionTypeFormat2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConversionTypeFormat2Choice.mmCode, com.tools20022.repository.choice.ConversionTypeFormat2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesConversion.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ConversionTypeFormat2Choice";
	...
	public ConversionTypeFormat2Choice setCode(ConversionType1Code code) {
	...
	public ConversionTypeFormat2Choice setProprietary(GenericIdentification25 proprietary) {
