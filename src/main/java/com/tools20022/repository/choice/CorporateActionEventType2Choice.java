...
public class CorporateActionEventType2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType2Choice.mmCode, CorporateActionEventType2Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType3Code code) {
		this.code = code;
	}
