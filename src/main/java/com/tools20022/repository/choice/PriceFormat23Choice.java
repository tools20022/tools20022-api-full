...
public class PriceFormat23Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat23Choice.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat44Choice.PercentagePrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat44Choice.AmountPrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NotSpecifiedPrice = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat44Choice.NotSpecifiedPrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IndexPoints = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat44Choice.IndexPoints);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat23Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat23Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat23Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat23Choice.IndexPoints);
