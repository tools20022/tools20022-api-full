...
public class AccountCriteria2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AccountCriteria2Choice, Max35Text> mmQueryName = new MMMessageAttribute<AccountCriteria2Choice, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(AccountCriteria2Choice obj) {
			return obj.getQueryName();
		}

		@Override
		public void setValue(AccountCriteria2Choice obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountCriteria2Choice, AccountCriteria6> mmNewCriteria = new MMMessageAssociationEnd<AccountCriteria2Choice, AccountCriteria6>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountCriteria2Choice.mmObject();
			isDerived = false;
			xmlTag = "NewCrit";
		...
		@Override
		public AccountCriteria6 getValue(AccountCriteria2Choice obj) {
			return obj.getNewCriteria();
		}

		@Override
		public void setValue(AccountCriteria2Choice obj, AccountCriteria6 value) {
