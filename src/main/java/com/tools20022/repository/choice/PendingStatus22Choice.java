...
public class PendingStatus22Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus22Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus22Choice.mmNoSpecifiedReason, PendingStatus22Choice.mmReason);
	...
	public void setReason(List<PendingReason12> reason) {
		this.reason = reason;
	}
}