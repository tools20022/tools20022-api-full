...
public class References6Choice {
	...
	public static final MMMessageAttribute AccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> References6Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References6Choice.AccountServicerTransactionIdentification,
						com.tools20022.repository.choice.References6Choice.AccountOwnerTransactionIdentification, com.tools20022.repository.choice.References6Choice.MarketInfrastructureTransactionIdentification,
						com.tools20022.repository.choice.References6Choice.PoolIdentification, com.tools20022.repository.choice.References6Choice.CommonIdentification, com.tools20022.repository.choice.References6Choice.TradeIdentification);
