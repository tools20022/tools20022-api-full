...
@XmlType(name = "FractionDispositionType30Choice", propOrder = {"code", "proprietary"})
public class FractionDispositionType30Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FractionDispositionType30Choice, FractionDispositionType11Code> mmCode = new MMMessageAttribute<FractionDispositionType30Choice, FractionDispositionType11Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType30Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public FractionDispositionType11Code getValue(FractionDispositionType30Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(FractionDispositionType30Choice obj, FractionDispositionType11Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FractionDispositionType30Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<FractionDispositionType30Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType30Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(FractionDispositionType30Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(FractionDispositionType30Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType30Choice.mmCode, com.tools20022.repository.choice.FractionDispositionType30Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FractionDispositionType30Choice";
	...
	public FractionDispositionType30Choice setCode(FractionDispositionType11Code code) {
	...
	public FractionDispositionType30Choice setProprietary(GenericIdentification47 proprietary) {
