	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ReplacementProcessingStatus1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the processing status of the replacement request.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.ReplacementProcessingStatus1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
