 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MarketType5Choice#mmCode
...
@XmlType(name = "MarketType5Choice", propOrder = {"code", "proprietary"})
public class MarketType5Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.MarketType5Choice
	 * MarketType5Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MarketType5Choice, MarketType5Code> mmCode = new MMMessageAttribute<MarketType5Choice, MarketType5Code>() {
		{
			businessElementTrace_lazy = () -> TradingMarket.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.MarketType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public MarketType5Code getValue(MarketType5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(MarketType5Choice obj, MarketType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MarketType5Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<MarketType5Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> TradingMarket.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.MarketType5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(MarketType5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(MarketType5Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketType5Choice.mmCode, com.tools20022.repository.choice.MarketType5Choice.mmProprietary);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketType5Choice";
	...
	public MarketType5Choice setCode(MarketType5Code code) {
	...
	public MarketType5Choice setProprietary(GenericIdentification25 proprietary) {
