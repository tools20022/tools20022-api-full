...
public class MarketType5Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> MarketType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MarketType5Choice.mmCode, MarketType5Choice.mmProprietary);
	...
	public void setCode(MarketType5Code code) {
		this.code = code;
	}
