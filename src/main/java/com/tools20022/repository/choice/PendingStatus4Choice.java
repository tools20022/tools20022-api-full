 ...
 * <li>{@linkplain com.tools20022.repository.choice.PendingStatus4Choice#Reason
...
public class PendingStatus4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus4Choice.NoSpecifiedReason, com.tools20022.repository.choice.PendingStatus4Choice.Reason);
