 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionType2Choice#mmCode
...
@XmlType(name = "OptionType2Choice", propOrder = {"code", "proprietary"})
public class OptionType2Choice {
	...
	public static final MMMessageAttribute<OptionType2Choice, OptionType1Code> mmCode = new MMMessageAttribute<OptionType2Choice, OptionType1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OptionType6Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<OptionType2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<OptionType2Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OptionType6Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionType2Choice.mmCode, com.tools20022.repository.choice.OptionType2Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionType2Choice";
				definition = "Choice of format for the option type.";
				nextVersions_lazy = () -> Arrays.asList(OptionType6Choice.mmObject());
			}
		});
	...
	public OptionType2Choice setCode(OptionType1Code code) {
	...
	public OptionType2Choice setProprietary(GenericIdentification20 proprietary) {
