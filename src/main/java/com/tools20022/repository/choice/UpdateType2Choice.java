 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UpdateType15Choice
...
@XmlType(name = "UpdateType2Choice", propOrder = {"code", "proprietary"})
public class UpdateType2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdateType2Choice, StatementUpdateType1Code> mmCode = new MMMessageAttribute<UpdateType2Choice, StatementUpdateType1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.UpdateType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Indicates whether the report is complete or contains changes only.";
			nextVersions_lazy = () -> Arrays.asList(UpdateType15Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public StatementUpdateType1Code getValue(UpdateType2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(UpdateType2Choice obj, StatementUpdateType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UpdateType2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<UpdateType2Choice, GenericIdentification20>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.UpdateType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			name = "Proprietary";
			definition = "Indicates whether the report is complete or contains changes only.";
			nextVersions_lazy = () -> Arrays.asList(UpdateType15Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(UpdateType2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(UpdateType2Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(UpdateType15Choice.mmObject());
			}
		});
	...
	public UpdateType2Choice setCode(StatementUpdateType1Code code) {
	...
	public UpdateType2Choice setProprietary(GenericIdentification20 proprietary) {
