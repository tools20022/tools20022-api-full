 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MarketType17Choice#mmCode
...
@XmlType(name = "MarketType17Choice", propOrder = {"code", "proprietary"})
public class MarketType17Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.MarketType17Choice
	 * MarketType17Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketType17Choice.mmCode, com.tools20022.repository.choice.MarketType17Choice.mmProprietary);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketType17Choice";
	...
	public MarketType17Choice setCode(MarketType4Code code) {
	...
	public MarketType17Choice setProprietary(GenericIdentification47 proprietary) {
