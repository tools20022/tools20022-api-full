...
public class IntermediateSecuritiesDistributionTypeFormat1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat1Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat1Choice.mmProprietary);
	...
	public void setCode(IntermediateSecurityDistributionType3Code code) {
		this.code = code;
	}
