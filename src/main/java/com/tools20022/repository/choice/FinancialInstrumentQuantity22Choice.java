...
public class FinancialInstrumentQuantity22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.Code);
