...
public class FinancialInstrumentQuantity22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity22Choice.mmUnit, FinancialInstrumentQuantity22Choice.mmFaceAmount, FinancialInstrumentQuantity22Choice.mmAmortisedValue,
						FinancialInstrumentQuantity22Choice.mmCode);
