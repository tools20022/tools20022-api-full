...
@XmlType(name = "FinancialInstrumentQuantity22Choice", propOrder = {"unit", "faceAmount", "amortisedValue", "code"})
public class FinancialInstrumentQuantity22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.mmUnit, com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.mmFaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.mmAmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity22Choice.mmCode);
				trace_lazy = () -> SecuritiesQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentQuantity22Choice";
	...
	public FinancialInstrumentQuantity22Choice setUnit(RestrictedFINDecimalNumber unit) {
	...
	public FinancialInstrumentQuantity22Choice setFaceAmount(RestrictedFINImpliedCurrencyAndAmount faceAmount) {
	...
	public FinancialInstrumentQuantity22Choice setAmortisedValue(RestrictedFINImpliedCurrencyAndAmount amortisedValue) {
	...
	public FinancialInstrumentQuantity22Choice setCode(Quantity5Code code) {
