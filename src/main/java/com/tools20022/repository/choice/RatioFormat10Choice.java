...
public class RatioFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RatioFormat10Choice.mmQuantityToQuantity, RatioFormat10Choice.mmNotSpecifiedRate, RatioFormat10Choice.mmAmountToAmount, RatioFormat10Choice.mmAmountToQuantity,
						RatioFormat10Choice.mmQuantityToAmount);
