 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.RatioFormat10Choice#mmNotSpecifiedRate
 * RatioFormat10Choice.mmNotSpecifiedRate}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat10Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat10Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat10Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat10Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "RatioFormat10Choice", propOrder = {"quantityToQuantity", "notSpecifiedRate", "amountToAmount", "amountToQuantity", "quantityToAmount"})
public class RatioFormat10Choice {
	...
	protected AmountAndQuantityRatio3 amountToQuantity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.choice.RatioFormat10Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat10Choice.mmNotSpecifiedRate,
								com.tools20022.repository.choice.RatioFormat10Choice.mmAmountToAmount, com.tools20022.repository.choice.RatioFormat10Choice.mmAmountToQuantity,
								com.tools20022.repository.choice.RatioFormat10Choice.mmQuantityToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat10Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat10Choice);
	...
	public RatioFormat10Choice setQuantityToQuantity(QuantityToQuantityRatio2 quantityToQuantity) {
	...
	public RatioFormat10Choice setNotSpecifiedRate(RateValueType6Code notSpecifiedRate) {
	...
	public RatioFormat10Choice setAmountToAmount(AmountToAmountRatio3 amountToAmount) {
	...
	public RatioFormat10Choice setAmountToQuantity(AmountAndQuantityRatio3 amountToQuantity) {
	...
	public RatioFormat10Choice setQuantityToAmount(AmountAndQuantityRatio3 quantityToAmount) {
