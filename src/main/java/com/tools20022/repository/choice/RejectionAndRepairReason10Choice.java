...
public class RejectionAndRepairReason10Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionAndRepairReason10Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionAndRepairReason10Choice.mmCode, RejectionAndRepairReason10Choice.mmProprietary);
	...
	public void setCode(RejectionReason21Code code) {
		this.code = code;
	}
