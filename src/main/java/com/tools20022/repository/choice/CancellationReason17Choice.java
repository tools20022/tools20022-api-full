...
public class CancellationReason17Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancellationReason17Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationReason22Choice.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancellationReason12Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the related instruction is cancelled, or the related cancellation request is executed.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationReason22Choice.mmProprietary);
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancellationReason12Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(CancelledStatusReason14Code code) {
		this.code = code;
	}
