...
public class GlobalNote1Choice {
	 ...
	 * {@linkplain com.tools20022.repository.entity.Issuance#GlobalNoteType
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> GlobalNote1Choice.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Issuance.GlobalNoteType;
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GlobalNote1Choice.Code, com.tools20022.repository.choice.GlobalNote1Choice.Proprietary);
