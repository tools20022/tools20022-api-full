...
public class InvestigationStatus2Choice {
	...
	public static final MMMessageAttribute Confirmation = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InvestigationStatus2Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestigationStatus2Choice.Confirmation, com.tools20022.repository.choice.InvestigationStatus2Choice.RejectedModification,
						com.tools20022.repository.choice.InvestigationStatus2Choice.DuplicateOf, com.tools20022.repository.choice.InvestigationStatus2Choice.AssignmentCancellationConfirmation);
				trace_lazy = () -> PaymentInvestigationCaseResolution.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.ResolutionOfInvestigationV03.Status);
