...
@XmlType(name = "SecuredMarketReport2Choice", propOrder = {"dataSetAction", "transaction"})
public class SecuredMarketReport2Choice {
	...
	public static final MMMessageAttribute<SecuredMarketReport2Choice, ReportPeriodActivity1Code> mmDataSetAction = new MMMessageAttribute<SecuredMarketReport2Choice, ReportPeriodActivity1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuredMarketReport3Choice.mmDataSetAction);
			previousVersion_lazy = () -> SecuredMarketReport1Choice.mmDataSetAction;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public SecuredMarketReport2Choice setDataSetAction(ReportPeriodActivity1Code dataSetAction) {
	...
	public SecuredMarketReport2Choice setTransaction(List<SecuredMarketTransaction2> transaction) {
