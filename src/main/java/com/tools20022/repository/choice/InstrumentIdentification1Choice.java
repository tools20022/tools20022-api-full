...
public class InstrumentIdentification1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstrumentIdentification1Choice.OtherFinancialInstrument, com.tools20022.repository.choice.InstrumentIdentification1Choice.InvestmentFund);
