...
@XmlType(name = "DistributionType1FormatChoice", propOrder = {"code", "proprietary"})
public class DistributionType1FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DistributionType1FormatChoice.mmCode, com.tools20022.repository.choice.DistributionType1FormatChoice.mmProprietary);
	...
	public DistributionType1FormatChoice setCode(DistributionType1Code code) {
	...
	public DistributionType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
