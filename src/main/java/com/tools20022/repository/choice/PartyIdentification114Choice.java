...
@XmlType(name = "PartyIdentification114Choice", propOrder = {"anyBIC", "proprietaryIdentification"})
public class PartyIdentification114Choice {
	...
	public static final MMMessageAttribute<PartyIdentification114Choice, AnyBICIdentifier> mmAnyBIC = new MMMessageAttribute<PartyIdentification114Choice, AnyBICIdentifier>() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification92Choice.mmAnyBIC;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<PartyIdentification114Choice, GenericIdentification84> mmProprietaryIdentification = new MMMessageAssociationEnd<PartyIdentification114Choice, GenericIdentification84>() {
		{
			...
			previousVersion_lazy = () -> PartyIdentification92Choice.mmProprietaryIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification114Choice.mmAnyBIC, com.tools20022.repository.choice.PartyIdentification114Choice.mmProprietaryIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PartyIdentification114Choice";
				definition = "Choice of identification of a party.";
				previousVersion_lazy = () -> PartyIdentification92Choice.mmObject();
			}
		});
	...
	public PartyIdentification114Choice setAnyBIC(AnyBICIdentifier anyBIC) {
	...
	public PartyIdentification114Choice setProprietaryIdentification(GenericIdentification84 proprietaryIdentification) {
