 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat31Choice#mmRateTypeAndAmountAndRateStatus
 * GrossDividendRateFormat31Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
@XmlType(name = "GrossDividendRateFormat31Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus"})
public class GrossDividendRateFormat31Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat31Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<GrossDividendRateFormat31Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat31Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(GrossDividendRateFormat31Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(GrossDividendRateFormat31Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat31Choice, AmountAndRateStatus2> mmAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat31Choice, AmountAndRateStatus2>() {
		{
		...
		@Override
		public AmountAndRateStatus2 getValue(GrossDividendRateFormat31Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat31Choice obj, AmountAndRateStatus2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat31Choice, RateTypeAndAmountAndStatus42> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat31Choice, RateTypeAndAmountAndStatus42>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat31Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus42 getValue(GrossDividendRateFormat31Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat31Choice obj, RateTypeAndAmountAndStatus42 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat31Choice.mmAmount, com.tools20022.repository.choice.GrossDividendRateFormat31Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.GrossDividendRateFormat31Choice.mmRateTypeAndAmountAndRateStatus);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GrossDividendRateFormat31Choice";
	...
	public GrossDividendRateFormat31Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat31Choice setAmountAndRateStatus(AmountAndRateStatus2 amountAndRateStatus) {
	...
	public GrossDividendRateFormat31Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus42 rateTypeAndAmountAndRateStatus) {
