...
@XmlType(name = "LegalRestrictions4Choice", propOrder = {"code", "proprietary"})
public class LegalRestrictions4Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected LegalRestrictions1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<LegalRestrictions4Choice, LegalRestrictions1Code> mmCode = new MMMessageAttribute<LegalRestrictions4Choice, LegalRestrictions1Code>() {
		{
			...
			previousVersion_lazy = () -> LegalRestrictions3Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<LegalRestrictions4Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<LegalRestrictions4Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> LegalRestrictions3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LegalRestrictions4Choice.mmCode, com.tools20022.repository.choice.LegalRestrictions4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesRestriction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "LegalRestrictions4Choice";
				definition = "Choice of format for legal restrictions.";
				previousVersion_lazy = () -> LegalRestrictions3Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public LegalRestrictions1Code getCode() {
		return code;
	}

	public LegalRestrictions4Choice setCode(LegalRestrictions1Code code) {
	...
	public LegalRestrictions4Choice setProprietary(GenericIdentification30 proprietary) {
