...
public class CancelledStatus9Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus9Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus9Choice.mmNoSpecifiedReason, CancelledStatus9Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason10> reason) {
		this.reason = reason;
	}
}