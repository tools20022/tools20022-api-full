...
import com.tools20022.repository.msg.CancelledStatusReason10;
...
@XmlType(name = "CancelledStatus9Choice", propOrder = {"noSpecifiedReason", "reason"})
public class CancelledStatus9Choice {
	...
	protected List<CancelledStatusReason10> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus9Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.CancelledStatus9Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CancelledStatus9Choice";
	...
	public CancelledStatus9Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<CancelledStatusReason10> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public CancelledStatus9Choice setReason(List<CancelledStatusReason10> reason) {
