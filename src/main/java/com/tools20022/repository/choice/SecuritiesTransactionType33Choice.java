...
public class SecuritiesTransactionType33Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionType33Choice, SecuritiesTransactionType18Code> mmCode = new MMMessageAttribute<SecuritiesTransactionType33Choice, SecuritiesTransactionType18Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType33Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType38Choice.mmCode);
			previousVersion_lazy = () -> SecuritiesTransactionType20Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesTransactionType18Code getValue(SecuritiesTransactionType33Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SecuritiesTransactionType33Choice obj, SecuritiesTransactionType18Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecuritiesTransactionType33Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<SecuritiesTransactionType33Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType33Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType38Choice.mmProprietary);
			previousVersion_lazy = () -> SecuritiesTransactionType20Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(SecuritiesTransactionType33Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SecuritiesTransactionType33Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesTransactionType33Choice.mmCode, com.tools20022.repository.choice.SecuritiesTransactionType33Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTransactionType33Choice";
				definition = "Choice of format for the repair reason.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType38Choice.mmObject());
				previousVersion_lazy = () -> SecuritiesTransactionType20Choice.mmObject();
			}
		});
	...
	public SecuritiesTransactionType33Choice setCode(SecuritiesTransactionType18Code code) {
	...
	public SecuritiesTransactionType33Choice setProprietary(GenericIdentification30 proprietary) {
