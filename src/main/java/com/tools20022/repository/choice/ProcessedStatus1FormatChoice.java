...
public class ProcessedStatus1FormatChoice {
	...
	public ProcessedStatus1FormatChoice setCode(ProcessedStatus1Code code) {
	...
	public ProcessedStatus1FormatChoice setProprietary(GenericIdentification13 proprietary) {
