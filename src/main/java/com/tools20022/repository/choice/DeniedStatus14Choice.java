 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus14Choice#Reason
...
public class DeniedStatus14Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus14Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus14Choice.Reason);
