	...
	public static final MMMessageAssociationEnd mmPrimaryOwner = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties7Choice.mmPrimaryOwner, com.tools20022.repository.choice.AccountParties5Choice.mmPrimaryOwner);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties1Choice.mmPrimaryOwner;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmTrustee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties7Choice.mmTrustee, com.tools20022.repository.choice.AccountParties5Choice.mmTrustee);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties1Choice.mmTrustee;
			maxOccurs = 5;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> InvestmentAccountOwnershipInformation9.mmObject();
	...
	public static final MMMessageAssociationEnd mmCustodianForMinor = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties7Choice.mmCustodianForMinor, com.tools20022.repository.choice.AccountParties5Choice.mmCustodianForMinor);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties1Choice.mmCustodianForMinor;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> InvestmentAccountOwnershipInformation9.mmObject();
	...
	public static final MMMessageAssociationEnd mmNominee = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties7Choice.mmNominee, com.tools20022.repository.choice.AccountParties5Choice.mmNominee);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties1Choice.mmNominee;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> InvestmentAccountOwnershipInformation9.mmObject();
	...
	public static final MMMessageAssociationEnd mmJointOwner = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties7Choice.mmJointOwner, com.tools20022.repository.choice.AccountParties5Choice.mmJointOwner);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties1Choice.mmJointOwner;
			maxOccurs = 5;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> InvestmentAccountOwnershipInformation9.mmObject();
