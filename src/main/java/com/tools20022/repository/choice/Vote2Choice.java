 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Vote2Choice#VoteInstruction
...
public class Vote2Choice {
	...
	public static final MMMessageAssociationEnd VoteInstruction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Vote3Choice.VoteInstruction);
			minOccurs = 1;
			maxOccurs = 1000;
	...
	public static final MMMessageAssociationEnd GlobalVoteInstruction = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Vote3Choice.GlobalVoteInstruction);
			minOccurs = 1;
			maxOccurs = 1000;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Vote2Choice.VoteInstruction, com.tools20022.repository.choice.Vote2Choice.GlobalVoteInstruction);
