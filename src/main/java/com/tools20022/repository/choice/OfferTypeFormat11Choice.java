...
import com.tools20022.repository.codeset.OfferType3Code;
...
@XmlType(name = "OfferTypeFormat11Choice", propOrder = {"code", "proprietary"})
public class OfferTypeFormat11Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OfferTypeFormat11Choice, OfferType3Code> mmCode = new MMMessageAttribute<OfferTypeFormat11Choice, OfferType3Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOfferType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OfferTypeFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OfferType3Code getValue(OfferTypeFormat11Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OfferTypeFormat11Choice obj, OfferType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OfferTypeFormat11Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<OfferTypeFormat11Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOfferType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OfferTypeFormat11Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(OfferTypeFormat11Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OfferTypeFormat11Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferTypeFormat11Choice.mmCode, com.tools20022.repository.choice.OfferTypeFormat11Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OfferTypeFormat11Choice";
	...
	public OfferTypeFormat11Choice setCode(OfferType3Code code) {
	...
	public OfferTypeFormat11Choice setProprietary(GenericIdentification47 proprietary) {
