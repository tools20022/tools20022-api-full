...
@XmlType(name = "OptionFeaturesFormat16Choice", propOrder = {"code", "proprietary"})
public class OptionFeaturesFormat16Choice {
	...
	public static final MMMessageAttribute<OptionFeaturesFormat16Choice, OptionFeatures8Code> mmCode = new MMMessageAttribute<OptionFeaturesFormat16Choice, OptionFeatures8Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat22Choice.mmCode);
			previousVersion_lazy = () -> OptionFeaturesFormat12Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<OptionFeaturesFormat16Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<OptionFeaturesFormat16Choice, GenericIdentification30>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat22Choice.mmProprietary);
			previousVersion_lazy = () -> OptionFeaturesFormat12Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public OptionFeaturesFormat16Choice setCode(OptionFeatures8Code code) {
	...
	public OptionFeaturesFormat16Choice setProprietary(GenericIdentification30 proprietary) {
