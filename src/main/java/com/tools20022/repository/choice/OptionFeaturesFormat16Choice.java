...
public class OptionFeaturesFormat16Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OptionFeaturesFormat16Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the features that may apply to a corporate action option.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat22Choice.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat12Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat22Choice.mmProprietary);
			previousVersion_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat12Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat16Choice.mmCode, com.tools20022.repository.choice.OptionFeaturesFormat16Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.mmdataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "OptionFeaturesFormat16Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat22Choice.mmObject());
				previousVersion_lazy = () -> OptionFeaturesFormat12Choice.mmObject();
			}
		});
	...
	public void setCode(OptionFeatures8Code code) {
		this.code = code;
	}
