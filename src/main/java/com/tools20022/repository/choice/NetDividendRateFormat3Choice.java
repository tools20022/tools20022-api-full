 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat3Choice#RateTypeAndAmountAndRateStatus
 * NetDividendRateFormat3Choice.RateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
public class NetDividendRateFormat3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat3Choice.Amount, com.tools20022.repository.choice.NetDividendRateFormat3Choice.RateTypeAndAmountAndRateStatus);
