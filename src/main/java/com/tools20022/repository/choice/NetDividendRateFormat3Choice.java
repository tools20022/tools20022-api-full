 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forNetDividendRateFormat3Choice
 * ConstraintCoexistenceAmountRule.forNetDividendRateFormat3Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class NetDividendRateFormat3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat3Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<NetDividendRateFormat3Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmNetDividend;
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat3Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(NetDividendRateFormat3Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(NetDividendRateFormat3Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat3Choice, RateTypeAndAmountAndStatus8> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat3Choice, RateTypeAndAmountAndStatus8>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat3Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus8 getValue(NetDividendRateFormat3Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat3Choice obj, RateTypeAndAmountAndStatus8 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat3Choice.mmAmount, com.tools20022.repository.choice.NetDividendRateFormat3Choice.mmRateTypeAndAmountAndRateStatus);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forNetDividendRateFormat3Choice);
	...
	public NetDividendRateFormat3Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat3Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus8 rateTypeAndAmountAndRateStatus) {
