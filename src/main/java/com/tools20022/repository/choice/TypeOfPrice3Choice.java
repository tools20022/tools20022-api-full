 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TypeOfPrice3Choice#mmCode
...
@XmlType(name = "TypeOfPrice3Choice", propOrder = {"code", "proprietary"})
public class TypeOfPrice3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TypeOfPrice29Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TypeOfPrice29Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TypeOfPrice3Choice.mmCode, com.tools20022.repository.choice.TypeOfPrice3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TypeOfPrice3Choice";
				definition = "Choice of format for the type of price.";
				nextVersions_lazy = () -> Arrays.asList(TypeOfPrice29Choice.mmObject());
			}
		});
	...
	public TypeOfPrice3Choice setCode(TypeOfPrice14Code code) {
	...
	public TypeOfPrice3Choice setProprietary(GenericIdentification20 proprietary) {
