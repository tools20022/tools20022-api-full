...
public class MatchingStatus16Choice {
	...
	public static final MMMessageAssociationEnd mmUnmatched = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.UnmatchedStatus11Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MatchingStatus16Choice.mmMatched, MatchingStatus16Choice.mmUnmatched, MatchingStatus16Choice.mmProprietary);
	...
	public void setUnmatched(com.tools20022.repository.choice.UnmatchedStatus11Choice unmatched) {
