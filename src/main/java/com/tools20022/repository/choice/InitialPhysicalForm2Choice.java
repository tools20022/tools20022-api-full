 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InitialPhysicalForm2Choice#Code
 * InitialPhysicalForm2Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InitialPhysicalForm2Choice#Proprietary
 * InitialPhysicalForm2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class InitialPhysicalForm2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InitialPhysicalForm2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InitialPhysicalForm2Choice.Code, com.tools20022.repository.choice.InitialPhysicalForm2Choice.Proprietary);
