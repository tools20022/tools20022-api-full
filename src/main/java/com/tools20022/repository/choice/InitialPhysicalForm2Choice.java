 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.InitialPhysicalForm4Choice
...
@XmlType(name = "InitialPhysicalForm2Choice", propOrder = {"code", "proprietary"})
public class InitialPhysicalForm2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InitialPhysicalForm2Choice, InitialPhysicalForm1Code> mmCode = new MMMessageAttribute<InitialPhysicalForm2Choice, InitialPhysicalForm1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.InitialPhysicalForm2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Initial physical form expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(InitialPhysicalForm4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InitialPhysicalForm1Code getValue(InitialPhysicalForm2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(InitialPhysicalForm2Choice obj, InitialPhysicalForm1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InitialPhysicalForm2Choice, GenericIdentification40> mmProprietary = new MMMessageAssociationEnd<InitialPhysicalForm2Choice, GenericIdentification40>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.InitialPhysicalForm2Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			nextVersions_lazy = () -> Arrays.asList(InitialPhysicalForm4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification40 getValue(InitialPhysicalForm2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(InitialPhysicalForm2Choice obj, GenericIdentification40 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InitialPhysicalForm2Choice.mmCode, com.tools20022.repository.choice.InitialPhysicalForm2Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "InitialPhysicalForm2Choice";
				definition = "Choice of format for initial physical form.";
				nextVersions_lazy = () -> Arrays.asList(InitialPhysicalForm4Choice.mmObject());
			}
		});
	...
	public InitialPhysicalForm2Choice setCode(InitialPhysicalForm1Code code) {
	...
	public InitialPhysicalForm2Choice setProprietary(GenericIdentification40 proprietary) {
