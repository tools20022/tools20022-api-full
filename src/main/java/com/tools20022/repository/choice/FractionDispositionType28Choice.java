...
public class FractionDispositionType28Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.FractionDispositionType17Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.FractionDispositionType17Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType28Choice.Code, com.tools20022.repository.choice.FractionDispositionType28Choice.Proprietary);
				...
				previousVersion_lazy = () -> FractionDispositionType17Choice.mmObject();
			}
		});
