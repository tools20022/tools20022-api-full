 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.InvestorType2Choice#mmCode
...
@XmlType(name = "InvestorType2Choice", propOrder = {"code", "proprietary"})
public class InvestorType2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestorType3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestorType3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorType2Choice.mmCode, com.tools20022.repository.choice.InvestorType2Choice.mmProprietary);
				trace_lazy = () -> InvestorRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "InvestorType2Choice";
				definition = "Choice of format for investor type.";
				nextVersions_lazy = () -> Arrays.asList(InvestorType3Choice.mmObject());
			}
		});
	...
	public InvestorType2Choice setCode(InvestorType1Code code) {
	...
	public InvestorType2Choice setProprietary(GenericIdentification40 proprietary) {
