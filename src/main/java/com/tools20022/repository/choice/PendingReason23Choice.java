...
import com.tools20022.repository.codeset.PendingReason11Code;
...
@XmlType(name = "PendingReason23Choice", propOrder = {"code", "proprietary"})
public class PendingReason23Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PendingReason11Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PendingReason23Choice
	 * PendingReason23Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason23Choice, PendingReason11Code> mmCode = new MMMessageAttribute<PendingReason23Choice, PendingReason11Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason23Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> PendingReason11Code.mmObject();
		}

		@Override
		public PendingReason11Code getValue(PendingReason23Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason23Choice obj, PendingReason11Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason23Choice, GenericIdentification25> mmProprietary = new MMMessageAttribute<PendingReason23Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason23Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(PendingReason23Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason23Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason23Choice.mmCode, com.tools20022.repository.choice.PendingReason23Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason23Choice";
	...
	public PendingReason11Code getCode() {
		return code;
	}

	public PendingReason23Choice setCode(PendingReason11Code code) {
	...
	public PendingReason23Choice setProprietary(GenericIdentification25 proprietary) {
