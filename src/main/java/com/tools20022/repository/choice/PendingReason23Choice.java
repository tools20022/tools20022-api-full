 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PendingReason23Choice#Code
...
public class PendingReason23Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason23Choice.Code, com.tools20022.repository.choice.PendingReason23Choice.Proprietary);
