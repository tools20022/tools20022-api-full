...
public class PriceFormat22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat22Choice.mmPercentagePrice, PriceFormat22Choice.mmAmountPrice, PriceFormat22Choice.mmNotSpecifiedPrice, PriceFormat22Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat22Choice.mmAmountPricePerAmount);
