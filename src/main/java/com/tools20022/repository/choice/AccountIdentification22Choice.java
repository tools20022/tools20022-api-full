...
public class AccountIdentification22Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification22Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification22Choice.mmForAllAccounts, AccountIdentification22Choice.mmAccountsListAndBalanceDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountAndBalance24> accountsListAndBalanceDetails) {
