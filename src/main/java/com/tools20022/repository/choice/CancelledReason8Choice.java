...
@XmlType(name = "CancelledReason8Choice", propOrder = {"code", "proprietary"})
public class CancelledReason8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledReason8Choice, CancelledStatusReason6Code> mmCode = new MMMessageAttribute<CancelledReason8Choice, CancelledStatusReason6Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancelledReason8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> CancelledReason1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CancelledStatusReason6Code getValue(CancelledReason8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancelledReason8Choice obj, CancelledStatusReason6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledReason8Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CancelledReason8Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancelledReason8Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CancelledReason1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CancelledReason8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancelledReason8Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledReason8Choice.mmCode, com.tools20022.repository.choice.CancelledReason8Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancelledReason8Choice";
				...
				previousVersion_lazy = () -> CancelledReason1Choice.mmObject();
			}
		});
	...
	public CancelledReason8Choice setCode(CancelledStatusReason6Code code) {
	...
	public CancelledReason8Choice setProprietary(GenericIdentification30 proprietary) {
