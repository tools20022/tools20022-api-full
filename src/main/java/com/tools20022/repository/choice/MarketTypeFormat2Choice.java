...
public class MarketTypeFormat2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketTypeFormat2Choice.Code, com.tools20022.repository.choice.MarketTypeFormat2Choice.Proprietary);
