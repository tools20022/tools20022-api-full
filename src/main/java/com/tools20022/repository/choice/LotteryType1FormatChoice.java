...
@XmlType(name = "LotteryType1FormatChoice", propOrder = {"code", "proprietary"})
public class LotteryType1FormatChoice {
	...
	public LotteryType1FormatChoice setCode(LotteryType1Code code) {
	...
	public LotteryType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
