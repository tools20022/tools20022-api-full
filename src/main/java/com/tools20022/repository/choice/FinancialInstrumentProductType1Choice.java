...
@XmlType(name = "FinancialInstrumentProductType1Choice", propOrder = {"code", "proprietary"})
public class FinancialInstrumentProductType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ProductType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public ProductType1Code getCode() {
		return code;
	}

	public FinancialInstrumentProductType1Choice setCode(ProductType1Code code) {
	...
	public FinancialInstrumentProductType1Choice setProprietary(GenericIdentification13 proprietary) {
