 ...
 * <li>{@linkplain com.tools20022.repository.choice.RepairStatus4Choice#Reason
...
public class RepairStatus4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepairStatus4Choice.NoSpecifiedReason, com.tools20022.repository.choice.RepairStatus4Choice.Reason);
