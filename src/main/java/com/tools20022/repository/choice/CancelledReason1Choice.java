...
import com.tools20022.repository.codeset.CancelledStatusReason6Code;
...
@XmlType(name = "CancelledReason1Choice", propOrder = {"code", "proprietary"})
public class CancelledReason1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CancelledStatusReason6Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledReason1Choice, CancelledStatusReason6Code> mmCode = new MMMessageAttribute<CancelledReason1Choice, CancelledStatusReason6Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancelledReason1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledReason8Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> CancelledStatusReason6Code.mmObject();
		}

		@Override
		public CancelledStatusReason6Code getValue(CancelledReason1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancelledReason1Choice obj, CancelledStatusReason6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancelledReason1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<CancelledReason1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancelledReason1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledReason8Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(CancelledReason1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancelledReason1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledReason1Choice.mmCode, com.tools20022.repository.choice.CancelledReason1Choice.mmProprietary);
				...
				nextVersions_lazy = () -> Arrays.asList(CancelledReason8Choice.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public CancelledStatusReason6Code getCode() {
		return code;
	}

	public CancelledReason1Choice setCode(CancelledStatusReason6Code code) {
	...
	public CancelledReason1Choice setProprietary(GenericIdentification20 proprietary) {
