...
@XmlType(name = "CorporateActionEventType53Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventType53Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType53Choice, CorporateActionEventType21Code> mmCode = new MMMessageAttribute<CorporateActionEventType53Choice, CorporateActionEventType21Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType53Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType74Choice.mmCode);
		...
		@Override
		public CorporateActionEventType21Code getValue(CorporateActionEventType53Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventType53Choice obj, CorporateActionEventType21Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionEventType53Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<CorporateActionEventType53Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType53Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType74Choice.mmProprietary);
		...
		@Override
		public GenericIdentification30 getValue(CorporateActionEventType53Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventType53Choice obj, GenericIdentification30 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionEventType53Choice);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionEventType53Choice";
				definition = "Choice between formats to express the corporate event type.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType74Choice.mmObject());
	...
	public CorporateActionEventType53Choice setCode(CorporateActionEventType21Code code) {
	...
	public CorporateActionEventType53Choice setProprietary(GenericIdentification30 proprietary) {
