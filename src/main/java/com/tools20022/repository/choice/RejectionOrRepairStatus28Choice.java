...
public class RejectionOrRepairStatus28Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus28Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus28Choice.mmNoSpecifiedReason, RejectionOrRepairStatus28Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason22> reason) {
		this.reason = reason;
	}
}