...
@XmlType(name = "FormOfSecurity3Choice", propOrder = {"code", "proprietary"})
public class FormOfSecurity3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FormOfSecurity3Choice.mmCode, com.tools20022.repository.choice.FormOfSecurity3Choice.mmProprietary);
				trace_lazy = () -> Security.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FormOfSecurity3Choice";
	...
	public FormOfSecurity3Choice setCode(FormOfSecurity1Code code) {
	...
	public FormOfSecurity3Choice setProprietary(GenericIdentification25 proprietary) {
