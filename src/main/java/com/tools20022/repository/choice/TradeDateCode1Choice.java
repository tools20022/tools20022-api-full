 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TradeDateCode3Choice
...
@XmlType(name = "TradeDateCode1Choice", propOrder = {"code", "proprietary"})
public class TradeDateCode1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeDateCode1Choice, DateType3Code> mmCode = new MMMessageAttribute<TradeDateCode1Choice, DateType3Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.TradeDateCode1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(TradeDateCode3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DateType3Code getValue(TradeDateCode1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(TradeDateCode1Choice obj, DateType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeDateCode1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<TradeDateCode1Choice, GenericIdentification20>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.TradeDateCode1Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			nextVersions_lazy = () -> Arrays.asList(TradeDateCode3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(TradeDateCode1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(TradeDateCode1Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(TradeDateCode3Choice.mmObject());
			}
		});
	...
	public TradeDateCode1Choice setCode(DateType3Code code) {
	...
	public TradeDateCode1Choice setProprietary(GenericIdentification20 proprietary) {
