 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.AccountStatus1Choice#Code
 * AccountStatus1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.AccountStatus1Choice#Proprietary
 * AccountStatus1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class AccountStatus1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountStatus1Choice.Code, com.tools20022.repository.choice.AccountStatus1Choice.Proprietary);
