 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.AccountStatus1Choice#mmCode
 * AccountStatus1Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.AccountStatus1Choice#mmProprietary
 * AccountStatus1Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats for the status of an account."</li>
...
@XmlType(name = "AccountStatus1Choice", propOrder = {"code", "proprietary"})
public class AccountStatus1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AccountStatus4Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public AccountStatus4Code getCode() {
		return code;
	}

	public AccountStatus1Choice setCode(AccountStatus4Code code) {
	...
	public AccountStatus1Choice setProprietary(GenericIdentification47 proprietary) {
