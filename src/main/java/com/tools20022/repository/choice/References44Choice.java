...
public class References44Choice {
	...
	public static final MMMessageAssociationEnd OtherTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References22Choice.OtherTransactionIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesFinancingTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References22Choice.SecuritiesFinancingTransactionIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesSettlementTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References22Choice.SecuritiesSettlementTransactionIdentification;
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> SettlementTypeAndIdentification18.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute IntraPositionMovementIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References22Choice.IntraPositionMovementIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References44Choice.OtherTransactionIdentification, com.tools20022.repository.choice.References44Choice.SecuritiesFinancingTransactionIdentification,
						com.tools20022.repository.choice.References44Choice.SecuritiesSettlementTransactionIdentification, com.tools20022.repository.choice.References44Choice.IntraPositionMovementIdentification);
