...
public class CorporateActionUnallocatedBalanceSD1Choice {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setTotalEligibleBalance(SignedQuantityFormat4 totalEligibleBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setBorrowedBalance(SignedQuantityFormat4 borrowedBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setCollateralInBalance(SignedQuantityFormat4 collateralInBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setCollateralOutBalance(SignedQuantityFormat4 collateralOutBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setOnLoanBalance(SignedQuantityFormat4 onLoanBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setPendingDeliveryBalance(SignedQuantityFormat4 pendingDeliveryBalance) {
	...
	public CorporateActionUnallocatedBalanceSD1Choice setPendingReceiptBalance(SignedQuantityFormat4 pendingReceiptBalance) {
