...
public class FractionDispositionType8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FractionDispositionType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FractionDispositionType8Choice.mmCode, FractionDispositionType8Choice.mmProprietary);
	...
	public void setCode(FractionDispositionType3Code code) {
		this.code = code;
	}
