...
@XmlType(name = "TradeTransactionCondition7Choice", propOrder = {"code", "proprietary"})
public class TradeTransactionCondition7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<TradeTransactionCondition7Choice, TradeTransactionCondition2Code> mmCode = new MMMessageAttribute<TradeTransactionCondition7Choice, TradeTransactionCondition2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmTradeTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.TradeTransactionCondition7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Trade transaction condition expressed as an ISO 20022 code.";
			previousVersion_lazy = () -> TradeTransactionCondition3Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TradeTransactionCondition2Code getValue(TradeTransactionCondition7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(TradeTransactionCondition7Choice obj, TradeTransactionCondition2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<TradeTransactionCondition7Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<TradeTransactionCondition7Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmTradeTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.TradeTransactionCondition7Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> TradeTransactionCondition3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(TradeTransactionCondition7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(TradeTransactionCondition7Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeTransactionCondition7Choice.mmCode, com.tools20022.repository.choice.TradeTransactionCondition7Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TradeTransactionCondition7Choice";
				definition = "Choice of format for trade transaction condition.";
				previousVersion_lazy = () -> TradeTransactionCondition3Choice.mmObject();
			}
		});
	...
	public TradeTransactionCondition7Choice setCode(TradeTransactionCondition2Code code) {
	...
	public TradeTransactionCondition7Choice setProprietary(GenericIdentification30 proprietary) {
