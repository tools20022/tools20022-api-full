...
@XmlType(name = "Registration7Choice", propOrder = {"code", "proprietary"})
public class Registration7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Registration7Choice, Registration2Code> mmCode = new MMMessageAttribute<Registration7Choice, Registration2Code>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Registration information expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(Registration10Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Registration2Code getValue(Registration7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Registration7Choice obj, Registration2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Registration7Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<Registration7Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration7Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Registration information expressed as a proprietary code.";
			nextVersions_lazy = () -> Arrays.asList(Registration10Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(Registration7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Registration7Choice obj, GenericIdentification20 value) {
	...
	public Registration7Choice setCode(Registration2Code code) {
	...
	public Registration7Choice setProprietary(GenericIdentification20 proprietary) {
