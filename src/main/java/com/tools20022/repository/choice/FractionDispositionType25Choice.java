...
@XmlType(name = "FractionDispositionType25Choice", propOrder = {"code", "proprietary"})
public class FractionDispositionType25Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FractionDispositionType25Choice, FractionDispositionType9Code> mmCode = new MMMessageAttribute<FractionDispositionType25Choice, FractionDispositionType9Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType25Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> FractionDispositionType15Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public FractionDispositionType9Code getValue(FractionDispositionType25Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(FractionDispositionType25Choice obj, FractionDispositionType9Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FractionDispositionType25Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<FractionDispositionType25Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType25Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FractionDispositionType15Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(FractionDispositionType25Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(FractionDispositionType25Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType25Choice.mmCode, com.tools20022.repository.choice.FractionDispositionType25Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FractionDispositionType25Choice";
				definition = "Choice between a standard code or a proprietary code to specify the type of fraction disposition.";
				previousVersion_lazy = () -> FractionDispositionType15Choice.mmObject();
			}
		});
	...
	public FractionDispositionType25Choice setCode(FractionDispositionType9Code code) {
	...
	public FractionDispositionType25Choice setProprietary(GenericIdentification30 proprietary) {
