 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PaymentType4Choice#mmCode
...
@XmlType(name = "PaymentType4Choice", propOrder = {"code", "proprietary"})
public class PaymentType4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentType4Choice, PaymentType3Code> mmCode = new MMMessageAttribute<PaymentType4Choice, PaymentType3Code>() {
		{
			businessElementTrace_lazy = () -> Payment.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.PaymentType4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PaymentType3Code getValue(PaymentType4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PaymentType4Choice obj, PaymentType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentType4Choice, Max35Text> mmProprietary = new MMMessageAttribute<PaymentType4Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Payment.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.PaymentType4Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> PaymentType3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(PaymentType4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PaymentType4Choice obj, Max35Text value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentType4Choice.mmCode, com.tools20022.repository.choice.PaymentType4Choice.mmProprietary);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentType4Choice";
				definition = "Choice between a payment type from a predefined list and a proprietary payment type.";
				previousVersion_lazy = () -> PaymentType3Choice.mmObject();
			}
		});
	...
	public PaymentType4Choice setCode(PaymentType3Code code) {
	...
	public PaymentType4Choice setProprietary(Max35Text proprietary) {
