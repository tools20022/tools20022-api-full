...
public class FinancialInstrumentQuantity9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity9Choice.UnitsNumber, com.tools20022.repository.choice.FinancialInstrumentQuantity9Choice.OrderedAmount);
