...
@XmlType(name = "CentralCounterPartyEligibility2Choice", propOrder = {"indicator", "proprietary"})
public class CentralCounterPartyEligibility2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CentralCounterPartyEligibility2Choice.mmIndicator, com.tools20022.repository.choice.CentralCounterPartyEligibility2Choice.mmProprietary);
	...
	public CentralCounterPartyEligibility2Choice setIndicator(YesNoIndicator indicator) {
	...
	public CentralCounterPartyEligibility2Choice setProprietary(GenericIdentification25 proprietary) {
