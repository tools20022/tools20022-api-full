...
@XmlType(name = "CancellationProcessingStatus1Choice", propOrder = {"code", "proprietary"})
public class CancellationProcessingStatus1Choice {
	...
	public CancellationProcessingStatus1Choice setCode(CancellationProcessingStatus1Code code) {
	...
	public CancellationProcessingStatus1Choice setProprietary(GenericIdentification20 proprietary) {
