...
@XmlType(name = "CashSettlementSystem4Choice", propOrder = {"code", "proprietary"})
public class CashSettlementSystem4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashSettlementSystem4Choice, CashSettlementSystem2Code> mmCode = new MMMessageAttribute<CashSettlementSystem4Choice, CashSettlementSystem2Code>() {
		{
			businessElementTrace_lazy = () -> CashClearingSystem.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CashSettlementSystem4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> CashSettlementSystem1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CashSettlementSystem2Code getValue(CashSettlementSystem4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CashSettlementSystem4Choice obj, CashSettlementSystem2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashSettlementSystem4Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CashSettlementSystem4Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CashClearingSystem.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CashSettlementSystem4Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CashSettlementSystem1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CashSettlementSystem4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CashSettlementSystem4Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CashSettlementSystem4Choice.mmCode, com.tools20022.repository.choice.CashSettlementSystem4Choice.mmProprietary);
				trace_lazy = () -> CashClearingSystem.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CashSettlementSystem4Choice";
				definition = "Choice of format for the cash settlement system.";
				previousVersion_lazy = () -> CashSettlementSystem1Choice.mmObject();
			}
		});
	...
	public CashSettlementSystem4Choice setCode(CashSettlementSystem2Code code) {
	...
	public CashSettlementSystem4Choice setProprietary(GenericIdentification30 proprietary) {
