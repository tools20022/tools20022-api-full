...
public class PaymentStatusCode3Choice {
	...
	public static final MMMessageAttribute PendingStatus = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentStatusCode3Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode3Choice.PendingStatus, com.tools20022.repository.choice.PaymentStatusCode3Choice.FinalStatus);
