...
@XmlType(name = "ProcessingStatus53Choice", propOrder = {"pendingCancellation", "rejected", "repair", "acknowledgedAccepted", "proprietary", "denied", "cancelled"})
public class ProcessingStatus53Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, PendingStatus39Choice> mmPendingCancellation = new MMMessageAssociationEnd<ProcessingStatus53Choice, PendingStatus39Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.ProcessingStatus53Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
		...
		@Override
		public PendingStatus39Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getPendingCancellation();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, PendingStatus39Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, RejectionOrRepairStatus30Choice> mmRejected = new MMMessageAssociationEnd<ProcessingStatus53Choice, RejectionOrRepairStatus30Choice>() {
		{
		...
		@Override
		public RejectionOrRepairStatus30Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, RejectionOrRepairStatus30Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, RejectionOrRepairStatus31Choice> mmRepair = new MMMessageAssociationEnd<ProcessingStatus53Choice, RejectionOrRepairStatus31Choice>() {
		{
		...
		@Override
		public RejectionOrRepairStatus31Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getRepair();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, RejectionOrRepairStatus31Choice value) {
			obj.setRepair(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, AcknowledgedAcceptedStatus24Choice> mmAcknowledgedAccepted = new MMMessageAssociationEnd<ProcessingStatus53Choice, AcknowledgedAcceptedStatus24Choice>() {
		{
		...
		@Override
		public AcknowledgedAcceptedStatus24Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getAcknowledgedAccepted();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, AcknowledgedAcceptedStatus24Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, ProprietaryStatusAndReason6> mmProprietary = new MMMessageAssociationEnd<ProcessingStatus53Choice, ProprietaryStatusAndReason6>() {
		{
		...
		@Override
		public ProprietaryStatusAndReason6 getValue(ProcessingStatus53Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, ProprietaryStatusAndReason6 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, DeniedStatus16Choice> mmDenied = new MMMessageAssociationEnd<ProcessingStatus53Choice, DeniedStatus16Choice>() {
		{
		...
		@Override
		public DeniedStatus16Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getDenied();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, DeniedStatus16Choice value) {
			obj.setDenied(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus53Choice, CancellationStatus15Choice> mmCancelled = new MMMessageAssociationEnd<ProcessingStatus53Choice, CancellationStatus15Choice>() {
		{
		...
		@Override
		public CancellationStatus15Choice getValue(ProcessingStatus53Choice obj) {
			return obj.getCancelled();
		}

		@Override
		public void setValue(ProcessingStatus53Choice obj, CancellationStatus15Choice value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus53Choice.mmPendingCancellation, com.tools20022.repository.choice.ProcessingStatus53Choice.mmRejected,
						com.tools20022.repository.choice.ProcessingStatus53Choice.mmRepair, com.tools20022.repository.choice.ProcessingStatus53Choice.mmAcknowledgedAccepted,
						com.tools20022.repository.choice.ProcessingStatus53Choice.mmProprietary, com.tools20022.repository.choice.ProcessingStatus53Choice.mmDenied, com.tools20022.repository.choice.ProcessingStatus53Choice.mmCancelled);
	...
	public ProcessingStatus53Choice setPendingCancellation(PendingStatus39Choice pendingCancellation) {
	...
	public ProcessingStatus53Choice setRejected(RejectionOrRepairStatus30Choice rejected) {
	...
	public ProcessingStatus53Choice setRepair(RejectionOrRepairStatus31Choice repair) {
	...
	public ProcessingStatus53Choice setAcknowledgedAccepted(AcknowledgedAcceptedStatus24Choice acknowledgedAccepted) {
	...
	public ProcessingStatus53Choice setProprietary(ProprietaryStatusAndReason6 proprietary) {
	...
	public ProcessingStatus53Choice setDenied(DeniedStatus16Choice denied) {
	...
	public ProcessingStatus53Choice setCancelled(CancellationStatus15Choice cancelled) {
