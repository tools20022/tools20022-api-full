...
@XmlType(name = "DividendTypeFormat8Choice", propOrder = {"code", "proprietary"})
public class DividendTypeFormat8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DividendTypeFormat8Choice.mmCode, com.tools20022.repository.choice.DividendTypeFormat8Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DividendTypeFormat8Choice";
	...
	public DividendTypeFormat8Choice setCode(CorporateActionFrequencyType3Code code) {
	...
	public DividendTypeFormat8Choice setProprietary(GenericIdentification25 proprietary) {
