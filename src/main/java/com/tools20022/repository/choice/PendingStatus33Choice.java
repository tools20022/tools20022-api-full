...
public class PendingStatus33Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus33Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus33Choice.mmNoSpecifiedReason, PendingStatus33Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason6> reason) {
		this.reason = reason;
	}
}