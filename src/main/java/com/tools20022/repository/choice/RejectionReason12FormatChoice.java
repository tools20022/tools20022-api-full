...
public class RejectionReason12FormatChoice {
	...
	/**
	 * Standard code to specify the reason of a rejection of a deactivation
	 * instruction.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionReason12FormatChoice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	/**
	 * Proprietary code to express the reason of a rejection of a deactivation
	 * instruction.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason12FormatChoice.mmCode, RejectionReason12FormatChoice.mmProprietary);
	...
	public void setCode(RejectionReason12Code code) {
		this.code = code;
	}
