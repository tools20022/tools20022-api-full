...
public class RejectionStatus10Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionStatus10Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionStatus10Choice.mmNoSpecifiedReason, RejectionStatus10Choice.mmReason);
	...
	public void setReason(List<RejectionReason14> reason) {
		this.reason = reason;
	}
}