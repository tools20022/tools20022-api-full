...
@XmlType(name = "RateType21Choice", propOrder = {"code", "proprietary"})
public class RateType21Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateType39Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RateType39Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType21Choice.mmCode, com.tools20022.repository.choice.RateType21Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType21Choice";
				definition = "Choice between a standard code or proprietary code to specify a rate type.";
				nextVersions_lazy = () -> Arrays.asList(RateType39Choice.mmObject());
	...
	public RateType21Choice setCode(NetDividendRateType2Code code) {
	...
	public RateType21Choice setProprietary(GenericIdentification20 proprietary) {
