...
public class RejectionReason11FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason11FormatChoice.Code, com.tools20022.repository.choice.RejectionReason11FormatChoice.Proprietary);
