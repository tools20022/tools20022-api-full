...
@XmlType(name = "AdditionalBusinessProcessFormat1Choice", propOrder = {"code", "proprietary"})
public class AdditionalBusinessProcessFormat1Choice {
	...
	public AdditionalBusinessProcessFormat1Choice setCode(AdditionalBusinessProcess1Code code) {
	...
	public AdditionalBusinessProcessFormat1Choice setProprietary(GenericIdentification20 proprietary) {
