...
public class MarketTypeFormat1Choice {
	...
	/**
	 * Standard code to specify the type of market in which transactions take
	 * place, for example, primary or secondary.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> MarketTypeFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	/**
	 * Proprietary identification of the type of market in which transactions
	 * take place.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public void setCode(MarketType3Code code) {
		this.code = code;
	}
