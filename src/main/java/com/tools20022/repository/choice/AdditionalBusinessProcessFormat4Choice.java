...
public class AdditionalBusinessProcessFormat4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalBusinessProcessFormat4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat4Choice.mmCode, AdditionalBusinessProcessFormat4Choice.mmProprietary);
	...
	public void setCode(AdditionalBusinessProcess1Code code) {
		this.code = code;
	}
