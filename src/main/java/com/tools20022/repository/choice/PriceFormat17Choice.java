 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat17Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat17Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat17Choice", propOrder = {"percentagePrice", "amountPrice"})
public class PriceFormat17Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat17Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat17Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat17Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat17Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat17Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat17Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat17Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat17Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat17Choice obj, AmountPrice5 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat17Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat17Choice.mmAmountPrice);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat17Choice);
	...
	public PriceFormat17Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat17Choice setAmountPrice(AmountPrice5 amountPrice) {
