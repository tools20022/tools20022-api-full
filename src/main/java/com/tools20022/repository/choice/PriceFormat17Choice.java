...
public class PriceFormat17Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat17Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat17Choice.AmountPrice);
