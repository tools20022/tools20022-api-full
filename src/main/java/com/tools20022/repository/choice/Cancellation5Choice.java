...
import com.tools20022.repository.area.sese.TransferInCancellationRequestV05;
...
@XmlType(name = "Cancellation5Choice", propOrder = {"references", "transferInDetails"})
public class Cancellation5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Cancellation5Choice, List<TransferReference5>> mmReferences = new MMMessageAttribute<Cancellation5Choice, List<TransferReference5>>() {
		{
			businessElementTrace_lazy = () -> Trade.mmTradeRelatedIdentifications;
			componentContext_lazy = () -> com.tools20022.repository.choice.Cancellation5Choice.mmObject();
			isDerived = false;
			xmlTag = "Refs";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "References";
			definition = "Reference of the transfer to be cancelled.";
			nextVersions_lazy = () -> Arrays.asList(Cancellation9Choice.mmReferences);
			previousVersion_lazy = () -> Cancellation2Choice.mmReference;
			minOccurs = 1;
			complexType_lazy = () -> TransferReference5.mmObject();
		}

		@Override
		public List<TransferReference5> getValue(Cancellation5Choice obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(Cancellation5Choice obj, List<TransferReference5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Cancellation5Choice, TransferIn10> mmTransferInDetails = new MMMessageAttribute<Cancellation5Choice, TransferIn10>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Cancellation9Choice.mmTransferInDetails);
			previousVersion_lazy = () -> Cancellation2Choice.mmTransferInDetails;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public TransferIn10 getValue(Cancellation5Choice obj) {
			return obj.getTransferInDetails();
		}

		@Override
		public void setValue(Cancellation5Choice obj, TransferIn10 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(TransferInCancellationRequestV05.mmCancellation);
	...
	public Cancellation5Choice setReferences(List<TransferReference5> references) {
	...
	public Cancellation5Choice setTransferInDetails(TransferIn10 transferInDetails) {
