...
public class NetDividendRateFormat5Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NetDividendRateFormat5Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat5Choice.mmAmount, NetDividendRateFormat5Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat5Choice.mmNotSpecifiedRate);
