...
@XmlType(name = "SettlementDateCode8Choice", propOrder = {"code", "proprietary"})
public class SettlementDateCode8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SettlementDateCode2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> SettlementDateCode2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDateCode8Choice.mmCode, com.tools20022.repository.choice.SettlementDateCode8Choice.mmProprietary);
	...
	public SettlementDateCode8Choice setCode(DateType4Code code) {
	...
	public SettlementDateCode8Choice setProprietary(GenericIdentification30 proprietary) {
