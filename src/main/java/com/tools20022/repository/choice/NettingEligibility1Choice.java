...
@XmlType(name = "NettingEligibility1Choice", propOrder = {"indicator", "proprietary"})
public class NettingEligibility1Choice {
	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(NettingEligibility4Choice.mmIndicator);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(NettingEligibility4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NettingEligibility1Choice.mmIndicator, com.tools20022.repository.choice.NettingEligibility1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesDeliveryObligation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NettingEligibility1Choice";
				definition = "Choice of format for the netting eligibility information.";
				nextVersions_lazy = () -> Arrays.asList(NettingEligibility4Choice.mmObject());
			}
		});
	...
	public NettingEligibility1Choice setIndicator(YesNoIndicator indicator) {
	...
	public NettingEligibility1Choice setProprietary(GenericIdentification20 proprietary) {
