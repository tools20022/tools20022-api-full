 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.RatioFormat9Choice#NotSpecifiedRate
 * RatioFormat9Choice.NotSpecifiedRate}</li>
 * <li>
...
public class RatioFormat9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat9Choice.QuantityToQuantity, com.tools20022.repository.choice.RatioFormat9Choice.NotSpecifiedRate,
						com.tools20022.repository.choice.RatioFormat9Choice.AmountToAmount);
