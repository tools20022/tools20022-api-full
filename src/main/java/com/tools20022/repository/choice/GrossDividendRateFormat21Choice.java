...
public class GrossDividendRateFormat21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat21Choice.mmAmount, GrossDividendRateFormat21Choice.mmAmountAndRateStatus, GrossDividendRateFormat21Choice.mmRateTypeAndAmountAndRateStatus);
