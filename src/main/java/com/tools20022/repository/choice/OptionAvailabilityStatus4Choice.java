...
public class OptionAvailabilityStatus4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OptionAvailabilityStatus4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionAvailabilityStatus4Choice.mmCode, OptionAvailabilityStatus4Choice.mmProprietary);
