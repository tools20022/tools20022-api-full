...
@XmlType(name = "InvestorCapacity5Choice", propOrder = {"code", "proprietary"})
public class InvestorCapacity5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestorCapacity5Choice, Eligibility1Code> mmCode = new MMMessageAttribute<InvestorCapacity5Choice, Eligibility1Code>() {
		{
			businessElementTrace_lazy = () -> InvestorRole.mmCapacity;
			componentContext_lazy = () -> com.tools20022.repository.choice.InvestorCapacity5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public Eligibility1Code getValue(InvestorCapacity5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(InvestorCapacity5Choice obj, Eligibility1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InvestorCapacity5Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<InvestorCapacity5Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> InvestorRole.mmCapacity;
			componentContext_lazy = () -> com.tools20022.repository.choice.InvestorCapacity5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(InvestorCapacity5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(InvestorCapacity5Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorCapacity5Choice.mmCode, com.tools20022.repository.choice.InvestorCapacity5Choice.mmProprietary);
				trace_lazy = () -> InvestorRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestorCapacity5Choice";
	...
	public InvestorCapacity5Choice setCode(Eligibility1Code code) {
	...
	public InvestorCapacity5Choice setProprietary(GenericIdentification47 proprietary) {
