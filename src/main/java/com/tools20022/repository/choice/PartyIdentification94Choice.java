...
public class PartyIdentification94Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification94Choice.mmBICFI, PartyIdentification94Choice.mmNameAndAddress, PartyIdentification94Choice.mmProprietaryIdentification);
