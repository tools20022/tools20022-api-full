 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat38Choice#mmDate
 * DateFormat38Choice.mmDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DateFormat38Choice#mmDateCodeAndTime
 * DateFormat38Choice.mmDateCodeAndTime}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DateFormat38Choice#mmDateCode
 * DateFormat38Choice.mmDateCode}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "DateFormat38Choice", propOrder = {"date", "dateCodeAndTime", "dateCode"})
public class DateFormat38Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DateFormat38Choice, DateAndDateTimeChoice> mmDate = new MMMessageAssociationEnd<DateFormat38Choice, DateAndDateTimeChoice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateFormat38Choice.mmObject();
			isDerived = false;
			xmlTag = "Dt";
		...
		@Override
		public DateAndDateTimeChoice getValue(DateFormat38Choice obj) {
			return obj.getDate();
		}

		@Override
		public void setValue(DateFormat38Choice obj, DateAndDateTimeChoice value) {
			obj.setDate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DateFormat38Choice, DateCodeAndTimeFormat4> mmDateCodeAndTime = new MMMessageAssociationEnd<DateFormat38Choice, DateCodeAndTimeFormat4>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateFormat38Choice.mmObject();
			isDerived = false;
			xmlTag = "DtCdAndTm";
		...
		@Override
		public DateCodeAndTimeFormat4 getValue(DateFormat38Choice obj) {
			return obj.getDateCodeAndTime();
		}

		@Override
		public void setValue(DateFormat38Choice obj, DateCodeAndTimeFormat4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DateFormat38Choice, DateCode22Choice> mmDateCode = new MMMessageAssociationEnd<DateFormat38Choice, DateCode22Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateFormat38Choice.mmObject();
			isDerived = false;
			xmlTag = "DtCd";
		...
		@Override
		public DateCode22Choice getValue(DateFormat38Choice obj) {
			return obj.getDateCode();
		}

		@Override
		public void setValue(DateFormat38Choice obj, DateCode22Choice value) {
	...
	public DateFormat38Choice setDate(DateAndDateTimeChoice date) {
	...
	public DateFormat38Choice setDateCodeAndTime(DateCodeAndTimeFormat4 dateCodeAndTime) {
	...
	public DateFormat38Choice setDateCode(DateCode22Choice dateCode) {
