...
@XmlType(name = "AcknowledgedAcceptedStatus7Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcknowledgedAcceptedStatus7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcknowledgedAcceptedStatus7Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<AcknowledgedAcceptedStatus7Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcknowledgedAcceptedStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus21Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NoReasonCode getValue(AcknowledgedAcceptedStatus7Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(AcknowledgedAcceptedStatus7Choice obj, NoReasonCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcknowledgedAcceptedStatus7Choice, List<AcknowledgementReason3>> mmReason = new MMMessageAssociationEnd<AcknowledgedAcceptedStatus7Choice, List<AcknowledgementReason3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus21Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<AcknowledgementReason3> getValue(AcknowledgedAcceptedStatus7Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(AcknowledgedAcceptedStatus7Choice obj, List<AcknowledgementReason3> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus7Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus7Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgedAcceptedStatus7Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus21Choice.mmObject());
				previousVersion_lazy = () -> AcknowledgedAcceptedStatus3Choice.mmObject();
			}
		});
	...
	public AcknowledgedAcceptedStatus7Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public AcknowledgedAcceptedStatus7Choice setReason(List<AcknowledgementReason3> reason) {
