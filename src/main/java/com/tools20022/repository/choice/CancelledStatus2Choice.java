...
public class CancelledStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus2Choice.mmNoSpecifiedReason, CancelledStatus2Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason5> reason) {
		this.reason = reason;
	}
}