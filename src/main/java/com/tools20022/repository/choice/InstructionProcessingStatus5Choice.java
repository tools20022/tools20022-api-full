...
@XmlType(name = "InstructionProcessingStatus5Choice", propOrder = {"code", "proprietary"})
public class InstructionProcessingStatus5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingStatus5Choice.mmCode, com.tools20022.repository.choice.InstructionProcessingStatus5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InstructionProcessingStatus5Choice";
	...
	public InstructionProcessingStatus5Choice setCode(InstructionProcessingStatus1Code code) {
	...
	public InstructionProcessingStatus5Choice setProprietary(GenericIdentification25 proprietary) {
