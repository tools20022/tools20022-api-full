...
@XmlType(name = "OfferTypeFormat5Choice", propOrder = {"code", "proprietary"})
public class OfferTypeFormat5Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OfferTypeFormat10Choice.mmCode);
			previousVersion_lazy = () -> OfferTypeFormat3Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OfferTypeFormat10Choice.mmProprietary);
			previousVersion_lazy = () -> OfferTypeFormat3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public OfferTypeFormat5Choice setCode(OfferType3Code code) {
	...
	public OfferTypeFormat5Choice setProprietary(GenericIdentification20 proprietary) {
