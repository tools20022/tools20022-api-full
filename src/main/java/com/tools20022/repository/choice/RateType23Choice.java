...
@XmlType(name = "RateType23Choice", propOrder = {"code", "proprietary"})
public class RateType23Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType23Choice, NetDividendRateType3Code> mmCode = new MMMessageAttribute<RateType23Choice, NetDividendRateType3Code>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType23Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of net dividend rate.";
			nextVersions_lazy = () -> Arrays.asList(RateType41Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NetDividendRateType3Code getValue(RateType23Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType23Choice obj, NetDividendRateType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateType23Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RateType23Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType23Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateType41Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RateType23Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType23Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType23Choice.mmCode, com.tools20022.repository.choice.RateType23Choice.mmProprietary);
	...
	public RateType23Choice setCode(NetDividendRateType3Code code) {
	...
	public RateType23Choice setProprietary(GenericIdentification20 proprietary) {
