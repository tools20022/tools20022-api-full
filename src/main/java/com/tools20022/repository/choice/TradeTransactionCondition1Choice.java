...
@XmlType(name = "TradeTransactionCondition1Choice", propOrder = {"code", "proprietary"})
public class TradeTransactionCondition1Choice {
	...
	public static final MMMessageAttribute<TradeTransactionCondition1Choice, TradeTransactionCondition4Code> mmCode = new MMMessageAttribute<TradeTransactionCondition1Choice, TradeTransactionCondition4Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TradeTransactionCondition5Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<TradeTransactionCondition1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<TradeTransactionCondition1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TradeTransactionCondition5Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeTransactionCondition1Choice.mmCode, com.tools20022.repository.choice.TradeTransactionCondition1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeTransactionCondition1Choice";
				definition = "Choice of format for the trade transaction condition.";
				nextVersions_lazy = () -> Arrays.asList(TradeTransactionCondition5Choice.mmObject());
			}
		});
	...
	public TradeTransactionCondition1Choice setCode(TradeTransactionCondition4Code code) {
	...
	public TradeTransactionCondition1Choice setProprietary(GenericIdentification20 proprietary) {
