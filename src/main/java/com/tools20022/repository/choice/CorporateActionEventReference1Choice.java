 ...
 * CorporateActionEventReference1Choice.mmLinkedCorporateActionIdentification}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forCorporateActionEventReference1Choice
 * ConstraintCoexistenceIdentificationRule.
 * forCorporateActionEventReference1Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class CorporateActionEventReference1Choice {
	...
	public static final MMMessageAttribute<CorporateActionEventReference1Choice, Max35Text> mmLinkedOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionEventReference1Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventReference3Choice.mmLinkedOfficialCorporateActionEventIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<CorporateActionEventReference1Choice, Max35Text> mmLinkedCorporateActionIdentification = new MMMessageAttribute<CorporateActionEventReference1Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventReference3Choice.mmLinkedCorporateActionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventReference1Choice.mmLinkedOfficialCorporateActionEventIdentification,
						com.tools20022.repository.choice.CorporateActionEventReference1Choice.mmLinkedCorporateActionIdentification);
				trace_lazy = () -> CorporateActionEventRegistration.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forCorporateActionEventReference1Choice);
				...
				name = "CorporateActionEventReference1Choice";
				definition = "Choice between a corporate action identification or a corporate action official identification.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionEventReference3Choice.mmObject());
			}
		});
	...
	public CorporateActionEventReference1Choice setLinkedOfficialCorporateActionEventIdentification(Max35Text linkedOfficialCorporateActionEventIdentification) {
	...
	public CorporateActionEventReference1Choice setLinkedCorporateActionIdentification(Max35Text linkedCorporateActionIdentification) {
