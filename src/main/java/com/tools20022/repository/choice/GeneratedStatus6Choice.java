...
public class GeneratedStatus6Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GeneratedStatus6Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedStatus6Choice.mmNoSpecifiedReason, GeneratedStatus6Choice.mmReason);
	...
	public void setReason(List<GeneratedReason4> reason) {
		this.reason = reason;
	}
}