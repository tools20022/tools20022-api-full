...
import com.tools20022.repository.msg.RejectedStatusReason14;
...
@XmlType(name = "RejectedStatus14Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectedStatus14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedStatus14Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectedStatus14Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectedStatus14Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatus18Choice.mmNoSpecifiedReason);
		...
		@Override
		public NoReasonCode getValue(RejectedStatus14Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(RejectedStatus14Choice obj, NoReasonCode value) {
			obj.setNoSpecifiedReason(value);
		}
	};
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectedStatusReason14> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.RejectedStatusReason14
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectedStatus14Choice, List<RejectedStatusReason14>> mmReason = new MMMessageAssociationEnd<RejectedStatus14Choice, List<RejectedStatusReason14>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatus18Choice.mmReason);
			previousVersion_lazy = () -> RejectedStatus1Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectedStatusReason14.mmObject();
		}

		@Override
		public List<RejectedStatusReason14> getValue(RejectedStatus14Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(RejectedStatus14Choice obj, List<RejectedStatusReason14> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus14Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectedStatus14Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatus14Choice";
				definition = "Choice between a reason or no reason for the corporate action instruction processing rejected status.";
				nextVersions_lazy = () -> Arrays.asList(RejectedStatus18Choice.mmObject());
	...
	public RejectedStatus14Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectedStatusReason14> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectedStatus14Choice setReason(List<RejectedStatusReason14> reason) {
