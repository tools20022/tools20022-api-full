...
@XmlType(name = "UnilateralSplit1Choice", propOrder = {"code", "proprietary"})
public class UnilateralSplit1Choice {
	...
	public static final MMMessageAttribute<UnilateralSplit1Choice, SecuritiesTransactionType5Code> mmCode = new MMMessageAttribute<UnilateralSplit1Choice, SecuritiesTransactionType5Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnilateralSplit3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<UnilateralSplit1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<UnilateralSplit1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnilateralSplit3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnilateralSplit1Choice.mmCode, com.tools20022.repository.choice.UnilateralSplit1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnilateralSplit1Choice";
				definition = "Specifies the matching processing change requested.";
				nextVersions_lazy = () -> Arrays.asList(UnilateralSplit3Choice.mmObject());
			}
		});
	...
	public UnilateralSplit1Choice setCode(SecuritiesTransactionType5Code code) {
	...
	public UnilateralSplit1Choice setProprietary(GenericIdentification20 proprietary) {
