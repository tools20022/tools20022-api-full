...
public class BeneficialOwnership2Choice {
	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> BeneficialOwnership2Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BeneficialOwnership2Choice.mmIndicator, BeneficialOwnership2Choice.mmProprietary);
