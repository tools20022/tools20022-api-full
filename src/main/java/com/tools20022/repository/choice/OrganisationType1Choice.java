 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.OrganisationType1Choice#Code
 * OrganisationType1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.OrganisationType1Choice#Proprietary
 * OrganisationType1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class OrganisationType1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OrganisationType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OrganisationType1Choice.Code, com.tools20022.repository.choice.OrganisationType1Choice.Proprietary);
