...
@XmlType(name = "SettlementStandingInstructionDatabase1Choice", propOrder = {"code", "proprietary"})
public class SettlementStandingInstructionDatabase1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementStandingInstructionDatabase1Choice, SettlementStandingInstructionDatabase1Code> mmCode = new MMMessageAttribute<SettlementStandingInstructionDatabase1Choice, SettlementStandingInstructionDatabase1Code>() {
		{
			businessElementTrace_lazy = () -> StandingSettlementInstruction.mmSettlementStandingInstructionDatabase;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStandingInstructionDatabase1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementStandingInstructionDatabase4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SettlementStandingInstructionDatabase1Code getValue(SettlementStandingInstructionDatabase1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementStandingInstructionDatabase1Choice obj, SettlementStandingInstructionDatabase1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementStandingInstructionDatabase1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<SettlementStandingInstructionDatabase1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StandingSettlementInstruction.mmSettlementStandingInstructionDatabase;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStandingInstructionDatabase1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementStandingInstructionDatabase4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(SettlementStandingInstructionDatabase1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementStandingInstructionDatabase1Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(SettlementStandingInstructionDatabase4Choice.mmObject());
			}
		});
	...
	public SettlementStandingInstructionDatabase1Choice setCode(SettlementStandingInstructionDatabase1Code code) {
	...
	public SettlementStandingInstructionDatabase1Choice setProprietary(GenericIdentification20 proprietary) {
