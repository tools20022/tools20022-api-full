...
public class TaxCreditRateFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TaxCreditRateFormat4Choice.mmRate, TaxCreditRateFormat4Choice.mmAmount, TaxCreditRateFormat4Choice.mmRateTypeAndAmountAndRateStatus, TaxCreditRateFormat4Choice.mmNotSpecifiedRate);
