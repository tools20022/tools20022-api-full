...
public class PriceFormat16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat16Choice.mmPercentagePrice, PriceFormat16Choice.mmAmountPrice, PriceFormat16Choice.mmNotSpecifiedPrice, PriceFormat16Choice.mmIndexPoints);
