 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat16Choice#mmNotSpecifiedPrice
 * PriceFormat16Choice.mmNotSpecifiedPrice}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat16Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat16Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat16Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "indexPoints"})
public class PriceFormat16Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat16Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat16Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat16Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat16Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat16Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat16Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat16Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat16Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat16Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat16Choice, PriceValueType5Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat16Choice, PriceValueType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat16Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType5Code getValue(PriceFormat16Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat16Choice obj, PriceValueType5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat16Choice, RestrictedFINDecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat16Choice, RestrictedFINDecimalNumber>() {
		{
		...
		@Override
		public RestrictedFINDecimalNumber getValue(PriceFormat16Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat16Choice obj, RestrictedFINDecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat16Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat16Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat16Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat16Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat16Choice);
	...
	public PriceFormat16Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat16Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat16Choice setNotSpecifiedPrice(PriceValueType5Code notSpecifiedPrice) {
	...
	public PriceFormat16Choice setIndexPoints(RestrictedFINDecimalNumber indexPoints) {
