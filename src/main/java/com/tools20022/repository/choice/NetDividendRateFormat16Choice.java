...
public class NetDividendRateFormat16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat16Choice.mmAmount, NetDividendRateFormat16Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat16Choice.mmNotSpecifiedRate);
