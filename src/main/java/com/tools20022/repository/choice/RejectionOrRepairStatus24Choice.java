...
public class RejectionOrRepairStatus24Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus24Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus24Choice.mmNoSpecifiedReason, RejectionOrRepairStatus24Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason19> reason) {
		this.reason = reason;
	}
}