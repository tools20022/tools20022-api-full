...
@XmlType(name = "IntermediateSecuritiesDistributionTypeFormat6Choice", propOrder = {"code", "proprietary"})
public class IntermediateSecuritiesDistributionTypeFormat6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat6Choice.mmCode,
						com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat6Choice.mmProprietary);
				...
				name = "IntermediateSecuritiesDistributionTypeFormat6Choice";
	...
	public IntermediateSecuritiesDistributionTypeFormat6Choice setCode(IntermediateSecurityDistributionType4Code code) {
	...
	public IntermediateSecuritiesDistributionTypeFormat6Choice setProprietary(GenericIdentification20 proprietary) {
