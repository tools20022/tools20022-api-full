...
public class IntermediateSecuritiesDistributionTypeFormat6Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat6Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat6Choice.mmProprietary);
