...
@XmlType(name = "RateType20Choice", propOrder = {"code", "proprietary"})
public class RateType20Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType20Choice, GrossDividendRateType2Code> mmCode = new MMMessageAttribute<RateType20Choice, GrossDividendRateType2Code>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType20Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of gross dividend rate.";
			nextVersions_lazy = () -> Arrays.asList(RateType38Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GrossDividendRateType2Code getValue(RateType20Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType20Choice obj, GrossDividendRateType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateType20Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RateType20Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType20Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateType38Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RateType20Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType20Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType20Choice.mmCode, com.tools20022.repository.choice.RateType20Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType20Choice";
				definition = "Choice between a standard code or proprietary code to specify a rate type.";
				nextVersions_lazy = () -> Arrays.asList(RateType38Choice.mmObject());
	...
	public RateType20Choice setCode(GrossDividendRateType2Code code) {
	...
	public RateType20Choice setProprietary(GenericIdentification20 proprietary) {
