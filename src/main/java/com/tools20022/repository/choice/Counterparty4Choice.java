 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty4Choice#Seller
 * Counterparty4Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty4Choice#Buyer
 * Counterparty4Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty4Choice.Seller, com.tools20022.repository.choice.Counterparty4Choice.Buyer);
