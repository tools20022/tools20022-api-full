...
public class PartyIdentification89Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification89Choice.mmAnyBIC, PartyIdentification89Choice.mmProprietaryIdentification, PartyIdentification89Choice.mmNameAndAddress);
