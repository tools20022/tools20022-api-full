...
public class PartyIdentification89Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification89Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification89Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification89Choice.NameAndAddress);
