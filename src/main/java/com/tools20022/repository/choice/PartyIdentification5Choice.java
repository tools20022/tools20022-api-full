...
public class PartyIdentification5Choice {
	...
	public static final MMMessageAttribute BICOrBEI = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification5Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification5Choice.BICOrBEI, com.tools20022.repository.choice.PartyIdentification5Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification5Choice.NameAndAddress, com.tools20022.repository.choice.PartyIdentification5Choice.TaxIdentificationNumber,
						com.tools20022.repository.choice.PartyIdentification5Choice.NationalRegistrationNumber);
