...
public class PendingStatus8Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus8Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus8Choice.mmNoSpecifiedReason, PendingStatus8Choice.mmReason);
	...
	public void setReason(List<PendingReason4> reason) {
		this.reason = reason;
	}
}