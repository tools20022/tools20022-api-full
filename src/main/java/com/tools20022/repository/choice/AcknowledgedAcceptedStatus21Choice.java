...
public class AcknowledgedAcceptedStatus21Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus21Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NoSpecifiedReason";
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcknowledgedAcceptedStatus7Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			name = "Reason";
			definition = "Specifies the reason of the acknowledged accepted status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcknowledgedAcceptedStatus7Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	public void setReason(List<AcknowledgementReason9> reason) {
		this.reason = reason;
	}
}