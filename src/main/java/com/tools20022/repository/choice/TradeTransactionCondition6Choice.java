...
@XmlType(name = "TradeTransactionCondition6Choice", propOrder = {"code", "proprietary"})
public class TradeTransactionCondition6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeTransactionCondition6Choice.mmCode, com.tools20022.repository.choice.TradeTransactionCondition6Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeTransactionCondition6Choice";
	...
	public TradeTransactionCondition6Choice setCode(TradeTransactionCondition4Code code) {
	...
	public TradeTransactionCondition6Choice setProprietary(GenericIdentification47 proprietary) {
