...
@XmlType(name = "AcknowledgedAcceptedStatus14Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcknowledgedAcceptedStatus14Choice {
	...
	public static final MMMessageAttribute<AcknowledgedAcceptedStatus14Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<AcknowledgedAcceptedStatus14Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus23Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public AcknowledgedAcceptedStatus14Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public AcknowledgedAcceptedStatus14Choice setReason(List<AcknowledgementReason7> reason) {
