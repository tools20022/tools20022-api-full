 ...
 * definition} = "Choice of format for standardisation."</li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Standardisation2Choice
...
@XmlType(name = "Standardisation1Choice", propOrder = {"code", "proprietary"})
public class Standardisation1Choice {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.Standardisation2Choice#mmCode
	 * Standardisation2Choice.mmCode}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Standardisation1Choice, List<StandardisationCode>> mmCode = new MMMessageAttribute<Standardisation1Choice, List<StandardisationCode>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.Standardisation1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standardisation expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(Standardisation2Choice.mmCode);
			minOccurs = 0;
			simpleType_lazy = () -> StandardisationCode.mmObject();
		}

		@Override
		public List<StandardisationCode> getValue(Standardisation1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Standardisation1Choice obj, List<StandardisationCode> value) {
			obj.setCode(value);
		}
	};
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.Standardisation2Choice#mmProprietary
	 * Standardisation2Choice.mmProprietary}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Standardisation1Choice, GenericIdentification40> mmProprietary = new MMMessageAssociationEnd<Standardisation1Choice, GenericIdentification40>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.Standardisation1Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			nextVersions_lazy = () -> Arrays.asList(Standardisation2Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification40 getValue(Standardisation1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Standardisation1Choice obj, GenericIdentification40 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(Standardisation2Choice.mmObject());
			}
		});
	...
	public Standardisation1Choice setCode(List<StandardisationCode> code) {
	...
	public Standardisation1Choice setProprietary(GenericIdentification40 proprietary) {
