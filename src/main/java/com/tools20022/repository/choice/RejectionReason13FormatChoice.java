...
import com.tools20022.repository.codeset.RejectionReason13Code;
...
public class RejectionReason13FormatChoice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Standard code to specify the reason of a rejection of a movement.";
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason13FormatChoice.Code, com.tools20022.repository.choice.RejectionReason13FormatChoice.Proprietary);
