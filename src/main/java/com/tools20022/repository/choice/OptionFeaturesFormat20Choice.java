...
@XmlType(name = "OptionFeaturesFormat20Choice", propOrder = {"code", "proprietary"})
public class OptionFeaturesFormat20Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionFeaturesFormat20Choice, OptionFeatures7Code> mmCode = new MMMessageAttribute<OptionFeaturesFormat20Choice, OptionFeatures7Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat20Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OptionFeatures7Code getValue(OptionFeaturesFormat20Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionFeaturesFormat20Choice obj, OptionFeatures7Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionFeaturesFormat20Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<OptionFeaturesFormat20Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat20Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(OptionFeaturesFormat20Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionFeaturesFormat20Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat20Choice.mmCode, com.tools20022.repository.choice.OptionFeaturesFormat20Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionFeaturesFormat20Choice";
	...
	public OptionFeaturesFormat20Choice setCode(OptionFeatures7Code code) {
	...
	public OptionFeaturesFormat20Choice setProprietary(GenericIdentification47 proprietary) {
