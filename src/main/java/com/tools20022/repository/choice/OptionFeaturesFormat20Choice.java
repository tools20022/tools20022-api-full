...
public class OptionFeaturesFormat20Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OptionFeaturesFormat20Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionFeaturesFormat20Choice.mmCode, OptionFeaturesFormat20Choice.mmProprietary);
	...
	public void setCode(OptionFeatures7Code code) {
		this.code = code;
	}
