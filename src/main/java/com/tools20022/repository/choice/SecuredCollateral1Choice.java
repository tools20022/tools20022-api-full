...
public class SecuredCollateral1Choice {
	...
	public static final MMMessageAssociationEnd SingleCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuredCollateral2Choice.SingleCollateral);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MultipleCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuredCollateral2Choice.MultipleCollateral);
			minOccurs = 1;
			type_lazy = () -> CollateralValuation3.mmObject();
			isComposite = true;
		}
	...
	public static final MMMessageAssociationEnd PoolCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuredCollateral2Choice.PoolCollateral);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> CollateralValuation3.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd OtherCollateral = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuredCollateral2Choice.OtherCollateral);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuredCollateral1Choice.SingleCollateral, com.tools20022.repository.choice.SecuredCollateral1Choice.MultipleCollateral,
