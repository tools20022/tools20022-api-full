...
public class RejectedStatus20Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatus20Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatus20Choice.mmNoSpecifiedReason, RejectedStatus20Choice.mmReason);
	...
	public void setReason(List<RejectedStatusReason19> reason) {
		this.reason = reason;
	}
}