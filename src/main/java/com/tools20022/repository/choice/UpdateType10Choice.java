 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UpdateType10Choice#Addition
 * UpdateType10Choice.Addition}</li>
 * <li>{@linkplain com.tools20022.repository.choice.UpdateType10Choice#Deletion
 * UpdateType10Choice.Deletion}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.UpdateType10Choice#Modification
 * UpdateType10Choice.Modification}</li>
 * </ul>
 * </li>
 * <li>
...
public class UpdateType10Choice {
	...
	public static final MMMessageAssociationEnd Addition = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> UpdateType10Choice.mmObject();
			isDerived = false;
			xmlTag = "Addtn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UpdateType10Choice.Addition, com.tools20022.repository.choice.UpdateType10Choice.Deletion,
						com.tools20022.repository.choice.UpdateType10Choice.Modification);
