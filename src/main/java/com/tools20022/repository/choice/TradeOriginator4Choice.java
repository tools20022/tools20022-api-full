...
@XmlType(name = "TradeOriginator4Choice", propOrder = {"code", "proprietary"})
public class TradeOriginator4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeOriginator4Choice.mmCode, com.tools20022.repository.choice.TradeOriginator4Choice.mmProprietary);
				trace_lazy = () -> TradeOriginatorRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeOriginator4Choice";
	...
	public TradeOriginator4Choice setCode(OriginatorRole2Code code) {
	...
	public TradeOriginator4Choice setProprietary(GenericIdentification47 proprietary) {
