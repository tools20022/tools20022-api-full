...
@XmlType(name = "OpeningClosing4Choice", propOrder = {"code", "proprietary"})
public class OpeningClosing4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OpeningClosing4Choice.mmCode, com.tools20022.repository.choice.OpeningClosing4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OpeningClosing4Choice";
	...
	public OpeningClosing4Choice setCode(OpeningClosing1Code code) {
	...
	public OpeningClosing4Choice setProprietary(GenericIdentification47 proprietary) {
