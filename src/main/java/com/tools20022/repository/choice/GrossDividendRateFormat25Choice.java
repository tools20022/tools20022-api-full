...
public class GrossDividendRateFormat25Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat25Choice.mmAmount, GrossDividendRateFormat25Choice.mmAmountAndRateStatus, GrossDividendRateFormat25Choice.mmRateTypeAndAmountAndRateStatus,
						GrossDividendRateFormat25Choice.mmNotSpecifiedRate);
