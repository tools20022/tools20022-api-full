 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat25Choice#mmRateTypeAndAmountAndRateStatus
 * GrossDividendRateFormat25Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat25Choice#mmNotSpecifiedRate
 * GrossDividendRateFormat25Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "GrossDividendRateFormat25Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class GrossDividendRateFormat25Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat25Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<GrossDividendRateFormat25Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(GrossDividendRateFormat25Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(GrossDividendRateFormat25Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat25Choice, AmountAndRateStatus2> mmAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat25Choice, AmountAndRateStatus2>() {
		{
		...
		@Override
		public AmountAndRateStatus2 getValue(GrossDividendRateFormat25Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat25Choice obj, AmountAndRateStatus2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat25Choice, RateTypeAndAmountAndStatus30> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat25Choice, RateTypeAndAmountAndStatus30>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus30 getValue(GrossDividendRateFormat25Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat25Choice obj, RateTypeAndAmountAndStatus30 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat25Choice, RateType13Code> mmNotSpecifiedRate = new MMMessageAttribute<GrossDividendRateFormat25Choice, RateType13Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateType13Code getValue(GrossDividendRateFormat25Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(GrossDividendRateFormat25Choice obj, RateType13Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmAmount, com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.GrossDividendRateFormat25Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GrossDividendRateFormat25Choice";
	...
	public GrossDividendRateFormat25Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat25Choice setAmountAndRateStatus(AmountAndRateStatus2 amountAndRateStatus) {
	...
	public GrossDividendRateFormat25Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus30 rateTypeAndAmountAndRateStatus) {
	...
	public GrossDividendRateFormat25Choice setNotSpecifiedRate(RateType13Code notSpecifiedRate) {
