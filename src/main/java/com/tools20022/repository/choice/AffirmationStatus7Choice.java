...
public class AffirmationStatus7Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AffirmationStatus7Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AffirmationStatus7Choice.Code, com.tools20022.repository.choice.AffirmationStatus7Choice.Proprietary);
