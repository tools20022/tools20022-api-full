...
public class PartyIdentification43Choice {
	...
	public static final MMMessageAttribute mmAnyBIC = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification43Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification43Choice.mmAnyBIC, PartyIdentification43Choice.mmProprietaryIdentification, PartyIdentification43Choice.mmNameAndAddress);
