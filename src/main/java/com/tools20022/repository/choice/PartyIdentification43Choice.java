...
public class PartyIdentification43Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification43Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification43Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification43Choice.NameAndAddress);
