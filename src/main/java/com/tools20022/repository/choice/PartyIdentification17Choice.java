...
public class PartyIdentification17Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification17Choice.mmBICOrBEI, PartyIdentification17Choice.mmNameAndAddress, PartyIdentification17Choice.mmCountry);
