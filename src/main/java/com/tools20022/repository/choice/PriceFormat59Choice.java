 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat59Choice#mmNotSpecifiedPrice
 * PriceFormat59Choice.mmNotSpecifiedPrice}</li>
 * <li>
...
@XmlType(name = "PriceFormat59Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "indexPoints"})
public class PriceFormat59Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PriceFormat59Choice
	 * PriceFormat59Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat59Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat59Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat59Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat59Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat59Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat59Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat59Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat59Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat59Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat59Choice, PriceValueType10Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat59Choice, PriceValueType10Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat59Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType10Code getValue(PriceFormat59Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat59Choice obj, PriceValueType10Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat59Choice, RestrictedFINDecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat59Choice, RestrictedFINDecimalNumber>() {
		{
		...
		@Override
		public RestrictedFINDecimalNumber getValue(PriceFormat59Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat59Choice obj, RestrictedFINDecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat59Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat59Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat59Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat59Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PriceFormat59Choice";
	...
	public PriceFormat59Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat59Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat59Choice setNotSpecifiedPrice(PriceValueType10Code notSpecifiedPrice) {
	...
	public PriceFormat59Choice setIndexPoints(RestrictedFINDecimalNumber indexPoints) {
