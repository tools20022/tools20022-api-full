...
public class CorporateActionOption12Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CorporateActionOption12Choice.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption20Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption20Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption12Choice.Code, com.tools20022.repository.choice.CorporateActionOption12Choice.Proprietary);
