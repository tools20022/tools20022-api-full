...
public class DeniedReason9Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedReason24Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the request was denied.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedReason24Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setProprietary(GenericIdentification63 proprietary) {
