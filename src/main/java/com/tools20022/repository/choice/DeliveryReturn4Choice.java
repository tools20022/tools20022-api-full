...
@XmlType(name = "DeliveryReturn4Choice", propOrder = {"code", "proprietary"})
public class DeliveryReturn4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeliveryReturn4Choice.mmCode, com.tools20022.repository.choice.DeliveryReturn4Choice.mmProprietary);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeliveryReturn4Choice";
	...
	public DeliveryReturn4Choice setCode(DeliveryReturn1Code code) {
	...
	public DeliveryReturn4Choice setProprietary(GenericIdentification47 proprietary) {
