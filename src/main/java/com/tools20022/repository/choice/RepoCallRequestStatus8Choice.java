...
@XmlType(name = "RepoCallRequestStatus8Choice", propOrder = {"code", "proprietary"})
public class RepoCallRequestStatus8Choice {
	...
	public static final MMMessageAttribute<RepoCallRequestStatus8Choice, RepoCallRequestStatus1Code> mmCode = new MMMessageAttribute<RepoCallRequestStatus8Choice, RepoCallRequestStatus1Code>() {
		{
			...
			previousVersion_lazy = () -> RepoCallRequestStatus1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RepoCallRequestStatus8Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RepoCallRequestStatus8Choice, GenericIdentification30>() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the repurchase agreement call request.";
			previousVersion_lazy = () -> RepoCallRequestStatus1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				previousVersion_lazy = () -> RepoCallRequestStatus1Choice.mmObject();
			}
		});
	...
	public RepoCallRequestStatus8Choice setCode(RepoCallRequestStatus1Code code) {
	...
	public RepoCallRequestStatus8Choice setProprietary(GenericIdentification30 proprietary) {
