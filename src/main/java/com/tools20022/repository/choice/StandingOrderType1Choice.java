...
public class StandingOrderType1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> StandingOrderType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(StandingOrderType1Choice.mmCode, StandingOrderType1Choice.mmProprietary);
	...
	public void setCode(StandingOrderType1Code code) {
		this.code = code;
	}
