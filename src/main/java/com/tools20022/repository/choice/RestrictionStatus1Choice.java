...
import com.tools20022.repository.codeset.RestrictionStatus1Code;
 ...
 * definition} = "Choice of formats for the restriction or limitation status."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "RestrictionStatus1Choice", propOrder = {"code", "proprietary"})
public class RestrictionStatus1Choice {
	...
	public RestrictionStatus1Choice setCode(RestrictionStatus1Code code) {
	...
	public RestrictionStatus1Choice setProprietary(GenericIdentification47 proprietary) {
