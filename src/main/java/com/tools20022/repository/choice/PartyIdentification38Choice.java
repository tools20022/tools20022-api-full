...
public class PartyIdentification38Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification38Choice.BICFI, com.tools20022.repository.choice.PartyIdentification38Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification38Choice.ProprietaryIdentification);
