...
public class PartyIdentification38Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification38Choice.mmBICFI, PartyIdentification38Choice.mmNameAndAddress, PartyIdentification38Choice.mmProprietaryIdentification);
