 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.MarketIdentification1Choice#Description
 * MarketIdentification1Choice.Description}</li>
 * </ul>
 * </li>
...
public class MarketIdentification1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketIdentification1Choice.MarketIdentifierCode, com.tools20022.repository.choice.MarketIdentification1Choice.Description);
