...
public class MarketType6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketType6Choice.Code, com.tools20022.repository.choice.MarketType6Choice.Proprietary);
