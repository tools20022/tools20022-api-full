...
public class FailingStatus12Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus12Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus12Choice.mmNoSpecifiedReason, FailingStatus12Choice.mmReason);
	...
	public void setReason(List<FailingReason10> reason) {
		this.reason = reason;
	}
}