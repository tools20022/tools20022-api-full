 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PurposeCode2Choice#mmCode
...
@XmlType(name = "PurposeCode2Choice", propOrder = {"code", "proprietary"})
public class PurposeCode2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PurposeCode2Choice, SecuritiesAccountPurposeType1Code> mmCode = new MMMessageAttribute<PurposeCode2Choice, SecuritiesAccountPurposeType1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesAccount.mmSecuritiesAccountType;
			componentContext_lazy = () -> com.tools20022.repository.choice.PurposeCode2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(PurposeCode7Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesAccountPurposeType1Code getValue(PurposeCode2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PurposeCode2Choice obj, SecuritiesAccountPurposeType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PurposeCode2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PurposeCode2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesAccount.mmSecuritiesAccountType;
			componentContext_lazy = () -> com.tools20022.repository.choice.PurposeCode2Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PurposeCode7Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(PurposeCode2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PurposeCode2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PurposeCode2Choice.mmCode, com.tools20022.repository.choice.PurposeCode2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PurposeCode2Choice";
				definition = "Choice between a code and or a data source scheme to determine the account type.";
				nextVersions_lazy = () -> Arrays.asList(PurposeCode7Choice.mmObject());
			}
		});
	...
	public PurposeCode2Choice setCode(SecuritiesAccountPurposeType1Code code) {
	...
	public PurposeCode2Choice setProprietary(GenericIdentification20 proprietary) {
