...
public class GrossDividendRateFormat4Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat4Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat4Choice.mmAmount, GrossDividendRateFormat4Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat4Choice.mmNotSpecifiedRate);
