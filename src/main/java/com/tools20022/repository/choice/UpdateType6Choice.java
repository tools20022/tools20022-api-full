...
public class UpdateType6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UpdateType6Choice.mmAddition, UpdateType6Choice.mmDeletion, UpdateType6Choice.mmModification);
	...
	public void setAddition(SecuritiesSettlementTransactionDetails5 addition) {
	...
	public void setDeletion(SecuritiesSettlementTransactionDetails6 deletion) {
	...
	public void setModification(SecuritiesSettlementTransactionDetails7 modification) {
