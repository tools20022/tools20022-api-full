...
public class InterestRateUsedForPaymentFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat10Choice.mmRate, InterestRateUsedForPaymentFormat10Choice.mmAmount, InterestRateUsedForPaymentFormat10Choice.mmRateTypeAndAmountAndRateStatus,
						InterestRateUsedForPaymentFormat10Choice.mmNotSpecifiedRate);
