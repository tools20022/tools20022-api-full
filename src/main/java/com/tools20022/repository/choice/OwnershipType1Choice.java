 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OwnershipType1Choice#mmCode
...
@XmlType(name = "OwnershipType1Choice", propOrder = {"code", "proprietary"})
public class OwnershipType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AccountOwnershipType3Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OwnershipType1Choice, AccountOwnershipType3Code> mmCode = new MMMessageAttribute<OwnershipType1Choice, AccountOwnershipType3Code>() {
		{
			businessElementTrace_lazy = () -> InvestmentAccount.mmOwnershipType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OwnershipType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Ownership type expressed as a code.";
			nextVersions_lazy = () -> Arrays.asList(OwnershipType2Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AccountOwnershipType3Code getValue(OwnershipType1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OwnershipType1Choice obj, AccountOwnershipType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OwnershipType1Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<OwnershipType1Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> InvestmentAccount.mmOwnershipType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OwnershipType1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OwnershipType2Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification47 getValue(OwnershipType1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OwnershipType1Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OwnershipType1Choice.mmCode, com.tools20022.repository.choice.OwnershipType1Choice.mmProprietary);
	...
	public AccountOwnershipType3Code getCode() {
		return code;
	}

	public OwnershipType1Choice setCode(AccountOwnershipType3Code code) {
	...
	public OwnershipType1Choice setProprietary(GenericIdentification47 proprietary) {
