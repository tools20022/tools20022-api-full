...
public class OwnershipType1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OwnershipType2Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OwnershipType2Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(AccountOwnershipType3Code code) {
		this.code = code;
	}
