...
public class DeniedStatus19Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> DeniedStatus19Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedStatus19Choice.mmNoSpecifiedReason, DeniedStatus19Choice.mmReason);
	...
	public void setReason(List<DeniedReason17> reason) {
		this.reason = reason;
	}
}