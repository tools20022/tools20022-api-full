...
@XmlType(name = "InstructionProcessingStatus2Choice", propOrder = {"code", "proprietary"})
public class InstructionProcessingStatus2Choice {
	...
	public static final MMMessageAttribute<InstructionProcessingStatus2Choice, InstructionProcessingStatus1Code> mmCode = new MMMessageAttribute<InstructionProcessingStatus2Choice, InstructionProcessingStatus1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus23Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<InstructionProcessingStatus2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<InstructionProcessingStatus2Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of an instruction.";
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus23Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus23Choice.mmObject());
			}
		});
	...
	public InstructionProcessingStatus2Choice setCode(InstructionProcessingStatus1Code code) {
	...
	public InstructionProcessingStatus2Choice setProprietary(GenericIdentification20 proprietary) {
