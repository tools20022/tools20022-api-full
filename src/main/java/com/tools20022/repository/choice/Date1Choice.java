 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Date1Choice#mmCode
 * Date1Choice.mmCode}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Date1Choice#mmProprietary
 * Date1Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Date1Choice", propOrder = {"code", "proprietary"})
public class Date1Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Date1Choice Date1Choice}</li>
	...
	public static final MMMessageAttribute<Date1Choice, DateType2Code> mmCode = new MMMessageAttribute<Date1Choice, DateType2Code>() {
		{
			...
			name = "Code";
			definition = "Date is defined using a code.";
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "Date is determined using a data source scheme and a code."
	 * </li>
	 * </ul>
	 */
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Date1Choice.mmCode, com.tools20022.repository.choice.Date1Choice.mmProprietary);
	...
	public Date1Choice setCode(DateType2Code code) {
	...
	public Date1Choice setProprietary(GenericIdentification13 proprietary) {
