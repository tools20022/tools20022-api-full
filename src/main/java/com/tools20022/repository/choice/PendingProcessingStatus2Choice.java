...
public class PendingProcessingStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessingStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingStatus2Choice.mmNoSpecifiedReason, PendingProcessingStatus2Choice.mmReason);
	...
	public void setReason(List<PendingProcessingReason2> reason) {
		this.reason = reason;
	}
}