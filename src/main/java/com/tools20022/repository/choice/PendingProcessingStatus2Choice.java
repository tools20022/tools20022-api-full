...
import com.tools20022.repository.msg.PendingProcessingReason2;
...
@XmlType(name = "PendingProcessingStatus2Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingProcessingStatus2Choice {
	...
	@XmlElement(name = "Rsn")
	protected List<PendingProcessingReason2> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.msg.PendingProcessingReason2
	 * PendingProcessingReason2}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingStatus2Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingProcessingStatus2Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingStatus2Choice";
	...
	public PendingProcessingStatus2Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<PendingProcessingReason2> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingProcessingStatus2Choice setReason(List<PendingProcessingReason2> reason) {
