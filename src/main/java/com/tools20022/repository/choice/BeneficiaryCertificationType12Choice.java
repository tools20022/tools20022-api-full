...
@XmlType(name = "BeneficiaryCertificationType12Choice", propOrder = {"code", "proprietary"})
public class BeneficiaryCertificationType12Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BeneficiaryCertificationType12Choice, BeneficiaryCertificationType4Code> mmCode = new MMMessageAttribute<BeneficiaryCertificationType12Choice, BeneficiaryCertificationType4Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType12Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public BeneficiaryCertificationType4Code getValue(BeneficiaryCertificationType12Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BeneficiaryCertificationType12Choice obj, BeneficiaryCertificationType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BeneficiaryCertificationType12Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<BeneficiaryCertificationType12Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType12Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(BeneficiaryCertificationType12Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BeneficiaryCertificationType12Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficiaryCertificationType12Choice.mmCode, com.tools20022.repository.choice.BeneficiaryCertificationType12Choice.mmProprietary);
				trace_lazy = () -> BeneficialOwner.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BeneficiaryCertificationType12Choice";
	...
	public BeneficiaryCertificationType12Choice setCode(BeneficiaryCertificationType4Code code) {
	...
	public BeneficiaryCertificationType12Choice setProprietary(GenericIdentification47 proprietary) {
