...
public class PendingProcessingReason9Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason9Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason9Choice.mmNoSpecifiedReason, PendingProcessingReason9Choice.mmReason);
	...
	public void setReason(List<com.tools20022.repository.choice.PendingProcessingReason8Choice> reason) {
		this.reason = reason;
	}
}