...
public class FractionDispositionType10Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FractionDispositionType10Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FractionDispositionType10Choice.mmCode, FractionDispositionType10Choice.mmProprietary);
	...
	public void setCode(FractionDispositionType6Code code) {
		this.code = code;
	}
