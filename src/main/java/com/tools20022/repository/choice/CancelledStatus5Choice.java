...
import com.tools20022.repository.msg.CancellationReason7;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.CancelledStatus10Choice
...
@XmlType(name = "CancelledStatus5Choice", propOrder = {"noSpecifiedReason", "reason"})
public class CancelledStatus5Choice {
	...
	public static final MMMessageAttribute<CancelledStatus5Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<CancelledStatus5Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(CancelledStatus10Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected CancellationReason7 reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.CancellationReason7
	...
	public static final MMMessageAssociationEnd<CancelledStatus5Choice, CancellationReason7> mmReason = new MMMessageAssociationEnd<CancelledStatus5Choice, CancellationReason7>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CancelledStatus10Choice.mmReason);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus5Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.CancelledStatus5Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancelledStatus5Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(CancelledStatus10Choice.mmObject());
			}
		});
	...
	public CancelledStatus5Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public CancellationReason7 getReason() {
		return reason;
	}

	public CancelledStatus5Choice setReason(CancellationReason7 reason) {
