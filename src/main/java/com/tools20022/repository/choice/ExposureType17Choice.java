 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType17Choice#mmCode
...
@XmlType(name = "ExposureType17Choice", propOrder = {"code", "proprietary"})
public class ExposureType17Choice {
	...
	public static final MMMessageAttribute<ExposureType17Choice, ExposureType4Code> mmCode = new MMMessageAttribute<ExposureType17Choice, ExposureType4Code>() {
		{
			...
			previousVersion_lazy = () -> ExposureType13Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<ExposureType17Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<ExposureType17Choice, GenericIdentification47>() {
		{
			...
			previousVersion_lazy = () -> ExposureType13Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType17Choice.mmCode, com.tools20022.repository.choice.ExposureType17Choice.mmProprietary);
				trace_lazy = () -> ExposureTerm.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ExposureType17Choice";
				definition = "Choice of format for the exposure information.";
				previousVersion_lazy = () -> ExposureType13Choice.mmObject();
			}
		});
	...
	public ExposureType17Choice setCode(ExposureType4Code code) {
	...
	public ExposureType17Choice setProprietary(GenericIdentification47 proprietary) {
