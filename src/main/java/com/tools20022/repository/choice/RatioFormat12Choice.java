 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat12Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat12Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat12Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat12Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class RatioFormat12Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat12Choice, QuantityToQuantityRatio1> mmQuantityToQuantity = new MMMessageAssociationEnd<RatioFormat12Choice, QuantityToQuantityRatio1>() {
		{
			businessComponentTrace_lazy = () -> QuantityRatio.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat12Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
		...
		@Override
		public QuantityToQuantityRatio1 getValue(RatioFormat12Choice obj) {
			return obj.getQuantityToQuantity();
		}

		@Override
		public void setValue(RatioFormat12Choice obj, QuantityToQuantityRatio1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RatioFormat12Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RatioFormat12Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat12Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(RatioFormat12Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RatioFormat12Choice obj, RateValueType7Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat12Choice, AmountToAmountRatio2> mmAmountToAmount = new MMMessageAssociationEnd<RatioFormat12Choice, AmountToAmountRatio2>() {
		{
		...
		@Override
		public AmountToAmountRatio2 getValue(RatioFormat12Choice obj) {
			return obj.getAmountToAmount();
		}

		@Override
		public void setValue(RatioFormat12Choice obj, AmountToAmountRatio2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat12Choice, AmountAndQuantityRatio2> mmAmountToQuantity = new MMMessageAssociationEnd<RatioFormat12Choice, AmountAndQuantityRatio2>() {
		{
		...
		@Override
		public AmountAndQuantityRatio2 getValue(RatioFormat12Choice obj) {
			return obj.getAmountToQuantity();
		}

		@Override
		public void setValue(RatioFormat12Choice obj, AmountAndQuantityRatio2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat12Choice, AmountAndQuantityRatio2> mmQuantityToAmount = new MMMessageAssociationEnd<RatioFormat12Choice, AmountAndQuantityRatio2>() {
		{
			businessComponentTrace_lazy = () -> AmountAndQuantity.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat12Choice.mmObject();
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.choice.RatioFormat12Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat12Choice.mmNotSpecifiedRate,
								com.tools20022.repository.choice.RatioFormat12Choice.mmAmountToAmount, com.tools20022.repository.choice.RatioFormat12Choice.mmAmountToQuantity,
								com.tools20022.repository.choice.RatioFormat12Choice.mmQuantityToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat12Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat12Choice);
	...
	public RatioFormat12Choice setQuantityToQuantity(QuantityToQuantityRatio1 quantityToQuantity) {
	...
	public RatioFormat12Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RatioFormat12Choice setAmountToAmount(AmountToAmountRatio2 amountToAmount) {
	...
	public RatioFormat12Choice setAmountToQuantity(AmountAndQuantityRatio2 amountToQuantity) {
	...
	public RatioFormat12Choice setQuantityToAmount(AmountAndQuantityRatio2 quantityToAmount) {
