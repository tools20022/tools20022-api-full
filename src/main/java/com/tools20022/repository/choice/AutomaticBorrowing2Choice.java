...
@XmlType(name = "AutomaticBorrowing2Choice", propOrder = {"code", "proprietary"})
public class AutomaticBorrowing2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AutoBorrowing2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AutomaticBorrowing2Choice, AutoBorrowing2Code> mmCode = new MMMessageAttribute<AutomaticBorrowing2Choice, AutoBorrowing2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(AutomaticBorrowing7Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AutoBorrowing2Code getValue(AutomaticBorrowing2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AutomaticBorrowing2Choice obj, AutoBorrowing2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getSemanticMarkup
	 * semanticMarkup} = ISO15022Synonym: :22F::BORR/4!c[4c]/4!c</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getRegistrationStatus
	 * registrationStatus} =
	 * com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AutomaticBorrowing2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<AutomaticBorrowing2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing2Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			semanticMarkup_lazy = () -> Arrays.asList(new ISO15022Synonym(this, ":22F::BORR/4!c[4c]/4!c"));
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Condition for automatic borrowing expressed as a proprietary code.";
			nextVersions_lazy = () -> Arrays.asList(AutomaticBorrowing7Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(AutomaticBorrowing2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AutomaticBorrowing2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AutomaticBorrowing2Choice.mmCode, com.tools20022.repository.choice.AutomaticBorrowing2Choice.mmProprietary);
	...
	public AutoBorrowing2Code getCode() {
		return code;
	}

	public AutomaticBorrowing2Choice setCode(AutoBorrowing2Code code) {
	...
	public AutomaticBorrowing2Choice setProprietary(GenericIdentification20 proprietary) {
