...
import com.tools20022.repository.msg.RejectionOrRepairReason33;
...
@XmlType(name = "RejectionOrRepairStatus39Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionOrRepairStatus39Choice {
	...
	public static final MMMessageAttribute<RejectionOrRepairStatus39Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectionOrRepairStatus39Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> RejectionOrRepairStatus28Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected List<RejectionOrRepairReason33> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.msg.RejectionOrRepairReason33
	 * RejectionOrRepairReason33}</li>
	 * <li>
	...
	public static final MMMessageAssociationEnd<RejectionOrRepairStatus39Choice, List<RejectionOrRepairReason33>> mmReason = new MMMessageAssociationEnd<RejectionOrRepairStatus39Choice, List<RejectionOrRepairReason33>>() {
		{
			...
			previousVersion_lazy = () -> RejectionOrRepairStatus28Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus39Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus39Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RejectionOrRepairStatus39Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				previousVersion_lazy = () -> RejectionOrRepairStatus28Choice.mmObject();
			}
		});
	...
	public RejectionOrRepairStatus39Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionOrRepairReason33> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionOrRepairStatus39Choice setReason(List<RejectionOrRepairReason33> reason) {
