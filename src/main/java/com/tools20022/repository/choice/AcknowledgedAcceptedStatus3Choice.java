...
public class AcknowledgedAcceptedStatus3Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AcknowledgedAcceptedStatus3Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus3Choice.NoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus3Choice.Reason);
