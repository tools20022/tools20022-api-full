...
import com.tools20022.repository.choice.CancelledStatus2Choice;
import com.tools20022.repository.choice.PendingCancellationStatus2Choice;
...
@XmlType(name = "InstructionCancellationRequestStatus2Choice", propOrder = {"cancellationCompleted", "accepted", "rejected", "pendingCancellation", "proprietaryStatus"})
public class InstructionCancellationRequestStatus2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, CancelledStatus2Choice> mmCancellationCompleted = new MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, CancelledStatus2Choice>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatus.mmCorporateActionStatusReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "CxlCmpltd";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CancelledStatus2Choice.mmObject();
		}

		@Override
		public CancelledStatus2Choice getValue(InstructionCancellationRequestStatus2Choice obj) {
			return obj.getCancellationCompleted();
		}

		@Override
		public void setValue(InstructionCancellationRequestStatus2Choice obj, CancelledStatus2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, AcceptedStatus2Choice> mmAccepted = new MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, AcceptedStatus2Choice>() {
		{
		...
		@Override
		public AcceptedStatus2Choice getValue(InstructionCancellationRequestStatus2Choice obj) {
			return obj.getAccepted();
		}

		@Override
		public void setValue(InstructionCancellationRequestStatus2Choice obj, AcceptedStatus2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, RejectedStatus2Choice> mmRejected = new MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, RejectedStatus2Choice>() {
		{
		...
		@Override
		public RejectedStatus2Choice getValue(InstructionCancellationRequestStatus2Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(InstructionCancellationRequestStatus2Choice obj, RejectedStatus2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, PendingCancellationStatus2Choice> mmPendingCancellation = new MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, PendingCancellationStatus2Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PendingCancellationStatus2Choice.mmObject();
		}

		@Override
		public PendingCancellationStatus2Choice getValue(InstructionCancellationRequestStatus2Choice obj) {
			return obj.getPendingCancellation();
		}

		@Override
		public void setValue(InstructionCancellationRequestStatus2Choice obj, PendingCancellationStatus2Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, ProprietaryStatusAndReason2> mmProprietaryStatus = new MMMessageAssociationEnd<InstructionCancellationRequestStatus2Choice, ProprietaryStatusAndReason2>() {
		{
		...
		@Override
		public ProprietaryStatusAndReason2 getValue(InstructionCancellationRequestStatus2Choice obj) {
			return obj.getProprietaryStatus();
		}

		@Override
		public void setValue(InstructionCancellationRequestStatus2Choice obj, ProprietaryStatusAndReason2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmCancellationCompleted,
						com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmAccepted, com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmRejected,
						com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmPendingCancellation, com.tools20022.repository.choice.InstructionCancellationRequestStatus2Choice.mmProprietaryStatus);
	...
	public InstructionCancellationRequestStatus2Choice setCancellationCompleted(CancelledStatus2Choice cancellationCompleted) {
	...
	public InstructionCancellationRequestStatus2Choice setAccepted(AcceptedStatus2Choice accepted) {
	...
	public InstructionCancellationRequestStatus2Choice setRejected(RejectedStatus2Choice rejected) {
	...
	public InstructionCancellationRequestStatus2Choice setPendingCancellation(PendingCancellationStatus2Choice pendingCancellation) {
	...
	public InstructionCancellationRequestStatus2Choice setProprietaryStatus(ProprietaryStatusAndReason2 proprietaryStatus) {
