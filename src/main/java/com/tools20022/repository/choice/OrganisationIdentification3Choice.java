...
@XmlType(name = "OrganisationIdentification3Choice", propOrder = {"lEI", "clientIdentification", "anyBIC"})
public class OrganisationIdentification3Choice {
	...
	public static final MMMessageAttribute mmClientIdentification = new MMMessageAttribute() {
		{
			...
			definition = "Unique and unambiguous client identification of the organisation.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OrganisationIdentification3Choice.mmLEI, com.tools20022.repository.choice.OrganisationIdentification3Choice.mmClientIdentification,
						com.tools20022.repository.choice.OrganisationIdentification3Choice.mmAnyBIC);
				trace_lazy = () -> OrganisationIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "OrganisationIdentification3Choice";
	...
	public OrganisationIdentification3Choice setLEI(LEIIdentifier lEI) {
	...
	public OrganisationIdentification3Choice setClientIdentification(Max50Text clientIdentification) {
	...
	public OrganisationIdentification3Choice setAnyBIC(AnyBICIdentifier anyBIC) {
