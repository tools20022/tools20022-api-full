...
import com.tools20022.repository.codeset.RepurchaseType4Code;
...
@XmlType(name = "RepurchaseType5Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType5Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RepurchaseType4Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RepurchaseType5Choice
	 * RepurchaseType5Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType5Choice, RepurchaseType4Code> mmCode = new MMMessageAttribute<RepurchaseType5Choice, RepurchaseType4Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> RepurchaseType4Code.mmObject();
		}

		@Override
		public RepurchaseType4Code getValue(RepurchaseType5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType5Choice obj, RepurchaseType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RepurchaseType5Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<RepurchaseType5Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(RepurchaseType5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType5Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType5Choice.mmCode, com.tools20022.repository.choice.RepurchaseType5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType5Choice";
	...
	public RepurchaseType4Code getCode() {
		return code;
	}

	public RepurchaseType5Choice setCode(RepurchaseType4Code code) {
	...
	public RepurchaseType5Choice setProprietary(GenericIdentification25 proprietary) {
