...
public class ReservationCriteriaDefinition1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReservationCriteriaDefinition1Choice.mmQueryName, ReservationCriteriaDefinition1Choice.mmNewCriteria);
	...
	public void setNewCriteria(ReservationCriteria1 newCriteria) {
