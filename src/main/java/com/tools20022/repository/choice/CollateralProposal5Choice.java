...
public class CollateralProposal5Choice {
	...
	public static final MMMessageAssociationEnd CollateralProposalDetails = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CollateralProposal4Choice.CollateralProposalDetails;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SegregatedIndependentAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CollateralProposal4Choice.SegregatedIndependentAmount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CollateralProposal5Choice.CollateralProposalDetails, com.tools20022.repository.choice.CollateralProposal5Choice.SegregatedIndependentAmount);
