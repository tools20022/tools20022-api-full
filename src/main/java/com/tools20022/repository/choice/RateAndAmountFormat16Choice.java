...
public class RateAndAmountFormat16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateAndAmountFormat16Choice.mmRate, RateAndAmountFormat16Choice.mmNotSpecifiedRate, RateAndAmountFormat16Choice.mmAmount);
