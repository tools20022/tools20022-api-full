...
@XmlType(name = "SettlementStatus5Choice", propOrder = {"code", "proprietary"})
public class SettlementStatus5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementStatus5Choice, SecuritiesSettlementStatus2Code> mmCode = new MMMessageAttribute<SettlementStatus5Choice, SecuritiesSettlementStatus2Code>() {
		{
			businessElementTrace_lazy = () -> Status.mmSettlementStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStatus5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Provides the status of settlement of an instruction/financial instrument movement.";
			nextVersions_lazy = () -> Arrays.asList(SettlementStatus19Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesSettlementStatus2Code getValue(SettlementStatus5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementStatus5Choice obj, SecuritiesSettlementStatus2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementStatus5Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<SettlementStatus5Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Status.mmSettlementStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStatus5Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Provides the status of settlement of an instruction/financial instrument movement.";
			nextVersions_lazy = () -> Arrays.asList(SettlementStatus19Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(SettlementStatus5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementStatus5Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementStatus5Choice.mmCode, com.tools20022.repository.choice.SettlementStatus5Choice.mmProprietary);
	...
	public SettlementStatus5Choice setCode(SecuritiesSettlementStatus2Code code) {
	...
	public SettlementStatus5Choice setProprietary(GenericIdentification20 proprietary) {
