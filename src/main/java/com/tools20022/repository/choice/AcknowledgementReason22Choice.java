...
@XmlType(name = "AcknowledgementReason22Choice", propOrder = {"code", "proprietary"})
public class AcknowledgementReason22Choice {
	...
	public AcknowledgementReason22Choice setCode(AcknowledgementReason3Code code) {
	...
	public AcknowledgementReason22Choice setProprietary(GenericIdentification47 proprietary) {
