...
@XmlType(name = "PriceType5Choice", propOrder = {"market", "indicative"})
public class PriceType5Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PriceType5Choice
	 * PriceType5Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceType5Choice, Price3> mmMarket = new MMMessageAssociationEnd<PriceType5Choice, Price3>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesPricing.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Mkt";
		...
		@Override
		public Price3 getValue(PriceType5Choice obj) {
			return obj.getMarket();
		}

		@Override
		public void setValue(PriceType5Choice obj, Price3 value) {
			obj.setMarket(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceType5Choice, Price3> mmIndicative = new MMMessageAssociationEnd<PriceType5Choice, Price3>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesPricing.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceType5Choice.mmObject();
			isDerived = false;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceType5Choice.mmMarket, com.tools20022.repository.choice.PriceType5Choice.mmIndicative);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PriceType5Choice";
	...
	public PriceType5Choice setMarket(Price3 market) {
	...
	public PriceType5Choice setIndicative(Price3 indicative) {
