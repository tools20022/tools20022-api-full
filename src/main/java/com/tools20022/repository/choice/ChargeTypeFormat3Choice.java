...
import com.tools20022.repository.codeset.ChargeType17Code;
...
public class ChargeTypeFormat3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ChargeTypeFormat3Choice.Code, com.tools20022.repository.choice.ChargeTypeFormat3Choice.Proprietary);
