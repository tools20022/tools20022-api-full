...
@XmlType(name = "Role3Choice", propOrder = {"code", "proprietary", "text"})
public class Role3Choice {
	...
	public Role3Choice setCode(InvestmentFundRole2Code code) {
	...
	public Role3Choice setProprietary(GenericIdentification25 proprietary) {
	...
	public Role3Choice setText(RestrictedFINXMax350Text text) {
