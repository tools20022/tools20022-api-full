...
@XmlType(name = "RateType11Choice", propOrder = {"code", "proprietary"})
public class RateType11Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RateType11Choice
	 * RateType11Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType11Choice.mmCode, com.tools20022.repository.choice.RateType11Choice.mmProprietary);
				trace_lazy = () -> Tax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType11Choice";
	...
	public RateType11Choice setCode(TaxType4Code code) {
	...
	public RateType11Choice setProprietary(GenericIdentification20 proprietary) {
