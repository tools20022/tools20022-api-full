...
public class RejectionReason19FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason19FormatChoice.mmCode, RejectionReason19FormatChoice.mmProprietary);
	...
	public void setCode(RejectionReason19Code code) {
		this.code = code;
	}
