...
public class RejectionReason19FormatChoice {
	...
	/**
	 * Standard code to specify the reason of a rejection of a global movement
	 * authorisation request.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RejectionReason19FormatChoice.mmObject();
	...
	/**
	 * Proprietary code to express the reason of a rejection of a global
	 * movement authorisation request.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason19FormatChoice.Code, com.tools20022.repository.choice.RejectionReason19FormatChoice.Proprietary);
