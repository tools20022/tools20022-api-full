 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Frequency2Choice#Code
 * Frequency2Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Frequency2Choice#Proprietary
 * Frequency2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Frequency2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Frequency2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Frequency2Choice.Code, com.tools20022.repository.choice.Frequency2Choice.Proprietary);
