...
public class SafekeepingPlaceFormat7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SafekeepingPlaceFormat7Choice.Identification, com.tools20022.repository.choice.SafekeepingPlaceFormat7Choice.Country,
						com.tools20022.repository.choice.SafekeepingPlaceFormat7Choice.TypeAndIdentification, com.tools20022.repository.choice.SafekeepingPlaceFormat7Choice.Proprietary);
