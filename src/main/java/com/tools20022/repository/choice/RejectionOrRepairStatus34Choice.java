...
public class RejectionOrRepairStatus34Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus34Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus34Choice.mmNoSpecifiedReason, RejectionOrRepairStatus34Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason28> reason) {
		this.reason = reason;
	}
}