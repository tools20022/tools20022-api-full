...
@XmlType(name = "RepurchaseType7Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType7Choice, RepurchaseType5Code> mmCode = new MMMessageAttribute<RepurchaseType7Choice, RepurchaseType5Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType15Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RepurchaseType5Code getValue(RepurchaseType7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType7Choice obj, RepurchaseType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RepurchaseType7Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RepurchaseType7Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType7Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType15Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RepurchaseType7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType7Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType7Choice.mmCode, com.tools20022.repository.choice.RepurchaseType7Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType7Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				nextVersions_lazy = () -> Arrays.asList(RepurchaseType15Choice.mmObject());
			}
		});
	...
	public RepurchaseType7Choice setCode(RepurchaseType5Code code) {
	...
	public RepurchaseType7Choice setProprietary(GenericIdentification20 proprietary) {
