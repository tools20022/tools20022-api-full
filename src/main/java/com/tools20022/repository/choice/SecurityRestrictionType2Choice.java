...
@XmlType(name = "SecurityRestrictionType2Choice", propOrder = {"restrictionType", "proprietaryRestriction"})
public class SecurityRestrictionType2Choice {
	...
	public static final MMMessageAttribute<SecurityRestrictionType2Choice, RestrictionType1Code> mmRestrictionType = new MMMessageAttribute<SecurityRestrictionType2Choice, RestrictionType1Code>() {
		{
			...
			previousVersion_lazy = () -> SecurityRestrictionType1Choice.mmRestrictionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected GenericIdentification30 proprietaryRestriction;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<SecurityRestrictionType2Choice, GenericIdentification30> mmProprietaryRestriction = new MMMessageAttribute<SecurityRestrictionType2Choice, GenericIdentification30>() {
		{
			...
			definition = "Type of the restriction, for example, selling restriction, buying restriction, placing restriction.";
			previousVersion_lazy = () -> SecurityRestrictionType1Choice.mmProprietaryRestriction;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecurityRestrictionType2Choice.mmRestrictionType, com.tools20022.repository.choice.SecurityRestrictionType2Choice.mmProprietaryRestriction);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SecurityRestrictionType2Choice";
				definition = "Choice between the type of restriction.";
				previousVersion_lazy = () -> SecurityRestrictionType1Choice.mmObject();
			}
		});
	...
	public SecurityRestrictionType2Choice setRestrictionType(RestrictionType1Code restrictionType) {
		this.restrictionType = Objects.requireNonNull(restrictionType);
		return this;
	}

	public GenericIdentification30 getProprietaryRestriction() {
		return proprietaryRestriction;
	}

	public SecurityRestrictionType2Choice setProprietaryRestriction(GenericIdentification30 proprietaryRestriction) {
