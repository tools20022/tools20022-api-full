...
@XmlType(name = "SettlementStandingInstructionDatabase2Choice", propOrder = {"code", "proprietary"})
public class SettlementStandingInstructionDatabase2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementStandingInstructionDatabase2Choice, SettlementStandingInstructionDatabase1Code> mmCode = new MMMessageAttribute<SettlementStandingInstructionDatabase2Choice, SettlementStandingInstructionDatabase1Code>() {
		{
			businessElementTrace_lazy = () -> StandingSettlementInstruction.mmSettlementStandingInstructionDatabase;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStandingInstructionDatabase2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public SettlementStandingInstructionDatabase1Code getValue(SettlementStandingInstructionDatabase2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementStandingInstructionDatabase2Choice obj, SettlementStandingInstructionDatabase1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementStandingInstructionDatabase2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<SettlementStandingInstructionDatabase2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> StandingSettlementInstruction.mmSettlementStandingInstructionDatabase;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementStandingInstructionDatabase2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(SettlementStandingInstructionDatabase2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementStandingInstructionDatabase2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementStandingInstructionDatabase2Choice.mmCode, com.tools20022.repository.choice.SettlementStandingInstructionDatabase2Choice.mmProprietary);
				trace_lazy = () -> StandingSettlementInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementStandingInstructionDatabase2Choice";
	...
	public SettlementStandingInstructionDatabase2Choice setCode(SettlementStandingInstructionDatabase1Code code) {
	...
	public SettlementStandingInstructionDatabase2Choice setProprietary(GenericIdentification25 proprietary) {
