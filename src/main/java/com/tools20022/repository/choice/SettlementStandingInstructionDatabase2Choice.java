...
public class SettlementStandingInstructionDatabase2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementStandingInstructionDatabase2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementStandingInstructionDatabase2Choice.mmCode, SettlementStandingInstructionDatabase2Choice.mmProprietary);
