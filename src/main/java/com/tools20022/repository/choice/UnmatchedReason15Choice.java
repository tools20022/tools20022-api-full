...
public class UnmatchedReason15Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> UnmatchedReason15Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedReason10Choice.Code;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason24Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedReason10Choice.Proprietary;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason24Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason15Choice.Code, com.tools20022.repository.choice.UnmatchedReason15Choice.Proprietary);
