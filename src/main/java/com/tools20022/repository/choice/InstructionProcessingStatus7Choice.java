...
public class InstructionProcessingStatus7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus7Choice.mmCancelled, InstructionProcessingStatus7Choice.mmAccepted, InstructionProcessingStatus7Choice.mmRejected,
						InstructionProcessingStatus7Choice.mmPending, InstructionProcessingStatus7Choice.mmDefaultAction, InstructionProcessingStatus7Choice.mmStandingInstruction, InstructionProcessingStatus7Choice.mmProprietaryStatus);
