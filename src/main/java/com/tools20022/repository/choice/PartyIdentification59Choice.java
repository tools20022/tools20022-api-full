...
public class PartyIdentification59Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification59Choice.mmAnyBIC, PartyIdentification59Choice.mmProprietaryIdentification, PartyIdentification59Choice.mmNameAndAddress);
