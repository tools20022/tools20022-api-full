...
public class PartyIdentification48Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification48Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification48Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification48Choice.NameAndAddress);
