...
public class PartyIdentification48Choice {
	...
	public static final MMMessageAttribute mmAnyBIC = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification48Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification48Choice.mmAnyBIC, PartyIdentification48Choice.mmProprietaryIdentification, PartyIdentification48Choice.mmNameAndAddress);
