...
@XmlType(name = "RepurchaseType19Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType19Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType19Choice, RepurchaseType3Code> mmCode = new MMMessageAttribute<RepurchaseType19Choice, RepurchaseType3Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType19Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public RepurchaseType3Code getValue(RepurchaseType19Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType19Choice obj, RepurchaseType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType19Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<RepurchaseType19Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType19Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(RepurchaseType19Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType19Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType19Choice.mmCode, com.tools20022.repository.choice.RepurchaseType19Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType19Choice";
	...
	public RepurchaseType19Choice setCode(RepurchaseType3Code code) {
	...
	public RepurchaseType19Choice setProprietary(GenericIdentification47 proprietary) {
