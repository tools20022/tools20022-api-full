...
@XmlType(name = "RateType30Choice", propOrder = {"code", "proprietary"})
public class RateType30Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType30Choice, WithholdingTaxRateType1Code> mmCode = new MMMessageAttribute<RateType30Choice, WithholdingTaxRateType1Code>() {
		{
			businessElementTrace_lazy = () -> Tax.mmWithholdingTaxType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType30Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public WithholdingTaxRateType1Code getValue(RateType30Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType30Choice obj, WithholdingTaxRateType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateType30Choice, GenericIdentification51> mmProprietary = new MMMessageAssociationEnd<RateType30Choice, GenericIdentification51>() {
		{
			businessElementTrace_lazy = () -> Tax.mmWithholdingTaxType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType30Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification51 getValue(RateType30Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType30Choice obj, GenericIdentification51 value) {
	...
	public RateType30Choice setCode(WithholdingTaxRateType1Code code) {
	...
	public RateType30Choice setProprietary(GenericIdentification51 proprietary) {
