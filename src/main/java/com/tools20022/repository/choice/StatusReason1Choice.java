 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatusReason1Choice#mmCode
...
@XmlType(name = "StatusReason1Choice", propOrder = {"code", "proprietary"})
public class StatusReason1Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.StatusReason1Choice
	 * StatusReason1Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatusReason1Choice.mmCode, com.tools20022.repository.choice.StatusReason1Choice.mmProprietary);
				trace_lazy = () -> PaymentStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StatusReason1Choice";
	...
	public StatusReason1Choice setCode(TransactionRejectReason2Code code) {
	...
	public StatusReason1Choice setProprietary(Max35Text proprietary) {
