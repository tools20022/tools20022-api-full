...
public class Quantity23Choice {
	...
	public void setOriginalAndCurrentFaceAmount(OriginalAndCurrentQuantities7 originalAndCurrentFaceAmount) {
	...
	public void setSignedQuantity(SignedQuantityFormat9 signedQuantity) {
