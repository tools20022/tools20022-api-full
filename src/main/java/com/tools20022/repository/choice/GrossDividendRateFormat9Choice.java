...
public class GrossDividendRateFormat9Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat9Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat9Choice.mmAmount, GrossDividendRateFormat9Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat9Choice.mmNotSpecifiedRate);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus15 rateTypeAndAmountAndRateStatus) {
