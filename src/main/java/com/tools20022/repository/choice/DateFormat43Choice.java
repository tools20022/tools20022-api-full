...
public class DateFormat43Choice {
	...
	public static final MMMessageAssociationEnd mmDate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DateFormat31Choice.mmDate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmDateCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> DateFormat31Choice.mmDateCode;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				previousVersion_lazy = () -> DateFormat31Choice.mmObject();
			}
		});
	...
	public DateFormat43Choice setDate(com.tools20022.repository.choice.DateAndDateTime2Choice date) {
	...
	public DateFormat43Choice setDateCode(com.tools20022.repository.choice.DateCode19Choice dateCode) {
