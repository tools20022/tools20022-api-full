 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.LevelOfControl1Choice#Code
 * LevelOfControl1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.LevelOfControl1Choice#Proprietary
 * LevelOfControl1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class LevelOfControl1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> LevelOfControl1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LevelOfControl1Choice.Code, com.tools20022.repository.choice.LevelOfControl1Choice.Proprietary);
