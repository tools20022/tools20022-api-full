...
public class InstructionProcessingStatus26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingStatus26Choice.Code, com.tools20022.repository.choice.InstructionProcessingStatus26Choice.Proprietary);
