...
import com.tools20022.repository.codeset.InstructionProcessingStatus1Code;
...
@XmlType(name = "InstructionProcessingStatus26Choice", propOrder = {"code", "proprietary"})
public class InstructionProcessingStatus26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingStatus26Choice.mmCode, com.tools20022.repository.choice.InstructionProcessingStatus26Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InstructionProcessingStatus26Choice";
	...
	public InstructionProcessingStatus26Choice setCode(InstructionProcessingStatus1Code code) {
	...
	public InstructionProcessingStatus26Choice setProprietary(GenericIdentification47 proprietary) {
