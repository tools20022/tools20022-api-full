...
@XmlType(name = "IntermediateSecuritiesDistributionTypeFormat5Choice", propOrder = {"code", "proprietary"})
public class IntermediateSecuritiesDistributionTypeFormat5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat5Choice, IntermediateSecurityDistributionType4Code> mmCode = new MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat5Choice, IntermediateSecurityDistributionType4Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public IntermediateSecurityDistributionType4Code getValue(IntermediateSecuritiesDistributionTypeFormat5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat5Choice obj, IntermediateSecurityDistributionType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat5Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat5Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(IntermediateSecuritiesDistributionTypeFormat5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat5Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				name = "IntermediateSecuritiesDistributionTypeFormat5Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat9Choice.mmObject(), IntermediateSecuritiesDistributionTypeFormat16Choice.mmObject());
			}
		});
	...
	public IntermediateSecuritiesDistributionTypeFormat5Choice setCode(IntermediateSecurityDistributionType4Code code) {
	...
	public IntermediateSecuritiesDistributionTypeFormat5Choice setProprietary(GenericIdentification20 proprietary) {
