 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.LetterOfGuarantee4Choice
...
@XmlType(name = "LetterOfGuarantee1Choice", propOrder = {"indicator", "proprietary"})
public class LetterOfGuarantee1Choice {
	 ...
	 * semanticMarkup} = ISO15022Synonym: :22F::LEOG//4!c</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getRegistrationStatus
	 * registrationStatus} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LetterOfGuarantee1Choice, YesNoIndicator> mmIndicator = new MMMessageAttribute<LetterOfGuarantee1Choice, YesNoIndicator>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmLetterOfGuarantee;
			componentContext_lazy = () -> com.tools20022.repository.choice.LetterOfGuarantee1Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
			semanticMarkup_lazy = () -> Arrays.asList(new ISO15022Synonym(this, ":22F::LEOG//4!c"));
			...
			nextVersions_lazy = () -> Arrays.asList(LetterOfGuarantee4Choice.mmIndicator);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public YesNoIndicator getValue(LetterOfGuarantee1Choice obj) {
			return obj.getIndicator();
		}

		@Override
		public void setValue(LetterOfGuarantee1Choice obj, YesNoIndicator value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LetterOfGuarantee1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<LetterOfGuarantee1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmLetterOfGuarantee;
			componentContext_lazy = () -> com.tools20022.repository.choice.LetterOfGuarantee1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(LetterOfGuarantee4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(LetterOfGuarantee1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(LetterOfGuarantee1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LetterOfGuarantee1Choice.mmIndicator, com.tools20022.repository.choice.LetterOfGuarantee1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "LetterOfGuarantee1Choice";
				definition = "Choice of format for the letter of guarantee information.";
				nextVersions_lazy = () -> Arrays.asList(LetterOfGuarantee4Choice.mmObject());
			}
		});
	...
	public LetterOfGuarantee1Choice setIndicator(YesNoIndicator indicator) {
	...
	public LetterOfGuarantee1Choice setProprietary(GenericIdentification20 proprietary) {
