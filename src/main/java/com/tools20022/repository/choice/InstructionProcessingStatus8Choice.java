...
public class InstructionProcessingStatus8Choice {
	...
	public static final MMMessageAssociationEnd Cancelled = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> InstructionProcessingStatus8Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingStatus8Choice.Cancelled, com.tools20022.repository.choice.InstructionProcessingStatus8Choice.Accepted,
						com.tools20022.repository.choice.InstructionProcessingStatus8Choice.Rejected, com.tools20022.repository.choice.InstructionProcessingStatus8Choice.Pending,
						...
						com.tools20022.repository.choice.InstructionProcessingStatus8Choice.ProprietaryStatus);
