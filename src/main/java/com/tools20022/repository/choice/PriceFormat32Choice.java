 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat32Choice#NotSpecifiedPrice
 * PriceFormat32Choice.NotSpecifiedPrice}</li>
 * <li>
...
public class PriceFormat32Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat32Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.PercentagePrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.PercentagePrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.AmountPrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.AmountPrice);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.PriceFormat47Choice#NotSpecifiedPrice
	 * PriceFormat47Choice.NotSpecifiedPrice}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.PriceFormat20Choice#NotSpecifiedPrice
	 * PriceFormat20Choice.NotSpecifiedPrice}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute NotSpecifiedPrice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.NotSpecifiedPrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.NotSpecifiedPrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.AmountPricePerFinancialInstrumentQuantity;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.AmountPricePerFinancialInstrumentQuantity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.AmountPricePerAmount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.AmountPricePerAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IndexPoints = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat47Choice.IndexPoints);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat32Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat32Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat32Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat32Choice.AmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat32Choice.AmountPricePerAmount, com.tools20022.repository.choice.PriceFormat32Choice.IndexPoints);
