 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat32Choice#mmNotSpecifiedPrice
 * PriceFormat32Choice.mmNotSpecifiedPrice}</li>
 * <li>
...
@XmlType(name = "PriceFormat32Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount", "indexPoints"})
public class PriceFormat32Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat32Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat32Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat32Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmPercentagePrice);
			previousVersion_lazy = () -> PriceFormat20Choice.mmPercentagePrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat32Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat32Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat32Choice, AmountPrice3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmAmountPrice);
			previousVersion_lazy = () -> PriceFormat20Choice.mmAmountPrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPrice3 getValue(PriceFormat32Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, AmountPrice3 value) {
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.PriceFormat20Choice#mmNotSpecifiedPrice
	 * PriceFormat20Choice.mmNotSpecifiedPrice}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat32Choice, PriceValueType8Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat32Choice, PriceValueType8Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat32Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmNotSpecifiedPrice);
			previousVersion_lazy = () -> PriceFormat20Choice.mmNotSpecifiedPrice;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PriceValueType8Code getValue(PriceFormat32Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, PriceValueType8Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat32Choice, AmountPricePerFinancialInstrumentQuantity3> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat32Choice, AmountPricePerFinancialInstrumentQuantity3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmAmountPricePerFinancialInstrumentQuantity);
			previousVersion_lazy = () -> PriceFormat20Choice.mmAmountPricePerFinancialInstrumentQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity3 getValue(PriceFormat32Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, AmountPricePerFinancialInstrumentQuantity3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat32Choice, AmountPricePerAmount2> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat32Choice, AmountPricePerAmount2>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmAmountPricePerAmount);
			previousVersion_lazy = () -> PriceFormat20Choice.mmAmountPricePerAmount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPricePerAmount2 getValue(PriceFormat32Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, AmountPricePerAmount2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat32Choice, DecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat32Choice, DecimalNumber>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmIndexPoints);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DecimalNumber getValue(PriceFormat32Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat32Choice obj, DecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat32Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat32Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat32Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat32Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat32Choice.mmAmountPricePerAmount, com.tools20022.repository.choice.PriceFormat32Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat32Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat32Choice);
				...
				nextVersions_lazy = () -> Arrays.asList(PriceFormat47Choice.mmObject());
				previousVersion_lazy = () -> PriceFormat20Choice.mmObject();
			}
		});
	...
	public PriceFormat32Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat32Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat32Choice setNotSpecifiedPrice(PriceValueType8Code notSpecifiedPrice) {
	...
	public PriceFormat32Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity3 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat32Choice setAmountPricePerAmount(AmountPricePerAmount2 amountPricePerAmount) {
	...
	public PriceFormat32Choice setIndexPoints(DecimalNumber indexPoints) {
