...
public class ProcessingStatus25Choice {
	...
	public static final MMMessageAssociationEnd mmAcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus25Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionStatus11Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus25Choice.mmAcknowledgedAccepted, ProcessingStatus25Choice.mmPendingProcessing, ProcessingStatus25Choice.mmRejected, ProcessingStatus25Choice.mmRepair,
						ProcessingStatus25Choice.mmCancelled, ProcessingStatus25Choice.mmPendingCancellation, ProcessingStatus25Choice.mmProprietary, ProcessingStatus25Choice.mmCancellationRequested,
						ProcessingStatus25Choice.mmModificationRequested);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionStatus11Choice rejected) {
