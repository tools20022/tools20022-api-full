...
@XmlType(name = "RateType12FormatChoice", propOrder = {"code", "proprietary"})
public class RateType12FormatChoice {
	...
	public RateType12FormatChoice setCode(RateType12Code code) {
	...
	public RateType12FormatChoice setProprietary(GenericIdentification13 proprietary) {
