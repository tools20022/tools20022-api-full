...
public class GrossDividendRateFormat11Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat11Choice.mmAmount, GrossDividendRateFormat11Choice.mmRateTypeAndAmountAndRateStatus);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus17 rateTypeAndAmountAndRateStatus) {
