...
public class RegistrationProcessingStatus3Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RegistrationProcessingStatus1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the registration processing.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.RegistrationProcessingStatus1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RegistrationProcessingStatus3Choice.Code, com.tools20022.repository.choice.RegistrationProcessingStatus3Choice.Proprietary);
