 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.VoteChoice#VoteInstruction
...
public class VoteChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.VoteChoice.VoteInstruction, com.tools20022.repository.choice.VoteChoice.GlobalVoteInstruction);
