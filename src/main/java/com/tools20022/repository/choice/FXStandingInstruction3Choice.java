...
public class FXStandingInstruction3Choice {
	...
	public static final MMMessageAttribute Indicator = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> FXStandingInstruction3Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FXStandingInstruction3Choice.Indicator, com.tools20022.repository.choice.FXStandingInstruction3Choice.Proprietary);
