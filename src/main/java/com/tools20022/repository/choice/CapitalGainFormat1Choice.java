...
@XmlType(name = "CapitalGainFormat1Choice", propOrder = {"code", "proprietary"})
public class CapitalGainFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CapitalGainFormat1Choice, EUCapitalGain2Code> mmCode = new MMMessageAttribute<CapitalGainFormat1Choice, EUCapitalGain2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTax.mmEUCapitalGain;
			componentContext_lazy = () -> com.tools20022.repository.choice.CapitalGainFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CapitalGainFormat3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public EUCapitalGain2Code getValue(CapitalGainFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CapitalGainFormat1Choice obj, EUCapitalGain2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CapitalGainFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CapitalGainFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTax.mmEUCapitalGain;
			componentContext_lazy = () -> com.tools20022.repository.choice.CapitalGainFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CapitalGainFormat3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(CapitalGainFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CapitalGainFormat1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CapitalGainFormat1Choice.mmCode, com.tools20022.repository.choice.CapitalGainFormat1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CapitalGainFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of capital gain.";
				nextVersions_lazy = () -> Arrays.asList(CapitalGainFormat3Choice.mmObject());
			}
		});
	...
	public CapitalGainFormat1Choice setCode(EUCapitalGain2Code code) {
	...
	public CapitalGainFormat1Choice setProprietary(GenericIdentification20 proprietary) {
