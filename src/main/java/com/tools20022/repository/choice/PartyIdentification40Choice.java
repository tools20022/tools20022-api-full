 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistencePartyProprietaryIdentificationRule#forPartyIdentification40Choice
 * ConstraintCoexistencePartyProprietaryIdentificationRule.
 * forPartyIdentification40Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceNameAndAdressRule#forPartyIdentification40Choice
 * ConstraintCoexistenceNameAndAdressRule.forPartyIdentification40Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PartyIdentification40Choice", propOrder = {"anyBIC", "proprietaryIdentification", "nameAndAddress"})
public class PartyIdentification40Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification40Choice, AnyBICIdentifier> mmAnyBIC = new MMMessageAttribute<PartyIdentification40Choice, AnyBICIdentifier>() {
		{
			businessElementTrace_lazy = () -> OrganisationIdentification.mmAnyBIC;
			componentContext_lazy = () -> com.tools20022.repository.choice.PartyIdentification40Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
		...
		@Override
		public AnyBICIdentifier getValue(PartyIdentification40Choice obj) {
			return obj.getAnyBIC();
		}

		@Override
		public void setValue(PartyIdentification40Choice obj, AnyBICIdentifier value) {
			obj.setAnyBIC(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification40Choice, GenericIdentification19> mmProprietaryIdentification = new MMMessageAssociationEnd<PartyIdentification40Choice, GenericIdentification19>() {
		{
		...
		@Override
		public GenericIdentification19 getValue(PartyIdentification40Choice obj) {
			return obj.getProprietaryIdentification();
		}

		@Override
		public void setValue(PartyIdentification40Choice obj, GenericIdentification19 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PartyIdentification40Choice, NameAndAddress5> mmNameAndAddress = new MMMessageAssociationEnd<PartyIdentification40Choice, NameAndAddress5>() {
		{
		...
		@Override
		public NameAndAddress5 getValue(PartyIdentification40Choice obj) {
			return obj.getNameAndAddress();
		}

		@Override
		public void setValue(PartyIdentification40Choice obj, NameAndAddress5 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistencePartyProprietaryIdentificationRule.forPartyIdentification40Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceNameAndAdressRule.forPartyIdentification40Choice);
	...
	public PartyIdentification40Choice setAnyBIC(AnyBICIdentifier anyBIC) {
	...
	public PartyIdentification40Choice setProprietaryIdentification(GenericIdentification19 proprietaryIdentification) {
	...
	public PartyIdentification40Choice setNameAndAddress(NameAndAddress5 nameAndAddress) {
