...
public class ProcessingStatus29Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus29Choice.mmAcknowledgedAccepted, ProcessingStatus29Choice.mmPendingProcessing, ProcessingStatus29Choice.mmRepair, ProcessingStatus29Choice.mmPendingCancellation,
						ProcessingStatus29Choice.mmProprietary, ProcessingStatus29Choice.mmCancellationRequested);
