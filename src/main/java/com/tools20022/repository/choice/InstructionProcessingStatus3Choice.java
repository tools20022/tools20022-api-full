...
public class InstructionProcessingStatus3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus3Choice.mmPendingProcessing, InstructionProcessingStatus3Choice.mmCancellationRequested, InstructionProcessingStatus3Choice.mmAcknowledgedAccepted,
						InstructionProcessingStatus3Choice.mmCancelled, InstructionProcessingStatus3Choice.mmGenerated, InstructionProcessingStatus3Choice.mmRepair, InstructionProcessingStatus3Choice.mmPendingCancellation,
						InstructionProcessingStatus3Choice.mmModificationRequested);
