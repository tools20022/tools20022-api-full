...
public class InstructionProcessingStatus3Choice {
	...
	public static final MMMessageAssociationEnd mmPendingProcessing = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> InstructionProcessingStatus3Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgPrcg";
	...
	public static final MMMessageAssociationEnd mmGenerated = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.GeneratedStatus1Choice.mmObject();
		}
	};
	...
	public void setGenerated(com.tools20022.repository.choice.GeneratedStatus1Choice generated) {
