...
public class TaxCreditRateFormat1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TaxCreditRateFormat1Choice.mmRate, TaxCreditRateFormat1Choice.mmAmount, TaxCreditRateFormat1Choice.mmRateTypeAndAmountAndRateStatus, TaxCreditRateFormat1Choice.mmNotSpecifiedRate);
