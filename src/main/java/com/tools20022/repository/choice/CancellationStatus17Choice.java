...
public class CancellationStatus17Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancellationStatus17Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationStatus17Choice.mmNoSpecifiedReason, CancellationStatus17Choice.mmReason);
	...
	public void setReason(List<CancellationReason14> reason) {
		this.reason = reason;
	}
}