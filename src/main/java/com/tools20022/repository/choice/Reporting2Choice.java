...
@XmlType(name = "Reporting2Choice", propOrder = {"code", "proprietary"})
public class Reporting2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Reporting2Choice, Reporting2Code> mmCode = new MMMessageAttribute<Reporting2Choice, Reporting2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmReportingType;
			componentContext_lazy = () -> com.tools20022.repository.choice.Reporting2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(Reporting6Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Reporting2Code getValue(Reporting2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Reporting2Choice obj, Reporting2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Reporting2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<Reporting2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmReportingType;
			componentContext_lazy = () -> com.tools20022.repository.choice.Reporting2Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(Reporting6Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(Reporting2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Reporting2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reporting2Choice.mmCode, com.tools20022.repository.choice.Reporting2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeExecution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Reporting2Choice";
				definition = "Choice of format for the reporting type.";
				nextVersions_lazy = () -> Arrays.asList(Reporting6Choice.mmObject());
			}
		});
	...
	public Reporting2Choice setCode(Reporting2Code code) {
	...
	public Reporting2Choice setProprietary(GenericIdentification20 proprietary) {
