...
import com.tools20022.repository.codeset.SignatureType2Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SignatureType1Choice#mmCode
 * SignatureType1Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SignatureType1Choice#mmProprietary
 * SignatureType1Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats for the signature type."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "SignatureType1Choice", propOrder = {"code", "proprietary"})
public class SignatureType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected SignatureType2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<SignatureType1Choice, SignatureType2Code> mmCode = new MMMessageAttribute<SignatureType1Choice, SignatureType2Code>() {
		{
			...
			name = "Code";
			definition = "Signature type expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<SignatureType1Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<SignatureType1Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Signature type expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SignatureType1Choice.mmCode, com.tools20022.repository.choice.SignatureType1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SignatureType1Choice";
				definition = "Choice of formats for the signature type.";
			}
		});
		return mmObject_lazy.get();
	}

	public SignatureType2Code getCode() {
		return code;
	}

	public SignatureType1Choice setCode(SignatureType2Code code) {
	...
	public SignatureType1Choice setProprietary(GenericIdentification47 proprietary) {
