...
public class PartyIdentification64Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification64Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification64Choice.ProprietaryIdentification);
