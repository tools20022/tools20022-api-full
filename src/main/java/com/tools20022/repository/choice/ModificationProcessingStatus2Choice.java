...
public class ModificationProcessingStatus2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ModificationProcessingStatus2Choice.mmAcknowledgedAccepted, ModificationProcessingStatus2Choice.mmPendingProcessing, ModificationProcessingStatus2Choice.mmDenied,
						ModificationProcessingStatus2Choice.mmRejected, ModificationProcessingStatus2Choice.mmRepaired, ModificationProcessingStatus2Choice.mmModified, ModificationProcessingStatus2Choice.mmProprietary);
