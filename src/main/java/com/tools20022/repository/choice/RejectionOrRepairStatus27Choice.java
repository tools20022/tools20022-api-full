...
public class RejectionOrRepairStatus27Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus27Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus27Choice.mmNoSpecifiedReason, RejectionOrRepairStatus27Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason21> reason) {
		this.reason = reason;
	}
}