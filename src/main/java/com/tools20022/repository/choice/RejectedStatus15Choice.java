...
public class RejectedStatus15Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatus15Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatus15Choice.mmNoSpecifiedReason, RejectedStatus15Choice.mmReason);
	...
	public void setReason(List<RejectedStatusReason15> reason) {
		this.reason = reason;
	}
}