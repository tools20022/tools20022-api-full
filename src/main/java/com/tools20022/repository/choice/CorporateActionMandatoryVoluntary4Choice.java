...
public class CorporateActionMandatoryVoluntary4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionMandatoryVoluntary4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionMandatoryVoluntary4Choice.mmCode, CorporateActionMandatoryVoluntary4Choice.mmProprietary);
