...
public class SecurityIdentification7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecurityIdentification7Choice.ISIN, com.tools20022.repository.choice.SecurityIdentification7Choice.OtherProprietaryIdentification);
