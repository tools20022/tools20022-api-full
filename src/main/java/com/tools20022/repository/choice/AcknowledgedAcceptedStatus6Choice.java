...
public class AcknowledgedAcceptedStatus6Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus6Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus6Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus6Choice.mmReason);
