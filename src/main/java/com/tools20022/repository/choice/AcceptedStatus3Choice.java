...
import com.tools20022.repository.msg.AcceptedStatusReason3;
...
public class AcceptedStatus3Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcceptedStatus3Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NoSpecifiedReason";
			definition = "Reason not specified.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedStatus8Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcceptedStatus1Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> NoReasonCode.mmObject();
		}
	};
	protected List<AcceptedStatusReason3> reason;
	/**
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.AcceptedStatusReason3
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedStatus8Choice.mmReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcceptedStatus1Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedStatus3Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcceptedStatus3Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.mmdataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "AcceptedStatus3Choice";
				definition = "Choice between a reason or no reason for the corporate action instruction processing accepted status.";
				nextVersions_lazy = () -> Arrays.asList(AcceptedStatus8Choice.mmObject());
				previousVersion_lazy = () -> AcceptedStatus1Choice.mmObject();
			}
		});
	...
	public List<AcceptedStatusReason3> getReason() {
		return reason;
	}

	public void setReason(List<AcceptedStatusReason3> reason) {
		this.reason = reason;
	}
}