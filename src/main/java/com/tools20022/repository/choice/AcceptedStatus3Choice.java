...
@XmlType(name = "AcceptedStatus3Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcceptedStatus3Choice {
	...
	public static final MMMessageAttribute<AcceptedStatus3Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<AcceptedStatus3Choice, NoReasonCode>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatus8Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> AcceptedStatus1Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<AcceptedStatus3Choice, List<AcceptedStatusReason3>> mmReason = new MMMessageAssociationEnd<AcceptedStatus3Choice, List<AcceptedStatusReason3>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatus8Choice.mmReason);
			previousVersion_lazy = () -> AcceptedStatus1Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	public AcceptedStatus3Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public AcceptedStatus3Choice setReason(List<AcceptedStatusReason3> reason) {
