...
@XmlType(name = "TaxCapacityParty1Choice", propOrder = {"code", "proprietary"})
public class TaxCapacityParty1Choice {
	...
	public static final MMMessageAttribute<TaxCapacityParty1Choice, TaxLiability1Code> mmCode = new MMMessageAttribute<TaxCapacityParty1Choice, TaxLiability1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TaxCapacityParty4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<TaxCapacityParty1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<TaxCapacityParty1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TaxCapacityParty4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TaxCapacityParty1Choice.mmCode, com.tools20022.repository.choice.TaxCapacityParty1Choice.mmProprietary);
	...
	public TaxCapacityParty1Choice setCode(TaxLiability1Code code) {
	...
	public TaxCapacityParty1Choice setProprietary(GenericIdentification20 proprietary) {
