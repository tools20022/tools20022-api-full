 ...
 * <li>{@linkplain com.tools20022.repository.choice.RateType3Choice#Proprietary
...
public class RateType3Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateType3Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType3Choice.Code, com.tools20022.repository.choice.RateType3Choice.Proprietary);
