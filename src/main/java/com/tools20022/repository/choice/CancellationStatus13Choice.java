...
public class CancellationStatus13Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationStatus13Choice.NoSpecifiedReason, com.tools20022.repository.choice.CancellationStatus13Choice.Reason);
