...
import com.tools20022.repository.codeset.RepurchaseType8Code;
...
@XmlType(name = "RepurchaseType21Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType21Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RepurchaseType8Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RepurchaseType21Choice
	 * RepurchaseType21Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType21Choice, RepurchaseType8Code> mmCode = new MMMessageAttribute<RepurchaseType21Choice, RepurchaseType8Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType21Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> RepurchaseType15Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> RepurchaseType8Code.mmObject();
		}

		@Override
		public RepurchaseType8Code getValue(RepurchaseType21Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType21Choice obj, RepurchaseType8Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RepurchaseType21Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<RepurchaseType21Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType21Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> RepurchaseType15Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(RepurchaseType21Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType21Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType21Choice.mmCode, com.tools20022.repository.choice.RepurchaseType21Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType21Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				previousVersion_lazy = () -> RepurchaseType15Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public RepurchaseType8Code getCode() {
		return code;
	}

	public RepurchaseType21Choice setCode(RepurchaseType8Code code) {
	...
	public RepurchaseType21Choice setProprietary(GenericIdentification30 proprietary) {
