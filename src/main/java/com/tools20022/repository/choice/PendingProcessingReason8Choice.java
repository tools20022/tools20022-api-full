...
import com.tools20022.repository.codeset.ExternalPendingProcessingReason1Code;
 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PendingProcessingReason8Choice#mmProprietary
 * PendingProcessingReason8Choice.mmProprietary}</li>
 * </ul>
 * </li>
...
@XmlType(name = "PendingProcessingReason8Choice", propOrder = {"code", "proprietary"})
public class PendingProcessingReason8Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExternalPendingProcessingReason1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<PendingProcessingReason8Choice, ExternalPendingProcessingReason1Code> mmCode = new MMMessageAttribute<PendingProcessingReason8Choice, ExternalPendingProcessingReason1Code>() {
		{
			...
			name = "Code";
			definition = "Reason for the pending status expressed as an ISO 20022 code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<PendingProcessingReason8Choice, GenericIdentification36> mmProprietary = new MMMessageAssociationEnd<PendingProcessingReason8Choice, GenericIdentification36>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Reason for the pending status expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingReason8Choice.mmCode, com.tools20022.repository.choice.PendingProcessingReason8Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingReason8Choice";
	...
	public ExternalPendingProcessingReason1Code getCode() {
		return code;
	}

	public PendingProcessingReason8Choice setCode(ExternalPendingProcessingReason1Code code) {
	...
	public PendingProcessingReason8Choice setProprietary(GenericIdentification36 proprietary) {
