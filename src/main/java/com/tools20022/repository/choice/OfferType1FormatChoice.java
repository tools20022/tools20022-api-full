...
@XmlType(name = "OfferType1FormatChoice", propOrder = {"code", "proprietary"})
public class OfferType1FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferType1FormatChoice.mmCode, com.tools20022.repository.choice.OfferType1FormatChoice.mmProprietary);
	...
	public OfferType1FormatChoice setCode(OfferType1Code code) {
	...
	public OfferType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
