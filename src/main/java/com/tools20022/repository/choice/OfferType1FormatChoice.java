 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OfferType1FormatChoice#Code
...
public class OfferType1FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferType1FormatChoice.Code, com.tools20022.repository.choice.OfferType1FormatChoice.Proprietary);
