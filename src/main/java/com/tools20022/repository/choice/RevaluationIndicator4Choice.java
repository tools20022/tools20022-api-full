...
@XmlType(name = "RevaluationIndicator4Choice", propOrder = {"indicator", "proprietary"})
public class RevaluationIndicator4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RevaluationIndicator4Choice.mmIndicator, com.tools20022.repository.choice.RevaluationIndicator4Choice.mmProprietary);
	...
	public RevaluationIndicator4Choice setIndicator(YesNoIndicator indicator) {
	...
	public RevaluationIndicator4Choice setProprietary(GenericIdentification47 proprietary) {
