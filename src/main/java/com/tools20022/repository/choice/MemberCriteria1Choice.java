...
public class MemberCriteria1Choice {
	...
	public static final MMMessageAttribute mmQueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> MemberCriteria1Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MemberCriteria1Choice.mmQueryName, MemberCriteria1Choice.mmNewCriteria);
	...
	public void setNewCriteria(MemberCriteria2 newCriteria) {
