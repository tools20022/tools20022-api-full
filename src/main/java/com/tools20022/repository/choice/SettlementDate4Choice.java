 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettlementDate4Choice#Date
 * SettlementDate4Choice.Date}</li>
 * <li>
...
public class SettlementDate4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate4Choice.Date, com.tools20022.repository.choice.SettlementDate4Choice.DateCode);
