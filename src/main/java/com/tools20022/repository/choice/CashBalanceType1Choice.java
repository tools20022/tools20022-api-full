...
@XmlType(name = "CashBalanceType1Choice", propOrder = {"code", "proprietary"})
public class CashBalanceType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CashBalanceType1Choice.mmCode, com.tools20022.repository.choice.CashBalanceType1Choice.mmProprietary);
	...
	public CashBalanceType1Choice setCode(BalanceType12Code code) {
	...
	public CashBalanceType1Choice setProprietary(GenericIdentification20 proprietary) {
