 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OfferTypeFormat4Choice#Code
...
public class OfferTypeFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferTypeFormat4Choice.Code, com.tools20022.repository.choice.OfferTypeFormat4Choice.Proprietary);
