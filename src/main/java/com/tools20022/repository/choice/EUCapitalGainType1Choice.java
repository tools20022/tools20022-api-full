...
public class EUCapitalGainType1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EUCapitalGainType1Choice, EUCapitalGain2Code> mmEUCapitalGain = new MMMessageAttribute<EUCapitalGainType1Choice, EUCapitalGain2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTax.mmEUCapitalGain;
			componentContext_lazy = () -> com.tools20022.repository.choice.EUCapitalGainType1Choice.mmObject();
			isDerived = false;
			xmlTag = "EUCptlGn";
		...
		@Override
		public EUCapitalGain2Code getValue(EUCapitalGainType1Choice obj) {
			return obj.getEUCapitalGain();
		}

		@Override
		public void setValue(EUCapitalGainType1Choice obj, EUCapitalGain2Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<EUCapitalGainType1Choice, GenericIdentification13> mmProprietary = new MMMessageAttribute<EUCapitalGainType1Choice, GenericIdentification13>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTax.mmEUCapitalGain;
			componentContext_lazy = () -> com.tools20022.repository.choice.EUCapitalGainType1Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification13 getValue(EUCapitalGainType1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(EUCapitalGainType1Choice obj, GenericIdentification13 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.EUCapitalGainType1Choice.mmEUCapitalGain, com.tools20022.repository.choice.EUCapitalGainType1Choice.mmProprietary);
	...
	public EUCapitalGainType1Choice setEUCapitalGain(EUCapitalGain2Code eUCapitalGain) {
	...
	public EUCapitalGainType1Choice setProprietary(GenericIdentification13 proprietary) {
