...
public class EUCapitalGainType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.EUCapitalGainType1Choice.EUCapitalGain, com.tools20022.repository.choice.EUCapitalGainType1Choice.Proprietary);
