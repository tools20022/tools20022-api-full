...
public class BlockTrade5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BlockTrade5Choice.Code, com.tools20022.repository.choice.BlockTrade5Choice.Proprietary);
