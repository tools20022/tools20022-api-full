 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.BlockTrade5Choice#mmCode
...
@XmlType(name = "BlockTrade5Choice", propOrder = {"code", "proprietary"})
public class BlockTrade5Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.BlockTrade5Choice
	 * BlockTrade5Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BlockTrade5Choice, BlockTrade1Code> mmCode = new MMMessageAttribute<BlockTrade5Choice, BlockTrade1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmBlockTrade;
			componentContext_lazy = () -> com.tools20022.repository.choice.BlockTrade5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public BlockTrade1Code getValue(BlockTrade5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BlockTrade5Choice obj, BlockTrade1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BlockTrade5Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<BlockTrade5Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmBlockTrade;
			componentContext_lazy = () -> com.tools20022.repository.choice.BlockTrade5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(BlockTrade5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BlockTrade5Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BlockTrade5Choice.mmCode, com.tools20022.repository.choice.BlockTrade5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BlockTrade5Choice";
	...
	public BlockTrade5Choice setCode(BlockTrade1Code code) {
	...
	public BlockTrade5Choice setProprietary(GenericIdentification47 proprietary) {
