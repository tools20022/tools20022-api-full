...
import com.tools20022.repository.codeset.CorporateActionOption7Code;
...
@XmlType(name = "CorporateActionOption10Choice", propOrder = {"code", "proprietary"})
public class CorporateActionOption10Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CorporateActionOption7Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * definition} =
	 * "Standard code to specify the type of corporate action options."</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMModelEntity#getNextVersions
	 * nextVersions} =
	 * <ul>
	 * <li>
	...
	public static final MMMessageAttribute<CorporateActionOption10Choice, CorporateActionOption7Code> mmCode = new MMMessageAttribute<CorporateActionOption10Choice, CorporateActionOption7Code>() {
		{
			...
			name = "Code";
			definition = "Standard code to specify the type of corporate action options.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption18Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "Proprietary identification of the type of corporate action options."</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMModelEntity#getNextVersions
	 * nextVersions} =
	 * <ul>
	 * <li>
	...
	public static final MMMessageAssociationEnd<CorporateActionOption10Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CorporateActionOption10Choice, GenericIdentification20>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Proprietary identification of the type of corporate action options.";
			nextVersions_lazy = () -> Arrays.asList(CorporateActionOption18Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption10Choice.mmCode, com.tools20022.repository.choice.CorporateActionOption10Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption10Choice";
				definition = "Choice between a standard code or a proprietary code to specify the type of corporate action options.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionOption18Choice.mmObject());
				previousVersion_lazy = () -> CorporateActionOption2Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public CorporateActionOption7Code getCode() {
		return code;
	}

	public CorporateActionOption10Choice setCode(CorporateActionOption7Code code) {
	...
	public CorporateActionOption10Choice setProprietary(GenericIdentification20 proprietary) {
