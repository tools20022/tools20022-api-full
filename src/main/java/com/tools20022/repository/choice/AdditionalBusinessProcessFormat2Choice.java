...
import com.tools20022.repository.codeset.AdditionalBusinessProcess2Code;
...
@XmlType(name = "AdditionalBusinessProcessFormat2Choice", propOrder = {"code", "proprietary"})
public class AdditionalBusinessProcessFormat2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AdditionalBusinessProcess2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalBusinessProcessFormat2Choice, AdditionalBusinessProcess2Code> mmCode = new MMMessageAttribute<AdditionalBusinessProcessFormat2Choice, AdditionalBusinessProcess2Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmAdditionalBusinessProcess;
			componentContext_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat10Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> AdditionalBusinessProcess2Code.mmObject();
		}

		@Override
		public AdditionalBusinessProcess2Code getValue(AdditionalBusinessProcessFormat2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AdditionalBusinessProcessFormat2Choice obj, AdditionalBusinessProcess2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AdditionalBusinessProcessFormat2Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<AdditionalBusinessProcessFormat2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmAdditionalBusinessProcess;
			componentContext_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat2Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat10Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(AdditionalBusinessProcessFormat2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AdditionalBusinessProcessFormat2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AdditionalBusinessProcessFormat2Choice.mmCode, com.tools20022.repository.choice.AdditionalBusinessProcessFormat2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AdditionalBusinessProcessFormat2Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat10Choice.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public AdditionalBusinessProcess2Code getCode() {
		return code;
	}

	public AdditionalBusinessProcessFormat2Choice setCode(AdditionalBusinessProcess2Code code) {
	...
	public AdditionalBusinessProcessFormat2Choice setProprietary(GenericIdentification20 proprietary) {
