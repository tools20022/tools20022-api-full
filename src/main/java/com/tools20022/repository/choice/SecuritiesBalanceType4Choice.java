...
@XmlType(name = "SecuritiesBalanceType4Choice", propOrder = {"code", "proprietary"})
public class SecuritiesBalanceType4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesBalanceType4Choice.mmCode, com.tools20022.repository.choice.SecuritiesBalanceType4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesBalance.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesBalanceType4Choice";
	...
	public SecuritiesBalanceType4Choice setCode(SecuritiesBalanceType13Code code) {
	...
	public SecuritiesBalanceType4Choice setProprietary(GenericIdentification25 proprietary) {
