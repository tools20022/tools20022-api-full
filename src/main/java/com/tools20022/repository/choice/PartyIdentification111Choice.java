...
public class PartyIdentification111Choice {
	...
	public static final MMMessageAttribute AnyBIC = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification111Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification111Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification111Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification111Choice.Country);
