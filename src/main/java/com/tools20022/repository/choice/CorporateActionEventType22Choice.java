...
public class CorporateActionEventType22Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType22Choice.mmCode, CorporateActionEventType22Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType10Code code) {
		this.code = code;
	}
