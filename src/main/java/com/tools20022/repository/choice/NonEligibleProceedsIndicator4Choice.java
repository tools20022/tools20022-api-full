...
@XmlType(name = "NonEligibleProceedsIndicator4Choice", propOrder = {"code", "proprietary"})
public class NonEligibleProceedsIndicator4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NonEligibleProceedsIndicator4Choice.mmCode, com.tools20022.repository.choice.NonEligibleProceedsIndicator4Choice.mmProprietary);
	...
	public NonEligibleProceedsIndicator4Choice setCode(NonEligibleProceedsIndicator1Code code) {
	...
	public NonEligibleProceedsIndicator4Choice setProprietary(GenericIdentification47 proprietary) {
