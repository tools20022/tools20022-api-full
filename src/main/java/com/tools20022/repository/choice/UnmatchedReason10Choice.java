 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UnmatchedReason15Choice
...
@XmlType(name = "UnmatchedReason10Choice", propOrder = {"code", "proprietary"})
public class UnmatchedReason10Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason10Choice.mmCode, com.tools20022.repository.choice.UnmatchedReason10Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnmatchedReason10Choice";
				definition = "Choice of format for the securities financing unmatched reason.";
				nextVersions_lazy = () -> Arrays.asList(UnmatchedReason15Choice.mmObject());
				previousVersion_lazy = () -> UnmatchedReason3Choice.mmObject();
			}
		});
	...
	public UnmatchedReason10Choice setCode(UnmatchedReason7Code code) {
	...
	public UnmatchedReason10Choice setProprietary(GenericIdentification20 proprietary) {
