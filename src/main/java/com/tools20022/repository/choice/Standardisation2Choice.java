...
@XmlType(name = "Standardisation2Choice", propOrder = {"code", "proprietary"})
public class Standardisation2Choice {
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> Standardisation1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Standardisation2Choice.mmCode, com.tools20022.repository.choice.Standardisation2Choice.mmProprietary);
				...
				name = "Standardisation2Choice";
				definition = "Choice of format for standardisation.";
				previousVersion_lazy = () -> Standardisation1Choice.mmObject();
			}
		});
	...
	public Standardisation2Choice setCode(List<StandardisationCode> code) {
	...
	public Standardisation2Choice setProprietary(GenericIdentification30 proprietary) {
