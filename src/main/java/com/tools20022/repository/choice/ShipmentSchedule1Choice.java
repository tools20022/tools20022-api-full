...
public class ShipmentSchedule1Choice {
	...
	public static final MMMessageAssociationEnd<ShipmentSchedule1Choice, ShipmentDateRange1> mmShipmentDateRange = new MMMessageAssociationEnd<ShipmentSchedule1Choice, ShipmentDateRange1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ShipmentSchedule2Choice.mmShipmentDateRange);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<ShipmentSchedule1Choice, List<ShipmentDateRange2>> mmShipmentSubSchedule = new MMMessageAssociationEnd<ShipmentSchedule1Choice, List<ShipmentDateRange2>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ShipmentSchedule2Choice.mmShipmentSubSchedule);
			minOccurs = 1;
			isComposite = true;
	...
	public ShipmentSchedule1Choice setShipmentDateRange(ShipmentDateRange1 shipmentDateRange) {
	...
	public ShipmentSchedule1Choice setShipmentSubSchedule(List<ShipmentDateRange2> shipmentSubSchedule) {
