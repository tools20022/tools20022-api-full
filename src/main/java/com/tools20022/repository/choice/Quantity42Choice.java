	...
	public static final MMMessageAttribute mmTotalUnitsNumber = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Quantity13Choice.mmTotalUnitsNumber;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmTransferRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> Quantity13Choice.mmPortfolioTransferOutRate;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				previousVersion_lazy = () -> Quantity13Choice.mmObject();
			}
		});
