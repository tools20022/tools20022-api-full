...
import com.tools20022.repository.codeset.ExternalDocumentFormat1Code;
...
@XmlType(name = "DocumentFormat1Choice", propOrder = {"code", "proprietary"})
public class DocumentFormat1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExternalDocumentFormat1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentFormat1Choice.mmCode, com.tools20022.repository.choice.DocumentFormat1Choice.mmProprietary);
	...
	public ExternalDocumentFormat1Code getCode() {
		return code;
	}

	public DocumentFormat1Choice setCode(ExternalDocumentFormat1Code code) {
	...
	public DocumentFormat1Choice setProprietary(GenericIdentification1 proprietary) {
