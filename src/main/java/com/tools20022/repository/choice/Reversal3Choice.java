 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Reversal3Choice#References
...
public class Reversal3Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Reversal1Choice#Reference
	...
	public static final MMMessageAttribute References = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Reversal1Choice.Reference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reversal5Choice.References);
			minOccurs = 1;
	...
	public static final MMMessageAttribute TransferOutConfirmationDetails = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Reversal1Choice.TransferOutConfirmationDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reversal5Choice.TransferOutConfirmationDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reversal3Choice.References, com.tools20022.repository.choice.Reversal3Choice.TransferOutConfirmationDetails);
				trace_lazy = () -> SecuritiesTransfer.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.ReversalOfTransferOutConfirmationV05.Reversal);
