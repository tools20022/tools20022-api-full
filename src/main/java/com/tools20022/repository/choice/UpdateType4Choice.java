...
@XmlType(name = "UpdateType4Choice", propOrder = {"code", "proprietary"})
public class UpdateType4Choice {
	...
	public UpdateType4Choice setCode(StatementUpdateType1Code code) {
	...
	public UpdateType4Choice setProprietary(GenericIdentification30 proprietary) {
