...
public class RateType38Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.RateType20Choice#Code
	 * RateType20Choice.Code}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateType38Choice.mmObject();
			...
			name = "Code";
			definition = "Standard code to specify the type of gross dividend rate.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateType20Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateType20Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType38Choice.Code, com.tools20022.repository.choice.RateType38Choice.Proprietary);
