 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CommunicationMethod3Choice#mmCode
 * CommunicationMethod3Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CommunicationMethod3Choice#mmProprietary
 * CommunicationMethod3Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats for the method of transmission."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CommunicationMethod3Choice", propOrder = {"code", "proprietary"})
public class CommunicationMethod3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CommunicationMethod1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<CommunicationMethod3Choice, CommunicationMethod1Code> mmCode = new MMMessageAttribute<CommunicationMethod3Choice, CommunicationMethod1Code>() {
		{
			...
			name = "Code";
			definition = "Method of transmission expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<CommunicationMethod3Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<CommunicationMethod3Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Method of transmission expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CommunicationMethod3Choice.mmCode, com.tools20022.repository.choice.CommunicationMethod3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CommunicationMethod3Choice";
				definition = "Choice of formats for the method of transmission.";
			}
		});
		return mmObject_lazy.get();
	}

	public CommunicationMethod1Code getCode() {
		return code;
	}

	public CommunicationMethod3Choice setCode(CommunicationMethod1Code code) {
	...
	public CommunicationMethod3Choice setProprietary(GenericIdentification47 proprietary) {
