...
import com.tools20022.repository.codeset.AdditionalBusinessProcess4Code;
...
@XmlType(name = "AdditionalBusinessProcessFormat7Choice", propOrder = {"code", "proprietary"})
public class AdditionalBusinessProcessFormat7Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AdditionalBusinessProcess4Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AdditionalBusinessProcessFormat7Choice, AdditionalBusinessProcess4Code> mmCode = new MMMessageAttribute<AdditionalBusinessProcessFormat7Choice, AdditionalBusinessProcess4Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmAdditionalBusinessProcess;
			componentContext_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat11Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> AdditionalBusinessProcess4Code.mmObject();
		}

		@Override
		public AdditionalBusinessProcess4Code getValue(AdditionalBusinessProcessFormat7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AdditionalBusinessProcessFormat7Choice obj, AdditionalBusinessProcess4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AdditionalBusinessProcessFormat7Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<AdditionalBusinessProcessFormat7Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmAdditionalBusinessProcess;
			componentContext_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat7Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat11Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(AdditionalBusinessProcessFormat7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AdditionalBusinessProcessFormat7Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AdditionalBusinessProcessFormat7Choice.mmCode, com.tools20022.repository.choice.AdditionalBusinessProcessFormat7Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AdditionalBusinessProcessFormat7Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat11Choice.mmObject());
				previousVersion_lazy = () -> AdditionalBusinessProcessFormat3Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public AdditionalBusinessProcess4Code getCode() {
		return code;
	}

	public AdditionalBusinessProcessFormat7Choice setCode(AdditionalBusinessProcess4Code code) {
	...
	public AdditionalBusinessProcessFormat7Choice setProprietary(GenericIdentification20 proprietary) {
