...
import com.tools20022.repository.msg.AcceptedStatusReason1;
...
@XmlType(name = "AcceptedStatus1Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcceptedStatus1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedStatus1Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<AcceptedStatus1Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcceptedStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatus3Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NoReasonCode getValue(AcceptedStatus1Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(AcceptedStatus1Choice obj, NoReasonCode value) {
			obj.setNoSpecifiedReason(value);
		}
	};
	@XmlElement(name = "Rsn", required = true)
	protected List<AcceptedStatusReason1> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.AcceptedStatusReason1
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedStatus1Choice, List<AcceptedStatusReason1>> mmReason = new MMMessageAssociationEnd<AcceptedStatus1Choice, List<AcceptedStatusReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedStatus3Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> AcceptedStatusReason1.mmObject();
		}

		@Override
		public List<AcceptedStatusReason1> getValue(AcceptedStatus1Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(AcceptedStatus1Choice obj, List<AcceptedStatusReason1> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedStatus1Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcceptedStatus1Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptedStatus1Choice";
				definition = "Choice between a reason or no reason for the corporate action instruction processing accepted status.";
				nextVersions_lazy = () -> Arrays.asList(AcceptedStatus3Choice.mmObject());
			}
		});
	...
	public AcceptedStatus1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<AcceptedStatusReason1> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public AcceptedStatus1Choice setReason(List<AcceptedStatusReason1> reason) {
