...
public class NetDividendRateFormat15Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NetDividendRateFormat15Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat15Choice.mmAmount, NetDividendRateFormat15Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat15Choice.mmNotSpecifiedRate);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus18 rateTypeAndAmountAndRateStatus) {
