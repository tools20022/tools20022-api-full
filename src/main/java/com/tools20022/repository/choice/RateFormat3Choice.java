 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateFormat3Choice#mmRate
...
@XmlType(name = "RateFormat3Choice", propOrder = {"rate", "notSpecifiedRate"})
public class RateFormat3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat3Choice, PercentageRate> mmRate = new MMMessageAttribute<RateFormat3Choice, PercentageRate>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat3Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
			...
			nextVersions_lazy = () -> Arrays.asList(RateFormat12Choice.mmRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PercentageRate getValue(RateFormat3Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(RateFormat3Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat3Choice, RateType5Code> mmNotSpecifiedRate = new MMMessageAttribute<RateFormat3Choice, RateType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat3Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
			...
			nextVersions_lazy = () -> Arrays.asList(RateFormat12Choice.mmNotSpecifiedRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RateType5Code getValue(RateFormat3Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RateFormat3Choice obj, RateType5Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateFormat3Choice.mmRate, com.tools20022.repository.choice.RateFormat3Choice.mmNotSpecifiedRate);
				trace_lazy = () -> RateAndAmount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateFormat3Choice";
				definition = "Choice between a rate or an unspecified rate.";
				nextVersions_lazy = () -> Arrays.asList(RateFormat12Choice.mmObject());
			}
		});
	...
	public RateFormat3Choice setRate(PercentageRate rate) {
	...
	public RateFormat3Choice setNotSpecifiedRate(RateType5Code notSpecifiedRate) {
