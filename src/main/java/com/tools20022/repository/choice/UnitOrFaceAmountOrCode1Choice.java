...
public class UnitOrFaceAmountOrCode1Choice {
	...
	public static final MMMessageAttribute Unit = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> UnitOrFaceAmountOrCode1Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnitOrFaceAmountOrCode1Choice.Unit, com.tools20022.repository.choice.UnitOrFaceAmountOrCode1Choice.FaceAmount,
						com.tools20022.repository.choice.UnitOrFaceAmountOrCode1Choice.Code);
