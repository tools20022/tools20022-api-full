...
public class ProcessingStatus30Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus30Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	/**
	 * Specifies the processing status of the instruction in a proprietary
	 * format.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public void setCode(TransactionProcessingStatus4Code code) {
		this.code = code;
	}
