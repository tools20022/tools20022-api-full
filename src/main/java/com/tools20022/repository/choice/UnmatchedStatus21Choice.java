...
public class UnmatchedStatus21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus21Choice.mmNoSpecifiedReason, UnmatchedStatus21Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason20> reason) {
		this.reason = reason;
	}
}