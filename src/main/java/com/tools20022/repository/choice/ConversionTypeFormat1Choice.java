...
@XmlType(name = "ConversionTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class ConversionTypeFormat1Choice {
	...
	public static final MMMessageAttribute<ConversionTypeFormat1Choice, ConversionType1Code> mmCode = new MMMessageAttribute<ConversionTypeFormat1Choice, ConversionType1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ConversionTypeFormat3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<ConversionTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<ConversionTypeFormat1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(ConversionTypeFormat3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConversionTypeFormat1Choice.mmCode, com.tools20022.repository.choice.ConversionTypeFormat1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesConversion.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ConversionTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of conversion.";
				nextVersions_lazy = () -> Arrays.asList(ConversionTypeFormat3Choice.mmObject());
			}
		});
	...
	public ConversionTypeFormat1Choice setCode(ConversionType1Code code) {
	...
	public ConversionTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
