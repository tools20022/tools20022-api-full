...
@XmlType(name = "CorporateActionEventStageFormat6Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventStageFormat6Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventStageFormat6Choice, CorporateActionEventStage4Code> mmCode = new MMMessageAttribute<CorporateActionEventStageFormat6Choice, CorporateActionEventStage4Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmEventStage;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventStageFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat14Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventStage4Code getValue(CorporateActionEventStageFormat6Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventStageFormat6Choice obj, CorporateActionEventStage4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionEventStageFormat6Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CorporateActionEventStageFormat6Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmEventStage;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventStageFormat6Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat14Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(CorporateActionEventStageFormat6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventStageFormat6Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventStageFormat6Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventStageFormat6Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionEventStageFormat6Choice";
				definition = "Choice between a standard code or proprietary code to specify the event stage type.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat14Choice.mmObject());
			}
		});
	...
	public CorporateActionEventStageFormat6Choice setCode(CorporateActionEventStage4Code code) {
	...
	public CorporateActionEventStageFormat6Choice setProprietary(GenericIdentification20 proprietary) {
