...
import com.tools20022.repository.msg.LimitCriteria5;
...
@XmlType(name = "LimitCriteria5Choice", propOrder = {"queryName", "newCriteria"})
public class LimitCriteria5Choice {
	...
	public static final MMMessageAttribute<LimitCriteria5Choice, Max35Text> mmQueryName = new MMMessageAttribute<LimitCriteria5Choice, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> LimitCriteria4Choice.mmQueryName;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected LimitCriteria5 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.LimitCriteria5
	 * LimitCriteria5}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	...
	public static final MMMessageAssociationEnd<LimitCriteria5Choice, LimitCriteria5> mmNewCriteria = new MMMessageAssociationEnd<LimitCriteria5Choice, LimitCriteria5>() {
		{
			...
			previousVersion_lazy = () -> LimitCriteria4Choice.mmNewCriteria;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LimitCriteria5Choice.mmQueryName, com.tools20022.repository.choice.LimitCriteria5Choice.mmNewCriteria);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "LimitCriteria5Choice";
				...
				previousVersion_lazy = () -> LimitCriteria4Choice.mmObject();
			}
		});
	...
	public LimitCriteria5Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public LimitCriteria5 getNewCriteria() {
		return newCriteria;
	}

	public LimitCriteria5Choice setNewCriteria(LimitCriteria5 newCriteria) {
