 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceRateOrAmountOrUnknown1Choice#mmUnknownIndicator
 * PriceRateOrAmountOrUnknown1Choice.mmUnknownIndicator}</li>
 * </ul>
 * </li>
...
public class PriceRateOrAmountOrUnknown1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, PercentageRate> mmRate = new MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, PercentageRate>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceRateOrAmountOrUnknown1Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
		...
		@Override
		public PercentageRate getValue(PriceRateOrAmountOrUnknown1Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(PriceRateOrAmountOrUnknown1Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, RestrictedFINActiveOrHistoricCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, RestrictedFINActiveOrHistoricCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public RestrictedFINActiveOrHistoricCurrencyAnd13DecimalAmount getValue(PriceRateOrAmountOrUnknown1Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(PriceRateOrAmountOrUnknown1Choice obj, RestrictedFINActiveOrHistoricCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, YesNoIndicator> mmUnknownIndicator = new MMMessageAttribute<PriceRateOrAmountOrUnknown1Choice, YesNoIndicator>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceRateOrAmountOrUnknown1Choice.mmObject();
			isDerived = false;
			xmlTag = "UknwnInd";
		...
		@Override
		public YesNoIndicator getValue(PriceRateOrAmountOrUnknown1Choice obj) {
			return obj.getUnknownIndicator();
		}

		@Override
		public void setValue(PriceRateOrAmountOrUnknown1Choice obj, YesNoIndicator value) {
	...
	public PriceRateOrAmountOrUnknown1Choice setRate(PercentageRate rate) {
	...
	public PriceRateOrAmountOrUnknown1Choice setAmount(RestrictedFINActiveOrHistoricCurrencyAnd13DecimalAmount amount) {
	...
	public PriceRateOrAmountOrUnknown1Choice setUnknownIndicator(YesNoIndicator unknownIndicator) {
