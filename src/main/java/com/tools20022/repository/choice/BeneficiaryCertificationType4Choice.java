...
public class BeneficiaryCertificationType4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> BeneficiaryCertificationType4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BeneficiaryCertificationType4Choice.mmCode, BeneficiaryCertificationType4Choice.mmProprietary);
	...
	public void setCode(BeneficiaryCertificationType3Code code) {
		this.code = code;
	}
