...
public class Party8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party8Choice.OrganisationIdentification, com.tools20022.repository.choice.Party8Choice.PrivateIdentification);
