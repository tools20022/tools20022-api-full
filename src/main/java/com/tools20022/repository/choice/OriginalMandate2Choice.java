 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.OriginalMandate2Choice#OriginalMandateIdentification
 * OriginalMandate2Choice.OriginalMandateIdentification}</li>
 * <li>
...
public class OriginalMandate2Choice {
	...
	public static final MMMessageAttribute OriginalMandateIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OriginalMandate3Choice.OriginalMandateIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.Mandate1 Mandate1}</li>
	 * <li>
	...
	public static final MMMessageAssociationEnd OriginalMandate = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OriginalMandate3Choice.OriginalMandate);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OriginalMandate2Choice.OriginalMandateIdentification, com.tools20022.repository.choice.OriginalMandate2Choice.OriginalMandate);
