...
@XmlType(name = "OriginalMandate2Choice", propOrder = {"originalMandateIdentification", "originalMandate"})
public class OriginalMandate2Choice {
	...
	protected Mandate1 originalMandate;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public OriginalMandate2Choice setOriginalMandateIdentification(Max35Text originalMandateIdentification) {
		this.originalMandateIdentification = Objects.requireNonNull(originalMandateIdentification);
		return this;
	}

	public Mandate1 getOriginalMandate() {
		return originalMandate;
	}

	public OriginalMandate2Choice setOriginalMandate(Mandate1 originalMandate) {
