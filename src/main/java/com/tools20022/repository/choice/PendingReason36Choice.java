...
@XmlType(name = "PendingReason36Choice", propOrder = {"code", "proprietary"})
public class PendingReason36Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason36Choice.mmCode, com.tools20022.repository.choice.PendingReason36Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason36Choice";
	...
	public PendingReason36Choice setCode(PendingReason10Code code) {
	...
	public PendingReason36Choice setProprietary(GenericIdentification47 proprietary) {
