...
import com.tools20022.repository.msg.GenericIdentification79;
...
@XmlType(name = "PartyIdentification95Choice", propOrder = {"anyBIC", "proprietaryIdentification"})
public class PartyIdentification95Choice {
	...
	protected GenericIdentification79 proprietaryIdentification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.msg.GenericIdentification79
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification95Choice.mmAnyBIC, com.tools20022.repository.choice.PartyIdentification95Choice.mmProprietaryIdentification);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PartyIdentification95Choice";
	...
	public PartyIdentification95Choice setAnyBIC(AnyBICIdentifier anyBIC) {
		this.anyBIC = Objects.requireNonNull(anyBIC);
		return this;
	}

	public GenericIdentification79 getProprietaryIdentification() {
		return proprietaryIdentification;
	}

	public PartyIdentification95Choice setProprietaryIdentification(GenericIdentification79 proprietaryIdentification) {
