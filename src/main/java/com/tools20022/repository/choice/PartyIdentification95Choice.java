...
public class PartyIdentification95Choice {
	...
	public static final MMMessageAttribute mmAnyBIC = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification95Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification95Choice.mmAnyBIC, PartyIdentification95Choice.mmProprietaryIdentification);
	...
	public void setProprietaryIdentification(GenericIdentification79 proprietaryIdentification) {
