...
public class ModificationProcessingStatus1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ModificationProcessingStatus1Choice.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Status.ModificationProcessingStatus;
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ModificationProcessingStatus1Choice.Code, com.tools20022.repository.choice.ModificationProcessingStatus1Choice.Proprietary);
