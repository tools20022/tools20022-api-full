...
@XmlType(name = "UnilateralSplit2Choice", propOrder = {"code", "proprietary"})
public class UnilateralSplit2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnilateralSplit2Choice.mmCode, com.tools20022.repository.choice.UnilateralSplit2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnilateralSplit2Choice";
	...
	public UnilateralSplit2Choice setCode(SecuritiesTransactionType5Code code) {
	...
	public UnilateralSplit2Choice setProprietary(GenericIdentification25 proprietary) {
