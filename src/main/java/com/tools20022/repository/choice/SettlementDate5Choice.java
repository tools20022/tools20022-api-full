 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettlementDate5Choice#Date
 * SettlementDate5Choice.Date}</li>
 * <li>
...
public class SettlementDate5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate5Choice.Date, com.tools20022.repository.choice.SettlementDate5Choice.DateCode);
