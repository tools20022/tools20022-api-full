...
public class RatioFormat22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat22Choice.QuantityToQuantity, com.tools20022.repository.choice.RatioFormat22Choice.AmountToAmount,
						com.tools20022.repository.choice.RatioFormat22Choice.AmountToQuantity, com.tools20022.repository.choice.RatioFormat22Choice.QuantityToAmount);
