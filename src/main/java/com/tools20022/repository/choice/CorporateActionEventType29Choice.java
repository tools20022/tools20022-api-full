...
@XmlType(name = "CorporateActionEventType29Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventType29Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType29Choice, CorporateActionEventType19Code> mmCode = new MMMessageAttribute<CorporateActionEventType29Choice, CorporateActionEventType19Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType29Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> CorporateActionEventType16Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventType19Code getValue(CorporateActionEventType29Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventType29Choice obj, CorporateActionEventType19Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType29Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CorporateActionEventType29Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType29Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> CorporateActionEventType16Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CorporateActionEventType29Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventType29Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventType29Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventType29Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionEventType29Choice);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionEventType29Choice";
				definition = "Choice between formats to express the corporate event type.";
				previousVersion_lazy = () -> CorporateActionEventType16Choice.mmObject();
			}
		});
	...
	public CorporateActionEventType29Choice setCode(CorporateActionEventType19Code code) {
	...
	public CorporateActionEventType29Choice setProprietary(GenericIdentification30 proprietary) {
