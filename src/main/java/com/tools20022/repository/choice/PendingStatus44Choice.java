...
public class PendingStatus44Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus44Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus44Choice.mmNoSpecifiedReason, PendingStatus44Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason12> reason) {
		this.reason = reason;
	}
}