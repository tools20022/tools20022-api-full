...
public class MatchingStatus6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MatchingStatus6Choice.Matched, com.tools20022.repository.choice.MatchingStatus6Choice.Unmatched,
						com.tools20022.repository.choice.MatchingStatus6Choice.Proprietary);
