...
public class MatchingStatus6Choice {
	...
	public static final MMMessageAssociationEnd mmUnmatched = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.UnmatchedStatus4Choice.mmObject();
		}
	};
	...
	public MatchingStatus6Choice setUnmatched(com.tools20022.repository.choice.UnmatchedStatus4Choice unmatched) {
