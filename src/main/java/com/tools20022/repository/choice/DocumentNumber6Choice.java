...
public class DocumentNumber6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DocumentNumber6Choice.mmShortNumber, DocumentNumber6Choice.mmLongNumber, DocumentNumber6Choice.mmProprietaryNumber);
	...
	public void setProprietaryNumber(GenericIdentification86 proprietaryNumber) {
