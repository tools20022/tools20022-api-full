 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DocumentNumber6Choice#ShortNumber
 * DocumentNumber6Choice.ShortNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DocumentNumber6Choice#LongNumber
 * DocumentNumber6Choice.LongNumber}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DocumentNumber6Choice#ProprietaryNumber
 * DocumentNumber6Choice.ProprietaryNumber}</li>
 * </ul>
 * </li>
 * <li>
...
public class DocumentNumber6Choice {
	...
	public static final MMMessageAttribute ShortNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DocumentNumber6Choice.mmObject();
			isDerived = false;
			xmlTag = "ShrtNb";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber6Choice.ShortNumber, com.tools20022.repository.choice.DocumentNumber6Choice.LongNumber,
						com.tools20022.repository.choice.DocumentNumber6Choice.ProprietaryNumber);
