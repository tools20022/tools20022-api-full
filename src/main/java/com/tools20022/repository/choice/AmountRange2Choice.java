...
public class AmountRange2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AmountRange2Choice.ImpliedCurrencyAndAmountRange, com.tools20022.repository.choice.AmountRange2Choice.CurrencyAndAmountRange);
