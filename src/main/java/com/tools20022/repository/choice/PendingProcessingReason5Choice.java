...
@XmlType(name = "PendingProcessingReason5Choice", propOrder = {"code", "proprietary"})
public class PendingProcessingReason5Choice {
	...
	public static final MMMessageAttribute<PendingProcessingReason5Choice, PendingProcessingReason3Code> mmCode = new MMMessageAttribute<PendingProcessingReason5Choice, PendingProcessingReason3Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingProcessingReason12Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<PendingProcessingReason5Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PendingProcessingReason5Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has a pending processing status.";
			nextVersions_lazy = () -> Arrays.asList(PendingProcessingReason12Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingReason5Choice.mmCode, com.tools20022.repository.choice.PendingProcessingReason5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingReason5Choice";
				definition = "Choice of format for the pending processing reason.";
				nextVersions_lazy = () -> Arrays.asList(PendingProcessingReason12Choice.mmObject());
			}
		});
	...
	public PendingProcessingReason5Choice setCode(PendingProcessingReason3Code code) {
	...
	public PendingProcessingReason5Choice setProprietary(GenericIdentification20 proprietary) {
