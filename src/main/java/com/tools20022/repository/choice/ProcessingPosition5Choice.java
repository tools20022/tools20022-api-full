 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ProcessingPosition5Choice#Code
 * ProcessingPosition5Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ProcessingPosition5Choice#Proprietary
 * ProcessingPosition5Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class ProcessingPosition5Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ProcessingPosition5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Processing position expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingPosition8Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingPosition8Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingPosition5Choice.Code, com.tools20022.repository.choice.ProcessingPosition5Choice.Proprietary);
