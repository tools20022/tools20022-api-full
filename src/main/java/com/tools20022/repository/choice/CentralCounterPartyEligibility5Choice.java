...
@XmlType(name = "CentralCounterPartyEligibility5Choice", propOrder = {"indicator", "proprietary"})
public class CentralCounterPartyEligibility5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CentralCounterPartyEligibility5Choice.mmIndicator, com.tools20022.repository.choice.CentralCounterPartyEligibility5Choice.mmProprietary);
				trace_lazy = () -> Settlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CentralCounterPartyEligibility5Choice";
	...
	public CentralCounterPartyEligibility5Choice setIndicator(YesNoIndicator indicator) {
	...
	public CentralCounterPartyEligibility5Choice setProprietary(GenericIdentification47 proprietary) {
