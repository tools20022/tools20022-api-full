...
public class CentralCounterPartyEligibility5Choice {
	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CentralCounterPartyEligibility5Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CentralCounterPartyEligibility5Choice.mmIndicator, CentralCounterPartyEligibility5Choice.mmProprietary);
