...
public class PendingStatus46Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus46Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus46Choice.mmNoSpecifiedReason, PendingStatus46Choice.mmReason);
	...
	public void setReason(List<PendingReason20> reason) {
		this.reason = reason;
	}
}