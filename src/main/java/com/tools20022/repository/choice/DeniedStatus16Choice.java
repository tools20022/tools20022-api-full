 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus16Choice#Reason
...
public class DeniedStatus16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus16Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus16Choice.Reason);
