...
public class AccountIdentification16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification16Choice.ForAllAccounts, com.tools20022.repository.choice.AccountIdentification16Choice.AccountsListAndBalanceDetails);
