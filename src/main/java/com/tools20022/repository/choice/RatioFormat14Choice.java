 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.RatioFormat14Choice#mmNotSpecifiedRate
 * RatioFormat14Choice.mmNotSpecifiedRate}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat14Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat14Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat14Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat14Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class RatioFormat14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat14Choice, QuantityToQuantityRatio2> mmQuantityToQuantity = new MMMessageAssociationEnd<RatioFormat14Choice, QuantityToQuantityRatio2>() {
		{
			businessComponentTrace_lazy = () -> QuantityRatio.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
		...
		@Override
		public QuantityToQuantityRatio2 getValue(RatioFormat14Choice obj) {
			return obj.getQuantityToQuantity();
		}

		@Override
		public void setValue(RatioFormat14Choice obj, QuantityToQuantityRatio2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RatioFormat14Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RatioFormat14Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(RatioFormat14Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RatioFormat14Choice obj, RateValueType7Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat14Choice, AmountToAmountRatio3> mmAmountToAmount = new MMMessageAssociationEnd<RatioFormat14Choice, AmountToAmountRatio3>() {
		{
		...
		@Override
		public AmountToAmountRatio3 getValue(RatioFormat14Choice obj) {
			return obj.getAmountToAmount();
		}

		@Override
		public void setValue(RatioFormat14Choice obj, AmountToAmountRatio3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat14Choice, AmountAndQuantityRatio3> mmAmountToQuantity = new MMMessageAssociationEnd<RatioFormat14Choice, AmountAndQuantityRatio3>() {
		{
		...
		@Override
		public AmountAndQuantityRatio3 getValue(RatioFormat14Choice obj) {
			return obj.getAmountToQuantity();
		}

		@Override
		public void setValue(RatioFormat14Choice obj, AmountAndQuantityRatio3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat14Choice, AmountAndQuantityRatio3> mmQuantityToAmount = new MMMessageAssociationEnd<RatioFormat14Choice, AmountAndQuantityRatio3>() {
		{
			businessComponentTrace_lazy = () -> AmountAndQuantity.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat14Choice.mmObject();
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.choice.RatioFormat14Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat14Choice.mmNotSpecifiedRate,
								com.tools20022.repository.choice.RatioFormat14Choice.mmAmountToAmount, com.tools20022.repository.choice.RatioFormat14Choice.mmAmountToQuantity,
								com.tools20022.repository.choice.RatioFormat14Choice.mmQuantityToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat14Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat14Choice);
	...
	public RatioFormat14Choice setQuantityToQuantity(QuantityToQuantityRatio2 quantityToQuantity) {
	...
	public RatioFormat14Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RatioFormat14Choice setAmountToAmount(AmountToAmountRatio3 amountToAmount) {
	...
	public RatioFormat14Choice setAmountToQuantity(AmountAndQuantityRatio3 amountToQuantity) {
	...
	public RatioFormat14Choice setQuantityToAmount(AmountAndQuantityRatio3 quantityToAmount) {
