...
public class PriceFormat7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat7Choice.mmPercentagePrice, PriceFormat7Choice.mmAmountPrice, PriceFormat7Choice.mmAmountPricePerFinancialInstrumentQuantity, PriceFormat7Choice.mmAmountPricePerAmount);
