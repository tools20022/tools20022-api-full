...
@XmlType(name = "PriceFormat7Choice", propOrder = {"percentagePrice", "amountPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount"})
public class PriceFormat7Choice {
	...
	public static final MMMessageAssociationEnd mmPercentagePrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat34Choice.mmPercentagePrice);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountPrice = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat34Choice.mmAmountPrice);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat34Choice.mmAmountPricePerFinancialInstrumentQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountPricePerAmount = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat34Choice.mmAmountPricePerAmount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat7Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat7Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat7Choice.mmAmountPricePerFinancialInstrumentQuantity, com.tools20022.repository.choice.PriceFormat7Choice.mmAmountPricePerAmount);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat7Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat7Choice);
				...
				nextVersions_lazy = () -> Arrays.asList(PriceFormat34Choice.mmObject());
			}
		});
	...
	public PriceFormat7Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat7Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat7Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity3 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat7Choice setAmountPricePerAmount(AmountPricePerAmount2 amountPricePerAmount) {
