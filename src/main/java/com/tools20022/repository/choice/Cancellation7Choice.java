...
public class Cancellation7Choice {
	...
	public static final MMMessageAttribute mmCancellationByTransferInstructionDetails = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation11Choice.mmCancellationByTransferInstructionDetails);
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation6Choice.mmCancellationByTransferInstructionDetails;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCancellationByReference = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation11Choice.mmCancellationByReference);
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation6Choice.mmCancellationByReference;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.mmCancellation);
	...
	public void setCancellationByTransferInstructionDetails(ISATransfer19 cancellationByTransferInstructionDetails) {
