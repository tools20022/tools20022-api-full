...
public class Cancellation7Choice {
	...
	public static final MMMessageAttribute CancellationByTransferInstructionDetails = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Cancellation7Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation6Choice.CancellationByTransferInstructionDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation11Choice.CancellationByTransferInstructionDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute CancellationByReference = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation6Choice.CancellationByReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation11Choice.CancellationByReference);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation7Choice.CancellationByTransferInstructionDetails, com.tools20022.repository.choice.Cancellation7Choice.CancellationByReference);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferCancellationRequestV06.Cancellation);
