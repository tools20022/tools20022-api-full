	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IdentificationSource5Choice.mmDomesticIdentificationSource);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IdentificationSource5Choice.mmProprietaryIdentificationSource);
			maxOccurs = 1;
			minOccurs = 1;
