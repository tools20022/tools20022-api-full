 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV03#AccountDetails
 * CorporateActionMovementPreliminaryAdviceV03.AccountDetails}</li>
 * <li>
...
public class AccountIdentification18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification18Choice.ForAllAccounts, com.tools20022.repository.choice.AccountIdentification18Choice.AccountsListAndBalanceDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV03.AccountDetails,
						com.tools20022.repository.area.seev.CorporateActionNotificationV03.AccountDetails);
