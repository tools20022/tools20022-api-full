...
@XmlType(name = "Reason3Choice", propOrder = {"reason", "noSpecifiedReason"})
public class Reason3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn")
	protected List<ProprietaryReason3> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Reason3Choice Reason3Choice}
	 * </li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Reason3Choice, List<ProprietaryReason3>> mmReason = new MMMessageAssociationEnd<Reason3Choice, List<ProprietaryReason3>>() {
		{
			businessComponentTrace_lazy = () -> StatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.Reason3Choice.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
		...
		@Override
		public List<ProprietaryReason3> getValue(Reason3Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(Reason3Choice obj, List<ProprietaryReason3> value) {
			obj.setReason(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Reason3Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<Reason3Choice, NoReasonCode>() {
		{
		...
		@Override
		public NoReasonCode getValue(Reason3Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(Reason3Choice obj, NoReasonCode value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason3Choice.mmReason, com.tools20022.repository.choice.Reason3Choice.mmNoSpecifiedReason);
	...
	public Reason3Choice setReason(List<ProprietaryReason3> reason) {
	...
	public Reason3Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
