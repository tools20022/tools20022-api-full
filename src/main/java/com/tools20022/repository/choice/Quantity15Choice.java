 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Quantity15Choice#QuantityChoice
 * Quantity15Choice.QuantityChoice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Quantity15Choice#ProprietaryQuantity
 * Quantity15Choice.ProprietaryQuantity}</li>
 * </ul>
 * </li>
...
public class Quantity15Choice {
	...
	public static final MMMessageAssociationEnd QuantityChoice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Quantity15Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyChc";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Quantity15Choice.QuantityChoice, com.tools20022.repository.choice.Quantity15Choice.ProprietaryQuantity);
