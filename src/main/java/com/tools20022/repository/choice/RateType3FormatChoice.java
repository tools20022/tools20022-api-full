 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateType3FormatChoice#Code
 * RateType3FormatChoice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateType3FormatChoice#Proprietary
 * RateType3FormatChoice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class RateType3FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType3FormatChoice.Code, com.tools20022.repository.choice.RateType3FormatChoice.Proprietary);
