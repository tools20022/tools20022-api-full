 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateCode6Choice#Code
 * DateCode6Choice.Code}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateCode6Choice#Proprietary
 * DateCode6Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateCode6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateCode6Choice.Code, com.tools20022.repository.choice.DateCode6Choice.Proprietary);
