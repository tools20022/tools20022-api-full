...
@XmlType(name = "UnmatchedReason2Choice", propOrder = {"code", "proprietary"})
public class UnmatchedReason2Choice {
	...
	public UnmatchedReason2Choice setCode(UnmatchedReason3Code code) {
	...
	public UnmatchedReason2Choice setProprietary(GenericIdentification20 proprietary) {
