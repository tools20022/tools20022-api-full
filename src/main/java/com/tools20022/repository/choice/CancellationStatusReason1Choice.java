 ...
 * definition} = "Speficies the reason for the transaction cancellation status."
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "CancellationStatusReason1Choice", propOrder = {"code", "proprietary"})
public class CancellationStatusReason1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PaymentCancellationRejection1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationStatusReason1Choice, PaymentCancellationRejection1Code> mmCode = new MMMessageAttribute<CancellationStatusReason1Choice, PaymentCancellationRejection1Code>() {
		{
			businessElementTrace_lazy = () -> PaymentInvestigationCaseRejection.mmRejectedCancellation;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationStatusReason1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PaymentCancellationRejection1Code getValue(CancellationStatusReason1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancellationStatusReason1Choice obj, PaymentCancellationRejection1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationStatusReason1Choice, Max35Text> mmProprietary = new MMMessageAttribute<CancellationStatusReason1Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentInvestigationCaseRejection.mmRejectedCancellation;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationStatusReason1Choice.mmObject();
			isDerived = false;
		...
		@Override
		public Max35Text getValue(CancellationStatusReason1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancellationStatusReason1Choice obj, Max35Text value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationStatusReason1Choice.mmCode, com.tools20022.repository.choice.CancellationStatusReason1Choice.mmProprietary);
	...
	public PaymentCancellationRejection1Code getCode() {
		return code;
	}

	public CancellationStatusReason1Choice setCode(PaymentCancellationRejection1Code code) {
	...
	public CancellationStatusReason1Choice setProprietary(Max35Text proprietary) {
