...
public class CancellationStatusReason1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancellationStatusReason1Choice.mmCode, CancellationStatusReason1Choice.mmProprietary);
	...
	public void setCode(PaymentCancellationRejection1Code code) {
		this.code = code;
	}
