...
import com.tools20022.repository.codeset.CashAccountType5Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CashAccountType3Choice#mmCode
 * CashAccountType3Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CashAccountType3Choice#mmProprietary
 * CashAccountType3Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats for the type of cash account."</li>
 * <li>
...
@XmlType(name = "CashAccountType3Choice", propOrder = {"code", "proprietary"})
public class CashAccountType3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CashAccountType5Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<CashAccountType3Choice, CashAccountType5Code> mmCode = new MMMessageAttribute<CashAccountType3Choice, CashAccountType5Code>() {
		{
			...
			name = "Code";
			definition = "Type of cash account expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<CashAccountType3Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<CashAccountType3Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Type of cash account expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CashAccountType3Choice.mmCode, com.tools20022.repository.choice.CashAccountType3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CashAccountType3Choice";
				definition = "Choice of formats for the type of cash account.";
			}
		});
		return mmObject_lazy.get();
	}

	public CashAccountType5Code getCode() {
		return code;
	}

	public CashAccountType3Choice setCode(CashAccountType5Code code) {
	...
	public CashAccountType3Choice setProprietary(GenericIdentification47 proprietary) {
