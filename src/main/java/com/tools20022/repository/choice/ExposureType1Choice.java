 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType1Choice#mmCode
...
@XmlType(name = "ExposureType1Choice", propOrder = {"code", "proprietary"})
public class ExposureType1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType1Choice, ExposureType1Code> mmCode = new MMMessageAttribute<ExposureType1Choice, ExposureType1Code>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ExposureType1Code getValue(ExposureType1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ExposureType1Choice obj, ExposureType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<ExposureType1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType1Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(ExposureType1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ExposureType1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType1Choice.mmCode, com.tools20022.repository.choice.ExposureType1Choice.mmProprietary);
	...
	public ExposureType1Choice setCode(ExposureType1Code code) {
	...
	public ExposureType1Choice setProprietary(GenericIdentification20 proprietary) {
