...
public class References47Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References47Choice, Max35Text> mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute<References47Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmSecuritiesSettlement;
			componentContext_lazy = () -> com.tools20022.repository.choice.References47Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> References1Choice.mmSecuritiesSettlementTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(References47Choice obj) {
			return obj.getSecuritiesSettlementTransactionIdentification();
		}

		@Override
		public void setValue(References47Choice obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References47Choice, Max35Text> mmPoolIdentification = new MMMessageAttribute<References47Choice, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> References1Choice.mmPoolIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References47Choice, Max35Text> mmIntraPositionMovementIdentification = new MMMessageAttribute<References47Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.References47Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> References1Choice.mmIntraPositionMovementIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References47Choice, Max35Text> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References47Choice, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> References1Choice.mmAccountServicerTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References47Choice, Max35Text> mmOtherTransactionIdentification = new MMMessageAttribute<References47Choice, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> References1Choice.mmOtherTransactionIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.mmSecuritiesSettlementTransactionIdentification, com.tools20022.repository.choice.References47Choice.mmPoolIdentification,
						com.tools20022.repository.choice.References47Choice.mmIntraPositionMovementIdentification, com.tools20022.repository.choice.References47Choice.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.choice.References47Choice.mmOtherTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "References47Choice";
				definition = "Choice of reference.";
				previousVersion_lazy = () -> References1Choice.mmObject();
			}
		});
	...
	public References47Choice setSecuritiesSettlementTransactionIdentification(Max35Text securitiesSettlementTransactionIdentification) {
	...
	public References47Choice setPoolIdentification(Max35Text poolIdentification) {
	...
	public References47Choice setIntraPositionMovementIdentification(Max35Text intraPositionMovementIdentification) {
	...
	public References47Choice setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References47Choice setOtherTransactionIdentification(Max35Text otherTransactionIdentification) {
