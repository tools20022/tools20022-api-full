 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.CurrentLimitChoice#LiquidityManagementCurrentLimitIdentification
 * CurrentLimitChoice.LiquidityManagementCurrentLimitIdentification}</li>
 * </ul>
 * </li>
...
public class CurrentLimitChoice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd RiskManagementCurrentLimitIdentification = new MMMessageAssociationEnd() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd LiquidityManagementCurrentLimitIdentification = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> CurrentLimitChoice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CurrentLimitChoice.RiskManagementCurrentLimitIdentification,
						com.tools20022.repository.choice.CurrentLimitChoice.LiquidityManagementCurrentLimitIdentification);
