...
@XmlType(name = "NetDividendRateFormat22Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class NetDividendRateFormat22Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat22Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<NetDividendRateFormat22Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmNetDividend;
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Number of monetary units specified in a currency.";
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat31Choice.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(NetDividendRateFormat22Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(NetDividendRateFormat22Choice obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat22Choice, AmountAndRateStatus1> mmAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat22Choice, AmountAndRateStatus1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat31Choice.mmAmountAndRateStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountAndRateStatus1 getValue(NetDividendRateFormat22Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat22Choice obj, AmountAndRateStatus1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat22Choice, RateTypeAndAmountAndStatus29> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat22Choice, RateTypeAndAmountAndStatus29>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat31Choice.mmRateTypeAndAmountAndRateStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public RateTypeAndAmountAndStatus29 getValue(NetDividendRateFormat22Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat22Choice obj, RateTypeAndAmountAndStatus29 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat22Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<NetDividendRateFormat22Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat31Choice.mmNotSpecifiedRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RateValueType7Code getValue(NetDividendRateFormat22Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(NetDividendRateFormat22Choice obj, RateValueType7Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmAmount, com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.NetDividendRateFormat22Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NetDividendRateFormat22Choice";
				definition = "Choice between an amount or an unspecified rate.";
				nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat31Choice.mmObject());
			}
		});
	...
	public NetDividendRateFormat22Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat22Choice setAmountAndRateStatus(AmountAndRateStatus1 amountAndRateStatus) {
	...
	public NetDividendRateFormat22Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus29 rateTypeAndAmountAndRateStatus) {
	...
	public NetDividendRateFormat22Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
