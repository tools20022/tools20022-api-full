...
public class NetDividendRateFormat22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat22Choice.mmAmount, NetDividendRateFormat22Choice.mmAmountAndRateStatus, NetDividendRateFormat22Choice.mmRateTypeAndAmountAndRateStatus,
						NetDividendRateFormat22Choice.mmNotSpecifiedRate);
