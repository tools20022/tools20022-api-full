 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.PreferenceToIncome4Choice#mmCode
 * PreferenceToIncome4Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.PreferenceToIncome4Choice#mmProprietary
...
@XmlType(name = "PreferenceToIncome4Choice", propOrder = {"code", "proprietary"})
public class PreferenceToIncome4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PreferenceToIncome4Choice, PreferenceToIncome1Code> mmCode = new MMMessageAttribute<PreferenceToIncome4Choice, PreferenceToIncome1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PreferenceToIncome4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PreferenceToIncome1Code getValue(PreferenceToIncome4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PreferenceToIncome4Choice obj, PreferenceToIncome1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PreferenceToIncome4Choice, GenericIdentification40> mmProprietary = new MMMessageAssociationEnd<PreferenceToIncome4Choice, GenericIdentification40>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PreferenceToIncome4Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
		...
		@Override
		public GenericIdentification40 getValue(PreferenceToIncome4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PreferenceToIncome4Choice obj, GenericIdentification40 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PreferenceToIncome4Choice.mmCode, com.tools20022.repository.choice.PreferenceToIncome4Choice.mmProprietary);
	...
	public PreferenceToIncome4Choice setCode(PreferenceToIncome1Code code) {
	...
	public PreferenceToIncome4Choice setProprietary(GenericIdentification40 proprietary) {
