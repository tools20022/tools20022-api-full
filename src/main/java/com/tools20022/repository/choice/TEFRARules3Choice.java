...
import com.tools20022.repository.codeset.TEFRARules1Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TEFRARules3Choice#mmCode
...
@XmlType(name = "TEFRARules3Choice", propOrder = {"code", "proprietary"})
public class TEFRARules3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected TEFRARules1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * {@linkplain com.tools20022.repository.entity.SecuritiesTax#mmTEFRARule
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TEFRARules2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TEFRARules2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TEFRARules3Choice.mmCode, com.tools20022.repository.choice.TEFRARules3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TEFRARules3Choice";
				definition = "Choice of format for TEFRA rules.";
				previousVersion_lazy = () -> TEFRARules2Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public TEFRARules1Code getCode() {
		return code;
	}

	public TEFRARules3Choice setCode(TEFRARules1Code code) {
	...
	public TEFRARules3Choice setProprietary(GenericIdentification30 proprietary) {
