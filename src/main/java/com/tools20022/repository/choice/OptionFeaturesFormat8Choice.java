...
@XmlType(name = "OptionFeaturesFormat8Choice", propOrder = {"code", "proprietary"})
public class OptionFeaturesFormat8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionFeaturesFormat8Choice, OptionFeatures3Code> mmCode = new MMMessageAttribute<OptionFeaturesFormat8Choice, OptionFeatures3Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OptionFeatures3Code getValue(OptionFeaturesFormat8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionFeaturesFormat8Choice obj, OptionFeatures3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionFeaturesFormat8Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<OptionFeaturesFormat8Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat8Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(OptionFeaturesFormat8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionFeaturesFormat8Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat8Choice.mmCode, com.tools20022.repository.choice.OptionFeaturesFormat8Choice.mmProprietary);
				...
				name = "OptionFeaturesFormat8Choice";
	...
	public OptionFeaturesFormat8Choice setCode(OptionFeatures3Code code) {
	...
	public OptionFeaturesFormat8Choice setProprietary(GenericIdentification25 proprietary) {
