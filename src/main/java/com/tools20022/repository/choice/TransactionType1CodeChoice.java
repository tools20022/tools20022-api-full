...
public class TransactionType1CodeChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TransactionType1CodeChoice.Structured, com.tools20022.repository.choice.TransactionType1CodeChoice.Unstructured);
