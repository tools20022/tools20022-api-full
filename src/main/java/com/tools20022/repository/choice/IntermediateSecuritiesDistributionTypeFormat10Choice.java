...
public class IntermediateSecuritiesDistributionTypeFormat10Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat10Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat10Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat10Choice.mmProprietary);
	...
	public void setCode(IntermediateSecurityDistributionType5Code code) {
		this.code = code;
	}
