...
public class ProcessingStatus23Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus23Choice.mmAcknowledgedAccepted, ProcessingStatus23Choice.mmPendingProcessing, ProcessingStatus23Choice.mmRepair, ProcessingStatus23Choice.mmPendingCancellation,
						ProcessingStatus23Choice.mmProprietary, ProcessingStatus23Choice.mmCancellationRequested);
