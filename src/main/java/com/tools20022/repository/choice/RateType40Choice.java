	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Standard code to specify the type of gross dividend rate.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateType22Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateType22Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
