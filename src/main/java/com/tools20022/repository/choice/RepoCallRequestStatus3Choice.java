...
@XmlType(name = "RepoCallRequestStatus3Choice", propOrder = {"code", "proprietary"})
public class RepoCallRequestStatus3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepoCallRequestStatus3Choice.mmCode, com.tools20022.repository.choice.RepoCallRequestStatus3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepoCallRequestStatus3Choice";
	...
	public RepoCallRequestStatus3Choice setCode(RepoCallRequestStatus1Code code) {
	...
	public RepoCallRequestStatus3Choice setProprietary(GenericIdentification25 proprietary) {
