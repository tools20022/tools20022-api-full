...
public class RepoCallRequestStatus3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepoCallRequestStatus3Choice.Code, com.tools20022.repository.choice.RepoCallRequestStatus3Choice.Proprietary);
