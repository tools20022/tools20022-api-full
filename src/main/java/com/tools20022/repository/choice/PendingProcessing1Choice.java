...
import com.tools20022.repository.msg.AwaitingAffirmationReason1;
 ...
 * definition} = "Choice of format for the Pending Processing status."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PendingProcessing1Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingProcessing1Choice {
	...
	protected List<AwaitingAffirmationReason1> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessing1Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingProcessing1Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessing1Choice";
				definition = "Choice of format for the Pending Processing status.";
			}
		});
	...
	public PendingProcessing1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<AwaitingAffirmationReason1> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingProcessing1Choice setReason(List<AwaitingAffirmationReason1> reason) {
