...
public class PendingProcessing1Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessing1Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessing1Choice.mmNoSpecifiedReason, PendingProcessing1Choice.mmReason);
	...
	public void setReason(List<AwaitingAffirmationReason1> reason) {
		this.reason = reason;
	}
}