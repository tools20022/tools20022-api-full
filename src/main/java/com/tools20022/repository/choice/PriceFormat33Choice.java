 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat33Choice#NotSpecifiedPrice
 * PriceFormat33Choice.NotSpecifiedPrice}</li>
 * <li>
...
public class PriceFormat33Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat21Choice.PercentagePrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.PercentagePrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat21Choice.AmountPrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.AmountPrice);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.PriceFormat49Choice#NotSpecifiedPrice
	 * PriceFormat49Choice.NotSpecifiedPrice}</li>
	 * </ul>
	 * </li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.PriceFormat21Choice#NotSpecifiedPrice
	 * PriceFormat21Choice.NotSpecifiedPrice}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute NotSpecifiedPrice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat21Choice.NotSpecifiedPrice;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.NotSpecifiedPrice);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat21Choice.AmountPricePerFinancialInstrumentQuantity;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.AmountPricePerFinancialInstrumentQuantity);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat21Choice.AmountPricePerAmount;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.AmountPricePerAmount);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IndexPoints = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.IndexPoints);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat33Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat33Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat33Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat33Choice.AmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat33Choice.AmountPricePerAmount, com.tools20022.repository.choice.PriceFormat33Choice.IndexPoints);
