...
@XmlType(name = "PriceFormat33Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount", "indexPoints"})
public class PriceFormat33Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat33Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat33Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat33Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat33Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat33Choice, AmountPrice3>() {
		{
		...
		@Override
		public AmountPrice3 getValue(PriceFormat33Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, AmountPrice3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat33Choice, PriceValueType9Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat33Choice, PriceValueType9Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType9Code getValue(PriceFormat33Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, PriceValueType9Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat33Choice, AmountPricePerFinancialInstrumentQuantity3> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat33Choice, AmountPricePerFinancialInstrumentQuantity3>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity3 getValue(PriceFormat33Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, AmountPricePerFinancialInstrumentQuantity3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat33Choice, AmountPricePerAmount2> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat33Choice, AmountPricePerAmount2>() {
		{
		...
		@Override
		public AmountPricePerAmount2 getValue(PriceFormat33Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, AmountPricePerAmount2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat33Choice, DecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat33Choice, DecimalNumber>() {
		{
		...
		@Override
		public DecimalNumber getValue(PriceFormat33Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat33Choice obj, DecimalNumber value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat33Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat33Choice);
	...
	public PriceFormat33Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat33Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat33Choice setNotSpecifiedPrice(PriceValueType9Code notSpecifiedPrice) {
	...
	public PriceFormat33Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity3 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat33Choice setAmountPricePerAmount(AmountPricePerAmount2 amountPricePerAmount) {
	...
	public PriceFormat33Choice setIndexPoints(DecimalNumber indexPoints) {
