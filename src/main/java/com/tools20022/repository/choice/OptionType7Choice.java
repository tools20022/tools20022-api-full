 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionType7Choice#mmCode
...
@XmlType(name = "OptionType7Choice", propOrder = {"code", "proprietary"})
public class OptionType7Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OptionType7Choice
	 * OptionType7Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionType7Choice.mmCode, com.tools20022.repository.choice.OptionType7Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionType7Choice";
	...
	public OptionType7Choice setCode(OptionType1Code code) {
	...
	public OptionType7Choice setProprietary(GenericIdentification47 proprietary) {
