...
public class SettlementOrCorporateActionEvent1Choice {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementOrCorporateActionEvent1Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType3Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent1Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent1Choice.mmCorporateActionEventType);
	...
	public void setSecuritiesTransactionType(com.tools20022.repository.choice.SecuritiesTransactionType3Choice securitiesTransactionType) {
