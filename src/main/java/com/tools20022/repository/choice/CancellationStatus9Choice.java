...
public class CancellationStatus9Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationStatus15Choice.NoSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationStatus15Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationStatus9Choice.NoSpecifiedReason, com.tools20022.repository.choice.CancellationStatus9Choice.Reason);
