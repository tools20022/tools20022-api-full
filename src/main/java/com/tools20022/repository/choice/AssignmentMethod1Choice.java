...
@XmlType(name = "AssignmentMethod1Choice", propOrder = {"code", "proprietary"})
public class AssignmentMethod1Choice {
	...
	public AssignmentMethod1Choice setCode(AssignmentMethod1Code code) {
	...
	public AssignmentMethod1Choice setProprietary(GenericIdentification40 proprietary) {
