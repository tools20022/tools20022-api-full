...
public class References34Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References34Choice.mmSecuritiesSettlementTransactionIdentification, References34Choice.mmIntraPositionMovementIdentification,
						References34Choice.mmIntraBalanceMovementIdentification, References34Choice.mmAccountServicerTransactionIdentification, References34Choice.mmMarketInfrastructureTransactionIdentification,
						References34Choice.mmPoolIdentification, References34Choice.mmOtherTransactionIdentification);
