 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.References34Choice#mmIntraPositionMovementIdentification
 * References34Choice.mmIntraPositionMovementIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.References34Choice#mmIntraBalanceMovementIdentification
 * References34Choice.mmIntraBalanceMovementIdentification}</li>
 * <li>
 ...
 * definition} = "Choice of references."</li>
 * <li>
...
@XmlType(name = "References34Choice", propOrder = {"securitiesSettlementTransactionIdentification", "intraPositionMovementIdentification", "intraBalanceMovementIdentification", "accountServicerTransactionIdentification",
...
public class References34Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.References34Choice
	 * References34Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmSecuritiesSettlement;
			componentContext_lazy = () -> com.tools20022.repository.choice.References34Choice.mmObject();
			isDerived = false;
		...
		@Override
		public Max35Text getValue(References34Choice obj) {
			return obj.getSecuritiesSettlementTransactionIdentification();
		}

		@Override
		public void setValue(References34Choice obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmIntraPositionMovementIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.References34Choice.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmIntraBalanceMovementIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.References34Choice.mmObject();
			isDerived = false;
			...
			definition = "Unambiguous identification of the intra-balance movement transaction as known by the account owner (or instructing party acting on its behalf).";
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmPoolIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References34Choice, Max35Text> mmOtherTransactionIdentification = new MMMessageAttribute<References34Choice, Max35Text>() {
		{
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References34Choice.mmSecuritiesSettlementTransactionIdentification,
						com.tools20022.repository.choice.References34Choice.mmIntraPositionMovementIdentification, com.tools20022.repository.choice.References34Choice.mmIntraBalanceMovementIdentification,
						com.tools20022.repository.choice.References34Choice.mmAccountServicerTransactionIdentification, com.tools20022.repository.choice.References34Choice.mmMarketInfrastructureTransactionIdentification,
						com.tools20022.repository.choice.References34Choice.mmPoolIdentification, com.tools20022.repository.choice.References34Choice.mmOtherTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "References34Choice";
				definition = "Choice of references.";
			}
		});
	...
	public References34Choice setSecuritiesSettlementTransactionIdentification(Max35Text securitiesSettlementTransactionIdentification) {
	...
	public References34Choice setIntraPositionMovementIdentification(Max35Text intraPositionMovementIdentification) {
	...
	public References34Choice setIntraBalanceMovementIdentification(Max35Text intraBalanceMovementIdentification) {
	...
	public References34Choice setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References34Choice setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public References34Choice setPoolIdentification(Max35Text poolIdentification) {
	...
	public References34Choice setOtherTransactionIdentification(Max35Text otherTransactionIdentification) {
