...
public class AccountIdentification10Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification10Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification10Choice.mmForAllAccounts, AccountIdentification10Choice.mmAccountsListAndBalanceDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountIdentification13> accountsListAndBalanceDetails) {
