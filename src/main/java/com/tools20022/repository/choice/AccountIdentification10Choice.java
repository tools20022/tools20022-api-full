...
import com.tools20022.repository.msg.AccountIdentification13;
...
@XmlType(name = "AccountIdentification10Choice", propOrder = {"forAllAccounts", "accountsListAndBalanceDetails"})
public class AccountIdentification10Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification10Choice, AccountIdentification10> mmForAllAccounts = new MMMessageAssociationEnd<AccountIdentification10Choice, AccountIdentification10>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification10Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
		...
		@Override
		public AccountIdentification10 getValue(AccountIdentification10Choice obj) {
			return obj.getForAllAccounts();
		}

		@Override
		public void setValue(AccountIdentification10Choice obj, AccountIdentification10 value) {
			obj.setForAllAccounts(value);
		}
	};
	@XmlElement(name = "AcctsListAndBalDtls", required = true)
	protected List<AccountIdentification13> accountsListAndBalanceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification10Choice, List<AccountIdentification13>> mmAccountsListAndBalanceDetails = new MMMessageAssociationEnd<AccountIdentification10Choice, List<AccountIdentification13>>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification10Choice.mmObject();
			isDerived = false;
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> AccountIdentification13.mmObject();
		}

		@Override
		public List<AccountIdentification13> getValue(AccountIdentification10Choice obj) {
			return obj.getAccountsListAndBalanceDetails();
		}

		@Override
		public void setValue(AccountIdentification10Choice obj, List<AccountIdentification13> value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification10Choice.mmForAllAccounts, com.tools20022.repository.choice.AccountIdentification10Choice.mmAccountsListAndBalanceDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountIdentification10Choice";
	...
	public AccountIdentification10Choice setForAllAccounts(AccountIdentification10 forAllAccounts) {
		this.forAllAccounts = Objects.requireNonNull(forAllAccounts);
		return this;
	}

	public List<AccountIdentification13> getAccountsListAndBalanceDetails() {
		return accountsListAndBalanceDetails == null ? accountsListAndBalanceDetails = new ArrayList<>() : accountsListAndBalanceDetails;
	}

	public AccountIdentification10Choice setAccountsListAndBalanceDetails(List<AccountIdentification13> accountsListAndBalanceDetails) {
