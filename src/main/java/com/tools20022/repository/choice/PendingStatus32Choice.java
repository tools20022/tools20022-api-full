...
import com.tools20022.repository.msg.PendingStatusReason5;
...
@XmlType(name = "PendingStatus32Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingStatus32Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatus34Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> PendingStatus1Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected List<PendingStatusReason5> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.PendingStatusReason5
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingStatus34Choice.mmReason);
			previousVersion_lazy = () -> PendingStatus1Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus32Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingStatus32Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatus32Choice";
				definition = "Choice between a reason or no reason for the corporate action instruction processing pending status.";
				nextVersions_lazy = () -> Arrays.asList(PendingStatus34Choice.mmObject());
				previousVersion_lazy = () -> PendingStatus1Choice.mmObject();
			}
		});
	...
	public PendingStatus32Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<PendingStatusReason5> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingStatus32Choice setReason(List<PendingStatusReason5> reason) {
