...
public class PendingStatus32Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus32Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus32Choice.mmNoSpecifiedReason, PendingStatus32Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason5> reason) {
		this.reason = reason;
	}
}