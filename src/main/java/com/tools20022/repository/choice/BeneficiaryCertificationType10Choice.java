...
@XmlType(name = "BeneficiaryCertificationType10Choice", propOrder = {"code", "proprietary"})
public class BeneficiaryCertificationType10Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BeneficiaryCertificationType10Choice, BeneficiaryCertificationType5Code> mmCode = new MMMessageAttribute<BeneficiaryCertificationType10Choice, BeneficiaryCertificationType5Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType10Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> BeneficiaryCertificationType6Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public BeneficiaryCertificationType5Code getValue(BeneficiaryCertificationType10Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BeneficiaryCertificationType10Choice obj, BeneficiaryCertificationType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BeneficiaryCertificationType10Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<BeneficiaryCertificationType10Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType10Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> BeneficiaryCertificationType6Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(BeneficiaryCertificationType10Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BeneficiaryCertificationType10Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficiaryCertificationType10Choice.mmCode, com.tools20022.repository.choice.BeneficiaryCertificationType10Choice.mmProprietary);
				trace_lazy = () -> BeneficialOwner.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BeneficiaryCertificationType10Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of beneficiary certification required.";
				previousVersion_lazy = () -> BeneficiaryCertificationType6Choice.mmObject();
			}
		});
	...
	public BeneficiaryCertificationType10Choice setCode(BeneficiaryCertificationType5Code code) {
	...
	public BeneficiaryCertificationType10Choice setProprietary(GenericIdentification30 proprietary) {
