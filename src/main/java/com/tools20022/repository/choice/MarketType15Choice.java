 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MarketType15Choice#mmCode
 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.MarketType4Choice
 * MarketType4Choice}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "MarketType15Choice", propOrder = {"code", "proprietary"})
public class MarketType15Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.MarketType15Choice
	 * MarketType15Choice}</li>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> MarketType4Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> MarketType4Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketType15Choice.mmCode, com.tools20022.repository.choice.MarketType15Choice.mmProprietary);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketType15Choice";
				definition = "Choice of format for the market type.";
				previousVersion_lazy = () -> MarketType4Choice.mmObject();
			}
		});
	...
	public MarketType15Choice setCode(MarketType4Code code) {
	...
	public MarketType15Choice setProprietary(GenericIdentification30 proprietary) {
