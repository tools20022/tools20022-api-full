 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.RatioFormat23Choice#NotSpecifiedRate
 * RatioFormat23Choice.NotSpecifiedRate}</li>
 * <li>
...
public class RatioFormat23Choice {
	...
	public static final MMMessageAssociationEnd QuantityToQuantity = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> RatioFormat23Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat23Choice.QuantityToQuantity, com.tools20022.repository.choice.RatioFormat23Choice.NotSpecifiedRate,
						com.tools20022.repository.choice.RatioFormat23Choice.AmountToAmount);
