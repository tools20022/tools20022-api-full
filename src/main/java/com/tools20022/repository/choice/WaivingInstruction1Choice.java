...
@XmlType(name = "WaivingInstruction1Choice", propOrder = {"code", "proprietary"})
public class WaivingInstruction1Choice {
	...
	public WaivingInstruction1Choice setCode(WaivingInstruction1Code code) {
	...
	public WaivingInstruction1Choice setProprietary(GenericIdentification47 proprietary) {
