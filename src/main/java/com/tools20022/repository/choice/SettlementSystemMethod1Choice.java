...
@XmlType(name = "SettlementSystemMethod1Choice", propOrder = {"code", "proprietary"})
public class SettlementSystemMethod1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementSystemMethod4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementSystemMethod4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementSystemMethod1Choice.mmCode, com.tools20022.repository.choice.SettlementSystemMethod1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementSystemMethod1Choice";
				definition = "Choice of format for the settlement system/method.";
				nextVersions_lazy = () -> Arrays.asList(SettlementSystemMethod4Choice.mmObject());
			}
		});
	...
	public SettlementSystemMethod1Choice setCode(SettlementSystemMethod1Code code) {
	...
	public SettlementSystemMethod1Choice setProprietary(GenericIdentification20 proprietary) {
