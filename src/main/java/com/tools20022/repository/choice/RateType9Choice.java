...
@XmlType(name = "RateType9Choice", propOrder = {"code", "proprietary"})
public class RateType9Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RateType9Choice
	 * RateType9Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType9Choice.mmCode, com.tools20022.repository.choice.RateType9Choice.mmProprietary);
				trace_lazy = () -> InterestCalculation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType9Choice";
	...
	public RateType9Choice setCode(RateType7Code code) {
	...
	public RateType9Choice setProprietary(GenericIdentification25 proprietary) {
