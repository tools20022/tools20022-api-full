 ...
 * <li>{@linkplain com.tools20022.repository.choice.RateType9Choice#Proprietary
...
public class RateType9Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateType9Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType9Choice.Code, com.tools20022.repository.choice.RateType9Choice.Proprietary);
