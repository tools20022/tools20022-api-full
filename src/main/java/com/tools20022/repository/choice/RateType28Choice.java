...
@XmlType(name = "RateType28Choice", propOrder = {"code", "proprietary"})
public class RateType28Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType28Choice, WithholdingTaxRateType1Code> mmCode = new MMMessageAttribute<RateType28Choice, WithholdingTaxRateType1Code>() {
		{
			businessElementTrace_lazy = () -> Tax.mmWithholdingTaxType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType28Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of withholding tax rate.";
			nextVersions_lazy = () -> Arrays.asList(RateType42Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public WithholdingTaxRateType1Code getValue(RateType28Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType28Choice obj, WithholdingTaxRateType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateType28Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RateType28Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Tax.mmWithholdingTaxType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType28Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateType42Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RateType28Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType28Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType28Choice.mmCode, com.tools20022.repository.choice.RateType28Choice.mmProprietary);
				trace_lazy = () -> Tax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType28Choice";
				definition = "Choice between a standard code or proprietary code to specify a rate type.";
				nextVersions_lazy = () -> Arrays.asList(RateType42Choice.mmObject());
			}
		});
	...
	public RateType28Choice setCode(WithholdingTaxRateType1Code code) {
	...
	public RateType28Choice setProprietary(GenericIdentification20 proprietary) {
