 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionStyle9Choice#mmCode
...
@XmlType(name = "OptionStyle9Choice", propOrder = {"code", "proprietary"})
public class OptionStyle9Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OptionStyle9Choice
	 * OptionStyle9Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionStyle9Choice, OptionStyle2Code> mmCode = new MMMessageAttribute<OptionStyle9Choice, OptionStyle2Code>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionStyle;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionStyle9Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OptionStyle2Code getValue(OptionStyle9Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionStyle9Choice obj, OptionStyle2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionStyle9Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<OptionStyle9Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionStyle;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionStyle9Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(OptionStyle9Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionStyle9Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle9Choice.mmCode, com.tools20022.repository.choice.OptionStyle9Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionStyle9Choice";
	...
	public OptionStyle9Choice setCode(OptionStyle2Code code) {
	...
	public OptionStyle9Choice setProprietary(GenericIdentification47 proprietary) {
