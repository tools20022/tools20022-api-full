...
public class OptionStyle9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle9Choice.Code, com.tools20022.repository.choice.OptionStyle9Choice.Proprietary);
