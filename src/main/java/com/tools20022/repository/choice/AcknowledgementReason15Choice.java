 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.AcknowledgementReason1Choice
 * AcknowledgementReason1Choice}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "AcknowledgementReason15Choice", propOrder = {"code", "proprietary"})
public class AcknowledgementReason15Choice {
	...
	public static final MMMessageAttribute<AcknowledgementReason15Choice, AcknowledgementReason3Code> mmCode = new MMMessageAttribute<AcknowledgementReason15Choice, AcknowledgementReason3Code>() {
		{
			...
			previousVersion_lazy = () -> AcknowledgementReason1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AcknowledgementReason15Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<AcknowledgementReason15Choice, GenericIdentification30>() {
		{
			...
			name = "Proprietary";
			definition = "Specifies additional information about the processed instruction.";
			previousVersion_lazy = () -> AcknowledgementReason1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgementReason15Choice.mmCode, com.tools20022.repository.choice.AcknowledgementReason15Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason15Choice";
				definition = "Choice of format for the acknowledgement reason.";
				previousVersion_lazy = () -> AcknowledgementReason1Choice.mmObject();
			}
		});
	...
	public AcknowledgementReason15Choice setCode(AcknowledgementReason3Code code) {
	...
	public AcknowledgementReason15Choice setProprietary(GenericIdentification30 proprietary) {
