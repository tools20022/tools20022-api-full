...
public class CancelledStatus7Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus7Choice.mmNoSpecifiedReason, CancelledStatus7Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason8> reason) {
		this.reason = reason;
	}
}