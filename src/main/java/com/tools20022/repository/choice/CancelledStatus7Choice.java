...
public class CancelledStatus7Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancelledStatus3Choice.NoSpecifiedReason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus11Choice.NoSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancelledStatus3Choice.Reason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus11Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus7Choice.NoSpecifiedReason, com.tools20022.repository.choice.CancelledStatus7Choice.Reason);
