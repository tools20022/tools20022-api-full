 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateCode8Choice#Code
 * DateCode8Choice.Code}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateCode8Choice#Proprietary
 * DateCode8Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateCode8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateCode8Choice.Code, com.tools20022.repository.choice.DateCode8Choice.Proprietary);
