...
@XmlType(name = "CashSettlementSystem1Choice", propOrder = {"code", "proprietary"})
public class CashSettlementSystem1Choice {
	...
	public static final MMMessageAttribute<CashSettlementSystem1Choice, CashSettlementSystem2Code> mmCode = new MMMessageAttribute<CashSettlementSystem1Choice, CashSettlementSystem2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashSettlementSystem4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<CashSettlementSystem1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<CashSettlementSystem1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CashSettlementSystem4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CashSettlementSystem1Choice.mmCode, com.tools20022.repository.choice.CashSettlementSystem1Choice.mmProprietary);
				trace_lazy = () -> CashClearingSystem.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CashSettlementSystem1Choice";
				definition = "Choice of format for the cash settlement system.";
				nextVersions_lazy = () -> Arrays.asList(CashSettlementSystem4Choice.mmObject());
			}
		});
	...
	public CashSettlementSystem1Choice setCode(CashSettlementSystem2Code code) {
	...
	public CashSettlementSystem1Choice setProprietary(GenericIdentification20 proprietary) {
