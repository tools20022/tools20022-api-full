...
public class PendingProcessingReason11Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingProcessingReason1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has a pending processing status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingProcessingReason1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingReason11Choice.Code, com.tools20022.repository.choice.PendingProcessingReason11Choice.Proprietary);
