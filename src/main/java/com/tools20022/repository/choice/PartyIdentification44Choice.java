...
public class PartyIdentification44Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification44Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification44Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification44Choice.Country);
