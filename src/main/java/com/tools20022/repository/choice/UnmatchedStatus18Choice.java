...
public class UnmatchedStatus18Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus18Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus18Choice.mmNoSpecifiedReason, UnmatchedStatus18Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason17> reason) {
		this.reason = reason;
	}
}