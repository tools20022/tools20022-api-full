...
public class FinancialInstrumentQuantity18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity18Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity18Choice.FaceAmount);
