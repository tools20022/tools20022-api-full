...
public class SettlementOrCorporateActionEvent21Choice {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementOrCorporateActionEvent21Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType34Choice.mmObject();
		}
	};
	...
	public static final MMMessageAttribute mmCorporateActionEventType = new MMMessageAttribute() {
		{
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType71Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent21Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent21Choice.mmCorporateActionEventType);
	...
	public void setSecuritiesTransactionType(com.tools20022.repository.choice.SecuritiesTransactionType34Choice securitiesTransactionType) {
	...
	public void setCorporateActionEventType(com.tools20022.repository.choice.CorporateActionEventType71Choice corporateActionEventType) {
