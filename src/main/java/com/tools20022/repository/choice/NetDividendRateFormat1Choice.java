...
public class NetDividendRateFormat1Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NetDividendRateFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat1Choice.mmAmount, NetDividendRateFormat1Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat1Choice.mmNotSpecifiedRate);
