...
@XmlType(name = "IntermediateSecuritiesDistributionTypeFormat18Choice", propOrder = {"code", "proprietary"})
public class IntermediateSecuritiesDistributionTypeFormat18Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat18Choice, IntermediateSecurityDistributionType5Code> mmCode = new MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat18Choice, IntermediateSecurityDistributionType5Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat18Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public IntermediateSecurityDistributionType5Code getValue(IntermediateSecuritiesDistributionTypeFormat18Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat18Choice obj, IntermediateSecurityDistributionType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat18Choice, GenericIdentification47> mmProprietary = new MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat18Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat18Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification47 getValue(IntermediateSecuritiesDistributionTypeFormat18Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat18Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat18Choice.mmCode,
						com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat18Choice.mmProprietary);
				trace_lazy = () -> SecuritiesProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "IntermediateSecuritiesDistributionTypeFormat18Choice";
	...
	public IntermediateSecuritiesDistributionTypeFormat18Choice setCode(IntermediateSecurityDistributionType5Code code) {
	...
	public IntermediateSecuritiesDistributionTypeFormat18Choice setProprietary(GenericIdentification47 proprietary) {
