...
import com.tools20022.repository.codeset.CorporateActionFrequencyType5Code;
...
@XmlType(name = "DividendTypeFormat10Choice", propOrder = {"code", "proprietary"})
public class DividendTypeFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DividendTypeFormat10Choice.mmCode, com.tools20022.repository.choice.DividendTypeFormat10Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DividendTypeFormat10Choice";
	...
	public DividendTypeFormat10Choice setCode(CorporateActionFrequencyType5Code code) {
	...
	public DividendTypeFormat10Choice setProprietary(GenericIdentification47 proprietary) {
