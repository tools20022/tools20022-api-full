 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.AcceptedReason7Choice#Code
 * AcceptedReason7Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.AcceptedReason7Choice#Proprietary
 * AcceptedReason7Choice.Proprietary}</li>
 * </ul>
 * </li>
...
public class AcceptedReason7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedReason7Choice.Code, com.tools20022.repository.choice.AcceptedReason7Choice.Proprietary);
