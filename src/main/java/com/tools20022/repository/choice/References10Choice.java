...
public class References10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References10Choice.mmAccountServicerTransactionIdentification, References10Choice.mmAccountOwnerTransactionIdentification,
						References10Choice.mmMarketInfrastructureTransactionIdentification, References10Choice.mmPoolIdentification, References10Choice.mmCommonIdentification, References10Choice.mmTradeIdentification);
