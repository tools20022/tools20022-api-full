...
@XmlType(name = "Reason13Choice", propOrder = {"repoCallAcknowledgementReason", "cancellationReason", "pendingCancellationReason", "generatedReason", "deniedReason", "acknowledgedAcceptedReason", "pendingReason", "failingReason",
...
public class Reason13Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Reason13Choice.mmRepoCallAcknowledgementReason, Reason13Choice.mmCancellationReason, Reason13Choice.mmPendingCancellationReason, Reason13Choice.mmGeneratedReason,
						Reason13Choice.mmDeniedReason, Reason13Choice.mmAcknowledgedAcceptedReason, Reason13Choice.mmPendingReason, Reason13Choice.mmFailingReason, Reason13Choice.mmPendingProcessingReason, Reason13Choice.mmRejectionReason,
						Reason13Choice.mmRepairReason, Reason13Choice.mmPendingModificationReason, Reason13Choice.mmUnmatchedReason);
