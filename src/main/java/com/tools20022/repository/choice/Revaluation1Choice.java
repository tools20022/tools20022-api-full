...
@XmlType(name = "Revaluation1Choice", propOrder = {"indicator", "proprietary"})
public class Revaluation1Choice {
	...
	public Revaluation1Choice setIndicator(YesNoIndicator indicator) {
	...
	public Revaluation1Choice setProprietary(GenericIdentification13 proprietary) {
