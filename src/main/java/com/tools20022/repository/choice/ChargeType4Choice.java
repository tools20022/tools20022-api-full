 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ChargeType4Choice#mmCode
...
@XmlType(name = "ChargeType4Choice", propOrder = {"code", "proprietary"})
public class ChargeType4Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ChargeType12Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ChargeType4Choice.mmCode, com.tools20022.repository.choice.ChargeType4Choice.mmProprietary);
	...
	public ChargeType12Code getCode() {
		return code;
	}

	public ChargeType4Choice setCode(ChargeType12Code code) {
	...
	public ChargeType4Choice setProprietary(GenericIdentification47 proprietary) {
