...
public class OptionFeaturesFormat11Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OptionFeaturesFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionFeaturesFormat11Choice.mmCode, OptionFeaturesFormat11Choice.mmProprietary);
