...
public class TransactionCriteriaDefinition3Choice {
	...
	public static final MMMessageAttribute mmQueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TransactionCriteriaDefinition3Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionCriteriaDefinition3Choice.mmQueryName, TransactionCriteriaDefinition3Choice.mmNewCriteria);
	...
	public void setNewCriteria(TransactionCriteria3 newCriteria) {
