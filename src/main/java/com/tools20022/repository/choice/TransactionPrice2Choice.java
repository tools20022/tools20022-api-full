...
@XmlType(name = "TransactionPrice2Choice", propOrder = {"dealPrice", "proprietary"})
public class TransactionPrice2Choice {
	...
	public TransactionPrice2Choice setDealPrice(ActiveOrHistoricCurrencyAndAmount dealPrice) {
	...
	public TransactionPrice2Choice setProprietary(List<ProprietaryPrice2> proprietary) {
