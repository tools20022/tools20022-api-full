...
public class SettlementTransactionCondition26Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTransactionCondition26Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTransactionCondition26Choice.mmCode, SettlementTransactionCondition26Choice.mmProprietary);
	...
	public void setCode(SettlementTransactionCondition4Code code) {
		this.code = code;
	}
