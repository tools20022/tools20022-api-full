...
public class ProcessingStatus26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus26Choice.mmPendingCancellation, ProcessingStatus26Choice.mmRejected, ProcessingStatus26Choice.mmRepair, ProcessingStatus26Choice.mmAcknowledgedAccepted,
						ProcessingStatus26Choice.mmProprietary, ProcessingStatus26Choice.mmDenied, ProcessingStatus26Choice.mmCancelled);
