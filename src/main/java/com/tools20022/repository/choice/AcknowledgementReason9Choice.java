...
@XmlType(name = "AcknowledgementReason9Choice", propOrder = {"code", "proprietary"})
public class AcknowledgementReason9Choice {
	...
	public static final MMMessageAttribute<AcknowledgementReason9Choice, AcknowledgementReason6Code> mmCode = new MMMessageAttribute<AcknowledgementReason9Choice, AcknowledgementReason6Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason14Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AcknowledgementReason9Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<AcknowledgementReason9Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Specifies additional information about the processed instruction.";
			nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason14Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgementReason9Choice.mmCode, com.tools20022.repository.choice.AcknowledgementReason9Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgementReason9Choice";
				definition = "Choice of format for the acknowledgement reason.";
				nextVersions_lazy = () -> Arrays.asList(AcknowledgementReason14Choice.mmObject());
			}
		});
	...
	public AcknowledgementReason9Choice setCode(AcknowledgementReason6Code code) {
	...
	public AcknowledgementReason9Choice setProprietary(GenericIdentification20 proprietary) {
