 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TimeUnit2Choice#Code
 * TimeUnit2Choice.Code}</li>
 * <li>{@linkplain com.tools20022.repository.choice.TimeUnit2Choice#Proprietary
 * TimeUnit2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class TimeUnit2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TimeUnit2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TimeUnit2Choice.Code, com.tools20022.repository.choice.TimeUnit2Choice.Proprietary);
