 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNarrativeDescriptionRule#forBeneficiaryCertificationType3Choice
 * ConstraintNarrativeDescriptionRule.forBeneficiaryCertificationType3Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "BeneficiaryCertificationType3Choice", propOrder = {"code", "proprietary"})
public class BeneficiaryCertificationType3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BeneficiaryCertificationType3Choice, BeneficiaryCertificationType2Code> mmCode = new MMMessageAttribute<BeneficiaryCertificationType3Choice, BeneficiaryCertificationType2Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public BeneficiaryCertificationType2Code getValue(BeneficiaryCertificationType3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BeneficiaryCertificationType3Choice obj, BeneficiaryCertificationType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BeneficiaryCertificationType3Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<BeneficiaryCertificationType3Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType3Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(BeneficiaryCertificationType3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BeneficiaryCertificationType3Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficiaryCertificationType3Choice.mmCode, com.tools20022.repository.choice.BeneficiaryCertificationType3Choice.mmProprietary);
				trace_lazy = () -> BeneficialOwner.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNarrativeDescriptionRule.forBeneficiaryCertificationType3Choice);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BeneficiaryCertificationType3Choice";
	...
	public BeneficiaryCertificationType3Choice setCode(BeneficiaryCertificationType2Code code) {
	...
	public BeneficiaryCertificationType3Choice setProprietary(GenericIdentification25 proprietary) {
