...
public class BeneficiaryCertificationType3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> BeneficiaryCertificationType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(BeneficiaryCertificationType3Choice.mmCode, BeneficiaryCertificationType3Choice.mmProprietary);
	...
	public void setCode(BeneficiaryCertificationType2Code code) {
		this.code = code;
	}
