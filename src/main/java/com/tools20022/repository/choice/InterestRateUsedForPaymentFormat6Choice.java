...
public class InterestRateUsedForPaymentFormat6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat6Choice.mmRate, InterestRateUsedForPaymentFormat6Choice.mmAmount, InterestRateUsedForPaymentFormat6Choice.mmRateTypeAndAmountAndRateStatus,
						InterestRateUsedForPaymentFormat6Choice.mmNotSpecifiedRate);
