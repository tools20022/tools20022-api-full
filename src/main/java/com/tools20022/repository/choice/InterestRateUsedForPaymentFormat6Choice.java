...
public class InterestRateUsedForPaymentFormat6Choice {
	...
	public static final MMMessageAttribute mmRate = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InterestRateUsedForPaymentFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus7 rateTypeAndAmountAndRateStatus) {
