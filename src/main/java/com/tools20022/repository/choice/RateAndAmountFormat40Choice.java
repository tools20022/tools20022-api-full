...
@XmlType(name = "RateAndAmountFormat40Choice", propOrder = {"rate", "amount", "rateTypeAndRate"})
public class RateAndAmountFormat40Choice {
	...
	public RateAndAmountFormat40Choice setRate(PercentageRate rate) {
	...
	public RateAndAmountFormat40Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateAndAmountFormat40Choice setRateTypeAndRate(RateTypeAndPercentageRate8 rateTypeAndRate) {
