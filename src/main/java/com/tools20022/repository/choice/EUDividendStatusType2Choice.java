...
public class EUDividendStatusType2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "EU dividend status expressed as a code.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.EUDividendStatusType1Choice.EUDividendStatus;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "EU dividend status expressed as a proprietary code.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.EUDividendStatusType1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.EUDividendStatusType2Choice.Code, com.tools20022.repository.choice.EUDividendStatusType2Choice.Proprietary);
				...
				previousVersion_lazy = () -> EUDividendStatusType1Choice.mmObject();
			}
		});
