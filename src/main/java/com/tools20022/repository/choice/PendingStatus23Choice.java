...
public class PendingStatus23Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus23Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus23Choice.mmNoSpecifiedReason, PendingStatus23Choice.mmReason);
	...
	public void setReason(List<PendingReason13> reason) {
		this.reason = reason;
	}
}