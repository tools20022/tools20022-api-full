...
public class RiskLevel2Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.RiskLevel1Choice#Code
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RiskLevel1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RiskLevel1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RiskLevel2Choice.Code, com.tools20022.repository.choice.RiskLevel2Choice.Proprietary);
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "RiskLevel2Choice";
				definition = "Choice of formats for the specification of the risk level.";
				previousVersion_lazy = () -> RiskLevel1Choice.mmObject();
			}
		});
