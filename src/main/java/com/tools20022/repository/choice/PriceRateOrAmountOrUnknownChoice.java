 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceRateOrAmountOrUnknownChoice#UnknownIndicator
 * PriceRateOrAmountOrUnknownChoice.UnknownIndicator}</li>
 * </ul>
 * </li>
...
public class PriceRateOrAmountOrUnknownChoice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute UnknownIndicator = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PriceRateOrAmountOrUnknownChoice.mmObject();
			isDerived = false;
			xmlTag = "UknwnInd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceRateOrAmountOrUnknownChoice.Rate, com.tools20022.repository.choice.PriceRateOrAmountOrUnknownChoice.Amount,
						com.tools20022.repository.choice.PriceRateOrAmountOrUnknownChoice.UnknownIndicator);
