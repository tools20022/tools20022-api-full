 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Registration3Choice#mmCode
...
@XmlType(name = "Registration3Choice", propOrder = {"code", "proprietary"})
public class Registration3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Registration3Choice, Registration2Code> mmCode = new MMMessageAttribute<Registration3Choice, Registration2Code>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public Registration2Code getValue(Registration3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Registration3Choice obj, Registration2Code value) {
			obj.setCode(value);
		}
	};
	@XmlElement(name = "Prtry", required = true)
	protected GenericIdentification19 proprietary;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Registration3Choice, GenericIdentification19> mmProprietary = new MMMessageAssociationEnd<Registration3Choice, GenericIdentification19>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration3Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification19 getValue(Registration3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Registration3Choice obj, GenericIdentification19 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Registration3Choice.mmCode, com.tools20022.repository.choice.Registration3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Registration3Choice";
				definition = "Choice of format for the registration information.";
				nextVersions_lazy = () -> Arrays.asList(Registration7Choice.mmObject());
			}
		});
	...
	public Registration3Choice setCode(Registration2Code code) {
		this.code = Objects.requireNonNull(code);
		return this;
	}

	public GenericIdentification19 getProprietary() {
		return proprietary;
	}

	public Registration3Choice setProprietary(GenericIdentification19 proprietary) {
