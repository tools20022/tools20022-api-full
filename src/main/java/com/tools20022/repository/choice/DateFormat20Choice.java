 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat20Choice#Date
 ...
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat20Choice#DateCode
...
public class DateFormat20Choice {
	...
	public static final MMMessageAssociationEnd Date = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat32Choice.Date);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DateCodeAndTime = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat32Choice.DateCodeAndTime);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.DateFormat32Choice#DateCode
	...
	public static final MMMessageAssociationEnd DateCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat32Choice.DateCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat20Choice.Date, com.tools20022.repository.choice.DateFormat20Choice.DateCodeAndTime,
						com.tools20022.repository.choice.DateFormat20Choice.DateCode);
