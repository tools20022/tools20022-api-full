...
@XmlType(name = "AcceptedReason2Choice", propOrder = {"code", "proprietary"})
public class AcceptedReason2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedReason2Choice, AcknowledgementReason4Code> mmCode = new MMMessageAttribute<AcceptedReason2Choice, AcknowledgementReason4Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcceptedReason2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public AcknowledgementReason4Code getValue(AcceptedReason2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AcceptedReason2Choice obj, AcknowledgementReason4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AcceptedReason2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<AcceptedReason2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcceptedReason2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(AcceptedReason2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AcceptedReason2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedReason2Choice.mmCode, com.tools20022.repository.choice.AcceptedReason2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptedReason2Choice";
	...
	public AcceptedReason2Choice setCode(AcknowledgementReason4Code code) {
	...
	public AcceptedReason2Choice setProprietary(GenericIdentification25 proprietary) {
