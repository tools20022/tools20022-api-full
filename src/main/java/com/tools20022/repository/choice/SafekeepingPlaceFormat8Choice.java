...
@XmlType(name = "SafekeepingPlaceFormat8Choice", propOrder = {"identification", "country", "typeAndIdentification", "proprietary"})
public class SafekeepingPlaceFormat8Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Id", required = true)
	protected SafekeepingPlaceTypeAndText6 identification;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, SafekeepingPlaceTypeAndText6> mmIdentification = new MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, SafekeepingPlaceTypeAndText6>() {
		{
			...
			previousVersion_lazy = () -> SafekeepingPlaceFormat2Choice.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute<SafekeepingPlaceFormat8Choice, CountryCode> mmCountry = new MMMessageAttribute<SafekeepingPlaceFormat8Choice, CountryCode>() {
		{
			...
			previousVersion_lazy = () -> SafekeepingPlaceFormat2Choice.mmCountry;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, SafekeepingPlaceTypeAndAnyBICIdentifier1> mmTypeAndIdentification = new MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, SafekeepingPlaceTypeAndAnyBICIdentifier1>() {
		{
			...
			previousVersion_lazy = () -> SafekeepingPlaceFormat2Choice.mmTypeAndIdentification;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, GenericIdentification78> mmProprietary = new MMMessageAssociationEnd<SafekeepingPlaceFormat8Choice, GenericIdentification78>() {
		{
			...
			previousVersion_lazy = () -> SafekeepingPlaceFormat2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SafekeepingPlaceFormat8Choice.mmIdentification, com.tools20022.repository.choice.SafekeepingPlaceFormat8Choice.mmCountry,
						com.tools20022.repository.choice.SafekeepingPlaceFormat8Choice.mmTypeAndIdentification, com.tools20022.repository.choice.SafekeepingPlaceFormat8Choice.mmProprietary);
	...
	public SafekeepingPlaceTypeAndText6 getIdentification() {
		return identification;
	}

	public SafekeepingPlaceFormat8Choice setIdentification(SafekeepingPlaceTypeAndText6 identification) {
	...
	public SafekeepingPlaceFormat8Choice setCountry(CountryCode country) {
	...
	public SafekeepingPlaceFormat8Choice setTypeAndIdentification(SafekeepingPlaceTypeAndAnyBICIdentifier1 typeAndIdentification) {
	...
	public SafekeepingPlaceFormat8Choice setProprietary(GenericIdentification78 proprietary) {
