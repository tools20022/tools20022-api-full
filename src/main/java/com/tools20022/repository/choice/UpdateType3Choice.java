 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UpdateType3Choice#Code
 * UpdateType3Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.UpdateType3Choice#Proprietary
 * UpdateType3Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class UpdateType3Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> UpdateType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UpdateType3Choice.Code, com.tools20022.repository.choice.UpdateType3Choice.Proprietary);
