 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InformationTypeFormat3Choice#mmCode
 * InformationTypeFormat3Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InformationTypeFormat3Choice#mmProprietary
 * InformationTypeFormat3Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "InformationTypeFormat3Choice", propOrder = {"code", "proprietary"})
public class InformationTypeFormat3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InformationTypeFormat3Choice.mmCode, com.tools20022.repository.choice.InformationTypeFormat3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InformationTypeFormat3Choice";
	...
	public InformationTypeFormat3Choice setCode(CorporateActionInformationType1Code code) {
	...
	public InformationTypeFormat3Choice setProprietary(GenericIdentification51 proprietary) {
