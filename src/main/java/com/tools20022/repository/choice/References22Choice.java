 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forReferences22Choice
 * ConstraintCoexistenceIdentificationRule.forReferences22Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class References22Choice {
	...
	public static final MMMessageAssociationEnd<References22Choice, GenericDocumentIdentification1> mmOtherTransactionIdentification = new MMMessageAssociationEnd<References22Choice, GenericDocumentIdentification1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References44Choice.mmOtherTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<References22Choice, SettlementTypeAndIdentification13> mmSecuritiesFinancingTransactionIdentification = new MMMessageAssociationEnd<References22Choice, SettlementTypeAndIdentification13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References44Choice.mmSecuritiesFinancingTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<References22Choice, SettlementTypeAndIdentification13> mmSecuritiesSettlementTransactionIdentification = new MMMessageAssociationEnd<References22Choice, SettlementTypeAndIdentification13>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References44Choice.mmSecuritiesSettlementTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SettlementTypeAndIdentification13.mmObject();
	...
	public static final MMMessageAttribute<References22Choice, Max35Text> mmIntraPositionMovementIdentification = new MMMessageAttribute<References22Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References44Choice.mmIntraPositionMovementIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forReferences22Choice);
	...
	public References22Choice setOtherTransactionIdentification(GenericDocumentIdentification1 otherTransactionIdentification) {
	...
	public References22Choice setSecuritiesFinancingTransactionIdentification(SettlementTypeAndIdentification13 securitiesFinancingTransactionIdentification) {
	...
	public References22Choice setSecuritiesSettlementTransactionIdentification(SettlementTypeAndIdentification13 securitiesSettlementTransactionIdentification) {
	...
	public References22Choice setIntraPositionMovementIdentification(Max35Text intraPositionMovementIdentification) {
