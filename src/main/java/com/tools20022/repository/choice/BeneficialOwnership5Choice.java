...
public class BeneficialOwnership5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficialOwnership5Choice.Indicator, com.tools20022.repository.choice.BeneficialOwnership5Choice.Proprietary);
