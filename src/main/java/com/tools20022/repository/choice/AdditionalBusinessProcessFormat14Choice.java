...
public class AdditionalBusinessProcessFormat14Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AdditionalBusinessProcessFormat14Choice.Code, com.tools20022.repository.choice.AdditionalBusinessProcessFormat14Choice.Proprietary);
