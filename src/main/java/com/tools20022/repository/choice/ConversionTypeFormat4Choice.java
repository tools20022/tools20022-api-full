...
@XmlType(name = "ConversionTypeFormat4Choice", propOrder = {"code", "proprietary"})
public class ConversionTypeFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConversionTypeFormat4Choice.mmCode, com.tools20022.repository.choice.ConversionTypeFormat4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesConversion.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ConversionTypeFormat4Choice";
	...
	public ConversionTypeFormat4Choice setCode(ConversionType1Code code) {
	...
	public ConversionTypeFormat4Choice setProprietary(GenericIdentification47 proprietary) {
