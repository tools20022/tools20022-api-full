...
@XmlType(name = "DeliveryReturn1Choice", propOrder = {"code", "proprietary"})
public class DeliveryReturn1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliveryReturn3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeliveryReturn3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeliveryReturn1Choice.mmCode, com.tools20022.repository.choice.DeliveryReturn1Choice.mmProprietary);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeliveryReturn1Choice";
				definition = "Choice of format for the delivery return information.";
				nextVersions_lazy = () -> Arrays.asList(DeliveryReturn3Choice.mmObject());
			}
		});
	...
	public DeliveryReturn1Choice setCode(DeliveryReturn1Code code) {
	...
	public DeliveryReturn1Choice setProprietary(GenericIdentification20 proprietary) {
