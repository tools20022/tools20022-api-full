...
public class SecuritiesTransactionType15Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecuritiesTransactionType15Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTransactionType15Choice.mmCode, SecuritiesTransactionType15Choice.mmProprietary);
	...
	public void setCode(SecuritiesTransactionType10Code code) {
		this.code = code;
	}
