...
@XmlType(name = "RateStatus1Choice", propOrder = {"code", "proprietary"})
public class RateStatus1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateStatus1Choice, RateStatus1Code> mmCode = new MMMessageAttribute<RateStatus1Choice, RateStatus1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public RateStatus1Code getValue(RateStatus1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateStatus1Choice obj, RateStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateStatus1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RateStatus1Choice, GenericIdentification20>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
		...
		@Override
		public GenericIdentification20 getValue(RateStatus1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateStatus1Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintRateStatusGuideline.forRateStatus1Choice);
	...
	public RateStatus1Choice setCode(RateStatus1Code code) {
	...
	public RateStatus1Choice setProprietary(GenericIdentification20 proprietary) {
