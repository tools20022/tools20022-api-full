...
import com.tools20022.repository.codeset.SecurityStatus2Code;
...
@XmlType(name = "SecurityStatus3Choice", propOrder = {"code", "proprietary"})
public class SecurityStatus3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecurityStatus3Choice, SecurityStatus2Code> mmCode = new MMMessageAttribute<SecurityStatus3Choice, SecurityStatus2Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.SecurityStatus3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Security status expressed as an ISO 20022 code.";
			previousVersion_lazy = () -> SecurityStatus2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecurityStatus2Code getValue(SecurityStatus3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SecurityStatus3Choice obj, SecurityStatus2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SecurityStatus3Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<SecurityStatus3Choice, GenericIdentification30>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.SecurityStatus3Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			previousVersion_lazy = () -> SecurityStatus2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(SecurityStatus3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SecurityStatus3Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecurityStatus3Choice.mmCode, com.tools20022.repository.choice.SecurityStatus3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SecurityStatus3Choice";
				definition = "Choice of format for security status.";
				previousVersion_lazy = () -> SecurityStatus2Choice.mmObject();
			}
		});
	...
	public SecurityStatus3Choice setCode(SecurityStatus2Code code) {
	...
	public SecurityStatus3Choice setProprietary(GenericIdentification30 proprietary) {
