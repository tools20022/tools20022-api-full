...
@XmlType(name = "RepurchaseType3Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType3Choice, RepurchaseType3Code> mmCode = new MMMessageAttribute<RepurchaseType3Choice, RepurchaseType3Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType12Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RepurchaseType3Code getValue(RepurchaseType3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType3Choice obj, RepurchaseType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType3Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RepurchaseType3Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType3Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType12Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(RepurchaseType3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType3Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType3Choice.mmCode, com.tools20022.repository.choice.RepurchaseType3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType3Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				nextVersions_lazy = () -> Arrays.asList(RepurchaseType12Choice.mmObject());
			}
		});
	...
	public RepurchaseType3Choice setCode(RepurchaseType3Code code) {
	...
	public RepurchaseType3Choice setProprietary(GenericIdentification20 proprietary) {
