...
@XmlType(name = "CorporateActionEventStatus2FormatChoice", propOrder = {"code", "proprietary"})
public class CorporateActionEventStatus2FormatChoice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CorporateActionEventStatus2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventStatus2FormatChoice.mmCode, com.tools20022.repository.choice.CorporateActionEventStatus2FormatChoice.mmProprietary);
	...
	public CorporateActionEventStatus2Code getCode() {
		return code;
	}

	public CorporateActionEventStatus2FormatChoice setCode(CorporateActionEventStatus2Code code) {
	...
	public CorporateActionEventStatus2FormatChoice setProprietary(GenericIdentification13 proprietary) {
