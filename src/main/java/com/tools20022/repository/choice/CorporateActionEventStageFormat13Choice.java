...
@XmlType(name = "CorporateActionEventStageFormat13Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventStageFormat13Choice {
	...
	public static final MMMessageAttribute<CorporateActionEventStageFormat13Choice, CorporateActionEventStage3Code> mmCode = new MMMessageAttribute<CorporateActionEventStageFormat13Choice, CorporateActionEventStage3Code>() {
		{
			...
			previousVersion_lazy = () -> CorporateActionEventStageFormat5Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<CorporateActionEventStageFormat13Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<CorporateActionEventStageFormat13Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> CorporateActionEventStageFormat5Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventStageFormat13Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventStageFormat13Choice.mmProprietary);
	...
	public CorporateActionEventStageFormat13Choice setCode(CorporateActionEventStage3Code code) {
	...
	public CorporateActionEventStageFormat13Choice setProprietary(GenericIdentification30 proprietary) {
