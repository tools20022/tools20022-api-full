...
@XmlType(name = "RateType22Choice", propOrder = {"code", "proprietary"})
public class RateType22Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType22Choice, GrossDividendRateType3Code> mmCode = new MMMessageAttribute<RateType22Choice, GrossDividendRateType3Code>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of gross dividend rate.";
			nextVersions_lazy = () -> Arrays.asList(RateType40Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GrossDividendRateType3Code getValue(RateType22Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType22Choice obj, GrossDividendRateType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateType22Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RateType22Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType22Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RateType40Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RateType22Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType22Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType22Choice.mmCode, com.tools20022.repository.choice.RateType22Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType22Choice";
				definition = "Choice between a standard code or proprietary code to specify a rate type.";
				nextVersions_lazy = () -> Arrays.asList(RateType40Choice.mmObject());
				previousVersion_lazy = () -> RateType13Choice.mmObject();
			}
		});
	...
	public RateType22Choice setCode(GrossDividendRateType3Code code) {
	...
	public RateType22Choice setProprietary(GenericIdentification20 proprietary) {
