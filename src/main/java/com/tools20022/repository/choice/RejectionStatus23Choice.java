...
public class RejectionStatus23Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionStatus23Choice.NoSpecifiedReason, com.tools20022.repository.choice.RejectionStatus23Choice.Reason);
