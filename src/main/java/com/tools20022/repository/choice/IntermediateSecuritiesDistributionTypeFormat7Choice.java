...
@XmlType(name = "IntermediateSecuritiesDistributionTypeFormat7Choice", propOrder = {"code", "proprietary"})
public class IntermediateSecuritiesDistributionTypeFormat7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat7Choice, IntermediateSecurityDistributionType4Code> mmCode = new MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat7Choice, IntermediateSecurityDistributionType4Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public IntermediateSecurityDistributionType4Code getValue(IntermediateSecuritiesDistributionTypeFormat7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat7Choice obj, IntermediateSecurityDistributionType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat7Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat7Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat7Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(IntermediateSecuritiesDistributionTypeFormat7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat7Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat7Choice.mmCode,
						com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat7Choice.mmProprietary);
				...
				name = "IntermediateSecuritiesDistributionTypeFormat7Choice";
	...
	public IntermediateSecuritiesDistributionTypeFormat7Choice setCode(IntermediateSecurityDistributionType4Code code) {
	...
	public IntermediateSecuritiesDistributionTypeFormat7Choice setProprietary(GenericIdentification25 proprietary) {
