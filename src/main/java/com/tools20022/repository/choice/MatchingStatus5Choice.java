...
@XmlType(name = "MatchingStatus5Choice", propOrder = {"code", "proprietary"})
public class MatchingStatus5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MatchingStatus5Choice.mmCode, com.tools20022.repository.choice.MatchingStatus5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MatchingStatus5Choice";
	...
	public MatchingStatus5Choice setCode(MatchingStatus1Code code) {
	...
	public MatchingStatus5Choice setProprietary(GenericIdentification25 proprietary) {
