...
public class AcknowledgedAcceptedStatus1Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus1Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus1Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason1> reason) {
		this.reason = reason;
	}
}