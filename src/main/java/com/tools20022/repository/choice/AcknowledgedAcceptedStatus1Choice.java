...
public class AcknowledgedAcceptedStatus1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus1Choice.NoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus1Choice.Reason);
