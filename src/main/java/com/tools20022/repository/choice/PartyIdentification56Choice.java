...
public class PartyIdentification56Choice {
	...
	public static final MMMessageAttribute mmAnyBIC = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification56Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification56Choice.mmAnyBIC, PartyIdentification56Choice.mmProprietaryIdentification, PartyIdentification56Choice.mmNameAndAddress);
