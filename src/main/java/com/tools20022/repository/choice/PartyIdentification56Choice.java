...
public class PartyIdentification56Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification56Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification56Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification56Choice.NameAndAddress);
