...
import com.tools20022.repository.msg.RejectedStatusReason13;
...
@XmlType(name = "RejectedStatus13Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectedStatus13Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedStatus13Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectedStatus13Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectedStatus13Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatus19Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> RejectedStatus9Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NoReasonCode getValue(RejectedStatus13Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(RejectedStatus13Choice obj, NoReasonCode value) {
			obj.setNoSpecifiedReason(value);
		}
	};
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectedStatusReason13> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.RejectedStatusReason13
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectedStatus13Choice, List<RejectedStatusReason13>> mmReason = new MMMessageAssociationEnd<RejectedStatus13Choice, List<RejectedStatusReason13>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedStatus19Choice.mmReason);
			previousVersion_lazy = () -> RejectedStatus9Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectedStatusReason13.mmObject();
		}

		@Override
		public List<RejectedStatusReason13> getValue(RejectedStatus13Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(RejectedStatus13Choice obj, List<RejectedStatusReason13> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus13Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectedStatus13Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatus13Choice";
				definition = "Choice between a reason or no reason for the corporate action instruction processing rejected status.";
				nextVersions_lazy = () -> Arrays.asList(RejectedStatus19Choice.mmObject());
				previousVersion_lazy = () -> RejectedStatus9Choice.mmObject();
			}
		});
	...
	public RejectedStatus13Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectedStatusReason13> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectedStatus13Choice setReason(List<RejectedStatusReason13> reason) {
