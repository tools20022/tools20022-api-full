...
public class FinancialInstrumentQuantity19Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity19Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity19Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity19Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity19Choice.Code);
				...
				previousVersion_lazy = () -> FinancialInstrumentQuantity16Choice.mmObject();
			}
		});
