...
public class SecuritiesTransactionType18Choice {
	...
	public SecuritiesTransactionType18Choice setCode(SecuritiesTransactionType8Code code) {
	...
	public SecuritiesTransactionType18Choice setProprietary(GenericIdentification30 proprietary) {
