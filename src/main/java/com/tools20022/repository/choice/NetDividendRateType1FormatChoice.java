...
@XmlType(name = "NetDividendRateType1FormatChoice", propOrder = {"code", "proprietary"})
public class NetDividendRateType1FormatChoice {
	...
	public NetDividendRateType1FormatChoice setCode(NetDividendRateType1Code code) {
	...
	public NetDividendRateType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
