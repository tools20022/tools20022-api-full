...
import com.tools20022.repository.msg.RejectionReason9;
...
@XmlType(name = "InstructionProcessingReason1Choice", propOrder = {"reason", "noSpecifiedReason"})
public class InstructionProcessingReason1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectionReason9> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.RejectionReason9
	 * RejectionReason9}</li>
	 * <li>
	...
	public static final MMMessageAssociationEnd<InstructionProcessingReason1Choice, List<RejectionReason9>> mmReason = new MMMessageAssociationEnd<InstructionProcessingReason1Choice, List<RejectionReason9>>() {
		{
			...
			name = "Reason";
			definition = "Specifies the reason of the RejectedStatus.";
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingReason1Choice.mmReason, com.tools20022.repository.choice.InstructionProcessingReason1Choice.mmNoSpecifiedReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InstructionProcessingReason1Choice";
	...
	public List<RejectionReason9> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public InstructionProcessingReason1Choice setReason(List<RejectionReason9> reason) {
	...
	public InstructionProcessingReason1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
