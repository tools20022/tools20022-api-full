...
public class TEFRARules2Choice {
	 ...
	 * {@linkplain com.tools20022.repository.entity.SecuritiesTax#TEFRARule
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TEFRARules2Choice.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.SecuritiesTax.TEFRARule;
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TEFRARules2Choice.Code, com.tools20022.repository.choice.TEFRARules2Choice.Proprietary);
