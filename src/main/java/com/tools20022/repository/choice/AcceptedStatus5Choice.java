...
public class AcceptedStatus5Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcceptedStatus5Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatus5Choice.mmNoSpecifiedReason, AcceptedStatus5Choice.mmReason);
	...
	public void setReason(List<AcceptedStatusReason5> reason) {
		this.reason = reason;
	}
}