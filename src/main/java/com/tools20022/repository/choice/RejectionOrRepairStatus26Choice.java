...
import com.tools20022.repository.msg.RejectionOrRepairReason20;
...
@XmlType(name = "RejectionOrRepairStatus26Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionOrRepairStatus26Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionOrRepairStatus26Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectionOrRepairStatus26Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus26Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
		...
		@Override
		public NoReasonCode getValue(RejectionOrRepairStatus26Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(RejectionOrRepairStatus26Choice obj, NoReasonCode value) {
			obj.setNoSpecifiedReason(value);
		}
	};
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectionOrRepairReason20> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.msg.RejectionOrRepairReason20
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionOrRepairStatus26Choice, List<RejectionOrRepairReason20>> mmReason = new MMMessageAssociationEnd<RejectionOrRepairStatus26Choice, List<RejectionOrRepairReason20>>() {
		{
		...
		@Override
		public List<RejectionOrRepairReason20> getValue(RejectionOrRepairStatus26Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(RejectionOrRepairStatus26Choice obj, List<RejectionOrRepairReason20> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus26Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus26Choice.mmReason);
	...
	public RejectionOrRepairStatus26Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionOrRepairReason20> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionOrRepairStatus26Choice setReason(List<RejectionOrRepairReason20> reason) {
