...
public class RejectionOrRepairStatus26Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus26Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus26Choice.mmNoSpecifiedReason, RejectionOrRepairStatus26Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason20> reason) {
		this.reason = reason;
	}
}