...
public class RepoCallRequestStatus6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepoCallRequestStatus6Choice.AcknowledgedAccepted, com.tools20022.repository.choice.RepoCallRequestStatus6Choice.Denied,
						com.tools20022.repository.choice.RepoCallRequestStatus6Choice.Proprietary);
