...
public class RepoCallRequestStatus6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepoCallRequestStatus6Choice.mmAcknowledgedAccepted, RepoCallRequestStatus6Choice.mmDenied, RepoCallRequestStatus6Choice.mmProprietary);
