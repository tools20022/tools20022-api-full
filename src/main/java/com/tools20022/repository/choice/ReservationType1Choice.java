...
import com.tools20022.repository.codeset.ReservationType2Code;
...
@XmlType(name = "ReservationType1Choice", propOrder = {"code", "proprietary"})
public class ReservationType1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReservationType1Choice, ReservationType2Code> mmCode = new MMMessageAttribute<ReservationType1Choice, ReservationType2Code>() {
		{
			businessElementTrace_lazy = () -> Reservation.mmReservationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ReservationType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ReservationType2Code getValue(ReservationType1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ReservationType1Choice obj, ReservationType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ReservationType1Choice, Max35Text> mmProprietary = new MMMessageAttribute<ReservationType1Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Reservation.mmReservationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ReservationType1Choice.mmObject();
			isDerived = false;
		...
		@Override
		public Max35Text getValue(ReservationType1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ReservationType1Choice obj, Max35Text value) {
	...
	public ReservationType1Choice setCode(ReservationType2Code code) {
	...
	public ReservationType1Choice setProprietary(Max35Text proprietary) {
