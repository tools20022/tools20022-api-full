...
@XmlType(name = "AcceptedReason6Choice", propOrder = {"code", "proprietary"})
public class AcceptedReason6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedReason6Choice.mmCode, com.tools20022.repository.choice.AcceptedReason6Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptedReason6Choice";
	...
	public AcceptedReason6Choice setCode(AcknowledgementReason8Code code) {
	...
	public AcceptedReason6Choice setProprietary(GenericIdentification51 proprietary) {
