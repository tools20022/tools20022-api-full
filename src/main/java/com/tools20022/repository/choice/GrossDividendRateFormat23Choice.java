...
@XmlType(name = "GrossDividendRateFormat23Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus"})
public class GrossDividendRateFormat23Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat23Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<GrossDividendRateFormat23Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat23Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(GrossDividendRateFormat23Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(GrossDividendRateFormat23Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat23Choice, AmountAndRateStatus2> mmAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat23Choice, AmountAndRateStatus2>() {
		{
		...
		@Override
		public AmountAndRateStatus2 getValue(GrossDividendRateFormat23Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat23Choice obj, AmountAndRateStatus2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat23Choice, RateTypeAndAmountAndStatus30> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat23Choice, RateTypeAndAmountAndStatus30>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat23Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus30 getValue(GrossDividendRateFormat23Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat23Choice obj, RateTypeAndAmountAndStatus30 value) {
	...
	public GrossDividendRateFormat23Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat23Choice setAmountAndRateStatus(AmountAndRateStatus2 amountAndRateStatus) {
	...
	public GrossDividendRateFormat23Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus30 rateTypeAndAmountAndRateStatus) {
