...
public class Party29Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party29Choice.OrganisationIdentification, com.tools20022.repository.choice.Party29Choice.FinancialInstitutionIdentification);
