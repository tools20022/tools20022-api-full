...
public class Party32Choice {
	...
	public static final MMMessageAssociationEnd Organisation = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Party32Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Party31Choice.Organisation;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IndividualPerson = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Party31Choice.IndividualPerson;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party32Choice.Organisation, com.tools20022.repository.choice.Party32Choice.IndividualPerson);
