...
public class GeneratedStatus7Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.GeneratedStatus5Choice.NoSpecifiedReason;
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.GeneratedReason5
	 * GeneratedReason5}</li>
	 * <li>
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.GeneratedStatus5Choice.Reason;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GeneratedStatus7Choice.NoSpecifiedReason, com.tools20022.repository.choice.GeneratedStatus7Choice.Reason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "GeneratedStatus7Choice";
				definition = "Choice of generated status.";
				previousVersion_lazy = () -> GeneratedStatus5Choice.mmObject();
			}
		});
