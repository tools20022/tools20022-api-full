...
public class FinancialInstrumentQuantity21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity21Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity21Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity21Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity21Choice.Code);
