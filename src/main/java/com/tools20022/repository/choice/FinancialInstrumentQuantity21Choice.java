...
public class FinancialInstrumentQuantity21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity21Choice.mmUnit, FinancialInstrumentQuantity21Choice.mmFaceAmount, FinancialInstrumentQuantity21Choice.mmAmortisedValue,
						FinancialInstrumentQuantity21Choice.mmCode);
