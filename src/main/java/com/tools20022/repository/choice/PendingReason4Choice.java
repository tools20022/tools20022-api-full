 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PendingReason4Choice#mmCode
...
@XmlType(name = "PendingReason4Choice", propOrder = {"code", "proprietary"})
public class PendingReason4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason4Choice, PendingReason4Code> mmCode = new MMMessageAttribute<PendingReason4Choice, PendingReason4Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason32Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PendingReason4Code getValue(PendingReason4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason4Choice obj, PendingReason4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason4Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PendingReason4Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason4Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason32Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(PendingReason4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason4Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason4Choice.mmCode, com.tools20022.repository.choice.PendingReason4Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason4Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(PendingReason32Choice.mmObject());
			}
		});
	...
	public PendingReason4Choice setCode(PendingReason4Code code) {
	...
	public PendingReason4Choice setProprietary(GenericIdentification20 proprietary) {
