...
import com.tools20022.repository.msg.AcceptedStatusReason6;
...
@XmlType(name = "AcceptedStatus6Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcceptedStatus6Choice {
	...
	protected List<AcceptedStatusReason6> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.AcceptedStatusReason6
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedStatus6Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcceptedStatus6Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptedStatus6Choice";
	...
	public AcceptedStatus6Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<AcceptedStatusReason6> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public AcceptedStatus6Choice setReason(List<AcceptedStatusReason6> reason) {
