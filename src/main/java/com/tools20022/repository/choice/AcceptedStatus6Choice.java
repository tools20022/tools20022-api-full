...
public class AcceptedStatus6Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcceptedStatus6Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatus6Choice.mmNoSpecifiedReason, AcceptedStatus6Choice.mmReason);
	...
	public void setReason(List<AcceptedStatusReason6> reason) {
		this.reason = reason;
	}
}