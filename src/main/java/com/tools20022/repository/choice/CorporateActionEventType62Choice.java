...
public class CorporateActionEventType62Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType62Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType62Choice.mmCode, CorporateActionEventType62Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType21Code code) {
		this.code = code;
	}
