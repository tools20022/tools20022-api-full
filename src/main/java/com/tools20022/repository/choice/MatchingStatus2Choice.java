...
@XmlType(name = "MatchingStatus2Choice", propOrder = {"matched", "unmatched", "proprietary"})
public class MatchingStatus2Choice {
	...
	protected UnmatchedStatus1Choice unmatched;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public MatchingStatus2Choice setMatched(NoSpecifiedReason1 matched) {
		this.matched = Objects.requireNonNull(matched);
		return this;
	}

	public UnmatchedStatus1Choice getUnmatched() {
		return unmatched;
	}
	...
	public MatchingStatus2Choice setProprietary(ProprietaryStatusAndReason1 proprietary) {
