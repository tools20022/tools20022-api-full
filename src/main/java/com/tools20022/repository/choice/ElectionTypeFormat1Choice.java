...
import com.tools20022.repository.codeset.ElectionMovementType2Code;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ElectionTypeFormat3Choice
...
@XmlType(name = "ElectionTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class ElectionTypeFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ElectionTypeFormat1Choice, ElectionMovementType2Code> mmCode = new MMMessageAttribute<ElectionTypeFormat1Choice, ElectionMovementType2Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionElection.mmElectionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ElectionTypeFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the effect on the holdings of electing a corporate action option.";
			nextVersions_lazy = () -> Arrays.asList(ElectionTypeFormat3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ElectionMovementType2Code getValue(ElectionTypeFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ElectionTypeFormat1Choice obj, ElectionMovementType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ElectionTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<ElectionTypeFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionElection.mmElectionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ElectionTypeFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(ElectionTypeFormat3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(ElectionTypeFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ElectionTypeFormat1Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(ElectionTypeFormat3Choice.mmObject());
			}
		});
	...
	public ElectionTypeFormat1Choice setCode(ElectionMovementType2Code code) {
	...
	public ElectionTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
