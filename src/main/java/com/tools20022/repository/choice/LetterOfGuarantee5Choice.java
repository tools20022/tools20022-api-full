...
public class LetterOfGuarantee5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LetterOfGuarantee5Choice.Indicator, com.tools20022.repository.choice.LetterOfGuarantee5Choice.Proprietary);
