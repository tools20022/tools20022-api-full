...
public class LetterOfGuarantee5Choice {
	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> LetterOfGuarantee5Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(LetterOfGuarantee5Choice.mmIndicator, LetterOfGuarantee5Choice.mmProprietary);
