...
@XmlType(name = "LetterOfGuarantee5Choice", propOrder = {"indicator", "proprietary"})
public class LetterOfGuarantee5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LetterOfGuarantee5Choice.mmIndicator, com.tools20022.repository.choice.LetterOfGuarantee5Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "LetterOfGuarantee5Choice";
	...
	public LetterOfGuarantee5Choice setIndicator(YesNoIndicator indicator) {
	...
	public LetterOfGuarantee5Choice setProprietary(GenericIdentification47 proprietary) {
