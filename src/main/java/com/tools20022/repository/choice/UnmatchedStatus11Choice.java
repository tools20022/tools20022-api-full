...
public class UnmatchedStatus11Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus11Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus11Choice.mmNoSpecifiedReason, UnmatchedStatus11Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason10> reason) {
		this.reason = reason;
	}
}