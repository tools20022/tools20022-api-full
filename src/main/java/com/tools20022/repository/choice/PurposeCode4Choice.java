 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PurposeCode4Choice#mmCode
...
@XmlType(name = "PurposeCode4Choice", propOrder = {"code", "proprietary"})
public class PurposeCode4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PurposeCode4Choice
	 * PurposeCode4Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PurposeCode4Choice.mmCode, com.tools20022.repository.choice.PurposeCode4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PurposeCode4Choice";
	...
	public PurposeCode4Choice setCode(SecuritiesAccountPurposeType1Code code) {
	...
	public PurposeCode4Choice setProprietary(GenericIdentification25 proprietary) {
