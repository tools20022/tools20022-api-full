...
import com.tools20022.repository.codeset.RepurchaseType6Code;
...
@XmlType(name = "RepurchaseType8Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType8Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RepurchaseType6Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType8Choice, RepurchaseType6Code> mmCode = new MMMessageAttribute<RepurchaseType8Choice, RepurchaseType6Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType13Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> RepurchaseType6Code.mmObject();
		}

		@Override
		public RepurchaseType6Code getValue(RepurchaseType8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType8Choice obj, RepurchaseType6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RepurchaseType8Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RepurchaseType8Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType8Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType13Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(RepurchaseType8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType8Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType8Choice.mmCode, com.tools20022.repository.choice.RepurchaseType8Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType8Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				nextVersions_lazy = () -> Arrays.asList(RepurchaseType13Choice.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public RepurchaseType6Code getCode() {
		return code;
	}

	public RepurchaseType8Choice setCode(RepurchaseType6Code code) {
	...
	public RepurchaseType8Choice setProprietary(GenericIdentification20 proprietary) {
