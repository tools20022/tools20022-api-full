...
@XmlType(name = "LinkageType4Choice", propOrder = {"code", "proprietary"})
public class LinkageType4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.LinkageType4Choice
	 * LinkageType4Choice}</li>
	...
	public LinkageType4Choice setCode(LinkageType1Code code) {
	...
	public LinkageType4Choice setProprietary(GenericIdentification47 proprietary) {
