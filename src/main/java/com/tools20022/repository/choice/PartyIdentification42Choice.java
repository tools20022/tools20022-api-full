...
public class PartyIdentification42Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification42Choice.mmBICFI, PartyIdentification42Choice.mmNameAndAddress, PartyIdentification42Choice.mmProprietaryIdentification);
