...
public class PartyIdentification54Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification54Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification54Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification54Choice.NameAndAddress);
