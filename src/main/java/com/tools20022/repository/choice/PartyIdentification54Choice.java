...
public class PartyIdentification54Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification54Choice.mmAnyBIC, PartyIdentification54Choice.mmProprietaryIdentification, PartyIdentification54Choice.mmNameAndAddress);
