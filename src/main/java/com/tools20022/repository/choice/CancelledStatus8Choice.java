...
public class CancelledStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus8Choice.mmNoSpecifiedReason, CancelledStatus8Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason9> reason) {
		this.reason = reason;
	}
}