...
public class SettlementDate15Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDate15Choice.mmDate, SettlementDate15Choice.mmDateCode);
	...
	public void setDateCode(com.tools20022.repository.choice.SettlementDateCode11Choice dateCode) {
