 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettlementDate15Choice#Date
 * SettlementDate15Choice.Date}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementDate15Choice#DateCode
 * SettlementDate15Choice.DateCode}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlementDate15Choice {
	...
	public static final MMMessageAttribute Date = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlementDate15Choice.mmObject();
			isDerived = false;
			xmlTag = "Dt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate15Choice.Date, com.tools20022.repository.choice.SettlementDate15Choice.DateCode);
