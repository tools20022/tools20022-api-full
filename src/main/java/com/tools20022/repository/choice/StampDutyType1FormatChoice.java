...
public class StampDutyType1FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StampDutyType1FormatChoice.mmCode, com.tools20022.repository.choice.StampDutyType1FormatChoice.mmProprietary);
	...
	public StampDutyType1FormatChoice setCode(StampDutyType1Code code) {
	...
	public StampDutyType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
