...
@XmlType(name = "BeneficiaryCertificationType8Choice", propOrder = {"code", "proprietary"})
public class BeneficiaryCertificationType8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BeneficiaryCertificationType8Choice, BeneficiaryCertificationType5Code> mmCode = new MMMessageAttribute<BeneficiaryCertificationType8Choice, BeneficiaryCertificationType5Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public BeneficiaryCertificationType5Code getValue(BeneficiaryCertificationType8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BeneficiaryCertificationType8Choice obj, BeneficiaryCertificationType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BeneficiaryCertificationType8Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<BeneficiaryCertificationType8Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType8Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(BeneficiaryCertificationType8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BeneficiaryCertificationType8Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficiaryCertificationType8Choice.mmCode, com.tools20022.repository.choice.BeneficiaryCertificationType8Choice.mmProprietary);
				trace_lazy = () -> BeneficialOwner.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BeneficiaryCertificationType8Choice";
	...
	public BeneficiaryCertificationType8Choice setCode(BeneficiaryCertificationType5Code code) {
	...
	public BeneficiaryCertificationType8Choice setProprietary(GenericIdentification25 proprietary) {
