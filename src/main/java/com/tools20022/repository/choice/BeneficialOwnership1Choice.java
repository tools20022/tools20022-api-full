...
@XmlType(name = "BeneficialOwnership1Choice", propOrder = {"indicator", "proprietary"})
public class BeneficialOwnership1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficialOwnership1Choice.mmIndicator, com.tools20022.repository.choice.BeneficialOwnership1Choice.mmProprietary);
	...
	public BeneficialOwnership1Choice setIndicator(YesNoIndicator indicator) {
	...
	public BeneficialOwnership1Choice setProprietary(GenericIdentification20 proprietary) {
