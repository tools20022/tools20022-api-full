...
@XmlType(name = "UnitOrFaceAmountChoice", propOrder = {"unit", "faceAmount"})
public class UnitOrFaceAmountChoice {
	...
	public UnitOrFaceAmountChoice setUnit(DecimalNumber unit) {
	...
	public UnitOrFaceAmountChoice setFaceAmount(CurrencyAndAmount faceAmount) {
