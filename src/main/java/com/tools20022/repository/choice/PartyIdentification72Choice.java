...
public class PartyIdentification72Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification72Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification72Choice.ProprietaryIdentification);
