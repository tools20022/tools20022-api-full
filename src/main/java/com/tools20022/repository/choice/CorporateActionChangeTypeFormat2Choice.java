...
import com.tools20022.repository.codeset.CorporateActionChangeType2Code;
...
/**
 * Choice between a standard code or a proprietary code to specify a type of
 * change.
 * <p>
...
@XmlType(name = "CorporateActionChangeTypeFormat2Choice", propOrder = {"code", "proprietary"})
public class CorporateActionChangeTypeFormat2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CorporateActionChangeType2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<CorporateActionChangeTypeFormat2Choice, CorporateActionChangeType2Code> mmCode = new MMMessageAttribute<CorporateActionChangeTypeFormat2Choice, CorporateActionChangeType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionChangeTypeFormat6Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<CorporateActionChangeTypeFormat2Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CorporateActionChangeTypeFormat2Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionChangeTypeFormat6Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionChangeTypeFormat2Choice.mmCode, com.tools20022.repository.choice.CorporateActionChangeTypeFormat2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesModification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionChangeTypeFormat2Choice";
				definition = "Choice between a standard code or a proprietary code to specify a type of change.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionChangeTypeFormat6Choice.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public CorporateActionChangeType2Code getCode() {
		return code;
	}

	public CorporateActionChangeTypeFormat2Choice setCode(CorporateActionChangeType2Code code) {
	...
	public CorporateActionChangeTypeFormat2Choice setProprietary(GenericIdentification20 proprietary) {
