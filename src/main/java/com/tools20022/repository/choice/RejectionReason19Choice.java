...
public class RejectionReason19Choice {
	...
	/**
	 * Specifies the reason why the instruction/request has a rejection status
	 * using a code.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionReason19Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason19Choice.mmCode, RejectionReason19Choice.mmProprietary);
	...
	public void setCode(RejectionReason40Code code) {
		this.code = code;
	}
