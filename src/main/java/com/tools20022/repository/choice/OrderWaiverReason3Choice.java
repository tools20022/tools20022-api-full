...
public class OrderWaiverReason3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OrderWaiverReason1Choice.mmReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> OrderWaiverReason1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OrderWaiverReason3Choice.mmCode, OrderWaiverReason3Choice.mmProprietary);
				trace_lazy = () -> InvestmentFundOrder.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OrderWaiverReason3Choice";
				definition = "Choice of formats for an order waiver reason.";
				previousVersion_lazy = () -> OrderWaiverReason1Choice.mmObject();
			}
		});
