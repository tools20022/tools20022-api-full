 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat31Choice#mmRateTypeAndAmountAndRateStatus
 * NetDividendRateFormat31Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat31Choice#mmNotSpecifiedRate
 * NetDividendRateFormat31Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "NetDividendRateFormat31Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class NetDividendRateFormat31Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> NetDividendRateFormat22Choice.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmAmountAndRateStatus = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> NetDividendRateFormat22Choice.mmAmountAndRateStatus;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat22Choice#mmRateTypeAndAmountAndRateStatus
	...
	public static final MMMessageAssociationEnd mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> NetDividendRateFormat22Choice.mmRateTypeAndAmountAndRateStatus;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat22Choice#mmNotSpecifiedRate
	...
	public static final MMMessageAttribute mmNotSpecifiedRate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> NetDividendRateFormat22Choice.mmNotSpecifiedRate;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat31Choice.mmAmount, com.tools20022.repository.choice.NetDividendRateFormat31Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.NetDividendRateFormat31Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.NetDividendRateFormat31Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NetDividendRateFormat31Choice";
				definition = "Choice between an amount or an unspecified rate.";
				previousVersion_lazy = () -> NetDividendRateFormat22Choice.mmObject();
			}
		});
	...
	public NetDividendRateFormat31Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat31Choice setAmountAndRateStatus(AmountAndRateStatus1 amountAndRateStatus) {
	...
	public NetDividendRateFormat31Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus41 rateTypeAndAmountAndRateStatus) {
	...
	public NetDividendRateFormat31Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
