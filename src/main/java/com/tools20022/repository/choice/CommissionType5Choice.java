 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CommissionType5Choice#mmCode
 * CommissionType5Choice.mmCode}</li>
 * <li>
...
@XmlType(name = "CommissionType5Choice", propOrder = {"code", "proprietary"})
public class CommissionType5Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CommissionType6Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<CommissionType5Choice, CommissionType6Code> mmCode = new MMMessageAttribute<CommissionType5Choice, CommissionType6Code>() {
		{
			...
			name = "Code";
			definition = "Commission type expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<CommissionType5Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<CommissionType5Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Commission type expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CommissionType5Choice.mmCode, com.tools20022.repository.choice.CommissionType5Choice.mmProprietary);
				trace_lazy = () -> Commission.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CommissionType5Choice";
	...
	public CommissionType6Code getCode() {
		return code;
	}

	public CommissionType5Choice setCode(CommissionType6Code code) {
	...
	public CommissionType5Choice setProprietary(GenericIdentification47 proprietary) {
