 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.References58Choice#mmIntraPositionMovementIdentification
 * References58Choice.mmIntraPositionMovementIdentification}</li>
 * <li>
...
@XmlType(name = "References58Choice", propOrder = {"securitiesSettlementTransactionIdentification", "poolIdentification", "intraPositionMovementIdentification", "accountServicerTransactionIdentification", "otherTransactionIdentification"})
public class References58Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.References58Choice
	 * References58Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References58Choice, RestrictedFINXMax16Text> mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute<References58Choice, RestrictedFINXMax16Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmSecuritiesSettlement;
			componentContext_lazy = () -> com.tools20022.repository.choice.References58Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RestrictedFINXMax16Text getValue(References58Choice obj) {
			return obj.getSecuritiesSettlementTransactionIdentification();
		}

		@Override
		public void setValue(References58Choice obj, RestrictedFINXMax16Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References58Choice, RestrictedFINXMax16Text> mmPoolIdentification = new MMMessageAttribute<References58Choice, RestrictedFINXMax16Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References58Choice, RestrictedFINXMax16Text> mmIntraPositionMovementIdentification = new MMMessageAttribute<References58Choice, RestrictedFINXMax16Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.References58Choice.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References58Choice, RestrictedFINXMax16Text> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References58Choice, RestrictedFINXMax16Text>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References58Choice, RestrictedFINXMax16Text> mmOtherTransactionIdentification = new MMMessageAttribute<References58Choice, RestrictedFINXMax16Text>() {
		{
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References58Choice.mmSecuritiesSettlementTransactionIdentification, com.tools20022.repository.choice.References58Choice.mmPoolIdentification,
						com.tools20022.repository.choice.References58Choice.mmIntraPositionMovementIdentification, com.tools20022.repository.choice.References58Choice.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.choice.References58Choice.mmOtherTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "References58Choice";
	...
	public References58Choice setSecuritiesSettlementTransactionIdentification(RestrictedFINXMax16Text securitiesSettlementTransactionIdentification) {
	...
	public References58Choice setPoolIdentification(RestrictedFINXMax16Text poolIdentification) {
	...
	public References58Choice setIntraPositionMovementIdentification(RestrictedFINXMax16Text intraPositionMovementIdentification) {
	...
	public References58Choice setAccountServicerTransactionIdentification(RestrictedFINXMax16Text accountServicerTransactionIdentification) {
	...
	public References58Choice setOtherTransactionIdentification(RestrictedFINXMax16Text otherTransactionIdentification) {
