...
@XmlType(name = "SecuritiesPaymentStatus6Choice", propOrder = {"code", "proprietary"})
public class SecuritiesPaymentStatus6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesPaymentStatus6Choice.mmCode, com.tools20022.repository.choice.SecuritiesPaymentStatus6Choice.mmProprietary);
	...
	public SecuritiesPaymentStatus6Choice setCode(SecuritiesPaymentStatus1Code code) {
	...
	public SecuritiesPaymentStatus6Choice setProprietary(GenericIdentification47 proprietary) {
