...
public class AccountIdentification26Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification26Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification26Choice.mmForAllAccounts, AccountIdentification26Choice.mmAccountsListAndBalanceDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountAndBalance29> accountsListAndBalanceDetails) {
