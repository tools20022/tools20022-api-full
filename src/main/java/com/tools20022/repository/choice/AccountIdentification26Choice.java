...
public class AccountIdentification26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification26Choice.ForAllAccounts, com.tools20022.repository.choice.AccountIdentification26Choice.AccountsListAndBalanceDetails);
