 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriorityNumeric2Choice#Numeric
 * PriorityNumeric2Choice.Numeric}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriorityNumeric2Choice#Proprietary
 * PriorityNumeric2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class PriorityNumeric2Choice {
	...
	public static final MMMessageAttribute Numeric = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PriorityNumeric2Choice.mmObject();
			isDerived = false;
			xmlTag = "Nmrc";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriorityNumeric2Choice.Numeric, com.tools20022.repository.choice.PriorityNumeric2Choice.Proprietary);
