...
public class ProcessingStatus2Choice {
	...
	public static final MMMessageAssociationEnd PendingCancellation = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> ProcessingStatus2Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus2Choice.PendingCancellation, com.tools20022.repository.choice.ProcessingStatus2Choice.Rejected,
						com.tools20022.repository.choice.ProcessingStatus2Choice.Repair, com.tools20022.repository.choice.ProcessingStatus2Choice.AcknowledgedAccepted, com.tools20022.repository.choice.ProcessingStatus2Choice.Proprietary,
						com.tools20022.repository.choice.ProcessingStatus2Choice.Denied, com.tools20022.repository.choice.ProcessingStatus2Choice.Cancelled);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV01.ProcessingStatus);
