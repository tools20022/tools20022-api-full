 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionType8Choice#mmCode
...
@XmlType(name = "OptionType8Choice", propOrder = {"code", "proprietary"})
public class OptionType8Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd")
	protected List<OptionType1Code> code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionType8Choice, List<OptionType1Code>> mmCode = new MMMessageAttribute<OptionType8Choice, List<OptionType1Code>>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Option type expressed as an ISO 20022 code.";
			previousVersion_lazy = () -> OptionType5Choice.mmCode;
			minOccurs = 0;
			simpleType_lazy = () -> OptionType1Code.mmObject();
		}

		@Override
		public List<OptionType1Code> getValue(OptionType8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionType8Choice obj, List<OptionType1Code> value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionType8Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<OptionType8Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType8Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> OptionType5Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(OptionType8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionType8Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionType8Choice.mmCode, com.tools20022.repository.choice.OptionType8Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "OptionType8Choice";
				definition = "Choice of format for option type.";
				previousVersion_lazy = () -> OptionType5Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public List<OptionType1Code> getCode() {
		return code == null ? code = new ArrayList<>() : code;
	}

	public OptionType8Choice setCode(List<OptionType1Code> code) {
	...
	public OptionType8Choice setProprietary(GenericIdentification30 proprietary) {
