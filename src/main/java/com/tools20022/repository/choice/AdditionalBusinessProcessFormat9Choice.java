...
public class AdditionalBusinessProcessFormat9Choice {
	...
	/**
	 * Standard code to specify the additional business process linked to a
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalBusinessProcessFormat9Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the additional business process linked to a corporate action event.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	/**
	 * Proprietary identification of the additional business process linked to a
	 * corporate action event.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AdditionalBusinessProcessFormat1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public void setCode(AdditionalBusinessProcess5Code code) {
		this.code = code;
	}
