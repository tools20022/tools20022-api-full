	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TypeOfPrice6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Type of price expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TypeOfPrice30Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TypeOfPrice30Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
