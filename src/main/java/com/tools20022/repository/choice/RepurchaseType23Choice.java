...
import com.tools20022.repository.codeset.RepurchaseType10Code;
...
@XmlType(name = "RepurchaseType23Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType23Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RepurchaseType10Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<RepurchaseType23Choice, RepurchaseType10Code> mmCode = new MMMessageAttribute<RepurchaseType23Choice, RepurchaseType10Code>() {
		{
			...
			previousVersion_lazy = () -> RepurchaseType14Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RepurchaseType23Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RepurchaseType23Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> RepurchaseType14Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType23Choice.mmCode, com.tools20022.repository.choice.RepurchaseType23Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType23Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				previousVersion_lazy = () -> RepurchaseType14Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public RepurchaseType10Code getCode() {
		return code;
	}

	public RepurchaseType23Choice setCode(RepurchaseType10Code code) {
	...
	public RepurchaseType23Choice setProprietary(GenericIdentification30 proprietary) {
