...
public class NetDividendRateFormat21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat21Choice.mmAmount, NetDividendRateFormat21Choice.mmAmountAndRateStatus, NetDividendRateFormat21Choice.mmRateTypeAndAmountAndRateStatus,
						NetDividendRateFormat21Choice.mmNotSpecifiedRate);
