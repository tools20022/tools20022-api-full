 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat21Choice#mmRateTypeAndAmountAndRateStatus
 * NetDividendRateFormat21Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat21Choice#mmNotSpecifiedRate
 * NetDividendRateFormat21Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "NetDividendRateFormat21Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class NetDividendRateFormat21Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat21Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<NetDividendRateFormat21Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmNetDividend;
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Amount";
			definition = "Number of monetary units specified in a currency.";
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat29Choice.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(NetDividendRateFormat21Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(NetDividendRateFormat21Choice obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat21Choice, AmountAndRateStatus1> mmAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat21Choice, AmountAndRateStatus1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat29Choice.mmAmountAndRateStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountAndRateStatus1 getValue(NetDividendRateFormat21Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat21Choice obj, AmountAndRateStatus1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat21Choice, RateTypeAndAmountAndStatus25> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat21Choice, RateTypeAndAmountAndStatus25>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat29Choice.mmRateTypeAndAmountAndRateStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public RateTypeAndAmountAndStatus25 getValue(NetDividendRateFormat21Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat21Choice obj, RateTypeAndAmountAndStatus25 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat21Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<NetDividendRateFormat21Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
			...
			nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat29Choice.mmNotSpecifiedRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RateValueType7Code getValue(NetDividendRateFormat21Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(NetDividendRateFormat21Choice obj, RateValueType7Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmAmount, com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.NetDividendRateFormat21Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "NetDividendRateFormat21Choice";
				definition = "Choice between an amount or an unspecified rate.";
				nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat29Choice.mmObject());
			}
		});
	...
	public NetDividendRateFormat21Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat21Choice setAmountAndRateStatus(AmountAndRateStatus1 amountAndRateStatus) {
	...
	public NetDividendRateFormat21Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus25 rateTypeAndAmountAndRateStatus) {
	...
	public NetDividendRateFormat21Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
