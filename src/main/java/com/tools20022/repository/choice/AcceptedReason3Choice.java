...
@XmlType(name = "AcceptedReason3Choice", propOrder = {"code", "proprietary"})
public class AcceptedReason3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedReason3Choice, AcknowledgementReason7Code> mmCode = new MMMessageAttribute<AcceptedReason3Choice, AcknowledgementReason7Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcceptedReason3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedReason10Choice.mmCode);
		...
		@Override
		public AcknowledgementReason7Code getValue(AcceptedReason3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AcceptedReason3Choice obj, AcknowledgementReason7Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AcceptedReason3Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<AcceptedReason3Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatusReason.mmAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.AcceptedReason3Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(AcceptedReason10Choice.mmProprietary);
		...
		@Override
		public GenericIdentification20 getValue(AcceptedReason3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AcceptedReason3Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcceptedReason3Choice.mmCode, com.tools20022.repository.choice.AcceptedReason3Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcceptedReason3Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(AcceptedReason10Choice.mmObject());
	...
	public AcceptedReason3Choice setCode(AcknowledgementReason7Code code) {
	...
	public AcceptedReason3Choice setProprietary(GenericIdentification20 proprietary) {
