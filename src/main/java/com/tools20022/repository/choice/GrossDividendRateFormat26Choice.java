 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat26Choice#mmRateTypeAndAmountAndRateStatus
 * GrossDividendRateFormat26Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat26Choice#mmNotSpecifiedRate
 * GrossDividendRateFormat26Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "GrossDividendRateFormat26Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class GrossDividendRateFormat26Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat26Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<GrossDividendRateFormat26Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(GrossDividendRateFormat26Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(GrossDividendRateFormat26Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat26Choice, AmountAndRateStatus2> mmAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat26Choice, AmountAndRateStatus2>() {
		{
		...
		@Override
		public AmountAndRateStatus2 getValue(GrossDividendRateFormat26Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat26Choice obj, AmountAndRateStatus2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat26Choice, RateTypeAndAmountAndStatus35> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat26Choice, RateTypeAndAmountAndStatus35>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus35 getValue(GrossDividendRateFormat26Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat26Choice obj, RateTypeAndAmountAndStatus35 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat26Choice, RateType13Code> mmNotSpecifiedRate = new MMMessageAttribute<GrossDividendRateFormat26Choice, RateType13Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateType13Code getValue(GrossDividendRateFormat26Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(GrossDividendRateFormat26Choice obj, RateType13Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmAmount, com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.GrossDividendRateFormat26Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GrossDividendRateFormat26Choice";
	...
	public GrossDividendRateFormat26Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat26Choice setAmountAndRateStatus(AmountAndRateStatus2 amountAndRateStatus) {
	...
	public GrossDividendRateFormat26Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus35 rateTypeAndAmountAndRateStatus) {
	...
	public GrossDividendRateFormat26Choice setNotSpecifiedRate(RateType13Code notSpecifiedRate) {
