...
public class GrossDividendRateFormat26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat26Choice.mmAmount, GrossDividendRateFormat26Choice.mmAmountAndRateStatus, GrossDividendRateFormat26Choice.mmRateTypeAndAmountAndRateStatus,
						GrossDividendRateFormat26Choice.mmNotSpecifiedRate);
