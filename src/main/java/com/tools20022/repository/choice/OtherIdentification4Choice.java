...
@XmlType(name = "OtherIdentification4Choice", propOrder = {"code", "proprietary"})
public class OtherIdentification4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OtherIdentification4Choice
	 * OtherIdentification4Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OtherIdentification4Choice, PersonIdentificationType6Code> mmCode = new MMMessageAttribute<OtherIdentification4Choice, PersonIdentificationType6Code>() {
		{
			businessComponentTrace_lazy = () -> PersonIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.OtherIdentification4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Type of identification expressed as a code.";
			previousVersion_lazy = () -> OtherIdentification2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PersonIdentificationType6Code getValue(OtherIdentification4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OtherIdentification4Choice obj, PersonIdentificationType6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OtherIdentification4Choice, GenericIdentification36> mmProprietary = new MMMessageAttribute<OtherIdentification4Choice, GenericIdentification36>() {
		{
			...
			previousVersion_lazy = () -> OtherIdentification2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification36 getValue(OtherIdentification4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OtherIdentification4Choice obj, GenericIdentification36 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OtherIdentification4Choice.mmCode, com.tools20022.repository.choice.OtherIdentification4Choice.mmProprietary);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OtherIdentification4Choice";
				definition = "Choice of formats for the specification of other identification.";
				previousVersion_lazy = () -> OtherIdentification2Choice.mmObject();
			}
		});
	...
	public OtherIdentification4Choice setCode(PersonIdentificationType6Code code) {
	...
	public OtherIdentification4Choice setProprietary(GenericIdentification36 proprietary) {
