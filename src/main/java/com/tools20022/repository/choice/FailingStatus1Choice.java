...
import com.tools20022.repository.msg.FailingReason1;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.FailingStatus3Choice
 * FailingStatus3Choice}</li>
 * <li>{@linkplain com.tools20022.repository.choice.FailingStatus4Choice
...
@XmlType(name = "FailingStatus1Choice", propOrder = {"noSpecifiedReason", "reason"})
public class FailingStatus1Choice {
	...
	@XmlElement(name = "Rsn")
	protected List<FailingReason1> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.FailingReason1
	 * FailingReason1}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FailingStatus1Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.FailingStatus1Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FailingStatus1Choice";
				definition = "Choice of failing status.";
				nextVersions_lazy = () -> Arrays.asList(FailingStatus3Choice.mmObject(), FailingStatus4Choice.mmObject());
			}
		});
	...
	public FailingStatus1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<FailingReason1> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public FailingStatus1Choice setReason(List<FailingReason1> reason) {
