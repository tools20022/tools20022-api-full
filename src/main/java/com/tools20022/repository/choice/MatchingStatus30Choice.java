...
public class MatchingStatus30Choice {
	...
	public static final MMMessageAssociationEnd mmMatched = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> MatchingStatus30Choice.mmObject();
			isDerived = false;
			xmlTag = "Mtchd";
	...
	public static final MMMessageAssociationEnd mmUnmatched = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.UnmatchedStatus20Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MatchingStatus30Choice.mmMatched, MatchingStatus30Choice.mmUnmatched, MatchingStatus30Choice.mmProprietary);
	...
	public void setUnmatched(com.tools20022.repository.choice.UnmatchedStatus20Choice unmatched) {
