...
public class MatchingStatus30Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MatchingStatus30Choice.Matched, com.tools20022.repository.choice.MatchingStatus30Choice.Unmatched,
						com.tools20022.repository.choice.MatchingStatus30Choice.Proprietary);
