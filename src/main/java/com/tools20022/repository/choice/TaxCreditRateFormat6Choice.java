...
public class TaxCreditRateFormat6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TaxCreditRateFormat6Choice.mmRate, TaxCreditRateFormat6Choice.mmAmount, TaxCreditRateFormat6Choice.mmRateTypeAndAmountAndRateStatus, TaxCreditRateFormat6Choice.mmNotSpecifiedRate);
