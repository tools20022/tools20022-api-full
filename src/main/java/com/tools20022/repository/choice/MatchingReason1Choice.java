...
public class MatchingReason1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MatchingReason1Choice.mmReason, MatchingReason1Choice.mmNoSpecifiedReason);
	...
	public void setReason(List<UnmatchedReason5> reason) {
		this.reason = reason;
	}
