...
public class MatchingReason1Choice {
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> MatchingReason1Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MatchingReason1Choice.Reason, com.tools20022.repository.choice.MatchingReason1Choice.NoSpecifiedReason);
