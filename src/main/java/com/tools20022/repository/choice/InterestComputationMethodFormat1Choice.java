...
@XmlType(name = "InterestComputationMethodFormat1Choice", propOrder = {"code", "proprietary"})
public class InterestComputationMethodFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InterestComputationMethodFormat1Choice, InterestComputationMethod2Code> mmCode = new MMMessageAttribute<InterestComputationMethodFormat1Choice, InterestComputationMethod2Code>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmDayCountBasis;
			componentContext_lazy = () -> com.tools20022.repository.choice.InterestComputationMethodFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the method used to compute accruing interest of a financial instrument.";
			nextVersions_lazy = () -> Arrays.asList(InterestComputationMethodFormat4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public InterestComputationMethod2Code getValue(InterestComputationMethodFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(InterestComputationMethodFormat1Choice obj, InterestComputationMethod2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InterestComputationMethodFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<InterestComputationMethodFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmDayCountBasis;
			componentContext_lazy = () -> com.tools20022.repository.choice.InterestComputationMethodFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InterestComputationMethodFormat4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(InterestComputationMethodFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(InterestComputationMethodFormat1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InterestComputationMethodFormat1Choice.mmCode, com.tools20022.repository.choice.InterestComputationMethodFormat1Choice.mmProprietary);
				trace_lazy = () -> InterestCalculation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InterestComputationMethodFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of interest computation method.";
				nextVersions_lazy = () -> Arrays.asList(InterestComputationMethodFormat4Choice.mmObject());
			}
		});
	...
	public InterestComputationMethodFormat1Choice setCode(InterestComputationMethod2Code code) {
	...
	public InterestComputationMethodFormat1Choice setProprietary(GenericIdentification20 proprietary) {
