 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus4Choice#Reason
...
public class DeniedStatus4Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DeniedStatus4Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus4Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus4Choice.Reason);
