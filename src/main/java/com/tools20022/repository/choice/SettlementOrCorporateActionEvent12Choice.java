...
public class SettlementOrCorporateActionEvent12Choice {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementOrCorporateActionEvent12Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent12Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent12Choice.mmCorporateActionEventType);
