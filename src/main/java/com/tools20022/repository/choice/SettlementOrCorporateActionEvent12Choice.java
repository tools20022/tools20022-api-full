...
public class SettlementOrCorporateActionEvent12Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementOrCorporateActionEvent12Choice.SecuritiesTransactionType,
						com.tools20022.repository.choice.SettlementOrCorporateActionEvent12Choice.CorporateActionEventType);
