 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DeniedReason6Choice#Code
...
public class DeniedReason6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedReason6Choice.Code, com.tools20022.repository.choice.DeniedReason6Choice.Proprietary);
