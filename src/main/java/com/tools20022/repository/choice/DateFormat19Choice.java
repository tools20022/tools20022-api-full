 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat19Choice#Date
 * DateFormat19Choice.Date}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat19Choice#DateCode
...
public class DateFormat19Choice {
	...
	public static final MMMessageAssociationEnd Date = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat31Choice.Date);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.DateFormat31Choice#DateCode
	...
	public static final MMMessageAssociationEnd DateCode = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat31Choice.DateCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat19Choice.Date, com.tools20022.repository.choice.DateFormat19Choice.DateCode);
