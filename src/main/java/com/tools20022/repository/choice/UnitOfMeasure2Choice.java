 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UnitOfMeasure2Choice#mmCode
...
@XmlType(name = "UnitOfMeasure2Choice", propOrder = {"code", "proprietary"})
public class UnitOfMeasure2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnitOfMeasure4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(UnitOfMeasure4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnitOfMeasure2Choice.mmCode, com.tools20022.repository.choice.UnitOfMeasure2Choice.mmProprietary);
				trace_lazy = () -> ProductQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "UnitOfMeasure2Choice";
				definition = "Choice of format for unit of measure.";
				nextVersions_lazy = () -> Arrays.asList(UnitOfMeasure4Choice.mmObject());
			}
		});
	...
	public UnitOfMeasure2Choice setCode(UnitOfMeasure4Code code) {
	...
	public UnitOfMeasure2Choice setProprietary(GenericIdentification40 proprietary) {
