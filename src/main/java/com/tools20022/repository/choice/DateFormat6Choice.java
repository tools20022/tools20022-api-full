...
@XmlType(name = "DateFormat6Choice", propOrder = {"date", "dateCode"})
public class DateFormat6Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DateFormat6Choice, DateAndDateTimeChoice> mmDate = new MMMessageAttribute<DateFormat6Choice, DateAndDateTimeChoice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Dt";
		...
		@Override
		public DateAndDateTimeChoice getValue(DateFormat6Choice obj) {
			return obj.getDate();
		}

		@Override
		public void setValue(DateFormat6Choice obj, DateAndDateTimeChoice value) {
			obj.setDate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DateFormat6Choice, DateCode2Choice> mmDateCode = new MMMessageAssociationEnd<DateFormat6Choice, DateCode2Choice>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "DtCd";
		...
		@Override
		public DateCode2Choice getValue(DateFormat6Choice obj) {
			return obj.getDateCode();
		}

		@Override
		public void setValue(DateFormat6Choice obj, DateCode2Choice value) {
	...
	public DateFormat6Choice setDate(DateAndDateTimeChoice date) {
	...
	public DateFormat6Choice setDateCode(DateCode2Choice dateCode) {
