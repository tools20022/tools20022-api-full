...
@XmlType(name = "RepoCallRequestStatus1Choice", propOrder = {"code", "proprietary"})
public class RepoCallRequestStatus1Choice {
	...
	public static final MMMessageAttribute<RepoCallRequestStatus1Choice, RepoCallRequestStatus1Code> mmCode = new MMMessageAttribute<RepoCallRequestStatus1Choice, RepoCallRequestStatus1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RepoCallRequestStatus8Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RepoCallRequestStatus1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RepoCallRequestStatus1Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the repurchase agreement call request.";
			nextVersions_lazy = () -> Arrays.asList(RepoCallRequestStatus8Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepoCallRequestStatus1Choice.mmCode, com.tools20022.repository.choice.RepoCallRequestStatus1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepoCallRequestStatus1Choice";
				definition = "Choice of format for the repurchase agreement call acknowledgement.";
				nextVersions_lazy = () -> Arrays.asList(RepoCallRequestStatus8Choice.mmObject());
			}
		});
	...
	public RepoCallRequestStatus1Choice setCode(RepoCallRequestStatus1Code code) {
	...
	public RepoCallRequestStatus1Choice setProprietary(GenericIdentification20 proprietary) {
