 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateCode22Choice#Code
 * DateCode22Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DateCode22Choice#Proprietary
 * DateCode22Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateCode22Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DateCode22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateCode22Choice.Code, com.tools20022.repository.choice.DateCode22Choice.Proprietary);
