 ...
 * <li>{@linkplain com.tools20022.repository.choice.Status20Choice#mmRejected
...
public class Status20Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Status14Choice#mmStatus
	 * Status14Choice.mmStatus}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<Status20Choice, AccountManagementStatus1Code> mmStatus = new MMMessageAttribute<Status20Choice, AccountManagementStatus1Code>() {
		{
			businessElementTrace_lazy = () -> AccountStatus.mmManagementStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.Status20Choice.mmObject();
			isDerived = false;
			xmlTag = "Sts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Status";
			definition = "Status of the account opening instruction or account modification instruction.";
			nextVersions_lazy = () -> Arrays.asList(Status25Choice.mmStatus);
			previousVersion_lazy = () -> Status14Choice.mmStatus;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public AccountManagementStatus1Code getValue(Status20Choice obj) {
			return obj.getStatus();
		}

		@Override
		public void setValue(Status20Choice obj, AccountManagementStatus1Code value) {
			obj.setStatus(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Status20Choice, List<RejectionReason31>> mmRejected = new MMMessageAssociationEnd<Status20Choice, List<RejectionReason31>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Status25Choice.mmRejected);
			previousVersion_lazy = () -> Status14Choice.mmRejected;
			maxOccurs = 10;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<RejectionReason31> getValue(Status20Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(Status20Choice obj, List<RejectionReason31> value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status20Choice.mmStatus, com.tools20022.repository.choice.Status20Choice.mmRejected);
				trace_lazy = () -> AccountStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Status20Choice";
				definition = "Choice of formats for the specification of the status.";
				nextVersions_lazy = () -> Arrays.asList(Status21Choice.mmObject(), Status25Choice.mmObject());
				previousVersion_lazy = () -> Status14Choice.mmObject();
			}
		});
	...
	public Status20Choice setStatus(AccountManagementStatus1Code status) {
	...
	public Status20Choice setRejected(List<RejectionReason31> rejected) {
