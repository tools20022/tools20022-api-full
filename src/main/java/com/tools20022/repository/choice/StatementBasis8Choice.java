...
@XmlType(name = "StatementBasis8Choice", propOrder = {"code", "proprietary"})
public class StatementBasis8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<StatementBasis8Choice, StatementBasis2Code> mmCode = new MMMessageAttribute<StatementBasis8Choice, StatementBasis2Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.StatementBasis8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> StatementBasis2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public StatementBasis2Code getValue(StatementBasis8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(StatementBasis8Choice obj, StatementBasis2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<StatementBasis8Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<StatementBasis8Choice, GenericIdentification30>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.StatementBasis8Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			previousVersion_lazy = () -> StatementBasis2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(StatementBasis8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(StatementBasis8Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementBasis8Choice.mmCode, com.tools20022.repository.choice.StatementBasis8Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StatementBasis8Choice";
				definition = "Choice of format for the statement basis.";
				previousVersion_lazy = () -> StatementBasis2Choice.mmObject();
			}
		});
	...
	public StatementBasis8Choice setCode(StatementBasis2Code code) {
	...
	public StatementBasis8Choice setProprietary(GenericIdentification30 proprietary) {
