...
public class SettlementOrCorporateActionEvent10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent10Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent10Choice.mmCorporateActionEventType);
