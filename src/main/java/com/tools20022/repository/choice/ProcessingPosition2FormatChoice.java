...
import com.tools20022.repository.codeset.ProcessingPosition2Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ProcessingPosition2FormatChoice#mmCode
 * ProcessingPosition2FormatChoice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ProcessingPosition2FormatChoice#mmProprietary
 * ProcessingPosition2FormatChoice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats to express the processing position."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ProcessingPosition2FormatChoice", propOrder = {"code", "proprietary"})
public class ProcessingPosition2FormatChoice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ProcessingPosition2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<ProcessingPosition2FormatChoice, ProcessingPosition2Code> mmCode = new MMMessageAttribute<ProcessingPosition2FormatChoice, ProcessingPosition2Code>() {
		{
			...
			name = "Code";
			definition = "Standard code to specify the processing position.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<ProcessingPosition2FormatChoice, GenericIdentification13> mmProprietary = new MMMessageAttribute<ProcessingPosition2FormatChoice, GenericIdentification13>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Proprietary code to express the processing position.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingPosition2FormatChoice.mmCode, com.tools20022.repository.choice.ProcessingPosition2FormatChoice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ProcessingPosition2FormatChoice";
				definition = "Choice of formats to express the processing position.";
			}
		});
		return mmObject_lazy.get();
	}

	public ProcessingPosition2Code getCode() {
		return code;
	}

	public ProcessingPosition2FormatChoice setCode(ProcessingPosition2Code code) {
	...
	public ProcessingPosition2FormatChoice setProprietary(GenericIdentification13 proprietary) {
