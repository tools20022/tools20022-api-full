...
@XmlType(name = "UndertakingDocumentType1Choice", propOrder = {"code", "proprietary"})
public class UndertakingDocumentType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UndertakingDocumentType1Choice.mmCode, com.tools20022.repository.choice.UndertakingDocumentType1Choice.mmProprietary);
				trace_lazy = () -> UndertakingDocument.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UndertakingDocumentType1Choice";
	...
	public UndertakingDocumentType1Choice setCode(ExternalUndertakingDocumentType1Code code) {
	...
	public UndertakingDocumentType1Choice setProprietary(GenericIdentification1 proprietary) {
