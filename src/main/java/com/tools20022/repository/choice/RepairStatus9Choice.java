...
public class RepairStatus9Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairStatus9Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairStatus9Choice.mmNoSpecifiedReason, RepairStatus9Choice.mmReason);
	...
	public void setReason(List<RepairReason7> reason) {
		this.reason = reason;
	}
}