...
@XmlType(name = "UnilateralSplit4Choice", propOrder = {"code", "proprietary"})
public class UnilateralSplit4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnilateralSplit4Choice.mmCode, com.tools20022.repository.choice.UnilateralSplit4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnilateralSplit4Choice";
	...
	public UnilateralSplit4Choice setCode(SecuritiesTransactionType5Code code) {
	...
	public UnilateralSplit4Choice setProprietary(GenericIdentification47 proprietary) {
