...
public class SecuritiesTransactionType6Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SecuritiesTransactionType6Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesTransactionType6Choice.Code, com.tools20022.repository.choice.SecuritiesTransactionType6Choice.Proprietary);
