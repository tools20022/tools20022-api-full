...
public class NonEligibleProceedsIndicator2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NonEligibleProceedsIndicator2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NonEligibleProceedsIndicator2Choice.mmCode, NonEligibleProceedsIndicator2Choice.mmProprietary);
