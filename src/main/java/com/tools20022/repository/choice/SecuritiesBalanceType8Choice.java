...
public class SecuritiesBalanceType8Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SecuritiesBalanceType8Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesBalanceType8Choice.Code, com.tools20022.repository.choice.SecuritiesBalanceType8Choice.Proprietary);
