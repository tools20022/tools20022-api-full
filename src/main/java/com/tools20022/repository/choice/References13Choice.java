...
public class References13Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References13Choice.mmSecuritiesSettlementTransactionIdentification, References13Choice.mmIntraPositionMovementIdentification,
						References13Choice.mmIntraBalanceMovementIdentification, References13Choice.mmAccountServicerTransactionIdentification, References13Choice.mmMarketInfrastructureTransactionIdentification,
						References13Choice.mmPoolIdentification, References13Choice.mmCommonIdentification, References13Choice.mmTradeIdentification, References13Choice.mmOtherTransactionIdentification);
