 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Registration1Choice#mmCode
...
@XmlType(name = "Registration1Choice", propOrder = {"code", "proprietary"})
public class Registration1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Registration1Choice, Registration1Code> mmCode = new MMMessageAttribute<Registration1Choice, Registration1Code>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(Registration9Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Registration1Code getValue(Registration1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Registration1Choice obj, Registration1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Registration1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<Registration1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration1Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Registration information expressed as a proprietary code.";
			nextVersions_lazy = () -> Arrays.asList(Registration9Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(Registration1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Registration1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Registration1Choice.mmCode, com.tools20022.repository.choice.Registration1Choice.mmProprietary);
				trace_lazy = () -> BasicSecuritiesRegistration.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Registration1Choice";
				definition = "Choice of format for the registration information.";
				nextVersions_lazy = () -> Arrays.asList(Registration9Choice.mmObject());
			}
		});
	...
	public Registration1Choice setCode(Registration1Code code) {
	...
	public Registration1Choice setProprietary(GenericIdentification20 proprietary) {
