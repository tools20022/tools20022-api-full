 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintShortLongNumberRule#forDocumentNumber2Choice
 * ConstraintShortLongNumberRule.forDocumentNumber2Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class DocumentNumber2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber2Choice.mmShortNumber, com.tools20022.repository.choice.DocumentNumber2Choice.mmLongNumber,
						com.tools20022.repository.choice.DocumentNumber2Choice.mmProprietaryNumber);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintShortLongNumberRule.forDocumentNumber2Choice);
	...
	public DocumentNumber2Choice setShortNumber(Exact3NumericText shortNumber) {
	...
	public DocumentNumber2Choice setLongNumber(ISO20022MessageIdentificationText longNumber) {
	...
	public DocumentNumber2Choice setProprietaryNumber(GenericIdentification23 proprietaryNumber) {
