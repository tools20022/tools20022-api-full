...
public class PaymentInstrument9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentInstrument9Choice.PaymentCardDetails, com.tools20022.repository.choice.PaymentInstrument9Choice.CreditTransferDetails,
						com.tools20022.repository.choice.PaymentInstrument9Choice.DirectDebitDetails, com.tools20022.repository.choice.PaymentInstrument9Choice.ChequeDetails,
						com.tools20022.repository.choice.PaymentInstrument9Choice.AccountDetails);
