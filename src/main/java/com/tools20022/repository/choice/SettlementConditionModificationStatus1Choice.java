 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementConditionModificationStatus1Choice#mmProprietary
 * SettlementConditionModificationStatus1Choice.mmProprietary}</li>
 * </ul>
 * </li>
...
@XmlType(name = "SettlementConditionModificationStatus1Choice", propOrder = {"code", "proprietary"})
public class SettlementConditionModificationStatus1Choice {
	...
	public static final MMMessageAttribute<SettlementConditionModificationStatus1Choice, SettlementConditionModificationStatus1Code> mmCode = new MMMessageAttribute<SettlementConditionModificationStatus1Choice, SettlementConditionModificationStatus1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementConditionModificationStatus3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<SettlementConditionModificationStatus1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<SettlementConditionModificationStatus1Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the securities settlement condition modification request.";
			nextVersions_lazy = () -> Arrays.asList(SettlementConditionModificationStatus3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementConditionModificationStatus1Choice.mmCode, com.tools20022.repository.choice.SettlementConditionModificationStatus1Choice.mmProprietary);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementConditionModificationStatus1Choice";
				definition = "Choice of processing change command status.";
				nextVersions_lazy = () -> Arrays.asList(SettlementConditionModificationStatus3Choice.mmObject());
			}
		});
	...
	public SettlementConditionModificationStatus1Choice setCode(SettlementConditionModificationStatus1Code code) {
	...
	public SettlementConditionModificationStatus1Choice setProprietary(GenericIdentification20 proprietary) {
