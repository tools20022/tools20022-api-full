...
public class PartyIdentification55Choice {
	...
	public static final MMMessageAttribute BICFI = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification55Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification55Choice.BICFI, com.tools20022.repository.choice.PartyIdentification55Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification55Choice.ProprietaryIdentification);
