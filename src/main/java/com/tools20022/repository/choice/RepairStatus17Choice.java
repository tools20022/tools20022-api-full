...
public class RepairStatus17Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairStatus17Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairStatus17Choice.mmNoSpecifiedReason, RepairStatus17Choice.mmReason);
	...
	public void setReason(List<RepairReason13> reason) {
		this.reason = reason;
	}
}