...
public class CorporateActionEventType8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType8Choice.mmCode, CorporateActionEventType8Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType9Code code) {
		this.code = code;
	}
