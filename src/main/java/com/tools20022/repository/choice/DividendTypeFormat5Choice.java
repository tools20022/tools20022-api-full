...
@XmlType(name = "DividendTypeFormat5Choice", propOrder = {"code", "proprietary"})
public class DividendTypeFormat5Choice {
	...
	public static final MMMessageAttribute<DividendTypeFormat5Choice, CorporateActionFrequencyType3Code> mmCode = new MMMessageAttribute<DividendTypeFormat5Choice, CorporateActionFrequencyType3Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DividendTypeFormat9Choice.mmCode);
			previousVersion_lazy = () -> DividendTypeFormat3Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<DividendTypeFormat5Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<DividendTypeFormat5Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DividendTypeFormat9Choice.mmProprietary);
			previousVersion_lazy = () -> DividendTypeFormat3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public DividendTypeFormat5Choice setCode(CorporateActionFrequencyType3Code code) {
	...
	public DividendTypeFormat5Choice setProprietary(GenericIdentification20 proprietary) {
