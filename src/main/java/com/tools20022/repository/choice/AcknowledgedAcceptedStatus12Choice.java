...
@XmlType(name = "AcknowledgedAcceptedStatus12Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcknowledgedAcceptedStatus12Choice {
	...
	public static final MMMessageAttribute<AcknowledgedAcceptedStatus12Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<AcknowledgedAcceptedStatus12Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus24Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<AcknowledgedAcceptedStatus12Choice, List<AcknowledgementReason1>> mmReason = new MMMessageAssociationEnd<AcknowledgedAcceptedStatus12Choice, List<AcknowledgementReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus24Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus12Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus12Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgedAcceptedStatus12Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus24Choice.mmObject());
				previousVersion_lazy = () -> AcknowledgedAcceptedStatus1Choice.mmObject();
			}
		});
	...
	public AcknowledgedAcceptedStatus12Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public AcknowledgedAcceptedStatus12Choice setReason(List<AcknowledgementReason1> reason) {
