...
@XmlType(name = "TradeOriginator1Choice", propOrder = {"code", "proprietary"})
public class TradeOriginator1Choice {
	...
	public static final MMMessageAttribute<TradeOriginator1Choice, OriginatorRole2Code> mmCode = new MMMessageAttribute<TradeOriginator1Choice, OriginatorRole2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TradeOriginator3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<TradeOriginator1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<TradeOriginator1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(TradeOriginator3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeOriginator1Choice.mmCode, com.tools20022.repository.choice.TradeOriginator1Choice.mmProprietary);
				trace_lazy = () -> TradeOriginatorRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TradeOriginator1Choice";
				definition = "Choice of format for the trading capacity of the party.";
				nextVersions_lazy = () -> Arrays.asList(TradeOriginator3Choice.mmObject());
			}
		});
	...
	public TradeOriginator1Choice setCode(OriginatorRole2Code code) {
	...
	public TradeOriginator1Choice setProprietary(GenericIdentification20 proprietary) {
