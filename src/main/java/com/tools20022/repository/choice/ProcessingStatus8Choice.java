...
public class ProcessingStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus8Choice.AcknowledgedAccepted, com.tools20022.repository.choice.ProcessingStatus8Choice.Rejected,
						com.tools20022.repository.choice.ProcessingStatus8Choice.Proprietary);
