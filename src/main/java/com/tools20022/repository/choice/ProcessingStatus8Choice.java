...
public class ProcessingStatus8Choice {
	...
	public static final MMMessageAssociationEnd mmAcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus8Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
	...
	public void setAcknowledgedAccepted(com.tools20022.repository.choice.AcknowledgedAcceptedStatus4Choice acknowledgedAccepted) {
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus7Choice rejected) {
