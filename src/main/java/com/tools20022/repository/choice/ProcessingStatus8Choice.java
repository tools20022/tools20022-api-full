...
public class ProcessingStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus8Choice.mmAcknowledgedAccepted, ProcessingStatus8Choice.mmRejected, ProcessingStatus8Choice.mmProprietary);
