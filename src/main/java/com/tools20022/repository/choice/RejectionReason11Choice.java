...
public class RejectionReason11Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason24Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason24Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason11Choice.Code, com.tools20022.repository.choice.RejectionReason11Choice.Proprietary);
