 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ClosingBalance5Choice#Final
...
public class ClosingBalance5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClosingBalance5Choice.Final, com.tools20022.repository.choice.ClosingBalance5Choice.Intermediary);
