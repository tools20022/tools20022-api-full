...
public class CancelledStatusReason1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatusReason1Choice.Reason, com.tools20022.repository.choice.CancelledStatusReason1Choice.Proprietary,
						com.tools20022.repository.choice.CancelledStatusReason1Choice.NoSpecifiedReason);
