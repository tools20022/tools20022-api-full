...
public class GrossDividendRateFormat6Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat6Choice.mmAmount, GrossDividendRateFormat6Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat6Choice.mmNotSpecifiedRate);
