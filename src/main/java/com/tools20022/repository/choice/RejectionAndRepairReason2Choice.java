...
@XmlType(name = "RejectionAndRepairReason2Choice", propOrder = {"code", "proprietary"})
public class RejectionAndRepairReason2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionAndRepairReason2Choice, RejectionReason24Code> mmCode = new MMMessageAttribute<RejectionAndRepairReason2Choice, RejectionReason24Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionAndRepairReason2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason26Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RejectionReason24Code getValue(RejectionAndRepairReason2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionAndRepairReason2Choice obj, RejectionReason24Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionAndRepairReason2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RejectionAndRepairReason2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionAndRepairReason2Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason26Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(RejectionAndRepairReason2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RejectionAndRepairReason2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionAndRepairReason2Choice.mmCode, com.tools20022.repository.choice.RejectionAndRepairReason2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionAndRepairReason2Choice";
				definition = "Choice of format for the rejection or repair reason.";
				nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason26Choice.mmObject());
			}
		});
	...
	public RejectionAndRepairReason2Choice setCode(RejectionReason24Code code) {
	...
	public RejectionAndRepairReason2Choice setProprietary(GenericIdentification20 proprietary) {
