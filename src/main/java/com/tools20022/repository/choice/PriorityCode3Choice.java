 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.PriorityCode3Choice#mmCode
...
@XmlType(name = "PriorityCode3Choice", propOrder = {"code", "proprietary"})
public class PriorityCode3Choice {
	...
	public PriorityCode3Choice setCode(Priority1Code code) {
	...
	public PriorityCode3Choice setProprietary(Max35Text proprietary) {
