 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.GrossDividendRateFormat8Choice#RateTypeAndAmountAndRateStatus
 * GrossDividendRateFormat8Choice.RateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
public class GrossDividendRateFormat8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat8Choice.Amount, com.tools20022.repository.choice.GrossDividendRateFormat8Choice.RateTypeAndAmountAndRateStatus);
