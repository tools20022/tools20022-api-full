...
public class GrossDividendRateFormat8Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat8Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat8Choice.mmAmount, GrossDividendRateFormat8Choice.mmRateTypeAndAmountAndRateStatus);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus13 rateTypeAndAmountAndRateStatus) {
