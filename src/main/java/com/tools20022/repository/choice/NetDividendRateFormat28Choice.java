 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat28Choice#mmRateTypeAndAmountAndRateStatus
 * NetDividendRateFormat28Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat28Choice#mmNotSpecifiedRate
 * NetDividendRateFormat28Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "NetDividendRateFormat28Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class NetDividendRateFormat28Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat28Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<NetDividendRateFormat28Choice, RestrictedFINActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> Dividend.mmNetDividend;
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat28Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public RestrictedFINActiveCurrencyAnd13DecimalAmount getValue(NetDividendRateFormat28Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(NetDividendRateFormat28Choice obj, RestrictedFINActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat28Choice, AmountAndRateStatus2> mmAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat28Choice, AmountAndRateStatus2>() {
		{
		...
		@Override
		public AmountAndRateStatus2 getValue(NetDividendRateFormat28Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat28Choice obj, AmountAndRateStatus2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<NetDividendRateFormat28Choice, RateTypeAndAmountAndStatus36> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<NetDividendRateFormat28Choice, RateTypeAndAmountAndStatus36>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat28Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus36 getValue(NetDividendRateFormat28Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(NetDividendRateFormat28Choice obj, RateTypeAndAmountAndStatus36 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<NetDividendRateFormat28Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<NetDividendRateFormat28Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.NetDividendRateFormat28Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(NetDividendRateFormat28Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(NetDividendRateFormat28Choice obj, RateValueType7Code value) {
	...
	public NetDividendRateFormat28Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat28Choice setAmountAndRateStatus(AmountAndRateStatus2 amountAndRateStatus) {
	...
	public NetDividendRateFormat28Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus36 rateTypeAndAmountAndRateStatus) {
	...
	public NetDividendRateFormat28Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
