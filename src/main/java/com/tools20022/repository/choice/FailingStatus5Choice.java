...
public class FailingStatus5Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus5Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus5Choice.mmNoSpecifiedReason, FailingStatus5Choice.mmReason);
	...
	public void setReason(List<FailingReason6> reason) {
		this.reason = reason;
	}
}