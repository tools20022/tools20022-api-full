 ...
 * <li>{@linkplain com.tools20022.repository.choice.FailingStatus5Choice#Reason
...
public class FailingStatus5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FailingStatus5Choice.NoSpecifiedReason, com.tools20022.repository.choice.FailingStatus5Choice.Reason);
