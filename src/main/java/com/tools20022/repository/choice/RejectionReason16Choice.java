...
public class RejectionReason16Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionReason16Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason22Choice.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionReason5Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason22Choice.mmProprietary);
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionReason5Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(RejectionReason39Code code) {
		this.code = code;
	}
