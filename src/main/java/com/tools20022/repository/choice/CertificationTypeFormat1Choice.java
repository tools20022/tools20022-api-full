...
@XmlType(name = "CertificationTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class CertificationTypeFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CertificationTypeFormat1Choice, CertificationFormatType1Code> mmCode = new MMMessageAttribute<CertificationTypeFormat1Choice, CertificationFormatType1Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationFormat;
			componentContext_lazy = () -> com.tools20022.repository.choice.CertificationTypeFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CertificationTypeFormat3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CertificationFormatType1Code getValue(CertificationTypeFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CertificationTypeFormat1Choice obj, CertificationFormatType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CertificationTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CertificationTypeFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationFormat;
			componentContext_lazy = () -> com.tools20022.repository.choice.CertificationTypeFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CertificationTypeFormat3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(CertificationTypeFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CertificationTypeFormat1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CertificationTypeFormat1Choice.mmCode, com.tools20022.repository.choice.CertificationTypeFormat1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CertificationTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the certification format required.";
				nextVersions_lazy = () -> Arrays.asList(CertificationTypeFormat3Choice.mmObject());
			}
		});
	...
	public CertificationTypeFormat1Choice setCode(CertificationFormatType1Code code) {
	...
	public CertificationTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
