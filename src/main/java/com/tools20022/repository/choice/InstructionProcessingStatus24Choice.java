...
public class InstructionProcessingStatus24Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus24Choice.mmCancelled, InstructionProcessingStatus24Choice.mmAcceptedForFurtherProcessing, InstructionProcessingStatus24Choice.mmRejected,
						InstructionProcessingStatus24Choice.mmPending, InstructionProcessingStatus24Choice.mmDefaultAction, InstructionProcessingStatus24Choice.mmStandingInstruction, InstructionProcessingStatus24Choice.mmProprietaryStatus);
