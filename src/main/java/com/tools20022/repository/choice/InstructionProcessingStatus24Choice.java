...
import com.tools20022.repository.choice.PendingStatus42Choice;
import com.tools20022.repository.choice.RejectedStatus19Choice;
...
@XmlType(name = "InstructionProcessingStatus24Choice", propOrder = {"cancelled", "acceptedForFurtherProcessing", "rejected", "pending", "defaultAction", "standingInstruction", "proprietaryStatus"})
public class InstructionProcessingStatus24Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, CancelledStatus12Choice> mmCancelled = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, CancelledStatus12Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmObject();
			isDerived = false;
			xmlTag = "Canc";
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmCancelled);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmCancelled;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public CancelledStatus12Choice getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getCancelled();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, CancelledStatus12Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, AcceptedStatus8Choice> mmAcceptedForFurtherProcessing = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, AcceptedStatus8Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmAcceptedForFurtherProcessing);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmAcceptedForFurtherProcessing;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AcceptedStatus8Choice getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getAcceptedForFurtherProcessing();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, AcceptedStatus8Choice value) {
			obj.setAcceptedForFurtherProcessing(value);
		}
	};
	@XmlElement(name = "Rjctd", required = true)
	protected RejectedStatus19Choice rejected;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, RejectedStatus19Choice> mmRejected = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, RejectedStatus19Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmRejected);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmRejected;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> RejectedStatus19Choice.mmObject();
		}

		@Override
		public RejectedStatus19Choice getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, RejectedStatus19Choice value) {
			obj.setRejected(value);
		}
	};
	@XmlElement(name = "Pdg", required = true)
	protected PendingStatus42Choice pending;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, PendingStatus42Choice> mmPending = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, PendingStatus42Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmPending);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmPending;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> PendingStatus42Choice.mmObject();
		}

		@Override
		public PendingStatus42Choice getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getPending();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, PendingStatus42Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, NoSpecifiedReason1> mmDefaultAction = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, NoSpecifiedReason1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmDefaultAction);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmDefaultAction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public NoSpecifiedReason1 getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getDefaultAction();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, NoSpecifiedReason1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, NoSpecifiedReason1> mmStandingInstruction = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, NoSpecifiedReason1>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmStandingInstruction);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmStandingInstruction;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> NoSpecifiedReason1.mmObject();
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InstructionProcessingStatus24Choice, ProprietaryStatusAndReason6> mmProprietaryStatus = new MMMessageAssociationEnd<InstructionProcessingStatus24Choice, ProprietaryStatusAndReason6>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmProprietaryStatus);
			previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmProprietaryStatus;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public ProprietaryStatusAndReason6 getValue(InstructionProcessingStatus24Choice obj) {
			return obj.getProprietaryStatus();
		}

		@Override
		public void setValue(InstructionProcessingStatus24Choice obj, ProprietaryStatusAndReason6 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmCancelled,
						com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmAcceptedForFurtherProcessing, com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmRejected,
						com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmPending, com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmDefaultAction,
						com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmStandingInstruction, com.tools20022.repository.choice.InstructionProcessingStatus24Choice.mmProprietaryStatus);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionStatusAdviceV07.mmInstructionProcessingStatus);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InstructionProcessingStatus24Choice";
				definition = "Choice between different instruction processing statuses.";
				nextVersions_lazy = () -> Arrays.asList(InstructionProcessingStatus29Choice.mmObject());
				previousVersion_lazy = () -> InstructionProcessingStatus20Choice.mmObject();
			}
		});
	...
	public InstructionProcessingStatus24Choice setCancelled(CancelledStatus12Choice cancelled) {
	...
	public InstructionProcessingStatus24Choice setAcceptedForFurtherProcessing(AcceptedStatus8Choice acceptedForFurtherProcessing) {
		this.acceptedForFurtherProcessing = Objects.requireNonNull(acceptedForFurtherProcessing);
		return this;
	}

	public RejectedStatus19Choice getRejected() {
		return rejected;
	}

	public InstructionProcessingStatus24Choice setRejected(RejectedStatus19Choice rejected) {
		this.rejected = Objects.requireNonNull(rejected);
		return this;
	}

	public PendingStatus42Choice getPending() {
		return pending;
	}

	public InstructionProcessingStatus24Choice setPending(PendingStatus42Choice pending) {
	...
	public InstructionProcessingStatus24Choice setDefaultAction(NoSpecifiedReason1 defaultAction) {
	...
	public InstructionProcessingStatus24Choice setStandingInstruction(NoSpecifiedReason1 standingInstruction) {
	...
	public InstructionProcessingStatus24Choice setProprietaryStatus(ProprietaryStatusAndReason6 proprietaryStatus) {
