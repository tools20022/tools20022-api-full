...
@XmlType(name = "RegistrationProcessingStatus1Choice", propOrder = {"code", "proprietary"})
public class RegistrationProcessingStatus1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RegistrationProcessingStatus3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the registration processing.";
			nextVersions_lazy = () -> Arrays.asList(RegistrationProcessingStatus3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(RegistrationProcessingStatus3Choice.mmObject());
			}
		});
	...
	public RegistrationProcessingStatus1Choice setCode(RegistrationProcessingStatus1Code code) {
	...
	public RegistrationProcessingStatus1Choice setProprietary(GenericIdentification20 proprietary) {
