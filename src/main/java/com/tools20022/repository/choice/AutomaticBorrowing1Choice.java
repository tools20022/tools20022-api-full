...
@XmlType(name = "AutomaticBorrowing1Choice", propOrder = {"code", "proprietary"})
public class AutomaticBorrowing1Choice {
	...
	public static final MMMessageAttribute<AutomaticBorrowing1Choice, AutoBorrowing1Code> mmCode = new MMMessageAttribute<AutomaticBorrowing1Choice, AutoBorrowing1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AutomaticBorrowing6Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<AutomaticBorrowing1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<AutomaticBorrowing1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AutomaticBorrowing6Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AutomaticBorrowing1Choice.mmCode, com.tools20022.repository.choice.AutomaticBorrowing1Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AutomaticBorrowing1Choice";
				definition = "Choice of format for the automatic borrowing information.";
				nextVersions_lazy = () -> Arrays.asList(AutomaticBorrowing6Choice.mmObject());
			}
		});
	...
	public AutomaticBorrowing1Choice setCode(AutoBorrowing1Code code) {
	...
	public AutomaticBorrowing1Choice setProprietary(GenericIdentification20 proprietary) {
