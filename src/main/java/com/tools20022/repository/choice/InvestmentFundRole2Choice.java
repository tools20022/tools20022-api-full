...
public class InvestmentFundRole2Choice {
	...
	public InvestmentFundRole2Choice setCode(InvestmentFundRole2Code code) {
	...
	public InvestmentFundRole2Choice setProprietary(GenericIdentification47 proprietary) {
