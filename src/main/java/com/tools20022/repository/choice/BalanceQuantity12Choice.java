...
public class BalanceQuantity12Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BalanceQuantity12Choice.Quantity, com.tools20022.repository.choice.BalanceQuantity12Choice.Proprietary);
