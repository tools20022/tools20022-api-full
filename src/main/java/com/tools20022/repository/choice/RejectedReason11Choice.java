 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RejectedReason11Choice#Code
...
public class RejectedReason11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedReason11Choice.Code, com.tools20022.repository.choice.RejectedReason11Choice.Proprietary);
