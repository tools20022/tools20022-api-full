...
@XmlType(name = "AllocationSatus2Choice", propOrder = {"code", "proprietary"})
public class AllocationSatus2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AllocationSatus2Choice, AllocationStatus1Code> mmCode = new MMMessageAttribute<AllocationSatus2Choice, AllocationStatus1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatus.mmCollateralAllocationStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.AllocationSatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public AllocationStatus1Code getValue(AllocationSatus2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AllocationSatus2Choice obj, AllocationStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AllocationSatus2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<AllocationSatus2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatus.mmCollateralAllocationStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.AllocationSatus2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(AllocationSatus2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AllocationSatus2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AllocationSatus2Choice.mmCode, com.tools20022.repository.choice.AllocationSatus2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AllocationSatus2Choice";
	...
	public AllocationSatus2Choice setCode(AllocationStatus1Code code) {
	...
	public AllocationSatus2Choice setProprietary(GenericIdentification25 proprietary) {
