...
public class PendingCancellationStatus6Choice {
	...
	public static final MMMessageAttribute mmNotSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingCancellationStatus6Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingCancellationStatus6Choice.mmNotSpecifiedReason, PendingCancellationStatus6Choice.mmReason);
	...
	public void setReason(List<PendingCancellationStatusReason6> reason) {
		this.reason = reason;
	}
}