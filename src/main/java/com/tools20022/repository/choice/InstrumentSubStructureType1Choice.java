...
import com.tools20022.repository.codeset.InstrumentSubStructureType1Code;
...
@XmlType(name = "InstrumentSubStructureType1Choice", propOrder = {"code", "proprietary"})
public class InstrumentSubStructureType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected InstrumentSubStructureType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstrumentSubStructureType1Choice.mmCode, com.tools20022.repository.choice.InstrumentSubStructureType1Choice.mmProprietary);
	...
	public InstrumentSubStructureType1Code getCode() {
		return code;
	}

	public InstrumentSubStructureType1Choice setCode(InstrumentSubStructureType1Code code) {
	...
	public InstrumentSubStructureType1Choice setProprietary(GenericIdentification40 proprietary) {
