...
public class SettlementFrequency1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementFrequency1Choice.mmCode, SettlementFrequency1Choice.mmProprietary);
	...
	public void setCode(EventFrequency10Code code) {
		this.code = code;
	}
