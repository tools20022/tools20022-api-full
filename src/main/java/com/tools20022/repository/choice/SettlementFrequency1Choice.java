 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementFrequency1Choice#Code
 * SettlementFrequency1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementFrequency1Choice#Proprietary
 * SettlementFrequency1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlementFrequency1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlementFrequency1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementFrequency1Choice.Code, com.tools20022.repository.choice.SettlementFrequency1Choice.Proprietary);
