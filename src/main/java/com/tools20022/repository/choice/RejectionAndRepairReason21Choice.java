...
public class RejectionAndRepairReason21Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionAndRepairReason21Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionAndRepairReason21Choice.mmCode, RejectionAndRepairReason21Choice.mmProprietary);
	...
	public void setCode(RejectionReason35Code code) {
		this.code = code;
	}
