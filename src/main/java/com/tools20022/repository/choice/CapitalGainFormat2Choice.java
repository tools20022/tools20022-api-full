...
public class CapitalGainFormat2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CapitalGainFormat2Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CapitalGainFormat2Choice.Code, com.tools20022.repository.choice.CapitalGainFormat2Choice.Proprietary);
