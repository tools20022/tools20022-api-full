...
@XmlType(name = "RenounceableEntitlementStatusTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class RenounceableEntitlementStatusTypeFormat1Choice {
	...
	public static final MMMessageAttribute<RenounceableEntitlementStatusTypeFormat1Choice, RenounceableStatus1Code> mmCode = new MMMessageAttribute<RenounceableEntitlementStatusTypeFormat1Choice, RenounceableStatus1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RenounceableEntitlementStatusTypeFormat3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<RenounceableEntitlementStatusTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<RenounceableEntitlementStatusTypeFormat1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RenounceableEntitlementStatusTypeFormat3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(com.tools20022.repository.choice.RenounceableEntitlementStatusTypeFormat1Choice.mmCode, com.tools20022.repository.choice.RenounceableEntitlementStatusTypeFormat1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionSecuritiesEntitlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RenounceableEntitlementStatusTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of the renounceable entitlement status.";
				nextVersions_lazy = () -> Arrays.asList(RenounceableEntitlementStatusTypeFormat3Choice.mmObject());
			}
		});
	...
	public RenounceableEntitlementStatusTypeFormat1Choice setCode(RenounceableStatus1Code code) {
	...
	public RenounceableEntitlementStatusTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
