...
public class PartyIdentification37Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification37Choice.mmAnyBIC, PartyIdentification37Choice.mmProprietaryIdentification, PartyIdentification37Choice.mmNameAndAddress, PartyIdentification37Choice.mmCountry);
