...
public class PriceFormat51Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat51Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat6Choice.PercentagePrice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat6Choice.AmountPrice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IndexPoints = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat6Choice.IndexPoints;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat51Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat51Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat51Choice.IndexPoints);
