...
@XmlType(name = "PriceFormat51Choice", propOrder = {"percentagePrice", "amountPrice", "indexPoints"})
public class PriceFormat51Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PriceFormat51Choice
	 * PriceFormat51Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat51Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat51Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat51Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
			...
			previousVersion_lazy = () -> PriceFormat6Choice.mmPercentagePrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat51Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat51Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat51Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat51Choice, AmountPrice3>() {
		{
			...
			previousVersion_lazy = () -> PriceFormat6Choice.mmAmountPrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPrice3 getValue(PriceFormat51Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat51Choice obj, AmountPrice3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat51Choice, DecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat51Choice, DecimalNumber>() {
		{
			...
			previousVersion_lazy = () -> PriceFormat6Choice.mmIndexPoints;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DecimalNumber getValue(PriceFormat51Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat51Choice obj, DecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat51Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat51Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat51Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PriceFormat51Choice";
				definition = "Choice between a percentage price or an amount price or index points.";
				previousVersion_lazy = () -> PriceFormat6Choice.mmObject();
			}
		});
	...
	public PriceFormat51Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat51Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat51Choice setIndexPoints(DecimalNumber indexPoints) {
