...
@XmlType(name = "AcknowledgementReason6Choice", propOrder = {"code", "proprietary"})
public class AcknowledgementReason6Choice {
	...
	public AcknowledgementReason6Choice setCode(AcknowledgementReason3Code code) {
	...
	public AcknowledgementReason6Choice setProprietary(GenericIdentification25 proprietary) {
