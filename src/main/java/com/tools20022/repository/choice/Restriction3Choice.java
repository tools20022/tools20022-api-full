 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Restriction3Choice#Code
 * Restriction3Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Restriction3Choice#Proprietary
 * Restriction3Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Restriction3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Restriction3Choice.Code, com.tools20022.repository.choice.Restriction3Choice.Proprietary);
