...
@XmlType(name = "AllocationSatus1Choice", propOrder = {"code", "proprietary"})
public class AllocationSatus1Choice {
	...
	public AllocationSatus1Choice setCode(AllocationStatus1Code code) {
	...
	public AllocationSatus1Choice setProprietary(GenericIdentification20 proprietary) {
