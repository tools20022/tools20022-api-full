...
public class SettlementTransactionCondition29Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTransactionCondition29Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTransactionCondition29Choice.mmCode, SettlementTransactionCondition29Choice.mmProprietary);
	...
	public void setCode(SettlementTransactionCondition8Code code) {
		this.code = code;
	}
