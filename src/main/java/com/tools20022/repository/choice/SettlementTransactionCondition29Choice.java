...
@XmlType(name = "SettlementTransactionCondition29Choice", propOrder = {"code", "proprietary"})
public class SettlementTransactionCondition29Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition29Choice.mmCode, com.tools20022.repository.choice.SettlementTransactionCondition29Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementTransactionCondition29Choice";
	...
	public SettlementTransactionCondition29Choice setCode(SettlementTransactionCondition8Code code) {
	...
	public SettlementTransactionCondition29Choice setProprietary(GenericIdentification47 proprietary) {
