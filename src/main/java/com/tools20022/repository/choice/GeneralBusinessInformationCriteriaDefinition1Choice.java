...
import com.tools20022.repository.msg.BusinessInformationCriteria1;
...
@XmlType(name = "GeneralBusinessInformationCriteriaDefinition1Choice", propOrder = {"queryName", "newCriteria"})
public class GeneralBusinessInformationCriteriaDefinition1Choice {
	...
	public static final MMMessageAttribute<GeneralBusinessInformationCriteriaDefinition1Choice, Max35Text> mmQueryName = new MMMessageAttribute<GeneralBusinessInformationCriteriaDefinition1Choice, Max35Text>() {
		{
			...
			previousVersion_lazy = () -> GeneralBusinessInformationCriteriaDefinitionChoice.mmQueryName;
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected BusinessInformationCriteria1 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<GeneralBusinessInformationCriteriaDefinition1Choice, BusinessInformationCriteria1> mmNewCriteria = new MMMessageAssociationEnd<GeneralBusinessInformationCriteriaDefinition1Choice, BusinessInformationCriteria1>() {
		{
			...
			previousVersion_lazy = () -> GeneralBusinessInformationCriteriaDefinitionChoice.mmNewCriteria;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GeneralBusinessInformationCriteriaDefinition1Choice.mmQueryName,
						com.tools20022.repository.choice.GeneralBusinessInformationCriteriaDefinition1Choice.mmNewCriteria);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GeneralBusinessInformationCriteriaDefinition1Choice";
				...
				previousVersion_lazy = () -> GeneralBusinessInformationCriteriaDefinitionChoice.mmObject();
			}
		});
	...
	public GeneralBusinessInformationCriteriaDefinition1Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public BusinessInformationCriteria1 getNewCriteria() {
		return newCriteria;
	}

	public GeneralBusinessInformationCriteriaDefinition1Choice setNewCriteria(BusinessInformationCriteria1 newCriteria) {
