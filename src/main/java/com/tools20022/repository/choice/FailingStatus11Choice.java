...
public class FailingStatus11Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus11Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus11Choice.mmNoSpecifiedReason, FailingStatus11Choice.mmReason);
	...
	public void setReason(List<FailingReason9> reason) {
		this.reason = reason;
	}
}