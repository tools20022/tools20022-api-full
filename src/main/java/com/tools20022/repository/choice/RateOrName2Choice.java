 ...
 * <li>{@linkplain com.tools20022.repository.choice.RateOrName2Choice#RateName
 * RateOrName2Choice.RateName}</li>
 * </ul>
 * </li>
...
public class RateOrName2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateOrName2Choice.Rate, com.tools20022.repository.choice.RateOrName2Choice.RateName);
