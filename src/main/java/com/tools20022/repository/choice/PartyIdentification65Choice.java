...
public class PartyIdentification65Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification65Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification65Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification65Choice.NameAndAddress);
