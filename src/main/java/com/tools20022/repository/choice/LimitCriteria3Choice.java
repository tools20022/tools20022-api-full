...
@XmlType(name = "LimitCriteria3Choice", propOrder = {"queryName", "newCriteria"})
public class LimitCriteria3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LimitCriteria3Choice, Max35Text> mmQueryName = new MMMessageAttribute<LimitCriteria3Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.LimitCriteria3Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
		...
		@Override
		public Max35Text getValue(LimitCriteria3Choice obj) {
			return obj.getQueryName();
		}

		@Override
		public void setValue(LimitCriteria3Choice obj, Max35Text value) {
			obj.setQueryName(value);
		}
	};
	@XmlElement(name = "NewCrit", required = true)
	protected LimitCriteria3 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.LimitCriteria3
	 * LimitCriteria3}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LimitCriteria3Choice, LimitCriteria3> mmNewCriteria = new MMMessageAssociationEnd<LimitCriteria3Choice, LimitCriteria3>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.LimitCriteria3Choice.mmObject();
			isDerived = false;
			xmlTag = "NewCrit";
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> LimitCriteria3.mmObject();
		}

		@Override
		public LimitCriteria3 getValue(LimitCriteria3Choice obj) {
			return obj.getNewCriteria();
		}

		@Override
		public void setValue(LimitCriteria3Choice obj, LimitCriteria3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LimitCriteria3Choice.mmQueryName, com.tools20022.repository.choice.LimitCriteria3Choice.mmNewCriteria);
	...
	public LimitCriteria3Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public LimitCriteria3 getNewCriteria() {
		return newCriteria;
	}

	public LimitCriteria3Choice setNewCriteria(LimitCriteria3 newCriteria) {
