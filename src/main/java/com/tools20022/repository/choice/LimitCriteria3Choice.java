 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.LimitCriteria3Choice#QueryName
 * LimitCriteria3Choice.QueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.LimitCriteria3Choice#NewCriteria
 * LimitCriteria3Choice.NewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class LimitCriteria3Choice {
	...
	public static final MMMessageAttribute QueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> LimitCriteria3Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LimitCriteria3Choice.QueryName, com.tools20022.repository.choice.LimitCriteria3Choice.NewCriteria);
