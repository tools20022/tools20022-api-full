...
@XmlType(name = "AutomaticBorrowing4Choice", propOrder = {"code", "proprietary"})
public class AutomaticBorrowing4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AutomaticBorrowing4Choice, AutoBorrowing1Code> mmCode = new MMMessageAttribute<AutomaticBorrowing4Choice, AutoBorrowing1Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public AutoBorrowing1Code getValue(AutomaticBorrowing4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AutomaticBorrowing4Choice obj, AutoBorrowing1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AutomaticBorrowing4Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<AutomaticBorrowing4Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing4Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(AutomaticBorrowing4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AutomaticBorrowing4Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AutomaticBorrowing4Choice.mmCode, com.tools20022.repository.choice.AutomaticBorrowing4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AutomaticBorrowing4Choice";
	...
	public AutomaticBorrowing4Choice setCode(AutoBorrowing1Code code) {
	...
	public AutomaticBorrowing4Choice setProprietary(GenericIdentification25 proprietary) {
