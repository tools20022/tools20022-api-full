 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat30Choice#Date
 * DateFormat30Choice.Date}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat30Choice#DateCode
 * DateFormat30Choice.DateCode}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateFormat30Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.DateFormat16Choice#Date
	 * DateFormat16Choice.Date}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute Date = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.DateFormat16Choice.Date;
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.DateFormat16Choice#DateCode
	 * DateFormat16Choice.DateCode}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd DateCode = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.DateFormat16Choice.DateCode;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat30Choice.Date, com.tools20022.repository.choice.DateFormat30Choice.DateCode);
