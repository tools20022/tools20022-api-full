 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType6Choice#mmCode
...
@XmlType(name = "ExposureType6Choice", propOrder = {"code", "proprietary"})
public class ExposureType6Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ExposureType6Choice
	 * ExposureType6Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType6Choice, ExposureType2Code> mmCode = new MMMessageAttribute<ExposureType6Choice, ExposureType2Code>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ExposureType2Code getValue(ExposureType6Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ExposureType6Choice obj, ExposureType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExposureType6Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ExposureType6Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType6Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(ExposureType6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ExposureType6Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType6Choice.mmCode, com.tools20022.repository.choice.ExposureType6Choice.mmProprietary);
	...
	public ExposureType6Choice setCode(ExposureType2Code code) {
	...
	public ExposureType6Choice setProprietary(GenericIdentification25 proprietary) {
