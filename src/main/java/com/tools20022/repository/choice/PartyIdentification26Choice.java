...
public class PartyIdentification26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification26Choice.BICOrBEI, com.tools20022.repository.choice.PartyIdentification26Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification26Choice.NameAndAddress);
