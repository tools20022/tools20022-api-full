...
public class PartyIdentification26Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification26Choice.mmBICOrBEI, PartyIdentification26Choice.mmProprietaryIdentification, PartyIdentification26Choice.mmNameAndAddress);
