...
public class MatchingStatus12Choice {
	...
	public MatchingStatus12Choice setMatched(ProprietaryReason1 matched) {
	...
	public MatchingStatus12Choice setProprietary(ProprietaryStatusAndReason1 proprietary) {
