...
public class SafekeepingPlaceFormat11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SafekeepingPlaceFormat11Choice.mmIdentification, SafekeepingPlaceFormat11Choice.mmCountry, SafekeepingPlaceFormat11Choice.mmTypeAndIdentification,
						SafekeepingPlaceFormat11Choice.mmProprietary);
