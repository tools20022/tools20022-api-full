...
public class SafekeepingPlaceFormat11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SafekeepingPlaceFormat11Choice.Identification, com.tools20022.repository.choice.SafekeepingPlaceFormat11Choice.Country,
						com.tools20022.repository.choice.SafekeepingPlaceFormat11Choice.TypeAndIdentification, com.tools20022.repository.choice.SafekeepingPlaceFormat11Choice.Proprietary);
