...
@XmlType(name = "CashSettlementSystem2Choice", propOrder = {"code", "proprietary"})
public class CashSettlementSystem2Choice {
	...
	public CashSettlementSystem2Choice setCode(CashSettlementSystem2Code code) {
	...
	public CashSettlementSystem2Choice setProprietary(GenericIdentification25 proprietary) {
