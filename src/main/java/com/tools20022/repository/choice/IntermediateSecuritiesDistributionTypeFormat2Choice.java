...
public class IntermediateSecuritiesDistributionTypeFormat2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat2Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat2Choice.mmProprietary);
	...
	public void setCode(IntermediateSecurityDistributionType2Code code) {
		this.code = code;
	}
