 ...
 * definition} =
 * "Choice of format between a rate, an amount or an unspecified rate."</li>
...
@XmlType(name = "RateAndAmountFormat37Choice", propOrder = {"rate", "notSpecifiedRate", "amount"})
public class RateAndAmountFormat37Choice {
	...
	public static final MMMessageAttribute<RateAndAmountFormat37Choice, PercentageRate> mmRate = new MMMessageAttribute<RateAndAmountFormat37Choice, PercentageRate>() {
		{
			...
			previousVersion_lazy = () -> RateAndAmountFormat14Choice.mmRate;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RateAndAmountFormat37Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RateAndAmountFormat37Choice, RateValueType7Code>() {
		{
			...
			previousVersion_lazy = () -> RateAndAmountFormat14Choice.mmNotSpecifiedRate;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RateAndAmountFormat37Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateAndAmountFormat37Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			...
			previousVersion_lazy = () -> RateAndAmountFormat14Choice.mmAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateAndAmountFormat37Choice.mmRate, com.tools20022.repository.choice.RateAndAmountFormat37Choice.mmNotSpecifiedRate,
						com.tools20022.repository.choice.RateAndAmountFormat37Choice.mmAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateAndAmountFormat37Choice";
				definition = "Choice of format between a rate, an amount or an unspecified rate.";
				previousVersion_lazy = () -> RateAndAmountFormat14Choice.mmObject();
			}
		});
	...
	public RateAndAmountFormat37Choice setRate(PercentageRate rate) {
	...
	public RateAndAmountFormat37Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RateAndAmountFormat37Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
