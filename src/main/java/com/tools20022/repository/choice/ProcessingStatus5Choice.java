...
public class ProcessingStatus5Choice {
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus4Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus5Choice.mmAcknowledgedAccepted, ProcessingStatus5Choice.mmRejected, ProcessingStatus5Choice.mmCompleted, ProcessingStatus5Choice.mmDenied,
						ProcessingStatus5Choice.mmProprietary, ProcessingStatus5Choice.mmPending);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus4Choice rejected) {
