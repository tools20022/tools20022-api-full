...
import com.tools20022.repository.msg.ConsentReason5;
...
public class ConsentStatus5Choice {
	...
	protected List<ConsentReason5> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.ConsentReason5
	 * ConsentReason5}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConsentStatus5Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.ConsentStatus5Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ConsentStatus5Choice";
	...
	public ConsentStatus5Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public ConsentStatus5Choice setReason(List<ConsentReason5> reason) {
