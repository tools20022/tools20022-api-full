...
@XmlType(name = "PreferenceToIncome3Choice", propOrder = {"code", "proprietary"})
public class PreferenceToIncome3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PreferenceToIncome3Choice.mmCode, com.tools20022.repository.choice.PreferenceToIncome3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PreferenceToIncome3Choice";
	...
	public PreferenceToIncome3Choice setCode(PreferenceToIncome1Code code) {
	...
	public PreferenceToIncome3Choice setProprietary(GenericIdentification25 proprietary) {
