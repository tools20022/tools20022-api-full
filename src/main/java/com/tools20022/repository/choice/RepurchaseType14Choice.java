...
@XmlType(name = "RepurchaseType14Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType14Choice, RepurchaseType2Code> mmCode = new MMMessageAttribute<RepurchaseType14Choice, RepurchaseType2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType23Choice.mmCode);
			previousVersion_lazy = () -> RepurchaseType1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RepurchaseType2Code getValue(RepurchaseType14Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType14Choice obj, RepurchaseType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType14Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RepurchaseType14Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType14Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RepurchaseType23Choice.mmProprietary);
			previousVersion_lazy = () -> RepurchaseType1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(RepurchaseType14Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType14Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType14Choice.mmCode, com.tools20022.repository.choice.RepurchaseType14Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType14Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				nextVersions_lazy = () -> Arrays.asList(RepurchaseType23Choice.mmObject());
				previousVersion_lazy = () -> RepurchaseType1Choice.mmObject();
			}
		});
	...
	public RepurchaseType14Choice setCode(RepurchaseType2Code code) {
	...
	public RepurchaseType14Choice setProprietary(GenericIdentification30 proprietary) {
