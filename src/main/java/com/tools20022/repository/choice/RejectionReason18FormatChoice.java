...
public class RejectionReason18FormatChoice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RejectionReason18FormatChoice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason18FormatChoice.Code, com.tools20022.repository.choice.RejectionReason18FormatChoice.Proprietary);
