...
public class ProcessingStatus61Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus61Choice.mmPendingCancellation, ProcessingStatus61Choice.mmRejected, ProcessingStatus61Choice.mmRepair, ProcessingStatus61Choice.mmAcknowledgedAccepted,
						ProcessingStatus61Choice.mmProprietary, ProcessingStatus61Choice.mmDenied, ProcessingStatus61Choice.mmCancelled);
