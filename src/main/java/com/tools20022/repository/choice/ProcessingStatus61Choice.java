...
public class ProcessingStatus61Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus61Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	public void setPendingCancellation(com.tools20022.repository.choice.PendingStatus51Choice pendingCancellation) {
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus35Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RejectionOrRepairStatus34Choice repair) {
		this.repair = repair;
	}
	...
	public void setDenied(com.tools20022.repository.choice.DeniedStatus21Choice denied) {
		this.denied = denied;
	}
	...
	public void setCancelled(com.tools20022.repository.choice.CancellationStatus20Choice cancelled) {
