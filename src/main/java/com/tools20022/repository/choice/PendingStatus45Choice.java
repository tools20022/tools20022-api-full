...
public class PendingStatus45Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus45Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus45Choice.mmNoSpecifiedReason, PendingStatus45Choice.mmReason);
	...
	public void setReason(List<PendingReason19> reason) {
		this.reason = reason;
	}
}