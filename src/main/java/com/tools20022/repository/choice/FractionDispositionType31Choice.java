...
public class FractionDispositionType31Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FractionDispositionType31Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FractionDispositionType31Choice.mmCode, FractionDispositionType31Choice.mmProprietary);
	...
	public void setCode(FractionDispositionType8Code code) {
		this.code = code;
	}
