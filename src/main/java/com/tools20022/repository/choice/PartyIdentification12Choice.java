...
public class PartyIdentification12Choice {
	...
	public static final MMMessageAttribute BICOrBEI = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification75Choice.AnyBIC);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NameAndAddress = new MMMessageAttribute() {
		{
			...
			name = "NameAndAddress";
			definition = "Unique and unambiguous way to identify an organisation.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification75Choice.NameAndAddress);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Country = new MMMessageAttribute() {
		{
			...
			name = "Country";
			definition = "Unique and unambiguous way to identify an organisation.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification75Choice.Country);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification12Choice.BICOrBEI, com.tools20022.repository.choice.PartyIdentification12Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification12Choice.Country);
