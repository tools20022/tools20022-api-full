...
public class CancellationProcessingStatus7Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancellationProcessingStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Provides the status of a cancellation request.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancellationProcessingStatus1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of a cancellation request.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.CancellationProcessingStatus1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(CancellationProcessingStatus1Code code) {
		this.code = code;
	}
