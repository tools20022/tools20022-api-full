...
@XmlType(name = "CancellationProcessingStatus7Choice", propOrder = {"code", "proprietary"})
public class CancellationProcessingStatus7Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CancellationProcessingStatus1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationProcessingStatus7Choice, CancellationProcessingStatus1Code> mmCode = new MMMessageAttribute<CancellationProcessingStatus7Choice, CancellationProcessingStatus1Code>() {
		{
			businessElementTrace_lazy = () -> Status.mmCancellationProcessingStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationProcessingStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> CancellationProcessingStatus1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CancellationProcessingStatus1Code getValue(CancellationProcessingStatus7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancellationProcessingStatus7Choice obj, CancellationProcessingStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationProcessingStatus7Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CancellationProcessingStatus7Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> Status.mmCancellationProcessingStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationProcessingStatus7Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Provides the status of a cancellation request.";
			previousVersion_lazy = () -> CancellationProcessingStatus1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CancellationProcessingStatus7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancellationProcessingStatus7Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationProcessingStatus7Choice.mmCode, com.tools20022.repository.choice.CancellationProcessingStatus7Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationProcessingStatus7Choice";
				definition = "Choice of cancellation processing status.";
				previousVersion_lazy = () -> CancellationProcessingStatus1Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public CancellationProcessingStatus1Code getCode() {
		return code;
	}

	public CancellationProcessingStatus7Choice setCode(CancellationProcessingStatus1Code code) {
	...
	public CancellationProcessingStatus7Choice setProprietary(GenericIdentification30 proprietary) {
