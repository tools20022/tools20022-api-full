...
import com.tools20022.repository.codeset.InvestorRestrictionType1Code;
 ...
 * trace} = {@linkplain com.tools20022.repository.entity.SecuritiesRestriction
...
@XmlType(name = "InvestorRestrictionType3Choice", propOrder = {"code", "proprietary"})
public class InvestorRestrictionType3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected InvestorRestrictionType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Investor restriction type expressed as an ISO 20022 code.";
			previousVersion_lazy = () -> InvestorRestrictionType2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> InvestorRestrictionType2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorRestrictionType3Choice.mmCode, com.tools20022.repository.choice.InvestorRestrictionType3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesRestriction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "InvestorRestrictionType3Choice";
				definition = "Choice of format for investor restriction type.";
				previousVersion_lazy = () -> InvestorRestrictionType2Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public InvestorRestrictionType1Code getCode() {
		return code;
	}

	public InvestorRestrictionType3Choice setCode(InvestorRestrictionType1Code code) {
	...
	public InvestorRestrictionType3Choice setProprietary(GenericIdentification30 proprietary) {
