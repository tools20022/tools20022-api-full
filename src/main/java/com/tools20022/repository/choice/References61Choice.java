 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.setr.OrderCancellationStatusReportV04#Reference
 * OrderCancellationStatusReportV04.Reference}</li>
 * <li>
...
public class References61Choice {
	...
	public static final MMMessageAssociationEnd RelatedReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References49Choice.RelatedReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References62Choice.PreviousReference);
			minOccurs = 1;
			maxOccurs = 2;
	...
	public static final MMMessageAssociationEnd OtherReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.References49Choice.OtherReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References62Choice.OtherReference);
			minOccurs = 1;
			maxOccurs = 2;
			type_lazy = () -> AdditionalReference8.mmObject();
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References61Choice.RelatedReference, com.tools20022.repository.choice.References61Choice.OtherReference);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.setr.OrderCancellationStatusReportV04.Reference, com.tools20022.repository.area.setr.OrderInstructionStatusReportV04.Reference,
						com.tools20022.repository.area.setr.OrderConfirmationStatusReportV02.Reference);
