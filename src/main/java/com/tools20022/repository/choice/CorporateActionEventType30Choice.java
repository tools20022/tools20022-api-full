...
public class CorporateActionEventType30Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType30Choice, CorporateActionEventType19Code> mmCode = new MMMessageAttribute<CorporateActionEventType30Choice, CorporateActionEventType19Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType30Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType56Choice.mmCode);
			previousVersion_lazy = () -> CorporateActionEventType15Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventType19Code getValue(CorporateActionEventType30Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventType30Choice obj, CorporateActionEventType19Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType30Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CorporateActionEventType30Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType30Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType56Choice.mmProprietary);
			previousVersion_lazy = () -> CorporateActionEventType15Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CorporateActionEventType30Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventType30Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventType30Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventType30Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionEventType30Choice);
	...
	public CorporateActionEventType30Choice setCode(CorporateActionEventType19Code code) {
	...
	public CorporateActionEventType30Choice setProprietary(GenericIdentification30 proprietary) {
