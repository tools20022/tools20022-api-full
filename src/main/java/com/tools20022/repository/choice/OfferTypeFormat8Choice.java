 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OfferTypeFormat8Choice#Code
...
public class OfferTypeFormat8Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OfferTypeFormat8Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferTypeFormat8Choice.Code, com.tools20022.repository.choice.OfferTypeFormat8Choice.Proprietary);
