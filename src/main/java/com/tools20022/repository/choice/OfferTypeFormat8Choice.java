...
@XmlType(name = "OfferTypeFormat8Choice", propOrder = {"code", "proprietary"})
public class OfferTypeFormat8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OfferTypeFormat8Choice, OfferType3Code> mmCode = new MMMessageAttribute<OfferTypeFormat8Choice, OfferType3Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOfferType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OfferTypeFormat8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OfferType3Code getValue(OfferTypeFormat8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OfferTypeFormat8Choice obj, OfferType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OfferTypeFormat8Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<OfferTypeFormat8Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOfferType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OfferTypeFormat8Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(OfferTypeFormat8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OfferTypeFormat8Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferTypeFormat8Choice.mmCode, com.tools20022.repository.choice.OfferTypeFormat8Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OfferTypeFormat8Choice";
	...
	public OfferTypeFormat8Choice setCode(OfferType3Code code) {
	...
	public OfferTypeFormat8Choice setProprietary(GenericIdentification25 proprietary) {
