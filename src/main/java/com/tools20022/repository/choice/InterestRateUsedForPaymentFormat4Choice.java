 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.InterestRateUsedForPaymentFormat4Choice#NotSpecifiedRate
 * InterestRateUsedForPaymentFormat4Choice.NotSpecifiedRate}</li>
 * </ul>
 * </li>
...
public class InterestRateUsedForPaymentFormat4Choice {
	...
	public static final MMMessageAttribute Rate = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InterestRateUsedForPaymentFormat4Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InterestRateUsedForPaymentFormat4Choice.Rate, com.tools20022.repository.choice.InterestRateUsedForPaymentFormat4Choice.Amount,
						com.tools20022.repository.choice.InterestRateUsedForPaymentFormat4Choice.RateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.InterestRateUsedForPaymentFormat4Choice.NotSpecifiedRate);
