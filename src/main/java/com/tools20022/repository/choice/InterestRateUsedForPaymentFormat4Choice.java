...
public class InterestRateUsedForPaymentFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat4Choice.mmRate, InterestRateUsedForPaymentFormat4Choice.mmAmount, InterestRateUsedForPaymentFormat4Choice.mmRateTypeAndAmountAndRateStatus,
						InterestRateUsedForPaymentFormat4Choice.mmNotSpecifiedRate);
