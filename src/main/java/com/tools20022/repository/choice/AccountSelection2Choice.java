...
public class AccountSelection2Choice {
	...
	public static final MMMessageAttribute AccountIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountSelection1Choice.AccountIdentification;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OtherAccountSelectionData = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountSelection1Choice.OtherAccountSelectionData;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountSelection2Choice.AccountIdentification, com.tools20022.repository.choice.AccountSelection2Choice.OtherAccountSelectionData);
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.acmt.AccountModificationInstructionV07.InvestmentAccountSelection);
