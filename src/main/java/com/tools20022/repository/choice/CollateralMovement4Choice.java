...
public class CollateralMovement4Choice {
	...
	public static final MMMessageAssociationEnd CollateralMovementDirection = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CollateralMovement3Choice.CollateralMovementDirection;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CollateralMovement5Choice.CollateralMovementDirection);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Return = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CollateralMovement3Choice.Return;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CollateralMovement5Choice.Return);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CollateralMovement4Choice.CollateralMovementDirection, com.tools20022.repository.choice.CollateralMovement4Choice.Return);
