...
@XmlType(name = "AccountIdentification23Choice", propOrder = {"forAllAccounts", "accountsListAndBalanceDetails"})
public class AccountIdentification23Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification23Choice, AccountIdentification10> mmForAllAccounts = new MMMessageAssociationEnd<AccountIdentification23Choice, AccountIdentification10>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification23Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32Choice.mmForAllAccounts);
			previousVersion_lazy = () -> AccountIdentification21Choice.mmForAllAccounts;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AccountIdentification10 getValue(AccountIdentification23Choice obj) {
			return obj.getForAllAccounts();
		}

		@Override
		public void setValue(AccountIdentification23Choice obj, AccountIdentification10 value) {
			obj.setForAllAccounts(value);
		}
	};
	@XmlElement(name = "AcctsListAndBalDtls", required = true)
	protected List<AccountAndBalance25> accountsListAndBalanceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification23Choice, List<AccountAndBalance25>> mmAccountsListAndBalanceDetails = new MMMessageAssociationEnd<AccountIdentification23Choice, List<AccountAndBalance25>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(AccountIdentification32Choice.mmAccountsListAndBalanceDetails);
			previousVersion_lazy = () -> AccountIdentification21Choice.mmAccountsListAndBalanceDetails;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<AccountAndBalance25> getValue(AccountIdentification23Choice obj) {
			return obj.getAccountsListAndBalanceDetails();
		}

		@Override
		public void setValue(AccountIdentification23Choice obj, List<AccountAndBalance25> value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification23Choice.mmForAllAccounts, com.tools20022.repository.choice.AccountIdentification23Choice.mmAccountsListAndBalanceDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNotificationV05.mmAccountDetails, CorporateActionMovementPreliminaryAdviceV05.mmAccountDetails, CorporateActionMovementPreliminaryAdviceV06.mmAccountDetails);
	...
	public AccountIdentification23Choice setForAllAccounts(AccountIdentification10 forAllAccounts) {
		this.forAllAccounts = Objects.requireNonNull(forAllAccounts);
		return this;
	}

	public List<AccountAndBalance25> getAccountsListAndBalanceDetails() {
		return accountsListAndBalanceDetails == null ? accountsListAndBalanceDetails = new ArrayList<>() : accountsListAndBalanceDetails;
	}

	public AccountIdentification23Choice setAccountsListAndBalanceDetails(List<AccountAndBalance25> accountsListAndBalanceDetails) {
