...
public class AccountIdentification23Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification32Choice.mmForAllAccounts);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountIdentification21Choice.mmForAllAccounts;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAccountsListAndBalanceDetails = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification32Choice.mmAccountsListAndBalanceDetails);
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountIdentification21Choice.mmAccountsListAndBalanceDetails;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionNotificationV05.mmAccountDetails,
						com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV05.mmAccountDetails, com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV06.mmAccountDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountAndBalance25> accountsListAndBalanceDetails) {
