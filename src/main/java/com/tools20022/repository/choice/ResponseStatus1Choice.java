...
@XmlType(name = "ResponseStatus1Choice", propOrder = {"code", "proprietary"})
public class ResponseStatus1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ResponseStatus1Choice, ResponseStatus1Code> mmCode = new MMMessageAttribute<ResponseStatus1Choice, ResponseStatus1Code>() {
		{
			businessElementTrace_lazy = () -> CollateralStatus.mmResponseStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.ResponseStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(ResponseStatus5Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ResponseStatus1Code getValue(ResponseStatus1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ResponseStatus1Choice obj, ResponseStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ResponseStatus1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<ResponseStatus1Choice, GenericIdentification20>() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the received collateral message (collateral claim, a collateral proposal or a proposal/request for collateral substitution) from a collateral management perspective.";
			nextVersions_lazy = () -> Arrays.asList(ResponseStatus5Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(ResponseStatus1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ResponseStatus1Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(ResponseStatus5Choice.mmObject());
			}
		});
	...
	public ResponseStatus1Choice setCode(ResponseStatus1Code code) {
	...
	public ResponseStatus1Choice setProprietary(GenericIdentification20 proprietary) {
