...
@XmlType(name = "PendingProcessingReason10Choice", propOrder = {"code", "proprietary"})
public class PendingProcessingReason10Choice {
	...
	public static final MMMessageAttribute<PendingProcessingReason10Choice, PendingProcessingReason2Code> mmCode = new MMMessageAttribute<PendingProcessingReason10Choice, PendingProcessingReason2Code>() {
		{
			...
			previousVersion_lazy = () -> PendingProcessingReason3Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<PendingProcessingReason10Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<PendingProcessingReason10Choice, GenericIdentification30>() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has a pending processing status.";
			previousVersion_lazy = () -> PendingProcessingReason3Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingReason10Choice.mmCode, com.tools20022.repository.choice.PendingProcessingReason10Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingReason10Choice";
				definition = "Choice of format for the pending processing reason.";
				previousVersion_lazy = () -> PendingProcessingReason3Choice.mmObject();
			}
		});
	...
	public PendingProcessingReason10Choice setCode(PendingProcessingReason2Code code) {
	...
	public PendingProcessingReason10Choice setProprietary(GenericIdentification30 proprietary) {
