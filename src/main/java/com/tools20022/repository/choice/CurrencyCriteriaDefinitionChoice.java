...
import com.tools20022.repository.msg.CurrencyExchangeCriteria;
...
@XmlType(name = "CurrencyCriteriaDefinitionChoice", propOrder = {"queryName", "newCriteria"})
public class CurrencyCriteriaDefinitionChoice {
	...
	public static final MMMessageAttribute<CurrencyCriteriaDefinitionChoice, Max35Text> mmQueryName = new MMMessageAttribute<CurrencyCriteriaDefinitionChoice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyCriteriaDefinition1Choice.mmQueryName);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<CurrencyCriteriaDefinitionChoice, CurrencyExchangeCriteria> mmNewCriteria = new MMMessageAssociationEnd<CurrencyCriteriaDefinitionChoice, CurrencyExchangeCriteria>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyCriteriaDefinition1Choice.mmNewCriteria);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(CurrencyCriteriaDefinition1Choice.mmObject());
			}
		});
	...
	public CurrencyCriteriaDefinitionChoice setQueryName(Max35Text queryName) {
	...
	public CurrencyCriteriaDefinitionChoice setNewCriteria(CurrencyExchangeCriteria newCriteria) {
