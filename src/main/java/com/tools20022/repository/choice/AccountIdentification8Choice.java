...
public class AccountIdentification8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification8Choice.ForAllAccounts, com.tools20022.repository.choice.AccountIdentification8Choice.AccountsListAndBalanceDetails);
