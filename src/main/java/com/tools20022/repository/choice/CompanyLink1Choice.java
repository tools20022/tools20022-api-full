 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.CompanyLink1Choice#Code
 * CompanyLink1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CompanyLink1Choice#Proprietary
 * CompanyLink1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class CompanyLink1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CompanyLink1Choice.Code, com.tools20022.repository.choice.CompanyLink1Choice.Proprietary);
