 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat3Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat3Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat3Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat3Choice}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RatioFormat20Choice
...
@XmlType(name = "RatioFormat3Choice", propOrder = {"quantityToQuantity", "amountToAmount"})
public class RatioFormat3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat3Choice, QuantityToQuantityRatio1> mmQuantityToQuantity = new MMMessageAssociationEnd<RatioFormat3Choice, QuantityToQuantityRatio1>() {
		{
			businessComponentTrace_lazy = () -> QuantityRatio.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat3Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
			...
			nextVersions_lazy = () -> Arrays.asList(RatioFormat20Choice.mmQuantityToQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public QuantityToQuantityRatio1 getValue(RatioFormat3Choice obj) {
			return obj.getQuantityToQuantity();
		}

		@Override
		public void setValue(RatioFormat3Choice obj, QuantityToQuantityRatio1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat3Choice, AmountToAmountRatio2> mmAmountToAmount = new MMMessageAssociationEnd<RatioFormat3Choice, AmountToAmountRatio2>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RatioFormat20Choice.mmAmountToAmount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountToAmountRatio2 getValue(RatioFormat3Choice obj) {
			return obj.getAmountToAmount();
		}

		@Override
		public void setValue(RatioFormat3Choice obj, AmountToAmountRatio2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat3Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat3Choice.mmAmountToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat3Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat3Choice);
				...
				name = "RatioFormat3Choice";
				definition = "Choice of format to expressed a ratio.";
				nextVersions_lazy = () -> Arrays.asList(RatioFormat20Choice.mmObject());
			}
		});
	...
	public RatioFormat3Choice setQuantityToQuantity(QuantityToQuantityRatio1 quantityToQuantity) {
	...
	public RatioFormat3Choice setAmountToAmount(AmountToAmountRatio2 amountToAmount) {
