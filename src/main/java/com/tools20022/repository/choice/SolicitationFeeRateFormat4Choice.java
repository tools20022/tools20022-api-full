 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.SolicitationFeeRateFormat4Choice#NotSpecifiedRate
 * SolicitationFeeRateFormat4Choice.NotSpecifiedRate}</li>
 * <li>
...
public class SolicitationFeeRateFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SolicitationFeeRateFormat4Choice.Rate, com.tools20022.repository.choice.SolicitationFeeRateFormat4Choice.NotSpecifiedRate,
						com.tools20022.repository.choice.SolicitationFeeRateFormat4Choice.AmountToQuantity);
