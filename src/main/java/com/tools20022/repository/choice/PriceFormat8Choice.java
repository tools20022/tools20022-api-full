...
public class PriceFormat8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat8Choice.mmPercentagePrice, PriceFormat8Choice.mmAmountPrice, PriceFormat8Choice.mmNotSpecifiedPrice, PriceFormat8Choice.mmIndexPoints);
