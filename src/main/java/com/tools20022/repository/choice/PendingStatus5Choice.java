...
public class PendingStatus5Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus5Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus5Choice.mmNoSpecifiedReason, PendingStatus5Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason3> reason) {
		this.reason = reason;
	}
}