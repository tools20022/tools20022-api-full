...
public class PartyIdentification63Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification63Choice.mmAnyBIC, PartyIdentification63Choice.mmProprietaryIdentification, PartyIdentification63Choice.mmNameAndAddress);
