...
import com.tools20022.repository.codeset.OptionEventType1Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.OptionEventType1Choice#mmCode
 * OptionEventType1Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.OptionEventType1Choice#mmProprietary
 * OptionEventType1Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * definition} = "Choice of formats to specify the type of option event."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "OptionEventType1Choice", propOrder = {"code", "proprietary"})
public class OptionEventType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected OptionEventType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<OptionEventType1Choice, OptionEventType1Code> mmCode = new MMMessageAttribute<OptionEventType1Choice, OptionEventType1Code>() {
		{
			...
			name = "Code";
			definition = "Specifies the type of event for an option using a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<OptionEventType1Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<OptionEventType1Choice, GenericIdentification30>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Specifies the type of event for an option using a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionEventType1Choice.mmCode, com.tools20022.repository.choice.OptionEventType1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "OptionEventType1Choice";
				definition = "Choice of formats to specify the type of option event.";
			}
		});
		return mmObject_lazy.get();
	}

	public OptionEventType1Code getCode() {
		return code;
	}

	public OptionEventType1Choice setCode(OptionEventType1Code code) {
	...
	public OptionEventType1Choice setProprietary(GenericIdentification30 proprietary) {
