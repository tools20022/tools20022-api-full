...
public class ProcessingStatus9Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus9Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus9Choice.mmPendingCancellation, ProcessingStatus9Choice.mmRejected, ProcessingStatus9Choice.mmRepair, ProcessingStatus9Choice.mmAcknowledgedAccepted,
						ProcessingStatus9Choice.mmProprietary, ProcessingStatus9Choice.mmDenied, ProcessingStatus9Choice.mmCancelled);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus8Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RejectionOrRepairStatus8Choice repair) {
		this.repair = repair;
	}
	...
	public void setCancelled(com.tools20022.repository.choice.CancellationStatus5Choice cancelled) {
