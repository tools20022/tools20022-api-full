...
public class Status9Choice {
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status15Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd MatchingStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status15Choice.MatchingStatus);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InferredMatchingStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status15Choice.InferredMatchingStatus);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> MatchingStatus7Choice.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd SettlementStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status15Choice.SettlementStatus);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd InstructionProcessingStatus = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status15Choice.InstructionProcessingStatus);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status9Choice.Proprietary, com.tools20022.repository.choice.Status9Choice.MatchingStatus,
						com.tools20022.repository.choice.Status9Choice.InferredMatchingStatus, com.tools20022.repository.choice.Status9Choice.SettlementStatus, com.tools20022.repository.choice.Status9Choice.InstructionProcessingStatus);
