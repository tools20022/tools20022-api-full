...
public class PriceFormat56Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat56Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat56Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat56Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat56Choice.AmountPricePerFinancialInstrumentQuantity, com.tools20022.repository.choice.PriceFormat56Choice.AmountPricePerAmount,
						com.tools20022.repository.choice.PriceFormat56Choice.IndexPoints);
