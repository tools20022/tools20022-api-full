...
public class IntraPositionProcessingStatus1Choice {
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus2Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionProcessingStatus1Choice.mmRejected, IntraPositionProcessingStatus1Choice.mmRepair, IntraPositionProcessingStatus1Choice.mmCancelled,
						IntraPositionProcessingStatus1Choice.mmAcknowledgedAccepted, IntraPositionProcessingStatus1Choice.mmProprietary);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus2Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RejectionOrRepairStatus2Choice repair) {
		this.repair = repair;
	}
