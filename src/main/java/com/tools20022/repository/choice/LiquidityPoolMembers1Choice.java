 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.LiquidityPoolMembers1Choice#HeadMemberDetails
 * LiquidityPoolMembers1Choice.HeadMemberDetails}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.LiquidityPoolMembers1Choice#SubordinateMemberDetails
 * LiquidityPoolMembers1Choice.SubordinateMemberDetails}</li>
 * </ul>
 * </li>
 * <li>
...
public class LiquidityPoolMembers1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd HeadMemberDetails = new MMMessageAssociationEnd() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd SubordinateMemberDetails = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> LiquidityPoolMembers1Choice.mmObject();
			isDerived = false;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LiquidityPoolMembers1Choice.HeadMemberDetails, com.tools20022.repository.choice.LiquidityPoolMembers1Choice.SubordinateMemberDetails);
