...
@XmlType(name = "CalculationType2Choice", propOrder = {"code", "proprietary"})
public class CalculationType2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CalculationType2Choice, CalculationType1Code> mmCode = new MMMessageAttribute<CalculationType2Choice, CalculationType1Code>() {
		{
			businessElementTrace_lazy = () -> YieldCalculation.mmCalculationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CalculationType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Calculation type expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(CalculationType3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CalculationType1Code getValue(CalculationType2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CalculationType2Choice obj, CalculationType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CalculationType2Choice, GenericIdentification40> mmProprietary = new MMMessageAssociationEnd<CalculationType2Choice, GenericIdentification40>() {
		{
			businessElementTrace_lazy = () -> YieldCalculation.mmCalculationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CalculationType2Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CalculationType3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification40 getValue(CalculationType2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CalculationType2Choice obj, GenericIdentification40 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CalculationType2Choice.mmCode, com.tools20022.repository.choice.CalculationType2Choice.mmProprietary);
				trace_lazy = () -> YieldCalculation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "CalculationType2Choice";
				definition = "Choice of format for calculation type.";
				nextVersions_lazy = () -> Arrays.asList(CalculationType3Choice.mmObject());
			}
		});
	...
	public CalculationType2Choice setCode(CalculationType1Code code) {
	...
	public CalculationType2Choice setProprietary(GenericIdentification40 proprietary) {
