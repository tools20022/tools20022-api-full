...
@XmlType(name = "SecuritiesTransactionType10Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType10Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionType10Choice, SecuritiesTransactionType8Code> mmCode = new MMMessageAttribute<SecuritiesTransactionType10Choice, SecuritiesTransactionType8Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType10Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType18Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SecuritiesTransactionType8Code getValue(SecuritiesTransactionType10Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SecuritiesTransactionType10Choice obj, SecuritiesTransactionType8Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionType10Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<SecuritiesTransactionType10Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType10Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType18Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(SecuritiesTransactionType10Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SecuritiesTransactionType10Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesTransactionType10Choice.mmCode, com.tools20022.repository.choice.SecuritiesTransactionType10Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTransactionType10Choice";
				definition = "Choice of format for the repair reason.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType18Choice.mmObject());
				previousVersion_lazy = () -> SecuritiesTransactionType3Choice.mmObject();
			}
		});
	...
	public SecuritiesTransactionType10Choice setCode(SecuritiesTransactionType8Code code) {
	...
	public SecuritiesTransactionType10Choice setProprietary(GenericIdentification20 proprietary) {
