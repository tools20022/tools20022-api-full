 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.ConsentOrRejectionReason2Choice
 * ConsentOrRejectionReason2Choice}</li>
 * </ul>
 */
public class ConsentOrRejectionReason4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ConsentOrRejectionReason4Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentOrRejectionReason2Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the counterparty response has a  rejection status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentOrRejectionReason2Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConsentOrRejectionReason4Choice.Code, com.tools20022.repository.choice.ConsentOrRejectionReason4Choice.Proprietary);
				...
				previousVersion_lazy = () -> ConsentOrRejectionReason2Choice.mmObject();
			}
		});
