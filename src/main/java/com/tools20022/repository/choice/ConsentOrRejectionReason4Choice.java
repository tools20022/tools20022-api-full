	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentOrRejectionReason2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the counterparty response has a  rejection status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentOrRejectionReason2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
