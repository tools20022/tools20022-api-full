...
public class ConsentOrRejectionReason4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ConsentOrRejectionReason2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the counterparty response has a  rejection status.";
			previousVersion_lazy = () -> ConsentOrRejectionReason2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ConsentOrRejectionReason4Choice.mmCode, ConsentOrRejectionReason4Choice.mmProprietary);
