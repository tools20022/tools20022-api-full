 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.Reason3Choice Reason3Choice}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "Reason18Choice", propOrder = {"reason", "noSpecifiedReason"})
public class Reason18Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Reason18Choice
	 * Reason18Choice}</li>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Reason3Choice#mmReason
	...
	public static final MMMessageAssociationEnd<Reason18Choice, List<ProprietaryReason4>> mmReason = new MMMessageAssociationEnd<Reason18Choice, List<ProprietaryReason4>>() {
		{
			...
			previousVersion_lazy = () -> Reason3Choice.mmReason;
			minOccurs = 0;
			isComposite = true;
	...
	public static final MMMessageAttribute<Reason18Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<Reason18Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> Reason3Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason18Choice.mmReason, com.tools20022.repository.choice.Reason18Choice.mmNoSpecifiedReason);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "Reason18Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				previousVersion_lazy = () -> Reason3Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public List<ProprietaryReason4> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public Reason18Choice setReason(List<ProprietaryReason4> reason) {
	...
	public Reason18Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
