...
public class InvestmentAccountType1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InvestmentAccountType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccountType1Choice.mmCode, InvestmentAccountType1Choice.mmProprietary);
	...
	public void setCode(FundCashAccount2Code code) {
		this.code = code;
	}
