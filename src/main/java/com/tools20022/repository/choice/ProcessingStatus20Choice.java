...
public class ProcessingStatus20Choice {
	...
	public static final MMMessageAssociationEnd PendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.PendingCancellation, com.tools20022.repository.choice.ProcessingStatus53Choice.PendingCancellation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Rejected = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.Rejected, com.tools20022.repository.choice.ProcessingStatus53Choice.Rejected);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Repair = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.Repair, com.tools20022.repository.choice.ProcessingStatus53Choice.Repair);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.AcknowledgedAccepted, com.tools20022.repository.choice.ProcessingStatus53Choice.AcknowledgedAccepted);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.Proprietary, com.tools20022.repository.choice.ProcessingStatus53Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Denied = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.Denied, com.tools20022.repository.choice.ProcessingStatus53Choice.Denied);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Cancelled = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus45Choice.Cancelled, com.tools20022.repository.choice.ProcessingStatus53Choice.Cancelled);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus20Choice.PendingCancellation, com.tools20022.repository.choice.ProcessingStatus20Choice.Rejected,
						com.tools20022.repository.choice.ProcessingStatus20Choice.Repair, com.tools20022.repository.choice.ProcessingStatus20Choice.AcknowledgedAccepted,
						com.tools20022.repository.choice.ProcessingStatus20Choice.Proprietary, com.tools20022.repository.choice.ProcessingStatus20Choice.Denied, com.tools20022.repository.choice.ProcessingStatus20Choice.Cancelled);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestStatusAdviceV03.ProcessingStatus);
