...
@XmlType(name = "PreferenceToIncome5Choice", propOrder = {"code", "proprietary"})
public class PreferenceToIncome5Choice {
	...
	public static final MMMessageAttribute<PreferenceToIncome5Choice, PreferenceToIncome1Code> mmCode = new MMMessageAttribute<PreferenceToIncome5Choice, PreferenceToIncome1Code>() {
		{
			...
			previousVersion_lazy = () -> PreferenceToIncome4Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<PreferenceToIncome5Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<PreferenceToIncome5Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> PreferenceToIncome4Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PreferenceToIncome5Choice.mmCode, com.tools20022.repository.choice.PreferenceToIncome5Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PreferenceToIncome5Choice";
				definition = "Choice of format for Preference to income.";
				previousVersion_lazy = () -> PreferenceToIncome4Choice.mmObject();
			}
		});
	...
	public PreferenceToIncome5Choice setCode(PreferenceToIncome1Code code) {
	...
	public PreferenceToIncome5Choice setProprietary(GenericIdentification30 proprietary) {
