...
public class RateType10Choice {
	 ...
	 * {@linkplain com.tools20022.repository.entity.Tax#TaxRateType
	 * Tax.TaxRateType}</li>
	 * <li>
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateType10Choice.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.Tax.TaxRateType;
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of tax rate.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType37Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType37Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType10Choice.Code, com.tools20022.repository.choice.RateType10Choice.Proprietary);
