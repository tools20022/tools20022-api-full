...
public class FinancialInstrumentQuantity17Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity17Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity17Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity17Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity17Choice.Code);
