...
public class PartyIdentification87Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification87Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification87Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification87Choice.NameAndAddress);
