...
public class PriceFormat40Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat40Choice.mmPercentagePrice, PriceFormat40Choice.mmAmountPrice, PriceFormat40Choice.mmNotSpecifiedPrice, PriceFormat40Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat40Choice.mmAmountPricePerAmount, PriceFormat40Choice.mmIndexPoints);
