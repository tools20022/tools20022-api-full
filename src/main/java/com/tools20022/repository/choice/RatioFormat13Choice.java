 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.RatioFormat13Choice#mmNotSpecifiedRate
 * RatioFormat13Choice.mmNotSpecifiedRate}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat13Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat13Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat13Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat13Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "RatioFormat13Choice", propOrder = {"quantityToQuantity", "notSpecifiedRate", "amountToAmount"})
public class RatioFormat13Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat13Choice, QuantityToQuantityRatio2> mmQuantityToQuantity = new MMMessageAssociationEnd<RatioFormat13Choice, QuantityToQuantityRatio2>() {
		{
			businessComponentTrace_lazy = () -> QuantityRatio.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat13Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
		...
		@Override
		public QuantityToQuantityRatio2 getValue(RatioFormat13Choice obj) {
			return obj.getQuantityToQuantity();
		}

		@Override
		public void setValue(RatioFormat13Choice obj, QuantityToQuantityRatio2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RatioFormat13Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RatioFormat13Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat13Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(RatioFormat13Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RatioFormat13Choice obj, RateValueType7Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat13Choice, AmountToAmountRatio3> mmAmountToAmount = new MMMessageAssociationEnd<RatioFormat13Choice, AmountToAmountRatio3>() {
		{
		...
		@Override
		public AmountToAmountRatio3 getValue(RatioFormat13Choice obj) {
			return obj.getAmountToAmount();
		}

		@Override
		public void setValue(RatioFormat13Choice obj, AmountToAmountRatio3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat13Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat13Choice.mmNotSpecifiedRate,
						com.tools20022.repository.choice.RatioFormat13Choice.mmAmountToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat13Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat13Choice);
	...
	public RatioFormat13Choice setQuantityToQuantity(QuantityToQuantityRatio2 quantityToQuantity) {
	...
	public RatioFormat13Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RatioFormat13Choice setAmountToAmount(AmountToAmountRatio3 amountToAmount) {
