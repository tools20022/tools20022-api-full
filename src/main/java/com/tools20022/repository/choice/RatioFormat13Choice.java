...
public class RatioFormat13Choice {
	...
	public static final MMMessageAssociationEnd mmQuantityToQuantity = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RatioFormat13Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RatioFormat13Choice.mmQuantityToQuantity, RatioFormat13Choice.mmNotSpecifiedRate, RatioFormat13Choice.mmAmountToAmount);
