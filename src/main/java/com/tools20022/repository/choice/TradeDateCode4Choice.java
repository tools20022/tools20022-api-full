 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TradeDateCode4Choice#Code
 * TradeDateCode4Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.TradeDateCode4Choice#Proprietary
 * TradeDateCode4Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class TradeDateCode4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TradeDateCode4Choice.Code, com.tools20022.repository.choice.TradeDateCode4Choice.Proprietary);
