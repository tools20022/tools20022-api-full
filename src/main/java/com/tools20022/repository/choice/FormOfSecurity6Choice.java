...
@XmlType(name = "FormOfSecurity6Choice", propOrder = {"code", "proprietary"})
public class FormOfSecurity6Choice {
	...
	public static final MMMessageAttribute<FormOfSecurity6Choice, FormOfSecurity1Code> mmCode = new MMMessageAttribute<FormOfSecurity6Choice, FormOfSecurity1Code>() {
		{
			...
			previousVersion_lazy = () -> FormOfSecurity2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<FormOfSecurity6Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<FormOfSecurity6Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> FormOfSecurity2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FormOfSecurity6Choice.mmCode, com.tools20022.repository.choice.FormOfSecurity6Choice.mmProprietary);
				trace_lazy = () -> Security.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FormOfSecurity6Choice";
				definition = "Choice of format for the form of securities.";
				previousVersion_lazy = () -> FormOfSecurity2Choice.mmObject();
			}
		});
	...
	public FormOfSecurity6Choice setCode(FormOfSecurity1Code code) {
	...
	public FormOfSecurity6Choice setProprietary(GenericIdentification30 proprietary) {
