...
public class CorporateActionEventType9Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType9Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType9Choice.mmCode, CorporateActionEventType9Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType8Code code) {
		this.code = code;
	}
