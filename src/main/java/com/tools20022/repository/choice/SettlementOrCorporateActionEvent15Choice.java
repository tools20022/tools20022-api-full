...
public class SettlementOrCorporateActionEvent15Choice {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementOrCorporateActionEvent15Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType30Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent15Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent15Choice.mmCorporateActionEventType);
	...
	public void setSecuritiesTransactionType(com.tools20022.repository.choice.SecuritiesTransactionType30Choice securitiesTransactionType) {
