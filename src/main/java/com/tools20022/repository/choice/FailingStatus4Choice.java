 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.FailingStatus5Choice
...
@XmlType(name = "FailingStatus4Choice", propOrder = {"noSpecifiedReason", "reason"})
public class FailingStatus4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FailingStatus4Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<FailingStatus4Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.FailingStatus4Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(FailingStatus9Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NoReasonCode getValue(FailingStatus4Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(FailingStatus4Choice obj, NoReasonCode value) {
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.FailingReason4
	 * FailingReason4}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FailingStatus4Choice, List<FailingReason4>> mmReason = new MMMessageAssociationEnd<FailingStatus4Choice, List<FailingReason4>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FailingStatus9Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<FailingReason4> getValue(FailingStatus4Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(FailingStatus4Choice obj, List<FailingReason4> value) {
			obj.setReason(value);
		}
	};
	...
	public FailingStatus4Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public FailingStatus4Choice setReason(List<FailingReason4> reason) {
