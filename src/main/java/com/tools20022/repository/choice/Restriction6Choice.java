 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Restriction6Choice#mmCode
 * Restriction6Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Restriction6Choice#mmProprietary
 * Restriction6Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Restriction6Choice", propOrder = {"code", "proprietary"})
public class Restriction6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Restriction6Choice.mmCode, com.tools20022.repository.choice.Restriction6Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Restriction6Choice";
	...
	public Restriction6Choice setCode(OwnershipLegalRestrictions1Code code) {
	...
	public Restriction6Choice setProprietary(GenericIdentification47 proprietary) {
