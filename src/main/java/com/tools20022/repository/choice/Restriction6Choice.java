 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Restriction6Choice#Code
 * Restriction6Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Restriction6Choice#Proprietary
 * Restriction6Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Restriction6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Restriction6Choice.Code, com.tools20022.repository.choice.Restriction6Choice.Proprietary);
