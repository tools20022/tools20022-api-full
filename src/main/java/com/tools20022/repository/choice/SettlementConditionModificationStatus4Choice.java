 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementConditionModificationStatus4Choice#Proprietary
 * SettlementConditionModificationStatus4Choice.Proprietary}</li>
 * </ul>
 * </li>
...
public class SettlementConditionModificationStatus4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlementConditionModificationStatus4Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementConditionModificationStatus4Choice.Code, com.tools20022.repository.choice.SettlementConditionModificationStatus4Choice.Proprietary);
