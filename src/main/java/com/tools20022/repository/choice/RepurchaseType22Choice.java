...
@XmlType(name = "RepurchaseType22Choice", propOrder = {"code", "proprietary"})
public class RepurchaseType22Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType22Choice, RepurchaseType9Code> mmCode = new MMMessageAttribute<RepurchaseType22Choice, RepurchaseType9Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> RepurchaseType12Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RepurchaseType9Code getValue(RepurchaseType22Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RepurchaseType22Choice obj, RepurchaseType9Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RepurchaseType22Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RepurchaseType22Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesFinancing.mmRepurchaseType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RepurchaseType22Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> RepurchaseType12Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(RepurchaseType22Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RepurchaseType22Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepurchaseType22Choice.mmCode, com.tools20022.repository.choice.RepurchaseType22Choice.mmProprietary);
				trace_lazy = () -> SecuritiesFinancing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RepurchaseType22Choice";
				definition = "Choice of format for the repurchase transaction type information.";
				previousVersion_lazy = () -> RepurchaseType12Choice.mmObject();
			}
		});
	...
	public RepurchaseType22Choice setCode(RepurchaseType9Code code) {
	...
	public RepurchaseType22Choice setProprietary(GenericIdentification30 proprietary) {
