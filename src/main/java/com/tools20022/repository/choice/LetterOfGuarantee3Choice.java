...
public class LetterOfGuarantee3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LetterOfGuarantee3Choice.Indicator, com.tools20022.repository.choice.LetterOfGuarantee3Choice.Proprietary);
