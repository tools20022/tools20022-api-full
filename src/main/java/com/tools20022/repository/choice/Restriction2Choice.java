 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Restriction2Choice#Code
 * Restriction2Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Restriction2Choice#Proprietary
 * Restriction2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Restriction2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Restriction2Choice.Code, com.tools20022.repository.choice.Restriction2Choice.Proprietary);
