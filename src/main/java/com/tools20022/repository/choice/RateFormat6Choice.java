 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateFormat6Choice#mmRate
 * RateFormat6Choice.mmRate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateFormat6Choice#mmNotSpecifiedRate
 * RateFormat6Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "RateFormat6Choice", propOrder = {"rate", "notSpecifiedRate"})
public class RateFormat6Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat6Choice, PercentageRate> mmRate = new MMMessageAttribute<RateFormat6Choice, PercentageRate>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
		...
		@Override
		public PercentageRate getValue(RateFormat6Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(RateFormat6Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat6Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RateFormat6Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(RateFormat6Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RateFormat6Choice obj, RateValueType7Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateFormat6Choice.mmRate, com.tools20022.repository.choice.RateFormat6Choice.mmNotSpecifiedRate);
	...
	public RateFormat6Choice setRate(PercentageRate rate) {
	...
	public RateFormat6Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
