...
@XmlType(name = "CorporateActionProcessingStatus2Choice", propOrder = {"code", "proprietary"})
public class CorporateActionProcessingStatus2Choice {
	...
	public CorporateActionProcessingStatus2Choice setProprietary(GenericIdentification20 proprietary) {
