...
public class LinkedMessage3Choice {
	...
	public static final MMMessageAssociationEnd PreviousReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.LinkedMessage2Choice.PreviousReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LinkedMessage4Choice.PreviousReference);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OtherReference = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.LinkedMessage2Choice.OtherReference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LinkedMessage4Choice.OtherReference);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> AdditionalReference6.mmObject();
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LinkedMessage3Choice.PreviousReference, com.tools20022.repository.choice.LinkedMessage3Choice.OtherReference);
