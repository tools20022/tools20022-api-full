...
public class PaymentStatusCode5Choice {
	...
	public static final MMMessageAttribute Pending = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode6Choice.Pending);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Final = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode6Choice.Final);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute RTGS = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode6Choice.RTGS);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Settlement = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode6Choice.Settlement);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max4AlphaNumericText.mmObject();
		}
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode6Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max4AlphaNumericText.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PaymentStatusCode5Choice.Pending, com.tools20022.repository.choice.PaymentStatusCode5Choice.Final,
						com.tools20022.repository.choice.PaymentStatusCode5Choice.RTGS, com.tools20022.repository.choice.PaymentStatusCode5Choice.Settlement, com.tools20022.repository.choice.PaymentStatusCode5Choice.Proprietary);
