...
public class AcknowledgedAcceptedStatus25Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus25Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus25Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus25Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason13> reason) {
		this.reason = reason;
	}
}