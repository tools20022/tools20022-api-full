...
public class RejectedStatus16Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatus16Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatus16Choice.mmNoSpecifiedReason, RejectedStatus16Choice.mmReason);
	...
	public void setReason(List<RejectedStatusReason16> reason) {
		this.reason = reason;
	}
}