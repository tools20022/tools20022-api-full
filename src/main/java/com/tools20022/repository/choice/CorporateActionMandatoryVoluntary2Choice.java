...
@XmlType(name = "CorporateActionMandatoryVoluntary2Choice", propOrder = {"code", "proprietary"})
public class CorporateActionMandatoryVoluntary2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionMandatoryVoluntary2Choice.mmCode, com.tools20022.repository.choice.CorporateActionMandatoryVoluntary2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionMandatoryVoluntary2Choice";
	...
	public CorporateActionMandatoryVoluntary2Choice setCode(CorporateActionMandatoryVoluntary1Code code) {
	...
	public CorporateActionMandatoryVoluntary2Choice setProprietary(GenericIdentification25 proprietary) {
