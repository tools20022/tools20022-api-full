...
public class CorporateActionMandatoryVoluntary2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionMandatoryVoluntary2Choice.Code, com.tools20022.repository.choice.CorporateActionMandatoryVoluntary2Choice.Proprietary);
