...
import com.tools20022.repository.msg.AccountIdentification37;
...
@XmlType(name = "AccountIdentification37Choice", propOrder = {"forAllAccounts", "accountsListAndBalanceDetails"})
public class AccountIdentification37Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification37Choice, AccountIdentification10> mmForAllAccounts = new MMMessageAssociationEnd<AccountIdentification37Choice, AccountIdentification10>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification37Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
		...
		@Override
		public AccountIdentification10 getValue(AccountIdentification37Choice obj) {
			return obj.getForAllAccounts();
		}

		@Override
		public void setValue(AccountIdentification37Choice obj, AccountIdentification10 value) {
			obj.setForAllAccounts(value);
		}
	};
	@XmlElement(name = "AcctsListAndBalDtls", required = true)
	protected List<AccountIdentification37> accountsListAndBalanceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification37Choice, List<AccountIdentification37>> mmAccountsListAndBalanceDetails = new MMMessageAssociationEnd<AccountIdentification37Choice, List<AccountIdentification37>>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification37Choice.mmObject();
			isDerived = false;
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> AccountIdentification37.mmObject();
		}

		@Override
		public List<AccountIdentification37> getValue(AccountIdentification37Choice obj) {
			return obj.getAccountsListAndBalanceDetails();
		}

		@Override
		public void setValue(AccountIdentification37Choice obj, List<AccountIdentification37> value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification37Choice.mmForAllAccounts, com.tools20022.repository.choice.AccountIdentification37Choice.mmAccountsListAndBalanceDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionNarrative002V04.mmAccountDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountIdentification37Choice";
	...
	public AccountIdentification37Choice setForAllAccounts(AccountIdentification10 forAllAccounts) {
		this.forAllAccounts = Objects.requireNonNull(forAllAccounts);
		return this;
	}

	public List<AccountIdentification37> getAccountsListAndBalanceDetails() {
		return accountsListAndBalanceDetails == null ? accountsListAndBalanceDetails = new ArrayList<>() : accountsListAndBalanceDetails;
	}

	public AccountIdentification37Choice setAccountsListAndBalanceDetails(List<AccountIdentification37> accountsListAndBalanceDetails) {
