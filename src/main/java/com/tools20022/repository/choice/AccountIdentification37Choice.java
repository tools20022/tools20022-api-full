...
public class AccountIdentification37Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification37Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionNarrative002V04.mmAccountDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountIdentification37> accountsListAndBalanceDetails) {
