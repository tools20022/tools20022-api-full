 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionType3Choice#mmCode
...
@XmlType(name = "OptionType3Choice", propOrder = {"code", "proprietary"})
public class OptionType3Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OptionType3Choice
	 * OptionType3Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionType3Choice, OptionType1Code> mmCode = new MMMessageAttribute<OptionType3Choice, OptionType1Code>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OptionType1Code getValue(OptionType3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionType3Choice obj, OptionType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionType3Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<OptionType3Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType3Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(OptionType3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionType3Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionType3Choice.mmCode, com.tools20022.repository.choice.OptionType3Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionType3Choice";
	...
	public OptionType3Choice setCode(OptionType1Code code) {
	...
	public OptionType3Choice setProprietary(GenericIdentification25 proprietary) {
