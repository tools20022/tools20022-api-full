 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus18Choice#Reason
...
public class DeniedStatus18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus18Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus18Choice.Reason);
