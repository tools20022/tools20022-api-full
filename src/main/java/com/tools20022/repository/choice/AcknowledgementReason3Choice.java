...
public class AcknowledgementReason3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies additional information about the processed instruction.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgementReason13Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies additional information about the processed instruction.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgementReason13Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(RepoCallAcknowledgementReason2Code code) {
		this.code = code;
	}
