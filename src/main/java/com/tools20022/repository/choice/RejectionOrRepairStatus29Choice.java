...
public class RejectionOrRepairStatus29Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus15Choice.NoSpecifiedReason;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus15Choice.Reason;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus29Choice.NoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus29Choice.Reason);
				...
				previousVersion_lazy = () -> RejectionOrRepairStatus15Choice.mmObject();
			}
		});
