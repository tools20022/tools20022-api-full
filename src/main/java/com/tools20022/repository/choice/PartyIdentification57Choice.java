...
public class PartyIdentification57Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification57Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification57Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification57Choice.NameAndAddress);
