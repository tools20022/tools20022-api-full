...
public class CurrencyCriteria1Choice {
	...
	public static final MMMessageAttribute mmQueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CurrencyCriteria1Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CurrencyCriteria1Choice.mmQueryName, CurrencyCriteria1Choice.mmNewCriteria);
	...
	public void setNewCriteria(CurrencyExchangeCriteria1 newCriteria) {
