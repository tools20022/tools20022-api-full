 ...
 * <li>{@linkplain com.tools20022.repository.choice.FailingStatus8Choice#Reason
...
public class FailingStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FailingStatus8Choice.NoSpecifiedReason, com.tools20022.repository.choice.FailingStatus8Choice.Reason);
