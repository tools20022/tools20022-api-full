...
public class FailingStatus8Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus8Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus8Choice.mmNoSpecifiedReason, FailingStatus8Choice.mmReason);
	...
	public void setReason(List<FailingReason5> reason) {
		this.reason = reason;
	}
}