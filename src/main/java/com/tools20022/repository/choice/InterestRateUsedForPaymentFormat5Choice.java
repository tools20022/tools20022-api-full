 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forInterestRateUsedForPaymentFormat5Choice
 * ConstraintCoexistenceAmountRule.forInterestRateUsedForPaymentFormat5Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "InterestRateUsedForPaymentFormat5Choice", propOrder = {"rate", "amount", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class InterestRateUsedForPaymentFormat5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, PercentageRate> mmRate = new MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, PercentageRate>() {
		{
			businessElementTrace_lazy = () -> Interest.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
			...
			nextVersions_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat8Choice.mmRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PercentageRate getValue(InterestRateUsedForPaymentFormat5Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(InterestRateUsedForPaymentFormat5Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat8Choice.mmAmount);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(InterestRateUsedForPaymentFormat5Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(InterestRateUsedForPaymentFormat5Choice obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * InterestRateUsedForPaymentFormat8Choice.mmRateTypeAndAmountAndRateStatus}
	 * </li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<InterestRateUsedForPaymentFormat5Choice, RateTypeAndAmountAndStatus3> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<InterestRateUsedForPaymentFormat5Choice, RateTypeAndAmountAndStatus3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat8Choice.mmRateTypeAndAmountAndRateStatus);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public RateTypeAndAmountAndStatus3 getValue(InterestRateUsedForPaymentFormat5Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(InterestRateUsedForPaymentFormat5Choice obj, RateTypeAndAmountAndStatus3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, RateType13Code> mmNotSpecifiedRate = new MMMessageAttribute<InterestRateUsedForPaymentFormat5Choice, RateType13Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
			...
			nextVersions_lazy = () -> Arrays.asList(InterestRateUsedForPaymentFormat8Choice.mmNotSpecifiedRate);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RateType13Code getValue(InterestRateUsedForPaymentFormat5Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(InterestRateUsedForPaymentFormat5Choice obj, RateType13Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmRate, com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmAmount,
						com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.InterestRateUsedForPaymentFormat5Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Interest.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forInterestRateUsedForPaymentFormat5Choice);
	...
	public InterestRateUsedForPaymentFormat5Choice setRate(PercentageRate rate) {
	...
	public InterestRateUsedForPaymentFormat5Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public InterestRateUsedForPaymentFormat5Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus3 rateTypeAndAmountAndRateStatus) {
	...
	public InterestRateUsedForPaymentFormat5Choice setNotSpecifiedRate(RateType13Code notSpecifiedRate) {
