...
public class RejectionOrRepairStatus10Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus10Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus10Choice.mmNoSpecifiedReason, RejectionOrRepairStatus10Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason9> reason) {
		this.reason = reason;
	}
}