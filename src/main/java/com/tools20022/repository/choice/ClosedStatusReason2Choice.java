...
public class ClosedStatusReason2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Reason for the closed account status expressed as a code.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.ProformaStatusReason2Choice.Code;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClosurePendingStatusReason2Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ProformaStatusReason2Choice.Proprietary;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClosurePendingStatusReason2Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClosedStatusReason2Choice.Code, com.tools20022.repository.choice.ClosedStatusReason2Choice.Proprietary);
