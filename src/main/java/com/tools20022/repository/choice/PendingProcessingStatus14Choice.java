...
import com.tools20022.repository.msg.PendingProcessingReason11;
...
@XmlType(name = "PendingProcessingStatus14Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingProcessingStatus14Choice {
	...
	protected List<PendingProcessingReason11> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingStatus14Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingProcessingStatus14Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingStatus14Choice";
	...
	public PendingProcessingStatus14Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<PendingProcessingReason11> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingProcessingStatus14Choice setReason(List<PendingProcessingReason11> reason) {
