...
public class AllegmentReason1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.SecuritiesTradeStatusReason.mmAllegementReason;
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AllegementReason1Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has been alleged.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AllegementReason1Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(AllegementReason1Code code) {
		this.code = code;
	}
