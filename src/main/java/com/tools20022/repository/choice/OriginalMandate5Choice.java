	...
	public static final MMMessageAttribute mmOriginalMandateIdentification = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.OriginalMandate4Choice.mmOriginalMandateIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmOriginalMandate = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.OriginalMandate4Choice.mmOriginalMandate;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
