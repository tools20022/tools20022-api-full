...
import com.tools20022.repository.codeset.UnmatchedReason9Code;
...
@XmlType(name = "UnmatchedReason20Choice", propOrder = {"code", "proprietary"})
public class UnmatchedReason20Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected UnmatchedReason9Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason20Choice.mmCode, com.tools20022.repository.choice.UnmatchedReason20Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnmatchedReason20Choice";
	...
	public UnmatchedReason9Code getCode() {
		return code;
	}

	public UnmatchedReason20Choice setCode(UnmatchedReason9Code code) {
	...
	public UnmatchedReason20Choice setProprietary(GenericIdentification25 proprietary) {
