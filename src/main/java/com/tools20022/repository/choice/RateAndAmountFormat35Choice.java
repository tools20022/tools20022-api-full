...
public class RateAndAmountFormat35Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateAndAmountFormat35Choice.mmRate, RateAndAmountFormat35Choice.mmAmount, RateAndAmountFormat35Choice.mmRateTypeAndRate);
