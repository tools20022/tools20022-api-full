...
@XmlType(name = "IntermediateSecuritiesDistributionTypeFormat14Choice", propOrder = {"code", "proprietary"})
public class IntermediateSecuritiesDistributionTypeFormat14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat14Choice, IntermediateSecurityDistributionType4Code> mmCode = new MMMessageAttribute<IntermediateSecuritiesDistributionTypeFormat14Choice, IntermediateSecurityDistributionType4Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public IntermediateSecurityDistributionType4Code getValue(IntermediateSecuritiesDistributionTypeFormat14Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat14Choice obj, IntermediateSecurityDistributionType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat14Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<IntermediateSecuritiesDistributionTypeFormat14Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesProceedsDefinition.mmIntermediateSecuritiesDistributionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat14Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(IntermediateSecuritiesDistributionTypeFormat14Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(IntermediateSecuritiesDistributionTypeFormat14Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat14Choice.mmCode,
						com.tools20022.repository.choice.IntermediateSecuritiesDistributionTypeFormat14Choice.mmProprietary);
				...
				name = "IntermediateSecuritiesDistributionTypeFormat14Choice";
	...
	public IntermediateSecuritiesDistributionTypeFormat14Choice setCode(IntermediateSecurityDistributionType4Code code) {
	...
	public IntermediateSecuritiesDistributionTypeFormat14Choice setProprietary(GenericIdentification25 proprietary) {
