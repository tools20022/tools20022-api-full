...
public class IntermediateSecuritiesDistributionTypeFormat14Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat14Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat14Choice.mmProprietary);
