...
public class AcknowledgedAcceptedStatus30Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus30Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus30Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus30Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason18> reason) {
		this.reason = reason;
	}
}