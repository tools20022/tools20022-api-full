...
public class PartyIdentification50Choice {
	...
	public static final MMMessageAttribute mmAnyBIC = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification50Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification50Choice.mmAnyBIC, PartyIdentification50Choice.mmProprietaryIdentification);
