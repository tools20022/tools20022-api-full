...
public class RejectionOrRepairStatus2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus2Choice.NoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus2Choice.Reason);
