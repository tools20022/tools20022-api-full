...
public class RejectionOrRepairStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus2Choice.mmNoSpecifiedReason, RejectionOrRepairStatus2Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason4> reason) {
		this.reason = reason;
	}
}