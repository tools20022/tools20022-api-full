...
public class AwaitingCancellationReason1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AwaitingCancellationReason1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AwaitingCancellationReason1Choice.mmCode, AwaitingCancellationReason1Choice.mmProprietary);
	...
	public void setCode(AwaitingCancellationReason1Code code) {
		this.code = code;
	}
