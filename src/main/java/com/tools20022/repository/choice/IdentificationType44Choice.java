...
@XmlType(name = "IdentificationType44Choice", propOrder = {"code", "proprietary"})
public class IdentificationType44Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IdentificationType44Choice.mmCode, com.tools20022.repository.choice.IdentificationType44Choice.mmProprietary);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "IdentificationType44Choice";
	...
	public IdentificationType44Choice setCode(TypeOfIdentification1Code code) {
	...
	public IdentificationType44Choice setProprietary(GenericIdentification47 proprietary) {
