...
public class DistributionTypeFormat6Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DistributionTypeFormat6Choice, DistributionType3Code> mmCode = new MMMessageAttribute<DistributionTypeFormat6Choice, DistributionType3Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionDistribution.mmOrderType;
			componentContext_lazy = () -> com.tools20022.repository.choice.DistributionTypeFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public DistributionType3Code getValue(DistributionTypeFormat6Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(DistributionTypeFormat6Choice obj, DistributionType3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DistributionTypeFormat6Choice, GenericIdentification51> mmProprietary = new MMMessageAssociationEnd<DistributionTypeFormat6Choice, GenericIdentification51>() {
		{
			businessElementTrace_lazy = () -> CorporateActionDistribution.mmOrderType;
			componentContext_lazy = () -> com.tools20022.repository.choice.DistributionTypeFormat6Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification51 getValue(DistributionTypeFormat6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(DistributionTypeFormat6Choice obj, GenericIdentification51 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DistributionTypeFormat6Choice.mmCode, com.tools20022.repository.choice.DistributionTypeFormat6Choice.mmProprietary);
	...
	public DistributionTypeFormat6Choice setCode(DistributionType3Code code) {
	...
	public DistributionTypeFormat6Choice setProprietary(GenericIdentification51 proprietary) {
