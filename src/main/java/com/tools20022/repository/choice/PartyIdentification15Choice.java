...
public class PartyIdentification15Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification15Choice.BICOrBEI, com.tools20022.repository.choice.PartyIdentification15Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification15Choice.NameAndAddress, com.tools20022.repository.choice.PartyIdentification15Choice.Country);
