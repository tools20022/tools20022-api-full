 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ConsolidationType1Choice#Code
 * ConsolidationType1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ConsolidationType1Choice#Proprietary
 * ConsolidationType1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class ConsolidationType1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ConsolidationType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConsolidationType1Choice.Code, com.tools20022.repository.choice.ConsolidationType1Choice.Proprietary);
