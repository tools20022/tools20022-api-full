 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.References1Choice#IntraPositionMovementIdentification
 * References1Choice.IntraPositionMovementIdentification}</li>
 * <li>
...
public class References1Choice {
	...
	public static final MMMessageAttribute SecuritiesSettlementTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.SecuritiesSettlementTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute PoolIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.PoolIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.References47Choice#IntraPositionMovementIdentification
	 * References47Choice.IntraPositionMovementIdentification}</li>
	 * </ul>
	 * </li>
	 * </ul>
	 */
	public static final MMMessageAttribute IntraPositionMovementIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.IntraPositionMovementIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute AccountServicerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.AccountServicerTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	public static final MMMessageAttribute OtherTransactionIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References47Choice.OtherTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References1Choice.SecuritiesSettlementTransactionIdentification, com.tools20022.repository.choice.References1Choice.PoolIdentification,
						com.tools20022.repository.choice.References1Choice.IntraPositionMovementIdentification, com.tools20022.repository.choice.References1Choice.AccountServicerTransactionIdentification,
						com.tools20022.repository.choice.References1Choice.OtherTransactionIdentification);
