 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.References1Choice#mmIntraPositionMovementIdentification
 * References1Choice.mmIntraPositionMovementIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forReferences1Choice
 * ConstraintCoexistenceIdentificationRule.forReferences1Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class References1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References1Choice, Max35Text> mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute<References1Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeExecution.mmSecuritiesSettlement;
			componentContext_lazy = () -> com.tools20022.repository.choice.References1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(References47Choice.mmSecuritiesSettlementTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(References1Choice obj) {
			return obj.getSecuritiesSettlementTransactionIdentification();
		}

		@Override
		public void setValue(References1Choice obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References1Choice, Max35Text> mmPoolIdentification = new MMMessageAttribute<References1Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References47Choice.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References1Choice, Max35Text> mmIntraPositionMovementIdentification = new MMMessageAttribute<References1Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.References1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(References47Choice.mmIntraPositionMovementIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References1Choice, Max35Text> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References1Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References47Choice.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References1Choice, Max35Text> mmOtherTransactionIdentification = new MMMessageAttribute<References1Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References47Choice.mmOtherTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References1Choice.mmSecuritiesSettlementTransactionIdentification, com.tools20022.repository.choice.References1Choice.mmPoolIdentification,
						com.tools20022.repository.choice.References1Choice.mmIntraPositionMovementIdentification, com.tools20022.repository.choice.References1Choice.mmAccountServicerTransactionIdentification,
						com.tools20022.repository.choice.References1Choice.mmOtherTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forReferences1Choice);
				...
				name = "References1Choice";
				definition = "Choice of reference.";
				nextVersions_lazy = () -> Arrays.asList(References47Choice.mmObject());
			}
		});
	...
	public References1Choice setSecuritiesSettlementTransactionIdentification(Max35Text securitiesSettlementTransactionIdentification) {
	...
	public References1Choice setPoolIdentification(Max35Text poolIdentification) {
	...
	public References1Choice setIntraPositionMovementIdentification(Max35Text intraPositionMovementIdentification) {
	...
	public References1Choice setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References1Choice setOtherTransactionIdentification(Max35Text otherTransactionIdentification) {
