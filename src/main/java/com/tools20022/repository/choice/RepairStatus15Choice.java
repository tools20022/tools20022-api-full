 ...
 * <li>{@linkplain com.tools20022.repository.choice.RepairStatus15Choice#Reason
...
public class RepairStatus15Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepairStatus15Choice.NoSpecifiedReason, com.tools20022.repository.choice.RepairStatus15Choice.Reason);
