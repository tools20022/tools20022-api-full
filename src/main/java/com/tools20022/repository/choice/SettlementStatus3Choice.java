...
@XmlType(name = "SettlementStatus3Choice", propOrder = {"code", "proprietary"})
public class SettlementStatus3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementStatus3Choice.mmCode, com.tools20022.repository.choice.SettlementStatus3Choice.mmProprietary);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementStatus3Choice";
	...
	public SettlementStatus3Choice setCode(SecuritiesSettlementStatus1Code code) {
	...
	public SettlementStatus3Choice setProprietary(GenericIdentification25 proprietary) {
