 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Registration4Choice#mmCode
...
@XmlType(name = "Registration4Choice", propOrder = {"code", "proprietary"})
public class Registration4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Registration4Choice
	 * Registration4Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<Registration4Choice, Registration2Code> mmCode = new MMMessageAttribute<Registration4Choice, Registration2Code>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public Registration2Code getValue(Registration4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(Registration4Choice obj, Registration2Code value) {
			obj.setCode(value);
		}
	};
	@XmlElement(name = "Prtry", required = true)
	protected GenericIdentification34 proprietary;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Registration4Choice, GenericIdentification34> mmProprietary = new MMMessageAssociationEnd<Registration4Choice, GenericIdentification34>() {
		{
			businessElementTrace_lazy = () -> BasicSecuritiesRegistration.mmRegistrationInstruction;
			componentContext_lazy = () -> com.tools20022.repository.choice.Registration4Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification34 getValue(Registration4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(Registration4Choice obj, GenericIdentification34 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Registration4Choice.mmCode, com.tools20022.repository.choice.Registration4Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Registration4Choice";
				definition = "Choice of format for the registration information.";
				nextVersions_lazy = () -> Arrays.asList(Registration8Choice.mmObject());
			}
		});
	...
	public Registration4Choice setCode(Registration2Code code) {
		this.code = Objects.requireNonNull(code);
		return this;
	}

	public GenericIdentification34 getProprietary() {
		return proprietary;
	}

	public Registration4Choice setProprietary(GenericIdentification34 proprietary) {
