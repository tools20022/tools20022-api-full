...
public class CancelledStatus15Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus15Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus15Choice.mmNoSpecifiedReason, CancelledStatus15Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason14> reason) {
		this.reason = reason;
	}
}