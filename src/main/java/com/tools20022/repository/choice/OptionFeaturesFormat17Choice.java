...
public class OptionFeaturesFormat17Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> OptionFeaturesFormat17Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat17Choice.Code, com.tools20022.repository.choice.OptionFeaturesFormat17Choice.Proprietary);
