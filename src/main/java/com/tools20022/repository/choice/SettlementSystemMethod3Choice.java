...
public class SettlementSystemMethod3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementSystemMethod3Choice.Code, com.tools20022.repository.choice.SettlementSystemMethod3Choice.Proprietary);
