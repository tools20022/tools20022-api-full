...
public class SettlementSystemMethod3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementSystemMethod3Choice.mmCode, com.tools20022.repository.choice.SettlementSystemMethod3Choice.mmProprietary);
	...
	public SettlementSystemMethod3Choice setCode(SettlementSystemMethod1Code code) {
	...
	public SettlementSystemMethod3Choice setProprietary(GenericIdentification38 proprietary) {
