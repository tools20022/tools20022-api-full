 ...
 * <li>{@linkplain com.tools20022.repository.choice.Reason7Choice#DeniedReason
 ...
 * <li>{@linkplain com.tools20022.repository.choice.Reason7Choice#PendingReason
 * Reason7Choice.PendingReason}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Reason7Choice#FailingReason
 ...
 * <li>{@linkplain com.tools20022.repository.choice.Reason7Choice#RepairReason
...
public class Reason7Choice {
	...
	public static final MMMessageAssociationEnd RepoCallAcknowledgementReason = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Reason7Choice.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.RepoCallAcknowledgementReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd CancellationReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.CancellationReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PendingCancellationReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.PendingCancellationReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd GeneratedReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.GeneratedReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd DeniedReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.DeniedReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AcknowledgedAcceptedReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.AcknowledgedAcceptedReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PendingReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.PendingReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd FailingReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.FailingReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PendingProcessingReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.PendingProcessingReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RejectionReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.RejectionReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd RepairReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.RepairReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd PendingModificationReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.PendingModificationReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd UnmatchedReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason12Choice.UnmatchedReason);
			minOccurs = 0;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reason7Choice.RepoCallAcknowledgementReason, com.tools20022.repository.choice.Reason7Choice.CancellationReason,
						com.tools20022.repository.choice.Reason7Choice.PendingCancellationReason, com.tools20022.repository.choice.Reason7Choice.GeneratedReason, com.tools20022.repository.choice.Reason7Choice.DeniedReason,
						com.tools20022.repository.choice.Reason7Choice.AcknowledgedAcceptedReason, com.tools20022.repository.choice.Reason7Choice.PendingReason, com.tools20022.repository.choice.Reason7Choice.FailingReason,
						com.tools20022.repository.choice.Reason7Choice.PendingProcessingReason, com.tools20022.repository.choice.Reason7Choice.RejectionReason, com.tools20022.repository.choice.Reason7Choice.RepairReason,
						com.tools20022.repository.choice.Reason7Choice.PendingModificationReason, com.tools20022.repository.choice.Reason7Choice.UnmatchedReason);
