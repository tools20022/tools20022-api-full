...
public class Reason7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Reason7Choice.mmRepoCallAcknowledgementReason, Reason7Choice.mmCancellationReason, Reason7Choice.mmPendingCancellationReason, Reason7Choice.mmGeneratedReason,
						Reason7Choice.mmDeniedReason, Reason7Choice.mmAcknowledgedAcceptedReason, Reason7Choice.mmPendingReason, Reason7Choice.mmFailingReason, Reason7Choice.mmPendingProcessingReason, Reason7Choice.mmRejectionReason,
						Reason7Choice.mmRepairReason, Reason7Choice.mmPendingModificationReason, Reason7Choice.mmUnmatchedReason);
