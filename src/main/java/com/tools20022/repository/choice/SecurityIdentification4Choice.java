...
import com.tools20022.repository.msg.AlternateSecurityIdentification2;
...
@XmlType(name = "SecurityIdentification4Choice", propOrder = {"iSIN", "proprietary"})
public class SecurityIdentification4Choice {
	...
	protected AlternateSecurityIdentification2 proprietary;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecurityIdentification4Choice.mmISIN, com.tools20022.repository.choice.SecurityIdentification4Choice.mmProprietary);
	...
	public SecurityIdentification4Choice setISIN(ISINIdentifier iSIN) {
		this.iSIN = Objects.requireNonNull(iSIN);
		return this;
	}

	public AlternateSecurityIdentification2 getProprietary() {
		return proprietary;
	}

	public SecurityIdentification4Choice setProprietary(AlternateSecurityIdentification2 proprietary) {
