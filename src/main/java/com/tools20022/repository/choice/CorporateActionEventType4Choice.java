...
public class CorporateActionEventType4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType4Choice.mmCode, CorporateActionEventType4Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType6Code code) {
		this.code = code;
	}
