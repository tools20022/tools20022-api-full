...
import com.tools20022.repository.msg.ModificationReason5;
...
@XmlType(name = "ModificationStatus5Choice", propOrder = {"noSpecifiedReason", "reason"})
public class ModificationStatus5Choice {
	...
	@XmlElement(name = "Rsn")
	protected List<ModificationReason5> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.ModificationReason5
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ModificationStatus5Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.ModificationStatus5Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ModificationStatus5Choice";
	...
	public ModificationStatus5Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<ModificationReason5> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public ModificationStatus5Choice setReason(List<ModificationReason5> reason) {
