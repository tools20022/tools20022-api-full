 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ProfileType1Choice#Code
 * ProfileType1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ProfileType1Choice#Proprietary
 * ProfileType1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class ProfileType1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ProfileType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProfileType1Choice.Code, com.tools20022.repository.choice.ProfileType1Choice.Proprietary);
