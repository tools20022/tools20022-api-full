 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType8Choice#mmCode
...
@XmlType(name = "ExposureType8Choice", propOrder = {"code", "proprietary"})
public class ExposureType8Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ExposureType8Choice
	 * ExposureType8Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType8Choice, ExposureType2Code> mmCode = new MMMessageAttribute<ExposureType8Choice, ExposureType2Code>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ExposureType2Code getValue(ExposureType8Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ExposureType8Choice obj, ExposureType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExposureType8Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ExposureType8Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType8Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(ExposureType8Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ExposureType8Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType8Choice.mmCode, com.tools20022.repository.choice.ExposureType8Choice.mmProprietary);
	...
	public ExposureType8Choice setCode(ExposureType2Code code) {
	...
	public ExposureType8Choice setProprietary(GenericIdentification25 proprietary) {
