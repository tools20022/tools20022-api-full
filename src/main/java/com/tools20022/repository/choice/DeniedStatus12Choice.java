...
public class DeniedStatus12Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> DeniedStatus12Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedStatus12Choice.mmNoSpecifiedReason, DeniedStatus12Choice.mmReason);
	...
	public void setReason(List<DeniedReason7> reason) {
		this.reason = reason;
	}
}