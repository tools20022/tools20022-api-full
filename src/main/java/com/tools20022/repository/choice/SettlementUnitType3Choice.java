...
@XmlType(name = "SettlementUnitType3Choice", propOrder = {"code", "proprietary"})
public class SettlementUnitType3Choice {
	...
	public static final MMMessageAttribute<SettlementUnitType3Choice, SettlementUnitType1Code> mmCode = new MMMessageAttribute<SettlementUnitType3Choice, SettlementUnitType1Code>() {
		{
			...
			previousVersion_lazy = () -> SettlementUnitType2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<SettlementUnitType3Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<SettlementUnitType3Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> SettlementUnitType2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementUnitType3Choice.mmCode, com.tools20022.repository.choice.SettlementUnitType3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SettlementUnitType3Choice";
				definition = "Choice of format for settlement unit type.";
				previousVersion_lazy = () -> SettlementUnitType2Choice.mmObject();
			}
		});
	...
	public SettlementUnitType3Choice setCode(SettlementUnitType1Code code) {
	...
	public SettlementUnitType3Choice setProprietary(GenericIdentification30 proprietary) {
