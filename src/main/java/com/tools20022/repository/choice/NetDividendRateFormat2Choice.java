 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat2Choice#mmRateTypeAndAmountAndRateStatus
 * NetDividendRateFormat2Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forNetDividendRateFormat2Choice
 * ConstraintCoexistenceAmountRule.forNetDividendRateFormat2Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class NetDividendRateFormat2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat2Choice.mmAmount, com.tools20022.repository.choice.NetDividendRateFormat2Choice.mmRateTypeAndAmountAndRateStatus);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forNetDividendRateFormat2Choice);
				...
				name = "NetDividendRateFormat2Choice";
				definition = "Choice between different formats to express a net dividend.";
				nextVersions_lazy = () -> Arrays.asList(NetDividendRateFormat10Choice.mmObject());
			}
		});
	...
	public NetDividendRateFormat2Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public NetDividendRateFormat2Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus4 rateTypeAndAmountAndRateStatus) {
