...
@XmlType(name = "OfferTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class OfferTypeFormat1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OfferTypeFormat1Choice.mmCode, com.tools20022.repository.choice.OfferTypeFormat1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OfferTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of offer.";
				nextVersions_lazy = () -> Arrays.asList(OfferTypeFormat3Choice.mmObject());
			}
		});
	...
	public OfferTypeFormat1Choice setCode(OfferType1Code code) {
	...
	public OfferTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
