 ...
 * <li>{@linkplain com.tools20022.repository.choice.RepairStatus2Choice#Reason
...
public class RepairStatus2Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RepairStatus2Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepairStatus2Choice.NoSpecifiedReason, com.tools20022.repository.choice.RepairStatus2Choice.Reason);
