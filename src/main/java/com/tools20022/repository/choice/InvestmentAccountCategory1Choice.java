...
public class InvestmentAccountCategory1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> InvestmentAccountCategory1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InvestmentAccountCategory1Choice.mmCode, InvestmentAccountCategory1Choice.mmProprietary);
	...
	public void setCode(InvestmentAccountCategory1Code code) {
		this.code = code;
	}
