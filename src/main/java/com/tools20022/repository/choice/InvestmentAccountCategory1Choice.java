...
import com.tools20022.repository.codeset.InvestmentAccountCategory1Code;
...
/**
 * Choice of formats for the specification of the category of investment
 * account.
 * <p>
...
@XmlType(name = "InvestmentAccountCategory1Choice", propOrder = {"code", "proprietary"})
public class InvestmentAccountCategory1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected InvestmentAccountCategory1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Category of investment account expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Category of investment account expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestmentAccountCategory1Choice.mmCode, com.tools20022.repository.choice.InvestmentAccountCategory1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestmentAccountCategory1Choice";
				definition = "Choice of formats for the specification of the category of investment account.";
			}
		});
		return mmObject_lazy.get();
	}

	public InvestmentAccountCategory1Code getCode() {
		return code;
	}

	public InvestmentAccountCategory1Choice setCode(InvestmentAccountCategory1Code code) {
	...
	public InvestmentAccountCategory1Choice setProprietary(GenericIdentification47 proprietary) {
