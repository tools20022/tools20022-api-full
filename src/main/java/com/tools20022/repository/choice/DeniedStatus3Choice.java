 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus3Choice#Reason
...
public class DeniedStatus3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus3Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus3Choice.Reason);
