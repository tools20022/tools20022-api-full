 ...
 * <li>{@linkplain com.tools20022.repository.choice.TaxAmountOrRate4Choice#Rate
...
public class TaxAmountOrRate4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TaxAmountOrRate4Choice.Amount, com.tools20022.repository.choice.TaxAmountOrRate4Choice.Rate);
