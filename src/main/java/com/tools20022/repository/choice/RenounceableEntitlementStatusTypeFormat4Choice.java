...
public class RenounceableEntitlementStatusTypeFormat4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RenounceableEntitlementStatusTypeFormat4Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RenounceableEntitlementStatusTypeFormat4Choice.Code, com.tools20022.repository.choice.RenounceableEntitlementStatusTypeFormat4Choice.Proprietary);
