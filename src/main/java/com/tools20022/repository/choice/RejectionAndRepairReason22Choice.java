...
public class RejectionAndRepairReason22Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionAndRepairReason22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionAndRepairReason22Choice.mmCode, RejectionAndRepairReason22Choice.mmProprietary);
	...
	public void setCode(RejectionReason34Code code) {
		this.code = code;
	}
