...
@XmlType(name = "RejectionAndRepairReason22Choice", propOrder = {"code", "proprietary"})
public class RejectionAndRepairReason22Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionAndRepairReason22Choice, RejectionReason34Code> mmCode = new MMMessageAttribute<RejectionAndRepairReason22Choice, RejectionReason34Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionAndRepairReason22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason33Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RejectionReason34Code getValue(RejectionAndRepairReason22Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionAndRepairReason22Choice obj, RejectionReason34Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionAndRepairReason22Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RejectionAndRepairReason22Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionAndRepairReason22Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason33Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(RejectionAndRepairReason22Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RejectionAndRepairReason22Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionAndRepairReason22Choice.mmCode, com.tools20022.repository.choice.RejectionAndRepairReason22Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RejectionAndRepairReason22Choice";
				definition = "Choice of format for the rejection or repair reason.";
				nextVersions_lazy = () -> Arrays.asList(RejectionAndRepairReason33Choice.mmObject());
			}
		});
	...
	public RejectionAndRepairReason22Choice setCode(RejectionReason34Code code) {
	...
	public RejectionAndRepairReason22Choice setProprietary(GenericIdentification20 proprietary) {
