...
public class OptionFeaturesFormat4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OptionFeaturesFormat4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionFeaturesFormat4Choice.mmCode, OptionFeaturesFormat4Choice.mmProprietary);
	...
	public void setCode(OptionFeatures2Code code) {
		this.code = code;
	}
