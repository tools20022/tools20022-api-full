...
public class SettlementStatus15Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementStatus15Choice.Pending, com.tools20022.repository.choice.SettlementStatus15Choice.Failing,
						com.tools20022.repository.choice.SettlementStatus15Choice.Proprietary);
