 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CorporateActionNarrative4Choice#mmCode
 * CorporateActionNarrative4Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.CorporateActionNarrative4Choice#mmProprietary
 * CorporateActionNarrative4Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "CorporateActionNarrative4Choice", propOrder = {"code", "proprietary"})
public class CorporateActionNarrative4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionNarrative4Choice.mmCode, com.tools20022.repository.choice.CorporateActionNarrative4Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionNarrative4Choice";
	...
	public CorporateActionNarrative4Choice setCode(CorporateActionNarrative1Code code) {
	...
	public CorporateActionNarrative4Choice setProprietary(GenericIdentification47 proprietary) {
