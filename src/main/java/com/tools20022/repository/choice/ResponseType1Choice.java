...
import com.tools20022.repository.codeset.MarginCallResponse1Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ResponseType1Choice#mmCode
 ...
 * definition} = "Choice between a response type code and a proprietary code."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ResponseType1Choice", propOrder = {"code", "proprietary"})
public class ResponseType1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected MarginCallResponse1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ResponseType1Choice
	 * ResponseType1Choice}</li>
	...
	public static final MMMessageAttribute<ResponseType1Choice, MarginCallResponse1Code> mmCode = new MMMessageAttribute<ResponseType1Choice, MarginCallResponse1Code>() {
		{
			...
			name = "Code";
			definition = "Provides a margin call response type using an ISO 20022 code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<ResponseType1Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<ResponseType1Choice, GenericIdentification30>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Provides a margin call response type using a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ResponseType1Choice.mmCode, com.tools20022.repository.choice.ResponseType1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ResponseType1Choice";
				definition = "Choice between a response type code and a proprietary code.";
			}
		});
		return mmObject_lazy.get();
	}

	public MarginCallResponse1Code getCode() {
		return code;
	}

	public ResponseType1Choice setCode(MarginCallResponse1Code code) {
	...
	public ResponseType1Choice setProprietary(GenericIdentification30 proprietary) {
