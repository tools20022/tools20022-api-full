...
import com.tools20022.repository.codeset.InvestmentFundFee1Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ChargeType5Choice#mmCode
...
@XmlType(name = "ChargeType5Choice", propOrder = {"code", "proprietary"})
public class ChargeType5Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected InvestmentFundFee1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<ChargeType5Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<ChargeType5Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Fee (charge/commission) expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ChargeType5Choice.mmCode, com.tools20022.repository.choice.ChargeType5Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ChargeType5Choice";
	...
	public InvestmentFundFee1Code getCode() {
		return code;
	}

	public ChargeType5Choice setCode(InvestmentFundFee1Code code) {
	...
	public ChargeType5Choice setProprietary(GenericIdentification47 proprietary) {
