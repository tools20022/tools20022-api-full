...
public class References25Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References25Choice.mmSecuritiesSettlementTransactionIdentification, References25Choice.mmIntraPositionMovementIdentification,
						References25Choice.mmIntraBalanceMovementIdentification, References25Choice.mmAccountServicerTransactionIdentification, References25Choice.mmMarketInfrastructureTransactionIdentification,
						References25Choice.mmPoolIdentification, References25Choice.mmOtherTransactionIdentification);
