 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Frequency5Choice#Code
 * Frequency5Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Frequency5Choice#Proprietary
 * Frequency5Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Frequency5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Frequency5Choice.Code, com.tools20022.repository.choice.Frequency5Choice.Proprietary);
