...
@XmlType(name = "ConsentOrRejectionReason3Choice", propOrder = {"code", "proprietary"})
public class ConsentOrRejectionReason3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConsentOrRejectionReason3Choice.mmCode, com.tools20022.repository.choice.ConsentOrRejectionReason3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ConsentOrRejectionReason3Choice";
	...
	public ConsentOrRejectionReason3Choice setCode(CounterpartyResponseStatusReason1Code code) {
	...
	public ConsentOrRejectionReason3Choice setProprietary(GenericIdentification25 proprietary) {
