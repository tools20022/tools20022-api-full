...
public class InvestorRestrictionType2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.SecuritiesRestriction.mmInvestorStatusRestrictionType;
	...
	public void setCode(InvestorRestrictionType1Code code) {
		this.code = code;
	}
