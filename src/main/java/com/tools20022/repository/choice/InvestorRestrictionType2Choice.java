...
@XmlType(name = "InvestorRestrictionType2Choice", propOrder = {"code", "proprietary"})
public class InvestorRestrictionType2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorRestrictionType2Choice.mmCode, com.tools20022.repository.choice.InvestorRestrictionType2Choice.mmProprietary);
	...
	public InvestorRestrictionType2Choice setCode(InvestorRestrictionType1Code code) {
	...
	public InvestorRestrictionType2Choice setProprietary(GenericIdentification40 proprietary) {
