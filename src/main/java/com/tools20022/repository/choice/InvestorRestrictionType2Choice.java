 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InvestorRestrictionType2Choice#Code
 * InvestorRestrictionType2Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.InvestorRestrictionType2Choice#Proprietary
 * InvestorRestrictionType2Choice.Proprietary}</li>
 * </ul>
 * </li>
 ...
 * </ul>
 */
public class InvestorRestrictionType2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InvestorRestrictionType2Choice.mmObject();
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.SecuritiesRestriction.InvestorStatusRestrictionType;
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorRestrictionType2Choice.Code, com.tools20022.repository.choice.InvestorRestrictionType2Choice.Proprietary);
