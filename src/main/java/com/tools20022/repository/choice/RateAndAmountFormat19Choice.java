 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateAndAmountFormat38Choice
...
public class RateAndAmountFormat19Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateAndAmountFormat19Choice, PercentageRate> mmRate = new MMMessageAttribute<RateAndAmountFormat19Choice, PercentageRate>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
			...
			nextVersions_lazy = () -> Arrays.asList(RateAndAmountFormat38Choice.mmRate);
		...
		@Override
		public PercentageRate getValue(RateAndAmountFormat19Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(RateAndAmountFormat19Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateAndAmountFormat19Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RateAndAmountFormat19Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
			...
			nextVersions_lazy = () -> Arrays.asList(RateAndAmountFormat38Choice.mmNotSpecifiedRate);
		...
		@Override
		public RateValueType7Code getValue(RateAndAmountFormat19Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RateAndAmountFormat19Choice obj, RateValueType7Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateAndAmountFormat19Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateAndAmountFormat19Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
			...
			nextVersions_lazy = () -> Arrays.asList(RateAndAmountFormat38Choice.mmAmount);
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(RateAndAmountFormat19Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(RateAndAmountFormat19Choice obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateAndAmountFormat19Choice, DecimalNumber> mmIndexPoints = new MMMessageAttribute<RateAndAmountFormat19Choice, DecimalNumber>() {
		{
			...
			name = "IndexPoints";
			definition = "Price expressed in index points.\r\n";
			nextVersions_lazy = () -> Arrays.asList(RateAndAmountFormat38Choice.mmIndexPoints);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DecimalNumber getValue(RateAndAmountFormat19Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(RateAndAmountFormat19Choice obj, DecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmRate, com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmNotSpecifiedRate,
						com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmAmount, com.tools20022.repository.choice.RateAndAmountFormat19Choice.mmIndexPoints);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRateAndAmountFormat19Choice);
				...
				name = "RateAndAmountFormat19Choice";
				definition = "Choice of format between a rate, an amount, index points or a unspecified rate.";
				nextVersions_lazy = () -> Arrays.asList(RateAndAmountFormat38Choice.mmObject());
	...
	public RateAndAmountFormat19Choice setRate(PercentageRate rate) {
	...
	public RateAndAmountFormat19Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RateAndAmountFormat19Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateAndAmountFormat19Choice setIndexPoints(DecimalNumber indexPoints) {
