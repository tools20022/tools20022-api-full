...
@XmlType(name = "TaxCapacityParty2Choice", propOrder = {"code", "proprietary"})
public class TaxCapacityParty2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TaxCapacityParty2Choice.mmCode, com.tools20022.repository.choice.TaxCapacityParty2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlementPartyRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TaxCapacityParty2Choice";
	...
	public TaxCapacityParty2Choice setCode(TaxLiability1Code code) {
	...
	public TaxCapacityParty2Choice setProprietary(GenericIdentification25 proprietary) {
