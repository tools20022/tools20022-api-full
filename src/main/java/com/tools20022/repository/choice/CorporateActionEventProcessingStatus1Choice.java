...
@XmlType(name = "CorporateActionEventProcessingStatus1Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventProcessingStatus1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventProcessingStatus1Choice, CorporateActionEventProcessingStatus1Code> mmCode = new MMMessageAttribute<CorporateActionEventProcessingStatus1Choice, CorporateActionEventProcessingStatus1Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatus.mmEventProcessingStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventProcessingStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventProcessingStatus3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventProcessingStatus1Code getValue(CorporateActionEventProcessingStatus1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventProcessingStatus1Choice obj, CorporateActionEventProcessingStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventProcessingStatus1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<CorporateActionEventProcessingStatus1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionStatus.mmEventProcessingStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventProcessingStatus1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventProcessingStatus3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(CorporateActionEventProcessingStatus1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventProcessingStatus1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventProcessingStatus1Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventProcessingStatus1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionEventProcessingStatus1Choice";
				definition = "Choice of corporate action processing status.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionEventProcessingStatus3Choice.mmObject());
			}
		});
	...
	public CorporateActionEventProcessingStatus1Choice setCode(CorporateActionEventProcessingStatus1Code code) {
	...
	public CorporateActionEventProcessingStatus1Choice setProprietary(GenericIdentification20 proprietary) {
