...
public class InstructionProcessingStatus1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus1Choice.mmCancelled, InstructionProcessingStatus1Choice.mmAccepted, InstructionProcessingStatus1Choice.mmRejected,
						InstructionProcessingStatus1Choice.mmPending, InstructionProcessingStatus1Choice.mmDefaultAction, InstructionProcessingStatus1Choice.mmStandingInstruction, InstructionProcessingStatus1Choice.mmProprietaryStatus);
