 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.TimeUnit2Choice TimeUnit2Choice}
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "TimeUnit3Choice", propOrder = {"code", "proprietary"})
public class TimeUnit3Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.TimeUnit2Choice#mmCode
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> TimeUnit2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> TimeUnit2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TimeUnit3Choice.mmCode, com.tools20022.repository.choice.TimeUnit3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TimeUnit3Choice";
				definition = "Choice of format for time unit.";
				previousVersion_lazy = () -> TimeUnit2Choice.mmObject();
			}
		});
	...
	public TimeUnit3Choice setCode(TimeUnit1Code code) {
	...
	public TimeUnit3Choice setProprietary(GenericIdentification30 proprietary) {
