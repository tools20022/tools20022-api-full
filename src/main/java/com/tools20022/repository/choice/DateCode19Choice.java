 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.DateCode11Choice
 * DateCode11Choice}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "DateCode19Choice", propOrder = {"code", "proprietary"})
public class DateCode19Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.DateCode19Choice
	 * DateCode19Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DateCode19Choice, DateType8Code> mmCode = new MMMessageAttribute<DateCode19Choice, DateType8Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateCode19Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> DateCode11Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DateType8Code getValue(DateCode19Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(DateCode19Choice obj, DateType8Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<DateCode19Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<DateCode19Choice, GenericIdentification30>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.DateCode19Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
			...
			previousVersion_lazy = () -> DateCode11Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(DateCode19Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(DateCode19Choice obj, GenericIdentification30 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				previousVersion_lazy = () -> DateCode11Choice.mmObject();
			}
		});
	...
	public DateCode19Choice setCode(DateType8Code code) {
	...
	public DateCode19Choice setProprietary(GenericIdentification30 proprietary) {
