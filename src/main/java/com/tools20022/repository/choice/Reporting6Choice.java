...
@XmlType(name = "Reporting6Choice", propOrder = {"code", "proprietary"})
public class Reporting6Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Reporting2Choice#mmCode
	...
	public static final MMMessageAttribute<Reporting6Choice, Reporting2Code> mmCode = new MMMessageAttribute<Reporting6Choice, Reporting2Code>() {
		{
			...
			previousVersion_lazy = () -> Reporting2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<Reporting6Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<Reporting6Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> Reporting2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reporting6Choice.mmCode, com.tools20022.repository.choice.Reporting6Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeExecution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Reporting6Choice";
				definition = "Choice of format for the reporting type.";
				previousVersion_lazy = () -> Reporting2Choice.mmObject();
			}
		});
	...
	public Reporting6Choice setCode(Reporting2Code code) {
	...
	public Reporting6Choice setProprietary(GenericIdentification30 proprietary) {
