...
@XmlType(name = "BeneficiaryCertificationType5Choice", propOrder = {"code", "proprietary"})
public class BeneficiaryCertificationType5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BeneficiaryCertificationType5Choice, BeneficiaryCertificationType4Code> mmCode = new MMMessageAttribute<BeneficiaryCertificationType5Choice, BeneficiaryCertificationType4Code>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public BeneficiaryCertificationType4Code getValue(BeneficiaryCertificationType5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(BeneficiaryCertificationType5Choice obj, BeneficiaryCertificationType4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BeneficiaryCertificationType5Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<BeneficiaryCertificationType5Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> BeneficialOwner.mmCertificationType;
			componentContext_lazy = () -> com.tools20022.repository.choice.BeneficiaryCertificationType5Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(BeneficiaryCertificationType5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(BeneficiaryCertificationType5Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BeneficiaryCertificationType5Choice.mmCode, com.tools20022.repository.choice.BeneficiaryCertificationType5Choice.mmProprietary);
				trace_lazy = () -> BeneficialOwner.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BeneficiaryCertificationType5Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of beneficiary certification required.";
				nextVersions_lazy = () -> Arrays.asList(BeneficiaryCertificationType7Choice.mmObject());
				previousVersion_lazy = () -> BeneficiaryCertificationType1Choice.mmObject();
			}
		});
	...
	public BeneficiaryCertificationType5Choice setCode(BeneficiaryCertificationType4Code code) {
	...
	public BeneficiaryCertificationType5Choice setProprietary(GenericIdentification20 proprietary) {
