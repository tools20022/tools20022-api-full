 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DistributionPolicy1Choice#Code
 * DistributionPolicy1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DistributionPolicy1Choice#Proprietary
 * DistributionPolicy1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class DistributionPolicy1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DistributionPolicy1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DistributionPolicy1Choice.Code, com.tools20022.repository.choice.DistributionPolicy1Choice.Proprietary);
