...
public class InstructionCancellationRequestStatus4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InstructionCancellationRequestStatus4Choice.CancellationCompleted,
						com.tools20022.repository.choice.InstructionCancellationRequestStatus4Choice.Accepted, com.tools20022.repository.choice.InstructionCancellationRequestStatus4Choice.Rejected,
						com.tools20022.repository.choice.InstructionCancellationRequestStatus4Choice.PendingCancellation, com.tools20022.repository.choice.InstructionCancellationRequestStatus4Choice.ProprietaryStatus);
