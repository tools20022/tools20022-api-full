...
public class UnmatchedReason24Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedReason15Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedReason15Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason24Choice.Code, com.tools20022.repository.choice.UnmatchedReason24Choice.Proprietary);
				...
				previousVersion_lazy = () -> UnmatchedReason15Choice.mmObject();
			}
		});
