 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NettingEligibility5Choice#Proprietary
 * NettingEligibility5Choice.Proprietary}</li>
 * </ul>
 * </li>
...
public class NettingEligibility5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NettingEligibility5Choice.Indicator, com.tools20022.repository.choice.NettingEligibility5Choice.Proprietary);
