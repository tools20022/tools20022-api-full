...
import com.tools20022.repository.choice.DeniedStatus9Choice;
...
@XmlType(name = "ProcessingStatus24Choice", propOrder = {"acknowledgedAccepted", "rejected", "completed", "denied", "pending", "proprietary"})
public class ProcessingStatus24Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ProcessingStatus24Choice
	 * ProcessingStatus24Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, AcknowledgedAcceptedStatus20Choice> mmAcknowledgedAccepted = new MMMessageAssociationEnd<ProcessingStatus24Choice, AcknowledgedAcceptedStatus20Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmAcknowledgedAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.ProcessingStatus24Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
		...
		@Override
		public AcknowledgedAcceptedStatus20Choice getValue(ProcessingStatus24Choice obj) {
			return obj.getAcknowledgedAccepted();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, AcknowledgedAcceptedStatus20Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, RejectionOrRepairStatus20Choice> mmRejected = new MMMessageAssociationEnd<ProcessingStatus24Choice, RejectionOrRepairStatus20Choice>() {
		{
		...
		@Override
		public RejectionOrRepairStatus20Choice getValue(ProcessingStatus24Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, RejectionOrRepairStatus20Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, ProprietaryReason2> mmCompleted = new MMMessageAssociationEnd<ProcessingStatus24Choice, ProprietaryReason2>() {
		{
		...
		@Override
		public ProprietaryReason2 getValue(ProcessingStatus24Choice obj) {
			return obj.getCompleted();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, ProprietaryReason2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, DeniedStatus9Choice> mmDenied = new MMMessageAssociationEnd<ProcessingStatus24Choice, DeniedStatus9Choice>() {
		{
		...
		@Override
		public DeniedStatus9Choice getValue(ProcessingStatus24Choice obj) {
			return obj.getDenied();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, DeniedStatus9Choice value) {
			obj.setDenied(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, PendingStatus24Choice> mmPending = new MMMessageAssociationEnd<ProcessingStatus24Choice, PendingStatus24Choice>() {
		{
		...
		@Override
		public PendingStatus24Choice getValue(ProcessingStatus24Choice obj) {
			return obj.getPending();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, PendingStatus24Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ProcessingStatus24Choice, ProprietaryStatusAndReason2> mmProprietary = new MMMessageAssociationEnd<ProcessingStatus24Choice, ProprietaryStatusAndReason2>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.ProcessingStatus24Choice.mmObject();
			isDerived = false;
		...
		@Override
		public ProprietaryStatusAndReason2 getValue(ProcessingStatus24Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ProcessingStatus24Choice obj, ProprietaryStatusAndReason2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus24Choice.mmAcknowledgedAccepted, com.tools20022.repository.choice.ProcessingStatus24Choice.mmRejected,
						com.tools20022.repository.choice.ProcessingStatus24Choice.mmCompleted, com.tools20022.repository.choice.ProcessingStatus24Choice.mmDenied, com.tools20022.repository.choice.ProcessingStatus24Choice.mmPending,
						com.tools20022.repository.choice.ProcessingStatus24Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ProcessingStatus24Choice";
	...
	public ProcessingStatus24Choice setAcknowledgedAccepted(AcknowledgedAcceptedStatus20Choice acknowledgedAccepted) {
	...
	public ProcessingStatus24Choice setRejected(RejectionOrRepairStatus20Choice rejected) {
	...
	public ProcessingStatus24Choice setCompleted(ProprietaryReason2 completed) {
	...
	public ProcessingStatus24Choice setDenied(DeniedStatus9Choice denied) {
	...
	public ProcessingStatus24Choice setPending(PendingStatus24Choice pending) {
	...
	public ProcessingStatus24Choice setProprietary(ProprietaryStatusAndReason2 proprietary) {
