 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.References8Choice#mmIntraPositionMovementIdentification
 * References8Choice.mmIntraPositionMovementIdentification}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forReferences8Choice
 * ConstraintCoexistenceIdentificationRule.forReferences8Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "References8Choice", propOrder = {"securitiesSettlementTransactionIdentification", "securitiesFinancingTransactionIdentification", "intraPositionMovementIdentification", "otherTransactionIdentification"})
public class References8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References8Choice.mmSecuritiesSettlementTransactionIdentification,
						com.tools20022.repository.choice.References8Choice.mmSecuritiesFinancingTransactionIdentification, com.tools20022.repository.choice.References8Choice.mmIntraPositionMovementIdentification,
						com.tools20022.repository.choice.References8Choice.mmOtherTransactionIdentification);
				trace_lazy = () -> SecuritiesTradeIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forReferences8Choice);
	...
	public References8Choice setSecuritiesSettlementTransactionIdentification(SettlementTypeAndIdentification7 securitiesSettlementTransactionIdentification) {
	...
	public References8Choice setSecuritiesFinancingTransactionIdentification(SettlementTypeAndIdentification7 securitiesFinancingTransactionIdentification) {
	...
	public References8Choice setIntraPositionMovementIdentification(RestrictedFINXMax16Text intraPositionMovementIdentification) {
	...
	public References8Choice setOtherTransactionIdentification(GenericDocumentIdentification2 otherTransactionIdentification) {
