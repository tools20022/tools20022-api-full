...
public class AmountType2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AmountType2Choice.InstructedAmount, com.tools20022.repository.choice.AmountType2Choice.EquivalentAmount);
