 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat12Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat12Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat12Choice", propOrder = {"percentagePrice", "amountPrice", "indexPoints"})
public class PriceFormat12Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat12Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat12Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat12Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat12Choice);
	...
	public PriceFormat12Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat12Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat12Choice setIndexPoints(RestrictedFINDecimalNumber indexPoints) {
