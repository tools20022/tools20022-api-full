...
public class PriceFormat12Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat12Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat12Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat12Choice.IndexPoints);
