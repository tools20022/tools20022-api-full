 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatementBasis6Choice#Code
 * StatementBasis6Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementBasis6Choice#Proprietary
 * StatementBasis6Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementBasis6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementBasis6Choice.Code, com.tools20022.repository.choice.StatementBasis6Choice.Proprietary);
