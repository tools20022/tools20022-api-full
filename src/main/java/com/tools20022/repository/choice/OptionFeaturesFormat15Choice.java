...
@XmlType(name = "OptionFeaturesFormat15Choice", propOrder = {"code", "proprietary"})
public class OptionFeaturesFormat15Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionFeaturesFormat15Choice, OptionFeatures5Code> mmCode = new MMMessageAttribute<OptionFeaturesFormat15Choice, OptionFeatures5Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat15Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public OptionFeatures5Code getValue(OptionFeaturesFormat15Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionFeaturesFormat15Choice obj, OptionFeatures5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionFeaturesFormat15Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<OptionFeaturesFormat15Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat15Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(OptionFeaturesFormat15Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionFeaturesFormat15Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat15Choice.mmCode, com.tools20022.repository.choice.OptionFeaturesFormat15Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionFeaturesFormat15Choice";
	...
	public OptionFeaturesFormat15Choice setCode(OptionFeatures5Code code) {
	...
	public OptionFeaturesFormat15Choice setProprietary(GenericIdentification25 proprietary) {
