 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.AccountCriteriaDefinition2Choice#QueryName
 * AccountCriteriaDefinition2Choice.QueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.AccountCriteriaDefinition2Choice#NewCriteria
 * AccountCriteriaDefinition2Choice.NewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class AccountCriteriaDefinition2Choice {
	...
	public static final MMMessageAttribute QueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AccountCriteriaDefinition2Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountCriteriaDefinition2Choice.QueryName, com.tools20022.repository.choice.AccountCriteriaDefinition2Choice.NewCriteria);
