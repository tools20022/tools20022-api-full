...
public class AccountCriteriaDefinition2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountCriteriaDefinition2Choice.mmQueryName, AccountCriteriaDefinition2Choice.mmNewCriteria);
	...
	public void setNewCriteria(AccountCriteria2 newCriteria) {
