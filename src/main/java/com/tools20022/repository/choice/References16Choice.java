...
public class References16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References16Choice.mmSecuritiesSettlementTransactionIdentification, References16Choice.mmIntraPositionMovementIdentification,
						References16Choice.mmIntraBalanceMovementIdentification, References16Choice.mmAccountServicerTransactionIdentification, References16Choice.mmMarketInfrastructureTransactionIdentification,
						References16Choice.mmPoolIdentification, References16Choice.mmOtherTransactionIdentification);
