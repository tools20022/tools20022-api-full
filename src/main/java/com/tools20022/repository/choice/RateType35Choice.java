 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.RateType5Choice RateType5Choice}
 * </li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "RateType35Choice", propOrder = {"code", "proprietary"})
public class RateType35Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.RateType5Choice#mmCode
	 * RateType5Choice.mmCode}</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType35Choice, RateType1Code> mmCode = new MMMessageAttribute<RateType35Choice, RateType1Code>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType35Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Rate expressed as an ISO 20022 code.";
			previousVersion_lazy = () -> RateType5Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RateType1Code getValue(RateType35Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RateType35Choice obj, RateType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateType35Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RateType35Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> InterestCalculation.mmRateType;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateType35Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification30 getValue(RateType35Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RateType35Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType35Choice.mmCode, com.tools20022.repository.choice.RateType35Choice.mmProprietary);
				trace_lazy = () -> InterestCalculation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType35Choice";
				definition = "Choice between a code and or a data source scheme to determine the rate.";
				previousVersion_lazy = () -> RateType5Choice.mmObject();
			}
		});
	...
	public RateType35Choice setCode(RateType1Code code) {
	...
	public RateType35Choice setProprietary(GenericIdentification30 proprietary) {
