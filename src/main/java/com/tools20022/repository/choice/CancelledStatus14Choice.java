...
import com.tools20022.repository.msg.CancelledStatusReason13;
...
@XmlType(name = "CancelledStatus14Choice", propOrder = {"noSpecifiedReason", "reason"})
public class CancelledStatus14Choice {
	...
	protected List<CancelledStatusReason13> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancelledStatus14Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.CancelledStatus14Choice.mmReason);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancelledStatus14Choice";
	...
	public CancelledStatus14Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<CancelledStatusReason13> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public CancelledStatus14Choice setReason(List<CancelledStatusReason13> reason) {
