...
public class CancelledStatus14Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus14Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus14Choice.mmNoSpecifiedReason, CancelledStatus14Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason13> reason) {
		this.reason = reason;
	}
}