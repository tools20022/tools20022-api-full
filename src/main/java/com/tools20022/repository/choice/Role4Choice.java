...
public class Role4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Role4Choice Role4Choice}</li>
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			name = "Code";
			definition = "Role of the party in the activity expressed as a code.";
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Role4Choice.Code, com.tools20022.repository.choice.Role4Choice.Proprietary);
