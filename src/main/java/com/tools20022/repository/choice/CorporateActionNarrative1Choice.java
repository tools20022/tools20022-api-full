...
@XmlType(name = "CorporateActionNarrative1Choice", propOrder = {"code", "proprietary"})
public class CorporateActionNarrative1Choice {
	...
	public CorporateActionNarrative1Choice setCode(CorporateActionNarrative1Code code) {
	...
	public CorporateActionNarrative1Choice setProprietary(GenericIdentification20 proprietary) {
