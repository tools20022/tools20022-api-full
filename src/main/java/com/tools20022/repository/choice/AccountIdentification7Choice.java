...
public class AccountIdentification7Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification7Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV01.mmAccountDetails,
						com.tools20022.repository.area.seev.CorporateActionNotificationV01.mmAccountDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountAndBalance1> accountsListAndBalanceDetails) {
