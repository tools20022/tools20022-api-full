...
import com.tools20022.repository.msg.AccountAndBalance1;
...
@XmlType(name = "AccountIdentification7Choice", propOrder = {"forAllAccounts", "accountsListAndBalanceDetails"})
public class AccountIdentification7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification7Choice, AccountIdentification10> mmForAllAccounts = new MMMessageAssociationEnd<AccountIdentification7Choice, AccountIdentification10>() {
		{
			businessComponentTrace_lazy = () -> AccountIdentification.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.AccountIdentification7Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
		...
		@Override
		public AccountIdentification10 getValue(AccountIdentification7Choice obj) {
			return obj.getForAllAccounts();
		}

		@Override
		public void setValue(AccountIdentification7Choice obj, AccountIdentification10 value) {
			obj.setForAllAccounts(value);
		}
	};
	@XmlElement(name = "AcctsListAndBalDtls", required = true)
	protected List<AccountAndBalance1> accountsListAndBalanceDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.AccountAndBalance1
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<AccountIdentification7Choice, List<AccountAndBalance1>> mmAccountsListAndBalanceDetails = new MMMessageAssociationEnd<AccountIdentification7Choice, List<AccountAndBalance1>>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> AccountAndBalance1.mmObject();
		}

		@Override
		public List<AccountAndBalance1> getValue(AccountIdentification7Choice obj) {
			return obj.getAccountsListAndBalanceDetails();
		}

		@Override
		public void setValue(AccountIdentification7Choice obj, List<AccountAndBalance1> value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification7Choice.mmForAllAccounts, com.tools20022.repository.choice.AccountIdentification7Choice.mmAccountsListAndBalanceDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdviceV01.mmAccountDetails, CorporateActionNotificationV01.mmAccountDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AccountIdentification7Choice";
	...
	public AccountIdentification7Choice setForAllAccounts(AccountIdentification10 forAllAccounts) {
		this.forAllAccounts = Objects.requireNonNull(forAllAccounts);
		return this;
	}

	public List<AccountAndBalance1> getAccountsListAndBalanceDetails() {
		return accountsListAndBalanceDetails == null ? accountsListAndBalanceDetails = new ArrayList<>() : accountsListAndBalanceDetails;
	}

	public AccountIdentification7Choice setAccountsListAndBalanceDetails(List<AccountAndBalance1> accountsListAndBalanceDetails) {
