...
public class AccountIdentification7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountIdentification7Choice.ForAllAccounts, com.tools20022.repository.choice.AccountIdentification7Choice.AccountsListAndBalanceDetails);
				trace_lazy = () -> AccountIdentification.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.seev.CorporateActionMovementPreliminaryAdviceV01.AccountDetails,
						com.tools20022.repository.area.seev.CorporateActionNotificationV01.AccountDetails);
