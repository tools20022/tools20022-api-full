 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType2Choice#mmCode
...
@XmlType(name = "ExposureType2Choice", propOrder = {"code", "proprietary"})
public class ExposureType2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExposureType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ExposureType2Choice
	 * ExposureType2Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType2Choice, ExposureType1Code> mmCode = new MMMessageAttribute<ExposureType2Choice, ExposureType1Code>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ExposureType1Code getValue(ExposureType2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ExposureType2Choice obj, ExposureType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExposureType2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ExposureType2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(ExposureType2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ExposureType2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType2Choice.mmCode, com.tools20022.repository.choice.ExposureType2Choice.mmProprietary);
				trace_lazy = () -> ExposureTerm.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ExposureType2Choice";
	...
	public ExposureType1Code getCode() {
		return code;
	}

	public ExposureType2Choice setCode(ExposureType1Code code) {
	...
	public ExposureType2Choice setProprietary(GenericIdentification25 proprietary) {
