...
@XmlType(name = "PendingProcessingStatus4Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingProcessingStatus4Choice {
	...
	public static final MMMessageAttribute<PendingProcessingStatus4Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<PendingProcessingStatus4Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(PendingProcessingStatus12Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<PendingProcessingStatus4Choice, List<PendingProcessingReason1>> mmReason = new MMMessageAssociationEnd<PendingProcessingStatus4Choice, List<PendingProcessingReason1>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingProcessingStatus12Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingStatus4Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingProcessingStatus4Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingStatus4Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(PendingProcessingStatus12Choice.mmObject());
	...
	public PendingProcessingStatus4Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public PendingProcessingStatus4Choice setReason(List<PendingProcessingReason1> reason) {
