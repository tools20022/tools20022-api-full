 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StandingOrderCriteria1Choice#QueryName
 * StandingOrderCriteria1Choice.QueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StandingOrderCriteria1Choice#NewCriteria
 * StandingOrderCriteria1Choice.NewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class StandingOrderCriteria1Choice {
	...
	public static final MMMessageAttribute QueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> StandingOrderCriteria1Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StandingOrderCriteria1Choice.QueryName, com.tools20022.repository.choice.StandingOrderCriteria1Choice.NewCriteria);
