...
public class Counterparty8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Counterparty8Choice.mmSeller, Counterparty8Choice.mmBuyer);
	...
	public void setSeller(PartyIdentificationAndAccount71 seller) {
		this.seller = seller;
	}
	...
	public void setBuyer(PartyIdentificationAndAccount71 buyer) {
		this.buyer = buyer;
	}
}