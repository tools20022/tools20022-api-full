 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty8Choice#Seller
 * Counterparty8Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty8Choice#Buyer
 * Counterparty8Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty8Choice {
	...
	public static final MMMessageAssociationEnd Seller = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Counterparty8Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty8Choice.Seller, com.tools20022.repository.choice.Counterparty8Choice.Buyer);
