...
public class References28Choice {
	...
	public static final MMMessageAttribute mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References28Choice.mmObject();
			isDerived = false;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References28Choice.mmSecuritiesSettlementTransactionIdentification, References28Choice.mmPoolIdentification, References28Choice.mmIntraPositionMovementIdentification,
						References28Choice.mmAccountServicerTransactionIdentification, References28Choice.mmOtherTransactionIdentification);
