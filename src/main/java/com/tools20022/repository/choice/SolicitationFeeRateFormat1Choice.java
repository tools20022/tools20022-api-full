 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.SolicitationFeeRateFormat1Choice#NotSpecifiedRate
 * SolicitationFeeRateFormat1Choice.NotSpecifiedRate}</li>
 * <li>
...
public class SolicitationFeeRateFormat1Choice {
	...
	public static final MMMessageAttribute Rate = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SolicitationFeeRateFormat1Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SolicitationFeeRateFormat1Choice.Rate, com.tools20022.repository.choice.SolicitationFeeRateFormat1Choice.NotSpecifiedRate,
						com.tools20022.repository.choice.SolicitationFeeRateFormat1Choice.AmountToQuantity);
