 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat39Choice#mmNotSpecifiedPrice
 * PriceFormat39Choice.mmNotSpecifiedPrice}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forPriceFormat39Choice
 * ConstraintCoexistenceQuantityRule.forPriceFormat39Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat39Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat39Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat39Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount", "indexPoints"})
public class PriceFormat39Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat39Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat39Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat39Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat39Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat39Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat39Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat39Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat39Choice, PriceValueType8Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat39Choice, PriceValueType8Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat39Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType8Code getValue(PriceFormat39Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, PriceValueType8Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat39Choice, AmountPricePerFinancialInstrumentQuantity4> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat39Choice, AmountPricePerFinancialInstrumentQuantity4>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity4 getValue(PriceFormat39Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, AmountPricePerFinancialInstrumentQuantity4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat39Choice, AmountPricePerAmount3> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat39Choice, AmountPricePerAmount3>() {
		{
		...
		@Override
		public AmountPricePerAmount3 getValue(PriceFormat39Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, AmountPricePerAmount3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat39Choice, RestrictedFINDecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat39Choice, RestrictedFINDecimalNumber>() {
		{
		...
		@Override
		public RestrictedFINDecimalNumber getValue(PriceFormat39Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat39Choice obj, RestrictedFINDecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat39Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat39Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat39Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat39Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat39Choice.mmAmountPricePerAmount, com.tools20022.repository.choice.PriceFormat39Choice.mmIndexPoints);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat39Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat39Choice);
	...
	public PriceFormat39Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat39Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat39Choice setNotSpecifiedPrice(PriceValueType8Code notSpecifiedPrice) {
	...
	public PriceFormat39Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity4 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat39Choice setAmountPricePerAmount(AmountPricePerAmount3 amountPricePerAmount) {
	...
	public PriceFormat39Choice setIndexPoints(RestrictedFINDecimalNumber indexPoints) {
