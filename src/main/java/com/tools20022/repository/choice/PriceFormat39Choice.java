...
public class PriceFormat39Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat39Choice.mmPercentagePrice, PriceFormat39Choice.mmAmountPrice, PriceFormat39Choice.mmNotSpecifiedPrice, PriceFormat39Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat39Choice.mmAmountPricePerAmount, PriceFormat39Choice.mmIndexPoints);
