...
public class PartyIdentification52Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification52Choice.mmAnyBIC, PartyIdentification52Choice.mmProprietaryIdentification, PartyIdentification52Choice.mmNameAndAddress);
