...
public class RejectionOrRepairStatus20Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus20Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus20Choice.mmNoSpecifiedReason, RejectionOrRepairStatus20Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason16> reason) {
		this.reason = reason;
	}
}