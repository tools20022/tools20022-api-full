...
import com.tools20022.repository.msg.RejectionOrRepairReason16;
...
@XmlType(name = "RejectionOrRepairStatus20Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionOrRepairStatus20Choice {
	...
	protected List<RejectionOrRepairReason16> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus20Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus20Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairStatus20Choice";
	...
	public RejectionOrRepairStatus20Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionOrRepairReason16> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionOrRepairStatus20Choice setReason(List<RejectionOrRepairReason16> reason) {
