...
public class CorporateActionEventType42Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType42Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType42Choice.mmCode, CorporateActionEventType42Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType18Code code) {
		this.code = code;
	}
