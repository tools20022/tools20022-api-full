...
public class PartyIdentification66Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification66Choice.mmAnyBIC, PartyIdentification66Choice.mmProprietaryIdentification, PartyIdentification66Choice.mmNameAndAddress);
