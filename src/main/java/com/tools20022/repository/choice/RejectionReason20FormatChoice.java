...
@XmlType(name = "RejectionReason20FormatChoice", propOrder = {"code", "proprietary"})
public class RejectionReason20FormatChoice {
	...
	public RejectionReason20FormatChoice setCode(RejectionReason20Code code) {
	...
	public RejectionReason20FormatChoice setProprietary(GenericIdentification13 proprietary) {
