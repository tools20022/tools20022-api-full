...
public class ProcessingStatus42Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus42Choice.mmAcknowledgedAccepted, ProcessingStatus42Choice.mmPendingProcessing, ProcessingStatus42Choice.mmRejected, ProcessingStatus42Choice.mmRepair,
						ProcessingStatus42Choice.mmCancelled, ProcessingStatus42Choice.mmPendingCancellation, ProcessingStatus42Choice.mmProprietary, ProcessingStatus42Choice.mmCancellationRequested,
						ProcessingStatus42Choice.mmModificationRequested);
