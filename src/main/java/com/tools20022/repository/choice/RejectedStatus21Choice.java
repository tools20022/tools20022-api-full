...
public class RejectedStatus21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus21Choice.NoSpecifiedReason, com.tools20022.repository.choice.RejectedStatus21Choice.Reason);
