...
@XmlType(name = "SystemEventType2Choice", propOrder = {"code", "proprietary"})
public class SystemEventType2Choice {
	...
	public SystemEventType2Choice setCode(SystemEventType2Code code) {
	...
	public SystemEventType2Choice setProprietary(GenericIdentification1 proprietary) {
