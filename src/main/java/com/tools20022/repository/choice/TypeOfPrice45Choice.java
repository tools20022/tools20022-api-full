 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TypeOfPrice45Choice#Code
...
public class TypeOfPrice45Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TypeOfPrice45Choice.Code, com.tools20022.repository.choice.TypeOfPrice45Choice.Proprietary);
