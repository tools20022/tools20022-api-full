 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.TypeOfPrice45Choice#mmCode
...
@XmlType(name = "TypeOfPrice45Choice", propOrder = {"code", "proprietary"})
public class TypeOfPrice45Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TypeOfPrice45Choice.mmCode, com.tools20022.repository.choice.TypeOfPrice45Choice.mmProprietary);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TypeOfPrice45Choice";
	...
	public TypeOfPrice45Choice setCode(TypeOfPrice16Code code) {
	...
	public TypeOfPrice45Choice setProprietary(GenericIdentification47 proprietary) {
