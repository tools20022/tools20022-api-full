 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlingCapacity5Choice#Code
 * SettlingCapacity5Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlingCapacity5Choice#Proprietary
 * SettlingCapacity5Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlingCapacity5Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlingCapacity5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity5Choice.Code, com.tools20022.repository.choice.SettlingCapacity5Choice.Proprietary);
