...
import com.tools20022.repository.codeset.ExternalTechnicalError1Code;
 ...
 * definition} = "Specifies the reason for the technical error."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "TechnicalError1Choice", propOrder = {"code", "proprietary"})
public class TechnicalError1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExternalTechnicalError1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<TechnicalError1Choice, ExternalTechnicalError1Code> mmCode = new MMMessageAttribute<TechnicalError1Choice, ExternalTechnicalError1Code>() {
		{
			...
			name = "Code";
			definition = "Reason for the technical error, as published in an external technical error code list.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<TechnicalError1Choice, Max35Text> mmProprietary = new MMMessageAttribute<TechnicalError1Choice, Max35Text>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Reason for the technical error, in a proprietary form.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TechnicalError1Choice.mmCode, com.tools20022.repository.choice.TechnicalError1Choice.mmProprietary);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TechnicalError1Choice";
				definition = "Specifies the reason for the technical error.";
			}
		});
		return mmObject_lazy.get();
	}

	public ExternalTechnicalError1Code getCode() {
		return code;
	}

	public TechnicalError1Choice setCode(ExternalTechnicalError1Code code) {
	...
	public TechnicalError1Choice setProprietary(Max35Text proprietary) {
