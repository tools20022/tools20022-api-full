...
@XmlType(name = "SettlementTransactionCondition7Choice", propOrder = {"code", "proprietary"})
public class SettlementTransactionCondition7Choice {
	...
	public static final MMMessageAttribute<SettlementTransactionCondition7Choice, SettlementTransactionCondition6Code> mmCode = new MMMessageAttribute<SettlementTransactionCondition7Choice, SettlementTransactionCondition6Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementTransactionCondition18Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<SettlementTransactionCondition7Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<SettlementTransactionCondition7Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SettlementTransactionCondition18Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition7Choice.mmCode, com.tools20022.repository.choice.SettlementTransactionCondition7Choice.mmProprietary);
				...
				name = "SettlementTransactionCondition7Choice";
				definition = "Choice of format for the settlement transaction conditions.";
				nextVersions_lazy = () -> Arrays.asList(SettlementTransactionCondition18Choice.mmObject());
			}
		});
	...
	public SettlementTransactionCondition7Choice setCode(SettlementTransactionCondition6Code code) {
	...
	public SettlementTransactionCondition7Choice setProprietary(GenericIdentification20 proprietary) {
