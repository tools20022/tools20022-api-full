 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintPendingToFailingRule#forStatus2Choice
 * ConstraintPendingToFailingRule.forStatus2Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintSettlementStatusAndMatchedRule#forStatus2Choice
 * ConstraintSettlementStatusAndMatchedRule.forStatus2Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "Status2Choice", propOrder = {"proprietary", "matchingStatus", "inferredMatchingStatus", "settlementStatus", "instructionProcessingStatus"})
public class Status2Choice {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPendingToFailingRule.forStatus2Choice, com.tools20022.repository.constraints.ConstraintSettlementStatusAndMatchedRule.forStatus2Choice);
	...
	public Status2Choice setProprietary(ProprietaryStatusAndReason1 proprietary) {
