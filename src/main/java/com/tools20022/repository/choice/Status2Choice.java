...
public class Status2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Status2Choice.mmProprietary, Status2Choice.mmMatchingStatus, Status2Choice.mmInferredMatchingStatus, Status2Choice.mmSettlementStatus, Status2Choice.mmInstructionProcessingStatus);
