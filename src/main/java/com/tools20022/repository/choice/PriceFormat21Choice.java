...
public class PriceFormat21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat21Choice.mmPercentagePrice, PriceFormat21Choice.mmAmountPrice, PriceFormat21Choice.mmNotSpecifiedPrice, PriceFormat21Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat21Choice.mmAmountPricePerAmount);
