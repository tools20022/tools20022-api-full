 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatementBasis5Choice#Code
 * StatementBasis5Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementBasis5Choice#Proprietary
 * StatementBasis5Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementBasis5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementBasis5Choice.Code, com.tools20022.repository.choice.StatementBasis5Choice.Proprietary);
