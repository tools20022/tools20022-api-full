 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementBasis5Choice#mmCode
 * StatementBasis5Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementBasis5Choice#mmProprietary
 * StatementBasis5Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "StatementBasis5Choice", propOrder = {"code", "proprietary"})
public class StatementBasis5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementBasis5Choice.mmCode, com.tools20022.repository.choice.StatementBasis5Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StatementBasis5Choice";
	...
	public StatementBasis5Choice setCode(StatementBasis2Code code) {
	...
	public StatementBasis5Choice setProprietary(GenericIdentification25 proprietary) {
