 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Frequency6Choice#Code
 * Frequency6Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.Frequency6Choice#Proprietary
 * Frequency6Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Frequency6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Frequency6Choice.Code, com.tools20022.repository.choice.Frequency6Choice.Proprietary);
