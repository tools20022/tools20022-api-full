...
public class AccountParties5Choice {
	...
	public static final MMMessageAssociationEnd PrimaryOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties4Choice.PrimaryOwner;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties8Choice.PrimaryOwner);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Trustee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties4Choice.Trustee;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties8Choice.Trustee);
			minOccurs = 1;
			maxOccurs = 5;
			type_lazy = () -> InvestmentAccountOwnershipInformation10.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd CustodianForMinor = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties4Choice.CustodianForMinor;
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> InvestmentAccountOwnershipInformation10.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Nominee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties4Choice.Nominee;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties8Choice.Nominee);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> InvestmentAccountOwnershipInformation10.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd JointOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties4Choice.JointOwner;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties8Choice.JointOwner);
			minOccurs = 1;
			maxOccurs = 5;
			type_lazy = () -> InvestmentAccountOwnershipInformation10.mmObject();
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties5Choice.PrimaryOwner, com.tools20022.repository.choice.AccountParties5Choice.Trustee,
						com.tools20022.repository.choice.AccountParties5Choice.CustodianForMinor, com.tools20022.repository.choice.AccountParties5Choice.Nominee, com.tools20022.repository.choice.AccountParties5Choice.JointOwner);
