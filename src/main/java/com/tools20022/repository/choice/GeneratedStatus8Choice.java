...
public class GeneratedStatus8Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GeneratedStatus8Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedStatus8Choice.mmNoSpecifiedReason, GeneratedStatus8Choice.mmReason);
	...
	public void setReason(List<GeneratedReason6> reason) {
		this.reason = reason;
	}
}