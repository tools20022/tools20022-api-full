...
public class GeneratedStatus1Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GeneratedStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedStatus1Choice.mmNoSpecifiedReason, GeneratedStatus1Choice.mmReason);
	...
	public void setReason(List<GeneratedReason1> reason) {
		this.reason = reason;
	}
}