...
public class UnmatchedStatus20Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus20Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus20Choice.mmNoSpecifiedReason, UnmatchedStatus20Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason19> reason) {
		this.reason = reason;
	}
}