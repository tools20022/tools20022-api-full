...
@XmlType(name = "SettlementTransactionCondition19Choice", propOrder = {"code", "proprietary"})
public class SettlementTransactionCondition19Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTransactionCondition19Choice, SettlementTransactionCondition3Code> mmCode = new MMMessageAttribute<SettlementTransactionCondition19Choice, SettlementTransactionCondition3Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition19Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> SettlementTransactionCondition2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public SettlementTransactionCondition3Code getValue(SettlementTransactionCondition19Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementTransactionCondition19Choice obj, SettlementTransactionCondition3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTransactionCondition19Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<SettlementTransactionCondition19Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition19Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> SettlementTransactionCondition2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(SettlementTransactionCondition19Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementTransactionCondition19Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition19Choice.mmCode, com.tools20022.repository.choice.SettlementTransactionCondition19Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementTransactionCondition19Choice";
				definition = "Choice of format for the settlement transaction conditions.";
				previousVersion_lazy = () -> SettlementTransactionCondition2Choice.mmObject();
			}
		});
	...
	public SettlementTransactionCondition19Choice setCode(SettlementTransactionCondition3Code code) {
	...
	public SettlementTransactionCondition19Choice setProprietary(GenericIdentification30 proprietary) {
