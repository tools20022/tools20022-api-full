...
@XmlType(name = "CancellationProcessingStatus8Choice", propOrder = {"code", "proprietary"})
public class CancellationProcessingStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationProcessingStatus8Choice.mmCode, com.tools20022.repository.choice.CancellationProcessingStatus8Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationProcessingStatus8Choice";
	...
	public CancellationProcessingStatus8Choice setCode(CancellationProcessingStatus1Code code) {
	...
	public CancellationProcessingStatus8Choice setProprietary(GenericIdentification47 proprietary) {
