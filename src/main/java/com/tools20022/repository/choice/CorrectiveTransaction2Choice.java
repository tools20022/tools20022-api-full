	...
	public static final MMMessageAssociationEnd Initiation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CorrectiveTransaction1Choice.Initiation;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Interbank = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CorrectiveTransaction1Choice.Interbank;
			minOccurs = 1;
			maxOccurs = 1;
