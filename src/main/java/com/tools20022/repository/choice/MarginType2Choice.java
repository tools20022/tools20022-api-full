...
import com.tools20022.repository.codeset.MarginType2Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MarginType2Choice#mmCode
 * MarginType2Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.MarginType2Choice#mmProprietary
 * MarginType2Choice.mmProprietary}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "MarginType2Choice", propOrder = {"code", "proprietary"})
public class MarginType2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected MarginType2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.MarginType2Choice
	 * MarginType2Choice}</li>
	...
	public static final MMMessageAssociationEnd<MarginType2Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<MarginType2Choice, GenericIdentification30>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Proprietary or institution's own code that specifies the type of margin, for example, initial margin, variation margin, initial deposit or coupon margin.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarginType2Choice.mmCode, com.tools20022.repository.choice.MarginType2Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "MarginType2Choice";
				definition = "Specifies the type of margin, for example, initial margin, variation margin, initial deposit or coupon margin.";
			}
		});
	...
	public MarginType2Code getCode() {
		return code;
	}

	public MarginType2Choice setCode(MarginType2Code code) {
	...
	public MarginType2Choice setProprietary(GenericIdentification30 proprietary) {
