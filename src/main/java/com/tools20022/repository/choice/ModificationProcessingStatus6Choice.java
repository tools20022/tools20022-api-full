...
public class ModificationProcessingStatus6Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, AcknowledgedAcceptedStatus15Choice> mmAcknowledgedAccepted = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, AcknowledgedAcceptedStatus15Choice>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmAcknowledgedAcceptedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
		...
		@Override
		public AcknowledgedAcceptedStatus15Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getAcknowledgedAccepted();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, AcknowledgedAcceptedStatus15Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, PendingProcessingStatus8Choice> mmPendingProcessing = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, PendingProcessingStatus8Choice>() {
		{
		...
		@Override
		public PendingProcessingStatus8Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getPendingProcessing();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, PendingProcessingStatus8Choice value) {
			obj.setPendingProcessing(value);
		}
	};
	@XmlElement(name = "Dnd", required = true)
	protected DeniedStatus13Choice denied;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.DeniedStatus13Choice
	 * DeniedStatus13Choice}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, DeniedStatus13Choice> mmDenied = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, DeniedStatus13Choice>() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> DeniedStatus13Choice.mmObject();
		}

		@Override
		public DeniedStatus13Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getDenied();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, DeniedStatus13Choice value) {
			obj.setDenied(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, RejectionStatus10Choice> mmRejected = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, RejectionStatus10Choice>() {
		{
		...
		@Override
		public RejectionStatus10Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getRejected();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, RejectionStatus10Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, RepairStatus9Choice> mmRepaired = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, RepairStatus9Choice>() {
		{
		...
		@Override
		public RepairStatus9Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getRepaired();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, RepairStatus9Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ModificationProcessingStatus6Choice, ModificationStatus3Choice> mmModified = new MMMessageAttribute<ModificationProcessingStatus6Choice, ModificationStatus3Choice>() {
		{
		...
		@Override
		public ModificationStatus3Choice getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getModified();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, ModificationStatus3Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ModificationProcessingStatus6Choice, ProprietaryStatusAndReason2> mmProprietary = new MMMessageAssociationEnd<ModificationProcessingStatus6Choice, ProprietaryStatusAndReason2>() {
		{
		...
		@Override
		public ProprietaryStatusAndReason2 getValue(ModificationProcessingStatus6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ModificationProcessingStatus6Choice obj, ProprietaryStatusAndReason2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmAcknowledgedAccepted,
						com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmPendingProcessing, com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmDenied,
						com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmRejected, com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmRepaired,
						com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmModified, com.tools20022.repository.choice.ModificationProcessingStatus6Choice.mmProprietary);
				...
				name = "ModificationProcessingStatus6Choice";
	...
	public ModificationProcessingStatus6Choice setAcknowledgedAccepted(AcknowledgedAcceptedStatus15Choice acknowledgedAccepted) {
	...
	public ModificationProcessingStatus6Choice setPendingProcessing(PendingProcessingStatus8Choice pendingProcessing) {
	...
	public ModificationProcessingStatus6Choice setDenied(DeniedStatus13Choice denied) {
	...
	public ModificationProcessingStatus6Choice setRejected(RejectionStatus10Choice rejected) {
	...
	public ModificationProcessingStatus6Choice setRepaired(RepairStatus9Choice repaired) {
	...
	public ModificationProcessingStatus6Choice setModified(ModificationStatus3Choice modified) {
	...
	public ModificationProcessingStatus6Choice setProprietary(ProprietaryStatusAndReason2 proprietary) {
