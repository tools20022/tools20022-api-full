...
public class ModificationProcessingStatus6Choice {
	...
	public static final MMMessageAssociationEnd mmDenied = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.DeniedStatus13Choice.mmObject();
		}
	};
	...
	public ModificationProcessingStatus6Choice setAcknowledgedAccepted(com.tools20022.repository.choice.AcknowledgedAcceptedStatus15Choice acknowledgedAccepted) {
	...
	public ModificationProcessingStatus6Choice setPendingProcessing(com.tools20022.repository.choice.PendingProcessingStatus8Choice pendingProcessing) {
	...
	public ModificationProcessingStatus6Choice setDenied(com.tools20022.repository.choice.DeniedStatus13Choice denied) {
	...
	public ModificationProcessingStatus6Choice setRejected(com.tools20022.repository.choice.RejectionStatus10Choice rejected) {
	...
	public ModificationProcessingStatus6Choice setRepaired(com.tools20022.repository.choice.RepairStatus9Choice repaired) {
	...
	public ModificationProcessingStatus6Choice setModified(com.tools20022.repository.choice.ModificationStatus3Choice modified) {
