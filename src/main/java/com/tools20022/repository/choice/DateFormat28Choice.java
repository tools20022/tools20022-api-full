 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat28Choice#Date
 * DateFormat28Choice.Date}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat28Choice#DateCode
 * DateFormat28Choice.DateCode}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateFormat28Choice {
	...
	public static final MMMessageAssociationEnd Date = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> DateFormat28Choice.mmObject();
			isDerived = false;
			xmlTag = "Dt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat28Choice.Date, com.tools20022.repository.choice.DateFormat28Choice.DateCode);
