 ...
 * <li>{@linkplain com.tools20022.repository.choice.PendingStatus7Choice#Reason
...
public class PendingStatus7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus7Choice.NoSpecifiedReason, com.tools20022.repository.choice.PendingStatus7Choice.Reason);
