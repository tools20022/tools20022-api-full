...
public class IntermediateSecuritiesDistributionTypeFormat13Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> IntermediateSecuritiesDistributionTypeFormat13Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntermediateSecuritiesDistributionTypeFormat13Choice.mmCode, IntermediateSecuritiesDistributionTypeFormat13Choice.mmProprietary);
