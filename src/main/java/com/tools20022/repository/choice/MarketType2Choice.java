 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MarketType2Choice#mmCode
...
@XmlType(name = "MarketType2Choice", propOrder = {"code", "proprietary"})
public class MarketType2Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.MarketType2Choice
	 * MarketType2Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MarketType2Choice, MarketType5Code> mmCode = new MMMessageAttribute<MarketType2Choice, MarketType5Code>() {
		{
			businessElementTrace_lazy = () -> TradingMarket.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.MarketType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public MarketType5Code getValue(MarketType2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(MarketType2Choice obj, MarketType5Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MarketType2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<MarketType2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> TradingMarket.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.MarketType2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(MarketType2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(MarketType2Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MarketType2Choice.mmCode, com.tools20022.repository.choice.MarketType2Choice.mmProprietary);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MarketType2Choice";
	...
	public MarketType2Choice setCode(MarketType5Code code) {
	...
	public MarketType2Choice setProprietary(GenericIdentification20 proprietary) {
