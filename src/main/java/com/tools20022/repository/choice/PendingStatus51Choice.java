...
import com.tools20022.repository.msg.PendingReason25;
...
@XmlType(name = "PendingStatus51Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingStatus51Choice {
	...
	protected List<PendingReason25> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.PendingReason25
	 * PendingReason25}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus51Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingStatus51Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatus51Choice";
	...
	public PendingStatus51Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<PendingReason25> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingStatus51Choice setReason(List<PendingReason25> reason) {
