 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat14Choice#mmNotSpecifiedPrice
 * PriceFormat14Choice.mmNotSpecifiedPrice}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forPriceFormat14Choice
 * ConstraintCoexistenceQuantityRule.forPriceFormat14Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat14Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat14Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat14Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount"})
public class PriceFormat14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat14Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat14Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat14Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat14Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat14Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat14Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat14Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat14Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat14Choice, PriceValueType5Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat14Choice, PriceValueType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType5Code getValue(PriceFormat14Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat14Choice obj, PriceValueType5Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat14Choice, AmountPricePerFinancialInstrumentQuantity4> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat14Choice, AmountPricePerFinancialInstrumentQuantity4>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity4 getValue(PriceFormat14Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat14Choice obj, AmountPricePerFinancialInstrumentQuantity4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat14Choice, AmountPricePerAmount3> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat14Choice, AmountPricePerAmount3>() {
		{
		...
		@Override
		public AmountPricePerAmount3 getValue(PriceFormat14Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat14Choice obj, AmountPricePerAmount3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat14Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat14Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat14Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat14Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat14Choice.mmAmountPricePerAmount);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat14Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat14Choice);
	...
	public PriceFormat14Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat14Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat14Choice setNotSpecifiedPrice(PriceValueType5Code notSpecifiedPrice) {
	...
	public PriceFormat14Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity4 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat14Choice setAmountPricePerAmount(AmountPricePerAmount3 amountPricePerAmount) {
