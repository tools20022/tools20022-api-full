...
public class PriceFormat14Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat14Choice.mmPercentagePrice, PriceFormat14Choice.mmAmountPrice, PriceFormat14Choice.mmNotSpecifiedPrice, PriceFormat14Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat14Choice.mmAmountPricePerAmount);
