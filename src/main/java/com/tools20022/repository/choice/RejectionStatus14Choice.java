...
@XmlType(name = "RejectionStatus14Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionStatus14Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(RejectionStatus19Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> RejectionStatus6Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionStatus19Choice.mmReason);
			previousVersion_lazy = () -> RejectionStatus6Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	public RejectionStatus14Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public RejectionStatus14Choice setReason(List<RejectionReason18> reason) {
