 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RenounceableStatus1FormatChoice#Code
 * RenounceableStatus1FormatChoice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RenounceableStatus1FormatChoice#Proprietary
 * RenounceableStatus1FormatChoice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class RenounceableStatus1FormatChoice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RenounceableStatus1FormatChoice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RenounceableStatus1FormatChoice.Code, com.tools20022.repository.choice.RenounceableStatus1FormatChoice.Proprietary);
