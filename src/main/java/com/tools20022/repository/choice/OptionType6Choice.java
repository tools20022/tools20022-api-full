 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionType6Choice#mmCode
...
@XmlType(name = "OptionType6Choice", propOrder = {"code", "proprietary"})
public class OptionType6Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OptionType6Choice
	 * OptionType6Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionType6Choice, OptionType1Code> mmCode = new MMMessageAttribute<OptionType6Choice, OptionType1Code>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> OptionType2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OptionType1Code getValue(OptionType6Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionType6Choice obj, OptionType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionType6Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<OptionType6Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionType6Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> OptionType2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(OptionType6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionType6Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionType6Choice.mmCode, com.tools20022.repository.choice.OptionType6Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionType6Choice";
				definition = "Choice of format for the option type.";
				previousVersion_lazy = () -> OptionType2Choice.mmObject();
			}
		});
	...
	public OptionType6Choice setCode(OptionType1Code code) {
	...
	public OptionType6Choice setProprietary(GenericIdentification30 proprietary) {
