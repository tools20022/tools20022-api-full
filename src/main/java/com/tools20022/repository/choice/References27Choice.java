 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule#forReferences27Choice
 * ConstraintCoexistenceIdentificationRule.forReferences27Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class References27Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References27Choice, Max35Text> mmAccountOwnerTransactionIdentification = new MMMessageAttribute<References27Choice, Max35Text>() {
		{
			businessElementTrace_lazy = () -> Entry.mmAccountOwnerTransactionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.choice.References27Choice.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AccountOwnerTransactionIdentification";
			definition = "Unambiguous identification of the transaction as known by the account owner (or the instructing party managing the account).";
			nextVersions_lazy = () -> Arrays.asList(References42Choice.mmAccountOwnerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(References27Choice obj) {
			return obj.getAccountOwnerTransactionIdentification();
		}

		@Override
		public void setValue(References27Choice obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References27Choice, Max35Text> mmAccountServicerTransactionIdentification = new MMMessageAttribute<References27Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References42Choice.mmAccountServicerTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References27Choice, Max35Text> mmPoolIdentification = new MMMessageAttribute<References27Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References42Choice.mmPoolIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References27Choice, Max35Text> mmMarketInfrastructureTransactionIdentification = new MMMessageAttribute<References27Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References42Choice.mmMarketInfrastructureTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<References27Choice, Max35Text> mmProcessorTransactionIdentification = new MMMessageAttribute<References27Choice, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(References42Choice.mmProcessorTransactionIdentification);
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> Max35Text.mmObject();
		}
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceIdentificationRule.forReferences27Choice);
	...
	public References27Choice setAccountOwnerTransactionIdentification(Max35Text accountOwnerTransactionIdentification) {
	...
	public References27Choice setAccountServicerTransactionIdentification(Max35Text accountServicerTransactionIdentification) {
	...
	public References27Choice setPoolIdentification(Max35Text poolIdentification) {
	...
	public References27Choice setMarketInfrastructureTransactionIdentification(Max35Text marketInfrastructureTransactionIdentification) {
	...
	public References27Choice setProcessorTransactionIdentification(Max35Text processorTransactionIdentification) {
