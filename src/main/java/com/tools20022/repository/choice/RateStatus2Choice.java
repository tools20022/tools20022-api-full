 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintRateStatusGuideline#forRateStatus2Choice
 * ConstraintRateStatusGuideline.forRateStatus2Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class RateStatus2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateStatus2Choice.mmCode, com.tools20022.repository.choice.RateStatus2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintRateStatusGuideline.forRateStatus2Choice);
	...
	public RateStatus2Choice setCode(RateStatus1Code code) {
	...
	public RateStatus2Choice setProprietary(GenericIdentification25 proprietary) {
