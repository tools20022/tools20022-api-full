...
public class RejectedStatus11Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatus11Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatus11Choice.mmNoSpecifiedReason, RejectedStatus11Choice.mmReason);
	...
	public void setReason(List<RejectedStatusReason11> reason) {
		this.reason = reason;
	}
}