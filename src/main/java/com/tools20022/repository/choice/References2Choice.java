...
public class References2Choice {
	...
	public static final MMMessageAssociationEnd SecuritiesSettlementTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References45Choice.SecuritiesSettlementTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd SecuritiesFinancingTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References45Choice.SecuritiesFinancingTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> SettlementTypeAndIdentification3.mmObject();
			isComposite = true;
	...
	public static final MMMessageAttribute IntraPositionMovementIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References45Choice.IntraPositionMovementIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd OtherTransactionIdentification = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References45Choice.OtherTransactionIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References2Choice.SecuritiesSettlementTransactionIdentification,
						com.tools20022.repository.choice.References2Choice.SecuritiesFinancingTransactionIdentification, com.tools20022.repository.choice.References2Choice.IntraPositionMovementIdentification,
						com.tools20022.repository.choice.References2Choice.OtherTransactionIdentification);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestV02.AccountOwnerTransactionIdentification,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestV03.AccountOwnerTransactionIdentification,
						com.tools20022.repository.area.sese.SecuritiesTransactionCancellationRequestV04.AccountOwnerTransactionIdentification);
