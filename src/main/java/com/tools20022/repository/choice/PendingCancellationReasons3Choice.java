...
@XmlType(name = "PendingCancellationReasons3Choice", propOrder = {"code", "proprietary"})
public class PendingCancellationReasons3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReasons3Choice.mmCode, com.tools20022.repository.choice.PendingCancellationReasons3Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationReasons3Choice";
	...
	public PendingCancellationReasons3Choice setCode(PendingReason7Code code) {
	...
	public PendingCancellationReasons3Choice setProprietary(GenericIdentification25 proprietary) {
