...
@XmlType(name = "InformationTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class InformationTypeFormat1Choice {
	...
	public static final MMMessageAttribute<InformationTypeFormat1Choice, CorporateActionInformationType1Code> mmCode = new MMMessageAttribute<InformationTypeFormat1Choice, CorporateActionInformationType1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InformationTypeFormat4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<InformationTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<InformationTypeFormat1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InformationTypeFormat4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InformationTypeFormat1Choice.mmCode, com.tools20022.repository.choice.InformationTypeFormat1Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InformationTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the information type format required.";
				nextVersions_lazy = () -> Arrays.asList(InformationTypeFormat4Choice.mmObject());
			}
		});
	...
	public InformationTypeFormat1Choice setCode(CorporateActionInformationType1Code code) {
	...
	public InformationTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
