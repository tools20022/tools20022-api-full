...
public class ProcessingStatus11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus11Choice.mmAcknowledgedAccepted, ProcessingStatus11Choice.mmRejected, ProcessingStatus11Choice.mmCompleted, ProcessingStatus11Choice.mmDenied,
						ProcessingStatus11Choice.mmProprietary, ProcessingStatus11Choice.mmPending);
