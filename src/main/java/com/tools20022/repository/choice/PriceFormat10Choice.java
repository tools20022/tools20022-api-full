 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat10Choice#NotSpecifiedPrice
 * PriceFormat10Choice.NotSpecifiedPrice}</li>
 * <li>
...
public class PriceFormat10Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat10Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat10Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat10Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat10Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat10Choice.AmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat10Choice.AmountPricePerAmount);
