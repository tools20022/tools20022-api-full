...
public class PriceFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat10Choice.mmPercentagePrice, PriceFormat10Choice.mmAmountPrice, PriceFormat10Choice.mmNotSpecifiedPrice, PriceFormat10Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat10Choice.mmAmountPricePerAmount);
