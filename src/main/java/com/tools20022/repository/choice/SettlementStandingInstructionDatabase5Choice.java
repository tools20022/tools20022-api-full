...
public class SettlementStandingInstructionDatabase5Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementStandingInstructionDatabase5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementStandingInstructionDatabase5Choice.mmCode, SettlementStandingInstructionDatabase5Choice.mmProprietary);
