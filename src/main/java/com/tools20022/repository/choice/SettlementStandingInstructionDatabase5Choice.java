...
@XmlType(name = "SettlementStandingInstructionDatabase5Choice", propOrder = {"code", "proprietary"})
public class SettlementStandingInstructionDatabase5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementStandingInstructionDatabase5Choice.mmCode, com.tools20022.repository.choice.SettlementStandingInstructionDatabase5Choice.mmProprietary);
				trace_lazy = () -> StandingSettlementInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementStandingInstructionDatabase5Choice";
	...
	public SettlementStandingInstructionDatabase5Choice setCode(SettlementStandingInstructionDatabase1Code code) {
	...
	public SettlementStandingInstructionDatabase5Choice setProprietary(GenericIdentification47 proprietary) {
