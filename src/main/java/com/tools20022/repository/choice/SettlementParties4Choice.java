...
public class SettlementParties4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementParties4Choice.DeliveringSettlementParties, com.tools20022.repository.choice.SettlementParties4Choice.ReceivingSettlementParties);
