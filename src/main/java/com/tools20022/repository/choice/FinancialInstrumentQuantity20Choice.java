...
public class FinancialInstrumentQuantity20Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity20Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity20Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity20Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity20Choice.Code);
