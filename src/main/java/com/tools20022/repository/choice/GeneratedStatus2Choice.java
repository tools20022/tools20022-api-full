...
public class GeneratedStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GeneratedStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GeneratedStatus2Choice.mmNoSpecifiedReason, GeneratedStatus2Choice.mmReason);
	...
	public void setReason(List<GeneratedReason2> reason) {
		this.reason = reason;
	}
}