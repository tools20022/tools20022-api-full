 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatementType3Choice#Code
 * StatementType3Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementType3Choice#Proprietary
 * StatementType3Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementType3Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> StatementType3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementType3Choice.Code, com.tools20022.repository.choice.StatementType3Choice.Proprietary);
