...
@XmlType(name = "IdentificationType4Choice", propOrder = {"code", "proprietary"})
public class IdentificationType4Choice {
	...
	public static final MMMessageAttribute<IdentificationType4Choice, TypeOfIdentification1Code> mmCode = new MMMessageAttribute<IdentificationType4Choice, TypeOfIdentification1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IdentificationType42Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<IdentificationType4Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<IdentificationType4Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(IdentificationType42Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.IdentificationType4Choice.mmCode, com.tools20022.repository.choice.IdentificationType4Choice.mmProprietary);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "IdentificationType4Choice";
				definition = "Choice between a code and a data source scheme to specify the type of alternate identification.";
				nextVersions_lazy = () -> Arrays.asList(IdentificationType42Choice.mmObject());
			}
		});
	...
	public IdentificationType4Choice setCode(TypeOfIdentification1Code code) {
	...
	public IdentificationType4Choice setProprietary(GenericIdentification20 proprietary) {
