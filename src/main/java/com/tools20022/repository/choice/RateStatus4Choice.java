 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateStatus4Choice#Code
 * RateStatus4Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateStatus4Choice#Proprietary
 * RateStatus4Choice.Proprietary}</li>
 * </ul>
 * </li>
...
public class RateStatus4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateStatus4Choice.Code, com.tools20022.repository.choice.RateStatus4Choice.Proprietary);
