...
public class FinancialInstrumentQuantity2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity2Choice.mmUnit, FinancialInstrumentQuantity2Choice.mmFaceAmount, FinancialInstrumentQuantity2Choice.mmAmortisedValue,
						FinancialInstrumentQuantity2Choice.mmCode);
