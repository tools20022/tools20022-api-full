...
public class ProcessingStatus6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus6Choice.mmAcknowledgedAccepted, ProcessingStatus6Choice.mmPendingProcessing, ProcessingStatus6Choice.mmRepair, ProcessingStatus6Choice.mmPendingCancellation,
						ProcessingStatus6Choice.mmProprietary, ProcessingStatus6Choice.mmCancellationRequested);
