...
public class RejectionAndRepairReason8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionAndRepairReason8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionAndRepairReason8Choice.mmCode, RejectionAndRepairReason8Choice.mmProprietary);
	...
	public void setCode(RejectionReason22Code code) {
		this.code = code;
	}
