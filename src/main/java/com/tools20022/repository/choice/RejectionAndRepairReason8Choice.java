...
import com.tools20022.repository.codeset.RejectionReason22Code;
...
@XmlType(name = "RejectionAndRepairReason8Choice", propOrder = {"code", "proprietary"})
public class RejectionAndRepairReason8Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionReason22Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionAndRepairReason8Choice.mmCode, com.tools20022.repository.choice.RejectionAndRepairReason8Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionAndRepairReason8Choice";
	...
	public RejectionReason22Code getCode() {
		return code;
	}

	public RejectionAndRepairReason8Choice setCode(RejectionReason22Code code) {
	...
	public RejectionAndRepairReason8Choice setProprietary(GenericIdentification25 proprietary) {
