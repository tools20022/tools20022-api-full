 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlingCapacity1Choice#Code
 * SettlingCapacity1Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlingCapacity1Choice#Proprietary
 * SettlingCapacity1Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlingCapacity1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> SettlingCapacity1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Settlement capacity expressed as an ISO 20022 code.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity4Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity4Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity1Choice.Code, com.tools20022.repository.choice.SettlingCapacity1Choice.Proprietary);
