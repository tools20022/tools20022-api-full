...
public class SettlingCapacity1Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlingCapacity4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(SettlingCapacity1Code code) {
		this.code = code;
	}
