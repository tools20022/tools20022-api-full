...
public class PendingStatus34Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus34Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NoSpecifiedReason";
			definition = "Reason not specified.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus42Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingStatus32Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingStatus42Choice.mmReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingStatus32Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	public void setReason(List<PendingStatusReason7> reason) {
		this.reason = reason;
	}
}