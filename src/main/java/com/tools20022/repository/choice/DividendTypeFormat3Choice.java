...
import com.tools20022.repository.codeset.CorporateActionFrequencyType2Code;
...
@XmlType(name = "DividendTypeFormat3Choice", propOrder = {"code", "proprietary"})
public class DividendTypeFormat3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected CorporateActionFrequencyType2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<DividendTypeFormat3Choice, CorporateActionFrequencyType2Code> mmCode = new MMMessageAttribute<DividendTypeFormat3Choice, CorporateActionFrequencyType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DividendTypeFormat5Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<DividendTypeFormat3Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<DividendTypeFormat3Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DividendTypeFormat5Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DividendTypeFormat3Choice.mmCode, com.tools20022.repository.choice.DividendTypeFormat3Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DividendTypeFormat3Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of dividend.";
				nextVersions_lazy = () -> Arrays.asList(DividendTypeFormat5Choice.mmObject());
			}
		});
		return mmObject_lazy.get();
	}

	public CorporateActionFrequencyType2Code getCode() {
		return code;
	}

	public DividendTypeFormat3Choice setCode(CorporateActionFrequencyType2Code code) {
	...
	public DividendTypeFormat3Choice setProprietary(GenericIdentification20 proprietary) {
