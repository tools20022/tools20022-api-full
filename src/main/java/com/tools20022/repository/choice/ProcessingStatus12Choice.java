...
public class ProcessingStatus12Choice {
	...
	public static final MMMessageAssociationEnd mmAcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus12Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus12Choice.mmAcknowledgedAccepted, ProcessingStatus12Choice.mmPendingProcessing, ProcessingStatus12Choice.mmRepair, ProcessingStatus12Choice.mmPendingCancellation,
						ProcessingStatus12Choice.mmProprietary, ProcessingStatus12Choice.mmCancellationRequested);
