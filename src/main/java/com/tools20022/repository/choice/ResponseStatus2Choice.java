...
@XmlType(name = "ResponseStatus2Choice", propOrder = {"code", "proprietary"})
public class ResponseStatus2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ResponseStatus2Choice, ResponseStatus1Code> mmCode = new MMMessageAttribute<ResponseStatus2Choice, ResponseStatus1Code>() {
		{
			businessElementTrace_lazy = () -> CollateralStatus.mmResponseStatus;
			componentContext_lazy = () -> com.tools20022.repository.choice.ResponseStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ResponseStatus1Code getValue(ResponseStatus2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ResponseStatus2Choice obj, ResponseStatus1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ResponseStatus2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ResponseStatus2Choice, GenericIdentification25>() {
		{
		...
		@Override
		public GenericIdentification25 getValue(ResponseStatus2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ResponseStatus2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ResponseStatus2Choice.mmCode, com.tools20022.repository.choice.ResponseStatus2Choice.mmProprietary);
				trace_lazy = () -> Status.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ResponseStatus2Choice";
	...
	public ResponseStatus2Choice setCode(ResponseStatus1Code code) {
	...
	public ResponseStatus2Choice setProprietary(GenericIdentification25 proprietary) {
