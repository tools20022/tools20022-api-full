...
@XmlType(name = "FXStandingInstruction5Choice", propOrder = {"indicator", "proprietary"})
public class FXStandingInstruction5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FXStandingInstruction5Choice.mmIndicator, com.tools20022.repository.choice.FXStandingInstruction5Choice.mmProprietary);
	...
	public FXStandingInstruction5Choice setIndicator(YesNoIndicator indicator) {
	...
	public FXStandingInstruction5Choice setProprietary(GenericIdentification47 proprietary) {
