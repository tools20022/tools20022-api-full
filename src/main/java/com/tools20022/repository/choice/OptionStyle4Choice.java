 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionStyle4Choice#mmCode
...
@XmlType(name = "OptionStyle4Choice", propOrder = {"code", "proprietary"})
public class OptionStyle4Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionStyle4Choice, OptionStyle2Code> mmCode = new MMMessageAttribute<OptionStyle4Choice, OptionStyle2Code>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionStyle;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionStyle4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(OptionStyle8Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OptionStyle2Code getValue(OptionStyle4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionStyle4Choice obj, OptionStyle2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionStyle4Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<OptionStyle4Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Option.mmOptionStyle;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionStyle4Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OptionStyle8Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(OptionStyle4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionStyle4Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle4Choice.mmCode, com.tools20022.repository.choice.OptionStyle4Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionStyle4Choice";
				definition = "Choice of format for the option style.";
				nextVersions_lazy = () -> Arrays.asList(OptionStyle8Choice.mmObject());
			}
		});
	...
	public OptionStyle4Choice setCode(OptionStyle2Code code) {
	...
	public OptionStyle4Choice setProprietary(GenericIdentification20 proprietary) {
