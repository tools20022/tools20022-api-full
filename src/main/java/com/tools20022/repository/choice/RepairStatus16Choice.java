...
public class RepairStatus16Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairStatus16Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairStatus16Choice.mmNoSpecifiedReason, RepairStatus16Choice.mmReason);
	...
	public void setReason(List<RepairReason12> reason) {
		this.reason = reason;
	}
}