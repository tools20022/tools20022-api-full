 ...
 * <li>{@linkplain com.tools20022.repository.choice.RepairStatus16Choice#Reason
...
public class RepairStatus16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RepairStatus16Choice.NoSpecifiedReason, com.tools20022.repository.choice.RepairStatus16Choice.Reason);
