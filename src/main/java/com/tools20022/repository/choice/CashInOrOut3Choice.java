...
public class CashInOrOut3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashInOrOut3Choice.mmCashInPaymentInstrument, CashInOrOut3Choice.mmCashOutPaymentInstrument);
	...
	public void setCashInPaymentInstrument(com.tools20022.repository.choice.PaymentInstrument6Choice cashInPaymentInstrument) {
