...
public class InstructionProcessingStatus25Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus25Choice.mmCancelled, InstructionProcessingStatus25Choice.mmAcceptedForFurtherProcessing, InstructionProcessingStatus25Choice.mmRejected,
						InstructionProcessingStatus25Choice.mmPending, InstructionProcessingStatus25Choice.mmDefaultAction, InstructionProcessingStatus25Choice.mmStandingInstruction, InstructionProcessingStatus25Choice.mmProprietaryStatus);
