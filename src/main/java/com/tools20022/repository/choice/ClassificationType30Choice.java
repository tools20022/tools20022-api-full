	...
	public static final MMMessageAttribute mmClassificationFinancialInstrument = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClassificationType32Choice.mmClassificationFinancialInstrument);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmAlternateClassification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClassificationType32Choice.mmAlternateClassification);
			maxOccurs = 1;
			minOccurs = 1;
