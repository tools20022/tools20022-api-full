...
public class ClassificationType30Choice {
	...
	public static final MMMessageAttribute ClassificationFinancialInstrument = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClassificationType32Choice.ClassificationFinancialInstrument);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute AlternateClassification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClassificationType32Choice.AlternateClassification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClassificationType30Choice.ClassificationFinancialInstrument, com.tools20022.repository.choice.ClassificationType30Choice.AlternateClassification);
