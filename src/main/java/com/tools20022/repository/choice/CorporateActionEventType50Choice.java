...
public class CorporateActionEventType50Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType50Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType50Choice.mmCode, CorporateActionEventType50Choice.mmProprietary);
