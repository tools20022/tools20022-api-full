...
@XmlType(name = "ElectionTypeFormat4Choice", propOrder = {"code", "proprietary"})
public class ElectionTypeFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ElectionTypeFormat4Choice.mmCode, com.tools20022.repository.choice.ElectionTypeFormat4Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ElectionTypeFormat4Choice";
	...
	public ElectionTypeFormat4Choice setCode(ElectionMovementType2Code code) {
	...
	public ElectionTypeFormat4Choice setProprietary(GenericIdentification47 proprietary) {
