...
@XmlType(name = "RateType73Choice", propOrder = {"code", "proprietary"})
public class RateType73Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RateType73Choice
	 * RateType73Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType73Choice.mmCode, com.tools20022.repository.choice.RateType73Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType73Choice";
	...
	public RateType73Choice setCode(NetDividendRateType4Code code) {
	...
	public RateType73Choice setProprietary(GenericIdentification47 proprietary) {
