...
@XmlType(name = "LotteryTypeFormat1Choice", propOrder = {"code", "proprietary"})
public class LotteryTypeFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<LotteryTypeFormat1Choice, LotteryType1Code> mmCode = new MMMessageAttribute<LotteryTypeFormat1Choice, LotteryType1Code>() {
		{
			businessElementTrace_lazy = () -> Lottery.mmLotteryType;
			componentContext_lazy = () -> com.tools20022.repository.choice.LotteryTypeFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the type of lottery announced.";
			nextVersions_lazy = () -> Arrays.asList(LotteryTypeFormat4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public LotteryType1Code getValue(LotteryTypeFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(LotteryTypeFormat1Choice obj, LotteryType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<LotteryTypeFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<LotteryTypeFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> Lottery.mmLotteryType;
			componentContext_lazy = () -> com.tools20022.repository.choice.LotteryTypeFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(LotteryTypeFormat4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(LotteryTypeFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(LotteryTypeFormat1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LotteryTypeFormat1Choice.mmCode, com.tools20022.repository.choice.LotteryTypeFormat1Choice.mmProprietary);
				trace_lazy = () -> Lottery.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "LotteryTypeFormat1Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of lottery.";
				nextVersions_lazy = () -> Arrays.asList(LotteryTypeFormat4Choice.mmObject());
			}
		});
	...
	public LotteryTypeFormat1Choice setCode(LotteryType1Code code) {
	...
	public LotteryTypeFormat1Choice setProprietary(GenericIdentification20 proprietary) {
