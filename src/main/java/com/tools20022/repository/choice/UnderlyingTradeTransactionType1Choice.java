...
public class UnderlyingTradeTransactionType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnderlyingTradeTransactionType1Choice.mmCode, UnderlyingTradeTransactionType1Choice.mmProprietary);
	...
	public void setCode(ExternalUnderlyingTradeTransactionType1Code code) {
		this.code = code;
	}
