...
public class RejectionReason14Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionReason14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason27Choice.mmCode);
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionReason10Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionReason27Choice.mmProprietary);
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectionReason10Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(RejectionReason37Code code) {
		this.code = code;
	}
