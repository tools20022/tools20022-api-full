...
public class ProcessingStatus7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus7Choice.mmAcknowledgedAccepted, ProcessingStatus7Choice.mmPendingProcessing, ProcessingStatus7Choice.mmRejected, ProcessingStatus7Choice.mmRepair,
						ProcessingStatus7Choice.mmCancelled, ProcessingStatus7Choice.mmPendingCancellation, ProcessingStatus7Choice.mmProprietary, ProcessingStatus7Choice.mmCancellationRequested,
						ProcessingStatus7Choice.mmModificationRequested);
