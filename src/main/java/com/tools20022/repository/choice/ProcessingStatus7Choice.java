...
public class ProcessingStatus7Choice {
	...
	public static final MMMessageAssociationEnd mmAcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "AckdAccptd";
	...
	public void setRejected(com.tools20022.repository.choice.RejectionStatus2Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RepairStatus2Choice repair) {
		this.repair = repair;
	}
