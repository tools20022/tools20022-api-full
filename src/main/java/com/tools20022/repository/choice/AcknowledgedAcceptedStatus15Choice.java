...
public class AcknowledgedAcceptedStatus15Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AcknowledgedAcceptedStatus15Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus15Choice.NoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus15Choice.Reason);
