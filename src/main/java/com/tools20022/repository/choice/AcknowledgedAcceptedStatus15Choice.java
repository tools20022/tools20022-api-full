...
public class AcknowledgedAcceptedStatus15Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus15Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus15Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason8> reason) {
		this.reason = reason;
	}
}