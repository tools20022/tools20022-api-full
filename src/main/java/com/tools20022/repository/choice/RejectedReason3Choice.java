...
@XmlType(name = "RejectedReason3Choice", propOrder = {"code", "proprietary"})
public class RejectedReason3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedReason3Choice, RejectedStatusReason6Code> mmCode = new MMMessageAttribute<RejectedReason3Choice, RejectedStatusReason6Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectedStatusReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectedReason3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Rejected reason expressed as a code.";
			nextVersions_lazy = () -> Arrays.asList(RejectedReason4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RejectedStatusReason6Code getValue(RejectedReason3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectedReason3Choice obj, RejectedStatusReason6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectedReason3Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<RejectedReason3Choice, GenericIdentification47>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectedStatusReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectedReason3Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(RejectedReason4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification47 getValue(RejectedReason3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RejectedReason3Choice obj, GenericIdentification47 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedReason3Choice.mmCode, com.tools20022.repository.choice.RejectedReason3Choice.mmProprietary);
				trace_lazy = () -> StatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedReason3Choice";
				definition = "Choice of formats for the specification of the rejected reason.";
				nextVersions_lazy = () -> Arrays.asList(RejectedReason4Choice.mmObject());
			}
		});
	...
	public RejectedReason3Choice setCode(RejectedStatusReason6Code code) {
	...
	public RejectedReason3Choice setProprietary(GenericIdentification47 proprietary) {
