 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatementBasis9Choice#Code
 * StatementBasis9Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementBasis9Choice#Proprietary
 * StatementBasis9Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementBasis9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementBasis9Choice.Code, com.tools20022.repository.choice.StatementBasis9Choice.Proprietary);
