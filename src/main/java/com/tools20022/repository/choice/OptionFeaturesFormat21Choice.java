...
public class OptionFeaturesFormat21Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OptionFeaturesFormat21Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OptionFeaturesFormat21Choice.mmCode, OptionFeaturesFormat21Choice.mmProprietary);
