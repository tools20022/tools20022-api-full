...
public class ProcessingStatus16Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus16Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionOrRepairStatus13Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus16Choice.mmPendingCancellation, ProcessingStatus16Choice.mmRejected, ProcessingStatus16Choice.mmRepair, ProcessingStatus16Choice.mmAcknowledgedAccepted,
						ProcessingStatus16Choice.mmProprietary, ProcessingStatus16Choice.mmDenied, ProcessingStatus16Choice.mmCancelled);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus13Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RejectionOrRepairStatus13Choice repair) {
		this.repair = repair;
	}
