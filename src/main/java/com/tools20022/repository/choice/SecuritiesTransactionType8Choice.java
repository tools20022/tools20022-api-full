...
public class SecuritiesTransactionType8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecuritiesTransactionType8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTransactionType8Choice.mmCode, SecuritiesTransactionType8Choice.mmProprietary);
	...
	public void setCode(SecuritiesTransactionType6Code code) {
		this.code = code;
	}
