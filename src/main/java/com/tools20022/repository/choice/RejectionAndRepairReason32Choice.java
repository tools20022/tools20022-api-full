...
@XmlType(name = "RejectionAndRepairReason32Choice", propOrder = {"code", "proprietary"})
public class RejectionAndRepairReason32Choice {
	...
	public static final MMMessageAttribute<RejectionAndRepairReason32Choice, RejectionReason33Code> mmCode = new MMMessageAttribute<RejectionAndRepairReason32Choice, RejectionReason33Code>() {
		{
			...
			previousVersion_lazy = () -> RejectionAndRepairReason20Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<RejectionAndRepairReason32Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<RejectionAndRepairReason32Choice, GenericIdentification30>() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			previousVersion_lazy = () -> RejectionAndRepairReason20Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionAndRepairReason32Choice.mmCode, com.tools20022.repository.choice.RejectionAndRepairReason32Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "RejectionAndRepairReason32Choice";
				definition = "Choice of format for the rejection or repair reason.";
				previousVersion_lazy = () -> RejectionAndRepairReason20Choice.mmObject();
			}
		});
	...
	public RejectionAndRepairReason32Choice setCode(RejectionReason33Code code) {
	...
	public RejectionAndRepairReason32Choice setProprietary(GenericIdentification30 proprietary) {
