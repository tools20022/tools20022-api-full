...
public class SettlementTransactionCondition16Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition12Choice.Code;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition20Choice.Code, com.tools20022.repository.choice.SettlementTransactionCondition30Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition12Choice.Proprietary;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition20Choice.Proprietary, com.tools20022.repository.choice.SettlementTransactionCondition30Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition16Choice.Code, com.tools20022.repository.choice.SettlementTransactionCondition16Choice.Proprietary);
				...
				previousVersion_lazy = () -> SettlementTransactionCondition12Choice.mmObject();
