...
public class References11Choice {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References11Choice.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References11Choice.mmAccountOwnerTransactionIdentification, References11Choice.mmAccountServicerTransactionIdentification, References11Choice.mmPoolIdentification,
						References11Choice.mmMarketInfrastructureTransactionIdentification);
