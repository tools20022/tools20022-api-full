...
public class References11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.References11Choice.AccountOwnerTransactionIdentification,
						com.tools20022.repository.choice.References11Choice.AccountServicerTransactionIdentification, com.tools20022.repository.choice.References11Choice.PoolIdentification,
						com.tools20022.repository.choice.References11Choice.MarketInfrastructureTransactionIdentification);
