 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettlementDate3Choice#Date
...
public class SettlementDate3Choice {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.SettlementDate11Choice#Date
	...
	public static final MMMessageAttribute Date = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate11Choice.Date);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute DateCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate11Choice.DateCode);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementDate3Choice.Date, com.tools20022.repository.choice.SettlementDate3Choice.DateCode);
