...
public class FinancialInstrumentQuantity14Choice {
	...
	public static final MMMessageAttribute Unit = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> FinancialInstrumentQuantity14Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity14Choice.Unit, com.tools20022.repository.choice.FinancialInstrumentQuantity14Choice.FaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity14Choice.AmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity14Choice.Code);
