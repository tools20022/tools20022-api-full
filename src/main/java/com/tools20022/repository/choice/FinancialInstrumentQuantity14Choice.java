...
public class FinancialInstrumentQuantity14Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity14Choice.mmUnit, FinancialInstrumentQuantity14Choice.mmFaceAmount, FinancialInstrumentQuantity14Choice.mmAmortisedValue,
						FinancialInstrumentQuantity14Choice.mmCode);
	...
	public void setCode(Quantity2Code code) {
		this.code = code;
	}
}