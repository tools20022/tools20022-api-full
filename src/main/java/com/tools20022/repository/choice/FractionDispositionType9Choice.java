...
public class FractionDispositionType9Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FractionDispositionType9Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FractionDispositionType9Choice.mmCode, FractionDispositionType9Choice.mmProprietary);
	...
	public void setCode(FractionDispositionType5Code code) {
		this.code = code;
	}
