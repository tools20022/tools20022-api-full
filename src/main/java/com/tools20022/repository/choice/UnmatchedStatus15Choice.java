...
public class UnmatchedStatus15Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus15Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus15Choice.mmNoSpecifiedReason, UnmatchedStatus15Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason14> reason) {
		this.reason = reason;
	}
}