...
public class InvestorCapacity4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> InvestorCapacity4Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.InvestorCapacity1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.InvestorCapacity1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorCapacity4Choice.Code, com.tools20022.repository.choice.InvestorCapacity4Choice.Proprietary);
				...
				previousVersion_lazy = () -> InvestorCapacity1Choice.mmObject();
			}
		});
