...
import com.tools20022.repository.msg.AcknowledgementReason2;
...
@XmlType(name = "AcknowledgedAcceptedStatus2Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcknowledgedAcceptedStatus2Choice {
	...
	@XmlElement(name = "Rsn")
	protected List<AcknowledgementReason2> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.AcknowledgementReason2
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus2Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus2Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgedAcceptedStatus2Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus10Choice.mmObject());
			}
		});
	...
	public AcknowledgedAcceptedStatus2Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<AcknowledgementReason2> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public AcknowledgedAcceptedStatus2Choice setReason(List<AcknowledgementReason2> reason) {
