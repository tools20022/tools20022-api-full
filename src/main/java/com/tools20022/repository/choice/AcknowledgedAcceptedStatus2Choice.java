...
public class AcknowledgedAcceptedStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus2Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus2Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason2> reason) {
		this.reason = reason;
	}
}