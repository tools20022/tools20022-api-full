 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat24Choice#mmNotSpecifiedPrice
 * PriceFormat24Choice.mmNotSpecifiedPrice}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forPriceFormat24Choice
 * ConstraintCoexistenceQuantityRule.forPriceFormat24Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat24Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat24Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat24Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount"})
public class PriceFormat24Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat24Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat24Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat24Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat24Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat24Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat24Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat24Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat24Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat24Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat24Choice, PriceValueType9Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat24Choice, PriceValueType9Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat24Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType9Code getValue(PriceFormat24Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat24Choice obj, PriceValueType9Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat24Choice, AmountPricePerFinancialInstrumentQuantity4> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat24Choice, AmountPricePerFinancialInstrumentQuantity4>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity4 getValue(PriceFormat24Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat24Choice obj, AmountPricePerFinancialInstrumentQuantity4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat24Choice, AmountPricePerAmount3> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat24Choice, AmountPricePerAmount3>() {
		{
		...
		@Override
		public AmountPricePerAmount3 getValue(PriceFormat24Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat24Choice obj, AmountPricePerAmount3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat24Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat24Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat24Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat24Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat24Choice.mmAmountPricePerAmount);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat24Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat24Choice);
	...
	public PriceFormat24Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat24Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat24Choice setNotSpecifiedPrice(PriceValueType9Code notSpecifiedPrice) {
	...
	public PriceFormat24Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity4 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat24Choice setAmountPricePerAmount(AmountPricePerAmount3 amountPricePerAmount) {
