...
public class PriceFormat24Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat24Choice.mmPercentagePrice, PriceFormat24Choice.mmAmountPrice, PriceFormat24Choice.mmNotSpecifiedPrice, PriceFormat24Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat24Choice.mmAmountPricePerAmount);
