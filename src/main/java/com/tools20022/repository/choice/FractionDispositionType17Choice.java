...
@XmlType(name = "FractionDispositionType17Choice", propOrder = {"code", "proprietary"})
public class FractionDispositionType17Choice {
	...
	public static final MMMessageAttribute<FractionDispositionType17Choice, FractionDispositionType10Code> mmCode = new MMMessageAttribute<FractionDispositionType17Choice, FractionDispositionType10Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FractionDispositionType28Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<FractionDispositionType17Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<FractionDispositionType17Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FractionDispositionType28Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType17Choice.mmCode, com.tools20022.repository.choice.FractionDispositionType17Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FractionDispositionType17Choice";
				definition = "Choice between a standard code or a proprietary code to specify the type of fraction disposition.";
				nextVersions_lazy = () -> Arrays.asList(FractionDispositionType28Choice.mmObject());
				previousVersion_lazy = () -> FractionDispositionType10Choice.mmObject();
			}
		});
	...
	public FractionDispositionType17Choice setCode(FractionDispositionType10Code code) {
	...
	public FractionDispositionType17Choice setProprietary(GenericIdentification20 proprietary) {
