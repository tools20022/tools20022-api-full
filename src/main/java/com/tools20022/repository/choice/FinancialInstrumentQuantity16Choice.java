...
public class FinancialInstrumentQuantity16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity16Choice.mmUnit, FinancialInstrumentQuantity16Choice.mmFaceAmount, FinancialInstrumentQuantity16Choice.mmAmortisedValue,
						FinancialInstrumentQuantity16Choice.mmCode);
