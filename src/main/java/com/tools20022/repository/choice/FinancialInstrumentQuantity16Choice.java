...
@XmlType(name = "FinancialInstrumentQuantity16Choice", propOrder = {"unit", "faceAmount", "amortisedValue", "code"})
public class FinancialInstrumentQuantity16Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentQuantity16Choice, DecimalNumber> mmUnit = new MMMessageAttribute<FinancialInstrumentQuantity16Choice, DecimalNumber>() {
		{
			businessElementTrace_lazy = () -> SecuritiesQuantity.mmUnit;
			componentContext_lazy = () -> com.tools20022.repository.choice.FinancialInstrumentQuantity16Choice.mmObject();
			isDerived = false;
			xmlTag = "Unit";
		...
		@Override
		public DecimalNumber getValue(FinancialInstrumentQuantity16Choice obj) {
			return obj.getUnit();
		}

		@Override
		public void setValue(FinancialInstrumentQuantity16Choice obj, DecimalNumber value) {
			obj.setUnit(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentQuantity16Choice, ImpliedCurrencyAndAmount> mmFaceAmount = new MMMessageAttribute<FinancialInstrumentQuantity16Choice, ImpliedCurrencyAndAmount>() {
		{
		...
		@Override
		public ImpliedCurrencyAndAmount getValue(FinancialInstrumentQuantity16Choice obj) {
			return obj.getFaceAmount();
		}

		@Override
		public void setValue(FinancialInstrumentQuantity16Choice obj, ImpliedCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentQuantity16Choice, ImpliedCurrencyAndAmount> mmAmortisedValue = new MMMessageAttribute<FinancialInstrumentQuantity16Choice, ImpliedCurrencyAndAmount>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FinancialInstrumentQuantity16Choice, Quantity3Code> mmCode = new MMMessageAttribute<FinancialInstrumentQuantity16Choice, Quantity3Code>() {
		{
		...
		@Override
		public Quantity3Code getValue(FinancialInstrumentQuantity16Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(FinancialInstrumentQuantity16Choice obj, Quantity3Code value) {
			obj.setCode(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FinancialInstrumentQuantity16Choice.mmUnit, com.tools20022.repository.choice.FinancialInstrumentQuantity16Choice.mmFaceAmount,
						com.tools20022.repository.choice.FinancialInstrumentQuantity16Choice.mmAmortisedValue, com.tools20022.repository.choice.FinancialInstrumentQuantity16Choice.mmCode);
				trace_lazy = () -> SecuritiesQuantity.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FinancialInstrumentQuantity16Choice";
				definition = "Choice between formats for the quantity of security.";
				nextVersions_lazy = () -> Arrays.asList(FinancialInstrumentQuantity19Choice.mmObject(), FinancialInstrumentQuantity20Choice.mmObject());
			}
		});
	...
	public FinancialInstrumentQuantity16Choice setUnit(DecimalNumber unit) {
	...
	public FinancialInstrumentQuantity16Choice setFaceAmount(ImpliedCurrencyAndAmount faceAmount) {
	...
	public FinancialInstrumentQuantity16Choice setAmortisedValue(ImpliedCurrencyAndAmount amortisedValue) {
	...
	public FinancialInstrumentQuantity16Choice setCode(Quantity3Code code) {
