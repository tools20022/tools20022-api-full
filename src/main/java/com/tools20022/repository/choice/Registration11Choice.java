 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Registration11Choice#mmCode
...
@XmlType(name = "Registration11Choice", propOrder = {"code", "proprietary"})
public class Registration11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Registration11Choice.mmCode, com.tools20022.repository.choice.Registration11Choice.mmProprietary);
				trace_lazy = () -> BasicSecuritiesRegistration.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Registration11Choice";
	...
	public Registration11Choice setCode(Registration1Code code) {
	...
	public Registration11Choice setProprietary(GenericIdentification47 proprietary) {
