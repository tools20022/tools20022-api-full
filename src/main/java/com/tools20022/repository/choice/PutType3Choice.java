 ...
 * previousVersion} =
 * {@linkplain com.tools20022.repository.choice.PutType2Choice PutType2Choice}</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PutType3Choice", propOrder = {"code", "proprietary"})
public class PutType3Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.PutType2Choice#mmCode
	...
	public static final MMMessageAttribute<PutType3Choice, PutType1Code> mmCode = new MMMessageAttribute<PutType3Choice, PutType1Code>() {
		{
			...
			previousVersion_lazy = () -> PutType2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<PutType3Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<PutType3Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> PutType2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PutType3Choice.mmCode, com.tools20022.repository.choice.PutType3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "PutType3Choice";
				definition = "Choice of format for put type.";
				previousVersion_lazy = () -> PutType2Choice.mmObject();
			}
		});
	...
	public PutType3Choice setCode(PutType1Code code) {
	...
	public PutType3Choice setProprietary(GenericIdentification30 proprietary) {
