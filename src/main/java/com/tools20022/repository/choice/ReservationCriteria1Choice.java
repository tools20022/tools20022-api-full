 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ReservationCriteria1Choice#QueryName
 * ReservationCriteria1Choice.QueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.ReservationCriteria1Choice#NewCriteria
 * ReservationCriteria1Choice.NewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
public class ReservationCriteria1Choice {
	...
	public static final MMMessageAttribute QueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ReservationCriteria1Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ReservationCriteria1Choice.QueryName, com.tools20022.repository.choice.ReservationCriteria1Choice.NewCriteria);
