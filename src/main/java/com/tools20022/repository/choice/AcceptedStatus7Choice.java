...
public class AcceptedStatus7Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcceptedStatus7Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NoSpecifiedReason";
			definition = "Reason not specified.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcceptedStatus4Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcceptedStatus4Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	public void setReason(List<AcceptedStatusReason8> reason) {
		this.reason = reason;
	}
}