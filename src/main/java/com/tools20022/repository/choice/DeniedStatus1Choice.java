 ...
 * <li>{@linkplain com.tools20022.repository.choice.DeniedStatus1Choice#Reason
...
public class DeniedStatus1Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> DeniedStatus1Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus1Choice.NoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus1Choice.Reason);
