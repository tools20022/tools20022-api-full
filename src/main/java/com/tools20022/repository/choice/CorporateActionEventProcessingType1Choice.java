...
public class CorporateActionEventProcessingType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventProcessingType1Choice.Code, com.tools20022.repository.choice.CorporateActionEventProcessingType1Choice.Proprietary);
