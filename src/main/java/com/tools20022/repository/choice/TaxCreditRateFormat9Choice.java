 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.TaxCreditRateFormat9Choice#mmRateTypeAndAmountAndRateStatus
 * TaxCreditRateFormat9Choice.mmRateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
@XmlType(name = "TaxCreditRateFormat9Choice", propOrder = {"rate", "amount", "rateTypeAndAmountAndRateStatus"})
public class TaxCreditRateFormat9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TaxCreditRateFormat9Choice.mmRate, com.tools20022.repository.choice.TaxCreditRateFormat9Choice.mmAmount,
						com.tools20022.repository.choice.TaxCreditRateFormat9Choice.mmRateTypeAndAmountAndRateStatus);
				trace_lazy = () -> RateAndAmount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "TaxCreditRateFormat9Choice";
	...
	public TaxCreditRateFormat9Choice setRate(PercentageRate rate) {
	...
	public TaxCreditRateFormat9Choice setAmount(RestrictedFINActiveCurrencyAnd13DecimalAmount amount) {
	...
	public TaxCreditRateFormat9Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus34 rateTypeAndAmountAndRateStatus) {
