...
public class PartyIdentification88Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification88Choice.BICFI, com.tools20022.repository.choice.PartyIdentification88Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification88Choice.ProprietaryIdentification);
