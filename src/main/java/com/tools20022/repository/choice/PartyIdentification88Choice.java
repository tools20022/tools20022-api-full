...
public class PartyIdentification88Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification88Choice.mmBICFI, PartyIdentification88Choice.mmNameAndAddress, PartyIdentification88Choice.mmProprietaryIdentification);
