...
public class ProcessedStatus5FormatChoice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ProcessedStatus5FormatChoice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessedStatus5FormatChoice.Code, com.tools20022.repository.choice.ProcessedStatus5FormatChoice.Proprietary);
