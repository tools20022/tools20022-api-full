...
import com.tools20022.repository.codeset.UnmatchedReason8Code;
...
@XmlType(name = "UnmatchedReason14Choice", propOrder = {"code", "proprietary"})
public class UnmatchedReason14Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnmatchedReason14Choice, UnmatchedReason8Code> mmCode = new MMMessageAttribute<UnmatchedReason14Choice, UnmatchedReason8Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmUnmatchedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.UnmatchedReason14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason21Choice.mmCode);
			previousVersion_lazy = () -> UnmatchedReason9Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public UnmatchedReason8Code getValue(UnmatchedReason14Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(UnmatchedReason14Choice obj, UnmatchedReason8Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnmatchedReason14Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<UnmatchedReason14Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmUnmatchedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.UnmatchedReason14Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction has an unmatched status.";
			nextVersions_lazy = () -> Arrays.asList(UnmatchedReason21Choice.mmProprietary);
			previousVersion_lazy = () -> UnmatchedReason9Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(UnmatchedReason14Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(UnmatchedReason14Choice obj, GenericIdentification20 value) {
	...
	public UnmatchedReason14Choice setCode(UnmatchedReason8Code code) {
	...
	public UnmatchedReason14Choice setProprietary(GenericIdentification20 proprietary) {
