...
public class OptionStyle8Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.OptionStyle4Choice#Code
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.OptionStyle4Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.OptionStyle4Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle8Choice.Code, com.tools20022.repository.choice.OptionStyle8Choice.Proprietary);
				...
				previousVersion_lazy = () -> OptionStyle4Choice.mmObject();
			}
		});
