...
public class SettlementOrCorporateActionEvent4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent4Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent4Choice.mmCorporateActionEventType);
	...
	public void setSecuritiesTransactionType(com.tools20022.repository.choice.SecuritiesTransactionType6Choice securitiesTransactionType) {
