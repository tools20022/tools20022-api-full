...
@XmlType(name = "SubBalanceQuantity5Choice", propOrder = {"quantity", "proprietary"})
public class SubBalanceQuantity5Choice {
	...
	public SubBalanceQuantity5Choice setProprietary(GenericIdentification56 proprietary) {
