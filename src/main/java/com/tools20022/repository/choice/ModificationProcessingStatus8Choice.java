...
public class ModificationProcessingStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ModificationProcessingStatus8Choice.mmAcknowledgedAccepted, ModificationProcessingStatus8Choice.mmPendingProcessing, ModificationProcessingStatus8Choice.mmDenied,
						ModificationProcessingStatus8Choice.mmRejected, ModificationProcessingStatus8Choice.mmRepaired, ModificationProcessingStatus8Choice.mmModified, ModificationProcessingStatus8Choice.mmProprietary);
