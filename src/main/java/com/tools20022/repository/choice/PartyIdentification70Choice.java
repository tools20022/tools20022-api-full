...
public class PartyIdentification70Choice {
	...
	public static final MMMessageAttribute AnyBIC = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification97Choice.AnyBIC);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ProprietaryIdentification = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification97Choice.ProprietaryIdentification);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NameAndAddress = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification97Choice.NameAndAddress);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification70Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification70Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification70Choice.NameAndAddress);
				trace_lazy = () -> PartyIdentificationInformation.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferInstructionV07.Transferee, com.tools20022.repository.area.sese.AccountHoldingInformationV05.Transferee,
						com.tools20022.repository.area.sese.PortfolioTransferConfirmationV07.Transferee, com.tools20022.repository.area.sese.AccountHoldingInformationRequestV04.Transferee);
