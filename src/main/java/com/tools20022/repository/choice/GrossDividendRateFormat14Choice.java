...
public class GrossDividendRateFormat14Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat14Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat14Choice.mmAmount, GrossDividendRateFormat14Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat14Choice.mmNotSpecifiedRate);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus20 rateTypeAndAmountAndRateStatus) {
