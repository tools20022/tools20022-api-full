...
public class OptionStyle1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle1Choice.Code, com.tools20022.repository.choice.OptionStyle1Choice.Proprietary);
