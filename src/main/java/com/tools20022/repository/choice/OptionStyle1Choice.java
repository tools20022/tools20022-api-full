...
import com.tools20022.repository.codeset.OptionStyle1Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OptionStyle1Choice#mmCode
...
@XmlType(name = "OptionStyle1Choice", propOrder = {"code", "proprietary"})
public class OptionStyle1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected OptionStyle1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.OptionStyle1Choice
	 * OptionStyle1Choice}</li>
	...
	public static final MMMessageAttribute<OptionStyle1Choice, OptionStyle1Code> mmCode = new MMMessageAttribute<OptionStyle1Choice, OptionStyle1Code>() {
		{
			...
			name = "Code";
			definition = "Option style is defined using a code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<OptionStyle1Choice, GenericIdentification13> mmProprietary = new MMMessageAssociationEnd<OptionStyle1Choice, GenericIdentification13>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Option style is defined using a data source scheme.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionStyle1Choice.mmCode, com.tools20022.repository.choice.OptionStyle1Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "OptionStyle1Choice";
				definition = "Choice between a code or a data source scheme to determine the option style.";
			}
		});
		return mmObject_lazy.get();
	}

	public OptionStyle1Code getCode() {
		return code;
	}

	public OptionStyle1Choice setCode(OptionStyle1Code code) {
	...
	public OptionStyle1Choice setProprietary(GenericIdentification13 proprietary) {
