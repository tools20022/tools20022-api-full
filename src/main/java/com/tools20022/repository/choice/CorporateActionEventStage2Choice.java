...
@XmlType(name = "CorporateActionEventStage2Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventStage2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventStage2Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventStage2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionEventStage2Choice";
	...
	public CorporateActionEventStage2Choice setCode(CorporateActionEventStage2Code code) {
	...
	public CorporateActionEventStage2Choice setProprietary(GenericIdentification25 proprietary) {
