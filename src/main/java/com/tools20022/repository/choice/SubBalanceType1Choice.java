...
public class SubBalanceType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SubBalanceType1Choice.SubBalanceType, com.tools20022.repository.choice.SubBalanceType1Choice.Proprietary);
