...
public class TaxableIncomePerShareCalculatedFormat2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> TaxableIncomePerShareCalculatedFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TaxableIncomePerShareCalculatedFormat2Choice.mmCode, TaxableIncomePerShareCalculatedFormat2Choice.mmProprietary);
