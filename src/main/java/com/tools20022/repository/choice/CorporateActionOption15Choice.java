...
@XmlType(name = "CorporateActionOption15Choice", propOrder = {"code", "proprietary"})
public class CorporateActionOption15Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionOption15Choice, CorporateActionOption9Code> mmCode = new MMMessageAttribute<CorporateActionOption15Choice, CorporateActionOption9Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionOption15Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public CorporateActionOption9Code getValue(CorporateActionOption15Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionOption15Choice obj, CorporateActionOption9Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionOption15Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<CorporateActionOption15Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionOption15Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(CorporateActionOption15Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionOption15Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption15Choice.mmCode, com.tools20022.repository.choice.CorporateActionOption15Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption15Choice";
	...
	public CorporateActionOption15Choice setCode(CorporateActionOption9Code code) {
	...
	public CorporateActionOption15Choice setProprietary(GenericIdentification25 proprietary) {
