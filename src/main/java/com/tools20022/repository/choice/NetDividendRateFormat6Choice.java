...
public class NetDividendRateFormat6Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NetDividendRateFormat6Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat6Choice.mmAmount, NetDividendRateFormat6Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat6Choice.mmNotSpecifiedRate);
