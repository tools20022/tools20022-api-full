...
public class LotteryTypeFormat4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> LotteryTypeFormat4Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.LotteryTypeFormat1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.LotteryTypeFormat1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LotteryTypeFormat4Choice.Code, com.tools20022.repository.choice.LotteryTypeFormat4Choice.Proprietary);
				...
				previousVersion_lazy = () -> LotteryTypeFormat1Choice.mmObject();
			}
		});
