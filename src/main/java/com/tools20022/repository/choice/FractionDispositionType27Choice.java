...
@XmlType(name = "FractionDispositionType27Choice", propOrder = {"code", "proprietary"})
public class FractionDispositionType27Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<FractionDispositionType27Choice, FractionDispositionType11Code> mmCode = new MMMessageAttribute<FractionDispositionType27Choice, FractionDispositionType11Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType27Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			previousVersion_lazy = () -> FractionDispositionType23Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public FractionDispositionType11Code getValue(FractionDispositionType27Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(FractionDispositionType27Choice obj, FractionDispositionType11Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<FractionDispositionType27Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<FractionDispositionType27Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmFractionDisposition;
			componentContext_lazy = () -> com.tools20022.repository.choice.FractionDispositionType27Choice.mmObject();
			isDerived = false;
			...
			previousVersion_lazy = () -> FractionDispositionType23Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification30 getValue(FractionDispositionType27Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(FractionDispositionType27Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType27Choice.mmCode, com.tools20022.repository.choice.FractionDispositionType27Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FractionDispositionType27Choice";
				definition = "Choice between a standard code or a proprietary code to specify the type of fraction disposition.";
				previousVersion_lazy = () -> FractionDispositionType23Choice.mmObject();
			}
		});
	...
	public FractionDispositionType27Choice setCode(FractionDispositionType11Code code) {
	...
	public FractionDispositionType27Choice setProprietary(GenericIdentification30 proprietary) {
