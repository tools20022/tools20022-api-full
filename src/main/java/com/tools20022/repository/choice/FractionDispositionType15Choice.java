...
@XmlType(name = "FractionDispositionType15Choice", propOrder = {"code", "proprietary"})
public class FractionDispositionType15Choice {
	...
	public static final MMMessageAttribute<FractionDispositionType15Choice, FractionDispositionType9Code> mmCode = new MMMessageAttribute<FractionDispositionType15Choice, FractionDispositionType9Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FractionDispositionType25Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<FractionDispositionType15Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<FractionDispositionType15Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(FractionDispositionType25Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.FractionDispositionType15Choice.mmCode, com.tools20022.repository.choice.FractionDispositionType15Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "FractionDispositionType15Choice";
				definition = "Choice between a standard code or a proprietary code to specify the type of fraction disposition.";
				nextVersions_lazy = () -> Arrays.asList(FractionDispositionType25Choice.mmObject());
				previousVersion_lazy = () -> FractionDispositionType9Choice.mmObject();
			}
		});
	...
	public FractionDispositionType15Choice setCode(FractionDispositionType9Code code) {
	...
	public FractionDispositionType15Choice setProprietary(GenericIdentification20 proprietary) {
