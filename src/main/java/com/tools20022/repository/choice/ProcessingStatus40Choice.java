...
public class ProcessingStatus40Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus40Choice.mmPendingCancellation, ProcessingStatus40Choice.mmAcknowledgedAccepted, ProcessingStatus40Choice.mmPendingProcessing, ProcessingStatus40Choice.mmRejected,
						ProcessingStatus40Choice.mmRepair, ProcessingStatus40Choice.mmCancelled, ProcessingStatus40Choice.mmProprietary, ProcessingStatus40Choice.mmCancellationRequested, ProcessingStatus40Choice.mmModificationRequested);
