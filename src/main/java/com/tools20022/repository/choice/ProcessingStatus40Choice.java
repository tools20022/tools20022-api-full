...
public class ProcessingStatus40Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus40Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	public void setPendingProcessing(com.tools20022.repository.choice.PendingProcessingStatus10Choice pendingProcessing) {
	...
	public void setRejected(com.tools20022.repository.choice.RejectionStatus15Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RepairStatus11Choice repair) {
		this.repair = repair;
	}
	...
	public void setCancelled(com.tools20022.repository.choice.CancellationStatus12Choice cancelled) {
