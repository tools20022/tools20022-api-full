...
public class SolicitationFeeRateFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SolicitationFeeRateFormat10Choice.mmRate, SolicitationFeeRateFormat10Choice.mmAmountToQuantity, SolicitationFeeRateFormat10Choice.mmAmount,
						SolicitationFeeRateFormat10Choice.mmNotSpecifiedRate);
