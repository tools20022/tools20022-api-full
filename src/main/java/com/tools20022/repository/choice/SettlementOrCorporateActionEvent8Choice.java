...
public class SettlementOrCorporateActionEvent8Choice {
	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementOrCorporateActionEvent8Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent8Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent8Choice.mmCorporateActionEventType);
