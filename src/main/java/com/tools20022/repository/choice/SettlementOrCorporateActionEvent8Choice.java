...
@XmlType(name = "SettlementOrCorporateActionEvent8Choice", propOrder = {"securitiesTransactionType", "corporateActionEventType"})
public class SettlementOrCorporateActionEvent8Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementOrCorporateActionEvent8Choice, SecuritiesTransactionType14Choice> mmSecuritiesTransactionType = new MMMessageAttribute<SettlementOrCorporateActionEvent8Choice, SecuritiesTransactionType14Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementOrCorporateActionEvent8Choice.mmObject();
			isDerived = false;
			xmlTag = "SctiesTxTp";
		...
		@Override
		public SecuritiesTransactionType14Choice getValue(SettlementOrCorporateActionEvent8Choice obj) {
			return obj.getSecuritiesTransactionType();
		}

		@Override
		public void setValue(SettlementOrCorporateActionEvent8Choice obj, SecuritiesTransactionType14Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementOrCorporateActionEvent8Choice, CorporateActionEventType2Choice> mmCorporateActionEventType = new MMMessageAttribute<SettlementOrCorporateActionEvent8Choice, CorporateActionEventType2Choice>() {
		{
		...
		@Override
		public CorporateActionEventType2Choice getValue(SettlementOrCorporateActionEvent8Choice obj) {
			return obj.getCorporateActionEventType();
		}

		@Override
		public void setValue(SettlementOrCorporateActionEvent8Choice obj, CorporateActionEventType2Choice value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementOrCorporateActionEvent8Choice.mmSecuritiesTransactionType,
						com.tools20022.repository.choice.SettlementOrCorporateActionEvent8Choice.mmCorporateActionEventType);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementOrCorporateActionEvent8Choice";
	...
	public SettlementOrCorporateActionEvent8Choice setSecuritiesTransactionType(SecuritiesTransactionType14Choice securitiesTransactionType) {
	...
	public SettlementOrCorporateActionEvent8Choice setCorporateActionEventType(CorporateActionEventType2Choice corporateActionEventType) {
