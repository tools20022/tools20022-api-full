...
public class SettlementOrCorporateActionEvent11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementOrCorporateActionEvent11Choice.mmSecuritiesTransactionType, SettlementOrCorporateActionEvent11Choice.mmCorporateActionEventType);
