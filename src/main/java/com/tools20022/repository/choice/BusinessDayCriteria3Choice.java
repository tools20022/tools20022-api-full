...
import com.tools20022.repository.msg.BusinessDayCriteria2;
...
@XmlType(name = "BusinessDayCriteria3Choice", propOrder = {"queryName", "newCriteria"})
public class BusinessDayCriteria3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<BusinessDayCriteria3Choice, Max35Text> mmQueryName = new MMMessageAttribute<BusinessDayCriteria3Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.BusinessDayCriteria3Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "QueryName";
			definition = "Recalls the criteria (search and return criteria) defined in a preceding query.";
			previousVersion_lazy = () -> BusinessDayCriteria2Choice.mmQueryName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(BusinessDayCriteria3Choice obj) {
			return obj.getQueryName();
		}

		@Override
		public void setValue(BusinessDayCriteria3Choice obj, Max35Text value) {
			obj.setQueryName(value);
		}
	};
	@XmlElement(name = "NewCrit", required = true)
	protected BusinessDayCriteria2 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.BusinessDayCriteria2
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<BusinessDayCriteria3Choice, BusinessDayCriteria2> mmNewCriteria = new MMMessageAssociationEnd<BusinessDayCriteria3Choice, BusinessDayCriteria2>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.BusinessDayCriteria3Choice.mmObject();
			isDerived = false;
			xmlTag = "NewCrit";
			...
			previousVersion_lazy = () -> BusinessDayCriteria2Choice.mmNewCriteria;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> BusinessDayCriteria2.mmObject();
		}

		@Override
		public BusinessDayCriteria2 getValue(BusinessDayCriteria3Choice obj) {
			return obj.getNewCriteria();
		}

		@Override
		public void setValue(BusinessDayCriteria3Choice obj, BusinessDayCriteria2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BusinessDayCriteria3Choice.mmQueryName, com.tools20022.repository.choice.BusinessDayCriteria3Choice.mmNewCriteria);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "BusinessDayCriteria3Choice";
				...
				previousVersion_lazy = () -> BusinessDayCriteria2Choice.mmObject();
			}
		});
	...
	public BusinessDayCriteria3Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public BusinessDayCriteria2 getNewCriteria() {
		return newCriteria;
	}

	public BusinessDayCriteria3Choice setNewCriteria(BusinessDayCriteria2 newCriteria) {
