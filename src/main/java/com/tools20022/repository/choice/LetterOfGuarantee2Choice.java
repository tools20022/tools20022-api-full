...
@XmlType(name = "LetterOfGuarantee2Choice", propOrder = {"indicator", "proprietary"})
public class LetterOfGuarantee2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LetterOfGuarantee2Choice.mmIndicator, com.tools20022.repository.choice.LetterOfGuarantee2Choice.mmProprietary);
	...
	public LetterOfGuarantee2Choice setIndicator(YesNoIndicator indicator) {
	...
	public LetterOfGuarantee2Choice setProprietary(GenericIdentification25 proprietary) {
