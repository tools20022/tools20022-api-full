 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettleStyle2Choice#mmCode
...
@XmlType(name = "SettleStyle2Choice", propOrder = {"code", "proprietary"})
public class SettleStyle2Choice {
	...
	public static final MMMessageAssociationEnd<SettleStyle2Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<SettleStyle2Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> SettleStyle1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettleStyle2Choice.mmCode, com.tools20022.repository.choice.SettleStyle2Choice.mmProprietary);
				trace_lazy = () -> Option.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "SettleStyle2Choice";
				definition = "Choice of format for settle style.";
				previousVersion_lazy = () -> SettleStyle1Choice.mmObject();
			}
		});
	...
	public SettleStyle2Choice setCode(List<SettleStyle1Code> code) {
	...
	public SettleStyle2Choice setProprietary(GenericIdentification30 proprietary) {
