 ...
 * "RejectionReason2Choice"</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
 * definition} = "Choice of format for the rejection reason."</li>
 * <li>{@linkplain com.tools20022.metamodel.MMModelEntity#getNextVersions
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RejectionReason15Choice
...
@XmlType(name = "RejectionReason2Choice", propOrder = {"code", "proprietary"})
public class RejectionReason2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionReason26Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RejectionReason2Choice
	 * RejectionReason2Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason2Choice, RejectionReason26Code> mmCode = new MMMessageAttribute<RejectionReason2Choice, RejectionReason26Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionReason2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public RejectionReason26Code getValue(RejectionReason2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason2Choice obj, RejectionReason26Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RejectionReason2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionReason2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(RejectionReason2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RejectionReason2Choice obj, GenericIdentification20 value) {
	...
	public RejectionReason26Code getCode() {
		return code;
	}

	public RejectionReason2Choice setCode(RejectionReason26Code code) {
	...
	public RejectionReason2Choice setProprietary(GenericIdentification20 proprietary) {
