...
public class NetDividendRateFormat9Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat9Choice.mmAmount, NetDividendRateFormat9Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat9Choice.mmNotSpecifiedRate);
