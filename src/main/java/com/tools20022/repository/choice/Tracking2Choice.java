 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Tracking2Choice#Indicator
 * Tracking2Choice.Indicator}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Tracking2Choice#Proprietary
 * Tracking2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class Tracking2Choice {
	...
	public static final MMMessageAttribute Indicator = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Tracking2Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Tracking2Choice.Indicator, com.tools20022.repository.choice.Tracking2Choice.Proprietary);
