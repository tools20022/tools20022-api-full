 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.StatementType6Choice#Code
 * StatementType6Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementType6Choice#Proprietary
 * StatementType6Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class StatementType6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementType6Choice.Code, com.tools20022.repository.choice.StatementType6Choice.Proprietary);
