 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat15Choice#mmNotSpecifiedPrice
 * PriceFormat15Choice.mmNotSpecifiedPrice}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat15Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat15Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat15Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice"})
public class PriceFormat15Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat15Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat15Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat15Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat15Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat15Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat15Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat15Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat15Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat15Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat15Choice, PriceValueType5Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat15Choice, PriceValueType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat15Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType5Code getValue(PriceFormat15Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat15Choice obj, PriceValueType5Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat15Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat15Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat15Choice.mmNotSpecifiedPrice);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat15Choice);
	...
	public PriceFormat15Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat15Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat15Choice setNotSpecifiedPrice(PriceValueType5Code notSpecifiedPrice) {
