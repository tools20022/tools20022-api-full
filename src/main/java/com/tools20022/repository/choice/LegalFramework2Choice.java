...
@XmlType(name = "LegalFramework2Choice", propOrder = {"code", "proprietary"})
public class LegalFramework2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.LegalFramework2Choice.mmCode, com.tools20022.repository.choice.LegalFramework2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTrade.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "LegalFramework2Choice";
	...
	public LegalFramework2Choice setCode(LegalFramework1Code code) {
	...
	public LegalFramework2Choice setProprietary(GenericIdentification25 proprietary) {
