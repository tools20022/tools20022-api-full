...
@XmlType(name = "SecuritiesTransactionType13Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType13Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionType13Choice, SecuritiesTransactionType8Code> mmCode = new MMMessageAttribute<SecuritiesTransactionType13Choice, SecuritiesTransactionType8Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType13Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public SecuritiesTransactionType8Code getValue(SecuritiesTransactionType13Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SecuritiesTransactionType13Choice obj, SecuritiesTransactionType8Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SecuritiesTransactionType13Choice, GenericIdentification25> mmProprietary = new MMMessageAttribute<SecuritiesTransactionType13Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTrade.mmSecuritiesTransactionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.SecuritiesTransactionType13Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(SecuritiesTransactionType13Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SecuritiesTransactionType13Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesTransactionType13Choice.mmCode, com.tools20022.repository.choice.SecuritiesTransactionType13Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTransactionType13Choice";
	...
	public SecuritiesTransactionType13Choice setCode(SecuritiesTransactionType8Code code) {
	...
	public SecuritiesTransactionType13Choice setProprietary(GenericIdentification25 proprietary) {
