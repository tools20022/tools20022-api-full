...
public class InstructionProcessingStatus11Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(InstructionProcessingStatus11Choice.mmPendingProcessing, InstructionProcessingStatus11Choice.mmCancellationRequested, InstructionProcessingStatus11Choice.mmAcknowledgedAccepted,
						InstructionProcessingStatus11Choice.mmCancelled, InstructionProcessingStatus11Choice.mmGenerated, InstructionProcessingStatus11Choice.mmRepair, InstructionProcessingStatus11Choice.mmPendingCancellation,
						InstructionProcessingStatus11Choice.mmModificationRequested);
