...
@XmlType(name = "CorporateActionEventProcessingType1FormatChoice", propOrder = {"code", "proprietary"})
public class CorporateActionEventProcessingType1FormatChoice {
	...
	public CorporateActionEventProcessingType1FormatChoice setCode(CorporateActionEventProcessingType1Code code) {
	...
	public CorporateActionEventProcessingType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
