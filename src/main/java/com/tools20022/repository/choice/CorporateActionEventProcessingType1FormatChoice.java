...
public class CorporateActionEventProcessingType1FormatChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventProcessingType1FormatChoice.Code, com.tools20022.repository.choice.CorporateActionEventProcessingType1FormatChoice.Proprietary);
