...
@XmlType(name = "SettlementTransactionCondition21Choice", propOrder = {"code", "proprietary"})
public class SettlementTransactionCondition21Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition21Choice.mmCode, com.tools20022.repository.choice.SettlementTransactionCondition21Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementTransactionCondition21Choice";
	...
	public SettlementTransactionCondition21Choice setCode(SettlementTransactionCondition3Code code) {
	...
	public SettlementTransactionCondition21Choice setProprietary(GenericIdentification47 proprietary) {
