 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty2Choice#Seller
 * Counterparty2Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty2Choice#Buyer
 * Counterparty2Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty2Choice.Seller, com.tools20022.repository.choice.Counterparty2Choice.Buyer);
