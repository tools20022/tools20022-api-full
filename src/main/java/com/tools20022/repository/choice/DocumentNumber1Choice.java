...
public class DocumentNumber1Choice {
	...
	public static final MMMessageAttribute ShortNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber5Choice.ShortNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute LongNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber5Choice.LongNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute ProprietaryNumber = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber5Choice.ProprietaryNumber);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DocumentNumber1Choice.ShortNumber, com.tools20022.repository.choice.DocumentNumber1Choice.LongNumber,
						com.tools20022.repository.choice.DocumentNumber1Choice.ProprietaryNumber);
