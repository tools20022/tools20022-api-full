...
public class UnmatchedStatus19Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus19Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus19Choice.mmNoSpecifiedReason, UnmatchedStatus19Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason18> reason) {
		this.reason = reason;
	}
}