...
@XmlType(name = "UnsecuredMarketReport3Choice", propOrder = {"dataSetAction", "transaction"})
public class UnsecuredMarketReport3Choice {
	...
	public UnsecuredMarketReport3Choice setDataSetAction(ReportPeriodActivity1Code dataSetAction) {
	...
	public UnsecuredMarketReport3Choice setTransaction(List<UnsecuredMarketTransaction3> transaction) {
