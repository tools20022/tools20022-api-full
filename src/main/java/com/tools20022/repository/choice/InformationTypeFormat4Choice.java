...
/**
 * Choice between a standard code or proprietary code to specify the information
...
@XmlType(name = "InformationTypeFormat4Choice", propOrder = {"code", "proprietary"})
public class InformationTypeFormat4Choice {
	...
	public InformationTypeFormat4Choice setCode(CorporateActionInformationType1Code code) {
	...
	public InformationTypeFormat4Choice setProprietary(GenericIdentification30 proprietary) {
