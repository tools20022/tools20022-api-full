...
public class RejectedStatus19Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectedStatus13Choice.NoSpecifiedReason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus23Choice.NoSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectedStatus13Choice.Reason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus23Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedStatus19Choice.NoSpecifiedReason, com.tools20022.repository.choice.RejectedStatus19Choice.Reason);
