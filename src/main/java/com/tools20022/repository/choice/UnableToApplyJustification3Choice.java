	...
	public static final MMMessageAttribute mmAnyInformation = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> UnableToApplyJustification2Choice.mmAnyInformation;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmMissingOrIncorrectInformation = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> UnableToApplyJustification2Choice.mmMissingOrIncorrectInformation;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmPossibleDuplicateInstruction = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> UnableToApplyJustification2Choice.mmPossibleDuplicateInstruction;
			maxOccurs = 1;
			minOccurs = 1;
