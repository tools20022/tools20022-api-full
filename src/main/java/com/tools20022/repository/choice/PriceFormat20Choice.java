...
@XmlType(name = "PriceFormat20Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount"})
public class PriceFormat20Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat20Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat20Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmPercentagePrice);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat20Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat20Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat20Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat20Choice, AmountPrice3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmAmountPrice);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPrice3 getValue(PriceFormat20Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat20Choice obj, AmountPrice3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat20Choice, PriceValueType8Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat20Choice, PriceValueType8Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat20Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmNotSpecifiedPrice);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PriceValueType8Code getValue(PriceFormat20Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat20Choice obj, PriceValueType8Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat20Choice, AmountPricePerFinancialInstrumentQuantity3> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat20Choice, AmountPricePerFinancialInstrumentQuantity3>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmAmountPricePerFinancialInstrumentQuantity);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity3 getValue(PriceFormat20Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat20Choice obj, AmountPricePerFinancialInstrumentQuantity3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat20Choice, AmountPricePerAmount2> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat20Choice, AmountPricePerAmount2>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmAmountPricePerAmount);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public AmountPricePerAmount2 getValue(PriceFormat20Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat20Choice obj, AmountPricePerAmount2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat20Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat20Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat20Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat20Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat20Choice.mmAmountPricePerAmount);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat20Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat20Choice);
				...
				nextVersions_lazy = () -> Arrays.asList(PriceFormat32Choice.mmObject());
			}
		});
	...
	public PriceFormat20Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat20Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat20Choice setNotSpecifiedPrice(PriceValueType8Code notSpecifiedPrice) {
	...
	public PriceFormat20Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity3 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat20Choice setAmountPricePerAmount(AmountPricePerAmount2 amountPricePerAmount) {
