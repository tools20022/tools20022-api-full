 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.SettlementType2Choice#Code
 * SettlementType2Choice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementType2Choice#Proprietary
 * SettlementType2Choice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class SettlementType2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementType2Choice.Code, com.tools20022.repository.choice.SettlementType2Choice.Proprietary);
