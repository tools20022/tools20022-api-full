 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DeniedReason13Choice#Code
...
public class DeniedReason13Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedReason13Choice.Code, com.tools20022.repository.choice.DeniedReason13Choice.Proprietary);
