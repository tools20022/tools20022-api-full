 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat18Choice#mmNotSpecifiedPrice
 * PriceFormat18Choice.mmNotSpecifiedPrice}</li>
 * <li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forPriceFormat18Choice
 * ConstraintCoexistenceQuantityRule.forPriceFormat18Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat18Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat18Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat18Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice", "amountPricePerFinancialInstrumentQuantity", "amountPricePerAmount"})
public class PriceFormat18Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat18Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat18Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat18Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat18Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat18Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat18Choice, AmountPrice5> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat18Choice, AmountPrice5>() {
		{
		...
		@Override
		public AmountPrice5 getValue(PriceFormat18Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat18Choice obj, AmountPrice5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat18Choice, PriceValueType4Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat18Choice, PriceValueType4Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat18Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType4Code getValue(PriceFormat18Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat18Choice obj, PriceValueType4Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat18Choice, AmountPricePerFinancialInstrumentQuantity4> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat18Choice, AmountPricePerFinancialInstrumentQuantity4>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity4 getValue(PriceFormat18Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat18Choice obj, AmountPricePerFinancialInstrumentQuantity4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat18Choice, AmountPricePerAmount3> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat18Choice, AmountPricePerAmount3>() {
		{
		...
		@Override
		public AmountPricePerAmount3 getValue(PriceFormat18Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat18Choice obj, AmountPricePerAmount3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat18Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat18Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat18Choice.mmNotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat18Choice.mmAmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat18Choice.mmAmountPricePerAmount);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forPriceFormat18Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat18Choice);
	...
	public PriceFormat18Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat18Choice setAmountPrice(AmountPrice5 amountPrice) {
	...
	public PriceFormat18Choice setNotSpecifiedPrice(PriceValueType4Code notSpecifiedPrice) {
	...
	public PriceFormat18Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity4 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat18Choice setAmountPricePerAmount(AmountPricePerAmount3 amountPricePerAmount) {
