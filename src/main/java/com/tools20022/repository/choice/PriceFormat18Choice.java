...
public class PriceFormat18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat18Choice.mmPercentagePrice, PriceFormat18Choice.mmAmountPrice, PriceFormat18Choice.mmNotSpecifiedPrice, PriceFormat18Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat18Choice.mmAmountPricePerAmount);
