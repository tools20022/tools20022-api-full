...
@XmlType(name = "CorporateActionEventType32Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventType32Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType32Choice, CorporateActionEventType15Code> mmCode = new MMMessageAttribute<CorporateActionEventType32Choice, CorporateActionEventType15Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType32Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType52Choice.mmCode);
			previousVersion_lazy = () -> CorporateActionEventType11Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventType15Code getValue(CorporateActionEventType32Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventType32Choice obj, CorporateActionEventType15Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventType32Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CorporateActionEventType32Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmType;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventType32Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventType52Choice.mmProprietary);
			previousVersion_lazy = () -> CorporateActionEventType11Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CorporateActionEventType32Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventType32Choice obj, GenericIdentification30 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionEventType32Choice);
	...
	public CorporateActionEventType32Choice setCode(CorporateActionEventType15Code code) {
	...
	public CorporateActionEventType32Choice setProprietary(GenericIdentification30 proprietary) {
