...
public class BalanceQuantity9Choice {
	...
	public static final MMMessageAttribute Quantity = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.BalanceQuantity4Choice.Quantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Total quantity of financial instruments of the balance.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.BalanceQuantity4Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BalanceQuantity9Choice.Quantity, com.tools20022.repository.choice.BalanceQuantity9Choice.Proprietary);
				...
				previousVersion_lazy = () -> BalanceQuantity4Choice.mmObject();
			}
		});
