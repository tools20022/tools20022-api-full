...
public class CorporateActionEventType6Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType6Choice.mmCode, CorporateActionEventType6Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType7Code code) {
		this.code = code;
	}
