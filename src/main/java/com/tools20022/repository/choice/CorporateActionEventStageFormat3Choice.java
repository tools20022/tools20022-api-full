...
@XmlType(name = "CorporateActionEventStageFormat3Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventStageFormat3Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionEventStageFormat3Choice, CorporateActionEventStage1Code> mmCode = new MMMessageAttribute<CorporateActionEventStageFormat3Choice, CorporateActionEventStage1Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmEventStage;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventStageFormat3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat5Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CorporateActionEventStage1Code getValue(CorporateActionEventStageFormat3Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CorporateActionEventStageFormat3Choice obj, CorporateActionEventStage1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionEventStageFormat3Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<CorporateActionEventStageFormat3Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEvent.mmEventStage;
			componentContext_lazy = () -> com.tools20022.repository.choice.CorporateActionEventStageFormat3Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat5Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(CorporateActionEventStageFormat3Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CorporateActionEventStageFormat3Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionEventStageFormat3Choice.mmCode, com.tools20022.repository.choice.CorporateActionEventStageFormat3Choice.mmProprietary);
				...
				name = "CorporateActionEventStageFormat3Choice";
				definition = "Choice between a standard code or proprietary code to specify the event stage type.";
				nextVersions_lazy = () -> Arrays.asList(CorporateActionEventStageFormat5Choice.mmObject());
			}
		});
	...
	public CorporateActionEventStageFormat3Choice setCode(CorporateActionEventStage1Code code) {
	...
	public CorporateActionEventStageFormat3Choice setProprietary(GenericIdentification20 proprietary) {
