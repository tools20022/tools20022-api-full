 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DeniedReason7Choice#mmCode
...
@XmlType(name = "DeniedReason7Choice", propOrder = {"code", "proprietary"})
public class DeniedReason7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeniedReason7Choice, DeniedReason6Code> mmCode = new MMMessageAttribute<DeniedReason7Choice, DeniedReason6Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmDeniedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.DeniedReason7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(DeniedReason15Choice.mmCode);
			previousVersion_lazy = () -> DeniedReason2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeniedReason6Code getValue(DeniedReason7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(DeniedReason7Choice obj, DeniedReason6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeniedReason7Choice, GenericIdentification40> mmProprietary = new MMMessageAttribute<DeniedReason7Choice, GenericIdentification40>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmDeniedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.DeniedReason7Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the request was denied.";
			nextVersions_lazy = () -> Arrays.asList(DeniedReason15Choice.mmProprietary);
			previousVersion_lazy = () -> DeniedReason2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification40 getValue(DeniedReason7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(DeniedReason7Choice obj, GenericIdentification40 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedReason7Choice.mmCode, com.tools20022.repository.choice.DeniedReason7Choice.mmProprietary);
	...
	public DeniedReason7Choice setCode(DeniedReason6Code code) {
	...
	public DeniedReason7Choice setProprietary(GenericIdentification40 proprietary) {
