...
public class AccountParties8Choice {
	...
	public static final MMMessageAssociationEnd PrimaryOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties5Choice.PrimaryOwner;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties10Choice.PrimaryOwner);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Trustee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties5Choice.Trustee;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties10Choice.Trustee);
			minOccurs = 1;
			maxOccurs = 5;
			type_lazy = () -> InvestmentAccountOwnershipInformation12.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd Nominee = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties5Choice.Nominee;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties10Choice.Nominee);
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> InvestmentAccountOwnershipInformation12.mmObject();
			isComposite = true;
	...
	public static final MMMessageAssociationEnd JointOwner = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AccountParties5Choice.JointOwner;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties10Choice.JointOwner);
			minOccurs = 1;
			maxOccurs = 5;
			type_lazy = () -> InvestmentAccountOwnershipInformation12.mmObject();
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AccountParties8Choice.PrimaryOwner, com.tools20022.repository.choice.AccountParties8Choice.Trustee,
						com.tools20022.repository.choice.AccountParties8Choice.Nominee, com.tools20022.repository.choice.AccountParties8Choice.JointOwner);
