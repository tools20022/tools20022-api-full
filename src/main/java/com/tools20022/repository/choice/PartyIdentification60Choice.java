...
public class PartyIdentification60Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification60Choice.mmAnyBIC, PartyIdentification60Choice.mmProprietaryIdentification, PartyIdentification60Choice.mmNameAndAddress, PartyIdentification60Choice.mmCountry);
