...
@XmlType(name = "PendingCancellationReason1Choice", propOrder = {"code", "proprietary"})
public class PendingCancellationReason1Choice {
	...
	public static final MMMessageAttribute<PendingCancellationReason1Choice, PendingCancellationReason4Code> mmCode = new MMMessageAttribute<PendingCancellationReason1Choice, PendingCancellationReason4Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationReason3Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<PendingCancellationReason1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PendingCancellationReason1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationReason3Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReason1Choice.mmCode, com.tools20022.repository.choice.PendingCancellationReason1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationReason1Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(PendingCancellationReason3Choice.mmObject());
			}
		});
	...
	public PendingCancellationReason1Choice setCode(PendingCancellationReason4Code code) {
	...
	public PendingCancellationReason1Choice setProprietary(GenericIdentification20 proprietary) {
