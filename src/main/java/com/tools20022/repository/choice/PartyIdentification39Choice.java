...
public class PartyIdentification39Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification39Choice.mmAnyBIC, PartyIdentification39Choice.mmNameAndAddress, PartyIdentification39Choice.mmCountry);
