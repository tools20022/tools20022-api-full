...
public class PartyIdentification39Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification39Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification39Choice.NameAndAddress,
						com.tools20022.repository.choice.PartyIdentification39Choice.Country);
