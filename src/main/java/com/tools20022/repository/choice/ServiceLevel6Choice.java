 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ServiceLevel6Choice#mmCode
...
@XmlType(name = "ServiceLevel6Choice", propOrder = {"code", "proprietary"})
public class ServiceLevel6Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ServiceLevel6Choice
	 * ServiceLevel6Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ServiceLevel6Choice, ServiceLevel3Code> mmCode = new MMMessageAttribute<ServiceLevel6Choice, ServiceLevel3Code>() {
		{
			businessElementTrace_lazy = () -> ServiceLevel.mmCode;
			componentContext_lazy = () -> com.tools20022.repository.choice.ServiceLevel6Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ServiceLevel3Code getValue(ServiceLevel6Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ServiceLevel6Choice obj, ServiceLevel3Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ServiceLevel6Choice, Max35Text> mmProprietary = new MMMessageAttribute<ServiceLevel6Choice, Max35Text>() {
		{
		...
		@Override
		public Max35Text getValue(ServiceLevel6Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ServiceLevel6Choice obj, Max35Text value) {
	...
	public ServiceLevel6Choice setCode(ServiceLevel3Code code) {
	...
	public ServiceLevel6Choice setProprietary(Max35Text proprietary) {
