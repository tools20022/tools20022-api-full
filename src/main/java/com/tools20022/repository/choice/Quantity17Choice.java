...
public class Quantity17Choice {
	...
	public static final MMMessageAssociationEnd QuantityChoice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Quantity3Choice.QuantityChoice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd ProprietaryQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Quantity3Choice.ProprietaryQuantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Quantity17Choice.QuantityChoice, com.tools20022.repository.choice.Quantity17Choice.ProprietaryQuantity);
