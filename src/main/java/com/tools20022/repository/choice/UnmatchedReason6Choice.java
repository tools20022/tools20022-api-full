 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UnmatchedReason6Choice#Code
...
public class UnmatchedReason6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason6Choice.Code, com.tools20022.repository.choice.UnmatchedReason6Choice.Proprietary);
