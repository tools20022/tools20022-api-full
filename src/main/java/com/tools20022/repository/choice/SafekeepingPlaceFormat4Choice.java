...
public class SafekeepingPlaceFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SafekeepingPlaceFormat4Choice.Identification, com.tools20022.repository.choice.SafekeepingPlaceFormat4Choice.Country,
						com.tools20022.repository.choice.SafekeepingPlaceFormat4Choice.TypeAndIdentification, com.tools20022.repository.choice.SafekeepingPlaceFormat4Choice.Proprietary);
