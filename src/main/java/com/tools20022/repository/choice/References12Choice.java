...
public class References12Choice {
	...
	public static final MMMessageAttribute mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References12Choice.mmObject();
			isDerived = false;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References12Choice.mmSecuritiesSettlementTransactionIdentification, References12Choice.mmPoolIdentification, References12Choice.mmIntraPositionMovementIdentification,
						References12Choice.mmAccountServicerTransactionIdentification, References12Choice.mmOtherTransactionIdentification);
