...
public class PartyIdentification62Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification62Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification62Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification62Choice.NameAndAddress);
