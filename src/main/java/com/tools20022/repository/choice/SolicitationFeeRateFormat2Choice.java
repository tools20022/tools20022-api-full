...
public class SolicitationFeeRateFormat2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SolicitationFeeRateFormat2Choice.mmRate, SolicitationFeeRateFormat2Choice.mmNotSpecifiedRate, SolicitationFeeRateFormat2Choice.mmAmountToQuantity);
