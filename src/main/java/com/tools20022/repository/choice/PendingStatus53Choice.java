...
public class PendingStatus53Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus53Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus53Choice.mmNoSpecifiedReason, PendingStatus53Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason15> reason) {
		this.reason = reason;
	}
}