...
public class AdditionalBusinessProcessFormat13Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AdditionalBusinessProcessFormat13Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AdditionalBusinessProcessFormat13Choice.Code, com.tools20022.repository.choice.AdditionalBusinessProcessFormat13Choice.Proprietary);
