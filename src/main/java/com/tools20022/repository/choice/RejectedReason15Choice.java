...
public class RejectedReason15Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectedReason17Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RejectedReason17Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public void setCode(TransferRejectedStatusReason2Code code) {
		this.code = code;
	}
