...
public class UnmatchedStatus1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedStatus1Choice.NoSpecifiedReason, com.tools20022.repository.choice.UnmatchedStatus1Choice.Reason);
