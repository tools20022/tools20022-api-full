...
@XmlType(name = "UnmatchedStatus13Choice", propOrder = {"noSpecifiedReason", "reason"})
public class UnmatchedStatus13Choice {
	...
	protected List<UnmatchedReason12> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public UnmatchedStatus13Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<UnmatchedReason12> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public UnmatchedStatus13Choice setReason(List<UnmatchedReason12> reason) {
