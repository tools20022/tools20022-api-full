...
public class UnmatchedStatus13Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedStatus6Choice.NoSpecifiedReason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedStatus18Choice.NoSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.UnmatchedReason12
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.UnmatchedStatus6Choice.Reason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedStatus18Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedStatus13Choice.NoSpecifiedReason, com.tools20022.repository.choice.UnmatchedStatus13Choice.Reason);
				...
				previousVersion_lazy = () -> UnmatchedStatus6Choice.mmObject();
