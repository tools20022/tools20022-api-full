 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule#forRatioFormat11Choice
 * ConstraintCoexistenceQuantityRule.forRatioFormat11Choice}</li>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forRatioFormat11Choice
 * ConstraintCoexistenceAmountRule.forRatioFormat11Choice}</li>
 * </ul>
 * </li>
 * <li>
...
public class RatioFormat11Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat11Choice, QuantityToQuantityRatio1> mmQuantityToQuantity = new MMMessageAssociationEnd<RatioFormat11Choice, QuantityToQuantityRatio1>() {
		{
			businessComponentTrace_lazy = () -> QuantityRatio.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "QtyToQty";
		...
		@Override
		public QuantityToQuantityRatio1 getValue(RatioFormat11Choice obj) {
			return obj.getQuantityToQuantity();
		}

		@Override
		public void setValue(RatioFormat11Choice obj, QuantityToQuantityRatio1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RatioFormat11Choice, RateValueType7Code> mmNotSpecifiedRate = new MMMessageAttribute<RatioFormat11Choice, RateValueType7Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RatioFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType7Code getValue(RatioFormat11Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RatioFormat11Choice obj, RateValueType7Code value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RatioFormat11Choice, AmountToAmountRatio2> mmAmountToAmount = new MMMessageAssociationEnd<RatioFormat11Choice, AmountToAmountRatio2>() {
		{
		...
		@Override
		public AmountToAmountRatio2 getValue(RatioFormat11Choice obj) {
			return obj.getAmountToAmount();
		}

		@Override
		public void setValue(RatioFormat11Choice obj, AmountToAmountRatio2 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RatioFormat11Choice.mmQuantityToQuantity, com.tools20022.repository.choice.RatioFormat11Choice.mmNotSpecifiedRate,
						com.tools20022.repository.choice.RatioFormat11Choice.mmAmountToAmount);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceQuantityRule.forRatioFormat11Choice,
						com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forRatioFormat11Choice);
	...
	public RatioFormat11Choice setQuantityToQuantity(QuantityToQuantityRatio1 quantityToQuantity) {
	...
	public RatioFormat11Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
	...
	public RatioFormat11Choice setAmountToAmount(AmountToAmountRatio2 amountToAmount) {
