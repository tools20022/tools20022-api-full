...
@XmlType(name = "DistributionPolicy2Choice", propOrder = {"code", "proprietary"})
public class DistributionPolicy2Choice {
	...
	public static final MMMessageAttribute<DistributionPolicy2Choice, DistributionPolicy1Code> mmCode = new MMMessageAttribute<DistributionPolicy2Choice, DistributionPolicy1Code>() {
		{
			...
			previousVersion_lazy = () -> DistributionPolicy1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<DistributionPolicy2Choice, GenericIdentification30> mmProprietary = new MMMessageAssociationEnd<DistributionPolicy2Choice, GenericIdentification30>() {
		{
			...
			previousVersion_lazy = () -> DistributionPolicy1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DistributionPolicy2Choice.mmCode, com.tools20022.repository.choice.DistributionPolicy2Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "DistributionPolicy2Choice";
				definition = "Choice of format for a distribution policy.";
				previousVersion_lazy = () -> DistributionPolicy1Choice.mmObject();
			}
		});
	...
	public DistributionPolicy2Choice setCode(DistributionPolicy1Code code) {
	...
	public DistributionPolicy2Choice setProprietary(GenericIdentification30 proprietary) {
