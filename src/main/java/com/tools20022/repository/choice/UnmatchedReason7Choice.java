 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UnmatchedReason7Choice#Code
...
public class UnmatchedReason7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UnmatchedReason7Choice.Code, com.tools20022.repository.choice.UnmatchedReason7Choice.Proprietary);
