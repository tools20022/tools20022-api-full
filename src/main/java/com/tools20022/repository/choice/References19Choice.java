...
public class References19Choice {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References19Choice.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References19Choice.mmAccountOwnerTransactionIdentification, References19Choice.mmAccountServicerTransactionIdentification, References19Choice.mmPoolIdentification,
						References19Choice.mmMarketInfrastructureTransactionIdentification, References19Choice.mmProcessorTransactionIdentification);
