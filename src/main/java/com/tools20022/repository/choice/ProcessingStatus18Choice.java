 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV03#ProcessingStatus
 * SecuritiesSettlementConditionModificationStatusAdviceV03.ProcessingStatus}</li>
 * <li>
 ...
 * SecuritiesSettlementConditionModificationStatusAdviceV05.ProcessingStatus}</li>
 * </ul>
 * </li>
 * <li>
...
public class ProcessingStatus18Choice {
	...
	public static final MMMessageAssociationEnd AcknowledgedAccepted = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ReportItemStatus1Choice.Accepted, com.tools20022.repository.choice.ProcessingStatus44Choice.AcknowledgedAccepted);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Rejected = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ReportItemStatus1Choice.Rejected, com.tools20022.repository.choice.ProcessingStatus44Choice.Rejected);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Completed = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus44Choice.Completed);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Denied = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus44Choice.Denied);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Pending = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus44Choice.Pending);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus44Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingStatus18Choice.AcknowledgedAccepted, com.tools20022.repository.choice.ProcessingStatus18Choice.Rejected,
						com.tools20022.repository.choice.ProcessingStatus18Choice.Completed, com.tools20022.repository.choice.ProcessingStatus18Choice.Denied, com.tools20022.repository.choice.ProcessingStatus18Choice.Pending,
						com.tools20022.repository.choice.ProcessingStatus18Choice.Proprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV03.ProcessingStatus,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV04.ProcessingStatus,
						com.tools20022.repository.area.sese.SecuritiesSettlementConditionModificationStatusAdviceV05.ProcessingStatus);
