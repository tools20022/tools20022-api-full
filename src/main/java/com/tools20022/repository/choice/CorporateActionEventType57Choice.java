...
public class CorporateActionEventType57Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType57Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType57Choice.mmCode, CorporateActionEventType57Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType22Code code) {
		this.code = code;
	}
