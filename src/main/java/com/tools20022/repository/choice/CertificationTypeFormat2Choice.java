...
public class CertificationTypeFormat2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> CertificationTypeFormat2Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CertificationTypeFormat2Choice.Code, com.tools20022.repository.choice.CertificationTypeFormat2Choice.Proprietary);
