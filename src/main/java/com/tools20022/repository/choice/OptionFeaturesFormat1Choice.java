...
@XmlType(name = "OptionFeaturesFormat1Choice", propOrder = {"code", "proprietary"})
public class OptionFeaturesFormat1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OptionFeaturesFormat1Choice, OptionFeatures1Code> mmCode = new MMMessageAttribute<OptionFeaturesFormat1Choice, OptionFeatures1Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Code";
			definition = "Standard code to specify the features that may apply to a corporate action option.";
			nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat18Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public OptionFeatures1Code getValue(OptionFeaturesFormat1Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(OptionFeaturesFormat1Choice obj, OptionFeatures1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OptionFeaturesFormat1Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<OptionFeaturesFormat1Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmOptionFeatures;
			componentContext_lazy = () -> com.tools20022.repository.choice.OptionFeaturesFormat1Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat18Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public GenericIdentification20 getValue(OptionFeaturesFormat1Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(OptionFeaturesFormat1Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OptionFeaturesFormat1Choice.mmCode, com.tools20022.repository.choice.OptionFeaturesFormat1Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OptionFeaturesFormat1Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(OptionFeaturesFormat18Choice.mmObject());
			}
		});
	...
	public OptionFeaturesFormat1Choice setCode(OptionFeatures1Code code) {
	...
	public OptionFeaturesFormat1Choice setProprietary(GenericIdentification20 proprietary) {
