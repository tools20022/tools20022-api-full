...
public class AcknowledgedAcceptedStatus24Choice {
	...
	public static final MMMessageAttribute NoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcknowledgedAcceptedStatus12Choice.NoSpecifiedReason;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			name = "Reason";
			definition = "Specifies the reason of the acknowledged accepted status.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AcknowledgedAcceptedStatus12Choice.Reason;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus24Choice.NoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus24Choice.Reason);
