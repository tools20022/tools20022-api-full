...
@XmlType(name = "RateType8Choice", propOrder = {"code", "proprietary"})
public class RateType8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType8Choice.mmCode, com.tools20022.repository.choice.RateType8Choice.mmProprietary);
				trace_lazy = () -> InterestCalculation.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType8Choice";
	...
	public RateType8Choice setCode(RateType1Code code) {
	...
	public RateType8Choice setProprietary(GenericIdentification25 proprietary) {
