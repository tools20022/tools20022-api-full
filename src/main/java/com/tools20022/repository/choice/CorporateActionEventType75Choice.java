	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionEventType54Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionEventType54Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				previousVersion_lazy = () -> CorporateActionEventType54Choice.mmObject();
			}
		});
