 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat25Choice#RateTypeAndAmountAndRateStatus
 * NetDividendRateFormat25Choice.RateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
public class NetDividendRateFormat25Choice {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> NetDividendRateFormat25Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat25Choice.Amount, com.tools20022.repository.choice.NetDividendRateFormat25Choice.AmountAndRateStatus,
						com.tools20022.repository.choice.NetDividendRateFormat25Choice.RateTypeAndAmountAndRateStatus);
