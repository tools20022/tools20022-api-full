...
public class NetDividendRateFormat25Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat25Choice.mmAmount, NetDividendRateFormat25Choice.mmAmountAndRateStatus, NetDividendRateFormat25Choice.mmRateTypeAndAmountAndRateStatus);
