...
@XmlType(name = "AllegementStatus4Choice", propOrder = {"code", "proprietary"})
public class AllegementStatus4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AllegementStatus4Choice.mmCode, com.tools20022.repository.choice.AllegementStatus4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AllegementStatus4Choice";
	...
	public AllegementStatus4Choice setCode(AllegementStatus1Code code) {
	...
	public AllegementStatus4Choice setProprietary(GenericIdentification47 proprietary) {
