...
import com.tools20022.repository.codeset.PaymentMethod6Code;
...
/**
 * Choice of formats to express the method of payment.
 * <p>
...
@XmlType(name = "PaymentMethod6FormatChoice", propOrder = {"code", "proprietary"})
public class PaymentMethod6FormatChoice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.PaymentMethod6FormatChoice
	 * PaymentMethod6FormatChoice}</li>
	...
	public PaymentMethod6FormatChoice setCode(PaymentMethod6Code code) {
	...
	public PaymentMethod6FormatChoice setProprietary(GenericIdentification13 proprietary) {
