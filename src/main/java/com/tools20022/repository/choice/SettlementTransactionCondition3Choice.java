...
public class SettlementTransactionCondition3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementTransactionCondition3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementTransactionCondition3Choice.mmCode, SettlementTransactionCondition3Choice.mmProprietary);
	...
	public void setCode(SettlementTransactionCondition2Code code) {
		this.code = code;
	}
