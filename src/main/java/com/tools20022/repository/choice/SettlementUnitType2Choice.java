...
import com.tools20022.repository.codeset.SettlementUnitType1Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementUnitType2Choice#mmCode
 * SettlementUnitType2Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.SettlementUnitType2Choice#mmProprietary
...
@XmlType(name = "SettlementUnitType2Choice", propOrder = {"code", "proprietary"})
public class SettlementUnitType2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected SettlementUnitType1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementUnitType2Choice, SettlementUnitType1Code> mmCode = new MMMessageAttribute<SettlementUnitType2Choice, SettlementUnitType1Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementUnitType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public SettlementUnitType1Code getValue(SettlementUnitType2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementUnitType2Choice obj, SettlementUnitType1Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementUnitType2Choice, GenericIdentification40> mmProprietary = new MMMessageAssociationEnd<SettlementUnitType2Choice, GenericIdentification40>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementUnitType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Prtry";
		...
		@Override
		public GenericIdentification40 getValue(SettlementUnitType2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementUnitType2Choice obj, GenericIdentification40 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementUnitType2Choice.mmCode, com.tools20022.repository.choice.SettlementUnitType2Choice.mmProprietary);
	...
	public SettlementUnitType1Code getCode() {
		return code;
	}

	public SettlementUnitType2Choice setCode(SettlementUnitType1Code code) {
	...
	public SettlementUnitType2Choice setProprietary(GenericIdentification40 proprietary) {
