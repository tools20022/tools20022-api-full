 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DeniedReason7Choice
...
@XmlType(name = "DeniedReason2Choice", propOrder = {"code", "proprietary"})
public class DeniedReason2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeniedReason2Choice, DeniedReason4Code> mmCode = new MMMessageAttribute<DeniedReason2Choice, DeniedReason4Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmDeniedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.DeniedReason2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(DeniedReason7Choice.mmCode, DeniedReason16Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public DeniedReason4Code getValue(DeniedReason2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(DeniedReason2Choice obj, DeniedReason4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<DeniedReason2Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<DeniedReason2Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmDeniedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.DeniedReason2Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the request was denied.";
			nextVersions_lazy = () -> Arrays.asList(DeniedReason7Choice.mmProprietary, DeniedReason16Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(DeniedReason2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(DeniedReason2Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(DeniedReason7Choice.mmObject(), DeniedReason16Choice.mmObject());
			}
		});
	...
	public DeniedReason2Choice setCode(DeniedReason4Code code) {
	...
	public DeniedReason2Choice setProprietary(GenericIdentification20 proprietary) {
