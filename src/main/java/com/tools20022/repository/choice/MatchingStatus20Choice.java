...
@XmlType(name = "MatchingStatus20Choice", propOrder = {"matched", "unmatched", "proprietary"})
public class MatchingStatus20Choice {
	...
	public static final MMMessageAssociationEnd<MatchingStatus20Choice, ProprietaryReason1> mmMatched = new MMMessageAssociationEnd<MatchingStatus20Choice, ProprietaryReason1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MatchingStatus26Choice.mmMatched);
			previousVersion_lazy = () -> MatchingStatus12Choice.mmMatched;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<MatchingStatus20Choice, UnmatchedStatus13Choice> mmUnmatched = new MMMessageAssociationEnd<MatchingStatus20Choice, UnmatchedStatus13Choice>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MatchingStatus26Choice.mmUnmatched);
			previousVersion_lazy = () -> MatchingStatus12Choice.mmUnmatched;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd<MatchingStatus20Choice, ProprietaryStatusAndReason1> mmProprietary = new MMMessageAssociationEnd<MatchingStatus20Choice, ProprietaryStatusAndReason1>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(MatchingStatus26Choice.mmProprietary);
			previousVersion_lazy = () -> MatchingStatus12Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingStatusAdviceV04.mmMatchingStatus, SecuritiesFinancingStatusAdviceV04.mmInferredMatchingStatus, SecuritiesFinancingStatusAdviceV05.mmMatchingStatus,
						SecuritiesFinancingStatusAdviceV05.mmInferredMatchingStatus);
	...
	public MatchingStatus20Choice setMatched(ProprietaryReason1 matched) {
	...
	public MatchingStatus20Choice setProprietary(ProprietaryStatusAndReason1 proprietary) {
