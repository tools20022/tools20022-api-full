...
public class RateAndAmountFormat39Choice {
	...
	public static final MMMessageAttribute Rate = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateAndAmountFormat5Choice.Rate;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.RateAndAmountFormat5Choice.Amount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateAndAmountFormat39Choice.Rate, com.tools20022.repository.choice.RateAndAmountFormat39Choice.Amount);
