...
public class PartyIdentification16Choice {
	...
	public static final MMMessageAttribute mmBICOrBEI = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentification16Choice.mmObject();
			isDerived = false;
			xmlTag = "BICOrBEI";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentification16Choice.mmBICOrBEI, PartyIdentification16Choice.mmProprietaryIdentification, PartyIdentification16Choice.mmNameAndAddress);
