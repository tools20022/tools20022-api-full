...
public class PartyIdentification14Choice {
	...
	public static final MMMessageAttribute BICOrBEI = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PartyIdentification14Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification14Choice.BICOrBEI, com.tools20022.repository.choice.PartyIdentification14Choice.ProprietaryIdentification,
						com.tools20022.repository.choice.PartyIdentification14Choice.NameAndAddress, com.tools20022.repository.choice.PartyIdentification14Choice.Country);
