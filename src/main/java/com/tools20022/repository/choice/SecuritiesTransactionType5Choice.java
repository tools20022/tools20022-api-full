...
public class SecuritiesTransactionType5Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SecuritiesTransactionType5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTransactionType5Choice.mmCode, SecuritiesTransactionType5Choice.mmProprietary);
	...
	public void setCode(SecuritiesTransactionType3Code code) {
		this.code = code;
	}
