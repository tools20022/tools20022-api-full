...
public class NetDividendRateFormat27Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> NetDividendRateFormat27Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat27Choice.mmAmount, NetDividendRateFormat27Choice.mmAmountAndRateStatus, NetDividendRateFormat27Choice.mmRateTypeAndAmountAndRateStatus,
						NetDividendRateFormat27Choice.mmNotSpecifiedRate);
	...
	public void setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus31 rateTypeAndAmountAndRateStatus) {
