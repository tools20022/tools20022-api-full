...
public class IntraPositionProcessingStatus2Choice {
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> IntraPositionProcessingStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "Rjctd";
	...
	public void setRejected(com.tools20022.repository.choice.RejectionOrRepairStatus3Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RejectionOrRepairStatus3Choice repair) {
		this.repair = repair;
	}
