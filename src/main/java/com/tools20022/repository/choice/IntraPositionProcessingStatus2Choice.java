...
public class IntraPositionProcessingStatus2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(IntraPositionProcessingStatus2Choice.mmRejected, IntraPositionProcessingStatus2Choice.mmRepair, IntraPositionProcessingStatus2Choice.mmCancelled,
						IntraPositionProcessingStatus2Choice.mmAcknowledgedAccepted, IntraPositionProcessingStatus2Choice.mmProprietary);
