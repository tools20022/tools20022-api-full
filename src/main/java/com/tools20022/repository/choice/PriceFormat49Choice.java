...
public class PriceFormat49Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.PercentagePrice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.AmountPrice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute NotSpecifiedPrice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.NotSpecifiedPrice;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.AmountPricePerFinancialInstrumentQuantity;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd AmountPricePerAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.AmountPricePerAmount;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute IndexPoints = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PriceFormat33Choice.IndexPoints;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat49Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat49Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat49Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat49Choice.AmountPricePerFinancialInstrumentQuantity,
						com.tools20022.repository.choice.PriceFormat49Choice.AmountPricePerAmount, com.tools20022.repository.choice.PriceFormat49Choice.IndexPoints);
				...
				previousVersion_lazy = () -> PriceFormat33Choice.mmObject();
			}
		});
