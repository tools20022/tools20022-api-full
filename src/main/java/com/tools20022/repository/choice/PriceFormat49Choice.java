	...
	public static final MMMessageAssociationEnd mmPercentagePrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmPercentagePrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountPrice = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmAmountPrice;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmNotSpecifiedPrice = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmNotSpecifiedPrice;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmAmountPricePerFinancialInstrumentQuantity;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAssociationEnd mmAmountPricePerAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmAmountPricePerAmount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public static final MMMessageAttribute mmIndexPoints = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> PriceFormat33Choice.mmIndexPoints;
			maxOccurs = 1;
			minOccurs = 1;
