...
public class FractionDispositionType13Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FractionDispositionType13Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FractionDispositionType13Choice.mmCode, FractionDispositionType13Choice.mmProprietary);
	...
	public void setCode(FractionDispositionType7Code code) {
		this.code = code;
	}
