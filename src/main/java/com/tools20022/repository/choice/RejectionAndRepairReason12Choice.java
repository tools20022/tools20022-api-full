...
public class RejectionAndRepairReason12Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionAndRepairReason12Choice.Code, com.tools20022.repository.choice.RejectionAndRepairReason12Choice.Proprietary);
