...
@XmlType(name = "PendingCancellationReason2Choice", propOrder = {"code", "proprietary"})
public class PendingCancellationReason2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingCancellationReason2Choice, PendingCancellationReason4Code> mmCode = new MMMessageAttribute<PendingCancellationReason2Choice, PendingCancellationReason4Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingCancellationReason2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PendingCancellationReason4Code getValue(PendingCancellationReason2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingCancellationReason2Choice obj, PendingCancellationReason4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PendingCancellationReason2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<PendingCancellationReason2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingCancellationReason2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(PendingCancellationReason2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingCancellationReason2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReason2Choice.mmCode, com.tools20022.repository.choice.PendingCancellationReason2Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationReason2Choice";
	...
	public PendingCancellationReason2Choice setCode(PendingCancellationReason4Code code) {
	...
	public PendingCancellationReason2Choice setProprietary(GenericIdentification25 proprietary) {
