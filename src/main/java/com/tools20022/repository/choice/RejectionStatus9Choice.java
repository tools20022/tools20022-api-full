...
import com.tools20022.repository.msg.RejectionReason13;
...
@XmlType(name = "RejectionStatus9Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionStatus9Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionStatus9Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectionStatus9Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionStatus9Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
		...
		@Override
		public NoReasonCode getValue(RejectionStatus9Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(RejectionStatus9Choice obj, NoReasonCode value) {
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.RejectionReason13
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionStatus9Choice, RejectionReason13> mmReason = new MMMessageAssociationEnd<RejectionStatus9Choice, RejectionReason13>() {
		{
		...
		@Override
		public RejectionReason13 getValue(RejectionStatus9Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(RejectionStatus9Choice obj, RejectionReason13 value) {
			obj.setReason(value);
		}
	};
	...
	public RejectionStatus9Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public RejectionStatus9Choice setReason(RejectionReason13 reason) {
