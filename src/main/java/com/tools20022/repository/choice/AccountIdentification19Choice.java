...
public class AccountIdentification19Choice {
	...
	public static final MMMessageAssociationEnd mmForAllAccounts = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AccountIdentification19Choice.mmObject();
			isDerived = false;
			xmlTag = "ForAllAccts";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AccountIdentification19Choice.mmForAllAccounts, AccountIdentification19Choice.mmAccountsListAndBalanceDetails);
	...
	public void setAccountsListAndBalanceDetails(List<AccountAndBalance18> accountsListAndBalanceDetails) {
