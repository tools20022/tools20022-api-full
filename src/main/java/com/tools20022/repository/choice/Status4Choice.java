 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Status4Choice#Proprietary
...
public class Status4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status4Choice.Proprietary, com.tools20022.repository.choice.Status4Choice.MatchingStatus,
						com.tools20022.repository.choice.Status4Choice.InferredMatchingStatus, com.tools20022.repository.choice.Status4Choice.SettlementStatus, com.tools20022.repository.choice.Status4Choice.InstructionProcessingStatus);
