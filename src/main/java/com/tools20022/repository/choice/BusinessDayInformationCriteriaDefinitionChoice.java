...
import com.tools20022.repository.msg.BusinessDayInformationCriteria;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.BusinessDayInformationCriteriaDefinitionChoice#mmQueryName
 * BusinessDayInformationCriteriaDefinitionChoice.mmQueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.BusinessDayInformationCriteriaDefinitionChoice#mmNewCriteria
 * BusinessDayInformationCriteriaDefinitionChoice.mmNewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "BusinessDayInformationCriteriaDefinitionChoice", propOrder = {"queryName", "newCriteria"})
public class BusinessDayInformationCriteriaDefinitionChoice {
	...
	protected BusinessDayInformationCriteria newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BusinessDayInformationCriteriaDefinitionChoice.mmQueryName,
						com.tools20022.repository.choice.BusinessDayInformationCriteriaDefinitionChoice.mmNewCriteria);
				...
				name = "BusinessDayInformationCriteriaDefinitionChoice";
	...
	public BusinessDayInformationCriteriaDefinitionChoice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public BusinessDayInformationCriteria getNewCriteria() {
		return newCriteria;
	}

	public BusinessDayInformationCriteriaDefinitionChoice setNewCriteria(BusinessDayInformationCriteria newCriteria) {
