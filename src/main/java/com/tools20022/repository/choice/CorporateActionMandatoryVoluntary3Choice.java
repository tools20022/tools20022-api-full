...
@XmlType(name = "CorporateActionMandatoryVoluntary3Choice", propOrder = {"code", "proprietary"})
public class CorporateActionMandatoryVoluntary3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> CorporateActionMandatoryVoluntary1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> CorporateActionMandatoryVoluntary1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionMandatoryVoluntary3Choice.mmCode, com.tools20022.repository.choice.CorporateActionMandatoryVoluntary3Choice.mmProprietary);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionMandatoryVoluntary3Choice";
				...
				previousVersion_lazy = () -> CorporateActionMandatoryVoluntary1Choice.mmObject();
			}
		});
	...
	public CorporateActionMandatoryVoluntary3Choice setCode(CorporateActionMandatoryVoluntary1Code code) {
	...
	public CorporateActionMandatoryVoluntary3Choice setProprietary(GenericIdentification30 proprietary) {
