...
@XmlType(name = "AllegementStatus3Choice", propOrder = {"code", "proprietary"})
public class AllegementStatus3Choice {
	...
	public AllegementStatus3Choice setCode(AllegementStatus1Code code) {
	...
	public AllegementStatus3Choice setProprietary(GenericIdentification30 proprietary) {
