...
public class PresentationMedium1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PresentationMedium1Choice.mmCode, PresentationMedium1Choice.mmProprietary);
	...
	public void setCode(PresentationMedium1Code code) {
		this.code = code;
	}
