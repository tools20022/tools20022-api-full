 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.UpdateType15Choice#mmCode
...
@XmlType(name = "UpdateType15Choice", propOrder = {"code", "proprietary"})
public class UpdateType15Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.UpdateType2Choice#mmCode
	...
	public static final MMMessageAttribute<UpdateType15Choice, StatementUpdateType1Code> mmCode = new MMMessageAttribute<UpdateType15Choice, StatementUpdateType1Code>() {
		{
			...
			previousVersion_lazy = () -> UpdateType2Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<UpdateType15Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<UpdateType15Choice, GenericIdentification30>() {
		{
			...
			name = "Proprietary";
			definition = "Indicates whether the report is complete or contains changes only.";
			previousVersion_lazy = () -> UpdateType2Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.UpdateType15Choice.mmCode, com.tools20022.repository.choice.UpdateType15Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UpdateType15Choice";
				definition = "Choice of format for the update information.";
				previousVersion_lazy = () -> UpdateType2Choice.mmObject();
			}
		});
	...
	public UpdateType15Choice setCode(StatementUpdateType1Code code) {
	...
	public UpdateType15Choice setProprietary(GenericIdentification30 proprietary) {
