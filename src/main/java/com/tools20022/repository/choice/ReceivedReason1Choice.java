 ...
 * definition} = "Choice of formats for the reason of a received status."</li>
 * <li>
...
@XmlType(name = "ReceivedReason1Choice", propOrder = {"noSpecifiedReason", "reason"})
public class ReceivedReason1Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ReceivedReason1Choice
	 * ReceivedReason1Choice}</li>
	...
	protected ReceivedReason2Choice reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} =
	 * {@linkplain com.tools20022.repository.choice.ReceivedReason2Choice
	...
	public static final MMMessageAssociationEnd<ReceivedReason1Choice, ReceivedReason2Choice> mmReason = new MMMessageAssociationEnd<ReceivedReason1Choice, ReceivedReason2Choice>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Reason";
			definition = "Reason for the received status.";
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ReceivedReason1Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.ReceivedReason1Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ReceivedReason1Choice";
				definition = "Choice of formats for the reason of a received status.";
			}
		});
	...
	public ReceivedReason1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public ReceivedReason2Choice getReason() {
		return reason;
	}
