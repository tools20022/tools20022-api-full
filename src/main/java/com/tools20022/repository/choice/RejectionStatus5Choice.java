...
@XmlType(name = "RejectionStatus5Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionStatus5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionStatus5Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectionStatus5Choice, NoReasonCode>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmNoSpecifiedReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionStatus5Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(RejectionStatus13Choice.mmNoSpecifiedReason, RejectionStatus17Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public NoReasonCode getValue(RejectionStatus5Choice obj) {
			return obj.getNoSpecifiedReason();
		}

		@Override
		public void setValue(RejectionStatus5Choice obj, NoReasonCode value) {
			obj.setNoSpecifiedReason(value);
		}
	};
	@XmlElement(name = "Rsn", required = true)
	protected List<RejectionReason10> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionStatus5Choice, List<RejectionReason10>> mmReason = new MMMessageAssociationEnd<RejectionStatus5Choice, List<RejectionReason10>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionStatus13Choice.mmReason, RejectionStatus17Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public List<RejectionReason10> getValue(RejectionStatus5Choice obj) {
			return obj.getReason();
		}

		@Override
		public void setValue(RejectionStatus5Choice obj, List<RejectionReason10> value) {
			obj.setReason(value);
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionStatus5Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionStatus5Choice.mmReason);
	...
	public RejectionStatus5Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionReason10> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionStatus5Choice setReason(List<RejectionReason10> reason) {
