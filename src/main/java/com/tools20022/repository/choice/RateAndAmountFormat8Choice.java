...
public class RateAndAmountFormat8Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateAndAmountFormat8Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateAndAmountFormat8Choice.mmAmount, RateAndAmountFormat8Choice.mmNotSpecifiedRate);
