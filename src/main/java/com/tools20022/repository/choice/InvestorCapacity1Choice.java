...
@XmlType(name = "InvestorCapacity1Choice", propOrder = {"code", "proprietary"})
public class InvestorCapacity1Choice {
	...
	public static final MMMessageAttribute<InvestorCapacity1Choice, Eligibility1Code> mmCode = new MMMessageAttribute<InvestorCapacity1Choice, Eligibility1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestorCapacity4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<InvestorCapacity1Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<InvestorCapacity1Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(InvestorCapacity4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.InvestorCapacity1Choice.mmCode, com.tools20022.repository.choice.InvestorCapacity1Choice.mmProprietary);
				trace_lazy = () -> InvestorRole.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "InvestorCapacity1Choice";
				definition = "Choice of format for the investor capacity.";
				nextVersions_lazy = () -> Arrays.asList(InvestorCapacity4Choice.mmObject());
			}
		});
	...
	public InvestorCapacity1Choice setCode(Eligibility1Code code) {
	...
	public InvestorCapacity1Choice setProprietary(GenericIdentification20 proprietary) {
