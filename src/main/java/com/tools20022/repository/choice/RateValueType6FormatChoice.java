 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateValueType6FormatChoice#Code
 * RateValueType6FormatChoice.Code}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateValueType6FormatChoice#Proprietary
 * RateValueType6FormatChoice.Proprietary}</li>
 * </ul>
 * </li>
 * <li>
...
public class RateValueType6FormatChoice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> RateValueType6FormatChoice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateValueType6FormatChoice.Code, com.tools20022.repository.choice.RateValueType6FormatChoice.Proprietary);
