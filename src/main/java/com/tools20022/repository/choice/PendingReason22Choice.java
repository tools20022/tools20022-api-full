...
@XmlType(name = "PendingReason22Choice", propOrder = {"code", "proprietary"})
public class PendingReason22Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason22Choice, PendingReason11Code> mmCode = new MMMessageAttribute<PendingReason22Choice, PendingReason11Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason24Choice.mmCode);
			previousVersion_lazy = () -> PendingReason6Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PendingReason11Code getValue(PendingReason22Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason22Choice obj, PendingReason11Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason22Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PendingReason22Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason22Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason24Choice.mmProprietary);
			previousVersion_lazy = () -> PendingReason6Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(PendingReason22Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason22Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason22Choice.mmCode, com.tools20022.repository.choice.PendingReason22Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason22Choice";
				...
				nextVersions_lazy = () -> Arrays.asList(PendingReason24Choice.mmObject());
				previousVersion_lazy = () -> PendingReason6Choice.mmObject();
			}
		});
	...
	public PendingReason22Choice setCode(PendingReason11Code code) {
	...
	public PendingReason22Choice setProprietary(GenericIdentification20 proprietary) {
