	...
	public static final MMMessageAttribute mmSecuritiesTransactionType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementOrCorporateActionEvent17Choice.mmSecuritiesTransactionType);
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementOrCorporateActionEvent10Choice.mmSecuritiesTransactionType;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmCorporateActionEventType = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementOrCorporateActionEvent17Choice.mmCorporateActionEventType);
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementOrCorporateActionEvent10Choice.mmCorporateActionEventType;
			maxOccurs = 1;
			minOccurs = 1;
