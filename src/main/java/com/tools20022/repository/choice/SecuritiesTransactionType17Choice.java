...
@XmlType(name = "SecuritiesTransactionType17Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType17Choice {
	...
	public SecuritiesTransactionType17Choice setCode(SecuritiesTransactionType11Code code) {
	...
	public SecuritiesTransactionType17Choice setProprietary(GenericIdentification40 proprietary) {
