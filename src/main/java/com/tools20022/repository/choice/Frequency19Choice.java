 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Frequency19Choice#mmCode
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Frequency20Choice
...
@XmlType(name = "Frequency19Choice", propOrder = {"code", "proprietary"})
public class Frequency19Choice {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.Frequency20Choice#mmCode
	...
	public static final MMMessageAttribute<Frequency19Choice, EventFrequency1Code> mmCode = new MMMessageAttribute<Frequency19Choice, EventFrequency1Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Frequency20Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<Frequency19Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<Frequency19Choice, GenericIdentification47>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Frequency20Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Frequency19Choice.mmCode, com.tools20022.repository.choice.Frequency19Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Frequency19Choice";
				definition = "Choice of formats for the frequency.";
				nextVersions_lazy = () -> Arrays.asList(Frequency20Choice.mmObject());
			}
		});
	...
	public Frequency19Choice setCode(EventFrequency1Code code) {
	...
	public Frequency19Choice setProprietary(GenericIdentification47 proprietary) {
