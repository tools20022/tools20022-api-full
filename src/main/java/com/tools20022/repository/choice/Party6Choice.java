...
public class Party6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party6Choice.OrganisationIdentification, com.tools20022.repository.choice.Party6Choice.PrivateIdentification);
