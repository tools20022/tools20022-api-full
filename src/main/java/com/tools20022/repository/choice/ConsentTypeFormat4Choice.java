...
public class ConsentTypeFormat4Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			businessElementTrace_lazy = () -> com.tools20022.repository.entity.CorporateActionEvent.mmConsentType;
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentTypeFormat1Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmProprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentTypeFormat1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	public void setCode(ConsentType1Code code) {
		this.code = code;
	}
