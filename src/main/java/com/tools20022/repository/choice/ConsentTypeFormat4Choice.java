...
public class ConsentTypeFormat4Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> ConsentTypeFormat4Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentTypeFormat1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Proprietary = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.ConsentTypeFormat1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ConsentTypeFormat4Choice.Code, com.tools20022.repository.choice.ConsentTypeFormat4Choice.Proprietary);
				...
				previousVersion_lazy = () -> ConsentTypeFormat1Choice.mmObject();
			}
		});
