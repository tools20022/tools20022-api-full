...
public class AdditionalBusinessProcessFormat8Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AdditionalBusinessProcessFormat8Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AdditionalBusinessProcessFormat8Choice.mmCode, AdditionalBusinessProcessFormat8Choice.mmProprietary);
