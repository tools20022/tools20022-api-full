 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateFormat2Choice#mmRate
 * RateFormat2Choice.mmRate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateFormat2Choice#mmNotSpecifiedRate
 * RateFormat2Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "RateFormat2Choice", propOrder = {"rate", "notSpecifiedRate"})
public class RateFormat2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat2Choice, PercentageRate> mmRate = new MMMessageAttribute<RateFormat2Choice, PercentageRate>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Rate";
		...
		@Override
		public PercentageRate getValue(RateFormat2Choice obj) {
			return obj.getRate();
		}

		@Override
		public void setValue(RateFormat2Choice obj, PercentageRate value) {
			obj.setRate(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateFormat2Choice, RateValueType6Code> mmNotSpecifiedRate = new MMMessageAttribute<RateFormat2Choice, RateValueType6Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.RateFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateValueType6Code getValue(RateFormat2Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(RateFormat2Choice obj, RateValueType6Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateFormat2Choice.mmRate, com.tools20022.repository.choice.RateFormat2Choice.mmNotSpecifiedRate);
				trace_lazy = () -> RateAndAmount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateFormat2Choice";
	...
	public RateFormat2Choice setRate(PercentageRate rate) {
	...
	public RateFormat2Choice setNotSpecifiedRate(RateValueType6Code notSpecifiedRate) {
