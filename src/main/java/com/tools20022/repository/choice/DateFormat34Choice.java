 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat34Choice#Date
 * DateFormat34Choice.Date}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat34Choice#DateCode
 * DateFormat34Choice.DateCode}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateFormat34Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat34Choice.Date, com.tools20022.repository.choice.DateFormat34Choice.DateCode);
