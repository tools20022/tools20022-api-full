...
import com.tools20022.repository.codeset.DistributionType2Code;
...
@XmlType(name = "DistributionTypeFormat3Choice", propOrder = {"code", "proprietary"})
public class DistributionTypeFormat3Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected DistributionType2Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<DistributionTypeFormat3Choice, DistributionType2Code> mmCode = new MMMessageAttribute<DistributionTypeFormat3Choice, DistributionType2Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DistributionTypeFormat4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<DistributionTypeFormat3Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<DistributionTypeFormat3Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DistributionTypeFormat4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DistributionTypeFormat3Choice.mmCode, com.tools20022.repository.choice.DistributionTypeFormat3Choice.mmProprietary);
				trace_lazy = () -> CorporateActionDistribution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DistributionTypeFormat3Choice";
				definition = "Choice between a standard code or proprietary code to specify the type of distribution.";
				nextVersions_lazy = () -> Arrays.asList(DistributionTypeFormat4Choice.mmObject());
				previousVersion_lazy = () -> DistributionTypeFormat1Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public DistributionType2Code getCode() {
		return code;
	}

	public DistributionTypeFormat3Choice setCode(DistributionType2Code code) {
	...
	public DistributionTypeFormat3Choice setProprietary(GenericIdentification20 proprietary) {
