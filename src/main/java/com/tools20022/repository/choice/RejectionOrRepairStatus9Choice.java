...
import com.tools20022.repository.msg.RejectionOrRepairReason7;
...
@XmlType(name = "RejectionOrRepairStatus9Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionOrRepairStatus9Choice {
	...
	@XmlElement(name = "Rsn")
	protected List<RejectionOrRepairReason7> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus9Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus9Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairStatus9Choice";
	...
	public RejectionOrRepairStatus9Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionOrRepairReason7> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionOrRepairStatus9Choice setReason(List<RejectionOrRepairReason7> reason) {
