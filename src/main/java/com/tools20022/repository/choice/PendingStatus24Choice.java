...
public class PendingStatus24Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus24Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus24Choice.mmNoSpecifiedReason, PendingStatus24Choice.mmReason);
	...
	public void setReason(List<PendingReason3> reason) {
		this.reason = reason;
	}
}