...
public class Party23Choice {
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.Organisation16
	 * Organisation16}</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Party23Choice, Organisation16> mmOrganisation = new MMMessageAssociationEnd<Party23Choice, Organisation16>() {
		{
			businessComponentTrace_lazy = () -> Organisation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.choice.Party23Choice.mmObject();
			isDerived = false;
			xmlTag = "Org";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Organisation";
			definition = "Organised structure that is set up for a particular purpose, for example, a business, government body, department, charity, or financial institution.";
			nextVersions_lazy = () -> Arrays.asList(Party24Choice.mmOrganisation, Party31Choice.mmOrganisation);
			previousVersion_lazy = () -> Party16Choice.mmOrganisation;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public Organisation16 getValue(Party23Choice obj) {
			return obj.getOrganisation();
		}

		@Override
		public void setValue(Party23Choice obj, Organisation16 value) {
	 ...
	 * <ul>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageAssociationEnd#getType
	 * type} = {@linkplain com.tools20022.repository.msg.IndividualPerson23
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<Party23Choice, IndividualPerson23> mmIndividualPerson = new MMMessageAssociationEnd<Party23Choice, IndividualPerson23>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(Party24Choice.mmIndividualPerson, Party31Choice.mmIndividualPerson);
			previousVersion_lazy = () -> Party16Choice.mmIndividualPerson;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
		...
		@Override
		public IndividualPerson23 getValue(Party23Choice obj) {
			return obj.getIndividualPerson();
		}

		@Override
		public void setValue(Party23Choice obj, IndividualPerson23 value) {
	...
	public Party23Choice setOrganisation(Organisation16 organisation) {
	...
	public Party23Choice setIndividualPerson(IndividualPerson23 individualPerson) {
