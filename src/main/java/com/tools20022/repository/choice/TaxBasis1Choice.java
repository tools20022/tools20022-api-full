 ...
 * <li>{@linkplain com.tools20022.repository.choice.TaxBasis1Choice#Proprietary
...
public class TaxBasis1Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TaxBasis1Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TaxBasis1Choice.Code, com.tools20022.repository.choice.TaxBasis1Choice.Proprietary);
