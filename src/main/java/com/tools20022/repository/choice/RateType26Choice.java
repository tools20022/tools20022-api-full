...
@XmlType(name = "RateType26Choice", propOrder = {"code", "proprietary"})
public class RateType26Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RateType26Choice
	 * RateType26Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType26Choice.mmCode, com.tools20022.repository.choice.RateType26Choice.mmProprietary);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType26Choice";
	...
	public RateType26Choice setCode(GrossDividendRateType2Code code) {
	...
	public RateType26Choice setProprietary(GenericIdentification25 proprietary) {
