...
public class ProcessingStatus3Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus3Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionStatus3Choice.mmObject();
		}
	};
	...
	public static final MMMessageAssociationEnd mmRepair = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RepairStatus3Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus3Choice.mmPendingCancellation, ProcessingStatus3Choice.mmAcknowledgedAccepted, ProcessingStatus3Choice.mmPendingProcessing, ProcessingStatus3Choice.mmRejected,
						ProcessingStatus3Choice.mmRepair, ProcessingStatus3Choice.mmCancelled, ProcessingStatus3Choice.mmProprietary, ProcessingStatus3Choice.mmCancellationRequested, ProcessingStatus3Choice.mmModificationRequested);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionStatus3Choice rejected) {
	...
	public void setRepair(com.tools20022.repository.choice.RepairStatus3Choice repair) {
		this.repair = repair;
	}
