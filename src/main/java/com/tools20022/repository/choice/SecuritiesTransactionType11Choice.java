...
import com.tools20022.repository.codeset.SecuritiesTransactionType9Code;
...
@XmlType(name = "SecuritiesTransactionType11Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType11Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected SecuritiesTransactionType9Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAttribute<SecuritiesTransactionType11Choice, SecuritiesTransactionType9Code> mmCode = new MMMessageAttribute<SecuritiesTransactionType11Choice, SecuritiesTransactionType9Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType19Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<SecuritiesTransactionType11Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<SecuritiesTransactionType11Choice, GenericIdentification20>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType19Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SecuritiesTransactionType11Choice.mmCode, com.tools20022.repository.choice.SecuritiesTransactionType11Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SecuritiesTransactionType11Choice";
				definition = "Choice of format for the repair reason.";
				nextVersions_lazy = () -> Arrays.asList(SecuritiesTransactionType19Choice.mmObject());
				previousVersion_lazy = () -> SecuritiesTransactionType2Choice.mmObject();
			}
		});
		return mmObject_lazy.get();
	}

	public SecuritiesTransactionType9Code getCode() {
		return code;
	}

	public SecuritiesTransactionType11Choice setCode(SecuritiesTransactionType9Code code) {
	...
	public SecuritiesTransactionType11Choice setProprietary(GenericIdentification20 proprietary) {
