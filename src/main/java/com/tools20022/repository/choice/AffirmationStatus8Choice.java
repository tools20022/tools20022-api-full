...
public class AffirmationStatus8Choice {
	...
	/**
	 * Provides the status of the trade at confirmation level at the time the
	 * settlement instruction was sent.
	 * <p>
	 * <strong>Constant fields:</strong>
	 * <ul>
	 * <li>
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> AffirmationStatus8Choice.mmObject();
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.AffirmationStatus1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the trade at confirmation level at the time the settlement instruction was sent.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.AffirmationStatus1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AffirmationStatus8Choice.Code, com.tools20022.repository.choice.AffirmationStatus8Choice.Proprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.dataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "AffirmationStatus8Choice";
				definition = "Choice of format for the affirmation status.";
				previousVersion_lazy = () -> AffirmationStatus1Choice.mmObject();
			}
		});
