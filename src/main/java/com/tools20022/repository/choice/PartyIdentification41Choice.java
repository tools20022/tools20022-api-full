...
public class PartyIdentification41Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PartyIdentification41Choice.AnyBIC, com.tools20022.repository.choice.PartyIdentification41Choice.ProprietaryIdentification);
