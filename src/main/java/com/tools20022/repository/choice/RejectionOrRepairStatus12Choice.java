...
public class RejectionOrRepairStatus12Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus12Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus12Choice.mmNoSpecifiedReason, RejectionOrRepairStatus12Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason11> reason) {
		this.reason = reason;
	}
}