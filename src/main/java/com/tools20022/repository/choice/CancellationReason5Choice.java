 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.CancellationReason12Choice
...
@XmlType(name = "CancellationReason5Choice", propOrder = {"code", "proprietary"})
public class CancellationReason5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationReason5Choice, CancelledStatusReason9Code> mmCode = new MMMessageAttribute<CancellationReason5Choice, CancelledStatusReason9Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationReason5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason23Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CancelledStatusReason9Code getValue(CancellationReason5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancellationReason5Choice obj, CancelledStatusReason9Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationReason5Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<CancellationReason5Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationReason5Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the related instruction is cancelled, or the related cancellation request is executed.";
			nextVersions_lazy = () -> Arrays.asList(CancellationReason23Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(CancellationReason5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancellationReason5Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationReason5Choice.mmCode, com.tools20022.repository.choice.CancellationReason5Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationReason5Choice";
				definition = "Choice of format for the cancellation reason.";
				nextVersions_lazy = () -> Arrays.asList(CancellationReason12Choice.mmObject(), CancellationReason23Choice.mmObject());
			}
		});
	...
	public CancellationReason5Choice setCode(CancelledStatusReason9Code code) {
	...
	public CancellationReason5Choice setProprietary(GenericIdentification20 proprietary) {
