...
@XmlType(name = "SuspendedStatusReasonChoice", propOrder = {"reason", "proprietary", "noSpecifiedReason"})
public class SuspendedStatusReasonChoice {
	...
	public SuspendedStatusReasonChoice setReason(SuspendedStatusReason3Code reason) {
	...
	public SuspendedStatusReasonChoice setProprietary(GenericIdentification13 proprietary) {
	...
	public SuspendedStatusReasonChoice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
