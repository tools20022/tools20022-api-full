...
public class SuspendedStatusReasonChoice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SuspendedStatusReasonChoice.Reason, com.tools20022.repository.choice.SuspendedStatusReasonChoice.Proprietary,
						com.tools20022.repository.choice.SuspendedStatusReasonChoice.NoSpecifiedReason);
