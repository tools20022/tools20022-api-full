 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty6Choice#Seller
 * Counterparty6Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty6Choice#Buyer
 * Counterparty6Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty6Choice.Seller, com.tools20022.repository.choice.Counterparty6Choice.Buyer);
