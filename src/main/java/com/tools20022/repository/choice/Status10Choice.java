...
public class Status10Choice {
	...
	public static final MMMessageAssociationEnd mmAffirmationStatus = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> Status10Choice.mmObject();
			isDerived = false;
			xmlTag = "AffirmSts";
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays
						.asList(Status10Choice.mmAffirmationStatus, Status10Choice.mmAllocationStatus, Status10Choice.mmRepoCallRequestStatus, Status10Choice.mmCorporateActionEventProcessingStatus,
								Status10Choice.mmCorporateActionEventStage, Status10Choice.mmInferredMatchingStatus, Status10Choice.mmInstructionProcessingStatus, Status10Choice.mmMatchingStatus,
								Status10Choice.mmRegistrationProcessingStatus, Status10Choice.mmResponseStatus, Status10Choice.mmReplacementProcessingStatus, Status10Choice.mmCancellationProcessingStatus, Status10Choice.mmSettlementStatus,
								Status10Choice.mmSettlementConditionModificationStatus);
	...
	public void setSettlementStatus(com.tools20022.repository.choice.SettlementStatus6Choice settlementStatus) {
