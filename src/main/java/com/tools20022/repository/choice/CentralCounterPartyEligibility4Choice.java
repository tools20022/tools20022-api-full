...
public class CentralCounterPartyEligibility4Choice {
	...
	public static final MMMessageAttribute Indicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CentralCounterPartyEligibility1Choice.Indicator;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CentralCounterPartyEligibility1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CentralCounterPartyEligibility4Choice.Indicator, com.tools20022.repository.choice.CentralCounterPartyEligibility4Choice.Proprietary);
				...
				previousVersion_lazy = () -> CentralCounterPartyEligibility1Choice.mmObject();
			}
		});
