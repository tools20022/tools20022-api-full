	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CentralCounterPartyEligibility1Choice.mmIndicator;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.CentralCounterPartyEligibility1Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
