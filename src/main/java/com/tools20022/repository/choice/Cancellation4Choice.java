...
public class Cancellation4Choice {
	...
	public static final MMMessageAttribute References = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation1Choice.Reference;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation8Choice.References);
			minOccurs = 1;
	...
	public static final MMMessageAttribute TransferOutDetails = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Cancellation1Choice.TransferOutDetails;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation8Choice.TransferOutDetails);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Cancellation4Choice.References, com.tools20022.repository.choice.Cancellation4Choice.TransferOutDetails);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.TransferOutCancellationRequestV05.Cancellation);
