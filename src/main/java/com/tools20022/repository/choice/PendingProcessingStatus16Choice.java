...
public class PendingProcessingStatus16Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessingStatus16Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingStatus16Choice.mmNoSpecifiedReason, PendingProcessingStatus16Choice.mmReason);
	...
	public void setReason(List<PendingProcessingReason13> reason) {
		this.reason = reason;
	}
}