...
public class FailingStatus2Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus2Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus2Choice.mmNoSpecifiedReason, FailingStatus2Choice.mmReason);
	...
	public void setReason(List<FailingReason2> reason) {
		this.reason = reason;
	}
}