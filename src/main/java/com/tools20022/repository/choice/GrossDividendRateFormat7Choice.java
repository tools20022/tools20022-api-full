...
public class GrossDividendRateFormat7Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat7Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat7Choice.mmAmount, GrossDividendRateFormat7Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat7Choice.mmNotSpecifiedRate);
