 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat22Choice#mmDate
 * DateFormat22Choice.mmDate}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.DateFormat22Choice#mmDateCode
 * DateFormat22Choice.mmDateCode}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "DateFormat22Choice", propOrder = {"date", "dateCode"})
public class DateFormat22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat22Choice.mmDate, com.tools20022.repository.choice.DateFormat22Choice.mmDateCode);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DateFormat22Choice";
