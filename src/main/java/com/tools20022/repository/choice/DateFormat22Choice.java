 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat22Choice#Date
 * DateFormat22Choice.Date}</li>
 * <li>{@linkplain com.tools20022.repository.choice.DateFormat22Choice#DateCode
 * DateFormat22Choice.DateCode}</li>
 * </ul>
 * </li>
 * <li>
...
public class DateFormat22Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DateFormat22Choice.Date, com.tools20022.repository.choice.DateFormat22Choice.DateCode);
