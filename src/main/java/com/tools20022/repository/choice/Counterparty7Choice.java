...
public class Counterparty7Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Counterparty7Choice.mmSeller, Counterparty7Choice.mmBuyer);
	...
	public void setSeller(PartyIdentificationAndAccount63 seller) {
		this.seller = seller;
	}
	...
	public void setBuyer(PartyIdentificationAndAccount63 buyer) {
		this.buyer = buyer;
	}
}