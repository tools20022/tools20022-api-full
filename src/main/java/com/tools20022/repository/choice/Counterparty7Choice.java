 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty7Choice#Seller
 * Counterparty7Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty7Choice#Buyer
 * Counterparty7Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty7Choice {
	...
	public static final MMMessageAssociationEnd Seller = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Counterparty7Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty7Choice.Seller, com.tools20022.repository.choice.Counterparty7Choice.Buyer);
