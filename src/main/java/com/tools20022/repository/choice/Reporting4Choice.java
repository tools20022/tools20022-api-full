...
@XmlType(name = "Reporting4Choice", propOrder = {"code", "proprietary"})
public class Reporting4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.Reporting4Choice
	 * Reporting4Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Reporting4Choice.mmCode, com.tools20022.repository.choice.Reporting4Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeExecution.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Reporting4Choice";
	...
	public Reporting4Choice setCode(Reporting1Code code) {
	...
	public Reporting4Choice setProprietary(GenericIdentification25 proprietary) {
