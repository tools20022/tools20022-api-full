...
public class PendingCancellationReasons2Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReasons4Choice.Code);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the cancellation request is pending.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReasons4Choice.Proprietary);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReasons2Choice.Code, com.tools20022.repository.choice.PendingCancellationReasons2Choice.Proprietary);
