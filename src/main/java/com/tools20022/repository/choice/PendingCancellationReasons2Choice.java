...
@XmlType(name = "PendingCancellationReasons2Choice", propOrder = {"code", "proprietary"})
public class PendingCancellationReasons2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationReasons4Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Specifies the reason why the cancellation request is pending.";
			nextVersions_lazy = () -> Arrays.asList(PendingCancellationReasons4Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationReasons2Choice.mmCode, com.tools20022.repository.choice.PendingCancellationReasons2Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingCancellationReasons2Choice";
				definition = "Choice of format for the pending cancellation reason.";
				nextVersions_lazy = () -> Arrays.asList(PendingCancellationReasons4Choice.mmObject());
			}
		});
	...
	public PendingCancellationReasons2Choice setCode(PendingReason7Code code) {
	...
	public PendingCancellationReasons2Choice setProprietary(GenericIdentification20 proprietary) {
