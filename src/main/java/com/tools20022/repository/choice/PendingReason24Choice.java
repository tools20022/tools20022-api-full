...
@XmlType(name = "PendingReason24Choice", propOrder = {"code", "proprietary"})
public class PendingReason24Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason24Choice, PendingReason13Code> mmCode = new MMMessageAttribute<PendingReason24Choice, PendingReason13Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason24Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason33Choice.mmCode);
			previousVersion_lazy = () -> PendingReason22Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public PendingReason13Code getValue(PendingReason24Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason24Choice obj, PendingReason13Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason24Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<PendingReason24Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason24Choice.mmObject();
			isDerived = false;
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason33Choice.mmProprietary);
			previousVersion_lazy = () -> PendingReason22Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(PendingReason24Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason24Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason24Choice.mmCode, com.tools20022.repository.choice.PendingReason24Choice.mmProprietary);
	...
	public PendingReason24Choice setCode(PendingReason13Code code) {
	...
	public PendingReason24Choice setProprietary(GenericIdentification20 proprietary) {
