...
public class SafekeepingPlaceFormat5Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SafekeepingPlaceFormat5Choice.mmIdentification, SafekeepingPlaceFormat5Choice.mmCountry, SafekeepingPlaceFormat5Choice.mmTypeAndIdentification,
						SafekeepingPlaceFormat5Choice.mmProprietary);
