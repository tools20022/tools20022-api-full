...
public class RejectionStatus1Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionStatus1Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionStatus1Choice.mmNoSpecifiedReason, RejectionStatus1Choice.mmReason);
	...
	public void setReason(List<RejectionReason5> reason) {
		this.reason = reason;
	}
}