...
import com.tools20022.repository.msg.RejectionOrRepairReason14;
...
@XmlType(name = "RejectionOrRepairStatus15Choice", propOrder = {"noSpecifiedReason", "reason"})
public class RejectionOrRepairStatus15Choice {
	...
	public static final MMMessageAttribute<RejectionOrRepairStatus15Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<RejectionOrRepairStatus15Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(RejectionOrRepairStatus29Choice.mmNoSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	protected List<RejectionOrRepairReason14> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	public static final MMMessageAssociationEnd<RejectionOrRepairStatus15Choice, List<RejectionOrRepairReason14>> mmReason = new MMMessageAssociationEnd<RejectionOrRepairStatus15Choice, List<RejectionOrRepairReason14>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionOrRepairStatus29Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectionOrRepairStatus15Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.RejectionOrRepairStatus15Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionOrRepairStatus15Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(RejectionOrRepairStatus29Choice.mmObject());
				previousVersion_lazy = () -> RejectionOrRepairStatus2Choice.mmObject();
			}
		});
	...
	public RejectionOrRepairStatus15Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<RejectionOrRepairReason14> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public RejectionOrRepairStatus15Choice setReason(List<RejectionOrRepairReason14> reason) {
