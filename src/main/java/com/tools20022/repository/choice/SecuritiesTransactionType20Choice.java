...
@XmlType(name = "SecuritiesTransactionType20Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType20Choice {
	...
	public SecuritiesTransactionType20Choice setCode(SecuritiesTransactionType10Code code) {
	...
	public SecuritiesTransactionType20Choice setProprietary(GenericIdentification30 proprietary) {
