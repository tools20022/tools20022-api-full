...
@XmlType(name = "ProcessingPosition23Choice", propOrder = {"code", "proprietary"})
public class ProcessingPosition23Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProcessingPosition9Choice.mmCode;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmProprietary = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> ProcessingPosition9Choice.mmProprietary;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ProcessingPosition23Choice.mmCode, com.tools20022.repository.choice.ProcessingPosition23Choice.mmProprietary);
	...
	public ProcessingPosition23Choice setCode(ProcessingPosition5Code code) {
	...
	public ProcessingPosition23Choice setProprietary(GenericIdentification47 proprietary) {
