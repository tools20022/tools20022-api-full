...
public class PendingProcessingStatus15Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessingStatus15Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingStatus15Choice.mmNoSpecifiedReason, PendingProcessingStatus15Choice.mmReason);
	...
	public void setReason(List<PendingProcessingReason12> reason) {
		this.reason = reason;
	}
}