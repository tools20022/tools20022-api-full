...
import com.tools20022.repository.msg.AcknowledgementReason19;
...
@XmlType(name = "AcknowledgedAcceptedStatus31Choice", propOrder = {"noSpecifiedReason", "reason"})
public class AcknowledgedAcceptedStatus31Choice {
	...
	protected List<AcknowledgementReason19> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AcknowledgedAcceptedStatus31Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.AcknowledgedAcceptedStatus31Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AcknowledgedAcceptedStatus31Choice";
	...
	public AcknowledgedAcceptedStatus31Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<AcknowledgementReason19> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public AcknowledgedAcceptedStatus31Choice setReason(List<AcknowledgementReason19> reason) {
