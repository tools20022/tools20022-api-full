 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty9Choice#Seller
 * Counterparty9Choice.Seller}</li>
 * <li>{@linkplain com.tools20022.repository.choice.Counterparty9Choice#Buyer
 * Counterparty9Choice.Buyer}</li>
 * </ul>
 * </li>
...
public class Counterparty9Choice {
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Counterparty3Choice#Seller
	 * Counterparty3Choice.Seller}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Seller = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Counterparty3Choice.Seller;
			minOccurs = 1;
			maxOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.choice.Counterparty3Choice#Buyer
	 * Counterparty3Choice.Buyer}</li>
	 * </ul>
	 */
	public static final MMMessageAssociationEnd Buyer = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.Counterparty3Choice.Buyer;
			minOccurs = 1;
			maxOccurs = 1;
			type_lazy = () -> PartyIdentificationAndAccount106.mmObject();
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Counterparty9Choice.Seller, com.tools20022.repository.choice.Counterparty9Choice.Buyer);
