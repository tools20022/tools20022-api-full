...
public class NetDividendRateFormat4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(NetDividendRateFormat4Choice.mmAmount, NetDividendRateFormat4Choice.mmRateTypeAndAmountAndRateStatus, NetDividendRateFormat4Choice.mmNotSpecifiedRate);
