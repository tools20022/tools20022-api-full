 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat4Choice#RateTypeAndAmountAndRateStatus
 * NetDividendRateFormat4Choice.RateTypeAndAmountAndRateStatus}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat4Choice#NotSpecifiedRate
 * NetDividendRateFormat4Choice.NotSpecifiedRate}</li>
 * </ul>
 * </li>
...
public class NetDividendRateFormat4Choice {
	...
	public static final MMMessageAttribute Amount = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> NetDividendRateFormat4Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat4Choice.Amount, com.tools20022.repository.choice.NetDividendRateFormat4Choice.RateTypeAndAmountAndRateStatus,
						com.tools20022.repository.choice.NetDividendRateFormat4Choice.NotSpecifiedRate);
