...
@XmlType(name = "GeneratedReasons6Choice", propOrder = {"code", "proprietary"})
public class GeneratedReasons6Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GeneratedReasons6Choice.mmCode, com.tools20022.repository.choice.GeneratedReasons6Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GeneratedReasons6Choice";
	...
	public GeneratedReasons6Choice setCode(GeneratedReason3Code code) {
	...
	public GeneratedReasons6Choice setProprietary(GenericIdentification47 proprietary) {
