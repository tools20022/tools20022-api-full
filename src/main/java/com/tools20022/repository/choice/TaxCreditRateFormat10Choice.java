...
public class TaxCreditRateFormat10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TaxCreditRateFormat10Choice.mmRate, TaxCreditRateFormat10Choice.mmAmount, TaxCreditRateFormat10Choice.mmRateTypeAndAmountAndRateStatus,
						TaxCreditRateFormat10Choice.mmNotSpecifiedRate);
