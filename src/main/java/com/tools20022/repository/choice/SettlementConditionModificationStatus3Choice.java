...
public class SettlementConditionModificationStatus3Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementConditionModificationStatus1Choice.Code;
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAttribute Proprietary = new MMMessageAttribute() {
		{
			...
			name = "Proprietary";
			definition = "Provides the status of the securities settlement condition modification request.";
			previousVersion_lazy = () -> com.tools20022.repository.choice.SettlementConditionModificationStatus1Choice.Proprietary;
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementConditionModificationStatus3Choice.Code, com.tools20022.repository.choice.SettlementConditionModificationStatus3Choice.Proprietary);
