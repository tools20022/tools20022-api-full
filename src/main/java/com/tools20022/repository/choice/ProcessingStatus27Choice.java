...
public class ProcessingStatus27Choice {
	...
	public static final MMMessageAssociationEnd mmPendingCancellation = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ProcessingStatus27Choice.mmObject();
			isDerived = false;
			xmlTag = "PdgCxl";
	...
	public static final MMMessageAssociationEnd mmRejected = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.choice.RejectionStatus12Choice.mmObject();
		}
	};
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ProcessingStatus27Choice.mmPendingCancellation, ProcessingStatus27Choice.mmAcknowledgedAccepted, ProcessingStatus27Choice.mmPendingProcessing, ProcessingStatus27Choice.mmRejected,
						ProcessingStatus27Choice.mmRepair, ProcessingStatus27Choice.mmCancelled, ProcessingStatus27Choice.mmProprietary, ProcessingStatus27Choice.mmCancellationRequested, ProcessingStatus27Choice.mmModificationRequested);
	...
	public void setRejected(com.tools20022.repository.choice.RejectionStatus12Choice rejected) {
