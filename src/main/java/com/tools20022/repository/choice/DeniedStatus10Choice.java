...
@XmlType(name = "DeniedStatus10Choice", propOrder = {"noSpecifiedReason", "reason"})
public class DeniedStatus10Choice {
	...
	public static final MMMessageAttribute<DeniedStatus10Choice, NoReasonCode> mmNoSpecifiedReason = new MMMessageAttribute<DeniedStatus10Choice, NoReasonCode>() {
		{
			...
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(DeniedStatus15Choice.mmNoSpecifiedReason);
	...
	public static final MMMessageAssociationEnd<DeniedStatus10Choice, List<DeniedReason5>> mmReason = new MMMessageAssociationEnd<DeniedStatus10Choice, List<DeniedReason5>>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(DeniedStatus15Choice.mmReason);
	...
	public DeniedStatus10Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
	...
	public DeniedStatus10Choice setReason(List<DeniedReason5> reason) {
