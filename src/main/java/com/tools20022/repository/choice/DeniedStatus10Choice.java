...
import com.tools20022.repository.msg.DeniedReason5;
...
public class DeniedStatus10Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> DeniedStatus10Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
			registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NoSpecifiedReason";
			definition = "Indicates that there is no reason available or to report.";
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus15Choice.mmNoSpecifiedReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.DeniedStatus6Choice.mmNoSpecifiedReason;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> NoReasonCode.mmObject();
		}
	};
	protected List<DeniedReason5> reason;
	/**
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.DeniedReason5
	 * DeniedReason5}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getBusinessElementTrace
	 * businessElementTrace} =
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus15Choice.mmReason);
			previousVersion_lazy = () -> com.tools20022.repository.choice.DeniedStatus6Choice.mmReason;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeniedStatus10Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.DeniedStatus10Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> com.tools20022.repository.GeneratedRepository.mmdataDict;
				registrationStatus = com.tools20022.metamodel.MMRegistrationStatus.REGISTERED;
				name = "DeniedStatus10Choice";
				definition = "Specifies whether the status is provided with a reason or not.";
				nextVersions_lazy = () -> Arrays.asList(DeniedStatus15Choice.mmObject());
	...
	public List<DeniedReason5> getReason() {
		return reason;
	}

	public void setReason(List<DeniedReason5> reason) {
		this.reason = reason;
	}
}