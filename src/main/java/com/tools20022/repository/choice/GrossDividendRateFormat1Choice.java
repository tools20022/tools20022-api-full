...
public class GrossDividendRateFormat1Choice {
	...
	public static final MMMessageAttribute mmAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GrossDividendRateFormat1Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GrossDividendRateFormat1Choice.mmAmount, GrossDividendRateFormat1Choice.mmRateTypeAndAmountAndRateStatus, GrossDividendRateFormat1Choice.mmNotSpecifiedRate);
	...
	public void setNotSpecifiedRate(RateType12Code notSpecifiedRate) {
