...
import com.tools20022.repository.codeset.RejectionReason16Code;
 ...
 * nextVersions} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RejectionReason16Choice
...
@XmlType(name = "RejectionReason5Choice", propOrder = {"code", "proprietary"})
public class RejectionReason5Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason5Choice, RejectionReason16Code> mmCode = new MMMessageAttribute<RejectionReason5Choice, RejectionReason16Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionReason5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(RejectionReason16Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public RejectionReason16Code getValue(RejectionReason5Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason5Choice obj, RejectionReason16Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason5Choice, GenericIdentification20> mmProprietary = new MMMessageAttribute<RejectionReason5Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmRejectionReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.RejectionReason5Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the instruction/request has a repair or rejection status.";
			nextVersions_lazy = () -> Arrays.asList(RejectionReason16Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification20 getValue(RejectionReason5Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(RejectionReason5Choice obj, GenericIdentification20 value) {
		...
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				...
				nextVersions_lazy = () -> Arrays.asList(RejectionReason16Choice.mmObject());
			}
		});
	...
	public RejectionReason5Choice setCode(RejectionReason16Code code) {
	...
	public RejectionReason5Choice setProprietary(GenericIdentification20 proprietary) {
