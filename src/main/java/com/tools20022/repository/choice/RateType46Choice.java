...
@XmlType(name = "RateType46Choice", propOrder = {"code", "proprietary"})
public class RateType46Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.RateType46Choice
	 * RateType46Choice}</li>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateType46Choice.mmCode, com.tools20022.repository.choice.RateType46Choice.mmProprietary);
				trace_lazy = () -> Tax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateType46Choice";
	...
	public RateType46Choice setCode(WithholdingTaxRateType1Code code) {
	...
	public RateType46Choice setProprietary(GenericIdentification47 proprietary) {
