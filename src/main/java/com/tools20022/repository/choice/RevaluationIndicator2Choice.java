...
public class RevaluationIndicator2Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RevaluationIndicator2Choice.Indicator, com.tools20022.repository.choice.RevaluationIndicator2Choice.Proprietary);
