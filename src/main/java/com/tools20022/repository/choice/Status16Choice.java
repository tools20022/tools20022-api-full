...
public class Status16Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Status16Choice.Proprietary, com.tools20022.repository.choice.Status16Choice.MatchingStatus,
						com.tools20022.repository.choice.Status16Choice.InferredMatchingStatus, com.tools20022.repository.choice.Status16Choice.SettlementStatus, com.tools20022.repository.choice.Status16Choice.InstructionProcessingStatus);
