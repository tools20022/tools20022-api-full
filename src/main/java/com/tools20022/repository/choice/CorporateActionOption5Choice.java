...
public class CorporateActionOption5Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionOption5Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption5Choice.mmCode, CorporateActionOption5Choice.mmProprietary);
	...
	public void setCode(CorporateActionOption6Code code) {
		this.code = code;
	}
