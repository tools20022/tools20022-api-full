...
public class RejectionOrRepairStatus33Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus33Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus33Choice.mmNoSpecifiedReason, RejectionOrRepairStatus33Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason27> reason) {
		this.reason = reason;
	}
}