...
public class FundOrderType1Choice {
	...
	public static final MMMessageAttribute<FundOrderType1Choice, FundOrderType6Code> mmType = new MMMessageAttribute<FundOrderType1Choice, FundOrderType6Code>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OrderType2Choice.mmType);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<FundOrderType1Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<FundOrderType1Choice, GenericIdentification47>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(OrderType2Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public FundOrderType1Choice setType(FundOrderType6Code type) {
	...
	public FundOrderType1Choice setProprietary(GenericIdentification47 proprietary) {
