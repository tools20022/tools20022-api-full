 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat27Choice#NotSpecifiedPrice
 * PriceFormat27Choice.NotSpecifiedPrice}</li>
 * <li>
...
public class PriceFormat27Choice {
	...
	public static final MMMessageAssociationEnd PercentagePrice = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> PriceFormat27Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat27Choice.PercentagePrice, com.tools20022.repository.choice.PriceFormat27Choice.AmountPrice,
						com.tools20022.repository.choice.PriceFormat27Choice.NotSpecifiedPrice, com.tools20022.repository.choice.PriceFormat27Choice.IndexPoints);
