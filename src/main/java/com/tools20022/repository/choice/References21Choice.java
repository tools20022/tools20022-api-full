...
public class References21Choice {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References21Choice.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References21Choice.mmAccountOwnerTransactionIdentification, References21Choice.mmAccountServicerTransactionIdentification, References21Choice.mmPoolIdentification,
						References21Choice.mmMarketInfrastructureTransactionIdentification, References21Choice.mmProcessorTransactionIdentification);
