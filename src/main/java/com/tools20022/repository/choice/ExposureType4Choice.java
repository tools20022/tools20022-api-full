 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.ExposureType4Choice#mmCode
...
@XmlType(name = "ExposureType4Choice", propOrder = {"code", "proprietary"})
public class ExposureType4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.ExposureType4Choice
	 * ExposureType4Choice}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ExposureType4Choice, ExposureType2Code> mmCode = new MMMessageAttribute<ExposureType4Choice, ExposureType2Code>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType4Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ExposureType2Code getValue(ExposureType4Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ExposureType4Choice obj, ExposureType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ExposureType4Choice, GenericIdentification20> mmProprietary = new MMMessageAssociationEnd<ExposureType4Choice, GenericIdentification20>() {
		{
			businessElementTrace_lazy = () -> ExposureTerm.mmExposureType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ExposureType4Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification20 getValue(ExposureType4Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ExposureType4Choice obj, GenericIdentification20 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ExposureType4Choice.mmCode, com.tools20022.repository.choice.ExposureType4Choice.mmProprietary);
	...
	public ExposureType4Choice setCode(ExposureType2Code code) {
	...
	public ExposureType4Choice setProprietary(GenericIdentification20 proprietary) {
