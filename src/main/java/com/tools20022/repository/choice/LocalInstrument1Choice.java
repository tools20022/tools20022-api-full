...
public class LocalInstrument1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(LocalInstrument1Choice.mmCode, LocalInstrument1Choice.mmProprietary);
	...
	public void setCode(ExternalLocalInstrumentCode code) {
		this.code = code;
	}
