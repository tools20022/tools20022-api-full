...
public class AcknowledgedAcceptedStatus18Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus18Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus18Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus18Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason4> reason) {
		this.reason = reason;
	}
}