...
@XmlType(name = "ElectionTypeFormat2Choice", propOrder = {"code", "proprietary"})
public class ElectionTypeFormat2Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ElectionTypeFormat2Choice, ElectionMovementType2Code> mmCode = new MMMessageAttribute<ElectionTypeFormat2Choice, ElectionMovementType2Code>() {
		{
			businessElementTrace_lazy = () -> CorporateActionElection.mmElectionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ElectionTypeFormat2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ElectionMovementType2Code getValue(ElectionTypeFormat2Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(ElectionTypeFormat2Choice obj, ElectionMovementType2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<ElectionTypeFormat2Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<ElectionTypeFormat2Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> CorporateActionElection.mmElectionType;
			componentContext_lazy = () -> com.tools20022.repository.choice.ElectionTypeFormat2Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(ElectionTypeFormat2Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(ElectionTypeFormat2Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ElectionTypeFormat2Choice.mmCode, com.tools20022.repository.choice.ElectionTypeFormat2Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ElectionTypeFormat2Choice";
	...
	public ElectionTypeFormat2Choice setCode(ElectionMovementType2Code code) {
	...
	public ElectionTypeFormat2Choice setProprietary(GenericIdentification25 proprietary) {
