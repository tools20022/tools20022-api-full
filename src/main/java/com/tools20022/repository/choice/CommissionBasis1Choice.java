 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.CommissionBasis1Choice#Code
...
public class CommissionBasis1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CommissionBasis1Choice.Code, com.tools20022.repository.choice.CommissionBasis1Choice.Proprietary);
