...
@XmlType(name = "SettlementTransactionCondition9Choice", propOrder = {"code", "proprietary"})
public class SettlementTransactionCondition9Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<SettlementTransactionCondition9Choice, SettlementTransactionCondition6Code> mmCode = new MMMessageAttribute<SettlementTransactionCondition9Choice, SettlementTransactionCondition6Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition9Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public SettlementTransactionCondition6Code getValue(SettlementTransactionCondition9Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(SettlementTransactionCondition9Choice obj, SettlementTransactionCondition6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<SettlementTransactionCondition9Choice, GenericIdentification25> mmProprietary = new MMMessageAssociationEnd<SettlementTransactionCondition9Choice, GenericIdentification25>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmSettlementTransactionCondition;
			componentContext_lazy = () -> com.tools20022.repository.choice.SettlementTransactionCondition9Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification25 getValue(SettlementTransactionCondition9Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(SettlementTransactionCondition9Choice obj, GenericIdentification25 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.SettlementTransactionCondition9Choice.mmCode, com.tools20022.repository.choice.SettlementTransactionCondition9Choice.mmProprietary);
				...
				name = "SettlementTransactionCondition9Choice";
	...
	public SettlementTransactionCondition9Choice setCode(SettlementTransactionCondition6Code code) {
	...
	public SettlementTransactionCondition9Choice setProprietary(GenericIdentification25 proprietary) {
