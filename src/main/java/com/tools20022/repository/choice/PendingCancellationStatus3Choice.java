...
public class PendingCancellationStatus3Choice {
	...
	public static final MMMessageAttribute mmNotSpecifiedReason = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus5Choice.mmNotSpecifiedReason);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus5Choice.mmReason);
			minOccurs = 1;
			isComposite = true;
	...
	public void setReason(List<PendingCancellationStatusReason3> reason) {
		this.reason = reason;
	}
}