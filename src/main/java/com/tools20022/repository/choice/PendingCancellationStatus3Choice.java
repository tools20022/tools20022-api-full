...
public class PendingCancellationStatus3Choice {
	...
	public static final MMMessageAttribute NotSpecifiedReason = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PendingCancellationStatus3Choice.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus5Choice.NotSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus5Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus3Choice.NotSpecifiedReason, com.tools20022.repository.choice.PendingCancellationStatus3Choice.Reason);
