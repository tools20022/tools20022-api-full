...
@XmlType(name = "MatchingStatus28Choice", propOrder = {"code", "proprietary"})
public class MatchingStatus28Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MatchingStatus28Choice.mmCode, com.tools20022.repository.choice.MatchingStatus28Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MatchingStatus28Choice";
	...
	public MatchingStatus28Choice setCode(MatchingStatus1Code code) {
	...
	public MatchingStatus28Choice setProprietary(GenericIdentification47 proprietary) {
