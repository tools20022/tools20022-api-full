...
@XmlType(name = "AccountCriteriaDefinition3Choice", propOrder = {"queryName", "newCriteria"})
public class AccountCriteriaDefinition3Choice {
	...
	public AccountCriteriaDefinition3Choice setQueryName(Max35Text queryName) {
	...
	public AccountCriteriaDefinition3Choice setNewCriteria(AccountCriteria3 newCriteria) {
