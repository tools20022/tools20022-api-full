...
import com.tools20022.repository.msg.MemberCriteria3;
...
@XmlType(name = "MemberCriteriaDefinition1Choice", propOrder = {"queryName", "newCriteria"})
public class MemberCriteriaDefinition1Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<MemberCriteriaDefinition1Choice, Max35Text> mmQueryName = new MMMessageAttribute<MemberCriteriaDefinition1Choice, Max35Text>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.MemberCriteriaDefinition1Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "QueryName";
			definition = "Recalls the criteria (search and return criteria) defined in a preceding query.";
			previousVersion_lazy = () -> MemberCriteriaDefinitionChoice.mmQueryName;
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public Max35Text getValue(MemberCriteriaDefinition1Choice obj) {
			return obj.getQueryName();
		}

		@Override
		public void setValue(MemberCriteriaDefinition1Choice obj, Max35Text value) {
			obj.setQueryName(value);
		}
	};
	@XmlElement(name = "NewCrit", required = true)
	protected MemberCriteria3 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.MemberCriteria3
	 * MemberCriteria3}</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageElement#getComponentContext
	 * componentContext} =
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<MemberCriteriaDefinition1Choice, MemberCriteria3> mmNewCriteria = new MMMessageAssociationEnd<MemberCriteriaDefinition1Choice, MemberCriteria3>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.MemberCriteriaDefinition1Choice.mmObject();
			isDerived = false;
			xmlTag = "NewCrit";
			...
			previousVersion_lazy = () -> MemberCriteriaDefinitionChoice.mmNewCriteria;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> MemberCriteria3.mmObject();
		}

		@Override
		public MemberCriteria3 getValue(MemberCriteriaDefinition1Choice obj) {
			return obj.getNewCriteria();
		}

		@Override
		public void setValue(MemberCriteriaDefinition1Choice obj, MemberCriteria3 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MemberCriteriaDefinition1Choice.mmQueryName, com.tools20022.repository.choice.MemberCriteriaDefinition1Choice.mmNewCriteria);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "MemberCriteriaDefinition1Choice";
				...
				previousVersion_lazy = () -> MemberCriteriaDefinitionChoice.mmObject();
			}
		});
	...
	public MemberCriteriaDefinition1Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public MemberCriteria3 getNewCriteria() {
		return newCriteria;
	}

	public MemberCriteriaDefinition1Choice setNewCriteria(MemberCriteria3 newCriteria) {
