...
public class ISAPortfolio3Choice {
	...
	public static final MMMessageAssociationEnd ISA = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> ISAPortfolio3Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ISAPortfolio3Choice.ISA, com.tools20022.repository.choice.ISAPortfolio3Choice.Portfolio);
