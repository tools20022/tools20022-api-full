...
public class PendingCancellationStatus8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus8Choice.NotSpecifiedReason, com.tools20022.repository.choice.PendingCancellationStatus8Choice.Reason);
