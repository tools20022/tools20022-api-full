 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.PriceFormat11Choice#mmNotSpecifiedPrice
 * PriceFormat11Choice.mmNotSpecifiedPrice}</li>
 * </ul>
 * </li>
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule#forPriceFormat11Choice
 * ConstraintCoexistenceAmountRule.forPriceFormat11Choice}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "PriceFormat11Choice", propOrder = {"percentagePrice", "amountPrice", "notSpecifiedPrice"})
public class PriceFormat11Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat11Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat11Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat11Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat11Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat11Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat11Choice, AmountPrice3>() {
		{
		...
		@Override
		public AmountPrice3 getValue(PriceFormat11Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat11Choice obj, AmountPrice3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat11Choice, PriceValueType5Code> mmNotSpecifiedPrice = new MMMessageAttribute<PriceFormat11Choice, PriceValueType5Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat11Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdPric";
		...
		@Override
		public PriceValueType5Code getValue(PriceFormat11Choice obj) {
			return obj.getNotSpecifiedPrice();
		}

		@Override
		public void setValue(PriceFormat11Choice obj, PriceValueType5Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat11Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat11Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat11Choice.mmNotSpecifiedPrice);
				trace_lazy = () -> SecuritiesPricing.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCoexistenceAmountRule.forPriceFormat11Choice);
	...
	public PriceFormat11Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat11Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat11Choice setNotSpecifiedPrice(PriceValueType5Code notSpecifiedPrice) {
