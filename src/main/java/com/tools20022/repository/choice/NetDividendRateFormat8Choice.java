 ...
 * <li>
 * {@linkplain com.tools20022.repository.choice.NetDividendRateFormat8Choice#RateTypeAndAmountAndRateStatus
 * NetDividendRateFormat8Choice.RateTypeAndAmountAndRateStatus}</li>
 * </ul>
 * </li>
...
public class NetDividendRateFormat8Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.NetDividendRateFormat8Choice.Amount, com.tools20022.repository.choice.NetDividendRateFormat8Choice.RateTypeAndAmountAndRateStatus);
