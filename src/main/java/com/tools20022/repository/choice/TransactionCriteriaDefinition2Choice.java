...
public class TransactionCriteriaDefinition2Choice {
	...
	public static final MMMessageAttribute mmQueryName = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> TransactionCriteriaDefinition2Choice.mmObject();
			isDerived = false;
			xmlTag = "QryNm";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(TransactionCriteriaDefinition2Choice.mmQueryName, TransactionCriteriaDefinition2Choice.mmNewCriteria);
	...
	public void setNewCriteria(TransactionCriteria2 newCriteria) {
