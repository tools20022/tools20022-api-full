...
import com.tools20022.repository.msg.TransactionCriteria2;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.TransactionCriteriaDefinition2Choice#mmQueryName
 * TransactionCriteriaDefinition2Choice.mmQueryName}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.TransactionCriteriaDefinition2Choice#mmNewCriteria
 * TransactionCriteriaDefinition2Choice.mmNewCriteria}</li>
 * </ul>
 * </li>
 * <li>
...
@XmlType(name = "TransactionCriteriaDefinition2Choice", propOrder = {"queryName", "newCriteria"})
public class TransactionCriteriaDefinition2Choice {
	...
	protected TransactionCriteria2 newCriteria;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.TransactionCriteria2
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TransactionCriteriaDefinition2Choice.mmQueryName, com.tools20022.repository.choice.TransactionCriteriaDefinition2Choice.mmNewCriteria);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
				name = "TransactionCriteriaDefinition2Choice";
	...
	public TransactionCriteriaDefinition2Choice setQueryName(Max35Text queryName) {
		this.queryName = Objects.requireNonNull(queryName);
		return this;
	}

	public TransactionCriteria2 getNewCriteria() {
		return newCriteria;
	}

	public TransactionCriteriaDefinition2Choice setNewCriteria(TransactionCriteria2 newCriteria) {
