...
import com.tools20022.repository.codeset.SecuritiesLendingType1Code;
 ...
 * definition} = "Choice of format for the securities lending type."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "SecuritiesLendingType1Choice", propOrder = {"code", "proprietary"})
public class SecuritiesLendingType1Choice {
	...
	public SecuritiesLendingType1Choice setCode(SecuritiesLendingType1Code code) {
	...
	public SecuritiesLendingType1Choice setProprietary(GenericIdentification38 proprietary) {
