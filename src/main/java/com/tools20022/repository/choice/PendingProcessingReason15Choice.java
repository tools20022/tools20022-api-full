...
public class PendingProcessingReason15Choice {
	...
	public static final MMMessageAttribute Code = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PendingProcessingReason15Choice.mmObject();
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingReason15Choice.Code, com.tools20022.repository.choice.PendingProcessingReason15Choice.Proprietary);
