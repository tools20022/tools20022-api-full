...
public class PendingCancellationStatus5Choice {
	...
	public static final MMMessageAttribute NotSpecifiedReason = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingCancellationStatus3Choice.NotSpecifiedReason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus7Choice.NotSpecifiedReason);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd Reason = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> com.tools20022.repository.choice.PendingCancellationStatus3Choice.Reason;
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus7Choice.Reason);
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingCancellationStatus5Choice.NotSpecifiedReason, com.tools20022.repository.choice.PendingCancellationStatus5Choice.Reason);
