 ...
 * "CertificationType1FormatChoice"</li>
...
@XmlType(name = "CertificationType1FormatChoice", propOrder = {"code", "proprietary"})
public class CertificationType1FormatChoice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.CertificationType1FormatChoice
	 * CertificationType1FormatChoice}</li>
	...
	public CertificationType1FormatChoice setProprietary(GenericIdentification13 proprietary) {
