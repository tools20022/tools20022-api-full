...
public class Party30Choice {
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.choice.Party33Choice#Organisation
	...
	public static final MMMessageAssociationEnd Organisation = new MMMessageAssociationEnd() {
		{
			componentContext_lazy = () -> Party30Choice.mmObject();
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party33Choice.Organisation);
			minOccurs = 1;
			maxOccurs = 1;
	...
	public static final MMMessageAssociationEnd IndividualPerson = new MMMessageAssociationEnd() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party33Choice.IndividualPerson);
			minOccurs = 1;
			maxOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Party30Choice.Organisation, com.tools20022.repository.choice.Party30Choice.IndividualPerson);
