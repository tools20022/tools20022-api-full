...
public class AffirmationReason1Choice {
	...
	public static final MMMessageAssociationEnd mmReason = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AffirmationReason1Choice.mmObject();
			isDerived = false;
			xmlTag = "Rsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AffirmationReason1Choice.mmReason, AffirmationReason1Choice.mmNoSpecifiedReason);
	...
	public void setReason(List<AffirmationReason1> reason) {
		this.reason = reason;
	}
