...
import com.tools20022.repository.msg.AffirmationReason1;
...
@XmlType(name = "AffirmationReason1Choice", propOrder = {"reason", "noSpecifiedReason"})
public class AffirmationReason1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Rsn", required = true)
	protected List<AffirmationReason1> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * type} = {@linkplain com.tools20022.repository.msg.AffirmationReason1
	...
	public static final MMMessageAssociationEnd<AffirmationReason1Choice, List<AffirmationReason1>> mmReason = new MMMessageAssociationEnd<AffirmationReason1Choice, List<AffirmationReason1>>() {
		{
			...
			name = "Reason";
			definition = "Specifies the reason of the UnaffirmedStatus.";
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AffirmationReason1Choice.mmReason, com.tools20022.repository.choice.AffirmationReason1Choice.mmNoSpecifiedReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AffirmationReason1Choice";
	...
	public List<AffirmationReason1> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public AffirmationReason1Choice setReason(List<AffirmationReason1> reason) {
	...
	public AffirmationReason1Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
