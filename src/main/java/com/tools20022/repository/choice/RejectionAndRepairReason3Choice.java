...
public class RejectionAndRepairReason3Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionAndRepairReason3Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionAndRepairReason3Choice.mmCode, RejectionAndRepairReason3Choice.mmProprietary);
	...
	public void setCode(RejectionReason23Code code) {
		this.code = code;
	}
