...
public class AcceptedStatus10Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcceptedStatus10Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcceptedStatus10Choice.mmNoSpecifiedReason, AcceptedStatus10Choice.mmReason);
	...
	public void setReason(List<AcceptedStatusReason11> reason) {
		this.reason = reason;
	}
}