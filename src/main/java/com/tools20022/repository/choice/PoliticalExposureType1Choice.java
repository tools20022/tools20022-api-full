...
public class PoliticalExposureType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PoliticalExposureType1Choice.mmCode, PoliticalExposureType1Choice.mmProprietary);
	...
	public void setCode(PoliticalExposureType1Code code) {
		this.code = code;
	}
