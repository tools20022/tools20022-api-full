		...
		mmObject_lazy.compareAndSet(null, new MMMessageSet() {
			{
				...
				messageDefinition_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionModificationRequestStatusAdvice002V04.mmObject(), PortfolioTransferNotification002V04.mmObject(),
						IntraPositionMovementStatusAdvice002V04.mmObject(), SecuritiesSettlementTransactionAuditTrailReport002V03.mmObject(), SecuritiesSettlementAllegementRemovalAdvice002V04.mmObject(),
						SecuritiesFinancingStatusAdvice002V06.mmObject(), SecuritiesSettlementConditionsModificationRequest002V06.mmObject(), SecuritiesTransactionStatusQuery002V04.mmObject(),
						SecuritiesMessageCancellationAdvice002V05.mmObject(), SecuritiesBalanceAccountingReport002V09.mmObject(), SecuritiesFinancingModificationInstruction002V05.mmObject(),
						SecuritiesSettlementTransactionCounterpartyResponse002V02.mmObject(), SecuritiesTransactionCancellationRequestStatusAdvice002V05.mmObject(), SecuritiesStatementQuery002V06.mmObject(),
						IntraPositionMovementInstruction002V04.mmObject(), SecuritiesBalanceCustodyReport002V09.mmObject(), SecuritiesStatusOrStatementQueryStatusAdvice002V04.mmObject(),
						SecuritiesTransactionCancellationRequest002V05.mmObject(), SecuritiesSettlementConditionModificationStatusAdvice002V07.mmObject(), SecuritiesTransactionPendingReport002V08.mmObject(),
						IntraPositionMovementConfirmation002V06.mmObject(), SecuritiesSettlementTransactionModificationRequest002V05.mmObject(), SecuritiesSettlementTransactionAllegementNotification002V06.mmObject(),
						SecuritiesSettlementTransactionInstruction002V07.mmObject(), SecuritiesFinancingConfirmation002V07.mmObject(), IntraPositionMovementPostingReport002V06.mmObject(),
						SecuritiesSettlementTransactionAllegementReport002V06.mmObject(), SecuritiesSettlementTransactionStatusAdvice002V08.mmObject(), SecuritiesFinancingInstruction002V07.mmObject(),
						SecuritiesTransactionPostingReport002V07.mmObject(), SecuritiesSettlementTransactionGenerationNotification002V07.mmObject(), SecuritiesSettlementTransactionConfirmation002V07.mmObject(),
