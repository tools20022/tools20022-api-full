		...
		mmObject_lazy.compareAndSet(null, new MMText() {
			{
				...
				name = "RestrictedFINXMax350Text";
				definition = "Specifies a character string with a maximum length of 350 characters limited to character set X, that is, a-z A-Z / - ? : ( ) . , ‘ + .";
				minLength = 1;
				maxLength = 350;
				pattern = "[0-9a-zA-Z/\\-\\?:\\(\\)\\.\\n\\r,'\\+ ]{1,350}";
			}
