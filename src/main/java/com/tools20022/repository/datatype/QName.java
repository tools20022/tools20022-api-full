 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.QName</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"QName\"."</li>
 * </ul>
 */
public class QName {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "QName";
				definition = "W3C XML Schema Built-in datatype \"QName\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.QName;
			}
		});
