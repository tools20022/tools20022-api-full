...
import com.tools20022.repository.datatype.RestrictedFINXMax34Text.InternalXmlAdapter;
...
public class RestrictedFINXMax34Text {
		...
		mmObject_lazy.compareAndSet(null, new MMText() {
			{
				...
				name = "RestrictedFINXMax34Text";
				definition = "Specifies a character string with a maximum length of 34 characters. It has a pattern that disables the use of characters that is not part of the character set X, that is, that is not a-z A-Z / - ? : ( ) . , ‘ + , and disable the use of slash \"/\" at the beginning and end of line and double slash \"//\" within the line.";
				minLength = 1;
				maxLength = 34;
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, RestrictedFINXMax34Text> {
		@Override
		public RestrictedFINXMax34Text unmarshal(String value) {
			return new RestrictedFINXMax34Text(value);
		}

		@Override
		public String marshal(RestrictedFINXMax34Text typedData) {
