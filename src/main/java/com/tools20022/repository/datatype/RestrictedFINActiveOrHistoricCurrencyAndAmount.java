 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintCurrencyAmount#forRestrictedFINActiveOrHistoricCurrencyAndAmount
 * ConstraintCurrencyAmount.forRestrictedFINActiveOrHistoricCurrencyAndAmount}</li>
 * </ul>
 * </li>
		...
		mmObject_lazy.compareAndSet(null, new MMAmount() {
			{
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintCurrencyAmount.forRestrictedFINActiveOrHistoricCurrencyAndAmount);
