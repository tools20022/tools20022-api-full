 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.Name</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"Name\"."</li>
 * </ul>
 */
public class Name {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "Name";
				definition = "W3C XML Schema Built-in datatype \"Name\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.Name;
			}
		});
