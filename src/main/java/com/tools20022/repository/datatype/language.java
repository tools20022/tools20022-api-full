 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.language</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"language\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "language";
				definition = "W3C XML Schema Built-in datatype \"language\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.language;
			}
		});
