 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.token</li>
 * <li>
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "token";
				definition = "W3C XML Schema Built-in datatype \"token\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.token;
			}
		});
