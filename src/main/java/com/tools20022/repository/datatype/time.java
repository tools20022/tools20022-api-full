 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.time</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"time\"."</li>
 * </ul>
 */
public class time {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "time";
				definition = "W3C XML Schema Built-in datatype \"time\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.time;
			}
		});
