 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.date</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"date\"."</li>
 * </ul>
 */
public class date {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "date";
				definition = "W3C XML Schema Built-in datatype \"date\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.date;
			}
		});
