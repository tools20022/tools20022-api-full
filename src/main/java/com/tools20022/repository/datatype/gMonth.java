 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.gMonth</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"gMonth\"."</li>
 * </ul>
 */
public class gMonth {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "gMonth";
				definition = "W3C XML Schema Built-in datatype \"gMonth\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.gMonth;
			}
		});
