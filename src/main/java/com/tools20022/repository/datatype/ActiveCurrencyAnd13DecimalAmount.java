...
import com.tools20022.repository.datatype.ActiveCurrencyAnd13DecimalAmount.InternalXmlAdapter;
...
public class ActiveCurrencyAnd13DecimalAmount {
		...
		mmObject_lazy.compareAndSet(null, new MMAmount() {
			{
				...
				name = "ActiveCurrencyAnd13DecimalAmount";
	...
	public ActiveCurrencyAnd13DecimalAmount(BigDecimal value) {
		this.value = value;
	}
	...
	protected static class InternalXmlAdapter extends XmlAdapter<BigDecimal, ActiveCurrencyAnd13DecimalAmount> {
		@Override
		public ActiveCurrencyAnd13DecimalAmount unmarshal(BigDecimal value) {
			return new ActiveCurrencyAnd13DecimalAmount(value);
		}

		@Override
		public BigDecimal marshal(ActiveCurrencyAnd13DecimalAmount typedData) {
