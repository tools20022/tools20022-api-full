 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.ENTITY</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"ENTITY\"."</li>
 * </ul>
 */
public class ENTITY {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "ENTITY";
				definition = "W3C XML Schema Built-in datatype \"ENTITY\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.ENTITY;
			}
		});
