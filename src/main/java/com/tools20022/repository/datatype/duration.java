 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.duration</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"duration\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "duration";
				definition = "W3C XML Schema Built-in datatype \"duration\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.duration;
			}
		});
