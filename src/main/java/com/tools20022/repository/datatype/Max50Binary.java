 ...
 * definition} =
 * "Specifies a binary string with a maximum length of 50 binary bytes."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType
public class Max50Binary {
		...
		mmObject_lazy.compareAndSet(null, new MMBinary() {
			{
				...
				name = "Max50Binary";
				definition = "Specifies a binary string with a maximum length of 50 binary bytes.";
				minLength = 1;
				maxLength = 50;
			}
		});
	...
	public Max50Binary(String value) {
		this.value = value;
	}
