 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.integer</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"integer\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "integer";
				definition = "W3C XML Schema Built-in datatype \"integer\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.integer;
			}
		});
