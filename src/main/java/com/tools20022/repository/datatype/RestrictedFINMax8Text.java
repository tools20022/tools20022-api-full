...
import com.tools20022.repository.datatype.RestrictedFINMax8Text.InternalXmlAdapter;
...
public class RestrictedFINMax8Text {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, RestrictedFINMax8Text> {
		@Override
		public RestrictedFINMax8Text unmarshal(String value) {
			return new RestrictedFINMax8Text(value);
		}

		@Override
		public String marshal(RestrictedFINMax8Text typedData) {
