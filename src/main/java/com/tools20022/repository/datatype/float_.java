 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.float_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"float\"."</li>
 * </ul>
 */
public class float_ {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "float";
				definition = "W3C XML Schema Built-in datatype \"float\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.float_;
			}
		});
