 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.short_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"short\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "short";
				definition = "W3C XML Schema Built-in datatype \"short\".";
				kind = MMSchemaTypeKind.short_;
			}
		});
