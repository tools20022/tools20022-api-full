...
import com.tools20022.repository.datatype.NACEDomainIdentifier.InternalXmlAdapter;
...
public class NACEDomainIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, NACEDomainIdentifier> {
		@Override
		public NACEDomainIdentifier unmarshal(String value) {
			return new NACEDomainIdentifier(value);
		}

		@Override
		public String marshal(NACEDomainIdentifier typedData) {
