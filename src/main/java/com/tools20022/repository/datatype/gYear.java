 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.gYear</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"gYear\"."</li>
 * </ul>
 */
public class gYear {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "gYear";
				definition = "W3C XML Schema Built-in datatype \"gYear\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.gYear;
			}
		});
