...
import com.tools20022.repository.datatype.ImpliedCurrencyAnd20Amount.InternalXmlAdapter;
...
public class ImpliedCurrencyAnd20Amount {
		...
		mmObject_lazy.compareAndSet(null, new MMAmount() {
			{
				...
				name = "ImpliedCurrencyAnd20Amount";
	...
	public ImpliedCurrencyAnd20Amount(BigDecimal value) {
		this.value = value;
	}
	...
	protected static class InternalXmlAdapter extends XmlAdapter<BigDecimal, ImpliedCurrencyAnd20Amount> {
		@Override
		public ImpliedCurrencyAnd20Amount unmarshal(BigDecimal value) {
			return new ImpliedCurrencyAnd20Amount(value);
		}

		@Override
		public BigDecimal marshal(ImpliedCurrencyAnd20Amount typedData) {
