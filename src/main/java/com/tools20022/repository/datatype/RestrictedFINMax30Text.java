...
import com.tools20022.repository.datatype.RestrictedFINMax30Text.InternalXmlAdapter;
...
public class RestrictedFINMax30Text {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, RestrictedFINMax30Text> {
		@Override
		public RestrictedFINMax30Text unmarshal(String value) {
			return new RestrictedFINMax30Text(value);
		}

		@Override
		public String marshal(RestrictedFINMax30Text typedData) {
