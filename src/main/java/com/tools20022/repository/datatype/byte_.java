 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.byte_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"byte\"."</li>
 * </ul>
 */
public class byte_ {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "byte";
				definition = "W3C XML Schema Built-in datatype \"byte\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.byte_;
			}
		});
