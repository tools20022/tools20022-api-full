 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.boolean_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"boolean\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "boolean";
				definition = "W3C XML Schema Built-in datatype \"boolean\".";
				kind = MMSchemaTypeKind.boolean_;
			}
		});
