 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.ID</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"ID\"."</li>
 * </ul>
 */
public class ID {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "ID";
				definition = "W3C XML Schema Built-in datatype \"ID\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.ID;
			}
		});
