 ...
 * definition} =
 * "Specifies a binary string with a maximum length of 3000 binary bytes."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType
public class Max3000Binary {
	...
	public Max3000Binary() {
	}

	public Max3000Binary(String value) {
		this.value = value;
	}
