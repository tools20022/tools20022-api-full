		...
		mmObject_lazy.compareAndSet(null, new MMText() {
			{
				...
				name = "RestrictedFINMax23Text";
				definition = "Specifies a character string with a maximum length of 23 characters. It has a pattern ([^/]+/)+([^/]+)|([^/]*) that disables the use of slash \"/\" at the beginning and end of line and double slash \"//\" within the line.";
			}
		});
