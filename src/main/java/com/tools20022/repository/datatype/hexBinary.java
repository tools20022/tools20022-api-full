 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.hexBinary</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"hexBinary\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "hexBinary";
				definition = "W3C XML Schema Built-in datatype \"hexBinary\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.hexBinary;
			}
		});
