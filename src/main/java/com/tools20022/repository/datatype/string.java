 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.string</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"string\"."</li>
 * </ul>
 */
public class string {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "string";
				definition = "W3C XML Schema Built-in datatype \"string\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.string;
			}
		});
