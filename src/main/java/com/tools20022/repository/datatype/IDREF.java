 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.IDREF</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"IDREF\"."</li>
 * </ul>
 */
public class IDREF {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "IDREF";
				definition = "W3C XML Schema Built-in datatype \"IDREF\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.IDREF;
			}
		});
