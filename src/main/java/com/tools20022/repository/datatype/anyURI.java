 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.anyURI</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"anyURI\"."</li>
 * </ul>
 */
public class anyURI {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "anyURI";
				definition = "W3C XML Schema Built-in datatype \"anyURI\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.anyURI;
			}
		});
