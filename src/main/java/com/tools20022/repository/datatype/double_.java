 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.double_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"double\"."</li>
 * </ul>
 */
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "double";
				definition = "W3C XML Schema Built-in datatype \"double\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.double_;
			}
		});
