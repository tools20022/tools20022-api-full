 ...
 * definition} = "Indicates if requested or not."</li>
 * </ul>
 */
...
public class RequestedIndicator {
		...
		mmObject_lazy.compareAndSet(null, new MMIndicator() {
			{
				...
				name = "RequestedIndicator";
				definition = "Indicates if requested or not.";
				meaningWhenTrue = "Requested";
				meaningWhenFalse = "Not Requested";
			}
		});
	...
	public RequestedIndicator(Boolean value) {
		this.value = value;
	}
