 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.int_</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"int\"."</li>
 * </ul>
 */
public class int_ {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "int";
				definition = "W3C XML Schema Built-in datatype \"int\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.int_;
			}
		});
