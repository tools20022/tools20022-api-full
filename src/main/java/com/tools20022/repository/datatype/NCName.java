 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.NCName</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"NCName\"."</li>
 * </ul>
 */
public class NCName {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "NCName";
				definition = "W3C XML Schema Built-in datatype \"NCName\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.NCName;
			}
		});
