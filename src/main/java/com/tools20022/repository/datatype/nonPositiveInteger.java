 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.nonPositiveInteger</li>
 * <li>
 ...
 * "nonPositiveInteger"</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
 * definition} = "W3C XML Schema Built-in datatype \"nonPositiveInteger\"."</li>
 * </ul>
 */
...
public class nonPositiveInteger {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				definition = "W3C XML Schema Built-in datatype \"nonPositiveInteger\".";
				kind = MMSchemaTypeKind.nonPositiveInteger;
			}
		});
	...
	public nonPositiveInteger(String value) {
		this.value = value;
	}
