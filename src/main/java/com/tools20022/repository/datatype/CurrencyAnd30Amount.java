...
import com.tools20022.repository.datatype.CurrencyAnd30Amount.InternalXmlAdapter;
...
public class CurrencyAnd30Amount {
	...
	public CurrencyAnd30Amount(BigDecimal value) {
		this.value = value;
	}
	...
	protected static class InternalXmlAdapter extends XmlAdapter<BigDecimal, CurrencyAnd30Amount> {
		@Override
		public CurrencyAnd30Amount unmarshal(BigDecimal value) {
			return new CurrencyAnd30Amount(value);
		}

		@Override
		public BigDecimal marshal(CurrencyAnd30Amount typedData) {
