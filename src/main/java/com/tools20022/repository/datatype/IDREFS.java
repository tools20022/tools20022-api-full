 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.IDREFS</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"IDREFS\"."</li>
 * </ul>
 */
public class IDREFS {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				name = "IDREFS";
				definition = "W3C XML Schema Built-in datatype \"IDREFS\".";
				kind = com.tools20022.metamodel.MMSchemaTypeKind.IDREFS;
			}
		});
