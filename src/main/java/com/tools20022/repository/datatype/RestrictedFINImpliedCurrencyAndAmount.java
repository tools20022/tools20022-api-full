...
import com.tools20022.repository.datatype.RestrictedFINImpliedCurrencyAndAmount.InternalXmlAdapter;
...
public class RestrictedFINImpliedCurrencyAndAmount {
		...
		mmObject_lazy.compareAndSet(null, new MMAmount() {
			{
				...
				name = "RestrictedFINImpliedCurrencyAndAmount";
	...
	public RestrictedFINImpliedCurrencyAndAmount(BigDecimal value) {
		this.value = value;
	}
	...
	protected static class InternalXmlAdapter extends XmlAdapter<BigDecimal, RestrictedFINImpliedCurrencyAndAmount> {
		@Override
		public RestrictedFINImpliedCurrencyAndAmount unmarshal(BigDecimal value) {
			return new RestrictedFINImpliedCurrencyAndAmount(value);
		}

		@Override
		public BigDecimal marshal(RestrictedFINImpliedCurrencyAndAmount typedData) {
