 ...
 * com.tools20022.metamodel.MMSchemaTypeKind.negativeInteger</li>
 * <li>
 ...
 * definition} = "W3C XML Schema Built-in datatype \"negativeInteger\"."</li>
 * </ul>
 */
...
public class negativeInteger {
		...
		mmObject_lazy.compareAndSet(null, new MMSchemaType() {
			{
				...
				definition = "W3C XML Schema Built-in datatype \"negativeInteger\".";
				kind = MMSchemaTypeKind.negativeInteger;
			}
		});
	...
	public negativeInteger(String value) {
		this.value = value;
	}
