...
import com.tools20022.repository.datatype.RestrictedFINMax31Text.InternalXmlAdapter;
...
public class RestrictedFINMax31Text {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, RestrictedFINMax31Text> {
		@Override
		public RestrictedFINMax31Text unmarshal(String value) {
			return new RestrictedFINMax31Text(value);
		}

		@Override
		public String marshal(RestrictedFINMax31Text typedData) {
