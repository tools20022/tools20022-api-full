...
import com.tools20022.repository.datatype.EICIdentifier.InternalXmlAdapter;
...
public class EICIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, EICIdentifier> {
		@Override
		public EICIdentifier unmarshal(String value) {
			return new EICIdentifier(value);
		}

		@Override
		public String marshal(EICIdentifier typedData) {
