 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.Quantity1Code#mmAllSecurities
 ...
 * </ul>
 */
public class Quantity1Code extends QuantityCode {
	...
	public static final MMCode mmAllSecurities = new MMCode() {
		{
			...
			name = "AllSecurities";
			owner_lazy = () -> Quantity1Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(Quantity1Code.mmAllSecurities);
