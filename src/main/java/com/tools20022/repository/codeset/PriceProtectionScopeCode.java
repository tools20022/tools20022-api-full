 ...
 * =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.codeset.PriceProtectionScope1Code
 * PriceProtectionScope1Code}</li>
 * <li>{@linkplain com.tools20022.repository.codeset.PriceProtectionScope2Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.PriceProtectionScopeCode.mmLocal, com.tools20022.repository.codeset.PriceProtectionScopeCode.mmNational,
						com.tools20022.repository.codeset.PriceProtectionScopeCode.mmGlobal, com.tools20022.repository.codeset.PriceProtectionScopeCode.mmNationalExcludingLocal);
				derivation_lazy = () -> Arrays.asList(PriceProtectionScope1Code.mmObject(), PriceProtectionScope2Code.mmObject());
			}
		});
