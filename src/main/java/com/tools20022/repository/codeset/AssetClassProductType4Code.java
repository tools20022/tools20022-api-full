 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassProductType4Code#mmFreight
 ...
 * </ul>
 */
public class AssetClassProductType4Code extends AssetClassProductTypeCode {
	...
	public static final MMCode mmFreight = new MMCode() {
		{
			...
			name = "Freight";
			owner_lazy = () -> AssetClassProductType4Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.AssetClassProductType4Code.mmFreight);
