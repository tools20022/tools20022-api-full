 ...
 * </ul>
 */
public class ATMStatus1Code extends ATMStatusCode {
	...
	public static final MMCode mmInService = new MMCode() {
		{
			...
			name = "InService";
			owner_lazy = () -> ATMStatus1Code.mmObject();
		}
	};
	/**
	 * (No doc)
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(ATMStatus1Code.mmInService, ATMStatus1Code.mmOutOfService);
