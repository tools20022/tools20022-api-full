 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassSubProductType36Code#mmNewsprint
 * AssetClassSubProductType36Code.mmNewsprint}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * </ul>
 */
public class AssetClassSubProductType36Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmNewsprint = new MMCode() {
		{
			...
			name = "Newsprint";
			owner_lazy = () -> AssetClassSubProductType36Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.AssetClassSubProductType36Code.mmNewsprint);
