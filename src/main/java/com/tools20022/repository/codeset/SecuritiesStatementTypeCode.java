		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.SecuritiesStatementTypeCode.mmCustody, com.tools20022.repository.codeset.SecuritiesStatementTypeCode.mmAccounting);
