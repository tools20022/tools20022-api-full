 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.DTCCPayoutType4Code#mmSecurities
 * DTCCPayoutType4Code.mmSecurities}</li>
 * </ul>
 * </li>
 * <li>
 ...
 * </ul>
 */
public class DTCCPayoutType4Code extends DTCCPayoutTypeCode {
	...
	public static final MMCode mmSecurities = new MMCode() {
		{
			...
			name = "Securities";
			owner_lazy = () -> DTCCPayoutType4Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.DTCCPayoutType4Code.mmSecurities);
