...
import com.tools20022.repository.codeset.AllegementReasonCode;
 ...
 * </ul>
 */
public class AllegementReason1Code extends AllegementReasonCode {
	...
	public static final MMCode mmAllegementReceived = new MMCode() {
		{
			...
			owner_lazy = () -> AllegementReason1Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(AllegementReason1Code.mmAllegementReceived);
