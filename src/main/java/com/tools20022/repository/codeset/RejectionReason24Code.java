...
import com.tools20022.repository.codeset.RejectionReason24Code.InternalXmlAdapter;
...
public class RejectionReason24Code extends MMCode {
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code SafekeepingAccountRejection = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "SafekeepingAccountRejection";
			owner_lazy = () -> com.tools20022.repository.codeset.RejectionReason24Code.mmObject();
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code InvalidSecurity = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code MarketDeadlineMissed = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code ReferenceRejection = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code AccountServicerDeadlineMissed = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code Other = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Other";
			owner_lazy = () -> com.tools20022.repository.codeset.RejectionReason24Code.mmObject();
	 ...
	 * </ul>
	 */
	public static final RejectionReason24Code InvalidRequest = new RejectionReason24Code() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "InvalidRequest";
			owner_lazy = () -> com.tools20022.repository.codeset.RejectionReason24Code.mmObject();
			codeName = RejectionReasonV2Code.InvalidRequest.getCodeName().orElse(name);
		}
	};
	final static private LinkedHashMap<String, RejectionReason24Code> codesByName = new LinkedHashMap<>();

	protected RejectionReason24Code() {
	}
	...
	public static RejectionReason24Code valueOf(String codeName) {
		return codesByName.get(codeName);
	}

	public static RejectionReason24Code[] values() {
		RejectionReason24Code[] values = new RejectionReason24Code[codesByName.size()];
		return codesByName.values().toArray(values);
	}

	protected static class InternalXmlAdapter extends XmlAdapter<String, RejectionReason24Code> {
		@Override
		public RejectionReason24Code unmarshal(String codeName) {
			return valueOf(codeName);
		}

		@Override
		public String marshal(RejectionReason24Code codeObj) {
