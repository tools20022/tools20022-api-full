...
import com.tools20022.repository.codeset.AccountStatusUpdateRequestReasonCode;
 ...
 * </ul>
 */
public class AccountStatusUpdateRequestReason1Code extends AccountStatusUpdateRequestReasonCode {
	...
	public static final MMCode mmAccountClosureInstructionError = new MMCode() {
		{
			...
			owner_lazy = () -> AccountStatusUpdateRequestReason1Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(AccountStatusUpdateRequestReason1Code.mmAccountClosureInstructionError);
