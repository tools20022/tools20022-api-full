 ...
 * =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.codeset.TradeConfirmationType2Code
 * TradeConfirmationType2Code}</li>
 * <li>{@linkplain com.tools20022.repository.codeset.TradeConfirmationType1Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(TradeConfirmationType2Code.mmObject(), TradeConfirmationType1Code.mmObject());
