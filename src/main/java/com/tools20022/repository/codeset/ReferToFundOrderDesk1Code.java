 ...
 * </ul>
 */
public class ReferToFundOrderDesk1Code extends HoldingTransferableCode {
	...
	public static final MMCode mmReferToFundOrderDesk = new MMCode() {
		{
			...
			owner_lazy = () -> ReferToFundOrderDesk1Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(ReferToFundOrderDesk1Code.mmReferToFundOrderDesk);
