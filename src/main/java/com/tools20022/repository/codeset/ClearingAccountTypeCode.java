 ...
 * <li>{@linkplain com.tools20022.repository.codeset.ClearingAccountType3Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(ClearingAccountType1Code.mmObject(), ClearingAccountType3Code.mmObject());
