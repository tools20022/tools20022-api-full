		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(FailingReason1Code.mmAwaitingMoney, FailingReason1Code.mmBuyInProcedure, FailingReason1Code.mmCounterpartyTooLateForSettlement, FailingReason1Code.mmAccountServicerDeadlineMissed,
						FailingReason1Code.mmCancellationConfirmationRequested, FailingReason1Code.mmAwaitingSecurities, FailingReason1Code.mmUnderObjection, FailingReason1Code.mmAwaitingSecuritiesFromCounterparty,
						FailingReason1Code.mmPhysicalDeliveryDelay, FailingReason1Code.mmConfirmationDiscrepency, FailingReason1Code.mmAwaitingDocumentsOrEndorsementsFromYou, FailingReason1Code.mmMoneySecuritiesTooLateForSettlement,
						FailingReason1Code.mmAwaitingDocumentsOrEndorsementsFromCounterparty, FailingReason1Code.mmAccountBlocked, FailingReason1Code.mmEnquirySent, FailingReason1Code.mmNewIssues,
						FailingReason1Code.mmCounterpartyInsufficientSecurities, FailingReason1Code.mmMultipleSettlementAmount, FailingReason1Code.mmGlobalFormSecurities, FailingReason1Code.mmYourInstructionOnHold,
						FailingReason1Code.mmTradeSettlesInPartials, FailingReason1Code.mmNoForeignExchangeInstruction, FailingReason1Code.mmCounterpartyInsufficientMoney, FailingReason1Code.mmCollateralShortage,
						FailingReason1Code.mmSecuritiesPledgedAsCollateral, FailingReason1Code.mmRefusedDepositForIssueOfDepositaryReceipts, FailingReason1Code.mmMaximumForeignLimitReached, FailingReason1Code.mmIncomeAdjustementRequired,
						FailingReason1Code.mmPendingLinkedInstruction, FailingReason1Code.mmLackOfSecurities, FailingReason1Code.mmSecuritiesLoanedOut, FailingReason1Code.mmInsufficientMoney, FailingReason1Code.mmConfirmationNotReceived,
						FailingReason1Code.mmNotInGoodOrder, FailingReason1Code.mmLackOfStampDutyInformation, FailingReason1Code.mmProcessingBatchDifference, FailingReason1Code.mmAwaitingNextSettlementCycle,
						FailingReason1Code.mmSecuritiesBlocked, FailingReason1Code.mmCounterpartyInReceivership, FailingReason1Code.mmMinimumSettlementAmount, FailingReason1Code.mmStatusReasonInvestigation, FailingReason1Code.mmOther,
						FailingReason1Code.mmPhysicalSecuritiesVerification, FailingReason1Code.mmBeneficialOwnershipDisagreement, FailingReason1Code.mmBothInstructionsOnHold, FailingReason1Code.mmClearingHouseTrade,
						FailingReason1Code.mmUnavailableDeliverableDenominatedQuantity, FailingReason1Code.mmNaturalDisaster, FailingReason1Code.mmCounterpartyReturnedShares, FailingReason1Code.mmSecuritiesFrozenAtCSD,
						FailingReason1Code.mmAwaitingOtherTransaction, FailingReason1Code.mmMarketDeadlineMissed, FailingReason1Code.mmInsufficientCentralBankLiquidity, FailingReason1Code.mmCounterpartyInstructionOnHold,
						FailingReason1Code.mmCertificatesRejected, FailingReason1Code.mmSettlementSystemMethodModified, FailingReason1Code.mmWrongCertificatesNumbers, FailingReason1Code.mmSystemOnHold);
