 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassSubProductType39Code#mmAmmonia
 ...
 * </ul>
 */
public class AssetClassSubProductType39Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmAmmonia = new MMCode() {
		{
			...
			name = "Ammonia";
			owner_lazy = () -> AssetClassSubProductType39Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.AssetClassSubProductType39Code.mmAmmonia);
