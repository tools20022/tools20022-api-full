		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(TerminalManagementAction1Code.mmObject(), TerminalManagementAction3Code.mmObject(), TerminalManagementAction2Code.mmObject(), TerminalManagementAction4Code.mmObject());
