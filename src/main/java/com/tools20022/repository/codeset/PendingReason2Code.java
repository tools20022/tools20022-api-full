		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(PendingReason2Code.mmAwaitingMoney, PendingReason2Code.mmAccountServicerDeadlineMissed, PendingReason2Code.mmAwaitingSecurities, PendingReason2Code.mmInstructionRefusedOrNotRecognised,
						PendingReason2Code.mmAwaitingSecuritiesFromCounterparty, PendingReason2Code.mmPhysicalDeliveryDelay, PendingReason2Code.mmTradeAmendedInMarket, PendingReason2Code.mmAwaitingDocumentsOrEndorsementsFromYou,
						PendingReason2Code.mmAwaitingDocumentsOrEndorsementsFromCounterparty, PendingReason2Code.mmAccountBlocked, PendingReason2Code.mmEnquirySent, PendingReason2Code.mmNewIssues,
						PendingReason2Code.mmCounterpartyInsufficientSecurities, PendingReason2Code.mmMultipleSettlementAmount, PendingReason2Code.mmGlobalFormSecurities, PendingReason2Code.mmYourInstructionOnHold,
						PendingReason2Code.mmTradeSettlesInPartials, PendingReason2Code.mmNoMatchingRequired, PendingReason2Code.mmNoForeignExchangeInstruction, PendingReason2Code.mmCounterpartyInsufficientMoney,
						PendingReason2Code.mmCollateralShortage, PendingReason2Code.mmSecuritiesPledgedAsCollateral, PendingReason2Code.mmRefusedDepositForIssueOfDepositaryReceipts, PendingReason2Code.mmMaximumForeignLimitReached,
						PendingReason2Code.mmIncomeAdjustementRequired, PendingReason2Code.mmPendingLinkedInstruction, PendingReason2Code.mmAwaitingSettlementDate, PendingReason2Code.mmLackOfSecurities,
						PendingReason2Code.mmSecuritiesLoanedOut, PendingReason2Code.mmInsufficientMoney, PendingReason2Code.mmConfirmationNotReceived, PendingReason2Code.mmNotInGoodOrder, PendingReason2Code.mmLackOfStampDutyInformation,
						PendingReason2Code.mmProcessingBatchDifference, PendingReason2Code.mmAwaitingNextSettlementCycle, PendingReason2Code.mmSecuritiesBlocked, PendingReason2Code.mmCounterpartyInReceivership,
						PendingReason2Code.mmMinimumSettlementAmount, PendingReason2Code.mmStatusReasonInvestigation, PendingReason2Code.mmOther, PendingReason2Code.mmPhysicalSecuritiesVerification,
						PendingReason2Code.mmBeneficialOwnershipDisagreement, PendingReason2Code.mmBothInstructionsOnHold, PendingReason2Code.mmClearingHouseTrade, PendingReason2Code.mmUnavailableDeliverableDenominatedQuantity,
						PendingReason2Code.mmNaturalDisaster, PendingReason2Code.mmCounterpartyReturnedShares, PendingReason2Code.mmSecuritiesFrozenAtCSD, PendingReason2Code.mmAwaitingOtherTransaction,
						PendingReason2Code.mmMarketDeadlineMissed, PendingReason2Code.mmInsufficientCentralBankLiquidity, PendingReason2Code.mmCounterpartyInstructionOnHold, PendingReason2Code.mmCertificatesRejected,
						PendingReason2Code.mmSettlementSystemMethodModified, PendingReason2Code.mmWrongCertificatesNumbers, PendingReason2Code.mmSystemOnHold, PendingReason2Code.mmCSDHold, PendingReason2Code.mmCSDValidation,
						PendingReason2Code.mmConditionalDeliveryAwaitingRelease, PendingReason2Code.mmIncompleteNumberCount);
