		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(DTCCorporateActionInstructionTypeCode.mmElectionInstruction, DTCCorporateActionInstructionTypeCode.mmProtectInstruction, DTCCorporateActionInstructionTypeCode.mmInstructionWithdrawal,
						DTCCorporateActionInstructionTypeCode.mmProtectWithdrawal, DTCCorporateActionInstructionTypeCode.mmCoverProtectSystem, DTCCorporateActionInstructionTypeCode.mmCoverProtectAgent);
