 ...
 * </ul>
 */
public class AmountPriceType2Code extends AmountPriceTypeCode {
	...
	public static final MMCode mmActualAmount = new MMCode() {
		{
			...
			name = "ActualAmount";
			owner_lazy = () -> AmountPriceType2Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(AmountPriceType2Code.mmActualAmount);
