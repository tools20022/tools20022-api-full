	...
	public static final MMCode mmAccountServicerDeadlineMissed = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmAccountServicerDeadlineMissed);
	...
	public static final MMCode mmOther = new MMCode() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Other";
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmOther);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmPendingBeneficiaryOwnerDetails = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmPendingBeneficiaryOwnerDetails);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmMissingCertification = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmMissingCertification);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmInsufficientMoney = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmInsufficientMoney);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmLackOfSecurities = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmLackOfSecurities);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmMarketDeadlineMissed = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmMarketDeadlineMissed);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmQuantityDisagreement = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmQuantityDisagreement);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmPendingReceipt = new MMCode() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PendingReceipt";
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmPendingReceipt);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
	/**
	...
	public static final MMCode mmWrongCertificatesNumbers = new MMCode() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(PendingReason14Code.mmWrongCertificatesNumbers);
			owner_lazy = () -> PendingReason13Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(PendingReason13Code.mmAccountServicerDeadlineMissed, PendingReason13Code.mmOther, PendingReason13Code.mmPendingBeneficiaryOwnerDetails, PendingReason13Code.mmMissingCertification,
						PendingReason13Code.mmInsufficientMoney, PendingReason13Code.mmLackOfSecurities, PendingReason13Code.mmMarketDeadlineMissed, PendingReason13Code.mmQuantityDisagreement, PendingReason13Code.mmPendingReceipt,
						PendingReason13Code.mmWrongCertificatesNumbers);
