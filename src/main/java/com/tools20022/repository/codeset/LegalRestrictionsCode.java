 ...
 * <li>{@linkplain com.tools20022.repository.codeset.LegalRestrictions1Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(LegalRestrictions2Code.mmObject(), LegalRestrictions1Code.mmObject());
