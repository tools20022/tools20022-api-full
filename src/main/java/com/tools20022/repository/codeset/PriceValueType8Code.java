 ...
 * </ul>
 */
public class PriceValueType8Code extends PriceValueTypeCode {
	...
	public static final MMCode mmToBeSpecified = new MMCode() {
		{
			...
			name = "ToBeSpecified";
			owner_lazy = () -> PriceValueType8Code.mmObject();
		}
	};
	/**
	 * (No doc)
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(PriceValueType8Code.mmToBeSpecified, PriceValueType8Code.mmUnspecified, PriceValueType8Code.mmUnknown, PriceValueType8Code.mmNilPayment);
