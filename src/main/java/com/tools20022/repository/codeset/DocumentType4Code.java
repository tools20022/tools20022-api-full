 ...
 * </ul>
 */
public class DocumentType4Code extends DocumentTypeCode {
	...
	public static final MMCode mmCommercialInvoice = new MMCode() {
		{
			...
			owner_lazy = () -> DocumentType4Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(DocumentType4Code.mmCommercialInvoice);
