		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.CollateralSubstitutionConfirmationCode.mmCollateralSubstitutionReleased,
						com.tools20022.repository.codeset.CollateralSubstitutionConfirmationCode.mmCollateralSubstitutionReturned);
				derivation_lazy = () -> Arrays.asList(CollateralSubstitutionConfirmation1Code.mmObject());
			}
		});
