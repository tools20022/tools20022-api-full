		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(PendingCancellationReason4Code.mmAccountServicerDeadlineMissed, PendingCancellationReason4Code.mmQuantityRejection, PendingCancellationReason4Code.mmMarketDeadlineMissed,
						PendingCancellationReason4Code.mmOther);
