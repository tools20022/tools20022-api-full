		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(TransactionRejectReason6Code.mmIncorrectAccountNumber, TransactionRejectReason6Code.mmClosedAccountNumber, TransactionRejectReason6Code.mmBlockedAccount,
						TransactionRejectReason6Code.mmTransactionForbidden, TransactionRejectReason6Code.mmInvalidBankOperationCode, TransactionRejectReason6Code.mmInsufficientFunds, TransactionRejectReason6Code.mmDuplication,
						TransactionRejectReason6Code.mmNoMandate, TransactionRejectReason6Code.mmMissingMandatoryInformationInMandate, TransactionRejectReason6Code.mmInvalidFileFormatForOtherReasonThanGroupingIndicator,
						TransactionRejectReason6Code.mmBankIdentifierIncorrect, TransactionRejectReason6Code.mmEndCustomerDeceased, TransactionRejectReason6Code.mmNotSpecifiedReasonCustomerGenerated,
						TransactionRejectReason6Code.mmNotSpecifiedReasonAgentGenerated, TransactionRejectReason6Code.mmCutOffTime);
