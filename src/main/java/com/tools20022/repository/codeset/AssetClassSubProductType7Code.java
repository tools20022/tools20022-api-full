 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassSubProductType7Code#mmNaturalGas
 ...
 * </ul>
 */
public class AssetClassSubProductType7Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmNaturalGas = new MMCode() {
		{
			...
			name = "NaturalGas";
			owner_lazy = () -> AssetClassSubProductType7Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(AssetClassSubProductType7Code.mmNaturalGas);
