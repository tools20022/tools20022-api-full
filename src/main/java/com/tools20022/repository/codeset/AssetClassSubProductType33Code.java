 ...
 * </ul>
 */
public class AssetClassSubProductType33Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmConstruction = new MMCode() {
		{
			...
			name = "Construction";
			owner_lazy = () -> AssetClassSubProductType33Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(AssetClassSubProductType33Code.mmConstruction);
