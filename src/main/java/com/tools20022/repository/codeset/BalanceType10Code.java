		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(BalanceType10Code.mmOpening, BalanceType10Code.mmInterim, BalanceType10Code.mmClosing, BalanceType10Code.mmBook, BalanceType10Code.mmCurrent, BalanceType10Code.mmPending,
						BalanceType10Code.mmLimitRelated, BalanceType10Code.mmAvailable, BalanceType10Code.mmLiquidityTransfer, BalanceType10Code.mmCredit, BalanceType10Code.mmEligibleAssets, BalanceType10Code.mmPayment,
						BalanceType10Code.mmBlocked, BalanceType10Code.mmExpected, BalanceType10Code.mmDaylightOverdraft, BalanceType10Code.mmExpectedCredit, BalanceType10Code.mmExpectedDebit, BalanceType10Code.mmAdjustment,
						BalanceType10Code.mmProgressiveAverage, BalanceType10Code.mmDebit, BalanceType10Code.mmThreshold, BalanceType10Code.mmNoted, BalanceType10Code.mmSelf, BalanceType10Code.mmMaster,
						BalanceType10Code.mmForecastSettlement, BalanceType10Code.mmBlockedTrades, BalanceType10Code.mmOtherBlockedTrades, BalanceType10Code.mmCustody, BalanceType10Code.mmCashForecast,
						BalanceType10Code.mmDividendsCollection, BalanceType10Code.mmNetFunding, BalanceType10Code.mmPayInPayOut, BalanceType10Code.mmExchangeForecast, BalanceType10Code.mmCentralCounterparty,
						BalanceType10Code.mmTotalOnHold, BalanceType10Code.mmCreditOnHold, BalanceType10Code.mmDebitOnHold, BalanceType10Code.mmTotalProcessed, BalanceType10Code.mmCreditProcessed, BalanceType10Code.mmDebitProcessed,
						BalanceType10Code.mmTotalFuture, BalanceType10Code.mmTotalRejected, BalanceType10Code.mmFirmCollateralisation, BalanceType10Code.mmUsedAmountsFirmCollateralisation, BalanceType10Code.mmSelfCollateralisation,
						BalanceType10Code.mmUsedAmountsSelfCollateralisation, BalanceType10Code.mmCustodyActual, BalanceType10Code.mmCCPGuaranteedForecasting, BalanceType10Code.mmNonCCPGuaranteedForecasting,
						BalanceType10Code.mmDefinitiveSettledSecurities, BalanceType10Code.mmLackOfHoldingsTransactions, BalanceType10Code.mmNonSettledSecurities, BalanceType10Code.mmCCPGuaranteedOTCTransactions,
						BalanceType10Code.mmForecastOTCTransactions, BalanceType10Code.mmNonCCPGuaranteedOTCTransactions, BalanceType10Code.mmSAPDirectDebitAmount, BalanceType10Code.mmSAPDirectCreditAmount,
						BalanceType10Code.mmCMUPRepoDebit, BalanceType10Code.mmCMUPRepoCredit, BalanceType10Code.mmBulkSettlementCMUPDebit, BalanceType10Code.mmBulkSettlementCMUPCredit, BalanceType10Code.mmSAPQueueAmount,
						BalanceType10Code.mmIntradayRepoLimit, BalanceType10Code.mmIntradayRepoDrawings, BalanceType10Code.mmDiscountWindowRepoDrawings, BalanceType10Code.mmAvailableDMVForDiscountWindowRepo,
						BalanceType10Code.mmAvailableDMVForIntradayRepo);
