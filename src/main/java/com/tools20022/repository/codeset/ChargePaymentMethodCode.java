 ...
 * =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.codeset.ChargePaymentMethod1Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.ChargePaymentMethodCode.mmCash, com.tools20022.repository.codeset.ChargePaymentMethodCode.mmUnit);
				derivation_lazy = () -> Arrays.asList(ChargePaymentMethod1Code.mmObject());
			}
		});
