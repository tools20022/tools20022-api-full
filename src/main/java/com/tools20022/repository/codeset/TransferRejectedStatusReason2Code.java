		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(TransferRejectedStatusReason2Code.mmSettlementDate, TransferRejectedStatusReason2Code.mmSettlementPlace, TransferRejectedStatusReason2Code.mmFinancialInstrumentIdentification,
						TransferRejectedStatusReason2Code.mmNotEnoughFinancialInstrument, TransferRejectedStatusReason2Code.mmSettlementParties, TransferRejectedStatusReason2Code.mmCertificateNumber,
						TransferRejectedStatusReason2Code.mmInvestmentAccount, TransferRejectedStatusReason2Code.mmAcquisitionDate, TransferRejectedStatusReason2Code.mmAccountBlockedForCorporateAction,
						TransferRejectedStatusReason2Code.mmAccountBlockedMissingDocuments, TransferRejectedStatusReason2Code.mmFinancialInstrumentIdentificationAndName, TransferRejectedStatusReason2Code.mmPhysicalDeliveryImpossible,
						TransferRejectedStatusReason2Code.mmLegallyImpossible, TransferRejectedStatusReason2Code.mmNotCompliantWithSLA, TransferRejectedStatusReason2Code.mmFinancialInstrumentQuantity,
						TransferRejectedStatusReason2Code.mmInvestorNameAddressUnknown, TransferRejectedStatusReason2Code.mmInsufficientInvestorData, TransferRejectedStatusReason2Code.mmInvalidAccountServicer,
						TransferRejectedStatusReason2Code.mmInvalidNomineeAccount, TransferRejectedStatusReason2Code.mmInvalidNewPlanManager, TransferRejectedStatusReason2Code.mmCurrentYearPartial,
						TransferRejectedStatusReason2Code.mmPartialNotSupported, TransferRejectedStatusReason2Code.mmFinancialInstrumentTaxYear, TransferRejectedStatusReason2Code.mmInvalidISAType,
						TransferRejectedStatusReason2Code.mmInvalidCashAccount, TransferRejectedStatusReason2Code.mmDuplicateTransferReference);
