		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(QualifiedDividendTax1Code.mmFullyQualified, QualifiedDividendTax1Code.mmPartlyQualified, QualifiedDividendTax1Code.mmNotQualified, QualifiedDividendTax1Code.mmUnknown);
