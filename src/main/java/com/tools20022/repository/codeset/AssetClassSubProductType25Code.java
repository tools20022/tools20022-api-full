 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassSubProductType25Code#mmDistillates
 ...
 * </ul>
 */
public class AssetClassSubProductType25Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmDistillates = new MMCode() {
		{
			...
			name = "Distillates";
			owner_lazy = () -> AssetClassSubProductType25Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.AssetClassSubProductType25Code.mmDistillates);
