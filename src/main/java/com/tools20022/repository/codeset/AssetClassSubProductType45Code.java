 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.codeset.AssetClassSubProductType45Code#mmPotato
 ...
 * </ul>
 */
public class AssetClassSubProductType45Code extends AssetClassSubProductTypeCode {
	...
	public static final MMCode mmPotato = new MMCode() {
		{
			...
			name = "Potato";
			owner_lazy = () -> AssetClassSubProductType45Code.mmObject();
		}
	};
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(com.tools20022.repository.codeset.AssetClassSubProductType45Code.mmPotato);
