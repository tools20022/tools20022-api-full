		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				code_lazy = () -> Arrays.asList(MeetingCancellationReason2Code.mmQuorum, MeetingCancellationReason2Code.mmProcessing, MeetingCancellationReason2Code.mmWithdrawal);
